...
\begin{definition}[Unramified rings]
\label{etale-definition-unramified-rings}
\source{stacks:024M}
\href{https://stacks.math.columbia.edu/tag/024M}{\texttt{Stacks tag 024M}}
\group{etale}
...
\begin{lemma}[Unramifiedness is a stalk local condition.]
\label{etale-lemma-characterize-unramified-Noetherian}
\source{stacks:039G}
\href{https://stacks.math.columbia.edu/tag/039G}{\texttt{Stacks tag 039G}}
\group{etale}
...
\begin{lemma}[Unramified completions]
\label{etale-lemma-unramified-completions}
\source{stacks:039H}
\href{https://stacks.math.columbia.edu/tag/039H}{\texttt{Stacks tag 039H}}
\group{etale}
...
\begin{lemma}[Characterize unramified completions]
\label{etale-lemma-characterize-unramified-completions}
\source{stacks:039I}
\href{https://stacks.math.columbia.edu/tag/039I}{\texttt{Stacks tag 039I}}
\group{etale}
...
\begin{proof}
\uses{etale-lemma-unramified-completions}
...
By Lemma \ref{etale-lemma-unramified-completions}
...
\begin{definition}[Unramified schemes]
\label{etale-definition-unramified-schemes}
\source{stacks:024N}
\href{https://stacks.math.columbia.edu/tag/024N}{\texttt{Stacks tag 024N}}
\group{etale}
...
\begin{lemma}[Unramified definition]
\label{etale-lemma-unramified-definition}
\source{stacks:039J}
\href{https://stacks.math.columbia.edu/tag/039J}{\texttt{Stacks tag 039J}}
\group{etale}

\uses{etale-definition-unramified-schemes}
Let $Y$ be a locally Noetherian scheme.
Let $f : X \to Y$ be locally of finite type.
Let $x \in X$. The morphism $f$ is unramified at $x$ in
the sense of Definition \ref{etale-definition-unramified-schemes}
if and only if it is unramified in
the sense of Morphisms, Definition \ref{morphisms-definition-unramified}.
\end{lemma}

\begin{proof}
\uses{etale-lemma-characterize-unramified-Noetherian}

This follows from Lemma \ref{etale-lemma-characterize-unramified-Noetherian}
and the definitions.
\end{proof}
...
\begin{theorem}[Unramified equivalence]
\label{etale-theorem-unramified-equivalence}
\source{stacks:024P}
\href{https://stacks.math.columbia.edu/tag/024P}{\texttt{Stacks tag 024P}}
\group{etale}
...
commutative diagram
$$
\begin{array}{ccc}U \underset{i}{\longrightarrow}\searrow &  & \mathbf{A}^n_V \swarrow \\  & V & \end{array}
$$
...
\begin{proof}
\uses{etale-definition-unramified-schemes, etale-lemma-unramified-definition}
...
from Definition \ref{etale-definition-unramified-schemes} of this chapter
but it does follow from
Morphisms, Definition \ref{morphisms-definition-unramified} which we
proved to be equivalent in
Lemma \ref{etale-lemma-unramified-definition}.
...
\begin{theorem}[Formally unramified]
\label{etale-theorem-formally-unramified}
\source{stacks:024R}
\href{https://stacks.math.columbia.edu/tag/024R}{\texttt{Stacks tag 024R}}
\group{etale}
...
\begin{proof}
\uses{etale-theorem-unramified-equivalence}
...
$$
\begin{array}{ccc} & B \overset{\phi}{\downarrow}\overset{\bar{\phi}}{\searrow} &  \\ R \longrightarrow\nearrow & C \longrightarrow & C/J\end{array}
$$
...
of differentials, see Theorem \ref{etale-theorem-unramified-equivalence}.
...
\begin{proposition}[Properties sections]
\label{etale-proposition-properties-sections}
\source{stacks:024T}
\href{https://stacks.math.columbia.edu/tag/024T}{\texttt{Stacks tag 024T}}
\group{etale}
...
\begin{theorem}[Sections unramified maps]
\label{etale-theorem-sections-unramified-maps}
\source{stacks:024U}
\href{https://stacks.math.columbia.edu/tag/024U}{\texttt{Stacks tag 024U}}
\group{etale}
...
\begin{proof}
\uses{etale-proposition-properties-sections}

Direct from Proposition \ref{etale-proposition-properties-sections} part (3).
\end{proof}
...
\begin{proposition}[Equality]
\label{etale-proposition-equality}
\source{stacks:024V}
\href{https://stacks.math.columbia.edu/tag/024V}{\texttt{Stacks tag 024V}}
\group{etale}
...
\begin{proof}
\uses{etale-theorem-sections-unramified-maps}
...
Thus according to Theorem \ref{etale-theorem-sections-unramified-maps}
...
\begin{lemma}[Finitely many maps to unramified]
\label{etale-lemma-finitely-many-maps-to-unramified}
\source{stacks:0AKI}
\href{https://stacks.math.columbia.edu/tag/0AKI}{\texttt{Stacks tag 0AKI}}
\group{etale}
...
\begin{proof}
\uses{etale-proposition-equality}
...
Proposition \ref{etale-proposition-equality}.
...
\source{stacks:05VH}
\href{https://stacks.math.columbia.edu/tag/05VH}{\texttt{Stacks tag 05VH}}
\group{etale}
...
\source{stacks:04XV}
\href{https://stacks.math.columbia.edu/tag/04XV}{\texttt{Stacks tag 04XV}}
\group{etale}
...
\begin{proof}
\uses{etale-lemma-universally-injective-unramified}

The equivalence of (4) -- (7) follows immediately from
Lemma \ref{etale-lemma-universally-injective-unramified}.
...
\begin{lemma}[Finite unramified one point]
\label{etale-lemma-finite-unramified-one-point}
\source{stacks:04DG}
\href{https://stacks.math.columbia.edu/tag/04DG}{\texttt{Stacks tag 04DG}}
\group{etale}
...
\begin{example}[Etale field extensions]
\label{etale-example-etale-field-extensions}
\source{stacks:024X}
\href{https://stacks.math.columbia.edu/tag/024X}{\texttt{Stacks tag 024X}}
\group{etale}
...
\begin{example}[Standard etale]
\label{etale-example-standard-etale}
\source{stacks:024Y}
\href{https://stacks.math.columbia.edu/tag/024Y}{\texttt{Stacks tag 024Y}}
\group{etale}

\uses{etale-theorem-unramified-equivalence}
Property (3) in
Theorem \ref{etale-theorem-unramified-equivalence}
...
\begin{example}[Number theory etale]
\label{etale-example-number-theory-etale}
\source{stacks:024Z}
\href{https://stacks.math.columbia.edu/tag/024Z}{\texttt{Stacks tag 024Z}}
\group{etale}
...
\begin{definition}[Flat rings]
\label{etale-definition-flat-rings}
\source{stacks:0251}
\href{https://stacks.math.columbia.edu/tag/0251}{\texttt{Stacks tag 0251}}
\group{etale}
...
\begin{theorem}[Flatness grothendieck]
\label{etale-theorem-flatness-grothendieck}
\source{stacks:0252}
\href{https://stacks.math.columbia.edu/tag/0252}{\texttt{Stacks tag 0252}}
\group{etale}
...
\begin{definition}[Flat schemes]
\label{etale-definition-flat-schemes}
\source{stacks:0253}
\href{https://stacks.math.columbia.edu/tag/0253}{\texttt{Stacks tag 0253}}
\group{etale}
...
\begin{theorem}[Flat open]
\label{etale-theorem-flat-open}
\source{stacks:0255}
\href{https://stacks.math.columbia.edu/tag/0255}{\texttt{Stacks tag 0255}}
\group{etale}
...
\begin{theorem}[Flat map open]
\label{etale-theorem-flat-map-open}
\source{stacks:039K}
\href{https://stacks.math.columbia.edu/tag/039K}{\texttt{Stacks tag 039K}}
\group{etale}
...
\begin{theorem}[Flat is quotient]
\label{etale-theorem-flat-is-quotient}
\source{stacks:0256}
\href{https://stacks.math.columbia.edu/tag/0256}{\texttt{Stacks tag 0256}}
\group{etale}
...
functorial characterization presented in Theorem \ref{etale-theorem-formally-etale}.
...
\begin{definition}[Etale ring]
\label{etale-definition-etale-ring}
\source{stacks:0258}
\href{https://stacks.math.columbia.edu/tag/0258}{\texttt{Stacks tag 0258}}
\group{etale}

\uses{etale-definition-unramified-rings}
Let $A$, $B$ be Noetherian local rings.
...
(please see Definition \ref{etale-definition-unramified-rings}).
\end{definition}
...
\begin{lemma}[Characterize etale Noetherian]
\label{etale-lemma-characterize-etale-Noetherian}
\source{stacks:039L}
\href{https://stacks.math.columbia.edu/tag/039L}{\texttt{Stacks tag 039L}}
\group{etale}
...
\begin{lemma}[Characterize etale completions]
\label{etale-lemma-characterize-etale-completions}
\source{stacks:039M}
\href{https://stacks.math.columbia.edu/tag/039M}{\texttt{Stacks tag 039M}}
\group{etale}
...
\begin{proof}
\uses{etale-lemma-characterize-unramified-completions, etale-lemma-unramified-completions}

To see the equivalences of (1), (2) and (3), as we have the corresponding
results for unramified ring maps
(Lemma \ref{etale-lemma-characterize-unramified-completions})
...
For the final statement, by Lemma \ref{etale-lemma-unramified-completions}
we see that $B^\wedge$ is a finite flat $A^\wedge$ module.
Hence it is finite free by our list
of properties on flat modules in Section \ref{etale-section-flat-morphisms}.
\end{proof}
...
\begin{definition}[Etale schemes 1]
\label{etale-definition-etale-schemes-1}
\source{stacks:0259}
\href{https://stacks.math.columbia.edu/tag/0259}{\texttt{Stacks tag 0259}}
\group{etale}
...
\begin{lemma}[Etale definition]
\label{etale-lemma-etale-definition}
\source{stacks:039N}
\href{https://stacks.math.columbia.edu/tag/039N}{\texttt{Stacks tag 039N}}
\group{etale}

\uses{etale-definition-etale-schemes-1}
Let $Y$ be a locally Noetherian scheme.
Let $f : X \to Y$ be locally of finite type.
Let $x \in X$. The morphism $f$ is \'etale at $x$ in
the sense of Definition \ref{etale-definition-etale-schemes-1}
if and only if it is \'etale at $x$ in
the sense of Morphisms, Definition \ref{morphisms-definition-etale}.
\end{lemma}

\begin{proof}
\uses{etale-lemma-characterize-etale-Noetherian}

This follows from Lemma \ref{etale-lemma-characterize-etale-Noetherian}
and the definitions.
\end{proof}
...
morphism is flat, and Theorem \ref{etale-theorem-flat-map-open}.
...
\begin{theorem}[Structure etale]
\label{etale-theorem-structure-etale}
\source{stacks:025B}
\href{https://stacks.math.columbia.edu/tag/025B}{\texttt{Stacks tag 025B}}
\group{etale}
...
By Lemma \ref{etale-lemma-characterize-etale-Noetherian}
...
\begin{theorem}[Structure unramified]
\label{etale-theorem-structure-unramified}
\source{stacks:039O}
\href{https://stacks.math.columbia.edu/tag/039O}{\texttt{Stacks tag 039O}}
\group{etale}
...
Write $B = B'_{\mathfrak q}$ for some finite type $A$-algebra $B'$
(we can do this because $B$ is essentially of finite type over $A$).
By Lemma \ref{etale-lemma-characterize-unramified-Noetherian}
...
\begin{theorem}[Geometric structure]
\label{etale-theorem-geometric-structure}
\source{stacks:025C}
\href{https://stacks.math.columbia.edu/tag/025C}{\texttt{Stacks tag 025C}}
\group{etale}
...
$$
\begin{array}{ccc}X \downarrow & U \longleftarrow\downarrow\underset{j}{\longrightarrow} & \Spec(R[t]_{f'}/(f)) \downarrow \\ Y & V \longleftarrow\xlongequal{} & \Spec(R)\end{array}
$$
...
\begin{theorem}[Smooth etale over n space]
\label{etale-theorem-smooth-etale-over-n-space}
\source{stacks:039Q}
\href{https://stacks.math.columbia.edu/tag/039Q}{\texttt{Stacks tag 039Q}}
\group{etale}
...
$$
\begin{array}{cccc}X \downarrow & U \longleftarrow\downarrow\underset{\pi}{\longrightarrow} & \mathbf{A}^n_R \downarrow\xlongequal{} & \Spec(R[x_1, \ldots, x_n]) \swarrow \\ Y & V \longleftarrow\xlongequal{} & \Spec(R) & \end{array}
$$
where $\pi$ is \'etale.
\end{theorem}
...
\begin{theorem}[Etale radicial open]
\label{etale-theorem-etale-radicial-open}
\source{stacks:025G}
\href{https://stacks.math.columbia.edu/tag/025G}{\texttt{Stacks tag 025G}}
\group{etale}
...
\begin{lemma}[Finite etale one point]
\label{etale-lemma-finite-etale-one-point}
\source{stacks:04DH}
\href{https://stacks.math.columbia.edu/tag/04DH}{\texttt{Stacks tag 04DH}}
\group{etale}
...
\begin{proof}
\uses{etale-lemma-finite-unramified-one-point, etale-theorem-etale-radicial-open}

By
Lemma \ref{etale-lemma-finite-unramified-one-point}
...
Theorem \ref{etale-theorem-etale-radicial-open}).
Hence after shrinking $U$ we obtain an isomorphism.
\end{proof}

\begin{lemma}[Relative frobenius etale]
\label{etale-lemma-relative-frobenius-etale}
\source{stacks:0EBS}
\href{https://stacks.math.columbia.edu/tag/0EBS}{\texttt{Stacks tag 0EBS}}
\group{etale}
...
\begin{proof}
\uses{etale-theorem-etale-radicial-open}
...
\source{stacks:025H}
\href{https://stacks.math.columbia.edu/tag/025H}{\texttt{Stacks tag 025H}}
\group{etale}
...
From the proof of preceding theorem, we also obtain one direction of the
...
\source{stacks:039R}
\href{https://stacks.math.columbia.edu/tag/039R}{\texttt{Stacks tag 039R}}
\group{etale}
...
\begin{proof}
\uses{etale-theorem-etale-topological}

By Theorem \ref{etale-theorem-etale-topological}
...
\begin{theorem}[Formally etale]
\label{etale-theorem-formally-etale}
\source{stacks:025K}
\href{https://stacks.math.columbia.edu/tag/025K}{\texttt{Stacks tag 025K}}
\group{etale}
...
$$
\begin{array}{ccc}V \longrightarrow\searrow & X_U \downarrow\longrightarrow & X \overset{f}{\downarrow} \\  & U \longrightarrow & S\end{array}
$$
see
More on Morphisms, Equation (\ref{more-morphisms-equation-basic-diagram}).
We start with a very general case.

\begin{lemma}[Unramified etale local]
\label{etale-lemma-unramified-etale-local}
\source{stacks:04HH}
\href{https://stacks.math.columbia.edu/tag/04HH}{\texttt{Stacks tag 04HH}}
\group{etale}
...
\begin{proof}
\uses{etale-lemma-finite-unramified-one-point}
...
\begin{lemma}[Unramified etale local technical]
\label{etale-lemma-unramified-etale-local-technical}
\source{stacks:04HI}
\href{https://stacks.math.columbia.edu/tag/04HI}{\texttt{Stacks tag 04HI}}
\group{etale}
...
\begin{proof}
\uses{etale-lemma-unramified-etale-local}

Apply
Lemma \ref{etale-lemma-unramified-etale-local}.
...
\begin{lemma}[Finite unramified etale local]
\label{etale-lemma-finite-unramified-etale-local}
\source{stacks:04HJ}
\href{https://stacks.math.columbia.edu/tag/04HJ}{\texttt{Stacks tag 04HJ}}
\group{etale}
...
\begin{proof}
\uses{etale-lemma-unramified-etale-local-technical}

Since $X \to S$ is finite the fibre over $s$ is a finite set
$\{x_1, \ldots, x_n\}$ of points of $X$. Apply
Lemma \ref{etale-lemma-unramified-etale-local-technical}
...
\begin{lemma}[Etale etale local]
\label{etale-lemma-etale-etale-local}
\source{stacks:04HL}
\href{https://stacks.math.columbia.edu/tag/04HL}{\texttt{Stacks tag 04HL}}
\group{etale}
...
\begin{proof}
\uses{etale-lemma-unramified-etale-local, etale-theorem-etale-radicial-open}
...
\begin{lemma}[Etale etale local technical]
\label{etale-lemma-etale-etale-local-technical}
\source{stacks:04HM}
\href{https://stacks.math.columbia.edu/tag/04HM}{\texttt{Stacks tag 04HM}}
\group{etale}
...
\begin{proof}
\uses{etale-lemma-unramified-etale-local-technical, etale-lemma-etale-etale-local}

An \'etale morphism is unramified, hence we may apply
Lemma \ref{etale-lemma-unramified-etale-local-technical}.
As in the proof of
Lemma \ref{etale-lemma-etale-etale-local}
...
\begin{lemma}[Finite etale etale local]
\label{etale-lemma-finite-etale-etale-local}
\source{stacks:04HN}
\href{https://stacks.math.columbia.edu/tag/04HN}{\texttt{Stacks tag 04HN}}
\group{etale}
...
\begin{proof}
\uses{etale-lemma-finite-unramified-etale-local, etale-lemma-etale-etale-local}

An \'etale morphism is unramified, hence we may apply
Lemma \ref{etale-lemma-finite-unramified-etale-local}.
As in the proof of
Lemma \ref{etale-lemma-etale-etale-local}
...
(as defined in Definition \ref{etale-definition-etale-ring}). See
...
\begin{lemma}[Etale dimension]
\label{etale-lemma-etale-dimension}
\source{stacks:039S}
\href{https://stacks.math.columbia.edu/tag/039S}{\texttt{Stacks tag 039S}}
\group{etale}
...
\begin{proposition}[Etale depth]
\label{etale-proposition-etale-depth}
\source{stacks:039T}
\href{https://stacks.math.columbia.edu/tag/039T}{\texttt{Stacks tag 039T}}
\group{etale}
...
\begin{proposition}[Being Cohen-Macaulay ascends and descends along \'etale maps.]
\label{etale-proposition-etale-CM}
\source{stacks:025Q}
\href{https://stacks.math.columbia.edu/tag/025Q}{\texttt{Stacks tag 025Q}}
\group{etale}
...
\begin{proposition}[Etale regular]
\label{etale-proposition-etale-regular}
\source{stacks:025N}
\href{https://stacks.math.columbia.edu/tag/025N}{\texttt{Stacks tag 025N}}
\group{etale}
...
\begin{proof}
\uses{etale-lemma-etale-dimension}
...
\dim(A) = \dim(B)$ (see Lemma \ref{etale-lemma-etale-dimension}).
...
\begin{proposition}[Etale reduced]
\label{etale-proposition-etale-reduced}
\source{stacks:025O}
\href{https://stacks.math.columbia.edu/tag/025O}{\texttt{Stacks tag 025O}}
\group{etale}
...
is \'etale over $A$, see Lemma \ref{etale-lemma-characterize-etale-Noetherian}.
Then we see that Algebra, Lemma \ref{algebra-lemma-reduced-goes-up} applies to
$A \to B'$ and $B'$ is reduced. Hence $B$ is reduced.
\end{proof}

\begin{remark}[Technicality needed]
\label{etale-remark-technicality-needed}
\source{stacks:039U}
\href{https://stacks.math.columbia.edu/tag/039U}{\texttt{Stacks tag 039U}}
\group{etale}
...
\begin{proposition}[Etale normal]
\label{etale-proposition-etale-normal}
\source{stacks:025P}
\href{https://stacks.math.columbia.edu/tag/025P}{\texttt{Stacks tag 025P}}
\group{etale}
...
Lemma \ref{etale-lemma-characterize-etale-Noetherian}.
Then we see that
...
The preceding propositions give some indication as to why we'd like to think
...
\source{stacks:0BTJ}
\href{https://stacks.math.columbia.edu/tag/0BTJ}{\texttt{Stacks tag 0BTJ}}
\group{etale}
...
By Proposition \ref{etale-proposition-equality} it suffices to
...
\source{stacks:0BTK}
\href{https://stacks.math.columbia.edu/tag/0BTK}{\texttt{Stacks tag 0BTK}}
\group{etale}
...
\begin{proof}
\uses{etale-lemma-faithful, etale-proposition-properties-sections, etale-theorem-etale-radicial-open}

By Lemma \ref{etale-lemma-faithful} the functor is faithful.
...
by Theorem \ref{etale-theorem-etale-radicial-open}.
Thus $\Gamma$ is the graph of a morphism $U_1 \to U_2$
and the base change of this morphism is $a$ as desired.
\end{proof}

\begin{lemma}[Fully faithful cases]
\label{etale-lemma-fully-faithful-cases}
\source{stacks:0BTL}
\href{https://stacks.math.columbia.edu/tag/0BTL}{\texttt{Stacks tag 0BTL}}
\group{etale}
...
\begin{proof}
\uses{etale-lemma-fully-faithful}

This follows from Lemma \ref{etale-lemma-fully-faithful}.
...
\begin{lemma}[Reduce to affine]
\label{etale-lemma-reduce-to-affine}
\source{stacks:0BTM}
\href{https://stacks.math.columbia.edu/tag/0BTM}{\texttt{Stacks tag 0BTM}}
\group{etale}
...
\begin{lemma}[Split henselian]
\label{etale-lemma-split-henselian}
\source{stacks:0BTN}
\href{https://stacks.math.columbia.edu/tag/0BTN}{\texttt{Stacks tag 0BTN}}
\group{etale}
...
\source{stacks:0BTP}
\href{https://stacks.math.columbia.edu/tag/0BTP}{\texttt{Stacks tag 0BTP}}
\group{etale}
...
\begin{proof}
\uses{etale-lemma-fully-faithful-cases, etale-lemma-reduce-to-affine, etale-lemma-split-henselian}

By Lemma \ref{etale-lemma-fully-faithful-cases} the
...
We can use Lemma \ref{etale-lemma-reduce-to-affine}
...
points lying over $Y$. See Lemma \ref{etale-lemma-split-henselian}.
...
\begin{definition}[Strict normal crossings]
\label{etale-definition-strict-normal-crossings}
\source{stacks:0BI9}
\href{https://stacks.math.columbia.edu/tag/0BI9}{\texttt{Stacks tag 0BI9}}
\group{etale}
...
\begin{lemma}[Strict normal crossings]
\label{etale-lemma-strict-normal-crossings}
\source{stacks:0BIA}
\href{https://stacks.math.columbia.edu/tag/0BIA}{\texttt{Stacks tag 0BIA}}
\group{etale}
...
\begin{proof}
\uses{etale-definition-strict-normal-crossings}
...
Definition \ref{etale-definition-strict-normal-crossings}.
...
\begin{lemma}[Pullback of a strict normal crossings divisor by a smooth morphism is a strict normal c...]
\label{etale-lemma-smooth-pullback-strict-normal-crossings}
\source{stacks:0CBP}
\href{https://stacks.math.columbia.edu/tag/0CBP}{\texttt{Stacks tag 0CBP}}
\group{etale}
...
\begin{definition}[Normal crossings]
\label{etale-definition-normal-crossings}
\source{stacks:0BSF}
\href{https://stacks.math.columbia.edu/tag/0BSF}{\texttt{Stacks tag 0BSF}}
\group{etale}
...
\begin{lemma}[Pullback of a normal crossings divisor by a smooth morphism is a normal crossings divisor.]
\label{etale-lemma-smooth-pullback-normal-crossings}
\source{stacks:0CBQ}
\href{https://stacks.math.columbia.edu/tag/0CBQ}{\texttt{Stacks tag 0CBQ}}
\group{etale}
...
\begin{proof}
\uses{etale-definition-normal-crossings, etale-lemma-smooth-pullback-strict-normal-crossings}
...
divisor as in Definition \ref{etale-definition-normal-crossings}.
...
divisor on $V$ by Lemma \ref{etale-lemma-smooth-pullback-strict-normal-crossings}.
Thus we have checked the condition of
Definition \ref{etale-definition-normal-crossings}
for $q \in f^*D$ and we conclude.
\end{proof}

\begin{lemma}[Characterize normal crossings normalization]
\label{etale-lemma-characterize-normal-crossings-normalization}
\source{stacks:0CBR}
\href{https://stacks.math.columbia.edu/tag/0CBR}{\texttt{Stacks tag 0CBR}}
\group{etale}
...
\begin{proof}
\uses{etale-lemma-strict-normal-crossings, etale-lemma-finite-unramified-etale-local}
...
(see Lemma \ref{etale-lemma-strict-normal-crossings} and
...
By Lemma \ref{etale-lemma-finite-unramified-etale-local}
...
\begin{lemma}[Characterize normal crossings]
\label{etale-lemma-characterize-normal-crossings}
\source{stacks:0CBS}
\href{https://stacks.math.columbia.edu/tag/0CBS}{\texttt{Stacks tag 0CBS}}
\group{etale}
...
\begin{proof}
\uses{etale-lemma-characterize-normal-crossings-normalization}
...
Lemma \ref{etale-lemma-characterize-normal-crossings-normalization}.
