...
The initial versions of Sections \ref{stacks-geometry-section-multiplicities} and
...
\begin{definition}[Situation: Versal]
\label{stacks-geometry-situation-versal}
\source{stacks:0DQU}
\href{https://stacks.math.columbia.edu/tag/0DQU}{\texttt{Stacks tag 0DQU}}
\group{stacks-geometry}
...
\begin{definition}[Versal ring at x]
\label{stacks-geometry-definition-versal-ring-at-x}
\source{stacks:0DQV}
\href{https://stacks.math.columbia.edu/tag/0DQV}{\texttt{Stacks tag 0DQV}}
\group{stacks-geometry}

In Situation \ref{stacks-geometry-situation-versal} let $x_0 : \Spec(k) \to \mathcal{X}$
...
\source{stacks:0DQW}
\href{https://stacks.math.columbia.edu/tag/0DQW}{\texttt{Stacks tag 0DQW}}
\group{stacks-geometry}
...
\begin{lemma}[Versal ring]
\label{stacks-geometry-lemma-versal-ring}
\source{stacks:0DQX}
\href{https://stacks.math.columbia.edu/tag/0DQX}{\texttt{Stacks tag 0DQX}}
\group{stacks-geometry}
...
\begin{proof}
Existence follows from Lemma \ref{stacks-geometry-lemma-deformation-category} and
Formal Deformation Theory,
Definition \ref{formal-defos-definition-deformation-category} and
...
\begin{lemma}[Versal ring field extension]
\label{stacks-geometry-lemma-versal-ring-field-extension}
\source{stacks:0DQY}
\href{https://stacks.math.columbia.edu/tag/0DQY}{\texttt{Stacks tag 0DQY}}
\group{stacks-geometry}
...
\begin{lemma}[Compare versal ring completion]
\label{stacks-geometry-lemma-compare-versal-ring-completion}
\source{stacks:0DQZ}
\href{https://stacks.math.columbia.edu/tag/0DQZ}{\texttt{Stacks tag 0DQZ}}
\group{stacks-geometry}

In Situation \ref{stacks-geometry-situation-versal} let $x : U \to \mathcal{X}$ be a
...
\begin{lemma}[Characterize smoothness]
\label{stacks-geometry-lemma-characterize-smoothness}
\source{stacks:0DZS}
\href{https://stacks.math.columbia.edu/tag/0DZS}{\texttt{Stacks tag 0DZS}}
\group{stacks-geometry}
...
of our versal ring by Lemma \ref{stacks-geometry-lemma-versal-ring}.
Next, let $l/k$ be a finite extension and choose
$A \to A'$ as in Lemma \ref{stacks-geometry-lemma-versal-ring-field-extension}.
...
Lemma \ref{stacks-geometry-lemma-compare-versal-ring-completion}.
...
\begin{lemma}[Artin approximation by smooth morphism]
\label{stacks-geometry-lemma-Artin-approximation-by-smooth-morphism}
\source{stacks:0DR0}
\href{https://stacks.math.columbia.edu/tag/0DR0}{\texttt{Stacks tag 0DR0}}
\group{stacks-geometry}
...
is versal at $u_0$. By Lemma \ref{stacks-geometry-lemma-compare-versal-ring-completion}
...
\source{stacks:0DR1}
\href{https://stacks.math.columbia.edu/tag/0DR1}{\texttt{Stacks tag 0DR1}}
\group{stacks-geometry}
...
\begin{enumerate}
\item in Lemma \ref{stacks-geometry-lemma-versal-ring} the isomorphism
$A \cong A'[[t_1, \ldots, t_r]]$ or $A' \cong A[[t_1, \ldots, t_r]]$
may be chosen compatible with these morphisms,
\item in Lemma \ref{stacks-geometry-lemma-versal-ring-field-extension} the
homomorphism $A \to A'$ may be chosen compatible with these morphisms,
\item in Lemma \ref{stacks-geometry-lemma-compare-versal-ring-completion}
...
$U \to \mathcal{X}$,
\item in Lemma \ref{stacks-geometry-lemma-Artin-approximation-by-smooth-morphism}
...
\begin{lemma}[Versal ring flat]
\label{stacks-geometry-lemma-versal-ring-flat}
\source{stacks:0DR2}
\href{https://stacks.math.columbia.edu/tag/0DR2}{\texttt{Stacks tag 0DR2}}
\group{stacks-geometry}
...
Remark \ref{stacks-geometry-remark-upgrade} is flat.
\end{lemma}

\begin{proof}
If the local ring of $S$ at the image point is a G-ring, then this
follows immediately from
Lemma \ref{stacks-geometry-lemma-Artin-approximation-by-smooth-morphism}
...
Lemma \ref{stacks-geometry-lemma-versal-ring} and
Remark \ref{stacks-geometry-remark-upgrade}.
...
let $A \to A'$ be as in Lemma \ref{stacks-geometry-lemma-versal-ring-field-extension}.
Then again the composition
$$
\Spec(A') \to \Spec(A) \to \mathcal{X}
$$
is the morphism $\Spec(A') \to \mathcal{X}$, see Remark \ref{stacks-geometry-remark-upgrade}.
...
\begin{remark}[Groupoid defo]
\label{stacks-geometry-remark-groupoid-defo}
\source{stacks:0DR3}
\href{https://stacks.math.columbia.edu/tag/0DR3}{\texttt{Stacks tag 0DR3}}
\group{stacks-geometry}

In Situation \ref{stacks-geometry-situation-versal} let $x_0 : \Spec(k) \to \mathcal{X}$
be a morphism, where $k$ is a finite type field over $S$.
By Lemma \ref{stacks-geometry-lemma-deformation-category} and
...
\begin{lemma}[Map of components]
\label{stacks-geometry-lemma-map-of-components}
\source{stacks:0DR5}
\href{https://stacks.math.columbia.edu/tag/0DR5}{\texttt{Stacks tag 0DR5}}
\group{stacks-geometry}
...
\begin{lemma}[Multiplicities]
\label{stacks-geometry-lemma-multiplicities}
\source{stacks:0DR6}
\href{https://stacks.math.columbia.edu/tag/0DR6}{\texttt{Stacks tag 0DR6}}
\group{stacks-geometry}
...
\source{stacks:0DR7}
\href{https://stacks.math.columbia.edu/tag/0DR7}{\texttt{Stacks tag 0DR7}}
\group{stacks-geometry}
...
Lemma \ref{stacks-geometry-lemma-map-of-components}).
...
then Lemma \ref{stacks-geometry-lemma-map-of-components} shows that the closure of
the image of $T'$ in $U_1$ (respectively $U_2$) is equal to $T'_1$
(respectively $T'_2$).

\medskip\noindent
Applying Lemma \ref{stacks-geometry-lemma-multiplicities} twice we find
that
$$
...
\source{stacks:0DR8}
\href{https://stacks.math.columbia.edu/tag/0DR8}{\texttt{Stacks tag 0DR8}}
\group{stacks-geometry}
...
by Lemmas \ref{stacks-geometry-lemma-map-of-components} and \ref{stacks-geometry-lemma-multiplicity}.
...
of an irreducible component given by Definition \ref{stacks-geometry-definition-multiplicity}
...
\begin{definition}[Formal branches]
\label{stacks-geometry-definition-formal-branches}
\source{stacks:0DRA}
\href{https://stacks.math.columbia.edu/tag/0DRA}{\texttt{Stacks tag 0DRA}}
\group{stacks-geometry}
...
Suppose in the situation of Definition \ref{stacks-geometry-definition-formal-branches}
we are given a finite extension $l/k$. Set
$x_{l, 0} : \Spec(l) \to \mathcal{X}$ equal to the composition of
$\Spec(l) \to \Spec(k)$ with $x_0$. Let
$A \to A'$ be as in Lemma \ref{stacks-geometry-lemma-versal-ring-field-extension}.
...
\begin{lemma}[Branches]
\label{stacks-geometry-lemma-branches}
\source{stacks:0DRB}
\href{https://stacks.math.columbia.edu/tag/0DRB}{\texttt{Stacks tag 0DRB}}
\group{stacks-geometry}

In the situation of Definition \ref{stacks-geometry-definition-formal-branches}
...
\begin{proof}
Let $A$ be as in Definition \ref{stacks-geometry-definition-formal-branches} and
let $\Spec(A) \to \mathcal{X}$ be as in Remark \ref{stacks-geometry-remark-upgrade}.
...
$$
\begin{array}{cc}\Spec(A) \times_\mathcal{X} U \underset{p}{\downarrow}\underset{q}{\longrightarrow} & U \overset{f}{\downarrow} \\ \Spec(A) \overset{j}{\longrightarrow} & \mathcal{X}\end{array}
$$
By Lemma \ref{stacks-geometry-lemma-versal-ring-flat} we see that $j$ is flat.
...
by Lemma \ref{stacks-geometry-lemma-map-of-components} as claimed.
...
introduction to Section \ref{stacks-geometry-section-multiplicities}.
...
Definition \ref{stacks-geometry-definition-formal-branches}
mean that the following definition makes sense.

\begin{definition}[Multiplicity formal branches]
\label{stacks-geometry-definition-multiplicity-formal-branches}
\source{stacks:0DRC}
\href{https://stacks.math.columbia.edu/tag/0DRC}{\texttt{Stacks tag 0DRC}}
\group{stacks-geometry}
...
\begin{lemma}[Branches multiplicity]
\label{stacks-geometry-lemma-branches-multiplicity}
\source{stacks:0DRD}
\href{https://stacks.math.columbia.edu/tag/0DRD}{\texttt{Stacks tag 0DRD}}
\group{stacks-geometry}
...
the map of Lemma \ref{stacks-geometry-lemma-branches} preserves multiplicities.
\end{lemma}

\begin{proof}
By Lemma \ref{stacks-geometry-lemma-Artin-approximation-by-smooth-morphism} we
...
the proof of Lemma \ref{stacks-geometry-lemma-branches} (which simplifies
...
(Lemma \ref{stacks-geometry-lemma-dimension-formula} below) which
...
\begin{remark}[Dimension algebraic space]
\label{stacks-geometry-remark-dimension-algebraic-space}
\source{stacks:0DRF}
\href{https://stacks.math.columbia.edu/tag/0DRF}{\texttt{Stacks tag 0DRF}}
\group{stacks-geometry}
...
\source{stacks:0DRG}
\href{https://stacks.math.columbia.edu/tag/0DRG}{\texttt{Stacks tag 0DRG}}
\group{stacks-geometry}
...
\begin{remark}[Relative dimension]
\label{stacks-geometry-remark-relative-dimension}
\source{stacks:0DRH}
\href{https://stacks.math.columbia.edu/tag/0DRH}{\texttt{Stacks tag 0DRH}}
\group{stacks-geometry}
...
\begin{lemma}[Behaviour of dimensions wrt smooth morphisms]
\label{stacks-geometry-lemma-behaviour-of-dimensions-wrt-smooth-morphisms}
\source{stacks:0DRI}
\href{https://stacks.math.columbia.edu/tag/0DRI}{\texttt{Stacks tag 0DRI}}
\group{stacks-geometry}
...
Definition \ref{stacks-geometry-definition-relative-dimension}.
\end{lemma}
...
the definition used there, by Remark \ref{stacks-geometry-remark-relative-dimension} (2).
\end{proof}

\begin{lemma}[Dimension for stacks]
\label{stacks-geometry-lemma-dimension-for-stacks}
\source{stacks:0DRJ}
\href{https://stacks.math.columbia.edu/tag/0DRJ}{\texttt{Stacks tag 0DRJ}}
\group{stacks-geometry}
...
by Definition \ref{stacks-geometry-definition-relative-dimension} and the
...
\begin{proof}
Lemma \ref{stacks-geometry-lemma-behaviour-of-dimensions-wrt-smooth-morphisms}
...
\begin{remark}[Dimension DM]
\label{stacks-geometry-remark-dimension-DM}
\source{stacks:0DRK}
\href{https://stacks.math.columbia.edu/tag/0DRK}{\texttt{Stacks tag 0DRK}}
\group{stacks-geometry}
...
We can now extend Definition \ref{stacks-geometry-definition-relative-dimension}
to the context of (locally finite type)
morphisms between (locally Noetherian) algebraic stacks.

\begin{definition}[Relative dimension for stacks]
\label{stacks-geometry-definition-relative-dimension-for-stacks}
\source{stacks:0DRL}
\href{https://stacks.math.columbia.edu/tag/0DRL}{\texttt{Stacks tag 0DRL}}
\group{stacks-geometry}
...
\begin{remark}[Dimension tangent space well defined]
\label{stacks-geometry-remark-dimension-tangent-space-well-defined}
\source{stacks:0DRM}
\href{https://stacks.math.columbia.edu/tag/0DRM}{\texttt{Stacks tag 0DRM}}
\group{stacks-geometry}
...
\begin{lemma}[Base change invariance of relative dimension]
\label{stacks-geometry-lemma-base-change-invariance-of-relative-dimension}
\source{stacks:0DRN}
\href{https://stacks.math.columbia.edu/tag/0DRN}{\texttt{Stacks tag 0DRN}}
\group{stacks-geometry}

Suppose given
a Cartesian square of morphisms of locally Noetherian stacks
$$
\begin{array}{cc}\mathcal{T}' \downarrow\longrightarrow & \mathcal{T} \downarrow \\ \mathcal{X}' \longrightarrow & \mathcal{X}\end{array}
$$
...
\begin{lemma}[Behaviour of dimensions wrt smooth morphisms stacky]
\label{stacks-geometry-lemma-behaviour-of-dimensions-wrt-smooth-morphisms-stacky}
\source{stacks:0DRP}
\href{https://stacks.math.columbia.edu/tag/0DRP}{\texttt{Stacks tag 0DRP}}
\group{stacks-geometry}
...
and by Lemma \ref{stacks-geometry-lemma-behaviour-of-dimensions-wrt-smooth-morphisms}
...
and so
Lemma \ref{stacks-geometry-lemma-base-change-invariance-of-relative-dimension}
shows that
...
\begin{lemma}[Relative dimension is semi continuous]
\label{stacks-geometry-lemma-relative-dimension-is-semi-continuous}
\source{stacks:0DRQ}
\href{https://stacks.math.columbia.edu/tag/0DRQ}{\texttt{Stacks tag 0DRQ}}
\group{stacks-geometry}
...
\begin{lemma}[Dimension achieved by finite type point]
\label{stacks-geometry-lemma-dimension-achieved-by-finite-type-point}
\source{stacks:0DRR}
\href{https://stacks.math.columbia.edu/tag/0DRR}{\texttt{Stacks tag 0DRR}}
\group{stacks-geometry}
...
\begin{lemma}[Constancy of dimension]
\label{stacks-geometry-lemma-constancy-of-dimension}
\source{stacks:0DRT}
\href{https://stacks.math.columbia.edu/tag/0DRT}{\texttt{Stacks tag 0DRT}}
\group{stacks-geometry}
...
of Lemma \ref{stacks-geometry-lemma-constancy-of-dimension}
in Lemma \ref{stacks-geometry-lemma-irreducible-implies-equidimensional} below,
...
\begin{definition}[Pseudo catenary]
\label{stacks-geometry-definition-pseudo-catenary}
\source{stacks:0DRU}
\href{https://stacks.math.columbia.edu/tag/0DRU}{\texttt{Stacks tag 0DRU}}
\group{stacks-geometry}
...
\begin{example}[Pseudo catenary]
\label{stacks-geometry-example-pseudo-catenary}
\source{stacks:0DRV}
\href{https://stacks.math.columbia.edu/tag/0DRV}{\texttt{Stacks tag 0DRV}}
\group{stacks-geometry}
...
\begin{lemma}[Catenary covers]
\label{stacks-geometry-lemma-catenary-covers}
\source{stacks:0DRW}
\href{https://stacks.math.columbia.edu/tag/0DRW}{\texttt{Stacks tag 0DRW}}
\group{stacks-geometry}
...
\begin{lemma}[Irreducible implies equidimensional]
\label{stacks-geometry-lemma-irreducible-implies-equidimensional}
\source{stacks:0DRX}
\href{https://stacks.math.columbia.edu/tag/0DRX}{\texttt{Stacks tag 0DRX}}
\group{stacks-geometry}
...
\medskip\noindent
By Lemma \ref{stacks-geometry-lemma-behaviour-of-dimensions-wrt-smooth-morphisms}, we have
$\dim_{f(u)}(\mathcal{X}) = \dim_{u}(U) - \dim_{u}(U_{f(u)}).$
Lemma \ref{stacks-geometry-lemma-relative-dimension-is-semi-continuous} (2)
...
(as follows from Lemma \ref{stacks-geometry-lemma-constancy-of-dimension}).
...
\source{stacks:0DRY}
\href{https://stacks.math.columbia.edu/tag/0DRY}{\texttt{Stacks tag 0DRY}}
\group{stacks-geometry}
...
while
$\dim_v (V_z) = \dim_u(U_x)$,
by Lemma \ref{stacks-geometry-lemma-base-change-invariance-of-relative-dimension}.
Thus
$$
...
\begin{lemma}[Dimension via components]
\label{stacks-geometry-lemma-dimension-via-components}
\source{stacks:0DRZ}
\href{https://stacks.math.columbia.edu/tag/0DRZ}{\texttt{Stacks tag 0DRZ}}
\group{stacks-geometry}
...
\begin{proof}
Lemma \ref{stacks-geometry-lemma-closed-immersions}
shows that
...
\begin{lemma}[Dimension at finite type point]
\label{stacks-geometry-lemma-dimension-at-finite-type-point}
\source{stacks:0DS1}
\href{https://stacks.math.columbia.edu/tag/0DS1}{\texttt{Stacks tag 0DS1}}
\group{stacks-geometry}
...
$\dim_{f(u_0)}(\mathcal{X}) = \dim_{f(u)}(\mathcal{X}).$
By Lemma \ref{stacks-geometry-lemma-behaviour-of-dimensions-wrt-smooth-morphisms}
...
Lemma \ref{stacks-geometry-lemma-dimension-achieved-by-finite-type-point}.
\end{proof}

\begin{lemma}[Monomorphing a component in of the right dimension]
\label{stacks-geometry-lemma-monomorphing-a-component-in-of-the-right-dimension}
\source{stacks:0DS2}
\href{https://stacks.math.columbia.edu/tag/0DS2}{\texttt{Stacks tag 0DS2}}
\group{stacks-geometry}
...
Lemma \ref{stacks-geometry-lemma-irreducible-implies-equidimensional}
...
$$
\begin{array}{cc}V' \longrightarrow\downarrow & V \downarrow \\ U' \longrightarrow & U\end{array}
$$
...
\begin{lemma}[Dims of images]
\label{stacks-geometry-lemma-dims-of-images}
\source{stacks:0DS4}
\href{https://stacks.math.columbia.edu/tag/0DS4}{\texttt{Stacks tag 0DS4}}
\group{stacks-geometry}
...
(Lemma \ref{stacks-geometry-lemma-relative-dimension-is-semi-continuous} (1)),
...
then Lemma \ref{stacks-geometry-lemma-map-of-components} ensures that
...
Lemma \ref{stacks-geometry-lemma-map-of-components} shows that any irreducible
...
and $V$
(and apply Lemma \ref{stacks-geometry-lemma-irreducible-implies-equidimensional}
to see that this
...
$$
\begin{array}{ccc}W \searrow\longrightarrow & \mathcal{W} \longrightarrow\downarrow & V \downarrow \\  & \mathcal{T} \longrightarrow & \mathcal{X}\end{array}
$$
...
\begin{remark}[Negative dimension]
\label{stacks-geometry-remark-negative-dimension}
\source{stacks:0DS5}
\href{https://stacks.math.columbia.edu/tag/0DS5}{\texttt{Stacks tag 0DS5}}
\group{stacks-geometry}
...
\begin{lemma}[Dims of images two]
\label{stacks-geometry-lemma-dims-of-images-two}
\source{stacks:0DS6}
\href{https://stacks.math.columbia.edu/tag/0DS6}{\texttt{Stacks tag 0DS6}}
\group{stacks-geometry}
...
\begin{lemma}[Dimension local ring pre]
\label{stacks-geometry-lemma-dimension-local-ring-pre}
\source{stacks:0DS8}
\href{https://stacks.math.columbia.edu/tag/0DS8}{\texttt{Stacks tag 0DS8}}
\group{stacks-geometry}
...
\source{stacks:0DS9}
\href{https://stacks.math.columbia.edu/tag/0DS9}{\texttt{Stacks tag 0DS9}}
\group{stacks-geometry}
...
\source{stacks:0DSA}
\href{https://stacks.math.columbia.edu/tag/0DSA}{\texttt{Stacks tag 0DSA}}
\group{stacks-geometry}
...
Lemma \ref{stacks-geometry-lemma-dimension-local-ring} are satisfied.
\end{definition}

To be sure, this is motivated by Lemma \ref{stacks-geometry-lemma-dimension-local-ring-pre}
...
\begin{lemma}[Dimension formula]
\label{stacks-geometry-lemma-dimension-formula}
\source{stacks:0DSB}
\href{https://stacks.math.columbia.edu/tag/0DSB}{\texttt{Stacks tag 0DSB}}
\group{stacks-geometry}
...
$\mathcal{F}_{\mathcal{X}, k, x_0}$ as in Remark \ref{stacks-geometry-remark-groupoid-defo}
...
By Lemma \ref{stacks-geometry-lemma-Artin-approximation-by-smooth-morphism},
...
Lemma \ref{stacks-geometry-lemma-versal-ring-field-extension}
and arguing exactly as in the preceding paragraph.
We omit the details.

\medskip\noindent
Finally, arguing as in the proof of Lemma \ref{stacks-geometry-lemma-versal-ring-flat}
