...
\source{stacks:0CV6}
\href{https://stacks.math.columbia.edu/tag/0CV6}{\texttt{Stacks tag 0CV6}}
\group{spaces-flat}
...
\vcenter{
\begin{array}{ccc}\xi \downarrow &  &  \\ t' \rightsquigarrow & t \longmapsto\longrightarrow & y\end{array}
}
\quad\quad
\vcenter{
\begin{array}{cc}X_T \underset{f_T}{\downarrow}\longrightarrow & X \overset{f}{\downarrow} \\ T \overset{g}{\longrightarrow} & Y\end{array}
}
\end{equation}
...
\source{stacks:0CV8}
\href{https://stacks.math.columbia.edu/tag/0CV8}{\texttt{Stacks tag 0CV8}}
\group{spaces-flat}
...
\source{stacks:0CV9}
\href{https://stacks.math.columbia.edu/tag/0CV9}{\texttt{Stacks tag 0CV9}}
\group{spaces-flat}

In Situation \ref{spaces-flat-situation-pre-pure}.
...
\begin{lemma}[Flat ascent impurity]
\label{spaces-flat-lemma-flat-ascent-impurity}
\source{stacks:0CVA}
\href{https://stacks.math.columbia.edu/tag/0CVA}{\texttt{Stacks tag 0CVA}}
\group{spaces-flat}
...
\begin{lemma}[Pure along X y]
\label{spaces-flat-lemma-pure-along-X-y}
\source{stacks:0CVB}
\href{https://stacks.math.columbia.edu/tag/0CVB}{\texttt{Stacks tag 0CVB}}
\group{spaces-flat}

In Situation \ref{spaces-flat-situation-pre-pure}. Let $\overline{y}$ be a geometric
...
Thus we see that (1) implies (3) by Lemma \ref{spaces-flat-lemma-impure-limit}.
...
By Lemma \ref{spaces-flat-lemma-flat-ascent-impurity}
we find an impurity
...
\source{stacks:0CVD}
\href{https://stacks.math.columbia.edu/tag/0CVD}{\texttt{Stacks tag 0CVD}}
\group{spaces-flat}

In Situation \ref{spaces-flat-situation-pre-pure}.
\begin{enumerate}
\item We say $\mathcal{F}$ is {\it pure above $y$} if {\bf none} of the
equivalent conditions of Lemma \ref{spaces-flat-lemma-pure-along-X-y} hold.
...
\source{stacks:0CVE}
\href{https://stacks.math.columbia.edu/tag/0CVE}{\texttt{Stacks tag 0CVE}}
\group{spaces-flat}
...
\source{stacks:0CVF}
\href{https://stacks.math.columbia.edu/tag/0CVF}{\texttt{Stacks tag 0CVF}}
\group{spaces-flat}
...
\source{stacks:0CVG}
\href{https://stacks.math.columbia.edu/tag/0CVG}{\texttt{Stacks tag 0CVG}}
\group{spaces-flat}
...
Lemma \ref{spaces-flat-lemma-flat-ascent-impurity}. For example
...
\source{stacks:0CVH}
\href{https://stacks.math.columbia.edu/tag/0CVH}{\texttt{Stacks tag 0CVH}}
\group{spaces-flat}

In Situation \ref{spaces-flat-situation-pre-pure}. Let $i : Z \to X$ be a closed immersion
...
\source{stacks:0CVI}
\href{https://stacks.math.columbia.edu/tag/0CVI}{\texttt{Stacks tag 0CVI}}
\group{spaces-flat}
...
Thus by Lemma \ref{spaces-flat-lemma-supported-on-closed} case (1) reduces to case (2).
...
\source{stacks:0CWJ}
\href{https://stacks.math.columbia.edu/tag/0CWJ}{\texttt{Stacks tag 0CWJ}}
\group{spaces-flat}
...
\source{stacks:0CWK}
\href{https://stacks.math.columbia.edu/tag/0CWK}{\texttt{Stacks tag 0CWK}}
\group{spaces-flat}
...
\source{stacks:0CVK}
\href{https://stacks.math.columbia.edu/tag/0CVK}{\texttt{Stacks tag 0CVK}}
\group{spaces-flat}
...
\source{stacks:0CVL}
\href{https://stacks.math.columbia.edu/tag/0CVL}{\texttt{Stacks tag 0CVL}}
\group{spaces-flat}
...
\begin{theorem}[Finite type flat]
\label{spaces-flat-theorem-finite-type-flat}
\source{stacks:0DLR}
\href{https://stacks.math.columbia.edu/tag/0DLR}{\texttt{Stacks tag 0DLR}}
\group{spaces-flat}
...
\source{stacks:0CVW}
\href{https://stacks.math.columbia.edu/tag/0CVW}{\texttt{Stacks tag 0CVW}}
\group{spaces-flat}
...
$$
\begin{array}{cc}X \downarrow & X' \overset{g}{\longleftarrow}\downarrow \\ Y & \Spec(\mathcal{O}_{Y', y'}) \longleftarrow\end{array}
$$
...
$$
\begin{array}{cc}X \downarrow & X' \overset{g}{\longleftarrow}\downarrow \\ Y & Y' \longleftarrow\end{array}
$$
...
diagram
$$
\begin{array}{ccc}X \downarrow & X' \overset{g}{\longleftarrow}\downarrow & X'' \overset{g'}{\longleftarrow}\downarrow \\ Y & Y' \longleftarrow & \Spec(\mathcal{O}_{Y'', y''}) \longleftarrow\end{array}
$$
...
\source{stacks:0CWL}
\href{https://stacks.math.columbia.edu/tag/0CWL}{\texttt{Stacks tag 0CWL}}
\group{spaces-flat}
...
\source{stacks:0CWM}
\href{https://stacks.math.columbia.edu/tag/0CWM}{\texttt{Stacks tag 0CWM}}
\group{spaces-flat}
...
\source{stacks:0CVY}
\href{https://stacks.math.columbia.edu/tag/0CVY}{\texttt{Stacks tag 0CVY}}
\group{spaces-flat}
...
$$
\begin{array}{cc}(X, x) \downarrow & (X', x') \overset{g}{\longleftarrow}\downarrow \\ (Y, y) & (Y', y') \longleftarrow\end{array}
$$
...
\source{stacks:0CVZ}
\href{https://stacks.math.columbia.edu/tag/0CVZ}{\texttt{Stacks tag 0CVZ}}
\group{spaces-flat}
...
$$
\begin{array}{cc}X \downarrow & X' \overset{g}{\longleftarrow}\downarrow \\ Y & Y' \underset{h}{\longleftarrow}\end{array}
$$
...
\source{stacks:0CW1}
\href{https://stacks.math.columbia.edu/tag/0CW1}{\texttt{Stacks tag 0CW1}}
\group{spaces-flat}
...
\begin{lemma}[Contains relative ass after base change]
\label{spaces-flat-lemma-contains-relative-ass-after-base-change}
\source{stacks:0CW2}
\href{https://stacks.math.columbia.edu/tag/0CW2}{\texttt{Stacks tag 0CW2}}
\group{spaces-flat}
...
\begin{lemma}[Pure on top]
\label{spaces-flat-lemma-pure-on-top}
\source{stacks:0CW3}
\href{https://stacks.math.columbia.edu/tag/0CW3}{\texttt{Stacks tag 0CW3}}
\group{spaces-flat}
...
we may apply the material in Sections \ref{spaces-flat-section-impure} and
...
Lemma \ref{spaces-flat-lemma-associated-point-specializes} every point of
...
\source{stacks:0CW4}
\href{https://stacks.math.columbia.edu/tag/0CW4}{\texttt{Stacks tag 0CW4}}
\group{spaces-flat}
...
By Lemma \ref{spaces-flat-lemma-flat-descend-pure} we reduce to the case
described in the next paragraph.

\medskip\noindent
Assume $Y$ is the spectrum of a strictly henselian local ring $R$
with closed point $y$.
By Lemma \ref{spaces-flat-lemma-finite-type-flat-along-fibre-free-variant}
...
by Lemma \ref{spaces-flat-lemma-pure-on-top} part (1).
This in turn follows from
Lemma \ref{spaces-flat-lemma-pure-on-top} part (2).
\end{proof}

\begin{lemma}[Finite type flat pure is universal]
\label{spaces-flat-lemma-finite-type-flat-pure-is-universal}
\source{stacks:0CW5}
\href{https://stacks.math.columbia.edu/tag/0CW5}{\texttt{Stacks tag 0CW5}}
\group{spaces-flat}
...
\source{stacks:0CW6}
\href{https://stacks.math.columbia.edu/tag/0CW6}{\texttt{Stacks tag 0CW6}}
\group{spaces-flat}
...
\source{stacks:083F}
\href{https://stacks.math.columbia.edu/tag/083F}{\texttt{Stacks tag 083F}}
\group{spaces-flat}
...
In Situation \ref{spaces-flat-situation-iso} we sometimes think of the functors
...
\source{stacks:083H}
\href{https://stacks.math.columbia.edu/tag/083H}{\texttt{Stacks tag 083H}}
\group{spaces-flat}

In Situation \ref{spaces-flat-situation-iso}.
...
\begin{lemma}[Iso go up]
\label{spaces-flat-lemma-iso-go-up}
\source{stacks:083I}
\href{https://stacks.math.columbia.edu/tag/083I}{\texttt{Stacks tag 083I}}
\group{spaces-flat}

In Situation \ref{spaces-flat-situation-iso} let $X' \to X$ be a flat morphism
...
\begin{lemma}[Iso limits]
\label{spaces-flat-lemma-iso-limits}
\source{stacks:083J}
\href{https://stacks.math.columbia.edu/tag/083J}{\texttt{Stacks tag 083J}}
\group{spaces-flat}
...
\begin{lemma}[Relate zero iso]
\label{spaces-flat-lemma-relate-zero-iso}
\source{stacks:0CVM}
\href{https://stacks.math.columbia.edu/tag/0CVM}{\texttt{Stacks tag 0CVM}}
\group{spaces-flat}

In Situation \ref{spaces-flat-situation-iso} suppose given an exact sequence
$$
...
\begin{lemma}[Relate zero affine]
\label{spaces-flat-lemma-relate-zero-affine}
\source{stacks:0CW7}
\href{https://stacks.math.columbia.edu/tag/0CW7}{\texttt{Stacks tag 0CW7}}
\group{spaces-flat}

In Situation \ref{spaces-flat-situation-iso} suppose given an affine morphism
...
\begin{lemma}[Relate zero affine push]
\label{spaces-flat-lemma-relate-zero-affine-push}
\source{stacks:0CW8}
\href{https://stacks.math.columbia.edu/tag/0CW8}{\texttt{Stacks tag 0CW8}}
\group{spaces-flat}
...
\source{stacks:0CWX}
\href{https://stacks.math.columbia.edu/tag/0CWX}{\texttt{Stacks tag 0CWX}}
\group{spaces-flat}
...
In Situation \ref{spaces-flat-situation-flat} we sometimes think of $F_{flat}$ as a functor
$(\Sch/S)^{opp} \to \textit{Sets}$ endowed with a morphism
...
\source{stacks:0CWZ}
\href{https://stacks.math.columbia.edu/tag/0CWZ}{\texttt{Stacks tag 0CWZ}}
\group{spaces-flat}

In Situation \ref{spaces-flat-situation-flat}.
\begin{enumerate}
...
\begin{definition}[Situation: Somewhat closed]
\label{spaces-flat-situation-somewhat-closed}
\source{stacks:0CWA}
\href{https://stacks.math.columbia.edu/tag/0CWA}{\texttt{Stacks tag 0CWA}}
\group{spaces-flat}
...
\begin{lemma}[F zero somewhat closed]
\label{spaces-flat-lemma-F-zero-somewhat-closed}
\source{stacks:083K}
\href{https://stacks.math.columbia.edu/tag/083K}{\texttt{Stacks tag 083K}}
\group{spaces-flat}

In Situation \ref{spaces-flat-situation-somewhat-closed}. Let $T \to S$
...
By Lemma \ref{spaces-flat-lemma-iso-go-up} we see that we may
...
for some $\lambda$ by Lemma \ref{spaces-flat-lemma-iso-limits}.
This finishes the proof of the lemma.
\end{proof}

\begin{lemma}[F zero module map]
\label{spaces-flat-lemma-F-zero-module-map}
\source{stacks:083L}
\href{https://stacks.math.columbia.edu/tag/083L}{\texttt{Stacks tag 083L}}
\group{spaces-flat}
...
\begin{lemma}[F zero somewhat closed points]
\label{spaces-flat-lemma-F-zero-somewhat-closed-points}
\source{stacks:0CWB}
\href{https://stacks.math.columbia.edu/tag/0CWB}{\texttt{Stacks tag 0CWB}}
\group{spaces-flat}

In Situation \ref{spaces-flat-situation-somewhat-closed}.
...
$$
as in Proposition \ref{spaces-flat-proposition-finite-presentation-flat-at-point}.
...
Let $I \subset R$ be the ideal defined in Lemma \ref{spaces-flat-lemma-F-zero-module-map}.
...
Lemma \ref{spaces-flat-lemma-F-zero-closed-pure} or
Lemma \ref{spaces-flat-lemma-F-zero-closed-proper}
using arguments like those used in
Lemmas \ref{spaces-flat-lemma-F-zero-somewhat-closed} and
...
\begin{lemma}[F zero closed pure]
\label{spaces-flat-lemma-F-zero-closed-pure}
\source{stacks:0CWC}
\href{https://stacks.math.columbia.edu/tag/0CWC}{\texttt{Stacks tag 0CWC}}
\group{spaces-flat}

In Situation \ref{spaces-flat-situation-iso}. Assume
\begin{enumerate}
...
\begin{proof}
By Lemma \ref{spaces-flat-lemma-finite-type-flat-pure-is-universal}
...
by a closed subscheme of $B$. By Lemma \ref{spaces-flat-lemma-iso-sheaf} and
...
Choose a diagram
$$
\begin{array}{cc}X \downarrow & X' \overset{g}{\longleftarrow}\downarrow \\ B & B' \longleftarrow\end{array}
$$
and $b' \in B'$ mapping to $b \in B$
as in Lemma \ref{spaces-flat-lemma-finite-presentation-flat-along-fibre}.
As we are working \'etale locally, we may replace
$B$ by $B'$ and assume that we have a diagram
$$
\begin{array}{ccc}X \searrow &  & X' \overset{g}{\longleftarrow}\swarrow \\  & B & \end{array}
$$
...
$$
is constructible in $B$. By Lemma \ref{spaces-flat-lemma-pure-on-top} part (2)
...
\medskip\noindent
From Lemma \ref{spaces-flat-lemma-universally-separating}
...
Lemma \ref{spaces-flat-lemma-F-zero-module-map}.

\medskip\noindent
We still have to show that $F_{zero} \to B$ is of finite presentation if
$\mathcal{F}$ is of finite type. This follows from
Lemma \ref{spaces-flat-lemma-iso-limits} combined with
Limits of Spaces, Proposition
\ref{spaces-limits-proposition-characterize-locally-finite-presentation}.
\end{proof}

\begin{lemma}[F zero closed proper]
\label{spaces-flat-lemma-F-zero-closed-proper}
\source{stacks:083M}
\href{https://stacks.math.columbia.edu/tag/083M}{\texttt{Stacks tag 083M}}
\group{spaces-flat}
...
Lemmas \ref{spaces-flat-lemma-F-zero-closed-pure} and \ref{spaces-flat-lemma-proper-pure}.
...
Lemma \ref{spaces-flat-lemma-relate-zero-affine}.
...
\source{stacks:0CWD}
\href{https://stacks.math.columbia.edu/tag/0CWD}{\texttt{Stacks tag 0CWD}}
\group{spaces-flat}
...
the inclusion. By Lemma \ref{spaces-flat-lemma-relate-zero-iso} we see that
$F_{u, iso} = F_{v, zero}$. By Lemma \ref{spaces-flat-lemma-F-zero-closed-pure}
...
\begin{lemma}[F iso closed]
\label{spaces-flat-lemma-F-iso-closed}
\source{stacks:083N}
\href{https://stacks.math.columbia.edu/tag/083N}{\texttt{Stacks tag 083N}}
\group{spaces-flat}
...
Let $\mathcal{K} = \Ker(u)$ and denote $v : \mathcal{K} \to \mathcal{F}$
the inclusion. By Lemma \ref{spaces-flat-lemma-relate-zero-iso} we see that
$F_{u, iso} = F_{v, zero}$. By Lemma \ref{spaces-flat-lemma-F-zero-closed-proper}
applied to $v$ we see that $F_{u, iso} = F_{v, zero}$ is representable
by a closed subspace of $B$. Note that $\mathcal{K}$ is of finite type
if $\mathcal{G}$ is of finite presentation, see
Modules on Sites, Lemma
...
\begin{lemma}[F surj open]
\label{spaces-flat-lemma-F-surj-open}
\source{stacks:09TP}
\href{https://stacks.math.columbia.edu/tag/09TP}{\texttt{Stacks tag 09TP}}
\group{spaces-flat}
...
\source{stacks:0CWP}
\href{https://stacks.math.columbia.edu/tag/0CWP}{\texttt{Stacks tag 0CWP}}
\group{spaces-flat}
...
Lemma \ref{spaces-flat-lemma-when-universal-flattening}.
...
\source{stacks:0CWR}
\href{https://stacks.math.columbia.edu/tag/0CWR}{\texttt{Stacks tag 0CWR}}
\group{spaces-flat}
...
if the functor $F_{flat}$ defined in Situation \ref{spaces-flat-situation-flat}
...
\source{stacks:0CWS}
\href{https://stacks.math.columbia.edu/tag/0CWS}{\texttt{Stacks tag 0CWS}}
\group{spaces-flat}
...
$$
\begin{array}{cc}U \underset{\varphi}{\downarrow}\longrightarrow & V \downarrow \\ X \longrightarrow & Y\end{array}
$$
...
\source{stacks:0CWT}
\href{https://stacks.math.columbia.edu/tag/0CWT}{\texttt{Stacks tag 0CWT}}
\group{spaces-flat}
...
if the equivalent conditions of Lemma \ref{spaces-flat-lemma-pre-flat-dimension-n}
are satisfied.
\end{definition}
...
\source{stacks:0CWU}
\href{https://stacks.math.columbia.edu/tag/0CWU}{\texttt{Stacks tag 0CWU}}
\group{spaces-flat}
...
Let $n \geq 0$. By Definition \ref{spaces-flat-definition-flat-dimension-n} and
Lemma \ref{spaces-flat-lemma-pre-flat-dimension-n} we obtain a functor
\begin{equation}
...
In Situation \ref{spaces-flat-situation-flat-dimension-n} we sometimes think of
...
\source{stacks:0CWW}
\href{https://stacks.math.columbia.edu/tag/0CWW}{\texttt{Stacks tag 0CWW}}
\group{spaces-flat}

In Situation \ref{spaces-flat-situation-flat-dimension-n}.
\begin{enumerate}
...
Choose a diagram as in part (1) of Lemma \ref{spaces-flat-lemma-pre-flat-dimension-n}.
...
by Lemma \ref{spaces-flat-lemma-pre-flat-dimension-n}
...
part (1) of Lemma \ref{spaces-flat-lemma-pre-flat-dimension-n}.
...
schemes over $V$. By
Lemma \ref{spaces-flat-lemma-pre-flat-dimension-n} again
...
\source{stacks:0CX0}
\href{https://stacks.math.columbia.edu/tag/0CX0}{\texttt{Stacks tag 0CX0}}
\group{spaces-flat}
...
Lemma \ref{spaces-flat-lemma-pre-flat-dimension-n}. Choose a surjective
...
On the other hand, Lemma \ref{spaces-flat-lemma-pre-flat-dimension-n}
...
\source{stacks:0CX1}
\href{https://stacks.math.columbia.edu/tag/0CX1}{\texttt{Stacks tag 0CX1}}
\group{spaces-flat}
...
Lemma \ref{spaces-flat-lemma-flat-dimension-n}.
...
or by Lemma \ref{spaces-flat-lemma-quasi-finite-base-change}.
...
Lemma \ref{spaces-flat-lemma-quasi-finite-base-change}
...
Thus by
Lemma \ref{spaces-flat-lemma-existence-complete}
...
$h_j$ is \'etale, by
Lemma \ref{spaces-flat-lemma-pre-flat-dimension-n}
...
It follows from
Lemma \ref{spaces-flat-lemma-localize-flat-dimension-n}
...
\source{stacks:0CX2}
\href{https://stacks.math.columbia.edu/tag/0CX2}{\texttt{Stacks tag 0CX2}}
\group{spaces-flat}
...
\source{stacks:0CX4}
\href{https://stacks.math.columbia.edu/tag/0CX4}{\texttt{Stacks tag 0CX4}}
\group{spaces-flat}
...
\source{stacks:0CX5}
\href{https://stacks.math.columbia.edu/tag/0CX5}{\texttt{Stacks tag 0CX5}}
\group{spaces-flat}

In Situation \ref{spaces-flat-situation-existence} consider
$$
...
\source{stacks:0CX6}
\href{https://stacks.math.columbia.edu/tag/0CX6}{\texttt{Stacks tag 0CX6}}
\group{spaces-flat}

In Situation \ref{spaces-flat-situation-existence} let $K$ be as in
Lemma \ref{spaces-flat-lemma-compute-what-it-should-be}. For any perfect
...
\source{stacks:0CX7}
\href{https://stacks.math.columbia.edu/tag/0CX7}{\texttt{Stacks tag 0CX7}}
\group{spaces-flat}

In Situation \ref{spaces-flat-situation-existence} let $K$ be as in
Lemma \ref{spaces-flat-lemma-compute-what-it-should-be}. Then $K$
is pseudo-coherent relative to $A$.
\end{lemma}

\begin{proof}
Combinging Lemma \ref{spaces-flat-lemma-compute-against-perfect} and
...
\source{stacks:0CX8}
\href{https://stacks.math.columbia.edu/tag/0CX8}{\texttt{Stacks tag 0CX8}}
\group{spaces-flat}

In Situation \ref{spaces-flat-situation-existence} let $K$ be as in
Lemma \ref{spaces-flat-lemma-compute-what-it-should-be}. For any
...
\end{align*}
Using Lemma \ref{spaces-flat-lemma-compute-against-perfect}
...
\source{stacks:0CX9}
\href{https://stacks.math.columbia.edu/tag/0CX9}{\texttt{Stacks tag 0CX9}}
\group{spaces-flat}

In Situation \ref{spaces-flat-situation-existence} let $K$ be as in
Lemma \ref{spaces-flat-lemma-compute-what-it-should-be}.
...
By Lemma \ref{spaces-flat-lemma-relative-pseudo-coherence}
...
By Lemma \ref{spaces-flat-lemma-compute-over-affine}
$$
...
\source{stacks:0CXA}
\href{https://stacks.math.columbia.edu/tag/0CXA}{\texttt{Stacks tag 0CXA}}
\group{spaces-flat}

In Situation \ref{spaces-flat-situation-existence} let $K$ be as in
Lemma \ref{spaces-flat-lemma-compute-what-it-should-be}. Let $W \subset X$
be as in Lemma \ref{spaces-flat-lemma-finitely-presented}.
...
By part (3) of Lemma \ref{spaces-flat-lemma-finitely-presented}
...
\source{stacks:0CXB}
\href{https://stacks.math.columbia.edu/tag/0CXB}{\texttt{Stacks tag 0CXB}}
\group{spaces-flat}

In Situation \ref{spaces-flat-situation-existence}
...
\begin{proof}
Apply Lemmas \ref{spaces-flat-lemma-compute-what-it-should-be},
...
\ref{spaces-flat-lemma-finitely-presented}, and
...
By Lemma \ref{spaces-flat-lemma-proper-pure} we see that $\mathcal{F}$
is universally pure relative to $\Spec(A)$.
By Theorem \ref{spaces-flat-theorem-flat-dimension-n-representable}
(for explanation, see Lemma \ref{spaces-flat-lemma-when-universal-flattening})
...
Section \ref{spaces-flat-section-existence} for quasi-coherent modules.
This section is the analogue of
...
\source{stacks:0DIK}
\href{https://stacks.math.columbia.edu/tag/0DIK}{\texttt{Stacks tag 0DIK}}
\group{spaces-flat}
...
\source{stacks:0DIL}
\href{https://stacks.math.columbia.edu/tag/0DIL}{\texttt{Stacks tag 0DIL}}
\group{spaces-flat}

In Situation \ref{spaces-flat-situation-existence-derived} consider
$$
...
\source{stacks:0DIM}
\href{https://stacks.math.columbia.edu/tag/0DIM}{\texttt{Stacks tag 0DIM}}
\group{spaces-flat}

In Situation \ref{spaces-flat-situation-existence-derived} let $K$ be as in
Lemma \ref{spaces-flat-lemma-compute-what-it-should-be-derived}. For any perfect
...
\source{stacks:0DIN}
\href{https://stacks.math.columbia.edu/tag/0DIN}{\texttt{Stacks tag 0DIN}}
\group{spaces-flat}

In Situation \ref{spaces-flat-situation-existence-derived} let $K$ be as in
Lemma \ref{spaces-flat-lemma-compute-what-it-should-be-derived}. Then $K$
is pseudo-coherent on $X$.
\end{lemma}

\begin{proof}
Combinging Lemma \ref{spaces-flat-lemma-compute-against-perfect-derived} and
...
\source{stacks:0DIP}
\href{https://stacks.math.columbia.edu/tag/0DIP}{\texttt{Stacks tag 0DIP}}
\group{spaces-flat}

In Situation \ref{spaces-flat-situation-existence-derived} let $K$ be as in
Lemma \ref{spaces-flat-lemma-compute-what-it-should-be-derived}. For any
\'etale morphism $U \to X$ with $U$ quasi-compact and quasi-separated we have
$$
R\Gamma(U, K) \otimes_A^\mathbf{L} A_n =
R\Gamma(U_n, K_n)
...
\end{align*}
Using Lemma \ref{spaces-flat-lemma-compute-against-perfect-derived}
and the fact that $- \otimes_A^\mathbf{L} A_n$
commutes with homotopy colimits we obtain the result.
\end{proof}
...
\source{stacks:0DIQ}
\href{https://stacks.math.columbia.edu/tag/0DIQ}{\texttt{Stacks tag 0DIQ}}
\group{spaces-flat}

In Situation \ref{spaces-flat-situation-existence-derived}
...
\begin{proof}
Apply Lemmas \ref{spaces-flat-lemma-compute-what-it-should-be-derived},
...
\source{stacks:0DIR}
\href{https://stacks.math.columbia.edu/tag/0DIR}{\texttt{Stacks tag 0DIR}}
\group{spaces-flat}
