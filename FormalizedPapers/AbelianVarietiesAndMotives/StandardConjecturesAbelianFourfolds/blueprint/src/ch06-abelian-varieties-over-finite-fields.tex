...
Moreover, if the CM-structure is , this decomposition in $\NUM(k)_\Q$  is orthogonal with respect to $\langle \cdot, \cdot \rangle_{1,\mot}^{\otimes n}$  (Definition \ref{defpairingmot}).
