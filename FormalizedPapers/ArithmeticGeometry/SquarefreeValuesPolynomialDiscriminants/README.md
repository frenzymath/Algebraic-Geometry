...
Blueprint project under `FormalizedPapers/ArithmeticGeometry/SquarefreeValuesPolynomialDiscriminants`.

- Blueprint: [`blueprint/src/content.tex`](blueprint/src/content.tex)
- Direct PDF: [arXiv PDF](https://arxiv.org/pdf/1611.09806)
