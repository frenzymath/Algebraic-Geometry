...
% Mathematical mathematical blueprint of Hartshorne, Algebraic Geometry (1977), Chapter II.
...
which kills the image of $B$, so the universal property gives exactness.
\end{proof}
...
no additional dimension exactly when it is separable.
\end{proof}
