...
\source{stacks:01AG}
\href{https://stacks.math.columbia.edu/tag/01AG}{\texttt{Stacks tag 01AG}}
\group{modules}
...
\source{stacks:01AH}
\href{https://stacks.math.columbia.edu/tag/01AH}{\texttt{Stacks tag 01AH}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-abelian}

As $\textit{Mod}(\mathcal{O}_X)$ is abelian (Lemma \ref{modules-lemma-abelian})
...
exactness on stalks (Lemma \ref{modules-lemma-abelian}) this follows from the case
of modules which is
...
\source{stacks:01AJ}
\href{https://stacks.math.columbia.edu/tag/01AJ}{\texttt{Stacks tag 01AJ}}
\group{modules}
...
\begin{lemma}[Section direct sum quasi compact]
\label{modules-lemma-section-direct-sum-quasi-compact}
\source{stacks:01AI}
\href{https://stacks.math.columbia.edu/tag/01AI}{\texttt{Stacks tag 01AI}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-limits-colimits}
...
is not needed, see Lemma \ref{modules-lemma-limits-colimits} above.
\end{proof}
...
\source{stacks:01AM}
\href{https://stacks.math.columbia.edu/tag/01AM}{\texttt{Stacks tag 01AM}}
\group{modules}
...
\source{stacks:01AN}
\href{https://stacks.math.columbia.edu/tag/01AN}{\texttt{Stacks tag 01AN}}
\group{modules}
...
\begin{lemma}[The tensor product of globally generated sheaves of modules is globally generated.]
\label{modules-lemma-tensor-product-globally-generated}
\source{stacks:01AO}
\href{https://stacks.math.columbia.edu/tag/01AO}{\texttt{Stacks tag 01AO}}
\group{modules}
...
\begin{lemma}[Generated by local sections]
\label{modules-lemma-generated-by-local-sections}
\source{stacks:01AP}
\href{https://stacks.math.columbia.edu/tag/01AP}{\texttt{Stacks tag 01AP}}
\group{modules}
...
\begin{definition}[Generated by local sections]
\label{modules-definition-generated-by-local-sections}
\source{stacks:01AQ}
\href{https://stacks.math.columbia.edu/tag/01AQ}{\texttt{Stacks tag 01AQ}}
\group{modules}

\uses{modules-lemma-generated-by-local-sections}
Let $(X, \mathcal{O}_X)$ be a ringed space.
Let $\mathcal{F}$ be a sheaf of $\mathcal{O}_X$-modules.
Given a set $I$, and
local sections $s_i$, $i \in I$ of $\mathcal{F}$
we say that the subsheaf $\mathcal{G}$ of
Lemma \ref{modules-lemma-generated-by-local-sections}
above is the {\it subsheaf generated by the $s_i$}.
\end{definition}

\begin{lemma}[Generated by local sections stalk]
\label{modules-lemma-generated-by-local-sections-stalk}
\source{stacks:01AR}
\href{https://stacks.math.columbia.edu/tag/01AR}{\texttt{Stacks tag 01AR}}
\group{modules}
...
in the proof of Lemma \ref{modules-lemma-generated-by-local-sections}.
\end{proof}
...
\source{stacks:01AT}
\href{https://stacks.math.columbia.edu/tag/01AT}{\texttt{Stacks tag 01AT}}
\group{modules}
...
\source{stacks:01AU}
\href{https://stacks.math.columbia.edu/tag/01AU}{\texttt{Stacks tag 01AU}}
\group{modules}
...
\source{stacks:01AV}
\href{https://stacks.math.columbia.edu/tag/01AV}{\texttt{Stacks tag 01AV}}
\group{modules}
...
\begin{lemma}[I star exact]
\label{modules-lemma-i-star-exact}
\source{stacks:01AX}
\href{https://stacks.math.columbia.edu/tag/01AX}{\texttt{Stacks tag 01AX}}
\group{modules}
...
and Lemma \ref{modules-lemma-abelian}. The rest was shown in
...
\begin{remark}[Sections support in closed]
\label{modules-remark-sections-support-in-closed}
\source{stacks:01AY}
\href{https://stacks.math.columbia.edu/tag/01AY}{\texttt{Stacks tag 01AY}}
\group{modules}

\uses{modules-lemma-i-star-exact, modules-lemma-support-section-closed}
Let $X$ be a topological space. Let $Z \subset X$ be a closed subset.
...
contained in $Z$. By Lemma \ref{modules-lemma-i-star-exact} we may (and we do)
...
Lemma \ref{modules-lemma-support-section-closed}.
\end{remark}

This seems like a good opportunity to show that the functor
$i_*$ has a right adjoint on abelian sheaves.

\begin{lemma}[I star right adjoint]
\label{modules-lemma-i-star-right-adjoint}
\source{stacks:01AZ}
\href{https://stacks.math.columbia.edu/tag/01AZ}{\texttt{Stacks tag 01AZ}}
\group{modules}

\uses{modules-remark-sections-support-in-closed}
...
Remark \ref{modules-remark-sections-support-in-closed}
...
\begin{remark}[I star right adjoint]
\label{modules-remark-i-star-right-adjoint}
\source{stacks:01B0}
\href{https://stacks.math.columbia.edu/tag/01B0}{\texttt{Stacks tag 01B0}}
\group{modules}
...
\begin{lemma}[Canonical exact sequence]
\label{modules-lemma-canonical-exact-sequence}
\source{stacks:02UT}
\href{https://stacks.math.columbia.edu/tag/02UT}{\texttt{Stacks tag 02UT}}
\group{modules}
...
$$
\begin{array}{ccccc}0 \longrightarrow & j_{!}j^{-1}\mathcal{F} \longrightarrow\downarrow & \mathcal{F} \longrightarrow\downarrow & i_*i^{-1}\mathcal{F} \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & j_{!}j^{-1}\mathcal{G} \longrightarrow & \mathcal{G} \longrightarrow & i_*i^{-1}\mathcal{G} \longrightarrow & 0\end{array}
$$
\end{lemma}
...
We may check exactness on stalks (Lemma \ref{modules-lemma-abelian}).
...
\begin{definition}[Locally generated]
\label{modules-definition-locally-generated}
\source{stacks:01B2}
\href{https://stacks.math.columbia.edu/tag/01B2}{\texttt{Stacks tag 01B2}}
\group{modules}
...
\begin{lemma}[Pullback locally generated]
\label{modules-lemma-pullback-locally-generated}
\source{stacks:01B3}
\href{https://stacks.math.columbia.edu/tag/01B3}{\texttt{Stacks tag 01B3}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-exactness-pushforward-pullback}

Given an open subspace $V$ of $Y$ we may
consider the commutative diagram of ringed spaces
$$
\begin{array}{cc}(f^{-1}V, \mathcal{O}_{f^{-1}V}) \underset{j'}{\longrightarrow}\underset{f'}{\downarrow} & (X, \mathcal{O}_X) \overset{f}{\downarrow} \\ (V, \mathcal{O}_V) \overset{j}{\longrightarrow} & (Y, \mathcal{O}_Y)\end{array}
$$
...
and is right exact, see Lemma \ref{modules-lemma-exactness-pushforward-pullback}.
...
\source{stacks:01B5}
\href{https://stacks.math.columbia.edu/tag/01B5}{\texttt{Stacks tag 01B5}}
\group{modules}
...
\begin{lemma}[Pullback finite type]
\label{modules-lemma-pullback-finite-type}
\source{stacks:01B6}
\href{https://stacks.math.columbia.edu/tag/01B6}{\texttt{Stacks tag 01B6}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-pullback-locally-generated, modules-lemma-exactness-pushforward-pullback}

Arguing as in the proof of Lemma \ref{modules-lemma-pullback-locally-generated}
...
\begin{lemma}[Extension finite type]
\label{modules-lemma-extension-finite-type}
\source{stacks:01B7}
\href{https://stacks.math.columbia.edu/tag/01B7}{\texttt{Stacks tag 01B7}}
\group{modules}
...
\begin{lemma}[Finite type surjective on stalk]
\label{modules-lemma-finite-type-surjective-on-stalk}
\source{stacks:01B8}
\href{https://stacks.math.columbia.edu/tag/01B8}{\texttt{Stacks tag 01B8}}
\group{modules}
...
\begin{lemma}[Finite type stalk zero]
\label{modules-lemma-finite-type-stalk-zero}
\source{stacks:01B9}
\href{https://stacks.math.columbia.edu/tag/01B9}{\texttt{Stacks tag 01B9}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-finite-type-surjective-on-stalk}

This is a special case of
Lemma \ref{modules-lemma-finite-type-surjective-on-stalk}
applied to the morphism $0 \to \mathcal{F}$.
\end{proof}

\begin{lemma}[Over any ringed space, sheaves of modules of finite type have closed support.]
\label{modules-lemma-support-finite-type-closed}
\source{stacks:01BA}
\href{https://stacks.math.columbia.edu/tag/01BA}{\texttt{Stacks tag 01BA}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-finite-type-stalk-zero}

This is a reformulation of Lemma \ref{modules-lemma-finite-type-stalk-zero}.
\end{proof}

\begin{lemma}[Finite type quasi compact colimit]
\label{modules-lemma-finite-type-quasi-compact-colimit}
\source{stacks:01BB}
\href{https://stacks.math.columbia.edu/tag/01BB}{\texttt{Stacks tag 01BB}}
\group{modules}
...
\begin{lemma}[Set isomorphism classes finite type modules]
\label{modules-lemma-set-isomorphism-classes-finite-type-modules}
\source{stacks:01BC}
\href{https://stacks.math.columbia.edu/tag/01BC}{\texttt{Stacks tag 01BC}}
\group{modules}
...
\begin{definition}[Quasi coherent]
\label{modules-definition-quasi-coherent}
\source{stacks:01BE}
\href{https://stacks.math.columbia.edu/tag/01BE}{\texttt{Stacks tag 01BE}}
\group{modules}
...
\begin{lemma}[Direct sum quasi coherent]
\label{modules-lemma-direct-sum-quasi-coherent}
\source{stacks:01BF}
\href{https://stacks.math.columbia.edu/tag/01BF}{\texttt{Stacks tag 01BF}}
\group{modules}
...
\begin{remark}[Infinite direct sum quasi coherent not]
\label{modules-remark-infinite-direct-sum-quasi-coherent-not}
\source{stacks:02CF}
\href{https://stacks.math.columbia.edu/tag/02CF}{\texttt{Stacks tag 02CF}}
\group{modules}

\uses{modules-example-quasi-coherent}
...
modules see Example \ref{modules-example-quasi-coherent}.
\end{remark}

\begin{lemma}[Pullback quasi coherent]
\label{modules-lemma-pullback-quasi-coherent}
\source{stacks:01BG}
\href{https://stacks.math.columbia.edu/tag/01BG}{\texttt{Stacks tag 01BG}}
\group{modules}
...
\begin{lemma}[Construct quasi coherent sheaves]
\label{modules-lemma-construct-quasi-coherent-sheaves}
\source{stacks:01BH}
\href{https://stacks.math.columbia.edu/tag/01BH}{\texttt{Stacks tag 01BH}}
\group{modules}
...
direct sums, see Lemma \ref{modules-lemma-exactness-pushforward-pullback},
...
\begin{definition}[Sheaf associated]
\label{modules-definition-sheaf-associated}
\source{stacks:01BI}
\href{https://stacks.math.columbia.edu/tag/01BI}{\texttt{Stacks tag 01BI}}
\group{modules}

\uses{modules-lemma-construct-quasi-coherent-sheaves}
In the situation of Lemma \ref{modules-lemma-construct-quasi-coherent-sheaves}
...
\begin{lemma}[Restrict quasi coherent]
\label{modules-lemma-restrict-quasi-coherent}
\source{stacks:01BJ}
\href{https://stacks.math.columbia.edu/tag/01BJ}{\texttt{Stacks tag 01BJ}}
\group{modules}
...
of $\mathcal{F}_M$ in Lemma \ref{modules-lemma-construct-quasi-coherent-sheaves}
as $\pi^*M$, and the following commutative diagram
of ringed spaces
$$
\begin{array}{cc}(Y, \mathcal{O}_Y) \underset{\pi}{\longrightarrow}\underset{g}{\downarrow} & (\{*\}, \Gamma(Y, \mathcal{O}_Y)) \overset{\text{induced by }g^\sharp}{\downarrow} \\ (X, \mathcal{O}_X) \overset{\pi}{\longrightarrow} & (\{*\}, \Gamma(X, \mathcal{O}_X))\end{array}
$$
(Also use Sheaves, Lemma \ref{sheaves-lemma-push-pull-composition-modules}.)
\end{proof}

\begin{lemma}[Quasi coherent module]
\label{modules-lemma-quasi-coherent-module}
\source{stacks:01BK}
\href{https://stacks.math.columbia.edu/tag/01BK}{\texttt{Stacks tag 01BK}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-section-direct-sum-quasi-compact, modules-lemma-limits-colimits, modules-lemma-construct-quasi-coherent-sheaves}
...
Lemma \ref{modules-lemma-section-direct-sum-quasi-compact}.
...
By Lemma \ref{modules-lemma-limits-colimits}
...
Lemma \ref{modules-lemma-construct-quasi-coherent-sheaves} we see that
...
\source{stacks:01BL}
\href{https://stacks.math.columbia.edu/tag/01BL}{\texttt{Stacks tag 01BL}}
\group{modules}

\uses{modules-lemma-quasi-coherent-module}
...
a ``matrix'' as in the proof of Lemma \ref{modules-lemma-quasi-coherent-module} above.
...
\ref{modules-lemma-quasi-coherent-module} shows this cannot happen
if $N$ is free).
\end{example}
...
\source{stacks:01BN}
\href{https://stacks.math.columbia.edu/tag/01BN}{\texttt{Stacks tag 01BN}}
\group{modules}
...
\begin{lemma}[Finite presentation quasi coherent]
\label{modules-lemma-finite-presentation-quasi-coherent}
\source{stacks:01BO}
\href{https://stacks.math.columbia.edu/tag/01BO}{\texttt{Stacks tag 01BO}}
\group{modules}
...
\source{stacks:0H96}
\href{https://stacks.math.columbia.edu/tag/0H96}{\texttt{Stacks tag 0H96}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-extension-finite-type}
...
$\mathcal{G}$ is finite type. By Lemma \ref{modules-lemma-extension-finite-type},
$\mathcal{N}$ is finite type. Thus
$\Coker(\varphi) = \mathcal{O}_X^{\oplus n} / \mathcal{N}$
is finitely presented.
\end{proof}

\begin{lemma}[Kernel surjection finite free onto finite presentation]
\label{modules-lemma-kernel-surjection-finite-free-onto-finite-presentation}
\source{stacks:01BP}
\href{https://stacks.math.columbia.edu/tag/01BP}{\texttt{Stacks tag 01BP}}
\group{modules}
...
\begin{lemma}[Pullback finite presentation]
\label{modules-lemma-pullback-finite-presentation}
\source{stacks:01BQ}
\href{https://stacks.math.columbia.edu/tag/01BQ}{\texttt{Stacks tag 01BQ}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-pullback-quasi-coherent}

Exactly the same as the proof of Lemma \ref{modules-lemma-pullback-quasi-coherent}
but with finite index sets.
\end{proof}

\begin{lemma}[Quasi coherent limit finite presentation]
\label{modules-lemma-quasi-coherent-limit-finite-presentation}
\source{stacks:01BR}
\href{https://stacks.math.columbia.edu/tag/01BR}{\texttt{Stacks tag 01BR}}
\group{modules}
...
Lemma \ref{modules-lemma-construct-quasi-coherent-sheaves}
...
\begin{lemma}[Finite presentation stalk free]
\label{modules-lemma-finite-presentation-stalk-free}
\source{stacks:0B8J}
\href{https://stacks.math.columbia.edu/tag/0B8J}{\texttt{Stacks tag 0B8J}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-finite-type-surjective-on-stalk, modules-lemma-kernel-surjection-finite-free-onto-finite-presentation, modules-lemma-finite-type-stalk-zero}
...
(Lemma \ref{modules-lemma-finite-type-surjective-on-stalk}).
By Lemma \ref{modules-lemma-kernel-surjection-finite-free-onto-finite-presentation}
we see that $\Ker(\psi)$ is of finite type.
Then $\Ker(\psi)_x = 0$ implies that $\Ker(\psi)$ becomes zero
after shrinking $U$ once more (Lemma \ref{modules-lemma-finite-type-stalk-zero}).
\end{proof}
...
\source{stacks:01BV}
\href{https://stacks.math.columbia.edu/tag/01BV}{\texttt{Stacks tag 01BV}}
\group{modules}
...
\begin{lemma}[Coherent finite presentation]
\label{modules-lemma-coherent-finite-presentation}
\source{stacks:01BW}
\href{https://stacks.math.columbia.edu/tag/01BW}{\texttt{Stacks tag 01BW}}
\group{modules}
...
\begin{example}[Coherent not Noetherian]
\label{modules-example-coherent-not-Noetherian}
\source{stacks:01BX}
\href{https://stacks.math.columbia.edu/tag/01BX}{\texttt{Stacks tag 01BX}}
\group{modules}
...
\begin{lemma}[Coherent abelian]
\label{modules-lemma-coherent-abelian}
\source{stacks:01BY}
\href{https://stacks.math.columbia.edu/tag/01BY}{\texttt{Stacks tag 01BY}}
\group{modules}
...
\begin{proof}
\uses{modules-definition-coherent, modules-lemma-extension-finite-type}

Condition (2) of Definition \ref{modules-definition-coherent}
...
By Definition \ref{modules-definition-coherent} the kernel $\mathcal{K}$
of the induced map
...
$$
\begin{array}{ccccc}0 \longrightarrow & \bigoplus_{j = 1}^m \mathcal{O}_U \underset{\Phi}{\downarrow}\longrightarrow & \bigoplus_{j = 1}^m \mathcal{O}_U \oplus
\bigoplus_{i = 1}^n \mathcal{O}_U \underset{\Psi}{\downarrow}\longrightarrow & \bigoplus_{i = 1}^n \mathcal{O}_U \underset{\overline{\Psi}}{\downarrow}\longrightarrow & 0 \\ 0 \longrightarrow & \Im(\varphi) \longrightarrow & \mathcal{G} \longrightarrow & \Coker(\varphi) \longrightarrow & 0\end{array}
$$
...
so is $\mathcal{F}_2$. By Lemma \ref{modules-lemma-extension-finite-type} we
...
Consider the following commutative diagram
$$
\begin{array}{ccccc}0 \longrightarrow & 0 \longrightarrow\downarrow & \bigoplus_{i = 1}^{n} \mathcal{O}_U \longrightarrow\downarrow & \bigoplus_{i = 1}^{n} \mathcal{O}_U \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & \mathcal{F}_1 \longrightarrow & \mathcal{F}_2 \longrightarrow & \mathcal{F}_3 \longrightarrow & 0\end{array}
$$
...
\begin{lemma}[Coherent structure sheaf]
\label{modules-lemma-coherent-structure-sheaf}
\source{stacks:01BZ}
\href{https://stacks.math.columbia.edu/tag/01BZ}{\texttt{Stacks tag 01BZ}}
\group{modules}
...
\begin{lemma}[Finite type to coherent injective on stalk]
\label{modules-lemma-finite-type-to-coherent-injective-on-stalk}
\source{stacks:01C0}
\href{https://stacks.math.columbia.edu/tag/01C0}{\texttt{Stacks tag 01C0}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-coherent-abelian, modules-lemma-finite-type-stalk-zero}

Denote $\mathcal{K} \subset \mathcal{G}$ the kernel of $\varphi$.
By Lemma \ref{modules-lemma-coherent-abelian} we see that $\mathcal{K}$ is
a finite type $\mathcal{O}_X$-module. Our assumption is that
$\mathcal{K}_x = 0$. By Lemma \ref{modules-lemma-finite-type-stalk-zero}
...
\source{stacks:01C2}
\href{https://stacks.math.columbia.edu/tag/01C2}{\texttt{Stacks tag 01C2}}
\group{modules}
...
\begin{lemma}[I star quasi coherent]
\label{modules-lemma-i-star-quasi-coherent}
\source{stacks:01C3}
\href{https://stacks.math.columbia.edu/tag/01C3}{\texttt{Stacks tag 01C3}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-i-star-right-adjoint}
...
see Lemma \ref{modules-lemma-i-star-right-adjoint}. Some details omitted.
\end{proof}

\begin{lemma}[I star reflects finite type]
\label{modules-lemma-i-star-reflects-finite-type}
\source{stacks:01C4}
\href{https://stacks.math.columbia.edu/tag/01C4}{\texttt{Stacks tag 01C4}}
\group{modules}
...
\source{stacks:08KS}
\href{https://stacks.math.columbia.edu/tag/08KS}{\texttt{Stacks tag 08KS}}
\group{modules}
...
\begin{remark}[Sections support in closed modules]
\label{modules-remark-sections-support-in-closed-modules}
\source{stacks:0G6N}
\href{https://stacks.math.columbia.edu/tag/0G6N}{\texttt{Stacks tag 0G6N}}
\group{modules}

\uses{modules-lemma-i-star-equivalence, modules-lemma-support-section-closed, modules-remark-sections-support-in-closed}
...
contained in $Z$.
Applying Lemma \ref{modules-lemma-i-star-equivalence} to
...
\begin{lemma}[Adjoint section with support]
\label{modules-lemma-adjoint-section-with-support}
\source{stacks:0G6P}
\href{https://stacks.math.columbia.edu/tag/0G6P}{\texttt{Stacks tag 0G6P}}
\group{modules}

\uses{modules-remark-sections-support-in-closed-modules}
...
Remark \ref{modules-remark-sections-support-in-closed-modules}
is right adjoint to
...
\source{stacks:01C6}
\href{https://stacks.math.columbia.edu/tag/01C6}{\texttt{Stacks tag 01C6}}
\group{modules}
...
\begin{lemma}[Locally free quasi coherent]
\label{modules-lemma-locally-free-quasi-coherent}
\source{stacks:01C7}
\href{https://stacks.math.columbia.edu/tag/01C7}{\texttt{Stacks tag 01C7}}
\group{modules}
...
\begin{lemma}[Pullback locally free]
\label{modules-lemma-pullback-locally-free}
\source{stacks:01C8}
\href{https://stacks.math.columbia.edu/tag/01C8}{\texttt{Stacks tag 01C8}}
\group{modules}
...
\source{stacks:01C9}
\href{https://stacks.math.columbia.edu/tag/01C9}{\texttt{Stacks tag 01C9}}
\group{modules}
...
\begin{lemma}[Map finite locally free]
\label{modules-lemma-map-finite-locally-free}
\source{stacks:089Q}
\href{https://stacks.math.columbia.edu/tag/089Q}{\texttt{Stacks tag 089Q}}
\group{modules}
...
\begin{lemma}[Direct summand of locally free is locally free]
\label{modules-lemma-direct-summand-of-locally-free-is-locally-free}
\source{stacks:0BCI}
\href{https://stacks.math.columbia.edu/tag/0BCI}{\texttt{Stacks tag 0BCI}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-finite-presentation-stalk-free}
...
By Lemma \ref{modules-lemma-finite-presentation-stalk-free}
...
of the diagram
$$
\begin{array}{cccc}\mathcal{F} \times \mathcal{F} \times \mathcal{G}
\underset{(f \circ \text{pr}_{13}, f \circ \text{pr}_{23})}{\longrightarrow}\underset{(+ \circ \text{pr}_{12}, \text{pr}_3)}{\downarrow} &  &  & \mathcal{H} \times \mathcal{H}
\overset{+}{\downarrow} \\ \mathcal{F} \times \mathcal{G} \overset{f}{\longrightarrow} &  &  & \mathcal{H}\end{array}
$$
...
of $\mathcal{O}_X$-modules as defined in Section \ref{modules-section-bilinear}.
...
\begin{lemma}[Stalk tensor product]
\label{modules-lemma-stalk-tensor-product}
\source{stacks:01CB}
\href{https://stacks.math.columbia.edu/tag/01CB}{\texttt{Stacks tag 01CB}}
\group{modules}
...
\begin{lemma}[Tensor product sheafification]
\label{modules-lemma-tensor-product-sheafification}
\source{stacks:05NA}
\href{https://stacks.math.columbia.edu/tag/05NA}{\texttt{Stacks tag 05NA}}
\group{modules}
...
\source{stacks:01CC}
\href{https://stacks.math.columbia.edu/tag/01CC}{\texttt{Stacks tag 01CC}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-abelian, modules-lemma-stalk-tensor-product}

This follows from the fact that exactness may be checked at stalks
(Lemma \ref{modules-lemma-abelian}), the description of stalks
(Lemma \ref{modules-lemma-stalk-tensor-product}) and the corresponding
...
\source{stacks:01CD}
\href{https://stacks.math.columbia.edu/tag/01CD}{\texttt{Stacks tag 01CD}}
\group{modules}
...
\source{stacks:05NB}
\href{https://stacks.math.columbia.edu/tag/05NB}{\texttt{Stacks tag 05NB}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-tensor-product-sheafification, modules-lemma-limits-colimits}
...
By
Lemma \ref{modules-lemma-tensor-product-sheafification}
...
$\textit{Mod}(\mathcal{O}_X)$, see Lemma \ref{modules-lemma-limits-colimits}.
\end{proof}

\begin{lemma}[Tensor product permanence]
\label{modules-lemma-tensor-product-permanence}
\source{stacks:01CE}
\href{https://stacks.math.columbia.edu/tag/01CE}{\texttt{Stacks tag 01CE}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-tensor-product-exact, modules-lemma-tensor-commute-colimits, modules-lemma-coherent-abelian}
...
is exact, then by Lemma \ref{modules-lemma-tensor-product-exact}
the complex
$\mathcal{F}_2 \otimes_{\mathcal{O}_X} \mathcal{G} \to
\mathcal{F}_1 \otimes_{\mathcal{O}_X} \mathcal{G} \to
...
by Lemma \ref{modules-lemma-tensor-commute-colimits}).
Since finite direct sums are coherent sheaves, these are coherent
and so is the cokernel of the map, see Lemma \ref{modules-lemma-coherent-abelian}.
...
\source{stacks:05ND}
\href{https://stacks.math.columbia.edu/tag/05ND}{\texttt{Stacks tag 05ND}}
\group{modules}
...
\begin{lemma}[Flat stalks flat]
\label{modules-lemma-flat-stalks-flat}
\source{stacks:05NE}
\href{https://stacks.math.columbia.edu/tag/05NE}{\texttt{Stacks tag 05NE}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-stalk-tensor-product}
...
Lemma \ref{modules-lemma-stalk-tensor-product}.
...
\source{stacks:05NF}
\href{https://stacks.math.columbia.edu/tag/05NF}{\texttt{Stacks tag 05NF}}
\group{modules}
...
\source{stacks:0H97}
\href{https://stacks.math.columbia.edu/tag/0H97}{\texttt{Stacks tag 0H97}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-flat-stalks-flat}

Combine Lemma \ref{modules-lemma-flat-stalks-flat} with
Sheaves, Lemma \ref{sheaves-lemma-stalk-pullback-modules} and
...
\source{stacks:05NG}
\href{https://stacks.math.columbia.edu/tag/05NG}{\texttt{Stacks tag 05NG}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-tensor-commute-colimits, modules-lemma-stalk-tensor-product}

This follows from
Lemma \ref{modules-lemma-tensor-commute-colimits},
Lemma \ref{modules-lemma-stalk-tensor-product},
Algebra, Lemma \ref{algebra-lemma-directed-colimit-exact},
...
\source{stacks:05NH}
\href{https://stacks.math.columbia.edu/tag/05NH}{\texttt{Stacks tag 05NH}}
\group{modules}
...
Lemma \ref{modules-lemma-flat-stalks-flat}.
\end{proof}

\begin{lemma}[Module quotient flat]
\label{modules-lemma-module-quotient-flat}
\source{stacks:05NI}
\href{https://stacks.math.columbia.edu/tag/05NI}{\texttt{Stacks tag 05NI}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-colimits-flat, modules-lemma-j-shriek-flat}
...
\ref{modules-lemma-colimits-flat} and \ref{modules-lemma-j-shriek-flat}.
\end{proof}

\begin{lemma}[Flat tor zero]
\label{modules-lemma-flat-tor-zero}
\source{stacks:05NJ}
\href{https://stacks.math.columbia.edu/tag/05NJ}{\texttt{Stacks tag 05NJ}}
\group{modules}
...
\begin{lemma}[Kernels of epimorphisms and extensions of flat sheaves of modules over a ringed space a...]
\label{modules-lemma-flat-ses}
\source{stacks:05NK}
\href{https://stacks.math.columbia.edu/tag/05NK}{\texttt{Stacks tag 05NK}}
\group{modules}
...
\source{stacks:05NL}
\href{https://stacks.math.columbia.edu/tag/05NL}{\texttt{Stacks tag 05NL}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-flat-tor-zero, modules-lemma-flat-ses}

Follows from Lemma \ref{modules-lemma-flat-tor-zero} by splitting the complex
into short exact sequences and using Lemma \ref{modules-lemma-flat-ses} to
...
\source{stacks:08BK}
\href{https://stacks.math.columbia.edu/tag/08BK}{\texttt{Stacks tag 08BK}}
\group{modules}
...
constructed in Section \ref{modules-section-tensor-product}
...
$\mathcal{O}_X$-module.
\end{enumerate}
This is proved in Example \ref{modules-example-dual} and
Lemmas \ref{modules-lemma-left-dual-module} and
\ref{modules-lemma-flat-locally-finite-presentation} of this section.

\begin{example}[Dual]
\label{modules-example-dual}
\source{stacks:0FNV}
\href{https://stacks.math.columbia.edu/tag/0FNV}{\texttt{Stacks tag 0FNV}}
\group{modules}
...
\source{stacks:0FNW}
\href{https://stacks.math.columbia.edu/tag/0FNW}{\texttt{Stacks tag 0FNW}}
\group{modules}
...
Example \ref{modules-example-dual}.
\end{proof}

\begin{lemma}[Flat locally finite presentation]
\label{modules-lemma-flat-locally-finite-presentation}
\source{stacks:08BL}
\href{https://stacks.math.columbia.edu/tag/08BL}{\texttt{Stacks tag 08BL}}
\group{modules}
...
$$
Let $x \in X$. By Lemma \ref{modules-lemma-flat-eq}
...
\begin{lemma}[Surjection]
\label{modules-lemma-surjection}
\source{stacks:0CAH}
\href{https://stacks.math.columbia.edu/tag/0CAH}{\texttt{Stacks tag 0CAH}}
\group{modules}
...
\begin{lemma}[Filtered colimit constructibles]
\label{modules-lemma-filtered-colimit-constructibles}
\source{stacks:0CAI}
\href{https://stacks.math.columbia.edu/tag/0CAI}{\texttt{Stacks tag 0CAI}}
\group{modules}
...
\longrightarrow\longrightarrow & \coprod\nolimits_{a = 1, \ldots, n} j_{U_a!}\underline{S_a}\end{array}
\right)
\end{equation}
...
\begin{proof}
\uses{modules-lemma-surjection}

By Lemma \ref{modules-lemma-surjection} every sheaf of sets $\mathcal{F}$
...
\longrightarrow\longrightarrow & \coprod\nolimits_{a \in A} j_{U_a!}\underline{S_a}\end{array}
$$
...
\begin{lemma}[Constructible comes from finite]
\label{modules-lemma-constructible-comes-from-finite}
\source{stacks:0CAK}
\href{https://stacks.math.columbia.edu/tag/0CAK}{\texttt{Stacks tag 0CAK}}
\group{modules}
...
\longrightarrow\longrightarrow & \coprod\nolimits_{a = 1, \ldots, n} j_{U_{a, i}!}\underline{S_a}\end{array}
\right)
$$
We omit some details.
\end{proof}

\begin{lemma}[Constructible in constant]
\label{modules-lemma-constructible-in-constant}
\source{stacks:0CAL}
\href{https://stacks.math.columbia.edu/tag/0CAL}{\texttt{Stacks tag 0CAL}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-constructible-comes-from-finite}

By Lemma \ref{modules-lemma-constructible-comes-from-finite}
...
\source{stacks:02N3}
\href{https://stacks.math.columbia.edu/tag/02N3}{\texttt{Stacks tag 02N3}}
\group{modules}
...
\source{stacks:02N4}
\href{https://stacks.math.columbia.edu/tag/02N4}{\texttt{Stacks tag 02N4}}
\group{modules}
...
\begin{proof}
\uses{modules-definition-flat-morphism}
...
Definition \ref{modules-definition-flat-morphism}.
\end{proof}

\begin{definition}[Flat module]
\label{modules-definition-flat-module}
\source{stacks:08KT}
\href{https://stacks.math.columbia.edu/tag/08KT}{\texttt{Stacks tag 08KT}}
\group{modules}
...
\begin{lemma}[Pullback tensor flat module]
\label{modules-lemma-pullback-tensor-flat-module}
\source{stacks:0GMU}
\href{https://stacks.math.columbia.edu/tag/0GMU}{\texttt{Stacks tag 0GMU}}
\group{modules}
...
\medskip\noindent
The algebras $\text{T}(\mathcal{F})$, $\wedge(\mathcal{F})$, and
$\text{Sym}(\mathcal{F})$ are graded $\mathcal{O}_X$-algebras
in the sense of Differential Graded Sheaves, Definition
\ref{sdga-definition-ga}.
Moreover $\text{Sym}(\mathcal{F})$
is commutative, and $\wedge(\mathcal{F})$ is graded commutative.

\begin{lemma}[Local tensor algebra]
\label{modules-lemma-local-tensor-algebra}
\source{stacks:01CG}
\href{https://stacks.math.columbia.edu/tag/01CG}{\texttt{Stacks tag 01CG}}
\group{modules}
...
\begin{lemma}[Stalk tensor algebra]
\label{modules-lemma-stalk-tensor-algebra}
\source{stacks:01CH}
\href{https://stacks.math.columbia.edu/tag/01CH}{\texttt{Stacks tag 01CH}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-local-tensor-algebra}

Clear from Lemma \ref{modules-lemma-local-tensor-algebra} above, and
Algebra, Lemma \ref{algebra-lemma-colimit-tensor-algebra}.
\end{proof}

\begin{lemma}[Pullback tensor algebra]
\label{modules-lemma-pullback-tensor-algebra}
\source{stacks:01CI}
\href{https://stacks.math.columbia.edu/tag/01CI}{\texttt{Stacks tag 01CI}}
\group{modules}
...
\begin{lemma}[Presentation sym exterior]
\label{modules-lemma-presentation-sym-exterior}
\source{stacks:01CJ}
\href{https://stacks.math.columbia.edu/tag/01CJ}{\texttt{Stacks tag 01CJ}}
\group{modules}
...
\begin{lemma}[Tensor algebra permanence]
\label{modules-lemma-tensor-algebra-permanence}
\source{stacks:01CK}
\href{https://stacks.math.columbia.edu/tag/01CK}{\texttt{Stacks tag 01CK}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-tensor-product-permanence, modules-lemma-presentation-sym-exterior, modules-lemma-local-tensor-algebra, modules-lemma-coherent-abelian}

These statements for $\text{T}^n(\mathcal{F})$ follow
from Lemma \ref{modules-lemma-tensor-product-permanence}.
...
Lemma \ref{modules-lemma-presentation-sym-exterior} above.
...
Lemma \ref{modules-lemma-tensor-product-permanence}.
...
combined with Lemma \ref{modules-lemma-local-tensor-algebra} above
...
subsheaf of $\text{T}^n(\mathcal{F})$, see Lemma \ref{modules-lemma-coherent-abelian}.
By that same lemma we conclude that $\text{Sym}^n(\mathcal{F})$ is
coherent.
\end{proof}

\begin{lemma}[Whole tensor algebra permanence]
\label{modules-lemma-whole-tensor-algebra-permanence}
\source{stacks:01CL}
\href{https://stacks.math.columbia.edu/tag/01CL}{\texttt{Stacks tag 01CL}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-tensor-algebra-permanence}
...
proof of Lemma \ref{modules-lemma-tensor-algebra-permanence} we saw that
...
\source{stacks:01CN}
\href{https://stacks.math.columbia.edu/tag/01CN}{\texttt{Stacks tag 01CN}}
\group{modules}
...
\source{stacks:01CO}
\href{https://stacks.math.columbia.edu/tag/01CO}{\texttt{Stacks tag 01CO}}
\group{modules}
...
\begin{lemma}[Adjoint tensor restrict]
\label{modules-lemma-adjoint-tensor-restrict}
\source{stacks:0A6F}
\href{https://stacks.math.columbia.edu/tag/0A6F}{\texttt{Stacks tag 0A6F}}
\group{modules}
...
\source{stacks:01CP}
\href{https://stacks.math.columbia.edu/tag/01CP}{\texttt{Stacks tag 01CP}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-internal-hom-exact}
...
0.
$$
By Lemma \ref{modules-lemma-internal-hom-exact} this gives an exact sequence
$
0 \to
\SheafHom_{\mathcal{O}_X}(\mathcal{F}, \mathcal{G}) \to
...
\source{stacks:0C6I}
\href{https://stacks.math.columbia.edu/tag/0C6I}{\texttt{Stacks tag 0C6I}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-pullback-finite-presentation, modules-lemma-stalk-internal-hom}

Note that $f^*\mathcal{F}$ is also finitely presented
(Lemma \ref{modules-lemma-pullback-finite-presentation}).
Let $x \in X$ map to $y \in Y$. Looking at the stalks
at $x$ we get an isomorphism by
Lemma \ref{modules-lemma-stalk-internal-hom} and
...
in the proof of Lemma \ref{modules-lemma-stalk-internal-hom}.
\end{proof}

\begin{lemma}[Internal hom locally kernel direct sum]
\label{modules-lemma-internal-hom-locally-kernel-direct-sum}
\source{stacks:01CQ}
\href{https://stacks.math.columbia.edu/tag/01CQ}{\texttt{Stacks tag 01CQ}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-stalk-internal-hom, modules-lemma-coherent-abelian}

The first assertion
we saw in the proof of Lemma \ref{modules-lemma-stalk-internal-hom}.
And the result for coherent sheaves then follows from
Lemma \ref{modules-lemma-coherent-abelian}.
\end{proof}

\begin{lemma}[Hom finite presentation colimit]
\label{modules-lemma-hom-finite-presentation-colimit}
\source{stacks:0GMV}
\href{https://stacks.math.columbia.edu/tag/0GMV}{\texttt{Stacks tag 0GMV}}
\group{modules}
...
is the identity functor. By this and by Lemma \ref{modules-lemma-internal-hom-exact}
...
$$
\begin{array}{cccc}0 \longrightarrow & \colim_\lambda \SheafHom_{\mathcal{O}_X}(\mathcal{F}, \mathcal{G}_\lambda)
...
\source{stacks:01BS}
\href{https://stacks.math.columbia.edu/tag/01BS}{\texttt{Stacks tag 01BS}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-hom-finite-presentation-colimit}
...
$$
by construction. By Lemma \ref{modules-lemma-hom-finite-presentation-colimit} we have
$\mathcal{H} = \colim \mathcal{H}_i$. Thus the lemma follows from
Sheaves, Lemma \ref{sheaves-lemma-directed-colimits-sections}.
\end{proof}

\begin{remark}[Condition necessary]
\label{modules-remark-condition-necessary}
\source{stacks:01BT}
\href{https://stacks.math.columbia.edu/tag/01BT}{\texttt{Stacks tag 01BT}}
\group{modules}
...
\begin{definition}[Annihilator sheaf]
\label{modules-definition-annihilator-sheaf}
\source{stacks:0H2H}
\href{https://stacks.math.columbia.edu/tag/0H2H}{\texttt{Stacks tag 0H2H}}
\group{modules}
...
\begin{lemma}[Finite type annihilator stalk]
\label{modules-lemma-finite-type-annihilator-stalk}
\source{stacks:0H2J}
\href{https://stacks.math.columbia.edu/tag/0H2J}{\texttt{Stacks tag 0H2J}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-stalk-internal-hom}

By Lemma \ref{modules-lemma-stalk-internal-hom} the map
$$
...
\begin{lemma}[Induced quotient ring sheaf module structure]
\label{modules-lemma-induced-quotient-ring-sheaf-module-structure}
\source{stacks:0H2K}
\href{https://stacks.math.columbia.edu/tag/0H2K}{\texttt{Stacks tag 0H2K}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-internal-hom}

Applying the universal property of the cokernel of the inclusion
$\mathcal{I} \to \mathcal{O}_X$, we obtain a commutative diagram
$$
\begin{array}{cc}\mathcal{O}_X \longrightarrow\downarrow & \SheafHom_{\mathcal{O}_X}(\mathcal{F}, \mathcal{F}) \\ \mathcal{O}_X/\mathcal{I} \nearrow & \end{array}
$$
of $\mathcal{O}_X$-modules. By Lemma \ref{modules-lemma-internal-hom}
...
\begin{lemma}[Coherent annihilator]
\label{modules-lemma-coherent-annihilator}
\source{stacks:0H2L}
\href{https://stacks.math.columbia.edu/tag/0H2L}{\texttt{Stacks tag 0H2L}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-coherent-abelian, modules-lemma-internal-hom-locally-kernel-direct-sum, modules-lemma-coherent-finite-presentation}

Since $\text{Ann}_{\mathcal{O}_X}(\mathcal{F})$ is the kernel of
$\mathcal{O}_X \to \SheafHom_{\mathcal{O}_X}(\mathcal{F}, \mathcal{F})$
by Lemma \ref{modules-lemma-coherent-abelian} it suffices
to show that $\SheafHom_{\mathcal{O}_X}(\mathcal{F}, \mathcal{F})$ is
coherent. This follows from
Lemma \ref{modules-lemma-internal-hom-locally-kernel-direct-sum}
and the fact that $\mathcal{F}$ is coherent and a fortiori finitely presented
(Lemma \ref{modules-lemma-coherent-finite-presentation}).
\end{proof}
...
\begin{definition}[Koszul]
\label{modules-definition-koszul}
\source{stacks:062K}
\href{https://stacks.math.columbia.edu/tag/062K}{\texttt{Stacks tag 062K}}
\group{modules}
...
\source{stacks:062L}
\href{https://stacks.math.columbia.edu/tag/062L}{\texttt{Stacks tag 062L}}
\group{modules}
...
\source{stacks:01CS}
\href{https://stacks.math.columbia.edu/tag/01CS}{\texttt{Stacks tag 01CS}}
\group{modules}
...
Lemma \ref{modules-lemma-invertible-is-locally-free-rank-1}
...
\source{stacks:0B8K}
\href{https://stacks.math.columbia.edu/tag/0B8K}{\texttt{Stacks tag 0B8K}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-stalk-internal-hom, modules-lemma-stalk-tensor-product}
...
$\mathcal{O}_X$-module
we can use Lemma \ref{modules-lemma-stalk-internal-hom}
...
\mathcal{O}_{X, x}$ (Lemma \ref{modules-lemma-stalk-tensor-product})
...
\source{stacks:0B8L}
\href{https://stacks.math.columbia.edu/tag/0B8L}{\texttt{Stacks tag 0B8L}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-invertible, modules-lemma-tensor-product-pullback}

By Lemma \ref{modules-lemma-invertible}
...
by Lemma \ref{modules-lemma-tensor-product-pullback}.
Thus $f^*\mathcal{L}$ is invertible by Lemma \ref{modules-lemma-invertible}.
\end{proof}

\begin{lemma}[Invertible is locally free rank 1]
\label{modules-lemma-invertible-is-locally-free-rank-1}
\source{stacks:0B8M}
\href{https://stacks.math.columbia.edu/tag/0B8M}{\texttt{Stacks tag 0B8M}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-invertible, modules-lemma-finite-presentation-stalk-free}
...
invertible. In the proof of Lemma \ref{modules-lemma-invertible}
...
Lemma \ref{modules-lemma-invertible} we conclude that $\mathcal{L}$
is locally free of rank $1$ by
Lemma \ref{modules-lemma-finite-presentation-stalk-free}.
\end{proof}

\begin{lemma}[Constructions invertible]
\label{modules-lemma-constructions-invertible}
\source{stacks:01CT}
\href{https://stacks.math.columbia.edu/tag/01CT}{\texttt{Stacks tag 01CT}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-invertible}

Part (1) is clear from the definition and part (2) follows from
Lemma \ref{modules-lemma-invertible} and its proof.
\end{proof}

\begin{definition}[Powers]
\label{modules-definition-powers}
\source{stacks:01CU}
\href{https://stacks.math.columbia.edu/tag/01CU}{\texttt{Stacks tag 01CU}}
\group{modules}
...
\right.
$$
see Lemma \ref{modules-lemma-constructions-invertible}.
...
\begin{definition}[Gamma star]
\label{modules-definition-gamma-star}
\source{stacks:01CV}
\href{https://stacks.math.columbia.edu/tag/01CV}{\texttt{Stacks tag 01CV}}
\group{modules}
...
(Lemma \ref{modules-lemma-pullback-invertible})
...
\source{stacks:01CW}
\href{https://stacks.math.columbia.edu/tag/01CW}{\texttt{Stacks tag 01CW}}
\group{modules}
...
Lemma \ref{modules-lemma-invertible}.
...
Lemma \ref{modules-lemma-constructions-invertible} says that
...
\source{stacks:01CX}
\href{https://stacks.math.columbia.edu/tag/01CX}{\texttt{Stacks tag 01CX}}
\group{modules}
...
\begin{lemma}[A (local) trivialisation of a linebundle is the same as a (local) nonvanishing section.]
\label{modules-lemma-s-open}
\source{stacks:01CY}
\href{https://stacks.math.columbia.edu/tag/01CY}{\texttt{Stacks tag 01CY}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-constructions-invertible}
...
\mathcal{O}_{X, x}
$$
by Lemma \ref{modules-lemma-constructions-invertible}.
...
\begin{remark}[Pullback s open]
\label{modules-remark-pullback-s-open}
\source{stacks:0H78}
\href{https://stacks.math.columbia.edu/tag/0H78}{\texttt{Stacks tag 0H78}}
\group{modules}
...
$$
See Lemma \ref{modules-lemma-rank}. By definition of locally free
...
conditions to check. By Lemma \ref{modules-lemma-det-ses} below
...
\source{stacks:0B38}
\href{https://stacks.math.columbia.edu/tag/0B38}{\texttt{Stacks tag 0B38}}
\group{modules}
...
finite presentation, see Lemma \ref{modules-lemma-flat-locally-finite-presentation}.
If all the stalks $\mathcal{O}_{X, x}$ are local, then such a module
$\mathcal{F}$ is finite locally free, see
Lemma \ref{modules-lemma-direct-summand-of-locally-free-is-locally-free}.
...
Definition \ref{modules-definition-invertible} (not necessarily locally
...
\begin{lemma}[Determinant as socle]
\label{modules-lemma-determinant-as-socle}
\source{stacks:0FJN}
\href{https://stacks.math.columbia.edu/tag/0FJN}{\texttt{Stacks tag 0FJN}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-flat-locally-finite-presentation, modules-lemma-construct-quasi-coherent-sheaves}

To prove this we may work locally on $X$. Hence we may assume $\mathcal{F}$
is a direct summand of a finite free module, see
Lemma \ref{modules-lemma-flat-locally-finite-presentation}. Say
...
\source{stacks:01D0}
\href{https://stacks.math.columbia.edu/tag/01D0}{\texttt{Stacks tag 01D0}}
\group{modules}
...
\source{stacks:01D1}
\href{https://stacks.math.columbia.edu/tag/01D1}{\texttt{Stacks tag 01D1}}
\group{modules}
...
\source{stacks:01UN}
\href{https://stacks.math.columbia.edu/tag/01UN}{\texttt{Stacks tag 01UN}}
\group{modules}
...
\source{stacks:08RM}
\href{https://stacks.math.columbia.edu/tag/08RM}{\texttt{Stacks tag 08RM}}
\group{modules}
...
\source{stacks:08RP}
\href{https://stacks.math.columbia.edu/tag/08RP}{\texttt{Stacks tag 08RP}}
\group{modules}

\uses{modules-lemma-universal-module}
Let $X$ be a topological space. Let $\varphi : \mathcal{O}_1 \to \mathcal{O}_2$
...
which exists by Lemma \ref{modules-lemma-universal-module}.
...
\source{stacks:08TD}
\href{https://stacks.math.columbia.edu/tag/08TD}{\texttt{Stacks tag 08TD}}
\group{modules}
...
\source{stacks:08RQ}
\href{https://stacks.math.columbia.edu/tag/08RQ}{\texttt{Stacks tag 08RQ}}
\group{modules}
...
\source{stacks:08RR}
\href{https://stacks.math.columbia.edu/tag/08RR}{\texttt{Stacks tag 08RR}}
\group{modules}
...
\begin{lemma}[Stalk module differentials]
\label{modules-lemma-stalk-module-differentials}
\source{stacks:08TE}
\href{https://stacks.math.columbia.edu/tag/08TE}{\texttt{Stacks tag 08TE}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-pullback-differentials, modules-lemma-differentials-sheafify}

This is a special case of Lemma \ref{modules-lemma-pullback-differentials}
for the inclusion map $\{x\} \to X$. An alternative proof is to use
Lemma \ref{modules-lemma-differentials-sheafify},
...
\source{stacks:08RS}
\href{https://stacks.math.columbia.edu/tag/08RS}{\texttt{Stacks tag 08RS}}
\group{modules}
...
\source{stacks:08TF}
\href{https://stacks.math.columbia.edu/tag/08TF}{\texttt{Stacks tag 08TF}}
\group{modules}

\uses{modules-lemma-functoriality-differentials}
In Lemma \ref{modules-lemma-functoriality-differentials} suppose that
...
\begin{proof}
\uses{modules-lemma-functoriality-differentials, modules-lemma-abelian, modules-lemma-stalk-module-differentials}
...
is the one from Lemma \ref{modules-lemma-functoriality-differentials}. To see
that the sequence is exact, we can check on stalks
(Lemma \ref{modules-lemma-abelian}). By
Lemma \ref{modules-lemma-stalk-module-differentials}
this follows from
...
\source{stacks:08RT}
\href{https://stacks.math.columbia.edu/tag/08RT}{\texttt{Stacks tag 08RT}}
\group{modules}

\uses{modules-definition-derivation}
...
Definition \ref{modules-definition-derivation}.
...
\source{stacks:01UP}
\href{https://stacks.math.columbia.edu/tag/01UP}{\texttt{Stacks tag 01UP}}
\group{modules}
...
\begin{lemma}[Functoriality differentials ringed spaces]
\label{modules-lemma-functoriality-differentials-ringed-spaces}
\source{stacks:08RU}
\href{https://stacks.math.columbia.edu/tag/08RU}{\texttt{Stacks tag 08RU}}
\group{modules}

\uses{modules-lemma-pullback-differentials, modules-lemma-functoriality-differentials}
Let
$$
\begin{array}{cc}X' \underset{h'}{\downarrow}\underset{f}{\longrightarrow} & X \overset{h}{\downarrow} \\ S' \overset{g}{\longrightarrow} & S\end{array}
$$
...
$$
\begin{array}{cc}f^{-1}\mathcal{O}_X \longrightarrow & \mathcal{O}_{X'} \\ f^{-1}h^{-1}\mathcal{O}_S \uparrow\longrightarrow & (h')^{-1}\mathcal{O}_{S'} \uparrow\end{array}
$$
induces by Lemmas \ref{modules-lemma-pullback-differentials} and
\ref{modules-lemma-functoriality-differentials}
...
\source{stacks:01UW}
\href{https://stacks.math.columbia.edu/tag/01UW}{\texttt{Stacks tag 01UW}}
\group{modules}

\uses{modules-lemma-functoriality-differentials-ringed-spaces}
Let
$$
\begin{array}{ccc}X'' \downarrow\underset{g}{\longrightarrow} & X' \downarrow\underset{f}{\longrightarrow} & X \downarrow \\ S'' \longrightarrow & S' \longrightarrow & S\end{array}
$$
be a commutative diagram of ringed spaces. With notation as in
Lemma \ref{modules-lemma-functoriality-differentials-ringed-spaces} we have
$$
...
\source{stacks:0H79}
\href{https://stacks.math.columbia.edu/tag/0H79}{\texttt{Stacks tag 0H79}}
\group{modules}
...
Lemma \ref{modules-lemma-functoriality-differentials-ringed-spaces}.
\end{lemma}

\begin{proof}
\uses{modules-lemma-stalk-module-differentials, modules-lemma-functoriality-differentials-ringed-spaces}

By taking induced maps in stalks at $x \in X$ and using
Lemma \ref{modules-lemma-stalk-module-differentials} we obtain a sequence
$$
...
\source{stacks:0G3Q}
\href{https://stacks.math.columbia.edu/tag/0G3Q}{\texttt{Stacks tag 0G3Q}}
\group{modules}
...
\source{stacks:0G3R}
\href{https://stacks.math.columbia.edu/tag/0G3R}{\texttt{Stacks tag 0G3R}}
\group{modules}
...
\source{stacks:0G3S}
\href{https://stacks.math.columbia.edu/tag/0G3S}{\texttt{Stacks tag 0G3S}}
\group{modules}
...
Lemma \ref{modules-lemma-universal-module}.
...
\source{stacks:0G3T}
\href{https://stacks.math.columbia.edu/tag/0G3T}{\texttt{Stacks tag 0G3T}}
\group{modules}

\uses{modules-lemma-module-principal-parts}
Let $X$ be a topological space.
Let $\mathcal{O}_1 \to \mathcal{O}_2$ be a map of sheaves of rings on $X$.
Let $\mathcal{F}$ be a sheaf of $\mathcal{O}_2$-modules.
The module $\mathcal{P}^k_{\mathcal{O}_2/\mathcal{O}_1}(\mathcal{F})$
constructed in Lemma \ref{modules-lemma-module-principal-parts}
...
\source{stacks:0G3U}
\href{https://stacks.math.columbia.edu/tag/0G3U}{\texttt{Stacks tag 0G3U}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-differentials-sheafify, modules-lemma-module-principal-parts}

This can be proved in exactly the same way as is done for the sheaf
of differentials in Lemma \ref{modules-lemma-differentials-sheafify}.
Perhaps a more pleasing approach is to use the universal property
of Lemma \ref{modules-lemma-module-principal-parts} directly to see the equality.
We omit the details.
\end{proof}
...
\source{stacks:0G3V}
\href{https://stacks.math.columbia.edu/tag/0G3V}{\texttt{Stacks tag 0G3V}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-differentials-sheafify, modules-lemma-differential-operators-sheafify}

Follows from the commutative algebra version
(Algebra, Lemma \ref{algebra-lemma-sequence-of-principal-parts})
and Lemmas \ref{modules-lemma-differentials-sheafify} and
...
\source{stacks:0G3W}
\href{https://stacks.math.columbia.edu/tag/0G3W}{\texttt{Stacks tag 0G3W}}
\group{modules}

\uses{modules-lemma-module-principal-parts, modules-lemma-sequence-of-principal-parts}
...
Lemma \ref{modules-lemma-module-principal-parts} but it can also be seen
directly from the universal
property of these modules. Moreover, these maps are compatible with
the short exact sequences of Lemma \ref{modules-lemma-sequence-of-principal-parts}.
\end{remark}

Next, we extend our definition to morphisms of ringed spaces.

\begin{definition}[Relative differential operators]
\label{modules-definition-relative-differential-operators}
\source{stacks:0G3X}
\href{https://stacks.math.columbia.edu/tag/0G3X}{\texttt{Stacks tag 0G3X}}
\group{modules}
...
constructed in Section \ref{modules-section-differentials}.
Let
$$
...
\source{stacks:0FKM}
\href{https://stacks.math.columbia.edu/tag/0FKM}{\texttt{Stacks tag 0FKM}}
\group{modules}
...
Lemma \ref{modules-lemma-local-tensor-algebra}.
...
\begin{lemma}[Pullback de rham complex]
\label{modules-lemma-pullback-de-rham-complex}
\source{stacks:0FKP}
\href{https://stacks.math.columbia.edu/tag/0FKP}{\texttt{Stacks tag 0FKP}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-pullback-differentials}

Omitted. Hint: compare with Lemma \ref{modules-lemma-pullback-differentials}.
\end{proof}

\begin{lemma}[Differentials de rham complex order 1]
\label{modules-lemma-differentials-de-rham-complex-order-1}
\source{stacks:0G3Y}
\href{https://stacks.math.columbia.edu/tag/0G3Y}{\texttt{Stacks tag 0G3Y}}
\group{modules}
...
Let $X$ be a topological space. Let
$$
\begin{array}{cc}\mathcal{B} \longrightarrow & \mathcal{B}' \\ \mathcal{A} \longrightarrow\uparrow & \mathcal{A}' \uparrow\end{array}
$$
...
constructed in Section \ref{modules-section-differentials}, and for $p \geq 2$
...
\begin{definition}[De rham complex morphism ringed spaces]
\label{modules-definition-de-rham-complex-morphism-ringed-spaces}
\source{stacks:0FKQ}
\href{https://stacks.math.columbia.edu/tag/0FKQ}{\texttt{Stacks tag 0FKQ}}
\group{modules}
...
\Omega^\bullet_{X'/S'}
$$
(using Lemma \ref{modules-lemma-pullback-de-rham-complex} for the first equality)
and then we can use adjunction.

\begin{lemma}[Differentials relative de rham complex order 1]
\label{modules-lemma-differentials-relative-de-rham-complex-order-1}
\source{stacks:0G3Z}
\href{https://stacks.math.columbia.edu/tag/0G3Z}{\texttt{Stacks tag 0G3Z}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-differentials-de-rham-complex-order-1}

Immediate from Lemma \ref{modules-lemma-differentials-de-rham-complex-order-1}
and the definition.
\end{proof}
...
Lemma \ref{modules-lemma-differential-seq} there is a canonical map
\begin{equation}
...
\source{stacks:08TJ}
\href{https://stacks.math.columbia.edu/tag/08TJ}{\texttt{Stacks tag 08TJ}}
\group{modules}
...
in Lemma \ref{modules-lemma-functoriality-differentials} for modules of differentials.
...
$$
\begin{array}{ccc}\mathcal{B} \longrightarrow & \mathcal{B}' \longrightarrow & \mathcal{B}'' \\ \mathcal{A} \uparrow\longrightarrow & \mathcal{A}' \uparrow\longrightarrow & \mathcal{A}'' \uparrow\end{array}
$$
...
\source{stacks:08TL}
\href{https://stacks.math.columbia.edu/tag/08TL}{\texttt{Stacks tag 08TL}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-abelian, modules-lemma-stalk-module-differentials}
...
it suffices to check on stalks (Lemma \ref{modules-lemma-abelian}). If $x \in X$
...
(Some details omitted; use Lemma \ref{modules-lemma-stalk-module-differentials}
...
\source{stacks:08TM}
\href{https://stacks.math.columbia.edu/tag/08TM}{\texttt{Stacks tag 08TM}}
\group{modules}
...
Omitted. Hint: Use Lemma \ref{modules-lemma-pullback-differentials}.
\end{proof}

\begin{lemma}[Stalk NL]
\label{modules-lemma-stalk-NL}
\source{stacks:0D09}
\href{https://stacks.math.columbia.edu/tag/0D09}{\texttt{Stacks tag 0D09}}
\group{modules}
...
\begin{proof}
\uses{modules-lemma-pullback-NL}

This is a special case of Lemma \ref{modules-lemma-pullback-NL}
...
\source{stacks:0E1Y}
\href{https://stacks.math.columbia.edu/tag/0E1Y}{\texttt{Stacks tag 0E1Y}}
\group{modules}
...
$$
\begin{array}{cccc}H^0(\NL_{\mathcal{B}/\mathcal{A}} \otimes_\mathcal{B} \mathcal{C}) \longrightarrow & H^0(\NL_{\mathcal{C}/\mathcal{A}}) \longrightarrow & H^0(\NL_{\mathcal{C}/\mathcal{B}}) \longrightarrow & 0 \\ H^{-1}(\NL_{\mathcal{B}/\mathcal{A}} \otimes_\mathcal{B} \mathcal{C}) \longrightarrow & H^{-1}(\NL_{\mathcal{C}/\mathcal{A}}) \longrightarrow & H^{-1}(\NL_{\mathcal{C}/\mathcal{B}}) \nwarrow & \end{array}
$$
of cohomology sheaves.
\end{lemma}

\begin{proof}
\uses{modules-lemma-stalk-NL}
...
To see this we can look at stalks, see Lemma \ref{modules-lemma-stalk-NL},
...
\source{stacks:08TN}
\href{https://stacks.math.columbia.edu/tag/08TN}{\texttt{Stacks tag 08TN}}
\group{modules}
...
Given a commutative diagram
$$
\begin{array}{cc}X' \underset{g}{\longrightarrow}\underset{f'}{\downarrow} & X \overset{f}{\downarrow} \\ Y' \overset{h}{\longrightarrow} & Y\end{array}
$$
...
$$
\begin{array}{cc}g^{-1}\mathcal{O}_X \underset{g^\sharp}{\longrightarrow} & \mathcal{O}_{X'} \\ g^{-1}f^{-1}\mathcal{O}_Y
\overset{g^{-1}h^\sharp}{\longrightarrow}\overset{g^{-1}f^\sharp}{\uparrow} & (f')^{-1}\mathcal{O}_{Y'} \underset{(f')^\sharp}{\uparrow}\end{array}
$$
as in (\ref{equation-commutative-square-sheaves}) above.
Given a second such diagram
$$
\begin{array}{cc}X'' \underset{g'}{\longrightarrow}\downarrow & X' \downarrow \\ Y'' \longrightarrow & Y'\end{array}
$$
the composition of $(g')^*c$ and the map
$c' : (g')^*\NL_{X'/Y'} \to \NL_{X''/Y''}$
is the map $(g \circ g')^*\NL_{X''/Y''} \to \NL_{X/Y}$.

\begin{lemma}[Exact sequence NL ringed topoi]
\label{modules-lemma-exact-sequence-NL-ringed-topoi}
\source{stacks:0E1Z}
\href{https://stacks.math.columbia.edu/tag/0E1Z}{\texttt{Stacks tag 0E1Z}}
\group{modules}
...
which produces a canonical six term exact sequence
$$
\begin{array}{cccc}H^0(f^*\NL_{Y/Z}) \longrightarrow & H^0(\NL_{X/Z}) \longrightarrow & H^0(\NL_{X/Y}) \longrightarrow & 0 \\ H^{-1}(f^*\NL_{Y/Z}) \longrightarrow & H^{-1}(\NL_{X/Z}) \longrightarrow & H^{-1}(\NL_{X/Y}) \nwarrow & \end{array}
$$
of cohomology sheaves.
\end{lemma}

\begin{proof}
\uses{modules-lemma-exact-sequence-NL}

Consider the maps of sheaves rings
$$
(g \circ f)^{-1}\mathcal{O}_Z \to f^{-1}\mathcal{O}_Y \to \mathcal{O}_X
$$
and apply Lemma \ref{modules-lemma-exact-sequence-NL}.
\end{proof}
