...
\end{align}
which induce
$ (\msf Y^{\ch\lambda,\ch\theta})_\red \cong (\msf S^{\ch\lambda} \xt_{\msf L X/\msf L^+G} \msf L^{\ch\theta}X/\msf L^+G)_\red$
and
$ (\ol{\msf Y}^{\ch\lambda,\ch\theta})_\red \cong (\ol{\msf S}^{\ch\lambda}
