...
`FormalizedPapers/SheavesAndCohomology/IntersectionComplexesUnramifiedLFactors`.
...
- Source bundle: [`references/intersection-complexes-unramified-l-factors/`](../../../references/intersection-complexes-unramified-l-factors/)
