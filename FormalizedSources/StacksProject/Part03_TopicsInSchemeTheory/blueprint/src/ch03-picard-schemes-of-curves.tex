...
\begin{lemma}[Hilb d sheaf]
\label{pic-lemma-hilb-d-sheaf}
\source{stacks:0B95}
\href{https://stacks.math.columbia.edu/tag/0B95}{\texttt{Stacks tag 0B95}}
\group{pic}
...
\begin{lemma}[Hilb d limit preserving]
\label{pic-lemma-hilb-d-limit-preserving}
\source{stacks:0B96}
\href{https://stacks.math.columbia.edu/tag/0B96}{\texttt{Stacks tag 0B96}}
\group{pic}
...
\begin{lemma}[Hilb d of closed]
\label{pic-lemma-hilb-d-of-closed}
\source{stacks:0B97}
\href{https://stacks.math.columbia.edu/tag/0B97}{\texttt{Stacks tag 0B97}}
\group{pic}
...
\begin{lemma}[Hilb d separated]
\label{pic-lemma-hilb-d-separated}
\source{stacks:0B98}
\href{https://stacks.math.columbia.edu/tag/0B98}{\texttt{Stacks tag 0B98}}
\group{pic}
...
\begin{proof}
\uses{pic-lemma-hilb-d-of-closed}
...
Lemma \ref{pic-lemma-hilb-d-of-closed}
the reader finds an alternative easier proof of the needed result
in our special case.
\end{proof}

\begin{lemma}[Hilb d An]
\label{pic-lemma-hilb-d-An}
\source{stacks:0B99}
\href{https://stacks.math.columbia.edu/tag/0B99}{\texttt{Stacks tag 0B99}}
\group{pic}
...
\begin{proposition}[Hilb d representable]
\label{pic-proposition-hilb-d-representable}
\source{stacks:0B9A}
\href{https://stacks.math.columbia.edu/tag/0B9A}{\texttt{Stacks tag 0B9A}}
\group{pic}
...
\begin{proof}
\uses{pic-lemma-hilb-d-sheaf, pic-lemma-hilb-d-An}
...
\medskip\noindent
Condition (1) is Lemma \ref{pic-lemma-hilb-d-sheaf}.

\medskip\noindent
Condition (2)(a) follows from the fact that $F_U = \Hilbfunctor^d_{U/S}$
and that this is representable by Lemma \ref{pic-lemma-hilb-d-An}.
...
\begin{remark}[When proposition applies]
\label{pic-remark-when-proposition-applies}
\source{stacks:0B9B}
\href{https://stacks.math.columbia.edu/tag/0B9B}{\texttt{Stacks tag 0B9B}}
\group{pic}

\uses{pic-proposition-hilb-d-representable}
Let $f : X \to S$ be a morphism of schemes. The assumption of
Proposition \ref{pic-proposition-hilb-d-representable} and
...
\begin{lemma}[Divisors on curves]
\label{pic-lemma-divisors-on-curves}
\source{stacks:0B9D}
\href{https://stacks.math.columbia.edu/tag/0B9D}{\texttt{Stacks tag 0B9D}}
\group{pic}
...
\begin{lemma}[Sum divisors on curves]
\label{pic-lemma-sum-divisors-on-curves}
\source{stacks:0B9E}
\href{https://stacks.math.columbia.edu/tag/0B9E}{\texttt{Stacks tag 0B9E}}
\group{pic}
...
\begin{proof}
\uses{pic-lemma-divisors-on-curves}

By Lemma \ref{pic-lemma-divisors-on-curves} we see that $D_1$
...
Lemma \ref{pic-lemma-divisors-on-curves}.
Applying
...
\begin{lemma}[Difference divisors on curves]
\label{pic-lemma-difference-divisors-on-curves}
\source{stacks:0B9F}
\href{https://stacks.math.columbia.edu/tag/0B9F}{\texttt{Stacks tag 0B9F}}
\group{pic}
...
\begin{proof}
\uses{pic-lemma-sum-divisors-on-curves, pic-lemma-divisors-on-curves}

This proof is almost exactly the same as the proof of
Lemma \ref{pic-lemma-sum-divisors-on-curves}.
By Lemma \ref{pic-lemma-divisors-on-curves} we see that $D_1$
and $D_2$ are relative effective Cartier divisors on $X/S$.
By Divisors, Lemma
...
This follows from Lemma \ref{pic-lemma-sum-divisors-on-curves}.
\end{proof}

Let $X \to S$ be a smooth morphism of schemes of relative dimension $1$.
By Lemma \ref{pic-lemma-divisors-on-curves} for a scheme $T$ over $S$ and
...
Lemma \ref{pic-lemma-sum-divisors-on-curves} we obtain a transformation
of functors
$$
...
\begin{lemma}[Universal object]
\label{pic-lemma-universal-object}
\source{stacks:0B9G}
\href{https://stacks.math.columbia.edu/tag/0B9G}{\texttt{Stacks tag 0B9G}}
\group{pic}
...
\begin{proof}
\uses{pic-lemma-difference-divisors-on-curves}

Let $D_{univ} \subset X \times_S \underline{\Hilbfunctor}^{d + 1}_{X/S}$
be the universal object. There is a commutative diagram
$$
\begin{array}{cccc}\underline{\Hilbfunctor}^d_{X/S} \times_S X \longrightarrow\searrow &  & D_{univ} \swarrow\longrightarrow & \underline{\Hilbfunctor}^{d + 1}_{X/S} \times_S X \\  & \underline{\Hilbfunctor}^{d + 1}_{X/S} &  & \end{array}
$$
...
Lemma \ref{pic-lemma-difference-divisors-on-curves}
...
\begin{lemma}[Hilb d smooth]
\label{pic-lemma-hilb-d-smooth}
\source{stacks:0B9H}
\href{https://stacks.math.columbia.edu/tag/0B9H}{\texttt{Stacks tag 0B9H}}
\group{pic}
...
\begin{proof}
\uses{pic-lemma-universal-object}
...
Lemma \ref{pic-lemma-universal-object}
...
\begin{proposition}[Hilb d]
\label{pic-proposition-hilb-d}
\source{stacks:0B9I}
\href{https://stacks.math.columbia.edu/tag/0B9I}{\texttt{Stacks tag 0B9I}}
\group{pic}
...
\begin{proof}
\uses{pic-proposition-hilb-d-representable, pic-remark-when-proposition-applies, pic-lemma-hilb-d-separated, pic-lemma-hilb-d-smooth, pic-lemma-universal-object}

The functors $\Hilbfunctor^d_{X/k}$ are representable by
Proposition \ref{pic-proposition-hilb-d-representable}
(see also Remark \ref{pic-remark-when-proposition-applies})
...
over $k$ by Lemma \ref{pic-lemma-hilb-d-separated}.
The schemes $\underline{\Hilbfunctor}^d_{X/k}$ are smooth
over $k$ by Lemma \ref{pic-lemma-hilb-d-smooth}.
Starting with $X = \underline{\Hilbfunctor}^1_{X/k}$,
the morphisms of Lemma \ref{pic-lemma-universal-object},
...
$$
\begin{array}{cc}X^{d_1} \times_k X^{d_2} \downarrow\xlongequal{} & X^{d_1 + d_2} \downarrow \\ \underline{\Hilbfunctor}^{d_1}_{X/k}
\times_k
\underline{\Hilbfunctor}^{d_2}_{X/k}
\longrightarrow & \underline{\Hilbfunctor}^{d_1 + d_2}_{X/k}\end{array}
$$
and multiplicativity of degrees of finite locally free morphisms.
\end{proof}

\begin{remark}[Universal object hilb d]
\label{pic-remark-universal-object-hilb-d}
\source{stacks:0B9J}
\href{https://stacks.math.columbia.edu/tag/0B9J}{\texttt{Stacks tag 0B9J}}
\group{pic}

\uses{pic-proposition-hilb-d, pic-lemma-divisors-on-curves, pic-lemma-universal-object}
Let $X$ be a geometrically irreducible smooth proper curve over a field $k$
as in Proposition \ref{pic-proposition-hilb-d}. Let $d \geq 0$. The universal
...
\begin{definition}[Picard functor]
\label{pic-definition-picard-functor}
\source{stacks:0B9L}
\href{https://stacks.math.columbia.edu/tag/0B9L}{\texttt{Stacks tag 0B9L}}
\group{pic}
...
\source{stacks:0B9M}
\href{https://stacks.math.columbia.edu/tag/0B9M}{\texttt{Stacks tag 0B9M}}
\group{pic}

\uses{pic-definition-picard-functor}
Let $f : X \to S$ be as in Definition \ref{pic-definition-picard-functor}.
...
\source{stacks:0B9N}
\href{https://stacks.math.columbia.edu/tag/0B9N}{\texttt{Stacks tag 0B9N}}
\group{pic}
...
\begin{proof}
\uses{pic-lemma-flat-geometrically-connected-fibres}
...
Thus by Lemma \ref{pic-lemma-flat-geometrically-connected-fibres} we see that
...
\source{stacks:0B9Q}
\href{https://stacks.math.columbia.edu/tag/0B9Q}{\texttt{Stacks tag 0B9Q}}
\group{pic}
...
In this section we will apply Lemma \ref{pic-lemma-criterion} to show that
...
\begin{lemma}[Check conditions]
\label{pic-lemma-check-conditions}
\source{stacks:0B9U}
\href{https://stacks.math.columbia.edu/tag/0B9U}{\texttt{Stacks tag 0B9U}}
\group{pic}

\uses{pic-lemma-flat-geometrically-connected-fibres-with-section}
Let $k$ be a field. Let $X$ be a smooth projective curve over $k$
which has a $k$-rational point. Then the hypotheses of
Lemma \ref{pic-lemma-flat-geometrically-connected-fibres-with-section}
are satisfied.
\end{lemma}
...
by Lemmas \ref{pic-lemma-check-conditions} and
...
\begin{lemma}[Define open]
\label{pic-lemma-define-open}
\source{stacks:0B9V}
\href{https://stacks.math.columbia.edu/tag/0B9V}{\texttt{Stacks tag 0B9V}}
\group{pic}
...
\source{stacks:0B9W}
\href{https://stacks.math.columbia.edu/tag/0B9W}{\texttt{Stacks tag 0B9W}}
\group{pic}
...
\begin{lemma}[Open representable]
\label{pic-lemma-open-representable}
\source{stacks:0B9X}
\href{https://stacks.math.columbia.edu/tag/0B9X}{\texttt{Stacks tag 0B9X}}
\group{pic}

\uses{pic-lemma-define-open}
...
in Lemma \ref{pic-lemma-define-open} is representable by an open subscheme of
$\underline{\Hilbfunctor}^g_{X/k}$.
\end{lemma}

\begin{proof}
\uses{pic-proposition-hilb-d, pic-remark-universal-object-hilb-d, pic-lemma-divisors-on-curves}

In this proof unadorned products are over $\Spec(k)$.
By Proposition \ref{pic-proposition-hilb-d} the scheme
...
Remark \ref{pic-remark-universal-object-hilb-d}.
...
$$
\begin{array}{cc}h_W \downarrow\longrightarrow & F \downarrow \\ h_H \longrightarrow & \Picardfunctor_{X/k, \sigma}\end{array}
$$
...
effective Cartier divisors, see Lemma \ref{pic-lemma-divisors-on-curves} and
...
\begin{lemma}[Twist with general divisor]
\label{pic-lemma-twist-with-general-divisor}
\source{stacks:0B9Y}
\href{https://stacks.math.columbia.edu/tag/0B9Y}{\texttt{Stacks tag 0B9Y}}
\group{pic}
...
\begin{proposition}[Pic curve]
\label{pic-proposition-pic-curve}
\source{stacks:0B9Z}
\href{https://stacks.math.columbia.edu/tag/0B9Z}{\texttt{Stacks tag 0B9Z}}
\group{pic}
...
\begin{proof}
\uses{pic-lemma-criterion, pic-lemma-flat-geometrically-connected-fibres-with-section, pic-lemma-check-conditions, pic-lemma-define-open, pic-lemma-open-representable, pic-lemma-twist-with-general-divisor}
...
Lemma \ref{pic-lemma-flat-geometrically-connected-fibres-with-section}
which applies by Lemma \ref{pic-lemma-check-conditions}.
This proves condition (1)

\medskip\noindent
As our subfunctor we use $F$ as defined in Lemma \ref{pic-lemma-define-open}.
Condition (2)(b) follows.
Condition (2)(a) is Lemma \ref{pic-lemma-open-representable}.
Condition (2)(c) is Lemma \ref{pic-lemma-twist-with-general-divisor}.
\end{proof}

In fact, the proof given above produces more information which we
collect here.

\begin{lemma}[Picard pieces]
\label{pic-lemma-picard-pieces}
\source{stacks:0BA0}
\href{https://stacks.math.columbia.edu/tag/0BA0}{\texttt{Stacks tag 0BA0}}
\group{pic}
...
\begin{proof}
\uses{pic-proposition-pic-curve, pic-remark-universal-object-hilb-d, pic-lemma-open-representable, pic-proposition-hilb-d}
...
(which exists by Proposition \ref{pic-proposition-pic-curve})
...
(Remark \ref{pic-remark-universal-object-hilb-d}) by the Yoneda lemma
(Categories, Lemma \ref{categories-lemma-yoneda}).
Our proof of the representability of the Picard functor of $X/k$
in Proposition \ref{pic-proposition-pic-curve} and
Lemma \ref{pic-lemma-open-representable} shows that $\gamma_g$
...
\begin{lemma}[Pic descends]
\label{pic-lemma-pic-descends}
\source{stacks:0CDT}
\href{https://stacks.math.columbia.edu/tag/0CDT}{\texttt{Stacks tag 0CDT}}
\group{pic}
...
\begin{lemma}[Torsion descends]
\label{pic-lemma-torsion-descends}
\source{stacks:0CD5}
\href{https://stacks.math.columbia.edu/tag/0CD5}{\texttt{Stacks tag 0CD5}}
\group{pic}
