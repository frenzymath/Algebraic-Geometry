...
\begin{definition}[Module valued functor]
\label{adequate-definition-module-valued-functor}
\source{stacks:06Z4}
\href{https://stacks.math.columbia.edu/tag/06Z4}{\texttt{Stacks tag 06Z4}}
\group{adequate}
...
given in Section \ref{adequate-section-conventions}.
...
\begin{definition}[Adequate functor]
\label{adequate-definition-adequate-functor}
\source{stacks:06UT}
\href{https://stacks.math.columbia.edu/tag/06UT}{\texttt{Stacks tag 06UT}}
\group{adequate}
...
(Lemmas \ref{adequate-lemma-cokernel-adequate} and \ref{adequate-lemma-kernel-adequate})
and has a set of generators
(Lemma \ref{adequate-lemma-adequate-surjection-from-linear}).
We will also see that it is a weak Serre subcategory of the category
of all module-valued functors on $\textit{Alg}_A$
(Lemma \ref{adequate-lemma-extension-adequate})
and that it has arbitrary colimits
(Lemma \ref{adequate-lemma-colimit-adequate}).

\begin{lemma}[Adequate finite presentation]
\label{adequate-lemma-adequate-finite-presentation}
\source{stacks:06UU}
\href{https://stacks.math.columbia.edu/tag/06UU}{\texttt{Stacks tag 06UU}}
\group{adequate}
...
\begin{remark}[Settheoretic]
\label{adequate-remark-settheoretic}
\source{stacks:06UV}
\href{https://stacks.math.columbia.edu/tag/06UV}{\texttt{Stacks tag 06UV}}
\group{adequate}

\uses{adequate-lemma-adequate-finite-presentation}
...
$\textit{Alg}_{fp, A}$. By
Lemma \ref{adequate-lemma-adequate-finite-presentation}
...
\begin{lemma}[Adequate flat]
\label{adequate-lemma-adequate-flat}
\source{stacks:06UW}
\href{https://stacks.math.columbia.edu/tag/06UW}{\texttt{Stacks tag 06UW}}
\group{adequate}
...
$$
\begin{array}{cccc}0 \longrightarrow & F(B) \otimes_B B' \longrightarrow\downarrow & (M \otimes_A B)\otimes_B B' \longrightarrow\downarrow & (N \otimes_A B)\otimes_B B' \downarrow \\ 0 \longrightarrow & F(B') \longrightarrow & M \otimes_A B' \longrightarrow & N \otimes_A B'\end{array}
$$
...
\begin{lemma}[Adequate surjection from linear]
\label{adequate-lemma-adequate-surjection-from-linear}
\source{stacks:06UX}
\href{https://stacks.math.columbia.edu/tag/06UX}{\texttt{Stacks tag 06UX}}
\group{adequate}
...
of $A$-modules
$$
\begin{array}{cc}A^{\oplus n} \longrightarrow\underset{m_1, \ldots, m_n}{\downarrow} & N' \downarrow \\ M \longrightarrow & N\end{array}
$$
...
$$
\begin{array}{cc}A^{\oplus n} \oplus A^{\oplus l} \longrightarrow\downarrow & A^{\oplus k} \downarrow \\ M \longrightarrow & N\end{array}
$$
...
\begin{lemma}[Flat functor split]
\label{adequate-lemma-flat-functor-split}
\source{stacks:06UZ}
\href{https://stacks.math.columbia.edu/tag/06UZ}{\texttt{Stacks tag 06UZ}}
\group{adequate}
...
$$
\begin{array}{cc}B \underset{a}{\longrightarrow}\underset{a'}{\downarrow} & B[t, t^{-1}] \overset{f}{\downarrow} \\ B[s, s^{-1}] \overset{g}{\longrightarrow} & B[t, s, t^{-1}, s^{-1}]\end{array}
$$
...
Lemma \ref{adequate-lemma-flat-functor-split}
note that
$$
...
\source{stacks:06V0}
\href{https://stacks.math.columbia.edu/tag/06V0}{\texttt{Stacks tag 06V0}}
\group{adequate}

Let $A$ be a ring. Given a solid diagram
$$
\begin{array}{cccc}0 \longrightarrow & L \underset{\varphi}{\downarrow}\longrightarrow & \underline{A^{\oplus n}} \longrightarrow\swarrow & \underline{A^{\oplus m}} \\  & \underline{M} &  & \end{array}
$$
...
\begin{proof}
\uses{adequate-lemma-flat-functor-split, adequate-lemma-adequate-flat}
...
Lemmas \ref{adequate-lemma-flat-functor-split} and \ref{adequate-lemma-adequate-flat}
...
\begin{lemma}[Cokernel into module]
\label{adequate-lemma-cokernel-into-module}
\source{stacks:06V1}
\href{https://stacks.math.columbia.edu/tag/06V1}{\texttt{Stacks tag 06V1}}
\group{adequate}
...
\begin{proof}
\uses{adequate-lemma-adequate-surjection-from-linear, adequate-lemma-lift-map}
...
Lemma \ref{adequate-lemma-lift-map}.
Consider the diagram
$$
\begin{array}{cccc}0 \longrightarrow & \bigoplus L_i  \longrightarrow\downarrow & \bigoplus \underline{A^{\oplus n_i}} \longrightarrow\swarrow & \bigoplus \underline{A^{\oplus m_i}} \\  & \underline{M} &  & \end{array}
$$
...
\begin{lemma}[The cokernel of a map of adequate functors on the category of algebras over a ring is a...]
\label{adequate-lemma-cokernel-adequate}
\source{stacks:06V2}
\href{https://stacks.math.columbia.edu/tag/06V2}{\texttt{Stacks tag 06V2}}
\group{adequate}
...
\begin{proof}
\uses{adequate-lemma-cokernel-into-module}

Choose an injection $G \to \underline{M}$.
Then we have an injection $G/F \to \underline{M}/F$. By
Lemma \ref{adequate-lemma-cokernel-into-module}
...
\begin{lemma}[Kernel adequate]
\label{adequate-lemma-kernel-adequate}
\source{stacks:06V3}
\href{https://stacks.math.columbia.edu/tag/06V3}{\texttt{Stacks tag 06V3}}
\group{adequate}
...
\begin{proof}
\uses{adequate-lemma-cokernel-adequate}
...
$$
\begin{array}{cc}F \downarrow\longrightarrow & G \downarrow \\ \underline{M \oplus N} \longrightarrow & \underline{N}\end{array}
$$
commutes. By
Lemma \ref{adequate-lemma-cokernel-adequate}
...
\begin{lemma}[Colimit adequate]
\label{adequate-lemma-colimit-adequate}
\source{stacks:06V4}
\href{https://stacks.math.columbia.edu/tag/06V4}{\texttt{Stacks tag 06V4}}
\group{adequate}
...
\begin{proof}
\uses{adequate-lemma-kernel-adequate}
...
Lemma \ref{adequate-lemma-kernel-adequate}.
\end{proof}

\begin{lemma}[Flat linear functor]
\label{adequate-lemma-flat-linear-functor}
\source{stacks:06V5}
\href{https://stacks.math.columbia.edu/tag/06V5}{\texttt{Stacks tag 06V5}}
\group{adequate}
...
\begin{lemma}[Extension adequate key]
\label{adequate-lemma-extension-adequate-key}
\source{stacks:06V6}
\href{https://stacks.math.columbia.edu/tag/06V6}{\texttt{Stacks tag 06V6}}
\group{adequate}
...
\begin{proof}
\uses{adequate-lemma-adequate-flat, adequate-lemma-flat-functor-split, adequate-lemma-flat-linear-functor}
...
Lemma \ref{adequate-lemma-adequate-flat}
...
Lemma \ref{adequate-lemma-flat-linear-functor}.
Clearly this implies that $G \cong \underline{M} \oplus L$ and we win.
\end{proof}

\begin{remark}[Linearly adequate]
\label{adequate-remark-linearly-adequate}
\source{stacks:06V7}
\href{https://stacks.math.columbia.edu/tag/06V7}{\texttt{Stacks tag 06V7}}
\group{adequate}

\uses{adequate-lemma-extension-adequate-key}
Let $A$ be a ring.
The proof of
Lemma \ref{adequate-lemma-extension-adequate-key}
...
\begin{lemma}[Extension adequate]
\label{adequate-lemma-extension-adequate}
\source{stacks:06V8}
\href{https://stacks.math.columbia.edu/tag/06V8}{\texttt{Stacks tag 06V8}}
\group{adequate}
...
\begin{proof}
\uses{adequate-lemma-kernel-adequate, adequate-lemma-adequate-surjection-from-linear, adequate-lemma-cokernel-adequate, adequate-lemma-extension-adequate-key, adequate-lemma-colimit-adequate}
...
\begin{lemma}[Base change adequate]
\label{adequate-lemma-base-change-adequate}
\source{stacks:06V9}
\href{https://stacks.math.columbia.edu/tag/06V9}{\texttt{Stacks tag 06V9}}
\group{adequate}
...
\begin{lemma}[Pushforward adequate]
\label{adequate-lemma-pushforward-adequate}
\source{stacks:06VA}
\href{https://stacks.math.columbia.edu/tag/06VA}{\texttt{Stacks tag 06VA}}
\group{adequate}
...
\begin{lemma}[Adequate product]
\label{adequate-lemma-adequate-product}
\source{stacks:06VB}
\href{https://stacks.math.columbia.edu/tag/06VB}{\texttt{Stacks tag 06VB}}
\group{adequate}
...
\begin{lemma}[Adequate descent]
\label{adequate-lemma-adequate-descent}
\source{stacks:06VH}
\href{https://stacks.math.columbia.edu/tag/06VH}{\texttt{Stacks tag 06VH}}
\group{adequate}
...
\begin{proof}
\uses{adequate-lemma-pushforward-adequate, adequate-lemma-base-change-adequate, adequate-lemma-kernel-adequate}

The functors $B \to F(B \otimes_A A')$ and
$B \mapsto F(B \otimes_A A' \otimes_A A')$ are adequate, see
Lemmas \ref{adequate-lemma-pushforward-adequate} and
...
\source{stacks:06Z6}
\href{https://stacks.math.columbia.edu/tag/06Z6}{\texttt{Stacks tag 06Z6}}
\group{adequate}
...
\begin{proof}
\uses{adequate-lemma-adequate-surjection-from-linear, adequate-lemma-kernel-adequate, adequate-lemma-colimit-adequate}
...
Lemmas \ref{adequate-lemma-adequate-surjection-from-linear} and
...
\begin{lemma}[Enough injectives]
\label{adequate-lemma-enough-injectives}
\source{stacks:06Z7}
\href{https://stacks.math.columbia.edu/tag/06Z7}{\texttt{Stacks tag 06Z7}}
\group{adequate}

\uses{adequate-lemma-adjoint}
...
the construction of Lemma \ref{adequate-lemma-adjoint}.
Then
\begin{enumerate}
...
\begin{proof}
\uses{adequate-lemma-cokernel-adequate, adequate-lemma-kernel-adequate, adequate-lemma-extension-adequate, adequate-lemma-adjoint}
...
and
Lemmas \ref{adequate-lemma-cokernel-adequate}, \ref{adequate-lemma-kernel-adequate},
and \ref{adequate-lemma-extension-adequate}.
...
Part (3) follows from
Lemma \ref{adequate-lemma-adjoint}
and
...
\begin{lemma}[Tangent functor]
\label{adequate-lemma-tangent-functor}
\source{stacks:06Z8}
\href{https://stacks.math.columbia.edu/tag/06Z8}{\texttt{Stacks tag 06Z8}}
\group{adequate}
...
diagram
$$
\begin{array}{ccc}B' \longrightarrow & B'[N'] \longrightarrow & B' \\ B \longrightarrow\uparrow & B[N] \longrightarrow\uparrow & B \uparrow\end{array}
$$
...
\begin{lemma}[Tangent injective]
\label{adequate-lemma-tangent-injective}
\source{stacks:06ZA}
\href{https://stacks.math.columbia.edu/tag/06ZA}{\texttt{Stacks tag 06ZA}}
\group{adequate}
...
\begin{proof}
\uses{adequate-lemma-tangent-functor}

We will use the results of
Lemma \ref{adequate-lemma-tangent-functor}
...
$$
\begin{array}{ccc}h_2 \longrightarrow & h \longrightarrow\longrightarrow & h_1\end{array}
$$
...
$$
\begin{array}{ccc}\mathcal{O}_{h_2} \longrightarrow & \mathcal{O}_h \longrightarrow\longrightarrow & \mathcal{O}_{h_1}\end{array}
$$
...
$$
\begin{array}{ccc}I(B[N_1]) \longrightarrow\longrightarrow & I(B[N]) \longrightarrow & I(B[N_2])\end{array}
$$
...
\begin{lemma}[Exactness implies]
\label{adequate-lemma-exactness-implies}
\source{stacks:06ZB}
\href{https://stacks.math.columbia.edu/tag/06ZB}{\texttt{Stacks tag 06ZB}}
\group{adequate}
...
\begin{example}[Module structure different]
\label{adequate-example-module-structure-different}
\source{stacks:06ZE}
\href{https://stacks.math.columbia.edu/tag/06ZE}{\texttt{Stacks tag 06ZE}}
\group{adequate}

\uses{adequate-lemma-exactness-implies}
Let $F$ be a module-valued functor as in
Lemma \ref{adequate-lemma-exactness-implies}.
...
\begin{lemma}[Exactness permanence]
\label{adequate-lemma-exactness-permanence}
\source{stacks:06ZF}
\href{https://stacks.math.columbia.edu/tag/06ZF}{\texttt{Stacks tag 06ZF}}
\group{adequate}
...
the diagram
$$
\begin{array}{ccccc}0 \longrightarrow & TF(B, N_1) \longrightarrow\downarrow & TG(B, N_1) \longrightarrow\downarrow & TH(B, N_1) \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & TF(B, N_2) \longrightarrow\downarrow & TG(B, N_2) \longrightarrow\downarrow & TH(B, N_2) \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & TF(B, N_3) \longrightarrow\downarrow & TG(B, N_3) \longrightarrow\downarrow & TH(B, N_3) \longrightarrow & 0 \\  & 0 & 0 &  & \end{array}
$$
with exact horizontal rows and exact columns involving $TF$ and $TG$.
To prove part (2) we do a diagram chase in the diagram
$$
\begin{array}{ccccc}0 \longrightarrow & TF(B, N_1) \longrightarrow\downarrow & TG(B, N_1) \longrightarrow\downarrow & TH(B, N_1) \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & TF(B, N_2) \longrightarrow\downarrow & TG(B, N_2) \longrightarrow\downarrow & TH(B, N_2) \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & TF(B, N_3) \longrightarrow\downarrow & TG(B, N_3) \longrightarrow & TH(B, N_3) \longrightarrow\downarrow & 0 \\  & 0 &  & 0 & \end{array}
$$
...
\begin{lemma}[Ext group zero key]
\label{adequate-lemma-ext-group-zero-key}
\source{stacks:06ZG}
\href{https://stacks.math.columbia.edu/tag/06ZG}{\texttt{Stacks tag 06ZG}}
\group{adequate}
...
\begin{proof}
\uses{adequate-lemma-enough-injectives, adequate-lemma-tangent-injective, adequate-lemma-exactness-permanence, adequate-lemma-exactness-implies, adequate-lemma-tangent-functor}

Choose an injective resolution $\underline{M} \to I^\bullet$ in
$\mathcal{P}$, see
Lemma \ref{adequate-lemma-enough-injectives}.
By
...
Lemma \ref{adequate-lemma-tangent-injective}
...
Lemma \ref{adequate-lemma-exactness-permanence}
...
$$
of
Lemma \ref{adequate-lemma-tangent-functor} (\ref{item-mult-map})
are $B$-linear by
Lemma \ref{adequate-lemma-exactness-implies} (\ref{item-mult-map-linear})
and functorial in $B$. Hence a map
$$
\begin{array}{ccccccc}0 \longrightarrow & \underline{M} \longrightarrow\overset{1}{\downarrow} & F_{i - 1} \longrightarrow\downarrow & \ldots \longrightarrow & F_0 \longrightarrow\downarrow & \underline{P} \longrightarrow\overset{1}{\downarrow} & 0 \\ 0 \longrightarrow & \underline{M} \longrightarrow & G_{i - 1} \longrightarrow & \ldots \longrightarrow & G_0 \longrightarrow & \underline{P} \longrightarrow & 0\end{array}
$$
...
$$
is exact. By
Lemma \ref{adequate-lemma-exactness-implies} (\ref{item-tangent-right-exact})
...
\begin{lemma}[Ext group zero]
\label{adequate-lemma-ext-group-zero}
\source{stacks:06ZH}
\href{https://stacks.math.columbia.edu/tag/06ZH}{\texttt{Stacks tag 06ZH}}
\group{adequate}
...
\begin{proof}
\uses{adequate-lemma-ext-group-zero-key}
...
Lemma \ref{adequate-lemma-ext-group-zero-key}
...
\source{stacks:06ZI}
\href{https://stacks.math.columbia.edu/tag/06ZI}{\texttt{Stacks tag 06ZI}}
\group{adequate}

\uses{adequate-lemma-enough-injectives}
With notation as in
Lemma \ref{adequate-lemma-enough-injectives}
...
\begin{proof}
\uses{adequate-lemma-adequate-surjection-from-linear, adequate-lemma-ext-group-zero}
...
Lemma \ref{adequate-lemma-ext-group-zero}.
\end{proof}
...
\source{stacks:06VG}
\href{https://stacks.math.columbia.edu/tag/06VG}{\texttt{Stacks tag 06VG}}
\group{adequate}
...
\begin{lemma}[Adequate local]
\label{adequate-lemma-adequate-local}
\source{stacks:06VI}
\href{https://stacks.math.columbia.edu/tag/06VI}{\texttt{Stacks tag 06VI}}
\group{adequate}
...
\begin{proof}
\uses{adequate-lemma-base-change-adequate, adequate-lemma-adequate-product, adequate-lemma-adequate-descent}
...
Lemma \ref{adequate-lemma-base-change-adequate}.
By
Lemma \ref{adequate-lemma-adequate-product}
the sequence
...
It follows from
Lemma \ref{adequate-lemma-adequate-descent}
that $F_{\mathcal{F}, A}$ is adequate.
\end{proof}

\begin{lemma}[Adequate affine]
\label{adequate-lemma-adequate-affine}
\source{stacks:06ZJ}
\href{https://stacks.math.columbia.edu/tag/06ZJ}{\texttt{Stacks tag 06ZJ}}
\group{adequate}
...
\begin{proof}
\uses{adequate-lemma-adequate-local}

Given an adequate module $\mathcal{F}$ the functor $F_{\mathcal{F}, A}$
is adequate by Lemma \ref{adequate-lemma-adequate-local}.
...
\begin{lemma}[Pullback adequate]
\label{adequate-lemma-pullback-adequate}
\source{stacks:06VJ}
\href{https://stacks.math.columbia.edu/tag/06VJ}{\texttt{Stacks tag 06VJ}}
\group{adequate}
...
Lemma \ref{adequate-lemma-adequate-local}
and the definition.
\end{proof}
...
\begin{lemma}[Adequate characterize]
\label{adequate-lemma-adequate-characterize}
\source{stacks:06VK}
\href{https://stacks.math.columbia.edu/tag/06VK}{\texttt{Stacks tag 06VK}}
\group{adequate}
...
\begin{proof}
\uses{adequate-lemma-adequate-local, adequate-lemma-adequate-affine, adequate-lemma-pullback-adequate}
...
Combining with
Lemmas \ref{adequate-lemma-adequate-local} and
...
Lemma \ref{adequate-lemma-pullback-adequate}
...
\begin{lemma}[Adequate fpqc]
\label{adequate-lemma-adequate-fpqc}
\source{stacks:06VL}
\href{https://stacks.math.columbia.edu/tag/06VL}{\texttt{Stacks tag 06VL}}
\group{adequate}
...
\begin{proof}
\uses{adequate-lemma-adequate-local, adequate-lemma-adequate-flat}
...
Lemma \ref{adequate-lemma-adequate-fpqc} shows in particular that
...
\begin{definition}[Category adequate modules]
\label{adequate-definition-category-adequate-modules}
\source{stacks:07AH}
\href{https://stacks.math.columbia.edu/tag/07AH}{\texttt{Stacks tag 07AH}}
\group{adequate}
...
\begin{lemma}[Same cohomology adequate]
\label{adequate-lemma-same-cohomology-adequate}
\source{stacks:06VM}
\href{https://stacks.math.columbia.edu/tag/06VM}{\texttt{Stacks tag 06VM}}
\group{adequate}
...
\begin{proof}
\uses{adequate-lemma-adequate-flat, adequate-lemma-adequate-local, adequate-lemma-adequate-fpqc}
...
and
Lemma \ref{adequate-lemma-adequate-fpqc}
...
\source{stacks:06VN}
\href{https://stacks.math.columbia.edu/tag/06VN}{\texttt{Stacks tag 06VN}}
\group{adequate}

\uses{adequate-lemma-adequate-characterize, adequate-lemma-same-cohomology-adequate}
...
adequate by
Lemma \ref{adequate-lemma-adequate-characterize}.
Conversely, the functor $v$ comes from restriction
$v : \mathcal{G} \mapsto \mathcal{G}|_{S_{Zar}}$, see
Lemma \ref{adequate-lemma-same-cohomology-adequate}.
...
\begin{lemma}[Sheafification adequate]
\label{adequate-lemma-sheafification-adequate}
\source{stacks:06VP}
\href{https://stacks.math.columbia.edu/tag/06VP}{\texttt{Stacks tag 06VP}}
\group{adequate}
...
\begin{proof}
\uses{adequate-lemma-adequate-flat}
...
\begin{lemma}[Abelian adequate]
\label{adequate-lemma-abelian-adequate}
\source{stacks:06VQ}
\href{https://stacks.math.columbia.edu/tag/06VQ}{\texttt{Stacks tag 06VQ}}
\group{adequate}
...
\begin{proof}
\uses{adequate-lemma-kernel-adequate, adequate-lemma-cokernel-adequate, adequate-lemma-sheafification-adequate, adequate-lemma-same-cohomology-adequate, adequate-lemma-adequate-local, adequate-lemma-extension-adequate, adequate-lemma-colimit-adequate}
...
By
Lemmas \ref{adequate-lemma-kernel-adequate} and
...
is adequate by
Lemma \ref{adequate-lemma-sheafification-adequate}.
...
\begin{lemma}[Direct image adequate]
\label{adequate-lemma-direct-image-adequate}
\source{stacks:06VR}
\href{https://stacks.math.columbia.edu/tag/06VR}{\texttt{Stacks tag 06VR}}
\group{adequate}
...
\begin{proof}
\uses{adequate-lemma-same-cohomology-adequate, adequate-lemma-sheafification-adequate, adequate-lemma-pushforward-adequate, adequate-lemma-kernel-adequate, adequate-lemma-cokernel-adequate, adequate-lemma-extension-adequate}
...
Lemma \ref{adequate-lemma-pushforward-adequate}.
...
Remark \ref{adequate-remark-compare}.
...
\begin{lemma}[Parasitic adequate]
\label{adequate-lemma-parasitic-adequate}
\source{stacks:06ZM}
\href{https://stacks.math.columbia.edu/tag/06ZM}{\texttt{Stacks tag 06ZM}}
\group{adequate}
...
\begin{proof}
\uses{adequate-lemma-adequate-local, adequate-lemma-adequate-flat, adequate-remark-compare}
...
\begin{lemma}[Adequate by parasitic]
\label{adequate-lemma-adequate-by-parasitic}
\source{stacks:06ZN}
\href{https://stacks.math.columbia.edu/tag/06ZN}{\texttt{Stacks tag 06ZN}}
\group{adequate}
...
\begin{lemma}[Direct image parasitic adequate]
\label{adequate-lemma-direct-image-parasitic-adequate}
\source{stacks:06ZP}
\href{https://stacks.math.columbia.edu/tag/06ZP}{\texttt{Stacks tag 06ZP}}
\group{adequate}
...
\begin{proof}
\uses{adequate-lemma-direct-image-adequate}

We have already seen in
Lemma \ref{adequate-lemma-direct-image-adequate}
...
\begin{lemma}[Quotient easy]
\label{adequate-lemma-quotient-easy}
\source{stacks:06ZQ}
\href{https://stacks.math.columbia.edu/tag/06ZQ}{\texttt{Stacks tag 06ZQ}}
\group{adequate}
...
\begin{lemma}[Describe Dplus adequate]
\label{adequate-lemma-describe-Dplus-adequate}
\source{stacks:06ZR}
\href{https://stacks.math.columbia.edu/tag/06ZR}{\texttt{Stacks tag 06ZR}}
\group{adequate}
...
\begin{proof}
\uses{adequate-lemma-adequate-characterize}
...
Lemma \ref{adequate-lemma-adequate-characterize}. Hence by
...
\begin{lemma}[Right adjoint adequate]
\label{adequate-lemma-right-adjoint-adequate}
\source{stacks:06ZS}
\href{https://stacks.math.columbia.edu/tag/06ZS}{\texttt{Stacks tag 06ZS}}
\group{adequate}
...
\begin{proof}
\uses{adequate-lemma-adjoint, adequate-lemma-adequate-affine}
...
\vcenter{
\begin{array}{ccc}\textit{Adeq}(\mathcal{O}) \underset{k}{\longrightarrow}\downarrow & \textit{Mod}((\textit{Aff}/U)_\tau, \mathcal{O}) \underset{j}{\longrightarrow} & \textit{PMod}((\textit{Aff}/U)_\tau, \mathcal{O}) \downarrow \\ \mathcal{A} \overset{i}{\longrightarrow} &  & \mathcal{P}\end{array}
}
\end{equation}
The left vertical equality is
Lemma \ref{adequate-lemma-adequate-affine}
...
Lemma \ref{adequate-lemma-abelian-adequate}
...
\source{stacks:06ZU}
\href{https://stacks.math.columbia.edu/tag/06ZU}{\texttt{Stacks tag 06ZU}}
\group{adequate}

\uses{adequate-lemma-right-adjoint-adequate}
Let $U = \Spec(A)$ be an affine scheme.
For any object $\mathcal{F}$ of $\textit{Adeq}(\mathcal{O})$
we have $R^pA(\mathcal{F}) = 0$ for all $p > 0$ where $A$ is
as in
Lemma \ref{adequate-lemma-right-adjoint-adequate}.
\end{lemma}

\begin{proof}
\uses{adequate-lemma-right-adjoint-adequate, adequate-lemma-same-cohomology-adequate, adequate-lemma-RQ-zero}
...
Lemma \ref{adequate-lemma-RQ-zero}.
\end{proof}
...
\source{stacks:06ZV}
\href{https://stacks.math.columbia.edu/tag/06ZV}{\texttt{Stacks tag 06ZV}}
\group{adequate}
...
\begin{proof}
\uses{adequate-lemma-right-adjoint-adequate, adequate-lemma-RA-zero}
...
quasi-isomorphism by Lemma \ref{adequate-lemma-RA-zero}.
...
\begin{lemma}[Ext adequate]
\label{adequate-lemma-ext-adequate}
\source{stacks:06ZW}
\href{https://stacks.math.columbia.edu/tag/06ZW}{\texttt{Stacks tag 06ZW}}
\group{adequate}
...
\source{stacks:06ZY}
\href{https://stacks.math.columbia.edu/tag/06ZY}{\texttt{Stacks tag 06ZY}}
\group{adequate}
...
\begin{lemma}[Pure projective]
\label{adequate-lemma-pure-projective}
\source{stacks:06ZZ}
\href{https://stacks.math.columbia.edu/tag/06ZZ}{\texttt{Stacks tag 06ZZ}}
\group{adequate}
...
\begin{lemma}[Pure injective]
\label{adequate-lemma-pure-injective}
\source{stacks:0700}
\href{https://stacks.math.columbia.edu/tag/0700}{\texttt{Stacks tag 0700}}
\group{adequate}
...
\begin{lemma}[Split universally exact sequence]
\label{adequate-lemma-split-universally-exact-sequence}
\source{stacks:0701}
\href{https://stacks.math.columbia.edu/tag/0701}{\texttt{Stacks tag 0701}}
\group{adequate}
...
\begin{definition}[Pure resolution]
\label{adequate-definition-pure-resolution}
\source{stacks:0702}
\href{https://stacks.math.columbia.edu/tag/0702}{\texttt{Stacks tag 0702}}
\group{adequate}
...
\begin{lemma}[Pure projective resolutions]
\label{adequate-lemma-pure-projective-resolutions}
\source{stacks:0703}
\href{https://stacks.math.columbia.edu/tag/0703}{\texttt{Stacks tag 0703}}
\group{adequate}
...
\begin{proof}
\uses{adequate-lemma-pure-projective, adequate-lemma-split-universally-exact-sequence}

Part (1) follows immediately from
Lemma \ref{adequate-lemma-pure-projective}.
Before we prove (2) and (3) note that by
Lemma \ref{adequate-lemma-split-universally-exact-sequence}
...
\begin{lemma}[Pure injective resolutions]
\label{adequate-lemma-pure-injective-resolutions}
\source{stacks:0704}
\href{https://stacks.math.columbia.edu/tag/0704}{\texttt{Stacks tag 0704}}
\group{adequate}
...
\begin{proof}
\uses{adequate-lemma-pure-projective-resolutions}

This lemma is dual to
Lemma \ref{adequate-lemma-pure-projective-resolutions}.
...
Lemma \ref{adequate-lemma-pure-injective-resolutions}
the complex
$$
\Hom_A(M, I^\bullet)
$$
...
\begin{definition}[Pure ext]
\label{adequate-definition-pure-ext}
\source{stacks:0705}
\href{https://stacks.math.columbia.edu/tag/0705}{\texttt{Stacks tag 0705}}
\group{adequate}
...
\begin{lemma}[Facts pext]
\label{adequate-lemma-facts-pext}
\source{stacks:0706}
\href{https://stacks.math.columbia.edu/tag/0706}{\texttt{Stacks tag 0706}}
\group{adequate}
...
\begin{lemma}[Pure injective injective adequate]
\label{adequate-lemma-pure-injective-injective-adequate}
\source{stacks:0708}
\href{https://stacks.math.columbia.edu/tag/0708}{\texttt{Stacks tag 0708}}
\group{adequate}
...
\source{stacks:0709}
\href{https://stacks.math.columbia.edu/tag/0709}{\texttt{Stacks tag 0709}}
\group{adequate}
...
\begin{proof}
\uses{adequate-lemma-ext-adequate, adequate-lemma-adequate-affine, adequate-lemma-right-adjoint-adequate, adequate-lemma-pure-injective-injective-adequate}
...
Lemma \ref{adequate-lemma-ext-adequate}.
...
Lemma \ref{adequate-lemma-adequate-affine}; see also the proof of
Lemma \ref{adequate-lemma-right-adjoint-adequate}.
...
Lemma \ref{adequate-lemma-pure-injective-injective-adequate}
...
\begin{remark}[D adeq independence topology]
\label{adequate-remark-D-adeq-independence-topology}
\source{stacks:070V}
\href{https://stacks.math.columbia.edu/tag/070V}{\texttt{Stacks tag 070V}}
\group{adequate}

\uses{adequate-lemma-same-cohomology-adequate}
Let $S$ be a scheme.
...
\begin{remark}[D adeq and D QCoh]
\label{adequate-remark-D-adeq-and-D-QCoh}
\source{stacks:070W}
\href{https://stacks.math.columbia.edu/tag/070W}{\texttt{Stacks tag 070W}}
\group{adequate}

\uses{adequate-remark-D-adeq-independence-topology, adequate-lemma-abelian-adequate}
...
Remark \ref{adequate-remark-D-adeq-independence-topology}
...
\source{stacks:070X}
\href{https://stacks.math.columbia.edu/tag/070X}{\texttt{Stacks tag 070X}}
\group{adequate}

\uses{adequate-remark-D-adeq-and-D-QCoh}
Remark \ref{adequate-remark-D-adeq-and-D-QCoh}
