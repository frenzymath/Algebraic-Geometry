% Source-derived chapter 10: Full version of Theorem~\ref{ThmHtInequality}
% Original source: uniformity-mordell-lang-curves
\chapter{Full version of Theorem~\ref{ThmHtInequality}}
\label{uniformity-mordell-lang-curves-chapter-10}
\source{uniformity-mordell-lang-curves}

\begin{remark}[Source section]
\label{uniformity-mordell-lang-curves-chapter-10-source}
\source{uniformity-mordell-lang-curves}
\source{uniformity-mordell-lang-curves}
...
% The source section title was: Full version of Theorem~\ref{ThmHtInequality}
\label{AppHtIneqApp}
\source{uniformity-mordell-lang-curves}
...
\begin{theorem}
\source{uniformity-mordell-lang-curves}
\notready\label{ThmHtInequalityFull}
\source{uniformity-mordell-lang-curves}
...
\begin{lemma}
\source{uniformity-mordell-lang-curves}
\notready\label{LemmaBettiRankZarOpenApp}
\source{uniformity-mordell-lang-curves}
...
\begin{definition}
\source{uniformity-mordell-lang-curves}
\notready\label{DefinitionNonDegenerateApp}
\source{uniformity-mordell-lang-curves}
