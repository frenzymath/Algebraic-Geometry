...
\begin{lemma}
\label{src-pixtons-formula-abel-jacobi-picard-stack-ch04-the-universal-double-ramification-cycle-statement-2}
\source{pixtons-formula-abel-jacobi-picard-stack}
...
\begin{definition}
\label{src-pixtons-formula-abel-jacobi-picard-stack-ch04-the-universal-double-ramification-cycle-statement-3}
\source{pixtons-formula-abel-jacobi-picard-stack}
\notready
...
\begin{remark}
\label{src-pixtons-formula-abel-jacobi-picard-stack-ch04-the-universal-double-ramification-cycle-statement-4}
\source{pixtons-formula-abel-jacobi-picard-stack}
\notready
...
\begin{proposition}
\label{src-pixtons-formula-abel-jacobi-picard-stack-ch04-the-universal-double-ramification-cycle-statement-5}
\source{pixtons-formula-abel-jacobi-picard-stack}
\notready
The Abel-Jacobi map 
$$\aj\colon \cat{Div}_{g,A} \to \Picabs_{g,n,d}$$
