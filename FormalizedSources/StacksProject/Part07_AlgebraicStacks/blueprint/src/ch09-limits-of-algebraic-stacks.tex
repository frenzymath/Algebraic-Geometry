...
\source{stacks:0CMR}
\href{https://stacks.math.columbia.edu/tag/0CMR}{\texttt{Stacks tag 0CMR}}
\group{stacks-limits}
...
$$
\begin{array}{cc}\colim \mathcal{X}_{U_i} \longrightarrow\underset{f}{\downarrow} & \mathcal{X}_U \overset{f}{\downarrow} \\ \colim \mathcal{Y}_{U_i} \longrightarrow & \mathcal{Y}_U\end{array}
$$
of fibre categories is $2$-cartesian.
\end{definition}

\begin{lemma}[Limit preserving objects]
\label{stacks-limits-lemma-limit-preserving-objects}
\source{stacks:0CMS}
\href{https://stacks.math.columbia.edu/tag/0CMS}{\texttt{Stacks tag 0CMS}}
\group{stacks-limits}

Let $S$ be a scheme. Let $f : \mathcal{X} \to \mathcal{Y}$ be a
$1$-morphism of categories fibred in groupoids over $(\Sch/S)_{fppf}$.
If $f$ is limit preserving (Definition \ref{stacks-limits-definition-limit-preserving}),
...
\source{stacks:0CMT}
\href{https://stacks.math.columbia.edu/tag/0CMT}{\texttt{Stacks tag 0CMT}}
\group{stacks-limits}
...
\source{stacks:0CMU}
\href{https://stacks.math.columbia.edu/tag/0CMU}{\texttt{Stacks tag 0CMU}}
\group{stacks-limits}
...
\source{stacks:0CMV}
\href{https://stacks.math.columbia.edu/tag/0CMV}{\texttt{Stacks tag 0CMV}}
\group{stacks-limits}
...
One direction we saw in Lemma \ref{stacks-limits-lemma-limit-preserving-objects}.
...
We claim that
$$
\begin{array}{ccc}U \downarrow\longrightarrow &  & U_i \overset{(x'_i, \text{id})}{\downarrow} \\ U_i \overset{(x_i, \text{id})}{\longrightarrow} & X_{y_i} \overset{\beta_i}{\longrightarrow} & X_{y'_i}\end{array}
$$
...
$$
\begin{array}{ccc}U_{i'} \downarrow\longrightarrow &  & U_i \overset{(x'_i, \text{id})}{\downarrow} \\ U_i \overset{(x_i, \text{id})}{\longrightarrow} & X_{y_i} \overset{\beta_i}{\longrightarrow} & X_{y'_i}\end{array}
$$
...
\begin{lemma}[Limit preserving diagonal]
\label{stacks-limits-lemma-limit-preserving-diagonal}
\source{stacks:0CMW}
\href{https://stacks.math.columbia.edu/tag/0CMW}{\texttt{Stacks tag 0CMW}}
\group{stacks-limits}
...
$$
\begin{array}{cc}\colim \mathcal{C}_i \underset{p}{\downarrow}\underset{f}{\longrightarrow} & \mathcal{C} \overset{p}{\downarrow} \\ \colim \mathcal{D}_i \overset{g}{\longrightarrow} & \mathcal{D}\end{array}
$$
Then we claim that
$$
...
$$
\begin{array}{cc}\mathcal{C}' \underset{p}{\downarrow}\underset{f}{\longrightarrow} & \mathcal{C} \overset{p}{\downarrow} \\ \mathcal{D}' \overset{g}{\longrightarrow} & \mathcal{D}\end{array}
$$
...
\begin{lemma}[Locally finite presentation limit preserving]
\label{stacks-limits-lemma-locally-finite-presentation-limit-preserving}
\source{stacks:0CMX}
\href{https://stacks.math.columbia.edu/tag/0CMX}{\texttt{Stacks tag 0CMX}}
\group{stacks-limits}
...
\source{stacks:0CMY}
\href{https://stacks.math.columbia.edu/tag/0CMY}{\texttt{Stacks tag 0CMY}}
\group{stacks-limits}
...
by Lemma \ref{stacks-limits-lemma-locally-finite-presentation-limit-preserving}.
...
By Lemma \ref{stacks-limits-lemma-representable-by-spaces-limit-preserving}
this implies that $\Delta$ is limit preserving.
By Lemma \ref{stacks-limits-lemma-limit-preserving-diagonal}
...
\source{stacks:0CPY}
\href{https://stacks.math.columbia.edu/tag/0CPY}{\texttt{Stacks tag 0CPY}}
\group{stacks-limits}
...
\source{stacks:0CPZ}
\href{https://stacks.math.columbia.edu/tag/0CPZ}{\texttt{Stacks tag 0CPZ}}
\group{stacks-limits}

In Situation \ref{stacks-limits-situation-descent} assume that $\mathcal{X}_0 \to Y_0$
...
\begin{lemma}[Descend a stack down]
\label{stacks-limits-lemma-descend-a-stack-down}
\source{stacks:0CN4}
\href{https://stacks.math.columbia.edu/tag/0CN4}{\texttt{Stacks tag 0CN4}}
\group{stacks-limits}
...
\source{stacks:0CQ1}
\href{https://stacks.math.columbia.edu/tag/0CQ1}{\texttt{Stacks tag 0CQ1}}
\group{stacks-limits}
...
$$
\begin{array}{cc}T_i \underset{q_i}{\longrightarrow}\underset{p_i}{\downarrow} & R_i \overset{t_i}{\downarrow} \\ R_i \overset{s_i}{\longrightarrow} & U_i\end{array}
$$
...
$$
\begin{array}{cc}\mathcal{X} \downarrow\longrightarrow & \mathcal{X}_i \downarrow \\ Y \longrightarrow & Y_i\end{array}
$$
(Groupoids in Spaces, Lemma
\ref{spaces-groupoids-lemma-quotient-stack-functorial}).
...
$$
\begin{array}{cc}U \downarrow\longrightarrow & U_i \downarrow \\ \mathcal{X} \longrightarrow & \mathcal{X}_i\end{array}
\quad\quad
\begin{array}{cc}U \downarrow\longrightarrow & Y \times_{Y_i} U_i \downarrow \\ \mathcal{X} \longrightarrow & Y \times_{Y_i} \mathcal{X}_i\end{array}
$$
...
\begin{lemma}[Separated closed in finite presentation]
\label{stacks-limits-lemma-separated-closed-in-finite-presentation}
\source{stacks:0CQ2}
\href{https://stacks.math.columbia.edu/tag/0CQ2}{\texttt{Stacks tag 0CQ2}}
\group{stacks-limits}
...
Lemma \ref{stacks-limits-lemma-finite-type-closed-in-finite-presentation}
...
\source{stacks:0H29}
\href{https://stacks.math.columbia.edu/tag/0H29}{\texttt{Stacks tag 0H29}}
\group{stacks-limits}
...
$$
\begin{array}{cccc}W \times_Y Z \downarrow & W \times_Y V \longleftarrow\underset{a_1}{\longrightarrow}\underset{c}{\downarrow} &  & W \times_Y Z' \overset{q}{\downarrow} \\ \mathcal{X} \times_Y Z & \mathcal{X} \times_Y V \longleftarrow\overset{a_2}{\longrightarrow} &  & \mathcal{X} \times_Y Z'\end{array}
$$
...
\source{stacks:0H2A}
\href{https://stacks.math.columbia.edu/tag/0H2A}{\texttt{Stacks tag 0H2A}}
\group{stacks-limits}
...
Apply Lemma \ref{stacks-limits-lemma-separate}.
...
$$
\begin{array}{ccc}\mathcal{X} \times_Y Z \downarrow & \mathcal{X} \times_Y V \longleftarrow\downarrow\longrightarrow & \mathcal{X} \times_Y Z' \downarrow \\ Z & V \longleftarrow\overset{a}{\longrightarrow} & Z'\end{array}
$$
...
$$
\vcenter{
\begin{array}{cc}\mathcal{X} \times_Y Z \downarrow\longrightarrow & \mathbf{A}^n \times \mathcal{X} \downarrow \\ Z \longrightarrow & \mathbf{A}^n \times Y\end{array}
}
\quad
\begin{matrix}
\text{inducing the} \\
