...
\begin{lemma}[Shriek derived]
\label{stacks-perfect-lemma-shriek-derived}
\source{stacks:07AS}
\href{https://stacks.math.columbia.edu/tag/07AS}{\texttt{Stacks tag 07AS}}
\group{stacks-perfect}
...
\begin{lemma}[Lisse etale functorial derived]
\label{stacks-perfect-lemma-lisse-etale-functorial-derived}
\source{stacks:07AV}
\href{https://stacks.math.columbia.edu/tag/07AV}{\texttt{Stacks tag 07AV}}
\group{stacks-perfect}
...
\begin{lemma}[Higher shriek quasi coherent]
\label{stacks-perfect-lemma-higher-shriek-quasi-coherent}
\source{stacks:07B3}
\href{https://stacks.math.columbia.edu/tag/07B3}{\texttt{Stacks tag 07B3}}
\group{stacks-perfect}
...
Lemma \ref{stacks-perfect-lemma-lisse-etale-functorial-derived}
...
\begin{lemma}[Higher shriek Z]
\label{stacks-perfect-lemma-higher-shriek-Z}
\source{stacks:0H0Z}
\href{https://stacks.math.columbia.edu/tag/0H0Z}{\texttt{Stacks tag 0H0Z}}
\group{stacks-perfect}

Let $\mathcal{X}$ be an algebraic stack. We have
$Lg_!\mathbf{Z} = \mathbf{Z}$ for either $Lg_!$ as in
Lemma \ref{stacks-perfect-lemma-shriek-derived} part (1) or $Lg_!$ as in
Lemma \ref{stacks-perfect-lemma-shriek-derived} part (3).
\end{lemma}
...
By Lemma \ref{stacks-perfect-lemma-lisse-etale-functorial-derived} we find
...
\source{stacks:0H10}
\href{https://stacks.math.columbia.edu/tag/0H10}{\texttt{Stacks tag 0H10}}
\group{stacks-perfect}

Let $\mathcal{X}$ be an algebraic stack. Notation as in
Lemma \ref{stacks-perfect-lemma-shriek-derived}.
\begin{enumerate}
...
We prove this for the comparison between the flat-fppf site with the
fppf site; the case of the lisse-\'etale site is exactly the same.
By Lemma \ref{stacks-perfect-lemma-higher-shriek-Z} we have $Lg_!\mathbf{Z} = \mathbf{Z}$.
Then we obtain
\begin{align*}
...
\source{stacks:07B6}
\href{https://stacks.math.columbia.edu/tag/07B6}{\texttt{Stacks tag 07B6}}
\group{stacks-perfect}
...
by Lemma \ref{stacks-perfect-lemma-derived-quasi-coherent}.}
$$
...
\begin{lemma}[Compare etale fppf QCoh]
\label{stacks-perfect-lemma-compare-etale-fppf-QCoh}
\source{stacks:07B8}
\href{https://stacks.math.columbia.edu/tag/07B8}{\texttt{Stacks tag 07B8}}
\group{stacks-perfect}
...
$$
\begin{array}{ccc}D_{\textit{Parasitic} \cap \textit{LQCoh}^{fbc}}(\mathcal{O}_\mathcal{X})
\longrightarrow & D_{\textit{LQCoh}^{fbc}}(\mathcal{O}_\mathcal{X}) \longrightarrow & D(\mathcal{O}_\mathcal{X}) \\ D_{\mathcal{P}_\mathcal{X}}(\mathcal{X}_\etale, \mathcal{O}_\mathcal{X})
\longrightarrow\overset{\epsilon^*}{\uparrow} & D_{\textit{LQCoh}^{fbc}(\mathcal{O}_\mathcal{X})}(
\mathcal{X}_\etale, \mathcal{O}_\mathcal{X})
\longrightarrow\overset{\epsilon^*}{\uparrow} & D(\mathcal{X}_\etale, \mathcal{O}_\mathcal{X})
\overset{\epsilon^*}{\uparrow}\end{array}
$$
...
\begin{lemma}[Derived quasi coherent]
\label{stacks-perfect-lemma-derived-quasi-coherent}
\source{stacks:07B9}
\href{https://stacks.math.columbia.edu/tag/07B9}{\texttt{Stacks tag 07B9}}
\group{stacks-perfect}
...
$$
\begin{array}{cc}D_\QCoh(\mathcal{O}_\mathcal{X}) \overset{g^*}{\longrightarrow} & D_\QCoh(\mathcal{O}_{\mathcal{X}_{lisse,\etale}})
\overset{Lg_!}{\longleftarrow}\end{array}
$$
\end{enumerate}
\item
Let $\mathcal{F}^\bullet$ be an object of
...
\item the functors $g^*$ and $Lg_!$ define mutually inverse functors
$$
\begin{array}{cc}D_\QCoh(\mathcal{O}_\mathcal{X}) \overset{g^*}{\longrightarrow} & D_\QCoh(\mathcal{O}_{\mathcal{X}_{flat,fppf}}) \overset{Lg_!}{\longleftarrow}\end{array}
$$
\end{enumerate}
\end{enumerate}
\end{lemma}
...
The construction of $Lg_!$ in Lemma \ref{stacks-perfect-lemma-shriek-derived}
...
Lemma \ref{stacks-perfect-lemma-higher-shriek-quasi-coherent}. Whence (c) holds.
...
$$
\begin{array}{ccc}D_{\textit{LQCoh}^{fbc}}(\mathcal{O}_\mathcal{X})
\overset{g^{-1}}{\searrow}\underset{q}{\longrightarrow} &  & D_\QCoh(\mathcal{O}_\mathcal{X}) \overset{c}{\swarrow} \\  & D_\QCoh(\mathcal{O}_{\mathcal{X}_{flat, fppf}})
\overset{Lg_!}{\nwarrow} & \end{array}
$$
...
Lemma \ref{stacks-perfect-lemma-compare-etale-fppf-QCoh}
finishes the proof.
\end{proof}
...
See Remark \ref{stacks-perfect-remark-QCoh-admissible}.

\begin{lemma}[Bousfield colocalization]
\label{stacks-perfect-lemma-bousfield-colocalization}
\source{stacks:07BA}
\href{https://stacks.math.columbia.edu/tag/07BA}{\texttt{Stacks tag 07BA}}
\group{stacks-perfect}
...
map $E' \to E$, see Lemma \ref{stacks-perfect-lemma-shriek-derived} part (4).
By Lemma \ref{stacks-perfect-lemma-derived-quasi-coherent} parts (2)(a) and (2)(c)
...
Lemma \ref{stacks-perfect-lemma-shriek-derived} part (4).
Hence $g^*P = 0$ and whence $P$ is an object of
$D_{\textit{Parasitic} \cap \textit{LQCoh}^{fbc}}(\mathcal{O}_\mathcal{X})$ by
Lemma \ref{stacks-perfect-lemma-derived-quasi-coherent} part (2)(b).
Finally, for $P'$ in
$D_{\textit{Parasitic} \cap \textit{LQCoh}^{fbc}}(\mathcal{O}_\mathcal{X})$
we have
$$
...
$$
as $g^*P' = 0$ by Lemma \ref{stacks-perfect-lemma-derived-quasi-coherent} part (2)(b).
...
\begin{remark}[QCoh admissible]
\label{stacks-perfect-remark-QCoh-admissible}
\source{stacks:0H11}
\href{https://stacks.math.columbia.edu/tag/0H11}{\texttt{Stacks tag 0H11}}
\group{stacks-perfect}

The result of Lemma \ref{stacks-perfect-lemma-bousfield-colocalization} tells us that
$$
D_{\textit{Parasitic} \cap \textit{LQCoh}^{fbc}}(\mathcal{O}_\mathcal{X})
\subset
D_{\textit{LQCoh}^{fbc}}(\mathcal{O}_\mathcal{X})
...
\begin{proposition}[Derived direct image quasi coherent]
\label{stacks-perfect-proposition-derived-direct-image-quasi-coherent}
\source{stacks:07BC}
\href{https://stacks.math.columbia.edu/tag/07BC}{\texttt{Stacks tag 07BC}}
\group{stacks-perfect}
...
$$
\begin{array}{ccc}D^{+}_{\textit{Parasitic} \cap \textit{LQCoh}^{fbc}}(\mathcal{O}_\mathcal{X})
\longrightarrow\overset{Rf_*}{\downarrow} & D^{+}_{\textit{LQCoh}^{fbc}}(\mathcal{O}_\mathcal{X})
\longrightarrow\overset{Rf_*}{\downarrow} & D(\mathcal{O}_\mathcal{X})
\overset{Rf_*}{\downarrow} \\ D^{+}_{\textit{Parasitic} \cap \textit{LQCoh}^{fbc}}(\mathcal{O}_\mathcal{Y})
\longrightarrow & D^{+}_{\textit{LQCoh}^{fbc}}(\mathcal{O}_\mathcal{Y}) \longrightarrow & D(\mathcal{O}_\mathcal{Y})\end{array}
$$
...
\begin{proposition}[Derived pullback quasi coherent]
\label{stacks-perfect-proposition-derived-pullback-quasi-coherent}
\source{stacks:07BE}
\href{https://stacks.math.columbia.edu/tag/07BE}{\texttt{Stacks tag 07BE}}
\group{stacks-perfect}

Let $f : \mathcal{X} \to \mathcal{Y}$ be a morphism of algebraic stacks.
The exact functor $f^*$ induces a commutative diagram
$$
\begin{array}{cc}D_{\textit{LQCoh}^{fbc}}(\mathcal{O}_\mathcal{X}) \longrightarrow & D(\mathcal{O}_\mathcal{X}) \\ D_{\textit{LQCoh}^{fbc}}(\mathcal{O}_\mathcal{Y})
\longrightarrow\overset{f^*}{\uparrow} & D(\mathcal{O}_\mathcal{Y}) \overset{f^*}{\uparrow}\end{array}
$$
The composition
$$
...
E' \to E \to P \to E'[1]
$$
constructed in Lemma \ref{stacks-perfect-lemma-bousfield-colocalization}.
...
$D_{\textit{Parasitic} \cap \textit{LQCoh}^{fbc}}(\mathcal{O}_\mathcal{Y})$.
By Lemma \ref{stacks-perfect-lemma-bousfield-colocalization} (and its proof)
...
by
Proposition \ref{stacks-perfect-proposition-derived-direct-image-quasi-coherent}
...
\source{stacks:0H13}
\href{https://stacks.math.columbia.edu/tag/0H13}{\texttt{Stacks tag 0H13}}
\group{stacks-perfect}
...
the morphism of topoi discussed in Section \ref{stacks-perfect-section-lisse-etale}.
...
By Lemma \ref{stacks-perfect-lemma-lisse-etale-cohomology} part (2)(b) we have
...
\begin{lemma}[Cohomology parasitic complex]
\label{stacks-perfect-lemma-cohomology-parasitic-complex}
\source{stacks:0H14}
\href{https://stacks.math.columbia.edu/tag/0H14}{\texttt{Stacks tag 0H14}}
\group{stacks-perfect}
...
Denote $g : \Sh(\mathcal{X}_{flat, fppf}) \to \Sh(\mathcal{X}_{fppf})$
the morphism of topoi discussed in Section \ref{stacks-perfect-section-lisse-etale}.
By Lemma \ref{stacks-perfect-lemma-lisse-etale-cohomology} part (2)(b) our assumption
...
what we want by Lemma \ref{stacks-perfect-lemma-lisse-etale-cohomology} part (2)(a).
\end{proof}

\begin{lemma}[Higher shriek QC]
\label{stacks-perfect-lemma-higher-shriek-QC}
\source{stacks:0H15}
\href{https://stacks.math.columbia.edu/tag/0H15}{\texttt{Stacks tag 0H15}}
\group{stacks-perfect}
...
\begin{proof}
By Lemma \ref{stacks-perfect-lemma-derived-quasi-coherent} part (2)(c) the object
...
\source{stacks:0H16}
\href{https://stacks.math.columbia.edu/tag/0H16}{\texttt{Stacks tag 0H16}}
\group{stacks-perfect}
...
\medskip\noindent
Similarly by Lemma \ref{stacks-perfect-lemma-bousfield-colocalization} and
Remark \ref{stacks-perfect-remark-QCoh-admissible} we find that
...
$$
By Lemma \ref{stacks-perfect-lemma-cohomology-parasitic} we see that $R\Gamma(x, P) = 0$
if $U \to \mathcal{X}$ is flat and hence $R\Gamma(x, H) = 0$ under the same
hypothesis. By Lemma \ref{stacks-perfect-lemma-cohomology-parasitic-complex} we conclude that
...
Lemma \ref{sites-cohomology-lemma-cartesion-plus-topology}.
By the proof of Lemma \ref{stacks-perfect-lemma-bousfield-colocalization}
and the discussion in Remark \ref{stacks-perfect-remark-QCoh-admissible}
...
$D_\QCoh(\mathcal{O}_{\mathcal{X}_{flat, fppf}})$.
Then the desired equality follow from Lemma \ref{stacks-perfect-lemma-higher-shriek-QC}.
\end{proof}
