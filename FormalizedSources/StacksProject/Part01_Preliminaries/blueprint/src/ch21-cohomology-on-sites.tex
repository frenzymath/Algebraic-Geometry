...
\source{stacks:03AH}
\href{https://stacks.math.columbia.edu/tag/03AH}{\texttt{Stacks tag 03AH}}
\group{sites-cohomology}
...
\source{stacks:03AI}
\href{https://stacks.math.columbia.edu/tag/03AI}{\texttt{Stacks tag 03AI}}
\group{sites-cohomology}
...
\source{stacks:03AJ}
\href{https://stacks.math.columbia.edu/tag/03AJ}{\texttt{Stacks tag 03AJ}}
\group{sites-cohomology}
...
\source{stacks:03F1}
\href{https://stacks.math.columbia.edu/tag/03F1}{\texttt{Stacks tag 03F1}}
\group{sites-cohomology}
...
$$
\begin{array}{ccccc}0 \longrightarrow & \mathcal{F} \longrightarrow\downarrow & \mathcal{E} \longrightarrow\downarrow & \mathcal{O} \longrightarrow\overset{\tilde \xi}{\downarrow} & 0 \\ 0 \longrightarrow & \mathcal{F} \longrightarrow & \mathcal{I} \longrightarrow & \mathcal{Q} \longrightarrow & 0\end{array}
$$
see Homology, Section \ref{homology-section-extensions}.
\end{proof}

The following lemma will be superseded by the more general
Lemma \ref{sites-cohomology-lemma-cohomology-modules-abelian-agree}.

\begin{lemma}[H1 mod ab agree]
\label{sites-cohomology-lemma-h1-mod-ab-agree}
\source{stacks:03F2}
\href{https://stacks.math.columbia.edu/tag/03F2}{\texttt{Stacks tag 03F2}}
\group{sites-cohomology}
...
we may apply
Lemma \ref{sites-cohomology-lemma-h1-extensions}
...
$$
\begin{array}{ccccc}0 \longrightarrow & \mathcal{F}_{ab} \longrightarrow\downarrow & \mathcal{E}_{ab} \longrightarrow\downarrow & \underline{\mathbf{Z}} \longrightarrow\overset{1}{\downarrow} & 0 \\ 0 \longrightarrow & \mathcal{F} \longrightarrow & \mathcal{E} \longrightarrow & \mathcal{O} \longrightarrow & 0\end{array}
$$
...
$\mathcal{F}$, like this
$$
\begin{array}{ccccc}0 \longrightarrow & \mathcal{F}_{ab} \otimes_{\underline{\mathbf{Z}}} \mathcal{O}
\longrightarrow\overset{\mu}{\downarrow} & \mathcal{E}_{ab} \otimes_{\underline{\mathbf{Z}}} \mathcal{O}
\longrightarrow\downarrow & \mathcal{O} \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & \mathcal{F} \longrightarrow & \mathcal{E} \longrightarrow & \mathcal{O} \longrightarrow & 0\end{array}
$$
...
\source{stacks:040E}
\href{https://stacks.math.columbia.edu/tag/040E}{\texttt{Stacks tag 040E}}
\group{sites-cohomology}
...
By
Lemma \ref{sites-cohomology-lemma-torsors-h1}
...
\source{stacks:03F3}
\href{https://stacks.math.columbia.edu/tag/03F3}{\texttt{Stacks tag 03F3}}
\group{sites-cohomology}
...
The following lemma will be used to see what happens if we change a
partial universe, or to compare cohomology of the small and big \'etale
sites.

\begin{lemma}[Cohomology bigger site]
\label{sites-cohomology-lemma-cohomology-bigger-site}
\source{stacks:03YU}
\href{https://stacks.math.columbia.edu/tag/03YU}{\texttt{Stacks tag 03YU}}
\group{sites-cohomology}
...
of this presheaf in Lemma \ref{sites-cohomology-lemma-include}.
...
\source{stacks:01FW}
\href{https://stacks.math.columbia.edu/tag/01FW}{\texttt{Stacks tag 01FW}}
\group{sites-cohomology}
...
\source{stacks:072W}
\href{https://stacks.math.columbia.edu/tag/072W}{\texttt{Stacks tag 072W}}
\group{sites-cohomology}
...
\source{stacks:03AM}
\href{https://stacks.math.columbia.edu/tag/03AM}{\texttt{Stacks tag 03AM}}
\group{sites-cohomology}
...
\source{stacks:03AN}
\href{https://stacks.math.columbia.edu/tag/03AN}{\texttt{Stacks tag 03AN}}
\group{sites-cohomology}
...
\source{stacks:03AQ}
\href{https://stacks.math.columbia.edu/tag/03AQ}{\texttt{Stacks tag 03AQ}}
\group{sites-cohomology}
...
\source{stacks:03AR}
\href{https://stacks.math.columbia.edu/tag/03AR}{\texttt{Stacks tag 03AR}}
\group{sites-cohomology}
...
\begin{proof}
By
Lemma \ref{sites-cohomology-lemma-cech-exact-presheaves}
...
\source{stacks:03AS}
\href{https://stacks.math.columbia.edu/tag/03AS}{\texttt{Stacks tag 03AS}}
\group{sites-cohomology}
...
\source{stacks:03AT}
\href{https://stacks.math.columbia.edu/tag/03AT}{\texttt{Stacks tag 03AT}}
\group{sites-cohomology}
...
of Lemma \ref{sites-cohomology-lemma-cech-map-into} above is exact in positive
...
$$
\begin{array}{c}\ldots \downarrow \\ \bigoplus_{i_0i_1i_2}
\mathbf{Z}[
\Mor_\mathcal{C}(V, U_{i_0} \times_U U_{i_1} \times_U U_{i_2})
]
\downarrow \\ \bigoplus_{i_0i_1}
\mathbf{Z}[
\Mor_\mathcal{C}(V, U_{i_0} \times_U U_{i_1})
]
\downarrow \\ \bigoplus_{i_0}
\mathbf{Z}[
...
$$
\begin{array}{c}\ldots \downarrow \\ \bigoplus_\varphi
\bigoplus_{i_0i_1i_2}
\mathbf{Z}[
\Mor_\varphi(V, U_{i_0} \times_U U_{i_1} \times_U U_{i_2})
]
\downarrow \\ \bigoplus_\varphi
\bigoplus_{i_0i_1}
\mathbf{Z}[
...
\begin{lemma}[The integral presheaf \v Cech complex is a flat resolution of the constant presheaf of ...]
\label{sites-cohomology-lemma-complex-tensored-still-exact}
\source{stacks:03F5}
\href{https://stacks.math.columbia.edu/tag/03F5}{\texttt{Stacks tag 03F5}}
\group{sites-cohomology}
...
is the chain complex of Lemma \ref{sites-cohomology-lemma-cech-map-into}, and
...
In the proof of Lemma \ref{sites-cohomology-lemma-homology-complex} we saw that
...
and the proof of Lemma \ref{sites-cohomology-lemma-homology-complex} shows that
...
\source{stacks:03AU}
\href{https://stacks.math.columbia.edu/tag/03AU}{\texttt{Stacks tag 03AU}}
\group{sites-cohomology}
...
Lemma \ref{sites-cohomology-lemma-cech-map-into} we have
$$
\Hom_{\textit{PAb}(\mathcal{C})}(
...
$$
By Lemma \ref{sites-cohomology-lemma-homology-complex} we have that
...
(see Lemma \ref{sites-cohomology-lemma-cech-cohomology-delta-functor-presheaves})
...
\begin{lemma}[Injective abelian sheaf injective presheaf]
\label{sites-cohomology-lemma-injective-abelian-sheaf-injective-presheaf}
\source{stacks:03F6}
\href{https://stacks.math.columbia.edu/tag/03F6}{\texttt{Stacks tag 03F6}}
\group{sites-cohomology}
...
\source{stacks:03AW}
\href{https://stacks.math.columbia.edu/tag/03AW}{\texttt{Stacks tag 03AW}}
\group{sites-cohomology}
...
\begin{proof}
By Lemma \ref{sites-cohomology-lemma-injective-abelian-sheaf-injective-presheaf}
we see that $\mathcal{I}$ is an injective object in
$\textit{PAb}(\mathcal{C})$.
Hence we can apply Lemma \ref{sites-cohomology-lemma-cech-cohomology-derived-presheaves}
(or its proof) to see the vanishing of higher {\v C}ech cohomology group.
For the zeroth see Lemma \ref{sites-cohomology-lemma-cech-h0}.
\end{proof}

\begin{lemma}[Cech cohomology]
\label{sites-cohomology-lemma-cech-cohomology}
\source{stacks:03AX}
\href{https://stacks.math.columbia.edu/tag/03AX}{\texttt{Stacks tag 03AX}}
\group{sites-cohomology}
...
Namely, Lemma \ref{sites-cohomology-lemma-injective-trivial-cech} implies that
...
\source{stacks:0A6G}
\href{https://stacks.math.columbia.edu/tag/0A6G}{\texttt{Stacks tag 0A6G}}
\group{sites-cohomology}
...
the bijection of Lemma \ref{sites-cohomology-lemma-torsors-h1}
...
$\mathcal{C}/U_i$ is trivial. By Lemma \ref{sites-cohomology-lemma-trivial-torsor}
this means there
...
\source{stacks:03AY}
\href{https://stacks.math.columbia.edu/tag/03AY}{\texttt{Stacks tag 03AY}}
\group{sites-cohomology}
...
$$
see discussion in Section \ref{sites-cohomology-section-locality}.
\end{lemma}
...
\source{stacks:03AZ}
\href{https://stacks.math.columbia.edu/tag/03AZ}{\texttt{Stacks tag 03AZ}}
\group{sites-cohomology}
...
by Lemma \ref{sites-cohomology-lemma-cech-h0}. We have that $i(\mathcal{I})$ is
{\v C}ech acyclic by Lemma \ref{sites-cohomology-lemma-injective-trivial-cech}. And we
have that $\check{H}^p(\mathcal{U}, -) = R^p\check{H}^0(\mathcal{U}, -)$
as functors on $\textit{PAb}(\mathcal{C})$
by Lemma \ref{sites-cohomology-lemma-cech-cohomology-derived-presheaves}.
...
\source{stacks:03F7}
\href{https://stacks.math.columbia.edu/tag/03F7}{\texttt{Stacks tag 03F7}}
\group{sites-cohomology}
...
\source{stacks:03F8}
\href{https://stacks.math.columbia.edu/tag/03F8}{\texttt{Stacks tag 03F8}}
\group{sites-cohomology}
...
\begin{lemma}[Cech vanish collection]
\label{sites-cohomology-lemma-cech-vanish-collection}
\source{stacks:03F9}
\href{https://stacks.math.columbia.edu/tag/03F9}{\texttt{Stacks tag 03F9}}
\group{sites-cohomology}
...
By Lemma \ref{sites-cohomology-lemma-injective-trivial-cech} $\mathcal{I}$
...
$$
By Lemma \ref{sites-cohomology-lemma-ses-cech-h1} and our assumption (2)
...
\source{stacks:0CK0}
\href{https://stacks.math.columbia.edu/tag/0CK0}{\texttt{Stacks tag 0CK0}}
\group{sites-cohomology}
...
\begin{lemma}[Injective module injective presheaf]
\label{sites-cohomology-lemma-injective-module-injective-presheaf}
\source{stacks:03FB}
\href{https://stacks.math.columbia.edu/tag/03FB}{\texttt{Stacks tag 03FB}}
\group{sites-cohomology}
...
\begin{lemma}[Include modules]
\label{sites-cohomology-lemma-include-modules}
\source{stacks:06YK}
\href{https://stacks.math.columbia.edu/tag/06YK}{\texttt{Stacks tag 06YK}}
\group{sites-cohomology}
...
$$
see discussion in
Section \ref{sites-cohomology-section-locality}.
\end{lemma}
...
\begin{lemma}[Injective module trivial cech]
\label{sites-cohomology-lemma-injective-module-trivial-cech}
\source{stacks:03FC}
\href{https://stacks.math.columbia.edu/tag/03FC}{\texttt{Stacks tag 03FC}}
\group{sites-cohomology}
...
\begin{proof}
Lemma \ref{sites-cohomology-lemma-cech-map-into} gives the first equality in the following
...
By Lemma \ref{sites-cohomology-lemma-injective-module-injective-presheaf}
we see that $\mathcal{I}$ is an injective object in
$\textit{PMod}(\mathcal{O})$.
Hence $\Hom_{\textit{PMod}(\mathcal{O})}(-, \mathcal{I})$
is an exact functor. By
Lemma \ref{sites-cohomology-lemma-complex-tensored-still-exact} we see the vanishing of
higher {\v C}ech cohomology groups.
For the zeroth see Lemma \ref{sites-cohomology-lemma-cech-h0}.
\end{proof}

\begin{lemma}[Cohomology modules abelian agree]
\label{sites-cohomology-lemma-cohomology-modules-abelian-agree}
\source{stacks:03FD}
\href{https://stacks.math.columbia.edu/tag/03FD}{\texttt{Stacks tag 03FD}}
\group{sites-cohomology}
...
Apply Lemma \ref{sites-cohomology-lemma-cech-vanish-collection}
with $\mathcal{F} = \mathcal{I}$, $\mathcal{B} = \mathcal{C}$
and $\text{Cov} = \text{Cov}_\mathcal{C}$.
Assumption (3) of that lemma holds by
Lemma \ref{sites-cohomology-lemma-injective-module-trivial-cech}.
...
\source{stacks:060L}
\href{https://stacks.math.columbia.edu/tag/060L}{\texttt{Stacks tag 060L}}
\group{sites-cohomology}
...
$\xi|_{U_j} = 0$ for all $j$. By Lemma \ref{sites-cohomology-lemma-cech-h1} this means
$\xi$ comes from an element
$\check \xi \in \check H^1(\mathcal{U}, \mathcal{F})$.
Since the maps
$\check H^1(\mathcal{U}, \mathcal{F}_i) \to H^1(U, \mathcal{F}_i)$
are injective for all $i$ (by Lemma \ref{sites-cohomology-lemma-cech-h1}), and since
...
\begin{lemma}[Restriction along monomorphism surjective]
\label{sites-cohomology-lemma-restriction-along-monomorphism-surjective}
\source{stacks:093X}
\href{https://stacks.math.columbia.edu/tag/093X}{\texttt{Stacks tag 093X}}
\group{sites-cohomology}
...
\begin{lemma}[Compute cohomology on sheaf sets]
\label{sites-cohomology-lemma-compute-cohomology-on-sheaf-sets}
\source{stacks:079Y}
\href{https://stacks.math.columbia.edu/tag/079Y}{\texttt{Stacks tag 079Y}}
\group{sites-cohomology}
...
\begin{lemma}[Cech to cohomology sheaf sets]
\label{sites-cohomology-lemma-cech-to-cohomology-sheaf-sets}
\source{stacks:079Z}
\href{https://stacks.math.columbia.edu/tag/079Z}{\texttt{Stacks tag 079Z}}
\group{sites-cohomology}
...
to cohomology spectral sequence of Lemma \ref{sites-cohomology-lemma-cech-spectral-sequence}
whose $E_1$ page is as indicated in the statement of the lemma.
\end{proof}

\begin{lemma}[Cohomology on sheaf sets]
\label{sites-cohomology-lemma-cohomology-on-sheaf-sets}
\source{stacks:07A0}
\href{https://stacks.math.columbia.edu/tag/07A0}{\texttt{Stacks tag 07A0}}
\group{sites-cohomology}
...
Lemma \ref{sites-cohomology-lemma-cohomology-of-open}.
\end{proof}

Keeping in mind Lemma \ref{sites-cohomology-lemma-compute-cohomology-on-sheaf-sets}
we see that the following definition is the ``correct one'' also
for sheaves of modules on ringed sites.

\begin{definition}[Limp]
\label{sites-cohomology-definition-limp}
\source{stacks:072Y}
\href{https://stacks.math.columbia.edu/tag/072Y}{\texttt{Stacks tag 072Y}}
\group{sites-cohomology}
...
\begin{lemma}[Characterize limp]
\label{sites-cohomology-lemma-characterize-limp}
\source{stacks:07A1}
\href{https://stacks.math.columbia.edu/tag/07A1}{\texttt{Stacks tag 07A1}}
\group{sites-cohomology}
...
\begin{lemma}[Direct image injective sheaf]
\label{sites-cohomology-lemma-direct-image-injective-sheaf}
\source{stacks:072Z}
\href{https://stacks.math.columbia.edu/tag/072Z}{\texttt{Stacks tag 072Z}}
\group{sites-cohomology}
...
\source{stacks:0730}
\href{https://stacks.math.columbia.edu/tag/0730}{\texttt{Stacks tag 0730}}
\group{sites-cohomology}
...
\begin{lemma}[Limp acyclic]
\label{sites-cohomology-lemma-limp-acyclic}
\source{stacks:0731}
\href{https://stacks.math.columbia.edu/tag/0731}{\texttt{Stacks tag 0731}}
\group{sites-cohomology}
...
\begin{remark}[Before Leray]
\label{sites-cohomology-remark-before-Leray}
\source{stacks:08J6}
\href{https://stacks.math.columbia.edu/tag/08J6}{\texttt{Stacks tag 08J6}}
\group{sites-cohomology}
...
Lemma \ref{sites-cohomology-lemma-limp-acyclic}.
\end{remark}
...
\source{stacks:0732}
\href{https://stacks.math.columbia.edu/tag/0732}{\texttt{Stacks tag 0732}}
\group{sites-cohomology}
...
Derived Categories, Lemma \ref{derived-lemma-grothendieck-spectral-sequence}
are satisfied, see
Lemmas \ref{sites-cohomology-lemma-direct-image-injective-sheaf} and
...
\source{stacks:0733}
\href{https://stacks.math.columbia.edu/tag/0733}{\texttt{Stacks tag 0733}}
\group{sites-cohomology}
...
\source{stacks:0734}
\href{https://stacks.math.columbia.edu/tag/0734}{\texttt{Stacks tag 0734}}
\group{sites-cohomology}
...
the general case is treated in Remark \ref{sites-cohomology-remark-base-change}.
...
\source{stacks:0736}
\href{https://stacks.math.columbia.edu/tag/0736}{\texttt{Stacks tag 0736}}
\group{sites-cohomology}

Let
$$
\begin{array}{cc}(\Sh(\mathcal{C}'), \mathcal{O}_{\mathcal{C}'})
\underset{g'}{\longrightarrow}\underset{f'}{\downarrow} & (\Sh(\mathcal{C}), \mathcal{O}_\mathcal{C}) \overset{f}{\downarrow} \\ (\Sh(\mathcal{D}'), \mathcal{O}_{\mathcal{D}'})
\overset{g}{\longrightarrow} & (\Sh(\mathcal{D}), \mathcal{O}_\mathcal{D})\end{array}
$$
...
By Lemma \ref{sites-cohomology-lemma-pushforward-injective-flat} we see that
...
\begin{lemma}[Colim works over collection]
\label{sites-cohomology-lemma-colim-works-over-collection}
\source{stacks:0739}
\href{https://stacks.math.columbia.edu/tag/0739}{\texttt{Stacks tag 0739}}
\group{sites-cohomology}
...
$$
\begin{array}{cccc}\colim_i H^p(U, \mathcal{I}_i) \downarrow\longrightarrow & \colim_i H^p(U, \mathcal{Q}_i) \downarrow\longrightarrow & \colim_i H^{p + 1}(U, \mathcal{F}_i) \downarrow\longrightarrow & 0 \downarrow \\ H^p(U, \colim_i \mathcal{I}_i) \longrightarrow & H^p(U, \colim_i \mathcal{Q}_i) \longrightarrow & H^{p + 1}(U, \colim_i \mathcal{F}_i) \longrightarrow & 0\end{array}
$$
...
\begin{lemma}[Colim global]
\label{sites-cohomology-lemma-colim-global}
\source{stacks:0GN3}
\href{https://stacks.math.columbia.edu/tag/0GN3}{\texttt{Stacks tag 0GN3}}
\group{sites-cohomology}
...
$$
of Lemma \ref{sites-cohomology-lemma-cech-to-cohomology-sheaf-sets}. Recall that
$H^q(K^{p + 1}, \mathcal{F}) = H^q(\mathcal{C}/K^{p + 1}, j^{-1}\mathcal{F})$,
for any abelian sheaf on $\mathcal{C}$, see
Lemma \ref{sites-cohomology-lemma-cohomology-on-sheaf-sets}. We have
...
on $\mathcal{C}/K^{p + 1}$ by Lemma \ref{sites-cohomology-lemma-cohomology-of-open}.
...
\begin{remark}[Colim global]
\label{sites-cohomology-remark-colim-global}
\source{stacks:0GN4}
\href{https://stacks.math.columbia.edu/tag/0GN4}{\texttt{Stacks tag 0GN4}}
\group{sites-cohomology}
...
Lemma \ref{sites-cohomology-lemma-colim-global}? One answer is that it suffices if
\begin{enumerate}
...
\source{stacks:0H7B}
\href{https://stacks.math.columbia.edu/tag/0H7B}{\texttt{Stacks tag 0H7B}}
\group{sites-cohomology}
...
Lemma \ref{sites-cohomology-lemma-higher-direct-images}. Similarly,
...
\begin{lemma}[Colim sites injective]
\label{sites-cohomology-lemma-colim-sites-injective}
\source{stacks:0EXZ}
\href{https://stacks.math.columbia.edu/tag/0EXZ}{\texttt{Stacks tag 0EXZ}}
\group{sites-cohomology}
...
Lemma \ref{sites-cohomology-lemma-pushforward-injective-flat} and
...
\source{stacks:09YP}
\href{https://stacks.math.columbia.edu/tag/09YP}{\texttt{Stacks tag 09YP}}
\group{sites-cohomology}

In the situation of Lemma \ref{sites-cohomology-lemma-colim-sites-injective} set
...
as in Lemma \ref{sites-cohomology-lemma-colim-sites-injective}.
...
Lemma \ref{sites-cohomology-lemma-injective-trivial-cech}. See
Algebra, Lemma \ref{algebra-lemma-directed-colimit-exact}.
\end{proof}
...
\source{stacks:06YM}
\href{https://stacks.math.columbia.edu/tag/06YM}{\texttt{Stacks tag 06YM}}
\group{sites-cohomology}
...
\source{stacks:06YN}
\href{https://stacks.math.columbia.edu/tag/06YN}{\texttt{Stacks tag 06YN}}
\group{sites-cohomology}
...
\source{stacks:06YP}
\href{https://stacks.math.columbia.edu/tag/06YP}{\texttt{Stacks tag 06YP}}
\group{sites-cohomology}
...
\begin{proof}
Follows from
Lemma \ref{sites-cohomology-lemma-derived-tor-exact}
and the fact that quasi-isomorphisms are characterized by having
acyclic cones.
\end{proof}

\begin{lemma}[Restriction K flat]
\label{sites-cohomology-lemma-restriction-K-flat}
\source{stacks:0E8K}
\href{https://stacks.math.columbia.edu/tag/0E8K}{\texttt{Stacks tag 0E8K}}
\group{sites-cohomology}
...
\source{stacks:07A2}
\href{https://stacks.math.columbia.edu/tag/07A2}{\texttt{Stacks tag 07A2}}
\group{sites-cohomology}
...
\source{stacks:07A3}
\href{https://stacks.math.columbia.edu/tag/07A3}{\texttt{Stacks tag 07A3}}
\group{sites-cohomology}
...
\source{stacks:0G7B}
\href{https://stacks.math.columbia.edu/tag/0G7B}{\texttt{Stacks tag 0G7B}}
\group{sites-cohomology}
...
\source{stacks:06YQ}
\href{https://stacks.math.columbia.edu/tag/06YQ}{\texttt{Stacks tag 06YQ}}
\group{sites-cohomology}
...
\source{stacks:06YR}
\href{https://stacks.math.columbia.edu/tag/06YR}{\texttt{Stacks tag 06YR}}
\group{sites-cohomology}
...
\source{stacks:077J}
\href{https://stacks.math.columbia.edu/tag/077J}{\texttt{Stacks tag 077J}}
\group{sites-cohomology}
...
\source{stacks:06YS}
\href{https://stacks.math.columbia.edu/tag/06YS}{\texttt{Stacks tag 06YS}}
\group{sites-cohomology}
...
Lemma \ref{sites-cohomology-lemma-resolution-by-direct-sums-extensions-by-zero}.
...
Lemma \ref{sites-cohomology-lemma-bounded-flat-K-flat}.
Thus $\colim \mathcal{K}_n^\bullet$ is K-flat by
Lemma \ref{sites-cohomology-lemma-colimit-K-flat}.
The induced map
$\colim \mathcal{K}_n^\bullet \to \mathcal{G}^\bullet$
is a quasi-isomorphism and termwise surjective by construction.
Property (3) of Lemma \ref{sites-cohomology-lemma-resolution-by-direct-sums-extensions-by-zero}
...
\source{stacks:06YT}
\href{https://stacks.math.columbia.edu/tag/06YT}{\texttt{Stacks tag 06YT}}
\group{sites-cohomology}
...
Lemma \ref{sites-cohomology-lemma-K-flat-resolution}.
Consider the commutative diagram
$$
\begin{array}{cc}\text{Tot}(\mathcal{K}^\bullet
\otimes_\mathcal{O} \mathcal{P}^\bullet) \longrightarrow\downarrow & \text{Tot}(\mathcal{K}^\bullet
\otimes_\mathcal{O} \mathcal{Q}^\bullet) \downarrow \\ \text{Tot}(\mathcal{F}^\bullet
\otimes_\mathcal{O} \mathcal{P}^\bullet) \longrightarrow & \text{Tot}(\mathcal{F}^\bullet
\otimes_\mathcal{O} \mathcal{Q}^\bullet)\end{array}
$$
The result follows as by
Lemma \ref{sites-cohomology-lemma-K-flat-quasi-isomorphism}
...
As the category of $K$-flat resolutions of $\mathcal{F}^\bullet$ is
cofiltered and as we have
Lemma \ref{sites-cohomology-lemma-derived-tor-quasi-isomorphism-other-side}
...
\source{stacks:06YU}
\href{https://stacks.math.columbia.edu/tag/06YU}{\texttt{Stacks tag 06YU}}
\group{sites-cohomology}
...
\source{stacks:08FF}
\href{https://stacks.math.columbia.edu/tag/08FF}{\texttt{Stacks tag 08FF}}
\group{sites-cohomology}
...
$$
\begin{array}{cccc}\mathcal{F}_1 \otimes_\mathcal{O} \mathcal{G} \longrightarrow & \mathcal{F}_2 \otimes_\mathcal{O} \mathcal{G} \longrightarrow & \mathcal{F}_3 \otimes_\mathcal{O} \mathcal{G} \longrightarrow & 0 \\ \text{Tor}_1^\mathcal{O}(\mathcal{F}_1, \mathcal{G}) \longrightarrow & \text{Tor}_1^\mathcal{O}(\mathcal{F}_2, \mathcal{G}) \longrightarrow & \text{Tor}_1^\mathcal{O}(\mathcal{F}_3, \mathcal{G}) \nwarrow & \end{array}
$$
...
\source{stacks:08FG}
\href{https://stacks.math.columbia.edu/tag/08FG}{\texttt{Stacks tag 08FG}}
\group{sites-cohomology}
...
\begin{lemma}[K flat flat acyclic]
\label{sites-cohomology-lemma-K-flat-flat-acyclic}
\source{stacks:0G7C}
\href{https://stacks.math.columbia.edu/tag/0G7C}{\texttt{Stacks tag 0G7C}}
\group{sites-cohomology}
...
of flat modules is K-flat (Lemma \ref{sites-cohomology-lemma-bounded-flat-K-flat})
...
and we conclude by Lemma \ref{sites-cohomology-lemma-flat-tor-zero}.
\end{proof}

\begin{lemma}[Factor through K flat]
\label{sites-cohomology-lemma-factor-through-K-flat}
\source{stacks:0G7D}
\href{https://stacks.math.columbia.edu/tag/0G7D}{\texttt{Stacks tag 0G7D}}
\group{sites-cohomology}
...
By Lemma \ref{sites-cohomology-lemma-K-flat-two-out-of-three} we see that
...
\source{stacks:0G7E}
\href{https://stacks.math.columbia.edu/tag/0G7E}{\texttt{Stacks tag 0G7E}}
\group{sites-cohomology}
...
Choose a diagram
$$
\begin{array}{ccc}\mathcal{K}_1^\bullet \downarrow\longrightarrow & \mathcal{K}_2^\bullet \downarrow\longrightarrow & \ldots \\ \tau_{\leq 1}\mathcal{K}^\bullet \longrightarrow & \tau_{\leq 2}\mathcal{K}^\bullet \longrightarrow & \ldots\end{array}
$$
as in Lemma \ref{sites-cohomology-lemma-resolution-by-direct-sums-extensions-by-zero}.
...
$$
defining $\mathcal{M}^\bullet$. By Lemmas \ref{sites-cohomology-lemma-bounded-flat-K-flat} and
\ref{sites-cohomology-lemma-colimit-K-flat} the complex $\colim \mathcal{K}_n^\bullet$
...
Lemma \ref{sites-cohomology-lemma-K-flat-two-out-of-three-ses}
...
Hence by Lemma \ref{sites-cohomology-lemma-K-flat-two-out-of-three-ses}
...
with flat terms. Then Lemma \ref{sites-cohomology-lemma-K-flat-flat-acyclic}
...
\source{stacks:06YY}
\href{https://stacks.math.columbia.edu/tag/06YY}{\texttt{Stacks tag 06YY}}
\group{sites-cohomology}
...
Namely, (1) follows from Lemma \ref{sites-cohomology-lemma-K-flat-resolution}
...
Lemma \ref{sites-cohomology-lemma-pullback-K-flat}
...
by Lemma \ref{sites-cohomology-lemma-bounded-flat-K-flat}.
\end{proof}

\begin{lemma}[Derived pullback composition]
\label{sites-cohomology-lemma-derived-pullback-composition}
\source{stacks:0D6D}
\href{https://stacks.math.columbia.edu/tag/0D6D}{\texttt{Stacks tag 0D6D}}
\group{sites-cohomology}
...
with flat terms, see Lemma \ref{sites-cohomology-lemma-K-flat-resolution}.
By construction $Lg^*E$ is computed by $g^*\mathcal{K}^\bullet$, see
Lemma \ref{sites-cohomology-lemma-derived-base-change}.
By Lemma \ref{sites-cohomology-lemma-pullback-K-flat} the complex
...
\source{stacks:07A4}
\href{https://stacks.math.columbia.edu/tag/07A4}{\texttt{Stacks tag 07A4}}
\group{sites-cohomology}
...
The complex
$\text{Tot}(\mathcal{F}^\bullet \otimes_{\mathcal{O}'} \mathcal{G}^\bullet)$
is K-flat with flat terms by Lemma \ref{sites-cohomology-lemma-tensor-product-K-flat} and
...
\source{stacks:08I6}
\href{https://stacks.math.columbia.edu/tag/08I6}{\texttt{Stacks tag 08I6}}
\group{sites-cohomology}
...
\source{stacks:0DEN}
\href{https://stacks.math.columbia.edu/tag/0DEN}{\texttt{Stacks tag 0DEN}}
\group{sites-cohomology}
...
Lemma \ref{sites-cohomology-lemma-K-flat-resolution}. Any pullback
of $\mathcal{L}^\bullet$ is K-flat, see
Lemma \ref{sites-cohomology-lemma-pullback-K-flat}. In particular the stalk
$\mathcal{L}_p^\bullet$ is a K-flat complex of $\mathcal{O}_p$-modules.
Thus the cone $C(a)$ on $a$ is a K-flat
(Lemma \ref{sites-cohomology-lemma-K-flat-two-out-of-three})
...
By Lemma \ref{sites-cohomology-lemma-restriction-K-flat}
...
\begin{lemma}[Pullback K flat points]
\label{sites-cohomology-lemma-pullback-K-flat-points}
\source{stacks:0DEP}
\href{https://stacks.math.columbia.edu/tag/0DEP}{\texttt{Stacks tag 0DEP}}
\group{sites-cohomology}
...
\begin{proof}
This follows from Lemma \ref{sites-cohomology-lemma-check-K-flat-stalks},
...
\source{stacks:0FPH}
\href{https://stacks.math.columbia.edu/tag/0FPH}{\texttt{Stacks tag 0FPH}}
\group{sites-cohomology}
...
\mathcal{M}^\bullet) \downarrow \\ Lf^*\mathcal{K}^\bullet \otimes_{\mathcal{O}_\mathcal{C}}^\mathbf{L}
Lf^*\mathcal{M}^\bullet \downarrow & f^*\text{Tot}(\mathcal{K}^\bullet
\otimes_{\mathcal{O}_\mathcal{D}}
\mathcal{M}^\bullet) \downarrow \\ f^*\mathcal{K}^\bullet \otimes_{\mathcal{O}_\mathcal{C}}^\mathbf{L}
f^*\mathcal{M}^\bullet \longrightarrow & \text{Tot}(f^*\mathcal{K}^\bullet \otimes_{\mathcal{O}_\mathcal{C}}
...
(Lemma \ref{sites-cohomology-lemma-K-flat-resolution}), we will use that derived pullback
is computed by such complexes (Lemma \ref{sites-cohomology-lemma-derived-base-change}),
and that pullbacks preserve these properties
(Lemma \ref{sites-cohomology-lemma-pullback-K-flat}). If we choose such
...
\otimes_{\mathcal{O}_\mathcal{D}}
\mathcal{M}^\bullet) \downarrow \\ \text{Tot}(f^*\mathcal{P}^\bullet \otimes_{\mathcal{O}_\mathcal{C}}
f^*\mathcal{Q}^\bullet) \longrightarrow & \text{Tot}(f^*\mathcal{K}^\bullet \otimes_{\mathcal{O}_\mathcal{C}}
f^*\mathcal{M}^\bullet)\end{array}
$$
...
Lemma \ref{sites-cohomology-lemma-tensor-product-K-flat}.
\end{proof}
...
\source{stacks:07A6}
\href{https://stacks.math.columbia.edu/tag/07A6}{\texttt{Stacks tag 07A6}}
\group{sites-cohomology}
...
Lemma \ref{sites-cohomology-lemma-derived-base-change} are adjoint:
$$
...
\source{stacks:0D6E}
\href{https://stacks.math.columbia.edu/tag/0D6E}{\texttt{Stacks tag 0D6E}}
\group{sites-cohomology}
...
\begin{proof}
By Lemma \ref{sites-cohomology-lemma-adjoint} we see that $Rg_* \circ Rf_*$
is adjoint to $Lf^* \circ Lg^*$. We have
$Lf^* \circ Lg^* = L(g \circ f)^*$ by
Lemma \ref{sites-cohomology-lemma-derived-pullback-composition}
and hence by
...
\source{stacks:07A7}
\href{https://stacks.math.columbia.edu/tag/07A7}{\texttt{Stacks tag 07A7}}
\group{sites-cohomology}
...
\source{stacks:0E46}
\href{https://stacks.math.columbia.edu/tag/0E46}{\texttt{Stacks tag 0E46}}
\group{sites-cohomology}

Consider a commutative diagram
$$
\begin{array}{cc}(\Sh(\mathcal{B}'), \mathcal{O}_{\mathcal{B}'})
\underset{k}{\longrightarrow}\underset{f'}{\downarrow} & (\Sh(\mathcal{B}), \mathcal{O}_\mathcal{B}) \overset{f}{\downarrow} \\ (\Sh(\mathcal{C}'), \mathcal{O}_{\mathcal{C}'})
\overset{l}{\longrightarrow}\underset{g'}{\downarrow} & (\Sh(\mathcal{C}), \mathcal{O}_\mathcal{C}) \overset{g}{\downarrow} \\ (\Sh(\mathcal{D}'), \mathcal{O}_{\mathcal{D}'})
\overset{m}{\longrightarrow} & (\Sh(\mathcal{D}), \mathcal{O}_\mathcal{D}) \\  & \end{array}
$$
...
\source{stacks:0E47}
\href{https://stacks.math.columbia.edu/tag/0E47}{\texttt{Stacks tag 0E47}}
\group{sites-cohomology}

Consider a commutative diagram
$$
\begin{array}{ccc}(\Sh(\mathcal{C}''), \mathcal{O}_{\mathcal{C}''})
\underset{g'}{\longrightarrow}\underset{f''}{\downarrow} & (\Sh(\mathcal{C}'), \mathcal{O}_{\mathcal{C}'})
\underset{g}{\longrightarrow}\underset{f'}{\downarrow} & (\Sh(\mathcal{C}), \mathcal{O}_\mathcal{C}) \overset{f}{\downarrow} \\ (\Sh(\mathcal{D}''), \mathcal{O}_{\mathcal{D}''})
\overset{h'}{\longrightarrow} & (\Sh(\mathcal{D}'), \mathcal{O}_{\mathcal{D}'})
\overset{h}{\longrightarrow} & (\Sh(\mathcal{D}), \mathcal{O}_\mathcal{D})\end{array}
$$
of ringed topoi. Then the base change maps of
Remark \ref{sites-cohomology-remark-base-change}
for the two squares compose to give the base
...
\source{stacks:0FPI}
\href{https://stacks.math.columbia.edu/tag/0FPI}{\texttt{Stacks tag 0FPI}}
\group{sites-cohomology}
...
\ref{sites-cohomology-lemma-K-flat-resolution}, \ref{sites-cohomology-lemma-derived-base-change}, and
\ref{sites-cohomology-lemma-pullback-K-flat} and the discussion above.
...
\source{stacks:0B6C}
\href{https://stacks.math.columbia.edu/tag/0B6C}{\texttt{Stacks tag 0B6C}}
\group{sites-cohomology}
...
(Lemma \ref{sites-cohomology-lemma-pullback-tensor-product})
with the map
$Lf^*Rf_*K \otimes_{\mathcal{O}_\mathcal{C}}^\mathbf{L} Lf^*Rf_*L
...
\source{stacks:0DD7}
\href{https://stacks.math.columbia.edu/tag/0DD7}{\texttt{Stacks tag 0DD7}}
\group{sites-cohomology}
...
\source{stacks:08FI}
\href{https://stacks.math.columbia.edu/tag/08FI}{\texttt{Stacks tag 08FI}}
\group{sites-cohomology}
...
\source{stacks:0D6F}
\href{https://stacks.math.columbia.edu/tag/0D6F}{\texttt{Stacks tag 0D6F}}
\group{sites-cohomology}
...
\source{stacks:0BKV}
\href{https://stacks.math.columbia.edu/tag/0BKV}{\texttt{Stacks tag 0BKV}}
\group{sites-cohomology}
...
holds by Lemma \ref{sites-cohomology-lemma-unbounded-cohomology-of-open}.
...
\source{stacks:0D6G}
\href{https://stacks.math.columbia.edu/tag/0D6G}{\texttt{Stacks tag 0D6G}}
\group{sites-cohomology}
...
\source{stacks:0D6H}
\href{https://stacks.math.columbia.edu/tag/0D6H}{\texttt{Stacks tag 0D6H}}
\group{sites-cohomology}
...
follows from Lemma \ref{sites-cohomology-lemma-derived-pushforward-composition}
applied to
$$
...
after applying Lemma \ref{sites-cohomology-lemma-restrict-direct-image-open}.
\end{proof}

\begin{lemma}[Unbounded describe higher direct images]
\label{sites-cohomology-lemma-unbounded-describe-higher-direct-images}
\source{stacks:0D6I}
\href{https://stacks.math.columbia.edu/tag/0D6I}{\texttt{Stacks tag 0D6I}}
\group{sites-cohomology}
...
Lemma \ref{sites-cohomology-lemma-Leray-unbounded}. Then the statement on sheafification
follows from Lemma \ref{sites-cohomology-lemma-sheafification-cohomology}.
\end{proof}

\begin{lemma}[Modules abelian unbounded]
\label{sites-cohomology-lemma-modules-abelian-unbounded}
\source{stacks:0D6J}
\href{https://stacks.math.columbia.edu/tag/0D6J}{\texttt{Stacks tag 0D6J}}
\group{sites-cohomology}
...
By Lemmas \ref{sites-cohomology-lemma-unbounded-cohomology-of-open} and
...
see discussion in Section \ref{sites-cohomology-section-flat}.)
...
Lemmas \ref{sites-cohomology-lemma-derived-tor-quasi-isomorphism-other-side} and
\ref{sites-cohomology-lemma-bounded-flat-K-flat}.
...
\source{stacks:08FJ}
\href{https://stacks.math.columbia.edu/tag/08FJ}{\texttt{Stacks tag 08FJ}}
\group{sites-cohomology}
...
By Lemma \ref{sites-cohomology-lemma-restrict-K-injective-to-open} the complex
...
\source{stacks:0GL1}
\href{https://stacks.math.columbia.edu/tag/0GL1}{\texttt{Stacks tag 0GL1}}
\group{sites-cohomology}
...
\source{stacks:093Y}
\href{https://stacks.math.columbia.edu/tag/093Y}{\texttt{Stacks tag 093Y}}
\group{sites-cohomology}
...
\begin{lemma}[Hom K injective]
\label{sites-cohomology-lemma-hom-K-injective}
\source{stacks:093Z}
\href{https://stacks.math.columbia.edu/tag/093Z}{\texttt{Stacks tag 093Z}}
\group{sites-cohomology}
...
\source{stacks:0EZ0}
\href{https://stacks.math.columbia.edu/tag/0EZ0}{\texttt{Stacks tag 0EZ0}}
\group{sites-cohomology}

Let $\mathcal{C}$ be a site. Let
$$
\begin{array}{cc}X' \downarrow\longrightarrow & X \downarrow \\ Y' \longrightarrow & Y\end{array}
$$
...
representing $E$. By Lemma \ref{sites-cohomology-lemma-restrict-K-injective-to-open}
...
\begin{lemma}[Localize cartesian square modules]
\label{sites-cohomology-lemma-localize-cartesian-square-modules}
\source{stacks:0FN5}
\href{https://stacks.math.columbia.edu/tag/0FN5}{\texttt{Stacks tag 0FN5}}
\group{sites-cohomology}
...
Lemma \ref{sites-cohomology-lemma-modules-abelian-unbounded} it suffices
to prove the result on derived categories of abelian sheaves
which we did in
Lemma \ref{sites-cohomology-lemma-localize-cartesian-square}.
\end{proof}
...
\source{stacks:0GYQ}
\href{https://stacks.math.columbia.edu/tag/0GYQ}{\texttt{Stacks tag 0GYQ}}
\group{sites-cohomology}
...
\source{stacks:0GYR}
\href{https://stacks.math.columbia.edu/tag/0GYR}{\texttt{Stacks tag 0GYR}}
\group{sites-cohomology}
...
\begin{proof}
The proof is exactly the same as the proof of Lemma \ref{sites-cohomology-lemma-ML-general}.
...
$$
constructed as in the proof of Lemma \ref{sites-cohomology-lemma-ML-general}.
...
\source{stacks:0GYS}
\href{https://stacks.math.columbia.edu/tag/0GYS}{\texttt{Stacks tag 0GYS}}
\group{sites-cohomology}
...
\source{stacks:0GYT}
\href{https://stacks.math.columbia.edu/tag/0GYT}{\texttt{Stacks tag 0GYT}}
\group{sites-cohomology}
...
Lemma \ref{sites-cohomology-lemma-topology-I-adic-general}.
In fact, the result will follow from the arguments given there
as soon as we show that
$\bigoplus N_n$ is a graded $\bigoplus_{n \geq 0} I^n/I^{n + 1}$-submodule
of $\bigoplus H^{p + 1}(\mathcal{C}, I^n\mathcal{F}_{n + 1})$
...
In the proof of Lemma \ref{sites-cohomology-lemma-ML-general-better}
...
\begin{lemma}[Derived limit is ok]
\label{sites-cohomology-lemma-derived-limit-is-ok}
\source{stacks:0941}
\href{https://stacks.math.columbia.edu/tag/0941}{\texttt{Stacks tag 0941}}
\group{sites-cohomology}
...
\source{stacks:0D6K}
\href{https://stacks.math.columbia.edu/tag/0D6K}{\texttt{Stacks tag 0D6K}}
\group{sites-cohomology}
...
\source{stacks:0A07}
\href{https://stacks.math.columbia.edu/tag/0A07}{\texttt{Stacks tag 0A07}}
\group{sites-cohomology}
...
$$
\begin{array}{cc}\Sh(\mathcal{C} \times \mathbf{N}) \underset{g}{\longrightarrow}\underset{f \times 1}{\downarrow} & \Sh(\mathcal{C}) \underset{f}{\downarrow} \\ \Sh(\mathcal{C}' \times \mathbf{N}) \overset{g'}{\longrightarrow} & \Sh(\mathcal{C}')\end{array}
$$
of morphisms of topoi. It follows that
$R\lim R(f \times 1)_*K = Rf_* R\lim K$. Working through the definitions
and using Lemma \ref{sites-cohomology-lemma-derived-limit-is-ok}
...
However, since $Rf_*$ is a right adjoint by Lemma \ref{sites-cohomology-lemma-adjoint}
...
\source{stacks:0BKW}
\href{https://stacks.math.columbia.edu/tag/0BKW}{\texttt{Stacks tag 0BKW}}
\group{sites-cohomology}
...
By Lemma \ref{sites-cohomology-lemma-sheafification-cohomology} we see that
...
\end{equation}
by Lemma \ref{sites-cohomology-lemma-RGamma-commutes-with-Rlim}.
\end{remark}
...
\source{stacks:0BKY}
\href{https://stacks.math.columbia.edu/tag/0BKY}{\texttt{Stacks tag 0BKY}}
\group{sites-cohomology}
...
of Remark \ref{sites-cohomology-remark-discuss-derived-limit} and assumption (2) we see that for
...
\source{stacks:0D6L}
\href{https://stacks.math.columbia.edu/tag/0D6L}{\texttt{Stacks tag 0D6L}}
\group{sites-cohomology}
...
$U \mapsto H^m(U, R\lim K_n)$ (by Lemma \ref{sites-cohomology-lemma-sheafification-cohomology})
...
(by Lemma \ref{sites-cohomology-lemma-sheafification-cohomology} again)
...
\lim H^m(V_i, K_n) \to 0
$$
of Lemma \ref{sites-cohomology-lemma-RGamma-commutes-with-Rlim}.
...
\begin{lemma}[Is limit per object]
\label{sites-cohomology-lemma-is-limit-per-object}
\source{stacks:0D6M}
\href{https://stacks.math.columbia.edu/tag/0D6M}{\texttt{Stacks tag 0D6M}}
\group{sites-cohomology}
...
(1) and (2) of Lemma \ref{sites-cohomology-lemma-cohomology-derived-limit-injective}
...
\source{stacks:0D6N}
\href{https://stacks.math.columbia.edu/tag/0D6N}{\texttt{Stacks tag 0D6N}}
\group{sites-cohomology}
...
\begin{proof}
This follows from Lemma \ref{sites-cohomology-lemma-is-limit-per-object}
...
\source{stacks:08U3}
\href{https://stacks.math.columbia.edu/tag/08U3}{\texttt{Stacks tag 08U3}}
\group{sites-cohomology}
...
\begin{proof}
Apply Lemma \ref{sites-cohomology-lemma-is-limit-per-object}
...
\source{stacks:0D6P}
\href{https://stacks.math.columbia.edu/tag/0D6P}{\texttt{Stacks tag 0D6P}}
\group{sites-cohomology}
...
\begin{proof}
Apply Lemma \ref{sites-cohomology-lemma-is-limit-spaltenstein}
...
\source{stacks:0BKZ}
\href{https://stacks.math.columbia.edu/tag/0BKZ}{\texttt{Stacks tag 0BKZ}}
\group{sites-cohomology}
...
Lemma \ref{sites-cohomology-lemma-is-limit-dimension} with $d = 0$.
...
\source{stacks:0A09}
\href{https://stacks.math.columbia.edu/tag/0A09}{\texttt{Stacks tag 0A09}}
\group{sites-cohomology}
...
Remark \ref{sites-cohomology-remark-discuss-derived-limit}. Let $U \in \mathcal{B}$.
By Lemma \ref{sites-cohomology-lemma-cohomology-over-U-trivial} and (2)(a)
...
\source{stacks:070Q}
\href{https://stacks.math.columbia.edu/tag/070Q}{\texttt{Stacks tag 070Q}}
\group{sites-cohomology}
...
$p > p(m)$, see Lemma \ref{sites-cohomology-lemma-is-limit}.}.
\end{enumerate}
...
is an isomorphism. This follows from Lemma \ref{sites-cohomology-lemma-is-limit-dimension}.
\end{proof}
...
\source{stacks:08CT}
\href{https://stacks.math.columbia.edu/tag/08CT}{\texttt{Stacks tag 08CT}}
\group{sites-cohomology}
...
\begin{definition}[Situation: Olsson laszlo]
\label{sites-cohomology-situation-olsson-laszlo}
\source{stacks:0D6R}
\href{https://stacks.math.columbia.edu/tag/0D6R}{\texttt{Stacks tag 0D6R}}
\group{sites-cohomology}
...
\begin{lemma}[Olsson laszlo]
\label{sites-cohomology-lemma-olsson-laszlo}
\source{stacks:0D6S}
\href{https://stacks.math.columbia.edu/tag/0D6S}{\texttt{Stacks tag 0D6S}}
\group{sites-cohomology}
...
for sites.
\end{reference}
In Situation \ref{sites-cohomology-situation-olsson-laszlo} for any
...
\begin{proof}
Follows immediately from Lemma \ref{sites-cohomology-lemma-is-limit-spaltenstein}.
\end{proof}

\begin{lemma}[Olsson laszlo modified]
\label{sites-cohomology-lemma-olsson-laszlo-modified}
\source{stacks:0D6T}
\href{https://stacks.math.columbia.edu/tag/0D6T}{\texttt{Stacks tag 0D6T}}
\group{sites-cohomology}

In Situation \ref{sites-cohomology-situation-olsson-laszlo} let
...
$\text{Cov}_V$ of Situation \ref{sites-cohomology-situation-olsson-laszlo}.
...
Lemma \ref{sites-cohomology-lemma-cohomology-derived-limit-injective}.
...
Situation \ref{sites-cohomology-situation-olsson-laszlo}.
Pick $n_0$ such that
$$
\begin{matrix}
\mathcal{H}^{j + 1} & = & H^{j + 1}(K_n), \\
...
of $U \mapsto H^j(U, K_{n_0})$ by Lemma \ref{sites-cohomology-lemma-sheafification-cohomology}.
...
Lemma \ref{sites-cohomology-lemma-RGamma-commutes-with-Rlim}.
This finishes the proof.
\end{proof}

\begin{lemma}[Olsson laszlo map version one]
\label{sites-cohomology-lemma-olsson-laszlo-map-version-one}
\source{stacks:0D6U}
\href{https://stacks.math.columbia.edu/tag/0D6U}{\texttt{Stacks tag 0D6U}}
\group{sites-cohomology}
...
assumption of Situation \ref{sites-cohomology-situation-olsson-laszlo},
\item $\mathcal{C}', \mathcal{O}', \mathcal{A}'$ satisfy the
assumption of Situation \ref{sites-cohomology-situation-olsson-laszlo},
...
\begin{proof}
By Lemma \ref{sites-cohomology-lemma-olsson-laszlo} we have $K = R\lim \tau_{\geq -n}K$.
By Lemma \ref{sites-cohomology-lemma-Rf-commutes-with-Rlim}
...
Lemma \ref{sites-cohomology-lemma-olsson-laszlo-modified} to conclude.
\end{proof}

It turns out that we sometimes need a variant of the lemma above
where the assumptions are slightly different.

\begin{definition}[Situation: Olsson laszlo prime]
\label{sites-cohomology-situation-olsson-laszlo-prime}
\source{stacks:0D6V}
\href{https://stacks.math.columbia.edu/tag/0D6V}{\texttt{Stacks tag 0D6V}}
\group{sites-cohomology}
...
\begin{lemma}[Olsson laszlo map version two]
\label{sites-cohomology-lemma-olsson-laszlo-map-version-two}
\source{stacks:0D6W}
\href{https://stacks.math.columbia.edu/tag/0D6W}{\texttt{Stacks tag 0D6W}}
\group{sites-cohomology}
...
Situation \ref{sites-cohomology-situation-olsson-laszlo-prime},
\item $R^pf_*\mathcal{F} = 0$ for
$p > N$ and $\mathcal{F} \in \Ob(\mathcal{A})$,
\end{enumerate}
...
$$
The assumption in Situation \ref{sites-cohomology-situation-olsson-laszlo-prime}
...
Lemma \ref{sites-cohomology-lemma-RGamma-commutes-with-Rlim} this gives that
$$
...
Thus Lemma \ref{sites-cohomology-lemma-cohomology-derived-limit-injective}
implies that
$$
...
commutative diagram
$$
\begin{array}{cc}E \downarrow\longrightarrow & Y \downarrow \\ Z \longrightarrow & X\end{array}
$$
...
\begin{lemma}[C square]
\label{sites-cohomology-lemma-c-square}
\source{stacks:0F16}
\href{https://stacks.math.columbia.edu/tag/0F16}{\texttt{Stacks tag 0F16}}
\group{sites-cohomology}
...
\begin{lemma}[Two out of three blow up square]
\label{sites-cohomology-lemma-two-out-of-three-blow-up-square}
\source{stacks:0EWP}
\href{https://stacks.math.columbia.edu/tag/0EWP}{\texttt{Stacks tag 0EWP}}
\group{sites-cohomology}
...
\begin{lemma}[Square triangle]
\label{sites-cohomology-lemma-square-triangle}
\source{stacks:0EVY}
\href{https://stacks.math.columbia.edu/tag/0EVY}{\texttt{Stacks tag 0EVY}}
\group{sites-cohomology}
...
\end{enumerate}
Then the construction of Lemma \ref{sites-cohomology-lemma-c-square}
...
abelian sheaves, see Section \ref{sites-cohomology-section-unbounded}.
...
\begin{lemma}[Square triangle general]
\label{sites-cohomology-lemma-square-triangle-general}
\source{stacks:0EVZ}
\href{https://stacks.math.columbia.edu/tag/0EVZ}{\texttt{Stacks tag 0EVZ}}
\group{sites-cohomology}

Let $\mathcal{C}$ be a site. Consider a commutative diagram
$$
\begin{array}{cc}\mathcal{D} \longrightarrow\downarrow & \mathcal{F} \downarrow \\ \mathcal{E} \longrightarrow & \mathcal{G}\end{array}
$$
...
is the cohomology discussed in Section \ref{sites-cohomology-section-limp}.
\end{lemma}
...
In this case the result follows from
Lemma \ref{sites-cohomology-lemma-square-triangle}.
\end{proof}
...
\begin{lemma}[Downstairs]
\label{sites-cohomology-lemma-downstairs}
\source{stacks:0D7Q}
\href{https://stacks.math.columbia.edu/tag/0D7Q}{\texttt{Stacks tag 0D7Q}}
\group{sites-cohomology}
...
pair of functors $(Lf^*, Rf_*)$, see Lemma \ref{sites-cohomology-lemma-adjoint}.
...
\begin{lemma}[Upstairs]
\label{sites-cohomology-lemma-upstairs}
\source{stacks:0D7R}
\href{https://stacks.math.columbia.edu/tag/0D7R}{\texttt{Stacks tag 0D7R}}
\group{sites-cohomology}
...
\begin{lemma}[Bounded in image upstairs]
\label{sites-cohomology-lemma-bounded-in-image-upstairs}
\source{stacks:0D7S}
\href{https://stacks.math.columbia.edu/tag/0D7S}{\texttt{Stacks tag 0D7S}}
\group{sites-cohomology}
...
Lemma \ref{sites-cohomology-lemma-upstairs}. Hence $K$ is in it too.
\end{proof}

\begin{lemma}[Bounded in image downstairs]
\label{sites-cohomology-lemma-bounded-in-image-downstairs}
\source{stacks:0D7T}
\href{https://stacks.math.columbia.edu/tag/0D7T}{\texttt{Stacks tag 0D7T}}
\group{sites-cohomology}
...
Lemma \ref{sites-cohomology-lemma-downstairs}. Hence $K$ is in it too.
\end{proof}

\begin{lemma}[Equivalence bounded]
\label{sites-cohomology-lemma-equivalence-bounded}
\source{stacks:0D7U}
\href{https://stacks.math.columbia.edu/tag/0D7U}{\texttt{Stacks tag 0D7U}}
\group{sites-cohomology}
...
Lemmas \ref{sites-cohomology-lemma-bounded-in-image-downstairs} and \ref{sites-cohomology-lemma-downstairs}
we see that
$f^* : D_{\mathcal{A}'}^+(\mathcal{O}') \to D_\mathcal{A}^+(\mathcal{O})$
is fully faithful.
...
Lemmas \ref{sites-cohomology-lemma-bounded-in-image-upstairs} and \ref{sites-cohomology-lemma-upstairs}
...
\begin{lemma}[Equivalence unbounded one]
\label{sites-cohomology-lemma-equivalence-unbounded-one}
\source{stacks:0D7V}
\href{https://stacks.math.columbia.edu/tag/0D7V}{\texttt{Stacks tag 0D7V}}
\group{sites-cohomology}
...
see Lemma \ref{sites-cohomology-lemma-equivalence-bounded}.
By Lemma \ref{sites-cohomology-lemma-olsson-laszlo-map-version-one}
...
\begin{lemma}[Equivalence unbounded two]
\label{sites-cohomology-lemma-equivalence-unbounded-two}
\source{stacks:0D7W}
\href{https://stacks.math.columbia.edu/tag/0D7W}{\texttt{Stacks tag 0D7W}}
\group{sites-cohomology}
...
of Lemma \ref{sites-cohomology-lemma-equivalence-unbounded-one}
except the reference to Lemma \ref{sites-cohomology-lemma-olsson-laszlo-map-version-one}
...
(\mathcal{C}_{\tau'}, \mathcal{O}_{\tau'})
$$
For more discussion, see Section \ref{sites-cohomology-section-compare}.

\begin{lemma}[Compare topologies derived adequate modules]
\label{sites-cohomology-lemma-compare-topologies-derived-adequate-modules}
\source{stacks:07A8}
\href{https://stacks.math.columbia.edu/tag/07A8}{\texttt{Stacks tag 07A8}}
\group{sites-cohomology}
...
$$
\begin{array}{ccccc}\mathcal{F}'_0 \longrightarrow\downarrow & \mathcal{F}'_1 \longrightarrow\downarrow & \mathcal{F}'_2 \longrightarrow\downarrow & \mathcal{F}'_3 \longrightarrow\downarrow & \mathcal{F}'_4 \downarrow \\ \epsilon_*\epsilon^*\mathcal{F}'_0 \longrightarrow & \epsilon_*\epsilon^*\mathcal{F}'_1 \longrightarrow & \epsilon_*\epsilon^*\mathcal{F}'_2 \longrightarrow & \epsilon_*\epsilon^*\mathcal{F}'_3 \longrightarrow & \epsilon_*\epsilon^*\mathcal{F}'_4\end{array}
$$
...
(1) -- (5) of Lemma \ref{sites-cohomology-lemma-equivalence-unbounded-two} apply.
...
condition (4) of Lemma \ref{sites-cohomology-lemma-equivalence-unbounded-two} is satisfied.
Similarly, condition (5) is satisfied as well.
\end{proof}

\begin{lemma}[Descent squares]
\label{sites-cohomology-lemma-descent-squares}
\source{stacks:0F18}
\href{https://stacks.math.columbia.edu/tag/0F18}{\texttt{Stacks tag 0F18}}
\group{sites-cohomology}
...
$$
\begin{array}{cc}E_\alpha \downarrow\longrightarrow & Y_\alpha \downarrow \\ Z_\alpha \longrightarrow & X_\alpha\end{array}
$$
...
of Lemma \ref{sites-cohomology-lemma-c-square}
...
By (2) and Lemma \ref{sites-cohomology-lemma-two-out-of-three-blow-up-square}
we see that $M'$ has (P). On the other hand, applying
$\epsilon^{-1}$ and using that $\epsilon^{-1}R\epsilon_* = \text{id}$
by Section \ref{sites-cohomology-section-compare} we find that $\epsilon^{-1}M' = 0$.
...
$$
by Lemma \ref{sites-cohomology-lemma-c-square}. Taking cohomology in degree $n$ and using
...
\begin{lemma}[Descent squares helper]
\label{sites-cohomology-lemma-descent-squares-helper}
\source{stacks:0F19}
\href{https://stacks.math.columbia.edu/tag/0F19}{\texttt{Stacks tag 0F19}}
\group{sites-cohomology}
...
$R\epsilon_*$ the map $c^{K'}_{X, Z, Y, E}$ of Lemma \ref{sites-cohomology-lemma-c-square}
...
Lemma \ref{sites-cohomology-lemma-K-injective-flat}. Next,
$$
0 \to
...
Lemma \ref{sites-cohomology-lemma-square-triangle} and its proof.
...
$\mathcal{C}$, $\tau$, and $\tau'$ as in Section \ref{sites-cohomology-section-compare}
...
\vcenter{
\begin{array}{cc}\Sh(\mathcal{C}_\tau/X) \underset{f_\tau}{\longrightarrow}\underset{\epsilon_X}{\downarrow} & \Sh(\mathcal{C}_\tau/Y) \overset{\epsilon_Y}{\downarrow} \\ \Sh(\mathcal{C}_{\tau'}/X) \overset{f_{\tau'}}{\longrightarrow} & \Sh(\mathcal{C}_{\tau'}/X)\end{array}
}
\end{equation}
Here the morphism $\epsilon_X$, resp.\ $\epsilon_Y$ is the comparison
morphism of Section \ref{sites-cohomology-section-compare} for the
...
\begin{definition}[Situation: Compare]
\label{sites-cohomology-situation-compare}
\source{stacks:0EZ3}
\href{https://stacks.math.columbia.edu/tag/0EZ3}{\texttt{Stacks tag 0EZ3}}
\group{sites-cohomology}

With $\mathcal{C}$, $\tau$, and $\tau'$ as in Section \ref{sites-cohomology-section-compare}.
...
\source{stacks:0EZ9}
\href{https://stacks.math.columbia.edu/tag/0EZ9}{\texttt{Stacks tag 0EZ9}}
\group{sites-cohomology}

In Situation \ref{sites-cohomology-situation-compare} for $X$ in $\mathcal{C}$
denote $\mathcal{A}_X$
...
Our next goal is to prove Lemmas \ref{sites-cohomology-lemma-compare-cohomology-general} and
\ref{sites-cohomology-lemma-cohomological-descent-general}. We will do this by an induction
...
\begin{lemma}[V implies C general]
\label{sites-cohomology-lemma-V-implies-C-general}
\source{stacks:0EZA}
\href{https://stacks.math.columbia.edu/tag/0EZA}{\texttt{Stacks tag 0EZA}}
\group{sites-cohomology}

In Situation \ref{sites-cohomology-situation-compare} assume $(V_n)$ holds.
...
Lemma \ref{sites-cohomology-lemma-relative-Leray}
...
(use the description of $\epsilon_*$ in Section \ref{sites-cohomology-section-compare}).
However, the $\tau$-sheafification of the $\tau'$-sheaf
$R^{n + 1}\epsilon_{Y, *}f_{\tau, *}\mathcal{F}$
is zero (by locality of cohomology; use
Lemmas \ref{sites-cohomology-lemma-kill-cohomology-class-on-covering} and
...
\begin{lemma}[V implies cohomology general]
\label{sites-cohomology-lemma-V-implies-cohomology-general}
\source{stacks:0EZB}
\href{https://stacks.math.columbia.edu/tag/0EZB}{\texttt{Stacks tag 0EZB}}
\group{sites-cohomology}

In Situation \ref{sites-cohomology-situation-compare} if $(V_n)$ holds, then
...
\begin{proof}
By Lemma \ref{sites-cohomology-lemma-Leray-unbounded} we have
...
\begin{lemma}[V implies cohomology extra general]
\label{sites-cohomology-lemma-V-implies-cohomology-extra-general}
\source{stacks:0EZC}
\href{https://stacks.math.columbia.edu/tag/0EZC}{\texttt{Stacks tag 0EZC}}
\group{sites-cohomology}

In Situation \ref{sites-cohomology-situation-compare} if $(V_n)$ holds, then for
...
by $\epsilon_X$. The Leray spectral sequence (Lemma \ref{sites-cohomology-lemma-Leray})
$$
...
\begin{lemma}[Make class zero general]
\label{sites-cohomology-lemma-make-class-zero-general}
\source{stacks:0EZD}
\href{https://stacks.math.columbia.edu/tag/0EZD}{\texttt{Stacks tag 0EZD}}
\group{sites-cohomology}

In Situation \ref{sites-cohomology-situation-compare} let $f : X \to Y$
be in $\mathcal{P}$ such that $\{X \to Y\}$ is a $\tau$-covering.
Let $\mathcal{F}'$ be in $\mathcal{A}'_Y$. If $n \geq 0$ and
$$
\theta \in
\text{Equalizer}\left(
\begin{array}{cc}H^{n + 1}_{\tau'}(X, \mathcal{F}')
\longrightarrow\longrightarrow & H^{n + 1}_{\tau'}(X \times_Y X, \mathcal{F}')\end{array}
\right)
$$
...
$$
\begin{array}{cc}X \times_Y X \underset{\text{pr}_1}{\downarrow}\underset{\text{pr}_2}{\longrightarrow} & X \overset{f}{\downarrow} \\ X \overset{f}{\longrightarrow} & Y\end{array}
$$
By trivial base change (Lemma \ref{sites-cohomology-lemma-localize-cartesian-square})
we have
$$
...
\begin{lemma}[Induction step V C general]
\label{sites-cohomology-lemma-induction-step-V-C-general}
\source{stacks:0EZE}
\href{https://stacks.math.columbia.edu/tag/0EZE}{\texttt{Stacks tag 0EZE}}
\group{sites-cohomology}

In Situation \ref{sites-cohomology-situation-compare} we have $(V_n) \Rightarrow (V_{n + 1})$.
\end{lemma}
...
\medskip\noindent
By Lemma \ref{sites-cohomology-lemma-V-implies-cohomology-extra-general} there exists a
...
(by uniqueness).
By Lemma \ref{sites-cohomology-lemma-make-class-zero-general}
...
$$
Use Lemma \ref{sites-cohomology-lemma-Leray-unbounded}.
...
$$
used in the proof of Lemma \ref{sites-cohomology-lemma-V-implies-C-general}
...
$$
which is an isomorphism by Lemma \ref{sites-cohomology-lemma-V-implies-C-general};
the lemma applies because $f_\tau^{-1}\mathcal{F}$ is in $\mathcal{A}_X$
by Lemma \ref{sites-cohomology-lemma-A}. Choose a distinguished triangle
$$
...
By Lemma \ref{sites-cohomology-lemma-V-implies-cohomology-general} we have
$$
...
\begin{lemma}[V C all n general]
\label{sites-cohomology-lemma-V-C-all-n-general}
\source{stacks:0EZF}
\href{https://stacks.math.columbia.edu/tag/0EZF}{\texttt{Stacks tag 0EZF}}
\group{sites-cohomology}

In Situation \ref{sites-cohomology-situation-compare} we have that
...
Lemma \ref{sites-cohomology-lemma-induction-step-V-C-general}.
...
Then Lemma \ref{sites-cohomology-lemma-V-implies-C-general} gives
$\epsilon_Y^{-1}R^if_{\tau', *}\mathcal{F}' =
R^if_{\tau, *}\epsilon_X^{-1}\mathcal{F}'$ for all $i$
and the proof is complete.
\end{proof}

\begin{lemma}[Cohomological descent general]
\label{sites-cohomology-lemma-cohomological-descent-general}
\source{stacks:0EZG}
\href{https://stacks.math.columbia.edu/tag/0EZG}{\texttt{Stacks tag 0EZG}}
\group{sites-cohomology}

In Situation \ref{sites-cohomology-situation-compare}. For any $X$ in
...
$$
Vanishing by Lemma \ref{sites-cohomology-lemma-V-C-all-n-general}.
...
have $(V_n)$ for all $n$ by Lemma \ref{sites-cohomology-lemma-V-C-all-n-general}.
Thus we conclude by Lemma \ref{sites-cohomology-lemma-equivalence-bounded}.
\end{proof}

\begin{lemma}[Compare cohomology general]
\label{sites-cohomology-lemma-compare-cohomology-general}
\source{stacks:0EZH}
\href{https://stacks.math.columbia.edu/tag/0EZH}{\texttt{Stacks tag 0EZH}}
\group{sites-cohomology}

In Situation \ref{sites-cohomology-situation-compare}. Let $X$ be in $\mathcal{C}$.
\begin{enumerate}
...
\begin{proof}
This follows from Lemma \ref{sites-cohomology-lemma-V-C-all-n-general}
by Remark \ref{sites-cohomology-remark-before-Leray}.
\end{proof}
...
\begin{lemma}[LC basic]
\label{sites-cohomology-lemma-LC-basic}
\source{stacks:09WZ}
\href{https://stacks.math.columbia.edu/tag/09WZ}{\texttt{Stacks tag 09WZ}}
\group{sites-cohomology}
...
\begin{definition}[Covering LC]
\label{sites-cohomology-definition-covering-LC}
\source{stacks:09X0}
\href{https://stacks.math.columbia.edu/tag/09X0}{\texttt{Stacks tag 09X0}}
\group{sites-cohomology}
...
\source{stacks:09X1}
\href{https://stacks.math.columbia.edu/tag/09X1}{\texttt{Stacks tag 09X1}}
\group{sites-cohomology}
...
\begin{lemma}[Proper surjective is qc covering]
\label{sites-cohomology-lemma-proper-surjective-is-qc-covering}
\source{stacks:09X5}
\href{https://stacks.math.columbia.edu/tag/09X5}{\texttt{Stacks tag 09X5}}
\group{sites-cohomology}
...
Besides some set theoretic issues Lemma \ref{sites-cohomology-lemma-qc} shows that
...
\source{stacks:09X2}
\href{https://stacks.math.columbia.edu/tag/09X2}{\texttt{Stacks tag 09X2}}
\group{sites-cohomology}
...
Remark \ref{sites-cohomology-remark-set-theoretic-LC}. Namely, given an object
...
$$
See Section \ref{sites-cohomology-section-compare}.
...
\begin{lemma}[Describe pullback pi]
\label{sites-cohomology-lemma-describe-pullback-pi}
\source{stacks:09X3}
\href{https://stacks.math.columbia.edu/tag/09X3}{\texttt{Stacks tag 09X3}}
\group{sites-cohomology}
...
\begin{lemma}[Collect true things Zar]
\label{sites-cohomology-lemma-collect-true-things-Zar}
\source{stacks:0DCU}
\href{https://stacks.math.columbia.edu/tag/0DCU}{\texttt{Stacks tag 0DCU}}
\group{sites-cohomology}
...
$$
\begin{array}{cc}\Sh(\textit{LC}_{Zar}/X) \underset{f_{Zar}}{\longrightarrow}\underset{\pi_X}{\downarrow} & \Sh(\textit{LC}_{Zar}/Y) \overset{\pi_Y}{\downarrow} \\ \Sh(X_{Zar}) \overset{f}{\longrightarrow} & \Sh(Y_{Zar})\end{array}
$$
of topoi,
...
should apply Lemma \ref{sites-cohomology-lemma-cohomology-bigger-site} to the functor
...
$\pi_X^{-1}$ in Lemma \ref{sites-cohomology-lemma-describe-pullback-pi}.
...
fibre product
$$
\begin{array}{cc}Z' \underset{f'}{\longrightarrow}\underset{g'}{\downarrow} & Z \overset{g}{\downarrow} \\ X \overset{f}{\longrightarrow} & Y\end{array}
$$
Then we have
$$
...
$$
the second equality by Lemma \ref{sites-cohomology-lemma-describe-pullback-pi}.
On the other hand
$$
(\pi_Y^{-1}f_*\mathcal{F})(Z/Y) = \Gamma(Z, g^{-1}f_*\mathcal{F})
$$
again by Lemma \ref{sites-cohomology-lemma-describe-pullback-pi}.
...
In the situation of Lemma \ref{sites-cohomology-lemma-describe-pullback-pi}
...
\begin{lemma}[Push pull LC]
\label{sites-cohomology-lemma-push-pull-LC}
\source{stacks:0D92}
\href{https://stacks.math.columbia.edu/tag/0D92}{\texttt{Stacks tag 0D92}}
\group{sites-cohomology}
...
$$
\vcenter{
\begin{array}{cc}\Sh(\textit{LC}_{qc}/X) \underset{f_{qc}}{\longrightarrow}\underset{\epsilon_X}{\downarrow} & \Sh(\textit{LC}_{qc}/Y) \overset{\epsilon_Y}{\downarrow} \\ \Sh(\textit{LC}_{Zar}/X) \overset{f_{Zar}}{\longrightarrow} & \Sh(\textit{LC}_{Zar}/Y)\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}\Sh(\textit{LC}_{qc}/X) \underset{f_{qc}}{\longrightarrow}\underset{a_X}{\downarrow} & \Sh(\textit{LC}_{qc}/Y) \overset{a_Y}{\downarrow} \\ \Sh(X) \overset{f}{\longrightarrow} & \Sh(Y)\end{array}
}
$$
...
and because of part (5) of Lemma \ref{sites-cohomology-lemma-collect-true-things-Zar}.

\medskip\noindent
Proof of the final assertion. The reader may repeat the proof of part (7a) of
Lemma \ref{sites-cohomology-lemma-collect-true-things-Zar}; we will instead deduce this from it.
As $\epsilon_{Y, *}$ is the identity functor on underlying presheaves,
it reflects isomorphisms. The description
in Lemma \ref{sites-cohomology-lemma-describe-pullback-pi}
...
(7a) of Lemma \ref{sites-cohomology-lemma-collect-true-things-Zar}.
\end{proof}

\begin{lemma}[Compare qc zar]
\label{sites-cohomology-lemma-compare-qc-zar}
\source{stacks:0EZI}
\href{https://stacks.math.columbia.edu/tag/0EZI}{\texttt{Stacks tag 0EZI}}
\group{sites-cohomology}
...
of Situation \ref{sites-cohomology-situation-compare} hold.
\end{lemma}
...
fully faithful by Lemma \ref{sites-cohomology-lemma-collect-true-things-Zar} part (3). If
...
is exact by Lemma \ref{sites-cohomology-lemma-collect-true-things-Zar} part (2).
Hence $\mathcal{G} = \pi_X^{-1}\pi_{X, *}\mathcal{G}$ is in
$\mathcal{A}'_X$ which checks the final condition.

\medskip\noindent
Property (\ref{item-base-change-P}) holds by Lemma \ref{sites-cohomology-lemma-LC-basic}
...
diagram (5) in Lemma \ref{sites-cohomology-lemma-collect-true-things-Zar}.

\medskip\noindent
Property (\ref{item-A-sheaf}) is Lemma \ref{sites-cohomology-lemma-describe-pullback-pi}.

\medskip\noindent
Property (\ref{item-A-and-P}) is Lemma \ref{sites-cohomology-lemma-collect-true-things-Zar}
part (7)(b).
...
hence a $qc$ covering by Lemma \ref{sites-cohomology-lemma-proper-surjective-is-qc-covering}.
Since we can do this for every $u \in U$ we see that
(\ref{item-refine-tau-by-P}) holds.
\end{proof}

\begin{lemma}[V C all n]
\label{sites-cohomology-lemma-V-C-all-n}
\source{stacks:0DCY}
\href{https://stacks.math.columbia.edu/tag/0DCY}{\texttt{Stacks tag 0DCY}}
\group{sites-cohomology}
...
\begin{proof}
By Lemma \ref{sites-cohomology-lemma-compare-qc-zar} the lemmas in
Section \ref{sites-cohomology-section-compare-general} all apply to our current setting.
To translate the results
observe that the category $\mathcal{A}_X$ of Lemma \ref{sites-cohomology-lemma-A}
is the essential image of
$a_X^{-1} : \textit{Ab}(X) \to \textit{Ab}(\textit{LC}_{qc}/X)$.

\medskip\noindent
Part (1) is equivalent to $(V_n)$ for all $n$ which holds by
Lemma \ref{sites-cohomology-lemma-V-C-all-n-general}.

\medskip\noindent
Part (2) follows by applying $\epsilon_Y^{-1}$ to the conclusion of
Lemma \ref{sites-cohomology-lemma-V-implies-C-general}.

\medskip\noindent
Part (3) follows from Lemma \ref{sites-cohomology-lemma-V-C-all-n-general} part (1)
because $\pi_X^{-1}K$ is in $D^+_{\mathcal{A}'_X}(\textit{LC}_{Zar}/X)$
and $a_X^{-1} = \epsilon_X^{-1} \circ a_X^{-1}$.

\medskip\noindent
Part (4) follows from Lemma \ref{sites-cohomology-lemma-V-C-all-n-general} part (2)
for the same reason.
\end{proof}

\begin{lemma}[Cohomological descent LC]
\label{sites-cohomology-lemma-cohomological-descent-LC}
\source{stacks:0D91}
\href{https://stacks.math.columbia.edu/tag/0D91}{\texttt{Stacks tag 0D91}}
\group{sites-cohomology}
...
\medskip\noindent
By Lemma \ref{sites-cohomology-lemma-describe-pullback-pi} we have
...
the Leray spectral sequence Lemma \ref{sites-cohomology-lemma-relative-Leray}.
By Lemma \ref{sites-cohomology-lemma-V-C-all-n}
we have $R^i\epsilon_{X, *}(a_X^{-1}\mathcal{F}) = 0$ for $i > 0$
and $\epsilon_{X, *}a_X^{-1}\mathcal{F} = \pi_X^{-1}\mathcal{F}$.
By Lemma \ref{sites-cohomology-lemma-collect-true-things-Zar} we have
$R^j\pi_{X, *}(\pi_X^{-1}\mathcal{F}) = 0$ for $j > 0$.
This concludes the proof.
\end{proof}

\begin{lemma}[Compare cohomology LC]
\label{sites-cohomology-lemma-compare-cohomology-LC}
\source{stacks:09X4}
\href{https://stacks.math.columbia.edu/tag/09X4}{\texttt{Stacks tag 09X4}}
\group{sites-cohomology}
...
\begin{proof}
This follows from Lemma \ref{sites-cohomology-lemma-cohomological-descent-LC}
by Remark \ref{sites-cohomology-remark-before-Leray}.
\end{proof}
...
\begin{example}[Hom complex into sheaf]
\label{sites-cohomology-example-hom-complex-into-sheaf}
\source{stacks:07AA}
\href{https://stacks.math.columbia.edu/tag/07AA}{\texttt{Stacks tag 07AA}}
\group{sites-cohomology}
...
as in Remark \ref{sites-cohomology-remark-cup-product}.
...
\source{stacks:0FPK}
\href{https://stacks.math.columbia.edu/tag/0FPK}{\texttt{Stacks tag 0FPK}}
\group{sites-cohomology}
...
\otimes_{\mathcal{O}_\mathcal{D}}^\mathbf{L}
Rf_*\mathcal{M}^\bullet \overset{\text{Remark \ref{sites-cohomology-remark-cup-product}}}{\downarrow} \\ \text{Tot}(
f_*\mathcal{K}^\bullet
\otimes_{\mathcal{O}_\mathcal{D}}
...
\begin{proof}
By the construction in Remark \ref{sites-cohomology-remark-cup-product} we see that
...
\mathcal{M}^\bullet)
\end{align*}
By Lemma \ref{sites-cohomology-lemma-adjoints-push-pull-compatibility} this is also equal to
\begin{align*}
Lf^*(f_*\mathcal{K}^\bullet
\otimes_{\mathcal{O}_\mathcal{D}}^\mathbf{L}
f_*\mathcal{M}^\bullet)
...
\otimes_{\mathcal{O}_\mathcal{D}}^\mathbf{L}
f_*\mathcal{M}^\bullet) \downarrow\longrightarrow &  & Lf^*f_*\mathcal{K}^\bullet \otimes_{\mathcal{O}_\mathcal{C}}^\mathbf{L}
...
f_*\mathcal{K}^\bullet
\otimes_{\mathcal{O}_\mathcal{D}}
f_*\mathcal{M}^\bullet) \overset{naive}{\swarrow}\downarrow & f^*f_*\mathcal{K}^\bullet \otimes_{\mathcal{O}_\mathcal{C}}^\mathbf{L}
f^*f_*\mathcal{M}^\bullet \downarrow\swarrow \\ Lf^*f_*\text{Tot}(\mathcal{K}^\bullet
\otimes_{\mathcal{O}_\mathcal{C}}
\mathcal{M}^\bullet) \downarrow &  &  \\ f^*f_*\text{Tot}(\mathcal{K}^\bullet \otimes_{\mathcal{O}_\mathcal{C}}
\mathcal{M}^\bullet) \searrow & \text{Tot}(f^*f_*\mathcal{K}^\bullet \otimes_{\mathcal{O}_\mathcal{C}}
f^*f_*\mathcal{M}^\bullet) \downarrow & \mathcal{K}^\bullet \otimes_{\mathcal{O}_\mathcal{C}}^\mathbf{L}
\mathcal{M}^\bullet \swarrow \\  & \text{Tot}(\mathcal{K}^\bullet
\otimes_{\mathcal{O}_\mathcal{C}}
\mathcal{M}^\bullet) & \end{array}
$$
All of the polygons in this diagram commute. The top one commutes
by Lemma \ref{sites-cohomology-lemma-tensor-pull-compatibility}.
...
\source{stacks:0FPL}
\href{https://stacks.math.columbia.edu/tag/0FPL}{\texttt{Stacks tag 0FPL}}
\group{sites-cohomology}

Let $f : (\Sh(\mathcal{C}), \mathcal{O}) \to (\Sh(\mathcal{C}'), \mathcal{O}')$
be a morphism of ringed topoi. The relative cup product of
Remark \ref{sites-cohomology-remark-cup-product} is associative in the sense that
the diagram
$$
\begin{array}{cc}Rf_*K \otimes_{\mathcal{O}'}^\mathbf{L}
Rf_*L \otimes_{\mathcal{O}'}^\mathbf{L}
Rf_*M \longrightarrow\downarrow & Rf_*(K \otimes_\mathcal{O}^\mathbf{L} L)
\otimes_{\mathcal{O}'}^\mathbf{L} Rf_*M \downarrow \\ Rf_*K \otimes_{\mathcal{O}'}^\mathbf{L}
Rf_*(L \otimes_\mathcal{O}^\mathbf{L} M) \longrightarrow & Rf_*(K \otimes_\mathcal{O}^\mathbf{L}
L \otimes_\mathcal{O}^\mathbf{L} M)\end{array}
$$
...
\source{stacks:0FPM}
\href{https://stacks.math.columbia.edu/tag/0FPM}{\texttt{Stacks tag 0FPM}}
\group{sites-cohomology}

Let $f : (\Sh(\mathcal{C}), \mathcal{O}) \to (\Sh(\mathcal{C}'), \mathcal{O}')$
be a morphism of ringed topoi. The relative cup product of
Remark \ref{sites-cohomology-remark-cup-product} is commutative in the sense that
the diagram
$$
\begin{array}{cc}Rf_*K \otimes_{\mathcal{O}'}^\mathbf{L} Rf_*L \longrightarrow\underset{\psi}{\downarrow} & Rf_*(K \otimes_\mathcal{O}^\mathbf{L} L) \overset{Rf_*\psi}{\downarrow} \\ Rf_*L \otimes_{\mathcal{O}'}^\mathbf{L} Rf_*K \longrightarrow & Rf_*(L \otimes_\mathcal{O}^\mathbf{L} K)\end{array}
$$
is commutative in $D(\mathcal{O}')$ for all $K, L$ in $D(\mathcal{O})$.
Here $\psi$ is the commutativity constraint on the derived category
(Lemma \ref{sites-cohomology-lemma-symmetric-monoidal-derived}).
\end{lemma}
...
\source{stacks:0FPN}
\href{https://stacks.math.columbia.edu/tag/0FPN}{\texttt{Stacks tag 0FPN}}
\group{sites-cohomology}
...
Remark \ref{sites-cohomology-remark-cup-product} is compatible with compositions
in the sense that the diagram
$$
\begin{array}{ccc}R(f' \circ f)_*K \otimes_{\mathcal{O}''}^\mathbf{L} R(f' \circ f)_*L
\xlongequal{}\downarrow &  & Rf'_*Rf_*K \otimes_{\mathcal{O}''}^\mathbf{L} Rf'_*Rf_*L \downarrow \\ R(f' \circ f)_*(K \otimes_\mathcal{O}^\mathbf{L} L) \xlongequal{} & Rf'_*Rf_*(K \otimes_\mathcal{O}^\mathbf{L} L) & Rf'_*(Rf_*K \otimes_{\mathcal{O}'}^\mathbf{L}  Rf_*L) \longleftarrow\end{array}
$$
is commutative in $D(\mathcal{O}'')$ for all $K, L$ in $D(\mathcal{O})$.
\end{lemma}
...
\source{stacks:0H9A}
\href{https://stacks.math.columbia.edu/tag/0H9A}{\texttt{Stacks tag 0H9A}}
\group{sites-cohomology}

Consider a commutative square
$$
\begin{array}{cc}(\Sh(\mathcal{C}'), \mathcal{O}_{\mathcal{C}'}) \underset{g'}{\longrightarrow}\underset{f'}{\downarrow} & (\Sh(\mathcal{C}, \mathcal{O}_{\mathcal{C}}) \overset{f}{\downarrow} \\ (\Sh(\mathcal{D}'), \mathcal{O}_{\mathcal{D}'}) \overset{g}{\longrightarrow} & (\Sh(\mathcal{D}), \mathcal{O}_{\mathcal{D}})\end{array}
$$
of ringed topoi. Let $K, L$ in $D(\mathcal{O}_{\mathcal{C}})$.
The relative cup product is compatible with the square
in the sense that the diagram
$$
\begin{array}{cc}Lg^*(Rf_*K \otimes_{\mathcal{O}_{\mathcal{D}}}^\mathbf{L} Rf_*L)
\longrightarrow\downarrow & Lg^*(Rf_*(K \otimes_{\mathcal{O}_{\mathcal{C}}}^\mathbf{L} L)) \downarrow \\ Lg^*Rf_*K \otimes_{\mathcal{O}_{\mathcal{D}'}}^\mathbf{L} Lg^*Rf_*L \downarrow & R(f')_*L(g')^*(K \otimes_{\mathcal{O}_{\mathcal{C}}}^\mathbf{L} L) \downarrow \\ R(f')_*(L(g')^*K \otimes_{\mathcal{O}_{\mathcal{D}'}} R(f')_*(L(g')^*L \longrightarrow & R(f')_*(L(g')^*K \otimes_{\mathcal{O}_{\mathcal{C}'}}^\mathbf{L} L(g')^*L)\end{array}
$$
is commutative in $D(\mathcal{O}_{\mathcal{D}'})$.
The horizontal arrows are given
by the relative cup product (Remark \ref{sites-cohomology-remark-cup-product})
and the vertical arrows are given
by the base change map (Remark \ref{sites-cohomology-remark-base-change})
and Lemma \ref{sites-cohomology-lemma-pullback-tensor-product}.
\end{lemma}
...
(viewed as graded $\mathcal{O}$-modules) which are homogeneous
...
\source{stacks:0A90}
\href{https://stacks.math.columbia.edu/tag/0A90}{\texttt{Stacks tag 0A90}}
\group{sites-cohomology}
...
\source{stacks:0A91}
\href{https://stacks.math.columbia.edu/tag/0A91}{\texttt{Stacks tag 0A91}}
\group{sites-cohomology}
...
\source{stacks:0BYT}
\href{https://stacks.math.columbia.edu/tag/0BYT}{\texttt{Stacks tag 0BYT}}
\group{sites-cohomology}
...
\source{stacks:0A93}
\href{https://stacks.math.columbia.edu/tag/0A93}{\texttt{Stacks tag 0A93}}
\group{sites-cohomology}
...
\source{stacks:0A92}
\href{https://stacks.math.columbia.edu/tag/0A92}{\texttt{Stacks tag 0A92}}
\group{sites-cohomology}
...
\source{stacks:0A94}
\href{https://stacks.math.columbia.edu/tag/0A94}{\texttt{Stacks tag 0A94}}
\group{sites-cohomology}
...
is K-injective by Lemma \ref{sites-cohomology-lemma-restrict-K-injective-to-open}.
...
\source{stacks:0A95}
\href{https://stacks.math.columbia.edu/tag/0A95}{\texttt{Stacks tag 0A95}}
\group{sites-cohomology}
...
By Lemma \ref{sites-cohomology-lemma-RHom-into-K-injective}
...
\source{stacks:0A96}
\href{https://stacks.math.columbia.edu/tag/0A96}{\texttt{Stacks tag 0A96}}
\group{sites-cohomology}
...
The second equality by Lemma \ref{sites-cohomology-lemma-compose}.
...
(Definition \ref{sites-cohomology-definition-K-flat}) and because $\mathcal{I}^\bullet$
is K-injective.
\end{proof}
...
constructed in Section \ref{sites-cohomology-section-hom-complexes}.
This is well defined by Lemma \ref{sites-cohomology-lemma-RHom-well-defined}.
We get a functor
$$
...
\source{stacks:08JA}
\href{https://stacks.math.columbia.edu/tag/08JA}{\texttt{Stacks tag 08JA}}
\group{sites-cohomology}
...
$\SheafHom^\bullet(\mathcal{L}^\bullet, \mathcal{I}^\bullet)$
is K-injective by Lemma \ref{sites-cohomology-lemma-RHom-from-K-flat-into-K-injective}.
Hence we can compute cohomology over $U$ by simply taking sections over $U$
and the result follows from Lemma \ref{sites-cohomology-lemma-RHom-into-K-injective}.
\end{proof}

\begin{lemma}[Internal hom]
\label{sites-cohomology-lemma-internal-hom}
\source{stacks:08J9}
\href{https://stacks.math.columbia.edu/tag/08J9}{\texttt{Stacks tag 08J9}}
\group{sites-cohomology}
...
\mathcal{I}^\bullet)
$$
by Lemma \ref{sites-cohomology-lemma-compose}.
Note that the left hand side represents
$R\SheafHom(K, R\SheafHom(L, M))$ (use
Lemma \ref{sites-cohomology-lemma-RHom-from-K-flat-into-K-injective})
and that the right hand side represents
$R\SheafHom(K \otimes_\mathcal{O}^\mathbf{L} L, M)$.
This proves the displayed formula of the lemma.
Taking global sections and using Lemma \ref{sites-cohomology-lemma-section-RHom-over-U}
...
\source{stacks:08JB}
\href{https://stacks.math.columbia.edu/tag/08JB}{\texttt{Stacks tag 08JB}}
\group{sites-cohomology}
...
\source{stacks:08JC}
\href{https://stacks.math.columbia.edu/tag/08JC}{\texttt{Stacks tag 08JC}}
\group{sites-cohomology}
...
\source{stacks:0A97}
\href{https://stacks.math.columbia.edu/tag/0A97}{\texttt{Stacks tag 0A97}}
\group{sites-cohomology}
...
$$
of Lemma \ref{sites-cohomology-lemma-evaluate-and-more}. By our particular
...
\begin{lemma}[Composition on RSheafHom.]
\label{sites-cohomology-lemma-internal-hom-composition}
\source{stacks:0A98}
\href{https://stacks.math.columbia.edu/tag/0A98}{\texttt{Stacks tag 0A98}}
\group{sites-cohomology}
...
By Lemma \ref{sites-cohomology-lemma-composition} there is a map of complexes
$$
\text{Tot}\left(
...
\source{stacks:0BYU}
\href{https://stacks.math.columbia.edu/tag/0BYU}{\texttt{Stacks tag 0BYU}}
\group{sites-cohomology}
...
$$
where the first map is the map from Lemma \ref{sites-cohomology-lemma-diagonal-better}.
\end{proof}

\begin{lemma}[Internal hom diagonal]
\label{sites-cohomology-lemma-internal-hom-diagonal}
\source{stacks:0A99}
\href{https://stacks.math.columbia.edu/tag/0A99}{\texttt{Stacks tag 0A99}}
\group{sites-cohomology}
...
$$
where the first map comes from Lemma \ref{sites-cohomology-lemma-diagonal}.
\end{proof}

\begin{lemma}[Dual]
\label{sites-cohomology-lemma-dual}
\source{stacks:08JD}
\href{https://stacks.math.columbia.edu/tag/08JD}{\texttt{Stacks tag 08JD}}
\group{sites-cohomology}
...
Lemma \ref{sites-cohomology-lemma-internal-hom-composition}
...
\source{stacks:0B6D}
\href{https://stacks.math.columbia.edu/tag/0B6D}{\texttt{Stacks tag 0B6D}}
\group{sites-cohomology}
...
(Remark \ref{sites-cohomology-remark-cup-product}) and the second arrow is $Rf_*$ applied
to the canonical map
$R\SheafHom(L, K) \otimes_{\mathcal{O}_\mathcal{C}}^\mathbf{L} L \to K$
coming from Lemma \ref{sites-cohomology-lemma-internal-hom-composition}
...
\source{stacks:08JF}
\href{https://stacks.math.columbia.edu/tag/08JF}{\texttt{Stacks tag 08JF}}
\group{sites-cohomology}
...
proved in Lemma \ref{sites-cohomology-lemma-internal-hom}
...
by Lemma \ref{sites-cohomology-lemma-pullback-tensor-product}
...
\source{stacks:08JG}
\href{https://stacks.math.columbia.edu/tag/08JG}{\texttt{Stacks tag 08JG}}
\group{sites-cohomology}

Suppose that
$$
\begin{array}{cc}(\Sh(\mathcal{C}'), \mathcal{O}_{\mathcal{C}'})
\underset{h}{\longrightarrow}\underset{f'}{\downarrow} & (\Sh(\mathcal{C}), \mathcal{O}_\mathcal{C}) \overset{f}{\downarrow} \\ (\Sh(\mathcal{D}'), \mathcal{O}_{\mathcal{D}'})
\overset{g}{\longrightarrow} & (\Sh(\mathcal{D}), \mathcal{O}_\mathcal{D})\end{array}
$$
...
constructed in Remark \ref{sites-cohomology-remark-prepare-fancy-base-change}.
\end{remark}
...
Lemma \ref{sites-cohomology-lemma-section-RHom-over-U} we have
$$
...
defined in Remark \ref{sites-cohomology-remark-prepare-fancy-base-change}.
...
\begin{lemma}[Pullback injective pre limp]
\label{sites-cohomology-lemma-pullback-injective-pre-limp}
\source{stacks:0D6X}
\href{https://stacks.math.columbia.edu/tag/0D6X}{\texttt{Stacks tag 0D6X}}
\group{sites-cohomology}
...
\begin{lemma}[Existence derived lower shriek]
\label{sites-cohomology-lemma-existence-derived-lower-shriek}
\source{stacks:07AC}
\href{https://stacks.math.columbia.edu/tag/07AC}{\texttt{Stacks tag 07AC}}
\group{sites-cohomology}
...
follows from Lemma \ref{sites-cohomology-lemma-pullback-injective-pre-limp}.
...
\begin{remark}[When derived shriek equal]
\label{sites-cohomology-remark-when-derived-shriek-equal}
\source{stacks:07AE}
\href{https://stacks.math.columbia.edu/tag/07AE}{\texttt{Stacks tag 07AE}}
\group{sites-cohomology}
...
$$
\begin{array}{cc}D(\mathcal{O}_\mathcal{C}) \underset{Lg_!}{\longrightarrow}\underset{forget}{\downarrow} & D(\mathcal{O}_\mathcal{D}) \overset{forget}{\downarrow} \\ D(\mathcal{C}) \overset{Lg^{Ab}_!}{\longrightarrow} & D(\mathcal{D})\end{array}
$$
...
\begin{lemma}[Pullback injective limp]
\label{sites-cohomology-lemma-pullback-injective-limp}
\source{stacks:0D6Y}
\href{https://stacks.math.columbia.edu/tag/0D6Y}{\texttt{Stacks tag 0D6Y}}
\group{sites-cohomology}
...
\begin{proof}
We will use the criterion of Lemma \ref{sites-cohomology-lemma-characterize-limp}.
Condition (1) holds by Lemma \ref{sites-cohomology-lemma-pullback-injective-pre-limp}.
...
it is totally acyclic by Lemma \ref{sites-cohomology-lemma-direct-image-injective-sheaf}
(applied to the identity). Hence we can use the converse of
Lemma \ref{sites-cohomology-lemma-characterize-limp} to see that the complex
$$
...
\begin{lemma}[Pullback same cohomology]
\label{sites-cohomology-lemma-pullback-same-cohomology}
\source{stacks:0DD8}
\href{https://stacks.math.columbia.edu/tag/0DD8}{\texttt{Stacks tag 0DD8}}
\group{sites-cohomology}
...
Lemma \ref{sites-cohomology-lemma-pullback-injective-pre-limp} as well as
...
\source{stacks:0FN6}
\href{https://stacks.math.columbia.edu/tag/0FN6}{\texttt{Stacks tag 0FN6}}
\group{sites-cohomology}
...
by condition (5).
By Lemma \ref{sites-cohomology-lemma-modules-abelian-unbounded} it suffices
...
\source{stacks:0FN7}
\href{https://stacks.math.columbia.edu/tag/0FN7}{\texttt{Stacks tag 0FN7}}
\group{sites-cohomology}
...
sheaves on $\mathcal{C}$ representing $K$. By
Lemma \ref{sites-cohomology-lemma-pullback-injective-pre-limp}
...
see Lemma \ref{sites-cohomology-lemma-higher-direct-images}.
...
discussed in Section \ref{sites-cohomology-section-derived-lower-shriek}.
...
\begin{definition}[Situation: Fibred category]
\label{sites-cohomology-situation-fibred-category}
\source{stacks:08P8}
\href{https://stacks.math.columbia.edu/tag/08P8}{\texttt{Stacks tag 08P8}}
\group{sites-cohomology}
...
\begin{lemma}[Fibred category with object]
\label{sites-cohomology-lemma-fibred-category-with-object}
\source{stacks:08P9}
\href{https://stacks.math.columbia.edu/tag/08P9}{\texttt{Stacks tag 08P9}}
\group{sites-cohomology}

Assumptions and notation as in Situation \ref{sites-cohomology-situation-fibred-category}.
...
\begin{definition}[Situation: Morphism fibred categories]
\label{sites-cohomology-situation-morphism-fibred-categories}
\source{stacks:08PA}
\href{https://stacks.math.columbia.edu/tag/08PA}{\texttt{Stacks tag 08PA}}
\group{sites-cohomology}
...
so that
$$
\begin{array}{ccc}(\Sh(\mathcal{C}'), \mathcal{O}_{\mathcal{C}'}) \underset{\pi'}{\searrow}\underset{g}{\longrightarrow} &  & (\Sh(\mathcal{C}), \mathcal{O}_\mathcal{C}) \overset{\pi}{\swarrow} \\  & (\Sh(\mathcal{D}), \mathcal{O}_\mathcal{D}) & \end{array}
$$
is a commutative diagram of morphisms of ringed topoi.
\end{definition}

\begin{lemma}[Morphism fibred categories with object]
\label{sites-cohomology-lemma-morphism-fibred-categories-with-object}
\source{stacks:08PB}
\href{https://stacks.math.columbia.edu/tag/08PB}{\texttt{Stacks tag 08PB}}
\group{sites-cohomology}
...
$$
\begin{array}{ccc}(\Sh(\mathcal{C}'/U'), \mathcal{O}_{U'}) \underset{\pi'_{U'}}{\searrow}\underset{g'}{\longrightarrow} &  & (\Sh(\mathcal{C}), \mathcal{O}_U) \overset{\pi_U}{\swarrow} \\  & (\Sh(\mathcal{D}/V), \mathcal{O}_V) & \end{array}
$$
Then there exists a morphism of topoi
$$
...
in the proof of Lemma \ref{sites-cohomology-lemma-fibred-category-with-object} starting
...
the proof of Lemma \ref{sites-cohomology-lemma-fibred-category-with-object}
relative to $p : \mathcal{C} \to \mathcal{D}$ and $U$. Thus our lemma
follows from that lemma.
\end{proof}

\begin{lemma}[Properties lower shriek fibred category]
\label{sites-cohomology-lemma-properties-lower-shriek-fibred-category}
\source{stacks:08PC}
\href{https://stacks.math.columbia.edu/tag/08PC}{\texttt{Stacks tag 08PC}}
\group{sites-cohomology}
...
\item The diagram
$$
\begin{array}{cc}\textit{Mod}(\mathcal{O}_{\mathcal{C}'}) \downarrow\underset{g_!}{\longrightarrow} & \textit{Mod}(\mathcal{O}_\mathcal{C}) \downarrow \\ \textit{Ab}(\mathcal{C}') \overset{g_!^{\textit{Ab}}}{\longrightarrow} & \textit{Ab}(\mathcal{C})\end{array}
$$
commutes.
\item There are left adjoints
...
\item The diagram
$$
\begin{array}{cc}D(\mathcal{O}_{\mathcal{C}'}) \downarrow\underset{Lg_!}{\longrightarrow} & D(\mathcal{O}_\mathcal{C}) \downarrow \\ D(\mathcal{C}') \overset{Lg_!^{\textit{Ab}}}{\longrightarrow} & D(\mathcal{C})\end{array}
$$
commutes.
\end{enumerate}
\end{lemma}
...
$\mathcal{C}'$, see Remark \ref{sites-cohomology-remark-when-derived-shriek-equal}.
...
Lemma \ref{sites-cohomology-lemma-morphism-fibred-categories-with-object}.
...
\begin{remark}[Fibred category]
\label{sites-cohomology-remark-fibred-category}
\source{stacks:09CY}
\href{https://stacks.math.columbia.edu/tag/09CY}{\texttt{Stacks tag 09CY}}
\group{sites-cohomology}

Assumptions and notation as in Situation \ref{sites-cohomology-situation-fibred-category}.
Note that setting $\mathcal{C}' = \mathcal{D}$ and $u$ equal to the
structure functor of $\mathcal{C}$ gives a situation as in
Situation \ref{sites-cohomology-situation-morphism-fibred-categories}. Hence
Lemma \ref{sites-cohomology-lemma-properties-lower-shriek-fibred-category}
...
\begin{remark}[Morphism fibred categories]
\label{sites-cohomology-remark-morphism-fibred-categories}
\source{stacks:08PD}
\href{https://stacks.math.columbia.edu/tag/08PD}{\texttt{Stacks tag 08PD}}
\group{sites-cohomology}
...
\begin{lemma}[Compute pi shriek]
\label{sites-cohomology-lemma-compute-pi-shriek}
\source{stacks:08PE}
\href{https://stacks.math.columbia.edu/tag/08PE}{\texttt{Stacks tag 08PE}}
\group{sites-cohomology}
...
\source{stacks:08PF}
\href{https://stacks.math.columbia.edu/tag/08PF}{\texttt{Stacks tag 08PF}}
\group{sites-cohomology}
...
$$
is an example of Situation \ref{sites-cohomology-situation-fibred-category}.
By Remark \ref{sites-cohomology-remark-fibred-category} we do not need to distinguish
between $\pi_!$ on modules or abelian sheaves. By
Lemma \ref{sites-cohomology-lemma-compute-pi-shriek} we see that
...
\source{stacks:08PG}
\href{https://stacks.math.columbia.edu/tag/08PG}{\texttt{Stacks tag 08PG}}
\group{sites-cohomology}

In Example \ref{sites-cohomology-example-category-to-point} we can compute
...
\begin{example}[Morphism categories]
\label{sites-cohomology-example-morphism-categories}
\source{stacks:08PH}
\href{https://stacks.math.columbia.edu/tag/08PH}{\texttt{Stacks tag 08PH}}
\group{sites-cohomology}

Let $u : \mathcal{C}' \to \mathcal{C}$ be a functor.
Endow $\mathcal{C}'$ and $\mathcal{C}$ with the chaotic
topology as in Example \ref{sites-cohomology-example-category-to-point}.
...
In this way
$$
\begin{array}{ccc}(\Sh(\mathcal{C}'), \underline{B}) \underset{\pi'}{\searrow}\underset{g}{\longrightarrow} &  & (\Sh(\mathcal{C}), \underline{B}) \overset{\pi}{\swarrow} \\  & (\Sh(*), B) & \end{array}
$$
is an example of Situation \ref{sites-cohomology-situation-morphism-fibred-categories}.
Thus
Lemma \ref{sites-cohomology-lemma-properties-lower-shriek-fibred-category}
applies to $g$ so we do not need to distinguish between $g_!$ on
modules or abelian sheaves. In particular
Remark \ref{sites-cohomology-remark-morphism-fibred-categories}
...
Example \ref{sites-cohomology-example-left-derived-colimits}
...
\begin{remark}[Map evaluation to derived]
\label{sites-cohomology-remark-map-evaluation-to-derived}
\source{stacks:08Q6}
\href{https://stacks.math.columbia.edu/tag/08Q6}{\texttt{Stacks tag 08Q6}}
\group{sites-cohomology}

Notation and assumptions as in Example \ref{sites-cohomology-example-category-to-point}.
...
\begin{lemma}[Initial final]
\label{sites-cohomology-lemma-initial-final}
\source{stacks:08Q7}
\href{https://stacks.math.columbia.edu/tag/08Q7}{\texttt{Stacks tag 08Q7}}
\group{sites-cohomology}
...
\source{stacks:08Q8}
\href{https://stacks.math.columbia.edu/tag/08Q8}{\texttt{Stacks tag 08Q8}}
\group{sites-cohomology}
...
of ringed topoi
$$
\begin{array}{cc}(\Sh(\mathcal{C}), \underline{B}) \underset{\pi}{\downarrow} & (\Sh(\mathcal{C}), \underline{B'}) \overset{\pi'}{\downarrow}\overset{h}{\longleftarrow} \\ (*, B) & (*, B') \underset{f}{\longleftarrow}\end{array}
$$
...
\begin{lemma}[Compute by cosimplicial resolution]
\label{sites-cohomology-lemma-compute-by-cosimplicial-resolution}
\source{stacks:08Q9}
\href{https://stacks.math.columbia.edu/tag/08Q9}{\texttt{Stacks tag 08Q9}}
\group{sites-cohomology}
...
$\mathcal{C}^{opp}$ (Lemma \ref{sites-cohomology-lemma-compute-pi-shriek})
...
\begin{lemma}[Get it now]
\label{sites-cohomology-lemma-get-it-now}
\source{stacks:08QA}
\href{https://stacks.math.columbia.edu/tag/08QA}{\texttt{Stacks tag 08QA}}
\group{sites-cohomology}

Notation and assumptions as in Example \ref{sites-cohomology-example-morphism-categories}.
If there exists a cosimplicial object $U'_\bullet$ of $\mathcal{C}'$
such that Lemma \ref{sites-cohomology-lemma-compute-by-cosimplicial-resolution}
...
\begin{proof}
Follows immediately from
Lemma \ref{sites-cohomology-lemma-compute-by-cosimplicial-resolution}
and the fact that $g^{-1}$ is given by precomposing with $u$.
\end{proof}

\begin{lemma}[Product categories]
\label{sites-cohomology-lemma-product-categories}
\source{stacks:08QB}
\href{https://stacks.math.columbia.edu/tag/08QB}{\texttt{Stacks tag 08QB}}
\group{sites-cohomology}
...
of ringed topoi, see Example \ref{sites-cohomology-example-morphism-categories}. For
...
construction of $L\pi_!$ in Lemma \ref{sites-cohomology-lemma-existence-derived-lower-shriek}.
\end{proof}

\begin{lemma}[Eilenberg zilber]
\label{sites-cohomology-lemma-eilenberg-zilber}
\source{stacks:08QC}
\href{https://stacks.math.columbia.edu/tag/08QC}{\texttt{Stacks tag 08QC}}
\group{sites-cohomology}
...
$$
\begin{array}{ccc} &  & \mathcal{C} \\ \mathcal{C} \overset{u}{\longrightarrow} & \mathcal{C} \times \mathcal{C} \overset{u_2}{\searrow}\underset{u_1}{\nearrow} &  \\  &  & \mathcal{C}\end{array}
$$
...
Thus Lemma \ref{sites-cohomology-lemma-get-it-now} gives
...
(Lemma \ref{sites-cohomology-lemma-pullback-tensor-product}).
To finish we apply Lemma \ref{sites-cohomology-lemma-product-categories}.
\end{proof}
...
\source{stacks:08QD}
\href{https://stacks.math.columbia.edu/tag/08QD}{\texttt{Stacks tag 08QD}}
\group{sites-cohomology}

Let $\mathcal{C} = \Delta$ and let $B$ be any ring. This is a special
case of Example \ref{sites-cohomology-example-category-to-point} where the assumptions
of Lemma \ref{sites-cohomology-lemma-compute-by-cosimplicial-resolution} hold.
...
a special case of Lemma \ref{sites-cohomology-lemma-eilenberg-zilber} is:
...
\begin{lemma}[O homology qis]
\label{sites-cohomology-lemma-O-homology-qis}
\source{stacks:08RX}
\href{https://stacks.math.columbia.edu/tag/08RX}{\texttt{Stacks tag 08RX}}
\group{sites-cohomology}
...
as in Lemma \ref{sites-cohomology-lemma-compute-by-cosimplicial-resolution}, and
...
\begin{remark}[O homology B homology general]
\label{sites-cohomology-remark-O-homology-B-homology-general}
\source{stacks:09CZ}
\href{https://stacks.math.columbia.edu/tag/09CZ}{\texttt{Stacks tag 09CZ}}
\group{sites-cohomology}

Let $\mathcal{C}$ and $B$ be as in Example \ref{sites-cohomology-example-category-to-point}.
...
by Lemma \ref{sites-cohomology-lemma-O-homology-qis}.
...
to compute
$L\pi_!$ in Situation \ref{sites-cohomology-situation-fibred-category} and
$Lg_!$ in Situation \ref{sites-cohomology-situation-morphism-fibred-categories}.

\begin{lemma}[Compute left derived pi shriek pre]
\label{sites-cohomology-lemma-compute-left-derived-pi-shriek-pre}
\source{stacks:08PI}
\href{https://stacks.math.columbia.edu/tag/08PI}{\texttt{Stacks tag 08PI}}
\group{sites-cohomology}
...
\mathcal{F}|_{\mathcal{C}_{V'}} \circ h^*.
$$
By Example \ref{sites-cohomology-example-morphism-categories}
...
Example \ref{sites-cohomology-example-left-derived-colimits}. Denote
...
\begin{lemma}[Compute left derived pi shriek]
\label{sites-cohomology-lemma-compute-left-derived-pi-shriek}
\source{stacks:08PJ}
\href{https://stacks.math.columbia.edu/tag/08PJ}{\texttt{Stacks tag 08PJ}}
\group{sites-cohomology}
...
Lemma \ref{sites-cohomology-lemma-compute-left-derived-pi-shriek-pre}.
\end{lemma}
...
Lemma \ref{sites-cohomology-lemma-compute-pi-shriek}
...
\begin{lemma}[Compute left derived g shriek]
\label{sites-cohomology-lemma-compute-left-derived-g-shriek}
\source{stacks:08PK}
\href{https://stacks.math.columbia.edu/tag/08PK}{\texttt{Stacks tag 08PK}}
\group{sites-cohomology}
...
$$
\begin{array}{ccc}\mathcal{C}' \overset{u'}{\longrightarrow} & \mathcal{C}'' \overset{u''}{\longrightarrow}\overset{w}{\longleftarrow} & \mathcal{C}\end{array}
$$
of $u$ as in
...
Lemma \ref{sites-cohomology-lemma-compute-left-derived-pi-shriek}
...
\source{stacks:09D1}
\href{https://stacks.math.columbia.edu/tag/09D1}{\texttt{Stacks tag 09D1}}
\group{sites-cohomology}
...
This follows from
Lemmas \ref{sites-cohomology-lemma-compute-left-derived-pi-shriek} and
\ref{sites-cohomology-lemma-compute-by-cosimplicial-resolution}.

\begin{lemma}[Base change by qis]
\label{sites-cohomology-lemma-base-change-by-qis}
\source{stacks:09D2}
\href{https://stacks.math.columbia.edu/tag/09D2}{\texttt{Stacks tag 09D2}}
\group{sites-cohomology}
...
In this case the result follows from Lemma \ref{sites-cohomology-lemma-O-homology-qis}.
\end{proof}

\begin{remark}[Homology augmentation]
\label{sites-cohomology-remark-homology-augmentation}
\source{stacks:09D3}
\href{https://stacks.math.columbia.edu/tag/09D3}{\texttt{Stacks tag 09D3}}
\group{sites-cohomology}
...
by Lemma \ref{sites-cohomology-lemma-base-change-by-qis}.
Thus we can define the displayed functor as the composition of
$- \otimes^\mathbf{L}_{\mathcal{A}_\bullet} \mathcal{O}$ with the functor
$L\pi_! : D(\Delta \times \mathcal{C}, \pi^{-1}\mathcal{O}) \to
D(\mathcal{O})$ of Remark \ref{sites-cohomology-remark-fibred-category}.
...
In the situation of Example \ref{sites-cohomology-example-category-to-point}
...
\source{stacks:08RZ}
\href{https://stacks.math.columbia.edu/tag/08RZ}{\texttt{Stacks tag 08RZ}}
\group{sites-cohomology}
...
\source{stacks:08S0}
\href{https://stacks.math.columbia.edu/tag/08S0}{\texttt{Stacks tag 08S0}}
\group{sites-cohomology}

In Example \ref{sites-cohomology-example-category-to-point} assume we are moreover given
...
Thus, arguing as in Example \ref{sites-cohomology-example-right-derived-limits},
...
as the corresponding statement in Example \ref{sites-cohomology-example-right-derived-limits}.
...
the chaotic topology. As in Example \ref{sites-cohomology-example-computing-exts} we let
...
\source{stacks:0GYV}
\href{https://stacks.math.columbia.edu/tag/0GYV}{\texttt{Stacks tag 0GYV}}
\group{sites-cohomology}
...
\begin{lemma}[Cartesian good sub]
\label{sites-cohomology-lemma-cartesian-good-sub}
\source{stacks:0GYW}
\href{https://stacks.math.columbia.edu/tag/0GYW}{\texttt{Stacks tag 0GYW}}
\group{sites-cohomology}
...
\begin{lemma}[QC bounded above]
\label{sites-cohomology-lemma-QC-bounded-above}
\source{stacks:0GZQ}
\href{https://stacks.math.columbia.edu/tag/0GZQ}{\texttt{Stacks tag 0GZQ}}
\group{sites-cohomology}
...
\begin{lemma}[QC final object]
\label{sites-cohomology-lemma-QC-final-object}
\source{stacks:0H0R}
\href{https://stacks.math.columbia.edu/tag/0H0R}{\texttt{Stacks tag 0H0R}}
\group{sites-cohomology}
...
\begin{lemma}[QC hom out of]
\label{sites-cohomology-lemma-QC-hom-out-of}
\source{stacks:0H0S}
\href{https://stacks.math.columbia.edu/tag/0H0S}{\texttt{Stacks tag 0H0S}}
\group{sites-cohomology}
...
Lemma \ref{sites-cohomology-lemma-QC-final-object} we see that $K = Lf^*P$
...
\begin{lemma}[Build from]
\label{sites-cohomology-lemma-build-from}
\source{stacks:0GYX}
\href{https://stacks.math.columbia.edu/tag/0GYX}{\texttt{Stacks tag 0GYX}}
\group{sites-cohomology}
...
\begin{lemma}[Qis small]
\label{sites-cohomology-lemma-qis-small}
\source{stacks:0GYY}
\href{https://stacks.math.columbia.edu/tag/0GYY}{\texttt{Stacks tag 0GYY}}
\group{sites-cohomology}
...
Applying Lemma \ref{sites-cohomology-lemma-build-from}
...
application of Lemma \ref{sites-cohomology-lemma-build-from} to the subsets
$$
...
\begin{lemma}[Cartesian colimit kappa]
\label{sites-cohomology-lemma-cartesian-colimit-kappa}
\source{stacks:0GYZ}
\href{https://stacks.math.columbia.edu/tag/0GYZ}{\texttt{Stacks tag 0GYZ}}
\group{sites-cohomology}
...
\item the cardinal found in Lemma \ref{sites-cohomology-lemma-qis-small}.
\end{enumerate}
...
of complexes. By Lemma \ref{sites-cohomology-lemma-qis-small} and our choice of
...
$$
\begin{array}{cc}\mathcal{S}_n^\bullet(V)
\longrightarrow\downarrow & \mathcal{S}_n^\bullet(U) \downarrow \\ \mathcal{F}^\bullet(V)
\longrightarrow & \mathcal{F}^\bullet(U)\end{array}
$$
...
Lemma \ref{sites-cohomology-lemma-build-from} using the subsets
$$
...
\begin{proposition}[Cartesian brown]
\label{sites-cohomology-proposition-cartesian-brown}
\source{stacks:0GZ0}
\href{https://stacks.math.columbia.edu/tag/0GZ0}{\texttt{Stacks tag 0GZ0}}
\group{sites-cohomology}
...
Definition \ref{sites-cohomology-definition-cartesian} we have
\begin{enumerate}
...
\begin{proof}
Part (1) is Lemma \ref{sites-cohomology-lemma-cartesian-good-sub}.
Part (2) follows from Lemma \ref{sites-cohomology-lemma-cartesian-colimit-kappa} and
Derived Categories, Lemma \ref{derived-lemma-brown-bis}.
Part (3) follows from
Lemma \ref{sites-cohomology-lemma-cartesian-colimit-kappa} and
...
\begin{lemma}[Cartesian functorial]
\label{sites-cohomology-lemma-cartesian-functorial}
\source{stacks:0GZ1}
\href{https://stacks.math.columbia.edu/tag/0GZ1}{\texttt{Stacks tag 0GZ1}}
\group{sites-cohomology}
...
$$
\begin{array}{ccc}(\Sh(pt), \mathcal{O}'(U')) \underset{U'}{\longrightarrow}\downarrow &  & (\Sh(\mathcal{C}'), \mathcal{O}') \overset{g}{\downarrow} \\ (\Sh(pt), \mathcal{O}(U)) \overset{U}{\longrightarrow} &  & (\Sh(\mathcal{C}), \mathcal{O})\end{array}
$$
...
(Lemma \ref{sites-cohomology-lemma-derived-pullback-composition}) and hence we conclude
$$
R\Gamma(U', Lg^*K) =
...
\begin{lemma}[Cartesian flat quasi coherent]
\label{sites-cohomology-lemma-cartesian-flat-quasi-coherent}
\source{stacks:0GZR}
\href{https://stacks.math.columbia.edu/tag/0GZR}{\texttt{Stacks tag 0GZR}}
\group{sites-cohomology}
...
\begin{lemma}[Cartesion plus topology]
\label{sites-cohomology-lemma-cartesion-plus-topology}
\source{stacks:0GZS}
\href{https://stacks.math.columbia.edu/tag/0GZS}{\texttt{Stacks tag 0GZS}}
\group{sites-cohomology}

Let $\epsilon : (\mathcal{C}_\tau, \mathcal{O}_\tau) \to
(\mathcal{C}_{\tau'}, \mathcal{O}_{\tau'})$ be as in
Section \ref{sites-cohomology-section-compare}. Assume
\begin{enumerate}
...
\begin{proof}
We will use the observations made in Section \ref{sites-cohomology-section-compare} without
...
Lemma \ref{sites-cohomology-lemma-pullback-K-flat} and use that the inclusion
...
\begin{lemma}[QC hom out of plus topology]
\label{sites-cohomology-lemma-QC-hom-out-of-plus-topology}
\source{stacks:0H0T}
\href{https://stacks.math.columbia.edu/tag/0H0T}{\texttt{Stacks tag 0H0T}}
\group{sites-cohomology}

Notation and assumptions as in Lemma \ref{sites-cohomology-lemma-cartesion-plus-topology}.
...
$$
by adjunction. Hence the result by Lemma \ref{sites-cohomology-lemma-QC-hom-out-of}
and the fact that
$$
...
\source{stacks:08FL}
\href{https://stacks.math.columbia.edu/tag/08FL}{\texttt{Stacks tag 08FL}}
\group{sites-cohomology}
...
\source{stacks:08FM}
\href{https://stacks.math.columbia.edu/tag/08FM}{\texttt{Stacks tag 08FM}}
\group{sites-cohomology}
...
\source{stacks:09J8}
\href{https://stacks.math.columbia.edu/tag/09J8}{\texttt{Stacks tag 09J8}}
\group{sites-cohomology}
...
\source{stacks:08H3}
\href{https://stacks.math.columbia.edu/tag/08H3}{\texttt{Stacks tag 08H3}}
\group{sites-cohomology}
...
\source{stacks:08FN}
\href{https://stacks.math.columbia.edu/tag/08FN}{\texttt{Stacks tag 08FN}}
\group{sites-cohomology}
...
\source{stacks:08FP}
\href{https://stacks.math.columbia.edu/tag/08FP}{\texttt{Stacks tag 08FP}}
\group{sites-cohomology}
...
Lemma \ref{sites-cohomology-lemma-local-lift-map} and the fact that
...
\source{stacks:08FQ}
\href{https://stacks.math.columbia.edu/tag/08FQ}{\texttt{Stacks tag 08FQ}}
\group{sites-cohomology}
...
Hence Lemma \ref{sites-cohomology-lemma-local-homotopy} guarantees there is a
...
\source{stacks:08FR}
\href{https://stacks.math.columbia.edu/tag/08FR}{\texttt{Stacks tag 08FR}}
\group{sites-cohomology}
...
Lemma \ref{sites-cohomology-lemma-lift-through-quasi-isomorphism}.
...
\source{stacks:08JH}
\href{https://stacks.math.columbia.edu/tag/08JH}{\texttt{Stacks tag 08JH}}
\group{sites-cohomology}
...
$$
and differential as described in Section \ref{sites-cohomology-section-internal-hom}.
\end{lemma}
...
by the construction in Section \ref{sites-cohomology-section-internal-hom}. It suffices
...
$$
By Lemma \ref{sites-cohomology-lemma-local-actual} the sheafification of
...
\source{stacks:08JI}
\href{https://stacks.math.columbia.edu/tag/08JI}{\texttt{Stacks tag 08JI}}
\group{sites-cohomology}
...
Hence the construction in Section \ref{sites-cohomology-section-internal-hom}
shows that
...
\source{stacks:08FT}
\href{https://stacks.math.columbia.edu/tag/08FT}{\texttt{Stacks tag 08FT}}
\group{sites-cohomology}
...
\source{stacks:08FU}
\href{https://stacks.math.columbia.edu/tag/08FU}{\texttt{Stacks tag 08FU}}
\group{sites-cohomology}
...
final object. By Lemma \ref{sites-cohomology-lemma-local-actual}
...
\source{stacks:08H4}
\href{https://stacks.math.columbia.edu/tag/08H4}{\texttt{Stacks tag 08H4}}
\group{sites-cohomology}
...
By Lemma \ref{sites-cohomology-lemma-pseudo-coherent-independent-representative}
...
Applying Lemma \ref{sites-cohomology-lemma-strictly-perfect-pullback} we conclude.
\end{proof}

\begin{lemma}[Cone pseudo coherent]
\label{sites-cohomology-lemma-cone-pseudo-coherent}
\source{stacks:08FV}
\href{https://stacks.math.columbia.edu/tag/08FV}{\texttt{Stacks tag 08FV}}
\group{sites-cohomology}
...
The cone $C(\gamma_i)^\bullet$ is strictly perfect (Lemma \ref{sites-cohomology-lemma-cone}).
...
Lemma \ref{sites-cohomology-lemma-pseudo-coherent-independent-representative}.
...
\source{stacks:09J9}
\href{https://stacks.math.columbia.edu/tag/09J9}{\texttt{Stacks tag 09J9}}
\group{sites-cohomology}
...
\source{stacks:08FW}
\href{https://stacks.math.columbia.edu/tag/08FW}{\texttt{Stacks tag 08FW}}
\group{sites-cohomology}
...
\source{stacks:08FX}
\href{https://stacks.math.columbia.edu/tag/08FX}{\texttt{Stacks tag 08FX}}
\group{sites-cohomology}
...
$H^n(E^\bullet) = 0$. By Lemma \ref{sites-cohomology-lemma-local-lift-map}
...
\source{stacks:08FZ}
\href{https://stacks.math.columbia.edu/tag/08FZ}{\texttt{Stacks tag 08FZ}}
\group{sites-cohomology}
...
\source{stacks:08G0}
\href{https://stacks.math.columbia.edu/tag/08G0}{\texttt{Stacks tag 08G0}}
\group{sites-cohomology}
...
$\Coker(d^{a - 1})$ is flat, see Lemma \ref{sites-cohomology-lemma-flat-tor-zero}.
\end{proof}

\begin{lemma}[Tor amplitude]
\label{sites-cohomology-lemma-tor-amplitude}
\source{stacks:08G1}
\href{https://stacks.math.columbia.edu/tag/08G1}{\texttt{Stacks tag 08G1}}
\group{sites-cohomology}
...
Section \ref{sites-cohomology-section-flat}.
...
which follows immediately from Lemma \ref{sites-cohomology-lemma-last-one-flat}
and the definitions.
\end{proof}

\begin{lemma}[Bounded below tor amplitude]
\label{sites-cohomology-lemma-bounded-below-tor-amplitude}
\source{stacks:0F1M}
\href{https://stacks.math.columbia.edu/tag/0F1M}{\texttt{Stacks tag 0F1M}}
\group{sites-cohomology}
...
with flat terms representing $E$, see Lemma \ref{sites-cohomology-lemma-K-flat-resolution}.
...
Lemma \ref{sites-cohomology-lemma-last-one-flat} to the complex
...
$f : (\mathcal{C}', \mathcal{O}') \to (\mathcal{C}, \mathcal{O})$
be a morphism of ringed sites. By Lemma \ref{sites-cohomology-lemma-pullback-K-flat}
...
By Lemma \ref{sites-cohomology-lemma-K-flat-two-out-of-three-ses}.
...
\source{stacks:08H5}
\href{https://stacks.math.columbia.edu/tag/08H5}{\texttt{Stacks tag 08H5}}
\group{sites-cohomology}
...
Lemma \ref{sites-cohomology-lemma-tor-amplitude}
...
Thus by Lemma \ref{sites-cohomology-lemma-tor-amplitude}
...
\source{stacks:08G2}
\href{https://stacks.math.columbia.edu/tag/08G2}{\texttt{Stacks tag 08G2}}
\group{sites-cohomology}
...
\source{stacks:09JA}
\href{https://stacks.math.columbia.edu/tag/09JA}{\texttt{Stacks tag 09JA}}
\group{sites-cohomology}
...
\source{stacks:08G3}
\href{https://stacks.math.columbia.edu/tag/08G3}{\texttt{Stacks tag 08G3}}
\group{sites-cohomology}
...
\source{stacks:0942}
\href{https://stacks.math.columbia.edu/tag/0942}{\texttt{Stacks tag 0942}}
\group{sites-cohomology}
...
\source{stacks:0DJJ}
\href{https://stacks.math.columbia.edu/tag/0DJJ}{\texttt{Stacks tag 0DJJ}}
\group{sites-cohomology}
...
we can apply Lemma \ref{sites-cohomology-lemma-tor-amplitude-pullback}.
...
\source{stacks:08G5}
\href{https://stacks.math.columbia.edu/tag/08G5}{\texttt{Stacks tag 08G5}}
\group{sites-cohomology}
...
\source{stacks:08G6}
\href{https://stacks.math.columbia.edu/tag/08G6}{\texttt{Stacks tag 08G6}}
\group{sites-cohomology}
...
\source{stacks:08G7}
\href{https://stacks.math.columbia.edu/tag/08G7}{\texttt{Stacks tag 08G7}}
\group{sites-cohomology}
...
Hence $\mathcal{E}'$ is flat (Lemma \ref{sites-cohomology-lemma-flat-tor-zero}).
...
\source{stacks:08G8}
\href{https://stacks.math.columbia.edu/tag/08G8}{\texttt{Stacks tag 08G8}}
\group{sites-cohomology}
...
Lemma \ref{sites-cohomology-lemma-tor-amplitude}. Thus (2) holds.
...
for all $m$ we conclude using Lemma \ref{sites-cohomology-lemma-perfect-precise}.
\end{proof}

\begin{lemma}[Perfect pullback]
\label{sites-cohomology-lemma-perfect-pullback}
\source{stacks:08H6}
\href{https://stacks.math.columbia.edu/tag/08H6}{\texttt{Stacks tag 08H6}}
\group{sites-cohomology}
...
\begin{proof}
This follows from Lemma \ref{sites-cohomology-lemma-perfect},
\ref{sites-cohomology-lemma-tor-amplitude-pullback}, and
...
\source{stacks:08G9}
\href{https://stacks.math.columbia.edu/tag/08G9}{\texttt{Stacks tag 08G9}}
\group{sites-cohomology}
...
\begin{proof}
First proof: Combine
Lemmas \ref{sites-cohomology-lemma-perfect}, \ref{sites-cohomology-lemma-cone-pseudo-coherent}, and
...
see Lemma \ref{sites-cohomology-lemma-local-actual}.
Then $M|_U$ is isomorphic to the cone of $\alpha$ which is strictly
perfect by Lemma \ref{sites-cohomology-lemma-cone}.
\end{proof}

\begin{lemma}[Tensor perfect]
\label{sites-cohomology-lemma-tensor-perfect}
\source{stacks:09JB}
\href{https://stacks.math.columbia.edu/tag/09JB}{\texttt{Stacks tag 09JB}}
\group{sites-cohomology}
...
\begin{proof}
Follows from
Lemmas \ref{sites-cohomology-lemma-perfect}, \ref{sites-cohomology-lemma-tensor-pseudo-coherent}, and
...
\source{stacks:08GA}
\href{https://stacks.math.columbia.edu/tag/08GA}{\texttt{Stacks tag 08GA}}
\group{sites-cohomology}
...
\begin{proof}
Follows from
Lemmas \ref{sites-cohomology-lemma-perfect}, \ref{sites-cohomology-lemma-summands-pseudo-coherent}, and
...
Example \ref{sites-cohomology-example-dual-derived} and
Lemma \ref{sites-cohomology-lemma-left-dual-derived}).

\begin{lemma}[Symmetric monoidal cat complexes]
\label{sites-cohomology-lemma-symmetric-monoidal-cat-complexes}
\source{stacks:0FPQ}
\href{https://stacks.math.columbia.edu/tag/0FPQ}{\texttt{Stacks tag 0FPQ}}
\group{sites-cohomology}

Let $(\mathcal{C}, \mathcal{O})$ be a ringed site. The category of complexes
...
\source{stacks:0FPR}
\href{https://stacks.math.columbia.edu/tag/0FPR}{\texttt{Stacks tag 0FPR}}
\group{sites-cohomology}
...
$$
as in Section \ref{sites-cohomology-section-hom-complexes}. Let
$$
\eta :
\mathcal{O}
\to
...
\source{stacks:0FPS}
\href{https://stacks.math.columbia.edu/tag/0FPS}{\texttt{Stacks tag 0FPS}}
\group{sites-cohomology}
...
Example \ref{sites-cohomology-example-dual}.
\end{lemma}
...
\source{stacks:08JJ}
\href{https://stacks.math.columbia.edu/tag/08JJ}{\texttt{Stacks tag 08JJ}}
\group{sites-cohomology}
...
with restriction (Lemma \ref{sites-cohomology-lemma-restriction-RHom-to-U}). Let $U$
...
(K^\vee)^\vee
$$
see Lemma \ref{sites-cohomology-lemma-internal-hom-evaluate}. It suffices to prove there
is a covering $\{U_i \to U\}$ such that the restriction of this map
to $\mathcal{C}/U_i$ is an isomorphism for all $i$.
By Lemma \ref{sites-cohomology-lemma-dual} to see the final statement it suffices to check
...
Lemma \ref{sites-cohomology-lemma-Rhom-strictly-perfect}
...
By Lemma \ref{sites-cohomology-lemma-Rhom-strictly-perfect} the complex
...
\source{stacks:0FPT}
\href{https://stacks.math.columbia.edu/tag/0FPT}{\texttt{Stacks tag 0FPT}}
\group{sites-cohomology}
...
\begin{proof}
Omitted. Compare with Lemma \ref{sites-cohomology-lemma-symmetric-monoidal-cat-complexes}.
\end{proof}

\begin{example}[Dual derived]
\label{sites-cohomology-example-dual-derived}
\source{stacks:0FPU}
\href{https://stacks.math.columbia.edu/tag/0FPU}{\texttt{Stacks tag 0FPU}}
\group{sites-cohomology}

Let $(\mathcal{C}, \mathcal{O})$ be a ringed site. Let $K$ be a perfect object
of $D(\mathcal{O})$. Set $K^\vee = R\SheafHom(K, \mathcal{O})$
as in Lemma \ref{sites-cohomology-lemma-dual-perfect-complex}.
Then the map
$$
...
Lemma \ref{sites-cohomology-lemma-internal-hom-composition} for example). Then
...
\source{stacks:0FPV}
\href{https://stacks.math.columbia.edu/tag/0FPV}{\texttt{Stacks tag 0FPV}}
\group{sites-cohomology}
...
Example \ref{sites-cohomology-example-dual-derived}.
\end{lemma}
...
$\mathcal{O}$-modules, see Lemma \ref{sites-cohomology-lemma-K-flat-resolution}.
Consider the map
$$
\eta : \mathcal{O} \to
...
Lemma \ref{sites-cohomology-lemma-perfect-precise} and the fact that
...
map $K \to M$. By Lemma \ref{sites-cohomology-lemma-local-actual} after replacing
...
\begin{lemma}[Trivial duality for systems of perfect objects.]
\label{sites-cohomology-lemma-colim-and-lim-of-duals}
\source{stacks:0A0A}
\href{https://stacks.math.columbia.edu/tag/0A0A}{\texttt{Stacks tag 0A0A}}
\group{sites-cohomology}
...
\begin{proof}
By Lemma \ref{sites-cohomology-lemma-dual-perfect-complex} we have
...
a ringed site (both in the case of a locally ringed topos and
in the general case).

\begin{lemma}[Category summands finite free]
\label{sites-cohomology-lemma-category-summands-finite-free}
\source{stacks:0FPX}
\href{https://stacks.math.columbia.edu/tag/0FPX}{\texttt{Stacks tag 0FPX}}
\group{sites-cohomology}
...
\source{stacks:0FPY}
\href{https://stacks.math.columbia.edu/tag/0FPY}{\texttt{Stacks tag 0FPY}}
\group{sites-cohomology}
...
Lemma \ref{sites-cohomology-lemma-left-dual-derived}. By symmetry we see that
...
\to \mathcal{O}
$$
See Lemma \ref{sites-cohomology-lemma-local-actual}. Then $\beta \circ \alpha = 1$
...
Lemma \ref{sites-cohomology-lemma-category-summands-finite-free}
...
Correspondingly, using Lemma \ref{sites-cohomology-lemma-category-summands-finite-free} again,
...
constructed in the proof of Lemma \ref{sites-cohomology-lemma-category-summands-finite-free}.
...
\ref{sites-cohomology-lemma-pullback-tensor-product} and \ref{sites-cohomology-lemma-adjoint}.
...
\source{stacks:0944}
\href{https://stacks.math.columbia.edu/tag/0944}{\texttt{Stacks tag 0944}}
\group{sites-cohomology}
...
\source{stacks:0E48}
\href{https://stacks.math.columbia.edu/tag/0E48}{\texttt{Stacks tag 0E48}}
\group{sites-cohomology}

The map (\ref{equation-projection-formula-map}) is compatible with the
base change map of Remark \ref{sites-cohomology-remark-base-change} in the following sense.
Namely, suppose that
$$
\begin{array}{cc}(\Sh(\mathcal{C}'), \mathcal{O}_{\mathcal{C}'})
\underset{g'}{\longrightarrow}\underset{f'}{\downarrow} & (\Sh(\mathcal{C}), \mathcal{O}_\mathcal{C}) \overset{f}{\downarrow} \\ (\Sh(\mathcal{D}'), \mathcal{O}_{\mathcal{D}'})
...
Then the diagram
$$
\begin{array}{cc}Lg^*(Rf_*E \otimes^\mathbf{L}_{\mathcal{O}_\mathcal{D}} K)
\underset{p}{\longrightarrow}\underset{t}{\downarrow} & Lg^*Rf_*(E \otimes^\mathbf{L}_{\mathcal{O}_\mathcal{C}} Lf^*K)
\underset{b}{\downarrow} \\ Lg^*Rf_*E \otimes^\mathbf{L}_{\mathcal{O}_{\mathcal{D}'}}
Lg^*K \underset{b}{\downarrow} & Rf'_*L(g')^*(E \otimes^\mathbf{L}_{\mathcal{O}_\mathcal{C}}
Lf^*K) \underset{t}{\downarrow} \\ Rf'_*L(g')^*E \otimes^\mathbf{L}_{\mathcal{O}_{\mathcal{D}'}}
Lg^*K \underset{p}{\searrow} & Rf'_*(L(g')^*E \otimes^\mathbf{L}_{\mathcal{O}_{\mathcal{D}'}}
L(g')^*Lf^*K) \underset{c}{\downarrow} \\  & Rf'_*(L(g')^*E \otimes^\mathbf{L}_{\mathcal{O}_{\mathcal{D}'}}
L(f')^*Lg^*K)\end{array}
$$
is commutative. Here arrows labeled $t$ are gotten by an application of
Lemma \ref{sites-cohomology-lemma-pullback-tensor-product}, arrows labeled $b$ by an
application of Remark \ref{sites-cohomology-remark-base-change}, arrows labeled $p$
...
\source{stacks:0946}
\href{https://stacks.math.columbia.edu/tag/0946}{\texttt{Stacks tag 0946}}
\group{sites-cohomology}
...
\begin{proposition}[Enough weakly contractibles]
\label{sites-cohomology-proposition-enough-weakly-contractibles}
\source{stacks:0947}
\href{https://stacks.math.columbia.edu/tag/0947}{\texttt{Stacks tag 0947}}
\group{sites-cohomology}
...
sequence by Lemma \ref{sites-cohomology-lemma-w-contractible}. Conversely, assume that
$\mathcal{F}_1(U) \to \mathcal{F}_2(U) \to \mathcal{F}_3(U)$
is exact for all $U \in \mathcal{B}$.
...
\medskip\noindent
Proof of (2). This holds by Lemma \ref{sites-cohomology-lemma-is-limit-dimension} with $d = 0$.
...
\medskip\noindent
Proof of (6) and (7). We refer to Section \ref{sites-cohomology-section-derived-limits}
...
\begin{lemma}[Compact in terms of generators]
\label{sites-cohomology-lemma-compact-in-terms-of-generators}
\source{stacks:094B}
\href{https://stacks.math.columbia.edu/tag/094B}{\texttt{Stacks tag 094B}}
\group{sites-cohomology}
...
\begin{lemma}[Compact objects if enough qc]
\label{sites-cohomology-lemma-compact-objects-if-enough-qc}
\source{stacks:094C}
\href{https://stacks.math.columbia.edu/tag/094C}{\texttt{Stacks tag 094C}}
\group{sites-cohomology}
...
\begin{proof}
Apply Lemma \ref{sites-cohomology-lemma-compact-in-terms-of-generators}
...
\begin{lemma}[When jshriek lower compact]
\label{sites-cohomology-lemma-when-jshriek-lower-compact}
\source{stacks:0G21}
\href{https://stacks.math.columbia.edu/tag/0G21}{\texttt{Stacks tag 0G21}}
\group{sites-cohomology}
...
\begin{lemma}[When jshriek lower compact worked out]
\label{sites-cohomology-lemma-when-jshriek-lower-compact-worked-out}
\source{stacks:0G22}
\href{https://stacks.math.columbia.edu/tag/0G22}{\texttt{Stacks tag 0G22}}
\group{sites-cohomology}
...
\begin{proof}
This follows from Lemma \ref{sites-cohomology-lemma-when-jshriek-lower-compact}
and Lemma \ref{sites-cohomology-lemma-colim-works-over-collection}.
\end{proof}

\begin{lemma}[When jshriek compact]
\label{sites-cohomology-lemma-when-jshriek-compact}
\source{stacks:094D}
\href{https://stacks.math.columbia.edu/tag/094D}{\texttt{Stacks tag 094D}}
\group{sites-cohomology}
...
\begin{lemma}[Quasi compact weakly contractible compact]
\label{sites-cohomology-lemma-quasi-compact-weakly-contractible-compact}
\source{stacks:094E}
\href{https://stacks.math.columbia.edu/tag/094E}{\texttt{Stacks tag 094E}}
\group{sites-cohomology}
...
\begin{proof}
Combine Lemmas \ref{sites-cohomology-lemma-when-jshriek-compact} and
\ref{sites-cohomology-lemma-w-contractible} with
...
\source{stacks:09JC}
\href{https://stacks.math.columbia.edu/tag/09JC}{\texttt{Stacks tag 09JC}}
\group{sites-cohomology}
...
Lemma \ref{sites-cohomology-lemma-dual-perfect-complex}. Then we have
$$
\Hom_{D(\mathcal{O})}(K, M) =
...
case of Lemma \ref{sites-cohomology-lemma-when-jshriek-lower-compact-worked-out} with $U = X$.
...
Lemma \ref{sites-cohomology-lemma-when-jshriek-compact}.
\end{proof}
...
\source{stacks:094G}
\href{https://stacks.math.columbia.edu/tag/094G}{\texttt{Stacks tag 094G}}
\group{sites-cohomology}
...
Lemma \ref{sites-cohomology-lemma-kill-cohomology-class-on-covering} (details omitted)
...
\begin{lemma}[Map out of locally constant]
\label{sites-cohomology-lemma-map-out-of-locally-constant}
\source{stacks:09BD}
\href{https://stacks.math.columbia.edu/tag/09BD}{\texttt{Stacks tag 09BD}}
\group{sites-cohomology}
...
\begin{proof}
Follows immediately from Lemma \ref{sites-cohomology-lemma-local-actual}.
\end{proof}

\begin{lemma}[Locally constant map]
\label{sites-cohomology-lemma-locally-constant-map}
\source{stacks:09BE}
\href{https://stacks.math.columbia.edu/tag/09BE}{\texttt{Stacks tag 09BE}}
\group{sites-cohomology}
...
\begin{proof}
Follows from Lemma \ref{sites-cohomology-lemma-map-out-of-locally-constant} and
Modules on Sites, Lemma \ref{sites-modules-lemma-morphism-locally-constant}.
\end{proof}

\begin{lemma}[Locally constant tensor product]
\label{sites-cohomology-lemma-locally-constant-tensor-product}
\source{stacks:094H}
\href{https://stacks.math.columbia.edu/tag/094H}{\texttt{Stacks tag 094H}}
\group{sites-cohomology}
...
\begin{proof}
We'll prove this as an application of Lemma \ref{sites-cohomology-lemma-locally-constant}.
...
Lemma \ref{sites-cohomology-lemma-locally-constant}
...
\begin{lemma}[Locally constant bounded]
\label{sites-cohomology-lemma-locally-constant-bounded}
\source{stacks:094I}
\href{https://stacks.math.columbia.edu/tag/094I}{\texttt{Stacks tag 094I}}
\group{sites-cohomology}
...
$$
Combined with Lemma \ref{sites-cohomology-lemma-locally-constant-tensor-product}
