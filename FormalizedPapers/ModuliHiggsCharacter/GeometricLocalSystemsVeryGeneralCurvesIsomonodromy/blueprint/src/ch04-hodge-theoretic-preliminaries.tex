...
\begin{definition}
[Deligne canonical extension \protect{\cite[Remarques 5.5(i)]{deligne:regular-singular}}]\label{src-geometric-local-systems-general-curves-isomonodromy-ch04-hodge-theoretic-preliminaries-statement-1}
\source{geometric-local-systems-general-curves-isomonodromy}
\notready
...
\begin{definition}
[The associated Higgs bundle]\label{src-geometric-local-systems-general-curves-isomonodromy-ch04-hodge-theoretic-preliminaries-statement-2}
\source{geometric-local-systems-general-curves-isomonodromy}
\notready
...
\end{proof}
\begin{remark}
\label{src-geometric-local-systems-general-curves-isomonodromy-ch04-hodge-theoretic-preliminaries-statement-3}
\source{geometric-local-systems-general-curves-isomonodromy}
\notready
