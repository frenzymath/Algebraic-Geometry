...
\begin{prop}
[{ \cite[(3.5.6)]{nek-selmer}}]\label{src-universal-p-adic-gross-zagier-formula-ch05-selmer-sheaves-and-p-adic-heights-statement-1}
\source{universal-p-adic-gross-zagier-formula}
\notready
...
\begin{prop}
\label{src-universal-p-adic-gross-zagier-formula-ch05-selmer-sheaves-and-p-adic-heights-statement-2}
\source{universal-p-adic-gross-zagier-formula}
...
\begin{prop}
\label{src-universal-p-adic-gross-zagier-formula-ch05-selmer-sheaves-and-p-adic-heights-statement-3}
\source{universal-p-adic-gross-zagier-formula}
\notready \lb{prop ht} 
...
\begin{prop}
\label{src-universal-p-adic-gross-zagier-formula-ch05-selmer-sheaves-and-p-adic-heights-statement-4}
\source{universal-p-adic-gross-zagier-formula}
