...
Theorem \ref{criteria-theorem-bootstrap}.
...
\source{stacks:05XK}
\href{https://stacks.math.columbia.edu/tag/05XK}{\texttt{Stacks tag 05XK}}
\group{criteria}
...
\source{stacks:05XL}
\href{https://stacks.math.columbia.edu/tag/05XL}{\texttt{Stacks tag 05XL}}
\group{criteria}
...
\begin{lemma}[Flat finite presentation surjective diagonal]
\label{criteria-lemma-flat-finite-presentation-surjective-diagonal}
\source{stacks:05XW}
\href{https://stacks.math.columbia.edu/tag/05XW}{\texttt{Stacks tag 05XW}}
\group{criteria}
...
\source{stacks:07WG}
\href{https://stacks.math.columbia.edu/tag/07WG}{\texttt{Stacks tag 07WG}}
\group{criteria}
...
\vcenter{
\begin{array}{ccc}p(x_{i'}|_U) \underset{p(\beta)}{\downarrow}\underset{\gamma_{i'}|_U}{\longrightarrow} &  & (y_i|_{U_{i'}})|_U \downarrow \\ p(x) \overset{\gamma}{\longrightarrow} &  & y_i|_U\end{array}
}
\end{equation}
...
\begin{lemma}[Base change limit preserving]
\label{criteria-lemma-base-change-limit-preserving}
\source{stacks:06CV}
\href{https://stacks.math.columbia.edu/tag/06CV}{\texttt{Stacks tag 06CV}}
\group{criteria}
...
\begin{lemma}[Composition limit preserving]
\label{criteria-lemma-composition-limit-preserving}
\source{stacks:06CW}
\href{https://stacks.math.columbia.edu/tag/06CW}{\texttt{Stacks tag 06CW}}
\group{criteria}
...
\begin{lemma}[Representable by spaces limit preserving]
\label{criteria-lemma-representable-by-spaces-limit-preserving}
\source{stacks:06CX}
\href{https://stacks.math.columbia.edu/tag/06CX}{\texttt{Stacks tag 06CX}}
\group{criteria}
...
\begin{lemma}[Open immersion limit preserving]
\label{criteria-lemma-open-immersion-limit-preserving}
\source{stacks:06CY}
\href{https://stacks.math.columbia.edu/tag/06CY}{\texttt{Stacks tag 06CY}}
\group{criteria}
...
\begin{proof}
\uses{criteria-lemma-representable-by-spaces-limit-preserving}

This follows from
Lemma \ref{criteria-lemma-representable-by-spaces-limit-preserving}
...
\begin{lemma}[Check representable limit preserving]
\label{criteria-lemma-check-representable-limit-preserving}
\source{stacks:07WH}
\href{https://stacks.math.columbia.edu/tag/07WH}{\texttt{Stacks tag 07WH}}
\group{criteria}
...
\begin{lemma}[Check property limit preserving]
\label{criteria-lemma-check-property-limit-preserving}
\source{stacks:07WI}
\href{https://stacks.math.columbia.edu/tag/07WI}{\texttt{Stacks tag 07WI}}
\group{criteria}
...
\vcenter{
\begin{array}{ccc}p(x'|_U) \underset{p(\beta)}{\downarrow}\underset{\gamma'|_U}{\longrightarrow} &  & y'|_U \downarrow \\ p(x) \overset{\gamma}{\longrightarrow} &  & y'|_U\end{array}
}
\end{equation}
...
\source{stacks:06D1}
\href{https://stacks.math.columbia.edu/tag/06D1}{\texttt{Stacks tag 06D1}}
\group{criteria}
...
\source{stacks:06D2}
\href{https://stacks.math.columbia.edu/tag/06D2}{\texttt{Stacks tag 06D2}}
\group{criteria}
...
\begin{lemma}[Representable by spaces formally smooth]
\label{criteria-lemma-representable-by-spaces-formally-smooth}
\source{stacks:06D3}
\href{https://stacks.math.columbia.edu/tag/06D3}{\texttt{Stacks tag 06D3}}
\group{criteria}
...
\source{stacks:06D5}
\href{https://stacks.math.columbia.edu/tag/06D5}{\texttt{Stacks tag 06D5}}
\group{criteria}
...
\source{stacks:06D6}
\href{https://stacks.math.columbia.edu/tag/06D6}{\texttt{Stacks tag 06D6}}
\group{criteria}
...
\begin{lemma}[Representable by spaces surjective]
\label{criteria-lemma-representable-by-spaces-surjective}
\source{stacks:06D7}
\href{https://stacks.math.columbia.edu/tag/06D7}{\texttt{Stacks tag 06D7}}
\group{criteria}
...
$$
\begin{array}{cc}\Spec(K) \downarrow\underset{x}{\longrightarrow} & X_y \downarrow \\ \Spec(k) \overset{t}{\longrightarrow} & T\end{array}
$$
...
\source{stacks:06CF}
\href{https://stacks.math.columbia.edu/tag/06CF}{\texttt{Stacks tag 06CF}}
\group{criteria}
...
\begin{lemma}[Algebraic morphism to algebraic]
\label{criteria-lemma-algebraic-morphism-to-algebraic}
\source{stacks:05XY}
\href{https://stacks.math.columbia.edu/tag/05XY}{\texttt{Stacks tag 05XY}}
\group{criteria}
...
\begin{lemma}[Map from algebraic]
\label{criteria-lemma-map-from-algebraic}
\source{stacks:06CG}
\href{https://stacks.math.columbia.edu/tag/06CG}{\texttt{Stacks tag 06CG}}
\group{criteria}
...
\begin{lemma}[Diagonals and algebraic morphisms]
\label{criteria-lemma-diagonals-and-algebraic-morphisms}
\source{stacks:0D3R}
\href{https://stacks.math.columbia.edu/tag/0D3R}{\texttt{Stacks tag 0D3R}}
\group{criteria}
...
\begin{lemma}[Surjection space of sections]
\label{criteria-lemma-surjection-space-of-sections}
\source{stacks:05XQ}
\href{https://stacks.math.columbia.edu/tag/05XQ}{\texttt{Stacks tag 05XQ}}
\group{criteria}
...
\begin{lemma}[Space of sections]
\label{criteria-lemma-space-of-sections}
\source{stacks:05XR}
\href{https://stacks.math.columbia.edu/tag/05XR}{\texttt{Stacks tag 05XR}}
\group{criteria}
...
\begin{proof}
\uses{criteria-lemma-surjection-space-of-sections}
...
Lemma \ref{criteria-lemma-surjection-space-of-sections}
...
\label{equation-hom}
\vcenter{
\begin{array}{cccccc}T \times_{a, B} Z \searrow\underset{b}{\longrightarrow} &  & T \times_{a, B} X \swarrow & Z \searrow &  & X \swarrow \\  & T \overset{a}{\longrightarrow} &  &  & B & \end{array}
}
\end{equation}
Of course, we can also think of $b$ as a morphism
$b : T \times_{a, B} Z \to X$ such that
$$
\begin{array}{cccc}T \times_{a, B} Z \longrightarrow\downarrow\underset{b}{\longrightarrow} & Z \searrow &  & X \swarrow \\ T \overset{a}{\longrightarrow} &  & B & \end{array}
$$
...
\begin{lemma}[Hom functor sheaf]
\label{criteria-lemma-hom-functor-sheaf}
\source{stacks:05Y3}
\href{https://stacks.math.columbia.edu/tag/05Y3}{\texttt{Stacks tag 05Y3}}
\group{criteria}
...
\begin{lemma}[Base change hom functor]
\label{criteria-lemma-base-change-hom-functor}
\source{stacks:05Y4}
\href{https://stacks.math.columbia.edu/tag/05Y4}{\texttt{Stacks tag 05Y4}}
\group{criteria}
...
\begin{proof}
\uses{criteria-lemma-hom-functor-sheaf}
...
\begin{proof}
\uses{criteria-lemma-space-of-sections, criteria-lemma-surjection-space-of-sections}
...
Lemma \ref{criteria-lemma-space-of-sections}
...
\begin{proposition}[Hom functor algebraic space]
\label{criteria-proposition-hom-functor-algebraic-space}
\source{stacks:05Y7}
\href{https://stacks.math.columbia.edu/tag/05Y7}{\texttt{Stacks tag 05Y7}}
\group{criteria}
...
\begin{proof}
\uses{criteria-lemma-base-change-hom-functor, criteria-lemma-etale-covering-hom-functor}
...
By
Lemma \ref{criteria-lemma-base-change-hom-functor}
and
Spaces, Lemma
...
Lemma \ref{criteria-lemma-etale-covering-hom-functor}
...
\vcenter{
\begin{array}{cc} & X \downarrow \\ T \times_{a, B} Z \downarrow\overset{b}{\nearrow}\longrightarrow & Z \downarrow \\ T \overset{a}{\longrightarrow} & B\end{array}
}
\end{equation}
...
\begin{lemma}[Restriction of scalars sheaf]
\label{criteria-lemma-restriction-of-scalars-sheaf}
\source{stacks:05YB}
\href{https://stacks.math.columbia.edu/tag/05YB}{\texttt{Stacks tag 05YB}}
\group{criteria}
...
\begin{lemma}[Etale base change restriction of scalars]
\label{criteria-lemma-etale-base-change-restriction-of-scalars}
\source{stacks:05YC}
\href{https://stacks.math.columbia.edu/tag/05YC}{\texttt{Stacks tag 05YC}}
\group{criteria}
...
\begin{proof}
\uses{criteria-lemma-restriction-of-scalars-sheaf}

The equality as functors follows immediately from the definitions.
The equality as sheaves follows from this because both sides are
sheaves according to
Lemma \ref{criteria-lemma-restriction-of-scalars-sheaf}
and the fact that a fibre product of sheaves is the same as the
corresponding fibre product of pre-sheaves (i.e., functors).
\end{proof}

\begin{lemma}[Etale covering restriction of scalars]
\label{criteria-lemma-etale-covering-restriction-of-scalars}
\source{stacks:05YD}
\href{https://stacks.math.columbia.edu/tag/05YD}{\texttt{Stacks tag 05YD}}
\group{criteria}
...
\begin{lemma}[Fibre diagram]
\label{criteria-lemma-fibre-diagram}
\source{stacks:05YE}
\href{https://stacks.math.columbia.edu/tag/05YE}{\texttt{Stacks tag 05YE}}
\group{criteria}

Let $S$ be a scheme. Let $X \to Z \to B$ be morphisms of
algebraic spaces over $S$. The following diagram
$$
\begin{array}{cc}\mathit{Mor}_B(Z, X) \longrightarrow & \mathit{Mor}_B(Z, Z) \\ \text{Res}_{Z/B}(X) \longrightarrow\uparrow & B \underset{\text{id}_Z}{\uparrow}\end{array}
$$
...
\begin{proposition}[Restriction of scalars algebraic space]
\label{criteria-proposition-restriction-of-scalars-algebraic-space}
\source{stacks:05YF}
\href{https://stacks.math.columbia.edu/tag/05YF}{\texttt{Stacks tag 05YF}}
\group{criteria}
...
\begin{proof}
\uses{criteria-proposition-hom-functor-algebraic-space, criteria-lemma-fibre-diagram}
...
diagram of
Lemma \ref{criteria-lemma-fibre-diagram}
...
\begin{lemma}[Map hilbert]
\label{criteria-lemma-map-hilbert}
\source{stacks:05XN}
\href{https://stacks.math.columbia.edu/tag/05XN}{\texttt{Stacks tag 05XN}}
\group{criteria}

Consider a $2$-commutative diagram
$$
\begin{array}{cc}\mathcal{X}' \underset{G}{\longrightarrow}\underset{F'}{\downarrow} & \mathcal{X} \overset{F}{\downarrow} \\ \mathcal{Y}' \overset{H}{\longrightarrow} & \mathcal{Y}\end{array}
$$
...
\begin{lemma}[Cartesian map hilbert]
\label{criteria-lemma-cartesian-map-hilbert}
\source{stacks:05XP}
\href{https://stacks.math.columbia.edu/tag/05XP}{\texttt{Stacks tag 05XP}}
\group{criteria}

\uses{criteria-lemma-map-hilbert}
In the situation of
Lemma \ref{criteria-lemma-map-hilbert}
assume that the given square is $2$-cartesian. Then the diagram
$$
\begin{array}{cc}\mathcal{H}_d(\mathcal{X}'/\mathcal{Y}') \longrightarrow\downarrow & \mathcal{H}_d(\mathcal{X}/\mathcal{Y}) \downarrow \\ \mathcal{Y}' \longrightarrow & \mathcal{Y}\end{array}
$$
is $2$-cartesian.
\end{lemma}
...
\begin{lemma}[Etale covering hilbert]
\label{criteria-lemma-etale-covering-hilbert}
\source{stacks:05YG}
\href{https://stacks.math.columbia.edu/tag/05YG}{\texttt{Stacks tag 05YG}}
\group{criteria}
...
\begin{lemma}[Etale map hilbert]
\label{criteria-lemma-etale-map-hilbert}
\source{stacks:05XS}
\href{https://stacks.math.columbia.edu/tag/05XS}{\texttt{Stacks tag 05XS}}
\group{criteria}
...
\begin{proof}
\uses{criteria-lemma-etale-permanence, criteria-lemma-cartesian-map-hilbert, criteria-lemma-etale-covering-hilbert}

Set $\mathcal{X}'' = \mathcal{Y}' \times_\mathcal{Y} \mathcal{X}$. By
Lemma \ref{criteria-lemma-etale-permanence}
...
$$
\begin{array}{ccc}\mathcal{X}' \longrightarrow\downarrow & \mathcal{X}'' \longrightarrow\downarrow & \mathcal{X} \downarrow \\ \mathcal{Y}' \longrightarrow & \mathcal{Y}' \longrightarrow & \mathcal{Y}\end{array}
$$
It follows from
Lemma \ref{criteria-lemma-cartesian-map-hilbert}
...
Lemma \ref{criteria-lemma-etale-covering-hilbert}.
\end{proof}

\begin{lemma}[Relative hilbert]
\label{criteria-lemma-relative-hilbert}
\source{stacks:05YH}
\href{https://stacks.math.columbia.edu/tag/05YH}{\texttt{Stacks tag 05YH}}
\group{criteria}
...
\begin{proof}
\uses{criteria-proposition-restriction-of-scalars-algebraic-space}
...
\begin{lemma}[Representable on top]
\label{criteria-lemma-representable-on-top}
\source{stacks:05YJ}
\href{https://stacks.math.columbia.edu/tag/05YJ}{\texttt{Stacks tag 05YJ}}
\group{criteria}
...
(\Sch/Z)_{fppf} \times_{x, \mathcal{X}} \mathcal{X}'
$$
is representable by an algebraic space $W$ over $Z$. It follows that
(\ref{equation-to-show-again}) is representable by $\text{Res}_{Z/U}(W)$,
...
\source{stacks:06CH}
\href{https://stacks.math.columbia.edu/tag/06CH}{\texttt{Stacks tag 06CH}}
\group{criteria}
...
$$
\begin{array}{ccc}Z \downarrow\longrightarrow\overset{f_\xi}{\longrightarrow} & Z_{i'} \downarrow\underset{f_{i'}}{\longrightarrow} & X_{y_i} \downarrow \\ U \longrightarrow & U_{i'} \longrightarrow & U_i\end{array}
$$
...
$$
\begin{array}{ccc}(\Sch/Z_{i'})_{fppf} \longrightarrow\searrow & (\Sch/U_i)_{fppf} \times_{y_i, \mathcal{Y}, F} \mathcal{X}
\longrightarrow\downarrow & \mathcal{X} \overset{F}{\downarrow} \\  & (\Sch/U_{i'})_{fppf} \longrightarrow & \mathcal{Y}\end{array}
$$
\end{enumerate}
...
\begin{lemma}[Represent FAd]
\label{criteria-lemma-represent-FAd}
\source{stacks:05YP}
\href{https://stacks.math.columbia.edu/tag/05YP}{\texttt{Stacks tag 05YP}}
\group{criteria}
...
\begin{proposition}[Finite hilbert point]
\label{criteria-proposition-finite-hilbert-point}
\source{stacks:05YQ}
\href{https://stacks.math.columbia.edu/tag/05YQ}{\texttt{Stacks tag 05YQ}}
\group{criteria}
...
\begin{proof}
\uses{criteria-lemma-represent-FAd}
...
Lemma \ref{criteria-lemma-represent-FAd}
...
\begin{lemma}[Hilbert stack of space]
\label{criteria-lemma-hilbert-stack-of-space}
\source{stacks:05YS}
\href{https://stacks.math.columbia.edu/tag/05YS}{\texttt{Stacks tag 05YS}}
\group{criteria}
...
\begin{proof}
\uses{criteria-lemma-representable-on-top, criteria-proposition-finite-hilbert-point}
...
Lemma \ref{criteria-lemma-representable-on-top}.
...
\begin{lemma}[Hilbert stack relative space]
\label{criteria-lemma-hilbert-stack-relative-space}
\source{stacks:06CI}
\href{https://stacks.math.columbia.edu/tag/06CI}{\texttt{Stacks tag 06CI}}
\group{criteria}
...
\begin{proof}
\uses{criteria-lemma-hilbert-stack-of-space, criteria-lemma-flat-finite-presentation-surjective-diagonal, criteria-lemma-relative-hilbert}
...
Lemma \ref{criteria-lemma-hilbert-stack-of-space}.
...
Lemma \ref{criteria-lemma-flat-finite-presentation-surjective-diagonal}.
We may apply
Lemma \ref{criteria-lemma-relative-hilbert}
...
$2$-cartesian diagram
$$
\begin{array}{cc}\mathcal{V} \downarrow\longrightarrow & \mathcal{X} \overset{F}{\downarrow} \\ \mathcal{W} \longrightarrow & \mathcal{Y}\end{array}
$$
because
$$
\mathcal{H}_d(\mathcal{X}/\mathcal{Y})
...
\vcenter{
\begin{array}{cc}Z \underset{x_\alpha}{\longrightarrow}\searrow & X_y \downarrow \\  & U\end{array}
}
\quad\quad
\vcenter{
\begin{array}{ccc}(\Sch/Z)_{fppf} \searrow\underset{x, \alpha}{\longrightarrow} & (\Sch/U)_{fppf} \times_{y, \mathcal{Y}, F} \mathcal{X} \longrightarrow\downarrow & \mathcal{X} \overset{F}{\downarrow} \\  & (\Sch/U)_{fppf} \overset{y}{\longrightarrow} & \mathcal{Y}\end{array}
}
\end{equation}
We remark that if
...
\begin{lemma}[Lci locus stack in groupoids]
\label{criteria-lemma-lci-locus-stack-in-groupoids}
\source{stacks:06CL}
\href{https://stacks.math.columbia.edu/tag/06CL}{\texttt{Stacks tag 06CL}}
\group{criteria}
...
\source{stacks:06D8}
\href{https://stacks.math.columbia.edu/tag/06D8}{\texttt{Stacks tag 06D8}}
\group{criteria}
...
$$
\begin{array}{ccc}(Z \subset Z') \searrow\underset{(f, f')}{\longrightarrow} &  & (X \subset X') \swarrow \\  & (U \subset U') & \end{array}
$$
...
\begin{lemma}[Lci formally smooth]
\label{criteria-lemma-lci-formally-smooth}
\source{stacks:06D9}
\href{https://stacks.math.columbia.edu/tag/06D9}{\texttt{Stacks tag 06D9}}
\group{criteria}
...
\begin{proof}
\uses{criteria-lemma-lci-unobstructed, criteria-lemma-lci-locus-stack-in-groupoids}
...
Hence we may apply
Lemma \ref{criteria-lemma-lci-unobstructed}
...
Lemma \ref{criteria-lemma-lci-locus-stack-in-groupoids}
...
\begin{lemma}[Lci surjective]
\label{criteria-lemma-lci-surjective}
\source{stacks:06DA}
\href{https://stacks.math.columbia.edu/tag/06DA}{\texttt{Stacks tag 06DA}}
\group{criteria}
...
\begin{theorem}[Artin's theorem on representability of flat groupoids]
\label{criteria-theorem-bootstrap}
\source{stacks:06DC}
\href{https://stacks.math.columbia.edu/tag/06DC}{\texttt{Stacks tag 06DC}}
\group{criteria}
...
\begin{proof}
\uses{criteria-lemma-flat-finite-presentation-surjective-diagonal, criteria-lemma-hilbert-stack-relative-space, criteria-lemma-lci-locus-stack-in-groupoids, criteria-lemma-limit-preserving, criteria-lemma-lci-formally-smooth, criteria-lemma-lci-surjective, criteria-lemma-representable-by-spaces-limit-preserving, criteria-lemma-representable-by-spaces-formally-smooth, criteria-lemma-representable-by-spaces-surjective, criteria-lemma-open-immersion-limit-preserving, criteria-lemma-composition-limit-preserving, criteria-lemma-composition-formally-smooth, criteria-lemma-composition-surjective}
...
Lemma \ref{criteria-lemma-hilbert-stack-relative-space}
we know that
$$
...
Lemmas \ref{criteria-lemma-limit-preserving} and \ref{criteria-lemma-lci-formally-smooth}
and the surjectivity a consequence of
Lemma \ref{criteria-lemma-lci-surjective}.
...
Applying
Lemmas \ref{criteria-lemma-representable-by-spaces-limit-preserving},
\ref{criteria-lemma-representable-by-spaces-formally-smooth}, and
...
Lemma \ref{criteria-lemma-limit-preserving}
...
\ref{criteria-lemma-open-immersion-limit-preserving}, and
...
Lemma \ref{criteria-lemma-lci-formally-smooth},
and
\item surjective on objects by
Lemma \ref{criteria-lemma-lci-surjective}.
\end{enumerate}
Using
Lemmas \ref{criteria-lemma-composition-limit-preserving},
\ref{criteria-lemma-composition-formally-smooth}, and
...
\begin{lemma}[Flat quotient flat presentation]
\label{criteria-lemma-flat-quotient-flat-presentation}
\source{stacks:06FH}
\href{https://stacks.math.columbia.edu/tag/06FH}{\texttt{Stacks tag 06FH}}
\group{criteria}
...
\begin{theorem}[Flat groupoid gives algebraic stack]
\label{criteria-theorem-flat-groupoid-gives-algebraic-stack}
\source{stacks:06FI}
\href{https://stacks.math.columbia.edu/tag/06FI}{\texttt{Stacks tag 06FI}}
\group{criteria}
...
\begin{proof}
\uses{criteria-theorem-bootstrap, criteria-lemma-flat-quotient-flat-presentation}
...
below
(Lemma \ref{criteria-lemma-BG-algebraic})
...
\begin{lemma}[Quotient algebraic]
\label{criteria-lemma-quotient-algebraic}
\source{stacks:06PJ}
\href{https://stacks.math.columbia.edu/tag/06PJ}{\texttt{Stacks tag 06PJ}}
\group{criteria}
...
\begin{proof}
\uses{criteria-theorem-flat-groupoid-gives-algebraic-stack}
...
\begin{lemma}[Group quotient algebraic]
\label{criteria-lemma-group-quotient-algebraic}
\source{stacks:06PK}
\href{https://stacks.math.columbia.edu/tag/06PK}{\texttt{Stacks tag 06PK}}
\group{criteria}
...
\begin{proof}
\uses{criteria-lemma-quotient-algebraic}

This lemma is a special case of
Lemma \ref{criteria-lemma-quotient-algebraic}.
...
\begin{lemma}[Gerbes are algebraic if and only if the associated groups are flat and locally of finit...]
\label{criteria-lemma-BG-algebraic}
\source{stacks:06PL}
\href{https://stacks.math.columbia.edu/tag/06PL}{\texttt{Stacks tag 06PL}}
\group{criteria}
...
\begin{proof}
\uses{criteria-theorem-flat-groupoid-gives-algebraic-stack, criteria-lemma-group-quotient-algebraic}
...
Lemma \ref{criteria-lemma-group-quotient-algebraic}
...
\begin{lemma}[Stacks etale]
\label{criteria-lemma-stacks-etale}
\source{stacks:076V}
\href{https://stacks.math.columbia.edu/tag/076V}{\texttt{Stacks tag 076V}}
\group{criteria}
