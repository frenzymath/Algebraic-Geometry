...
Blueprint project under `FormalizedPapers/CurvesAndLinearSeries/RefinedBrillNoetherTheoryHurwitzSpaces`.

- Blueprint: [`blueprint/src/content.tex`](blueprint/src/content.tex)
- Direct PDF: [arXiv PDF](https://arxiv.org/pdf/1907.08597)
