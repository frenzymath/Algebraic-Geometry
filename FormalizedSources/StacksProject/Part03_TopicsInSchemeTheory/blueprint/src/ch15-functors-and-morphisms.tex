...
\begin{lemma}[Functor on fp modules]
\label{functors-lemma-functor-on-fp-modules}
\source{stacks:0GNJ}
\href{https://stacks.math.columbia.edu/tag/0GNJ}{\texttt{Stacks tag 0GNJ}}
\group{functors}
...
\begin{lemma}[Functor on fp modules additive]
\label{functors-lemma-functor-on-fp-modules-additive}
\source{stacks:0GNK}
\href{https://stacks.math.columbia.edu/tag/0GNK}{\texttt{Stacks tag 0GNK}}
\group{functors}

\uses{functors-lemma-functor-on-fp-modules}
Let $A$, $\mathcal{B}$, $F$ be as in Lemma \ref{functors-lemma-functor-on-fp-modules}.
...
\begin{lemma}[Functor on fp modules right exact]
\label{functors-lemma-functor-on-fp-modules-right-exact}
\source{stacks:0GNL}
\href{https://stacks.math.columbia.edu/tag/0GNL}{\texttt{Stacks tag 0GNL}}
\group{functors}
...
\begin{proof}
\uses{functors-lemma-functor-on-fp-modules-additive}
...
Lemma \ref{functors-lemma-functor-on-fp-modules-additive}.
...
\begin{lemma}[Functor on fp modules left exact]
\label{functors-lemma-functor-on-fp-modules-left-exact}
\source{stacks:0GNM}
\href{https://stacks.math.columbia.edu/tag/0GNM}{\texttt{Stacks tag 0GNM}}
\group{functors}
...
\begin{lemma}[Functor on modules fp]
\label{functors-lemma-functor-on-modules-fp}
\source{stacks:0GNN}
\href{https://stacks.math.columbia.edu/tag/0GNN}{\texttt{Stacks tag 0GNN}}
\group{functors}
...
\label{equation-map}
\vcenter{
\begin{array}{cccc}A^{\oplus m_M} \underset{\varphi_M}{\longrightarrow}\underset{\psi_f}{\downarrow} & A^{\oplus n_M} \longrightarrow\underset{\chi_f}{\downarrow} & M \longrightarrow\underset{f}{\downarrow} & 0 \\ A^{\oplus m_N} \overset{\varphi_N}{\longrightarrow} & A^{\oplus n_N} \longrightarrow & N \longrightarrow & 0\end{array}
}
\end{equation}
...
$$
\begin{array}{cccc}A^{\oplus m_M} \underset{\varphi_M}{\longrightarrow}\underset{\psi}{\downarrow} & A^{\oplus n_M} \longrightarrow\underset{\chi}{\downarrow} & M \longrightarrow\underset{f}{\downarrow} & 0 \\ A^{\oplus m_N} \overset{\varphi_N}{\longrightarrow} & A^{\oplus n_N} \longrightarrow & N \longrightarrow & 0\end{array}
$$
...
$$
\begin{array}{cccc}A^{\oplus m_M} \underset{\varphi_M}{\longrightarrow}\underset{\psi}{\downarrow} & A^{\oplus n_M} \longrightarrow\underset{\chi}{\downarrow} & M \longrightarrow\underset{1}{\downarrow} & 0 \\ K \longrightarrow & L \longrightarrow & M \longrightarrow & 0\end{array}
$$
...
\begin{lemma}[Functor on modules]
\label{functors-lemma-functor-on-modules}
\source{stacks:0GNQ}
\href{https://stacks.math.columbia.edu/tag/0GNQ}{\texttt{Stacks tag 0GNQ}}
\group{functors}
...
\begin{proof}
\uses{functors-lemma-functor-on-modules-fp, functors-lemma-functor-on-fp-modules-right-exact}

Combine Lemmas \ref{functors-lemma-functor-on-modules-fp} and
...
\source{stacks:0GNS}
\href{https://stacks.math.columbia.edu/tag/0GNS}{\texttt{Stacks tag 0GNS}}
\group{functors}
...
$$
\begin{array}{cccc}(\bigoplus\nolimits_{j \in J} A) \otimes_A K \longrightarrow\downarrow & (\bigoplus\nolimits_{i \in I} A) \otimes_A K \longrightarrow\downarrow & M \otimes_A K \longrightarrow\downarrow & 0 \\ F(\bigoplus\nolimits_{j \in J} A) \longrightarrow & F(\bigoplus\nolimits_{i \in I} A) \longrightarrow & F(M) \longrightarrow & 0\end{array}
$$
...
\begin{example}[Functor modules]
\label{functors-example-functor-modules}
\source{stacks:0GNT}
\href{https://stacks.math.columbia.edu/tag/0GNT}{\texttt{Stacks tag 0GNT}}
\group{functors}

\uses{functors-lemma-functor}
...
with all colimits, has a right adjoint (Lemma \ref{functors-lemma-functor}).
\end{example}

\begin{lemma}[Functor modules]
\label{functors-lemma-functor-modules}
\source{stacks:0GNV}
\href{https://stacks.math.columbia.edu/tag/0GNV}{\texttt{Stacks tag 0GNV}}
\group{functors}
...
Lemma \ref{functors-lemma-functor} we may assume $F(M) = M \otimes_A K$
...
and $F'(A)$ given in the proof of Lemma \ref{functors-lemma-functor}.
\end{proof}

\begin{remark}[Composition]
\label{functors-remark-composition}
\source{stacks:0GNW}
\href{https://stacks.math.columbia.edu/tag/0GNW}{\texttt{Stacks tag 0GNW}}
\group{functors}

\uses{functors-lemma-functor-modules}
...
If by the equivalence of Lemma \ref{functors-lemma-functor-modules} the object
...
\begin{remark}[Exact flat]
\label{functors-remark-exact-flat}
\source{stacks:0GNX}
\href{https://stacks.math.columbia.edu/tag/0GNX}{\texttt{Stacks tag 0GNX}}
\group{functors}

\uses{functors-lemma-functor-modules}
In the situation of Lemma \ref{functors-lemma-functor-modules}
...
\source{stacks:0GNY}
\href{https://stacks.math.columbia.edu/tag/0GNY}{\texttt{Stacks tag 0GNY}}
\group{functors}
...
\source{stacks:0GNZ}
\href{https://stacks.math.columbia.edu/tag/0GNZ}{\texttt{Stacks tag 0GNZ}}
\group{functors}
...
\begin{lemma}[Functor equivalence]
\label{functors-lemma-functor-equivalence}
\source{stacks:0GP0}
\href{https://stacks.math.columbia.edu/tag/0GP0}{\texttt{Stacks tag 0GP0}}
\group{functors}
...
\begin{proof}
\uses{functors-lemma-functor, functors-remark-composition, functors-lemma-functor-modules}

Since an equivalence commutes with all colimits, we see that
Lemmas \ref{functors-lemma-functor} applies. Let $K$ be the
...
By Remark \ref{functors-remark-composition} and
Lemma \ref{functors-lemma-functor-modules} we have an isomorphism
$$
...
\begin{lemma}[Functor equivalence linear]
\label{functors-lemma-functor-equivalence-linear}
\source{stacks:0GP1}
\href{https://stacks.math.columbia.edu/tag/0GP1}{\texttt{Stacks tag 0GP1}}
\group{functors}
...
\begin{proof}
\uses{functors-lemma-functor-equivalence}

We get $A \to B$ and $L$ from Lemma \ref{functors-lemma-functor-equivalence}.
To finish the proof, we need to show that the $R$-linearity
of $F$ forces $A \to B$ to be an $R$-algebra map. We omit the details.
\end{proof}

\begin{remark}[Monoidal]
\label{functors-remark-monoidal}
\source{stacks:0GP2}
\href{https://stacks.math.columbia.edu/tag/0GP2}{\texttt{Stacks tag 0GP2}}
\group{functors}
...
then $F(M) = M \otimes_{A, \varphi} B$ by Lemma \ref{functors-lemma-functor}.
\end{enumerate}
...
\begin{lemma}[Functor fp modules]
\label{functors-lemma-functor-fp-modules}
\source{stacks:0GP4}
\href{https://stacks.math.columbia.edu/tag/0GP4}{\texttt{Stacks tag 0GP4}}
\group{functors}
...
Special case of Lemma \ref{functors-lemma-functor-on-fp-modules}.
\end{proof}

\begin{remark}[Monoidal extension]
\label{functors-remark-monoidal-extension}
\source{stacks:0GP5}
\href{https://stacks.math.columbia.edu/tag/0GP5}{\texttt{Stacks tag 0GP5}}
\group{functors}

\uses{functors-lemma-functor-fp-modules}
With $A$, $B$, $F$, and $F'$ as in Lemma \ref{functors-lemma-functor-fp-modules}.
...
\begin{lemma}[Functor fp modules exact]
\label{functors-lemma-functor-fp-modules-exact}
\source{stacks:0GP6}
\href{https://stacks.math.columbia.edu/tag/0GP6}{\texttt{Stacks tag 0GP6}}
\group{functors}
...
\begin{proof}
\uses{functors-lemma-functor-on-fp-modules-additive, functors-lemma-functor-on-fp-modules-right-exact}

Follows from Lemmas \ref{functors-lemma-functor-on-fp-modules-additive} and
\ref{functors-lemma-functor-on-fp-modules-right-exact}.
\end{proof}

\begin{remark}[Monoidal extension exact]
\label{functors-remark-monoidal-extension-exact}
\source{stacks:0GP7}
\href{https://stacks.math.columbia.edu/tag/0GP7}{\texttt{Stacks tag 0GP7}}
\group{functors}

\uses{functors-remark-monoidal, functors-remark-monoidal-extension, functors-lemma-functor-fp-modules-exact}
Combining Remarks \ref{functors-remark-monoidal} and \ref{functors-remark-monoidal-extension}
and Lemma \ref{functors-lemma-functor-fp-modules-exact}
...
\begin{lemma}[Functor fp modules left exact]
\label{functors-lemma-functor-fp-modules-left-exact}
\source{stacks:0GP8}
\href{https://stacks.math.columbia.edu/tag/0GP8}{\texttt{Stacks tag 0GP8}}
\group{functors}
...
\begin{proof}
\uses{functors-lemma-functor-on-fp-modules-left-exact}

Special case of Lemma \ref{functors-lemma-functor-on-fp-modules-left-exact}.
\end{proof}

For a ring $A$ let us denote $\text{Mod}^{fg}_A$ the category of
finitely generated $A$-modules (AKA finite $A$-modules).

\begin{lemma}[Functor finite modules]
\label{functors-lemma-functor-finite-modules}
\source{stacks:0GP9}
\href{https://stacks.math.columbia.edu/tag/0GP9}{\texttt{Stacks tag 0GP9}}
\group{functors}
...
\begin{proof}
\uses{functors-lemma-functor-fp-modules-exact, functors-lemma-functor-fp-modules-left-exact}

See Lemmas \ref{functors-lemma-functor-fp-modules-exact} and
...
\begin{example}[Functor quasi coherent]
\label{functors-example-functor-quasi-coherent}
\source{stacks:0FZB}
\href{https://stacks.math.columbia.edu/tag/0FZB}{\texttt{Stacks tag 0FZB}}
\group{functors}
...
Lemma \ref{functors-lemma-functor-modules}.

\begin{lemma}[Functor quasi coherent from affine]
\label{functors-lemma-functor-quasi-coherent-from-affine}
\source{stacks:0FZD}
\href{https://stacks.math.columbia.edu/tag/0FZD}{\texttt{Stacks tag 0FZD}}
\group{functors}
...
\begin{proof}
\uses{functors-example-functor-quasi-coherent, functors-lemma-functor-on-modules}
...
Example \ref{functors-example-functor-quasi-coherent} we already know that
...
Lemma \ref{functors-lemma-functor-on-modules} because we have an isomorphism
...
\begin{remark}[Affine morphism]
\label{functors-remark-affine-morphism}
\source{stacks:0FZE}
\href{https://stacks.math.columbia.edu/tag/0FZE}{\texttt{Stacks tag 0FZE}}
\group{functors}
...
\begin{lemma}[Functor quasi coherent from affine compose]
\label{functors-lemma-functor-quasi-coherent-from-affine-compose}
\source{stacks:0FZF}
\href{https://stacks.math.columbia.edu/tag/0FZF}{\texttt{Stacks tag 0FZF}}
\group{functors}

\uses{functors-lemma-functor-quasi-coherent-from-affine}
In Lemma \ref{functors-lemma-functor-quasi-coherent-from-affine} let $F$
...
\begin{proof}
\uses{functors-remark-affine-morphism}

Proof of (1). Consider the commutative diagram
$$
\begin{array}{ccc}X' \times_R Y \overset{\text{pr}'_2}{\searrow}\underset{f \times \text{id}_Y}{\searrow}\underset{\text{pr}'_1}{\downarrow} &  &  \\  & X \times_R Y \underset{\text{pr}_2}{\longrightarrow}\underset{\text{pr}_1}{\downarrow} & Y \\ X' \overset{f}{\longrightarrow} & X & \end{array}
$$
...
The second equality hold by Remark \ref{functors-remark-affine-morphism}.
...
$$
\begin{array}{ccc}X \times_R Y' \underset{\text{pr}'_2}{\longrightarrow}\overset{\text{id}_X \times g}{\searrow}\underset{\text{pr}'_1}{\searrow} &  & Y' \overset{g}{\downarrow} \\  & X \times_R Y \underset{\text{pr}_2}{\longrightarrow}\overset{\text{pr}_1}{\downarrow} & Y \\  & X & \end{array}
$$
We have
\begin{align*}
...
\begin{lemma}[Functor quasi coherent from affine diagonal pre]
\label{functors-lemma-functor-quasi-coherent-from-affine-diagonal-pre}
\source{stacks:0GPA}
\href{https://stacks.math.columbia.edu/tag/0GPA}{\texttt{Stacks tag 0GPA}}
\group{functors}
...
\begin{proof}
\uses{functors-lemma-functor-quasi-coherent-from-affine, functors-lemma-functor-quasi-coherent-from-affine-compose}
...
on $X' \times_R Y$ by Lemma \ref{functors-lemma-functor-quasi-coherent-from-affine}.
...
Lemma \ref{functors-lemma-functor-quasi-coherent-from-affine-compose}.
...
$$
\begin{array}{cccc} & F(\mathcal{F}) \longrightarrow\downarrow & \bigoplus F(j_{i_0*}\mathcal{F}_{i_0}) \longrightarrow\downarrow & \bigoplus F(j_{i_0i_1*}\mathcal{F}_{i_0i_1}) \downarrow \\ 0 \longrightarrow & F_\mathcal{K}(\mathcal{F}) \longrightarrow & \bigoplus
\text{pr}_{i_0, 2, *}
(\text{pr}_1^*\mathcal{F} \otimes \mathcal{K})_{i_0}
\longrightarrow & \bigoplus
\text{pr}_{i_0i_1, 2, *}
(\text{pr}_1^*\mathcal{F} \otimes \mathcal{K})_{i_0i_1}\end{array}
$$
...
\begin{lemma}[Coh noetherian from affine flat]
\label{functors-lemma-coh-noetherian-from-affine-flat}
\source{stacks:0FZG}
\href{https://stacks.math.columbia.edu/tag/0FZG}{\texttt{Stacks tag 0FZG}}
\group{functors}

\uses{functors-lemma-functor-quasi-coherent-from-affine, functors-lemma-functor-quasi-coherent-from-affine-diagonal-pre}
In Lemma \ref{functors-lemma-functor-quasi-coherent-from-affine}
or in Lemma \ref{functors-lemma-functor-quasi-coherent-from-affine-diagonal-pre}
if $F$ is an exact functor, then the corresponding object
$\mathcal{K}$ of $\QCoh(\mathcal{O}_{X \times_R Y})$ is flat over $X$.
\end{lemma}

\begin{proof}
\uses{functors-lemma-functor-quasi-coherent-from-affine, functors-lemma-functor-quasi-coherent-from-affine-compose, functors-remark-exact-flat}

We may assume $X$ is affine, so we are in the case of
Lemma \ref{functors-lemma-functor-quasi-coherent-from-affine}.
By Lemma \ref{functors-lemma-functor-quasi-coherent-from-affine-compose}
we may assume $Y$ is affine. In the affine case the statement
translates into Remark \ref{functors-remark-exact-flat}.
\end{proof}

\begin{lemma}[Functor quasi coherent from affine diagonal]
\label{functors-lemma-functor-quasi-coherent-from-affine-diagonal}
\source{stacks:0FZH}
\href{https://stacks.math.columbia.edu/tag/0FZH}{\texttt{Stacks tag 0FZH}}
\group{functors}
...
\begin{proof}
\uses{functors-lemma-functor-quasi-coherent-from-affine-diagonal-pre, functors-lemma-coh-noetherian-from-affine-flat}
...
in Lemma \ref{functors-lemma-functor-quasi-coherent-from-affine-diagonal-pre}.
By Lemma \ref{functors-lemma-coh-noetherian-from-affine-flat} we see
...
computes $R\text{pr}_{2, *}(\text{pr}_1^*\mathcal{F} \otimes \mathcal{K})$.
Please see proof of
Lemma \ref{functors-lemma-functor-quasi-coherent-from-affine-diagonal-pre}
...
\begin{remark}[Characterize FM QCoh]
\label{functors-remark-characterize-FM-QCoh}
\source{stacks:0GPB}
\href{https://stacks.math.columbia.edu/tag/0GPB}{\texttt{Stacks tag 0GPB}}
\group{functors}

\uses{functors-lemma-functor-quasi-coherent-from-affine-diagonal, functors-lemma-functor-quasi-coherent-from-affine-diagonal-pre}
Let $R$ be a ring. Let $X$ and $Y$ be schemes over $R$. Assume $X$
is quasi-compact with affine diagonal.
Lemma \ref{functors-lemma-functor-quasi-coherent-from-affine-diagonal} may
...
\begin{lemma}[Compose FM QCoh]
\label{functors-lemma-compose-FM-QCoh}
\source{stacks:0GPC}
\href{https://stacks.math.columbia.edu/tag/0GPC}{\texttt{Stacks tag 0GPC}}
\group{functors}

\uses{functors-lemma-functor-quasi-coherent-from-affine-diagonal}
...
Lemma \ref{functors-lemma-functor-quasi-coherent-from-affine-diagonal}.
...
\begin{proof}
\uses{functors-lemma-functor-quasi-coherent-from-affine-diagonal, functors-lemma-functor-quasi-coherent-from-affine, functors-remark-affine-morphism}

Since $G \circ F : \QCoh(\mathcal{O}_X) \to \QCoh(\mathcal{O}_Z)$
is $R$-linear, exact, and commutes with arbitrary direct sums,
we find by Lemma \ref{functors-lemma-functor-quasi-coherent-from-affine-diagonal}
...
Lemma \ref{functors-lemma-functor-quasi-coherent-from-affine} that
$$
\Gamma(U \times_R W, \mathcal{M}) =
...
by Remark \ref{functors-remark-affine-morphism} for example.
...
of Lemma \ref{functors-lemma-functor-quasi-coherent-from-affine}.)
...
$$
\begin{array}{cc}U \times_R Y \times_R Z \longrightarrow\downarrow & U \times_R Y \downarrow \\ Y \times_R Z \longrightarrow & Y\end{array}
$$
we obtain
$$
...
$$
Using Remark \ref{functors-remark-affine-morphism} again we find
\begin{align*}
(U \times_R Y \times_R Z \to Y \times_R Z)_*
\text{pr}_{12}^*\mathcal{K}|_{U \times_R Y \times_R Z}
\otimes \mathcal{L} \\
...
\begin{lemma}[Persistence exactness]
\label{functors-lemma-persistence-exactness}
\source{stacks:0FZI}
\href{https://stacks.math.columbia.edu/tag/0FZI}{\texttt{Stacks tag 0FZI}}
\group{functors}

\uses{functors-lemma-functor-quasi-coherent-from-affine-diagonal}
Let $R$, $X$, $Y$, and $\mathcal{K}$ be as in
Lemma \ref{functors-lemma-functor-quasi-coherent-from-affine-diagonal} part (2).
...
$$
\begin{array}{ccc}T \times_R X \downarrow & T \times_R X \times_R Y \downarrow\longleftarrow\longrightarrow & T \times_R Y \downarrow \\ X & X \times_R Y \longleftarrow\longrightarrow & Y\end{array}
$$
...
The equality holds by Remark \ref{functors-remark-affine-morphism}.
\end{proof}

\begin{lemma}[Functor quasi coherent from separated]
\label{functors-lemma-functor-quasi-coherent-from-separated}
\source{stacks:0FZJ}
\href{https://stacks.math.columbia.edu/tag/0FZJ}{\texttt{Stacks tag 0FZJ}}
\group{functors}

\uses{functors-lemma-functor-quasi-coherent-from-affine-diagonal}
In Lemma \ref{functors-lemma-functor-quasi-coherent-from-affine-diagonal}
...
\begin{proof}
\uses{functors-lemma-persistence-exactness}
...
Thus, by Lemma \ref{functors-lemma-persistence-exactness}
...
\begin{lemma}[Categorically compact QCoh]
\label{functors-lemma-categorically-compact-QCoh}
\source{stacks:0GPE}
\href{https://stacks.math.columbia.edu/tag/0GPE}{\texttt{Stacks tag 0GPE}}
\group{functors}
...
\begin{lemma}[Supported on support pre]
\label{functors-lemma-supported-on-support-pre}
\source{stacks:0GPF}
\href{https://stacks.math.columbia.edu/tag/0GPF}{\texttt{Stacks tag 0GPF}}
\group{functors}
...
\begin{lemma}[Supported on support]
\label{functors-lemma-supported-on-support}
\source{stacks:0GPG}
\href{https://stacks.math.columbia.edu/tag/0GPG}{\texttt{Stacks tag 0GPG}}
\group{functors}
...
\begin{proof}
\uses{functors-lemma-supported-on-support-pre}
...
By Lemma \ref{functors-lemma-supported-on-support-pre}
...
\begin{lemma}[Quotient supported on closed]
\label{functors-lemma-quotient-supported-on-closed}
\source{stacks:0GPH}
\href{https://stacks.math.columbia.edu/tag/0GPH}{\texttt{Stacks tag 0GPH}}
\group{functors}
...
\source{stacks:0GPI}
\href{https://stacks.math.columbia.edu/tag/0GPI}{\texttt{Stacks tag 0GPI}}
\group{functors}
...
\begin{proof}
\uses{functors-lemma-categorically-compact-QCoh}
...
(Lemma \ref{functors-lemma-categorically-compact-QCoh}),
...
\begin{proposition}[Gabriel rosenberg]
\label{functors-proposition-gabriel-rosenberg}
\source{stacks:0GPJ}
\href{https://stacks.math.columbia.edu/tag/0GPJ}{\texttt{Stacks tag 0GPJ}}
\group{functors}
...
\begin{proof}
\uses{functors-lemma-categorically-compact-QCoh, functors-lemma-supported-on-support, functors-lemma-quotient-supported-on-closed, functors-lemma-characterize-affine, functors-lemma-functor-equivalence}
...
By Lemma \ref{functors-lemma-supported-on-support} we see that $F$ induces an
equivalence between
\begin{enumerate}
...
\end{enumerate}
By Lemma \ref{functors-lemma-quotient-supported-on-closed} we obtain a commutative
diagram
$$
\begin{array}{cc}\QCoh(\mathcal{O}_X) \underset{F}{\longrightarrow}\downarrow & \QCoh(\mathcal{O}_Y) \downarrow \\ \QCoh(\mathcal{O}_U) \overset{F_U}{\longrightarrow} & \QCoh(\mathcal{O}_V)\end{array}
$$
where the vertical arrows are the restruction functors and the
horizontal arrows are equivalences. By Lemma \ref{functors-lemma-characterize-affine}
we conclude that $V$ is affine. For the affine case we have
Lemma \ref{functors-lemma-functor-equivalence}. Thus we find that there
...
\begin{lemma}[Functor coherent]
\label{functors-lemma-functor-coherent}
\source{stacks:0FZL}
\href{https://stacks.math.columbia.edu/tag/0FZL}{\texttt{Stacks tag 0FZL}}
\group{functors}
...
\begin{lemma}[Equivalence coherent]
\label{functors-lemma-equivalence-coherent}
\source{stacks:0GPK}
\href{https://stacks.math.columbia.edu/tag/0GPK}{\texttt{Stacks tag 0GPK}}
\group{functors}
...
\begin{proof}
\uses{functors-lemma-functor-coherent, functors-proposition-gabriel-rosenberg}

By Lemma \ref{functors-lemma-functor-coherent} we obtain a unique functor
...
\begin{remark}[Equivalence coherent linear]
\label{functors-remark-equivalence-coherent-linear}
\source{stacks:0GPL}
\href{https://stacks.math.columbia.edu/tag/0GPL}{\texttt{Stacks tag 0GPL}}
\group{functors}

\uses{functors-lemma-equivalence-coherent}
In Lemma \ref{functors-lemma-equivalence-coherent} if $X$ and $Y$ are defined
...
\source{stacks:0FZM}
\href{https://stacks.math.columbia.edu/tag/0FZM}{\texttt{Stacks tag 0FZM}}
\group{functors}
...
\begin{lemma}[Functor coherent over field]
\label{functors-lemma-functor-coherent-over-field}
\source{stacks:0FZN}
\href{https://stacks.math.columbia.edu/tag/0FZN}{\texttt{Stacks tag 0FZN}}
\group{functors}
...
\begin{proof}
\uses{functors-lemma-functor-quasi-coherent-from-affine-diagonal, functors-lemma-functor-coherent, functors-lemma-functor-quasi-coherent-from-separated, functors-lemma-characterize-finite}
...
as in (1). By Lemma \ref{functors-lemma-functor-coherent} we can extend $F$
to a $k$-linear exact functor on the
categories of quasi-coherent modules which commutes with arbitrary direct sums.
By Lemma \ref{functors-lemma-functor-quasi-coherent-from-affine-diagonal}
...
conclude from Lemma \ref{functors-lemma-functor-quasi-coherent-from-separated}
...
that $Z \to Y$ is finite by Lemma \ref{functors-lemma-characterize-finite}.
\end{proof}

\begin{lemma}[Pushforward invertible pre]
\label{functors-lemma-pushforward-invertible-pre}
\source{stacks:0FZP}
\href{https://stacks.math.columbia.edu/tag/0FZP}{\texttt{Stacks tag 0FZP}}
\group{functors}
...
\begin{lemma}[Pushforward invertible]
\label{functors-lemma-pushforward-invertible}
\source{stacks:0FZQ}
\href{https://stacks.math.columbia.edu/tag/0FZQ}{\texttt{Stacks tag 0FZQ}}
\group{functors}
...
\begin{proof}
\uses{functors-lemma-pushforward-invertible-pre}

By Lemma \ref{functors-lemma-pushforward-invertible-pre}
...
\begin{lemma}[Equivalence coherent over field]
\label{functors-lemma-equivalence-coherent-over-field}
\source{stacks:0FZR}
\href{https://stacks.math.columbia.edu/tag/0FZR}{\texttt{Stacks tag 0FZR}}
\group{functors}
...
\begin{proof}
\uses{functors-lemma-equivalence-coherent, functors-remark-equivalence-coherent-linear}
[Proof using Gabriel-Rosenberg reconstruction]
This lemma is a weak form of the results discussed in
Lemma \ref{functors-lemma-equivalence-coherent} and
Remark \ref{functors-remark-equivalence-coherent-linear}.
\end{proof}

\begin{proof}
\uses{functors-lemma-functor-coherent-over-field, functors-lemma-pushforward-invertible-pre}
[Proof not relying on Gabriel-Rosenberg reconstruction]
By Lemma \ref{functors-lemma-functor-coherent-over-field} we obtain a coherent
...
then by Lemma \ref{functors-lemma-pushforward-invertible-pre}
