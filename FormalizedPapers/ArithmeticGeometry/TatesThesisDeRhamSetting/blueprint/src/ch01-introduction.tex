...
\end{equation}
 ...
 for $\LocSys_{\bG_m}$ the moduli space of rank $1$ de Rham local systems on the
...
\]
 ...
 i.e., there is a preferred object of $T(\o{\sD}_x)$,
...
\]
 ...
 This functional evaluated on the vacuum is
$T(X) \in \Vect$.
...
%\footnote{Specifically, the gauge theory in
...
\]
 ...
 Up to smearing\footnote{Throughout this exposition of the general ideas,
...
\]
 ...
 of boundary conditions for $\YM_{\check{G}}$. I.e., the
...
\]
 ...
 are supposed to match, where the middle isomorphism is local geometric
...
\]
 ...
 As our group is abelian, we expect an honest equivalence
...
\]
 ...
 is expected to be $3d$ mirror dual (with respect to our $(G,\check{G})$).
...
\]
 ...
 Here $\fL_n^+\bA^1$ is the (scheme corresponding to)
...
\]
 ...
 As the left hand side is modules over a Weyl algebra, this amounts
