...
\begin{definition}
\label{src-pixtons-formula-abel-jacobi-picard-stack-ch03-picard-stacks-and-operational-chow-statement-1}
\source{pixtons-formula-abel-jacobi-picard-stack}
\notready
...
result.
\begin{corollary}
\label{src-pixtons-formula-abel-jacobi-picard-stack-ch03-picard-stacks-and-operational-chow-statement-2}
\source{pixtons-formula-abel-jacobi-picard-stack}
\notready
...
\end{lemma}
\begin{remark}
\label{src-pixtons-formula-abel-jacobi-picard-stack-ch03-picard-stacks-and-operational-chow-statement-3}
\source{pixtons-formula-abel-jacobi-picard-stack}
\notready
