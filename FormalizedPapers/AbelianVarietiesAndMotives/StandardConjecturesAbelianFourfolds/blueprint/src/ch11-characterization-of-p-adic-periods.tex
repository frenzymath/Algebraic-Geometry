...
\begin{equation} \label{eq:mirella3} \varphi(v_{B})  \in V_{B,-}   \textrm{and}  \varphi(v_{Z})  \in V_{Z,-}
\source{standard-conjectures-abelian-fourfolds}
\end{equation}
as well as
\begin{equation} \label{eq:mirella4} \varphi^2(v_B)=v_B   \textrm{and}    \varphi^2(v_Z)=v_Z.
\source{standard-conjectures-abelian-fourfolds}
\end{equation}
...
\begin{equation} \label{eq:mirella9}v_B + \varphi(v_{B})  \in  V_{B,p}   \textrm{and}     v_Z + \varphi(v_{Z})  \in  V_{Z,p}.
\source{standard-conjectures-abelian-fourfolds}
\end{equation}

Write  $\langle \cdot  ,  \cdot \rangle_{?}$ for the bilinear form associated to the quadratic form $q_?$. Then we have
\[q_{B,p}(v_B + \varphi(v_{B}) ) = 2 \langle v_B ,  \varphi(v_{B}) \rangle_{B,p}    \textrm{and}    q_{Z,p}(v_Z + \varphi(v_{Z}) ) = 2 \langle v_Z ,  \varphi(v_{Z}) \rangle_{Z,p}  \]
