% Source-derived chapter 07: N\'{e}ron--Tate distance between points on curves
% Original source: uniformity-mordell-lang-curves
\chapter{N\'{e}ron--Tate distance between points on curves}
\label{uniformity-mordell-lang-curves-chapter-07}
\source{uniformity-mordell-lang-curves}

\begin{remark}[Source section]
\label{uniformity-mordell-lang-curves-chapter-07-source}
\source{uniformity-mordell-lang-curves}
\source{uniformity-mordell-lang-curves}
...
% The source section title was: N\'{e}ron--Tate distance between points on curves
\label{SectionDistanceCurve}
\source{uniformity-mordell-lang-curves}
