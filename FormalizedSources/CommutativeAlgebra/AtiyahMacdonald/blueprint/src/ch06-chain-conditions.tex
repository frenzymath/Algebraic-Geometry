...
\label{am-prop-6-1}
\dcref{6.1}
\source{atiyah-macdonald-commutative-algebra:page-0083}\uses{}
...
\label{am-prop-6-2}
\dcref{6.2}
\source{atiyah-macdonald-commutative-algebra:page-0084}\uses{}
...
\label{am-cor-6-4}
\dcref{6.4}
\source{atiyah-macdonald-commutative-algebra:page-0085}\uses{}
...
\dcref{6.6}
\source{atiyah-macdonald-commutative-algebra:page-0085}\uses{}
If $A$ is Noetherian (respectively Artinian), then $A/\mathfrak{a}$ is so for every
ideal $\mathfrak{a}$.
\end{proposition}
\begin{proof}
The quotient is a quotient module of $A$ and its $A$-submodules are exactly its
$A/\mathfrak{a}$-submodules.
\end{proof}
...
\label{am-prop-6-7}
\dcref{6.7}
\source{atiyah-macdonald-commutative-algebra:page-0086}\uses{}
...
\label{am-prop-6-10}
\dcref{6.10}
\source{atiyah-macdonald-commutative-algebra:page-0087}\uses{}
...
\dcref{6.11}
\source{atiyah-macdonald-commutative-algebra:page-0087}\uses{}
If $(0)=\mathfrak{m}_1\cdots\mathfrak{m}_n$ is a product of maximal ideals, then $A$ is Noetherian
iff Artinian.
\end{corollary}
\begin{proof}
Use the finite chain $A\supset\mathfrak{m}_1\supset\mathfrak{m}_1\mathfrak{m}_2\supset\cdots\supset0$.
