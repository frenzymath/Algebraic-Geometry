...
We define by transfinite recursion $V_0 = \emptyset$,
...
\begin{lemma}[Axiom regularity]
\label{sets-lemma-axiom-regularity}
\source{stacks:000C}
\href{https://stacks.math.columbia.edu/tag/000C}{\texttt{Stacks tag 000C}}
\group{sets}
...
transfinite recursion. We note the equality $\aleph_1 = \omega_1$.
...
Hence alternatively we can define the cofinality of
$\alpha$ as the least cardinality of a cofinal subset of $\alpha$.

\begin{lemma}[Map from set lifts]
\label{sets-lemma-map-from-set-lifts}
\source{stacks:05N2}
\href{https://stacks.math.columbia.edu/tag/05N2}{\texttt{Stacks tag 05N2}}
\group{sets}
...
\begin{proposition}[Exist ordinals large cofinality]
\label{sets-proposition-exist-ordinals-large-cofinality}
\source{stacks:05N3}
\href{https://stacks.math.columbia.edu/tag/05N3}{\texttt{Stacks tag 05N3}}
\group{sets}
...
\source{stacks:000G}
\href{https://stacks.math.columbia.edu/tag/000G}{\texttt{Stacks tag 000G}}
\group{sets}
...
\begin{lemma}[Bounded size]
\label{sets-lemma-bounded-size}
\source{stacks:000I}
\href{https://stacks.math.columbia.edu/tag/000I}{\texttt{Stacks tag 000I}}
\group{sets}
...
\begin{lemma}[Construct category]
\label{sets-lemma-construct-category}
\source{stacks:000J}
\href{https://stacks.math.columbia.edu/tag/000J}{\texttt{Stacks tag 000J}}
\group{sets}
...
\begin{proof}
\uses{sets-lemma-bounded-size, sets-proposition-exist-ordinals-large-cofinality}
...
as in Lemma \ref{sets-lemma-bounded-size}.
...
\begin{remark}[How to use reflection]
\label{sets-remark-how-to-use-reflection}
\source{stacks:000O}
\href{https://stacks.math.columbia.edu/tag/000O}{\texttt{Stacks tag 000O}}
\group{sets}
...
\begin{lemma}[Bound affine]
\label{sets-lemma-bound-affine}
\source{stacks:000P}
\href{https://stacks.math.columbia.edu/tag/000P}{\texttt{Stacks tag 000P}}
\group{sets}
...
\begin{lemma}[Bound size]
\label{sets-lemma-bound-size}
\source{stacks:000Q}
\href{https://stacks.math.columbia.edu/tag/000Q}{\texttt{Stacks tag 000Q}}
\group{sets}
...
\begin{lemma}[Bound size fibre product]
\label{sets-lemma-bound-size-fibre-product}
\source{stacks:04T6}
\href{https://stacks.math.columbia.edu/tag/04T6}{\texttt{Stacks tag 04T6}}
\group{sets}
...
\begin{proof}
\uses{sets-lemma-bound-size, sets-lemma-bound-affine}
...
Lemma \ref{sets-lemma-bound-size}
...
$U_i \times_S V_j$. By
Lemma \ref{sets-lemma-bound-affine}
...
\begin{lemma}[Bound finite type]
\label{sets-lemma-bound-finite-type}
\source{stacks:04T7}
\href{https://stacks.math.columbia.edu/tag/04T7}{\texttt{Stacks tag 04T7}}
\group{sets}
...
\begin{lemma}[Bound monomorphism]
\label{sets-lemma-bound-monomorphism}
\source{stacks:04VA}
\href{https://stacks.math.columbia.edu/tag/04VA}{\texttt{Stacks tag 04VA}}
\group{sets}
...
with $|J| \leq \text{size}(Y)$. By Lemma \ref{sets-lemma-bound-size}
...
and Lemma \ref{sets-lemma-bound-affine}. Thus it suffices to show
...
\begin{lemma}[What is in it]
\label{sets-lemma-what-is-in-it}
\source{stacks:000R}
\href{https://stacks.math.columbia.edu/tag/000R}{\texttt{Stacks tag 000R}}
\group{sets}

\uses{sets-lemma-construct-category}
Let $\alpha$ be an ordinal as in Lemma \ref{sets-lemma-construct-category} above.
...
\begin{proof}
\uses{sets-lemma-bound-size, sets-lemma-bound-finite-type, sets-lemma-bound-monomorphism, sets-lemma-bound-affine}
...
by Lemma \ref{sets-lemma-bound-size}. Statement (7) follows from (6).
Namely, for any affine open $V \subset T$ we have
$\text{size}(V) \leq \text{size}(S)$ by
Lemma \ref{sets-lemma-bound-finite-type}.
Thus, we see that (6) applies in the situation of (7).
Part (8) follows from
Lemma \ref{sets-lemma-bound-monomorphism}.

\medskip\noindent
Statement (9) is translated, via Lemma \ref{sets-lemma-bound-affine},
...
\begin{remark}[What is not in it]
\label{sets-remark-what-is-not-in-it}
\source{stacks:000S}
\href{https://stacks.math.columbia.edu/tag/000S}{\texttt{Stacks tag 000S}}
\group{sets}

\uses{sets-lemma-what-is-in-it}
...
Thus the ``And so on'' of Lemma \ref{sets-lemma-what-is-in-it} above
...
\begin{lemma}[Bound by covering]
\label{sets-lemma-bound-by-covering}
\source{stacks:0AHK}
\href{https://stacks.math.columbia.edu/tag/0AHK}{\texttt{Stacks tag 0AHK}}
\group{sets}
...
\begin{lemma}[Bound fppf covering]
\label{sets-lemma-bound-fppf-covering}
\source{stacks:0AHL}
\href{https://stacks.math.columbia.edu/tag/0AHL}{\texttt{Stacks tag 0AHL}}
\group{sets}
...
\begin{proof}
\uses{sets-lemma-bound-finite-type, sets-lemma-bound-size}
...
by Lemma \ref{sets-lemma-bound-size}.
\end{proof}
...
\begin{lemma}[Sets with group action]
\label{sets-lemma-sets-with-group-action}
\source{stacks:000U}
\href{https://stacks.math.columbia.edu/tag/000U}{\texttt{Stacks tag 000U}}
\group{sets}
...
Lemma \ref{sets-lemma-construct-category} above.
\end{proof}

\begin{lemma}[What is in it G sets]
\label{sets-lemma-what-is-in-it-G-sets}
\source{stacks:000V}
\href{https://stacks.math.columbia.edu/tag/000V}{\texttt{Stacks tag 000V}}
\group{sets}

\uses{sets-lemma-sets-with-group-action}
Let $\alpha$ be an ordinal as in Lemma \ref{sets-lemma-sets-with-group-action}
...
\begin{lemma}[Coverings site]
\label{sets-lemma-coverings-site}
\source{stacks:000X}
\href{https://stacks.math.columbia.edu/tag/000X}{\texttt{Stacks tag 000X}}
\group{sets}
...
\begin{proof}
\uses{sets-proposition-exist-ordinals-large-cofinality}
...
\source{stacks:000Y}
\href{https://stacks.math.columbia.edu/tag/000Y}{\texttt{Stacks tag 000Y}}
\group{sets}

\uses{sets-remark-how-to-use-reflection}
...
described at the end of Section \ref{sets-section-reflection-principle}
and in Remark \ref{sets-remark-how-to-use-reflection}).
\end{remark}
...
\begin{lemma}[Abelian injectives]
\label{sets-lemma-abelian-injectives}
\source{stacks:0010}
\href{https://stacks.math.columbia.edu/tag/0010}{\texttt{Stacks tag 0010}}
\group{sets}
