...
\source{stacks:07C5}
\href{https://stacks.math.columbia.edu/tag/07C5}{\texttt{Stacks tag 07C5}}
\group{smoothing}
...
\begin{lemma}[Find strictly standard]
\label{smoothing-lemma-find-strictly-standard}
\source{stacks:07C6}
\href{https://stacks.math.columbia.edu/tag/07C6}{\texttt{Stacks tag 07C6}}
\group{smoothing}
...
Lemma \ref{smoothing-lemma-compare-standard}.

\begin{definition}[Strictly standard]
\label{smoothing-definition-strictly-standard}
\source{stacks:07C7}
\href{https://stacks.math.columbia.edu/tag/07C7}{\texttt{Stacks tag 07C7}}
\group{smoothing}
...
\begin{lemma}[Parse equation strictly standard one]
\label{smoothing-lemma-parse-equation-strictly-standard-one}
\source{stacks:07ET}
\href{https://stacks.math.columbia.edu/tag/07ET}{\texttt{Stacks tag 07ET}}
\group{smoothing}
...
\source{stacks:07CA}
\href{https://stacks.math.columbia.edu/tag/07CA}{\texttt{Stacks tag 07CA}}
\group{smoothing}
...
\begin{proof}
\uses{smoothing-definition-strictly-standard, smoothing-lemma-parse-equation-strictly-standard-one, smoothing-lemma-find-strictly-standard}
...
be as in Definition \ref{smoothing-definition-strictly-standard}.
...
Lemma \ref{smoothing-lemma-parse-equation-strictly-standard-one}.
...
follows from Lemma \ref{smoothing-lemma-find-strictly-standard}.
\end{proof}

\begin{example}[Not quasi compact]
\label{smoothing-example-not-quasi-compact}
\source{stacks:07CB}
\href{https://stacks.math.columbia.edu/tag/07CB}{\texttt{Stacks tag 07CB}}
\group{smoothing}
...
\begin{lemma}[Strictly standard base change]
\label{smoothing-lemma-strictly-standard-base-change}
\source{stacks:07CC}
\href{https://stacks.math.columbia.edu/tag/07CC}{\texttt{Stacks tag 07CC}}
\group{smoothing}
...
\begin{lemma}[Final solve]
\label{smoothing-lemma-final-solve}
\source{stacks:07EU}
\href{https://stacks.math.columbia.edu/tag/07EU}{\texttt{Stacks tag 07EU}}
\group{smoothing}
...
\begin{lemma}[Improve presentation]
\label{smoothing-lemma-improve-presentation}
\source{stacks:07CE}
\href{https://stacks.math.columbia.edu/tag/07CE}{\texttt{Stacks tag 07CE}}
\group{smoothing}
...
\begin{proposition}[Smooth and syntomic algebras lift along surjections]
\label{smoothing-proposition-lift-smooth}
\source{stacks:07M8}
\href{https://stacks.math.columbia.edu/tag/07M8}{\texttt{Stacks tag 07M8}}
\group{smoothing}
...
\begin{proof}
\uses{smoothing-lemma-improve-presentation}
...
By Lemma \ref{smoothing-lemma-improve-presentation} the ring map
...
Picture
$$
\begin{array}{ccccc}R \downarrow\longrightarrow &  & C \longrightarrow\downarrow & C' \longrightarrow\downarrow & D \downarrow \\ R/I \longrightarrow & A_0 \longrightarrow & C/IC \overset{\cong}{\longrightarrow} & C'/IC' \longrightarrow & D/ID\end{array}
$$
...
\begin{lemma}[Syntomic complete intersection]
\label{smoothing-lemma-syntomic-complete-intersection}
\source{stacks:07CG}
\href{https://stacks.math.columbia.edu/tag/07CG}{\texttt{Stacks tag 07CG}}
\group{smoothing}
...
Apply Lemma \ref{smoothing-lemma-improve-presentation} to get $A \to C$.
...
\begin{lemma}[Smooth standard smooth]
\label{smoothing-lemma-smooth-standard-smooth}
\source{stacks:07CH}
\href{https://stacks.math.columbia.edu/tag/07CH}{\texttt{Stacks tag 07CH}}
\group{smoothing}
...
\begin{proof}
\uses{smoothing-lemma-syntomic-complete-intersection}

Apply Lemma \ref{smoothing-lemma-syntomic-complete-intersection}
...
\begin{lemma}[Colimit standard smooth]
\label{smoothing-lemma-colimit-standard-smooth}
\source{stacks:07CI}
\href{https://stacks.math.columbia.edu/tag/07CI}{\texttt{Stacks tag 07CI}}
\group{smoothing}
...
\begin{proof}
\uses{smoothing-lemma-smooth-standard-smooth}
...
Lemma \ref{smoothing-lemma-smooth-standard-smooth}.
Then the desired factorization is $A \to B \to C \to B \to \Lambda$.
\end{proof}

\begin{lemma}[Standard smooth include generators]
\label{smoothing-lemma-standard-smooth-include-generators}
\source{stacks:07EY}
\href{https://stacks.math.columbia.edu/tag/07EY}{\texttt{Stacks tag 07EY}}
\group{smoothing}
...
\begin{lemma}[Compare standard]
\label{smoothing-lemma-compare-standard}
\source{stacks:07EZ}
\href{https://stacks.math.columbia.edu/tag/07EZ}{\texttt{Stacks tag 07EZ}}
\group{smoothing}
...
\begin{proof}
\uses{smoothing-definition-strictly-standard, smoothing-lemma-elkik, smoothing-lemma-parse-equation-strictly-standard-one, smoothing-lemma-standard-smooth-include-generators}

Part (a) is clear from the definitions and
Algebra, Lemma \ref{algebra-lemma-standard-smooth}.
Part (b) is clear from Definition \ref{smoothing-definition-strictly-standard}.
...
Lemma \ref{smoothing-lemma-elkik}. By
Lemma \ref{smoothing-lemma-parse-equation-strictly-standard-one}
...
over $R$, see Lemma \ref{smoothing-lemma-standard-smooth-include-generators}.
...
\begin{definition}[Situation: Neron]
\label{smoothing-situation-neron}
\source{stacks:0BJ2}
\href{https://stacks.math.columbia.edu/tag/0BJ2}{\texttt{Stacks tag 0BJ2}}
\group{smoothing}
...
In Situation \ref{smoothing-situation-neron} let $\pi \in R$ be a uniformizer.
...
\begin{lemma}[Neron functorial]
\label{smoothing-lemma-neron-functorial}
\source{stacks:0BJ3}
\href{https://stacks.math.columbia.edu/tag/0BJ3}{\texttt{Stacks tag 0BJ3}}
\group{smoothing}

\uses{smoothing-situation-neron}
In Situation \ref{smoothing-situation-neron} N\'eron's blowup is functorial
...
\begin{lemma}[Neron blowup smooth]
\label{smoothing-lemma-neron-blowup-smooth}
\source{stacks:0BJ4}
\href{https://stacks.math.columbia.edu/tag/0BJ4}{\texttt{Stacks tag 0BJ4}}
\group{smoothing}

\uses{smoothing-situation-neron}
In Situation \ref{smoothing-situation-neron} assume that $R \to A$ is smooth
...
\begin{proof}
\uses{smoothing-lemma-neron-functorial}

By Lemma \ref{smoothing-lemma-neron-functorial} we may replace $A$ by a localization
...
\begin{lemma}[Neron when smooth]
\label{smoothing-lemma-neron-when-smooth}
\source{stacks:0BJ5}
\href{https://stacks.math.columbia.edu/tag/0BJ5}{\texttt{Stacks tag 0BJ5}}
\group{smoothing}
...
\begin{lemma}[Neron desingularization]
\label{smoothing-lemma-neron-desingularization}
\source{stacks:0BJ6}
\href{https://stacks.math.columbia.edu/tag/0BJ6}{\texttt{Stacks tag 0BJ6}}
\group{smoothing}

\uses{smoothing-situation-neron}
In Situation \ref{smoothing-situation-neron}
...
\begin{proof}
\uses{smoothing-lemma-neron-when-smooth, smoothing-lemma-neron-functorial, smoothing-lemma-neron-blowup-smooth}
...
$$
of Lemma \ref{smoothing-lemma-neron-when-smooth}. By the structure of finite modules
...
Lemma \ref{smoothing-lemma-neron-when-smooth}.

\medskip\noindent
Next, we consider what happens when we perform the N\'eron blowup.
Recall that $A'$ is the quotient of $B'/IB'$ by its $\pi$-power
torsion (Lemma \ref{smoothing-lemma-neron-functorial}) and that $R \to B'$ is smooth at
$\mathfrak p_{B'}$ (Lemma \ref{smoothing-lemma-neron-blowup-smooth}).
Thus after blowup we have exactly the same setup. Picture
$$
\begin{array}{ccccc}0 \longrightarrow & I' \longrightarrow & B' \longrightarrow & A' \longrightarrow & 0 \\ 0 \longrightarrow & I \uparrow\longrightarrow & B \uparrow\longrightarrow & A \longrightarrow\uparrow & 0\end{array}
$$
Since $I \subset \mathfrak p_B$, we see that $I \to I'$
factors through $\pi I'$. Looking at the induced map of
complexes we get
$$
\begin{array}{ccc}I'/(I')^2 \otimes_{A'} \Lambda \longrightarrow & \Omega_{B'/R} \otimes_{B'} \Lambda \xlongequal{} & M' \\ I/I^2 \otimes_A \Lambda \longrightarrow\uparrow & \Omega_{B/R} \otimes_B \Lambda \uparrow\xlongequal{} & M\end{array}
$$
Then $M \subset M'$ are finite free $\Lambda$-modules with quotient
$M'/M$ annihilated by $\pi$, see Lemma \ref{smoothing-lemma-neron-blowup-smooth}.
Let $N \subset M$ and $N' \subset M'$ be the images of the horizontal
maps and denote $Q = M/N$ and $Q' = M'/N'$.
We obtain a commutative diagram
$$
\begin{array}{ccccc}0 \longrightarrow & N' \longrightarrow & M' \longrightarrow & Q' \longrightarrow & 0 \\ 0 \longrightarrow & N \longrightarrow\uparrow & M \longrightarrow\uparrow & Q \longrightarrow\uparrow & 0\end{array}
$$
...
$$
\begin{array}{ccccc}0 \longrightarrow & N' \longrightarrow & N'_K \cap M' \longrightarrow & Q'_{tor} \longrightarrow & 0 \\ 0 \longrightarrow & N \longrightarrow\uparrow & N_K \cap M \longrightarrow\uparrow & Q_{tor} \longrightarrow\uparrow & 0\end{array}
$$
...
Theorem \ref{smoothing-theorem-popescu}.

\begin{lemma}[Unramified extensions of DVRs are ind-smooth AKA N\'eron desingularization]
\label{smoothing-lemma-neron-colimit}
\source{stacks:0BJ7}
\href{https://stacks.math.columbia.edu/tag/0BJ7}{\texttt{Stacks tag 0BJ7}}
\group{smoothing}
...
\begin{proof}
\uses{smoothing-situation-neron, smoothing-lemma-neron-desingularization}

By Algebra, Lemma \ref{algebra-lemma-when-colimit} it suffices to show
that any $R \to A \to \Lambda$ as in Situation \ref{smoothing-situation-neron}
...
is smooth at $\mathfrak p$, see Lemma \ref{smoothing-lemma-neron-desingularization}.
...
The goal in this section is to prove (Proposition \ref{smoothing-proposition-lift})
...
\begin{lemma}[Lift once]
\label{smoothing-lemma-lift-once}
\source{stacks:07CK}
\href{https://stacks.math.columbia.edu/tag/07CK}{\texttt{Stacks tag 07CK}}
\group{smoothing}
...
\begin{proof}
\uses{smoothing-lemma-colimit-standard-smooth}
...
assumption and Lemma \ref{smoothing-lemma-colimit-standard-smooth}. Write
$$
...
\begin{lemma}[Lift twice]
\label{smoothing-lemma-lift-twice}
\source{stacks:07CL}
\href{https://stacks.math.columbia.edu/tag/07CL}{\texttt{Stacks tag 07CL}}
\group{smoothing}
...
\begin{proof}
\uses{smoothing-lemma-lift-once}
...
C \to B'/J' \to \Lambda
$$
as in Lemma \ref{smoothing-lemma-lift-once}. Since $B$ is smooth over $R$ we can
...
\begin{proposition}[Ind-smoothness of an algebra is stable under infinitesimal deformations]
\label{smoothing-proposition-lift}
\source{stacks:07CM}
\href{https://stacks.math.columbia.edu/tag/07CM}{\texttt{Stacks tag 07CM}}
\group{smoothing}
...
\begin{proof}
\uses{smoothing-lemma-lift-once, smoothing-lemma-lift-twice}
...
By Lemma \ref{smoothing-lemma-lift-once} we may assume that
$A = B/J$ with $B$ smooth over $R$ and $J \subset IB$
a finitely generated ideal. By
Lemma \ref{smoothing-lemma-lift-twice}
we can find a commutative diagram
$$
\begin{array}{ccc}B \underset{\alpha}{\longrightarrow}\underset{\varphi}{\searrow} &  & B' \overset{\beta}{\swarrow} \\  & \Lambda & \end{array}
$$
...
\source{stacks:07CP}
\href{https://stacks.math.columbia.edu/tag/07CP}{\texttt{Stacks tag 07CP}}
\group{smoothing}
...
$$
\begin{array}{ccc}R/\pi^2R \longrightarrow\downarrow & \bar C \longrightarrow\downarrow & \Lambda/\pi^2\Lambda \downarrow \\ R/\pi R \longrightarrow & D/\pi D \longrightarrow & \Lambda/\pi \Lambda\end{array}
$$
...
\begin{proof}
\uses{smoothing-lemma-find-strictly-standard}
...
Applying
Lemma \ref{smoothing-lemma-find-strictly-standard}
...
\begin{lemma}[Desingularize]
\label{smoothing-lemma-desingularize}
\source{stacks:07CR}
\href{https://stacks.math.columbia.edu/tag/07CR}{\texttt{Stacks tag 07CR}}
\group{smoothing}
...
Lemma \ref{smoothing-lemma-elkik}.
...
\begin{lemma}[Desingularize strictly standard]
\label{smoothing-lemma-desingularize-strictly-standard}
\source{stacks:07CT}
\href{https://stacks.math.columbia.edu/tag/07CT}{\texttt{Stacks tag 07CT}}
\group{smoothing}
...
\begin{proof}
\uses{smoothing-lemma-desingularize, smoothing-lemma-strictly-standard-base-change}

We apply Lemma \ref{smoothing-lemma-desingularize} to
$$
D \longrightarrow A \otimes_R D \longrightarrow \Lambda
$$
and the image of $\pi$ in $D$. By
Lemma \ref{smoothing-lemma-strictly-standard-base-change}
...
Lemma \ref{smoothing-lemma-desingularize} applies and we obtain a factorization
...
\begin{lemma}[Desingularize lifting apply]
\label{smoothing-lemma-desingularize-lifting-apply}
\source{stacks:07F0}
\href{https://stacks.math.columbia.edu/tag/07F0}{\texttt{Stacks tag 07F0}}
\group{smoothing}
...
\begin{proof}
\uses{smoothing-lemma-lifting, smoothing-lemma-desingularize-strictly-standard}

Apply Lemma \ref{smoothing-lemma-lifting} to get $R \to D \to \Lambda$
...
By Lemma \ref{smoothing-lemma-desingularize-strictly-standard}
...
ring is a field, see Lemma \ref{smoothing-lemma-reduce-to-field}.

\begin{definition}[Situation: Global]
\label{smoothing-situation-global}
\source{stacks:07F2}
\href{https://stacks.math.columbia.edu/tag/07F2}{\texttt{Stacks tag 07F2}}
\group{smoothing}

Here $R \to \Lambda$ is a regular ring map of Noetherian rings.
\end{definition}

Let $R \to \Lambda$ be as in Situation \ref{smoothing-situation-global}.
...
\source{stacks:07F3}
\href{https://stacks.math.columbia.edu/tag/07F3}{\texttt{Stacks tag 07F3}}
\group{smoothing}

\uses{smoothing-situation-global}
Let $R_i \to \Lambda_i$, $i = 1, 2$ be as in Situation \ref{smoothing-situation-global}.
...
\begin{lemma}[Delocalize base]
\label{smoothing-lemma-delocalize-base}
\source{stacks:07F4}
\href{https://stacks.math.columbia.edu/tag/07F4}{\texttt{Stacks tag 07F4}}
\group{smoothing}

\uses{smoothing-definition-strictly-standard}
Let $R \to A \to \Lambda$ be ring maps with $A$ of finite presentation
...
elementary standard element (Definition \ref{smoothing-definition-strictly-standard})
in $B$ over $R$.
\end{lemma}

\begin{proof}
\uses{smoothing-lemma-smooth-standard-smooth, smoothing-lemma-standard-smooth-include-generators}

We first apply Lemma \ref{smoothing-lemma-smooth-standard-smooth} to $S^{-1}R \to B'$.
...
see Lemma \ref{smoothing-lemma-standard-smooth-include-generators}.
...
\begin{lemma}[Proving Popescu approximation reduces to algebras over a field]
\label{smoothing-lemma-reduce-to-field}
\source{stacks:07F5}
\href{https://stacks.math.columbia.edu/tag/07F5}{\texttt{Stacks tag 07F5}}
\group{smoothing}


\uses{smoothing-situation-global}
If for every Situation \ref{smoothing-situation-global} where $R$
is a field PT holds, then PT holds in general.
\end{lemma}

\begin{proof}
\uses{smoothing-situation-global, smoothing-proposition-lift, smoothing-lemma-product, smoothing-lemma-delocalize-base, smoothing-lemma-lifting, smoothing-lemma-desingularize-strictly-standard}

Assume PT holds for any Situation \ref{smoothing-situation-global} where $R$ is a field.
Let $R \to \Lambda$ be as in Situation \ref{smoothing-situation-global} arbitrary.
...
By Lemma \ref{smoothing-lemma-product} and our assumption
...
\medskip\noindent
We apply Lemma \ref{smoothing-lemma-delocalize-base}
...
Lemma \ref{smoothing-lemma-lifting}
...
\begin{definition}[Situation: Local]
\label{smoothing-situation-local}
\source{stacks:07F7}
\href{https://stacks.math.columbia.edu/tag/07F7}{\texttt{Stacks tag 07F7}}
\group{smoothing}
...
Situation \ref{smoothing-situation-local}. We say
...
\begin{lemma}[Lift solution]
\label{smoothing-lemma-lift-solution}
\source{stacks:07F8}
\href{https://stacks.math.columbia.edu/tag/07F8}{\texttt{Stacks tag 07F8}}
\group{smoothing}

\uses{smoothing-situation-local}
Let $R \to A \to \Lambda \supset \mathfrak q$ be as in
Situation \ref{smoothing-situation-local}. Let $r \geq 1$ and
...
\begin{proof}
\uses{smoothing-lemma-desingularize-lifting-apply, smoothing-lemma-strictly-standard-base-change}
...
Lemma \ref{smoothing-lemma-desingularize-lifting-apply}.
...
\begin{lemma}[Delocalize weak]
\label{smoothing-lemma-delocalize-weak}
\source{stacks:07F9}
\href{https://stacks.math.columbia.edu/tag/07F9}{\texttt{Stacks tag 07F9}}
\group{smoothing}
...
\end{reference}
Let $R \to A \to \Lambda \supset \mathfrak q$ be as in
Situation \ref{smoothing-situation-local}. Let $\mathfrak p = R \cap \mathfrak q$.
...
\begin{proof}
\uses{smoothing-lemma-final-solve, smoothing-lemma-smooth-standard-smooth, smoothing-lemma-standard-smooth-include-generators}
...
By Lemma \ref{smoothing-lemma-final-solve}
we may assume that $C$ is smooth over $R_\mathfrak p$.
By Lemma \ref{smoothing-lemma-smooth-standard-smooth} we may assume that
...
Lemma \ref{smoothing-lemma-standard-smooth-include-generators}.
...
\begin{lemma}[Delocalize height zero]
\label{smoothing-lemma-delocalize-height-zero}
\source{stacks:07FA}
\href{https://stacks.math.columbia.edu/tag/07FA}{\texttt{Stacks tag 07FA}}
\group{smoothing}
...
\begin{proof}
\uses{smoothing-lemma-delocalize-weak}
...
in $\Lambda$. By Lemma \ref{smoothing-lemma-delocalize-weak} we can find a factorization
...
\source{stacks:07FC}
\href{https://stacks.math.columbia.edu/tag/07FC}{\texttt{Stacks tag 07FC}}
\group{smoothing}
...
\begin{lemma}[Find sequence]
\label{smoothing-lemma-find-sequence}
\source{stacks:07FD}
\href{https://stacks.math.columbia.edu/tag/07FD}{\texttt{Stacks tag 07FD}}
\group{smoothing}
...
for some $s \in S$ by Lemma \ref{smoothing-lemma-ogoma}. By induction on $t$ this
produces a sequence satisfying (1), (2), and (3).
\end{proof}

\begin{lemma}[Resolve special]
\label{smoothing-lemma-resolve-special}
\source{stacks:07FE}
\href{https://stacks.math.columbia.edu/tag/07FE}{\texttt{Stacks tag 07FE}}
\group{smoothing}

\uses{smoothing-situation-local}
Let $k \to A \to \Lambda \supset \mathfrak q$ be as in
Situation \ref{smoothing-situation-local} where
\begin{enumerate}
\item $k$ is a field,
...
\begin{proof}
\uses{smoothing-lemma-improve-presentation, smoothing-lemma-compare-standard, smoothing-lemma-find-sequence, smoothing-lemma-lift-solution, smoothing-lemma-delocalize-height-zero, smoothing-proposition-lift}
...
map constructed in Lemma \ref{smoothing-lemma-improve-presentation}
...
Lemma \ref{smoothing-lemma-find-sequence}
...
Diagram
$$
\begin{array}{ccc}R \longrightarrow & B \searrow &  \\ k \uparrow\longrightarrow & A \uparrow\longrightarrow & \Lambda\end{array}
$$
Now we apply
Lemma \ref{smoothing-lemma-lift-solution}
...
$$
for $e = 8c$. By
Lemma \ref{smoothing-lemma-delocalize-height-zero}
...
and Proposition \ref{smoothing-proposition-lift}.
...
\source{stacks:07FG}
\href{https://stacks.math.columbia.edu/tag/07FG}{\texttt{Stacks tag 07FG}}
\group{smoothing}
...
\begin{lemma}[Solution modulo]
\label{smoothing-lemma-solution-modulo}
\source{stacks:07FH}
\href{https://stacks.math.columbia.edu/tag/07FH}{\texttt{Stacks tag 07FH}}
\group{smoothing}
...
ideal of $\bar \Lambda$, see Lemma \ref{smoothing-lemma-helper}.
...
By construction the residue field extension $F/\kappa(\mathfrak p)$
...
\begin{lemma}[Enlarge solution modulo]
\label{smoothing-lemma-enlarge-solution-modulo}
\source{stacks:07FI}
\href{https://stacks.math.columbia.edu/tag/07FI}{\texttt{Stacks tag 07FI}}
\group{smoothing}

\uses{smoothing-lemma-solution-modulo}
...
$$
be as in Lemma \ref{smoothing-lemma-solution-modulo}. Then for any
...
\begin{lemma}[Resolve general]
\label{smoothing-lemma-resolve-general}
\source{stacks:07FJ}
\href{https://stacks.math.columbia.edu/tag/07FJ}{\texttt{Stacks tag 07FJ}}
\group{smoothing}
...
\begin{proof}
\uses{smoothing-lemma-improve-presentation, smoothing-lemma-compare-standard, smoothing-lemma-solution-modulo, smoothing-lemma-ogoma, smoothing-lemma-enlarge-solution-modulo, smoothing-lemma-lift-solution, smoothing-lemma-strictly-standard-base-change, smoothing-lemma-delocalize-height-zero}
...
$B \to C$ be as in
Lemma \ref{smoothing-lemma-improve-presentation}.
...
By Lemma \ref{smoothing-lemma-improve-presentation}
...
by Lemma \ref{smoothing-lemma-compare-standard}.

\medskip\noindent
Ad (\ref{item-NP}). This follows by applying Lemma \ref{smoothing-lemma-solution-modulo}.
...
Lemma \ref{smoothing-lemma-ogoma}. By induction on $t$ this produces the desired
sequence.
...
$$
Hence we may apply Lemma \ref{smoothing-lemma-ogoma} to find an $s' \in S$
such that
$$
...
$$
for any $q > 0$. By Lemma \ref{smoothing-lemma-enlarge-solution-modulo}
...
Lemma \ref{smoothing-lemma-lift-solution} to
...
over $R$ by Lemma \ref{smoothing-lemma-strictly-standard-base-change}.
The other assumption of Lemma \ref{smoothing-lemma-lift-solution} holds by steps
(\ref{item-modify-pii}) and (\ref{item-choose-deltai}).

\medskip\noindent
Ad (\ref{item-third-resolve}). Apply Lemma \ref{smoothing-lemma-delocalize-height-zero}
...
$$
\begin{array}{cc}B \longrightarrow & D'[t_1, \ldots, t_d] \\ k[x_1, \ldots, x_d] \longrightarrow\uparrow & R_\mathfrak p/\mathfrak p^nR_\mathfrak p \uparrow\end{array}
$$
...
\source{stacks:07GC}
\href{https://stacks.math.columbia.edu/tag/07GC}{\texttt{Stacks tag 07GC}}
\group{smoothing}
...
\begin{proof}
\uses{smoothing-lemma-reduce-to-field, smoothing-lemma-final-solve, smoothing-situation-local, smoothing-lemma-resolve-special, smoothing-lemma-resolve-general}

By Lemma \ref{smoothing-lemma-reduce-to-field}
...
$\mathfrak h_B = \Lambda$, see Lemma \ref{smoothing-lemma-final-solve}.
...
(as defined in the text following Situation \ref{smoothing-situation-local}).
If the characteristic of $k$ is zero, this follows from
Lemma \ref{smoothing-lemma-resolve-special}.
If the characteristic of $k$ is $p > 0$, this follows from
Lemma \ref{smoothing-lemma-resolve-general}.
\end{proof}
...
\begin{theorem}[Approximation property]
\label{smoothing-theorem-approximation-property}
\source{stacks:07QY}
\href{https://stacks.math.columbia.edu/tag/07QY}{\texttt{Stacks tag 07QY}}
\group{smoothing}
...
\begin{proof}
\uses{smoothing-theorem-popescu}
...
A \to B \to R^\wedge
$$
with $B$ smooth over $R$, see Theorem \ref{smoothing-theorem-popescu}.
Denote $\kappa = R/\mathfrak m$ the residue field. It is also
the residue field of $R^\wedge$, so we get a commutative diagram
$$
\begin{array}{cc}B \searrow\dashrightarrow & R' \downarrow \\ R \longrightarrow\uparrow & \kappa\end{array}
$$
...
\begin{theorem}[Approximation property variant]
\label{smoothing-theorem-approximation-property-variant}
\source{stacks:07QZ}
\href{https://stacks.math.columbia.edu/tag/07QZ}{\texttt{Stacks tag 07QZ}}
\group{smoothing}
...
\begin{proof}
\uses{smoothing-theorem-approximation-property, smoothing-theorem-popescu}

We could deduce this theorem from Theorem \ref{smoothing-theorem-approximation-property}
...
\begin{example}[Describe henselian]
\label{smoothing-example-describe-henselian}
\source{stacks:0A1W}
\href{https://stacks.math.columbia.edu/tag/0A1W}{\texttt{Stacks tag 0A1W}}
\group{smoothing}

\uses{smoothing-theorem-approximation-property-variant}
...
see Theorem \ref{smoothing-theorem-approximation-property-variant}.
...
\begin{lemma}[Approximation property variant]
\label{smoothing-lemma-approximation-property-variant}
\source{stacks:0CAR}
\href{https://stacks.math.columbia.edu/tag/0CAR}{\texttt{Stacks tag 0CAR}}
\group{smoothing}
...
By Theorem \ref{smoothing-theorem-approximation-property-variant}
...
Section \ref{smoothing-section-approximation-G-rings} to the case of henselian pairs.
Henselian pairs where defined in
More on Algebra, Section \ref{more-algebra-section-henselian-pairs}.

\begin{lemma}[Approximation for henselian pairs.]
\label{smoothing-lemma-henselian-pair}
\source{stacks:0AH5}
\href{https://stacks.math.columbia.edu/tag/0AH5}{\texttt{Stacks tag 0AH5}}
\group{smoothing}
...
By Theorem \ref{smoothing-theorem-popescu} we can find a factorization
