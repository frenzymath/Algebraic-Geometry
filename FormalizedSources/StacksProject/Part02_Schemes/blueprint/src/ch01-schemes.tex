...
\source{stacks:01HB}
\href{https://stacks.math.columbia.edu/tag/01HB}{\texttt{Stacks tag 01HB}}
\group{schemes}
...
\begin{lemma}[An isomorphism of ringed spaces between locally ringed spaces is an isomorphism of loca...]
\label{schemes-lemma-isomorphism-locally-ringed}
\source{stacks:01HC}
\href{https://stacks.math.columbia.edu/tag/01HC}{\texttt{Stacks tag 01HC}}
\group{schemes}
...
\begin{definition}[Immersion locally ringed spaces]
\label{schemes-definition-immersion-locally-ringed-spaces}
\source{stacks:01HE}
\href{https://stacks.math.columbia.edu/tag/01HE}{\texttt{Stacks tag 01HE}}
\group{schemes}
...
\begin{example}[Open subspace]
\label{schemes-example-open-subspace}
\source{stacks:01HF}
\href{https://stacks.math.columbia.edu/tag/01HF}{\texttt{Stacks tag 01HF}}
\group{schemes}
...
\begin{definition}[Open subspace]
\label{schemes-definition-open-subspace}
\source{stacks:01HG}
\href{https://stacks.math.columbia.edu/tag/01HG}{\texttt{Stacks tag 01HG}}
\group{schemes}

\uses{schemes-example-open-subspace}
Let $X$ be a locally ringed space.
Let $U \subset X$ be an open subset.
The locally ringed space $(U, \mathcal{O}_U)$
of Example \ref{schemes-example-open-subspace} above
...
\source{stacks:01HH}
\href{https://stacks.math.columbia.edu/tag/01HH}{\texttt{Stacks tag 01HH}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-isomorphism-locally-ringed}
...
(use Lemma \ref{schemes-lemma-isomorphism-locally-ringed}).
...
$$
\begin{array}{cc}\Gamma(U, f^{-1}(\mathcal{O}_Y)) \underset{\cong}{\downarrow}\overset{\cong}{\longrightarrow} & \Gamma(U, \mathcal{O}_X) \\ \Gamma(U, f'^{-1}(\mathcal{O}_V)) \overset{f'^\sharp}{\nearrow}\underset{f''^\sharp}{\nearrow} & \end{array}
$$
...
\begin{lemma}[Restrict map to opens]
\label{schemes-lemma-restrict-map-to-opens}
\source{stacks:01HI}
\href{https://stacks.math.columbia.edu/tag/01HI}{\texttt{Stacks tag 01HI}}
\group{schemes}
...
locally ringed spaces
$$
\begin{array}{cc}U \underset{f|_U}{\downarrow}\longrightarrow & X \overset{f}{\downarrow} \\ V \longrightarrow & Y\end{array}
$$
\end{lemma}
...
\begin{definition}[Closed immersion locally ringed spaces]
\label{schemes-definition-closed-immersion-locally-ringed-spaces}
\source{stacks:01HK}
\href{https://stacks.math.columbia.edu/tag/01HK}{\texttt{Stacks tag 01HK}}
\group{schemes}
...
\begin{lemma}[Closed local target]
\label{schemes-lemma-closed-local-target}
\source{stacks:01HL}
\href{https://stacks.math.columbia.edu/tag/01HL}{\texttt{Stacks tag 01HL}}
\group{schemes}
...
\begin{example}[Closed subspace]
\label{schemes-example-closed-subspace}
\source{stacks:01HM}
\href{https://stacks.math.columbia.edu/tag/01HM}{\texttt{Stacks tag 01HM}}
\group{schemes}
...
\source{stacks:01HN}
\href{https://stacks.math.columbia.edu/tag/01HN}{\texttt{Stacks tag 01HN}}
\group{schemes}

\uses{schemes-example-closed-subspace}
Let $X$ be a locally ringed space.
Let $\mathcal{I}$ be a sheaf of ideals on $X$
which is locally generated by sections.
The locally ringed space $(Z, \mathcal{O}_Z)$
of Example \ref{schemes-example-closed-subspace} above
...
\source{stacks:01HO}
\href{https://stacks.math.columbia.edu/tag/01HO}{\texttt{Stacks tag 01HO}}
\group{schemes}
...
\begin{lemma}[Characterize closed subspace]
\label{schemes-lemma-characterize-closed-subspace}
\source{stacks:01HP}
\href{https://stacks.math.columbia.edu/tag/01HP}{\texttt{Stacks tag 01HP}}
\group{schemes}
...
\begin{lemma}[Restrict map to closed]
\label{schemes-lemma-restrict-map-to-closed}
\source{stacks:01HQ}
\href{https://stacks.math.columbia.edu/tag/01HQ}{\texttt{Stacks tag 01HQ}}
\group{schemes}
...
locally ringed spaces
$$
\begin{array}{cc}Z' \underset{f'}{\downarrow}\underset{i'}{\longrightarrow} & X \overset{f}{\downarrow} \\ Z \overset{i}{\longrightarrow} & Y\end{array}
$$
...
\begin{proof}
\uses{schemes-lemma-characterize-closed-subspace}
...
in Lemma \ref{schemes-lemma-characterize-closed-subspace} above,
...
\begin{lemma}[Standard open]
\label{schemes-lemma-standard-open}
\source{stacks:01HS}
\href{https://stacks.math.columbia.edu/tag/01HS}{\texttt{Stacks tag 01HS}}
\group{schemes}
...
\begin{definition}[Standard covering]
\label{schemes-definition-standard-covering}
\source{stacks:01HT}
\href{https://stacks.math.columbia.edu/tag/01HT}{\texttt{Stacks tag 01HT}}
\group{schemes}
...
by Lemma \ref{schemes-lemma-standard-open} above there are canonical
...
Lemma \ref{schemes-lemma-standard-open} above we have
a canonical map
$$
...
$$
In addition, by Lemma \ref{schemes-lemma-standard-open} above
...
\source{stacks:01HU}
\href{https://stacks.math.columbia.edu/tag/01HU}{\texttt{Stacks tag 01HU}}
\group{schemes}
...
\begin{lemma}[Spec sheaves]
\label{schemes-lemma-spec-sheaves}
\source{stacks:01HV}
\href{https://stacks.math.columbia.edu/tag/01HV}{\texttt{Stacks tag 01HV}}
\group{schemes}

\uses{schemes-lemma-standard-open}
...
\source{stacks:01HW}
\href{https://stacks.math.columbia.edu/tag/01HW}{\texttt{Stacks tag 01HW}}
\group{schemes}
...
\begin{lemma}[Morphism into affine where point goes]
\label{schemes-lemma-morphism-into-affine-where-point-goes}
\source{stacks:01HY}
\href{https://stacks.math.columbia.edu/tag/01HY}{\texttt{Stacks tag 01HY}}
\group{schemes}
...
$$
\begin{array}{cc}\Gamma(X, \mathcal{O}_X) \longrightarrow & \mathcal{O}_{X, x} \\ \Gamma(Y, \mathcal{O}_Y) \longrightarrow\uparrow & \mathcal{O}_{Y, f(x)} \uparrow\end{array}
$$
...
\source{stacks:01HZ}
\href{https://stacks.math.columbia.edu/tag/01HZ}{\texttt{Stacks tag 01HZ}}
\group{schemes}
...
\begin{lemma}[F open affine]
\label{schemes-lemma-f-open-affine}
\source{stacks:01I0}
\href{https://stacks.math.columbia.edu/tag/01I0}{\texttt{Stacks tag 01I0}}
\group{schemes}

\uses{schemes-lemma-f-open}
In Lemma \ref{schemes-lemma-f-open} above, if $X$ is an affine scheme,
...
\begin{lemma}[Morphism into affine]
\label{schemes-lemma-morphism-into-affine}
\source{stacks:01I1}
\href{https://stacks.math.columbia.edu/tag/01I1}{\texttt{Stacks tag 01I1}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-spec-sheaves, schemes-lemma-morphism-into-affine-where-point-goes, schemes-lemma-f-open, schemes-lemma-standard-open}
...
\ref{schemes-lemma-spec-sheaves}.
...
$$
by the rule of
Lemma \ref{schemes-lemma-morphism-into-affine-where-point-goes}.
...
$D(\psi_Y(g)) \subset X$ which is open by Lemma \ref{schemes-lemma-f-open}.
...
Lemmas \ref{schemes-lemma-spec-sheaves} and \ref{schemes-lemma-standard-open}.
...
of the proof of Lemma \ref{schemes-lemma-morphism-into-affine-where-point-goes}
...
\ref{schemes-lemma-morphism-into-affine-where-point-goes} and
given the uniqueness of $\Psi$ the uniqueness of the
map $\psi$ was pointed out during the course of the proof
above.
\end{proof}

\begin{lemma}[Category affine schemes]
\label{schemes-lemma-category-affine-schemes}
\source{stacks:01I2}
\href{https://stacks.math.columbia.edu/tag/01I2}{\texttt{Stacks tag 01I2}}
\group{schemes}
...
\begin{proof}
\uses{schemes-definition-affine-scheme, schemes-lemma-morphism-into-affine}

This is now clear from Definition \ref{schemes-definition-affine-scheme}
and Lemma \ref{schemes-lemma-morphism-into-affine}.
\end{proof}

\begin{lemma}[Standard open affine]
\label{schemes-lemma-standard-open-affine}
\source{stacks:01I3}
\href{https://stacks.math.columbia.edu/tag/01I3}{\texttt{Stacks tag 01I3}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-open-immersion}
...
is isomorphic to $U$ by Lemma \ref{schemes-lemma-open-immersion}.
\end{proof}

\begin{lemma}[Fibre product affine schemes]
\label{schemes-lemma-fibre-product-affine-schemes}
\source{stacks:01I4}
\href{https://stacks.math.columbia.edu/tag/01I4}{\texttt{Stacks tag 01I4}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-morphism-into-affine}

This is just an application of Lemma \ref{schemes-lemma-morphism-into-affine}.
...
\begin{lemma}[Disjoint union affines]
\label{schemes-lemma-disjoint-union-affines}
\source{stacks:01I5}
\href{https://stacks.math.columbia.edu/tag/01I5}{\texttt{Stacks tag 01I5}}
\group{schemes}
...
by the sheaf property. By Lemma \ref{schemes-lemma-morphism-into-affine}
...
\begin{lemma}[Compare constructions]
\label{schemes-lemma-compare-constructions}
\source{stacks:01I7}
\href{https://stacks.math.columbia.edu/tag/01I7}{\texttt{Stacks tag 01I7}}
\group{schemes}

\uses{schemes-definition-structure-sheaf}
...
$M$ (Definition \ref{schemes-definition-structure-sheaf}) and the sheaf
...
\begin{lemma}[Widetilde constructions]
\label{schemes-lemma-widetilde-constructions}
\source{stacks:01I8}
\href{https://stacks.math.columbia.edu/tag/01I8}{\texttt{Stacks tag 01I8}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-compare-constructions, schemes-lemma-spec-sheaves}
[First proof]
Using Lemma \ref{schemes-lemma-compare-constructions} and
...
localizations of $R$ (Lemma \ref{schemes-lemma-spec-sheaves})
...
\uses{schemes-lemma-compare-constructions, schemes-lemma-spec-sheaves}
[Second proof]
Proof of (1). By Lemma \ref{schemes-lemma-compare-constructions} to give a map
...
of $\widetilde{M}$ (either in Lemma \ref{schemes-lemma-spec-sheaves} or in
Modules, Lemma \ref{modules-lemma-construct-quasi-coherent-sheaves}),
...
$\SheafHom_{\mathcal{O}_X}(\widetilde M, \widetilde N)$.
Hence by Lemma \ref{schemes-lemma-compare-constructions} we obtain a map
...
\begin{proof}
\uses{schemes-lemma-compare-constructions}
[Third proof of part (1)]
...
Lemma \ref{schemes-lemma-compare-constructions}. The third equality holds by
...
\begin{lemma}[Widetilde pullback]
\label{schemes-lemma-widetilde-pullback}
\source{stacks:01I9}
\href{https://stacks.math.columbia.edu/tag/01I9}{\texttt{Stacks tag 01I9}}
\group{schemes}

\uses{schemes-lemma-category-affine-schemes}
Let
...
$\psi^\sharp : R \to S$ (see Lemma \ref{schemes-lemma-category-affine-schemes}).
\begin{enumerate}
...
Lemma \ref{schemes-lemma-compare-constructions}
...
Lemma \ref{schemes-lemma-widetilde-pullback} above says in particular
...
\begin{lemma}[Quasi coherent affine]
\label{schemes-lemma-quasi-coherent-affine}
\source{stacks:01IA}
\href{https://stacks.math.columbia.edu/tag/01IA}{\texttt{Stacks tag 01IA}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-standard-open, schemes-lemma-compare-constructions}
...
By Lemma \ref{schemes-lemma-standard-open} for example we can refine this
...
we get isomorphisms
$$
\begin{array}{ccccc}\mathcal{F}_{M_i}|_{D(f_if_j)}
\overset{\varphi_i^{-1}|_{D(f_if_j)}}{\longrightarrow} &  & \mathcal{F}|_{D(f_if_j)}
\overset{\varphi_j|_{D(f_if_j)}}{\longrightarrow} &  & \mathcal{F}_{M_j}|_{D(f_if_j)}.\end{array}
$$
...
\ref{schemes-lemma-compare-constructions} above. In particular we see that
$\mathcal{F}_{M_i}(D(f_if_j)) = (M_i)_{f_j}$, etc.
Also by Lemma \ref{schemes-lemma-compare-constructions} above we see
...
$$
\begin{array}{ccc}(M_i)_{f_jf_k}
\underset{\psi_{ij}}{\searrow}\overset{\psi_{ik}}{\longrightarrow} &  & (M_k)_{f_if_j} \\  & (M_j)_{f_if_k} \underset{\psi_{jk}}{\nearrow} & \end{array}
$$
...
By Lemma \ref{schemes-lemma-compare-constructions} we obtain an associated
...
\begin{lemma}[Equivalence quasi coherent]
\label{schemes-lemma-equivalence-quasi-coherent}
\source{stacks:01IB}
\href{https://stacks.math.columbia.edu/tag/01IB}{\texttt{Stacks tag 01IB}}
\group{schemes}
...
$$
\begin{array}{cc}\QCoh(\mathcal{O}_X)
\longrightarrow & \text{Mod}_R
...
\begin{proof}
\uses{schemes-lemma-compare-constructions, schemes-lemma-quasi-coherent-affine}

See Lemmas \ref{schemes-lemma-compare-constructions}
and \ref{schemes-lemma-quasi-coherent-affine} above.
\end{proof}

From now on we will not distinguish between quasi-coherent
sheaves on affine schemes and sheaves of the form $\widetilde M$.

\begin{lemma}[Kernel cokernel quasi coherent]
\label{schemes-lemma-kernel-cokernel-quasi-coherent}
\source{stacks:01IC}
\href{https://stacks.math.columbia.edu/tag/01IC}{\texttt{Stacks tag 01IC}}
\group{schemes}
...
since by Lemma \ref{schemes-lemma-compare-constructions} we know that any map
...
\begin{lemma}[Colimit quasi coherent]
\label{schemes-lemma-colimit-quasi-coherent}
\source{stacks:01ID}
\href{https://stacks.math.columbia.edu/tag/01ID}{\texttt{Stacks tag 01ID}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-equivalence-quasi-coherent}

Suppose $\mathcal{F}_i$, $i \in I$ is a collection of quasi-coherent
sheaves on $X$. By Lemma \ref{schemes-lemma-equivalence-quasi-coherent}
...
\begin{lemma}[Extension quasi coherent]
\label{schemes-lemma-extension-quasi-coherent}
\source{stacks:01IE}
\href{https://stacks.math.columbia.edu/tag/01IE}{\texttt{Stacks tag 01IE}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-spec-sheaves, schemes-lemma-compare-constructions}

This is clear in case both $\mathcal{F}_1$ and $\mathcal{F}_2$ are
quasi-coherent because the functor $M \mapsto \widetilde M$
is exact, see Lemma \ref{schemes-lemma-spec-sheaves}.
...
property of Lemma \ref{schemes-lemma-compare-constructions}) we get a commutative
diagram
$$
\begin{array}{ccccc}0 \longrightarrow & \widetilde M_1 \longrightarrow\downarrow & \widetilde M_2 \longrightarrow\downarrow & \widetilde M_3 \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & \mathcal{F}_1 \longrightarrow & \mathcal{F}_2 \longrightarrow & \mathcal{F}_3 \longrightarrow & 0\end{array}
$$
...
\begin{example}[Closed immersion affines]
\label{schemes-example-closed-immersion-affines}
\source{stacks:01IG}
\href{https://stacks.math.columbia.edu/tag/01IG}{\texttt{Stacks tag 01IG}}
\group{schemes}

\uses{schemes-definition-closed-immersion-locally-ringed-spaces, schemes-example-closed-subspace}
Let $R$ be a ring.
...
see Definition \ref{schemes-definition-closed-immersion-locally-ringed-spaces}.
Clearly, this is (isomorphic) to the closed subspace associated
to the quasi-coherent sheaf of ideals $\widetilde I$, as in
Example \ref{schemes-example-closed-subspace}.
\end{example}

\begin{lemma}[For affine schemes, closed immersions correspond to ideals.]
\label{schemes-lemma-closed-immersion-affine-case}
\source{stacks:01IH}
\href{https://stacks.math.columbia.edu/tag/01IH}{\texttt{Stacks tag 01IH}}
\group{schemes}


\uses{schemes-example-closed-immersion-affines}
Let $(X, \mathcal{O}_X) = (\Spec(R), \mathcal{O}_{\Spec(R)})$
...
constructed in Example \ref{schemes-example-closed-immersion-affines} above.
\end{lemma}

\begin{proof}
\uses{schemes-lemma-closed-immersion, schemes-definition-closed-subspace, schemes-example-closed-subspace, schemes-lemma-extension-quasi-coherent}

This is kind of silly! Namely, by Lemma \ref{schemes-lemma-closed-immersion}
we can identify $Z \to X$ with the closed subspace associated to
a sheaf of ideals $\mathcal{I} \subset \mathcal{O}_X$ as in
Definition \ref{schemes-definition-closed-subspace} and
Example \ref{schemes-example-closed-subspace}.
...
By our results in Section \ref{schemes-section-quasi-coherent-affine}
it is of the form $\widetilde S$ for some $R$-module $S$.
Moreover, since $\mathcal{O}_X = \widetilde R \to \widetilde S$
is surjective we see by Lemma \ref{schemes-lemma-extension-quasi-coherent}
...
\source{stacks:01IJ}
\href{https://stacks.math.columbia.edu/tag/01IJ}{\texttt{Stacks tag 01IJ}}
\group{schemes}
...
\begin{lemma}[Open subspace scheme]
\label{schemes-lemma-open-subspace-scheme}
\source{stacks:01IK}
\href{https://stacks.math.columbia.edu/tag/01IK}{\texttt{Stacks tag 01IK}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-standard-open-affine}
...
by Lemma \ref{schemes-lemma-standard-open-affine}. This proves that every point
...
\begin{example}[Not affine]
\label{schemes-example-not-affine}
\source{stacks:01IL}
\href{https://stacks.math.columbia.edu/tag/01IL}{\texttt{Stacks tag 01IL}}
\group{schemes}
...
Lemma \ref{schemes-lemma-category-affine-schemes} we would have $U \cong X$.
\end{example}

\section{Immersions of schemes}
\label{schemes-section-immersions}
In Lemma \ref{schemes-lemma-open-subspace-scheme} we saw that any open subspace
...
By our efforts in Section \ref{schemes-section-quasi-coherent-affine} we
know that such a sheaf is on any affine open $U \subset X$
of the form $\widetilde M$ for some $\mathcal{O}_X(U)$-module $M$.

\begin{lemma}[Closed subspace scheme]
\label{schemes-lemma-closed-subspace-scheme}
\source{stacks:01IN}
\href{https://stacks.math.columbia.edu/tag/01IN}{\texttt{Stacks tag 01IN}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-closed-immersion-affine-case}
...
By Lemma \ref{schemes-lemma-closed-immersion-affine-case} we know
...
\source{stacks:01IO}
\href{https://stacks.math.columbia.edu/tag/01IO}{\texttt{Stacks tag 01IO}}
\group{schemes}

\uses{schemes-definition-immersion-locally-ringed-spaces, schemes-definition-open-subspace, schemes-lemma-open-subspace-scheme, schemes-definition-closed-immersion-locally-ringed-spaces, schemes-definition-closed-subspace, schemes-lemma-closed-subspace-scheme}
Let $X$ be a scheme.
\begin{enumerate}
\item A morphism of schemes is called an {\it open immersion}
if it is an open immersion of locally ringed spaces (see
Definition \ref{schemes-definition-immersion-locally-ringed-spaces}).
\item An {\it open subscheme} of $X$ is an open subspace of $X$
in the sense of Definition \ref{schemes-definition-open-subspace}; an open subscheme
of $X$ is a scheme by Lemma \ref{schemes-lemma-open-subspace-scheme}.
\item A morphism of schemes is called a {\it closed immersion}
if it is a closed immersion of locally ringed spaces (see
Definition \ref{schemes-definition-closed-immersion-locally-ringed-spaces}).
\item A {\it closed subscheme} of $X$ is a closed subspace of $X$
in the sense of Definition \ref{schemes-definition-closed-subspace}; a closed subscheme
is a scheme by Lemma \ref{schemes-lemma-closed-subspace-scheme}.
...
It follows from the lemmas in Sections \ref{schemes-section-open-immersion} and
\ref{schemes-section-closed-immersion} that any open (resp.\ closed) immersion of
...
Lemma \ref{schemes-lemma-characterize-closed-immersions}. In \cite{EGA},
Grothendieck and Dieudonn\'e first define closed subschemes
via the construction of Example \ref{schemes-example-closed-subspace}
...
closed subscheme. It follows from Lemma \ref{schemes-lemma-closed-subspace-scheme}
...
\begin{remark}[Not reverse open closed]
\label{schemes-remark-not-reverse-open-closed}
\source{stacks:01IP}
\href{https://stacks.math.columbia.edu/tag/01IP}{\texttt{Stacks tag 01IP}}
\group{schemes}
...
\source{stacks:01IQ}
\href{https://stacks.math.columbia.edu/tag/01IQ}{\texttt{Stacks tag 01IQ}}
\group{schemes}
...
\begin{proof}
\uses{schemes-example-closed-subspace, schemes-lemma-closed-immersion}
...
associated to $\mathcal{I}$, see Lemma \ref{schemes-lemma-closed-immersion},
...
\begin{lemma}[Scheme sober]
\label{schemes-lemma-scheme-sober}
\source{stacks:01IS}
\href{https://stacks.math.columbia.edu/tag/01IS}{\texttt{Stacks tag 01IS}}
\group{schemes}
...
\begin{lemma}[Basis affine opens]
\label{schemes-lemma-basis-affine-opens}
\source{stacks:01IT}
\href{https://stacks.math.columbia.edu/tag/01IT}{\texttt{Stacks tag 01IT}}
\group{schemes}
...
in Section \ref{schemes-section-schemes}.
\end{proof}

\begin{remark}[Intersection affine opens]
\label{schemes-remark-intersection-affine-opens}
\source{stacks:01IU}
\href{https://stacks.math.columbia.edu/tag/01IU}{\texttt{Stacks tag 01IU}}
\group{schemes}

\uses{schemes-example-affine-space-zero-doubled}
In general the intersection of two affine opens in $X$
is not affine open. See Example \ref{schemes-example-affine-space-zero-doubled}.
\end{remark}

\begin{lemma}[Locally quasi compact]
\label{schemes-lemma-locally-quasi-compact}
\source{stacks:01IV}
\href{https://stacks.math.columbia.edu/tag/01IV}{\texttt{Stacks tag 01IV}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-basis-affine-opens}

This follows from Lemma \ref{schemes-lemma-basis-affine-opens} above
and the fact that the spectrum of a ring is quasi-compact, see
Algebra, Lemma \ref{algebra-lemma-quasi-compact}.
\end{proof}

\begin{lemma}[Standard open two affines]
\label{schemes-lemma-standard-open-two-affines}
\source{stacks:01IW}
\href{https://stacks.math.columbia.edu/tag/01IW}{\texttt{Stacks tag 01IW}}
\group{schemes}
...
\begin{lemma}[Good subcover]
\label{schemes-lemma-good-subcover}
\source{stacks:01IX}
\href{https://stacks.math.columbia.edu/tag/01IX}{\texttt{Stacks tag 01IX}}
\group{schemes}

\uses{schemes-definition-standard-covering}
Let $X$ be a scheme.
...
Definition \ref{schemes-definition-standard-covering})
such that each $V_j$ is a standard open in one of the $U_i$.
\end{lemma}

\begin{proof}
\uses{schemes-lemma-standard-open-two-affines}

Pick $v \in V$. Then $v \in U_i$ for some $i$.
By Lemma \ref{schemes-lemma-standard-open-two-affines} above there exists an open
$v \in W_v \subset V \cap U_i$ such that
$W_v$ is a standard open in both $V$ and $U_i$.
Since $V$ is quasi-compact the lemma follows.
\end{proof}

\begin{lemma}[Sheaf on affines]
\label{schemes-lemma-sheaf-on-affines}
\source{stacks:0F1A}
\href{https://stacks.math.columbia.edu/tag/0F1A}{\texttt{Stacks tag 0F1A}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-standard-open, schemes-definition-standard-covering}
...
Sheaves, Lemma \ref{sheaves-lemma-cofinal-systems-coverings-standard-case}
and Lemma \ref{schemes-lemma-standard-open} it suffices to prove the sheaf
...
\begin{lemma}[Scheme finite discrete affine]
\label{schemes-lemma-scheme-finite-discrete-affine}
\source{stacks:02O0}
\href{https://stacks.math.columbia.edu/tag/02O0}{\texttt{Stacks tag 02O0}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-basis-affine-opens, schemes-lemma-disjoint-union-affines}

Say $X = \{x_1, \ldots, x_n\}$. Then $U_i = \{x_i\}$ is an open neighbourhood
of $x_i$. By
Lemma \ref{schemes-lemma-basis-affine-opens}
it is affine. Hence $X$ is a finite disjoint union of affine schemes, and
hence is affine by
Lemma \ref{schemes-lemma-disjoint-union-affines}.
\end{proof}

\begin{example}[Scheme without closed points]
\label{schemes-example-scheme-without-closed-points}
\source{stacks:01IY}
\href{https://stacks.math.columbia.edu/tag/01IY}{\texttt{Stacks tag 01IY}}
\group{schemes}
...
\source{stacks:01J0}
\href{https://stacks.math.columbia.edu/tag/01J0}{\texttt{Stacks tag 01J0}}
\group{schemes}
...
\source{stacks:01J1}
\href{https://stacks.math.columbia.edu/tag/01J1}{\texttt{Stacks tag 01J1}}
\group{schemes}
...
\begin{lemma}[Affine reduced]
\label{schemes-lemma-affine-reduced}
\source{stacks:01J2}
\href{https://stacks.math.columbia.edu/tag/01J2}{\texttt{Stacks tag 01J2}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-reduced}

The direct implication follows immediately from
Lemma \ref{schemes-lemma-reduced} above.
...
\begin{lemma}[Reduced closed subscheme]
\label{schemes-lemma-reduced-closed-subscheme}
\source{stacks:01J3}
\href{https://stacks.math.columbia.edu/tag/01J3}{\texttt{Stacks tag 01J3}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-affine-reduced}
...
hence $Z$ is reduced (by Lemma \ref{schemes-lemma-affine-reduced} above).
...
By Lemma \ref{schemes-lemma-affine-reduced} the ring $R/I'$ is
...
\begin{definition}[Reduced induced scheme]
\label{schemes-definition-reduced-induced-scheme}
\source{stacks:01J4}
\href{https://stacks.math.columbia.edu/tag/01J4}{\texttt{Stacks tag 01J4}}
\group{schemes}

\uses{schemes-lemma-reduced-closed-subscheme}
...
on $Z$ is the one constructed in Lemma \ref{schemes-lemma-reduced-closed-subscheme}.
...
\begin{remark}[Reduced induced locally closed]
\label{schemes-remark-reduced-induced-locally-closed}
\source{stacks:0F2L}
\href{https://stacks.math.columbia.edu/tag/0F2L}{\texttt{Stacks tag 0F2L}}
\group{schemes}

\uses{schemes-definition-reduced-induced-scheme}
...
\source{stacks:0356}
\href{https://stacks.math.columbia.edu/tag/0356}{\texttt{Stacks tag 0356}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-reduced, schemes-lemma-characterize-closed-subspace}
...
This implies $b = 0$ as $B$ is reduced (Lemma \ref{schemes-lemma-reduced}, and
Algebra, Lemma \ref{algebra-lemma-Zariski-topology}).
Hence $f$ factors through
$Z$ by Lemma \ref{schemes-lemma-characterize-closed-subspace}.
\end{proof}
...
\begin{lemma}[Morphism from spec local ring]
\label{schemes-lemma-morphism-from-spec-local-ring}
\source{stacks:01J6}
\href{https://stacks.math.columbia.edu/tag/01J6}{\texttt{Stacks tag 01J6}}
\group{schemes}
...
Lemma \ref{schemes-lemma-morphism-into-affine}
...
$$
\begin{array}{cc}\Spec(\mathcal{O}_{X, x}) \longrightarrow\downarrow & X \downarrow \\ \Spec(\mathcal{O}_{S, s}) \longrightarrow & S\end{array}
$$
where the left vertical map corresponds to the local ring map
$f^\sharp_x : \mathcal{O}_{S, s} \to \mathcal{O}_{X, x}$.

\begin{lemma}[Specialize points]
\label{schemes-lemma-specialize-points}
\source{stacks:01J7}
\href{https://stacks.math.columbia.edu/tag/01J7}{\texttt{Stacks tag 01J7}}
\group{schemes}
...
$$
\begin{array}{cc}\Spec(\Omega) \longrightarrow\downarrow & \Spec(L) \overset{q}{\downarrow} \\ \Spec(K) \overset{p}{\longrightarrow} & X\end{array}
$$
...
$$
\begin{array}{cc}\Omega & L \longleftarrow \\ K \uparrow & \kappa(x) \longleftarrow\uparrow\end{array}
$$
of fields. This defines an equivalence relation, because given
any set of field extensions $K_i/\kappa$ there exists
some field extension $\Omega/\kappa$ such that all
the field extensions $K_i$ are contained in the extension $\Omega$.

\begin{lemma}[Characterize points]
\label{schemes-lemma-characterize-points}
\source{stacks:01J9}
\href{https://stacks.math.columbia.edu/tag/01J9}{\texttt{Stacks tag 01J9}}
\group{schemes}
...
$\Spec(\mathcal{O}_{X, x}) \to X$.
And the content of Lemma \ref{schemes-lemma-specialize-points} is in
...
a commutative diagram
$$
\begin{array}{ccc}\Spec(\kappa(x)) \longrightarrow\downarrow & \Spec(\mathcal{O}_{X, x}) \longrightarrow\downarrow & X \downarrow \\ \Spec(\kappa(s)) \longrightarrow & \Spec(\mathcal{O}_{S, s}) \longrightarrow & S.\end{array}
$$
...
\item the diagram
$$
\begin{array}{ccc}U_{ij} \cap U_{ik} \underset{\varphi_{ik}}{\longrightarrow}\underset{\varphi_{ij}}{\searrow} &  & U_{ki} \cap U_{kj} \\  & U_{ji} \cap U_{jk} \underset{\varphi_{jk}}{\nearrow} & \end{array}
$$
is commutative.
\end{enumerate}
...
\begin{lemma}[If you have two locally ringed spaces, and a subspace of the first one is isomorphic to...]
\label{schemes-lemma-glue}
\source{stacks:01JB}
\href{https://stacks.math.columbia.edu/tag/01JB}{\texttt{Stacks tag 01JB}}
\group{schemes}
...
$$
\begin{array}{ccc}U_{ij} \underset{\varphi_{ij}}{\longrightarrow}\underset{\varphi_i|_{U_{ij}}}{\searrow} &  & U_{ji} \overset{\varphi_j|_{U_{ji}}}{\swarrow} \\  & U_i \cap U_j & \end{array}
$$
...
\begin{lemma}[Schemes can be glued to give new schemes.]
\label{schemes-lemma-glue-schemes}
\source{stacks:01JC}
\href{https://stacks.math.columbia.edu/tag/01JC}{\texttt{Stacks tag 01JC}}
\group{schemes}


\uses{schemes-lemma-glue}
In Lemma \ref{schemes-lemma-glue} above, assume that all
...
\source{stacks:01JD}
\href{https://stacks.math.columbia.edu/tag/01JD}{\texttt{Stacks tag 01JD}}
\group{schemes}

\uses{schemes-example-not-affine}
...
described in Example \ref{schemes-example-not-affine} and hence not affine.
...
\source{stacks:01JE}
\href{https://stacks.math.columbia.edu/tag/01JE}{\texttt{Stacks tag 01JE}}
\group{schemes}
...
of Section \ref{schemes-section-glueing-schemes} in terms
...
\source{stacks:01JG}
\href{https://stacks.math.columbia.edu/tag/01JG}{\texttt{Stacks tag 01JG}}
\group{schemes}
...
\begin{example}[Global sections]
\label{schemes-example-global-sections}
\source{stacks:01JH}
\href{https://stacks.math.columbia.edu/tag/01JH}{\texttt{Stacks tag 01JH}}
\group{schemes}
...
Thus, using Lemma \ref{schemes-lemma-morphism-into-affine}, we see that
$$
...
\begin{definition}[Representable by open immersions]
\label{schemes-definition-representable-by-open-immersions}
\source{stacks:01JI}
\href{https://stacks.math.columbia.edu/tag/01JI}{\texttt{Stacks tag 01JI}}
\group{schemes}
...
\begin{lemma}[Glue functors]
\label{schemes-lemma-glue-functors}
\source{stacks:01JJ}
\href{https://stacks.math.columbia.edu/tag/01JJ}{\texttt{Stacks tag 01JJ}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-glue-schemes, schemes-lemma-glue}
...
the cocycle condition in Section \ref{schemes-section-glueing-schemes}
...
to the element $\xi_i$.
Thus we may apply Lemma \ref{schemes-lemma-glue-schemes}
to obtain a scheme $X$ with an open
covering $X = \bigcup U_i$ and isomorphisms $\varphi_i : X_i \to U_i$
with properties as in Lemma \ref{schemes-lemma-glue}.
Let $\xi_i' = (\varphi_i^{-1})^* \xi_i$.
The conditions of Lemma \ref{schemes-lemma-glue} imply that
...
\begin{remark}[Representable locally ringed]
\label{schemes-remark-representable-locally-ringed}
\source{stacks:01JK}
\href{https://stacks.math.columbia.edu/tag/01JK}{\texttt{Stacks tag 01JK}}
\group{schemes}

\uses{schemes-lemma-glue-functors}
Suppose the functor $F$ is defined on all locally ringed spaces,
and if conditions of Lemma \ref{schemes-lemma-glue-functors} are replaced by
the following:
\begin{enumerate}
...
\source{stacks:01JM}
\href{https://stacks.math.columbia.edu/tag/01JM}{\texttt{Stacks tag 01JM}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-morphism-into-affine, schemes-lemma-glue-functors, schemes-lemma-glue, schemes-lemma-fibre-product-affine-schemes}
...
\medskip\noindent
By Lemma \ref{schemes-lemma-morphism-into-affine}
...
\end{eqnarray*}
is representable. We claim that Lemma \ref{schemes-lemma-glue-functors}
...
the mapping property of Lemma \ref{schemes-lemma-glue}). Moreover,
...
$$
\begin{array}{ccc} & W_k \downarrow\searrow &  \\ V_j \searrow\longrightarrow & U_i \searrow & Y \downarrow \\  & X \longrightarrow & S\end{array}
$$
...
\medskip\noindent
We check condition (2)(a) of Lemma \ref{schemes-lemma-glue-functors}.
This follows directly from Lemma \ref{schemes-lemma-fibre-product-affine-schemes}.
...
\medskip\noindent
We check condition (2)(b) of Lemma \ref{schemes-lemma-glue-functors}.
...
\medskip\noindent
We check condition (2)(c) of Lemma \ref{schemes-lemma-glue-functors}.
...
\begin{remark}[Fibre product schemes locally ringed]
\label{schemes-remark-fibre-product-schemes-locally-ringed}
\source{stacks:01JN}
\href{https://stacks.math.columbia.edu/tag/01JN}{\texttt{Stacks tag 01JN}}
\group{schemes}

\uses{schemes-remark-representable-locally-ringed}
Using Remark \ref{schemes-remark-representable-locally-ringed}
...
\source{stacks:01JP}
\href{https://stacks.math.columbia.edu/tag/01JP}{\texttt{Stacks tag 01JP}}
\group{schemes}
...
commutative diagram
$$
\begin{array}{cc}X \times_S Y \underset{q}{\longrightarrow}\underset{p}{\downarrow} & Y \overset{g}{\downarrow} \\ X \overset{f}{\longrightarrow} & S\end{array}
$$
...
$$
\begin{array}{cccc}T \searrow\searrow\searrow &  &  &  \\  &  & X \times_S Y \downarrow\longrightarrow & Y \downarrow \\  &  & X \longrightarrow & S\end{array}
$$
...
\begin{lemma}[Fibre product affines]
\label{schemes-lemma-fibre-product-affines}
\source{stacks:01JQ}
\href{https://stacks.math.columbia.edu/tag/01JQ}{\texttt{Stacks tag 01JQ}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-fibre-product-affine-schemes}

Suppose that $X = \Spec(A)$, $Y = \Spec(B)$
and $S = \Spec(R)$. By Lemma \ref{schemes-lemma-fibre-product-affine-schemes}
...
\begin{lemma}[Open fibre product]
\label{schemes-lemma-open-fibre-product}
\source{stacks:01JR}
\href{https://stacks.math.columbia.edu/tag/01JR}{\texttt{Stacks tag 01JR}}
\group{schemes}
...
\begin{lemma}[Bare-hands construction of fiber products: an affine open cover of a fiber product of s...]
\label{schemes-lemma-affine-covering-fibre-product}
\source{stacks:01JS}
\href{https://stacks.math.columbia.edu/tag/01JS}{\texttt{Stacks tag 01JS}}
\group{schemes}
...
In other words, we might have used the previous lemma to construct
the fibre product directly by
glueing the affine schemes. (Which is of course exactly
what we did in the proof of Lemma \ref{schemes-lemma-fibre-products} anyway.)
Here is a way to describe the set of points of a fibre product of schemes.

\begin{lemma}[Points fibre product]
\label{schemes-lemma-points-fibre-product}
\source{stacks:01JT}
\href{https://stacks.math.columbia.edu/tag/01JT}{\texttt{Stacks tag 01JT}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-characterize-points}

Let $z$ be a point of $X \times_S Y$ and let us construct a
quadruple as above. Recall that we may think of $z$ as a morphism
$\Spec(\kappa(z)) \to X \times_S Y$, see
Lemma \ref{schemes-lemma-characterize-points}. This morphism corresponds
...
$$
\begin{array}{cccc}X \times_S Y
\searrow\searrow &  &  &  \\  & \Spec(\kappa(x) \otimes_{\kappa(s)} \kappa(y)/\mathfrak p)
\longrightarrow\downarrow\nwarrow & \Spec(\kappa(y)) \downarrow\longrightarrow & Y \downarrow \\  & \Spec(\kappa(x)) \longrightarrow\downarrow & \Spec(\kappa(s)) \searrow &  \\  & X \longrightarrow &  & S\end{array}
$$
see the discussion in Section \ref{schemes-section-points}. Thus we get the
...
\begin{lemma}[Fibre product immersion]
\label{schemes-lemma-fibre-product-immersion}
\source{stacks:01JU}
\href{https://stacks.math.columbia.edu/tag/01JU}{\texttt{Stacks tag 01JU}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-restrict-map-to-closed, schemes-lemma-closed-subspace-scheme, schemes-lemma-open-fibre-product}

Assume that $X \to S$ is a closed immersion corresponding
to the quasi-coherent sheaf of ideals $\mathcal{I} \subset \mathcal{O}_S$.
By Lemma \ref{schemes-lemma-restrict-map-to-closed} the closed subspace
...
By Lemma \ref{schemes-lemma-closed-subspace-scheme} $Z$ is a scheme.
Hence $Z = X \times_S Y$ and the first statement follows.
The second follows from Lemma \ref{schemes-lemma-open-fibre-product}
for example. The third is a combination of
the first two.
\end{proof}

\begin{definition}[Inverse image closed subscheme]
\label{schemes-definition-inverse-image-closed-subscheme}
\source{stacks:01JV}
\href{https://stacks.math.columbia.edu/tag/01JV}{\texttt{Stacks tag 01JV}}
\group{schemes}

\uses{schemes-lemma-fibre-product-immersion}
...
$X$. See Lemma \ref{schemes-lemma-fibre-product-immersion} above.
\end{definition}
...
\source{stacks:01JX}
\href{https://stacks.math.columbia.edu/tag/01JX}{\texttt{Stacks tag 01JX}}
\group{schemes}
...
\source{stacks:01JY}
\href{https://stacks.math.columbia.edu/tag/01JY}{\texttt{Stacks tag 01JY}}
\group{schemes}
...
commutative diagram:
$$
\begin{array}{cc}X_{S'} \longrightarrow\downarrow & X \downarrow\downarrow \\ Y_{S'} \longrightarrow\downarrow & Y \downarrow \\ S' \longrightarrow & S\end{array}
$$
The diagram implies $X_{S'} \cong Y_{S'} \times_Y X$,
and the lemma follows from Lemma \ref{schemes-lemma-fibre-product-immersion}.
\end{proof}
...
\source{stacks:01JZ}
\href{https://stacks.math.columbia.edu/tag/01JZ}{\texttt{Stacks tag 01JZ}}
\group{schemes}
...
\source{stacks:01K0}
\href{https://stacks.math.columbia.edu/tag/01K0}{\texttt{Stacks tag 01K0}}
\group{schemes}
...
$$
\begin{array}{cc}X_s = \Spec(\kappa(s)) \times_S X \longrightarrow\downarrow & X \downarrow \\ \Spec(\kappa(s)) \longrightarrow & S\end{array}
$$
We think of the fibre $X_s$ always as a scheme over $\kappa(s)$.
\end{definition}

\begin{lemma}[Fibre topological]
\label{schemes-lemma-fibre-topological}
\source{stacks:01K1}
\href{https://stacks.math.columbia.edu/tag/01K1}{\texttt{Stacks tag 01K1}}
\group{schemes}
...
$$
\vcenter{
\begin{array}{cc}X_s \longrightarrow\downarrow & X \downarrow \\ \Spec(\kappa(s)) \longrightarrow & S\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}\Spec(\mathcal{O}_{S, s}) \times_S X \longrightarrow\downarrow & X \downarrow \\ \Spec(\mathcal{O}_{S, s}) \longrightarrow & S\end{array}
}
$$
...
\begin{proof}
\uses{schemes-lemma-morphism-from-spec-local-ring}

Choose an open affine $U \subset S$ that contains $s$.
The bottom horizontal morphisms factor through $U$, see
Lemma \ref{schemes-lemma-morphism-from-spec-local-ring} for example.
...
\begin{lemma}[Local ring fibre]
\label{schemes-lemma-local-ring-fibre}
\source{stacks:0HA1}
\href{https://stacks.math.columbia.edu/tag/0HA1}{\texttt{Stacks tag 0HA1}}
\group{schemes}

\uses{schemes-lemma-fibre-topological}
Let $f : X \to S$ be a morphism of schemes. Let $x \in X$
with image $s \in S$. Thinking of $x$ as a point of $X_s$
(see Lemma \ref{schemes-lemma-fibre-topological}) we have
$$
...
As in the proof of Lemma \ref{schemes-lemma-fibre-topological} this reduces
to the case where $X$ and $S$ are affine. In the affine case the statement
translates to Algebra, Remark \ref{algebra-remark-local-ring-fibre}.
\end{proof}
...
\source{stacks:01K3}
\href{https://stacks.math.columbia.edu/tag/01K3}{\texttt{Stacks tag 01K3}}
\group{schemes}
...
\begin{lemma}[Quasi compact affine]
\label{schemes-lemma-quasi-compact-affine}
\source{stacks:01K4}
\href{https://stacks.math.columbia.edu/tag/01K4}{\texttt{Stacks tag 01K4}}
\group{schemes}
...
\begin{lemma}[Quasi compact preserved base change]
\label{schemes-lemma-quasi-compact-preserved-base-change}
\source{stacks:01K5}
\href{https://stacks.math.columbia.edu/tag/01K5}{\texttt{Stacks tag 01K5}}
\group{schemes}
...
\source{stacks:01K6}
\href{https://stacks.math.columbia.edu/tag/01K6}{\texttt{Stacks tag 01K6}}
\group{schemes}
...
\source{stacks:01K7}
\href{https://stacks.math.columbia.edu/tag/01K7}{\texttt{Stacks tag 01K7}}
\group{schemes}
...
\begin{example}[Open immersion not quasi compact]
\label{schemes-example-open-immersion-not-quasi-compact}
\source{stacks:01K8}
\href{https://stacks.math.columbia.edu/tag/01K8}{\texttt{Stacks tag 01K8}}
\group{schemes}
...
\begin{lemma}[Image quasi compact closed]
\label{schemes-lemma-image-quasi-compact-closed}
\source{stacks:05JL}
\href{https://stacks.math.columbia.edu/tag/05JL}{\texttt{Stacks tag 05JL}}
\group{schemes}
...
\begin{lemma}[Quasi compact closed]
\label{schemes-lemma-quasi-compact-closed}
\source{stacks:01K9}
\href{https://stacks.math.columbia.edu/tag/01K9}{\texttt{Stacks tag 01K9}}
\group{schemes}
...
\begin{proof}
\uses{schemes-definition-reduced-induced-scheme, schemes-lemma-image-quasi-compact-closed}
...
Lemma \ref{schemes-lemma-image-quasi-compact-closed}.
\end{proof}
...
\source{stacks:01KB}
\href{https://stacks.math.columbia.edu/tag/01KB}{\texttt{Stacks tag 01KB}}
\group{schemes}
...
then we say that ``$X \to S$ is universally $\mathcal{P}$''
...
\begin{lemma}[Specializations lift]
\label{schemes-lemma-specializations-lift}
\source{stacks:01KC}
\href{https://stacks.math.columbia.edu/tag/01KC}{\texttt{Stacks tag 01KC}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-quasi-compact-closed, schemes-lemma-quasi-compact-preserved-base-change}

Part (1) is a direct consequence of
Topology, Lemma \ref{topology-lemma-closed-open-map-specialization}.
Part (2) follows from
Lemmas \ref{schemes-lemma-quasi-compact-closed} and
...
\source{stacks:01KD}
\href{https://stacks.math.columbia.edu/tag/01KD}{\texttt{Stacks tag 01KD}}
\group{schemes}
...
\begin{lemma}[Specializations are witnessed by valuation rings.]
\label{schemes-lemma-points-specialize}
\source{stacks:01J8}
\href{https://stacks.math.columbia.edu/tag/01J8}{\texttt{Stacks tag 01J8}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-specialize-points, schemes-lemma-characterize-points, schemes-lemma-morphism-from-spec-local-ring}

Let $s' \leadsto s$ be a specialization in $S$, and let
$K/\kappa(s')$ be an extension of fields. By
Lemma \ref{schemes-lemma-specialize-points}
and the discussion following
Lemma \ref{schemes-lemma-characterize-points}
...
$f : \Spec(A) \to S$, see
Lemma \ref{schemes-lemma-morphism-from-spec-local-ring}.
This morphism has all the desired properties by construction.
\end{proof}

\begin{lemma}[Lift specializations valuative]
\label{schemes-lemma-lift-specializations-valuative}
\source{stacks:01KE}
\href{https://stacks.math.columbia.edu/tag/01KE}{\texttt{Stacks tag 01KE}}
\group{schemes}
...
\begin{proof}
\uses{schemes-definition-valuative-criterion, schemes-lemma-characterize-points, schemes-lemma-specialize-points, schemes-lemma-morphism-from-spec-local-ring, schemes-lemma-points-specialize}

Assume (1) holds. Let a solid diagram as in
Definition \ref{schemes-definition-valuative-criterion} be given.
...
Lemma \ref{schemes-lemma-specialize-points} and the discussion following
Lemma \ref{schemes-lemma-characterize-points}. The composition
...
(see Lemma \ref{schemes-lemma-morphism-from-spec-local-ring} and
...
$$
\begin{array}{ccc}\Spec(K) \longrightarrow\downarrow & X_{S'} \longrightarrow\downarrow & X \downarrow \\ \Spec(A) \longrightarrow\nearrow\nearrow & S' \longrightarrow & S\end{array}
$$
...
Lemma \ref{schemes-lemma-points-specialize}
to $s' \leadsto s$ and the extension of fields
$K = \kappa(x')/\kappa(s')$.
We get a commutative diagram
$$
\begin{array}{ccc}\Spec(K) \longrightarrow\downarrow &  & X \downarrow \\ \Spec(A) \longrightarrow\nearrow & \Spec(\mathcal{O}_{S, s}) \longrightarrow & S\end{array}
$$
...
\source{stacks:01KF}
\href{https://stacks.math.columbia.edu/tag/01KF}{\texttt{Stacks tag 01KF}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-specializations-lift, schemes-lemma-lift-specializations-valuative}

This is a formal consequence of
Lemmas \ref{schemes-lemma-specializations-lift} and
\ref{schemes-lemma-lift-specializations-valuative} above.
\end{proof}

\begin{example}[Projective line universally closed]
\label{schemes-example-projective-line-universally-closed}
\source{stacks:01KG}
\href{https://stacks.math.columbia.edu/tag/01KG}{\texttt{Stacks tag 01KG}}
\group{schemes}

\uses{schemes-example-projective-line}
Let $k$ be a field. Consider the structure morphism
$p : \mathbf{P}^1_k \to \Spec(k)$ of the projective
line over $k$, see Example \ref{schemes-example-projective-line}.
...
$$
\begin{array}{cc}\Spec(K) \underset{\xi}{\longrightarrow}\downarrow & \mathbf{P}^1_k \downarrow \\ \Spec(A) \overset{\varphi}{\longrightarrow} & \Spec(k)\end{array}
$$
...
$$
\begin{array}{cc}K & k[x] \overset{\xi^\sharp}{\longleftarrow} \\ A \uparrow & k \uparrow\underset{\varphi^\sharp}{\longleftarrow}\end{array}
$$
...
\begin{lemma}[Diagonal affines closed]
\label{schemes-lemma-diagonal-affines-closed}
\source{stacks:01KI}
\href{https://stacks.math.columbia.edu/tag/01KI}{\texttt{Stacks tag 01KI}}
\group{schemes}
...
\begin{lemma}[The diagonal morphism for relative schemes is an immersion.]
\label{schemes-lemma-diagonal-immersion}
\source{stacks:01KJ}
\href{https://stacks.math.columbia.edu/tag/01KJ}{\texttt{Stacks tag 01KJ}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-fibre-product-affines, schemes-lemma-open-fibre-product, schemes-lemma-closed-local-target, schemes-lemma-diagonal-affines-closed}

Recall that if $V \subset X$ is affine open and maps into
$U \subset S$ affine open, then $V \times_U V$ is affine open
in $X \times_S X$, see Lemmas \ref{schemes-lemma-fibre-product-affines}
and \ref{schemes-lemma-open-fibre-product}.
Consider the open subscheme $W$ of $X \times_S X$ which
is the union of these affine opens $V \times_U V$.
By Lemma \ref{schemes-lemma-closed-local-target} it is enough
...
immersion, which is Lemma \ref{schemes-lemma-diagonal-affines-closed}.
\end{proof}

\begin{definition}[Separated]
\label{schemes-definition-separated}
\source{stacks:01KK}
\href{https://stacks.math.columbia.edu/tag/01KK}{\texttt{Stacks tag 01KK}}
\group{schemes}
...
By Lemmas \ref{schemes-lemma-diagonal-immersion} and \ref{schemes-lemma-immersion-when-closed}
we see that $\Delta_{X/S}$ is a closed immersion if an only if
$\Delta_{X/S}(X) \subset X \times_S X$ is a closed subset. Moreover,
by Lemma \ref{schemes-lemma-closed-immersion-quasi-compact} we see that a
...
\begin{example}[Not quasi separated]
\label{schemes-example-not-quasi-separated}
\source{stacks:01KL}
\href{https://stacks.math.columbia.edu/tag/01KL}{\texttt{Stacks tag 01KL}}
\group{schemes}
...
(glued as in Example \ref{schemes-example-affine-space-zero-doubled}).
...
\begin{lemma}[Where are they equal]
\label{schemes-lemma-where-are-they-equal}
\source{stacks:01KM}
\href{https://stacks.math.columbia.edu/tag/01KM}{\texttt{Stacks tag 01KM}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-base-change-immersion, schemes-lemma-diagonal-immersion, schemes-definition-separated}

The equalizer of $(a, b)$ is for categorical reasons
the fibre product $Z$ in the following diagram
$$
\begin{array}{cc}Z = Y \times_{(Y \times_S Y)} X \longrightarrow\downarrow & X \overset{(a , b)}{\downarrow} \\ Y \overset{\Delta_{Y/S}}{\longrightarrow} & Y \times_S Y\end{array}
$$
Thus the lemma follows from Lemmas
\ref{schemes-lemma-base-change-immersion}, \ref{schemes-lemma-diagonal-immersion} and
Definition \ref{schemes-definition-separated}.
\end{proof}

\begin{lemma}[Characterize quasi separated]
\label{schemes-lemma-characterize-quasi-separated}
\source{stacks:01KO}
\href{https://stacks.math.columbia.edu/tag/01KO}{\texttt{Stacks tag 01KO}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-affine-covering-fibre-product, schemes-lemma-quasi-compact-affine}

Let us prove that (3) implies (1).
By Lemma \ref{schemes-lemma-affine-covering-fibre-product}
...
Hence the implication follows from Lemma \ref{schemes-lemma-quasi-compact-affine}.
...
\source{stacks:01KP}
\href{https://stacks.math.columbia.edu/tag/01KP}{\texttt{Stacks tag 01KP}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-open-fibre-product, schemes-lemma-closed-subspace-scheme, schemes-lemma-affine-covering-fibre-product, schemes-lemma-closed-local-target}
...
By Lemma \ref{schemes-lemma-open-fibre-product} we see that
$U \times_S V = U \times_W V = \Spec(A \otimes_R B)$
is an affine open of $X \times_S X$. Hence, by
Lemma \ref{schemes-lemma-closed-subspace-scheme} we see that
...
of $X \times_S X$ (see e.g.\ Lemma \ref{schemes-lemma-affine-covering-fibre-product}).
Hence it suffices to show that each morphism
$U \cap V = \Delta_{X/S}^{-1}(U \times_S V) \to U \times_S V$
is a closed immersion, see Lemma \ref{schemes-lemma-closed-local-target}.
...
\begin{example}[Projective line separated]
\label{schemes-example-projective-line-separated}
\source{stacks:01KQ}
\href{https://stacks.math.columbia.edu/tag/01KQ}{\texttt{Stacks tag 01KQ}}
\group{schemes}

\uses{schemes-example-projective-line, schemes-lemma-characterize-separated}
Let $k$ be a field. Consider the structure morphism
$p : \mathbf{P}^1_k \to \Spec(k)$ of the projective
line over $k$, see Example \ref{schemes-example-projective-line}.
...
conditions (2)(a) and (2)(b) of Lemma \ref{schemes-lemma-characterize-separated}
...
\source{stacks:01KR}
\href{https://stacks.math.columbia.edu/tag/01KR}{\texttt{Stacks tag 01KR}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-diagonal-immersion, schemes-lemma-fibre-product-immersion, schemes-lemma-quasi-compact-preserved-base-change}

By general category theory the following diagram
$$
\begin{array}{cc}X \times_T Y \longrightarrow\downarrow & X \times_S Y \downarrow \\ T \overset{\Delta_{T/S}}{\longrightarrow}\longrightarrow & T \times_S T\end{array}
$$
is a fibre product diagram. The lemma follows
from Lemmas \ref{schemes-lemma-diagonal-immersion},
\ref{schemes-lemma-fibre-product-immersion} and
\ref{schemes-lemma-quasi-compact-preserved-base-change}.
\end{proof}
...
\source{stacks:01KS}
\href{https://stacks.math.columbia.edu/tag/01KS}{\texttt{Stacks tag 01KS}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-fibre-product-after-map}

This is a special case of Lemma \ref{schemes-lemma-fibre-product-after-map}
...
\source{stacks:01KT}
\href{https://stacks.math.columbia.edu/tag/01KT}{\texttt{Stacks tag 01KT}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-semi-diagonal}

This is a special case of Lemma \ref{schemes-lemma-semi-diagonal} applied to
$g =s$ so the morphism $i = s : S \to S \times_S X$.
\end{proof}

\begin{lemma}[Separated permanence]
\label{schemes-lemma-separated-permanence}
\source{stacks:01KU}
\href{https://stacks.math.columbia.edu/tag/01KU}{\texttt{Stacks tag 01KU}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-fibre-product-after-map, schemes-lemma-fibre-product-immersion, schemes-lemma-quasi-compact-preserved-base-change}
...
one by Lemma \ref{schemes-lemma-fibre-product-after-map}. The same argument
...
\begin{lemma}[Separated and quasi-separated morphisms satisfy cancellation.]
\label{schemes-lemma-compose-after-separated}
\source{stacks:01KV}
\href{https://stacks.math.columbia.edu/tag/01KV}{\texttt{Stacks tag 01KV}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-fibre-product-after-map, schemes-lemma-immersion-when-closed, schemes-lemma-characterize-quasi-separated}
...
By Lemma \ref{schemes-lemma-fibre-product-after-map}
...
is a closed immersion by Lemma \ref{schemes-lemma-immersion-when-closed}.
...
deduce the lemma from Lemma \ref{schemes-lemma-characterize-quasi-separated}.
\end{proof}

\begin{lemma}[Quasi compact permanence]
\label{schemes-lemma-quasi-compact-permanence}
\source{stacks:03GI}
\href{https://stacks.math.columbia.edu/tag/03GI}{\texttt{Stacks tag 03GI}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-section-immersion, schemes-lemma-separated-permanence, schemes-lemma-quasi-compact-preserved-base-change, schemes-lemma-composition-quasi-compact}

This is true because $f$ equals the composition
$(1, f) : X \to X \times_Z Y \to Y$. The first map
is quasi-compact by Lemma \ref{schemes-lemma-section-immersion}
because it is a section of the quasi-separated morphism $X \times_Z Y \to X$
(a base change of $g$, see Lemma \ref{schemes-lemma-separated-permanence}).
The second map is quasi-compact as it
is the base change of $g \circ f$, see
Lemma \ref{schemes-lemma-quasi-compact-preserved-base-change}.
And compositions of quasi-compact
morphisms are quasi-compact, see Lemma \ref{schemes-lemma-composition-quasi-compact}.
\end{proof}

\begin{lemma}[Affine separated]
\label{schemes-lemma-affine-separated}
\source{stacks:01KN}
\href{https://stacks.math.columbia.edu/tag/01KN}{\texttt{Stacks tag 01KN}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-diagonal-affines-closed, schemes-definition-separated, schemes-lemma-compose-after-separated}

Let $U = \Spec(A)$ be an affine scheme. Then $U \to \Spec(\mathbf{Z})$
has closed diagonal by Lemma \ref{schemes-lemma-diagonal-affines-closed}.
Thus $U$ is separated by Definition \ref{schemes-definition-separated}.
If $U \to X$ is a morphism of schemes, then we can apply
Lemma \ref{schemes-lemma-compose-after-separated}
...
\source{stacks:01KW}
\href{https://stacks.math.columbia.edu/tag/01KW}{\texttt{Stacks tag 01KW}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-separated-permanence, schemes-lemma-characterize-separated}

In this case $X$ is separated by Lemma \ref{schemes-lemma-separated-permanence}.
Hence $U \cap V$ is affine by
applying Lemma \ref{schemes-lemma-characterize-separated} to the
...
\begin{example}[Image affine projective]
\label{schemes-example-image-affine-projective}
\source{stacks:01KX}
\href{https://stacks.math.columbia.edu/tag/01KX}{\texttt{Stacks tag 01KX}}
\group{schemes}

\uses{schemes-example-not-affine}
Consider the nonaffine scheme
$U = \Spec(k[x, y]) \setminus \{(x, y)\}$ of
Example \ref{schemes-example-not-affine}. On the other hand, consider the
scheme
$$
...
\begin{remark}[Quasi compact and quasi separated]
\label{schemes-remark-quasi-compact-and-quasi-separated}
\source{stacks:0816}
\href{https://stacks.math.columbia.edu/tag/0816}{\texttt{Stacks tag 0816}}
\group{schemes}

\uses{schemes-lemma-separated-permanence, schemes-lemma-composition-quasi-compact, schemes-lemma-compose-after-separated, schemes-lemma-quasi-compact-permanence, schemes-lemma-quasi-compact-preserved-base-change}
Let $P$ equal one of the following $4$ properties:
``quasi-separated'', ``separated'',
``quasi-compact and quasi-separated'', or ``quasi-compact and separated''.
Then the following are true
\begin{enumerate}
\item Any affine scheme has $P$.
\item Given a morphism $f : X \to Y$ of scheme where $Y$ has $P$, then
$f$ has $P$ if and only if $X$ has $P$.
\item If  $X \to Y$ and $Z \to Y$ are morphisms of schemes
and $X$, $Y$, $Z$ have $P$, then $X \times_Y Z$ has $P$.
\end{enumerate}
Statement (1) is clear.
Let $f : X \to Y$ be as in (2). If $f$ has $P$, then so does $X$
by Lemmas \ref{schemes-lemma-separated-permanence} and
\ref{schemes-lemma-composition-quasi-compact} applied to
$X \to Y \to \Spec(\mathbf{Z})$. If $X$ has $P$, then so does $f$ by
Lemmas \ref{schemes-lemma-compose-after-separated} and
\ref{schemes-lemma-quasi-compact-permanence} applied to
$X \to Y \to \Spec(\mathbf{Z})$.
Let $X \to Y$ and $Z \to Y$ be as in (3).
Then the projection $X \times_Y Z \to Z$ has $P$ as a base change of
the arrow $X \to Y$ which has $P$ by (2), see Lemmas
\ref{schemes-lemma-separated-permanence} and
\ref{schemes-lemma-quasi-compact-preserved-base-change}.
Hence $X \times_Y Z$ has $P$ by (2).
\end{remark}
...
\source{stacks:01KZ}
\href{https://stacks.math.columbia.edu/tag/01KZ}{\texttt{Stacks tag 01KZ}}
\group{schemes}
...
\begin{proof}
\uses{schemes-definition-valuative-criterion, schemes-lemma-where-are-they-equal}

Let a diagram as in Definition \ref{schemes-definition-valuative-criterion}
...
By Lemma \ref{schemes-lemma-where-are-they-equal} this is a closed
...
\source{stacks:01L0}
\href{https://stacks.math.columbia.edu/tag/01L0}{\texttt{Stacks tag 01L0}}
\group{schemes}
...
\begin{proof}
\uses{schemes-proposition-characterize-universally-closed, schemes-lemma-diagonal-immersion, schemes-lemma-immersion-when-closed}

By assumption (1),
Proposition \ref{schemes-proposition-characterize-universally-closed}, and
Lemmas \ref{schemes-lemma-diagonal-immersion} and \ref{schemes-lemma-immersion-when-closed}
...
\source{stacks:01L2}
\href{https://stacks.math.columbia.edu/tag/01L2}{\texttt{Stacks tag 01L2}}
\group{schemes}
...
\begin{lemma}[A scheme morphism is a monomorphism iff its diagonal is an isomorphism.]
\label{schemes-lemma-monomorphism}
\source{stacks:01L3}
\href{https://stacks.math.columbia.edu/tag/01L3}{\texttt{Stacks tag 01L3}}
\group{schemes}
...
\source{stacks:01L4}
\href{https://stacks.math.columbia.edu/tag/01L4}{\texttt{Stacks tag 01L4}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-monomorphism}

This is true because an isomorphism is a closed immersion,
and Lemma \ref{schemes-lemma-monomorphism} above.
\end{proof}

\begin{lemma}[Composition monomorphism]
\label{schemes-lemma-composition-monomorphism}
\source{stacks:01L5}
\href{https://stacks.math.columbia.edu/tag/01L5}{\texttt{Stacks tag 01L5}}
\group{schemes}
...
\source{stacks:02YC}
\href{https://stacks.math.columbia.edu/tag/02YC}{\texttt{Stacks tag 02YC}}
\group{schemes}
...
\begin{lemma}[Injective points]
\label{schemes-lemma-injective-points}
\source{stacks:0DVA}
\href{https://stacks.math.columbia.edu/tag/0DVA}{\texttt{Stacks tag 0DVA}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-diagonal-immersion}
...
proof of Lemma \ref{schemes-lemma-diagonal-immersion}).
\end{proof}

\begin{lemma}[Injective points surjective stalks]
\label{schemes-lemma-injective-points-surjective-stalks}
\source{stacks:01L6}
\href{https://stacks.math.columbia.edu/tag/01L6}{\texttt{Stacks tag 01L6}}
\group{schemes}
...
\source{stacks:01L7}
\href{https://stacks.math.columbia.edu/tag/01L7}{\texttt{Stacks tag 01L7}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-injective-points-surjective-stalks, schemes-lemma-restrict-map-to-opens, schemes-lemma-characterize-closed-subspace}

We can see this by checking that the criterion of
Lemma \ref{schemes-lemma-injective-points-surjective-stalks} applies.
More elegantly perhaps, we can use that
Lemmas \ref{schemes-lemma-restrict-map-to-opens} and
\ref{schemes-lemma-characterize-closed-subspace} imply that
open and closed immersions are monomorphisms and hence
any immersion (which is a composition of such)
is a monomorphism.
\end{proof}

\begin{lemma}[Subscheme of separated scheme]
\label{schemes-lemma-subscheme-of-separated-scheme}
\source{stacks:01L8}
\href{https://stacks.math.columbia.edu/tag/01L8}{\texttt{Stacks tag 01L8}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-immersions-monomorphisms, schemes-lemma-separated-permanence}

Follows from Lemma \ref{schemes-lemma-immersions-monomorphisms}
and the fact that a composition of separated morphisms is separated
(Lemma \ref{schemes-lemma-separated-permanence}).
\end{proof}

\begin{example}[Q over Z]
\label{schemes-example-Q-over-Z}
\source{stacks:01L9}
\href{https://stacks.math.columbia.edu/tag/01L9}{\texttt{Stacks tag 01L9}}
\group{schemes}
...
\begin{lemma}[Mono towards spec field]
\label{schemes-lemma-mono-towards-spec-field}
\source{stacks:03DP}
\href{https://stacks.math.columbia.edu/tag/03DP}{\texttt{Stacks tag 03DP}}
\group{schemes}
...
We have seen in
Section \ref{schemes-section-quasi-coherent-affine}
...
\begin{lemma}[Push forward quasi coherent]
\label{schemes-lemma-push-forward-quasi-coherent}
\source{stacks:01LC}
\href{https://stacks.math.columbia.edu/tag/01LC}{\texttt{Stacks tag 01LC}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-characterize-quasi-separated, schemes-lemma-widetilde-pullback}
...
affine open $U_{ijk}$, see Lemma \ref{schemes-lemma-characterize-quasi-separated}.
...
Hence by Lemma \ref{schemes-lemma-widetilde-pullback} we see that the second and
...
\begin{lemma}[Characterize closed immersions]
\label{schemes-lemma-characterize-closed-immersions}
\source{stacks:01LD}
\href{https://stacks.math.columbia.edu/tag/01LD}{\texttt{Stacks tag 01LD}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-injective-points-surjective-stalks, schemes-lemma-monomorphism-separated, schemes-lemma-push-forward-quasi-coherent, schemes-lemma-extension-quasi-coherent, schemes-definition-closed-immersion-locally-ringed-spaces}
...
Lemma \ref{schemes-lemma-injective-points-surjective-stalks}.
Hence $f : X \to Y$ is a monomorphism. In particular, $f$
is separated, see Lemma \ref{schemes-lemma-monomorphism-separated}.
Hence Lemma \ref{schemes-lemma-push-forward-quasi-coherent}
...
by Lemma \ref{schemes-lemma-extension-quasi-coherent}. Since a quasi-coherent
...
\source{stacks:02V0}
\href{https://stacks.math.columbia.edu/tag/02V0}{\texttt{Stacks tag 02V0}}
\group{schemes}
...
\begin{proof}
\uses{schemes-lemma-characterize-closed-immersions}
...
Hence by Lemma \ref{schemes-lemma-characterize-closed-immersions}
