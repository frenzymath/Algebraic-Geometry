...
\source{stacks:0FQW}
\href{https://stacks.math.columbia.edu/tag/0FQW}{\texttt{Stacks tag 0FQW}}
\group{sdga}
...
\begin{remark}[Functoriality ga]
\label{sdga-remark-functoriality-ga}
\source{stacks:0FQX}
\href{https://stacks.math.columbia.edu/tag/0FQX}{\texttt{Stacks tag 0FQX}}
\group{sdga}
...
\source{stacks:0FQZ}
\href{https://stacks.math.columbia.edu/tag/0FQZ}{\texttt{Stacks tag 0FQZ}}
\group{sdga}
...
\begin{lemma}[Gm abelian]
\label{sdga-lemma-gm-abelian}
\source{stacks:0FR0}
\href{https://stacks.math.columbia.edu/tag/0FR0}{\texttt{Stacks tag 0FR0}}
\group{sdga}
...
Definition \ref{sdga-definition-gm}. Hence these are also
...
Section \ref{sdga-section-graded-modules}). Given graded
...
in Section \ref{sdga-section-gm-gr-cat}.
Let $(\mathcal{C}, \mathcal{O})$, $\mathcal{A}$,
$\mathcal{M}$, $\mathcal{L}$ be as in Section \ref{sdga-section-gm-gr-cat}.
Then we define
$$
...
$$
for local sections $a$ of $\mathcal{A}^i$ and
$m$ of $\mathcal{L}^{-q - i}$. As in Section \ref{sdga-section-gm-gr-cat}
...
defined in Section \ref{sdga-section-tensor-product}.
...
\source{stacks:0FR5}
\href{https://stacks.math.columbia.edu/tag/0FR5}{\texttt{Stacks tag 0FR5}}
\group{sdga}
...
graded tensor product defined in Section \ref{sdga-section-tensor-product}
$$
\mathcal{M} \otimes_\mathcal{A} \mathcal{N}
$$
...
defined in Section \ref{sdga-section-internal-hom-graded}
$$
...
\begin{lemma}[Tensor hom adjunction gr]
\label{sdga-lemma-tensor-hom-adjunction-gr}
\source{stacks:0FR6}
\href{https://stacks.math.columbia.edu/tag/0FR6}{\texttt{Stacks tag 0FR6}}
\group{sdga}
...
Lemma \ref{sdga-lemma-tensor-hom-adjunction-gr}
...
See Remark \ref{sdga-remark-functoriality-ga}.
...
product discussion in Section \ref{sdga-section-graded-bimodules}
...
\begin{lemma}[Adjunction push pull gr]
\label{sdga-lemma-adjunction-push-pull-gr}
\source{stacks:0FR8}
\href{https://stacks.math.columbia.edu/tag/0FR8}{\texttt{Stacks tag 0FR8}}
\group{sdga}
...
given in Section \ref{sdga-section-graded-bimodules}.
\end{proof}
...
In Section \ref{sdga-section-functoriality-graded}
...
\begin{lemma}[Extension by zero graded]
\label{sdga-lemma-extension-by-zero-graded}
\source{stacks:0FRA}
\href{https://stacks.math.columbia.edu/tag/0FRA}{\texttt{Stacks tag 0FRA}}
\group{sdga}
...
$$
\begin{array}{cc}\mathcal{M}^n \otimes_{\mathcal{O}_U} \mathcal{A}_U^m
\underset{f^n \otimes 1}{\longrightarrow}\downarrow & j^*\mathcal{N}^{n + d} \otimes_{\mathcal{O}_U} \mathcal{A}_U^m \downarrow \\ \mathcal{M}^{n + m} \overset{f^{n + m}}{\longrightarrow} & j^*\mathcal{N}^{n + m + d}\end{array}
$$
commutes if and only if
$$
\begin{array}{cc}j_!\mathcal{M}^n \otimes_\mathcal{O} \mathcal{A}^m
\underset{g^n \otimes 1}{\longrightarrow}\downarrow & \mathcal{N}^{n + d} \otimes_\mathcal{O} \mathcal{A}_U^m \downarrow \\ j_!\mathcal{M}^{n + m} \overset{g^{n + m}}{\longrightarrow} & \mathcal{N}^{n + m + d}\end{array}
$$
...
\begin{lemma}[Tensor with extension by zero]
\label{sdga-lemma-tensor-with-extension-by-zero}
\source{stacks:0FRB}
\href{https://stacks.math.columbia.edu/tag/0FRB}{\texttt{Stacks tag 0FRB}}
\group{sdga}
...
$$
See Section \ref{sdga-section-tensor-product}.
...
\begin{lemma}[Gm grothendieck abelian]
\label{sdga-lemma-gm-grothendieck-abelian}
\source{stacks:0FRD}
\href{https://stacks.math.columbia.edu/tag/0FRD}{\texttt{Stacks tag 0FRD}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-gm-abelian}

By Lemma \ref{sdga-lemma-gm-abelian} and the definition of a Grothendieck
abelian category
...
\source{stacks:0FRF}
\href{https://stacks.math.columbia.edu/tag/0FRF}{\texttt{Stacks tag 0FRF}}
\group{sdga}
...
\begin{remark}[Functoriality dga]
\label{sdga-remark-functoriality-dga}
\source{stacks:0FRG}
\href{https://stacks.math.columbia.edu/tag/0FRG}{\texttt{Stacks tag 0FRG}}
\group{sdga}

\uses{sdga-remark-functoriality-ga}
Let $(f, f^\sharp) : (\Sh(\mathcal{C}), \mathcal{O}_\mathcal{C})
\to (\Sh(\mathcal{D}), \mathcal{O}_\mathcal{D})$
...
Remark \ref{sdga-remark-functoriality-ga} and
...
\source{stacks:0FRI}
\href{https://stacks.math.columbia.edu/tag/0FRI}{\texttt{Stacks tag 0FRI}}
\group{sdga}
...
\source{stacks:0FRJ}
\href{https://stacks.math.columbia.edu/tag/0FRJ}{\texttt{Stacks tag 0FRJ}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-gm-abelian, sdga-definition-dgm}
...
Lemma \ref{sdga-lemma-gm-abelian}.
...
Definition \ref{sdga-definition-dgm}. Hence these are also
...
Combining Lemmas \ref{sdga-lemma-dgm-abelian} and \ref{sdga-lemma-gm-abelian}
...
Section \ref{sdga-section-modules}. Given differential graded
$\mathcal{A}$-modules $\mathcal{L}$ and $\mathcal{M}$ we set
$$
...
\bigoplus\nolimits_{n \in \mathbf{Z}} \Hom^n(\mathcal{L}, \mathcal{M})
$$
as a graded $R$-module, see Section \ref{sdga-section-gm-gr-cat}.
...
\Hom^{n + m}(\mathcal{K}, \mathcal{M})
$$
in Section \ref{sdga-section-gm-gr-cat} by the usual composition
...
in Section \ref{sdga-section-tensor-product}. It comes endowed
with a differential
$$
...
this is what we did in Section \ref{sdga-section-tensor-product}.
...
We are going to need the sheafified version of the construction
in Section \ref{sdga-section-dgm-dg-cat}.
Let $(\mathcal{C}, \mathcal{O})$, $\mathcal{A}$,
$\mathcal{M}$, $\mathcal{L}$ be as in Section \ref{sdga-section-dgm-dg-cat}.
Then we define
$$
...
Section \ref{sdga-section-internal-hom-graded}.
...
Using the exact same computation as in Section \ref{sdga-section-dgm-dg-cat}
we see that $\text{d}(f)$ is $\mathcal{A}_U$-linear.

\medskip\noindent
As in Section \ref{sdga-section-dgm-dg-cat} there is a composition map
$$
...
defined in Section \ref{sdga-section-tensor-product-dg}. This map
...
computation as in Section \ref{sdga-section-dgm-dg-cat} on local sections
...
\begin{definition}[Dg bimodule]
\label{sdga-definition-dg-bimodule}
\source{stacks:0FRQ}
\href{https://stacks.math.columbia.edu/tag/0FRQ}{\texttt{Stacks tag 0FRQ}}
\group{sdga}
...
\source{stacks:0FRR}
\href{https://stacks.math.columbia.edu/tag/0FRR}{\texttt{Stacks tag 0FRR}}
\group{sdga}
...
Section \ref{sdga-section-tensor-product-dg}
$$
\mathcal{M} \otimes_\mathcal{A} \mathcal{N}
$$
is a right differential graded $\mathcal{B}$-module with
multiplication maps as in Section \ref{sdga-section-graded-bimodules}.
This construction defines a functor and a functor of graded categories
$$
\otimes_\mathcal{A} \mathcal{N} :
\textit{Mod}(\mathcal{A}, \text{d})
...
defined in Section \ref{sdga-section-internal-hom-dg}
$$
...
in Section \ref{sdga-section-graded-bimodules}. Another way to define
...
\SheafHom_\mathcal{B}^{dg}(\mathcal{N}, \mathcal{L})
$$
where the first arrow comes from Lemma \ref{sdga-lemma-what-makes-a-bimodule-dg}
and the second arrow is the composition of
Section \ref{sdga-section-internal-hom-dg}. Since these arrows are
...
\begin{lemma}[Tensor hom adjunction dg]
\label{sdga-lemma-tensor-hom-adjunction-dg}
\source{stacks:0FRS}
\href{https://stacks.math.columbia.edu/tag/0FRS}{\texttt{Stacks tag 0FRS}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-tensor-hom-adjunction-gr}

Omitted. Hint: On the graded level we have seen this is true in
Lemma \ref{sdga-lemma-tensor-hom-adjunction-gr}. Thus it suffices
...
See Remark \ref{sdga-remark-functoriality-dga}.
...
in Section \ref{sdga-section-functoriality-graded} with differential
...
constructed in Section \ref{sdga-section-functoriality-graded}. Recall
that
$$
...
tensor product discussed in Section \ref{sdga-section-dg-bimodules}
...
\begin{lemma}[Adjunction push pull dg]
\label{sdga-lemma-adjunction-push-pull-dg}
\source{stacks:0FRU}
\href{https://stacks.math.columbia.edu/tag/0FRU}{\texttt{Stacks tag 0FRU}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-adjunction-push-pull-gr}

Omitted. Hints: This is true for the underlying graded categories
by Lemma \ref{sdga-lemma-adjunction-push-pull-gr}. A calculation shows
...
to $\mathcal{C}/U$, in other words, we have
$\mathcal{A}_U = j^*\mathcal{A} = j^{-1}\mathcal{A}$.
In Section \ref{sdga-section-functoriality-dg}
we have constructed adjoint functors
$$
j_* :
...
Section \ref{sdga-section-localize-graded}
with differentials
...
\begin{lemma}[Extension by zero dg]
\label{sdga-lemma-extension-by-zero-dg}
\source{stacks:0FRW}
\href{https://stacks.math.columbia.edu/tag/0FRW}{\texttt{Stacks tag 0FRW}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-extension-by-zero-graded}

Omitted. Hint: We have seen in Lemma \ref{sdga-lemma-extension-by-zero-graded}
...
\begin{lemma}[Tensor with extension by zero dg]
\label{sdga-lemma-tensor-with-extension-by-zero-dg}
\source{stacks:0FRX}
\href{https://stacks.math.columbia.edu/tag/0FRX}{\texttt{Stacks tag 0FRX}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-tensor-with-extension-by-zero}

As graded modules, this follows from
Lemma \ref{sdga-lemma-tensor-with-extension-by-zero}.
...
as defined in Section \ref{sdga-section-shift},
...
\Hom_{\textit{Mod}^{dg}(\mathcal{A}, \text{d})}(\mathcal{L}, \mathcal{M})[k]
$$
defined in Section \ref{sdga-section-shift} on underlying graded modules
is compatible with
...
\source{stacks:0FS0}
\href{https://stacks.math.columbia.edu/tag/0FS0}{\texttt{Stacks tag 0FS0}}
\group{sdga}
...
\source{stacks:0FS1}
\href{https://stacks.math.columbia.edu/tag/0FS1}{\texttt{Stacks tag 0FS1}}
\group{sdga}
...
\text{Comp}(\textit{Mod}^{dg}(\mathcal{A}, \text{d}))
$$
(see discussion in Section \ref{sdga-section-dgm-dg-cat}) and we obtain
$$
...
$$
when $h$ is as in Definition \ref{sdga-definition-homotopy}. We omit the
details.

\begin{lemma}[Homotopy direct sums]
\label{sdga-lemma-homotopy-direct-sums}
\source{stacks:0FS2}
\href{https://stacks.math.columbia.edu/tag/0FS2}{\texttt{Stacks tag 0FS2}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-dgm-abelian}

Omitted. Hint: Just use the direct sums and products as in
Lemma \ref{sdga-lemma-dgm-abelian}. This works because we saw that
...
\begin{lemma}[Axioms AB]
\label{sdga-lemma-axioms-AB}
\source{stacks:0FS4}
\href{https://stacks.math.columbia.edu/tag/0FS4}{\texttt{Stacks tag 0FS4}}
\group{sdga}
...
\medskip\noindent
Axiom (B) was shown in Section \ref{sdga-section-shift-dg}.
\end{proof}
...
Combining Lemma \ref{sdga-lemma-axioms-AB} and
...
\source{stacks:0FS5}
\href{https://stacks.math.columbia.edu/tag/0FS5}{\texttt{Stacks tag 0FS5}}
\group{sdga}
...
\source{stacks:0FS6}
\href{https://stacks.math.columbia.edu/tag/0FS6}{\texttt{Stacks tag 0FS6}}
\group{sdga}
...
\source{stacks:0FS7}
\href{https://stacks.math.columbia.edu/tag/0FS7}{\texttt{Stacks tag 0FS7}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-axioms-AB, sdga-lemma-axiom-C}

Recall that $K(\textit{Mod}(\mathcal{A}, \text{d})) =
K(\textit{Mod}^{dg}(\mathcal{A}, \text{d}))$, see
Section \ref{sdga-section-homotopy}.
Having said this, the proposition
follows from Lemmas \ref{sdga-lemma-axioms-AB} and \ref{sdga-lemma-axiom-C}
and
Differential Graded Algebra, Proposition
\ref{dga-proposition-ABC-homotopy-category-triangulated}.
\end{proof}

\begin{remark}[Cone identity]
\label{sdga-remark-cone-identity}
\source{stacks:0FS8}
\href{https://stacks.math.columbia.edu/tag/0FS8}{\texttt{Stacks tag 0FS8}}
\group{sdga}
...
\begin{lemma}[Dgm grothendieck abelian]
\label{sdga-lemma-dgm-grothendieck-abelian}
\source{stacks:0FS9}
\href{https://stacks.math.columbia.edu/tag/0FS9}{\texttt{Stacks tag 0FS9}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-dgm-abelian, sdga-remark-cone-identity}

By Lemma \ref{sdga-lemma-dgm-abelian} and the definition of a Grothendieck
abelian category
(Injectives, Definition \ref{injectives-definition-grothendieck-conditions})
it suffices to
...
as in Remark \ref{sdga-remark-cone-identity}. We claim that
$$
...
\begin{lemma}[Supply good]
\label{sdga-lemma-supply-good}
\source{stacks:0FSB}
\href{https://stacks.math.columbia.edu/tag/0FSB}{\texttt{Stacks tag 0FSB}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-tensor-with-extension-by-zero, sdga-lemma-tensor-with-extension-by-zero-dg}

Let $\mathcal{N}$ be a left graded $\mathcal{A}$-module.
By Lemma \ref{sdga-lemma-tensor-with-extension-by-zero} we have
$$
...
Lemma \ref{sdga-lemma-tensor-with-extension-by-zero-dg}.
...
\underset{(j', (j')^\sharp)}{\longrightarrow}\underset{(f', (f')^\sharp)}{\downarrow} &  & (\Sh(\mathcal{C}'), \mathcal{O}')
\overset{(f, f^\sharp)}{\downarrow} \\ (\Sh(\mathcal{C}/U), \mathcal{O}_U)
\overset{(j, j^\sharp)}{\longrightarrow} &  & (\Sh(\mathcal{C}), \mathcal{O}).\end{array}
$$
...
The third equation by Lemma \ref{sdga-lemma-tensor-with-extension-by-zero-dg}
...
\begin{lemma}[Good admissible ses]
\label{sdga-lemma-good-admissible-ses}
\source{stacks:0FSC}
\href{https://stacks.math.columbia.edu/tag/0FSC}{\texttt{Stacks tag 0FSC}}
\group{sdga}
...
\begin{lemma}[Good direct sum]
\label{sdga-lemma-good-direct-sum}
\source{stacks:0FSD}
\href{https://stacks.math.columbia.edu/tag/0FSD}{\texttt{Stacks tag 0FSD}}
\group{sdga}
...
\source{stacks:0FSE}
\href{https://stacks.math.columbia.edu/tag/0FSE}{\texttt{Stacks tag 0FSE}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-supply-good, sdga-lemma-good-direct-sum, sdga-remark-cone-identity, sdga-lemma-good-admissible-ses}
...
$j_{U!}\mathcal{A}_U[-k]$ are good (Lemma \ref{sdga-lemma-supply-good})
and any direct sum of good objects is good (Lemma \ref{sdga-lemma-good-direct-sum}).
...
as in Remark \ref{sdga-remark-cone-identity}. The element $x$ will determine a map
$\varphi_x : C_U[-k - 1] \to \mathcal{A}_U$, see
Remark \ref{sdga-remark-cone-identity}. Now, since we have
...
Lemma \ref{sdga-lemma-good-admissible-ses} and
the already used Lemma \ref{sdga-lemma-supply-good}.
...
\begin{remark}[Sheaf graded sets]
\label{sdga-remark-sheaf-graded-sets}
\source{stacks:0FSF}
\href{https://stacks.math.columbia.edu/tag/0FSF}{\texttt{Stacks tag 0FSF}}
\group{sdga}
...
\begin{lemma}[Free graded module good]
\label{sdga-lemma-free-graded-module-good}
\source{stacks:0FSG}
\href{https://stacks.math.columbia.edu/tag/0FSG}{\texttt{Stacks tag 0FSG}}
\group{sdga}

\uses{sdga-remark-sheaf-graded-sets}
Let $(\mathcal{C}, \mathcal{O})$ be a ringed site.
...
Remark \ref{sdga-remark-sheaf-graded-sets}
...
\source{stacks:0FSH}
\href{https://stacks.math.columbia.edu/tag/0FSH}{\texttt{Stacks tag 0FSH}}
\group{sdga}
...
\begin{proof}
\uses{sdga-remark-sheaf-graded-sets, sdga-lemma-free-graded-module-good, sdga-lemma-good-admissible-ses, sdga-lemma-good-direct-sum}
[First proof]
...
$$
where the left hand side is as in Remark \ref{sdga-remark-sheaf-graded-sets}
...
by Lemma \ref{sdga-lemma-free-graded-module-good} and each $\mathcal{P}_{i + 1}$
...
Lemma \ref{sdga-lemma-good-admissible-ses}.
Finally, we conclude that $\mathcal{P}$ is good by
Lemma \ref{sdga-lemma-good-direct-sum}.
\end{proof}

\begin{proof}
\uses{sdga-lemma-good-quotient, sdga-lemma-good-admissible-ses, sdga-lemma-good-direct-sum}
[Second proof]
...
Lemma \ref{sdga-lemma-good-quotient}.
...
$$
By induction and Lemma \ref{sdga-lemma-good-admissible-ses}
we find that $F_i\mathcal{P}$ is a good differential graded
$\mathcal{A}$-module. Since $\mathcal{P} = \colim F_i\mathcal{P}$
we find that $\mathcal{P}$ is good by Lemma \ref{sdga-lemma-good-direct-sum}.
...
$$
\begin{array}{cccc}\mathcal{M}_{i + 2}[i + 1] \underset{a}{\longrightarrow} & T_{i + 1} \longrightarrow & F_{i + 1}\mathcal{P} \longrightarrow & C_{i + 1} \downarrow \\  & \mathcal{M}_{i + 1}[i] \longrightarrow\overset{b}{\uparrow} & F_i\mathcal{P} \uparrow\longrightarrow & C_i\end{array}
$$
...
$$
\begin{array}{cccc}H^d(T_{i + 1}) \longrightarrow & H^d(F_{i + 1}\mathcal{P}) \longrightarrow & H^d(\mathcal{M}) \longrightarrow & H^{d + 1}(T_{i + 1}) \\ H^d(\mathcal{M}_{i + 1}[i]) \longrightarrow\uparrow & H^d(F_i\mathcal{P}) \longrightarrow\uparrow & H^d(\mathcal{M}) \longrightarrow\uparrow & H^{d + 1}(\mathcal{M}_{i + 1}[i]) \uparrow\end{array}
$$
...
\begin{lemma}[Acyclic good]
\label{sdga-lemma-acyclic-good}
\source{stacks:0FSI}
\href{https://stacks.math.columbia.edu/tag/0FSI}{\texttt{Stacks tag 0FSI}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-resolve}

Proof of (1). By Lemma \ref{sdga-lemma-resolve} we can choose a good
...
\source{stacks:0FSK}
\href{https://stacks.math.columbia.edu/tag/0FSK}{\texttt{Stacks tag 0FSK}}
\group{sdga}
...
$F$ are satisfied by Lemma \ref{sdga-lemma-dgm-abelian}. The set theoretic
...
\begin{lemma}[Dg hull acyclic]
\label{sdga-lemma-dg-hull-acyclic}
\source{stacks:0FSL}
\href{https://stacks.math.columbia.edu/tag/0FSL}{\texttt{Stacks tag 0FSL}}
\group{sdga}

\uses{sdga-lemma-dg-hull}
The functors $F, G$ of Lemma \ref{sdga-lemma-dg-hull} have
...
\begin{proof}
\uses{sdga-remark-cone-identity, sdga-lemma-gm-grothendieck-abelian}
...
$$
By Remark \ref{sdga-remark-cone-identity} we see that this functor represented
...
$$
\vcenter{
\begin{array}{cc}\textit{Mod}(\mathcal{A}, \text{d}) \underset{j_U^*}{\downarrow}\underset{F}{\longrightarrow} & \textit{Mod}(\mathcal{A}) \overset{j_U^*}{\downarrow} \\ \textit{Mod}(\mathcal{A}_U, \text{d}) \overset{F_U}{\longrightarrow} & \textit{Mod}(\mathcal{A}_U)\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}\textit{Mod}(\mathcal{A}_U, \text{d}) \underset{F_U}{\longrightarrow}\underset{j_{U!}}{\downarrow} & \textit{Mod}(\mathcal{A}_U) \overset{j_{U!}}{\downarrow} \\ \textit{Mod}(\mathcal{A}, \text{d}) \overset{F}{\longrightarrow} & \textit{Mod}(\mathcal{A})\end{array}
}
$$
by the construction of $j^*_U$ and $j_{U!}$ in
Sections \ref{sdga-section-functoriality-graded},
\ref{sdga-section-functoriality-dg},
\ref{sdga-section-localize-graded}, and
\ref{sdga-section-localize-dg}.
...
\medskip\noindent
In the proof of Lemma \ref{sdga-lemma-gm-grothendieck-abelian}
...
\source{stacks:0FSN}
\href{https://stacks.math.columbia.edu/tag/0FSN}{\texttt{Stacks tag 0FSN}}
\group{sdga}
...
\begin{remark}[Why graded injective]
\label{sdga-remark-why-graded-injective}
\source{stacks:0FSQ}
\href{https://stacks.math.columbia.edu/tag/0FSQ}{\texttt{Stacks tag 0FSQ}}
\group{sdga}
...
$$
\begin{array}{cc}\Hom_{K(\textit{Mod}(\mathcal{A}, \text{d}))}(\mathcal{M}_3, \mathcal{I})
\downarrow & \Hom_{K(\textit{Mod}(\mathcal{A}, \text{d}))}(\mathcal{M}_3, \mathcal{I})[1]
\downarrow \\ \Hom_{K(\textit{Mod}(\mathcal{A}, \text{d}))}(\mathcal{M}_2, \mathcal{I})
\downarrow & \Hom_{K(\textit{Mod}(\mathcal{A}, \text{d}))}(\mathcal{M}_2, \mathcal{I})[1]
\downarrow \\ \Hom_{K(\textit{Mod}(\mathcal{A}, \text{d}))}(\mathcal{M}_1, \mathcal{I})
\nearrow & \Hom_{K(\textit{Mod}(\mathcal{A}, \text{d}))}(\mathcal{M}_1, \mathcal{I})[1]\end{array}
$$
...
\begin{lemma}[Product graded injective]
\label{sdga-lemma-product-graded-injective}
\source{stacks:0FSR}
\href{https://stacks.math.columbia.edu/tag/0FSR}{\texttt{Stacks tag 0FSR}}
\group{sdga}
...
\begin{lemma}[Characterize graded injectives in dg]
\label{sdga-lemma-characterize-graded-injectives-in-dg}
\source{stacks:0FSS}
\href{https://stacks.math.columbia.edu/tag/0FSS}{\texttt{Stacks tag 0FSS}}
\group{sdga}
...
$$
\begin{array}{cc}\mathcal{M}_t \longrightarrow\downarrow & \mathcal{I} \\ \mathcal{M}'_t \nearrow & \end{array}
$$
...
$$
\begin{array}{cc}\mathcal{N}_t \longrightarrow\downarrow & F(\mathcal{I}) \\ \mathcal{N}'_t \nearrow & \end{array}
$$
...
\begin{lemma}[Small acyclics]
\label{sdga-lemma-small-acyclics}
\source{stacks:0FST}
\href{https://stacks.math.columbia.edu/tag/0FST}{\texttt{Stacks tag 0FST}}
\group{sdga}
...
\source{stacks:0FSU}
\href{https://stacks.math.columbia.edu/tag/0FSU}{\texttt{Stacks tag 0FSU}}
\group{sdga}
...
\source{stacks:0FSV}
\href{https://stacks.math.columbia.edu/tag/0FSV}{\texttt{Stacks tag 0FSV}}
\group{sdga}
...
\begin{lemma}[First property dg injective]
\label{sdga-lemma-first-property-dg-injective}
\source{stacks:0FSW}
\href{https://stacks.math.columbia.edu/tag/0FSW}{\texttt{Stacks tag 0FSW}}
\group{sdga}
...
$$
\begin{array}{cc}\mathcal{M} \underset{a}{\longrightarrow}\underset{b}{\downarrow} & \mathcal{I} \\ \mathcal{M}' \nearrow & \end{array}
$$
...
\begin{lemma}[Second property dg injective]
\label{sdga-lemma-second-property-dg-injective}
\source{stacks:0FSX}
\href{https://stacks.math.columbia.edu/tag/0FSX}{\texttt{Stacks tag 0FSX}}
\group{sdga}
...
\begin{proof}
\uses{sdga-remark-why-graded-injective}
...
by Remark \ref{sdga-remark-why-graded-injective}
we see that
$$
...
\begin{lemma}[Better set of monos]
\label{sdga-lemma-better-set-of-monos}
\source{stacks:0FSY}
\href{https://stacks.math.columbia.edu/tag/0FSY}{\texttt{Stacks tag 0FSY}}
\group{sdga}
...
\item for every solid diagram
$$
\begin{array}{cc}\mathcal{M}_r \longrightarrow\downarrow & \mathcal{I} \\ \mathcal{M}'_r \nearrow & \end{array}
$$
a dotted arrow exists in $\textit{Mod}(\mathcal{A}, \text{d})$
making the diagram commute.
\end{enumerate}
...
\begin{proof}
\uses{sdga-lemma-characterize-graded-injectives-in-dg, sdga-lemma-small-acyclics, sdga-lemma-first-property-dg-injective, sdga-remark-why-graded-injective}

Let $T$ and $\mathcal{M}_t \to \mathcal{M}'_t$ be as in
Lemma \ref{sdga-lemma-characterize-graded-injectives-in-dg}.
Let $S$ and $\mathcal{M}_s$ be as in
Lemma \ref{sdga-lemma-small-acyclics}.
...
applies by the discussion in Section \ref{sdga-section-conclude-triangulated}.
We claim that $R = T \coprod S$ with the given maps works.

\medskip\noindent
The implication (1) $\Rightarrow$ (2) holds by
Lemma \ref{sdga-lemma-first-property-dg-injective}.

\medskip\noindent
Assume (2). First, by Lemma \ref{sdga-lemma-characterize-graded-injectives-in-dg}
...
are surjective by Remark \ref{sdga-remark-why-graded-injective}
...
\begin{lemma}[Functor set of monos]
\label{sdga-lemma-functor-set-of-monos}
\source{stacks:0FSZ}
\href{https://stacks.math.columbia.edu/tag/0FSZ}{\texttt{Stacks tag 0FSZ}}
\group{sdga}
...
\item for every solid diagram
$$
\begin{array}{cc}\mathcal{M}_r \longrightarrow\downarrow & \mathcal{M} \overset{j_\mathcal{M}}{\downarrow} \\ \mathcal{M}'_r \dashrightarrow & M(\mathcal{M})\end{array}
$$
a dotted arrow exists in $\textit{Mod}(\mathcal{A}, \text{d})$
making the diagram commute.
\end{enumerate}
...
$$
\begin{array}{cc}\bigoplus_{(r, \varphi)} \mathcal{M}_r \longrightarrow\downarrow & \mathcal{M} \downarrow \\ \bigoplus_{(r, \varphi)} \mathcal{M}'_r \longrightarrow & M(\mathcal{M})\end{array}
$$
...
\begin{theorem}[Qis into dg injective]
\label{sdga-theorem-qis-into-dg-injective}
\source{stacks:0FT0}
\href{https://stacks.math.columbia.edu/tag/0FT0}{\texttt{Stacks tag 0FT0}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-better-set-of-monos, sdga-lemma-functor-set-of-monos}

Let $R$ and $\mathcal{M}_r \to \mathcal{M}'_r$ be a set of
morphisms of $\textit{Mod}(\mathcal{A}, \text{d})$ found in
Lemma \ref{sdga-lemma-better-set-of-monos}.
Let $M$ with transformation $\text{id} \to M$
be as constructed in Lemma \ref{sdga-lemma-functor-set-of-monos}
...
\source{stacks:0FT2}
\href{https://stacks.math.columbia.edu/tag/0FT2}{\texttt{Stacks tag 0FT2}}
\group{sdga}
...
of Section \ref{sdga-section-modules} factors through a
functor
$$
...
$$
\begin{array}{cc}\textit{Mod}(\mathcal{A}, \text{d}) \longrightarrow\downarrow & K(\textit{Mod}(\mathcal{A}, \text{d})) \downarrow \\ \text{Comp}(\mathcal{O}) \longrightarrow & K(\textit{Mod}(\mathcal{O}))\end{array}
$$
...
\begin{lemma}[Acyclics]
\label{sdga-lemma-acyclics}
\source{stacks:0FT3}
\href{https://stacks.math.columbia.edu/tag/0FT3}{\texttt{Stacks tag 0FT3}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-cohomology-homological}
...
Lemma \ref{sdga-lemma-cohomology-homological}, and
...
\source{stacks:0FT4}
\href{https://stacks.math.columbia.edu/tag/0FT4}{\texttt{Stacks tag 0FT4}}
\group{sdga}
...
the same by Lemma \ref{sdga-lemma-cohomology-homological}. Thus it is
...
In the situation of Lemma \ref{sdga-lemma-qis} we can apply
...
K-injective complexes. Namely, by Theorem \ref{sdga-theorem-qis-into-dg-injective}
...
By Lemma \ref{sdga-lemma-second-property-dg-injective}
we can choose the dotted arrow
$$
\begin{array}{cccc}\mathcal{M} \overset{f}{\searrow} &  & \mathcal{N} \underset{s}{\swarrow}\overset{s_0}{\searrow} &  \\  & \mathcal{N}' \overset{s'}{\dashrightarrow} &  & \mathcal{I}\end{array}
$$
...
\source{stacks:0FT5}
\href{https://stacks.math.columbia.edu/tag/0FT5}{\texttt{Stacks tag 0FT5}}
\group{sdga}
...
\source{stacks:0FT6}
\href{https://stacks.math.columbia.edu/tag/0FT6}{\texttt{Stacks tag 0FT6}}
\group{sdga}

\uses{sdga-definition-derived-category, sdga-lemma-acyclics}
In Definition \ref{sdga-definition-derived-category}
the kernel of the localization functor
$Q : K(\textit{Mod}(\mathcal{A}, \text{d})) \to D(\mathcal{A}, \text{d})$
is the category $\text{Ac}$ of Lemma \ref{sdga-lemma-acyclics}.
\end{lemma}
...
\begin{lemma}[H0 over D]
\label{sdga-lemma-H0-over-D}
\source{stacks:0FT7}
\href{https://stacks.math.columbia.edu/tag/0FT7}{\texttt{Stacks tag 0FT7}}
\group{sdga}

\uses{sdga-definition-derived-category}
In Definition \ref{sdga-definition-derived-category} the functor
...
\source{stacks:0FT8}
\href{https://stacks.math.columbia.edu/tag/0FT8}{\texttt{Stacks tag 0FT8}}
\group{sdga}
...
\begin{proof}
\uses{sdga-definition-derived-category, sdga-lemma-second-property-dg-injective}
...
$$
In the discussion preceding Definition \ref{sdga-definition-derived-category}
we found, using Lemma \ref{sdga-lemma-second-property-dg-injective},
...
However, by Lemma \ref{sdga-lemma-second-property-dg-injective} there
exists a map
...
\source{stacks:0FT9}
\href{https://stacks.math.columbia.edu/tag/0FT9}{\texttt{Stacks tag 0FT9}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-dgm-abelian, sdga-lemma-homotopy-direct-sums, sdga-theorem-qis-into-dg-injective, sdga-lemma-hom-derived, sdga-lemma-product-K-injective, sdga-lemma-product-graded-injective}
...
See Lemmas \ref{sdga-lemma-dgm-abelian} and \ref{sdga-lemma-homotopy-direct-sums}.
...
Theorem \ref{sdga-theorem-qis-into-dg-injective}.
Using Lemma \ref{sdga-lemma-hom-derived} we have
\begin{align*}
\Hom_{D(\mathcal{A}, \text{d})}(\mathcal{M}, \mathcal{N})
& =
...
of differential graded $\mathcal{A}$-modules.
By Lemmas \ref{sdga-lemma-product-K-injective} and
\ref{sdga-lemma-product-graded-injective} we see that
$\mathcal{I}$ is graded injective and K-injective as a
differential graded $\mathcal{A}$-module.
For a differential graded $\mathcal{A}$-module
$\mathcal{N}$ using Lemma \ref{sdga-lemma-hom-derived} we have
\begin{align*}
...
$p : C(a) \to \mathcal{K}[1]$, see Definition \ref{sdga-definition-cone}.
...
Section \ref{sdga-section-conclude-triangulated})
applied to the diagram
$$
\begin{array}{cc}\mathcal{K} \underset{a}{\longrightarrow}\downarrow & \mathcal{L} \overset{b}{\downarrow} \\ 0 \longrightarrow & \mathcal{M}\end{array}
$$
...
\source{stacks:0FTB}
\href{https://stacks.math.columbia.edu/tag/0FTB}{\texttt{Stacks tag 0FTB}}
\group{sdga}
...
(which we may use by the discussion in
Section \ref{sdga-section-conclude-triangulated}) with a bit of
work. Compare with
...
\source{stacks:0FTC}
\href{https://stacks.math.columbia.edu/tag/0FTC}{\texttt{Stacks tag 0FTC}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-derived-products, sdga-lemma-derived-canonical-delta-functor}
...
Lemma \ref{sdga-lemma-derived-products}.
...
(Lemma \ref{sdga-lemma-derived-canonical-delta-functor}).
\end{proof}
...
Sections \ref{sdga-section-functoriality-dg} and \ref{sdga-section-dg-bimodules}.
...
\begin{lemma}[Derived tensor product]
\label{sdga-lemma-derived-tensor-product}
\source{stacks:0FTF}
\href{https://stacks.math.columbia.edu/tag/0FTF}{\texttt{Stacks tag 0FTF}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-resolve, sdga-lemma-good-admissible-ses, sdga-lemma-acyclic-good}
...
See Lemma \ref{sdga-lemma-resolve}.
...
$\mathcal{A}$-module by Lemma \ref{sdga-lemma-good-admissible-ses}.
...
Lemma \ref{sdga-lemma-acyclic-good}
...
\source{stacks:0FTG}
\href{https://stacks.math.columbia.edu/tag/0FTG}{\texttt{Stacks tag 0FTG}}
\group{sdga}

\uses{sdga-lemma-derived-tensor-product}
...
constructed in Lemma \ref{sdga-lemma-derived-tensor-product}
...
\begin{lemma}[Compose pullback tensor]
\label{sdga-lemma-compose-pullback-tensor}
\source{stacks:0FTH}
\href{https://stacks.math.columbia.edu/tag/0FTH}{\texttt{Stacks tag 0FTH}}
\group{sdga}

\uses{sdga-lemma-derived-tensor-product}
In Lemma \ref{sdga-lemma-derived-tensor-product} the functor
...
\begin{lemma}[Compose pullback]
\label{sdga-lemma-compose-pullback}
\source{stacks:0FTI}
\href{https://stacks.math.columbia.edu/tag/0FTI}{\texttt{Stacks tag 0FTI}}
\group{sdga}
...
\begin{lemma}[Tensor symmetry]
\label{sdga-lemma-tensor-symmetry}
\source{stacks:0FTJ}
\href{https://stacks.math.columbia.edu/tag/0FTJ}{\texttt{Stacks tag 0FTJ}}
\group{sdga}
...
$\mathcal{A}$-module, see Definition \ref{sdga-definition-cone}.
...
\begin{lemma}[Good on other side]
\label{sdga-lemma-good-on-other-side}
\source{stacks:0FTK}
\href{https://stacks.math.columbia.edu/tag/0FTK}{\texttt{Stacks tag 0FTK}}
\group{sdga}
...
\begin{lemma}[Compose tensor]
\label{sdga-lemma-compose-tensor}
\source{stacks:0FTL}
\href{https://stacks.math.columbia.edu/tag/0FTL}{\texttt{Stacks tag 0FTL}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-resolve, sdga-lemma-good-on-other-side, sdga-lemma-tensor-symmetry}

Choose a good differential graded $\mathcal{A}$-module
$\mathcal{P}$ and a quasi-isomorphism $\mathcal{P} \to \mathcal{M}$, see
Lemma \ref{sdga-lemma-resolve}. Then
$$
\mathcal{M}
\otimes_\mathcal{A}^\mathbf{L}
(\mathcal{N} \otimes_{\mathcal{A}'} \mathcal{N}') =
...
By Lemma \ref{sdga-lemma-good-on-other-side} the map
...
Lemma \ref{sdga-lemma-tensor-symmetry} (the left and right hand side
...
\begin{lemma}[Right derived]
\label{sdga-lemma-right-derived}
\source{stacks:0FTN}
\href{https://stacks.math.columbia.edu/tag/0FTN}{\texttt{Stacks tag 0FTN}}
\group{sdga}
...
\begin{proof}
\uses{sdga-theorem-qis-into-dg-injective, sdga-lemma-hom-derived, sdga-lemma-second-property-dg-injective}

By Theorem \ref{sdga-theorem-qis-into-dg-injective}
...
for example from Lemma \ref{sdga-lemma-hom-derived} (or one can
deduce it from Lemma \ref{sdga-lemma-second-property-dg-injective}).
\end{proof}
...
\source{stacks:0FTP}
\href{https://stacks.math.columbia.edu/tag/0FTP}{\texttt{Stacks tag 0FTP}}
\group{sdga}
...
agrees with derived pushforward on underlying complexes
of $\mathcal{O}$-modules, see Lemma \ref{sdga-lemma-pushforward-agrees}.

\medskip\noindent
These functors are the adjoints of derived pullback and
derived tensor product.

\begin{lemma}[Derived adjoint tensor hom]
\label{sdga-lemma-derived-adjoint-tensor-hom}
\source{stacks:0FTQ}
\href{https://stacks.math.columbia.edu/tag/0FTQ}{\texttt{Stacks tag 0FTQ}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-tensor-hom-adjunction-dg}

This follows from Derived Categories, Lemma
\ref{derived-lemma-pre-derived-adjoint-functors-general}
and Lemma \ref{sdga-lemma-tensor-hom-adjunction-dg}.
\end{proof}

\begin{lemma}[Derived adjoint push pull]
\label{sdga-lemma-derived-adjoint-push-pull}
\source{stacks:0FTR}
\href{https://stacks.math.columbia.edu/tag/0FTR}{\texttt{Stacks tag 0FTR}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-adjunction-push-pull-dg}

This follows from Derived Categories, Lemma
\ref{derived-lemma-pre-derived-adjoint-functors-general}
and Lemma \ref{sdga-lemma-adjunction-push-pull-dg}.
\end{proof}

Next, we discuss what happens in the situation considered in
Section \ref{sdga-section-derived-pullback}.
...
\begin{lemma}[Compose pushforward hom]
\label{sdga-lemma-compose-pushforward-hom}
\source{stacks:0FTT}
\href{https://stacks.math.columbia.edu/tag/0FTT}{\texttt{Stacks tag 0FTT}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-tensor-hom-adjunction-dg, sdga-lemma-adjunction-push-pull-dg, sdga-lemma-derived-tensor-product, sdga-lemma-compose-pullback-tensor, sdga-lemma-derived-adjoint-tensor-hom, sdga-lemma-derived-adjoint-push-pull}

By Lemmas \ref{sdga-lemma-tensor-hom-adjunction-dg} and
\ref{sdga-lemma-adjunction-push-pull-dg} the functor
...
of Lemma \ref{sdga-lemma-derived-tensor-product} which is equal to
$Lf^*(-) \otimes_\mathcal{A}^\mathbf{L} \mathcal{N}$ by
Lemma \ref{sdga-lemma-compose-pullback-tensor}.
By Lemmas \ref{sdga-lemma-derived-adjoint-tensor-hom} and
\ref{sdga-lemma-derived-adjoint-push-pull} the functor
...
\source{stacks:0FTU}
\href{https://stacks.math.columbia.edu/tag/0FTU}{\texttt{Stacks tag 0FTU}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-compose-pullback, sdga-lemma-derived-adjoint-push-pull}

Follows from Lemmas \ref{sdga-lemma-compose-pullback} and
\ref{sdga-lemma-derived-adjoint-push-pull}
and uniqueness of adjoints.
\end{proof}

\begin{lemma}[Compose hom]
\label{sdga-lemma-compose-hom}
\source{stacks:0FTV}
\href{https://stacks.math.columbia.edu/tag/0FTV}{\texttt{Stacks tag 0FTV}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-compose-tensor, sdga-lemma-derived-adjoint-tensor-hom}

Follows from Lemmas \ref{sdga-lemma-compose-tensor} and
\ref{sdga-lemma-derived-adjoint-tensor-hom}
and uniqueness of adjoints.
\end{proof}

\begin{lemma}[Pushforward agrees]
\label{sdga-lemma-pushforward-agrees}
\source{stacks:0FTW}
\href{https://stacks.math.columbia.edu/tag/0FTW}{\texttt{Stacks tag 0FTW}}
\group{sdga}
...
The diagram
$$
\begin{array}{ccc}D(\mathcal{A}, \text{d}) \underset{Rf_*}{\downarrow}\underset{forget}{\longrightarrow} &  & D(\mathcal{O}_\mathcal{C}) \overset{Rf_*}{\downarrow} \\ D(\mathcal{B}, \text{d}) \overset{forget}{\longrightarrow} &  & D(\mathcal{O}_\mathcal{D})\end{array}
$$
commutes.
\end{lemma}

\begin{proof}
\uses{sdga-lemma-compose-pushforward, sdga-definition-pushforward}

Besides identifying some categories, this lemma follows immediately
from Lemma \ref{sdga-lemma-compose-pushforward}.
...
defined in Section \ref{sdga-section-functoriality-dg}
...
\begin{lemma}[Cohomology ext]
\label{sdga-lemma-cohomology-ext}
\source{stacks:0FTX}
\href{https://stacks.math.columbia.edu/tag/0FTX}{\texttt{Stacks tag 0FTX}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-right-derived, sdga-lemma-pushforward-agrees, sdga-lemma-hom-derived}
...
Lemmas \ref{sdga-lemma-right-derived} and \ref{sdga-lemma-pushforward-agrees}).
By Lemma \ref{sdga-lemma-hom-derived} we have
$$
\Hom_{D(\mathcal{A}, \text{d})}(\mathcal{A}, \mathcal{M}[n]) =
...
\source{stacks:0FTZ}
\href{https://stacks.math.columbia.edu/tag/0FTZ}{\texttt{Stacks tag 0FTZ}}
\group{sdga}
...
$$
See Section \ref{sdga-section-dg-bimodules}. Since restriction
...
Remark \ref{sdga-remark-sheaf-graded-sets} consider a
...
$$
with notation as in Remark \ref{sdga-remark-sheaf-graded-sets}.
...
\begin{lemma}[Special good]
\label{sdga-lemma-special-good}
\source{stacks:0FU1}
\href{https://stacks.math.columbia.edu/tag/0FU1}{\texttt{Stacks tag 0FU1}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-good-direct-sum, sdga-lemma-good-admissible-ses, sdga-lemma-free-graded-module-good}
...
for $w' < w$, then by Lemmas \ref{sdga-lemma-good-direct-sum},
...
\begin{lemma}[Good dga]
\label{sdga-lemma-good-dga}
\source{stacks:0FU2}
\href{https://stacks.math.columbia.edu/tag/0FU2}{\texttt{Stacks tag 0FU2}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-resolve, sdga-lemma-special-good, sdga-remark-sheaf-graded-sets}

The proof is exactly the same as the first proof of
Lemma \ref{sdga-lemma-resolve} but now working with free graded
algebras instead of free graded modules.

\medskip\noindent
We will construct $\mathcal{A} = \colim \mathcal{A}_i$ as in
Lemma \ref{sdga-lemma-special-good} by constructing
$$
...
Lemma \ref{sdga-lemma-special-good}.
\end{proof}
...
the tensor product of Section \ref{sdga-section-tensor-product-dg} so that
...
that the diagram
$$
\begin{array}{ccc}Rf_*\mathcal{A} \otimes_{\mathcal{O}'}^\mathbf{L} Rf_*\mathcal{A}
\otimes_{\mathcal{O}'}^\mathbf{L} Rf_*\mathcal{A}
\underset{\mu \otimes 1}{\longrightarrow}\underset{1 \otimes \mu}{\downarrow} &  & Rf_*\mathcal{A} \otimes_{\mathcal{O}'}^\mathbf{L} Rf_*\mathcal{A}
\overset{\mu}{\downarrow} \\ Rf_*\mathcal{A} \otimes_{\mathcal{O}'}^\mathbf{L} Rf_*\mathcal{A}
\overset{\mu}{\longrightarrow} &  & Rf_*\mathcal{A}\end{array}
$$
...
$$
\begin{array}{ccc}Rf_*\mathcal{M} \otimes_{\mathcal{O}'}^\mathbf{L} Rf_*\mathcal{A}
\otimes_{\mathcal{O}'}^\mathbf{L} Rf_*\mathcal{A}
\underset{\mu_\mathcal{M} \otimes 1}{\longrightarrow}\underset{1 \otimes \mu}{\downarrow} &  & Rf_*\mathcal{M} \otimes_{\mathcal{O}'}^\mathbf{L} Rf_*\mathcal{A}
\overset{\mu_\mathcal{M}}{\downarrow} \\ Rf_*\mathcal{M} \otimes_{\mathcal{O}'}^\mathbf{L} Rf_*\mathcal{A}
\overset{\mu_\mathcal{M}}{\longrightarrow} &  & Rf_*\mathcal{M}\end{array}
$$
...
$$
\begin{array}{ccc}Rf_*\mathcal{M}_1 \otimes_{\mathcal{O}'}^\mathbf{L} Rf_*\mathcal{A}
\underset{\mu_{\mathcal{M}_1}}{\longrightarrow}\downarrow &  & Rf_*\mathcal{M}_1 \downarrow \\ Rf_*\mathcal{M}_2 \otimes_{\mathcal{O}'}^\mathbf{L} Rf_*\mathcal{A}
\overset{\mu_{\mathcal{M}_2}}{\longrightarrow} &  & Rf_*\mathcal{M}_2\end{array}
$$
...
that the diagram
$$
\begin{array}{ccc}Rf_*\mathcal{M}_3 \otimes_{\mathcal{O}'}^\mathbf{L} Rf_*\mathcal{A}
\underset{\mu_{\mathcal{M}_3}}{\longrightarrow}\underset{Rf_*\delta \otimes \text{id}}{\downarrow} &  & Rf_*\mathcal{M}_3 \overset{Rf_*\delta}{\downarrow} \\ Rf_*\mathcal{M}_1[1] \otimes_{\mathcal{O}'}^\mathbf{L} Rf_*\mathcal{A}
\overset{\mu_{\mathcal{M}_1[1]}}{\longrightarrow} &  & Rf_*\mathcal{M}_1[1]\end{array}
$$
...
$$
\begin{array}{cccc}\mathcal{M}_1 \underset{a}{\longrightarrow}\downarrow & \mathcal{M}_2 \underset{i}{\longrightarrow}\downarrow & C(a) \underset{-p}{\longrightarrow}\overset{q}{\downarrow} & \mathcal{M}_1[1] \downarrow \\ \mathcal{M}_1 \longrightarrow & \mathcal{M}_2 \longrightarrow & \mathcal{M}_3 \overset{\delta}{\longrightarrow} & \mathcal{M}_1[1]\end{array}
$$
...
Definition \ref{sdga-definition-cone}.
...
Lemma \ref{sdga-lemma-cohomology-ext} we can construct maps
$$
...
$$
\begin{array}{ccc}Rf_*\mathcal{A} \otimes_{\mathcal{O}'}^\mathbf{L} Rf_*\mathcal{A}
\underset{\mu}{\longrightarrow}\underset{Rf_*\xi' \otimes \text{id}}{\downarrow} &  & Rf_*\mathcal{A} \overset{Rf_*\xi'}{\downarrow} \\ Rf_*\mathcal{M}[n] \otimes_{\mathcal{O}'}^\mathbf{L} Rf_*\mathcal{A}
\overset{\mu_{\mathcal{M}[n]}}{\longrightarrow} &  & Rf_*\mathcal{M}[n]\end{array}
$$
commutes in $D(\mathcal{O}')$. Using this compatibility for the
map to the punctual topos, we see in particular that
$$
\begin{array}{cc}R\Gamma(\mathcal{C}, \mathcal{A})
\otimes_{\Gamma(\mathcal{C}, \mathcal{O})}^\mathbf{L}
R\Gamma(\mathcal{C}, \mathcal{A})
\underset{\xi' \otimes \text{id}}{\downarrow}\longrightarrow & R\Gamma(\mathcal{C}, \mathcal{A}) \overset{\xi'}{\downarrow} \\ R\Gamma(\mathcal{C}, \mathcal{M}[n])
\otimes_{\Gamma(\mathcal{C}, \mathcal{O})}^\mathbf{L}
R\Gamma(\mathcal{C}, \mathcal{A})
\longrightarrow & R\Gamma(\mathcal{C}, \mathcal{M}[n])\end{array}
$$
...
\source{stacks:0GZ9}
\href{https://stacks.math.columbia.edu/tag/0GZ9}{\texttt{Stacks tag 0GZ9}}
\group{sdga}
...
\source{stacks:0GZA}
\href{https://stacks.math.columbia.edu/tag/0GZA}{\texttt{Stacks tag 0GZA}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-derived-products}
...
\begin{remark}[Cartesian brown]
\label{sdga-remark-cartesian-brown}
\source{stacks:0GZB}
\href{https://stacks.math.columbia.edu/tag/0GZB}{\texttt{Stacks tag 0GZB}}
\group{sdga}
...
$\mathcal{O}'$-algebras (see Section \ref{sdga-section-functoriality-dg}).

\begin{lemma}[Cartesian functorial]
\label{sdga-lemma-cartesian-functorial}
\source{stacks:0GZC}
\href{https://stacks.math.columbia.edu/tag/0GZC}{\texttt{Stacks tag 0GZC}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-compose-pullback}
...
(Lemma \ref{sdga-lemma-compose-pullback}) and hence we conclude
$$
R\Gamma(U', Lg^*K) =
...
modules introduced in Section \ref{sdga-section-modules-cohomology}.

\begin{lemma}[Cartesian cofinal subcategory]
\label{sdga-lemma-cartesian-cofinal-subcategory}
\source{stacks:0GZE}
\href{https://stacks.math.columbia.edu/tag/0GZE}{\texttt{Stacks tag 0GZE}}
\group{sdga}

Let $\mathcal{C}, \mathcal{O}, \mathcal{A}$ be as in
Section \ref{sdga-section-modules-cohomology}. Let
...
see Lemma \ref{sdga-lemma-resolve}. Then for every $U' \in \Ob(\mathcal{C}')$
...
\begin{lemma}[Cartesian qis equivalence]
\label{sdga-lemma-cartesian-qis-equivalence}
\source{stacks:0GZF}
\href{https://stacks.math.columbia.edu/tag/0GZF}{\texttt{Stacks tag 0GZF}}
\group{sdga}

\uses{sdga-lemma-qis-equivalence}
...
$D(\mathcal{A}, \text{d}) \to D(\mathcal{B}, \text{d})$
of Lemma \ref{sdga-lemma-qis-equivalence} induces an equivalence
...
discussed in Section \ref{sdga-section-modules-cohomology}:
\begin{enumerate}
...
In this section we drop the differential from the notation
and we write $\mathit{QC}(\mathcal{A})$ for the category
denoted $\mathit{QC}(\mathcal{A}, \text{d})$ in
Definition \ref{sdga-definition-cartesian}.
...
$\mathit{QC}(\mathcal{A})$ to $\mathit{QC}(\mathcal{B})$.
...
$$
\begin{array}{cccc}\ldots \longrightarrow & A_{m(3)} \overset{\varphi_3}{\downarrow}\longrightarrow & A_{m(2)} \overset{\varphi_2}{\downarrow}\longrightarrow & A_{m(1)} \overset{\varphi_1}{\downarrow} \\ \ldots \longrightarrow & B_3 \longrightarrow & B_2 \longrightarrow & B_1\end{array}
$$
of differential graded $R$-algebras. Then given a good sheaf of
differential graded $\mathcal{A}$-modules $\mathcal{M} = (M_n)$
representing an object of $\mathit{QC}(\mathcal{A})$
we can set
$$
N_n = M_{m(n)} \otimes_{A_{m(n)}} B_n
$$
This inverse system determines an object of
$\mathit{QC}(\mathcal{B})$ because the
...
\begin{lemma}[Pro isomorphic]
\label{sdga-lemma-pro-isomorphic}
\source{stacks:0GZH}
\href{https://stacks.math.columbia.edu/tag/0GZH}{\texttt{Stacks tag 0GZH}}
\group{sdga}
...
a commutative diagram
$$
\begin{array}{cccc}\ldots \longrightarrow & B_{n(3)} \overset{\psi_3}{\downarrow}\longrightarrow & B_{n(2)} \overset{\psi_2}{\downarrow}\longrightarrow & B_{n(1)} \overset{\psi_1}{\downarrow} \\ \ldots \longrightarrow & A_3 \longrightarrow & A_2 \longrightarrow & A_1\end{array}
$$
...
\begin{lemma}[Pro isomorphic systems tensor]
\label{sdga-lemma-pro-isomorphic-systems-tensor}
\source{stacks:0GZI}
\href{https://stacks.math.columbia.edu/tag/0GZI}{\texttt{Stacks tag 0GZI}}
\group{sdga}
...
$(M_n \otimes_{A_n}^\mathbf{L} N'_n)$ of $D(R)$.
Thus the result by
More on Algebra, Lemma \ref{more-algebra-lemma-pro-isomorphism-Rlim}.
\end{proof}

\begin{lemma}[Different tensors]
\label{sdga-lemma-different-tensors}
\source{stacks:0GZJ}
\href{https://stacks.math.columbia.edu/tag/0GZJ}{\texttt{Stacks tag 0GZJ}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-pro-isomorphic-systems-tensor}
...
$$
Hence by Lemma \ref{sdga-lemma-pro-isomorphic-systems-tensor}
it suffices to show that
...
\begin{proposition}[Derived complete]
\label{sdga-proposition-derived-complete}
\source{stacks:0GZK}
\href{https://stacks.math.columbia.edu/tag/0GZK}{\texttt{Stacks tag 0GZK}}
\group{sdga}
...
\begin{proof}
\uses{sdga-lemma-pro-isomorphic, sdga-lemma-cartesian-qis-equivalence, sdga-lemma-different-tensors}
...
$$
\begin{array}{cccc}B_{n_1} \downarrow & B_{n_2} \downarrow\longleftarrow & B_{n_3} \downarrow\longleftarrow & \ldots \longleftarrow \\ E_1 \downarrow & E_2 \longleftarrow\downarrow & E_3 \longleftarrow\downarrow & \ldots \longleftarrow \\ B_1 & B_{n_1} \longleftarrow & B_{n_2} \longleftarrow & \ldots \longleftarrow\end{array}
$$
...
$\mathit{QC}(\mathcal{A})$.
\end{enumerate}
Namely, for (1) we can apply Lemma \ref{sdga-lemma-pro-isomorphic}
to the diagram above which shows that $(E_i)$ and $(B_n)$ are pro-isomorphic.
For (2) we can apply  Lemma \ref{sdga-lemma-cartesian-qis-equivalence} to the
inverse system of quasi-isomorphisms $E_i \to R/(f_1^{n_i}, \ldots, f_r^{n_i})$.
For (3) we can apply Lemma \ref{sdga-lemma-pro-isomorphic}
...
$$
By Lemma \ref{sdga-lemma-different-tensors} we have
$R\lim (M_n \otimes_R^\mathbf{L} B_t) =
...
\begin{remark}[Proregular]
\label{sdga-remark-proregular}
\source{stacks:0H1E}
\href{https://stacks.math.columbia.edu/tag/0H1E}{\texttt{Stacks tag 0H1E}}
\group{sdga}

\uses{sdga-proposition-derived-complete}
...
the arguments in the proof of Proposition \ref{sdga-proposition-derived-complete}
