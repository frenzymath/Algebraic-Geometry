...
\begin{lemma}[Higher direct image]
\label{spaces-cohomology-lemma-higher-direct-image}
\source{stacks:0720}
\href{https://stacks.math.columbia.edu/tag/0720}{\texttt{Stacks tag 0720}}
\group{spaces-cohomology}
...
Picture
$$
\begin{array}{cc}U \underset{g}{\longrightarrow}\underset{f \circ g}{\searrow} & X \overset{f}{\downarrow} \\  & Y\end{array}
$$
...
\source{stacks:08EX}
\href{https://stacks.math.columbia.edu/tag/08EX}{\texttt{Stacks tag 08EX}}
\group{spaces-cohomology}
...
By Lemma \ref{spaces-cohomology-lemma-higher-direct-image}
...
\begin{lemma}[Finite higher direct image zero]
\label{spaces-cohomology-lemma-finite-higher-direct-image-zero}
\source{stacks:0A4K}
\href{https://stacks.math.columbia.edu/tag/0A4K}{\texttt{Stacks tag 0A4K}}
\group{spaces-cohomology}
...
\begin{lemma}[Stalk push finite]
\label{spaces-cohomology-lemma-stalk-push-finite}
\source{stacks:0DK3}
\href{https://stacks.math.columbia.edu/tag/0DK3}{\texttt{Stacks tag 0DK3}}
\group{spaces-cohomology}
...
\begin{lemma}[Finite rings]
\label{spaces-cohomology-lemma-finite-rings}
\source{stacks:0DK4}
\href{https://stacks.math.columbia.edu/tag/0DK4}{\texttt{Stacks tag 0DK4}}
\group{spaces-cohomology}
...
Lemma \ref{spaces-cohomology-lemma-stalk-push-finite}.
\end{proof}

We end this section with an insanely general projection formula
for finite morphisms.

\begin{lemma}[Projection formula finite]
\label{spaces-cohomology-lemma-projection-formula-finite}
\source{stacks:0DK5}
\href{https://stacks.math.columbia.edu/tag/0DK5}{\texttt{Stacks tag 0DK5}}
\group{spaces-cohomology}

With $S$, $X$, $Y$, $\pi$, $\mathcal{A}$, $\mathcal{B}$, $\varphi$, and $f$
as in Lemma \ref{spaces-cohomology-lemma-finite-rings} we have
$$
...
\begin{proof}
Since $f_*$ is exact (Lemma \ref{spaces-cohomology-lemma-finite-higher-direct-image-zero})
...
$$
which are true by Lemma \ref{spaces-cohomology-lemma-finite-rings}.
\end{proof}
...
\source{stacks:073E}
\href{https://stacks.math.columbia.edu/tag/073E}{\texttt{Stacks tag 073E}}
\group{spaces-cohomology}
...
\begin{lemma}[Higher direct images of qcqs morphisms commute with filtered colimits of sheaves.]
\label{spaces-cohomology-lemma-colimit-cohomology}
\source{stacks:07U6}
\href{https://stacks.math.columbia.edu/tag/07U6}{\texttt{Stacks tag 07U6}}
\group{spaces-cohomology}
...
Hence we can apply Lemma \ref{spaces-cohomology-lemma-colimits}
to conclude.
\end{proof}
...
\source{stacks:07U7}
\href{https://stacks.math.columbia.edu/tag/07U7}{\texttt{Stacks tag 07U7}}
\group{spaces-cohomology}
...
\begin{lemma}[Product is tensor product]
\label{spaces-cohomology-lemma-product-is-tensor-product}
\source{stacks:0722}
\href{https://stacks.math.columbia.edu/tag/0722}{\texttt{Stacks tag 0722}}
\group{spaces-cohomology}
...
\source{stacks:0724}
\href{https://stacks.math.columbia.edu/tag/0724}{\texttt{Stacks tag 0724}}
\group{spaces-cohomology}
...
\begin{lemma}[Alternating cech to cohomology]
\label{spaces-cohomology-lemma-alternating-cech-to-cohomology}
\source{stacks:0725}
\href{https://stacks.math.columbia.edu/tag/0725}{\texttt{Stacks tag 0725}}
\group{spaces-cohomology}
...
\source{stacks:0726}
\href{https://stacks.math.columbia.edu/tag/0726}{\texttt{Stacks tag 0726}}
\group{spaces-cohomology}
...
By
Lemma \ref{spaces-cohomology-lemma-product-is-tensor-product}
we see that
$$
...
\source{stacks:0727}
\href{https://stacks.math.columbia.edu/tag/0727}{\texttt{Stacks tag 0727}}
\group{spaces-cohomology}
...
\begin{lemma}[Alternating spectral sequence]
\label{spaces-cohomology-lemma-alternating-spectral-sequence}
\source{stacks:0728}
\href{https://stacks.math.columbia.edu/tag/0728}{\texttt{Stacks tag 0728}}
\group{spaces-cohomology}
...
W_p = U \times_X \ldots \times_X U \setminus \text{all diagonals}
$$
(with $p + 1$ factors) as in Lemma \ref{spaces-cohomology-lemma-compute}.
Let $\chi_p : S_{p + 1} \to \{+1, -1\}$ be the sign character.
Let $U_p = W_p/S_{p + 1}$ and $\underline{\mathbf{Z}}(\chi_p)$ be as in
Lemma \ref{spaces-cohomology-lemma-twist}.
Then the spectral sequence of
Lemma \ref{spaces-cohomology-lemma-alternating-cech-to-cohomology}
has $E_1$-page
$$
E_1^{p, q} =
...
$$
which by
Lemma \ref{spaces-cohomology-lemma-compute}
...
\begin{lemma}[Quasi coherent twist]
\label{spaces-cohomology-lemma-quasi-coherent-twist}
\source{stacks:072A}
\href{https://stacks.math.columbia.edu/tag/072A}{\texttt{Stacks tag 072A}}
\group{spaces-cohomology}
...
\begin{proposition}[Vanishing]
\label{spaces-cohomology-proposition-vanishing}
\source{stacks:072B}
\href{https://stacks.math.columbia.edu/tag/072B}{\texttt{Stacks tag 072B}}
\group{spaces-cohomology}
...
Lemma \ref{spaces-cohomology-lemma-alternating-spectral-sequence}.
...
\ref{coherent-lemma-quasi-coherent-affine-cohomology-zero}.
By
Lemma \ref{spaces-cohomology-lemma-quasi-coherent-twist}
the sheaves
$\mathcal{F}|_{U_p} \otimes_\mathbf{Z} \underline{\mathbf{Z}}(\chi_p)$
...
\begin{lemma}[Vanishing quasi separated]
\label{spaces-cohomology-lemma-vanishing-quasi-separated}
\source{stacks:072C}
\href{https://stacks.math.columbia.edu/tag/072C}{\texttt{Stacks tag 072C}}
\group{spaces-cohomology}
...
Lemma \ref{spaces-cohomology-lemma-alternating-spectral-sequence}, and
...
By Proposition \ref{spaces-cohomology-proposition-vanishing}
and
Lemma \ref{spaces-cohomology-lemma-quasi-coherent-twist}
we see that
$H^q(U_p,
...
\begin{lemma}[Vanishing higher direct images]
\label{spaces-cohomology-lemma-vanishing-higher-direct-images}
\source{stacks:073G}
\href{https://stacks.math.columbia.edu/tag/073G}{\texttt{Stacks tag 073G}}
\group{spaces-cohomology}
...
Lemma \ref{spaces-cohomology-lemma-higher-direct-image}.
...
Lemma \ref{spaces-cohomology-lemma-vanishing-quasi-separated}.
...
\begin{lemma}[Affine vanishing higher direct images]
\label{spaces-cohomology-lemma-affine-vanishing-higher-direct-images}
\source{stacks:073H}
\href{https://stacks.math.columbia.edu/tag/073H}{\texttt{Stacks tag 073H}}
\group{spaces-cohomology}
...
\source{stacks:0D2U}
\href{https://stacks.math.columbia.edu/tag/0D2U}{\texttt{Stacks tag 0D2U}}
\group{spaces-cohomology}
...
\begin{proof}
Follows from Lemma \ref{spaces-cohomology-lemma-affine-vanishing-higher-direct-images}
...
\source{stacks:0A4M}
\href{https://stacks.math.columbia.edu/tag/0A4M}{\texttt{Stacks tag 0A4M}}
\group{spaces-cohomology}
...
Since $i_*$ is exact (Lemma \ref{spaces-cohomology-lemma-finite-higher-direct-image-zero})
...
\source{stacks:0A4N}
\href{https://stacks.math.columbia.edu/tag/0A4N}{\texttt{Stacks tag 0A4N}}
\group{spaces-cohomology}
...
(Lemma \ref{spaces-cohomology-lemma-finite-higher-direct-image-zero}) and transforms
injective abelian sheaves into injective abelian sheaves
(Cohomology on Sites, Lemma
\ref{sites-cohomology-lemma-pushforward-injective-flat}).
\end{proof}

\begin{lemma}[Etale localization sheaf with support]
\label{spaces-cohomology-lemma-etale-localization-sheaf-with-support}
\source{stacks:0A4P}
\href{https://stacks.math.columbia.edu/tag/0A4P}{\texttt{Stacks tag 0A4P}}
\group{spaces-cohomology}
...
\source{stacks:0AEI}
\href{https://stacks.math.columbia.edu/tag/0AEI}{\texttt{Stacks tag 0AEI}}
\group{spaces-cohomology}
...
\begin{lemma}[Vanishing above dimension]
\label{spaces-cohomology-lemma-vanishing-above-dimension}
\source{stacks:0A4R}
\href{https://stacks.math.columbia.edu/tag/0A4R}{\texttt{Stacks tag 0A4R}}
\group{spaces-cohomology}
...
$$
by Lemma \ref{spaces-cohomology-lemma-etale-localization-sheaf-with-support}
...
Lemma \ref{spaces-cohomology-lemma-etale-localization-sheaf-with-support}
...
\vcenter{
\begin{array}{cccc}\mathcal{F}' = (g')^*\mathcal{F} & X' \underset{g'}{\longrightarrow}\underset{f'}{\downarrow} & X \overset{f}{\downarrow} & \mathcal{F} \\ Rf'_*\mathcal{F}' & Y' \overset{g}{\longrightarrow} & Y & Rf_*\mathcal{F}\end{array}
}
\end{equation}
...
\source{stacks:07U8}
\href{https://stacks.math.columbia.edu/tag/07U8}{\texttt{Stacks tag 07U8}}
\group{spaces-cohomology}
...
\source{stacks:073K}
\href{https://stacks.math.columbia.edu/tag/073K}{\texttt{Stacks tag 073K}}
\group{spaces-cohomology}
...
colimits (see
Lemma \ref{spaces-cohomology-lemma-colimits}).
...
\begin{lemma}[Etale pull push split]
\label{spaces-cohomology-lemma-etale-pull-push-split}
\source{stacks:0HAP}
\href{https://stacks.math.columbia.edu/tag/0HAP}{\texttt{Stacks tag 0HAP}}
\group{spaces-cohomology}
...
$$
\begin{array}{cc}X \times_Y X \underset{p}{\longrightarrow}\underset{q}{\downarrow} & X \overset{f}{\downarrow} \\ X \overset{f}{\longrightarrow} & Y\end{array}
$$
By Lemma \ref{spaces-cohomology-lemma-affine-base-change} we have
...
\source{stacks:07UA}
\href{https://stacks.math.columbia.edu/tag/07UA}{\texttt{Stacks tag 07UA}}
\group{spaces-cohomology}
...
\source{stacks:07UB}
\href{https://stacks.math.columbia.edu/tag/07UB}{\texttt{Stacks tag 07UB}}
\group{spaces-cohomology}
...
\source{stacks:07UC}
\href{https://stacks.math.columbia.edu/tag/07UC}{\texttt{Stacks tag 07UC}}
\group{spaces-cohomology}
...
By
Lemma \ref{spaces-cohomology-lemma-coherent-Noetherian} we can check whether an
...
\source{stacks:07UD}
\href{https://stacks.math.columbia.edu/tag/07UD}{\texttt{Stacks tag 07UD}}
\group{spaces-cohomology}
...
\source{stacks:07UE}
\href{https://stacks.math.columbia.edu/tag/07UE}{\texttt{Stacks tag 07UE}}
\group{spaces-cohomology}
...
\begin{proof}
Via Lemma \ref{spaces-cohomology-lemma-coherent-Noetherian} this follows from the result
for schemes, see
...
\source{stacks:07UF}
\href{https://stacks.math.columbia.edu/tag/07UF}{\texttt{Stacks tag 07UF}}
\group{spaces-cohomology}
...
\source{stacks:07UG}
\href{https://stacks.math.columbia.edu/tag/07UG}{\texttt{Stacks tag 07UG}}
\group{spaces-cohomology}
...
Lemma \ref{spaces-cohomology-lemma-coherent-Noetherian}
\end{proof}

\begin{lemma}[I star equivalence]
\label{spaces-cohomology-lemma-i-star-equivalence}
\source{stacks:08AM}
\href{https://stacks.math.columbia.edu/tag/08AM}{\texttt{Stacks tag 08AM}}
\group{spaces-cohomology}
...
we can work \'etale locally (Lemma \ref{spaces-cohomology-lemma-coherent-Noetherian}).
...
\source{stacks:07UH}
\href{https://stacks.math.columbia.edu/tag/07UH}{\texttt{Stacks tag 07UH}}
\group{spaces-cohomology}
...
\source{stacks:07UJ}
\href{https://stacks.math.columbia.edu/tag/07UJ}{\texttt{Stacks tag 07UJ}}
\group{spaces-cohomology}
...
\source{stacks:07UK}
\href{https://stacks.math.columbia.edu/tag/07UK}{\texttt{Stacks tag 07UK}}
\group{spaces-cohomology}
...
\source{stacks:07UL}
\href{https://stacks.math.columbia.edu/tag/07UL}{\texttt{Stacks tag 07UL}}
\group{spaces-cohomology}
...
\source{stacks:07UM}
\href{https://stacks.math.columbia.edu/tag/07UM}{\texttt{Stacks tag 07UM}}
\group{spaces-cohomology}
...
\source{stacks:07UP}
\href{https://stacks.math.columbia.edu/tag/07UP}{\texttt{Stacks tag 07UP}}
\group{spaces-cohomology}
...
Lemma \ref{spaces-cohomology-lemma-power-ideal-kills-sheaf}
...
\source{stacks:07UQ}
\href{https://stacks.math.columbia.edu/tag/07UQ}{\texttt{Stacks tag 07UQ}}
\group{spaces-cohomology}
...
Lemma \ref{spaces-cohomology-lemma-coherent-support-closed}. Hence it suffices to prove the
...
By Lemma \ref{spaces-cohomology-lemma-homs-over-open} there exists an $n \geq 0$ and a
...
\source{stacks:07UR}
\href{https://stacks.math.columbia.edu/tag/07UR}{\texttt{Stacks tag 07UR}}
\group{spaces-cohomology}
...
Then we can apply Lemma \ref{spaces-cohomology-lemma-prepare-filter-support}
...
see Properties of Spaces, Lemma
\ref{spaces-properties-lemma-reduced-closed-subspace}.
By Lemma \ref{spaces-cohomology-lemma-power-ideal-kills-sheaf} we see there exists
...
$\mathcal{F}$ is $T$, see
Morphisms of Spaces, Lemma \ref{spaces-morphisms-lemma-i-star-equivalence}.
Hence we can apply Lemma \ref{spaces-cohomology-lemma-prepare-filter-irreducible}.
...
\source{stacks:07US}
\href{https://stacks.math.columbia.edu/tag/07US}{\texttt{Stacks tag 07US}}
\group{spaces-cohomology}
...
On the other hand, by Lemma \ref{spaces-cohomology-lemma-coherent-filter}
...
\source{stacks:07UT}
\href{https://stacks.math.columbia.edu/tag/07UT}{\texttt{Stacks tag 07UT}}
\group{spaces-cohomology}
...
Morphisms of Spaces, Lemma \ref{spaces-morphisms-lemma-i-star-equivalence}
and Lemma \ref{spaces-cohomology-lemma-coherent-support-closed}.
Let $\mathcal{G}$ be the coherent sheaf on $Z$ satisfying
(3)(a) and (3)(b). We apply Lemma \ref{spaces-cohomology-lemma-prepare-filter-irreducible}
...
(Lemma \ref{spaces-cohomology-lemma-homs-over-open})
a map
$$
...
Lemma \ref{spaces-cohomology-lemma-power-ideal-kills-sheaf}. Thus after increasing
$n$ we may assume the displayed map is injective, see
Lemma \ref{spaces-cohomology-lemma-Artin-Rees}. Applying (3)(b) we find
...
\begin{lemma}[Property higher rank cohomological variant]
\label{spaces-cohomology-lemma-property-higher-rank-cohomological-variant}
\source{stacks:08AN}
\href{https://stacks.math.columbia.edu/tag/08AN}{\texttt{Stacks tag 08AN}}
\group{spaces-cohomology}
...
Lemma \ref{spaces-cohomology-lemma-property-initial} hold. This is clear for condition (1).
...
Lemma \ref{spaces-cohomology-lemma-prepare-filter-irreducible}. Let
$$
0 = \mathcal{F}_0 \subset \mathcal{F}_1 \subset
\ldots \subset \mathcal{F}_m = \Coker(\varphi)
$$
be a filtration as in Lemma \ref{spaces-cohomology-lemma-coherent-filter}. By minimality
...
\source{stacks:07UV}
\href{https://stacks.math.columbia.edu/tag/07UV}{\texttt{Stacks tag 07UV}}
\group{spaces-cohomology}
...
(see Lemmas \ref{spaces-cohomology-lemma-coherent-abelian-Noetherian} and
...
\begin{lemma}[Direct colimit finite presentation]
\label{spaces-cohomology-lemma-direct-colimit-finite-presentation}
\source{stacks:07UW}
\href{https://stacks.math.columbia.edu/tag/07UW}{\texttt{Stacks tag 07UW}}
\group{spaces-cohomology}
...
Lemma \ref{spaces-cohomology-lemma-directed-colimit-coherent}.
By Lemma \ref{spaces-cohomology-lemma-coherent-Noetherian} the modules $\mathcal{H}_i$
...
$$
\begin{array}{cc}\mathcal{G}_j \underset{\alpha}{\longrightarrow}\downarrow & \mathcal{H}_i \downarrow \\ \colim_{j \in J} \mathcal{G}_j \longrightarrow & \colim_{i \in I} \mathcal{H}_i\end{array}
$$
commutes, see
Lemma \ref{spaces-cohomology-lemma-finite-presentation-quasi-compact-colimit}.
...
$$
\begin{array}{cc}\mathcal{G}_j \underset{\alpha}{\longrightarrow}\downarrow & \mathcal{H}_i \downarrow \\ \mathcal{G}_{j'} \overset{\alpha'}{\longrightarrow} & \mathcal{H}_{i'}\end{array}
$$
...
\source{stacks:07UY}
\href{https://stacks.math.columbia.edu/tag/07UY}{\texttt{Stacks tag 07UY}}
\group{spaces-cohomology}
...
\begin{lemma}[Vanishing compute]
\label{spaces-cohomology-lemma-vanishing-compute}
\source{stacks:07UZ}
\href{https://stacks.math.columbia.edu/tag/07UZ}{\texttt{Stacks tag 07UZ}}
\group{spaces-cohomology}

In Situation \ref{spaces-cohomology-situation-vanishing} for an $A$-module $M$ we have
...
\bigoplus_{i \in I} A$ by Lemma \ref{spaces-cohomology-lemma-colimits}. Hence the
...
The following lemma shows that Situation \ref{spaces-cohomology-situation-vanishing}
is preserved by base change of $X \to \Spec(A)$ by $\Spec(A') \to \Spec(A)$.

\begin{lemma}[Vanishing base change]
\label{spaces-cohomology-lemma-vanishing-base-change}
\source{stacks:07V0}
\href{https://stacks.math.columbia.edu/tag/07V0}{\texttt{Stacks tag 07V0}}
\group{spaces-cohomology}

In Situation \ref{spaces-cohomology-situation-vanishing}.
\begin{enumerate}
...
\begin{proof}
Part (1) follows from Lemma \ref{spaces-cohomology-lemma-affine-vanishing-higher-direct-images}
...
by Lemma \ref{spaces-cohomology-lemma-affine-base-change} and thus
$$
\Gamma(X', \mathcal{O}_{X'}) =
\Gamma(X, (X' \to X)_*\mathcal{O}_{X'}) =
\Gamma(X, A' \otimes_A \mathcal{O}_X) = A'
$$
by Lemma \ref{spaces-cohomology-lemma-vanishing-compute}.
\end{proof}

\begin{lemma}[Vanishing separate closed]
\label{spaces-cohomology-lemma-vanishing-separate-closed}
\source{stacks:07V1}
\href{https://stacks.math.columbia.edu/tag/07V1}{\texttt{Stacks tag 07V1}}
\group{spaces-cohomology}

In Situation \ref{spaces-cohomology-situation-vanishing}. Let $Z_0, Z_1 \subset |X|$
...
\begin{lemma}[Vanishing injective]
\label{spaces-cohomology-lemma-vanishing-injective}
\source{stacks:07V4}
\href{https://stacks.math.columbia.edu/tag/07V4}{\texttt{Stacks tag 07V4}}
\group{spaces-cohomology}

In Situation \ref{spaces-cohomology-situation-vanishing} the morphism $p : X \to \Spec(A)$ is
...
Using Lemma \ref{spaces-cohomology-lemma-vanishing-base-change} we may assume that $A$
...
Lemma \ref{spaces-cohomology-lemma-vanishing-separate-closed}. We conclude that
$x = x'$ as desired.
\end{proof}

\begin{lemma}[Vanishing separated]
\label{spaces-cohomology-lemma-vanishing-separated}
\source{stacks:07V5}
\href{https://stacks.math.columbia.edu/tag/07V5}{\texttt{Stacks tag 07V5}}
\group{spaces-cohomology}
...
Lemma \ref{spaces-cohomology-lemma-vanishing-base-change}
...
\begin{proposition}[Serre's criterion for affineness in the setting of algebraic spaces.]
\label{spaces-cohomology-proposition-vanishing-affine}
\source{stacks:07V6}
\href{https://stacks.math.columbia.edu/tag/07V6}{\texttt{Stacks tag 07V6}}
\group{spaces-cohomology}
...
Situation \ref{spaces-cohomology-situation-vanishing} is an affine scheme.
\end{proposition}

\begin{proof}
Choose an affine scheme $U = \Spec(B)$ and a surjective \'etale
morphism $\varphi : U \to X$. Set $R = U \times_X U$. As $p$ is separated
(Lemma \ref{spaces-cohomology-lemma-vanishing-separated}) we see that $R$ is a
...
(by Lemma \ref{spaces-cohomology-lemma-flat-base-change-cohomology})
...
By Lemma \ref{spaces-cohomology-lemma-vanishing-injective}
and
...
\begin{lemma}[Noetherian h1 zero]
\label{spaces-cohomology-lemma-Noetherian-h1-zero}
\source{stacks:0D2V}
\href{https://stacks.math.columbia.edu/tag/0D2V}{\texttt{Stacks tag 0D2V}}
\group{spaces-cohomology}
...
Lemmas \ref{spaces-cohomology-lemma-directed-colimit-coherent} and \ref{spaces-cohomology-lemma-colimits}.
Then $X$ is affine by
Proposition \ref{spaces-cohomology-proposition-vanishing-affine}.
\end{proof}

\begin{lemma}[Noetherian h1 zero invertible]
\label{spaces-cohomology-lemma-Noetherian-h1-zero-invertible}
\source{stacks:0D2W}
\href{https://stacks.math.columbia.edu/tag/0D2W}{\texttt{Stacks tag 0D2W}}
\group{spaces-cohomology}
...
This will prove the claim by Proposition \ref{spaces-cohomology-proposition-vanishing-affine}.
...
$$
by Lemma \ref{spaces-cohomology-lemma-affine-vanishing-higher-direct-images}
...
Lemma \ref{spaces-cohomology-lemma-directed-colimit-coherent}. Then
$$
H^1(X, j_*\mathcal{F}) = \colim H^1(X, \mathcal{F}_i)
$$
by Lemma \ref{spaces-cohomology-lemma-colimits}.
...
commutative diagram
$$
\begin{array}{cc}H^1(X, \mathcal{F}_i) \longrightarrow\underset{s^a}{\downarrow} & H^1(U, j^*\mathcal{F}_i)
\overset{\cong}{\downarrow} \\ H^1(X, \mathcal{F}_i \otimes_{\mathcal{O}_X} \mathcal{L}^{\otimes ad}) \longrightarrow & H^1(U,
j^*(\mathcal{F}_i \otimes_{\mathcal{O}_X} \mathcal{L}^{\otimes ad}))\end{array}
$$
...
\source{stacks:0GF7}
\href{https://stacks.math.columbia.edu/tag/0GF7}{\texttt{Stacks tag 0GF7}}
\group{spaces-cohomology}
...
are of finite type). By Lemma \ref{spaces-cohomology-lemma-finite-pushforward-coherent}
...
\source{stacks:0GF8}
\href{https://stacks.math.columbia.edu/tag/0GF8}{\texttt{Stacks tag 0GF8}}
\group{spaces-cohomology}
...
\source{stacks:07VP}
\href{https://stacks.math.columbia.edu/tag/07VP}{\texttt{Stacks tag 07VP}}
\group{spaces-cohomology}
...
$$
We are going to apply Lemma \ref{spaces-cohomology-lemma-property-higher-rank-cohomological}.
...
and $f' : Z' \to Z$ be as in Lemma \ref{spaces-cohomology-lemma-finite-morphism-Noetherian}
and set $\mathcal{G} = f'_*\mathcal{O}_{Z'}$. We claim that
$\mathcal{G}$ satisfies properties (3)(a) and (3)(b) of
Lemma \ref{spaces-cohomology-lemma-property-higher-rank-cohomological}
which will finish the proof. Property (3)(a) we have seen in
Lemma \ref{spaces-cohomology-lemma-finite-morphism-Noetherian}. To see (3)(b) let
...
By Lemma \ref{spaces-cohomology-lemma-affine-morphism-projection-ideal} we have
...
\begin{lemma}[Weak chow]
\label{spaces-cohomology-lemma-weak-chow}
\source{stacks:089J}
\href{https://stacks.math.columbia.edu/tag/089J}{\texttt{Stacks tag 089J}}
\group{spaces-cohomology}
...
$$
\begin{array}{cc}\Spec(K) \longrightarrow\downarrow & V \downarrow \\ \Spec(R) \longrightarrow & X\end{array}
$$
...
$$
\begin{array}{cc}\Spec(K) \longrightarrow\downarrow & Z \underset{g_i}{\downarrow} \\ \Spec(R) \overset{w}{\longrightarrow} & Y\end{array}
$$
...
\source{stacks:0ARJ}
\href{https://stacks.math.columbia.edu/tag/0ARJ}{\texttt{Stacks tag 0ARJ}}
\group{spaces-cohomology}
...
\begin{lemma}[Check proper dvr]
\label{spaces-cohomology-lemma-check-proper-dvr}
\source{stacks:0ARK}
\href{https://stacks.math.columbia.edu/tag/0ARK}{\texttt{Stacks tag 0ARK}}
\group{spaces-cohomology}
...
Lemma \ref{spaces-cohomology-lemma-check-separated-dvr}.
...
(Lemma \ref{spaces-cohomology-lemma-weak-chow}). We claim that $X' \to \Spec(A)$
...
\source{stacks:0ARL}
\href{https://stacks.math.columbia.edu/tag/0ARL}{\texttt{Stacks tag 0ARL}}
\group{spaces-cohomology}

In Lemmas \ref{spaces-cohomology-lemma-check-separated-dvr} and \ref{spaces-cohomology-lemma-check-proper-dvr}
it suffices to consider complete discrete valuation rings.
To be precise in Lemma \ref{spaces-cohomology-lemma-check-separated-dvr} we can replace
...
any diagram as in Lemma \ref{spaces-cohomology-lemma-check-separated-dvr} (3)
...
Similarly in Lemma \ref{spaces-cohomology-lemma-check-proper-dvr}
...
$$
commute. Namely, given any diagram as in Lemma \ref{spaces-cohomology-lemma-check-proper-dvr}
part (3) the existence of any commutative diagram
$$
\begin{array}{ccc}\Spec(L) \longrightarrow\downarrow & \Spec(K) \longrightarrow & X \downarrow \\ \Spec(B) \longrightarrow\nearrow & \Spec(A) \longrightarrow & Y\end{array}
$$
...
\source{stacks:08AQ}
\href{https://stacks.math.columbia.edu/tag/08AQ}{\texttt{Stacks tag 08AQ}}
\group{spaces-cohomology}

Let $S$ be a scheme. Consider a commutative diagram
$$
\begin{array}{cc}X \underset{i}{\longrightarrow}\underset{f}{\searrow} & \mathbf{P}^n_Y \downarrow \\  & Y\end{array}
$$
...
\begin{lemma}[Proper pushforward coherent]
\label{spaces-cohomology-lemma-proper-pushforward-coherent}
\source{stacks:08AR}
\href{https://stacks.math.columbia.edu/tag/08AR}{\texttt{Stacks tag 08AR}}
\group{spaces-cohomology}
...
\'etale locally on $Y$ (Lemma \ref{spaces-cohomology-lemma-coherent-Noetherian}).
...
Thus Lemma \ref{spaces-cohomology-lemma-property-higher-rank-cohomological-variant}
...
Lemma \ref{spaces-cohomology-lemma-property-higher-rank-cohomological-variant} hold
...
Lemmas \ref{spaces-cohomology-lemma-coherent-abelian-Noetherian} and
\ref{spaces-cohomology-lemma-coherent-Noetherian-quasi-coherent-sub-quotient}.
...
\medskip\noindent
We apply Lemma \ref{spaces-cohomology-lemma-weak-chow} to the morphism $Z \to \Spec(A)$.
Thus we get a diagram
$$
\begin{array}{ccc}Z \underset{g}{\searrow} & Z' \overset{g'}{\downarrow}\overset{\pi}{\longleftarrow}\underset{i}{\longrightarrow} & \mathbf{P}^n_A \swarrow \\  & \Spec(A) & \end{array}
$$
...
$$
We may apply Lemma \ref{spaces-cohomology-lemma-kill-by-twisting}
...
\source{stacks:08AS}
\href{https://stacks.math.columbia.edu/tag/08AS}{\texttt{Stacks tag 08AS}}
\group{spaces-cohomology}
...
\begin{proof}
This is just the affine case of Lemma \ref{spaces-cohomology-lemma-proper-pushforward-coherent}.
Namely, by Lemma \ref{spaces-cohomology-lemma-higher-direct-image} we know that
...
\ref{coherent-lemma-quasi-coherent-affine-cohomology-zero}).
By Lemma \ref{spaces-cohomology-lemma-coherent-Noetherian} we see $R^if_*\mathcal{F}$ is
a coherent sheaf if and only if $H^i(X, \mathcal{F})$
is an $A$-module of finite type. Hence
Lemma \ref{spaces-cohomology-lemma-proper-pushforward-coherent} gives us the conclusion.
\end{proof}

\begin{lemma}[Graded finiteness]
\label{spaces-cohomology-lemma-graded-finiteness}
\source{stacks:08AT}
\href{https://stacks.math.columbia.edu/tag/08AT}{\texttt{Stacks tag 08AT}}
\group{spaces-cohomology}
...
Lemma \ref{spaces-cohomology-lemma-proper-over-affine-cohomology-finite}.
\end{proof}
...
\source{stacks:0GFA}
\href{https://stacks.math.columbia.edu/tag/0GFA}{\texttt{Stacks tag 0GFA}}
\group{spaces-cohomology}
...
Lemma \ref{spaces-cohomology-lemma-Noetherian-h1-zero-invertible}.
\end{proof}

\begin{lemma}[Surjective finite morphism ample]
\label{spaces-cohomology-lemma-surjective-finite-morphism-ample}
\source{stacks:0GFB}
\href{https://stacks.math.columbia.edu/tag/0GFB}{\texttt{Stacks tag 0GFB}}
\group{spaces-cohomology}
...
$\mathcal{L}$ is ample by Lemma \ref{spaces-cohomology-lemma-vanshing-gives-ample}.
We are going to apply Lemma \ref{spaces-cohomology-lemma-property-higher-rank-cohomological}.
...
Lemma \ref{spaces-cohomology-lemma-finite-morphism-Noetherian} and set
...
coherent modules, see Lemmas \ref{spaces-cohomology-lemma-finite-pushforward-coherent} and
\ref{spaces-cohomology-lemma-i-star-equivalence}.
As $Y$ is a scheme and $\mathcal{L}$ is ample
we see from Lemma \ref{spaces-cohomology-lemma-vanshing-gives-ample}
...
and Lemma \ref{spaces-cohomology-lemma-finite-higher-direct-image-zero}.
This verifies property (3)(b) of
Lemma \ref{spaces-cohomology-lemma-property-higher-rank-cohomological} as desired.
\end{proof}
...
\begin{definition}[Situation: Formal functions]
\label{spaces-cohomology-situation-formal-functions}
\source{stacks:08AV}
\href{https://stacks.math.columbia.edu/tag/08AV}{\texttt{Stacks tag 08AV}}
\group{spaces-cohomology}
...
\source{stacks:08AW}
\href{https://stacks.math.columbia.edu/tag/08AW}{\texttt{Stacks tag 08AW}}
\group{spaces-cohomology}

In Situation \ref{spaces-cohomology-situation-formal-functions}.
...
from Lemma \ref{spaces-cohomology-lemma-graded-finiteness}.
\end{proof}

\begin{lemma}[Cohomology powers ideal application]
\label{spaces-cohomology-lemma-cohomology-powers-ideal-application}
\source{stacks:08AX}
\href{https://stacks.math.columbia.edu/tag/08AX}{\texttt{Stacks tag 08AX}}
\group{spaces-cohomology}
...
\begin{proof}
By Lemma \ref{spaces-cohomology-lemma-cohomology-powers-ideal-times-F}
...
$$
\begin{array}{ccc}I^{n + m - c - b} \otimes I^b \otimes
H^p(X, I^c\mathcal{F}) \longrightarrow\downarrow & I^{n + m - c} \otimes H^p(X, I^c\mathcal{F}) \longrightarrow & H^p(X, I^{n + m}\mathcal{F}) \downarrow \\ I^{n + m - c - b} \otimes H^p(X, I^n\mathcal{F}) \longrightarrow &  & H^p(X, I^n\mathcal{F})\end{array}
$$
...
\source{stacks:08AY}
\href{https://stacks.math.columbia.edu/tag/08AY}{\texttt{Stacks tag 08AY}}
\group{spaces-cohomology}
...
found in Lemma \ref{spaces-cohomology-lemma-cohomology-powers-ideal-application} for
...
$$
\begin{array}{cccc}H^p(X, I^n\mathcal{F}) \longrightarrow & H^p(X, \mathcal{F}) \longrightarrow & H^p(X, \mathcal{F}/I^n\mathcal{F}) \underset{\delta}{\longrightarrow} & H^{p + 1}(X, I^n\mathcal{F}) \\ H^p(X, I^{n + m}\mathcal{F}) \longrightarrow\uparrow & H^p(X, \mathcal{F}) \longrightarrow\overset{1}{\uparrow} & H^p(X, \mathcal{F}/I^{n + m}\mathcal{F}) \longrightarrow\uparrow & H^{p + 1}(X, I^{n + m}\mathcal{F}) \overset{a}{\uparrow}\end{array}
$$
...
\source{stacks:08AZ}
\href{https://stacks.math.columbia.edu/tag/08AZ}{\texttt{Stacks tag 08AZ}}
\group{spaces-cohomology}

In Situation \ref{spaces-cohomology-situation-formal-functions}. Fix $p \geq 0$.
The system of maps
$$
...
Lemma \ref{spaces-cohomology-lemma-ML-cohomology-powers-ideal}. We spell out the details.
...
By Lemma \ref{spaces-cohomology-lemma-ML-cohomology-powers-ideal} part (3)
we have $x_n \in N_n$ for all $n$ since by
definition $x_n$ is the image of some $x_{n + m} \in M_{n + m}$ for
all $m$. By Lemma \ref{spaces-cohomology-lemma-ML-cohomology-powers-ideal} part (1)
...
\source{stacks:08B0}
\href{https://stacks.math.columbia.edu/tag/08B0}{\texttt{Stacks tag 08B0}}
\group{spaces-cohomology}
...
(Theorem \ref{spaces-cohomology-theorem-formal-functions}) in the
case of a complete Noetherian base ring. Namely, in this case the
$A$-module $H^p(X, \mathcal{F})$ is finite
(Lemma \ref{spaces-cohomology-lemma-proper-over-affine-cohomology-finite}) hence
...
\source{stacks:08B1}
\href{https://stacks.math.columbia.edu/tag/08B1}{\texttt{Stacks tag 08B1}}
\group{spaces-cohomology}
...
\underset{i_n}{\longrightarrow}\underset{f_n}{\downarrow} & X \overset{f}{\downarrow} \\ \Spec(\mathcal{O}_{Y, \overline{y}}/\mathfrak m_{\overline{y}}^n)
\overset{c_n}{\longrightarrow} & Y\end{array}
$$
...
on formal functions, Theorem \ref{spaces-cohomology-theorem-formal-functions}.
...
for $i_n$, and Lemma \ref{spaces-cohomology-lemma-finite-pushforward-coherent} we see that
$$
...
\source{stacks:0A4S}
\href{https://stacks.math.columbia.edu/tag/0A4S}{\texttt{Stacks tag 0A4S}}
\group{spaces-cohomology}
...
Lemma \ref{spaces-cohomology-lemma-formal-functions-stalk}
...
By Lemma \ref{spaces-cohomology-lemma-image-affine-finite-morphism-affine-Noetherian}
...
by Lemma \ref{spaces-cohomology-lemma-formal-functions-stalk}.
Note that $R^pf_*\mathcal{F}$ is coherent by
Lemma \ref{spaces-cohomology-lemma-proper-pushforward-coherent} and
...
\begin{lemma}[For proper maps, stalks of higher direct images are trivial in degrees larger than the ...]
\label{spaces-cohomology-lemma-higher-direct-images-zero-above-dimension-fibre}
\source{stacks:0A4T}
\href{https://stacks.math.columbia.edu/tag/0A4T}{\texttt{Stacks tag 0A4T}}
\group{spaces-cohomology}
...
Lemma \ref{spaces-cohomology-lemma-vanishing-above-dimension}.
Hence we see that $(R^pf_*\mathcal{F})_{\overline{y}}^\wedge = 0$
by Lemma \ref{spaces-cohomology-lemma-formal-functions-stalk} for $p > d$.
Note that $R^pf_*\mathcal{F}$ is coherent by
Lemma \ref{spaces-cohomology-lemma-proper-pushforward-coherent} and
hence $R^pf_*\mathcal{F}_{\overline{y}}$ is a finite
$\mathcal{O}_{Y, \overline{y}}$-module.
...
\source{stacks:0A4V}
\href{https://stacks.math.columbia.edu/tag/0A4V}{\texttt{Stacks tag 0A4V}}
\group{spaces-cohomology}
...
Lemmas \ref{spaces-cohomology-lemma-directed-colimit-coherent} and \ref{spaces-cohomology-lemma-colimits}.
Then it follows that $X$ is affine from
Proposition \ref{spaces-cohomology-proposition-vanishing-affine}. By
Lemma \ref{spaces-cohomology-lemma-higher-direct-images-zero-finite-fibre}
...
\source{stacks:0A4W}
\href{https://stacks.math.columbia.edu/tag/0A4W}{\texttt{Stacks tag 0A4W}}
\group{spaces-cohomology}
...
Thus $f^{-1}(V) \to V$
is finite by Lemma \ref{spaces-cohomology-lemma-characterize-finite}.
\end{proof}
