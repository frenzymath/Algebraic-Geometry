...
\begin{lemma}[Section support in locally closed pre]
\label{more-etale-lemma-section-support-in-locally-closed-pre}
\source{stacks:0F6F}
\href{https://stacks.math.columbia.edu/tag/0F6F}{\texttt{Stacks tag 0F6F}}
\group{more-etale}
...
\begin{lemma}[Section support in locally closed]
\label{more-etale-lemma-section-support-in-locally-closed}
\source{stacks:0F6G}
\href{https://stacks.math.columbia.edu/tag/0F6G}{\texttt{Stacks tag 0F6G}}
\group{more-etale}
...
of Lemma \ref{more-etale-lemma-section-support-in-locally-closed-pre}.
\end{proof}

Let us introduce a bit of nonstandard notation which will stand us
in good stead later. Namely, in the situation of
Lemma \ref{more-etale-lemma-section-support-in-locally-closed} above, let us denote
$$
...
Lemma \ref{more-etale-lemma-section-support-in-locally-closed-pre}
...
\begin{lemma}[F shriek separated]
\label{more-etale-lemma-f-shriek-separated}
\source{stacks:0F4X}
\href{https://stacks.math.columbia.edu/tag/0F4X}{\texttt{Stacks tag 0F4X}}
\group{more-etale}
...
\begin{lemma}[Separated etale shriek]
\label{more-etale-lemma-separated-etale-shriek}
\source{stacks:0F4Y}
\href{https://stacks.math.columbia.edu/tag/0F4Y}{\texttt{Stacks tag 0F4Y}}
\group{more-etale}
...
is the subsheaf of Lemma \ref{more-etale-lemma-f-shriek-separated}.
\end{lemma}
...
Lemma \ref{more-etale-lemma-f-shriek-separated}.
...
\begin{definition}[F shriek separated]
\label{more-etale-definition-f-shriek-separated}
\source{stacks:0F4Z}
\href{https://stacks.math.columbia.edu/tag/0F4Z}{\texttt{Stacks tag 0F4Z}}
\group{more-etale}

Let $f : X \to Y$ be a morphism of schemes which is separated (!) and
locally of finite type. Let $\mathcal{F}$ be an abelian sheaf on
$X_\etale$. The subsheaf $f_!\mathcal{F} \subset f_*\mathcal{F}$
constructed in Lemma \ref{more-etale-lemma-f-shriek-separated} is called the
{\it direct image with compact support}.
\end{definition}

By Lemma \ref{more-etale-lemma-separated-etale-shriek} this does not conflict with
...
\begin{lemma}[Proper f shriek]
\label{more-etale-lemma-proper-f-shriek}
\source{stacks:0F51}
\href{https://stacks.math.columbia.edu/tag/0F51}{\texttt{Stacks tag 0F51}}
\group{more-etale}
...
\source{stacks:0F53}
\href{https://stacks.math.columbia.edu/tag/0F53}{\texttt{Stacks tag 0F53}}
\group{more-etale}
...
Lemma \ref{more-etale-lemma-section-support-in-locally-closed}. This construction is
...
$$
\begin{array}{cc}f'_!(\mathcal{F}|_{X'}) \longrightarrow\downarrow & f_!\mathcal{F} \downarrow \\ f'_*(\mathcal{F}|_{X'}) & f_*\mathcal{F} \longleftarrow\end{array}
$$
...
\begin{lemma}[Compactify f shriek separated]
\label{more-etale-lemma-compactify-f-shriek-separated}
\source{stacks:0F52}
\href{https://stacks.math.columbia.edu/tag/0F52}{\texttt{Stacks tag 0F52}}
\group{more-etale}
...
Lemma \ref{more-etale-lemma-proper-f-shriek} we obtain
...
of Remark \ref{more-etale-remark-covariance-f-shriek-separated}
...
\source{stacks:0F72}
\href{https://stacks.math.columbia.edu/tag/0F72}{\texttt{Stacks tag 0F72}}
\group{more-etale}
...
\begin{lemma}[Proper compact support]
\label{more-etale-lemma-proper-compact-support}
\source{stacks:0F73}
\href{https://stacks.math.columbia.edu/tag/0F73}{\texttt{Stacks tag 0F73}}
\group{more-etale}
...
\source{stacks:0F74}
\href{https://stacks.math.columbia.edu/tag/0F74}{\texttt{Stacks tag 0F74}}
\group{more-etale}

Let $X$ be a separated scheme locally of finite type over a field $k$.
Let $\mathcal{F}$ be an abelian sheaf on $X_\etale$.
Exactly as in Remark \ref{more-etale-remark-covariance-f-shriek-separated}
...
\begin{lemma}[Compactify compact support]
\label{more-etale-lemma-compactify-compact-support}
\source{stacks:0F75}
\href{https://stacks.math.columbia.edu/tag/0F75}{\texttt{Stacks tag 0F75}}
\group{more-etale}
...
Lemma \ref{more-etale-lemma-proper-compact-support}.
\end{lemma}
...
of Remark \ref{more-etale-remark-covariance-compact-support}
for $\mathcal{G} = j_!\mathcal{F}$. The explicit nature
...
\begin{lemma}[Stalk f shriek separated]
\label{more-etale-lemma-stalk-f-shriek-separated}
\source{stacks:0F76}
\href{https://stacks.math.columbia.edu/tag/0F76}{\texttt{Stacks tag 0F76}}
\group{more-etale}
...
$$
\begin{array}{cc}(f'_!(\mathcal{F}|_{X'}))_{\overline{y}} \longrightarrow\downarrow & H^0_c(X'_{\overline{y}}, \mathcal{F}|_{X'_{\overline{y}}}) \downarrow \\ (f_!\mathcal{F})_{\overline{y}} \longrightarrow & H^0_c(X_{\overline{y}}, \mathcal{F}|_{X_{\overline{y}}})\end{array}
$$
where the horizontal arrows are the maps constructed above and
the vertical arrows are given in
Remarks \ref{more-etale-remark-covariance-f-shriek-separated} and
...
$$
\begin{array}{cc}(f_!\mathcal{F})_{\overline{y}} \longrightarrow\downarrow & H^0_c(X_{\overline{y}}, \mathcal{F}|_{X_{\overline{y}}}) \downarrow \\ (\overline{f}_!\mathcal{G})_{\overline{y}} \longrightarrow & H^0_c(\overline{X}_{\overline{y}}, \mathcal{G}|_{\overline{X}_{\overline{y}}})\end{array}
$$
By Lemmas \ref{more-etale-lemma-compactify-f-shriek-separated} and
\ref{more-etale-lemma-compactify-compact-support} the vertical maps
are isomorphisms. This reduces us to the case of the proper
morphism $\overline{X} \to Y$. For a proper morphism our map
is an isomorphism by
Lemmas \ref{more-etale-lemma-proper-f-shriek} and \ref{more-etale-lemma-proper-compact-support}
and proper base change for pushforwards, see
\'Etale Cohomology, Lemma
\ref{etale-cohomology-lemma-proper-pushforward-stalk}.
\end{proof}

\begin{lemma}[Base change f shriek separated]
\label{more-etale-lemma-base-change-f-shriek-separated}
\source{stacks:0F55}
\href{https://stacks.math.columbia.edu/tag/0F55}{\texttt{Stacks tag 0F55}}
\group{more-etale}
...
commutative diagram
$$
\begin{array}{cc}(f_*\mathcal{F})_{\overline{y}} \longrightarrow\downarrow & H^0(X_{\overline{y}}, \mathcal{F}|_{X_{\overline{y}}}) \downarrow \\ (f'_*(g')^{-1}\mathcal{F})_{\overline{y}'} \longrightarrow & H^0(X'_{\overline{y}'}, (g')^{-1}\mathcal{F}|_{X'_{\overline{y}'}})\end{array}
$$
where the horizontal maps were used in the proof of
Lemma \ref{more-etale-lemma-stalk-f-shriek-separated}
...
Hence by Lemma \ref{more-etale-lemma-stalk-f-shriek-separated}
and its proof we obtain a commutative diagram
$$
\begin{array}{cccc}(f_*\mathcal{F})_{\overline{y}} \longrightarrow\downarrow &  &  & H^0(X_{\overline{y}}, \mathcal{F}|_{X_{\overline{y}}}) \downarrow \\  & (f_!\mathcal{F})_{\overline{y}} \longrightarrow\downarrow\nwarrow & H^0_c(X_{\overline{y}}, \mathcal{F}|_{X_{\overline{y}}}) \downarrow\nearrow &  \\  & (f'_!(g')^{-1}\mathcal{F})_{\overline{y}'} \longrightarrow\swarrow & H^0_c(X'_{\overline{y}'}, (g')^{-1}\mathcal{F}|_{X'_{\overline{y}'}}) \searrow &  \\ (f'_*(g')^{-1}\mathcal{F})_{\overline{y}'} \longrightarrow &  &  & H^0(X'_{\overline{y}'}, (g')^{-1}\mathcal{F}|_{X'_{\overline{y}'}})\end{array}
$$
...
\begin{lemma}[F shriek composition]
\label{more-etale-lemma-f-shriek-composition}
\source{stacks:0F50}
\href{https://stacks.math.columbia.edu/tag/0F50}{\texttt{Stacks tag 0F50}}
\group{more-etale}
...
\begin{remark}[F shriek base change composition]
\label{more-etale-remark-f-shriek-base-change-composition}
\source{stacks:0F77}
\href{https://stacks.math.columbia.edu/tag/0F77}{\texttt{Stacks tag 0F77}}
\group{more-etale}
...
Then the diagram
$$
\begin{array}{cc}(h \circ g \circ f)_! \longrightarrow\downarrow & (h \circ g)_! \circ f_! \downarrow \\ h_! \circ (g \circ f)_! \longrightarrow & h_! \circ g_! \circ f_!\end{array}
$$
commutes where the arrows are those of Lemma \ref{more-etale-lemma-f-shriek-composition}.
\item Suppose that we have a diagram of schemes
$$
\begin{array}{cc}X' \underset{f'}{\downarrow}\underset{c}{\longrightarrow} & X \overset{f}{\downarrow} \\ Y' \underset{g'}{\downarrow}\underset{b}{\longrightarrow} & Y \overset{g}{\downarrow} \\ Z' \overset{a}{\longrightarrow} & Z\end{array}
$$
with both squares cartesian and $f$ and $g$ separated and
locally of finite type. Then the diagram
$$
\begin{array}{ccc}a^{-1} \circ (g \circ f)_! \downarrow\longrightarrow &  & (g' \circ f')_! \circ c^{-1} \downarrow \\ a^{-1} \circ g_! \circ f_! \longrightarrow & g'_! \circ b^{-1} \circ f_! \longrightarrow & g'_! \circ f'_! \circ c^{-1}\end{array}
$$
commutes where the horizontal arrows are those of
Lemma \ref{more-etale-lemma-base-change-f-shriek-separated}
the arrows are those of Lemma \ref{more-etale-lemma-f-shriek-composition}.
\end{enumerate}
...
Lemmas \ref{more-etale-lemma-base-change-f-shriek-separated} and
\ref{more-etale-lemma-f-shriek-composition}
are constructed using the corresponding maps of pushforwards.
\end{remark}

\begin{lemma}[Colim f shriek separated]
\label{more-etale-lemma-colim-f-shriek-separated}
\source{stacks:0F54}
\href{https://stacks.math.columbia.edu/tag/0F54}{\texttt{Stacks tag 0F54}}
\group{more-etale}
...
Remark \ref{more-etale-remark-covariance-f-shriek-separated}.
\end{lemma}
...
\begin{lemma}[F shriek separated direct sums]
\label{more-etale-lemma-f-shriek-separated-direct-sums}
\source{stacks:0F56}
\href{https://stacks.math.columbia.edu/tag/0F56}{\texttt{Stacks tag 0F56}}
\group{more-etale}
...
and using Lemma \ref{more-etale-lemma-colim-f-shriek-separated}
...
\begin{lemma}[Lqf f shriek separated colimits]
\label{more-etale-lemma-lqf-f-shriek-separated-colimits}
\source{stacks:0F57}
\href{https://stacks.math.columbia.edu/tag/0F57}{\texttt{Stacks tag 0F57}}
\group{more-etale}
...
Section \ref{more-etale-section-compact-support} to not necessarily
...
Section \ref{more-etale-section-growing}, we set
$$
H_{Z_i}(\mathcal{F}) =
...
the construction in Section \ref{more-etale-section-compact-support}
and with the construction in
\'Etale Cohomology, Section \ref{etale-cohomology-section-extension-by-zero}
when both apply.

\begin{lemma}[Finite support f shriek separated]
\label{more-etale-lemma-finite-support-f-shriek-separated}
\source{stacks:0F6N}
\href{https://stacks.math.columbia.edu/tag/0F6N}{\texttt{Stacks tag 0F6N}}
\group{more-etale}
...
$f_!\mathcal{F}$ of Definition \ref{more-etale-definition-f-shriek-separated}
...
\begin{lemma}[Finite support stalk]
\label{more-etale-lemma-finite-support-stalk}
\source{stacks:0F6P}
\href{https://stacks.math.columbia.edu/tag/0F6P}{\texttt{Stacks tag 0F6P}}
\group{more-etale}
...
\begin{lemma}[Finite support etale shriek]
\label{more-etale-lemma-finite-support-etale-shriek}
\source{stacks:0F6Q}
\href{https://stacks.math.columbia.edu/tag/0F6Q}{\texttt{Stacks tag 0F6Q}}
\group{more-etale}
...
$$
\begin{array}{cc}(j_{p!}\mathcal{F})_{\overline{y}} \longrightarrow\downarrow & \bigoplus_{j(\overline{x}) = \overline{y}} \mathcal{F}_{\overline{x}}
\downarrow \\ (f_{p!}\mathcal{F})_{\overline{y}} \longrightarrow & \bigoplus_{f(\overline{x}) = \overline{y}} \mathcal{F}_{\overline{x}}\end{array}
$$
...
Lemma \ref{more-etale-lemma-finite-support-stalk},
...
\begin{definition}[F shriek lqf]
\label{more-etale-definition-f-shriek-lqf}
\source{stacks:0F6R}
\href{https://stacks.math.columbia.edu/tag/0F6R}{\texttt{Stacks tag 0F6R}}
\group{more-etale}
...
By Lemma \ref{more-etale-lemma-finite-support-f-shriek-separated}
this does not conflict with Definition \ref{more-etale-definition-f-shriek-separated}
(when both definitions apply) and by
Lemma \ref{more-etale-lemma-finite-support-etale-shriek}
this does not conflict with
\'Etale Cohomology, Definition \ref{etale-cohomology-definition-extension-zero}
(when both definitions apply).

\begin{lemma}[Lqf f shriek stalk]
\label{more-etale-lemma-lqf-f-shriek-stalk}
\source{stacks:0F5F}
\href{https://stacks.math.columbia.edu/tag/0F5F}{\texttt{Stacks tag 0F5F}}
\group{more-etale}
...
\source{stacks:0F6S}
\href{https://stacks.math.columbia.edu/tag/0F6S}{\texttt{Stacks tag 0F6S}}
\group{more-etale}
...
\ref{more-etale-lemma-finite-support-stalk} and \ref{more-etale-lemma-lqf-f-shriek-stalk}.
\item If $f$ is separated, then the map
$f'_{p!}\mathcal{F}' \to f_{p!}\mathcal{F}$ is the same as the map
constructed in Remark \ref{more-etale-remark-covariance-f-shriek-separated}
via the isomorphism in Lemma \ref{more-etale-lemma-finite-support-f-shriek-separated}.
...
\begin{lemma}[Lqf colimit f shriek]
\label{more-etale-lemma-lqf-colimit-f-shriek}
\source{stacks:0F5H}
\href{https://stacks.math.columbia.edu/tag/0F5H}{\texttt{Stacks tag 0F5H}}
\group{more-etale}
...
constructed in Remark \ref{more-etale-remark-covariance-lqf-f-shriek}
with sign rules as in the {\v C}ech complex.
Exactness follows easily from the description of stalks in
Lemma \ref{more-etale-lemma-lqf-f-shriek-stalk}. Details omitted.
\end{proof}
...
\source{stacks:0F5I}
\href{https://stacks.math.columbia.edu/tag/0F5I}{\texttt{Stacks tag 0F5I}}
\group{more-etale}

Lemma \ref{more-etale-lemma-lqf-colimit-f-shriek}
...
$f_{i_0i_1, !}$ in Section \ref{more-etale-section-compact-support}
because the morphisms $f_{i_0}$ and $f_{i_0 i_1}$ are separated.
One can then compute the stalks of $f_!$ (using the separated
case, namely Lemma \ref{more-etale-lemma-lqf-f-shriek-separated-colimits})
and obtain the result of Lemma \ref{more-etale-lemma-lqf-f-shriek-stalk}.
Having done so all the other results of this section can be
deduced from this as well.
\end{remark}

\begin{remark}[Construct map presheaves downstairs]
\label{more-etale-remark-construct-map-presheaves-downstairs}
\source{stacks:0F78}
\href{https://stacks.math.columbia.edu/tag/0F78}{\texttt{Stacks tag 0F78}}
\group{more-etale}
...
$$
\begin{array}{cc}\mathcal{G} \downarrow\underset{\alpha}{\longrightarrow} & g_*\mathcal{G}' \downarrow \\ \mathcal{G}^\# \overset{\alpha^\#}{\longrightarrow} & g_*((\mathcal{G}')^\#)\end{array}
$$
...
\begin{lemma}[Lqf base change f shriek]
\label{more-etale-lemma-lqf-base-change-f-shriek}
\source{stacks:0F5J}
\href{https://stacks.math.columbia.edu/tag/0F5J}{\texttt{Stacks tag 0F5J}}
\group{more-etale}
...
the descriptions of stalks given in Lemma \ref{more-etale-lemma-lqf-f-shriek-stalk}
(see proof for the precise statement).
\end{lemma}

\begin{proof}
With conventions as in Remark \ref{more-etale-remark-construct-map-presheaves-downstairs}
...
Remark \ref{more-etale-remark-construct-map-presheaves-downstairs}
...
$$
\begin{array}{ccc}(g^{-1}f_!\mathcal{F})_{\overline{y}'} \xlongequal{}\downarrow & (f_!\mathcal{F})_{\overline{y}} \longrightarrow\swarrow & \bigoplus\nolimits_{f(\overline{x}) = \overline{y}}
\mathcal{F}_{\overline{x}} \downarrow \\ (f'_!(g')^{-1}\mathcal{F})_{\overline{y}'} \longrightarrow &  & \bigoplus\nolimits_{f'(\overline{x}') = \overline{y}'}
(g')^{-1}\mathcal{F}_{\overline{x}'}\end{array}
$$
commutes where the horizontal arrows are given in the proof of
Lemma \ref{more-etale-lemma-finite-support-stalk} and where the right vertical
arrow is an equality by what we just said above. The southwest arrow is
described in Remark \ref{more-etale-remark-construct-map-presheaves-downstairs}
...
Lemma \ref{more-etale-lemma-finite-support-stalk} immediately shows the
diagram commutes. This finishes the proof of the lemma.
\end{proof}

\begin{lemma}[Lqf separated shriek composition]
\label{more-etale-lemma-lqf-separated-shriek-composition}
\source{stacks:0F79}
\href{https://stacks.math.columbia.edu/tag/0F79}{\texttt{Stacks tag 0F79}}
\group{more-etale}
...
Lemmas \ref{more-etale-lemma-lqf-base-change-f-shriek}
and \ref{more-etale-lemma-base-change-f-shriek-separated}, and
\item[(c)] equal to the isomorphism of Lemma \ref{more-etale-lemma-f-shriek-composition}
via the identifications of Lemma \ref{more-etale-lemma-finite-support-f-shriek-separated}
...
Remark \ref{more-etale-remark-construct-map-presheaves-downstairs} we will explicitly
construct a map
$$
...
$$
\begin{array}{cc}X_1 \underset{f'_1}{\downarrow}\underset{a}{\longrightarrow}\underset{f_1}{\downarrow} & X \overset{f'}{\downarrow}\overset{f}{\downarrow} \\ Y'_1 \underset{g_1}{\downarrow}\underset{b'}{\longrightarrow} & Y' \overset{g}{\downarrow} \\ Y \xlongequal{} & Y\end{array}
$$
where the horizontal arrows are open immersions. Then our claim is that
the diagram
$$
\begin{array}{ccc}f_{1, !}\mathcal{F}|_{X_1} \underset{c'_1}{\longrightarrow}\downarrow & g_{1, !}f'_{1, !}\mathcal{F}|_{X_1} \downarrow &  \\  & g_{1, !}(f'_!\mathcal{F})|_{Y'_1} \downarrow &  \\ f_!\mathcal{F} \overset{c'}{\longrightarrow} & g_!f'_!\mathcal{F} \longrightarrow & g_*f'_!\mathcal{F}\end{array}
$$
commutes where the left vertical arrow is
Remark \ref{more-etale-remark-covariance-lqf-f-shriek} and
the right vertical arrow is Remark \ref{more-etale-remark-covariance-f-shriek-separated}.
...
commutative diagram
$$
\begin{array}{cc}X_1 \underset{f'_1}{\downarrow}\underset{a}{\longrightarrow}\underset{f_1}{\downarrow} & X \overset{f'}{\downarrow}\overset{f}{\downarrow} \\ Y'_1 \underset{g_1}{\downarrow}\underset{b'}{\longrightarrow} & Y' \overset{g}{\downarrow} \\ Y_1 \overset{b}{\longrightarrow} & Y\end{array}
$$
with cartesian squares. We claim that our construction is compatible
with the base change maps of Lemmas \ref{more-etale-lemma-lqf-base-change-f-shriek}
and \ref{more-etale-lemma-base-change-f-shriek-separated}, i.e.,
that the top rectangle of the diagram
$$
\begin{array}{ccc}b^{-1}f_!\mathcal{F} \longrightarrow\underset{b^{-1}c'}{\downarrow} &  & f_{1, !}a^{-1}\mathcal{F} \overset{c_1'}{\downarrow} \\ b^{-1}g_!f'_!\mathcal{F} \longrightarrow\downarrow & g_{1, !}(b')^{-1}f'_!\mathcal{F} \longrightarrow\downarrow & g_{1, !}f'_{1, !}a^{-1}\mathcal{F} \downarrow \\ b^{-1}g_*f'_!\mathcal{F} \longrightarrow & g_{1, *}(b')^{-1}f'_!\mathcal{F} \longrightarrow & g_{1, *}f'_{1, !}a^{-1}\mathcal{F}\end{array}
$$
...
Lemmas \ref{more-etale-lemma-lqf-f-shriek-stalk} and
...
image $y'$ of $x$ in $Y$ by Lemma \ref{more-etale-lemma-lqf-f-shriek-stalk}.
In this case it is obvious that our construction
produces the identity map $A \to H^0_c(Y', y'_*A) = A$
as desired.
\end{proof}

\begin{lemma}[Lqf shriek composition]
\label{more-etale-lemma-lqf-shriek-composition}
\source{stacks:0F6T}
\href{https://stacks.math.columbia.edu/tag/0F6T}{\texttt{Stacks tag 0F6T}}
\group{more-etale}
...
with Lemma \ref{more-etale-lemma-f-shriek-composition}.
\item If $g$ is separated, then the isomorphism agrees with
Lemma \ref{more-etale-lemma-lqf-separated-shriek-composition}.
\item For a geometric point $\overline{z} : \Spec(k) \to Z$ the diagram
$$
\begin{array}{ccc}((g \circ f)_!\mathcal{F})_{\overline{z}} \downarrow\longrightarrow &  & \bigoplus\nolimits_{g(f(\overline{x})) = \overline{z}}
\mathcal{F}_{\overline{x}} \downarrow \\ (g_!f_!\mathcal{F})_{\overline{z}} \longrightarrow & \bigoplus\nolimits_{g(\overline{y}) = \overline{z}}
(f_!\mathcal{F})_{\overline{y}} \longrightarrow & \bigoplus\nolimits_{g(f(\overline{x})) = \overline{z}}
\mathcal{F}_{\overline{x}}\end{array}
$$
is commutative where the horizontal arrows are given by
Lemma \ref{more-etale-lemma-lqf-f-shriek-stalk}.
...
$$
commutes where the horizontal arrows are those of
Lemma \ref{more-etale-lemma-lqf-base-change-f-shriek}.
\end{enumerate}
\end{lemma}
...
$$
\begin{array}{cccc}\bigoplus\nolimits_{i_0, i_1}
h_{i_0i_1, !}\mathcal{F}|_{X_{i_0i_1}} \longrightarrow\downarrow & \bigoplus\nolimits_{i_0} h_{i_0, !}\mathcal{F}|_{X_{i_0}} \longrightarrow\downarrow & h_!\mathcal{F} \longrightarrow\downarrow & 0 \\ \bigoplus\nolimits_{i_0, i_1}
g_{i_0i_1, !} f_{i_0i_1, !}\mathcal{F}|_{X_{i_0i_1}} \longrightarrow\downarrow & \bigoplus\nolimits_{i_0}
g_{i_0, !} f_{i_0, !}\mathcal{F}|_{X_{i_0}} \downarrow &  &  \\ \bigoplus\nolimits_{i_0, i_1}
g_{i_0i_1, !} (f_!\mathcal{F})|_{Y_{i_0i_1}} \longrightarrow & \bigoplus\nolimits_{i_0}
g_{i_0, !} (f_!\mathcal{F})|_{Y_{i_0}} \longrightarrow & g_!f_!\mathcal{F} \longrightarrow & 0\end{array}
$$
By Lemma \ref{more-etale-lemma-lqf-colimit-f-shriek} the top and bottom row
in the diagram are exact. By Lemma \ref{more-etale-lemma-lqf-separated-shriek-composition}
...
maps of Lemma \ref{more-etale-lemma-lqf-separated-shriek-composition}
and Lemma \ref{more-etale-lemma-f-shriek-composition}.
...
constructed in Lemma \ref{more-etale-lemma-lqf-separated-shriek-composition}.
...
Lemma \ref{more-etale-lemma-lqf-f-shriek-stalk} combined with
\'Etale Cohomology, Lemma \ref{etale-cohomology-lemma-stalk-pullback}.
...
Example \ref{more-etale-example-trace-for-flat-quasi-finite}.
...
Example \ref{more-etale-example-trace-for-quasi-finite-over-normal}.

\begin{lemma}[F shriek projection]
\label{more-etale-lemma-f-shriek-projection}
\source{stacks:0GKF}
\href{https://stacks.math.columbia.edu/tag/0GKF}{\texttt{Stacks tag 0GKF}}
\group{more-etale}
...
by Definition \ref{more-etale-definition-f-shriek-lqf} where
$f_{p!}\mathcal{F}$ is the presheaf
constructed in Section \ref{more-etale-section-finite-support}.
...
$$
See Section \ref{more-etale-section-finite-support}. Our map will be defined
...
stalks of $f_!$ in Lemma \ref{more-etale-lemma-lqf-f-shriek-stalk}.
In other words, the map $can$ we've produced on stalks at a geometric
point $\overline{y}$ fits into a commutative diagram
$$
\begin{array}{cc}(f_!\mathcal{F} \otimes_\Lambda \mathcal{G})_{\overline{y}}
\underset{can_{\overline{y}}}{\longrightarrow}\downarrow & f_!(\mathcal{F} \otimes_\Lambda f^{-1}\mathcal{G})_{\overline{y}} \downarrow \\ (\bigoplus \mathcal{F}_{\overline{x}})
\otimes_\Lambda \mathcal{G}_{\overline{y}} \longrightarrow & \bigoplus
(\mathcal{F}_{\overline{x}} \otimes_\Lambda \mathcal{G}_{\overline{y}})\end{array}
$$
...
of Lemma \ref{more-etale-lemma-lqf-f-shriek-stalk}, and where the lower horizontal arrow
is the obvious isomorphism.
We conclude that $can$ is an isomorphism as desired.
\end{proof}

\begin{lemma}[Trace map exists]
\label{more-etale-lemma-trace-map-exists}
\source{stacks:0GKG}
\href{https://stacks.math.columbia.edu/tag/0GKG}{\texttt{Stacks tag 0GKG}}
\group{more-etale}
...
\begin{proof}
By Lemma \ref{more-etale-lemma-f-shriek-projection} we have an identification
...
Definition \ref{more-etale-definition-f-shriek-lqf} we have
...
Recall from Section \ref{more-etale-section-finite-support} that
$$
...
(see proof of Lemma \ref{more-etale-lemma-finite-support-stalk}) and
...
\begin{lemma}[Properties trace map]
\label{more-etale-lemma-properties-trace-map}
\source{stacks:0GKH}
\href{https://stacks.math.columbia.edu/tag/0GKH}{\texttt{Stacks tag 0GKH}}
\group{more-etale}
...
in the proof of Lemma \ref{more-etale-lemma-trace-map-exists}
...
$$
\begin{array}{ccc}g^{-1}f_!f^{-1}\mathcal{F}
\underset{g^{-1}\text{Tr}_{f, w, \mathcal{F}}}{\longrightarrow}\downarrow &  & g^{-1}\mathcal{F} \downarrow \\ f'_!(f')^{-1}g^{-1}\mathcal{F}
\overset{\text{Tr}_{f', w', g^{-1}\mathcal{F}}}{\longrightarrow} &  & g^{-1}\mathcal{F}\end{array}
$$
...
$$
with first equality sign given by Lemma \ref{more-etale-lemma-lqf-base-change-f-shriek}
...
Lemma \ref{more-etale-lemma-lqf-base-change-f-shriek} respects the descriptions of stalks.
...
\source{stacks:0GL3}
\href{https://stacks.math.columbia.edu/tag/0GL3}{\texttt{Stacks tag 0GL3}}
\group{more-etale}
...
Lemma \ref{more-etale-lemma-lqf-shriek-composition}.
...
\source{stacks:0GKI}
\href{https://stacks.math.columbia.edu/tag/0GKI}{\texttt{Stacks tag 0GKI}}
\group{more-etale}
...
Thus by Lemmas \ref{more-etale-lemma-trace-map-exists} and
\ref{more-etale-lemma-properties-trace-map} for $f$ we obtain trace maps
$$
...
\begin{remark}[Trace etale counit]
\label{more-etale-remark-trace-etale-counit}
\source{stacks:0GL4}
\href{https://stacks.math.columbia.edu/tag/0GL4}{\texttt{Stacks tag 0GL4}}
\group{more-etale}

Let $j : U \to X$ be an \'etale morphism of schemes. Then the trace
map $\text{Tr} : j_!j^{-1}K \to K$ of
Example \ref{more-etale-example-trace-for-flat-quasi-finite} is equal to the
...
\source{stacks:0GKJ}
\href{https://stacks.math.columbia.edu/tag/0GKJ}{\texttt{Stacks tag 0GKJ}}
\group{more-etale}
...
Thus by Lemmas \ref{more-etale-lemma-trace-map-exists} and
\ref{more-etale-lemma-properties-trace-map} for $f$ and $w$ we obtain trace maps
$$
...
with direct sums and is exact, see Lemma \ref{more-etale-lemma-lqf-f-shriek-stalk}.
This suggests that it has a right adjoint which we will denote $f^!$.

\medskip\noindent
Warning: This functor is the non-derived version!

\begin{lemma}[Lqf f upper shriek]
\label{more-etale-lemma-lqf-f-upper-shriek}
\source{stacks:0F59}
\href{https://stacks.math.columbia.edu/tag/0F59}{\texttt{Stacks tag 0F59}}
\group{more-etale}
...
\begin{lemma}[Etale upper shriek]
\label{more-etale-lemma-etale-upper-shriek}
\source{stacks:0F5A}
\href{https://stacks.math.columbia.edu/tag/0F5A}{\texttt{Stacks tag 0F5A}}
\group{more-etale}
...
Lemma \ref{more-etale-lemma-finite-support-etale-shriek}. Finally, in
\'Etale Cohomology, Section \ref{etale-cohomology-section-extension-by-zero}
...
\begin{lemma}[Upper shriek restriction]
\label{more-etale-lemma-upper-shriek-restriction}
\source{stacks:0F5B}
\href{https://stacks.math.columbia.edu/tag/0F5B}{\texttt{Stacks tag 0F5B}}
\group{more-etale}
...
the diagram
$$
\begin{array}{cc}(h \circ g \circ f)^! \longrightarrow\downarrow & f^! \circ (h \circ g)^! \downarrow \\ (g \circ f)^! \circ h^! \longrightarrow & f^! \circ g^! \circ h^!\end{array}
$$
commutes.
\end{lemma}
...
See Lemma \ref{more-etale-lemma-lqf-shriek-composition}.
\end{proof}

\begin{lemma}[Upper shriek restriction etale]
\label{more-etale-lemma-upper-shriek-restriction-etale}
\source{stacks:0F5C}
\href{https://stacks.math.columbia.edu/tag/0F5C}{\texttt{Stacks tag 0F5C}}
\group{more-etale}
...
Lemma \ref{more-etale-lemma-upper-shriek-restriction}
agree via the isomorphism of Lemma \ref{more-etale-lemma-etale-upper-shriek}.
\end{lemma}
...
\begin{lemma}[Lqf base change upper shriek]
\label{more-etale-lemma-lqf-base-change-upper-shriek}
\source{stacks:0F6U}
\href{https://stacks.math.columbia.edu/tag/0F6U}{\texttt{Stacks tag 0F6U}}
\group{more-etale}
...
See Lemma \ref{more-etale-lemma-lqf-base-change-f-shriek}.
\end{proof}

\begin{remark}[Pointed sets]
\label{more-etale-remark-pointed-sets}
\source{stacks:0F5L}
\href{https://stacks.math.columbia.edu/tag/0F5L}{\texttt{Stacks tag 0F5L}}
\group{more-etale}
...
\begin{lemma}[Lqf shriek derived]
\label{more-etale-lemma-lqf-shriek-derived}
\source{stacks:0F5N}
\href{https://stacks.math.columbia.edu/tag/0F5N}{\texttt{Stacks tag 0F5N}}
\group{more-etale}

Let $f : X \to Y$ be a locally quasi-finite morphism of schemes.
Let $\Lambda$ be a ring. The functors $f_!$ and $f^!$ of
Definition \ref{more-etale-definition-f-shriek-lqf} and
...
the fact that $f_!$ is exact (Lemma \ref{more-etale-lemma-lqf-f-shriek-stalk})
and hence $Lf_! = f_!$
and the fact that we have enough K-injective complexes of $\Lambda$-modules
on $Y_\etale$ so that $Rf^!$ is defined.
\end{proof}

\begin{remark}[Lqf shriek derived torsion]
\label{more-etale-remark-lqf-shriek-derived-torsion}
\source{stacks:0GJX}
\href{https://stacks.math.columbia.edu/tag/0GJX}{\texttt{Stacks tag 0GJX}}
\group{more-etale}
...
Lemma \ref{more-etale-lemma-lqf-shriek-derived}
...
see Lemma \ref{more-etale-lemma-lqf-f-shriek-stalk}.
\end{remark}

\begin{lemma}[Mayer vietoris shriek]
\label{more-etale-lemma-mayer-vietoris-shriek}
\source{stacks:0GKK}
\href{https://stacks.math.columbia.edu/tag/0GKK}{\texttt{Stacks tag 0GKK}}
\group{more-etale}
...
\begin{lemma}[Triangle associated to open]
\label{more-etale-lemma-triangle-associated-to-open}
\source{stacks:0GKL}
\href{https://stacks.math.columbia.edu/tag/0GKL}{\texttt{Stacks tag 0GKL}}
\group{more-etale}
...
\begin{lemma}[Shriek proper and open]
\label{more-etale-lemma-shriek-proper-and-open}
\source{stacks:0F7B}
\href{https://stacks.math.columbia.edu/tag/0F7B}{\texttt{Stacks tag 0F7B}}
\group{more-etale}
...
Lemma \ref{more-etale-lemma-proper-f-shriek}
and the second equality comes from
Lemma \ref{more-etale-lemma-f-shriek-composition} which tells us that both
...
$$
for example by Lemma \ref{more-etale-lemma-colim-f-shriek-separated} (but it
is also obvious from the definition of $g'_{\overline{y}, !}$
in Section \ref{more-etale-section-compact-support}).
...
$$
\begin{array}{ccc}g_! Rf'_*(H^a(K)[-a]) \downarrow\longrightarrow & g_! Rf'_* K \longrightarrow\downarrow & g_! Rf'_* \tau_{\geq a + 1} K \downarrow \\ Rf_*(g'_!(H^a(K)[-a])) \longrightarrow & Rf_*(g'_!K) \longrightarrow & Rf_*(g'_!\tau_{|geq a + 1}K)\end{array}
$$
...
Lemma \ref{more-etale-lemma-lqf-f-shriek-separated-colimits} and
\'Etale Cohomology, Lemma
\ref{etale-cohomology-lemma-relative-colimit-general})
the proof is complete.
\end{proof}

\begin{lemma}[Shriek proper and open compose]
\label{more-etale-lemma-shriek-proper-and-open-compose}
\source{stacks:0F7C}
\href{https://stacks.math.columbia.edu/tag/0F7C}{\texttt{Stacks tag 0F7C}}
\group{more-etale}

Consider a commutative diagram of schemes
$$
\begin{array}{cc}X' \underset{k}{\longrightarrow}\underset{f'}{\downarrow} & X \overset{f}{\downarrow} \\ Y' \underset{l}{\longrightarrow}\underset{g'}{\downarrow} & Y \overset{g}{\downarrow} \\ Z' \overset{m}{\longrightarrow} & Z\end{array}
$$
with $f$, $f'$, $g$ and $g'$ proper and
$k$, $l$, and $m$ separated and locally quasi-finite.
Then the isomorphisms of Lemma \ref{more-etale-lemma-shriek-proper-and-open}
...
on $X_\etale$. The proof of Lemma \ref{more-etale-lemma-shriek-proper-and-open}
...
the first arrow. Finally, the proof of Lemma \ref{more-etale-lemma-shriek-proper-and-open}
...
$g_*(a) \circ b$ is the arrow of Lemma \ref{more-etale-lemma-shriek-proper-and-open}
for the rectangle.
\end{proof}

\begin{lemma}[Shriek proper and open compose horizontal]
\label{more-etale-lemma-shriek-proper-and-open-compose-horizontal}
\source{stacks:0F7D}
\href{https://stacks.math.columbia.edu/tag/0F7D}{\texttt{Stacks tag 0F7D}}
\group{more-etale}
...
using the equalities of Lemma \ref{more-etale-lemma-f-shriek-composition},
then the isomorphism
...
on $X_\etale$.
The proof of Lemma \ref{more-etale-lemma-shriek-proper-and-open} shows that the canonical
maps
$$
...
(Lemma \ref{more-etale-lemma-lqf-f-shriek-separated-colimits})
...
\source{stacks:0F7E}
\href{https://stacks.math.columbia.edu/tag/0F7E}{\texttt{Stacks tag 0F7E}}
\group{more-etale}
...
\end{matrix}
$$
Then the maps of Lemma \ref{more-etale-lemma-shriek-proper-and-open}
...
\end{matrix}
$$
By Lemma \ref{more-etale-lemma-shriek-proper-and-open-compose-horizontal} we have
$$
\gamma_{A + B} = \gamma_B \circ \gamma_A, \quad
\gamma_{C + D} = \gamma_D \circ \gamma_C
$$
and by Lemma \ref{more-etale-lemma-shriek-proper-and-open-compose} we have
$$
...
$$
\begin{array}{cc}m_! \circ g'_* \circ l'_! \circ f''_* \underset{\gamma_D}{\longrightarrow}\underset{\gamma_A}{\downarrow} & g_* \circ l_! \circ l'_! \circ f''_* \overset{\gamma_A}{\downarrow} \\ m_! \circ g'_* \circ f'_* \circ k'_! \overset{\gamma_D}{\longrightarrow} & g_* \circ l_! \circ f'_* \circ k'_!\end{array}
$$
...
\begin{lemma}[Shriek proper and open base change]
\label{more-etale-lemma-shriek-proper-and-open-base-change}
\source{stacks:0F7F}
\href{https://stacks.math.columbia.edu/tag/0F7F}{\texttt{Stacks tag 0F7F}}
\group{more-etale}
...
\vcenter{
\begin{array}{cc}X'_1 \underset{g'_1}{\longrightarrow}\underset{f'_1}{\downarrow} & X_1 \overset{f_1}{\downarrow} \\ Y'_1 \overset{g_1}{\longrightarrow} & Y_1\end{array}
}
$$
...
$$
\begin{array}{ccc}b^{-1}g_!Rf'_*K \downarrow\longrightarrow & g_{1, !}(b')^{-1}Rf'_*K \longrightarrow & g_{1, !}Rf'_{1, *}(a')^{-1}K \downarrow \\ b^{-1}Rf_*g'_!K \longrightarrow & Rf_{1, *}a^{-1}g'_!K \longrightarrow & Rf_{1, *}g'_{1, !}(a')^{-1}K\end{array}
$$
in $D(Y_{1, \etale}, \Lambda)$ where $a : X_1 \to X$, $a' : X'_1 \to X'$,
$b' : Y'_1 \to Y'$ are the projections, the vertical maps are the arrows
of Lemma \ref{more-etale-lemma-shriek-proper-and-open}
...
and the base change map of Lemma \ref{more-etale-lemma-base-change-f-shriek-separated}.
\end{lemma}
...
K-injective complex $\mathcal{I}^\bullet$ of
sheaves of $\Lambda$-modules on $X_\etale$.
The proof of Lemma \ref{more-etale-lemma-shriek-proper-and-open}
...
$$
\begin{array}{ccc}g'_{1, !}\mathcal{J}_1^\bullet \longrightarrow &  & \mathcal{I}_1^\bullet \\ g'_{1, !}(a')^{-1}\mathcal{J}^\bullet \uparrow\xlongequal{} & a^{-1}g'_!\mathcal{J}^\bullet \longrightarrow & a^{-1}\mathcal{I}^\bullet \uparrow\end{array}
$$
commuting up to homotopy where all arrows are quasi-isomorphisms, the
equality comes from Lemma \ref{more-etale-lemma-proper-f-shriek},
...
$$
\begin{array}{ccc}b^{-1}g_!f'_*\mathcal{J}^\bullet \downarrow\longrightarrow & g_{1, !}(b')^{-1}f'_*\mathcal{J}^\bullet \longrightarrow & g_{1, !}f'_{1, *}(a')^{-1}\mathcal{J}^\bullet \downarrow \\ b^{-1}f_*g'_!\mathcal{J}^\bullet \longrightarrow & f_{1, *}a^{-1}g'_!\mathcal{J}^\bullet \longrightarrow & f_{1, *}g'_{1, !}(a')^{-1}\mathcal{J}^\bullet\end{array}
$$
...
proof of Lemma \ref{more-etale-lemma-base-change-f-shriek-separated}).
...
Since of course
$$
\begin{array}{cc}g_{1, !}f'_{1, *}(a')^{-1}\mathcal{J}^\bullet \downarrow\longrightarrow & g_{1, !}f'_{1, *}\mathcal{J}_1^\bullet \downarrow \\ f_{1, *}g'_{1, !}(a')^{-1}\mathcal{J}^\bullet \longrightarrow & f_{1, *}g'_{1, !}\mathcal{J}_1^\bullet\end{array}
$$
commutes, to finish the proof it suffices to show that
$$
\begin{array}{cccc}b^{-1}f_*g'_!\mathcal{J}^\bullet \longrightarrow\downarrow & f_{1, *}a^{-1}g'_!\mathcal{J}^\bullet \longrightarrow\downarrow & f_{1, *}g'_{1, !}(a')^{-1}\mathcal{J}^\bullet \longrightarrow & f_{1, *}g'_{1, !}\mathcal{J}_1^\bullet \downarrow \\ b^{-1}f_*\mathcal{I}^\bullet \longrightarrow & f_{1, *}a^{-1}\mathcal{I}^\bullet \longrightarrow &  & f_{1, *}\mathcal{I}_1^\bullet\end{array}
$$
commutes in the derived category, which holds by our choice of
maps earlier.
\end{proof}

\begin{lemma}[Shriek lqf and proper]
\label{more-etale-lemma-shriek-lqf-and-proper}
\source{stacks:0F7G}
\href{https://stacks.math.columbia.edu/tag/0F7G}{\texttt{Stacks tag 0F7G}}
\group{more-etale}

Consider a commutative diagram of schemes
$$
\begin{array}{cc}X \underset{f}{\longrightarrow}\underset{g}{\searrow} & Y \overset{h}{\downarrow} \\  & Z\end{array}
$$
...
\begin{proof}
This is a special case of Lemma \ref{more-etale-lemma-shriek-proper-and-open}
...
Lemmas \ref{more-etale-lemma-lqf-separated-shriek-composition}
and \ref{more-etale-lemma-proper-f-shriek}. This map of complexes determines the map
...
in the proof of Lemma \ref{more-etale-lemma-shriek-proper-and-open}
(using Lemma \ref{more-etale-lemma-lqf-f-shriek-stalk} instead of
Lemma \ref{more-etale-lemma-lqf-f-shriek-separated-colimits}).
\end{proof}
...
Remark \ref{more-etale-remark-lqf-shriek-derived-torsion} and $R\overline{f}_*$ sends
...
\source{stacks:0F7I}
\href{https://stacks.math.columbia.edu/tag/0F7I}{\texttt{Stacks tag 0F7I}}
\group{more-etale}
...
$$
using Lemma \ref{more-etale-lemma-shriek-lqf-and-proper} in the first equality.
...
$$
of Lemma \ref{more-etale-lemma-shriek-lqf-and-proper} agrees with the corresponding
map $j_{3, !} \to R(h \circ g)_* \circ j_{1, !}$
via the identification $R(h \circ g)_* = Rh_* \circ Rg_*$.
Since the map of Lemma \ref{more-etale-lemma-shriek-lqf-and-proper}
is a special case of the map of Lemma \ref{more-etale-lemma-shriek-proper-and-open}
(as $j_1$ and $j_2$ are separated) this follows immediately from
Lemma \ref{more-etale-lemma-shriek-proper-and-open-compose}.
\end{proof}

\begin{lemma}[Shriek composition]
\label{more-etale-lemma-shriek-composition}
\source{stacks:0F7J}
\href{https://stacks.math.columbia.edu/tag/0F7J}{\texttt{Stacks tag 0F7J}}
\group{more-etale}
...
$$
\begin{array}{ccc}X \underset{j}{\longrightarrow}\underset{f}{\downarrow} & U \overset{f'}{\swarrow}\underset{j'}{\longrightarrow} & \overline{X} \overset{\overline{f}}{\swarrow} \\ Y \underset{i}{\longrightarrow}\underset{g}{\downarrow} & \overline{Y} \overset{\overline{g}}{\swarrow} &  \\ Z &  & \end{array}
$$
Then we have
\begin{align*}
R(g \circ f)_!
...
and $(j' \circ j)_! = j'_! \circ j_!$ of Lemma \ref{more-etale-lemma-f-shriek-composition}.
The identification $i_! \circ Rf'_* \to R\overline{f}_* \circ j_!$
used in the third equality is Lemma \ref{more-etale-lemma-shriek-proper-and-open}.
...
$$
\vcenter{
\begin{array}{ccc}X \underset{j_1}{\longrightarrow}\downarrow & U_1 \overset{f_1}{\swarrow}\underset{j'_1}{\longrightarrow} & \overline{X}_1 \overset{\overline{f}_1}{\swarrow} \\ Y \underset{i_1}{\longrightarrow}\downarrow & \overline{Y}_1 \overset{\overline{g}_1}{\swarrow} &  \\ Z &  & \end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{ccc}X \underset{j_2}{\longrightarrow}\downarrow & U_2 \overset{f_2}{\swarrow}\underset{j'_2}{\longrightarrow} & \overline{X}_2 \overset{\overline{f}_2}{\swarrow} \\ Y \underset{i_2}{\longrightarrow}\downarrow & \overline{Y}_2 \overset{\overline{g}_2}{\swarrow} &  \\ Z &  & \end{array}
}
$$
...
as follows
$$
\begin{array}{ccccc}X \underset{j_1}{\longrightarrow}\downarrow &  & U_1 \overset{h'}{\downarrow}\swarrow\underset{j'_1}{\longrightarrow} &  & \overline{X}_1 \overset{h}{\downarrow}\swarrow \\ X \overset{j_2}{\longrightarrow}\downarrow &  & U_2 \swarrow\overset{j'_2}{\longrightarrow} &  & \overline{X}_2 \swarrow \\ Y \overset{i_1}{\longrightarrow}\downarrow &  & \overline{Y}_1 \overset{k}{\downarrow} &  &  \\ Y \overset{i_2}{\longrightarrow}\downarrow &  & \overline{Y}_2 \swarrow &  &  \\ Z &  &  &  & \end{array}
$$
Each of the squares
$$
\begin{array}{cc}X \underset{j_1}{\longrightarrow}\underset{\text{id}}{\downarrow}\searrow|A & U_1 \overset{h'}{\downarrow} \\ X \overset{j_2}{\longrightarrow} & U_2\end{array}
\quad
\begin{array}{cc}U_2 \underset{j_2'}{\longrightarrow}\underset{f_2}{\downarrow}\searrow|B & \overline{X}_2 \overset{\overline{f}_2}{\downarrow} \\ Y \overset{i_2}{\longrightarrow} & \overline{Y}_2\end{array}
\quad
\begin{array}{cc}U_1 \underset{j_1'}{\longrightarrow}\underset{f_1}{\downarrow}\searrow|C & \overline{X}_1 \overset{\overline{f}_1}{\downarrow} \\ Y \overset{i_1}{\longrightarrow} & \overline{Y}_1\end{array}
\quad
\begin{array}{cc}Y \underset{i_1}{\longrightarrow}\underset{\text{id}}{\downarrow}\searrow|D & \overline{Y}_1 \overset{k}{\downarrow} \\ Y \overset{i_2}{\longrightarrow} & \overline{Y}_2\end{array}
\quad
\begin{array}{cc}X \underset{j_1' \circ j_1}{\longrightarrow}\underset{\text{id}}{\downarrow}\searrow|E & \overline{X}_1 \overset{h}{\downarrow} \\ X \overset{j_2}{\longrightarrow} & \overline{X}_2\end{array}
$$
...
\end{align*}
by applying the map from Lemma \ref{more-etale-lemma-shriek-proper-and-open}
(which is the same as the map in Lemma \ref{more-etale-lemma-shriek-lqf-and-proper}
...
and in Lemma \ref{more-etale-lemma-shriek-well-defined} uses
\begin{enumerate}
...
$$
\begin{array}{ccc}C_2 \underset{\gamma_E}{\longrightarrow} &  & C_1 \\ G_2 \circ F_2 \overset{\gamma_D \circ \gamma_A}{\longrightarrow}\overset{\gamma_B}{\uparrow} &  & G_1 \circ F_1 \underset{\gamma_C}{\uparrow}\end{array}
$$
is commutative. We will use
Lemmas \ref{more-etale-lemma-shriek-proper-and-open-compose} and
\ref{more-etale-lemma-shriek-proper-and-open-compose-horizontal}
and with (abuse of) notation as in
Remark \ref{more-etale-remark-going-around} (in particular
dropping $\star$ products with identity transformations
from the notation).
We can write $\gamma_E = \gamma_F \circ \gamma_A$ where
$$
\begin{array}{cc}U_1 \underset{j'_1}{\longrightarrow}\underset{h'}{\downarrow}\searrow|F & \overline{X}_1 \overset{h}{\downarrow} \\ U_2 \overset{j'_2}{\longrightarrow} & \overline{X}_2\end{array}
$$
Thus we see that
$$
...
Remark \ref{more-etale-remark-going-around}). Thus it suffices to prove that
...
\source{stacks:0F7K}
\href{https://stacks.math.columbia.edu/tag/0F7K}{\texttt{Stacks tag 0F7K}}
\group{more-etale}
...
the diagram
$$
\begin{array}{cc}Rh_! \circ Rg_! \circ Rf_! \underset{\gamma_C}{\longrightarrow}\overset{\gamma_A}{\downarrow} & R(h \circ g)_! \circ Rf_! \underset{\gamma_{A + B}}{\downarrow} \\ Rh_! \circ R(g \circ f)_! \overset{\gamma_{B + C}}{\longrightarrow} & R(h \circ g \circ f)_!\end{array}
$$
of isomorphisms of Lemma \ref{more-etale-lemma-shriek-composition} commutes
...
as in the proof of Lemma \ref{more-etale-lemma-shriek-composition}
we see that the maps in the first displayed diagram use the
maps of Lemma \ref{more-etale-lemma-shriek-proper-and-open} for the rectangles
...
intersect in one point (similar to the last argument in
Remark \ref{more-etale-remark-going-around}).
\end{proof}

\begin{lemma}[Base change shriek]
\label{more-etale-lemma-base-change-shriek}
\source{stacks:0F7L}
\href{https://stacks.math.columbia.edu/tag/0F7L}{\texttt{Stacks tag 0F7L}}
\group{more-etale}
...
of Lemma \ref{more-etale-lemma-shriek-composition}.
\end{lemma}
...
for (2) by Remark \ref{more-etale-remark-f-shriek-base-change-composition}, and
(3) by Lemma \ref{more-etale-lemma-shriek-proper-and-open-base-change}.
\end{proof}

\begin{remark}[Shriek to star]
\label{more-etale-remark-shriek-to-star}
\source{stacks:0H6X}
\href{https://stacks.math.columbia.edu/tag/0H6X}{\texttt{Stacks tag 0H6X}}
\group{more-etale}
...
Lemma \ref{more-etale-lemma-shriek-composition} and the isomorphism
...
of Lemma \ref{more-etale-lemma-base-change-shriek}
...
\begin{lemma}[Derived lower shriek commute direct sums]
\label{more-etale-lemma-derived-lower-shriek-commute-direct-sums}
\source{stacks:0G29}
\href{https://stacks.math.columbia.edu/tag/0G29}{\texttt{Stacks tag 0G29}}
\group{more-etale}
...
\begin{lemma}[Derived lower shriek bounded]
\label{more-etale-lemma-derived-lower-shriek-bounded}
\source{stacks:0G2A}
\href{https://stacks.math.columbia.edu/tag/0G2A}{\texttt{Stacks tag 0G2A}}
\group{more-etale}

Let $f : X \to Y$ be a finite type separated morphism of quasi-compact
and quasi-separated schemes. Let $\Lambda$ be a ring. The functors $Rf_!$
constructed in Section \ref{more-etale-section-derived-lower-shriek-compactification}
...
\begin{lemma}[Rf shriek for quasi finite]
\label{more-etale-lemma-Rf-shriek-for-quasi-finite}
\source{stacks:0GKM}
\href{https://stacks.math.columbia.edu/tag/0GKM}{\texttt{Stacks tag 0GKM}}
\group{more-etale}
...
$f_! : D(X_\etale, \Lambda) \to D(Y_\etale, \Lambda)$
constructed in Section \ref{more-etale-section-derived-duality-locally-quasi-finite}
...
for example by Lemma \ref{more-etale-lemma-compactify-f-shriek-separated}.
\end{proof}

\begin{lemma}[Relative mayer vietoris]
\label{more-etale-lemma-relative-mayer-vietoris}
\source{stacks:0GKN}
\href{https://stacks.math.columbia.edu/tag/0GKN}{\texttt{Stacks tag 0GKN}}
\group{more-etale}
...
\begin{proof}
This follows from Lemma \ref{more-etale-lemma-mayer-vietoris-shriek},
the fact that $Rf_! \circ Rj_{U!} = Ra_!$ by
Lemma \ref{more-etale-lemma-shriek-composition}, and the fact that
$Rj_{U!} = j_{U!}$ by Lemma \ref{more-etale-lemma-Rf-shriek-for-quasi-finite}.
\end{proof}

\begin{lemma}[Relative triangle associated to open]
\label{more-etale-lemma-relative-triangle-associated-to-open}
\source{stacks:0GKP}
\href{https://stacks.math.columbia.edu/tag/0GKP}{\texttt{Stacks tag 0GKP}}
\group{more-etale}
...
\begin{proof}
This follows from
Lemma \ref{more-etale-lemma-triangle-associated-to-open},
the fact that $Rf_! \circ Rj_! = Rg_!$ and $Rf_! \circ Ri_!$ by
Lemma \ref{more-etale-lemma-shriek-composition}, and the fact that
$Rj_! = j_!$ and $Ri_! = i_! = i_*$ by
Lemma \ref{more-etale-lemma-Rf-shriek-for-quasi-finite}.
\end{proof}

\begin{lemma}[Shriek and thickening]
\label{more-etale-lemma-shriek-and-thickening}
\source{stacks:0GKQ}
\href{https://stacks.math.columbia.edu/tag/0GKQ}{\texttt{Stacks tag 0GKQ}}
\group{more-etale}
...
and we can apply
Lemma \ref{more-etale-lemma-shriek-composition}.
\end{proof}

\begin{lemma}[Projection formula Rf lower shriek]
\label{more-etale-lemma-projection-formula-Rf-lower-shriek}
\source{stacks:0GL5}
\href{https://stacks.math.columbia.edu/tag/0GL5}{\texttt{Stacks tag 0GL5}}
\group{more-etale}
...
\begin{remark}[Rf lower shriek change of rings]
\label{more-etale-remark-Rf-lower-shriek-change-of-rings}
\source{stacks:0GL6}
\href{https://stacks.math.columbia.edu/tag/0GL6}{\texttt{Stacks tag 0GL6}}
\group{more-etale}
...
$$
\begin{array}{cc}D(X_\etale, \Lambda_2) \underset{res}{\longrightarrow}\underset{Rf_!}{\downarrow} & D(X_\etale, \Lambda_1) \overset{Rf_!}{\downarrow} \\ D(Y_\etale, \Lambda_2) \overset{res}{\longrightarrow} & D(Y_\etale, \Lambda_1)\end{array}
$$
...
Section \ref{more-etale-section-derived-lower-shriek-compactification}, we see that
...
$$
\begin{array}{cc}D(X_\etale, \Lambda_1)
\underset{- \otimes_{\Lambda_1}^\mathbf{L} \Lambda_2}{\longrightarrow}\underset{Rf_!}{\downarrow} & D(X_\etale, \Lambda_2) \overset{Rf_!}{\downarrow} \\ D(Y_\etale, \Lambda_1)
\overset{- \otimes_{\Lambda_1}^\mathbf{L} \Lambda_2}{\longrightarrow} & D(Y_\etale, \Lambda_2)\end{array}
$$
is commutative as follows from
Lemma \ref{more-etale-lemma-projection-formula-Rf-lower-shriek}.
\end{remark}

\begin{remark}[Projection formula for internal hom]
\label{more-etale-remark-projection-formula-for-internal-hom}
\source{stacks:0GL7}
\href{https://stacks.math.columbia.edu/tag/0GL7}{\texttt{Stacks tag 0GL7}}
\group{more-etale}
...
\begin{lemma}[Upper shriek derived]
\label{more-etale-lemma-upper-shriek-derived}
\source{stacks:0G2C}
\href{https://stacks.math.columbia.edu/tag/0G2C}{\texttt{Stacks tag 0G2C}}
\group{more-etale}
...
and Lemma \ref{more-etale-lemma-derived-lower-shriek-commute-direct-sums} above.
\end{proof}

\begin{lemma}[Rf upper shriek for quasi finite]
\label{more-etale-lemma-Rf-upper-shriek-for-quasi-finite}
\source{stacks:0GL8}
\href{https://stacks.math.columbia.edu/tag/0GL8}{\texttt{Stacks tag 0GL8}}
\group{more-etale}

Let $f : X \to Y$ be a separated quasi-finite morphism of quasi-compact
and quasi-separated schemes. Let $\Lambda$ be a torsion coefficient ring.
The functor $Rf^! : D(Y_\etale, \Lambda) \to D(X_\etale, \Lambda)$
of Lemma \ref{more-etale-lemma-upper-shriek-derived} is the same as the functor
$Rf^!$ of Lemma \ref{more-etale-lemma-lqf-shriek-derived}.
\end{lemma}
...
\begin{lemma}[Rf upper shriek for etale]
\label{more-etale-lemma-Rf-upper-shriek-for-etale}
\source{stacks:0GL9}
\href{https://stacks.math.columbia.edu/tag/0GL9}{\texttt{Stacks tag 0GL9}}
\group{more-etale}
...
\ref{more-etale-lemma-Rf-upper-shriek-for-quasi-finite} and
...
\source{stacks:0GLA}
\href{https://stacks.math.columbia.edu/tag/0GLA}{\texttt{Stacks tag 0GLA}}
\group{more-etale}
...
\begin{proof}
Let $N$ be the integer found in Lemma \ref{more-etale-lemma-derived-lower-shriek-bounded}.
...
Lemma \ref{more-etale-lemma-derived-lower-shriek-bounded}
...
Remark \ref{more-etale-remark-projection-formula-for-internal-hom}
...
\source{stacks:0GLC}
\href{https://stacks.math.columbia.edu/tag/0GLC}{\texttt{Stacks tag 0GLC}}
\group{more-etale}
...
The fourth equality by Lemma \ref{more-etale-lemma-projection-formula-Rf-lower-shriek}
...
\source{stacks:0GLD}
\href{https://stacks.math.columbia.edu/tag/0GLD}{\texttt{Stacks tag 0GLD}}
\group{more-etale}
...
$$
Thus the lemma is a consequence of Lemma \ref{more-etale-lemma-iso-on-RSheafHom}.
\end{proof}

\begin{lemma}[Cartesian square Rf upper shriek]
\label{more-etale-lemma-cartesian-square-Rf-upper-shriek}
\source{stacks:0GLE}
\href{https://stacks.math.columbia.edu/tag/0GLE}{\texttt{Stacks tag 0GLE}}
\group{more-etale}
...
Lemma \ref{more-etale-lemma-base-change-shriek}.
\end{proof}

\begin{remark}[Rf upper shriek change of rings]
\label{more-etale-remark-Rf-upper-shriek-change-of-rings}
\source{stacks:0GLF}
\href{https://stacks.math.columbia.edu/tag/0GLF}{\texttt{Stacks tag 0GLF}}
\group{more-etale}
...
and quasi-separated schemes. The diagram
$$
\begin{array}{cc}D(X_\etale, \Lambda_2) \underset{res}{\longrightarrow} & D(X_\etale, \Lambda_1) \\ D(Y_\etale, \Lambda_2) \overset{res}{\longrightarrow}\overset{Rf^!}{\uparrow} & D(Y_\etale, \Lambda_1) \underset{Rf^!}{\uparrow}\end{array}
$$
commutes where $res$ is the ``restriction'' functor which turns a
$\Lambda_2$-module into a $\Lambda_1$-module using the given ring map.
This holds by uniquenss of adjoints, the second commutative diagram
of Remark \ref{more-etale-remark-Rf-lower-shriek-change-of-rings} and because we have
$$
...
In Section \ref{more-etale-section-derived-lower-shriek-compactification}
...
\begin{definition}[Cohomology compact support]
\label{more-etale-definition-cohomology-compact-support}
\source{stacks:0GJZ}
\href{https://stacks.math.columbia.edu/tag/0GJZ}{\texttt{Stacks tag 0GJZ}}
\group{more-etale}
...
Definition \ref{more-etale-definition-compact-support} by
Lemma \ref{more-etale-lemma-compact-support-h0}.
The utility of this definition lies in the following result.

\begin{lemma}[Stalk R f shriek]
\label{more-etale-lemma-stalk-R-f-shriek}
\source{stacks:0GK0}
\href{https://stacks.math.columbia.edu/tag/0GK0}{\texttt{Stacks tag 0GK0}}
\group{more-etale}
...
\begin{proof}
Immediate consequence of Lemma \ref{more-etale-lemma-base-change-shriek} and the
definitions.
\end{proof}

\begin{lemma}[Compact support h0]
\label{more-etale-lemma-compact-support-h0}
\source{stacks:0GK1}
\href{https://stacks.math.columbia.edu/tag/0GK1}{\texttt{Stacks tag 0GK1}}
\group{more-etale}

Let $X$ be a separated scheme of finite type over a field $k$.
If $\mathcal{F}$ is a torsion abelian sheaf, then the abelian group
$H^0_c(X, \mathcal{F})$ defined in Definition \ref{more-etale-definition-compact-support}
agrees with the abelian group $H^0_c(X, \mathcal{F})$ defined in
Definition \ref{more-etale-definition-cohomology-compact-support}.
\end{lemma}
...
Lemma \ref{more-etale-lemma-compactify-compact-support}
and for the second version by construction.
\end{proof}

\begin{lemma}[Finiteness curves]
\label{more-etale-lemma-finiteness-curves}
\source{stacks:0GKR}
\href{https://stacks.math.columbia.edu/tag/0GKR}{\texttt{Stacks tag 0GKR}}
\group{more-etale}
...
\source{stacks:0GKS}
\href{https://stacks.math.columbia.edu/tag/0GKS}{\texttt{Stacks tag 0GKS}}
\group{more-etale}
...
\text{Tr}_{f, w, K} : f_!f^{-1}K \longrightarrow K
$$
See Section \ref{more-etale-section-weightings} for the existence of the
trace map and Examples \ref{more-etale-example-trace-for-flat-quasi-finite} and
\ref{more-etale-example-trace-for-quasi-finite-over-normal} for cases (2) and (3).
If $p : X \to \Spec(k)$ and $q : Y \to \Spec(k)$ denote
the structure morphisms, then we have $Rq_! \circ f_! = Rp_!$
by Lemma \ref{more-etale-lemma-shriek-composition} and the fact that
$Rf_! = f_!$ for the quasi-finite separated morphism $f$ by
Lemma \ref{more-etale-lemma-Rf-shriek-for-quasi-finite}. Hence we can look
at the map
\begin{align*}
R\Gamma_c(X, f^{-1}K)
& =
...
\begin{lemma}[Frobenius linear on vb]
\label{more-etale-lemma-frobenius-linear-on-vb}
\source{stacks:0GKU}
\href{https://stacks.math.columbia.edu/tag/0GKU}{\texttt{Stacks tag 0GKU}}
\group{more-etale}
...
\begin{lemma}[Proper smooth family curves]
\label{more-etale-lemma-proper-smooth-family-curves}
\source{stacks:0GKV}
\href{https://stacks.math.columbia.edu/tag/0GKV}{\texttt{Stacks tag 0GKV}}
\group{more-etale}
...
\to 0
$$
Applying Lemma \ref{more-etale-lemma-frobenius-linear-on-vb} we win.
\end{proof}

\begin{lemma}[Proper smooth family curves modules]
\label{more-etale-lemma-proper-smooth-family-curves-modules}
\source{stacks:0GKW}
\href{https://stacks.math.columbia.edu/tag/0GKW}{\texttt{Stacks tag 0GKW}}
\group{more-etale}
...
This case is Lemma \ref{more-etale-lemma-proper-smooth-family-curves}.
\end{proof}
...
\begin{lemma}[Qf f shriek constructible]
\label{more-etale-lemma-qf-f-shriek-constructible}
\source{stacks:0GK3}
\href{https://stacks.math.columbia.edu/tag/0GK3}{\texttt{Stacks tag 0GK3}}
\group{more-etale}
...
of Lemma \ref{more-etale-lemma-lqf-shriek-derived}
...
covering. By Lemma \ref{more-etale-lemma-lqf-colimit-f-shriek}
...
by Lemma \ref{more-etale-lemma-proper-f-shriek}.
...
\begin{lemma}[Constant shriek rel dim 1]
\label{more-etale-lemma-constant-shriek-rel-dim-1}
\source{stacks:0GKX}
\href{https://stacks.math.columbia.edu/tag/0GKX}{\texttt{Stacks tag 0GKX}}
\group{more-etale}
...
by Lemma \ref{more-etale-lemma-stalk-R-f-shriek}.
This is a finite $\Lambda$-module by Lemma \ref{more-etale-lemma-finiteness-curves}.
...
with all base change (Lemma \ref{more-etale-lemma-base-change-shriek}).
...
$$
\begin{array}{ccccc}\overline{Y}_1 \amalg \ldots \amalg \overline{Y}_n \searrow & Y_1 \amalg \ldots \amalg Y_n \underset{\nu}{\longrightarrow}\downarrow\overset{j}{\longleftarrow} & X_V \longrightarrow\downarrow & X_U \longrightarrow\downarrow & X \overset{f}{\downarrow} \\  & T_1 \amalg \ldots \amalg T_n \longrightarrow & V \longrightarrow & U \longrightarrow & S\end{array}
$$
...
\ldots
$$
of Lemma \ref{more-etale-lemma-relative-triangle-associated-to-open} and
from Lemma \ref{more-etale-lemma-qf-f-shriek-constructible}
...
and we may apply Lemma \ref{more-etale-lemma-shriek-and-thickening}.
...
is Lemma \ref{more-etale-lemma-proper-smooth-family-curves-modules}
and we win because $T_i \to V$ is finite \'etale
and we can apply Lemma \ref{more-etale-lemma-qf-f-shriek-constructible}.
\end{proof}

\begin{lemma}[Loc constant shriek rel dim 1]
\label{more-etale-lemma-loc-constant-shriek-rel-dim-1}
\source{stacks:0GKY}
\href{https://stacks.math.columbia.edu/tag/0GKY}{\texttt{Stacks tag 0GKY}}
\group{more-etale}
...
by Lemma \ref{more-etale-lemma-shriek-composition}.
...
Lemma \ref{more-etale-lemma-constant-shriek-rel-dim-1}.
\end{proof}

\begin{lemma}[Constructible shriek rel dim 1]
\label{more-etale-lemma-constructible-shriek-rel-dim-1}
\source{stacks:0GKZ}
\href{https://stacks.math.columbia.edu/tag/0GKZ}{\texttt{Stacks tag 0GKZ}}
\group{more-etale}
...
Lemma \ref{more-etale-lemma-relative-triangle-associated-to-open}
and the result for $Z \to Y$ (Lemma \ref{more-etale-lemma-qf-f-shriek-constructible})
we reduce to showing that
$R(U \to Y)_!\mathcal{F}$ has constructible cohomology sheaves.
This is Lemma \ref{more-etale-lemma-loc-constant-shriek-rel-dim-1}.
\end{proof}

\begin{theorem}[Constructible shriek]
\label{more-etale-theorem-constructible-shriek}
\source{stacks:0GL0}
\href{https://stacks.math.columbia.edu/tag/0GL0}{\texttt{Stacks tag 0GL0}}
\group{more-etale}
...
By the induction principle and Lemma \ref{more-etale-lemma-relative-mayer-vietoris}
...
by Lemma \ref{more-etale-lemma-shriek-composition}. By
Lemma \ref{more-etale-lemma-qf-f-shriek-constructible}
...
Lemma \ref{more-etale-lemma-constructible-shriek-rel-dim-1}.
\end{proof}

\section{Applications}
\label{more-etale-section-applications}
In this section we give some applications of
Theorem \ref{more-etale-theorem-constructible-shriek}.

\begin{lemma}[Finiteness compactly supported]
\label{more-etale-lemma-finiteness-compactly-supported}
\source{stacks:0GLH}
\href{https://stacks.math.columbia.edu/tag/0GLH}{\texttt{Stacks tag 0GLH}}
\group{more-etale}
...
\begin{proof}
Immediate consequence of Theorem \ref{more-etale-theorem-constructible-shriek}
and the definition of compactly supported cohomology in
Section \ref{more-etale-section-compactly-supported-cohomology}.
\end{proof}

\begin{proposition}[Loc cst torsion]
\label{more-etale-proposition-loc-cst-torsion}
\source{stacks:0GLI}
\href{https://stacks.math.columbia.edu/tag/0GLI}{\texttt{Stacks tag 0GLI}}
\group{more-etale}
...
By Theorem \ref{more-etale-theorem-constructible-shriek}
...
$$
\begin{array}{ccc}U \underset{j}{\longrightarrow}\underset{g}{\searrow} &  & U' \overset{g'}{\swarrow} \\  & Y & \end{array}
$$
...
$$
in $D(Y_\etale, \Lambda)$. Namely, by Lemmas \ref{more-etale-lemma-shriek-composition}
and \ref{more-etale-lemma-Rf-shriek-for-quasi-finite} we have $Rg_! = Rg'_! \circ j_!$.
...
Remark \ref{more-etale-remark-trace-etale-counit}.
...
see Lemma \ref{more-etale-lemma-trace-composition} for a more general case.
...
\begin{lemma}[Describe Rf upper shriek]
\label{more-etale-lemma-describe-Rf-upper-shriek}
\source{stacks:0GLK}
\href{https://stacks.math.columbia.edu/tag/0GLK}{\texttt{Stacks tag 0GLK}}
\group{more-etale}
