...
\begin{proposition}
\label{src-no-enriques-surface-over-the-integers-ch12-possible-configurations-for-enriques-surfaces-statement-1}
\source{no-enriques-surface-over-the-integers}
\notready
\mylabel{possible configurations}
...
\begin{proposition}
\label{src-no-enriques-surface-over-the-integers-ch12-possible-configurations-for-enriques-surfaces-statement-2}
\source{no-enriques-surface-over-the-integers}
\notready
\mylabel{no I8}
...
\begin{proposition}
\label{src-no-enriques-surface-over-the-integers-ch12-possible-configurations-for-enriques-surfaces-statement-3}
\source{no-enriques-surface-over-the-integers}
\notready
\mylabel{no II*, IV*, IV}
...
\begin{proposition}
\label{src-no-enriques-surface-over-the-integers-ch12-possible-configurations-for-enriques-surfaces-statement-4}
\source{no-enriques-surface-over-the-integers}
\notready
