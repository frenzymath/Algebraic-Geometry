...
\source{stacks:08GE}
\href{https://stacks.math.columbia.edu/tag/08GE}{\texttt{Stacks tag 08GE}}
\group{spaces-perfect}
...
\source{stacks:08GF}
\href{https://stacks.math.columbia.edu/tag/08GF}{\texttt{Stacks tag 08GF}}
\group{spaces-perfect}
...
\begin{lemma}[Epsilon flat]
\label{spaces-perfect-lemma-epsilon-flat}
\source{stacks:08H8}
\href{https://stacks.math.columbia.edu/tag/08H8}{\texttt{Stacks tag 08H8}}
\group{spaces-perfect}
...
The functor $\epsilon^*$ is exact (Lemma \ref{spaces-perfect-lemma-epsilon-flat})
hence induces
...
\begin{lemma}[Derived quasi coherent small etale site]
\label{spaces-perfect-lemma-derived-quasi-coherent-small-etale-site}
\source{stacks:071Q}
\href{https://stacks.math.columbia.edu/tag/071Q}{\texttt{Stacks tag 071Q}}
\group{spaces-perfect}
...
\begin{definition}[Derived quasi coherent]
\label{spaces-perfect-definition-derived-quasi-coherent}
\source{stacks:071X}
\href{https://stacks.math.columbia.edu/tag/071X}{\texttt{Stacks tag 071X}}
\group{spaces-perfect}
...
\begin{lemma}[Check quasi coherence on covering]
\label{spaces-perfect-lemma-check-quasi-coherence-on-covering}
\source{stacks:08F2}
\href{https://stacks.math.columbia.edu/tag/08F2}{\texttt{Stacks tag 08F2}}
\group{spaces-perfect}
...
\source{stacks:08F3}
\href{https://stacks.math.columbia.edu/tag/08F3}{\texttt{Stacks tag 08F3}}
\group{spaces-perfect}
...
\source{stacks:0D3E}
\href{https://stacks.math.columbia.edu/tag/0D3E}{\texttt{Stacks tag 0D3E}}
\group{spaces-perfect}
...
\source{stacks:08F4}
\href{https://stacks.math.columbia.edu/tag/08F4}{\texttt{Stacks tag 08F4}}
\group{spaces-perfect}
...
\source{stacks:08F5}
\href{https://stacks.math.columbia.edu/tag/08F5}{\texttt{Stacks tag 08F5}}
\group{spaces-perfect}
...
\source{stacks:08F6}
\href{https://stacks.math.columbia.edu/tag/08F6}{\texttt{Stacks tag 08F6}}
\group{spaces-perfect}
...
\source{stacks:08F7}
\href{https://stacks.math.columbia.edu/tag/08F7}{\texttt{Stacks tag 08F7}}
\group{spaces-perfect}
...
$E = R\lim E_n$, see Lemma \ref{spaces-perfect-lemma-nice-K-injective}. Thus
...
\source{stacks:08FA}
\href{https://stacks.math.columbia.edu/tag/08FA}{\texttt{Stacks tag 08FA}}
\group{spaces-perfect}
...
Hence we may apply Lemma \ref{spaces-perfect-lemma-application-nice-K-injective}
...
\source{stacks:08FB}
\href{https://stacks.math.columbia.edu/tag/08FB}{\texttt{Stacks tag 08FB}}
\group{spaces-perfect}
...
Choose an integer $N$ as in Lemma \ref{spaces-perfect-lemma-quasi-coherence-direct-image}.
...
\begin{remark}[Match total direct images]
\label{spaces-perfect-remark-match-total-direct-images}
\source{stacks:08GH}
\href{https://stacks.math.columbia.edu/tag/08GH}{\texttt{Stacks tag 08GH}}
\group{spaces-perfect}
...
Then the diagram
$$
\begin{array}{ccccccc}D_\QCoh(\mathcal{O}_{X_0})
\xlongequal{} &  &  &  &  &  & D_\QCoh(\mathcal{O}_X) \\ D_\QCoh(\mathcal{O}_{Y_0})
\overset{Lf^*_0}{\uparrow}\xlongequal{\text{Lemma
\ref{spaces-perfect-lemma-derived-quasi-coherent-small-etale-site}}} &  &  &  &  &  & D_\QCoh(\mathcal{O}_Y) \underset{Lf^*}{\uparrow}\end{array}
$$
(Lemma \ref{spaces-perfect-lemma-quasi-coherence-pullback} and
Derived Categories of Schemes, Lemma
\ref{perfect-lemma-quasi-coherence-pullback})
...
of Lemma \ref{spaces-perfect-lemma-derived-quasi-coherent-small-etale-site}
...
$$
\begin{array}{ccccccc}D_\QCoh(\mathcal{O}_{X_0})
\underset{Rf_{0, *}}{\downarrow}\xlongequal{} &  &  &  &  &  & D_\QCoh(\mathcal{O}_X) \overset{Rf_*}{\downarrow} \\ D_\QCoh(\mathcal{O}_{Y_0})
\xlongequal{\text{Lemma
\ref{spaces-perfect-lemma-derived-quasi-coherent-small-etale-site}}} &  &  &  &  &  & D_\QCoh(\mathcal{O}_Y)\end{array}
$$
(Lemma \ref{spaces-perfect-lemma-quasi-coherence-direct-image} and
Derived Categories of Schemes, Lemma
...
\source{stacks:08II}
\href{https://stacks.math.columbia.edu/tag/08II}{\texttt{Stacks tag 08II}}
\group{spaces-perfect}
...
via Lemma \ref{spaces-perfect-lemma-derived-quasi-coherent-small-etale-site} and
...
\source{stacks:08IJ}
\href{https://stacks.math.columbia.edu/tag/08IJ}{\texttt{Stacks tag 08IJ}}
\group{spaces-perfect}
...
\source{stacks:0CZC}
\href{https://stacks.math.columbia.edu/tag/0CZC}{\texttt{Stacks tag 0CZC}}
\group{spaces-perfect}
...
\source{stacks:0CZD}
\href{https://stacks.math.columbia.edu/tag/0CZD}{\texttt{Stacks tag 0CZD}}
\group{spaces-perfect}
...
if the equivalent conditions of Lemma \ref{spaces-perfect-lemma-closed-proper-over-base}
are satisfied.
\end{definition}
...
\source{stacks:0CZE}
\href{https://stacks.math.columbia.edu/tag/0CZE}{\texttt{Stacks tag 0CZE}}
\group{spaces-perfect}
...
\source{stacks:0CZF}
\href{https://stacks.math.columbia.edu/tag/0CZF}{\texttt{Stacks tag 0CZF}}
\group{spaces-perfect}
...
\source{stacks:0CZG}
\href{https://stacks.math.columbia.edu/tag/0CZG}{\texttt{Stacks tag 0CZG}}
\group{spaces-perfect}
...
\source{stacks:0CZH}
\href{https://stacks.math.columbia.edu/tag/0CZH}{\texttt{Stacks tag 0CZH}}
\group{spaces-perfect}
...
we conclude by
Lemma \ref{spaces-perfect-lemma-functoriality-closed-proper-over-base} part (2)
...
\source{stacks:0CZI}
\href{https://stacks.math.columbia.edu/tag/0CZI}{\texttt{Stacks tag 0CZI}}
\group{spaces-perfect}
...
Hence we can apply Definition \ref{spaces-perfect-definition-proper-over-base}.
...
\source{stacks:0CZJ}
\href{https://stacks.math.columbia.edu/tag/0CZJ}{\texttt{Stacks tag 0CZJ}}
\group{spaces-perfect}
...
Thus the lemma follows from
Lemma \ref{spaces-perfect-lemma-base-change-closed-proper-over-base}.
\end{proof}

\begin{lemma}[Cat module support proper over base]
\label{spaces-perfect-lemma-cat-module-support-proper-over-base}
\source{stacks:0CZK}
\href{https://stacks.math.columbia.edu/tag/0CZK}{\texttt{Stacks tag 0CZK}}
\group{spaces-perfect}
...
is clear from Lemmas \ref{spaces-perfect-lemma-closed-closed-proper-over-base} and
...
\source{stacks:08GC}
\href{https://stacks.math.columbia.edu/tag/08GC}{\texttt{Stacks tag 08GC}}
\group{spaces-perfect}
...
\begin{proof}
By Lemma \ref{spaces-perfect-lemma-module-support-proper-over-base}
...
\source{stacks:08GK}
\href{https://stacks.math.columbia.edu/tag/08GK}{\texttt{Stacks tag 08GK}}
\group{spaces-perfect}
...
By assumption and Lemma \ref{spaces-perfect-lemma-support-proper-over-base-pushforward}
...
\ref{spaces-cohomology-lemma-vanishing-higher-direct-images}
or from
Lemma \ref{spaces-perfect-lemma-quasi-coherence-direct-image}.
\end{proof}

\begin{lemma}[Direct image coherent bdd below]
\label{spaces-perfect-lemma-direct-image-coherent-bdd-below}
\source{stacks:0D0R}
\href{https://stacks.math.columbia.edu/tag/0D0R}{\texttt{Stacks tag 0D0R}}
\group{spaces-perfect}
...
Lemma \ref{spaces-perfect-lemma-direct-image-coherent}.
...
\source{stacks:0D0S}
\href{https://stacks.math.columbia.edu/tag/0D0S}{\texttt{Stacks tag 0D0S}}
\group{spaces-perfect}
...
\source{stacks:0D0T}
\href{https://stacks.math.columbia.edu/tag/0D0T}{\texttt{Stacks tag 0D0T}}
\group{spaces-perfect}
...
Lemmas \ref{spaces-perfect-lemma-coherent-internal-hom} and
...
\begin{definition}[Elementary distinguished square]
\label{spaces-perfect-definition-elementary-distinguished-square}
\source{stacks:08GM}
\href{https://stacks.math.columbia.edu/tag/08GM}{\texttt{Stacks tag 08GM}}
\group{spaces-perfect}

Let $S$ be a scheme. A commutative diagram
$$
\begin{array}{cc}U \times_W V \longrightarrow\downarrow & V \overset{f}{\downarrow} \\ U \overset{j}{\longrightarrow} & W\end{array}
$$
...
\begin{lemma}[Make more elementary distinguished squares]
\label{spaces-perfect-lemma-make-more-elementary-distinguished-squares}
\source{stacks:08GN}
\href{https://stacks.math.columbia.edu/tag/08GN}{\texttt{Stacks tag 08GN}}
\group{spaces-perfect}
...
\source{stacks:08GP}
\href{https://stacks.math.columbia.edu/tag/08GP}{\texttt{Stacks tag 08GP}}
\group{spaces-perfect}
...
Lemma \ref{spaces-perfect-lemma-make-more-elementary-distinguished-squares}.
...
\begin{lemma}[Induction principle separated]
\label{spaces-perfect-lemma-induction-principle-separated}
\source{stacks:08GQ}
\href{https://stacks.math.columbia.edu/tag/08GQ}{\texttt{Stacks tag 08GQ}}
\group{spaces-perfect}
...
\source{stacks:08GR}
\href{https://stacks.math.columbia.edu/tag/08GR}{\texttt{Stacks tag 08GR}}
\group{spaces-perfect}

How to choose the collection $\mathcal{B}$ in
Lemma \ref{spaces-perfect-lemma-induction-principle-separated}?
...
Lemma \ref{spaces-perfect-lemma-induction-principle-separated} reproduces
Lemma \ref{spaces-perfect-lemma-induction-principle}.
\item If $X$ is quasi-compact with affine diagonal
over $\mathbf{Z}$ (as in Properties of Spaces, Definition
\ref{spaces-properties-definition-separated}), then we can choose
$\mathcal{B}$ to be the set of objects
of $X_{spaces, \etale}$ which are quasi-compact and have affine
diagonal over $\mathbf{Z}$. Again $X \in \mathcal{B}$ and $\mathcal{B}$
...
\begin{lemma}[Induction principle enlarge]
\label{spaces-perfect-lemma-induction-principle-enlarge}
\source{stacks:09IT}
\href{https://stacks.math.columbia.edu/tag/09IT}{\texttt{Stacks tag 09IT}}
\group{spaces-perfect}
...
\begin{proof}
We can deduce this from Lemma \ref{spaces-perfect-lemma-induction-principle-separated},
but instead we will give a direct argument by explicitly redoing the proof of
Lemma \ref{spaces-perfect-lemma-induction-principle}. We will use the filtration
$$
\emptyset = U_{n + 1} \subset
U_n \subset U_{n - 1} \subset \ldots \subset U_1 = X
$$
...
\source{stacks:08GV}
\href{https://stacks.math.columbia.edu/tag/08GV}{\texttt{Stacks tag 08GV}}
\group{spaces-perfect}
...
\source{stacks:08GW}
\href{https://stacks.math.columbia.edu/tag/08GW}{\texttt{Stacks tag 08GW}}
\group{spaces-perfect}
...
By Lemma \ref{spaces-perfect-lemma-make-more-elementary-distinguished-squares}
...
Lemma \ref{spaces-perfect-lemma-exact-sequence-lower-shriek} and applying
...
\source{stacks:08JK}
\href{https://stacks.math.columbia.edu/tag/08JK}{\texttt{Stacks tag 08JK}}
\group{spaces-perfect}
...
$$
of Lemma \ref{spaces-perfect-lemma-exact-sequence-j-star}
...
\source{stacks:08H9}
\href{https://stacks.math.columbia.edu/tag/08H9}{\texttt{Stacks tag 08H9}}
\group{spaces-perfect}
...
$$
\begin{array}{ccc} & \ldots \longrightarrow & \Ext^{-1}(E_{U \times_X V}, F_{U \times_X V}) \swarrow \\ \Hom(E, F) \longrightarrow & \Hom(E_U, F_U) \oplus
\Hom(E_V, F_V) \longrightarrow & \Hom(E_{U \times_X V}, F_{U \times_X V})\end{array}
$$
...
Lemma \ref{spaces-perfect-lemma-exact-sequence-lower-shriek}
...
\source{stacks:0CRS}
\href{https://stacks.math.columbia.edu/tag/0CRS}{\texttt{Stacks tag 0CRS}}
\group{spaces-perfect}
...
$\textit{Mod}(\mathcal{O}_X)$, see Injectives, Theorem
\ref{injectives-theorem-K-injective-embedding-grothendieck}.
In the proof of Lemma \ref{spaces-perfect-lemma-exact-sequence-j-star}
...
\begin{lemma}[Restrict lower shriek]
\label{spaces-perfect-lemma-restrict-lower-shriek}
\source{stacks:08HA}
\href{https://stacks.math.columbia.edu/tag/08HA}{\texttt{Stacks tag 08HA}}
\group{spaces-perfect}
...
\begin{lemma}[Pushforward with support in open]
\label{spaces-perfect-lemma-pushforward-with-support-in-open}
\source{stacks:08GG}
\href{https://stacks.math.columbia.edu/tag/08GG}{\texttt{Stacks tag 08GG}}
\group{spaces-perfect}
...
Thus (1)(a) follows from Lemma \ref{spaces-perfect-lemma-exact-sequence-j-star}.
...
Lemma \ref{spaces-perfect-lemma-restrict-direct-image-open} we have
$(Rj_*F)|_U = Rj_{W, *}(F|_W) = 0$ because $F|_W = 0$ by our assumption.
Similarly $(j_!F)|_U = j_{W!}(F|_W) = 0$ by
Lemma \ref{spaces-perfect-lemma-restrict-lower-shriek}.
...
\ref{spaces-perfect-lemma-restrict-lower-shriek}, and
...
Lemmas \ref{spaces-perfect-lemma-exact-sequence-lower-shriek} and
\ref{spaces-perfect-lemma-exact-sequence-j-star} show that
...
\source{stacks:08HB}
\href{https://stacks.math.columbia.edu/tag/08HB}{\texttt{Stacks tag 08HB}}
\group{spaces-perfect}
...
total direct image (Lemma \ref{spaces-perfect-lemma-restrict-direct-image-open})
...
$$
\begin{array}{cccc}F \longrightarrow\downarrow & Rj_{U, *}F|_U \oplus Rj_{V, *}F|_V \longrightarrow\downarrow & Rj_{U \times_X V, *}F|_{U \times_X V} \longrightarrow\downarrow & F[1] \downarrow \\ F \longrightarrow & Rj_{U, *}A \oplus Rj_{V, *}B \longrightarrow & Rj_{U \times_X V, *}(B|_{U \times_X V}) \longrightarrow & F[1]\end{array}
$$
...
Section \ref{spaces-perfect-section-better-coherator}
...
\source{stacks:08GY}
\href{https://stacks.math.columbia.edu/tag/08GY}{\texttt{Stacks tag 08GY}}
\group{spaces-perfect}
...
Remark \ref{spaces-perfect-remark-match-total-direct-images}. The case of schemes is
...
\source{stacks:08GZ}
\href{https://stacks.math.columbia.edu/tag/08GZ}{\texttt{Stacks tag 08GZ}}
\group{spaces-perfect}
...
\source{stacks:08H0}
\href{https://stacks.math.columbia.edu/tag/08H0}{\texttt{Stacks tag 08H0}}
\group{spaces-perfect}
...
$$
\begin{array}{cc}\QCoh(\mathcal{O}_X) \overset{{\epsilon_*}}{\longrightarrow} & \QCoh(\mathcal{O}_{X_0}) \overset{{\epsilon^*}}{\longleftarrow}\end{array}
$$
see Lemma
\ref{spaces-perfect-lemma-derived-quasi-coherent-small-etale-site}.
...
\source{stacks:09TG}
\href{https://stacks.math.columbia.edu/tag/09TG}{\texttt{Stacks tag 09TG}}
\group{spaces-perfect}
...
$$
\begin{array}{cc}D(\QCoh(\mathcal{O}_V)) \underset{\Phi}{\downarrow}\underset{i_V}{\longrightarrow} & D_\QCoh(\mathcal{O}_V) \overset{Rj_*}{\downarrow} \\ D(\QCoh(\mathcal{O}_W)) \overset{i_W}{\longrightarrow} & D_\QCoh(\mathcal{O}_W)\end{array}
$$
...
More precisely, we will use Lemma \ref{spaces-perfect-lemma-induction-principle-enlarge}.
...
(Lemma \ref{spaces-perfect-lemma-affine-coherator}).
...
$$
\begin{array}{cc}\Hom_{D(\QCoh(\mathcal{O}_X))}(A, B'[-1]) \longrightarrow\downarrow & \Hom_{D(\mathcal{O}_X)}(i_X(A), i_X(B')[-1]) \downarrow \\ \Hom_{D(\QCoh(\mathcal{O}_X))}(A, B) \longrightarrow\downarrow & \Hom_{D(\mathcal{O}_X)}(i_X(A), i_X(B)) \downarrow \\ \Hom_{D(\QCoh(\mathcal{O}_X))}(A, B'') \longrightarrow\downarrow & \Hom_{D(\mathcal{O}_X)}(i_X(A), i_X(B'')) \downarrow \\ \Hom_{D(\QCoh(\mathcal{O}_X))}(A, B') \longrightarrow & \Hom_{D(\mathcal{O}_X)}(i_X(A), i_X(B'))\end{array}
$$
...
Lemmas \ref{spaces-perfect-lemma-affine-coherator} and
\ref{spaces-perfect-lemma-flat-pushforward-coherator}
...
\source{stacks:08H1}
\href{https://stacks.math.columbia.edu/tag/08H1}{\texttt{Stacks tag 08H1}}
\group{spaces-perfect}
...
the morphism $V \to W$ is affine as $W$ has affine diagonal over $\mathbf{Z}$
and $V$ is affine
(Morphisms of Spaces, Lemma \ref{spaces-morphisms-lemma-affine-permanence}).
Lemma \ref{spaces-perfect-lemma-affine-pushforward} then guarantees that
the assumption of Lemma \ref{spaces-perfect-lemma-argument-proves} holds.
Hence we conclude.
\end{proof}
...
\source{stacks:0CSR}
\href{https://stacks.math.columbia.edu/tag/0CSR}{\texttt{Stacks tag 0CSR}}
\group{spaces-perfect}
...
Proposition \ref{spaces-perfect-proposition-quasi-compact-affine-diagonal}.
...
is an isomorphism''.
By Remark \ref{spaces-perfect-remark-how-to} conditions (1), (2), and (3)(a) of
Lemma \ref{spaces-perfect-lemma-induction-principle-separated} hold and we are
...
Hence $P(U)$ holds by Lemma \ref{spaces-perfect-lemma-affine-pushforward}.
...
\begin{lemma}[Affine injective colimit direct sum pushforwards artin]
\label{spaces-perfect-lemma-affine-injective-colimit-direct-sum-pushforwards-artin}
\source{stacks:09TI}
\href{https://stacks.math.columbia.edu/tag/09TI}{\texttt{Stacks tag 09TI}}
\group{spaces-perfect}
...
\begin{lemma}[Injective colimit direct sum pushforwards artin]
\label{spaces-perfect-lemma-injective-colimit-direct-sum-pushforwards-artin}
\source{stacks:09TJ}
\href{https://stacks.math.columbia.edu/tag/09TJ}{\texttt{Stacks tag 09TJ}}
\group{spaces-perfect}
...
$\mathcal{J}'$ proved in
Lemma \ref{spaces-perfect-lemma-affine-injective-colimit-direct-sum-pushforwards-artin}.
\end{proof}

\begin{lemma}[Flat pullback injective quasi coherent]
\label{spaces-perfect-lemma-flat-pullback-injective-quasi-coherent}
\source{stacks:09TK}
\href{https://stacks.math.columbia.edu/tag/09TK}{\texttt{Stacks tag 09TK}}
\group{spaces-perfect}
...
\begin{lemma}[Injective pushforward]
\label{spaces-perfect-lemma-injective-pushforward}
\source{stacks:09TL}
\href{https://stacks.math.columbia.edu/tag/09TL}{\texttt{Stacks tag 09TL}}
\group{spaces-perfect}
...
as in Lemma \ref{spaces-perfect-lemma-injective-colimit-direct-sum-pushforwards-artin}.
...
\source{stacks:09TM}
\href{https://stacks.math.columbia.edu/tag/09TM}{\texttt{Stacks tag 09TM}}
\group{spaces-perfect}
...
with required vanishing because of Lemma \ref{spaces-perfect-lemma-injective-pushforward}.
\end{proof}

\begin{proposition}[Noetherian]
\label{spaces-perfect-proposition-Noetherian}
\source{stacks:09TN}
\href{https://stacks.math.columbia.edu/tag/09TN}{\texttt{Stacks tag 09TN}}
\group{spaces-perfect}
...
\begin{proof}
Follows immediately from Lemmas \ref{spaces-perfect-lemma-Noetherian-pushforward} and
\ref{spaces-perfect-lemma-argument-proves}.
\end{proof}
...
\begin{lemma}[Descend finite type]
\label{spaces-perfect-lemma-descend-finite-type}
\source{stacks:08HD}
\href{https://stacks.math.columbia.edu/tag/08HD}{\texttt{Stacks tag 08HD}}
\group{spaces-perfect}
...
\begin{lemma}[Descend pseudo coherent]
\label{spaces-perfect-lemma-descend-pseudo-coherent}
\source{stacks:08HE}
\href{https://stacks.math.columbia.edu/tag/08HE}{\texttt{Stacks tag 08HE}}
\group{spaces-perfect}
...
By Lemma \ref{spaces-perfect-lemma-epsilon-flat} it follows that $E$ is an object of
$D^-(\mathcal{O}_X)$.
...
Lemma \ref{spaces-perfect-lemma-descend-finite-type}.
...
\begin{lemma}[Descend tor amplitude]
\label{spaces-perfect-lemma-descend-tor-amplitude}
\source{stacks:08HF}
\href{https://stacks.math.columbia.edu/tag/08HF}{\texttt{Stacks tag 08HF}}
\group{spaces-perfect}
...
morphism of ringed sites (Lemma \ref{spaces-perfect-lemma-epsilon-flat})
we have
$$
...
Lemma \ref{spaces-perfect-lemma-epsilon-flat}.
\end{proof}

\begin{lemma}[Tor dimension rel]
\label{spaces-perfect-lemma-tor-dimension-rel}
\source{stacks:0DK7}
\href{https://stacks.math.columbia.edu/tag/0DK7}{\texttt{Stacks tag 0DK7}}
\group{spaces-perfect}
...
\source{stacks:08HG}
\href{https://stacks.math.columbia.edu/tag/08HG}{\texttt{Stacks tag 08HG}}
\group{spaces-perfect}
...
Lemmas \ref{spaces-perfect-lemma-descend-pseudo-coherent} and
...
\source{stacks:08JL}
\href{https://stacks.math.columbia.edu/tag/08JL}{\texttt{Stacks tag 08JL}}
\group{spaces-perfect}
...
\source{stacks:08IK}
\href{https://stacks.math.columbia.edu/tag/08IK}{\texttt{Stacks tag 08IK}}
\group{spaces-perfect}
...
if and only if $E_0$ is by Lemma \ref{spaces-perfect-lemma-descend-pseudo-coherent}.
Similarly, $H^i(E_0)$ is of finite type (i.e., coherent) if and only if
$H^i(E)$ is by Lemma \ref{spaces-perfect-lemma-descend-finite-type}.
...
\source{stacks:08IL}
\href{https://stacks.math.columbia.edu/tag/08IL}{\texttt{Stacks tag 08IL}}
\group{spaces-perfect}
...
$$
as $\epsilon$ is flat (Lemma \ref{spaces-perfect-lemma-epsilon-flat}).
...
\begin{lemma}[Descend RHom]
\label{spaces-perfect-lemma-descend-RHom}
\source{stacks:08JP}
\href{https://stacks.math.columbia.edu/tag/08JP}{\texttt{Stacks tag 08JP}}
\group{spaces-perfect}
...
\begin{proof}
Recall that $\epsilon$ is flat (Lemma \ref{spaces-perfect-lemma-epsilon-flat}) and
...
\source{stacks:0A8A}
\href{https://stacks.math.columbia.edu/tag/0A8A}{\texttt{Stacks tag 0A8A}}
\group{spaces-perfect}
...
via the criterion of Lemma \ref{spaces-perfect-lemma-check-quasi-coherence-on-covering},
the criterion of Lemmas \ref{spaces-perfect-lemma-descend-pseudo-coherent} and
\ref{spaces-perfect-lemma-descend-perfect},
and the result of Lemma \ref{spaces-perfect-lemma-descend-RHom}.
\end{proof}

\begin{lemma}[Internal hom evaluate tensor isomorphism]
\label{spaces-perfect-lemma-internal-hom-evaluate-tensor-isomorphism}
\source{stacks:0E4Q}
\href{https://stacks.math.columbia.edu/tag/0E4Q}{\texttt{Stacks tag 0E4Q}}
\group{spaces-perfect}
...
Lemma \ref{spaces-perfect-lemma-derived-quasi-coherent-small-etale-site}.
Then we see that Lemma \ref{spaces-perfect-lemma-descend-RHom}
...
\source{stacks:08HI}
\href{https://stacks.math.columbia.edu/tag/08HI}{\texttt{Stacks tag 08HI}}
\group{spaces-perfect}
...
\source{stacks:08HJ}
\href{https://stacks.math.columbia.edu/tag/08HJ}{\texttt{Stacks tag 08HJ}}
\group{spaces-perfect}
...
Definition \ref{spaces-perfect-definition-approximation-holds} with
\begin{enumerate}
...
\source{stacks:08HK}
\href{https://stacks.math.columbia.edu/tag/08HK}{\texttt{Stacks tag 08HK}}
\group{spaces-perfect}
...
We have $Rj_*E|_V = E$ by Lemma \ref{spaces-perfect-lemma-pushforward-with-support-in-open}
which is perfect. We have $Rj_*E|_U = 0$ because
$E|_{V \setminus j^{-1}(T)} = 0$ (use
Lemma \ref{spaces-perfect-lemma-restrict-direct-image-open}).
\end{proof}

\begin{lemma}[Open]
\label{spaces-perfect-lemma-open}
\source{stacks:08HL}
\href{https://stacks.math.columbia.edu/tag/08HL}{\texttt{Stacks tag 08HL}}
\group{spaces-perfect}

Let $S$ be a scheme. Let $(U \subset X, j : V \to X)$ be an elementary
distinguished square of algebraic spaces over $S$. Let $T$ be a closed
subset of $|X| \setminus |U|$ and let $(T, E, m)$ be a triple as in
Definition \ref{spaces-perfect-definition-approximation-holds}. If
\begin{enumerate}
...
Lemma \ref{spaces-perfect-lemma-pushforward-perfect}. On the other hand,
$Rj_*P = j_!P$ by Lemma \ref{spaces-perfect-lemma-pushforward-with-support-in-open}.
...
\source{stacks:08HM}
\href{https://stacks.math.columbia.edu/tag/08HM}{\texttt{Stacks tag 08HM}}
\group{spaces-perfect}
...
triple $(T, E, m)$ as in Definition \ref{spaces-perfect-definition-approximation-holds}
...
$(T_0, E_0, m)$. By Lemma \ref{spaces-perfect-lemma-descend-perfect}
...
\source{stacks:08HN}
\href{https://stacks.math.columbia.edu/tag/08HN}{\texttt{Stacks tag 08HN}}
\group{spaces-perfect}
...
Definition \ref{spaces-perfect-definition-approximation}
...
Lemma \ref{spaces-perfect-lemma-approximation-affine}
guarantees the existence of an approximation
$P \to E|_V$ of $(T', E|_V, m)$ on $V$.
Applying Lemma \ref{spaces-perfect-lemma-open} we see that
...
Lemma \ref{spaces-perfect-lemma-derived-quasi-coherent-small-etale-site}
(and the compatibilities of Remark \ref{spaces-perfect-remark-match-total-direct-images})
...
$$
lifts to $Q \to E|_V$. By Lemma \ref{spaces-perfect-lemma-glue}
...
\source{stacks:08HP}
\href{https://stacks.math.columbia.edu/tag/08HP}{\texttt{Stacks tag 08HP}}
\group{spaces-perfect}
...
Lemma \ref{spaces-perfect-lemma-induction-principle}
and Lemmas \ref{spaces-perfect-lemma-induction-step} and \ref{spaces-perfect-lemma-approximation-affine}.
\end{proof}
...
\source{stacks:09IV}
\href{https://stacks.math.columbia.edu/tag/09IV}{\texttt{Stacks tag 09IV}}
\group{spaces-perfect}
...
Lemma \ref{spaces-perfect-lemma-induction-principle-enlarge} to prove this.
...
and \'etale site agree, see Lemma \ref{spaces-perfect-lemma-descend-perfect}.
...
\source{stacks:09IW}
\href{https://stacks.math.columbia.edu/tag/09IW}{\texttt{Stacks tag 09IW}}
\group{spaces-perfect}

The proof of Lemma \ref{spaces-perfect-lemma-lift-map-from-perfect-complex-with-support}
shows that
$$
...
\source{stacks:09IX}
\href{https://stacks.math.columbia.edu/tag/09IX}{\texttt{Stacks tag 09IX}}
\group{spaces-perfect}
...
\begin{proof}
Special case of Lemma \ref{spaces-perfect-lemma-lift-map-from-perfect-complex-with-support}.
\end{proof}

\begin{theorem}[Bondal van den Bergh]
\label{spaces-perfect-theorem-bondal-van-den-Bergh}
\source{stacks:09IY}
\href{https://stacks.math.columbia.edu/tag/09IY}{\texttt{Stacks tag 09IY}}
\group{spaces-perfect}
...
This follows from Lemma \ref{spaces-perfect-lemma-derived-quasi-coherent-small-etale-site}
and
Derived Categories of Schemes,
...
Lemma \ref{spaces-perfect-lemma-direct-summand-of-a-restriction} we may
...
(see Definition \ref{spaces-perfect-definition-elementary-distinguished-square}).
...
restriction to $V$ is $K$ (see Lemmas \ref{spaces-perfect-lemma-pushforward-perfect}
and \ref{spaces-perfect-lemma-pushforward-with-support-in-open}).
...
By Lemma \ref{spaces-perfect-lemma-pushforward-with-support-in-open}
...
\source{stacks:0E4R}
\href{https://stacks.math.columbia.edu/tag/0E4R}{\texttt{Stacks tag 0E4R}}
\group{spaces-perfect}
...
(see Theorem \ref{spaces-perfect-theorem-bondal-van-den-Bergh}).
...
These conditions hold if $f$ is affine (Lemma \ref{spaces-perfect-lemma-affine-morphism})
or if $f$ is an open immersion, or if $f$ is a composition of such.
\end{remark}

The following result is an strengthening of
Theorem \ref{spaces-perfect-theorem-bondal-van-den-Bergh}
...
\source{stacks:0AEC}
\href{https://stacks.math.columbia.edu/tag/0AEC}{\texttt{Stacks tag 0AEC}}
\group{spaces-perfect}
...
Lemma \ref{spaces-perfect-lemma-lift-map-from-perfect-complex-with-support}
...
$$
\begin{array}{ccc}W \underset{j}{\longrightarrow} & V & Z \cap T \longleftarrow\downarrow \\ V \setminus f^{-1}Z \overset{j'}{\uparrow}\underset{j''}{\nearrow} &  & Z \nwarrow\end{array}
$$
...
\source{stacks:09M8}
\href{https://stacks.math.columbia.edu/tag/09M8}{\texttt{Stacks tag 09M8}}
\group{spaces-perfect}
...
Lemma \ref{spaces-perfect-lemma-quasi-coherence-pushforward-direct-sums}
...
Lemma \ref{spaces-perfect-lemma-derived-quasi-coherent-small-etale-site} and
\ref{spaces-perfect-lemma-descend-perfect}
...
\source{stacks:0GFC}
\href{https://stacks.math.columbia.edu/tag/0GFC}{\texttt{Stacks tag 0GFC}}
\group{spaces-perfect}
...
$D_\QCoh(\mathcal{O}_X)$. By Theorem \ref{spaces-perfect-theorem-bondal-van-den-Bergh}
there is at least one of these. Combining
Lemma \ref{spaces-perfect-lemma-quasi-coherence-direct-sums} with
Proposition \ref{spaces-perfect-proposition-compact-is-perfect} and with
...
\source{stacks:0AED}
\href{https://stacks.math.columbia.edu/tag/0AED}{\texttt{Stacks tag 0AED}}
\group{spaces-perfect}
...
By Proposition \ref{spaces-perfect-proposition-compact-is-perfect}
...
Lemma \ref{spaces-perfect-lemma-generator-with-support}.
...
\source{stacks:0GFD}
\href{https://stacks.math.columbia.edu/tag/0GFD}{\texttt{Stacks tag 0GFD}}
\group{spaces-perfect}
...
$D_{\QCoh, T}(\mathcal{O}_X)$. By Lemma \ref{spaces-perfect-lemma-generator-with-support}
there is at least one of these. Combining the fact that
$D_{\QCoh, T}(\mathcal{O}_X)$ has direct sums with
Lemma \ref{spaces-perfect-lemma-compact-is-perfect-with-support} and with
Derived Categories, Proposition
\ref{derived-proposition-generator-versus-classical-generator}
...
\source{stacks:0AEE}
\href{https://stacks.math.columbia.edu/tag/0AEE}{\texttt{Stacks tag 0AEE}}
\group{spaces-perfect}
...
Lemma \ref{spaces-perfect-lemma-quasi-coherence-internal-hom} for quasi-coherence.
...
Lemma \ref{spaces-perfect-lemma-generator-with-support}. Write
$$
K = \text{hocolim} K_n
$$
...
\source{stacks:09MA}
\href{https://stacks.math.columbia.edu/tag/09MA}{\texttt{Stacks tag 09MA}}
\group{spaces-perfect}
...
\source{stacks:09MB}
\href{https://stacks.math.columbia.edu/tag/09MB}{\texttt{Stacks tag 09MB}}
\group{spaces-perfect}
...
\ref{spaces-perfect-lemma-pseudo-coherent} (to see that a perfect complex
...
Lemma \ref{spaces-perfect-lemma-application-nice-K-injective}, we have
$$
...
\source{stacks:09MC}
\href{https://stacks.math.columbia.edu/tag/09MC}{\texttt{Stacks tag 09MC}}
\group{spaces-perfect}
...
thing exists by Theorem \ref{spaces-perfect-theorem-bondal-van-den-Bergh}
...
are nonzero by Lemma \ref{spaces-perfect-lemma-ext-from-perfect-into-bounded-QCoh}.
...
$D(\mathcal{O}_X)$, see Proposition \ref{spaces-perfect-proposition-compact-is-perfect}.
...
Lemma \ref{spaces-perfect-lemma-tensor-with-QCoh-complex} that we obtain
$$
- \otimes_E^\mathbf{L} K^\bullet :
...
\source{stacks:0DK8}
\href{https://stacks.math.columbia.edu/tag/0DK8}{\texttt{Stacks tag 0DK8}}
\group{spaces-perfect}
...
The analogue of Theorem \ref{spaces-perfect-theorem-DQCoh-is-Ddga} holds
for $D_{\QCoh, T}(\mathcal{O}_X)$.
This follows from the exact same argument as in the proof
of the theorem, using
Lemmas \ref{spaces-perfect-lemma-generator-with-support} and
\ref{spaces-perfect-lemma-compact-is-perfect-with-support}
and a variant of Lemma \ref{spaces-perfect-lemma-tensor-with-QCoh-complex}
with supports.
...
\source{stacks:0DK9}
\href{https://stacks.math.columbia.edu/tag/0DK9}{\texttt{Stacks tag 0DK9}}
\group{spaces-perfect}

Let $X$ be a quasi-compact and quasi-separated algebraic space over a ring $R$.
By the construction of the proof of
Theorem \ref{spaces-perfect-theorem-DQCoh-is-Ddga}
...
\source{stacks:0DKB}
\href{https://stacks.math.columbia.edu/tag/0DKB}{\texttt{Stacks tag 0DKB}}
\group{spaces-perfect}
...
Definitions \ref{spaces-perfect-definition-approximation-holds} and
\ref{spaces-perfect-definition-approximation} and
...
Lemma \ref{spaces-perfect-lemma-ext-from-perfect-into-bounded-QCoh}
...
\source{stacks:0DKC}
\href{https://stacks.math.columbia.edu/tag/0DKC}{\texttt{Stacks tag 0DKC}}
\group{spaces-perfect}
...
Lemma \ref{spaces-perfect-lemma-pseudo-coherent-hocolim}
...
In Section \ref{spaces-perfect-section-coherator} we constructed and studied
...
\source{stacks:0CR4}
\href{https://stacks.math.columbia.edu/tag/0CR4}{\texttt{Stacks tag 0CR4}}
\group{spaces-perfect}
...
$RQ_X$ of Section \ref{spaces-perfect-section-coherator} is a right adjoint to the functor
$D(\QCoh(\mathcal{O}_X)) \to D(\mathcal{O}_X)$.
...
$$
in $D(\mathcal{O}_X)$ of Lemma \ref{spaces-perfect-lemma-exact-sequence-j-star}.
...
by Lemma \ref{spaces-perfect-lemma-quasi-coherence-direct-image}.
On the other hand, if $M$ in $D_\QCoh(\mathcal{O}_X)$, then
$$
\Hom(M, Rj_*Q) = \Hom(Lj^*M, Q) = 0
$$
because $Lj^*M$ is in $D_\QCoh(\mathcal{O}_U)$ by
Lemma \ref{spaces-perfect-lemma-quasi-coherence-pullback}.
This finishes the proof.
\end{proof}
...
(Lemma \ref{spaces-perfect-lemma-quasi-coherence-direct-sums}).
On the other hand, $D_\QCoh(\mathcal{O}_X)$
is compactly generated because it has a perfect
generator Theorem \ref{spaces-perfect-theorem-bondal-van-den-Bergh}
...
\source{stacks:0CR5}
\href{https://stacks.math.columbia.edu/tag/0CR5}{\texttt{Stacks tag 0CR5}}
\group{spaces-perfect}
...
\source{stacks:0CR6}
\href{https://stacks.math.columbia.edu/tag/0CR6}{\texttt{Stacks tag 0CR6}}
\group{spaces-perfect}

Let $S$ be a scheme. Let $(U \subset X, f : V \to X)$ be an
elementary distinguished square of algebraic spaces over $S$.
Assume $X$, $U$, $V$ are quasi-compact and quasi-separated.
By Lemma \ref{spaces-perfect-lemma-better-coherator} the functors
...
Lemma \ref{spaces-perfect-lemma-exact-sequence-j-star}
and using Lemma \ref{spaces-perfect-lemma-pushforward-better-coherator} three times.
\end{remark}

\begin{lemma}[Boundedness better coherator]
\label{spaces-perfect-lemma-boundedness-better-coherator}
\source{stacks:0CSS}
\href{https://stacks.math.columbia.edu/tag/0CSS}{\texttt{Stacks tag 0CSS}}
\group{spaces-perfect}

Let $S$ be a scheme.
Let $X$ be a quasi-compact and quasi-separated algebraic space over $S$.
The functor $DQ_X$ of Lemma \ref{spaces-perfect-lemma-better-coherator}
...
See Lemma \ref{spaces-perfect-lemma-affine-coherator}.
...
of Remark \ref{spaces-perfect-remark-explain-consequence}.
\end{proof}

\begin{example}[Inverse limit quasi coherent]
\label{spaces-perfect-example-inverse-limit-quasi-coherent}
\source{stacks:0CST}
\href{https://stacks.math.columbia.edu/tag/0CST}{\texttt{Stacks tag 0CST}}
\group{spaces-perfect}
...
by Lemma \ref{spaces-perfect-lemma-boundedness-better-coherator}.
\end{example}
...
\source{stacks:08IN}
\href{https://stacks.math.columbia.edu/tag/08IN}{\texttt{Stacks tag 08IN}}
\group{spaces-perfect}
...
\source{stacks:08IP}
\href{https://stacks.math.columbia.edu/tag/08IP}{\texttt{Stacks tag 08IP}}
\group{spaces-perfect}
...
commutative diagram
$$
\begin{array}{cc}\Spec(k) \underset{\overline{y}}{\downarrow}\underset{\overline{b}}{\searrow}\underset{\overline{x}}{\longrightarrow} & X \downarrow \\ Y \longrightarrow & B\end{array}
$$
...
\source{stacks:08IQ}
\href{https://stacks.math.columbia.edu/tag/08IQ}{\texttt{Stacks tag 08IQ}}
\group{spaces-perfect}
...
$$
\begin{array}{ccc}U \downarrow\longrightarrow & W \downarrow & V \downarrow\longleftarrow \\ X \longrightarrow & B & Y \longleftarrow\end{array}
$$
...
Definition \ref{spaces-perfect-definition-tor-independent}.
...
Definition \ref{spaces-perfect-definition-tor-independent} lying over the points
$x, y, b$. Recall that
...
\source{stacks:08IR}
\href{https://stacks.math.columbia.edu/tag/08IR}{\texttt{Stacks tag 08IR}}
\group{spaces-perfect}
...
$$
is an isomorphism, see Lemma \ref{spaces-perfect-lemma-affine-morphism}
(and use Lemmas \ref{spaces-perfect-lemma-quasi-coherence-pullback},
...
By Lemma \ref{spaces-perfect-lemma-affine-morphism-pull-push} the map becomes a map
$$
...
Lemma \ref{spaces-perfect-lemma-cohomology-base-change} it suffices to prove that
...
(see
Lemma \ref{spaces-perfect-lemma-tor-independent}
and
...
\source{stacks:0E4S}
\href{https://stacks.math.columbia.edu/tag/0E4S}{\texttt{Stacks tag 0E4S}}
\group{spaces-perfect}
...
$$
by Lemma \ref{spaces-perfect-lemma-affine-morphism-pull-push}. In both cases the complex
$R\SheafHom(M, K)$ is an object of $D_\QCoh(\mathcal{O}_X)$ by
Lemma \ref{spaces-perfect-lemma-quasi-coherence-internal-hom}. There is a natural map
$$
...
Lemma \ref{spaces-perfect-lemma-internal-hom-evaluate-tensor-isomorphism}.
...
Lemma \ref{spaces-perfect-lemma-descend-tor-amplitude}, and
Cohomology on Sites, Lemma \ref{sites-cohomology-lemma-tor-amplitude-pullback}
...
by Lemma \ref{spaces-perfect-lemma-affine-morphism-pull-push}.
Hence the result follows from
Lemma \ref{spaces-perfect-lemma-compare-base-change}.
\end{proof}
...
\source{stacks:0E4T}
\href{https://stacks.math.columbia.edu/tag/0E4T}{\texttt{Stacks tag 0E4T}}
\group{spaces-perfect}

With notation as in Lemma \ref{spaces-perfect-lemma-affine-morphism-and-hom-out-of-perfect}.
The diagram
$$
...
\source{stacks:0DKD}
\href{https://stacks.math.columbia.edu/tag/0DKD}{\texttt{Stacks tag 0DKD}}
\group{spaces-perfect}
...
\source{stacks:0DKG}
\href{https://stacks.math.columbia.edu/tag/0DKG}{\texttt{Stacks tag 0DKG}}
\group{spaces-perfect}
...
$$
\begin{array}{ccc} & U \downarrow\overset{a}{\searrow} &  \\ V' \longrightarrow\overset{c}{\searrow} & V \overset{b}{\searrow} & X \overset{f}{\downarrow} \\  & Y' \overset{g}{\longrightarrow} & Y\end{array}
$$
...
$$
\begin{array}{cc}H^i(K_{\overline{x}}
\otimes_{\mathcal{O}_{Y, \overline{y}}}^\mathbf{L}
\mathcal{O}_{Y', \overline{y}'})
\otimes_{(\mathcal{O}_{X, \overline{x}}
\otimes_{\mathcal{O}_{Y, \overline{y}}}
\mathcal{O}_{Y', \overline{y}'})}
\mathcal{O}_{X', \overline{x}'}
\longrightarrow & H^i(K'_{\overline{x}'}) \\ H^i(K_{0, x} \otimes_{\mathcal{O}_{Y, y}}^\mathbf{L} \mathcal{O}_{Y', y'})
\otimes_{(\mathcal{O}_{X, x} \otimes_{\mathcal{O}_{Y, y}} \mathcal{O}_{Y', y'})}
\mathcal{O}_{X', x'}
\uparrow\longrightarrow & H^i(K'_{0, x'}) \uparrow\end{array}
$$
...
\source{stacks:0DKH}
\href{https://stacks.math.columbia.edu/tag/0DKH}{\texttt{Stacks tag 0DKH}}
\group{spaces-perfect}
...
Lemma \ref{spaces-perfect-lemma-single-complex-base-change-condition} hold, and
...
Lemma \ref{spaces-perfect-lemma-single-complex-base-change-condition}.
...
(Lemma \ref{spaces-perfect-lemma-unbounded-relative-mayer-vietoris})
we obtain a commutative diagram
$$
\begin{array}{cc}Lg^*Rf_*K \longrightarrow\downarrow & Rf'_*K' \downarrow \\ Lg^*Ra_*K|_U \oplus Lg^*Rb_*K|_V \longrightarrow\downarrow & Ra'_* K'|_{U'} \oplus Rb'_* K'|_{V'} \downarrow \\ Lg^*Rc_*K|_{U \times_X V} \longrightarrow\downarrow & Rc'_*K'|_{U' \times_{X'} V'} \downarrow \\ Lg^*Rf_* K[1] \longrightarrow & Rf'_* K'[1]\end{array}
$$
...
\source{stacks:0DKI}
\href{https://stacks.math.columbia.edu/tag/0DKI}{\texttt{Stacks tag 0DKI}}
\group{spaces-perfect}
...
Lemma \ref{spaces-perfect-lemma-single-complex-base-change-condition} hold, then
\begin{enumerate}
\item for $E \in D_\QCoh(\mathcal{O}_X)$ the equivalent
conditions of Lemma \ref{spaces-perfect-lemma-single-complex-base-change-condition} hold
for $L(g')^*(E \otimes^\mathbf{L} K) \to L(g')^*E \otimes^\mathbf{L} K'$,
\item if $E$ in $D(\mathcal{O}_X)$ is perfect the equivalent conditions of
Lemma \ref{spaces-perfect-lemma-single-complex-base-change-condition} hold for
...
\ref{spaces-perfect-lemma-quasi-coherence-tensor-product}, and
\ref{spaces-perfect-lemma-quasi-coherence-internal-hom} and
Cohomology on Sites, Lemmas
...
\source{stacks:0A1K}
\href{https://stacks.math.columbia.edu/tag/0A1K}{\texttt{Stacks tag 0A1K}}
\group{spaces-perfect}
...
To prove this, we apply Lemmas \ref{spaces-perfect-lemma-single-complex-base-change} and
\ref{spaces-perfect-lemma-single-complex-base-change-condition-inherited} to see that it
...
\source{stacks:08JQ}
\href{https://stacks.math.columbia.edu/tag/08JQ}{\texttt{Stacks tag 08JQ}}
\group{spaces-perfect}
...
algebraic spaces and consider the base change diagram
$$
\begin{array}{cc}X' \underset{h}{\longrightarrow}\underset{f'}{\downarrow} & X \overset{f}{\downarrow} \\ Y' \overset{g}{\longrightarrow} & Y\end{array}
$$
in other words $X' = Y' \times_Y X$. The lemma asserts that
$$
...
Lemmas \ref{spaces-perfect-lemma-single-complex-base-change} and
\ref{spaces-perfect-lemma-single-complex-base-change-condition-inherited} to see that it
suffices to prove the canonical map
$$
L(g')^*\mathcal{G}^\bullet \to (g')^*\mathcal{G}^\bullet
...
satisfies the equivalent conditions of
Lemma \ref{spaces-perfect-lemma-single-complex-base-change-condition}.
This was shown in the proof of Lemma \ref{spaces-perfect-lemma-base-change-tensor}.
\end{proof}
...
\source{stacks:08IS}
\href{https://stacks.math.columbia.edu/tag/08IS}{\texttt{Stacks tag 08IS}}
\group{spaces-perfect}
...
\begin{proof}
By Lemma \ref{spaces-perfect-lemma-direct-image-coherent} we see that $Rf_*E$ is an object of
...
Cohomology on Sites, Lemma \ref{sites-cohomology-lemma-perfect}.
By Lemma \ref{spaces-perfect-lemma-tor-qc-qs} it suffices to check that
...
and (2) and Lemma \ref{spaces-perfect-lemma-union-closed-proper-over-base}.
...
\source{stacks:0DKJ}
\href{https://stacks.math.columbia.edu/tag/0DKJ}{\texttt{Stacks tag 0DKJ}}
\group{spaces-perfect}
...
\begin{proof}
The object $K$ is perfect by Lemma \ref{spaces-perfect-lemma-perfect-direct-image}.
...
\source{stacks:0DKK}
\href{https://stacks.math.columbia.edu/tag/0DKK}{\texttt{Stacks tag 0DKK}}
\group{spaces-perfect}
...
Thus the perfectness of $K$ follows from Lemma \ref{spaces-perfect-lemma-tensor-perfect}.
\end{proof}

\section{A projection formula for Ext}
\label{spaces-perfect-section-ext}
Lemma \ref{spaces-perfect-lemma-compute-ext} (or similar results in the literature)
...
easily from Lemma \ref{spaces-perfect-lemma-cohomology-base-change}.

\begin{lemma}[Compute tensor perfect]
\label{spaces-perfect-lemma-compute-tensor-perfect}
\source{stacks:0A1M}
\href{https://stacks.math.columbia.edu/tag/0A1M}{\texttt{Stacks tag 0A1M}}
\group{spaces-perfect}

Assumptions and notation as in Lemma \ref{spaces-perfect-lemma-tensor-perfect}.
...
the third equality by Lemma \ref{spaces-perfect-lemma-cohomology-base-change}.
...
$$
\begin{array}{cc}H^i(B, K \otimes^\mathbf{L}_{\mathcal{O}_B} \mathcal{F}_3)
\longrightarrow\underset{\delta}{\downarrow} & H^i(X, E \otimes^\mathbf{L}_{\mathcal{O}_X}
(\mathcal{G}^\bullet \otimes_{\mathcal{O}_X} f^*\mathcal{F}_3)) \overset{\delta}{\downarrow} \\ H^{i + 1}(B, K \otimes^\mathbf{L}_{\mathcal{O}_B} \mathcal{F}_1)
...
\source{stacks:08JN}
\href{https://stacks.math.columbia.edu/tag/08JN}{\texttt{Stacks tag 08JN}}
\group{spaces-perfect}

Assumption and notation as in Lemma \ref{spaces-perfect-lemma-ext-perfect}.
Then there are functorial isomorphisms
$$
H^i(B, K \otimes^\mathbf{L}_{\mathcal{O}_B} \mathcal{F})
\longrightarrow
...
\begin{proof}
As in the proof of Lemma \ref{spaces-perfect-lemma-ext-perfect} let
...
follows from Lemma \ref{spaces-perfect-lemma-compute-tensor-perfect} applied to $E^\vee$
...
\source{stacks:08JR}
\href{https://stacks.math.columbia.edu/tag/08JR}{\texttt{Stacks tag 08JR}}
\group{spaces-perfect}
...
$(X, E, -m - 1 + a)$
(possible by Theorem \ref{spaces-perfect-theorem-approximation}).
...
$E$ is a perfect complex which is Lemma \ref{spaces-perfect-lemma-compute-ext-perfect}.
The statement on boundaries is explained in the proof of
Lemma \ref{spaces-perfect-lemma-compute-ext-perfect}.

\medskip\noindent
Proof of (B). As in the proof of (A) we may assume $X$ is Noetherian.
Observe that $E$ is pseudo-coherent by
Lemma \ref{spaces-perfect-lemma-identify-pseudo-coherent-noetherian}.
By Lemma \ref{spaces-perfect-lemma-pseudo-coherent-hocolim} we can write
...
$$
perfect on $Y$, see Lemma \ref{spaces-perfect-lemma-tensor-perfect}.
By Lemma \ref{spaces-perfect-lemma-compute-ext-perfect} and its proof and
...
\mathcal{G}^\bullet \otimes_{\mathcal{O}_X} f^*\mathcal{F})
\swarrow\searrow &  \\ H^i(Y, K_{n + 1} \otimes_{\mathcal{O}_Y}^\mathbf{L} \mathcal{F})
\longrightarrow &  & H^i(Y, K_n \otimes_{\mathcal{O}_Y}^\mathbf{L} \mathcal{F})\end{array}
$$
...
Lemma \ref{spaces-perfect-lemma-pseudo-coherent-hocolim}. The mapping property
...
\source{stacks:0DKL}
\href{https://stacks.math.columbia.edu/tag/0DKL}{\texttt{Stacks tag 0DKL}}
\group{spaces-perfect}

The pseudo-coherent complex $L$ of part (B) of Lemma \ref{spaces-perfect-lemma-compute-ext}
...
\source{stacks:09RH}
\href{https://stacks.math.columbia.edu/tag/09RH}{\texttt{Stacks tag 09RH}}
\group{spaces-perfect}
...
\source{stacks:09RI}
\href{https://stacks.math.columbia.edu/tag/09RI}{\texttt{Stacks tag 09RI}}
\group{spaces-perfect}

In Situation \ref{spaces-perfect-situation-descent}. Let $E_0$ and $K_0$ be objects of
...
by the induction principle of Lemma \ref{spaces-perfect-lemma-induction-principle}.
Condition (2) of this lemma follows immediately from Mayer-Vietoris
for hom in the derived category, see Lemma \ref{spaces-perfect-lemma-mayer-vietoris-hom}.
...
\begin{lemma}[Perfect on limit]
\label{spaces-perfect-lemma-perfect-on-limit}
\source{stacks:09RJ}
\href{https://stacks.math.columbia.edu/tag/09RJ}{\texttt{Stacks tag 09RJ}}
\group{spaces-perfect}

In Situation \ref{spaces-perfect-situation-descent} the category of perfect
...
by Lemma \ref{spaces-perfect-lemma-descend-homomorphisms}. Thus it suffices to prove
...
$$
Apply Lemma \ref{spaces-perfect-lemma-glue}
...
To see this use the equivalence of
Lemma \ref{spaces-perfect-lemma-derived-quasi-coherent-small-etale-site}
and use the translation of Lemma \ref{spaces-perfect-lemma-descend-perfect}.
\end{proof}
...
Remark \ref{spaces-perfect-remark-explain-perfect-direct-image}.

\begin{lemma}[Base change tensor perfect]
\label{spaces-perfect-lemma-base-change-tensor-perfect}
\source{stacks:0A1P}
\href{https://stacks.math.columbia.edu/tag/0A1P}{\texttt{Stacks tag 0A1P}}
\group{spaces-perfect}
...
\begin{proof}
The statement on base change is Lemma \ref{spaces-perfect-lemma-base-change-tensor}.
Thus it suffices to show that $K$ is a perfect object. If $Y$ is
Noetherian, then this follows from
Lemma \ref{spaces-perfect-lemma-tensor-perfect}.
...
Finally, by Lemma \ref{spaces-perfect-lemma-perfect-on-limit}
we may, after increasing $i$, assume there exists a perfect
object $E_i$ of $D(\mathcal{O}_{X_i})$ whose pullback to
$X$ is $E$. By Lemma \ref{spaces-perfect-lemma-tensor-perfect} we have that
$K_i =
...
(Lemma \ref{spaces-perfect-lemma-base-change-tensor}) the pullback of $K_i$
...
\source{stacks:0A1Q}
\href{https://stacks.math.columbia.edu/tag/0A1Q}{\texttt{Stacks tag 0A1Q}}
\group{spaces-perfect}
...
Lemma \ref{spaces-perfect-lemma-base-change-tensor-perfect}
...
\source{stacks:0CTL}
\href{https://stacks.math.columbia.edu/tag/0CTL}{\texttt{Stacks tag 0CTL}}
\group{spaces-perfect}
...
This will follow from Lemma \ref{spaces-perfect-lemma-base-change-tensor-perfect}
...
$$
is an isomorphism on cohomology sheaves in degrees $\geq m$.
By Lemma \ref{spaces-perfect-lemma-base-change-tensor-perfect} the source
...
\source{stacks:0CTM}
\href{https://stacks.math.columbia.edu/tag/0CTM}{\texttt{Stacks tag 0CTM}}
\group{spaces-perfect}
...
\begin{proof}
Special cases of
Lemma \ref{spaces-perfect-lemma-base-change-tensor-perfect} applied with
...
\source{stacks:0CTN}
\href{https://stacks.math.columbia.edu/tag/0CTN}{\texttt{Stacks tag 0CTN}}
\group{spaces-perfect}
...
\begin{proof}
Special case of
Lemma \ref{spaces-perfect-lemma-base-change-tensor-pseudo-coherent} applied with
...
\source{stacks:0D3F}
\href{https://stacks.math.columbia.edu/tag/0D3F}{\texttt{Stacks tag 0D3F}}
\group{spaces-perfect}
...
a perfect generator (Theorem \ref{spaces-perfect-theorem-bondal-van-den-Bergh})
it suffices to check this for perfect $E$.
By Lemma \ref{spaces-perfect-lemma-Rlim-quasi-coherent} we have
...
$$
by Lemma \ref{spaces-perfect-lemma-cohomology-base-change}.
From Lemma \ref{spaces-perfect-lemma-flat-proper-perfect-direct-image-general}
...
\source{stacks:0CWH}
\href{https://stacks.math.columbia.edu/tag/0CWH}{\texttt{Stacks tag 0CWH}}
\group{spaces-perfect}
...
\source{stacks:0A1R}
\href{https://stacks.math.columbia.edu/tag/0A1R}{\texttt{Stacks tag 0A1R}}
\group{spaces-perfect}
...
\begin{proof}
The statement on base change is Lemma \ref{spaces-perfect-lemma-base-change-RHom}.
Thus it suffices to show that $K$ is a perfect object. If $Y$ is
Noetherian, then this follows from Lemma \ref{spaces-perfect-lemma-ext-perfect}.
We will reduce to this case by Noetherian approximation.
We encourage the reader to skip the rest of this proof.
...
is proper over $R_i$, see
Limits of Spaces, Lemma \ref{spaces-limits-lemma-eventually-proper-support}.
Finally, by Lemma \ref{spaces-perfect-lemma-descend-perfect}
we may, after increasing $i$, assume there exists a perfect
object $E_i$ of $D(\mathcal{O}_{X_i})$ whose pullback to
$X$ is $E$. Applying Lemma \ref{spaces-perfect-lemma-compute-ext-perfect}
...
\source{stacks:0D1Y}
\href{https://stacks.math.columbia.edu/tag/0D1Y}{\texttt{Stacks tag 0D1Y}}
\group{spaces-perfect}
...
Lemma \ref{spaces-perfect-lemma-descend-pseudo-coherent}) and we can apply the result
for schemes, see
...
\source{stacks:0E0R}
\href{https://stacks.math.columbia.edu/tag/0E0R}{\texttt{Stacks tag 0E0R}}
\group{spaces-perfect}
...
Lemma \ref{spaces-perfect-lemma-flat-proper-perfect-direct-image-general})
...
$$
Thus the lemma follows from Lemma \ref{spaces-perfect-lemma-jump-loci}.
\end{proof}

\begin{lemma}[Chi locally constant]
\label{spaces-perfect-lemma-chi-locally-constant}
\source{stacks:0D1Z}
\href{https://stacks.math.columbia.edu/tag/0D1Z}{\texttt{Stacks tag 0D1Z}}
\group{spaces-perfect}
...
\source{stacks:0D20}
\href{https://stacks.math.columbia.edu/tag/0D20}{\texttt{Stacks tag 0D20}}
\group{spaces-perfect}
...
\source{stacks:0E6A}
\href{https://stacks.math.columbia.edu/tag/0E6A}{\texttt{Stacks tag 0E6A}}
\group{spaces-perfect}
...
Lemma \ref{spaces-perfect-lemma-open-where-cohomology-in-degree-i-rank-r}.
\end{proof}

\begin{lemma}[Locally closed where H0 locally free]
\label{spaces-perfect-lemma-locally-closed-where-H0-locally-free}
\source{stacks:0D21}
\href{https://stacks.math.columbia.edu/tag/0D21}{\texttt{Stacks tag 0D21}}
\group{spaces-perfect}
...
\source{stacks:0E6B}
\href{https://stacks.math.columbia.edu/tag/0E6B}{\texttt{Stacks tag 0E6B}}
\group{spaces-perfect}
...
Lemma \ref{spaces-perfect-lemma-jump-loci}. Apply
Lemma \ref{spaces-perfect-lemma-locally-closed-where-H0-locally-free}
...
\source{stacks:0E0S}
\href{https://stacks.math.columbia.edu/tag/0E0S}{\texttt{Stacks tag 0E0S}}
\group{spaces-perfect}
...
\begin{proof}
By Lemma \ref{spaces-perfect-lemma-proper-flat-h0}
...
\source{stacks:0CRU}
\href{https://stacks.math.columbia.edu/tag/0CRU}{\texttt{Stacks tag 0CRU}}
\group{spaces-perfect}
...
the result holds for $W$. This is an immediate consequence
of the Mayer-Vietoris sequence, see
Lemma \ref{spaces-perfect-lemma-unbounded-mayer-vietoris}.
\end{proof}

\begin{lemma}[Countable]
\label{spaces-perfect-lemma-countable}
\source{stacks:0CRV}
\href{https://stacks.math.columbia.edu/tag/0CRV}{\texttt{Stacks tag 0CRV}}
\group{spaces-perfect}
...
According to Theorem \ref{spaces-perfect-theorem-DQCoh-is-Ddga}
...
This follows from Lemma \ref{spaces-perfect-lemma-countable-cohomology}.
\end{proof}

\begin{lemma}[Computing sections as colim]
\label{spaces-perfect-lemma-computing-sections-as-colim}
\source{stacks:0CRW}
\href{https://stacks.math.columbia.edu/tag/0CRW}{\texttt{Stacks tag 0CRW}}
\group{spaces-perfect}
...
\begin{proof}
By Lemma \ref{spaces-perfect-lemma-cohomology-base-change} we have
$$
...
\ref{spaces-limits-lemma-descend-flat}.
By Lemma \ref{spaces-perfect-lemma-compare-base-change}
...
colimit of perfect complexes. To see this we apply Lemma \ref{spaces-perfect-lemma-countable}.
...
This section is the analogue of Derived Categories of Schemes, Section
\ref{perfect-section-resolution-property} for algebraic spaces; please
read that section first. It is currently not known if a smooth
proper algebraic space over a field always has the resolution property
or if this is false. If you know the answer to this question, please email
\href{mailto:stacks.project@gmail.com}{stacks.project@gmail.com}.

\medskip\noindent
We can make the following definition although it scarcely makes
sense to consider it for general algebraic spaces.

\begin{definition}[Resolution property]
\label{spaces-perfect-definition-resolution-property}
\source{stacks:0GUS}
\href{https://stacks.math.columbia.edu/tag/0GUS}{\texttt{Stacks tag 0GUS}}
\group{spaces-perfect}
...
If $X$ is a quasi-compact and quasi-separated algebraic space, then
it suffices to check every $\mathcal{O}_X$-module module of
finite presentation (automatically quasi-coherent) is the quotient
of a finite locally free $\mathcal{O}_X$-module, see
Limits of Spaces, Lemma
\ref{spaces-limits-lemma-finite-directed-colimit-surjective-maps}.
If $X$ is a Noetherian algebraic space, then finite type quasi-coherent modules
...
\source{stacks:0GUT}
\href{https://stacks.math.columbia.edu/tag/0GUT}{\texttt{Stacks tag 0GUT}}
\group{spaces-perfect}
...
\source{stacks:0GUU}
\href{https://stacks.math.columbia.edu/tag/0GUU}{\texttt{Stacks tag 0GUU}}
\group{spaces-perfect}
...
\begin{proof}
By Divisors on Spaces, Lemma \ref{spaces-divisors-lemma-quasi-affine-O-ample}
this is a special case of
Lemma \ref{spaces-perfect-lemma-resolution-property-ample-relative}.
\end{proof}
...
\source{stacks:0GUV}
\href{https://stacks.math.columbia.edu/tag/0GUV}{\texttt{Stacks tag 0GUV}}
\group{spaces-perfect}
...
$\mathcal{O}_X$-module $\mathcal{E}$. Since $f_*$ is exact
(Cohomology of Spaces, Section \ref{spaces-cohomology-section-finite-morphisms})
we get a surjection
$$
f_*\mathcal{E}
\longrightarrow
...
\mathcal{G}
$$
Since $f_*\mathcal{E}$ is finite locally free, we conclude.
\end{proof}

For more on the resolution property of algebraic spaces, please see
...
Section \ref{spaces-perfect-section-generating}, have a special property.
...
\source{stacks:0GFF}
\href{https://stacks.math.columbia.edu/tag/0GFF}{\texttt{Stacks tag 0GFF}}
\group{spaces-perfect}
...
\source{stacks:0GFG}
\href{https://stacks.math.columbia.edu/tag/0GFG}{\texttt{Stacks tag 0GFG}}
\group{spaces-perfect}
...
\source{stacks:0GFH}
\href{https://stacks.math.columbia.edu/tag/0GFH}{\texttt{Stacks tag 0GFH}}
\group{spaces-perfect}
...
Lemma \ref{spaces-perfect-lemma-ext-from-perfect-into-bounded-QCoh}. This proves
that (1) implies (2).
...
Remark \ref{spaces-perfect-remark-classical-generator}.
...
By Lemma \ref{spaces-perfect-lemma-direct-summand-of-a-restriction} and
Theorem \ref{spaces-perfect-theorem-bondal-van-den-Bergh} there exists a perfect
...
$U$ and to $V$). Hence using Lemma \ref{spaces-perfect-lemma-bounded-truncation}
twice we see that
$$
...
(by Lemma \ref{spaces-perfect-lemma-quasi-coherence-direct-image}), we get
...
\source{stacks:0GFI}
\href{https://stacks.math.columbia.edu/tag/0GFI}{\texttt{Stacks tag 0GFI}}
\group{spaces-perfect}
...
(check that the canonical map is an isomorphism after restricting to
$U$ and to $V$). Hence using Lemma \ref{spaces-perfect-lemma-bounded-below-truncation}
twice we see that
$$
\Hom_{D(\mathcal{O}_U)}(Q|_U [-i], E|_U) =
\Hom_{D(\mathcal{O}_X)}(Q[-i], R (U \to X)_* (E|_U)) = 0
...
Let $S$ be a scheme. Let $X$ be an algebraic space over $S$.
Recall that $X_{affine, \etale}$ denotes the category of affine
objects of $X_\etale$ with topology given by standard \'etale coverings, see
Properties of Spaces, Definition
\ref{spaces-properties-definition-affine-etale-site}.
We remind the reader that the topos of $X_{affine, \etale}$
is the small \'etale topos of $X$, see Properties of Spaces, Lemma
\ref{spaces-properties-lemma-alternative}. The site $X_\etale$
comes with a structure sheaf $\mathcal{O}_X$ whose restriction
to $X_{affine, \etale}$ we also denote $\mathcal{O}_X$. Then there is an
...
$$
See Descent on Spaces, Equation
(\ref{spaces-descent-equation-alternative-small-ringed})
and the discussion in
Descent on Spaces, Section
\ref{spaces-descent-section-alternative-quasi-coherent}.

\medskip\noindent
In this section we denote $X_{affine}$ the underlying category of
$X_{affine, \etale}$ endowed with the chaotic topology, i.e., such that sheaves
agree with presheaves. In particular, the structure sheaf $\mathcal{O}_X$
...
the category $\mathit{QC}(X_{affine}, \mathcal{O}_X)$ introduced in
...
\source{stacks:0H06}
\href{https://stacks.math.columbia.edu/tag/0H06}{\texttt{Stacks tag 0H06}}
\group{spaces-perfect}
...
\source{stacks:0H07}
\href{https://stacks.math.columbia.edu/tag/0H07}{\texttt{Stacks tag 0H07}}
\group{spaces-perfect}

Let $S$ be a scheme. Let $X$ be an algebraic space over $S$.
We will later show that also
$\mathit{QC}((\textit{Aff}/X), \mathcal{O})$
is canonically equivalent to $D_\QCoh(\mathcal{O}_X)$.
