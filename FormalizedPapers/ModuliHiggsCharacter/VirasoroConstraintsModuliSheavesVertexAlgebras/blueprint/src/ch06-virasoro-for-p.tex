...
\[
    ...
    \begin{claim}
\label{src-virasoro-constraints-moduli-sheaves-vertex-algebras-ch06-virasoro-for-p-statement-1}
\source{virasoro-constraints-moduli-sheaves-vertex-algebras}
\notready
...
\begin{claim}
\label{src-virasoro-constraints-moduli-sheaves-vertex-algebras-ch06-virasoro-for-p-statement-2}
\source{virasoro-constraints-moduli-sheaves-vertex-algebras}
\notready
The integral 
...
\begin{remark}
\label{src-virasoro-constraints-moduli-sheaves-vertex-algebras-ch06-virasoro-for-p-statement-4}
\source{virasoro-constraints-moduli-sheaves-vertex-algebras}
\notready
