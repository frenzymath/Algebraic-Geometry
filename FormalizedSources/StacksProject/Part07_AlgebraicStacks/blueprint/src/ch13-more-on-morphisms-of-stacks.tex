...
\source{stacks:0BPP}
\href{https://stacks.math.columbia.edu/tag/0BPP}{\texttt{Stacks tag 0BPP}}
\group{stacks-more-morphisms}
...
\source{stacks:0CJ7}
\href{https://stacks.math.columbia.edu/tag/0CJ7}{\texttt{Stacks tag 0CJ7}}
\group{stacks-more-morphisms}
...
\begin{definition}[First order thickening]
\label{stacks-more-morphisms-definition-first-order-thickening}
\source{stacks:0BPQ}
\href{https://stacks.math.columbia.edu/tag/0BPQ}{\texttt{Stacks tag 0BPQ}}
\group{stacks-more-morphisms}
...
\source{stacks:0BPR}
\href{https://stacks.math.columbia.edu/tag/0BPR}{\texttt{Stacks tag 0BPR}}
\group{stacks-more-morphisms}
...
\source{stacks:0BPS}
\href{https://stacks.math.columbia.edu/tag/0BPS}{\texttt{Stacks tag 0BPS}}
\group{stacks-more-morphisms}
...
\begin{example}[Reduction thickening]
\label{stacks-more-morphisms-example-reduction-thickening}
\source{stacks:0BPT}
\href{https://stacks.math.columbia.edu/tag/0BPT}{\texttt{Stacks tag 0BPT}}
\group{stacks-more-morphisms}
...
\begin{lemma}[Reduced diagonal]
\label{stacks-more-morphisms-lemma-reduced-diagonal}
\source{stacks:0BPU}
\href{https://stacks.math.columbia.edu/tag/0BPU}{\texttt{Stacks tag 0BPU}}
\group{stacks-more-morphisms}
...
$$
\begin{array}{cc}\mathcal{X} \underset{\Delta}{\longrightarrow}\downarrow & \mathcal{X} \times_\mathcal{Y} \mathcal{X} \downarrow \\ \mathcal{X}' \overset{\Delta'}{\longrightarrow} & \mathcal{X}' \times_{\mathcal{Y}'} \mathcal{X}'\end{array}
$$
is cartesian.
\end{lemma}
...
(Lemma \ref{stacks-more-morphisms-lemma-base-change-thickening}).
...
\begin{lemma}[Thickening diagonals]
\label{stacks-more-morphisms-lemma-thickening-diagonals}
\source{stacks:0BPV}
\href{https://stacks.math.columbia.edu/tag/0BPV}{\texttt{Stacks tag 0BPV}}
\group{stacks-more-morphisms}
...
\mathcal{X}' \times_{\mathcal{Y}'} \mathcal{X}')
$$
is a morphism of thickenings (Lemma \ref{stacks-more-morphisms-lemma-reduced-diagonal}).
...
\medskip\noindent
Lemma \ref{stacks-more-morphisms-lemma-reduced-diagonal} tells us that
...
\begin{lemma}[Thickening properties]
\label{stacks-more-morphisms-lemma-thickening-properties}
\source{stacks:0BPW}
\href{https://stacks.math.columbia.edu/tag/0BPW}{\texttt{Stacks tag 0BPW}}
\group{stacks-more-morphisms}
...
we use Lemma \ref{stacks-more-morphisms-lemma-thickening-diagonals} applied to the
...
\source{stacks:0CJ9}
\href{https://stacks.math.columbia.edu/tag/0CJ9}{\texttt{Stacks tag 0CJ9}}
\group{stacks-more-morphisms}
...
\begin{proof}
By Lemma \ref{stacks-more-morphisms-lemma-thickening} the morphisms $\mathcal{X} \to \mathcal{X}'$
...
as in Lemma \ref{stacks-more-morphisms-lemma-thickening-diagonals}. See
Morphisms of Stacks, Definition \ref{stacks-morphisms-definition-separated} and
Lemma \ref{stacks-morphisms-lemma-hierarchy}.
Hence these cases follow from Lemma \ref{stacks-more-morphisms-lemma-thickening-diagonals}.
...
\mathcal{X}' \times_{\mathcal{Y}'} T'
$$
is a thickening (by Lemma \ref{stacks-more-morphisms-lemma-base-change-thickening})
and the source is a scheme. Hence the target is a scheme by
Lemma \ref{stacks-more-morphisms-lemma-thickening-properties}.
...
\source{stacks:0CJB}
\href{https://stacks.math.columbia.edu/tag/0CJB}{\texttt{Stacks tag 0CJB}}
\group{stacks-more-morphisms}

Consider a commutative diagram
$$
\begin{array}{ccc}(\mathcal{X} \subset \mathcal{X}') \underset{(f, f')}{\longrightarrow}\searrow &  & (\mathcal{Y} \subset \mathcal{Y}') \swarrow \\  & (\mathcal{B} \subset \mathcal{B}') & \end{array}
$$
...
\source{stacks:0CJC}
\href{https://stacks.math.columbia.edu/tag/0CJC}{\texttt{Stacks tag 0CJC}}
\group{stacks-more-morphisms}
...
Lemma \ref{stacks-more-morphisms-lemma-flatness-morphism-thickenings-fp-over-ft}.
...
Lemma \ref{stacks-more-morphisms-lemma-thicken-property-morphisms}. Then we can choose
...
we first conclude by Lemma \ref{stacks-more-morphisms-lemma-thicken-property-morphisms}
...
$f'$ is by
Lemma \ref{stacks-more-morphisms-lemma-thicken-property-morphisms}.
...
$$
\begin{array}{cc}W \downarrow\dashrightarrow & W' \downarrow \\ \mathcal{X} \longrightarrow & \mathcal{X}'\end{array}
$$
...
\source{stacks:0CJP}
\href{https://stacks.math.columbia.edu/tag/0CJP}{\texttt{Stacks tag 0CJP}}
\group{stacks-more-morphisms}

Consider a diagram
$$
\begin{array}{cc}W \underset{x}{\downarrow} &  \\ \mathcal{X} \longrightarrow & \mathcal{X}'\end{array}
$$
where $\mathcal{X} \subset \mathcal{X}'$ is a thickening of algebraic stacks,
...
\vcenter{
\begin{array}{cc}U \underset{a}{\downarrow}\underset{i}{\longrightarrow} & U' \overset{x'}{\downarrow} \\ W \underset{x}{\downarrow} &  \\ \mathcal{X} \longrightarrow & \mathcal{X}'\end{array}
}
\end{equation}
...
\vcenter{
\begin{array}{cccc} & V \underset{f}{\swarrow}\overset{b}{\swarrow}\underset{j}{\longrightarrow} &  & V' \underset{f'}{\swarrow}\overset{y'}{\swarrow} \\ U \underset{a}{\downarrow}\underset{i}{\longrightarrow} &  & U' \underset{x'}{\downarrow} &  \\ W \underset{x}{\downarrow} &  &  &  \\ \mathcal{X} \longrightarrow &  & \mathcal{X}' & \end{array}
}
\end{equation}
...
\begin{lemma}[Morphisms lifts etale]
\label{stacks-more-morphisms-lemma-morphisms-lifts-etale}
\source{stacks:0CJS}
\href{https://stacks.math.columbia.edu/tag/0CJS}{\texttt{Stacks tag 0CJS}}
\group{stacks-more-morphisms}
...
and we can apply
Lemma \ref{stacks-more-morphisms-lemma-deform-property-fp-over-ft} because $U' \to \mathcal{X}'$
and $V' \to \mathcal{X}'$ are smooth and
$U = \mathcal{X} \times_{\mathcal{X}'} U'$ and
$V = \mathcal{X} \times_{\mathcal{X}'} V'$.
\end{proof}

\begin{lemma}[Gerbe of lifts fibred]
\label{stacks-more-morphisms-lemma-gerbe-of-lifts-fibred}
\source{stacks:0CJT}
\href{https://stacks.math.columbia.edu/tag/0CJT}{\texttt{Stacks tag 0CJT}}
\group{stacks-more-morphisms}

The category $p : \mathcal{C} \to W_{spaces, \etale}$ constructed
in Remark \ref{stacks-more-morphisms-remark-gerbe-of-lifts} is fibred in groupoids.
\end{lemma}
...
$f'$ is an isomorphism by Lemma \ref{stacks-more-morphisms-lemma-deform-property-fp-over-ft}
...
\begin{lemma}[Gerbe of lifts stack]
\label{stacks-more-morphisms-lemma-gerbe-of-lifts-stack}
\source{stacks:0CJU}
\href{https://stacks.math.columbia.edu/tag/0CJU}{\texttt{Stacks tag 0CJU}}
\group{stacks-more-morphisms}

The category $p : \mathcal{C} \to W_{spaces, \etale}$ constructed
in Remark \ref{stacks-more-morphisms-remark-gerbe-of-lifts} is a stack in groupoids.
\end{lemma}

\begin{proof}
By Lemma \ref{stacks-more-morphisms-lemma-gerbe-of-lifts-fibred} we see the first condition
...
$$
Then we get an \'etale (by Lemma \ref{stacks-more-morphisms-lemma-morphisms-lifts-etale}) morphism
$s_{kk'} : U'_{kk'} \to U'_k$
...
\begin{lemma}[Etale local lifts]
\label{stacks-more-morphisms-lemma-etale-local-lifts}
\source{stacks:0CJV}
\href{https://stacks.math.columbia.edu/tag/0CJV}{\texttt{Stacks tag 0CJV}}
\group{stacks-more-morphisms}
...
a cartesian diagram
$$
\begin{array}{cc}W_i \longrightarrow\downarrow & W_i' \downarrow \\ \mathcal{X} \longrightarrow & \mathcal{X}'\end{array}
$$
...
Picture
$$
\begin{array}{ccc}Z' \longrightarrow\downarrow & Y' \downarrow &  \\ W'_w \times_{\mathcal{X}'} X' \downarrow\longrightarrow & U'_w \times_{\mathcal{X}'} X' \downarrow\longrightarrow & X' \\ W'_w = V(f'_1, \ldots, f'_r) \longrightarrow & U'_w & \end{array}
$$
...
\begin{lemma}[Etale local lifts isomorphic]
\label{stacks-more-morphisms-lemma-etale-local-lifts-isomorphic}
\source{stacks:0CJW}
\href{https://stacks.math.columbia.edu/tag/0CJW}{\texttt{Stacks tag 0CJW}}
\group{stacks-more-morphisms}

Let $\mathcal{X} \subset \mathcal{X}'$ be a thickening of algebraic stacks.
Consider a commutative diagram
$$
\begin{array}{ccc}W'' \underset{x''}{\downarrow} & W \longleftarrow\longrightarrow\underset{x}{\downarrow} & W' \overset{x'}{\downarrow} \\ \mathcal{X}' & \mathcal{X} \longleftarrow\longrightarrow & \mathcal{X}'\end{array}
$$
...
$$
\begin{array}{cccc}W \underset{\delta}{\longrightarrow} &  & I' \overset{p'}{\swarrow}\underset{q'}{\searrow} &  \\  & W' &  & W''\end{array}
$$
...
$$
\begin{array}{ccc}W_k \overset{f_k}{\longrightarrow}\downarrow & W \overset{\delta}{\longrightarrow} & I' \overset{p'}{\downarrow} \\ W'_k \overset{f'_k}{\longrightarrow}\overset{\delta_k}{\nearrow} &  & W'\end{array}
$$
...
by Lemma \ref{stacks-more-morphisms-lemma-deform-property-fp-over-ft}.
...
Lemma \ref{stacks-more-morphisms-lemma-base-change-thickening}) we get $\delta_k$ as
desired.
...
\begin{lemma}[Gerbe of lifts]
\label{stacks-more-morphisms-lemma-gerbe-of-lifts}
\source{stacks:0CJX}
\href{https://stacks.math.columbia.edu/tag/0CJX}{\texttt{Stacks tag 0CJX}}
\group{stacks-more-morphisms}

The category $p : \mathcal{C} \to W_{spaces, \etale}$ constructed
in Remark \ref{stacks-more-morphisms-remark-gerbe-of-lifts} is a gerbe.
\end{lemma}

\begin{proof}
In Lemma \ref{stacks-more-morphisms-lemma-gerbe-of-lifts-stack}
...
Lemma \ref{stacks-more-morphisms-lemma-etale-local-lifts}.
Condition (3) follows from
Lemma \ref{stacks-more-morphisms-lemma-etale-local-lifts-isomorphic}.
\end{proof}

\begin{lemma}[Gerbe of lifts first order]
\label{stacks-more-morphisms-lemma-gerbe-of-lifts-first-order}
\source{stacks:0CKG}
\href{https://stacks.math.columbia.edu/tag/0CKG}{\texttt{Stacks tag 0CKG}}
\group{stacks-more-morphisms}

In Remark \ref{stacks-more-morphisms-remark-gerbe-of-lifts} assume $\mathcal{X} \subset \mathcal{X}'$
...
in Remark \ref{stacks-more-morphisms-remark-gerbe-of-lifts} are abelian, and
...
$$
\begin{array}{cccc}U' \underset{\Delta'}{\longrightarrow} &  & I' \overset{p'}{\swarrow}\underset{q'}{\searrow} &  \\  & U' &  & U'\end{array}
$$
...
Lemma \ref{stacks-more-morphisms-lemma-gerbe-of-lifts-fibred}.
...
$$
\begin{array}{cc}V' \underset{h'}{\longrightarrow}\underset{q' \circ \delta'}{\searrow} & V' \overset{f'}{\downarrow} \\  & U'\end{array}
$$
...
\source{stacks:0CKI}
\href{https://stacks.math.columbia.edu/tag/0CKI}{\texttt{Stacks tag 0CKI}}
\group{stacks-more-morphisms}
...
a cartesian diagram
$$
\begin{array}{cc}W \downarrow\longrightarrow & W' \downarrow \\ \mathcal{X} \longrightarrow & \mathcal{X}'\end{array}
$$
...
introduced in Remark \ref{stacks-more-morphisms-remark-gerbe-of-lifts}.
...
\medskip\noindent
Lemma \ref{stacks-more-morphisms-lemma-gerbe-of-lifts} tells us $\mathcal{C}$ is a gerbe over
...
By Lemma \ref{stacks-more-morphisms-lemma-gerbe-of-lifts-first-order}
...
\begin{lemma}[Inf quasi coherent]
\label{stacks-more-morphisms-lemma-inf-quasi-coherent}
\source{stacks:0DNR}
\href{https://stacks.math.columbia.edu/tag/0DNR}{\texttt{Stacks tag 0DNR}}
\group{stacks-more-morphisms}
...
\begin{lemma}[Sheaf of infinitesimal lifts]
\label{stacks-more-morphisms-lemma-sheaf-of-infinitesimal-lifts}
\source{stacks:0DNS}
\href{https://stacks.math.columbia.edu/tag/0DNS}{\texttt{Stacks tag 0DNS}}
\group{stacks-more-morphisms}
...
Lemma \ref{stacks-more-morphisms-lemma-inf-quasi-coherent} applied to
...
\begin{lemma}[T quasi coherent]
\label{stacks-more-morphisms-lemma-T-quasi-coherent}
\source{stacks:0DNT}
\href{https://stacks.math.columbia.edu/tag/0DNT}{\texttt{Stacks tag 0DNT}}
\group{stacks-more-morphisms}
...
to $A[M]$. Therefore
Lemma \ref{stacks-more-morphisms-lemma-sheaf-of-infinitesimal-lifts}\footnote{This lemma applies:
...
$$
\begin{array}{cccc}0 \longrightarrow & T_y(M \otimes_A B) \longrightarrow & T_{y|_{B_1}}(M \otimes_A B_1) \longrightarrow & T_{y|_{B_2}}(M \otimes_A B_2) \\ 0 \longrightarrow & T_x(M) \longrightarrow\uparrow & T_{x|_{A_1}}(M \otimes_A A_1) \longrightarrow\uparrow & T_{x|_{A_2}}(M \otimes_A A_2) \uparrow\end{array}
$$
...
\begin{lemma}[Local lift enough]
\label{stacks-more-morphisms-lemma-local-lift-enough}
\source{stacks:0DNU}
\href{https://stacks.math.columbia.edu/tag/0DNU}{\texttt{Stacks tag 0DNU}}
\group{stacks-more-morphisms}
...
Lemma \ref{stacks-more-morphisms-lemma-sheaf-of-infinitesimal-lifts}
(which applies, see footnote in the proof of
Lemma \ref{stacks-more-morphisms-lemma-T-quasi-coherent}).
Thus we have an equalizer diagram
$$
\begin{array}{ccc}F(A') \longrightarrow & F(B') \longrightarrow\longrightarrow & F(B'_1)\end{array}
$$
...
$$
The equality in the displayed equation holds by
Lemma \ref{stacks-more-morphisms-lemma-T-quasi-coherent} applied to
...
Lemma \ref{stacks-more-morphisms-lemma-smooth-formally-smooth}.
...
\source{stacks:0DNW}
\href{https://stacks.math.columbia.edu/tag/0DNW}{\texttt{Stacks tag 0DNW}}
\group{stacks-more-morphisms}
...
\vcenter{
\begin{array}{cc}T \underset{x}{\longrightarrow}\underset{i}{\downarrow} & \mathcal{X} \overset{f}{\downarrow} \\ T' \overset{y}{\longrightarrow}\nearrow & \mathcal{Y}\end{array}
}
\end{equation}
...
$$
\begin{array}{ccc} & f \circ x' \circ i \overset{\text{id}_f \star \alpha}{\searrow} &  \\ y \circ i \overset{\beta \star \text{id}_i}{\nearrow}\overset{\gamma}{\longrightarrow} &  & f \circ x\end{array}
$$
...
\begin{lemma}[Reformulate formal smoothness]
\label{stacks-more-morphisms-lemma-reformulate-formal-smoothness}
\source{stacks:0DNY}
\href{https://stacks.math.columbia.edu/tag/0DNY}{\texttt{Stacks tag 0DNY}}
\group{stacks-more-morphisms}

A morphism $f : \mathcal{X} \to \mathcal{Y}$ of algebraic stacks is
formally smooth (Definition \ref{stacks-more-morphisms-definition-formally-smooth})
...
\begin{lemma}[Base change formal smoothness]
\label{stacks-more-morphisms-lemma-base-change-formal-smoothness}
\source{stacks:0H1I}
\href{https://stacks.math.columbia.edu/tag/0H1I}{\texttt{Stacks tag 0H1I}}
\group{stacks-more-morphisms}
...
\begin{lemma}[Composition formal smoothness]
\label{stacks-more-morphisms-lemma-composition-formal-smoothness}
\source{stacks:0H1J}
\href{https://stacks.math.columbia.edu/tag/0H1J}{\texttt{Stacks tag 0H1J}}
\group{stacks-more-morphisms}
...
\begin{lemma}[Formal smoothness representable]
\label{stacks-more-morphisms-lemma-formal-smoothness-representable}
\source{stacks:0H1K}
\href{https://stacks.math.columbia.edu/tag/0H1K}{\texttt{Stacks tag 0H1K}}
\group{stacks-more-morphisms}
...
\begin{lemma}[Lift to smooth]
\label{stacks-more-morphisms-lemma-lift-to-smooth}
\source{stacks:0DNZ}
\href{https://stacks.math.columbia.edu/tag/0DNZ}{\texttt{Stacks tag 0DNZ}}
\group{stacks-more-morphisms}
...
\begin{proof}
We may apply the result of Lemma \ref{stacks-more-morphisms-lemma-local-lift-enough}.
...
\source{stacks:0DP0}
\href{https://stacks.math.columbia.edu/tag/0DP0}{\texttt{Stacks tag 0DP0}}
\group{stacks-more-morphisms}
...
arrow (see Lemma \ref{stacks-more-morphisms-lemma-reformulate-formal-smoothness}).
Forming fibre products we obtain
$$
\begin{array}{ccc}T \downarrow\longrightarrow & T' \times_\mathcal{Y} \mathcal{X} \downarrow\longrightarrow & \mathcal{X} \downarrow \\ T' \longrightarrow & T' \longrightarrow & \mathcal{Y}\end{array}
$$
...
Lemma \ref{stacks-more-morphisms-lemma-lift-to-smooth}.
...
(see Lemma \ref{stacks-more-morphisms-lemma-reformulate-formal-smoothness})
...
\begin{lemma}[Flatten stack]
\label{stacks-more-morphisms-lemma-flatten-stack}
\source{stacks:0CQ4}
\href{https://stacks.math.columbia.edu/tag/0CQ4}{\texttt{Stacks tag 0CQ4}}
\group{stacks-more-morphisms}
...
$$
\vcenter{
\begin{array}{cc}R' \longrightarrow\downarrow & R_{Y'} \overset{s_{Y'}}{\downarrow} \\ U' \longrightarrow & U_{Y'}\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}R' \longrightarrow\downarrow & R_{Y'} \overset{t_{Y'}}{\downarrow} \\ U' \longrightarrow & U_{Y'}\end{array}
}
$$
...
\begin{lemma}[Finite cover factor]
\label{stacks-more-morphisms-lemma-finite-cover-factor}
\source{stacks:0CQ6}
\href{https://stacks.math.columbia.edu/tag/0CQ6}{\texttt{Stacks tag 0CQ6}}
\group{stacks-more-morphisms}
...
\begin{lemma}[Make section]
\label{stacks-more-morphisms-lemma-make-section}
\source{stacks:0CQ7}
\href{https://stacks.math.columbia.edu/tag/0CQ7}{\texttt{Stacks tag 0CQ7}}
\group{stacks-more-morphisms}
...
$$
\begin{array}{ccc}\overline{Z} \underset{\overline{g}}{\searrow} & Z \overset{j}{\longleftarrow}\underset{g}{\downarrow}\underset{h}{\longrightarrow} & \mathcal{X} \overset{f}{\swarrow} \\  & Y & \end{array}
$$
...
$$
\begin{array}{cc}\mathcal{X}' \underset{f'}{\downarrow}\longrightarrow & \mathcal{X} \overset{f}{\downarrow} \\ Y' \longrightarrow & Y\end{array}
$$
...
\medskip\noindent
Using Lemma \ref{stacks-more-morphisms-lemma-flatten-stack}
...
By Lemma \ref{stacks-more-morphisms-lemma-finite-cover-factor}
...
We apply Lemma \ref{stacks-more-morphisms-lemma-finite-cover-factor}
...
\source{stacks:0CQ8}
\href{https://stacks.math.columbia.edu/tag/0CQ8}{\texttt{Stacks tag 0CQ8}}
\group{stacks-more-morphisms}
...
Then there exists a commutative diagram
$$
\begin{array}{ccc}\mathcal{X} \searrow & X \longleftarrow\downarrow\longrightarrow & \overline{X} \swarrow \\  & Y & \end{array}
$$
...
and appeal to Lemma \ref{stacks-more-morphisms-lemma-make-section}.
...
Picture
$$
\begin{array}{cc}\mathcal{V} \longrightarrow\downarrow & \mathcal{X} \downarrow \\ V \longrightarrow & Y\end{array}
$$
...
$$
\begin{array}{ccc}\mathcal{V} \longrightarrow\downarrow &  & \mathcal{X} \downarrow \\ V \longrightarrow & \mathbf{P}^n_Y \longrightarrow & Y\end{array}
$$
...
$$
\begin{array}{cccc}\mathcal{V} \longrightarrow\downarrow & \mathcal{X}' \longrightarrow\downarrow & \mathbf{P}^n_Y \times_Y \mathcal{X} \downarrow\longrightarrow & \mathcal{X} \downarrow \\ V \longrightarrow & Y' \longrightarrow & \mathbf{P}^n_Y \longrightarrow & Y\end{array}
$$
...
Lemma \ref{stacks-more-morphisms-lemma-make-section} applies to the morphism $\mathcal{X}' \to Y'$
and the open subspace $V \subset Y'$. If the claim is true, then we obtain
$$
\begin{array}{ccc}\overline{X} \underset{\overline{g}}{\searrow} & X \longleftarrow\underset{g}{\downarrow}\underset{h}{\longrightarrow} & \mathcal{X}' \overset{f}{\swarrow} \\  & Y' & \end{array}
$$
...
$$
\begin{array}{ccc}\Spec(K) \downarrow\longrightarrow & \mathcal{U} \longrightarrow & \mathcal{X} \downarrow \\ \Spec(A) \longrightarrow\nearrow &  & \mathcal{Y}\end{array}
$$
...
\source{stacks:0H2B}
\href{https://stacks.math.columbia.edu/tag/0H2B}{\texttt{Stacks tag 0H2B}}
\group{stacks-more-morphisms}
...
Then there exists a commutative diagram
$$
\begin{array}{cc}\Spec(K) \longrightarrow\downarrow & \mathcal{X} \overset{f}{\downarrow} \\ \Spec(A) \longrightarrow & \mathcal{Y}\end{array}
$$
...
\begin{lemma}[Check separated dvr]
\label{stacks-more-morphisms-lemma-check-separated-dvr}
\source{stacks:0E80}
\href{https://stacks.math.columbia.edu/tag/0E80}{\texttt{Stacks tag 0E80}}
\group{stacks-more-morphisms}
...
$$
\begin{array}{ccc}\Spec(K) \underset{v}{\longrightarrow}\underset{j}{\downarrow} & V \overset{g}{\downarrow}\longrightarrow & \mathcal{X} \overset{\Delta}{\downarrow} \\ \Spec(A) \overset{u}{\longrightarrow}\nearrow\nearrow & U \longrightarrow & \mathcal{X} \times_\mathcal{Y} \mathcal{X}\end{array}
$$
where $A$ is a discrete valuation ring and $K$ its fraction field,
...
\source{stacks:0CQM}
\href{https://stacks.math.columbia.edu/tag/0CQM}{\texttt{Stacks tag 0CQM}}
\group{stacks-more-morphisms}
...
$$
\begin{array}{ccc}\Spec(K) \underset{u}{\longrightarrow}\underset{j}{\downarrow} & \mathcal{U} \underset{h}{\longrightarrow} & \mathcal{X} \overset{f}{\downarrow} \\ \Spec(A) \overset{y}{\longrightarrow} &  & \mathcal{Y}\end{array}
$$
...
By Chow's lemma (Theorem \ref{stacks-more-morphisms-theorem-chow-finite-type})
...
$$
\begin{array}{ccc}\Spec(K) \longrightarrow\downarrow & W \longrightarrow & X \downarrow \\ \Spec(A) \longrightarrow\nearrow &  & Y\end{array}
$$
...
\source{stacks:0E95}
\href{https://stacks.math.columbia.edu/tag/0E95}{\texttt{Stacks tag 0E95}}
\group{stacks-more-morphisms}
...
If given any $2$-commutative diagram
$$
\begin{array}{ccc}\Spec(K) \underset{u}{\longrightarrow}\underset{j}{\downarrow} & \mathcal{U} \underset{h}{\longrightarrow} & \mathcal{X} \overset{f}{\downarrow} \\ \Spec(A) \overset{y}{\longrightarrow}\nearrow &  & \mathcal{Y}\end{array}
$$
where $A$ is a discrete valuation ring with field of fractions $K$
...
Lemma \ref{stacks-more-morphisms-lemma-refined-valuative-criterion-proper}
...
$$
\begin{array}{ccc}\Spec(K) \underset{u}{\longrightarrow}\underset{j}{\downarrow} & \mathcal{U} \underset{h}{\longrightarrow} & \mathcal{X} \overset{\Delta}{\downarrow} \\ \Spec(A) \overset{y}{\longrightarrow}\nearrow &  & \mathcal{X} \times_\mathcal{Y} \mathcal{X}\end{array}
$$
where $A$ is a discrete valuation ring with field of fractions $K$
...
\begin{lemma}[Valuative criterion universally closed]
\label{stacks-more-morphisms-lemma-valuative-criterion-universally-closed}
\source{stacks:0H2C}
\href{https://stacks.math.columbia.edu/tag/0H2C}{\texttt{Stacks tag 0H2C}}
\group{stacks-more-morphisms}
...
$|\mathcal{X}| \to |Y|$. By Lemma \ref{stacks-more-morphisms-lemma-reach-point-closure-Noetherian}
we may choose a commutative diagram
$$
\begin{array}{cc}\Spec(K) \longrightarrow\downarrow & \mathcal{X} \overset{f}{\downarrow} \\ \Spec(A) \longrightarrow & Y\end{array}
$$
...
\begin{definition}[Categorical quotient]
\label{stacks-more-morphisms-definition-categorical-quotient}
\source{stacks:0DUG}
\href{https://stacks.math.columbia.edu/tag/0DUG}{\texttt{Stacks tag 0DUG}}
\group{stacks-more-morphisms}
...
\begin{lemma}[Quotient compare]
\label{stacks-more-morphisms-lemma-quotient-compare}
\source{stacks:0DUH}
\href{https://stacks.math.columbia.edu/tag/0DUH}{\texttt{Stacks tag 0DUH}}
\group{stacks-more-morphisms}
...
\begin{lemma}[Categorical quotient compare]
\label{stacks-more-morphisms-lemma-categorical-quotient-compare}
\source{stacks:0DUI}
\href{https://stacks.math.columbia.edu/tag/0DUI}{\texttt{Stacks tag 0DUI}}
\group{stacks-more-morphisms}

With assumption and notation as in Lemma \ref{stacks-more-morphisms-lemma-quotient-compare}.
...
Lemma \ref{stacks-more-morphisms-lemma-quotient-compare} that $f$ is a categorical moduli space
...
\begin{lemma}[Check uniform categorical quotient on affines]
\label{stacks-more-morphisms-lemma-check-uniform-categorical-quotient-on-affines}
\source{stacks:0DUJ}
\href{https://stacks.math.columbia.edu/tag/0DUJ}{\texttt{Stacks tag 0DUJ}}
\group{stacks-more-morphisms}
...
$$
\begin{array}{ccc}\mathcal{X}_i \longrightarrow\downarrow & \mathcal{X} \downarrow\underset{g}{\longrightarrow} & W \\ Y_i \longrightarrow\nearrow & Y & \end{array}
$$
...
\begin{definition}[Well nigh affine]
\label{stacks-more-morphisms-definition-well-nigh-affine}
\source{stacks:0DUL}
\href{https://stacks.math.columbia.edu/tag/0DUL}{\texttt{Stacks tag 0DUL}}
\group{stacks-more-morphisms}
...
\begin{lemma}[Well nigh affine]
\label{stacks-more-morphisms-lemma-well-nigh-affine}
\source{stacks:0DUM}
\href{https://stacks.math.columbia.edu/tag/0DUM}{\texttt{Stacks tag 0DUM}}
\group{stacks-more-morphisms}
...
\begin{lemma}[Affine over well nigh affine]
\label{stacks-more-morphisms-lemma-affine-over-well-nigh-affine}
\source{stacks:0DUN}
\href{https://stacks.math.columbia.edu/tag/0DUN}{\texttt{Stacks tag 0DUN}}
\group{stacks-more-morphisms}
...
Lemma \ref{stacks-more-morphisms-lemma-well-nigh-affine} combined with
...
\begin{lemma}[Well nigh affine moduli space]
\label{stacks-more-morphisms-lemma-well-nigh-affine-moduli-space}
\source{stacks:0DUP}
\href{https://stacks.math.columbia.edu/tag/0DUP}{\texttt{Stacks tag 0DUP}}
\group{stacks-more-morphisms}
...
Lemma \ref{stacks-more-morphisms-lemma-well-nigh-affine}. Let $C$ be the ring of
...
\medskip\noindent
Since $\mathcal{X}$ is separated by Lemma \ref{stacks-more-morphisms-lemma-well-nigh-affine}
...
$$
\begin{array}{cc}\mathcal{X}' \overset{f'}{\downarrow}\longrightarrow & \mathcal{X} \overset{f}{\downarrow} \\ M^1 \downarrow &  \\ M' \longrightarrow & M\end{array}
$$
...
\begin{lemma}[Well nigh affine moduli space etale]
\label{stacks-more-morphisms-lemma-well-nigh-affine-moduli-space-etale}
\source{stacks:0DUQ}
\href{https://stacks.math.columbia.edu/tag/0DUQ}{\texttt{Stacks tag 0DUQ}}
\group{stacks-more-morphisms}
...
$$
\begin{array}{cc}\mathcal{X}' \downarrow\longrightarrow & \mathcal{X} \downarrow \\ M' \longrightarrow & M\end{array}
$$
where $M' \to M$ is \'etale and
the vertical arrows are the moduli spaces constructed in
Lemma \ref{stacks-more-morphisms-lemma-well-nigh-affine-moduli-space}.
\end{lemma}
...
By Lemma \ref{stacks-more-morphisms-lemma-affine-over-well-nigh-affine}
...
see proof of Lemma \ref{stacks-more-morphisms-lemma-well-nigh-affine}.
...
\begin{lemma}[Moduli space finite affine]
\label{stacks-more-morphisms-lemma-moduli-space-finite-affine}
\source{stacks:0DUR}
\href{https://stacks.math.columbia.edu/tag/0DUR}{\texttt{Stacks tag 0DUR}}
\group{stacks-more-morphisms}
...
f : \mathcal{X} \longrightarrow M
$$
of Lemma \ref{stacks-more-morphisms-lemma-well-nigh-affine-moduli-space}
...
Lemma \ref{stacks-more-morphisms-lemma-check-uniform-categorical-quotient-on-affines}
...
Lemma \ref{stacks-more-morphisms-lemma-affine-over-well-nigh-affine}.
...
a cartesian square
$$
\begin{array}{cc}\mathcal{X}' \longrightarrow\downarrow & \mathcal{X} \downarrow \\ M' \longrightarrow & M\end{array}
$$
...
as in Lemma \ref{stacks-more-morphisms-lemma-well-nigh-affine}.
...
well-nigh affine. By Lemma \ref{stacks-more-morphisms-lemma-well-nigh-affine-moduli-space-etale}
...
\begin{lemma}[Etale separated over well nigh affine]
\label{stacks-more-morphisms-lemma-etale-separated-over-well-nigh-affine}
\source{stacks:0DUS}
\href{https://stacks.math.columbia.edu/tag/0DUS}{\texttt{Stacks tag 0DUS}}
\group{stacks-more-morphisms}
...
Lemma \ref{stacks-more-morphisms-lemma-well-nigh-affine-moduli-space-etale}
we obtain cartesian diagrams
$$
\begin{array}{cc}\mathcal{X}'_i \longrightarrow\downarrow & \mathcal{X} \downarrow \\ M'_i \longrightarrow & M\end{array}
$$
...
By the result of
Lemma \ref{stacks-more-morphisms-lemma-moduli-space-finite-affine}
we see that both
...
such that
$$
\begin{array}{ccccc}\mathcal{X}'_i \downarrow &  & \mathcal{X}'_i \cap \mathcal{X}'_j \longrightarrow\longleftarrow\swarrow\searrow &  & \mathcal{X}'_j \downarrow \\ M'_i & V_{ij} \longleftarrow\overset{\varphi_{ij}}{\longrightarrow} &  & V_{ji} \longrightarrow & M'_j\end{array}
$$
...
\begin{lemma}[Etale local finite inertia]
\label{stacks-more-morphisms-lemma-etale-local-finite-inertia}
\source{stacks:0DUE}
\href{https://stacks.math.columbia.edu/tag/0DUE}{\texttt{Stacks tag 0DUE}}
\group{stacks-more-morphisms}
...
$\mathcal{U}''$ is separated (Lemma \ref{stacks-more-morphisms-lemma-well-nigh-affine})
...
\source{stacks:0DUT}
\href{https://stacks.math.columbia.edu/tag/0DUT}{\texttt{Stacks tag 0DUT}}
\group{stacks-more-morphisms}
...
Lemma \ref{stacks-more-morphisms-lemma-etale-local-finite-inertia}; we will use all
of the properties listed in this lemma without further mention.
Let
$$
f_i : \mathcal{X}_i \to M_i
$$
be as in Lemma \ref{stacks-more-morphisms-lemma-well-nigh-affine-moduli-space}.
Consider the stacks
$$
...
Morphisms of Stacks, Lemma
\ref{stacks-morphisms-lemma-base-change-stabilizer-preserving}.
Thus we may apply Lemma \ref{stacks-more-morphisms-lemma-etale-separated-over-well-nigh-affine}
to find a commutative diagram
$$
\begin{array}{ccc}\mathcal{X}_i \underset{f_i}{\downarrow} & \mathcal{X}_{ij} \underset{f_{ij}}{\downarrow}\longleftarrow\longrightarrow & \mathcal{X}_j \underset{f_j}{\downarrow} \\ M_i & M_{ij} \longleftarrow\longrightarrow & M_j\end{array}
$$
...
$$
\begin{array}{cc}\Mor(\Spec(k), \mathcal{X}_{ij}) \downarrow\longrightarrow & \Mor(\Spec(k), \mathcal{X}_j) \downarrow \\ \Mor(\Spec(k), \mathcal{X}_i) \longrightarrow & \Mor(\Spec(k), \mathcal{X})\end{array}
$$
...
\begin{array}{cc}\mathcal{X}_i \underset{g_i}{\longrightarrow}\underset{f_i}{\downarrow} & \mathcal{X} \overset{f}{\downarrow} \\ M_i \longrightarrow & M\end{array}
\end{equation}
...
the diagram
$$
\begin{array}{cc}\Mor(\Spec(k), M_i \times_M \mathcal{X}) \longrightarrow\downarrow & \Mor(\Spec(k), \mathcal{X}) \downarrow \\ M_i(k) \longrightarrow & M(k)\end{array}
$$
...
$$
\begin{array}{cc}M' \times_M \mathcal{X}_i \downarrow\longrightarrow & M' \times_M \mathcal{X} \overset{\theta}{\downarrow} \\ M' \times_M M_i \overset{\psi_i}{\longrightarrow} & E\end{array}
$$
...
$$
\begin{array}{cc}M' \times_M \mathcal{X} \downarrow\overset{\theta}{\searrow} &  \\ M' \overset{\psi}{\longrightarrow} & E\end{array}
$$
...
\begin{lemma}[Etale separated over keel mori]
\label{stacks-more-morphisms-lemma-etale-separated-over-keel-mori}
\source{stacks:0DUV}
\href{https://stacks.math.columbia.edu/tag/0DUV}{\texttt{Stacks tag 0DUV}}
\group{stacks-more-morphisms}
...
Lemma \ref{stacks-more-morphisms-lemma-etale-local-finite-inertia}.
...
Lemma \ref{stacks-more-morphisms-lemma-well-nigh-affine-moduli-space}.
In the proof of Theorem \ref{stacks-more-morphisms-theorem-keel-mori}
we have seen that the diagrams
$$
\begin{array}{cc}\mathcal{X}'_i \underset{f'_i}{\downarrow}\underset{g'_i}{\longrightarrow} & \mathcal{X}' \overset{f'}{\downarrow} \\ M'_i \longrightarrow & M'\end{array}
\quad\text{and}\quad
\begin{array}{cc}\mathcal{X}'_i \underset{f'_i}{\downarrow}\underset{g_i}{\longrightarrow} & \mathcal{X} \overset{f}{\downarrow} \\ M'_i \longrightarrow & M\end{array}
$$
...
diagram
$$
\begin{array}{cc}\mathcal{X}' \longrightarrow\downarrow & \mathcal{X}' \times_\mathcal{X} \mathcal{X}' \downarrow \\ M' \longrightarrow & M' \times_M M'\end{array}
$$
The top horizontal arrow is universally closed as
$\mathcal{X}' \to \mathcal{X}$ is separated.
The vertical arrows are as in Theorem \ref{stacks-more-morphisms-theorem-keel-mori}
...
establish properties of these moduli spaces.

\begin{lemma}[Keel mori finite type]
\label{stacks-more-morphisms-lemma-keel-mori-finite-type}
\source{stacks:0DUX}
\href{https://stacks.math.columbia.edu/tag/0DUX}{\texttt{Stacks tag 0DUX}}
\group{stacks-more-morphisms}
...
as in Lemma \ref{stacks-more-morphisms-lemma-etale-local-finite-inertia}.
Then by Lemma \ref{stacks-more-morphisms-lemma-etale-separated-over-keel-mori}
...
\begin{lemma}[Keel mori diagonal]
\label{stacks-more-morphisms-lemma-keel-mori-diagonal}
\source{stacks:0DUY}
\href{https://stacks.math.columbia.edu/tag/0DUY}{\texttt{Stacks tag 0DUY}}
\group{stacks-more-morphisms}
...
$$
\begin{array}{cc}\mathcal{X} \underset{f}{\downarrow}\underset{\Delta_\mathcal{X}}{\longrightarrow} & \mathcal{X} \times \mathcal{X} \overset{f \times f}{\downarrow} \\ M \overset{\Delta_M}{\longrightarrow} & M \times M\end{array}
$$
...
\begin{lemma}[Keel mori proper]
\label{stacks-more-morphisms-lemma-keel-mori-proper}
\source{stacks:0DUZ}
\href{https://stacks.math.columbia.edu/tag/0DUZ}{\texttt{Stacks tag 0DUZ}}
\group{stacks-more-morphisms}
...
\end{enumerate}
Let $f : \mathcal{X} \to M$ be the moduli space constructed in
Theorem \ref{stacks-more-morphisms-theorem-keel-mori}. Then $M \to Y$ is proper.
\end{lemma}

\begin{proof}
By Lemma \ref{stacks-more-morphisms-lemma-keel-mori-finite-type}
we see that $M \to Y$ is locally of finite type.
By Lemma \ref{stacks-more-morphisms-lemma-keel-mori-diagonal} we see that
$M \to Y$ is separated.
...
\begin{proposition}[Stack fpqc]
\label{stacks-more-morphisms-proposition-stack-fpqc}
\source{stacks:0GRH}
\href{https://stacks.math.columbia.edu/tag/0GRH}{\texttt{Stacks tag 0GRH}}
\group{stacks-more-morphisms}
...
$$
\begin{array}{ccc}W' \downarrow & W_i \longleftarrow\downarrow\longrightarrow & W \downarrow \\ U & U_i \longleftarrow\overset{x_i}{\longrightarrow} & \mathcal{X}\end{array}
$$
...
$$
\begin{array}{ccc}W_i \downarrow\longrightarrow & W' \downarrow\longrightarrow & W \downarrow \\ U_i \longrightarrow\underset{x_i}{\longrightarrow} & U & \mathcal{X}\end{array}
$$
...
a diagram
$$
\begin{array}{ccc}W_{\alpha, i} \downarrow\longrightarrow & W_\alpha' \downarrow\longrightarrow & W_\alpha \downarrow \\ U_i \longrightarrow\underset{x_i}{\longrightarrow} & U & \mathcal{X}\end{array}
$$
...
Theorem \ref{stacks-more-morphisms-theorem-main} as an introduction to these ideas.
...
\source{stacks:0GRJ}
\href{https://stacks.math.columbia.edu/tag/0GRJ}{\texttt{Stacks tag 0GRJ}}
\group{stacks-more-morphisms}
...
\source{stacks:0GRK}
\href{https://stacks.math.columbia.edu/tag/0GRK}{\texttt{Stacks tag 0GRK}}
\group{stacks-more-morphisms}
...
$$
\begin{array}{ccc}g_{\QCoh, *}\mathcal{O}_U \otimes_{\mathcal{O}_\mathcal{X}}
g_{\QCoh, *}\mathcal{O}_U
\underset{\kappa(r) \otimes 1}{\downarrow}\underset{\mu}{\longrightarrow} &  & g_{\QCoh, *}\mathcal{O}_U \overset{\kappa(r)}{\downarrow} \\ g_{\QCoh, *}\mathcal{O}_U \otimes_{\mathcal{O}_\mathcal{X}}
g_{\QCoh, *}\mathcal{O}_U
\overset{\mu}{\longrightarrow} &  & g_{\QCoh, *}\mathcal{O}_U\end{array}
$$
...
\source{stacks:0GRL}
\href{https://stacks.math.columbia.edu/tag/0GRL}{\texttt{Stacks tag 0GRL}}
\group{stacks-more-morphisms}

Notation as in Lemma \ref{stacks-more-morphisms-lemma-affine}. Assume $\mathcal{X}$ is
...
\source{stacks:0GRM}
\href{https://stacks.math.columbia.edu/tag/0GRM}{\texttt{Stacks tag 0GRM}}
\group{stacks-more-morphisms}
...
cohomology of quasi-coherent modules on algebraic stacks.

\begin{lemma}[Easy kunneth]
\label{stacks-more-morphisms-lemma-easy-kunneth}
\source{stacks:0GRN}
\href{https://stacks.math.columbia.edu/tag/0GRN}{\texttt{Stacks tag 0GRN}}
\group{stacks-more-morphisms}
...
\source{stacks:0GRP}
\href{https://stacks.math.columbia.edu/tag/0GRP}{\texttt{Stacks tag 0GRP}}
\group{stacks-more-morphisms}
...
with ring map $A \to C_i$ constructed in Lemma \ref{stacks-more-morphisms-lemma-affine}
...
diagrams
$$
\begin{array}{cc}U_i \longrightarrow\downarrow & U \overset{g}{\downarrow} \\ \Spec(B) \overset{f_i}{\longrightarrow} & \mathcal{X}\end{array}
\quad\quad
\begin{array}{ccc} & U_2 \swarrow\overset{\cong}{\downarrow}\searrow &  \\ \Spec(B) & U_1 \longleftarrow\longrightarrow & U\end{array}
$$
...
\source{stacks:0GRQ}
\href{https://stacks.math.columbia.edu/tag/0GRQ}{\texttt{Stacks tag 0GRQ}}
\group{stacks-more-morphisms}
...
Lemma \ref{stacks-more-morphisms-lemma-affine} to get the finite type
commutative $B$-algebra $C = F(g_{\QCoh, *}\mathcal{O}_U)$
and the ring map $A \to C$.
By Lemma \ref{stacks-more-morphisms-lemma-universally-injective}
...
by Lemma \ref{stacks-more-morphisms-lemma-easy-kunneth} we have the first equality in
$$
g_{\QCoh, *}\mathcal{O}_U
\otimes_{\mathcal{O}_\mathcal{X}}
g_{\QCoh, *}\mathcal{O}_U
...
Lemma \ref{stacks-more-morphisms-lemma-affine}. Since $A \to R$ is flat (because
$\text{pr}_2$ is flat as a base change of $U \to \mathcal{X}$),
we conclude that $C \otimes_B C$ is flat over $C$.
By Lemma \ref{stacks-more-morphisms-lemma-flat} we conclude that $B \to C$ is faithfully flat.

\medskip\noindent
We claim there is a solid commutative diagram
$$
\begin{array}{cc}\Spec(C \otimes_B C) \downarrow\downarrow\longrightarrow & U \times_\mathcal{X} U \downarrow\downarrow \\ \Spec(C) \downarrow\longrightarrow & U \downarrow \\ \Spec(B) \dashrightarrow & \mathcal{X}\end{array}
$$
The arrow $\Spec(C) \to U = \Spec(A)$ comes from the ring map
$A \to C$ in the statement of Lemma \ref{stacks-more-morphisms-lemma-affine}.
The arrow $\Spec(C \otimes_B C) \to U \times_\mathcal{X} U$
similarly comes from the ring map $R \to C \otimes_B C$.
To verify the top square commutes use Lemma \ref{stacks-more-morphisms-lemma-fully-faithful};
details omitted.
We conclude we get the dotted arrow $\Spec(B) \to \mathcal{X}$
by Proposition \ref{stacks-more-morphisms-proposition-stack-fpqc}.
...
statement in Lemma \ref{stacks-more-morphisms-lemma-affine}. Details omitted.
\end{proof}
...
\source{stacks:0GRR}
\href{https://stacks.math.columbia.edu/tag/0GRR}{\texttt{Stacks tag 0GRR}}
\group{stacks-more-morphisms}
...
\begin{proof}
By Lemma \ref{stacks-more-morphisms-lemma-extend}
...
Lemma \ref{stacks-more-morphisms-lemma-main}.
\end{proof}
