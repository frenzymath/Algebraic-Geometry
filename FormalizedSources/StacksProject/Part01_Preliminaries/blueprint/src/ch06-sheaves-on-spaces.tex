...
\source{stacks:006E}
\href{https://stacks.math.columbia.edu/tag/006E}{\texttt{Stacks tag 006E}}
\group{sheaves}
...
diagram
$$
\begin{array}{cc}\mathcal{F}(U) \overset{\varphi}{\longrightarrow}\overset{\rho^U_V}{\downarrow} & \mathcal{G}(U) \overset{\rho^U_V}{\downarrow} \\ \mathcal{F}(V) \overset{\varphi}{\longrightarrow} & \mathcal{G}(V)\end{array}
$$
commutes.
...
\begin{definition}[Constant presheaf]
\label{sheaves-definition-constant-presheaf}
\source{stacks:006F}
\href{https://stacks.math.columbia.edu/tag/006F}{\texttt{Stacks tag 006F}}
\group{sheaves}
...
\begin{example}[Singleton presheaf]
\label{sheaves-example-singleton-presheaf}
\source{stacks:006H}
\href{https://stacks.math.columbia.edu/tag/006H}{\texttt{Stacks tag 006H}}
\group{sheaves}
...
\begin{lemma}[Product presheaves]
\label{sheaves-lemma-product-presheaves}
\source{stacks:006I}
\href{https://stacks.math.columbia.edu/tag/006I}{\texttt{Stacks tag 006I}}
\group{sheaves}
...
\begin{lemma}[Abelian presheaves]
\label{sheaves-lemma-abelian-presheaves}
\source{stacks:006J}
\href{https://stacks.math.columbia.edu/tag/006J}{\texttt{Stacks tag 006J}}
\group{sheaves}

\uses{sheaves-example-singleton-presheaf}
Let $X$ be a topological space.
...
(see Example \ref{sheaves-example-singleton-presheaf})
...
\begin{definition}[Abelian presheaves]
\label{sheaves-definition-abelian-presheaves}
\source{stacks:006K}
\href{https://stacks.math.columbia.edu/tag/006K}{\texttt{Stacks tag 006K}}
\group{sheaves}

\uses{sheaves-lemma-abelian-presheaves}
Let $X$ be a topological space.
\begin{enumerate}
...
Lemma \ref{sheaves-lemma-abelian-presheaves} above.
...
\begin{example}[Direct sum points]
\label{sheaves-example-direct-sum-points}
\source{stacks:006L}
\href{https://stacks.math.columbia.edu/tag/006L}{\texttt{Stacks tag 006L}}
\group{sheaves}
...
\medskip\noindent
In analogy with Definition \ref{sheaves-definition-abelian-presheaves}
...
\begin{definition}[Presheaf values in category]
\label{sheaves-definition-presheaf-values-in-category}
\source{stacks:006N}
\href{https://stacks.math.columbia.edu/tag/006N}{\texttt{Stacks tag 006N}}
\group{sheaves}
...
\begin{definition}[Underlying presheaf sets]
\label{sheaves-definition-underlying-presheaf-sets}
\source{stacks:006O}
\href{https://stacks.math.columbia.edu/tag/006O}{\texttt{Stacks tag 006O}}
\group{sheaves}
...
Definition \ref{sheaves-definition-presheaf-values-in-category}.
...
\ref{sheaves-definition-abelian-presheaves} we are tempted to define
...
\source{stacks:006Q}
\href{https://stacks.math.columbia.edu/tag/006Q}{\texttt{Stacks tag 006Q}}
\group{sheaves}
...
This presheaf is called the {\it tensor product presheaf}. We obtain
...
\source{stacks:006R}
\href{https://stacks.math.columbia.edu/tag/006R}{\texttt{Stacks tag 006R}}
\group{sheaves}
...
\source{stacks:006T}
\href{https://stacks.math.columbia.edu/tag/006T}{\texttt{Stacks tag 006T}}
\group{sheaves}
...
\begin{remark}[Confusion]
\label{sheaves-remark-confusion}
\source{stacks:006U}
\href{https://stacks.math.columbia.edu/tag/006U}{\texttt{Stacks tag 006U}}
\group{sheaves}
...
\begin{example}[Basic continuous maps]
\label{sheaves-example-basic-continuous-maps}
\source{stacks:006V}
\href{https://stacks.math.columbia.edu/tag/006V}{\texttt{Stacks tag 006V}}
\group{sheaves}
...
\source{stacks:006W}
\href{https://stacks.math.columbia.edu/tag/006W}{\texttt{Stacks tag 006W}}
\group{sheaves}
...
\begin{example}[Sheaf product pointwise]
\label{sheaves-example-sheaf-product-pointwise}
\source{stacks:006X}
\href{https://stacks.math.columbia.edu/tag/006X}{\texttt{Stacks tag 006X}}
\group{sheaves}
...
\begin{example}[Direct sum points not sheaf]
\label{sheaves-example-direct-sum-points-not-sheaf}
\source{stacks:006Y}
\href{https://stacks.math.columbia.edu/tag/006Y}{\texttt{Stacks tag 006Y}}
\group{sheaves}

\uses{sheaves-example-direct-sum-points}
Let $X$ be a topological space.
Suppose for each $x\in X$ we are given an abelian group $M_x$.
Consider the presheaf $\mathcal{F} : U \mapsto \bigoplus_{x \in U} M_x$
defined in Example \ref{sheaves-example-direct-sum-points}. This
...
\begin{definition}[Abelian sheaf]
\label{sheaves-definition-abelian-sheaf}
\source{stacks:0070}
\href{https://stacks.math.columbia.edu/tag/0070}{\texttt{Stacks tag 0070}}
\group{sheaves}
...
\begin{definition}[Sheaf values in category]
\label{sheaves-definition-sheaf-values-in-category}
\source{stacks:0072}
\href{https://stacks.math.columbia.edu/tag/0072}{\texttt{Stacks tag 0072}}
\group{sheaves}
...
(Definition \ref{sheaves-definition-underlying-presheaf-sets}).
Note that the underlying
presheaf of sets is a sheaf of sets if and only if all the
diagrams
$$
\begin{array}{ccc}F(\mathcal{F}(U)) \longrightarrow & \prod\nolimits_{i\in I}
F(\mathcal{F}(U_i))
\longrightarrow\longrightarrow & \prod\nolimits_{(i_0, i_1) \in I \times I}
F(\mathcal{F}(U_{i_0} \cap U_{i_1}))\end{array}
$$
...
(see Example \ref{sheaves-example-sheaves-topological-spaces});
...
\begin{lemma}[Sheaves structure]
\label{sheaves-lemma-sheaves-structure}
\source{stacks:0073}
\href{https://stacks.math.columbia.edu/tag/0073}{\texttt{Stacks tag 0073}}
\group{sheaves}
...
\begin{proof}
\uses{sheaves-definition-sheaf-values-in-category}
...
Definition \ref{sheaves-definition-sheaf-values-in-category}.
...
\begin{example}[C0 sheaf rings]
\label{sheaves-example-C0-sheaf-rings}
\source{stacks:0074}
\href{https://stacks.math.columbia.edu/tag/0074}{\texttt{Stacks tag 0074}}
\group{sheaves}

\uses{sheaves-example-basic-continuous-maps, sheaves-lemma-sheaves-structure}
...
By Example \ref{sheaves-example-basic-continuous-maps} it is a sheaf of sets.
Hence by the Lemma \ref{sheaves-lemma-sheaves-structure} it is a sheaf of
$\mathbf{R}$-algebras over $X$.
\end{example}

\begin{example}[Sheaves topological spaces]
\label{sheaves-example-sheaves-topological-spaces}
\source{stacks:0075}
\href{https://stacks.math.columbia.edu/tag/0075}{\texttt{Stacks tag 0075}}
\group{sheaves}

\uses{sheaves-lemma-sheaves-structure, sheaves-example-sheaf-product-pointwise, sheaves-definition-sheaf-values-in-category}
...
the analogue of Lemma \ref{sheaves-lemma-sheaves-structure} is wrong.
...
Example \ref{sheaves-example-sheaf-product-pointwise}.
However, if each $A_i$ has at least two elements, then
this is not a sheaf of topological spaces
according to Definition \ref{sheaves-definition-sheaf-values-in-category}.
...
\source{stacks:0077}
\href{https://stacks.math.columbia.edu/tag/0077}{\texttt{Stacks tag 0077}}
\group{sheaves}

\uses{sheaves-definition-presheaf-modules}
Let $X$ be a topological space.
Let $\mathcal{O}$ be a sheaf of rings on $X$.
\begin{enumerate}
\item A {\it sheaf of $\mathcal{O}$-modules} is a presheaf
of $\mathcal{O}$-modules $\mathcal{F}$,
see Definition \ref{sheaves-definition-presheaf-modules},
...
\begin{lemma}[Sheaf subset stalks]
\label{sheaves-lemma-sheaf-subset-stalks}
\source{stacks:0079}
\href{https://stacks.math.columbia.edu/tag/0079}{\texttt{Stacks tag 0079}}
\group{sheaves}
...
\source{stacks:007A}
\href{https://stacks.math.columbia.edu/tag/007A}{\texttt{Stacks tag 007A}}
\group{sheaves}
...
\begin{example}[Stalk constant presheaf]
\label{sheaves-example-stalk-constant-presheaf}
\source{stacks:007B}
\href{https://stacks.math.columbia.edu/tag/007B}{\texttt{Stacks tag 007B}}
\group{sheaves}
...
\begin{example}[Germs functions]
\label{sheaves-example-germs-functions}
\source{stacks:007C}
\href{https://stacks.math.columbia.edu/tag/007C}{\texttt{Stacks tag 007C}}
\group{sheaves}

\uses{sheaves-example-basic-continuous-maps}
...
As in Example \ref{sheaves-example-basic-continuous-maps}
...
\begin{example}[Sheaf product pointwise stalk]
\label{sheaves-example-sheaf-product-pointwise-stalk}
\source{stacks:007D}
\href{https://stacks.math.columbia.edu/tag/007D}{\texttt{Stacks tag 007D}}
\group{sheaves}

\uses{sheaves-example-sheaf-product-pointwise}
...
\ref{sheaves-example-sheaf-product-pointwise}. We would just like to point
...
\begin{lemma}[Stalk abelian presheaf]
\label{sheaves-lemma-stalk-abelian-presheaf}
\source{stacks:007F}
\href{https://stacks.math.columbia.edu/tag/007F}{\texttt{Stacks tag 007F}}
\group{sheaves}
...
The proof of Lemma \ref{sheaves-lemma-stalk-abelian-presheaf} will work
for any type of algebraic structure such that directed
colimits commute with the forgetful functor.

\begin{lemma}[Stalk presheaf values in category]
\label{sheaves-lemma-stalk-presheaf-values-in-category}
\source{stacks:007H}
\href{https://stacks.math.columbia.edu/tag/007H}{\texttt{Stacks tag 007H}}
\group{sheaves}
...
\begin{lemma}[Stalk module]
\label{sheaves-lemma-stalk-module}
\source{stacks:007J}
\href{https://stacks.math.columbia.edu/tag/007J}{\texttt{Stacks tag 007J}}
\group{sheaves}
...
\begin{lemma}[Stalk tensor presheaf modules]
\label{sheaves-lemma-stalk-tensor-presheaf-modules}
\source{stacks:007K}
\href{https://stacks.math.columbia.edu/tag/007K}{\texttt{Stacks tag 007K}}
\group{sheaves}
...
\source{stacks:007M}
\href{https://stacks.math.columbia.edu/tag/007M}{\texttt{Stacks tag 007M}}
\group{sheaves}
...
\begin{lemma}[List algebraic structures]
\label{sheaves-lemma-list-algebraic-structures}
\source{stacks:007N}
\href{https://stacks.math.columbia.edu/tag/007N}{\texttt{Stacks tag 007N}}
\group{sheaves}
...
This is allowable by Lemmas \ref{sheaves-lemma-sheaves-structure} and
...
\begin{lemma}[Properties algebraic structures]
\label{sheaves-lemma-properties-algebraic-structures}
\source{stacks:007O}
\href{https://stacks.math.columbia.edu/tag/007O}{\texttt{Stacks tag 007O}}
\group{sheaves}
...
\begin{lemma}[Image contained in]
\label{sheaves-lemma-image-contained-in}
\source{stacks:007P}
\href{https://stacks.math.columbia.edu/tag/007P}{\texttt{Stacks tag 007P}}
\group{sheaves}
...
\begin{example}[Application lemma image contained in]
\label{sheaves-example-application-lemma-image-contained-in}
\source{stacks:007Q}
\href{https://stacks.math.columbia.edu/tag/007Q}{\texttt{Stacks tag 007Q}}
\group{sheaves}

The lemma will be applied often to the following situation.
Suppose that we have a diagram
$$
\begin{array}{cc}A \longrightarrow & B \downarrow \\ C \longrightarrow & D\end{array}
$$
...
$$
\begin{array}{cc}A \longrightarrow\downarrow & B \downarrow \\ C \longrightarrow & D\end{array}
$$
in $\mathcal{C}$.
\end{example}

\begin{example}[Sheaf product pointwise algebraic structure]
\label{sheaves-example-sheaf-product-pointwise-algebraic-structure}
\source{stacks:007R}
\href{https://stacks.math.columbia.edu/tag/007R}{\texttt{Stacks tag 007R}}
\group{sheaves}
...
by Example \ref{sheaves-example-sheaf-product-pointwise}.
...
\begin{lemma}[Points exactness]
\label{sheaves-lemma-points-exactness}
\source{stacks:007T}
\href{https://stacks.math.columbia.edu/tag/007T}{\texttt{Stacks tag 007T}}
\group{sheaves}
...
\source{stacks:007U}
\href{https://stacks.math.columbia.edu/tag/007U}{\texttt{Stacks tag 007U}}
\group{sheaves}
...
\begin{lemma}[Characterize epi mono]
\label{sheaves-lemma-characterize-epi-mono}
\source{stacks:0H7H}
\href{https://stacks.math.columbia.edu/tag/0H7H}{\texttt{Stacks tag 0H7H}}
\group{sheaves}
...
\begin{lemma}[Check homomorphism stalks]
\label{sheaves-lemma-check-homomorphism-stalks}
\source{stacks:007W}
\href{https://stacks.math.columbia.edu/tag/007W}{\texttt{Stacks tag 007W}}
\group{sheaves}
...
\begin{proof}
\uses{sheaves-lemma-sheaf-subset-stalks, sheaves-lemma-image-contained-in, sheaves-example-application-lemma-image-contained-in}

Let $U$ be an open subset of $X$. Consider the diagram of
(underlying) sets
$$
\begin{array}{cc}\mathcal{F}(U) \longrightarrow\downarrow & \prod_{x \in U} \mathcal{F}_x \downarrow \\ \mathcal{G}(U) \longrightarrow & \prod_{x \in U} \mathcal{G}_x\end{array}
$$
...
see Lemma \ref{sheaves-lemma-sheaf-subset-stalks}.
Hence we conclude by Lemma \ref{sheaves-lemma-image-contained-in},
see also Example \ref{sheaves-example-application-lemma-image-contained-in}
\end{proof}
...
described in Section \ref{sheaves-section-stalks} clearly has image
in $\mathcal{F}^{\#}(U)$. In addition, if $V \subset U \subset X$ are
open then we have the following commutative diagram
$$
\begin{array}{ccc}\mathcal{F}(U) \longrightarrow\downarrow & \mathcal{F}^{\#}(U) \longrightarrow\downarrow & \prod_{u\in U} \mathcal{F}_u \downarrow \\ \mathcal{F}(V) \longrightarrow & \mathcal{F}^{\#}(V) \longrightarrow & \prod_{v\in V} \mathcal{F}_v\end{array}
$$
...
\medskip\noindent
In Example \ref{sheaves-example-sheaf-product-pointwise} we saw
...
\begin{lemma}[Sheafification sheaf]
\label{sheaves-lemma-sheafification-sheaf}
\source{stacks:007Y}
\href{https://stacks.math.columbia.edu/tag/007Y}{\texttt{Stacks tag 007Y}}
\group{sheaves}
...
function is a sheaf, see Example \ref{sheaves-example-basic-continuous-maps}
...
\begin{lemma}[Stalk sheafification]
\label{sheaves-lemma-stalk-sheafification}
\source{stacks:007Z}
\href{https://stacks.math.columbia.edu/tag/007Z}{\texttt{Stacks tag 007Z}}
\group{sheaves}
...
\begin{proof}
\uses{sheaves-example-sheaf-product-pointwise-stalk}
...
see Example \ref{sheaves-example-sheaf-product-pointwise-stalk}.
...
\begin{lemma}[Sheafify universal]
\label{sheaves-lemma-sheafify-universal}
\source{stacks:0080}
\href{https://stacks.math.columbia.edu/tag/0080}{\texttt{Stacks tag 0080}}
\group{sheaves}
...
\begin{proof}
\uses{sheaves-lemma-points-exactness, sheaves-lemma-stalk-sheafification}

Clearly, there is a commutative diagram
$$
\begin{array}{ccc}\mathcal{F} \longrightarrow\downarrow & \mathcal{F}^\# \longrightarrow\downarrow & \Pi(\mathcal{F}) \downarrow \\ \mathcal{G} \longrightarrow & \mathcal{G}^\# \longrightarrow & \Pi(\mathcal{G}) \\  &  & \end{array}
$$
...
Lemma \ref{sheaves-lemma-points-exactness}. And this is
Lemma \ref{sheaves-lemma-stalk-sheafification} above.
\end{proof}
...
\begin{example}[Sheafify constant]
\label{sheaves-example-sheafify-constant}
\source{stacks:0081}
\href{https://stacks.math.columbia.edu/tag/0081}{\texttt{Stacks tag 0081}}
\group{sheaves}

\uses{sheaves-example-stalk-constant-presheaf}
See Example \ref{sheaves-example-stalk-constant-presheaf} for notation.
...
\begin{lemma}[Separated presheaf into sheaf]
\label{sheaves-lemma-separated-presheaf-into-sheaf}
\source{stacks:0082}
\href{https://stacks.math.columbia.edu/tag/0082}{\texttt{Stacks tag 0082}}
\group{sheaves}

\uses{sheaves-definition-separated}
Let $X$ be a topological space.
A presheaf $\mathcal{F}$ is separated (see
Definition \ref{sheaves-definition-separated}) if and only if
...
\begin{lemma}[Sheafify epi mono]
\label{sheaves-lemma-sheafify-epi-mono}
\source{stacks:0H7I}
\href{https://stacks.math.columbia.edu/tag/0H7I}{\texttt{Stacks tag 0H7I}}
\group{sheaves}
...
\begin{lemma}[Diagram fibre product]
\label{sheaves-lemma-diagram-fibre-product}
\source{stacks:0084}
\href{https://stacks.math.columbia.edu/tag/0084}{\texttt{Stacks tag 0084}}
\group{sheaves}

\uses{sheaves-lemma-stalk-sheafification}
...
$$
\begin{array}{cc}\mathcal{F}^\#(U) \downarrow\longrightarrow & \Pi(\mathcal{F})(U) \downarrow \\ \prod_{x \in U} \mathcal{F}_x
\longrightarrow & \prod_{x \in U} \Pi(\mathcal{F})_x\end{array}
$$
where the maps are the following:
\begin{enumerate}
\item The left vertical map has components
$\mathcal{F}^\#(U) \to \mathcal{F}^\#_x = \mathcal{F}_x$
where the equality is Lemma \ref{sheaves-lemma-stalk-sheafification}.
\item The top horizontal map comes from the
map of presheaves $\mathcal{F} \to \Pi(\mathcal{F})$ described
in Section \ref{sheaves-section-sheafification}.
...
Lemma \ref{sheaves-lemma-stalk-sheafification}).
...
\begin{lemma}[Sheafify abelian presheaf]
\label{sheaves-lemma-sheafify-abelian-presheaf}
\source{stacks:0085}
\href{https://stacks.math.columbia.edu/tag/0085}{\texttt{Stacks tag 0085}}
\group{sheaves}
...
\begin{proof}
\uses{sheaves-lemma-stalk-abelian-presheaf, sheaves-example-sheaf-product-pointwise-algebraic-structure, sheaves-lemma-diagram-fibre-product, sheaves-lemma-stalk-sheafification, sheaves-lemma-check-homomorphism-stalks}

Recall the sheaf of sets $\Pi(\mathcal{F})$ defined in
Section \ref{sheaves-section-sheafification}. All the stalks
$\mathcal{F}_x$ are abelian groups, see
Lemma \ref{sheaves-lemma-stalk-abelian-presheaf}.
Hence $\Pi(\mathcal{F})$ is a sheaf of abelian groups by
Example \ref{sheaves-example-sheaf-product-pointwise-algebraic-structure}.
Also, it is clear that the map $\mathcal{F} \to \Pi(\mathcal{F})$
is a morphism of abelian presheaves. If we show that
condition $(*)$ of Section \ref{sheaves-section-sheafification} defines a subgroup
...
Lemma \ref{sheaves-lemma-diagram-fibre-product} show that
...
group by Lemma \ref{sheaves-lemma-stalk-abelian-presheaf}
and that $\mathcal{F}_x \to \mathcal{F}^\#_x$ is a
bijection (Lemma \ref{sheaves-lemma-stalk-sheafification})
...
by Lemma \ref{sheaves-lemma-stalk-sheafification}, and then using
Lemma \ref{sheaves-lemma-check-homomorphism-stalks} above.
\end{proof}

\section{Sheafification of presheaves of algebraic structures}
\label{sheaves-section-sheafification-presheaves-structures}
\begin{lemma}[Sheafify presheaf structures]
\label{sheaves-lemma-sheafify-presheaf-structures}
\source{stacks:0087}
\href{https://stacks.math.columbia.edu/tag/0087}{\texttt{Stacks tag 0087}}
\group{sheaves}
...
\begin{proof}
\uses{sheaves-lemma-sheafify-abelian-presheaf, sheaves-lemma-image-contained-in, sheaves-example-application-lemma-image-contained-in, sheaves-lemma-diagram-fibre-product}

The proof is the same as the proof of
Lemma \ref{sheaves-lemma-sheafify-abelian-presheaf},
with repeated application of
Lemma \ref{sheaves-lemma-image-contained-in} (see also
Example \ref{sheaves-example-application-lemma-image-contained-in}).
The main idea however, is to define $\mathcal{F}^\#(U)$
as the fibre product in $\mathcal{C}$ of the diagram
$$
\begin{array}{cc} & \Pi(\mathcal{F})(U) \downarrow \\ \prod_{x \in U} \mathcal{F}_x
\longrightarrow & \prod_{x \in U} \Pi(\mathcal{F})_x\end{array}
$$
compare Lemma \ref{sheaves-lemma-diagram-fibre-product}.
\end{proof}
...
\source{stacks:0089}
\href{https://stacks.math.columbia.edu/tag/0089}{\texttt{Stacks tag 0089}}
\group{sheaves}
...
In Section \ref{sheaves-section-presheaves-modules}
...
\source{stacks:008A}
\href{https://stacks.math.columbia.edu/tag/008A}{\texttt{Stacks tag 008A}}
\group{sheaves}
...
\begin{proof}
\uses{sheaves-lemma-adjointness-tensor-restrict-presheaves}

This follows from
Lemma \ref{sheaves-lemma-adjointness-tensor-restrict-presheaves}
and the fact that
$\Hom_{\mathcal{O}_2}(
\mathcal{O}_2 \otimes_{\mathcal{O}_1} \mathcal{G},
\mathcal{F}
...
\begin{lemma}[Stalk tensor sheaf modules]
\label{sheaves-lemma-stalk-tensor-sheaf-modules}
\source{stacks:008B}
\href{https://stacks.math.columbia.edu/tag/008B}{\texttt{Stacks tag 008B}}
\group{sheaves}
...
\begin{proof}
\uses{sheaves-lemma-stalk-tensor-presheaf-modules}

Follows directly from Lemma \ref{sheaves-lemma-stalk-tensor-presheaf-modules}
...
$$
\begin{array}{cc}f_*\mathcal{F}(V_2) \downarrow\xlongequal{} & \mathcal{F}(f^{-1}(V_2)) \overset{\text{restriction for }\mathcal{F}}{\downarrow} \\ f_*\mathcal{F}(V_1) \xlongequal{} & \mathcal{F}(f^{-1}(V_1))\end{array}
$$
...
\source{stacks:008D}
\href{https://stacks.math.columbia.edu/tag/008D}{\texttt{Stacks tag 008D}}
\group{sheaves}
...
\begin{lemma}[Pushforward composition]
\label{sheaves-lemma-pushforward-composition}
\source{stacks:008E}
\href{https://stacks.math.columbia.edu/tag/008E}{\texttt{Stacks tag 008E}}
\group{sheaves}
...
\begin{lemma}[Pullback presheaves]
\label{sheaves-lemma-pullback-presheaves}
\source{stacks:008F}
\href{https://stacks.math.columbia.edu/tag/008F}{\texttt{Stacks tag 008F}}
\group{sheaves}
...
\begin{lemma}[Stalk pullback presheaf]
\label{sheaves-lemma-stalk-pullback-presheaf}
\source{stacks:008G}
\href{https://stacks.math.columbia.edu/tag/008G}{\texttt{Stacks tag 008G}}
\group{sheaves}
...
to this statement in the proof of Lemma \ref{sheaves-lemma-f-map}.

\begin{lemma}[Stalk pullback]
\label{sheaves-lemma-stalk-pullback}
\source{stacks:008H}
\href{https://stacks.math.columbia.edu/tag/008H}{\texttt{Stacks tag 008H}}
\group{sheaves}
...
\begin{proof}
\uses{sheaves-lemma-stalk-sheafification, sheaves-lemma-stalk-pullback-presheaf}

This is a combination of Lemmas \ref{sheaves-lemma-stalk-sheafification}
and \ref{sheaves-lemma-stalk-pullback-presheaf}.
\end{proof}

\begin{lemma}[Pullback composition]
\label{sheaves-lemma-pullback-composition}
\source{stacks:008I}
\href{https://stacks.math.columbia.edu/tag/008I}{\texttt{Stacks tag 008I}}
\group{sheaves}
...
\begin{proof}
\uses{sheaves-lemma-pushforward-composition}

To see this
use that adjoint functors are unique up to unique isomorphism,
and Lemma \ref{sheaves-lemma-pushforward-composition}.
\end{proof}

\begin{definition}[F map]
\label{sheaves-definition-f-map}
\source{stacks:008J}
\href{https://stacks.math.columbia.edu/tag/008J}{\texttt{Stacks tag 008J}}
\group{sheaves}
...
$$
\begin{array}{cc}\mathcal{G}(V) \underset{\xi_V}{\longrightarrow}\underset{\text{restriction of }\mathcal{G}}{\downarrow} & \mathcal{F}(f^{-1}V) \overset{\text{restriction of }\mathcal{F}}{\downarrow} \\ \mathcal{G}(V') \overset{\xi_{V'}}{\longrightarrow} & \mathcal{F}(f^{-1}V')\end{array}
$$
commutes for all $V' \subset V \subset Y$ open.
\end{definition}

In the literature we sometimes find this defined alternatively
as in part (4) of Lemma \ref{sheaves-lemma-f-map} but as the lemma shows there
is really no difference.

\begin{lemma}[F map]
\label{sheaves-lemma-f-map}
\source{stacks:008K}
\href{https://stacks.math.columbia.edu/tag/008K}{\texttt{Stacks tag 008K}}
\group{sheaves}
...
satisfy the condition in Definition \ref{sheaves-definition-f-map}.
...
\begin{definition}[Composition f maps]
\label{sheaves-definition-composition-f-maps}
\source{stacks:008L}
\href{https://stacks.math.columbia.edu/tag/008L}{\texttt{Stacks tag 008L}}
\group{sheaves}
...
$$
\begin{array}{ccc}\mathcal{H}(W) \underset{(\varphi \circ \psi)_W}{\longrightarrow}\underset{\psi_W}{\searrow} &  & \mathcal{F}(f^{-1}g^{-1}W) \\  & \mathcal{G}(g^{-1}W)
\underset{\varphi_{g^{-1}W}}{\nearrow} & \end{array}
$$
\end{definition}
...
$$
\begin{array}{cc}\mathcal{F}(f^{-1}V) \longrightarrow & \mathcal{F}_x \\ \mathcal{G}(V) \longrightarrow\overset{\varphi_V}{\uparrow} & \mathcal{G}_{f(x)} \overset{\varphi_x}{\uparrow}\end{array}
$$
(for $f(x) \in V \subset Y$ open) commute.

\begin{lemma}[Compose f maps stalks]
\label{sheaves-lemma-compose-f-maps-stalks}
\source{stacks:008M}
\href{https://stacks.math.columbia.edu/tag/008M}{\texttt{Stacks tag 008M}}
\group{sheaves}
...
\begin{proof}
\uses{sheaves-definition-composition-f-maps}

Immediate from Definition \ref{sheaves-definition-composition-f-maps}
...
of Lemma \ref{sheaves-lemma-pullback-presheaves}
...
from the proof of Lemma \ref{sheaves-lemma-pullback-presheaves} is a
...
see Lemma \ref{sheaves-lemma-pushforward-sheaf}. This defines the functor
...
\begin{lemma}[Pullback abelian stalk]
\label{sheaves-lemma-pullback-abelian-stalk}
\source{stacks:008O}
\href{https://stacks.math.columbia.edu/tag/008O}{\texttt{Stacks tag 008O}}
\group{sheaves}

\uses{sheaves-lemma-stalk-pullback-presheaf, sheaves-lemma-stalk-pullback}
Let $f : X \to Y$ be a continuous map.
\begin{enumerate}
\item Let $\mathcal{G}$ be an abelian presheaf on $Y$.
Let $x \in X$. The bijection
$\mathcal{G}_{f(x)} \to (f_p\mathcal{G})_x$ of
Lemma \ref{sheaves-lemma-stalk-pullback-presheaf} is an isomorphism of abelian groups.
\item Let $\mathcal{G}$ be an abelian sheaf on $Y$.
Let $x \in X$. The bijection
$\mathcal{G}_{f(x)} \to (f^{-1}\mathcal{G})_x$ of
Lemma \ref{sheaves-lemma-stalk-pullback} is an isomorphism of abelian groups.
\end{enumerate}
\end{lemma}
...
it exactly as in Definition \ref{sheaves-definition-f-map} (replacing maps
...
$$
\begin{array}{cccc}\textit{PSh}(X, \mathcal{C}) \overset{f_*}{\longrightarrow}\overset{F}{\downarrow} & \textit{PSh}(Y, \mathcal{C}) \overset{F}{\downarrow} & \Sh(X, \mathcal{C}) \overset{f_*}{\longrightarrow}\overset{F}{\downarrow} & \Sh(Y, \mathcal{C}) \overset{F}{\downarrow} \\ \textit{PSh}(X) \overset{f_*}{\longrightarrow} & \textit{PSh}(Y) & \Sh(X) \overset{f_*}{\longrightarrow} & \Sh(Y) \\ \textit{PSh}(Y, \mathcal{C}) \overset{f_p}{\longrightarrow}\overset{F}{\downarrow} & \textit{PSh}(X, \mathcal{C}) \overset{F}{\downarrow} & \Sh(Y, \mathcal{C}) \overset{f^{-1}}{\longrightarrow}\overset{F}{\downarrow} & \Sh(X, \mathcal{C}) \overset{F}{\downarrow} \\ \textit{PSh}(Y) \overset{f_p}{\longrightarrow} & \textit{PSh}(X) & \Sh(Y) \overset{f^{-1}}{\longrightarrow} & \Sh(X)\end{array}
$$
...
$$
which occur in the proof of Lemma \ref{sheaves-lemma-pullback-presheaves} as
...
\begin{lemma}[F map sets algebraic structures]
\label{sheaves-lemma-f-map-sets-algebraic-structures}
\source{stacks:008Q}
\href{https://stacks.math.columbia.edu/tag/008Q}{\texttt{Stacks tag 008Q}}
\group{sheaves}
...
\begin{lemma}[Pushforward presheaf module]
\label{sheaves-lemma-pushforward-presheaf-module}
\source{stacks:008S}
\href{https://stacks.math.columbia.edu/tag/008S}{\texttt{Stacks tag 008S}}
\group{sheaves}
...
\begin{lemma}[Pullback presheaf module]
\label{sheaves-lemma-pullback-presheaf-module}
\source{stacks:008T}
\href{https://stacks.math.columbia.edu/tag/008T}{\texttt{Stacks tag 008T}}
\group{sheaves}
...
\begin{lemma}[Adjoint push pull presheaves modules]
\label{sheaves-lemma-adjoint-push-pull-presheaves-modules}
\source{stacks:008U}
\href{https://stacks.math.columbia.edu/tag/008U}{\texttt{Stacks tag 008U}}
\group{sheaves}

\uses{sheaves-lemma-pullback-presheaf-module, sheaves-lemma-pushforward-presheaf-module, sheaves-lemma-pullback-presheaves}
Let $f : X \to Y$ be a continuous map of topological spaces.
...
$$
Here we use
Lemmas \ref{sheaves-lemma-pullback-presheaf-module}
and \ref{sheaves-lemma-pushforward-presheaf-module}, and we think of
$f_*\mathcal{F}$ as an $\mathcal{O}$-module via the map
$i_\mathcal{O} : \mathcal{O} \to f_*f_p\mathcal{O}$
(defined first in the proof of Lemma \ref{sheaves-lemma-pullback-presheaves}).
\end{lemma}
...
\Mor_{\textit{PAb}(Y)}(\mathcal{G}, f_*\mathcal{F}).
$$
according to Section \ref{sheaves-section-abelian-presheaves-functorial}.
...
\begin{lemma}[Adjoint pull push presheaves modules]
\label{sheaves-lemma-adjoint-pull-push-presheaves-modules}
\source{stacks:008V}
\href{https://stacks.math.columbia.edu/tag/008V}{\texttt{Stacks tag 008V}}
\group{sheaves}

\uses{sheaves-lemma-pullback-presheaf-module, sheaves-lemma-pushforward-presheaf-module}
Let $f : X \to Y$ be a continuous map of topological spaces.
Let $\mathcal{O}$ be a presheaf of rings on $X$.
Let $\mathcal{F}$ be a presheaf of $\mathcal{O}$-modules.
...
Here we use
Lemmas \ref{sheaves-lemma-pullback-presheaf-module}
and \ref{sheaves-lemma-pushforward-presheaf-module}, and we use
the map $c_\mathcal{O} : f_pf_*\mathcal{O} \to \mathcal{O}$
in the definition of the tensor product.
\end{lemma}

\begin{proof}
\uses{sheaves-lemma-adjointness-tensor-restrict-presheaves, sheaves-lemma-adjoint-push-pull-presheaves-modules, sheaves-lemma-pullback-presheaves}
...
Lemma \ref{sheaves-lemma-adjoint-push-pull-presheaves-modules}.
...
Lemma \ref{sheaves-lemma-pullback-presheaves}
and thus
...
\source{stacks:008W}
\href{https://stacks.math.columbia.edu/tag/008W}{\texttt{Stacks tag 008W}}
\group{sheaves}

\uses{sheaves-lemma-pushforward-presheaf-module}
Let $f : X \to Y$ be a continuous map of topological spaces.
...
Lemma \ref{sheaves-lemma-pushforward-presheaf-module}
is a sheaf of $f_*\mathcal{O}$-modules.
\end{lemma}

\begin{proof}
\uses{sheaves-lemma-pushforward-sheaf}

Obvious from the definition and Lemma \ref{sheaves-lemma-pushforward-sheaf}.
\end{proof}

\begin{lemma}[Pullback module]
\label{sheaves-lemma-pullback-module}
\source{stacks:008X}
\href{https://stacks.math.columbia.edu/tag/008X}{\texttt{Stacks tag 008X}}
\group{sheaves}
...
\begin{proof}
\uses{sheaves-lemma-pullback-presheaf-module, sheaves-lemma-sheafification-presheaf-modules}

Recall that $f^{-1}$ is defined as the composition of the
functor $f_p$ and sheafification. Thus the lemma
is a combination of Lemma \ref{sheaves-lemma-pullback-presheaf-module}
and Lemma \ref{sheaves-lemma-sheafification-presheaf-modules}.
\end{proof}
...
\source{stacks:008Y}
\href{https://stacks.math.columbia.edu/tag/008Y}{\texttt{Stacks tag 008Y}}
\group{sheaves}

\uses{sheaves-lemma-pullback-module, sheaves-lemma-pushforward-module}
Let $f : X \to Y$ be a continuous map of topological spaces.
...
$$
Here we use
Lemmas \ref{sheaves-lemma-pullback-module}
and \ref{sheaves-lemma-pushforward-module}, and we think of
$f_*\mathcal{F}$ as an $\mathcal{O}$-module by restriction via
$\mathcal{O} \to f_*f^{-1}\mathcal{O}$.
\end{lemma}

\begin{proof}
\uses{sheaves-lemma-adjoint-push-pull-presheaves-modules, sheaves-lemma-sheafification-presheaf-modules}
...
\end{eqnarray*}
where the second is
Lemmas \ref{sheaves-lemma-adjoint-push-pull-presheaves-modules}
and the first is by Lemma \ref{sheaves-lemma-sheafification-presheaf-modules}.
\end{proof}

\begin{lemma}[Adjoint pull push modules]
\label{sheaves-lemma-adjoint-pull-push-modules}
\source{stacks:008Z}
\href{https://stacks.math.columbia.edu/tag/008Z}{\texttt{Stacks tag 008Z}}
\group{sheaves}
...
Here we use
Lemmas \ref{sheaves-lemma-pullback-module}
and \ref{sheaves-lemma-pushforward-module}, and we use
the canonical map $f^{-1}f_*\mathcal{O} \to \mathcal{O}$
in the definition of the tensor product.
\end{lemma}

\begin{proof}
\uses{sheaves-lemma-adjointness-tensor-restrict, sheaves-lemma-adjoint-push-pull-modules}
...
Lemma \ref{sheaves-lemma-adjointness-tensor-restrict}
and \ref{sheaves-lemma-adjoint-push-pull-modules}.
\end{proof}
...
see Definition \ref{sheaves-definition-f-map} and
Lemma \ref{sheaves-lemma-f-map}.
For a precise example, see
Example \ref{sheaves-example-continuous-map-ringed} below. Here is the
relevant abstract definition.

\begin{definition}[Ringed space]
\label{sheaves-definition-ringed-space}
\source{stacks:0091}
\href{https://stacks.math.columbia.edu/tag/0091}{\texttt{Stacks tag 0091}}
\group{sheaves}
...
\begin{example}[Continuous map ringed]
\label{sheaves-example-continuous-map-ringed}
\source{stacks:0092}
\href{https://stacks.math.columbia.edu/tag/0092}{\texttt{Stacks tag 0092}}
\group{sheaves}

\uses{sheaves-example-C0-sheaf-rings, sheaves-definition-f-map, sheaves-lemma-f-map-sets-algebraic-structures}
Let $f : X \to Y$ be a continuous map of topological spaces.
Consider the sheaves of continuous real valued functions
$\mathcal{C}^0_X$ on $X$ and $\mathcal{C}^0_Y$ on $Y$,
see Example \ref{sheaves-example-C0-sheaf-rings}. We claim that there
...
Definition \ref{sheaves-definition-f-map} and compatible with the $\mathbf{R}$-algebra
structures. Hence it is an $f$-map of sheaves of $\mathbf{R}$-algebras, see
Lemma \ref{sheaves-lemma-f-map-sets-algebraic-structures}.
...
\begin{definition}[Composition maps ringed spaces]
\label{sheaves-definition-composition-maps-ringed-spaces}
\source{stacks:0093}
\href{https://stacks.math.columbia.edu/tag/0093}{\texttt{Stacks tag 0093}}
\group{sheaves}
...
Definition \ref{sheaves-definition-composition-f-maps}.
\end{definition}
...
\source{stacks:0095}
\href{https://stacks.math.columbia.edu/tag/0095}{\texttt{Stacks tag 0095}}
\group{sheaves}

\uses{sheaves-lemma-pushforward-module, sheaves-lemma-pullback-module}
...
in Lemma \ref{sheaves-lemma-pushforward-module}.
...
structure is given by Lemma \ref{sheaves-lemma-pullback-module}.
\end{enumerate}
\end{definition}
...
\source{stacks:0096}
\href{https://stacks.math.columbia.edu/tag/0096}{\texttt{Stacks tag 0096}}
\group{sheaves}
...
\Hom_{\mathcal{O}_Y}(\mathcal{G}, f_*\mathcal{F}).
\end{eqnarray*}
Here we use Lemmas \ref{sheaves-lemma-adjointness-tensor-restrict}
and \ref{sheaves-lemma-adjoint-push-pull-modules}.
\end{proof}
...
\source{stacks:0097}
\href{https://stacks.math.columbia.edu/tag/0097}{\texttt{Stacks tag 0097}}
\group{sheaves}
...
\begin{proof}
\uses{sheaves-lemma-pushforward-composition, sheaves-lemma-pullback-composition}

The result on pushforwards is a consequence of Lemma
\ref{sheaves-lemma-pushforward-composition} and our definitions.
The result on pullbacks follows from this by the same
argument as in the proof of Lemma \ref{sheaves-lemma-pullback-composition}.
\end{proof}
...
of abelian sheaves (see Definition \ref{sheaves-definition-f-map} and
Lemma \ref{sheaves-lemma-f-map}) such that for all open $V \subset Y$ the map
$$
...
\begin{lemma}[Stalk pullback modules]
\label{sheaves-lemma-stalk-pullback-modules}
\source{stacks:0098}
\href{https://stacks.math.columbia.edu/tag/0098}{\texttt{Stacks tag 0098}}
\group{sheaves}
...
\begin{proof}
\uses{sheaves-lemma-stalk-tensor-sheaf-modules}

This follows from Lemma \ref{sheaves-lemma-stalk-tensor-sheaf-modules}
and the identification of the stalks of pullback sheaves
at $x$ with the corresponding stalks at $f(x)$. See the
formulae in Section \ref{sheaves-section-presheaves-structures-functorial}
for example.
\end{proof}
...
\source{stacks:009A}
\href{https://stacks.math.columbia.edu/tag/009A}{\texttt{Stacks tag 009A}}
\group{sheaves}
...
\begin{lemma}[Skyscraper stalks]
\label{sheaves-lemma-skyscraper-stalks}
\source{stacks:009B}
\href{https://stacks.math.columbia.edu/tag/009B}{\texttt{Stacks tag 009B}}
\group{sheaves}
...
\begin{lemma}[Stalk skyscraper adjoint]
\label{sheaves-lemma-stalk-skyscraper-adjoint}
\source{stacks:009C}
\href{https://stacks.math.columbia.edu/tag/009C}{\texttt{Stacks tag 009C}}
\group{sheaves}
...
\source{stacks:009F}
\href{https://stacks.math.columbia.edu/tag/009F}{\texttt{Stacks tag 009F}}
\group{sheaves}
...
\begin{proof}
\uses{sheaves-definition-separated, sheaves-lemma-separated-presheaf-into-sheaf}

Assume all the transition maps are injective. In this case the presheaf
$\mathcal{F}' : V \mapsto \colim_i \mathcal{F}_i(V)$ is
separated (see Definition \ref{sheaves-definition-separated}).
By the discussion above we have
$(\mathcal{F}')^\# = \colim_i \mathcal{F}_i$.
By Lemma \ref{sheaves-lemma-separated-presheaf-into-sheaf} we see that
...
\begin{example}[Conditions needed colimit]
\label{sheaves-example-conditions-needed-colimit}
\source{stacks:009G}
\href{https://stacks.math.columbia.edu/tag/009G}{\texttt{Stacks tag 009G}}
\group{sheaves}

\uses{sheaves-lemma-directed-colimits-sections}
...
of Lemma \ref{sheaves-lemma-directed-colimits-sections} above.
\end{example}
...
\source{stacks:0A32}
\href{https://stacks.math.columbia.edu/tag/0A32}{\texttt{Stacks tag 0A32}}
\group{sheaves}
...
\source{stacks:0A33}
\href{https://stacks.math.columbia.edu/tag/0A33}{\texttt{Stacks tag 0A33}}
\group{sheaves}
...
\begin{proof}
\uses{sheaves-lemma-directed-colimits-sections, sheaves-lemma-compute-pullback-to-limit}

Recall that $p_i^{-1}(U_i)$ is a quasi-compact open of the spectral space
$X$, see
Topology, Lemma \ref{topology-lemma-directed-inverse-limit-spectral-spaces}.
Hence Lemma \ref{sheaves-lemma-directed-colimits-sections} applies and we have
$$
\mathcal{F}(p_i^{-1}(U_i)) =
...
$$
This is Lemma \ref{sheaves-lemma-compute-pullback-to-limit}
...
\begin{definition}[Presheaf basis]
\label{sheaves-definition-presheaf-basis}
\source{stacks:009I}
\href{https://stacks.math.columbia.edu/tag/009I}{\texttt{Stacks tag 009I}}
\group{sheaves}
...
\begin{definition}[Sheaf basis]
\label{sheaves-definition-sheaf-basis}
\source{stacks:009J}
\href{https://stacks.math.columbia.edu/tag/009J}{\texttt{Stacks tag 009J}}
\group{sheaves}
...
\begin{lemma}[Cofinal systems coverings]
\label{sheaves-lemma-cofinal-systems-coverings}
\source{stacks:009K}
\href{https://stacks.math.columbia.edu/tag/009K}{\texttt{Stacks tag 009K}}
\group{sheaves}
...
\begin{lemma}[Cofinal systems coverings standard case]
\label{sheaves-lemma-cofinal-systems-coverings-standard-case}
\source{stacks:009L}
\href{https://stacks.math.columbia.edu/tag/009L}{\texttt{Stacks tag 009L}}
\group{sheaves}
...
\begin{proof}
\uses{sheaves-lemma-cofinal-systems-coverings}

This is a reformulation of
Lemma \ref{sheaves-lemma-cofinal-systems-coverings} above
...
\begin{lemma}[Condition star sections]
\label{sheaves-lemma-condition-star-sections}
\source{stacks:009M}
\href{https://stacks.math.columbia.edu/tag/009M}{\texttt{Stacks tag 009M}}
\group{sheaves}
...
\begin{proof}
\uses{sheaves-definition-sheaf-basis}

First note that the map
$\mathcal{F}(U) \to \prod\nolimits_{x \in U} \mathcal{F}_x$
is injective by the uniqueness in the sheaf condition
of Definition \ref{sheaves-definition-sheaf-basis}. Let $(s_x)$ be
...
Thus the sheaf condition $(**)$ of Definition \ref{sheaves-definition-sheaf-basis}
...
\begin{lemma}[Extend off basis]
\label{sheaves-lemma-extend-off-basis}
\source{stacks:009N}
\href{https://stacks.math.columbia.edu/tag/009N}{\texttt{Stacks tag 009N}}
\group{sheaves}
...
\begin{proof}
\uses{sheaves-lemma-condition-star-sections, sheaves-lemma-sheafification-sheaf}
...
Lemma \ref{sheaves-lemma-condition-star-sections} holds.
It is clear that there are restriction mappings
that turn $\mathcal{F}^{ext}$ into a presheaf of sets.
Also, by Lemma \ref{sheaves-lemma-condition-star-sections} we
...
argue as in the proof of Lemma \ref{sheaves-lemma-sheafification-sheaf}.
\end{proof}
...
\begin{lemma}[Restrict basis equivalence]
\label{sheaves-lemma-restrict-basis-equivalence}
\source{stacks:009O}
\href{https://stacks.math.columbia.edu/tag/009O}{\texttt{Stacks tag 009O}}
\group{sheaves}
...
\begin{proof}
\uses{sheaves-lemma-extend-off-basis}

The inverse functor in given in Lemma \ref{sheaves-lemma-extend-off-basis} above.
...
\begin{definition}[Sheaf structures basis]
\label{sheaves-definition-sheaf-structures-basis}
\source{stacks:009P}
\href{https://stacks.math.columbia.edu/tag/009P}{\texttt{Stacks tag 009P}}
\group{sheaves}
...
\medskip\noindent
Note that Lemmas \ref{sheaves-lemma-cofinal-systems-coverings},
\ref{sheaves-lemma-cofinal-systems-coverings-standard-case} and
\ref{sheaves-lemma-condition-star-sections} refer to the sheaf
...
Lemma \ref{sheaves-lemma-extend-off-basis} need some care. Here it is.

\begin{lemma}[Extend off basis structures]
\label{sheaves-lemma-extend-off-basis-structures}
\source{stacks:009Q}
\href{https://stacks.math.columbia.edu/tag/009Q}{\texttt{Stacks tag 009Q}}
\group{sheaves}
...
\begin{proof}
\uses{sheaves-lemma-diagram-fibre-product, sheaves-lemma-image-contained-in, sheaves-example-application-lemma-image-contained-in}
...
Lemma \ref{sheaves-lemma-diagram-fibre-product} in the setting
...
$$
\begin{array}{cc}FIB(\mathcal{U}) \longrightarrow\downarrow & \prod\nolimits_{x\in U} \mathcal{F}_x \downarrow \\ \prod\nolimits_{i\in I} \mathcal{F}(U_i) \longrightarrow & \prod\nolimits_{i \in I} \prod\nolimits_{x\in U_i} \mathcal{F}_x\end{array}
$$
By the usual arguments, see Lemma \ref{sheaves-lemma-image-contained-in}
and Example \ref{sheaves-example-application-lemma-image-contained-in}
...
\begin{lemma}[Restrict basis equivalence structures]
\label{sheaves-lemma-restrict-basis-equivalence-structures}
\source{stacks:009R}
\href{https://stacks.math.columbia.edu/tag/009R}{\texttt{Stacks tag 009R}}
\group{sheaves}
...
\begin{proof}
\uses{sheaves-lemma-extend-off-basis-structures}

The inverse functor in given in
Lemma \ref{sheaves-lemma-extend-off-basis-structures} above.
Checking the obvious functorialities is left to the
reader.
\end{proof}
...
\begin{definition}[Sheaf modules basis]
\label{sheaves-definition-sheaf-modules-basis}
\source{stacks:009S}
\href{https://stacks.math.columbia.edu/tag/009S}{\texttt{Stacks tag 009S}}
\group{sheaves}
...
Lemma \ref{sheaves-lemma-extend-off-basis} is as follows.

\begin{lemma}[Extend off basis module]
\label{sheaves-lemma-extend-off-basis-module}
\source{stacks:009T}
\href{https://stacks.math.columbia.edu/tag/009T}{\texttt{Stacks tag 009T}}
\group{sheaves}
...
$\mathcal{F}$, see Lemma \ref{sheaves-lemma-extend-off-basis-structures}.
...
of Lemma \ref{sheaves-lemma-extend-off-basis} we construct the extension
...
\begin{lemma}[Restrict basis equivalence modules]
\label{sheaves-lemma-restrict-basis-equivalence-modules}
\source{stacks:009U}
\href{https://stacks.math.columbia.edu/tag/009U}{\texttt{Stacks tag 009U}}
\group{sheaves}
...
\begin{proof}
\uses{sheaves-lemma-extend-off-basis-module}

The inverse functor in given in
Lemma \ref{sheaves-lemma-extend-off-basis-module} above.
...
\begin{lemma}[F map basis below structures]
\label{sheaves-lemma-f-map-basis-below-structures}
\source{stacks:009V}
\href{https://stacks.math.columbia.edu/tag/009V}{\texttt{Stacks tag 009V}}
\group{sheaves}
...
Then there is a unique $f$-map (see Definition \ref{sheaves-definition-f-map}
...
\begin{proof}
\uses{sheaves-lemma-restrict-basis-equivalence-structures, sheaves-lemma-f-map, sheaves-lemma-f-map-sets-algebraic-structures}
...
By Lemma \ref{sheaves-lemma-restrict-basis-equivalence-structures}
this is the same as giving a morphism from $\mathcal{G}$
to $f_*\mathcal{F}$, which by Lemma \ref{sheaves-lemma-f-map}
...
\begin{lemma}[F map basis below modules]
\label{sheaves-lemma-f-map-basis-below-modules}
\source{stacks:009W}
\href{https://stacks.math.columbia.edu/tag/009W}{\texttt{Stacks tag 009W}}
\group{sheaves}
...
\begin{lemma}[F map basis above and below structures]
\label{sheaves-lemma-f-map-basis-above-and-below-structures}
\source{stacks:009X}
\href{https://stacks.math.columbia.edu/tag/009X}{\texttt{Stacks tag 009X}}
\group{sheaves}
...
Definition \ref{sheaves-definition-f-map} and the discussion
of $f$-maps in Section \ref{sheaves-section-presheaves-structures-functorial})
$\varphi : \mathcal{G} \to \mathcal{F}$
...
\begin{proof}
\uses{sheaves-lemma-extend-off-basis, sheaves-lemma-condition-star-sections, sheaves-lemma-f-map-basis-below-structures, sheaves-lemma-f-map-sets-algebraic-structures}
...
Thus, by the proof of Lemma \ref{sheaves-lemma-extend-off-basis}
...
follows from Lemma \ref{sheaves-lemma-condition-star-sections}.
...
\ref{sheaves-lemma-f-map-basis-below-structures} above to
...
\begin{lemma}[F map basis above and below modules]
\label{sheaves-lemma-f-map-basis-above-and-below-modules}
\source{stacks:009Y}
\href{https://stacks.math.columbia.edu/tag/009Y}{\texttt{Stacks tag 009Y}}
\group{sheaves}
...
Definition \ref{sheaves-definition-f-map} and the discussion
of $f$-maps in Section \ref{sheaves-section-ringed-spaces-functoriality-modules})
$\varphi : \mathcal{G} \to \mathcal{F}$
recovering $\varphi_V^U$ as the composition
$$
\mathcal{G}(V) \xrightarrow{\varphi_V}
...
In Section \ref{sheaves-section-presheaves-functorial} we have defined
...
\begin{lemma}[J pullback]
\label{sheaves-lemma-j-pullback}
\source{stacks:00A0}
\href{https://stacks.math.columbia.edu/tag/00A0}{\texttt{Stacks tag 00A0}}
\group{sheaves}
...
(see Section \ref{sheaves-section-presheaves-functorial}) is given by the rule
...
\source{stacks:00A1}
\href{https://stacks.math.columbia.edu/tag/00A1}{\texttt{Stacks tag 00A1}}
\group{sheaves}

\uses{sheaves-lemma-j-pullback, sheaves-lemma-pullback-module}
Let $X$ be a topological space.
...
in Lemma \ref{sheaves-lemma-j-pullback} is called
...
(see Lemma \ref{sheaves-lemma-pullback-module})
...
\begin{definition}[J shriek]
\label{sheaves-definition-j-shriek}
\source{stacks:00A2}
\href{https://stacks.math.columbia.edu/tag/00A2}{\texttt{Stacks tag 00A2}}
\group{sheaves}
...
\begin{lemma}[J shriek]
\label{sheaves-lemma-j-shriek}
\source{stacks:00A3}
\href{https://stacks.math.columbia.edu/tag/00A3}{\texttt{Stacks tag 00A3}}
\group{sheaves}

\uses{sheaves-lemma-j-pullback}
Let $X$ be a topological space.
Let $j : U \to X$ be the inclusion of an open subset.
\begin{enumerate}
\item The functor $j_{p!}$ is a left adjoint to the
restriction functor $j_p$ (see Lemma \ref{sheaves-lemma-j-pullback}).
...
mappings. And by Lemma \ref{sheaves-lemma-j-pullback}
...
\begin{definition}[J shriek structures]
\label{sheaves-definition-j-shriek-structures}
\source{stacks:00A4}
\href{https://stacks.math.columbia.edu/tag/00A4}{\texttt{Stacks tag 00A4}}
\group{sheaves}
...
\begin{lemma}[J shriek abelian]
\label{sheaves-lemma-j-shriek-abelian}
\source{stacks:00A5}
\href{https://stacks.math.columbia.edu/tag/00A5}{\texttt{Stacks tag 00A5}}
\group{sheaves}
...
\begin{lemma}[J shriek structures]
\label{sheaves-lemma-j-shriek-structures}
\source{stacks:00A6}
\href{https://stacks.math.columbia.edu/tag/00A6}{\texttt{Stacks tag 00A6}}
\group{sheaves}
...
\begin{lemma}[J shriek modules]
\label{sheaves-lemma-j-shriek-modules}
\source{stacks:00A7}
\href{https://stacks.math.columbia.edu/tag/00A7}{\texttt{Stacks tag 00A7}}
\group{sheaves}
...
\begin{lemma}[Equivalence categories open]
\label{sheaves-lemma-equivalence-categories-open}
\source{stacks:00A8}
\href{https://stacks.math.columbia.edu/tag/00A8}{\texttt{Stacks tag 00A8}}
\group{sheaves}
...
\begin{lemma}[Equivalence categories open abelian]
\label{sheaves-lemma-equivalence-categories-open-abelian}
\source{stacks:00A9}
\href{https://stacks.math.columbia.edu/tag/00A9}{\texttt{Stacks tag 00A9}}
\group{sheaves}
...
\begin{lemma}[Equivalence categories open structures]
\label{sheaves-lemma-equivalence-categories-open-structures}
\source{stacks:00AA}
\href{https://stacks.math.columbia.edu/tag/00AA}{\texttt{Stacks tag 00AA}}
\group{sheaves}
...
\begin{lemma}[Equivalence categories open modules]
\label{sheaves-lemma-equivalence-categories-open-modules}
\source{stacks:00AB}
\href{https://stacks.math.columbia.edu/tag/00AB}{\texttt{Stacks tag 00AB}}
\group{sheaves}
...
\begin{remark}[J shriek not exact]
\label{sheaves-remark-j-shriek-not-exact}
\source{stacks:00AC}
\href{https://stacks.math.columbia.edu/tag/00AC}{\texttt{Stacks tag 00AC}}
\group{sheaves}

\uses{sheaves-lemma-j-shriek}
Let $j : U \to X$ be an open immersion of topological spaces as above.
Let $x \in X$, $x \not \in U$. Let $\mathcal{F}$ be a sheaf of sets
on $U$. Then $j_!\mathcal{F}_x = \emptyset$ by Lemma \ref{sheaves-lemma-j-shriek}.
...
\begin{lemma}[Stalks closed pushforward]
\label{sheaves-lemma-stalks-closed-pushforward}
\source{stacks:00AE}
\href{https://stacks.math.columbia.edu/tag/00AE}{\texttt{Stacks tag 00AE}}
\group{sheaves}
...
see Remark \ref{sheaves-remark-confusion}. This proves the first case.
...
\begin{lemma}[Equivalence categories closed]
\label{sheaves-lemma-equivalence-categories-closed}
\source{stacks:00AF}
\href{https://stacks.math.columbia.edu/tag/00AF}{\texttt{Stacks tag 00AF}}
\group{sheaves}
...
\begin{lemma}[Equivalence categories closed abelian]
\label{sheaves-lemma-equivalence-categories-closed-abelian}
\source{stacks:00AG}
\href{https://stacks.math.columbia.edu/tag/00AG}{\texttt{Stacks tag 00AG}}
\group{sheaves}
...
\begin{lemma}[Equivalence categories closed structures]
\label{sheaves-lemma-equivalence-categories-closed-structures}
\source{stacks:00AH}
\href{https://stacks.math.columbia.edu/tag/00AH}{\texttt{Stacks tag 00AH}}
\group{sheaves}
...
\begin{remark}[I star not exact]
\label{sheaves-remark-i-star-not-exact}
\source{stacks:00AI}
\href{https://stacks.math.columbia.edu/tag/00AI}{\texttt{Stacks tag 00AI}}
\group{sheaves}

\uses{sheaves-lemma-stalks-closed-pushforward}
...
by Lemma \ref{sheaves-lemma-stalks-closed-pushforward}.
...
\begin{remark}[Closed immersion spaces]
\label{sheaves-remark-closed-immersion-spaces}
\source{stacks:00AJ}
\href{https://stacks.math.columbia.edu/tag/00AJ}{\texttt{Stacks tag 00AJ}}
\group{sheaves}
...
\begin{lemma}[Glue maps]
\label{sheaves-lemma-glue-maps}
\source{stacks:04TN}
\href{https://stacks.math.columbia.edu/tag/04TN}{\texttt{Stacks tag 04TN}}
\group{sheaves}
...
$$
\begin{array}{ccc}\mathcal{F}_i|_{U_i \cap U_j \cap U_k}
\underset{\varphi_{ik}}{\longrightarrow}\underset{\varphi_{ij}}{\searrow} &  & \mathcal{F}_k|_{U_i \cap U_j \cap U_k} \\  & \mathcal{F}_j|_{U_i \cap U_j \cap U_k}
\underset{\varphi_{jk}}{\nearrow} & \end{array}
$$
...
\source{stacks:00AL}
\href{https://stacks.math.columbia.edu/tag/00AL}{\texttt{Stacks tag 00AL}}
\group{sheaves}
...
$$
\begin{array}{cc}\mathcal{F}|_{U_i \cap U_j} \underset{\varphi_i}{\longrightarrow}\underset{\text{id}}{\downarrow} & \mathcal{F}_i|_{U_i \cap U_j} \overset{\varphi_{ij}}{\downarrow} \\ \mathcal{F}|_{U_i \cap U_j} \overset{\varphi_j}{\longrightarrow} & \mathcal{F}_j|_{U_i \cap U_j}\end{array}
$$
are commutative.
\end{lemma}
...
Finally, use Lemma \ref{sheaves-lemma-extend-off-basis} to extend $\mathcal{F}$
to a unique sheaf $\mathcal{F}$ on $X$.
\end{proof}

\begin{lemma}[Glue sheaves structures]
\label{sheaves-lemma-glue-sheaves-structures}
\source{stacks:00AM}
\href{https://stacks.math.columbia.edu/tag/00AM}{\texttt{Stacks tag 00AM}}
\group{sheaves}

\uses{sheaves-lemma-glue-sheaves}
Let $X$ be a topological space.
Let $X = \bigcup U_i$ be an open covering.
...
Lemma \ref{sheaves-lemma-glue-sheaves} above leads to a sheaf
...
$$
\begin{array}{cc}\prod_{i \in I} \mathcal{F}_i(W \cap U_i)
\longrightarrow\longrightarrow & \prod_{i, j\in I} \mathcal{F}_i(W \cap U_i \cap U_j)\end{array}
$$
...
\source{stacks:00AN}
\href{https://stacks.math.columbia.edu/tag/00AN}{\texttt{Stacks tag 00AN}}
\group{sheaves}
...
\begin{proof}
\uses{sheaves-lemma-glue-maps, sheaves-lemma-glue-sheaves}

The functor is fully faithful by
Lemma \ref{sheaves-lemma-glue-maps}
and essentially surjective (via an explicitly given quasi-inverse functor) by
Lemma \ref{sheaves-lemma-glue-sheaves}.
\end{proof}
