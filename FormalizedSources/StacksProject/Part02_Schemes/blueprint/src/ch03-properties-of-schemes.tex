...
\begin{lemma}[Locally constructible]
\label{properties-lemma-locally-constructible}
\source{stacks:054C}
\href{https://stacks.math.columbia.edu/tag/054C}{\texttt{Stacks tag 054C}}
\group{properties}
...
\source{stacks:0AAW}
\href{https://stacks.math.columbia.edu/tag/0AAW}{\texttt{Stacks tag 0AAW}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-locally-constructible}

As the complement of a locally constructible subset is locally
constructible it suffices to show (2). We may assume $X$ is
affine and hence $E$ constructible (Lemma \ref{properties-lemma-locally-constructible}).
...
\begin{lemma}[Quasi separated quasi compact open retrocompact]
\label{properties-lemma-quasi-separated-quasi-compact-open-retrocompact}
\source{stacks:054D}
\href{https://stacks.math.columbia.edu/tag/054D}{\texttt{Stacks tag 054D}}
\group{properties}
...
\begin{lemma}[Quasi compact quasi separated spectral]
\label{properties-lemma-quasi-compact-quasi-separated-spectral}
\source{stacks:094L}
\href{https://stacks.math.columbia.edu/tag/094L}{\texttt{Stacks tag 094L}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-quasi-separated-quasi-compact-open-retrocompact}
...
and
Lemma \ref{properties-lemma-quasi-separated-quasi-compact-open-retrocompact}
above.
\end{proof}
...
\source{stacks:054E}
\href{https://stacks.math.columbia.edu/tag/054E}{\texttt{Stacks tag 054E}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-quasi-separated-quasi-compact-open-retrocompact, properties-lemma-locally-constructible}
...
Lemma \ref{properties-lemma-locally-constructible}.
\end{proof}

\begin{lemma}[Retrocompact]
\label{properties-lemma-retrocompact}
\source{stacks:07ZL}
\href{https://stacks.math.columbia.edu/tag/07ZL}{\texttt{Stacks tag 07ZL}}
\group{properties}
...
\begin{lemma}[Stratification locally finite constructible]
\label{properties-lemma-stratification-locally-finite-constructible}
\source{stacks:0F2M}
\href{https://stacks.math.columbia.edu/tag/0F2M}{\texttt{Stacks tag 0F2M}}
\group{properties}
...
\source{stacks:01OK}
\href{https://stacks.math.columbia.edu/tag/01OK}{\texttt{Stacks tag 01OK}}
\group{properties}
...
\begin{lemma}[Characterize reduced]
\label{properties-lemma-characterize-reduced}
\source{stacks:01OL}
\href{https://stacks.math.columbia.edu/tag/01OL}{\texttt{Stacks tag 01OL}}
\group{properties}
...
\begin{lemma}[Characterize irreducible]
\label{properties-lemma-characterize-irreducible}
\source{stacks:01OM}
\href{https://stacks.math.columbia.edu/tag/01OM}{\texttt{Stacks tag 01OM}}
\group{properties}
...
\begin{lemma}[Characterize integral]
\label{properties-lemma-characterize-integral}
\source{stacks:01ON}
\href{https://stacks.math.columbia.edu/tag/01ON}{\texttt{Stacks tag 01ON}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-characterize-reduced, properties-lemma-characterize-irreducible}

If $X$ is irreducible, then every affine open $\Spec(R) = U \subset X$
is irreducible. If $X$ is reduced, then $R$ is reduced, by
Lemma \ref{properties-lemma-characterize-reduced} above. Hence $R$ is reduced
...
and hence $X$ is reduced by Lemma \ref{properties-lemma-characterize-reduced}.
Moreover, every nonempty affine open is irreducible.
Hence $X$ is irreducible, see Lemma \ref{properties-lemma-characterize-irreducible}.
\end{proof}
...
\source{stacks:01OP}
\href{https://stacks.math.columbia.edu/tag/01OP}{\texttt{Stacks tag 01OP}}
\group{properties}
...
\begin{definition}[Locally P]
\label{properties-definition-locally-P}
\source{stacks:01OQ}
\href{https://stacks.math.columbia.edu/tag/01OQ}{\texttt{Stacks tag 01OQ}}
\group{properties}
...
\begin{lemma}[Locally P]
\label{properties-lemma-locally-P}
\source{stacks:01OR}
\href{https://stacks.math.columbia.edu/tag/01OR}{\texttt{Stacks tag 01OR}}
\group{properties}
...
\begin{proof}
\uses{properties-definition-property-local}
...
Definition \ref{properties-definition-property-local} (1) we get $P(R_{f_j})$.
Whereupon $P(R)$ by Definition \ref{properties-definition-property-local} (2).
\end{proof}

Here is a sample application.

\begin{lemma}[Reduced is locally reduced]
\label{properties-lemma-reduced-is-locally-reduced}
\source{stacks:01OS}
\href{https://stacks.math.columbia.edu/tag/01OS}{\texttt{Stacks tag 01OS}}
\group{properties}

\uses{properties-definition-locally-P}
Let $X$ be a scheme. Then $X$ is reduced if and only if $X$ is
``locally reduced'' in the sense of Definition \ref{properties-definition-locally-P}.
\end{lemma}

\begin{proof}
\uses{properties-lemma-characterize-reduced}

This is clear from Lemma \ref{properties-lemma-characterize-reduced}.
\end{proof}

\begin{lemma}[Properties local]
\label{properties-lemma-properties-local}
\source{stacks:01OT}
\href{https://stacks.math.columbia.edu/tag/01OT}{\texttt{Stacks tag 01OT}}
\group{properties}
...
\source{stacks:01OV}
\href{https://stacks.math.columbia.edu/tag/01OV}{\texttt{Stacks tag 01OV}}
\group{properties}
...
\begin{lemma}[Locally Noetherian]
\label{properties-lemma-locally-Noetherian}
\source{stacks:01OW}
\href{https://stacks.math.columbia.edu/tag/01OW}{\texttt{Stacks tag 01OW}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-locally-P, properties-definition-property-local}

To show this it suffices to show that being Noetherian is a local
property of rings, see Lemma \ref{properties-lemma-locally-P}.
...
property to Definition \ref{properties-definition-property-local}.
\end{proof}

\begin{lemma}[Immersion into noetherian]
\label{properties-lemma-immersion-into-noetherian}
\source{stacks:01OX}
\href{https://stacks.math.columbia.edu/tag/01OX}{\texttt{Stacks tag 01OX}}
\group{properties}
...
\begin{lemma}[Locally Noetherian quasi separated]
\label{properties-lemma-locally-Noetherian-quasi-separated}
\source{stacks:01OY}
\href{https://stacks.math.columbia.edu/tag/01OY}{\texttt{Stacks tag 01OY}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-immersion-into-noetherian}
...
Lemma \ref{properties-lemma-immersion-into-noetherian} above on
...
\source{stacks:01OZ}
\href{https://stacks.math.columbia.edu/tag/01OZ}{\texttt{Stacks tag 01OZ}}
\group{properties}
...
\source{stacks:02IK}
\href{https://stacks.math.columbia.edu/tag/02IK}{\texttt{Stacks tag 02IK}}
\group{properties}
...
\begin{lemma}[Noetherian irreducible components]
\label{properties-lemma-Noetherian-irreducible-components}
\source{stacks:0BA8}
\href{https://stacks.math.columbia.edu/tag/0BA8}{\texttt{Stacks tag 0BA8}}
\group{properties}
...
Use Lemma \ref{properties-lemma-Noetherian-topology}
...
\begin{lemma}[Locally Noetherian closed point]
\label{properties-lemma-locally-Noetherian-closed-point}
\source{stacks:02IL}
\href{https://stacks.math.columbia.edu/tag/02IL}{\texttt{Stacks tag 02IL}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-locally-closed-in-Noetherian}

The second assertion follows from the first (using
Schemes, Lemma \ref{schemes-lemma-reduced-closed-subscheme}
and Lemma \ref{properties-lemma-locally-closed-in-Noetherian}).
...
by Lemma \ref{properties-lemma-locally-closed-in-Noetherian}. Denote $V \subset \Spec(R)$
...
\begin{lemma}[Locally Noetherian specialization dvr]
\label{properties-lemma-locally-Noetherian-specialization-dvr}
\source{stacks:054F}
\href{https://stacks.math.columbia.edu/tag/054F}{\texttt{Stacks tag 054F}}
\group{properties}
...
\begin{proof}
First assume $x' \leadsto x$ is a specialization in $X$
with $x \not = x'$ and let $K/\kappa(x')$ be a finitely
generated extension of fields. By
Schemes, Lemma \ref{schemes-lemma-specialize-points}
...
Since $x \not = x'$ the image of $\mathcal{O}_{X, x}$ in $K$
is not a field (details omitted).
...
If $x = x'$ then we can set $R = \kappa(x)[t]_{(t)}$.
\end{proof}

\begin{lemma}[Thin infinite sequence]
\label{properties-lemma-thin-infinite-sequence}
\source{stacks:0CXG}
\href{https://stacks.math.columbia.edu/tag/0CXG}{\texttt{Stacks tag 0CXG}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-locally-Noetherian-quasi-separated}
...
is Noetherian by Lemma \ref{properties-lemma-locally-Noetherian-quasi-separated}.
\end{proof}

\begin{lemma}[Maximal points]
\label{properties-lemma-maximal-points}
\source{stacks:0G2R}
\href{https://stacks.math.columbia.edu/tag/0G2R}{\texttt{Stacks tag 0G2R}}
\group{properties}
...
\begin{lemma}[Countable dense subset]
\label{properties-lemma-countable-dense-subset}
\source{stacks:0G2F}
\href{https://stacks.math.columbia.edu/tag/0G2F}{\texttt{Stacks tag 0G2F}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-maximal-points}
...
as in Lemma \ref{properties-lemma-maximal-points} whose results we will use
...
\source{stacks:01P2}
\href{https://stacks.math.columbia.edu/tag/01P2}{\texttt{Stacks tag 01P2}}
\group{properties}
...
\begin{lemma}[Affine jacobson]
\label{properties-lemma-affine-jacobson}
\source{stacks:01P3}
\href{https://stacks.math.columbia.edu/tag/01P3}{\texttt{Stacks tag 01P3}}
\group{properties}
...
\begin{lemma}[Locally jacobson]
\label{properties-lemma-locally-jacobson}
\source{stacks:01P4}
\href{https://stacks.math.columbia.edu/tag/01P4}{\texttt{Stacks tag 01P4}}
\group{properties}
...
Definition \ref{properties-definition-locally-P}.
\item For every affine open $U \subset X$ the ring $\mathcal{O}_X(U)$
is Jacobson.
\item There exists an affine open covering $X = \bigcup U_i$ such that
...
\begin{proof}
\uses{properties-lemma-affine-jacobson, properties-lemma-locally-P, properties-definition-property-local}
...
Hence, using Lemma \ref{properties-lemma-affine-jacobson},
we see that (1) $\Leftrightarrow$ (2).
To finish proving the lemma it suffices to show that ``Jacobson''
is a local property of rings, see Lemma \ref{properties-lemma-locally-P}.
...
This proves the second property of Definition \ref{properties-definition-property-local}.
\end{proof}
...
\begin{lemma}[Complement closed point Jacobson]
\label{properties-lemma-complement-closed-point-Jacobson}
\source{stacks:02IM}
\href{https://stacks.math.columbia.edu/tag/02IM}{\texttt{Stacks tag 02IM}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-locally-jacobson, properties-lemma-locally-closed-in-Noetherian}
...
$S$ is a Noetherian scheme (Lemma \ref{properties-lemma-locally-closed-in-Noetherian}).
...
\source{stacks:033I}
\href{https://stacks.math.columbia.edu/tag/033I}{\texttt{Stacks tag 033I}}
\group{properties}
...
\begin{lemma}[Locally normal]
\label{properties-lemma-locally-normal}
\source{stacks:033J}
\href{https://stacks.math.columbia.edu/tag/033J}{\texttt{Stacks tag 033J}}
\group{properties}
...
\begin{lemma}[Normal reduced]
\label{properties-lemma-normal-reduced}
\source{stacks:033K}
\href{https://stacks.math.columbia.edu/tag/033K}{\texttt{Stacks tag 033K}}
\group{properties}
...
\begin{lemma}[Integral normal]
\label{properties-lemma-integral-normal}
\source{stacks:033L}
\href{https://stacks.math.columbia.edu/tag/033L}{\texttt{Stacks tag 033L}}
\group{properties}
...
\begin{lemma}[Normal locally finite nr irreducibles]
\label{properties-lemma-normal-locally-finite-nr-irreducibles}
\source{stacks:0357}
\href{https://stacks.math.columbia.edu/tag/0357}{\texttt{Stacks tag 0357}}
\group{properties}
...
\begin{lemma}[Normal Noetherian]
\label{properties-lemma-normal-Noetherian}
\source{stacks:033M}
\href{https://stacks.math.columbia.edu/tag/033M}{\texttt{Stacks tag 033M}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-normal-locally-finite-nr-irreducibles, properties-lemma-Noetherian-topology}

This is a special case of
Lemma \ref{properties-lemma-normal-locally-finite-nr-irreducibles} because a Noetherian
...
\begin{lemma}[Normal locally Noetherian]
\label{properties-lemma-normal-locally-Noetherian}
\source{stacks:033N}
\href{https://stacks.math.columbia.edu/tag/033N}{\texttt{Stacks tag 033N}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-normal-Noetherian}

Omitted. Hint: This is purely topological from
Lemma \ref{properties-lemma-normal-Noetherian}.
\end{proof}

\begin{remark}[Normal connected irreducible]
\label{properties-remark-normal-connected-irreducible}
\source{stacks:033O}
\href{https://stacks.math.columbia.edu/tag/033O}{\texttt{Stacks tag 033O}}
\group{properties}

\uses{properties-lemma-normal-locally-Noetherian}
Let $X$ be a normal scheme. If $X$ is locally Noetherian then we see that
$X$ is integral if and only if $X$ is connected, see
Lemma \ref{properties-lemma-normal-locally-Noetherian}.
...
\begin{lemma}[The ring of functions on a normal scheme is normal.]
\label{properties-lemma-normal-integral-sections}
\source{stacks:0358}
\href{https://stacks.math.columbia.edu/tag/0358}{\texttt{Stacks tag 0358}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-integral-normal}
...
(Lemma \ref{properties-lemma-integral-normal}), we see that
...
\source{stacks:02IO}
\href{https://stacks.math.columbia.edu/tag/02IO}{\texttt{Stacks tag 02IO}}
\group{properties}
...
\begin{lemma}[Characterize Cohen Macaulay]
\label{properties-lemma-characterize-Cohen-Macaulay}
\source{stacks:02IP}
\href{https://stacks.math.columbia.edu/tag/02IP}{\texttt{Stacks tag 02IP}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-locally-Noetherian, properties-lemma-locally-Noetherian-closed-point}
...
by combining this with Lemma \ref{properties-lemma-locally-Noetherian},
with the existence of closed
points on locally Noetherian schemes
(Lemma \ref{properties-lemma-locally-Noetherian-closed-point}), and
the definitions.
\end{proof}

\begin{lemma}[Locally Cohen Macaulay]
\label{properties-lemma-locally-Cohen-Macaulay}
\source{stacks:02IQ}
\href{https://stacks.math.columbia.edu/tag/02IQ}{\texttt{Stacks tag 02IQ}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-locally-Noetherian, properties-lemma-characterize-Cohen-Macaulay}

Combine Lemmas \ref{properties-lemma-locally-Noetherian}
and \ref{properties-lemma-characterize-Cohen-Macaulay}.
\end{proof}
...
\source{stacks:02IS}
\href{https://stacks.math.columbia.edu/tag/02IS}{\texttt{Stacks tag 02IS}}
\group{properties}
...
\begin{lemma}[Characterize regular]
\label{properties-lemma-characterize-regular}
\source{stacks:02IT}
\href{https://stacks.math.columbia.edu/tag/02IT}{\texttt{Stacks tag 02IT}}
\group{properties}
...
\begin{lemma}[Locally regular]
\label{properties-lemma-locally-regular}
\source{stacks:02IU}
\href{https://stacks.math.columbia.edu/tag/02IU}{\texttt{Stacks tag 02IU}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-locally-Noetherian, properties-lemma-characterize-regular}

Combine Lemmas \ref{properties-lemma-locally-Noetherian}
and \ref{properties-lemma-characterize-regular}.
\end{proof}

\begin{lemma}[Regular normal]
\label{properties-lemma-regular-normal}
\source{stacks:0569}
\href{https://stacks.math.columbia.edu/tag/0569}{\texttt{Stacks tag 0569}}
\group{properties}
...
\source{stacks:04MT}
\href{https://stacks.math.columbia.edu/tag/04MT}{\texttt{Stacks tag 04MT}}
\group{properties}
...
\begin{lemma}[Dimension]
\label{properties-lemma-dimension}
\source{stacks:04MU}
\href{https://stacks.math.columbia.edu/tag/04MU}{\texttt{Stacks tag 04MU}}
\group{properties}
...
\begin{lemma}[Codimension local ring]
\label{properties-lemma-codimension-local-ring}
\source{stacks:02IZ}
\href{https://stacks.math.columbia.edu/tag/02IZ}{\texttt{Stacks tag 02IZ}}
\group{properties}
...
\begin{lemma}[Generic point]
\label{properties-lemma-generic-point}
\source{stacks:0BA9}
\href{https://stacks.math.columbia.edu/tag/0BA9}{\texttt{Stacks tag 0BA9}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-codimension-local-ring}

This follows from Lemma \ref{properties-lemma-codimension-local-ring} for example.
\end{proof}

\begin{lemma}[Locally Noetherian dimension 0]
\label{properties-lemma-locally-Noetherian-dimension-0}
\source{stacks:0AAX}
\href{https://stacks.math.columbia.edu/tag/0AAX}{\texttt{Stacks tag 0AAX}}
\group{properties}
...
\begin{lemma}[Dimension zero]
\label{properties-lemma-dimension-zero}
\source{stacks:0CKV}
\href{https://stacks.math.columbia.edu/tag/0CKV}{\texttt{Stacks tag 0CKV}}
\group{properties}
...
\begin{lemma}[Isolated dim 0 locally noetherian]
\label{properties-lemma-isolated-dim-0-locally-noetherian}
\source{stacks:0H7C}
\href{https://stacks.math.columbia.edu/tag/0H7C}{\texttt{Stacks tag 0H7C}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-locally-Noetherian-dimension-0}
...
(Topology, Definition \ref{topology-definition-Krull}).
By Lemma \ref{properties-lemma-locally-Noetherian-dimension-0}
...
\source{stacks:02IW}
\href{https://stacks.math.columbia.edu/tag/02IW}{\texttt{Stacks tag 02IW}}
\group{properties}
...
\begin{lemma}[Catenary local]
\label{properties-lemma-catenary-local}
\source{stacks:02IX}
\href{https://stacks.math.columbia.edu/tag/02IX}{\texttt{Stacks tag 02IX}}
\group{properties}
...
\begin{lemma}[Catenary dimension function]
\label{properties-lemma-catenary-dimension-function}
\source{stacks:02IY}
\href{https://stacks.math.columbia.edu/tag/02IY}{\texttt{Stacks tag 02IY}}
\group{properties}
...
Schemes, Lemma \ref{schemes-lemma-scheme-sober}
and finally Lemma \ref{properties-lemma-Noetherian-topology}.
\end{proof}

It turns out that a scheme is catenary if and only if its local
rings are catenary.

\begin{lemma}[Catenary local rings catenary]
\label{properties-lemma-catenary-local-rings-catenary}
\source{stacks:02J0}
\href{https://stacks.math.columbia.edu/tag/02J0}{\texttt{Stacks tag 02J0}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-catenary-local}

Assume $X$ is catenary. Let $x \in X$. By Lemma \ref{properties-lemma-catenary-local}
...
\source{stacks:033Q}
\href{https://stacks.math.columbia.edu/tag/033Q}{\texttt{Stacks tag 033Q}}
\group{properties}
...
in Section \ref{properties-section-catenary} that if $Y \subset X$ is irreducible
...
\begin{lemma}[Scheme regular iff all Rk]
\label{properties-lemma-scheme-regular-iff-all-Rk}
\source{stacks:0B3C}
\href{https://stacks.math.columbia.edu/tag/0B3C}{\texttt{Stacks tag 0B3C}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-characterize-regular}

Follows from Lemma \ref{properties-lemma-characterize-regular} and the definitions.
\end{proof}

\begin{lemma}[Scheme CM iff all Sk]
\label{properties-lemma-scheme-CM-iff-all-Sk}
\source{stacks:0342}
\href{https://stacks.math.columbia.edu/tag/0342}{\texttt{Stacks tag 0342}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-characterize-Cohen-Macaulay}

By Lemma \ref{properties-lemma-characterize-Cohen-Macaulay}
...
\begin{lemma}[Criterion reduced]
\label{properties-lemma-criterion-reduced}
\source{stacks:0344}
\href{https://stacks.math.columbia.edu/tag/0344}{\texttt{Stacks tag 0344}}
\group{properties}
...
\begin{lemma}[Criterion normal]
\label{properties-lemma-criterion-normal}
\source{stacks:0345}
\href{https://stacks.math.columbia.edu/tag/0345}{\texttt{Stacks tag 0345}}
\group{properties}
...
\begin{lemma}[Normal dimension 1 regular]
\label{properties-lemma-normal-dimension-1-regular}
\source{stacks:0BX2}
\href{https://stacks.math.columbia.edu/tag/0BX2}{\texttt{Stacks tag 0BX2}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-criterion-normal}

This follows from Lemma \ref{properties-lemma-criterion-normal} and the definitions.
\end{proof}

\begin{lemma}[Normal dimension 2 Cohen Macaulay]
\label{properties-lemma-normal-dimension-2-Cohen-Macaulay}
\source{stacks:0B3D}
\href{https://stacks.math.columbia.edu/tag/0B3D}{\texttt{Stacks tag 0B3D}}
\group{properties}
...
\begin{definition}[Nagata]
\label{properties-definition-nagata}
\source{stacks:033S}
\href{https://stacks.math.columbia.edu/tag/033S}{\texttt{Stacks tag 033S}}
\group{properties}
...
Lemma \ref{properties-lemma-nagata-universally-Japanese}.

\begin{remark}[Non integral Japanese]
\label{properties-remark-non-integral-Japanese}
\source{stacks:033T}
\href{https://stacks.math.columbia.edu/tag/033T}{\texttt{Stacks tag 033T}}
\group{properties}
...
\begin{lemma}[Nagata locally Noetherian]
\label{properties-lemma-nagata-locally-Noetherian}
\source{stacks:033U}
\href{https://stacks.math.columbia.edu/tag/033U}{\texttt{Stacks tag 033U}}
\group{properties}
...
\begin{lemma}[Locally Japanese]
\label{properties-lemma-locally-Japanese}
\source{stacks:033V}
\href{https://stacks.math.columbia.edu/tag/033V}{\texttt{Stacks tag 033V}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-locally-P}

This follows from Lemma \ref{properties-lemma-locally-P} and
Algebra, Lemmas \ref{algebra-lemma-localize-N} and
\ref{algebra-lemma-Japanese-local}.
\end{proof}

\begin{lemma}[Locally universally Japanese]
\label{properties-lemma-locally-universally-Japanese}
\source{stacks:033W}
\href{https://stacks.math.columbia.edu/tag/033W}{\texttt{Stacks tag 033W}}
\group{properties}
...
\begin{lemma}[Locally nagata]
\label{properties-lemma-locally-nagata}
\source{stacks:033X}
\href{https://stacks.math.columbia.edu/tag/033X}{\texttt{Stacks tag 033X}}
\group{properties}
...
\begin{lemma}[Characterize nagata]
\label{properties-lemma-characterize-nagata}
\source{stacks:033Y}
\href{https://stacks.math.columbia.edu/tag/033Y}{\texttt{Stacks tag 033Y}}
\group{properties}
...
\begin{proof}
\uses{properties-definition-integral, properties-lemma-locally-Noetherian, properties-lemma-locally-Japanese}
...
Definition \ref{properties-definition-integral}). By
...
(Lemma \ref{properties-lemma-locally-Noetherian}). Let $\mathfrak p \subset A$
...
by assumption and by Lemma \ref{properties-lemma-locally-Japanese} we see that
$A/\mathfrak p$ is Japanese.
\end{proof}

\begin{lemma}[Nagata universally Japanese]
\label{properties-lemma-nagata-universally-Japanese}
\source{stacks:033Z}
\href{https://stacks.math.columbia.edu/tag/033Z}{\texttt{Stacks tag 033Z}}
\group{properties}
...
We remark that a ring $R$ is a G-ring if $R$ is Noetherian and
for every prime ideal $\mathfrak p$ of $R$ the ring map
$R_\mathfrak p \to (R_\mathfrak p)^\wedge$ is regular.

\begin{definition}[G scheme]
\label{properties-definition-G-scheme}
\source{stacks:0HA3}
\href{https://stacks.math.columbia.edu/tag/0HA3}{\texttt{Stacks tag 0HA3}}
\group{properties}

Let $X$ be a scheme. We say $X$ is a {\it G-scheme}\footnote{This may be
...
More on Algebra, Definition \ref{more-algebra-definition-G-ring}).
\end{definition}

\begin{lemma}[Characterize G scheme]
\label{properties-lemma-characterize-G-scheme}
\source{stacks:0HA4}
\href{https://stacks.math.columbia.edu/tag/0HA4}{\texttt{Stacks tag 0HA4}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-locally-Noetherian-closed-point, properties-lemma-locally-Noetherian}

It is clear that (1) implies (2) and (2) implies (3).
Assume (3). Let $x \in X$ be any point. By
Lemma \ref{properties-lemma-locally-Noetherian-closed-point}
there exists a specialization $x \leadsto x'$ with $x'$ closed
in $X$. Then $\mathcal{O}_{X, x'}$ is a G-ring by
More on Algebra, Lemma \ref{more-algebra-lemma-check-G-ring-maximal-ideals}.
Since $\mathcal{O}_{X, x}$ is the localization of $\mathcal{O}_{X, x'}$
at a prime ideal (Schemes, Lemma \ref{schemes-lemma-specialize-points}),
we see that $\mathcal{O}_{X, x} \to \mathcal{O}_{X, x}^\wedge$
is a regular ring map. Since $x \in X$ was arbitrary we conclude
that for any affine open $U \subset X$ the Noetherian
(Lemma \ref{properties-lemma-locally-Noetherian}) ring $\mathcal{O}_X(U)$ is a G-ring.
This proves that (1) holds.
\end{proof}

\begin{lemma}[Locally G scheme]
\label{properties-lemma-locally-G-scheme}
\source{stacks:0HA5}
\href{https://stacks.math.columbia.edu/tag/0HA5}{\texttt{Stacks tag 0HA5}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-locally-Noetherian, properties-lemma-characterize-G-scheme}

Combine Lemmas \ref{properties-lemma-locally-Noetherian}
and \ref{properties-lemma-characterize-G-scheme}.
\end{proof}
...
\source{stacks:07R1}
\href{https://stacks.math.columbia.edu/tag/07R1}{\texttt{Stacks tag 07R1}}
\group{properties}
...
\begin{definition}[Unibranch]
\label{properties-definition-unibranch}
\source{stacks:0BQ2}
\href{https://stacks.math.columbia.edu/tag/0BQ2}{\texttt{Stacks tag 0BQ2}}
\group{properties}
...
of Definition \ref{properties-definition-unibranch}. For example this happens
...
\begin{lemma}[Normal geometrically unibranch]
\label{properties-lemma-normal-geometrically-unibranch}
\source{stacks:0BQ3}
\href{https://stacks.math.columbia.edu/tag/0BQ3}{\texttt{Stacks tag 0BQ3}}
\group{properties}
...
\begin{lemma}[Geometrically unibranch]
\label{properties-lemma-geometrically-unibranch}
\source{stacks:0BQ4}
\href{https://stacks.math.columbia.edu/tag/0BQ4}{\texttt{Stacks tag 0BQ4}}
\group{properties}

\uses{properties-definition-unibranch}
\begin{reference}
Compare with \cite[Proposition 2.3]{Etale-coverings}
\end{reference}
Let $X$ be a Noetherian scheme. The following are equivalent
\begin{enumerate}
\item $X$ is geometrically unibranch (Definition \ref{properties-definition-unibranch}),
...
\begin{definition}[Number of branches]
\label{properties-definition-number-of-branches}
\source{stacks:0C38}
\href{https://stacks.math.columbia.edu/tag/0C38}{\texttt{Stacks tag 0C38}}
\group{properties}
...
\begin{lemma}[Number of branches irreducible components]
\label{properties-lemma-number-of-branches-irreducible-components}
\source{stacks:0E20}
\href{https://stacks.math.columbia.edu/tag/0E20}{\texttt{Stacks tag 0E20}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-characterize-integral}
...
Lemma \ref{properties-lemma-characterize-integral}.
...
\begin{lemma}[Number of branches 1]
\label{properties-lemma-number-of-branches-1}
\source{stacks:0C39}
\href{https://stacks.math.columbia.edu/tag/0C39}{\texttt{Stacks tag 0C39}}
\group{properties}
...
\begin{lemma}[Finite type module]
\label{properties-lemma-finite-type-module}
\source{stacks:01PB}
\href{https://stacks.math.columbia.edu/tag/01PB}{\texttt{Stacks tag 01PB}}
\group{properties}
...
\source{stacks:01PC}
\href{https://stacks.math.columbia.edu/tag/01PC}{\texttt{Stacks tag 01PC}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-finite-type-module}

Assume $\widetilde M$ is an $\mathcal{O}_X$-module of finite presentation.
By Lemma \ref{properties-lemma-finite-type-module} we see that $M$ is a finite $R$-module.
...
Hence by Lemma \ref{properties-lemma-finite-type-module}
...
\begin{lemma}[Sections of quasi-coherent sheaves have only meromorphic singularities at infinity.]
\label{properties-lemma-invert-f-sections}
\source{stacks:01P7}
\href{https://stacks.math.columbia.edu/tag/01P7}{\texttt{Stacks tag 01P7}}
\group{properties}
...
\begin{lemma}[Invert s sections]
\label{properties-lemma-invert-s-sections}
\source{stacks:01PW}
\href{https://stacks.math.columbia.edu/tag/01PW}{\texttt{Stacks tag 01PW}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-invert-f-sections}
...
Lemma \ref{properties-lemma-extend-finite-presentation},
...
\begin{lemma}[Section maps backwards]
\label{properties-lemma-section-maps-backwards}
\source{stacks:01XQ}
\href{https://stacks.math.columbia.edu/tag/01XQ}{\texttt{Stacks tag 01XQ}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-finite-type-module, properties-lemma-finite-presentation-module, properties-lemma-invert-s-sections}
...
(via Lemmas \ref{properties-lemma-finite-type-module} and
\ref{properties-lemma-finite-presentation-module}) into
...
Lemma \ref{properties-lemma-invert-s-sections} applied to
$\SheafHom_{\mathcal{O}_X}(\mathcal{F}, \mathcal{G})$.
\end{proof}
...
\source{stacks:01P6}
\href{https://stacks.math.columbia.edu/tag/01P6}{\texttt{Stacks tag 01P6}}
\group{properties}
...
\begin{lemma}[Quasi coherent quasi affine]
\label{properties-lemma-quasi-coherent-quasi-affine}
\source{stacks:0EHM}
\href{https://stacks.math.columbia.edu/tag/0EHM}{\texttt{Stacks tag 0EHM}}
\group{properties}
...
\begin{lemma}[Invert f affine]
\label{properties-lemma-invert-f-affine}
\source{stacks:01P8}
\href{https://stacks.math.columbia.edu/tag/01P8}{\texttt{Stacks tag 01P8}}
\group{properties}
...
Lemma \ref{properties-lemma-invert-f-sections} above.
\end{proof}

\begin{lemma}[Quasi affine]
\label{properties-lemma-quasi-affine}
\source{stacks:01P9}
\href{https://stacks.math.columbia.edu/tag/01P9}{\texttt{Stacks tag 01P9}}
\group{properties}
...
in $A$. The open $X_f$ of Lemma \ref{properties-lemma-invert-f-sections}
...
\begin{lemma}[Cartesian diagram quasi affine]
\label{properties-lemma-cartesian-diagram-quasi-affine}
\source{stacks:0ARY}
\href{https://stacks.math.columbia.edu/tag/0ARY}{\texttt{Stacks tag 0ARY}}
\group{properties}

Let $U \to V$ be an open immersion of quasi-affine schemes. Then
$$
\begin{array}{ccc}U \downarrow\underset{j}{\longrightarrow} &  & \Spec(\Gamma(U, \mathcal{O}_U)) \downarrow \\ U \longrightarrow & V \overset{j'}{\longrightarrow} & \Spec(\Gamma(V, \mathcal{O}_V))\end{array}
$$
is cartesian.
\end{lemma}

\begin{proof}
\uses{properties-lemma-invert-f-affine, properties-lemma-quasi-affine}
...
\ref{properties-lemma-invert-f-affine} we see that $j'$ induces an isomorphism of
$V_g$ with the standard open $D(g)$ of $\Spec(B)$. Thus
$V_g \times_{\Spec(B)} \Spec(A) \to \Spec(A)$ is an
isomorphism onto $D(f) \subset \Spec(A)$. By Lemma \ref{properties-lemma-invert-f-affine}
again $j$ maps $U_f$ isomorphically to $D(f)$. Thus we see that
$U_f = U_f \times_{\Spec(B)} \Spec(A)$. Since by
Lemma \ref{properties-lemma-quasi-affine} we can cover $U$ by $V_g = U_f$ as above,
we see that $U \to U \times_{\Spec(B)} \Spec(A)$ is an isomorphism.
\end{proof}

\begin{lemma}[Quasi affine presentation]
\label{properties-lemma-quasi-affine-presentation}
\source{stacks:0F82}
\href{https://stacks.math.columbia.edu/tag/0F82}{\texttt{Stacks tag 0F82}}
\group{properties}
...
\begin{lemma}[Flatness is the same for modules and sheaves.]
\label{properties-lemma-flat-module}
\source{stacks:05P0}
\href{https://stacks.math.columbia.edu/tag/05P0}{\texttt{Stacks tag 05P0}}
\group{properties}
...
\begin{lemma}[Locally free module]
\label{properties-lemma-locally-free-module}
\source{stacks:05JM}
\href{https://stacks.math.columbia.edu/tag/05JM}{\texttt{Stacks tag 05JM}}
\group{properties}
...
\begin{lemma}[Finite locally free]
\label{properties-lemma-finite-locally-free}
\source{stacks:05P2}
\href{https://stacks.math.columbia.edu/tag/05P2}{\texttt{Stacks tag 05P2}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-finite-type-module, properties-lemma-finite-presentation-module, properties-lemma-flat-module, properties-lemma-locally-free-module}
...
Lemmas \ref{properties-lemma-finite-type-module},
\ref{properties-lemma-finite-presentation-module},
\ref{properties-lemma-flat-module}, and
\ref{properties-lemma-locally-free-module}.
\end{proof}

\begin{lemma}[Finite locally free reduced]
\label{properties-lemma-finite-locally-free-reduced}
\source{stacks:0FWH}
\href{https://stacks.math.columbia.edu/tag/0FWH}{\texttt{Stacks tag 0FWH}}
\group{properties}

\uses{properties-lemma-finite-locally-free}
Let $X$ be a reduced scheme. Let $\mathcal{F}$ be a quasi-coherent
$\mathcal{O}_X$-module. Then the equivalent conditions of
Lemma \ref{properties-lemma-finite-locally-free} are also equivalent to
\begin{enumerate}
...
\begin{definition}[Locally projective]
\label{properties-definition-locally-projective}
\source{stacks:05JP}
\href{https://stacks.math.columbia.edu/tag/05JP}{\texttt{Stacks tag 05JP}}
\group{properties}
...
\begin{lemma}[Locally projective]
\label{properties-lemma-locally-projective}
\source{stacks:05JQ}
\href{https://stacks.math.columbia.edu/tag/05JQ}{\texttt{Stacks tag 05JQ}}
\group{properties}
...
\begin{lemma}[Locally projective pullback]
\label{properties-lemma-locally-projective-pullback}
\source{stacks:060M}
\href{https://stacks.math.columbia.edu/tag/060M}{\texttt{Stacks tag 060M}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-locally-projective}

Follows from
Algebra, Lemma \ref{algebra-lemma-ascend-properties-modules}
and Lemma \ref{properties-lemma-locally-projective}.
\end{proof}
...
\begin{lemma}[Extend trivial]
\label{properties-lemma-extend-trivial}
\source{stacks:01PE}
\href{https://stacks.math.columbia.edu/tag/01PE}{\texttt{Stacks tag 01PE}}
\group{properties}
...
\source{stacks:01PF}
\href{https://stacks.math.columbia.edu/tag/01PF}{\texttt{Stacks tag 01PF}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-extend-trivial, properties-lemma-finite-type-module}
...
see Lemma \ref{properties-lemma-finite-type-module}.
...
\begin{lemma}[Quasi coherent colimit finite type]
\label{properties-lemma-quasi-coherent-colimit-finite-type}
\source{stacks:01PG}
\href{https://stacks.math.columbia.edu/tag/01PG}{\texttt{Stacks tag 01PG}}
\group{properties}
...
\begin{lemma}[Extend finite presentation]
\label{properties-lemma-extend-finite-presentation}
\source{stacks:01PI}
\href{https://stacks.math.columbia.edu/tag/01PI}{\texttt{Stacks tag 01PI}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-extend, properties-lemma-extend-trivial, properties-lemma-finite-presentation-module}

The beginning of the proof is a repeat of the beginning of the
proof of Lemma \ref{properties-lemma-extend}. We write it out carefully anyway.
...
\medskip\noindent
Assume $X = \Spec(R)$.
By Lemma \ref{properties-lemma-extend-trivial} above we may
...
By Lemma \ref{properties-lemma-extend} we can find a finite type
...
By Lemma \ref{properties-lemma-finite-presentation-module}
...
an $\mathcal{O}_U$-module of finite type. Hence by Lemma \ref{properties-lemma-extend}
...
\begin{lemma}[Lift finite presentation]
\label{properties-lemma-lift-finite-presentation}
\source{stacks:0G41}
\href{https://stacks.math.columbia.edu/tag/0G41}{\texttt{Stacks tag 0G41}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-extend-finite-presentation, properties-lemma-extend-trivial, properties-lemma-extend}

Part (2) is the special case of Lemma \ref{properties-lemma-extend-finite-presentation}
where $\mathcal{F} = 0$. For part (1) we first write
$\mathcal{G} = \mathcal{F}|_U$ for some quasi-coherent $\mathcal{O}_X$-module
by Lemma \ref{properties-lemma-extend-trivial}
and then we apply Lemma \ref{properties-lemma-extend} with $\mathcal{G} = \mathcal{F}|_U$.
\end{proof}
...
\begin{lemma}[Quasi-coherent modules on quasi-compact and quasi-separated schemes are filtered colimi...]
\label{properties-lemma-directed-colimit-diagram-finite-presentation}
\source{stacks:01PJ}
\href{https://stacks.math.columbia.edu/tag/01PJ}{\texttt{Stacks tag 01PJ}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-extend, properties-lemma-extend-finite-presentation}
...
$$
\begin{array}{cc}\mathcal{F}_i \longrightarrow\downarrow & \mathcal{F} \downarrow \\ \mathcal{F}_i \oplus \mathcal{F}_{i'} \longrightarrow & \mathcal{F}\end{array}
\quad
\text{and}
\quad
\begin{array}{cc}\mathcal{F}_{i'} \longrightarrow\downarrow & \mathcal{F} \downarrow \\ \mathcal{F}_i \oplus \mathcal{F}_{i'} \longrightarrow & \mathcal{F}\end{array}
$$
...
By Lemma \ref{properties-lemma-extend}
...
By Lemma \ref{properties-lemma-extend-finite-presentation}
there exists an $\mathcal{O}_X$-module $\mathcal{G}$
...
\begin{lemma}[Directed colimit finite presentation]
\label{properties-lemma-directed-colimit-finite-presentation}
\source{stacks:01PK}
\href{https://stacks.math.columbia.edu/tag/01PK}{\texttt{Stacks tag 01PK}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-directed-colimit-diagram-finite-presentation}

This is a direct consequence of
Lemma \ref{properties-lemma-directed-colimit-diagram-finite-presentation} and
...
\begin{lemma}[Finite directed colimit surjective maps]
\label{properties-lemma-finite-directed-colimit-surjective-maps}
\source{stacks:086M}
\href{https://stacks.math.columbia.edu/tag/086M}{\texttt{Stacks tag 086M}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-directed-colimit-finite-presentation, properties-lemma-finite-type-module, properties-lemma-quasi-coherent-colimit-finite-type}

Write $\mathcal{F} = \colim \mathcal{G}_i$ as a filtered colimit of
finitely presented $\mathcal{O}_X$-modules
(Lemma \ref{properties-lemma-directed-colimit-finite-presentation}).
...
$\mathcal{F}|_{U_j}$, see Lemma \ref{properties-lemma-finite-type-module}.
...
(Lemma \ref{properties-lemma-quasi-coherent-colimit-finite-type}). Then
$\mathcal{F} = \colim \mathcal{G}_i/\mathcal{K}_a$ is a solution
to the problem posed by the lemma.
\end{proof}

\begin{lemma}[Application directed colimit]
\label{properties-lemma-application-directed-colimit}
\source{stacks:080V}
\href{https://stacks.math.columbia.edu/tag/080V}{\texttt{Stacks tag 080V}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-directed-colimit-finite-presentation, properties-lemma-finite-type-module, properties-lemma-extend}

Write $\mathcal{F} = \colim \mathcal{F}_i$ as a directed colimit
with each $\mathcal{F}_i$ of finite presentation,
see Lemma \ref{properties-lemma-directed-colimit-finite-presentation}.
Choose a finite affine open covering $X = \bigcup V_j$ and choose
finitely many sections $s_{jl} \in \mathcal{F}(V_j)$ generating
$\mathcal{F}|_{V_j}$, see Lemma \ref{properties-lemma-finite-type-module}.
By Sheaves, Lemma \ref{sheaves-lemma-directed-colimits-sections}
...
see Lemma \ref{properties-lemma-extend}. Then
...
\begin{lemma}[Algebra directed colimit finite presentation]
\label{properties-lemma-algebra-directed-colimit-finite-presentation}
\source{stacks:05JS}
\href{https://stacks.math.columbia.edu/tag/05JS}{\texttt{Stacks tag 05JS}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-directed-colimit-finite-presentation, properties-lemma-quasi-coherent-colimit-finite-type}
...
\begin{lemma}[Algebra directed colimit finite type]
\label{properties-lemma-algebra-directed-colimit-finite-type}
\source{stacks:05JT}
\href{https://stacks.math.columbia.edu/tag/05JT}{\texttt{Stacks tag 05JT}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-algebra-directed-colimit-finite-presentation}
...
Lemma \ref{properties-lemma-algebra-directed-colimit-finite-presentation}.
...
\begin{lemma}[Finite algebra directed colimit finite finitely presented]
\label{properties-lemma-finite-algebra-directed-colimit-finite-finitely-presented}
\source{stacks:086N}
\href{https://stacks.math.columbia.edu/tag/086N}{\texttt{Stacks tag 086N}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-finite-directed-colimit-surjective-maps, properties-lemma-quasi-coherent-colimit-finite-type}

By Lemma \ref{properties-lemma-finite-directed-colimit-surjective-maps}
...
$\mathcal{E}_i$ (Lemma \ref{properties-lemma-quasi-coherent-colimit-finite-type}). Set
$$
...
\begin{lemma}[Integral algebra directed colimit finite]
\label{properties-lemma-integral-algebra-directed-colimit-finite}
\source{stacks:0817}
\href{https://stacks.math.columbia.edu/tag/0817}{\texttt{Stacks tag 0817}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-algebra-directed-colimit-finite-type, properties-lemma-directed-colimit-finite-presentation, properties-lemma-finite-algebra-directed-colimit-finite-finitely-presented}

By Lemma \ref{properties-lemma-algebra-directed-colimit-finite-type} we have
...
making
$$
\begin{array}{cc}\mathcal{J}_i \longrightarrow & \mathcal{J}_{i'} \\ \mathcal{E}_{ik} \uparrow\longrightarrow & \mathcal{E}_{i'k'} \uparrow\end{array}
$$
...
(see proof of
Lemma \ref{properties-lemma-finite-algebra-directed-colimit-finite-finitely-presented}).
Finally, we have
$$
...
\begin{definition}[Kappa generated]
\label{properties-definition-kappa-generated}
\source{stacks:077L}
\href{https://stacks.math.columbia.edu/tag/077L}{\texttt{Stacks tag 077L}}
\group{properties}
...
\begin{lemma}[Set of iso classes]
\label{properties-lemma-set-of-iso-classes}
\source{stacks:077M}
\href{https://stacks.math.columbia.edu/tag/077M}{\texttt{Stacks tag 077M}}
\group{properties}
...
\begin{lemma}[Colimit kappa]
\label{properties-lemma-colimit-kappa}
\source{stacks:077N}
\href{https://stacks.math.columbia.edu/tag/077N}{\texttt{Stacks tag 077N}}
\group{properties}
...
\begin{proposition}[Coherator]
\label{properties-proposition-coherator}
\source{stacks:077P}
\href{https://stacks.math.columbia.edu/tag/077P}{\texttt{Stacks tag 077P}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-colimit-kappa, properties-lemma-set-of-iso-classes}
...
Lemma \ref{properties-lemma-colimit-kappa}. Pick a collection
$(\mathcal{F}_t)_{t \in T}$ of $\kappa$-generated quasi-coherent sheaves as in
Lemma \ref{properties-lemma-set-of-iso-classes}. Set
...
\begin{lemma}[Quasi coherent finite type ideals]
\label{properties-lemma-quasi-coherent-finite-type-ideals}
\source{stacks:01PH}
\href{https://stacks.math.columbia.edu/tag/01PH}{\texttt{Stacks tag 01PH}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-quasi-separated-quasi-compact-open-retrocompact, properties-lemma-extend, properties-lemma-finite-type-module, properties-lemma-retrocompact}
...
By Lemma \ref{properties-lemma-extend} there exists a quasi-coherent subsheaf
...
ideal $I \subset R$, see Lemma \ref{properties-lemma-finite-type-module}.
It follows that $U \cap W = \Spec(R) \setminus V(I)$ is quasi-compact,
see Algebra, Lemma \ref{algebra-lemma-qc-open}. Hence $U \subset X$
is retrocompact by Lemma \ref{properties-lemma-retrocompact}.
\end{proof}

\begin{lemma}[Sections annihilated by ideal]
\label{properties-lemma-sections-annihilated-by-ideal}
\source{stacks:01PO}
\href{https://stacks.math.columbia.edu/tag/01PO}{\texttt{Stacks tag 01PO}}
\group{properties}
...
is of finite type, see Lemma \ref{properties-lemma-finite-type-module}.
...
\begin{definition}[Subsheaf sections annihilated by ideal]
\label{properties-definition-subsheaf-sections-annihilated-by-ideal}
\source{stacks:01PP}
\href{https://stacks.math.columbia.edu/tag/01PP}{\texttt{Stacks tag 01PP}}
\group{properties}

\uses{properties-lemma-sections-annihilated-by-ideal}
Let $X$ be a scheme.
Let $\mathcal{I} \subset \mathcal{O}_X$ be a quasi-coherent sheaf of ideals
of finite type.
Let $\mathcal{F}$ be a quasi-coherent $\mathcal{O}_X$-module.
The subsheaf $\mathcal{F}' \subset \mathcal{F}$ defined in
Lemma \ref{properties-lemma-sections-annihilated-by-ideal} above is called
the {\it subsheaf of sections annihilated by $\mathcal{I}$}.
\end{definition}

\begin{lemma}[Push sections annihilated by ideal]
\label{properties-lemma-push-sections-annihilated-by-ideal}
\source{stacks:07ZN}
\href{https://stacks.math.columbia.edu/tag/07ZN}{\texttt{Stacks tag 07ZN}}
\group{properties}
...
so that Lemma \ref{properties-lemma-sections-annihilated-by-ideal} applies
...
\begin{lemma}[Sections supported on closed subset]
\label{properties-lemma-sections-supported-on-closed-subset}
\source{stacks:07ZP}
\href{https://stacks.math.columbia.edu/tag/07ZP}{\texttt{Stacks tag 07ZP}}
\group{properties}
...
\begin{definition}[Subsheaf sections supported on closed]
\label{properties-definition-subsheaf-sections-supported-on-closed}
\source{stacks:084L}
\href{https://stacks.math.columbia.edu/tag/084L}{\texttt{Stacks tag 084L}}
\group{properties}

\uses{properties-lemma-sections-supported-on-closed-subset}
Let $X$ be a scheme.
...
Lemma \ref{properties-lemma-sections-supported-on-closed-subset} is called
the {\it subsheaf of sections supported on $T$}.
\end{definition}

\begin{lemma}[Push sections supported on closed subset]
\label{properties-lemma-push-sections-supported-on-closed-subset}
\source{stacks:07ZQ}
\href{https://stacks.math.columbia.edu/tag/07ZQ}{\texttt{Stacks tag 07ZQ}}
\group{properties}
...
Lemma \ref{properties-lemma-sections-supported-on-closed-subset}
applies to $f^{-1}Z$ and $\mathcal{F}$. As $f$ is quasi-compact and
quasi-separated we see that $f_*\mathcal{F}$ is quasi-coherent.
Hence Lemma \ref{properties-lemma-sections-supported-on-closed-subset}
...
\begin{lemma}[Sections over quasi compact open in affine]
\label{properties-lemma-sections-over-quasi-compact-open-in-affine}
\source{stacks:01PM}
\href{https://stacks.math.columbia.edu/tag/01PM}{\texttt{Stacks tag 01PM}}
\group{properties}
...
\begin{example}[Does not work in general]
\label{properties-example-does-not-work-in-general}
\source{stacks:01PN}
\href{https://stacks.math.columbia.edu/tag/01PN}{\texttt{Stacks tag 01PN}}
\group{properties}

\uses{properties-lemma-sections-over-quasi-compact-open-in-affine}
...
of Lemma \ref{properties-lemma-sections-over-quasi-compact-open-in-affine}.
...
\begin{lemma}[Sections over quasi compact open]
\label{properties-lemma-sections-over-quasi-compact-open}
\source{stacks:01PQ}
\href{https://stacks.math.columbia.edu/tag/01PQ}{\texttt{Stacks tag 01PQ}}
\group{properties}
...
\source{stacks:01PS}
\href{https://stacks.math.columbia.edu/tag/01PS}{\texttt{Stacks tag 01PS}}
\group{properties}
...
\begin{lemma}[Ample power ample]
\label{properties-lemma-ample-power-ample}
\source{stacks:01PT}
\href{https://stacks.math.columbia.edu/tag/01PT}{\texttt{Stacks tag 01PT}}
\group{properties}
...
\begin{lemma}[Ample on closed]
\label{properties-lemma-ample-on-closed}
\source{stacks:01PU}
\href{https://stacks.math.columbia.edu/tag/01PU}{\texttt{Stacks tag 01PU}}
\group{properties}
...
\begin{lemma}[Affine cap s open]
\label{properties-lemma-affine-cap-s-open}
\source{stacks:01PV}
\href{https://stacks.math.columbia.edu/tag/01PV}{\texttt{Stacks tag 01PV}}
\group{properties}
...
\begin{lemma}[Ample tensor globally generated]
\label{properties-lemma-ample-tensor-globally-generated}
\source{stacks:0890}
\href{https://stacks.math.columbia.edu/tag/0890}{\texttt{Stacks tag 0890}}
\group{properties}
...
\begin{proof}
\uses{properties-definition-ample, properties-lemma-affine-cap-s-open}

We check the conditions of Definition \ref{properties-definition-ample}.
...
Lemma \ref{properties-lemma-affine-cap-s-open}.
\end{proof}

\begin{lemma}[Affine s opens]
\label{properties-lemma-affine-s-opens}
\source{stacks:01PX}
\href{https://stacks.math.columbia.edu/tag/01PX}{\texttt{Stacks tag 01PX}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-affine-cap-s-open, properties-lemma-locally-free-module}

We show first that $X$ is quasi-separated.  By assumption we
can find a covering of $X$ by affine opens of the form
$X_s$.  By Lemma \ref{properties-lemma-affine-cap-s-open}, the
...
$1$ (Lemma \ref{properties-lemma-locally-free-module}) and as $A$ is
...
\begin{lemma}[Ample separated]
\label{properties-lemma-ample-separated}
\source{stacks:09MP}
\href{https://stacks.math.columbia.edu/tag/09MP}{\texttt{Stacks tag 09MP}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-affine-s-opens-cover-quasi-separated, properties-definition-ample}

Follows immediately from
Lemma \ref{properties-lemma-affine-s-opens-cover-quasi-separated} and
Definition \ref{properties-definition-ample}.
\end{proof}

\begin{lemma}[Map into proj]
\label{properties-lemma-map-into-proj}
\source{stacks:01PZ}
\href{https://stacks.math.columbia.edu/tag/01PZ}{\texttt{Stacks tag 01PZ}}
\group{properties}
...
\begin{lemma}[Map into proj quasi compact]
\label{properties-lemma-map-into-proj-quasi-compact}
\source{stacks:01Q0}
\href{https://stacks.math.columbia.edu/tag/01Q0}{\texttt{Stacks tag 01Q0}}
\group{properties}

\uses{properties-lemma-map-into-proj}
Let $X$ be a scheme. Let $\mathcal{L}$ be an invertible $\mathcal{O}_X$-module.
...
$f : X \longrightarrow \text{Proj}(S)$ of Lemma \ref{properties-lemma-map-into-proj}
above is quasi-compact with dense image.
\end{lemma}

\begin{proof}
\uses{properties-lemma-affine-cap-s-open, properties-lemma-map-into-proj, properties-lemma-invert-s-sections}
...
affine opens. By Lemma \ref{properties-lemma-affine-cap-s-open} each intersection
...
By Lemma \ref{properties-lemma-map-into-proj}
this means $X_s = \emptyset$. By Lemma \ref{properties-lemma-invert-s-sections}
...
\begin{lemma}[Ample immersion into proj]
\label{properties-lemma-ample-immersion-into-proj}
\source{stacks:01Q1}
\href{https://stacks.math.columbia.edu/tag/01Q1}{\texttt{Stacks tag 01Q1}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-affine-s-opens-cover-quasi-separated, properties-lemma-map-into-proj, properties-lemma-invert-s-sections, properties-lemma-map-into-proj-quasi-compact}

By Lemma \ref{properties-lemma-affine-s-opens-cover-quasi-separated} we see
...
$D_{+}(s_i)$ under $f$ is $X_{s_i}$, see Lemma \ref{properties-lemma-map-into-proj}.
By Lemma \ref{properties-lemma-invert-s-sections} the ring map
$$
...
The image is dense by Lemma \ref{properties-lemma-map-into-proj-quasi-compact}.
\end{proof}

\begin{lemma}[Open in proj ample]
\label{properties-lemma-open-in-proj-ample}
\source{stacks:01Q2}
\href{https://stacks.math.columbia.edu/tag/01Q2}{\texttt{Stacks tag 01Q2}}
\group{properties}
...
\begin{proposition}[Characterize ample]
\label{properties-proposition-characterize-ample}
\source{stacks:01Q3}
\href{https://stacks.math.columbia.edu/tag/01Q3}{\texttt{Stacks tag 01Q3}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-ample-immersion-into-proj, properties-lemma-ample-power-ample, properties-lemma-open-in-proj-ample, properties-lemma-affine-s-opens, properties-lemma-invert-s-sections, properties-lemma-affine-cap-s-open, properties-lemma-quasi-coherent-colimit-finite-type}

Lemma \ref{properties-lemma-ample-immersion-into-proj} is
(\ref{item-ample}) $\Rightarrow$ (\ref{item-immersion}).
Lemmas \ref{properties-lemma-ample-power-ample} and \ref{properties-lemma-open-in-proj-ample}
...
Lemma \ref{properties-lemma-affine-s-opens} is
...
Namely, by Lemma \ref{properties-lemma-invert-s-sections} we may write
...
of ideals. By Lemma \ref{properties-lemma-quasi-coherent-colimit-finite-type}
...
\begin{lemma}[Ample on locally closed]
\label{properties-lemma-ample-on-locally-closed}
\source{stacks:0B3E}
\href{https://stacks.math.columbia.edu/tag/0B3E}{\texttt{Stacks tag 0B3E}}
\group{properties}
...
\begin{proof}
\uses{properties-definition-ample, properties-proposition-characterize-ample}

Observe that in cases (1) and (3) the scheme $X'$ is quasi-compact
as $X$ is quasi-compact by Definition \ref{properties-definition-ample}.
...
\begin{lemma}[Ample on product]
\label{properties-lemma-ample-on-product}
\source{stacks:0DNK}
\href{https://stacks.math.columbia.edu/tag/0DNK}{\texttt{Stacks tag 0DNK}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-ample-on-locally-closed, properties-definition-ample}
...
By Lemma \ref{properties-lemma-ample-on-locally-closed} it suffices to prove the
lemma for $X \times Y$. We check (1) and (2) of
Definition \ref{properties-definition-ample} for $\mathcal{M}$ on $X \times Y$.
...
\begin{lemma}[Quasi affine O ample]
\label{properties-lemma-quasi-affine-O-ample}
\source{stacks:01QE}
\href{https://stacks.math.columbia.edu/tag/01QE}{\texttt{Stacks tag 01QE}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-quasi-affine, properties-lemma-open-in-proj-ample, properties-lemma-ample-immersion-into-proj}
...
$$
from Lemma \ref{properties-lemma-quasi-affine}. Note that
$\Spec(A) = \text{Proj}(A[T])$, see
Constructions, Example \ref{constructions-example-trivial-proj}.
Hence we can apply Lemma \ref{properties-lemma-open-in-proj-ample}
...
\ref{properties-lemma-ample-immersion-into-proj} and \ref{properties-lemma-quasi-affine}
taking into account that
$\Spec(A) = \text{Proj}(A[T])$ for any ring $A$
as seen above.
\end{proof}

\begin{lemma}[Quasi affine locally closed]
\label{properties-lemma-quasi-affine-locally-closed}
\source{stacks:0BCK}
\href{https://stacks.math.columbia.edu/tag/0BCK}{\texttt{Stacks tag 0BCK}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-quasi-affine-O-ample, properties-lemma-ample-on-locally-closed}
...
Lemma \ref{properties-lemma-quasi-affine-O-ample}.
Then $\mathcal{O}_{X'}$ is ample by
Lemma \ref{properties-lemma-ample-on-locally-closed}. Then $X'$ is quasi-affine by
Lemma \ref{properties-lemma-quasi-affine-O-ample}.
\end{proof}
...
\source{stacks:01QF}
\href{https://stacks.math.columbia.edu/tag/01QF}{\texttt{Stacks tag 01QF}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-quasi-affine-O-ample, properties-lemma-quasi-affine, properties-lemma-invert-f-affine}
...
Lemma \ref{properties-lemma-quasi-affine-O-ample} above.
Consider the open immersion
$$
j : X \to \Spec(\Gamma(X, \mathcal{O}_X)),
$$
see Lemma \ref{properties-lemma-quasi-affine}. The inverse image of the standard open
...
Lemma \ref{properties-lemma-invert-f-affine}. Since the $f_i$ generate the unit ideal
...
\begin{definition}[Situation: Ample]
\label{properties-situation-ample}
\source{stacks:01QH}
\href{https://stacks.math.columbia.edu/tag/01QH}{\texttt{Stacks tag 01QH}}
\group{properties}
...
Set $S = \Gamma_*(X, \mathcal{L})$ as a graded ring.
Set $Y = \text{Proj}(S)$.
Let $f : X \to Y$ be the canonical morphism of Lemma \ref{properties-lemma-map-into-proj}.
...
\begin{lemma}[Ample gcd is one]
\label{properties-lemma-ample-gcd-is-one}
\source{stacks:01QI}
\href{https://stacks.math.columbia.edu/tag/01QI}{\texttt{Stacks tag 01QI}}
\group{properties}

\uses{properties-situation-ample}
In Situation \ref{properties-situation-ample}.
...
\begin{proof}
\uses{properties-proposition-characterize-ample}

By Proposition \ref{properties-proposition-characterize-ample} there exists an integer
...
\Gamma(X, \mathcal{F} \otimes_{\mathcal{O}_X} \mathcal{L}^{\otimes n}).
$$
The following lemma says that, in Situation \ref{properties-situation-ample},
...
\begin{lemma}[Ample quasi coherent]
\label{properties-lemma-ample-quasi-coherent}
\source{stacks:01QJ}
\href{https://stacks.math.columbia.edu/tag/01QJ}{\texttt{Stacks tag 01QJ}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-invert-s-sections}
...
quasi-separated, see Section \ref{properties-section-ample}.
By Lemma \ref{properties-lemma-invert-s-sections} there is a canonical isomorphism
...
\begin{remark}[Neurotic]
\label{properties-remark-neurotic}
\source{stacks:01QK}
\href{https://stacks.math.columbia.edu/tag/01QK}{\texttt{Stacks tag 01QK}}
\group{properties}

\uses{properties-lemma-ample-quasi-coherent, properties-lemma-ample-gcd-is-one}
With assumptions and notation of Lemma \ref{properties-lemma-ample-quasi-coherent}.
Denote the displayed map of the lemma by $\theta_\mathcal{F}$.
Note that the isomorphism $f^*\mathcal{O}_Y(n) \to \mathcal{L}^{\otimes n}$
of Lemma \ref{properties-lemma-ample-gcd-is-one} is just
...
$$
\begin{array}{cc}f^*\widetilde{M} \otimes_{\mathcal{O}_X} f^*\mathcal{O}_Y(n)
\longrightarrow\underset{\theta_\mathcal{F} \otimes \theta_{\mathcal{L}^{\otimes n}}}{\downarrow} & f^*\widetilde{M(n)}
\overset{\theta_{\mathcal{F} \otimes \mathcal{L}^{\otimes n}}}{\downarrow} \\ \mathcal{F} \otimes \mathcal{L}^{\otimes n} \overset{\text{id}}{\longrightarrow} & \mathcal{F} \otimes \mathcal{L}^{\otimes n}\end{array}
$$
...
Lemma \ref{properties-lemma-ample-quasi-coherent} (or conversely) but it seems
simpler to just repeat the proof.

\begin{lemma}[Proj quasi coherent]
\label{properties-lemma-proj-quasi-coherent}
\source{stacks:0AG5}
\href{https://stacks.math.columbia.edu/tag/0AG5}{\texttt{Stacks tag 0AG5}}
\group{properties}
...
\begin{lemma}[Maximal points affine]
\label{properties-lemma-maximal-points-affine}
\source{stacks:01ZV}
\href{https://stacks.math.columbia.edu/tag/01ZV}{\texttt{Stacks tag 01ZV}}
\group{properties}
...
\begin{remark}[Maximal points affine]
\label{properties-remark-maximal-points-affine}
\source{stacks:01ZW}
\href{https://stacks.math.columbia.edu/tag/01ZW}{\texttt{Stacks tag 01ZW}}
\group{properties}

\uses{properties-lemma-maximal-points-affine}
Lemma \ref{properties-lemma-maximal-points-affine} above is false if $X$
...
closed subsets one can apply Lemma \ref{properties-lemma-maximal-points-affine} above,
at least if $X$ is quasi-compact. This is true because $X$ contains a dense
open which is separated.

\begin{lemma}[Quasi compact dense open separated]
\label{properties-lemma-quasi-compact-dense-open-separated}
\source{stacks:03J1}
\href{https://stacks.math.columbia.edu/tag/03J1}{\texttt{Stacks tag 03J1}}
\group{properties}
...
Here is a slight refinement of Lemma \ref{properties-lemma-maximal-points-affine} above.

\begin{lemma}[Point and maximal points affine]
\label{properties-lemma-point-and-maximal-points-affine}
\source{stacks:01ZX}
\href{https://stacks.math.columbia.edu/tag/01ZX}{\texttt{Stacks tag 01ZX}}
\group{properties}
...
for $i = 1, \ldots, r$. By Lemma \ref{properties-lemma-maximal-points-affine}
...
\begin{lemma}[Ample finite set in affine]
\label{properties-lemma-ample-finite-set-in-affine}
\source{stacks:01ZY}
\href{https://stacks.math.columbia.edu/tag/01ZY}{\texttt{Stacks tag 01ZY}}
\group{properties}
...
\begin{proof}
\uses{properties-definition-quasi-affine, properties-proposition-characterize-ample}
...
By Proposition \ref{properties-proposition-characterize-ample}
...
\begin{lemma}[Ample finite set in principal affine]
\label{properties-lemma-ample-finite-set-in-principal-affine}
\source{stacks:09NV}
\href{https://stacks.math.columbia.edu/tag/09NV}{\texttt{Stacks tag 09NV}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-ample-finite-set-in-affine, properties-lemma-affine-cap-s-open}

The reader can modify the proof of Lemma \ref{properties-lemma-ample-finite-set-in-affine}
to prove this lemma; we will instead deduce the lemma from it.
By Lemma \ref{properties-lemma-ample-finite-set-in-affine} we can choose an affine
...
\begin{lemma}[Quasi affine invertible nonvanishing section]
\label{properties-lemma-quasi-affine-invertible-nonvanishing-section}
\source{stacks:0F20}
\href{https://stacks.math.columbia.edu/tag/0F20}{\texttt{Stacks tag 0F20}}
\group{properties}
...
\begin{proof}
\uses{properties-lemma-quasi-affine-O-ample, properties-proposition-characterize-ample, properties-lemma-affine-cap-s-open, properties-lemma-ample-finite-set-in-affine, properties-lemma-ample-finite-set-in-principal-affine}
...
Lemmas \ref{properties-lemma-quasi-affine-O-ample} and
Proposition \ref{properties-proposition-characterize-ample}
...
By either Lemma \ref{properties-lemma-ample-finite-set-in-affine} or
Lemma \ref{properties-lemma-ample-finite-set-in-principal-affine}
...
\begin{lemma}[Ring affine open injective local ring]
\label{properties-lemma-ring-affine-open-injective-local-ring}
\source{stacks:0BX3}
\href{https://stacks.math.columbia.edu/tag/0BX3}{\texttt{Stacks tag 0BX3}}
\group{properties}
...
\source{stacks:0H9B}
\href{https://stacks.math.columbia.edu/tag/0H9B}{\texttt{Stacks tag 0H9B}}
\group{properties}

Let $U$, $V$ be affine schemes and let $W \to U$ and $W \to V$
be open immersions. For any $w \in W$ there exists an affine
open neighbourhood $W' \subset W$ of $w$ such that $W'$
maps to a standard open of both $U$ and $V$.
\end{lemma}

\begin{proof}
Let $X$ be the glueing of $U$ and $V$ along $W$ and
apply Schemes, Lemma \ref{schemes-lemma-standard-open-two-affines}.
\end{proof}
