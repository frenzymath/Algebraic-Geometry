...
\begin{lemma}[Directed inverse system affine schemes has limit]
\label{limits-lemma-directed-inverse-system-affine-schemes-has-limit}
\source{stacks:01YW}
\href{https://stacks.math.columbia.edu/tag/01YW}{\texttt{Stacks tag 01YW}}
\group{limits}
...
\begin{lemma}[Directed inverse system has limit]
\label{limits-lemma-directed-inverse-system-has-limit}
\source{stacks:01YX}
\href{https://stacks.math.columbia.edu/tag/01YX}{\texttt{Stacks tag 01YX}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-directed-inverse-system-affine-schemes-has-limit}
...
By Lemma \ref{limits-lemma-directed-inverse-system-affine-schemes-has-limit} above
...
\begin{lemma}[Scheme over limit]
\label{limits-lemma-scheme-over-limit}
\source{stacks:01YZ}
\href{https://stacks.math.columbia.edu/tag/01YZ}{\texttt{Stacks tag 01YZ}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-directed-inverse-system-has-limit}
...
\begin{lemma}[Infinite products of affine schemes exist and are affine.]
\label{limits-lemma-infinite-product}
\source{stacks:0CNI}
\href{https://stacks.math.columbia.edu/tag/0CNI}{\texttt{Stacks tag 0CNI}}
\group{limits}
...
and use Lemma \ref{limits-lemma-directed-inverse-system-has-limit}
for existence of the limit.
\end{proof}

\begin{lemma}[Infinite product surjective]
\label{limits-lemma-infinite-product-surjective}
\source{stacks:0CNJ}
\href{https://stacks.math.columbia.edu/tag/0CNJ}{\texttt{Stacks tag 0CNJ}}
\group{limits}

\uses{limits-lemma-infinite-product}
Let $S$ be a scheme. Let $I$ be a set and for each $i \in I$
let $f_i : T_i \to S$ be a surjective affine morphism. Then the
product $T = \prod T_i$ in the category of schemes over $S$
(Lemma \ref{limits-lemma-infinite-product})
...
\begin{lemma}[Infinite product integral]
\label{limits-lemma-infinite-product-integral}
\source{stacks:0CNK}
\href{https://stacks.math.columbia.edu/tag/0CNK}{\texttt{Stacks tag 0CNK}}
\group{limits}
...
\begin{lemma}[Inverse limit sets]
\label{limits-lemma-inverse-limit-sets}
\source{stacks:0CUE}
\href{https://stacks.math.columbia.edu/tag/0CUE}{\texttt{Stacks tag 0CUE}}
\group{limits}

\uses{limits-lemma-directed-inverse-system-has-limit}
Let $S = \lim S_i$ be the limit of a directed inverse system
of schemes with affine transition morphisms
(Lemma \ref{limits-lemma-directed-inverse-system-has-limit}). Then
...
By Lemma \ref{limits-lemma-directed-inverse-system-has-limit}
...
\begin{lemma}[Inverse limit top]
\label{limits-lemma-inverse-limit-top}
\source{stacks:0CUF}
\href{https://stacks.math.columbia.edu/tag/0CUF}{\texttt{Stacks tag 0CUF}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-inverse-limit-sets, limits-lemma-directed-inverse-system-has-limit, limits-lemma-directed-inverse-system-affine-schemes-has-limit}

We will use the criterion of
Topology, Lemma \ref{topology-lemma-characterize-limit}.
We have seen that $S_{set} = \lim_i S_{i, set}$ in
Lemma \ref{limits-lemma-inverse-limit-sets}.
...
\begin{lemma}[Limit nonempty]
\label{limits-lemma-limit-nonempty}
\source{stacks:01Z2}
\href{https://stacks.math.columbia.edu/tag/01Z2}{\texttt{Stacks tag 01Z2}}
\group{limits}
...
\begin{lemma}[Inverse limit irreducibles]
\label{limits-lemma-inverse-limit-irreducibles}
\source{stacks:0CUG}
\href{https://stacks.math.columbia.edu/tag/0CUG}{\texttt{Stacks tag 0CUG}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-inverse-limit-sets}
...
$$
This follows from Lemma \ref{limits-lemma-inverse-limit-sets}
...
\source{stacks:086P}
\href{https://stacks.math.columbia.edu/tag/086P}{\texttt{Stacks tag 086P}}
\group{limits}
...
\begin{lemma}[Topology limit]
\label{limits-lemma-topology-limit}
\source{stacks:01YY}
\href{https://stacks.math.columbia.edu/tag/01YY}{\texttt{Stacks tag 01YY}}
\group{limits}

\uses{limits-situation-descent}
...
\begin{proof}
\uses{limits-lemma-inverse-limit-sets, limits-lemma-inverse-limit-top, limits-lemma-inverse-limit-irreducibles}

Part (1) is a special case of Lemma \ref{limits-lemma-inverse-limit-sets}.

\medskip\noindent
Part (2) is a special case of Lemma \ref{limits-lemma-inverse-limit-top}.

\medskip\noindent
Part (3) is a special case of Lemma \ref{limits-lemma-inverse-limit-irreducibles}.
\end{proof}

\begin{lemma}[Descend section]
\label{limits-lemma-descend-section}
\source{stacks:01Z0}
\href{https://stacks.math.columbia.edu/tag/01Z0}{\texttt{Stacks tag 01Z0}}
\group{limits}
...
\begin{lemma}[Limit closed nonempty]
\label{limits-lemma-limit-closed-nonempty}
\source{stacks:01Z3}
\href{https://stacks.math.columbia.edu/tag/01Z3}{\texttt{Stacks tag 01Z3}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-limit-nonempty}
...
\begin{lemma}[Limit fibre product empty]
\label{limits-lemma-limit-fibre-product-empty}
\source{stacks:05F3}
\href{https://stacks.math.columbia.edu/tag/05F3}{\texttt{Stacks tag 05F3}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-scheme-over-limit, limits-lemma-limit-nonempty}

By Lemma \ref{limits-lemma-scheme-over-limit}
we see that $T \times_{S_i} S = \lim_{i' \geq i} T \times_{S_i} S_{i'}$.
Hence the result follows from
Lemma \ref{limits-lemma-limit-nonempty}.
\end{proof}

\begin{lemma}[Limit contained in constructible]
\label{limits-lemma-limit-contained-in-constructible}
\source{stacks:05F4}
\href{https://stacks.math.columbia.edu/tag/05F4}{\texttt{Stacks tag 05F4}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-directed-inverse-system-has-limit, limits-lemma-limit-fibre-product-empty}
...
By
Lemma \ref{limits-lemma-limit-fibre-product-empty}
...
\source{stacks:01Z4}
\href{https://stacks.math.columbia.edu/tag/01Z4}{\texttt{Stacks tag 01Z4}}
\group{limits}
...
\begin{lemma}[Limit quasi affine]
\label{limits-lemma-limit-quasi-affine}
\source{stacks:01Z5}
\href{https://stacks.math.columbia.edu/tag/01Z5}{\texttt{Stacks tag 01Z5}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-descend-section, limits-lemma-descend-opens}
...
\begin{lemma}[Limit affine]
\label{limits-lemma-limit-affine}
\source{stacks:01Z6}
\href{https://stacks.math.columbia.edu/tag/01Z6}{\texttt{Stacks tag 01Z6}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-limit-quasi-affine, limits-lemma-descend-section, limits-lemma-limit-closed-nonempty, limits-lemma-topology-limit}
...
\begin{lemma}[Limit separated]
\label{limits-lemma-limit-separated}
\source{stacks:086Q}
\href{https://stacks.math.columbia.edu/tag/086Q}{\texttt{Stacks tag 086Q}}
\group{limits}

\uses{limits-situation-descent}
In Situation \ref{limits-situation-descent} if $S$ is separated,
then for some $i_0 \in I$ the schemes $S_i$ for $i \geq i_0$
are separated.
\end{lemma}

\begin{proof}
\uses{limits-lemma-limit-affine}
...
by Lemma \ref{limits-lemma-limit-affine}. To show that $S_i$ is separated
...
$$
\begin{array}{cc}U_i \cap V_i \longrightarrow\downarrow & U_i \downarrow \\ U_0 \cap V_0 \longrightarrow & U_0\end{array}
$$
...
\begin{lemma}[Limit ample]
\label{limits-lemma-limit-ample}
\source{stacks:09MT}
\href{https://stacks.math.columbia.edu/tag/09MT}{\texttt{Stacks tag 09MT}}
\group{limits}

\uses{limits-situation-descent}
In Situation \ref{limits-situation-descent} let $\mathcal{L}_0$ be an invertible
...
\begin{proof}
\uses{limits-lemma-descend-section, limits-lemma-limit-affine, limits-lemma-descend-opens}
...
By Lemma \ref{limits-lemma-descend-section} we can find an $i \in I$
and sections $s_{i, j} \in \Gamma(S_i, \mathcal{L}_i)$ mapping to $s_j$.
By Lemma \ref{limits-lemma-limit-affine} we may, after increasing $i$, assume
that $(S_i)_{s_{i, j}}$ is affine for $j = 1, \ldots, m$.
By Lemma \ref{limits-lemma-descend-opens} we may, after increasing $i$ a
last time, assume that $S_i = \bigcup (S_i)_{s_{i, j}}$.
Then $\mathcal{L}_i$ is ample by definition.
\end{proof}

\begin{lemma}[Finite type eventually closed]
\label{limits-lemma-finite-type-eventually-closed}
\source{stacks:081B}
\href{https://stacks.math.columbia.edu/tag/081B}{\texttt{Stacks tag 081B}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-descend-opens}
...
Lemma \ref{limits-lemma-descend-opens}
...
\begin{lemma}[Eventually separated]
\label{limits-lemma-eventually-separated}
\source{stacks:01ZH}
\href{https://stacks.math.columbia.edu/tag/01ZH}{\texttt{Stacks tag 01ZH}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-limit-separated}
...
Thus the lemma follows from Lemma \ref{limits-lemma-limit-separated}.
\end{proof}

\begin{lemma}[Eventually affine]
\label{limits-lemma-eventually-affine}
\source{stacks:09ZM}
\href{https://stacks.math.columbia.edu/tag/09ZM}{\texttt{Stacks tag 09ZM}}
\group{limits}
...
Lemma \ref{limits-lemma-limit-affine} there exists an $i \in I$ such that
...
\begin{lemma}[Eventually finite]
\label{limits-lemma-eventually-finite}
\source{stacks:09ZN}
\href{https://stacks.math.columbia.edu/tag/09ZN}{\texttt{Stacks tag 09ZN}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-eventually-affine}

By Lemma \ref{limits-lemma-eventually-affine}
...
\begin{lemma}[Eventually closed immersion]
\label{limits-lemma-eventually-closed-immersion}
\source{stacks:0A0N}
\href{https://stacks.math.columbia.edu/tag/0A0N}{\texttt{Stacks tag 0A0N}}
\group{limits}
...
\begin{lemma}[Eventually immersion]
\label{limits-lemma-eventually-immersion}
\source{stacks:0GIH}
\href{https://stacks.math.columbia.edu/tag/0GIH}{\texttt{Stacks tag 0GIH}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-descend-opens, limits-lemma-eventually-closed-immersion}
...
large enough by Lemma \ref{limits-lemma-descend-opens}. Thus we may
assume $X = \lim X_i$ in the category of schemes over $U$.
Then we see that $X_i \to U$ is a closed immersion for $i$
large enough by Lemma \ref{limits-lemma-eventually-closed-immersion}.
...
from Section \ref{limits-section-limits} without further mention.

\begin{lemma}[Quasi affine finite type over Z]
\label{limits-lemma-quasi-affine-finite-type-over-Z}
\source{stacks:01Z7}
\href{https://stacks.math.columbia.edu/tag/01Z7}{\texttt{Stacks tag 01Z7}}
\group{limits}
...
\source{stacks:01Z9}
\href{https://stacks.math.columbia.edu/tag/01Z9}{\texttt{Stacks tag 01Z9}}
\group{limits}

Suppose given a cartesian diagram of rings
$$
\begin{array}{cc}B \underset{s}{\longrightarrow} & R \\ B'\uparrow\longrightarrow & R' \underset{t}{\uparrow}\end{array}
$$
...
\source{stacks:07RN}
\href{https://stacks.math.columbia.edu/tag/07RN}{\texttt{Stacks tag 07RN}}
\group{limits}
...
$$
\vcenter{
\begin{array}{cc}V \downarrow\searrow &  \\ V'_j \longrightarrow & V_{\alpha(j)}\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}V'_j \longrightarrow\downarrow & V_{\alpha(j)} \downarrow \\ V'_{j'} \longrightarrow & V_{\alpha(j')}\end{array}
}
$$
are commutative.
\end{enumerate}
...
\begin{proof}
\uses{limits-lemma-descend-opens, limits-lemma-limit-quasi-affine, limits-lemma-descend-section, limits-lemma-diagram, limits-lemma-quasi-affine-finite-type-over-Z}
...
$$
\begin{array}{cc}B \underset{s}{\longrightarrow} & R \\  & R_i \underset{t_i}{\uparrow}\end{array}
$$
We set $B_i = \{(b, r) \in B \times R_i \mid s(b) = t_i(r)\}$ so that we
have a cartesian diagram
$$
\begin{array}{cc}B \underset{s}{\longrightarrow} & R \\ B_i \uparrow\longrightarrow & R_i \underset{t_i}{\uparrow}\end{array}
$$
...
$$
\begin{array}{cccc} &  & V \swarrow\downarrow & W \longleftarrow\swarrow\downarrow \\ V_i \downarrow & W_i \longleftarrow\downarrow & S \swarrow & U \swarrow\longleftarrow \\ S_{i, p} & \Spec(A_{i, p}) \longleftarrow &  & \end{array}
$$
...
\source{stacks:01ZA}
\href{https://stacks.math.columbia.edu/tag/01ZA}{\texttt{Stacks tag 01ZA}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-approximate}

This is a special case of Lemma \ref{limits-lemma-approximate}
with $V = \emptyset$.
\end{proof}
...
\begin{proposition}[Characterize locally finite presentation]
\label{limits-proposition-characterize-locally-finite-presentation}
\source{stacks:01ZC}
\href{https://stacks.math.columbia.edu/tag/01ZC}{\texttt{Stacks tag 01ZC}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-limit-closed-nonempty, limits-lemma-descend-opens, limits-lemma-limit-affine}
...
to get a contradiction. By Lemma \ref{limits-lemma-limit-closed-nonempty}
...
If each $Z_{i'}$ is nonempty, then by Lemma \ref{limits-lemma-limit-closed-nonempty}
...
and $g(W_j) \subset U_j$. By Lemmas \ref{limits-lemma-descend-opens}
and \ref{limits-lemma-limit-affine}
...
\begin{remark}[Limit preserving]
\label{limits-remark-limit-preserving}
\source{stacks:05LX}
\href{https://stacks.math.columbia.edu/tag/05LX}{\texttt{Stacks tag 05LX}}
\group{limits}

\uses{limits-proposition-characterize-locally-finite-presentation}
...
\begin{lemma}[Surjection is enough]
\label{limits-lemma-surjection-is-enough}
\source{stacks:0CM0}
\href{https://stacks.math.columbia.edu/tag/0CM0}{\texttt{Stacks tag 0CM0}}
\group{limits}
...
\begin{proof}
\uses{limits-proposition-characterize-locally-finite-presentation, limits-lemma-limit-closed-nonempty}
...
\begin{lemma}[Morphism glueing near closed point]
\label{limits-lemma-morphism-glueing-near-closed-point}
\source{stacks:0GWT}
\href{https://stacks.math.columbia.edu/tag/0GWT}{\texttt{Stacks tag 0GWT}}
\group{limits}
...
\begin{proof}
\uses{limits-proposition-characterize-locally-finite-presentation, limits-lemma-directed-inverse-system-has-limit}
...
We discuss variants of Proposition \ref{limits-proposition-approximate}
over a base.

\begin{lemma}[Approximate morphism]
\label{limits-lemma-approximate-morphism}
\source{stacks:0GS1}
\href{https://stacks.math.columbia.edu/tag/0GS1}{\texttt{Stacks tag 0GS1}}
\group{limits}
...
\begin{proof}
\uses{limits-proposition-approximate, limits-proposition-characterize-locally-finite-presentation}

Write $X = \lim_{a \in A} X_a$ and $S = \lim_{b \in B} S_b$ as in
Proposition \ref{limits-proposition-approximate}, i.e., with $X_a$ and $S_b$
of finite type over $\mathbf{Z}$ and with affine transition morphisms.

\medskip\noindent
Fix $b \in B$.
By Proposition \ref{limits-proposition-characterize-locally-finite-presentation}
...
$$
\begin{array}{cc}X \downarrow\longrightarrow & S \downarrow \\ X_a \longrightarrow & S_b\end{array}
$$
...
\begin{lemma}[Relative approximation]
\label{limits-lemma-relative-approximation}
\source{stacks:09MV}
\href{https://stacks.math.columbia.edu/tag/09MV}{\texttt{Stacks tag 09MV}}
\group{limits}
...
\begin{lemma}[Integral limit finite and finite presentation]
\label{limits-lemma-integral-limit-finite-and-finite-presentation}
\source{stacks:09YZ}
\href{https://stacks.math.columbia.edu/tag/09YZ}{\texttt{Stacks tag 09YZ}}
\group{limits}
...
\begin{definition}[Situation: Descent property]
\label{limits-situation-descent-property}
\source{stacks:081D}
\href{https://stacks.math.columbia.edu/tag/081D}{\texttt{Stacks tag 081D}}
\group{limits}
...
\begin{lemma}[Descend affine finite presentation]
\label{limits-lemma-descend-affine-finite-presentation}
\source{stacks:01ZN}
\href{https://stacks.math.columbia.edu/tag/01ZN}{\texttt{Stacks tag 01ZN}}
\group{limits}

\uses{limits-situation-descent-property}
...
\begin{proof}
\uses{limits-lemma-directed-inverse-system-has-limit, limits-lemma-limit-affine}
...
\begin{lemma}[Descend finite finite presentation]
\label{limits-lemma-descend-finite-finite-presentation}
\source{stacks:01ZO}
\href{https://stacks.math.columbia.edu/tag/01ZO}{\texttt{Stacks tag 01ZO}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-descend-affine-finite-presentation}
...
\begin{lemma}[Descend unramified]
\label{limits-lemma-descend-unramified}
\source{stacks:0C4W}
\href{https://stacks.math.columbia.edu/tag/0C4W}{\texttt{Stacks tag 0C4W}}
\group{limits}
...
\begin{lemma}[Descend closed immersion finite presentation]
\label{limits-lemma-descend-closed-immersion-finite-presentation}
\source{stacks:01ZP}
\href{https://stacks.math.columbia.edu/tag/01ZP}{\texttt{Stacks tag 01ZP}}
\group{limits}
...
\begin{lemma}[Descend separated finite presentation]
\label{limits-lemma-descend-separated-finite-presentation}
\source{stacks:01ZQ}
\href{https://stacks.math.columbia.edu/tag/01ZQ}{\texttt{Stacks tag 01ZQ}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-descend-closed-immersion-finite-presentation}

Apply Lemma \ref{limits-lemma-descend-closed-immersion-finite-presentation}
...
\begin{lemma}[Descend flat finite presentation]
\label{limits-lemma-descend-flat-finite-presentation}
\source{stacks:04AI}
\href{https://stacks.math.columbia.edu/tag/04AI}{\texttt{Stacks tag 04AI}}
\group{limits}
...
\begin{lemma}[Descend finite locally free]
\label{limits-lemma-descend-finite-locally-free}
\source{stacks:06AC}
\href{https://stacks.math.columbia.edu/tag/06AC}{\texttt{Stacks tag 06AC}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-descend-flat-finite-presentation, limits-lemma-descend-finite-finite-presentation, limits-lemma-limit-contained-in-constructible}

By
Lemmas \ref{limits-lemma-descend-flat-finite-presentation} and
...
\begin{lemma}[Descend smooth]
\label{limits-lemma-descend-smooth}
\source{stacks:0C0C}
\href{https://stacks.math.columbia.edu/tag/0C0C}{\texttt{Stacks tag 0C0C}}
\group{limits}
...
\begin{lemma}[Descend etale]
\label{limits-lemma-descend-etale}
\source{stacks:07RP}
\href{https://stacks.math.columbia.edu/tag/07RP}{\texttt{Stacks tag 07RP}}
\group{limits}
...
\begin{lemma}[Descend isomorphism]
\label{limits-lemma-descend-isomorphism}
\source{stacks:081E}
\href{https://stacks.math.columbia.edu/tag/081E}{\texttt{Stacks tag 081E}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-descend-etale, limits-lemma-descend-closed-immersion-finite-presentation, limits-lemma-limit-contained-in-constructible}
...
Thus by Lemma \ref{limits-lemma-limit-contained-in-constructible}
we find that $Y_{i'}$ maps into $f_i(X_i)$ for some $i' \geq i$.
It follows that $X_{i'} \to Y_{i'}$ is surjective and we win.
\end{proof}

\begin{lemma}[Descend open immersion]
\label{limits-lemma-descend-open-immersion}
\source{stacks:0EUU}
\href{https://stacks.math.columbia.edu/tag/0EUU}{\texttt{Stacks tag 0EUU}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-descend-etale, limits-lemma-descend-isomorphism}

By Lemma \ref{limits-lemma-descend-etale} we can find an $i$ such that $f_i$
...
Lemma \ref{limits-lemma-descend-isomorphism} we see that
$X_{i'} \to V_{i'}$ is an isomorphism
for some $i' \geq i$ as desired.
\end{proof}

\begin{lemma}[Descend immersion]
\label{limits-lemma-descend-immersion}
\source{stacks:0GTB}
\href{https://stacks.math.columbia.edu/tag/0GTB}{\texttt{Stacks tag 0GTB}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-descend-opens, limits-lemma-descend-closed-immersion-finite-presentation}
...
of $Y$. By Lemma \ref{limits-lemma-descend-opens} after increasing $0$
...
\begin{lemma}[Descend monomorphism]
\label{limits-lemma-descend-monomorphism}
\source{stacks:07RQ}
\href{https://stacks.math.columbia.edu/tag/07RQ}{\texttt{Stacks tag 07RQ}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-descend-isomorphism}
...
\begin{lemma}[Descend surjective]
\label{limits-lemma-descend-surjective}
\source{stacks:07RR}
\href{https://stacks.math.columbia.edu/tag/07RR}{\texttt{Stacks tag 07RR}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-limit-contained-in-constructible}
...
\begin{lemma}[Descend syntomic]
\label{limits-lemma-descend-syntomic}
\source{stacks:0C3L}
\href{https://stacks.math.columbia.edu/tag/0C3L}{\texttt{Stacks tag 0C3L}}
\group{limits}
...
\begin{lemma}[Locally finite type in finite presentation]
\label{limits-lemma-locally-finite-type-in-finite-presentation}
\source{stacks:01ZE}
\href{https://stacks.math.columbia.edu/tag/01ZE}{\texttt{Stacks tag 01ZE}}
\group{limits}
...
\begin{proof}
\uses{limits-proposition-approximate, limits-lemma-descend-opens, limits-lemma-limit-affine, limits-lemma-descend-section}
...
$$
\begin{array}{ccc}X \longrightarrow\searrow & X_{i, S} \longrightarrow\downarrow & X_i \downarrow \\  & S \longrightarrow & \Spec(\mathbf{Z})\end{array}
$$
...
By Lemma \ref{limits-lemma-descend-section} we can choose $i$ so large that each
...
\begin{remark}[Cannot do better]
\label{limits-remark-cannot-do-better}
\source{stacks:01ZF}
\href{https://stacks.math.columbia.edu/tag/01ZF}{\texttt{Stacks tag 01ZF}}
\group{limits}
...
\begin{lemma}[Finite type closed in finite presentation]
\label{limits-lemma-finite-type-closed-in-finite-presentation}
\source{stacks:01ZG}
\href{https://stacks.math.columbia.edu/tag/01ZG}{\texttt{Stacks tag 01ZG}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-locally-finite-type-in-finite-presentation}

By Lemma \ref{limits-lemma-locally-finite-type-in-finite-presentation} above
...
\begin{lemma}[Closed is limit closed and finite presentation]
\label{limits-lemma-closed-is-limit-closed-and-finite-presentation}
\source{stacks:09ZP}
\href{https://stacks.math.columbia.edu/tag/09ZP}{\texttt{Stacks tag 09ZP}}
\group{limits}
...
\begin{lemma}[Finite type is limit finite presentation]
\label{limits-lemma-finite-type-is-limit-finite-presentation}
\source{stacks:09ZQ}
\href{https://stacks.math.columbia.edu/tag/09ZQ}{\texttt{Stacks tag 09ZQ}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-finite-type-closed-in-finite-presentation, limits-lemma-closed-is-limit-closed-and-finite-presentation}

By Lemma \ref{limits-lemma-finite-type-closed-in-finite-presentation}
...
Lemma \ref{limits-lemma-closed-is-limit-closed-and-finite-presentation}.
The morphisms $X_i \to S$ are of finite presentation by
Morphisms, Lemma \ref{morphisms-lemma-composition-finite-presentation}.
\end{proof}

\begin{proposition}[Separated closed in finite presentation]
\label{limits-proposition-separated-closed-in-finite-presentation}
\source{stacks:01ZJ}
\href{https://stacks.math.columbia.edu/tag/01ZJ}{\texttt{Stacks tag 01ZJ}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-finite-type-is-limit-finite-presentation, limits-lemma-eventually-separated}

Apply Lemma \ref{limits-lemma-finite-type-is-limit-finite-presentation}
and note that $X_i \to S$ is separated for
large $i$ by Lemma \ref{limits-lemma-eventually-separated} as we have
assumed that $X \to S$ is separated.
\end{proof}

\begin{lemma}[Finite closed in finite finite presentation]
\label{limits-lemma-finite-closed-in-finite-finite-presentation}
\source{stacks:01ZK}
\href{https://stacks.math.columbia.edu/tag/01ZK}{\texttt{Stacks tag 01ZK}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-finite-type-is-limit-finite-presentation, limits-lemma-eventually-finite}

We may write $X = \lim X_i$ as in
Lemma \ref{limits-lemma-finite-type-is-limit-finite-presentation}.
Applying Lemma \ref{limits-lemma-eventually-finite} we see that $X_i \to S$
is finite for large enough $i$.
\end{proof}

\begin{lemma}[Finite in finite and finite presentation]
\label{limits-lemma-finite-in-finite-and-finite-presentation}
\source{stacks:09YY}
\href{https://stacks.math.columbia.edu/tag/09YY}{\texttt{Stacks tag 09YY}}
\group{limits}
...
\begin{lemma}[Descend finite presentation]
\label{limits-lemma-descend-finite-presentation}
\source{stacks:01ZM}
\href{https://stacks.math.columbia.edu/tag/01ZM}{\texttt{Stacks tag 01ZM}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-scheme-over-limit, limits-lemma-descend-opens, limits-lemma-limit-affine}
...
\begin{lemma}[Descend modules finite presentation]
\label{limits-lemma-descend-modules-finite-presentation}
\source{stacks:01ZR}
\href{https://stacks.math.columbia.edu/tag/01ZR}{\texttt{Stacks tag 01ZR}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-descend-finite-presentation}
...
\end{enumerate}
Having said this, we can use Lemma \ref{limits-lemma-descend-finite-presentation}
...
\begin{lemma}[Descend invertible modules]
\label{limits-lemma-descend-invertible-modules}
\source{stacks:0B8W}
\href{https://stacks.math.columbia.edu/tag/0B8W}{\texttt{Stacks tag 0B8W}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-descend-modules-finite-presentation}
...
Lemma \ref{limits-lemma-descend-modules-finite-presentation}.
...
Hence by Lemma \ref{limits-lemma-descend-modules-finite-presentation}
...
\begin{lemma}[Descend module flat finite presentation]
\label{limits-lemma-descend-module-flat-finite-presentation}
\source{stacks:05LY}
\href{https://stacks.math.columbia.edu/tag/05LY}{\texttt{Stacks tag 05LY}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-descend-flat-finite-presentation, limits-lemma-directed-inverse-system-has-limit}

(This lemma is the analogue of
Lemma \ref{limits-lemma-descend-flat-finite-presentation}
for modules.)
...
\begin{lemma}[Descend finite presentation variant]
\label{limits-lemma-descend-finite-presentation-variant}
\source{stacks:0EY1}
\href{https://stacks.math.columbia.edu/tag/0EY1}{\texttt{Stacks tag 0EY1}}
\group{limits}
...
between this lemma and Lemma \ref{limits-lemma-descend-finite-presentation}.

\begin{proof}
\uses{limits-lemma-descend-opens, limits-lemma-descend-finite-presentation, limits-lemma-limit-fibre-product-empty}
...
Lemma \ref{limits-lemma-descend-opens}.
By Lemma \ref{limits-lemma-descend-finite-presentation}
...
$W_{i, j} \cap W_{i, j'}$
we can apply Lemma \ref{limits-lemma-limit-fibre-product-empty}
...
\begin{lemma}[A scheme, admitting a finite surjective map from an affine scheme, is affine.]
\label{limits-lemma-affine}
\source{stacks:01ZT}
\href{https://stacks.math.columbia.edu/tag/01ZT}{\texttt{Stacks tag 01ZT}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-finite-in-finite-and-finite-presentation, limits-lemma-limit-affine, limits-proposition-approximate, limits-lemma-descend-finite-presentation, limits-lemma-descend-finite-finite-presentation}
...
\medskip\noindent
By Lemma \ref{limits-lemma-finite-in-finite-and-finite-presentation}
we can write $X = \lim_a X_a$ with $X_a \to S$ finite and of finite
presentation. By Lemma \ref{limits-lemma-limit-affine} we see that $X_a$
is affine for some $a \in A$. Replacing $X$ by $X_a$ we may assume
that $X \to S$ is surjective, finite, of finite presentation and
that $X$ is affine.

\medskip\noindent
By Proposition \ref{limits-proposition-approximate} we may write
$S = \lim_{i \in I} S_i$ as
a directed limits of schemes of finite type over $\mathbf{Z}$.
By Lemma \ref{limits-lemma-descend-finite-presentation} we can
...
Lemma \ref{limits-lemma-descend-finite-finite-presentation} we may
assume that $X_i \to S_i$ is finite for all $i \in I$ as well.
By Lemma \ref{limits-lemma-limit-affine} once again we may assume that $X_i$ is
affine for all $i \in I$. Hence the result follows from the
Noetherian case, see Cohomology of Schemes,
Lemma \ref{coherent-lemma-image-affine-finite-morphism-affine-Noetherian}.
\end{proof}

\begin{proposition}[A scheme admitting a surjective integral map from an affine scheme is affine.]
\label{limits-proposition-affine}
\source{stacks:05YU}
\href{https://stacks.math.columbia.edu/tag/05YU}{\texttt{Stacks tag 05YU}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-integral-limit-finite-and-finite-presentation, limits-lemma-limit-affine, limits-lemma-affine}
...
\medskip\noindent
By Lemma \ref{limits-lemma-integral-limit-finite-and-finite-presentation}
we can write $X = \lim_i X_i$ with $X_i \to S$ finite. By
Lemma \ref{limits-lemma-limit-affine}
...
Lemma \ref{limits-lemma-affine}.
\end{proof}

\begin{lemma}[Affines glued in closed affine]
\label{limits-lemma-affines-glued-in-closed-affine}
\source{stacks:09NL}
\href{https://stacks.math.columbia.edu/tag/09NL}{\texttt{Stacks tag 09NL}}
\group{limits}
...
\begin{proof}
\uses{limits-proposition-affine}
...
\source{stacks:09MW}
\href{https://stacks.math.columbia.edu/tag/09MW}{\texttt{Stacks tag 09MW}}
\group{limits}
...
\begin{proof}
\uses{limits-proposition-approximate, limits-lemma-descend-modules-finite-presentation, limits-lemma-limit-ample, limits-lemma-limit-contained-in-constructible}
...
\medskip\noindent
By Proposition \ref{limits-proposition-approximate} we can write
...
$\mathcal{L}$, see Lemma \ref{limits-lemma-descend-modules-finite-presentation}.
...
By Lemma \ref{limits-lemma-limit-ample} we see that $\mathcal{L}_i|_{Z_i}$
...
\source{stacks:0B7L}
\href{https://stacks.math.columbia.edu/tag/0B7L}{\texttt{Stacks tag 0B7L}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-ample-on-reduction}
...
Lemma \ref{limits-lemma-ample-on-reduction}, hence
...
\begin{lemma}[Ample profinite set in principal affine]
\label{limits-lemma-ample-profinite-set-in-principal-affine}
\source{stacks:0E21}
\href{https://stacks.math.columbia.edu/tag/0E21}{\texttt{Stacks tag 0E21}}
\group{limits}
...
\begin{proof}
\uses{limits-proposition-approximate, limits-lemma-limit-ample, limits-lemma-descend-invertible-modules, limits-lemma-descend-opens, limits-proposition-characterize-locally-finite-presentation}
...
By Proposition \ref{limits-proposition-approximate} we can
...
Lemmas \ref{limits-lemma-limit-ample}, \ref{limits-lemma-descend-invertible-modules}, and
...
\source{stacks:0202}
\href{https://stacks.math.columbia.edu/tag/0202}{\texttt{Stacks tag 0202}}
\group{limits}
...
\begin{proof}
\uses{limits-proposition-separated-closed-in-finite-presentation, limits-proposition-approximate, limits-lemma-descend-finite-presentation, limits-lemma-descend-separated-finite-presentation}

By Proposition \ref{limits-proposition-separated-closed-in-finite-presentation}
...
Proposition \ref{limits-proposition-approximate}. By
Lemma \ref{limits-lemma-descend-finite-presentation} we can
find an index $i \in I$ and a scheme $X_i \to S_i$ of finite presentation
so that $X = S \times_{S_i} X_i$.
By Lemma \ref{limits-lemma-descend-separated-finite-presentation}
...
\begin{remark}[Chow finite type]
\label{limits-remark-chow-finite-type}
\source{stacks:0GII}
\href{https://stacks.math.columbia.edu/tag/0GII}{\texttt{Stacks tag 0GII}}
\group{limits}

\uses{limits-lemma-chow-finite-type, limits-lemma-closed-is-limit-closed-and-finite-presentation, limits-lemma-finite-type-eventually-closed}
In the situation of Chow's Lemma \ref{limits-lemma-chow-finite-type}:
\begin{enumerate}
...
from the proof of Lemma \ref{limits-lemma-chow-finite-type} but we can also prove
this directly as follows. By (1) we have a closed immersion
$X' \to \mathbf{P}^n_X$. By
Lemma \ref{limits-lemma-closed-is-limit-closed-and-finite-presentation} we can write
...
Lemma \ref{limits-lemma-finite-type-eventually-closed}. Replacing
...
\begin{lemma}[Chow EGA]
\label{limits-lemma-chow-EGA}
\source{stacks:0203}
\href{https://stacks.math.columbia.edu/tag/0203}{\texttt{Stacks tag 0203}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-chow-finite-type, limits-proposition-separated-closed-in-finite-presentation, limits-proposition-approximate, limits-lemma-descend-finite-presentation, limits-lemma-descend-separated-finite-presentation, limits-lemma-scheme-over-limit, limits-lemma-topology-limit}
...
the proof of Lemma \ref{limits-lemma-chow-finite-type} above.
...
$$
\begin{array}{cccc}\eta_j \in Z_j \longrightarrow & X \longrightarrow\searrow & Y \longrightarrow\downarrow & Y_i \downarrow \\  &  & S \longrightarrow & S_i\end{array}
$$
...
Lemma \ref{limits-lemma-scheme-over-limit}.
...
$$
\begin{array}{ccc}Y' \searrow & Y^* \downarrow\overset{\pi}{\longleftarrow}\longrightarrow & \mathbf{P}^n_{S_i} \swarrow \\  & S_i & \end{array}
$$
...
$$
\begin{array}{cccc}X' \xlongequal{} & X \times_{Y'} Y^* \longrightarrow\downarrow & Y^* \longrightarrow\downarrow & \mathbf{P}^n_{S_i} \swarrow \\  & X \longrightarrow\downarrow & Y' \downarrow &  \\  & S \longrightarrow & S_i & \end{array}
$$
...
\begin{lemma}[If the base change of a scheme to a limit is proper, then already the base change is pr...]
\label{limits-lemma-eventually-proper}
\source{stacks:081F}
\href{https://stacks.math.columbia.edu/tag/081F}{\texttt{Stacks tag 081F}}
\group{limits}


\uses{limits-situation-descent-property}
Assumptions and notation as in Situation \ref{limits-situation-descent-property}.
If
\begin{enumerate}
...
\begin{proof}
\uses{limits-lemma-descend-separated-finite-presentation, limits-lemma-chow-finite-type, limits-lemma-descend-closed-immersion-finite-presentation}

By Lemma \ref{limits-lemma-descend-separated-finite-presentation} we see that
...
Schemes, Lemma \ref{schemes-lemma-quasi-compact-permanence}.
By Lemma \ref{limits-lemma-chow-finite-type} we can choose a diagram
$$
\begin{array}{ccc}X_0 \searrow & X_0' \downarrow\overset{\pi}{\longleftarrow}\longrightarrow & \mathbf{P}^n_{Y_0} \swarrow \\  & Y_0 & \end{array}
$$
...
By Lemma \ref{limits-lemma-descend-closed-immersion-finite-presentation}
we find that $X'_i \to \mathbf{P}^n_{Y_i}$ is
a closed immersion for $i$ large enough. Then $X'_i \to Y_i$
is proper and we win.
\end{proof}

\begin{lemma}[Proper limit of proper finite presentation]
\label{limits-lemma-proper-limit-of-proper-finite-presentation}
\source{stacks:09ZR}
\href{https://stacks.math.columbia.edu/tag/09ZR}{\texttt{Stacks tag 09ZR}}
\group{limits}
...
\begin{proof}
\uses{limits-proposition-separated-closed-in-finite-presentation, limits-lemma-chow-finite-type, limits-lemma-closed-is-limit-closed-and-finite-presentation, limits-lemma-eventually-closed-immersion}

By Proposition \ref{limits-proposition-separated-closed-in-finite-presentation}
we can find a closed immersion $X \to Y$ with $Y$ separated and of
finite presentation over $S$. By Lemma \ref{limits-lemma-chow-finite-type}
we can find a diagram
$$
\begin{array}{ccc}Y \searrow & Y' \downarrow\overset{\pi}{\longleftarrow}\longrightarrow & \mathbf{P}^n_S \swarrow \\  & S & \end{array}
$$
...
Lemma \ref{limits-lemma-eventually-closed-immersion}.
Thus $X'_i$ is proper over $S$.
For such $i$ the morphism $X_i \to S$ is proper by
Morphisms, Lemma \ref{morphisms-lemma-image-proper-is-proper}.
\end{proof}

\begin{lemma}[Proper limit of proper finite presentation noetherian]
\label{limits-lemma-proper-limit-of-proper-finite-presentation-noetherian}
\source{stacks:0A0P}
\href{https://stacks.math.columbia.edu/tag/0A0P}{\texttt{Stacks tag 0A0P}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-proper-limit-of-proper-finite-presentation, limits-proposition-approximate, limits-lemma-descend-finite-presentation, limits-lemma-eventually-proper}

By Lemma \ref{limits-lemma-proper-limit-of-proper-finite-presentation}
we can write $X = \lim_{k \in K} X_k$ with $X_k \to S$ proper and
of finite presentation. Next, by absolute Noetherian approximation
(Proposition \ref{limits-proposition-approximate}) we can
...
Lemma \ref{limits-lemma-eventually-proper}. The set $I$ will be consist
...
\begin{lemma}[Finite type eventually proper]
\label{limits-lemma-finite-type-eventually-proper}
\source{stacks:0EX1}
\href{https://stacks.math.columbia.edu/tag/0EX1}{\texttt{Stacks tag 0EX1}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-proper-limit-of-proper-finite-presentation, limits-lemma-descend-finite-presentation, limits-lemma-eventually-proper, limits-lemma-finite-type-eventually-closed}

Choose a closed immersion $Y \to Y'$ with $Y'$ proper and of finite
presentation over $X$, see
Lemma \ref{limits-lemma-proper-limit-of-proper-finite-presentation}.
...
\ref{limits-lemma-eventually-proper}. Then after replacing $i$
by a larger index we have that $Y \to Y'_i$ is a closed
immersion, see Lemma \ref{limits-lemma-finite-type-eventually-closed}.
\end{proof}
...
\begin{lemma}[Eventually proper support]
\label{limits-lemma-eventually-proper-support}
\source{stacks:081G}
\href{https://stacks.math.columbia.edu/tag/081G}{\texttt{Stacks tag 081G}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-eventually-proper}
...
Morphisms, Lemma \ref{morphisms-lemma-image-proper-is-proper}.
By Lemma \ref{limits-lemma-eventually-proper} we see that $X_i \to Y$ is proper
...
\begin{lemma}[Separate]
\label{limits-lemma-separate}
\source{stacks:05BD}
\href{https://stacks.math.columbia.edu/tag/05BD}{\texttt{Stacks tag 05BD}}
\group{limits}
...
\begin{lemma}[Test universally closed]
\label{limits-lemma-test-universally-closed}
\source{stacks:05JX}
\href{https://stacks.math.columbia.edu/tag/05JX}{\texttt{Stacks tag 05JX}}
\group{limits}
...
Lemma \ref{limits-lemma-separate}.
...
$$
\begin{array}{cc}X_T \underset{f_T}{\downarrow}\longrightarrow & \mathbf{A}^n \times X \overset{f_n}{\downarrow} \\ T \longrightarrow & \mathbf{A}^n \times S\end{array}
$$
...
\begin{lemma}[Limited base change]
\label{limits-lemma-limited-base-change}
\source{stacks:0205}
\href{https://stacks.math.columbia.edu/tag/0205}{\texttt{Stacks tag 0205}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-test-universally-closed}
[First proof]
...
lemma is a special case of Lemma \ref{limits-lemma-test-universally-closed}.
\end{proof}

\begin{proof}
\uses{limits-lemma-chow-finite-type}
[Second proof]
...
We can apply Chow's Lemma \ref{limits-lemma-chow-finite-type}
...
\begin{array}{cc}X' \longrightarrow\underset{\pi}{\downarrow} & \mathbf{P}^n_S \downarrow \\ X \overset{f}{\longrightarrow} & S\end{array}
\end{equation}
...
\begin{lemma}[Reach point closure Noetherian]
\label{limits-lemma-reach-point-closure-Noetherian}
\source{stacks:0CM2}
\href{https://stacks.math.columbia.edu/tag/0CM2}{\texttt{Stacks tag 0CM2}}
\group{limits}
...
$$
\begin{array}{cc}\Spec(K) \longrightarrow\downarrow & X \overset{f}{\downarrow} \\ \Spec(A) \longrightarrow & Y\end{array}
$$
...
$$
\begin{array}{cccc}\Spec(\kappa(x)) \downarrow\longrightarrow &  &  & X \downarrow \\ \Spec(A) \longrightarrow & \Spec(R) \longrightarrow & \Spec(\mathcal{O}_{Y, y}) \longrightarrow & Y\end{array}
$$
...
\begin{lemma}[Noetherian dvr valuative separation]
\label{limits-lemma-Noetherian-dvr-valuative-separation}
\source{stacks:0207}
\href{https://stacks.math.columbia.edu/tag/0207}{\texttt{Stacks tag 0207}}
\group{limits}
...
\begin{array}{cc}\Spec(K) \longrightarrow\downarrow & X_\alpha \downarrow \\ \Spec(A) \longrightarrow\nearrow & S_\alpha\end{array}
\end{equation}
...
\begin{array}{cc}\Spec(K) \longrightarrow\downarrow & X_0 \overset{\Delta}{\downarrow} \\ \Spec(A) \longrightarrow\nearrow & X_0 \times_S X_0 \\  & \end{array}
\end{equation}
...
\begin{array}{cc}\Spec(K) \longrightarrow\downarrow & X_0 \downarrow \\ \Spec(A) \longrightarrow\nearrow & S \\  & \end{array}
\end{equation}
...
\begin{lemma}[Noetherian dvr valuative proper]
\label{limits-lemma-Noetherian-dvr-valuative-proper}
\source{stacks:0208}
\href{https://stacks.math.columbia.edu/tag/0208}{\texttt{Stacks tag 0208}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-Noetherian-dvr-valuative-separation, limits-lemma-limited-base-change}

(1) implies (2) implies (3) implies (4).  We will now show (4) implies
(1).  As in the proof of Lemma \ref{limits-lemma-Noetherian-dvr-valuative-separation},
...
\ref{limits-lemma-limited-base-change}, it is enough to check that
$X' \to \mathbf{P}^n_S$ is a closed immersion.
...
\begin{array}{ccc}\Spec K \longrightarrow\downarrow & X' \longrightarrow\downarrow & \mathbf{P}^n_S \downarrow \\ \Spec A \dashrightarrow\nearrow\nearrow & X \longrightarrow & S \\  &  & \end{array}
\end{equation}
...
\begin{lemma}[Check universally closed Noetherian]
\label{limits-lemma-check-universally-closed-Noetherian}
\source{stacks:05JY}
\href{https://stacks.math.columbia.edu/tag/05JY}{\texttt{Stacks tag 05JY}}
\group{limits}
...
Lemma \ref{limits-lemma-test-universally-closed}.
...
$$
\begin{array}{ccc}\Spec(\kappa(y)) \longrightarrow\downarrow & \mathbf{A}^n \times X \downarrow\longrightarrow & X \downarrow \\ \Spec(A) \longrightarrow & \mathbf{A}^n \times S \longrightarrow & S\end{array}
$$
...
Lemmas \ref{limits-lemma-Noetherian-dvr-valuative-separation} and
\ref{limits-lemma-Noetherian-dvr-valuative-proper}. Here is another variant.

\begin{lemma}[Refined valuative criterion proper]
\label{limits-lemma-refined-valuative-criterion-proper}
\source{stacks:0CM3}
\href{https://stacks.math.columbia.edu/tag/0CM3}{\texttt{Stacks tag 0CM3}}
\group{limits}
...
$$
\begin{array}{ccc}\Spec(K) \longrightarrow\downarrow & U \overset{h}{\longrightarrow} & X \overset{f}{\downarrow} \\ \Spec(A) \longrightarrow\nearrow &  & S\end{array}
$$
...
\begin{proof}
\uses{limits-lemma-Noetherian-dvr-valuative-proper}
...
part (4) of Lemma \ref{limits-lemma-Noetherian-dvr-valuative-proper}.
To do this consider a diagram
$$
\begin{array}{cc}\Spec(K) \underset{y}{\longrightarrow}\downarrow & Y \overset{f \circ g}{\downarrow} \\ \Spec(A) \longrightarrow\nearrow & S\end{array}
$$
...
$$
\begin{array}{ccc}\Spec(K) \underset{y}{\longrightarrow}\downarrow & U \longrightarrow & X \overset{f}{\downarrow} \\ \Spec(A) \longrightarrow\overset{a}{\nearrow} &  & S\end{array}
$$
...
$$
\begin{array}{cc}\Spec(K) \underset{y}{\longrightarrow}\downarrow & Y \overset{g}{\downarrow} \\ \Spec(A) \overset{a}{\longrightarrow}\overset{b}{\nearrow} & X\end{array}
$$
is commutative. This finishes the proof since
$b$ can serve as the dotted arrow above.
\end{proof}

\begin{lemma}[Refined valuative criterion separated]
\label{limits-lemma-refined-valuative-criterion-separated}
\source{stacks:0CM4}
\href{https://stacks.math.columbia.edu/tag/0CM4}{\texttt{Stacks tag 0CM4}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-refined-valuative-criterion-proper}

We will apply Lemma \ref{limits-lemma-refined-valuative-criterion-proper}
...
$$
\begin{array}{ccc}\Spec(K) \longrightarrow\downarrow & U \overset{h}{\longrightarrow} & X \overset{\Delta}{\downarrow} \\ \Spec(A) \overset{(a, b)}{\longrightarrow}\nearrow &  & X \times_S X\end{array}
$$
...
\source{stacks:0CM5}
\href{https://stacks.math.columbia.edu/tag/0CM5}{\texttt{Stacks tag 0CM5}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-refined-valuative-criterion-separated, limits-lemma-refined-valuative-criterion-proper}

Combine Lemmas \ref{limits-lemma-refined-valuative-criterion-separated} and
\ref{limits-lemma-refined-valuative-criterion-proper}.
\end{proof}

\section{Valuative criteria over a Nagata base}
...
\begin{lemma}[Essentially finite type criterion universally closed]
\label{limits-lemma-essentially-finite-type-criterion-universally-closed}
\source{stacks:0GWV}
\href{https://stacks.math.columbia.edu/tag/0GWV}{\texttt{Stacks tag 0GWV}}
\group{limits}

\uses{limits-lemma-morphism-glueing-near-closed-point}
...
$$
\begin{array}{cc}U \longrightarrow\downarrow & X \overset{f}{\downarrow} \\ C \longrightarrow\nearrow & Y\end{array}
$$
...
$$
\begin{array}{cc}\Spec(K) \longrightarrow\downarrow & X \overset{f}{\downarrow} \\ \Spec(A) \longrightarrow\nearrow & Y\end{array}
$$
where $K = \text{Frac}(A)$ some dotted arrow exists\footnote{By
Lemma \ref{limits-lemma-morphism-glueing-near-closed-point} this is
...
\begin{proof}
\uses{limits-lemma-check-universally-closed-Noetherian}

We have seen the equivalence of (1) and (2) and the
fact that these imply (3) in
Lemma \ref{limits-lemma-check-universally-closed-Noetherian}.
...
\begin{lemma}[Essentially finite type criterion separation]
\label{limits-lemma-essentially-finite-type-criterion-separation}
\source{stacks:0GWW}
\href{https://stacks.math.columbia.edu/tag/0GWW}{\texttt{Stacks tag 0GWW}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-Noetherian-dvr-valuative-separation, limits-lemma-essentially-finite-type-criterion-universally-closed, limits-lemma-morphism-glueing-near-closed-point}

By Lemma \ref{limits-lemma-Noetherian-dvr-valuative-separation} we see that
...
By Lemma \ref{limits-lemma-essentially-finite-type-criterion-universally-closed}
it suffices to show: for any commutative diagram
$$
\begin{array}{ccc}U \longrightarrow\downarrow &  & X \overset{\Delta}{\downarrow} \\ C \overset{(a_1, a_2)}{\longrightarrow}\nearrow &  & X \times_Y X\end{array}
$$
of schemes over $S$ such that
\begin{enumerate}
\item $C$ is a normal integral scheme of finite type over $S$,
...
then in the commutative diagram
$$
\begin{array}{cc}\Spec(K) \longrightarrow\downarrow & X \overset{\Delta}{\downarrow} \\ \Spec(A) \longrightarrow\nearrow & X \times_Y X\end{array}
$$
where $K = \text{Frac}(A)$ there exists some dotted arrow
making the diagram commute. By
Lemma \ref{limits-lemma-morphism-glueing-near-closed-point}
...
\begin{lemma}[Essentially finite type criterion proper]
\label{limits-lemma-essentially-finite-type-criterion-proper}
\source{stacks:0GWX}
\href{https://stacks.math.columbia.edu/tag/0GWX}{\texttt{Stacks tag 0GWX}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-essentially-finite-type-criterion-universally-closed, limits-lemma-essentially-finite-type-criterion-separation}

This is formal from Lemmas
\ref{limits-lemma-essentially-finite-type-criterion-universally-closed} and
...
\begin{lemma}[Limit dimension]
\label{limits-lemma-limit-dimension}
\source{stacks:05M5}
\href{https://stacks.math.columbia.edu/tag/05M5}{\texttt{Stacks tag 05M5}}
\group{limits}
...
\begin{lemma}[Descend quasi finite]
\label{limits-lemma-descend-quasi-finite}
\source{stacks:094M}
\href{https://stacks.math.columbia.edu/tag/094M}{\texttt{Stacks tag 094M}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-limit-dimension}

Follows immediately from Lemma \ref{limits-lemma-limit-dimension}.
\end{proof}

\begin{lemma}[Eventually relative dimension]
\label{limits-lemma-eventually-relative-dimension}
\source{stacks:0H3V}
\href{https://stacks.math.columbia.edu/tag/0H3V}{\texttt{Stacks tag 0H3V}}
\group{limits}
...
\begin{lemma}[Descend dimension d]
\label{limits-lemma-descend-dimension-d}
\source{stacks:0EY2}
\href{https://stacks.math.columbia.edu/tag/0EY2}{\texttt{Stacks tag 0EY2}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-limit-dimension, limits-lemma-limit-contained-in-constructible}

By Lemma \ref{limits-lemma-limit-dimension} we may assume all fibres
...
(Lemma \ref{limits-lemma-limit-contained-in-constructible}). Then all fibres
of $X_i \to Y_i$ have dimension $d$ by the aforementioned
Morphisms, Lemma \ref{morphisms-lemma-dimension-fibre-after-base-change}.
\end{proof}

\begin{lemma}[Approximate given relative dimension]
\label{limits-lemma-approximate-given-relative-dimension}
\source{stacks:05M6}
\href{https://stacks.math.columbia.edu/tag/05M6}{\texttt{Stacks tag 05M6}}
\group{limits}
...
\begin{proof}
\uses{limits-proposition-approximate, limits-lemma-descend-finite-presentation, limits-lemma-limit-dimension}
...
\begin{lemma}[Top cohomology functor]
\label{limits-lemma-top-cohomology-functor}
\source{stacks:0EX3}
\href{https://stacks.math.columbia.edu/tag/0EX3}{\texttt{Stacks tag 0EX3}}
\group{limits}
...
$$
\begin{array}{ccc}X'' \underset{f''}{\downarrow}\underset{h'}{\longrightarrow} & X' \underset{f'}{\downarrow}\underset{g'}{\longrightarrow} & X \overset{f}{\downarrow} \\ Y'' \overset{h}{\longrightarrow} & Y' \overset{g}{\longrightarrow} & Y\end{array}
$$
...
\source{stacks:0E7D}
\href{https://stacks.math.columbia.edu/tag/0E7D}{\texttt{Stacks tag 0E7D}}
\group{limits}

\uses{limits-lemma-top-cohomology-functor}
...
assumptions and conclusions of Lemma \ref{limits-lemma-top-cohomology-functor}.
\end{enumerate}
\end{lemma}

\begin{proof}
\uses{limits-lemma-proper-limit-of-proper-finite-presentation, limits-lemma-limit-dimension, limits-lemma-descend-finite-presentation, limits-lemma-eventually-proper}
...
see Lemma \ref{limits-lemma-limit-dimension}.
...
(Lemma \ref{limits-lemma-eventually-proper})
...
\begin{lemma}[Proper top cohomology finite type]
\label{limits-lemma-proper-top-cohomology-finite-type}
\source{stacks:0EX4}
\href{https://stacks.math.columbia.edu/tag/0EX4}{\texttt{Stacks tag 0EX4}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-proper-limit-of-proper-finite-presentation, limits-lemma-limit-dimension, limits-lemma-higher-direct-images-zero-above-dimension-fibre, limits-lemma-descend-finite-presentation, limits-lemma-eventually-proper, limits-lemma-descend-modules-finite-presentation, limits-lemma-top-cohomology-functor}
...
and transition morphisms are closed immersions.
For some $i$ we have that $X_i \to Y$ has fibres of dimension $\leq d$,
see Lemma \ref{limits-lemma-limit-dimension}. We have
$R^pf_*\mathcal{F} = R^pf_{i, *}(X \to X_i)_*\mathcal{F}$ by
Cohomology of Schemes, Lemma \ref{coherent-lemma-relative-affine-vanishing}
and Leray (Cohomology, Lemma \ref{cohomology-lemma-relative-Leray}).
Thus we may replace $X$ by $X_i$ and
...
Lemma \ref{limits-lemma-higher-direct-images-zero-above-dimension-fibre}
...
Lemma \ref{limits-lemma-descend-modules-finite-presentation}.
By Lemma \ref{limits-lemma-top-cohomology-functor}
we have
$$
...
\begin{lemma}[Proper top cohomology finite presentation]
\label{limits-lemma-proper-top-cohomology-finite-presentation}
\source{stacks:0EX5}
\href{https://stacks.math.columbia.edu/tag/0EX5}{\texttt{Stacks tag 0EX5}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-proper-top-cohomology-finite-type}

The proof is exactly the same as the proof of
Lemma \ref{limits-lemma-proper-top-cohomology-finite-type}
...
\begin{lemma}[Glueing near closed point]
\label{limits-lemma-glueing-near-closed-point}
\source{stacks:0BPA}
\href{https://stacks.math.columbia.edu/tag/0BPA}{\texttt{Stacks tag 0BPA}}
\group{limits}
...
\left\{
\vcenter{
\begin{array}{ccc}X' \downarrow & Y' \downarrow\longleftarrow\longrightarrow & Y \downarrow \\ U & V \longleftarrow\longrightarrow & \Spec(\mathcal{O}_{S, s})\end{array}
}
\right\}
$$
...
\begin{proof}
\uses{limits-lemma-descend-finite-presentation, limits-lemma-directed-inverse-system-has-limit}
...
\left\{
\vcenter{
\begin{array}{ccc}X' \downarrow & Y' \downarrow\longleftarrow\longrightarrow & Y \downarrow \\ U & W \setminus \{s\} \longleftarrow\longrightarrow & W\end{array}
}
\right\}
$$
...
\begin{lemma}[Glueing near closed point modules]
\label{limits-lemma-glueing-near-closed-point-modules}
\source{stacks:0F21}
\href{https://stacks.math.columbia.edu/tag/0F21}{\texttt{Stacks tag 0F21}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-glueing-near-closed-point, limits-lemma-descend-modules-finite-presentation}

You can either prove this by
redoing the proof of Lemma \ref{limits-lemma-glueing-near-closed-point}
using Lemma \ref{limits-lemma-descend-modules-finite-presentation}
or you can deduce it from Lemma \ref{limits-lemma-glueing-near-closed-point}
...
\begin{lemma}[Glueing near point]
\label{limits-lemma-glueing-near-point}
\source{stacks:0BQ5}
\href{https://stacks.math.columbia.edu/tag/0BQ5}{\texttt{Stacks tag 0BQ5}}
\group{limits}
...
\left\{
\vcenter{
\begin{array}{c}X \downarrow \\ U'\end{array}
}
\right\}
\longrightarrow
\left\{
...
\left\{
\vcenter{
\begin{array}{ccc}X' \downarrow & Y' \downarrow\longleftarrow\longrightarrow & Y \downarrow \\ U & W \cap U \longleftarrow\longrightarrow & W\end{array}
}
\right\}
$$
is an equivalence of categories. We have
...
\begin{lemma}[Glueing near point properties]
\label{limits-lemma-glueing-near-point-properties}
\source{stacks:0EY3}
\href{https://stacks.math.columbia.edu/tag/0EY3}{\texttt{Stacks tag 0EY3}}
\group{limits}

\uses{limits-lemma-glueing-near-point}
Notation and assumptions as in Lemma \ref{limits-lemma-glueing-near-point}.
...
\begin{proof}
\uses{limits-lemma-descend-separated-finite-presentation, limits-lemma-eventually-proper, limits-lemma-descend-finite-finite-presentation, limits-lemma-descend-etale}
...
Lemmas \ref{limits-lemma-descend-separated-finite-presentation},
...
\begin{lemma}[Glueing near multiple closed points]
\label{limits-lemma-glueing-near-multiple-closed-points}
\source{stacks:0E8Q}
\href{https://stacks.math.columbia.edu/tag/0E8Q}{\texttt{Stacks tag 0E8Q}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-glueing-near-closed-point}

For $n = 1$ this is Lemma \ref{limits-lemma-glueing-near-closed-point}.
...
By Lemma \ref{limits-lemma-glueing-near-closed-point} we can find
...
Using the results from Section \ref{limits-section-change-over-closed-points}
we can describe the category of modifications of
a scheme over a closed point in terms of the local ring.

\begin{lemma}[Modifications]
\label{limits-lemma-modifications}
\source{stacks:0B3X}
\href{https://stacks.math.columbia.edu/tag/0B3X}{\texttt{Stacks tag 0B3X}}
\group{limits}
...
This is a special case of Lemma \ref{limits-lemma-glueing-near-closed-point}.
\end{proof}

\begin{lemma}[Modifications properties]
\label{limits-lemma-modifications-properties}
\source{stacks:0BFN}
\href{https://stacks.math.columbia.edu/tag/0BFN}{\texttt{Stacks tag 0BFN}}
\group{limits}

\uses{limits-lemma-modifications}
Notation and assumptions as in Lemma \ref{limits-lemma-modifications}.
...
\begin{proof}
\uses{limits-lemma-glueing-near-point-properties, limits-lemma-descend-separated-finite-presentation, limits-lemma-eventually-proper, limits-lemma-descend-finite-finite-presentation, limits-lemma-descend-etale}
...
The converse follows from Lemma \ref{limits-lemma-glueing-near-point-properties}
...
\begin{remark}[More general modification]
\label{limits-remark-more-general-modification}
\source{stacks:0B3Y}
\href{https://stacks.math.columbia.edu/tag/0B3Y}{\texttt{Stacks tag 0B3Y}}
\group{limits}
...
\begin{definition}[Situation: Limit noetherian]
\label{limits-situation-limit-noetherian}
\source{stacks:0CNM}
\href{https://stacks.math.columbia.edu/tag/0CNM}{\texttt{Stacks tag 0CNM}}
\group{limits}
...
\begin{lemma}[Good diagram]
\label{limits-lemma-good-diagram}
\source{stacks:0CNN}
\href{https://stacks.math.columbia.edu/tag/0CNN}{\texttt{Stacks tag 0CNN}}
\group{limits}

\uses{limits-situation-limit-noetherian}
In Situation \ref{limits-situation-limit-noetherian}.
Let $X \to S$ be quasi-separated and of finite type.
Then there exists an $i \in I$ and a diagram
\begin{equation}
\label{equation-good-diagram}
\vcenter{
\begin{array}{cc}X \longrightarrow\downarrow & W \downarrow \\ S \longrightarrow & S_i\end{array}
}
\end{equation}
...
\begin{proof}
\uses{limits-lemma-finite-type-closed-in-finite-presentation, limits-lemma-descend-finite-presentation}
...
\begin{lemma}[Limit from good diagram]
\label{limits-lemma-limit-from-good-diagram}
\source{stacks:0CNQ}
\href{https://stacks.math.columbia.edu/tag/0CNQ}{\texttt{Stacks tag 0CNQ}}
\group{limits}
...
\begin{lemma}[Morphism good diagram]
\label{limits-lemma-morphism-good-diagram}
\source{stacks:0CNR}
\href{https://stacks.math.columbia.edu/tag/0CNR}{\texttt{Stacks tag 0CNR}}
\group{limits}

\uses{limits-situation-limit-noetherian, limits-lemma-limit-from-good-diagram}
In Situation \ref{limits-situation-limit-noetherian}.
Let $f : X \to Y$ be a morphism of schemes quasi-separated
and of finite type over $S$. Let
$$
\vcenter{
\begin{array}{cc}X \longrightarrow\downarrow & W \downarrow \\ S \longrightarrow & S_{i_1}\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}Y \longrightarrow\downarrow & V \downarrow \\ S \longrightarrow & S_{i_2}\end{array}
}
$$
be diagrams as in (\ref{equation-good-diagram}). Let
$X = \lim_{i \geq i_1} X_i$ and
$Y = \lim_{i \geq i_2} Y_i$ be the corresponding
limit descriptions as in Lemma \ref{limits-lemma-limit-from-good-diagram}.
...
\begin{proof}
\uses{limits-proposition-characterize-locally-finite-presentation, limits-lemma-limit-contained-in-constructible}
...
$$
\begin{array}{ccc}X \downarrow\longrightarrow & X_i \longrightarrow\downarrow\downarrow & X_{i_0} \overset{h}{\downarrow} \\ Y \longrightarrow\downarrow & Y_i \longrightarrow\downarrow & V \downarrow \\ S \longrightarrow & S_i \longrightarrow & S_{i_0}\end{array}
$$
...
for large enough $i$ by Lemma \ref{limits-lemma-limit-contained-in-constructible}.
...
\begin{remark}[Finite type gives well defined system]
\label{limits-remark-finite-type-gives-well-defined-system}
\source{stacks:0CNS}
\href{https://stacks.math.columbia.edu/tag/0CNS}{\texttt{Stacks tag 0CNS}}
\group{limits}

\uses{limits-situation-limit-noetherian, limits-lemma-good-diagram, limits-lemma-limit-from-good-diagram, limits-lemma-morphism-good-diagram}
In Situation \ref{limits-situation-limit-noetherian}
Lemmas \ref{limits-lemma-good-diagram}, \ref{limits-lemma-limit-from-good-diagram}, and
...
the ones produced by applying Lemma \ref{limits-lemma-limit-from-good-diagram}
...
applying Lemma \ref{limits-lemma-morphism-good-diagram} to $\text{id}_X$
(in two directions)
...
\begin{lemma}[Morphism good diagram flat]
\label{limits-lemma-morphism-good-diagram-flat}
\source{stacks:0CNT}
\href{https://stacks.math.columbia.edu/tag/0CNT}{\texttt{Stacks tag 0CNT}}
\group{limits}

\uses{limits-lemma-morphism-good-diagram}
Notation and assumptions as in Lemma \ref{limits-lemma-morphism-good-diagram}.
...
\begin{proof}
\uses{limits-lemma-descend-finite-presentation, limits-lemma-descend-flat-finite-presentation, limits-remark-finite-type-gives-well-defined-system}
...
Lemma \ref{limits-lemma-descend-flat-finite-presentation}.
As discussed in Remark \ref{limits-remark-finite-type-gives-well-defined-system}
...
\begin{lemma}[Morphism good diagram smooth]
\label{limits-lemma-morphism-good-diagram-smooth}
\source{stacks:0CNU}
\href{https://stacks.math.columbia.edu/tag/0CNU}{\texttt{Stacks tag 0CNU}}
\group{limits}
...
\begin{proof}
\uses{limits-lemma-morphism-good-diagram-flat, limits-lemma-descend-smooth}

Combine Lemmas \ref{limits-lemma-morphism-good-diagram-flat} and
\ref{limits-lemma-descend-smooth}.
\end{proof}

\begin{lemma}[Morphism good diagram proper]
\label{limits-lemma-morphism-good-diagram-proper}
\source{stacks:0CNV}
\href{https://stacks.math.columbia.edu/tag/0CNV}{\texttt{Stacks tag 0CNV}}
\group{limits}
...
\begin{proof}
\uses{limits-remark-finite-type-gives-well-defined-system, limits-lemma-proper-limit-of-proper-finite-presentation, limits-lemma-descend-finite-presentation, limits-lemma-eventually-proper}

By the discussion in
Remark \ref{limits-remark-finite-type-gives-well-defined-system}
...
\begin{lemma}[Good diagram fibre product]
\label{limits-lemma-good-diagram-fibre-product}
\source{stacks:0CNW}
\href{https://stacks.math.columbia.edu/tag/0CNW}{\texttt{Stacks tag 0CNW}}
\group{limits}

\uses{limits-situation-limit-noetherian, limits-lemma-morphism-good-diagram}
In Situation \ref{limits-situation-limit-noetherian} suppose that we have a
cartesian diagram
$$
\begin{array}{cc}X^1 \underset{p}{\longrightarrow}\underset{q}{\downarrow} & X^3 \overset{a}{\downarrow} \\ X^2 \overset{b}{\longrightarrow} & X^4\end{array}
$$
of schemes quasi-separated and of finite type over $S$.
For each $j = 1, 2, 3, 4$ choose $i_j \in I$ and a diagram
$$
\begin{array}{cc}X^j \longrightarrow\downarrow & W^j \downarrow \\ S \longrightarrow & S_{i_j}\end{array}
$$
as in (\ref{equation-good-diagram}). Let
$X^j = \lim_{i \geq i_j} X^j_i$ be the corresponding limit descriptions
as in Lemma \ref{limits-lemma-morphism-good-diagram}.
...
in Lemma \ref{limits-lemma-morphism-good-diagram}. Then there exists an
...
\begin{proof}
\uses{limits-remark-finite-type-gives-well-defined-system, limits-lemma-morphism-good-diagram-flat, limits-lemma-descend-isomorphism}
...
Lemma \ref{limits-lemma-morphism-good-diagram-flat}
...
large $i$ by Lemma \ref{limits-lemma-descend-isomorphism}.
\end{proof}
