...
\source{stacks:0EDT}
\href{https://stacks.math.columbia.edu/tag/0EDT}{\texttt{Stacks tag 0EDT}}
\group{spaces-chow}
...
are easier in the setting of Situation \ref{spaces-chow-situation-setup} because
...
\source{stacks:0EDU}
\href{https://stacks.math.columbia.edu/tag/0EDU}{\texttt{Stacks tag 0EDU}}
\group{spaces-chow}

In Situation \ref{spaces-chow-situation-setup} if $X/B$ is good, then
...
\begin{remark}[Integral]
\label{spaces-chow-remark-integral}
\source{stacks:0EDV}
\href{https://stacks.math.columbia.edu/tag/0EDV}{\texttt{Stacks tag 0EDV}}
\group{spaces-chow}
...
\source{stacks:0EDW}
\href{https://stacks.math.columbia.edu/tag/0EDW}{\texttt{Stacks tag 0EDW}}
\group{spaces-chow}

In Situation \ref{spaces-chow-situation-setup} assume $B$ is Jacobson
...
\source{stacks:0EDX}
\href{https://stacks.math.columbia.edu/tag/0EDX}{\texttt{Stacks tag 0EDX}}
\group{spaces-chow}

In Situation \ref{spaces-chow-situation-setup} for any good $X/B$
...
\source{stacks:0EDZ}
\href{https://stacks.math.columbia.edu/tag/0EDZ}{\texttt{Stacks tag 0EDZ}}
\group{spaces-chow}

In Situation \ref{spaces-chow-situation-setup} let $X/B$ be good.
Let $k \in \mathbf{Z}$.
\begin{enumerate}
...
(Remark \ref{spaces-chow-remark-integral}) of $\delta$-dimension $k$.
...
\source{stacks:0EE1}
\href{https://stacks.math.columbia.edu/tag/0EE1}{\texttt{Stacks tag 0EE1}}
\group{spaces-chow}
...
\begin{definition}[Length at x]
\label{spaces-chow-definition-length-at-x}
\source{stacks:0EE2}
\href{https://stacks.math.columbia.edu/tag/0EE2}{\texttt{Stacks tag 0EE2}}
\group{spaces-chow}
...
if the equivalent conditions of Lemma \ref{spaces-chow-lemma-length}
are satisfied.
\end{definition}

\begin{lemma}[Length closed immersion]
\label{spaces-chow-lemma-length-closed-immersion}
\source{stacks:0EE3}
\href{https://stacks.math.columbia.edu/tag/0EE3}{\texttt{Stacks tag 0EE3}}
\group{spaces-chow}
...
\source{stacks:0EE4}
\href{https://stacks.math.columbia.edu/tag/0EE4}{\texttt{Stacks tag 0EE4}}
\group{spaces-chow}
...
\begin{lemma}[Point of max dimension]
\label{spaces-chow-lemma-point-of-max-dimension}
\source{stacks:0EE6}
\href{https://stacks.math.columbia.edu/tag/0EE6}{\texttt{Stacks tag 0EE6}}
\group{spaces-chow}
...
\begin{remark}[Irreducible component]
\label{spaces-chow-remark-irreducible-component}
\source{stacks:0EE8}
\href{https://stacks.math.columbia.edu/tag/0EE8}{\texttt{Stacks tag 0EE8}}
\group{spaces-chow}

In Situation \ref{spaces-chow-situation-setup} let $X/B$ be good.
Let $Y \subset X$ be a closed subspace. By
Remarks \ref{spaces-chow-remark-sober} and \ref{spaces-chow-remark-integral}
...
\source{stacks:0EE9}
\href{https://stacks.math.columbia.edu/tag/0EE9}{\texttt{Stacks tag 0EE9}}
\group{spaces-chow}
...
(Definition \ref{spaces-chow-definition-length-at-x}) is called the
{\it multiplicity of $Z$ in $Y$}.
By Lemma \ref{spaces-chow-lemma-length-finite} applied to $\mathcal{O}_Y$
...
\source{stacks:0EEB}
\href{https://stacks.math.columbia.edu/tag/0EEB}{\texttt{Stacks tag 0EEB}}
\group{spaces-chow}
...
the length of $\mathcal{F}$ at $\xi$ (Definition \ref{spaces-chow-definition-length-at-x})
is called the {\it multiplicity of $Z$ in $\mathcal{F}$}.
By Lemma \ref{spaces-chow-lemma-length-finite} this is a positive integer.
...
\begin{lemma}[Reformulate coeff coherent]
\label{spaces-chow-lemma-reformulate-coeff-coherent}
\source{stacks:0EEC}
\href{https://stacks.math.columbia.edu/tag/0EEC}{\texttt{Stacks tag 0EEC}}
\group{spaces-chow}
...
Lemma \ref{spaces-chow-lemma-point-of-max-dimension}.
Moreover, the length of $\mathcal{F}$ at $\xi$ is zero if
$\xi \not \in \text{Supp}(\mathcal{F})$. Combining this
with Definition \ref{spaces-chow-definition-cycle-associated-to-coherent-sheaf}
we conclude.
\end{proof}
...
\source{stacks:0EED}
\href{https://stacks.math.columbia.edu/tag/0EED}{\texttt{Stacks tag 0EED}}
\group{spaces-chow}
...
follows from Lemma \ref{spaces-chow-lemma-length-closed-immersion}.
\end{proof}

\begin{lemma}[Additivity sheaf cycle]
\label{spaces-chow-lemma-additivity-sheaf-cycle}
\source{stacks:0EEE}
\href{https://stacks.math.columbia.edu/tag/0EEE}{\texttt{Stacks tag 0EEE}}
\group{spaces-chow}
...
Lemma \ref{spaces-chow-lemma-reformulate-coeff-coherent}
it suffices to show
$$
...
$$
for any $x \in |X|$. Looking at Definition \ref{spaces-chow-definition-length-at-x}
...
\begin{lemma}[Proper image]
\label{spaces-chow-lemma-proper-image}
\source{stacks:0EEG}
\href{https://stacks.math.columbia.edu/tag/0EEG}{\texttt{Stacks tag 0EEG}}
\group{spaces-chow}

In Situation \ref{spaces-chow-situation-setup} let $X,Y/B$ be good and let $f : X \to Y$
...
$$
\begin{array}{cc}Z \longrightarrow\downarrow & X \overset{f}{\downarrow} \\ Z' \longrightarrow & Y\end{array}
$$
...
Remark \ref{spaces-chow-remark-integral}. Since $\xi \in |f^{-1}(Z')| = |f|^{-1}(|Z'|)$
...
\source{stacks:0ENW}
\href{https://stacks.math.columbia.edu/tag/0ENW}{\texttt{Stacks tag 0ENW}}
\group{spaces-chow}

In Situation \ref{spaces-chow-situation-setup} let $X/B$ be good. Every $x \in |X|$
...
\begin{remark}[Function field]
\label{spaces-chow-remark-function-field}
\source{stacks:0ENX}
\href{https://stacks.math.columbia.edu/tag/0ENX}{\texttt{Stacks tag 0ENX}}
\group{spaces-chow}

In Situation \ref{spaces-chow-situation-setup} let $X/B$ be good. Assume $X$ is integral.
...
Combining this with Remark \ref{spaces-chow-remark-integral}
...
\source{stacks:0ENY}
\href{https://stacks.math.columbia.edu/tag/0ENY}{\texttt{Stacks tag 0ENY}}
\group{spaces-chow}

In Situation \ref{spaces-chow-situation-setup} let $X, Y/B$ be good and let
...
\begin{proof}
By Lemma \ref{spaces-chow-lemma-proper-image} there is a unique integral closed
...
our construction of dimension functions (see Situation \ref{spaces-chow-situation-setup})
...
\source{stacks:0ENZ}
\href{https://stacks.math.columbia.edu/tag/0ENZ}{\texttt{Stacks tag 0ENZ}}
\group{spaces-chow}

In Situation \ref{spaces-chow-situation-setup} let $X, Y/B$ be good.
...
\source{stacks:0EP1}
\href{https://stacks.math.columbia.edu/tag/0EP1}{\texttt{Stacks tag 0EP1}}
\group{spaces-chow}
...
image of $Z$ as in Lemma \ref{spaces-chow-lemma-proper-image}.
We define
$$
f_*[Z] =
\left\{
...
$\dim_\delta(Z') = \dim_\delta(Z)$ by Lemma \ref{spaces-chow-lemma-equal-dimension} and
...
by Lemma \ref{spaces-chow-lemma-quasi-compact-locally-finite} above.
\end{enumerate}
\end{definition}
...
\source{stacks:0EP2}
\href{https://stacks.math.columbia.edu/tag/0EP2}{\texttt{Stacks tag 0EP2}}
\group{spaces-chow}

In Situation \ref{spaces-chow-situation-setup} let $X, Y, Z/B$ be good.
...
we get by applying Lemma \ref{spaces-chow-lemma-proper-image}
...
both satisfy the hypotheses of Lemma \ref{spaces-chow-lemma-equal-dimension}.
Hence
$$
...
\source{stacks:0EP3}
\href{https://stacks.math.columbia.edu/tag/0EP3}{\texttt{Stacks tag 0EP3}}
\group{spaces-chow}

In Situation \ref{spaces-chow-situation-setup} let $f : X \to Y$ be a proper morphism
...
\begin{proof}
Part (1) follows from (2) and Lemma \ref{spaces-chow-lemma-cycle-closed-coherent}.
...
Lemma \ref{spaces-chow-lemma-length-closed-immersion} and the definitions.
...
$\delta$-dimension $k$ (see Lemma \ref{spaces-chow-lemma-point-of-max-dimension}).
...
(see Lemma \ref{spaces-chow-lemma-point-of-max-dimension}).
...
\source{stacks:0EP5}
\href{https://stacks.math.columbia.edu/tag/0EP5}{\texttt{Stacks tag 0EP5}}
\group{spaces-chow}
...
\source{stacks:0EP6}
\href{https://stacks.math.columbia.edu/tag/0EP6}{\texttt{Stacks tag 0EP6}}
\group{spaces-chow}
...
\source{stacks:0EP8}
\href{https://stacks.math.columbia.edu/tag/0EP8}{\texttt{Stacks tag 0EP8}}
\group{spaces-chow}
...
by Lemma \ref{spaces-chow-lemma-flat-inverse-image-dimension}.
...
The sum is locally finite by Lemma \ref{spaces-chow-lemma-inverse-image-locally-finite}.
...
\source{stacks:0EP9}
\href{https://stacks.math.columbia.edu/tag/0EP9}{\texttt{Stacks tag 0EP9}}
\group{spaces-chow}
...
\begin{lemma}[Etale pullback]
\label{spaces-chow-lemma-etale-pullback}
\source{stacks:0EPY}
\href{https://stacks.math.columbia.edu/tag/0EPY}{\texttt{Stacks tag 0EPY}}
\group{spaces-chow}

In Situation \ref{spaces-chow-situation-setup} let $f : X \to Y$ be an \'etale
...
irreducible components (Remark \ref{spaces-chow-remark-irreducible-component})
of $f^{-1}(Z)$.
\end{lemma}
...
\source{stacks:0EPA}
\href{https://stacks.math.columbia.edu/tag/0EPA}{\texttt{Stacks tag 0EPA}}
\group{spaces-chow}
...
and repeatedly using Lemma \ref{spaces-chow-lemma-length}
we find
$$
...
\source{stacks:0EPB}
\href{https://stacks.math.columbia.edu/tag/0EPB}{\texttt{Stacks tag 0EPB}}
\group{spaces-chow}
...
\begin{proof}
Part (1) follows from part (2) by Lemma \ref{spaces-chow-lemma-cycle-closed-coherent}
...
actually do not need to verify this. See Lemma \ref{spaces-chow-lemma-length-finite}.)
We have
...
This section is the analogue of
Chow Homology, Section \ref{chow-section-push-pull}.
...
\source{stacks:0EPD}
\href{https://stacks.math.columbia.edu/tag/0EPD}{\texttt{Stacks tag 0EPD}}
\group{spaces-chow}

In Situation \ref{spaces-chow-situation-setup} let
$$
...
Lemma \ref{spaces-chow-lemma-cycle-closed-coherent}.
By Lemmas \ref{spaces-chow-lemma-cycle-push-sheaf} and
\ref{spaces-chow-lemma-pullback-coherent} it therefore suffices
...
\source{stacks:0EPE}
\href{https://stacks.math.columbia.edu/tag/0EPE}{\texttt{Stacks tag 0EPE}}
\group{spaces-chow}
...
$$
where we have used Lemmas \ref{spaces-chow-lemma-pullback-coherent} and
...
\source{stacks:0EPZ}
\href{https://stacks.math.columbia.edu/tag/0EPZ}{\texttt{Stacks tag 0EPZ}}
\group{spaces-chow}

In Situation \ref{spaces-chow-situation-setup} let $X/B$ be good. Assume $X$ is
integral.
\begin{enumerate}
...
\source{stacks:0EQ1}
\href{https://stacks.math.columbia.edu/tag/0EQ1}{\texttt{Stacks tag 0EQ1}}
\group{spaces-chow}
...
Lemma \ref{spaces-chow-lemma-divisor-delta-dimension}.
\end{definition}
...
\begin{lemma}[Etale pullback principal divisor]
\label{spaces-chow-lemma-etale-pullback-principal-divisor}
\source{stacks:0EQ2}
\href{https://stacks.math.columbia.edu/tag/0EQ2}{\texttt{Stacks tag 0EQ2}}
\group{spaces-chow}
...
Definition \ref{spaces-chow-definition-flat-pullback}
...
subspace constructed in Lemma \ref{spaces-chow-lemma-proper-image}.
Then $\dim_\delta(Z') = n - 1$ too. Let $\xi \in |Z|$ be the generic point.
Then $\xi' = f(\xi) \in |Z'|$ is the generic point.
Consider the commutative diagram
$$
\begin{array}{cc}\Spec(\mathcal{O}_{X, \xi}^h) \longrightarrow\downarrow & X \downarrow \\ \Spec(\mathcal{O}_{Y, \xi'}^h) \longrightarrow & Y\end{array}
$$
...
is the same integer, see Lemma \ref{spaces-chow-lemma-etale-pullback}.
...
\source{stacks:0EQ4}
\href{https://stacks.math.columbia.edu/tag/0EQ4}{\texttt{Stacks tag 0EQ4}}
\group{spaces-chow}
...
By Lemma \ref{spaces-chow-lemma-etale-pullback} it suffices to prove the equality
of cycles after pulling back to $V$.
Set $U = V \times_Y X$ and consider the commutative diagram
$$
\begin{array}{cc}U \underset{a}{\longrightarrow}\underset{p'}{\downarrow} & X \overset{p}{\downarrow} \\ V \overset{b}{\longrightarrow} & Y\end{array}
$$
...
\ref{spaces-chow-lemma-etale-pullback-principal-divisor}, and
\ref{spaces-chow-lemma-compose-pushforward}.
To finish the proof, using Lemma \ref{spaces-chow-lemma-etale-pullback-principal-divisor}
...
\source{stacks:0EQ6}
\href{https://stacks.math.columbia.edu/tag/0EQ6}{\texttt{Stacks tag 0EQ6}}
\group{spaces-chow}
...
\source{stacks:0EQ7}
\href{https://stacks.math.columbia.edu/tag/0EQ7}{\texttt{Stacks tag 0EQ7}}
\group{spaces-chow}
...
The lemma follows by applying Lemma \ref{spaces-chow-lemma-exact-sequence-open}.
\end{proof}

\begin{remark}[Infinite sums rational equivalences]
\label{spaces-chow-remark-infinite-sums-rational-equivalences}
\source{stacks:0EQ8}
\href{https://stacks.math.columbia.edu/tag/0EQ8}{\texttt{Stacks tag 0EQ8}}
\group{spaces-chow}
...
\source{stacks:0EQA}
\href{https://stacks.math.columbia.edu/tag/0EQA}{\texttt{Stacks tag 0EQA}}
\group{spaces-chow}
...
$$
\begin{array}{cc}U \underset{a}{\longrightarrow}\underset{h}{\downarrow} & X \overset{f}{\downarrow} \\ V \overset{b}{\longrightarrow} & Y\end{array}
$$
Since $a$ is surjective and \'etale it follows from
Lemma \ref{spaces-chow-lemma-etale-pullback} that it suffices to prove the
equality of cycles after pulling back by $a$.
We can use Lemma \ref{spaces-chow-lemma-etale-pullback-principal-divisor} to write
$$
b^*\text{div}_Y(g) = \sum (V' \to V)_*\text{div}_{V'}(g \circ b|_{V'})
$$
where the sum is over the irreducible components $V'$ of $V$.
Using Lemma \ref{spaces-chow-lemma-flat-pullback-proper-pushforward} we find
$$
h^*b^*\text{div}_Y(g) =
...
(Lemma \ref{spaces-chow-lemma-proper-image}); this
...
(Lemma \ref{spaces-chow-lemma-compose-flat-pullback}), the definitions, and
Lemma \ref{spaces-chow-lemma-etale-pullback}.
...
First, we use Lemma \ref{spaces-chow-lemma-flat-pullback-proper-pushforward}
to get
$$
...
By Lemma \ref{spaces-chow-lemma-etale-pullback-principal-divisor}
we get
$$
...
\source{stacks:0EQB}
\href{https://stacks.math.columbia.edu/tag/0EQB}{\texttt{Stacks tag 0EQB}}
\group{spaces-chow}
...
makes sense by Lemma \ref{spaces-chow-lemma-inverse-image-locally-finite}.
...
By Lemma \ref{spaces-chow-lemma-flat-pullback-proper-pushforward}
we can write the sum above as
$$
\sum i'_{j, *}(f_j^*\text{div}(g_j))
$$
By Lemma \ref{spaces-chow-lemma-prepare-flat-pullback-rational-equivalence}
...
Remark \ref{spaces-chow-remark-infinite-sums-rational-equivalences}.
\end{proof}

\begin{lemma}[Proper pushforward rational equivalence]
\label{spaces-chow-lemma-proper-pushforward-rational-equivalence}
\source{stacks:0EQC}
\href{https://stacks.math.columbia.edu/tag/0EQC}{\texttt{Stacks tag 0EQC}}
\group{spaces-chow}
...
image of $p \circ i_j$, see Lemma \ref{spaces-chow-lemma-proper-image}.
The collection $\{W'_j\}$ is locally finite
in $Y$ by Lemma \ref{spaces-chow-lemma-quasi-compact-locally-finite}.
...
Lemma \ref{spaces-chow-lemma-compose-pushforward}. As explained above
...
$$
\begin{array}{cc}W_\eta \longrightarrow\underset{c}{\downarrow} & W \overset{p'}{\downarrow} \\ \Spec(K) \overset{\eta}{\longrightarrow} & W'\end{array}
$$
...
Lemma \ref{spaces-chow-lemma-proper-pushforward-alteration} applies,
...
\source{stacks:0EQE}
\href{https://stacks.math.columbia.edu/tag/0EQE}{\texttt{Stacks tag 0EQE}}
\group{spaces-chow}
...
by Lemma \ref{spaces-chow-lemma-divisor-delta-dimension}.
...
\source{stacks:0EQF}
\href{https://stacks.math.columbia.edu/tag/0EQF}{\texttt{Stacks tag 0EQF}}
\group{spaces-chow}
...
\begin{lemma}[Gm torsor]
\label{spaces-chow-lemma-Gm-torsor}
\source{stacks:0EQG}
\href{https://stacks.math.columbia.edu/tag/0EQG}{\texttt{Stacks tag 0EQG}}
\group{spaces-chow}
...
\begin{lemma}[Gm torsor divisor meromorphic section]
\label{spaces-chow-lemma-Gm-torsor-divisor-meromorphic-section}
\source{stacks:0EQH}
\href{https://stacks.math.columbia.edu/tag/0EQH}{\texttt{Stacks tag 0EQH}}
\group{spaces-chow}
...
of Lemma \ref{spaces-chow-lemma-Gm-torsor}. Then
$$
...
Lemma \ref{spaces-chow-lemma-Gm-torsor} without further mention.
...
$$
\begin{array}{cc}\Spec(\mathcal{O}_{T, \xi}^h) \underset{c_\xi}{\longrightarrow}\underset{h}{\downarrow} & T \overset{q}{\downarrow} \\ \Spec(\mathcal{O}_{X, \xi'}^h) \overset{c_{\xi'}}{\longrightarrow} & X\end{array}
$$
...
shown in Lemma \ref{spaces-chow-lemma-Gm-torsor}.
\end{proof}
...
\source{stacks:0EQJ}
\href{https://stacks.math.columbia.edu/tag/0EQJ}{\texttt{Stacks tag 0EQJ}}
\group{spaces-chow}
...
Definition \ref{spaces-chow-definition-divisor-invertible-sheaf}.
...
\source{stacks:0EQK}
\href{https://stacks.math.columbia.edu/tag/0EQK}{\texttt{Stacks tag 0EQK}}
\group{spaces-chow}
...
\source{stacks:0EQL}
\href{https://stacks.math.columbia.edu/tag/0EQL}{\texttt{Stacks tag 0EQL}}
\group{spaces-chow}

In Situation \ref{spaces-chow-situation-setup} let $Y/B$ be good.
...
by $\varphi$, see Lemma \ref{spaces-chow-lemma-etale-pullback}.
...
\source{stacks:0EQN}
\href{https://stacks.math.columbia.edu/tag/0EQN}{\texttt{Stacks tag 0EQN}}
\group{spaces-chow}
...
zero, and hence is a regular section. By Lemma \ref{spaces-chow-lemma-compute-c1}
we see that $[Z(s_i)]_k$ represents $c_1(\mathcal{L}|_{Y_i})$.
Hence by definition
$$
c_1(\mathcal{L}) \cap [Y]_{k + 1} = \sum n_i[Z(s_i)]_k
$$
Thus the result follows from Lemma \ref{spaces-chow-lemma-prepare-geometric-cap}.
\end{proof}
...
\source{stacks:0EQQ}
\href{https://stacks.math.columbia.edu/tag/0EQQ}{\texttt{Stacks tag 0EQQ}}
\group{spaces-chow}
...
Lemma \ref{spaces-chow-lemma-prepare-flat-pullback-rational-equivalence}.
...
Lemma \ref{spaces-chow-lemma-Gm-torsor} constructed using $\mathcal{L}$ on $Y$.
We will use all the properties of $T$ stated in this lemma.
Consider the fibre product diagram
$$
\begin{array}{cc}T' \underset{q'}{\longrightarrow}\underset{h}{\downarrow} & X \overset{f}{\downarrow} \\ T \overset{q}{\longrightarrow} & Y\end{array}
$$
...
$$
by Lemma \ref{spaces-chow-lemma-Gm-torsor-divisor-meromorphic-section}
(and Lemma \ref{spaces-chow-lemma-compose-flat-pullback}).
On the other hand, denoting $q'_i : T'_i \to X_i$
the restriction of $q'$ we find that
Lemma \ref{spaces-chow-lemma-Gm-torsor-divisor-meromorphic-section}
...
Thus Lemma \ref{spaces-chow-lemma-prepare-flat-pullback-rational-equivalence}
exactly says that
$$
...
\source{stacks:0EQR}
\href{https://stacks.math.columbia.edu/tag/0EQR}{\texttt{Stacks tag 0EQR}}
\group{spaces-chow}
...
each $i$. By Lemma \ref{spaces-chow-lemma-prepare-flat-pullback-cap-c1}
...
\source{stacks:0EQS}
\href{https://stacks.math.columbia.edu/tag/0EQS}{\texttt{Stacks tag 0EQS}}
\group{spaces-chow}
...
Lemma \ref{spaces-chow-lemma-Gm-torsor} constructed using $\mathcal{L}$ on $Y$. We will use
...
\end{align*}
The first equality by Lemma \ref{spaces-chow-lemma-flat-pullback-proper-pushforward}.
The second by Lemma \ref{spaces-chow-lemma-prepare-flat-pullback-cap-c1}
...
$$
This follows from Lemma \ref{spaces-chow-lemma-prepare-flat-pullback-cap-c1},
the fact that $T$ is integral, and the equality
$[R(T') : R(T)] = [R(X) : R(Y)]$ whose proof we omit
(it follows from Lemma \ref{spaces-chow-lemma-flat-pullback-proper-pushforward}
...
$$
Comparing with the result of Lemma \ref{spaces-chow-lemma-proper-pushforward-alteration}
...
\source{stacks:0EQT}
\href{https://stacks.math.columbia.edu/tag/0EQT}{\texttt{Stacks tag 0EQT}}
\group{spaces-chow}
...
in Lemma \ref{spaces-chow-lemma-proper-image}. Consider the diagram
$$
...
Lemma \ref{spaces-chow-lemma-equal-c1-as-cycles}.
\end{proof}
...
\source{stacks:0EQV}
\href{https://stacks.math.columbia.edu/tag/0EQV}{\texttt{Stacks tag 0EQV}}
\group{spaces-chow}
...
Lemma \ref{spaces-chow-lemma-Gm-torsor}. We will use all properties stated in
...
$$
\begin{array}{cc}\Spec(B'_i) \underset{c_{\xi'_i}}{\longrightarrow}\downarrow & T \overset{q}{\downarrow} \\ \Spec(B_i) \overset{c_{\xi_i}}{\longrightarrow} & X\end{array}
$$
see Decent Spaces, Remark
\ref{decent-spaces-remark-functoriality-henselian-local-ring}.
...
$$
By Lemma \ref{spaces-chow-lemma-prepare-flat-pullback-cap-c1} applied
...
Thus Lemma \ref{spaces-chow-lemma-etale-pullback-principal-divisor} applies to show
$$
...
immersions (Lemma \ref{spaces-chow-lemma-flat-pullback-proper-pushforward})
...
\source{stacks:0EQX}
\href{https://stacks.math.columbia.edu/tag/0EQX}{\texttt{Stacks tag 0EQX}}
\group{spaces-chow}
...
\begin{proof}
Immediate from the key Lemma \ref{spaces-chow-lemma-key-formula}
...
\source{stacks:0EQY}
\href{https://stacks.math.columbia.edu/tag/0EQY}{\texttt{Stacks tag 0EQY}}
\group{spaces-chow}
...
as defined in Definition \ref{spaces-chow-definition-cap-c1} is zero.
By Definition \ref{spaces-chow-definition-rational-equivalence} there
...
By Lemma \ref{spaces-chow-lemma-pushforward-cap-c1} we have
...
By Lemma \ref{spaces-chow-lemma-commutativity-on-integral}
we conclude that
$$
c_1(\mathcal{L}) \cap \alpha = c_1(\mathcal{O}_X) \cap \beta.
$$
However, by Lemma \ref{spaces-chow-lemma-c1-cap-additive} we see that the right hand side
...
Lemma \ref{spaces-chow-lemma-factors}. We will denote $c_1(\mathcal{L}^s \cap -$
the $s$-fold iterate of this operation for all $s \geq 0$.

\begin{lemma}[Cap commutative]
\label{spaces-chow-lemma-cap-commutative}
\source{stacks:0EQZ}
\href{https://stacks.math.columbia.edu/tag/0EQZ}{\texttt{Stacks tag 0EQZ}}
\group{spaces-chow}
...
Lemma \ref{spaces-chow-lemma-pushforward-cap-c1} we see that
$c_1(\mathcal{L}) \cap c_1(\mathcal{N}) \cap \alpha
...
from Lemma \ref{spaces-chow-lemma-commutativity-on-integral} and the definitions.
\end{proof}
...
\source{stacks:0ER1}
\href{https://stacks.math.columbia.edu/tag/0ER1}{\texttt{Stacks tag 0ER1}}
\group{spaces-chow}
...
\begin{remark}[On cycles]
\label{spaces-chow-remark-on-cycles}
\source{stacks:0ER2}
\href{https://stacks.math.columbia.edu/tag/0ER2}{\texttt{Stacks tag 0ER2}}
\group{spaces-chow}

Let $S$, $B$, $X$, $\mathcal{L}$, $s$, $i : D \to X$ be as in
Definition \ref{spaces-chow-definition-gysin-homomorphism} and assume
...
\source{stacks:0ER3}
\href{https://stacks.math.columbia.edu/tag/0ER3}{\texttt{Stacks tag 0ER3}}
\group{spaces-chow}

Let $f : X' \to X$ be a morphism of good algebraic spaces over $B$
as in Situation \ref{spaces-chow-situation-setup}. Let $(\mathcal{L}, s, i : D \to X)$
be a triple as in Definition \ref{spaces-chow-definition-gysin-homomorphism}.
...
\source{stacks:0ER4}
\href{https://stacks.math.columbia.edu/tag/0ER4}{\texttt{Stacks tag 0ER4}}
\group{spaces-chow}

In Situation \ref{spaces-chow-situation-setup} let $X/B$ be good. Let
$(\mathcal{L}, s, i : D \to X)$ be as in
Definition \ref{spaces-chow-definition-gysin-homomorphism}. Let $\alpha$ be a
...
by Lemma \ref{spaces-chow-lemma-geometric-cap}. So we have
$$
...
$$
in $\CH_k(X)$ by Definition \ref{spaces-chow-definition-cap-c1}.
The right hand side matches (termwise) the pushforward of the class
$i^*\alpha$ on $D$ from Definition \ref{spaces-chow-definition-gysin-homomorphism}.
Hence we win.
\end{proof}
...
\source{stacks:0ER5}
\href{https://stacks.math.columbia.edu/tag/0ER5}{\texttt{Stacks tag 0ER5}}
\group{spaces-chow}

In Situation \ref{spaces-chow-situation-setup}. Let $f : X' \to X$ be a proper morphism
of good algebraic spaces over $B$. Let $(\mathcal{L}, s, i : D \to X)$ be as in
Definition \ref{spaces-chow-definition-gysin-homomorphism}.
Form the diagram
$$
\begin{array}{cc}D' \underset{g}{\downarrow}\underset{i'}{\longrightarrow} & X' \overset{f}{\downarrow} \\ D \overset{i}{\longrightarrow} & X\end{array}
$$
as in Remark \ref{spaces-chow-remark-pullback-pairs}.
...
as in Lemma \ref{spaces-chow-lemma-proper-image}. In case $W' \not \subset D'$,
...
Lemma \ref{spaces-chow-lemma-equal-c1-as-cycles}. Hence the
...
assertion of Lemma \ref{spaces-chow-lemma-equal-c1-as-cycles}.
By Remark \ref{spaces-chow-remark-infinite-sums-rational-equivalences}
...
\source{stacks:0ER6}
\href{https://stacks.math.columbia.edu/tag/0ER6}{\texttt{Stacks tag 0ER6}}
\group{spaces-chow}

In Situation \ref{spaces-chow-situation-setup}. Let $f : X' \to X$
be a flat morphism of relative dimension $r$ of
good algebraic spaces over $B$. Let $(\mathcal{L}, s, i : D \to X)$ be as in
Definition \ref{spaces-chow-definition-gysin-homomorphism}. Form the diagram
$$
\begin{array}{cc}D' \underset{g}{\downarrow}\underset{i'}{\longrightarrow} & X' \overset{f}{\downarrow} \\ D \overset{i}{\longrightarrow} & X\end{array}
$$
as in Remark \ref{spaces-chow-remark-pullback-pairs}.
...
equality holds as cycles, see Lemma \ref{spaces-chow-lemma-pullback-coherent}.
In case $W \subset D$, then $W' \subset D'$ and $W' = g^{-1}(W)$
with $[W']_{k + 1 + r} = g^*[W]$ and equality holds in
$\CH_{k + r}(D')$ by Lemma \ref{spaces-chow-lemma-flat-pullback-cap-c1}.
By Remark \ref{spaces-chow-remark-infinite-sums-rational-equivalences}
the result follows for general $\alpha'$.
\end{proof}
...
\source{stacks:0ER7}
\href{https://stacks.math.columbia.edu/tag/0ER7}{\texttt{Stacks tag 0ER7}}
\group{spaces-chow}
...
See Lemma \ref{spaces-chow-lemma-prepare-geometric-cap}.
...
\source{stacks:0ER9}
\href{https://stacks.math.columbia.edu/tag/0ER9}{\texttt{Stacks tag 0ER9}}
\group{spaces-chow}
...
Section \ref{spaces-chow-section-key} to our current situation.
...
Lemma \ref{spaces-chow-lemma-compute-c1}. Similarly,
$$
c_1(\mathcal{N}) \cap [D]_{n - 1} =
\sum \text{ord}_{B_i}(f_i) \text{div}_{\mathcal{N}|_{Z_i}}(t_i|_{Z_i})
$$
The key formula (Lemma \ref{spaces-chow-lemma-key-formula}) gives the equality
$$
\sum \left(
\text{ord}_{B_i}(f_i) \text{div}_{\mathcal{N}|_{Z_i}}(t_i|_{Z_i}) -
\text{ord}_{B_i}(g_i) \text{div}_{\mathcal{L}|_{Z_i}}(s_i|_{Z_i}) \right) =
...
\source{stacks:0ERA}
\href{https://stacks.math.columbia.edu/tag/0ERA}{\texttt{Stacks tag 0ERA}}
\group{spaces-chow}
...
$$
of Remark \ref{spaces-chow-remark-pullback-pairs}. Since $X' \to X$ is proper
we see that $i^*p_* = q_*(i')^*$ by Lemma \ref{spaces-chow-lemma-closed-in-X-gysin}.
As we know that $q_*$ factors through rational equivalence
(Lemma \ref{spaces-chow-lemma-proper-pushforward-rational-equivalence}), it suffices
...
This is rationally equivalent to zero by Lemma \ref{spaces-chow-lemma-factors}.
If $D \not = X$, then we see that $i^*\text{div}_X(f)$ is equal to
$c_1(\mathcal{O}_D) \cap [D]_{n - 1}$ in $\CH_k(D)$ by
Lemma \ref{spaces-chow-lemma-gysin-factors-general}. Of course
...
\source{stacks:0ERB}
\href{https://stacks.math.columbia.edu/tag/0ERB}{\texttt{Stacks tag 0ERB}}
\group{spaces-chow}
...
\begin{proof}
With exactly the same proof as in Lemma \ref{spaces-chow-lemma-gysin-factors}
...
\source{stacks:0ERC}
\href{https://stacks.math.columbia.edu/tag/0ERC}{\texttt{Stacks tag 0ERC}}
\group{spaces-chow}

In Situation \ref{spaces-chow-situation-setup} let $X/B$ be good.
Let $(\mathcal{L}, s, i : D \to X)$ and
$(\mathcal{L}', s', i' : D' \to X)$ be two triples as in
Definition \ref{spaces-chow-definition-gysin-homomorphism}. Then the diagram
$$
\begin{array}{cc}\CH_k(X) \underset{i^*}{\longrightarrow}\underset{(i')^*}{\downarrow} & \CH_{k - 1}(D) \downarrow \\ \CH_{k - 1}(D') \longrightarrow & \CH_{k - 2}(D \cap D')\end{array}
$$
...
$$
as in the discussion in Section \ref{spaces-chow-section-key}.
Then we see that $Z_i \subset D$ if $n_i \not = 0$ and
$Z'_i \subset D'$ if $n'_i \not = 0$. For each $i$, let $\xi_i \in |Z_i|$
be the generic point. As in Section \ref{spaces-chow-section-key} we choose
...
$$
The key formula (Lemma \ref{spaces-chow-lemma-key-formula}) now gives the equality
$$
\sum \left(
...
\source{stacks:0ERE}
\href{https://stacks.math.columbia.edu/tag/0ERE}{\texttt{Stacks tag 0ERE}}
\group{spaces-chow}
...
Cartier divisor on $p^{-1}W$. By Lemma \ref{spaces-chow-lemma-easy-gysin}
...
first apply Lemma \ref{spaces-chow-lemma-support-cap-effective-Cartier}.
\end{proof}
...
\source{stacks:0ERG}
\href{https://stacks.math.columbia.edu/tag/0ERG}{\texttt{Stacks tag 0ERG}}
\group{spaces-chow}
...
as in Lemma \ref{spaces-chow-lemma-proper-image}. For any quasi-compact open
...
for some $\beta \in Z_k(V)$. By Lemma \ref{spaces-chow-lemma-exact-sequence-open}
we see that
$\beta = \beta'|_V$ for some $\beta' \in Z_k(Y)$.
By the exact sequence
$\CH_k(f^{-1}(Y \setminus V)) \to \CH_k(X) \to \CH_k(f^{-1}(V))$
of Lemma \ref{spaces-chow-lemma-restrict-to-open}
...
\source{stacks:0ERH}
\href{https://stacks.math.columbia.edu/tag/0ERH}{\texttt{Stacks tag 0ERH}}
\group{spaces-chow}
...
\begin{proof}
For surjectivity see Lemma \ref{spaces-chow-lemma-pullback-affine-fibres-surjective}.
...
Cartier divisor on $L$. Hence by Lemma \ref{spaces-chow-lemma-relative-effective-cartier}
...
\source{stacks:0ERJ}
\href{https://stacks.math.columbia.edu/tag/0ERJ}{\texttt{Stacks tag 0ERJ}}
\group{spaces-chow}

\begin{reference}
Similar to \cite[Definition 17.1]{F}
\end{reference}
In Situation \ref{spaces-chow-situation-setup} let $f : X \to Y$ be a morphism of
...
In Situation \ref{spaces-chow-situation-setup} let $X \to Y$ and $Y \to Z$
...
\source{stacks:0ERK}
\href{https://stacks.math.columbia.edu/tag/0ERK}{\texttt{Stacks tag 0ERK}}
\group{spaces-chow}

In Situation \ref{spaces-chow-situation-setup} let $X/B$ be good. The {\it Chow cohomology}
...
\source{stacks:0ERL}
\href{https://stacks.math.columbia.edu/tag/0ERL}{\texttt{Stacks tag 0ERL}}
\group{spaces-chow}
...
\source{stacks:0ERM}
\href{https://stacks.math.columbia.edu/tag/0ERM}{\texttt{Stacks tag 0ERM}}
\group{spaces-chow}
...
\begin{proof}
This follows from Lemmas \ref{spaces-chow-lemma-factors},
\ref{spaces-chow-lemma-pushforward-cap-c1},
...
\source{stacks:0ERN}
\href{https://stacks.math.columbia.edu/tag/0ERN}{\texttt{Stacks tag 0ERN}}
\group{spaces-chow}

In Situation \ref{spaces-chow-situation-setup} let $f : X \to Y$ be a morphism
...
\begin{proof}
This follows from
Lemmas \ref{spaces-chow-lemma-flat-pullback-rational-equivalence},
...
\source{stacks:0ERP}
\href{https://stacks.math.columbia.edu/tag/0ERP}{\texttt{Stacks tag 0ERP}}
\group{spaces-chow}
...
\begin{proof}
This follows from Lemmas \ref{spaces-chow-lemma-gysin-factors},
...
\source{stacks:0ERQ}
\href{https://stacks.math.columbia.edu/tag/0ERQ}{\texttt{Stacks tag 0ERQ}}
\group{spaces-chow}

In Situation \ref{spaces-chow-situation-setup} let $f : X \to Y$ and
...
\begin{proof}
This follows from Lemmas \ref{spaces-chow-lemma-compose-pushforward},
\ref{spaces-chow-lemma-flat-pullback-proper-pushforward}, and
\ref{spaces-chow-lemma-closed-in-X-gysin}.
\end{proof}
...
\source{stacks:0ERR}
\href{https://stacks.math.columbia.edu/tag/0ERR}{\texttt{Stacks tag 0ERR}}
\group{spaces-chow}
...
\begin{proof}
Let $p : L \to X$ be as in Lemma \ref{spaces-chow-lemma-linebundle} and let $o : X \to L$
...
o_* o^* p^*\alpha
$$
by Lemmas \ref{spaces-chow-lemma-flat-pullback-cap-c1} and
...
\source{stacks:0ERS}
\href{https://stacks.math.columbia.edu/tag/0ERS}{\texttt{Stacks tag 0ERS}}
\group{spaces-chow}

In Situation \ref{spaces-chow-situation-setup} let $X/B$ be good. Let $c \in A^p(X)$.
...
\source{stacks:0ERU}
\href{https://stacks.math.columbia.edu/tag/0ERU}{\texttt{Stacks tag 0ERU}}
\group{spaces-chow}
...
\source{stacks:0ERV}
\href{https://stacks.math.columbia.edu/tag/0ERV}{\texttt{Stacks tag 0ERV}}
\group{spaces-chow}

Let $(S, \delta)$ be as in Situation \ref{spaces-chow-situation-setup}.
...
By Lemma \ref{spaces-chow-lemma-cap-projective-bundle} we see that
$$
0 = \pi_*(\pi^*\alpha_0 +
c_1(\mathcal{O}_P(1)) \cap \pi^*\alpha_1
+ \ldots +
...
as in the proof of Lemma \ref{spaces-chow-lemma-pullback-affine-fibres-surjective}
...
of $W_j$ as in Lemma \ref{spaces-chow-lemma-proper-image}. For any quasi-compact open
...
Consider the fibre product diagrams
$$
\begin{array}{cc}P_j \longrightarrow\underset{\pi_j}{\downarrow} & P \overset{\pi}{\downarrow} \\ Z_j \longrightarrow & X\end{array}
$$
...
By Lemma \ref{spaces-chow-lemma-exact-sequence-open} we see that
...
\source{stacks:0ERW}
\href{https://stacks.math.columbia.edu/tag/0ERW}{\texttt{Stacks tag 0ERW}}
\group{spaces-chow}
...
\begin{proof}
(For the case of linebundles, see Lemma \ref{spaces-chow-lemma-linebundle}.)
For surjectivity see Lemma \ref{spaces-chow-lemma-pullback-affine-fibres-surjective}.
...
see Lemma \ref{spaces-chow-lemma-restrict-to-open}. So if $p^*\alpha = 0$, then
$\pi^*\alpha = i_*\beta$ for some $\beta \in \CH_{k + r}(D)$.
By Lemma \ref{spaces-chow-lemma-chow-ring-projective-bundle} we may write
$$
\beta = \pi_D^*\beta_0 +
\ldots + c_1(\mathcal{O}_D(1))^{r - 1} \cap \pi_D^* \beta_{r - 1}.
$$
for some $\beta_i \in \CH_{k + i}(X)$.
By Lemmas \ref{spaces-chow-lemma-relative-effective-cartier}
...
this contradicts Lemma \ref{spaces-chow-lemma-pushforward-cap-c1} unless all
...
\begin{lemma}[Segre classes]
\label{spaces-chow-lemma-segre-classes}
\source{stacks:0ERY}
\href{https://stacks.math.columbia.edu/tag/0ERY}{\texttt{Stacks tag 0ERY}}
\group{spaces-chow}
...
follows immediately from Lemma \ref{spaces-chow-lemma-chow-ring-projective-bundle}
...
the Segre classes of $\mathcal{E}$.} by Lemmas \ref{spaces-chow-lemma-cap-c1-bivariant},
\ref{spaces-chow-lemma-flat-pullback-bivariant}, and
\ref{spaces-chow-lemma-push-proper-bivariant}.
By Lemma \ref{spaces-chow-lemma-cap-projective-bundle} we have
$t_i(\mathcal{E}) = 0$ for $i < 0$ and $t_0(\mathcal{E}) = 1$.
Applying pushforward to the equation in the statement of the lemma
we find from Lemma \ref{spaces-chow-lemma-cap-projective-bundle} that
$$
...
\source{stacks:0ERZ}
\href{https://stacks.math.columbia.edu/tag/0ERZ}{\texttt{Stacks tag 0ERZ}}
\group{spaces-chow}
...
constructed in Lemma \ref{spaces-chow-lemma-segre-classes}.
...
\source{stacks:0ES0}
\href{https://stacks.math.columbia.edu/tag/0ES0}{\texttt{Stacks tag 0ES0}}
\group{spaces-chow}

In Situation \ref{spaces-chow-situation-setup} let $X/B$ be good.
Let $\mathcal{L}$ be an invertible $\mathcal{O}_X$-module.
The first Chern class of $\mathcal{L}$ on $X$ of
Definition \ref{spaces-chow-definition-chern-classes}
is equal to the bivariant class of Lemma \ref{spaces-chow-lemma-cap-c1-bivariant}.
\end{lemma}

\begin{proof}
Namely, in this case $P = \mathbf{P}(\mathcal{L}) = X$ with
$\mathcal{O}_P(1) = \mathcal{L}$ by our normalization of the
projective bundle, see Section \ref{spaces-chow-section-projective-space-bundle-formula}.
Hence the equation in Lemma \ref{spaces-chow-lemma-segre-classes}
reads
$$
...
\source{stacks:0ES1}
\href{https://stacks.math.columbia.edu/tag/0ES1}{\texttt{Stacks tag 0ES1}}
\group{spaces-chow}
...
$\alpha_0 = \alpha$. By Lemma \ref{spaces-chow-lemma-segre-classes} we have
$$
\sum\nolimits_{i = 0}^r
(-1)^i c_1(\mathcal{O}_{P'}(1))^i \cap
(\pi')^*(\alpha_{r - i}) = 0
...
Applying $c \cap -$ and using Lemma \ref{spaces-chow-lemma-c1-center}
...
Lemma \ref{spaces-chow-lemma-segre-classes}. This proves the lemma.
\end{proof}

\begin{remark}[Extend to finite locally free]
\label{spaces-chow-remark-extend-to-finite-locally-free}
\source{stacks:0ES2}
\href{https://stacks.math.columbia.edu/tag/0ES2}{\texttt{Stacks tag 0ES2}}
\group{spaces-chow}
...
free $\mathcal{O}_X$-modules. By Lemma \ref{spaces-chow-lemma-cap-commutative-chern}
...
By Lemma \ref{spaces-chow-lemma-bivariant-zero}
...
$$
proved in Lemma \ref{spaces-chow-lemma-c1-cap-additive}.
...
\source{stacks:0ES4}
\href{https://stacks.math.columbia.edu/tag/0ES4}{\texttt{Stacks tag 0ES4}}
\group{spaces-chow}
...
replacing the lemmas used there by Lemmas \ref{spaces-chow-lemma-bivariant-zero} and
...
\source{stacks:0ES7}
\href{https://stacks.math.columbia.edu/tag/0ES7}{\texttt{Stacks tag 0ES7}}
\group{spaces-chow}
...
Lemmas \ref{spaces-chow-lemma-bivariant-zero},
\ref{spaces-chow-lemma-relative-effective-cartier},
...
\source{stacks:0ES8}
\href{https://stacks.math.columbia.edu/tag/0ES8}{\texttt{Stacks tag 0ES8}}
\group{spaces-chow}
...
\source{stacks:0ES9}
\href{https://stacks.math.columbia.edu/tag/0ES9}{\texttt{Stacks tag 0ES9}}
\group{spaces-chow}
...
\source{stacks:0ESA}
\href{https://stacks.math.columbia.edu/tag/0ESA}{\texttt{Stacks tag 0ESA}}
\group{spaces-chow}
...
\begin{proof}
Apply Lemma \ref{spaces-chow-lemma-additivity-invertible-subsheaf} and induction.
\end{proof}
...
\source{stacks:0ESC}
\href{https://stacks.math.columbia.edu/tag/0ESC}{\texttt{Stacks tag 0ESC}}
\group{spaces-chow}
...
over $B$, see Lemma \ref{spaces-chow-lemma-chow-ring-projective-bundle}.
...
\source{stacks:0ESD}
\href{https://stacks.math.columbia.edu/tag/0ESD}{\texttt{Stacks tag 0ESD}}
\group{spaces-chow}
...
Lemma \ref{spaces-chow-lemma-splitting-principle}.
...
by Lemma \ref{spaces-chow-lemma-c1-cap-additive}.
By Lemma \ref{spaces-chow-lemma-chern-filter-by-linebundles}
we have
$$
c(\mathcal{E}) = \prod\nolimits_{i = 1}^r (1 + x_i)
\quad\text{and}\quad
...
\source{stacks:0ESE}
\href{https://stacks.math.columbia.edu/tag/0ESE}{\texttt{Stacks tag 0ESE}}
\group{spaces-chow}
...
\begin{proof}
Arguing exactly as in the proof of Lemma \ref{spaces-chow-lemma-chern-classes-dual}
...
\source{stacks:0ESG}
\href{https://stacks.math.columbia.edu/tag/0ESG}{\texttt{Stacks tag 0ESG}}
\group{spaces-chow}
...
\source{stacks:0ESH}
\href{https://stacks.math.columbia.edu/tag/0ESH}{\texttt{Stacks tag 0ESH}}
\group{spaces-chow}
...
(Definition \ref{spaces-chow-definition-proper-pushforward}).
\end{proof}

\begin{lemma}[Degrees and numerical intersections]
\label{spaces-chow-lemma-degrees-and-numerical-intersections}
\source{stacks:0ESI}
\href{https://stacks.math.columbia.edu/tag/0ESI}{\texttt{Stacks tag 0ESI}}
\group{spaces-chow}
...
$$
by Lemma \ref{spaces-chow-lemma-pushforward-cap-c1}. Thus we may replace $X$ by $X'$
