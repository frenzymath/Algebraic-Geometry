...
/-!
# StacksPart07Lib.FiberedGroupoids
...
required to be a groupoid.  Keeping the two requirements together gives the
Part 07 development a stable interface without making the (false) claim that
all arrows in the total category are invertible.
-/
