...
\begin{lemma}[Properties diagonal]
\label{spaces-morphisms-lemma-properties-diagonal}
\source{stacks:03HK}
\href{https://stacks.math.columbia.edu/tag/03HK}{\texttt{Stacks tag 03HK}}
\group{spaces-morphisms}
...
$$
\begin{array}{ccc}R = U \times_X U \longrightarrow\downarrow & U \times_Y U \downarrow\longrightarrow & U \times_S U \downarrow \\ X \longrightarrow & X \times_Y X \longrightarrow & X \times_S X\end{array}
$$
...
\source{stacks:03HL}
\href{https://stacks.math.columbia.edu/tag/03HL}{\texttt{Stacks tag 03HL}}
\group{spaces-morphisms}
...
(Lemma \ref{spaces-morphisms-lemma-match-separated}) that this definition matches the ones
...
\source{stacks:03KK}
\href{https://stacks.math.columbia.edu/tag/03KK}{\texttt{Stacks tag 03KK}}
\group{spaces-morphisms}
...
\source{stacks:03KL}
\href{https://stacks.math.columbia.edu/tag/03KL}{\texttt{Stacks tag 03KL}}
\group{spaces-morphisms}

All of the separation axioms listed in Definition \ref{spaces-morphisms-definition-separated}
...
Definition \ref{spaces-morphisms-definition-separated}
is stable under base change. Hence the lemma is true.
\end{proof}

\begin{lemma}[The top arrow of a ``magic diagram'' of algebraic spaces has nice immersion-like proper...]
\label{spaces-morphisms-lemma-fibre-product-after-map}
\source{stacks:03KN}
\href{https://stacks.math.columbia.edu/tag/03KN}{\texttt{Stacks tag 03KN}}
\group{spaces-morphisms}
...
$$
\begin{array}{cc}X \times_Z Y \underset{i}{\longrightarrow}\downarrow & X \times_T Y \downarrow \\ Z \overset{\Delta_{Z/T}}{\longrightarrow}\longrightarrow & Z \times_T Z\end{array}
$$
is a fibre product diagram. Hence $i$ is the base change of the
diagonal morphism $\Delta_{Z/T}$. Thus the lemma follows
from Lemma \ref{spaces-morphisms-lemma-properties-diagonal}, and the material in
Section \ref{spaces-morphisms-section-representable}.
\end{proof}

\begin{lemma}[Properties of the graph of a morphism of algebraic spaces as a consequence of separatio...]
\label{spaces-morphisms-lemma-semi-diagonal}
\source{stacks:03KO}
\href{https://stacks.math.columbia.edu/tag/03KO}{\texttt{Stacks tag 03KO}}
\group{spaces-morphisms}
...
\begin{proof}
This is a special case of Lemma \ref{spaces-morphisms-lemma-fibre-product-after-map}
...
\source{stacks:03KP}
\href{https://stacks.math.columbia.edu/tag/03KP}{\texttt{Stacks tag 03KP}}
\group{spaces-morphisms}
...
\begin{proof}
This is a special case of Lemma \ref{spaces-morphisms-lemma-semi-diagonal} applied to
...
\source{stacks:03KQ}
\href{https://stacks.math.columbia.edu/tag/03KQ}{\texttt{Stacks tag 03KQ}}
\group{spaces-morphisms}
...
Lemma \ref{spaces-morphisms-lemma-fibre-product-after-map} above we see that
...
\source{stacks:04ZH}
\href{https://stacks.math.columbia.edu/tag/04ZH}{\texttt{Stacks tag 04ZH}}
\group{spaces-morphisms}
...
Lemma \ref{spaces-morphisms-lemma-composition-separated}
and
...
\source{stacks:03KR}
\href{https://stacks.math.columbia.edu/tag/03KR}{\texttt{Stacks tag 03KR}}
\group{spaces-morphisms}
...
\source{stacks:04ZI}
\href{https://stacks.math.columbia.edu/tag/04ZI}{\texttt{Stacks tag 04ZI}}
\group{spaces-morphisms}
...
\begin{lemma}[Separated local]
\label{spaces-morphisms-lemma-separated-local}
\source{stacks:03KM}
\href{https://stacks.math.columbia.edu/tag/03KM}{\texttt{Stacks tag 03KM}}
\group{spaces-morphisms}

Let $S$ be a scheme.
Let $f : X \to Y$ be a morphism of algebraic spaces over $S$.
Let $\mathcal{P}$ be any of the separation
axioms of Definition \ref{spaces-morphisms-definition-separated}.
...
Lemma \ref{spaces-morphisms-lemma-composition-separated}). Hence the algebraic
...
$$
\begin{array}{cc}V \times_Y X \longrightarrow\downarrow & X \downarrow \\ V \times_Y X \times_Y X \longrightarrow & X \times_Y X\end{array}
$$
...
\begin{lemma}[Match separated]
\label{spaces-morphisms-lemma-match-separated}
\source{stacks:03KY}
\href{https://stacks.math.columbia.edu/tag/03KY}{\texttt{Stacks tag 03KY}}
\group{spaces-morphisms}
...
We have already defined in Section \ref{spaces-morphisms-section-representable}
what it means for a representable morphism of algebraic spaces
to be surjective.

\begin{lemma}[Surjective representable]
\label{spaces-morphisms-lemma-surjective-representable}
\source{stacks:03MD}
\href{https://stacks.math.columbia.edu/tag/03MD}{\texttt{Stacks tag 03MD}}
\group{spaces-morphisms}

Let $S$ be a scheme. Let $f : X \to Y$ be a representable
morphism of algebraic spaces over $S$. Then
$f$ is surjective (in the sense of Section \ref{spaces-morphisms-section-representable})
...
\source{stacks:03ME}
\href{https://stacks.math.columbia.edu/tag/03ME}{\texttt{Stacks tag 03ME}}
\group{spaces-morphisms}
...
\begin{lemma}[Surjective local]
\label{spaces-morphisms-lemma-surjective-local}
\source{stacks:03MF}
\href{https://stacks.math.columbia.edu/tag/03MF}{\texttt{Stacks tag 03MF}}
\group{spaces-morphisms}
...
\source{stacks:03MG}
\href{https://stacks.math.columbia.edu/tag/03MG}{\texttt{Stacks tag 03MG}}
\group{spaces-morphisms}
...
\source{stacks:03MH}
\href{https://stacks.math.columbia.edu/tag/03MH}{\texttt{Stacks tag 03MH}}
\group{spaces-morphisms}
...
\source{stacks:03Z1}
\href{https://stacks.math.columbia.edu/tag/03Z1}{\texttt{Stacks tag 03Z1}}
\group{spaces-morphisms}
...
(in the sense of Section \ref{spaces-morphisms-section-representable}), and
...
$$
\begin{array}{cc}|V \times_Y X| \longrightarrow\downarrow & |Z \times_Y X| \downarrow \\ |V| \longrightarrow & |Z|\end{array}
$$
...
\source{stacks:03Z2}
\href{https://stacks.math.columbia.edu/tag/03Z2}{\texttt{Stacks tag 03Z2}}
\group{spaces-morphisms}
...
\source{stacks:03Z3}
\href{https://stacks.math.columbia.edu/tag/03Z3}{\texttt{Stacks tag 03Z3}}
\group{spaces-morphisms}
...
\begin{lemma}[Composition open]
\label{spaces-morphisms-lemma-composition-open}
\source{stacks:03Z4}
\href{https://stacks.math.columbia.edu/tag/03Z4}{\texttt{Stacks tag 03Z4}}
\group{spaces-morphisms}
...
\begin{lemma}[Universally open local]
\label{spaces-morphisms-lemma-universally-open-local}
\source{stacks:03Z5}
\href{https://stacks.math.columbia.edu/tag/03Z5}{\texttt{Stacks tag 03Z5}}
\group{spaces-morphisms}
...
$$
\begin{array}{cccc}\coprod_i |W_i \times_Y X| \xlongequal{}\downarrow & |W \times_Y X| \longrightarrow\downarrow & |Z \times_Y X| \downarrow\xlongequal{} & |Z \times_V (V \times_Y X)| \swarrow \\ \coprod |W_i| \xlongequal{} & |W| \longrightarrow & |Z| & \end{array}
$$
...
diagram
$$
\begin{array}{ccc}|(V \times_Y Z) \times_V (V \times_Y X)| \xlongequal{}\searrow & |V \times_Y X| \longrightarrow\downarrow & |Z \times_Y X| \downarrow \\  & |V \times_Y Z| \longrightarrow & |Z|\end{array}
$$
...
\begin{lemma}[Space over field universally open]
\label{spaces-morphisms-lemma-space-over-field-universally-open}
\source{stacks:06DN}
\href{https://stacks.math.columbia.edu/tag/06DN}{\texttt{Stacks tag 06DN}}
\group{spaces-morphisms}
...
Lemma \ref{spaces-morphisms-lemma-universally-open-local}.
\end{proof}
...
\source{stacks:0CFQ}
\href{https://stacks.math.columbia.edu/tag/0CFQ}{\texttt{Stacks tag 0CFQ}}
\group{spaces-morphisms}
...
\source{stacks:0412}
\href{https://stacks.math.columbia.edu/tag/0412}{\texttt{Stacks tag 0412}}
\group{spaces-morphisms}
...
\source{stacks:0CFR}
\href{https://stacks.math.columbia.edu/tag/0CFR}{\texttt{Stacks tag 0CFR}}
\group{spaces-morphisms}
...
\source{stacks:0CFS}
\href{https://stacks.math.columbia.edu/tag/0CFS}{\texttt{Stacks tag 0CFS}}
\group{spaces-morphisms}
...
By Section \ref{spaces-morphisms-section-representable} we know what it means for
...
\source{stacks:03HD}
\href{https://stacks.math.columbia.edu/tag/03HD}{\texttt{Stacks tag 03HD}}
\group{spaces-morphisms}
...
\source{stacks:03HE}
\href{https://stacks.math.columbia.edu/tag/03HE}{\texttt{Stacks tag 03HE}}
\group{spaces-morphisms}
...
By Lemma \ref{spaces-morphisms-lemma-characterize-representable-quasi-compact}
above this agrees with the already existing notion
for representable morphisms of algebraic spaces.

\begin{lemma}[Quasi compact is quasi compact]
\label{spaces-morphisms-lemma-quasi-compact-is-quasi-compact}
\source{stacks:0EMK}
\href{https://stacks.math.columbia.edu/tag/0EMK}{\texttt{Stacks tag 0EMK}}
\group{spaces-morphisms}
...
space by Definition \ref{spaces-morphisms-definition-quasi-compact}.
...
\source{stacks:03HF}
\href{https://stacks.math.columbia.edu/tag/03HF}{\texttt{Stacks tag 03HF}}
\group{spaces-morphisms}
...
\source{stacks:03HG}
\href{https://stacks.math.columbia.edu/tag/03HG}{\texttt{Stacks tag 03HG}}
\group{spaces-morphisms}
...
\begin{lemma}[The image of a quasi-compact algebraic space under a surjective morphism is quasi-compact.]
\label{spaces-morphisms-lemma-surjection-from-quasi-compact}
\source{stacks:040W}
\href{https://stacks.math.columbia.edu/tag/040W}{\texttt{Stacks tag 040W}}
\group{spaces-morphisms}
...
Definition \ref{spaces-morphisms-definition-surjective}
...
\source{stacks:04ZJ}
\href{https://stacks.math.columbia.edu/tag/04ZJ}{\texttt{Stacks tag 04ZJ}}
\group{spaces-morphisms}
...
\begin{lemma}[Quasi-compact morphisms of algebraic spaces are preserved under pullback and local on t...]
\label{spaces-morphisms-lemma-quasi-compact-local}
\source{stacks:03KG}
\href{https://stacks.math.columbia.edu/tag/03KG}{\texttt{Stacks tag 03KG}}
\group{spaces-morphisms}
...
\begin{proof}
We will use Lemma \ref{spaces-morphisms-lemma-base-change-quasi-compact}
...
Lemma \ref{spaces-morphisms-lemma-descent-quasi-compact}
and the fact that an \'etale morphism of algebraic spaces is universally open
(see discussion following
Definition \ref{spaces-morphisms-definition-open}).
...
\source{stacks:03KS}
\href{https://stacks.math.columbia.edu/tag/03KS}{\texttt{Stacks tag 03KS}}
\group{spaces-morphisms}
...
is quasi-compact by Lemma \ref{spaces-morphisms-lemma-section-immersion}
because it is a section of the quasi-separated morphism $X \times_Z Y \to X$
(a base change of $g$, see Lemma \ref{spaces-morphisms-lemma-base-change-separated}).
...
morphisms are quasi-compact, see Lemma \ref{spaces-morphisms-lemma-composition-quasi-compact}.
\end{proof}
...
\source{stacks:073B}
\href{https://stacks.math.columbia.edu/tag/073B}{\texttt{Stacks tag 073B}}
\group{spaces-morphisms}
...
Lemmas \ref{spaces-morphisms-lemma-base-change-quasi-compact} and
...
$Z$, see
Lemmas \ref{spaces-morphisms-lemma-separated-over-separated} and
...
\source{stacks:03XD}
\href{https://stacks.math.columbia.edu/tag/03XD}{\texttt{Stacks tag 03XD}}
\group{spaces-morphisms}
...
\source{stacks:03HI}
\href{https://stacks.math.columbia.edu/tag/03HI}{\texttt{Stacks tag 03HI}}
\group{spaces-morphisms}
...
\source{stacks:03IS}
\href{https://stacks.math.columbia.edu/tag/03IS}{\texttt{Stacks tag 03IS}}
\group{spaces-morphisms}
...
\source{stacks:03IU}
\href{https://stacks.math.columbia.edu/tag/03IU}{\texttt{Stacks tag 03IU}}
\group{spaces-morphisms}
...
\source{stacks:03IT}
\href{https://stacks.math.columbia.edu/tag/03IT}{\texttt{Stacks tag 03IT}}
\group{spaces-morphisms}
...
\begin{example}[Strange universally closed]
\label{spaces-morphisms-example-strange-universally-closed}
\source{stacks:03IV}
\href{https://stacks.math.columbia.edu/tag/03IV}{\texttt{Stacks tag 03IV}}
\group{spaces-morphisms}
...
closed by Lemma \ref{spaces-morphisms-lemma-universally-closed-local}.
\end{example}

\begin{lemma}[Universally closed quasi compact]
\label{spaces-morphisms-lemma-universally-closed-quasi-compact}
\source{stacks:04XW}
\href{https://stacks.math.columbia.edu/tag/04XW}{\texttt{Stacks tag 04XW}}
\group{spaces-morphisms}
...
$$
\begin{array}{ccc}Z \longrightarrow\searrow & T \times_Y X \overset{f_T}{\downarrow}\underset{q}{\longrightarrow} & X \overset{f}{\downarrow} \\  & T \overset{p}{\longrightarrow} & Y\end{array}
$$
...
\begin{lemma}[Image universally closed separated]
\label{spaces-morphisms-lemma-image-universally-closed-separated}
\source{stacks:05Z2}
\href{https://stacks.math.columbia.edu/tag/05Z2}{\texttt{Stacks tag 05Z2}}
\group{spaces-morphisms}
...
$$
\begin{array}{ccc}X \downarrow\underset{\Delta_{X/B}}{\longrightarrow} &  & X \times_B X \downarrow \\ Y \overset{\Delta_{Y/B}}{\longrightarrow} &  & Y \times_B Y\end{array}
$$
...
according to Section \ref{spaces-morphisms-section-representable} if for every scheme
...
\source{stacks:042L}
\href{https://stacks.math.columbia.edu/tag/042L}{\texttt{Stacks tag 042L}}
\group{spaces-morphisms}
...
\source{stacks:042M}
\href{https://stacks.math.columbia.edu/tag/042M}{\texttt{Stacks tag 042M}}
\group{spaces-morphisms}
...
The following are equivalent:
\begin{enumerate}
\item $j$ is a monomorphism (as in Definition \ref{spaces-morphisms-definition-monomorphism}),
...
\source{stacks:042N}
\href{https://stacks.math.columbia.edu/tag/042N}{\texttt{Stacks tag 042N}}
\group{spaces-morphisms}
...
and Lemma \ref{spaces-morphisms-lemma-monomorphism} above.
\end{proof}

\begin{lemma}[Composition monomorphism]
\label{spaces-morphisms-lemma-composition-monomorphism}
\source{stacks:042O}
\href{https://stacks.math.columbia.edu/tag/042O}{\texttt{Stacks tag 042O}}
\group{spaces-morphisms}
...
\source{stacks:042P}
\href{https://stacks.math.columbia.edu/tag/042P}{\texttt{Stacks tag 042P}}
\group{spaces-morphisms}
...
\begin{lemma}[Monomorphism local]
\label{spaces-morphisms-lemma-monomorphism-local}
\source{stacks:042Q}
\href{https://stacks.math.columbia.edu/tag/042Q}{\texttt{Stacks tag 042Q}}
\group{spaces-morphisms}
...
\begin{lemma}[Immersions monomorphisms]
\label{spaces-morphisms-lemma-immersions-monomorphisms}
\source{stacks:042R}
\href{https://stacks.math.columbia.edu/tag/042R}{\texttt{Stacks tag 042R}}
\group{spaces-morphisms}
...
\begin{lemma}[Monomorphism toward field]
\label{spaces-morphisms-lemma-monomorphism-toward-field}
\source{stacks:06MG}
\href{https://stacks.math.columbia.edu/tag/06MG}{\texttt{Stacks tag 06MG}}
\group{spaces-morphisms}
...
\begin{proof}
By
Lemmas \ref{spaces-morphisms-lemma-monomorphism-separated} and
...
\begin{lemma}[Monomorphism injective points]
\label{spaces-morphisms-lemma-monomorphism-injective-points}
\source{stacks:06RV}
\href{https://stacks.math.columbia.edu/tag/06RV}{\texttt{Stacks tag 06RV}}
\group{spaces-morphisms}
...
\begin{lemma}[Compute pushforward]
\label{spaces-morphisms-lemma-compute-pushforward}
\source{stacks:03M8}
\href{https://stacks.math.columbia.edu/tag/03M8}{\texttt{Stacks tag 03M8}}
\group{spaces-morphisms}
...
\source{stacks:03M9}
\href{https://stacks.math.columbia.edu/tag/03M9}{\texttt{Stacks tag 03M9}}
\group{spaces-morphisms}
...
By Lemma \ref{spaces-morphisms-lemma-compute-pushforward} we get an exact sequence
$$
0 \to f_*\mathcal{F} \to a_*(\mathcal{F}|_U) \to b_*(\mathcal{F}|_R).
$$
where $R = U \times_X U$.
...
resp.\ immersion) in the sense of Section \ref{spaces-morphisms-section-representable}.
...
\begin{lemma}[Closed immersion local]
\label{spaces-morphisms-lemma-closed-immersion-local}
\source{stacks:03M4}
\href{https://stacks.math.columbia.edu/tag/03M4}{\texttt{Stacks tag 03M4}}
\group{spaces-morphisms}
...
base (see Section \ref{spaces-morphisms-section-representable}).
...
\begin{lemma}[Immersion permanence]
\label{spaces-morphisms-lemma-immersion-permanence}
\source{stacks:0AGC}
\href{https://stacks.math.columbia.edu/tag/0AGC}{\texttt{Stacks tag 0AGC}}
\group{spaces-morphisms}
...
$$
\begin{array}{ccc}Z \longrightarrow\searrow & Y \times_X Z \longrightarrow\downarrow & Z \downarrow \\  & Y \longrightarrow & X\end{array}
$$
...
\begin{lemma}[Immersion when closed]
\label{spaces-morphisms-lemma-immersion-when-closed}
\source{stacks:04CD}
\href{https://stacks.math.columbia.edu/tag/04CD}{\texttt{Stacks tag 04CD}}
\group{spaces-morphisms}
...
is an immersion of schemes. By Lemma \ref{spaces-morphisms-lemma-closed-immersion-local}
...
\begin{remark}[Immersion]
\label{spaces-morphisms-remark-immersion}
\source{stacks:04CE}
\href{https://stacks.math.columbia.edu/tag/04CE}{\texttt{Stacks tag 04CE}}
\group{spaces-morphisms}
...
\begin{remark}[Space structure locally closed subset]
\label{spaces-morphisms-remark-space-structure-locally-closed-subset}
\source{stacks:06EC}
\href{https://stacks.math.columbia.edu/tag/06EC}{\texttt{Stacks tag 06EC}}
\group{spaces-morphisms}
...
\begin{lemma}[Factor the other way]
\label{spaces-morphisms-lemma-factor-the-other-way}
\source{stacks:081U}
\href{https://stacks.math.columbia.edu/tag/081U}{\texttt{Stacks tag 081U}}
\group{spaces-morphisms}
...
Spaces, Section \ref{spaces-section-Zariski}
and
Section \ref{spaces-morphisms-section-immersions} in this chapter.
This section is the analogue of
Morphisms, Section \ref{morphisms-section-closed-immersions}
for algebraic spaces.

\begin{lemma}[Closed immersion ideals]
\label{spaces-morphisms-lemma-closed-immersion-ideals}
\source{stacks:03MB}
\href{https://stacks.math.columbia.edu/tag/03MB}{\texttt{Stacks tag 03MB}}
\group{spaces-morphisms}
...
Consider the diagram
$$
\begin{array}{cc}U \times_X Z \longrightarrow\underset{i'}{\downarrow} & Z \overset{i}{\downarrow} \\ U \longrightarrow & X\end{array}
$$
By
...
\begin{definition}[Inverse image closed subspace]
\label{spaces-morphisms-definition-inverse-image-closed-subspace}
\source{stacks:083Q}
\href{https://stacks.math.columbia.edu/tag/083Q}{\texttt{Stacks tag 083Q}}
\group{spaces-morphisms}
...
This definition makes sense by Lemma \ref{spaces-morphisms-lemma-closed-immersion-local}.
If $\mathcal{I} \subset \mathcal{O}_X$ is the quasi-coherent sheaf of
ideals corresponding to $Z$ via Lemma \ref{spaces-morphisms-lemma-closed-immersion-ideals} then
...
\source{stacks:04CG}
\href{https://stacks.math.columbia.edu/tag/04CG}{\texttt{Stacks tag 04CG}}
\group{spaces-morphisms}
...
\begin{lemma}[Closed immersion separated]
\label{spaces-morphisms-lemma-closed-immersion-separated}
\source{stacks:04CH}
\href{https://stacks.math.columbia.edu/tag/04CH}{\texttt{Stacks tag 04CH}}
\group{spaces-morphisms}
...
\begin{lemma}[Closed immersion push pull]
\label{spaces-morphisms-lemma-closed-immersion-push-pull}
\source{stacks:04E5}
\href{https://stacks.math.columbia.edu/tag/04E5}{\texttt{Stacks tag 04E5}}
\group{spaces-morphisms}
...
\begin{lemma}[Stalk push closed]
\label{spaces-morphisms-lemma-stalk-push-closed}
\source{stacks:0DK1}
\href{https://stacks.math.columbia.edu/tag/0DK1}{\texttt{Stacks tag 0DK1}}
\group{spaces-morphisms}
...
\begin{lemma}[Closed immersion rings]
\label{spaces-morphisms-lemma-closed-immersion-rings}
\source{stacks:04G0}
\href{https://stacks.math.columbia.edu/tag/04G0}{\texttt{Stacks tag 04G0}}
\group{spaces-morphisms}
...
Lemma \ref{spaces-morphisms-lemma-stalk-push-closed}.
\end{proof}
...
\source{stacks:04CJ}
\href{https://stacks.math.columbia.edu/tag/04CJ}{\texttt{Stacks tag 04CJ}}
\group{spaces-morphisms}
...
Lemma \ref{spaces-morphisms-lemma-closed-immersion-rings} applied with
...
Lemma \ref{spaces-morphisms-lemma-closed-immersion-push-pull}
...
Lemmas \ref{spaces-morphisms-lemma-closed-immersion-quasi-compact} and
\ref{spaces-morphisms-lemma-closed-immersion-separated}. Hence
Lemma \ref{spaces-morphisms-lemma-pushforward}
...
\begin{lemma}[Largest quasi coherent subsheaf]
\label{spaces-morphisms-lemma-largest-quasi-coherent-subsheaf}
\source{stacks:04CK}
\href{https://stacks.math.columbia.edu/tag/04CK}{\texttt{Stacks tag 04CK}}
\group{spaces-morphisms}
...
\begin{lemma}[I upper shriek]
\label{spaces-morphisms-lemma-i-upper-shriek}
\source{stacks:04CL}
\href{https://stacks.math.columbia.edu/tag/04CL}{\texttt{Stacks tag 04CL}}
\group{spaces-morphisms}
...
Lemma \ref{spaces-morphisms-lemma-largest-quasi-coherent-subsheaf}
...
\begin{definition}[Scheme theoretic intersection union]
\label{spaces-morphisms-definition-scheme-theoretic-intersection-union}
\source{stacks:0CYZ}
\href{https://stacks.math.columbia.edu/tag/0CYZ}{\texttt{Stacks tag 0CYZ}}
\group{spaces-morphisms}
...
\begin{lemma}[Scheme theoretic intersection]
\label{spaces-morphisms-lemma-scheme-theoretic-intersection}
\source{stacks:0CZ0}
\href{https://stacks.math.columbia.edu/tag/0CZ0}{\texttt{Stacks tag 0CZ0}}
\group{spaces-morphisms}
...
and
$$
\begin{array}{cc}Z \cap Y \longrightarrow\downarrow & Z \downarrow \\ Y \longrightarrow & X\end{array}
$$
...
by Lemma \ref{spaces-morphisms-lemma-closed-immersion-ideals}.
...
\begin{lemma}[Scheme theoretic union]
\label{spaces-morphisms-lemma-scheme-theoretic-union}
\source{stacks:0CZ1}
\href{https://stacks.math.columbia.edu/tag/0CZ1}{\texttt{Stacks tag 0CZ1}}
\group{spaces-morphisms}
...
$$
\begin{array}{cc}Y \cap Z \longrightarrow\downarrow & Y \downarrow \\ Z \longrightarrow & Y \cup Z\end{array}
$$
...
by Lemma \ref{spaces-morphisms-lemma-closed-immersion-ideals}. In the short exact sequence
we use the equivalence of Lemma \ref{spaces-morphisms-lemma-i-star-equivalence} to think of
...
\begin{lemma}[Support covering]
\label{spaces-morphisms-lemma-support-covering}
\source{stacks:07TY}
\href{https://stacks.math.columbia.edu/tag/07TY}{\texttt{Stacks tag 07TY}}
\group{spaces-morphisms}
...
\begin{lemma}[Support finite type]
\label{spaces-morphisms-lemma-support-finite-type}
\source{stacks:07TZ}
\href{https://stacks.math.columbia.edu/tag/07TZ}{\texttt{Stacks tag 07TZ}}
\group{spaces-morphisms}
...
By Lemma \ref{spaces-morphisms-lemma-support-covering} the inverse image of the support of
...
\begin{lemma}[Scheme theoretic support]
\label{spaces-morphisms-lemma-scheme-theoretic-support}
\source{stacks:07U0}
\href{https://stacks.math.columbia.edu/tag/07U0}{\texttt{Stacks tag 07U0}}
\group{spaces-morphisms}
...
Lemma \ref{spaces-morphisms-lemma-support-covering}.
Detailed proofs omitted.
\end{proof}

\begin{definition}[Scheme theoretic support]
\label{spaces-morphisms-definition-scheme-theoretic-support}
\source{stacks:07U1}
\href{https://stacks.math.columbia.edu/tag/07U1}{\texttt{Stacks tag 07U1}}
\group{spaces-morphisms}

Let $S$ be a scheme. Let $X$ be an algebraic space over $S$.
Let $\mathcal{F}$ be a finite type quasi-coherent $\mathcal{O}_X$-module.
The {\it scheme theoretic support of $\mathcal{F}$} is the closed subspace
$Z \subset X$ constructed in Lemma \ref{spaces-morphisms-lemma-scheme-theoretic-support}.
\end{definition}
...
Lemma \ref{spaces-morphisms-lemma-i-star-equivalence}).
...
\begin{lemma}[The scheme-theoretic image of a morphism of algebraic spaces exists.]
\label{spaces-morphisms-lemma-scheme-theoretic-image}
\source{stacks:082X}
\href{https://stacks.math.columbia.edu/tag/082X}{\texttt{Stacks tag 082X}}
\group{spaces-morphisms}
...
$\mathcal{I}$.
This follows from Lemma \ref{spaces-morphisms-lemma-largest-quasi-coherent-subsheaf}.
\end{proof}

Suppose that in the situation of Lemma \ref{spaces-morphisms-lemma-scheme-theoretic-image}
...
The reason is that closed subspaces (or subschemes) are in an inclusion
...
\source{stacks:082Y}
\href{https://stacks.math.columbia.edu/tag/082Y}{\texttt{Stacks tag 082Y}}
\group{spaces-morphisms}

Let $S$ be a scheme. Let $f : X \to Y$ be a morphism of algebraic spaces
over $S$. The {\it scheme theoretic image} of $f$ is the smallest closed
subspace $Z \subset Y$ through which $f$
factors, see Lemma \ref{spaces-morphisms-lemma-scheme-theoretic-image} above.
\end{definition}
...
\begin{lemma}[Quasi compact scheme theoretic image]
\label{spaces-morphisms-lemma-quasi-compact-scheme-theoretic-image}
\source{stacks:082Z}
\href{https://stacks.math.columbia.edu/tag/082Z}{\texttt{Stacks tag 082Z}}
\group{spaces-morphisms}
...
If (1) holds then in the proof of Lemma \ref{spaces-morphisms-lemma-scheme-theoretic-image}
...
By Lemma \ref{spaces-morphisms-lemma-pushforward}
...
\begin{lemma}[Scheme theoretic image reduced]
\label{spaces-morphisms-lemma-scheme-theoretic-image-reduced}
\source{stacks:0830}
\href{https://stacks.math.columbia.edu/tag/0830}{\texttt{Stacks tag 0830}}
\group{spaces-morphisms}
...
\source{stacks:089B}
\href{https://stacks.math.columbia.edu/tag/089B}{\texttt{Stacks tag 089B}}
\group{spaces-morphisms}
...
$$
\begin{array}{ccc}\Spec(K) \longrightarrow\downarrow &  & X \downarrow\swarrow \\ \Spec(A) \longrightarrow & Z \longrightarrow & Y\end{array}
$$
...
By Lemma \ref{spaces-morphisms-lemma-quasi-compact-scheme-theoretic-image} we have
...
$$
\begin{array}{cccc}\Spec(K) \longrightarrow\downarrow & W \longrightarrow\downarrow & X \times_Y V \downarrow\longrightarrow & X \downarrow \\ \Spec(A) \longrightarrow & Z' \longrightarrow & V \longrightarrow & Y\end{array}
$$
such that the closed point of $\Spec(A)$ maps to $z'$.
...
\source{stacks:0CP2}
\href{https://stacks.math.columbia.edu/tag/0CP2}{\texttt{Stacks tag 0CP2}}
\group{spaces-morphisms}

Let $S$ be a scheme. Let
$$
\begin{array}{cc}X_1 \downarrow\underset{f_1}{\longrightarrow} & Y_1 \downarrow \\ X_2 \overset{f_2}{\longrightarrow} & Y_2\end{array}
$$
...
commutative diagram
$$
\begin{array}{ccc}X_1 \longrightarrow\downarrow & Z_1 \downarrow\longrightarrow & Y_1 \downarrow \\ X_2 \longrightarrow & Z_2 \longrightarrow & Y_2\end{array}
$$
\end{lemma}
...
\source{stacks:0CP3}
\href{https://stacks.math.columbia.edu/tag/0CP3}{\texttt{Stacks tag 0CP3}}
\group{spaces-morphisms}
...
\begin{proof}
By Lemma \ref{spaces-morphisms-lemma-quasi-compact-permanence}
...
\begin{lemma}[Scheme theoretically dense representable]
\label{spaces-morphisms-lemma-scheme-theoretically-dense-representable}
\source{stacks:0832}
\href{https://stacks.math.columbia.edu/tag/0832}{\texttt{Stacks tag 0832}}
\group{spaces-morphisms}
...
commutative diagram
$$
\begin{array}{cc}V \longrightarrow\underset{\pi}{\downarrow} & X \overset{f}{\downarrow} \\ U \longrightarrow & S,\end{array}
$$
...
\begin{lemma}[Scheme theoretically dense]
\label{spaces-morphisms-lemma-scheme-theoretically-dense}
\source{stacks:0833}
\href{https://stacks.math.columbia.edu/tag/0833}{\texttt{Stacks tag 0833}}
\group{spaces-morphisms}
...
Thus Lemma \ref{spaces-morphisms-lemma-scheme-theoretically-dense-representable}
...
It follows from
Lemma \ref{spaces-morphisms-lemma-scheme-theoretically-dense}
that the following definition is compatible with the definition
in the case of schemes.

\begin{definition}[Scheme theoretically dense]
\label{spaces-morphisms-definition-scheme-theoretically-dense}
\source{stacks:0834}
\href{https://stacks.math.columbia.edu/tag/0834}{\texttt{Stacks tag 0834}}
\group{spaces-morphisms}
...
Lemma \ref{spaces-morphisms-lemma-scheme-theoretically-dense} are satisfied.
\end{enumerate}
\end{definition}
...
\begin{lemma}[Scheme theoretically dense quasi compact]
\label{spaces-morphisms-lemma-scheme-theoretically-dense-quasi-compact}
\source{stacks:0835}
\href{https://stacks.math.columbia.edu/tag/0835}{\texttt{Stacks tag 0835}}
\group{spaces-morphisms}
...
\begin{proof}
Follows from Lemma \ref{spaces-morphisms-lemma-quasi-compact-scheme-theoretic-image} part (3).
\end{proof}

\begin{lemma}[Characterize scheme theoretically dense]
\label{spaces-morphisms-lemma-characterize-scheme-theoretically-dense}
\source{stacks:0836}
\href{https://stacks.math.columbia.edu/tag/0836}{\texttt{Stacks tag 0836}}
\group{spaces-morphisms}
...
Lemma \ref{spaces-morphisms-lemma-scheme-theoretic-image}.
...
\begin{lemma}[Intersection scheme theoretically dense]
\label{spaces-morphisms-lemma-intersection-scheme-theoretically-dense}
\source{stacks:0837}
\href{https://stacks.math.columbia.edu/tag/0837}{\texttt{Stacks tag 0837}}
\group{spaces-morphisms}
...
By Lemma \ref{spaces-morphisms-lemma-characterize-scheme-theoretically-dense}
both maps are injective. Hence the composite is injective.
Hence by Lemma \ref{spaces-morphisms-lemma-characterize-scheme-theoretically-dense}
$U \cap V$ is scheme theoretically dense in $X$.
\end{proof}

\begin{lemma}[Quasi compact immersion]
\label{spaces-morphisms-lemma-quasi-compact-immersion}
\source{stacks:088G}
\href{https://stacks.math.columbia.edu/tag/088G}{\texttt{Stacks tag 088G}}
\group{spaces-morphisms}
...
Lemmas \ref{spaces-morphisms-lemma-quasi-compact-scheme-theoretic-image} and
...
\begin{lemma}[Equality of morphisms]
\label{spaces-morphisms-lemma-equality-of-morphisms}
\source{stacks:084N}
\href{https://stacks.math.columbia.edu/tag/084N}{\texttt{Stacks tag 084N}}
\group{spaces-morphisms}
...
\source{stacks:0ABL}
\href{https://stacks.math.columbia.edu/tag/0ABL}{\texttt{Stacks tag 0ABL}}
\group{spaces-morphisms}
...
\begin{lemma}[Universally injective representable]
\label{spaces-morphisms-lemma-universally-injective-representable}
\source{stacks:03MU}
\href{https://stacks.math.columbia.edu/tag/03MU}{\texttt{Stacks tag 03MU}}
\group{spaces-morphisms}

Let $S$ be a scheme. Let $f : X \to Y$ be a representable
morphism of algebraic spaces over $S$. Then $f$ is universally injective
(in the sense of Section \ref{spaces-morphisms-section-representable})
...
\source{stacks:040X}
\href{https://stacks.math.columbia.edu/tag/040X}{\texttt{Stacks tag 040X}}
\group{spaces-morphisms}
...
$$
\begin{array}{cccc}\Spec(\Omega) \searrow\overset{\alpha_1}{\searrow}\underset{\alpha_2}{\longrightarrow} & \Spec(K_2) \overset{\varphi_2}{\searrow} &  &  \\  & \Spec(K_1) \overset{\varphi_1}{\longrightarrow} & Y' \times_Y X  \overset{f'}{\downarrow}\overset{g'}{\longrightarrow} & X \overset{f}{\downarrow} \\  &  & Y' \overset{g}{\longrightarrow} & Y.\end{array}
$$
...
$$
\begin{array}{cc}\Spec(\Omega) \underset{\alpha_1}{\longrightarrow}\underset{\alpha_2}{\downarrow} & \Spec(K) \overset{a}{\downarrow} \\ \Spec(K) \overset{b}{\longrightarrow} & \Spec(K) \times_{c, Y} X\end{array}
$$
...
\source{stacks:03MV}
\href{https://stacks.math.columbia.edu/tag/03MV}{\texttt{Stacks tag 03MV}}
\group{spaces-morphisms}
...
\begin{remark}[Universally injective not separated]
\label{spaces-morphisms-remark-universally-injective-not-separated}
\source{stacks:05VS}
\href{https://stacks.math.columbia.edu/tag/05VS}{\texttt{Stacks tag 05VS}}
\group{spaces-morphisms}
...
\source{stacks:03MW}
\href{https://stacks.math.columbia.edu/tag/03MW}{\texttt{Stacks tag 03MW}}
\group{spaces-morphisms}
...
\source{stacks:03MX}
\href{https://stacks.math.columbia.edu/tag/03MX}{\texttt{Stacks tag 03MX}}
\group{spaces-morphisms}
...
\source{stacks:03MY}
\href{https://stacks.math.columbia.edu/tag/03MY}{\texttt{Stacks tag 03MY}}
\group{spaces-morphisms}
...
\begin{lemma}[Affine representable]
\label{spaces-morphisms-lemma-affine-representable}
\source{stacks:03WE}
\href{https://stacks.math.columbia.edu/tag/03WE}{\texttt{Stacks tag 03WE}}
\group{spaces-morphisms}

Let $S$ be a scheme. Let $f : X \to Y$ be a representable morphism
of algebraic spaces over $S$. Then
$f$ is affine (in the sense of Section \ref{spaces-morphisms-section-representable})
...
\source{stacks:03WF}
\href{https://stacks.math.columbia.edu/tag/03WF}{\texttt{Stacks tag 03WF}}
\group{spaces-morphisms}
...
\begin{lemma}[Affine local]
\label{spaces-morphisms-lemma-affine-local}
\source{stacks:03WG}
\href{https://stacks.math.columbia.edu/tag/03WG}{\texttt{Stacks tag 03WG}}
\group{spaces-morphisms}
...
\source{stacks:03WH}
\href{https://stacks.math.columbia.edu/tag/03WH}{\texttt{Stacks tag 03WH}}
\group{spaces-morphisms}
...
\source{stacks:03WI}
\href{https://stacks.math.columbia.edu/tag/03WI}{\texttt{Stacks tag 03WI}}
\group{spaces-morphisms}
...
\begin{lemma}[Closed immersion affine]
\label{spaces-morphisms-lemma-closed-immersion-affine}
\source{stacks:07U2}
\href{https://stacks.math.columbia.edu/tag/07U2}{\texttt{Stacks tag 07U2}}
\group{spaces-morphisms}
...
\begin{lemma}[Affine equivalence algebras]
\label{spaces-morphisms-lemma-affine-equivalence-algebras}
\source{stacks:081V}
\href{https://stacks.math.columbia.edu/tag/081V}{\texttt{Stacks tag 081V}}
\group{spaces-morphisms}
...
$$
\vcenter{
\begin{array}{cc}W \underset{s'}{\longrightarrow}\downarrow & V \downarrow \\ R \overset{s}{\longrightarrow} & U\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}W \underset{t'}{\longrightarrow}\downarrow & V \downarrow \\ R \overset{t}{\longrightarrow} & U\end{array}
}
$$
...
Lemma \ref{spaces-morphisms-lemma-affine-local}. Finally, the isomorphism of
$$
...
\begin{definition}[Relative spec]
\label{spaces-morphisms-definition-relative-spec}
\source{stacks:081W}
\href{https://stacks.math.columbia.edu/tag/081W}{\texttt{Stacks tag 081W}}
\group{spaces-morphisms}
...
Lemma \ref{spaces-morphisms-lemma-affine-equivalence-algebras}.
\end{definition}

Forming the relative spectrum commutes with arbitrary base change.

\begin{remark}[Factorization quasi compact quasi separated]
\label{spaces-morphisms-remark-factorization-quasi-compact-quasi-separated}
\source{stacks:081X}
\href{https://stacks.math.columbia.edu/tag/081X}{\texttt{Stacks tag 081X}}
\group{spaces-morphisms}
...
by Lemma \ref{spaces-morphisms-lemma-pushforward}. The morphism
...
Lemma \ref{spaces-morphisms-lemma-affine-equivalence-algebras}) whence a factorization
of $f$ as above.
\end{remark}

\begin{lemma}[Affine equivalence modules]
\label{spaces-morphisms-lemma-affine-equivalence-modules}
\source{stacks:08AI}
\href{https://stacks.math.columbia.edu/tag/08AI}{\texttt{Stacks tag 08AI}}
\group{spaces-morphisms}
...
\source{stacks:08GB}
\href{https://stacks.math.columbia.edu/tag/08GB}{\texttt{Stacks tag 08GB}}
\group{spaces-morphisms}
...
Lemma \ref{spaces-morphisms-lemma-base-change-affine}.
The composition of affine morphisms is affine
(see Lemma \ref{spaces-morphisms-lemma-composition-affine}) and (1) follows.
Part (2) follows from (1) as a closed immersion is affine
(see Lemma \ref{spaces-morphisms-lemma-closed-immersion-affine}) and $Y/B$ separated
means $\Delta$ is a closed immersion. Parts (3) and (4) are special
cases of (1) and (2).
\end{proof}

\begin{lemma}[Artinian affine]
\label{spaces-morphisms-lemma-Artinian-affine}
\source{stacks:09TF}
\href{https://stacks.math.columbia.edu/tag/09TF}{\texttt{Stacks tag 09TF}}
\group{spaces-morphisms}
...
Lemma \ref{spaces-morphisms-lemma-affine-local}. Since $X$ is quasi-separated the
...
\begin{lemma}[Quasi affine representable]
\label{spaces-morphisms-lemma-quasi-affine-representable}
\source{stacks:03WK}
\href{https://stacks.math.columbia.edu/tag/03WK}{\texttt{Stacks tag 03WK}}
\group{spaces-morphisms}

Let $S$ be a scheme. Let $f : X \to Y$ be a representable
morphism of algebraic spaces over $S$. Then
$f$ is quasi-affine (in the sense of Section \ref{spaces-morphisms-section-representable})
if and only if for all affine schemes $Z$
...
\begin{definition}[Quasi affine]
\label{spaces-morphisms-definition-quasi-affine}
\source{stacks:03WL}
\href{https://stacks.math.columbia.edu/tag/03WL}{\texttt{Stacks tag 03WL}}
\group{spaces-morphisms}
...
\begin{lemma}[Quasi affine local]
\label{spaces-morphisms-lemma-quasi-affine-local}
\source{stacks:03WM}
\href{https://stacks.math.columbia.edu/tag/03WM}{\texttt{Stacks tag 03WM}}
\group{spaces-morphisms}
...
\begin{lemma}[Composition quasi affine]
\label{spaces-morphisms-lemma-composition-quasi-affine}
\source{stacks:03WN}
\href{https://stacks.math.columbia.edu/tag/03WN}{\texttt{Stacks tag 03WN}}
\group{spaces-morphisms}
...
\begin{lemma}[Base change quasi affine]
\label{spaces-morphisms-lemma-base-change-quasi-affine}
\source{stacks:03WO}
\href{https://stacks.math.columbia.edu/tag/03WO}{\texttt{Stacks tag 03WO}}
\group{spaces-morphisms}
...
\begin{lemma}[Characterize quasi affine]
\label{spaces-morphisms-lemma-characterize-quasi-affine}
\source{stacks:086S}
\href{https://stacks.math.columbia.edu/tag/086S}{\texttt{Stacks tag 086S}}
\group{spaces-morphisms}
...
(Remark \ref{spaces-morphisms-remark-factorization-quasi-compact-quasi-separated})
...
$U$ (Lemma \ref{spaces-morphisms-lemma-quasi-affine-local}), since $f_*\mathcal{O}_Y|_V$
...
\source{stacks:03MJ}
\href{https://stacks.math.columbia.edu/tag/03MJ}{\texttt{Stacks tag 03MJ}}
\group{spaces-morphisms}
...
of Section \ref{spaces-morphisms-section-representable}.
\end{lemma}
...
$$
\begin{array}{ccc}U \underset{h}{\downarrow} & U \times_X U' \longleftarrow\overset{(h, h')}{\downarrow}\longrightarrow & U' \overset{h'}{\downarrow} \\ V & V \times_Y V' \longleftarrow\longrightarrow & V'\end{array}
$$
By
...
$$
\begin{array}{cc}Z \times_Y U \downarrow\longrightarrow & Z \times_Y V \downarrow \\ Z \times_Y X \longrightarrow & Z\end{array}
$$
...
\source{stacks:04RD}
\href{https://stacks.math.columbia.edu/tag/04RD}{\texttt{Stacks tag 04RD}}
\group{spaces-morphisms}
...
\begin{remark}[Composition P]
\label{spaces-morphisms-remark-composition-P}
\source{stacks:0AML}
\href{https://stacks.math.columbia.edu/tag/0AML}{\texttt{Stacks tag 0AML}}
\group{spaces-morphisms}
...
\begin{remark}[Base change P]
\label{spaces-morphisms-remark-base-change-P}
\source{stacks:0AMM}
\href{https://stacks.math.columbia.edu/tag/0AMM}{\texttt{Stacks tag 0AMM}}
\group{spaces-morphisms}
...
\source{stacks:04NC}
\href{https://stacks.math.columbia.edu/tag/04NC}{\texttt{Stacks tag 04NC}}
\group{spaces-morphisms}
...
\begin{definition}[P at point]
\label{spaces-morphisms-definition-P-at-point}
\source{stacks:04RE}
\href{https://stacks.math.columbia.edu/tag/04RE}{\texttt{Stacks tag 04RE}}
\group{spaces-morphisms}
...
Lemma \ref{spaces-morphisms-lemma-local-source-target-at-point}
hold.
\end{definition}
...
\source{stacks:04RF}
\href{https://stacks.math.columbia.edu/tag/04RF}{\texttt{Stacks tag 04RF}}
\group{spaces-morphisms}
...
\begin{remark}[When apply]
\label{spaces-morphisms-remark-when-apply}
\source{stacks:04RG}
\href{https://stacks.math.columbia.edu/tag/04RG}{\texttt{Stacks tag 04RG}}
\group{spaces-morphisms}

We will apply
Lemma \ref{spaces-morphisms-lemma-local-source-target-global-implies-local}
...
\source{stacks:03XF}
\href{https://stacks.math.columbia.edu/tag/03XF}{\texttt{Stacks tag 03XF}}
\group{spaces-morphisms}
...
\source{stacks:03XG}
\href{https://stacks.math.columbia.edu/tag/03XG}{\texttt{Stacks tag 03XG}}
\group{spaces-morphisms}
...
\begin{proof}
See Remark \ref{spaces-morphisms-remark-composition-P} and
...
\source{stacks:03XH}
\href{https://stacks.math.columbia.edu/tag/03XH}{\texttt{Stacks tag 03XH}}
\group{spaces-morphisms}
...
\begin{proof}
See Remark \ref{spaces-morphisms-remark-base-change-P} and
Morphisms, Lemma \ref{morphisms-lemma-base-change-finite-type}.
\end{proof}

\begin{lemma}[Finite type local]
\label{spaces-morphisms-lemma-finite-type-local}
\source{stacks:040Y}
\href{https://stacks.math.columbia.edu/tag/040Y}{\texttt{Stacks tag 040Y}}
\group{spaces-morphisms}
...
type by Lemma \ref{spaces-morphisms-lemma-composition-finite-type}.
Hence (8) is true.
...
\source{stacks:04ZK}
\href{https://stacks.math.columbia.edu/tag/04ZK}{\texttt{Stacks tag 04ZK}}
\group{spaces-morphisms}
...
\begin{lemma}[Permanence finite type]
\label{spaces-morphisms-lemma-permanence-finite-type}
\source{stacks:0462}
\href{https://stacks.math.columbia.edu/tag/0462}{\texttt{Stacks tag 0462}}
\group{spaces-morphisms}
...
$$
\begin{array}{ccc}U \longrightarrow\downarrow & V \longrightarrow\downarrow & W \downarrow \\ X \longrightarrow & Y \longrightarrow & Z\end{array}
$$
...
\source{stacks:06ED}
\href{https://stacks.math.columbia.edu/tag/06ED}{\texttt{Stacks tag 06ED}}
\group{spaces-morphisms}
...
Here is a diagram
$$
\begin{array}{cc}\Spec(k) \underset{\overline{x}}{\longrightarrow}\underset{\overline{s}}{\searrow} & X \downarrow \\  & S.\end{array}
$$
...
\begin{lemma}[Locally finite type surjective geometric points]
\label{spaces-morphisms-lemma-locally-finite-type-surjective-geometric-points}
\source{stacks:0487}
\href{https://stacks.math.columbia.edu/tag/0487}{\texttt{Stacks tag 0487}}
\group{spaces-morphisms}
...
Lemmas \ref{spaces-morphisms-lemma-composition-surjective} and
...
Lemmas \ref{spaces-morphisms-lemma-base-change-surjective} and
...
all the cardinalities of residue fields of $T$. Note that if $R$
...
\begin{lemma}[Large enough]
\label{spaces-morphisms-lemma-large-enough}
\source{stacks:0488}
\href{https://stacks.math.columbia.edu/tag/0488}{\texttt{Stacks tag 0488}}
\group{spaces-morphisms}
...
\source{stacks:06EF}
\href{https://stacks.math.columbia.edu/tag/06EF}{\texttt{Stacks tag 06EF}}
\group{spaces-morphisms}
...
\source{stacks:06EG}
\href{https://stacks.math.columbia.edu/tag/06EG}{\texttt{Stacks tag 06EG}}
\group{spaces-morphisms}
...
Lemma \ref{spaces-morphisms-lemma-point-finite-type}
...
\source{stacks:06EH}
\href{https://stacks.math.columbia.edu/tag/06EH}{\texttt{Stacks tag 06EH}}
\group{spaces-morphisms}
...
\source{stacks:06EI}
\href{https://stacks.math.columbia.edu/tag/06EI}{\texttt{Stacks tag 06EI}}
\group{spaces-morphisms}
...
\source{stacks:06EJ}
\href{https://stacks.math.columbia.edu/tag/06EJ}{\texttt{Stacks tag 06EJ}}
\group{spaces-morphisms}
...
\source{stacks:06EK}
\href{https://stacks.math.columbia.edu/tag/06EK}{\texttt{Stacks tag 06EK}}
\group{spaces-morphisms}
...
Remark \ref{spaces-morphisms-remark-space-structure-locally-closed-subset}.
...
\source{stacks:06EL}
\href{https://stacks.math.columbia.edu/tag/06EL}{\texttt{Stacks tag 06EL}}
\group{spaces-morphisms}
...
the diagram
$$
\begin{array}{cc}u \downarrow\longrightarrow & U \downarrow \\ Z \longrightarrow & X\end{array}
$$
...
Lemma \ref{spaces-morphisms-lemma-finite-type-points-morphism}
(and
Lemma \ref{spaces-morphisms-lemma-enough-finite-type-points}
...
\begin{lemma}[Finite type nagata]
\label{spaces-morphisms-lemma-finite-type-nagata}
\source{stacks:0BAU}
\href{https://stacks.math.columbia.edu/tag/0BAU}{\texttt{Stacks tag 0BAU}}
\group{spaces-morphisms}
...
\begin{lemma}[Ubiquity nagata]
\label{spaces-morphisms-lemma-ubiquity-nagata}
\source{stacks:0BAV}
\href{https://stacks.math.columbia.edu/tag/0BAV}{\texttt{Stacks tag 0BAV}}
\group{spaces-morphisms}
...
\begin{proof}
The first property holds by Lemma \ref{spaces-morphisms-lemma-finite-type-nagata}.
...
\source{stacks:03XJ}
\href{https://stacks.math.columbia.edu/tag/03XJ}{\texttt{Stacks tag 03XJ}}
\group{spaces-morphisms}
...
Lemma \ref{spaces-morphisms-lemma-local-source-target} hold with
...
\begin{lemma}[Base change quasi finite locus]
\label{spaces-morphisms-lemma-base-change-quasi-finite-locus}
\source{stacks:0ABM}
\href{https://stacks.math.columbia.edu/tag/0ABM}{\texttt{Stacks tag 0ABM}}
\group{spaces-morphisms}
...
Descent, Remark \ref{descent-remark-list-local-source-target}.
Hence Lemmas \ref{spaces-morphisms-lemma-local-source-target-at-point} and
\ref{spaces-morphisms-lemma-local-source-target-global-implies-local} apply and
...
Part (4) follows from (3) and Lemma \ref{spaces-morphisms-lemma-base-change-quasi-compact}.
\end{proof}

\begin{lemma}[Composition quasi finite]
\label{spaces-morphisms-lemma-composition-quasi-finite}
\source{stacks:03XK}
\href{https://stacks.math.columbia.edu/tag/03XK}{\texttt{Stacks tag 03XK}}
\group{spaces-morphisms}
...
\source{stacks:03XL}
\href{https://stacks.math.columbia.edu/tag/03XL}{\texttt{Stacks tag 03XL}}
\group{spaces-morphisms}
...
\begin{proof}
Immediate consequence of Lemma \ref{spaces-morphisms-lemma-base-change-quasi-finite-locus}.
\end{proof}
...
\begin{lemma}[Locally quasi finite]
\label{spaces-morphisms-lemma-locally-quasi-finite}
\source{stacks:06RW}
\href{https://stacks.math.columbia.edu/tag/06RW}{\texttt{Stacks tag 06RW}}
\group{spaces-morphisms}
...
Picture
$$
\begin{array}{ccc}U \longrightarrow\searrow & X \times_Y V \downarrow\longrightarrow & V \downarrow \\  & X \longrightarrow & Y\end{array}
$$
...
\begin{lemma}[Quasi finite local]
\label{spaces-morphisms-lemma-quasi-finite-local}
\source{stacks:040Z}
\href{https://stacks.math.columbia.edu/tag/040Z}{\texttt{Stacks tag 040Z}}
\group{spaces-morphisms}
...
\begin{lemma}[Immersion quasi finite]
\label{spaces-morphisms-lemma-immersion-quasi-finite}
\source{stacks:03XM}
\href{https://stacks.math.columbia.edu/tag/03XM}{\texttt{Stacks tag 03XM}}
\group{spaces-morphisms}
...
\begin{lemma}[Permanence quasi finite]
\label{spaces-morphisms-lemma-permanence-quasi-finite}
\source{stacks:03XN}
\href{https://stacks.math.columbia.edu/tag/03XN}{\texttt{Stacks tag 03XN}}
\group{spaces-morphisms}
...
Choose a commutative diagram
$$
\begin{array}{ccc}U \downarrow\longrightarrow & V \downarrow\longrightarrow & W \downarrow \\ X \longrightarrow & Y \longrightarrow & Z\end{array}
$$
...
\begin{lemma}[Quasi finite at a finite number of points]
\label{spaces-morphisms-lemma-quasi-finite-at-a-finite-number-of-points}
\source{stacks:0ABN}
\href{https://stacks.math.columbia.edu/tag/0ABN}{\texttt{Stacks tag 0ABN}}
\group{spaces-morphisms}
...
$f$ is quasi-finite by Lemma \ref{spaces-morphisms-lemma-base-change-quasi-finite-locus}.
...
\begin{lemma}[Monomorphism loc finite type loc quasi finite]
\label{spaces-morphisms-lemma-monomorphism-loc-finite-type-loc-quasi-finite}
\source{stacks:0463}
\href{https://stacks.math.columbia.edu/tag/0463}{\texttt{Stacks tag 0463}}
\group{spaces-morphisms}
...
Lemma \ref{spaces-morphisms-lemma-monomorphism-separated}.
By
...
\source{stacks:03XP}
\href{https://stacks.math.columbia.edu/tag/03XP}{\texttt{Stacks tag 03XP}}
\group{spaces-morphisms}
...
\source{stacks:03XQ}
\href{https://stacks.math.columbia.edu/tag/03XQ}{\texttt{Stacks tag 03XQ}}
\group{spaces-morphisms}
...
(Lemmas \ref{spaces-morphisms-lemma-composition-quasi-compact} and
...
\source{stacks:03XR}
\href{https://stacks.math.columbia.edu/tag/03XR}{\texttt{Stacks tag 03XR}}
\group{spaces-morphisms}
...
\begin{lemma}[Finite presentation local]
\label{spaces-morphisms-lemma-finite-presentation-local}
\source{stacks:0410}
\href{https://stacks.math.columbia.edu/tag/0410}{\texttt{Stacks tag 0410}}
\group{spaces-morphisms}
...
\source{stacks:0464}
\href{https://stacks.math.columbia.edu/tag/0464}{\texttt{Stacks tag 0464}}
\group{spaces-morphisms}
...
\begin{lemma}[Finite presentation noetherian]
\label{spaces-morphisms-lemma-finite-presentation-noetherian}
\source{stacks:04ZL}
\href{https://stacks.math.columbia.edu/tag/04ZL}{\texttt{Stacks tag 04ZL}}
\group{spaces-morphisms}
...
\source{stacks:06G4}
\href{https://stacks.math.columbia.edu/tag/06G4}{\texttt{Stacks tag 06G4}}
\group{spaces-morphisms}
...
\begin{lemma}[Finite presentation quasi compact quasi separated]
\label{spaces-morphisms-lemma-finite-presentation-quasi-compact-quasi-separated}
\source{stacks:06G5}
\href{https://stacks.math.columbia.edu/tag/06G5}{\texttt{Stacks tag 06G5}}
\group{spaces-morphisms}
...
\source{stacks:05WT}
\href{https://stacks.math.columbia.edu/tag/05WT}{\texttt{Stacks tag 05WT}}
\group{spaces-morphisms}
...
\source{stacks:084P}
\href{https://stacks.math.columbia.edu/tag/084P}{\texttt{Stacks tag 084P}}
\group{spaces-morphisms}
...
of finite type over $X$ (by Lemma \ref{spaces-morphisms-lemma-base-change-finite-type}).
...
\source{stacks:06CN}
\href{https://stacks.math.columbia.edu/tag/06CN}{\texttt{Stacks tag 06CN}}
\group{spaces-morphisms}
...
\begin{lemma}[Closed immersion finite presentation]
\label{spaces-morphisms-lemma-closed-immersion-finite-presentation}
\source{stacks:084Q}
\href{https://stacks.math.columbia.edu/tag/084Q}{\texttt{Stacks tag 084Q}}
\group{spaces-morphisms}
...
\begin{proof}
Let $U$ be a scheme and let $U \to X$ be a surjective \'etale morphism.
By Lemma \ref{spaces-morphisms-lemma-finite-presentation-local}
...
\begin{lemma}[Inverse image constructible]
\label{spaces-morphisms-lemma-inverse-image-constructible}
\source{stacks:0ECW}
\href{https://stacks.math.columbia.edu/tag/0ECW}{\texttt{Stacks tag 0ECW}}
\group{spaces-morphisms}
...
\source{stacks:0ECX}
\href{https://stacks.math.columbia.edu/tag/0ECX}{\texttt{Stacks tag 0ECX}}
\group{spaces-morphisms}
...
\source{stacks:03ML}
\href{https://stacks.math.columbia.edu/tag/03ML}{\texttt{Stacks tag 03ML}}
\group{spaces-morphisms}
...
Lemma \ref{spaces-morphisms-lemma-local-source-target} with
$\mathcal{P} =$``flat''.
...
\begin{lemma}[Flat is flat at all points]
\label{spaces-morphisms-lemma-flat-is-flat-at-all-points}
\source{stacks:08EW}
\href{https://stacks.math.columbia.edu/tag/08EW}{\texttt{Stacks tag 08EW}}
\group{spaces-morphisms}
...
(Definition \ref{spaces-morphisms-definition-P}).
...
\source{stacks:03MN}
\href{https://stacks.math.columbia.edu/tag/03MN}{\texttt{Stacks tag 03MN}}
\group{spaces-morphisms}
...
\source{stacks:03MO}
\href{https://stacks.math.columbia.edu/tag/03MO}{\texttt{Stacks tag 03MO}}
\group{spaces-morphisms}
...
\begin{lemma}[Flat local]
\label{spaces-morphisms-lemma-flat-local}
\source{stacks:03MM}
\href{https://stacks.math.columbia.edu/tag/03MM}{\texttt{Stacks tag 03MM}}
\group{spaces-morphisms}
...
\source{stacks:042S}
\href{https://stacks.math.columbia.edu/tag/042S}{\texttt{Stacks tag 042S}}
\group{spaces-morphisms}
...
$$
\begin{array}{cc}U \underset{\alpha}{\longrightarrow}\downarrow & V \downarrow \\ X \longrightarrow & Y\end{array}
$$
where $U$ and $V$ are schemes and the vertical arrows are surjective and
\'etale, see
Spaces, Lemma \ref{spaces-lemma-lift-morphism-presentations}.
By
Lemmas \ref{spaces-morphisms-lemma-flat-local} and \ref{spaces-morphisms-lemma-finite-presentation-local}
...
\begin{lemma}[Fpqc quotient topology]
\label{spaces-morphisms-lemma-fpqc-quotient-topology}
\source{stacks:0413}
\href{https://stacks.math.columbia.edu/tag/0413}{\texttt{Stacks tag 0413}}
\group{spaces-morphisms}
...
\begin{lemma}[Flat at point etale local rings]
\label{spaces-morphisms-lemma-flat-at-point-etale-local-rings}
\source{stacks:04NG}
\href{https://stacks.math.columbia.edu/tag/04NG}{\texttt{Stacks tag 04NG}}
\group{spaces-morphisms}
...
$$
\begin{array}{cc}\mathcal{O}_{U, u} \longrightarrow & \mathcal{O}_{X, \overline{x}} \\ \mathcal{O}_{V, v} \uparrow\longrightarrow & \mathcal{O}_{Y, \overline{y}} \uparrow\end{array}
$$
...
\begin{lemma}[Flat morphism sites]
\label{spaces-morphisms-lemma-flat-morphism-sites}
\source{stacks:073C}
\href{https://stacks.math.columbia.edu/tag/073C}{\texttt{Stacks tag 073C}}
\group{spaces-morphisms}
...
\begin{lemma}[Flat pullback support]
\label{spaces-morphisms-lemma-flat-pullback-support}
\source{stacks:089C}
\href{https://stacks.math.columbia.edu/tag/089C}{\texttt{Stacks tag 089C}}
\group{spaces-morphisms}
...
as given in Lemma \ref{spaces-morphisms-lemma-scheme-theoretic-support}
and using the characterization of flat morphisms in terms of
\'etale coverings in Lemma \ref{spaces-morphisms-lemma-flat-local}
we reduce to the case of schemes which is
Morphisms, Lemma \ref{morphisms-lemma-flat-pullback-support}.
\end{proof}

\begin{lemma}[Flat morphism scheme theoretically dense open]
\label{spaces-morphisms-lemma-flat-morphism-scheme-theoretically-dense-open}
\source{stacks:089D}
\href{https://stacks.math.columbia.edu/tag/089D}{\texttt{Stacks tag 089D}}
\group{spaces-morphisms}
...
in Lemma \ref{spaces-morphisms-lemma-scheme-theoretically-dense}
and using the characterization of flat morphisms in terms of
\'etale coverings in Lemma \ref{spaces-morphisms-lemma-flat-local}
we reduce to the case of schemes which is
Morphisms, Lemma
...
\begin{lemma}[Flat base change scheme theoretic image]
\label{spaces-morphisms-lemma-flat-base-change-scheme-theoretic-image}
\source{stacks:089E}
\href{https://stacks.math.columbia.edu/tag/089E}{\texttt{Stacks tag 089E}}
\group{spaces-morphisms}
...
By Lemma \ref{spaces-morphisms-lemma-flat-local} the morphism $X' \to Y'$ is flat.
Set $V' = V \times_Y Y'$.
By Lemma \ref{spaces-morphisms-lemma-quasi-compact-scheme-theoretic-image}
...
\source{stacks:05VU}
\href{https://stacks.math.columbia.edu/tag/05VU}{\texttt{Stacks tag 05VU}}
\group{spaces-morphisms}
...
\source{stacks:05VV}
\href{https://stacks.math.columbia.edu/tag/05VV}{\texttt{Stacks tag 05VV}}
\group{spaces-morphisms}
...
if the equivalent conditions of
Lemma \ref{spaces-morphisms-lemma-flat-at-point}
hold.
...
\begin{lemma}[Base change module flat]
\label{spaces-morphisms-lemma-base-change-module-flat}
\source{stacks:05VW}
\href{https://stacks.math.columbia.edu/tag/05VW}{\texttt{Stacks tag 05VW}}
\group{spaces-morphisms}
...
\begin{lemma}[Composition module flat]
\label{spaces-morphisms-lemma-composition-module-flat}
\source{stacks:05VX}
\href{https://stacks.math.columbia.edu/tag/05VX}{\texttt{Stacks tag 05VX}}
\group{spaces-morphisms}
...
Lemmas \ref{spaces-morphisms-lemma-flat-at-point} and
...
\source{stacks:05VY}
\href{https://stacks.math.columbia.edu/tag/05VY}{\texttt{Stacks tag 05VY}}
\group{spaces-morphisms}
...
\begin{lemma}[Pf flat module open]
\label{spaces-morphisms-lemma-pf-flat-module-open}
\source{stacks:0CVU}
\href{https://stacks.math.columbia.edu/tag/0CVU}{\texttt{Stacks tag 0CVU}}
\group{spaces-morphisms}
...
\begin{proposition}[Generic flatness reduced]
\label{spaces-morphisms-proposition-generic-flatness-reduced}
\source{stacks:06QS}
\href{https://stacks.math.columbia.edu/tag/06QS}{\texttt{Stacks tag 06QS}}
\group{spaces-morphisms}
...
Lemmas \ref{spaces-morphisms-lemma-finite-presentation-local},
\ref{spaces-morphisms-lemma-flat-local}, and
...
\begin{proposition}[Generic flatness reduced quasi separated]
\label{spaces-morphisms-proposition-generic-flatness-reduced-quasi-separated}
\source{stacks:06QT}
\href{https://stacks.math.columbia.edu/tag/06QT}{\texttt{Stacks tag 06QT}}
\group{spaces-morphisms}
...
\begin{definition}[Dimension fibre]
\label{spaces-morphisms-definition-dimension-fibre}
\source{stacks:04NM}
\href{https://stacks.math.columbia.edu/tag/04NM}{\texttt{Stacks tag 04NM}}
\group{spaces-morphisms}
...
\source{stacks:06LR}
\href{https://stacks.math.columbia.edu/tag/06LR}{\texttt{Stacks tag 06LR}}
\group{spaces-morphisms}
...
\begin{lemma}[Compare tr deg]
\label{spaces-morphisms-lemma-compare-tr-deg}
\source{stacks:06RX}
\href{https://stacks.math.columbia.edu/tag/06RX}{\texttt{Stacks tag 06RX}}
\group{spaces-morphisms}
...
\begin{lemma}[Jacobson finite type points]
\label{spaces-morphisms-lemma-jacobson-finite-type-points}
\source{stacks:0ECY}
\href{https://stacks.math.columbia.edu/tag/0ECY}{\texttt{Stacks tag 0ECY}}
\group{spaces-morphisms}
...
By Lemma \ref{spaces-morphisms-lemma-finite-type-points-surjective-morphism}
...
\begin{lemma}[Rel dimension dimension]
\label{spaces-morphisms-lemma-rel-dimension-dimension}
\source{stacks:0AFH}
\href{https://stacks.math.columbia.edu/tag/0AFH}{\texttt{Stacks tag 0AFH}}
\group{spaces-morphisms}
...
\begin{lemma}[Dimension fibre at a point]
\label{spaces-morphisms-lemma-dimension-fibre-at-a-point}
\source{stacks:04NQ}
\href{https://stacks.math.columbia.edu/tag/04NQ}{\texttt{Stacks tag 04NQ}}
\group{spaces-morphisms}
...
\begin{lemma}[Dimension fibre at a point additive]
\label{spaces-morphisms-lemma-dimension-fibre-at-a-point-additive}
\source{stacks:04NR}
\href{https://stacks.math.columbia.edu/tag/04NR}{\texttt{Stacks tag 04NR}}
\group{spaces-morphisms}
...
\begin{lemma}[Dimension fibre after base change]
\label{spaces-morphisms-lemma-dimension-fibre-after-base-change}
\source{stacks:04NS}
\href{https://stacks.math.columbia.edu/tag/04NS}{\texttt{Stacks tag 04NS}}
\group{spaces-morphisms}
...
\begin{lemma}[Openness bounded dimension fibres]
\label{spaces-morphisms-lemma-openness-bounded-dimension-fibres}
\source{stacks:04NT}
\href{https://stacks.math.columbia.edu/tag/04NT}{\texttt{Stacks tag 04NT}}
\group{spaces-morphisms}
...
Choose a diagram
$$
\begin{array}{cc}U \underset{h}{\longrightarrow}\underset{a}{\downarrow} & V \downarrow \\ X \longrightarrow & Y\end{array}
$$
where $U$ and $V$ are schemes and the vertical arrows are surjective and
\'etale, see
Spaces, Lemma \ref{spaces-lemma-lift-morphism-presentations}.
...
\begin{lemma}[Openness bounded dimension fibres finite presentation]
\label{spaces-morphisms-lemma-openness-bounded-dimension-fibres-finite-presentation}
\source{stacks:04NU}
\href{https://stacks.math.columbia.edu/tag/04NU}{\texttt{Stacks tag 04NU}}
\group{spaces-morphisms}
...
\text{ such that the relative dimension of }f\text{ at } x \leq n\}
$$
of Lemma \ref{spaces-morphisms-lemma-openness-bounded-dimension-fibres}
...
Spaces, Lemma \ref{spaces-lemma-lift-morphism-presentations}.
In the proof of
Lemma \ref{spaces-morphisms-lemma-openness-bounded-dimension-fibres}
...
\begin{lemma}[Locally quasi finite rel dimension 0]
\label{spaces-morphisms-lemma-locally-quasi-finite-rel-dimension-0}
\source{stacks:04NV}
\href{https://stacks.math.columbia.edu/tag/04NV}{\texttt{Stacks tag 04NV}}
\group{spaces-morphisms}
...
\begin{lemma}[Locally finite type quasi finite part]
\label{spaces-morphisms-lemma-locally-finite-type-quasi-finite-part}
\source{stacks:04NW}
\href{https://stacks.math.columbia.edu/tag/04NW}{\texttt{Stacks tag 04NW}}
\group{spaces-morphisms}
...
\ref{spaces-morphisms-lemma-locally-quasi-finite-rel-dimension-0}, and
...
\source{stacks:06LS}
\href{https://stacks.math.columbia.edu/tag/06LS}{\texttt{Stacks tag 06LS}}
\group{spaces-morphisms}
...
\begin{lemma}[Dimension formula general]
\label{spaces-morphisms-lemma-dimension-formula-general}
\source{stacks:0BAX}
\href{https://stacks.math.columbia.edu/tag/0BAX}{\texttt{Stacks tag 0BAX}}
\group{spaces-morphisms}
...
in $X$. Unwinding Definition \ref{spaces-morphisms-definition-dimension-fibre} and
...
\begin{lemma}[Alteration dimension general]
\label{spaces-morphisms-lemma-alteration-dimension-general}
\source{stacks:0BAY}
\href{https://stacks.math.columbia.edu/tag/0BAY}{\texttt{Stacks tag 0BAY}}
\group{spaces-morphisms}
...
\begin{proof}
Immediate consequence of Lemma \ref{spaces-morphisms-lemma-dimension-formula-general}
...
\begin{definition}[Syntomic]
\label{spaces-morphisms-definition-syntomic}
\source{stacks:03Z7}
\href{https://stacks.math.columbia.edu/tag/03Z7}{\texttt{Stacks tag 03Z7}}
\group{spaces-morphisms}
...
\begin{lemma}[Composition syntomic]
\label{spaces-morphisms-lemma-composition-syntomic}
\source{stacks:03Z8}
\href{https://stacks.math.columbia.edu/tag/03Z8}{\texttt{Stacks tag 03Z8}}
\group{spaces-morphisms}
...
\begin{lemma}[Base change syntomic]
\label{spaces-morphisms-lemma-base-change-syntomic}
\source{stacks:03Z9}
\href{https://stacks.math.columbia.edu/tag/03Z9}{\texttt{Stacks tag 03Z9}}
\group{spaces-morphisms}
...
\begin{lemma}[Syntomic local]
\label{spaces-morphisms-lemma-syntomic-local}
\source{stacks:03ZA}
\href{https://stacks.math.columbia.edu/tag/03ZA}{\texttt{Stacks tag 03ZA}}
\group{spaces-morphisms}
...
\begin{lemma}[Syntomic locally finite presentation]
\label{spaces-morphisms-lemma-syntomic-locally-finite-presentation}
\source{stacks:0DEY}
\href{https://stacks.math.columbia.edu/tag/0DEY}{\texttt{Stacks tag 0DEY}}
\group{spaces-morphisms}
...
\begin{lemma}[Syntomic flat]
\label{spaces-morphisms-lemma-syntomic-flat}
\source{stacks:0DEZ}
\href{https://stacks.math.columbia.edu/tag/0DEZ}{\texttt{Stacks tag 0DEZ}}
\group{spaces-morphisms}
...
\begin{lemma}[Syntomic open]
\label{spaces-morphisms-lemma-syntomic-open}
\source{stacks:0DF0}
\href{https://stacks.math.columbia.edu/tag/0DF0}{\texttt{Stacks tag 0DF0}}
\group{spaces-morphisms}
...
\source{stacks:03ZC}
\href{https://stacks.math.columbia.edu/tag/03ZC}{\texttt{Stacks tag 03ZC}}
\group{spaces-morphisms}
...
\source{stacks:03ZD}
\href{https://stacks.math.columbia.edu/tag/03ZD}{\texttt{Stacks tag 03ZD}}
\group{spaces-morphisms}
...
\source{stacks:03ZE}
\href{https://stacks.math.columbia.edu/tag/03ZE}{\texttt{Stacks tag 03ZE}}
\group{spaces-morphisms}
...
\begin{lemma}[Smooth local]
\label{spaces-morphisms-lemma-smooth-local}
\source{stacks:03ZF}
\href{https://stacks.math.columbia.edu/tag/03ZF}{\texttt{Stacks tag 03ZF}}
\group{spaces-morphisms}
...
\source{stacks:04AJ}
\href{https://stacks.math.columbia.edu/tag/04AJ}{\texttt{Stacks tag 04AJ}}
\group{spaces-morphisms}
...
\begin{lemma}[Smooth locally finite type]
\label{spaces-morphisms-lemma-smooth-locally-finite-type}
\source{stacks:06MH}
\href{https://stacks.math.columbia.edu/tag/06MH}{\texttt{Stacks tag 06MH}}
\group{spaces-morphisms}
...
\begin{lemma}[Smooth flat]
\label{spaces-morphisms-lemma-smooth-flat}
\source{stacks:04TA}
\href{https://stacks.math.columbia.edu/tag/04TA}{\texttt{Stacks tag 04TA}}
\group{spaces-morphisms}
...
\begin{lemma}[Smooth syntomic]
\label{spaces-morphisms-lemma-smooth-syntomic}
\source{stacks:06CP}
\href{https://stacks.math.columbia.edu/tag/06CP}{\texttt{Stacks tag 06CP}}
\group{spaces-morphisms}
...
\source{stacks:0DZI}
\href{https://stacks.math.columbia.edu/tag/0DZI}{\texttt{Stacks tag 0DZI}}
\group{spaces-morphisms}
...
Lemma \ref{spaces-morphisms-lemma-smooth-local}. Moreover, this lemma allows
...
\begin{lemma}[Smoothness dimension spaces]
\label{spaces-morphisms-lemma-smoothness-dimension-spaces}
\source{stacks:0AFI}
\href{https://stacks.math.columbia.edu/tag/0AFI}{\texttt{Stacks tag 0AFI}}
\group{spaces-morphisms}
...
in Definition \ref{spaces-morphisms-definition-dimension-fibre}.
\end{lemma}
...
\source{stacks:03ZH}
\href{https://stacks.math.columbia.edu/tag/03ZH}{\texttt{Stacks tag 03ZH}}
\group{spaces-morphisms}
...
\begin{lemma}[Unramified G unramified]
\label{spaces-morphisms-lemma-unramified-G-unramified}
\source{stacks:04G1}
\href{https://stacks.math.columbia.edu/tag/04G1}{\texttt{Stacks tag 04G1}}
\group{spaces-morphisms}
...
\source{stacks:03ZI}
\href{https://stacks.math.columbia.edu/tag/03ZI}{\texttt{Stacks tag 03ZI}}
\group{spaces-morphisms}
...
\source{stacks:03ZJ}
\href{https://stacks.math.columbia.edu/tag/03ZJ}{\texttt{Stacks tag 03ZJ}}
\group{spaces-morphisms}
...
\begin{lemma}[Unramified local]
\label{spaces-morphisms-lemma-unramified-local}
\source{stacks:03ZK}
\href{https://stacks.math.columbia.edu/tag/03ZK}{\texttt{Stacks tag 03ZK}}
\group{spaces-morphisms}
...
\begin{lemma}[Unramified locally finite type]
\label{spaces-morphisms-lemma-unramified-locally-finite-type}
\source{stacks:05VZ}
\href{https://stacks.math.columbia.edu/tag/05VZ}{\texttt{Stacks tag 05VZ}}
\group{spaces-morphisms}
...
\source{stacks:05W0}
\href{https://stacks.math.columbia.edu/tag/05W0}{\texttt{Stacks tag 05W0}}
\group{spaces-morphisms}
...
\source{stacks:06CQ}
\href{https://stacks.math.columbia.edu/tag/06CQ}{\texttt{Stacks tag 06CQ}}
\group{spaces-morphisms}
...
\begin{lemma}[Diagonal unramified morphism]
\label{spaces-morphisms-lemma-diagonal-unramified-morphism}
\source{stacks:05W1}
\href{https://stacks.math.columbia.edu/tag/05W1}{\texttt{Stacks tag 05W1}}
\group{spaces-morphisms}
...
Consider the commutative diagram
$$
\begin{array}{cccc}U \downarrow\underset{\Delta_{U/V}}{\longrightarrow} &  & U \times_V U \downarrow\longrightarrow & V \overset{\Delta_{V/Y}}{\downarrow} \\ X \overset{\Delta_{X/Y}}{\longrightarrow} &  & X \times_Y X \longrightarrow & V \times_Y V\end{array}
$$
...
\source{stacks:05W2}
\href{https://stacks.math.columbia.edu/tag/05W2}{\texttt{Stacks tag 05W2}}
\group{spaces-morphisms}
...
Definition \ref{spaces-morphisms-definition-unramified}
...
\source{stacks:06G6}
\href{https://stacks.math.columbia.edu/tag/06G6}{\texttt{Stacks tag 06G6}}
\group{spaces-morphisms}
...
\source{stacks:04RH}
\href{https://stacks.math.columbia.edu/tag/04RH}{\texttt{Stacks tag 04RH}}
\group{spaces-morphisms}
...
\begin{lemma}[Etale local]
\label{spaces-morphisms-lemma-etale-local}
\source{stacks:03XT}
\href{https://stacks.math.columbia.edu/tag/03XT}{\texttt{Stacks tag 03XT}}
\group{spaces-morphisms}
...
\source{stacks:0465}
\href{https://stacks.math.columbia.edu/tag/0465}{\texttt{Stacks tag 0465}}
\group{spaces-morphisms}
...
\source{stacks:0466}
\href{https://stacks.math.columbia.edu/tag/0466}{\texttt{Stacks tag 0466}}
\group{spaces-morphisms}
...
\begin{lemma}[Etale locally quasi finite]
\label{spaces-morphisms-lemma-etale-locally-quasi-finite}
\source{stacks:03XU}
\href{https://stacks.math.columbia.edu/tag/03XU}{\texttt{Stacks tag 03XU}}
\group{spaces-morphisms}
...
\begin{lemma}[Etale smooth]
\label{spaces-morphisms-lemma-etale-smooth}
\source{stacks:04XX}
\href{https://stacks.math.columbia.edu/tag/04XX}{\texttt{Stacks tag 04XX}}
\group{spaces-morphisms}
...
\begin{lemma}[Etale flat]
\label{spaces-morphisms-lemma-etale-flat}
\source{stacks:0467}
\href{https://stacks.math.columbia.edu/tag/0467}{\texttt{Stacks tag 0467}}
\group{spaces-morphisms}
...
\begin{lemma}[\'Etale implies locally of finite presentation.]
\label{spaces-morphisms-lemma-etale-locally-finite-presentation}
\source{stacks:0468}
\href{https://stacks.math.columbia.edu/tag/0468}{\texttt{Stacks tag 0468}}
\group{spaces-morphisms}
...
\begin{lemma}[Etale locally finite type]
\label{spaces-morphisms-lemma-etale-locally-finite-type}
\source{stacks:06LT}
\href{https://stacks.math.columbia.edu/tag/06LT}{\texttt{Stacks tag 06LT}}
\group{spaces-morphisms}
...
\source{stacks:06CR}
\href{https://stacks.math.columbia.edu/tag/06CR}{\texttt{Stacks tag 06CR}}
\group{spaces-morphisms}
...
\source{stacks:05W3}
\href{https://stacks.math.columbia.edu/tag/05W3}{\texttt{Stacks tag 05W3}}
\group{spaces-morphisms}
...
\begin{lemma}[Unramified flat lfp etale]
\label{spaces-morphisms-lemma-unramified-flat-lfp-etale}
\source{stacks:06LU}
\href{https://stacks.math.columbia.edu/tag/06LU}{\texttt{Stacks tag 06LU}}
\group{spaces-morphisms}
...
\source{stacks:03ZM}
\href{https://stacks.math.columbia.edu/tag/03ZM}{\texttt{Stacks tag 03ZM}}
\group{spaces-morphisms}
...
\begin{lemma}[Proper local]
\label{spaces-morphisms-lemma-proper-local}
\source{stacks:083R}
\href{https://stacks.math.columbia.edu/tag/083R}{\texttt{Stacks tag 083R}}
\group{spaces-morphisms}
...
\begin{proof}
Combine Lemmas \ref{spaces-morphisms-lemma-separated-local},
...
\source{stacks:04WP}
\href{https://stacks.math.columbia.edu/tag/04WP}{\texttt{Stacks tag 04WP}}
\group{spaces-morphisms}
...
\source{stacks:04XY}
\href{https://stacks.math.columbia.edu/tag/04XY}{\texttt{Stacks tag 04XY}}
\group{spaces-morphisms}
...
\source{stacks:04XZ}
\href{https://stacks.math.columbia.edu/tag/04XZ}{\texttt{Stacks tag 04XZ}}
\group{spaces-morphisms}
...
\source{stacks:04NX}
\href{https://stacks.math.columbia.edu/tag/04NX}{\texttt{Stacks tag 04NX}}
\group{spaces-morphisms}

Let $S$ be a scheme.
Consider a commutative diagram of algebraic spaces
$$
\begin{array}{ccc}X \longrightarrow\searrow &  & Y \swarrow \\  & B & \end{array}
$$
over $S$.
\begin{enumerate}
...
Lemma \ref{spaces-morphisms-lemma-semi-diagonal}
...
Lemmas \ref{spaces-morphisms-lemma-compose-after-separated},
\ref{spaces-morphisms-lemma-quasi-compact-permanence}, and
...
\source{stacks:08AJ}
\href{https://stacks.math.columbia.edu/tag/08AJ}{\texttt{Stacks tag 08AJ}}
\group{spaces-morphisms}
...
(Lemma \ref{spaces-morphisms-lemma-base-change-surjective}), and the base
...
\begin{lemma}[Scheme theoretic image is proper]
\label{spaces-morphisms-lemma-scheme-theoretic-image-is-proper}
\source{stacks:0AGD}
\href{https://stacks.math.columbia.edu/tag/0AGD}{\texttt{Stacks tag 0AGD}}
\group{spaces-morphisms}
...
hence $|h|(|X|) \subset |Z|$
is dense (Lemma \ref{spaces-morphisms-lemma-quasi-compact-scheme-theoretic-image}).
...
Thus $Z \to B$ is a proper (Lemma \ref{spaces-morphisms-lemma-image-proper-is-proper}).
\end{proof}

\begin{lemma}[Separated diagonal proper]
\label{spaces-morphisms-lemma-separated-diagonal-proper}
\source{stacks:04Y0}
\href{https://stacks.math.columbia.edu/tag/04Y0}{\texttt{Stacks tag 04Y0}}
\group{spaces-morphisms}
...
Lemma \ref{spaces-morphisms-lemma-closed-immersion-proper}.
We will use
Spaces, Lemma
\ref{spaces-lemma-representable-transformations-property-implication}
...
\begin{definition}[Valuative criterion]
\label{spaces-morphisms-definition-valuative-criterion}
\source{stacks:03IX}
\href{https://stacks.math.columbia.edu/tag/03IX}{\texttt{Stacks tag 03IX}}
\group{spaces-morphisms}
...
$$
\begin{array}{cc}\Spec(K) \longrightarrow\downarrow & X \downarrow \\ \Spec(A) \longrightarrow\nearrow & Y\end{array}
$$
...
diagram commutes
$$
\begin{array}{ccc}\Spec(K') \longrightarrow\downarrow & \Spec(K) \longrightarrow & X \downarrow \\ \Spec(A') \longrightarrow\nearrow & \Spec(A) \longrightarrow & Y\end{array}
$$
...
part of the valuative criterion, see Lemma \ref{spaces-morphisms-lemma-finite-separable-enough}.
...
valuative criterion, see Lemma \ref{spaces-morphisms-lemma-usual-enough}.
...
Lemma \ref{spaces-morphisms-lemma-characterize-separated-and-universally-closed}.
...
\begin{lemma}[Valuative criterion representable]
\label{spaces-morphisms-lemma-valuative-criterion-representable}
\source{stacks:03K8}
\href{https://stacks.math.columbia.edu/tag/03K8}{\texttt{Stacks tag 03K8}}
\group{spaces-morphisms}
...
as in Definition \ref{spaces-morphisms-definition-valuative-criterion},
...
$$
\begin{array}{ccc}\Spec(K') \longrightarrow\downarrow & \Spec(K) \longrightarrow & X \downarrow \\ \Spec(A') \longrightarrow\overset{\varphi}{\nearrow} & \Spec(A) \longrightarrow & Y\end{array}
$$
as in Definition \ref{spaces-morphisms-definition-valuative-criterion}, then we can
...
$$
\begin{array}{ccc}K' & K \longleftarrow & \mathcal{O}_{X_A, x} \longleftarrow\swarrow \\ A' \uparrow & A \longleftarrow & A \longleftarrow\uparrow\end{array}
$$
...
\begin{lemma}[Finite separable enough]
\label{spaces-morphisms-lemma-finite-separable-enough}
\source{stacks:03KH}
\href{https://stacks.math.columbia.edu/tag/03KH}{\texttt{Stacks tag 03KH}}
\group{spaces-morphisms}
...
as in Definition \ref{spaces-morphisms-definition-valuative-criterion},
\item $f$ satisfies the existence part of the valuative criterion
as in Definition \ref{spaces-morphisms-definition-valuative-criterion} modified by
...
\begin{array}{ccc}\Spec(K') \longrightarrow\downarrow & \Spec(K) \longrightarrow & X \downarrow \\ \Spec(A') \longrightarrow\nearrow & \Spec(A) \longrightarrow & Y\end{array}
$$
as in Definition \ref{spaces-morphisms-definition-valuative-criterion} with $K \subset K'$
...
rings
$$
\begin{array}{cccc}\kappa(p') &  & \kappa(q') \longleftarrow & \kappa(u') \longleftarrow \\  & \mathcal{O}_{\Spec(A') \times_X U, p} \nwarrow &  & \mathcal{O}_{U, u} \longleftarrow\uparrow \\ K' \uparrow & A' \longleftarrow\uparrow & A \longleftarrow\uparrow & \end{array}
$$
...
$$
\begin{array}{ccc}\Spec(\kappa(q')) \longrightarrow\downarrow & \Spec(K) \longrightarrow & X \downarrow \\ \Spec(A_1) \longrightarrow\nearrow & \Spec(A) \longrightarrow & Y\end{array}
$$
...
spaces (Lemma \ref{spaces-morphisms-lemma-base-change-separated}). Base changing
all the morphisms of the diagram above we obtain
$$
\begin{array}{ccc}\Spec(K') \longrightarrow\downarrow & \Spec(K) \longrightarrow & X_A \downarrow \\ \Spec(A') \longrightarrow\nearrow & \Spec(A) \xlongequal{} & \Spec(A)\end{array}
$$
...
$\Spec(K) \to \Spec(A)$. By
Lemma \ref{spaces-morphisms-lemma-flat-base-change-scheme-theoretic-image}
...
closed immersion (Lemma \ref{spaces-morphisms-lemma-section-immersion}).
...
\begin{lemma}[Usual enough]
\label{spaces-morphisms-lemma-usual-enough}
\source{stacks:0A3W}
\href{https://stacks.math.columbia.edu/tag/0A3W}{\texttt{Stacks tag 0A3W}}
\group{spaces-morphisms}
...
$$
\begin{array}{cc}\Spec(K) \longrightarrow\downarrow & X \downarrow \\ \Spec(A) \longrightarrow & Y\end{array}
$$
...
$$
as in Definition \ref{spaces-morphisms-definition-valuative-criterion} with $K \subset K'$
arbitrary. By Lemma \ref{spaces-morphisms-lemma-push-down-solution} we can find a morphism
$\Spec(A) \to X$ fitting into the diagram, i.e., (2) holds.
\end{proof}

\begin{example}[Finite separable needed]
\label{spaces-morphisms-example-finite-separable-needed}
\source{stacks:03KI}
\href{https://stacks.math.columbia.edu/tag/03KI}{\texttt{Stacks tag 03KI}}
\group{spaces-morphisms}
...
$$
\begin{array}{cc}\Spec(k((x))) \longrightarrow\downarrow & X \overset{\pi}{\downarrow} \\ \Spec(k[[x]]) \longrightarrow\nearrow & \mathbf{A}^1_k\end{array}
$$
...
\begin{lemma}[Base change valuative criteria]
\label{spaces-morphisms-lemma-base-change-valuative-criteria}
\source{stacks:03IY}
\href{https://stacks.math.columbia.edu/tag/03IY}{\texttt{Stacks tag 03IY}}
\group{spaces-morphisms}
...
$$
\begin{array}{ccc}\Spec(K) \longrightarrow\downarrow & Z \times_Y X \longrightarrow\downarrow & X \downarrow \\ \Spec(A) \longrightarrow\nearrow\nearrow & Z \longrightarrow & Y\end{array}
$$
...
diagram
$$
\begin{array}{cccc}\Spec(K') \longrightarrow\downarrow & \Spec(K) \longrightarrow & Z \times_Y X \longrightarrow & X \downarrow \\ \Spec(A') \longrightarrow\nearrow & \Spec(A) \longrightarrow & Z \longrightarrow & Y\end{array}
$$
And by the remarks above the skew arrow corresponds to an arrow
$\Spec(A') \to Z \times_Y X$ as desired.
\end{proof}

\begin{lemma}[Composition valuative criteria]
\label{spaces-morphisms-lemma-composition-valuative-criteria}
\source{stacks:03IZ}
\href{https://stacks.math.columbia.edu/tag/03IZ}{\texttt{Stacks tag 03IZ}}
\group{spaces-morphisms}
...
$$
\begin{array}{cc}\Spec(K) \downarrow\longrightarrow & X \overset{f}{\downarrow} \\  & Y \overset{g}{\downarrow} \\ \Spec(A) \longrightarrow\nearrow\nearrow & Z\end{array}
$$
...
$$
\begin{array}{cccc}\Spec(K'') \longrightarrow\downarrow & \Spec(K') \longrightarrow & \Spec(K) \longrightarrow & X \overset{f}{\downarrow} \\  &  &  & Y \overset{g}{\downarrow} \\ \Spec(A'') \longrightarrow\nearrow & \Spec(A') \longrightarrow\nearrow & \Spec(A) \longrightarrow & Z\end{array}
$$
...
Example \ref{spaces-morphisms-example-strange-universally-closed}
...
\source{stacks:03KA}
\href{https://stacks.math.columbia.edu/tag/03KA}{\texttt{Stacks tag 03KA}}
\group{spaces-morphisms}
...
\begin{proof}
By Lemmas \ref{spaces-morphisms-lemma-base-change-quasi-compact}
and \ref{spaces-morphisms-lemma-base-change-valuative-criteria}
properties (1) and (2) are preserved under
any base change. By Lemma \ref{spaces-morphisms-lemma-universally-closed-local}
...
$$
\begin{array}{cc}\Spec(K) \underset{x'}{\longrightarrow}\downarrow & X \overset{f}{\downarrow} \\ \Spec(\mathcal{O}_{Y, y}) \longrightarrow & Y,\end{array}
$$
see
Schemes, Section \ref{schemes-section-points}
...
\begin{lemma}[Characterize universally closed quasi separated]
\label{spaces-morphisms-lemma-characterize-universally-closed-quasi-separated}
\source{stacks:0A3X}
\href{https://stacks.math.columbia.edu/tag/0A3X}{\texttt{Stacks tag 0A3X}}
\group{spaces-morphisms}
...
$$
\begin{array}{cc}\Spec(K) \underset{x}{\longrightarrow}\downarrow & X \overset{f}{\downarrow} \\ \Spec(A) \xlongequal{}\nearrow & \Spec(A)\end{array}
$$
where $A$ is a valuation ring with field of fractions $K$.
By Lemma \ref{spaces-morphisms-lemma-quasi-compact-permanence} and the fact
...
By Lemma \ref{spaces-morphisms-lemma-reach-points-scheme-theoretic-image}
we can find a commutative diagram
$$
\begin{array}{cc}\Spec(K') \longrightarrow\downarrow & \Spec(K) \downarrow \\ \Spec(A') \longrightarrow & X\end{array}
$$
...
\begin{lemma}[Characterize universally closed separated]
\label{spaces-morphisms-lemma-characterize-universally-closed-separated}
\source{stacks:0A3Y}
\href{https://stacks.math.columbia.edu/tag/0A3Y}{\texttt{Stacks tag 0A3Y}}
\group{spaces-morphisms}
...
as in Definition \ref{spaces-morphisms-definition-valuative-criterion}, and
\item given any commutative solid diagram
$$
\begin{array}{cc}\Spec(K) \longrightarrow\downarrow & X \downarrow \\ \Spec(A) \longrightarrow\nearrow & Y\end{array}
$$
...
Lemma \ref{spaces-morphisms-lemma-characterize-universally-closed-quasi-separated}.
\end{proof}
...
\source{stacks:089F}
\href{https://stacks.math.columbia.edu/tag/089F}{\texttt{Stacks tag 089F}}
\group{spaces-morphisms}
...
$$
\begin{array}{cc}\Spec(A') \longrightarrow\downarrow & X \downarrow \\ \Spec(A) \longrightarrow & Y\end{array}
$$
...
(Lemma \ref{spaces-morphisms-lemma-base-change-flat}) and the closed point of
...
\begin{lemma}[Refined valuative criterion universally closed]
\label{spaces-morphisms-lemma-refined-valuative-criterion-universally-closed}
\source{stacks:089G}
\href{https://stacks.math.columbia.edu/tag/089G}{\texttt{Stacks tag 089G}}
\group{spaces-morphisms}
...
$$
\begin{array}{ccc}\Spec(K) \longrightarrow\downarrow & U \longrightarrow & X \downarrow \\ \Spec(A) \longrightarrow\nearrow &  & Y\end{array}
$$
where $A$ is a valuation ring with field of fractions $K$
\begin{enumerate}
...
$$
\begin{array}{cccc}\Spec(K') \longrightarrow\downarrow & \Spec(K) \longrightarrow & U \longrightarrow & X \downarrow \\ \Spec(A') \longrightarrow\nearrow & \Spec(A) \longrightarrow &  & Y\end{array}
$$
\end{enumerate}
...
Lemma \ref{spaces-morphisms-lemma-lift-valuation-ring-through-flat-morphism}
we can find a local ring map $A \to A'$ of valuation rings
and a morphism $\Spec(A') \to \Spec(R)$ fitting into a commutative
diagram
$$
\begin{array}{cc}\Spec(A') \longrightarrow\downarrow & \Spec(R) \downarrow \\ \Spec(A) \longrightarrow & Y\end{array}
$$
Since in Definition \ref{spaces-morphisms-definition-valuative-criterion}
...
we can find a commutative diagram
$$
\begin{array}{cc}\Spec(K') \longrightarrow\downarrow & U \times_X \Spec(P) \downarrow \\ \Spec(A') \longrightarrow & \Spec(P)\end{array}
$$
where $A'$ is a valuation ring and $K'$ is the fraction field of $A'$
...
commutative diagram
$$
\begin{array}{cccc}\Spec(K'_1) \dashrightarrow\downarrow & \Spec(K') \longrightarrow\downarrow & U \longrightarrow & X \downarrow \\ \Spec(C_1) \dashrightarrow\nearrow & \Spec(C) \longrightarrow &  & Y\end{array}
$$
...
$$
\begin{array}{ccc}\Spec(A'_1) \longrightarrow\downarrow & \Spec(C_1) \longrightarrow & X \\ \Spec(A') \longrightarrow & \Spec(P) \longrightarrow & \Spec(B) \uparrow\end{array}
$$
...
By Lemma \ref{spaces-morphisms-lemma-separated-diagonal-proper} we conclude that
$f$ is separated.
\end{proof}
...
\begin{lemma}[Separated implies valuative]
\label{spaces-morphisms-lemma-separated-implies-valuative}
\source{stacks:03KU}
\href{https://stacks.math.columbia.edu/tag/03KU}{\texttt{Stacks tag 03KU}}
\group{spaces-morphisms}
...
\begin{proof}
Let a diagram as in Definition \ref{spaces-morphisms-definition-valuative-criterion}
...
\source{stacks:03KV}
\href{https://stacks.math.columbia.edu/tag/03KV}{\texttt{Stacks tag 03KV}}
\group{spaces-morphisms}
...
\begin{lemma}[Characterize separated and universally closed]
\label{spaces-morphisms-lemma-characterize-separated-and-universally-closed}
\source{stacks:0A3Z}
\href{https://stacks.math.columbia.edu/tag/0A3Z}{\texttt{Stacks tag 0A3Z}}
\group{spaces-morphisms}
...
consequence of
Lemma \ref{spaces-morphisms-lemma-characterize-universally-closed-separated}.
\end{proof}
...
\source{stacks:0A40}
\href{https://stacks.math.columbia.edu/tag/0A40}{\texttt{Stacks tag 0A40}}
\group{spaces-morphisms}
...
\begin{lemma}[Integral representable]
\label{spaces-morphisms-lemma-integral-representable}
\source{stacks:03ZO}
\href{https://stacks.math.columbia.edu/tag/03ZO}{\texttt{Stacks tag 03ZO}}
\group{spaces-morphisms}
...
\source{stacks:03ZP}
\href{https://stacks.math.columbia.edu/tag/03ZP}{\texttt{Stacks tag 03ZP}}
\group{spaces-morphisms}
...
\begin{lemma}[Integral local]
\label{spaces-morphisms-lemma-integral-local}
\source{stacks:03ZQ}
\href{https://stacks.math.columbia.edu/tag/03ZQ}{\texttt{Stacks tag 03ZQ}}
\group{spaces-morphisms}
...
\source{stacks:03ZR}
\href{https://stacks.math.columbia.edu/tag/03ZR}{\texttt{Stacks tag 03ZR}}
\group{spaces-morphisms}
...
\source{stacks:03ZS}
\href{https://stacks.math.columbia.edu/tag/03ZS}{\texttt{Stacks tag 03ZS}}
\group{spaces-morphisms}
...
\begin{lemma}[Finite integral]
\label{spaces-morphisms-lemma-finite-integral}
\source{stacks:0414}
\href{https://stacks.math.columbia.edu/tag/0414}{\texttt{Stacks tag 0414}}
\group{spaces-morphisms}
...
Lemmas \ref{spaces-morphisms-lemma-integral-local}. Hence this lemma follows from the
same lemma for the case of schemes, see
Morphisms, Lemma \ref{morphisms-lemma-finite-integral}.
\end{proof}

\begin{lemma}[Integral universally closed]
\label{spaces-morphisms-lemma-integral-universally-closed}
\source{stacks:0415}
\href{https://stacks.math.columbia.edu/tag/0415}{\texttt{Stacks tag 0415}}
\group{spaces-morphisms}
...
\ref{spaces-morphisms-lemma-affine-local}, and
\ref{spaces-morphisms-lemma-universally-closed-local}.
Hence the result follows from
Morphisms, Lemma \ref{morphisms-lemma-integral-universally-closed}.
\end{proof}

\begin{lemma}[Finite quasi finite]
\label{spaces-morphisms-lemma-finite-quasi-finite}
\source{stacks:04NY}
\href{https://stacks.math.columbia.edu/tag/04NY}{\texttt{Stacks tag 04NY}}
\group{spaces-morphisms}
...
Let $f : X \to Y$ be a morphism of algebraic spaces.
By
Definition \ref{spaces-morphisms-definition-integral}
and
Lemmas \ref{spaces-morphisms-lemma-quasi-compact-local} and
...
\begin{lemma}[Finite proper]
\label{spaces-morphisms-lemma-finite-proper}
\source{stacks:04NZ}
\href{https://stacks.math.columbia.edu/tag/04NZ}{\texttt{Stacks tag 04NZ}}
\group{spaces-morphisms}
...
Lemmas \ref{spaces-morphisms-lemma-integral-local}, \ref{spaces-morphisms-lemma-affine-local}, and
\ref{spaces-morphisms-lemma-proper-local}. Hence the result follows from
Morphisms, Lemma \ref{morphisms-lemma-finite-proper}.
\end{proof}

\begin{lemma}[Closed immersion finite]
\label{spaces-morphisms-lemma-closed-immersion-finite}
\source{stacks:081Y}
\href{https://stacks.math.columbia.edu/tag/081Y}{\texttt{Stacks tag 081Y}}
\group{spaces-morphisms}
...
\begin{lemma}[Finite union finite]
\label{spaces-morphisms-lemma-finite-union-finite}
\source{stacks:0CZ2}
\href{https://stacks.math.columbia.edu/tag/0CZ2}{\texttt{Stacks tag 0CZ2}}
\group{spaces-morphisms}
...
\begin{lemma}[Finite permanence]
\label{spaces-morphisms-lemma-finite-permanence}
\source{stacks:081Z}
\href{https://stacks.math.columbia.edu/tag/081Z}{\texttt{Stacks tag 081Z}}
\group{spaces-morphisms}
...
see Lemma \ref{spaces-morphisms-lemma-closed-immersion-finite}.
The composition of finite (resp.\ integral) morphisms is finite
(resp.\ integral),
see Lemma \ref{spaces-morphisms-lemma-composition-integral}. Thus we win.
\end{proof}
...
\begin{lemma}[Finite locally free representable]
\label{spaces-morphisms-lemma-finite-locally-free-representable}
\source{stacks:03ZU}
\href{https://stacks.math.columbia.edu/tag/03ZU}{\texttt{Stacks tag 03ZU}}
\group{spaces-morphisms}
...
Section \ref{spaces-morphisms-section-representable}). This means that
...
\begin{definition}[Finite locally free]
\label{spaces-morphisms-definition-finite-locally-free}
\source{stacks:03ZV}
\href{https://stacks.math.columbia.edu/tag/03ZV}{\texttt{Stacks tag 03ZV}}
\group{spaces-morphisms}
...
\begin{lemma}[Finite locally free local]
\label{spaces-morphisms-lemma-finite-locally-free-local}
\source{stacks:03ZW}
\href{https://stacks.math.columbia.edu/tag/03ZW}{\texttt{Stacks tag 03ZW}}
\group{spaces-morphisms}
...
\begin{lemma}[Composition finite locally free]
\label{spaces-morphisms-lemma-composition-finite-locally-free}
\source{stacks:03ZX}
\href{https://stacks.math.columbia.edu/tag/03ZX}{\texttt{Stacks tag 03ZX}}
\group{spaces-morphisms}
...
\begin{lemma}[Base change finite locally free]
\label{spaces-morphisms-lemma-base-change-finite-locally-free}
\source{stacks:03ZY}
\href{https://stacks.math.columbia.edu/tag/03ZY}{\texttt{Stacks tag 03ZY}}
\group{spaces-morphisms}
...
\source{stacks:0416}
\href{https://stacks.math.columbia.edu/tag/0416}{\texttt{Stacks tag 0416}}
\group{spaces-morphisms}
...
\source{stacks:0EMM}
\href{https://stacks.math.columbia.edu/tag/0EMM}{\texttt{Stacks tag 0EMM}}
\group{spaces-morphisms}
...
Morphisms, Definition \ref{spaces-morphisms-definition-rational-map}.
...
\source{stacks:0EMN}
\href{https://stacks.math.columbia.edu/tag/0EMN}{\texttt{Stacks tag 0EMN}}
\group{spaces-morphisms}
...
\begin{definition}[Ring of rational functions]
\label{spaces-morphisms-definition-ring-of-rational-functions}
\source{stacks:0EMP}
\href{https://stacks.math.columbia.edu/tag/0EMP}{\texttt{Stacks tag 0EMP}}
\group{spaces-morphisms}
...
\source{stacks:0EMQ}
\href{https://stacks.math.columbia.edu/tag/0EMQ}{\texttt{Stacks tag 0EMQ}}
\group{spaces-morphisms}
...
\begin{lemma}[Rational map from reduced to separated]
\label{spaces-morphisms-lemma-rational-map-from-reduced-to-separated}
\source{stacks:0EMR}
\href{https://stacks.math.columbia.edu/tag/0EMR}{\texttt{Stacks tag 0EMR}}
\group{spaces-morphisms}
...
\begin{definition}[Dominant rational]
\label{spaces-morphisms-definition-dominant-rational}
\source{stacks:0EMS}
\href{https://stacks.math.columbia.edu/tag/0EMS}{\texttt{Stacks tag 0EMS}}
\group{spaces-morphisms}
...
morphism in the sense of Definition \ref{spaces-morphisms-definition-dominant}.
\end{definition}
...
\begin{definition}[Birational spaces]
\label{spaces-morphisms-definition-birational-spaces}
\source{stacks:0EMT}
\href{https://stacks.math.columbia.edu/tag/0EMT}{\texttt{Stacks tag 0EMT}}
\group{spaces-morphisms}
...
\begin{lemma}[Birational]
\label{spaces-morphisms-lemma-birational}
\source{stacks:0EMU}
\href{https://stacks.math.columbia.edu/tag/0EMU}{\texttt{Stacks tag 0EMU}}
\group{spaces-morphisms}
...
\begin{lemma}[Integral closure]
\label{spaces-morphisms-lemma-integral-closure}
\source{stacks:0820}
\href{https://stacks.math.columbia.edu/tag/0820}{\texttt{Stacks tag 0820}}
\group{spaces-morphisms}
...
\source{stacks:0821}
\href{https://stacks.math.columbia.edu/tag/0821}{\texttt{Stacks tag 0821}}
\group{spaces-morphisms}
...
constructed in Lemma \ref{spaces-morphisms-lemma-integral-closure} above.
\end{definition}
...
$f : Y \to X$ (see Lemma \ref{spaces-morphisms-lemma-pushforward}). We can then take
the relative spectrum of the quasi-coherent $\mathcal{O}_X$-algebra
(Lemma \ref{spaces-morphisms-lemma-affine-equivalence-algebras}) to obtain the
normalization of $X$ in $Y$.

\begin{definition}[Normalization X in Y]
\label{spaces-morphisms-definition-normalization-X-in-Y}
\source{stacks:0822}
\href{https://stacks.math.columbia.edu/tag/0822}{\texttt{Stacks tag 0822}}
\group{spaces-morphisms}
...
\begin{lemma}[Properties normalization]
\label{spaces-morphisms-lemma-properties-normalization}
\source{stacks:0ABP}
\href{https://stacks.math.columbia.edu/tag/0ABP}{\texttt{Stacks tag 0ABP}}
\group{spaces-morphisms}
...
\begin{lemma}[Characterize normalization]
\label{spaces-morphisms-lemma-characterize-normalization}
\source{stacks:0823}
\href{https://stacks.math.columbia.edu/tag/0823}{\texttt{Stacks tag 0823}}
\group{spaces-morphisms}
...
$$
\begin{array}{cc}Y \underset{f'}{\downarrow}\underset{g}{\longrightarrow} & Z \overset{\pi}{\downarrow} \\ X' \overset{h}{\nearrow}\overset{\nu}{\longrightarrow} & X\end{array}
$$
...
$\mathcal{O}_X$ as in Definition \ref{spaces-morphisms-definition-normalization-X-in-Y}.
The morphism $\nu$ is integral by construction, which proves (1).
Assume given a factorization $f = \pi \circ g$ with $\pi : Z \to X$
integral as in (2). By Definition \ref{spaces-morphisms-definition-integral}
...
(by Definition \ref{spaces-morphisms-definition-integral})
we see from Lemma \ref{spaces-morphisms-lemma-integral-closure}
...
is integral by Lemma \ref{spaces-morphisms-lemma-finite-permanence}.
...
\begin{lemma}[Normalization in reduced]
\label{spaces-morphisms-lemma-normalization-in-reduced}
\source{stacks:0AYF}
\href{https://stacks.math.columbia.edu/tag/0AYF}{\texttt{Stacks tag 0AYF}}
\group{spaces-morphisms}
...
\begin{lemma}[Normalization generic]
\label{spaces-morphisms-lemma-normalization-generic}
\source{stacks:0AYG}
\href{https://stacks.math.columbia.edu/tag/0AYG}{\texttt{Stacks tag 0AYG}}
\group{spaces-morphisms}
...
\begin{proof}
By Lemma \ref{spaces-morphisms-lemma-properties-normalization} and the definitions, we may
...
\begin{lemma}[Normalization in disjoint union]
\label{spaces-morphisms-lemma-normalization-in-disjoint-union}
\source{stacks:0824}
\href{https://stacks.math.columbia.edu/tag/0824}{\texttt{Stacks tag 0824}}
\group{spaces-morphisms}
...
\begin{lemma}[Normalization in universally closed]
\label{spaces-morphisms-lemma-normalization-in-universally-closed}
\source{stacks:0A0Q}
\href{https://stacks.math.columbia.edu/tag/0A0Q}{\texttt{Stacks tag 0A0Q}}
\group{spaces-morphisms}
...
\longrightarrow Y
$$
of Remark \ref{spaces-morphisms-remark-factorization-quasi-compact-quasi-separated}.
\end{lemma}
...
$$
\begin{array}{ccc}X \underset{h}{\longrightarrow}\underset{f}{\searrow} &  & \mathbf{A}^1_Y \swarrow \\  & Y & \end{array}
$$
Let $Z \subset \mathbf{A}^1_Y$ be the scheme theoretic image of $h$,
see Definition \ref{spaces-morphisms-definition-scheme-theoretic-image}.
The morphism $h$ is quasi-compact as $f$ is quasi-compact and
$\mathbf{A}^1_Y \to Y$ is separated, see
Lemma \ref{spaces-morphisms-lemma-quasi-compact-permanence}.
By Lemma \ref{spaces-morphisms-lemma-quasi-compact-scheme-theoretic-image} the
morphism $X \to Z$ has dense image on underlying topological spaces. By
Lemma \ref{spaces-morphisms-lemma-universally-closed-permanence} the morphism
...
and proper, hence integral by Lemma \ref{spaces-morphisms-lemma-integral-universally-closed}.
...
\begin{lemma}[Normalization in integral]
\label{spaces-morphisms-lemma-normalization-in-integral}
\source{stacks:0825}
\href{https://stacks.math.columbia.edu/tag/0825}{\texttt{Stacks tag 0825}}
\group{spaces-morphisms}
...
\begin{proof}
By Lemma \ref{spaces-morphisms-lemma-integral-universally-closed} this is a special case of
Lemma \ref{spaces-morphisms-lemma-normalization-in-universally-closed}.
\end{proof}

\begin{lemma}[Nagata normalization finite]
\label{spaces-morphisms-lemma-nagata-normalization-finite}
\source{stacks:0BB0}
\href{https://stacks.math.columbia.edu/tag/0BB0}{\texttt{Stacks tag 0BB0}}
\group{spaces-morphisms}
...
Lemma \ref{spaces-morphisms-lemma-properties-normalization}.
...
\source{stacks:0BB1}
\href{https://stacks.math.columbia.edu/tag/0BB1}{\texttt{Stacks tag 0BB1}}
\group{spaces-morphisms}
...
\begin{lemma}[Flat image point codimension 0]
\label{spaces-morphisms-lemma-flat-image-point-codimension-0}
\source{stacks:0GMC}
\href{https://stacks.math.columbia.edu/tag/0GMC}{\texttt{Stacks tag 0GMC}}
\group{spaces-morphisms}
...
\begin{lemma}[Flat locally finite type points codimension 0]
\label{spaces-morphisms-lemma-flat-locally-finite-type-points-codimension-0}
\source{stacks:0GMD}
\href{https://stacks.math.columbia.edu/tag/0GMD}{\texttt{Stacks tag 0GMD}}
\group{spaces-morphisms}
...
Lemma \ref{spaces-morphisms-lemma-prepare-normalization} and for $x \in |X|$ we have:
$x$ has codimension $0$ in $X \Rightarrow f(x)$ has codimension $0$ in $Y$.
\end{lemma}

\begin{proof}
The last statement follows from
Lemma \ref{spaces-morphisms-lemma-flat-image-point-codimension-0}.
...
and we can apply Lemma \ref{spaces-morphisms-lemma-locally-noetherian-can-be-normalized}
for example.
\end{proof}
...
\source{stacks:07U4}
\href{https://stacks.math.columbia.edu/tag/07U4}{\texttt{Stacks tag 07U4}}
\group{spaces-morphisms}

Let $S$ be a scheme. For every algebraic space $X$ over $S$ satisfying
the equivalent conditions of Lemma \ref{spaces-morphisms-lemma-prepare-normalization}
...
Lemma \ref{spaces-morphisms-lemma-prepare-normalization} then
$X^\nu$ is normal and $\nu_X$ is integral,
...
Lemma \ref{spaces-morphisms-lemma-prepare-normalization} and every codimension $0$
...
Lemma \ref{spaces-morphisms-lemma-prepare-normalization}, then the hypotheses of (3)
...
Lemma \ref{spaces-morphisms-lemma-flat-locally-finite-type-points-codimension-0}
...
Lemma \ref{spaces-morphisms-lemma-prepare-normalization} if we choose a surjective \'etale
morphism $g : U \to X$ where $U$ is a scheme, then we obtain
a cartesian diagram
$$
\begin{array}{cc}X^\nu \underset{\nu_X}{\downarrow} & U^\nu \overset{g^\nu}{\longleftarrow}\overset{\nu_U}{\downarrow} \\ X & U \underset{g}{\longleftarrow}\end{array}
$$
...
that $h = \nu_U \circ h^\nu$. Picture:
$$
\begin{array}{ccc}X^\nu \underset{\nu_X}{\downarrow} & U^\nu \overset{g^\nu}{\longleftarrow}\overset{\nu_U}{\downarrow} & Z \overset{h^\nu}{\longleftarrow}\underset{a}{\longleftarrow}\overset{h}{\swarrow} \\ X & U \underset{g}{\longleftarrow} & \end{array}
$$
...
\source{stacks:0BB2}
\href{https://stacks.math.columbia.edu/tag/0BB2}{\texttt{Stacks tag 0BB2}}
\group{spaces-morphisms}

Let $S$ be a scheme. Let $X$ be an algebraic space over $S$ satisfying the
equivalent conditions of Lemma \ref{spaces-morphisms-lemma-prepare-normalization}.
We define the {\it normalization} of $X$ as the morphism
$$
\nu_X : X^\nu \longrightarrow X
$$
constructed in Lemma \ref{spaces-morphisms-lemma-normalization}.
\end{definition}

The definition applies to locally Noetherian algebraic
spaces, see Lemma \ref{spaces-morphisms-lemma-locally-noetherian-can-be-normalized}.
...
\begin{lemma}[Normalization reduced]
\label{spaces-morphisms-lemma-normalization-reduced}
\source{stacks:0BB3}
\href{https://stacks.math.columbia.edu/tag/0BB3}{\texttt{Stacks tag 0BB3}}
\group{spaces-morphisms}
...
\begin{lemma}[Normalization normal]
\label{spaces-morphisms-lemma-normalization-normal}
\source{stacks:0BB4}
\href{https://stacks.math.columbia.edu/tag/0BB4}{\texttt{Stacks tag 0BB4}}
\group{spaces-morphisms}
...
$U \times_X Z \to U^\nu$. Picture
$$
\begin{array}{ccc}U \times_X Z \longrightarrow\downarrow & U^\nu \longrightarrow\downarrow & U \downarrow \\ Z \longrightarrow\dashrightarrow & X^\nu \longrightarrow & X\end{array}
$$
...
$s, t : R \to U$ and $s^\nu, t^\nu : R^\nu \to U^\nu$.
Recall that $X^\nu = U^\nu/R^\nu$, see proof of
Lemma \ref{spaces-morphisms-lemma-normalization}. Since $X = U/R$ a
...
\begin{lemma}[Nagata normalization]
\label{spaces-morphisms-lemma-nagata-normalization}
\source{stacks:0BB5}
\href{https://stacks.math.columbia.edu/tag/0BB5}{\texttt{Stacks tag 0BB5}}
\group{spaces-morphisms}
...
Definition \ref{spaces-morphisms-definition-normalization} applies.
By construction of $X^\nu$ in Lemma \ref{spaces-morphisms-lemma-normalization}
...
\begin{lemma}[Neighbourhood scheme]
\label{spaces-morphisms-lemma-neighbourhood-scheme}
\source{stacks:03XW}
\href{https://stacks.math.columbia.edu/tag/03XW}{\texttt{Stacks tag 03XW}}
\group{spaces-morphisms}

Let $S$ be a scheme. Consider a commutative diagram
$$
\begin{array}{ccc}V' \longrightarrow\searrow & T' \times_T X \longrightarrow\downarrow & X \downarrow \\  & T' \longrightarrow & T\end{array}
$$
...
Note that $V'$ is representable by Lemma \ref{spaces-morphisms-lemma-quasi-affine-local}.
...
$$
\begin{array}{ccc}p_0^{-1}(V') \cap X^* \longrightarrow\searrow & X^* \underset{p_1|_{X^*}}{\longrightarrow}\downarrow & X' \downarrow \\  & T^* \overset{\text{pr}_1|_{T^*}}{\longrightarrow} & T'\end{array}
$$
...
\begin{proposition}[Locally quasi finite separated over scheme]
\label{spaces-morphisms-proposition-locally-quasi-finite-separated-over-scheme}
\source{stacks:03XX}
\href{https://stacks.math.columbia.edu/tag/03XX}{\texttt{Stacks tag 03XX}}
\group{spaces-morphisms}
...
Lemmas \ref{spaces-morphisms-lemma-etale-locally-quasi-finite} and
...
Lemma \ref{spaces-morphisms-lemma-neighbourhood-scheme}
...
\begin{lemma}[Locally quasi finite separated representable]
\label{spaces-morphisms-lemma-locally-quasi-finite-separated-representable}
\source{stacks:0418}
\href{https://stacks.math.columbia.edu/tag/0418}{\texttt{Stacks tag 0418}}
\group{spaces-morphisms}
...
Lemmas \ref{spaces-morphisms-lemma-base-change-quasi-finite} and
\ref{spaces-morphisms-lemma-base-change-separated}.
\end{proof}

\begin{lemma}[Universally injective \'etale maps are open immersions.]
\label{spaces-morphisms-lemma-etale-universally-injective-open}
\source{stacks:05W5}
\href{https://stacks.math.columbia.edu/tag/05W5}{\texttt{Stacks tag 05W5}}
\group{spaces-morphisms}
...
Lemmas \ref{spaces-morphisms-lemma-base-change-etale} and
...
\source{stacks:0ABR}
\href{https://stacks.math.columbia.edu/tag/0ABR}{\texttt{Stacks tag 0ABR}}
\group{spaces-morphisms}
...
$$
\begin{array}{ccc}W \times_Y X \underset{(1, f)}{\searrow}\underset{(1, f')}{\longrightarrow} &  & W \times_Y Y' \overset{(1, \nu)}{\swarrow} \\  & W & \end{array}
$$
...
$(1, f)$ is quasi-finite.
\end{enumerate}
By Lemma \ref{spaces-morphisms-lemma-locally-finite-type-quasi-finite-part}
...
by Lemma \ref{spaces-morphisms-lemma-closed-immersion-local}
...
\source{stacks:0ABS}
\href{https://stacks.math.columbia.edu/tag/0ABS}{\texttt{Stacks tag 0ABS}}
\group{spaces-morphisms}
...
\begin{proof}
By Lemma \ref{spaces-morphisms-lemma-locally-quasi-finite-separated-representable}
the morphism $f$ is representable. Hence we may apply
Lemma \ref{spaces-morphisms-lemma-finite-type-separated}. Thus there exists an open
...
\begin{lemma}[Universal homeomorphism representable]
\label{spaces-morphisms-lemma-universal-homeomorphism-representable}
\source{stacks:05Z4}
\href{https://stacks.math.columbia.edu/tag/05Z4}{\texttt{Stacks tag 05Z4}}
\group{spaces-morphisms}

Let $S$ be a scheme.
Let $f : X \to Y$ be a representable morphism of algebraic spaces over $S$.
Then $f$ is a universal homeomorphism
(in the sense of Section \ref{spaces-morphisms-section-representable}) if and only
...
\source{stacks:05Z5}
\href{https://stacks.math.columbia.edu/tag/05Z5}{\texttt{Stacks tag 05Z5}}
\group{spaces-morphisms}
...
Lemma \ref{spaces-morphisms-lemma-universal-homeomorphism-representable}.
For morphisms of algebraic spaces it is not the case that universal
homeomorphisms are always integral.

\begin{example}[Universal homeomorphism]
\label{spaces-morphisms-example-universal-homeomorphism}
\source{stacks:05Z6}
\href{https://stacks.math.columbia.edu/tag/05Z6}{\texttt{Stacks tag 05Z6}}
\group{spaces-morphisms}

This is a continuation of
Remark \ref{spaces-morphisms-remark-universally-injective-not-separated}.
...
\source{stacks:0CFT}
\href{https://stacks.math.columbia.edu/tag/0CFT}{\texttt{Stacks tag 0CFT}}
\group{spaces-morphisms}
...
\source{stacks:0CFU}
\href{https://stacks.math.columbia.edu/tag/0CFU}{\texttt{Stacks tag 0CFU}}
\group{spaces-morphisms}
...
\begin{lemma}[Reduction universal homeomorphism]
\label{spaces-morphisms-lemma-reduction-universal-homeomorphism}
\source{stacks:08AK}
\href{https://stacks.math.columbia.edu/tag/08AK}{\texttt{Stacks tag 08AK}}
\group{spaces-morphisms}
...
\begin{lemma}[Integral universally injective push pull]
\label{spaces-morphisms-lemma-integral-universally-injective-push-pull}
\source{stacks:0AEH}
\href{https://stacks.math.columbia.edu/tag/0AEH}{\texttt{Stacks tag 0AEH}}
\group{spaces-morphisms}
