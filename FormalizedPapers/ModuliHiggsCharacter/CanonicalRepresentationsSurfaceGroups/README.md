...
`FormalizedPapers/ModuliHiggsCharacter/CanonicalRepresentationsSurfaceGroups`.
...
- Source bundle: [`references/canonical-representations-surface-groups/`](../../../references/canonical-representations-surface-groups/)
