...
\begin{proof}
  \leanok\uses{mk-thm:identity_component_open_subgroup, mk-thm:identity_component_base_change_commutes, mk-thm:identity_component_is_subgroup_homomorphism, mk-def:identity_component_group_scheme}
