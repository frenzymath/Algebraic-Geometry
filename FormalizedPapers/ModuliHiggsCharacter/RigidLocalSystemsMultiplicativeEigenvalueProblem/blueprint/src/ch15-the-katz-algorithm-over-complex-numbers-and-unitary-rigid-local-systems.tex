...
\iffalse
\begin{remark}
\label{src-rigid-local-systems-multiplicative-eigenvalue-problem-ch15-the-katz-algorithm-over-complex-numbers-and-unitary-rigid-local-systems-statement-1}
\source{rigid-local-systems-multiplicative-eigenvalue-problem}
\notready
