...
\begin{lemma}[Relative glueing]
\label{constructions-lemma-relative-glueing}
\source{stacks:01LH}
\href{https://stacks.math.columbia.edu/tag/01LH}{\texttt{Stacks tag 01LH}}
\group{constructions}
...
$$
\begin{array}{ccccc}X_V \overset{i_V^{-1}}{\longrightarrow} & f^{-1}(V) \overset{inclusion}{\longrightarrow} &  & f^{-1}(U) \overset{i_U}{\longrightarrow} & X_U\end{array}
$$
...
\begin{lemma}[Relative glueing sheaves]
\label{constructions-lemma-relative-glueing-sheaves}
\source{stacks:01LI}
\href{https://stacks.math.columbia.edu/tag/01LI}{\texttt{Stacks tag 01LI}}
\group{constructions}
...
\begin{proof}
\uses{constructions-lemma-relative-glueing}

By Lemma \ref{constructions-lemma-relative-glueing} we get the scheme $X$ over $S$
...
\begin{remark}[Relative glueing functorial]
\label{constructions-remark-relative-glueing-functorial}
\source{stacks:01LK}
\href{https://stacks.math.columbia.edu/tag/01LK}{\texttt{Stacks tag 01LK}}
\group{constructions}

\uses{constructions-lemma-relative-glueing, constructions-lemma-relative-glueing-sheaves}
There is a functoriality property for the constructions explained
in Lemmas \ref{constructions-lemma-relative-glueing} and
\ref{constructions-lemma-relative-glueing-sheaves}. Namely, suppose given
two collections of data $(f_U : X_U \to U, \rho^U_V)$ and
$(g_U : Y_U \to U, \sigma^U_V)$ as in Lemma \ref{constructions-lemma-relative-glueing}.
...
as in Lemma \ref{constructions-lemma-relative-glueing-sheaves}.
Suppose for every $U \in \mathcal{B}$ given
a morphism $h_U : X_U \to Y_U$ over $U$ compatible with
...
\begin{definition}[Situation: Relative spec]
\label{constructions-situation-relative-spec}
\source{stacks:01LM}
\href{https://stacks.math.columbia.edu/tag/01LM}{\texttt{Stacks tag 01LM}}
\group{constructions}
...
suitable collection of schemes, as in Lemma \ref{constructions-lemma-relative-glueing}.

\begin{lemma}[Spec inclusion]
\label{constructions-lemma-spec-inclusion}
\source{stacks:01LN}
\href{https://stacks.math.columbia.edu/tag/01LN}{\texttt{Stacks tag 01LN}}
\group{constructions}

\uses{constructions-situation-relative-spec}
In Situation \ref{constructions-situation-relative-spec}.
...
$$
\begin{array}{cc}\Spec(A) \longrightarrow\downarrow & \Spec(A') \downarrow \\ U \longrightarrow & U'\end{array}
$$
is cartesian.
\end{lemma}
...
\begin{lemma}[Transitive spec]
\label{constructions-lemma-transitive-spec}
\source{stacks:01LO}
\href{https://stacks.math.columbia.edu/tag/01LO}{\texttt{Stacks tag 01LO}}
\group{constructions}

\uses{constructions-situation-relative-spec, constructions-lemma-spec-inclusion}
In Situation \ref{constructions-situation-relative-spec}.
...
$\Spec(A) \to \Spec(A')$, and
$\Spec(A') \to \Spec(A'')$ of
Lemma \ref{constructions-lemma-spec-inclusion} gives the
morphism $\Spec(A) \to \Spec(A'')$
of Lemma \ref{constructions-lemma-spec-inclusion}.
\end{lemma}
...
\begin{lemma}[Glue relative spec]
\label{constructions-lemma-glue-relative-spec}
\source{stacks:01LP}
\href{https://stacks.math.columbia.edu/tag/01LP}{\texttt{Stacks tag 01LP}}
\group{constructions}
...
$$
\begin{array}{ccccc}\Spec(\mathcal{A}(U)) \overset{i_U^{-1}}{\longrightarrow} & \pi^{-1}(U) \overset{inclusion}{\longrightarrow} &  & \pi^{-1}(U') \overset{i_{U'}}{\longrightarrow} & \Spec(\mathcal{A}(U'))\end{array}
$$
is the open immersion of Lemma \ref{constructions-lemma-spec-inclusion} above.
\end{enumerate}
...
\begin{proof}
\uses{constructions-lemma-relative-glueing, constructions-lemma-spec-inclusion, constructions-lemma-transitive-spec}

Follows immediately from
Lemmas \ref{constructions-lemma-relative-glueing},
\ref{constructions-lemma-spec-inclusion}, and
\ref{constructions-lemma-transitive-spec}.
Uniqueness is stated in the last sentence of
Lemma \ref{constructions-lemma-relative-glueing}.
\end{proof}

\section{Relative spectrum as a functor}
\label{constructions-section-spec}
We place ourselves in Situation \ref{constructions-situation-relative-spec}, i.e.,
...
\begin{lemma}[Spec base change]
\label{constructions-lemma-spec-base-change}
\source{stacks:01LS}
\href{https://stacks.math.columbia.edu/tag/01LS}{\texttt{Stacks tag 01LS}}
\group{constructions}
...
\begin{lemma}[Spec affine]
\label{constructions-lemma-spec-affine}
\source{stacks:01LT}
\href{https://stacks.math.columbia.edu/tag/01LT}{\texttt{Stacks tag 01LT}}
\group{constructions}
...
ring map
$$
\begin{array}{ccc}A = \Gamma(S, \mathcal{A}) \overset{f^*}{\longrightarrow} & \Gamma(T, f^*\mathcal{A}) \overset{\varphi}{\longrightarrow} & \Gamma(T, \mathcal{O}_T)\end{array}
$$
...
\source{stacks:01LU}
\href{https://stacks.math.columbia.edu/tag/01LU}{\texttt{Stacks tag 01LU}}
\group{constructions}
...
\begin{proof}
\uses{constructions-lemma-spec-base-change, constructions-lemma-spec-affine}
...
by Lemma \ref{constructions-lemma-spec-base-change}.
Thus the result follows from Lemma \ref{constructions-lemma-spec-affine}.
...
\begin{lemma}[Glueing gives functor spec]
\label{constructions-lemma-glueing-gives-functor-spec}
\source{stacks:01LV}
\href{https://stacks.math.columbia.edu/tag/01LV}{\texttt{Stacks tag 01LV}}
\group{constructions}

\uses{constructions-situation-relative-spec, constructions-lemma-glue-relative-spec}
In Situation \ref{constructions-situation-relative-spec}.
The scheme $\pi : \underline{\Spec}_S(\mathcal{A}) \to S$
constructed in Lemma \ref{constructions-lemma-glue-relative-spec}
and the scheme representing the functor $F$ are
canonically isomorphic as schemes over $S$.
\end{lemma}

\begin{proof}
\uses{constructions-lemma-glue-relative-spec, constructions-lemma-spec-affine}
...
Lemma \ref{constructions-lemma-glue-relative-spec} part (1).
For $U \subset U' \subset S$ open these isomorphisms are
compatible with the restriction mappings; this follows from
Lemma \ref{constructions-lemma-glue-relative-spec} part (2).
...
Lemma \ref{constructions-lemma-spec-affine}. In other words $X_U \cong \pi^{-1}(U)$.
...
\source{stacks:01LW}
\href{https://stacks.math.columbia.edu/tag/01LW}{\texttt{Stacks tag 01LW}}
\group{constructions}

\uses{constructions-lemma-glue-relative-spec, constructions-lemma-glueing-gives-functor-spec}
...
constructed in Lemma \ref{constructions-lemma-glue-relative-spec} which represents the
functor $F$ (\ref{equation-spec}), see
Lemma \ref{constructions-lemma-glueing-gives-functor-spec}.
...
\begin{lemma}[Spec properties]
\label{constructions-lemma-spec-properties}
\source{stacks:01LX}
\href{https://stacks.math.columbia.edu/tag/01LX}{\texttt{Stacks tag 01LX}}
\group{constructions}
...
\begin{proof}
\uses{constructions-lemma-glue-relative-spec, constructions-lemma-spec-base-change, constructions-lemma-spec-affine}

Part (1) comes from the description of the relative spectrum
by glueing, see Lemma \ref{constructions-lemma-glue-relative-spec}.
Part (2) follows immediately from Lemma \ref{constructions-lemma-spec-base-change}.
Part (3) follows because it is local on $S$ and it is clear in case $S$
is affine by Lemma \ref{constructions-lemma-spec-affine} for example.
\end{proof}

\begin{lemma}[Canonical morphism]
\label{constructions-lemma-canonical-morphism}
\source{stacks:01LY}
\href{https://stacks.math.columbia.edu/tag/01LY}{\texttt{Stacks tag 01LY}}
\group{constructions}
...
\begin{proof}
\uses{constructions-lemma-spec-affine}
...
affines, see Lemma \ref{constructions-lemma-spec-affine}.
\end{proof}
...
\source{stacks:01M0}
\href{https://stacks.math.columbia.edu/tag/01M0}{\texttt{Stacks tag 01M0}}
\group{constructions}
...
\source{stacks:01M2}
\href{https://stacks.math.columbia.edu/tag/01M2}{\texttt{Stacks tag 01M2}}
\group{constructions}
...
\begin{definition}[Abstract vector bundle]
\label{constructions-definition-abstract-vector-bundle}
\source{stacks:062M}
\href{https://stacks.math.columbia.edu/tag/062M}{\texttt{Stacks tag 062M}}
\group{constructions}
...
$\mathbf{A}^n_S$ over $S$, see Definition \ref{constructions-definition-affine-n-space}.
This is true because
$\mathcal{O}_S[T_1, \ldots, T_n] = \text{Sym}(\mathcal{O}_S^{\oplus n})$.

\begin{lemma}[Category vector bundles]
\label{constructions-lemma-category-vector-bundles}
\source{stacks:062N}
\href{https://stacks.math.columbia.edu/tag/062N}{\texttt{Stacks tag 062N}}
\group{constructions}
...
\source{stacks:062Q}
\href{https://stacks.math.columbia.edu/tag/062Q}{\texttt{Stacks tag 062Q}}
\group{constructions}
...
\begin{definition}[Abstract cone]
\label{constructions-definition-abstract-cone}
\source{stacks:062R}
\href{https://stacks.math.columbia.edu/tag/062R}{\texttt{Stacks tag 062R}}
\group{constructions}
...
\source{stacks:01M4}
\href{https://stacks.math.columbia.edu/tag/01M4}{\texttt{Stacks tag 01M4}}
\group{constructions}
...
topological spaces
$$
\begin{array}{ccc}D_{+}(g) \downarrow & \{\mathbf{Z}\text{-graded primes of }S_g\} \longleftarrow\longrightarrow\downarrow & \Spec(S_{(g)}) \downarrow \\ D_{+}(f) & \{\mathbf{Z}\text{-graded primes of }S_f\} \longleftarrow\longrightarrow & \Spec(S_{(f)})\end{array}
$$
...
\source{stacks:01M5}
\href{https://stacks.math.columbia.edu/tag/01M5}{\texttt{Stacks tag 01M5}}
\group{constructions}
...
by Lemma \ref{constructions-lemma-standard-open} above there are canonical
...
Lemma \ref{constructions-lemma-standard-open} above we have
a canonical map
$$
...
$$
By Lemma \ref{constructions-lemma-standard-open} we see that
$g_1^{\deg(f)}/f^{\deg(g_1)}, \ldots, g_n^{\deg(f)}/f^{\deg(g_n)}$
...
\source{stacks:01M6}
\href{https://stacks.math.columbia.edu/tag/01M6}{\texttt{Stacks tag 01M6}}
\group{constructions}
...
\begin{lemma}[Proj sheaves]
\label{constructions-lemma-proj-sheaves}
\source{stacks:01M7}
\href{https://stacks.math.columbia.edu/tag/01M7}{\texttt{Stacks tag 01M7}}
\group{constructions}

\uses{constructions-lemma-standard-open}
...
\ref{constructions-lemma-standard-open}.
...
\begin{remark}[Global sections not isomorphism]
\label{constructions-remark-global-sections-not-isomorphism}
\source{stacks:01M9}
\href{https://stacks.math.columbia.edu/tag/01M9}{\texttt{Stacks tag 01M9}}
\group{constructions}
...
\begin{lemma}[Standard open proj]
\label{constructions-lemma-standard-open-proj}
\source{stacks:01MA}
\href{https://stacks.math.columbia.edu/tag/01MA}{\texttt{Stacks tag 01MA}}
\group{constructions}
...
\begin{lemma}[Proj scheme]
\label{constructions-lemma-proj-scheme}
\source{stacks:01MB}
\href{https://stacks.math.columbia.edu/tag/01MB}{\texttt{Stacks tag 01MB}}
\group{constructions}
...
\begin{proof}
\uses{constructions-lemma-standard-open, constructions-lemma-proj-sheaves, constructions-lemma-standard-open-proj}

Consider a standard open $D_{+}(f) \subset \text{Proj}(S)$.
By Lemmas \ref{constructions-lemma-standard-open} and \ref{constructions-lemma-proj-sheaves}
...
pick an $h \in S_{+}$ as in Lemma \ref{constructions-lemma-standard-open-proj}.
Then $\varphi^{-1}(D(g)) = D_{+}(h)$, and by
Lemmas \ref{constructions-lemma-proj-sheaves} and \ref{constructions-lemma-standard-open} we see
$$
...
\begin{lemma}[Proj separated]
\label{constructions-lemma-proj-separated}
\source{stacks:01MC}
\href{https://stacks.math.columbia.edu/tag/01MC}{\texttt{Stacks tag 01MC}}
\group{constructions}
...
\begin{lemma}[Proj quasi compact]
\label{constructions-lemma-proj-quasi-compact}
\source{stacks:01MD}
\href{https://stacks.math.columbia.edu/tag/01MD}{\texttt{Stacks tag 01MD}}
\group{constructions}
...
\begin{lemma}[Structure morphism proj]
\label{constructions-lemma-structure-morphism-proj}
\source{stacks:01ME}
\href{https://stacks.math.columbia.edu/tag/01ME}{\texttt{Stacks tag 01ME}}
\group{constructions}
...
Lemma \ref{constructions-lemma-standard-open}.
...
\begin{lemma}[Proj valuative criterion]
\label{constructions-lemma-proj-valuative-criterion}
\source{stacks:01MF}
\href{https://stacks.math.columbia.edu/tag/01MF}{\texttt{Stacks tag 01MF}}
\group{constructions}
...
\begin{proof}
\uses{constructions-lemma-proj-separated}

The uniqueness part follows from the fact that $\text{Proj}(S)$ is
separated (Lemma \ref{constructions-lemma-proj-separated} and
...
$$
\begin{array}{cc}\Spec(K) \longrightarrow\downarrow & \text{Proj}(S) \downarrow \\ \Spec(A) \longrightarrow & \Spec(S_0)\end{array}
$$
...
$$
\begin{array}{cc}K & S_{(f)} \overset{\varphi}{\longleftarrow} \\ A \uparrow & S_0 \longleftarrow\uparrow\end{array}
$$
...
We saw in the proof of Lemma \ref{constructions-lemma-proj-valuative-criterion}
...
\begin{example}[Not existence valuative big proj]
\label{constructions-example-not-existence-valuative-big-proj}
\source{stacks:01MG}
\href{https://stacks.math.columbia.edu/tag/01MG}{\texttt{Stacks tag 01MG}}
\group{constructions}
...
\begin{example}[Not existence valuative small proj]
\label{constructions-example-not-existence-valuative-small-proj}
\source{stacks:01MH}
\href{https://stacks.math.columbia.edu/tag/01MH}{\texttt{Stacks tag 01MH}}
\group{constructions}
...
\begin{example}[Trivial proj]
\label{constructions-example-trivial-proj}
\source{stacks:01MI}
\href{https://stacks.math.columbia.edu/tag/01MI}{\texttt{Stacks tag 01MI}}
\group{constructions}

\uses{constructions-lemma-structure-morphism-proj}
Let $A$ be a ring.
Let $S = A[T]$ as a graded $A$ algebra with $T$ in degree $1$.
Then the canonical morphism $\text{Proj}(S) \to \Spec(A)$
(see Lemma \ref{constructions-lemma-structure-morphism-proj})
is an isomorphism.
\end{example}

\begin{example}[Open subset proj]
\label{constructions-example-open-subset-proj}
\source{stacks:0G5W}
\href{https://stacks.math.columbia.edu/tag/0G5W}{\texttt{Stacks tag 0G5W}}
\group{constructions}
...
$\text{Proj}(S) \to \Spec(A)$ of Lemma \ref{constructions-lemma-structure-morphism-proj}
...
Let $S$ be a graded ring. Let $M$ be a graded $S$-module.
We saw in Lemma \ref{constructions-lemma-proj-sheaves} how to construct a quasi-coherent
...
Definition \ref{constructions-definition-twist}. In order to relate the two notions
we will use the following lemma.

\begin{lemma}[Widetilde tensor]
\label{constructions-lemma-widetilde-tensor}
\source{stacks:01MK}
\href{https://stacks.math.columbia.edu/tag/01MK}{\texttt{Stacks tag 01MK}}
\group{constructions}

\uses{constructions-lemma-proj-scheme}
Let $S$ be a graded ring.
Let $(X, \mathcal{O}_X) = (\text{Proj}(S), \mathcal{O}_{\text{Proj}(S)})$
be the scheme of Lemma \ref{constructions-lemma-proj-scheme}.
...
$$
\begin{array}{cc}M_0 \otimes_{S_0} N_0 \longrightarrow\downarrow & (M \otimes_S N)_0 \downarrow \\ \Gamma(X, \widetilde M \otimes_{\mathcal{O}_X} \widetilde N) \longrightarrow & \Gamma(X, \widetilde{M \otimes_S N})\end{array}
$$
...
\begin{remark}[Not isomorphism]
\label{constructions-remark-not-isomorphism}
\source{stacks:01ML}
\href{https://stacks.math.columbia.edu/tag/01ML}{\texttt{Stacks tag 01ML}}
\group{constructions}

\uses{constructions-lemma-widetilde-tensor}
In general the map constructed in Lemma \ref{constructions-lemma-widetilde-tensor}
...
\source{stacks:01MN}
\href{https://stacks.math.columbia.edu/tag/01MN}{\texttt{Stacks tag 01MN}}
\group{constructions}
...
We are going to use Lemma \ref{constructions-lemma-widetilde-tensor}
...
Remark \ref{constructions-remark-not-isomorphism}. The same example shows
...
\begin{lemma}[When invertible]
\label{constructions-lemma-when-invertible}
\source{stacks:01MS}
\href{https://stacks.math.columbia.edu/tag/01MS}{\texttt{Stacks tag 01MS}}
\group{constructions}
...
\begin{proof}
The graded $S$-module maps $S \to S(nd)$, and $M \to M(nd)$, given by
...
\begin{lemma}[Apply modules]
\label{constructions-lemma-apply-modules}
\source{stacks:01MT}
\href{https://stacks.math.columbia.edu/tag/01MT}{\texttt{Stacks tag 01MT}}
\group{constructions}
...
\begin{proof}
\uses{constructions-lemma-when-invertible}

Under the assumptions of the lemma $X$ is covered by the
open subsets $D_{+}(f)$ with $f \in S_1$ and the
lemma is a consequence of Lemma \ref{constructions-lemma-when-invertible} above.
\end{proof}

\begin{lemma}[Where invertible]
\label{constructions-lemma-where-invertible}
\source{stacks:01MU}
\href{https://stacks.math.columbia.edu/tag/01MU}{\texttt{Stacks tag 01MU}}
\group{constructions}
...
proof of Lemma \ref{constructions-lemma-when-invertible}.
...
are isomorphisms. Compare with the proof of Lemma \ref{constructions-lemma-when-invertible}.
\end{proof}
...
\begin{lemma}[Principal open]
\label{constructions-lemma-principal-open}
\source{stacks:01MV}
\href{https://stacks.math.columbia.edu/tag/01MV}{\texttt{Stacks tag 01MV}}
\group{constructions}

\uses{constructions-lemma-where-invertible}
Let $S$ be a graded ring. Set $X = \text{Proj}(S)$. Fix $d \geq 1$ an
integer. Let $W = W_d \subset X$ be the open subscheme defined in
Lemma \ref{constructions-lemma-where-invertible}. Let $n \geq 1$ and $f \in S_{nd}$.
...
We have seen in the proof of Lemma \ref{constructions-lemma-where-invertible} that
...
\begin{lemma}[Ample on proj]
\label{constructions-lemma-ample-on-proj}
\source{stacks:01MW}
\href{https://stacks.math.columbia.edu/tag/01MW}{\texttt{Stacks tag 01MW}}
\group{constructions}
...
in Lemma \ref{constructions-lemma-where-invertible},
...
\begin{proof}
\uses{constructions-lemma-where-invertible, constructions-lemma-when-invertible, constructions-lemma-principal-open}
...
(2) in Lemma \ref{constructions-lemma-where-invertible} or
by (1) using Lemma \ref{constructions-lemma-when-invertible}.
Note that (1) implies (2), (3) and (4) by Lemma \ref{constructions-lemma-where-invertible}.
(Note that (3) is a special case of (4).)
Assertion (5) follows from Lemma \ref{constructions-lemma-principal-open}.
Assertions (6) and (7) follow because the open subsets $D_{+}(f)$
form a basis for the topology of $X$ and are affine.
\end{proof}

\begin{lemma}[Comparison proj quasi coherent]
\label{constructions-lemma-comparison-proj-quasi-coherent}
\source{stacks:0B5I}
\href{https://stacks.math.columbia.edu/tag/0B5I}{\texttt{Stacks tag 0B5I}}
\group{constructions}
...
\begin{proof}
\uses{constructions-lemma-proj-sheaves, constructions-lemma-when-invertible}

Let $f \in S$ be homogeneous of degree $d > 0$. Recall that
$\widetilde{M}|_{D_{+}(f)}$ corresponds to the
$S_{(f)}$-module $M_{(f)}$ by Lemma \ref{constructions-lemma-proj-sheaves}.
...
Lemma \ref{constructions-lemma-when-invertible} and its proof.
...
\begin{lemma}[Morphism proj]
\label{constructions-lemma-morphism-proj}
\source{stacks:01MY}
\href{https://stacks.math.columbia.edu/tag/01MY}{\texttt{Stacks tag 01MY}}
\group{constructions}
...
$$
\begin{array}{ccc}A_d \downarrow\underset{\psi}{\longrightarrow} &  & B_d \downarrow \\ \Gamma(X, \mathcal{O}_X(d)) \overset{\theta}{\longrightarrow} & \Gamma(U(\psi), \mathcal{O}_Y(d)) & \Gamma(Y, \mathcal{O}_Y(d)) \longleftarrow\end{array}
$$
is commutative.
...
\begin{lemma}[Morphism proj transitive]
\label{constructions-lemma-morphism-proj-transitive}
\source{stacks:01MZ}
\href{https://stacks.math.columbia.edu/tag/01MZ}{\texttt{Stacks tag 01MZ}}
\group{constructions}
...
\begin{lemma}[Surjective graded rings map proj]
\label{constructions-lemma-surjective-graded-rings-map-proj}
\source{stacks:01N0}
\href{https://stacks.math.columbia.edu/tag/01N0}{\texttt{Stacks tag 01N0}}
\group{constructions}

\uses{constructions-lemma-morphism-proj}
With hypotheses and notation as in Lemma \ref{constructions-lemma-morphism-proj} above.
...
\begin{lemma}[Eventual iso graded rings map proj]
\label{constructions-lemma-eventual-iso-graded-rings-map-proj}
\source{stacks:07ZE}
\href{https://stacks.math.columbia.edu/tag/07ZE}{\texttt{Stacks tag 07ZE}}
\group{constructions}
...
\begin{proof}
\uses{constructions-lemma-surjective-graded-rings-map-proj}

We have (1) by Lemma \ref{constructions-lemma-surjective-graded-rings-map-proj}.
...
\begin{lemma}[Surjective graded rings generated degree 1 map proj]
\label{constructions-lemma-surjective-graded-rings-generated-degree-1-map-proj}
\source{stacks:01N1}
\href{https://stacks.math.columbia.edu/tag/01N1}{\texttt{Stacks tag 01N1}}
\group{constructions}
...
\begin{proof}
\uses{constructions-lemma-eventual-iso-graded-rings-map-proj, constructions-lemma-morphism-proj-transitive, constructions-lemma-surjective-graded-rings-map-proj, constructions-lemma-apply-modules}

By Lemmas \ref{constructions-lemma-eventual-iso-graded-rings-map-proj} and
...
Lemma \ref{constructions-lemma-surjective-graded-rings-map-proj} we get (1) and (2)
and surjectivity in (3).
By Lemma \ref{constructions-lemma-apply-modules} we see that both
$\mathcal{O}_X(n)$ and $\mathcal{O}_Y(n)$
are invertible. Hence $\theta$ is an isomorphism.
\end{proof}

\begin{lemma}[Base change map proj]
\label{constructions-lemma-base-change-map-proj}
\source{stacks:01N2}
\href{https://stacks.math.columbia.edu/tag/01N2}{\texttt{Stacks tag 01N2}}
\group{constructions}
...
\item the diagram
$$
\begin{array}{cc}Y = \text{Proj}(B) \underset{r_\psi}{\longrightarrow}\downarrow & \text{Proj}(A) = X \downarrow \\ \Spec(R') \longrightarrow & \Spec(R)\end{array}
$$
...
\begin{lemma}[Localization map proj]
\label{constructions-lemma-localization-map-proj}
\source{stacks:01N3}
\href{https://stacks.math.columbia.edu/tag/01N3}{\texttt{Stacks tag 01N3}}
\group{constructions}
...
\begin{proof}
\uses{constructions-lemma-base-change-map-proj}

This is a special case of Lemma \ref{constructions-lemma-base-change-map-proj} above.
\end{proof}

\begin{lemma}[D uple]
\label{constructions-lemma-d-uple}
\source{stacks:0B5J}
\href{https://stacks.math.columbia.edu/tag/0B5J}{\texttt{Stacks tag 0B5J}}
\group{constructions}
...
of Lemma \ref{constructions-lemma-widetilde-tensor} and hence with the maps
...
\begin{proof}
\uses{constructions-lemma-standard-open, constructions-lemma-widetilde-tensor}
...
Lemma \ref{constructions-lemma-standard-open}, we see that there exists an
...
Lemma \ref{constructions-lemma-widetilde-tensor} is the commutativity of the diagram
$$
\begin{array}{cc}\widetilde M \otimes_{\mathcal{O}_X} \widetilde N
\underset{(1) \otimes (1)}{\downarrow}\longrightarrow & \widetilde{M \otimes_S N} \overset{(1)}{\downarrow} \\ i^*(\widetilde{M'} \otimes_{\mathcal{O}_{X'}} \widetilde{N'}) \longrightarrow & i^*(\widetilde{M' \otimes_{S'} N'})\end{array}
$$
...
By Lemma \ref{constructions-lemma-when-invertible}
...
\begin{lemma}[Converse construction]
\label{constructions-lemma-converse-construction}
\source{stacks:01N8}
\href{https://stacks.math.columbia.edu/tag/01N8}{\texttt{Stacks tag 01N8}}
\group{constructions}
...
$$
\begin{array}{ccc}\Gamma_*(Y, \mathcal{L}) & \Gamma_*(Y, \varphi^*\mathcal{O}_{U_d}(d)) \overset{\alpha}{\longleftarrow} & \Gamma_*(U_d, \mathcal{O}_{U_d}(d)) \overset{\varphi^*}{\longleftarrow} \\ S^{(d)} \overset{\psi}{\uparrow} &  & S^{(d)} \overset{\psi^d}{\uparrow}\overset{\psi^d_\varphi}{\nwarrow}\underset{\text{id}}{\longleftarrow}\end{array}
$$
commutes. Moreover, the pair $(\varphi, \alpha)$ is unique.
\end{lemma}

\begin{proof}
\uses{constructions-lemma-ample-on-proj, constructions-lemma-proj-separated}
...
$D_{+}(f) \cap D_{+}(f') = D_{+}(ff')$.
In Lemma \ref{constructions-lemma-ample-on-proj} we saw that
...
$S_{(ff')} \to \Gamma(Y_{ss'}, \mathcal{O}_Y)$ making the
following diagram commute
$$
\begin{array}{ccc}\Gamma(Y_s, \mathcal{O}_Y) \longrightarrow & \Gamma(Y_{ss'}, \mathcal{O}_Y) & \Gamma(Y_{s, '} \mathcal{O}_Y) \longleftarrow \\ S_{(f)} \longrightarrow\overset{\psi_{(f)}}{\uparrow} & S_{(ff')} \uparrow & S_{(f')} \longleftarrow\overset{\psi_{(f')}}{\uparrow}\end{array}
$$
...
Lemma \ref{constructions-lemma-proj-separated} and its proof. This shows that the
...
$\psi_{(f')}(f/f')$ agree. This proves that the morphisms $\psi_f$
...
\begin{lemma}[Proj functor strict]
\label{constructions-lemma-proj-functor-strict}
\source{stacks:01N9}
\href{https://stacks.math.columbia.edu/tag/01N9}{\texttt{Stacks tag 01N9}}
\group{constructions}
...
\begin{proof}
\uses{constructions-lemma-converse-construction}

This is a reformulation of Lemma \ref{constructions-lemma-converse-construction}
\end{proof}

\begin{lemma}[Apply]
\label{constructions-lemma-apply}
\source{stacks:01NA}
\href{https://stacks.math.columbia.edu/tag/01NA}{\texttt{Stacks tag 01NA}}
\group{constructions}
...
\begin{proof}
\uses{constructions-lemma-proj-functor-strict}

Under the assumptions of the lemma we have $X = U_1$ and the
lemma is a reformulation of Lemma \ref{constructions-lemma-proj-functor-strict} above.
\end{proof}
...
\source{stacks:01NB}
\href{https://stacks.math.columbia.edu/tag/01NB}{\texttt{Stacks tag 01NB}}
\group{constructions}
...
in Lemma \ref{constructions-lemma-converse-construction}.
...
(by Lemma \ref{constructions-lemma-converse-construction} again). Hence taking
...
This, combined with Lemma \ref{constructions-lemma-converse-construction} shows
...
One of the implications of Lemma \ref{constructions-lemma-equivalent} is that the
...
\begin{lemma}[Proj functor]
\label{constructions-lemma-proj-functor}
\source{stacks:01NC}
\href{https://stacks.math.columbia.edu/tag/01NC}{\texttt{Stacks tag 01NC}}
\group{constructions}
...
\begin{lemma}[Projective space]
\label{constructions-lemma-projective-space}
\source{stacks:01NE}
\href{https://stacks.math.columbia.edu/tag/01NE}{\texttt{Stacks tag 01NE}}
\group{constructions}
...
\begin{proof}
\uses{constructions-lemma-apply}

This is a special case of Lemma \ref{constructions-lemma-apply} above.
...
\source{stacks:01NF}
\href{https://stacks.math.columbia.edu/tag/01NF}{\texttt{Stacks tag 01NF}}
\group{constructions}
...
Lemma \ref{constructions-lemma-projective-space}
...
Via Lemma \ref{constructions-lemma-relative-proj-base-change}
we can identify $\mathbf{P}^n_S$ with a relative Proj of
the graded $\mathcal{O}_S$-algebra $\mathcal{O}_S[T_0, \ldots, T_n]$
and we can characterize $\varphi_{(\mathcal{L}, (s_0, \ldots, s_n))}$
as the unique $S$-morphism such that
$$
\mathcal{L} =
...
$\mathcal{O}_{\mathbf{P}^n_S}(1)$ via the map $\psi$ of
Lemma \ref{constructions-lemma-glue-relative-proj-twists}; details omitted.

\begin{lemma}[Standard covering projective space]
\label{constructions-lemma-standard-covering-projective-space}
\source{stacks:01NG}
\href{https://stacks.math.columbia.edu/tag/01NG}{\texttt{Stacks tag 01NG}}
\group{constructions}
...
\begin{lemma}[Projective space separated]
\label{constructions-lemma-projective-space-separated}
\source{stacks:01NH}
\href{https://stacks.math.columbia.edu/tag/01NH}{\texttt{Stacks tag 01NH}}
\group{constructions}
...
\begin{proof}
\uses{constructions-lemma-proj-separated, constructions-lemma-standard-covering-projective-space, constructions-lemma-proj-valuative-criterion}
...
Separatedness is Lemma \ref{constructions-lemma-proj-separated}. Quasi-compactness follows
from Lemma \ref{constructions-lemma-standard-covering-projective-space}.
Existence and uniqueness of the valuative criterion follow from
Lemma \ref{constructions-lemma-proj-valuative-criterion}.
Universally closed follows from the above and
Schemes, Proposition \ref{schemes-proposition-characterize-universally-closed}.
\end{proof}

\begin{remark}[Missing finite type]
\label{constructions-remark-missing-finite-type}
\source{stacks:01NI}
\href{https://stacks.math.columbia.edu/tag/01NI}{\texttt{Stacks tag 01NI}}
\group{constructions}
...
\source{stacks:01WD}
\href{https://stacks.math.columbia.edu/tag/01WD}{\texttt{Stacks tag 01WD}}
\group{constructions}
...
\begin{proof}
\uses{constructions-lemma-projective-space}
...
See Lemma \ref{constructions-lemma-projective-space}.
...
perhaps it makes sense to prove these directly here now. The first one is
a special case of Divisors, Lemma \ref{divisors-lemma-closed-subscheme-proj}.

\begin{lemma}[Closed in projective space]
\label{constructions-lemma-closed-in-projective-space}
\source{stacks:03GL}
\href{https://stacks.math.columbia.edu/tag/03GL}{\texttt{Stacks tag 03GL}}
\group{constructions}
...
\begin{proof}
\uses{constructions-lemma-surjective-graded-rings-generated-degree-1-map-proj}

It is clear that $I$ is a graded ideal.
Set $Z' = \text{Proj}(R[T_0, \ldots, T_n]/I)$.
By Lemma \ref{constructions-lemma-surjective-graded-rings-generated-degree-1-map-proj}
...
\begin{lemma}[Quasi coherent projective space]
\label{constructions-lemma-quasi-coherent-projective-space}
\source{stacks:03GM}
\href{https://stacks.math.columbia.edu/tag/03GM}{\texttt{Stacks tag 03GM}}
\group{constructions}
...
\begin{lemma}[Globally generated omega twist 1]
\label{constructions-lemma-globally-generated-omega-twist-1}
\source{stacks:0B3B}
\href{https://stacks.math.columbia.edu/tag/0B3B}{\texttt{Stacks tag 0B3B}}
\group{constructions}
...
lemma as a slight generalization of Lemma \ref{constructions-lemma-apply}.
It also is a generalization of Lemma \ref{constructions-lemma-morphism-proj}.

\begin{lemma}[Invertible map into proj]
\label{constructions-lemma-invertible-map-into-proj}
\source{stacks:01NK}
\href{https://stacks.math.columbia.edu/tag/01NK}{\texttt{Stacks tag 01NK}}
\group{constructions}
...
\item For every $d \geq 0$ the diagram
$$
\begin{array}{cc}A_d \underset{(\ref{equation-global-sections})}{\downarrow}\underset{\psi}{\longrightarrow} & \Gamma(T, \mathcal{L}^{\otimes d}) \overset{restrict}{\downarrow} \\ \Gamma(X, \mathcal{O}_X(d)) \overset{\theta}{\longrightarrow} & \Gamma(U(\psi), \mathcal{L}^{\otimes d})\end{array}
$$
is commutative.
\end{enumerate}
...
of Lemma \ref{constructions-lemma-converse-construction}
associated to
...
According to Lemma \ref{constructions-lemma-converse-construction}
...
\begin{remark}[Not in invertible locus]
\label{constructions-remark-not-in-invertible-locus}
\source{stacks:01NL}
\href{https://stacks.math.columbia.edu/tag/01NL}{\texttt{Stacks tag 01NL}}
\group{constructions}

\uses{constructions-lemma-invertible-map-into-proj, constructions-remark-not-isomorphism}
Assumptions as in Lemma \ref{constructions-lemma-invertible-map-into-proj} above.
...
Remark \ref{constructions-remark-not-isomorphism} we showed that the sheaf
...
\begin{definition}[Situation: Relative proj]
\label{constructions-situation-relative-proj}
\source{stacks:01NN}
\href{https://stacks.math.columbia.edu/tag/01NN}{\texttt{Stacks tag 01NN}}
\group{constructions}
...
\begin{lemma}[Proj inclusion]
\label{constructions-lemma-proj-inclusion}
\source{stacks:01NO}
\href{https://stacks.math.columbia.edu/tag/01NO}{\texttt{Stacks tag 01NO}}
\group{constructions}

\uses{constructions-situation-relative-proj}
In Situation \ref{constructions-situation-relative-proj}.
Suppose $U \subset U' \subset S$ are affine opens.
Let $A = \mathcal{A}(U)$ and $A' = \mathcal{A}(U')$.
The map of graded rings $A' \to A$ induces a morphism
$r : \text{Proj}(A) \to \text{Proj}(A')$, and the diagram
$$
\begin{array}{cc}\text{Proj}(A) \longrightarrow\downarrow & \text{Proj}(A') \downarrow \\ U \longrightarrow & U'\end{array}
$$
...
Lemma \ref{constructions-lemma-base-change-map-proj}.
\end{proof}

In particular the morphism $\text{Proj}(A) \to \text{Proj}(A')$
of the lemma is an open immersion.

\begin{lemma}[Transitive proj]
\label{constructions-lemma-transitive-proj}
\source{stacks:01NP}
\href{https://stacks.math.columbia.edu/tag/01NP}{\texttt{Stacks tag 01NP}}
\group{constructions}

\uses{constructions-situation-relative-proj, constructions-lemma-proj-inclusion}
In Situation \ref{constructions-situation-relative-proj}.
Suppose $U \subset U' \subset U'' \subset S$ are affine opens.
Let $A = \mathcal{A}(U)$, $A' = \mathcal{A}(U')$ and $A'' = \mathcal{A}(U'')$.
The composition of the morphisms
...
Lemma \ref{constructions-lemma-proj-inclusion} gives the
morphism $r'' : \text{Proj}(A) \to \text{Proj}(A'')$
of Lemma \ref{constructions-lemma-proj-inclusion}. A similar statement
holds for the isomorphisms $\theta$.
\end{lemma}

\begin{proof}
\uses{constructions-lemma-morphism-proj-transitive}

This follows from Lemma \ref{constructions-lemma-morphism-proj-transitive} since
the map $A'' \to A$ is the composition of $A'' \to A'$ and
$A' \to A$.
\end{proof}

\begin{lemma}[Glue relative proj]
\label{constructions-lemma-glue-relative-proj}
\source{stacks:01NQ}
\href{https://stacks.math.columbia.edu/tag/01NQ}{\texttt{Stacks tag 01NQ}}
\group{constructions}
...
\item for $U \subset U' \subset S$ affine open the composition
$$
\begin{array}{ccccc}\text{Proj}(A) \overset{i_U^{-1}}{\longrightarrow} & \pi^{-1}(U) \overset{inclusion}{\longrightarrow} &  & \pi^{-1}(U') \overset{i_{U'}}{\longrightarrow} & \text{Proj}(A')\end{array}
$$
with $A = \mathcal{A}(U)$, $A' = \mathcal{A}(U')$
is the open immersion of Lemma \ref{constructions-lemma-proj-inclusion} above.
\end{enumerate}
\end{lemma}

\begin{proof}
\uses{constructions-lemma-relative-glueing, constructions-lemma-proj-inclusion, constructions-lemma-transitive-proj}

Follows immediately from
Lemmas \ref{constructions-lemma-relative-glueing},
\ref{constructions-lemma-proj-inclusion}, and
\ref{constructions-lemma-transitive-proj}.
\end{proof}

\begin{lemma}[Glue relative proj twists]
\label{constructions-lemma-glue-relative-proj-twists}
\source{stacks:01NR}
\href{https://stacks.math.columbia.edu/tag/01NR}{\texttt{Stacks tag 01NR}}
\group{constructions}

\uses{constructions-situation-relative-proj, constructions-lemma-glue-relative-proj}
In Situation \ref{constructions-situation-relative-proj}.
The morphism $\pi : \underline{\text{Proj}}_S(\mathcal{A}) \to S$
of Lemma \ref{constructions-lemma-glue-relative-proj} comes with the following
...
$$
\begin{array}{ccc}A_n
\underset{\psi}{\longrightarrow}\underset{(\ref{equation-global-sections})}{\searrow} &  & \Gamma(\pi^{-1}(U),
\mathcal{O}_{\underline{\text{Proj}}_S(\mathcal{A})}(n)) \\  & \Gamma(\text{Proj}(A),
...
\begin{proof}
\uses{constructions-lemma-relative-glueing-sheaves, constructions-lemma-proj-inclusion, constructions-lemma-transitive-proj, constructions-remark-relative-glueing-functorial, constructions-lemma-morphism-proj}

We are going to use Lemma \ref{constructions-lemma-relative-glueing-sheaves}
...
Lemma \ref{constructions-lemma-proj-inclusion} and we have checked condition (d) of
Lemma \ref{constructions-lemma-relative-glueing-sheaves} in
Lemma \ref{constructions-lemma-transitive-proj}. Hence we get the
...
of relative glueing, see Remark \ref{constructions-remark-relative-glueing-functorial}.
...
because the proof of Lemma \ref{constructions-lemma-morphism-proj} shows that
...
We place ourselves in Situation \ref{constructions-situation-relative-proj}.
...
discussion of the relative spectrum in Section \ref{constructions-section-spec}.
The easier method using glueing schemes of the form
$\text{Proj}(A)$, $A = \Gamma(U, \mathcal{A})$, $U \subset S$
affine open, is explained in Section \ref{constructions-section-relative-proj-via-glueing},
...
\begin{lemma}[Proj base change]
\label{constructions-lemma-proj-base-change}
\source{stacks:01NT}
\href{https://stacks.math.columbia.edu/tag/01NT}{\texttt{Stacks tag 01NT}}
\group{constructions}

\uses{constructions-situation-relative-proj}
In Situation \ref{constructions-situation-relative-proj}. Let $d \geq 1$.
...
\begin{lemma}[Relative proj affine]
\label{constructions-lemma-relative-proj-affine}
\source{stacks:01NU}
\href{https://stacks.math.columbia.edu/tag/01NU}{\texttt{Stacks tag 01NU}}
\group{constructions}

\uses{constructions-situation-relative-proj}
In Situation \ref{constructions-situation-relative-proj}. Let $F_d$ be the functor
...
\ref{constructions-section-morphisms-proj}.
...
\begin{lemma}[Relative proj d]
\label{constructions-lemma-relative-proj-d}
\source{stacks:01NV}
\href{https://stacks.math.columbia.edu/tag/01NV}{\texttt{Stacks tag 01NV}}
\group{constructions}
...
\begin{proof}
\uses{constructions-lemma-proj-base-change, constructions-lemma-relative-proj-affine}
...
$\mathcal{A}|_{U_i}$ by Lemma \ref{constructions-lemma-proj-base-change}.
Thus the result follows from Lemma \ref{constructions-lemma-relative-proj-affine}.
...
Section \ref{constructions-section-morphisms-proj} in the current
...
\begin{lemma}[Equivalent relative]
\label{constructions-lemma-equivalent-relative}
\source{stacks:01NW}
\href{https://stacks.math.columbia.edu/tag/01NW}{\texttt{Stacks tag 01NW}}
\group{constructions}
...
\begin{proof}
\uses{constructions-lemma-equivalent, constructions-lemma-relative-proj-affine}
...
from the corresponding result for triples (see Lemma \ref{constructions-lemma-equivalent})
and the fact that triples and quadruples correspond in the
affine base case (see proof of Lemma \ref{constructions-lemma-relative-proj-affine}).
\end{proof}
...
One of the implications of Lemma \ref{constructions-lemma-equivalent-relative} is that the
transformation $F_d \to F_{d'}$ is injective!
For a quasi-compact scheme $T$ we define
$$
F(T) = \bigcup\nolimits_{d \in \mathbf{N}} F_d(T)
...
\begin{lemma}[Relative proj]
\label{constructions-lemma-relative-proj}
\source{stacks:01NY}
\href{https://stacks.math.columbia.edu/tag/01NY}{\texttt{Stacks tag 01NY}}
\group{constructions}
...
\begin{proof}
\uses{constructions-lemma-relative-proj-affine}
...
subscheme of $\text{Proj}(A)$, see Lemma \ref{constructions-lemma-relative-proj-affine}.
...
\begin{lemma}[Glueing gives functor proj]
\label{constructions-lemma-glueing-gives-functor-proj}
\source{stacks:01NZ}
\href{https://stacks.math.columbia.edu/tag/01NZ}{\texttt{Stacks tag 01NZ}}
\group{constructions}

\uses{constructions-situation-relative-proj, constructions-lemma-glue-relative-proj}
In Situation \ref{constructions-situation-relative-proj}.
The scheme $\pi : \underline{\text{Proj}}_S(\mathcal{A}) \to S$
constructed in Lemma \ref{constructions-lemma-glue-relative-proj}
and the scheme representing the functor $F$
are canonically isomorphic as schemes over $S$.
\end{lemma}

\begin{proof}
\uses{constructions-lemma-relative-proj, constructions-lemma-glue-relative-proj-twists}
...
proof of Lemma \ref{constructions-lemma-relative-proj}.
...
Lemma \ref{constructions-lemma-glue-relative-proj-twists}
...
\begin{definition}[Relative proj]
\label{constructions-definition-relative-proj}
\source{stacks:01O0}
\href{https://stacks.math.columbia.edu/tag/01O0}{\texttt{Stacks tag 01O0}}
\group{constructions}

\uses{constructions-lemma-glue-relative-proj, constructions-lemma-glueing-gives-functor-proj}
Let $S$ be a scheme. Let $\mathcal{A}$ be a quasi-coherent sheaf of
...
constructed in Lemma \ref{constructions-lemma-glue-relative-proj} which represents the
functor $F$ (\ref{equation-proj}), see
Lemma \ref{constructions-lemma-glueing-gives-functor-proj}.
...
\right)
$$
see Lemma \ref{constructions-lemma-glue-relative-proj-twists}. We may also think of this
as a homomorphism
$$
\psi_{univ} :
\pi^*\mathcal{A}
...
\begin{lemma}[Tie up psi]
\label{constructions-lemma-tie-up-psi}
\source{stacks:01O1}
\href{https://stacks.math.columbia.edu/tag/01O1}{\texttt{Stacks tag 01O1}}
\group{constructions}
...
$$
\begin{array}{ccc}\mathcal{A}^{(d)} \underset{\psi}{\longrightarrow}\underset{\psi_{univ}}{\searrow} &  & f_*\left(
\bigoplus\nolimits_{n \in \mathbf{Z}}
\mathcal{L}^{\otimes n}
\right) \\  & \pi_*\left(
\bigoplus\nolimits_{n \geq 0}
...
\begin{proof}
\uses{constructions-lemma-relative-proj, constructions-lemma-proj-base-change, constructions-lemma-glue-relative-proj-twists, constructions-lemma-relative-proj-affine, constructions-lemma-proj-functor-strict}
...
of Lemma \ref{constructions-lemma-relative-proj}. Hence the result will follow
...
(see Lemma \ref{constructions-lemma-proj-base-change}), and (b) the pair
$(\bigoplus_{n \in \mathbf{Z}}
\mathcal{O}_{\underline{\text{Proj}}_S(\mathcal{A})}(n),
\psi_{univ})$
is constructed by glueing over affine opens in $S$
(see Lemma \ref{constructions-lemma-glue-relative-proj-twists}).
Hence we may assume that $S$ is affine. In this case the functor
of quadruples $F_d$ and the functor of triples $F_d$ agree
(see proof of Lemma \ref{constructions-lemma-relative-proj-affine}) and moreover
Lemma \ref{constructions-lemma-proj-functor-strict}
...
Lemma \ref{constructions-lemma-relative-proj-affine} shows that
$(U_d \to S, d, \mathcal{O}_{U_d}(d), \psi_{univ}|_{\mathcal{A}^{(d)}})$
is the universal quadruple as desired.
\end{proof}

\begin{lemma}[Relative proj separated]
\label{constructions-lemma-relative-proj-separated}
\source{stacks:01O2}
\href{https://stacks.math.columbia.edu/tag/01O2}{\texttt{Stacks tag 01O2}}
\group{constructions}
...
Lemma \ref{constructions-lemma-proj-separated} we see that $\text{Proj}(A)$ is separated.
Hence $\text{Proj}(A) \to U$ is separated (see
Schemes, Lemma \ref{schemes-lemma-compose-after-separated}) as desired.
\end{proof}

\begin{lemma}[Relative proj base change]
\label{constructions-lemma-relative-proj-base-change}
\source{stacks:01O3}
\href{https://stacks.math.columbia.edu/tag/01O3}{\texttt{Stacks tag 01O3}}
\group{constructions}
...
\begin{proof}
\uses{constructions-lemma-proj-base-change, constructions-lemma-relative-proj, constructions-lemma-base-change-map-proj}

This follows from Lemma \ref{constructions-lemma-proj-base-change} and the construction
of $\underline{\text{Proj}}_S(\mathcal{A})$ in
Lemma \ref{constructions-lemma-relative-proj} as the union
...
in Lemma \ref{constructions-lemma-base-change-map-proj} which provides us with
the isomorphism $\theta$. Some details omitted.
\end{proof}

\begin{lemma}[Apply relative]
\label{constructions-lemma-apply-relative}
\source{stacks:01O4}
\href{https://stacks.math.columbia.edu/tag/01O4}{\texttt{Stacks tag 01O4}}
\group{constructions}
...
\begin{proof}
\uses{constructions-lemma-relative-proj, constructions-lemma-apply}

Under the assumptions of the lemma the sheaves
$\mathcal{O}_{\underline{\text{Proj}}(\mathcal{A})}(n)$
are invertible and the multiplication maps isomorphisms
by Lemma \ref{constructions-lemma-relative-proj} and
Lemma \ref{constructions-lemma-apply}
over affine opens of $S$. Thus $X$ actually represents the
functor $F_1$, see proof of Lemma \ref{constructions-lemma-relative-proj}.
\end{proof}
...
be a quadruple over $T$, as in Section \ref{constructions-section-relative-proj}.
...
of pure tensors $\sum m_i \otimes \gamma(a)^{-n_i}$ with $m_i \in M_{n_id}$.
...
\begin{lemma}[Relative proj modules]
\label{constructions-lemma-relative-proj-modules}
\source{stacks:01O7}
\href{https://stacks.math.columbia.edu/tag/01O7}{\texttt{Stacks tag 01O7}}
\group{constructions}

\uses{constructions-situation-relative-proj, constructions-lemma-widetilde-tensor}
In Situation \ref{constructions-situation-relative-proj}.
...
$$
as in
Lemma \ref{constructions-lemma-widetilde-tensor}.
...
This section is the analogue of Section \ref{constructions-section-functoriality-proj}
...
\begin{lemma}[Morphism relative proj]
\label{constructions-lemma-morphism-relative-proj}
\source{stacks:07ZG}
\href{https://stacks.math.columbia.edu/tag/07ZG}{\texttt{Stacks tag 07ZG}}
\group{constructions}
...
Lemma \ref{constructions-lemma-morphism-proj} via the identifications
...
\begin{lemma}[Morphism relative proj transitive]
\label{constructions-lemma-morphism-relative-proj-transitive}
\source{stacks:07ZH}
\href{https://stacks.math.columbia.edu/tag/07ZH}{\texttt{Stacks tag 07ZH}}
\group{constructions}
...
\begin{lemma}[Surjective graded rings map relative proj]
\label{constructions-lemma-surjective-graded-rings-map-relative-proj}
\source{stacks:07ZI}
\href{https://stacks.math.columbia.edu/tag/07ZI}{\texttt{Stacks tag 07ZI}}
\group{constructions}

\uses{constructions-lemma-morphism-relative-proj}
With hypotheses and notation as in Lemma \ref{constructions-lemma-morphism-relative-proj}
...
\begin{proof}
\uses{constructions-lemma-morphism-relative-proj, constructions-lemma-surjective-graded-rings-map-proj}

Follows on combining
Lemma \ref{constructions-lemma-morphism-relative-proj}
with
Lemma \ref{constructions-lemma-surjective-graded-rings-map-proj}.
\end{proof}

\begin{lemma}[Eventual iso graded rings map relative proj]
\label{constructions-lemma-eventual-iso-graded-rings-map-relative-proj}
\source{stacks:07ZJ}
\href{https://stacks.math.columbia.edu/tag/07ZJ}{\texttt{Stacks tag 07ZJ}}
\group{constructions}
...
\begin{proof}
\uses{constructions-lemma-morphism-relative-proj, constructions-lemma-eventual-iso-graded-rings-map-proj}

Follows on combining
Lemma \ref{constructions-lemma-morphism-relative-proj}
with
Lemma \ref{constructions-lemma-eventual-iso-graded-rings-map-proj}.
\end{proof}

\begin{lemma}[Surjective generated degree 1 map relative proj]
\label{constructions-lemma-surjective-generated-degree-1-map-relative-proj}
\source{stacks:07ZK}
\href{https://stacks.math.columbia.edu/tag/07ZK}{\texttt{Stacks tag 07ZK}}
\group{constructions}
...
\begin{proof}
\uses{constructions-lemma-morphism-relative-proj, constructions-lemma-surjective-graded-rings-generated-degree-1-map-proj}

Follows on combining
Lemma \ref{constructions-lemma-morphism-relative-proj}
with
Lemma \ref{constructions-lemma-surjective-graded-rings-generated-degree-1-map-proj}.
\end{proof}
...
\begin{lemma}[Invertible map into relative proj]
\label{constructions-lemma-invertible-map-into-relative-proj}
\source{stacks:01O9}
\href{https://stacks.math.columbia.edu/tag/01O9}{\texttt{Stacks tag 01O9}}
\group{constructions}

\uses{constructions-definition-relative-proj, constructions-lemma-glue-relative-proj, constructions-lemma-invertible-map-into-proj}
...
$$
\begin{array}{cc}\mathcal{A}_d(V) \underset{\psi}{\downarrow}\underset{\psi}{\longrightarrow} & \Gamma(f^{-1}(V), \mathcal{L}^{\otimes d}) \overset{restrict}{\downarrow} \\ \Gamma(\pi^{-1}(V),
\mathcal{O}_{\underline{\text{Proj}}_S(\mathcal{A})}(d)) \overset{\theta}{\longrightarrow} & \Gamma(f^{-1}(V) \cap U(\psi), \mathcal{L}^{\otimes d})\end{array}
$$
is commutative.
...
see Definition \ref{constructions-definition-relative-proj}.
...
$$
agrees via $i_V$ (see Lemma \ref{constructions-lemma-glue-relative-proj}) with the triple
$(U(\psi'), r_{\mathcal{L}, \psi'}, \theta')$
of Lemma \ref{constructions-lemma-invertible-map-into-proj} associated to the map
...
\begin{proof}
\uses{constructions-lemma-invertible-map-into-proj}
...
\begin{lemma}[Twisting and proj]
\label{constructions-lemma-twisting-and-proj}
\source{stacks:02NC}
\href{https://stacks.math.columbia.edu/tag/02NC}{\texttt{Stacks tag 02NC}}
\group{constructions}

With notation $S$, $\mathcal{A}$, $\mathcal{L}$ and $\mathcal{B}$ as
above. There is a canonical isomorphism
$$
\begin{array}{ccc}P = \underline{\text{Proj}}_S(\mathcal{A})
\underset{g}{\longrightarrow}\underset{\pi}{\searrow} &  & \underline{\text{Proj}}_S(\mathcal{B}) = P'
\overset{\pi'}{\swarrow} \\  & S & \end{array}
$$
with the following properties
\begin{enumerate}
...
$$
\begin{array}{cc}\mathcal{A}_n(V) \otimes \mathcal{L}^{\otimes n}(V)
\underset{multiply}{\longrightarrow}\overset{\psi \otimes \pi^*}{\downarrow} & \mathcal{B}_n(V) \overset{\psi}{\downarrow} \\ \Gamma(\pi^{-1}V, \mathcal{O}_P(n)) \otimes
\Gamma(\pi^{-1}V, \pi^*\mathcal{L}^{\otimes n})
\overset{multiply}{\downarrow} &  \\ \Gamma(\pi^{-1}V, \mathcal{O}_P(n) \otimes \pi^*\mathcal{L}^{\otimes n}) & \Gamma(\pi'^{-1}V, \mathcal{O}_{P'}(n)) \underset{\theta_n}{\longleftarrow}\end{array}
$$
are commutative.
...
\ref{constructions-lemma-relative-proj} and \ref{constructions-lemma-apply-relative}.

\begin{definition}[Projective bundle]
\label{constructions-definition-projective-bundle}
\source{stacks:01OB}
\href{https://stacks.math.columbia.edu/tag/01OB}{\texttt{Stacks tag 01OB}}
\group{constructions}

\uses{constructions-lemma-apply-relative}
Let $S$ be a scheme. Let $\mathcal{E}$ be a quasi-coherent
$\mathcal{O}_S$-module\footnote{The reader may expect here
the condition that $\mathcal{E}$ is finite locally free. We do not
...
of Lemma \ref{constructions-lemma-apply-relative} and is called the $n$th
{\it twist of the structure sheaf}.
\end{definition}

According to Lemma \ref{constructions-lemma-glue-relative-proj-twists} there are
...
is a surjection by Lemma \ref{constructions-lemma-apply-relative}.
...
Definition \ref{constructions-definition-projective-bundle}. Let $f : T \to S$
...
the functor $F$ in Section \ref{constructions-section-relative-proj}. On the other hand,
...
By Lemma \ref{constructions-lemma-apply-relative} these constructions
...
\source{stacks:0FCY}
\href{https://stacks.math.columbia.edu/tag/0FCY}{\texttt{Stacks tag 0FCY}}
\group{constructions}
...
\Gamma(X, \mathcal{L})
$$
See Lemma \ref{constructions-lemma-invertible-map-into-proj}. If
...
then the diagram
$$
\begin{array}{ccc}X \downarrow\underset{\varphi_{\mathcal{L}, \psi}}{\longrightarrow} &  & \mathbf{P}(V) \overset{\cong}{\downarrow} \\ X \overset{\varphi_{(\mathcal{L}, (s_0, \ldots, s_n))}}{\longrightarrow} &  & \mathbf{P}^n_k\end{array}
$$
is commutative, where $s_i = \psi(v_i) \in \Gamma(X, \mathcal{L})$, where
$\varphi_{(\mathcal{L}, (s_0, \ldots, s_n))}$
is as in Section \ref{constructions-section-projective-space},
and where the right vertical arrow corresponds
to the isomorphism $k[T_0, \ldots, T_n] \to \text{Sym}(V)$ sending
$T_i$ to $v_i$.
\end{example}

\begin{example}[Projective bundle]
\label{constructions-example-projective-bundle}
\source{stacks:01OC}
\href{https://stacks.math.columbia.edu/tag/01OC}{\texttt{Stacks tag 01OC}}
\group{constructions}
...
\begin{lemma}[Projective bundle separated]
\label{constructions-lemma-projective-bundle-separated}
\source{stacks:01OD}
\href{https://stacks.math.columbia.edu/tag/01OD}{\texttt{Stacks tag 01OD}}
\group{constructions}
...
\begin{proof}
\uses{constructions-lemma-relative-proj-separated}

Immediate from Lemma \ref{constructions-lemma-relative-proj-separated}.
\end{proof}

\begin{lemma}[Projective space bundle]
\label{constructions-lemma-projective-space-bundle}
\source{stacks:01OE}
\href{https://stacks.math.columbia.edu/tag/01OE}{\texttt{Stacks tag 01OE}}
\group{constructions}
...
\begin{proof}
\uses{constructions-lemma-relative-proj-base-change}
...
see Lemma \ref{constructions-lemma-relative-proj-base-change}.
...
\begin{lemma}[Gkn representable]
\label{constructions-lemma-gkn-representable}
\source{stacks:089T}
\href{https://stacks.math.columbia.edu/tag/089T}{\texttt{Stacks tag 089T}}
\group{constructions}
...
\source{stacks:089U}
\href{https://stacks.math.columbia.edu/tag/089U}{\texttt{Stacks tag 089U}}
\group{constructions}
...
Lemma \ref{constructions-lemma-gkn-representable}
that these functors are indeed representable.

\begin{lemma}[Projective space grassmannian]
\label{constructions-lemma-projective-space-grassmannian}
\source{stacks:089V}
\href{https://stacks.math.columbia.edu/tag/089V}{\texttt{Stacks tag 089V}}
\group{constructions}
...
According to Lemma \ref{constructions-lemma-projective-space} the scheme
