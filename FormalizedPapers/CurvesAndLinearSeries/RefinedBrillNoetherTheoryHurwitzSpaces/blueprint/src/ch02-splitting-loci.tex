...
\begin{equation} \label{u}\dcref{2.1}
\source{refined-brill-noether-theory-hurwitz-spaces}
...
We now realize the Brill-Noether splitting loci as splitting loci of a vector
bundle on $\pp^1 \times \Pic^d(C)$. Let $f\colon C \to \pp^1$ be a degree
$k$ cover, let $\nu:C\times\Pic^d(C)\to\Pic^d(C)$ and
$\pi:\pp^1\times\Pic^d(C)\to\Pic^d(C)$ be projections, and write
$f\times\mathrm{id}$ for the induced map between products.
...
\begin{equation} \label{weq}\dcref{2.2}
\source{refined-brill-noether-theory-hurwitz-spaces}
...
\begin{Example}
The balanced-plus-balanced splitting types of rank $5$ and degree $-4$ with at least
$4$ global sections are
\[
\begin{array}{c|cccc}
\ell & 0 & 1 & 2 & 3\\
\vec{w}_{3,\ell} & (-4,0,0,0,0) & (-3,-2,0,0,1) &
(-2,-2,-2,1,1) & (-2,-2,-2,-1,3)\\
u(\vec{w}_{3,\ell}) & 12 & 11 & 12 & 15
\end{array}
\]
and the first three are maximal.
