...
\source{stacks:03BS}
\href{https://stacks.math.columbia.edu/tag/03BS}{\texttt{Stacks tag 03BS}}
...
\source{stacks:03DY}
\href{https://stacks.math.columbia.edu/tag/03DY}{\texttt{Stacks tag 03DY}}
\group{spaces-properties}

Let $S$ be a scheme.
Let $X$ be an algebraic space over $S$.
We have the following implications among the separation axioms
of Definition \ref{spaces-properties-definition-separated}:
\begin{enumerate}
...
\source{stacks:0AHR}
\href{https://stacks.math.columbia.edu/tag/0AHR}{\texttt{Stacks tag 0AHR}}
\group{spaces-properties}
...
\source{stacks:0AHS}
\href{https://stacks.math.columbia.edu/tag/0AHS}{\texttt{Stacks tag 0AHS}}
\group{spaces-properties}
...
$$
\begin{array}{cc}\Spec(\Omega) \longrightarrow\downarrow & \Spec(L) \overset{q}{\downarrow} \\ \Spec(K) \overset{p}{\longrightarrow} & F.\end{array}
$$
...
\source{stacks:03BU}
\href{https://stacks.math.columbia.edu/tag/03BU}{\texttt{Stacks tag 03BU}}
\group{spaces-properties}
...
\begin{lemma}[Scheme points]
\label{spaces-properties-lemma-scheme-points}
\source{stacks:03BV}
\href{https://stacks.math.columbia.edu/tag/03BV}{\texttt{Stacks tag 03BV}}
\group{spaces-properties}
...
\source{stacks:03H4}
\href{https://stacks.math.columbia.edu/tag/03H4}{\texttt{Stacks tag 03H4}}
\group{spaces-properties}

Let $S$ be a scheme. Let
$$
\begin{array}{cc}Z \times_Y X \longrightarrow\downarrow & X \downarrow \\ Z \longrightarrow & Y\end{array}
$$
...
\source{stacks:03H5}
\href{https://stacks.math.columbia.edu/tag/03H5}{\texttt{Stacks tag 03H5}}
\group{spaces-properties}
...
$$
\begin{array}{ccc}\Spec(K') \longrightarrow\downarrow & \Spec(K) \times_X T \downarrow\longrightarrow & T \downarrow \\ \Spec(K) \xlongequal{} & \Spec(K) \overset{x}{\longrightarrow} & X\end{array}
$$
...
\source{stacks:03BW}
\href{https://stacks.math.columbia.edu/tag/03BW}{\texttt{Stacks tag 03BW}}
\group{spaces-properties}
...
\source{stacks:03BX}
\href{https://stacks.math.columbia.edu/tag/03BX}{\texttt{Stacks tag 03BX}}
\group{spaces-properties}
...
(via the identification of Lemma \ref{spaces-properties-lemma-scheme-points}),
...
$$
\begin{array}{cc}U'' \longrightarrow\downarrow & U' \downarrow \\ U \longrightarrow & X\end{array}
$$
...
\source{stacks:03BY}
\href{https://stacks.math.columbia.edu/tag/03BY}{\texttt{Stacks tag 03BY}}
\group{spaces-properties}
...
\begin{lemma}[Open subspaces]
\label{spaces-properties-lemma-open-subspaces}
\source{stacks:03BZ}
\href{https://stacks.math.columbia.edu/tag/03BZ}{\texttt{Stacks tag 03BZ}}
\group{spaces-properties}
...
$U = \bigcup U \times_X X_i$ by Lemma \ref{spaces-properties-lemma-points-presentation}
(and the fact that the projections $U \times_X X_i \to X_i$ are surjective
and \'etale). Thus the equivalence of (2) follows.
\end{proof}

\begin{lemma}[Factor through open subspace]
\label{spaces-properties-lemma-factor-through-open-subspace}
\source{stacks:03IE}
\href{https://stacks.math.columbia.edu/tag/03IE}{\texttt{Stacks tag 03IE}}
\group{spaces-properties}
...
\begin{lemma}[Etale image open]
\label{spaces-properties-lemma-etale-image-open}
\source{stacks:06NF}
\href{https://stacks.math.columbia.edu/tag/06NF}{\texttt{Stacks tag 06NF}}
\group{spaces-properties}
...
\begin{lemma}[Equivalence class point monomorphism]
\label{spaces-properties-lemma-equivalence-class-point-monomorphism}
\source{stacks:0H2X}
\href{https://stacks.math.columbia.edu/tag/0H2X}{\texttt{Stacks tag 0H2X}}
\group{spaces-properties}
...
\begin{lemma}[Points monomorphism]
\label{spaces-properties-lemma-points-monomorphism}
\source{stacks:03E1}
\href{https://stacks.math.columbia.edu/tag/03E1}{\texttt{Stacks tag 03E1}}
\group{spaces-properties}
...
\begin{proof}
This follows from Lemma \ref{spaces-properties-lemma-equivalence-class-point-monomorphism}.
\end{proof}

We will see in Decent Spaces,
Lemma \ref{decent-spaces-lemma-decent-points-monomorphism}
that the map of Lemma \ref{spaces-properties-lemma-points-monomorphism}
...
\source{stacks:03E3}
\href{https://stacks.math.columbia.edu/tag/03E3}{\texttt{Stacks tag 03E3}}
\group{spaces-properties}

Let $S$ be a scheme.
Let $X$ be an algebraic space over $S$.
We say $X$ is {\it quasi-compact} if there exists a surjective
\'etale morphism $U \to X$ where $U$ is a quasi-compact scheme.
\end{definition}

\begin{lemma}[Quasi compact space]
\label{spaces-properties-lemma-quasi-compact-space}
\source{stacks:03E4}
\href{https://stacks.math.columbia.edu/tag/03E4}{\texttt{Stacks tag 03E4}}
\group{spaces-properties}
...
We will use Lemma \ref{spaces-properties-lemma-characterize-surjective}.
...
\source{stacks:040T}
\href{https://stacks.math.columbia.edu/tag/040T}{\texttt{Stacks tag 040T}}
\group{spaces-properties}
...
\begin{example}[Quasi compact not very reasonable]
\label{spaces-properties-example-quasi-compact-not-very-reasonable}
\source{stacks:03IO}
\href{https://stacks.math.columbia.edu/tag/03IO}{\texttt{Stacks tag 03IO}}
\group{spaces-properties}
...
\source{stacks:04NN}
\href{https://stacks.math.columbia.edu/tag/04NN}{\texttt{Stacks tag 04NN}}
\group{spaces-properties}
...
\begin{lemma}[Cover by union affines]
\label{spaces-properties-lemma-cover-by-union-affines}
\source{stacks:03FX}
\href{https://stacks.math.columbia.edu/tag/03FX}{\texttt{Stacks tag 03FX}}
\group{spaces-properties}
...
\begin{lemma}[Union of quasi compact]
\label{spaces-properties-lemma-union-of-quasi-compact}
\source{stacks:03FY}
\href{https://stacks.math.columbia.edu/tag/03FY}{\texttt{Stacks tag 03FY}}
\group{spaces-properties}
...
\begin{proof}
By Lemma \ref{spaces-properties-lemma-cover-by-union-affines} we can find a surjective
...
\begin{lemma}[Quasi compact affine cover]
\label{spaces-properties-lemma-quasi-compact-affine-cover}
\source{stacks:03H6}
\href{https://stacks.math.columbia.edu/tag/03H6}{\texttt{Stacks tag 03H6}}
\group{spaces-properties}
...
affine then $X$ is quasi-compact by Definition \ref{spaces-properties-definition-quasi-compact}.
...
\begin{lemma}[Separated cover]
\label{spaces-properties-lemma-separated-cover}
\source{stacks:03FZ}
\href{https://stacks.math.columbia.edu/tag/03FZ}{\texttt{Stacks tag 03FZ}}
\group{spaces-properties}
...
$$
\begin{array}{cc}R = U \times_X U \longrightarrow\downarrow & U \downarrow \\ U \longrightarrow & X\end{array}
$$
In the proof of
...
\begin{lemma}[Quasi separated]
\label{spaces-properties-lemma-quasi-separated}
\source{stacks:07S4}
\href{https://stacks.math.columbia.edu/tag/07S4}{\texttt{Stacks tag 07S4}}
\group{spaces-properties}
...
$$
\begin{array}{cc}U \times_X U \longrightarrow\underset{j}{\downarrow} & X \overset{\Delta}{\downarrow} \\ U \times U \longrightarrow & X \times X\end{array}
$$
...
\begin{lemma}[Quasi separated quasi compact pieces]
\label{spaces-properties-lemma-quasi-separated-quasi-compact-pieces}
\source{stacks:03W7}
\href{https://stacks.math.columbia.edu/tag/03W7}{\texttt{Stacks tag 03W7}}
\group{spaces-properties}
...
$$
\begin{array}{cc}U \times_X U \longrightarrow\downarrow & U \times_S U \downarrow \\ X \overset{\Delta_{X/S}}{\longrightarrow} & X \times_S X\end{array}
$$
...
\begin{lemma}[Finite fibres presentation]
\label{spaces-properties-lemma-finite-fibres-presentation}
\source{stacks:03IJ}
\href{https://stacks.math.columbia.edu/tag/03IJ}{\texttt{Stacks tag 03IJ}}
\group{spaces-properties}
...
\source{stacks:03E8}
\href{https://stacks.math.columbia.edu/tag/03E8}{\texttt{Stacks tag 03E8}}
\group{spaces-properties}
...
\source{stacks:03E6}
\href{https://stacks.math.columbia.edu/tag/03E6}{\texttt{Stacks tag 03E6}}
\group{spaces-properties}
...
Lemma \ref{spaces-properties-lemma-type-property}
hold.
\end{definition}

\begin{remark}[List properties local etale topology]
\label{spaces-properties-remark-list-properties-local-etale-topology}
\source{stacks:03E7}
\href{https://stacks.math.columbia.edu/tag/03E7}{\texttt{Stacks tag 03E7}}
\group{spaces-properties}
...
\source{stacks:04N2}
\href{https://stacks.math.columbia.edu/tag/04N2}{\texttt{Stacks tag 04N2}}
\group{spaces-properties}
...
\source{stacks:04RC}
\href{https://stacks.math.columbia.edu/tag/04RC}{\texttt{Stacks tag 04RC}}
\group{spaces-properties}
...
\begin{remark}[List properties local ring local etale topology]
\label{spaces-properties-remark-list-properties-local-ring-local-etale-topology}
\source{stacks:0BBL}
\href{https://stacks.math.columbia.edu/tag/0BBL}{\texttt{Stacks tag 0BBL}}
\group{spaces-properties}
...
\source{stacks:0ECT}
\href{https://stacks.math.columbia.edu/tag/0ECT}{\texttt{Stacks tag 0ECT}}
\group{spaces-properties}
...
as $\varphi$ is surjective, see Lemma \ref{spaces-properties-lemma-points-cartesian}.
...
\begin{definition}[Locally constructible]
\label{spaces-properties-definition-locally-constructible}
\source{stacks:0ECU}
\href{https://stacks.math.columbia.edu/tag/0ECU}{\texttt{Stacks tag 0ECU}}
\group{spaces-properties}

Let $S$ be a scheme. Let $X$ be an algebraic space over $S$.
Let $E \subset |X|$ be a subset. We say $E$ is
{\it \'etale locally constructible} if the equivalent
conditions of Lemma \ref{spaces-properties-lemma-locally-constructible} are satisfied.
\end{definition}
...
\source{stacks:04N5}
\href{https://stacks.math.columbia.edu/tag/04N5}{\texttt{Stacks tag 04N5}}
\group{spaces-properties}
...
Lemma \ref{spaces-properties-lemma-local-source-target-at-point}, and
Descent, Lemma \ref{descent-lemma-dimension-at-point-local}.
\end{definition}
...
\source{stacks:04N6}
\href{https://stacks.math.columbia.edu/tag/04N6}{\texttt{Stacks tag 04N6}}
\group{spaces-properties}
...
\begin{lemma}[Pre dimension local ring]
\label{spaces-properties-lemma-pre-dimension-local-ring}
\source{stacks:0BAM}
\href{https://stacks.math.columbia.edu/tag/0BAM}{\texttt{Stacks tag 0BAM}}
\group{spaces-properties}
...
\begin{definition}[Dimension local ring]
\label{spaces-properties-definition-dimension-local-ring}
\source{stacks:04NA}
\href{https://stacks.math.columbia.edu/tag/04NA}{\texttt{Stacks tag 04NA}}
\group{spaces-properties}
...
conditions of Lemma \ref{spaces-properties-lemma-pre-dimension-local-ring}. In this case we
will also say {\it $x$ is a point of codimension $d$ on $X$}.
\end{definition}

Besides the lemma below we also point the reader to
Lemmas \ref{spaces-properties-lemma-dimension-local-ring} and
...
\source{stacks:0BAN}
\href{https://stacks.math.columbia.edu/tag/0BAN}{\texttt{Stacks tag 0BAN}}
\group{spaces-properties}
...
\begin{proof}
The numbers in (1) and (3) are equal by Definition \ref{spaces-properties-definition-dimension}.
...
the set of points of codimension $0$ (Lemma \ref{spaces-properties-lemma-codimension-0-points}).
...
\begin{lemma}[Codimension 0 points]
\label{spaces-properties-lemma-codimension-0-points}
\source{stacks:0BAQ}
\href{https://stacks.math.columbia.edu/tag/0BAQ}{\texttt{Stacks tag 0BAQ}}
\group{spaces-properties}
...
point on $X$ (Definition \ref{spaces-properties-definition-dimension-local-ring}).
\end{proof}

\begin{lemma}[Codimension 0 points dense]
\label{spaces-properties-lemma-codimension-0-points-dense}
\source{stacks:0BAR}
\href{https://stacks.math.columbia.edu/tag/0BAR}{\texttt{Stacks tag 0BAR}}
\group{spaces-properties}
...
$|U|$ (Lemma \ref{spaces-properties-lemma-codimension-0-points}). Since $|X|$ has the
...
\source{stacks:0ABJ}
\href{https://stacks.math.columbia.edu/tag/0ABJ}{\texttt{Stacks tag 0ABJ}}
\group{spaces-properties}
...
of $|U|$. By Lemma \ref{spaces-properties-lemma-points-cartesian} the subset
...
\begin{lemma}[Subspaces presentation]
\label{spaces-properties-lemma-subspaces-presentation}
\source{stacks:07TW}
\href{https://stacks.math.columbia.edu/tag/07TW}{\texttt{Stacks tag 07TW}}
\group{spaces-properties}
...
\begin{lemma}[Reduced closed subspace]
\label{spaces-properties-lemma-reduced-closed-subspace}
\source{stacks:03IQ}
\href{https://stacks.math.columbia.edu/tag/03IQ}{\texttt{Stacks tag 03IQ}}
\group{spaces-properties}
...
By Lemma \ref{spaces-properties-lemma-points-presentation}
...
Thus we can apply Lemma \ref{spaces-properties-lemma-subspaces-presentation}
...
\source{stacks:03JJ}
\href{https://stacks.math.columbia.edu/tag/03JJ}{\texttt{Stacks tag 03JJ}}
\group{spaces-properties}
...
$$
\begin{array}{cc}V \underset{b}{\downarrow}\underset{h}{\longrightarrow} & U \overset{a}{\downarrow} \\ Y \overset{f}{\longrightarrow} & X\end{array}
$$
...
\begin{definition}[Reduced induced space]
\label{spaces-properties-definition-reduced-induced-space}
\source{stacks:047X}
\href{https://stacks.math.columbia.edu/tag/047X}{\texttt{Stacks tag 047X}}
\group{spaces-properties}
...
\begin{lemma}[Subscheme]
\label{spaces-properties-lemma-subscheme}
\source{stacks:03JH}
\href{https://stacks.math.columbia.edu/tag/03JH}{\texttt{Stacks tag 03JH}}
\group{spaces-properties}
...
\begin{lemma}[Quasi separated finite etale cover dense open scheme]
\label{spaces-properties-lemma-quasi-separated-finite-etale-cover-dense-open-scheme}
\source{stacks:0BAS}
\href{https://stacks.math.columbia.edu/tag/0BAS}{\texttt{Stacks tag 0BAS}}
\group{spaces-properties}
...
By Lemma \ref{spaces-properties-lemma-codimension-0-points-dense}
...
By Lemma \ref{spaces-properties-lemma-finite-fibres-presentation}
the fibre of $|U| \to |X|$ over $x$ is finite, say
$\{\eta_1, \ldots, \eta_n\}$. By Lemma \ref{spaces-properties-lemma-codimension-0-points}
...
\begin{proposition}[Locally quasi separated open dense scheme]
\label{spaces-properties-proposition-locally-quasi-separated-open-dense-scheme}
\source{stacks:06NH}
\href{https://stacks.math.columbia.edu/tag/06NH}{\texttt{Stacks tag 06NH}}
\group{spaces-properties}
...
\begin{proof}
The question is local on $X$ by Lemma \ref{spaces-properties-lemma-subscheme}.
Thus by Lemma \ref{spaces-properties-lemma-quasi-separated-quasi-compact-pieces}
we may assume that there exists an affine scheme $U$ and a
surjective, quasi-compact, \'etale morphism $U \to X$.
Moreover $U \to X$ is separated (Lemma \ref{spaces-properties-lemma-separated-cover}).
...
This reduces us to
Lemma \ref{spaces-properties-lemma-quasi-separated-finite-etale-cover-dense-open-scheme}.
\end{proof}
...
\begin{proposition}[Finite flat equivalence global]
\label{spaces-properties-proposition-finite-flat-equivalence-global}
\source{stacks:07S6}
\href{https://stacks.math.columbia.edu/tag/07S6}{\texttt{Stacks tag 07S6}}
\group{spaces-properties}
...
\begin{lemma}[Quotient scheme]
\label{spaces-properties-lemma-quotient-scheme}
\source{stacks:07S7}
\href{https://stacks.math.columbia.edu/tag/07S7}{\texttt{Stacks tag 07S7}}
\group{spaces-properties}
...
Proposition \ref{spaces-properties-proposition-finite-flat-equivalence-global} holds.
...
\begin{lemma}[Quotient separated]
\label{spaces-properties-lemma-quotient-separated}
\source{stacks:0BBM}
\href{https://stacks.math.columbia.edu/tag/0BBM}{\texttt{Stacks tag 0BBM}}
\group{spaces-properties}

Notation and assumptions as in
Proposition \ref{spaces-properties-proposition-finite-flat-equivalence-global}. Then
\begin{enumerate}
...
\item add more here.
\end{enumerate}
Similar results hold in the setting of Lemma \ref{spaces-properties-lemma-quotient-scheme}.
\end{lemma}

\begin{proof}
Since $M$ represents the quotient sheaf we have a cartesian diagram
$$
\begin{array}{cc}R \underset{j}{\longrightarrow}\downarrow & U \times_S U \downarrow \\ M \longrightarrow & M \times_S M\end{array}
$$
...
$\Spec(\mathbf{Z})$, see Definition \ref{spaces-properties-definition-separated}.
Since Lemma \ref{spaces-properties-lemma-quotient-scheme} is proved through an application of
Proposition \ref{spaces-properties-proposition-finite-flat-equivalence-global}
...
\begin{lemma}[Quasi separated sober]
\label{spaces-properties-lemma-quasi-separated-sober}
\source{stacks:06NJ}
\href{https://stacks.math.columbia.edu/tag/06NJ}{\texttt{Stacks tag 06NJ}}
\group{spaces-properties}
...
Lemma \ref{spaces-properties-lemma-points-presentation} (points on an algebraic space in
terms of a presentation), and
Lemma \ref{spaces-properties-lemma-topology-points} (openness quotient map).}.
...
\source{stacks:0A4G}
\href{https://stacks.math.columbia.edu/tag/0A4G}{\texttt{Stacks tag 0A4G}}
\group{spaces-properties}
...
Lemma \ref{spaces-properties-lemma-quasi-separated-sober} we see that $|X|$ is sober.
By Lemma \ref{spaces-properties-lemma-quasi-compact-space} we see that $|X|$ is quasi-compact.
By Lemma \ref{spaces-properties-lemma-quasi-compact-affine-cover} there exists an affine scheme
...
for some open subspaces $X', X'' \subset X$ (Lemma \ref{spaces-properties-lemma-open-subspaces})
...
$|V \times_X W| \to |X|$ (Lemma \ref{spaces-properties-lemma-points-cartesian}).
...
\begin{lemma}[Point like spaces]
\label{spaces-properties-lemma-point-like-spaces}
\source{stacks:03DZ}
\href{https://stacks.math.columbia.edu/tag/03DZ}{\texttt{Stacks tag 03DZ}}
\group{spaces-properties}
...
$$
\begin{array}{cc}R \underset{s}{\longrightarrow}\underset{t}{\downarrow} & \Spec(k) \downarrow \\ \Spec(k) \longrightarrow & X\end{array}
$$
By
Spaces, Lemma \ref{spaces-lemma-space-presentation}
...
\begin{remark}[Cannot decide yet]
\label{spaces-properties-remark-cannot-decide-yet}
\source{stacks:03E0}
\href{https://stacks.math.columbia.edu/tag/03E0}{\texttt{Stacks tag 03E0}}
\group{spaces-properties}

Lemma \ref{spaces-properties-lemma-point-like-spaces} holds for decent algebraic spaces, see
...
\begin{lemma}[Etale over space]
\label{spaces-properties-lemma-etale-over-space}
\source{stacks:03EC}
\href{https://stacks.math.columbia.edu/tag/03EC}{\texttt{Stacks tag 03EC}}
\group{spaces-properties}
...
$$
\begin{array}{cc}W \times_X U \longrightarrow\downarrow & W \times_X U' \downarrow \\ U \longrightarrow & U'\end{array}
$$
...
$$
\begin{array}{ccc}W \times_X U \longrightarrow\downarrow & W \times_X U' \downarrow\longrightarrow & W \downarrow \\ U \longrightarrow & U' \longrightarrow & X\end{array}
$$
...
\source{stacks:03FR}
\href{https://stacks.math.columbia.edu/tag/03FR}{\texttt{Stacks tag 03FR}}
\group{spaces-properties}
...
Spaces, Definition \ref{spaces-definition-relative-representable-property}.
This follows by combining Lemma \ref{spaces-properties-lemma-etale-local} below and
Spaces, Lemma \ref{spaces-lemma-representable-morphisms-spaces-property}.

\begin{lemma}[Etale local]
\label{spaces-properties-lemma-etale-local}
\source{stacks:03FS}
\href{https://stacks.math.columbia.edu/tag/03FS}{\texttt{Stacks tag 03FS}}
\group{spaces-properties}
...
Lemma \ref{spaces-properties-lemma-etale-over-space} (1). Since also
the projection $W \times_X U \to W$ is surjective and \'etale, we conclude
from Lemma \ref{spaces-properties-lemma-etale-over-space} (3) that $W \to Y$ is \'etale.
...
and hence $U \to V$ is \'etale by Lemma \ref{spaces-properties-lemma-etale-over-space} (2).
...
\source{stacks:03FT}
\href{https://stacks.math.columbia.edu/tag/03FT}{\texttt{Stacks tag 03FT}}
\group{spaces-properties}
...
\source{stacks:03FU}
\href{https://stacks.math.columbia.edu/tag/03FU}{\texttt{Stacks tag 03FU}}
\group{spaces-properties}
...
$$
\begin{array}{cc}W \times_Y U \downarrow\longrightarrow & W \downarrow \\ Z \times_Y X \longrightarrow & Z\end{array}
$$
...
horizontal arrow is \'etale by Lemma \ref{spaces-properties-lemma-etale-local}.
\end{proof}

\begin{lemma}[Etale permanence]
\label{spaces-properties-lemma-etale-permanence}
\source{stacks:03FV}
\href{https://stacks.math.columbia.edu/tag/03FV}{\texttt{Stacks tag 03FV}}
\group{spaces-properties}
...
$$
\begin{array}{cc}U \downarrow\underset{\chi}{\longrightarrow} & V \downarrow \\ X \longrightarrow & Y\end{array}
$$
where $U \to X$ and $V \to Y$ are surjective and \'etale, see
Spaces, Lemma \ref{spaces-lemma-lift-morphism-presentations}.
...
Hence $U \to V$ is \'etale by Lemma \ref{spaces-properties-lemma-etale-over-space}
part (2).
\end{proof}

\begin{lemma}[Etale open]
\label{spaces-properties-lemma-etale-open}
\source{stacks:03IR}
\href{https://stacks.math.columbia.edu/tag/03IR}{\texttt{Stacks tag 03IR}}
\group{spaces-properties}
...
\begin{lemma}[Etale over field scheme]
\label{spaces-properties-lemma-etale-over-field-scheme}
\source{stacks:03KX}
\href{https://stacks.math.columbia.edu/tag/03KX}{\texttt{Stacks tag 03KX}}
\group{spaces-properties}
...
our conventions, see Section \ref{spaces-properties-section-conventions}).

\begin{proposition}[Gabber]

\label{spaces-properties-proposition-sheaf-fpqc}
\source{stacks:0APL}
\href{https://stacks.math.columbia.edu/tag/0APL}{\texttt{Stacks tag 0APL}}
\group{spaces-properties}
...
This is possible by Lemmas \ref{spaces-properties-lemma-topology-points} and
\ref{spaces-properties-lemma-cover-by-union-affines}, the fact that a finite disjoint union of
affines is affine, and the fact that $|T'|$ is quasi-compact
(small argument omitted). Since $U \to X$ is separated
(Lemma \ref{spaces-properties-lemma-separated-cover}), we see that
$$
V = U \times_{X, c} T' \longrightarrow T'
$$
is a surjective, \'etale, separated morphism of schemes
(to see that it is surjective use Lemma \ref{spaces-properties-lemma-points-cartesian}
...
Lemma \ref{spaces-properties-lemma-etale-over-space} implies that in the definition below
...
\source{stacks:03ED}
\href{https://stacks.math.columbia.edu/tag/03ED}{\texttt{Stacks tag 03ED}}
\group{spaces-properties}
...
\begin{definition}[Spaces etale site]
\label{spaces-properties-definition-spaces-etale-site}
\source{stacks:03G0}
\href{https://stacks.math.columbia.edu/tag/03G0}{\texttt{Stacks tag 03G0}}
\group{spaces-properties}
...
\begin{lemma}[Compare etale sites]
\label{spaces-properties-lemma-compare-etale-sites}
\source{stacks:03G1}
\href{https://stacks.math.columbia.edu/tag/03G1}{\texttt{Stacks tag 03G1}}
\group{spaces-properties}
...
\begin{remark}[Explain equivalence]
\label{spaces-properties-remark-explain-equivalence}
\source{stacks:03H7}
\href{https://stacks.math.columbia.edu/tag/03H7}{\texttt{Stacks tag 03H7}}
\group{spaces-properties}

Let us explain the meaning of Lemma \ref{spaces-properties-lemma-compare-etale-sites}.
Let $S$ be a scheme, and let $X$ be an algebraic space over $S$.
...
$$
\begin{array}{ccc}\mathcal{F}'(U) \longrightarrow & \mathcal{F}(U') \longrightarrow\longrightarrow & \mathcal{F}(U' \times_U U').\end{array}
$$
...
\begin{definition}[Affine etale site]
\label{spaces-properties-definition-affine-etale-site}
\source{stacks:0H01}
\href{https://stacks.math.columbia.edu/tag/0H01}{\texttt{Stacks tag 0H01}}
\group{spaces-properties}
...
\source{stacks:04JS}
\href{https://stacks.math.columbia.edu/tag/04JS}{\texttt{Stacks tag 04JS}}
\group{spaces-properties}
...
\source{stacks:04JT}
\href{https://stacks.math.columbia.edu/tag/04JT}{\texttt{Stacks tag 04JT}}
\group{spaces-properties}
...
Lemma \ref{spaces-properties-lemma-alternative}
we see that
...
\source{stacks:03G2}
\href{https://stacks.math.columbia.edu/tag/03G2}{\texttt{Stacks tag 03G2}}
\group{spaces-properties}
...
induces, via Lemma \ref{spaces-properties-lemma-compare-etale-sites}, a morphism of topoi
...
over $Y$ (see Lemmas \ref{spaces-properties-lemma-composition-etale} and
\ref{spaces-properties-lemma-base-change-etale} above).
...
from Lemma \ref{spaces-properties-lemma-compare-etale-sites} above.
Part (4) follows, because if $f$ is representable, then the
functors above fit into a commutative diagram
$$
\begin{array}{cc}X_\etale \longrightarrow & X_{spaces, \etale} \\ Y_\etale \longrightarrow\uparrow & Y_{spaces, \etale} \uparrow\end{array}
$$
of categories.
\end{proof}
...
\begin{definition}[F map]
\label{spaces-properties-definition-f-map}
\source{stacks:03G3}
\href{https://stacks.math.columbia.edu/tag/03G3}{\texttt{Stacks tag 03G3}}
\group{spaces-properties}
...
$$
\begin{array}{cc}U \underset{g}{\downarrow}\longrightarrow & X \overset{f}{\downarrow} \\ V \longrightarrow & Y\end{array}
$$
where $U \in X_\etale$, $V \in Y_\etale$ such that whenever
given an extended diagram
$$
\begin{array}{ccc}U' \longrightarrow\underset{g'}{\downarrow} & U \underset{g}{\downarrow}\longrightarrow & X \overset{f}{\downarrow} \\ V' \longrightarrow & V \longrightarrow & Y\end{array}
$$
with $V' \to V$ and $U' \to U$ \'etale morphisms of schemes the diagram
$$
\begin{array}{ccc}\mathcal{G}(V)
\underset{\varphi_{(U, V, g)}}{\longrightarrow}\underset{\text{restriction of }\mathcal{G}}{\downarrow} &  & \mathcal{F}(U)
\overset{\text{restriction of }\mathcal{F}}{\downarrow} \\ \mathcal{G}(V')
\overset{\varphi_{(U', V', g')}}{\longrightarrow} &  & \mathcal{F}(U')\end{array}
$$
commutes.
\end{definition}
...
\source{stacks:03G4}
\href{https://stacks.math.columbia.edu/tag/03G4}{\texttt{Stacks tag 03G4}}
\group{spaces-properties}
...
$$
\begin{array}{cc}U \underset{g}{\downarrow}\underset{j_U}{\longrightarrow} & X \overset{f}{\downarrow} \\ V \overset{j_V}{\longrightarrow} & Y\end{array}
$$
as in Definition \ref{spaces-properties-definition-f-map} be given.
...
$$
\begin{array}{ccc}\mathcal{F}'(X \times_Y V) \longrightarrow & \mathcal{F}(U') \longrightarrow\longrightarrow & \mathcal{F}(U' \times_{X \times_Y V} U') \\ \mathcal{G}'(X \times_Y V) \longrightarrow\uparrow & \mathcal{G}(V') \longrightarrow\longrightarrow\underset{\varphi_{(U', V', g')}}{\uparrow} & \mathcal{G}(V' \times_V V') \underset{\varphi_{(U'', V'', g'')}}{\uparrow}\end{array}
$$
...
\source{stacks:03LP}
\href{https://stacks.math.columbia.edu/tag/03LP}{\texttt{Stacks tag 03LP}}
\group{spaces-properties}
...
(Definition \ref{spaces-properties-definition-etale}) it is
...
$$
\begin{array}{cc}X_\etale \longrightarrow\overset{j}{\downarrow} & X_{spaces, \etale} \underset{j_{spaces}}{\downarrow} \\ Y_\etale \longrightarrow & Y_{spaces, \etale} \underset{v : V \mapsto X \times_Y V}{\uparrow}\end{array}
$$
...
Lemma \ref{spaces-properties-lemma-functoriality-etale-site} we win.
\end{proof}
...
\begin{lemma}[Pushforward etale base change]
\label{spaces-properties-lemma-pushforward-etale-base-change}
\source{stacks:03LR}
\href{https://stacks.math.columbia.edu/tag/03LR}{\texttt{Stacks tag 03LR}}
\group{spaces-properties}

Let $S$ be a scheme. Let
$$
\begin{array}{cc}X' \longrightarrow\underset{f'}{\downarrow} & X \overset{f}{\downarrow} \\ Y' \overset{g}{\longrightarrow} & Y\end{array}
$$
...
$$
\begin{array}{cc}X'_{spaces, \etale} \underset{j}{\longrightarrow} & X_{spaces, \etale} \\ Y'_{spaces, \etale} \overset{j}{\longrightarrow}\overset{V' \mapsto V' \times_{Y'} X'}{\uparrow} & Y_{spaces, \etale} \underset{V \mapsto V \times_Y X}{\uparrow}\end{array}
$$
...
\begin{lemma}[Characterize sheaf small etale]
\label{spaces-properties-lemma-characterize-sheaf-small-etale}
\source{stacks:03LS}
\href{https://stacks.math.columbia.edu/tag/03LS}{\texttt{Stacks tag 03LS}}
\group{spaces-properties}
...
\begin{proof}
We may interpret $g_{small}^{-1}$ as in Lemma \ref{spaces-properties-lemma-etale-morphism-topoi}.
...
\begin{lemma}[Descent sheaf]
\label{spaces-properties-lemma-descent-sheaf}
\source{stacks:05YY}
\href{https://stacks.math.columbia.edu/tag/05YY}{\texttt{Stacks tag 05YY}}
\group{spaces-properties}
...
$$
\begin{array}{cccc} & \text{pr}_1^{-1}t^{-1}\mathcal{G} \underset{\text{pr}_1^{-1}\alpha}{\longrightarrow} & \text{pr}_1^{-1}s^{-1}\mathcal{G} \searrow &  \\ \text{pr}_0^{-1}s^{-1}\mathcal{G} \nearrow &  &  & c^{-1}s^{-1}\mathcal{G} \\  & \text{pr}_0^{-1}t^{-1}\mathcal{G} \overset{\text{pr}_0^{-1}\alpha}{\nwarrow}\xlongequal{} & c^{-1}t^{-1}\mathcal{G} \underset{c^{-1}\alpha}{\nearrow} & \end{array}
$$
...
\begin{proof}[First proof of Lemma \ref{spaces-properties-lemma-descent-sheaf}]
Let $\mathcal{C} = X_{spaces, \etale}$. By
Lemma \ref{spaces-properties-lemma-etale-morphism-topoi}
...
\begin{proof}[Second proof of Lemma \ref{spaces-properties-lemma-descent-sheaf}]
...
we simply define
$$
\begin{array}{ccc}\mathcal{F}(V) \xlongequal{} & \text{Equalizer}(\mathcal{G}(V') \longrightarrow\longrightarrow & \mathcal{G}(V' \times_V V').\end{array}
$$
...
\source{stacks:0486}
\href{https://stacks.math.columbia.edu/tag/0486}{\texttt{Stacks tag 0486}}
\group{spaces-properties}
...
\begin{definition}[Etale neighbourhood]
\label{spaces-properties-definition-etale-neighbourhood}
\source{stacks:04JV}
\href{https://stacks.math.columbia.edu/tag/04JV}{\texttt{Stacks tag 04JV}}
\group{spaces-properties}
...
$$
\begin{array}{cc} & U \overset{\varphi}{\downarrow} \\ {\bar x} \overset{\bar x}{\longrightarrow}\overset{\bar u}{\nearrow} & X\end{array}
$$
...
\source{stacks:04JW}
\href{https://stacks.math.columbia.edu/tag/04JW}{\texttt{Stacks tag 04JW}}
\group{spaces-properties}
...
Lemmas \ref{spaces-properties-lemma-base-change-etale} and \ref{spaces-properties-lemma-composition-etale}.
...
$$
\begin{array}{cc}U'' \longrightarrow\downarrow & U \overset{(h_1, h_2)}{\downarrow} \\ U' \overset{\Delta}{\longrightarrow} & U' \times_X U'.\end{array}
$$
...
\begin{lemma}[Geometric lift to usual]
\label{spaces-properties-lemma-geometric-lift-to-usual}
\source{stacks:05VN}
\href{https://stacks.math.columbia.edu/tag/05VN}{\texttt{Stacks tag 05VN}}
\group{spaces-properties}
...
$$
\begin{array}{cc}\Spec(k) \times_{\overline{x}, X, \varphi} U
\underset{\text{pr}_1}{\downarrow}\underset{\text{pr}_2}{\longrightarrow} & U
\overset{\varphi}{\downarrow} \\ \Spec(k) \overset{\overline{x}}{\longrightarrow} & X\end{array}
$$
The projection $\text{pr}_1$ is the base change of an \'etale morphisms
so it is \'etale, see
Lemma \ref{spaces-properties-lemma-base-change-etale}.
...
\source{stacks:04JX}
\href{https://stacks.math.columbia.edu/tag/04JX}{\texttt{Stacks tag 04JX}}
\group{spaces-properties}
...
Lemma \ref{spaces-properties-lemma-geometric-lift-to-usual}
...
\source{stacks:04JY}
\href{https://stacks.math.columbia.edu/tag/04JY}{\texttt{Stacks tag 04JY}}
\group{spaces-properties}
...
By
Lemma \ref{spaces-properties-lemma-cofinal-etale},
...
\begin{lemma}[A geometric point of an algebraic space gives a point of its \'etale topos.]
\label{spaces-properties-lemma-stalk-gives-point}
\source{stacks:04K0}
\href{https://stacks.math.columbia.edu/tag/04K0}{\texttt{Stacks tag 04K0}}
\group{spaces-properties}
...
Definition \ref{spaces-properties-definition-etale-neighbourhood}.
...
Lemma \ref{spaces-properties-lemma-geometric-lift-to-cover}.
Hence
...
\source{stacks:04K1}
\href{https://stacks.math.columbia.edu/tag/04K1}{\texttt{Stacks tag 04K1}}
\group{spaces-properties}
...
Lemma \ref{spaces-properties-lemma-stalk-gives-point}. See the proof of
...
\source{stacks:04K2}
\href{https://stacks.math.columbia.edu/tag/04K2}{\texttt{Stacks tag 04K2}}
\group{spaces-properties}
...
via
Lemma \ref{spaces-properties-lemma-stalk-gives-point}.
We also provide a direct proof. Note that by
Lemma \ref{spaces-properties-lemma-stalk-exact}.
...
\source{stacks:04K3}
\href{https://stacks.math.columbia.edu/tag/04K3}{\texttt{Stacks tag 04K3}}
\group{spaces-properties}
...
Lemma \ref{spaces-properties-lemma-stalk-pullback} part (4)
...
\source{stacks:04K4}
\href{https://stacks.math.columbia.edu/tag/04K4}{\texttt{Stacks tag 04K4}}
\group{spaces-properties}
...
$$
\begin{array}{cc}\overline{x}'' \longrightarrow\downarrow\overset{\overline{x}''}{\searrow} & \overline{x}' \overset{\overline{x}'}{\downarrow} \\ \overline{x} \overset{\overline{x}}{\longrightarrow} & X.\end{array}
$$
...
\source{stacks:04K5}
\href{https://stacks.math.columbia.edu/tag/04K5}{\texttt{Stacks tag 04K5}}
\group{spaces-properties}
...
Lemma \ref{spaces-properties-lemma-stalk-pullback}.)
...
\source{stacks:04K6}
\href{https://stacks.math.columbia.edu/tag/04K6}{\texttt{Stacks tag 04K6}}
\group{spaces-properties}
...
\source{stacks:04K8}
\href{https://stacks.math.columbia.edu/tag/04K8}{\texttt{Stacks tag 04K8}}
\group{spaces-properties}
...
\source{stacks:04K9}
\href{https://stacks.math.columbia.edu/tag/04K9}{\texttt{Stacks tag 04K9}}
\group{spaces-properties}
...
Remark \ref{spaces-properties-remark-map-stalks}
...
\source{stacks:04KA}
\href{https://stacks.math.columbia.edu/tag/04KA}{\texttt{Stacks tag 04KA}}
\group{spaces-properties}
...
Lemma \ref{spaces-properties-lemma-zero-over-image}).
\end{enumerate}
\end{definition}
...
\source{stacks:04KB}
\href{https://stacks.math.columbia.edu/tag/04KB}{\texttt{Stacks tag 04KB}}
\group{spaces-properties}
...
Lemma \ref{spaces-properties-lemma-zero-over-image} part (3).
...
\source{stacks:04KC}
\href{https://stacks.math.columbia.edu/tag/04KC}{\texttt{Stacks tag 04KC}}
\group{spaces-properties}
...
\source{stacks:03G6}
\href{https://stacks.math.columbia.edu/tag/03G6}{\texttt{Stacks tag 03G6}}
\group{spaces-properties}
...
\source{stacks:03G7}
\href{https://stacks.math.columbia.edu/tag/03G7}{\texttt{Stacks tag 03G7}}
\group{spaces-properties}
...
Lemma \ref{spaces-properties-lemma-sheaf-condition-holds}.
\end{definition}

According to Lemma \ref{spaces-properties-lemma-characterize-sheaf-small-etale} the sheaf
...
Via the equivalence
$\Sh(X_\etale) = \Sh(X_{spaces, \etale})$
of Lemma \ref{spaces-properties-lemma-compare-etale-sites} we may also think of $\mathcal{O}_X$
...
\begin{lemma}[Morphism ringed topoi]
\label{spaces-properties-lemma-morphism-ringed-topoi}
\source{stacks:03G8}
\href{https://stacks.math.columbia.edu/tag/03G8}{\texttt{Stacks tag 03G8}}
\group{spaces-properties}
...
\begin{proof}
By Lemma \ref{spaces-properties-lemma-f-map} it suffices to give an $f$-map from
...
\begin{lemma}[Reduced space]
\label{spaces-properties-lemma-reduced-space}
\source{stacks:0BGS}
\href{https://stacks.math.columbia.edu/tag/0BGS}{\texttt{Stacks tag 0BGS}}
\group{spaces-properties}
...
reduced (Remark \ref{spaces-properties-remark-list-properties-local-ring-local-etale-topology}).
\end{enumerate}
...
\begin{lemma}[Describe etale local ring]
\label{spaces-properties-lemma-describe-etale-local-ring}
\source{stacks:04KF}
\href{https://stacks.math.columbia.edu/tag/04KF}{\texttt{Stacks tag 04KF}}
\group{spaces-properties}
...
\source{stacks:04KG}
\href{https://stacks.math.columbia.edu/tag/04KG}{\texttt{Stacks tag 04KG}}
\group{spaces-properties}
...
\source{stacks:04KH}
\href{https://stacks.math.columbia.edu/tag/04KH}{\texttt{Stacks tag 04KH}}
\group{spaces-properties}
...
Theorem \ref{spaces-properties-theorem-exactness-stalks}.
See
...
\begin{lemma}[Dimension local ring]
\label{spaces-properties-lemma-dimension-local-ring}
\source{stacks:04N9}
\href{https://stacks.math.columbia.edu/tag/04N9}{\texttt{Stacks tag 04N9}}
\group{spaces-properties}
...
(Definition \ref{spaces-properties-definition-dimension-local-ring}) is $d$,
...
on $x \in |X|$, see Remark \ref{spaces-properties-remark-map-stalks}.
Using Lemma \ref{spaces-properties-lemma-describe-etale-local-ring}
...
\begin{lemma}[Dimension decent invariant under etale]
\label{spaces-properties-lemma-dimension-decent-invariant-under-etale}
\source{stacks:0A4H}
\href{https://stacks.math.columbia.edu/tag/0A4H}{\texttt{Stacks tag 0A4H}}
\group{spaces-properties}
...
Definition \ref{spaces-properties-definition-dimension-at-point} for (1). Part (3) is
an immediate consequence of (1), see Definition \ref{spaces-properties-definition-dimension}.
\end{proof}

\begin{lemma}[Reduced local ring]
\label{spaces-properties-lemma-reduced-local-ring}
\source{stacks:0E01}
\href{https://stacks.math.columbia.edu/tag/0E01}{\texttt{Stacks tag 0E01}}
\group{spaces-properties}
...
\begin{lemma}[Irreducible local ring]
\label{spaces-properties-lemma-irreducible-local-ring}
\source{stacks:06DK}
\href{https://stacks.math.columbia.edu/tag/06DK}{\texttt{Stacks tag 06DK}}
\group{spaces-properties}
...
\source{stacks:06DL}
\href{https://stacks.math.columbia.edu/tag/06DL}{\texttt{Stacks tag 06DL}}
\group{spaces-properties}

Let $S$ be a scheme. Let $X$ be an algebraic space over $S$.
Let $x \in |X|$. We say that $X$ is {\it geometrically unibranch
at $x$} if the equivalent conditions of
Lemma \ref{spaces-properties-lemma-irreducible-local-ring}
...
\begin{lemma}[Nr branches local ring]
\label{spaces-properties-lemma-nr-branches-local-ring}
\source{stacks:0DQ3}
\href{https://stacks.math.columbia.edu/tag/0DQ3}{\texttt{Stacks tag 0DQ3}}
\group{spaces-properties}
...
Lemma \ref{spaces-properties-lemma-describe-etale-local-ring}. Recall that
...
\source{stacks:0DQ4}
\href{https://stacks.math.columbia.edu/tag/0DQ4}{\texttt{Stacks tag 0DQ4}}
\group{spaces-properties}
...
of Lemma \ref{spaces-properties-lemma-nr-branches-local-ring}
hold, or else $\infty$.
\end{definition}
...
\source{stacks:03EA}
\href{https://stacks.math.columbia.edu/tag/03EA}{\texttt{Stacks tag 03EA}}
\group{spaces-properties}
...
\source{stacks:04ZF}
\href{https://stacks.math.columbia.edu/tag/04ZF}{\texttt{Stacks tag 04ZF}}
\group{spaces-properties}
...
\begin{lemma}[Noetherian sober]
\label{spaces-properties-lemma-Noetherian-sober}
\source{stacks:04ZG}
\href{https://stacks.math.columbia.edu/tag/04ZG}{\texttt{Stacks tag 04ZG}}
\group{spaces-properties}
...
space, see
Lemma \ref{spaces-properties-lemma-quasi-separated-sober}.
It is Noetherian by
Lemma \ref{spaces-properties-lemma-Noetherian-topology}.
\end{proof}

\begin{lemma}[Noetherian local ring Noetherian]
\label{spaces-properties-lemma-Noetherian-local-ring-Noetherian}
\source{stacks:08AH}
\href{https://stacks.math.columbia.edu/tag/08AH}{\texttt{Stacks tag 08AH}}
\group{spaces-properties}
...
\source{stacks:06LQ}
\href{https://stacks.math.columbia.edu/tag/06LQ}{\texttt{Stacks tag 06LQ}}
\group{spaces-properties}
...
Definition \ref{spaces-properties-definition-type-property}.
\end{proof}
...
\begin{definition}[Regular at point]
\label{spaces-properties-definition-regular-at-point}
\source{stacks:0AH9}
\href{https://stacks.math.columbia.edu/tag/0AH9}{\texttt{Stacks tag 0AH9}}
\group{spaces-properties}
...
See Definition \ref{spaces-properties-definition-property-at-point},
Lemma \ref{spaces-properties-lemma-local-source-target-at-point}, and
Descent, Lemma \ref{descent-lemma-regular-local-ring-local}.

\begin{lemma}[Regular at x]
\label{spaces-properties-lemma-regular-at-x}
\source{stacks:0AHA}
\href{https://stacks.math.columbia.edu/tag/0AHA}{\texttt{Stacks tag 0AHA}}
\group{spaces-properties}
...
\source{stacks:0BGT}
\href{https://stacks.math.columbia.edu/tag/0BGT}{\texttt{Stacks tag 0BGT}}
\group{spaces-properties}
...
\begin{lemma}[Etale exact pullback]
\label{spaces-properties-lemma-etale-exact-pullback}
\source{stacks:03LV}
\href{https://stacks.math.columbia.edu/tag/03LV}{\texttt{Stacks tag 03LV}}
\group{spaces-properties}
...
\begin{proof}
By the description of inverse image in Lemma \ref{spaces-properties-lemma-etale-morphism-topoi}
...
\begin{lemma}[Pushforward etale base change modules]
\label{spaces-properties-lemma-pushforward-etale-base-change-modules}
\source{stacks:03LX}
\href{https://stacks.math.columbia.edu/tag/03LX}{\texttt{Stacks tag 03LX}}
\group{spaces-properties}
...
\begin{lemma}[Characterize module small etale]
\label{spaces-properties-lemma-characterize-module-small-etale}
\source{stacks:03LY}
\href{https://stacks.math.columbia.edu/tag/03LY}{\texttt{Stacks tag 03LY}}
\group{spaces-properties}
...
\begin{proof}
Combine Lemmas \ref{spaces-properties-lemma-etale-exact-pullback}
and \ref{spaces-properties-lemma-characterize-sheaf-small-etale}, and use the fact that
...
Lemma \ref{spaces-properties-lemma-etale-exact-pullback}.
...
\source{stacks:04M4}
\href{https://stacks.math.columbia.edu/tag/04M4}{\texttt{Stacks tag 04M4}}
\group{spaces-properties}
...
\begin{lemma}[Relocalize morphism at schemes]
\label{spaces-properties-lemma-relocalize-morphism-at-schemes}
\source{stacks:04M5}
\href{https://stacks.math.columbia.edu/tag/04M5}{\texttt{Stacks tag 04M5}}
\group{spaces-properties}

Same notation and assumptions as in
Lemma \ref{spaces-properties-lemma-relocalize-morphism}
...
Lemma \ref{spaces-properties-lemma-functoriality-etale-site}. There is a canonical map
$X \to Y$ sending the pair $(y, s)$ to $y$.

\begin{lemma}[Sheaf gives space]
\label{spaces-properties-lemma-sheaf-gives-space}
\source{stacks:0GF6}
\href{https://stacks.math.columbia.edu/tag/0GF6}{\texttt{Stacks tag 0GF6}}
\group{spaces-properties}
...
Lemma \ref{spaces-properties-lemma-support-subsheaf-final} (small detail omitted).
By the Yoneda lemma we obtain two morphisms $s, t : R \to V$ in $Y_\etale$
and we find a coequalizer diagram
$$
\begin{array}{ccc}h_R \longrightarrow\longrightarrow & h_V \longrightarrow & \mathcal{F}\end{array}
$$
...
coequalizer diagram
$$
\begin{array}{ccc}R \longrightarrow\longrightarrow & V \longrightarrow & X\end{array}
$$
...
functor $j$ of Lemma \ref{spaces-properties-lemma-etale-morphism-topoi}
...
sense, see
Theorem \ref{spaces-properties-theorem-fully-faithful}.

\begin{lemma}[Morphism locally ringed]
\label{spaces-properties-lemma-morphism-locally-ringed}
\source{stacks:04KJ}
\href{https://stacks.math.columbia.edu/tag/04KJ}{\texttt{Stacks tag 04KJ}}
\group{spaces-properties}
...
Lemma \ref{spaces-properties-lemma-etale-site-locally-ringed}.
...
Lemma \ref{spaces-properties-lemma-points-small-etale-site}
...
diagram
$$
\begin{array}{cc}U \downarrow\underset{\psi}{\longrightarrow} & V \downarrow \\ X \longrightarrow & Y\end{array}
$$
...
$$
\begin{array}{cc}\mathcal{O}_{U, \overline{u}} & \mathcal{O}_{V, \overline{v}} \longleftarrow \\ \mathcal{O}_{X, \overline{x}} \uparrow & \mathcal{O}_{Y, \overline{y}}. \longleftarrow\uparrow\end{array}
$$
By
...
\source{stacks:04KK}
\href{https://stacks.math.columbia.edu/tag/04KK}{\texttt{Stacks tag 04KK}}
\group{spaces-properties}
...
\underset{f^\sharp}{\searrow} &  & f_{small}^{-1}\mathcal{O}_Y \overset{t}{\longleftarrow}\overset{f^\sharp}{\swarrow} \\  & \mathcal{O}_X & \end{array}
$$
...
$$
\begin{array}{ccc}f_{small}^{-1}h_V \overset{f^{-1}h_i}{\longrightarrow} & \prod_{j \in J} f_{small}^{-1}\mathcal{O}_Y
\overset{\prod f^\sharp}{\longrightarrow} & \prod_{j \in J} \mathcal{O}_X\end{array}
$$
(verification omitted). This means that the map
$t : f_{small}^{-1}h_V \to f_{small}^{-1}h_V$
fits into the commutative diagram
$$
\begin{array}{ccc}f_{small}^{-1}h_V \overset{f^{-1}h_i}{\longrightarrow}\overset{t}{\downarrow} & \prod_{j \in J} f_{small}^{-1}\mathcal{O}_Y
\overset{\prod f^\sharp}{\longrightarrow}\overset{\prod t}{\downarrow} & \prod_{j \in J} \mathcal{O}_X \overset{\text{id}}{\downarrow} \\ f_{small}^{-1}h_V \overset{f^{-1}h_i}{\longrightarrow} & \prod_{j \in J} f_{small}^{-1}\mathcal{O}_Y
\overset{\prod f^\sharp}{\longrightarrow} & \prod_{j \in J} \mathcal{O}_X\end{array}
$$
...
\source{stacks:04M6}
\href{https://stacks.math.columbia.edu/tag/04M6}{\texttt{Stacks tag 04M6}}
\group{spaces-properties}
...
$$
\begin{array}{cc}h_U \underset{\alpha}{\longrightarrow}\downarrow & a_{spaces, \etale}^{-1}h_V \overset{t}{\downarrow} \\ h_U \dashrightarrow & b_{spaces, \etale}^{-1}h_V\end{array}
$$
...
$$
\begin{array}{cc}U \underset{p}{\downarrow}\underset{\beta}{\longrightarrow} & V \overset{q}{\downarrow} \\ X \overset{b}{\longrightarrow} & Y\end{array}
$$
...
\source{stacks:04KL}
\href{https://stacks.math.columbia.edu/tag/04KL}{\texttt{Stacks tag 04KL}}
\group{spaces-properties}
...
Lemma \ref{spaces-properties-lemma-faithful}.
...
Lemma \ref{spaces-properties-lemma-relocalize-morphism-at-schemes}.
...
$$
\begin{array}{ccc}(\Sh(X_\etale/U), \mathcal{O}_U)
\underset{(j, j^\sharp)}{\longrightarrow}\underset{(g_s, g_s^\sharp)}{\downarrow} &  & (\Sh(X_\etale), \mathcal{O}_X) \overset{(g, g^\sharp)}{\downarrow} \\ (\Sh(V_\etale), \mathcal{O}_V) \longrightarrow &  & (\Sh(Y_\etale), \mathcal{O}_Y).\end{array}
$$
By
...
$$
\begin{array}{cc}h_{U'} \underset{a}{\downarrow}\underset{s'}{\longrightarrow} & g^{-1}h_{V'} \overset{g^{-1}b}{\downarrow} \\ h_U \overset{s}{\longrightarrow} & g^{-1}h_V\end{array}
$$
commutes. Then the diagram
$$
\begin{array}{cc}U' \underset{f_{s'}}{\longrightarrow}\underset{a}{\downarrow} & u(V') \overset{u(b)}{\downarrow} \\ U \overset{f_s}{\longrightarrow} & u(V)\end{array}
$$
...
$$
\begin{array}{ccc}R' \downarrow\downarrow\underset{f_{s \times s}}{\longrightarrow} &  & R \downarrow\downarrow \\ U \overset{f_s}{\longrightarrow} &  & V\end{array}
$$
...
\begin{lemma}[Isomorphism ringed topoi]
\label{spaces-properties-lemma-isomorphism-ringed-topoi}
\source{stacks:05YZ}
\href{https://stacks.math.columbia.edu/tag/05YZ}{\texttt{Stacks tag 05YZ}}
\group{spaces-properties}
...
\source{stacks:03G9}
\href{https://stacks.math.columbia.edu/tag/03G9}{\texttt{Stacks tag 03G9}}
\group{spaces-properties}
...
\source{stacks:03GA}
\href{https://stacks.math.columbia.edu/tag/03GA}{\texttt{Stacks tag 03GA}}
\group{spaces-properties}
...
\begin{lemma}[Characterize quasi coherent small etale]
\label{spaces-properties-lemma-characterize-quasi-coherent-small-etale}
\source{stacks:03LZ}
\href{https://stacks.math.columbia.edu/tag/03LZ}{\texttt{Stacks tag 03LZ}}
\group{spaces-properties}
...
\begin{proof}
Combine Lemmas \ref{spaces-properties-lemma-pullback-quasi-coherent} and
\ref{spaces-properties-lemma-characterize-module-small-etale}.
\end{proof}

\begin{lemma}[Stalk quasi coherent]
\label{spaces-properties-lemma-stalk-quasi-coherent}
\source{stacks:05VP}
\href{https://stacks.math.columbia.edu/tag/05VP}{\texttt{Stacks tag 05VP}}
\group{spaces-properties}
...
Definition \ref{spaces-properties-definition-stalk}
it is clear that
$$
...
\begin{lemma}[Stalk pullback quasi coherent]
\label{spaces-properties-lemma-stalk-pullback-quasi-coherent}
\source{stacks:05VQ}
\href{https://stacks.math.columbia.edu/tag/05VQ}{\texttt{Stacks tag 05VQ}}
\group{spaces-properties}
...
\end{align*}
Here we have used
Lemma \ref{spaces-properties-lemma-stalk-quasi-coherent} (twice)
...
\begin{lemma}[Characterize quasi coherent]
\label{spaces-properties-lemma-characterize-quasi-coherent}
\source{stacks:03M0}
\href{https://stacks.math.columbia.edu/tag/03M0}{\texttt{Stacks tag 03M0}}
\group{spaces-properties}
...
and by Lemma \ref{spaces-properties-lemma-pullback-quasi-coherent} the pullback of $\mathcal{F}$
...
\source{stacks:03M1}
\href{https://stacks.math.columbia.edu/tag/03M1}{\texttt{Stacks tag 03M1}}
\group{spaces-properties}
...
By Lemma \ref{spaces-properties-lemma-pullback-quasi-coherent} we have a commutative diagram
$$
\begin{array}{cc}\QCoh(\mathcal{O}_X) \underset{\varphi^*}{\longrightarrow}\downarrow & \QCoh(\mathcal{O}_U) \downarrow \\ \textit{Mod}(\mathcal{O}_X) \overset{\varphi^*}{\longrightarrow} & \textit{Mod}(\mathcal{O}_U)\end{array}
$$
...
Section \ref{spaces-properties-section-localize}, especially formula
...
\item[(k)] {\it quasi-coherent} (see Section \ref{spaces-properties-section-quasi-coherent}),
...
\source{stacks:060Q}
\href{https://stacks.math.columbia.edu/tag/060Q}{\texttt{Stacks tag 060Q}}
\group{spaces-properties}
...
\source{stacks:060R}
\href{https://stacks.math.columbia.edu/tag/060R}{\texttt{Stacks tag 060R}}
\group{spaces-properties}
...
Lemma \ref{spaces-properties-lemma-locally-projective}
are satisfied.
\end{definition}
...
\source{stacks:060S}
\href{https://stacks.math.columbia.edu/tag/060S}{\texttt{Stacks tag 060S}}
\group{spaces-properties}
...
\begin{proposition}[Quasi coherent]
\label{spaces-properties-proposition-quasi-coherent}
\source{stacks:03M3}
\href{https://stacks.math.columbia.edu/tag/03M3}{\texttt{Stacks tag 03M3}}
\group{spaces-properties}
...
\source{stacks:077V}
\href{https://stacks.math.columbia.edu/tag/077V}{\texttt{Stacks tag 077V}}
\group{spaces-properties}
...
By Lemma \ref{spaces-properties-lemma-properties-quasi-coherent}
...
\begin{lemma}[Morphism to affine scheme]
\label{spaces-properties-lemma-morphism-to-affine-scheme}
\source{stacks:05Z1}
\href{https://stacks.math.columbia.edu/tag/05Z1}{\texttt{Stacks tag 05Z1}}
\group{spaces-properties}
...
the diagram
$$
\begin{array}{cc}\Gamma(U, \mathcal{O}_U) & \Gamma(X, \mathcal{O}_X) \longleftarrow \\  & \Gamma(T, \mathcal{O}_T) \overset{g^\sharp}{\nwarrow}\overset{\varphi}{\underset{f^\sharp}{\uparrow}}\end{array}
$$
...
\source{stacks:071S}
\href{https://stacks.math.columbia.edu/tag/071S}{\texttt{Stacks tag 071S}}
\group{spaces-properties}
