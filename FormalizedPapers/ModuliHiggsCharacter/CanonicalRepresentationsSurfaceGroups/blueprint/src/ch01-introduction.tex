...
\begin{remark}[Geography of MCG-finite representations]
\label{figure:MCG-geography}
\source{canonical-representations-surface-groups}
The source's schematic records the qualitative ranges used here:
below $r<\sqrt{g+1}$, MCG-finite representations have finite image; known
infinite-image examples occur at larger ranks, with virtually solvable image
in polynomial rank and richer examples at exponential rank.
\end{remark}
...
references therein. Previte-Xia \cite{previte2000topological,previte2002topological} study the relationship between density of the image of
...
\source{canonical-representations-surface-groups}
The source gives a schematic overview of the three proof stages for
\autoref{theorem:finite-image}; the argument proceeds through the unitary,
integral, and non-unitary cases described in the following subsections.
\end{remark}
