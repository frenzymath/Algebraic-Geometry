...
$$
\begin{array}{ccc}X_2
\longrightarrow\longrightarrow\longrightarrow & X_1
\longrightarrow\longrightarrow\longleftarrow\longleftarrow & X_0
...
\begin{lemma}[Simplicial site]
\label{spaces-simplicial-lemma-simplicial-site}
\source{stacks:09VL}
\href{https://stacks.math.columbia.edu/tag/09VL}{\texttt{Stacks tag 09VL}}
\group{spaces-simplicial}
...
\begin{lemma}[Describe sheaves simplicial site]
\label{spaces-simplicial-lemma-describe-sheaves-simplicial-site}
\source{stacks:09VM}
\href{https://stacks.math.columbia.edu/tag/09VM}{\texttt{Stacks tag 09VM}}
\group{spaces-simplicial}
...
\begin{lemma}[Simplicial space site functorial]
\label{spaces-simplicial-lemma-simplicial-space-site-functorial}
\source{stacks:09VN}
\href{https://stacks.math.columbia.edu/tag/09VN}{\texttt{Stacks tag 09VN}}
\group{spaces-simplicial}
...
\begin{lemma}[Describe functoriality]
\label{spaces-simplicial-lemma-describe-functoriality}
\source{stacks:09VP}
\href{https://stacks.math.columbia.edu/tag/09VP}{\texttt{Stacks tag 09VP}}
\group{spaces-simplicial}

Let $f : Y \to X$ be a morphism of simplicial spaces. In terms of the
description of sheaves in
Lemma \ref{spaces-simplicial-lemma-describe-sheaves-simplicial-site} the
morphism $f_{Zar}$ of Lemma \ref{spaces-simplicial-lemma-simplicial-space-site-functorial}
...
Lemma \ref{spaces-simplicial-lemma-simplicial-space-site-functorial}
...
\begin{lemma}[Restriction to components]
\label{spaces-simplicial-lemma-restriction-to-components}
\source{stacks:09W0}
\href{https://stacks.math.columbia.edu/tag/09W0}{\texttt{Stacks tag 09W0}}
\group{spaces-simplicial}
...
\begin{lemma}[Restriction injective to component]
\label{spaces-simplicial-lemma-restriction-injective-to-component}
\source{stacks:09W1}
\href{https://stacks.math.columbia.edu/tag/09W1}{\texttt{Stacks tag 09W1}}
\group{spaces-simplicial}
...
and
Lemma \ref{spaces-simplicial-lemma-restriction-to-components}.
\end{proof}

\begin{lemma}[Restriction to components functorial]
\label{spaces-simplicial-lemma-restriction-to-components-functorial}
\source{stacks:09W2}
\href{https://stacks.math.columbia.edu/tag/09W2}{\texttt{Stacks tag 09W2}}
\group{spaces-simplicial}

Let $f : Y \to X$ be a morphism of simplicial spaces. Then
$$
\begin{array}{cc}\Sh(Y_n) \downarrow\underset{f_n}{\longrightarrow} & \Sh(X_n) \downarrow \\ \Sh(Y_{Zar}) \overset{f_{Zar}}{\longrightarrow} & \Sh(X_{Zar})\end{array}
$$
...
Lemmas \ref{spaces-simplicial-lemma-describe-functoriality} and
...
\source{stacks:09W4}
\href{https://stacks.math.columbia.edu/tag/09W4}{\texttt{Stacks tag 09W4}}
\group{spaces-simplicial}
...
$g_n$ as in Lemma \ref{spaces-simplicial-lemma-restriction-to-components},
...
Lemma \ref{spaces-simplicial-lemma-describe-sheaves-simplicial-site}) and
...
\begin{lemma}[Simplicial resolution Z]
\label{spaces-simplicial-lemma-simplicial-resolution-Z}
\source{stacks:09W5}
\href{https://stacks.math.columbia.edu/tag/09W5}{\texttt{Stacks tag 09W5}}
\group{spaces-simplicial}
...
\begin{lemma}[Simplicial sheaf cohomology]
\label{spaces-simplicial-lemma-simplicial-sheaf-cohomology}
\source{stacks:09W6}
\href{https://stacks.math.columbia.edu/tag/09W6}{\texttt{Stacks tag 09W6}}
\group{spaces-simplicial}
...
Lemma \ref{spaces-simplicial-lemma-describe-sheaves-simplicial-site}. Note that
$$
A^{p, q} = \Gamma(X_p, \mathcal{I}_p^q) =
\Mor_{\textit{PSh}}(h_{X_p}, \mathcal{I}^q) =
\Mor_{\textit{PAb}}(\mathbf{Z}_{X_p}, \mathcal{I}^q)
$$
Hence it follows from Lemma \ref{spaces-simplicial-lemma-simplicial-resolution-Z} and
...
(Lemma \ref{spaces-simplicial-lemma-restriction-injective-to-component}).
...
\begin{lemma}[Augmentation pushforward higher direct image]
\label{spaces-simplicial-lemma-augmentation-pushforward-higher-direct-image}
\source{stacks:0D84}
\href{https://stacks.math.columbia.edu/tag/0D84}{\texttt{Stacks tag 0D84}}
\group{spaces-simplicial}
...
by Lemma \ref{spaces-simplicial-lemma-augmentation},
...
for example by Lemma \ref{spaces-simplicial-lemma-simplicial-sheaf-cohomology}.
\end{enumerate}
...
Lemma \ref{spaces-simplicial-lemma-describe-sheaves-simplicial-site}
a sheaf on $X_{\bullet, Zar}$ is the same
thing as a cosimplicial object in the category of sheaves on $X$.

\begin{lemma}[Constant simplicial space]
\label{spaces-simplicial-lemma-constant-simplicial-space}
\source{stacks:09W3}
\href{https://stacks.math.columbia.edu/tag/09W3}{\texttt{Stacks tag 09W3}}
\group{spaces-simplicial}
...
\begin{lemma}[Simplicial site site]
\label{spaces-simplicial-lemma-simplicial-site-site}
\source{stacks:09WC}
\href{https://stacks.math.columbia.edu/tag/09WC}{\texttt{Stacks tag 09WC}}
\group{spaces-simplicial}
...
\begin{lemma}[Simplicial cocontinuous site]
\label{spaces-simplicial-lemma-simplicial-cocontinuous-site}
\source{stacks:09WD}
\href{https://stacks.math.columbia.edu/tag/09WD}{\texttt{Stacks tag 09WD}}
\group{spaces-simplicial}
...
\begin{definition}[Situation: Simplicial site]
\label{spaces-simplicial-situation-simplicial-site}
\source{stacks:09WE}
\href{https://stacks.math.columbia.edu/tag/09WE}{\texttt{Stacks tag 09WE}}
\group{spaces-simplicial}
...
site defined in
Lemma \ref{spaces-simplicial-lemma-simplicial-site-site} (case A) or
Lemma \ref{spaces-simplicial-lemma-simplicial-cocontinuous-site} (case B).
\end{definition}

Let $\mathcal{C}$ be as in Situation \ref{spaces-simplicial-situation-simplicial-site}.
...
$$
\vcenter{
\begin{array}{ccc}\mathcal{F}_l \underset{\mathcal{F}(\varphi \circ \psi)}{\longrightarrow}\underset{\mathcal{F}(\psi)}{\searrow} &  & f_{\varphi \circ \psi, *} \mathcal{F}_n \\  & f_{\psi, *}\mathcal{F}_m \underset{f_{\psi, *}\mathcal{F}(\varphi)}{\nearrow} & \end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{ccc}f_{\varphi \circ \psi}^{-1}\mathcal{F}_l
\underset{\mathcal{F}(\varphi \circ \psi)}{\longrightarrow}\underset{f_\varphi^{-1}\mathcal{F}(\psi)}{\searrow} &  & \mathcal{F}_n \\  & f_\varphi^{-1}\mathcal{F}_m \underset{\mathcal{F}(\varphi)}{\nearrow} & \end{array}
}
$$
...
\begin{lemma}[Describe sheaves simplicial site site]
\label{spaces-simplicial-lemma-describe-sheaves-simplicial-site-site}
\source{stacks:09WF}
\href{https://stacks.math.columbia.edu/tag/09WF}{\texttt{Stacks tag 09WF}}
\group{spaces-simplicial}

In Situation \ref{spaces-simplicial-situation-simplicial-site} there is an equivalence of
categories between
\begin{enumerate}
...
\begin{lemma}[Restriction to components site]
\label{spaces-simplicial-lemma-restriction-to-components-site}
\source{stacks:09WG}
\href{https://stacks.math.columbia.edu/tag/09WG}{\texttt{Stacks tag 09WG}}
\group{spaces-simplicial}

In Situation \ref{spaces-simplicial-situation-simplicial-site} the functor
...
by definition (Lemma \ref{spaces-simplicial-lemma-simplicial-site-site}). For a morphism
...
proof of Lemma \ref{spaces-simplicial-lemma-simplicial-site-site}).
...
then the image $\{U_i \to U\}_{i \in I}$ is a covering in $\mathcal{C}_{total}$
by definition (Lemma \ref{spaces-simplicial-lemma-simplicial-cocontinuous-site}). For a morphism
$V \to U$ of $\mathcal{C}_n$, the fibre product
$V \times_U U_i$ in $\mathcal{C}_n$ is also
the fibre product in $\mathcal{C}_{total}$ (by the claim in the
proof of Lemma \ref{spaces-simplicial-lemma-simplicial-cocontinuous-site}).
Therefore our functor is continuous. On the other hand, our functor
defines a bijection between coverings of $U$ in $\mathcal{C}_n$
and coverings of $U$ in $\mathcal{C}_{total}$. Therefore it is
certainly the case that our functor is cocontinuous.
...
\begin{lemma}[An injective abelian sheaf on a simplicial site is injective on each component]
\label{spaces-simplicial-lemma-restriction-injective-to-component-site}
\source{stacks:09WH}
\href{https://stacks.math.columbia.edu/tag/09WH}{\texttt{Stacks tag 09WH}}
\group{spaces-simplicial}


In Situation \ref{spaces-simplicial-situation-simplicial-site}.
...
Homology, Lemma \ref{homology-lemma-adjoint-preserve-injectives}
and
Lemma \ref{spaces-simplicial-lemma-restriction-to-components-site}.
...
\begin{remark}[Augmentation site]
\label{spaces-simplicial-remark-augmentation-site}
\source{stacks:0D6Z}
\href{https://stacks.math.columbia.edu/tag/0D6Z}{\texttt{Stacks tag 0D6Z}}
\group{spaces-simplicial}

In Situation \ref{spaces-simplicial-situation-simplicial-site} an
...
\begin{lemma}[Augmentation site]
\label{spaces-simplicial-lemma-augmentation-site}
\source{stacks:0D70}
\href{https://stacks.math.columbia.edu/tag/0D70}{\texttt{Stacks tag 0D70}}
\group{spaces-simplicial}

In Situation \ref{spaces-simplicial-situation-simplicial-site} let $a_0$ be an
augmentation towards a site $\mathcal{D}$ as in
Remark \ref{spaces-simplicial-remark-augmentation-site}. Then $a_0$ induces
\begin{enumerate}
...
is as in Lemma \ref{spaces-simplicial-lemma-restriction-to-components-site}, then
$a \circ g_n = a_n$, and
...
Lemma \ref{spaces-simplicial-lemma-describe-sheaves-simplicial-site-site}.
...
associates
$$
\begin{array}{ccc}a_*\mathcal{F} \xlongequal{} & \text{Equalizer}(a_{0, *}\mathcal{F}_0
\longrightarrow\longrightarrow & a_{1, *}\mathcal{F}_1)\end{array}
$$
...
\begin{remark}[Morphism simplicial sites]
\label{spaces-simplicial-remark-morphism-simplicial-sites}
\source{stacks:0D95}
\href{https://stacks.math.columbia.edu/tag/0D95}{\texttt{Stacks tag 0D95}}
\group{spaces-simplicial}

Let $\mathcal{C}_n, f_\varphi, u_\varphi$ and
$\mathcal{C}'_n, f'_\varphi, u'_\varphi$ be as in
Situation \ref{spaces-simplicial-situation-simplicial-site}. A
...
\begin{lemma}[Morphism simplicial sites]
\label{spaces-simplicial-lemma-morphism-simplicial-sites}
\source{stacks:0D96}
\href{https://stacks.math.columbia.edu/tag/0D96}{\texttt{Stacks tag 0D96}}
\group{spaces-simplicial}
...
Remark \ref{spaces-simplicial-remark-morphism-simplicial-sites}.
...
$$
\begin{array}{cc}\Sh(\mathcal{C}_n) \underset{g_n}{\downarrow}\underset{h_n}{\longrightarrow} & \Sh(\mathcal{C}'_n) \overset{g'_n}{\downarrow} \\ \Sh(\mathcal{C}_{total}) \overset{h_{total}}{\longrightarrow} & \Sh(\mathcal{C}'_{total})\end{array}
$$
...
(see definition of coverings in Lemma \ref{spaces-simplicial-lemma-simplicial-site-site}).
Let
...
as in Lemma \ref{spaces-simplicial-lemma-describe-sheaves-simplicial-site-site}, then
...
(see definition of coverings in Lemma \ref{spaces-simplicial-lemma-simplicial-cocontinuous-site}).
...
\begin{lemma}[Direct image morphism simplicial sites]
\label{spaces-simplicial-lemma-direct-image-morphism-simplicial-sites}
\source{stacks:0D97}
\href{https://stacks.math.columbia.edu/tag/0D97}{\texttt{Stacks tag 0D97}}
\group{spaces-simplicial}

With notation and hypotheses as in Lemma \ref{spaces-simplicial-lemma-morphism-simplicial-sites}.
...
Lemma \ref{spaces-simplicial-lemma-restriction-injective-to-component-site}.
We have $(g'_n)^{-1}h_{total, *}\mathcal{I}^\bullet =
h_{n, *}g_n^{-1}\mathcal{I}_n^\bullet$ by
Lemma \ref{spaces-simplicial-lemma-morphism-simplicial-sites}
which gives the desired equality.
\end{proof}

\begin{remark}[Morphism augmentation simplicial sites]
\label{spaces-simplicial-remark-morphism-augmentation-simplicial-sites}
\source{stacks:0D98}
\href{https://stacks.math.columbia.edu/tag/0D98}{\texttt{Stacks tag 0D98}}
\group{spaces-simplicial}
...
as in Remark \ref{spaces-simplicial-remark-augmentation-site}.
Let $h$ be a morphism between simplicial sites as in
Remark \ref{spaces-simplicial-remark-morphism-simplicial-sites}.
...
\begin{lemma}[Morphism augmentation simplicial sites]
\label{spaces-simplicial-lemma-morphism-augmentation-simplicial-sites}
\source{stacks:0D99}
\href{https://stacks.math.columbia.edu/tag/0D99}{\texttt{Stacks tag 0D99}}
\group{spaces-simplicial}
...
Remark \ref{spaces-simplicial-remark-morphism-augmentation-simplicial-sites}.
Then we obtain a commutative diagram
$$
\begin{array}{cc}\Sh(\mathcal{C}_{total}) \underset{a}{\downarrow}\underset{h_{total}}{\longrightarrow} & \Sh(\mathcal{C}'_{total}) \overset{a'}{\downarrow} \\ \Sh(\mathcal{D}) \overset{h_{-1}}{\longrightarrow} & \Sh(\mathcal{D}')\end{array}
$$
\end{lemma}

\begin{proof}
The morphism $h$ is defined in Lemma \ref{spaces-simplicial-lemma-morphism-simplicial-sites}.
The morphisms $a$ and $a'$ are defined in Lemma \ref{spaces-simplicial-lemma-augmentation-site}.
...
in Lemma \ref{spaces-simplicial-lemma-describe-sheaves-simplicial-site-site},
it suffices to show that
$$
\begin{array}{cc}\Sh(\mathcal{C}_n) \underset{a_n}{\downarrow}\underset{h_n}{\longrightarrow} & \Sh(\mathcal{C}'_n) \overset{a'_n}{\downarrow} \\ \Sh(\mathcal{D}) \overset{h_{-1}}{\longrightarrow} & \Sh(\mathcal{D}')\end{array}
$$
...
\begin{lemma}[Restriction module to components site]
\label{spaces-simplicial-lemma-restriction-module-to-components-site}
\source{stacks:0D72}
\href{https://stacks.math.columbia.edu/tag/0D72}{\texttt{Stacks tag 0D72}}
\group{spaces-simplicial}

In Situation \ref{spaces-simplicial-situation-simplicial-site}. Let $\mathcal{O}$
...
Lemma \ref{spaces-simplicial-lemma-restriction-to-components-site} on underlying topoi.
The functor
...
\begin{proof}
By Lemma \ref{spaces-simplicial-lemma-restriction-to-components-site} we have
...
(use Lemma \ref{spaces-simplicial-lemma-describe-sheaves-simplicial-site-site}).
Then one proves directly that
$$
\Mor_{\mathcal{O}_n}(\mathcal{G}, \mathcal{F}_n) =
\Mor_{\mathcal{O}}(\mathcal{H}, \mathcal{F})
$$
proceeding as in the proof of Lemma \ref{spaces-simplicial-lemma-restriction-to-components-site}.
Thus $\mathcal{H} = g_{n!}\mathcal{G}$ as desired.
\end{proof}

\begin{lemma}[Restriction injective to component limp]
\label{spaces-simplicial-lemma-restriction-injective-to-component-limp}
\source{stacks:0D73}
\href{https://stacks.math.columbia.edu/tag/0D73}{\texttt{Stacks tag 0D73}}
\group{spaces-simplicial}
...
and its properties proven in Lemma \ref{spaces-simplicial-lemma-restriction-to-components-site}.
\end{proof}

\begin{lemma}[Exactness g shriek modules]
\label{spaces-simplicial-lemma-exactness-g-shriek-modules}
\source{stacks:0D74}
\href{https://stacks.math.columbia.edu/tag/0D74}{\texttt{Stacks tag 0D74}}
\group{spaces-simplicial}

With assumptions as in
Lemma \ref{spaces-simplicial-lemma-restriction-module-to-components-site} the functor
...
\begin{lemma}[Restriction injective to component site module]
\label{spaces-simplicial-lemma-restriction-injective-to-component-site-module}
\source{stacks:0D75}
\href{https://stacks.math.columbia.edu/tag/0D75}{\texttt{Stacks tag 0D75}}
\group{spaces-simplicial}
...
Homology, Lemma \ref{homology-lemma-adjoint-preserve-injectives}
and
Lemma \ref{spaces-simplicial-lemma-exactness-g-shriek-modules}.
\end{proof}

\section{Morphisms of ringed simplicial sites}
\label{spaces-simplicial-section-morphism-simplicial-sites-modules}
We continue the discussion of Section \ref{spaces-simplicial-section-morphism-simplicial-sites}.

\begin{remark}[Morphism simplicial sites modules]
\label{spaces-simplicial-remark-morphism-simplicial-sites-modules}
\source{stacks:0DGZ}
\href{https://stacks.math.columbia.edu/tag/0DGZ}{\texttt{Stacks tag 0DGZ}}
\group{spaces-simplicial}
...
\begin{lemma}[Morphism simplicial sites modules]
\label{spaces-simplicial-lemma-morphism-simplicial-sites-modules}
\source{stacks:0DH0}
\href{https://stacks.math.columbia.edu/tag/0DH0}{\texttt{Stacks tag 0DH0}}
\group{spaces-simplicial}
...
Remark \ref{spaces-simplicial-remark-morphism-simplicial-sites-modules}.
...
and commutative diagrams
$$
\begin{array}{cc}(\Sh(\mathcal{C}_n), \mathcal{O}_n) \underset{g_n}{\downarrow}\underset{h_n}{\longrightarrow} & (\Sh(\mathcal{C}'_n), \mathcal{O}'_n) \overset{g'_n}{\downarrow} \\ (\Sh(\mathcal{C}_{total}), \mathcal{O}) \overset{h_{total}}{\longrightarrow} & (\Sh(\mathcal{C}'_{total}), \mathcal{O}')\end{array}
$$
of ringed topoi where $g_n$ and $g'_n$ are as in
Lemma \ref{spaces-simplicial-lemma-restriction-module-to-components-site}.
Moreover, we have
...
\begin{proof}
Follows from
Lemma \ref{spaces-simplicial-lemma-morphism-simplicial-sites} and
...
\begin{lemma}[Direct image morphism simplicial sites modules]
\label{spaces-simplicial-lemma-direct-image-morphism-simplicial-sites-modules}
\source{stacks:0DH1}
\href{https://stacks.math.columbia.edu/tag/0DH1}{\texttt{Stacks tag 0DH1}}
\group{spaces-simplicial}

With notation and hypotheses as in
Lemma \ref{spaces-simplicial-lemma-morphism-simplicial-sites-modules}.
...
by the construction in Lemma \ref{spaces-simplicial-lemma-restriction-module-to-components-site}.
...
Lemma \ref{spaces-simplicial-lemma-direct-image-morphism-simplicial-sites}
...
Lemma \ref{spaces-simplicial-lemma-restriction-to-components-site}. If $\varphi : [m] \to [n]$
is a morphism of $\Delta$, then the diagram of topoi
$$
\begin{array}{ccc}\Sh(\mathcal{C}_n) \underset{g_n}{\searrow}\underset{f_\varphi}{\longrightarrow} &  & \Sh(\mathcal{C}_m) \overset{g_m}{\swarrow} \\  & \Sh(\mathcal{C}_{total}) & \end{array}
$$
...
\begin{lemma}[Simplicial resolution Z site]
\label{spaces-simplicial-lemma-simplicial-resolution-Z-site}
\source{stacks:09WI}
\href{https://stacks.math.columbia.edu/tag/09WI}{\texttt{Stacks tag 09WI}}
\group{spaces-simplicial}

In Situation \ref{spaces-simplicial-situation-simplicial-site} and with notation as above
there is a complex
$$
...
Lemma \ref{spaces-simplicial-lemma-restriction-to-components-site} without further mention.
...
\source{stacks:0D77}
\href{https://stacks.math.columbia.edu/tag/0D77}{\texttt{Stacks tag 0D77}}
\group{spaces-simplicial}

In Situation \ref{spaces-simplicial-situation-simplicial-site}. Let $\mathcal{F}$ be an abelian
...
Lemma \ref{spaces-simplicial-lemma-simplicial-resolution-Z-site}
and the fact that $\Hom(-, \mathcal{F})$ is exact if
$\mathcal{F}$ is injective.
\end{proof}

\begin{lemma}[Simplicial sheaf cohomology site]
\label{spaces-simplicial-lemma-simplicial-sheaf-cohomology-site}
\source{stacks:09WJ}
\href{https://stacks.math.columbia.edu/tag/09WJ}{\texttt{Stacks tag 09WJ}}
\group{spaces-simplicial}

In Situation \ref{spaces-simplicial-situation-simplicial-site}. For $K$ in
...
$$
where the horizontal arrows come from Lemma \ref{spaces-simplicial-lemma-cech-complex}
...
\begin{remark}[Simplicial cohomology site]
\label{spaces-simplicial-remark-simplicial-cohomology-site}
\source{stacks:0H0V}
\href{https://stacks.math.columbia.edu/tag/0H0V}{\texttt{Stacks tag 0H0V}}
\group{spaces-simplicial}

Assumptions and notation as in
Lemma \ref{spaces-simplicial-lemma-simplicial-sheaf-cohomology-site}
...
holds by Lemma \ref{spaces-simplicial-lemma-simplicial-resolution-Z-site}.
...
as in Lemma \ref{spaces-simplicial-lemma-simplicial-sheaf-cohomology-site}.
\end{remark}

\begin{lemma}[Simplicial sheaf cohomology site zero]
\label{spaces-simplicial-lemma-simplicial-sheaf-cohomology-site-zero}
\source{stacks:0H0W}
\href{https://stacks.math.columbia.edu/tag/0H0W}{\texttt{Stacks tag 0H0W}}
\group{spaces-simplicial}

In Situation \ref{spaces-simplicial-situation-simplicial-site}. Let $K$ be an object of
$D(\mathcal{C}_{total})$.
\begin{enumerate}
...
\begin{proof}
With notation as in Remark \ref{spaces-simplicial-remark-simplicial-cohomology-site}
...
\begin{lemma}[Sanity check]
\label{spaces-simplicial-lemma-sanity-check}
\source{stacks:0DBZ}
\href{https://stacks.math.columbia.edu/tag/0DBZ}{\texttt{Stacks tag 0DBZ}}
\group{spaces-simplicial}
...
Lemma \ref{spaces-simplicial-lemma-simplicial-site-site} in case (A) and
Lemma \ref{spaces-simplicial-lemma-simplicial-cocontinuous-site} in case (B).
...
Remark \ref{spaces-simplicial-remark-augmentation-site}.
By Lemma \ref{spaces-simplicial-lemma-augmentation-site} we obtain a morphism of topoi
$$
a : \Sh(\mathcal{C}_{total}) \longrightarrow \Sh(\mathcal{D})
$$
and morphisms of topoi
$g_n : \Sh(\mathcal{C}_n) \to \Sh(\mathcal{C}_{total})$
as in Lemma \ref{spaces-simplicial-lemma-restriction-to-components-site}.
...
\begin{lemma}[Simplicial resolution augmentation]
\label{spaces-simplicial-lemma-simplicial-resolution-augmentation}
\source{stacks:0D78}
\href{https://stacks.math.columbia.edu/tag/0D78}{\texttt{Stacks tag 0D78}}
\group{spaces-simplicial}

In Situation \ref{spaces-simplicial-situation-simplicial-site} let
...
Lemma \ref{spaces-simplicial-lemma-simplicial-resolution-Z-site} first.
We will use Lemma \ref{spaces-simplicial-lemma-augmentation-site} and
...
\bigoplus\nolimits_{\alpha \in \Mor_\Delta([0], [m])]} \mathbf{Z}
$$
discussed in the proof of Lemma \ref{spaces-simplicial-lemma-simplicial-resolution-Z-site}.
There we have seen that this complex is homotopy equivalent to
$\mathbf{Z}$ placed in degree $0$ which finishes the proof.
\end{proof}

\begin{lemma}[Augmentation cech complex]
\label{spaces-simplicial-lemma-augmentation-cech-complex}
\source{stacks:0D79}
\href{https://stacks.math.columbia.edu/tag/0D79}{\texttt{Stacks tag 0D79}}
\group{spaces-simplicial}
...
to the exact complex of Lemma \ref{spaces-simplicial-lemma-simplicial-resolution-augmentation}
...
\begin{lemma}[Augmentation spectral sequence]
\label{spaces-simplicial-lemma-augmentation-spectral-sequence}
\source{stacks:0D7A}
\href{https://stacks.math.columbia.edu/tag/0D7A}{\texttt{Stacks tag 0D7A}}
\group{spaces-simplicial}
...
Lemma \ref{spaces-simplicial-lemma-augmentation-cech-complex}
and the vertical arrows from the differentials of the
complex $\mathcal{I}^\bullet$. The rows of the double complex are exact
...
Section \ref{spaces-simplicial-section-cohomology-simplicial-sites}
...
of ringed topoi
$$
\begin{array}{ccc}(\Sh(\mathcal{C}_n), \mathcal{O}_n) \underset{g_n}{\searrow}\underset{f_\varphi}{\longrightarrow} &  & (\Sh(\mathcal{C}_m), \mathcal{O}_m) \overset{g_m}{\swarrow} \\  & (\Sh(\mathcal{C}_{total}), \mathcal{O}) & \end{array}
$$
is not commutative, but there is a $2$-morphism $g_n \to g_m \circ f_\varphi$
coming from the maps
$\mathcal{F}(\varphi) : f_\varphi^{-1}\mathcal{F}_m \to \mathcal{F}_n$.
...
\begin{lemma}[Simplicial resolution ringed]
\label{spaces-simplicial-lemma-simplicial-resolution-ringed}
\source{stacks:0D9B}
\href{https://stacks.math.columbia.edu/tag/0D9B}{\texttt{Stacks tag 0D9B}}
\group{spaces-simplicial}
...
$\mathcal{O}$.
Here $g_{n!}$ is as in Lemma \ref{spaces-simplicial-lemma-restriction-module-to-components-site}.
\end{lemma}
...
\begin{lemma}[Cech complex modules]
\label{spaces-simplicial-lemma-cech-complex-modules}
\source{stacks:0D9C}
\href{https://stacks.math.columbia.edu/tag/0D9C}{\texttt{Stacks tag 0D9C}}
\group{spaces-simplicial}
...
Hence this lemma is an immediate consequence of
Lemma \ref{spaces-simplicial-lemma-simplicial-resolution-ringed}
and the fact that $\Hom(-, \mathcal{F})$ is exact if
$\mathcal{F}$ is injective.
\end{proof}

\begin{lemma}[Simplicial module cohomology site]
\label{spaces-simplicial-lemma-simplicial-module-cohomology-site}
\source{stacks:0D7E}
\href{https://stacks.math.columbia.edu/tag/0D7E}{\texttt{Stacks tag 0D7E}}
\group{spaces-simplicial}
...
$$
where the horizontal arrows come from
Lemma \ref{spaces-simplicial-lemma-cech-complex-modules}
and the vertical arrows from the differentials of the
...
(Lemma \ref{spaces-simplicial-lemma-restriction-injective-to-component-limp}).
Hence the cohomology of the columns computes the groups
...
\begin{lemma}[Sanity check modules]
\label{spaces-simplicial-lemma-sanity-check-modules}
\source{stacks:0DH2}
\href{https://stacks.math.columbia.edu/tag/0DH2}{\texttt{Stacks tag 0DH2}}
\group{spaces-simplicial}
...
Lemma \ref{spaces-simplicial-lemma-restriction-to-components-site}, and
...
This section is the analogue of
Section \ref{spaces-simplicial-section-cohomology-augmentation-simplicial-sites}
for sheaves of modules.
...
$$
where $a$ is as in Lemma \ref{spaces-simplicial-lemma-augmentation-site}.
...
as in
Lemma \ref{spaces-simplicial-lemma-restriction-module-to-components-site}, then
taking the composition $a_n = a \circ g_n$
(Lemma \ref{spaces-simplicial-lemma-augmentation-site})
...
\begin{lemma}[Flat augmentation modules]
\label{spaces-simplicial-lemma-flat-augmentation-modules}
\source{stacks:0DH3}
\href{https://stacks.math.columbia.edu/tag/0DH3}{\texttt{Stacks tag 0DH3}}
\group{spaces-simplicial}
...
\begin{lemma}[Simplicial resolution augmentation modules]
\label{spaces-simplicial-lemma-simplicial-resolution-augmentation-modules}
\source{stacks:0D7C}
\href{https://stacks.math.columbia.edu/tag/0D7C}{\texttt{Stacks tag 0D7C}}
\group{spaces-simplicial}
...
in Lemma \ref{spaces-simplicial-lemma-restriction-module-to-components-site}
...
Lemma \ref{spaces-simplicial-lemma-simplicial-resolution-augmentation},
replacing $a_m^{-1}\mathcal{G}$ by $a_m^*\mathcal{G}$.
\end{proof}

\begin{lemma}[Augmentation cech complex modules]
\label{spaces-simplicial-lemma-augmentation-cech-complex-modules}
\source{stacks:0D7D}
\href{https://stacks.math.columbia.edu/tag/0D7D}{\texttt{Stacks tag 0D7D}}
\group{spaces-simplicial}
...
Lemma \ref{spaces-simplicial-lemma-simplicial-resolution-augmentation-modules}
and use adjointness of pullback and pushforward.
The exactness properties in degrees $-1, 0$ follow from
...
\begin{lemma}[Augmentation spectral sequence modules]
\label{spaces-simplicial-lemma-augmentation-spectral-sequence-modules}
\source{stacks:0D7F}
\href{https://stacks.math.columbia.edu/tag/0D7F}{\texttt{Stacks tag 0D7F}}
\group{spaces-simplicial}
...
$$
where the horizontal arrows come from
Lemma \ref{spaces-simplicial-lemma-augmentation-cech-complex-modules}
and the vertical arrows from the differentials of the
...
\begin{definition}[Cartesian sheaf]
\label{spaces-simplicial-definition-cartesian-sheaf}
\source{stacks:07TF}
\href{https://stacks.math.columbia.edu/tag/07TF}{\texttt{Stacks tag 07TF}}
\group{spaces-simplicial}
...
\begin{lemma}[Check cartesian module]
\label{spaces-simplicial-lemma-check-cartesian-module}
\source{stacks:07TG}
\href{https://stacks.math.columbia.edu/tag/07TG}{\texttt{Stacks tag 07TG}}
\group{spaces-simplicial}
...
\begin{lemma}[Augmentation cartesian module]
\label{spaces-simplicial-lemma-augmentation-cartesian-module}
\source{stacks:0D7H}
\href{https://stacks.math.columbia.edu/tag/0D7H}{\texttt{Stacks tag 0D7H}}
\group{spaces-simplicial}
...
morphism as in
Section \ref{spaces-simplicial-section-cohomology-augmentation-ringed-simplicial-sites}.
\begin{enumerate}
...
See Lemma \ref{spaces-simplicial-lemma-augmentation-site} and the discussion in
Section \ref{spaces-simplicial-section-cohomology-augmentation-ringed-simplicial-sites}.
\end{proof}

\begin{lemma}[Characterize cartesian]
\label{spaces-simplicial-lemma-characterize-cartesian}
\source{stacks:0D7I}
\href{https://stacks.math.columbia.edu/tag/0D7I}{\texttt{Stacks tag 0D7I}}
\group{spaces-simplicial}
...
$$
\begin{array}{cccc} & (d^2_0)^{-1}(d^1_1)^{-1}\mathcal{F} \underset{(d^2_0)^{-1}\alpha}{\longrightarrow} & (d^2_0)^{-1}(d^1_0)^{-1}\mathcal{F} \searrow &  \\ (d^2_2)^{-1}(d^1_0)^{-1}\mathcal{F} \nearrow &  &  & (d^2_1)^{-1}(d^1_0)^{-1}\mathcal{F} \\  & (d^2_2)^{-1}(d^1_1)^{-1}\mathcal{F} \overset{(d^2_2)^{-1}\alpha}{\nwarrow}\xlongequal{} & (d^2_1)^{-1}(d^1_1)^{-1}\mathcal{F} \underset{(d^2_1)^{-1}\alpha}{\nearrow} & \end{array}
$$
...
using
$$
\begin{array}{cccc}(f_\varphi)^{-1}\mathcal{G}_n \xlongequal{} & (f_\varphi)^{-1}(f_{\tau^n_n})^{-1}\mathcal{F} \xlongequal{} & (f_{\tau^m_{\varphi(n)}})^{-1}\mathcal{F} \xlongequal{} & (f_{\tau^m_{\varphi(n)m}})^{-1}(d^1_1)^{-1}\mathcal{F}
\overset{(f_{\tau^m_{\varphi(n)m}})^{-1}\alpha}{\downarrow} \\  & \mathcal{G}_m \xlongequal{} & (f_{\tau^m_m})^{-1}\mathcal{F} \xlongequal{} & (f_{\tau^m_{\varphi(n)m}})^{-1}(d^1_0)^{-1}\mathcal{F}\end{array}
$$
...
\begin{lemma}[Characterize cartesian modules]
\label{spaces-simplicial-lemma-characterize-cartesian-modules}
\source{stacks:07TH}
\href{https://stacks.math.columbia.edu/tag/07TH}{\texttt{Stacks tag 07TH}}
\group{spaces-simplicial}
...
Lemma \ref{spaces-simplicial-lemma-characterize-cartesian}
with pullback of sheaves of abelian groups replaced
by pullback of modules.
\end{proof}

\begin{lemma}[Serre subcat cartesian modules]
\label{spaces-simplicial-lemma-Serre-subcat-cartesian-modules}
\source{stacks:0D7J}
\href{https://stacks.math.columbia.edu/tag/0D7J}{\texttt{Stacks tag 0D7J}}
\group{spaces-simplicial}
...
for $f_{\delta^n_j}$, see Lemma \ref{spaces-simplicial-lemma-check-cartesian-module}.
\end{proof}
...
\source{stacks:0D7K}
\href{https://stacks.math.columbia.edu/tag/0D7K}{\texttt{Stacks tag 0D7K}}
\group{spaces-simplicial}

Lemma \ref{spaces-simplicial-lemma-Serre-subcat-cartesian-modules} notwithstanding, it
...
Lemma \ref{spaces-simplicial-lemma-characterize-cartesian-modules}
...
\begin{lemma}[Derived cartesian modules]
\label{spaces-simplicial-lemma-derived-cartesian-modules}
\source{stacks:0D7L}
\href{https://stacks.math.columbia.edu/tag/0D7L}{\texttt{Stacks tag 0D7L}}
\group{spaces-simplicial}
...
Lemma \ref{spaces-simplicial-lemma-check-cartesian-module}
and the fact that $L(f_{\delta^n_j})^* = (f_{\delta^n_j})^*$
by flatness.
\end{proof}

\begin{lemma}[Derived cartesian shriek]
\label{spaces-simplicial-lemma-derived-cartesian-shriek}
\source{stacks:0D9E}
\href{https://stacks.math.columbia.edu/tag/0D9E}{\texttt{Stacks tag 0D9E}}
\group{spaces-simplicial}
...
given in Lemma \ref{spaces-simplicial-lemma-restriction-to-components-site}
...
(Lemma \ref{spaces-simplicial-lemma-exactness-g-shriek-modules}), it induces a functor
...
Using the description of $g_{n!}$
given in Lemma \ref{spaces-simplicial-lemma-restriction-module-to-components-site}
we see that the restriction to $\mathcal{C}_m$ of this map
is
$$
...
\begin{lemma}[Quasi coherent sheaf]
\label{spaces-simplicial-lemma-quasi-coherent-sheaf}
\source{stacks:0D7M}
\href{https://stacks.math.columbia.edu/tag/0D7M}{\texttt{Stacks tag 0D7M}}
\group{spaces-simplicial}
...
is discussed in Section \ref{spaces-simplicial-section-glueing-modules}.

\begin{definition}[Cartesian derived]
\label{spaces-simplicial-definition-cartesian-derived}
\source{stacks:0D9G}
\href{https://stacks.math.columbia.edu/tag/0D9G}{\texttt{Stacks tag 0D9G}}
\group{spaces-simplicial}

In Situation \ref{spaces-simplicial-situation-simplicial-site}. A
...
\begin{lemma}[Cartesian objects derived]
\label{spaces-simplicial-lemma-cartesian-objects-derived}
\source{stacks:0D9H}
\href{https://stacks.math.columbia.edu/tag/0D9H}{\texttt{Stacks tag 0D9H}}
\group{spaces-simplicial}
...
\begin{lemma}[Construct cartesian objects derived]
\label{spaces-simplicial-lemma-construct-cartesian-objects-derived}
\source{stacks:0GME}
\href{https://stacks.math.columbia.edu/tag/0GME}{\texttt{Stacks tag 0GME}}
\group{spaces-simplicial}
...
\begin{proof}
Please compare with Lemma \ref{spaces-simplicial-lemma-characterize-cartesian}
...
using
$$
\begin{array}{cccc}f_\varphi^{-1}K_n \xlongequal{} & f_\varphi^{-1} f_{\tau^n_n}^{-1}K_0 \xlongequal{} & f_{\tau^m_{\varphi(n)}}^{-1}K_0 \xlongequal{} & f_{\tau^m_{\varphi(n)m}}^{-1}f_{\delta^1_1}^{-1}K_0
\underset{f_{\tau^m_{\varphi(n)m}}^{-1}\alpha}{\downarrow} \\  & K_m \xlongequal{} & f_{\tau^m_m}^{-1}K_0 \xlongequal{} & f_{\tau^m_{\varphi(n)m}}^{-1}f_{\delta^1_0}^{-1}K_0\end{array}
$$
...
\begin{lemma}[Abelian postnikov]
\label{spaces-simplicial-lemma-abelian-postnikov}
\source{stacks:0D9I}
\href{https://stacks.math.columbia.edu/tag/0D9I}{\texttt{Stacks tag 0D9I}}
\group{spaces-simplicial}

In Situation \ref{spaces-simplicial-situation-simplicial-site}. Let $K$ be
...
as in Lemma \ref{spaces-simplicial-lemma-simplicial-resolution-Z-site}.
...
by Lemma \ref{spaces-simplicial-lemma-simplicial-resolution-Z-site}.
...
\begin{lemma}[Nullity cartesian objects derived]
\label{spaces-simplicial-lemma-nullity-cartesian-objects-derived}
\source{stacks:0D9J}
\href{https://stacks.math.columbia.edu/tag/0D9J}{\texttt{Stacks tag 0D9J}}
\group{spaces-simplicial}
...
associated to $K$ in Lemma \ref{spaces-simplicial-lemma-abelian-postnikov}.
As $K = \text{hocolim} Y_n[n]$ the map $K \to K'$ induces
a compatible family of morphisms $Y_n[n] \to K'$.
By (1) and Lemma \ref{spaces-simplicial-lemma-derived-cartesian-shriek} we have
...
\begin{lemma}[Hom cartesian objects derived]
\label{spaces-simplicial-lemma-hom-cartesian-objects-derived}
\source{stacks:0D9K}
\href{https://stacks.math.columbia.edu/tag/0D9K}{\texttt{Stacks tag 0D9K}}
\group{spaces-simplicial}
...
associated to $K$ of Lemma \ref{spaces-simplicial-lemma-abelian-postnikov}.
By (1) and Lemma \ref{spaces-simplicial-lemma-derived-cartesian-shriek} we have
...
$$
\begin{array}{cc}X_0 \searrow\longrightarrow & K \overset{\gamma}{\downarrow} \\  & K'\end{array}
$$
...
\begin{lemma}[Cartesian object derived from simplicial]
\label{spaces-simplicial-lemma-cartesian-object-derived-from-simplicial}
\source{stacks:0D9L}
\href{https://stacks.math.columbia.edu/tag/0D9L}{\texttt{Stacks tag 0D9L}}
\group{spaces-simplicial}
...
in the proof of Lemma \ref{spaces-simplicial-lemma-simplicial-resolution-Z-site}.
We obtain a complex
$$
...
$$
\begin{array}{cccc}\ldots \longrightarrow & g_m^{-1}X_2 \longrightarrow\downarrow & g_m^{-1}X_1 \longrightarrow\downarrow & g_m^{-1}X_0 \downarrow \\ \ldots \longrightarrow & \bigoplus\nolimits_{\varphi : [2] \to [m]} K_m \longrightarrow & \bigoplus\nolimits_{\varphi : [1] \to [m]} K_m \longrightarrow & \bigoplus\nolimits_{\varphi : [0] \to [m]} K_m\end{array}
$$
...
(please compare with the proof of Lemma \ref{spaces-simplicial-lemma-abelian-postnikov}
...
$$
\begin{array}{cc}f_\varphi^{-1}g_m^{-1}K \underset{f_\varphi^{-1}\gamma_m}{\downarrow}\underset{K(\varphi)}{\longrightarrow} & g_n^{-1}K \overset{\gamma_n}{\downarrow} \\ f_\varphi^{-1}K_m \overset{K_\varphi}{\longrightarrow} & K_n\end{array}
$$
for every $\varphi : [m] \to [n]$. Consider the diagram
$$
\begin{array}{cccc}f_\varphi^{-1}(\bigoplus_{\psi : [0] \to [m]} f_\psi^{-1}K_0)
\xlongequal{}\underset{f_\varphi^{-1}(\bigoplus K_\psi)}{\downarrow} & f_\varphi^{-1}g_m^{-1}X_0 \downarrow\underset{X_0(\varphi)}{\longrightarrow} & g_n^{-1}X_0 \downarrow & \bigoplus_{\chi : [0] \to [n]} f_\chi^{-1}K_0
\xlongequal{}\overset{\bigoplus K_\chi}{\downarrow} \\ f_\varphi^{-1}(\bigoplus_{\psi : [0] \to [m]} K_m) \downarrow & f_\varphi^{-1}g_m^{-1}K \underset{f_\varphi^{-1}\gamma_m}{\downarrow}\underset{K(\varphi)}{\longrightarrow} & g_n^{-1}K \overset{\gamma_n}{\downarrow} & \bigoplus_{\chi : [0] \to [n]} K_n \downarrow \\ f_\varphi^{-1}Y'_{0, m} \longrightarrow & f_\varphi^{-1}K_m \overset{K_\varphi}{\longrightarrow} & K_n & Y'_{0, n} \longleftarrow\end{array}
$$
...
case of abelian sheaves is discussed in Section \ref{spaces-simplicial-section-glueing}.

\begin{definition}[Cartesian derived modules]
\label{spaces-simplicial-definition-cartesian-derived-modules}
\source{stacks:0D9N}
\href{https://stacks.math.columbia.edu/tag/0D9N}{\texttt{Stacks tag 0D9N}}
\group{spaces-simplicial}
...
\begin{lemma}[Cartesian objects derived modules]
\label{spaces-simplicial-lemma-cartesian-objects-derived-modules}
\source{stacks:0D9P}
\href{https://stacks.math.columbia.edu/tag/0D9P}{\texttt{Stacks tag 0D9P}}
\group{spaces-simplicial}

In Situation \ref{spaces-simplicial-situation-simplicial-site} let $\mathcal{O}$ be a
...
\begin{lemma}[Construct cartesian objects derived modules]
\label{spaces-simplicial-lemma-construct-cartesian-objects-derived-modules}
\source{stacks:0GMF}
\href{https://stacks.math.columbia.edu/tag/0GMF}{\texttt{Stacks tag 0GMF}}
\group{spaces-simplicial}
...
\begin{proof}
Please compare with Lemmas \ref{spaces-simplicial-lemma-construct-cartesian-objects-derived}
and \ref{spaces-simplicial-lemma-characterize-cartesian} and its proof
...
using
$$
\begin{array}{cccc}L(f_\varphi)^*K_n \xlongequal{} & L(f_\varphi)^* L(f_{\tau^n_n})^*K_0 \xlongequal{} & L(f_{\tau^m_{\varphi(n)}})^*K_0 \xlongequal{} & L(f_{\tau^m_{\varphi(n)m}})^* L(f_{\delta^1_1})^*K_0
\underset{L(f_{\tau^m_{\varphi(n)m}})^*\alpha}{\downarrow} \\  & K_m \xlongequal{} & L(f_{\tau^m_m})^*K_0 \xlongequal{} & L(f_{\tau^m_{\varphi(n)m}})^* L(f_{\delta^1_0})^*K_0\end{array}
$$
We omit the verification that the cocycle condition
implies the maps compose correctly (in their respective
derived categories) and hence give rise to a
...
\begin{lemma}[Modules postnikov]
\label{spaces-simplicial-lemma-modules-postnikov}
\source{stacks:0D9Q}
\href{https://stacks.math.columbia.edu/tag/0D9Q}{\texttt{Stacks tag 0D9Q}}
\group{spaces-simplicial}
...
by Lemma \ref{spaces-simplicial-lemma-simplicial-resolution-ringed}.
The general case follows from this, the fact that the exact functor
...
\begin{lemma}[Nullity cartesian modules derived]
\label{spaces-simplicial-lemma-nullity-cartesian-modules-derived}
\source{stacks:0D9R}
\href{https://stacks.math.columbia.edu/tag/0D9R}{\texttt{Stacks tag 0D9R}}
\group{spaces-simplicial}

In Situation \ref{spaces-simplicial-situation-simplicial-site} let $\mathcal{O}$ be
...
Lemma \ref{spaces-simplicial-lemma-nullity-cartesian-objects-derived} except using
Lemma \ref{spaces-simplicial-lemma-modules-postnikov} instead of
Lemma \ref{spaces-simplicial-lemma-abelian-postnikov}.
\end{proof}

\begin{lemma}[Hom cartesian modules derived]
\label{spaces-simplicial-lemma-hom-cartesian-modules-derived}
\source{stacks:0D9S}
\href{https://stacks.math.columbia.edu/tag/0D9S}{\texttt{Stacks tag 0D9S}}
\group{spaces-simplicial}
...
\begin{proof}
The proof is exactly the same as the proof of
Lemma \ref{spaces-simplicial-lemma-hom-cartesian-objects-derived} except using
Lemma \ref{spaces-simplicial-lemma-modules-postnikov} instead of
Lemma \ref{spaces-simplicial-lemma-abelian-postnikov}.
\end{proof}

\begin{lemma}[Cartesian module derived from simplicial]
\label{spaces-simplicial-lemma-cartesian-module-derived-from-simplicial}
\source{stacks:0D9T}
\href{https://stacks.math.columbia.edu/tag/0D9T}{\texttt{Stacks tag 0D9T}}
\group{spaces-simplicial}
...
\begin{proof}
The proof is exactly the same as the proof of
Lemma \ref{spaces-simplicial-lemma-cartesian-object-derived-from-simplicial}
with the following changes
\begin{enumerate}
\item use $g_n^* = Lg_n^*$ everywhere instead of $g_n^{-1}$,
\item use $f_\varphi^* = Lf_\varphi^*$ everywhere instead of $f_\varphi^{-1}$,
\item refer to Lemma \ref{spaces-simplicial-lemma-simplicial-resolution-ringed}
instead of Lemma \ref{spaces-simplicial-lemma-simplicial-resolution-Z-site},
\item in the construction of $Y'_{m, n}$ use
$\mathcal{O}_m$ instead of $\mathbf{Z}$,
\item compare with the proof of Lemma \ref{spaces-simplicial-lemma-modules-postnikov}
rather than the proof of Lemma \ref{spaces-simplicial-lemma-abelian-postnikov}.
\end{enumerate}
This ends the proof.
\end{proof}
...
\source{stacks:0D85}
\href{https://stacks.math.columbia.edu/tag/0D85}{\texttt{Stacks tag 0D85}}
\group{spaces-simplicial}
...
\begin{lemma}[Push pull localization]
\label{spaces-simplicial-lemma-push-pull-localization}
\source{stacks:0D86}
\href{https://stacks.math.columbia.edu/tag/0D86}{\texttt{Stacks tag 0D86}}
\group{spaces-simplicial}
...
\source{stacks:0D87}
\href{https://stacks.math.columbia.edu/tag/0D87}{\texttt{Stacks tag 0D87}}
\group{spaces-simplicial}
...
\begin{lemma}[Localize injective]
\label{spaces-simplicial-lemma-localize-injective}
\source{stacks:0D88}
\href{https://stacks.math.columbia.edu/tag/0D88}{\texttt{Stacks tag 0D88}}
\group{spaces-simplicial}
...
Lemma \ref{spaces-simplicial-lemma-localize-compare} part (1)
...
\source{stacks:0D89}
\href{https://stacks.math.columbia.edu/tag/0D89}{\texttt{Stacks tag 0D89}}
\group{spaces-simplicial}
...
\source{stacks:0D9U}
\href{https://stacks.math.columbia.edu/tag/0D9U}{\texttt{Stacks tag 0D9U}}
\group{spaces-simplicial}
...
\source{stacks:0D9V}
\href{https://stacks.math.columbia.edu/tag/0D9V}{\texttt{Stacks tag 0D9V}}
\group{spaces-simplicial}
...
Remarks \ref{spaces-simplicial-remark-semi-representable-over-object}
and \ref{spaces-simplicial-remark-semi-representable-ringed} to get
\begin{enumerate}
\item a ringed site $(\mathcal{C}/K, \mathcal{O}_K)$
...
Remark \ref{spaces-simplicial-remark-semi-representable-ringed}
...
Section \ref{spaces-simplicial-section-semi-representable} we obtain a simplicial object
...
a gadget as in Case B of Section \ref{spaces-simplicial-section-simplicial-sites}.
The functors satisfy property P by Lemma \ref{spaces-simplicial-lemma-has-P}.
Hence we may apply
Lemma \ref{spaces-simplicial-lemma-simplicial-cocontinuous-site}
...
$$
\vcenter{
\begin{array}{cc}U \underset{f}{\longrightarrow}\downarrow & V \downarrow \\ U_{n, i} \overset{f_{\varphi, i}}{\longrightarrow} & U_{m, j}\end{array}
}
$$
is commutative, and
...
\begin{lemma}[Augmentation simplicial semi representable]
\label{spaces-simplicial-lemma-augmentation-simplicial-semi-representable}
\source{stacks:0D8B}
\href{https://stacks.math.columbia.edu/tag/0D8B}{\texttt{Stacks tag 0D8B}}
\group{spaces-simplicial}
...
$$
of Lemma \ref{spaces-simplicial-lemma-augmentation-site}
...
\source{stacks:09WM}
\href{https://stacks.math.columbia.edu/tag/09WM}{\texttt{Stacks tag 09WM}}
\group{spaces-simplicial}

With assumption and notation as in
Lemma \ref{spaces-simplicial-lemma-augmentation-simplicial-semi-representable}
...
simplicial site, see Lemma \ref{spaces-simplicial-lemma-augmentation-site}.
...
\begin{lemma}[Sanity check simplicial semi representable]
\label{spaces-simplicial-lemma-sanity-check-simplicial-semi-representable}
\source{stacks:0DC0}
\href{https://stacks.math.columbia.edu/tag/0DC0}{\texttt{Stacks tag 0DC0}}
\group{spaces-simplicial}
...
of Section \ref{spaces-simplicial-section-semi-representable}.
\end{enumerate}
\end{lemma}

\begin{proof}
This follows immediately from Lemma \ref{spaces-simplicial-lemma-sanity-check}
and the product decompositions of Section \ref{spaces-simplicial-section-semi-representable}.
\end{proof}
...
\source{stacks:0D8C}
\href{https://stacks.math.columbia.edu/tag/0D8C}{\texttt{Stacks tag 0D8C}}
\group{spaces-simplicial}
...
see Remark \ref{spaces-simplicial-remark-semi-representable-over-object}.
...
\source{stacks:0D9W}
\href{https://stacks.math.columbia.edu/tag/0D9W}{\texttt{Stacks tag 0D9W}}
\group{spaces-simplicial}
...
is as in Lemmas \ref{spaces-simplicial-lemma-augmentation-simplicial-semi-representable} and
\ref{spaces-simplicial-lemma-comparison}.
The constructions above, keeping track of the sheaves of rings
as in Remark \ref{spaces-simplicial-remark-semi-representable-ringed}, give
\begin{enumerate}
...
Modules on Sites, Lemma \ref{sites-modules-lemma-g-shriek-adjoint}
in the proof of Lemma \ref{spaces-simplicial-lemma-comparison}
by Modules on Sites, Lemma \ref{sites-modules-lemma-lower-shriek-modules}.
As discussed in Remark \ref{spaces-simplicial-remark-semi-representable-ringed}
...
\source{stacks:0D9X}
\href{https://stacks.math.columbia.edu/tag/0D9X}{\texttt{Stacks tag 0D9X}}
\group{spaces-simplicial}
...
Then we can combine the constructions given in
Remarks \ref{spaces-simplicial-remark-augmentation-over-object} and
...
Remark \ref{spaces-simplicial-remark-augmentation-ringed}
hold in this setting as well.
\end{remark}
...
a : \Sh((\mathcal{C}/K)_{total}) \longrightarrow \Sh(\mathcal{C})
$$
of Section \ref{spaces-simplicial-section-simplicial-semi-representable}.

\begin{lemma}[Hypercovering descent sheaves]
\label{spaces-simplicial-lemma-hypercovering-descent-sheaves}
\source{stacks:0D8E}
\href{https://stacks.math.columbia.edu/tag/0D8E}{\texttt{Stacks tag 0D8E}}
\group{spaces-simplicial}
...
Lemma \ref{spaces-simplicial-lemma-augmentation-cartesian-module}.
...
see Lemma \ref{spaces-simplicial-lemma-comparison}.
By Lemma \ref{spaces-simplicial-lemma-push-pull-localization}
$$
...
$$
\begin{array}{ccc}F(K_1)^\# \longrightarrow\longrightarrow & F(K_0)^\# \longrightarrow & \text{final object }*\text{ of }\Sh(\mathcal{C})\end{array}
$$
...
$$
\begin{array}{ccc}\mathcal{K}_2
\longrightarrow\longrightarrow\longrightarrow & \mathcal{K}_1
\longrightarrow\longrightarrow & \mathcal{K}_0\end{array}
$$
...
\mathcal{K}_2 \to
\left(\text{cosk}_1(
\begin{array}{cc}\mathcal{K}_1
\longrightarrow\longrightarrow & \mathcal{K}_0 \longleftarrow\end{array})\right)_2
$$
are surjective maps of sheaves. Using the description of cartesian sheaves on
$(\mathcal{C}/K)_{total}$ given in Lemma \ref{spaces-simplicial-lemma-characterize-cartesian}
and using the description of $\Sh(\mathcal{C}/K_n)$ in
Lemma \ref{spaces-simplicial-lemma-localize-compare}
...
formulated in Lemma \ref{spaces-simplicial-lemma-characterize-cartesian}.
...
$$
\begin{array}{ccc}U_1 \times_{(d^1_1, d^1_0), U_0 \times U_0, (d^1_1, d^1_0)} U_1
\downarrow\underset{c}{\longrightarrow} &  & U_2 \downarrow \\ U_1 \times U_1
\overset{(\text{pr}_1, \text{pr}_2, s^0_0 \circ d^1_1 \circ \text{pr}_1)}{\longrightarrow} &  & U_1 \times U_1 \times U_1\end{array}
$$
...
\begin{lemma}[Hypercovering cech complex]
\label{spaces-simplicial-lemma-hypercovering-cech-complex}
\source{stacks:0D8F}
\href{https://stacks.math.columbia.edu/tag/0D8F}{\texttt{Stacks tag 0D8F}}
\group{spaces-simplicial}

Let $\mathcal{C}$ be a site with equalizers and fibre products.
Let $K$ be a hypercovering. The {\v C}ech complex
of Lemma \ref{spaces-simplicial-lemma-augmentation-cech-complex} associated to
$a^{-1}\mathcal{F}$
$$
...
\begin{proof}
By Lemma \ref{spaces-simplicial-lemma-push-pull-localization} we have
$$
...
\begin{lemma}[Hypercovering descent bounded abelian]
\label{spaces-simplicial-lemma-hypercovering-descent-bounded-abelian}
\source{stacks:0D8G}
\href{https://stacks.math.columbia.edu/tag/0D8G}{\texttt{Stacks tag 0D8G}}
\group{spaces-simplicial}
...
Lemma \ref{spaces-simplicial-lemma-augmentation-spectral-sequence}
for the sheaf $a^{-1}\mathcal{I}$ degenerates as
$(a^{-1}\mathcal{I})_p = a_p^{-1}\mathcal{I}$
is injective by Lemma \ref{spaces-simplicial-lemma-localize-injective}.
Thus the complex
$$
...
Lemma \ref{spaces-simplicial-lemma-hypercovering-cech-complex}
...
by Lemma \ref{spaces-simplicial-lemma-hypercovering-descent-sheaves}.
...
$$
By Lemma \ref{spaces-simplicial-lemma-simplicial-resolution-augmentation}
...
Lemma \ref{spaces-simplicial-lemma-localize-injective}.
...
$$
\begin{array}{cc}R\Gamma(U, E) \longrightarrow\downarrow & \text{Tot}_\pi(A^{\bullet, \bullet}) \downarrow \\ R\Gamma(U, Ra_*a^{-1}E) \longrightarrow & \text{Tot}_\pi(B^{\bullet, \bullet})\end{array}
$$
is a quasi-isomorphism. Since we saw above that the horizontal arrows
are quasi-isomorphisms, so is the left vertical arrow.
\end{proof}

\begin{lemma}[Compare cohomology hypercovering]
\label{spaces-simplicial-lemma-compare-cohomology-hypercovering}
\source{stacks:0D8H}
\href{https://stacks.math.columbia.edu/tag/0D8H}{\texttt{Stacks tag 0D8H}}
\group{spaces-simplicial}
...
\begin{proof}
This follows from Lemma \ref{spaces-simplicial-lemma-hypercovering-descent-bounded-abelian}
...
\begin{lemma}[Hypercovering equivalence bounded]
\label{spaces-simplicial-lemma-hypercovering-equivalence-bounded}
\source{stacks:0D8I}
\href{https://stacks.math.columbia.edu/tag/0D8I}{\texttt{Stacks tag 0D8I}}
\group{spaces-simplicial}
...
Lemma \ref{spaces-simplicial-lemma-Serre-subcat-cartesian-modules}.
The equivalence is a
formal consequence of the results obtained so far. Use
Lemmas \ref{spaces-simplicial-lemma-hypercovering-descent-sheaves} and
\ref{spaces-simplicial-lemma-hypercovering-descent-bounded-abelian} and
Cohomology on Sites, Lemma \ref{sites-cohomology-lemma-equivalence-bounded}
\end{proof}

We urge the reader to skip the following remark.

\begin{remark}[Compare cohomology hypercovering presheaf]
\label{spaces-simplicial-remark-compare-cohomology-hypercovering-presheaf}
\source{stacks:09X6}
\href{https://stacks.math.columbia.edu/tag/09X6}{\texttt{Stacks tag 09X6}}
\group{spaces-simplicial}
...
Lemma \ref{spaces-simplicial-lemma-compare-cohomology-hypercovering}.
...
(\Sh(\mathcal{C}), \mathcal{O}_\mathcal{C})
$$
of Remark \ref{spaces-simplicial-remark-augmentation-ringed}.

\begin{lemma}[Hypercovering descent modules]
\label{spaces-simplicial-lemma-hypercovering-descent-modules}
\source{stacks:0D9Z}
\href{https://stacks.math.columbia.edu/tag/0D9Z}{\texttt{Stacks tag 0D9Z}}
\group{spaces-simplicial}
...
immediately from Lemma \ref{spaces-simplicial-lemma-hypercovering-descent-sheaves}.
\end{proof}

\begin{lemma}[Hypercovering descent bounded modules]
\label{spaces-simplicial-lemma-hypercovering-descent-bounded-modules}
\source{stacks:0DA0}
\href{https://stacks.math.columbia.edu/tag/0DA0}{\texttt{Stacks tag 0DA0}}
\group{spaces-simplicial}
...
immediately from Lemma \ref{spaces-simplicial-lemma-hypercovering-descent-bounded-abelian}.
\end{proof}

\begin{lemma}[Compare cohomology hypercovering modules]
\label{spaces-simplicial-lemma-compare-cohomology-hypercovering-modules}
\source{stacks:0DA1}
\href{https://stacks.math.columbia.edu/tag/0DA1}{\texttt{Stacks tag 0DA1}}
\group{spaces-simplicial}
...
\begin{proof}
This follows from Lemma \ref{spaces-simplicial-lemma-hypercovering-descent-bounded-modules}
because $R\Gamma((\mathcal{C}/K)_{total}, -) =
R\Gamma(\mathcal{C}, -) \circ Ra_*$ by
Cohomology on Sites, Remark \ref{sites-cohomology-remark-before-Leray}
or by
...
\begin{lemma}[Hypercovering equivalence bounded modules]
\label{spaces-simplicial-lemma-hypercovering-equivalence-bounded-modules}
\source{stacks:0DA2}
\href{https://stacks.math.columbia.edu/tag/0DA2}{\texttt{Stacks tag 0DA2}}
\group{spaces-simplicial}
...
The equivalence is a
formal consequence of the results obtained so far. Use
Lemmas \ref{spaces-simplicial-lemma-hypercovering-descent-modules} and
\ref{spaces-simplicial-lemma-hypercovering-descent-bounded-modules} and
Cohomology on Sites, Lemma \ref{sites-cohomology-lemma-equivalence-bounded}.
\end{proof}
...
$$
of Remark \ref{spaces-simplicial-remark-augmentation-over-object}.
...
in Section \ref{spaces-simplicial-section-cohomological-descent-hypercoverings}
has an immediate analogue in the situation in this section.

\begin{lemma}[Hypercovering X descent sheaves]
\label{spaces-simplicial-lemma-hypercovering-X-descent-sheaves}
\source{stacks:0D8K}
\href{https://stacks.math.columbia.edu/tag/0D8K}{\texttt{Stacks tag 0D8K}}
\group{spaces-simplicial}
...
\begin{proof}
Via Remarks \ref{spaces-simplicial-remark-semi-representable-over-object} and
\ref{spaces-simplicial-remark-augmentation-over-object} and the discussion in
the introduction to this section
this follows from Lemma \ref{spaces-simplicial-lemma-hypercovering-descent-sheaves}.
\end{proof}

\begin{lemma}[Hypercovering X descent bounded abelian]
\label{spaces-simplicial-lemma-hypercovering-X-descent-bounded-abelian}
\source{stacks:0D8L}
\href{https://stacks.math.columbia.edu/tag/0D8L}{\texttt{Stacks tag 0D8L}}
\group{spaces-simplicial}
...
\begin{lemma}[Compare cohomology hypercovering X]
\label{spaces-simplicial-lemma-compare-cohomology-hypercovering-X}
\source{stacks:09X7}
\href{https://stacks.math.columbia.edu/tag/09X7}{\texttt{Stacks tag 09X7}}
\group{spaces-simplicial}
...
this follows from Lemma \ref{spaces-simplicial-lemma-compare-cohomology-hypercovering}.
\end{proof}

\begin{lemma}[Hypercovering X equivalence bounded]
\label{spaces-simplicial-lemma-hypercovering-X-equivalence-bounded}
\source{stacks:0D8M}
\href{https://stacks.math.columbia.edu/tag/0D8M}{\texttt{Stacks tag 0D8M}}
\group{spaces-simplicial}
...
Via Remarks \ref{spaces-simplicial-remark-semi-representable-over-object} and
\ref{spaces-simplicial-remark-augmentation-over-object}
this follows from Lemma \ref{spaces-simplicial-lemma-hypercovering-equivalence-bounded}.
\end{proof}
...
(\Sh(\mathcal{C}/X), \mathcal{O}_X)
$$
of Remark \ref{spaces-simplicial-remark-augmentation-ringed-over-object}.
Observe that $\mathcal{C}/X$ is a site which has equalizers
and fibre products and that $K$ is a
...
Section \ref{spaces-simplicial-section-cohomological-descent-hypercoverings-modules}.

\begin{lemma}[Hypercovering X descent modules]
\label{spaces-simplicial-lemma-hypercovering-X-descent-modules}
\source{stacks:0DA4}
\href{https://stacks.math.columbia.edu/tag/0DA4}{\texttt{Stacks tag 0DA4}}
\group{spaces-simplicial}
...
\begin{proof}
Via Remarks \ref{spaces-simplicial-remark-semi-representable-ringed-over-object} and
\ref{spaces-simplicial-remark-augmentation-ringed-over-object} and the discussion in
the introduction to this section
this follows from Lemma \ref{spaces-simplicial-lemma-hypercovering-descent-modules}.
\end{proof}

\begin{lemma}[Hypercovering X descent bounded modules]
\label{spaces-simplicial-lemma-hypercovering-X-descent-bounded-modules}
\source{stacks:0DA5}
\href{https://stacks.math.columbia.edu/tag/0DA5}{\texttt{Stacks tag 0DA5}}
\group{spaces-simplicial}
...
\begin{lemma}[Compare cohomology hypercovering X modules]
\label{spaces-simplicial-lemma-compare-cohomology-hypercovering-X-modules}
\source{stacks:0DA6}
\href{https://stacks.math.columbia.edu/tag/0DA6}{\texttt{Stacks tag 0DA6}}
\group{spaces-simplicial}
...
\ref{spaces-simplicial-remark-augmentation-ringed-over-object} and the discussion in
the introduction to this section
this follows from Lemma \ref{spaces-simplicial-lemma-compare-cohomology-hypercovering-modules}.
\end{proof}

\begin{lemma}[Hypercovering X equivalence bounded modules]
\label{spaces-simplicial-lemma-hypercovering-X-equivalence-bounded-modules}
\source{stacks:0DA7}
\href{https://stacks.math.columbia.edu/tag/0DA7}{\texttt{Stacks tag 0DA7}}
\group{spaces-simplicial}
...
\ref{spaces-simplicial-remark-augmentation-ringed-over-object} and the discussion in
the introduction to this section
this follows from Lemma \ref{spaces-simplicial-lemma-hypercovering-equivalence-bounded-modules}.
\end{proof}
...
Section \ref{spaces-simplicial-section-cohomological-descent-hypercoverings-X}
...
Remark \ref{spaces-simplicial-remark-augmentation-over-object}.
...
$$
\begin{array}{cc}V \underset{f}{\longrightarrow}\downarrow & W \downarrow \\ U_n \overset{f_\varphi}{\longrightarrow} & U_m\end{array}
$$
...
\begin{lemma}[Hypercovering X simple descent sheaves]
\label{spaces-simplicial-lemma-hypercovering-X-simple-descent-sheaves}
\source{stacks:0DA8}
\href{https://stacks.math.columbia.edu/tag/0DA8}{\texttt{Stacks tag 0DA8}}
\group{spaces-simplicial}
...
Lemma \ref{spaces-simplicial-lemma-hypercovering-X-descent-sheaves}.
\end{proof}

\begin{lemma}[Hypercovering X simple descent bounded abelian]
\label{spaces-simplicial-lemma-hypercovering-X-simple-descent-bounded-abelian}
\source{stacks:0D8N}
\href{https://stacks.math.columbia.edu/tag/0D8N}{\texttt{Stacks tag 0D8N}}
\group{spaces-simplicial}
...
\begin{proof}
This is a special case of
Lemma \ref{spaces-simplicial-lemma-hypercovering-X-descent-bounded-abelian}.
\end{proof}

\begin{lemma}[Compare cohomology hypercovering X simple]
\label{spaces-simplicial-lemma-compare-cohomology-hypercovering-X-simple}
\source{stacks:09X9}
\href{https://stacks.math.columbia.edu/tag/09X9}{\texttt{Stacks tag 09X9}}
\group{spaces-simplicial}
...
\begin{proof}
This is a special case of
Lemma \ref{spaces-simplicial-lemma-compare-cohomology-hypercovering-X}.
\end{proof}

\begin{lemma}[Hypercovering X simple equivalence bounded]
\label{spaces-simplicial-lemma-hypercovering-X-simple-equivalence-bounded}
\source{stacks:0DA9}
\href{https://stacks.math.columbia.edu/tag/0DA9}{\texttt{Stacks tag 0DA9}}
\group{spaces-simplicial}
...
\begin{proof}
This is a special case of
Lemma \ref{spaces-simplicial-lemma-hypercovering-X-equivalence-bounded}
\end{proof}

\begin{lemma}[Sr when fibre products]
\label{spaces-simplicial-lemma-sr-when-fibre-products}
\source{stacks:09WL}
\href{https://stacks.math.columbia.edu/tag/09WL}{\texttt{Stacks tag 09WL}}
\group{spaces-simplicial}
...
\item the construction of Lemma \ref{spaces-simplicial-lemma-simplicial-site-site}
...
as in Remark \ref{spaces-simplicial-remark-augmentation-site} part (A) and gives the
...
in Lemma \ref{spaces-simplicial-lemma-simplicial-site-site}
...
in Section \ref{spaces-simplicial-section-hypercovering}. In this section we study the
augmentation
$$
a :
...
Remark \ref{spaces-simplicial-remark-augmentation-ringed-over-object}.
Thus all the results in this section are immediate consequences
of the corresponding results in
Section \ref{spaces-simplicial-section-cohomological-descent-hypercoverings-X-modules}.

\begin{lemma}[Hypercovering X simple descent modules]
\label{spaces-simplicial-lemma-hypercovering-X-simple-descent-modules}
\source{stacks:0DAB}
\href{https://stacks.math.columbia.edu/tag/0DAB}{\texttt{Stacks tag 0DAB}}
\group{spaces-simplicial}
...
\begin{proof}
This is a special case of
Lemma \ref{spaces-simplicial-lemma-hypercovering-X-descent-modules}.
\end{proof}

\begin{lemma}[Hypercovering X simple descent bounded modules]
\label{spaces-simplicial-lemma-hypercovering-X-simple-descent-bounded-modules}
\source{stacks:0DAC}
\href{https://stacks.math.columbia.edu/tag/0DAC}{\texttt{Stacks tag 0DAC}}
\group{spaces-simplicial}
...
\begin{proof}
This is a special case of
Lemma \ref{spaces-simplicial-lemma-hypercovering-X-descent-bounded-modules}.
\end{proof}

\begin{lemma}[Compare cohomology hypercovering X simple modules]
\label{spaces-simplicial-lemma-compare-cohomology-hypercovering-X-simple-modules}
\source{stacks:0DAD}
\href{https://stacks.math.columbia.edu/tag/0DAD}{\texttt{Stacks tag 0DAD}}
\group{spaces-simplicial}
...
\begin{proof}
This is a special case of
Lemma \ref{spaces-simplicial-lemma-compare-cohomology-hypercovering-X-modules}.
\end{proof}

\begin{lemma}[Hypercovering X simple equivalence bounded modules]
\label{spaces-simplicial-lemma-hypercovering-X-simple-equivalence-bounded-modules}
\source{stacks:0DAE}
\href{https://stacks.math.columbia.edu/tag/0DAE}{\texttt{Stacks tag 0DAE}}
\group{spaces-simplicial}
...
\begin{proof}
This is a special case of
Lemma \ref{spaces-simplicial-lemma-hypercovering-X-equivalence-bounded-modules}.
\end{proof}
...
\begin{example}[Quasi coherent spaces etale]
\label{spaces-simplicial-example-quasi-coherent-spaces-etale}
\source{stacks:0DC5}
\href{https://stacks.math.columbia.edu/tag/0DC5}{\texttt{Stacks tag 0DC5}}
\group{spaces-simplicial}
...
\source{stacks:0DC6}
\href{https://stacks.math.columbia.edu/tag/0DC6}{\texttt{Stacks tag 0DC6}}
\group{spaces-simplicial}
...
\end{enumerate}
See Remark \ref{spaces-simplicial-remark-semi-representable-ringed} for notation and
...
$\textit{Mod}(\mathcal{O})$ as in Remark \ref{spaces-simplicial-remark-augmentation-ringed}
to have restrictions $\mathcal{F}_n$ in
$\mathcal{A}_{K_n}$ for all $n$.

\begin{lemma}[Hypercovering equivalence modules]
\label{spaces-simplicial-lemma-hypercovering-equivalence-modules}
\source{stacks:0DC7}
\href{https://stacks.math.columbia.edu/tag/0DC7}{\texttt{Stacks tag 0DC7}}
\group{spaces-simplicial}
...
bounded version
(Lemma \ref{spaces-simplicial-lemma-hypercovering-equivalence-bounded-modules}).
...
Lemma \ref{spaces-simplicial-lemma-hypercovering-descent-modules}.
...
Assumption (1) is clear (see Remark \ref{spaces-simplicial-remark-augmentation-ringed}).
...
Section \ref{spaces-simplicial-section-simplicial-semi-representable}.
...
Lemma \ref{spaces-simplicial-lemma-sanity-check-simplicial-semi-representable}
...
the material from Sections \ref{spaces-simplicial-section-glueing} and
\ref{spaces-simplicial-section-glueing-modules}. We will also reprove the
unbounded version as it is proved in \cite{six-I}.

\medskip\noindent
Advice to the reader: We suggest the reader first look at the statement of
Lemma \ref{spaces-simplicial-lemma-bbd-glueing-cech} as well as the second proof of this lemma.
...
\source{stacks:0DC9}
\href{https://stacks.math.columbia.edu/tag/0DC9}{\texttt{Stacks tag 0DC9}}
\group{spaces-simplicial}
...
\medskip\noindent
In Situation \ref{spaces-simplicial-situation-locally-given} a {\it solution}
...
\begin{lemma}[Prepare bbd glueing]
\label{spaces-simplicial-lemma-prepare-bbd-glueing}
\source{stacks:0DCA}
\href{https://stacks.math.columbia.edu/tag/0DCA}{\texttt{Stacks tag 0DCA}}
\group{spaces-simplicial}

In Situation \ref{spaces-simplicial-situation-locally-given}.
...
as in Definition \ref{spaces-simplicial-definition-cartesian-derived-modules}.
The vanishing of negative exts assumed in the lemma implies that
$\Hom(E_n[t], E_n) = 0$ for $n \geq 0$ and $t > 0$.
Thus by
Lemma \ref{spaces-simplicial-lemma-cartesian-module-derived-from-simplicial}
we obtain $E$.
Uniqueness up to unique isomorphism follows from
Lemmas \ref{spaces-simplicial-lemma-nullity-cartesian-modules-derived} and
...
\source{stacks:0DCB}
\href{https://stacks.math.columbia.edu/tag/0DCB}{\texttt{Stacks tag 0DCB}}
\group{spaces-simplicial}

In Situation \ref{spaces-simplicial-situation-locally-given}. Assume
\begin{enumerate}
...
Set $K = u(L)$. Apply Lemma \ref{spaces-simplicial-lemma-prepare-bbd-glueing}
...
By Lemma \ref{spaces-simplicial-lemma-hypercovering-equivalence-bounded-modules}
...
with the maps $\rho_a$ of Situation \ref{spaces-simplicial-situation-locally-given}
...
Lemma \ref{spaces-simplicial-lemma-prepare-bbd-glueing} gives that
$$
...
\source{stacks:0DCC}
\href{https://stacks.math.columbia.edu/tag/0DCC}{\texttt{Stacks tag 0DCC}}
\group{spaces-simplicial}
...
Lemma \ref{spaces-simplicial-lemma-bbd-glueing}. The only change is that
$E$ is an object of $D_{\mathcal{A}_{total}}(\mathcal{O})$
and hence we use Lemma \ref{spaces-simplicial-lemma-hypercovering-equivalence-modules}
to obtain $F$ with $E = a^*F$
instead of Lemma \ref{spaces-simplicial-lemma-hypercovering-equivalence-bounded-modules}.
\end{proof}

Here is an example application of the general theory above.

\begin{lemma}[Bbd glueing cech]
\label{spaces-simplicial-lemma-bbd-glueing-cech}
\source{stacks:0GMG}
\href{https://stacks.math.columbia.edu/tag/0GMG}{\texttt{Stacks tag 0GMG}}
\group{spaces-simplicial}
...
Lemma \ref{spaces-simplicial-lemma-bbd-glueing}. We urge the reader to look
...
are as in Situation \ref{spaces-simplicial-situation-locally-given}; the
isomorphisms $\rho_a$ satisfy the cocycle condition
exactly because of condition (1) in the statement of the lemma
(details omitted).

\medskip\noindent
We are going to apply Lemma \ref{spaces-simplicial-lemma-bbd-glueing} with $\mathcal{B}$,
$E_U$, $\rho_a$ as above and with $\mathcal{D} = \mathcal{C}$ and
$f : \mathcal{C} \to \mathcal{D}$ the identity morphism.
Assumptions (1) and (2)(a) of Lemma \ref{spaces-simplicial-lemma-bbd-glueing} we have seen above.
Assumption (2)(b) of Lemma \ref{spaces-simplicial-lemma-bbd-glueing} is clear.
Assumption (2)(c) of Lemma \ref{spaces-simplicial-lemma-bbd-glueing} holds because
...
with the same proof.}.
Assumption (3) of Lemma \ref{spaces-simplicial-lemma-bbd-glueing} holds
...
Assumption (4) of Lemma \ref{spaces-simplicial-lemma-bbd-glueing} holds because
...
By Lemma \ref{spaces-simplicial-lemma-construct-cartesian-objects-derived-modules}
...
we see that by Lemma \ref{spaces-simplicial-lemma-hypercovering-X-equivalence-bounded-modules}
...
\begin{lemma}[Compare simplicial objects]
\label{spaces-simplicial-lemma-compare-simplicial-objects}
\source{stacks:0DAF}
\href{https://stacks.math.columbia.edu/tag/0DAF}{\texttt{Stacks tag 0DAF}}
\group{spaces-simplicial}

Let $U$ be a simplicial object of $\textit{LC}$ and let $a : U \to X$
be an augmentation. There is a commutative diagram
$$
\begin{array}{cc}\Sh((\textit{LC}_{qc}/U)_{total}) \underset{h}{\longrightarrow}\underset{a_{qc}}{\downarrow} & \Sh(U_{Zar}) \overset{a}{\downarrow} \\ \Sh(\textit{LC}_{qc}/X) \overset{h_{-1}}{\longrightarrow} & \Sh(X)\end{array}
$$
where the left vertical arrow is defined in
Section \ref{spaces-simplicial-section-hypercovering}
and the right vertical arrow is defined in
Lemma \ref{spaces-simplicial-lemma-augmentation}.
\end{lemma}

\begin{proof}
Write $\Sh(X) = \Sh(X_{Zar})$. Observe that both
$(\textit{LC}_{qc}/U)_{total}$ and $U_{Zar}$ fall
into case A of Situation \ref{spaces-simplicial-situation-simplicial-site}.
This is immediate from the construction of
$U_{Zar}$ in Section \ref{spaces-simplicial-section-simplicial-top}
and it follows from Lemma \ref{spaces-simplicial-lemma-sr-when-fibre-products}
...
augmentations as in Remark \ref{spaces-simplicial-remark-morphism-augmentation-simplicial-sites}
and we may apply
Lemma \ref{spaces-simplicial-lemma-morphism-augmentation-simplicial-sites} to conclude.
\end{proof}

\begin{lemma}[Descent sheaves for proper hypercovering]
\label{spaces-simplicial-lemma-descent-sheaves-for-proper-hypercovering}
\source{stacks:0DAG}
\href{https://stacks.math.columbia.edu/tag/0DAG}{\texttt{Stacks tag 0DAG}}
\group{spaces-simplicial}
...
Consider the diagram of Lemma \ref{spaces-simplicial-lemma-compare-simplicial-objects}.
...
(as defined in Section \ref{spaces-simplicial-section-hypercovering}) by
Cohomology on Sites, Lemma
\ref{sites-cohomology-lemma-proper-surjective-is-qc-covering}.
By Lemma \ref{spaces-simplicial-lemma-hypercovering-X-simple-descent-sheaves}
...
(h_{-1})^{-1}
\text{Eq}(
\begin{array}{cc}a_{0, *}\mathcal{G}_0
\longrightarrow\longrightarrow & a_{1, *}\mathcal{G}_1\end{array}
) \\
& =
\text{Eq}(
\begin{array}{cc}(h_{-1})^{-1}a_{0, *}\mathcal{G}_0
\longrightarrow\longrightarrow & (h_{-1})^{-1}a_{1, *}\mathcal{G}_1\end{array}
) \\
& =
\text{Eq}(
\begin{array}{cc}a_{qc, 0, *}h_0^{-1}\mathcal{G}_0
\longrightarrow\longrightarrow & a_{qc, 1, *}h_1^{-1}\mathcal{G}_1\end{array}
) \\
& =
\text{Eq}(
\begin{array}{cc}a_{qc, 0, *}a_{qc, 0}^{-1}\mathcal{H}
\longrightarrow\longrightarrow & a_{qc, 1, *}a_{qc, 1}^{-1}\mathcal{H}\end{array}
) \\
& =
...
\mathcal{H}
\end{align*}
Here the first equality follows from Lemma \ref{spaces-simplicial-lemma-augmentation},
...
the fifth from Lemma \ref{spaces-simplicial-lemma-augmentation-site}, and the
...
\begin{lemma}[Cohomological descent for proper hypercovering]
\label{spaces-simplicial-lemma-cohomological-descent-for-proper-hypercovering}
\source{stacks:09XS}
\href{https://stacks.math.columbia.edu/tag/09XS}{\texttt{Stacks tag 09XS}}
\group{spaces-simplicial}
...
Lemma \ref{spaces-simplicial-lemma-compare-simplicial-objects}, the third equality by
Lemma \ref{spaces-simplicial-lemma-hypercovering-X-simple-descent-bounded-abelian}
...
\begin{lemma}[Compute via proper hypercovering]
\label{spaces-simplicial-lemma-compute-via-proper-hypercovering}
\source{stacks:09XC}
\href{https://stacks.math.columbia.edu/tag/09XC}{\texttt{Stacks tag 09XC}}
\group{spaces-simplicial}
...
is as in Lemma \ref{spaces-simplicial-lemma-augmentation}.
\end{lemma}

\begin{proof}
This follows from
Lemma \ref{spaces-simplicial-lemma-cohomological-descent-for-proper-hypercovering}
because $R\Gamma(U_{Zar}, -) = R\Gamma(X, -) \circ Ra_*$ by
Cohomology on Sites, Remark \ref{sites-cohomology-remark-before-Leray}.
\end{proof}

\begin{lemma}[Proper hypercovering equivalence bounded]
\label{spaces-simplicial-lemma-proper-hypercovering-equivalence-bounded}
\source{stacks:0DAH}
\href{https://stacks.math.columbia.edu/tag/0DAH}{\texttt{Stacks tag 0DAH}}
\group{spaces-simplicial}
...
The equivalence is a
formal consequence of the results obtained so far. Use
Lemmas \ref{spaces-simplicial-lemma-descent-sheaves-for-proper-hypercovering} and
\ref{spaces-simplicial-lemma-cohomological-descent-for-proper-hypercovering} and
Cohomology on Sites, Lemma \ref{sites-cohomology-lemma-equivalence-bounded}.
\end{proof}

\begin{lemma}[Spectral sequence proper hypercovering]
\label{spaces-simplicial-lemma-spectral-sequence-proper-hypercovering}
\source{stacks:09XB}
\href{https://stacks.math.columbia.edu/tag/09XB}{\texttt{Stacks tag 09XB}}
\group{spaces-simplicial}
...
\begin{proof}
Immediate consequence of Lemmas \ref{spaces-simplicial-lemma-compute-via-proper-hypercovering}
and \ref{spaces-simplicial-lemma-simplicial-sheaf-cohomology}.
\end{proof}
...
Section \ref{spaces-simplicial-section-simplicial-top} applied to the underlying
...
In Lemma \ref{spaces-simplicial-lemma-simplicial-site-site} we constructed an associated
...
from Lemma \ref{spaces-simplicial-lemma-describe-sheaves-simplicial-site} or from
Lemma \ref{spaces-simplicial-lemma-describe-sheaves-simplicial-site-site}. We will say
...
applies, see Sections \ref{spaces-simplicial-section-simplicial-sites},
...
\ref{spaces-simplicial-section-glueing}, and
...
Lemma \ref{spaces-simplicial-lemma-quasi-coherent-sheaf}.

\medskip\noindent
Let $h : X \to Y$ be a morphism of simplicial schemes. Either by
Lemma \ref{spaces-simplicial-lemma-simplicial-space-site-functorial} or by
(the proof of) Lemma \ref{spaces-simplicial-lemma-morphism-simplicial-sites}
...
Lemma \ref{spaces-simplicial-lemma-describe-functoriality} or
Lemma \ref{spaces-simplicial-lemma-morphism-simplicial-sites}.
...
Either by
Lemma \ref{spaces-simplicial-lemma-augmentation} or by
Lemma \ref{spaces-simplicial-lemma-augmentation-site}
...
$$
\begin{array}{cc}X_0 \underset{h_0}{\longrightarrow}\underset{a_0}{\downarrow} & Y_0 \overset{b_0}{\downarrow} \\ X_{-1} \overset{h_{-1}}{\longrightarrow} & Y_{-1}\end{array}
$$
...
$$
\begin{array}{cc}(\Sh(X_{Zar}), \mathcal{O}_X) \underset{h_{Zar}}{\longrightarrow}\underset{a}{\downarrow} & (\Sh(Y_{Zar}), \mathcal{O}_Y) \overset{b}{\downarrow} \\ (\Sh(X_{-1}), \mathcal{O}_{X_{-1}}) \overset{h_{-1}}{\longrightarrow} & (\Sh(Y_{-1}), \mathcal{O}_{Y_{-1}})\end{array}
$$
...
\source{stacks:0249}
\href{https://stacks.math.columbia.edu/tag/0249}{\texttt{Stacks tag 0249}}
\group{spaces-simplicial}
...
diagram
$$
\begin{array}{cc}Y_m \underset{a}{\longrightarrow}\underset{Y(\varphi)}{\downarrow} & X_m \overset{X(\varphi)}{\downarrow} \\ Y_n \overset{a}{\longrightarrow} & X_n\end{array}
$$
...
\begin{lemma}[Characterize cartesian schemes]
\label{spaces-simplicial-lemma-characterize-cartesian-schemes}
\source{stacks:07TC}
\href{https://stacks.math.columbia.edu/tag/07TC}{\texttt{Stacks tag 07TC}}
\group{spaces-simplicial}
...
can picture these maps as follows
$$
\begin{array}{cccc} & X_2 \times_{d^1_1 \circ d^2_0, X_0} V
\underset{(d^2_0)^*\varphi}{\longrightarrow} & X_2 \times_{d^1_0 \circ d^2_0, X_0} V
\searrow &  \\ X_2 \times_{d^1_0 \circ d^2_2, X_0} V
\nearrow &  &  & X_2 \times_{d^1_0 \circ d^2_1, X_0} V \\  & X_2 \times_{d^1_1 \circ d^2_2, X_0} V
\overset{(d^2_2)^*\varphi}{\nwarrow}\xlongequal{} & X_2 \times_{d^1_1 \circ d^2_1, X_0} V
\underset{(d^2_1)^*\varphi}{\nearrow} & \end{array}
$$
and the condition signifies the diagram is commutative. It is clear that
...
\begin{definition}[Fibre products simplicial scheme]
\label{spaces-simplicial-definition-fibre-products-simplicial-scheme}
\source{stacks:024A}
\href{https://stacks.math.columbia.edu/tag/024A}{\texttt{Stacks tag 024A}}
\group{spaces-simplicial}
...
\begin{lemma}[Cartesian over]
\label{spaces-simplicial-lemma-cartesian-over}
\source{stacks:024B}
\href{https://stacks.math.columbia.edu/tag/024B}{\texttt{Stacks tag 024B}}
\group{spaces-simplicial}
...
$$
\begin{array}{ccccc}V \times_S X &  & Y_1 \underset{(d^1_1, \text{pr}_1 \circ \pi_1)}{\longleftarrow}\overset{(\text{pr}_0 \circ \pi_1, d^1_0)}{\longrightarrow} &  & X \times_S V.\end{array}
$$
...
Lemma \ref{spaces-simplicial-lemma-characterize-cartesian-schemes}
...
\begin{lemma}[Cartesian equivalent descent datum]
\label{spaces-simplicial-lemma-cartesian-equivalent-descent-datum}
\source{stacks:024C}
\href{https://stacks.math.columbia.edu/tag/024C}{\texttt{Stacks tag 024C}}
\group{spaces-simplicial}
...
\end{matrix}
$$
of Lemma \ref{spaces-simplicial-lemma-cartesian-over}
is an equivalence of categories.
\end{lemma}

\begin{proof}
The functor from left to right is given in
Lemma \ref{spaces-simplicial-lemma-cartesian-over}.
...
$$
\begin{array}{cc}X' \underset{f}{\longrightarrow}\downarrow & X \downarrow \\ S' \longrightarrow & S.\end{array}
$$
...
Lemma \ref{spaces-simplicial-lemma-cartesian-equivalent-descent-datum}
...
\begin{lemma}[Pullback cartesian module]
\label{spaces-simplicial-lemma-pullback-cartesian-module}
\source{stacks:07TI}
\href{https://stacks.math.columbia.edu/tag/07TI}{\texttt{Stacks tag 07TI}}
\group{spaces-simplicial}
...
quasi-coherent, see Lemma \ref{spaces-simplicial-lemma-quasi-coherent-sheaf}.
By Lemma \ref{spaces-simplicial-lemma-describe-functoriality} we see that
...
Lemma \ref{spaces-simplicial-lemma-quasi-coherent-sheaf} again.
\end{proof}

\begin{lemma}[Pushforward cartesian module]
\label{spaces-simplicial-lemma-pushforward-cartesian-module}
\source{stacks:07TJ}
\href{https://stacks.math.columbia.edu/tag/07TJ}{\texttt{Stacks tag 07TJ}}
\group{spaces-simplicial}
...
Lemma \ref{spaces-simplicial-lemma-describe-functoriality}.
...
by Lemma \ref{spaces-simplicial-lemma-quasi-coherent-sheaf}.
...
\begin{lemma}[Adjoint functors cartesian modules]
\label{spaces-simplicial-lemma-adjoint-functors-cartesian-modules}
\source{stacks:07TK}
\href{https://stacks.math.columbia.edu/tag/07TK}{\texttt{Stacks tag 07TK}}
\group{spaces-simplicial}
...
\begin{proof}
We have seen in Lemmas \ref{spaces-simplicial-lemma-pullback-cartesian-module} and
...
\begin{lemma}[Cartesian modules with section]
\label{spaces-simplicial-lemma-cartesian-modules-with-section}
\source{stacks:07TL}
\href{https://stacks.math.columbia.edu/tag/07TL}{\texttt{Stacks tag 07TL}}
\group{spaces-simplicial}
...
Definition \ref{spaces-simplicial-definition-fibre-products-simplicial-scheme}.
...
be a pair as in Lemma \ref{spaces-simplicial-lemma-characterize-cartesian-modules}.
Set $\mathcal{G} = \sigma^*\mathcal{F}$. Consider the diagram
$$
\begin{array}{ccc}X \underset{(\sigma \circ f, 1)}{\longrightarrow}\underset{f}{\downarrow} & X \times_S X \overset{\text{pr}_0}{\downarrow}\underset{\text{pr}_1}{\longrightarrow} & X \\ S \overset{\sigma}{\longrightarrow} & X & \end{array}
$$
...
\begin{lemma}[Groupoid simplicial]
\label{spaces-simplicial-lemma-groupoid-simplicial}
\source{stacks:07TN}
\href{https://stacks.math.columbia.edu/tag/07TN}{\texttt{Stacks tag 07TN}}
\group{spaces-simplicial}
...
$$
\begin{array}{c}\text{Arrows} \times_{s, \text{Ob}, t} \text{Arrows}
\overset{\text{pr}_0}{\downarrow}\underset{c}{\downarrow}\underset{\text{pr}_1}{\downarrow} \\ \text{Arrows}
\overset{t}{\downarrow}\underset{s}{\downarrow}\overset{1, e}{\uparrow}\underset{e, 1}{\uparrow} \\ \text{Ob}
\underset{e}{\uparrow}\end{array}
$$
...
\ref{spaces-simplicial-lemma-quasi-coherent-sheaf} and
...
Definition \ref{spaces-simplicial-definition-cartesian-morphism}.

\begin{lemma}[Quasi coherent groupoid R cartesian]
\label{spaces-simplicial-lemma-quasi-coherent-groupoid-R-cartesian}
\source{stacks:07TQ}
\href{https://stacks.math.columbia.edu/tag/07TQ}{\texttt{Stacks tag 07TQ}}
\group{spaces-simplicial}
...
$$
\begin{array}{ccc}R \times_{s, U, s} R \times_{s, U, s} R
\underset{\text{pr}_{12}}{\longrightarrow}\underset{\text{pr}_{02}}{\longrightarrow}\underset{\text{pr}_{01}}{\longrightarrow}\underset{(r_0, r_1, r_2) \mapsto (r_0 \circ r_1^{-1}, r_1 \circ r_2^{-1})}{\downarrow} & R \times_{s, U, s} R
\underset{\text{pr}_1}{\longrightarrow}\underset{\text{pr}_0}{\longrightarrow}\underset{(r_0, r_1) \mapsto r_0 \circ r_1^{-1}}{\downarrow} & R \overset{t}{\downarrow} \\  &  &  \\ R \times_{s, U, t} R
\underset{\text{pr}_1}{\longrightarrow}\underset{c}{\longrightarrow}\underset{\text{pr}_0}{\longrightarrow} & R \underset{s}{\longrightarrow}\underset{t}{\longrightarrow} & U\end{array}
$$
\end{lemma}
...
degeneracies in Lemma \ref{spaces-simplicial-lemma-groupoid-simplicial}.
...
In Section \ref{spaces-simplicial-section-simplicial-descent} we saw how descent data relative to
...
\source{stacks:024E}
\href{https://stacks.math.columbia.edu/tag/024E}{\texttt{Stacks tag 024E}}
\group{spaces-simplicial}

Let $f : X \to S$ be a morphism of schemes.
Let $\pi : Y \to (X/S)_\bullet$ be a cartesian morphism of simplicial
schemes, see Definitions \ref{spaces-simplicial-definition-cartesian-morphism} and
...
\begin{lemma}[Equivalence classes points]
\label{spaces-simplicial-lemma-equivalence-classes-points}
\source{stacks:024G}
\href{https://stacks.math.columbia.edu/tag/024G}{\texttt{Stacks tag 024G}}
\group{spaces-simplicial}
...
\begin{proof}
Combine Lemma \ref{spaces-simplicial-lemma-equivalence-relation} and
Groupoids, Lemma
...
\source{stacks:024H}
\href{https://stacks.math.columbia.edu/tag/024H}{\texttt{Stacks tag 024H}}
\group{spaces-simplicial}
...
$$
\begin{array}{ccc}F_y \longrightarrow\downarrow & Y_1 \overset{d^1_0}{\longrightarrow}\overset{d^1_1}{\downarrow} & Y_0 \\ y \longrightarrow & Y_0 & \end{array}
$$
Note that $F_y$ is quasi-compact. This proves the lemma.
\end{proof}

\begin{lemma}[Descent disjoint union Artinian along fields]
\label{spaces-simplicial-lemma-descent-disjoint-union-Artinian-along-fields}
\source{stacks:024I}
\href{https://stacks.math.columbia.edu/tag/024I}{\texttt{Stacks tag 024I}}
\group{spaces-simplicial}
...
Lemma \ref{spaces-simplicial-lemma-equivalence-classes-points} above.
By Lemmas \ref{spaces-simplicial-lemma-equivalence-classes-points} and \ref{spaces-simplicial-lemma-quasi-compact}
...
$$
\begin{array}{cc}U \underset{f}{\longrightarrow}\downarrow & V \downarrow \\ X_n \overset{f_\varphi}{\longrightarrow} & X_m\end{array}
$$
...
By Lemma \ref{spaces-simplicial-lemma-morphism-simplicial-sites} applied to the morphisms
...
we obtain a commutative diagram of morphisms of ringed topoi as follows
$$
\begin{array}{cc}(\Sh(X_\etale), \mathcal{O}_X) \underset{h_\etale}{\longrightarrow}\underset{a}{\downarrow} & (\Sh(Y_\etale), \mathcal{O}_Y) \overset{b}{\downarrow} \\ (\Sh(X_{-1}), \mathcal{O}_{X_{-1}}) \overset{h_{-1}}{\longrightarrow} & (\Sh(Y_{-1}), \mathcal{O}_{Y_{-1}})\end{array}
$$

\section{Fppf hypercoverings of algebraic spaces}
\label{spaces-simplicial-section-fppf-hypercovering}
This section is the analogue of Section \ref{spaces-simplicial-section-proper-hypercovering}
...
a : U \to X
$$
See Section \ref{spaces-simplicial-section-simplicial-algebraic-spaces}.
...
\begin{lemma}[Compare simplicial objects fppf etale]
\label{spaces-simplicial-lemma-compare-simplicial-objects-fppf-etale}
\source{stacks:0DH5}
\href{https://stacks.math.columbia.edu/tag/0DH5}{\texttt{Stacks tag 0DH5}}
\group{spaces-simplicial}
...
$$
\begin{array}{cc}\Sh((\textit{Spaces}/U)_{fppf, total}) \underset{h}{\longrightarrow}\underset{a_{fppf}}{\downarrow} & \Sh(U_\etale) \overset{a}{\downarrow} \\ \Sh((\textit{Spaces}/X)_{fppf}) \overset{h_{-1}}{\longrightarrow} & \Sh(X_\etale)\end{array}
$$
where the left vertical arrow is defined in
Section \ref{spaces-simplicial-section-hypercovering}
and the right vertical arrow is defined in
Section \ref{spaces-simplicial-section-simplicial-algebraic-spaces}.
\end{lemma}
...
see discussion in Section \ref{spaces-simplicial-section-simplicial-algebraic-spaces}.

\medskip\noindent
Observe that both $(\textit{Spaces}/U)_{fppf, total}$ and
$U_{spaces, \etale}$
fall into case A of Situation \ref{spaces-simplicial-situation-simplicial-site}.
This is immediate from the construction of
$U_\etale$ in Section \ref{spaces-simplicial-section-simplicial-algebraic-spaces}
and it follows from Lemma \ref{spaces-simplicial-lemma-sr-when-fibre-products}
...
\begin{lemma}[Descent sheaves for fppf hypercovering]
\label{spaces-simplicial-lemma-descent-sheaves-for-fppf-hypercovering}
\source{stacks:0DH6}
\href{https://stacks.math.columbia.edu/tag/0DH6}{\texttt{Stacks tag 0DH6}}
\group{spaces-simplicial}
...
is as in Section \ref{spaces-simplicial-section-simplicial-algebraic-spaces}.
\end{lemma}
...
Lemma \ref{spaces-simplicial-lemma-compare-simplicial-objects-fppf-etale}.
...
as defined in Section \ref{spaces-simplicial-section-hypercovering}.
By Lemma \ref{spaces-simplicial-lemma-hypercovering-X-simple-descent-sheaves}
...
\begin{lemma}[Cohomological descent for fppf hypercovering]
\label{spaces-simplicial-lemma-cohomological-descent-for-fppf-hypercovering}
\source{stacks:0DH7}
\href{https://stacks.math.columbia.edu/tag/0DH7}{\texttt{Stacks tag 0DH7}}
\group{spaces-simplicial}
...
\begin{proof}
Consider the diagram of Lemma \ref{spaces-simplicial-lemma-compare-simplicial-objects-fppf-etale}.
Observe that $Rh_{n, *}h_n^{-1}$ is the identity functor
on $D^+(U_{n, \etale})$ by
More on Cohomology of Spaces, Lemma
...
\begin{lemma}[Compute via fppf hypercovering]
\label{spaces-simplicial-lemma-compute-via-fppf-hypercovering}
\source{stacks:0DH8}
\href{https://stacks.math.columbia.edu/tag/0DH8}{\texttt{Stacks tag 0DH8}}
\group{spaces-simplicial}
...
\begin{proof}
This follows from
Lemma \ref{spaces-simplicial-lemma-cohomological-descent-for-fppf-hypercovering}
because $R\Gamma(U_\etale, -) = R\Gamma(X_\etale, -) \circ Ra_*$ by
Cohomology on Sites, Remark \ref{sites-cohomology-remark-before-Leray}.
\end{proof}

\begin{lemma}[Fppf hypercovering equivalence bounded]
\label{spaces-simplicial-lemma-fppf-hypercovering-equivalence-bounded}
\source{stacks:0DH9}
\href{https://stacks.math.columbia.edu/tag/0DH9}{\texttt{Stacks tag 0DH9}}
\group{spaces-simplicial}
...
The equivalence is a
formal consequence of the results obtained so far. Use
Lemmas \ref{spaces-simplicial-lemma-descent-sheaves-for-fppf-hypercovering} and
\ref{spaces-simplicial-lemma-cohomological-descent-for-fppf-hypercovering} and
Cohomology on Sites, Lemma \ref{sites-cohomology-lemma-equivalence-bounded}.
\end{proof}

\begin{lemma}[Spectral sequence fppf hypercovering]
\label{spaces-simplicial-lemma-spectral-sequence-fppf-hypercovering}
\source{stacks:0DHA}
\href{https://stacks.math.columbia.edu/tag/0DHA}{\texttt{Stacks tag 0DHA}}
\group{spaces-simplicial}
...
\begin{proof}
Immediate consequence of Lemmas \ref{spaces-simplicial-lemma-compute-via-fppf-hypercovering}
and \ref{spaces-simplicial-lemma-simplicial-sheaf-cohomology-site}.
\end{proof}
...
started in Section \ref{spaces-simplicial-section-fppf-hypercovering}
...
\begin{lemma}[Compare simplicial objects fppf etale modules]
\label{spaces-simplicial-lemma-compare-simplicial-objects-fppf-etale-modules}
\source{stacks:0DHC}
\href{https://stacks.math.columbia.edu/tag/0DHC}{\texttt{Stacks tag 0DHC}}
\group{spaces-simplicial}
...
Let $a : U \to X$ be an augmentation. There is a commutative diagram
$$
\begin{array}{cc}(\Sh((\textit{Spaces}/U)_{fppf, total}), \mathcal{O}_{big, total})
\underset{h}{\longrightarrow}\underset{a_{fppf}}{\downarrow} & (\Sh(U_\etale), \mathcal{O}_U) \overset{a}{\downarrow} \\ (\Sh((\textit{Spaces}/X)_{fppf}), \mathcal{O}_{big}) \overset{h_{-1}}{\longrightarrow} & (\Sh(X_\etale), \mathcal{O}_X)\end{array}
$$
of ringed topoi where the left vertical arrow is defined in
Section \ref{spaces-simplicial-section-hypercovering-modules}
and the right vertical arrow is defined in
Section \ref{spaces-simplicial-section-simplicial-algebraic-spaces}.
\end{lemma}
...
the proof of Lemma \ref{spaces-simplicial-lemma-compare-simplicial-objects-fppf-etale}.
...
Lemma \ref{spaces-simplicial-lemma-morphism-augmentation-simplicial-sites}.}
...
by Lemma \ref{spaces-simplicial-lemma-morphism-simplicial-sites-modules}.
...
\begin{lemma}[Descent qcoh for fppf hypercovering]
\label{spaces-simplicial-lemma-descent-qcoh-for-fppf-hypercovering}
\source{stacks:0DHD}
\href{https://stacks.math.columbia.edu/tag/0DHD}{\texttt{Stacks tag 0DHD}}
\group{spaces-simplicial}
...
\begin{proof}
Consider the diagram of
Lemma \ref{spaces-simplicial-lemma-compare-simplicial-objects-fppf-etale-modules}.
In the proof of this lemma we have seen that
$h_{-1}$ is the morphism $a_X$ of
More on Cohomology of Spaces, Section
\ref{spaces-more-cohomology-section-fppf-etale-modules}.
...
Observe that $U$ is a hypercovering of $X$ in $(\textit{Spaces}/S)_{fppf}$
as defined in Section \ref{spaces-simplicial-section-hypercovering}.
By Lemma \ref{spaces-simplicial-lemma-hypercovering-X-simple-descent-modules}
...
$\QCoh(\mathcal{O}_{big, total})$ of Lemma \ref{spaces-simplicial-lemma-quasi-coherent-sheaf},
...
\begin{lemma}[Cohomological descent qcoh for fppf hypercovering]
\label{spaces-simplicial-lemma-cohomological-descent-qcoh-for-fppf-hypercovering}
\source{stacks:0DHE}
\href{https://stacks.math.columbia.edu/tag/0DHE}{\texttt{Stacks tag 0DHE}}
\group{spaces-simplicial}
...
Lemma \ref{spaces-simplicial-lemma-direct-image-morphism-simplicial-sites-modules}.
We have
\begin{align*}
Ra_*(a^*\mathcal{F})
& =
...
because of the commutativity of the diagram in
Lemma \ref{spaces-simplicial-lemma-compare-simplicial-objects}, the third equality by
Lemma \ref{spaces-simplicial-lemma-hypercovering-X-simple-descent-bounded-modules}
as $U$ is a hypercovering of $X$ in $(\textit{Spaces}/S)_{fppf}$
and $La_{fppf}^* = a_{fppf}^*$ as $a_{fppf}$ is flat
(namely $a_{fppf}^{-1}\mathcal{O}_{big} = \mathcal{O}_{big, total}$,
see Remark \ref{spaces-simplicial-remark-augmentation-ringed}), and
the last equality by the already used
More on Cohomology of Spaces, Lemma
\ref{spaces-more-cohomology-lemma-cohomological-descent-etale-fppf-modules}.
\end{proof}

\begin{lemma}[Coh descent qcoh unbounded for fppf hypercovering]
\label{spaces-simplicial-lemma-coh-descent-qcoh-unbounded-for-fppf-hypercovering}
\source{stacks:0DHF}
\href{https://stacks.math.columbia.edu/tag/0DHF}{\texttt{Stacks tag 0DHF}}
\group{spaces-simplicial}
...
See Lemma \ref{spaces-simplicial-lemma-quasi-coherent-sheaf}.
By Lemma \ref{spaces-simplicial-lemma-Serre-subcat-cartesian-modules}
...
by Lemma \ref{spaces-simplicial-lemma-flat-augmentation-modules}.

\medskip\noindent
Ad (2). This is the content of
Lemma \ref{spaces-simplicial-lemma-descent-qcoh-for-fppf-hypercovering}.

\medskip\noindent
Ad (3). This is the content of
Lemma \ref{spaces-simplicial-lemma-cohomological-descent-qcoh-for-fppf-hypercovering}.

\medskip\noindent
Ad (4). Recall that we can use either the site $U_\etale$ or
$U_{spaces, \etale}$ to define the small \'etale topos
$\Sh(U_\etale)$, see Section \ref{spaces-simplicial-section-simplicial-algebraic-spaces}.
The assumption of
Cohomology on Sites, Situation \ref{sites-cohomology-situation-olsson-laszlo}
...
$$
by Lemma \ref{spaces-simplicial-lemma-sanity-check-modules}. Here on the
...
\begin{lemma}[Compute via fppf hypercovering modules]
\label{spaces-simplicial-lemma-compute-via-fppf-hypercovering-modules}
\source{stacks:0DHG}
\href{https://stacks.math.columbia.edu/tag/0DHG}{\texttt{Stacks tag 0DHG}}
\group{spaces-simplicial}
...
\begin{proof}
This follows from
Lemma \ref{spaces-simplicial-lemma-coh-descent-qcoh-unbounded-for-fppf-hypercovering}
because $R\Gamma(U_\etale, -) = R\Gamma(X_\etale, -) \circ Ra_*$ by
Cohomology on Sites, Remark \ref{sites-cohomology-remark-before-Leray}.
\end{proof}

\begin{lemma}[Spectral sequence fppf hypercovering modules]
\label{spaces-simplicial-lemma-spectral-sequence-fppf-hypercovering-modules}
\source{stacks:0DHH}
\href{https://stacks.math.columbia.edu/tag/0DHH}{\texttt{Stacks tag 0DHH}}
\group{spaces-simplicial}
...
Lemmas \ref{spaces-simplicial-lemma-compute-via-fppf-hypercovering-modules}
and \ref{spaces-simplicial-lemma-simplicial-module-cohomology-site}.
\end{proof}
...
\begin{lemma}[Fppf neg ext zero hom]
\label{spaces-simplicial-lemma-fppf-neg-ext-zero-hom}
\source{stacks:0DL9}
\href{https://stacks.math.columbia.edu/tag/0DL9}{\texttt{Stacks tag 0DL9}}
\group{spaces-simplicial}
...
simplicial systems of the derived category of modules
(Definition \ref{spaces-simplicial-definition-cartesian-derived-modules})
associated to $La^*K$ and $La^*E$
(Lemma \ref{spaces-simplicial-lemma-cartesian-objects-derived-modules})
...
Lemma \ref{spaces-simplicial-lemma-nullity-cartesian-modules-derived}.
The image of this arrow is the kernel of the second
by Lemma \ref{spaces-simplicial-lemma-hom-cartesian-modules-derived}.
This finishes the proof of (2).
Part (1) follows by applying part (2) with
$K[i]$ and $E$ for $i > 0$.
\end{proof}

\begin{lemma}[Fppf glue neg ext zero]
\label{spaces-simplicial-lemma-fppf-glue-neg-ext-zero}
\source{stacks:0DLA}
\href{https://stacks.math.columbia.edu/tag/0DLA}{\texttt{Stacks tag 0DLA}}
\group{spaces-simplicial}
...
Lemma \ref{spaces-simplicial-lemma-construct-cartesian-objects-derived-modules}.
...
as defined in Section \ref{spaces-simplicial-section-hypercovering}. If we ever need
this, we will precisely formulate and prove this here.

\begin{lemma}[Compare simplicial objects ph etale]
\label{spaces-simplicial-lemma-compare-simplicial-objects-ph-etale}
\source{stacks:0DHJ}
\href{https://stacks.math.columbia.edu/tag/0DHJ}{\texttt{Stacks tag 0DHJ}}
\group{spaces-simplicial}
...
Let $a : U \to X$ be an augmentation. There is a commutative diagram
$$
\begin{array}{cc}\Sh((\textit{Spaces}/U)_{ph, total}) \underset{h}{\longrightarrow}\underset{a_{ph}}{\downarrow} & \Sh(U_\etale) \overset{a}{\downarrow} \\ \Sh((\textit{Spaces}/X)_{ph}) \overset{h_{-1}}{\longrightarrow} & \Sh(X_\etale)\end{array}
$$
where the left vertical arrow is defined in
Section \ref{spaces-simplicial-section-hypercovering}
and the right vertical arrow is defined in
...
topology in Section \ref{spaces-simplicial-section-fppf-hypercovering}.}.
We will use the sites $X_{spaces, \etale}$ and $U_{spaces, \etale}$
for the topoi on the right hand side; this is permissible
see discussion in Section \ref{spaces-simplicial-section-simplicial-algebraic-spaces}.
...
\begin{lemma}[Descent sheaves for ph hypercovering]
\label{spaces-simplicial-lemma-descent-sheaves-for-ph-hypercovering}
\source{stacks:0DHK}
\href{https://stacks.math.columbia.edu/tag/0DHK}{\texttt{Stacks tag 0DHK}}
\group{spaces-simplicial}
...
almost formal consequence of results already established.
Consider the diagram of
Lemma \ref{spaces-simplicial-lemma-compare-simplicial-objects-ph-etale}.
In the proof of this lemma we have seen that
$h_{-1}$ is the morphism $a_X$ of
More on Cohomology of Spaces, Section
\ref{spaces-more-cohomology-section-ph-etale}.
...
as defined in Section \ref{spaces-simplicial-section-hypercovering} since a surjective
...
(h_{-1})^{-1}
\text{Eq}(
\begin{array}{cc}a_{0, small, *}\mathcal{G}_0
\longrightarrow\longrightarrow & a_{1, small, *}\mathcal{G}_1\end{array}
) \\
& =
\text{Eq}(
\begin{array}{cc}(h_{-1})^{-1}a_{0, small, *}\mathcal{G}_0
\longrightarrow\longrightarrow & (h_{-1})^{-1}a_{1, small, *}\mathcal{G}_1\end{array}
) \\
& =
\text{Eq}(
\begin{array}{cc}a_{0, big, ph, *}h_0^{-1}\mathcal{G}_0
\longrightarrow\longrightarrow & a_{1, big, ph, *}h_1^{-1}\mathcal{G}_1\end{array}
) \\
& =
\text{Eq}(
\begin{array}{cc}a_{0, big, ph, *}(a_{0, big, ph})^{-1}\mathcal{H}
\longrightarrow\longrightarrow & a_{1, big, ph, *}(a_{1, big, ph})^{-1}\mathcal{H}\end{array}
) \\
& =
...
\mathcal{H}
\end{align*}
Here the first equality follows from Lemma \ref{spaces-simplicial-lemma-augmentation-site},
the second equality follows as $(h_{-1})^{-1}$ is an exact functor,
the third equality follows from
More on Cohomology of Spaces, Lemma
...
\begin{lemma}[Cohomological descent for ph hypercovering]
\label{spaces-simplicial-lemma-cohomological-descent-for-ph-hypercovering}
\source{stacks:0DHL}
\href{https://stacks.math.columbia.edu/tag/0DHL}{\texttt{Stacks tag 0DHL}}
\group{spaces-simplicial}
...
\begin{proof}
Consider the diagram of Lemma \ref{spaces-simplicial-lemma-compare-simplicial-objects-ph-etale}.
Observe that $Rh_{n, *}h_n^{-1}$ is the identity functor
on $D^+(U_{n, \etale})$ by
More on Cohomology of Spaces, Lemma
...
\begin{lemma}[Compute via ph hypercovering]
\label{spaces-simplicial-lemma-compute-via-ph-hypercovering}
\source{stacks:0DHM}
\href{https://stacks.math.columbia.edu/tag/0DHM}{\texttt{Stacks tag 0DHM}}
\group{spaces-simplicial}
...
\begin{proof}
This follows from
Lemma \ref{spaces-simplicial-lemma-cohomological-descent-for-ph-hypercovering}
because $R\Gamma(U_\etale, -) = R\Gamma(X_\etale, -) \circ Ra_*$ by
Cohomology on Sites, Remark \ref{sites-cohomology-remark-before-Leray}.
\end{proof}

\begin{lemma}[Ph hypercovering equivalence bounded]
\label{spaces-simplicial-lemma-ph-hypercovering-equivalence-bounded}
\source{stacks:0DHN}
\href{https://stacks.math.columbia.edu/tag/0DHN}{\texttt{Stacks tag 0DHN}}
\group{spaces-simplicial}
...
The equivalence is a
formal consequence of the results obtained so far. Use
Lemmas \ref{spaces-simplicial-lemma-descent-sheaves-for-ph-hypercovering} and
\ref{spaces-simplicial-lemma-cohomological-descent-for-ph-hypercovering} and
Cohomology on Sites, Lemma \ref{sites-cohomology-lemma-equivalence-bounded}.
\end{proof}

\begin{lemma}[Spectral sequence ph hypercovering]
\label{spaces-simplicial-lemma-spectral-sequence-ph-hypercovering}
\source{stacks:0DHP}
\href{https://stacks.math.columbia.edu/tag/0DHP}{\texttt{Stacks tag 0DHP}}
\group{spaces-simplicial}
...
\begin{proof}
Immediate consequence of Lemmas \ref{spaces-simplicial-lemma-compute-via-ph-hypercovering}
and \ref{spaces-simplicial-lemma-simplicial-sheaf-cohomology-site}.
\end{proof}
