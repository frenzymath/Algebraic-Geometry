...
\begin{lemma}[Spectral split]
\label{proetale-lemma-spectral-split}
\source{stacks:0968}
\href{https://stacks.math.columbia.edu/tag/0968}{\texttt{Stacks tag 0968}}
\group{proetale}
...
Picture
$$
\begin{array}{cc}X_0 \underset{f}{\searrow}\longrightarrow & X \overset{\pi}{\downarrow} \\  & \pi_0(X)\end{array}
$$
...
\begin{example}[Not w local]
\label{proetale-example-not-w-local}
\source{stacks:0969}
\href{https://stacks.math.columbia.edu/tag/0969}{\texttt{Stacks tag 0969}}
\group{proetale}

\uses{proetale-lemma-spectral-split}
...
Lemma \ref{proetale-lemma-spectral-split} do no imply the set of closed points
is closed.
\end{example}

It turns out it is more convenient to work with spectral
spaces which have the slightly stronger property mentioned in
the final statement of Lemma \ref{proetale-lemma-spectral-split}.
We give this property a name.

\begin{definition}[W local]
\label{proetale-definition-w-local}
\source{stacks:096A}
\href{https://stacks.math.columbia.edu/tag/096A}{\texttt{Stacks tag 096A}}
\group{proetale}
...
We have seen in the proof of Lemma \ref{proetale-lemma-spectral-split}
...
\begin{lemma}[Closed subspace w local]
\label{proetale-lemma-closed-subspace-w-local}
\source{stacks:096B}
\href{https://stacks.math.columbia.edu/tag/096B}{\texttt{Stacks tag 096B}}
\group{proetale}
...
\source{stacks:096C}
\href{https://stacks.math.columbia.edu/tag/096C}{\texttt{Stacks tag 096C}}
\group{proetale}

Let $X$ be a spectral space. Let
$$
\begin{array}{cc}Y \longrightarrow\downarrow & T \downarrow \\ X \longrightarrow & \pi_0(X)\end{array}
$$
...
by Lemma \ref{proetale-lemma-spectral-split}. Moreover, $Y_0$ is quasi-compact
...
\source{stacks:096E}
\href{https://stacks.math.columbia.edu/tag/096E}{\texttt{Stacks tag 096E}}
\group{proetale}
...
\begin{lemma}[Base change local isomorphism]
\label{proetale-lemma-base-change-local-isomorphism}
\source{stacks:096F}
\href{https://stacks.math.columbia.edu/tag/096F}{\texttt{Stacks tag 096F}}
\group{proetale}
...
\begin{lemma}[Composition local isomorphism]
\label{proetale-lemma-composition-local-isomorphism}
\source{stacks:096G}
\href{https://stacks.math.columbia.edu/tag/096G}{\texttt{Stacks tag 096G}}
\group{proetale}
...
\begin{lemma}[Local isomorphism permanence]
\label{proetale-lemma-local-isomorphism-permanence}
\source{stacks:096H}
\href{https://stacks.math.columbia.edu/tag/096H}{\texttt{Stacks tag 096H}}
\group{proetale}
...
\begin{lemma}[Local isomorphism implies]
\label{proetale-lemma-local-isomorphism-implies}
\source{stacks:096I}
\href{https://stacks.math.columbia.edu/tag/096I}{\texttt{Stacks tag 096I}}
\group{proetale}
...
\begin{lemma}[Structure local isomorphism]
\label{proetale-lemma-structure-local-isomorphism}
\source{stacks:096J}
\href{https://stacks.math.columbia.edu/tag/096J}{\texttt{Stacks tag 096J}}
\group{proetale}
...
\begin{lemma}[Fully faithful spaces over X]
\label{proetale-lemma-fully-faithful-spaces-over-X}
\source{stacks:096K}
\href{https://stacks.math.columbia.edu/tag/096K}{\texttt{Stacks tag 096K}}
\group{proetale}
...
\begin{lemma}[Local isomorphism fully faithful]
\label{proetale-lemma-local-isomorphism-fully-faithful}
\source{stacks:096L}
\href{https://stacks.math.columbia.edu/tag/096L}{\texttt{Stacks tag 096L}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-fully-faithful-spaces-over-X}

This follows from Lemma \ref{proetale-lemma-fully-faithful-spaces-over-X}
...
We start with a definition; please see Remark \ref{proetale-remark-slightly-stronger}
for a comparison with the corresponding definition of the article \cite{BS}.

\begin{definition}[Ind zariski]
\label{proetale-definition-ind-zariski}
\source{stacks:096N}
\href{https://stacks.math.columbia.edu/tag/096N}{\texttt{Stacks tag 096N}}
\group{proetale}
...
\begin{lemma}[Base change ind zariski]
\label{proetale-lemma-base-change-ind-zariski}
\source{stacks:096P}
\href{https://stacks.math.columbia.edu/tag/096P}{\texttt{Stacks tag 096P}}
\group{proetale}
...
\begin{lemma}[Composition ind zariski]
\label{proetale-lemma-composition-ind-zariski}
\source{stacks:096Q}
\href{https://stacks.math.columbia.edu/tag/096Q}{\texttt{Stacks tag 096Q}}
\group{proetale}
...
\begin{lemma}[Ind zariski permanence]
\label{proetale-lemma-ind-zariski-permanence}
\source{stacks:096R}
\href{https://stacks.math.columbia.edu/tag/096R}{\texttt{Stacks tag 096R}}
\group{proetale}
...
\begin{lemma}[Ind ind zariski]
\label{proetale-lemma-ind-ind-zariski}
\source{stacks:096S}
\href{https://stacks.math.columbia.edu/tag/096S}{\texttt{Stacks tag 096S}}
\group{proetale}
...
\begin{lemma}[Ind zariski implies]
\label{proetale-lemma-ind-zariski-implies}
\source{stacks:096T}
\href{https://stacks.math.columbia.edu/tag/096T}{\texttt{Stacks tag 096T}}
\group{proetale}
...
topological space is w-local (Definition \ref{proetale-definition-w-local}).
...
\source{stacks:096V}
\href{https://stacks.math.columbia.edu/tag/096V}{\texttt{Stacks tag 096V}}
\group{proetale}
...
\source{stacks:096Y}
\href{https://stacks.math.columbia.edu/tag/096Y}{\texttt{Stacks tag 096Y}}
\group{proetale}
...
\end{equation}
with notation as in Lemma \ref{proetale-lemma-localization}. This makes sense because
...
Lemma \ref{proetale-lemma-localization}. Using these maps collectively we obtain
...
\begin{lemma}[Make w local]
\label{proetale-lemma-make-w-local}
\source{stacks:0975}
\href{https://stacks.math.columbia.edu/tag/0975}{\texttt{Stacks tag 0975}}
\group{proetale}

\uses{proetale-definition-w-local}
...
\end{enumerate}
In particular, $X_w$ is w-local (Definition \ref{proetale-definition-w-local}).
\end{lemma}
...
\source{stacks:0976}
\href{https://stacks.math.columbia.edu/tag/0976}{\texttt{Stacks tag 0976}}
\group{proetale}

\uses{proetale-lemma-make-w-local}
Let $A$ be a ring. Let $\kappa$ be an infinite cardinal bigger or
equal than the cardinality of $A$. Then the cardinality of $A_w$
(Lemma \ref{proetale-lemma-make-w-local})
...
\source{stacks:0977}
\href{https://stacks.math.columbia.edu/tag/0977}{\texttt{Stacks tag 0977}}
\group{proetale}

\uses{proetale-lemma-make-w-local}
Let $A$ be a ring. Let $A \to A_w$ be the ring map constructed in
Lemma \ref{proetale-lemma-make-w-local}. For any ring map $A \to B$ such that
...
Lemma \ref{proetale-lemma-fully-faithful-spaces-over-X}
...
\begin{lemma}[Profinite goes up]
\label{proetale-lemma-profinite-goes-up}
\source{stacks:0978}
\href{https://stacks.math.columbia.edu/tag/0978}{\texttt{Stacks tag 0978}}
\group{proetale}
...
\begin{lemma}[Localize along closed profinite]
\label{proetale-lemma-localize-along-closed-profinite}
\source{stacks:0979}
\href{https://stacks.math.columbia.edu/tag/0979}{\texttt{Stacks tag 0979}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-make-w-local, proetale-lemma-localization, proetale-lemma-local-isomorphism-fully-faithful}
...
Topology, Lemma \ref{topology-lemma-bijective-map}.
Let $B = (A_w)_T^\sim$, see Lemma \ref{proetale-lemma-localization}.
...
Lemma \ref{proetale-lemma-local-isomorphism-fully-faithful}.
\end{proof}

\begin{lemma}[W local algebraic residue field extensions]
\label{proetale-lemma-w-local-algebraic-residue-field-extensions}
\source{stacks:097A}
\href{https://stacks.math.columbia.edu/tag/097A}{\texttt{Stacks tag 097A}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-profinite-goes-up, proetale-lemma-localize-along-closed-profinite}

By Lemma \ref{proetale-lemma-profinite-goes-up} applied to $A/I \to B/IB$
all points of $Z = V(IB) = \Spec(B/IB)$ are closed, in fact $\Spec(B/IB)$
is a profinite space.
To finish the proof we apply Lemma \ref{proetale-lemma-localize-along-closed-profinite}
to $IB \subset B$.
\end{proof}
...
(Lemma \ref{proetale-lemma-ind-zariski-implies}). The converse does not hold
...
ring maps, see Proposition \ref{proetale-proposition-maps-wich-identify-local-rings}.
...
\begin{lemma}[Construct]
\label{proetale-lemma-construct}
\source{stacks:097C}
\href{https://stacks.math.columbia.edu/tag/097C}{\texttt{Stacks tag 097C}}
\group{proetale}
...
\begin{lemma}[Construct profinite]
\label{proetale-lemma-construct-profinite}
\source{stacks:097D}
\href{https://stacks.math.columbia.edu/tag/097D}{\texttt{Stacks tag 097D}}
\group{proetale}
...
$$
\begin{array}{cc}Y \longrightarrow\downarrow & \pi_0(Y) \downarrow \\ X \longrightarrow & \pi_0(X)\end{array}
$$
...
\begin{proof}
\uses{proetale-lemma-construct, proetale-lemma-local-isomorphism-fully-faithful, proetale-lemma-ind-zariski-implies, proetale-lemma-silly}
...
and that $A \to A_i$ is a local isomorphism. By Lemma \ref{proetale-lemma-construct}
...
(Lemmas \ref{proetale-lemma-local-isomorphism-fully-faithful} and
...
\begin{array}{cc}Y \longrightarrow\downarrow & T \downarrow \\ X \longrightarrow & \pi_0(X)\end{array}
$$
of topological spaces. By Lemma \ref{proetale-lemma-silly}
we conclude that $T = \pi_0(Y)$.
\end{proof}

\begin{example}[Construct space]
\label{proetale-example-construct-space}
\source{stacks:09BJ}
\href{https://stacks.math.columbia.edu/tag/09BJ}{\texttt{Stacks tag 09BJ}}
\group{proetale}

\uses{proetale-lemma-construct-profinite}
...
Lemma \ref{proetale-lemma-construct-profinite} to $T \to \pi_0(\Spec(k)) = \{*\}$.
...
\begin{lemma}[W local morphism equal points stalks is iso]
\label{proetale-lemma-w-local-morphism-equal-points-stalks-is-iso}
\source{stacks:097E}
\href{https://stacks.math.columbia.edu/tag/097E}{\texttt{Stacks tag 097E}}
\group{proetale}
...
\begin{lemma}[W local morphism equal stalks is ind zariski]
\label{proetale-lemma-w-local-morphism-equal-stalks-is-ind-zariski}
\source{stacks:097F}
\href{https://stacks.math.columbia.edu/tag/097F}{\texttt{Stacks tag 097F}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-construct-profinite, proetale-lemma-silly, proetale-lemma-local-isomorphism-fully-faithful, proetale-lemma-ind-zariski-implies, proetale-lemma-w-local-morphism-equal-points-stalks-is-iso}
...
$$
\begin{array}{cc}X' \longrightarrow\downarrow & \pi_0(X') \downarrow \\ X \longrightarrow & \pi_0(X)\end{array}
$$
is cartesian in the category of topological spaces and such that
$\pi_0(X') = \pi_0(Y)$ as spaces over $\pi_0(X)$, see
Lemma \ref{proetale-lemma-construct-profinite}. By
Lemma \ref{proetale-lemma-silly} we see that $X'$ is w-local and
...
Lemma \ref{proetale-lemma-local-isomorphism-fully-faithful}
(and Lemma \ref{proetale-lemma-ind-zariski-implies})
...
By Lemma \ref{proetale-lemma-w-local-morphism-equal-points-stalks-is-iso}
...
\begin{proposition}[Maps wich identify local rings]
\label{proetale-proposition-maps-wich-identify-local-rings}
\source{stacks:097G}
\href{https://stacks.math.columbia.edu/tag/097G}{\texttt{Stacks tag 097G}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-make-w-local, proetale-lemma-universal, proetale-lemma-local-isomorphism-permanence, proetale-lemma-w-local-morphism-equal-stalks-is-ind-zariski, proetale-lemma-composition-ind-zariski}

Let $A \to A_w$, resp. $B \to B_w$ be the faithfully flat, ind-Zariski ring
map constructed in Lemma \ref{proetale-lemma-make-w-local} for $A$, resp.\ $B$.
Since $\Spec(B_w)$ is w-local, there exists a unique factorization
$A \to A_w \to B_w$ such that $\Spec(B_w) \to \Spec(A_w)$ is w-local
by Lemma \ref{proetale-lemma-universal}. Note that $A_w \to B_w$ identifies
local rings, see
Lemma \ref{proetale-lemma-local-isomorphism-permanence}.
By Lemma \ref{proetale-lemma-w-local-morphism-equal-stalks-is-ind-zariski}
this means $A_w \to B_w$ is ind-Zariski. Since $B \to B_w$ is
faithfully flat, ind-Zariski (Lemma \ref{proetale-lemma-make-w-local})
and the composition $A \to B \to B_w$ is ind-Zariski
(Lemma \ref{proetale-lemma-composition-ind-zariski})
...
\begin{lemma}[W local extremally disconnected]
\label{proetale-lemma-w-local-extremally-disconnected}
\source{stacks:09AZ}
\href{https://stacks.math.columbia.edu/tag/09AZ}{\texttt{Stacks tag 09AZ}}
\group{proetale}
...
\begin{proof}
\uses{proetale-proposition-maps-wich-identify-local-rings, proetale-lemma-w-local-algebraic-residue-field-extensions, proetale-lemma-construct, proetale-lemma-w-local-morphism-equal-points-stalks-is-iso, proetale-lemma-make-w-local, proetale-lemma-closed-subspace-w-local, proetale-lemma-construct-profinite}
...
Lemma \ref{proetale-lemma-w-local-algebraic-residue-field-extensions}
...
quotient ring constructed in Lemma \ref{proetale-lemma-construct}
we see that we may assume $\pi_0(\Spec(B)) \to \pi_0(\Spec(A))$
is bijective. At this point $A \to B$ is an isomorphism by
Lemma \ref{proetale-lemma-w-local-morphism-equal-points-stalks-is-iso}.

\medskip\noindent
Assume (1) or equivalently (2). Let $A \to A_w$ be the ring map constructed in
Lemma \ref{proetale-lemma-make-w-local}. By (1) there is a retraction $A_w \to A$.
Thus $\Spec(A)$ is homeomorphic to a closed subset of $\Spec(A_w)$. By
Lemma \ref{proetale-lemma-closed-subspace-w-local} we see (3)(a) holds.
...
Choose $A \to B$ as in Lemma \ref{proetale-lemma-construct-profinite}
...
\begin{lemma}[Find Zariski w contractible]
\label{proetale-lemma-find-Zariski-w-contractible}
\source{stacks:09B0}
\href{https://stacks.math.columbia.edu/tag/09B0}{\texttt{Stacks tag 09B0}}
\group{proetale}

\uses{proetale-lemma-w-local-extremally-disconnected}
Let $A$ be a ring. There exists a faithfully flat, ind-Zariski ring
map $A \to B$ such that $B$ satisfies the equivalent conditions
of Lemma \ref{proetale-lemma-w-local-extremally-disconnected}.
\end{lemma}

\begin{proof}
\uses{proetale-lemma-make-w-local, proetale-lemma-construct-profinite, proetale-lemma-silly, proetale-lemma-w-local-extremally-disconnected}

We first apply Lemma \ref{proetale-lemma-make-w-local} to see that we may assume that
$\Spec(A)$ is w-local.
Choose an extremally disconnected space $T$ and a surjective
continuous map $T \to \pi_0(\Spec(A))$, see
Topology, Lemma \ref{topology-lemma-existence-projective-cover}.
Note that $T$ is profinite. Apply Lemma \ref{proetale-lemma-construct-profinite}
to find an ind-Zariski ring map $A \to B$ such that
$\pi_0(\Spec(B)) \to \pi_0(\Spec(A))$ realizes $T \to \pi_0(\Spec(A))$
and such that
$$
\begin{array}{cc}\Spec(B) \longrightarrow\downarrow & \pi_0(\Spec(B)) \downarrow \\ \Spec(A) \longrightarrow & \pi_0(\Spec(A))\end{array}
$$
...
set of closed points of $\Spec(A)$, see Lemma \ref{proetale-lemma-silly}.
Thus condition (3) of
Lemma \ref{proetale-lemma-w-local-extremally-disconnected}
holds for $B$.
\end{proof}

\begin{remark}[Slightly stronger]
\label{proetale-remark-slightly-stronger}
\source{stacks:0A0D}
\href{https://stacks.math.columbia.edu/tag/0A0D}{\texttt{Stacks tag 0A0D}}
\group{proetale}

\uses{proetale-lemma-construct, proetale-lemma-construct-profinite, proetale-proposition-maps-wich-identify-local-rings, proetale-lemma-find-Zariski-w-contractible}
In each of Lemmas \ref{proetale-lemma-construct}, \ref{proetale-lemma-construct-profinite},
Proposition \ref{proetale-proposition-maps-wich-identify-local-rings}, and
Lemma \ref{proetale-lemma-find-Zariski-w-contractible} we find an ind-Zariski ring
...
\begin{definition}[Ind etale]
\label{proetale-definition-ind-etale}
\source{stacks:097I}
\href{https://stacks.math.columbia.edu/tag/097I}{\texttt{Stacks tag 097I}}
\group{proetale}
...
\begin{lemma}[Base change ind etale]
\label{proetale-lemma-base-change-ind-etale}
\source{stacks:097J}
\href{https://stacks.math.columbia.edu/tag/097J}{\texttt{Stacks tag 097J}}
\group{proetale}
...
\begin{lemma}[Composition ind etale]
\label{proetale-lemma-composition-ind-etale}
\source{stacks:097K}
\href{https://stacks.math.columbia.edu/tag/097K}{\texttt{Stacks tag 097K}}
\group{proetale}
...
\begin{lemma}[Ind ind etale]
\label{proetale-lemma-ind-ind-etale}
\source{stacks:097L}
\href{https://stacks.math.columbia.edu/tag/097L}{\texttt{Stacks tag 097L}}
\group{proetale}
...
\begin{lemma}[Ind etale permanence]
\label{proetale-lemma-ind-etale-permanence}
\source{stacks:097M}
\href{https://stacks.math.columbia.edu/tag/097M}{\texttt{Stacks tag 097M}}
\group{proetale}
...
\begin{lemma}[Ind etale implies]
\label{proetale-lemma-ind-etale-implies}
\source{stacks:097N}
\href{https://stacks.math.columbia.edu/tag/097N}{\texttt{Stacks tag 097N}}
\group{proetale}
...
\begin{lemma}[Lift ind etale]
\label{proetale-lemma-lift-ind-etale}
\source{stacks:097P}
\href{https://stacks.math.columbia.edu/tag/097P}{\texttt{Stacks tag 097P}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-ind-etale-permanence}
...
(Lemma \ref{proetale-lemma-ind-etale-permanence})
...
\begin{lemma}[First construction]
\label{proetale-lemma-first-construction}
\source{stacks:097R}
\href{https://stacks.math.columbia.edu/tag/097R}{\texttt{Stacks tag 097R}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-ind-ind-etale}
...
Moreover, $C$ is ind-\'etale over $A$ by Lemma \ref{proetale-lemma-ind-ind-etale}.
...
\source{stacks:097S}
\href{https://stacks.math.columbia.edu/tag/097S}{\texttt{Stacks tag 097S}}
\group{proetale}

\uses{proetale-lemma-first-construction}
Let $A$ be a ring. Let $\kappa$ be an infinite cardinal bigger or
...
ring constructed in the proof of Lemma \ref{proetale-lemma-first-construction}
has cardinality at most $\kappa$ as well.
\end{remark}

\begin{remark}[First construction functorial]
\label{proetale-remark-first-construction-functorial}
\source{stacks:097T}
\href{https://stacks.math.columbia.edu/tag/097T}{\texttt{Stacks tag 097T}}
\group{proetale}
...
$$
\begin{array}{cc}A \longrightarrow\downarrow & T(A) \downarrow \\ A' \longrightarrow & T(A')\end{array}
$$
...
$$
\begin{array}{cc}A \longrightarrow\downarrow & A[x_1, \ldots, x_n]/(f_1, \ldots, f_n) \downarrow \\ A' \longrightarrow & A'[x_1, \ldots, x_n]/(f^\varphi_1, \ldots, f^\varphi_n)\end{array}
$$
in the category of rings. For $E \subset S(A)$ finite, set
...
\begin{lemma}[Have sections quotient]
\label{proetale-lemma-have-sections-quotient}
\source{stacks:097U}
\href{https://stacks.math.columbia.edu/tag/097U}{\texttt{Stacks tag 097U}}
\group{proetale}
...
\begin{lemma}[Have sections strictly henselian]
\label{proetale-lemma-have-sections-strictly-henselian}
\source{stacks:097V}
\href{https://stacks.math.columbia.edu/tag/097V}{\texttt{Stacks tag 097V}}
\group{proetale}
...
\begin{lemma}[Have sections localize]
\label{proetale-lemma-have-sections-localize}
\source{stacks:097W}
\href{https://stacks.math.columbia.edu/tag/097W}{\texttt{Stacks tag 097W}}
\group{proetale}

\uses{proetale-lemma-localization}
Let $A$ be a ring such that every faithfully flat \'etale ring map
$A \to B$ has a retraction. Let $Z \subset \Spec(A)$ be a closed subscheme.
Let $A \to A_Z^\sim$ be as constructed in Lemma \ref{proetale-lemma-localization}.
...
\begin{lemma}[Get w local algebraic residue field extensions]
\label{proetale-lemma-get-w-local-algebraic-residue-field-extensions}
\source{stacks:097X}
\href{https://stacks.math.columbia.edu/tag/097X}{\texttt{Stacks tag 097X}}
\group{proetale}

Let $A \to B$ be a ring map inducing algebraic extensions on residue fields.
There exists a commutative diagram
$$
\begin{array}{cc}B \longrightarrow & D \\ A \longrightarrow\uparrow & C \uparrow\end{array}
$$
...
\begin{proof}
\uses{proetale-lemma-make-w-local, proetale-lemma-first-construction, proetale-lemma-have-sections-strictly-henselian, proetale-lemma-w-local-algebraic-residue-field-extensions}
...
$\Spec(A')$ maps onto $\Spec(A)$, see Lemma \ref{proetale-lemma-make-w-local}.
Let $I \subset A'$ be the ideal such that $V(I)$ is the set
of closed points of $\Spec(A')$.
Choose $A' \to C'$ as in Lemma \ref{proetale-lemma-first-construction}.
Note that the local rings $C'_{\mathfrak m'}$ at maximal ideals
$\mathfrak m' \subset C'$ are strictly henselian by
Lemma \ref{proetale-lemma-have-sections-strictly-henselian}.
We apply Lemma \ref{proetale-lemma-w-local-algebraic-residue-field-extensions}
...
\begin{proposition}[Weakly etale]
\label{proetale-proposition-weakly-etale}
\source{stacks:097Z}
\href{https://stacks.math.columbia.edu/tag/097Z}{\texttt{Stacks tag 097Z}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-get-w-local-algebraic-residue-field-extensions, proetale-proposition-maps-wich-identify-local-rings}

The ring map $A \to B$ induces (separable) algebraic extensions of
residue fields, see More on Algebra, Lemma
\ref{more-algebra-lemma-weakly-etale-residue-field-extensions}.
Thus we may apply
Lemma \ref{proetale-lemma-get-w-local-algebraic-residue-field-extensions}
...
Thus Proposition \ref{proetale-proposition-maps-wich-identify-local-rings}
...
For example, in Section \ref{proetale-section-proetale} we will see that
...
\source{stacks:0EVN}
\href{https://stacks.math.columbia.edu/tag/0EVN}{\texttt{Stacks tag 0EVN}}
\group{proetale}
...
$$
\begin{array}{cc}\Spec(W) \longrightarrow\downarrow & X \downarrow \\ \Spec(V) \overset{g}{\longrightarrow} & Y\end{array}
$$
...
\source{stacks:0EVP}
\href{https://stacks.math.columbia.edu/tag/0EVP}{\texttt{Stacks tag 0EVP}}
\group{proetale}
...
Lemma \ref{proetale-lemma-pro-V-V} we see that (1) is true.
...
Please also compare with Remark \ref{proetale-remark-h-limit-preserving}.

\begin{lemma}[H limit preserving]
\label{proetale-lemma-h-limit-preserving}
\source{stacks:0EVQ}
\href{https://stacks.math.columbia.edu/tag/0EVQ}{\texttt{Stacks tag 0EVQ}}
\group{proetale}
...
By Lemma \ref{proetale-lemma-pro-h-V} we can write $X = \lim X_i$
...
&
\text{Equalizer}(
\begin{array}{cc}F(X) \longrightarrow\longrightarrow & F(X \times_Y X)\end{array}
)
\\
& =
\text{Equalizer}(
\begin{array}{cc}\colim F(X_i) \longrightarrow\longrightarrow & \colim F(X_i \times_Y X_i)\end{array}
)
\\
& =
\colim
\text{Equalizer}(
\begin{array}{cc}F(X_i) \longrightarrow\longrightarrow & F(X_i \times_Y X_i)\end{array}
)
\\
& =
\colim F(Y) = F(Y)
...
\begin{remark}[H limit preserving]
\label{proetale-remark-h-limit-preserving}
\source{stacks:0EVR}
\href{https://stacks.math.columbia.edu/tag/0EVR}{\texttt{Stacks tag 0EVR}}
\group{proetale}

\uses{proetale-lemma-h-limit-preserving}
...
In this situation Lemma \ref{proetale-lemma-h-limit-preserving}
...
\source{stacks:0981}
\href{https://stacks.math.columbia.edu/tag/0981}{\texttt{Stacks tag 0981}}
\group{proetale}
...
We remark that by Proposition \ref{proetale-proposition-weakly-etale}
...
\begin{lemma}[W local strictly henselian extremally disconnected]
\label{proetale-lemma-w-local-strictly-henselian-extremally-disconnected}
\source{stacks:0982}
\href{https://stacks.math.columbia.edu/tag/0982}{\texttt{Stacks tag 0982}}
\group{proetale}
...
\begin{proof}
\uses{proetale-proposition-weakly-etale, proetale-lemma-w-local-algebraic-residue-field-extensions, proetale-lemma-w-local-extremally-disconnected, proetale-lemma-have-sections-strictly-henselian}
...
\begin{proposition}[Find w contractible]
\label{proetale-proposition-find-w-contractible}
\source{stacks:0983}
\href{https://stacks.math.columbia.edu/tag/0983}{\texttt{Stacks tag 0983}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-get-w-local-algebraic-residue-field-extensions, proetale-lemma-construct-profinite, proetale-lemma-silly, proetale-lemma-w-local-strictly-henselian-extremally-disconnected}

Applying Lemma \ref{proetale-lemma-get-w-local-algebraic-residue-field-extensions}
...
and such that
$$
\begin{array}{cc}\Spec(D) \longrightarrow\downarrow & \pi_0(\Spec(D)) \downarrow \\ \Spec(C) \longrightarrow & \pi_0(\Spec(C))\end{array}
$$
...
set of closed points of $\Spec(C)$, see Lemma \ref{proetale-lemma-silly}.
...
It follows from
Lemma \ref{proetale-lemma-w-local-strictly-henselian-extremally-disconnected}
that $D$ is w-contractible.
\end{proof}

\begin{remark}[Size w contractible]
\label{proetale-remark-size-w-contractible}
\source{stacks:0984}
\href{https://stacks.math.columbia.edu/tag/0984}{\texttt{Stacks tag 0984}}
\group{proetale}

\uses{proetale-proposition-find-w-contractible, proetale-lemma-get-w-local-algebraic-residue-field-extensions, proetale-remark-size-w, proetale-remark-size-T, proetale-lemma-localize-along-closed-profinite, proetale-lemma-w-local-algebraic-residue-field-extensions}
Let $A$ be a ring. Let $\kappa$ be an infinite cardinal bigger or
equal than the cardinality of $A$. Then the cardinality of the
ring $D$ constructed in Proposition \ref{proetale-proposition-find-w-contractible}
is at most
$$
\kappa^{2^{2^{2^\kappa}}}.
$$
...
Remark \ref{proetale-remark-size-w}.
We have $|C'| \leq \kappa$ by
Remark \ref{proetale-remark-size-T}.
Then $|C| \leq \kappa$ because $C$ is a localization of $(C')_w$
(it is constructed from $C'$ by an application of
Lemma \ref{proetale-lemma-localize-along-closed-profinite}
in the proof of Lemma \ref{proetale-lemma-w-local-algebraic-residue-field-extensions}).
...
\begin{lemma}[Finite finitely presented over extremally disconnected]
\label{proetale-lemma-finite-finitely-presented-over-extremally-disconnected}
\source{stacks:0985}
\href{https://stacks.math.columbia.edu/tag/0985}{\texttt{Stacks tag 0985}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-profinite-goes-up}
...
$$
\begin{array}{cc}\coprod_{i = 1, \ldots, r} X' \longrightarrow\downarrow & Y \downarrow \\ X' \longrightarrow & X\end{array}
$$
...
(Lemma \ref{proetale-lemma-profinite-goes-up}), the continuous map
...
\begin{lemma}[Finite finitely presented over w contractible]
\label{proetale-lemma-finite-finitely-presented-over-w-contractible}
\source{stacks:0986}
\href{https://stacks.math.columbia.edu/tag/0986}{\texttt{Stacks tag 0986}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-w-local-strictly-henselian-extremally-disconnected, proetale-lemma-finite-finitely-presented-over-extremally-disconnected}
...
Lemma \ref{proetale-lemma-finite-finitely-presented-over-extremally-disconnected}.
\end{proof}

\begin{lemma}[Localization w contractible]
\label{proetale-lemma-localization-w-contractible}
\source{stacks:0987}
\href{https://stacks.math.columbia.edu/tag/0987}{\texttt{Stacks tag 0987}}
\group{proetale}

\uses{proetale-lemma-localization}
Let $A$ be a ring. Let $Z \subset \Spec(A)$ be a closed subset
of the form $Z = V(f_1, \ldots, f_r)$. Set $B = A_Z^\sim$, see
Lemma \ref{proetale-lemma-localization}. If $A$ is w-contractible, so is $B$.
\end{lemma}
...
our underlying category of schemes, see Section \ref{proetale-section-change-universe}.
...
in Section \ref{proetale-section-V-versus-pro-h} starting with $\tau = \etale$.}
with the definition that follows.

\begin{definition}[Fpqc covering]
\label{proetale-definition-fpqc-covering}
\source{stacks:0989}
\href{https://stacks.math.columbia.edu/tag/0989}{\texttt{Stacks tag 0989}}
\group{proetale}
...
\begin{lemma}[Recognize proetale covering]
\label{proetale-lemma-recognize-proetale-covering}
\source{stacks:098A}
\href{https://stacks.math.columbia.edu/tag/098A}{\texttt{Stacks tag 098A}}
\group{proetale}
...
\begin{lemma}[Etale proetale]
\label{proetale-lemma-etale-proetale}
\source{stacks:098B}
\href{https://stacks.math.columbia.edu/tag/098B}{\texttt{Stacks tag 098B}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-recognize-proetale-covering}
...
Lemma \ref{proetale-lemma-recognize-proetale-covering}, and
...
\begin{lemma}[Proetale]
\label{proetale-lemma-proetale}
\source{stacks:098C}
\href{https://stacks.math.columbia.edu/tag/098C}{\texttt{Stacks tag 098C}}
\group{proetale}
...
\begin{lemma}[Proetale affine]
\label{proetale-lemma-proetale-affine}
\source{stacks:098D}
\href{https://stacks.math.columbia.edu/tag/098D}{\texttt{Stacks tag 098D}}
\group{proetale}
...
\begin{definition}[Standard proetale]
\label{proetale-definition-standard-proetale}
\source{stacks:098E}
\href{https://stacks.math.columbia.edu/tag/098E}{\texttt{Stacks tag 098E}}
\group{proetale}
...
\begin{definition}[Big proetale site]
\label{proetale-definition-big-proetale-site}
\source{stacks:098G}
\href{https://stacks.math.columbia.edu/tag/098G}{\texttt{Stacks tag 098G}}
\group{proetale}
...
\medskip\noindent
It will turn out, see Lemma \ref{proetale-lemma-proetale-induced}, that the
...
\begin{definition}[Big small proetale]
\label{proetale-definition-big-small-proetale}
\source{stacks:098K}
\href{https://stacks.math.columbia.edu/tag/098K}{\texttt{Stacks tag 098K}}
\group{proetale}
...
\begin{lemma}[Verify site proetale]
\label{proetale-lemma-verify-site-proetale}
\source{stacks:098L}
\href{https://stacks.math.columbia.edu/tag/098L}{\texttt{Stacks tag 098L}}
\group{proetale}
...
Sites, Definition \ref{sites-definition-site}.
This follows from Lemma \ref{proetale-lemma-recognize-proetale-covering}
and the corresponding result for standard fpqc coverings
(Topologies, Lemma \ref{topologies-lemma-fpqc-affine-axioms}).
\end{proof}

\begin{lemma}[Fibre products proetale]
\label{proetale-lemma-fibre-products-proetale}
\source{stacks:098M}
\href{https://stacks.math.columbia.edu/tag/098M}{\texttt{Stacks tag 098M}}
\group{proetale}
...
\begin{lemma}[Affine big site proetale]
\label{proetale-lemma-affine-big-site-proetale}
\source{stacks:098N}
\href{https://stacks.math.columbia.edu/tag/098N}{\texttt{Stacks tag 098N}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-proetale-affine}
...
Lemma \ref{proetale-lemma-proetale-affine}.
...
\source{stacks:098P}
\href{https://stacks.math.columbia.edu/tag/098P}{\texttt{Stacks tag 098P}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-fibre-products-proetale}
...
Lemma \ref{proetale-lemma-fibre-products-proetale}.
Moreover, $T_\proetale$ has equalizers and $u$ commutes with them
by Lemma \ref{proetale-lemma-fibre-products-proetale}.
...
\source{stacks:098Q}
\href{https://stacks.math.columbia.edu/tag/098Q}{\texttt{Stacks tag 098Q}}
\group{proetale}

\uses{proetale-lemma-put-in-T}
Let $S$ be a scheme. Let $\Sch_\proetale$ be a big pro-\'etale
site containing $S$.
...
with $i_{\text{id}_S}$ as in Lemma \ref{proetale-lemma-put-in-T}. In particular the
...
Lemma \ref{proetale-lemma-put-in-T} above, also is fully faithful
and transforms the final object into the final object.
The lemma follows from Sites, Lemma \ref{sites-lemma-bigger-site}.
\end{proof}

\begin{definition}[Restriction small proetale]
\label{proetale-definition-restriction-small-proetale}
\source{stacks:098R}
\href{https://stacks.math.columbia.edu/tag/098R}{\texttt{Stacks tag 098R}}
\group{proetale}

\uses{proetale-lemma-at-the-bottom}
In the situation of
Lemma \ref{proetale-lemma-at-the-bottom}
...
\source{stacks:098S}
\href{https://stacks.math.columbia.edu/tag/098S}{\texttt{Stacks tag 098S}}
\group{proetale}
...
Lemma \ref{proetale-lemma-put-in-T}). Hence
...
\source{stacks:098T}
\href{https://stacks.math.columbia.edu/tag/098T}{\texttt{Stacks tag 098T}}
\group{proetale}

\uses{proetale-lemma-put-in-T, proetale-lemma-at-the-bottom}
Let $\Sch_\proetale$ be a big pro-\'etale site.
Let $f : T \to S$ be a morphism in $\Sch_\proetale$.
\begin{enumerate}
\item We have $i_f = f_{big} \circ i_T$ with $i_f$ as in
Lemma \ref{proetale-lemma-put-in-T} and $i_T$ as in
Lemma \ref{proetale-lemma-at-the-bottom}.
...
$$
\begin{array}{cc}T_\proetale \underset{f_{small}}{\downarrow} & (\Sch/T)_\proetale \overset{f_{big}}{\downarrow}\overset{\pi_T}{\longleftarrow} \\ S_\proetale & (\Sch/S)_\proetale \underset{\pi_S}{\longleftarrow}\end{array}
$$
...
\begin{proof}
\uses{proetale-lemma-proetale, proetale-lemma-fibre-products-proetale}
...
see Lemmas \ref{proetale-lemma-proetale} and \ref{proetale-lemma-fibre-products-proetale}.
...
Definition \ref{proetale-definition-restriction-small-proetale}
...
\begin{lemma}[Composition proetale]
\label{proetale-lemma-composition-proetale}
\source{stacks:098U}
\href{https://stacks.math.columbia.edu/tag/098U}{\texttt{Stacks tag 098U}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-put-in-T, proetale-lemma-morphism-big}
...
(use Lemmas \ref{proetale-lemma-put-in-T} and \ref{proetale-lemma-morphism-big}).
...
\source{stacks:098V}
\href{https://stacks.math.columbia.edu/tag/098V}{\texttt{Stacks tag 098V}}
\group{proetale}
...
\source{stacks:098W}
\href{https://stacks.math.columbia.edu/tag/098W}{\texttt{Stacks tag 098W}}
\group{proetale}

\uses{proetale-definition-standard-proetale}
...
Definition \ref{proetale-definition-standard-proetale}.
Then restriction
$$
...
\begin{lemma}[Affine alternative]
\label{proetale-lemma-affine-alternative}
\source{stacks:098X}
\href{https://stacks.math.columbia.edu/tag/098X}{\texttt{Stacks tag 098X}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-alternative, proetale-proposition-weakly-etale}

By Lemma \ref{proetale-lemma-alternative} we may replace $S_\proetale$ by
$S_{affine, \proetale}$.
...
\begin{lemma}[Proetale subcanonical]
\label{proetale-lemma-proetale-subcanonical}
\source{stacks:098Z}
\href{https://stacks.math.columbia.edu/tag/098Z}{\texttt{Stacks tag 098Z}}
\group{proetale}
...
Combine Lemma \ref{proetale-lemma-recognize-proetale-covering} and
...
Lemma \ref{proetale-lemma-get-many-weakly-contractible} is the reason for
the shape of the function $Bound$ in
Definition \ref{proetale-definition-big-proetale-site} (although
...
\begin{lemma}[W contractible proetale cover]
\label{proetale-lemma-w-contractible-proetale-cover}
\source{stacks:098F}
\href{https://stacks.math.columbia.edu/tag/098F}{\texttt{Stacks tag 098F}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-proetale-affine, proetale-definition-w-contractible}

Assume $A$ is w-contractible. By Lemma \ref{proetale-lemma-proetale-affine}
...
of affine schemes. Hence by Definition \ref{proetale-definition-w-contractible}
...
\begin{lemma}[W contractible is weakly contractible]
\label{proetale-lemma-w-contractible-is-weakly-contractible}
\source{stacks:098H}
\href{https://stacks.math.columbia.edu/tag/098H}{\texttt{Stacks tag 098H}}
\group{proetale}

\uses{proetale-definition-big-proetale-site}
Let $\Sch_\proetale$ be a big pro-\'etale site as in
Definition \ref{proetale-definition-big-proetale-site}.
...
\begin{proof}
\uses{proetale-lemma-w-contractible-proetale-cover, proetale-lemma-etale-proetale, proetale-proposition-find-w-contractible, proetale-remark-size-w-contractible, proetale-definition-big-proetale-site, proetale-lemma-proetale-subcanonical}

We have seen the equivalence of (1) and (3) in
Lemma \ref{proetale-lemma-w-contractible-proetale-cover}.
...
(Lemma \ref{proetale-lemma-etale-proetale}) we conclude that
...
by Remark \ref{proetale-remark-size-w-contractible}
combined with our choice of the function
$Bound$ in Definition \ref{proetale-definition-big-proetale-site}
...
(Lemma \ref{proetale-lemma-proetale-subcanonical})
...
\begin{lemma}[Get many weakly contractible]
\label{proetale-lemma-get-many-weakly-contractible}
\source{stacks:098I}
\href{https://stacks.math.columbia.edu/tag/098I}{\texttt{Stacks tag 098I}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-w-contractible-is-weakly-contractible, proetale-proposition-find-w-contractible, proetale-definition-big-proetale-site, proetale-remark-size-w-contractible}

For those readers who do not care about set-theoretical issues
this lemma is a trivial consequence of
Lemma \ref{proetale-lemma-w-contractible-is-weakly-contractible} and
Proposition \ref{proetale-proposition-find-w-contractible}.
...
of $\Sch_\proetale$ in Definition \ref{proetale-definition-big-proetale-site}
...
Definition \ref{proetale-definition-big-proetale-site} we win.
\end{proof}

\begin{lemma}[Proetale enough w contractible]
\label{proetale-lemma-proetale-enough-w-contractible}
\source{stacks:0990}
\href{https://stacks.math.columbia.edu/tag/0990}{\texttt{Stacks tag 0990}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-get-many-weakly-contractible}

Follows immediately from Lemma \ref{proetale-lemma-get-many-weakly-contractible}.
\end{proof}

\begin{lemma}[Weakly contractible cover]
\label{proetale-lemma-weakly-contractible-cover}
\source{stacks:0F4P}
\href{https://stacks.math.columbia.edu/tag/0F4P}{\texttt{Stacks tag 0F4P}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-get-many-weakly-contractible, proetale-lemma-recognize-proetale-covering}
...
weakly contractible as in Lemma \ref{proetale-lemma-get-many-weakly-contractible}.
...
Lemma \ref{proetale-lemma-recognize-proetale-covering}).
...
Lemma \ref{proetale-lemma-get-many-weakly-contractible}
...
the proof of Lemma \ref{proetale-lemma-get-many-weakly-contractible}
...
The results of Section \ref{proetale-section-weakly-contractible}
leads to the existence of hypercoverings made up out weakly
contractible objects.

\begin{lemma}[W contractible hypercovering]
\label{proetale-lemma-w-contractible-hypercovering}
\source{stacks:09A1}
\href{https://stacks.math.columbia.edu/tag/09A1}{\texttt{Stacks tag 09A1}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-weakly-contractible-cover, proetale-lemma-get-many-weakly-contractible}
...
Lemma \ref{proetale-lemma-weakly-contractible-cover}.
...
\begin{lemma}[Compute cohomology]
\label{proetale-lemma-compute-cohomology}
\source{stacks:09A2}
\href{https://stacks.math.columbia.edu/tag/09A2}{\texttt{Stacks tag 09A2}}
\group{proetale}
...
\begin{lemma}[Quasi compact quasi separated commutes direct sums]
\label{proetale-lemma-quasi-compact-quasi-separated-commutes-direct-sums}
\source{stacks:09A3}
\href{https://stacks.math.columbia.edu/tag/09A3}{\texttt{Stacks tag 09A3}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-w-contractible-hypercovering, proetale-lemma-compute-cohomology}
...
Lemma \ref{proetale-lemma-w-contractible-hypercovering}.
...
By Lemma \ref{proetale-lemma-compute-cohomology} we have
$$
...
\begin{remark}[Extend to all]
\label{proetale-remark-extend-to-all}
\source{stacks:09A4}
\href{https://stacks.math.columbia.edu/tag/09A4}{\texttt{Stacks tag 09A4}}
\group{proetale}
...
\begin{lemma}[Enough compact proetale]
\label{proetale-lemma-enough-compact-proetale}
\source{stacks:0F4Q}
\href{https://stacks.math.columbia.edu/tag/0F4Q}{\texttt{Stacks tag 0F4Q}}
\group{proetale}
...
as in Lemma \ref{proetale-lemma-get-many-weakly-contractible}.
...
\begin{lemma}[Presheaf value weakly contractible]
\label{proetale-lemma-presheaf-value-weakly-contractible}
\source{stacks:0F63}
\href{https://stacks.math.columbia.edu/tag/0F63}{\texttt{Stacks tag 0F63}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-w-contractible-is-weakly-contractible}
...
Lemma \ref{proetale-lemma-w-contractible-is-weakly-contractible}.
...
\begin{lemma}[Small pullback weakly contractible]
\label{proetale-lemma-small-pullback-weakly-contractible}
\source{stacks:0F64}
\href{https://stacks.math.columbia.edu/tag/0F64}{\texttt{Stacks tag 0F64}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-presheaf-value-weakly-contractible}
...
Lemma \ref{proetale-lemma-presheaf-value-weakly-contractible}
...
\source{stacks:0F65}
\href{https://stacks.math.columbia.edu/tag/0F65}{\texttt{Stacks tag 0F65}}
\group{proetale}
...
\pi_S : (\Sch/S)_\proetale \longrightarrow S_\proetale
$$
of Lemma \ref{proetale-lemma-at-the-bottom}. Let $\mathcal{F}$ be a sheaf on
...
\begin{proof}
\uses{proetale-lemma-put-in-T, proetale-lemma-weakly-contractible-cover, proetale-lemma-small-pullback-weakly-contractible}

Observe that we have a morphism
$i_f : \Sh(T_\proetale) \to \Sh(\Sch/S)_\proetale)$
such that $\pi_S \circ i_f = f_{small}$ as morphisms
$T_\proetale \to S_\proetale$, see Lemma \ref{proetale-lemma-put-in-T}.
...
Lemma \ref{proetale-lemma-weakly-contractible-cover}. By
Lemma \ref{proetale-lemma-small-pullback-weakly-contractible}
...
of Lemma \ref{proetale-lemma-at-the-bottom}.

\begin{lemma}[Compare injectives]
\label{proetale-lemma-compare-injectives}
\source{stacks:0F67}
\href{https://stacks.math.columbia.edu/tag/0F67}{\texttt{Stacks tag 0F67}}
\group{proetale}
...
Lemma \ref{proetale-lemma-put-in-T} and its proof. Hence we obtain $i_{f, !}$ by
...
\source{stacks:0F68}
\href{https://stacks.math.columbia.edu/tag/0F68}{\texttt{Stacks tag 0F68}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-compare-injectives, proetale-lemma-morphism-big-small-cartesian-diagram}

The first equality follows from Lemma \ref{proetale-lemma-compare-injectives}
and (\ref{equation-compare-big-small})
on choosing a K-injective complex of abelian sheaves representing $K$.
The second equality follows from Lemma \ref{proetale-lemma-compare-injectives}
and Lemma
...
and Lemma \ref{proetale-lemma-morphism-big-small-cartesian-diagram}
on choosing a K-injective complex of abelian sheaves representing $K$.
\end{proof}
...
\source{stacks:0F69}
\href{https://stacks.math.columbia.edu/tag/0F69}{\texttt{Stacks tag 0F69}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-compare-injectives}

To prove the last equality represent $M$
by a K-injective complex of abelian sheaves
and apply Lemma \ref{proetale-lemma-compare-injectives}
...
\begin{lemma}[Cohomological descent proetale]
\label{proetale-lemma-cohomological-descent-proetale}
\source{stacks:0F6A}
\href{https://stacks.math.columbia.edu/tag/0F6A}{\texttt{Stacks tag 0F6A}}
\group{proetale}
...
\begin{lemma}[Points proetale]
\label{proetale-lemma-points-proetale}
\source{stacks:0992}
\href{https://stacks.math.columbia.edu/tag/0992}{\texttt{Stacks tag 0992}}
\group{proetale}
...
$$
\begin{array}{cc}\Spec(k) \underset{\overline{u}}{\longrightarrow}\underset{\overline{s}}{\searrow} & U \downarrow \\  & S\end{array}
$$
...
\source{stacks:0F6B}
\href{https://stacks.math.columbia.edu/tag/0F6B}{\texttt{Stacks tag 0F6B}}
\group{proetale}
...
\source{stacks:0F6C}
\href{https://stacks.math.columbia.edu/tag/0F6C}{\texttt{Stacks tag 0F6C}}
\group{proetale}
...
\begin{lemma}[Classical point]
\label{proetale-lemma-classical-point}
\source{stacks:0993}
\href{https://stacks.math.columbia.edu/tag/0993}{\texttt{Stacks tag 0993}}
\group{proetale}
...
Example \ref{proetale-example-functions-mod-locally-constant-functions}.
...
Lemma \ref{proetale-lemma-proetale-enough-w-contractible}.
...
Definition \ref{proetale-definition-big-proetale-site}. Then let $\Sch_\etale$
...
Definition \ref{proetale-definition-big-small-proetale} and
...
\begin{lemma}[Describe pullback from etale]
\label{proetale-lemma-describe-pullback-from-etale}
\source{stacks:0GLZ}
\href{https://stacks.math.columbia.edu/tag/0GLZ}{\texttt{Stacks tag 0GLZ}}
\group{proetale}
...
By Lemma \ref{proetale-lemma-recognize-proetale-covering} any pro-\'etale covering
...
\source{stacks:099T}
\href{https://stacks.math.columbia.edu/tag/099T}{\texttt{Stacks tag 099T}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-describe-pullback-from-etale}

Follows immediately from the description of
$\epsilon^{-1}$ in Lemma \ref{proetale-lemma-describe-pullback-from-etale}.
\end{proof}

\begin{lemma}[Limit pullback]
\label{proetale-lemma-limit-pullback}
\source{stacks:099S}
\href{https://stacks.math.columbia.edu/tag/099S}{\texttt{Stacks tag 099S}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-describe-pullback-from-etale, proetale-lemma-fully-faithful}

By the description of $\epsilon^{-1}\mathcal{F}$ in
Lemma \ref{proetale-lemma-describe-pullback-from-etale}, the displayed formula
...
and Lemma \ref{proetale-lemma-fully-faithful}.
\end{proof}

\begin{lemma}[Affine vanishing]
\label{proetale-lemma-affine-vanishing}
\source{stacks:099U}
\href{https://stacks.math.columbia.edu/tag/099U}{\texttt{Stacks tag 099U}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-composition-ind-etale, proetale-lemma-base-change-ind-etale, proetale-lemma-proetale-affine, proetale-proposition-weakly-etale, proetale-lemma-limit-pullback, proetale-lemma-fully-faithful}
...
Lemmas \ref{proetale-lemma-composition-ind-etale},
\ref{proetale-lemma-base-change-ind-etale}, and
\ref{proetale-lemma-proetale-affine} and
Proposition \ref{proetale-proposition-weakly-etale}.
...
commute with fibred products. Hence by Lemma \ref{proetale-lemma-limit-pullback}
...
$$
the final equality by Lemma \ref{proetale-lemma-fully-faithful}.
...
\begin{lemma}[Relative comparison]
\label{proetale-lemma-relative-comparison}
\source{stacks:099V}
\href{https://stacks.math.columbia.edu/tag/099V}{\texttt{Stacks tag 099V}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-affine-vanishing, proetale-lemma-fully-faithful}
...
By Lemma \ref{proetale-lemma-affine-vanishing} we see that this is zero for $q > 0$
...
By Lemma \ref{proetale-lemma-fully-faithful} we conclude that
...
\source{stacks:099W}
\href{https://stacks.math.columbia.edu/tag/099W}{\texttt{Stacks tag 099W}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-relative-comparison}

Immediate consequence of Lemma \ref{proetale-lemma-relative-comparison} and
the Leray spectral sequence (Cohomology on Sites, Lemma
\ref{sites-cohomology-lemma-apply-Leray}).
\end{proof}

\begin{lemma}[Compare cohomology nonabelian]
\label{proetale-lemma-compare-cohomology-nonabelian}
\source{stacks:099X}
\href{https://stacks.math.columbia.edu/tag/099X}{\texttt{Stacks tag 099X}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-fully-faithful, proetale-proposition-weakly-etale, proetale-lemma-proetale-affine, proetale-lemma-limit-pullback}

Since the functor $\epsilon^{-1}$ is fully faithful by
Lemma \ref{proetale-lemma-fully-faithful}
...
nonempty. We can do this by Proposition \ref{proetale-proposition-weakly-etale}
and the fact that
standard pro-\'etale coverings of $X$ are cofinal among all pro-\'etale
coverings of $X$ (Lemma \ref{proetale-lemma-proetale-affine}).
...
Lemma \ref{proetale-lemma-limit-pullback}
we have
$$
...
\begin{lemma}[Compare derived]
\label{proetale-lemma-compare-derived}
\source{stacks:09B1}
\href{https://stacks.math.columbia.edu/tag/09B1}{\texttt{Stacks tag 09B1}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-fully-faithful, proetale-lemma-relative-comparison}

To prove (1) we will prove conditions (1) -- (4) of
Homology, Lemma \ref{homology-lemma-characterize-weak-serre-subcategory}.
Since $\epsilon^{-1}$ is fully faithful (Lemma \ref{proetale-lemma-fully-faithful})
...
$$
which by Lemma \ref{proetale-lemma-relative-comparison}
...
\begin{lemma}[Compare locally constant]
\label{proetale-lemma-compare-locally-constant}
\source{stacks:099Y}
\href{https://stacks.math.columbia.edu/tag/099Y}{\texttt{Stacks tag 099Y}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-compare-cohomology-nonabelian}
...
\begin{proof}
\uses{proetale-lemma-compare-derived, proetale-lemma-compare-locally-constant}
...
Lemmas \ref{proetale-lemma-compare-derived} and
\ref{proetale-lemma-compare-locally-constant}.
\end{proof}

\begin{lemma}[Compare truncations]
\label{proetale-lemma-compare-truncations}
\source{stacks:09B2}
\href{https://stacks.math.columbia.edu/tag/09B2}{\texttt{Stacks tag 09B2}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-compare-derived}
...
$$
and the fact proven in Lemma \ref{proetale-lemma-compare-derived}
that the essential image of $\epsilon^{-1}$ is a triangulated
subcategory of $D^+(X_\proetale, \Lambda/I^n)$.
\end{proof}

\begin{example}[Functions mod locally constant functions]
\label{proetale-example-functions-mod-locally-constant-functions}
\source{stacks:0F6D}
\href{https://stacks.math.columbia.edu/tag/0F6D}{\texttt{Stacks tag 0F6D}}
\group{proetale}

\uses{proetale-lemma-compare-cohomology}
...
$$
by Lemma \ref{proetale-lemma-compare-cohomology} and
\'Etale Cohomology, Lemma
...
\begin{lemma}[Naive completion]
\label{proetale-lemma-naive-completion}
\source{stacks:099M}
\href{https://stacks.math.columbia.edu/tag/099M}{\texttt{Stacks tag 099M}}
\group{proetale}
...
\begin{lemma}[Pushforward Noetherian case]
\label{proetale-lemma-pushforward-Noetherian-case}
\source{stacks:099N}
\href{https://stacks.math.columbia.edu/tag/099N}{\texttt{Stacks tag 099N}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-naive-completion}
...
$$
the first equality by Lemma \ref{proetale-lemma-naive-completion}
and the second because $Rf_*$ commutes with $R\lim$
(Cohomology on Sites, Lemma
\ref{sites-cohomology-lemma-Rf-commutes-with-Rlim}). This proves (4).
To prove (5), by Lemma \ref{proetale-lemma-naive-completion} we have
$$
Lf_{comp}^*M =
...
\source{stacks:099Q}
\href{https://stacks.math.columbia.edu/tag/099Q}{\texttt{Stacks tag 099Q}}
\group{proetale}
...
Lemma \ref{proetale-lemma-naive-completion}
and
Cohomology on Sites, Lemma \ref{sites-cohomology-lemma-bounded}
...
The second equality by Lemma \ref{proetale-lemma-compare-cohomology}.
...
\begin{lemma}[More general point]
\label{proetale-lemma-more-general-point}
\source{stacks:09B4}
\href{https://stacks.math.columbia.edu/tag/09B4}{\texttt{Stacks tag 09B4}}
\group{proetale}
...
$$
\begin{array}{cc}X_\proetale \underset{\epsilon}{\longrightarrow}\underset{f_\proetale}{\downarrow} & X_\etale \overset{f_\etale}{\downarrow} \\ Y_\proetale \overset{\epsilon}{\longrightarrow} & Y_\etale\end{array}
$$
where $\epsilon$ is as in Section \ref{proetale-section-comparison}.
In particular we have
$\epsilon^{-1} f_\etale^{-1} = f_\proetale^{-1} \epsilon^{-1}$.
Here is the corresponding result for pushforward.

\begin{lemma}[Morphism comparison]
\label{proetale-lemma-morphism-comparison}
\source{stacks:09A6}
\href{https://stacks.math.columbia.edu/tag/09A6}{\texttt{Stacks tag 09A6}}
\group{proetale}
...
\begin{proof}
\uses{proetale-proposition-weakly-etale, proetale-lemma-limit-pullback, proetale-lemma-describe-pullback-from-etale}
...
$$
See Lemma \ref{proetale-lemma-limit-pullback} for the left hand side.
By Lemma \ref{proetale-lemma-describe-pullback-from-etale} we have
$$
\Gamma(X \times_Y V, \epsilon^*\mathcal{F}) =
...
\source{stacks:09A8}
\href{https://stacks.math.columbia.edu/tag/09A8}{\texttt{Stacks tag 09A8}}
\group{proetale}
...
\begin{proof}
\uses{proetale-proposition-find-w-contractible, proetale-lemma-finite-finitely-presented-over-w-contractible}
...
by Lemma \ref{proetale-lemma-finite-finitely-presented-over-w-contractible}
...
\begin{lemma}[Closed immersion affines]
\label{proetale-lemma-closed-immersion-affines}
\source{stacks:09BK}
\href{https://stacks.math.columbia.edu/tag/09BK}{\texttt{Stacks tag 09BK}}
\group{proetale}

\uses{proetale-lemma-affine-alternative}
Let $i : Z \to X$ be a closed immersion morphism of affine schemes.
Denote $X_{app}$ and $Z_{app}$ the sites introduced in
Lemma \ref{proetale-lemma-affine-alternative}.
...
\begin{proof}
\uses{proetale-lemma-lift-ind-etale}

The existence of the adjoint follows immediately from
Lemma \ref{proetale-lemma-lift-ind-etale} and the definitions.
...
We have seen in the statement of Lemma \ref{proetale-lemma-lift-ind-etale}
...
\begin{lemma}[Closed immersion affines apply]
\label{proetale-lemma-closed-immersion-affines-apply}
\source{stacks:09BL}
\href{https://stacks.math.columbia.edu/tag/09BL}{\texttt{Stacks tag 09BL}}
\group{proetale}

\uses{proetale-lemma-closed-immersion-affines}
...
$v : Z_{app} \to X_{app}$ of Lemma \ref{proetale-lemma-closed-immersion-affines}.
It follows that
\begin{enumerate}
...
\begin{proof}
\uses{proetale-lemma-affine-alternative, proetale-lemma-closed-immersion-affines, proetale-lemma-proetale-enough-w-contractible}

By Lemma \ref{proetale-lemma-affine-alternative} we may describe $i_\proetale$ in terms
...
Lemma \ref{proetale-lemma-closed-immersion-affines} we see that the presheaf
...
contractible objects (Lemma \ref{proetale-lemma-proetale-enough-w-contractible}).
...
\source{stacks:09AA}
\href{https://stacks.math.columbia.edu/tag/09AA}{\texttt{Stacks tag 09AA}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-closed-immersion-affines-apply}
...
Lemma \ref{proetale-lemma-closed-immersion-affines-apply}.
\end{proof}

\begin{lemma}[Thickening]
\label{proetale-lemma-thickening}
\source{stacks:09AB}
\href{https://stacks.math.columbia.edu/tag/09AB}{\texttt{Stacks tag 09AB}}
\group{proetale}
...
of Lemma \ref{proetale-lemma-affine-alternative} are equivalent.
We omit the verification
that this equivalence sends coverings to coverings and vice versa.
Thus the result as Lemma \ref{proetale-lemma-affine-alternative}
tells us the pro-\'etale topos is the topos of sheaves on $X_{app}$.
\end{proof}

\begin{lemma}[Compute i star]
\label{proetale-lemma-compute-i-star}
\source{stacks:09AC}
\href{https://stacks.math.columbia.edu/tag/09AC}{\texttt{Stacks tag 09AC}}
\group{proetale}
...
By Lemma \ref{proetale-lemma-closed-immersion-affines-apply} part (1)
...
\begin{lemma}[Closed immersion complement retrocompact exact]
\label{proetale-lemma-closed-immersion-complement-retrocompact-exact}
\source{stacks:09BM}
\href{https://stacks.math.columbia.edu/tag/09BM}{\texttt{Stacks tag 09BM}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-thickening, proetale-lemma-finite}
...
By Lemma \ref{proetale-lemma-thickening} we may assume that
$Z = \Spec(A/(f_1, \ldots, f_r))$. In this case
the functor $i_{\proetale, *}$ is exact by
Lemma \ref{proetale-lemma-finite}.
\end{proof}
...
\source{stacks:09AE}
\href{https://stacks.math.columbia.edu/tag/09AE}{\texttt{Stacks tag 09AE}}
\group{proetale}
...
\begin{lemma}[Jshriek comparison]
\label{proetale-lemma-jshriek-comparison}
\source{stacks:09AF}
\href{https://stacks.math.columbia.edu/tag/09AF}{\texttt{Stacks tag 09AF}}
\group{proetale}
...
The equality holds by the discussion in Section \ref{proetale-section-morphism}.
\end{proof}

\begin{lemma}[Jshriek zero]
\label{proetale-lemma-jshriek-zero}
\source{stacks:09AG}
\href{https://stacks.math.columbia.edu/tag/09AG}{\texttt{Stacks tag 09AG}}
\group{proetale}
...
Lemma \ref{proetale-lemma-localization}.
...
\begin{lemma}[Open immersion]
\label{proetale-lemma-open-immersion}
\source{stacks:09BN}
\href{https://stacks.math.columbia.edu/tag/09BN}{\texttt{Stacks tag 09BN}}
\group{proetale}
...
\source{stacks:09AH}
\href{https://stacks.math.columbia.edu/tag/09AH}{\texttt{Stacks tag 09AH}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-localization, proetale-lemma-jshriek-zero, proetale-lemma-compute-i-star, proetale-lemma-localization-w-contractible}
...
A_{V(I)}^\sim
$$
with $A_{V(I)}^\sim$ as in Lemma \ref{proetale-lemma-localization}.
...
$$
the first equality by Lemma \ref{proetale-lemma-jshriek-zero}
and the second by
Lemmas \ref{proetale-lemma-compute-i-star} and \ref{proetale-lemma-localization-w-contractible}.
Thus the sequence evaluates to an exact sequence on
$\Spec(A_{f_1} \times \ldots \times A_{f_r} \times A_{V(I)}^\sim)$
and the lemma is proved.
\end{proof}

\begin{lemma}[J shriek limits]
\label{proetale-lemma-j-shriek-limits}
\source{stacks:09BP}
\href{https://stacks.math.columbia.edu/tag/09BP}{\texttt{Stacks tag 09BP}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-ses-associated-to-open, proetale-lemma-closed-immersion}
...
the exact sequence of Lemma \ref{proetale-lemma-ses-associated-to-open}
we get
$$
...
Lemma \ref{proetale-lemma-closed-immersion}.
...
\source{stacks:09AJ}
\href{https://stacks.math.columbia.edu/tag/09AJ}{\texttt{Stacks tag 09AJ}}
\group{proetale}
...
\begin{lemma}[Compare constructible]
\label{proetale-lemma-compare-constructible}
\source{stacks:09AK}
\href{https://stacks.math.columbia.edu/tag/09AK}{\texttt{Stacks tag 09AK}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-fully-faithful, proetale-definition-constructible, proetale-lemma-compare-locally-constant, proetale-lemma-ses-associated-to-open, proetale-lemma-jshriek-comparison, proetale-lemma-morphism-comparison}

By Lemma \ref{proetale-lemma-fully-faithful} the functor $\epsilon^{-1}$
...
on $X_\proetale$ as in Definition \ref{proetale-definition-constructible}.
...
The base case $n = 1$ follows from Lemma \ref{proetale-lemma-compare-locally-constant}.
...
$\mathcal{F}$ to $Z$ and to $U$. By Lemma \ref{proetale-lemma-ses-associated-to-open}
...
$$
\begin{array}{ccccc}0 \longrightarrow & \epsilon^{-1}\epsilon_*j_!j^{-1}\mathcal{F} \longrightarrow\downarrow & \epsilon^{-1}\epsilon_*\mathcal{F} \longrightarrow\downarrow & \epsilon^{-1}\epsilon_*i_*i^{-1}\mathcal{F} \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & j_!j^{-1}\mathcal{F} \longrightarrow & \mathcal{F} \longrightarrow & i_*i^{-1}\mathcal{F} \longrightarrow & 0\end{array}
$$
...
j_!j^{-1}\mathcal{F}
$$
the second equality by Lemma \ref{proetale-lemma-jshriek-comparison},
the third equality by Lemma \ref{proetale-lemma-fully-faithful}, and the
fourth equality by Lemma \ref{proetale-lemma-jshriek-comparison} again.
Similarly, we have
$$
...
i_*i^{-1}\mathcal{F}
$$
this time using Lemma \ref{proetale-lemma-morphism-comparison}.
By the five lemma we conclude the
vertical map in the middle of the big diagram is an isomorphism.
\end{proof}

\begin{lemma}[Constructible serre]
\label{proetale-lemma-constructible-serre}
\source{stacks:09B5}
\href{https://stacks.math.columbia.edu/tag/09B5}{\texttt{Stacks tag 09B5}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-compare-constructible, proetale-lemma-compare-derived}

This is a formal consequence of
Lemmas \ref{proetale-lemma-compare-constructible} and \ref{proetale-lemma-compare-derived}
and the result for the \'etale site
(\'Etale Cohomology, Lemma \ref{etale-cohomology-lemma-constructible-abelian}).
\end{proof}

\begin{lemma}[Compare constructible derived]
\label{proetale-lemma-compare-constructible-derived}
\source{stacks:09AL}
\href{https://stacks.math.columbia.edu/tag/09AL}{\texttt{Stacks tag 09AL}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-constructible-serre, proetale-lemma-compare-derived, proetale-lemma-compare-constructible}
...
\'Etale Cohomology, Lemma \ref{etale-cohomology-lemma-constructible-abelian}
and
Lemma \ref{proetale-lemma-constructible-serre}
and
Derived Categories, Section \ref{derived-section-triangulated-sub}.
The statement of the lemma follows by combining
Lemmas \ref{proetale-lemma-compare-derived} and
...
\source{stacks:09BQ}
\href{https://stacks.math.columbia.edu/tag/09BQ}{\texttt{Stacks tag 09BQ}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-compare-constructible-derived}
...
In this case we can apply Lemma \ref{proetale-lemma-compare-constructible-derived} to
reduce to the case of the \'etale site, see
\'Etale Cohomology, Lemma \ref{etale-cohomology-lemma-tensor-c}.
\end{proof}

\begin{lemma}[Compare truncations constructible]
\label{proetale-lemma-compare-truncations-constructible}
\source{stacks:09BR}
\href{https://stacks.math.columbia.edu/tag/09BR}{\texttt{Stacks tag 09BR}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-tensor-c, proetale-lemma-constructible-serre}
...
K_1 \otimes_{\Lambda/I}^\mathbf{L} \underline{I^n/I^{n + 1}}
$$
By Lemma \ref{proetale-lemma-tensor-c} we see that this tensor product has
...
\begin{definition}[Adic]
\label{proetale-definition-adic}
\source{stacks:09BT}
\href{https://stacks.math.columbia.edu/tag/09BT}{\texttt{Stacks tag 09BT}}
\group{proetale}
...
$$
\begin{array}{cc}\text{lisse adic} \Longrightarrow\downarrow & \text{adic constructible} \downarrow \\ \text{lisse constructible }\Lambda\text{-sheaf} \Longrightarrow & \text{constructible }\Lambda\text{-sheaf}\end{array}
$$
The vertical arrows can be inverted in some cases
(see Lemmas \ref{proetale-lemma-Noetherian-constructible} and
\ref{proetale-lemma-Noetherian-adic-constructible}). In general
...
Example \ref{proetale-example-construct-space}. Denote
...
\begin{lemma}[Noetherian constructible]
\label{proetale-lemma-Noetherian-constructible}
\source{stacks:09BU}
\href{https://stacks.math.columbia.edu/tag/09BU}{\texttt{Stacks tag 09BU}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-compare-constructible}
...
Lemma \ref{proetale-lemma-compare-constructible}.
...
\source{stacks:09BV}
\href{https://stacks.math.columbia.edu/tag/09BV}{\texttt{Stacks tag 09BV}}
\group{proetale}
...
\begin{lemma}[Connected lisse]
\label{proetale-lemma-connected-lisse}
\source{stacks:09BW}
\href{https://stacks.math.columbia.edu/tag/09BW}{\texttt{Stacks tag 09BW}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-compare-locally-constant, proetale-lemma-weird}

By Lemma \ref{proetale-lemma-compare-locally-constant} we have
...
Lemma \ref{proetale-lemma-weird}
...
\begin{lemma}[Noetherian adic constructible]
\label{proetale-lemma-Noetherian-adic-constructible}
\source{stacks:09BX}
\href{https://stacks.math.columbia.edu/tag/09BX}{\texttt{Stacks tag 09BX}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-Noetherian-constructible, proetale-lemma-connected-lisse}

This is a consequence of Lemmas \ref{proetale-lemma-Noetherian-constructible} and
\ref{proetale-lemma-connected-lisse}, the fact that a Noetherian scheme
...
\begin{lemma}[Derived complete zero]
\label{proetale-lemma-derived-complete-zero}
\source{stacks:09BY}
\href{https://stacks.math.columbia.edu/tag/09BY}{\texttt{Stacks tag 09BY}}
\group{proetale}
...
\begin{proof}
\uses{proetale-proposition-enough-weakly-contractibles}
...
\begin{lemma}[Derived complete limit]
\label{proetale-lemma-derived-complete-limit}
\source{stacks:09BZ}
\href{https://stacks.math.columbia.edu/tag/09BZ}{\texttt{Stacks tag 09BZ}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-naive-completion, proetale-proposition-enough-weakly-contractibles, proetale-lemma-derived-complete-zero}
...
Lemma \ref{proetale-lemma-derived-complete-zero}
...
\begin{definition}[Dbc]
\label{proetale-definition-Dbc}
\source{stacks:09C1}
\href{https://stacks.math.columbia.edu/tag/09C1}{\texttt{Stacks tag 09C1}}
\group{proetale}
...
\begin{lemma}[Describe constructible complexes]
\label{proetale-lemma-describe-constructible-complexes}
\source{stacks:09C2}
\href{https://stacks.math.columbia.edu/tag/09C2}{\texttt{Stacks tag 09C2}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-naive-completion, proetale-lemma-compare-truncations-constructible, proetale-lemma-compare-constructible-derived}
...
Part (3) follows from
Lemma \ref{proetale-lemma-compare-truncations-constructible},
Part (4) follows from
Lemma \ref{proetale-lemma-compare-constructible-derived}
and the fact that $L_n$ has finite tor dimension because $K_n$ does
(small argument omitted).
\end{proof}

\begin{lemma}[Local structure constructible complex]
\label{proetale-lemma-local-structure-constructible-complex}
\source{stacks:09C3}
\href{https://stacks.math.columbia.edu/tag/09C3}{\texttt{Stacks tag 09C3}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-describe-constructible-complexes, proetale-proposition-enough-weakly-contractibles, proetale-lemma-derived-complete-limit, proetale-lemma-derived-complete-zero}

We freely use the results of
Lemma \ref{proetale-lemma-describe-constructible-complexes}.
...
constant sheaf of $\Lambda/I$-modules of finite type.
Apply Lemma \ref{proetale-lemma-derived-complete-limit} to get a surjection
...
is zero by Lemma \ref{proetale-lemma-derived-complete-zero}.
Then
$$
...
\begin{definition}[Adic constructible]
\label{proetale-definition-adic-constructible}
\source{stacks:09C4}
\href{https://stacks.math.columbia.edu/tag/09C4}{\texttt{Stacks tag 09C4}}
\group{proetale}
...
Lemma \ref{proetale-lemma-local-structure-constructible-complex}
...
\begin{lemma}[Weakly contractible locally constant ML]
\label{proetale-lemma-weakly-contractible-locally-constant-ML}
\source{stacks:09C5}
\href{https://stacks.math.columbia.edu/tag/09C5}{\texttt{Stacks tag 09C5}}
\group{proetale}
...
\begin{lemma}[Connected adic lisse]
\label{proetale-lemma-connected-adic-lisse}
\source{stacks:09C6}
\href{https://stacks.math.columbia.edu/tag/09C6}{\texttt{Stacks tag 09C6}}
\group{proetale}

\uses{proetale-definition-adic-constructible}
Let $X$ be a connected scheme. Let $\Lambda$ be a Noetherian ring and let
...
\begin{proof}
\uses{proetale-lemma-describe-constructible-complexes, proetale-lemma-weakly-contractible-locally-constant-ML}

Write $K_n = K \otimes_\Lambda^\mathbf{L} \underline{\Lambda/I^n}$.
We will use the results of Lemma \ref{proetale-lemma-describe-constructible-complexes}
...
\end{align*}
Thus we may apply Lemma \ref{proetale-lemma-weakly-contractible-locally-constant-ML}
...
\begin{proposition}[Noetherian adic constructible]
\label{proetale-proposition-Noetherian-adic-constructible}
\source{stacks:09C7}
\href{https://stacks.math.columbia.edu/tag/09C7}{\texttt{Stacks tag 09C7}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-connected-adic-lisse}

This is a consequence of Lemma \ref{proetale-lemma-connected-adic-lisse}
...
\source{stacks:09C9}
\href{https://stacks.math.columbia.edu/tag/09C9}{\texttt{Stacks tag 09C9}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-naive-completion, proetale-lemma-pushforward-Noetherian-case, proetale-lemma-compare-derived, proetale-lemma-morphism-comparison}
...
By Lemma \ref{proetale-lemma-naive-completion} we have $K = R\lim K_n$
because $K$ is derived complete.
By Lemmas \ref{proetale-lemma-pushforward-Noetherian-case} and
\ref{proetale-lemma-naive-completion} we can unwind the left hand side
$$
Lg_{comp}^* Rf_* K =
...
Using Lemma \ref{proetale-lemma-pushforward-Noetherian-case} we can unwind the right
hand side
$$
Rf'_* L(g')^*_{comp} K =
Rf'_* R\lim L(g')^* K_n  =
...
$$
are isomorphisms. By Lemma \ref{proetale-lemma-compare-derived} and our second
condition we can write $K_n = \epsilon^{-1}L_n$ for some
$L_n \in D^+(X_\etale, \Lambda/I^n)$. By Lemma \ref{proetale-lemma-morphism-comparison}
...
Lemma \ref{proetale-lemma-proetale-cohomology-independent-partial-universe} below
is an embedding of small pro-\'etale topoi which does not change cohomology.
For big pro-\'etale sites we have Lemmas \ref{proetale-lemma-change-alpha} and
\ref{proetale-lemma-cohomology-enlarge-partial-universe} saying essentially the
same thing.

\medskip\noindent
But first,
as promised in Section \ref{proetale-section-proetale} we prove that the topology on a
big pro-\'etale site $\Sch_\proetale$ is in some sense induced from
the pro-\'etale topology on the category of all schemes.

\begin{lemma}[Proetale induced]
\label{proetale-lemma-proetale-induced}
\source{stacks:098J}
\href{https://stacks.math.columbia.edu/tag/098J}{\texttt{Stacks tag 098J}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-get-many-weakly-contractible, proetale-lemma-w-contractible-proetale-cover}
...
\begin{lemma}[Proetale cohomology independent partial universe]
\label{proetale-lemma-proetale-cohomology-independent-partial-universe}
\source{stacks:098Y}
\href{https://stacks.math.columbia.edu/tag/098Y}{\texttt{Stacks tag 098Y}}
\group{proetale}

\uses{proetale-definition-big-small-proetale}
Let $S$ be a scheme. Let $S_\proetale \subset S_\proetale'$ be
two small pro-\'etale sites of $S$ as constructed in
Definition \ref{proetale-definition-big-small-proetale}. Then the inclusion functor
satisfies the assumptions of
Sites, Lemma \ref{sites-lemma-bigger-site}.
Hence there exist morphisms of topoi
$$
\begin{array}{ccc}\Sh(S_\proetale) \overset{g}{\longrightarrow} & \Sh(S_\proetale') \overset{f}{\longrightarrow} & \Sh(S_\proetale)\end{array}
$$
...
\begin{proof}
\uses{proetale-lemma-fibre-products-proetale, proetale-lemma-proetale-induced}
...
(Lemma \ref{proetale-lemma-fibre-products-proetale}).
It follows from Lemma \ref{proetale-lemma-proetale-induced}
...
\source{stacks:0F4S}
\href{https://stacks.math.columbia.edu/tag/0F4S}{\texttt{Stacks tag 0F4S}}
\group{proetale}
...
\begin{proof}
\uses{proetale-lemma-proetale-induced}
...
Lemma \ref{proetale-lemma-proetale-induced}.
...
\source{stacks:0F4T}
\href{https://stacks.math.columbia.edu/tag/0F4T}{\texttt{Stacks tag 0F4T}}
\group{proetale}

\uses{proetale-definition-big-small-proetale}
Let $S$ be a scheme. Let $(\Sch/S)_\proetale$ and $(\Sch'/S)_\proetale$ be two
big pro-\'etale sites of $S$ as in
Definition \ref{proetale-definition-big-small-proetale}.
...
\begin{proof}
\uses{proetale-lemma-change-alpha}

By Lemma \ref{proetale-lemma-change-alpha} the inclusion functor
