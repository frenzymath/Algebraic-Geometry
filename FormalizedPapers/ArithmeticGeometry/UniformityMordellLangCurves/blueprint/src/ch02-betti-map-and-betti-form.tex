% Source-derived chapter 02: Betti map and Betti form
% Original source: uniformity-mordell-lang-curves
\chapter{Betti map and Betti form}
\label{uniformity-mordell-lang-curves-chapter-02}
\source{uniformity-mordell-lang-curves}

\begin{remark}[Source section]
\label{uniformity-mordell-lang-curves-chapter-02-source}
\source{uniformity-mordell-lang-curves}
This chapter records the source section; no Lean declaration has yet been checked for this material.
\notready
\end{remark}

% The source section title was: Betti map and Betti form
\label{SectionBettiRevisited}
\source{uniformity-mordell-lang-curves}
...
\begin{lemma}
\source{uniformity-mordell-lang-curves}
\notready\label{LemmaBettiOnUniversalCovering}
...
\begin{lemma}
\source{uniformity-mordell-lang-curves}
\notready\label{LemmaBettiFormComplexReal}
...
\begin{corollary}
\source{uniformity-mordell-lang-curves}
\notready\label{CorBettiFormVanishingDirection}
...
\begin{lemma}
\source{uniformity-mordell-lang-curves}
\notready\label{LemmaBettiFormUnivAb}
Let $\hat{\omega}^{\mathrm{univ}}$ be as in
...
\begin{proposition}
\source{uniformity-mordell-lang-curves}
\notready\label{PropBettiFormNonDegUnivAb}
