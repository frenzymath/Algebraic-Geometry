...
%%
\begin{lemma}
\label{src-chabauty-coleman-bound-surfaces-ch03-curves-and-surfaces-statement-1}
\source{chabauty-coleman-bound-surfaces}
...
%%
\begin{lemma}
\label{src-chabauty-coleman-bound-surfaces-ch03-curves-and-surfaces-statement-2}
\source{chabauty-coleman-bound-surfaces}
...
%% 
\begin{lemma}
\label{src-chabauty-coleman-bound-surfaces-ch03-curves-and-surfaces-statement-3}
\source{chabauty-coleman-bound-surfaces}
