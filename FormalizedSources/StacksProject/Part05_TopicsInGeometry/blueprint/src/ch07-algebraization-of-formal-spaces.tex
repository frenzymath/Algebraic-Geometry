...
see Theorem \ref{restricted-theorem-dilatations}; the result on contractions will be
...
first part of this chapter (Sections \ref{restricted-section-two-categories}
-- \ref{restricted-section-approximation-principal})
...
a G-ring), see Lemma \ref{restricted-lemma-approximate}. For pointers to the literature
on this type of algebraization, see Remark \ref{restricted-remark-discussion}.
General references for the first part are
\cite{EGA}, \cite{Abbes}, and \cite{Fujiwara-Kato}.

\medskip\noindent
In the second part of this chapter
(Sections \ref{restricted-section-finite-type-red} -- \ref{restricted-section-formal-modifications})
...
(Sections \ref{restricted-section-completion-and-morphisms} --
\ref{restricted-section-modifications}) we prove the main theorem and
we give a few applications.
In fact, we deduce Artin's theorem from a stronger
result, namely, Theorem \ref{restricted-theorem-dilatations-general}.
...
\begin{lemma}[Topologically finite type]
\label{restricted-lemma-topologically-finite-type}
\source{stacks:0AJP}
\href{https://stacks.math.columbia.edu/tag/0AJP}{\texttt{Stacks tag 0AJP}}
\group{restricted}
...
\begin{lemma}[Topologically finite type Noetherian]
\label{restricted-lemma-topologically-finite-type-Noetherian}
\source{stacks:0AJQ}
\href{https://stacks.math.columbia.edu/tag/0AJQ}{\texttt{Stacks tag 0AJQ}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-topologically-finite-type}

Part (4) follows from
Algebra, Lemma \ref{algebra-lemma-completion-Noetherian-Noetherian}
as $A[x_1, \ldots, x_r]$ is Noetherian
(Algebra, Lemma \ref{algebra-lemma-Noetherian-permanence}).
To see (1) by Lemma \ref{restricted-lemma-topologically-finite-type}
...
\source{stacks:0AL5}
\href{https://stacks.math.columbia.edu/tag/0AL5}{\texttt{Stacks tag 0AL5}}
\group{restricted}
...
which are equivalences by Lemma \ref{restricted-lemma-topologically-finite-type}.
\end{remark}
...
\source{stacks:0AL6}
\href{https://stacks.math.columbia.edu/tag/0AL6}{\texttt{Stacks tag 0AL6}}
\group{restricted}
...
By Lemma \ref{restricted-lemma-topologically-finite-type-Noetherian} we can write
$$
B = A[x_1, \ldots, x_r]^\wedge / J
$$
...
\begin{lemma}[NL up to homotopy]
\label{restricted-lemma-NL-up-to-homotopy}
\source{stacks:0GAE}
\href{https://stacks.math.columbia.edu/tag/0GAE}{\texttt{Stacks tag 0GAE}}
\group{restricted}
...
\begin{lemma}[NL is completion]
\label{restricted-lemma-NL-is-completion}
\source{stacks:0GAF}
\href{https://stacks.math.columbia.edu/tag/0GAF}{\texttt{Stacks tag 0GAF}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-topologically-finite-type-Noetherian}
...
\begin{lemma}[NL is limit]
\label{restricted-lemma-NL-is-limit}
\source{stacks:0AJS}
\href{https://stacks.math.columbia.edu/tag/0AJS}{\texttt{Stacks tag 0AJS}}
\group{restricted}
...
\end{enumerate}
Here $B_n$ and $A_n$ are as in Section \ref{restricted-section-two-categories}.
\end{lemma}
...
\begin{lemma}[NL base change]
\label{restricted-lemma-NL-base-change}
\source{stacks:0GAG}
\href{https://stacks.math.columbia.edu/tag/0GAG}{\texttt{Stacks tag 0GAG}}
\group{restricted}

\uses{restricted-remark-base-change}
Let $(A_1, I_1) \to (A_2, I_2)$ be as in
Remark \ref{restricted-remark-base-change} with $A_1$ and $A_2$ Noetherian.
...
$$
\begin{array}{ccc}\NL^\wedge_{B_1/A_1} : \downarrow & J_1/J_1^2 \underset{\text{d}}{\longrightarrow}\downarrow & \bigoplus B_1\text{d}x_i \downarrow \\ \NL^\wedge_{B_2/A_2} : & J_2/J_2^2 \overset{\text{d}}{\longrightarrow} & \bigoplus B_2\text{d}x_i\end{array}
$$
...
\begin{lemma}[Exact sequence NL]
\label{restricted-lemma-exact-sequence-NL}
\source{stacks:0ALM}
\href{https://stacks.math.columbia.edu/tag/0ALM}{\texttt{Stacks tag 0ALM}}
\group{restricted}
...
$$
\begin{array}{cccc}C \otimes_B H^0(\NL_{B/A}^\wedge) \longrightarrow & H^0(\NL_{C/A}^\wedge) \longrightarrow & H^0(\NL_{C/B}^\wedge) \longrightarrow & 0 \\ H^{-1}(\NL_{B/A}^\wedge \otimes_B C) \longrightarrow & H^{-1}(\NL_{C/A}^\wedge) \longrightarrow & H^{-1}(\NL_{C/B}^\wedge) \nwarrow & \end{array}
$$
See proof for elucidation.
\end{lemma}

\begin{proof}
\uses{restricted-lemma-NL-up-to-homotopy, restricted-lemma-topologically-finite-type-Noetherian}
...
Lemma \ref{restricted-lemma-NL-up-to-homotopy}.
...
$$
\begin{array}{ccccc}0 \longrightarrow & \bigoplus C \text{d}x_i \longrightarrow & \bigoplus C \text{d}x_i \oplus \bigoplus C \text{d}y_j \longrightarrow & \bigoplus C \text{d}y_j \longrightarrow & 0 \\  & J/J^2 \otimes_B C \longrightarrow\uparrow & K/K^2 \longrightarrow\uparrow & J'/(J')^2 \longrightarrow\uparrow & 0\end{array}
$$
...
\begin{lemma}[Transitive lci at end]
\label{restricted-lemma-transitive-lci-at-end}
\source{stacks:0AQJ}
\href{https://stacks.math.columbia.edu/tag/0AQJ}{\texttt{Stacks tag 0AQJ}}
\group{restricted}

\uses{restricted-lemma-exact-sequence-NL}
With assumptions as in Lemma \ref{restricted-lemma-exact-sequence-NL}
...
\begin{proof}
\uses{restricted-lemma-NL-is-limit}
...
The third holds by Lemma \ref{restricted-lemma-NL-is-limit}.
...
\begin{definition}[Rig smooth homomorphism]
\label{restricted-definition-rig-smooth-homomorphism}
\source{stacks:0GAI}
\href{https://stacks.math.columbia.edu/tag/0GAI}{\texttt{Stacks tag 0GAI}}
\group{restricted}
...
\begin{lemma}[Equivalent with artin smooth]
\label{restricted-lemma-equivalent-with-artin-smooth}
\source{stacks:0GAJ}
\href{https://stacks.math.columbia.edu/tag/0GAJ}{\texttt{Stacks tag 0GAJ}}
\group{restricted}
...
\begin{lemma}[Rig smooth]
\label{restricted-lemma-rig-smooth}
\source{stacks:0GAK}
\href{https://stacks.math.columbia.edu/tag/0GAK}{\texttt{Stacks tag 0GAK}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-equivalent-with-artin-smooth, restricted-lemma-NL-is-completion}

We will use Lemma \ref{restricted-lemma-equivalent-with-artin-smooth}
...
by Lemma \ref{restricted-lemma-NL-is-completion} we conclude (2) holds by
...
$$
\begin{array}{cc}J/J^2 \longrightarrow\overset{b}{\downarrow} & \bigoplus B\text{d}x_i \overset{h}{\downarrow} \\ J/J^2 \longrightarrow & (J/J^2)_g\end{array}
$$
...
\begin{lemma}[Zero ext 1 after modding out]
\label{restricted-lemma-zero-ext-1-after-modding-out}
\source{stacks:0GAL}
\href{https://stacks.math.columbia.edu/tag/0GAL}{\texttt{Stacks tag 0GAL}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-NL-base-change}

By Lemma \ref{restricted-lemma-NL-base-change} there is a map
$$
\NL_{B_1/A_1} \otimes_{B_2} B_1 \to \NL_{B_2/A_2}
$$
which induces and isomorphism on $H^0$ and a surjection on $H^{-1}$.
...
\begin{lemma}[Base change rig smooth homomorphism]
\label{restricted-lemma-base-change-rig-smooth-homomorphism}
\source{stacks:0GAM}
\href{https://stacks.math.columbia.edu/tag/0GAM}{\texttt{Stacks tag 0GAM}}
\group{restricted}
...
Remark \ref{restricted-remark-base-change}.
If $B_1$ is rig-smooth over $(A_1, I_1)$,
then $B_2$ is rig-smooth over $(A_2, I_2)$.
\end{lemma}

\begin{proof}
\uses{restricted-lemma-zero-ext-1-after-modding-out, restricted-definition-rig-smooth-homomorphism}

Follows from Lemma \ref{restricted-lemma-zero-ext-1-after-modding-out} and
Definition \ref{restricted-definition-rig-smooth-homomorphism}
...
\source{stacks:0AK3}
\href{https://stacks.math.columbia.edu/tag/0AK3}{\texttt{Stacks tag 0AK3}}
\group{restricted}
...
\source{stacks:0GAP}
\href{https://stacks.math.columbia.edu/tag/0GAP}{\texttt{Stacks tag 0GAP}}
\group{restricted}

\uses{restricted-remark-linear-approximation}
...
0 \bmod I^{2n'}C
$$
See Remark \ref{restricted-remark-linear-approximation} for the first equality.
Hence $\psi'$ induces an $A$-algebra homomorphism
$\psi'_{2n'} : B \to C/I^{2n'}C$ as desired.
\end{remark}

\begin{lemma}[Get morphism general better]
\label{restricted-lemma-get-morphism-general-better}
\source{stacks:0GAQ}
\href{https://stacks.math.columbia.edu/tag/0GAQ}{\texttt{Stacks tag 0GAQ}}
\group{restricted}
...
\begin{proof}
\uses{restricted-remark-improve-homomorphism}

Consider the obstruction class
$$
o(\psi_n) \in \Ext^1_B(\NL_{B/A}^\wedge, I^nC/I^{2n}C)
$$
of Remark \ref{restricted-remark-improve-homomorphism}. For any $C/I^nC$-module
$N$ we have
\begin{align*}
...
Remark \ref{restricted-remark-improve-homomorphism} we obtain a map
$$
...
\begin{lemma}[Get morphism nonzerodivisor]
\label{restricted-lemma-get-morphism-nonzerodivisor}
\source{stacks:0AK6}
\href{https://stacks.math.columbia.edu/tag/0AK6}{\texttt{Stacks tag 0AK6}}
\group{restricted}
...
$$
of Remark \ref{restricted-remark-improve-homomorphism}. Since $a$ is a nonzerodivisor
...
$$
By the discussion in Remark \ref{restricted-remark-improve-homomorphism} we obtain a map
$$
...
\begin{lemma}[Get morphism principal]
\label{restricted-lemma-get-morphism-principal}
\source{stacks:0AK7}
\href{https://stacks.math.columbia.edu/tag/0AK7}{\texttt{Stacks tag 0AK7}}
\group{restricted}
...
by Lemma \ref{restricted-lemma-topologically-finite-type-Noetherian}.

\begin{proof}
\uses{restricted-lemma-get-morphism-nonzerodivisor}
...
$$
\begin{array}{ccccc}0 \longrightarrow & C[a^\infty] \longrightarrow\downarrow & C \longrightarrow\downarrow & C' \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & C[a^\infty] \longrightarrow & C/a^m C \longrightarrow & C'/a^m C' \longrightarrow & 0\end{array}
$$
has exact rows. Thus $C$ is the fibre product of $C'$ and
$C/a^mC$ over $C'/a^mC'$ for all $m \geq d$. By
Lemma \ref{restricted-lemma-get-morphism-nonzerodivisor}
...
\begin{lemma}[Close enough]
\label{restricted-lemma-close-enough}
\source{stacks:0GAR}
\href{https://stacks.math.columbia.edu/tag/0GAR}{\texttt{Stacks tag 0GAR}}
\group{restricted}
...
\begin{proof}
\uses{restricted-definition-rig-smooth-homomorphism, restricted-lemma-get-morphism-general-better}

(A) By Definition \ref{restricted-definition-rig-smooth-homomorphism}
...
we may apply Lemma \ref{restricted-lemma-get-morphism-general-better}
...
\begin{lemma}[Algebraize easy]
\label{restricted-lemma-algebraize-easy}
\source{stacks:0GAS}
\href{https://stacks.math.columbia.edu/tag/0GAS}{\texttt{Stacks tag 0GAS}}
\group{restricted}
...
\begin{proposition}[Approximate]
\label{restricted-proposition-approximate}
\source{stacks:0GAT}
\href{https://stacks.math.columbia.edu/tag/0GAT}{\texttt{Stacks tag 0GAT}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-close-enough, restricted-lemma-algebraize-easy}
...
Choose a large enough integer $n$ as in Lemma \ref{restricted-lemma-close-enough}.
...
$$
This finishes the proof by Lemma \ref{restricted-lemma-algebraize-easy}.
\end{proof}
...
\begin{lemma}[Fully faithfulness]
\label{restricted-lemma-fully-faithfulness}
\source{stacks:0AK4}
\href{https://stacks.math.columbia.edu/tag/0AK4}{\texttt{Stacks tag 0AK4}}
\group{restricted}
...
Remark \ref{restricted-remark-discussion} for a discussion.

\begin{lemma}[Presentation rig smooth]
\label{restricted-lemma-presentation-rig-smooth}
\source{stacks:0GAV}
\href{https://stacks.math.columbia.edu/tag/0GAV}{\texttt{Stacks tag 0GAV}}
\group{restricted}
...
\begin{lemma}[Approximate presentation rig smooth]
\label{restricted-lemma-approximate-presentation-rig-smooth}
\source{stacks:0GAW}
\href{https://stacks.math.columbia.edu/tag/0GAW}{\texttt{Stacks tag 0GAW}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-equivalent-with-artin-smooth, restricted-lemma-presentation-rig-smooth, restricted-lemma-NL-is-completion, restricted-lemma-get-morphism-general-better, restricted-lemma-exact-sequence-NL}

The conditions imply that $B$ is rig-smooth over $(A, I)$, see
Lemma \ref{restricted-lemma-equivalent-with-artin-smooth}.
...
$$
We will apply Lemma \ref{restricted-lemma-presentation-rig-smooth} to $C$.
We compute
$$
\det\left(
\begin{matrix}
...
Lemma \ref{restricted-lemma-NL-is-completion} we conclude that multiplication
...
found in
Local Cohomology, Section \ref{local-cohomology-section-uniform}.
By Lemma \ref{restricted-lemma-get-morphism-general-better} if we take
...
$$
by Lemma \ref{restricted-lemma-exact-sequence-NL}. The first two modules are
...
\source{stacks:0GAX}
\href{https://stacks.math.columbia.edu/tag/0GAX}{\texttt{Stacks tag 0GAX}}
\group{restricted}

\uses{restricted-proposition-approximate, restricted-lemma-approximate}
Let $I$ be an ideal of a Noetherian ring $A$. Let $B$ be an object
...
Proposition \ref{restricted-proposition-approximate}.
\item If $B$ is rig-\'etale over $(A, I)$, then the result follows from
Lemma \ref{restricted-lemma-approximate}.
...
\begin{definition}[Rig etale homomorphism]
\label{restricted-definition-rig-etale-homomorphism}
\source{stacks:0GAY}
\href{https://stacks.math.columbia.edu/tag/0GAY}{\texttt{Stacks tag 0GAY}}
\group{restricted}
...
\begin{lemma}[Equivalent with artin]
\label{restricted-lemma-equivalent-with-artin}
\source{stacks:0AJU}
\href{https://stacks.math.columbia.edu/tag/0AJU}{\texttt{Stacks tag 0AJU}}
\group{restricted}
...
\begin{proof}
\uses{restricted-definition-rig-etale-homomorphism, restricted-lemma-NL-is-limit, restricted-lemma-topologically-finite-type-Noetherian}

The equivalence of (1) and (\ref{item-zero-on-NL}) is a restatement of
Definition \ref{restricted-definition-rig-etale-homomorphism}.
...
are strictly isomorphic, see Lemma \ref{restricted-lemma-NL-is-limit}.
...
\begin{lemma}[Rig etale rig smooth]
\label{restricted-lemma-rig-etale-rig-smooth}
\source{stacks:0GB1}
\href{https://stacks.math.columbia.edu/tag/0GB1}{\texttt{Stacks tag 0GB1}}
\group{restricted}
...
\begin{proof}
\uses{restricted-definition-rig-smooth-homomorphism, restricted-definition-rig-etale-homomorphism}

Immediate from Definitions \ref{restricted-definition-rig-smooth-homomorphism} and
\ref{restricted-definition-rig-etale-homomorphism}.
\end{proof}

\begin{lemma}[Rig etale]
\label{restricted-lemma-rig-etale}
\source{stacks:0ALQ}
\href{https://stacks.math.columbia.edu/tag/0ALQ}{\texttt{Stacks tag 0ALQ}}
\group{restricted}

\uses{restricted-lemma-equivalent-with-artin}
Let $A$ be a Noetherian ring and let $I$ be an ideal.
Let $B$ be a finite type $A$-algebra.
\begin{enumerate}
\item If $\Spec(B) \to \Spec(A)$ is \'etale over $\Spec(A) \setminus V(I)$,
then $B^\wedge$ satisfies the equivalent conditions of
Lemma \ref{restricted-lemma-equivalent-with-artin}.
...
\begin{proof}
\uses{restricted-lemma-equivalent-with-artin, restricted-lemma-NL-is-limit}
...
$\NL_{B/A}$ (see Lemma \ref{restricted-lemma-NL-is-limit}) it follows that
$B^\wedge$ satisfies the equivalent conditions of
Lemma \ref{restricted-lemma-equivalent-with-artin}.
\end{proof}

\begin{lemma}[Zero after modding out]
\label{restricted-lemma-zero-after-modding-out}
\source{stacks:0AK2}
\href{https://stacks.math.columbia.edu/tag/0AK2}{\texttt{Stacks tag 0AK2}}
\group{restricted}
...
\begin{lemma}[Base change rig etale homomorphism]
\label{restricted-lemma-base-change-rig-etale-homomorphism}
\source{stacks:0GB2}
\href{https://stacks.math.columbia.edu/tag/0GB2}{\texttt{Stacks tag 0GB2}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-zero-after-modding-out, restricted-definition-rig-etale-homomorphism}

Follows from Lemma \ref{restricted-lemma-zero-after-modding-out} and
Definition \ref{restricted-definition-rig-etale-homomorphism} and the fact
that $I_2^c \subset I_1A_2$ for some $c \geq 0$ as $A_2$ is Noetherian.
\end{proof}

\begin{lemma}[Fully faithful etale over complement]
\label{restricted-lemma-fully-faithful-etale-over-complement}
\source{stacks:0AKJ}
\href{https://stacks.math.columbia.edu/tag/0AKJ}{\texttt{Stacks tag 0AKJ}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-rig-etale, restricted-lemma-exact-sequence-NL}
...
By Lemmas \ref{restricted-lemma-rig-etale} and \ref{restricted-lemma-exact-sequence-NL}
...
Lemma \ref{restricted-lemma-rig-etale} we may replace $D$ by a localization
...
\begin{lemma}[Lift approximation]
\label{restricted-lemma-lift-approximation}
\source{stacks:0ALT}
\href{https://stacks.math.columbia.edu/tag/0ALT}{\texttt{Stacks tag 0ALT}}
\group{restricted}

Let $A$ be a Noetherian ring and $I \subset A$ an ideal.
Let $J \subset A$ be a nilpotent ideal. Consider a commutative diagram
$$
\begin{array}{ccc}C \longrightarrow & C_0 \xlongequal{} & C/JC \\  & B_0 \uparrow &  \\ A \longrightarrow\uparrow & A_0 \uparrow\xlongequal{} & A/J\end{array}
$$
...
$$
\begin{array}{cc}C \longrightarrow & C/JC \\ B \uparrow\longrightarrow & B_0 \uparrow \\ A \longrightarrow\uparrow & A/J \uparrow\end{array}
$$
...
situation:
$$
\begin{array}{cc}Z \downarrow & Z_0 \longleftarrow\downarrow \\  & Y_0 \downarrow \\ X & X_0 \longleftarrow\end{array}
\quad\quad\quad
\begin{array}{cc}W \downarrow & W_0 \longleftarrow\downarrow \\  & V_0 \downarrow \\ U & U_0 \longleftarrow\end{array}
$$
The conditions in the lemma guarantee that
$$
\begin{array}{cc}W_0 \longrightarrow\downarrow & Z_0 \downarrow \\ V_0 \longrightarrow & Y_0\end{array}
$$
...
$$
\begin{array}{cc}W \longrightarrow\downarrow & Z \downarrow \\ V \longrightarrow & Y\end{array}
$$
...
we see that
$$
\begin{array}{cc}W_0 \longrightarrow\downarrow & Z_0 \downarrow \\ V_0 \longrightarrow & Y \times_X X_0\end{array}
$$
...
of Section \ref{restricted-section-approximation} to finish the proof.

\begin{lemma}[Approximate principal]
\label{restricted-lemma-approximate-principal}
\source{stacks:0ALS}
\href{https://stacks.math.columbia.edu/tag/0ALS}{\texttt{Stacks tag 0ALS}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-equivalent-with-artin, restricted-lemma-approximate-presentation-rig-smooth, restricted-lemma-get-morphism-general-better, restricted-lemma-get-morphism-principal}

Choose a presentation $B = A[x_1, \ldots, x_r]^\wedge/J$.
By Lemma \ref{restricted-lemma-equivalent-with-artin} part (6) we can find
$c \geq 0$ and $f_1, \ldots, f_r \in J$ such that
$\det_{1 \leq i, j \leq r}(\partial f_j/\partial x_i)$ divides
$a^c$ in $B$ and
$a^c J \subset (f_1, \ldots, f_r) + J^2$.
Hence Lemma \ref{restricted-lemma-approximate-presentation-rig-smooth} applies.
...
\source{stacks:0AKA}
\href{https://stacks.math.columbia.edu/tag/0AKA}{\texttt{Stacks tag 0AKA}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-approximate-principal, restricted-remark-take-bar, restricted-lemma-base-change-rig-etale-homomorphism, restricted-lemma-rig-etale, restricted-lemma-fully-faithful-etale-over-complement, restricted-lemma-lift-approximation, restricted-lemma-topologically-finite-type, restricted-lemma-NL-is-completion, restricted-lemma-equivalent-with-artin}
...
Lemma \ref{restricted-lemma-approximate-principal}. Assume $t > 1$.
...
map $(A, I) \to (\bar A_m, \bar I_m)$, see Remark \ref{restricted-remark-take-bar}.
By Lemma \ref{restricted-lemma-base-change-rig-etale-homomorphism}
...
By Lemma \ref{restricted-lemma-rig-etale} we may assume that
...
Hence by Lemma \ref{restricted-lemma-fully-faithful-etale-over-complement}
...
We apply Lemma \ref{restricted-lemma-lift-approximation} to the diagram
$$
\begin{array}{ccc} & C'_m \longrightarrow & C'_m/(a_t^{m - 1}) \\ C''_m \nearrow\dashrightarrow &  & C_{m - 1} \uparrow \\  & \bar A_m \longrightarrow\uparrow\nwarrow & \bar A_{m - 1} \uparrow\end{array}
$$
...
over $A/(a_t)$, see Lemma \ref{restricted-lemma-topologically-finite-type}.
...
Lemma \ref{restricted-lemma-NL-is-completion}, it
...
Lemma \ref{restricted-lemma-equivalent-with-artin}. It follows that $B'$
is rig \'etale over $(A, (a_t))$ by the same lemma.
Hence finally, we may apply Lemma \ref{restricted-lemma-approximate-principal}
to $B'$ over $(A, (a_t))$ to finish the proof.
\end{proof}

\begin{lemma}[Approximate by etale over complement]
\label{restricted-lemma-approximate-by-etale-over-complement}
\source{stacks:0AKG}
\href{https://stacks.math.columbia.edu/tag/0AKG}{\texttt{Stacks tag 0AKG}}
\group{restricted}
...
Lemma \ref{restricted-lemma-equivalent-with-artin} are also equivalent to
\begin{enumerate}
\item[(8)]
...
\begin{proof}
\uses{restricted-lemma-equivalent-with-artin, restricted-lemma-approximate, restricted-lemma-rig-etale}

Combine Lemmas \ref{restricted-lemma-equivalent-with-artin}, \ref{restricted-lemma-approximate}, and
\ref{restricted-lemma-rig-etale}. Small detail omitted.
\end{proof}
...
\begin{lemma}[Finite type]
\label{restricted-lemma-finite-type}
\source{stacks:0GBW}
\href{https://stacks.math.columbia.edu/tag/0GBW}{\texttt{Stacks tag 0GBW}}
\group{restricted}
...
\begin{remark}[NL well defined topological]
\label{restricted-remark-NL-well-defined-topological}
\source{stacks:0GBX}
\href{https://stacks.math.columbia.edu/tag/0GBX}{\texttt{Stacks tag 0GBX}}
\group{restricted}

\uses{restricted-lemma-finite-type, restricted-lemma-NL-up-to-homotopy}
Let $A \to B$ be an arrow of $\text{WAdm}^{adic*}$ which is adic and
topologically of finite type (see Lemma \ref{restricted-lemma-finite-type}). Write
...
$$
Exactly as in the proof of Lemma \ref{restricted-lemma-NL-up-to-homotopy}
...
in Section \ref{restricted-section-naive-cotangent-complex} simply because
...
\source{stacks:0GBY}
\href{https://stacks.math.columbia.edu/tag/0GBY}{\texttt{Stacks tag 0GBY}}
\group{restricted}

\uses{restricted-lemma-finite-type}
Consider the property $P$ on arrows of $\textit{WAdm}^{adic*}$ defined in
Lemma \ref{restricted-lemma-finite-type}. Then $P$ is stable under base change as
...
The statement makes sense by Lemma \ref{restricted-lemma-finite-type}.
...
\source{stacks:0GBZ}
\href{https://stacks.math.columbia.edu/tag/0GBZ}{\texttt{Stacks tag 0GBZ}}
\group{restricted}

\uses{restricted-lemma-finite-type}
Consider the property $P$ on arrows of $\textit{WAdm}^{adic*}$ defined in
Lemma \ref{restricted-lemma-finite-type}. Then $P$ is stable under composition as
defined in Formal Spaces, Remark
...
Lemma \ref{restricted-lemma-finite-type}.

\begin{lemma}[Finite type morphisms]
\label{restricted-lemma-finite-type-morphisms}
\source{stacks:0GC0}
\href{https://stacks.math.columbia.edu/tag/0GC0}{\texttt{Stacks tag 0GC0}}
\group{restricted}
...
Lemma \ref{restricted-lemma-finite-type} and
Formal Spaces, Lemma
...
\begin{lemma}[Finite type red]
\label{restricted-lemma-finite-type-red}
\source{stacks:0GC2}
\href{https://stacks.math.columbia.edu/tag/0GC2}{\texttt{Stacks tag 0GC2}}
\group{restricted}
...
$$
\begin{array}{cc}B \longrightarrow & (B')^\wedge \\ A \longrightarrow\overset{\varphi}{\uparrow} & (A')^\wedge \underset{\varphi'}{\uparrow}\end{array}
$$
as in Formal Spaces, Situation
\ref{formal-spaces-situation-local-property}.
Taking $\text{Spf}$ of this diagram we obtain
$$
\begin{array}{cc}\text{Spf}(B) \downarrow & \text{Spf}((B')^\wedge) \longleftarrow\downarrow \\ \text{Spf}(A) & \text{Spf}((A')^\wedge) \longleftarrow\end{array}
$$
...
$$
\begin{array}{cc}\text{Spf}(B)_{red} \overset{f}{\downarrow} & \text{Spf}((B')^\wedge)_{red} \overset{g}{\longleftarrow}\overset{f'}{\downarrow} \\ \text{Spf}(A)_{red} & \text{Spf}((A')^\wedge)_{red} \longleftarrow\end{array}
$$
...
\begin{lemma}[Base change finite type red]
\label{restricted-lemma-base-change-finite-type-red}
\source{stacks:0GC3}
\href{https://stacks.math.columbia.edu/tag/0GC3}{\texttt{Stacks tag 0GC3}}
\group{restricted}

\uses{restricted-lemma-finite-type-red}
Consider the property $P$ on arrows of $\textit{WAdm}^{count}$ defined in
Lemma \ref{restricted-lemma-finite-type-red}. Then $P$ is stable under base change
(Formal Spaces, Situation
...
The statement makes sense by Lemma \ref{restricted-lemma-finite-type-red}.
...
\begin{lemma}[Composition finite type red]
\label{restricted-lemma-composition-finite-type-red}
\source{stacks:0GC4}
\href{https://stacks.math.columbia.edu/tag/0GC4}{\texttt{Stacks tag 0GC4}}
\group{restricted}

\uses{restricted-lemma-finite-type-red}
Consider the property $P$ on arrows of $\textit{WAdm}^{count}$ defined in
Lemma \ref{restricted-lemma-finite-type-red}. Then $P$ is stable under composition
(Formal Spaces, Situation
...
\begin{lemma}[Finite type finite type red]
\label{restricted-lemma-finite-type-finite-type-red}
\source{stacks:0GC5}
\href{https://stacks.math.columbia.edu/tag/0GC5}{\texttt{Stacks tag 0GC5}}
\group{restricted}

\uses{restricted-lemma-finite-type-red}
Let $\varphi : A \to B$ be an arrow of $\textit{WAdm}^{count}$.
If $\varphi$ is taut and topologically of finite type, then $\varphi$
satisfies the condition defined in Lemma \ref{restricted-lemma-finite-type-red}.
\end{lemma}
...
\begin{lemma}[Noetherian finite type red]
\label{restricted-lemma-Noetherian-finite-type-red}
\source{stacks:0GC6}
\href{https://stacks.math.columbia.edu/tag/0GC6}{\texttt{Stacks tag 0GC6}}
\group{restricted}

\uses{restricted-lemma-finite-type-red}
Let $\varphi : A \to B$ be an arrow of $\textit{WAdm}^{Noeth}$
satisfying the condition defined in Lemma \ref{restricted-lemma-finite-type-red}.
...
\begin{lemma}[Noetherian adic finite type red]
\label{restricted-lemma-Noetherian-adic-finite-type-red}
\source{stacks:0GG6}
\href{https://stacks.math.columbia.edu/tag/0GG6}{\texttt{Stacks tag 0GG6}}
\group{restricted}

\uses{restricted-lemma-finite-type-red, restricted-lemma-finite-type}
Let $\varphi : A \to B$ be an arrow of $\textit{WAdm}^{Noeth}$.
If $\varphi$ is adic the following are equivalent
\begin{enumerate}
\item $\varphi$ satisfies the condition defined in
Lemma \ref{restricted-lemma-finite-type-red} and
\item $\varphi$ satisfies the condition defined in
Lemma \ref{restricted-lemma-finite-type}.
\end{enumerate}
\end{lemma}
...
\begin{proof}
\uses{restricted-lemma-Noetherian-finite-type-red}

Omitted. Hint: For the proof of (1) $\Rightarrow$ (2) use
Lemma \ref{restricted-lemma-Noetherian-finite-type-red}.
\end{proof}

\begin{lemma}[Finite type red morphisms]
\label{restricted-lemma-finite-type-red-morphisms}
\source{stacks:0GC7}
\href{https://stacks.math.columbia.edu/tag/0GC7}{\texttt{Stacks tag 0GC7}}
\group{restricted}
...
property defined in Lemma \ref{restricted-lemma-finite-type-red},
\item there exists a covering $\{Y_j \to Y\}$ as in
Formal Spaces,
Definition \ref{formal-spaces-definition-formal-algebraic-space}
and for each $j$
...
by algebraic spaces and \'etale, and $X_i \to Y_i$ corresponds
to an arrow of $\textit{WAdm}^{count}$ satisfying the
property defined in Lemma \ref{restricted-lemma-finite-type-red}, and
...
Lemma \ref{restricted-lemma-finite-type-red} and an application of
Formal Spaces, Lemma
...
\begin{lemma}[Flat axioms]
\label{restricted-lemma-flat-axioms}
\source{stacks:0GC9}
\href{https://stacks.math.columbia.edu/tag/0GC9}{\texttt{Stacks tag 0GC9}}
\group{restricted}
...
\begin{lemma}[Base change flat continuous]
\label{restricted-lemma-base-change-flat-continuous}
\source{stacks:0GCA}
\href{https://stacks.math.columbia.edu/tag/0GCA}{\texttt{Stacks tag 0GCA}}
\group{restricted}

\uses{restricted-lemma-flat-axioms, restricted-lemma-finite-type-red, restricted-lemma-finite-type}
Denote $P$ the property of arrows of $\textit{WAdm}^{Noeth}$
defined in Lemma \ref{restricted-lemma-flat-axioms}.
Denote $Q$ the property defined in Lemma \ref{restricted-lemma-finite-type-red}
viewed as a property of arrows of $\textit{WAdm}^{Noeth}$.
Denote $R$ the property defined in Lemma \ref{restricted-lemma-finite-type}
...
\begin{proof}
\uses{restricted-lemma-finite-type-finite-type-red, restricted-lemma-Noetherian-finite-type-red}
...
Since $R$ implies $Q$ (Lemma \ref{restricted-lemma-finite-type-finite-type-red}),
...
By Lemma \ref{restricted-lemma-Noetherian-finite-type-red} the ring map
...
\begin{lemma}[Composition flat continuous]
\label{restricted-lemma-composition-flat-continuous}
\source{stacks:0GCB}
\href{https://stacks.math.columbia.edu/tag/0GCB}{\texttt{Stacks tag 0GCB}}
\group{restricted}

\uses{restricted-lemma-flat-axioms}
Denote $P$ the property of arrows of $\textit{WAdm}^{Noeth}$
defined in Lemma \ref{restricted-lemma-flat-axioms}.
...
\source{stacks:0GCC}
\href{https://stacks.math.columbia.edu/tag/0GCC}{\texttt{Stacks tag 0GCC}}
\group{restricted}
...
\begin{lemma}[Flat morphisms]
\label{restricted-lemma-flat-morphisms}
\source{stacks:0GCD}
\href{https://stacks.math.columbia.edu/tag/0GCD}{\texttt{Stacks tag 0GCD}}
\group{restricted}
...
\begin{proof}
\uses{restricted-definition-flat, restricted-lemma-flat-axioms}

The equivalence of (1) and (2) is Definition \ref{restricted-definition-flat}.
The equivalence of (2), (3), and (4) follows from the fact that
being flat is a local property of arrows of
$\text{WAdm}^{Noeth}$ by Lemma \ref{restricted-lemma-flat-axioms}
...
\source{stacks:0GCE}
\href{https://stacks.math.columbia.edu/tag/0GCE}{\texttt{Stacks tag 0GCE}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-base-change-flat-continuous, restricted-lemma-flat-morphisms, restricted-lemma-finite-type-red-morphisms, restricted-lemma-finite-type-morphisms}

Part (1) follows from a combination of
Formal Spaces, Remark
\ref{formal-spaces-remark-base-change-variant-variant-Noetherian},
Lemma \ref{restricted-lemma-base-change-flat-continuous} part (1),
...
Formal Spaces, Remark
\ref{formal-spaces-remark-base-change-variant-Noetherian},
Lemma \ref{restricted-lemma-base-change-flat-continuous} part (2),
Lemma \ref{restricted-lemma-flat-morphisms}, and
...
\source{stacks:0GCF}
\href{https://stacks.math.columbia.edu/tag/0GCF}{\texttt{Stacks tag 0GCF}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-composition-flat-continuous}

Combine Formal Spaces, Remark
\ref{formal-spaces-remark-composition-variant-Noetherian}
and Lemma \ref{restricted-lemma-composition-flat-continuous}.
\end{proof}

\begin{lemma}[Representable flat]
\label{restricted-lemma-representable-flat}
\source{stacks:0GCG}
\href{https://stacks.math.columbia.edu/tag/0GCG}{\texttt{Stacks tag 0GCG}}
\group{restricted}

\uses{restricted-definition-flat}
...
then $f$ is flat in the sense of Definition \ref{restricted-definition-flat}.
\end{lemma}
...
$$
\begin{array}{cc}\Spec(A/J^nA) \longrightarrow\downarrow & \Spec(B/J^n) \downarrow \\ U \longrightarrow & V\end{array}
$$
are cartesian.
...
\begin{lemma}[Rig point]
\label{restricted-lemma-rig-point}
\source{stacks:0GG8}
\href{https://stacks.math.columbia.edu/tag/0GG8}{\texttt{Stacks tag 0GG8}}
\group{restricted}
...
\begin{definition}[Rig closed]
\label{restricted-definition-rig-closed}
\source{stacks:0GG9}
\href{https://stacks.math.columbia.edu/tag/0GG9}{\texttt{Stacks tag 0GG9}}
\group{restricted}

\uses{restricted-lemma-rig-point}
Let $A$ be a Noetherian adic topological ring. Let
$\mathfrak q \subset A$ be a prime ideal. We say
$\mathfrak q$ is {\it rig-closed} if the equivalent
conditions of Lemma \ref{restricted-lemma-rig-point} are satisfied.
\end{definition}

We will need a few lemmas which essentially tell us there are
plenty of rig-closed primes even in a relative setting.

\begin{lemma}[Rig closed point relative residue field]
\label{restricted-lemma-rig-closed-point-relative-residue-field}
\source{stacks:0GGA}
\href{https://stacks.math.columbia.edu/tag/0GGA}{\texttt{Stacks tag 0GGA}}
\group{restricted}
...
\begin{lemma}[Rig closed point relative]
\label{restricted-lemma-rig-closed-point-relative}
\source{stacks:0GGB}
\href{https://stacks.math.columbia.edu/tag/0GGB}{\texttt{Stacks tag 0GGB}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-rig-closed-point-relative-residue-field, restricted-lemma-finite-type-finite-type-red}
...
By Lemma \ref{restricted-lemma-rig-closed-point-relative-residue-field}
(and Lemma \ref{restricted-lemma-finite-type-finite-type-red})
...
\begin{lemma}[Rig closed jacobson]
\label{restricted-lemma-rig-closed-jacobson}
\source{stacks:0GGC}
\href{https://stacks.math.columbia.edu/tag/0GGC}{\texttt{Stacks tag 0GGC}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-rig-closed-point-relative-residue-field, restricted-lemma-finite-type-finite-type-red, restricted-lemma-rig-closed-point-relative}

By Lemma \ref{restricted-lemma-rig-closed-point-relative-residue-field}
(combined with Lemma \ref{restricted-lemma-finite-type-finite-type-red})
...
We conclude by Lemma \ref{restricted-lemma-rig-closed-point-relative}.
\end{proof}

\begin{lemma}[Rig closed point in image]
\label{restricted-lemma-rig-closed-point-in-image}
\source{stacks:0GGD}
\href{https://stacks.math.columbia.edu/tag/0GGD}{\texttt{Stacks tag 0GGD}}
\group{restricted}

\uses{restricted-lemma-rig-closed-point-relative}
Let $\varphi : A \to B$ be an arrow of $\textit{WAdm}^{Noeth}$
which is adic and topologically of finite type.
...
satisfy the conclusions of Lemma \ref{restricted-lemma-rig-closed-point-relative}.
\end{lemma}
...
Lemma \ref{restricted-lemma-rig-closed-point-relative}.
\end{proof}

We introduce some notation.

\begin{definition}[Completed principal localization]
\label{restricted-definition-completed-principal-localization}
\source{stacks:0GGE}
\href{https://stacks.math.columbia.edu/tag/0GGE}{\texttt{Stacks tag 0GGE}}
\group{restricted}
...
\begin{lemma}[Rig closed point in localization]
\label{restricted-lemma-rig-closed-point-in-localization}
\source{stacks:0GGF}
\href{https://stacks.math.columbia.edu/tag/0GGF}{\texttt{Stacks tag 0GGF}}
\group{restricted}
...
\begin{lemma}[Rig closed point after localization]
\label{restricted-lemma-rig-closed-point-after-localization}
\source{stacks:0GGG}
\href{https://stacks.math.columbia.edu/tag/0GGG}{\texttt{Stacks tag 0GGG}}
\group{restricted}
...
$$
\vcenter{
\begin{array}{cc}B \longrightarrow & B_{\{f\}} \\ A \longrightarrow\underset{\varphi}{\uparrow} & A_{\{f\}} \underset{\varphi_{\{f\}}}{\uparrow}\end{array}
}
\quad\text{with primes}\quad
\vcenter{
\begin{array}{ccc}\mathfrak q \longrightarrow\downarrow & \mathfrak q' \downarrow\xlongequal{} & \mathfrak q B_{\{f\}} \\ \mathfrak p \longrightarrow & \mathfrak p' & \end{array}
}
$$
such that $\mathfrak p'$ is rig-closed, i.e.,
the map $A_{\{f\}} \to B_{\{f\}}$ and the prime ideals
$\mathfrak q'$ and $\mathfrak p'$ satisfy
the equivalent conditions of Lemma \ref{restricted-lemma-rig-closed-point-relative}.
\end{lemma}

\begin{proof}
\uses{restricted-lemma-rig-closed-point-in-localization, restricted-lemma-rig-closed-point-relative, restricted-lemma-rig-closed-point-relative-residue-field}

Please see Lemma \ref{restricted-lemma-rig-closed-point-in-localization}
...
By Lemma \ref{restricted-lemma-rig-closed-point-relative} this in turn
...
\begin{lemma}[Rig closed point variables]
\label{restricted-lemma-rig-closed-point-variables}
\source{stacks:0GGH}
\href{https://stacks.math.columbia.edu/tag/0GGH}{\texttt{Stacks tag 0GGH}}
\group{restricted}
...
By Lemma \ref{restricted-lemma-rig-closed-point-relative} the ring map
...
\begin{lemma}[Rig closed point etale]
\label{restricted-lemma-rig-closed-point-etale}
\source{stacks:0GGI}
\href{https://stacks.math.columbia.edu/tag/0GGI}{\texttt{Stacks tag 0GGI}}
\group{restricted}
...
\begin{lemma}[Fibre regular]
\label{restricted-lemma-fibre-regular}
\source{stacks:0GGJ}
\href{https://stacks.math.columbia.edu/tag/0GGJ}{\texttt{Stacks tag 0GGJ}}
\group{restricted}
...
\begin{lemma}[Naively rig flat continuous]
\label{restricted-lemma-naively-rig-flat-continuous}
\source{stacks:0GGL}
\href{https://stacks.math.columbia.edu/tag/0GGL}{\texttt{Stacks tag 0GGL}}
\group{restricted}
...
\begin{definition}[Naively rig flat]
\label{restricted-definition-naively-rig-flat}
\source{stacks:0GGM}
\href{https://stacks.math.columbia.edu/tag/0GGM}{\texttt{Stacks tag 0GGM}}
\group{restricted}

\uses{restricted-lemma-naively-rig-flat-continuous}
...
Lemma \ref{restricted-lemma-naively-rig-flat-continuous}.
\end{definition}

The example below shows that this notion does not ``localize''.

\begin{example}[Recompletion not rig flat]
\label{restricted-example-recompletion-not-rig-flat}
\source{stacks:0GGN}
\href{https://stacks.math.columbia.edu/tag/0GGN}{\texttt{Stacks tag 0GGN}}
\group{restricted}
...
\begin{definition}[Rig flat continuous homomorphism]
\label{restricted-definition-rig-flat-continuous-homomorphism}
\source{stacks:0GGP}
\href{https://stacks.math.columbia.edu/tag/0GGP}{\texttt{Stacks tag 0GGP}}
\group{restricted}

\uses{restricted-definition-naively-rig-flat}
...
$$
is naively rig-flat (Definition \ref{restricted-definition-naively-rig-flat}).
\end{definition}
...
\begin{lemma}[Rig flat naive]
\label{restricted-lemma-rig-flat-naive}
\source{stacks:0GGQ}
\href{https://stacks.math.columbia.edu/tag/0GGQ}{\texttt{Stacks tag 0GGQ}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-naively-rig-flat-continuous, restricted-lemma-rig-closed-jacobson, restricted-lemma-rig-closed-point-in-localization, restricted-lemma-rig-closed-point-relative}
...
is flat over $A_{\{f\}}$, see Lemma \ref{restricted-lemma-naively-rig-flat-continuous}.
By Lemma \ref{restricted-lemma-rig-closed-jacobson} the primes
...
to the diagram
$$
\begin{array}{cc}B_\mathfrak q \longrightarrow & (B_{\{f\}})_{\mathfrak q'} \\ A_\mathfrak p \uparrow\longrightarrow & (A_{\{f\}})_{\mathfrak p'} \uparrow\end{array}
$$
...
Lemma \ref{restricted-lemma-rig-closed-point-in-localization};
...
\begin{lemma}[Rig flat base change]
\label{restricted-lemma-rig-flat-base-change}
\source{stacks:0GGR}
\href{https://stacks.math.columbia.edu/tag/0GGR}{\texttt{Stacks tag 0GGR}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-rig-closed-point-after-localization, restricted-lemma-rig-closed-point-relative, restricted-lemma-rig-closed-point-variables}
...
By Lemma \ref{restricted-lemma-rig-closed-point-after-localization}
...
$$
\begin{array}{cc}(B\{x\})_{\mathfrak q} \longrightarrow & (B_{\{f\}}\{x\})_{\mathfrak q'} \\ A\{x\} \longrightarrow\uparrow & A_{\{f\}}\{x\} \uparrow\end{array}
$$
...
This implies, via Lemma \ref{restricted-lemma-rig-closed-point-relative},
that the intermediate primes $B \cap \mathfrak q$ and
$A\{x\} \cap \mathfrak q$ are rig-closed as well.
Consider the diagram
$$
\begin{array}{cc}(B[x])_{B[x] \cap \mathfrak q} \longrightarrow & (B\{x\})_{\mathfrak q} \\ (A[x])_{A[x] \cap \mathfrak q} \longrightarrow\uparrow & (A\{x\})_{A\{x\} \cap \mathfrak q} \uparrow\end{array}
$$
of local homomorphisms of Noetherian local rings.
By Lemma \ref{restricted-lemma-rig-closed-point-variables}
...
\begin{lemma}[Rig flat local etale]
\label{restricted-lemma-rig-flat-local-etale}
\source{stacks:0GGS}
\href{https://stacks.math.columbia.edu/tag/0GGS}{\texttt{Stacks tag 0GGS}}
\group{restricted}

Consider a commutative diagram
$$
\begin{array}{cc}B \longrightarrow & B' \\ A \longrightarrow\overset{\varphi}{\uparrow} & A' \underset{\varphi'}{\uparrow}\end{array}
$$
...
\begin{proof}
\uses{restricted-lemma-rig-closed-point-after-localization, restricted-lemma-rig-closed-point-relative, restricted-lemma-rig-closed-point-etale}

Given $f \in A'$ the assumptions of the lemma remain true for the digram
$$
\begin{array}{cc}B \longrightarrow & (B')_{\{f\}} \\ A \longrightarrow\overset{\varphi}{\uparrow} & (A')_{\{f\}} \uparrow\end{array}
$$
...
is rig-closed, see Lemma \ref{restricted-lemma-rig-closed-point-after-localization}.
To be precise, here $\mathfrak q'' = \mathfrak q' B'_{\{f\}}$ and
$\mathfrak p'' = A_{\{f\}} \cap \mathfrak q''$.
Consider the diagram
$$
\begin{array}{cc}B'_{\mathfrak q'} \longrightarrow & (B'_{\{f\}})_{\mathfrak q''} \\ A \longrightarrow\uparrow & A_{\{f\}} \uparrow\end{array}
$$
We want to show that the left vertical arrow is flat.
The top horizontal arrow is faithfully flat as it is a local
...
$$
\begin{array}{cc}B_{\{f\}} \longrightarrow & B'_{\{f\}} \\ A_{\{f\}} \longrightarrow\uparrow & A'_{\{f\}} \uparrow\end{array}
$$
This reduces us to the case discussed in the next paragraph.
...
to the diagram
$$
\begin{array}{cc}B_\mathfrak q \longrightarrow & B'_{\mathfrak q'} \\ A_\mathfrak p \uparrow\longrightarrow & A'_{\mathfrak p'} \uparrow\end{array}
$$
...
Lemma \ref{restricted-lemma-rig-closed-point-etale}.
\end{proof}

\begin{lemma}[Rig flat local down]
\label{restricted-lemma-rig-flat-local-down}
\source{stacks:0GGT}
\href{https://stacks.math.columbia.edu/tag/0GGT}{\texttt{Stacks tag 0GGT}}
\group{restricted}
...
Given $f \in A$ the assumptions of the lemma remain true for the digram
$$
\begin{array}{cc}B_{\{f\}} \longrightarrow & (B')_{\{f\}} \\ A_{\{f\}} \longrightarrow\overset{\varphi}{\uparrow} & (A')_{\{f\}} \uparrow\end{array}
$$
...
\begin{lemma}[Rig flat axioms]
\label{restricted-lemma-rig-flat-axioms}
\source{stacks:0GGU}
\href{https://stacks.math.columbia.edu/tag/0GGU}{\texttt{Stacks tag 0GGU}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-finite-type, restricted-lemma-rig-flat-local-etale, restricted-lemma-rig-flat-local-down}
...
conditions (1), (2), and (3), see Lemma \ref{restricted-lemma-finite-type}.
...
from Lemmas \ref{restricted-lemma-rig-flat-local-etale} and
\ref{restricted-lemma-rig-flat-local-down}.
We omit the trivial proof of (3).
\end{proof}

\begin{lemma}[Composition rig flat continuous]
\label{restricted-lemma-composition-rig-flat-continuous}
\source{stacks:0GGV}
\href{https://stacks.math.columbia.edu/tag/0GGV}{\texttt{Stacks tag 0GGV}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-rig-flat-axioms, restricted-lemma-composition-finite-type}

The statement makes sense by Lemma \ref{restricted-lemma-rig-flat-axioms}.
...
by Lemma \ref{restricted-lemma-composition-finite-type}.
...
\begin{definition}[Rig flat]
\label{restricted-definition-rig-flat}
\source{stacks:0GGX}
\href{https://stacks.math.columbia.edu/tag/0GGX}{\texttt{Stacks tag 0GGX}}
\group{restricted}
...
\begin{lemma}[Rig flat morphisms]
\label{restricted-lemma-rig-flat-morphisms}
\source{stacks:0GGY}
\href{https://stacks.math.columbia.edu/tag/0GGY}{\texttt{Stacks tag 0GGY}}
\group{restricted}
...
\begin{proof}
\uses{restricted-definition-rig-flat, restricted-lemma-rig-flat-axioms}

The equivalence of (1) and (2) is Definition \ref{restricted-definition-rig-flat}.
The equivalence of (2), (3), and (4) follows from the fact that
being rig-flat is a local property of arrows of
$\text{WAdm}^{Noeth}$ by Lemma \ref{restricted-lemma-rig-flat-axioms}
and an application of the variant of
Formal Spaces, Lemma
\ref{formal-spaces-lemma-property-defines-property-morphisms}
for morphisms between locally Noetherian algebraic spaces
...
\begin{lemma}[Base change rig flat]
\label{restricted-lemma-base-change-rig-flat}
\source{stacks:0GGZ}
\href{https://stacks.math.columbia.edu/tag/0GGZ}{\texttt{Stacks tag 0GGZ}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-rig-flat-base-change}
...
this follows from
Lemma \ref{restricted-lemma-rig-flat-base-change}.
\end{proof}

\begin{lemma}[Composition rig flat]
\label{restricted-lemma-composition-rig-flat}
\source{stacks:0GH0}
\href{https://stacks.math.columbia.edu/tag/0GH0}{\texttt{Stacks tag 0GH0}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-composition-rig-flat-continuous}

By Formal Spaces, Remark
\ref{formal-spaces-remark-composition-variant-Noetherian}
this follows from Lemma \ref{restricted-lemma-composition-rig-flat-continuous}.
\end{proof}
...
\begin{lemma}[Rig smooth continuous]
\label{restricted-lemma-rig-smooth-continuous}
\source{stacks:0GCI}
\href{https://stacks.math.columbia.edu/tag/0GCI}{\texttt{Stacks tag 0GCI}}
\group{restricted}
...
Lemma \ref{restricted-lemma-finite-type} and there exists an ideal of definition
$I \subset B$ such that $B$ is rig-smooth over $(A, I)$, and
\item[(b)] $A \to B$ satisfies the equivalent conditions of
Lemma \ref{restricted-lemma-finite-type} and for all ideals of definition
$I \subset A$ the algebra $B$ is rig-smooth over $(A, I)$.
\end{enumerate}
\end{lemma}

\begin{proof}
\uses{restricted-definition-rig-smooth-homomorphism, restricted-remark-NL-well-defined-topological}
...
Remark \ref{restricted-remark-NL-well-defined-topological}.
\end{proof}

\begin{definition}[Rig smooth continuous homomorphism]
\label{restricted-definition-rig-smooth-continuous-homomorphism}
\source{stacks:0GCJ}
\href{https://stacks.math.columbia.edu/tag/0GCJ}{\texttt{Stacks tag 0GCJ}}
\group{restricted}

\uses{restricted-lemma-rig-smooth-continuous}
Let $\varphi : A \to B$ be a continuous ring homomorphism
between adic Noetherian topological rings, i.e., $\varphi$
is an arrow of $\textit{WAdm}^{Noeth}$. We say
$\varphi$ is {\it rig-smooth} if the equivalent conditions
of Lemma \ref{restricted-lemma-rig-smooth-continuous} hold.
\end{definition}

This defines a local property.

\begin{lemma}[Rig smooth axioms]
\label{restricted-lemma-rig-smooth-axioms}
\source{stacks:0GCK}
\href{https://stacks.math.columbia.edu/tag/0GCK}{\texttt{Stacks tag 0GCK}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-finite-type, restricted-lemma-NL-is-completion, restricted-lemma-exact-sequence-NL, restricted-lemma-transitive-lci-at-end}
...
\end{enumerate}
The equivalent conditions of Lemma \ref{restricted-lemma-finite-type} satisfy
conditions (1), (2), and (3).
Thus in verifying (1), (2), and (3) for the property
``rig-smooth'' we may already assume our ring maps satisfy
the equivalent conditions of Lemma \ref{restricted-lemma-finite-type}
in each case.
...
are zero by Lemma \ref{restricted-lemma-NL-is-completion}.
Applying Lemma \ref{restricted-lemma-exact-sequence-NL} to
...
Hence we may apply
Lemmas \ref{restricted-lemma-exact-sequence-NL} and
\ref{restricted-lemma-transitive-lci-at-end} to
...
\begin{lemma}[Base change rig smooth continuous]
\label{restricted-lemma-base-change-rig-smooth-continuous}
\source{stacks:0GCL}
\href{https://stacks.math.columbia.edu/tag/0GCL}{\texttt{Stacks tag 0GCL}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-rig-smooth-continuous, restricted-lemma-base-change-rig-smooth-homomorphism}

The statement makes sense by Lemma \ref{restricted-lemma-rig-smooth-continuous}.
To see that it is true assume we have morphisms
...
Lemma \ref{restricted-lemma-base-change-rig-smooth-homomorphism}.
\end{proof}

\begin{lemma}[Composition rig smooth continuous]
\label{restricted-lemma-composition-rig-smooth-continuous}
\source{stacks:0GCM}
\href{https://stacks.math.columbia.edu/tag/0GCM}{\texttt{Stacks tag 0GCM}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-rig-smooth-continuous, restricted-lemma-exact-sequence-NL, restricted-lemma-equivalent-with-artin-smooth}

We strongly urge the reader to find their own proof and not read the proof
that follows. The statement makes sense by
Lemma \ref{restricted-lemma-rig-smooth-continuous}.
...
By Lemma \ref{restricted-lemma-exact-sequence-NL} we obtain an exact sequence
$$
\begin{array}{cccc}C \otimes_B H^0(\NL_{B/A}^\wedge) \longrightarrow & H^0(\NL_{C/A}^\wedge) \longrightarrow & H^0(\NL_{C/B}^\wedge) \longrightarrow & 0 \\ H^{-1}(\NL_{B/A}^\wedge \otimes_B C) \longrightarrow & H^{-1}(\NL_{C/A}^\wedge) \longrightarrow & H^{-1}(\NL_{C/B}^\wedge) \nwarrow & \end{array}
$$
...
Lemma \ref{restricted-lemma-equivalent-with-artin-smooth} part (2)
combined with
More on Algebra, Lemmas \ref{more-algebra-lemma-two-term-base-change} and
\ref{more-algebra-lemma-base-change-property-ext-1-annihilated}
...
\begin{lemma}[Rig smooth rig flat]
\label{restricted-lemma-rig-smooth-rig-flat}
\source{stacks:0GH1}
\href{https://stacks.math.columbia.edu/tag/0GH1}{\texttt{Stacks tag 0GH1}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-base-change-rig-smooth-continuous, restricted-lemma-rig-smooth-axioms, restricted-lemma-rig-closed-point-after-localization, restricted-lemma-equivalent-with-artin-smooth, restricted-lemma-fibre-regular}
...
and using Lemma \ref{restricted-lemma-base-change-rig-smooth-continuous}
or by using the fact that being rig-smooth
is a local property (Lemma \ref{restricted-lemma-rig-smooth-axioms}) we see that
...
Lemma \ref{restricted-lemma-rig-closed-point-after-localization}
...
$$
\begin{array}{cc}A\{x_1, \ldots, x_n\}_{\mathfrak q} / J_\mathfrak q \longrightarrow & A_{\{f\}}\{x_1, \ldots, x_n\}_{\mathfrak q'}/
J A_{\{f\}}\{x_1, \ldots, x_n\}_{\mathfrak q'} \\ A\{x_1, \ldots, x_n\}_{\mathfrak q} \longrightarrow\uparrow & A_{\{f\}}\{x_1, \ldots, x_n\}_{\mathfrak q'} \uparrow \\ A \longrightarrow\uparrow & A_{\{f\}} \uparrow\end{array}
$$
...
given in Lemma \ref{restricted-lemma-equivalent-with-artin-smooth}
...
\end{enumerate}
By Lemma \ref{restricted-lemma-fibre-regular} the fibre ring
$$
...
\begin{lemma}[Exact sequence NL rig smooth]
\label{restricted-lemma-exact-sequence-NL-rig-smooth}
\source{stacks:0GH2}
\href{https://stacks.math.columbia.edu/tag/0GH2}{\texttt{Stacks tag 0GH2}}
\group{restricted}
...
H^{-1}(\NL_{B/A}^\wedge \otimes_B C) \to H^{-1}(\NL_{C/A}^\wedge)
$$
(see Lemma \ref{restricted-lemma-exact-sequence-NL})
is annihilated by an ideal of definition.
\end{lemma}

\begin{proof}
\uses{restricted-lemma-exact-sequence-NL, restricted-lemma-rig-smooth-rig-flat}
...
$$
is injective. As in the proof of Lemma \ref{restricted-lemma-exact-sequence-NL}
choose presentations $B = A\{x_1, \ldots, x_r\}/J$,
$C = B\{y_1, \ldots, y_s\}/J'$, and
$C = A\{x_1, \ldots, x_r, y_1, \ldots, y_s\}/K$.
Looking at the diagram in the proof of Lemma \ref{restricted-lemma-exact-sequence-NL}
...
By Lemma \ref{restricted-lemma-rig-smooth-rig-flat}
...
\begin{definition}[Rig smooth]
\label{restricted-definition-rig-smooth}
\source{stacks:0GCP}
\href{https://stacks.math.columbia.edu/tag/0GCP}{\texttt{Stacks tag 0GCP}}
\group{restricted}
...
\begin{lemma}[Rig smooth morphisms]
\label{restricted-lemma-rig-smooth-morphisms}
\source{stacks:0GCQ}
\href{https://stacks.math.columbia.edu/tag/0GCQ}{\texttt{Stacks tag 0GCQ}}
\group{restricted}
...
\begin{proof}
\uses{restricted-definition-rig-smooth, restricted-lemma-rig-smooth-axioms}

The equivalence of (1) and (2) is Definition \ref{restricted-definition-rig-smooth}.
The equivalence of (2), (3), and (4) follows from the fact that
being rig-smooth is a local property of arrows of
$\text{WAdm}^{Noeth}$ by Lemma \ref{restricted-lemma-rig-smooth-axioms}
and an application of the variant of
Formal Spaces, Lemma
\ref{formal-spaces-lemma-property-defines-property-morphisms}
for morphisms between locally Noetherian algebraic spaces
...
\begin{lemma}[Base change rig smooth]
\label{restricted-lemma-base-change-rig-smooth}
\source{stacks:0GCR}
\href{https://stacks.math.columbia.edu/tag/0GCR}{\texttt{Stacks tag 0GCR}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-base-change-rig-smooth-continuous}

By Formal Spaces, Remark
\ref{formal-spaces-remark-base-change-variant-variant-Noetherian}
and the discussion in Formal Spaces, Section
\ref{formal-spaces-section-adic},
this follows from Lemma \ref{restricted-lemma-base-change-rig-smooth-continuous}.
\end{proof}

\begin{lemma}[Composition rig smooth]
\label{restricted-lemma-composition-rig-smooth}
\source{stacks:0GCS}
\href{https://stacks.math.columbia.edu/tag/0GCS}{\texttt{Stacks tag 0GCS}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-composition-rig-smooth-continuous}

By Formal Spaces, Remark
\ref{formal-spaces-remark-composition-variant-Noetherian}
this follows from Lemma \ref{restricted-lemma-composition-rig-smooth-continuous}.
\end{proof}

\begin{lemma}[Rig smooth rig flat morphism]
\label{restricted-lemma-rig-smooth-rig-flat-morphism}
\source{stacks:0GH3}
\href{https://stacks.math.columbia.edu/tag/0GH3}{\texttt{Stacks tag 0GH3}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-rig-smooth-rig-flat}

Follows immediately from Lemma \ref{restricted-lemma-rig-smooth-rig-flat}
and the definitions.
\end{proof}
...
\begin{lemma}[Rig etale continuous]
\label{restricted-lemma-rig-etale-continuous}
\source{stacks:0GCU}
\href{https://stacks.math.columbia.edu/tag/0GCU}{\texttt{Stacks tag 0GCU}}
\group{restricted}
...
\begin{proof}
\uses{restricted-definition-rig-etale-homomorphism, restricted-remark-NL-well-defined-topological}
...
\begin{definition}[Rig etale continuous homomorphism]
\label{restricted-definition-rig-etale-continuous-homomorphism}
\source{stacks:0GCV}
\href{https://stacks.math.columbia.edu/tag/0GCV}{\texttt{Stacks tag 0GCV}}
\group{restricted}

\uses{restricted-lemma-rig-etale-continuous}
Let $\varphi : A \to B$ be a continuous ring homomorphism
between adic Noetherian topological rings, i.e., $\varphi$
is an arrow of $\textit{WAdm}^{Noeth}$. We say
$\varphi$ is {\it rig-etale} if the equivalent conditions
of Lemma \ref{restricted-lemma-rig-etale-continuous} hold.
\end{definition}

This defines a local property.

\begin{lemma}[Rig etale axioms]
\label{restricted-lemma-rig-etale-axioms}
\source{stacks:0AQL}
\href{https://stacks.math.columbia.edu/tag/0AQL}{\texttt{Stacks tag 0AQL}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-rig-smooth-axioms, restricted-lemma-finite-type, restricted-lemma-NL-is-completion, restricted-lemma-exact-sequence-NL, restricted-lemma-transitive-lci-at-end, restricted-lemma-equivalent-with-artin}

This proof is exactly the same as the proof of
Lemma \ref{restricted-lemma-rig-smooth-axioms}.
Let us recall what the statement signifies. First,
$\textit{WAdm}^{Noeth}$ is the category whose objects are
adic Noetherian topological rings and whose morphisms are
continuous ring homomorphisms. Consider a commutative diagram
...
by $I^c$. It follows from Lemma \ref{restricted-lemma-equivalent-with-artin}
...
\begin{lemma}[Base change rig etale continuous]
\label{restricted-lemma-base-change-rig-etale-continuous}
\source{stacks:0GCW}
\href{https://stacks.math.columbia.edu/tag/0GCW}{\texttt{Stacks tag 0GCW}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-rig-etale-continuous, restricted-lemma-base-change-rig-etale-homomorphism}

The statement makes sense by Lemma \ref{restricted-lemma-rig-etale-continuous}.
To see that it is true assume we have morphisms
$B \to A$ and $B \to C$ in $\textit{WAdm}^{Noeth}$
...
\begin{lemma}[Composition rig etale continuous]
\label{restricted-lemma-composition-rig-etale-continuous}
\source{stacks:0GCX}
\href{https://stacks.math.columbia.edu/tag/0GCX}{\texttt{Stacks tag 0GCX}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-rig-etale-continuous, restricted-lemma-exact-sequence-NL, restricted-lemma-equivalent-with-artin}

The statement makes sense by
Lemma \ref{restricted-lemma-rig-etale-continuous}.
...
It follows from Lemma \ref{restricted-lemma-equivalent-with-artin}
that $C$ is rig-\'etale over $(A, I)$ as desired.
\end{proof}

\begin{lemma}[Permanence rig etale continuous]
\label{restricted-lemma-permanence-rig-etale-continuous}
\source{stacks:0GCY}
\href{https://stacks.math.columbia.edu/tag/0GCY}{\texttt{Stacks tag 0GCY}}
\group{restricted}
...
\begin{definition}[Rig etale]
\label{restricted-definition-rig-etale}
\source{stacks:0AQM}
\href{https://stacks.math.columbia.edu/tag/0AQM}{\texttt{Stacks tag 0AQM}}
\group{restricted}
...
\begin{lemma}[Rig etale morphisms]
\label{restricted-lemma-rig-etale-morphisms}
\source{stacks:0GCZ}
\href{https://stacks.math.columbia.edu/tag/0GCZ}{\texttt{Stacks tag 0GCZ}}
\group{restricted}
...
\begin{proof}
\uses{restricted-definition-rig-etale, restricted-lemma-rig-etale-axioms}

The equivalence of (1) and (2) is Definition \ref{restricted-definition-rig-etale}.
The equivalence of (2), (3), and (4) follows from the fact that
being rig-\'etale is a local property of arrows of
$\text{WAdm}^{Noeth}$ by Lemma \ref{restricted-lemma-rig-etale-axioms}
and an application of the variant of
Formal Spaces, Lemma
\ref{formal-spaces-lemma-property-defines-property-morphisms}
for morphisms between locally Noetherian algebraic spaces
...
\begin{lemma}[Rig etale finite type]
\label{restricted-lemma-rig-etale-finite-type}
\source{stacks:0AQN}
\href{https://stacks.math.columbia.edu/tag/0AQN}{\texttt{Stacks tag 0AQN}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-rig-etale-axioms}

The property $P$ in Lemma \ref{restricted-lemma-rig-etale-axioms}
...
\begin{lemma}[Rig etale rig smooth morphism]
\label{restricted-lemma-rig-etale-rig-smooth-morphism}
\source{stacks:0GD0}
\href{https://stacks.math.columbia.edu/tag/0GD0}{\texttt{Stacks tag 0GD0}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-rig-etale-rig-smooth}

Follows from the definitions and
Lemma \ref{restricted-lemma-rig-etale-rig-smooth}.
\end{proof}

\begin{lemma}[Base change rig etale]
\label{restricted-lemma-base-change-rig-etale}
\source{stacks:0GD1}
\href{https://stacks.math.columbia.edu/tag/0GD1}{\texttt{Stacks tag 0GD1}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-base-change-rig-etale-continuous}

By Formal Spaces, Remark
\ref{formal-spaces-remark-base-change-variant-variant-Noetherian}
and the discussion in Formal Spaces, Section
\ref{formal-spaces-section-adic},
this follows from Lemma \ref{restricted-lemma-base-change-rig-etale-continuous}.
\end{proof}

\begin{lemma}[Composition rig etale]
\label{restricted-lemma-composition-rig-etale}
\source{stacks:0GD2}
\href{https://stacks.math.columbia.edu/tag/0GD2}{\texttt{Stacks tag 0GD2}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-composition-rig-etale-continuous}

By Formal Spaces, Remark
\ref{formal-spaces-remark-composition-variant-Noetherian}
this follows from Lemma \ref{restricted-lemma-composition-rig-etale-continuous}.
\end{proof}

\begin{lemma}[Rig etale permanence]
\label{restricted-lemma-rig-etale-permanence}
\source{stacks:0GD3}
\href{https://stacks.math.columbia.edu/tag/0GD3}{\texttt{Stacks tag 0GD3}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-permanence-rig-etale-continuous}

By Formal Spaces, Remark
\ref{formal-spaces-remark-permanence-variant-Noetherian}
this follows from Lemma \ref{restricted-lemma-permanence-rig-etale-continuous}.
\end{proof}

\begin{lemma}[Rig etale alternative permanence]
\label{restricted-lemma-rig-etale-alternative-permanence}
\source{stacks:0GH4}
\href{https://stacks.math.columbia.edu/tag/0GH4}{\texttt{Stacks tag 0GH4}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-base-change-rig-etale}

Use Lemma \ref{restricted-lemma-base-change-rig-etale} and that
$f$ is the base change of $g \circ f$ by $g$.
\end{proof}

\begin{lemma}[Closed immersion rig smooth]
\label{restricted-lemma-closed-immersion-rig-smooth}
\source{stacks:0GD4}
\href{https://stacks.math.columbia.edu/tag/0GD4}{\texttt{Stacks tag 0GD4}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-rig-etale-rig-smooth-morphism, restricted-lemma-rig-etale-morphisms, restricted-definition-rig-etale-continuous-homomorphism, restricted-definition-rig-etale-homomorphism, restricted-definition-rig-smooth, restricted-lemma-equivalent-with-artin-smooth}
...
Lemma \ref{restricted-lemma-rig-etale-rig-smooth-morphism}.

\medskip\noindent
Proof of (3) $\Rightarrow$ (2). Assume (3). By
Lemma \ref{restricted-lemma-rig-etale-morphisms}
it suffices to show that the ring maps
$B \to A$ occurring in (3) are rig-\'etale in the
sense of Definition \ref{restricted-definition-rig-etale-continuous-homomorphism}.
...
By Definition \ref{restricted-definition-rig-smooth} we see that
...
Hence by Lemma \ref{restricted-lemma-equivalent-with-artin-smooth}
...
Remark \ref{restricted-remark-rig-surjective-more-general} for a discussion
of what to do in more general cases.

\begin{definition}[Rig surjective]
\label{restricted-definition-rig-surjective}
\source{stacks:0AQQ}
\href{https://stacks.math.columbia.edu/tag/0AQQ}{\texttt{Stacks tag 0AQQ}}
\group{restricted}
...
$$
\begin{array}{cc}\text{Spf}(R') \dashrightarrow\downarrow & X \overset{f}{\downarrow} \\ \text{Spf}(R) \overset{p}{\longrightarrow} & Y\end{array}
$$
...
\begin{remark}[Rig surjective more general]
\label{restricted-remark-rig-surjective-more-general}
\source{stacks:0AQZ}
\href{https://stacks.math.columbia.edu/tag/0AQZ}{\texttt{Stacks tag 0AQZ}}
\group{restricted}

\uses{restricted-definition-rig-surjective}
The condition as formulated in Definition \ref{restricted-definition-rig-surjective}
...
\begin{lemma}[Rig-surjectivity of locally finite type morphisms is preserved under composition]
\label{restricted-lemma-composition-rig-surjective}
\source{stacks:0AQR}
\href{https://stacks.math.columbia.edu/tag/0AQR}{\texttt{Stacks tag 0AQR}}
\group{restricted}
...
\begin{lemma}[Base change rig surjective]
\label{restricted-lemma-base-change-rig-surjective}
\source{stacks:0AQS}
\href{https://stacks.math.columbia.edu/tag/0AQS}{\texttt{Stacks tag 0AQS}}
\group{restricted}
...
\begin{lemma}[Rig surjective alternative permanence]
\label{restricted-lemma-rig-surjective-alternative-permanence}
\source{stacks:0GH5}
\href{https://stacks.math.columbia.edu/tag/0GH5}{\texttt{Stacks tag 0GH5}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-base-change-rig-surjective}

Use Lemma \ref{restricted-lemma-base-change-rig-surjective} and that
$f$ is the base change of $g \circ f$ by $g$.
\end{proof}

\begin{lemma}[Permanence rig surjective]
\label{restricted-lemma-permanence-rig-surjective}
\source{stacks:0AQT}
\href{https://stacks.math.columbia.edu/tag/0AQT}{\texttt{Stacks tag 0AQT}}
\group{restricted}
...
\begin{lemma}[Etale covering rig surjective]
\label{restricted-lemma-etale-covering-rig-surjective}
\source{stacks:0AQU}
\href{https://stacks.math.columbia.edu/tag/0AQU}{\texttt{Stacks tag 0AQU}}
\group{restricted}
...
\source{stacks:0AQV}
\href{https://stacks.math.columbia.edu/tag/0AQV}{\texttt{Stacks tag 0AQV}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-base-change-rig-surjective, restricted-lemma-etale-covering-rig-surjective, restricted-lemma-composition-rig-surjective, restricted-lemma-permanence-rig-surjective}
...
By Lemma \ref{restricted-lemma-etale-covering-rig-surjective}
the morphism $\coprod g_i : \coprod Y_i \to Y$ is rig-surjective.
Hence $\coprod X \times_Y Y_i \to Y$ is rig-surjective
(Lemma \ref{restricted-lemma-composition-rig-surjective}).
Since this morphism factors through $X \to Y$ we see that $X \to Y$
is rig-surjective by Lemma \ref{restricted-lemma-permanence-rig-surjective}.
\end{proof}

\begin{lemma}[Faithfully flat rig surjective]
\label{restricted-lemma-faithfully-flat-rig-surjective}
\source{stacks:0AQX}
\href{https://stacks.math.columbia.edu/tag/0AQX}{\texttt{Stacks tag 0AQX}}
\group{restricted}
...
Remark \ref{restricted-remark-base-change} for example.
...
diagram of rings
$$
\begin{array}{ccc}(R')^\wedge & C \longleftarrow & B \longleftarrow \\ R \uparrow & R \longleftarrow\uparrow & A \longleftarrow\uparrow\end{array}
$$
which gives the desired lift.
\end{proof}

\begin{lemma}[Flat rig surjective]
\label{restricted-lemma-flat-rig-surjective}
\source{stacks:0AQY}
\href{https://stacks.math.columbia.edu/tag/0AQY}{\texttt{Stacks tag 0AQY}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-faithfully-flat-rig-surjective}

Faithful flatness implies rig-surjectivity by
Lemma \ref{restricted-lemma-faithfully-flat-rig-surjective}.
...
diagram of rings
$$
\begin{array}{cc}R' & B \longleftarrow \\ R^\wedge \uparrow & A \longleftarrow\uparrow\end{array}
$$
...
\begin{lemma}[Monomorphism rig surjective]
\label{restricted-lemma-monomorphism-rig-surjective}
\source{stacks:0AR0}
\href{https://stacks.math.columbia.edu/tag/0AR0}{\texttt{Stacks tag 0AR0}}
\group{restricted}
...
\begin{lemma}[Closed immersion rig surjective]
\label{restricted-lemma-closed-immersion-rig-surjective}
\source{stacks:0GD5}
\href{https://stacks.math.columbia.edu/tag/0GD5}{\texttt{Stacks tag 0GD5}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-base-change-rig-surjective, restricted-lemma-monomorphism-rig-surjective, restricted-lemma-upshot}
...
\medskip\noindent
Assume (1). By Lemma \ref{restricted-lemma-base-change-rig-surjective} we see that
...
According to Lemma \ref{restricted-lemma-monomorphism-rig-surjective}
...
\medskip\noindent
Assume (2). By Lemma \ref{restricted-lemma-upshot} it suffices to show
...
\begin{lemma}[Closed immersion rig smooth rig surjective]
\label{restricted-lemma-closed-immersion-rig-smooth-rig-surjective}
\source{stacks:0GD6}
\href{https://stacks.math.columbia.edu/tag/0GD6}{\texttt{Stacks tag 0GD6}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-closed-immersion-rig-smooth, restricted-lemma-closed-immersion-rig-surjective}
...
Lemmas \ref{restricted-lemma-closed-immersion-rig-smooth} and
\ref{restricted-lemma-closed-immersion-rig-surjective}.
\end{proof}

\begin{lemma}[Rig etale descent]
\label{restricted-lemma-rig-etale-descent}
\source{stacks:0GH6}
\href{https://stacks.math.columbia.edu/tag/0GH6}{\texttt{Stacks tag 0GH6}}
\group{restricted}
...
\begin{proof}
\uses{restricted-definition-rig-smooth, restricted-lemma-finite-type-morphisms, restricted-lemma-base-change-rig-smooth, restricted-lemma-base-change-rig-surjective, restricted-lemma-equivalent-with-artin-smooth, restricted-lemma-etale-covering-rig-surjective, restricted-lemma-rig-smooth-rig-flat, restricted-lemma-exact-sequence-NL, restricted-lemma-exact-sequence-NL-rig-smooth}
...
Consider a commutative diagram
$$
\begin{array}{ccc}X \times_Y V \longrightarrow\downarrow & V \downarrow\longrightarrow & W \downarrow \\ X \longrightarrow & Y \longrightarrow & Z\end{array}
$$
...
Lemma \ref{restricted-lemma-equivalent-with-artin-smooth}; some details
...
is flat by Lemma \ref{restricted-lemma-rig-smooth-rig-flat}.
Consider the associated exact sequence
$$
\begin{array}{ccccc} & H^0(\NL_{B/C}^\wedge) \otimes_B A_\mathfrak p \longrightarrow & H^0(\NL_{A/C}^\wedge)_\mathfrak p \longrightarrow & H^0(\NL_{A/B}^\wedge)_\mathfrak p \longrightarrow & 0 \\ 0 \longrightarrow & H^{-1}(\NL_{B/C}^\wedge \otimes_B A)_\mathfrak p \longrightarrow & H^{-1}(\NL_{A/C}^\wedge)_\mathfrak p \longrightarrow & H^{-1}(\NL_{A/B}^\wedge)_\mathfrak p \nwarrow & \end{array}
$$
of Lemmas \ref{restricted-lemma-exact-sequence-NL} and
...
\begin{lemma}[Flat locus]
\label{restricted-lemma-flat-locus}
\source{stacks:0GD8}
\href{https://stacks.math.columbia.edu/tag/0GD8}{\texttt{Stacks tag 0GD8}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-representable-flat}
...
representable by algebraic spaces and \'etale
are flat (Lemma \ref{restricted-lemma-representable-flat}).
...
$$
\begin{array}{cc}\coprod X'_i \longrightarrow\downarrow & \coprod X_i \downarrow \\ X' \longrightarrow & X\end{array}
$$
...
\begin{lemma}[Flat and diagonal rig surjective]
\label{restricted-lemma-flat-and-diagonal-rig-surjective}
\source{stacks:0GD9}
\href{https://stacks.math.columbia.edu/tag/0GD9}{\texttt{Stacks tag 0GD9}}
\group{restricted}

\uses{restricted-lemma-flat-locus}
...
Let $X' \subset X$ be as in Lemma \ref{restricted-lemma-flat-locus}.
If $X \to X \times_{\text{Spf}(A)} X$ is rig-\'etale and rig-surjective,
then $X' = \text{Spf}(A)$ or $X' = \emptyset$.
\end{lemma}

\begin{proof}
\uses{restricted-lemma-base-change-rig-surjective, restricted-lemma-closed-immersion-rig-smooth-rig-surjective}
...
The diagram
$$
\begin{array}{cc}X' \longrightarrow\downarrow & X' \times_{\text{Spf}(A)} X' \downarrow \\ X \longrightarrow & X \times_{\text{Spf}(A)} X\end{array}
$$
...
Lemma \ref{restricted-lemma-closed-immersion-rig-smooth-rig-surjective}.
...
\begin{lemma}[Rig monomorphism rig surjective]
\label{restricted-lemma-rig-monomorphism-rig-surjective}
\source{stacks:0GDA}
\href{https://stacks.math.columbia.edu/tag/0GDA}{\texttt{Stacks tag 0GDA}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-flat-and-diagonal-rig-surjective}
...
$$
\begin{array}{ccc}\text{Spf}(R') \longrightarrow\searrow & \text{Spf}(R) \times_Y X \longrightarrow\overset{p}{\downarrow} & X \overset{f}{\downarrow} \\  & \text{Spf}(R) \longrightarrow & Y\end{array}
$$
...
By Lemma \ref{restricted-lemma-flat-and-diagonal-rig-surjective}
...
\quad\quad
\vcenter{
\begin{array}{cc}U' \downarrow\longrightarrow & X' \underset{f}{\downarrow} \\ U \longrightarrow & X\end{array}
}
\quad\quad
\vcenter{
\begin{array}{ccc}|U'| \longrightarrow\downarrow & |X'| \overset{|f|}{\downarrow} & T' \longleftarrow\downarrow \\ |U| \longrightarrow & |X| & T \longleftarrow\end{array}
}
\quad\quad
T' = |f|^{-1}T
$$
...
$$
\begin{array}{cc}X'_{/T'} \underset{f_{/T}}{\downarrow}\longrightarrow & X' \overset{f}{\downarrow} \\ X_{/T} \longrightarrow & X\end{array}
$$
is cartesian. Please keep this fact in mind whilst reading the lemmas stated
and proved below.

\begin{lemma}[Map completions finite type]
\label{restricted-lemma-map-completions-finite-type}
\source{stacks:0AQ9}
\href{https://stacks.math.columbia.edu/tag/0AQ9}{\texttt{Stacks tag 0AQ9}}
\group{restricted}
...
\begin{lemma}[Map completions etale]
\label{restricted-lemma-map-completions-etale}
\source{stacks:0GI0}
\href{https://stacks.math.columbia.edu/tag/0GI0}{\texttt{Stacks tag 0GI0}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-map-completions-finite-type}

By the same argument as in the proof of
Lemma \ref{restricted-lemma-map-completions-finite-type} this follows from
Morphisms of Spaces, Lemma \ref{spaces-morphisms-lemma-base-change-etale}.
\end{proof}

\begin{lemma}[Closed immersion gives closed immersion]
\label{restricted-lemma-closed-immersion-gives-closed-immersion}
\source{stacks:0GDC}
\href{https://stacks.math.columbia.edu/tag/0GDC}{\texttt{Stacks tag 0GDC}}
\group{restricted}
...
\begin{lemma}[Proper gives proper]
\label{restricted-lemma-proper-gives-proper}
\source{stacks:0GDD}
\href{https://stacks.math.columbia.edu/tag/0GDD}{\texttt{Stacks tag 0GDD}}
\group{restricted}
...
\begin{lemma}[Quasi compact gives quasi compact]
\label{restricted-lemma-quasi-compact-gives-quasi-compact}
\source{stacks:0GDE}
\href{https://stacks.math.columbia.edu/tag/0GDE}{\texttt{Stacks tag 0GDE}}
\group{restricted}
...
\begin{remark}[Diagonal gives diagonal]
\label{restricted-remark-diagonal-gives-diagonal}
\source{stacks:0GDF}
\href{https://stacks.math.columbia.edu/tag/0GDF}{\texttt{Stacks tag 0GDF}}
\group{restricted}
...
\begin{lemma}[Quasi separated gives quasi separated]
\label{restricted-lemma-quasi-separated-gives-quasi-separated}
\source{stacks:0GDG}
\href{https://stacks.math.columbia.edu/tag/0GDG}{\texttt{Stacks tag 0GDG}}
\group{restricted}
...
\begin{proof}
\uses{restricted-remark-diagonal-gives-diagonal, restricted-lemma-quasi-compact-gives-quasi-compact, restricted-lemma-closed-immersion-gives-closed-immersion}
...
in Remark \ref{restricted-remark-diagonal-gives-diagonal} and
Lemmas \ref{restricted-lemma-quasi-compact-gives-quasi-compact} and
\ref{restricted-lemma-closed-immersion-gives-closed-immersion}.
\end{proof}

\begin{lemma}[Smooth gives rig smooth]
\label{restricted-lemma-smooth-gives-rig-smooth}
\source{stacks:0GDH}
\href{https://stacks.math.columbia.edu/tag/0GDH}{\texttt{Stacks tag 0GDH}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-rig-smooth, restricted-lemma-rig-smooth-morphisms}
...
Lemma \ref{restricted-lemma-rig-smooth}. We urge the reader to skip the details.
...
\ref{formal-spaces-definition-formal-algebraic-space}.
By Lemma \ref{restricted-lemma-rig-smooth-morphisms}
...
By Lemma \ref{restricted-lemma-rig-smooth} we see that
...
Lemma \ref{restricted-lemma-rig-smooth-morphisms}.
\end{proof}

\begin{lemma}[Etale gives rig etale]
\label{restricted-lemma-etale-gives-rig-etale}
\source{stacks:0AR2}
\href{https://stacks.math.columbia.edu/tag/0AR2}{\texttt{Stacks tag 0AR2}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-smooth-gives-rig-smooth, restricted-lemma-rig-smooth, restricted-lemma-rig-smooth-morphisms, restricted-lemma-rig-etale, restricted-lemma-rig-etale-morphisms}

The proof is exactly the same as the proof of
Lemma \ref{restricted-lemma-smooth-gives-rig-smooth} except with
Lemmas \ref{restricted-lemma-rig-smooth} and \ref{restricted-lemma-rig-smooth-morphisms}
replaced by
Lemmas \ref{restricted-lemma-rig-etale} and \ref{restricted-lemma-rig-etale-morphisms}
\end{proof}

\begin{lemma}[Completion proper surjective rig surjective]
\label{restricted-lemma-completion-proper-surjective-rig-surjective}
\source{stacks:0AQW}
\href{https://stacks.math.columbia.edu/tag/0AQW}{\texttt{Stacks tag 0AQW}}
\group{restricted}
...
(The statement makes sense by
Lemma \ref{restricted-lemma-map-completions-finite-type} and
...
diagram
$$
\begin{array}{ccc}\Spec(K') \longrightarrow\downarrow & U' \longrightarrow\downarrow & X' \downarrow \\ \Spec(K) \longrightarrow & U \longrightarrow & X\end{array}
$$
...
\begin{lemma}[Separated mono open diagonal rig surjective]
\label{restricted-lemma-separated-mono-open-diagonal-rig-surjective}
\source{stacks:0GDI}
\href{https://stacks.math.columbia.edu/tag/0GDI}{\texttt{Stacks tag 0GDI}}
\group{restricted}
...
\begin{proof}
\uses{restricted-remark-diagonal-gives-diagonal, restricted-lemma-completion-proper-surjective-rig-surjective}
...
Remark \ref{restricted-remark-diagonal-gives-diagonal} and
Lemma \ref{restricted-lemma-completion-proper-surjective-rig-surjective}.
\end{proof}
...
\begin{definition}[Formal modification]
\label{restricted-definition-formal-modification}
\source{stacks:0GDK}
\href{https://stacks.math.columbia.edu/tag/0GDK}{\texttt{Stacks tag 0GDK}}
\group{restricted}
...
Lemma \ref{restricted-lemma-modification-gives-formal-modification}
and indeed we will later show that every formal modification is
``formal locally'' of this type, see
Lemma \ref{restricted-lemma-formal-modifications-locally-algebraic}.
Let us compare these conditions with those in Artin's paper.

\begin{remark}[Compare formal modification artin]
\label{restricted-remark-compare-formal-modification-artin}
\source{stacks:0GDL}
\href{https://stacks.math.columbia.edu/tag/0GDL}{\texttt{Stacks tag 0GDL}}
\group{restricted}

\uses{restricted-lemma-equivalent-with-artin, restricted-lemma-base-change-rig-etale, restricted-lemma-rig-etale-permanence, restricted-lemma-closed-immersion-rig-smooth-rig-surjective, restricted-lemma-rig-monomorphism-rig-surjective}
...
Lemma \ref{restricted-lemma-equivalent-with-artin} part (\ref{item-condition-artin}).
...
See Lemmas \ref{restricted-lemma-base-change-rig-etale} and
...
Lemma \ref{restricted-lemma-rig-monomorphism-rig-surjective}.
\end{remark}

\begin{lemma}[Modification gives formal modification]
\label{restricted-lemma-modification-gives-formal-modification}
\source{stacks:0GDM}
\href{https://stacks.math.columbia.edu/tag/0GDM}{\texttt{Stacks tag 0GDM}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-proper-gives-proper, restricted-lemma-etale-gives-rig-etale, restricted-lemma-completion-proper-surjective-rig-surjective, restricted-lemma-separated-mono-open-diagonal-rig-surjective}
...
Lemmas \ref{restricted-lemma-proper-gives-proper},
\ref{restricted-lemma-etale-gives-rig-etale},
\ref{restricted-lemma-completion-proper-surjective-rig-surjective}, and
\ref{restricted-lemma-separated-mono-open-diagonal-rig-surjective}.
\end{proof}

\begin{lemma}[Base change formal modification]
\label{restricted-lemma-base-change-formal-modification}
\source{stacks:0GDN}
\href{https://stacks.math.columbia.edu/tag/0GDN}{\texttt{Stacks tag 0GDN}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-base-change-rig-etale, restricted-lemma-base-change-rig-surjective}

The morphism $f'$ is proper by
Formal Spaces, Lemma \ref{formal-spaces-lemma-base-change-proper}.
The morphism $f'$ is rig-etale by
Lemma \ref{restricted-lemma-base-change-rig-etale}.
Then morphism $f'$ is rig-surjective by
Lemma \ref{restricted-lemma-base-change-rig-surjective}. Set $X' = X \times_ Y'$.
...
which we will use in the proof of Theorem \ref{restricted-theorem-dilatations-general}.
...
\begin{lemma}[Algebraize rig etale affine]
\label{restricted-lemma-algebraize-rig-etale-affine}
\source{stacks:0AR4}
\href{https://stacks.math.columbia.edu/tag/0AR4}{\texttt{Stacks tag 0AR4}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-approximate-by-etale-over-complement}

The existence of $X'$ is a restatement of
Lemma \ref{restricted-lemma-approximate-by-etale-over-complement}.
The final statement follows from
More on Morphisms, Lemma
\ref{more-morphisms-lemma-check-smoothness-on-infinitesimal-nbhds}.
\end{proof}

\begin{lemma}[Algebraize morphism rig etale]
\label{restricted-lemma-algebraize-morphism-rig-etale}
\source{stacks:0AR3}
\href{https://stacks.math.columbia.edu/tag/0AR3}{\texttt{Stacks tag 0AR3}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-fully-faithful-etale-over-complement}
...
Lemma \ref{restricted-lemma-fully-faithful-etale-over-complement}.
\end{proof}

\begin{lemma}[Factor]
\label{restricted-lemma-factor}
\source{stacks:0AR6}
\href{https://stacks.math.columbia.edu/tag/0AR6}{\texttt{Stacks tag 0AR6}}
\group{restricted}
...
\begin{lemma}[Faithful general]
\label{restricted-lemma-faithful-general}
\source{stacks:0GI1}
\href{https://stacks.math.columbia.edu/tag/0GI1}{\texttt{Stacks tag 0GI1}}
\group{restricted}
...
Our assumptions imply we can apply Lemma \ref{restricted-lemma-factor} to the two
...
\source{stacks:0AR7}
\href{https://stacks.math.columbia.edu/tag/0AR7}{\texttt{Stacks tag 0AR7}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-faithful-general}

Consequence of the more general Lemma \ref{restricted-lemma-faithful-general}.
\end{proof}

\begin{lemma}[Equivalence relation]
\label{restricted-lemma-equivalence-relation}
\source{stacks:0AR8}
\href{https://stacks.math.columbia.edu/tag/0AR8}{\texttt{Stacks tag 0AR8}}
\group{restricted}
...
algebraic spaces, see Section \ref{restricted-section-completion-functor}.
...
\ref{more-morphisms-lemma-check-smoothness-on-infinitesimal-nbhds}.
Applying Lemma \ref{restricted-lemma-factor} to the morphisms
...
\begin{lemma}[Smash away from T]
\label{restricted-lemma-smash-away-from-T}
\source{stacks:0AR9}
\href{https://stacks.math.columbia.edu/tag/0AR9}{\texttt{Stacks tag 0AR9}}
\group{restricted}
...
\begin{proposition}[Glue modification]
\label{restricted-proposition-glue-modification}
\source{stacks:0GI3}
\href{https://stacks.math.columbia.edu/tag/0GI3}{\texttt{Stacks tag 0GI3}}
\group{restricted}
...
The uniqueness is immediate from Lemma \ref{restricted-lemma-faithful-general}.
...
Thus by Lemma \ref{restricted-lemma-faithful-general}
we see $a = b$.
...
Section \ref{restricted-section-completion-functor} except our algebraic
...
Section \ref{restricted-section-completion-functor}. We will sometimes write
...
Lemma \ref{restricted-lemma-etale-gives-rig-etale}.

\begin{lemma}[Functoriality completion functor]
\label{restricted-lemma-functoriality-completion-functor}
\source{stacks:0GDQ}
\href{https://stacks.math.columbia.edu/tag/0GDQ}{\texttt{Stacks tag 0GDQ}}
\group{restricted}
...
Then the diagram
$$
\begin{array}{cc}\mathcal{C}_{X, T} \downarrow\longrightarrow & \mathcal{C}_{X_{/T}} \downarrow \\ \mathcal{C}_{X_1, T_1} \longrightarrow & \mathcal{C}_{X_{1, /T_1}}\end{array}
$$
...
\begin{lemma}[Completion functor fully faithful]
\label{restricted-lemma-completion-functor-fully-faithful}
\source{stacks:0GDR}
\href{https://stacks.math.columbia.edu/tag/0GDR}{\texttt{Stacks tag 0GDR}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-faithful, restricted-lemma-algebraize-morphism-rig-etale, restricted-lemma-algebraize-rig-etale-affine}
...
Hence $a = b$ by Lemma \ref{restricted-lemma-faithful}.
...
Lemma \ref{restricted-lemma-algebraize-morphism-rig-etale}.
...
$$
\begin{array}{ccc}Y'_{/T} \searrow\dashrightarrow & W \downarrow\longrightarrow & V_{/T} \overset{h_{/T}}{\downarrow} \\  & Y_{/T} \overset{\alpha}{\longrightarrow} & X'_{/T}\end{array}
$$
...
By Lemma \ref{restricted-lemma-algebraize-rig-etale-affine}
...
By Lemma \ref{restricted-lemma-algebraize-morphism-rig-etale}
...
\begin{lemma}[Dilatations affine]
\label{restricted-lemma-dilatations-affine}
\source{stacks:0ARA}
\href{https://stacks.math.columbia.edu/tag/0ARA}{\texttt{Stacks tag 0ARA}}
\group{restricted}
...
Lemma \ref{restricted-lemma-smash-away-from-T}
starting with $X \amalg X$ over $X$.

\begin{proof}
\uses{restricted-lemma-completion-functor-fully-faithful, restricted-lemma-algebraize-rig-etale-affine, restricted-lemma-smash-away-from-T, restricted-lemma-equivalence-relation}

We already know the functor is fully faithful, see
Lemma \ref{restricted-lemma-completion-functor-fully-faithful}.
...
Applying Lemma \ref{restricted-lemma-equivalence-relation} we find that
...
\begin{theorem}[Dilatations general]
\label{restricted-theorem-dilatations-general}
\source{stacks:0ARB}
\href{https://stacks.math.columbia.edu/tag/0ARB}{\texttt{Stacks tag 0ARB}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-completion-functor-fully-faithful, restricted-lemma-functoriality-completion-functor, restricted-lemma-dilatations-affine}
...
Lemma \ref{restricted-lemma-functoriality-completion-functor}.
...
By Lemma \ref{restricted-lemma-dilatations-affine} applied to
...
given by Theorem \ref{restricted-theorem-dilatations-general}.
We urge the reader to skip this section.

\begin{lemma}[Output quasi compact]
\label{restricted-lemma-output-quasi-compact}
\source{stacks:0ARU}
\href{https://stacks.math.columbia.edu/tag/0ARU}{\texttt{Stacks tag 0ARU}}
\group{restricted}

\uses{restricted-theorem-dilatations-general}
With assumptions and notation as in Theorem \ref{restricted-theorem-dilatations-general}
let $f : X' \to X$ correspond to $g : W \to X_{/T}$.
Then $f$ is quasi-compact if and only if $g$ is quasi-compact.
\end{lemma}

\begin{proof}
\uses{restricted-lemma-quasi-compact-gives-quasi-compact, restricted-lemma-functoriality-completion-functor}

If $f$ is quasi-compact, then $g$ is quasi-compact by
Lemma \ref{restricted-lemma-quasi-compact-gives-quasi-compact}.
...
are quasi-compact.
By Lemma \ref{restricted-lemma-functoriality-completion-functor}
...
\begin{lemma}[Output quasi separated]
\label{restricted-lemma-output-quasi-separated}
\source{stacks:0ARV}
\href{https://stacks.math.columbia.edu/tag/0ARV}{\texttt{Stacks tag 0ARV}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-quasi-separated-gives-quasi-separated, restricted-lemma-output-quasi-compact}

If $f$ is quasi-separated, then $g$ is quasi-separated by
Lemma \ref{restricted-lemma-quasi-separated-gives-quasi-separated}.
Conversely, assume $g$ is quasi-separated. We have to show
that $f$ is quasi-separated. Exactly as in the proof
of Lemma \ref{restricted-lemma-output-quasi-compact} we may check
...
\begin{lemma}[Output separated]
\label{restricted-lemma-output-separated}
\source{stacks:0ARW}
\href{https://stacks.math.columbia.edu/tag/0ARW}{\texttt{Stacks tag 0ARW}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-quasi-separated-gives-quasi-separated, restricted-lemma-separated-mono-open-diagonal-rig-surjective, restricted-lemma-output-quasi-compact, restricted-lemma-base-change-rig-surjective, restricted-lemma-output-quasi-separated, restricted-lemma-monomorphism-rig-surjective}

If $f$ is separated, then $g$ is separated and $\Delta_g$
is rig-surjective by
Lemmas \ref{restricted-lemma-quasi-separated-gives-quasi-separated} and
\ref{restricted-lemma-separated-mono-open-diagonal-rig-surjective}.
Assume $g$ is separated and $\Delta_g$ is rig-surjective.
Exactly as in the proof of
Lemma \ref{restricted-lemma-output-quasi-compact}
...
by base change), and
Lemma \ref{restricted-lemma-base-change-rig-surjective} (being rig-surjective
...
Lemma \ref{restricted-lemma-output-quasi-separated}.
...
$$
\begin{array}{cc}\Spec(K) \longrightarrow\downarrow & X' \downarrow \\ \Spec(R) \overset{p}{\longrightarrow}\nearrow & X' \times_X X'\end{array}
$$
...
Lemma \ref{restricted-lemma-monomorphism-rig-surjective}.
...
\begin{lemma}[Output proper]
\label{restricted-lemma-output-proper}
\source{stacks:0ARX}
\href{https://stacks.math.columbia.edu/tag/0ARX}{\texttt{Stacks tag 0ARX}}
\group{restricted}

\uses{restricted-theorem-dilatations-general, restricted-definition-formal-modification}
With assumptions and notation as in Theorem \ref{restricted-theorem-dilatations-general}
let $f : X' \to X$ correspond to $g : W \to X_{/T}$.
Then $f$ is proper if and only if $g$ is a formal modification
(Definition \ref{restricted-definition-formal-modification}).
\end{lemma}

\begin{proof}
\uses{restricted-lemma-modification-gives-formal-modification, restricted-lemma-output-quasi-compact, restricted-lemma-output-separated}

If $f$ is proper, then $g$ is a formal modification by
Lemma \ref{restricted-lemma-modification-gives-formal-modification}.
Assume $g$ is a formal modification. By
Lemmas \ref{restricted-lemma-output-quasi-compact} and \ref{restricted-lemma-output-separated}
...
it suffices to show that given any commutative diagram
$$
\begin{array}{cc}\Spec(K) \longrightarrow\downarrow & X' \overset{f}{\downarrow} \\ \Spec(R) \overset{p}{\longrightarrow}\nearrow & X\end{array}
$$
where $R$ is a complete discrete valuation ring with fraction field $K$,
...
\begin{lemma}[Output etale]
\label{restricted-lemma-output-etale}
\source{stacks:0GI4}
\href{https://stacks.math.columbia.edu/tag/0GI4}{\texttt{Stacks tag 0GI4}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-map-completions-etale}

If $f$ is \'etale, then $g$ is \'etale by
Lemma \ref{restricted-lemma-map-completions-etale}.
...
\begin{theorem}[Dilatations]
\label{restricted-theorem-dilatations}
\source{stacks:0GDU}
\href{https://stacks.math.columbia.edu/tag/0GDU}{\texttt{Stacks tag 0GDU}}
\group{restricted}

\uses{restricted-definition-formal-modification}
\begin{reference}
...
$$
be a formal modification (Definition \ref{restricted-definition-formal-modification}).
...
\begin{proof}
\uses{restricted-theorem-dilatations-general, restricted-lemma-output-proper}

This follows from Theorem \ref{restricted-theorem-dilatations-general}
and Lemma \ref{restricted-lemma-output-proper}.
\end{proof}

Here is the characterization of formal modifications
as promised in Section \ref{restricted-section-formal-modifications}.

\begin{lemma}[Formal modifications locally algebraic]
\label{restricted-lemma-formal-modifications-locally-algebraic}
\source{stacks:0GDV}
\href{https://stacks.math.columbia.edu/tag/0GDV}{\texttt{Stacks tag 0GDV}}
\group{restricted}
...
\begin{proof}
\uses{restricted-lemma-base-change-formal-modification, restricted-theorem-dilatations}

The morphism $\text{Spf}(A) \times_{\mathfrak X} \mathfrak X'
\to \text{Spf}(A)$ is a formal modification by
Lemma \ref{restricted-lemma-base-change-formal-modification}.
Hence this follows from Theorem \ref{restricted-theorem-dilatations}.
\end{proof}
...
\begin{lemma}[Noetherian local ring]
\label{restricted-lemma-Noetherian-local-ring}
\source{stacks:0AE5}
\href{https://stacks.math.columbia.edu/tag/0AE5}{\texttt{Stacks tag 0AE5}}
\group{restricted}
...
\begin{proof}
\uses{restricted-theorem-dilatations-general, restricted-lemma-dilatations-affine}

Set $X = \Spec(A)$ and $T = V(I)$.
Set $X_1 = \Spec(B)$ and $T_1 = V(IB)$.
By Theorem \ref{restricted-theorem-dilatations-general} (in fact we only need
the affine case treated in Lemma \ref{restricted-lemma-dilatations-affine})
...
\begin{lemma}[Noetherian local ring properties]
\label{restricted-lemma-Noetherian-local-ring-properties}
\source{stacks:0BH5}
\href{https://stacks.math.columbia.edu/tag/0BH5}{\texttt{Stacks tag 0BH5}}
\group{restricted}

\uses{restricted-lemma-Noetherian-local-ring}
Notation and assumptions as in Lemma \ref{restricted-lemma-Noetherian-local-ring}.
...
\begin{proof}
\uses{restricted-lemma-output-quasi-compact, restricted-lemma-output-quasi-separated, restricted-lemma-output-separated, restricted-lemma-output-proper, restricted-lemma-Noetherian-local-ring}

You can deduce this for the statements
quasi-compact, quasi-separated, separated, and proper
by using Lemmas \ref{restricted-lemma-output-quasi-compact}
\ref{restricted-lemma-output-quasi-separated},
\ref{restricted-lemma-output-separated},
\ref{restricted-lemma-output-quasi-separated}, and
...
of Lemma \ref{restricted-lemma-Noetherian-local-ring}.
...
\begin{lemma}[Equivalence to completion]
\label{restricted-lemma-equivalence-to-completion}
\source{stacks:0AF7}
\href{https://stacks.math.columbia.edu/tag/0AF7}{\texttt{Stacks tag 0AF7}}
\group{restricted}
...
Lemma \ref{restricted-lemma-Noetherian-local-ring}.
\end{proof}

\begin{lemma}[Dominate by admissible blowup]
\label{restricted-lemma-dominate-by-admissible-blowup}
\source{stacks:0AE6}
\href{https://stacks.math.columbia.edu/tag/0AE6}{\texttt{Stacks tag 0AE6}}
\group{restricted}
