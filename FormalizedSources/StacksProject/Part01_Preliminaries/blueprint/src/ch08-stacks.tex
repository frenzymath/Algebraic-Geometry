...
\source{stacks:026A}
\href{https://stacks.math.columbia.edu/tag/026A}{\texttt{Stacks tag 026A}}
\group{stacks}
...
$$
\begin{array}{ccc}(g \circ g')^*f^*x
\underset{(g \circ g')^\ast \phi}{\longrightarrow}\underset{(\alpha_{g', g})_{f^*x}}{\downarrow} &  & (g \circ g')^*f^*y
\overset{(\alpha_{g', g})_{f^*y}}{\downarrow} \\ (g')^*g^*f^*x
\overset{(g')^*g^\ast \phi}{\longrightarrow} &  & (g')^*g^*f^*y\end{array}
$$
...
\begin{definition}[Mor presheaf]
\label{stacks-definition-mor-presheaf}
\source{stacks:02ZB}
\href{https://stacks.math.columbia.edu/tag/02ZB}{\texttt{Stacks tag 02ZB}}
\group{stacks}
...
\begin{lemma}[Presheaf mor map fibred categories]
\label{stacks-lemma-presheaf-mor-map-fibred-categories}
\source{stacks:042V}
\href{https://stacks.math.columbia.edu/tag/042V}{\texttt{Stacks tag 042V}}
\group{stacks}
...
Thus we may define
$$
\begin{array}{cc}\mathit{Mor}_{\mathcal{S}_1}(x, y)(f : V \to U) \xlongequal{} & \Mor_{\mathcal{S}_{1, V}}(f^\ast x, f^\ast y) \downarrow \\ \mathit{Mor}_{\mathcal{S}_2}(F(x), F(y))(f : V \to U) \xlongequal{} & \Mor_{\mathcal{S}_{2, V}}(f^\ast F(x), f^\ast F(y))\end{array}
$$
...
\source{stacks:02ZA}
\href{https://stacks.math.columbia.edu/tag/02ZA}{\texttt{Stacks tag 02ZA}}
\group{stacks}

\uses{stacks-lemma-painful, stacks-lemma-presheaf-mor-map-fibred-categories}
Suppose that $p : \mathcal{S} \to \mathcal{C}$ is fibred in groupoids.
In this case we can prove
Lemma \ref{stacks-lemma-painful}
using
...
Lemma \ref{stacks-lemma-presheaf-mor-map-fibred-categories}.
\end{remark}

\begin{lemma}[Isom as 2 fibre product]
\label{stacks-lemma-isom-as-2-fibre-product}
\source{stacks:04SI}
\href{https://stacks.math.columbia.edu/tag/04SI}{\texttt{Stacks tag 04SI}}
\group{stacks}
...
\source{stacks:026B}
\href{https://stacks.math.columbia.edu/tag/026B}{\texttt{Stacks tag 026B}}
\group{stacks}
...
diagram
$$
\begin{array}{ccc}\text{pr}_0^*X_i \underset{\text{pr}_{01}^*\varphi_{ij}}{\searrow}\underset{\text{pr}_{02}^*\varphi_{ik}}{\longrightarrow} &  & \text{pr}_2^*X_k \\  & \text{pr}_1^*X_j \underset{\text{pr}_{12}^*\varphi_{jk}}{\nearrow} & \end{array}
$$
...
$$
\begin{array}{cc}\text{pr}_0^*X_i \underset{\varphi_{ij}}{\longrightarrow}\underset{\text{pr}_0^*\psi_i}{\downarrow} & \text{pr}_1^*X_j \overset{\text{pr}_1^*\psi_j}{\downarrow} \\ \text{pr}_0^*X'_i \overset{\varphi'_{ij}}{\longrightarrow} & \text{pr}_1^*X'_j \\  & \end{array}
$$
...
Two remarks on Definition \ref{stacks-definition-descent-data} are in order.
Let $p : \mathcal{S} \to \mathcal{C}$ be a fibred category.
Let $\{f_i : U_i \to U\}_{i \in I}$, and $(X_i, \varphi_{ij})$
be as in Definition \ref{stacks-definition-descent-data}.
\begin{enumerate}
...
\source{stacks:02ZD}
\href{https://stacks.math.columbia.edu/tag/02ZD}{\texttt{Stacks tag 02ZD}}
\group{stacks}
...
\source{stacks:02ZE}
\href{https://stacks.math.columbia.edu/tag/02ZE}{\texttt{Stacks tag 02ZE}}
\group{stacks}

\uses{stacks-lemma-pullback}
With $\mathcal{U} = \{U_i \to U\}_{i \in I}$,
$\mathcal{V} = \{V_j \to V\}_{j \in J}$,
$\alpha : I \to J$, $h : U \to V$,
and $g_i : U_i \to V_{\alpha(i)}$ as in Lemma \ref{stacks-lemma-pullback}
the functor
$$
...
$\tilde h$ as we saw in Lemma \ref{stacks-lemma-pullback}.
Hence we will sometimes simply write $h^*$ to indicate
the pullback functor.

\begin{definition}[Effective descent datum]
\label{stacks-definition-effective-descent-datum}
\source{stacks:026E}
\href{https://stacks.math.columbia.edu/tag/026E}{\texttt{Stacks tag 026E}}
\group{stacks}
...
\begin{lemma}[Trivial cocycle]
\label{stacks-lemma-trivial-cocycle}
\source{stacks:026D}
\href{https://stacks.math.columbia.edu/tag/026D}{\texttt{Stacks tag 026D}}
\group{stacks}

\uses{stacks-definition-effective-descent-datum}
In the situation of
Definition \ref{stacks-definition-effective-descent-datum} part (2) the maps
...
\begin{lemma}[Compare descent condition]
\label{stacks-lemma-compare-descent-condition}
\source{stacks:0GEA}
\href{https://stacks.math.columbia.edu/tag/0GEA}{\texttt{Stacks tag 0GEA}}
\group{stacks}
...
By Lemma \ref{stacks-lemma-pullback} we can pull this back to a descent datum
...
$$
\begin{array}{ccc}\mathcal{V}_i \longrightarrow\downarrow & \mathcal{V} \longrightarrow & \mathcal{U} \downarrow \\ \{U_i \to U_i\} \longrightarrow\nearrow &  & \{U \to U\}\end{array}
$$
of morphisms of families of maps with fixed target of $\mathcal{C}$.
This diagram does not commute, but by Lemma \ref{stacks-lemma-pullback}
...
\source{stacks:026F}
\href{https://stacks.math.columbia.edu/tag/026F}{\texttt{Stacks tag 026F}}
\group{stacks}

\uses{stacks-definition-mor-presheaf}
...
Definition \ref{stacks-definition-mor-presheaf}) is a sheaf on
...
\begin{lemma}[Stack equivalences]
\label{stacks-lemma-stack-equivalences}
\source{stacks:02ZF}
\href{https://stacks.math.columbia.edu/tag/02ZF}{\texttt{Stacks tag 02ZF}}
\group{stacks}
...
\begin{lemma}[Substack]
\label{stacks-lemma-substack}
\source{stacks:04TU}
\href{https://stacks.math.columbia.edu/tag/04TU}{\texttt{Stacks tag 04TU}}
\group{stacks}
...
\begin{lemma}[Stack equivalent]
\label{stacks-lemma-stack-equivalent}
\source{stacks:042W}
\href{https://stacks.math.columbia.edu/tag/042W}{\texttt{Stacks tag 042W}}
\group{stacks}
...
\begin{proof}
\uses{stacks-lemma-presheaf-mor-map-fibred-categories}
...
$$
are identified, see
Lemma \ref{stacks-lemma-presheaf-mor-map-fibred-categories}. Hence
...
\begin{definition}[Stacks over C]
\label{stacks-definition-stacks-over-C}
\source{stacks:02ZG}
\href{https://stacks.math.columbia.edu/tag/02ZG}{\texttt{Stacks tag 02ZG}}
\group{stacks}
...
\begin{lemma}[2 product stacks]
\label{stacks-lemma-2-product-stacks}
\source{stacks:026G}
\href{https://stacks.math.columbia.edu/tag/026G}{\texttt{Stacks tag 026G}}
\group{stacks}
...
\begin{lemma}[Characterize ff]
\label{stacks-lemma-characterize-ff}
\source{stacks:04WQ}
\href{https://stacks.math.columbia.edu/tag/04WQ}{\texttt{Stacks tag 04WQ}}
\group{stacks}
...
\begin{lemma}[Characterize essentially surjective when ff]
\label{stacks-lemma-characterize-essentially-surjective-when-ff}
\source{stacks:046N}
\href{https://stacks.math.columbia.edu/tag/046N}{\texttt{Stacks tag 046N}}
\group{stacks}
...
\begin{remark}[Stack make small]
\label{stacks-remark-stack-make-small}
\source{stacks:03ZZ}
\href{https://stacks.math.columbia.edu/tag/03ZZ}{\texttt{Stacks tag 03ZZ}}
\group{stacks}

\uses{stacks-definition-stack}
...
conditions (1), (2), (3) of
Definition \ref{stacks-definition-stack}.
...
\begin{definition}[Stack in groupoids]
\label{stacks-definition-stack-in-groupoids}
\source{stacks:02ZI}
\href{https://stacks.math.columbia.edu/tag/02ZI}{\texttt{Stacks tag 02ZI}}
\group{stacks}
...
\begin{lemma}[Stack in groupoids stack]
\label{stacks-lemma-stack-in-groupoids-stack}
\source{stacks:02ZJ}
\href{https://stacks.math.columbia.edu/tag/02ZJ}{\texttt{Stacks tag 02ZJ}}
\group{stacks}
...
\begin{lemma}[Stack gives stack groupoids]
\label{stacks-lemma-stack-gives-stack-groupoids}
\source{stacks:03YI}
\href{https://stacks.math.columbia.edu/tag/03YI}{\texttt{Stacks tag 03YI}}
\group{stacks}
...
\begin{proof}
\uses{stacks-lemma-stack-equivalences}
...
Lemma \ref{stacks-lemma-stack-equivalences}. Some details omitted.
\end{proof}

\begin{lemma}[Stack in groupoids equivalent]
\label{stacks-lemma-stack-in-groupoids-equivalent}
\source{stacks:042X}
\href{https://stacks.math.columbia.edu/tag/042X}{\texttt{Stacks tag 042X}}
\group{stacks}
...
\begin{proof}
\uses{stacks-lemma-stack-in-groupoids-stack, stacks-lemma-stack-equivalent}

Follows by combining
Lemmas \ref{stacks-lemma-stack-in-groupoids-stack} and \ref{stacks-lemma-stack-equivalent}.
\end{proof}

The $2$-category of stacks in groupoids over $\mathcal{C}$
is defined as follows.

\begin{definition}[Stacks in groupoids over C]
\label{stacks-definition-stacks-in-groupoids-over-C}
\source{stacks:02ZK}
\href{https://stacks.math.columbia.edu/tag/02ZK}{\texttt{Stacks tag 02ZK}}
\group{stacks}

\uses{stacks-definition-stacks-over-C}
Let $\mathcal{C}$ be a site.
The {\it $2$-category of stacks in groupoids over $\mathcal{C}$}
is the sub $2$-category of the $2$-category of stacks
over $\mathcal{C}$ (see Definition \ref{stacks-definition-stacks-over-C})
defined as follows:
\begin{enumerate}
...
\begin{lemma}[2 product stacks in groupoids]
\label{stacks-lemma-2-product-stacks-in-groupoids}
\source{stacks:02ZL}
\href{https://stacks.math.columbia.edu/tag/02ZL}{\texttt{Stacks tag 02ZL}}
\group{stacks}
...
\begin{proof}
\uses{stacks-lemma-stack-in-groupoids-stack, stacks-lemma-2-product-stacks}

This is clear from
Categories, Lemma \ref{categories-lemma-2-product-fibred-categories}
and Lemmas \ref{stacks-lemma-stack-in-groupoids-stack}
and \ref{stacks-lemma-2-product-stacks}.
\end{proof}
...
\begin{definition}[Stack in sets]
\label{stacks-definition-stack-in-sets}
\source{stacks:042Z}
\href{https://stacks.math.columbia.edu/tag/042Z}{\texttt{Stacks tag 042Z}}
\group{stacks}
...
\begin{lemma}[When stack in sets]
\label{stacks-lemma-when-stack-in-sets}
\source{stacks:0430}
\href{https://stacks.math.columbia.edu/tag/0430}{\texttt{Stacks tag 0430}}
\group{stacks}
...
\begin{lemma}[Stack in setoids characterize]
\label{stacks-lemma-stack-in-setoids-characterize}
\source{stacks:0432}
\href{https://stacks.math.columbia.edu/tag/0432}{\texttt{Stacks tag 0432}}
\group{stacks}
...
\begin{lemma}[Stack in setoids equivalent]
\label{stacks-lemma-stack-in-setoids-equivalent}
\source{stacks:0431}
\href{https://stacks.math.columbia.edu/tag/0431}{\texttt{Stacks tag 0431}}
\group{stacks}
...
\begin{proof}
\uses{stacks-lemma-stack-in-setoids-characterize}
...
Lemma \ref{stacks-lemma-stack-in-setoids-characterize}.
\end{proof}

The $2$-category of stacks in setoids over $\mathcal{C}$
is defined as follows.

\begin{definition}[Stacks in setoids over C]
\label{stacks-definition-stacks-in-setoids-over-C}
\source{stacks:0433}
\href{https://stacks.math.columbia.edu/tag/0433}{\texttt{Stacks tag 0433}}
\group{stacks}
...
\begin{lemma}[2 product stacks in setoids]
\label{stacks-lemma-2-product-stacks-in-setoids}
\source{stacks:0434}
\href{https://stacks.math.columbia.edu/tag/0434}{\texttt{Stacks tag 0434}}
\group{stacks}
...
and
Lemmas \ref{stacks-lemma-stack-in-groupoids-stack} and
\ref{stacks-lemma-2-product-stacks}.
\end{proof}

\begin{lemma}[2 fibre product gives stack in setoids]
\label{stacks-lemma-2-fibre-product-gives-stack-in-setoids}
\source{stacks:05UI}
\href{https://stacks.math.columbia.edu/tag/05UI}{\texttt{Stacks tag 05UI}}
\group{stacks}
...
\begin{lemma}[2 fibre product stacks in setoids over stack in groupoids]
\label{stacks-lemma-2-fibre-product-stacks-in-setoids-over-stack-in-groupoids}
\source{stacks:05UJ}
\href{https://stacks.math.columbia.edu/tag/05UJ}{\texttt{Stacks tag 05UJ}}
\group{stacks}
...
\begin{proof}
\uses{stacks-lemma-2-fibre-product-gives-stack-in-setoids}

This is a special case of
Lemma \ref{stacks-lemma-2-fibre-product-gives-stack-in-setoids}
as $f_2$ is faithful.
\end{proof}

\begin{lemma}[Faithful descent]
\label{stacks-lemma-faithful-descent}
\source{stacks:06DV}
\href{https://stacks.math.columbia.edu/tag/06DV}{\texttt{Stacks tag 06DV}}
\group{stacks}

Let $\mathcal{C}$ be a site. Let
$$
\begin{array}{cc}\mathcal{T}_2 \longrightarrow\underset{G'}{\downarrow} & \mathcal{T}_1 \overset{G}{\downarrow} \\ \mathcal{S}_2 \overset{F}{\longrightarrow} & \mathcal{S}_1\end{array}
$$
...
\begin{lemma}[Stack in setoids descent]
\label{stacks-lemma-stack-in-setoids-descent}
\source{stacks:05W9}
\href{https://stacks.math.columbia.edu/tag/05W9}{\texttt{Stacks tag 05W9}}
\group{stacks}

Let $\mathcal{C}$ be a site.
Let
$$
\begin{array}{cc}\mathcal{T}_2 \longrightarrow\downarrow & \mathcal{T}_1 \overset{G}{\downarrow} \\ \mathcal{S}_2 \overset{F}{\longrightarrow} & \mathcal{S}_1\end{array}
$$
be a $2$-cartesian diagram of stacks in groupoids over $\mathcal{C}$.
If
\begin{enumerate}
...
\begin{lemma}[Relative sheaf over stack is stack]
\label{stacks-lemma-relative-sheaf-over-stack-is-stack}
\source{stacks:0CKJ}
\href{https://stacks.math.columbia.edu/tag/0CKJ}{\texttt{Stacks tag 0CKJ}}
\group{stacks}
...
\source{stacks:036Y}
\href{https://stacks.math.columbia.edu/tag/036Y}{\texttt{Stacks tag 036Y}}
\group{stacks}
...
\begin{proof}
\uses{stacks-lemma-2-product-stacks, stacks-lemma-2-product-stacks-in-groupoids, stacks-lemma-2-product-stacks-in-setoids}

The first three assertions follow from
Lemmas \ref{stacks-lemma-2-product-stacks},
\ref{stacks-lemma-2-product-stacks-in-groupoids}, and
...
\begin{lemma}[Characterize stack in setoids]
\label{stacks-lemma-characterize-stack-in-setoids}
\source{stacks:04ZM}
\href{https://stacks.math.columbia.edu/tag/04ZM}{\texttt{Stacks tag 04ZM}}
\group{stacks}
...
The result of the procedure in the following lemma will be called the
{\it stackification} of a fibred category over a site.

\begin{lemma}[Stackify]
\label{stacks-lemma-stackify}
\source{stacks:02ZN}
\href{https://stacks.math.columbia.edu/tag/02ZN}{\texttt{Stacks tag 02ZN}}
\group{stacks}
...
$$
\begin{array}{cc}x_i|_W \underset{a_{ij}|_W}{\longrightarrow}\underset{\varphi_{ii'}|_W}{\downarrow} & y_j|_W \overset{\psi_{jj'}|_W}{\downarrow} \\ x_{i'}|_W \overset{a_{i'j'}|_W}{\longrightarrow} & y_{j'}|_W\end{array}
$$
...
\begin{proof}
\uses{stacks-definition-pullback-functor}
[Less naive proof]
...
this morphism (see Definition \ref{stacks-definition-pullback-functor}).
...
\begin{lemma}[Stackify universal property]
\label{stacks-lemma-stackify-universal-property}
\source{stacks:0435}
\href{https://stacks.math.columbia.edu/tag/0435}{\texttt{Stacks tag 0435}}
\group{stacks}

\uses{stacks-lemma-stackify}
Let $\mathcal{C}$ be a site.
Let $p : \mathcal{S} \to \mathcal{C}$ be a fibred category over $\mathcal{C}$.
Let $p' : \mathcal{S}' \to \mathcal{C}$ and $G : \mathcal{S} \to \mathcal{S}'$
the stack and $1$-morphism constructed in Lemma \ref{stacks-lemma-stackify}.
...
$$
\begin{array}{ccc}\mathcal{S} \underset{F}{\longrightarrow}\underset{G}{\searrow} &  & \mathcal{X} \\  & \mathcal{S}' \underset{H}{\nearrow} & \end{array}
$$
is $2$-commutative.
\end{lemma}
...
By the result of Lemma \ref{stacks-lemma-stackify}
...
\begin{lemma}[Stackify universal property more]
\label{stacks-lemma-stackify-universal-property-more}
\source{stacks:04W9}
\href{https://stacks.math.columbia.edu/tag/04W9}{\texttt{Stacks tag 04W9}}
\group{stacks}

\uses{stacks-lemma-stackify-universal-property}
Notation and assumptions as in
Lemma \ref{stacks-lemma-stackify-universal-property}.
...
\begin{lemma}[Stackification fibre product fibred categories]
\label{stacks-lemma-stackification-fibre-product-fibred-categories}
\source{stacks:04Y1}
\href{https://stacks.math.columbia.edu/tag/04Y1}{\texttt{Stacks tag 04Y1}}
\group{stacks}
...
\begin{proof}
\uses{stacks-lemma-2-product-stacks, stacks-lemma-stackify-universal-property, stacks-lemma-characterize-ff, stacks-lemma-characterize-essentially-surjective-when-ff, stacks-lemma-stackify}
...
Lemma \ref{stacks-lemma-2-product-stacks})
...
equivalence using
Lemmas \ref{stacks-lemma-characterize-ff} and
...
Lemma \ref{stacks-lemma-stackify})
...
\begin{lemma}[Stackification inertia]
\label{stacks-lemma-stackification-inertia}
\source{stacks:06NS}
\href{https://stacks.math.columbia.edu/tag/06NS}{\texttt{Stacks tag 06NS}}
\group{stacks}
...
\begin{proof}
\uses{stacks-lemma-stackification-fibre-product-fibred-categories}

This follows from the fact that stackification is compatible
with $2$-fibre products by
Lemma \ref{stacks-lemma-stackification-fibre-product-fibred-categories}
...
\begin{lemma}[Stackify groupoids]
\label{stacks-lemma-stackify-groupoids}
\source{stacks:02ZP}
\href{https://stacks.math.columbia.edu/tag/02ZP}{\texttt{Stacks tag 02ZP}}
\group{stacks}
...
\begin{proof}
\uses{stacks-lemma-stackify, stacks-lemma-stack-in-groupoids-stack}

Apply Lemma \ref{stacks-lemma-stackify}. The result will be a
stack in groupoids by applying Lemma \ref{stacks-lemma-stack-in-groupoids-stack}.
\end{proof}

\begin{lemma}[Stackify groupoids universal property]
\label{stacks-lemma-stackify-groupoids-universal-property}
\source{stacks:0436}
\href{https://stacks.math.columbia.edu/tag/0436}{\texttt{Stacks tag 0436}}
\group{stacks}

\uses{stacks-lemma-stackify-groupoids}
Let $\mathcal{C}$ be a site.
...
Lemma \ref{stacks-lemma-stackify-groupoids}.
This construction has the following universal property: Given a stack
...
\begin{lemma}[Stackification fibre product categories fibred in groupoids]
\label{stacks-lemma-stackification-fibre-product-categories-fibred-in-groupoids}
\source{stacks:04Y2}
\href{https://stacks.math.columbia.edu/tag/04Y2}{\texttt{Stacks tag 04Y2}}
\group{stacks}
...
\begin{lemma}[Topology inherited]
\label{stacks-lemma-topology-inherited}
\source{stacks:06NU}
\href{https://stacks.math.columbia.edu/tag/06NU}{\texttt{Stacks tag 06NU}}
\group{stacks}
...
Lemma \ref{stacks-lemma-topology-inherited}
...
\begin{definition}[Topology inherited]
\label{stacks-definition-topology-inherited}
\source{stacks:06NV}
\href{https://stacks.math.columbia.edu/tag/06NV}{\texttt{Stacks tag 06NV}}
\group{stacks}

\uses{stacks-lemma-topology-inherited}
...
\begin{lemma}[Topology inherited functorial]
\label{stacks-lemma-topology-inherited-functorial}
\source{stacks:06NW}
\href{https://stacks.math.columbia.edu/tag/06NW}{\texttt{Stacks tag 06NW}}
\group{stacks}
...
\source{stacks:0CN0}
\href{https://stacks.math.columbia.edu/tag/0CN0}{\texttt{Stacks tag 0CN0}}
\group{stacks}
...
\begin{proof}
\uses{stacks-definition-topology-inherited}
...
\begin{lemma}[Stack in groupoids over stack in groupoids]
\label{stacks-lemma-stack-in-groupoids-over-stack-in-groupoids}
\source{stacks:06NX}
\href{https://stacks.math.columbia.edu/tag/06NX}{\texttt{Stacks tag 06NX}}
\group{stacks}
...
\begin{lemma}[Stack over stack]
\label{stacks-lemma-stack-over-stack}
\source{stacks:09WX}
\href{https://stacks.math.columbia.edu/tag/09WX}{\texttt{Stacks tag 09WX}}
\group{stacks}
...
\begin{proof}
\uses{stacks-definition-stack, stacks-lemma-presheaf-mor-map-fibred-categories, stacks-definition-descent-data, stacks-definition-effective-descent-datum}

We check the three conditions in Definition \ref{stacks-definition-stack}
...
$$
on $\mathcal{C}/U$, see Lemma \ref{stacks-lemma-presheaf-mor-map-fibred-categories}.
...
datum relative to this covering (Definition \ref{stacks-definition-descent-data}).
...
\source{stacks:06NZ}
\href{https://stacks.math.columbia.edu/tag/06NZ}{\texttt{Stacks tag 06NZ}}
\group{stacks}

\uses{stacks-definition-stack-in-groupoids}
...
\begin{lemma}[Gerbe equivalent]
\label{stacks-lemma-gerbe-equivalent}
\source{stacks:06P0}
\href{https://stacks.math.columbia.edu/tag/06P0}{\texttt{Stacks tag 06P0}}
\group{stacks}
...
\begin{proof}
\uses{stacks-lemma-stack-in-groupoids-equivalent}

Assume $\mathcal{S}_1$ is a gerbe over $\mathcal{C}$. By
Lemma \ref{stacks-lemma-stack-in-groupoids-equivalent}
...
\source{stacks:06P1}
\href{https://stacks.math.columbia.edu/tag/06P1}{\texttt{Stacks tag 06P1}}
\group{stacks}
...
\begin{proof}
\uses{stacks-lemma-gerbe-equivalent, stacks-lemma-stack-in-groupoids-over-stack-in-groupoids, stacks-definition-gerbe}
...
Lemma \ref{stacks-lemma-gerbe-equivalent}
...
Lemma \ref{stacks-lemma-stack-in-groupoids-over-stack-in-groupoids}
...
Definition \ref{stacks-definition-gerbe}
...
\begin{definition}[Gerbe over stack in groupoids]
\label{stacks-definition-gerbe-over-stack-in-groupoids}
\source{stacks:06P2}
\href{https://stacks.math.columbia.edu/tag/06P2}{\texttt{Stacks tag 06P2}}
\group{stacks}

\uses{stacks-lemma-when-gerbe}
...
Lemma \ref{stacks-lemma-when-gerbe}
are satisfied.
\end{definition}
...
\source{stacks:06P3}
\href{https://stacks.math.columbia.edu/tag/06P3}{\texttt{Stacks tag 06P3}}
\group{stacks}
...
\source{stacks:06R3}
\href{https://stacks.math.columbia.edu/tag/06R3}{\texttt{Stacks tag 06R3}}
\group{stacks}
...
\source{stacks:06P4}
\href{https://stacks.math.columbia.edu/tag/06P4}{\texttt{Stacks tag 06P4}}
\group{stacks}
...
\begin{lemma}[Gerbe abelian auts]
\label{stacks-lemma-gerbe-abelian-auts}
\source{stacks:0CJY}
\href{https://stacks.math.columbia.edu/tag/0CJY}{\texttt{Stacks tag 0CJY}}
\group{stacks}
...
$$
\begin{array}{ccc}\mathcal{G}|_U \downarrow\xlongequal{} &  & \mathcal{G}|_U \downarrow \\ \mathit{Aut}(x)
\overset{\alpha \mapsto \varphi \circ \alpha \circ \varphi^{-1}}{\longrightarrow} &  & \mathit{Aut}(y)\end{array}
$$
is commutative.
\end{lemma}
...
that
$$
\begin{array}{ccc}\mathit{Aut}(x) \searrow\longrightarrow &  & \mathit{Aut}(z) \\  & \mathit{Aut}(y) \nearrow & \end{array}
$$
commutes.
...
\begin{lemma}[Fibred category pushforward]
\label{stacks-lemma-fibred-category-pushforward}
\source{stacks:04WB}
\href{https://stacks.math.columbia.edu/tag/04WB}{\texttt{Stacks tag 04WB}}
\group{stacks}
...
\begin{lemma}[Stack pushforward]
\label{stacks-lemma-stack-pushforward}
\source{stacks:04WC}
\href{https://stacks.math.columbia.edu/tag/04WC}{\texttt{Stacks tag 04WC}}
\group{stacks}
...
\begin{proof}
\uses{stacks-lemma-fibred-category-pushforward}

We have seen in
Lemma \ref{stacks-lemma-fibred-category-pushforward}
...
\begin{lemma}[Stack in groupoids pushforward]
\label{stacks-lemma-stack-in-groupoids-pushforward}
\source{stacks:04WD}
\href{https://stacks.math.columbia.edu/tag/04WD}{\texttt{Stacks tag 04WD}}
\group{stacks}
...
\begin{proof}
\uses{stacks-lemma-stack-pushforward}

This follows immediately from
Lemma \ref{stacks-lemma-stack-pushforward}
and the fact that all fibre categories are groupoids.
\end{proof}

\begin{definition}[Pushforward stack]
\label{stacks-definition-pushforward-stack}
\source{stacks:04WE}
\href{https://stacks.math.columbia.edu/tag/04WE}{\texttt{Stacks tag 04WE}}
\group{stacks}
...
$$
\begin{array}{cc}V_1 \underset{\phi_1}{\downarrow}\underset{b}{\longrightarrow} & V_2 \overset{\phi_2}{\downarrow} \\ u(U_1) \overset{u(a)}{\longrightarrow} & u(U_2)\end{array}
$$
...
\source{stacks:04WF}
\href{https://stacks.math.columbia.edu/tag/04WF}{\texttt{Stacks tag 04WF}}
\group{stacks}
...
\begin{lemma}[Fibred category pullback]
\label{stacks-lemma-fibred-category-pullback}
\source{stacks:04WG}
\href{https://stacks.math.columbia.edu/tag/04WG}{\texttt{Stacks tag 04WG}}
\group{stacks}

\uses{stacks-lemma-right-multiplicative-system}
With notation and assumptions as in
Lemma \ref{stacks-lemma-right-multiplicative-system}.
...
a picture
$$
\begin{array}{ccc} &  & (U_1, V_1 \to u(U_1), x_1) \overset{(a, b, \alpha)}{\downarrow} \\ (U, V \to u(U), x) \overset{(a_2, b_2, \alpha_2)}{\longrightarrow} &  & (U_2, V_2 \to u(U_2), x_2)\end{array}
$$
...
$$
\begin{array}{ccc}(U', \phi' : V \to u(U'), x')
\underset{(c, \text{id}_V, \gamma)}{\downarrow}\underset{(a_1, b_1, \alpha_1)}{\longrightarrow} &  & (U_1, V_1 \to u(U_1), x_1) \overset{(a, b, \alpha)}{\downarrow} \\ (U, V \to u(U), x) \overset{(a_2, b_2, \alpha_2)}{\longrightarrow} &  & (U_2, V_2 \to u(U_2), x_2)\end{array}
$$
...
\begin{lemma}[Fibred groupoids category pullback]
\label{stacks-lemma-fibred-groupoids-category-pullback}
\source{stacks:04WH}
\href{https://stacks.math.columbia.edu/tag/04WH}{\texttt{Stacks tag 04WH}}
\group{stacks}

\uses{stacks-lemma-fibred-category-pullback}
With notation and assumptions as in
Lemma \ref{stacks-lemma-fibred-category-pullback}.
...
\begin{lemma}[Adjointness pullback pushforward]
\label{stacks-lemma-adjointness-pullback-pushforward}
\source{stacks:04WI}
\href{https://stacks.math.columbia.edu/tag/04WI}{\texttt{Stacks tag 04WI}}
\group{stacks}
...
\begin{proof}
\uses{stacks-lemma-fibred-category-pullback, stacks-lemma-right-multiplicative-system, stacks-lemma-fibred-category-pushforward}
...
$$
\begin{array}{cc}\phi^*\text{pr}(H(x)) \downarrow\underset{\beta}{\longrightarrow} & (\phi')^*\text{pr}(H(x')) \downarrow \\ \text{pr}(H(x)) \overset{\text{pr}(H(a, \alpha))}{\longrightarrow} & \text{pr}(H(x'))\end{array}
$$
...
\begin{definition}[Pullback stack]
\label{stacks-definition-pullback-stack}
\source{stacks:04WJ}
\href{https://stacks.math.columbia.edu/tag/04WJ}{\texttt{Stacks tag 04WJ}}
\group{stacks}
...
Lemmas \ref{stacks-lemma-stackify-groupoids} and
\ref{stacks-lemma-fibred-groupoids-category-pullback}.

\begin{lemma}[Adjointness pullback pushforward stacks]
\label{stacks-lemma-adjointness-pullback-pushforward-stacks}
\source{stacks:04WK}
\href{https://stacks.math.columbia.edu/tag/04WK}{\texttt{Stacks tag 04WK}}
\group{stacks}
...
\begin{proof}
\uses{stacks-definition-stacks-over-C, stacks-lemma-adjointness-pullback-pushforward, stacks-lemma-stackify-universal-property-more}

For $i = 1, 2$ an $i$-morphism of stacks is the same thing as a
$i$-morphism of fibred categories, see
Definition \ref{stacks-definition-stacks-over-C}.
By
Lemma \ref{stacks-lemma-adjointness-pullback-pushforward}
we have already
$$
\Mor_{\textit{Fib}/\mathcal{C}}(\mathcal{S}, u^p\mathcal{T})
=
...
Lemma \ref{stacks-lemma-stackify-universal-property-more}
...
\source{stacks:04WR}
\href{https://stacks.math.columbia.edu/tag/04WR}{\texttt{Stacks tag 04WR}}
\group{stacks}
...
\source{stacks:04WS}
\href{https://stacks.math.columbia.edu/tag/04WS}{\texttt{Stacks tag 04WS}}
\group{stacks}
...
\begin{proof}
\uses{stacks-lemma-adjointness-pullback-pushforward-stacks, stacks-lemma-characterize-essentially-surjective-when-ff, stacks-lemma-adjointness-pullback-pushforward, stacks-lemma-characterize-ff}

Note that by
Lemma \ref{stacks-lemma-adjointness-pullback-pushforward-stacks}
...
Lemma \ref{stacks-lemma-characterize-essentially-surjective-when-ff}.
...
Lemma \ref{stacks-lemma-characterize-ff}.
...
$$
\begin{array}{cc}(U', \phi : u(U) \to u(U'), x')
\underset{(c, \text{id}_{u(U)}, \gamma)}{\downarrow}\underset{(a, b, \alpha)}{\longrightarrow} & (U, \text{id} : u(U) \to u(U), y) \\ (U, \text{id} : u(U) \to u(U), x) & \end{array}
$$
...
the morphism
$$
\begin{array}{ccc}(U, \text{id} : u(U) \to u(U), x)
\underset{(\text{id}, \text{id}, \alpha \circ \gamma')}{\longrightarrow} &  & (U, \text{id} : u(U) \to u(U), y)\end{array}
$$
...
\begin{lemma}[When localization stack]
\label{stacks-lemma-when-localization-stack}
\source{stacks:04WU}
\href{https://stacks.math.columbia.edu/tag/04WU}{\texttt{Stacks tag 04WU}}
\group{stacks}
...
\begin{lemma}[Localize stacks]
\label{stacks-lemma-localize-stacks}
\source{stacks:04WV}
\href{https://stacks.math.columbia.edu/tag/04WV}{\texttt{Stacks tag 04WV}}
\group{stacks}
