...
\begin{proof}
\notready The source places the detailed construction after the reduction lemma;
it proceeds
through regularity, the Grassmannian embedding, flattening stratification,
and the valuative criterion.
\end{proof}
