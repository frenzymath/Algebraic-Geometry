...
The part-local Lean package `StacksPart08Lib/` is a port of the corresponding Horizon
`FormalizedSources/StacksProject/Part08_TopicsInModuliTheory` library. Lake metadata lives
