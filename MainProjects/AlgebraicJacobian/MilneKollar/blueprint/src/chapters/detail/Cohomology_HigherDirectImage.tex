\section{Higher direct images of quasi-coherent sheaves in positive degree}
\label{mk-chap:Cohomology_HigherDirectImage}

\section{Definition of the higher direct images}

\begin{definition}[Higher direct image]\label{mk-def:higher_direct_image}
...
\begin{lemma}[Quasi-coherence of higher direct images]
  \label{mk-lem:higher_direct_image_quasi_coherent}
  \uses{mk-def:higher_direct_image, mk-lem:higher_direct_image_affine_vanishing}
  \dcref{custom}
...
\begin{proof}
  ...
  Lemma~\ref{mk-lem:higher_direct_image_affine_vanishing}, while
...
\begin{lemma}[Relative affine vanishing]
  \label{mk-lem:higher_direct_image_affine_vanishing}
  \uses{mk-def:higher_direct_image}
  \dcref{custom}
...
\begin{proof}
  \uses{mk-def:higher_direct_image}
  By Definition~\ref{mk-def:higher_direct_image}, \(R^i f_*\mathcal{F}\) is the
...
\begin{theorem}[Flat base change, $i \geq 1$ case]
  \label{mk-thm:flat_base_change_higher}
  \uses{mk-def:higher_direct_image, mk-lem:higher_direct_image_quasi_coherent,
    mk-def:pushforward_base_change_map, mk-lem:cech_computes_cohomology,
    mk-lem:cech_flat_base_change}
  \dcref{custom}
  ...
  of Definition~\ref{mk-def:pushforward_base_change_map}) is an isomorphism
  \[
...
\begin{proof}
  \uses{mk-def:higher_direct_image, mk-lem:higher_direct_image_quasi_coherent,
    mk-def:pushforward_base_change_map}
  ...
  (Lemma~\ref{mk-lem:higher_direct_image_quasi_coherent}), \(R^i f_*\mathcal{F}\) is
