...
\end{definition}
\begin{remark}
\label{src-standard-conjectures-abelian-fourfolds-ch06-abelian-varieties-over-finite-fields-statement-1}
\source{standard-conjectures-abelian-fourfolds}
\notready
...
\end{proof}
\begin{remark}
\label{src-standard-conjectures-abelian-fourfolds-ch06-abelian-varieties-over-finite-fields-statement-3}
\source{standard-conjectures-abelian-fourfolds}
