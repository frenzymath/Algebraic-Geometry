...
\be\label{sq-zero}
\source{purity-flat-cohomology}
\ba\text{[Diagram omitted; see source PDF.]}\ea\ee
...
\be \label{eqn:exicision-prep-square} \ba\text{[Diagram omitted; see source PDF.]}
\ea\ee
\elem
...
\be \label{eqn:two-Cartesian-squares-argument} \ba\text{[Diagram omitted; see source PDF.]}
\ea \ee
