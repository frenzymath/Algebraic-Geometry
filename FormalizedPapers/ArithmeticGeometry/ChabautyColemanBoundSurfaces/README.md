...
`FormalizedPapers/ArithmeticGeometry/ChabautyColemanBoundSurfaces`.
...
- Source bundle: [`references/chabauty-coleman-bound-surfaces/`](../../../references/chabauty-coleman-bound-surfaces/)
