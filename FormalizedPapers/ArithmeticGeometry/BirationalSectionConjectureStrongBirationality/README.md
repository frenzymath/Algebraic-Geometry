...
Blueprint project under `FormalizedPapers/ArithmeticGeometry/BirationalSectionConjectureStrongBirationality`.

- Blueprint: [`blueprint/src/content.tex`](blueprint/src/content.tex)
- Direct PDF: [arXiv PDF](https://arxiv.org/pdf/2108.13397)
