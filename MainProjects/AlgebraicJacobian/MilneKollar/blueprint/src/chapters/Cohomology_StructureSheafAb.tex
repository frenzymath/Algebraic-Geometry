...
Let \(X\) be a topological space. Abelian-group-valued presheaves on the topology of opens admit sheafification, and their sheaf category admits \(\Ext\). Together with \cref{chap:Cohomology_SheafCompose}, these facts allow the structure sheaf of a scheme to be regarded as a sheaf of abelian groups.
...
\begin{theorem}[Sheafification on the topology of opens, abelian-group valued]\leanok
...
\begin{theorem}[\(\Ext\) on the topology of opens, abelian-group valued]\leanok
...
\leanok
  By \cref{thm:HasSheafify_Opens_AddCommGrp}, sheaves of abelian groups form a Grothendieck abelian category. In particular, this category has enough injectives, so the right derived functors of \(\Hom\) define its \(\Ext\) groups.
\end{proof}

\section{Structure sheaf as a sheaf of abelian groups}

\begin{definition}[Structure sheaf as a sheaf of abelian groups]\leanok
