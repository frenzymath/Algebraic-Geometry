...
\begin{definition}
\label{src-anticyclotomic-iwasawa-rational-elliptic-eisenstein-ch02-algebraic-side-statement-1}
\source{anticyclotomic-iwasawa-rational-elliptic-eisenstein}
\notready 
...
\begin{remark}
\label{src-anticyclotomic-iwasawa-rational-elliptic-eisenstein-ch02-algebraic-side-statement-2}
\source{anticyclotomic-iwasawa-rational-elliptic-eisenstein}
\notready
