...
We recall here some classical facts on quadratic forms. They will allow us to reduce Theorem \ref{mainthm} to a $p$-adic question (Proposition \ref{padicreduction}). For simplicity, we will  work only in the context we will need later, namely with non-degenerate  forms of rank $2$.
