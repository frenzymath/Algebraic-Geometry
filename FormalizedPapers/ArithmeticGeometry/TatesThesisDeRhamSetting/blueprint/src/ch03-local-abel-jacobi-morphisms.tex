...
\]
 ...
 there is a canonical trivialization
of
...
\]
 ...
 where $\sO_{\sD}(\tau)$ is the line bundle on
...
\end{equation}
 ...
 that is linear in the second coordinate.
...
\]
 ...
 Comparing to Remark \ref{r:dlog-aj-fmla}, we obtain the
claim.
...
\]
 ...
 There is an evident commutative monoid
...
\]
 ...
 that is bilinear for multiplicative monoid
...
\]
 ...
 This pairing is compatible with Contou-Carr\'ere's
...
\]
 ...
 maps into $\Gr_{\bG_m}^{\leq n}$. Indeed,
...
\end{equation}
 ...
 Indeed, our map $\vph$ is (tautologically) equivalent to
...
\]
 ...
 by the above. (As in Remark \ref{r:upsilon-ff},
...
\]
 ...
 coming from our pairings and \S \ref{ss:pairing-map}
is an isomorphism.
...
\]
 ...
 where the second equality is by finiteness of
$\Sym^m \sD^{\leq n}$.
...
\]
 ...
 from the proposition is the identity:
