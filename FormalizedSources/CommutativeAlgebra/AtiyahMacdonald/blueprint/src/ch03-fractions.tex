...
\source{atiyah-macdonald-commutative-algebra:page-0045}\uses{}
...
\label{am-prop-3-1}
\dcref{3.1}
\source{atiyah-macdonald-commutative-algebra:page-0046}\uses{}
...
\label{am-cor-3-2}
\dcref{3.2}
\source{atiyah-macdonald-commutative-algebra:page-0047}\uses{}
...
For a prime $\mathfrak{p}$, $S=A\setminus\mathfrak{p}$ gives the local ring $A_\mathfrak{p}$ with maximal
ideal $\mathfrak{p} A_\mathfrak{p}$; $S^{-1}A=0$ iff $0\in S$; $S=\{1,f,f^2,\ldots\}$ gives
$A_f$; $S=1+\mathfrak{a}$ is multiplicatively closed.
\end{remark}
...
\label{am-prop-3-3}
\dcref{3.3}
\source{atiyah-macdonald-commutative-algebra:page-0048}\uses{}
...
\label{am-cor-3-6}
\dcref{3.6}
\source{atiyah-macdonald-commutative-algebra:page-0049}\uses{}
...
$M_\mathfrak{p}=0$ for every prime $\mathfrak{p}$; $M_\mathfrak{m}=0$ for every maximal $\mathfrak{m}$.
\end{proposition}
\begin{proof}
Only the last implication needs proof.  If $x\ne0$, $\Ann(x)$ is proper and
lies in a maximal $\mathfrak{m}$.  If $x/1=0$ in $M_\mathfrak{m}$, some element outside $\mathfrak{m}$ kills
$x$, contradicting $\Ann(x)\subseteq\mathfrak{m}$.
...
\label{am-prop-3-10}
\dcref{3.10}
\source{atiyah-macdonald-commutative-algebra:page-0050}\uses{}
An $A$-module $M$ is flat iff $M_\mathfrak{p}$ is flat over $A_\mathfrak{p}$ for all primes,
equivalently iff $M_\mathfrak{m}$ is flat over $A_\mathfrak{m}$ for all maximals.
\end{proposition}
\begin{proof}
...
\dcref{3.11}
\source{atiyah-macdonald-commutative-algebra:page-0050}\uses{}
Every ideal of $S^{-1}A$ is extended.  For an ideal $\mathfrak{a}\subseteq A$,
\[
\mathfrak{a}^{ec}=\bigcup_{s\in S}(\mathfrak{a}:s),\qquad
\mathfrak{a}^e=(1)\Longleftrightarrow\mathfrak{a}\cap S\ne\varnothing.
\]
The ideal is contracted iff no element of $S$ is a zero-divisor in $A/\mathfrak{a}$.
Prime ideals of $S^{-1}A$ correspond bijectively to primes of $A$ disjoint
from $S$, by $\mathfrak{p}\leftrightarrow S^{-1}\mathfrak{p}$.  Localization commutes with finite
...
exactly the absence of $s\in S$ killing a nonzero class.  For a prime $\mathfrak{p}$,
$S^{-1}(A/\mathfrak{p})$ is a domain precisely when $\mathfrak{p}$ misses $S$, yielding the prime
...
\label{am-cor-3-12}
\dcref{3.12}
\source{atiyah-macdonald-commutative-algebra:page-0051}\uses{}
...
\dcref{3.13}
\source{atiyah-macdonald-commutative-algebra:page-0051}\uses{}
If $\mathfrak{p}$ is prime, primes of $A_\mathfrak{p}$ correspond to primes of $A$ contained in
$\mathfrak{p}$.
\uses{am-prop-3-11}
\end{corollary}
\begin{proof}
...
\label{am-prop-3-14}
\dcref{3.14}
\source{atiyah-macdonald-commutative-algebra:page-0052}\uses{}
If $M$ is finitely generated, then
$S^{-1}\Ann(M)=\Ann(S^{-1}M)$.
\end{proposition}
\begin{proof}
For a cyclic module $M\simeq A/\mathfrak{a}$, Corollary~\ref{am-cor-3-4} identifies
$S^{-1}M$ with $S^{-1}A/S^{-1}\mathfrak{a}$, whose annihilator is $S^{-1}\mathfrak{a}$.
...
\dcref{3.16}
\source{atiyah-macdonald-commutative-algebra:page-0052}\uses{}
For $f:A\to B$ and $\mathfrak{p}\in\Spec A$, $\mathfrak{p}$ is the contraction of a prime of
$B$ iff $\mathfrak{p}^{ec}=\mathfrak{p}$.
\end{proposition}
\begin{proof}
If $\mathfrak{p}=\mathfrak{q}^c$, Proposition~\ref{am-prop-1-17} gives $\mathfrak{p}^{ec}=\mathfrak{p}$.  Conversely,
let $S$ be the image of $A\setminus\mathfrak{p}$ in $B$.  The equality means
$\mathfrak{p}^e$ misses $S$; its extension to $S^{-1}B$ is proper and lies in a maximal
