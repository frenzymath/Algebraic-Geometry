...
\begin{thm}
[Combination of Theorems \ref{th:Eis Den} and \ref{th:Den Wd}]\label{src-higher-siegel-weil-unitary-nonsingular-terms-ch12-matching-of-sheaves-statement-1}
\source{higher-siegel-weil-unitary-nonsingular-terms}
...
\begin{prop}
\label{src-higher-siegel-weil-unitary-nonsingular-terms-ch12-matching-of-sheaves-statement-2}
\source{higher-siegel-weil-unitary-nonsingular-terms}
\notready
...
\begin{lemma}
\label{src-higher-siegel-weil-unitary-nonsingular-terms-ch12-matching-of-sheaves-statement-3}
\source{higher-siegel-weil-unitary-nonsingular-terms}
