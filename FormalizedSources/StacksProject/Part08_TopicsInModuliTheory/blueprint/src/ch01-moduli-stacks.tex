...
\begin{lemma}[Coherent diagonal affine fp]
...
proper over $T$. This was discussed in Section \ref{moduli-section-hom-isom}.
\end{proof}

\begin{lemma}[Coherent qs lfp]
...
\begin{proof}
\uses{moduli-lemma-coherent-diagonal-affine-fp}

To check $\Cohstack_{X/B} \to B$ is quasi-separated we have to
show that its diagonal is quasi-compact and quasi-separated.
This is immediate from Lemma \ref{moduli-lemma-coherent-diagonal-affine-fp}.
...
\begin{lemma}[Coherent existence part]
...
\begin{lemma}[Coherent functorial]
...
Analyzing the proof of Lemma \ref{moduli-lemma-coherent-functorial}
...
\begin{definition}[Situation: Numerical invariants]
...
\uses{moduli-situation-numerical}
...
\begin{proof}
\uses{moduli-lemma-coherent-qs-lfp}
...
is $\Cohstack_{X/B}$ by Lemma \ref{moduli-lemma-coherent-qs-lfp} and
...
\begin{lemma}[Finite list perfect objects]
...
$$
\begin{array}{cc}\Cohstack^P_{X/B} \longrightarrow\downarrow & \Cohstack_{X/B} \downarrow \\ \Cohstack^P_{X_i/\Spec(\Lambda_i)} \longrightarrow & \Cohstack_{X_i/\Spec(\Lambda_i)}\end{array}
$$
and hence we may appeal to Lemma \ref{moduli-lemma-open-P}
to finish the proof.
\end{proof}
...
\uses{moduli-situation-numerical, moduli-lemma-finite-list-perfect-objects}
Let $f : X \to B$ be as in the introduction to this section.
...
\begin{lemma}[Quot diagonal closed]
...
Lemma \ref{moduli-lemma-coherent-functorial}
...
By Lemma \ref{moduli-lemma-coherent-functorial}
...
\begin{lemma}[Quot quotient]
\label{moduli-lemma-quot-quotient}
\source{stacks:0DP5}
\href{https://stacks.math.columbia.edu/tag/0DP5}{\texttt{Stacks tag 0DP5}}
\group{moduli}
...
\uses{moduli-situation-numerical, moduli-lemma-open-P, moduli-lemma-finite-list-perfect-objects, moduli-example-hilbert-polynomial}
...
\begin{lemma}[Quot tensor invertible]
...
\begin{lemma}[Quot power invertible]
...
\begin{proof}
\uses{moduli-lemma-quot-s-lfp, moduli-lemma-quot-existence-part}

We already know that $X \to \Spec(\mathbf{Z})$ is separated and
locally of finite presentation (Lemma \ref{moduli-lemma-quot-s-lfp}).
We also know that $X \to \Spec(\mathbf{Z})$ satisfies the
existence part of the valuative criterion, see
Lemma \ref{moduli-lemma-quot-existence-part}.
...
\begin{proof}
\uses{moduli-lemma-quot-tensor-invertible, moduli-lemma-quot-quotient, moduli-lemma-quot-Pn}
...
By Lemma \ref{moduli-lemma-quot-tensor-invertible}
we may replace $\mathcal{F}$ by
$\mathcal{F} \otimes_{\mathcal{O}_X} \mathcal{L}^{\otimes r'}$
and $P(t)$ by $P(t + r')$.
By Lemma \ref{moduli-lemma-quot-quotient}
...
is proper in Lemma \ref{moduli-lemma-quot-Pn} we conclude.
\end{proof}

\begin{lemma}[Quot proper over base]
...
\begin{proof}
\uses{moduli-lemma-quot-closed, moduli-lemma-quot-Pn-over-base}
...
Lemma \ref{moduli-lemma-quot-closed} induces an isomorphism
...
is proper over $B$ by Lemma \ref{moduli-lemma-quot-Pn-over-base}
we conclude.
\end{proof}

\begin{lemma}[Quot qc over base]
...
\begin{proof}
\uses{moduli-lemma-quot-s-lfp, moduli-remark-quot-numerical, moduli-lemma-quot-power-invertible, moduli-lemma-quot-better-open, moduli-lemma-quot-proper-over-base}

We have already seen that $\Quotfunctor_{\mathcal{F}/X/B} \to B$
is separated and locally of finite presentation, see
Lemma \ref{moduli-lemma-quot-s-lfp}. Thus it suffices to show that
the open subspace $\Quotfunctor^P_{\mathcal{F}/X/B}$
of Remark \ref{moduli-remark-quot-numerical} is quasi-compact over $B$.
...
by a positive power, see Lemma \ref{moduli-lemma-quot-power-invertible}.
...
\begin{lemma}[Hilb diagonal closed]
...
Hence this follows from Lemma \ref{moduli-lemma-quot-diagonal-closed}.
\end{proof}

\begin{lemma}[Hilb s lfp]
...
\begin{proof}
\uses{moduli-lemma-hilb-diagonal-closed}

To check $\Hilbfunctor_{X/B} \to B$ is separated we have to
show that its diagonal is a closed immersion. This
is true by Lemma \ref{moduli-lemma-hilb-diagonal-closed}.
The second statement is part of
Quot, Proposition \ref{quot-proposition-hilb}.
\end{proof}

\begin{lemma}[Hilb existence part]
...
\begin{proof}
\uses{moduli-lemma-quot-existence-part}

In Quot, Lemma \ref{quot-lemma-hilb-is-quot} we have seen that
$\Hilbfunctor_{X/B} = \Quotfunctor_{\mathcal{O}_X/X/B}$.
Hence this follows from Lemma \ref{moduli-lemma-quot-existence-part}.
\end{proof}

\begin{lemma}[Hilb open]
...
\begin{lemma}[Hilb closed]
\label{moduli-lemma-hilb-closed}
\source{stacks:0DPF}
\href{https://stacks.math.columbia.edu/tag/0DPF}{\texttt{Stacks tag 0DPF}}
\group{moduli}
...
\begin{proof}
\uses{moduli-lemma-quot-quotient}
...
Lemma \ref{moduli-lemma-quot-quotient} for the map
...
\uses{moduli-remark-quot-numerical}
Let $f : X \to B$ be as in the introduction to this section.
Let $I$ be a set and for $i \in I$ let $E_i \in D(\mathcal{O}_X)$ be perfect.
...
\begin{lemma}[Hilb proper over base]
...
\begin{proof}
\uses{moduli-lemma-quot-proper-over-base}
...
\begin{proof}
\uses{moduli-lemma-quot-qc-over-base}

Recall that $\Hilbfunctor_{X/B} = \Quotfunctor_{\mathcal{O}_X/X/B}$, see
Quot, Lemma \ref{quot-lemma-hilb-is-quot}.
Thus this lemma is an immediate consequence of
Lemma \ref{moduli-lemma-quot-qc-over-base}.
\end{proof}
...
\begin{lemma}[Pic diagonal affine fp]
...
Lemma \ref{moduli-lemma-coherent-diagonal-affine-fp}.
\end{proof}

\begin{lemma}[Pic qs lfp]
...
$\Picardstack_{X/B}$ is an open substack of
$\Cohstack_{X/B}$. Hence this follows from
Lemma \ref{moduli-lemma-coherent-qs-lfp}.
\end{proof}

\begin{lemma}[Pic existence part]
...
\begin{proof}
\uses{moduli-lemma-pic-qs-lfp}

We already know that $\Picardstack_{X/B} \to B$ is
locally of finite presentation, see Lemma \ref{moduli-lemma-pic-qs-lfp}.
...
\begin{lemma}[Pic gerbe over pic functor]
...
\begin{lemma}[Pic functor diagonal qc immersion]
...
\begin{proof}
\uses{moduli-lemma-pic-diagonal-affine-fp, moduli-lemma-pic-gerbe-over-pic-functor}
...
\begin{proof}
\uses{moduli-lemma-pic-functor-diagonal-qc-immersion, moduli-lemma-pic-gerbe-over-pic-functor, moduli-lemma-pic-qs-lfp}
...
Lemma \ref{moduli-lemma-pic-functor-diagonal-qc-immersion}.
Since the morphism $\Picardstack_{X/B} \to \Picardfunctor_{X/B}$
is surjective, flat, and locally of finite presentation
(by Lemma \ref{moduli-lemma-pic-gerbe-over-pic-functor} and
...
This follows
from Lemma \ref{moduli-lemma-pic-qs-lfp}.
\end{proof}

\begin{lemma}[Pic functor uniqueness part]
...
\begin{proof}
\uses{moduli-lemma-pic-gerbe-over-pic-functor}
...
(surjective and flat by Lemma \ref{moduli-lemma-pic-gerbe-over-pic-functor} and
Morphisms of Stacks, Lemma \ref{stacks-morphisms-lemma-gerbe-fppf})
...
\begin{lemma}[Pic functor curves smooth]
...
\begin{proof}
\uses{moduli-lemma-pic-curves-smooth, moduli-lemma-pic-gerbe-over-pic-functor}

By Lemma \ref{moduli-lemma-pic-curves-smooth} we know that
$\Picardstack_{X/B} \to B$ is smooth. The morphism
$\Picardstack_{X/B} \to \Picardfunctor_{X/B}$ is surjective
and smooth by combining Lemma \ref{moduli-lemma-pic-gerbe-over-pic-functor} with
...
\begin{lemma}[Mor diagonal closed]
...
Lemma \ref{moduli-lemma-hilb-diagonal-closed}.
\end{proof}

\begin{lemma}[Mor s lfp]
...
\begin{proof}
\uses{moduli-lemma-Mor-diagonal-closed}

To check $\mathit{Mor}_B(Y, X) \to B$ is separated we have to
show that its diagonal is a closed immersion. This
is true by Lemma \ref{moduli-lemma-Mor-diagonal-closed}.
The second statement is part of
Quot, Proposition \ref{quot-proposition-Mor}.
\end{proof}

\begin{lemma}[Isom in Mor]
\label{moduli-lemma-Isom-in-Mor}
\source{stacks:0DPP}
\href{https://stacks.math.columbia.edu/tag/0DPP}{\texttt{Stacks tag 0DPP}}
\group{moduli}
...
\uses{moduli-remark-hilb-numerical}
...
\begin{proof}
\uses{moduli-lemma-Mor-s-lfp, moduli-remark-Mor-numerical, moduli-lemma-hilb-qc-over-base}

By Lemma \ref{moduli-lemma-Mor-s-lfp} the morphism $\mathit{Mor}_B(Y, X) \to B$
...
of Remark \ref{moduli-remark-Mor-numerical} is quasi-compact over $B$.
...
we see that $\mathcal{M}$ is ample. By Lemma \ref{moduli-lemma-hilb-qc-over-base}
...
\begin{lemma}[Polarized diagonal separated fp]
...
\begin{proof}
\uses{moduli-lemma-Mor-s-lfp, moduli-lemma-Isom-in-Mor, moduli-remark-Mor-numerical, moduli-lemma-Mor-qc-over-base}
...
\mathit{Isom}_U(Y, X)
$$
Since we have seen in Lemmas \ref{moduli-lemma-Mor-s-lfp} and
...
$\mathit{Isom}(\mathcal{N}_T, f^*\mathcal{L}_T)$
is the algebraic space discussed in Section \ref{moduli-section-hom-isom}.
...
$\mathit{Mor}_U(Y, X)$ (see Lemma \ref{moduli-lemma-Isom-in-Mor} and
...
presentation over $U$ by Lemma \ref{moduli-lemma-Mor-qc-over-base}.
...
\begin{proof}
\uses{moduli-lemma-polarized-diagonal-separated-fp}

To check $\Polarizedstack \to \Spec(\mathbf{Z})$ is quasi-separated we have to
show that its diagonal is quasi-compact and quasi-separated.
This is immediate from Lemma \ref{moduli-lemma-polarized-diagonal-separated-fp}.
...
\begin{proof}
\uses{moduli-lemma-polarized-qs-lfp, moduli-lemma-hilb-proper-over-base}
...
by Lemma \ref{moduli-lemma-polarized-qs-lfp} and
Morphisms of Stacks, Lemma
\ref{stacks-morphisms-lemma-locally-finite-type-locally-noetherian}).
...
\medskip\noindent
By Lemma \ref{moduli-lemma-hilb-proper-over-base} the algebraic space
$$
H =
...
\begin{lemma}[Complexes diagonal affine fp]
...
\begin{proof}
\uses{moduli-lemma-complexes-diagonal-affine-fp}

To check $\Complexesstack_{X/B} \to B$ is quasi-separated we have to
show that its diagonal is quasi-compact and quasi-separated.
This is immediate from Lemma \ref{moduli-lemma-complexes-diagonal-affine-fp}.
