...
\begin{remark}
\label{src-canonical-representations-surface-groups-ch10-questions-and-examples-statement-1}
\source{canonical-representations-surface-groups}
\notready
...
\begin{example}
\label{src-canonical-representations-surface-groups-ch10-questions-and-examples-statement-2}
\source{canonical-representations-surface-groups}
\notready
...
\begin{remark}
\label{src-canonical-representations-surface-groups-ch10-questions-and-examples-statement-3}
\source{canonical-representations-surface-groups}
\notready
