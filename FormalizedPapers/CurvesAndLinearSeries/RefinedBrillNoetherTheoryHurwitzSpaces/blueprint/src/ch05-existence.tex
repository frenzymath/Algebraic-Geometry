...
\end{Lemma}
\begin{proof}
Use the natural commutative square of $f$, $f\times\mathrm{id}$, and the
projections $\alpha$, $\beta$, $\nu$, and $\pi$ from the product spaces.
Let $H = f^*(\O_{\pp^1}(1))$.
...
\begin{Example} \label{revisit}\dcref{5.3}
\source{refined-brill-noether-theory-hurwitz-spaces}
