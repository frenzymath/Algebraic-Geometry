...
\begin{proposition}
\label{src-no-enriques-surface-over-the-integers-ch08-counting-points-over-finite-fields-statement-1}
\source{no-enriques-surface-over-the-integers}
\notready
...
\begin{corollary}
\label{src-no-enriques-surface-over-the-integers-ch08-counting-points-over-finite-fields-statement-2}
\source{no-enriques-surface-over-the-integers}
\notready
...
\begin{corollary}
\label{src-no-enriques-surface-over-the-integers-ch08-counting-points-over-finite-fields-statement-3}
\source{no-enriques-surface-over-the-integers}
\notready
