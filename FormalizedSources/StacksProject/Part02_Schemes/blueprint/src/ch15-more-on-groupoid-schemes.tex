...
\vcenter{
\begin{array}{cc}R \longrightarrow\downarrow & U \downarrow \\ U \longrightarrow & [U/R]\end{array}
}
\end{equation}
...
\begin{lemma}[Sheaf differentials]
\label{more-groupoids-lemma-sheaf-differentials}
\source{stacks:04R9}
\href{https://stacks.math.columbia.edu/tag/04R9}{\texttt{Stacks tag 04R9}}
\group{more-groupoids}
...
$$
\begin{array}{cccc}R \underset{(1, i)}{\longrightarrow}\underset{t}{\downarrow} & R \times_{s, U, t} R \overset{c}{\downarrow}\underset{(\text{pr}_0, i \circ \text{pr}_1)}{\longrightarrow} &  & R \times_{t, U, t} R \\ U \overset{e}{\longrightarrow} & R &  & \end{array}
$$
...
$$
\begin{array}{ccc}A \underset{t}{\searrow}\overset{1}{\searrow} &  &  \\  & B \overset{e}{\longrightarrow} & A \\ A \overset{s}{\nearrow}\underset{1}{\nearrow} &  & \end{array}
$$
...
\begin{lemma}[First order structure c]
\label{more-groupoids-lemma-first-order-structure-c}
\source{stacks:0CK4}
\href{https://stacks.math.columbia.edu/tag/0CK4}{\texttt{Stacks tag 0CK4}}
\group{more-groupoids}
...
\source{stacks:04LH}
\href{https://stacks.math.columbia.edu/tag/04LH}{\texttt{Stacks tag 04LH}}
\group{more-groupoids}
...
$$
\begin{array}{ccc}h : U' \times_{g, U, t} R \underset{\text{pr}_1}{\longrightarrow} & R \underset{s}{\longrightarrow} & U.\end{array}
$$
...
$$
\begin{array}{ccc}U' \times_{g, U, t} R \times_{t, U, t} R
\underset{\text{pr}_{12}}{\longrightarrow}\overset{\text{pr}_{02}}{\downarrow}\underset{\text{pr}_{01}}{\downarrow} &  & R \times_{t, U, t} R
\overset{\text{pr}_1}{\downarrow}\underset{\text{pr}_0}{\downarrow} \\ U' \times_{g, U, t} R \overset{\text{pr}_1}{\longrightarrow} &  & R\end{array}
$$
...
$$
\begin{array}{ccc}U' \times_{g, U, t} R \times_{t, U, t} R
\underset{c \circ (i, 1)}{\longrightarrow}\overset{\text{pr}_{02}}{\downarrow}\underset{\text{pr}_{01}}{\downarrow} &  & R
\overset{s}{\downarrow}\underset{t}{\downarrow} \\ U' \times_{g, U, t} R \overset{h}{\longrightarrow} &  & U\end{array}
$$
...
\source{stacks:04LI}
\href{https://stacks.math.columbia.edu/tag/04LI}{\texttt{Stacks tag 04LI}}
\group{more-groupoids}

Warning:
Lemma \ref{more-groupoids-lemma-local-source}
...
\source{stacks:047W}
\href{https://stacks.math.columbia.edu/tag/047W}{\texttt{Stacks tag 047W}}
\group{more-groupoids}

Notwithstanding the warning in
Remark \ref{more-groupoids-remark-local-source-warning}
...
\begin{lemma}[Property invariant]
\label{more-groupoids-lemma-property-invariant}
\source{stacks:03JC}
\href{https://stacks.math.columbia.edu/tag/03JC}{\texttt{Stacks tag 03JC}}
\group{more-groupoids}
...
\begin{lemma}[Property G invariant]
\label{more-groupoids-lemma-property-G-invariant}
\source{stacks:06QQ}
\href{https://stacks.math.columbia.edu/tag/06QQ}{\texttt{Stacks tag 06QQ}}
\group{more-groupoids}
...
Lemma \ref{more-groupoids-lemma-two-fibres}
...
\begin{lemma}[Two fibres]
\label{more-groupoids-lemma-two-fibres}
\source{stacks:02YF}
\href{https://stacks.math.columbia.edu/tag/02YF}{\texttt{Stacks tag 02YF}}
\group{more-groupoids}
...
\source{stacks:0460}
\href{https://stacks.math.columbia.edu/tag/0460}{\texttt{Stacks tag 0460}}
\group{more-groupoids}
...
$\mathcal{R} =$``flat and locally of finite presentation'', and
$\mathcal{P}=$``Cohen-Macaulay'', see
Remark \ref{more-groupoids-remark-local-source-apply}.
...
\begin{lemma}[Restrict preserves type]
\label{more-groupoids-lemma-restrict-preserves-type}
\source{stacks:04MP}
\href{https://stacks.math.columbia.edu/tag/04MP}{\texttt{Stacks tag 04MP}}
\group{more-groupoids}
...
\begin{lemma}[Restrict property]
\label{more-groupoids-lemma-restrict-property}
\source{stacks:04MV}
\href{https://stacks.math.columbia.edu/tag/04MV}{\texttt{Stacks tag 04MV}}
\group{more-groupoids}
...
\begin{lemma}[Double restrict]
\label{more-groupoids-lemma-double-restrict}
\source{stacks:04MW}
\href{https://stacks.math.columbia.edu/tag/04MW}{\texttt{Stacks tag 04MW}}
\group{more-groupoids}
...
$$
\begin{array}{ccc}U'' \times_{g', U', t} R' \overset{h'}{\downarrow} & (U' \times_{g, U, t} R) \times_U (U'' \times_{g'', U, t} R)
\longleftarrow\longrightarrow\downarrow & U'' \times_{g'', U, t} R \underset{h''}{\downarrow} \\ U' & U' \times_{g, U, t} R \underset{\text{pr}_0}{\longleftarrow}\overset{h}{\longrightarrow} & U\end{array}
$$
...
$$
\begin{array}{ccc}t(r_0) = g(u') & s(r_0) = s(r_1) \underset{r_0}{\longleftarrow}\overset{r_1}{\longrightarrow} & t(r_1) = g(g'(u''))\end{array}
$$
...
$$
\begin{array}{ccc}s(p) \overset{p}{\longrightarrow} & g(v') = g(u'_1) \overset{r}{\longrightarrow} & g(u'_0) = g(g'(v''))\end{array}
$$
...
\begin{lemma}[Double restrict property]
\label{more-groupoids-lemma-double-restrict-property}
\source{stacks:04MX}
\href{https://stacks.math.columbia.edu/tag/04MX}{\texttt{Stacks tag 04MX}}
\group{more-groupoids}
...
Lemma \ref{more-groupoids-lemma-double-restrict}.
...
\begin{lemma}[Groupoid on field open multiplication]
\label{more-groupoids-lemma-groupoid-on-field-open-multiplication}
\source{stacks:04LM}
\href{https://stacks.math.columbia.edu/tag/04LM}{\texttt{Stacks tag 04LM}}
\group{more-groupoids}
...
\begin{lemma}[Groupoid on field separated]
\label{more-groupoids-lemma-groupoid-on-field-separated}
\source{stacks:04LN}
\href{https://stacks.math.columbia.edu/tag/04LN}{\texttt{Stacks tag 04LN}}
\group{more-groupoids}
...
\begin{lemma}[Groupoid on field homogeneous]
\label{more-groupoids-lemma-groupoid-on-field-homogeneous}
\source{stacks:04LP}
\href{https://stacks.math.columbia.edu/tag/04LP}{\texttt{Stacks tag 04LP}}
\group{more-groupoids}
...
and a diagram
$$
\begin{array}{cccc}R & R \times_{s, \Spec(k)} \Spec(k')
\underset{\text{pr}_0}{\longleftarrow}\overset{\varphi}{\longrightarrow} & R \times_{s, \Spec(k)} \Spec(k')
\overset{\text{pr}_0}{\longrightarrow} & R\end{array}
$$
...
\begin{lemma}[Restrict groupoid on field]
\label{more-groupoids-lemma-restrict-groupoid-on-field}
\source{stacks:04LQ}
\href{https://stacks.math.columbia.edu/tag/04LQ}{\texttt{Stacks tag 04LQ}}
\group{more-groupoids}
...
$$
\begin{array}{ccc}R' \downarrow\longrightarrow\underset{t'}{\downarrow}\overset{s'}{\longrightarrow}\searrow & R \times_{s, U} U' \longrightarrow\downarrow & U' \downarrow \\ U' \times_{U, t} R \downarrow\longrightarrow & R \overset{s}{\longrightarrow}\underset{t}{\downarrow} & U \\ U' \longrightarrow & U & \end{array}
$$
...
\begin{lemma}[Groupoid on field explain points]
\label{more-groupoids-lemma-groupoid-on-field-explain-points}
\source{stacks:04LR}
\href{https://stacks.math.columbia.edu/tag/04LR}{\texttt{Stacks tag 04LR}}
\group{more-groupoids}
...
$$
\begin{array}{ccc}k' & k' \overset{1}{\longleftarrow} &  \\ k' \overset{\tau}{\uparrow} & \kappa(r) \overset{\sigma}{\nwarrow} & k \overset{s}{\longleftarrow}\underset{i}{\nwarrow} \\  & k \overset{i}{\nwarrow}\underset{t}{\uparrow} & \end{array}
$$
...
\begin{lemma}[Groupoid on field move point]
\label{more-groupoids-lemma-groupoid-on-field-move-point}
\source{stacks:04LS}
\href{https://stacks.math.columbia.edu/tag/04LS}{\texttt{Stacks tag 04LS}}
\group{more-groupoids}
...
\begin{lemma}[Groupoid on field translate open]
\label{more-groupoids-lemma-groupoid-on-field-translate-open}
\source{stacks:0B7V}
\href{https://stacks.math.columbia.edu/tag/0B7V}{\texttt{Stacks tag 0B7V}}
\group{more-groupoids}
...
(Lemma \ref{more-groupoids-lemma-groupoid-on-field-move-point}) is
...
As $R' \to R$ is open (Lemma \ref{more-groupoids-lemma-restrict-groupoid-on-field})
we conclude the image contains an open neighbourhood of
the image of $\xi$ as desired.
\end{proof}

\begin{lemma}[Groupoid on field geometrically irreducible]
\label{more-groupoids-lemma-groupoid-on-field-geometrically-irreducible}
\source{stacks:04LT}
\href{https://stacks.math.columbia.edu/tag/04LT}{\texttt{Stacks tag 04LT}}
\group{more-groupoids}
...
Lemma \ref{more-groupoids-lemma-restrict-groupoid-on-field}.
...
\begin{lemma}[Groupoid on field locally finite type dimension]
\label{more-groupoids-lemma-groupoid-on-field-locally-finite-type-dimension}
\source{stacks:04LU}
\href{https://stacks.math.columbia.edu/tag/04LU}{\texttt{Stacks tag 04LU}}
\group{more-groupoids}
...
Lemma \ref{more-groupoids-lemma-groupoid-on-field-homogeneous}
and
...
\begin{lemma}[Groupoid on field dimension equal stabilizer]
\label{more-groupoids-lemma-groupoid-on-field-dimension-equal-stabilizer}
\source{stacks:04MQ}
\href{https://stacks.math.columbia.edu/tag/04MQ}{\texttt{Stacks tag 04MQ}}
\group{more-groupoids}
...
Lemma \ref{more-groupoids-lemma-groupoid-on-field-geometrically-irreducible})
...
$$
\begin{array}{ccc}k \underset{t}{\searrow}\overset{1}{\searrow} &  &  \\  & \Gamma(Z, \mathcal{O}_Z) \overset{e}{\longrightarrow} & k \\ k \overset{s}{\nearrow}\underset{1}{\nearrow} &  & \end{array}
$$
...
Lemma \ref{more-groupoids-lemma-groupoid-on-field-locally-finite-type-dimension} and
Groupoids, Lemma \ref{groupoids-lemma-group-scheme-finite-type-field}.
\end{proof}

\begin{remark}[Warn dimension groupoid on field]
\label{more-groupoids-remark-warn-dimension-groupoid-on-field}
\source{stacks:04MR}
\href{https://stacks.math.columbia.edu/tag/04MR}{\texttt{Stacks tag 04MR}}
\group{more-groupoids}

Warning:
Lemma \ref{more-groupoids-lemma-groupoid-on-field-dimension-equal-stabilizer}
...
\begin{lemma}[Groupoid characteristic zero smooth]
\label{more-groupoids-lemma-groupoid-characteristic-zero-smooth}
\source{stacks:04RA}
\href{https://stacks.math.columbia.edu/tag/04RA}{\texttt{Stacks tag 04RA}}
\group{more-groupoids}
...
\begin{proof}
By
Lemma \ref{more-groupoids-lemma-sheaf-differentials}
...
\begin{lemma}[Reduced group scheme perfect field characteristic p smooth]
\label{more-groupoids-lemma-reduced-group-scheme-perfect-field-characteristic-p-smooth}
\source{stacks:04RB}
\href{https://stacks.math.columbia.edu/tag/04RB}{\texttt{Stacks tag 04RB}}
\group{more-groupoids}
...
\begin{definition}[Situation: Morphism groupoids on field]
\label{more-groupoids-situation-morphism-groupoids-on-field}
\source{stacks:04Q5}
\href{https://stacks.math.columbia.edu/tag/04Q5}{\texttt{Stacks tag 04Q5}}
\group{more-groupoids}
...
$$
\vcenter{
\begin{array}{ccc}R_1 \overset{t_1}{\searrow}\underset{s_1}{\searrow}\underset{a}{\searrow} &  &  \\  & R_2 \overset{t_2}{\downarrow}\underset{s_2}{\longrightarrow} & U \\  & U & \end{array}
}
\quad\quad
\vcenter{
\begin{array}{cc}R_1 \times_{s_1, U, t_1} R_1 \underset{c_1}{\longrightarrow}\underset{a \times a}{\downarrow} & R_1 \overset{a}{\downarrow} \\ R_2 \times_{s_2, U, t_2} R_2 \overset{c_2}{\longrightarrow} & R_2\end{array}
}
$$
\end{definition}
...
\begin{lemma}[Open image is closed]
\label{more-groupoids-lemma-open-image-is-closed}
\source{stacks:04Q6}
\href{https://stacks.math.columbia.edu/tag/04Q6}{\texttt{Stacks tag 04Q6}}
\group{more-groupoids}
...
$$
\begin{array}{cc}R'_1 \underset{a'}{\longrightarrow}\underset{p_1}{\downarrow} & R'_2 \overset{p_2}{\downarrow} \\ R_1 \overset{a}{\longrightarrow} & R_2\end{array}
$$
...
\begin{lemma}[Map groupoids on field image]
\label{more-groupoids-lemma-map-groupoids-on-field-image}
\source{stacks:04Q7}
\href{https://stacks.math.columbia.edu/tag/04Q7}{\texttt{Stacks tag 04Q7}}
\group{more-groupoids}
...
$$
\begin{array}{cc}R_1 \times_{s_1, U, t_1} R_1 \longrightarrow\downarrow & R_1 \downarrow \\ R_2 \times_{s_2, U, t_2} R_2 \longrightarrow & R_2\end{array}
$$
By
...
\begin{lemma}[Map groupoids on perfect field image]
\label{more-groupoids-lemma-map-groupoids-on-perfect-field-image}
\source{stacks:04Q8}
\href{https://stacks.math.columbia.edu/tag/04Q8}{\texttt{Stacks tag 04Q8}}
\group{more-groupoids}
...
Hence by
Lemma \ref{more-groupoids-lemma-map-groupoids-on-field-image}
...
\begin{lemma}[Locally closed image is closed]
\label{more-groupoids-lemma-locally-closed-image-is-closed}
\source{stacks:04Q9}
\href{https://stacks.math.columbia.edu/tag/04Q9}{\texttt{Stacks tag 04Q9}}
\group{more-groupoids}
...
Lemma \ref{more-groupoids-lemma-map-groupoids-on-perfect-field-image}.
By the same lemma applied to
$\text{id}_{R_1} : R_1 \to R_1$
we see that $(R_2)_{red}$ is a groupoid scheme.
Thus we may apply
Lemma \ref{more-groupoids-lemma-open-image-is-closed}
to the morphism
$a|_{(R_2)_{red}} : (R_2)_{red} \to Z$
to conclude that $Z$ equals the image of $a$.
\end{proof}

\begin{lemma}[Quasi compact map groupoids on field image]
\label{more-groupoids-lemma-quasi-compact-map-groupoids-on-field-image}
\source{stacks:04QA}
\href{https://stacks.math.columbia.edu/tag/04QA}{\texttt{Stacks tag 04QA}}
\group{more-groupoids}
...
$$
\begin{array}{cc}R_1 \times_{s_1, U, t_1} R_1 \longrightarrow\overset{a \times a}{\downarrow} & R_1 \downarrow \\ R_2 \times_{s_2, U, t_2} R_2 \longrightarrow & R_2\end{array}
$$
By
...
\begin{lemma}[Groupoid on field image]
\label{more-groupoids-lemma-groupoid-on-field-image}
\source{stacks:04QB}
\href{https://stacks.math.columbia.edu/tag/04QB}{\texttt{Stacks tag 04QB}}
\group{more-groupoids}
...
Consider the commutative diagram
$$
\begin{array}{cc}R_s \times_k {}_tR \overset{c}{\longrightarrow}\underset{j_s \times {}_tj}{\downarrow} & R \overset{j}{\downarrow} \\ U^2_s \times_k {}_tU^2 \longrightarrow & U \times_S U\end{array}
$$
By
Varieties, Lemma \ref{varieties-lemma-closure-image-product-map}
...
\begin{lemma}[Groupoid on perfect field image]
\label{more-groupoids-lemma-groupoid-on-perfect-field-image}
\source{stacks:04QC}
\href{https://stacks.math.columbia.edu/tag/04QC}{\texttt{Stacks tag 04QC}}
\group{more-groupoids}
...
Varieties, Lemma \ref{varieties-lemma-geometrically-reduced-any-base-change}.
Hence by
Lemma \ref{more-groupoids-lemma-groupoid-on-field-image}
...
\begin{lemma}[Quasi compact groupoid on field image]
\label{more-groupoids-lemma-quasi-compact-groupoid-on-field-image}
\source{stacks:04QD}
\href{https://stacks.math.columbia.edu/tag/04QD}{\texttt{Stacks tag 04QD}}
\group{more-groupoids}
...
As $(U, U \times_S U, \text{pr}_1, \text{pr}_0, \text{pr}_{02})$
is a groupoid scheme over $S$ this is a special case of
Lemma \ref{more-groupoids-lemma-quasi-compact-map-groupoids-on-field-image}.
But we can also prove it directly as follows.
...
conclude that $Z_s \times_k {}_tZ$ maps into $Z$ by the bottom
horizontal arrow. As in the proof of
Lemma \ref{more-groupoids-lemma-groupoid-on-perfect-field-image}
...
\begin{definition}[Situation: Slice]
\label{more-groupoids-situation-slice}
\source{stacks:04MY}
\href{https://stacks.math.columbia.edu/tag/04MY}{\texttt{Stacks tag 04MY}}
\group{more-groupoids}
...
\source{stacks:0461}
\href{https://stacks.math.columbia.edu/tag/0461}{\texttt{Stacks tag 0461}}
\group{more-groupoids}
...
$$
\vcenter{
\begin{array}{cc}B & A \overset{s}{\longleftarrow} \\ A \overset{t}{\uparrow} & \end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}B_{\mathfrak q} & A_{\mathfrak m} \overset{s}{\longleftarrow} \\ A_{\mathfrak m} \overset{t}{\uparrow} & \end{array}
}
$$
...
Lemma \ref{more-groupoids-lemma-restrict-preserves-type}.
By
Lemma \ref{more-groupoids-lemma-groupoid-on-field-dimension-equal-stabilizer}
this implies that $\dim(G'') = \dim(R'')$. We also have
$\dim(R'') = \dim_{e''}(R'') = \dim(\mathcal{O}_{R'', e''})$, see
Lemma \ref{more-groupoids-lemma-groupoid-on-field-locally-finite-type-dimension}.
By
...
$$
\begin{array}{ccc}B/t(f)B \xlongequal{} & A/(f) \otimes_{A, t} B & A \underset{s}{\longleftarrow}\end{array}
$$
...
\begin{lemma}[Max slice]
\label{more-groupoids-lemma-max-slice}
\source{stacks:04MZ}
\href{https://stacks.math.columbia.edu/tag/04MZ}{\texttt{Stacks tag 04MZ}}
\group{more-groupoids}
...
Lemma \ref{more-groupoids-lemma-slice}
...
Lemma \ref{more-groupoids-lemma-restrict-property}
...
Lemma \ref{more-groupoids-lemma-double-restrict-property}
(use
...
\begin{lemma}[Max slice quasi finite]
\label{more-groupoids-lemma-max-slice-quasi-finite}
\source{stacks:04N0}
\href{https://stacks.math.columbia.edu/tag/04N0}{\texttt{Stacks tag 04N0}}
\group{more-groupoids}
...
\begin{proof}
Take $g : U' \to U$ as in
Lemma \ref{more-groupoids-lemma-max-slice}.
...
\begin{lemma}[Quasi finite over base]
\label{more-groupoids-lemma-quasi-finite-over-base}
\source{stacks:03FL}
\href{https://stacks.math.columbia.edu/tag/03FL}{\texttt{Stacks tag 03FL}}
\group{more-groupoids}
...
$$
\begin{array}{ccc}R' \amalg W'
\xlongequal{} & S' \times_S R
\longrightarrow\overset{s'}{\downarrow}\underset{t'}{\downarrow} & R \overset{s}{\downarrow}\underset{t}{\downarrow} \\ U' \amalg W
\xlongequal{} & S' \times_S U
\longrightarrow\downarrow & U \downarrow \\  & S' \longrightarrow & S\end{array}
$$
...
\begin{lemma}[Quasi finite over base j proper]
\label{more-groupoids-lemma-quasi-finite-over-base-j-proper}
\source{stacks:03X5}
\href{https://stacks.math.columbia.edu/tag/03X5}{\texttt{Stacks tag 03X5}}
\group{more-groupoids}
...
Lemma \ref{more-groupoids-lemma-quasi-finite-over-base}
hold as well as
\begin{enumerate}
...
\begin{proof}
We apply Lemma \ref{more-groupoids-lemma-quasi-finite-over-base} for the
...
\begin{lemma}[Finite stratify]
\label{more-groupoids-lemma-finite-stratify}
\source{stacks:0AB9}
\href{https://stacks.math.columbia.edu/tag/0AB9}{\texttt{Stacks tag 0AB9}}
\group{more-groupoids}
...
\begin{lemma}[Finite flat over almost dense subscheme]
\label{more-groupoids-lemma-finite-flat-over-almost-dense-subscheme}
\source{stacks:0ABA}
\href{https://stacks.math.columbia.edu/tag/0ABA}{\texttt{Stacks tag 0ABA}}
\group{more-groupoids}
...
of Lemma \ref{more-groupoids-lemma-finite-stratify}.
...
Lemma \ref{more-groupoids-lemma-finite-stratify}.

\medskip\noindent
By Lemma \ref{more-groupoids-lemma-finite-stratify} we have $\bigcap Z_r = \emptyset$.
...
\begin{lemma}[Finite flat over almost dense subscheme addendum]
\label{more-groupoids-lemma-finite-flat-over-almost-dense-subscheme-addendum}
\source{stacks:0ABB}
\href{https://stacks.math.columbia.edu/tag/0ABB}{\texttt{Stacks tag 0ABB}}
\group{more-groupoids}

In Lemma \ref{more-groupoids-lemma-finite-flat-over-almost-dense-subscheme}
...
Lemma \ref{more-groupoids-lemma-finite-stratify} is given by closed immersions $Z_k \to U$
...
In the proof of Lemma \ref{more-groupoids-lemma-finite-flat-over-almost-dense-subscheme}
...
\begin{lemma}[Invariant affine open around generic point]
\label{more-groupoids-lemma-invariant-affine-open-around-generic-point}
\source{stacks:0ABC}
\href{https://stacks.math.columbia.edu/tag/0ABC}{\texttt{Stacks tag 0ABC}}
\group{more-groupoids}
...
Lemma \ref{more-groupoids-lemma-finite-flat-over-almost-dense-subscheme}.
By Lemma \ref{more-groupoids-lemma-finite-flat-over-almost-dense-subscheme-addendum}
...
Lemma \ref{more-groupoids-lemma-invariant-affine-open-around-generic-point}
but we redo the argument as it is slightly easier in this case
(it avoids using
Lemma \ref{more-groupoids-lemma-finite-flat-over-almost-dense-subscheme-addendum}).

\begin{lemma}[Invariant affine open around generic point Noetherian]
\label{more-groupoids-lemma-invariant-affine-open-around-generic-point-Noetherian}
\source{stacks:0ABD}
\href{https://stacks.math.columbia.edu/tag/0ABD}{\texttt{Stacks tag 0ABD}}
\group{more-groupoids}
...
\begin{lemma}[Find affine integral]
\label{more-groupoids-lemma-find-affine-integral}
\source{stacks:0ABE}
\href{https://stacks.math.columbia.edu/tag/0ABE}{\texttt{Stacks tag 0ABE}}
\group{more-groupoids}
...
\begin{lemma}[Find almost invariant function]
\label{more-groupoids-lemma-find-almost-invariant-function}
\source{stacks:0ABF}
\href{https://stacks.math.columbia.edu/tag/0ABF}{\texttt{Stacks tag 0ABF}}
\group{more-groupoids}
...
\source{stacks:0ABG}
\href{https://stacks.math.columbia.edu/tag/0ABG}{\texttt{Stacks tag 0ABG}}
\group{more-groupoids}
...
\begin{lemma}[Get affine]
\label{more-groupoids-lemma-get-affine}
\source{stacks:0ABH}
\href{https://stacks.math.columbia.edu/tag/0ABH}{\texttt{Stacks tag 0ABH}}
\group{more-groupoids}
...
\begin{lemma}[Find affine codimension 1]
\label{more-groupoids-lemma-find-affine-codimension-1}
\source{stacks:0ABI}
\href{https://stacks.math.columbia.edu/tag/0ABI}{\texttt{Stacks tag 0ABI}}
\group{more-groupoids}
...
\medskip\noindent
By Lemma \ref{more-groupoids-lemma-find-affine-integral} we may replace $U$ by its reduction
...
and by Lemma \ref{more-groupoids-lemma-find-affine-integral}
...
orbit of $u$ (Lemma \ref{more-groupoids-lemma-no-specializations-map-to-same-point})
...
is closed. Apply Lemma \ref{more-groupoids-lemma-find-almost-invariant-function}
...
Lemma \ref{more-groupoids-lemma-find-almost-invariant-function} to
...
Lemma \ref{more-groupoids-lemma-get-affine}
...
\begin{lemma}[Sits in functions]
\label{more-groupoids-lemma-sits-in-functions}
\source{stacks:0API}
\href{https://stacks.math.columbia.edu/tag/0API}{\texttt{Stacks tag 0API}}
\group{more-groupoids}
...
$$
\begin{array}{cc}(E, \mathcal{O}_X|_E) \longrightarrow\downarrow & (\Spec(A), \mathcal{O}_{\Spec(A)}) \downarrow \\ (U_i, \mathcal{O}_{U_i}) \longrightarrow & (\Spec(A_i), \mathcal{O}_{\Spec(A_i)})\end{array}
$$
...
$$
\begin{array}{cc}U_i \longrightarrow\downarrow & \Spec(A_i) \downarrow \\ U_i \longrightarrow & \Spec(A_j)\end{array}
\quad\quad
\begin{array}{cc}W \longrightarrow\downarrow & \Spec(A_i) \downarrow \\ W \longrightarrow & \Spec(A_j)\end{array}
\quad\quad
\begin{array}{cc}W \longrightarrow\downarrow & \Spec(A) \downarrow \\ W \longrightarrow & \Spec(A_j)\end{array}
$$
By Properties, Lemma
...
\source{stacks:0APJ}
\href{https://stacks.math.columbia.edu/tag/0APJ}{\texttt{Stacks tag 0APJ}}
\group{more-groupoids}

Suppose given a cartesian diagram
$$
\begin{array}{cc}X \underset{f}{\downarrow}\longrightarrow & \Spec(B) \downarrow \\ Y \longrightarrow & \Spec(A)\end{array}
$$
...
\source{stacks:0APK}
\href{https://stacks.math.columbia.edu/tag/0APK}{\texttt{Stacks tag 0APK}}
\group{more-groupoids}
...
similarly for $X \times_S E$. By Lemma \ref{more-groupoids-lemma-affine-base-change}
...
\medskip\noindent
By Lemma \ref{more-groupoids-lemma-sits-in-functions} we obtain a canonical ``embedding''
$$
...
$$
\begin{array}{ccccc} & E \times_S X \underset{\varphi}{\longrightarrow}\swarrow\overset{j'}{\searrow} &  & X \times_S E \searrow\underset{j''}{\swarrow} &  \\ E \overset{j}{\searrow} &  & \Spec(R' \otimes_R A \otimes_R A) \swarrow\searrow &  & E \underset{j}{\swarrow} \\  & \Spec(R' \otimes_R A) \searrow &  & \Spec(R' \otimes_R A) \swarrow &  \\  &  & \Spec(R') &  & \end{array}
$$
