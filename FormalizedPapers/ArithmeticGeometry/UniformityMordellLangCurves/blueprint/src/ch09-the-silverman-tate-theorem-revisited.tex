% Source-derived chapter 09: The Silverman--Tate Theorem revisited
% Original source: uniformity-mordell-lang-curves
\chapter{The Silverman--Tate Theorem revisited}
\label{uniformity-mordell-lang-curves-chapter-09}
\source{uniformity-mordell-lang-curves}

\begin{remark}[Source section]
\label{uniformity-mordell-lang-curves-chapter-09-source}
\source{uniformity-mordell-lang-curves}
\source{uniformity-mordell-lang-curves}
...
% The source section title was: The Silverman--Tate Theorem revisited
\label{app:silvermantate}
\source{uniformity-mordell-lang-curves}
% Appendix A:
...
\begin{proposition}
\label{src-uniformity-mordell-lang-curves-ch09-the-silverman-tate-theorem-revisited-statement-1}
\source{uniformity-mordell-lang-curves}
\notready
