...
\begin{lemma}[Lift etale]
\label{flat-lemma-lift-etale}
\source{stacks:057R}
\href{https://stacks.math.columbia.edu/tag/057R}{\texttt{Stacks tag 057R}}
\group{flat}
...
\source{stacks:05H2}
\href{https://stacks.math.columbia.edu/tag/05H2}{\texttt{Stacks tag 05H2}}
\group{flat}

Let
$$
\begin{array}{cc}X \downarrow & X' \longleftarrow\downarrow \\ S & S' \longleftarrow\end{array}
$$
...
\begin{lemma}[Etale flat up down]
\label{flat-lemma-etale-flat-up-down}
\source{stacks:05B9}
\href{https://stacks.math.columbia.edu/tag/05B9}{\texttt{Stacks tag 05B9}}
\group{flat}
...
\begin{lemma}[Etale flat up down local ring]
\label{flat-lemma-etale-flat-up-down-local-ring}
\source{stacks:05BA}
\href{https://stacks.math.columbia.edu/tag/05BA}{\texttt{Stacks tag 05BA}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-etale-flat-up-down}
...
Apply
Lemma \ref{flat-lemma-etale-flat-up-down}.
\end{proof}

\begin{lemma}[Flat up down henselization]
\label{flat-lemma-flat-up-down-henselization}
\source{stacks:05VL}
\href{https://stacks.math.columbia.edu/tag/05VL}{\texttt{Stacks tag 05VL}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-etale-flat-up-down-local-ring}
...
\medskip\noindent
Assume (1). By
Lemma \ref{flat-lemma-etale-flat-up-down-local-ring}
...
\begin{lemma}[Tor amplitude up down henselization]
\label{flat-lemma-tor-amplitude-up-down-henselization}
\source{stacks:0DK0}
\href{https://stacks.math.columbia.edu/tag/0DK0}{\texttt{Stacks tag 0DK0}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-flat-up-down-henselization}
...
Hence by Lemma \ref{flat-lemma-flat-up-down-henselization}
...
\begin{lemma}[Finite flat weak assassin up down]
\label{flat-lemma-finite-flat-weak-assassin-up-down}
\source{stacks:05FN}
\href{https://stacks.math.columbia.edu/tag/05FN}{\texttt{Stacks tag 05FN}}
\group{flat}
...
\begin{lemma}[Etale weak assassin up down]
\label{flat-lemma-etale-weak-assassin-up-down}
\source{stacks:05FP}
\href{https://stacks.math.columbia.edu/tag/05FP}{\texttt{Stacks tag 05FP}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-finite-flat-weak-assassin-up-down}
...
Lemma \ref{flat-lemma-finite-flat-weak-assassin-up-down}
above.
\end{proof}

\begin{lemma}[Weakly associated henselization]
\label{flat-lemma-weakly-associated-henselization}
\source{stacks:0CTU}
\href{https://stacks.math.columbia.edu/tag/0CTU}{\texttt{Stacks tag 0CTU}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-etale-weak-assassin-up-down}
...
By Lemma \ref{flat-lemma-etale-weak-assassin-up-down}
...
Lemma \ref{flat-lemma-elementary-devissage}.

\begin{lemma}[Sheaf lives on subscheme]
\label{flat-lemma-sheaf-lives-on-subscheme}
\source{stacks:057Q}
\href{https://stacks.math.columbia.edu/tag/057Q}{\texttt{Stacks tag 057Q}}
\group{flat}
...
\begin{lemma}[Elementary devissage]
\label{flat-lemma-elementary-devissage}
\source{stacks:057S}
\href{https://stacks.math.columbia.edu/tag/057S}{\texttt{Stacks tag 057S}}
\group{flat}
...
$$
\begin{array}{ccc}X \underset{f}{\downarrow} & X' \downarrow\overset{g}{\longleftarrow} & Z' \overset{i}{\longleftarrow}\overset{\pi}{\downarrow} \\  &  & Y' \overset{h}{\downarrow} \\ S & S' \underset{e}{\longleftarrow} & S' \xlongequal{}\end{array}
$$
...
\begin{proof}
\uses{flat-lemma-sheaf-lives-on-subscheme, flat-lemma-lift-etale}
...
$$
\begin{array}{cc}X \downarrow & X' \overset{g}{\longleftarrow}\overset{\pi}{\downarrow} \\  & Y' \overset{h}{\downarrow} \\ S & S' \underset{e}{\longleftarrow}\end{array}
$$
...
Lemma \ref{flat-lemma-sheaf-lives-on-subscheme}.
Applying the result of the previous paragraph to $Z \to S$ and
$\mathcal{G}$ we obtain a diagram
$$
\begin{array}{ccc}X \underset{f}{\downarrow} & Z \longleftarrow\underset{f|_Z}{\downarrow} & Z' \overset{g}{\longleftarrow}\overset{\pi}{\downarrow} \\  &  & Y' \overset{h}{\downarrow} \\ S & S \xlongequal{} & S' \underset{e}{\longleftarrow}\end{array}
$$
and point $z' \in Z'$ satisfying all the required properties.
We will use
Lemma \ref{flat-lemma-lift-etale}
...
$$
\begin{array}{ccc}Z' \longrightarrow & Z \times_S S' \longrightarrow & X \times_S S'\end{array}
$$
...
$$
\begin{array}{ccc}X \downarrow & X' \downarrow\longleftarrow & Z' \overset{i}{\longleftarrow}\overset{\pi}{\downarrow} \\  &  & Y' \overset{h}{\downarrow} \\ S & S' \underset{e}{\longleftarrow} & S' \xlongequal{}\end{array}
$$
is a solution of the original problem.
\end{proof}

\begin{lemma}[Devissage finite presentation]
\label{flat-lemma-devissage-finite-presentation}
\source{stacks:057T}
\href{https://stacks.math.columbia.edu/tag/057T}{\texttt{Stacks tag 057T}}
\group{flat}

\uses{flat-lemma-elementary-devissage}
...
\begin{lemma}[Devissage flat]
\label{flat-lemma-devissage-flat}
\source{stacks:057U}
\href{https://stacks.math.columbia.edu/tag/057U}{\texttt{Stacks tag 057U}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-etale-flat-up-down, flat-lemma-etale-flat-up-down-local-ring}
...
of local ring maps
$$
\begin{array}{cccc}\mathcal{O}_{X', x'} \underset{\iota}{\longrightarrow} & \mathcal{O}_{Z', z'} & \mathcal{O}_{Y', y'} \overset{\alpha}{\longleftarrow} & \mathcal{O}_{S', s'} \overset{\beta}{\longleftarrow} \\ \mathcal{O}_{X, x} \overset{\gamma}{\uparrow} &  &  & \mathcal{O}_{S, s} \underset{\varphi}{\longleftarrow}\underset{\epsilon}{\uparrow}\end{array}
$$
We will use
Lemma \ref{flat-lemma-etale-flat-up-down-local-ring}
...
\begin{definition}[One step devissage]
\label{flat-definition-one-step-devissage}
\source{stacks:05H4}
\href{https://stacks.math.columbia.edu/tag/05H4}{\texttt{Stacks tag 05H4}}
\group{flat}
...
$$
\begin{array}{ccc}X & Z \underset{i}{\longleftarrow}\overset{\pi}{\longrightarrow} & Y\end{array}
$$
...
Lemma \ref{flat-lemma-devissage-finite-presentation}
and the observations in
Remark \ref{flat-remark-finite-presentation}
to deal with this issue in an ad hoc fashion whenever it comes up.

\begin{definition}[One step devissage at x]
\label{flat-definition-one-step-devissage-at-x}
\source{stacks:05H5}
\href{https://stacks.math.columbia.edu/tag/05H5}{\texttt{Stacks tag 05H5}}
\group{flat}
...
via condition (5) of
Definition \ref{flat-definition-one-step-devissage}.

\begin{lemma}[Elementary devissage variant]
\label{flat-lemma-elementary-devissage-variant}
\source{stacks:05H6}
\href{https://stacks.math.columbia.edu/tag/05H6}{\texttt{Stacks tag 05H6}}
\group{flat}
...
$$
\begin{array}{cc}(X, x) \underset{f}{\downarrow} & (X', x') \overset{g}{\longleftarrow}\downarrow \\ (S, s) & (S', s') \longleftarrow \\  & \end{array}
$$
...
\begin{proof}
\uses{flat-definition-one-step-devissage-at-x, flat-lemma-elementary-devissage}

This is immediate from
Definition \ref{flat-definition-one-step-devissage-at-x}
and
Lemma \ref{flat-lemma-elementary-devissage}.
\end{proof}

\begin{lemma}[Base change one step]
\label{flat-lemma-base-change-one-step}
\source{stacks:05H7}
\href{https://stacks.math.columbia.edu/tag/05H7}{\texttt{Stacks tag 05H7}}
\group{flat}

\uses{flat-definition-one-step-devissage}
...
\begin{lemma}[Base change one step at x]
\label{flat-lemma-base-change-one-step-at-x}
\source{stacks:05H8}
\href{https://stacks.math.columbia.edu/tag/05H8}{\texttt{Stacks tag 05H8}}
\group{flat}

\uses{flat-definition-one-step-devissage-at-x, flat-lemma-base-change-one-step}
...
Lemma \ref{flat-lemma-base-change-one-step}
...
\begin{proof}
\uses{flat-lemma-base-change-one-step, flat-definition-one-step-devissage-at-x}
...
\source{stacks:05H9}
\href{https://stacks.math.columbia.edu/tag/05H9}{\texttt{Stacks tag 05H9}}
\group{flat}

\uses{flat-definition-one-step-devissage-at-x}
Let $S$, $X$, $\mathcal{F}$, $x$, $s$ be as in
Definition \ref{flat-definition-one-step-devissage-at-x}.
Let $(Z, Y, i, \pi, \mathcal{G}, z, y)$ be a one step d\'evissage
...
\source{stacks:05HA}
\href{https://stacks.math.columbia.edu/tag/05HA}{\texttt{Stacks tag 05HA}}
\group{flat}

\uses{flat-definition-shrink}
With assumption and notation as in
Definition \ref{flat-definition-shrink}
we have:
\begin{enumerate}
\item
...
\begin{proof}
\uses{flat-lemma-base-change-one-step-at-x}

Part (1) is immediate from
Lemma \ref{flat-lemma-base-change-one-step-at-x}
...
\begin{lemma}[Elementary etale neighbourhood]
\label{flat-lemma-elementary-etale-neighbourhood}
\source{stacks:05HE}
\href{https://stacks.math.columbia.edu/tag/05HE}{\texttt{Stacks tag 05HE}}
\group{flat}
...
$$
\begin{array}{cc}(Y, y) \downarrow & (Y', y') \longleftarrow\downarrow \\ (S, s) & (S', s') \longleftarrow\end{array}
$$
...
$$
\begin{array}{cccc} &  & (X'', x'') \swarrow\downarrow & (Z'', z'') \longleftarrow\swarrow\downarrow \\ (X, x) \downarrow & (Z, z) \longleftarrow\downarrow & (S'', s'') \swarrow & (Y'', y'') \swarrow\longleftarrow \\ (S, s) & (Y, y) \longleftarrow &  & \end{array}
$$
...
\begin{proof}
\uses{flat-lemma-lift-etale, flat-definition-one-step-devissage}
...
\begin{lemma}[Existence alpha]
\label{flat-lemma-existence-alpha}
\source{stacks:05HF}
\href{https://stacks.math.columbia.edu/tag/05HF}{\texttt{Stacks tag 05HF}}
\group{flat}
...
\begin{definition}[Complete devissage]
\label{flat-definition-complete-devissage}
\source{stacks:05HH}
\href{https://stacks.math.columbia.edu/tag/05HH}{\texttt{Stacks tag 05HH}}
\group{flat}
...
diagram
$$
\begin{array}{ccccc}X & Z_1 \overset{i_1}{\longleftarrow}\overset{\pi_1}{\downarrow} &  &  &  \\  & Y_1 & Z_2 \overset{i_2}{\longleftarrow}\overset{\pi_2}{\downarrow} &  &  \\  &  & Y_2 & Z_3 \longleftarrow\downarrow &  \\  &  &  & ... & ... \longleftarrow\downarrow \\  &  &  &  & Y_n\end{array}
$$
...
\begin{definition}[Complete devissage at x]
\label{flat-definition-complete-devissage-at-x}
\source{stacks:05HI}
\href{https://stacks.math.columbia.edu/tag/05HI}{\texttt{Stacks tag 05HI}}
\group{flat}
...
\begin{lemma}[Base change complete]
\label{flat-lemma-base-change-complete}
\source{stacks:05HJ}
\href{https://stacks.math.columbia.edu/tag/05HJ}{\texttt{Stacks tag 05HJ}}
\group{flat}

\uses{flat-definition-complete-devissage}
Let $S$, $X$, $\mathcal{F}$, $s$ be as in
Definition \ref{flat-definition-complete-devissage}.
Let $(S', s') \to (S, s)$ be any morphism of pointed schemes.
...
\begin{proof}
\uses{flat-lemma-base-change-one-step, flat-definition-complete-devissage}
...
\begin{lemma}[Base change complete at x]
\label{flat-lemma-base-change-complete-at-x}
\source{stacks:05HK}
\href{https://stacks.math.columbia.edu/tag/05HK}{\texttt{Stacks tag 05HK}}
\group{flat}

\uses{flat-definition-complete-devissage-at-x, flat-lemma-base-change-complete}
Let $S$, $X$, $\mathcal{F}$, $x$, $s$ be as in
Definition \ref{flat-definition-complete-devissage-at-x}.
Let $(S', s') \to (S, s)$ be a morphism of pointed schemes
...
Lemma \ref{flat-lemma-base-change-complete}
...
\begin{proof}
\uses{flat-lemma-base-change-complete, flat-lemma-base-change-one-step-at-x}
...
\begin{definition}[Shrink complete]
\label{flat-definition-shrink-complete}
\source{stacks:05HL}
\href{https://stacks.math.columbia.edu/tag/05HL}{\texttt{Stacks tag 05HL}}
\group{flat}

\uses{flat-definition-complete-devissage-at-x}
Let $S$, $X$, $\mathcal{F}$, $x$, $s$ be as in
Definition \ref{flat-definition-complete-devissage-at-x}.
...
\begin{lemma}[Shrink complete]
\label{flat-lemma-shrink-complete}
\source{stacks:05HM}
\href{https://stacks.math.columbia.edu/tag/05HM}{\texttt{Stacks tag 05HM}}
\group{flat}

\uses{flat-definition-shrink-complete}
With assumption and notation as in
Definition \ref{flat-definition-shrink-complete}
we have:
\begin{enumerate}
\item
...
\begin{proof}
\uses{flat-lemma-base-change-complete-at-x, flat-lemma-shrink}

Part (1) is immediate from
Lemmas \ref{flat-lemma-base-change-complete-at-x} and
\ref{flat-lemma-shrink}.

\medskip\noindent
Proof of (2). For convenience denote $X = Y_0$. We apply
Lemma \ref{flat-lemma-shrink} (\ref{item-shrink-on-Y})
...
Lemma \ref{flat-lemma-shrink} (\ref{item-shrink-on-X})
to find a standard shrinking
$S', X', Z'_1, Y'_1$
...
\begin{proposition}[Existence complete at x]
\label{flat-proposition-existence-complete-at-x}
\source{stacks:05HR}
\href{https://stacks.math.columbia.edu/tag/05HR}{\texttt{Stacks tag 05HR}}
\group{flat}
...
$$
\begin{array}{cc}(X, x) \downarrow & (X', x') \overset{g}{\longleftarrow}\downarrow \\ (S, s) & (S', s') \longleftarrow\end{array}
$$
...
\begin{proof}
\uses{flat-lemma-elementary-devissage-variant, flat-lemma-existence-alpha, flat-lemma-shrink, flat-lemma-elementary-etale-neighbourhood, flat-lemma-base-change-complete-at-x, flat-lemma-shrink-complete}

We prove this by induction on the integer
$d = \dim_x(\text{Supp}(\mathcal{F}_s))$.
By
Lemma \ref{flat-lemma-elementary-devissage-variant}
...
\medskip\noindent
We apply
Lemma \ref{flat-lemma-existence-alpha}
to find a map
$$
\alpha_1 :
...
\vcenter{
\begin{array}{cc}(Y_1, y_1) \downarrow & (Y'_1, y'_1) \overset{h}{\longleftarrow}\downarrow \\ (S, s) & (S', s') \longleftarrow\end{array}
}
\end{equation}
of pointed schemes such that the horizontal
arrows are elementary \'etale neighbourhoods
...
Lemma \ref{flat-lemma-elementary-etale-neighbourhood}
to $S, X, \mathcal{F}, x, s$, the system
$(Z_1, Y_1, i_1, \pi_1, \mathcal{G}_1)$ and
diagram (\ref{equation-overcome-this}). We obtain a diagram
$$
\begin{array}{cccc} &  & (X'', x'') \swarrow\downarrow & (Z''_1, z''_1) \longleftarrow\swarrow\downarrow \\ (X, x) \downarrow & (Z_1, z_1) \longleftarrow\downarrow & (S'', s'') \swarrow & (Y''_1, y''_1) \swarrow\longleftarrow \\ (S, s) & (Y_1, y_1) \longleftarrow &  & \end{array}
$$
...
Lemma \ref{flat-lemma-base-change-complete-at-x}
the system
\begin{equation}
...
Lemmas \ref{flat-lemma-shrink} and
...
Lemma \ref{flat-lemma-shrink-complete} (\ref{item-shrink-on-X-complete})
...
Lemma \ref{flat-lemma-shrink} (\ref{item-shrink-base}) and then
...
\begin{lemma}[Existence complete]
\label{flat-lemma-existence-complete}
\source{stacks:05HU}
\href{https://stacks.math.columbia.edu/tag/05HU}{\texttt{Stacks tag 05HU}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-base-change-complete}
...
$$
\vcenter{
\begin{array}{cc}(X, x) \downarrow & (X'_i, x'_i) \overset{g_i}{\longleftarrow}\downarrow \\ (S, s) & (S'_i, s'_i) \longleftarrow\end{array}
}
\quad i = 1, \ldots, n
$$
...
\begin{definition}[Elementary etale neighbourhood]
\label{flat-definition-elementary-etale-neighbourhood}
\source{stacks:05HW}
\href{https://stacks.math.columbia.edu/tag/05HW}{\texttt{Stacks tag 05HW}}
\group{flat}
...
$$
\begin{array}{cc}S \longrightarrow & S' \\ R \uparrow\longrightarrow & R' \uparrow\end{array}
\quad\quad
\begin{array}{cc}\mathfrak q \longrightarrow & \mathfrak q' \\ \mathfrak p \uparrow\longrightarrow & \mathfrak p' \uparrow\end{array}
$$
...
\begin{definition}[Complete devissage algebra]
\label{flat-definition-complete-devissage-algebra}
\source{stacks:05HX}
\href{https://stacks.math.columbia.edu/tag/05HX}{\texttt{Stacks tag 05HX}}
\group{flat}
...
$$
\begin{array}{ccccccccc} & A_1 &  & A_2 &  & ... &  & A_n &  \\ S \nearrow &  & B_1 \nwarrow\nearrow &  & ... \nwarrow\nearrow &  & ... \nwarrow\nearrow &  & B_n \nwarrow\end{array}
$$
...
\begin{remark}[Finite presentation]
\label{flat-remark-finite-presentation}
\source{stacks:05HY}
\href{https://stacks.math.columbia.edu/tag/05HY}{\texttt{Stacks tag 05HY}}
\group{flat}
...
\begin{definition}[Complete devissage at x algebra]
\label{flat-definition-complete-devissage-at-x-algebra}
\source{stacks:05HZ}
\href{https://stacks.math.columbia.edu/tag/05HZ}{\texttt{Stacks tag 05HZ}}
\group{flat}
...
\begin{remark}[Same notion]
\label{flat-remark-same-notion}
\source{stacks:05I0}
\href{https://stacks.math.columbia.edu/tag/05I0}{\texttt{Stacks tag 05I0}}
\group{flat}
...
\begin{lemma}[Existence algebra]
\label{flat-lemma-existence-algebra}
\source{stacks:05I1}
\href{https://stacks.math.columbia.edu/tag/05I1}{\texttt{Stacks tag 05I1}}
\group{flat}
...
\begin{proof}
\uses{flat-proposition-existence-complete-at-x, flat-remark-same-notion}

This is a reformulation of
Proposition \ref{flat-proposition-existence-complete-at-x}
via
Remark \ref{flat-remark-same-notion}
\end{proof}

\section{Localization and universally injective maps}
\label{flat-section-localize-universally-injective}
\begin{lemma}[Homothety spectrum]
\label{flat-lemma-homothety-spectrum}
\source{stacks:05DE}
\href{https://stacks.math.columbia.edu/tag/05DE}{\texttt{Stacks tag 05DE}}
\group{flat}
...
\begin{lemma}[Homothety universally injective]
\label{flat-lemma-homothety-universally-injective}
\source{stacks:05DF}
\href{https://stacks.math.columbia.edu/tag/05DF}{\texttt{Stacks tag 05DF}}
\group{flat}

\uses{flat-lemma-homothety-spectrum}
Assumption and notation as in
Lemma \ref{flat-lemma-homothety-spectrum}.
...
\begin{lemma}[Base change universally flat local]
\label{flat-lemma-base-change-universally-flat-local}
\source{stacks:05DG}
\href{https://stacks.math.columbia.edu/tag/05DG}{\texttt{Stacks tag 05DG}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-homothety-spectrum, flat-lemma-homothety-universally-injective}

Set $N' = N \otimes_R S'$. Consider the commutative diagram
$$
\begin{array}{cc}N \downarrow\longrightarrow & N' \downarrow \\ \Sigma^{-1}N \longrightarrow & \Sigma^{-1}N'\end{array}
$$
...
Finally, we apply
Lemma \ref{flat-lemma-homothety-universally-injective}
...
\begin{lemma}[Base change universally flat]
\label{flat-lemma-base-change-universally-flat}
\source{stacks:05DH}
\href{https://stacks.math.columbia.edu/tag/05DH}{\texttt{Stacks tag 05DH}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-base-change-universally-flat-local}
...
Lemma \ref{flat-lemma-base-change-universally-flat-local}
to the ring maps
...
\source{stacks:05FQ}
\href{https://stacks.math.columbia.edu/tag/05FQ}{\texttt{Stacks tag 05FQ}}
\group{flat}
...
\begin{lemma}[Invert universally injective]
\label{flat-lemma-invert-universally-injective}
\source{stacks:05FR}
\href{https://stacks.math.columbia.edu/tag/05FR}{\texttt{Stacks tag 05FR}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-universally-injective-local}

Pick $s \in \Sigma$. By
Lemma \ref{flat-lemma-universally-injective-local}
...
\begin{lemma}[Completed direct sum ML]
\label{flat-lemma-completed-direct-sum-ML}
\source{stacks:05DJ}
\href{https://stacks.math.columbia.edu/tag/05DJ}{\texttt{Stacks tag 05DJ}}
\group{flat}
...
\source{stacks:05DK}
\href{https://stacks.math.columbia.edu/tag/05DK}{\texttt{Stacks tag 05DK}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-completed-direct-sum-ML}
...
Lemma \ref{flat-lemma-completed-direct-sum-ML}.
\end{proof}

In
Lemmas \ref{flat-lemma-universally-injective-to-completion} and
...
\begin{lemma}[Universally injective to completion]
\label{flat-lemma-universally-injective-to-completion}
\source{stacks:05DL}
\href{https://stacks.math.columbia.edu/tag/05DL}{\texttt{Stacks tag 05DL}}
\group{flat}
...
\begin{lemma}[Universally injective to completion flat]
\label{flat-lemma-universally-injective-to-completion-flat}
\source{stacks:05DM}
\href{https://stacks.math.columbia.edu/tag/05DM}{\texttt{Stacks tag 05DM}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-universally-injective-to-completion}

This follows from
Lemma \ref{flat-lemma-universally-injective-to-completion}
because
Algebra, Lemma
...
Lemma \ref{flat-lemma-fibres-irreducible-flat-projective}.

\begin{lemma}[Flat pure over complete projective]
\label{flat-lemma-flat-pure-over-complete-projective}
\source{stacks:05DP}
\href{https://stacks.math.columbia.edu/tag/05DP}{\texttt{Stacks tag 05DP}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-universally-injective-to-completion-flat, flat-lemma-lift-ML}

By
Lemma \ref{flat-lemma-universally-injective-to-completion-flat}
the map $N \to N^\wedge$ is universally injective.
By
Lemma \ref{flat-lemma-lift-ML}
...
\begin{lemma}[Fibres irreducible flat projective]
\label{flat-lemma-fibres-irreducible-flat-projective}
\source{stacks:05FS}
\href{https://stacks.math.columbia.edu/tag/05FS}{\texttt{Stacks tag 05FS}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-flat-pure-over-complete-projective}
...
Lemma \ref{flat-lemma-flat-pure-over-complete-projective}.
...
\begin{lemma}[Fibres irreducible flat projective nonnoetherian]
\label{flat-lemma-fibres-irreducible-flat-projective-nonnoetherian}
\source{stacks:05FT}
\href{https://stacks.math.columbia.edu/tag/05FT}{\texttt{Stacks tag 05FT}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-fibres-irreducible-flat-projective}

We can find a cocartesian diagram of rings
$$
\begin{array}{cc}S_0 \longrightarrow & S \\ R_0 \uparrow\longrightarrow & R \uparrow\end{array}
$$
...
\begin{remark}[How in RG]
\label{flat-remark-how-in-RG}
\source{stacks:05FU}
\href{https://stacks.math.columbia.edu/tag/05FU}{\texttt{Stacks tag 05FU}}
\group{flat}

\uses{flat-lemma-fibres-irreducible-flat-projective-nonnoetherian, flat-lemma-base-change-universally-flat}
Lemma \ref{flat-lemma-fibres-irreducible-flat-projective-nonnoetherian}
...
\source{stacks:05I3}
\href{https://stacks.math.columbia.edu/tag/05I3}{\texttt{Stacks tag 05I3}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-universally-injective-local, flat-lemma-fibres-irreducible-flat-projective-nonnoetherian, flat-lemma-invert-universally-injective}
...
by a combination of
Lemmas \ref{flat-lemma-invert-universally-injective} and
\ref{flat-lemma-fibres-irreducible-flat-projective-nonnoetherian}.
...
\begin{lemma}[Complete devissage flat finite type module]
\label{flat-lemma-complete-devissage-flat-finite-type-module}
\source{stacks:05I4}
\href{https://stacks.math.columbia.edu/tag/05I4}{\texttt{Stacks tag 05I4}}
\group{flat}
...
\begin{proof}
\uses{flat-remark-finite-presentation, flat-lemma-induction-step, flat-lemma-fibres-irreducible-flat-projective-nonnoetherian}
...
Lemma \ref{flat-lemma-induction-step}
...
\begin{proposition}[Finite type flat at point]
\label{flat-proposition-finite-type-flat-at-point}
\source{stacks:05I5}
\href{https://stacks.math.columbia.edu/tag/05I5}{\texttt{Stacks tag 05I5}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-elementary-devissage, flat-lemma-etale-at-point, flat-lemma-devissage-finite-presentation, flat-lemma-devissage-flat, flat-lemma-induction-step}
[First proof]
...
$$
\begin{array}{ccc}X_{\mathcal{O}_{S', s'}} \underset{f}{\searrow} & X'_{\mathcal{O}_{S', s'}} \downarrow\overset{g}{\longleftarrow} & Z'_{\mathcal{O}_{S', s'}} \overset{i}{\longleftarrow}\overset{\pi}{\downarrow} \\  &  & Y'_{\mathcal{O}_{S', s'}} \overset{h}{\swarrow} \\  & \Spec(\mathcal{O}_{S', s'}) & \end{array}
$$
...
$g$ is \'etale, see
Lemma \ref{flat-lemma-etale-at-point}.
...
\begin{proof}
\uses{flat-proposition-existence-complete-at-x, flat-lemma-etale-flat-up-down, flat-remark-same-notion, flat-lemma-complete-devissage-flat-finite-type-module, flat-lemma-etale-at-point}
[Second proof]
We apply
Proposition \ref{flat-proposition-existence-complete-at-x}
...
$s'$. Thus
Lemma \ref{flat-lemma-complete-devissage-flat-finite-type-module}
implies that
$$
\Gamma(X', \mathcal{F}')
...
\begin{lemma}[Open in fibre where flat]
\label{flat-lemma-open-in-fibre-where-flat}
\source{stacks:05M9}
\href{https://stacks.math.columbia.edu/tag/05M9}{\texttt{Stacks tag 05M9}}
\group{flat}
...
\begin{proof}
\uses{flat-proposition-finite-type-flat-at-point}
...
\begin{lemma}[Finite type flat at point]
\label{flat-lemma-finite-type-flat-at-point}
\source{stacks:05KT}
\href{https://stacks.math.columbia.edu/tag/05KT}{\texttt{Stacks tag 05KT}}
\group{flat}
...
\begin{lemma}[Finite type flat along fibre]
\label{flat-lemma-finite-type-flat-along-fibre}
\source{stacks:05KU}
\href{https://stacks.math.columbia.edu/tag/05KU}{\texttt{Stacks tag 05KU}}
\group{flat}
...
\begin{lemma}[Finite type flat along fibre variant]
\label{flat-lemma-finite-type-flat-along-fibre-variant}
\source{stacks:05KV}
\href{https://stacks.math.columbia.edu/tag/05KV}{\texttt{Stacks tag 05KV}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-finite-type-flat-along-fibre, flat-lemma-finite-type-flat-at-point}

(The only difference between this and
Lemma \ref{flat-lemma-finite-type-flat-along-fibre}
is that we do not assume $f$ is of finite presentation.)
For every point $x \in X_s$ we can use
Lemma \ref{flat-lemma-finite-type-flat-at-point}
to find an elementary \'etale neighbourhood $(S_x, s_x) \to (S, s)$
and an open $V_x \subset X \times_S \Spec(\mathcal{O}_{S_x, s_x})$
such that $x \in X_s = X \times_S s_x$ is contained in $V_x$ and such that
...
\begin{lemma}[Finite type flat at point X]
\label{flat-lemma-finite-type-flat-at-point-X}
\source{stacks:05I6}
\href{https://stacks.math.columbia.edu/tag/05I6}{\texttt{Stacks tag 05I6}}
\group{flat}
...
\begin{lemma}[Finite type flat at point local]
\label{flat-lemma-finite-type-flat-at-point-local}
\source{stacks:05I7}
\href{https://stacks.math.columbia.edu/tag/05I7}{\texttt{Stacks tag 05I7}}
\group{flat}
...
\begin{lemma}[Finite type flat at point local X]
\label{flat-lemma-finite-type-flat-at-point-local-X}
\source{stacks:05I8}
\href{https://stacks.math.columbia.edu/tag/05I8}{\texttt{Stacks tag 05I8}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-finite-type-flat-at-point-local}
...
Lemma \ref{flat-lemma-finite-type-flat-at-point-local}
to $\mathbf{A}^n_S \to S$, the sheaf $\mathcal{F} = i_*\mathcal{O}_X$
...
\begin{lemma}[$S$-flat and finite type extensions of finitely presented modules on a (good) open are ...]
\label{flat-lemma-flat-finite-type-finitely-presented-over-dense-open}
\source{stacks:081N}
\href{https://stacks.math.columbia.edu/tag/081N}{\texttt{Stacks tag 081N}}
\group{flat}
...
By Lemma \ref{flat-lemma-finite-type-flat-at-point-local}
...
$$
\begin{array}{cc}N'_g \longrightarrow\downarrow & N_g \downarrow \\ \prod N'_{gf_i} \longrightarrow & \prod N_{gf_i}\end{array}
$$
...
\begin{lemma}[Flat finite type finitely presented over dense open X]
\label{flat-lemma-flat-finite-type-finitely-presented-over-dense-open-X}
\source{stacks:081P}
\href{https://stacks.math.columbia.edu/tag/081P}{\texttt{Stacks tag 081P}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-flat-finite-type-finitely-presented-over-dense-open}

The question is local on $X$ and $S$, hence we may assume $X$ and
$S$ affine. Choose a closed immersion $i : X \to \mathbf{A}^n_S$
and apply
Lemma \ref{flat-lemma-flat-finite-type-finitely-presented-over-dense-open}
to $i_*\mathcal{O}_X$. Some details omitted.
\end{proof}

\begin{lemma}[Flat finite presentation dimension over dense open]
\label{flat-lemma-flat-finite-presentation-dimension-over-dense-open}
\source{stacks:081L}
\href{https://stacks.math.columbia.edu/tag/081L}{\texttt{Stacks tag 081L}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-flat-finite-type-finitely-presented-over-dense-open-X}
...
by Lemma \ref{flat-lemma-flat-finite-type-finitely-presented-over-dense-open-X}.
In this way we reduce to case (1).
\end{proof}

\begin{lemma}[Proper flat finite over dense open]
\label{flat-lemma-proper-flat-finite-over-dense-open}
\source{stacks:0B48}
\href{https://stacks.math.columbia.edu/tag/0B48}{\texttt{Stacks tag 0B48}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-flat-finite-presentation-dimension-over-dense-open}

By Lemma \ref{flat-lemma-flat-finite-presentation-dimension-over-dense-open}
...
\source{stacks:081M}
\href{https://stacks.math.columbia.edu/tag/081M}{\texttt{Stacks tag 081M}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-flat-finite-type-finitely-presented-over-dense-open-X, flat-lemma-flat-finite-presentation-dimension-over-dense-open}
...
Lemma \ref{flat-lemma-flat-finite-presentation-dimension-over-dense-open}.
...
\begin{lemma}[Induction step fp]
\label{flat-lemma-induction-step-fp}
\source{stacks:05IA}
\href{https://stacks.math.columbia.edu/tag/05IA}{\texttt{Stacks tag 05IA}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-induction-step}
...
\begin{lemma}[Complete devissage flat finitely presented module]
\label{flat-lemma-complete-devissage-flat-finitely-presented-module}
\source{stacks:05IB}
\href{https://stacks.math.columbia.edu/tag/05IB}{\texttt{Stacks tag 05IB}}
\group{flat}
...
\begin{proof}
\uses{flat-remark-finite-presentation, flat-lemma-induction-step-fp, flat-lemma-fibres-irreducible-flat-projective-nonnoetherian}
...
Lemma \ref{flat-lemma-induction-step-fp}
...
\begin{remark}[Complete devissage flat finitely presented module]
\label{flat-remark-complete-devissage-flat-finitely-presented-module}
\source{stacks:05IC}
\href{https://stacks.math.columbia.edu/tag/05IC}{\texttt{Stacks tag 05IC}}
\group{flat}

\uses{flat-lemma-complete-devissage-flat-finitely-presented-module, flat-lemma-complete-devissage-flat-finite-type-module}
There is a variant of
Lemma \ref{flat-lemma-complete-devissage-flat-finitely-presented-module}
...
\begin{proposition}[Finite presentation flat at point]
\label{flat-proposition-finite-presentation-flat-at-point}
\source{stacks:05ID}
\href{https://stacks.math.columbia.edu/tag/05ID}{\texttt{Stacks tag 05ID}}
\group{flat}
...
\begin{proof}
\uses{flat-proposition-existence-complete-at-x, flat-lemma-etale-flat-up-down, flat-remark-same-notion, flat-lemma-complete-devissage-flat-finitely-presented-module}
...
\begin{lemma}[Finite presentation flat along fibre]
\label{flat-lemma-finite-presentation-flat-along-fibre}
\source{stacks:05KW}
\href{https://stacks.math.columbia.edu/tag/05KW}{\texttt{Stacks tag 05KW}}
\group{flat}
...
$$
\begin{array}{cc}X \downarrow & X' \overset{g}{\longleftarrow}\downarrow \\ S & S' \longleftarrow\end{array}
$$
...
\begin{proof}
\uses{flat-proposition-finite-presentation-flat-at-point}

For every point $x \in X_s$ we can use
Proposition \ref{flat-proposition-finite-presentation-flat-at-point}
to find a commutative diagram
$$
\begin{array}{cc}(X, x) \downarrow & (Y_x, y_x) \overset{g_x}{\longleftarrow}\downarrow \\ (S, s) & (S_x, s_x) \longleftarrow\end{array}
$$
whose horizontal arrows are elementary \'etale neighbourhoods
...
\begin{lemma}[Finite presentation flat at point X]
\label{flat-lemma-finite-presentation-flat-at-point-X}
\source{stacks:05IE}
\href{https://stacks.math.columbia.edu/tag/05IE}{\texttt{Stacks tag 05IE}}
\group{flat}
...
\begin{lemma}[Finite presentation flat along fibre X]
\label{flat-lemma-finite-presentation-flat-along-fibre-X}
\source{stacks:05KX}
\href{https://stacks.math.columbia.edu/tag/05KX}{\texttt{Stacks tag 05KX}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-finite-presentation-flat-along-fibre}
...
\begin{lemma}[Finite type flat at point free]
\label{flat-lemma-finite-type-flat-at-point-free}
\source{stacks:05KY}
\href{https://stacks.math.columbia.edu/tag/05KY}{\texttt{Stacks tag 05KY}}
\group{flat}
...
$$
\begin{array}{cc}(X, x) \downarrow & (X', x') \overset{g}{\longleftarrow}\downarrow \\ (S, s) & (\Spec(\mathcal{O}_{S', s'}), s') \longleftarrow\end{array}
$$
...
\begin{proof}
\uses{flat-proposition-finite-type-flat-at-point, flat-proposition-finite-presentation-flat-at-point}
...
\begin{lemma}[Finite type flat at point free variant]
\label{flat-lemma-finite-type-flat-at-point-free-variant}
\source{stacks:05KZ}
\href{https://stacks.math.columbia.edu/tag/05KZ}{\texttt{Stacks tag 05KZ}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-finite-type-flat-at-point-free}

(The only difference with
Lemma \ref{flat-lemma-finite-type-flat-at-point-free}
is that we do not assume $f$ is of finite presentation.)
...
and a commutative diagram of pointed schemes
$$
\begin{array}{cc}(\mathbf{A}^n_S, t) \downarrow & (Y, y) \overset{h}{\longleftarrow}\downarrow \\ (S, s) & (\Spec(\mathcal{O}_{S', s'}), s') \longleftarrow\end{array}
$$
...
\begin{lemma}[Finite type flat along fibre free]
\label{flat-lemma-finite-type-flat-along-fibre-free}
\source{stacks:05L0}
\href{https://stacks.math.columbia.edu/tag/05L0}{\texttt{Stacks tag 05L0}}
\group{flat}
...
$$
\begin{array}{cc}X \downarrow & X' \overset{g}{\longleftarrow}\downarrow \\ S & \Spec(\mathcal{O}_{S', s'}) \longleftarrow\end{array}
$$
such that $X' \to X \times_S \Spec(\mathcal{O}_{S', s'})$
...
$$
\begin{array}{cc}(X, x) \downarrow & (Y_x, y_x) \overset{g_x}{\longleftarrow}\downarrow \\ (S, s) & (\Spec(\mathcal{O}_{S_x, s_x}), s_x) \longleftarrow\end{array}
$$
...
\begin{lemma}[Finite type flat along fibre free variant]
\label{flat-lemma-finite-type-flat-along-fibre-free-variant}
\source{stacks:05L1}
\href{https://stacks.math.columbia.edu/tag/05L1}{\texttt{Stacks tag 05L1}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-finite-type-flat-along-fibre-free, flat-lemma-finite-type-flat-at-point-free-variant}

(The only difference with
Lemma \ref{flat-lemma-finite-type-flat-along-fibre-free}
is that we do not assume $f$ is of finite presentation.)
For every point $x \in X_s$ we can use
Lemma \ref{flat-lemma-finite-type-flat-at-point-free-variant}
to find an elementary \'etale neighbourhood $(S_x , s_x) \to (S, s)$
and a commutative diagram
$$
\begin{array}{cc}(X, x) \downarrow & (Y_x, y_x) \overset{g_x}{\longleftarrow}\downarrow \\ (S, s) & (\Spec(\mathcal{O}_{S_x, s_x}), s_x) \longleftarrow\end{array}
...
\begin{lemma}[Weak bourbaki pre pre]
\label{flat-lemma-weak-bourbaki-pre-pre}
\source{stacks:0CU6}
\href{https://stacks.math.columbia.edu/tag/0CU6}{\texttt{Stacks tag 0CU6}}
\group{flat}
...
The following lemma has a slightly stronger variant
Lemma \ref{flat-lemma-weak-bourbaki}
below.

\begin{lemma}[Weak bourbaki pre]
\label{flat-lemma-weak-bourbaki-pre}
\source{stacks:05IG}
\href{https://stacks.math.columbia.edu/tag/05IG}{\texttt{Stacks tag 05IG}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-weak-bourbaki-pre-pre, flat-proposition-finite-presentation-flat-at-point, flat-lemma-etale-weak-assassin-up-down, flat-lemma-invert-universally-injective}

Pick $g \in S$ as in Lemma \ref{flat-lemma-weak-bourbaki-pre-pre}.
Apply Proposition \ref{flat-proposition-finite-presentation-flat-at-point}
...
$$
\begin{array}{ccc}S \longrightarrow & S_g \longrightarrow & S' \\  & R \nwarrow\uparrow\longrightarrow & R' \uparrow\end{array}
\quad\quad
\begin{array}{ccc}\mathfrak q \longrightarrow\searrow & \mathfrak qS_g \downarrow\longrightarrow & \mathfrak q' \downarrow \\  & \mathfrak p \longrightarrow & \mathfrak p'\end{array}
$$
...
$$
By Lemma \ref{flat-lemma-etale-weak-assassin-up-down} we have
\begin{align*}
...
Lemma \ref{flat-lemma-invert-universally-injective}
...
$\mathfrak r' \in \text{Ass}_{\overline{S}'}(\overline{N})$.
Hence by Lemma \ref{flat-lemma-invert-universally-injective}
...
\begin{lemma}[Bourbaki finite type general base at point]
\label{flat-lemma-bourbaki-finite-type-general-base-at-point}
\source{stacks:05IH}
\href{https://stacks.math.columbia.edu/tag/05IH}{\texttt{Stacks tag 05IH}}
\group{flat}
...
\begin{proof}
\uses{flat-proposition-finite-type-flat-at-point, flat-lemma-etale-weak-assassin-up-down, flat-lemma-weak-bourbaki-pre}
...
as in Proposition \ref{flat-proposition-finite-type-flat-at-point}.
...
Lemma \ref{flat-lemma-etale-weak-assassin-up-down}.
...
Lemma \ref{flat-lemma-weak-bourbaki-pre}.
\end{proof}

\begin{lemma}[Weak bourbaki]
\label{flat-lemma-weak-bourbaki}
\source{stacks:05II}
\href{https://stacks.math.columbia.edu/tag/05II}{\texttt{Stacks tag 05II}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-bourbaki-finite-type-general-base-at-point}

This lemma is a translation of
Lemma \ref{flat-lemma-bourbaki-finite-type-general-base-at-point}
into algebra. Details of translation omitted.
\end{proof}

\begin{lemma}[Bourbaki finite type general base]
\label{flat-lemma-bourbaki-finite-type-general-base}
\source{stacks:05IJ}
\href{https://stacks.math.columbia.edu/tag/05IJ}{\texttt{Stacks tag 05IJ}}
\group{flat}
...
\begin{theorem}[The flat locus is open (non-Noetherian version).]
\label{flat-theorem-finite-type-flat}
\source{stacks:05IK}
\href{https://stacks.math.columbia.edu/tag/05IK}{\texttt{Stacks tag 05IK}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-finite-type-flat-at-point-local, flat-lemma-bourbaki-finite-type-general-base}
...
\begin{lemma}[Finite type flat algebra]
\label{flat-lemma-finite-type-flat-algebra}
\source{stacks:05IL}
\href{https://stacks.math.columbia.edu/tag/05IL}{\texttt{Stacks tag 05IL}}
\group{flat}
...
\begin{proof}
\uses{flat-theorem-finite-type-flat}

Follows immediately from
Theorem \ref{flat-theorem-finite-type-flat}.
\end{proof}

\begin{lemma}[Finite type flat X]
\label{flat-lemma-finite-type-flat-X}
\source{stacks:05IM}
\href{https://stacks.math.columbia.edu/tag/05IM}{\texttt{Stacks tag 05IM}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-finite-type-flat-algebra}
...
Lemma \ref{flat-lemma-finite-type-flat-algebra}
finishes the proof.
\end{proof}

\begin{lemma}[Finite type flat over integral]
\label{flat-lemma-finite-type-flat-over-integral}
\source{stacks:05IN}
\href{https://stacks.math.columbia.edu/tag/05IN}{\texttt{Stacks tag 05IN}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-finite-type-flat-X}

Special case of
Lemma \ref{flat-lemma-finite-type-flat-X}.
\end{proof}

\begin{proposition}[Flat finite type finite presentation domain]
\label{flat-proposition-flat-finite-type-finite-presentation-domain}
\source{stacks:053G}
\href{https://stacks.math.columbia.edu/tag/053G}{\texttt{Stacks tag 053G}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-finite-type-flat-over-integral, flat-lemma-finite-type-flat-algebra}

Part (1) is a special case of
Lemma \ref{flat-lemma-finite-type-flat-over-integral}.
For Part (2) choose a surjection $R[x_1, \ldots, x_n] \to S$.
By Lemma \ref{flat-lemma-finite-type-flat-algebra} we find that $M$
...
\begin{lemma}[Finite type version of Theorem flat-theorem-finite-type-flat]

\label{flat-lemma-finite-type-flat}
\source{stacks:05IQ}
\href{https://stacks.math.columbia.edu/tag/05IQ}{\texttt{Stacks tag 05IQ}}
\group{flat}
...
We apply Theorem \ref{flat-theorem-finite-type-flat} to $X' = \mathbf{A}^n_S \to S$
...
\begin{lemma}[Finite type flat algebra bis]
\label{flat-lemma-finite-type-flat-algebra-bis}
\source{stacks:05IR}
\href{https://stacks.math.columbia.edu/tag/05IR}{\texttt{Stacks tag 05IR}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-finite-type-flat}

This is Lemma \ref{flat-lemma-finite-type-flat} translated into algebra.
\end{proof}
...
\ref{flat-lemma-universally-injective-to-completion-flat}, and
\ref{flat-lemma-flat-pure-over-complete-projective}.
See also
Algebra, Lemma \ref{algebra-lemma-compare-relative-assassins}
for a discussion.

\begin{lemma}[Explain why pure]
\label{flat-lemma-explain-why-pure}
\source{stacks:05FV}
\href{https://stacks.math.columbia.edu/tag/05FV}{\texttt{Stacks tag 05FV}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-homothety-spectrum, flat-lemma-invert-universally-injective}

Note that the hypotheses of
Lemmas \ref{flat-lemma-homothety-spectrum} and
...
\begin{lemma}[Explain why pure complete]
\label{flat-lemma-explain-why-pure-complete}
\source{stacks:05IT}
\href{https://stacks.math.columbia.edu/tag/05IT}{\texttt{Stacks tag 05IT}}
\group{flat}
...
Lemma \ref{flat-lemma-explain-why-pure}
as a projective module over a local ring is free, see
Algebra, Theorem \ref{algebra-theorem-projective-free-over-local-ring}.

\begin{lemma}[Explain why pure direct sum finite modules]
\label{flat-lemma-explain-why-pure-direct-sum-finite-modules}
\source{stacks:05IU}
\href{https://stacks.math.columbia.edu/tag/05IU}{\texttt{Stacks tag 05IU}}
\group{flat}
...
\begin{lemma}[Explain why pure ML]
\label{flat-lemma-explain-why-pure-ML}
\source{stacks:05IV}
\href{https://stacks.math.columbia.edu/tag/05IV}{\texttt{Stacks tag 05IV}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-explain-why-pure-direct-sum-finite-modules}

This lemma reduces to
Lemma \ref{flat-lemma-explain-why-pure-direct-sum-finite-modules}
by
...
Picture
$$
\begin{array}{ccc}\xi \downarrow & Z \longrightarrow\searrow & X \overset{f}{\downarrow} \\ f(\xi) &  & S\end{array}
$$
...
\ref{flat-lemma-explain-why-pure-direct-sum-finite-modules}, and
...
\begin{definition}[Situation: Pre pure]
\label{flat-situation-pre-pure}
\source{stacks:05FW}
\href{https://stacks.math.columbia.edu/tag/05FW}{\texttt{Stacks tag 05FW}}
\group{flat}
...
\vcenter{
\begin{array}{ccc}\xi \downarrow &  &  \\ t' \rightsquigarrow & t \longmapsto & s\end{array}
}
\quad\quad
\vcenter{
\begin{array}{cc}X_T \downarrow\longrightarrow & X \downarrow \\ T \overset{g}{\longrightarrow} & S\end{array}
}
\end{equation}
Moreover, denote $\mathcal{F}_T$ the pullback of $\mathcal{F}$ to $X_T$.

\begin{definition}[Impurity]
\label{flat-definition-impurity}
\source{stacks:05IY}
\href{https://stacks.math.columbia.edu/tag/05IY}{\texttt{Stacks tag 05IY}}
\group{flat}

\uses{flat-situation-pre-pure}
In
...
\begin{lemma}[Impure finite presentation]
\label{flat-lemma-impure-finite-presentation}
\source{stacks:05FX}
\href{https://stacks.math.columbia.edu/tag/05FX}{\texttt{Stacks tag 05FX}}
\group{flat}

\uses{flat-situation-pre-pure}
In Situation \ref{flat-situation-pre-pure}.
...
$$
\begin{array}{cc}V \downarrow\underset{a}{\longrightarrow} & T' \overset{b}{\downarrow} \\ T \overset{g}{\longrightarrow} & S,\end{array}
$$
...
$$
\begin{array}{ccc}X_T \downarrow\longrightarrow & X_{T'} \downarrow\longrightarrow & X \downarrow \\ T \overset{a}{\longrightarrow} & T' \overset{b}{\longrightarrow} & S\end{array}
$$
...
\begin{lemma}[Impure limit]
\label{flat-lemma-impure-limit}
\source{stacks:05IZ}
\href{https://stacks.math.columbia.edu/tag/05IZ}{\texttt{Stacks tag 05IZ}}
\group{flat}
...
\begin{lemma}[Quasi finite impurity elementary]
\label{flat-lemma-quasi-finite-impurity-elementary}
\source{stacks:05J0}
\href{https://stacks.math.columbia.edu/tag/05J0}{\texttt{Stacks tag 05J0}}
\group{flat}
...
$$
\begin{array}{ccc}T \downarrow & T \times_S U \longleftarrow\downarrow & V \longleftarrow\swarrow \\ S & U \longleftarrow & \end{array}
$$
...
\begin{lemma}[Noetherian impurity quasi finite]
\label{flat-lemma-Noetherian-impurity-quasi-finite}
\source{stacks:05J1}
\href{https://stacks.math.columbia.edu/tag/05J1}{\texttt{Stacks tag 05J1}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-impure-finite-presentation}

We may replace $S$ by an affine neighbourhood of $s$. By
Lemma \ref{flat-lemma-impure-finite-presentation}
...
\begin{lemma}[Impurity on henselization]
\label{flat-lemma-impurity-on-henselization}
\source{stacks:05J2}
\href{https://stacks.math.columbia.edu/tag/05J2}{\texttt{Stacks tag 05J2}}
\group{flat}
...
Lemma \ref{flat-lemma-impure-limit}.
\end{proof}

\begin{lemma}[Pure along X s]
\label{flat-lemma-pure-along-X-s}
\source{stacks:05J3}
\href{https://stacks.math.columbia.edu/tag/05J3}{\texttt{Stacks tag 05J3}}
\group{flat}

\uses{flat-situation-pre-pure}
In Situation \ref{flat-situation-pre-pure} the following
are equivalent
\begin{enumerate}
...
\begin{proof}
\uses{flat-lemma-quasi-finite-impurity-elementary, flat-lemma-impurity-on-henselization}

As an \'etale morphism is locally quasi-finite it is clear that
(2) implies (3). We have seen that (3) implies (2) in
Lemma \ref{flat-lemma-quasi-finite-impurity-elementary}.
We have seen that (1) implies (2) in
Lemma \ref{flat-lemma-impurity-on-henselization}.
...
\source{stacks:05J4}
\href{https://stacks.math.columbia.edu/tag/05J4}{\texttt{Stacks tag 05J4}}
\group{flat}
...
finite type, see
Remark \ref{flat-remark-discuss-finite-type}
for a discussion. In the situation of the definition
Lemma \ref{flat-lemma-pure-along-X-s}
...
\begin{remark}[Discuss finite type]
\label{flat-remark-discuss-finite-type}
\source{stacks:05J5}
\href{https://stacks.math.columbia.edu/tag/05J5}{\texttt{Stacks tag 05J5}}
\group{flat}

\uses{flat-lemma-quasi-finite-impurity-elementary}
Let $f : X \to S$ be a morphism which is locally of finite type
...
Lemma \ref{flat-lemma-Noetherian-base-change}),
or if the sheaf is flat (see
Lemmas \ref{flat-lemma-finite-type-flat-pure-along-fibre-is-universal} and
...
\begin{lemma}[Base change universally]
\label{flat-lemma-base-change-universally}
\source{stacks:05J6}
\href{https://stacks.math.columbia.edu/tag/05J6}{\texttt{Stacks tag 05J6}}
\group{flat}
...
\begin{lemma}[Quasi finite base change]
\label{flat-lemma-quasi-finite-base-change}
\source{stacks:05J7}
\href{https://stacks.math.columbia.edu/tag/05J7}{\texttt{Stacks tag 05J7}}
\group{flat}
...
Definition \ref{flat-definition-pure}.
\end{proof}

\begin{lemma}[Noetherian base change]
\label{flat-lemma-Noetherian-base-change}
\source{stacks:05J8}
\href{https://stacks.math.columbia.edu/tag/05J8}{\texttt{Stacks tag 05J8}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-Noetherian-impurity-quasi-finite, flat-definition-pure}

First we may replace $S$ by $\Spec(\mathcal{O}_{S, s})$, i.e.,
we may assume that $S$ is Noetherian. Next, use
Lemma \ref{flat-lemma-Noetherian-impurity-quasi-finite}
...
\begin{lemma}[Flat descend pure]
\label{flat-lemma-flat-descend-pure}
\source{stacks:05J9}
\href{https://stacks.math.columbia.edu/tag/05J9}{\texttt{Stacks tag 05J9}}
\group{flat}
...
\begin{lemma}[Supported on closed]
\label{flat-lemma-supported-on-closed}
\source{stacks:05K1}
\href{https://stacks.math.columbia.edu/tag/05K1}{\texttt{Stacks tag 05K1}}
\group{flat}
...
\begin{lemma}[Proper pure]
\label{flat-lemma-proper-pure}
\source{stacks:05K3}
\href{https://stacks.math.columbia.edu/tag/05K3}{\texttt{Stacks tag 05K3}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-supported-on-closed}
...
Thus by Lemma \ref{flat-lemma-supported-on-closed} case (1) reduces to case (2).
...
\begin{lemma}[Quasi finite pure]
\label{flat-lemma-quasi-finite-pure}
\source{stacks:05K4}
\href{https://stacks.math.columbia.edu/tag/05K4}{\texttt{Stacks tag 05K4}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-supported-on-closed, flat-lemma-proper-pure}
...
$$
\begin{array}{ccc}X \underset{f}{\searrow}\underset{j}{\longrightarrow} &  & T \overset{\pi}{\swarrow} \\  & S & \end{array}
$$
...
\begin{lemma}[Flat geometrically integral fibres pure]
\label{flat-lemma-flat-geometrically-integral-fibres-pure}
\source{stacks:05K5}
\href{https://stacks.math.columbia.edu/tag/05K5}{\texttt{Stacks tag 05K5}}
\group{flat}
...
\begin{lemma}[Affine locally projective pure]
\label{flat-lemma-affine-locally-projective-pure}
\source{stacks:05K6}
\href{https://stacks.math.columbia.edu/tag/05K6}{\texttt{Stacks tag 05K6}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-explain-why-pure}
...
\begin{lemma}[Associated point specializes]
\label{flat-lemma-associated-point-specializes}
\source{stacks:05L3}
\href{https://stacks.math.columbia.edu/tag/05L3}{\texttt{Stacks tag 05L3}}
\group{flat}
...
\source{stacks:05L4}
\href{https://stacks.math.columbia.edu/tag/05L4}{\texttt{Stacks tag 05L4}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-quasi-finite-base-change, flat-lemma-flat-descend-pure, flat-lemma-associated-point-specializes, flat-definition-pure, flat-lemma-etale-weak-assassin-up-down}
...
Lemma \ref{flat-lemma-etale-weak-assassin-up-down} (applied to
...
\begin{lemma}[Finite type flat pure along fibre is universal]
\label{flat-lemma-finite-type-flat-pure-along-fibre-is-universal}
\source{stacks:05L5}
\href{https://stacks.math.columbia.edu/tag/05L5}{\texttt{Stacks tag 05L5}}
\group{flat}
...
\begin{proof}
\uses{flat-definition-pure, flat-lemma-flat-descend-pure, flat-lemma-finite-type-flat-along-fibre-free-variant, flat-lemma-affine-locally-projective-pure, flat-lemma-criterion}
...
Lemma \ref{flat-lemma-finite-type-flat-along-fibre-free-variant}.
...
$$
\begin{array}{ccc}X \searrow &  & X' \overset{g}{\longleftarrow}\swarrow \\  & S & \end{array}
$$
...
Lemma \ref{flat-lemma-affine-locally-projective-pure}.
...
\begin{lemma}[Finite type flat pure is universal]
\label{flat-lemma-finite-type-flat-pure-is-universal}
\source{stacks:05L6}
\href{https://stacks.math.columbia.edu/tag/05L6}{\texttt{Stacks tag 05L6}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-finite-type-flat-pure-along-fibre-is-universal}
...
\begin{lemma}[Limit purity]
\label{flat-lemma-limit-purity}
\source{stacks:05MA}
\href{https://stacks.math.columbia.edu/tag/05MA}{\texttt{Stacks tag 05MA}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-finite-presentation-flat-along-fibre, flat-lemma-affine-locally-projective-pure, flat-lemma-criterion}
...
$$
\begin{array}{cc}X_i \downarrow & X_i' \overset{g_i}{\longleftarrow}\downarrow \\ S_i & S_i' \longleftarrow\end{array}
$$
...
\begin{lemma}[Flat finite presentation purity open]
\label{flat-lemma-flat-finite-presentation-purity-open}
\source{stacks:05MC}
\href{https://stacks.math.columbia.edu/tag/05MC}{\texttt{Stacks tag 05MC}}
\group{flat}
...
\begin{lemma}[Injectivity map source flat pure]
\label{flat-lemma-injectivity-map-source-flat-pure}
\source{stacks:05L8}
\href{https://stacks.math.columbia.edu/tag/05L8}{\texttt{Stacks tag 05L8}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-bourbaki-finite-type-general-base, flat-lemma-associated-point-specializes}
...
\begin{proposition}[Finite presentation flat pure is projective]
\label{flat-proposition-finite-presentation-flat-pure-is-projective}
\source{stacks:05MD}
\href{https://stacks.math.columbia.edu/tag/05MD}{\texttt{Stacks tag 05MD}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-affine-locally-projective-pure, flat-lemma-finite-type-flat-pure-along-fibre-is-universal, flat-lemma-finite-presentation-flat-along-fibre, flat-lemma-criterion, flat-lemma-base-change-universally-flat}
...
\begin{lemma}[Flat finite presentation affine neighbourhood projective]
\label{flat-lemma-flat-finite-presentation-affine-neighbourhood-projective}
\source{stacks:05ME}
\href{https://stacks.math.columbia.edu/tag/05ME}{\texttt{Stacks tag 05ME}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-finite-presentation-flat-along-fibre, flat-lemma-affine-locally-projective-pure, flat-lemma-flat-finite-presentation-purity-open, flat-proposition-finite-presentation-flat-pure-is-projective, flat-lemma-associated-point-specializes, flat-lemma-etale-weak-assassin-up-down}
...
\begin{lemma}[Flat finite type affine neighbourhood projective]
\label{flat-lemma-flat-finite-type-affine-neighbourhood-projective}
\source{stacks:05MF}
\href{https://stacks.math.columbia.edu/tag/05MF}{\texttt{Stacks tag 05MF}}
\group{flat}
...
\begin{proof}
\uses{flat-proposition-finite-type-flat-at-point, flat-lemma-flat-finite-presentation-affine-neighbourhood-projective}
...
\begin{lemma}[Flat finite type local colimit free]
\label{flat-lemma-flat-finite-type-local-colimit-free}
\source{stacks:05U7}
\href{https://stacks.math.columbia.edu/tag/05U7}{\texttt{Stacks tag 05U7}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-flat-finite-type-affine-neighbourhood-projective, flat-lemma-universally-injective-local}
...
$A$-universally injective (Lemma \ref{flat-lemma-universally-injective-local})
...
\begin{lemma}[Flat finite type local valuation ring has content]
\label{flat-lemma-flat-finite-type-local-valuation-ring-has-content}
\source{stacks:0ASX}
\href{https://stacks.math.columbia.edu/tag/0ASX}{\texttt{Stacks tag 0ASX}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-flat-finite-type-local-colimit-free}
...
Lemma \ref{flat-lemma-flat-finite-type-local-colimit-free} and
Algebra, Lemma \ref{algebra-lemma-minimal-contains}.
\end{proof}

An application is the following.

\begin{lemma}[Proper flat over dvr reduced fibre]
\label{flat-lemma-proper-flat-over-dvr-reduced-fibre}
\source{stacks:0H2T}
\href{https://stacks.math.columbia.edu/tag/0H2T}{\texttt{Stacks tag 0H2T}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-flat-finite-type-local-valuation-ring-has-content}
...
$A$ is reduced. Let $a \in A$ be nonzero and let $I = (\pi) \subset R$ be its
content ideal, see
Lemma \ref{flat-lemma-flat-finite-type-local-valuation-ring-has-content}.
...
\begin{definition}[Situation: Iso]
\label{flat-situation-iso}
\source{stacks:05MH}
\href{https://stacks.math.columbia.edu/tag/05MH}{\texttt{Stacks tag 05MH}}
\group{flat}
...
\begin{lemma}[Iso sheaf]
\label{flat-lemma-iso-sheaf}
\source{stacks:05MJ}
\href{https://stacks.math.columbia.edu/tag/05MJ}{\texttt{Stacks tag 05MJ}}
\group{flat}

\uses{flat-situation-iso}
In Situation \ref{flat-situation-iso}.
\begin{enumerate}
...
\begin{definition}[Situation: Flat at point]
\label{flat-situation-flat-at-point}
\source{stacks:05MK}
\href{https://stacks.math.columbia.edu/tag/05MK}{\texttt{Stacks tag 05MK}}
\group{flat}
...
\source{stacks:05MN}
\href{https://stacks.math.columbia.edu/tag/05MN}{\texttt{Stacks tag 05MN}}
\group{flat}

\uses{flat-situation-flat-at-point}
In Situation \ref{flat-situation-flat-at-point}.
\begin{enumerate}
...
\begin{lemma}[Flat at point finite]
\label{flat-lemma-flat-at-point-finite}
\source{stacks:05P4}
\href{https://stacks.math.columbia.edu/tag/05P4}{\texttt{Stacks tag 05P4}}
\group{flat}

\uses{flat-situation-flat-at-point}
In Situation \ref{flat-situation-flat-at-point}. Let $B \to C$ is a local map of
...
\begin{lemma}[Flat at point go up]
\label{flat-lemma-flat-at-point-go-up}
\source{stacks:05P5}
\href{https://stacks.math.columbia.edu/tag/05P5}{\texttt{Stacks tag 05P5}}
\group{flat}
...
of $B'$, $M'$ in
Situation \ref{flat-situation-flat-at-point}. Note that
$$
...
\begin{definition}[Situation: Free at generic points]
\label{flat-situation-free-at-generic-points}
\source{stacks:05MP}
\href{https://stacks.math.columbia.edu/tag/05MP}{\texttt{Stacks tag 05MP}}
\group{flat}
...
\begin{lemma}[Free at generic points]
\label{flat-lemma-free-at-generic-points}
\source{stacks:05MS}
\href{https://stacks.math.columbia.edu/tag/05MS}{\texttt{Stacks tag 05MS}}
\group{flat}

\uses{flat-situation-free-at-generic-points}
In Situation \ref{flat-situation-free-at-generic-points}.
\begin{enumerate}
...
\begin{lemma}[Pre flat dimension n]
\label{flat-lemma-pre-flat-dimension-n}
\source{stacks:0CWF}
\href{https://stacks.math.columbia.edu/tag/0CWF}{\texttt{Stacks tag 0CWF}}
\group{flat}

\uses{flat-lemma-open-in-fibre-where-flat}
Let $f : X \to S$ be a morphism of schemes which is locally of finite type.
...
Lemma \ref{flat-lemma-open-in-fibre-where-flat})
...
\begin{definition}[Flat dimension n]
\label{flat-definition-flat-dimension-n}
\source{stacks:0CWG}
\href{https://stacks.math.columbia.edu/tag/0CWG}{\texttt{Stacks tag 0CWG}}
\group{flat}

\uses{flat-lemma-pre-flat-dimension-n}
Let $f : X \to S$ be a morphism of schemes which is locally of finite type.
Let $\mathcal{F}$ be a quasi-coherent $\mathcal{O}_X$-module of finite type.
Let $n \geq 0$.
We say {\it $\mathcal{F}$ is flat over $S$ in dimensions $\geq n$}
if the equivalent conditions of Lemma \ref{flat-lemma-pre-flat-dimension-n}
are satisfied.
\end{definition}

\begin{definition}[Situation: Flat dimension n]
\label{flat-situation-flat-dimension-n}
\source{stacks:05MT}
\href{https://stacks.math.columbia.edu/tag/05MT}{\texttt{Stacks tag 05MT}}
\group{flat}

\uses{flat-definition-flat-dimension-n, flat-lemma-pre-flat-dimension-n}
Let $f : X \to S$ be a morphism of schemes which is locally of finite type.
Let $\mathcal{F}$ be a quasi-coherent $\mathcal{O}_X$-module of finite
...
Let $n \geq 0$. By Definition \ref{flat-definition-flat-dimension-n} and
Lemma \ref{flat-lemma-pre-flat-dimension-n} we obtain a functor
\begin{equation}
...
\begin{lemma}[Flat dimension n]
\label{flat-lemma-flat-dimension-n}
\source{stacks:05MV}
\href{https://stacks.math.columbia.edu/tag/05MV}{\texttt{Stacks tag 05MV}}
\group{flat}

\uses{flat-situation-flat-dimension-n}
In Situation \ref{flat-situation-flat-dimension-n}.
\begin{enumerate}
...
$$
\begin{array}{cc}X_{\Spec(\mathcal{O}_{T, t})} \downarrow & X_{\Spec(\mathcal{O}_{T_i, t_i})} \downarrow\longleftarrow \\ \Spec(\mathcal{O}_{T, t}) & \Spec(\mathcal{O}_{T_i, t_i}) \longleftarrow\end{array}
$$
...
\begin{definition}[Situation: Flat]
\label{flat-situation-flat}
\source{stacks:05MW}
\href{https://stacks.math.columbia.edu/tag/05MW}{\texttt{Stacks tag 05MW}}
\group{flat}
...
\source{stacks:05MY}
\href{https://stacks.math.columbia.edu/tag/05MY}{\texttt{Stacks tag 05MY}}
\group{flat}

\uses{flat-situation-flat}
In Situation \ref{flat-situation-flat}.
\begin{enumerate}
...
\begin{proof}
\uses{flat-lemma-flat-dimension-n}
...
the proof of
Lemma \ref{flat-lemma-flat-dimension-n}).
\end{proof}
...
\source{stacks:05P6}
\href{https://stacks.math.columbia.edu/tag/05P6}{\texttt{Stacks tag 05P6}}
\group{flat}
...
if the functor $F_{flat}$ defined in Situation \ref{flat-situation-flat}
...
\begin{example}[No universal flattening]
\label{flat-example-no-universal-flattening}
\source{stacks:0FJ1}
\href{https://stacks.math.columbia.edu/tag/0FJ1}{\texttt{Stacks tag 0FJ1}}
\group{flat}
...
\begin{definition}[Flattening stratification]
\label{flat-definition-flattening-stratification}
\source{stacks:05P7}
\href{https://stacks.math.columbia.edu/tag/05P7}{\texttt{Stacks tag 05P7}}
\group{flat}
...
\begin{lemma}[Flattening stratification artinian]
\label{flat-lemma-flattening-stratification-artinian}
\source{stacks:05PB}
\href{https://stacks.math.columbia.edu/tag/05PB}{\texttt{Stacks tag 05PB}}
\group{flat}
...
Theorem \ref{flat-theorem-flattening-map}
is the key to further flattening statements.

\begin{lemma}[Universally separating]
\label{flat-lemma-universally-separating}
\source{stacks:05PD}
\href{https://stacks.math.columbia.edu/tag/05PD}{\texttt{Stacks tag 05PD}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-bourbaki-finite-type-general-base}
...
\begin{lemma}[Flattening module map]
\label{flat-lemma-flattening-module-map}
\source{stacks:05PE}
\href{https://stacks.math.columbia.edu/tag/05PE}{\texttt{Stacks tag 05PE}}
\group{flat}
...
\begin{theorem}[Flattening map]
\label{flat-theorem-flattening-map}
\source{stacks:05PF}
\href{https://stacks.math.columbia.edu/tag/05PF}{\texttt{Stacks tag 05PF}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-finite-type-flat-pure-along-fibre-is-universal, flat-lemma-iso-sheaf, flat-lemma-finite-presentation-flat-along-fibre, flat-lemma-affine-locally-projective-pure, flat-lemma-criterion, flat-lemma-universally-separating, flat-lemma-flattening-module-map}

We will use without further mention that $\mathcal{F}$ is universally pure
over $S$, see
Lemma \ref{flat-lemma-finite-type-flat-pure-along-fibre-is-universal}.
By
Lemma \ref{flat-lemma-iso-sheaf}
and
...
Lemma \ref{flat-lemma-universally-separating}
...
Lemma \ref{flat-lemma-flattening-module-map}.

\medskip\noindent
To see that $Z$ is of finite presentation if $\mathcal{G}$ is of finite
presentation, combine
Lemma \ref{flat-lemma-iso-sheaf} part (4)
with
Limits, Remark \ref{limits-remark-limit-preserving}.
\end{proof}

\begin{lemma}[Weil restriction closed subschemes]
\label{flat-lemma-Weil-restriction-closed-subschemes}
\source{stacks:07AI}
\href{https://stacks.math.columbia.edu/tag/07AI}{\texttt{Stacks tag 07AI}}
\group{flat}
...
\begin{proof}
\uses{flat-theorem-flattening-map}
...
\begin{theorem}[Flattening local]
\label{flat-theorem-flattening-local}
\source{stacks:05PG}
\href{https://stacks.math.columbia.edu/tag/05PG}{\texttt{Stacks tag 05PG}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-flat-at-point-go-up, flat-lemma-existence-algebra, flat-definition-complete-devissage-at-x-algebra, flat-lemma-flat-at-point-finite, flat-lemma-induction-step, flat-lemma-complete-devissage-flat-finite-type-module, flat-theorem-flattening-map, flat-lemma-flat-at-point}
...
Definition \ref{flat-definition-complete-devissage-at-x-algebra}.
Since $C \to A_1$ is surjective and $N \cong M_1$ as $C$-modules,
we see by
Lemma \ref{flat-lemma-flat-at-point-finite}
...
Lemma \ref{flat-lemma-flat-at-point} part (2).
Clearly this implies that $I = I_\lambda$.
\end{proof}

\begin{remark}[Flattening local scheme theoretic]
\label{flat-remark-flattening-local-scheme-theoretic}
\source{stacks:05PH}
\href{https://stacks.math.columbia.edu/tag/05PH}{\texttt{Stacks tag 05PH}}
\group{flat}

\uses{flat-theorem-flattening-local}
Here is a scheme theoretic reformulation of
Theorem \ref{flat-theorem-flattening-local}.
...
\source{stacks:05PI}
\href{https://stacks.math.columbia.edu/tag/05PI}{\texttt{Stacks tag 05PI}}
\group{flat}
...
\begin{proof}
\uses{flat-remark-flattening-local-scheme-theoretic, flat-theorem-flattening-local}

For $x \in X_s$ denote $Z_x \subset S$ the closed subscheme we found in
Remark \ref{flat-remark-flattening-local-scheme-theoretic}.
...
\begin{remark}[Flattening complete noetherian]
\label{flat-remark-flattening-complete-noetherian}
\source{stacks:052G}
\href{https://stacks.math.columbia.edu/tag/052G}{\texttt{Stacks tag 052G}}
\group{flat}

\uses{flat-lemma-freebie}
Tracing the proof of
Lemma \ref{flat-lemma-freebie}
...
Lemma \ref{flat-lemma-upstairs-finite-type-injective-into-flat-mod-m}.
...
Theorem \ref{flat-theorem-check-flatness-at-associated-points}.

\begin{definition}[Situation: Mod injective]
\label{flat-situation-mod-injective}
\source{stacks:0AT0}
\href{https://stacks.math.columbia.edu/tag/0AT0}{\texttt{Stacks tag 0AT0}}
\group{flat}
...
\begin{lemma}[Noetherian finite type injective into flat mod m]
\label{flat-lemma-Noetherian-finite-type-injective-into-flat-mod-m}
\source{stacks:0AT1}
\href{https://stacks.math.columbia.edu/tag/0AT1}{\texttt{Stacks tag 0AT1}}
\group{flat}

\uses{flat-situation-mod-injective}
If in Situation \ref{flat-situation-mod-injective} the ring $A$ is Noetherian
...
\begin{lemma}[Reduce finite type injective into flat mod m]
\label{flat-lemma-reduce-finite-type-injective-into-flat-mod-m}
\source{stacks:0AT2}
\href{https://stacks.math.columbia.edu/tag/0AT2}{\texttt{Stacks tag 0AT2}}
\group{flat}

\uses{flat-situation-mod-injective}
Let $A_0$ be a local ring. If the lemma holds for every
Situation \ref{flat-situation-mod-injective} with $A = A_0$, with $B$ a
localization of a polynomial algebra over $A$, and $N$ of finite presentation
over $B$, then the lemma holds for every
Situation \ref{flat-situation-mod-injective} with $A = A_0$.
\end{lemma}

\begin{proof}
\uses{flat-situation-mod-injective}

Let $A \to B$, $u : N \to M$ be as in Situation \ref{flat-situation-mod-injective}.
...
\begin{lemma}[Henselian finite type injective into flat mod m]
\label{flat-lemma-henselian-finite-type-injective-into-flat-mod-m}
\source{stacks:0AT3}
\href{https://stacks.math.columbia.edu/tag/0AT3}{\texttt{Stacks tag 0AT3}}
\group{flat}

\uses{flat-situation-mod-injective}
If in Situation \ref{flat-situation-mod-injective} the ring $A$ is henselian
then the lemma holds.
\end{lemma}

\begin{proof}
\uses{flat-lemma-reduce-finite-type-injective-into-flat-mod-m, flat-lemma-flat-finite-type-local-colimit-free, flat-lemma-universally-injective-local, flat-theorem-flattening-local}

It suffices to prove this when $B$ is essentially of finite presentation
over $A$ and $N$ is of finite presentation over $B$, see
Lemma \ref{flat-lemma-reduce-finite-type-injective-into-flat-mod-m}.
...
Lemma \ref{flat-lemma-flat-finite-type-local-colimit-free}.
...
$$
\begin{array}{ccccc}0 \longrightarrow & M \otimes_A I/I^2 \longrightarrow & M/I^2M \longrightarrow & M/IM \longrightarrow & 0 \\  & N \otimes_A I/I^2 \longrightarrow\overset{u}{\uparrow} & N/I^2N \longrightarrow\overset{u}{\uparrow} & N/IN \longrightarrow\overset{u}{\uparrow} & 0\end{array}
$$
...
Situation \ref{flat-situation-mod-injective} where $M$ has
...
\begin{lemma}[Upstairs finite type injective into flat mod m]
\label{flat-lemma-upstairs-finite-type-injective-into-flat-mod-m}
\source{stacks:0AT4}
\href{https://stacks.math.columbia.edu/tag/0AT4}{\texttt{Stacks tag 0AT4}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-henselian-finite-type-injective-into-flat-mod-m}
...
Lemma \ref{flat-lemma-henselian-finite-type-injective-into-flat-mod-m}.
\end{proof}

\begin{lemma}[Valuation ring finite type injective into flat mod m]
\label{flat-lemma-valuation-ring-finite-type-injective-into-flat-mod-m}
\source{stacks:0AT5}
\href{https://stacks.math.columbia.edu/tag/0AT5}{\texttt{Stacks tag 0AT5}}
\group{flat}

\uses{flat-situation-mod-injective}
If in Situation \ref{flat-situation-mod-injective} the ring $A$ is a
...
\begin{lemma}[Properties pure spreadout]
\label{flat-lemma-properties-pure-spreadout}
\source{stacks:0AT7}
\href{https://stacks.math.columbia.edu/tag/0AT7}{\texttt{Stacks tag 0AT7}}
\group{flat}
...
\begin{lemma}[Find pure spreadout]
\label{flat-lemma-find-pure-spreadout}
\source{stacks:0AT8}
\href{https://stacks.math.columbia.edu/tag/0AT8}{\texttt{Stacks tag 0AT8}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-invert-universally-injective}
...
\begin{lemma}[Universally injective if flat]
\label{flat-lemma-universally-injective-if-flat}
\source{stacks:0AT9}
\href{https://stacks.math.columbia.edu/tag/0AT9}{\texttt{Stacks tag 0AT9}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-find-pure-spreadout, flat-lemma-properties-pure-spreadout}
...
Lemma \ref{flat-lemma-find-pure-spreadout}. Then $I^n y = 0$ for some $n$. Now
...
Lemma \ref{flat-lemma-properties-pure-spreadout} part (2).
\end{proof}

\begin{lemma}[Big intersection is zero]
\label{flat-lemma-big-intersection-is-zero}
\source{stacks:0ATA}
\href{https://stacks.math.columbia.edu/tag/0ATA}{\texttt{Stacks tag 0ATA}}
\group{flat}
...
\begin{lemma}[Closed points complement]
\label{flat-lemma-closed-points-complement}
\source{stacks:0ATB}
\href{https://stacks.math.columbia.edu/tag/0ATB}{\texttt{Stacks tag 0ATB}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-big-intersection-is-zero}
...
Hence by Lemma \ref{flat-lemma-big-intersection-is-zero} applied
to the collection of ideals $J^nA/\mathfrak p$ we conclude that
the image of $f$ is zero in $A/\mathfrak p$.
\end{proof}

\begin{lemma}[Make smaller flatness ideal]
\label{flat-lemma-make-smaller-flatness-ideal}
\source{stacks:0ATC}
\href{https://stacks.math.columbia.edu/tag/0ATC}{\texttt{Stacks tag 0ATC}}
\group{flat}
...
\begin{proposition}[Finite type injective into flat mod m]
\label{flat-proposition-finite-type-injective-into-flat-mod-m}
\source{stacks:05U9}
\href{https://stacks.math.columbia.edu/tag/05U9}{\texttt{Stacks tag 05U9}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-reduce-finite-type-injective-into-flat-mod-m, flat-theorem-flattening-local, flat-lemma-closed-points-complement, flat-lemma-make-smaller-flatness-ideal, flat-lemma-find-pure-spreadout, flat-lemma-properties-pure-spreadout, flat-lemma-universally-injective-if-flat, flat-lemma-flat-finite-type-local-colimit-free, flat-lemma-big-intersection-is-zero}
...
Theorem \ref{flat-theorem-flattening-local} there is a smallest ideal
...
of $S_i \subset \Spec(A)$. By Lemma \ref{flat-lemma-closed-points-complement}
we see that $V(I)$ contains the closed points of $U = \Spec(A^h) - S_1^h$.
By construction $N'$ is $A^h$-flat over $U$.
By Lemma \ref{flat-lemma-make-smaller-flatness-ideal} we see that $N'/I_2N'$
...
of Theorem \ref{flat-theorem-flattening-local} is nilpotent.
...
By Lemma \ref{flat-lemma-find-pure-spreadout}
...
Lemma \ref{flat-lemma-properties-pure-spreadout}
...
injective, see Lemma \ref{flat-lemma-universally-injective-if-flat}.
...
By Lemma \ref{flat-lemma-flat-finite-type-local-colimit-free} and
More on Algebra, Lemma
...
Lemma \ref{flat-lemma-big-intersection-is-zero}.
...
Lemma \ref{flat-lemma-universally-injective-if-flat}.
Then the diagrams
$$
\begin{array}{cc}N \otimes_A (I_0^n/I_0^{n + 1}) \longrightarrow\downarrow & M \otimes_A (I_0^n/I_0^{n + 1}) \downarrow \\ I_0^n N /I_0^{n + 1} N \longrightarrow & I_0^n M /I_0^{n + 1} M\end{array}
$$
...
\begin{theorem}[Check flatness at associated points]
\label{flat-theorem-check-flatness-at-associated-points}
\source{stacks:05UA}
\href{https://stacks.math.columbia.edu/tag/05UA}{\texttt{Stacks tag 05UA}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-homothety-spectrum, flat-lemma-upstairs-finite-type-injective-into-flat-mod-m}
...
\begin{lemma}[Check along closed fibre]
\label{flat-lemma-check-along-closed-fibre}
\source{stacks:05UB}
\href{https://stacks.math.columbia.edu/tag/05UB}{\texttt{Stacks tag 05UB}}
\group{flat}
...
\begin{proof}
\uses{flat-theorem-check-flatness-at-associated-points}
...
\begin{lemma}[Free at generic points representable]
\label{flat-lemma-free-at-generic-points-representable}
\source{stacks:05UC}
\href{https://stacks.math.columbia.edu/tag/05UC}{\texttt{Stacks tag 05UC}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-free-at-generic-points, flat-lemma-injectivity-map-source-flat-pure, flat-lemma-induction-step-fp, flat-theorem-flattening-map}

For each $S$ we will prove the statement for all $p \geq 0$ concurrently.
The functor $H_p$ is a sheaf for the fppf topology by
Lemma \ref{flat-lemma-free-at-generic-points}.
Hence combining
...
Lemma \ref{flat-lemma-injectivity-map-source-flat-pure}
but also from
Lemma \ref{flat-lemma-induction-step-fp}
...
Lemma \ref{flat-lemma-free-at-generic-points} part (2) combined with
Limits, Remark \ref{limits-remark-limit-preserving}.
...
\begin{lemma}[Localize flat dimension n]
\label{flat-lemma-localize-flat-dimension-n}
\source{stacks:05UD}
\href{https://stacks.math.columbia.edu/tag/05UD}{\texttt{Stacks tag 05UD}}
\group{flat}
...
\begin{lemma}[Compare H F]
\label{flat-lemma-compare-H-F}
\source{stacks:05UE}
\href{https://stacks.math.columbia.edu/tag/05UE}{\texttt{Stacks tag 05UE}}
\group{flat}
...
\begin{lemma}[Flat dimension n representable]
\label{flat-lemma-flat-dimension-n-representable}
\source{stacks:05UF}
\href{https://stacks.math.columbia.edu/tag/05UF}{\texttt{Stacks tag 05UF}}
\group{flat}
...
\begin{proof}
\uses{flat-definition-complete-devissage, flat-definition-one-step-devissage, flat-lemma-induction-step-fp, flat-lemma-compare-H-F, flat-lemma-free-at-generic-points-representable}
...
Lemma \ref{flat-lemma-compare-H-F}
and
Lemma \ref{flat-lemma-free-at-generic-points-representable}.
\end{proof}

\begin{theorem}[Flat dimension n representable]
\label{flat-theorem-flat-dimension-n-representable}
\source{stacks:05UG}
\href{https://stacks.math.columbia.edu/tag/05UG}{\texttt{Stacks tag 05UG}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-flat-dimension-n, flat-lemma-quasi-finite-base-change, flat-lemma-existence-complete, flat-lemma-localize-flat-dimension-n, flat-lemma-flat-dimension-n-representable}
...
Thus by
Lemma \ref{flat-lemma-existence-complete}
...
Lemma \ref{flat-lemma-localize-flat-dimension-n}
...
Lemma \ref{flat-lemma-flat-dimension-n-representable}.
\end{proof}

We make explicit what the theorem means in terms of universal
flattenings in the following lemma.

\begin{lemma}[When universal flattening]
\label{flat-lemma-when-universal-flattening}
\source{stacks:05UH}
\href{https://stacks.math.columbia.edu/tag/05UH}{\texttt{Stacks tag 05UH}}
\group{flat}
...
\begin{proof}
\uses{flat-theorem-flat-dimension-n-representable, flat-lemma-proper-pure}

These statements follow immediately from
Theorem \ref{flat-theorem-flat-dimension-n-representable}
...
\begin{definition}[Situation: Existence]
\label{flat-situation-existence}
\source{stacks:0CTC}
\href{https://stacks.math.columbia.edu/tag/0CTC}{\texttt{Stacks tag 0CTC}}
\group{flat}
...
\begin{lemma}[Compute what it should be]
\label{flat-lemma-compute-what-it-should-be}
\source{stacks:0CTD}
\href{https://stacks.math.columbia.edu/tag/0CTD}{\texttt{Stacks tag 0CTD}}
\group{flat}

\uses{flat-situation-existence}
In Situation \ref{flat-situation-existence} consider
$$
...
\begin{lemma}[Compute against perfect]
\label{flat-lemma-compute-against-perfect}
\source{stacks:0CTE}
\href{https://stacks.math.columbia.edu/tag/0CTE}{\texttt{Stacks tag 0CTE}}
\group{flat}

\uses{flat-situation-existence, flat-lemma-compute-what-it-should-be}
In Situation \ref{flat-situation-existence} let $K$ be as in
Lemma \ref{flat-lemma-compute-what-it-should-be}. For any perfect
...
\begin{lemma}[Relative pseudo coherence]
\label{flat-lemma-relative-pseudo-coherence}
\source{stacks:0CTF}
\href{https://stacks.math.columbia.edu/tag/0CTF}{\texttt{Stacks tag 0CTF}}
\group{flat}

\uses{flat-situation-existence, flat-lemma-compute-what-it-should-be}
In Situation \ref{flat-situation-existence} let $K$ be as in
Lemma \ref{flat-lemma-compute-what-it-should-be}. Then $K$
is pseudo-coherent relative to $A$.
\end{lemma}

\begin{proof}
\uses{flat-lemma-compute-against-perfect}

Combinging Lemma \ref{flat-lemma-compute-against-perfect} and
...
\begin{lemma}[Compute over affine]
\label{flat-lemma-compute-over-affine}
\source{stacks:0CTG}
\href{https://stacks.math.columbia.edu/tag/0CTG}{\texttt{Stacks tag 0CTG}}
\group{flat}

\uses{flat-situation-existence, flat-lemma-compute-what-it-should-be}
In Situation \ref{flat-situation-existence} let $K$ be as in
Lemma \ref{flat-lemma-compute-what-it-should-be}. For any quasi-compact
...
\end{align*}
Using Lemma \ref{flat-lemma-compute-against-perfect}
and the fact that $- \otimes_A^\mathbf{L} A_n$
commutes with homotopy colimits we obtain the result.
\end{proof}

\begin{lemma}[Finitely presented]
\label{flat-lemma-finitely-presented}
\source{stacks:0CTH}
\href{https://stacks.math.columbia.edu/tag/0CTH}{\texttt{Stacks tag 0CTH}}
\group{flat}

\uses{flat-situation-existence, flat-lemma-compute-what-it-should-be}
In Situation \ref{flat-situation-existence} let $K$ be as in
Lemma \ref{flat-lemma-compute-what-it-should-be}.
...
\begin{proof}
\uses{flat-lemma-relative-pseudo-coherence, flat-lemma-compute-over-affine}
...
By Lemma \ref{flat-lemma-relative-pseudo-coherence}
...
By Lemma \ref{flat-lemma-compute-over-affine}
$$
...
\begin{lemma}[Proper support]
\label{flat-lemma-proper-support}
\source{stacks:0CTI}
\href{https://stacks.math.columbia.edu/tag/0CTI}{\texttt{Stacks tag 0CTI}}
\group{flat}

\uses{flat-situation-existence, flat-lemma-compute-what-it-should-be, flat-lemma-finitely-presented}
In Situation \ref{flat-situation-existence} let $K$ be as in
Lemma \ref{flat-lemma-compute-what-it-should-be}. Let $W \subset X$
be as in Lemma \ref{flat-lemma-finitely-presented}.
Set $\mathcal{F} = H^0(K)|_W$. Then, after possibly shrinking the open $W$,
the support of $\mathcal{F}$ is proper over $A$.
\end{lemma}

\begin{proof}
\uses{flat-lemma-finitely-presented}
...
By part (3) of Lemma \ref{flat-lemma-finitely-presented}
...
\begin{lemma}[Monomorphism isomorphism]
\label{flat-lemma-monomorphism-isomorphism}
\source{stacks:0CTJ}
\href{https://stacks.math.columbia.edu/tag/0CTJ}{\texttt{Stacks tag 0CTJ}}
\group{flat}
...
\source{stacks:0CTK}
\href{https://stacks.math.columbia.edu/tag/0CTK}{\texttt{Stacks tag 0CTK}}
\group{flat}

\uses{flat-situation-existence}
In Situation \ref{flat-situation-existence}
...
By Lemma \ref{flat-lemma-proper-pure} we see that $\mathcal{F}$
is universally pure relative to $\Spec(A)$.
By Theorem \ref{flat-theorem-flat-dimension-n-representable}
(for explanation, see Lemma \ref{flat-lemma-when-universal-flattening})
...
By Lemma \ref{flat-lemma-monomorphism-isomorphism}
...
Section \ref{flat-section-existence} for quasi-coherent modules.
...
\begin{definition}[Situation: Existence derived]
\label{flat-situation-existence-derived}
\source{stacks:0DIB}
\href{https://stacks.math.columbia.edu/tag/0DIB}{\texttt{Stacks tag 0DIB}}
\group{flat}
...
\begin{lemma}[Compute what it should be derived]
\label{flat-lemma-compute-what-it-should-be-derived}
\source{stacks:0DIC}
\href{https://stacks.math.columbia.edu/tag/0DIC}{\texttt{Stacks tag 0DIC}}
\group{flat}

\uses{flat-situation-existence-derived}
In Situation \ref{flat-situation-existence-derived} consider
$$
...
\begin{lemma}[Compute against perfect derived]
\label{flat-lemma-compute-against-perfect-derived}
\source{stacks:0DID}
\href{https://stacks.math.columbia.edu/tag/0DID}{\texttt{Stacks tag 0DID}}
\group{flat}

\uses{flat-situation-existence-derived, flat-lemma-compute-what-it-should-be-derived}
In Situation \ref{flat-situation-existence-derived} let $K$ be as in
Lemma \ref{flat-lemma-compute-what-it-should-be-derived}. For any perfect
...
\begin{lemma}[Relative pseudo coherence derived]
\label{flat-lemma-relative-pseudo-coherence-derived}
\source{stacks:0DIE}
\href{https://stacks.math.columbia.edu/tag/0DIE}{\texttt{Stacks tag 0DIE}}
\group{flat}

\uses{flat-situation-existence-derived, flat-lemma-compute-what-it-should-be-derived}
In Situation \ref{flat-situation-existence-derived} let $K$ be as in
Lemma \ref{flat-lemma-compute-what-it-should-be-derived}. Then $K$
is pseudo-coherent on $X$.
\end{lemma}

\begin{proof}
\uses{flat-lemma-compute-against-perfect-derived}

Combinging Lemma \ref{flat-lemma-compute-against-perfect-derived} and
Derived Categories of Schemes, Lemma
...
\begin{lemma}[Compute over affine derived]
\label{flat-lemma-compute-over-affine-derived}
\source{stacks:0DIF}
\href{https://stacks.math.columbia.edu/tag/0DIF}{\texttt{Stacks tag 0DIF}}
\group{flat}

\uses{flat-situation-existence-derived, flat-lemma-compute-what-it-should-be-derived}
In Situation \ref{flat-situation-existence-derived} let $K$ be as in
Lemma \ref{flat-lemma-compute-what-it-should-be-derived}. For any quasi-compact
open $U \subset X$ we have
$$
R\Gamma(U, K) \otimes_A^\mathbf{L} A_n =
R\Gamma(U_n, K_n)
...
\end{align*}
Using Lemma \ref{flat-lemma-compute-against-perfect-derived}
and the fact that $- \otimes_A^\mathbf{L} A_n$
commutes with homotopy colimits we obtain the result.
\end{proof}
...
\source{stacks:0DIG}
\href{https://stacks.math.columbia.edu/tag/0DIG}{\texttt{Stacks tag 0DIG}}
\group{flat}

\uses{flat-situation-existence-derived}
In Situation \ref{flat-situation-existence-derived}
...
\begin{proof}
\uses{flat-lemma-compute-what-it-should-be-derived, flat-lemma-compute-against-perfect-derived, flat-lemma-relative-pseudo-coherence-derived, flat-lemma-compute-over-affine-derived}

Apply Lemmas \ref{flat-lemma-compute-what-it-should-be-derived},
...
\begin{remark}[Correct generality]
\label{flat-remark-correct-generality}
\source{stacks:0DIH}
\href{https://stacks.math.columbia.edu/tag/0DIH}{\texttt{Stacks tag 0DIH}}
\group{flat}
...
\begin{remark}[Successive blowups]
\label{flat-remark-successive-blowups}
\source{stacks:080Y}
\href{https://stacks.math.columbia.edu/tag/080Y}{\texttt{Stacks tag 080Y}}
\group{flat}
...
\begin{lemma}[Helper blowup affine space]
\label{flat-lemma-helper-blowup-affine-space}
\source{stacks:0810}
\href{https://stacks.math.columbia.edu/tag/0810}{\texttt{Stacks tag 0810}}
\group{flat}
...
By Lemma \ref{flat-lemma-fibres-irreducible-flat-projective-nonnoetherian}
...
\begin{lemma}[Flatten module pre]
\label{flat-lemma-flatten-module-pre}
\source{stacks:0811}
\href{https://stacks.math.columbia.edu/tag/0811}{\texttt{Stacks tag 0811}}
\group{flat}
...
\begin{proof}
\uses{flat-remark-successive-blowups, flat-lemma-helper-blowup-affine-space}
...
of Remark \ref{flat-remark-successive-blowups} apply to the problem posed by
the lemma.
...
\medskip\noindent
By Remark \ref{flat-remark-successive-blowups} we see that we may assume that
we have an effective Cartier divisor $D \subset S$ whose support is
$S \setminus U$. Another application of Remark \ref{flat-remark-successive-blowups}
combined with
...
Lemma \ref{flat-lemma-helper-blowup-affine-space}.
\end{proof}

\begin{lemma}[Trick fitting ideal]
\label{flat-lemma-trick-fitting-ideal}
\source{stacks:0812}
\href{https://stacks.math.columbia.edu/tag/0812}{\texttt{Stacks tag 0812}}
\group{flat}
...
\begin{lemma}[Push ideal]
\label{flat-lemma-push-ideal}
\source{stacks:0813}
\href{https://stacks.math.columbia.edu/tag/0813}{\texttt{Stacks tag 0813}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-trick-fitting-ideal}
...
As in Lemma \ref{flat-lemma-trick-fitting-ideal} we take
...
\begin{lemma}[Flatten module etale localize]
\label{flat-lemma-flatten-module-etale-localize}
\source{stacks:0814}
\href{https://stacks.math.columbia.edu/tag/0814}{\texttt{Stacks tag 0814}}
\group{flat}
...
$$
\begin{array}{ccc} & X_i \underset{j_i}{\longrightarrow}\downarrow & X \downarrow \\ S_i^* \longrightarrow & S_i \overset{e_i}{\longrightarrow} & S\end{array}
$$
where
\begin{enumerate}
...
\begin{proof}
\uses{flat-remark-successive-blowups, flat-lemma-push-ideal, flat-lemma-etale-flat-up-down}
...
$$
\begin{array}{cc}S_i^{\prime *} \longrightarrow\searrow\downarrow & S'_i \downarrow \\ S_i^* \longrightarrow & S_i\end{array}
$$
...
Remark \ref{flat-remark-successive-blowups} apply to the
...
$D \subset S$. Another application of Remark \ref{flat-remark-successive-blowups}
combined with
Divisors, Lemma \ref{divisors-lemma-characterize-effective-Cartier-divisor}
...
\medskip\noindent
Pick an $i$ and $s \in S_i$. Lemma \ref{flat-lemma-push-ideal}
...
\begin{theorem}[Flatten module]
\label{flat-theorem-flatten-module}
\source{stacks:0815}
\href{https://stacks.math.columbia.edu/tag/0815}{\texttt{Stacks tag 0815}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-flatten-module-etale-localize, flat-lemma-elementary-devissage, flat-lemma-flatten-module-pre, flat-lemma-induction-step, flat-lemma-flat-finite-type-finitely-presented-over-dense-open, flat-remark-successive-blowups}
...
and the target, see
Lemma \ref{flat-lemma-flatten-module-etale-localize} for a precise statement.
...
Apply Lemma \ref{flat-lemma-elementary-devissage} to get
...
\medskip\noindent
Next, we apply a blowup as in Lemma \ref{flat-lemma-flatten-module-pre}.
...
Lemma \ref{flat-lemma-induction-step}. Hence $\alpha$ is universally injective,
...
\to \mathcal{H}' \to 0
$$
Hence Lemma \ref{flat-lemma-induction-step} also shows that $\mathcal{F}'$
...
third paragraph of Remark \ref{flat-remark-successive-blowups}).
...
\begin{lemma}[Flat after blowing up]
\label{flat-lemma-flat-after-blowing-up}
\source{stacks:081R}
\href{https://stacks.math.columbia.edu/tag/081R}{\texttt{Stacks tag 081R}}
\group{flat}
...
\begin{proof}
\uses{flat-remark-successive-blowups, flat-theorem-flatten-module}
...
see also Remark \ref{flat-remark-successive-blowups}).
...
Theorem \ref{flat-theorem-flatten-module}
...
\begin{lemma}[Finite after blowing up]
\label{flat-lemma-finite-after-blowing-up}
\source{stacks:0B49}
\href{https://stacks.math.columbia.edu/tag/0B49}{\texttt{Stacks tag 0B49}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-flat-after-blowing-up, flat-lemma-proper-flat-finite-over-dense-open}

By Lemma \ref{flat-lemma-flat-after-blowing-up} we may assume that
...
finite by Lemma \ref{flat-lemma-proper-flat-finite-over-dense-open}.
Hence $f$ is finite locally free by
Morphisms, Lemma \ref{morphisms-lemma-finite-flat}.
\end{proof}

\begin{lemma}[Zariski after blowup]
\label{flat-lemma-zariski-after-blowup}
\source{stacks:081S}
\href{https://stacks.math.columbia.edu/tag/081S}{\texttt{Stacks tag 081S}}
\group{flat}
...
\begin{proof}
\uses{flat-remark-successive-blowups, flat-lemma-flat-after-blowing-up, flat-lemma-zariski}

The discussion in Remark \ref{flat-remark-successive-blowups} applies.
...
Lemma \ref{flat-lemma-flat-after-blowing-up}.
In this case the result follows from Lemma \ref{flat-lemma-zariski}.
\end{proof}

The following lemma says that a proper modification can be dominated
by a blowup.

\begin{lemma}[Dominate modification by blowup]
\label{flat-lemma-dominate-modification-by-blowup}
\source{stacks:081T}
\href{https://stacks.math.columbia.edu/tag/081T}{\texttt{Stacks tag 081T}}
\group{flat}
...
\begin{proof}
\uses{flat-remark-successive-blowups, flat-lemma-zariski-after-blowup}
...
Lemma \ref{flat-lemma-zariski-after-blowup}.
Since $X' \to S'$ is proper, and
$U \subset S'$ is dense, we see that $X' = S'$. Some details omitted.
\end{proof}

\begin{lemma}[Get section after blowup]
\label{flat-lemma-get-section-after-blowup}
\source{stacks:0CP1}
\href{https://stacks.math.columbia.edu/tag/0CP1}{\texttt{Stacks tag 0CP1}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-dominate-modification-by-blowup}
...
By Lemma \ref{flat-lemma-dominate-modification-by-blowup}
...
in the next section, see Theorem \ref{flat-theorem-nagata}.
...
\begin{lemma}[Compactifications cofiltered]
\label{flat-lemma-compactifications-cofiltered}
\source{stacks:0ATU}
\href{https://stacks.math.columbia.edu/tag/0ATU}{\texttt{Stacks tag 0ATU}}
\group{flat}
...
$$
\begin{array}{ccc}(X, \overline{X}_1) & (X, \overline{X}) \longleftarrow\longrightarrow & (X, \overline{X}_2)\end{array}
$$
...
\begin{lemma}[Compactifyable]
\label{flat-lemma-compactifyable}
\source{stacks:0A9Z}
\href{https://stacks.math.columbia.edu/tag/0A9Z}{\texttt{Stacks tag 0A9Z}}
\group{flat}
...
$$
\begin{array}{cc}X \downarrow\underset{f}{\longrightarrow} & Y \downarrow \\ \overline{X} \overset{\overline{f}}{\longrightarrow} & \overline{Y}\end{array}
$$
of morphisms of schemes over $S$.

\begin{lemma}[Right multiplicative system]
\label{flat-lemma-right-multiplicative-system}
\source{stacks:0ATV}
\href{https://stacks.math.columbia.edu/tag/0ATV}{\texttt{Stacks tag 0ATV}}
\group{flat}
...
$$
\begin{array}{cc} & (X', \overline{X}') \underset{(u, \overline{u})}{\downarrow} \\ (Y, \overline{Y}) \overset{(f, \overline{f})}{\longrightarrow} & (X, \overline{X})\end{array}
$$
...
The diagram
$$
\begin{array}{cc}(Y', \overline{Y}') \underset{(g, \overline{g})}{\longrightarrow}\underset{(v, \overline{v})}{\downarrow} & (X', \overline{X}') \underset{(u, \overline{u})}{\downarrow} \\ (Y, \overline{Y}) \overset{(f, \overline{f})}{\longrightarrow} & (X, \overline{X})\end{array}
$$
...
\begin{lemma}[Invert right multiplicative system]
\label{flat-lemma-invert-right-multiplicative-system}
\source{stacks:0ATW}
\href{https://stacks.math.columbia.edu/tag/0ATW}{\texttt{Stacks tag 0ATW}}
\group{flat}

\uses{flat-lemma-right-multiplicative-system}
Let $S$ be a quasi-compact and quasi-separated scheme.
...
at the right
multiplicative system of Lemma \ref{flat-lemma-right-multiplicative-system}
to the category of compactifyable schemes over $S$.
\end{lemma}

\begin{proof}
\uses{flat-lemma-compactifyable}
...
$\overline{Y}$ (possible by Lemma \ref{flat-lemma-compactifyable}
...
\begin{lemma}[Check separated]
\label{flat-lemma-check-separated}
\source{stacks:0F3U}
\href{https://stacks.math.columbia.edu/tag/0F3U}{\texttt{Stacks tag 0F3U}}
\group{flat}
...
\begin{lemma}[Separate disjoint locally closed by blowing up]
\label{flat-lemma-separate-disjoint-locally-closed-by-blowing-up}
\source{stacks:0F3V}
\href{https://stacks.math.columbia.edu/tag/0F3V}{\texttt{Stacks tag 0F3V}}
\group{flat}
...
\begin{lemma}[Blowup iso along]
\label{flat-lemma-blowup-iso-along}
\source{stacks:0F3W}
\href{https://stacks.math.columbia.edu/tag/0F3W}{\texttt{Stacks tag 0F3W}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-separate-disjoint-locally-closed-by-blowing-up, flat-lemma-zariski-after-blowup}
...
By Lemma \ref{flat-lemma-separate-disjoint-locally-closed-by-blowing-up}
...
\begin{lemma}[Find common blowups]
\label{flat-lemma-find-common-blowups}
\source{stacks:0F3X}
\href{https://stacks.math.columbia.edu/tag/0F3X}{\texttt{Stacks tag 0F3X}}
\group{flat}
...
$$
\begin{array}{ccc}X_1' \downarrow\longrightarrow & X & X_2' \longleftarrow\downarrow \\ X_1 & U \longleftarrow\nwarrow\uparrow\nearrow\longrightarrow & X_2\end{array}
$$
...
\begin{proof}
\uses{flat-lemma-zariski-after-blowup, flat-lemma-check-separated}
...
$$
\begin{array}{cc}X_{12}' \downarrow\longrightarrow & X_{12}^2 \downarrow \\ X_{12}^1 \longrightarrow & X_{12}\end{array}
$$
...
$$
\begin{array}{cc}X_{12}' \downarrow\longrightarrow & X_i' \downarrow \\ X_{12}^i \longrightarrow & X_i^i\end{array}
$$
...
and separated (Lemma \ref{flat-lemma-check-separated}).
As compositions of $U$-admissible blowups are $U$-admissible blowups
(Divisors, Lemma \ref{divisors-lemma-composition-admissible-blowups})
the lemma is proved.
\end{proof}

\begin{lemma}[Replaced by strict transform]
\label{flat-lemma-replaced-by-strict-transform}
\source{stacks:0F3Y}
\href{https://stacks.math.columbia.edu/tag/0F3Y}{\texttt{Stacks tag 0F3Y}}
\group{flat}
...
\begin{lemma}[Compactification dominates]
\label{flat-lemma-compactification-dominates}
\source{stacks:0F3Z}
\href{https://stacks.math.columbia.edu/tag/0F3Z}{\texttt{Stacks tag 0F3Z}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-replaced-by-strict-transform, flat-lemma-zariski-after-blowup}
...
Lemma \ref{flat-lemma-replaced-by-strict-transform}. Hence by
Lemma \ref{flat-lemma-zariski-after-blowup} we may assume $Z \to Y$
...
\begin{lemma}[Two compactifications]
\label{flat-lemma-two-compactifications}
\source{stacks:0F40}
\href{https://stacks.math.columbia.edu/tag/0F40}{\texttt{Stacks tag 0F40}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-compactification-dominates, flat-lemma-separate-disjoint-locally-closed-by-blowing-up, flat-lemma-replaced-by-strict-transform, flat-lemma-blowup-iso-along, flat-lemma-check-separated, flat-lemma-find-common-blowups}
...
Lemma \ref{flat-lemma-compactification-dominates}. Picture
$$
\begin{array}{ccc}U_i \longrightarrow\downarrow & V_i \longrightarrow\overset{\psi_i}{\swarrow} & X_i \\ U &  & \end{array}
$$
If $\{i, j\} = \{1, 2\}$ denote
...
Lemma \ref{flat-lemma-separate-disjoint-locally-closed-by-blowing-up}.
...
the strict transform with respect to this blowing up, see
Lemma \ref{flat-lemma-replaced-by-strict-transform}.
...
By Lemma \ref{flat-lemma-blowup-iso-along}
...
\quad i = 1, 2
$$
obtained by glueing. Let us apply Lemma \ref{flat-lemma-check-separated}
...
Consider a diagram
$$
\begin{array}{ccc}W_1' \downarrow\longrightarrow & W & W_2' \longleftarrow\downarrow \\ W_1 & U \longleftarrow\nwarrow\uparrow\nearrow\longrightarrow & W_2\end{array}
$$
as in Lemma \ref{flat-lemma-find-common-blowups}. By the previous paragraph
for every solid diagram
$$
\begin{array}{cc}\Spec(K) \underset{\gamma}{\longrightarrow}\downarrow & W \downarrow \\ \Spec(A) \nearrow\longrightarrow & S\end{array}
$$
...
\source{stacks:0F41}
\href{https://stacks.math.columbia.edu/tag/0F41}{\texttt{Stacks tag 0F41}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-two-compactifications}
...
Applying Lemma \ref{flat-lemma-two-compactifications}
...
of finite presentation, see Lemma \ref{flat-lemma-characterize-sheaf-h}.
...
Lemma \ref{flat-lemma-Noetherian-h-covering}.
...
\begin{lemma}[Equivalence h v locally finite presentation]
\label{flat-lemma-equivalence-h-v-locally-finite-presentation}
\source{stacks:0ETR}
\href{https://stacks.math.columbia.edu/tag/0ETR}{\texttt{Stacks tag 0ETR}}
\group{flat}
...
\begin{proof}
\uses{flat-theorem-flatten-module, flat-remark-successive-blowups}
...
By Theorem \ref{flat-theorem-flatten-module}
...
(see Remark \ref{flat-remark-successive-blowups}).
...
$$
\begin{array}{ccc}\Spec(W) \downarrow\longrightarrow &  & X_i \downarrow \\ \Spec(V) \longrightarrow & X' \longrightarrow & X\end{array}
$$
...
\begin{definition}[H covering]
\label{flat-definition-h-covering}
\source{stacks:0ETS}
\href{https://stacks.math.columbia.edu/tag/0ETS}{\texttt{Stacks tag 0ETS}}
\group{flat}

\uses{flat-lemma-equivalence-h-v-locally-finite-presentation}
...
Lemma \ref{flat-lemma-equivalence-h-v-locally-finite-presentation} is satisfied.
\end{definition}

For Noetherian schemes this is the same thing as a ph covering
(we record this in Lemma \ref{flat-lemma-Noetherian-h-ph} below) and
we recover Voevodsky's notion.

\begin{lemma}[Noetherian h covering]
\label{flat-lemma-Noetherian-h-covering}
\source{stacks:0ETT}
\href{https://stacks.math.columbia.edu/tag/0ETT}{\texttt{Stacks tag 0ETT}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-equivalence-h-v-locally-finite-presentation, flat-theorem-flatten-module, flat-remark-successive-blowups}
...
Lemma \ref{flat-lemma-equivalence-h-v-locally-finite-presentation}.
...
\begin{lemma}[Noetherian h ph]
\label{flat-lemma-Noetherian-h-ph}
\source{stacks:0H45}
\href{https://stacks.math.columbia.edu/tag/0H45}{\texttt{Stacks tag 0H45}}
\group{flat}
...
\begin{proof}
\uses{flat-definition-h-covering}

By Definition \ref{flat-definition-h-covering} a h covering is a ph covering.
...
\begin{lemma}[Approximate h cover]
\label{flat-lemma-approximate-h-cover}
\source{stacks:0ETU}
\href{https://stacks.math.columbia.edu/tag/0ETU}{\texttt{Stacks tag 0ETU}}
\group{flat}
...
See Definition \ref{flat-definition-h-covering} and
...
\begin{lemma}[Zariski h]
\label{flat-lemma-zariski-h}
\source{stacks:0ETV}
\href{https://stacks.math.columbia.edu/tag/0ETV}{\texttt{Stacks tag 0ETV}}
\group{flat}
...
\begin{lemma}[Surjective proper finite presentation h]
\label{flat-lemma-surjective-proper-finite-presentation-h}
\source{stacks:0ETW}
\href{https://stacks.math.columbia.edu/tag/0ETW}{\texttt{Stacks tag 0ETW}}
\group{flat}
...
\begin{lemma}[Refine by h]
\label{flat-lemma-refine-by-h}
\source{stacks:0ETX}
\href{https://stacks.math.columbia.edu/tag/0ETX}{\texttt{Stacks tag 0ETX}}
\group{flat}
...
\label{flat-lemma-h}
\source{stacks:0ETY}
\href{https://stacks.math.columbia.edu/tag/0ETY}{\texttt{Stacks tag 0ETY}}
\group{flat}
...
\begin{definition}[Big h site]
\label{flat-definition-big-h-site}
\source{stacks:0ETZ}
\href{https://stacks.math.columbia.edu/tag/0ETZ}{\texttt{Stacks tag 0ETZ}}
\group{flat}
...
\begin{definition}[Standard h]
\label{flat-definition-standard-h}
\source{stacks:0EUY}
\href{https://stacks.math.columbia.edu/tag/0EUY}{\texttt{Stacks tag 0EUY}}
\group{flat}
...
\begin{lemma}[H induced]
\label{flat-lemma-h-induced}
\source{stacks:0EU0}
\href{https://stacks.math.columbia.edu/tag/0EU0}{\texttt{Stacks tag 0EU0}}
\group{flat}

\uses{flat-definition-big-h-site}
Let $\Sch_h$ be a big h site as in
Definition \ref{flat-definition-big-h-site}.
Let $T \in \Ob(\Sch_h)$.
...
\begin{definition}[Big small h]
\label{flat-definition-big-small-h}
\source{stacks:0EU1}
\href{https://stacks.math.columbia.edu/tag/0EU1}{\texttt{Stacks tag 0EU1}}
\group{flat}
...
\begin{lemma}[Verify site h]
\label{flat-lemma-verify-site-h}
\source{stacks:0EU2}
\href{https://stacks.math.columbia.edu/tag/0EU2}{\texttt{Stacks tag 0EU2}}
\group{flat}
...
(Lemma \ref{flat-lemma-h}), $\bigcup_{i\in I} J_i$ is finite and
each $T_{ij}$ is affine. Thus $\{T_{ij} \to T\}_{i \in I, j\in J_i}$
is a standard h covering.
\end{proof}

\begin{lemma}[Fibre products h]
\label{flat-lemma-fibre-products-h}
\source{stacks:0EU3}
\href{https://stacks.math.columbia.edu/tag/0EU3}{\texttt{Stacks tag 0EU3}}
\group{flat}
...
\begin{lemma}[Affine big site h]
\label{flat-lemma-affine-big-site-h}
\source{stacks:0EU4}
\href{https://stacks.math.columbia.edu/tag/0EU4}{\texttt{Stacks tag 0EU4}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-approximate-h-cover}
...
for example by Lemma \ref{flat-lemma-approximate-h-cover}. Hence (1) holds.
...
\begin{lemma}[Characterize sheaf h]
\label{flat-lemma-characterize-sheaf-h}
\source{stacks:0EU5}
\href{https://stacks.math.columbia.edu/tag/0EU5}{\texttt{Stacks tag 0EU5}}
\group{flat}
...
See Lemma \ref{flat-lemma-approximate-h-cover}.
...
\begin{lemma}[Morphism big h]
\label{flat-lemma-morphism-big-h}
\source{stacks:0EU6}
\href{https://stacks.math.columbia.edu/tag/0EU6}{\texttt{Stacks tag 0EU6}}
\group{flat}
...
\begin{lemma}[Composition h]
\label{flat-lemma-composition-h}
\source{stacks:0EU7}
\href{https://stacks.math.columbia.edu/tag/0EU7}{\texttt{Stacks tag 0EU7}}
\group{flat}
...
\begin{example}[Structure sheaf not h sheaf]
\label{flat-example-structure-sheaf-not-h-sheaf}
\source{stacks:0EV0}
\href{https://stacks.math.columbia.edu/tag/0EV0}{\texttt{Stacks tag 0EV0}}
\group{flat}

\uses{flat-lemma-surjective-proper-finite-presentation-h}
...
for example by Lemma \ref{flat-lemma-surjective-proper-finite-presentation-h}.
...
\begin{example}[Representable sheaf not h sheaf]
\label{flat-example-representable-sheaf-not-h-sheaf}
\source{stacks:0EV1}
\href{https://stacks.math.columbia.edu/tag/0EV1}{\texttt{Stacks tag 0EV1}}
\group{flat}

\uses{flat-example-structure-sheaf-not-h-sheaf}
...
Example \ref{flat-example-structure-sheaf-not-h-sheaf}
that $\mathcal{O}$ is not a sheaf.
\end{example}

\begin{lemma}[Limit h topology]
\label{flat-lemma-limit-h-topology}
\source{stacks:0EV2}
\href{https://stacks.math.columbia.edu/tag/0EV2}{\texttt{Stacks tag 0EV2}}
\group{flat}

\uses{flat-definition-standard-h}
...
To see this we use Lemma \ref{flat-lemma-approximate-h-cover} to
...
\begin{lemma}[Extend sheaf h]
\label{flat-lemma-extend-sheaf-h}
\source{stacks:0EV3}
\href{https://stacks.math.columbia.edu/tag/0EV3}{\texttt{Stacks tag 0EV3}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-limit-h-topology, flat-lemma-h-induced}
...
Lemmas \ref{flat-lemma-limit-h-topology} and \ref{flat-lemma-h-induced}.
Details omitted.
\end{proof}
...
\begin{lemma}[Blow up square ph]
\label{flat-lemma-blow-up-square-ph}
\source{stacks:0EW1}
\href{https://stacks.math.columbia.edu/tag/0EW1}{\texttt{Stacks tag 0EW1}}
\group{flat}
...
$$
\begin{array}{cc}\mathcal{F}(E) & \mathcal{F}(X') \longleftarrow \\ \mathcal{F}(Z) \uparrow & \mathcal{F}(X) \uparrow\longleftarrow\end{array}
$$
...
\begin{lemma}[Thickening ph]
\label{flat-lemma-thickening-ph}
\source{stacks:0EW2}
\href{https://stacks.math.columbia.edu/tag/0EW2}{\texttt{Stacks tag 0EW2}}
\group{flat}
...
Examples \ref{flat-example-one-generator} and
...
\begin{lemma}[Base change almost blow up]
\label{flat-lemma-base-change-almost-blow-up}
\source{stacks:0EV7}
\href{https://stacks.math.columbia.edu/tag/0EV7}{\texttt{Stacks tag 0EV7}}
\group{flat}

Consider an almost blow up square (\ref{equation-almost-blow-up-square}).
Let $Y \to X$ be any morphism. Then the base change
$$
\begin{array}{cc}Y \times_X E \downarrow\longrightarrow & Y \times_X X' \downarrow \\ Y \times_X Z \longrightarrow & Y\end{array}
$$
...
\begin{lemma}[Shrink almost blow up]
\label{flat-lemma-shrink-almost-blow-up}
\source{stacks:0EV8}
\href{https://stacks.math.columbia.edu/tag/0EV8}{\texttt{Stacks tag 0EV8}}
\group{flat}
...
\item the diagram
$$
\begin{array}{cc}E \cap W \downarrow\longrightarrow & W \downarrow \\ Z \longrightarrow & X\end{array}
$$
...
\begin{lemma}[Blow up limit almost blow up]
\label{flat-lemma-blow-up-limit-almost-blow-up}
\source{stacks:0EV9}
\href{https://stacks.math.columbia.edu/tag/0EV9}{\texttt{Stacks tag 0EV9}}
\group{flat}

\uses{flat-lemma-shrink-almost-blow-up}
Consider an almost blow up square (\ref{equation-almost-blow-up-square})
...
conditions of Lemma \ref{flat-lemma-shrink-almost-blow-up}.
\end{lemma}
...
\begin{lemma}[Almost blow up square]
\label{flat-lemma-almost-blow-up-square}
\source{stacks:0EVA}
\href{https://stacks.math.columbia.edu/tag/0EVA}{\texttt{Stacks tag 0EVA}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-base-change-almost-blow-up}
...
$$
\begin{array}{cc}E_i \longrightarrow\downarrow & X'_i \overset{b_i}{\downarrow} \\ Z_i \longrightarrow & X_i\end{array}
$$
...
By Lemma \ref{flat-lemma-base-change-almost-blow-up}
...
Lemma \ref{flat-lemma-shrink-almost-blow-up}.

\begin{lemma}[Almost blow up unique]
\label{flat-lemma-almost-blow-up-unique}
\source{stacks:0EVB}
\href{https://stacks.math.columbia.edu/tag/0EVB}{\texttt{Stacks tag 0EVB}}
\group{flat}
...
$$
\begin{array}{cc}E_k \longrightarrow\downarrow & X_k' \downarrow \\ Z \longrightarrow & X\end{array}
$$
for $k = 1, 2$, then there exists an almost blow up square
$$
\begin{array}{cc}E \longrightarrow\downarrow & X' \downarrow \\ Z \longrightarrow & X\end{array}
$$
...
\begin{lemma}[Flat after almost blowing up]
\label{flat-lemma-flat-after-almost-blowing-up}
\source{stacks:0EVC}
\href{https://stacks.math.columbia.edu/tag/0EVC}{\texttt{Stacks tag 0EVC}}
\group{flat}
...
$$
\begin{array}{cccc}E \downarrow\searrow &  &  & D \longleftarrow\downarrow\swarrow \\  & Y' \downarrow & X' \longleftarrow\downarrow &  \\  & Y & X \longleftarrow &  \\ Z \nearrow &  &  & T \longleftarrow\nwarrow\end{array}
$$
...
\begin{proof}
\uses{flat-lemma-flat-after-blowing-up, flat-lemma-base-change-almost-blow-up}

If $Y$ is a Noetherian scheme, then this lemma follows immediately
from Lemma \ref{flat-lemma-flat-after-blowing-up}
...
Lemma \ref{flat-lemma-base-change-almost-blow-up}.
\end{proof}

\begin{lemma}[Blow up square h]
\label{flat-lemma-blow-up-square-h}
\source{stacks:0EVD}
\href{https://stacks.math.columbia.edu/tag/0EVD}{\texttt{Stacks tag 0EVD}}
\group{flat}

\uses{flat-definition-big-small-h}
Let $\mathcal{F}$ be a sheaf on one of the sites $(\Sch/S)_h$
constructed in Definition \ref{flat-definition-big-small-h}.
...
covering (Lemma \ref{flat-lemma-surjective-proper-finite-presentation-h}).
We have
$$
(Z \amalg X') \times_X (Z \amalg X') =
Z \amalg E \amalg E \amalg X' \times_X X'
...
\begin{lemma}[Thickening h]
\label{flat-lemma-thickening-h}
\source{stacks:0EVE}
\href{https://stacks.math.columbia.edu/tag/0EVE}{\texttt{Stacks tag 0EVE}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-surjective-proper-finite-presentation-h, flat-lemma-blow-up-square-h}
...
(Lemma \ref{flat-lemma-surjective-proper-finite-presentation-h})
we conclude.
...
$$
\begin{array}{cc}\emptyset \longrightarrow\downarrow & \emptyset \downarrow \\ X \longrightarrow & X'\end{array}
$$
Since $\mathcal{F}$ is a sheaf we have that $\mathcal{F}(\emptyset)$
is a singleton.
Applying Lemma \ref{flat-lemma-blow-up-square-h} we get the conclusion.
\end{proof}

\begin{proposition}[Check h]
\label{flat-proposition-check-h}
\source{stacks:0EVF}
\href{https://stacks.math.columbia.edu/tag/0EVF}{\texttt{Stacks tag 0EVF}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-zariski-h, flat-lemma-blow-up-square-h, flat-lemma-characterize-sheaf-h, flat-lemma-thickening-h, flat-lemma-flat-after-almost-blowing-up, flat-lemma-shrink-almost-blow-up}

Assume $\mathcal{F}$ is a sheaf. Condition (1) holds because
a Zariski covering is a h covering, see
Lemma \ref{flat-lemma-zariski-h}.
Condition (2) holds because for $f$ as in (2) we have that
$\{X \to Y\}$ is an fppf covering (this is clear)
and hence an h covering, see Lemma \ref{flat-lemma-zariski-h}.
Condition (3) holds by Lemma \ref{flat-lemma-blow-up-square-h}.

\medskip\noindent
Conversely, assume $\mathcal{F}$ satisfies (1), (2), and (3).
We will prove $\mathcal{F}$ is a sheaf by applying
Lemma \ref{flat-lemma-characterize-sheaf-h}. Consider
...
(compare with the second proof of Lemma \ref{flat-lemma-thickening-h}).
Hence we see that condition (3) tells us that
$$
\begin{array}{cc}\mathcal{F}(\emptyset) & \mathcal{F}(\emptyset) \longleftarrow \\ \mathcal{F}(X) \uparrow & \mathcal{F}(Y) \uparrow\longleftarrow\end{array}
$$
...
\begin{array}{cccc}E \downarrow\searrow &  &  & D \longleftarrow\downarrow\swarrow \\  & Y' \downarrow & X' \longleftarrow\downarrow &  \\  & Y & X \longleftarrow &  \\ Z \nearrow &  &  & T \longleftarrow\nwarrow\end{array}
$$
as in Lemma \ref{flat-lemma-flat-after-almost-blowing-up}
...
in $W$. By Lemma \ref{flat-lemma-shrink-almost-blow-up}
...
$$
\vcenter{
\begin{array}{cc}\mathcal{F}(E) & \mathcal{F}(Y') \longleftarrow \\ \mathcal{F}(Z) \uparrow & \mathcal{F}(Y) \uparrow\longleftarrow\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}\mathcal{F}(D) & \mathcal{F}(X') \longleftarrow \\ \mathcal{F}(T) \uparrow & \mathcal{F}(X) \uparrow\longleftarrow\end{array}
}
$$
...
\begin{example}[One generator]
\label{flat-example-one-generator}
\source{stacks:0EVG}
\href{https://stacks.math.columbia.edu/tag/0EVG}{\texttt{Stacks tag 0EVG}}
\group{flat}
...
Then
$$
\begin{array}{cc}E = \Spec(A/fA + J) \longrightarrow\downarrow & \Spec(A/J) = X' \downarrow \\ Z = \Spec(A/fA) \longrightarrow & \Spec(A) = X\end{array}
$$
is an almost blowup square.
\end{example}

\begin{example}[Two generators]
\label{flat-example-two-generators}
\source{stacks:0EVH}
\href{https://stacks.math.columbia.edu/tag/0EVH}{\texttt{Stacks tag 0EVH}}
\group{flat}

Let $A$ be a ring. Let $f_1, f_2 \in A$ be elements.
$$
\begin{array}{cc}E = \text{Proj}(A/(f_1, f_2)[T_0, T_1]) \longrightarrow\downarrow & \text{Proj}(A[T_0, T_1]/(f_2 T_0 - f_1 T_1) = X' \downarrow \\ Z = \Spec(A/(f_1, f_2)) \longrightarrow & \Spec(A) = X\end{array}
$$
is an almost blowup square.
\end{example}
...
\source{stacks:0EVI}
\href{https://stacks.math.columbia.edu/tag/0EVI}{\texttt{Stacks tag 0EVI}}
\group{flat}

\uses{flat-definition-big-small-h, flat-example-one-generator, flat-example-two-generators}
Let $\mathcal{F}$ be a presheaf on one of the sites $(\Sch/S)_h$
constructed in Definition \ref{flat-definition-big-small-h}.
Then $\mathcal{F}$ is a sheaf if and only if the following
conditions are satisfied
...
Example \ref{flat-example-one-generator} in the category $(\Sch/S)_h$
into a cartesian diagram of sets, and
\item $\mathcal{F}$ turns an almost blow up square as in
Example \ref{flat-example-two-generators} in the category $(\Sch/S)_h$
into a cartesian diagram of sets.
\end{enumerate}
\end{lemma}

\begin{proof}
\uses{flat-proposition-check-h, flat-lemma-almost-blow-up-unique, flat-lemma-almost-blow-up-square, flat-example-two-generators, flat-lemma-base-change-almost-blow-up}

By Proposition \ref{flat-proposition-check-h} it suffices to show that given
...
$$
\vcenter{
\begin{array}{cc}\mathcal{F}(E \cap b^{-1}(U_i)) & \mathcal{F}(b^{-1}(U_i)) \longleftarrow \\ \mathcal{F}(Z \cap U_i) \uparrow & \mathcal{F}(U_i) \uparrow\longleftarrow\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}\mathcal{F}(E \cap b^{-1}(U_{ijk})) & \mathcal{F}(b^{-1}(U_{ijk})) \longleftarrow \\ \mathcal{F}(Z \cap U_{ijk}) \uparrow & \mathcal{F}(U_{ijk}) \uparrow\longleftarrow\end{array}
}
$$
...
Lemma \ref{flat-lemma-almost-blow-up-unique}. Then
$$
\begin{array}{cc}E \downarrow\longrightarrow & X' \downarrow \\ E_k \longrightarrow & X'_k\end{array}
$$
...
(Moreover, by Lemma \ref{flat-lemma-almost-blow-up-square}
...
in Example \ref{flat-example-two-generators}
...
and let
$$
\begin{array}{cc}E_1 \downarrow\longrightarrow & Y \downarrow \\ Z_1 \longrightarrow & X\end{array}
$$
be the almost blow up square constructed in
Example \ref{flat-example-two-generators}.
By Lemma \ref{flat-lemma-base-change-almost-blow-up} the base changes
$$
(I)
\vcenter{
\begin{array}{cc}Y \times_X E \longrightarrow\downarrow & Y \times_X X' \downarrow \\ Y \times_X Z \longrightarrow & Y\end{array}
}
\quad\text{and}\quad
(II)
\vcenter{
\begin{array}{cc}E \longrightarrow\downarrow & Z_1 \times_X X' \downarrow \\ Z \longrightarrow & Z_1\end{array}
}
$$
...
square
$$
\begin{array}{cc}E_1 \times_X E \longrightarrow\downarrow & E_1 \times_X X' \downarrow \\ E_1 \times_X Z \longrightarrow & E_1\end{array}
$$
...
\begin{lemma}[Refine check h stack]
\label{flat-lemma-refine-check-h-stack}
\source{stacks:0EX9}
\href{https://stacks.math.columbia.edu/tag/0EX9}{\texttt{Stacks tag 0EX9}}
\group{flat}

\uses{flat-example-one-generator, flat-example-two-generators}
...
Example \ref{flat-example-one-generator} or \ref{flat-example-two-generators}
...
\begin{proof}
\uses{flat-lemma-refine-check-h}

This lemma is a formal consequence of Lemma \ref{flat-lemma-refine-check-h}
and our definition of stacks in groupoids.
...
(1), (2), (3), and (4) of Lemma \ref{flat-lemma-refine-check-h}
...
To do this we may use the criterion of Lemma \ref{flat-lemma-refine-check-h}.
However, our assumptions (1), (2), (3) imply (by drawing some
commutative diagrams which we omit), that properties (1), (2), (3), and (4)
of Lemma \ref{flat-lemma-refine-check-h} hold for $F$.
...
\begin{lemma}[Funny blow up]
\label{flat-lemma-funny-blow-up}
\source{stacks:0EVJ}
\href{https://stacks.math.columbia.edu/tag/0EVJ}{\texttt{Stacks tag 0EVJ}}
\group{flat}

\uses{flat-example-two-generators}
...
\medskip\noindent
Next, we observe that any diagram as in Example \ref{flat-example-two-generators}
...
\source{stacks:0EVK}
\href{https://stacks.math.columbia.edu/tag/0EVK}{\texttt{Stacks tag 0EVK}}
\group{flat}

\uses{flat-definition-big-small-h}
Let $p$ be a prime number. Let $S$ be a scheme over $\mathbf{F}_p$.
Let $(\Sch/S)_h$ be a site as in Definition \ref{flat-definition-big-small-h}.
...
\begin{proof}
\uses{flat-lemma-refine-check-h, flat-example-one-generator, flat-example-two-generators, flat-lemma-funny-blow-up}
...
Lemma \ref{flat-lemma-refine-check-h}.
...
Example \ref{flat-example-one-generator}.
...
Example \ref{flat-example-two-generators}. By
Lemma \ref{flat-lemma-funny-blow-up} we see that
$$
\mathcal{F}(X) = \colim_F \Gamma(X, \mathcal{O}_X)
\longrightarrow
...
\begin{lemma}[H sheaf lim F]
\label{flat-lemma-h-sheaf-lim-F}
\source{stacks:0EVL}
\href{https://stacks.math.columbia.edu/tag/0EVL}{\texttt{Stacks tag 0EVL}}
\group{flat}
...
We check condition (4). Let $X, X', Z, E$ be as in
Example \ref{flat-example-two-generators}. By
Lemma \ref{flat-lemma-funny-blow-up} and the same argument as above
we see that
$$
\mathcal{F}(X) = \lim_F \Gamma(X, \mathcal{O}_X)
\longrightarrow
...
\begin{lemma}[Weak normalization ph sheaf]
\label{flat-lemma-weak-normalization-ph-sheaf}
\source{stacks:0EVT}
\href{https://stacks.math.columbia.edu/tag/0EVT}{\texttt{Stacks tag 0EVT}}
\group{flat}
...
\begin{lemma}[Weak normalization h sheaf]
\label{flat-lemma-weak-normalization-h-sheaf}
\source{stacks:0EVU}
\href{https://stacks.math.columbia.edu/tag/0EVU}{\texttt{Stacks tag 0EVU}}
\group{flat}

\uses{flat-definition-big-small-h}
Let $S$ be a scheme. Choose a site $(\Sch/S)_h$
as in Definition \ref{flat-definition-big-small-h}.
The rule
$$
X \longmapsto \Gamma(X^{awn}, \mathcal{O}_{X^{awn}})
$$
...
\begin{proof}
\uses{flat-lemma-weak-normalization-ph-sheaf}

In Lemma \ref{flat-lemma-weak-normalization-ph-sheaf}
...
\begin{lemma}[Perfect weankly normal]
\label{flat-lemma-perfect-weankly-normal}
\source{stacks:0EVV}
\href{https://stacks.math.columbia.edu/tag/0EVV}{\texttt{Stacks tag 0EVV}}
\group{flat}
...
\source{stacks:0EVW}
\href{https://stacks.math.columbia.edu/tag/0EVW}{\texttt{Stacks tag 0EVW}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-perfect-weankly-normal, flat-lemma-h-sheaf-colim-F, flat-lemma-weak-normalization-h-sheaf}
...
Lemma \ref{flat-lemma-perfect-weankly-normal} applies.

\medskip\noindent
Proof of (2). This follows from (1) and
Lemmas \ref{flat-lemma-h-sheaf-colim-F} and
...
\begin{lemma}[Colim F Vect]
\label{flat-lemma-colim-F-Vect}
\source{stacks:0EXB}
\href{https://stacks.math.columbia.edu/tag/0EXB}{\texttt{Stacks tag 0EXB}}
\group{flat}
...
\begin{lemma}[Vector bundle I]
\label{flat-lemma-vector-bundle-I}
\source{stacks:0EXC}
\href{https://stacks.math.columbia.edu/tag/0EXC}{\texttt{Stacks tag 0EXC}}
\group{flat}

\uses{flat-example-one-generator}
Let $p$ be a prime number. Consider an almost blowup square $X, X', Z, E$
in characteristic $p$ as in Example \ref{flat-example-one-generator}.
Then the functor
$$
...
\begin{proof}
\uses{flat-example-one-generator, flat-lemma-h-sheaf-colim-F}

Let $A, f, J$ be as in Example \ref{flat-example-one-generator}.
...
$P = A$ follows from Lemma \ref{flat-lemma-h-sheaf-colim-F}
...
\begin{lemma}[Vector bundle II]
\label{flat-lemma-vector-bundle-II}
\source{stacks:0EXD}
\href{https://stacks.math.columbia.edu/tag/0EXD}{\texttt{Stacks tag 0EXD}}
\group{flat}

\uses{flat-example-two-generators}
Let $p$ be a prime number. Consider an almost blowup square $X, X', Z, E$
in characteristic $p$ as in Example \ref{flat-example-two-generators}.
Then the functor
$$
G :
\colim_F \textit{Vect}(X)
...
\begin{proof}
\uses{flat-example-two-generators, flat-lemma-h-sheaf-colim-F, flat-lemma-colim-F-Vect}
...
$$
\begin{array}{cc}E_i \longrightarrow\downarrow & X'_i \downarrow \\ Z_i \longrightarrow & X_i\end{array}
$$
is another almost blow up square as in Example \ref{flat-example-two-generators}.
...
$$
by Lemma \ref{flat-lemma-h-sheaf-colim-F} (see proof of the lemma).
...
in the Zariski topology (Lemma \ref{flat-lemma-colim-F-Vect}), and
...
\begin{proposition}[H descent vector bundles p]
\label{flat-proposition-h-descent-vector-bundles-p}
\source{stacks:0EXE}
\href{https://stacks.math.columbia.edu/tag/0EXE}{\texttt{Stacks tag 0EXE}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-colim-F-Vect, flat-lemma-refine-check-h-stack, flat-lemma-vector-bundle-I, flat-lemma-vector-bundle-II}

The final assertion is the content of Lemma \ref{flat-lemma-colim-F-Vect}.
To prove the proposition we will check conditions (1), (2), and (3) of
Lemma \ref{flat-lemma-refine-check-h-stack}.
...
Lemmas \ref{flat-lemma-vector-bundle-I} and \ref{flat-lemma-vector-bundle-II}.
\end{proof}

\begin{lemma}[Trivial fibres dvr]
\label{flat-lemma-trivial-fibres-dvr}
\source{stacks:0EXF}
\href{https://stacks.math.columbia.edu/tag/0EXF}{\texttt{Stacks tag 0EXF}}
\group{flat}
...
\begin{lemma}[Trivial over dvrs]
\label{flat-lemma-trivial-over-dvrs}
\source{stacks:0EXG}
\href{https://stacks.math.columbia.edu/tag/0EXG}{\texttt{Stacks tag 0EXG}}
\group{flat}
...
\begin{theorem}[Pullback trivial fibres]
\label{flat-theorem-pullback-trivial-fibres}
\source{stacks:0EXH}
\href{https://stacks.math.columbia.edu/tag/0EXH}{\texttt{Stacks tag 0EXH}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-h-sheaf-colim-F, flat-proposition-h-descent-vector-bundles-p, flat-lemma-flat-after-blowing-up, flat-lemma-trivial-fibres-dvr, flat-lemma-trivial-over-dvrs}
...
follow from Lemma \ref{flat-lemma-h-sheaf-colim-F} if we can show that the two maps
$$
\colim_F \Gamma(X, \mathcal{O}_X)
\longrightarrow
...
Noetherian approximation. We strongly urge the reader to skip
...
By Lemma \ref{flat-lemma-flat-after-blowing-up}
...
Lemma \ref{flat-lemma-trivial-fibres-dvr} for the scheme $X_{A_i}$ over $A_i$.
...
Then Lemma \ref{flat-lemma-trivial-fibres-dvr} tells us that
$\mathcal{E}$ is free on $X_{A_i}$.
Thus finally we conclude by applying Lemma \ref{flat-lemma-trivial-over-dvrs}.
\end{proof}
...
\begin{lemma}[Fitting ideals complex]
\label{flat-lemma-fitting-ideals-complex}
\source{stacks:0ESP}
\href{https://stacks.math.columbia.edu/tag/0ESP}{\texttt{Stacks tag 0ESP}}
\group{flat}
...
\begin{lemma}[Blowup complex]
\label{flat-lemma-blowup-complex}
\source{stacks:0ESQ}
\href{https://stacks.math.columbia.edu/tag/0ESQ}{\texttt{Stacks tag 0ESQ}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-fitting-ideals-complex}
...
\medskip\noindent
On the one hand, comparing with Lemma \ref{flat-lemma-fitting-ideals-complex}
...
\begin{lemma}[Blowup complex integral]
\label{flat-lemma-blowup-complex-integral}
\source{stacks:0ESR}
\href{https://stacks.math.columbia.edu/tag/0ESR}{\texttt{Stacks tag 0ESR}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-blowup-complex}
...
first and Lemma \ref{flat-lemma-blowup-complex} as any nonempty open is
scheme theoretically dense in the integral scheme $X$.
\end{proof}

\begin{remark}[When you have a complex]
\label{flat-remark-when-you-have-a-complex}
\source{stacks:0F8J}
\href{https://stacks.math.columbia.edu/tag/0F8J}{\texttt{Stacks tag 0F8J}}
\group{flat}
...
\begin{lemma}[Blowup pd1 derived]
\label{flat-lemma-blowup-pd1-derived}
\source{stacks:0ESS}
\href{https://stacks.math.columbia.edu/tag/0ESS}{\texttt{Stacks tag 0ESS}}
\group{flat}
...
\begin{lemma}[Blowup pd1]
\label{flat-lemma-blowup-pd1}
\source{stacks:0EST}
\href{https://stacks.math.columbia.edu/tag/0EST}{\texttt{Stacks tag 0EST}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-blowup-pd1-derived}

Combine Divisors, Lemma \ref{divisors-lemma-blowup-fitting-ideal} and
Lemma \ref{flat-lemma-blowup-pd1-derived}.
\end{proof}

\begin{lemma}[Canonical blowup torsion pd1]
\label{flat-lemma-canonical-blowup-torsion-pd1}
\source{stacks:0ESU}
\href{https://stacks.math.columbia.edu/tag/0ESU}{\texttt{Stacks tag 0ESU}}
\group{flat}
...
\begin{lemma}[Blowup map pd1]
\label{flat-lemma-blowup-map-pd1}
\source{stacks:0ESV}
\href{https://stacks.math.columbia.edu/tag/0ESV}{\texttt{Stacks tag 0ESV}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-blowup-complex, flat-lemma-blowup-pd1-derived}
...
works for the cokernel and kernel by Lemmas \ref{flat-lemma-blowup-complex}
and \ref{flat-lemma-blowup-pd1-derived} (to see what the complex looks
...
\source{stacks:0F8M}
\href{https://stacks.math.columbia.edu/tag/0F8M}{\texttt{Stacks tag 0F8M}}
\group{flat}
...
\source{stacks:0GTV}
\href{https://stacks.math.columbia.edu/tag/0GTV}{\texttt{Stacks tag 0GTV}}
\group{flat}
...
Macpherson's graph construction in Section \ref{flat-section-blowup-complexes-III}.

\begin{definition}[Situation: Complex and divisor]
\label{flat-situation-complex-and-divisor}
\source{stacks:0F8S}
\href{https://stacks.math.columbia.edu/tag/0F8S}{\texttt{Stacks tag 0F8S}}
\group{flat}
...
\begin{lemma}[Pullback triple ideals good]
\label{flat-lemma-pullback-triple-ideals-good}
\source{stacks:0F8T}
\href{https://stacks.math.columbia.edu/tag/0F8T}{\texttt{Stacks tag 0F8T}}
\group{flat}

\uses{flat-situation-complex-and-divisor}
In Situation \ref{flat-situation-complex-and-divisor} let $h : Y \to X$ be a
...
\begin{proof}
The first statement follows from the following observations:
...
\begin{lemma}[Good triple]
\label{flat-lemma-good-triple}
\source{stacks:0GTW}
\href{https://stacks.math.columbia.edu/tag/0GTW}{\texttt{Stacks tag 0GTW}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-Leta}

Translation of
More on Algebra, Lemma \ref{more-algebra-lemma-eta-locally-free}.
To do the translation use Lemma \ref{flat-lemma-Leta}.
\end{proof}

\begin{lemma}[Good triple bdd loc free]
\label{flat-lemma-good-triple-bdd-loc-free}
\source{stacks:0GTX}
\href{https://stacks.math.columbia.edu/tag/0GTX}{\texttt{Stacks tag 0GTX}}
\group{flat}
...
corresponding to $\eta_fN^i$ by Lemma \ref{flat-lemma-eta-stalks} we conclude.
\end{proof}

\begin{lemma}[Complex and divisor eta pull]
\label{flat-lemma-complex-and-divisor-eta-pull}
\source{stacks:0F9X}
\href{https://stacks.math.columbia.edu/tag/0F9X}{\texttt{Stacks tag 0F9X}}
\group{flat}

\uses{flat-situation-complex-and-divisor}
In Situation \ref{flat-situation-complex-and-divisor} let $h : Y \to X$
...
\begin{proof}
\uses{flat-lemma-eta-stalks, flat-lemma-Leta}

Translation of
More on Algebra, Lemma \ref{more-algebra-lemma-eta-base-change}.
Use Lemmas \ref{flat-lemma-eta-stalks} and \ref{flat-lemma-Leta}
to do the translation.
\end{proof}

\begin{lemma}[Complex and divisor blowup pre]
\label{flat-lemma-complex-and-divisor-blowup-pre}
\source{stacks:0GTY}
\href{https://stacks.math.columbia.edu/tag/0GTY}{\texttt{Stacks tag 0GTY}}
\group{flat}

\uses{flat-situation-complex-and-divisor}
In Situation \ref{flat-situation-complex-and-divisor}
...
\begin{proof}
\uses{flat-lemma-pullback-triple-ideals-good}
...
Lemma \ref{flat-lemma-pullback-triple-ideals-good}
...
\begin{lemma}[Complex and divisor blowup]
\label{flat-lemma-complex-and-divisor-blowup}
\source{stacks:0F8U}
\href{https://stacks.math.columbia.edu/tag/0F8U}{\texttt{Stacks tag 0F8U}}
\group{flat}

\uses{flat-situation-complex-and-divisor, flat-lemma-complex-and-divisor-blowup-pre}
In Situation \ref{flat-situation-complex-and-divisor} let $b : X' \to X$
be the morphism of Lemma \ref{flat-lemma-complex-and-divisor-blowup-pre}.
...
\begin{proof}
\uses{flat-lemma-complex-and-divisor-blowup-pre, flat-lemma-good-triple}

Follows from Lemmas \ref{flat-lemma-complex-and-divisor-blowup-pre}
and \ref{flat-lemma-good-triple}.
\end{proof}

\begin{lemma}[Complex and divisor blowup base change]
\label{flat-lemma-complex-and-divisor-blowup-base-change}
\source{stacks:0F8V}
\href{https://stacks.math.columbia.edu/tag/0F8V}{\texttt{Stacks tag 0F8V}}
\group{flat}

\uses{flat-situation-complex-and-divisor, flat-lemma-complex-and-divisor-blowup-pre, flat-lemma-complex-and-divisor-blowup}
In Situation \ref{flat-situation-complex-and-divisor} let $h : Y \to X$
be a morphism of schemes such that the pullback $E = h^{-1}D$
is defined. Let $b : X' \to X$, resp.\ $c : Y' \to Y$ be as constructed in
Lemma \ref{flat-lemma-complex-and-divisor-blowup-pre} for
...
Lemma \ref{flat-lemma-complex-and-divisor-blowup}.
...
\begin{proof}
\uses{flat-lemma-complex-and-divisor-blowup-pre, flat-lemma-complex-and-divisor-blowup, flat-lemma-pullback-triple-ideals-good, flat-lemma-complex-and-divisor-eta-pull}

Denote $E' = c^{-1}E$. Then $(Y', E', L(h \circ c)^*M)$ is a good
triple. Hence by the universal property of
Lemma \ref{flat-lemma-complex-and-divisor-blowup-pre}
...
\medskip\noindent
Let $(U, A, f, M^\bullet)$ be an affine chart for $(X, D, M)$.
Recall from the proof of Lemma \ref{flat-lemma-complex-and-divisor-blowup}
...
$L\eta_{\mathcal{J}'}L(h \circ c)^*M = L(Y' \to X')^*Q$
follows from
Lemma \ref{flat-lemma-complex-and-divisor-eta-pull}.
The final statement is a special case of this
(namely, the case where $c = \text{id}_Y$ and $k = h'$).
\end{proof}

\begin{lemma}[Complex and divisor blowup good]
\label{flat-lemma-complex-and-divisor-blowup-good}
\source{stacks:0F8W}
\href{https://stacks.math.columbia.edu/tag/0F8W}{\texttt{Stacks tag 0F8W}}
\group{flat}

\uses{flat-situation-complex-and-divisor, flat-lemma-complex-and-divisor-blowup-pre}
In Situation \ref{flat-situation-complex-and-divisor} let $W \subset X$
be the maximal open subscheme over which the cohomology sheaves
of $M$ are locally free. Then the morphism $b : X' \to X$
of Lemma \ref{flat-lemma-complex-and-divisor-blowup-pre} is an isomorphism
over $W$.
\end{lemma}
...
\begin{lemma}[Complex and divisor blowup good T]
\label{flat-lemma-complex-and-divisor-blowup-good-T}
\source{stacks:0GTZ}
\href{https://stacks.math.columbia.edu/tag/0GTZ}{\texttt{Stacks tag 0GTZ}}
\group{flat}
...
\begin{lemma}[Complex and divisor blowup T]
\label{flat-lemma-complex-and-divisor-blowup-T}
\source{stacks:0F8X}
\href{https://stacks.math.columbia.edu/tag/0F8X}{\texttt{Stacks tag 0F8X}}
\group{flat}

\uses{flat-situation-complex-and-divisor, flat-lemma-complex-and-divisor-blowup-pre, flat-lemma-complex-and-divisor-blowup}
In Situation \ref{flat-situation-complex-and-divisor}. Let $b : X' \to X$
and $D'$ be as in Lemma \ref{flat-lemma-complex-and-divisor-blowup-pre}. Let
...
\begin{proof}
\uses{flat-lemma-complex-and-divisor-blowup-good, flat-lemma-complex-and-divisor-blowup-good-T}

Lemma \ref{flat-lemma-complex-and-divisor-blowup-good} tells us that
...
Lemma \ref{flat-lemma-complex-and-divisor-blowup-good-T} applied
to $(X', D', Lb^*M)$ and the other lemmas mentioned in the statement.
\end{proof}

\begin{lemma}[Complex and divisor blowup T ranks]
\label{flat-lemma-complex-and-divisor-blowup-T-ranks}
\source{stacks:0F8Y}
\href{https://stacks.math.columbia.edu/tag/0F8Y}{\texttt{Stacks tag 0F8Y}}
\group{flat}

\uses{flat-situation-complex-and-divisor, flat-lemma-complex-and-divisor-blowup, flat-lemma-complex-and-divisor-blowup-T}
In Situation \ref{flat-situation-complex-and-divisor}. Let $b : X' \to X$,
...
Let $i : T \to D'$ be as in Lemma \ref{flat-lemma-complex-and-divisor-blowup-T}.
...
\begin{proof}
\uses{flat-lemma-complex-and-divisor-blowup-T}
...
Lemma \ref{flat-lemma-complex-and-divisor-blowup-T}
on ranks of the cohomology modules.
\end{proof}

\begin{lemma}[Complex and divisor blowup T represented bdd loc free]
\label{flat-lemma-complex-and-divisor-blowup-T-represented-bdd-loc-free}
\source{stacks:0GU0}
\href{https://stacks.math.columbia.edu/tag/0GU0}{\texttt{Stacks tag 0GU0}}
\group{flat}

\uses{flat-situation-complex-and-divisor, flat-lemma-complex-and-divisor-blowup}
In Situation \ref{flat-situation-complex-and-divisor}. Let $b : X' \to X$,
$D' \subset X'$, and $Q$ be as in
Lemma \ref{flat-lemma-complex-and-divisor-blowup}.
If there exists a locally bounded complex $\mathcal{M}^\bullet$
...
\begin{proof}
\uses{flat-lemma-good-triple-bdd-loc-free}
...
Lemma \ref{flat-lemma-good-triple-bdd-loc-free}.
\end{proof}

\begin{lemma}[Complex and divisor derived]
\label{flat-lemma-complex-and-divisor-derived}
\source{stacks:0F9Y}
\href{https://stacks.math.columbia.edu/tag/0F9Y}{\texttt{Stacks tag 0F9Y}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-pullback-triple-ideals-good, flat-lemma-good-triple, flat-lemma-complex-and-divisor-eta-pull, flat-lemma-complex-and-divisor-blowup-pre, flat-lemma-complex-and-divisor-blowup, flat-lemma-complex-and-divisor-blowup-base-change, flat-lemma-complex-and-divisor-blowup-good, flat-lemma-complex-and-divisor-blowup-good-T, flat-lemma-complex-and-divisor-blowup-T, flat-lemma-complex-and-divisor-blowup-T-represented-bdd-loc-free}

This statement collects the information obtained in
Lemmas \ref{flat-lemma-pullback-triple-ideals-good},
...
\ref{flat-lemma-complex-and-divisor-blowup-T}, and
...
Consider the commutative diagram
$$
\begin{array}{ccc}\mathbf{A}^1_X \longrightarrow\searrow & \mathbf{P}^1_X \overset{p}{\downarrow} & (\mathbf{P}^1_X)_\infty \longleftarrow\swarrow \\  & X \underset{\infty}{\nearrow} & \end{array}
$$
...
$$
is a triple as in Situation \ref{flat-situation-complex-and-divisor}
in Section \ref{flat-section-blowup-complexes-II}.
Let
$$
...
considered in Lemma \ref{flat-lemma-complex-and-divisor-blowup}.
Here $\mathcal{I} \subset \mathcal{O}_W$ is the ideal sheaf
of $W_\infty$.

\begin{lemma}[Graph construction]
\label{flat-lemma-graph-construction}
\source{stacks:0F90}
\href{https://stacks.math.columbia.edu/tag/0F90}{\texttt{Stacks tag 0F90}}
\group{flat}
...
\begin{proof}
\uses{flat-lemma-complex-and-divisor-derived}

This follows immediately from the results in
Section \ref{flat-section-blowup-complexes-II}; for a statement
collecting everything needed, see
Lemma \ref{flat-lemma-complex-and-divisor-derived}.
\end{proof}
