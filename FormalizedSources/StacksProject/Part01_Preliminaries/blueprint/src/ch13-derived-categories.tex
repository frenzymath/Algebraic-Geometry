...
\source{stacks:0144}
\href{https://stacks.math.columbia.edu/tag/0144}{\texttt{Stacks tag 0144}}
\group{derived}
...
commutative diagram
$$
\begin{array}{cccc}X \longrightarrow\overset{a}{\downarrow} & Y \longrightarrow\overset{b}{\downarrow} & Z \longrightarrow\overset{c}{\downarrow} & X[1] \overset{a[1]}{\downarrow} \\ X' \longrightarrow & Y' \longrightarrow & Z' \longrightarrow & X'[1]\end{array}
$$
In the setting of Definition \ref{derived-definition-triangle}, we
...
\source{stacks:0145}
\href{https://stacks.math.columbia.edu/tag/0145}{\texttt{Stacks tag 0145}}
\group{derived}

\uses{derived-definition-triangle}
...
\item $\mathcal{T}$ is a set of triangles (Definition \ref{derived-definition-triangle})
...
$$
\begin{array}{cccc}X \overset{f}{\longrightarrow}\overset{a}{\downarrow} & Y \overset{g}{\longrightarrow}\overset{b}{\downarrow} & Z \overset{h}{\longrightarrow}\downarrow & X[1] \overset{a[1]}{\downarrow} \\ X' \overset{f'}{\longrightarrow} & Y' \overset{g'}{\longrightarrow} & Z' \overset{h'}{\longrightarrow} & X'[1]\end{array}
$$
...
of this idea see the proof of Lemma \ref{derived-lemma-two-split-injections}.
...
\begin{definition}[Exact functor triangulated categories]
\label{derived-definition-exact-functor-triangulated-categories}
\source{stacks:014V}
\href{https://stacks.math.columbia.edu/tag/014V}{\texttt{Stacks tag 014V}}
\group{derived}
...
Lemma \ref{derived-lemma-exact-functor-additive}.
...
with $\xi$ and $\xi'$, i.e.,
$$
\begin{array}{cc}F \circ [1] \underset{\xi}{\longrightarrow}\underset{a \star 1}{\downarrow} & [1] \circ F \overset{1 \star a}{\downarrow} \\ F' \circ [1] \overset{\xi'}{\longrightarrow} & [1] \circ F'\end{array}
$$
commutes.
...
\source{stacks:05QM}
\href{https://stacks.math.columbia.edu/tag/05QM}{\texttt{Stacks tag 05QM}}
\group{derived}

\uses{derived-lemma-triangulated-subcategory}
...
\medskip\noindent
We will see in
Lemma \ref{derived-lemma-composition-zero}
...
\begin{definition}[Homological]
\label{derived-definition-homological}
\source{stacks:0147}
\href{https://stacks.math.columbia.edu/tag/0147}{\texttt{Stacks tag 0147}}
\group{derived}
...
\begin{array}{ccccc}H^{-1}(Z) \overset{H(h[-1])}{\longrightarrow} & H^0(X) \overset{H(f)}{\longrightarrow} & H^0(Y) \overset{H(g)}{\longrightarrow} & H^0(Z) \overset{H(h)}{\longrightarrow} & H^1(X)\end{array}
\end{equation}
...
\source{stacks:0150}
\href{https://stacks.math.columbia.edu/tag/0150}{\texttt{Stacks tag 0150}}
\group{derived}
...
$$
\begin{array}{ccc}G(C) \downarrow\underset{\delta_{A \to B \to C}}{\longrightarrow} &  & G(A)[1] \downarrow \\ G(C') \overset{\delta_{A' \to B' \to C'}}{\longrightarrow} &  & G(A')[1]\end{array}
$$
is commutative.
\end{enumerate}
...
\begin{lemma}[Composition zero]
\label{derived-lemma-composition-zero}
\source{stacks:0146}
\href{https://stacks.math.columbia.edu/tag/0146}{\texttt{Stacks tag 0146}}
\group{derived}
...
Apply TR3 to
$$
\begin{array}{cccc}X \longrightarrow\overset{1}{\downarrow} & X \longrightarrow\overset{f}{\downarrow} & 0 \longrightarrow\downarrow & X[1] \overset{1[1]}{\downarrow} \\ X \overset{f}{\longrightarrow} & Y \overset{g}{\longrightarrow} & Z \overset{h}{\longrightarrow} & X[1]\end{array}
$$
...
\begin{lemma}[Representable homological]
\label{derived-lemma-representable-homological}
\source{stacks:0149}
\href{https://stacks.math.columbia.edu/tag/0149}{\texttt{Stacks tag 0149}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-composition-zero}
...
$$
\begin{array}{cccc}W \underset{1}{\longrightarrow}\overset{b}{\downarrow} & W \longrightarrow\overset{a}{\downarrow} & 0 \longrightarrow\overset{0}{\downarrow} & W[1] \overset{b[1]}{\downarrow} \\ X \longrightarrow & Y \longrightarrow & Z \longrightarrow & X[1]\end{array}
$$
...
\begin{lemma}[Third isomorphism triangle]
\label{derived-lemma-third-isomorphism-triangle}
\source{stacks:014A}
\href{https://stacks.math.columbia.edu/tag/014A}{\texttt{Stacks tag 014A}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-representable-homological}
...
$$
\begin{array}{ccccc}H_W(Z[-1]) \longrightarrow\downarrow & H_W(X) \longrightarrow\downarrow & H_W(Y) \longrightarrow\downarrow & H_W(Z) \longrightarrow\downarrow & H_W(X[1]) \downarrow \\ H_W(Z'[-1]) \longrightarrow & H_W(X') \longrightarrow & H_W(Y') \longrightarrow & H_W(Z') \longrightarrow & H_W(X'[1])\end{array}
$$
...
\begin{remark}[Special triangles]
\label{derived-remark-special-triangles}
\source{stacks:09WA}
\href{https://stacks.math.columbia.edu/tag/09WA}{\texttt{Stacks tag 09WA}}
\group{derived}

\uses{derived-definition-triangle, derived-lemma-third-isomorphism-triangle}
Let $\mathcal{D}$ be an additive category with translation functors $[n]$
as in Definition \ref{derived-definition-triangle}. Let us call a triangle
...
$$
is exact.  The proof of Lemma \ref{derived-lemma-third-isomorphism-triangle}
shows that if
$$
(a, b, c) : (X, Y, Z, f, g, h) \to (X', Y', Z', f', g', h')
$$
...
\begin{lemma}[Third map square zero]
\label{derived-lemma-third-map-square-zero}
\source{stacks:05QP}
\href{https://stacks.math.columbia.edu/tag/05QP}{\texttt{Stacks tag 05QP}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-representable-homological, derived-lemma-composition-zero}

Picture
$$
\begin{array}{cccc}X \longrightarrow\overset{0}{\downarrow} & Y \longrightarrow\overset{b, b'}{\downarrow}\overset{\alpha}{\swarrow} & Z \longrightarrow\overset{0}{\downarrow}\overset{\beta}{\swarrow} & X[1] \overset{0}{\downarrow} \\ X \longrightarrow & Y \longrightarrow & Z \longrightarrow & X[1]\end{array}
$$
Applying
Lemma \ref{derived-lemma-representable-homological}
...
\begin{lemma}[Third map idempotent]
\label{derived-lemma-third-map-idempotent}
\source{stacks:05QQ}
\href{https://stacks.math.columbia.edu/tag/05QQ}{\texttt{Stacks tag 05QQ}}
\group{derived}
...
If
$$
\begin{array}{cc}Z \underset{h}{\longrightarrow}\underset{c}{\downarrow} & X[1] \overset{a[1]}{\downarrow} \\ Z \overset{h}{\longrightarrow} & X[1]\end{array}
$$
...
\begin{proof}
\uses{derived-lemma-third-map-square-zero}
...
Lemma \ref{derived-lemma-third-map-square-zero}
...
\begin{lemma}[Cone triangle unique isomorphism]
\label{derived-lemma-cone-triangle-unique-isomorphism}
\source{stacks:014B}
\href{https://stacks.math.columbia.edu/tag/014B}{\texttt{Stacks tag 014B}}
\group{derived}
...
We will use Lemma \ref{derived-lemma-representable-homological}
...
$$
\begin{array}{cccc}X \underset{f}{\longrightarrow}\overset{0}{\downarrow} & Y \underset{g}{\longrightarrow}\overset{b}{\downarrow} & Z \underset{h}{\longrightarrow}\overset{0}{\downarrow}\overset{\epsilon}{\swarrow} & X[1] \overset{0}{\downarrow} \\ X' \overset{f'}{\longrightarrow} & Y' \overset{g'}{\longrightarrow} & Z' \overset{h'}{\longrightarrow} & X'[1]\end{array}
$$
...
\begin{lemma}[Third object zero]
\label{derived-lemma-third-object-zero}
\source{stacks:05QR}
\href{https://stacks.math.columbia.edu/tag/05QR}{\texttt{Stacks tag 05QR}}
\group{derived}
...
of triangles by Lemma \ref{derived-lemma-third-isomorphism-triangle}
and $Z = 0$. Conversely, if $Z = 0$, then $(1, f, 0)$ is an
isomorphism of triangles as well, hence $f$ is an isomorphism.
\end{proof}

\begin{lemma}[Direct sum triangles]
\label{derived-lemma-direct-sum-triangles}
\source{stacks:05QS}
\href{https://stacks.math.columbia.edu/tag/05QS}{\texttt{Stacks tag 05QS}}
\group{derived}
...
\begin{proof}
\uses{derived-remark-special-triangles}
...
$$
\begin{array}{c}(X \oplus X', Y \oplus Y', Z \oplus Z',
f \oplus f', g \oplus g', h \oplus h')
\overset{(1, 1, c)}{\downarrow} \\ (X \oplus X', Y \oplus Y', Q, f \oplus f', g'', h'').\end{array}
$$
In the terminology of Remark \ref{derived-remark-special-triangles}
...
(terminology from Remark \ref{derived-remark-special-triangles})
...
(X, Y, Q, f, g'', h'')
$$
By Remark \ref{derived-remark-special-triangles}
...
\source{stacks:05QT}
\href{https://stacks.math.columbia.edu/tag/05QT}{\texttt{Stacks tag 05QT}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-representable-homological, derived-lemma-direct-sum-triangles}
...
from TR1 and
Lemma \ref{derived-lemma-direct-sum-triangles}.
\end{proof}

\begin{lemma}[When split]
\label{derived-lemma-when-split}
\source{stacks:05QU}
\href{https://stacks.math.columbia.edu/tag/05QU}{\texttt{Stacks tag 05QU}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-composition-zero, derived-lemma-split}
...
By Lemma \ref{derived-lemma-composition-zero} the composition
$f \circ h[-1] = 0$. As $f$ is a monomorphism we see that $h[-1] = 0$
and hence $h = 0$. Then
Lemma \ref{derived-lemma-split}
...
\begin{lemma}[Products sums shifts triangles]
\label{derived-lemma-products-sums-shifts-triangles}
\source{stacks:0CRG}
\href{https://stacks.math.columbia.edu/tag/0CRG}{\texttt{Stacks tag 0CRG}}
\group{derived}
...
$\prod X_i \to \prod Y_i \to \prod Z_i \to \prod X_i[1]$
is special in the terminology of Remark \ref{derived-remark-special-triangles}
because products of exact sequences of abelian groups are exact.
Hence Remark \ref{derived-remark-special-triangles} shows that
the morphism of triangles is an isomorphism and we conclude by TR1.
The proof of (2)(b) is dual.
\end{proof}

\begin{lemma}[Projectors have images triangulated]
\label{derived-lemma-projectors-have-images-triangulated}
\source{stacks:05QW}
\href{https://stacks.math.columbia.edu/tag/05QW}{\texttt{Stacks tag 05QW}}
\group{derived}
...
has a kernel by
Lemma \ref{derived-lemma-when-split}.
...
\begin{lemma}[Easier axiom four]
\label{derived-lemma-easier-axiom-four}
\source{stacks:014C}
\href{https://stacks.math.columbia.edu/tag/014C}{\texttt{Stacks tag 014C}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-cone-triangle-unique-isomorphism}
...
Lemma \ref{derived-lemma-cone-triangle-unique-isomorphism}.
\end{proof}

\begin{lemma}[Triangulated subcategory]
\label{derived-lemma-triangulated-subcategory}
\source{stacks:05QX}
\href{https://stacks.math.columbia.edu/tag/05QX}{\texttt{Stacks tag 05QX}}
\group{derived}
...
\begin{lemma}[Exact functor additive]
\label{derived-lemma-exact-functor-additive}
\source{stacks:05QY}
\href{https://stacks.math.columbia.edu/tag/05QY}{\texttt{Stacks tag 05QY}}
\group{derived}
...
Lemma \ref{derived-lemma-split} part (3), we see that
$(F(X), F(X \oplus Y), F(Y), F(1, 0), F(0, 1), 0)$ is
one too. This implies that the map $F(X) \oplus F(Y) \to F(X \oplus Y)$
is an isomorphism by Lemma \ref{derived-lemma-split} part (2). To finish we apply
Homology, Lemma \ref{homology-lemma-additive-functor}.
\end{proof}

\begin{lemma}[Exact equivalence]
\label{derived-lemma-exact-equivalence}
\source{stacks:05SQ}
\href{https://stacks.math.columbia.edu/tag/05SQ}{\texttt{Stacks tag 05SQ}}
\group{derived}
...
\begin{lemma}[Composition exact]
\label{derived-lemma-composition-exact}
\source{stacks:014Y}
\href{https://stacks.math.columbia.edu/tag/014Y}{\texttt{Stacks tag 014Y}}
\group{derived}
...
\begin{lemma}[Exact compose homological functor]
\label{derived-lemma-exact-compose-homological-functor}
\source{stacks:05QZ}
\href{https://stacks.math.columbia.edu/tag/05QZ}{\texttt{Stacks tag 05QZ}}
\group{derived}
...
\begin{lemma}[Exact compose delta functor]
\label{derived-lemma-exact-compose-delta-functor}
\source{stacks:0151}
\href{https://stacks.math.columbia.edu/tag/0151}{\texttt{Stacks tag 0151}}
\group{derived}
...
\begin{lemma}[Compose delta functor homological]
\label{derived-lemma-compose-delta-functor-homological}
\source{stacks:05SR}
\href{https://stacks.math.columbia.edu/tag/05SR}{\texttt{Stacks tag 05SR}}
\group{derived}
...
\begin{proof}
\uses{derived-definition-delta-functor}
...
Definition \ref{derived-definition-delta-functor}.
...
\source{stacks:05R0}
\href{https://stacks.math.columbia.edu/tag/05R0}{\texttt{Stacks tag 05R0}}
\group{derived}

Let $\mathcal{D}$ be a triangulated category. Any commutative diagram
$$
\begin{array}{cc}X \longrightarrow\downarrow & Y \downarrow \\ X' \longrightarrow & Y'\end{array}
$$
can be extended to a diagram
$$
\begin{array}{cccc}X \longrightarrow\downarrow & Y \longrightarrow\downarrow & Z \longrightarrow\downarrow & X[1] \downarrow \\ X' \longrightarrow\downarrow & Y' \longrightarrow\downarrow & Z' \longrightarrow\downarrow & X'[1] \downarrow \\ X'' \longrightarrow\downarrow & Y'' \longrightarrow\downarrow & Z'' \longrightarrow\downarrow & X''[1] \downarrow \\ X[1] \longrightarrow & Y[1] \longrightarrow & Z[1] \longrightarrow & X[2]\end{array}
$$
...
$$
\vcenter{
\begin{array}{cc}X' \longrightarrow\downarrow & Y' \downarrow \\ X'' \overset{b \circ a'}{\longrightarrow}\downarrow & Y'' \downarrow \\ X[1] \longrightarrow & Y[1]\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{ccc}Y \longrightarrow\downarrow & Z \overset{b' \circ a}{\downarrow}\longrightarrow & X[1] \downarrow \\ Y' \longrightarrow & Z' \longrightarrow & X'[1]\end{array}
}
$$
...
\source{stacks:05R2}
\href{https://stacks.math.columbia.edu/tag/05R2}{\texttt{Stacks tag 05R2}}
\group{derived}

\uses{derived-remark-MS5}
...
$f \in S \Leftrightarrow f[1] \in S$\footnote{See Remark \ref{derived-remark-MS5}.}.
\item[MS6] Given a solid commutative square
$$
\begin{array}{cccc}X \longrightarrow\overset{s}{\downarrow} & Y \longrightarrow\overset{s'}{\downarrow} & Z \longrightarrow\downarrow & X[1] \overset{s[1]}{\downarrow} \\ X' \longrightarrow & Y' \longrightarrow & Z' \longrightarrow & X'[1]\end{array}
$$
...
\begin{lemma}[Localization conditions]
\label{derived-lemma-localization-conditions}
\source{stacks:05R3}
\href{https://stacks.math.columbia.edu/tag/05R3}{\texttt{Stacks tag 05R3}}
\group{derived}

\uses{derived-definition-localization}
Let $\mathcal{D}$ be a pre-triangulated category.
Let $S \subset \text{Arrows}(\mathcal{D})$.
\begin{enumerate}
\item If $S$ contains all identities and MS6 holds
(Definition \ref{derived-definition-localization}),
...
\begin{proof}
\uses{derived-lemma-third-object-zero}

Assume $S$ contains all identities and MS6 holds.
Let $f : X \to Y$ be an isomorphism of $\mathcal{D}$.
Consider the diagram
$$
\begin{array}{cccc}0 \longrightarrow\overset{1}{\downarrow} & X \underset{1}{\longrightarrow}\overset{1}{\downarrow} & X \longrightarrow\downarrow & 0[1] \overset{1[1]}{\downarrow} \\ 0 \longrightarrow & X \overset{f}{\longrightarrow} & Y \longrightarrow & 0[1]\end{array}
$$
The rows are distinguished triangles by Lemma \ref{derived-lemma-third-object-zero}.
...
$$
\begin{array}{cccc}X \longrightarrow\overset{t}{\downarrow} & Y \longrightarrow\overset{s'}{\downarrow} & Z \longrightarrow\overset{1}{\downarrow} & X[1] \overset{t[1]}{\downarrow} \\ X' \longrightarrow & Y' \longrightarrow & Z \longrightarrow & X'[1]\end{array}
$$
...
\source{stacks:0H30}
\href{https://stacks.math.columbia.edu/tag/0H30}{\texttt{Stacks tag 0H30}}
\group{derived}

\uses{derived-lemma-localization-conditions}
...
Lemma \ref{derived-lemma-localization-conditions} (1) we find $f, g \in S$,
hence $s[-1][1] \in S$ by MS1, hence $s[-1] \in S$ by MS5.
We leave a complete proof to the reader as an exercise.
\end{remark}

\begin{lemma}[Triangle functor localize]
\label{derived-lemma-triangle-functor-localize}
\source{stacks:05R4}
\href{https://stacks.math.columbia.edu/tag/05R4}{\texttt{Stacks tag 05R4}}
\group{derived}
...
\begin{proof}
\uses{derived-definition-localization, derived-lemma-third-isomorphism-triangle, derived-lemma-localization-conditions, derived-lemma-representable-homological, derived-lemma-third-object-zero}
...
Lemma \ref{derived-lemma-third-isomorphism-triangle}.
By
Lemma \ref{derived-lemma-localization-conditions}
...
$$
\begin{array}{cccc}Z \underset{t}{\longrightarrow} & X \underset{d}{\longrightarrow}\overset{1}{\downarrow} & Q \longrightarrow\overset{i}{\downarrow} & Z[1] \\  & X \underset{a}{\longrightarrow} & Y \overset{j}{\downarrow} &  \\  &  & W & \end{array}
$$
OK, and now we apply the functor $F$ to this diagram.
Since $t \in S$ we see that $F(Q) = 0$, see
Lemma \ref{derived-lemma-third-object-zero}.
...
\begin{lemma}[Homological functor localize]
\label{derived-lemma-homological-functor-localize}
\source{stacks:05R5}
\href{https://stacks.math.columbia.edu/tag/05R5}{\texttt{Stacks tag 05R5}}
\group{derived}
...
\begin{proof}
\uses{derived-definition-localization, derived-lemma-localization-conditions, derived-lemma-representable-homological}
...
$(Q, Y, W, i, j, k)$. Here is a picture
$$
\begin{array}{cccc}Z \underset{t}{\longrightarrow} & X \underset{u}{\longrightarrow}\overset{1}{\downarrow} & Q \underset{v}{\longrightarrow}\overset{i}{\downarrow} & Z[1] \\  & X \underset{a}{\longrightarrow} & Y \overset{j}{\downarrow} &  \\  &  & W & \end{array}
$$
...
\begin{proposition}[Construct localization]
\label{derived-proposition-construct-localization}
\source{stacks:05R6}
\href{https://stacks.math.columbia.edu/tag/05R6}{\texttt{Stacks tag 05R6}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-easier-axiom-four}
...
$$
\begin{array}{cc}Q(X) \underset{Q(f)}{\longrightarrow}\underset{a}{\downarrow} & Q(Y) \overset{b}{\downarrow} \\ Q(X') \overset{Q(f')}{\longrightarrow} & Q(Y')\end{array}
$$
...
diagram
$$
\begin{array}{ccc}X \underset{f}{\downarrow}\underset{k}{\longrightarrow} & X'' \overset{f''}{\downarrow} & X' \overset{f'}{\downarrow}\overset{s}{\longleftarrow} \\ Y \overset{l}{\longrightarrow} & Y'' & Y' \underset{t}{\longleftarrow}\end{array}
$$
in $\mathcal{D}$ with $s, t \in S$ and $a = s^{-1}k$, $b = t^{-1}l$.
At this point we can use TR3 for $\mathcal{D}$ and MS6 to find
a commutative diagram
$$
\begin{array}{cccc}X \longrightarrow\overset{k}{\downarrow} & Y \longrightarrow\overset{l}{\downarrow} & Z \longrightarrow\overset{m}{\downarrow} & X[1] \overset{g[1]}{\downarrow} \\ X'' \longrightarrow & Y'' \longrightarrow & Z'' \longrightarrow & X''[1] \\ X' \longrightarrow\underset{s}{\uparrow} & Y' \longrightarrow\underset{t}{\uparrow} & Z' \longrightarrow\underset{r}{\uparrow} & X'[1] \underset{s[1]}{\uparrow}\end{array}
$$
with $r \in S$. It follows that setting $c = Q(r)^{-1}Q(m)$ we obtain
the desired morphism of triangles
$$
\begin{array}{c}(Q(X), Q(Y), Q(Z), Q(f), Q(g), Q(h))
\overset{(a, b, c)}{\downarrow} \\ (Q(X'), Q(Y'), Q(Z'), Q(f'), Q(g'), Q(h'))\end{array}
$$
...
Lemma \ref{derived-lemma-easier-axiom-four}
...
\begin{lemma}[Universal property localization]
\label{derived-lemma-universal-property-localization}
\source{stacks:05R7}
\href{https://stacks.math.columbia.edu/tag/05R7}{\texttt{Stacks tag 05R7}}
\group{derived}

\uses{derived-proposition-construct-localization}
Let $\mathcal{D}$ be a pre-triangulated category. Let $S$ be a multiplicative
system compatible with the triangulated structure. Let
$Q : \mathcal{D} \to S^{-1}\mathcal{D}$ be the localization functor, see
Proposition \ref{derived-proposition-construct-localization}.
\begin{enumerate}
...
\begin{lemma}[Localization subcategory]
\label{derived-lemma-localization-subcategory}
\source{stacks:0GSL}
\href{https://stacks.math.columbia.edu/tag/0GSL}{\texttt{Stacks tag 0GSL}}
\group{derived}
...
\begin{proof}
\uses{derived-proposition-construct-localization, derived-lemma-triangle-functor-localize, derived-lemma-universal-property-localization}

Consider the quotient functor $Q : \mathcal{D} \to S^{-1}\mathcal{D}$
of Proposition \ref{derived-proposition-construct-localization}.
...
triangulated structure by Lemma \ref{derived-lemma-triangle-functor-localize}.
By Lemma \ref{derived-lemma-universal-property-localization} we obtain the
...
Definition \ref{derived-definition-kernel-category})
of the localization functor.

\begin{lemma}[Kernel localization]
\label{derived-lemma-kernel-localization}
\source{stacks:05R8}
\href{https://stacks.math.columbia.edu/tag/05R8}{\texttt{Stacks tag 05R8}}
\group{derived}
...
\begin{lemma}[Limit triangles]
\label{derived-lemma-limit-triangles}
\source{stacks:05R9}
\href{https://stacks.math.columbia.edu/tag/05R9}{\texttt{Stacks tag 05R9}}
\group{derived}
...
\source{stacks:05RB}
\href{https://stacks.math.columbia.edu/tag/05RB}{\texttt{Stacks tag 05RB}}
\group{derived}
...
$$
\begin{array}{ccccc} & S \searrow &  &  &  \\ X \nearrow\longrightarrow &  & Y \longrightarrow & T \longrightarrow & X[1]\end{array}
$$
...
\begin{lemma}[Triangle functor kernel]
\label{derived-lemma-triangle-functor-kernel}
\source{stacks:05RC}
\href{https://stacks.math.columbia.edu/tag/05RC}{\texttt{Stacks tag 05RC}}
\group{derived}
...
\begin{lemma}[Homological functor kernel]
\label{derived-lemma-homological-functor-kernel}
\source{stacks:05RD}
\href{https://stacks.math.columbia.edu/tag/05RD}{\texttt{Stacks tag 05RD}}
\group{derived}
...
\begin{lemma}[Homological functor bounded]
\label{derived-lemma-homological-functor-bounded}
\source{stacks:05RE}
\href{https://stacks.math.columbia.edu/tag/05RE}{\texttt{Stacks tag 05RE}}
\group{derived}
...
\begin{definition}[Kernel category]
\label{derived-definition-kernel-category}
\source{stacks:05RF}
\href{https://stacks.math.columbia.edu/tag/05RF}{\texttt{Stacks tag 05RF}}
\group{derived}

\uses{derived-lemma-triangle-functor-kernel, derived-lemma-homological-functor-kernel}
Let $\mathcal{D}$ be a (pre-)triangulated category.
\begin{enumerate}
...
\begin{lemma}[Construct multiplicative system]
\label{derived-lemma-construct-multiplicative-system}
\source{stacks:05RG}
\href{https://stacks.math.columbia.edu/tag/05RG}{\texttt{Stacks tag 05RG}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-triangle-functor-localize, derived-lemma-representable-homological, derived-lemma-composition-zero, derived-proposition-9, derived-lemma-localization-conditions, derived-lemma-split}
...
Lemma \ref{derived-lemma-triangle-functor-localize}. Choose a distinguished
...
$$
\begin{array}{cccc}Z \underset{t}{\longrightarrow} & X \underset{g}{\longrightarrow}\overset{1}{\downarrow} & Q \longrightarrow\overset{i}{\downarrow} & Z[1] \\  & X \underset{a}{\longrightarrow} & Y \overset{s}{\downarrow} &  \\  &  & W & \end{array}
$$
Since $t \in S$ we see that $Q$ is isomorphic to an object of $\mathcal{D}'$.
Hence $s \in S$. Finally, $s \circ a = s \circ i \circ g = 0$ as
$s \circ i = 0$ by Lemma \ref{derived-lemma-composition-zero}.
...
$$
\begin{array}{cc}X \longrightarrow\overset{s}{\downarrow} & Y \overset{s'}{\downarrow} \\ X' \longrightarrow & Y'\end{array}
$$
with $s, s' \in S$. By
Proposition \ref{derived-proposition-9}
...
$$
\begin{array}{ccccccc} &  & Q_{12} \searrow &  & Q_{23} \searrow &  &  \\  & Q_1 \underset{\! + \! 1}{\swarrow}\nearrow &  & Q_2 \underset{\! + \! 1}{\swarrow}\underset{\! + \! 1}{\longleftarrow}\nearrow &  & Q_3 \underset{\! + \! 1}{\swarrow}\underset{\! + \! 1}{\longleftarrow} &  \\ W \longrightarrow &  & X \nwarrow\longrightarrow &  & Y \nwarrow\longrightarrow &  & Z \nwarrow\end{array}
$$
...
$\mathcal{D}'$, see Lemma \ref{derived-lemma-split}.
...
\source{stacks:05RI}
\href{https://stacks.math.columbia.edu/tag/05RI}{\texttt{Stacks tag 05RI}}
\group{derived}

\uses{derived-lemma-construct-multiplicative-system}
Let $\mathcal{D}$ be a triangulated category.
...
$\mathcal{B}$ via
Lemma \ref{derived-lemma-construct-multiplicative-system}.
...
\begin{lemma}[The universal property of the Verdier quotient.]
\label{derived-lemma-universal-property-quotient}
\source{stacks:05RJ}
\href{https://stacks.math.columbia.edu/tag/05RJ}{\texttt{Stacks tag 05RJ}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-universal-property-localization}

This lemma follows from
Lemma \ref{derived-lemma-universal-property-localization}.
...
\begin{lemma}[Kernel quotient]
\label{derived-lemma-kernel-quotient}
\source{stacks:05RK}
\href{https://stacks.math.columbia.edu/tag/05RK}{\texttt{Stacks tag 05RK}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-triangle-functor-kernel, derived-lemma-kernel-localization}
...
Lemma \ref{derived-lemma-kernel-localization} part (4).
\end{proof}
...
\source{stacks:05RL}
\href{https://stacks.math.columbia.edu/tag/05RL}{\texttt{Stacks tag 05RL}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-kernel-quotient, derived-lemma-third-object-zero}
...
Lemma \ref{derived-lemma-kernel-quotient}.
...
\begin{lemma}[Acyclic general]
\label{derived-lemma-acyclic-general}
\source{stacks:05RM}
\href{https://stacks.math.columbia.edu/tag/05RM}{\texttt{Stacks tag 05RM}}
\group{derived}

\uses{derived-definition-homological, derived-lemma-operations}
...
\begin{proof}
\uses{derived-lemma-homological-functor-kernel, derived-lemma-homological-functor-localize, derived-lemma-universal-property-quotient}
...
Lemma \ref{derived-lemma-homological-functor-localize}.
...
consequence of
Lemma \ref{derived-lemma-universal-property-quotient}.
\end{proof}
...
\begin{lemma}[Adjoint is exact]
\label{derived-lemma-adjoint-is-exact}
\source{stacks:0A8D}
\href{https://stacks.math.columbia.edu/tag/0A8D}{\texttt{Stacks tag 0A8D}}
\group{derived}
...
\begin{proof}
\uses{derived-definition-exact-functor-triangulated-categories}

Let $\xi_X : F(X[1]) \to F(X)[1]$ be as in
Definition \ref{derived-definition-exact-functor-triangulated-categories}.
Let $\epsilon_A : F(G(A)) \to A$ be the adjunction map.
Consider the composition
$$
F(G(A)[1]) \xrightarrow{\xi_{G(A)}} F(G(A))[1] \xrightarrow{\epsilon_A[1]} A[1]
$$
This map is adjoint to a map $G(A)[1] \to G(A[1])$ which we claim to
be an isomorphism. To see this, by the Yoneda lemma it suffices to
show that we get a bijection on applying $\Mor_\mathcal{D}(X[1], -)$
for every object $X$ of $\mathcal{D}$.
Now, every morphism $f : X[1] \to G(A)[1]$ is of the form $g[1]$ for a unique
$g : X \to G(A)$ and every $g$ is adjoint to a unique
$h : F(X) \to A$ and in turn $h[1] \circ \xi_X$ is adjoint to a unique
$i : X[1] \to G(A[1])$. The rule sending $f$ to $i$ gives a bijection between
$\Mor_\mathcal{D}(X[1], G(A)[1])$ and $\Mor_\mathcal{D}(X[1], G(A[1]))$.
That this bijection is given by the morphism above follows from
the discussion in Categories, Section \ref{categories-section-adjoint}
...
h[1] \circ \xi_X
\end{align*}
Some details omitted. We will show that $G$ is an exact functor using the
inverse of the isomorphisms $G(A)[1] \to G(A[1])$. These isomorphisms
are functorial in $A$ (details omitted).
...
a morphism of distinguished triangles
$$
\begin{array}{cccc}F(G(A)) \longrightarrow\overset{\epsilon_A}{\downarrow} & F(G(B)) \longrightarrow\overset{\epsilon_B}{\downarrow} & F(X) \longrightarrow\downarrow & F(G(A))[1] \overset{\epsilon_A[1]}{\downarrow} \\ A \longrightarrow & B \longrightarrow & C \longrightarrow & A[1]\end{array}
$$
Recall that the arrow $F(X) \to F(G(A))[1]$ is the composition
of $F(X) \to F(G(A)[1])$ with $\xi_{G(A)}$. Hence using that
$G$ is the right adjoint of $F$ and our discussion above, we
conclude the existence of a morphism $X \to G(C)$
such that the diagram
$$
\begin{array}{cccc}G(A) \longrightarrow\downarrow & G(B) \longrightarrow\downarrow & X \longrightarrow\downarrow & G(A)[1] \downarrow \\ G(A) \longrightarrow & G(B) \longrightarrow & G(C) \longrightarrow & G(A[1])\end{array}
$$
commutes and the right vertical arrow is the morphism constructed above.
Applying the homological functor $\Hom_{\mathcal{D}'}(W, -)$
...
\begin{lemma}[Fully faithful adjoint kernel zero]
\label{derived-lemma-fully-faithful-adjoint-kernel-zero}
\source{stacks:09J1}
\href{https://stacks.math.columbia.edu/tag/09J1}{\texttt{Stacks tag 09J1}}
\group{derived}
...
\begin{definition}[Complexes notation]
\label{derived-definition-complexes-notation}
\source{stacks:013H}
\href{https://stacks.math.columbia.edu/tag/013H}{\texttt{Stacks tag 013H}}
\group{derived}
...
\source{stacks:014E}
\href{https://stacks.math.columbia.edu/tag/014E}{\texttt{Stacks tag 014E}}
\group{derived}
...
\begin{lemma}[Functorial cone]
\label{derived-lemma-functorial-cone}
\source{stacks:014F}
\href{https://stacks.math.columbia.edu/tag/014F}{\texttt{Stacks tag 014F}}
\group{derived}

Suppose that
$$
\begin{array}{cc}K_1^\bullet \underset{f_1}{\longrightarrow}\underset{a}{\downarrow} & L_1^\bullet \overset{b}{\downarrow} \\ K_2^\bullet \overset{f_2}{\longrightarrow} & L_2^\bullet\end{array}
$$
...
constructed in the
proof of Lemma \ref{derived-lemma-functorial-cone} in general depends on the
chosen homotopy $h$ between $f_2 \circ a$ and $b \circ f_1$.

\begin{lemma}[Map from cone]
\label{derived-lemma-map-from-cone}
\source{stacks:08RI}
\href{https://stacks.math.columbia.edu/tag/08RI}{\texttt{Stacks tag 08RI}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-functorial-cone}

The assumptions say that the diagram
$$
\begin{array}{cc}K^\bullet \underset{f}{\longrightarrow}\downarrow & L^\bullet \overset{g}{\downarrow} \\ 0 \longrightarrow & M^\bullet\end{array}
$$
commutes up to homotopy.
Since the cone on $0 \to M^\bullet$ is $M^\bullet$ the
map $C(f)^\bullet \to C(0 \to M^\bullet) = M^\bullet$
of Lemma \ref{derived-lemma-functorial-cone}
is the map in (1). The cone on $K^\bullet \to 0$ is
$K^\bullet[1]$ and applying Lemma \ref{derived-lemma-functorial-cone}
...
of Lemma \ref{derived-lemma-map-from-cone} in general depend on the
chosen homotopy.

\begin{definition}[Termwise split map]
\label{derived-definition-termwise-split-map}
\source{stacks:014G}
\href{https://stacks.math.columbia.edu/tag/014G}{\texttt{Stacks tag 014G}}
\group{derived}
...
\begin{lemma}[Make commute map]
\label{derived-lemma-make-commute-map}
\source{stacks:014H}
\href{https://stacks.math.columbia.edu/tag/014H}{\texttt{Stacks tag 014H}}
\group{derived}

Let $\mathcal{A}$ be an additive category.
Let
$$
\begin{array}{cc}A^\bullet \underset{f}{\longrightarrow}\underset{a}{\downarrow} & B^\bullet \overset{b}{\downarrow} \\ C^\bullet \overset{g}{\longrightarrow} & D^\bullet\end{array}
$$
...
\begin{lemma}[Make injective]
\label{derived-lemma-make-injective}
\source{stacks:013N}
\href{https://stacks.math.columbia.edu/tag/013N}{\texttt{Stacks tag 013N}}
\group{derived}

\uses{derived-definition-termwise-split-map}
Let $\mathcal{A}$ be an additive category.
Let $\alpha : K^\bullet \to L^\bullet$ be a morphism
of complexes of $\mathcal{A}$.
There exists a factorization
$$
\begin{array}{ccc}K^\bullet \overset{\tilde \alpha}{\longrightarrow}\underset{\alpha}{\longrightarrow} & \tilde L^\bullet \overset{\pi}{\longrightarrow} & L^\bullet\end{array}
$$
such that
\begin{enumerate}
\item $\tilde \alpha$ is a termwise split injection (see
Definition \ref{derived-definition-termwise-split-map}),
...
\begin{remark}[Compute modules]
\label{derived-remark-compute-modules}
\source{stacks:013O}
\href{https://stacks.math.columbia.edu/tag/013O}{\texttt{Stacks tag 013O}}
\group{derived}
...
\begin{lemma}[Make surjective]
\label{derived-lemma-make-surjective}
\source{stacks:0642}
\href{https://stacks.math.columbia.edu/tag/0642}{\texttt{Stacks tag 0642}}
\group{derived}
...
There exists a factorization
$$
\begin{array}{ccc}K^\bullet \overset{i}{\longrightarrow}\underset{\alpha}{\longrightarrow} & \tilde K^\bullet \overset{\tilde \alpha}{\longrightarrow} & L^\bullet\end{array}
$$
such that
\begin{enumerate}
...
\begin{proof}
\uses{derived-lemma-make-injective}

Dual to Lemma \ref{derived-lemma-make-injective}.
Take
$$
...
\begin{definition}[Split ses]
\label{derived-definition-split-ses}
\source{stacks:014I}
\href{https://stacks.math.columbia.edu/tag/014I}{\texttt{Stacks tag 014I}}
\group{derived}
...
\begin{lemma}[Triangle independent splittings]
\label{derived-lemma-triangle-independent-splittings}
\source{stacks:05SS}
\href{https://stacks.math.columbia.edu/tag/05SS}{\texttt{Stacks tag 05SS}}
\group{derived}

\uses{derived-definition-split-ses}
...
\begin{remark}[Make commute]
\label{derived-remark-make-commute}
\source{stacks:014J}
\href{https://stacks.math.columbia.edu/tag/014J}{\texttt{Stacks tag 014J}}
\group{derived}
...
such that
$$
\begin{array}{ccc}A_1^\bullet \underset{a}{\downarrow}\longrightarrow & B_1^\bullet \longrightarrow\underset{b}{\downarrow} & C_1^\bullet \underset{c}{\downarrow} \\ A_2^\bullet \longrightarrow & B_2^\bullet \longrightarrow & C_2^\bullet\end{array}
$$
...
\begin{lemma}[Nilpotent]
\label{derived-lemma-nilpotent}
\source{stacks:086L}
\href{https://stacks.math.columbia.edu/tag/086L}{\texttt{Stacks tag 086L}}
\group{derived}
...
$$
\vcenter{
\begin{array}{ccc}A_1^\bullet \underset{0}{\downarrow}\longrightarrow & B_1^\bullet \longrightarrow\underset{b}{\downarrow} & C_1^\bullet \underset{0}{\downarrow} \\ A_2^\bullet \longrightarrow & B_2^\bullet \longrightarrow & C_2^\bullet\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{ccc}A_2^\bullet \overset{0}{\downarrow}\longrightarrow & B_2^\bullet \longrightarrow\overset{b'}{\downarrow} & C_2^\bullet \overset{0}{\downarrow} \\ A_3^\bullet \longrightarrow & B_3^\bullet \longrightarrow & C_3^\bullet\end{array}
}
$$
...
\begin{proof}
\uses{derived-lemma-make-commute-map}

By Lemma \ref{derived-lemma-make-commute-map} we can replace $b$ and $b'$ by homotopic
...
\begin{lemma}[Third isomorphism]
\label{derived-lemma-third-isomorphism}
\source{stacks:014K}
\href{https://stacks.math.columbia.edu/tag/014K}{\texttt{Stacks tag 014K}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-functorial-cone, derived-lemma-nilpotent}
...
be the morphism from Lemma \ref{derived-lemma-functorial-cone} applied
...
$$
\begin{array}{ccc}L^\bullet \longrightarrow\underset{1}{\downarrow} & C(f)^\bullet \longrightarrow\underset{c}{\downarrow} & K^\bullet[1] \underset{1}{\downarrow} \\ L^\bullet \longrightarrow & C(f)^\bullet \longrightarrow & K^\bullet[1]\end{array}
$$
commute up to homotopy. By construction of $C(f)^\bullet$ the rows
form termwise split sequences of complexes. Thus we see that
$(c - 1)^2 = 0$ in $K(\mathcal{A})$ by Lemma \ref{derived-lemma-nilpotent}.
...
\begin{lemma}[The same up to isomorphisms]
\label{derived-lemma-the-same-up-to-isomorphisms}
\source{stacks:014L}
\href{https://stacks.math.columbia.edu/tag/014L}{\texttt{Stacks tag 014L}}
\group{derived}
...
such that the diagram
$$
\begin{array}{cccc}A^\bullet \longrightarrow\downarrow & B^\bullet \downarrow\longrightarrow & C(\alpha)^\bullet \underset{-p}{\longrightarrow}\downarrow & A^\bullet[1] \downarrow \\ A^\bullet \longrightarrow & B^\bullet \longrightarrow & C^\bullet \overset{\delta}{\longrightarrow} & A^\bullet[1]\end{array}
$$
defines an isomorphism of triangles in $K(\mathcal{A})$.
\item Given a morphism of complexes $f : K^\bullet \to L^\bullet$
there exists an isomorphism of triangles
$$
\begin{array}{cccc}K^\bullet \longrightarrow\downarrow & \tilde L^\bullet \downarrow\longrightarrow & M^\bullet \underset{\delta}{\longrightarrow}\downarrow & K^\bullet[1] \downarrow \\ K^\bullet \longrightarrow & L^\bullet \longrightarrow & C(f)^\bullet \overset{-p}{\longrightarrow} & K^\bullet[1]\end{array}
$$
...
\begin{proof}
\uses{derived-definition-cone, derived-lemma-make-injective, derived-lemma-functorial-cone, derived-lemma-third-isomorphism}
...
Definition \ref{derived-definition-cone})
...
Lemma \ref{derived-lemma-make-injective}. By
Lemmas \ref{derived-lemma-functorial-cone} and \ref{derived-lemma-third-isomorphism}
...
\begin{lemma}[Sequence maps split]
\label{derived-lemma-sequence-maps-split}
\source{stacks:014M}
\href{https://stacks.math.columbia.edu/tag/014M}{\texttt{Stacks tag 014M}}
\group{derived}
...
$$
\begin{array}{cccc}A_1^\bullet \longrightarrow & A_2^\bullet \longrightarrow & \ldots \longrightarrow & A_n^\bullet \\ B_1^\bullet \longrightarrow\uparrow & B_2^\bullet \longrightarrow\uparrow & \ldots \longrightarrow & B_n^\bullet \uparrow\end{array}
$$
...
Lemma \ref{derived-lemma-make-injective} is the case $n = 2$.
Suppose we have constructed the diagram
except for $B_n^\bullet$. Apply Lemma \ref{derived-lemma-make-injective} to
...
\begin{lemma}[Rotate triangle]
\label{derived-lemma-rotate-triangle}
\source{stacks:014N}
\href{https://stacks.math.columbia.edu/tag/014N}{\texttt{Stacks tag 014N}}
\group{derived}
...
\begin{lemma}[Rotate cone]
\label{derived-lemma-rotate-cone}
\source{stacks:014O}
\href{https://stacks.math.columbia.edu/tag/014O}{\texttt{Stacks tag 014O}}
\group{derived}
...
\begin{definition}[Distinguished triangle]
\label{derived-definition-distinguished-triangle}
\source{stacks:014Q}
\href{https://stacks.math.columbia.edu/tag/014Q}{\texttt{Stacks tag 014Q}}
\group{derived}
...
\begin{proposition}[Homotopy category triangulated]
\label{derived-proposition-homotopy-category-triangulated}
\source{stacks:014S}
\href{https://stacks.math.columbia.edu/tag/014S}{\texttt{Stacks tag 014S}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-the-same-up-to-isomorphisms, derived-lemma-rotate-triangle, derived-lemma-rotate-cone, derived-lemma-functorial-cone, derived-lemma-easier-axiom-four, derived-lemma-sequence-maps-split, derived-lemma-two-split-injections}
...
Lemma \ref{derived-lemma-the-same-up-to-isomorphisms}.
...
$(C^\bullet[-1], A^\bullet, B^\bullet, -\delta[-1], \alpha, \beta)$.
It follows from Lemma \ref{derived-lemma-rotate-triangle} that the triangle
$(C^\bullet[-1], A^\bullet, B^\bullet, \delta[-1], \alpha, \beta)$
is isomorphic to
$(C^\bullet[-1], A^\bullet, C(\delta[-1])^\bullet, \delta[-1], i, p)$.
...
By Lemma \ref{derived-lemma-the-same-up-to-isomorphisms} this means that it is
...
By Lemma \ref{derived-lemma-rotate-cone} this triangle is distinguished.
...
Lemma \ref{derived-lemma-the-same-up-to-isomorphisms} we may assume that
$(X, Y, Z, f, g, h) = (X, Y, C(f), f, i, -p)$ and
$(X', Y', Z', f', g', h') = (X', Y', C(f'), f', i', -p')$.
At this point we simply apply Lemma \ref{derived-lemma-functorial-cone}
...
Lemma \ref{derived-lemma-easier-axiom-four}. Let $A^\bullet \to B^\bullet$
and $B^\bullet \to C^\bullet$ be composable morphisms of
$K(\mathcal{A})$. By Lemma \ref{derived-lemma-sequence-maps-split} we may assume that
$A^\bullet \to B^\bullet$ and $B^\bullet \to C^\bullet$
are split injective morphisms. In this case the result follows
from Lemma \ref{derived-lemma-two-split-injections}.
\end{proof}

\begin{remark}[Boundedness conditions triangulated]
\label{derived-remark-boundedness-conditions-triangulated}
\source{stacks:05RP}
\href{https://stacks.math.columbia.edu/tag/05RP}{\texttt{Stacks tag 05RP}}
\group{derived}

\uses{derived-proposition-homotopy-category-triangulated}
Let $\mathcal{A}$ be an additive category.
...
\begin{lemma}[Bounded triangulated subcategories]
\label{derived-lemma-bounded-triangulated-subcategories}
\source{stacks:05RQ}
\href{https://stacks.math.columbia.edu/tag/05RQ}{\texttt{Stacks tag 05RQ}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-triangulated-subcategory, derived-lemma-make-injective}
...
$K^b(\mathcal{A})$, see
Lemma \ref{derived-lemma-make-injective}
and then one can directly take the associated
distinguished triangle.)
\end{proof}

\begin{lemma}[Additive exact homotopy category]
\label{derived-lemma-additive-exact-homotopy-category}
\source{stacks:014X}
\href{https://stacks.math.columbia.edu/tag/014X}{\texttt{Stacks tag 014X}}
\group{derived}
...
see Definition \ref{derived-definition-split-ses}. Then
...
\begin{lemma}[Improve distinguished triangle homotopy]
\label{derived-lemma-improve-distinguished-triangle-homotopy}
\source{stacks:0G6C}
\href{https://stacks.math.columbia.edu/tag/0G6C}{\texttt{Stacks tag 0G6C}}
\group{derived}
...
\begin{proof}
\uses{derived-proposition-homotopy-category-triangulated, derived-lemma-the-same-up-to-isomorphisms, derived-lemma-third-isomorphism-triangle}
...
by Lemma \ref{derived-lemma-the-same-up-to-isomorphisms}. Rotating backwards twice
...
which must be an isomorphism by Lemma \ref{derived-lemma-third-isomorphism-triangle}.
...
by the very construction of cones in Section \ref{derived-section-cones}.
\end{proof}

\begin{remark}[Homotopy double]
\label{derived-remark-homotopy-double}
\source{stacks:0G6D}
\href{https://stacks.math.columbia.edu/tag/0G6D}{\texttt{Stacks tag 0G6D}}
\group{derived}
...
\begin{remark}[Double complex as tensor product of]
\label{derived-remark-double-complex-as-tensor-product-of}
\source{stacks:0G6E}
\href{https://stacks.math.columbia.edu/tag/0G6E}{\texttt{Stacks tag 0G6E}}
\group{derived}

\uses{derived-remark-homotopy-double}
...
is an exact functor of triangulated categories.
\end{enumerate}
This follows from Remark \ref{derived-remark-homotopy-double} since
the functors
...
\begin{lemma}[Cohomology homological]
\label{derived-lemma-cohomology-homological}
\source{stacks:05RS}
\href{https://stacks.math.columbia.edu/tag/05RS}{\texttt{Stacks tag 05RS}}
\group{derived}
...
\begin{array}{cccccc}\ldots \longrightarrow & H^i(X) \overset{H^i(f)}{\longrightarrow} & H^i(Y) \overset{H^i(g)}{\longrightarrow} & H^i(Z) \overset{H^i(h)}{\longrightarrow} & H^{i + 1}(X) \longrightarrow & \ldots\end{array}
\end{equation}
...
\source{stacks:05RT}
\href{https://stacks.math.columbia.edu/tag/05RT}{\texttt{Stacks tag 05RT}}
\group{derived}

\uses{derived-lemma-operations}
...
\begin{proof}
\uses{derived-lemma-cohomology-homological, derived-lemma-acyclic-general}

We know that $H^0$ is a homological functor by
Lemma \ref{derived-lemma-cohomology-homological}.
Thus this lemma is a special case of
Lemma \ref{derived-lemma-acyclic-general}.
\end{proof}

\begin{definition}[Unbounded derived category]
\label{derived-definition-unbounded-derived-category}
\source{stacks:05RU}
\href{https://stacks.math.columbia.edu/tag/05RU}{\texttt{Stacks tag 05RU}}
\group{derived}

\uses{derived-lemma-acyclic, derived-lemma-homological-functor-bounded}
Let $\mathcal{A}$ be an abelian category.
Let $\text{Ac}(\mathcal{A})$ and $\text{Qis}(\mathcal{A})$
be as in
Lemma \ref{derived-lemma-acyclic}.
...
Lemma \ref{derived-lemma-homological-functor-bounded}
...
\begin{remark}[Existence derived]
\label{derived-remark-existence-derived}
\source{stacks:09PA}
\href{https://stacks.math.columbia.edu/tag/09PA}{\texttt{Stacks tag 09PA}}
\group{derived}

\uses{derived-lemma-K-injective}
...
K-injective complex $I^\bullet$ and Lemma \ref{derived-lemma-K-injective} shows that
$$
...
\begin{lemma}[Complex cohomology bounded]
\label{derived-lemma-complex-cohomology-bounded}
\source{stacks:05RV}
\href{https://stacks.math.columbia.edu/tag/05RV}{\texttt{Stacks tag 05RV}}
\group{derived}
...
$$
\begin{array}{cc}K^\bullet \longrightarrow & L^\bullet \\ M^\bullet \uparrow\longrightarrow & N^\bullet \uparrow\end{array}
$$
...
\begin{lemma}[Bounded derived]
\label{derived-lemma-bounded-derived}
\source{stacks:05RW}
\href{https://stacks.math.columbia.edu/tag/05RW}{\texttt{Stacks tag 05RW}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-acyclic-general, derived-lemma-complex-cohomology-bounded}
...
Lemma \ref{derived-lemma-complex-cohomology-bounded}.
...
\begin{lemma}[Derived canonical delta functor]
\label{derived-lemma-derived-canonical-delta-functor}
\source{stacks:0152}
\href{https://stacks.math.columbia.edu/tag/0152}{\texttt{Stacks tag 0152}}
\group{derived}
...
\begin{proof}
\uses{derived-definition-delta-functor, derived-lemma-functorial-cone}
...
$$
\begin{array}{ccccc}0 \longrightarrow & A^\bullet \underset{a}{\longrightarrow}\underset{f}{\downarrow} & B^\bullet \underset{b}{\longrightarrow}\underset{g}{\downarrow} & C^\bullet \longrightarrow\underset{h}{\downarrow} & 0 \\ 0 \longrightarrow & (A')^\bullet \overset{a'}{\longrightarrow} & (B')^\bullet \overset{b'}{\longrightarrow} & (C')^\bullet \longrightarrow & 0\end{array}
$$
we get the desired commutative diagram of
Definition \ref{derived-definition-delta-functor} (2).
By Lemma \ref{derived-lemma-functorial-cone}
...
\begin{lemma}[Derived compare triangles ses]
\label{derived-lemma-derived-compare-triangles-ses}
\source{stacks:0153}
\href{https://stacks.math.columbia.edu/tag/0153}{\texttt{Stacks tag 0153}}
\group{derived}

\uses{derived-lemma-derived-canonical-delta-functor}
Let $\mathcal{A}$ be an abelian category.
Let
$$
\begin{array}{ccccc}0 \longrightarrow & A^\bullet \longrightarrow\downarrow & B^\bullet \longrightarrow\downarrow & C^\bullet \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & D^\bullet \longrightarrow & E^\bullet \longrightarrow & F^\bullet \longrightarrow & 0\end{array}
$$
...
\begin{lemma}[Derived compare triangles split case]
\label{derived-lemma-derived-compare-triangles-split-case}
\source{stacks:0154}
\href{https://stacks.math.columbia.edu/tag/0154}{\texttt{Stacks tag 0154}}
\group{derived}

\uses{derived-lemma-derived-canonical-delta-functor}
Let $\mathcal{A}$ be an abelian category. Let
$$
\begin{array}{ccccc}0 \longrightarrow & A^\bullet \longrightarrow & B^\bullet \longrightarrow & C^\bullet \longrightarrow & 0\end{array}
$$
...
\begin{proof}
\uses{derived-lemma-the-same-up-to-isomorphisms}

Follows from
Lemma \ref{derived-lemma-the-same-up-to-isomorphisms}.
\end{proof}

\begin{remark}[Truncation distinguished triangle]
\label{derived-remark-truncation-distinguished-triangle}
\source{stacks:08J5}
\href{https://stacks.math.columbia.edu/tag/08J5}{\texttt{Stacks tag 08J5}}
\group{derived}
...
\begin{lemma}[Trick vanishing composition]
\label{derived-lemma-trick-vanishing-composition}
\source{stacks:08Q2}
\href{https://stacks.math.columbia.edu/tag/08Q2}{\texttt{Stacks tag 08Q2}}
\group{derived}
...
\begin{proof}
\uses{derived-remark-truncation-distinguished-triangle, derived-lemma-representable-homological}
...
$$
(Remark \ref{derived-remark-truncation-distinguished-triangle}).
...
is a homological functor (Lemma \ref{derived-lemma-representable-homological}),
...
Lemma \ref{derived-lemma-two-ss-complex-functor}, see also
Remark \ref{derived-remark-functorial-ss}.
...
\begin{definition}[Finite filtered]
\label{derived-definition-finite-filtered}
\source{stacks:05RY}
\href{https://stacks.math.columbia.edu/tag/05RY}{\texttt{Stacks tag 05RY}}
\group{derived}
...
$$
by
Lemma \ref{derived-lemma-additive-exact-homotopy-category}.
By analogy with the case of the homotopy category of an abelian category
we make the following definitions.

\begin{definition}[Filtered acyclic]
\label{derived-definition-filtered-acyclic}
\source{stacks:05RZ}
\href{https://stacks.math.columbia.edu/tag/05RZ}{\texttt{Stacks tag 05RZ}}
\group{derived}
...
\begin{lemma}[Filtered cohomology homological]
\label{derived-lemma-filtered-cohomology-homological}
\source{stacks:05S0}
\href{https://stacks.math.columbia.edu/tag/05S0}{\texttt{Stacks tag 05S0}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-cohomology-homological, derived-lemma-exact-compose-homological-functor}
...
Lemma \ref{derived-lemma-exact-compose-homological-functor}.
\end{proof}

\begin{lemma}[Filtered acyclic]
\label{derived-lemma-filtered-acyclic}
\source{stacks:05S1}
\href{https://stacks.math.columbia.edu/tag/05S1}{\texttt{Stacks tag 05S1}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-filtered-cohomology-homological, derived-lemma-acyclic-general}

We know that $H^0 \circ \text{gr}$ is a homological functor by
Lemma \ref{derived-lemma-filtered-cohomology-homological}.
Thus this lemma is a special case of
Lemma \ref{derived-lemma-acyclic-general}.
\end{proof}

\begin{definition}[Filtered derived]
\label{derived-definition-filtered-derived}
\source{stacks:05S2}
\href{https://stacks.math.columbia.edu/tag/05S2}{\texttt{Stacks tag 05S2}}
\group{derived}

\uses{derived-lemma-filtered-acyclic}
Let $\mathcal{A}$ be an abelian category.
Let $\text{FAc}(\mathcal{A})$ and $\text{FQis}(\mathcal{A})$
be as in
Lemma \ref{derived-lemma-filtered-acyclic}.
...
\begin{lemma}[Filtered derived functors]
\label{derived-lemma-filtered-derived-functors}
\source{stacks:05S3}
\href{https://stacks.math.columbia.edu/tag/05S3}{\texttt{Stacks tag 05S3}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-universal-property-localization, derived-lemma-filtered-acyclic}
...
\begin{definition}[Filtered derived bounded]
\label{derived-definition-filtered-derived-bounded}
\source{stacks:05S4}
\href{https://stacks.math.columbia.edu/tag/05S4}{\texttt{Stacks tag 05S4}}
\group{derived}
...
\begin{lemma}[Filtered complex cohomology bounded]
\label{derived-lemma-filtered-complex-cohomology-bounded}
\source{stacks:05S5}
\href{https://stacks.math.columbia.edu/tag/05S5}{\texttt{Stacks tag 05S5}}
\group{derived}
...
\begin{lemma}[Filtered bounded derived]
\label{derived-lemma-filtered-bounded-derived}
\source{stacks:05S6}
\href{https://stacks.math.columbia.edu/tag/05S6}{\texttt{Stacks tag 05S6}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-filtered-complex-cohomology-bounded, derived-lemma-bounded-derived}

This follows from the results above, in particular
Lemma \ref{derived-lemma-filtered-complex-cohomology-bounded},
by exactly the same arguments as used in the proof of
Lemma \ref{derived-lemma-bounded-derived}.
\end{proof}
...
\begin{definition}[Situation: Derived functor]
\label{derived-situation-derived-functor}
\source{stacks:05S8}
\href{https://stacks.math.columbia.edu/tag/05S8}{\texttt{Stacks tag 05S8}}
\group{derived}
...
\begin{definition}[Right derived functor defined]
\label{derived-definition-right-derived-functor-defined}
\source{stacks:05S9}
\href{https://stacks.math.columbia.edu/tag/05S9}{\texttt{Stacks tag 05S9}}
\group{derived}

\uses{derived-situation-derived-functor}
Assumptions and notation as in
Situation \ref{derived-situation-derived-functor}.
...
\begin{lemma}[Derived functor]
\label{derived-lemma-derived-functor}
\source{stacks:05SA}
\href{https://stacks.math.columbia.edu/tag/05SA}{\texttt{Stacks tag 05SA}}
\group{derived}
...
$$
\begin{array}{cc}X \underset{f}{\downarrow}\underset{s}{\longrightarrow} & X' \overset{f'}{\downarrow} \\ Y \overset{s'}{\longrightarrow} & Y'\end{array}
$$
with $s, s' \in S$ the diagram
$$
\begin{array}{ccc}F(X) \downarrow\longrightarrow & F(X') \downarrow\longrightarrow & RF(X) \downarrow \\ F(Y) \longrightarrow & F(Y') \longrightarrow & RF(Y)\end{array}
$$
commutes.
...
with $s, s'$ in $S$ the diagram
$$
\begin{array}{ccc}LF(X) \downarrow\longrightarrow & F(X') \downarrow\longrightarrow & F(X) \downarrow \\ LF(Y) \longrightarrow & F(Y') \longrightarrow & F(Y)\end{array}
$$
commutes.
\end{enumerate}
\end{lemma}
...
\begin{lemma}[Derived inverts]
\label{derived-lemma-derived-inverts}
\source{stacks:05SB}
\href{https://stacks.math.columbia.edu/tag/05SB}{\texttt{Stacks tag 05SB}}
\group{derived}
...
\begin{lemma}[Derived functors are compatible with shifts]
\label{derived-lemma-derived-shift}
\source{stacks:05SU}
\href{https://stacks.math.columbia.edu/tag/05SU}{\texttt{Stacks tag 05SU}}
\group{derived}
...
\begin{lemma}[2 out of 3 defined]
\label{derived-lemma-2-out-of-3-defined}
\source{stacks:05SC}
\href{https://stacks.math.columbia.edu/tag/05SC}{\texttt{Stacks tag 05SC}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-derived-functor, derived-lemma-derived-inverts, derived-lemma-limit-triangles}

Say $RF$ is defined at $X, Y$ with values $A, B$.
Let $RF(f) : A \to B$ be the induced morphism, see
Lemma \ref{derived-lemma-derived-functor}.
...
Picture
$$
\begin{array}{ccc}A \underset{RF(f)}{\downarrow}\underset{\alpha}{\longrightarrow} & F(X') \longrightarrow\overset{F(f')}{\downarrow} & A \overset{RF(f)}{\downarrow} \\ B \overset{\beta}{\longrightarrow} & F(Y') \longrightarrow & B\end{array}
$$
...
\medskip\noindent
By Lemma \ref{derived-lemma-derived-inverts} it suffices to prove that $RF(Z')$
...
Lemma \ref{derived-lemma-limit-triangles}
of triangles
$$
\mathcal{I} =
...
(cofinality is proven in Lemma \ref{derived-lemma-limit-triangles}).
For any object $W$ in $\mathcal{D}'$ we
consider the diagram
$$
\begin{array}{cc}\colim_\mathcal{I} \Mor_{\mathcal{D}'}(W, F(X'')) \downarrow & \Mor_{\mathcal{D}'}(W, A) \longleftarrow\downarrow \\ \colim_\mathcal{I} \Mor_{\mathcal{D}'}(W, F(Y'')) \downarrow & \Mor_{\mathcal{D}'}(W, B) \downarrow\longleftarrow \\ \colim_\mathcal{I} \Mor_{\mathcal{D}'}(W, F(Z'')) \downarrow & \Mor_{\mathcal{D}'}(W, C) \downarrow\longleftarrow \\ \colim_\mathcal{I} \Mor_{\mathcal{D}'}(W, F(X''[1])) \downarrow & \Mor_{\mathcal{D}'}(W, A[1]) \downarrow\longleftarrow \\ \colim_\mathcal{I} \Mor_{\mathcal{D}'}(W, F(Y''[1])) & \Mor_{\mathcal{D}'}(W, B[1]) \longleftarrow\end{array}
$$
...
\begin{lemma}[Direct sum defined]
\label{derived-lemma-direct-sum-defined}
\source{stacks:05SD}
\href{https://stacks.math.columbia.edu/tag/05SD}{\texttt{Stacks tag 05SD}}
\group{derived}

\uses{derived-situation-derived-functor}
Assumptions and notation as in Situation \ref{derived-situation-derived-functor}.
...
\begin{proof}
\uses{derived-lemma-split, derived-lemma-2-out-of-3-defined}

If $RF$ is defined at $X$ and $Y$, then the distinguished triangle
$X \to X \oplus Y \to Y \to X[1]$ (Lemma \ref{derived-lemma-split}) and
Lemma \ref{derived-lemma-2-out-of-3-defined}
shows that $RF$ is defined at $X \oplus Y$ and that we
have a distinguished triangle
$RF(X) \to RF(X \oplus Y) \to RF(Y) \to RF(X)[1]$.
Applying Lemma \ref{derived-lemma-split} to this once more we find
...
$$
\begin{array}{ccc}X \overset{s}{\downarrow} & X \oplus Y \downarrow\longleftarrow\longrightarrow & Y \underset{s'}{\downarrow} \\ X' & Z \longleftarrow\longrightarrow & Y'\end{array}
$$
...
\begin{proposition}[Derived functor]
\label{derived-proposition-derived-functor}
\source{stacks:05SE}
\href{https://stacks.math.columbia.edu/tag/05SE}{\texttt{Stacks tag 05SE}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-derived-inverts, derived-lemma-2-out-of-3-defined, derived-lemma-derived-shift, derived-lemma-derived-functor, derived-proposition-construct-localization, derived-lemma-universal-property-localization, derived-lemma-direct-sum-defined}

Since $S$ is saturated it contains all isomorphisms (see remark
following Categories, Definition
\ref{categories-definition-saturated-multiplicative-system}).
Hence (1) follows from Lemmas \ref{derived-lemma-derived-inverts},
\ref{derived-lemma-2-out-of-3-defined}, and \ref{derived-lemma-derived-shift}.
We get (2) from Lemmas \ref{derived-lemma-derived-functor}, \ref{derived-lemma-derived-shift},
and \ref{derived-lemma-2-out-of-3-defined}.
We get (3) from Lemma \ref{derived-lemma-derived-inverts}.
Part (4) follows from Lemma \ref{derived-lemma-derived-inverts}.
...
follows from Lemma \ref{derived-lemma-universal-property-localization}.
Finally, part (8) follows from Lemma \ref{derived-lemma-direct-sum-defined}.
\end{proof}

Proposition \ref{derived-proposition-derived-functor}
...
$$
\begin{array}{cccc}\mathcal{D} \underset{Q}{\downarrow}\underset{F}{\longrightarrow} &  &  & \mathcal{D}' \\ S^{-1}\mathcal{D} &  & S_\mathcal{E}^{-1}\mathcal{E}
\overset{\text{exact}}{\underset{\text{fully faithful}}{\longleftarrow}}\underset{RF}{\nearrow} & \end{array}
$$

\begin{definition}[Everywhere defined]
\label{derived-definition-everywhere-defined}
\source{stacks:05SV}
\href{https://stacks.math.columbia.edu/tag/05SV}{\texttt{Stacks tag 05SV}}
\group{derived}
...
\source{stacks:05SX}
\href{https://stacks.math.columbia.edu/tag/05SX}{\texttt{Stacks tag 05SX}}
\group{derived}
...
\begin{lemma}[Computes shift]
\label{derived-lemma-computes-shift}
\source{stacks:05SY}
\href{https://stacks.math.columbia.edu/tag/05SY}{\texttt{Stacks tag 05SY}}
\group{derived}
...
\begin{lemma}[2 out of 3 computes]
\label{derived-lemma-2-out-of-3-computes}
\source{stacks:05SZ}
\href{https://stacks.math.columbia.edu/tag/05SZ}{\texttt{Stacks tag 05SZ}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-2-out-of-3-defined}
...
$$
\begin{array}{c}(F(X), F(Y), F(Z), F(f), F(g), F(h)) \downarrow \\ (RF(X), RF(Y), RF(Z), RF(f), RF(g), RF(h))\end{array}
$$
Two out of three maps are isomorphisms, hence so is the third.
\end{proof}

\begin{lemma}[Direct sum computes]
\label{derived-lemma-direct-sum-computes}
\source{stacks:05T0}
\href{https://stacks.math.columbia.edu/tag/05T0}{\texttt{Stacks tag 05T0}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-direct-sum-defined}

If $X \oplus Y$ computes $RF$, then $RF(X \oplus Y) = F(X) \oplus F(Y)$.
In the proof of Lemma \ref{derived-lemma-direct-sum-defined} we have seen that
...
\begin{lemma}[Existence computes]
\label{derived-lemma-existence-computes}
\source{stacks:05T1}
\href{https://stacks.math.columbia.edu/tag/05T1}{\texttt{Stacks tag 05T1}}
\group{derived}
...
\begin{lemma}[Find existence computes]
\label{derived-lemma-find-existence-computes}
\source{stacks:06XN}
\href{https://stacks.math.columbia.edu/tag/06XN}{\texttt{Stacks tag 06XN}}
\group{derived}
...
\begin{lemma}[Compose derived functors general]
\label{derived-lemma-compose-derived-functors-general}
\source{stacks:05T2}
\href{https://stacks.math.columbia.edu/tag/05T2}{\texttt{Stacks tag 05T2}}
\group{derived}
...
\begin{definition}[Situation: Classical]
\label{derived-situation-classical}
\source{stacks:05T4}
\href{https://stacks.math.columbia.edu/tag/05T4}{\texttt{Stacks tag 05T4}}
\group{derived}

\uses{derived-lemma-additive-exact-homotopy-category, derived-situation-derived-functor}
...
$$
See Lemma \ref{derived-lemma-additive-exact-homotopy-category}.
...
\begin{lemma}[Irrelevant]
\label{derived-lemma-irrelevant}
\source{stacks:05T5}
\href{https://stacks.math.columbia.edu/tag/05T5}{\texttt{Stacks tag 05T5}}
\group{derived}

\uses{derived-situation-classical}
In
Situation \ref{derived-situation-classical}.
\begin{enumerate}
...
\begin{proof}
\uses{derived-lemma-complex-cohomology-bounded}
...
\source{stacks:0157}
\href{https://stacks.math.columbia.edu/tag/0157}{\texttt{Stacks tag 0157}}
\group{derived}
...
\begin{lemma}[Subcategory left resolution]
\label{derived-lemma-subcategory-left-resolution}
\source{stacks:05T7}
\href{https://stacks.math.columbia.edu/tag/05T7}{\texttt{Stacks tag 05T7}}
\group{derived}
...
$$
\begin{array}{cccccc} &  & P^n \overset{\alpha}{\downarrow}\longrightarrow & P^{n + 1} \overset{\alpha}{\downarrow}\longrightarrow & P^{n + 2} \overset{\alpha}{\downarrow}\longrightarrow & \ldots \\ \ldots \longrightarrow & K^{n - 1} \longrightarrow & K^n \longrightarrow & K^{n + 1} \longrightarrow & K^{n + 2} \longrightarrow & \ldots\end{array}
$$
...
above to
$$
\begin{array}{cccccc} & P^{n - 1} \overset{\alpha}{\downarrow}\longrightarrow & P^n \overset{\alpha}{\downarrow}\longrightarrow & P^{n + 1} \overset{\alpha}{\downarrow}\longrightarrow & P^{n + 2} \overset{\alpha}{\downarrow}\longrightarrow & \ldots \\ \ldots \longrightarrow & K^{n - 1} \longrightarrow & K^n \longrightarrow & K^{n + 1} \longrightarrow & K^{n + 2} \longrightarrow & \ldots\end{array}
$$
...
\begin{lemma}[Subcategory right resolution]
\label{derived-lemma-subcategory-right-resolution}
\source{stacks:05T6}
\href{https://stacks.math.columbia.edu/tag/05T6}{\texttt{Stacks tag 05T6}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-subcategory-left-resolution}

This lemma is dual to Lemma \ref{derived-lemma-subcategory-left-resolution}.
\end{proof}

\begin{lemma}[Subcategory right acyclics]
\label{derived-lemma-subcategory-right-acyclics}
\source{stacks:05T8}
\href{https://stacks.math.columbia.edu/tag/05T8}{\texttt{Stacks tag 05T8}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-subcategory-right-resolution}
...
Lemma \ref{derived-lemma-subcategory-right-resolution}\footnote{By (1)
...
\begin{lemma}[Subcategory left acyclics]
\label{derived-lemma-subcategory-left-acyclics}
\source{stacks:05T9}
\href{https://stacks.math.columbia.edu/tag/05T9}{\texttt{Stacks tag 05T9}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-subcategory-right-acyclics}

Dual to the proof of
Lemma \ref{derived-lemma-subcategory-right-acyclics}.
\end{proof}
...
\begin{lemma}[Negative vanishing]
\label{derived-lemma-negative-vanishing}
\source{stacks:05TC}
\href{https://stacks.math.columbia.edu/tag/05TC}{\texttt{Stacks tag 05TC}}
\group{derived}
...
\begin{proof}
\uses{derived-remark-truncation-distinguished-triangle, derived-lemma-2-out-of-3-defined}
...
$$
of Remark \ref{derived-remark-truncation-distinguished-triangle} to conclude
via Lemma \ref{derived-lemma-2-out-of-3-defined} that
...
\begin{definition}[Higher derived functors]
\label{derived-definition-higher-derived-functors}
\source{stacks:015A}
\href{https://stacks.math.columbia.edu/tag/015A}{\texttt{Stacks tag 015A}}
\group{derived}
...
\begin{lemma}[Left exact higher derived]
\label{derived-lemma-left-exact-higher-derived}
\source{stacks:05TD}
\href{https://stacks.math.columbia.edu/tag/05TD}{\texttt{Stacks tag 05TD}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-negative-vanishing, derived-lemma-derived-canonical-delta-functor}

Let $A$ be an object of $\mathcal{A}$. By Lemma \ref{derived-lemma-negative-vanishing}
...
\begin{lemma}[F acyclic]
\label{derived-lemma-F-acyclic}
\source{stacks:015C}
\href{https://stacks.math.columbia.edu/tag/015C}{\texttt{Stacks tag 015C}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-left-exact-higher-derived}
...
Lemma \ref{derived-lemma-left-exact-higher-derived} part (1)
and hence $A$ is acyclic. If $F$ is left exact then $F = R^0F$, see
Lemma \ref{derived-lemma-left-exact-higher-derived}.
\end{proof}

\begin{lemma}[F acyclic ses]
\label{derived-lemma-F-acyclic-ses}
\source{stacks:015D}
\href{https://stacks.math.columbia.edu/tag/015D}{\texttt{Stacks tag 015D}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-derived-canonical-delta-functor, derived-lemma-left-exact-higher-derived, derived-lemma-F-acyclic}
...
Lemma \ref{derived-lemma-F-acyclic}.
\end{proof}

\begin{lemma}[Right derived delta functor]
\label{derived-lemma-right-derived-delta-functor}
\source{stacks:05TE}
\href{https://stacks.math.columbia.edu/tag/05TE}{\texttt{Stacks tag 05TE}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-derived-canonical-delta-functor, derived-definition-unbounded-derived-category, derived-lemma-compose-delta-functor-homological, derived-lemma-exact-compose-delta-functor, derived-lemma-F-acyclic}
...
Lemma \ref{derived-lemma-compose-delta-functor-homological}
and
Lemma \ref{derived-lemma-exact-compose-delta-functor}.
Part (2) follows from
...
\source{stacks:015E}
\href{https://stacks.math.columbia.edu/tag/015E}{\texttt{Stacks tag 015E}}
\group{derived}
...
\begin{proof}
\uses{derived-definition-derived-functor, derived-lemma-2-out-of-3-computes, derived-lemma-2-out-of-3-defined, derived-lemma-negative-vanishing}
...
object by Definition \ref{derived-definition-derived-functor}.
Next, suppose that
...
by Lemma \ref{derived-lemma-2-out-of-3-computes}.
...
$$
See Lemma \ref{derived-lemma-2-out-of-3-defined}.
Using these distinguished triangles we obtain a map of exact sequences
$$
\begin{array}{cccc}H^i(\sigma_{\geq i + 2} F(A^\bullet)) \longrightarrow\downarrow & H^i(F(A^\bullet)) \longrightarrow\overset{\alpha}{\downarrow} & H^i(\sigma_{\leq i + 1} F(A^\bullet)) \longrightarrow\overset{\beta}{\downarrow} & H^{i + 1}(\sigma_{\geq i + 2} F(A^\bullet)) \downarrow \\ H^i(RF(\sigma_{\geq i + 2} A^\bullet)) \longrightarrow & H^i(RF(A^\bullet)) \longrightarrow & H^i(RF(\sigma_{\leq i + 1} A^\bullet)) \longrightarrow & H^{i + 1}(RF(\sigma_{\geq i + 2} A^\bullet))\end{array}
$$
...
Lemma \ref{derived-lemma-negative-vanishing}.
\end{proof}

\begin{proposition}[A functor on Abelian categories is extended to the (bounded below or above) derived cat...]
\label{derived-proposition-enough-acyclics}
\source{stacks:05TA}
\href{https://stacks.math.columbia.edu/tag/05TA}{\texttt{Stacks tag 05TA}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-subcategory-right-resolution, derived-lemma-find-existence-computes, derived-lemma-derived-canonical-delta-functor, derived-lemma-2-out-of-3-computes, derived-proposition-derived-functor}
...
Lemma \ref{derived-lemma-subcategory-right-resolution}
...
Lemma \ref{derived-lemma-find-existence-computes}.
...
then Lemma \ref{derived-lemma-2-out-of-3-computes} shows that
$J^{n + 1}$ is in $\mathcal{I}$ and we have $H_{n + 1}$.
By Proposition \ref{derived-proposition-derived-functor} we have a
...
\begin{lemma}[Right derived exact functor]
\label{derived-lemma-right-derived-exact-functor}
\source{stacks:015F}
\href{https://stacks.math.columbia.edu/tag/015F}{\texttt{Stacks tag 015F}}
\group{derived}
...
\begin{lemma}[Cohomology in serre subcategory]
\label{derived-lemma-cohomology-in-serre-subcategory}
\source{stacks:06UQ}
\href{https://stacks.math.columbia.edu/tag/06UQ}{\texttt{Stacks tag 06UQ}}
\group{derived}
...
Lemma \ref{derived-lemma-right-derived-exact-functor}. Clearly the
...
\begin{lemma}[Derived of quotient]
\label{derived-lemma-derived-of-quotient}
\source{stacks:06XL}
\href{https://stacks.math.columbia.edu/tag/06XL}{\texttt{Stacks tag 06XL}}
\group{derived}
...
$$
\begin{array}{cccc} & (X')^1 \dashrightarrow & (X')^2 \dashrightarrow & \ldots \\ X^0 \nearrow & X^1 \uparrow & X^2 \uparrow & \ldots \\ Y^0 \underset{s^0}{\uparrow}\underset{f^0}{\nearrow} & Y^1 \underset{s^1}{\uparrow}\underset{f^1}{\nearrow} & Y^2 \underset{s^2}{\uparrow}\underset{f^2}{\nearrow} & \ldots\end{array}
$$
...
By induction we will construct a commutative diagram
$$
\begin{array}{cccc}\ldots & Z^{-2} & Z^{-1} & Z^0 \\ \ldots & X^{-2} \underset{t_{-2}}{\uparrow}\underset{g_{-2}}{\nearrow} & X^{-1} \underset{t_{-1}}{\uparrow}\underset{g_{-1}}{\nearrow} & X^0 \underset{t^0}{\uparrow} \\ \ldots & (X')^{-2} \uparrow\dashrightarrow & (X')^{-1} \uparrow\nearrow & \end{array}
$$
where the vertical arrows $(X')^i \to X^i$ become isomorphisms
...
\begin{lemma}[Quotient by serre easy]
\label{derived-lemma-quotient-by-serre-easy}
\source{stacks:06XM}
\href{https://stacks.math.columbia.edu/tag/06XM}{\texttt{Stacks tag 06XM}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-derived-of-quotient}

The functor $D(v) : D(\mathcal{A}) \to D(\mathcal{A}/\mathcal{B})$
is essentially surjective by
Lemma \ref{derived-lemma-derived-of-quotient}.
...
\begin{lemma}[Fully faithful embedding]
\label{derived-lemma-fully-faithful-embedding}
\source{stacks:0FCL}
\href{https://stacks.math.columbia.edu/tag/0FCL}{\texttt{Stacks tag 0FCL}}
\group{derived}
...
\source{stacks:013I}
\href{https://stacks.math.columbia.edu/tag/013I}{\texttt{Stacks tag 013I}}
\group{derived}
...
$$
\begin{array}{ccccc}\ldots \longrightarrow & K^{n - 1} \downarrow\longrightarrow & K^n \downarrow\longrightarrow & K^{n + 1} \downarrow\longrightarrow & \ldots \\ \ldots \longrightarrow & I^{n - 1} \longrightarrow & I^n \longrightarrow & I^{n + 1} \longrightarrow & \ldots\end{array}
$$
...
\begin{lemma}[Cohomology bounded below]
\label{derived-lemma-cohomology-bounded-below}
\source{stacks:013J}
\href{https://stacks.math.columbia.edu/tag/013J}{\texttt{Stacks tag 013J}}
\group{derived}
...
\begin{lemma}[Injective resolutions exist]
\label{derived-lemma-injective-resolutions-exist}
\source{stacks:013K}
\href{https://stacks.math.columbia.edu/tag/013K}{\texttt{Stacks tag 013K}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-cohomology-bounded-below, derived-lemma-subcategory-right-resolution}
...
By Lemma \ref{derived-lemma-cohomology-bounded-below} part (2) follows from part (3).
Part (3) is a special case of
Lemma \ref{derived-lemma-subcategory-right-resolution}.
\end{proof}

\begin{lemma}[Acyclic is zero]
\label{derived-lemma-acyclic-is-zero}
\source{stacks:013R}
\href{https://stacks.math.columbia.edu/tag/013R}{\texttt{Stacks tag 013R}}
\group{derived}
...
complexes. Note that $\alpha^j = 0$ for $j \ll 0$ as $I^\bullet$
is bounded below. In particular, we can find an $n$ such that
there exist $h^j :  K^j \to I^{j - 1}$ for $j \leq n$ such that
$\alpha^j = d^{j - 1} \circ h^j + h^{j + 1} \circ d^j$
for $j < n$. We will show that there exists a morphism
$h^{n + 1} : K^{n + 1} \to I^n$
such that $\alpha^n = d^{n - 1} \circ h^n + h^{n + 1} \circ d^n$.
Note that
\begin{align*}
...
Hence we can think of $\alpha^n -  d^{n - 1} \circ h^{n - 1}$
as a map into $I^n$ defined on the subobject $\Im(K^n \to K^{n + 1})$
of $K^{n + 1}$. By injectivity of the object $I^n$ we can extend this to
a map $h^{n + 1} : K^{n + 1} \to I^n$. With this choice the reader
checks that we indeed have
$\alpha^n = d^{n - 1} \circ h^n + h^{n + 1} \circ d^n$.

\medskip\noindent
By induction on $n$ we conclude we can find $h  = (h^j)_{j \in \mathbf{Z}}$
which forms a homotopy between $\alpha$ and $0$ as desired.
\end{proof}

\begin{remark}[Easier proofs]
\label{derived-remark-easier-proofs}
\source{stacks:05TF}
\href{https://stacks.math.columbia.edu/tag/05TF}{\texttt{Stacks tag 05TF}}
\group{derived}

\uses{derived-lemma-acyclic-is-zero, derived-lemma-the-same-up-to-isomorphisms, derived-lemma-acyclic, derived-lemma-representable-homological}
Let $\mathcal{A}$ be an abelian category.
Using the fact that $K(\mathcal{A})$ is a triangulated category we
may use
Lemma \ref{derived-lemma-acyclic-is-zero}
...
$$
\begin{array}{ccc}\Hom_{K(\mathcal{A})}(C(\alpha)^\bullet, I^\bullet) \longrightarrow & \Hom_{K(\mathcal{A})}(L^\bullet, I^\bullet) \longrightarrow & \Hom_{K(\mathcal{A})}(K^\bullet, I^\bullet) \swarrow \\ \Hom_{K(\mathcal{A})}(C(\alpha)^\bullet[-1], I^\bullet) &  & \end{array}
$$
...
\begin{lemma}[Morphisms lift]
\label{derived-lemma-morphisms-lift}
\source{stacks:013P}
\href{https://stacks.math.columbia.edu/tag/013P}{\texttt{Stacks tag 013P}}
\group{derived}

Let $\mathcal{A}$ be an abelian category.
Consider a solid diagram
$$
\begin{array}{cc}K^\bullet \underset{\alpha}{\longrightarrow}\underset{\gamma}{\downarrow} & L^\bullet \overset{\beta}{\swarrow} \\ I^\bullet & \end{array}
$$
...
\begin{proof}
\uses{derived-remark-easier-proofs, derived-lemma-make-injective}

The ``correct'' proof of part (1) is explained in
Remark \ref{derived-remark-easier-proofs}.
We also give a direct proof here.

\medskip\noindent
We first show that (2) implies (1). Namely, let
$\tilde \alpha : K \to \tilde L^\bullet$, $\pi$, $s$ be as in
Lemma \ref{derived-lemma-make-injective}. Since $\tilde \alpha$ is injective
...
$$
\begin{array}{cc}K^{n - 1} \longrightarrow\underset{\gamma}{\downarrow}\overset{\alpha}{\downarrow} & K^n \overset{\gamma}{\downarrow}\overset{\alpha}{\downarrow} \\ L^{n - 1} \longrightarrow\overset{\beta}{\downarrow} & L^n \downarrow \\ I^{n - 1} \longrightarrow & I^n\end{array}
$$
...
\begin{lemma}[Morphisms equal up to homotopy]
\label{derived-lemma-morphisms-equal-up-to-homotopy}
\source{stacks:013S}
\href{https://stacks.math.columbia.edu/tag/013S}{\texttt{Stacks tag 013S}}
\group{derived}

Let $\mathcal{A}$ be an abelian category.
Consider a solid diagram
$$
\begin{array}{cc}K^\bullet \underset{\alpha}{\longrightarrow}\underset{\gamma}{\downarrow} & L^\bullet \overset{\beta_i}{\swarrow} \\ I^\bullet & \end{array}
$$
where $I^\bullet$ is bounded below and consists of injective
objects, and $\alpha$ is a quasi-isomorphism.
...
\begin{proof}
\uses{derived-remark-easier-proofs, derived-lemma-make-injective, derived-lemma-acyclic-is-zero}
...
Lemma \ref{derived-lemma-make-injective}. If we can show that $\beta_1 \circ\pi$
...
Thus the result of the lemma follows from Lemma \ref{derived-lemma-acyclic-is-zero}.
\end{proof}

\begin{lemma}[Morphisms into injective complex]
\label{derived-lemma-morphisms-into-injective-complex}
\source{stacks:05TG}
\href{https://stacks.math.columbia.edu/tag/05TG}{\texttt{Stacks tag 05TG}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-morphisms-lift, derived-lemma-morphisms-equal-up-to-homotopy}
...
of complexes. By
Lemma \ref{derived-lemma-morphisms-lift}
...
Lemma \ref{derived-lemma-morphisms-equal-up-to-homotopy}
shows that $\beta$ is homotopic to zero also, i.e., $b = 0$.
\end{proof}

\begin{lemma}[Injective resolution ses]
\label{derived-lemma-injective-resolution-ses}
\source{stacks:013T}
\href{https://stacks.math.columbia.edu/tag/013T}{\texttt{Stacks tag 013T}}
\group{derived}
...
$$
\begin{array}{ccccc}0 \longrightarrow & A^\bullet \longrightarrow\downarrow & B^\bullet \longrightarrow\downarrow & C^\bullet \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & I_1^\bullet \longrightarrow & I_2^\bullet \longrightarrow & I_3^\bullet \longrightarrow & 0\end{array}
$$
...
\begin{proof}
\uses{derived-lemma-injective-resolutions-exist, derived-lemma-morphisms-lift}

Step 1. Choose an injective resolution $A^\bullet \to I^\bullet$ (see
Lemma \ref{derived-lemma-injective-resolutions-exist}) or use the given one.
...
$$
\begin{array}{ccccc}0 \longrightarrow & A^\bullet \longrightarrow\downarrow & B^\bullet \longrightarrow\downarrow & C^\bullet \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & I^\bullet \longrightarrow & E^\bullet \longrightarrow & C^\bullet \longrightarrow & 0\end{array}
$$
...
injectives, then use $I_1^\bullet = A^\bullet$. If $A^n = C^n = 0$ for
$n < 0$, then pick these such that $I_1^n = I_3^n = 0$ for $n < 0$, see
Lemma \ref{derived-lemma-injective-resolutions-exist}.)
We may assume $f_3$ is injective in
every degree. By Lemma \ref{derived-lemma-morphisms-lift} we may find
...
Section \ref{derived-section-injective-resolutions}.
...
\source{stacks:0644}
\href{https://stacks.math.columbia.edu/tag/0644}{\texttt{Stacks tag 0644}}
\group{derived}
...
\begin{lemma}[Cohomology bounded above]
\label{derived-lemma-cohomology-bounded-above}
\source{stacks:0645}
\href{https://stacks.math.columbia.edu/tag/0645}{\texttt{Stacks tag 0645}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-cohomology-bounded-below}

Dual to
Lemma \ref{derived-lemma-cohomology-bounded-below}.
\end{proof}

\begin{lemma}[Projective resolutions exist]
\label{derived-lemma-projective-resolutions-exist}
\source{stacks:0646}
\href{https://stacks.math.columbia.edu/tag/0646}{\texttt{Stacks tag 0646}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-injective-resolutions-exist}

Dual to
Lemma \ref{derived-lemma-injective-resolutions-exist}.
\end{proof}

\begin{lemma}[Projective into acyclic is zero]
\label{derived-lemma-projective-into-acyclic-is-zero}
\source{stacks:0647}
\href{https://stacks.math.columbia.edu/tag/0647}{\texttt{Stacks tag 0647}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-acyclic-is-zero}

Dual to
Lemma \ref{derived-lemma-acyclic-is-zero}.
\end{proof}

\begin{remark}[Easier projective]
\label{derived-remark-easier-projective}
\source{stacks:0648}
\href{https://stacks.math.columbia.edu/tag/0648}{\texttt{Stacks tag 0648}}
\group{derived}

\uses{derived-remark-easier-proofs}
Let $\mathcal{A}$ be an abelian category.
...
\begin{lemma}[Morphisms lift projective]
\label{derived-lemma-morphisms-lift-projective}
\source{stacks:0649}
\href{https://stacks.math.columbia.edu/tag/0649}{\texttt{Stacks tag 0649}}
\group{derived}

Let $\mathcal{A}$ be an abelian category.
Consider a solid diagram
$$
\begin{array}{cc}K^\bullet & L^\bullet \overset{\alpha}{\longleftarrow} \\ P^\bullet \uparrow\underset{\beta}{\nearrow} & \end{array}
$$
...
\begin{proof}
\uses{derived-lemma-morphisms-lift}

Dual to
Lemma \ref{derived-lemma-morphisms-lift}.
\end{proof}

\begin{lemma}[Morphisms equal up to homotopy projective]
\label{derived-lemma-morphisms-equal-up-to-homotopy-projective}
\source{stacks:064A}
\href{https://stacks.math.columbia.edu/tag/064A}{\texttt{Stacks tag 064A}}
\group{derived}

Let $\mathcal{A}$ be an abelian category. Consider a solid diagram
$$
\begin{array}{cc}K^\bullet & L^\bullet \overset{\alpha}{\longleftarrow} \\ P^\bullet \uparrow\underset{\beta_i}{\nearrow} & \end{array}
$$
where $P^\bullet$ is bounded above and consists of projective
objects, and $\alpha$ is a quasi-isomorphism.
Any two morphisms $\beta_1, \beta_2$ making the diagram commute
...
\begin{proof}
\uses{derived-lemma-morphisms-equal-up-to-homotopy}

Dual to
Lemma \ref{derived-lemma-morphisms-equal-up-to-homotopy}.
\end{proof}

\begin{lemma}[Morphisms from projective complex]
\label{derived-lemma-morphisms-from-projective-complex}
\source{stacks:064B}
\href{https://stacks.math.columbia.edu/tag/064B}{\texttt{Stacks tag 064B}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-morphisms-into-injective-complex}

Dual to
Lemma \ref{derived-lemma-morphisms-into-injective-complex}.
\end{proof}

\begin{lemma}[Projective resolution ses]
\label{derived-lemma-projective-resolution-ses}
\source{stacks:064C}
\href{https://stacks.math.columbia.edu/tag/064C}{\texttt{Stacks tag 064C}}
\group{derived}
...
commutative diagram in $\text{Comp}^{+}(\mathcal{A})$
$$
\begin{array}{ccccc}0 \longrightarrow & P_1^\bullet \longrightarrow\downarrow & P_2^\bullet \longrightarrow\downarrow & P_3^\bullet \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & A^\bullet \longrightarrow & B^\bullet \longrightarrow & C^\bullet \longrightarrow & 0\end{array}
$$
...
\begin{proof}
\uses{derived-lemma-injective-resolution-ses}

Dual to
Lemma \ref{derived-lemma-injective-resolution-ses}.
\end{proof}

\begin{lemma}[Precise vanishing]
\label{derived-lemma-precise-vanishing}
\source{stacks:064D}
\href{https://stacks.math.columbia.edu/tag/064D}{\texttt{Stacks tag 064D}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-morphisms-from-projective-complex, derived-remark-truncation-distinguished-triangle, derived-lemma-representable-homological, derived-lemma-projective-into-acyclic-is-zero}
...
$$
by Remark \ref{derived-remark-truncation-distinguished-triangle}. Hence, by
Lemma \ref{derived-lemma-representable-homological}
...
Lemma \ref{derived-lemma-projective-into-acyclic-is-zero}.
\end{proof}

\begin{lemma}[Lift map]
\label{derived-lemma-lift-map}
\source{stacks:064E}
\href{https://stacks.math.columbia.edu/tag/064E}{\texttt{Stacks tag 064E}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-precise-vanishing, derived-lemma-representable-homological}

Consider the cone $C^\bullet = C(\alpha)^\bullet$ with map
$i : L^\bullet \to C^\bullet$.
Note that $i \circ \beta$ is zero by
Lemma \ref{derived-lemma-precise-vanishing}.
...
\begin{lemma}[Injective acyclic]
\label{derived-lemma-injective-acyclic}
\source{stacks:05TH}
\href{https://stacks.math.columbia.edu/tag/05TH}{\texttt{Stacks tag 05TH}}
\group{derived}
...
\begin{proof}
\uses{derived-definition-derived-functor, derived-lemma-morphisms-lift, derived-definition-right-derived-functor-defined, derived-definition-computes}

Part (2) is a direct consequences of part (1) and
Definition \ref{derived-definition-derived-functor}.
...
\begin{lemma}[Enough injectives right derived]
\label{derived-lemma-enough-injectives-right-derived}
\source{stacks:05TI}
\href{https://stacks.math.columbia.edu/tag/05TI}{\texttt{Stacks tag 05TI}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-injective-acyclic, derived-proposition-enough-acyclics, derived-lemma-injective-resolutions-exist, derived-lemma-existence-computes}

Combine
Lemma \ref{derived-lemma-injective-acyclic}
and
Proposition \ref{derived-proposition-enough-acyclics}
for the second assertion. To see the first assertion combine
Lemma \ref{derived-lemma-injective-resolutions-exist},
Lemma \ref{derived-lemma-injective-acyclic},
Lemma \ref{derived-lemma-existence-computes},
and Equation (\ref{equation-everywhere}).
\end{proof}

\begin{lemma}[Right derived properties]
\label{derived-lemma-right-derived-properties}
\source{stacks:0159}
\href{https://stacks.math.columbia.edu/tag/0159}{\texttt{Stacks tag 0159}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-enough-injectives-right-derived, derived-lemma-2-out-of-3-defined, derived-lemma-derived-canonical-delta-functor}

This lemma simply reviews some of the results obtained so far.
Note that by
Lemma \ref{derived-lemma-enough-injectives-right-derived}
...
\begin{lemma}[Higher derived functors]
\label{derived-lemma-higher-derived-functors}
\source{stacks:015B}
\href{https://stacks.math.columbia.edu/tag/015B}{\texttt{Stacks tag 015B}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-enough-injectives-right-derived, derived-lemma-right-derived-properties, derived-lemma-left-exact-higher-derived, derived-lemma-right-derived-delta-functor}
...
Lemma \ref{derived-lemma-right-derived-properties} part (3)
...
\begin{definition}[Cartan eilenberg]
\label{derived-definition-cartan-eilenberg}
\source{stacks:015H}
\href{https://stacks.math.columbia.edu/tag/015H}{\texttt{Stacks tag 015H}}
\group{derived}
...
\begin{lemma}[Cartan eilenberg]
\label{derived-lemma-cartan-eilenberg}
\source{stacks:015I}
\href{https://stacks.math.columbia.edu/tag/015I}{\texttt{Stacks tag 015I}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-injective-resolutions-exist, derived-lemma-injective-resolution-ses}
...
Lemma \ref{derived-lemma-injective-resolutions-exist}.
\item Using Lemma \ref{derived-lemma-injective-resolution-ses} choose injective
...
\begin{lemma}[Two ss complex functor]
\label{derived-lemma-two-ss-complex-functor}
\source{stacks:015J}
\href{https://stacks.math.columbia.edu/tag/015J}{\texttt{Stacks tag 015J}}
\group{derived}
...
\begin{remark}[Functorial ss]
\label{derived-remark-functorial-ss}
\source{stacks:015K}
\href{https://stacks.math.columbia.edu/tag/015K}{\texttt{Stacks tag 015K}}
\group{derived}

\uses{derived-lemma-two-ss-complex-functor, derived-remark-final-functorial}
The spectral sequences of Lemma \ref{derived-lemma-two-ss-complex-functor}
...
derived category, see Remark \ref{derived-remark-final-functorial}.
\end{remark}
...
Lemma \ref{derived-lemma-compose-derived-functors-general}.
This transformation need not always be an isomorphism.

\begin{lemma}[Compose derived functors]
\label{derived-lemma-compose-derived-functors}
\source{stacks:015M}
\href{https://stacks.math.columbia.edu/tag/015M}{\texttt{Stacks tag 015M}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-compose-derived-functors-general, derived-lemma-leray-acyclicity}
...
Lemma \ref{derived-lemma-leray-acyclicity}.
\end{proof}
...
\source{stacks:015N}
\href{https://stacks.math.columbia.edu/tag/015N}{\texttt{Stacks tag 015N}}
\group{derived}

\uses{derived-lemma-compose-derived-functors}
With assumptions as in Lemma \ref{derived-lemma-compose-derived-functors}
...
\begin{proof}
\uses{derived-lemma-cartan-eilenberg, derived-lemma-two-ss-complex-functor}
...
Lemma \ref{derived-lemma-cartan-eilenberg}.
Apply the second spectral sequence of
Lemma \ref{derived-lemma-two-ss-complex-functor}.
\end{proof}
...
Proposition \ref{derived-proposition-derived-category}).
For many purposes it therefore makes sense to think of
$D^{+}(\mathcal{A})$ as the (easier to grok) category $K^{+}(\mathcal{I})$
in this case.

\begin{proposition}[Derived category]
\label{derived-proposition-derived-category}
\source{stacks:013V}
\href{https://stacks.math.columbia.edu/tag/013V}{\texttt{Stacks tag 013V}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-injective-resolutions-exist, derived-lemma-morphisms-into-injective-complex}
...
\begin{definition}[Localization functor]
\label{derived-definition-localization-functor}
\source{stacks:013W}
\href{https://stacks.math.columbia.edu/tag/013W}{\texttt{Stacks tag 013W}}
\group{derived}
...
\begin{lemma}[Resolution functor]
\label{derived-lemma-resolution-functor}
\source{stacks:05TJ}
\href{https://stacks.math.columbia.edu/tag/05TJ}{\texttt{Stacks tag 05TJ}}
\group{derived}
...
$$
\begin{array}{ccc}K^{+}(\mathcal{A}) \searrow\underset{j}{\longrightarrow} &  & K^{+}(\mathcal{I}) \swarrow \\  & D^{+}(\mathcal{A}) & \end{array}
$$
...
\begin{proof}
\uses{derived-lemma-morphisms-lift, derived-lemma-morphisms-equal-up-to-homotopy, derived-lemma-morphisms-into-injective-complex}
...
such that
$$
\begin{array}{cc}K^\bullet \underset{\alpha}{\longrightarrow}\underset{i_{K^\bullet}}{\downarrow} & L^\bullet \overset{i_{L^\bullet}}{\downarrow} \\ j(K^\bullet) \overset{j(\alpha)}{\longrightarrow} & j(L^\bullet)\end{array}
$$
is commutative in $K^{+}(\mathcal{A})$. To see this either use
Lemmas \ref{derived-lemma-morphisms-lift} and
...
\begin{lemma}[Into derived category]
\label{derived-lemma-into-derived-category}
\source{stacks:013X}
\href{https://stacks.math.columbia.edu/tag/013X}{\texttt{Stacks tag 013X}}
\group{derived}
...
By Lemma \ref{derived-lemma-injective-resolutions-exist} every object
...
\begin{lemma}[J is exact]
\label{derived-lemma-j-is-exact}
\source{stacks:014W}
\href{https://stacks.math.columbia.edu/tag/014W}{\texttt{Stacks tag 014W}}
\group{derived}
...
\begin{proof}
\uses{derived-definition-localization-functor, derived-lemma-morphisms-lift, derived-lemma-morphisms-equal-up-to-homotopy, derived-lemma-exact-equivalence}

Denote $i_{K^\bullet} : K^\bullet \to j(K^\bullet)$ the
canonical maps of Definition \ref{derived-definition-localization-functor}.
First we discuss the existence of the functorial isomorphism
$j(K^\bullet[1]) \to j(K^\bullet)[1]$.
Consider the diagram
$$
\begin{array}{ccc}K^\bullet[1] \overset{i_{K^\bullet[1]}}{\downarrow}\xlongequal{} &  & K^\bullet[1] \overset{i_{K^\bullet}[1]}{\downarrow} \\ j(K^\bullet[1]) \overset{\xi_{K^\bullet}}{\dashrightarrow} &  & j(K^\bullet)[1]\end{array}
$$
By Lemmas \ref{derived-lemma-morphisms-lift}
...
(Hint: use Lemma \ref{derived-lemma-morphisms-equal-up-to-homotopy} again.)
...
$$
\begin{array}{ccccc}K^\bullet \underset{f}{\longrightarrow}\downarrow & L^\bullet \underset{g}{\longrightarrow}\downarrow & M^\bullet \underset{h}{\longrightarrow}\downarrow &  & K^\bullet[1] \downarrow \\ j(K^\bullet) \overset{j(f)}{\longrightarrow} & j(L^\bullet) \overset{j(g)}{\longrightarrow} & j(M^\bullet) \overset{\xi_{K^\bullet} \circ j(h)}{\longrightarrow} &  & j(K^\bullet)[1]\end{array}
$$
...
Lemma \ref{derived-lemma-exact-equivalence}
that $(j(K^\bullet), j(L^\bullet), j(M^\bullet), j(f), j(g),
\xi_{K^\bullet} \circ j(h))$ is a distinguished triangle in
$K^{+}(\mathcal{I})$.
\end{proof}

\begin{lemma}[Resolution functor quasi inverse]
\label{derived-lemma-resolution-functor-quasi-inverse}
\source{stacks:05TK}
\href{https://stacks.math.columbia.edu/tag/05TK}{\texttt{Stacks tag 05TK}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-bounded-derived, derived-lemma-universal-property-localization, derived-lemma-j-is-exact, derived-proposition-derived-category}

The functor $Q$ is a localization by
Lemma \ref{derived-lemma-bounded-derived}.
To prove the existence of $j'$ it suffices to show that any element of
$\text{Qis}^{+}(\mathcal{A})$ is mapped to an isomorphism under
the functor $j$, see Lemma \ref{derived-lemma-universal-property-localization}.
Consider the commutative square in proof of
Lemma \ref{derived-lemma-j-is-exact}. In this square, if $\alpha$ is a
quasi-isomorphism, then $i_{L^\bullet}\circ\alpha=j(\alpha)\circ i_{K^\bullet}$
is a quasi-isomorphism too, hence so is $j(\alpha)$. Thus by
Proposition \ref{derived-proposition-derived-category} the morphism
$j(\alpha)$ is an isomorphism in $K^+(\mathcal{I})$. We omit the
verification that $j'$ is quasi-inverse to
$K^{+}(\mathcal{I}) \to D^{+}(\mathcal{A})$.
\end{proof}

\begin{remark}[Big localization]
\label{derived-remark-big-localization}
\source{stacks:013Y}
\href{https://stacks.math.columbia.edu/tag/013Y}{\texttt{Stacks tag 013Y}}
\group{derived}
...
category. See
Remark \ref{derived-remark-big-abelian-category}
below.
...
\begin{lemma}[Functorial injective resolutions]
\label{derived-lemma-functorial-injective-resolutions}
\source{stacks:0141}
\href{https://stacks.math.columbia.edu/tag/0141}{\texttt{Stacks tag 0141}}
\group{derived}

\uses{derived-definition-localization-functor}
Let $\mathcal{A}$ be an abelian category.
...
Definition \ref{derived-definition-localization-functor}.
\end{enumerate}
\end{lemma}
...
\source{stacks:05TL}
\href{https://stacks.math.columbia.edu/tag/05TL}{\texttt{Stacks tag 05TL}}
\group{derived}

\uses{derived-lemma-functorial-injective-resolutions, derived-lemma-resolution-functor}
Suppose $inj$ is a functor such that $s \circ inj = \text{id}$
as in part (2) of
Lemma \ref{derived-lemma-functorial-injective-resolutions}.
...
$$
\begin{array}{ccc}K^\bullet
\overset{\alpha}{\longrightarrow}\underset{i_K}{\downarrow} &  & L^\bullet \overset{i_L}{\downarrow} \\ j(K)^\bullet
\overset{inj(\alpha)}{\longrightarrow} &  & j(L)^\bullet\end{array}
$$
of morphisms of complexes.
Hence, looking at the proof of
Lemma \ref{derived-lemma-resolution-functor}
...
diagram
$$
\begin{array}{ccc}\text{Comp}^{+}(\mathcal{A}) \underset{t \circ inj}{\longrightarrow}\searrow &  & K^{+}(\mathcal{I}) \\  & K^{+}(\mathcal{A}) \underset{j}{\nearrow} & \end{array}
$$
is commutative.
\end{remark}

\begin{remark}[Big abelian category]
\label{derived-remark-big-abelian-category}
\source{stacks:0142}
\href{https://stacks.math.columbia.edu/tag/0142}{\texttt{Stacks tag 0142}}
\group{derived}

\uses{derived-lemma-into-derived-category, derived-lemma-functorial-injective-resolutions}
...
Note that the proof of Lemma \ref{derived-lemma-into-derived-category} does
not apply to $\textit{Mod}(\mathcal{O}_X)$. But the proof of
Lemma \ref{derived-lemma-functorial-injective-resolutions} does apply
...
\begin{lemma}[Right derived functor]
\label{derived-lemma-right-derived-functor}
\source{stacks:05TN}
\href{https://stacks.math.columbia.edu/tag/05TN}{\texttt{Stacks tag 05TN}}
\group{derived}

\uses{derived-definition-localization-functor, derived-lemma-resolution-functor-quasi-inverse}
Let $\mathcal{A}$ be an abelian category with enough injectives
...
$$
\begin{array}{ccc}D^{+}(\mathcal{A}) \underset{RF}{\searrow}\overset{j'}{\longrightarrow} &  & K^{+}(\mathcal{I}) \overset{F}{\swarrow} \\  & D^{+}(\mathcal{B}) & \end{array}
$$
where $j'$ is the functor from
Lemma \ref{derived-lemma-resolution-functor-quasi-inverse}.
\end{lemma}

\begin{proof}
\uses{derived-lemma-injective-acyclic}
...
\begin{remark}[Right derived functor]
\label{derived-remark-right-derived-functor}
\source{stacks:0158}
\href{https://stacks.math.columbia.edu/tag/0158}{\texttt{Stacks tag 0158}}
\group{derived}

\uses{derived-lemma-right-derived-functor}
In the situation of
Lemma \ref{derived-lemma-right-derived-functor}
...
\begin{definition}[Filtered complexes notation]
\label{derived-definition-filtered-complexes-notation}
\source{stacks:015P}
\href{https://stacks.math.columbia.edu/tag/015P}{\texttt{Stacks tag 015P}}
\group{derived}
...
\begin{lemma}[Filtered injective]
\label{derived-lemma-filtered-injective}
\source{stacks:05TP}
\href{https://stacks.math.columbia.edu/tag/05TP}{\texttt{Stacks tag 05TP}}
\group{derived}
...
\begin{lemma}[Split strict monomorphism]
\label{derived-lemma-split-strict-monomorphism}
\source{stacks:05TQ}
\href{https://stacks.math.columbia.edu/tag/05TQ}{\texttt{Stacks tag 05TQ}}
\group{derived}
...
\begin{lemma}[Injective property filtered injective]
\label{derived-lemma-injective-property-filtered-injective}
\source{stacks:05TR}
\href{https://stacks.math.columbia.edu/tag/05TR}{\texttt{Stacks tag 05TR}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-split-strict-monomorphism}
...
Lemma \ref{derived-lemma-split-strict-monomorphism}.
\end{proof}

\begin{lemma}[Strict monomorphism into filtered injective]
\label{derived-lemma-strict-monomorphism-into-filtered-injective}
\source{stacks:05TS}
\href{https://stacks.math.columbia.edu/tag/05TS}{\texttt{Stacks tag 05TS}}
\group{derived}
...
\begin{lemma}[Filtered injective right resolution single object]
\label{derived-lemma-filtered-injective-right-resolution-single-object}
\source{stacks:05TT}
\href{https://stacks.math.columbia.edu/tag/05TT}{\texttt{Stacks tag 05TT}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-strict-monomorphism-into-filtered-injective}

First choose a strict monomorphism $u_0 : A \to I^0$ of $A$ into a filtered
injective object, see
Lemma \ref{derived-lemma-strict-monomorphism-into-filtered-injective}.
...
\begin{lemma}[Filtered injective right resolution map]
\label{derived-lemma-filtered-injective-right-resolution-map}
\source{stacks:05TU}
\href{https://stacks.math.columbia.edu/tag/05TU}{\texttt{Stacks tag 05TU}}
\group{derived}
...
there exists a commutative diagram
$$
\begin{array}{cc}A[0] \longrightarrow\downarrow & B[0] \downarrow \\ I^\bullet \longrightarrow & J^\bullet\end{array}
$$
\end{lemma}

\begin{proof}
\uses{derived-lemma-injective-property-filtered-injective}
...
commutative diagram
$$
\begin{array}{ccccc}A \underset{a}{\longrightarrow}\underset{f}{\downarrow} & I^0 \longrightarrow\overset{f^0}{\downarrow} & I^1 \longrightarrow\overset{f^1}{\downarrow} & I^2 \longrightarrow\overset{f^2}{\downarrow} & \ldots \\ B \overset{b}{\longrightarrow} & J^0 \longrightarrow & J^1 \longrightarrow & J^2 \longrightarrow & \ldots\end{array}
$$
...
Lemma \ref{derived-lemma-injective-property-filtered-injective}.
...
\begin{lemma}[Filtered injective right resolution ses]
\label{derived-lemma-filtered-injective-right-resolution-ses}
\source{stacks:05TV}
\href{https://stacks.math.columbia.edu/tag/05TV}{\texttt{Stacks tag 05TV}}
\group{derived}
...
there exists a commutative diagram
$$
\begin{array}{ccccc}0 \longrightarrow & A[0] \longrightarrow\downarrow & B[0] \longrightarrow\downarrow & C[0] \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & I^\bullet \longrightarrow & M^\bullet \longrightarrow & J^\bullet \longrightarrow & 0\end{array}
$$
where the lower row is a termwise split sequence of complexes.
\end{lemma}

\begin{proof}
\uses{derived-lemma-filtered-acyclic, derived-lemma-injective-property-filtered-injective}

As $A[0] \to I^\bullet$ and $C[0] \to J^\bullet$ are filtered
quasi-isomorphisms we conclude that $a : A \to I^0$, $c : C \to J^0$
and all the morphisms $d_I^n$, $d_J^n$ are strict, see
Homology, Lemma \ref{derived-lemma-filtered-acyclic}.
We are going to step by step construct the south-east and the south
arrows in the following commutative diagram
$$
\begin{array}{ccccc}B \underset{\beta}{\longrightarrow}\overset{b}{\searrow} & C \underset{c}{\longrightarrow}\overset{\overline{b}}{\searrow} & J^0 \overset{\delta^0}{\downarrow}\longrightarrow & J^1 \overset{\delta^1}{\downarrow}\longrightarrow & \ldots \\ A \overset{\alpha}{\uparrow}\overset{a}{\longrightarrow} & I^0 \longrightarrow & I^1 \longrightarrow & I^2 \longrightarrow & \ldots\end{array}
$$
...
\begin{lemma}[Right resolution by filtered injectives]
\label{derived-lemma-right-resolution-by-filtered-injectives}
\source{stacks:05TW}
\href{https://stacks.math.columbia.edu/tag/05TW}{\texttt{Stacks tag 05TW}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-filtered-injective-right-resolution-single-object, derived-lemma-filtered-injective-right-resolution-map, derived-lemma-filtered-injective-right-resolution-ses}
...
Lemma \ref{derived-lemma-filtered-injective-right-resolution-single-object}.
By
Lemma \ref{derived-lemma-filtered-injective-right-resolution-map}
...
$$
\begin{array}{ccccc}0 \longrightarrow & \Ker(d_K^i)[0] \longrightarrow\downarrow & K^i[0] \longrightarrow\downarrow & \Coim(d_K^i)[0] \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & I_{ker, i}^\bullet \overset{\alpha_i}{\longrightarrow} & I_i^\bullet \overset{\beta_i}{\longrightarrow} & I_{coim, i}^\bullet \longrightarrow & 0\end{array}
$$
with the lower sequence a termwise split exact sequence, see
Lemma \ref{derived-lemma-filtered-injective-right-resolution-ses}.
...
a commutative diagram
$$
\begin{array}{cccc}I_0^\bullet \longrightarrow & I_1^\bullet \longrightarrow & I_2^\bullet \longrightarrow & \ldots \\ K^0[0] \longrightarrow\uparrow & K^1[0] \longrightarrow\uparrow & K^2[0] \longrightarrow\uparrow & \ldots\end{array}
$$
...
\begin{lemma}[Filtered acyclic is zero]
\label{derived-lemma-filtered-acyclic-is-zero}
\source{stacks:05TX}
\href{https://stacks.math.columbia.edu/tag/05TX}{\texttt{Stacks tag 05TX}}
\group{derived}
...
\begin{lemma}[Morphisms into filtered injective complex]
\label{derived-lemma-morphisms-into-filtered-injective-complex}
\source{stacks:05TY}
\href{https://stacks.math.columbia.edu/tag/05TY}{\texttt{Stacks tag 05TY}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-the-same-up-to-isomorphisms, derived-lemma-filtered-acyclic, derived-lemma-representable-homological, derived-lemma-filtered-acyclic-is-zero}
...
Then
$$
\begin{array}{ccc}\Hom_{K(\text{Fil}^f(\mathcal{A}))}(C(\alpha)^\bullet, I^\bullet) \longrightarrow & \Hom_{K(\text{Fil}^f(\mathcal{A}))}(L^\bullet, I^\bullet) \longrightarrow & \Hom_{K(\text{Fil}^f(\mathcal{A}))}(K^\bullet, I^\bullet) \swarrow \\ \Hom_{K(\text{Fil}^f(\mathcal{A}))}(C(\alpha)^\bullet[-1], I^\bullet) &  & \end{array}
$$
is an exact sequence of abelian groups, see
Lemma \ref{derived-lemma-representable-homological}.
At this point
Lemma \ref{derived-lemma-filtered-acyclic-is-zero}
guarantees that the outer two groups are zero and hence
$\Hom_{K(\mathcal{A})}(L^\bullet, I^\bullet) =
\Hom_{K(\mathcal{A})}(K^\bullet, I^\bullet)$.
...
\begin{lemma}[Filtered localization functor]
\label{derived-lemma-filtered-localization-functor}
\source{stacks:015Q}
\href{https://stacks.math.columbia.edu/tag/015Q}{\texttt{Stacks tag 015Q}}
\group{derived}
...
$$
\begin{array}{cc}K^{+}(\mathcal{I}^f) \underset{\text{gr}^p}{\downarrow}\longrightarrow & DF^{+}(\mathcal{A}) \underset{\text{gr}^p}{\downarrow} \\ K^{+}(\mathcal{I}) \longrightarrow & D^{+}(\mathcal{A})\end{array}
\quad
\begin{array}{cc}K^{+}(\mathcal{I}^f) \overset{\text{forget }F}{\downarrow}\longrightarrow & DF^{+}(\mathcal{A}) \overset{\text{forget }F}{\downarrow} \\ K^{+}(\mathcal{I}) \longrightarrow & D^{+}(\mathcal{A})\end{array}
$$
...
\begin{proof}
\uses{derived-lemma-right-resolution-by-filtered-injectives, derived-lemma-morphisms-into-filtered-injective-complex}

The functor $K^{+}(\mathcal{I}^f) \to DF^{+}(\mathcal{A})$
is essentially surjective by
Lemma \ref{derived-lemma-right-resolution-by-filtered-injectives}.
It is fully faithful by
Lemma \ref{derived-lemma-morphisms-into-filtered-injective-complex}.
It is an exact functor by our definitions regarding distinguished
triangles.
The commutativity of the squares is immediate.
\end{proof}

\begin{remark}[Filtered localization big]
\label{derived-remark-filtered-localization-big}
\source{stacks:015R}
\href{https://stacks.math.columbia.edu/tag/015R}{\texttt{Stacks tag 015R}}
\group{derived}
...
discussion of
Section \ref{derived-section-right-derived-functor}
to define the
...
Section \ref{derived-section-right-derived-functor-via-resolutions},
...
equivalence of
Lemma \ref{derived-lemma-filtered-localization-functor}.
By
Lemma \ref{derived-lemma-exact-equivalence}
...
\end{equation}
by
Lemma \ref{derived-lemma-filtered-injective}.
...
Lemmas \ref{derived-lemma-injective-acyclic},
...
\begin{lemma}[Ss filtered derived]
\label{derived-lemma-ss-filtered-derived}
\source{stacks:015W}
\href{https://stacks.math.columbia.edu/tag/015W}{\texttt{Stacks tag 015W}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-right-resolution-by-filtered-injectives, equation-definition-filtered-derived-functor, derived-lemma-morphisms-into-filtered-injective-complex}
...
$$
\begin{array}{cc}K^\bullet \longrightarrow\downarrow & L^\bullet \downarrow \\ I^\bullet \longrightarrow & J^\bullet\end{array}
$$
...
\begin{remark}[Final functorial]
\label{derived-remark-final-functorial}
\source{stacks:015X}
\href{https://stacks.math.columbia.edu/tag/015X}{\texttt{Stacks tag 015X}}
\group{derived}

\uses{derived-remark-functorial-ss, derived-lemma-two-ss-complex-functor, derived-lemma-ss-filtered-derived}
As promised in Remark \ref{derived-remark-functorial-ss} we discuss the connection
...
According to Lemma \ref{derived-lemma-ss-filtered-derived} there is a spectral sequence
with $E_1$ term
$$
...
with this filtration. According to Lemma \ref{derived-lemma-ss-filtered-derived}
...
\source{stacks:06XQ}
\href{https://stacks.math.columbia.edu/tag/06XQ}{\texttt{Stacks tag 06XQ}}
\group{derived}
...
Lemmas \ref{derived-lemma-cohomology-bounded-below} and
\ref{derived-lemma-cohomology-bounded-above}.

\begin{lemma}[Compute ext resolutions]
\label{derived-lemma-compute-ext-resolutions}
\source{stacks:06XR}
\href{https://stacks.math.columbia.edu/tag/06XR}{\texttt{Stacks tag 06XR}}
\group{derived}

\uses{derived-definition-injective-resolution, derived-definition-projective-resolution}
Let $\mathcal{A}$ be an abelian category.
Let $X^\bullet, Y^\bullet \in \Ob(K(\mathcal{A}))$.
\begin{enumerate}
\item Let $Y^\bullet \to I^\bullet$ be an injective resolution
(Definition \ref{derived-definition-injective-resolution}). Then
$$
...
(Definition \ref{derived-definition-projective-resolution}). Then
$$
\Ext^i_\mathcal{A}(X^\bullet, Y^\bullet) =
...
\begin{proof}
\uses{derived-lemma-morphisms-into-injective-complex, derived-lemma-morphisms-from-projective-complex}
...
\begin{lemma}[Negative exts]
\label{derived-lemma-negative-exts}
\source{stacks:06XS}
\href{https://stacks.math.columbia.edu/tag/06XS}{\texttt{Stacks tag 06XS}}
\group{derived}
...
\source{stacks:06XT}
\href{https://stacks.math.columbia.edu/tag/06XT}{\texttt{Stacks tag 06XT}}
\group{derived}
...
$$
\begin{array}{ccccccc}0 \longrightarrow & A \longrightarrow & Z_{i - 1} \longrightarrow & \ldots \longrightarrow & Z_0 \longrightarrow & B \longrightarrow & 0 \\ 0 \longrightarrow & A \longrightarrow\overset{\text{id}}{\uparrow}\underset{\text{id}}{\downarrow} & Z''_{i - 1} \longrightarrow\uparrow\downarrow & \ldots \longrightarrow & Z''_0 \longrightarrow\uparrow\downarrow & B \longrightarrow\underset{\text{id}}{\uparrow}\overset{\text{id}}{\downarrow} & 0 \\ 0 \longrightarrow & A \longrightarrow & Z'_{i - 1} \longrightarrow & \ldots \longrightarrow & Z'_0 \longrightarrow & B \longrightarrow & 0\end{array}
$$
...
Lemma \ref{derived-lemma-yoneda-extension}
below.
...
\begin{lemma}[Yoneda extension]
\label{derived-lemma-yoneda-extension}
\source{stacks:06XU}
\href{https://stacks.math.columbia.edu/tag/06XU}{\texttt{Stacks tag 06XU}}
\group{derived}
...
$$
\begin{array}{cccccc}L^{- i - 1} \longrightarrow & L^{-i} \longrightarrow\downarrow & \ldots \longrightarrow & L^0 \longrightarrow & B \longrightarrow & 0 \\  & A &  &  &  & \end{array}
$$
...
\source{stacks:06XV}
\href{https://stacks.math.columbia.edu/tag/06XV}{\texttt{Stacks tag 06XV}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-yoneda-extension}

This is the case $i = 1$ of
Lemma \ref{derived-lemma-yoneda-extension}.
\end{proof}

Given an abelian category $\mathcal{A}$ and objects $X, Y, Z$ of
$D(\mathcal{A})$, there are bilinear and associative composition laws
$$
...
$$
Namely, if $\xi : X \to Y[i]$ and $\eta : Y \to Z[j]$, then
we define $\eta \circ \xi$ as the composition of $\xi$ by
$\eta[i] : Y[i] \to Z[i + j]$. If $A, B, C$ are objects of
$\mathcal{A}$ and $i, j \geq 1$, then this composition law
$$
...
\begin{lemma}[Cup ext 1 zero]
\label{derived-lemma-cup-ext-1-zero}
\source{stacks:0GSM}
\href{https://stacks.math.columbia.edu/tag/0GSM}{\texttt{Stacks tag 0GSM}}
\group{derived}
...
$$
\begin{array}{ccccc} &  & 0 \downarrow & 0 \downarrow &  \\ 0 \longrightarrow & A \longrightarrow\overset{1}{\downarrow} & Z \longrightarrow\downarrow & B \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & A \longrightarrow & W \longrightarrow\downarrow & Z' \longrightarrow\downarrow & 0 \\  &  & C \overset{1}{\longrightarrow}\downarrow & C \downarrow &  \\  &  & 0 & 0 & \end{array}
$$
...
Lemma \ref{derived-lemma-yoneda-extension} and working
...
of $\Ext$ the element $[Z] \in \Ext^1_\mathcal{A}(B, A)$ is the
image of some element in $\Ext^1_\mathcal{A}(Z', A)$.
\end{proof}

\begin{lemma}[Higher ext zero]
\label{derived-lemma-higher-ext-zero}
\source{stacks:0EWW}
\href{https://stacks.math.columbia.edu/tag/0EWW}{\texttt{Stacks tag 0EWW}}
\group{derived}
...
E : 0 \to A \to Z_{i - 1} \to Z_{i - 2} \to \ldots \to Z_0 \to B \to 0
$$
This is possible by Lemma \ref{derived-lemma-yoneda-extension}.
...
\begin{lemma}[Ext 2 zero pre]
\label{derived-lemma-ext-2-zero-pre}
\source{stacks:0GM4}
\href{https://stacks.math.columbia.edu/tag/0GM4}{\texttt{Stacks tag 0GM4}}
\group{derived}
...
\begin{proof}
\uses{derived-remark-truncation-distinguished-triangle, derived-lemma-split}
...
$$
see Remark \ref{derived-remark-truncation-distinguished-triangle}.
By Lemma \ref{derived-lemma-split} if the last arrow is zero, then
...
\begin{lemma}[Ext 2 zero]
\label{derived-lemma-ext-2-zero}
\source{stacks:0EWX}
\href{https://stacks.math.columbia.edu/tag/0EWX}{\texttt{Stacks tag 0EWX}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-higher-ext-zero, derived-lemma-ext-2-zero-pre}

The assumption implies that $\Ext^i_\mathcal{A}(B, A) = 0$ for $i \geq 2$
and any pair of objects $A, B$ of $\mathcal{A}$ by
Lemma \ref{derived-lemma-higher-ext-zero}. Hence this lemma is a special
case of Lemma \ref{derived-lemma-ext-2-zero-pre}.
\end{proof}
...
\begin{definition}[K zero]
\label{derived-definition-K-zero}
\source{stacks:0FCN}
\href{https://stacks.math.columbia.edu/tag/0FCN}{\texttt{Stacks tag 0FCN}}
\group{derived}
...
\begin{lemma}[K bounded derived]
\label{derived-lemma-K-bounded-derived}
\source{stacks:0FCP}
\href{https://stacks.math.columbia.edu/tag/0FCP}{\texttt{Stacks tag 0FCP}}
\group{derived}
...
Section \ref{derived-section-canonical-delta-functor}.
...
\source{stacks:0FCQ}
\href{https://stacks.math.columbia.edu/tag/0FCQ}{\texttt{Stacks tag 0FCQ}}
\group{derived}
...
\begin{lemma}[Homological map K]
\label{derived-lemma-homological-map-K}
\source{stacks:0FCR}
\href{https://stacks.math.columbia.edu/tag/0FCR}{\texttt{Stacks tag 0FCR}}
\group{derived}
...
\begin{lemma}[DBA map K]
\label{derived-lemma-DBA-map-K}
\source{stacks:0FCS}
\href{https://stacks.math.columbia.edu/tag/0FCS}{\texttt{Stacks tag 0FCS}}
\group{derived}
...
\begin{proof}
\uses{derived-remark-truncation-distinguished-triangle}
...
Remark \ref{derived-remark-truncation-distinguished-triangle} and an
...
\begin{lemma}[Bilinear map K]
\label{derived-lemma-bilinear-map-K}
\source{stacks:0FCT}
\href{https://stacks.math.columbia.edu/tag/0FCT}{\texttt{Stacks tag 0FCT}}
\group{derived}
...
\begin{lemma}[Special direct system]
\label{derived-lemma-special-direct-system}
\source{stacks:06XX}
\href{https://stacks.math.columbia.edu/tag/06XX}{\texttt{Stacks tag 06XX}}
\group{derived}
...
There exists a commutative diagram
$$
\begin{array}{ccc}P_1^\bullet \downarrow\longrightarrow & P_2^\bullet \downarrow\longrightarrow & \ldots \\ \tau_{\leq 1}K^\bullet \longrightarrow & \tau_{\leq 2}K^\bullet \longrightarrow & \ldots\end{array}
$$
...
\begin{proof}
\uses{derived-proposition-homotopy-category-triangulated, derived-lemma-subcategory-left-resolution, derived-lemma-improve-distinguished-triangle-homotopy}
...
By Lemma \ref{derived-lemma-subcategory-left-resolution} we can find a
...
Lemma \ref{derived-lemma-subcategory-left-resolution} we choose a
...
in $K(\mathcal{A})$.
By Lemma \ref{derived-lemma-improve-distinguished-triangle-homotopy}
...
$$
\begin{array}{cccc}P_n^\bullet \longrightarrow\downarrow & P_{n + 1}^\bullet \longrightarrow\downarrow & Q^\bullet \longrightarrow\downarrow & P_n^\bullet[1] \downarrow \\ P_n^\bullet \longrightarrow & \tau_{\leq n + 1}K^\bullet \longrightarrow & C^\bullet \longrightarrow & P_n^\bullet[1]\end{array}
$$
...
$$
\begin{array}{cc}P_n^\bullet \downarrow\longrightarrow & P_{n + 1}^\bullet \downarrow \\ \tau_{\leq n}K^\bullet \longrightarrow & \tau_{\leq n + 1}K^\bullet\end{array}
$$
...
\begin{proposition}[Left derived exists]
\label{derived-proposition-left-derived-exists}
\source{stacks:0794}
\href{https://stacks.math.columbia.edu/tag/0794}{\texttt{Stacks tag 0794}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-subcategory-left-resolution, derived-lemma-find-existence-computes, derived-lemma-special-direct-system, derived-lemma-acyclic}

By (1) and Lemma \ref{derived-lemma-subcategory-left-resolution} for any bounded
...
\begin{array}{ccc}P_1^\bullet \downarrow\longrightarrow & P_2^\bullet \downarrow\longrightarrow & \ldots \\ \tau_{\leq 1}K^\bullet \longrightarrow & \tau_{\leq 2}K^\bullet \longrightarrow & \ldots\end{array}
$$
as in Lemma \ref{derived-lemma-special-direct-system}. Note that
...
computes $LF$. To see this, by Lemma \ref{derived-lemma-find-existence-computes},
...
$$
\begin{array}{ccc} & R^\bullet \downarrow &  \\ P_n^\bullet \downarrow & L^\bullet \dashleftarrow\dashrightarrow & Q_n^\bullet \downarrow \\ \tau_{\leq n}P^\bullet \overset{\tau_{\leq n}\alpha}{\longrightarrow} &  & \tau_{\leq n}Q^\bullet\end{array}
$$
are quasi-isomorphisms. Because quasi-isomorphisms form a multiplicative
system in $K(\mathcal{A})$ (see Lemma \ref{derived-lemma-acyclic})
...
diagram
$$
\begin{array}{cc}H^i(F(P_n^\bullet)) \longrightarrow\downarrow & H^i(F(Q_n^\bullet)) \downarrow \\ H^i(F(P^\bullet)) \longrightarrow & H^i(F(Q^\bullet))\end{array}
$$
...
\begin{lemma}[Special inverse system]
\label{derived-lemma-special-inverse-system}
\source{stacks:070F}
\href{https://stacks.math.columbia.edu/tag/070F}{\texttt{Stacks tag 070F}}
\group{derived}
...
There exists a commutative diagram
$$
\begin{array}{ccc}\ldots \longrightarrow & \tau_{\geq -2}K^\bullet \longrightarrow\downarrow & \tau_{\geq -1}K^\bullet \downarrow \\ \ldots \longrightarrow & I_2^\bullet \longrightarrow & I_1^\bullet\end{array}
$$
in the category of complexes such that
\begin{enumerate}
...
\begin{proof}
\uses{derived-lemma-special-direct-system}

This lemma is dual to
Lemma \ref{derived-lemma-special-direct-system}.
\end{proof}
...
$$
\vcenter{
\begin{array}{cc}\mathcal{D} \underset{F}{\longrightarrow}\underset{Q}{\downarrow} & \mathcal{D}' \overset{Q'}{\downarrow} \\ S^{-1}\mathcal{D} \overset{RF}{\dashrightarrow} & (S')^{-1}\mathcal{D}'\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}\mathcal{D}' \underset{G}{\longrightarrow}\underset{Q'}{\downarrow} & \mathcal{D} \overset{Q}{\downarrow} \\ (S')^{-1}\mathcal{D}' \overset{LG}{\dashrightarrow} & S^{-1}\mathcal{D}\end{array}
}
$$

\begin{lemma}[Pre derived adjoint functors general]
\label{derived-lemma-pre-derived-adjoint-functors-general}
\source{stacks:0FND}
\href{https://stacks.math.columbia.edu/tag/0FND}{\texttt{Stacks tag 0FND}}
\group{derived}
...
\begin{lemma}[Pre derived adjoint functors]
\label{derived-lemma-pre-derived-adjoint-functors}
\source{stacks:0DVC}
\href{https://stacks.math.columbia.edu/tag/0DVC}{\texttt{Stacks tag 0DVC}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-pre-derived-adjoint-functors-general}

This is a special case of the very general
Lemma \ref{derived-lemma-pre-derived-adjoint-functors-general}.
\end{proof}
...
\begin{lemma}[Derived adjoint functors]
\label{derived-lemma-derived-adjoint-functors}
\source{stacks:09T5}
\href{https://stacks.math.columbia.edu/tag/09T5}{\texttt{Stacks tag 09T5}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-pre-derived-adjoint-functors}

Immediate from Lemma \ref{derived-lemma-pre-derived-adjoint-functors}.
\end{proof}
...
\begin{definition}[K injective]
\label{derived-definition-K-injective}
\source{stacks:070H}
\href{https://stacks.math.columbia.edu/tag/070H}{\texttt{Stacks tag 070H}}
\group{derived}
...
\source{stacks:070I}
\href{https://stacks.math.columbia.edu/tag/070I}{\texttt{Stacks tag 070I}}
\group{derived}
...
\begin{lemma}[Triangle K injective]
\label{derived-lemma-triangle-K-injective}
\source{stacks:090X}
\href{https://stacks.math.columbia.edu/tag/090X}{\texttt{Stacks tag 090X}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-representable-homological, derived-proposition-homotopy-category-triangulated}

Follows from the definition,
Lemma \ref{derived-lemma-representable-homological}, and
the fact that $K(\mathcal{A})$ is a triangulated category
(Proposition \ref{derived-proposition-homotopy-category-triangulated}).
\end{proof}

\begin{lemma}[Bounded below injectives K injective]
\label{derived-lemma-bounded-below-injectives-K-injective}
\source{stacks:070J}
\href{https://stacks.math.columbia.edu/tag/070J}{\texttt{Stacks tag 070J}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-K-injective, derived-lemma-morphisms-into-injective-complex}

Follows from
Lemmas \ref{derived-lemma-K-injective} and
\ref{derived-lemma-morphisms-into-injective-complex}.
\end{proof}

\begin{lemma}[Product K injective]
\label{derived-lemma-product-K-injective}
\source{stacks:0BK6}
\href{https://stacks.math.columbia.edu/tag/0BK6}{\texttt{Stacks tag 0BK6}}
\group{derived}
...
Having said this, we can use Lemma \ref{derived-lemma-K-injective}
to conclude that
$$
...
\begin{lemma}[K injective defined]
\label{derived-lemma-K-injective-defined}
\source{stacks:070Y}
\href{https://stacks.math.columbia.edu/tag/070Y}{\texttt{Stacks tag 070Y}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-derived-inverts, derived-lemma-K-injective}

By
Lemma \ref{derived-lemma-derived-inverts}
...
Consider a quasi-isomorphism $I^\bullet \to N^\bullet$. By
Lemma \ref{derived-lemma-K-injective} it has a left inverse.
Thus $I^\bullet \to I^\bullet$ is a final object of
$I^\bullet/\text{Qis}(\mathcal{A})$ and we win.
\end{proof}

\begin{lemma}[Enough K injectives implies]
\label{derived-lemma-enough-K-injectives-implies}
\source{stacks:070K}
\href{https://stacks.math.columbia.edu/tag/070K}{\texttt{Stacks tag 070K}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-find-existence-computes, derived-lemma-K-injective}
...
Lemma \ref{derived-lemma-K-injective}.
\end{proof}

The following lemma can be generalized to limits over bigger ordinals.

\begin{lemma}[The limit of a ``split'' tower of K-injective complexes is K-injective.]
\label{derived-lemma-limit-K-injectives}
\source{stacks:070L}
\href{https://stacks.math.columbia.edu/tag/070L}{\texttt{Stacks tag 070L}}
\group{derived}
...
It appears that a combination of Lemmas \ref{derived-lemma-special-inverse-system},
\ref{derived-lemma-bounded-below-injectives-K-injective}, and
\ref{derived-lemma-limit-K-injectives} produces ``enough K-injectives'' for any
abelian category with enough injectives and countable products.
Actually, this may not work! See Lemma \ref{derived-lemma-difficulty-K-injectives}
for an explanation.

\begin{lemma}[Adjoint preserve K injectives]
\label{derived-lemma-adjoint-preserve-K-injectives}
\source{stacks:08BJ}
\href{https://stacks.math.columbia.edu/tag/08BJ}{\texttt{Stacks tag 08BJ}}
\group{derived}
...
\begin{lemma}[Replace resolution]
\label{derived-lemma-replace-resolution}
\source{stacks:07K6}
\href{https://stacks.math.columbia.edu/tag/07K6}{\texttt{Stacks tag 07K6}}
\group{derived}
...
By Lemma \ref{derived-lemma-subcategory-right-resolution} we can find a
...
$$
\begin{array}{ccccc}K^\bullet : \downarrow & K^{n - 1} \downarrow\longrightarrow & K^n \downarrow\longrightarrow & K^{n + 1} \downarrow\longrightarrow & K^{n + 2} \downarrow \\ (K')^\bullet : & K^{n - 1} \longrightarrow & M \longrightarrow & M' \longrightarrow & K^{n + 2}\end{array}
$$
...
\begin{lemma}[Unbounded right derived]
\label{derived-lemma-unbounded-right-derived}
\source{stacks:07K7}
\href{https://stacks.math.columbia.edu/tag/07K7}{\texttt{Stacks tag 07K7}}
\group{derived}
...
\begin{proof}
\uses{derived-proposition-enough-acyclics, derived-lemma-replace-resolution, derived-lemma-find-existence-computes, derived-lemma-two-ss-complex-functor, derived-lemma-negative-vanishing, derived-remark-truncation-distinguished-triangle}
...
\medskip\noindent
We are going to use Lemma \ref{derived-lemma-replace-resolution} with the function
$d : \Ob(\mathcal{A}) \to \{0, 1, 2, \ldots \}$ given by
$d(A) = \max \{0\} \cup \{i \mid R^iF(A) \not = 0\}$.
The first assumption of Lemma \ref{derived-lemma-replace-resolution}
is our assumption (1). The second assumption of
Lemma \ref{derived-lemma-replace-resolution} follows from the fact
that $RF(A \oplus B) = RF(A) \oplus RF(B)$. The third assumption of
Lemma \ref{derived-lemma-replace-resolution} follows from the long exact
...
By Proposition \ref{derived-proposition-enough-acyclics} we know that
...
\medskip\noindent
Part (4)(a) follows from Lemma \ref{derived-lemma-negative-vanishing}.
...
$$
of Remark \ref{derived-remark-truncation-distinguished-triangle}.
...
(see Section \ref{derived-section-canonical-delta-functor})
...
\begin{lemma}[Unbounded left derived]
\label{derived-lemma-unbounded-left-derived}
\source{stacks:07K8}
\href{https://stacks.math.columbia.edu/tag/07K8}{\texttt{Stacks tag 07K8}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-unbounded-right-derived}

This is dual to Lemma \ref{derived-lemma-unbounded-right-derived}.
\end{proof}
...
\begin{definition}[Derived colimit]
\label{derived-definition-derived-colimit}
\source{stacks:090Z}
\href{https://stacks.math.columbia.edu/tag/090Z}{\texttt{Stacks tag 090Z}}
\group{derived}
...
\begin{remark}[Uniqueness derived colimit]
\label{derived-remark-uniqueness-derived-colimit}
\source{stacks:0CRH}
\href{https://stacks.math.columbia.edu/tag/0CRH}{\texttt{Stacks tag 0CRH}}
\group{derived}
...
\begin{remark}[Functoriality derived colimit]
\label{derived-remark-functoriality-derived-colimit}
\source{stacks:0CRI}
\href{https://stacks.math.columbia.edu/tag/0CRI}{\texttt{Stacks tag 0CRI}}
\group{derived}

\uses{derived-remark-uniqueness-derived-colimit}
Let $\mathcal{D}$ be a triangulated category.
...
Remark \ref{derived-remark-uniqueness-derived-colimit}.
...
\begin{lemma}[Hocolim subsequence]
\label{derived-lemma-hocolim-subsequence}
\source{stacks:0CRJ}
\href{https://stacks.math.columbia.edu/tag/0CRJ}{\texttt{Stacks tag 0CRJ}}
\group{derived}
...
such that
$$
\begin{array}{cc}K_{n_i} \longrightarrow\underset{\text{id}}{\downarrow} & \text{hocolim} K_{n_i} \downarrow \\ K_{n_i} \longrightarrow & \text{hocolim} K_n\end{array}
$$
commutes for all $i$.
\end{lemma}

\begin{proof}
\uses{derived-lemma-third-isomorphism-triangle, derived-lemma-third-map-square-zero}
...
$$
\vcenter{
\begin{array}{cc}\bigoplus\nolimits_i K_{n_i} \underset{1 - g_i}{\longrightarrow}\underset{b}{\downarrow} & \bigoplus\nolimits_i K_{n_i} \overset{a}{\downarrow} \\ \bigoplus\nolimits_n K_n \overset{1 - f_n}{\longrightarrow} & \bigoplus\nolimits_n K_n\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}\bigoplus\nolimits_n K_n \underset{1 - f_n}{\longrightarrow}\underset{d}{\downarrow} & \bigoplus\nolimits_n K_n \overset{c}{\downarrow} \\ \bigoplus\nolimits_i K_{n_i} \overset{1 - g_i}{\longrightarrow} & \bigoplus\nolimits_i K_{n_i}\end{array}
}
$$
...
Lemma \ref{derived-lemma-third-map-square-zero} (small argument omitted).
...
\begin{lemma}[Direct sums]
\label{derived-lemma-direct-sums}
\source{stacks:0A5L}
\href{https://stacks.math.columbia.edu/tag/0A5L}{\texttt{Stacks tag 0A5L}}
\group{derived}
...
\begin{lemma}[Compute colimit]
\label{derived-lemma-compute-colimit}
\source{stacks:093W}
\href{https://stacks.math.columbia.edu/tag/093W}{\texttt{Stacks tag 093W}}
\group{derived}
...
\begin{lemma}[Colim hocolim]
\label{derived-lemma-colim-hocolim}
\source{stacks:0949}
\href{https://stacks.math.columbia.edu/tag/0949}{\texttt{Stacks tag 0949}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-compute-colimit, derived-lemma-direct-sums, derived-definition-derived-colimit, derived-lemma-derived-canonical-delta-functor}

We have an exact sequence of complexes
$$
0 \to \bigoplus L_n^\bullet \to \bigoplus L_n^\bullet \to L^\bullet \to 0
$$
by Lemma \ref{derived-lemma-compute-colimit}.
The direct sums are direct sums in $D(\mathcal{A})$ by
Lemma \ref{derived-lemma-direct-sums}.
...
\begin{lemma}[Cohomology of hocolim]
\label{derived-lemma-cohomology-of-hocolim}
\source{stacks:0CRK}
\href{https://stacks.math.columbia.edu/tag/0CRK}{\texttt{Stacks tag 0CRK}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-compute-colimit}
...
Apply Lemma \ref{derived-lemma-compute-colimit} to see that this proves the lemma.
\end{proof}

The following lemma tells us that taking maps out of a compact
object (to be defined later) commutes with derived colimits.

\begin{lemma}[Commutes with countable sums]
\label{derived-lemma-commutes-with-countable-sums}
\source{stacks:094A}
\href{https://stacks.math.columbia.edu/tag/094A}{\texttt{Stacks tag 094A}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-representable-homological, derived-lemma-cohomology-of-hocolim}

By Lemma \ref{derived-lemma-representable-homological}, this is a particular case
of Lemma \ref{derived-lemma-cohomology-of-hocolim}.
\end{proof}
...
\begin{definition}[Derived limit]
\label{derived-definition-derived-limit}
\source{stacks:08TC}
\href{https://stacks.math.columbia.edu/tag/08TC}{\texttt{Stacks tag 08TC}}
\group{derived}
...
\source{stacks:07KC}
\href{https://stacks.math.columbia.edu/tag/07KC}{\texttt{Stacks tag 07KC}}
\group{derived}
...
The duals of Lemmas \ref{derived-lemma-compute-colimit},
\ref{derived-lemma-colim-hocolim}, and
...
\begin{lemma}[Inverse limit bounded below]
\label{derived-lemma-inverse-limit-bounded-below}
\source{stacks:0BK7}
\href{https://stacks.math.columbia.edu/tag/0BK7}{\texttt{Stacks tag 0BK7}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-injective-resolutions-exist, derived-lemma-product-K-injective}

It suffices to show that $\prod K_n$ exists in $D(\mathcal{A})$.
For every $n$ we can represent $K_n$ by a bounded below complex
$I_n^\bullet$ of injectives (Lemma \ref{derived-lemma-injective-resolutions-exist}).
Then $\prod K_n$ is represented by $\prod I_n^\bullet$, see
Lemma \ref{derived-lemma-product-K-injective}.
\end{proof}

\begin{remark}[Functoriality derived limit]
\label{derived-remark-functoriality-derived-limit}
\source{stacks:0H9J}
\href{https://stacks.math.columbia.edu/tag/0H9J}{\texttt{Stacks tag 0H9J}}
\group{derived}
...
$$
\begin{array}{ccc}K \longrightarrow\downarrow & \prod K_n \longrightarrow\overset{a'}{\downarrow} & \prod K_n \overset{a''}{\downarrow} \\ L \longrightarrow & \prod L_n \longrightarrow & \prod L_n\end{array}
$$
...
More on Algebra, Lemma \ref{more-algebra-lemma-pro-isomorphism-Rlim}.
\end{remark}

\begin{remark}[Map into derived limit truncations]
\label{derived-remark-map-into-derived-limit-truncations}
\source{stacks:0H72}
\href{https://stacks.math.columbia.edu/tag/0H72}{\texttt{Stacks tag 0H72}}
\group{derived}

\uses{derived-definition-derived-limit, derived-lemma-representable-homological}
...
triangle of Definition \ref{derived-definition-derived-limit} and
Lemma \ref{derived-lemma-representable-homological}
...
\begin{lemma}[Difficulty K injectives]
\label{derived-lemma-difficulty-K-injectives}
\source{stacks:070M}
\href{https://stacks.math.columbia.edu/tag/070M}{\texttt{Stacks tag 070M}}
\group{derived}

\uses{derived-lemma-special-inverse-system, derived-remark-map-into-derived-limit-truncations}
Let $\mathcal{A}$ be an abelian category with countable products and
...
Lemma \ref{derived-lemma-special-inverse-system}. Then
...
of Remark \ref{derived-remark-map-into-derived-limit-truncations}
is an isomorphism in $D(\mathcal{A})$.
\end{enumerate}
\end{lemma}

\begin{proof}
\uses{derived-lemma-inverse-limit-bounded-below, derived-lemma-bounded-below-injectives-K-injective, derived-lemma-product-K-injective, derived-definition-derived-limit, derived-lemma-triangle-K-injective, derived-lemma-special-inverse-system, derived-remark-map-into-derived-limit-truncations}

The statement of the lemma makes sense as $R\lim \tau_{\geq -n}K^\bullet$
exists by Lemma \ref{derived-lemma-inverse-limit-bounded-below}.
...
and $D(\mathcal{A})$. By Lemma \ref{derived-lemma-product-K-injective}
...
Lemma \ref{derived-lemma-triangle-K-injective}.
By the commutative diagram of Lemma \ref{derived-lemma-special-inverse-system}
...
$$
\begin{array}{cc}K^\bullet \longrightarrow\underset{\gamma}{\downarrow} & \tau_{\geq -n} K^\bullet \downarrow \\ I^\bullet \longrightarrow & I_n^\bullet\end{array}
$$
commute. It follows that $\gamma$ is a map of complexes which represents
the map $c : K^\bullet \to R\lim \tau_{\geq -n}K^\bullet$ of
Remark \ref{derived-remark-map-into-derived-limit-truncations}
in $D(\mathcal{A})$. In other words, the diagram
$$
\begin{array}{cc}K^\bullet \underset{c}{\longrightarrow}\underset{\gamma}{\downarrow} & R\lim \tau_{\geq -n} K^\bullet
\overset{\cong}{\downarrow} \\ I^\bullet \overset{\cong}{\longrightarrow} & R\lim I_n^\bullet\end{array}
$$
is commutative in $D(\mathcal{A})$. The lemma follows.
\end{proof}

\begin{lemma}[Enough K injectives Ab4 star]
\label{derived-lemma-enough-K-injectives-Ab4-star}
\source{stacks:090Y}
\href{https://stacks.math.columbia.edu/tag/090Y}{\texttt{Stacks tag 090Y}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-difficulty-K-injectives, derived-lemma-products}

By Lemma \ref{derived-lemma-difficulty-K-injectives} it suffices to show that
...
(R\lim\tau_{\geq -n}K)[1]
$$
By Lemma \ref{derived-lemma-products} we have
$$
...
\begin{lemma}[Associativity star]
\label{derived-lemma-associativity-star}
\source{stacks:0FX1}
\href{https://stacks.math.columbia.edu/tag/0FX1}{\texttt{Stacks tag 0FX1}}
\group{derived}
...
\begin{lemma}[Smd star]
\label{derived-lemma-smd-star}
\source{stacks:0FX2}
\href{https://stacks.math.columbia.edu/tag/0FX2}{\texttt{Stacks tag 0FX2}}
\group{derived}
...
\begin{lemma}[Add star]
\label{derived-lemma-add-star}
\source{stacks:0FX3}
\href{https://stacks.math.columbia.edu/tag/0FX3}{\texttt{Stacks tag 0FX3}}
\group{derived}
...
\source{stacks:0FX4}
\href{https://stacks.math.columbia.edu/tag/0FX4}{\texttt{Stacks tag 0FX4}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-associativity-star, derived-lemma-smd-star, derived-lemma-add-star}

Immediate from Lemmas \ref{derived-lemma-associativity-star}, \ref{derived-lemma-smd-star}, and
\ref{derived-lemma-add-star}.
\end{proof}

\begin{remark}[Operations functor]
\label{derived-remark-operations-functor}
\source{stacks:0FX5}
\href{https://stacks.math.columbia.edu/tag/0FX5}{\texttt{Stacks tag 0FX5}}
\group{derived}
...
\begin{remark}[Operations unions]
\label{derived-remark-operations-unions}
\source{stacks:0FX6}
\href{https://stacks.math.columbia.edu/tag/0FX6}{\texttt{Stacks tag 0FX6}}
\group{derived}
...
\begin{lemma}[In cone n]
\label{derived-lemma-in-cone-n}
\source{stacks:0FX7}
\href{https://stacks.math.columbia.edu/tag/0FX7}{\texttt{Stacks tag 0FX7}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-cone-n}

We will use Lemma \ref{derived-lemma-cone-n} without further mention.
...
\begin{lemma}[Forward cone n]
\label{derived-lemma-forward-cone-n}
\source{stacks:0FX8}
\href{https://stacks.math.columbia.edu/tag/0FX8}{\texttt{Stacks tag 0FX8}}
\group{derived}
...
they call ``\'epaisse'', see Definition \ref{derived-definition-saturated}, and
...
Section \ref{derived-section-operate-on-full} we have
$$
...
(by Lemma \ref{derived-lemma-add-star}) subcategory of $\mathcal{D}$ preserved
...
\begin{lemma}[Generated by E explicit]
\label{derived-lemma-generated-by-E-explicit}
\source{stacks:0FX9}
\href{https://stacks.math.columbia.edu/tag/0FX9}{\texttt{Stacks tag 0FX9}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-associativity-star, derived-lemma-smd-star, derived-remark-operations-unions, derived-lemma-cone-n}

The left equality in the displayed formula follows from
Lemmas \ref{derived-lemma-associativity-star} and \ref{derived-lemma-smd-star}
...
we see from Remark \ref{derived-remark-operations-unions} and
Lemma \ref{derived-lemma-smd-star} that we get the equality on the right.
Then the final statement follows from the remark and the
corresponding statement of Lemma \ref{derived-lemma-cone-n}.
\end{proof}

\begin{lemma}[Find smallest containing E]
\label{derived-lemma-find-smallest-containing-E}
\source{stacks:0ATG}
\href{https://stacks.math.columbia.edu/tag/0ATG}{\texttt{Stacks tag 0ATG}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-generated-by-E-explicit}

The equality on the right follows from
Lemma \ref{derived-lemma-generated-by-E-explicit}.
...
$X \in \langle E \rangle_{a + b}$ by Lemma \ref{derived-lemma-generated-by-E-explicit}.
...
\source{stacks:09SJ}
\href{https://stacks.math.columbia.edu/tag/09SJ}{\texttt{Stacks tag 09SJ}}
\group{derived}
...
\begin{lemma}[Right orthogonal]
\label{derived-lemma-right-orthogonal}
\source{stacks:09SK}
\href{https://stacks.math.columbia.edu/tag/09SK}{\texttt{Stacks tag 09SK}}
\group{derived}
...
\begin{lemma}[Classical generator generator]
\label{derived-lemma-classical-generator-generator}
\source{stacks:09SL}
\href{https://stacks.math.columbia.edu/tag/09SL}{\texttt{Stacks tag 09SL}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-find-smallest-containing-E, derived-lemma-generated-by-E-explicit}
...
for some $m \geq 1$ by Lemma \ref{derived-lemma-find-smallest-containing-E}.
...
\langle E \rangle_{nm}
$$
as desired. Here we used Lemma \ref{derived-lemma-generated-by-E-explicit}.
\end{proof}

\begin{remark}[Check on generator]
\label{derived-remark-check-on-generator}
\source{stacks:0ATH}
\href{https://stacks.math.columbia.edu/tag/0ATH}{\texttt{Stacks tag 0ATH}}
\group{derived}
...
\source{stacks:07LS}
\href{https://stacks.math.columbia.edu/tag/07LS}{\texttt{Stacks tag 07LS}}
\group{derived}
...
\begin{lemma}[Compact objects subcategory]
\label{derived-lemma-compact-objects-subcategory}
\source{stacks:09QH}
\href{https://stacks.math.columbia.edu/tag/09QH}{\texttt{Stacks tag 09QH}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-representable-homological, derived-lemma-projectors-have-images-triangulated}
...
\begin{lemma}[Write as colimit]
\label{derived-lemma-write-as-colimit}
\source{stacks:09SN}
\href{https://stacks.math.columbia.edu/tag/09SN}{\texttt{Stacks tag 09SN}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-commutes-with-countable-sums}
...
Lemma \ref{derived-lemma-commutes-with-countable-sums}
...
\begin{lemma}[Factor through]
\label{derived-lemma-factor-through}
\source{stacks:09SP}
\href{https://stacks.math.columbia.edu/tag/09SP}{\texttt{Stacks tag 09SP}}
\group{derived}

\uses{derived-lemma-write-as-colimit}
With assumptions and notation as in Lemma \ref{derived-lemma-write-as-colimit}.
...
$$
\begin{array}{cccc}E' \longrightarrow\downarrow & C' \longrightarrow\downarrow & C \longrightarrow\downarrow & E'[1] \downarrow \\ Y_{n - 1} \longrightarrow & X_{n - 1} \longrightarrow & X_n \longrightarrow & Y_{n - 1}[1]\end{array}
$$
...
\source{stacks:09SQ}
\href{https://stacks.math.columbia.edu/tag/09SQ}{\texttt{Stacks tag 09SQ}}
\group{derived}
...
\begin{proposition}[Generator versus classical generator]
\label{derived-proposition-generator-versus-classical-generator}
\source{stacks:09SR}
\href{https://stacks.math.columbia.edu/tag/09SR}{\texttt{Stacks tag 09SR}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-right-orthogonal, derived-lemma-write-as-colimit, derived-lemma-commutes-with-countable-sums, derived-lemma-factor-through}
...
and Lemma \ref{derived-lemma-right-orthogonal} that $E$ is a generator
for $\mathcal{D}$.

\medskip\noindent
The converse is more interesting. Assume that $E$ is a generator
for $\mathcal{D}$. Let $X$ be a compact object of $\mathcal{D}$.
Apply Lemma \ref{derived-lemma-write-as-colimit} with $I = \{1\}$ and
$E_1 = E$ to write
$$
X = \text{hocolim} X_n
$$
...
some $n$ (Lemma \ref{derived-lemma-commutes-with-countable-sums}).
Thus $X$ is a direct summand of $X_n$.
By Lemma \ref{derived-lemma-factor-through} we see that $X$ is an
...
\source{stacks:0A8F}
\href{https://stacks.math.columbia.edu/tag/0A8F}{\texttt{Stacks tag 0A8F}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-commutes-with-countable-sums, derived-lemma-homological-functor-kernel, derived-lemma-write-as-colimit}
...
$$
by Lemma \ref{derived-lemma-commutes-with-countable-sums}
...
Lemma \ref{derived-lemma-homological-functor-kernel}). Moreover, as both
...
Lemma \ref{derived-lemma-write-as-colimit} that $\mathcal{D}' = \mathcal{D}$
...
\source{stacks:0A8G}
\href{https://stacks.math.columbia.edu/tag/0A8G}{\texttt{Stacks tag 0A8G}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-brown, derived-lemma-adjoint-is-exact}
...
Lemma \ref{derived-lemma-brown} we find an object $X$ of $\mathcal{D}$ such that
...
Exactness follows from Lemma \ref{derived-lemma-adjoint-is-exact}.
\end{proof}
...
\begin{lemma}[Brown bis]
\label{derived-lemma-brown-bis}
\source{stacks:0GYG}
\href{https://stacks.math.columbia.edu/tag/0GYG}{\texttt{Stacks tag 0GYG}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-brown, derived-lemma-homological-functor-kernel}

This proof is very similar to the proof of Lemma \ref{derived-lemma-brown}.
...
\begin{proposition}[Brown bis]
\label{derived-proposition-brown-bis}
\source{stacks:0GYH}
\href{https://stacks.math.columbia.edu/tag/0GYH}{\texttt{Stacks tag 0GYH}}
\group{derived}

\uses{derived-lemma-brown-bis}
Let $\mathcal{D}$ be a triangulated category with direct sums.
Assume there exists a set $\mathcal{E}$ of objects of $\mathcal{D}$
satisfying conditions (1) and (2) of Lemma \ref{derived-lemma-brown-bis}.
Let $F : \mathcal{D} \to \mathcal{D}'$ be an exact functor of triangulated
...
\begin{proof}
\uses{derived-lemma-brown-bis, derived-lemma-adjoint-is-exact}
...
This is a cohomological functor as $F$ is exact and transforms direct sums
into products as $F$ transforms direct sums into direct sums. Thus by
Lemma \ref{derived-lemma-brown-bis} we find an object $X$ of $\mathcal{D}$ such that
$\Hom_\mathcal{D}(W, X) = \Hom_{\mathcal{D}'}(F(W), Y)$.
The existence of the adjoint follows from
Categories, Lemma \ref{categories-lemma-adjoint-exists}.
Exactness follows from Lemma \ref{derived-lemma-adjoint-is-exact}.
...
\source{stacks:0FXB}
\href{https://stacks.math.columbia.edu/tag/0FXB}{\texttt{Stacks tag 0FXB}}
\group{derived}
...
\begin{lemma}[Pre prepare adjoint]
\label{derived-lemma-pre-prepare-adjoint}
\source{stacks:0CQQ}
\href{https://stacks.math.columbia.edu/tag/0CQQ}{\texttt{Stacks tag 0CQQ}}
\group{derived}
...
By Lemma \ref{derived-lemma-representable-homological} the functor
...
\begin{lemma}[Pre prepare adjoint dual]
\label{derived-lemma-pre-prepare-adjoint-dual}
\source{stacks:0H0M}
\href{https://stacks.math.columbia.edu/tag/0H0M}{\texttt{Stacks tag 0H0M}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-pre-prepare-adjoint}

Dual to Lemma \ref{derived-lemma-pre-prepare-adjoint}.
\end{proof}

\begin{lemma}[Orthogonal triangulated]
\label{derived-lemma-orthogonal-triangulated}
\source{stacks:0FXC}
\href{https://stacks.math.columbia.edu/tag/0FXC}{\texttt{Stacks tag 0FXC}}
\group{derived}

\uses{derived-definition-saturated}
...
are strictly full, saturated\footnote{Definition \ref{derived-definition-saturated}.},
triangulated subcagories of $\mathcal{D}$.
\end{lemma}

\begin{proof}
\uses{derived-lemma-triangulated-subcategory, derived-lemma-pre-prepare-adjoint}
...
X \to Y \to Z \to X[1]
$$
of $\mathcal{D}$. By Lemma \ref{derived-lemma-triangulated-subcategory} it
suffices to show that if $X$ and $Y$ are in $\mathcal{A}^\perp$, then
$Z$ is in $\mathcal{A}^\perp$. This is immediate from
Lemma \ref{derived-lemma-pre-prepare-adjoint}.
\end{proof}

\begin{lemma}[Prepare adjoint]
\label{derived-lemma-prepare-adjoint}
\source{stacks:0CQR}
\href{https://stacks.math.columbia.edu/tag/0CQR}{\texttt{Stacks tag 0CQR}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-pre-prepare-adjoint, derived-proposition-9, derived-lemma-orthogonal-triangulated, derived-lemma-split}
...
$\Hom(A_1, A_2) = \Hom(A_1, X_2)$ by Lemma \ref{derived-lemma-pre-prepare-adjoint}
there is a unique morphism $A_1 \to A_2$ such that the diagram
$$
\begin{array}{cc}A_1 \downarrow\longrightarrow & X_1 \downarrow \\ A_2 \longrightarrow & X_2\end{array}
$$
commutes. Choose an extension of this to a diagram
$$
\begin{array}{cccc}A_1 \longrightarrow\downarrow & X_1 \longrightarrow\downarrow & Q_1 \longrightarrow\downarrow & A_1[1] \downarrow \\ A_2 \longrightarrow\downarrow & X_2 \longrightarrow\downarrow & Q_2 \longrightarrow\downarrow & A_2[1] \downarrow \\ A_3 \longrightarrow\downarrow & X_3 \longrightarrow\downarrow & Q_3 \longrightarrow\downarrow & A_3[1] \downarrow \\ A_1[1] \longrightarrow & X_1[1] \longrightarrow & Q_1[1] \longrightarrow & A_1[2]\end{array}
$$
as in Proposition \ref{derived-proposition-9}. By TR3 we see that
...
by Lemma \ref{derived-lemma-orthogonal-triangulated}.
...
via Lemma \ref{derived-lemma-split}.
\end{proof}

\begin{lemma}[Prepare adjoint dual]
\label{derived-lemma-prepare-adjoint-dual}
\source{stacks:0H0N}
\href{https://stacks.math.columbia.edu/tag/0H0N}{\texttt{Stacks tag 0H0N}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-prepare-adjoint}

Dual to Lemma \ref{derived-lemma-prepare-adjoint}.
\end{proof}

\begin{lemma}[Right adjoint]
\label{derived-lemma-right-adjoint}
\source{stacks:0CQS}
\href{https://stacks.math.columbia.edu/tag/0CQS}{\texttt{Stacks tag 0CQS}}
\group{derived}
...
(Definition \ref{derived-definition-saturated}) and if $\mathcal{A}$
is strictly full in $\mathcal{D}$, then
$\mathcal{A} = {}^\perp(\mathcal{A}^\perp)$.
\end{lemma}

\begin{proof}
\uses{derived-lemma-pre-prepare-adjoint, derived-lemma-orthogonal-triangulated, derived-lemma-split}
...
by Lemma \ref{derived-lemma-pre-prepare-adjoint}.

\medskip\noindent
Assume (2). We will construct the adjoint $v$ explicitly.
...
$\Hom(A, A') = \Hom(A, Y)$ by Lemma \ref{derived-lemma-pre-prepare-adjoint}
there is a unique morphism $f' : A \to A'$ such that the diagram
$$
\begin{array}{cc}A \underset{f'}{\downarrow}\longrightarrow & X \overset{f}{\downarrow} \\ A' \longrightarrow & Y\end{array}
$$
commutes. Hence we can set $v(f) = f'$ to get a functor.
To see that $v$ is adjoint to the inclusion morphism use
Lemma \ref{derived-lemma-pre-prepare-adjoint} again.
...
$\mathcal{A}$ will be saturated by Lemma \ref{derived-lemma-orthogonal-triangulated}.
...
$A \cong X \oplus B[-1]$ by Lemma \ref{derived-lemma-split}.
Since $\Hom(A, B[-1]) = 0$ as $B \in \mathcal{A}^\perp$
this implies $B[-1] = 0$ and $A \cong X$ as desired.
\end{proof}

\begin{lemma}[Left adjoint]
\label{derived-lemma-left-adjoint}
\source{stacks:0CQT}
\href{https://stacks.math.columbia.edu/tag/0CQT}{\texttt{Stacks tag 0CQT}}
\group{derived}
...
(Definition \ref{derived-definition-saturated}) and if $\mathcal{B}$
is strictly full in $\mathcal{D}$, then
$\mathcal{B} = ({}^\perp\mathcal{B})^\perp$.
\end{lemma}

\begin{proof}
\uses{derived-lemma-right-adjoint}

Dual to Lemma \ref{derived-lemma-right-adjoint}.
\end{proof}

\begin{definition}[Admissible]
\label{derived-definition-admissible}
\source{stacks:0FXD}
\href{https://stacks.math.columbia.edu/tag/0FXD}{\texttt{Stacks tag 0FXD}}
\group{derived}

\uses{derived-lemma-right-adjoint, derived-lemma-left-adjoint}
...
satisfying the equivalent conditions of Lemma \ref{derived-lemma-right-adjoint}.
A {\it left admissible}
subcategory of $\mathcal{D}$ is a strictly full triangulated subcategory
satisfying the equivalent conditions of Lemma \ref{derived-lemma-left-adjoint}.
...
\begin{proposition}[Summarize admissible]
\label{derived-proposition-summarize-admissible}
\source{stacks:0H0P}
\href{https://stacks.math.columbia.edu/tag/0H0P}{\texttt{Stacks tag 0H0P}}
\group{derived}
...
from Lemmas \ref{derived-lemma-right-adjoint} and \ref{derived-lemma-left-adjoint} (small
...
in the proof of Lemma \ref{derived-lemma-right-adjoint}.
...
\begin{definition}[Postnikov system]
\label{derived-definition-postnikov-system}
\source{stacks:0D7Z}
\href{https://stacks.math.columbia.edu/tag/0D7Z}{\texttt{Stacks tag 0D7Z}}
\group{derived}
...
\vcenter{
\begin{array}{cccc}X_n \longrightarrow\downarrow & X_{n - 1} \longrightarrow\downarrow & \ldots \longrightarrow & X_0 \downarrow \\ X'_n \longrightarrow & X'_{n - 1} \longrightarrow & \ldots \longrightarrow & X'_0\end{array}
}
\end{equation}
...
\begin{example}[Key postnikov]
\label{derived-example-key-postnikov}
\source{stacks:0D8Z}
\href{https://stacks.math.columbia.edu/tag/0D8Z}{\texttt{Stacks tag 0D8Z}}
\group{derived}

\uses{derived-definition-postnikov-system, derived-lemma-colim-hocolim}
...
Definition \ref{derived-definition-postnikov-system} for
...
Lemma \ref{derived-lemma-colim-hocolim}.
\end{example}

Given a complex $X_n \to X_{n - 1} \to \ldots \to X_0$ and a Postnikov
system as in Definition \ref{derived-definition-postnikov-system}
...
picture for $n = 3$:
$$
\begin{array}{ccccccc}Y_0 \longrightarrow &  & Y_1[1] \swarrow\longrightarrow &  & Y_2[2] \swarrow\longrightarrow &  & Y_3[3] \swarrow \\  & X_1[1] \underset{+1}{\nwarrow} &  & X_2[2] \underset{+1}{\longleftarrow}\underset{+1}{\nwarrow} &  & X_3[3] \underset{+1}{\longleftarrow}\underset{+1}{\nwarrow} & \end{array}
$$
...
\begin{lemma}[Postnikov system small cases]
\label{derived-lemma-postnikov-system-small-cases}
\source{stacks:0D81}
\href{https://stacks.math.columbia.edu/tag/0D81}{\texttt{Stacks tag 0D81}}
\group{derived}
...
\begin{lemma}[Maps postnikov systems vanishing]
\label{derived-lemma-maps-postnikov-systems-vanishing}
\source{stacks:0D82}
\href{https://stacks.math.columbia.edu/tag/0D82}{\texttt{Stacks tag 0D82}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-representable-homological, derived-lemma-postnikov-system-small-cases}
...
$$
The long exact sequence of Lemma \ref{derived-lemma-representable-homological}
...
established in Lemma \ref{derived-lemma-postnikov-system-small-cases}.
...
$$
\begin{array}{cc}X_n \longrightarrow\downarrow & Y_{n - 1} \downarrow \\ X'_n \longrightarrow & Y'_{n - 1}\end{array}
$$
...
$$
\begin{array}{cccc}Y_{n - 1}[-1] \downarrow\longrightarrow & Y_n \longrightarrow\downarrow & X_n \longrightarrow\downarrow & Y_{n - 1} \downarrow \\ Y'_{n - 1}[-1] \longrightarrow & Y'_n \longrightarrow & X'_n \longrightarrow & Y'_{n - 1}\end{array}
$$
by TR3.
\end{proof}

\begin{lemma}[Uniqueness maps postnikov systems]
\label{derived-lemma-uniqueness-maps-postnikov-systems}
\source{stacks:0FXE}
\href{https://stacks.math.columbia.edu/tag/0FXE}{\texttt{Stacks tag 0FXE}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-maps-postnikov-systems-vanishing, derived-lemma-uniqueness-third-arrow}

Proof of (1). Look at the following diagram
$$
\begin{array}{ccccc}Y_0 \longrightarrow\downarrow & Y_1[1] \longrightarrow\swarrow & Y_2[2] \longrightarrow\swarrow & \ldots \longrightarrow & Y_n[n] \swarrow \\ Y'_n[n] &  &  &  & \end{array}
$$
...
Lemma \ref{derived-lemma-maps-postnikov-systems-vanishing}
and arguing by induction on $n$ it suffices to show that the dotted arrow
in the morphism of triangles
$$
\begin{array}{cccc}Y_{n - 1}[-1] \downarrow\longrightarrow & Y_n \longrightarrow\downarrow & X_n \longrightarrow\downarrow & Y_{n - 1} \downarrow \\ Y'_{n - 1}[-1] \longrightarrow & Y'_n \longrightarrow & X'_n \longrightarrow & Y'_{n - 1}\end{array}
$$
is unique. By Lemma \ref{derived-lemma-uniqueness-third-arrow} part (5)
...
\begin{lemma}[Existence postnikov system]
\label{derived-lemma-existence-postnikov-system}
\source{stacks:0D83}
\href{https://stacks.math.columbia.edu/tag/0D83}{\texttt{Stacks tag 0D83}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-postnikov-system-small-cases, derived-lemma-representable-homological, derived-lemma-maps-postnikov-systems-vanishing, derived-lemma-third-isomorphism-triangle}

We argue by induction on $n$. The cases $n = 0, 1, 2$
follow from Lemma \ref{derived-lemma-postnikov-system-small-cases}.
Assume $n > 2$.
...
(see Lemma \ref{derived-lemma-representable-homological})
...
Lemma \ref{derived-lemma-maps-postnikov-systems-vanishing} part (1)
...
proven in Lemma \ref{derived-lemma-maps-postnikov-systems-vanishing} part (2)
and Lemma \ref{derived-lemma-third-isomorphism-triangle} to show all the maps are
isomorphisms.
\end{proof}
...
\begin{lemma}[Essentially constant]
\label{derived-lemma-essentially-constant}
\source{stacks:0G39}
\href{https://stacks.math.columbia.edu/tag/0G39}{\texttt{Stacks tag 0G39}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-when-split, derived-lemma-split}
...
Lemmas \ref{derived-lemma-when-split} and \ref{derived-lemma-split}.
...
\begin{lemma}[Essentially constant 2 out of 3]
\label{derived-lemma-essentially-constant-2-out-of-3}
\source{stacks:0G3A}
\href{https://stacks.math.columbia.edu/tag/0G3A}{\texttt{Stacks tag 0G3A}}
\group{derived}
...
$$
\begin{array}{cccc}A_n \downarrow\longrightarrow & B_n \downarrow\longrightarrow & C_n \downarrow\longrightarrow & A_n[1] \downarrow \\ A \longrightarrow & B \longrightarrow & C \longrightarrow & A[1]\end{array}
$$
...
\begin{proof}
\uses{derived-lemma-essentially-constant}

After renumbering we may assume that $A_n = A \oplus A'_n$ and
$C_n = C \oplus C'_n$ for inverse systems $(A'_n)$ and $(C'_n)$
which are essentially zero, see Lemma \ref{derived-lemma-essentially-constant}.
...
a commutative diagram
$$
\begin{array}{ccccc}\ldots \longrightarrow & \Hom_\mathcal{D}(C, D) \longrightarrow\downarrow & \Hom_\mathcal{D}(B, D) \longrightarrow\downarrow & \Hom_\mathcal{D}(A, D) \longrightarrow\downarrow & \ldots \\ \ldots \longrightarrow & \colim \Hom_\mathcal{D}(C_n, D) \longrightarrow & \colim \Hom_\mathcal{D}(B_n, D) \longrightarrow & \colim \Hom_\mathcal{D}(A_n, D) \longrightarrow & \ldots\end{array}
$$
...
\begin{lemma}[Essentially constant cohomology]
\label{derived-lemma-essentially-constant-cohomology}
\source{stacks:0G3B}
\href{https://stacks.math.columbia.edu/tag/0G3B}{\texttt{Stacks tag 0G3B}}
\group{derived}
...
\begin{proof}
\uses{derived-remark-truncation-distinguished-triangle, derived-lemma-essentially-constant-2-out-of-3}

By Remark \ref{derived-remark-truncation-distinguished-triangle} we obtain
...
By Lemma \ref{derived-lemma-essentially-constant-2-out-of-3} we find that
$A_n$ is an essentially constant system. We omit the proof of
the statement on cohomologies (hint: use the final part of
Lemma \ref{derived-lemma-essentially-constant-2-out-of-3}).
\end{proof}

\begin{lemma}[Pro isomorphism]
\label{derived-lemma-pro-isomorphism}
\source{stacks:0G3C}
\href{https://stacks.math.columbia.edu/tag/0G3C}{\texttt{Stacks tag 0G3C}}
\group{derived}
...
\colim \Hom(C_n[-1], X) \to
$$
Exactness follows from Lemma \ref{derived-lemma-representable-homological}
combined with
...
\begin{lemma}[Pro isomorphism bis]
\label{derived-lemma-pro-isomorphism-bis}
\source{stacks:0G3D}
\href{https://stacks.math.columbia.edu/tag/0G3D}{\texttt{Stacks tag 0G3D}}
\group{derived}
...
\begin{proof}
\uses{derived-lemma-pro-isomorphism, derived-lemma-essentially-constant-cohomology}

We can inductively extend the maps $A_n \to B_n$ to an inverse system of
distinguished triangles $A_n \to B_n \to C_n \to A_n[1]$ by
axiom TR3. By Lemma \ref{derived-lemma-pro-isomorphism} it suffices to prove
that $C_n$ is pro-zero. By Lemma \ref{derived-lemma-essentially-constant-cohomology}
