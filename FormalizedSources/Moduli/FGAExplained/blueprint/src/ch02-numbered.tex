...
\begin{remark}[Source statement 2.10]\label{fga-rem-2-10}\dcref{2.10}\source{fga-explained:page-0028}\uses{}
\begin{verbatim}
...
\begin{remark}[Source statement 2.14]\label{fga-rem-2-14}\dcref{2.14}\source{fga-explained:page-0030}\uses{}
\begin{verbatim}
...
\begin{remark}[Source statement 2.23]\label{fga-rem-2-23}\dcref{2.23}\source{fga-explained:page-0035}\uses{}
\begin{verbatim}
...
\begin{remark}[Source statement 2.25]\label{fga-rem-2-25}\dcref{2.25}\source{fga-explained:page-0036}\uses{}
\begin{verbatim}
...
\begin{lemma}[Source statement 2.43]\label{fga-lem-2-43}\dcref{2.43}\source{fga-explained:page-0042}\uses{}
\begin{verbatim}
...
\begin{proposition}[Source statement 2.49]\label{fga-pro-2-49}\dcref{2.49}\source{fga-explained:page-0043}\uses{fga-prop-2-42}
\begin{verbatim}
...
\begin{proposition}[Source statement 2.54]\label{fga-pro-2-54}\dcref{2.54}\source{fga-explained:page-0044}\uses{}
\begin{verbatim}
...
\begin{remark}[Source statement 2.56]\label{fga-rem-2-56}\dcref{2.56}\source{fga-explained:page-0045}\uses{}
\begin{verbatim}
...
\begin{lemma}[Source statement 2.61]\label{fga-lem-2-61}\dcref{2.61}\source{fga-explained:page-0047}\uses{}
\begin{verbatim}
The sequence
                         0       AJ-.B^^^^Bi           B
isexact.
