...
\source{stacks:01G0}
\href{https://stacks.math.columbia.edu/tag/01G0}{\texttt{Stacks tag 01G0}}
\group{hypercovering}
...
\begin{definition}[SR F]
\label{hypercovering-definition-SR-F}
\source{stacks:01G1}
\href{https://stacks.math.columbia.edu/tag/01G1}{\texttt{Stacks tag 01G1}}
\group{hypercovering}
...
$$
\begin{array}{cc}\text{SR}(\mathcal{C}, X) \underset{F}{\longrightarrow}\downarrow & \textit{PSh}(\mathcal{C})/h_X \downarrow \\ \text{SR}(\mathcal{C}) \overset{F}{\longrightarrow} & \textit{PSh}(\mathcal{C})\end{array}
$$
Next we discuss the existence of limits in the category of semi-representable
objects.

\begin{lemma}[Coprod prod SR]
\label{hypercovering-lemma-coprod-prod-SR}
\source{stacks:01G2}
\href{https://stacks.math.columbia.edu/tag/01G2}{\texttt{Stacks tag 01G2}}
\group{hypercovering}
...
\begin{definition}[Covering SR]
\label{hypercovering-definition-covering-SR}
\source{stacks:01G3}
\href{https://stacks.math.columbia.edu/tag/01G3}{\texttt{Stacks tag 01G3}}
\group{hypercovering}
...
\begin{lemma}[Covering permanence]
\label{hypercovering-lemma-covering-permanence}
\source{stacks:01G4}
\href{https://stacks.math.columbia.edu/tag/01G4}{\texttt{Stacks tag 01G4}}
\group{hypercovering}
...
\begin{proof}
\uses{hypercovering-lemma-coprod-prod-SR}
...
Lemma \ref{hypercovering-lemma-coprod-prod-SR}
...
By Lemma \ref{hypercovering-lemma-coprod-prod-SR} and
...
\begin{definition}[Hypercovering]
\label{hypercovering-definition-hypercovering}
\source{stacks:01G5}
\href{https://stacks.math.columbia.edu/tag/01G5}{\texttt{Stacks tag 01G5}}
\group{hypercovering}
...
\begin{example}[\v Cech hypercoverings]

\label{hypercovering-example-cech}
\source{stacks:01G6}
\href{https://stacks.math.columbia.edu/tag/01G6}{\texttt{Stacks tag 01G6}}
\group{hypercovering}

\uses{hypercovering-definition-hypercovering}
...
K = \text{cosk}_0 K_0.
$$
Clearly $K$ passes condition (1) of Definition \ref{hypercovering-definition-hypercovering}.
...
\source{stacks:0GM9}
\href{https://stacks.math.columbia.edu/tag/0GM9}{\texttt{Stacks tag 0GM9}}
\group{hypercovering}
...
Definition \ref{hypercovering-definition-hypercovering}
...
\begin{example}[\v Cech hypercovering associated to a cover]

\label{hypercovering-example-cech-cover}
\source{stacks:0GMA}
\href{https://stacks.math.columbia.edu/tag/0GMA}{\texttt{Stacks tag 0GMA}}
\group{hypercovering}

\uses{hypercovering-example-cech, hypercovering-example-hypercovering-in-C}
...
Example \ref{hypercovering-example-cech} and of
Example \ref{hypercovering-example-hypercovering-in-C}.
\end{example}

\begin{lemma}[Hypercoverings set]
\label{hypercovering-lemma-hypercoverings-set}
\source{stacks:01G7}
\href{https://stacks.math.columbia.edu/tag/01G7}{\texttt{Stacks tag 01G7}}
\group{hypercovering}
...
\begin{remark}[Hypercoverings really set]
\label{hypercovering-remark-hypercoverings-really-set}
\source{stacks:01G8}
\href{https://stacks.math.columbia.edu/tag/01G8}{\texttt{Stacks tag 01G8}}
\group{hypercovering}
...
\begin{lemma}[Hypercovering F]
\label{hypercovering-lemma-hypercovering-F}
\source{stacks:01G9}
\href{https://stacks.math.columbia.edu/tag/01G9}{\texttt{Stacks tag 01G9}}
\group{hypercovering}
...
\begin{proof}
\uses{hypercovering-lemma-coprod-prod-SR, hypercovering-definition-covering-SR}
...
By Lemma \ref{hypercovering-lemma-coprod-prod-SR} the functor
...
functor $F$ to a covering as in Definition \ref{hypercovering-definition-covering-SR},
...
\source{stacks:01GB}
\href{https://stacks.math.columbia.edu/tag/01GB}{\texttt{Stacks tag 01GB}}
\group{hypercovering}
...
\begin{lemma}[Compare cosk0]
\label{hypercovering-lemma-compare-cosk0}
\source{stacks:01GC}
\href{https://stacks.math.columbia.edu/tag/01GC}{\texttt{Stacks tag 01GC}}
\group{hypercovering}
...
\source{stacks:01GD}
\href{https://stacks.math.columbia.edu/tag/01GD}{\texttt{Stacks tag 01GD}}
\group{hypercovering}
...
\begin{proof}
\uses{hypercovering-lemma-compare-cosk0}

This proof is exactly the same as the proof of
Lemma \ref{hypercovering-lemma-compare-cosk0} above. Namely,
...
\begin{lemma}[Acyclic hypercover sheaves]
\label{hypercovering-lemma-acyclic-hypercover-sheaves}
\source{stacks:01GE}
\href{https://stacks.math.columbia.edu/tag/01GE}{\texttt{Stacks tag 01GE}}
\group{hypercovering}
...
\begin{proof}
\uses{hypercovering-lemma-compare-cosk0, hypercovering-lemma-acyclicity}
...
\medskip\noindent
By Lemma \ref{hypercovering-lemma-compare-cosk0} we see that
...
sheafification. By Lemma \ref{hypercovering-lemma-acyclicity} we conclude that
$H_i(K^n) = H_i(K^{n - 1})$.
Combined with the above this proves the lemma.
\end{proof}

\begin{lemma}[Hypercovering acyclic]
\label{hypercovering-lemma-hypercovering-acyclic}
\source{stacks:01GF}
\href{https://stacks.math.columbia.edu/tag/01GF}{\texttt{Stacks tag 01GF}}
\group{hypercovering}
...
\begin{proof}
\uses{hypercovering-lemma-acyclic-hypercover-sheaves, hypercovering-lemma-hypercovering-F}

Combine Lemmas \ref{hypercovering-lemma-acyclic-hypercover-sheaves}
and \ref{hypercovering-lemma-hypercovering-F}.
\end{proof}

\section{{\v C}
ech cohomology and hypercoverings}
...
\source{stacks:01GV}
\href{https://stacks.math.columbia.edu/tag/01GV}{\texttt{Stacks tag 01GV}}
\group{hypercovering}
...
The analogue of Cohomology, Lemma \ref{hypercovering-lemma-injective-trivial-cech}
in this case is the following.

\begin{lemma}[Injective trivial cech]
\label{hypercovering-lemma-injective-trivial-cech}
\source{stacks:01GW}
\href{https://stacks.math.columbia.edu/tag/01GW}{\texttt{Stacks tag 01GW}}
\group{hypercovering}
...
\begin{proof}
\uses{hypercovering-definition-homology, hypercovering-lemma-hypercovering-acyclic, hypercovering-lemma-h0-cech}
...
\end{equation}
see Definition \ref{hypercovering-definition-homology} for notation.
The complex of sheaves $s(\mathbf{Z}_{F(K)}^\#)$ is quasi-isomorphic
to $\mathbf{Z}_X^\#$ if $K$ is a hypercovering, see
Lemma \ref{hypercovering-lemma-hypercovering-acyclic}. We conclude
...
$$
for $i > 0$. Combined with Lemma \ref{hypercovering-lemma-h0-cech} the lemma is proved.
\end{proof}
...
\source{stacks:01GY}
\href{https://stacks.math.columbia.edu/tag/01GY}{\texttt{Stacks tag 01GY}}
\group{hypercovering}
...
\begin{proof}
\uses{hypercovering-lemma-injective-trivial-cech}
...
\medskip\noindent
By Lemma \ref{hypercovering-lemma-injective-trivial-cech}
...
conclusion of Lemma \ref{hypercovering-lemma-hypercovering-F}.
Therefore the following definition makes sense.

\begin{definition}[Hypercovering variant]
\label{hypercovering-definition-hypercovering-variant}
\source{stacks:09VU}
\href{https://stacks.math.columbia.edu/tag/09VU}{\texttt{Stacks tag 09VU}}
\group{hypercovering}
...
(Lemma \ref{hypercovering-lemma-coprod-prod-SR}) which suffices
...
\begin{lemma}[H0 cech variant]
\label{hypercovering-lemma-h0-cech-variant}
\source{stacks:09VV}
\href{https://stacks.math.columbia.edu/tag/09VV}{\texttt{Stacks tag 09VV}}
\group{hypercovering}
...
and the fact that
$$
\begin{array}{ccc}F(K_1) \longrightarrow\longrightarrow & F(K_0) \longrightarrow & \mathcal{G}\end{array}
$$
becomes an coequalizer diagram after sheafification.
\end{proof}

\begin{lemma}[Injective trivial cech variant]
\label{hypercovering-lemma-injective-trivial-cech-variant}
\source{stacks:09VW}
\href{https://stacks.math.columbia.edu/tag/09VW}{\texttt{Stacks tag 09VW}}
\group{hypercovering}
...
\begin{proof}
\uses{hypercovering-lemma-acyclic-hypercover-sheaves, hypercovering-lemma-h0-cech-variant}
...
Lemma \ref{hypercovering-lemma-acyclic-hypercover-sheaves}. We conclude
...
for $i > 0$. Combined with Lemma \ref{hypercovering-lemma-h0-cech-variant}
the lemma is proved.
\end{proof}

\begin{lemma}[Cech spectral sequence variant]
\label{hypercovering-lemma-cech-spectral-sequence-variant}
\source{stacks:09VX}
\href{https://stacks.math.columbia.edu/tag/09VX}{\texttt{Stacks tag 09VX}}
\group{hypercovering}
...
\begin{proof}
\uses{hypercovering-lemma-injective-trivial-cech-variant}
...
\medskip\noindent
By Lemma \ref{hypercovering-lemma-injective-trivial-cech-variant} the complexes
...
\begin{lemma}[Cech spectral sequence verdier]
\label{hypercovering-lemma-cech-spectral-sequence-verdier}
\source{stacks:09VY}
\href{https://stacks.math.columbia.edu/tag/09VY}{\texttt{Stacks tag 09VY}}
\group{hypercovering}
...
\begin{proof}
\uses{hypercovering-lemma-cech-spectral-sequence-variant}

This is a special case of Lemma \ref{hypercovering-lemma-cech-spectral-sequence-variant}.
\end{proof}
...
\begin{lemma}[Funny gamma]
\label{hypercovering-lemma-funny-gamma}
\source{stacks:01GH}
\href{https://stacks.math.columbia.edu/tag/01GH}{\texttt{Stacks tag 01GH}}
\group{hypercovering}
...
$$
\begin{array}{ccc}M_{n + 1} \downarrow\longrightarrow\overset{\gamma}{\searrow} &  & (\text{cosk}_n \text{sk}_n M)_{n + 1} \downarrow \\  & L_{n + 1}
\times_{(\text{cosk}_n \text{sk}_n L)_{n + 1}}
(\text{cosk}_n \text{sk}_n M)_{n + 1}
\swarrow\nearrow &  \\ L_{n + 1} \longrightarrow &  & (\text{cosk}_n \text{sk}_n L)_{n + 1}\end{array}
$$
...
\begin{proof}
\uses{hypercovering-lemma-covering-permanence, hypercovering-definition-hypercovering}

The morphism $(K \times_L M)_0 = K_0 \times_{L_0} M_0 \to K_0$
is a base change of a covering by (2), hence a covering, see
Lemma \ref{hypercovering-lemma-covering-permanence}. And $K_0 \to \{X \to X\}$
is a covering by (1). Thus $(K \times_L M)_0 \to \{X \to X\}$
is a covering by Lemma \ref{hypercovering-lemma-covering-permanence}. Hence
...
$$
\begin{array}{cccc}K_{n + 1} \times_{L_{n + 1}} M_{n + 1} \longrightarrow\downarrow & M_{n + 1} \downarrow\underset{\gamma}{\searrow}\searrow &  &  \\ K_{n + 1} \longrightarrow\searrow & L_{n + 1} \searrow & L_{n + 1} \times_B C \longleftarrow\longrightarrow & C \downarrow \\  & A \longrightarrow &  & B\end{array}
$$
...
\begin{lemma}[Product hypercoverings]
\label{hypercovering-lemma-product-hypercoverings}
\source{stacks:01GI}
\href{https://stacks.math.columbia.edu/tag/01GI}{\texttt{Stacks tag 01GI}}
\group{hypercovering}
...
\begin{proof}
\uses{hypercovering-lemma-funny-gamma}

You can either verify this directly, or use
Lemma \ref{hypercovering-lemma-funny-gamma} above and check that $L \to \{X \to X\}$
has property (3).
\end{proof}
...
\source{stacks:01GJ}
\href{https://stacks.math.columbia.edu/tag/01GJ}{\texttt{Stacks tag 01GJ}}
\group{hypercovering}
...
\begin{proof}
\uses{hypercovering-lemma-funny-gamma, hypercovering-lemma-covering-permanence}
...
$$
\begin{array}{ccc}L_k \longrightarrow\downarrow & \prod_{\alpha : [k] \to [k]} Z \overset{\text{pr}_{\text{id}_{[k]}}}{\longrightarrow}\downarrow & Z \downarrow \\ K_k \longrightarrow & \prod_{\alpha : [k] \to [k]} Y \overset{\text{pr}_{\text{id}_{[k]}}}{\longrightarrow} & Y\end{array}
$$
...
To see this we will use Lemma \ref{hypercovering-lemma-funny-gamma}.
...
$$
\begin{array}{cc}\prod\nolimits_{\alpha : [k] \to [1]} Z \longrightarrow\downarrow & Z \times Z \downarrow \\ \prod\nolimits_{\alpha : [k] \to [1]} Y \longrightarrow & Y \times Y\end{array}
$$
...
Lemma \ref{hypercovering-lemma-covering-permanence}.
...
$$
which is a product of coverings and hence a covering by
Lemma \ref{hypercovering-lemma-covering-permanence}. By construction, we have
...
\begin{lemma}[Covering sheaf]
\label{hypercovering-lemma-covering-sheaf}
\source{stacks:01GK}
\href{https://stacks.math.columbia.edu/tag/01GK}{\texttt{Stacks tag 01GK}}
\group{hypercovering}
...
\begin{proof}
\uses{hypercovering-lemma-covering}
...
Thus the result follows from Lemma \ref{hypercovering-lemma-covering} above.
\end{proof}
...
Let $\mathcal{C}$ be a site with fibre products.
Let $X$ be an object of $\mathcal{C}$.
As we pointed out in Section \ref{hypercovering-section-covering} above,
...
\begin{lemma}[One more simplex]
\label{hypercovering-lemma-one-more-simplex}
\source{stacks:01GM}
\href{https://stacks.math.columbia.edu/tag/01GM}{\texttt{Stacks tag 01GM}}
\group{hypercovering}
...
\begin{proof}
\uses{hypercovering-lemma-covering-permanence}
...
from Lemma \ref{hypercovering-lemma-covering-permanence}.
...
we get that
$$
\begin{array}{cc}\Hom(V, K)_0 \longrightarrow\downarrow & \Hom(U, K)_0 \downarrow \\ \Hom(\Delta[n], K)_0 \longrightarrow & \Hom(\partial \Delta[n], K)_0\end{array}
$$
...
\source{stacks:01GN}
\href{https://stacks.math.columbia.edu/tag/01GN}{\texttt{Stacks tag 01GN}}
\group{hypercovering}
...
\begin{proof}
\uses{hypercovering-lemma-one-more-simplex}

By Lemma \ref{hypercovering-lemma-one-more-simplex}
...
\begin{lemma}[Degeneracy maps coverings]
\label{hypercovering-lemma-degeneracy-maps-coverings}
\source{stacks:0DEQ}
\href{https://stacks.math.columbia.edu/tag/0DEQ}{\texttt{Stacks tag 0DEQ}}
\group{hypercovering}
...
\begin{proof}
\uses{hypercovering-definition-hypercovering, hypercovering-definition-covering-SR, hypercovering-lemma-covering-permanence, hypercovering-lemma-add-simplices}

Recall that $K_0$ is a covering of $X$ by
Definition \ref{hypercovering-definition-hypercovering}
and that this is equivalent to saying that
$K_0 \to \{X \to X\}$ is a covering in the sense
of Definition \ref{hypercovering-definition-covering-SR}.
Hence (1) follows from (2) because it will prove that
the composition
$K_n \to K_{n - 1} \to \ldots \to K_0 \to \{X \to X\}$
is a covering by Lemma \ref{hypercovering-lemma-covering-permanence}.
...
Therefore (2) follows from Lemma \ref{hypercovering-lemma-add-simplices}
applied to the $n + 1$ different inclusions $\Delta[n - 1] \to \Delta[n]$.
\end{proof}

\begin{remark}[P covering]
\label{hypercovering-remark-P-covering}
\source{stacks:0DER}
\href{https://stacks.math.columbia.edu/tag/0DER}{\texttt{Stacks tag 0DER}}
\group{hypercovering}

\uses{hypercovering-lemma-add-simplices, hypercovering-lemma-degeneracy-maps-coverings}
A useful special case of Lemmas \ref{hypercovering-lemma-add-simplices} and
\ref{hypercovering-lemma-degeneracy-maps-coverings} is the following.
...
\begin{lemma}[Hom hypercovering]
\label{hypercovering-lemma-hom-hypercovering}
\source{stacks:01GP}
\href{https://stacks.math.columbia.edu/tag/01GP}{\texttt{Stacks tag 01GP}}
\group{hypercovering}
...
\begin{array}{cc}\Hom(\Delta[1], L)_{n + 1} \longrightarrow\downarrow & (\text{cosk}_n \text{sk}_n \Hom(\Delta[1], L))_{n + 1} \downarrow \\ (L \times L)_{n + 1} \longrightarrow & (\text{cosk}_n \text{sk}_n (L \times L))_{n + 1}\end{array}
\end{equation}
...
\begin{array}{cc}\Delta[1] \times \Delta[n + 1] & \Delta[1] \times \partial\Delta[n + 1] \longleftarrow \\ \Delta[n + 1] \amalg \Delta[n + 1] \uparrow & \partial\Delta[n + 1] \amalg \partial\Delta[n + 1]
\longleftarrow\uparrow\end{array}
\end{equation}
...
\source{stacks:01GS}
\href{https://stacks.math.columbia.edu/tag/01GS}{\texttt{Stacks tag 01GS}}
\group{hypercovering}
...
\begin{proof}
\uses{hypercovering-lemma-funny-gamma, hypercovering-lemma-hom-hypercovering, hypercovering-lemma-add-simplices}

Consider the following commutative diagram
$$
\begin{array}{ccc}K' \xlongequal{def}\underset{c}{\searrow} & K \times_{(L \times L)} \Hom(\Delta[1], L)
\longrightarrow\downarrow & \Hom(\Delta[1], L) \downarrow \\  & K \overset{(a, b)}{\longrightarrow} & L \times L\end{array}
$$
...
To see this we will apply Lemma \ref{hypercovering-lemma-funny-gamma}
to the pair of morphisms $K \to L \times L$
and $\Hom(\Delta[1], L) \to L \times L$.
Condition (1) of Lemma \ref{hypercovering-lemma-funny-gamma} is satisfied.
Condition (2) of Lemma \ref{hypercovering-lemma-funny-gamma} is true because
...
To prove condition (3) of Lemma \ref{hypercovering-lemma-funny-gamma}
we use Lemma \ref{hypercovering-lemma-hom-hypercovering} above. According
to this lemma the morphism $\gamma$ of condition (3) of Lemma
\ref{hypercovering-lemma-funny-gamma} is the morphism
$$
\Hom(\Delta[1] \times \Delta[n + 1], L)_0
\longrightarrow
\Hom(U, L)_0
$$
where $U \subset \Delta[1] \times \Delta[n + 1]$.
According to Lemma \ref{hypercovering-lemma-add-simplices}
this is a covering and hence the claim has been proven.
\end{proof}

\begin{remark}[Contractible category]
\label{hypercovering-remark-contractible-category}
\source{stacks:01GT}
\href{https://stacks.math.columbia.edu/tag/01GT}{\texttt{Stacks tag 01GT}}
\group{hypercovering}

\uses{hypercovering-lemma-add-simplices}
Note that the crux of the proof is to use
Lemma \ref{hypercovering-lemma-add-simplices}. This lemma
...
see Lemma \ref{hypercovering-lemma-hypercoverings-set}.
...
\textit{Ab}.
$$
By Lemmas \ref{hypercovering-lemma-product-hypercoverings} and \ref{hypercovering-lemma-homotopy}
...
\begin{theorem}[Cohomology hypercoverings]
\label{hypercovering-theorem-cohomology-hypercoverings}
\source{stacks:01H0}
\href{https://stacks.math.columbia.edu/tag/01H0}{\texttt{Stacks tag 01H0}}
\group{hypercovering}
...
\begin{proof}
\uses{hypercovering-lemma-cech-spectral-sequence, hypercovering-lemma-h0-cech, hypercovering-example-cech, hypercovering-definition-covering-SR, hypercovering-lemma-covering}
...
Lemma \ref{hypercovering-lemma-cech-spectral-sequence}
for some hypercovering $K$ of $X$.

\medskip\noindent
This is true if $p = 0$ by Lemma \ref{hypercovering-lemma-h0-cech}.
If $p = 1$, choose a {\v C}ech hypercovering $K$ of $X$ as in
Example \ref{hypercovering-example-cech} starting with a covering
...
in Lemma \ref{hypercovering-lemma-cech-spectral-sequence} that $\xi$ comes
...
(using Example \ref{hypercovering-example-cech} and
Cohomology on Sites,
Lemma \ref{sites-cohomology-lemma-kill-cohomology-class-on-covering}
again).
By the spectral sequence of Lemma \ref{hypercovering-lemma-cech-spectral-sequence}
...
Definition \ref{hypercovering-definition-covering-SR}. By
Lemma \ref{hypercovering-lemma-covering} there
...
\begin{proof}
\uses{hypercovering-lemma-h0-cech, hypercovering-lemma-injective-trivial-cech, hypercovering-definition-covering-SR, hypercovering-lemma-covering, hypercovering-lemma-product-hypercoverings, hypercovering-lemma-homotopy}
[Proof without using spectral sequences.]
We have seen the result for $i = 0$, see Lemma \ref{hypercovering-lemma-h0-cech}.
...
is zero on injective sheaves (Lemma \ref{hypercovering-lemma-injective-trivial-cech})
...
really comes down to Lemmas \ref{hypercovering-lemma-product-hypercoverings}
and \ref{hypercovering-lemma-homotopy}. We also omit the verification that
...
Theorem \ref{hypercovering-theorem-cohomology-hypercoverings}
by a sleight of hand.

\begin{proposition}[Cohomology hypercoverings]
\label{hypercovering-proposition-cohomology-hypercoverings}
\source{stacks:09VZ}
\href{https://stacks.math.columbia.edu/tag/09VZ}{\texttt{Stacks tag 09VZ}}
\group{hypercovering}
...
\begin{proof}
\uses{hypercovering-theorem-cohomology-hypercoverings, hypercovering-example-cech, hypercovering-definition-hypercovering-variant}
...
Example \ref{hypercovering-example-cech}. Note that every $K_{init, n}$ has the shape
...
of Definition \ref{hypercovering-definition-hypercovering-variant}.
...
Definition \ref{hypercovering-definition-hypercovering-variant} and
...
\medskip\noindent
Let us first unwind Definition \ref{hypercovering-definition-SR}.
...
\begin{remark}[Not covering set]
\label{hypercovering-remark-not-covering-set}
\source{stacks:01H5}
\href{https://stacks.math.columbia.edu/tag/01H5}{\texttt{Stacks tag 01H5}}
\group{hypercovering}
...
\begin{remark}[Repackage into simplicial space]
\label{hypercovering-remark-repackage-into-simplicial-space}
\source{stacks:02N9}
\href{https://stacks.math.columbia.edu/tag/02N9}{\texttt{Stacks tag 02N9}}
\group{hypercovering}

\uses{hypercovering-lemma-cech-spectral-sequence}
...
In this case the spectral sequence of Lemma \ref{hypercovering-lemma-cech-spectral-sequence}
...
\begin{lemma}[Basis hypercovering]
\label{hypercovering-lemma-basis-hypercovering}
\source{stacks:01H6}
\href{https://stacks.math.columbia.edu/tag/01H6}{\texttt{Stacks tag 01H6}}
\group{hypercovering}
...
\begin{lemma}[Quasi separated quasi compact hypercovering]
\label{hypercovering-lemma-quasi-separated-quasi-compact-hypercovering}
\source{stacks:01H7}
\href{https://stacks.math.columbia.edu/tag/01H7}{\texttt{Stacks tag 01H7}}
\group{hypercovering}
...
\begin{proof}
\uses{hypercovering-lemma-basis-hypercovering}

This follows directly from the construction in the proof of
Lemma \ref{hypercovering-lemma-basis-hypercovering} if we choose finite coverings
...
\source{stacks:0DAU}
\href{https://stacks.math.columbia.edu/tag/0DAU}{\texttt{Stacks tag 0DAU}}
\group{hypercovering}
...
\begin{lemma}[Hypercovering object]
\label{hypercovering-lemma-hypercovering-object}
\source{stacks:0DAV}
\href{https://stacks.math.columbia.edu/tag/0DAV}{\texttt{Stacks tag 0DAV}}
\group{hypercovering}
...
\begin{proof}
\uses{hypercovering-lemma-basis-hypercovering, hypercovering-definition-covering-SR, hypercovering-lemma-split}

A warmup for this proof is the proof of
Lemma \ref{hypercovering-lemma-basis-hypercovering} and
...
for $a = 0, \ldots, n - 1$
is a covering as in Definition \ref{hypercovering-definition-covering-SR}.
...
Lemma \ref{hypercovering-lemma-split}.
...
(see Lemma \ref{hypercovering-lemma-split}).
\end{enumerate}
...
\begin{lemma}[Hypercovering site]
\label{hypercovering-lemma-hypercovering-site}
\source{stacks:0DAX}
\href{https://stacks.math.columbia.edu/tag/0DAX}{\texttt{Stacks tag 0DAX}}
\group{hypercovering}
...
\begin{proof}
\uses{hypercovering-lemma-hypercovering-object, hypercovering-lemma-coprod-prod-SR}

This proof is almost the same as the proof of
Lemma \ref{hypercovering-lemma-hypercovering-object}. We will
...
Lemma \ref{hypercovering-lemma-hypercovering-object}.
...
guarantees that $\text{SR}(\mathcal{C})$ has fibre products
and equalizers and $F$ commutes with these
(Lemma \ref{hypercovering-lemma-coprod-prod-SR}). This suffices
assure us the coskeleton functors used exist (see
Simplicial, Remark \ref{simplicial-remark-existence-cosk} and
Categories, Lemma \ref{categories-lemma-fibre-products-equalizers-exist}).
\end{proof}

\begin{lemma}[Hypercovering morphism sites]
\label{hypercovering-lemma-hypercovering-morphism-sites}
\source{stacks:0DAY}
\href{https://stacks.math.columbia.edu/tag/0DAY}{\texttt{Stacks tag 0DAY}}
\group{hypercovering}
...
\begin{proof}
\uses{hypercovering-definition-hypercovering-variant}
...
hypercovering from Definition \ref{hypercovering-definition-hypercovering-variant}.
...
\begin{lemma}[Hypercovering continuous functor]
\label{hypercovering-lemma-hypercovering-continuous-functor}
\source{stacks:0DAZ}
\href{https://stacks.math.columbia.edu/tag/0DAZ}{\texttt{Stacks tag 0DAZ}}
\group{hypercovering}
...
\begin{proof}
\uses{hypercovering-lemma-hypercovering-morphism-sites, hypercovering-definition-hypercovering, hypercovering-definition-covering-SR}

This is easier than the proof of Lemma \ref{hypercovering-lemma-hypercovering-morphism-sites}
because the notion of being a hypercovering of an object is stronger, see
Definitions \ref{hypercovering-definition-hypercovering} and \ref{hypercovering-definition-covering-SR}.
...
\source{stacks:094K}
\href{https://stacks.math.columbia.edu/tag/094K}{\texttt{Stacks tag 094K}}
\group{hypercovering}
...
\begin{proof}
\uses{hypercovering-lemma-quasi-separated-quasi-compact-hypercovering, hypercovering-lemma-hypercovering-object}
...
\begin{remark}[Taking disjoint unions]
\label{hypercovering-remark-taking-disjoint-unions}
\source{stacks:0DB0}
\href{https://stacks.math.columbia.edu/tag/0DB0}{\texttt{Stacks tag 0DB0}}
\group{hypercovering}
...
\begin{remark}[Take unions hypercovering]
\label{hypercovering-remark-take-unions-hypercovering}
\source{stacks:0DB1}
\href{https://stacks.math.columbia.edu/tag/0DB1}{\texttt{Stacks tag 0DB1}}
\group{hypercovering}

\uses{hypercovering-remark-taking-disjoint-unions, hypercovering-definition-hypercovering-variant}
...
with $L_n = \{U_n\}$, see
Remark \ref{hypercovering-remark-taking-disjoint-unions}.
Now we claim that $L$ is a hypercovering.
To see this we check conditions (1), (2), (3) of
Definition \ref{hypercovering-definition-hypercovering-variant}.
...
\begin{remark}[Take unions hypercovering X]
\label{hypercovering-remark-take-unions-hypercovering-X}
\source{stacks:0DB2}
\href{https://stacks.math.columbia.edu/tag/0DB2}{\texttt{Stacks tag 0DB2}}
\group{hypercovering}

\uses{hypercovering-definition-covering-SR, hypercovering-remark-taking-disjoint-unions, hypercovering-definition-hypercovering}
...
Definition \ref{hypercovering-definition-covering-SR}
and $U = \coprod U_i$ and $V = \coprod V_j$ exist,
then the corresponding morphism $U \to V$
of Remark \ref{hypercovering-remark-taking-disjoint-unions}
...
Definition \ref{hypercovering-definition-covering-SR} by (2) for $K$.
