...
\iffalse
\begin{remark}
\label{src-rigid-local-systems-multiplicative-eigenvalue-problem-ch01-introduction-statement-1}
\source{rigid-local-systems-multiplicative-eigenvalue-problem}
\notready
...
\begin{remark}
\label{src-rigid-local-systems-multiplicative-eigenvalue-problem-ch01-introduction-statement-2}
\source{rigid-local-systems-multiplicative-eigenvalue-problem}
\notready
...
\label{src-rigid-local-systems-multiplicative-eigenvalue-problem-ch01-introduction-statement-3}
