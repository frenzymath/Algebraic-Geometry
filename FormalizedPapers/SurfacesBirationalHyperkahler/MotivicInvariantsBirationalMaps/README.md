...
Blueprint project under `FormalizedPapers/SurfacesBirationalHyperkahler/MotivicInvariantsBirationalMaps`.

- Blueprint: [`blueprint/src/content.tex`](blueprint/src/content.tex)
- Direct PDF: [arXiv PDF](https://arxiv.org/pdf/2207.07389)
