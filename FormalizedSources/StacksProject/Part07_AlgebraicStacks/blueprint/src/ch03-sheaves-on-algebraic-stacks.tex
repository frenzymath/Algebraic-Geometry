...
\source{stacks:06TJ}
\href{https://stacks.math.columbia.edu/tag/06TJ}{\texttt{Stacks tag 06TJ}}
\group{stacks-sheaves}
...
Lemma \ref{stacks-sheaves-lemma-functoriality-sheaves}
has been proved.}
\begin{equation}
...
\begin{lemma}[1 morphisms presheaves]
\label{stacks-sheaves-lemma-1-morphisms-presheaves}
\source{stacks:06TL}
\href{https://stacks.math.columbia.edu/tag/06TL}{\texttt{Stacks tag 06TL}}
\group{stacks-sheaves}
...
$$
\begin{array}{ccc}\Mor_{\textit{PSh}(\mathcal{X})}(f^pg^p\mathcal{H}, \mathcal{F})
\xlongequal{}\downarrow & \Mor_{\textit{PSh}(\mathcal{Y})}(g^p\mathcal{H}, {}_pf\mathcal{F})
\xlongequal{} & \Mor_{\textit{PSh}(\mathcal{Y})}(\mathcal{H}, {}_pg{}_pf\mathcal{F}) \\ \Mor_{\textit{PSh}(\mathcal{X})}((g \circ f)^p\mathcal{G}, \mathcal{F})
\xlongequal{} &  & \Mor_{\textit{PSh}(\mathcal{Y})}(\mathcal{G}, {}_p(g \circ f)\mathcal{F})
\uparrow\end{array}
$$
Proof omitted.
\end{proof}

\begin{lemma}[2 morphisms presheaves]
\label{stacks-sheaves-lemma-2-morphisms-presheaves}
\source{stacks:06TM}
\href{https://stacks.math.columbia.edu/tag/06TM}{\texttt{Stacks tag 06TM}}
\group{stacks-sheaves}
...
$$
\begin{array}{cc}\Mor_{\textit{PSh}(\mathcal{X})}(f^p\mathcal{G}, \mathcal{F})
\xlongequal{}\underset{- \circ t^p}{\downarrow} & \Mor_{\textit{PSh}(\mathcal{Y})}(\mathcal{G}, {}_pf\mathcal{F})
\overset{{}_pt \circ -}{\downarrow} \\ \Mor_{\textit{PSh}(\mathcal{X})}(g^p\mathcal{G}, \mathcal{F})
\xlongequal{} & \Mor_{\textit{PSh}(\mathcal{Y})}(\mathcal{G}, {}_pg\mathcal{F})\end{array}
$$
...
\begin{definition}[Inherited topologies]
\label{stacks-sheaves-definition-inherited-topologies}
\source{stacks:06TP}
\href{https://stacks.math.columbia.edu/tag/06TP}{\texttt{Stacks tag 06TP}}
\group{stacks-sheaves}
...
\begin{remark}[Ambiguity]
\label{stacks-sheaves-remark-ambiguity}
\source{stacks:06TQ}
\href{https://stacks.math.columbia.edu/tag/06TQ}{\texttt{Stacks tag 06TQ}}
\group{stacks-sheaves}
...
\source{stacks:06TR}
\href{https://stacks.math.columbia.edu/tag/06TR}{\texttt{Stacks tag 06TR}}
\group{stacks-sheaves}
...
\begin{lemma}[Functoriality sheaves]
\label{stacks-sheaves-lemma-functoriality-sheaves}
\source{stacks:06TS}
\href{https://stacks.math.columbia.edu/tag/06TS}{\texttt{Stacks tag 06TS}}
\group{stacks-sheaves}
...
\source{stacks:06TT}
\href{https://stacks.math.columbia.edu/tag/06TT}{\texttt{Stacks tag 06TT}}
\group{stacks-sheaves}
...
\source{stacks:075B}
\href{https://stacks.math.columbia.edu/tag/075B}{\texttt{Stacks tag 075B}}
\group{stacks-sheaves}

Let $S$ be a scheme. Let
$$
\begin{array}{cc}\mathcal{Y}' \times_\mathcal{Y} \mathcal{X} \underset{g'}{\longrightarrow}\underset{f'}{\downarrow} & \mathcal{X} \overset{f}{\downarrow} \\ \mathcal{Y}' \overset{g}{\longrightarrow} & \mathcal{Y}\end{array}
$$
...
\source{stacks:06W7}
\href{https://stacks.math.columbia.edu/tag/06W7}{\texttt{Stacks tag 06W7}}
\group{stacks-sheaves}
...
Let
$$
\begin{array}{ccc}\mathcal{X} \underset{f}{\longrightarrow}\underset{p}{\searrow} &  & \mathcal{Y} \overset{q}{\swarrow} \\  & (\Sch/S)_{fppf} & \end{array}
$$
...
Lemma \ref{stacks-sheaves-lemma-representable}
...
$$
\begin{array}{ccc}f(u(y')) \downarrow\underset{f(u(\beta))}{\longrightarrow} &  & f(u(y)) \downarrow \\ y' \longrightarrow &  & y\end{array}
$$
...
$$
\begin{array}{ccc}U' \underset{p(u(\beta))}{\longrightarrow}\downarrow &  & U \downarrow \\ V' \overset{q(\beta)}{\longrightarrow} &  & V\end{array}
$$
...
\begin{lemma}[Representable pushforward]
\label{stacks-sheaves-lemma-representable-pushforward}
\source{stacks:06W8}
\href{https://stacks.math.columbia.edu/tag/06W8}{\texttt{Stacks tag 06W8}}
\group{stacks-sheaves}
...
\source{stacks:06TV}
\href{https://stacks.math.columbia.edu/tag/06TV}{\texttt{Stacks tag 06TV}}
\group{stacks-sheaves}
...
\begin{lemma}[Functoriality structure sheaf]
\label{stacks-sheaves-lemma-functoriality-structure-sheaf}
\source{stacks:06TW}
\href{https://stacks.math.columbia.edu/tag/06TW}{\texttt{Stacks tag 06TW}}
\group{stacks-sheaves}
...
Lemma \ref{stacks-sheaves-lemma-1-morphisms-presheaves}. Since
...
\source{stacks:06TX}
\href{https://stacks.math.columbia.edu/tag/06TX}{\texttt{Stacks tag 06TX}}
\group{stacks-sheaves}

In the situation of
Lemma \ref{stacks-sheaves-lemma-functoriality-structure-sheaf}
...
\source{stacks:06WB}
\href{https://stacks.math.columbia.edu/tag/06WB}{\texttt{Stacks tag 06WB}}
\group{stacks-sheaves}
...
\begin{lemma}[Compare with scheme]
\label{stacks-sheaves-lemma-compare-with-scheme}
\source{stacks:075I}
\href{https://stacks.math.columbia.edu/tag/075I}{\texttt{Stacks tag 075I}}
\group{stacks-sheaves}
...
\begin{lemma}[Compare with morphism of schemes]
\label{stacks-sheaves-lemma-compare-with-morphism-of-schemes}
\source{stacks:075J}
\href{https://stacks.math.columbia.edu/tag/075J}{\texttt{Stacks tag 075J}}
\group{stacks-sheaves}
...
Lemma \ref{stacks-sheaves-lemma-compare-with-scheme}.
\end{lemma}
...
\begin{lemma}[Localizing]
\label{stacks-sheaves-lemma-localizing}
\source{stacks:06W0}
\href{https://stacks.math.columbia.edu/tag/06W0}{\texttt{Stacks tag 06W0}}
\group{stacks-sheaves}
...
\source{stacks:06W1}
\href{https://stacks.math.columbia.edu/tag/06W1}{\texttt{Stacks tag 06W1}}
\group{stacks-sheaves}
...
Lemma \ref{stacks-sheaves-lemma-localizing}.
...
via
$$
\begin{array}{ccc}a_{small, *}(\mathcal{F}|_{U_\etale})(V') & \mathcal{F}|_{U_\etale}(U') \xlongequal{} & \mathcal{F}(x') \xlongequal{} \\ \mathcal{F}|_{V_\etale}(V') \xlongequal{}\overset{c_\varphi}{\uparrow} &  & \mathcal{F}(y') \underset{\mathcal{F}(\varphi')}{\uparrow}\end{array}
$$
Here $\varphi' : x' \to y'$ is a morphism of $\mathcal{X}$
fitting into a commutative diagram
$$
\vcenter{
\begin{array}{cc}x' \longrightarrow\underset{\varphi'}{\downarrow} & x \overset{\varphi}{\downarrow} \\ y' \longrightarrow & y\end{array}
}
\quad\text{lying over}\quad
\vcenter{
\begin{array}{cc}U' \longrightarrow\downarrow & U \overset{a}{\downarrow} \\ V' \longrightarrow & V\end{array}
}
$$
...
\source{stacks:075D}
\href{https://stacks.math.columbia.edu/tag/075D}{\texttt{Stacks tag 075D}}
\group{stacks-sheaves}
...
\begin{lemma}[Localizing structure sheaf]
\label{stacks-sheaves-lemma-localizing-structure-sheaf}
\source{stacks:06W9}
\href{https://stacks.math.columbia.edu/tag/06W9}{\texttt{Stacks tag 06W9}}
\group{stacks-sheaves}
...
Definition \ref{stacks-sheaves-definition-modules}.
Let $x$ be an object of $\mathcal{X}$ lying over $U$. Then
Lemma \ref{stacks-sheaves-lemma-localizing-structure-sheaf}
...
\source{stacks:073M}
\href{https://stacks.math.columbia.edu/tag/073M}{\texttt{Stacks tag 073M}}
\group{stacks-sheaves}
...
Then
$$
\begin{array}{ccc}h_R \longrightarrow\longrightarrow & h_U \longrightarrow & {*}\end{array}
$$
...
we see that
$$
\begin{array}{ccc}h_{u(R)} \longrightarrow\longrightarrow & h_{u(U)} \longrightarrow & i_{F, !}{*}\end{array}
$$
...
\source{stacks:0GQA}
\href{https://stacks.math.columbia.edu/tag/0GQA}{\texttt{Stacks tag 0GQA}}
\group{stacks-sheaves}

The constructions in Lemma \ref{stacks-sheaves-lemma-compare} are compatible with \'etale
...
$$
\begin{array}{ccc}(\Sh(F_\etale), \mathcal{O}_F) \underset{f_{small}}{\longrightarrow}\underset{i_F}{\downarrow} &  & (\Sh(G_\etale), \mathcal{O}_G) \overset{i_G}{\downarrow} \\ (\Sh(\mathcal{X}_\etale), \mathcal{O}_\mathcal{X})
\underset{\pi_F}{\downarrow}\underset{f}{\longrightarrow} &  & (\Sh(\mathcal{Y}_\etale), \mathcal{O}_\mathcal{Y}) \overset{\pi_G}{\downarrow} \\ (\Sh(F_\etale), \mathcal{O}_F) \overset{f_{small}}{\longrightarrow} &  & (\Sh(G_\etale), \mathcal{O}_G)\end{array}
$$
...
functor of the proof of Lemma \ref{stacks-sheaves-lemma-compare} above.
...
similarly to
Definition \ref{stacks-sheaves-definition-pullback}
...
\begin{lemma}[Compare morphism]
\label{stacks-sheaves-lemma-compare-morphism}
\source{stacks:073N}
\href{https://stacks.math.columbia.edu/tag/073N}{\texttt{Stacks tag 073N}}
\group{stacks-sheaves}
...
the corresponding morphism of ringed topoi. Then
$$
\begin{array}{ccc}(\Sh(\mathcal{X}_\etale), \mathcal{O}_\mathcal{X})
\underset{\pi_F}{\downarrow}\underset{f}{\longrightarrow} &  & (\Sh(\mathcal{Y}_\etale), \mathcal{O}_\mathcal{Y}) \overset{\pi_G}{\downarrow} \\ (\Sh(F_\etale), \mathcal{O}_F) \overset{f_{small}}{\longrightarrow} &  & (\Sh(G_\etale), \mathcal{O}_G)\end{array}
$$
...
Lemma \ref{stacks-sheaves-lemma-compare}. Because of the 2-functoriality of
sheaves on categories fibred in groupoids over $\Sch_{fppf}$
(see discussion in Section \ref{stacks-sheaves-section-presheaves})
...
the diagram
$$
\begin{array}{ccc}\Gamma\Big(
(\Sch/V)_{fppf} \times_{\mathcal{Y}} \mathcal{X},
\ \text{pr}^{-1}\mathcal{G}\Big)
\longrightarrow & \text{pr}^{-1}\mathcal{G}(U/V \times_G F) \longrightarrow\longrightarrow & \text{pr}^{-1}\mathcal{G}(R/V \times_G F)\end{array}
$$
...
$$
\begin{array}{ccc}f_{small, *}\pi_{F, *}\mathcal{G}(V)
\longrightarrow & \pi_{F, *}\mathcal{G}(U/F) \longrightarrow\longrightarrow & \pi_{F, *}\mathcal{G}(R/F)\end{array}
$$
...
$$
\begin{array}{cc}\mathcal{U} \overset{a}{\longrightarrow}\underset{f}{\searrow}\drtwocell<\omit>{<-2>\varphi} & \mathcal{V} \overset{g}{\downarrow} \\  & \mathcal{X}\end{array}
$$
...
\source{stacks:06WG}
\href{https://stacks.math.columbia.edu/tag/06WG}{\texttt{Stacks tag 06WG}}
\group{stacks-sheaves}
...
Cohomology on Stacks, Lemma \ref{stacks-sheaves-lemma-quasi-coherent}.
...
\source{stacks:06WH}
\href{https://stacks.math.columbia.edu/tag/06WH}{\texttt{Stacks tag 06WH}}
\group{stacks-sheaves}
...
Lemma \ref{stacks-sheaves-lemma-quasi-coherent}
...
\source{stacks:06WI}
\href{https://stacks.math.columbia.edu/tag/06WI}{\texttt{Stacks tag 06WI}}
\group{stacks-sheaves}
...
\begin{proof}
By
Lemma \ref{stacks-sheaves-lemma-pullback-quasi-coherent}
...
\begin{lemma}[Characterize quasi coherent bis]
\label{stacks-sheaves-lemma-characterize-quasi-coherent-bis}
\source{stacks:0EM8}
\href{https://stacks.math.columbia.edu/tag/0EM8}{\texttt{Stacks tag 0EM8}}
\group{stacks-sheaves}
...
in the sense of Definition \ref{stacks-sheaves-definition-quasi-coherent}.
\end{enumerate}
\end{lemma}
...
\begin{definition}[Locally quasi coherent]
\label{stacks-sheaves-definition-locally-quasi-coherent}
\source{stacks:06WJ}
\href{https://stacks.math.columbia.edu/tag/06WJ}{\texttt{Stacks tag 06WJ}}
\group{stacks-sheaves}
...
$$
\begin{array}{cc}\QCoh(\mathcal{O}_\mathcal{X}) \longrightarrow\downarrow & \textit{Mod}(\mathcal{O}_\mathcal{X}) \downarrow \\ \textit{LQCoh}(\mathcal{O}_\mathcal{X}) \longrightarrow & \textit{Mod}(\mathcal{X}_\etale, \mathcal{O}_\mathcal{X})\end{array}
$$
...
\begin{lemma}[Quasi coherent]
\label{stacks-sheaves-lemma-quasi-coherent}
\source{stacks:06WK}
\href{https://stacks.math.columbia.edu/tag/06WK}{\texttt{Stacks tag 06WK}}
\group{stacks-sheaves}
...
Lemma \ref{stacks-sheaves-lemma-characterize-quasi-coherent}.
\end{proof}

\begin{lemma}[Pullback lqc]
\label{stacks-sheaves-lemma-pullback-lqc}
\source{stacks:06WL}
\href{https://stacks.math.columbia.edu/tag/06WL}{\texttt{Stacks tag 06WL}}
\group{stacks-sheaves}
...
\begin{lemma}[Lqc colimits]
\label{stacks-sheaves-lemma-lqc-colimits}
\source{stacks:06WM}
\href{https://stacks.math.columbia.edu/tag/06WM}{\texttt{Stacks tag 06WM}}
\group{stacks-sheaves}
...
\source{stacks:06WN}
\href{https://stacks.math.columbia.edu/tag/06WN}{\texttt{Stacks tag 06WN}}
\group{stacks-sheaves}
...
See Lemmas \ref{stacks-sheaves-lemma-characterize-quasi-coherent} and
\ref{stacks-sheaves-lemma-characterize-quasi-coherent-bis}. Similarly for being
...
\begin{lemma}[Stackification]
\label{stacks-sheaves-lemma-stackification}
\source{stacks:06WQ}
\href{https://stacks.math.columbia.edu/tag/06WQ}{\texttt{Stacks tag 06WQ}}
\group{stacks-sheaves}
...
\begin{lemma}[Stackification quasi coherent]
\label{stacks-sheaves-lemma-stackification-quasi-coherent}
\source{stacks:06WR}
\href{https://stacks.math.columbia.edu/tag/06WR}{\texttt{Stacks tag 06WR}}
\group{stacks-sheaves}
...
Lemma \ref{stacks-sheaves-lemma-stackification}
and
...
\begin{lemma}[Compare locally quasi coherent]
\label{stacks-sheaves-lemma-compare-locally-quasi-coherent}
\source{stacks:0GQC}
\href{https://stacks.math.columbia.edu/tag/0GQC}{\texttt{Stacks tag 0GQC}}
\group{stacks-sheaves}
...
This is clear but see also Remark \ref{stacks-sheaves-remark-compare}.
Thus the assertion follows from the definitions.
\end{proof}

\begin{lemma}[Compare quasi coherent]
\label{stacks-sheaves-lemma-compare-quasi-coherent}
\source{stacks:0GQD}
\href{https://stacks.math.columbia.edu/tag/0GQD}{\texttt{Stacks tag 0GQD}}
\group{stacks-sheaves}
...
\begin{proof}
By Lemma \ref{stacks-sheaves-lemma-characterize-quasi-coherent-bis} we may work with
the \'etale topology. We will use the notation and results of
Lemma \ref{stacks-sheaves-lemma-compare} without further mention.
...
Lemma \ref{stacks-sheaves-lemma-compare-locally-quasi-coherent} or by
Modules on Sites, Lemma \ref{sites-modules-lemma-local-pullback}
...
Since $U \to F$ is \'etale, it follows from Remark \ref{stacks-sheaves-remark-compare} that
$$
...
Lemma \ref{stacks-sheaves-lemma-compare-morphism}.
\end{proof}
...
\source{stacks:06WT}
\href{https://stacks.math.columbia.edu/tag/06WT}{\texttt{Stacks tag 06WT}}
\group{stacks-sheaves}
...
$$
\begin{array}{cc}\mathcal{R} \underset{s}{\longrightarrow}\underset{t}{\downarrow} & \mathcal{U} \overset{x}{\downarrow} \\ \mathcal{U} \overset{x}{\longrightarrow} & \mathcal{X}\end{array}
$$
See Groupoids in Spaces, Lemma
\ref{spaces-groupoids-lemma-quotient-stack-2-arrow}.
By Lemma \ref{stacks-sheaves-lemma-2-morphisms-presheaves}
...
Lemma \ref{stacks-sheaves-lemma-compare-quasi-coherent}
...
According to Lemma \ref{stacks-sheaves-lemma-stackification-quasi-coherent}
...
\begin{lemma}[Map from quasi coherent]
\label{stacks-sheaves-lemma-map-from-quasi-coherent}
\source{stacks:076S}
\href{https://stacks.math.columbia.edu/tag/076S}{\texttt{Stacks tag 076S}}
\group{stacks-sheaves}
...
diagram
$$
\begin{array}{ccc}s_{small}^*(x^*\mathcal{F}|_{U_\etale})
\longrightarrow\overset{s_{small}^*\varphi}{\downarrow} & (x \circ s)^*\mathcal{F}|_{R_\etale} =
(x \circ t)^*\mathcal{F}|_{R_\etale} & t_{small}^*(x^*\mathcal{F}|_{U_\etale})
\longleftarrow\underset{t_{small}^*\varphi}{\downarrow} \\ s_{small}^*(x^*\mathcal{H}|_{U_\etale})
\longrightarrow & (x \circ s)^*\mathcal{H}|_{R_\etale} =
(x \circ t)^*\mathcal{H}|_{R_\etale} & t_{small}^*(x^*\mathcal{H}|_{U_\etale})
...
\begin{proof}
According to
Lemma \ref{stacks-sheaves-lemma-stackification-quasi-coherent}
the stackification map $[U/_{\!p}R] \to [U/R]$ (see
Groupoids in Spaces, Definition
\ref{spaces-groupoids-definition-quotient-stack})
induces an equivalence of categories of quasi-coherent sheaves
...
By Proposition \ref{stacks-sheaves-proposition-quasi-coherent}
...
\begin{lemma}[Quasi coherent algebraic stack]
\label{stacks-sheaves-lemma-quasi-coherent-algebraic-stack}
\source{stacks:06WV}
\href{https://stacks.math.columbia.edu/tag/06WV}{\texttt{Stacks tag 06WV}}
\group{stacks-sheaves}
...
Lemma \ref{stacks-sheaves-lemma-qc-colimits}.
Part (1) is
Proposition \ref{stacks-sheaves-proposition-quasi-coherent}.
...
\source{stacks:0781}
\href{https://stacks.math.columbia.edu/tag/0781}{\texttt{Stacks tag 0781}}
\group{stacks-sheaves}
...
By Lemma \ref{stacks-sheaves-lemma-quasi-coherent-algebraic-stack}
...
Lemma \ref{stacks-sheaves-lemma-quasi-coherent-algebraic-stack}
above we have
...
\begin{lemma}[Cohomology restriction]
\label{stacks-sheaves-lemma-cohomology-restriction}
\source{stacks:075F}
\href{https://stacks.math.columbia.edu/tag/075F}{\texttt{Stacks tag 075F}}
\group{stacks-sheaves}
...
\source{stacks:06WX}
\href{https://stacks.math.columbia.edu/tag/06WX}{\texttt{Stacks tag 06WX}}
\group{stacks-sheaves}
...
\source{stacks:06WY}
\href{https://stacks.math.columbia.edu/tag/06WY}{\texttt{Stacks tag 06WY}}
\group{stacks-sheaves}
...
\begin{lemma}[Fibre products morphism]
\label{stacks-sheaves-lemma-fibre-products-morphism}
\source{stacks:06WZ}
\href{https://stacks.math.columbia.edu/tag/06WZ}{\texttt{Stacks tag 06WZ}}
\group{stacks-sheaves}
...
\begin{lemma}[Fibre products preserve properties]
\label{stacks-sheaves-lemma-fibre-products-preserve-properties}
\source{stacks:06X0}
\href{https://stacks.math.columbia.edu/tag/06X0}{\texttt{Stacks tag 06X0}}
\group{stacks-sheaves}
...
Lemma \ref{stacks-sheaves-lemma-fibre-products-morphism})
we see that $f(x'') \to f(x)$ is the equalizer of $f(a)$ and $f(a')$.
Similarly, $g(z'') \to g(z)$ is the equalizer of $g(b)$ and $g(b')$.
Picture
$$
\begin{array}{ccc}f(x'') \longrightarrow\underset{\alpha''}{\downarrow} & f(x) \underset{\alpha}{\downarrow}\overset{f(a)}{\longrightarrow}\underset{f(a')}{\longrightarrow} & f(x') \overset{\alpha'}{\downarrow} \\ g(z'') \longrightarrow & g(z)
\overset{g(b)}{\longrightarrow}\underset{g(b')}{\longrightarrow} & g(z')\end{array}
$$
...
\begin{lemma}[Pullback injective]
\label{stacks-sheaves-lemma-pullback-injective}
\source{stacks:06X1}
\href{https://stacks.math.columbia.edu/tag/06X1}{\texttt{Stacks tag 06X1}}
\group{stacks-sheaves}
...
Lemmas \ref{stacks-sheaves-lemma-fibre-products} and
\ref{stacks-sheaves-lemma-fibre-products-morphism}
above. Part (2) follows from this formally, see
Homology, Lemma \ref{homology-lemma-adjoint-preserve-injectives}.
\end{proof}

\begin{lemma}[Pullback injective modules]
\label{stacks-sheaves-lemma-pullback-injective-modules}
\source{stacks:06X2}
\href{https://stacks.math.columbia.edu/tag/06X2}{\texttt{Stacks tag 06X2}}
\group{stacks-sheaves}
...
agrees with the functor $f_!$ of Lemma \ref{stacks-sheaves-lemma-pullback-injective}
...
Lemma \ref{stacks-sheaves-lemma-pullback-injective}
...
\vcenter{
\begin{array}{ccc}\mathcal{U} \underset{f}{\longrightarrow}\underset{q}{\searrow} &  & \mathcal{X} \overset{p}{\swarrow} \\  & (\Sch/S)_{fppf} & \end{array}
}
\end{equation}
We are going to think about $\mathcal{U}$ as a ``covering'' of $\mathcal{X}$.
Hence we want to consider the simplicial object
$$
\begin{array}{ccc}\mathcal{U} \times_\mathcal{X} \mathcal{U} \times_\mathcal{X} \mathcal{U}
\longrightarrow\longrightarrow\longrightarrow & \mathcal{U} \times_\mathcal{X} \mathcal{U}
\longrightarrow\longrightarrow & \mathcal{U}\end{array}
$$
...
cosimplicial set
$$
\begin{array}{ccc}\Gamma(\mathcal{U}_0, f_0^{-1}\mathcal{F})
\longrightarrow\longrightarrow & \Gamma(\mathcal{U}_1, f_1^{-1}\mathcal{F})
\longrightarrow\longrightarrow\longrightarrow & \Gamma(\mathcal{U}_2, f_2^{-1}\mathcal{F})\end{array}
$$
...
\begin{lemma}[Generalities]
\label{stacks-sheaves-lemma-generalities}
\source{stacks:06X5}
\href{https://stacks.math.columbia.edu/tag/06X5}{\texttt{Stacks tag 06X5}}
\group{stacks-sheaves}
...
\item If
$$
\begin{array}{cc}\mathcal{V} \underset{g}{\downarrow}\underset{h}{\longrightarrow} & \mathcal{U} \overset{f}{\downarrow} \\ \mathcal{Y} \overset{e}{\longrightarrow} & \mathcal{X}\end{array}
$$
...
\source{stacks:06X6}
\href{https://stacks.math.columbia.edu/tag/06X6}{\texttt{Stacks tag 06X6}}
\group{stacks-sheaves}
...
Lemma \ref{stacks-sheaves-lemma-generalities}.
...
$$
\begin{array}{ccc}f_{0, *}f_0^{-1}\mathcal{F}
\longrightarrow\longrightarrow & f_{1, *}f_1^{-1}\mathcal{F}
\longrightarrow\longrightarrow\longrightarrow & f_{2, *}f_2^{-1}\mathcal{F}\end{array}
$$
...
\begin{remark}[Cech complex presheaves]
\label{stacks-sheaves-remark-cech-complex-presheaves}
\source{stacks:06X8}
\href{https://stacks.math.columbia.edu/tag/06X8}{\texttt{Stacks tag 06X8}}
\group{stacks-sheaves}
...
$$
\begin{array}{ccc}\mathcal{V} \underset{g}{\searrow}\underset{h}{\longrightarrow} &  & \mathcal{U} \overset{f}{\swarrow} \\  & \mathcal{X} & \end{array}
$$
...
Sections \ref{stacks-sheaves-section-presheaves} and \ref{stacks-sheaves-section-sheaves}.
\end{remark}

\begin{lemma}[Generalities sheafified]
\label{stacks-sheaves-lemma-generalities-sheafified}
\source{stacks:06X9}
\href{https://stacks.math.columbia.edu/tag/06X9}{\texttt{Stacks tag 06X9}}
\group{stacks-sheaves}
...
Remark \ref{stacks-sheaves-remark-cech-complex-presheaves}.
\end{proof}

\begin{lemma}[Homotopy sheafified]
\label{stacks-sheaves-lemma-homotopy-sheafified}
\source{stacks:06XA}
\href{https://stacks.math.columbia.edu/tag/06XA}{\texttt{Stacks tag 06XA}}
\group{stacks-sheaves}
...
\begin{proof}
Literally the same as the proof of
Lemma \ref{stacks-sheaves-lemma-homotopy}.
\end{proof}

\begin{remark}[Cech complex sections]
\label{stacks-sheaves-remark-cech-complex-sections}
\source{stacks:06XB}
\href{https://stacks.math.columbia.edu/tag/06XB}{\texttt{Stacks tag 06XB}}
\group{stacks-sheaves}
...
$$
\begin{array}{ccc}\mathcal{V} \xlongequal{}\underset{g}{\downarrow} & (\Sch/U)_{fppf} \times_{x, \mathcal{X}} \mathcal{U} \longrightarrow\downarrow & \mathcal{U} \overset{f}{\downarrow} \\ \mathcal{Y} \xlongequal{} & (\Sch/U)_{fppf} \overset{x}{\longrightarrow} & \mathcal{X}\end{array}
$$
...
\mathcal{K}^\bullet(g, e^{-1}\mathcal{F})$
of
Lemma \ref{stacks-sheaves-lemma-generalities-sheafified}
...
$$
by
Remark \ref{stacks-sheaves-remark-cech-complex-sections}. On the other hand,
$$
...
$$
also by
Remark \ref{stacks-sheaves-remark-cech-complex-sections}.
...
\begin{lemma}[Check exactness covering]
\label{stacks-sheaves-lemma-check-exactness-covering}
\source{stacks:06XD}
\href{https://stacks.math.columbia.edu/tag/06XD}{\texttt{Stacks tag 06XD}}
\group{stacks-sheaves}
...
\begin{proposition}[Exactness cech complex]
\label{stacks-sheaves-proposition-exactness-cech-complex}
\source{stacks:06XE}
\href{https://stacks.math.columbia.edu/tag/06XE}{\texttt{Stacks tag 06XE}}
\group{stacks-sheaves}
...
\begin{proof}
By
Lemma \ref{stacks-sheaves-lemma-check-exactness-covering}
it suffices to check exactness after pulling back to $\mathcal{U}$.
By
Lemma \ref{stacks-sheaves-lemma-base-change-cech-complex}
...
\begin{lemma}[Cech to cohomology]
\label{stacks-sheaves-lemma-cech-to-cohomology}
\source{stacks:06XF}
\href{https://stacks.math.columbia.edu/tag/06XF}{\texttt{Stacks tag 06XF}}
\group{stacks-sheaves}
...
Lemma \ref{stacks-sheaves-lemma-fibre-products-preserve-properties}
...
Lemma \ref{stacks-sheaves-lemma-pushforward-injective}.
Hence
...
\begin{lemma}[Cech to cohomology modules]
\label{stacks-sheaves-lemma-cech-to-cohomology-modules}
\source{stacks:06XG}
\href{https://stacks.math.columbia.edu/tag/06XG}{\texttt{Stacks tag 06XG}}
\group{stacks-sheaves}
...
Lemma \ref{stacks-sheaves-lemma-cech-to-cohomology}
except that it uses an injective resolution in
$\textit{Mod}(\mathcal{X}_\tau, \mathcal{O}_\mathcal{X})$
and it uses
Lemma \ref{stacks-sheaves-lemma-pullback-injective-modules}
instead of
Lemma \ref{stacks-sheaves-lemma-pullback-injective}.
\end{proof}
...
\source{stacks:06XH}
\href{https://stacks.math.columbia.edu/tag/06XH}{\texttt{Stacks tag 06XH}}
\group{stacks-sheaves}
...
\begin{lemma}[Cech to cohomology relative]
\label{stacks-sheaves-lemma-cech-to-cohomology-relative}
\source{stacks:072D}
\href{https://stacks.math.columbia.edu/tag/072D}{\texttt{Stacks tag 072D}}
\group{stacks-sheaves}
...
\begin{lemma}[Cech to cohomology relative modules]
\label{stacks-sheaves-lemma-cech-to-cohomology-relative-modules}
\source{stacks:072E}
\href{https://stacks.math.columbia.edu/tag/072E}{\texttt{Stacks tag 072E}}
\group{stacks-sheaves}
...
Lemma \ref{stacks-sheaves-lemma-cech-to-cohomology-relative}
except that it uses an injective resolution in
$\textit{Mod}(\mathcal{X}_\tau, \mathcal{O}_\mathcal{X})$
and it uses
Lemma \ref{stacks-sheaves-lemma-pullback-injective-modules}
...
\begin{proposition}[Cohomology of a stack can be computed on the Cech nerve of a presentation]
\label{stacks-sheaves-proposition-smooth-covering-compute-cohomology}
\source{stacks:06XJ}
\href{https://stacks.math.columbia.edu/tag/06XJ}{\texttt{Stacks tag 06XJ}}
\group{stacks-sheaves}
...
stack, see
Lemma \ref{stacks-sheaves-lemma-fibre-products}.
To see (2) apply
...
\begin{proposition}[Smooth covering compute direct image]
\label{stacks-sheaves-proposition-smooth-covering-compute-direct-image}
\source{stacks:072G}
\href{https://stacks.math.columbia.edu/tag/072G}{\texttt{Stacks tag 072G}}
\group{stacks-sheaves}
...
\begin{proof}
To see this we will check the hypotheses (1) -- (4) of
Lemma \ref{stacks-sheaves-lemma-cech-to-cohomology-relative} and
Lemma \ref{stacks-sheaves-lemma-cech-to-cohomology-relative-modules}.
The $1$-morphism $f$ is faithful by
Algebraic Stacks, Lemma
\ref{algebraic-lemma-characterize-representable-by-algebraic-spaces}.
This proves (4).
...
\source{stacks:075G}
\href{https://stacks.math.columbia.edu/tag/075G}{\texttt{Stacks tag 075G}}
\group{stacks-sheaves}
...
Lemmas \ref{stacks-sheaves-lemma-pullback-injective} and
...
\begin{lemma}[Base change higher direct images]
\label{stacks-sheaves-lemma-base-change-higher-direct-images}
\source{stacks:075H}
\href{https://stacks.math.columbia.edu/tag/075H}{\texttt{Stacks tag 075H}}
\group{stacks-sheaves}
...
Lemma \ref{stacks-sheaves-lemma-base-change} (and it holds for arbitrary presheaves).
...
Lemma \ref{stacks-sheaves-lemma-pushforward-restriction}.
\end{proof}
...
\source{stacks:075L}
\href{https://stacks.math.columbia.edu/tag/075L}{\texttt{Stacks tag 075L}}
\group{stacks-sheaves}
...
$\pi_{F, *} = i_F^{-1}$ (see Lemma \ref{stacks-sheaves-lemma-compare})
...
\begin{lemma}[Compare morphism cohomology]
\label{stacks-sheaves-lemma-compare-morphism-cohomology}
\source{stacks:075N}
\href{https://stacks.math.columbia.edu/tag/075N}{\texttt{Stacks tag 075N}}
\group{stacks-sheaves}
...
Lemma \ref{stacks-sheaves-lemma-compare-injectives}
and (\ref{equation-compare-big-small})
on choosing an injective resolution of $\mathcal{F}$.

\medskip\noindent
Part (2) can be proved as follows. In Lemma \ref{stacks-sheaves-lemma-compare-morphism}
...
\begin{lemma}[Compare representable morphism cohomology]
\label{stacks-sheaves-lemma-compare-representable-morphism-cohomology}
\source{stacks:075P}
\href{https://stacks.math.columbia.edu/tag/075P}{\texttt{Stacks tag 075P}}
\group{stacks-sheaves}

Let $S$ be a scheme. Consider a $2$-fibre product square
$$
\begin{array}{cc}\mathcal{X}' \underset{g'}{\longrightarrow}\underset{f'}{\downarrow} & \mathcal{X} \overset{f}{\downarrow} \\ \mathcal{Y}' \overset{g}{\longrightarrow} & \mathcal{Y}\end{array}
$$
...
Lemmas \ref{stacks-sheaves-lemma-base-change-higher-direct-images} and
...
\begin{lemma}[Lqc flat base change fppf sheaf]
\label{stacks-sheaves-lemma-lqc-flat-base-change-fppf-sheaf}
\source{stacks:076T}
\href{https://stacks.math.columbia.edu/tag/076T}{\texttt{Stacks tag 076T}}
\group{stacks-sheaves}
...
\source{stacks:075R}
\href{https://stacks.math.columbia.edu/tag/075R}{\texttt{Stacks tag 075R}}
\group{stacks-sheaves}
...
follows from
Lemma \ref{stacks-sheaves-lemma-lqc-flat-base-change-fppf-sheaf}.
...
Lemma \ref{stacks-sheaves-lemma-cohomology-restriction}
we have
...
also (by Lemmas \ref{stacks-sheaves-lemma-pullback-lqc} and \ref{stacks-sheaves-lemma-comparison}),
...
\begin{lemma}[Cohomology on subcategory]
\label{stacks-sheaves-lemma-cohomology-on-subcategory}
\source{stacks:07AK}
\href{https://stacks.math.columbia.edu/tag/07AK}{\texttt{Stacks tag 07AK}}
\group{stacks-sheaves}
...
$(\Sch/U)_{fppf}$, see Lemma \ref{stacks-sheaves-lemma-localizing}.)
The map of sheaves
$$
h_x \longrightarrow *
$$
...
\source{stacks:0H09}
\href{https://stacks.math.columbia.edu/tag/0H09}{\texttt{Stacks tag 0H09}}
\group{stacks-sheaves}
...
\begin{definition}[Alternative inherited topologies]
\label{stacks-sheaves-definition-alternative-inherited-topologies}
\source{stacks:0H0A}
\href{https://stacks.math.columbia.edu/tag/0H0A}{\texttt{Stacks tag 0H0A}}
\group{stacks-sheaves}
...
\source{stacks:0H0B}
\href{https://stacks.math.columbia.edu/tag/0H0B}{\texttt{Stacks tag 0H0B}}
\group{stacks-sheaves}
...
Lemma \ref{stacks-sheaves-lemma-alternative} extends to an equivalence
\begin{equation}
...
Let $p : \mathcal{X} \to (\Sch/S)_{fppf}$ be a category fibred in groupoids.
In Section \ref{stacks-sheaves-section-alternative} we have associated to this a ringed site
$(\mathcal{X}_{affine}, \mathcal{O})$.

\begin{lemma}[Quasi coherent alternative]
\label{stacks-sheaves-lemma-quasi-coherent-alternative}
\source{stacks:0H0E}
\href{https://stacks.math.columbia.edu/tag/0H0E}{\texttt{Stacks tag 0H0E}}
\group{stacks-sheaves}
...
topology (Definition \ref{stacks-sheaves-definition-alternative}) and hence a sheaf
...
Similarly to the discussion in Section \ref{stacks-sheaves-section-restriction}
...
\begin{lemma}[Locally quasi coherent alternative]
\label{stacks-sheaves-lemma-locally-quasi-coherent-alternative}
\source{stacks:0H0F}
\href{https://stacks.math.columbia.edu/tag/0H0F}{\texttt{Stacks tag 0H0F}}
\group{stacks-sheaves}
...
Lemma \ref{stacks-sheaves-lemma-quasi-coherent-alternative},
...
\source{stacks:0H0H}
\href{https://stacks.math.columbia.edu/tag/0H0H}{\texttt{Stacks tag 0H0H}}
\group{stacks-sheaves}

Let $p : \mathcal{X} \to (\Sch/S)_{fppf}$ be a category fibred in groupoids.
Let $\mathcal{O}$ be the sheaf of rings on $\mathcal{X}_{affine}$ introduced
in Section \ref{stacks-sheaves-section-alternative}. We define the
...
\source{stacks:0H0I}
\href{https://stacks.math.columbia.edu/tag/0H0I}{\texttt{Stacks tag 0H0I}}
\group{stacks-sheaves}

In the situation of Definition \ref{stacks-sheaves-definition-QC} suppose that
...
\begin{lemma}[QC compare]
\label{stacks-sheaves-lemma-QC-compare}
\source{stacks:0H0J}
\href{https://stacks.math.columbia.edu/tag/0H0J}{\texttt{Stacks tag 0H0J}}
\group{stacks-sheaves}
...
discussion in Section \ref{stacks-sheaves-section-restriction}.
...
\begin{proposition}[QC compare]
\label{stacks-sheaves-proposition-QC-compare}
\source{stacks:0H0K}
\href{https://stacks.math.columbia.edu/tag/0H0K}{\texttt{Stacks tag 0H0K}}
\group{stacks-sheaves}
...
The functor $u : X_\etale \to \mathcal{X}_\etale$ of Lemma \ref{stacks-sheaves-lemma-compare}
...
of ringed sites. Lemma \ref{stacks-sheaves-lemma-QC-compare} and
...
$$
where $i_X$ and $\pi_X$ are the morphisms from Lemma \ref{stacks-sheaves-lemma-compare}
...
\begin{proposition}[QC derived complete]
\label{stacks-sheaves-proposition-QC-derived-complete}
\source{stacks:0H0L}
\href{https://stacks.math.columbia.edu/tag/0H0L}{\texttt{Stacks tag 0H0L}}
\group{stacks-sheaves}
...
\begin{lemma}[QC compare fppf]
\label{stacks-sheaves-lemma-QC-compare-fppf}
\source{stacks:0H0X}
\href{https://stacks.math.columbia.edu/tag/0H0X}{\texttt{Stacks tag 0H0X}}
\group{stacks-sheaves}
...
\begin{proof}
The proof is exactly the same as the proof of Lemma \ref{stacks-sheaves-lemma-QC-compare}.
Assumption (1) holds by definition of $\mathcal{X}_{affine}$.
For condition (2) we use that for $x \in \Ob(\mathcal{X})$
lying over the affine scheme $U = p(x)$ we have an equivalence
$\mathcal{X}_{affine, \etale}/x = (\textit{Aff}/U)_\etale$ compatible
