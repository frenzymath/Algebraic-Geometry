...
\begin{remark}
\label{src-geometric-local-systems-general-curves-isomonodromy-ch03-background-on-atiyah-bundles-and-isomonodromic-deformations-statement-1}
\source{geometric-local-systems-general-curves-isomonodromy}
\notready
...
\end{remark}
\begin{example}
[Families of families, essentially in \cite{doran:isomonodromic}]\label{src-geometric-local-systems-general-curves-isomonodromy-ch03-background-on-atiyah-bundles-and-isomonodromic-deformations-statement-2}
\source{geometric-local-systems-general-curves-isomonodromy}
\notready
