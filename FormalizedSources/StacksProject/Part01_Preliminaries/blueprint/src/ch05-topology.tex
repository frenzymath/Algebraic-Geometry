...
\begin{lemma}[Hausdorff]
\label{topology-lemma-Hausdorff}
\source{stacks:08ZE}
\href{https://stacks.math.columbia.edu/tag/08ZE}{\texttt{Stacks tag 08ZE}}
\group{topology}
...
\Delta(X)$ is an open set of $ X \times X$ which is equivalent to saying that
the diagonal $\Delta(X) \subset X \times X$ is closed in $X \times X$.
The converse is similar:
The complement $(X \times X) \setminus \Delta(X)$ consists
...
\begin{lemma}[Graphs of maps to Hausdorff spaces are closed.]
\label{topology-lemma-graph-closed}
\source{stacks:08ZF}
\href{https://stacks.math.columbia.edu/tag/08ZF}{\texttt{Stacks tag 08ZF}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-Hausdorff}

The graph is the inverse image of the diagonal under the map
$X \times Y \to Y \times Y$. Thus the lemma follows from
Lemma \ref{topology-lemma-Hausdorff}.
\end{proof}

\begin{lemma}[Section closed]
\label{topology-lemma-section-closed}
\source{stacks:08ZG}
\href{https://stacks.math.columbia.edu/tag/08ZG}{\texttt{Stacks tag 08ZG}}
\group{topology}
...
This follows from Lemma \ref{topology-lemma-Hausdorff} as
$s(Y) = \{x \in X \mid x = s(f(x))\}$.
\end{proof}

\begin{lemma}[Fibre product closed]
\label{topology-lemma-fibre-product-closed}
\source{stacks:08ZH}
\href{https://stacks.math.columbia.edu/tag/08ZH}{\texttt{Stacks tag 08ZH}}
\group{topology}
...
\source{stacks:0CY1}
\href{https://stacks.math.columbia.edu/tag/0CY1}{\texttt{Stacks tag 0CY1}}
\group{topology}
...
\begin{lemma}[Separated]
\label{topology-lemma-separated}
\source{stacks:0CY2}
\href{https://stacks.math.columbia.edu/tag/0CY2}{\texttt{Stacks tag 0CY2}}
\group{topology}
...
\begin{proof}
\uses{topology-definition-separated}

If $f$ is separated, by Definition \ref{topology-definition-separated}, $\Delta$ is a
...
\begin{lemma}[From hausdorff]
\label{topology-lemma-from-hausdorff}
\source{stacks:0CY3}
\href{https://stacks.math.columbia.edu/tag/0CY3}{\texttt{Stacks tag 0CY3}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-separated, topology-lemma-Hausdorff}

Clear from Lemmas \ref{topology-lemma-separated} and \ref{topology-lemma-Hausdorff}
...
\source{stacks:0CY4}
\href{https://stacks.math.columbia.edu/tag/0CY4}{\texttt{Stacks tag 0CY4}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-separated}

Follows from characterization (2) of Lemma \ref{topology-lemma-separated}.
...
\source{stacks:004P}
\href{https://stacks.math.columbia.edu/tag/004P}{\texttt{Stacks tag 004P}}
\group{topology}
...
\begin{lemma}[Make base]
\label{topology-lemma-make-base}
\source{stacks:0D5P}
\href{https://stacks.math.columbia.edu/tag/0D5P}{\texttt{Stacks tag 0D5P}}
\group{topology}
...
Properties (1) and (2) of Definition \ref{topology-definition-base} are
...
(1) of Definition \ref{topology-definition-base} and
hence $\sigma(\mathcal{B}) \subset \mathcal{T}$. Conversely, part
(2) of Definition \ref{topology-definition-base} tells us that every element
of $\mathcal{T}$ is a union of elements of $\mathcal{B}$, i.e.,
$\mathcal{T} \subset \sigma(\mathcal{B})$. This finishes the proof.
\end{proof}

\begin{lemma}[Refine covering basis]
\label{topology-lemma-refine-covering-basis}
\source{stacks:004Q}
\href{https://stacks.math.columbia.edu/tag/004Q}{\texttt{Stacks tag 004Q}}
\group{topology}
...
\source{stacks:08ZI}
\href{https://stacks.math.columbia.edu/tag/08ZI}{\texttt{Stacks tag 08ZI}}
\group{topology}
...
\source{stacks:08ZJ}
\href{https://stacks.math.columbia.edu/tag/08ZJ}{\texttt{Stacks tag 08ZJ}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-make-base}

By convention $\bigcap_\emptyset B = X $. Thus we can apply Lemma
\ref{topology-lemma-make-base} to the set of finite intersections of elements
from $\mathcal B$.
\end{proof}

\begin{lemma}[Create map from subcollection]
\label{topology-lemma-create-map-from-subcollection}
\source{stacks:0D5Q}
\href{https://stacks.math.columbia.edu/tag/0D5Q}{\texttt{Stacks tag 0D5Q}}
\group{topology}
...
mirror the assumptions in Lemma \ref{topology-lemma-make-base}
...
\source{stacks:09R8}
\href{https://stacks.math.columbia.edu/tag/09R8}{\texttt{Stacks tag 09R8}}
\group{topology}
...
\source{stacks:08ZK}
\href{https://stacks.math.columbia.edu/tag/08ZK}{\texttt{Stacks tag 08ZK}}
\group{topology}
...
\source{stacks:0406}
\href{https://stacks.math.columbia.edu/tag/0406}{\texttt{Stacks tag 0406}}
\group{topology}
...
\begin{lemma}[Open morphism quotient topology]
\label{topology-lemma-open-morphism-quotient-topology}
\source{stacks:02YB}
\href{https://stacks.math.columbia.edu/tag/02YB}{\texttt{Stacks tag 02YB}}
\group{topology}
...
\begin{lemma}[Closed morphism quotient topology]
\label{topology-lemma-closed-morphism-quotient-topology}
\source{stacks:0AAU}
\href{https://stacks.math.columbia.edu/tag/0AAU}{\texttt{Stacks tag 0AAU}}
\group{topology}
...
\source{stacks:004S}
\href{https://stacks.math.columbia.edu/tag/004S}{\texttt{Stacks tag 004S}}
\group{topology}
...
\begin{lemma}[Image connected space]
\label{topology-lemma-image-connected-space}
\source{stacks:0376}
\href{https://stacks.math.columbia.edu/tag/0376}{\texttt{Stacks tag 0376}}
\group{topology}
...
\begin{lemma}[Connected components]
\label{topology-lemma-connected-components}
\source{stacks:004T}
\href{https://stacks.math.columbia.edu/tag/004T}{\texttt{Stacks tag 004T}}
\group{topology}
...
\begin{remark}[Quasi components]
\label{topology-remark-quasi-components}
\source{stacks:0FIY}
\href{https://stacks.math.columbia.edu/tag/0FIY}{\texttt{Stacks tag 0FIY}}
\group{topology}
...
\begin{lemma}[Connected fibres quotient topology connected components]
\label{topology-lemma-connected-fibres-quotient-topology-connected-components}
\source{stacks:0377}
\href{https://stacks.math.columbia.edu/tag/0377}{\texttt{Stacks tag 0377}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-connected-components, topology-lemma-image-connected-space}

Let $T \subset Y$ be a connected component.
Note that $T$ is closed, see Lemma \ref{topology-lemma-connected-components}.
The lemma follows if we show that $f^{-1}(T)$ is connected
because any connected subset of $X$ maps into a connected component
of $Y$ by Lemma \ref{topology-lemma-image-connected-space}.
...
\begin{lemma}[Connected fibres connected components]
\label{topology-lemma-connected-fibres-connected-components}
\source{stacks:0378}
\href{https://stacks.math.columbia.edu/tag/0378}{\texttt{Stacks tag 0378}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-connected-fibres-quotient-topology-connected-components}

This is a special case of
Lemma \ref{topology-lemma-connected-fibres-quotient-topology-connected-components}.
\end{proof}

\begin{lemma}[Finite fibre connected components]
\label{topology-lemma-finite-fibre-connected-components}
\source{stacks:07VB}
\href{https://stacks.math.columbia.edu/tag/07VB}{\texttt{Stacks tag 07VB}}
\group{topology}
...
\source{stacks:04MC}
\href{https://stacks.math.columbia.edu/tag/04MC}{\texttt{Stacks tag 04MC}}
\group{topology}
...
\begin{lemma}[Space connected components]
\label{topology-lemma-space-connected-components}
\source{stacks:08ZL}
\href{https://stacks.math.columbia.edu/tag/08ZL}{\texttt{Stacks tag 08ZL}}
\group{topology}
...
\source{stacks:04MD}
\href{https://stacks.math.columbia.edu/tag/04MD}{\texttt{Stacks tag 04MD}}
\group{topology}
...
\begin{lemma}[Locally connected]
\label{topology-lemma-locally-connected}
\source{stacks:04ME}
\href{https://stacks.math.columbia.edu/tag/04ME}{\texttt{Stacks tag 04ME}}
\group{topology}
...
\source{stacks:004V}
\href{https://stacks.math.columbia.edu/tag/004V}{\texttt{Stacks tag 004V}}
\group{topology}
...
\begin{lemma}[Image irreducible space]
\label{topology-lemma-image-irreducible-space}
\source{stacks:0379}
\href{https://stacks.math.columbia.edu/tag/0379}{\texttt{Stacks tag 0379}}
\group{topology}
...
\begin{lemma}[Irreducible]
\label{topology-lemma-irreducible}
\source{stacks:004W}
\href{https://stacks.math.columbia.edu/tag/004W}{\texttt{Stacks tag 004W}}
\group{topology}
...
\begin{lemma}[Pick irreducible components]
\label{topology-lemma-pick-irreducible-components}
\source{stacks:0G2Y}
\href{https://stacks.math.columbia.edu/tag/0G2Y}{\texttt{Stacks tag 0G2Y}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-irreducible}
...
\medskip\noindent
Conversely, take one of the $X_i$. By Lemma \ref{topology-lemma-irreducible} it is
contained in an irreducible component $Y$ of $X$. By the previous paragraph
$Y = X_j$ for some $j$. So $X_i \subset X_j$ and since the original union does
not have redundant members, $X_i = X_j$, which is an irreducible component.
\end{proof}

\begin{lemma}[Surjective continuous irreducible components]
\label{topology-lemma-surjective-continuous-irreducible-components}
\source{stacks:0GM2}
\href{https://stacks.math.columbia.edu/tag/0GM2}{\texttt{Stacks tag 0GM2}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-image-irreducible-space, topology-lemma-irreducible, topology-lemma-pick-irreducible-components}

Say $X_1, \ldots, X_n$ are the irreducible components of $X$.
By Lemmas \ref{topology-lemma-image-irreducible-space} and \ref{topology-lemma-irreducible}
...
Lemma \ref{topology-lemma-pick-irreducible-components} to see that the $Y_i$
...
\source{stacks:004X}
\href{https://stacks.math.columbia.edu/tag/004X}{\texttt{Stacks tag 004X}}
\group{topology}
...
\begin{lemma}[Sober subspace]
\label{topology-lemma-sober-subspace}
\source{stacks:0B31}
\href{https://stacks.math.columbia.edu/tag/0B31}{\texttt{Stacks tag 0B31}}
\group{topology}
...
\begin{lemma}[Sober local]
\label{topology-lemma-sober-local}
\source{stacks:06N9}
\href{https://stacks.math.columbia.edu/tag/06N9}{\texttt{Stacks tag 06N9}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-sober-subspace}

Proof of (1). If $X$ is Kolmogorov then so is $X_i$ for every $i\in I$ by
Lemma \ref{topology-lemma-sober-subspace}. Suppose $X_i$ is Kolmogorov for every
...
Lemma \ref{topology-lemma-sober-subspace}. Suppose $X_i$ is quasi-sober for every
...
\begin{example}[Quasi sober not kolmogorov]
\label{topology-example-quasi-sober-not-kolmogorov}
\source{stacks:0B32}
\href{https://stacks.math.columbia.edu/tag/0B32}{\texttt{Stacks tag 0B32}}
\group{topology}
...
\begin{example}[Kolmogorov not quasi sober]
\label{topology-example-kolmogorov-not-quasi-sober}
\source{stacks:0B33}
\href{https://stacks.math.columbia.edu/tag/0B33}{\texttt{Stacks tag 0B33}}
\group{topology}
...
However, the family of its singletons is
a covering by discrete and hence sober spaces.
\end{example}

\begin{example}[Not kolmogorov not quasi sober]
\label{topology-example-not-kolmogorov-not-quasi-sober}
\source{stacks:0B34}
\href{https://stacks.math.columbia.edu/tag/0B34}{\texttt{Stacks tag 0B34}}
\group{topology}

\uses{topology-example-quasi-sober-not-kolmogorov, topology-example-kolmogorov-not-quasi-sober}
Let $X$ and $Y$ be as in Example \ref{topology-example-quasi-sober-not-kolmogorov} and
Example \ref{topology-example-kolmogorov-not-quasi-sober}. Then, $X\amalg Y$ is neither
Kolmogorov nor quasi-sober.
\end{example}

\begin{example}[Sober subspace]
\label{topology-example-sober-subspace}
\source{stacks:0B35}
\href{https://stacks.math.columbia.edu/tag/0B35}{\texttt{Stacks tag 0B35}}
\group{topology}
...
\begin{example}[Hausdorff]
\label{topology-example-Hausdorff}
\source{stacks:004Y}
\href{https://stacks.math.columbia.edu/tag/004Y}{\texttt{Stacks tag 004Y}}
\group{topology}
...
\begin{lemma}[Irreducible on top]
\label{topology-lemma-irreducible-on-top}
\source{stacks:004Z}
\href{https://stacks.math.columbia.edu/tag/004Z}{\texttt{Stacks tag 004Z}}
\group{topology}
...
\begin{lemma}[Irreducible fibres irreducible components]
\label{topology-lemma-irreducible-fibres-irreducible-components}
\source{stacks:037A}
\href{https://stacks.math.columbia.edu/tag/037A}{\texttt{Stacks tag 037A}}
\group{topology}
...
\begin{proof}
\uses{topology-definition-irreducible-components, topology-lemma-irreducible, topology-lemma-image-irreducible-space, topology-lemma-irreducible-on-top}
...
Note that $T$ is closed, see Lemma \ref{topology-lemma-irreducible}.
...
of $Y$ by Lemma \ref{topology-lemma-image-irreducible-space}.
Note that $f^{-1}(T) \to T$ satisfies the assumptions
of Lemma \ref{topology-lemma-irreducible-on-top}. Hence we win.
\end{proof}

The construction of the following lemma is sometimes called
the ``soberification''.

\begin{lemma}[Make sober]
\label{topology-lemma-make-sober}
\source{stacks:0A2N}
\href{https://stacks.math.columbia.edu/tag/0A2N}{\texttt{Stacks tag 0A2N}}
\group{topology}
...
\begin{lemma}[Remove irreducible connected]
\label{topology-lemma-remove-irreducible-connected}
\source{stacks:0GM3}
\href{https://stacks.math.columbia.edu/tag/0GM3}{\texttt{Stacks tag 0GM3}}
\group{topology}
...
\source{stacks:0051}
\href{https://stacks.math.columbia.edu/tag/0051}{\texttt{Stacks tag 0051}}
\group{topology}
...
\begin{lemma}[Noetherian]
\label{topology-lemma-Noetherian}
\source{stacks:0052}
\href{https://stacks.math.columbia.edu/tag/0052}{\texttt{Stacks tag 0052}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-irreducible, topology-lemma-pick-irreducible-components}
...
components (Lemma \ref{topology-lemma-irreducible}).
...
components (Lemma \ref{topology-lemma-pick-irreducible-components}), a contradiction.
...
Because $X = Z \cup Z_1 \cup \ldots Z_n$ (see Lemma \ref{topology-lemma-irreducible}),
also $U = X \setminus (Z_1\cup\ldots\cup Z_n)$
and hence open in $X$. Thus $Z$ contains a nonempty
open of $X$.
\end{proof}

\begin{lemma}[Image Noetherian]
\label{topology-lemma-image-Noetherian}
\source{stacks:04Z8}
\href{https://stacks.math.columbia.edu/tag/04Z8}{\texttt{Stacks tag 04Z8}}
\group{topology}
...
\begin{lemma}[Finite union Noetherian]
\label{topology-lemma-finite-union-Noetherian}
\source{stacks:0053}
\href{https://stacks.math.columbia.edu/tag/0053}{\texttt{Stacks tag 0053}}
\group{topology}
...
\begin{example}[Locally Noetherian no closed point]
\label{topology-example-locally-Noetherian-no-closed-point}
\source{stacks:02HZ}
\href{https://stacks.math.columbia.edu/tag/02HZ}{\texttt{Stacks tag 02HZ}}
\group{topology}

\uses{topology-lemma-quasi-compact-closed-point, topology-lemma-Noetherian-quasi-compact}
Any nonempty, Kolmogorov Noetherian topological space has a closed point
(combine Lemmas \ref{topology-lemma-quasi-compact-closed-point} and
...
\begin{lemma}[Locally Noetherian locally connected]
\label{topology-lemma-locally-Noetherian-locally-connected}
\source{stacks:04MF}
\href{https://stacks.math.columbia.edu/tag/04MF}{\texttt{Stacks tag 04MF}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-Noetherian}
...
Lemma \ref{topology-lemma-Noetherian}.
...
\begin{definition}[Krull]
\label{topology-definition-Krull}
\source{stacks:0055}
\href{https://stacks.math.columbia.edu/tag/0055}{\texttt{Stacks tag 0055}}
\group{topology}
...
\begin{lemma}[Dimension supremum local dimensions]
\label{topology-lemma-dimension-supremum-local-dimensions}
\source{stacks:0B7I}
\href{https://stacks.math.columbia.edu/tag/0B7I}{\texttt{Stacks tag 0B7I}}
\group{topology}
...
\begin{proof}
\uses{topology-definition-Krull}

It is clear that $\dim(X) \geq \dim_x(X)$ for all $x \in X$ (see
discussion following Definition \ref{topology-definition-Krull}).
...
\begin{example}[Krull Rn]
\label{topology-example-Krull-Rn}
\source{stacks:0056}
\href{https://stacks.math.columbia.edu/tag/0056}{\texttt{Stacks tag 0056}}
\group{topology}
...
\begin{example}[Krull 2set]
\label{topology-example-krull-2set}
\source{stacks:0057}
\href{https://stacks.math.columbia.edu/tag/0057}{\texttt{Stacks tag 0057}}
\group{topology}
...
\source{stacks:0058}
\href{https://stacks.math.columbia.edu/tag/0058}{\texttt{Stacks tag 0058}}
\group{topology}
...
\source{stacks:02I3}
\href{https://stacks.math.columbia.edu/tag/02I3}{\texttt{Stacks tag 02I3}}
\group{topology}
...
\begin{lemma}[Codimension at generic point]
\label{topology-lemma-codimension-at-generic-point}
\source{stacks:02I4}
\href{https://stacks.math.columbia.edu/tag/02I4}{\texttt{Stacks tag 02I4}}
\group{topology}
...
\begin{example}[Noetherian infinite codimension]
\label{topology-example-Noetherian-infinite-codimension}
\source{stacks:02I5}
\href{https://stacks.math.columbia.edu/tag/02I5}{\texttt{Stacks tag 02I5}}
\group{topology}
...
\source{stacks:02I1}
\href{https://stacks.math.columbia.edu/tag/02I1}{\texttt{Stacks tag 02I1}}
\group{topology}
...
\begin{lemma}[Catenary]
\label{topology-lemma-catenary}
\source{stacks:02I2}
\href{https://stacks.math.columbia.edu/tag/02I2}{\texttt{Stacks tag 02I2}}
\group{topology}
...
\begin{lemma}[Catenary in codimension]
\label{topology-lemma-catenary-in-codimension}
\source{stacks:02I6}
\href{https://stacks.math.columbia.edu/tag/02I6}{\texttt{Stacks tag 02I6}}
\group{topology}
...
\begin{proof}
\uses{topology-definition-catenary}

Let suppose that $X$ is catenary. According to
Definition \ref{topology-definition-catenary}, for every pair of
...
\source{stacks:005A}
\href{https://stacks.math.columbia.edu/tag/005A}{\texttt{Stacks tag 005A}}
\group{topology}
...
\source{stacks:005B}
\href{https://stacks.math.columbia.edu/tag/005B}{\texttt{Stacks tag 005B}}
\group{topology}
...
\begin{lemma}[Closed in quasi compact]
\label{topology-lemma-closed-in-quasi-compact}
\source{stacks:005C}
\href{https://stacks.math.columbia.edu/tag/005C}{\texttt{Stacks tag 005C}}
\group{topology}
...
\begin{lemma}[Quasi compact in Hausdorff]
\label{topology-lemma-quasi-compact-in-Hausdorff}
\source{stacks:08YB}
\href{https://stacks.math.columbia.edu/tag/08YB}{\texttt{Stacks tag 08YB}}
\group{topology}
...
\begin{lemma}[Closed in compact]
\label{topology-lemma-closed-in-compact}
\source{stacks:08YC}
\href{https://stacks.math.columbia.edu/tag/08YC}{\texttt{Stacks tag 08YC}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-closed-in-quasi-compact, topology-lemma-quasi-compact-in-Hausdorff}

The implication (a) $\Rightarrow$ (b) is
Lemma \ref{topology-lemma-closed-in-quasi-compact}.
The implication (b) $\Rightarrow$ (a) is
Lemma \ref{topology-lemma-quasi-compact-in-Hausdorff}.
\end{proof}

The following is really a reformulation of the
quasi-compact property.

\begin{lemma}[Intersection closed in quasi compact]
\label{topology-lemma-intersection-closed-in-quasi-compact}
\source{stacks:005D}
\href{https://stacks.math.columbia.edu/tag/005D}{\texttt{Stacks tag 005D}}
\group{topology}
...
\begin{lemma}[Image quasi compact]
\label{topology-lemma-image-quasi-compact}
\source{stacks:04Z9}
\href{https://stacks.math.columbia.edu/tag/04Z9}{\texttt{Stacks tag 04Z9}}
\group{topology}
...
\begin{lemma}[Quasi compact closed point]
\label{topology-lemma-quasi-compact-closed-point}
\source{stacks:005E}
\href{https://stacks.math.columbia.edu/tag/005E}{\texttt{Stacks tag 005E}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-intersection-closed-in-quasi-compact}
...
By Lemma \ref{topology-lemma-intersection-closed-in-quasi-compact} we see
...
\begin{lemma}[Closed points quasi compact]
\label{topology-lemma-closed-points-quasi-compact}
\source{stacks:08ZM}
\href{https://stacks.math.columbia.edu/tag/08ZM}{\texttt{Stacks tag 08ZM}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-closed-in-quasi-compact, topology-lemma-quasi-compact-closed-point}
...
$X$, hence quasi-compact (Lemma \ref{topology-lemma-closed-in-quasi-compact})
and Kolmogorov. By Lemma \ref{topology-lemma-quasi-compact-closed-point}
...
\begin{lemma}[Connected component intersection]
\label{topology-lemma-connected-component-intersection}
\source{stacks:005F}
\href{https://stacks.math.columbia.edu/tag/005F}{\texttt{Stacks tag 005F}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-closed-in-quasi-compact, topology-lemma-intersection-closed-in-quasi-compact}
...
Lemma \ref{topology-lemma-closed-in-quasi-compact} and assumption (1).
...
By Lemma \ref{topology-lemma-intersection-closed-in-quasi-compact}
...
\begin{lemma}[Connected component intersection compact Hausdorff]
\label{topology-lemma-connected-component-intersection-compact-Hausdorff}
\source{stacks:08ZN}
\href{https://stacks.math.columbia.edu/tag/08ZN}{\texttt{Stacks tag 08ZN}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-closed-in-quasi-compact, topology-lemma-quasi-compact-in-Hausdorff, topology-lemma-intersection-closed-in-quasi-compact}
...
In particular, $B$ and $C$ are closed in $X$, and so quasi-compact by
Lemma \ref{topology-lemma-closed-in-quasi-compact}.
By Lemma \ref{topology-lemma-quasi-compact-in-Hausdorff}
there exist disjoint opens $U, V \subset X$ with $B \subset U$ and
$C \subset V$. Then $X \setminus U \cup V$ is closed in $X$
hence quasi-compact (Lemma \ref{topology-lemma-closed-in-quasi-compact}).
It follows that $(X \setminus U \cup V) \cap Z_\alpha = \emptyset$
for some $\alpha$ by Lemma \ref{topology-lemma-intersection-closed-in-quasi-compact}.
...
\begin{lemma}[Closed union connected components]
\label{topology-lemma-closed-union-connected-components}
\source{stacks:04PL}
\href{https://stacks.math.columbia.edu/tag/04PL}{\texttt{Stacks tag 04PL}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-connected-component-intersection, topology-lemma-closed-in-quasi-compact, topology-lemma-intersection-closed-in-quasi-compact}
...
Lemma \ref{topology-lemma-connected-component-intersection}
...
Lemma \ref{topology-lemma-intersection-closed-in-quasi-compact}.
For this $\alpha$ we see that $U_\alpha = X \setminus V_\alpha$
is an open and closed subset of $X$ which contains $T$ and not $x$.
The lemma follows.
\end{proof}

\begin{lemma}[Noetherian quasi compact]
\label{topology-lemma-Noetherian-quasi-compact}
\source{stacks:04ZA}
\href{https://stacks.math.columbia.edu/tag/04ZA}{\texttt{Stacks tag 04ZA}}
\group{topology}
...
\begin{lemma}[Quasi compact locally Noetherian Noetherian]
\label{topology-lemma-quasi-compact-locally-Noetherian-Noetherian}
\source{stacks:04ZB}
\href{https://stacks.math.columbia.edu/tag/04ZB}{\texttt{Stacks tag 04ZB}}
\group{topology}
...
\source{stacks:08ZP}
\href{https://stacks.math.columbia.edu/tag/08ZP}{\texttt{Stacks tag 08ZP}}
\group{topology}
...
\begin{definition}[Locally quasi compact]
\label{topology-definition-locally-quasi-compact}
\source{stacks:0068}
\href{https://stacks.math.columbia.edu/tag/0068}{\texttt{Stacks tag 0068}}
\group{topology}
...
\begin{lemma}[Locally quasi compact Hausdorff]
\label{topology-lemma-locally-quasi-compact-Hausdorff}
\source{stacks:08ZR}
\href{https://stacks.math.columbia.edu/tag/08ZR}{\texttt{Stacks tag 08ZR}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-quasi-compact-in-Hausdorff, topology-lemma-closed-in-quasi-compact}
...
as a closed subset of $E$ (Lemma \ref{topology-lemma-closed-in-quasi-compact}).
...
\source{stacks:0CQN}
\href{https://stacks.math.columbia.edu/tag/0CQN}{\texttt{Stacks tag 0CQN}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-quasi-compact-in-Hausdorff, topology-lemma-intersection-closed-in-quasi-compact}
...
\begin{lemma}[Relatively compact refinement]
\label{topology-lemma-relatively-compact-refinement}
\source{stacks:09UV}
\href{https://stacks.math.columbia.edu/tag/09UV}{\texttt{Stacks tag 09UV}}
\group{topology}
...
subsets of $X$, by Lemmas \ref{topology-lemma-closed-in-quasi-compact} and
...
\begin{lemma}[Refine covering]
\label{topology-lemma-refine-covering}
\source{stacks:09UW}
\href{https://stacks.math.columbia.edu/tag/09UW}{\texttt{Stacks tag 09UW}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-relatively-compact-refinement}
...
Lemma \ref{topology-lemma-relatively-compact-refinement}
...
\begin{lemma}[Lift covering of a closed]
\label{topology-lemma-lift-covering-of-a-closed}
\source{stacks:09UX}
\href{https://stacks.math.columbia.edu/tag/09UX}{\texttt{Stacks tag 09UX}}
\group{topology}
...
\begin{lemma}[Lift covering of quasi compact hausdorff subset]
\label{topology-lemma-lift-covering-of-quasi-compact-hausdorff-subset}
\source{stacks:0CY5}
\href{https://stacks.math.columbia.edu/tag/0CY5}{\texttt{Stacks tag 0CY5}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-closed-in-quasi-compact}
...
\source{stacks:08ZT}
\href{https://stacks.math.columbia.edu/tag/08ZT}{\texttt{Stacks tag 08ZT}}
\group{topology}
...
\begin{lemma}[Describe limits]
\label{topology-lemma-describe-limits}
\source{stacks:0A2P}
\href{https://stacks.math.columbia.edu/tag/0A2P}{\texttt{Stacks tag 0A2P}}
\group{topology}
...
\begin{lemma}[Characterize limit]
\label{topology-lemma-characterize-limit}
\source{stacks:0A2Q}
\href{https://stacks.math.columbia.edu/tag/0A2Q}{\texttt{Stacks tag 0A2Q}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-describe-limits}

Follows from the description of the limit topology
in Lemma \ref{topology-lemma-describe-limits}.
\end{proof}
...
\source{stacks:08ZU}
\href{https://stacks.math.columbia.edu/tag/08ZU}{\texttt{Stacks tag 08ZU}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-subbase-theorem}
...
for the topology on $X$. By Lemma \ref{topology-lemma-subbase-theorem} it
...
\begin{lemma}[Inverse limit quasi compact]
\label{topology-lemma-inverse-limit-quasi-compact}
\source{stacks:08ZV}
\href{https://stacks.math.columbia.edu/tag/08ZV}{\texttt{Stacks tag 08ZV}}
\group{topology}
...
\begin{proof}
\uses{topology-theorem-tychonov, topology-lemma-closed-in-quasi-compact, topology-lemma-graph-closed}

Recall that $\lim X_i$ is a subspace of $\prod X_i$. By
Theorem \ref{topology-theorem-tychonov} this product is quasi-compact. Hence it
...
Lemma \ref{topology-lemma-graph-closed} this graph is closed.
...
\source{stacks:0A2R}
\href{https://stacks.math.columbia.edu/tag/0A2R}{\texttt{Stacks tag 0A2R}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-inverse-limit-quasi-compact, topology-lemma-intersection-closed-in-quasi-compact}

In the proof of Lemma \ref{topology-lemma-inverse-limit-quasi-compact}
...
\source{stacks:005G}
\href{https://stacks.math.columbia.edu/tag/005G}{\texttt{Stacks tag 005G}}
\group{topology}
...
\begin{lemma}[Constructible]
\label{topology-lemma-constructible}
\source{stacks:005H}
\href{https://stacks.math.columbia.edu/tag/005H}{\texttt{Stacks tag 005H}}
\group{topology}
...
\begin{lemma}[Inverse images constructibles]
\label{topology-lemma-inverse-images-constructibles}
\source{stacks:005I}
\href{https://stacks.math.columbia.edu/tag/005I}{\texttt{Stacks tag 005I}}
\group{topology}
...
\begin{lemma}[Open immersion constructible inverse image]
\label{topology-lemma-open-immersion-constructible-inverse-image}
\source{stacks:005J}
\href{https://stacks.math.columbia.edu/tag/005J}{\texttt{Stacks tag 005J}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-inverse-images-constructibles}

Suppose that $V \subset X$ is retrocompact open in $X$.
It suffices to show that $V \cap U$ is retrocompact in $U$
by Lemma \ref{topology-lemma-inverse-images-constructibles}. To show this
...
\begin{lemma}[Quasi compact open immersion constructible image]
\label{topology-lemma-quasi-compact-open-immersion-constructible-image}
\source{stacks:09YD}
\href{https://stacks.math.columbia.edu/tag/09YD}{\texttt{Stacks tag 09YD}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-composition-quasi-compact}

Suppose that $V, W \subset U$ are retrocompact open in $U$.
Then $V, W$ are retrocompact open in $X$
(Lemma \ref{topology-lemma-composition-quasi-compact}).
...
\begin{lemma}[Collate constructible]
\label{topology-lemma-collate-constructible}
\source{stacks:053W}
\href{https://stacks.math.columbia.edu/tag/053W}{\texttt{Stacks tag 053W}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-open-immersion-constructible-inverse-image, topology-lemma-quasi-compact-open-immersion-constructible-image}
...
Lemma \ref{topology-lemma-quasi-compact-open-immersion-constructible-image}
and hence constructible.
\end{proof}

\begin{lemma}[Intersect constructible with closed]
\label{topology-lemma-intersect-constructible-with-closed}
\source{stacks:09YE}
\href{https://stacks.math.columbia.edu/tag/09YE}{\texttt{Stacks tag 09YE}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-inverse-images-constructibles, topology-lemma-closed-in-quasi-compact}
...
by Lemma \ref{topology-lemma-closed-in-quasi-compact}.
\end{proof}

\begin{lemma}[Intersect constructible with retrocompact]
\label{topology-lemma-intersect-constructible-with-retrocompact}
\source{stacks:09YF}
\href{https://stacks.math.columbia.edu/tag/09YF}{\texttt{Stacks tag 09YF}}
\group{topology}
...
\begin{lemma}[Closed constructible image]
\label{topology-lemma-closed-constructible-image}
\source{stacks:09YG}
\href{https://stacks.math.columbia.edu/tag/09YG}{\texttt{Stacks tag 09YG}}
\group{topology}
...
(Lemma \ref{topology-lemma-closed-in-quasi-compact}) and $V$ is retrocompact in $Z$.
...
\begin{lemma}[Constructible is retrocompact]
\label{topology-lemma-constructible-is-retrocompact}
\source{stacks:09YH}
\href{https://stacks.math.columbia.edu/tag/09YH}{\texttt{Stacks tag 09YH}}
\group{topology}
...
Lemma \ref{topology-lemma-intersect-constructible-with-closed}.

\begin{lemma}[Intersect constructible with constructible]
\label{topology-lemma-intersect-constructible-with-constructible}
\source{stacks:09YI}
\href{https://stacks.math.columbia.edu/tag/09YI}{\texttt{Stacks tag 09YI}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-intersect-constructible-with-retrocompact, topology-lemma-constructible-is-retrocompact}

Combine Lemmas \ref{topology-lemma-intersect-constructible-with-retrocompact} and
\ref{topology-lemma-constructible-is-retrocompact}.
\end{proof}

\begin{lemma}[Constructible in constructible]
\label{topology-lemma-constructible-in-constructible}
\source{stacks:09YJ}
\href{https://stacks.math.columbia.edu/tag/09YJ}{\texttt{Stacks tag 09YJ}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-constructible-is-retrocompact, topology-lemma-intersect-constructible-with-constructible, topology-lemma-closed-constructible-image, topology-lemma-quasi-compact-open-immersion-constructible-image}
...
(Lemma \ref{topology-lemma-constructible-is-retrocompact}).
...
Lemma \ref{topology-lemma-intersect-constructible-with-constructible}.
...
E = U \cap V^c \to U \to X
$$
Then we can apply Lemma \ref{topology-lemma-closed-constructible-image}
to the first inclusion and
Lemma \ref{topology-lemma-quasi-compact-open-immersion-constructible-image}
to the second.
\end{proof}

\begin{lemma}[Locally closed constructible image]
\label{topology-lemma-locally-closed-constructible-image}
\source{stacks:0F2K}
\href{https://stacks.math.columbia.edu/tag/0F2K}{\texttt{Stacks tag 0F2K}}
\group{topology}
...
\begin{lemma}[Collate constructible from constructible]
\label{topology-lemma-collate-constructible-from-constructible}
\source{stacks:09YK}
\href{https://stacks.math.columbia.edu/tag/09YK}{\texttt{Stacks tag 09YK}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-intersect-constructible-with-constructible, topology-lemma-constructible-in-constructible}

Combine
Lemmas \ref{topology-lemma-intersect-constructible-with-constructible} and
\ref{topology-lemma-constructible-in-constructible}.
\end{proof}

\begin{lemma}[Generic point in constructible]
\label{topology-lemma-generic-point-in-constructible}
\source{stacks:005K}
\href{https://stacks.math.columbia.edu/tag/005K}{\texttt{Stacks tag 005K}}
\group{topology}
...
\begin{lemma}[Constructible Noetherian space]
\label{topology-lemma-constructible-Noetherian-space}
\source{stacks:005L}
\href{https://stacks.math.columbia.edu/tag/005L}{\texttt{Stacks tag 005L}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-Noetherian-quasi-compact}

This follows immediately from
Lemma \ref{topology-lemma-Noetherian-quasi-compact}.
\end{proof}

\begin{lemma}[Constructible map Noetherian]
\label{topology-lemma-constructible-map-Noetherian}
\source{stacks:053Y}
\href{https://stacks.math.columbia.edu/tag/053Y}{\texttt{Stacks tag 053Y}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-constructible-Noetherian-space}

Follows immediately from
Lemma \ref{topology-lemma-constructible-Noetherian-space}
and the definition of a continuous map.
\end{proof}

\begin{lemma}[Characterize constructible Noetherian]
\label{topology-lemma-characterize-constructible-Noetherian}
\source{stacks:053Z}
\href{https://stacks.math.columbia.edu/tag/053Z}{\texttt{Stacks tag 053Z}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-constructible-map-Noetherian, topology-lemma-Noetherian, topology-lemma-constructible-Noetherian-space}

Assume $E$ is constructible and $Z \subset X$ irreducible closed.
Then $E \cap Z$ is constructible in $Z$ by
Lemma \ref{topology-lemma-constructible-map-Noetherian}.
...
\begin{lemma}[Constructible neighbourhood Noetherian]
\label{topology-lemma-constructible-neighbourhood-Noetherian}
\source{stacks:0540}
\href{https://stacks.math.columbia.edu/tag/0540}{\texttt{Stacks tag 0540}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-characterize-constructible-Noetherian}
...
Lemma \ref{topology-lemma-characterize-constructible-Noetherian}.
...
\begin{lemma}[Characterize open Noetherian]
\label{topology-lemma-characterize-open-Noetherian}
\source{stacks:0541}
\href{https://stacks.math.columbia.edu/tag/0541}{\texttt{Stacks tag 0541}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-characterize-constructible-Noetherian, topology-lemma-constructible-neighbourhood-Noetherian}

This follows formally from
Lemmas \ref{topology-lemma-characterize-constructible-Noetherian} and
...
\source{stacks:005N}
\href{https://stacks.math.columbia.edu/tag/005N}{\texttt{Stacks tag 005N}}
\group{topology}
...
\source{stacks:005O}
\href{https://stacks.math.columbia.edu/tag/005O}{\texttt{Stacks tag 005O}}
\group{topology}
...
\source{stacks:005P}
\href{https://stacks.math.columbia.edu/tag/005P}{\texttt{Stacks tag 005P}}
\group{topology}
...
which is not in $\text{pr}_1(M)$. By the Tube Lemma \ref{topology-lemma-tube}
there exists an open $U \subset Z$ such that $U \times X$ is
contained in the complement of $M$. Hence $\text{pr}_1(M)$ is closed.
\end{proof}

\begin{remark}[Lemma literature]
\label{topology-remark-lemma-literature}
\source{stacks:005Q}
\href{https://stacks.math.columbia.edu/tag/005Q}{\texttt{Stacks tag 005Q}}
\group{topology}

\uses{topology-lemma-characterize-quasi-compact}
Lemma \ref{topology-lemma-characterize-quasi-compact} is a combination of
\cite[I, p. 75, Lemme 1]{Bourbaki} and
\cite[I, p. 76, Corollaire 1]{Bourbaki}.
\end{remark}

\begin{theorem}[Characterize proper]
\label{topology-theorem-characterize-proper}
\source{stacks:005R}
\href{https://stacks.math.columbia.edu/tag/005R}{\texttt{Stacks tag 005R}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-tube, topology-lemma-characterize-quasi-compact}
...
$$
\begin{array}{cc}Z \times_Y X \underset{g'}{\longrightarrow}\underset{f'}{\downarrow} & X \overset{f}{\downarrow} \\ Z \overset{g}{\longrightarrow} & Y\end{array}
$$
...
We may apply the Tube Lemma \ref{topology-lemma-tube} to
...
$K \times Z\to Z$ is closed by Lemma \ref{topology-lemma-characterize-quasi-compact}.
Hence the composition $Z \times f^{-1}(K)\to Z \times K \to Z$
is closed and therefore $f^{-1}(K)$ must be quasi-compact
by Lemma \ref{topology-lemma-characterize-quasi-compact} again.
\end{proof}

\begin{remark}[Proof literature]
\label{topology-remark-proof-literature}
\source{stacks:005S}
\href{https://stacks.math.columbia.edu/tag/005S}{\texttt{Stacks tag 005S}}
\group{topology}
...
\begin{lemma}[A map from a compact space to a Hausdorff space is universally closed.]
\label{topology-lemma-closed-map}
\source{stacks:08YD}
\href{https://stacks.math.columbia.edu/tag/08YD}{\texttt{Stacks tag 08YD}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-closed-in-quasi-compact, topology-theorem-characterize-proper, topology-lemma-image-quasi-compact, topology-lemma-quasi-compact-in-Hausdorff}

Since every point of $Y$ is closed, we see from
Lemma \ref{topology-lemma-closed-in-quasi-compact}
that the closed subset $f^{-1}(y)$ of $X$ is quasi-compact for all $y \in Y$.
Thus, by Theorem \ref{topology-theorem-characterize-proper}
it suffices to show that $f$ is closed.
If $E \subset X$ is closed, then it is quasi-compact
(Lemma \ref{topology-lemma-closed-in-quasi-compact}),
hence $f(E) \subset Y$ is quasi-compact
(Lemma \ref{topology-lemma-image-quasi-compact}),
hence $f(E)$ is closed in $Y$
(Lemma \ref{topology-lemma-quasi-compact-in-Hausdorff}).
\end{proof}

\begin{lemma}[Bijective map]
\label{topology-lemma-bijective-map}
\source{stacks:08YE}
\href{https://stacks.math.columbia.edu/tag/08YE}{\texttt{Stacks tag 08YE}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-closed-in-quasi-compact, topology-lemma-image-quasi-compact, topology-lemma-quasi-compact-in-Hausdorff}

It suffices to prove $f$ is closed, because this implies that
$f^{-1}$ is continuous. If $T \subset X$ is closed, then $T$
is quasi-compact by Lemma \ref{topology-lemma-closed-in-quasi-compact},
hence $f(T)$ is quasi-compact by Lemma \ref{topology-lemma-image-quasi-compact},
hence $f(T)$ is closed by Lemma \ref{topology-lemma-quasi-compact-in-Hausdorff}.
\end{proof}

\section{Jacobson spaces}
\label{topology-section-space-jacobson}
\begin{definition}[Space jacobson]
\label{topology-definition-space-jacobson}
\source{stacks:005U}
\href{https://stacks.math.columbia.edu/tag/005U}{\texttt{Stacks tag 005U}}
\group{topology}
...
\begin{lemma}[Jacobson check irreducible closed]
\label{topology-lemma-jacobson-check-irreducible-closed}
\source{stacks:005V}
\href{https://stacks.math.columbia.edu/tag/005V}{\texttt{Stacks tag 005V}}
\group{topology}
...
\begin{lemma}[Non jacobson Noetherian characterize]
\label{topology-lemma-non-jacobson-Noetherian-characterize}
\source{stacks:02I7}
\href{https://stacks.math.columbia.edu/tag/02I7}{\texttt{Stacks tag 02I7}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-quasi-compact-closed-point}
...
Lemma \ref{topology-lemma-quasi-compact-closed-point}, there exists a point
$x \in Z \cap U$ closed in $Z \cap U$,
and so $\{x\}$ is locally closed but not closed in $X$.
\end{proof}

\begin{lemma}[Jacobson local]
\label{topology-lemma-jacobson-local}
\source{stacks:005W}
\href{https://stacks.math.columbia.edu/tag/005W}{\texttt{Stacks tag 005W}}
\group{topology}
...
\begin{lemma}[Jacobson inherited]
\label{topology-lemma-jacobson-inherited}
\source{stacks:005X}
\href{https://stacks.math.columbia.edu/tag/005X}{\texttt{Stacks tag 005X}}
\group{topology}
...
\begin{lemma}[Finite jacobson]
\label{topology-lemma-finite-jacobson}
\source{stacks:07JU}
\href{https://stacks.math.columbia.edu/tag/07JU}{\texttt{Stacks tag 07JU}}
\group{topology}
...
\begin{lemma}[For Jacobson spaces, closed points see everything about the topology.]
\label{topology-lemma-jacobson-equivalent-locally-closed}
\source{stacks:005Z}
\href{https://stacks.math.columbia.edu/tag/005Z}{\texttt{Stacks tag 005Z}}
\group{topology}
...
\begin{lemma}[Jacobson equivalent constructible]
\label{topology-lemma-jacobson-equivalent-constructible}
\source{stacks:005Y}
\href{https://stacks.math.columbia.edu/tag/005Y}{\texttt{Stacks tag 005Y}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-jacobson-equivalent-locally-closed, topology-lemma-jacobson-inherited}

From  Lemma \ref{topology-lemma-jacobson-equivalent-locally-closed} above,
...
From  Lemma \ref{topology-lemma-jacobson-inherited} it follows that we may replace
...
\source{stacks:0061}
\href{https://stacks.math.columbia.edu/tag/0061}{\texttt{Stacks tag 0061}}
\group{topology}
...
\begin{lemma}[Open closed specialization]
\label{topology-lemma-open-closed-specialization}
\source{stacks:0062}
\href{https://stacks.math.columbia.edu/tag/0062}{\texttt{Stacks tag 0062}}
\group{topology}
...
\begin{lemma}[Stable specialization]
\label{topology-lemma-stable-specialization}
\source{stacks:0EES}
\href{https://stacks.math.columbia.edu/tag/0EES}{\texttt{Stacks tag 0EES}}
\group{topology}
...
\begin{definition}[Lift specializations]
\label{topology-definition-lift-specializations}
\source{stacks:0063}
\href{https://stacks.math.columbia.edu/tag/0063}{\texttt{Stacks tag 0063}}
\group{topology}
...
\begin{lemma}[Lift specialization composition]
\label{topology-lemma-lift-specialization-composition}
\source{stacks:0064}
\href{https://stacks.math.columbia.edu/tag/0064}{\texttt{Stacks tag 0064}}
\group{topology}
...
\begin{lemma}[Lift specializations images]
\label{topology-lemma-lift-specializations-images}
\source{stacks:0065}
\href{https://stacks.math.columbia.edu/tag/0065}{\texttt{Stacks tag 0065}}
\group{topology}
...
\begin{lemma}[Closed open map specialization]
\label{topology-lemma-closed-open-map-specialization}
\source{stacks:0066}
\href{https://stacks.math.columbia.edu/tag/0066}{\texttt{Stacks tag 0066}}
\group{topology}
...
\begin{lemma}[Quotient kolmogorov]
\label{topology-lemma-quotient-kolmogorov}
\source{stacks:06NA}
\href{https://stacks.math.columbia.edu/tag/06NA}{\texttt{Stacks tag 06NA}}
\group{topology}
...
\begin{lemma}[Dimension specializations lift]
\label{topology-lemma-dimension-specializations-lift}
\source{stacks:02JF}
\href{https://stacks.math.columbia.edu/tag/02JF}{\texttt{Stacks tag 02JF}}
\group{topology}
...
\begin{lemma}[Characterize closed Noetherian]
\label{topology-lemma-characterize-closed-Noetherian}
\source{stacks:0542}
\href{https://stacks.math.columbia.edu/tag/0542}{\texttt{Stacks tag 0542}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-characterize-constructible-Noetherian, topology-lemma-characterize-open-Noetherian}
...
Lemma \ref{topology-lemma-characterize-constructible-Noetherian}.
Thus $E$ is open by
Lemma \ref{topology-lemma-characterize-open-Noetherian}.
...
considered is sober (Definition \ref{topology-definition-generic-point}). Thus the
...
\source{stacks:02I9}
\href{https://stacks.math.columbia.edu/tag/02I9}{\texttt{Stacks tag 02I9}}
\group{topology}
...
\begin{lemma}[Dimension function catenary]
\label{topology-lemma-dimension-function-catenary}
\source{stacks:02IA}
\href{https://stacks.math.columbia.edu/tag/02IA}{\texttt{Stacks tag 02IA}}
\group{topology}
...
\begin{lemma}[Dimension function unique]
\label{topology-lemma-dimension-function-unique}
\source{stacks:02IB}
\href{https://stacks.math.columbia.edu/tag/02IB}{\texttt{Stacks tag 02IB}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-Noetherian, topology-lemma-dimension-function-catenary}
...
$X$ is Noetherian, see Lemma \ref{topology-lemma-Noetherian}.)
...
$$
by Lemma \ref{topology-lemma-dimension-function-catenary}.
Similarly for $\delta'$. Whence the result.
\end{proof}

\begin{lemma}[Locally dimension function]
\label{topology-lemma-locally-dimension-function}
\source{stacks:02IC}
\href{https://stacks.math.columbia.edu/tag/02IC}{\texttt{Stacks tag 02IC}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-catenary, topology-lemma-Noetherian, topology-lemma-dimension-function-unique, topology-lemma-catenary-in-codimension}

We will use repeatedly
that an open subspace of a catenary space is catenary, see
Lemma \ref{topology-lemma-catenary} and that a Noetherian topological space
has finitely many irreducible components, see Lemma \ref{topology-lemma-Noetherian}.
In the proof of Lemma \ref{topology-lemma-dimension-function-unique} we saw how to
...
Then we have (using Lemma \ref{topology-lemma-catenary-in-codimension})
\begin{align*}
\delta(y) & =
- \text{codim}(\overline{\{y\}}, Z_i)
+ \text{codim}(\overline{\{x\}}, Z_i) \\
...
\begin{remark}[Obstruction to dimension function]
\label{topology-remark-obstruction-to-dimension-function}
\source{stacks:02ID}
\href{https://stacks.math.columbia.edu/tag/02ID}{\texttt{Stacks tag 02ID}}
\group{topology}

\uses{topology-lemma-dimension-function-unique, topology-lemma-locally-dimension-function}
Combining Lemmas \ref{topology-lemma-dimension-function-unique} and
\ref{topology-lemma-locally-dimension-function} we see that on a catenary,
...
\source{stacks:03HN}
\href{https://stacks.math.columbia.edu/tag/03HN}{\texttt{Stacks tag 03HN}}
\group{topology}
...
\begin{lemma}[Nowhere dense]
\label{topology-lemma-nowhere-dense}
\source{stacks:03HO}
\href{https://stacks.math.columbia.edu/tag/03HO}{\texttt{Stacks tag 03HO}}
\group{topology}
...
\begin{lemma}[Image nowhere dense open]
\label{topology-lemma-image-nowhere-dense-open}
\source{stacks:03J0}
\href{https://stacks.math.columbia.edu/tag/03J0}{\texttt{Stacks tag 03J0}}
\group{topology}
...
\begin{lemma}[Nowhere dense local]
\label{topology-lemma-nowhere-dense-local}
\source{stacks:03HP}
\href{https://stacks.math.columbia.edu/tag/03HP}{\texttt{Stacks tag 03HP}}
\group{topology}
...
\begin{lemma}[Closed image nowhere dense]
\label{topology-lemma-closed-image-nowhere-dense}
\source{stacks:03HQ}
\href{https://stacks.math.columbia.edu/tag/03HQ}{\texttt{Stacks tag 03HQ}}
\group{topology}
...
\begin{lemma}[Open inverse image closed nowhere dense]
\label{topology-lemma-open-inverse-image-closed-nowhere-dense}
\source{stacks:03HR}
\href{https://stacks.math.columbia.edu/tag/03HR}{\texttt{Stacks tag 03HR}}
\group{topology}
...
\begin{lemma}[Dense in constructible]
\label{topology-lemma-dense-in-constructible}
\group{topology}

Let $X$ be a topological space. Let $E \subset X$ be a finite union
of locally closed subsets (e.g.\ $E$ is constructible). Then $E$
contains a dense open subset of its closure.
\end{lemma}

\begin{proof}
\uses{topology-lemma-nowhere-dense}

After replacing $X$ by the closure of $E$ we may assume that $E$
is dense in $X$ and we have to show that $E$ contains a dense open.
Then the complement $T$ of $E$ is a finite union of locally closed subsets,
say $T = T_1 \cup \ldots \cup T_n$, and $T$ is nowhere dense in $X$.
Since $T_i$ is open dense in its closure $Z_i$ we see that also
$Z_i$ is nowhere dense in $X$. Then the closure $Z = Z_1 \cup \ldots \cup Z_n$
of $T$ is nowhere dense in $X$ by Lemma \ref{topology-lemma-nowhere-dense}.
We conclude that $E$ contains the dense open $X \setminus Z$.
\end{proof}
...
\source{stacks:08ZX}
\href{https://stacks.math.columbia.edu/tag/08ZX}{\texttt{Stacks tag 08ZX}}
\group{topology}
...
\begin{lemma}[Profinite]
\label{topology-lemma-profinite}
\source{stacks:08ZY}
\href{https://stacks.math.columbia.edu/tag/08ZY}{\texttt{Stacks tag 08ZY}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-inverse-limit-quasi-compact, topology-lemma-connected-component-intersection-compact-Hausdorff, topology-lemma-intersection-closed-in-quasi-compact, topology-lemma-bijective-map}
...
that $X$ is quasi-compact by Lemma \ref{topology-lemma-inverse-limit-quasi-compact}.
...
Lemma \ref{topology-lemma-intersection-closed-in-quasi-compact}.
By Lemma \ref{topology-lemma-bijective-map} the map is a homeomorphism.
\end{proof}

\begin{lemma}[Directed inverse limit profinite]
\label{topology-lemma-directed-inverse-limit-profinite}
\source{stacks:0ET8}
\href{https://stacks.math.columbia.edu/tag/0ET8}{\texttt{Stacks tag 0ET8}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-profinite, topology-lemma-limits, topology-lemma-inverse-limit-quasi-compact}
...
Lemma \ref{topology-lemma-profinite}. In particular each $X_i$ is
Hausdorff, quasi-compact, and totally disconnected.
By Lemma \ref{topology-lemma-limits} the limit $X = \lim X_i$ exists.
By Lemma \ref{topology-lemma-inverse-limit-quasi-compact}
...
\begin{lemma}[Profinite refine open covering]
\label{topology-lemma-profinite-refine-open-covering}
\source{stacks:08ZZ}
\href{https://stacks.math.columbia.edu/tag/08ZZ}{\texttt{Stacks tag 08ZZ}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-profinite}

Write $X = \lim X_i$ as a limit of an inverse system of finite discrete
spaces over a directed set $I$ (Lemma \ref{topology-lemma-profinite}).
...
\begin{lemma}[Pi0 profinite]
\label{topology-lemma-pi0-profinite}
\source{stacks:0900}
\href{https://stacks.math.columbia.edu/tag/0900}{\texttt{Stacks tag 0900}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-profinite, topology-lemma-image-quasi-compact, topology-lemma-space-connected-components, topology-lemma-connected-components, topology-lemma-closed-in-quasi-compact, topology-lemma-intersection-closed-in-quasi-compact}

We will use Lemma \ref{topology-lemma-profinite} to prove this.
Since $\pi_0(X)$ is the image of a quasi-compact space it is
quasi-compact (Lemma \ref{topology-lemma-image-quasi-compact}).
It is totally disconnected by construction
(Lemma \ref{topology-lemma-space-connected-components}).
...
(use Lemmas \ref{topology-lemma-connected-components},
\ref{topology-lemma-closed-in-quasi-compact} and
...
\source{stacks:08YG}
\href{https://stacks.math.columbia.edu/tag/08YG}{\texttt{Stacks tag 08YG}}
\group{topology}
...
only if it is quasi-compact (Definition \ref{topology-definition-quasi-compact}).
...
(see Section \ref{topology-section-constructible} for definitions and properties of
constructible sets).
...
\begin{lemma}[Constructible hausdorff quasi compact]
\label{topology-lemma-constructible-hausdorff-quasi-compact}
\source{stacks:0901}
\href{https://stacks.math.columbia.edu/tag/0901}{\texttt{Stacks tag 0901}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-subbase-theorem, topology-lemma-intersection-closed-in-quasi-compact}
...
Lemma \ref{topology-lemma-subbase-theorem}.
...
\begin{lemma}[Fibres spectral map quasi compact]
\label{topology-lemma-fibres-spectral-map-quasi-compact}
\source{stacks:0A2S}
\href{https://stacks.math.columbia.edu/tag/0A2S}{\texttt{Stacks tag 0A2S}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-constructible-hausdorff-quasi-compact, topology-lemma-quasi-compact-in-Hausdorff, topology-lemma-closed-in-quasi-compact, topology-lemma-image-quasi-compact}

Let $X'$ and $Y'$ denote $X$ and $Y$ endowed with the constructible topology
which are quasi-compact Hausdorff spaces by
Lemma \ref{topology-lemma-constructible-hausdorff-quasi-compact}.
...
Hausdorff space $Y'$, see Lemma \ref{topology-lemma-quasi-compact-in-Hausdorff}.
We have a commutative diagram
$$
\begin{array}{cc}X' \longrightarrow\downarrow & X \downarrow \\ Y' \longrightarrow & Y\end{array}
$$
...
that $X_y$ is quasi-compact (Lemma \ref{topology-lemma-image-quasi-compact}).
\end{proof}

\begin{lemma}[Spectral if continuous wrt constructible top]
\label{topology-lemma-spectral-if-continuous-wrt-constructible-top}
\source{stacks:0G1J}
\href{https://stacks.math.columbia.edu/tag/0G1J}{\texttt{Stacks tag 0G1J}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-fibres-spectral-map-quasi-compact, topology-lemma-constructible-hausdorff-quasi-compact, topology-lemma-image-quasi-compact}

The only if part of this is
Lemma \ref{topology-lemma-fibres-spectral-map-quasi-compact}.
...
in the topology of $X$ by Lemma \ref{topology-lemma-image-quasi-compact}.
This finishes the proof.
\end{proof}

\begin{lemma}[Spectral sub]
\label{topology-lemma-spectral-sub}
\source{stacks:0902}
\href{https://stacks.math.columbia.edu/tag/0902}{\texttt{Stacks tag 0902}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-generic-point-in-constructible, topology-lemma-closed-in-quasi-compact, topology-lemma-constructible-hausdorff-quasi-compact}
...
By Lemma \ref{topology-lemma-generic-point-in-constructible} this implies
...
(Lemmas \ref{topology-lemma-closed-in-quasi-compact} and
\ref{topology-lemma-constructible-hausdorff-quasi-compact}). Hence a fortiori it is
...
\begin{lemma}[Constructible stable specialization closed]
\label{topology-lemma-constructible-stable-specialization-closed}
\source{stacks:0903}
\href{https://stacks.math.columbia.edu/tag/0903}{\texttt{Stacks tag 0903}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-constructible-hausdorff-quasi-compact, topology-lemma-intersection-closed-in-quasi-compact, topology-lemma-constructible, topology-lemma-open-closed-specialization}
...
Lemma \ref{topology-lemma-constructible-hausdorff-quasi-compact} and
Lemma \ref{topology-lemma-intersection-closed-in-quasi-compact}.
Since $\{U_i\}$ is a
...
in the constructible topology (Lemma \ref{topology-lemma-constructible})
...
\begin{lemma}[Two points]
\label{topology-lemma-two-points}
\source{stacks:0904}
\href{https://stacks.math.columbia.edu/tag/0904}{\texttt{Stacks tag 0904}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-constructible-hausdorff-quasi-compact, topology-lemma-intersection-closed-in-quasi-compact}
...
\begin{lemma}[Characterize profinite spectral]
\label{topology-lemma-characterize-profinite-spectral}
\source{stacks:0905}
\href{https://stacks.math.columbia.edu/tag/0905}{\texttt{Stacks tag 0905}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-profinite, topology-lemma-constructible-stable-specialization-closed, topology-lemma-quasi-compact-in-Hausdorff}

Lemma \ref{topology-lemma-profinite} shows the implication (1) $\Rightarrow$ (3).
...
(Lemma \ref{topology-lemma-constructible-stable-specialization-closed}), in
...
(Lemma \ref{topology-lemma-quasi-compact-in-Hausdorff}). This implies $X$
is totally disconnected. Hence it is profinite, by
Lemma \ref{topology-lemma-profinite}.
\end{proof}

\begin{lemma}[Spectral pi0]
\label{topology-lemma-spectral-pi0}
\source{stacks:0906}
\href{https://stacks.math.columbia.edu/tag/0906}{\texttt{Stacks tag 0906}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-connected-component-intersection, topology-lemma-pi0-profinite}

Combine Lemmas \ref{topology-lemma-connected-component-intersection} and
\ref{topology-lemma-pi0-profinite}.
\end{proof}

\begin{lemma}[Product spectral spaces]
\label{topology-lemma-product-spectral-spaces}
\source{stacks:0907}
\href{https://stacks.math.columbia.edu/tag/0907}{\texttt{Stacks tag 0907}}
\group{topology}
...
\begin{lemma}[Spectral bijective]
\label{topology-lemma-spectral-bijective}
\source{stacks:09XU}
\href{https://stacks.math.columbia.edu/tag/09XU}{\texttt{Stacks tag 09XU}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-constructible-hausdorff-quasi-compact, topology-lemma-bijective-map, topology-lemma-constructible-stable-specialization-closed}

Since $f$ is spectral it defines a continuous map between $X$ and $Y$ in
the constructible topology. By
Lemmas \ref{topology-lemma-constructible-hausdorff-quasi-compact} and
...
Lemma \ref{topology-lemma-constructible-stable-specialization-closed}.
...
\begin{lemma}[Directed inverse limit finite sober spectral spaces]
\label{topology-lemma-directed-inverse-limit-finite-sober-spectral-spaces}
\source{stacks:09XV}
\href{https://stacks.math.columbia.edu/tag/09XV}{\texttt{Stacks tag 09XV}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-limits, topology-lemma-describe-limits}

Let $I$ be a directed set. Let $X_i$ be an inverse
system of finite sober spaces over $I$. Let $X = \lim X_i$ which exists
by Lemma \ref{topology-lemma-limits}. As a set $X = \lim X_i$. Denote
$p_i : X \to X_i$ the projection.
Because $I$ is directed we may apply Lemma \ref{topology-lemma-describe-limits}.
...
\begin{lemma}[Spectral closed in product two point space]
\label{topology-lemma-spectral-closed-in-product-two-point-space}
\source{stacks:09XW}
\href{https://stacks.math.columbia.edu/tag/09XW}{\texttt{Stacks tag 09XW}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-directed-inverse-limit-finite-sober-spectral-spaces, topology-lemma-spectral-sub, topology-lemma-fibres-spectral-map-quasi-compact, topology-lemma-spectral-bijective}

Write $W = \{0, 1\}$ where $0$ is a specialization of $1$ but not vice versa.
Let $I$ be a set. The space $\prod_{i \in I} W$ is spectral by
Lemma \ref{topology-lemma-directed-inverse-limit-finite-sober-spectral-spaces}.
Thus we see that a subspace of $\prod_{i \in I} W$ closed in the
constructible topology is
a spectral space by Lemma \ref{topology-lemma-spectral-sub}.
...
Lemma \ref{topology-lemma-spectral-bijective}.
\end{proof}

\begin{lemma}[Spectral inverse limit finite sober spaces]
\label{topology-lemma-spectral-inverse-limit-finite-sober-spaces}
\source{stacks:09XX}
\href{https://stacks.math.columbia.edu/tag/09XX}{\texttt{Stacks tag 09XX}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-directed-inverse-limit-finite-sober-spectral-spaces, topology-lemma-spectral-closed-in-product-two-point-space}
...
Lemma \ref{topology-lemma-spectral-closed-in-product-two-point-space}.
We can write
$$
\prod\nolimits_{i \in I} W =
...
\begin{lemma}[Noetherian goes to spectral]
\label{topology-lemma-Noetherian-goes-to-spectral}
\source{stacks:0A2T}
\href{https://stacks.math.columbia.edu/tag/0A2T}{\texttt{Stacks tag 0A2T}}
\group{topology}

\uses{topology-lemma-make-sober}
Let $X$ be a topological space and let $c : X \to X'$ be the universal
map from $X$ to a sober topological space, see
Lemma \ref{topology-lemma-make-sober}.
\begin{enumerate}
...
Lemma \ref{topology-lemma-spectral-inverse-limit-finite-sober-spaces} tells us
...
\begin{lemma}[Inverse limit spectral spaces quasi compact]
\label{topology-lemma-inverse-limit-spectral-spaces-quasi-compact}
\source{stacks:0A2V}
\href{https://stacks.math.columbia.edu/tag/0A2V}{\texttt{Stacks tag 0A2V}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-limits, topology-lemma-constructible-hausdorff-quasi-compact, topology-lemma-closed-in-quasi-compact, topology-lemma-inverse-limit-quasi-compact, topology-lemma-image-quasi-compact}

The limit $Z = \lim Z_i$ exists by Lemma \ref{topology-lemma-limits}.
...
Lemma \ref{topology-lemma-inverse-limit-quasi-compact}.
...
\begin{lemma}[Inverse limit spectral spaces nonempty]
\label{topology-lemma-inverse-limit-spectral-spaces-nonempty}
\source{stacks:0A2W}
\href{https://stacks.math.columbia.edu/tag/0A2W}{\texttt{Stacks tag 0A2W}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-constructible-hausdorff-quasi-compact, topology-lemma-closed-in-quasi-compact, topology-lemma-nonempty-limit}
...
Hausdorff spaces (by
Lemmas \ref{topology-lemma-constructible-hausdorff-quasi-compact} and
\ref{topology-lemma-closed-in-quasi-compact}). By
Lemma \ref{topology-lemma-nonempty-limit} the space $\lim Z'_i$ is nonempty.
Since $\lim Z'_i = \lim Z_i$ as sets we conclude.
\end{proof}

\begin{lemma}[Inverse limit spectral spaces equal]
\label{topology-lemma-inverse-limit-spectral-spaces-equal}
\source{stacks:0A2X}
\href{https://stacks.math.columbia.edu/tag/0A2X}{\texttt{Stacks tag 0A2X}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-inverse-limit-spectral-spaces-nonempty}
...
Lemma \ref{topology-lemma-inverse-limit-spectral-spaces-nonempty}
applies to show that the LHS is nonempty if and only if each of the spaces
of the RHS is nonempty.
\end{proof}

\begin{lemma}[Inverse limit spectral spaces constructible]
\label{topology-lemma-inverse-limit-spectral-spaces-constructible}
\source{stacks:0A2Y}
\href{https://stacks.math.columbia.edu/tag/0A2Y}{\texttt{Stacks tag 0A2Y}}
\group{topology}
...
Lemma \ref{topology-lemma-describe-limits} we can write $E = p_i^{-1}(U_i)$
...
\begin{lemma}[Directed inverse limit spectral spaces]
\label{topology-lemma-directed-inverse-limit-spectral-spaces}
\source{stacks:0A2Z}
\href{https://stacks.math.columbia.edu/tag/0A2Z}{\texttt{Stacks tag 0A2Z}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-limits, topology-lemma-inverse-limit-spectral-spaces-quasi-compact, topology-lemma-describe-limits, topology-lemma-inverse-limit-spectral-spaces-constructible}

The limit $X = \lim X_i$ exists (Lemma \ref{topology-lemma-limits})
and is quasi-compact by
Lemma \ref{topology-lemma-inverse-limit-spectral-spaces-quasi-compact}.

\medskip\noindent
Denote $p_i : X \to X_i$ the projection.
Because $\mathcal{I}$ is cofiltered we can apply
Lemma \ref{topology-lemma-describe-limits}.
...
by Lemma \ref{topology-lemma-inverse-limit-spectral-spaces-quasi-compact}.
...
(see Lemma \ref{topology-lemma-inverse-limit-spectral-spaces-constructible}).
...
\begin{lemma}[Descend opens]
\label{topology-lemma-descend-opens}
\source{stacks:0A30}
\href{https://stacks.math.columbia.edu/tag/0A30}{\texttt{Stacks tag 0A30}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-inverse-limit-spectral-spaces-constructible, topology-lemma-inverse-limit-spectral-spaces-equal}

Part (1) is a special case of
Lemma \ref{topology-lemma-inverse-limit-spectral-spaces-constructible}.
Part (2) is a special case of
Lemma \ref{topology-lemma-inverse-limit-spectral-spaces-equal}
...
\begin{lemma}[Make spectral space]
\label{topology-lemma-make-spectral-space}
\source{stacks:0A31}
\href{https://stacks.math.columbia.edu/tag/0A31}{\texttt{Stacks tag 0A31}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-constructible-hausdorff-quasi-compact, topology-lemma-closed-in-quasi-compact, topology-lemma-directed-inverse-limit-spectral-spaces, topology-lemma-intersection-closed-in-quasi-compact}
...
Lemmas \ref{topology-lemma-constructible-hausdorff-quasi-compact} and
\ref{topology-lemma-closed-in-quasi-compact}), hence quasi-compact in the topology
...
Lemma \ref{topology-lemma-directed-inverse-limit-spectral-spaces}.
...
is quasi-compact (Lemma \ref{topology-lemma-constructible-hausdorff-quasi-compact})
we conclude from
Lemma \ref{topology-lemma-intersection-closed-in-quasi-compact}
that $E_i = \emptyset$ for some $i$.
\end{proof}

\begin{lemma}[Make spectral space minus]
\label{topology-lemma-make-spectral-space-minus}
\source{stacks:0AP0}
\href{https://stacks.math.columbia.edu/tag/0AP0}{\texttt{Stacks tag 0AP0}}
\group{topology}

\uses{topology-lemma-make-spectral-space}
...
Lemma \ref{topology-lemma-make-spectral-space}
(\ref{item-intersection-quasi-compact-open})
then $W \setminus E = \lim (U_i \setminus E)$.
\end{lemma}

\begin{proof}
\uses{topology-lemma-make-spectral-space, topology-lemma-spectral-sub, topology-lemma-directed-inverse-limit-spectral-spaces}

Since $E$ is constructible, it is quasi-compact and hence
Lemma \ref{topology-lemma-make-spectral-space} applies to $W$.
If $E$ is constructible, then $E$ is constructible in $U_i$
for all $i \in I$. Hence $U_i \setminus E$
is spectral by Lemma \ref{topology-lemma-spectral-sub}.
...
\begin{lemma}[Dense image]
\label{topology-lemma-dense-image}
\source{stacks:0909}
\href{https://stacks.math.columbia.edu/tag/0909}{\texttt{Stacks tag 0909}}
\group{topology}
...
Let $X$ be a topological space. By Lemma \ref{topology-lemma-dense-image}, there
is a set $I$
...
is $\beta(X)$ (use Theorem \ref{topology-theorem-tychonov} and
Lemma \ref{topology-lemma-closed-in-quasi-compact}).
...
\begin{lemma}[One point compactification]
\label{topology-lemma-one-point-compactification}
\source{stacks:090A}
\href{https://stacks.math.columbia.edu/tag/090A}{\texttt{Stacks tag 090A}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-quasi-compact-in-Hausdorff, topology-lemma-section-closed}
...
is closed (Lemma \ref{topology-lemma-quasi-compact-in-Hausdorff} part (1)) and
...
(Lemma \ref{topology-lemma-section-closed}).
...
\source{stacks:08YI}
\href{https://stacks.math.columbia.edu/tag/08YI}{\texttt{Stacks tag 08YI}}
\group{topology}
...
Lemma \ref{topology-lemma-profinite}, but the converse does not hold in general.
...
\begin{lemma}[Image open technical]
\label{topology-lemma-image-open-technical}
\source{stacks:08YJ}
\href{https://stacks.math.columbia.edu/tag/08YJ}{\texttt{Stacks tag 08YJ}}
\group{topology}
...
\begin{lemma}[Intersection empty]
\label{topology-lemma-intersection-empty}
\source{stacks:08YK}
\href{https://stacks.math.columbia.edu/tag/08YK}{\texttt{Stacks tag 08YK}}
\group{topology}
...
\begin{lemma}[Isomorphism]
\label{topology-lemma-isomorphism}
\source{stacks:08YL}
\href{https://stacks.math.columbia.edu/tag/08YL}{\texttt{Stacks tag 08YL}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-bijective-map, topology-lemma-closed-map, topology-lemma-image-open-technical, topology-lemma-intersection-empty}

By Lemma \ref{topology-lemma-bijective-map} it suffices to show that $f$ is injective.
Suppose that $x, x' \in X$ are distinct points with $y = f(x) = f(x')$.
Choose disjoint open neighbourhoods $U, U' \subset X$ of $x, x'$.
Observe that $f$ is closed (Lemma \ref{topology-lemma-closed-map}) hence
$T = f(X \setminus U)$ and $T' = f(X \setminus U')$ are closed in $Y$.
Since $X$ is the union of $X \setminus U$ and $X \setminus U'$ we see that
$Y = T \cup T'$. By Lemma \ref{topology-lemma-image-open-technical} we
see that $y$ is contained in the closure of $Y \setminus T$ and
the closure of $Y \setminus T'$. On the other hand, by
Lemma \ref{topology-lemma-intersection-empty},
this intersection is empty. In this way we obtain the desired contradiction.
\end{proof}

\begin{lemma}[Find compact subset]
\label{topology-lemma-find-compact-subset}
\source{stacks:08YM}
\href{https://stacks.math.columbia.edu/tag/08YM}{\texttt{Stacks tag 08YM}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-closed-in-compact, topology-lemma-intersection-closed-in-quasi-compact}

We will use without further mention that the quasi-compact subsets
of $X$ are exactly the closed subsets
(Lemma \ref{topology-lemma-closed-in-compact}).
...
\begin{proposition}[Projective in category hausdorff qc]
\label{topology-proposition-projective-in-category-hausdorff-qc}
\source{stacks:08YN}
\href{https://stacks.math.columbia.edu/tag/08YN}{\texttt{Stacks tag 08YN}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-find-compact-subset, topology-lemma-isomorphism}
...
By Lemma \ref{topology-lemma-find-compact-subset} there exists a quasi-compact subset
$E \subset Y$ such that $f(E) = X$ but $f(E') \not = X$ for all
proper closed subsets $E' \subset E$. By
Lemma \ref{topology-lemma-isomorphism} we find that $f|_E : E \to X$
...
\begin{lemma}[Rainwater]
\label{topology-lemma-rainwater}
\source{stacks:090B}
\href{https://stacks.math.columbia.edu/tag/090B}{\texttt{Stacks tag 090B}}
\group{topology}
...
\begin{example}[Stone Cech discrete]
\label{topology-example-stone-Cech-discrete}
\source{stacks:090C}
\href{https://stacks.math.columbia.edu/tag/090C}{\texttt{Stacks tag 090C}}
\group{topology}

\uses{topology-proposition-projective-in-category-hausdorff-qc, topology-definition-extremally-disconnected, topology-lemma-profinite}
We can use Proposition \ref{topology-proposition-projective-in-category-hausdorff-qc}
...
Definition \ref{topology-definition-extremally-disconnected} and
Lemma \ref{topology-lemma-profinite}).
\end{example}

Using the supply of extremally disconnected spaces given by
Example \ref{topology-example-stone-Cech-discrete}
...
\begin{lemma}[Every quasi-compact Hausdorff space has a canonical extremally disconnected cover]
\label{topology-lemma-existence-projective-cover}
\source{stacks:090D}
\href{https://stacks.math.columbia.edu/tag/090D}{\texttt{Stacks tag 090D}}
\group{topology}
...
\begin{proof}
\uses{topology-example-stone-Cech-discrete, topology-lemma-find-compact-subset, topology-proposition-projective-in-category-hausdorff-qc, topology-lemma-rainwater, topology-lemma-closed-map, topology-lemma-isomorphism}
...
\medskip\noindent
By Lemma \ref{topology-lemma-find-compact-subset} we can find a quasi-compact subset
...
Lemma \ref{topology-lemma-rainwater} shows that $E$ isn't minimal.
...
Observe that $g$ is a closed map (Lemma \ref{topology-lemma-closed-map}).
...
of $X'$. By Lemma \ref{topology-lemma-isomorphism} we see that $g$ is an isomorphism.
\end{proof}

\begin{remark}[Size projective cover]
\label{topology-remark-size-projective-cover}
\source{stacks:090E}
\href{https://stacks.math.columbia.edu/tag/090E}{\texttt{Stacks tag 090E}}
\group{topology}

\uses{topology-lemma-existence-projective-cover, topology-lemma-dense-image}
...
$X' \to X$ (Lemma \ref{topology-lemma-existence-projective-cover})
is at most $2^{2^\kappa}$. Namely, choose a subset $S \subset X'$
mapping bijectively to $X$. By minimality of $X'$ the set $S$ is dense
in $X'$. Thus $|X'| \leq 2^{2^\kappa}$ by Lemma \ref{topology-lemma-dense-image}.
\end{remark}
...
\begin{lemma}[Topology quasi separated scheme]
\label{topology-lemma-topology-quasi-separated-scheme}
\source{stacks:0069}
\href{https://stacks.math.columbia.edu/tag/0069}{\texttt{Stacks tag 0069}}
\group{topology}
...
\source{stacks:06RM}
\href{https://stacks.math.columbia.edu/tag/06RM}{\texttt{Stacks tag 06RM}}
\group{topology}
...
\begin{definition}[Paritition]
\label{topology-definition-paritition}
\source{stacks:09XZ}
\href{https://stacks.math.columbia.edu/tag/09XZ}{\texttt{Stacks tag 09XZ}}
\group{topology}
...
\begin{definition}[Good stratification]
\label{topology-definition-good-stratification}
\source{stacks:09Y0}
\href{https://stacks.math.columbia.edu/tag/09Y0}{\texttt{Stacks tag 09Y0}}
\group{topology}
...
\source{stacks:09Y1}
\href{https://stacks.math.columbia.edu/tag/09Y1}{\texttt{Stacks tag 09Y1}}
\group{topology}
...
\source{stacks:0BDS}
\href{https://stacks.math.columbia.edu/tag/0BDS}{\texttt{Stacks tag 0BDS}}
\group{topology}
...
\begin{remark}[Locally finite stratification]
\label{topology-remark-locally-finite-stratification}
\source{stacks:09Y2}
\href{https://stacks.math.columbia.edu/tag/09Y2}{\texttt{Stacks tag 09Y2}}
\group{topology}
...
\begin{lemma}[Partition refined by stratification]
\label{topology-lemma-partition-refined-by-stratification}
\source{stacks:09Y3}
\href{https://stacks.math.columbia.edu/tag/09Y3}{\texttt{Stacks tag 09Y3}}
\group{topology}
...
\begin{lemma}[Constructible partition refined by stratification]
\label{topology-lemma-constructible-partition-refined-by-stratification}
\source{stacks:09Y4}
\href{https://stacks.math.columbia.edu/tag/09Y4}{\texttt{Stacks tag 09Y4}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-constructible}
...
(Lemma \ref{topology-lemma-constructible}).
...
\begin{lemma}[Noetherian partition refined by stratification]
\label{topology-lemma-noetherian-partition-refined-by-stratification}
\source{stacks:09Y5}
\href{https://stacks.math.columbia.edu/tag/09Y5}{\texttt{Stacks tag 09Y5}}
\group{topology}
...
$Z \cap X_i$ contains an open $U$ of $X$ (Lemma \ref{topology-lemma-Noetherian}).
...
of sets endowed with the quotient topology (Section \ref{topology-section-submersive}).

\begin{lemma}[Colimits]
\label{topology-lemma-colimits}
\source{stacks:0B1X}
\href{https://stacks.math.columbia.edu/tag/0B1X}{\texttt{Stacks tag 0B1X}}
\group{topology}
...
\source{stacks:0B1Z}
\href{https://stacks.math.columbia.edu/tag/0B1Z}{\texttt{Stacks tag 0B1Z}}
\group{topology}
...
\begin{example}[Automorphisms of a set]
\label{topology-example-automorphisms-of-a-set}
\source{stacks:0BMC}
\href{https://stacks.math.columbia.edu/tag/0BMC}{\texttt{Stacks tag 0BMC}}
\group{topology}

\uses{topology-definition-topological-group}
...
Definition \ref{topology-definition-topological-group}.
\end{example}

\begin{lemma}[Topological group limits]
\label{topology-lemma-topological-group-limits}
\source{stacks:0B20}
\href{https://stacks.math.columbia.edu/tag/0B20}{\texttt{Stacks tag 0B20}}
\group{topology}
...
\begin{lemma}[Profinite group]
\label{topology-lemma-profinite-group}
\source{stacks:0BR1}
\href{https://stacks.math.columbia.edu/tag/0BR1}{\texttt{Stacks tag 0BR1}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-profinite, topology-lemma-topological-group-limits, topology-lemma-intersection-closed-in-quasi-compact, topology-lemma-bijective-map}

We have the corresponding result for topological spaces, see
Lemma \ref{topology-lemma-profinite}. Combined with
Lemma \ref{topology-lemma-topological-group-limits}
...
discrete topological spaces (Lemma \ref{topology-lemma-profinite}),
...
\source{stacks:0BR2}
\href{https://stacks.math.columbia.edu/tag/0BR2}{\texttt{Stacks tag 0BR2}}
\group{topology}

\uses{topology-lemma-profinite-group}
A topological group is called a {\it profinite group} if it satisfies
the equivalent conditions of Lemma \ref{topology-lemma-profinite-group}.
\end{definition}

If $G_1 \to G_2 \to G_3 \to \ldots$ is a system of topological groups
then the colimit $G = \colim G_n$ as a topological group
(Lemma \ref{topology-lemma-topological-group-colimits}) is in general different
from the colimit as a topological space (Lemma \ref{topology-lemma-colimits})
even though these have the same underlying set. See
Examples, Section \ref{examples-section-colimit-topology}.

\begin{lemma}[Topological group colimits]
\label{topology-lemma-topological-group-colimits}
\source{stacks:0B21}
\href{https://stacks.math.columbia.edu/tag/0B21}{\texttt{Stacks tag 0B21}}
\group{topology}
...
\source{stacks:0B22}
\href{https://stacks.math.columbia.edu/tag/0B22}{\texttt{Stacks tag 0B22}}
\group{topology}
...
\begin{lemma}[Topological ring limits]
\label{topology-lemma-topological-ring-limits}
\source{stacks:0B23}
\href{https://stacks.math.columbia.edu/tag/0B23}{\texttt{Stacks tag 0B23}}
\group{topology}
...
\begin{lemma}[Topological ring colimits]
\label{topology-lemma-topological-ring-colimits}
\source{stacks:0B24}
\href{https://stacks.math.columbia.edu/tag/0B24}{\texttt{Stacks tag 0B24}}
\group{topology}
...
\begin{proof}
\uses{topology-lemma-topological-group-colimits}

The exact same argument as used in the proof of
Lemma \ref{topology-lemma-topological-group-colimits} shows existence of colimits.
To see the statement on commutation with the forgetful functor to
...
\begin{definition}[Topological module]
\label{topology-definition-topological-module}
\source{stacks:0B25}
\href{https://stacks.math.columbia.edu/tag/0B25}{\texttt{Stacks tag 0B25}}
\group{topology}
...
\begin{lemma}[Topological module limits]
\label{topology-lemma-topological-module-limits}
\source{stacks:0B26}
\href{https://stacks.math.columbia.edu/tag/0B26}{\texttt{Stacks tag 0B26}}
\group{topology}
...
\begin{lemma}[Topological module colimits]
\label{topology-lemma-topological-module-colimits}
\source{stacks:0B27}
\href{https://stacks.math.columbia.edu/tag/0B27}{\texttt{Stacks tag 0B27}}
\group{topology}
