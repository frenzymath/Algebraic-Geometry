...
\begin{enumerate}
\item $\mathcal{O}_{S, s}$ is a G-ring for all $s \in S$\footnote{This
means that $S$ is a G-scheme, see
Properties, Section \ref{properties-section-G-scheme}.},
...
\end{enumerate}
This is Lemma \ref{artin-lemma-diagonal-representable}; see also
...
are algebraic spaces, see Section \ref{artin-section-algebraic-spaces}.
...
finite type $S$-schemes $U$, see Lemma \ref{artin-lemma-approximate}.
...
free, see Lemma \ref{artin-lemma-SGE-implies-openness-versality}.
...
Lemma \ref{artin-lemma-get-openness-obstruction-theory}.
\end{enumerate}
...
done in the literature) in Lemma \ref{artin-lemma-dual-openness}.

\medskip\noindent
In Section \ref{artin-section-algebraic-spaces-noetherian}
...
Section \ref{artin-section-contractions}. The theorem says roughly that given an
...
diagrams
$$
\begin{array}{ccc}x &  & x' \longleftarrow \\  & x_0 \nwarrow\nearrow & \end{array}
$$
...
\begin{lemma}[Predeformation category]
\label{artin-lemma-predeformation-category}
\source{stacks:07T5}
\href{https://stacks.math.columbia.edu/tag/07T5}{\texttt{Stacks tag 07T5}}
\group{artin}
...
\begin{lemma}[Formally smooth on deformation categories]
\label{artin-lemma-formally-smooth-on-deformation-categories}
\source{stacks:07WK}
\href{https://stacks.math.columbia.edu/tag/07WK}{\texttt{Stacks tag 07WK}}
\group{artin}
...
\begin{lemma}[Fibre product deformation categories]
\label{artin-lemma-fibre-product-deformation-categories}
\source{stacks:07WL}
\href{https://stacks.math.columbia.edu/tag/07WL}{\texttt{Stacks tag 07WL}}
\group{artin}

Let $S$ be a locally Noetherian scheme. Let
$$
\begin{array}{cc}\mathcal{W} \downarrow\longrightarrow & \mathcal{Z} \downarrow \\ \mathcal{X} \longrightarrow & \mathcal{Y}\end{array}
$$
...
$$
\begin{array}{cc}\mathcal{F}_{\mathcal{W}, k, w_0} \downarrow\longrightarrow & \mathcal{F}_{\mathcal{Z}, k, z_0} \downarrow \\ \mathcal{F}_{\mathcal{X}, k, x_0} \longrightarrow & \mathcal{F}_{\mathcal{Y}, k, y_0}\end{array}
$$
...
\begin{lemma}[Algebraic stacks satisfy the (strong) Rim-Schlessinger condition]
\label{artin-lemma-pushout}
\source{stacks:07WN}
\href{https://stacks.math.columbia.edu/tag/07WN}{\texttt{Stacks tag 07WN}}
\group{artin}
...
\source{stacks:07WP}
\href{https://stacks.math.columbia.edu/tag/07WP}{\texttt{Stacks tag 07WP}}
\group{artin}
...
$$
\begin{array}{cc}X \longrightarrow\downarrow & X' \downarrow \\ Y \longrightarrow & Y' = Y \amalg_X X'\end{array}
$$
...
\begin{lemma}[Algebraic stack RS]
\label{artin-lemma-algebraic-stack-RS}
\source{stacks:07WQ}
\href{https://stacks.math.columbia.edu/tag/07WQ}{\texttt{Stacks tag 07WQ}}
\group{artin}
...
\begin{proof}
\uses{artin-lemma-pushout}

Immediate from the definitions and Lemma \ref{artin-lemma-pushout}.
\end{proof}

\begin{lemma}[Fibre product RS]
\label{artin-lemma-fibre-product-RS}
\source{stacks:07WR}
\href{https://stacks.math.columbia.edu/tag/07WR}{\texttt{Stacks tag 07WR}}
\group{artin}
...
\begin{proof}
\uses{artin-definition-RS}

This is formal. Let
$$
\begin{array}{cc}X \longrightarrow\downarrow & X' \downarrow \\ Y \longrightarrow & Y' = Y \amalg_X X'\end{array}
$$
be a diagram as in Definition \ref{artin-definition-RS}. We have to show that
$$
...
\begin{lemma}[Deformation category]
\label{artin-lemma-deformation-category}
\source{stacks:07WU}
\href{https://stacks.math.columbia.edu/tag/07WU}{\texttt{Stacks tag 07WU}}
\group{artin}
...
$$
\begin{array}{cc}\mathcal{X}_{Y'} \longrightarrow\downarrow & \mathcal{X}_Y \times_{\mathcal{X}_X} \mathcal{X}_{X'} \downarrow \\ \mathcal{X}_{\Spec(k)} \xlongequal{} & \mathcal{X}_{\Spec(k)}\end{array}
$$
the top horizontal arrow is an equivalence by
Definition \ref{artin-definition-RS}.
Since $\mathcal{F}(B)$ is the category of objects of $\mathcal{X}_{\Spec(B)}$
with an identification with $x_0$ over $k$ we win.
\end{proof}

\begin{remark}[Deformation category implies]
\label{artin-remark-deformation-category-implies}
\source{stacks:07WV}
\href{https://stacks.math.columbia.edu/tag/07WV}{\texttt{Stacks tag 07WV}}
\group{artin}

\uses{artin-lemma-deformation-category}
...
Lemma \ref{artin-lemma-deformation-category}.
\end{remark}
...
\begin{lemma}[Change of field]
\label{artin-lemma-change-of-field}
\source{stacks:07WX}
\href{https://stacks.math.columbia.edu/tag/07WX}{\texttt{Stacks tag 07WX}}
\group{artin}
...
$$
\vcenter{
\begin{array}{cc}l & B \longleftarrow \\ k \uparrow & B \times_l k \longleftarrow\uparrow\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}\Spec(l) \downarrow\longrightarrow & \Spec(B) \downarrow \\ \Spec(k) \longrightarrow & \Spec(B \times_l k)\end{array}
}
$$
...
Definition \ref{artin-definition-RS}). Hence (RS) kicks in to give an equivalence
of fibre categories
$$
...
(assumptions hold by Lemma \ref{artin-lemma-deformation-category} and
Remark \ref{artin-remark-deformation-category-implies}). Moreover,
...
\begin{lemma}[Finite dimension]
\label{artin-lemma-finite-dimension}
\source{stacks:07X1}
\href{https://stacks.math.columbia.edu/tag/07X1}{\texttt{Stacks tag 07X1}}
\group{artin}
...
\begin{proof}
\uses{artin-lemma-change-of-field, artin-lemma-algebraic-stack-RS, artin-lemma-deformation-category, artin-remark-deformation-category-implies, artin-lemma-fibre-product-deformation-categories, artin-lemma-formally-smooth-on-deformation-categories}
...
\mathcal{F}_{\mathcal{X}, l, x_{l, 0}}
$$
by Lemma \ref{artin-lemma-change-of-field} and the fact that $\mathcal{X}$
...
Lemmas \ref{artin-lemma-algebraic-stack-RS} and
\ref{artin-lemma-deformation-category} and
Remark \ref{artin-remark-deformation-category-implies}).
...
$\mathcal{R}$. Combining
Lemma \ref{artin-lemma-fibre-product-deformation-categories} and
Formal Deformation Theory, Lemma
...
\mathcal{F}_{\mathcal{X}, l, x_{l, 0}}
$$
is smooth by Lemma \ref{artin-lemma-formally-smooth-on-deformation-categories}.
...
\begin{lemma}[Fibre product tangent spaces]
\label{artin-lemma-fibre-product-tangent-spaces}
\source{stacks:07X2}
\href{https://stacks.math.columbia.edu/tag/07X2}{\texttt{Stacks tag 07X2}}
\group{artin}
...
$$
\begin{array}{cccc}0 \longrightarrow & \text{Inf}(\mathcal{F}_{\mathcal{W}, k, w_0}) \longrightarrow & \text{Inf}(\mathcal{F}_{\mathcal{X}, k, x_0}) \oplus
\text{Inf}(\mathcal{F}_{\mathcal{Z}, k, z_0}) \longrightarrow & \text{Inf}(\mathcal{F}_{\mathcal{Y}, k, y_0}) \swarrow \\  & T\mathcal{F}_{\mathcal{W}, k, w_0} \longrightarrow & T\mathcal{F}_{\mathcal{X}, k, x_0} \oplus
T\mathcal{F}_{\mathcal{Z}, k, z_0} \longrightarrow & T\mathcal{F}_{\mathcal{Y}, k, y_0}\end{array}
$$
of $k$-vector spaces.
\end{lemma}

\begin{proof}
\uses{artin-lemma-fibre-product-RS, artin-lemma-fibre-product-deformation-categories, artin-lemma-deformation-category}

By Lemma \ref{artin-lemma-fibre-product-RS} we see that $\mathcal{W}$
satisfies (RS) and hence the lemma makes sense. To see the lemma
is true, apply Lemmas \ref{artin-lemma-fibre-product-deformation-categories} and
...
\source{stacks:07X4}
\href{https://stacks.math.columbia.edu/tag/07X4}{\texttt{Stacks tag 07X4}}
\group{artin}
...
the diagram
$$
\begin{array}{cc}\xi_n \underset{f_n}{\longrightarrow}\underset{a_n}{\downarrow} & \xi_{n + 1} \overset{a_{n + 1}}{\downarrow} \\ \eta_n \overset{g_n}{\longrightarrow} & \eta_{n + 1}\end{array}
$$
...
\begin{remark}[Formal objects match]
\label{artin-remark-formal-objects-match}
\source{stacks:0CXH}
\href{https://stacks.math.columbia.edu/tag/0CXH}{\texttt{Stacks tag 0CXH}}
\group{artin}

\uses{artin-definition-formal-objects}
Let $S$ be a locally Noetherian scheme. Let
$p : \mathcal{X} \to (\Sch/S)_{fppf}$ be a category fibred in groupoids.
...
Definition \ref{artin-definition-formal-objects} above,
Formal Deformation Theory, Definition
...
\begin{lemma}[Smooth lift formal]
\label{artin-lemma-smooth-lift-formal}
\source{stacks:07X5}
\href{https://stacks.math.columbia.edu/tag/07X5}{\texttt{Stacks tag 07X5}}
\group{artin}
...
Definition \ref{artin-definition-formal-objects}.

\begin{definition}[Effective]
\label{artin-definition-effective}
\source{stacks:07X7}
\href{https://stacks.math.columbia.edu/tag/07X7}{\texttt{Stacks tag 07X7}}
\group{artin}
...
\begin{lemma}[Effective]
\label{artin-lemma-effective}
\source{stacks:07X8}
\href{https://stacks.math.columbia.edu/tag/07X8}{\texttt{Stacks tag 07X8}}
\group{artin}
...
$$
\begin{array}{cc}V_{n + 1} \downarrow & V_n \downarrow\longleftarrow \\ \Spec(R/\mathfrak m^{n + 1}) & \Spec(R/\mathfrak m^n) \longleftarrow\end{array}
$$
...
$$
\begin{array}{cc}\Spec(R'/(\mathfrak m')^{n + 1}) \underset{v'_{n + 1}}{\downarrow} & \Spec(R'/(\mathfrak m')^n) \overset{v'_n}{\downarrow}\longleftarrow \\ V_{n + 1} & V_n \longleftarrow\end{array}
$$
...
\begin{lemma}[Fibre product effective]
\label{artin-lemma-fibre-product-effective}
\source{stacks:07X9}
\href{https://stacks.math.columbia.edu/tag/07X9}{\texttt{Stacks tag 07X9}}
\group{artin}
...
\source{stacks:07XB}
\href{https://stacks.math.columbia.edu/tag/07XB}{\texttt{Stacks tag 07XB}}
\group{artin}
...
\begin{definition}[Limit preserving]
\label{artin-definition-limit-preserving}
\source{stacks:07XL}
\href{https://stacks.math.columbia.edu/tag/07XL}{\texttt{Stacks tag 07XL}}
\group{artin}
...
\begin{lemma}[Fibre product limit preserving]
\label{artin-lemma-fibre-product-limit-preserving}
\source{stacks:07XM}
\href{https://stacks.math.columbia.edu/tag/07XM}{\texttt{Stacks tag 07XM}}
\group{artin}
...
\begin{lemma}[Limit preserving algebraic space]
\label{artin-lemma-limit-preserving-algebraic-space}
\source{stacks:07XN}
\href{https://stacks.math.columbia.edu/tag/07XN}{\texttt{Stacks tag 07XN}}
\group{artin}
...
\source{stacks:0CXI}
\href{https://stacks.math.columbia.edu/tag/0CXI}{\texttt{Stacks tag 0CXI}}
\group{artin}
...
\begin{proof}
\uses{artin-lemma-fibre-product-limit-preserving, artin-lemma-limit-preserving-algebraic-space}
...
Lemmas \ref{artin-lemma-fibre-product-limit-preserving} and
...
\begin{definition}[Versal formal object]
\label{artin-definition-versal-formal-object}
\source{stacks:0CXJ}
\href{https://stacks.math.columbia.edu/tag/0CXJ}{\texttt{Stacks tag 0CXJ}}
\group{artin}

\uses{artin-remark-formal-objects-match}
Let $S$ be a locally Noetherian scheme. Let
$p : \mathcal{X} \to (\Sch/S)_{fppf}$ be a category fibred in groupoids.
Let $\xi = (R, \xi_n, f_n)$ be a formal object. Set $k = R/\mathfrak m$ and
$x_0 = \xi_1$. We will say that $\xi$ is {\it versal} if $\xi$
as a formal object of $\mathcal{F}_{\mathcal{X}, k, x_0}$
(Remark \ref{artin-remark-formal-objects-match}) is versal in the sense
...
$$
\vcenter{
\begin{array}{cc} & y \swarrow \\ \xi_n & \xi_1 \uparrow\longleftarrow\end{array}
}
\quad\text{lying over}\quad
\vcenter{
\begin{array}{cc} & \Spec(A) \swarrow \\ \Spec(R/\mathfrak m^n) & \Spec(k) \uparrow\longleftarrow\end{array}
}
$$
...
$$
\vcenter{
\begin{array}{ccc} &  & z \swarrow \\  &  & y \swarrow\uparrow \\ \xi_m & \xi_n \longleftarrow & \xi_1 \uparrow\longleftarrow\end{array}
}
\quad\text{lying over}
\vcenter{
\begin{array}{ccc} &  & \Spec(B) \swarrow \\  &  & \Spec(A) \swarrow\uparrow \\ \Spec(R/\mathfrak m^m) & \Spec(R/\mathfrak m^n) \longleftarrow & \Spec(k) \uparrow\longleftarrow\end{array}
}
$$
...
\source{stacks:07XF}
\href{https://stacks.math.columbia.edu/tag/07XF}{\texttt{Stacks tag 07XF}}
\group{artin}
...
\begin{lemma}[Versality matches]
\label{artin-lemma-versality-matches}
\source{stacks:0CXK}
\href{https://stacks.math.columbia.edu/tag/0CXK}{\texttt{Stacks tag 0CXK}}
\group{artin}

\uses{artin-definition-versal}
With notation as in Definition \ref{artin-definition-versal}.
...
\begin{lemma}[Versal implies smooth]
\label{artin-lemma-versal-implies-smooth}
\source{stacks:0CXL}
\href{https://stacks.math.columbia.edu/tag/0CXL}{\texttt{Stacks tag 0CXL}}
\group{artin}
...
\begin{lemma}[Versal change of field]
\label{artin-lemma-versal-change-of-field}
\source{stacks:07XG}
\href{https://stacks.math.columbia.edu/tag/07XG}{\texttt{Stacks tag 07XG}}
\group{artin}

\uses{artin-definition-versal}
Let $S$, $\mathcal{X}$, $U$, $x$, $u_0$ be as in
Definition \ref{artin-definition-versal}. Let $l$ be a field and let
...
\begin{proof}
\uses{artin-lemma-algebraic-stack-RS, artin-lemma-change-of-field}

Note that $(\Sch/U)_{fppf}$ satisfies (RS) by
Lemma \ref{artin-lemma-algebraic-stack-RS}.
...
(\mathcal{F}_{\mathcal{X}, k , x_0})_{l/k}
$$
associated to $\hat x$, see Lemma \ref{artin-lemma-change-of-field}.
...
Definition \ref{artin-definition-versal},
then $x$ viewed as a morphism from $U$ to $\mathcal{X}$ is
smooth whenever we make a base change by a scheme.

\begin{lemma}[Base change versal]
\label{artin-lemma-base-change-versal}
\source{stacks:0CXM}
\href{https://stacks.math.columbia.edu/tag/0CXM}{\texttt{Stacks tag 0CXM}}
\group{artin}

\uses{artin-definition-versal}
Let $S$, $\mathcal{X}$, $U$, $x$, $u_0$ be as in
Definition \ref{artin-definition-versal}. Assume
\begin{enumerate}
\item $\Delta : \mathcal{X} \to \mathcal{X} \times \mathcal{X}$
is representable by algebraic spaces,
...
$$
\begin{array}{cc}\mathcal{Z} \longrightarrow\downarrow & (\Sch/U)_{fppf} \overset{x}{\downarrow} \\ (\Sch/V)_{fppf} \overset{y}{\longrightarrow} & \mathcal{X}\end{array}
$$
...
\begin{proof}
\uses{artin-lemma-diagonal, artin-lemma-fibre-product-deformation-categories, artin-lemma-versal-change-of-field, artin-lemma-formally-smooth-on-deformation-categories}

(The parenthetical remark in the statement holds by
Lemma \ref{artin-lemma-diagonal}.)
...
Consider
$$
\begin{array}{ccc}\mathcal{F}_{(\Sch/W)_{fppf}, l, w_0} \longrightarrow & \mathcal{F}_{\mathcal{Z}, l, z_{l, 0}} \downarrow\longrightarrow & \mathcal{F}_{(\Sch/U)_{fppf}, l, u_{l, 0}} \downarrow \\  & \mathcal{F}_{(\Sch/V)_{fppf}, l, v_{l, 0}} \longrightarrow & \mathcal{F}_{\mathcal{X}, l, x_{l, 0}}\end{array}
$$
By Lemma \ref{artin-lemma-fibre-product-deformation-categories}
the square is a fibre product of predeformation categories.
By Lemma \ref{artin-lemma-versal-change-of-field}
...
By Lemma \ref{artin-lemma-formally-smooth-on-deformation-categories}
...
\begin{lemma}[Approximate versal]
\label{artin-lemma-approximate-versal}
\source{stacks:07XH}
\href{https://stacks.math.columbia.edu/tag/07XH}{\texttt{Stacks tag 07XH}}
\group{artin}
...
\begin{proof}
\uses{artin-lemma-approximate, artin-lemma-versality-matches}

Choose an object $x_R$ of $\mathcal{X}$ lying over $\Spec(R)$ whose associated
formal object is $\xi$. Let $N = 2$ and apply Lemma \ref{artin-lemma-approximate}.
...
$$
\vcenter{
\begin{array}{cc} & \eta \downarrow \\ \xi \longrightarrow\nearrow & \xi_2 = \eta_2\end{array}
}
\quad\text{lying over}\quad
\vcenter{
\begin{array}{cc} & A^\wedge \downarrow \\ R \longrightarrow\nearrow & R/\mathfrak m_R^2 = A/\mathfrak m_A^2\end{array}
}
$$
...
Lemma \ref{artin-lemma-versality-matches}
we conclude that $x_A$ is versal at the point $u_0$ of
$U = \Spec(A)$ corresponding to $\mathfrak m_A$.
\end{proof}

\begin{example}[Approximate versal implies]
\label{artin-example-approximate-versal-implies}
\source{stacks:07XI}
\href{https://stacks.math.columbia.edu/tag/07XI}{\texttt{Stacks tag 07XI}}
\group{artin}

\uses{artin-lemma-approximate-versal}
In this example we show that the local ring $\mathcal{O}_{S, s}$ has to be
a G-ring in order for the result of Lemma \ref{artin-lemma-approximate-versal} to
...
Hence if the conclusion of Lemma \ref{artin-lemma-approximate-versal} holds
...
Lemma \ref{artin-lemma-approximate-versal} holds for every $\mathcal{X}$ as
...
\begin{definition}[Openness versality]
\label{artin-definition-openness-versality}
\source{stacks:07XQ}
\href{https://stacks.math.columbia.edu/tag/07XQ}{\texttt{Stacks tag 07XQ}}
\group{artin}
...
\begin{example}[Versality]
\label{artin-example-versality}
\source{stacks:07XR}
\href{https://stacks.math.columbia.edu/tag/07XR}{\texttt{Stacks tag 07XR}}
\group{artin}
...
\begin{lemma}[Versal smooth]
\label{artin-lemma-versal-smooth}
\source{stacks:07XT}
\href{https://stacks.math.columbia.edu/tag/07XT}{\texttt{Stacks tag 07XT}}
\group{artin}
...
\begin{proof}
\uses{artin-lemma-versal-change-of-field}
...
\mathcal{F}_{\mathcal{X}, l, x_{l, 0}}$
is smooth by Lemma \ref{artin-lemma-versal-change-of-field}.
\end{proof}

\begin{lemma}[Composition smooth]
\label{artin-lemma-composition-smooth}
\source{stacks:07XU}
\href{https://stacks.math.columbia.edu/tag/07XU}{\texttt{Stacks tag 07XU}}
\group{artin}
...
\source{stacks:07XV}
\href{https://stacks.math.columbia.edu/tag/07XV}{\texttt{Stacks tag 07XV}}
\group{artin}
...
\begin{proof}
\uses{artin-lemma-fibre-product-deformation-categories}

Follows immediately from
Lemma \ref{artin-lemma-fibre-product-deformation-categories}
and
Formal Deformation Theory, Lemma
\ref{formal-defos-lemma-smooth-properties}.
\end{proof}

\begin{lemma}[Smooth smooth]
\label{artin-lemma-smooth-smooth}
\source{stacks:07XW}
\href{https://stacks.math.columbia.edu/tag/07XW}{\texttt{Stacks tag 07XW}}
\group{artin}
...
\begin{proof}
\uses{artin-lemma-formally-smooth-on-deformation-categories}

A reformulation of Lemma \ref{artin-lemma-formally-smooth-on-deformation-categories}.
\end{proof}

\begin{lemma}[Implies smooth]
\label{artin-lemma-implies-smooth}
\source{stacks:07XX}
\href{https://stacks.math.columbia.edu/tag/07XX}{\texttt{Stacks tag 07XX}}
\group{artin}
...
\begin{proof}
\uses{artin-lemma-limit-preserving-algebraic-space, artin-lemma-fibre-product-limit-preserving, artin-lemma-base-change-smooth, artin-lemma-smooth-smooth, artin-lemma-composition-smooth}
...
Lemma \ref{artin-lemma-limit-preserving-algebraic-space}.
...
$\mathcal{Z} \to (\Sch/V)_{fppf}$, see Lemma \ref{artin-lemma-base-change-smooth}.
Next, we see that $(\Sch/W)_{fppf} \to \mathcal{Z}$ satisfies
(\ref{equation-smooth}) by Lemma \ref{artin-lemma-smooth-smooth}.
Thus the composition
$$
(\Sch/W)_{fppf} \to \mathcal{Z} \to (\Sch/V)_{fppf}
$$
satisfies (\ref{equation-smooth}) by Lemma \ref{artin-lemma-composition-smooth}.
More on Morphisms, Lemma
\ref{more-morphisms-lemma-lifting-along-artinian-at-point}
...
\begin{lemma}[Get smooth]
\label{artin-lemma-get-smooth}
\source{stacks:07XY}
\href{https://stacks.math.columbia.edu/tag/07XY}{\texttt{Stacks tag 07XY}}
\group{artin}
...
\begin{proof}
\uses{artin-lemma-deformation-category, artin-remark-deformation-category-implies, artin-lemma-approximate-versal, artin-lemma-versal-smooth, artin-lemma-implies-smooth}

By axiom [2], Lemma \ref{artin-lemma-deformation-category}, and
Remark \ref{artin-remark-deformation-category-implies}
...
Lemma \ref{artin-lemma-approximate-versal}
...
x : (\Sch/U)_{fppf} \longrightarrow \mathcal{X}
$$
is smooth which proves the lemma. Namely, by Lemma \ref{artin-lemma-versal-smooth}
$x$ satisfies (\ref{equation-smooth})
whereupon Lemma \ref{artin-lemma-implies-smooth}
finishes the proof.
\end{proof}
...
Lemma \ref{artin-lemma-formally-smooth-on-deformation-categories} tells us that if
...
\medskip\noindent
Lemma \ref{artin-lemma-pushout} says that if $Y' = Y \amalg_X X'$ in the
...
\medskip\noindent
Lemma \ref{artin-lemma-deformation-category} says that
...
\medskip\noindent
Lemma \ref{artin-lemma-finite-dimension} says that an algebraic space $F$
...
Lemma \ref{artin-lemma-effective} says that if $F$ is an algebraic space,
...
\begin{proposition}[Spaces diagonal representable]
\label{artin-proposition-spaces-diagonal-representable}
\source{stacks:07Y1}
\href{https://stacks.math.columbia.edu/tag/07Y1}{\texttt{Stacks tag 07Y1}}
\group{artin}
...
(see Section \ref{artin-section-axioms-functors}), and
...
\begin{proof}
\uses{artin-lemma-get-smooth}

Lemma \ref{artin-lemma-get-smooth} applies to $F$. Using this we
...
\source{stacks:07Y2}
\href{https://stacks.math.columbia.edu/tag/07Y2}{\texttt{Stacks tag 07Y2}}
\group{artin}
...
\begin{proof}
\uses{artin-lemma-finite-dimension, artin-proposition-spaces-diagonal-representable}

By Lemma \ref{artin-lemma-finite-dimension} the functor $G$ satisfies [3].
...
Thus Proposition \ref{artin-proposition-spaces-diagonal-representable}
...
Proposition \ref{artin-proposition-second-diagonal-representable} is our first
main result on algebraic stacks.

\begin{lemma}[Diagonal representable]
\label{artin-lemma-diagonal-representable}
\source{stacks:07Y4}
\href{https://stacks.math.columbia.edu/tag/07Y4}{\texttt{Stacks tag 07Y4}}
\group{artin}
...
Lemma \ref{artin-lemma-get-smooth} applies to $\mathcal{X}$. Using this we
...
\begin{proposition}[Second diagonal representable]
\label{artin-proposition-second-diagonal-representable}
\source{stacks:07Y5}
\href{https://stacks.math.columbia.edu/tag/07Y5}{\texttt{Stacks tag 07Y5}}
\group{artin}
...
(see Section \ref{artin-section-axioms}),
\item $\mathcal{O}_{S, s}$ is a G-ring for all finite type points $s$ of $S$.
\end{enumerate}
Then $\mathcal{X}$ is an algebraic stack.
\end{proposition}
...
\begin{proof}
\uses{artin-proposition-spaces-diagonal-representable, artin-lemma-fibre-product-limit-preserving, artin-lemma-algebraic-stack-RS, artin-lemma-fibre-product-RS, artin-lemma-finite-dimension, artin-lemma-fibre-product-tangent-spaces, artin-lemma-effective, artin-lemma-fibre-product-effective, artin-lemma-diagonal-representable}
...
Lemma \ref{artin-lemma-fibre-product-limit-preserving}, i.e., we have [1].
Note that $Y$ has (RS), i.e., axiom [2] holds, by
Lemmas \ref{artin-lemma-algebraic-stack-RS} and
\ref{artin-lemma-fibre-product-RS}. Axiom [3] for $Y$ follows
from Lemmas \ref{artin-lemma-finite-dimension} and
\ref{artin-lemma-fibre-product-tangent-spaces}.
Axiom [4] follows from Lemmas \ref{artin-lemma-effective} and
...
\medskip\noindent
At this point it follows from Lemma \ref{artin-lemma-diagonal-representable}
that $\mathcal{X}$ is an algebraic stack.
\end{proof}
...
\begin{definition}[RS star]
\label{artin-definition-RS-star}
\source{stacks:07Y8}
\href{https://stacks.math.columbia.edu/tag/07Y8}{\texttt{Stacks tag 07Y8}}
\group{artin}
...
$$
\begin{array}{cc}B' \longrightarrow & B \\ A' = A \times_B B' \uparrow\longrightarrow & A \uparrow\end{array}
$$
...
with $A \to B \leftarrow B'$ as in Definition \ref{artin-definition-RS-star}
\begin{enumerate}
...
(RS*) by Lemma \ref{artin-lemma-algebraic-stack-RS-star}.
\end{enumerate}
...
\begin{lemma}[Algebraic stack RS star]
\label{artin-lemma-algebraic-stack-RS-star}
\source{stacks:0CXP}
\href{https://stacks.math.columbia.edu/tag/0CXP}{\texttt{Stacks tag 0CXP}}
\group{artin}
...
\begin{proof}
\uses{artin-lemma-pushout, artin-definition-RS-star}

This is implied by Lemma \ref{artin-lemma-pushout}, see
remarks following Definition \ref{artin-definition-RS-star}.
\end{proof}

\begin{lemma}[Fibre product RS star]
\label{artin-lemma-fibre-product-RS-star}
\source{stacks:0CXQ}
\href{https://stacks.math.columbia.edu/tag/0CXQ}{\texttt{Stacks tag 0CXQ}}
\group{artin}
...
\begin{proof}
\uses{artin-lemma-fibre-product-RS}

The proof is exactly the same as the proof of
Lemma \ref{artin-lemma-fibre-product-RS}.
\end{proof}
...
\begin{lemma}[Single point]
\label{artin-lemma-single-point}
\source{stacks:0G2J}
\href{https://stacks.math.columbia.edu/tag/0G2J}{\texttt{Stacks tag 0G2J}}
\group{artin}
...
\begin{proof}
\uses{artin-lemma-versality-matches, artin-definition-versal-formal-object}
...
Lemma \ref{artin-lemma-versality-matches}. By the discussion following
Definition \ref{artin-definition-versal-formal-object}
...
$$
\vcenter{
\begin{array}{cc} & x_A \swarrow \\ \xi_n & \xi_1 \uparrow\longleftarrow\end{array}
}
\quad\text{lying over}\quad
\vcenter{
\begin{array}{cc} & \Spec(A) \swarrow \\ \Spec(R/\mathfrak m^n) & \Spec(k) \uparrow\longleftarrow\end{array}
...
$$
\vcenter{
\begin{array}{ccc} &  & x_B \swarrow \\  &  & x_A \swarrow\uparrow \\ \xi_m & \xi_n \longleftarrow & \xi_1 \uparrow\longleftarrow\end{array}
}
\quad\text{lying over}
\vcenter{
\begin{array}{ccc} &  & \Spec(B) \swarrow \\  &  & \Spec(A) \swarrow\uparrow \\ \Spec(R/\mathfrak m^m) & \Spec(R/\mathfrak m^n) \longleftarrow & \Spec(k) \uparrow\longleftarrow\end{array}
...
$$
\begin{array}{ccccc}0 \longrightarrow & I \longrightarrow & B \longrightarrow & A \longrightarrow & 0 \\ 0 \longrightarrow & I \longrightarrow\uparrow & \Gamma(T, \mathcal{O}_T) \longrightarrow\uparrow & \Gamma(U, \mathcal{O}_U) \longrightarrow\uparrow & 0\end{array}
$$
...
$$
\begin{array}{cc}x_B \downarrow & x_A \downarrow\longleftarrow \\ \xi_m & \xi_n \longleftarrow\end{array}
$$
is commutative. This gives the contradiction we were looking for.
\end{proof}

\begin{lemma}[Generalization versality]
\label{artin-lemma-generalization-versality}
\source{stacks:0G2K}
\href{https://stacks.math.columbia.edu/tag/0G2K}{\texttt{Stacks tag 0G2K}}
\group{artin}
...
\begin{proof}
\uses{artin-lemma-single-point, artin-lemma-base-change-versal}
...
Lemma \ref{artin-lemma-single-point}. Write $U = \Spec(R_0)$ and $T = \Spec(R)$.
...
$$
\begin{array}{ccc}U \searrow\searrow\searrow &  &  \\  & Z \underset{p'}{\longrightarrow}\overset{p}{\downarrow} & U' \downarrow \\  & U \longrightarrow & S\end{array}
$$
The morphism $i : U \to Z$ comes the isomorphism $x \to x'|_U$.
Let $z_0 = i(u_0) \in Z$. By Lemma \ref{artin-lemma-base-change-versal}
...
$u$ is in this open. Condition (3) of Lemma \ref{artin-lemma-single-point}
...
(3) of Lemma \ref{artin-lemma-single-point}.
...
discussed in Remark \ref{artin-remark-strong-effectiveness}. In addition, the
...
\begin{lemma}[Infinite sequence pre]
\label{artin-lemma-infinite-sequence-pre}
\source{stacks:0G2S}
\href{https://stacks.math.columbia.edu/tag/0G2S}{\texttt{Stacks tag 0G2S}}
\group{artin}
...
By Lemma \ref{artin-lemma-single-point} for each $n \geq 1$ we can find
$$
x \to y_n
\quad\text{in }\mathcal{X}\text{ lying over}\quad
U \to T_n
...
\source{stacks:0CXT}
\href{https://stacks.math.columbia.edu/tag/0CXT}{\texttt{Stacks tag 0CXT}}
\group{artin}
...
every system $(\xi_n)$ as in Remark \ref{artin-remark-strong-effectiveness}
is effective. An example is given in
Examples, Section \ref{examples-section-non-formal-effectiveness}.

\begin{lemma}[SGE implies openness versality]
\label{artin-lemma-SGE-implies-openness-versality}
\source{stacks:0CXU}
\href{https://stacks.math.columbia.edu/tag/0CXU}{\texttt{Stacks tag 0CXU}}
\group{artin}

\uses{artin-remark-strong-effectiveness}
Let $S$ be a locally Noetherian scheme. Let $\mathcal{X}$ be a category fibred
in groupoids over $(\Sch/S)_{fppf}$. Assume
\begin{enumerate}
\item $\Delta : \mathcal{X} \to \mathcal{X} \times \mathcal{X}$ is
...
\item $\mathcal{X}$ has (RS*),
\item $\mathcal{X}$ is limit preserving,
\item systems $(\xi_n)$ as in Remark \ref{artin-remark-strong-effectiveness}
...
\begin{proof}
\uses{artin-lemma-generalization-versality, artin-lemma-infinite-sequence-pre, artin-lemma-base-change-versal}
...
Lemma \ref{artin-lemma-generalization-versality}
...
$U \to U_1 \to U_2 \to \ldots$ as in Lemma \ref{artin-lemma-infinite-sequence-pre}.
...
(3) of Lemma \ref{artin-lemma-infinite-sequence-pre}
...
\begin{remark}[Trade openness versality diagonal with strong effectiveness]
\label{artin-remark-trade-openness-versality-diagonal-with-strong-effectiveness}
\source{stacks:0CXV}
\href{https://stacks.math.columbia.edu/tag/0CXV}{\texttt{Stacks tag 0CXV}}
\group{artin}

\uses{artin-remark-strong-effectiveness, artin-lemma-SGE-implies-openness-versality}
...
as in Remark \ref{artin-remark-strong-effectiveness}
where $\Ker(R_m \to R_n)$ is an ideal of square zero for all $m \geq n$
the functor
$$
...
Lemma \ref{artin-lemma-SGE-implies-openness-versality}
...
tangent space introduced in Section \ref{artin-section-tangent-spaces}.
...
\source{stacks:07Y7}
\href{https://stacks.math.columbia.edu/tag/07Y7}{\texttt{Stacks tag 07Y7}}
\group{artin}
...
\begin{lemma}[Properties lift RS star]
\label{artin-lemma-properties-lift-RS-star}
\source{stacks:07Y9}
\href{https://stacks.math.columbia.edu/tag/07Y9}{\texttt{Stacks tag 07Y9}}
\group{artin}
...
\underset{(a_1, a_2, a_3) \mapsto (g(a_1, a_2), g(a_2, a_3))}{\longrightarrow}\underset{(a_1, a_2, a_3) \mapsto g(a_1, a_3)}{\searrow} &  &  &  &  & A[I] \times_A A[I] = A[I \times I] \overset{+}{\downarrow} \\  &  &  &  &  & A[I]\end{array}
$$
...
\source{stacks:07YA}
\href{https://stacks.math.columbia.edu/tag/07YA}{\texttt{Stacks tag 07YA}}
\group{artin}

\uses{artin-lemma-properties-lift-RS-star}
Assumptions and notation as in Lemma \ref{artin-lemma-properties-lift-RS-star}.
...
$$
\vcenter{
\begin{array}{cc}\text{Inf}_y(J) \longrightarrow & \text{Inf}(y'/y) \\ \text{Inf}_x(I) \longrightarrow\uparrow & \text{Inf}(x'/x) \uparrow\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}T_y(J) \times \text{Lift}(y, B') \longrightarrow & \text{Lift}(y, B') \\ T_x(I) \times \text{Lift}(x, A') \longrightarrow\uparrow & \text{Lift}(x, A') \uparrow\end{array}
}
$$
...
\source{stacks:07YB}
\href{https://stacks.math.columbia.edu/tag/07YB}{\texttt{Stacks tag 07YB}}
\group{artin}
...
\source{stacks:07YE}
\href{https://stacks.math.columbia.edu/tag/07YE}{\texttt{Stacks tag 07YE}}
\group{artin}
...
\begin{lemma}[Ses inf and T]
\label{artin-lemma-ses-inf-and-T}
\source{stacks:0DNN}
\href{https://stacks.math.columbia.edu/tag/0DNN}{\texttt{Stacks tag 0DNN}}
\group{artin}
...
$$
\begin{array}{cccc}0 \longrightarrow & \text{Inf}_w(M) \longrightarrow & \text{Inf}_x(M) \oplus \text{Inf}_z(M) \longrightarrow & \text{Inf}_y(M) \swarrow \\  & T_w(M) \longrightarrow & T_x(M) \oplus T_z(M) \longrightarrow & T_y(M)\end{array}
$$
of $A$-modules.
\end{lemma}

\begin{proof}
\uses{artin-lemma-fibre-product-RS-star, artin-lemma-functoriality}

By Lemma \ref{artin-lemma-fibre-product-RS-star} we see that $\mathcal{W}$
satisfies (RS*) and hence $T_w(M)$ and $\text{Inf}_w(M)$ are defined.
The horizontal arrows are defined using the functoriality of
Lemma \ref{artin-lemma-functoriality}.
...
\source{stacks:0D18}
\href{https://stacks.math.columbia.edu/tag/0D18}{\texttt{Stacks tag 0D18}}
\group{artin}
...
Lemma \ref{artin-lemma-properties-lift-RS-star}.
\end{remark}
...
\source{stacks:07YC}
\href{https://stacks.math.columbia.edu/tag/07YC}{\texttt{Stacks tag 07YC}}
\group{artin}
...
\source{stacks:07YD}
\href{https://stacks.math.columbia.edu/tag/07YD}{\texttt{Stacks tag 07YD}}
\group{artin}

\uses{artin-remark-automorphisms}
Let $S$ be a locally Noetherian scheme. Let $\mathcal{X}$ be a category
fibred in groupoids over $(\Sch/S)_{fppf}$. Assume $\mathcal{X}$ satisfies
...
By the discussion of Remark \ref{artin-remark-automorphisms}
...
Lemma \ref{artin-lemma-properties-lift-RS-star}
and Remark \ref{artin-remark-functoriality}.

\begin{definition}[Obstruction theory]
\label{artin-definition-obstruction-theory}
\source{stacks:07YG}
\href{https://stacks.math.columbia.edu/tag/07YG}{\texttt{Stacks tag 07YG}}
\group{artin}
...
Lemma \ref{artin-lemma-get-openness-obstruction-theory} below.
...
\begin{lemma}[Get openness obstruction theory]
\label{artin-lemma-get-openness-obstruction-theory}
\source{stacks:0CYF}
\href{https://stacks.math.columbia.edu/tag/0CYF}{\texttt{Stacks tag 0CYF}}
\group{artin}

\uses{artin-definition-obstruction-theory}
\begin{reference}
...
Definition \ref{artin-definition-obstruction-theory}
...
\begin{proof}
\uses{artin-lemma-SGE-implies-openness-versality, artin-remark-strong-effectiveness, artin-remark-short-exact-sequence-thickenings, artin-lemma-properties-lift-RS-star}

We prove this by verifying condition (4) of
Lemma \ref{artin-lemma-SGE-implies-openness-versality}.
Let $(\xi_n)$ and $(R_n)$ be as in Remark \ref{artin-remark-strong-effectiveness}
...
Remark \ref{artin-remark-short-exact-sequence-thickenings}.
...
Lemma \ref{artin-lemma-properties-lift-RS-star} part (2)(b).
...
\source{stacks:07YH}
\href{https://stacks.math.columbia.edu/tag/07YH}{\texttt{Stacks tag 07YH}}
\group{artin}
...
\source{stacks:07YI}
\href{https://stacks.math.columbia.edu/tag/07YI}{\texttt{Stacks tag 07YI}}
\group{artin}
...
locally Noetherian scheme $S$. The key Example \ref{artin-example-key}
...
Lemma \ref{artin-lemma-characterize-versal} which leads to a criterion for
openness of versality in Lemma \ref{artin-lemma-openness}. We introduce a notion of
a naive obstruction theory in
Definition \ref{artin-definition-naive-obstruction-theory} to try to formalize
...
\begin{lemma}[Compute ext into field]
\label{artin-lemma-compute-ext-into-field}
\source{stacks:07YK}
\href{https://stacks.math.columbia.edu/tag/07YK}{\texttt{Stacks tag 07YK}}
\group{artin}
...
\begin{lemma}[Construct essential surjection]
\label{artin-lemma-construct-essential-surjection}
\source{stacks:07YL}
\href{https://stacks.math.columbia.edu/tag/07YL}{\texttt{Stacks tag 07YL}}
\group{artin}
...
\begin{proof}
\uses{artin-lemma-compute-ext-into-field}
...
Lemma \ref{artin-lemma-compute-ext-into-field}
we see that the composition is zero.
\end{proof}

The following lemma is our key technical result.

\begin{lemma}[Characterize versal]
\label{artin-lemma-characterize-versal}
\source{stacks:07YM}
\href{https://stacks.math.columbia.edu/tag/07YM}{\texttt{Stacks tag 07YM}}
\group{artin}

\uses{artin-remark-canonical-element}
Let $S$ be a locally Noetherian scheme. Let $\mathcal{X}$ be a category
...
Remark \ref{artin-remark-canonical-element}).
\end{enumerate}
...
\begin{proof}
\uses{artin-lemma-construct-essential-surjection, artin-lemma-compute-ext-into-field, artin-remark-canonical-element, artin-example-key}
...
Lemma \ref{artin-lemma-construct-essential-surjection}.
...
\medskip\noindent
Assume that $x$ versal at $u_0$. By Lemma \ref{artin-lemma-compute-ext-into-field}
...
infinitesimal deformation of $x_0$, see Remark \ref{artin-remark-canonical-element}.
...
$\Ext^1_A(\NL_{A/\Lambda}, I)$, see Example \ref{artin-example-key}.
By Lemma \ref{artin-lemma-compute-ext-into-field} and our assumption the map
...
\source{stacks:07YN}
\href{https://stacks.math.columbia.edu/tag/07YN}{\texttt{Stacks tag 07YN}}
\group{artin}
...
Lemma \ref{artin-lemma-characterize-versal}
...
\begin{definition}[Naive obstruction theory]
\label{artin-definition-naive-obstruction-theory}
\source{stacks:07YP}
\href{https://stacks.math.columbia.edu/tag/07YP}{\texttt{Stacks tag 07YP}}
\group{artin}

\uses{artin-remark-functoriality, artin-remark-canonical-element}
Let $S$ be a locally Noetherian base. Let $\mathcal{X}$ be a category fibred
...
$$
\begin{array}{cc}E_y \underset{\xi_y}{\longrightarrow} & \NL_{B/\Lambda} \\ E_x \uparrow\overset{\xi_x}{\longrightarrow} & \NL_{A/\Lambda} \uparrow\end{array}
$$
...
maps and the maps of Remark \ref{artin-remark-functoriality},
\item[(iv)]
...
as in Section \ref{artin-section-obstruction-theory} by setting
$\mathcal{O}_x( - ) = \Ext^1_A(E_x, -)$.

\begin{lemma}[Naive obstruction theory qis]
\label{artin-lemma-naive-obstruction-theory-qis}
\source{stacks:07YT}
\href{https://stacks.math.columbia.edu/tag/07YT}{\texttt{Stacks tag 07YT}}
\group{artin}

\uses{artin-definition-naive-obstruction-theory}
Let $S$ and $\mathcal{X}$ be as in
Definition \ref{artin-definition-naive-obstruction-theory}
...
for $i = -1, 0$. By Lemma \ref{artin-lemma-compute-ext-into-field} our maps
$H^i(E_x \otimes_A^{\mathbf{L}} k) \to H^i(E_y \otimes_B^{\mathbf{L}} k)$,
$i = 0, 1$ induce isomorphisms on dual vector spaces hence are isomorphisms.
\end{proof}

\begin{lemma}[Naive obstruction theory gives openness]
\label{artin-lemma-naive-obstruction-theory-gives-openness}
\source{stacks:07YU}
\href{https://stacks.math.columbia.edu/tag/07YU}{\texttt{Stacks tag 07YU}}
\group{artin}
...
complexes $E_x$ of Definition \ref{artin-definition-naive-obstruction-theory}
have finitely generated cohomology groups for pairs $(A, x)$ where
$A$ is of finite type over $S$.
\end{lemma}

\begin{proof}
\uses{artin-lemma-openness}
...
At this point we may apply Lemma \ref{artin-lemma-openness} to conclude.
\end{proof}
...
Definition \ref{artin-definition-obstruction-theory}. In practice
...
\begin{example}[Global sections dual]
\label{artin-example-global-sections-dual}
\source{stacks:07YW}
\href{https://stacks.math.columbia.edu/tag/07YW}{\texttt{Stacks tag 07YW}}
\group{artin}

\uses{artin-example-global-sections}
Let $\Lambda, S, W, \mathcal{F}$ be as in
Example \ref{artin-example-global-sections}.
...
In particular the obstruction spaces from Example \ref{artin-example-global-sections}
...
\begin{definition}[Situation: Dual]
\label{artin-situation-dual}
\source{stacks:07YX}
\href{https://stacks.math.columbia.edu/tag/07YX}{\texttt{Stacks tag 07YX}}
\group{artin}
...
In Situation \ref{artin-situation-dual} an important role will be played by
...
\begin{lemma}[Dual obstruction]
\label{artin-lemma-dual-obstruction}
\source{stacks:07YY}
\href{https://stacks.math.columbia.edu/tag/07YY}{\texttt{Stacks tag 07YY}}
\group{artin}

\uses{artin-situation-dual, artin-remark-short-exact-sequence-thickenings, artin-remark-canonical-element}
In Situation \ref{artin-situation-dual}. Assume furthermore that
\begin{enumerate}
\item[(iv)] given a short exact sequence of deformation situations
as in Remark \ref{artin-remark-short-exact-sequence-thickenings} and
...
Remark \ref{artin-remark-canonical-element} via the given transformation
$T_x(-) \to H^1(K^\bullet \otimes_A^\mathbf{L} -)$.
\end{enumerate}
\end{lemma}
...
and property (ii) of Situation \ref{artin-situation-dual}.
...
Remark \ref{artin-remark-short-exact-sequence-thickenings}) equals the given
...
\begin{lemma}[Dual openness]
\label{artin-lemma-dual-openness}
\source{stacks:07YZ}
\href{https://stacks.math.columbia.edu/tag/07YZ}{\texttt{Stacks tag 07YZ}}
\group{artin}

\uses{artin-situation-dual, artin-lemma-dual-obstruction}
In Situation \ref{artin-situation-dual} assume that (iv) of
Lemma \ref{artin-lemma-dual-obstruction} holds and that $K^\bullet$ is a
...
\begin{proof}
\uses{artin-lemma-dual-obstruction, artin-lemma-openness}
...
be the element constructed in Lemma \ref{artin-lemma-dual-obstruction}
and denote $\xi : E = E^\bullet[-1] \to \NL_{A/\Lambda}$ the corresponding
map (loc.cit.). We claim that the pair $(E, \xi)$ satisfies all the
assumptions of Lemma \ref{artin-lemma-openness} which finishes the proof.

\medskip\noindent
Namely, assumption (i) of Lemma \ref{artin-lemma-openness} follows from conclusion
(1) of Lemma \ref{artin-lemma-dual-obstruction}
and the fact that $H^2(K^\bullet \otimes_A^\mathbf{L} -) =
\Ext^1(E, -)$ by loc.cit. Assumption (ii) of
Lemma \ref{artin-lemma-openness} follows from conclusion (2) of
Lemma \ref{artin-lemma-dual-obstruction}
and the fact that $H^1(K^\bullet \otimes_A^\mathbf{L} -) =
\Ext^0(E, -)$ by loc.cit. Assumption (iii) of Lemma \ref{artin-lemma-openness}
is clear.
\end{proof}
...
\source{stacks:0GE2}
\href{https://stacks.math.columbia.edu/tag/0GE2}{\texttt{Stacks tag 0GE2}}
\group{artin}
...
\source{stacks:0GE3}
\href{https://stacks.math.columbia.edu/tag/0GE3}{\texttt{Stacks tag 0GE3}}
\group{artin}
...
\begin{lemma}[Representable limit preserving]
\label{artin-lemma-representable-limit-preserving}
\source{stacks:0GE4}
\href{https://stacks.math.columbia.edu/tag/0GE4}{\texttt{Stacks tag 0GE4}}
\group{artin}
...
\begin{lemma}[Representable]
\label{artin-lemma-representable}
\source{stacks:0GE5}
\href{https://stacks.math.columbia.edu/tag/0GE5}{\texttt{Stacks tag 0GE5}}
\group{artin}
...
\begin{proof}
\uses{artin-lemma-representable-limit-preserving, artin-lemma-canonical-extension}
...
By Lemma \ref{artin-lemma-representable-limit-preserving}
...
By the equivalence of categories of Lemma \ref{artin-lemma-canonical-extension}
...
denote the site studied in Section \ref{artin-section-noetherian}.
...
Section \ref{artin-section-axioms-functors} make sense. We will review them
...
in Section \ref{artin-section-noetherian}:  for any
directed limit of affine schemes $X = \lim X_i$ of
...
Definition \ref{artin-definition-RS} and the discussion in
...
Sections \ref{artin-section-formal-objects} and \ref{artin-section-axioms-functors}
...
\begin{proposition}[Spaces diagonal representable noetherian]
\label{artin-proposition-spaces-diagonal-representable-noetherian}
\source{stacks:0GE7}
\href{https://stacks.math.columbia.edu/tag/0GE7}{\texttt{Stacks tag 0GE7}}
\group{artin}
...
\begin{proof}
\uses{artin-lemma-canonical-extension, artin-lemma-representable, artin-proposition-spaces-diagonal-representable}

Recall that the sites $(\Sch/S)_{fppf}$ and $(\Sch/S)_\etale$ have the same
underlying category, see discussion in Section \ref{artin-section-noetherian}.
...
Lemma \ref{artin-lemma-canonical-extension}.
Then $F'$ satisfies axioms [0] and [1] as given in
Section \ref{artin-section-axioms-functors}.
By Lemma \ref{artin-lemma-representable} we see that
...
\begin{definition}[Situation: Contractions]
\label{artin-situation-contractions}
\source{stacks:0GH8}
\href{https://stacks.math.columbia.edu/tag/0GH8}{\texttt{Stacks tag 0GH8}}
\group{artin}
...
\begin{remark}[G rings]
\label{artin-remark-G-rings}
\source{stacks:0GH9}
\href{https://stacks.math.columbia.edu/tag/0GH9}{\texttt{Stacks tag 0GH9}}
\group{artin}

\uses{artin-situation-contractions}
In particular, we cannot prove that the desired result is true for
every Situation \ref{artin-situation-contractions} because we will need to
...
In Situation \ref{artin-situation-contractions}
...
$$
\begin{array}{cc}V'_{/Z} \longrightarrow\underset{\hat x'}{\downarrow} & V_{/Z} \overset{\hat x}{\downarrow} \\ X'_{/T'} \overset{g}{\longrightarrow} & W\end{array}
$$
...
$$
\begin{array}{cccc}V \setminus Z \longrightarrow\underset{u'}{\downarrow} & V' \overset{x'}{\downarrow} & V'_{/Z} \longleftarrow\overset{\hat x'}{\downarrow}\longrightarrow & V_{/Z} \overset{\hat x}{\downarrow} \\ U' \longrightarrow & X' & X'_{/T'} \overset{g}{\longrightarrow}\longleftarrow & W\end{array}
$$
...
\begin{remark}[How to think compatibility]
\label{artin-remark-how-to-think-compatibility}
\source{stacks:0GID}
\href{https://stacks.math.columbia.edu/tag/0GID}{\texttt{Stacks tag 0GID}}
\group{artin}

\uses{artin-situation-contractions}
In Situation \ref{artin-situation-contractions} let $V$ be a locally Noetherian
...
$$
\begin{array}{ccc}(V_{/Z})^{rig} \underset{can}{\longrightarrow}\underset{(g^{rig})^{-1} \circ \hat x^{an}}{\downarrow} &  & (V \setminus Z)^{an} \overset{(u')^{an}}{\downarrow} \\ (X'_{/T'})^{rig} \overset{can}{\longrightarrow} &  & (X' \setminus T')^{an}\end{array}
$$
...
\source{stacks:0GHA}
\href{https://stacks.math.columbia.edu/tag/0GHA}{\texttt{Stacks tag 0GHA}}
\group{artin}

\uses{artin-situation-contractions}
In Situation \ref{artin-situation-contractions} the rule $F$ that sends
...
\source{stacks:0GHB}
\href{https://stacks.math.columbia.edu/tag/0GHB}{\texttt{Stacks tag 0GHB}}
\group{artin}

\uses{artin-situation-contractions}
In Situation \ref{artin-situation-contractions} if there exists a solution
...
\begin{lemma}[Functor is solution]
\label{artin-lemma-functor-is-solution}
\source{stacks:0GHC}
\href{https://stacks.math.columbia.edu/tag/0GHC}{\texttt{Stacks tag 0GHC}}
\group{artin}

\uses{artin-situation-contractions}
In Situation \ref{artin-situation-contractions} if there exists an
...
\begin{proof}
\uses{artin-situation-contractions, artin-lemma-canonical-extension, artin-lemma-functor}

We have to construct a proper morphism $f : X' \to X$, a closed subset
$T \subset |X|$, and an isomorphism $a : X_{/T} \to W$ with properties
(1), (2), (3) listed just below Situation \ref{artin-situation-contractions}.
...
$(\textit{Noetherian}/S)_\etale$ of Section \ref{artin-section-noetherian}.
...
transformation $h_{X'} \to h_X = F$, see Lemma \ref{artin-lemma-canonical-extension}.
...
(see discussion preceding Lemma \ref{artin-lemma-functor}).
...
\begin{remark}[Diagonal]
\label{artin-remark-diagonal}
\source{stacks:0GHD}
\href{https://stacks.math.columbia.edu/tag/0GHD}{\texttt{Stacks tag 0GHD}}
\group{artin}

\uses{artin-situation-contractions, artin-lemma-solution, artin-lemma-functor-is-solution}
In Situation \ref{artin-situation-contractions}.
Let $V$ be a locally Noetherian scheme over $S$.
...
and the diagram
$$
\begin{array}{cc}E'_{/Z} \longrightarrow\downarrow & X'_{/T'} \overset{g}{\downarrow} \\ E_W \longrightarrow & W\end{array}
$$
...
is a triple as in Situation \ref{artin-situation-contractions}
...
\end{enumerate}
We conclude, using
Lemmas \ref{artin-lemma-solution} and \ref{artin-lemma-functor-is-solution},
...
\source{stacks:0GHE}
\href{https://stacks.math.columbia.edu/tag/0GHE}{\texttt{Stacks tag 0GHE}}
\group{artin}

\uses{artin-situation-contractions}
In Situation \ref{artin-situation-contractions} assume given a closed
...
$$
\begin{array}{ccc}X' \downarrow & X'_{/T'} \times_{S_{/Z}} \text{Spf}(A^\wedge) \longleftarrow\downarrow & X'_{/T'} \times_W \text{Spf}(A^\wedge/J') \xlongequal{}\downarrow \\ \Spec(A) & \text{Spf}(A^\wedge) \longleftarrow & \text{Spf}(A^\wedge/J') \longleftarrow\end{array}
$$
...
\begin{lemma}[Diagonal contractions]
\label{artin-lemma-diagonal-contractions}
\source{stacks:0GHF}
\href{https://stacks.math.columbia.edu/tag/0GHF}{\texttt{Stacks tag 0GHF}}
\group{artin}

\uses{artin-situation-contractions}
In Situation \ref{artin-situation-contractions} assume $X' \to S$
and $W \to S$ are separated. Then the diagonal $\Delta : F \to F \times F$
is representable by closed immersions.
\end{lemma}

\begin{proof}
\uses{artin-lemma-closed-immersion, artin-remark-diagonal}

Combine Lemma \ref{artin-lemma-closed-immersion}
with the discussion in Remark \ref{artin-remark-diagonal}.
\end{proof}

\begin{lemma}[Sheaf]
\label{artin-lemma-sheaf}
\source{stacks:0GHG}
\href{https://stacks.math.columbia.edu/tag/0GHG}{\texttt{Stacks tag 0GHG}}
\group{artin}

\uses{artin-situation-contractions}
In Situation \ref{artin-situation-contractions} the functor
...
\begin{lemma}[Limit preserving]
\label{artin-lemma-limit-preserving}
\source{stacks:0GI5}
\href{https://stacks.math.columbia.edu/tag/0GI5}{\texttt{Stacks tag 0GI5}}
\group{artin}

\uses{artin-situation-contractions}
In Situation \ref{artin-situation-contractions} the functor $F$ is limit preserving:
for any directed limit $V = \lim V_\lambda$ of Noetherian affine schemes
over $S$ we have $F(V) = \colim F(V_\lambda)$.
\end{lemma}

\begin{proof}
\uses{artin-remark-diagonal, artin-lemma-closed-immersion, artin-lemma-solution, artin-lemma-sheaf, artin-situation-contractions}
...
Remark \ref{artin-remark-diagonal} to $V_\lambda$ and the two elements
$\xi_{\lambda, 1}, \xi_{\lambda, 2} \in F(V_\lambda)$.
This gives us
\begin{enumerate}
...
\end{enumerate}
Assertion (2) holds by assertion (2) in Remark \ref{artin-remark-diagonal}
...
Then we see from assertion (4) in Remark \ref{artin-remark-diagonal}
and Lemma \ref{artin-lemma-closed-immersion} applied to the triple
...
Next we use assertion (5) in Remark \ref{artin-remark-diagonal}
which combined with Lemma \ref{artin-lemma-solution}
...
sheaf property of $F$ in Lemma \ref{artin-lemma-sheaf}, the problem
...
$$
is another example of Situation \ref{artin-situation-contractions}.
...
$$
\begin{array}{cc}C_\mu^\wedge \longrightarrow & C^\wedge \\ B \overset{(g \circ x'_{\mu, /Z_\mu})^\sharp}{\uparrow}\overset{(\hat x)^\sharp}{\longrightarrow} & A^\wedge \uparrow\end{array}
$$
...
\source{stacks:0GI6}
\href{https://stacks.math.columbia.edu/tag/0GI6}{\texttt{Stacks tag 0GI6}}
\group{artin}

\uses{artin-situation-contractions}
In Situation \ref{artin-situation-contractions} the functor $F$ satisfies
the Rim-Schlessinger condition (RS).
\end{lemma}

\begin{proof}
\uses{artin-lemma-algebraic-stack-RS}
...
\begin{lemma}[Finite dim]
\label{artin-lemma-finite-dim}
\source{stacks:0GI7}
\href{https://stacks.math.columbia.edu/tag/0GI7}{\texttt{Stacks tag 0GI7}}
\group{artin}

\uses{artin-situation-contractions}
In Situation \ref{artin-situation-contractions} the tangent spaces of
the functor $F$ are finite dimensional.
\end{lemma}

\begin{proof}
\uses{artin-lemma-rs, artin-lemma-finite-dimension}

In the proof of Lemma \ref{artin-lemma-rs} we have seen that
...
Lemma \ref{artin-lemma-finite-dimension}.
Write $W = \colim W_n$ as in the proof of Lemma \ref{artin-lemma-rs}.
...
\begin{lemma}[Formal object effective]
\label{artin-lemma-formal-object-effective}
\source{stacks:0GI8}
\href{https://stacks.math.columbia.edu/tag/0GI8}{\texttt{Stacks tag 0GI8}}
\group{artin}

\uses{artin-situation-contractions}
In Situation \ref{artin-situation-contractions} assume $X' \to S$ is separated.
Then every formal object for $F$ is effective.
\end{lemma}

\begin{proof}
\uses{artin-lemma-rs, artin-lemma-effective}

A formal object $\xi = (R, \xi_n)$ of $F$ consists of a Noetherian
complete local $S$-algebra $R$ whose residue field is of finite type
over $S$, together with elements $\xi_n \in F(\Spec(R/\mathfrak m^n))$
for all $n$ such that $\xi_{n + 1}|_{\Spec(R/\mathfrak m^n)} = \xi_n$.
By the discussion in the proof of Lemma \ref{artin-lemma-rs}
we see that either $\xi$ is a formal object of $U'$ or a formal
object of $W$. In the first case we see that $\xi$ is effective
by Lemma \ref{artin-lemma-effective}. The second case is the interesting case.
...
proof of Lemma \ref{artin-lemma-rs}, noticing that $\xi|_{\text{Spf}(R/I^n)}$
...
\begin{lemma}[Openness smoothness]
\label{artin-lemma-openness-smoothness}
\source{stacks:0GI9}
\href{https://stacks.math.columbia.edu/tag/0GI9}{\texttt{Stacks tag 0GI9}}
\group{artin}
...
\begin{proof}
\uses{artin-lemma-base-change-versal, artin-lemma-rs}
...
is smooth at $v$ by
Lemma \ref{artin-lemma-base-change-versal}\footnote{The lemma applies since
...
and we have seen that $W$ has (RS) in the proof of Lemma \ref{artin-lemma-rs}.}.
...
\begin{lemma}[Openness versality]
\label{artin-lemma-openness-versality}
\source{stacks:0GIA}
\href{https://stacks.math.columbia.edu/tag/0GIA}{\texttt{Stacks tag 0GIA}}
\group{artin}
...
\begin{proof}
\uses{artin-lemma-openness-smoothness}
...
By Lemma \ref{artin-lemma-openness-smoothness} we may assume $\hat x : V_{/Z} \to W$
...
\begin{theorem}[Contractions]
\label{artin-theorem-contractions}
\source{stacks:0GIB}
\href{https://stacks.math.columbia.edu/tag/0GIB}{\texttt{Stacks tag 0GIB}}
\group{artin}

\uses{artin-remark-separated-needed}
\begin{reference}
...
separated\footnote{See Remark \ref{artin-remark-separated-needed}.} over $S$, then
...
\begin{proof}
\uses{artin-lemma-functor-is-solution, artin-proposition-spaces-diagonal-representable-noetherian, artin-lemma-diagonal-contractions, artin-lemma-sheaf, artin-lemma-limit-preserving, artin-lemma-rs, artin-lemma-finite-dim, artin-lemma-formal-object-effective, artin-lemma-openness-versality}

Let $F$ be the functor constructed using $X'$, $T'$, $W$, $g$ in this section.
By Lemma \ref{artin-lemma-functor-is-solution} it suffices to show that
$F$ corresponds to an algebraic space $X$ locally of finite type over $S$.
In order to do this, we will apply
Proposition \ref{artin-proposition-spaces-diagonal-representable-noetherian}.
Namely, by Lemma \ref{artin-lemma-diagonal-contractions}
the diagonal of $F$ is representable by closed immersions
and by
Lemmas \ref{artin-lemma-sheaf}, \ref{artin-lemma-limit-preserving},
\ref{artin-lemma-rs}, \ref{artin-lemma-finite-dim},
\ref{artin-lemma-formal-object-effective}, and \ref{artin-lemma-openness-versality}
we have axioms [0], [1], [2], [3], [4], and [5].
\end{proof}

\begin{remark}[Separated needed]
\label{artin-remark-separated-needed}
\source{stacks:0GIC}
\href{https://stacks.math.columbia.edu/tag/0GIC}{\texttt{Stacks tag 0GIC}}
\group{artin}

\uses{artin-theorem-contractions, artin-remark-diagonal, artin-lemma-formal-object-effective}
The proof of Theorem \ref{artin-theorem-contractions} uses that $X'$ and $W$
...
found in Remark \ref{artin-remark-diagonal} (this is the usual bootstrap
procedure for the diagonal). Thus the proof of
Lemma \ref{artin-lemma-formal-object-effective} is the only
place in our proof of Theorem \ref{artin-theorem-contractions}
