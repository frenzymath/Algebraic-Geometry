...
\begin{lemma}[Baffling]
\label{trace-lemma-baffling}
\source{stacks:03SP}
\href{https://stacks.math.columbia.edu/tag/03SP}{\texttt{Stacks tag 03SP}}
\group{trace}

Let $X$ be a scheme and $g : X \to X$ a morphism. Assume that for all
$\varphi : U \to X$ \'etale, there is an isomorphism
$$
\begin{array}{ccc}U \underset{\varphi}{\searrow}\overset{\sim}{\longrightarrow} &  & {U
\times_{\varphi, X, g} X} \overset{\text{pr}_2}{\swarrow} \\  & X & \end{array}
$$
...
\source{stacks:03SN}
\href{https://stacks.math.columbia.edu/tag/03SN}{\texttt{Stacks tag 03SN}}
\group{trace}
...
verify that the assumption of Lemma \ref{trace-lemma-baffling}
holds for the frobenius.

\begin{proof}
\uses{trace-theorem-baffling}
[Proof of Theorem \ref{trace-theorem-baffling}]
...
$$
\begin{array}{ccc}U \searrow\overset{F_U}{\searrow}\underset{\varphi}{\searrow} &  &  \\  & {U \times_{\varphi, X, F_X} X} \underset{\text{pr}_1}{\longrightarrow}\overset{\text{pr}_2}{\downarrow} & U \overset{\varphi}{\downarrow} \\  & X \overset{F_X}{\longrightarrow} & X.\end{array}
$$
...
\source{stacks:03SQ}
\href{https://stacks.math.columbia.edu/tag/03SQ}{\texttt{Stacks tag 03SQ}}
\group{trace}
...
\begin{lemma}[Sheaf over finite field has frobenius descent]
\label{trace-lemma-sheaf-over-finite-field-has-frobenius-descent}
\source{stacks:03SR}
\href{https://stacks.math.columbia.edu/tag/03SR}{\texttt{Stacks tag 03SR}}
\group{trace}
...
Theorem \ref{trace-theorem-baffling} that there is a functorial isomorphism
$$
\begin{array}{ccc}U \underset{\varphi}{\searrow}\underset{\gamma_U}{\longrightarrow} &  & U \times_{\varphi, X, \pi_X} X \overset{\text{pr}_2}{\swarrow} \\  & X & \end{array}
$$
...
\begin{remark}[May be confusing]
\label{trace-remark-may-be-confusing}
\source{stacks:03SS}
\href{https://stacks.math.columbia.edu/tag/03SS}{\texttt{Stacks tag 03SS}}
\group{trace}
...
$$
\begin{array}{ccc}X_{\bar k} \searrow\overset{\Spec(\sigma) \times \text{id}_X}{\longrightarrow} &  & X_{\bar k} \swarrow \\  & X & \end{array}
$$
...
\begin{lemma}[Two actions agree]
\label{trace-lemma-two-actions-agree}
\source{stacks:03ST}
\href{https://stacks.math.columbia.edu/tag/03ST}{\texttt{Stacks tag 03ST}}
\group{trace}
...
\source{stacks:03SU}
\href{https://stacks.math.columbia.edu/tag/03SU}{\texttt{Stacks tag 03SU}}
\group{trace}
...
\begin{theorem}[Geometric arithmetic inverse]
\label{trace-theorem-geometric-arithmetic-inverse}
\source{stacks:03SV}
\href{https://stacks.math.columbia.edu/tag/03SV}{\texttt{Stacks tag 03SV}}
\group{trace}
...
Lemma \ref{trace-lemma-sheaf-over-finite-field-has-frobenius-descent}.
...
\begin{definition}[Geometric frobenius on stalk]
\label{trace-definition-geometric-frobenius-on-stalk}
\source{stacks:03SW}
\href{https://stacks.math.columbia.edu/tag/03SW}{\texttt{Stacks tag 03SW}}
\group{trace}
...
\begin{remark}[Compute degree lifting]
\label{trace-remark-compute-degree-lifting}
\source{stacks:03SY}
\href{https://stacks.math.columbia.edu/tag/03SY}{\texttt{Stacks tag 03SY}}
\group{trace}
...
\text{Mat}_m(\Lambda)$. Note that since the modules are left modules,
...
\source{stacks:03T0}
\href{https://stacks.math.columbia.edu/tag/03T0}{\texttt{Stacks tag 03T0}}
\group{trace}
...
\begin{remark}[Remarks derived categories]
\label{remarks-derived-categories}
\source{stacks:03T4}
\href{https://stacks.math.columbia.edu/tag/03T4}{\texttt{Stacks tag 03T4}}
\group{trace}
...
\begin{lemma}[When in bounded]
\label{trace-lemma-when-in-bounded}
\source{stacks:03T5}
\href{https://stacks.math.columbia.edu/tag/03T5}{\texttt{Stacks tag 03T5}}
\group{trace}
...
\begin{lemma}[Derived categories]
\label{trace-lemma-derived-categories}
\source{stacks:03T6}
\href{https://stacks.math.columbia.edu/tag/03T6}{\texttt{Stacks tag 03T6}}
\group{trace}
...
\source{stacks:03T7}
\href{https://stacks.math.columbia.edu/tag/03T7}{\texttt{Stacks tag 03T7}}
\group{trace}
...
$$
\begin{array}{cc}D^+(\mathcal{A}) \overset{RF}{\longrightarrow} & D^+(\mathcal{B}) \\ K^+(\mathcal I) \uparrow\overset{F}{\longrightarrow} & K^+(\mathcal{B}). \uparrow\end{array}
$$
...
$$
\begin{array}{cc}D^-(\mathcal{A}) \overset{LG}{\longrightarrow} & D^-(\mathcal{B}) \\ K^-(\mathcal{P}) \uparrow\overset{G}{\longrightarrow} & K^-(\mathcal{B}). \uparrow\end{array}
$$
This is possible since the left vertical arrow is invertible by the previous
lemma.
\end{definition}

\begin{remark}[Cohomology of derived functor]
\label{trace-remark-cohomology-of-derived-functor}
\source{stacks:03T8}
\href{https://stacks.math.columbia.edu/tag/03T8}{\texttt{Stacks tag 03T8}}
\group{trace}
...
\source{stacks:03TA}
\href{https://stacks.math.columbia.edu/tag/03TA}{\texttt{Stacks tag 03TA}}
\group{trace}
...
\begin{lemma}[Filtered derived category]
\label{trace-lemma-filtered-derived-category}
\source{stacks:03TB}
\href{https://stacks.math.columbia.edu/tag/03TB}{\texttt{Stacks tag 03TB}}
\group{trace}
...
\begin{definition}[Filtered derived functors]
\label{trace-definition-filtered-derived-functors}
\source{stacks:03TD}
\href{https://stacks.math.columbia.edu/tag/03TD}{\texttt{Stacks tag 03TD}}
\group{trace}
...
$$
\begin{array}{cc}DF^+(\mathcal{A}) \overset{RT}{\longrightarrow} & DF^+(\mathcal{B}) \\ K^+(\mathcal{I}) \uparrow\overset{T \quad}{\longrightarrow} & K^+(\text{Fil}^f(\mathcal{B})).
\uparrow\end{array}
$$
...
the diagram
$$
\begin{array}{cc}DF^-(\mathcal{A}) \overset{LG}{\longrightarrow} & DF^-(\mathcal{B}) \\ K^-(\mathcal{P}) \uparrow\overset{G \quad}{\longrightarrow} & K^-(\text{Fil}^f(\mathcal{B})).
\uparrow\end{array}
$$
...
\begin{proposition}[Compare filtered graded]
\label{trace-proposition-compare-filtered-graded}
\source{stacks:03TE}
\href{https://stacks.math.columbia.edu/tag/03TE}{\texttt{Stacks tag 03TE}}
\group{trace}
...
$$
\begin{array}{cc}DF^+(\mathcal{A}) \overset{RT}{\longrightarrow}\underset{\text{gr}^p}{\downarrow} & DF^+(\mathcal{B})
\overset{\text{gr}^p}{\downarrow} \\ D^+(\mathcal{A}) \overset{RT}{\longrightarrow} & D^+(\mathcal{B}).\end{array}
$$
\end{proposition}
...
$$
\begin{array}{cccc}0 \longrightarrow & T(L) \longrightarrow & T(M) \longrightarrow & T(N) \downarrow \\  & R^1T(L) \longrightarrow & R^1T(M) \longrightarrow & \ldots\end{array}
$$
...
\source{stacks:03TH}
\href{https://stacks.math.columbia.edu/tag/03TH}{\texttt{Stacks tag 03TH}}
\group{trace}
...
\begin{proposition}[Trace well defined]
\label{trace-proposition-trace-well-defined}
\source{stacks:03TI}
\href{https://stacks.math.columbia.edu/tag/03TI}{\texttt{Stacks tag 03TI}}
\group{trace}
...
\source{stacks:03TK}
\href{https://stacks.math.columbia.edu/tag/03TK}{\texttt{Stacks tag 03TK}}
\group{trace}
...
\begin{proof}
\uses{trace-proposition-trace-well-defined}

By Proposition \ref{trace-proposition-trace-well-defined}, we may assume we have
a bounded
...
\begin{lemma}[Additive filtered finite projective]
\label{trace-lemma-additive-filtered-finite-projective}
\source{stacks:03TL}
\href{https://stacks.math.columbia.edu/tag/03TL}{\texttt{Stacks tag 03TL}}
\group{trace}
...
\begin{definition}[Finite tor dimension]
\label{trace-definition-finite-tor-dimension}
\source{stacks:03TN}
\href{https://stacks.math.columbia.edu/tag/03TN}{\texttt{Stacks tag 03TN}}
\group{trace}
...
\begin{lemma}[Characterize perfect]
\label{trace-lemma-characterize-perfect}
\source{stacks:03TO}
\href{https://stacks.math.columbia.edu/tag/03TO}{\texttt{Stacks tag 03TO}}
\group{trace}
...
\source{stacks:03TP}
\href{https://stacks.math.columbia.edu/tag/03TP}{\texttt{Stacks tag 03TP}}
\group{trace}
...
\begin{proposition}[Projective curve constructible cohomology]
\label{trace-proposition-projective-curve-constructible-cohomology}
\source{stacks:03TV}
\href{https://stacks.math.columbia.edu/tag/03TV}{\texttt{Stacks tag 03TV}}
\group{trace}
...
\begin{proof}
\uses{trace-lemma-characterize-perfect}
[Sketch of proof.]
...
complex by Lemma \ref{trace-lemma-characterize-perfect}.
\end{proof}
...
\begin{definition}[Global lefschetz number]
\label{trace-definition-global-lefschetz-number}
\source{stacks:03TX}
\href{https://stacks.math.columbia.edu/tag/03TX}{\texttt{Stacks tag 03TX}}
\group{trace}
...
\begin{definition}[Local lefschetz number]
\label{trace-definition-local-lefschetz-number}
\source{stacks:03TY}
\href{https://stacks.math.columbia.edu/tag/03TY}{\texttt{Stacks tag 03TY}}
\group{trace}

\uses{trace-definition-global-lefschetz-number}
With $\Lambda, X, k, K$ as in
Definition \ref{trace-definition-global-lefschetz-number}.
...
have seen in Section \ref{trace-section-frobenii}, the Frobenius $\pi_X$ acts on
...
\source{stacks:03TZ}
\href{https://stacks.math.columbia.edu/tag/03TZ}{\texttt{Stacks tag 03TZ}}
\group{trace}
...
are listed in Section \ref{trace-section-list-skipped}).
...
\source{stacks:03U1}
\href{https://stacks.math.columbia.edu/tag/03U1}{\texttt{Stacks tag 03U1}}
\group{trace}
...
\source{stacks:03U2}
\href{https://stacks.math.columbia.edu/tag/03U2}{\texttt{Stacks tag 03U2}}
\group{trace}
...
\begin{lemma}[Weil mod]
\label{trace-lemma-weil-mod}
\source{stacks:03U3}
\href{https://stacks.math.columbia.edu/tag/03U3}{\texttt{Stacks tag 03U3}}
\group{trace}

\uses{trace-theorem-weil-trace-formula}
Consider the situation of
Theorem \ref{trace-theorem-weil-trace-formula}
...
$$
and the corollary follows from Theorem \ref{trace-theorem-weil-trace-formula}.
\end{proof}
...
\source{stacks:03U5}
\href{https://stacks.math.columbia.edu/tag/03U5}{\texttt{Stacks tag 03U5}}
\group{trace}
...
\begin{definition}[Trace G]
\label{trace-definition-trace-G}
\source{stacks:03U6}
\href{https://stacks.math.columbia.edu/tag/03U6}{\texttt{Stacks tag 03U6}}
\group{trace}
...
\begin{lemma}[Lambda trace]
\label{trace-lemma-lambda-trace}
\source{stacks:03U7}
\href{https://stacks.math.columbia.edu/tag/03U7}{\texttt{Stacks tag 03U7}}
\group{trace}
...
\begin{lemma}[A module structure]
\label{trace-lemma-A-module-structure}
\source{stacks:03U8}
\href{https://stacks.math.columbia.edu/tag/03U8}{\texttt{Stacks tag 03U8}}
\group{trace}
...
\begin{lemma}[Diagonal action projective module]
\label{trace-lemma-diagonal-action-projective-module}
\source{stacks:03U9}
\href{https://stacks.math.columbia.edu/tag/03U9}{\texttt{Stacks tag 03U9}}
\group{trace}
...
\begin{lemma}[Multiplicative trace]
\label{trace-lemma-multiplicative-trace}
\source{stacks:03UA}
\href{https://stacks.math.columbia.edu/tag/03UA}{\texttt{Stacks tag 03UA}}
\group{trace}

\uses{trace-lemma-diagonal-action-projective-module}
With assumptions as in
Lemma \ref{trace-lemma-diagonal-action-projective-module},
let
...
\begin{lemma}[Gamma z gamma trace]
\label{trace-lemma-gamma-z-gamma-trace}
\source{stacks:03UB}
\href{https://stacks.math.columbia.edu/tag/03UB}{\texttt{Stacks tag 03UB}}
\group{trace}
...
\begin{proof}
\uses{trace-lemma-lambda-trace}

This follows readily from Lemma \ref{trace-lemma-lambda-trace}.
\end{proof}

\begin{lemma}[Weak trace]
\label{trace-lemma-weak-trace}
\source{stacks:03UC}
\href{https://stacks.math.columbia.edu/tag/03UC}{\texttt{Stacks tag 03UC}}
\group{trace}
...
\begin{proof}
\uses{trace-lemma-multiplicative-trace}

This follows directly from Lemma \ref{trace-lemma-multiplicative-trace}.
\end{proof}

\begin{lemma}[Trivial trace]
\label{trace-lemma-trivial-trace}
\source{stacks:03UD}
\href{https://stacks.math.columbia.edu/tag/03UD}{\texttt{Stacks tag 03UD}}
\group{trace}
...
$$
\begin{array}{ccc}P^G \underset{a}{\searrow} &  & P_G \overset{c}{\longleftarrow} \\  & P \underset{b}{\nearrow} & \end{array}
$$
...
\begin{remark}[Content trivial trace]
\label{trace-remark-content-trivial-trace}
\source{stacks:03UE}
\href{https://stacks.math.columbia.edu/tag/03UE}{\texttt{Stacks tag 03UE}}
\group{trace}

\uses{trace-lemma-weak-trace}
Let us try to illustrate the content of the formula of
Lemma \ref{trace-lemma-weak-trace}.
...
$$
Therefore, Lemma \ref{trace-lemma-weak-trace} says
$$
\text{Tr}_\Lambda (1 , P_G)
...
\begin{theorem}[Trace formula again]
\label{trace-theorem-trace-formula-again}
\source{stacks:03UG}
\href{https://stacks.math.columbia.edu/tag/03UG}{\texttt{Stacks tag 03UG}}
\group{trace}
...
Please see Remark \ref{trace-remark-on-trace-formula-again} for some remarks
...
\begin{proof}
\uses{trace-theorem-trace-formula-again, trace-lemma-trivial-trace, trace-lemma-weak-trace, trace-lemma-gamma-z-gamma-trace, trace-theorem-weil-trace-formula}
[Proof of Theorem \ref{trace-theorem-trace-formula-again}]
...
$$
\begin{array}{cc}\mathcal{V} \underset{f}{\downarrow}\longrightarrow & Y \overset{\bar f}{\downarrow} \\ \mathcal{U} \longrightarrow & X\end{array}
$$
...
equality follows from Lemma \ref{trace-lemma-trivial-trace} and the second from
Lemma \ref{trace-lemma-weak-trace}.
...
Lemma \ref{trace-lemma-gamma-z-gamma-trace},
...
\begin{remark}[On trace formula again]
\label{trace-remark-on-trace-formula-again}
\source{stacks:03UI}
\href{https://stacks.math.columbia.edu/tag/03UI}{\texttt{Stacks tag 03UI}}
\group{trace}

\uses{trace-theorem-trace-formula-again}
Remarks on Theorem \ref{trace-theorem-trace-formula-again}.
\begin{enumerate}
\item
...
\begin{remark}[Stronger]
\label{trace-remark-stronger}
\source{stacks:03UJ}
\href{https://stacks.math.columbia.edu/tag/03UJ}{\texttt{Stacks tag 03UJ}}
\group{trace}

\uses{trace-theorem-trace-formula-again, trace-theorem-weil-trace-formula}
Even though all we did are reductions and mostly algebra, the trace formula
Theorem \ref{trace-theorem-trace-formula-again} is much stronger than
Weil's geometric trace formula (Theorem \ref{trace-theorem-weil-trace-formula})
...
\begin{definition}[L adic sheaf]
\label{trace-definition-l-adic-sheaf}
\source{stacks:03UM}
\href{https://stacks.math.columbia.edu/tag/03UM}{\texttt{Stacks tag 03UM}}
\group{trace}
...
\begin{lemma}[Eventually constant]
\label{trace-lemma-eventually-constant}
\source{stacks:03UN}
\href{https://stacks.math.columbia.edu/tag/03UN}{\texttt{Stacks tag 03UN}}
\group{trace}
...
\begin{lemma}[L adic abelian]
\label{trace-lemma-l-adic-abelian}
\source{stacks:03UO}
\href{https://stacks.math.columbia.edu/tag/03UO}{\texttt{Stacks tag 03UO}}
\group{trace}
...
\begin{proof}
\uses{trace-lemma-eventually-constant}
...
Lemma \ref{trace-lemma-eventually-constant}
...
\source{stacks:03UP}
\href{https://stacks.math.columbia.edu/tag/03UP}{\texttt{Stacks tag 03UP}}
\group{trace}
...
\begin{remark}[Stalk l adic sheaf]
\label{trace-remark-stalk-l-adic-sheaf}
\source{stacks:03UQ}
\href{https://stacks.math.columbia.edu/tag/03UQ}{\texttt{Stacks tag 03UQ}}
\group{trace}
...
\begin{definition}[Torsion l adic sheaf]
\label{trace-definition-torsion-l-adic-sheaf}
\source{stacks:03UR}
\href{https://stacks.math.columbia.edu/tag/03UR}{\texttt{Stacks tag 03UR}}
\group{trace}
...
\begin{remark}[Torsion stalks]
\label{trace-remark-torsion-stalks}
\source{stacks:03US}
\href{https://stacks.math.columbia.edu/tag/03US}{\texttt{Stacks tag 03US}}
\group{trace}
...
\begin{definition}[Cohomology l adic]
\label{trace-definition-cohomology-l-adic}
\source{stacks:03UT}
\href{https://stacks.math.columbia.edu/tag/03UT}{\texttt{Stacks tag 03UT}}
\group{trace}
...
\begin{definition}[L function finite ring]
\label{trace-definition-L-function-finite-ring}
\source{stacks:03UV}
\href{https://stacks.math.columbia.edu/tag/03UV}{\texttt{Stacks tag 03UV}}
\group{trace}
...
\source{stacks:03UW}
\href{https://stacks.math.columbia.edu/tag/03UW}{\texttt{Stacks tag 03UW}}
\group{trace}
...
\begin{definition}[L function l adic]
\label{trace-definition-L-function-l-adic}
\source{stacks:03UX}
\href{https://stacks.math.columbia.edu/tag/03UX}{\texttt{Stacks tag 03UX}}
\group{trace}
...
\source{stacks:03UZ}
\href{https://stacks.math.columbia.edu/tag/03UZ}{\texttt{Stacks tag 03UZ}}
\group{trace}
...
\source{stacks:03V0}
\href{https://stacks.math.columbia.edu/tag/03V0}{\texttt{Stacks tag 03V0}}
\group{trace}
...
\begin{remark}[Which is harder]
\label{trace-remark-which-is-harder}
\source{stacks:03V1}
\href{https://stacks.math.columbia.edu/tag/03V1}{\texttt{Stacks tag 03V1}}
\group{trace}

\uses{trace-theorem-A, trace-theorem-B}
Since we have only developed some theory of traces and not of determinants,
Theorem \ref{trace-theorem-A}
is harder to prove than
Theorem \ref{trace-theorem-B}.
...
We reduce the proof of Theorem \ref{trace-theorem-B} to a trace formula. Since
...
inversion formula, we see that Theorem \ref{trace-theorem-B} is a consequence of the
following equality
$$
...
$$
which is a consequence of Theorem \ref{trace-theorem-C}.
...
\source{stacks:03V3}
\href{https://stacks.math.columbia.edu/tag/03V3}{\texttt{Stacks tag 03V3}}
\group{trace}
...
\source{stacks:03V2}
\href{https://stacks.math.columbia.edu/tag/03V2}{\texttt{Stacks tag 03V2}}
\group{trace}
...
\begin{proof}
\uses{trace-theorem-D}

We explain how to deduce this from Theorem \ref{trace-theorem-D}.
...
\begin{lemma}[Piece together]
\label{trace-lemma-piece-together}
\source{stacks:03V4}
\href{https://stacks.math.columbia.edu/tag/03V4}{\texttt{Stacks tag 03V4}}
\group{trace}
...
$$
\begin{array}{cc}{K_{n+1}^\bullet} \underset{\pi_{n+1}^\bullet}{\downarrow}\overset{\varphi_n^\bullet}{\longrightarrow} & {K_n^\bullet} \overset{\pi_n^\bullet}{\downarrow} \\ {K_{n+1}^\bullet} \underset{\varphi_n^\bullet}{\longrightarrow} & {K_n^\bullet.}\end{array}
$$
...
We use Theorem \ref{trace-theorem-B} for curves to give examples of $L$-functions
...
\frac{1}{1-T^{\deg x}}.
$$
Applying Theorem \ref{trace-theorem-B}, we get
\begin{align*}
L(X, \mathcal{F})
& =
\prod_{i = 0}^2
...
\begin{lemma}[Count points projective]
\label{trace-lemma-count-points-projective}
\source{stacks:03V8}
\href{https://stacks.math.columbia.edu/tag/03V8}{\texttt{Stacks tag 03V8}}
\group{trace}
...
Part (3) is Theorem \ref{trace-theorem-C} applied to $\mathcal{F} =
...
\source{stacks:03VE}
\href{https://stacks.math.columbia.edu/tag/03VE}{\texttt{Stacks tag 03VE}}
\group{trace}
...
\source{stacks:03VF}
\href{https://stacks.math.columbia.edu/tag/03VF}{\texttt{Stacks tag 03VF}}
\group{trace}
...
\begin{proposition}[Integral normal fundamental group]
\label{trace-proposition-integral-normal-fundamental-group}
\source{stacks:03VG}
\href{https://stacks.math.columbia.edu/tag/03VG}{\texttt{Stacks tag 03VG}}
\group{trace}
...
\source{stacks:03VH}
\href{https://stacks.math.columbia.edu/tag/03VH}{\texttt{Stacks tag 03VH}}
\group{trace}
...
\begin{lemma}[Identify h2c]
\label{trace-lemma-identify-h2c}
\source{stacks:03VK}
\href{https://stacks.math.columbia.edu/tag/03VK}{\texttt{Stacks tag 03VK}}
\group{trace}
...
\begin{proof}
\uses{trace-lemma-identify-h2c}
[Proof of Lemma \ref{trace-lemma-identify-h2c}]
...
\begin{remark}[Projective]
\label{trace-remark-projective}
\source{stacks:03VL}
\href{https://stacks.math.columbia.edu/tag/03VL}{\texttt{Stacks tag 03VL}}
\group{trace}
...
\begin{proposition}[Curve kpi1]
\label{trace-proposition-curve-kpi1}
\source{stacks:03VM}
\href{https://stacks.math.columbia.edu/tag/03VM}{\texttt{Stacks tag 03VM}}
\group{trace}
...
\begin{remark}[Poincare groups]
\label{trace-remark-poincare-groups}
\source{stacks:03VN}
\href{https://stacks.math.columbia.edu/tag/03VN}{\texttt{Stacks tag 03VN}}
\group{trace}
...
\begin{remark}[Abstract trace formula]
\label{trace-remark-abstract-trace-formula}
\source{stacks:03VP}
\href{https://stacks.math.columbia.edu/tag/03VP}{\texttt{Stacks tag 03VP}}
\group{trace}
...
\begin{example}[Commutative]
\label{trace-example-commutative}
\source{stacks:03VQ}
\href{https://stacks.math.columbia.edu/tag/03VQ}{\texttt{Stacks tag 03VQ}}
\group{trace}
...
\source{stacks:03VS}
\href{https://stacks.math.columbia.edu/tag/03VS}{\texttt{Stacks tag 03VS}}
\group{trace}
...
\begin{theorem}[Drinfeld make rho]
\label{trace-theorem-drinfeld-make-rho}
\source{stacks:03VT}
\href{https://stacks.math.columbia.edu/tag/03VT}{\texttt{Stacks tag 03VT}}
\group{trace}
...
\begin{theorem}[Drinfeld make f]
\label{trace-theorem-drinfeld-make-f}
\source{stacks:03VU}
\href{https://stacks.math.columbia.edu/tag/03VU}{\texttt{Stacks tag 03VU}}
\group{trace}
...
\begin{remark}[Lafforgue]
\label{trace-remark-lafforgue}
\source{stacks:03VV}
\href{https://stacks.math.columbia.edu/tag/03VV}{\texttt{Stacks tag 03VV}}
\group{trace}
...
\begin{proposition}[Cusp forms finite]
\label{trace-proposition-cusp-forms-finite}
\source{stacks:03VW}
\href{https://stacks.math.columbia.edu/tag/03VW}{\texttt{Stacks tag 03VW}}
\group{trace}
...
\begin{lemma}[Eigenvalues algebraic]
\label{trace-lemma-eigenvalues-algebraic}
\source{stacks:03VX}
\href{https://stacks.math.columbia.edu/tag/03VX}{\texttt{Stacks tag 03VX}}
\group{trace}
...
\begin{proof}
\uses{trace-proposition-cusp-forms-finite}

Follows from Proposition \ref{trace-proposition-cusp-forms-finite}.
\end{proof}

Combining all of the above we can do the following very useful trick.

\begin{lemma}[Switch l]
\label{trace-lemma-switch-l}
\source{stacks:03VY}
\href{https://stacks.math.columbia.edu/tag/03VY}{\texttt{Stacks tag 03VY}}
\group{trace}
...
\begin{proof}
\uses{trace-theorem-drinfeld-make-f, trace-proposition-cusp-forms-finite, trace-theorem-drinfeld-make-rho}

To prove the switching lemma use
Theorem \ref{trace-theorem-drinfeld-make-f}
to obtain $f\in C(\overline{\mathbf{Q}}_l)$ eigenform ass. to $\rho$.
Next, use
Proposition \ref{trace-proposition-cusp-forms-finite}
...
And finally we use
Theorem \ref{trace-theorem-drinfeld-make-rho}
to obtain
...
\begin{theorem}[Conjecture n 2]
\label{trace-theorem-conjecture-n-2}
\source{stacks:03VZ}
\href{https://stacks.math.columbia.edu/tag/03VZ}{\texttt{Stacks tag 03VZ}}
\group{trace}
...
\begin{theorem}[Conjecture l bigger 2n]
\label{trace-theorem-conjecture-l-bigger-2n}
\source{stacks:03W0}
\href{https://stacks.math.columbia.edu/tag/03W0}{\texttt{Stacks tag 03W0}}
\group{trace}
...
\begin{theorem}[Deformation rings]
\label{trace-theorem-deformation-rings}
\source{stacks:03W1}
\href{https://stacks.math.columbia.edu/tag/03W1}{\texttt{Stacks tag 03W1}}
\group{trace}
...
\begin{proposition}[Finite set frobenii generate topologically]
\label{trace-proposition-finite-set-frobenii-generate-topologically}
\source{stacks:03W5}
\href{https://stacks.math.columbia.edu/tag/03W5}{\texttt{Stacks tag 03W5}}
\group{trace}
