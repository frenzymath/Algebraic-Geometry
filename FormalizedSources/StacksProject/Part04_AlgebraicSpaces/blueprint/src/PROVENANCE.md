...
The part-local Lean package `StacksPart04Lib/` is a port of the corresponding Horizon
`FormalizedSources/StacksProject/Part04_AlgebraicSpaces` library. Lake metadata lives
