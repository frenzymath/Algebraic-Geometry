...
\section{{\v C}
ech cohomology of quasi-coherent sheaves}
...
\begin{lemma}[Cech cohomology quasi coherent trivial]
\label{coherent-lemma-cech-cohomology-quasi-coherent-trivial}
\source{stacks:01X9}
\href{https://stacks.math.columbia.edu/tag/01X9}{\texttt{Stacks tag 01X9}}
\group{coherent}
...
\begin{lemma}[Serre vanishing: Higher cohomology vanishes on affine schemes for quasi-coherent modules.]
\label{coherent-lemma-quasi-coherent-affine-cohomology-zero}
\source{stacks:01XB}
\href{https://stacks.math.columbia.edu/tag/01XB}{\texttt{Stacks tag 01XB}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-cech-cohomology-quasi-coherent-trivial}
...
Lemma \ref{coherent-lemma-cech-cohomology-quasi-coherent-trivial}.
\end{proof}
...
\source{stacks:01XC}
\href{https://stacks.math.columbia.edu/tag/01XC}{\texttt{Stacks tag 01XC}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-quasi-coherent-affine-cohomology-zero}
...
By Lemma \ref{coherent-lemma-quasi-coherent-affine-cohomology-zero} we conclude that
$H^i(f^{-1}(V), \mathcal{F}|_{f^{-1}(V)}) = 0$
whenever $V$ is affine. Since $S$ has a basis consisting of affine
opens we win.
\end{proof}

\begin{lemma}[Relative affine cohomology]
\label{coherent-lemma-relative-affine-cohomology}
\source{stacks:089W}
\href{https://stacks.math.columbia.edu/tag/089W}{\texttt{Stacks tag 089W}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-relative-affine-vanishing}

Follows from Lemma \ref{coherent-lemma-relative-affine-vanishing}
...
\source{stacks:0BDX}
\href{https://stacks.math.columbia.edu/tag/0BDX}{\texttt{Stacks tag 0BDX}}
\group{coherent}
...
\begin{lemma}[Cech cohomology quasi coherent]
\label{coherent-lemma-cech-cohomology-quasi-coherent}
\source{stacks:01XD}
\href{https://stacks.math.columbia.edu/tag/01XD}{\texttt{Stacks tag 01XD}}
\group{coherent}
...
\begin{lemma}[Serre's criterion for affineness.]
\label{coherent-lemma-quasi-compact-h1-zero-covering}
\source{stacks:01XF}
\href{https://stacks.math.columbia.edu/tag/01XF}{\texttt{Stacks tag 01XF}}
\group{coherent}
...
$$
\begin{array}{cccccc}0 \longrightarrow & \mathcal{F} \longrightarrow & \mathcal{O}_X^{\oplus n} \overset{f_1, \ldots, f_n}{\longrightarrow} &  & \mathcal{O}_X \longrightarrow & 0\end{array}
$$
...
$$
\begin{array}{ccc}\bigoplus\nolimits_{i = 1, \ldots, n} \Gamma(X, \mathcal{O}_X)
\overset{f_1, \ldots, f_n}{\longrightarrow} &  & \Gamma(X, \mathcal{O}_X)\end{array}
$$
...
\source{stacks:01XG}
\href{https://stacks.math.columbia.edu/tag/01XG}{\texttt{Stacks tag 01XG}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-quasi-compact-h1-zero-covering}
...
we see that Lemma \ref{coherent-lemma-quasi-compact-h1-zero-covering} applies.
\end{proof}
...
\begin{lemma}[Quasi compact h1 zero invertible]
\label{coherent-lemma-quasi-compact-h1-zero-invertible}
\source{stacks:0B5P}
\href{https://stacks.math.columbia.edu/tag/0B5P}{\texttt{Stacks tag 0B5P}}
\group{coherent}
...
Lemma \ref{coherent-lemma-quasi-compact-h1-zero-covering}.
Let $x \in X$ be a closed point. Let $U \subset X$ be an affine open
...
There is a variant of Lemma \ref{coherent-lemma-quasi-compact-h1-zero-invertible}
with finite type ideal sheaves which we will formulate and prove here if
we ever need it.

\begin{lemma}[Criterion affine morphism]
\label{coherent-lemma-criterion-affine-morphism}
\source{stacks:0F83}
\href{https://stacks.math.columbia.edu/tag/0F83}{\texttt{Stacks tag 0F83}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-quasi-coherent-affine-cohomology-zero, coherent-lemma-quasi-compact-h1-zero-covering}
...
\source{stacks:08DR}
\href{https://stacks.math.columbia.edu/tag/08DR}{\texttt{Stacks tag 08DR}}
\group{coherent}
...
\begin{lemma}[For schemes with affine diagonal, the cohomology of quasi-coherent modules vanishes in ...]
\label{coherent-lemma-vanishing-nr-affines}
\source{stacks:01XI}
\href{https://stacks.math.columbia.edu/tag/01XI}{\texttt{Stacks tag 01XI}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-quasi-coherent-affine-cohomology-zero, coherent-lemma-affine-diagonal, coherent-lemma-cech-cohomology-quasi-coherent}
...
affine opens is affine, see Lemma \ref{coherent-lemma-affine-diagonal}.
...
Lemma \ref{coherent-lemma-affine-diagonal}.
By Lemma \ref{coherent-lemma-cech-cohomology-quasi-coherent} the {\v C}ech
...
\begin{lemma}[Affine diagonal universal delta functor]
\label{coherent-lemma-affine-diagonal-universal-delta-functor}
\source{stacks:0BDY}
\href{https://stacks.math.columbia.edu/tag/0BDY}{\texttt{Stacks tag 0BDY}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-quasi-coherent-affine-cohomology-zero, coherent-lemma-relative-affine-cohomology}
...
$p > 0$ by Lemma \ref{coherent-lemma-relative-affine-cohomology}
...
\begin{lemma}[Vanishing nr affines quasi separated]
\label{coherent-lemma-vanishing-nr-affines-quasi-separated}
\source{stacks:071L}
\href{https://stacks.math.columbia.edu/tag/071L}{\texttt{Stacks tag 071L}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-vanishing-nr-affines}
...
If $n = 1$ then the result follows from Lemma \ref{coherent-lemma-vanishing-nr-affines}.
...
\begin{lemma}[Quasi coherence higher direct images]
\label{coherent-lemma-quasi-coherence-higher-direct-images}
\source{stacks:01XJ}
\href{https://stacks.math.columbia.edu/tag/01XJ}{\texttt{Stacks tag 01XJ}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-induction-principle, coherent-lemma-relative-affine-vanishing, coherent-lemma-vanishing-nr-affines-quasi-separated}
...
the prove conditions (1) and (2) of Lemma \ref{coherent-lemma-induction-principle} hold.
If $U$ is affine, then $P(U)$ holds because $R^pa_*\mathcal{F} = 0$ for
$p \geq 1$ (by  Lemma \ref{coherent-lemma-relative-affine-vanishing} and
...
\begin{lemma}[Quasi coherence higher direct images application]
\label{coherent-lemma-quasi-coherence-higher-direct-images-application}
\source{stacks:01XK}
\href{https://stacks.math.columbia.edu/tag/01XK}{\texttt{Stacks tag 01XK}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-quasi-coherence-higher-direct-images, coherent-lemma-quasi-coherent-affine-cohomology-zero}

Consider the Leray spectral sequence $E_2^{p, q} = H^p(S, R^qf_*\mathcal{F})$
converging to $H^{p + q}(X, \mathcal{F})$, see
Cohomology, Lemma \ref{cohomology-lemma-Leray}.
By Lemma \ref{coherent-lemma-quasi-coherence-higher-direct-images}
we see that the sheaves $R^qf_*\mathcal{F}$ are quasi-coherent.
By Lemma \ref{coherent-lemma-quasi-coherent-affine-cohomology-zero}
...
\vcenter{
\begin{array}{cccc}\mathcal{F}' = (g')^*\mathcal{F} & X' \underset{g'}{\longrightarrow}\underset{f'}{\downarrow} & X \overset{f}{\downarrow} & \mathcal{F} \\ Rf'_*\mathcal{F}' & S' \overset{g}{\longrightarrow} & S & Rf_*\mathcal{F}\end{array}
}
\end{equation}
Here is the simplest case of the base change property we have in mind.

\begin{lemma}[Affine base change]
\label{coherent-lemma-affine-base-change}
\source{stacks:02KG}
\href{https://stacks.math.columbia.edu/tag/02KG}{\texttt{Stacks tag 02KG}}
\group{coherent}
...
Lemma \ref{coherent-lemma-relative-affine-vanishing}.
...
\source{stacks:02KH}
\href{https://stacks.math.columbia.edu/tag/02KH}{\texttt{Stacks tag 02KH}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-quasi-coherence-higher-direct-images, coherent-lemma-quasi-coherence-higher-direct-images-application, coherent-lemma-cech-cohomology-quasi-coherent, coherent-lemma-affine-base-change}
...
(equality by
Lemma \ref{coherent-lemma-quasi-coherence-higher-direct-images-application}).
...
$$
see
Lemma \ref{coherent-lemma-cech-cohomology-quasi-coherent}.
...
$$
as follows from
Lemma \ref{coherent-lemma-affine-base-change}.
...
\source{stacks:0CKW}
\href{https://stacks.math.columbia.edu/tag/0CKW}{\texttt{Stacks tag 0CKW}}
\group{coherent}

Consider a cartesian diagram of schemes
$$
\begin{array}{cc}Y \underset{g}{\downarrow}\underset{h}{\longrightarrow} & X \overset{f}{\downarrow} \\ \Spec(B) \longrightarrow & \Spec(A)\end{array}
$$
Let $\mathcal{F}$ be a quasi-coherent $\mathcal{O}_X$-module
...
between this and Lemma \ref{coherent-lemma-flat-base-change-cohomology}.

\begin{proof}
\uses{coherent-lemma-cech-cohomology-quasi-coherent, coherent-lemma-affine-base-change}
...
\begin{lemma}[Colimit cohomology]
\label{coherent-lemma-colimit-cohomology}
\source{stacks:07TB}
\href{https://stacks.math.columbia.edu/tag/07TB}{\texttt{Stacks tag 07TB}}
\group{coherent}
...
\begin{proof}
We will apply Cohomology, Lemma
\ref{cohomology-lemma-higher-direct-image-colimit}.
Since the affine opens form a basis for the topology of $S$,
it suffices to show that for $U \subset S$ affine open we have
$H^p(f^{-1}U, \mathcal{F}) = \colim H^p(f^{-1}U, \mathcal{F}_i)$.
Since $f^{-1}U$ is quasi-compact and quasi-separated we conclude
using
Cohomology, Lemma \ref{cohomology-lemma-quasi-separated-cohomology-colimit}.
(Because the basis of affine opens in $f^{-1}U$
satisfies the assumptions of that lemma.)
\end{proof}
...
\begin{lemma}[Separated case relative cech]
\label{coherent-lemma-separated-case-relative-cech}
\source{stacks:01XL}
\href{https://stacks.math.columbia.edu/tag/01XL}{\texttt{Stacks tag 01XL}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-affine-diagonal, coherent-lemma-relative-affine-vanishing}
...
and Lemma \ref{coherent-lemma-affine-diagonal}.
Hence $R^qj_{i_0 \ldots i_p *}\mathcal{F}_{i_0 \ldots i_p}$
as well as $R^qf_{i_0 \ldots i_p *}\mathcal{F}_{i_0 \ldots i_p}$
are zero for $q > 0$ (Lemma \ref{coherent-lemma-relative-affine-vanishing}).
...
\begin{lemma}[Base change complex]
\label{coherent-lemma-base-change-complex}
\source{stacks:01XM}
\href{https://stacks.math.columbia.edu/tag/01XM}{\texttt{Stacks tag 01XM}}
\group{coherent}

\uses{coherent-lemma-separated-case-relative-cech}
With notation as in diagram (\ref{equation-base-change-diagram}).
Assume $f : X \to S$ and $\mathcal{F}$ satisfy the hypotheses of
Lemma \ref{coherent-lemma-separated-case-relative-cech}. Choose a finite
...
\begin{proof}
\uses{coherent-lemma-separated-case-relative-cech, coherent-lemma-affine-base-change}
...
Lemma \ref{coherent-lemma-separated-case-relative-cech}.
This is clear from the case of affine morphisms
(Lemma \ref{coherent-lemma-affine-base-change}) by working locally on $S'$.
...
\begin{lemma}[Hypercoverings]
\label{coherent-lemma-hypercoverings}
\source{stacks:01XN}
\href{https://stacks.math.columbia.edu/tag/01XN}{\texttt{Stacks tag 01XN}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-base-change-complex}

(If $f$ is separated as well, please see
Lemma \ref{coherent-lemma-base-change-complex}.)
...
\begin{lemma}[Base change tensor with flat]
\label{coherent-lemma-base-change-tensor-with-flat}
\source{stacks:0GN5}
\href{https://stacks.math.columbia.edu/tag/0GN5}{\texttt{Stacks tag 0GN5}}
\group{coherent}
...
\begin{lemma}[Cohomology projective space over ring]
\label{coherent-lemma-cohomology-projective-space-over-ring}
\source{stacks:01XT}
\href{https://stacks.math.columbia.edu/tag/01XT}{\texttt{Stacks tag 01XT}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-cech-cohomology-quasi-coherent, coherent-lemma-cech-cohomology-quasi-coherent-trivial}
...
This is permissible by Lemma \ref{coherent-lemma-cech-cohomology-quasi-coherent}
...
For these facts, see
Lemma \ref{coherent-lemma-cech-cohomology-quasi-coherent-trivial} and its proof.
Note that also
$\check{\mathcal{C}}_{ord}^\bullet(\mathcal{V}, \mathcal{O}_{\Spec(R)})$
...
as in the proof of Lemma \ref{coherent-lemma-cech-cohomology-quasi-coherent-trivial}
shows that
$$
...
Lemma \ref{coherent-lemma-cohomology-projective-space-over-ring} as saying that
\begin{equation}
...
\begin{lemma}[Identify functorially]
\label{coherent-lemma-identify-functorially}
\source{stacks:01XV}
\href{https://stacks.math.columbia.edu/tag/01XV}{\texttt{Stacks tag 01XV}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-cohomology-projective-space-over-ring}
...
Lemma \ref{coherent-lemma-cohomology-projective-space-over-ring}
...
\begin{lemma}[Cohomology projective space over base]
\label{coherent-lemma-cohomology-projective-space-over-base}
\source{stacks:01XW}
\href{https://stacks.math.columbia.edu/tag/01XW}{\texttt{Stacks tag 01XW}}
\group{coherent}
...
\begin{lemma}[Cohomology projective bundle]
\label{coherent-lemma-cohomology-projective-bundle}
\source{stacks:01XX}
\href{https://stacks.math.columbia.edu/tag/01XX}{\texttt{Stacks tag 01XX}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-cohomology-projective-space-over-ring, coherent-lemma-identify-functorially, coherent-lemma-cohomology-projective-space-over-base}
...
\ref{coherent-lemma-identify-functorially}, or
...
cohomology in Lemmas \ref{coherent-lemma-cohomology-projective-space-over-ring},
\ref{coherent-lemma-identify-functorially}, or
\ref{coherent-lemma-cohomology-projective-space-over-base} the statements on
...
\begin{lemma}[Coherent Noetherian]
\label{coherent-lemma-coherent-Noetherian}
\source{stacks:01XZ}
\href{https://stacks.math.columbia.edu/tag/01XZ}{\texttt{Stacks tag 01XZ}}
\group{coherent}
...
\begin{lemma}[Coherent abelian Noetherian]
\label{coherent-lemma-coherent-abelian-Noetherian}
\source{stacks:01Y0}
\href{https://stacks.math.columbia.edu/tag/01Y0}{\texttt{Stacks tag 01Y0}}
\group{coherent}
...
\begin{lemma}[Coherent Noetherian quasi coherent sub quotient]
\label{coherent-lemma-coherent-Noetherian-quasi-coherent-sub-quotient}
\source{stacks:01Y1}
\href{https://stacks.math.columbia.edu/tag/01Y1}{\texttt{Stacks tag 01Y1}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-coherent-Noetherian}

We may assume that $X$ is affine, say $X = \Spec(A)$.
Properties, Lemma \ref{properties-lemma-locally-Noetherian}
implies that $A$ is Noetherian. Lemma \ref{coherent-lemma-coherent-Noetherian}
...
\begin{lemma}[Tensor hom coherent]
\label{coherent-lemma-tensor-hom-coherent}
\source{stacks:01Y2}
\href{https://stacks.math.columbia.edu/tag/01Y2}{\texttt{Stacks tag 01Y2}}
\group{coherent}
...
\source{stacks:01Y3}
\href{https://stacks.math.columbia.edu/tag/01Y3}{\texttt{Stacks tag 01Y3}}
\group{coherent}
...
\begin{lemma}[Map stalks local map]
\label{coherent-lemma-map-stalks-local-map}
\source{stacks:01Y4}
\href{https://stacks.math.columbia.edu/tag/01Y4}{\texttt{Stacks tag 01Y4}}
\group{coherent}
...
In view of Lemma \ref{coherent-lemma-coherent-Noetherian}
this is a reformulation of
Modules, Lemma \ref{modules-lemma-stalk-internal-hom}.
\end{proof}

\begin{lemma}[Coherent support closed]
\label{coherent-lemma-coherent-support-closed}
\source{stacks:01Y5}
\href{https://stacks.math.columbia.edu/tag/01Y5}{\texttt{Stacks tag 01Y5}}
\group{coherent}
...
Lemma \ref{coherent-lemma-coherent-Noetherian}
\end{proof}

\begin{lemma}[I star equivalence]
\label{coherent-lemma-i-star-equivalence}
\source{stacks:087T}
\href{https://stacks.math.columbia.edu/tag/087T}{\texttt{Stacks tag 087T}}
\group{coherent}
...
\begin{lemma}[Finite pushforward coherent]
\label{coherent-lemma-finite-pushforward-coherent}
\source{stacks:01Y6}
\href{https://stacks.math.columbia.edu/tag/01Y6}{\texttt{Stacks tag 01Y6}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-relative-affine-vanishing, coherent-lemma-coherent-Noetherian}

The higher direct images vanish by
Lemma \ref{coherent-lemma-relative-affine-vanishing} and because
...
\begin{lemma}[Coherent support dimension 0]
\label{coherent-lemma-coherent-support-dimension-0}
\source{stacks:0B3J}
\href{https://stacks.math.columbia.edu/tag/0B3J}{\texttt{Stacks tag 0B3J}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-coherent-support-closed, coherent-lemma-quasi-coherent-affine-cohomology-zero, coherent-lemma-relative-affine-cohomology}

By Lemma \ref{coherent-lemma-coherent-support-closed} we see that
...
(Lemma \ref{coherent-lemma-relative-affine-cohomology} applies as a
closed immersion is affine)
we conclude that the higher cohomology groups of $\mathcal{F}$ are zero.
\end{proof}

\begin{lemma}[Pushforward coherent on open]
\label{coherent-lemma-pushforward-coherent-on-open}
\source{stacks:0CYJ}
\href{https://stacks.math.columbia.edu/tag/0CYJ}{\texttt{Stacks tag 0CYJ}}
\group{coherent}
...
\begin{lemma}[Acc coherent]
\label{coherent-lemma-acc-coherent}
\source{stacks:01Y8}
\href{https://stacks.math.columbia.edu/tag/01Y8}{\texttt{Stacks tag 01Y8}}
\group{coherent}
...
\begin{lemma}[Power ideal kills sheaf]
\label{coherent-lemma-power-ideal-kills-sheaf}
\source{stacks:01Y9}
\href{https://stacks.math.columbia.edu/tag/01Y9}{\texttt{Stacks tag 01Y9}}
\group{coherent}
...
\source{stacks:01YA}
\href{https://stacks.math.columbia.edu/tag/01YA}{\texttt{Stacks tag 01YA}}
\group{coherent}
...
\begin{lemma}[Directed colimit coherent]
\label{coherent-lemma-directed-colimit-coherent}
\source{stacks:0GN6}
\href{https://stacks.math.columbia.edu/tag/0GN6}{\texttt{Stacks tag 0GN6}}
\group{coherent}
...
\begin{lemma}[Homs over open]
\label{coherent-lemma-homs-over-open}
\source{stacks:01YB}
\href{https://stacks.math.columbia.edu/tag/01YB}{\texttt{Stacks tag 01YB}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-coherent-Noetherian, coherent-lemma-acc-coherent, coherent-lemma-Artin-Rees}
...
Properties, Lemma \ref{properties-lemma-quasi-coherent-colimit-finite-type}
(and Lemma \ref{coherent-lemma-coherent-Noetherian})
...
$\mathcal{F}_n = \mathcal{F}_{n + 1} = \ldots $ for some $n \geq 0$
by Lemma \ref{coherent-lemma-acc-coherent}. Set $\mathcal{H} = \mathcal{F}_n$
for this $n$. By Artin-Rees (Lemma \ref{coherent-lemma-Artin-Rees})
...
$$
\begin{array}{cc}\colim_n \Hom_{\mathcal{O}_X}(
\mathcal{I}^n, \mathcal{F}')
\longrightarrow\downarrow & \Gamma(U, \mathcal{F}') \downarrow \\ \colim_n \Hom_{\mathcal{O}_X}(
\mathcal{I}^n, \mathcal{F})
\longrightarrow & \Gamma(U, \mathcal{F})\end{array}
$$
...
By Lemma \ref{coherent-lemma-coherent-Noetherian} the sheaf $\mathcal{G}$
...
\begin{lemma}[Extend coherent]
\label{coherent-lemma-extend-coherent}
\source{stacks:0FD0}
\href{https://stacks.math.columbia.edu/tag/0FD0}{\texttt{Stacks tag 0FD0}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-homs-over-open}
...
If $X$ is Noetherian, then Lemma \ref{coherent-lemma-homs-over-open} tells us that
...
\source{stacks:0341}
\href{https://stacks.math.columbia.edu/tag/0341}{\texttt{Stacks tag 0341}}
\group{coherent}
...
\begin{lemma}[Hom into depth]
\label{coherent-lemma-hom-into-depth}
\source{stacks:0EBC}
\href{https://stacks.math.columbia.edu/tag/0EBC}{\texttt{Stacks tag 0EBC}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-tensor-hom-coherent, coherent-lemma-coherent-Noetherian}

Observe that $\SheafHom_{\mathcal{O}_X}(\mathcal{F}, \mathcal{G})$ is
a coherent $\mathcal{O}_X$-module by Lemma \ref{coherent-lemma-tensor-hom-coherent}.
Coherent modules are of finite presentation
(Lemma \ref{coherent-lemma-coherent-Noetherian}) hence taking stalks commutes
...
\begin{lemma}[Hom into S2]
\label{coherent-lemma-hom-into-S2}
\source{stacks:0AXQ}
\href{https://stacks.math.columbia.edu/tag/0AXQ}{\texttt{Stacks tag 0AXQ}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-hom-into-depth}

Follows immediately from Lemma \ref{coherent-lemma-hom-into-depth}
and the definitions.
\end{proof}
...
\source{stacks:0343}
\href{https://stacks.math.columbia.edu/tag/0343}{\texttt{Stacks tag 0343}}
\group{coherent}
...
\begin{lemma}[Cohen Macaulay over regular]
\label{coherent-lemma-Cohen-Macaulay-over-regular}
\source{stacks:0B3K}
\href{https://stacks.math.columbia.edu/tag/0B3K}{\texttt{Stacks tag 0B3K}}
\group{coherent}
...
\begin{lemma}[Prepare filter support]
\label{coherent-lemma-prepare-filter-support}
\source{stacks:01YD}
\href{https://stacks.math.columbia.edu/tag/01YD}{\texttt{Stacks tag 01YD}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-power-ideal-kills-sheaf}
...
is a Noetherian scheme. Hence by Lemma \ref{coherent-lemma-power-ideal-kills-sheaf}
...
\begin{lemma}[Prepare filter irreducible]
\label{coherent-lemma-prepare-filter-irreducible}
\source{stacks:01YE}
\href{https://stacks.math.columbia.edu/tag/01YE}{\texttt{Stacks tag 01YE}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-local-isomorphism, coherent-lemma-i-star-equivalence, coherent-lemma-map-stalks-local-map, coherent-lemma-homs-over-open}
...
Properties, Lemma \ref{properties-lemma-sections-annihilated-by-ideal}.
By Lemma \ref{coherent-lemma-local-isomorphism} we see that
...
Lemma \ref{coherent-lemma-i-star-equivalence} we can write
...
By Lemma \ref{coherent-lemma-map-stalks-local-map} there exists a nonempty
...
Lemma \ref{coherent-lemma-local-isomorphism}.
By Schemes, Lemma \ref{schemes-lemma-reduced-closed-subscheme}
there exists a quasi-coherent sheaf of ideals
$\mathcal{I} \subset \mathcal{O}_X$
whose associated closed subscheme $Y \subset X$ is the complement
of $U$.
By Lemma \ref{coherent-lemma-homs-over-open} there exists an $n \geq 0$ and a morphism
...
\begin{lemma}[Coherent filter]
\label{coherent-lemma-coherent-filter}
\source{stacks:01YF}
\href{https://stacks.math.columbia.edu/tag/01YF}{\texttt{Stacks tag 01YF}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-prepare-filter-support, coherent-lemma-power-ideal-kills-sheaf, coherent-lemma-prepare-filter-irreducible}
...
Then we can apply Lemma \ref{coherent-lemma-prepare-filter-support}
...
By Lemma \ref{coherent-lemma-power-ideal-kills-sheaf} we see there exists
...
we can apply Lemma \ref{coherent-lemma-prepare-filter-irreducible}.
...
\begin{lemma}[Property initial]
\label{coherent-lemma-property-initial}
\source{stacks:01YG}
\href{https://stacks.math.columbia.edu/tag/01YG}{\texttt{Stacks tag 01YG}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-coherent-filter}
...
On the other hand, by Lemma \ref{coherent-lemma-coherent-filter}
we can filter any $\mathcal{F}$
with successive subquotients as in (2).
Hence the lemma follows.
\end{proof}

\begin{lemma}[Property irreducible]
\label{coherent-lemma-property-irreducible}
\source{stacks:01YH}
\href{https://stacks.math.columbia.edu/tag/01YH}{\texttt{Stacks tag 01YH}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-coherent-filter, coherent-lemma-prepare-filter-irreducible}
...
sheaf has a filtration (see Lemma \ref{coherent-lemma-coherent-filter})
whose subquotients have property $\mathcal{P}$ according to (2).

\medskip\noindent
Let $\mathcal{G}$ be as in (3). By Lemma \ref{coherent-lemma-prepare-filter-irreducible}
...
(see Lemma \ref{coherent-lemma-coherent-filter} again) whose subquotients
all have property $\mathcal{P}$ by what we just said.
\end{proof}

\begin{lemma}[Property]
\label{coherent-lemma-property}
\source{stacks:01YI}
\href{https://stacks.math.columbia.edu/tag/01YI}{\texttt{Stacks tag 01YI}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-property-initial, coherent-lemma-property-irreducible}

According to Lemma \ref{coherent-lemma-property-initial} it suffices to show that
...
Lemma \ref{coherent-lemma-property-irreducible} this cannot happen.
\end{proof}

\begin{lemma}[Property irreducible higher rank cohomological]
\label{coherent-lemma-property-irreducible-higher-rank-cohomological}
\source{stacks:01YL}
\href{https://stacks.math.columbia.edu/tag/01YL}{\texttt{Stacks tag 01YL}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-coherent-filter, coherent-lemma-prepare-filter-irreducible, coherent-lemma-power-ideal-kills-sheaf}
...
By Lemma \ref{coherent-lemma-prepare-filter-irreducible}
...
Lemma \ref{coherent-lemma-power-ideal-kills-sheaf}
...
\begin{lemma}[Property higher rank cohomological]
\label{coherent-lemma-property-higher-rank-cohomological}
\source{stacks:01YM}
\href{https://stacks.math.columbia.edu/tag/01YM}{\texttt{Stacks tag 01YM}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-property-irreducible-higher-rank-cohomological, coherent-lemma-property, coherent-lemma-property-irreducible}

Follows from Lemma \ref{coherent-lemma-property-irreducible-higher-rank-cohomological}
in exactly the same way that Lemma \ref{coherent-lemma-property} follows from
Lemma \ref{coherent-lemma-property-irreducible}.
\end{proof}
...
\begin{lemma}[Finite morphism Noetherian]
\label{coherent-lemma-finite-morphism-Noetherian}
\source{stacks:01YO}
\href{https://stacks.math.columbia.edu/tag/01YO}{\texttt{Stacks tag 01YO}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-finite-pushforward-coherent}
...
$$
\begin{array}{cc}Z' \underset{i'}{\longrightarrow}\underset{f'}{\downarrow} & Y \overset{f}{\downarrow} \\ Z \overset{i}{\longrightarrow} & X\end{array}
$$
...
\begin{lemma}[Affine morphism projection ideal]
\label{coherent-lemma-affine-morphism-projection-ideal}
\source{stacks:01YP}
\href{https://stacks.math.columbia.edu/tag/01YP}{\texttt{Stacks tag 01YP}}
\group{coherent}
...
\begin{lemma}[Image affine finite morphism affine Noetherian]
\label{coherent-lemma-image-affine-finite-morphism-affine-Noetherian}
\source{stacks:01YQ}
\href{https://stacks.math.columbia.edu/tag/01YQ}{\texttt{Stacks tag 01YQ}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-quasi-compact-h1-zero-covering, coherent-lemma-quasi-separated-h1-zero-covering, coherent-lemma-property-higher-rank-cohomological, coherent-lemma-finite-morphism-Noetherian, coherent-lemma-affine-morphism-projection-ideal, coherent-lemma-quasi-coherent-affine-cohomology-zero, coherent-lemma-relative-affine-cohomology}
...
Lemma \ref{coherent-lemma-quasi-compact-h1-zero-covering} or
Lemma \ref{coherent-lemma-quasi-separated-h1-zero-covering}.
...
$$
We are going to apply Lemma \ref{coherent-lemma-property-higher-rank-cohomological}.
...
and $(f_*\mathcal{F})_\xi$ is annihilated by $\mathfrak m_\xi$,
see Lemma \ref{coherent-lemma-finite-morphism-Noetherian}. We claim that
taking $\mathcal{G} = f_*\mathcal{F}$ works. We only have to verify
part (3)(c) of Lemma \ref{coherent-lemma-property-higher-rank-cohomological}.
...
Lemma \ref{coherent-lemma-affine-morphism-projection-ideal} we see that
$\mathcal{J}\mathcal{G} = f_*(f^{-1}\mathcal{J}\mathcal{F})$.
Also, as pointed out in the proof of
Lemma \ref{coherent-lemma-affine-morphism-projection-ideal} the sheaf
...
see Lemma \ref{coherent-lemma-quasi-coherent-affine-cohomology-zero}.
...
$$
by Lemma \ref{coherent-lemma-relative-affine-cohomology}.
Hence the quasi-coherent subsheaf $\mathcal{G}' = \mathcal{J}\mathcal{G}$
satisfies $\mathcal{P}$. This verifies property (3)(c) of
Lemma \ref{coherent-lemma-property-higher-rank-cohomological} as desired.
\end{proof}
...
\begin{lemma}[Coherent projective]
\label{coherent-lemma-coherent-projective}
\source{stacks:01YS}
\href{https://stacks.math.columbia.edu/tag/01YS}{\texttt{Stacks tag 01YS}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-coherent-Noetherian, coherent-lemma-vanishing-nr-affines, coherent-lemma-coherent-abelian-Noetherian, coherent-lemma-cohomology-projective-space-over-ring}
...
space over $R$ by Lemma \ref{coherent-lemma-coherent-Noetherian}. Thus we see (1).
...
see Lemma \ref{coherent-lemma-vanishing-nr-affines}. Hence (2) holds.
...
\mathcal{F} \to 0
$$
By Lemma \ref{coherent-lemma-coherent-abelian-Noetherian}
...
Lemma \ref{coherent-lemma-cohomology-projective-space-over-ring} the left
...
R[T_0, \ldots, T_n](d_j)
$$
by our computations in Section \ref{coherent-section-cohomology-projective-space}.
In particular it is finitely generated.
Suppose $k \in \mathbf{Z}$ is arbitrary.
Choose $k_{-} \ll k \ll k_{+}$.
Consider the diagram
$$
\begin{array}{cc}N_{k_{-}} & N_{k_{+}} \downarrow\longleftarrow \\ M_k & M_{k_{+}} \longleftarrow\end{array}
$$
...
\begin{lemma}[Coherent on proj]
\label{coherent-lemma-coherent-on-proj}
\source{stacks:0AG6}
\href{https://stacks.math.columbia.edu/tag/0AG6}{\texttt{Stacks tag 0AG6}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-coherent-projective, coherent-lemma-i-star-equivalence, coherent-lemma-relative-affine-cohomology}
...
results of Lemma \ref{coherent-lemma-coherent-projective} for the coherent sheaf
$i_*\mathcal{F}$ (Lemma \ref{coherent-lemma-i-star-equivalence}) on
...
\begin{lemma}[Recover tail graded module]
\label{coherent-lemma-recover-tail-graded-module}
\source{stacks:0AG7}
\href{https://stacks.math.columbia.edu/tag/0AG7}{\texttt{Stacks tag 0AG7}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-coherent-on-proj}
...
Set $N = \bigoplus_{n \in \mathbf{Z}} \Gamma(X, \widetilde{M}(n))$.
...
$$
\begin{array}{ccc}M_n \downarrow\longrightarrow & N_n \downarrow\searrow &  \\ \Gamma(X, \widetilde{M}(n)) \longrightarrow & \Gamma(X, \widetilde{N}(n)) \overset{\cong}{\longrightarrow} & \Gamma(X, \widetilde{M}(n))\end{array}
$$
...
$N' = \bigoplus_{n \geq 0} N_n$ is finitely generated by
the last part of Lemma \ref{coherent-lemma-coherent-on-proj}.
Hence $K' = \bigoplus_{n \geq 0} K_n$ and
...
\begin{proposition}[Coherent modules on proj]
\label{coherent-proposition-coherent-modules-on-proj}
\source{stacks:0BXD}
\href{https://stacks.math.columbia.edu/tag/0BXD}{\texttt{Stacks tag 0BXD}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-coherent-on-proj, coherent-lemma-recover-tail-graded-module}
...
\medskip\noindent
By Lemma \ref{coherent-lemma-coherent-on-proj} the proposed quasi-inverse
...
\medskip\noindent
By Lemma \ref{coherent-lemma-recover-tail-graded-module}
...
\begin{lemma}[Coherent on proj general]
\label{coherent-lemma-coherent-on-proj-general}
\source{stacks:0B5Q}
\href{https://stacks.math.columbia.edu/tag/0B5Q}{\texttt{Stacks tag 0B5Q}}
\group{coherent}
...
Lemma \ref{coherent-lemma-coherent-on-proj}.
...
Thus Lemma \ref{coherent-lemma-coherent-on-proj} applies to $X' = \text{Proj}(A')$.
...
Thus Lemma \ref{coherent-lemma-coherent-on-proj} implies $X$ is Noetherian and that
...
Lemma \ref{coherent-lemma-coherent-on-proj}. Since there are only a finite number
...
is a finite $A'$-module by Lemma \ref{coherent-lemma-coherent-on-proj}. Using
...
\begin{lemma}[Recover tail graded module general]
\label{coherent-lemma-recover-tail-graded-module-general}
\source{stacks:0B5R}
\href{https://stacks.math.columbia.edu/tag/0B5R}{\texttt{Stacks tag 0B5R}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-coherent-on-proj-general}
...
$\widetilde{M}$ is a finite type $\mathcal{O}_X$-module,
i.e., a coherent $\mathcal{O}_X$-module.
Thus part (2) follows from Lemma \ref{coherent-lemma-coherent-on-proj-general}.
...
\begin{proposition}[Coherent modules on proj general]
\label{coherent-proposition-coherent-modules-on-proj-general}
\source{stacks:0BXF}
\href{https://stacks.math.columbia.edu/tag/0BXF}{\texttt{Stacks tag 0BXF}}
\group{coherent}
...
\begin{proof}
\uses{coherent-proposition-coherent-modules-on-proj, coherent-lemma-recover-tail-graded-module-general, coherent-lemma-coherent-on-proj-general}
...
Lemma \ref{coherent-lemma-recover-tail-graded-module-general}.
...
\medskip\noindent
By Lemma \ref{coherent-lemma-coherent-on-proj-general} the proposed quasi-inverse
makes sense. Namely, the lemma shows that
$\mathcal{F} \longmapsto \bigoplus_{n \geq 0} \Gamma(X, \mathcal{F}(n))$
is a functor $\textit{Coh}(\mathcal{O}_X) \to \text{Mod}^{fg}_A$
which we can compose with the quotient functor
...
\medskip\noindent
By Lemma \ref{coherent-lemma-recover-tail-graded-module-general}
the composite left to right to left is isomorphic to the identity functor.
...
\begin{lemma}[Coherent proper ample]
\label{coherent-lemma-coherent-proper-ample}
\source{stacks:0B5T}
\href{https://stacks.math.columbia.edu/tag/0B5T}{\texttt{Stacks tag 0B5T}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-relative-affine-cohomology, coherent-lemma-i-star-equivalence, coherent-lemma-coherent-projective}
...
(by Lemma \ref{coherent-lemma-relative-affine-cohomology} and the fact that
...
is coherent as well (Lemma \ref{coherent-lemma-i-star-equivalence}).
...
is a finite graded $S$-module by Lemma \ref{coherent-lemma-coherent-projective}.
Since
...
\medskip\noindent
Proof of (3). Apply Lemma \ref{coherent-lemma-coherent-projective}
...
\mathcal{O}_{\mathbf{P}^n_R}(n)
$$
for all $n \in \mathbf{Z}$. By Lemma \ref{coherent-lemma-coherent-projective}
...
\begin{lemma}[Kill by twisting]
\label{coherent-lemma-kill-by-twisting}
\source{stacks:02O1}
\href{https://stacks.math.columbia.edu/tag/02O1}{\texttt{Stacks tag 02O1}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-quasi-coherence-higher-direct-images-application, coherent-lemma-coherent-proper-ample}
...
from Lemma \ref{coherent-lemma-coherent-proper-ample} (which applies because
$\mathcal{L}$ is ample on $X$ by Morphisms, Lemma
\ref{morphisms-lemma-finite-type-over-affine-ample-very-ample}).
\end{proof}

\begin{lemma}[Locally projective pushforward]
\label{coherent-lemma-locally-projective-pushforward}
\source{stacks:02O4}
\href{https://stacks.math.columbia.edu/tag/02O4}{\texttt{Stacks tag 02O4}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-quasi-coherence-higher-direct-images, coherent-lemma-quasi-coherence-higher-direct-images-application, coherent-lemma-coherent-Noetherian, coherent-lemma-coherent-proper-ample}
...
(Morphisms, Lemma \ref{morphisms-lemma-finite-type-noetherian})
and hence the statement makes sense.
Moreover, by Lemma \ref{coherent-lemma-quasi-coherence-higher-direct-images}
...
are finite $R$-modules (Lemma \ref{coherent-lemma-coherent-Noetherian}).
This follows from Lemma \ref{coherent-lemma-coherent-proper-ample}
...
\begin{lemma}[Vanshing gives ample]
\label{coherent-lemma-vanshing-gives-ample}
\source{stacks:0B5U}
\href{https://stacks.math.columbia.edu/tag/0B5U}{\texttt{Stacks tag 0B5U}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-coherent-proper-ample, coherent-lemma-quasi-compact-h1-zero-invertible}

The implication (1) $\Rightarrow$ (2) follows from
Lemma \ref{coherent-lemma-coherent-proper-ample}.
The implication (2) $\Rightarrow$ (3) is trivial.
The implication (3) $\Rightarrow$ (1) is
Lemma \ref{coherent-lemma-quasi-compact-h1-zero-invertible}.
\end{proof}

\begin{lemma}[Surjective finite morphism ample]
\label{coherent-lemma-surjective-finite-morphism-ample}
\source{stacks:0B5V}
\href{https://stacks.math.columbia.edu/tag/0B5V}{\texttt{Stacks tag 0B5V}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-vanshing-gives-ample, coherent-lemma-property-higher-rank-cohomological, coherent-lemma-finite-morphism-Noetherian, coherent-lemma-affine-morphism-projection-ideal, coherent-lemma-relative-affine-cohomology}
...
$\mathcal{L}$ is ample by Lemma \ref{coherent-lemma-vanshing-gives-ample}.
We are going to apply Lemma \ref{coherent-lemma-property-higher-rank-cohomological}.
...
As $\mathcal{L}$ is ample we see from Lemma \ref{coherent-lemma-vanshing-gives-ample}
...
Lemma \ref{coherent-lemma-relative-affine-cohomology}.
Hence the quasi-coherent subsheaf $\mathcal{G}' = \mathcal{J}\mathcal{G}$
...
\begin{lemma}[Invert s cohomology]
\label{coherent-lemma-invert-s-cohomology}
\source{stacks:09MR}
\href{https://stacks.math.columbia.edu/tag/09MR}{\texttt{Stacks tag 09MR}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-induction-principle, coherent-lemma-quasi-coherent-affine-cohomology-zero}
...
principle (Lemma \ref{coherent-lemma-induction-principle}) where for
...
$$
\begin{array}{ccc}H^{p - 1}_*(U \cap V, \mathcal{L}, \mathcal{F})_{(s)} \longrightarrow\downarrow & H^p_*(U \cup V, \mathcal{L}, \mathcal{F})_{(s)} \longrightarrow\downarrow & H^p_*(U, \mathcal{L}, \mathcal{F})_{(s)}
\oplus
H^p_*(V, \mathcal{L}, \mathcal{F})_{(s)} \downarrow \\ H^{p - 1}(U_s \cap V_s, \mathcal{F}) \longrightarrow & H^p(U_s \cup V_s, \mathcal{F}) \longrightarrow & H^p(U_s, \mathcal{F})
\oplus
H^p(V_s, \mathcal{F})\end{array}
$$
...
\begin{lemma}[Section affine open kills classes]
\label{coherent-lemma-section-affine-open-kills-classes}
\source{stacks:01XR}
\href{https://stacks.math.columbia.edu/tag/01XR}{\texttt{Stacks tag 01XR}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-quasi-coherent-affine-cohomology-zero, coherent-lemma-invert-s-cohomology}

Recall that $H^p(X_s, \mathcal{G})$ is zero for every quasi-coherent
module $\mathcal{G}$ by
Lemma \ref{coherent-lemma-quasi-coherent-affine-cohomology-zero}.
Hence the lemma follows from
Lemma \ref{coherent-lemma-invert-s-cohomology}.
\end{proof}

For a more general version of the following lemma see
Limits, Lemma \ref{limits-lemma-ample-on-reduction}.

\begin{lemma}[Ample on reduction]
\label{coherent-lemma-ample-on-reduction}
\source{stacks:09MS}
\href{https://stacks.math.columbia.edu/tag/09MS}{\texttt{Stacks tag 09MS}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-power-ideal-kills-sheaf, coherent-lemma-section-affine-open-kills-classes, coherent-lemma-image-affine-finite-morphism-affine-Noetherian}
...
\mathcal{I}$. Then each of the closed immersions $Z_{i - 1} \to Z_{i}$
...
Lemma \ref{coherent-lemma-section-affine-open-kills-classes}
...
$X_s$ is affine by
Lemma \ref{coherent-lemma-image-affine-finite-morphism-affine-Noetherian} and
...
\begin{lemma}[Thickening quasi affine]
\label{coherent-lemma-thickening-quasi-affine}
\source{stacks:0B7K}
\href{https://stacks.math.columbia.edu/tag/0B7K}{\texttt{Stacks tag 0B7K}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-ample-on-reduction}
...
Lemma \ref{coherent-lemma-ample-on-reduction}, hence
...
\begin{lemma}[Affine in presence ample]
\label{coherent-lemma-affine-in-presence-ample}
\source{stacks:0EBD}
\href{https://stacks.math.columbia.edu/tag/0EBD}{\texttt{Stacks tag 0EBD}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-quasi-compact-h1-zero-covering, coherent-lemma-vanishing-nr-affines}
...
by Lemma \ref{coherent-lemma-quasi-compact-h1-zero-covering}.
...
Lemma \ref{coherent-lemma-vanishing-nr-affines}. Thus we may use descending
...
\begin{lemma}[Affine if quasi affine]
\label{coherent-lemma-affine-if-quasi-affine}
\source{stacks:0EBE}
\href{https://stacks.math.columbia.edu/tag/0EBE}{\texttt{Stacks tag 0EBE}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-affine-in-presence-ample}

Since $\mathcal{O}_X$ is ample by
Properties, Lemma \ref{properties-lemma-quasi-affine-O-ample}
this follows from Lemma \ref{coherent-lemma-affine-in-presence-ample}.
\end{proof}

\section{Chow's Lemma}
\label{coherent-section-chows-lemma}
In this section we prove Chow's lemma in the Noetherian
case (Lemma \ref{coherent-lemma-chow-Noetherian}).
In
...
\source{stacks:0200}
\href{https://stacks.math.columbia.edu/tag/0200}{\texttt{Stacks tag 0200}}
\group{coherent}
...
$$
\begin{array}{ccc}X \searrow & X' \downarrow\overset{\pi}{\longleftarrow}\longrightarrow & \mathbf{P}^n_S \swarrow \\  & S & \end{array}
$$
...
$$
\begin{array}{cc}V_i \longrightarrow\underset{p_i|_{V_i}}{\searrow} & \pi^{-1}(U_i) \downarrow \\  & U_i\end{array}
$$
...
$$
\begin{array}{cc}U \longrightarrow\searrow & \pi^{-1}(U) \downarrow \\  & U\end{array}
$$
...
\source{stacks:0201}
\href{https://stacks.math.columbia.edu/tag/0201}{\texttt{Stacks tag 0201}}
\group{coherent}

\uses{coherent-lemma-chow-Noetherian}
In the situation of Chow's
Lemma \ref{coherent-lemma-chow-Noetherian}:
\begin{enumerate}
...
\begin{proposition}[Proper pushforward coherent]
\label{coherent-proposition-proper-pushforward-coherent}
\source{stacks:02O5}
\href{https://stacks.math.columbia.edu/tag/02O5}{\texttt{Stacks tag 02O5}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-property, coherent-lemma-coherent-abelian-Noetherian, coherent-lemma-coherent-Noetherian-quasi-coherent-sub-quotient, coherent-lemma-finite-pushforward-coherent, coherent-lemma-chow-Noetherian, coherent-remark-chow-Noetherian, coherent-lemma-kill-by-twisting, coherent-lemma-locally-projective-pushforward}
...
Lemma \ref{coherent-lemma-property} to prove that
...
Lemma \ref{coherent-lemma-coherent-abelian-Noetherian} and
...
\medskip\noindent
We can apply Chow's Lemma \ref{coherent-lemma-chow-Noetherian}
to the morphism $Z \to S$. Thus we get a diagram
$$
\begin{array}{ccc}Z \underset{g}{\searrow} & Z' \overset{g'}{\downarrow}\overset{\pi}{\longleftarrow}\underset{i}{\longrightarrow} & \mathbf{P}^m_S \swarrow \\  & S & \end{array}
$$
...
By the discussion in Remark \ref{coherent-remark-chow-Noetherian} we see that
...
Hence by Lemma \ref{coherent-lemma-kill-by-twisting}
...
Lemma \ref{coherent-lemma-locally-projective-pushforward}
we see that $g_*\mathcal{G} = (g')_*\mathcal{L}^{\otimes n}$ is
coherent as desired.
\end{proof}

\begin{lemma}[Proper over affine cohomology finite]
\label{coherent-lemma-proper-over-affine-cohomology-finite}
\source{stacks:02O6}
\href{https://stacks.math.columbia.edu/tag/02O6}{\texttt{Stacks tag 02O6}}
\group{coherent}

Let $S = \Spec(A)$ with $A$ a Noetherian ring.
Let $f : X \to S$ be a proper morphism.
Let $\mathcal{F}$ be a coherent $\mathcal{O}_X$-module.
Then $H^i(X, \mathcal{F})$ is a finite $A$-module for all $i \geq 0$.
\end{lemma}

\begin{proof}
\uses{coherent-proposition-proper-pushforward-coherent, coherent-lemma-quasi-coherence-higher-direct-images, coherent-lemma-quasi-coherence-higher-direct-images-application, coherent-lemma-coherent-Noetherian}

This is just the affine case of
Proposition \ref{coherent-proposition-proper-pushforward-coherent}.
Namely, by Lemmas \ref{coherent-lemma-quasi-coherence-higher-direct-images} and
\ref{coherent-lemma-quasi-coherence-higher-direct-images-application} we know that
$R^if_*\mathcal{F}$ is the quasi-coherent sheaf associated
to the $A$-module $H^i(X, \mathcal{F})$
and by Lemma \ref{coherent-lemma-coherent-Noetherian} this is
a coherent sheaf if and only if $H^i(X, \mathcal{F})$
is an $A$-module of finite type.
\end{proof}

\begin{lemma}[Graded finiteness]
\label{coherent-lemma-graded-finiteness}
\source{stacks:0897}
\href{https://stacks.math.columbia.edu/tag/0897}{\texttt{Stacks tag 0897}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-coherent-Noetherian, coherent-lemma-relative-affine-cohomology, coherent-lemma-proper-over-affine-cohomology-finite, coherent-lemma-kill-by-twisting}

To prove this we consider the fibre product diagram
$$
\begin{array}{cc}X' = \Spec(B) \times_{\Spec(A)} X
\underset{\pi}{\longrightarrow}\underset{f'}{\downarrow} & X \overset{f}{\downarrow} \\ \Spec(B) \longrightarrow & \Spec(A)\end{array}
$$
...
by Lemma \ref{coherent-lemma-relative-affine-cohomology}.
Thus (1) follows from
Lemma \ref{coherent-lemma-proper-over-affine-cohomology-finite}.
...
Lemma \ref{coherent-lemma-kill-by-twisting}.
\end{proof}
...
\begin{lemma}[Cohomology powers ideal times F]
\label{coherent-lemma-cohomology-powers-ideal-times-F}
\source{stacks:02O8}
\href{https://stacks.math.columbia.edu/tag/02O8}{\texttt{Stacks tag 02O8}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-graded-finiteness}

Let $\mathcal{B} = f^*\widetilde{B}$. Since $\mathcal{B}$ surjects
onto $\bigoplus I^n\mathcal{O}_X$ it is clear that
$\bigoplus I^n\mathcal{F}$ is a finite type graded $\mathcal{B}$-module.
Hence the result follows from Lemma \ref{coherent-lemma-graded-finiteness} part (1).
\end{proof}

\begin{lemma}[Cohomology powers ideal times sheaf]
\label{coherent-lemma-cohomology-powers-ideal-times-sheaf}
\source{stacks:02O9}
\href{https://stacks.math.columbia.edu/tag/02O9}{\texttt{Stacks tag 02O9}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-cohomology-powers-ideal-times-F}

The statement is local on $Y$, hence this reduces to the
case where $Y$ is affine. In the affine case the result follows
from Lemma \ref{coherent-lemma-cohomology-powers-ideal-times-F}.
Details omitted.
\end{proof}

\begin{lemma}[Cohomology powers ideal application]
\label{coherent-lemma-cohomology-powers-ideal-application}
\source{stacks:02OA}
\href{https://stacks.math.columbia.edu/tag/02OA}{\texttt{Stacks tag 02OA}}
\group{coherent}
...
Lemma \ref{coherent-lemma-cohomology-powers-ideal-times-F}.
...
that the diagrams
$$
\begin{array}{cc}B_n \otimes_A M_m \longrightarrow\downarrow & M_{n + m} \downarrow \\ B_n \otimes_A M_{m'} \longrightarrow & M_{n + m'}\end{array}
$$
...
$$
\begin{array}{ccc}I^n \otimes_A M_0 \longrightarrow\downarrow & I^nM_0 \longrightarrow\downarrow & M_0 \downarrow \\ M_n \longrightarrow & M_{n - c} \longrightarrow & M_0\end{array}
$$
...
In the situation of Lemmas \ref{coherent-lemma-cohomology-powers-ideal-times-F} and
\ref{coherent-lemma-cohomology-powers-ideal-application} consider the inverse
system
$$
...
\begin{lemma}[ML cohomology powers ideal]
\label{coherent-lemma-ML-cohomology-powers-ideal}
\source{stacks:02OB}
\href{https://stacks.math.columbia.edu/tag/02OB}{\texttt{Stacks tag 02OB}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-cohomology-powers-ideal-application}

Let $c = \max\{c_p, c_{p + 1}\}$, where $c_p, c_{p + 1}$ are the integers
found in Lemma \ref{coherent-lemma-cohomology-powers-ideal-application} for
$H^p$ and $H^{p + 1}$.
...
$$
Hence by Lemma \ref{coherent-lemma-cohomology-powers-ideal-application} part (2)
...
$$
\begin{array}{ccccc}0 \longrightarrow & I^n\mathcal{F} \longrightarrow & \mathcal{F} \longrightarrow & \mathcal{F}/I^n\mathcal{F} \longrightarrow & 0 \\ 0 \longrightarrow & I^{n + m}\mathcal{F} \longrightarrow\uparrow & \mathcal{F} \longrightarrow\uparrow & \mathcal{F}/I^{n + m}\mathcal{F} \longrightarrow\uparrow & 0\end{array}
$$
This gives rise to the following commutative diagram
$$
\begin{array}{cccc}H^p(X, \mathcal{F}) \longrightarrow & H^p(X, \mathcal{F}/I^n\mathcal{F}) \underset{\delta}{\longrightarrow} & H^{p + 1}(X, I^n\mathcal{F}) \longrightarrow & H^{p + 1}(X, \mathcal{F}) \\ H^p(X, \mathcal{F}) \longrightarrow\overset{1}{\uparrow} & H^p(X, \mathcal{F}/I^{n + m}\mathcal{F}) \longrightarrow\overset{\gamma}{\uparrow} & H^{p + 1}(X, I^{n + m}\mathcal{F}) \overset{\alpha}{\uparrow}\overset{\beta}{\longrightarrow} & H^{p + 1}(X, \mathcal{F}) \underset{1}{\uparrow}\end{array}
$$
with exact rows. By
Lemma \ref{coherent-lemma-cohomology-powers-ideal-application} part (4) the kernel
...
\source{stacks:02OC}
\href{https://stacks.math.columbia.edu/tag/02OC}{\texttt{Stacks tag 02OC}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-ML-cohomology-powers-ideal}

This follows from Lemma \ref{coherent-lemma-ML-cohomology-powers-ideal} as follows.
Set $M = H^p(X, \mathcal{F})$, $M_n = H^p(X, \mathcal{F}/I^n\mathcal{F})$,
and denote $N_n = \Im(M \to M_n)$. By
Lemma \ref{coherent-lemma-ML-cohomology-powers-ideal} parts (2) and (3) we see that
...
By Lemma \ref{coherent-lemma-ML-cohomology-powers-ideal} part (1)
...
\begin{lemma}[Spell out theorem formal functions]
\label{coherent-lemma-spell-out-theorem-formal-functions}
\source{stacks:087U}
\href{https://stacks.math.columbia.edu/tag/087U}{\texttt{Stacks tag 087U}}
\group{coherent}
...
\begin{proof}
\uses{coherent-theorem-formal-functions, coherent-lemma-proper-over-affine-cohomology-finite}

This is a reformulation of the theorem on formal functions
(Theorem \ref{coherent-theorem-formal-functions}) in the
case of a complete Noetherian base ring. Namely, in this case the
$A$-module $H^p(X, \mathcal{F})$ is finite
(Lemma \ref{coherent-lemma-proper-over-affine-cohomology-finite}) hence
...
\begin{lemma}[Formal functions stalk]
\label{coherent-lemma-formal-functions-stalk}
\source{stacks:02OD}
\href{https://stacks.math.columbia.edu/tag/02OD}{\texttt{Stacks tag 02OD}}
\group{coherent}
...
\underset{i_n}{\longrightarrow}\underset{f_n}{\downarrow} & X \overset{f}{\downarrow} \\ \Spec(\mathcal{O}_{Y, y}/\mathfrak m_y^n) \overset{c_n}{\longrightarrow} & Y\end{array}
$$
...
\begin{proof}
\uses{coherent-theorem-formal-functions, coherent-lemma-flat-base-change-cohomology, coherent-lemma-finite-pushforward-coherent}

This is just a reformulation of a special case of the theorem
on formal functions, Theorem \ref{coherent-theorem-formal-functions}.
...
for $i_n$, and Lemma \ref{coherent-lemma-finite-pushforward-coherent} we see that
$$
...
\begin{lemma}[Higher direct images zero finite fibre]
\label{coherent-lemma-higher-direct-images-zero-finite-fibre}
\source{stacks:02OE}
\href{https://stacks.math.columbia.edu/tag/02OE}{\texttt{Stacks tag 02OE}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-formal-functions-stalk, coherent-proposition-proper-pushforward-coherent}
...
by Lemma \ref{coherent-lemma-formal-functions-stalk}.
...
\begin{lemma}[Higher direct images zero above dimension fibre]
\label{coherent-lemma-higher-direct-images-zero-above-dimension-fibre}
\source{stacks:02V7}
\href{https://stacks.math.columbia.edu/tag/02V7}{\texttt{Stacks tag 02V7}}
\group{coherent}
...
by Lemma \ref{coherent-lemma-formal-functions-stalk} for $p > d$.
Note that $R^pf_*\mathcal{F}$ is coherent by
Proposition \ref{coherent-proposition-proper-pushforward-coherent} and
hence $R^pf_*\mathcal{F}_y$ is a finite
$\mathcal{O}_{Y, y}$-module. By Nakayama's lemma
...
\source{stacks:02OG}
\href{https://stacks.math.columbia.edu/tag/02OG}{\texttt{Stacks tag 02OG}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-quasi-separated-h1-zero-covering, coherent-lemma-higher-direct-images-zero-finite-fibre, coherent-lemma-quasi-coherent-affine-cohomology-zero}
...
Lemma \ref{coherent-lemma-quasi-separated-h1-zero-covering} to prove that $X$
...
Lemma \ref{coherent-lemma-higher-direct-images-zero-finite-fibre} we conclude that
...
from Lemma \ref{coherent-lemma-quasi-coherent-affine-cohomology-zero}
as desired. Hence $H^1(X, \mathcal{I}) = 0$ as desired.
\end{proof}

As a consequence we have the following useful result.

\begin{lemma}[A proper morphism is finite in a neighbourhood of a finite fiber.]
\label{coherent-lemma-proper-finite-fibre-finite-in-neighbourhood}
\source{stacks:02OH}
\href{https://stacks.math.columbia.edu/tag/02OH}{\texttt{Stacks tag 02OH}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-characterize-finite}
...
is finite by Lemma \ref{coherent-lemma-characterize-finite}.
\end{proof}

\begin{lemma}[Ample on fibre]
\label{coherent-lemma-ample-on-fibre}
\source{stacks:0D2M}
\href{https://stacks.math.columbia.edu/tag/0D2M}{\texttt{Stacks tag 0D2M}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-flat-base-change-cohomology, coherent-lemma-i-star-equivalence, coherent-lemma-graded-finiteness, coherent-lemma-relative-affine-cohomology, coherent-theorem-formal-functions, coherent-lemma-proper-over-affine-cohomology-finite, coherent-lemma-ML-cohomology-powers-ideal}
...
We will use notation as in Section \ref{coherent-section-theorem-formal-functions}
...
Lemma \ref{coherent-lemma-i-star-equivalence}. Then
...
Hence by Lemma \ref{coherent-lemma-graded-finiteness} part (2)
we see that
$$
...
\end{enumerate}
By the theorem on formal functions (Theorem \ref{coherent-theorem-formal-functions})
...
Lemma \ref{coherent-lemma-ML-cohomology-powers-ideal} part (3)
...
\source{stacks:0D2N}
\href{https://stacks.math.columbia.edu/tag/0D2N}{\texttt{Stacks tag 0D2N}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-ample-on-fibre, coherent-lemma-proper-finite-fibre-finite-in-neighbourhood}

Pick $d_0$ as in Lemma \ref{coherent-lemma-ample-on-fibre} for
...
Namely, by Lemma \ref{coherent-lemma-proper-finite-fibre-finite-in-neighbourhood}
...
Please see Remark \ref{coherent-remark-explain-perfect-direct-image} for a translation
of the following lemma into algebra.

\begin{lemma}[Perfect direct image]
\label{coherent-lemma-perfect-direct-image}
\source{stacks:07VK}
\href{https://stacks.math.columbia.edu/tag/07VK}{\texttt{Stacks tag 07VK}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-separated-case-relative-cech, coherent-lemma-base-change-complex, coherent-lemma-proper-over-affine-cohomology-finite}

Choose a finite affine open covering $X = \bigcup_{i = 1, \ldots, n} U_i$.
By Lemmas \ref{coherent-lemma-separated-case-relative-cech} and
\ref{coherent-lemma-base-change-complex} the {\v C}ech complex
...
\source{stacks:07VL}
\href{https://stacks.math.columbia.edu/tag/07VL}{\texttt{Stacks tag 07VL}}
\group{coherent}

\uses{coherent-lemma-perfect-direct-image}
A consequence of Lemma \ref{coherent-lemma-perfect-direct-image} is that there
...
\begin{lemma}[Inverse systems affine]
\label{coherent-lemma-inverse-systems-affine}
\source{stacks:087W}
\href{https://stacks.math.columbia.edu/tag/087W}{\texttt{Stacks tag 087W}}
\group{coherent}
...
sheaves on $X$ and finite $A$-modules (Lemma \ref{coherent-lemma-coherent-Noetherian})
...
\source{stacks:087X}
\href{https://stacks.math.columbia.edu/tag/087X}{\texttt{Stacks tag 087X}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-inverse-systems-affine}
...
Lemma \ref{coherent-lemma-inverse-systems-affine}
...
\source{stacks:087Y}
\href{https://stacks.math.columbia.edu/tag/087Y}{\texttt{Stacks tag 087Y}}
\group{coherent}
...
Lemma \ref{coherent-lemma-inverse-systems-affine}, and use
Algebra, Lemma \ref{algebra-lemma-NAK}.
\end{proof}
...
\source{stacks:0881}
\href{https://stacks.math.columbia.edu/tag/0881}{\texttt{Stacks tag 0881}}
\group{coherent}
...
\source{stacks:0882}
\href{https://stacks.math.columbia.edu/tag/0882}{\texttt{Stacks tag 0882}}
\group{coherent}
...
$$
via the equivalence of Lemma \ref{coherent-lemma-inverse-systems-affine}.
...
\source{stacks:0889}
\href{https://stacks.math.columbia.edu/tag/0889}{\texttt{Stacks tag 0889}}
\group{coherent}
...
Lemma \ref{coherent-lemma-inverse-systems-affine} applies.
...
\begin{lemma}[Torsion hom ext]
\label{coherent-lemma-torsion-hom-ext}
\source{stacks:0EHP}
\href{https://stacks.math.columbia.edu/tag/0EHP}{\texttt{Stacks tag 0EHP}}
\group{coherent}
...
$$
\begin{array}{cc}\Hom_X(\mathcal{F}, \mathcal{G}) \downarrow & \Ext_X(\mathcal{F}, \mathcal{G}) \downarrow \\ \Hom_{\textit{Coh}(X, \mathcal{I})}(\mathcal{F}^\wedge, \mathcal{G}^\wedge) & \Ext_{\textit{Coh}(X, \mathcal{I})}(\mathcal{F}^\wedge, \mathcal{G}^\wedge)\end{array}
$$
are isomorphisms.
\end{lemma}

\begin{proof}
\uses{coherent-lemma-completion-internal-hom, coherent-lemma-existence-easy}
...
(\mathcal{G}^\wedge, \mathcal{F}^\wedge).
$$
see Lemma \ref{coherent-lemma-completion-internal-hom}.
...
by a power of $I$. Then part (1) of Lemma \ref{coherent-lemma-existence-easy}
...
\begin{lemma}[Finite over rees algebra]
\label{coherent-lemma-finite-over-rees-algebra}
\source{stacks:087Z}
\href{https://stacks.math.columbia.edu/tag/087Z}{\texttt{Stacks tag 087Z}}
\group{coherent}
...
we have a situation as in Lemma \ref{coherent-lemma-inverse-systems-affine}.
...
\begin{lemma}[Inverse systems pullback]
\label{coherent-lemma-inverse-systems-pullback}
\source{stacks:0887}
\href{https://stacks.math.columbia.edu/tag/0887}{\texttt{Stacks tag 0887}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-inverse-systems-abelian}
...
cokernels in the proof of Lemma \ref{coherent-lemma-inverse-systems-abelian}
shows that
...
in the proof of Lemma \ref{coherent-lemma-inverse-systems-abelian}
that in this case
$f^* : \textit{Coh}(Y, \mathcal{J}) \to \textit{Coh}(X, \mathcal{I})$
also transforms kernels into kernels.
\end{proof}

\begin{lemma}[Inverse systems pullback equivalence]
\label{coherent-lemma-inverse-systems-pullback-equivalence}
\source{stacks:0EHQ}
\href{https://stacks.math.columbia.edu/tag/0EHQ}{\texttt{Stacks tag 0EHQ}}
\group{coherent}

\uses{coherent-lemma-inverse-systems-pullback}
...
(Lemma \ref{coherent-lemma-inverse-systems-pullback})
is an equivalence.
\end{lemma}

\begin{proof}
\uses{coherent-lemma-i-star-equivalence}
...
$(\mathcal{I}')^n$, see
Lemma \ref{coherent-lemma-i-star-equivalence}.
This clearly implies the lemma.
\end{proof}

\begin{lemma}[Inverse systems ideals equivalence]
\label{coherent-lemma-inverse-systems-ideals-equivalence}
\source{stacks:0EHR}
\href{https://stacks.math.columbia.edu/tag/0EHR}{\texttt{Stacks tag 0EHR}}
\group{coherent}
...
Thus the equivalence follows from Lemma \ref{coherent-lemma-inverse-systems-affine}
in this case.
...
developed in Section \ref{coherent-section-coherent-formal}. The reader who is familiar
...
\source{stacks:0883}
\href{https://stacks.math.columbia.edu/tag/0883}{\texttt{Stacks tag 0883}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-completion-internal-hom, coherent-lemma-spell-out-theorem-formal-functions}
...
By Lemma \ref{coherent-lemma-completion-internal-hom} the map
$$
...
functions (Lemma \ref{coherent-lemma-spell-out-theorem-formal-functions})
for the coherent sheaf $\mathcal{H}$.
\end{proof}

\begin{lemma}[Vanishing projective]
\label{coherent-lemma-vanishing-projective}
\source{stacks:0884}
\href{https://stacks.math.columbia.edu/tag/0884}{\texttt{Stacks tag 0884}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-finite-over-rees-algebra, coherent-lemma-graded-finiteness}

Set $B = \bigoplus I^n/I^{n + 1}$ and
$\mathcal{B} = \bigoplus \mathcal{I}^n/\mathcal{I}^{n + 1} = f^*\widetilde{B}$.
By Lemma \ref{coherent-lemma-finite-over-rees-algebra} the graded quasi-coherent
$\mathcal{B}$-module
$\mathcal{G} = \bigoplus \Ker(\mathcal{F}_{n + 1} \to \mathcal{F}_n)$
is of finite type. Hence the lemma follows from
Lemma \ref{coherent-lemma-graded-finiteness} part (2).
\end{proof}

\begin{lemma}[Existence projective]
\label{coherent-lemma-existence-projective}
\source{stacks:0885}
\href{https://stacks.math.columbia.edu/tag/0885}{\texttt{Stacks tag 0885}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-fully-faithful, coherent-lemma-vanishing-projective, coherent-lemma-inverse-systems-surjective, coherent-lemma-inverse-systems-abelian, coherent-lemma-exact}

We have already seen that (\ref{equation-completion-functor}) is
fully faithful in Lemma \ref{coherent-lemma-fully-faithful}. Thus it suffices
...
Choose $d_0$ as in Lemma \ref{coherent-lemma-vanishing-projective}.
...
$$
Using Lemma \ref{coherent-lemma-inverse-systems-surjective}
...
(Lemma \ref{coherent-lemma-inverse-systems-abelian})
implies that
...
Lemmas \ref{coherent-lemma-fully-faithful} and \ref{coherent-lemma-exact}
we conclude.
\end{proof}
...
introduced in Section \ref{coherent-section-coherent-formal}.
...
\source{stacks:0888}
\href{https://stacks.math.columbia.edu/tag/0888}{\texttt{Stacks tag 0888}}
\group{coherent}
...
corresponds to $\alpha|_U$ via Lemma \ref{coherent-lemma-inverse-systems-affine}.
...
\source{stacks:088A}
\href{https://stacks.math.columbia.edu/tag/088A}{\texttt{Stacks tag 088A}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-i-star-equivalence, coherent-remark-inverse-systems-kernel-cokernel-annihilated-by, coherent-lemma-existence-easy}
...
by the ideal sheaf of $Z$, see Lemma \ref{coherent-lemma-i-star-equivalence}.
...
$$
see Remark \ref{coherent-remark-inverse-systems-kernel-cokernel-annihilated-by}.
We apply Lemma \ref{coherent-lemma-existence-easy} to obtain a coherent
...
Lemma \ref{coherent-lemma-existence-easy}
...
\source{stacks:088B}
\href{https://stacks.math.columbia.edu/tag/088B}{\texttt{Stacks tag 088B}}
\group{coherent}
...
\begin{proof}
\uses{coherent-proposition-proper-pushforward-coherent, coherent-lemma-ML-cohomology-powers-ideal, coherent-theorem-formal-functions, coherent-lemma-inverse-systems-affine, coherent-lemma-flat-base-change-cohomology, coherent-remark-inverse-systems-kernel-cokernel-annihilated-by, coherent-lemma-fully-faithful, coherent-lemma-power-ideal-kills-sheaf}
...
M = H^0(X, \mathcal{F})
$$
By Lemma \ref{coherent-lemma-ML-cohomology-powers-ideal} and
Theorem \ref{coherent-theorem-formal-functions}
...
to $Y'$ by Lemma \ref{coherent-lemma-flat-base-change-cohomology}.
...
Lemma \ref{coherent-lemma-fully-faithful}
...
(Lemma \ref{coherent-lemma-power-ideal-kills-sheaf}) as desired.
\end{proof}

The following proposition is the form of Grothendieck's existence
theorem which is most often used in practice.

\begin{proposition}[Existence proper]
\label{coherent-proposition-existence-proper}
\source{stacks:088C}
\href{https://stacks.math.columbia.edu/tag/088C}{\texttt{Stacks tag 088C}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-fully-faithful, coherent-lemma-acc-coherent, coherent-lemma-i-star-equivalence, coherent-lemma-chow-Noetherian, coherent-lemma-existence-projective, coherent-proposition-proper-pushforward-coherent, coherent-lemma-inverse-systems-push-pull, coherent-lemma-existence-tricky}
...
not in $\Xi$, see
Lemma \ref{coherent-lemma-acc-coherent}.
...
\medskip\noindent
Apply Chow's lemma (Lemma \ref{coherent-lemma-chow-Noetherian}) to find a
...
(Lemma \ref{coherent-lemma-existence-projective})
...
and by Lemma \ref{coherent-lemma-inverse-systems-push-pull}
...
We conclude by Lemma \ref{coherent-lemma-existence-tricky}.
\end{proof}
...
\begin{lemma}[Closed proper over base]
\label{coherent-lemma-closed-proper-over-base}
\source{stacks:0CYL}
\href{https://stacks.math.columbia.edu/tag/0CYL}{\texttt{Stacks tag 0CYL}}
\group{coherent}
...
\begin{definition}[Proper over base]
\label{coherent-definition-proper-over-base}
\source{stacks:0CYM}
\href{https://stacks.math.columbia.edu/tag/0CYM}{\texttt{Stacks tag 0CYM}}
\group{coherent}

\uses{coherent-lemma-closed-proper-over-base}
Let $f : X \to S$ be a morphism of schemes which is locally of finite type.
Let $Z \subset X$ be a closed subset.
We say {\it $Z$ is proper over $S$}
if the equivalent conditions of Lemma \ref{coherent-lemma-closed-proper-over-base}
are satisfied.
\end{definition}
...
\begin{lemma}[Closed closed proper over base]
\label{coherent-lemma-closed-closed-proper-over-base}
\source{stacks:0CYN}
\href{https://stacks.math.columbia.edu/tag/0CYN}{\texttt{Stacks tag 0CYN}}
\group{coherent}
...
\begin{lemma}[Base change closed proper over base]
\label{coherent-lemma-base-change-closed-proper-over-base}
\source{stacks:0CYP}
\href{https://stacks.math.columbia.edu/tag/0CYP}{\texttt{Stacks tag 0CYP}}
\group{coherent}
...
\begin{lemma}[Functoriality closed proper over base]
\label{coherent-lemma-functoriality-closed-proper-over-base}
\source{stacks:0CYQ}
\href{https://stacks.math.columbia.edu/tag/0CYQ}{\texttt{Stacks tag 0CYQ}}
\group{coherent}
...
\begin{lemma}[Union closed proper over base]
\label{coherent-lemma-union-closed-proper-over-base}
\source{stacks:0CYR}
\href{https://stacks.math.columbia.edu/tag/0CYR}{\texttt{Stacks tag 0CYR}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-functoriality-closed-proper-over-base}
...
we conclude by
Lemma \ref{coherent-lemma-functoriality-closed-proper-over-base} part (2)
...
\begin{lemma}[Module support proper over base]
\label{coherent-lemma-module-support-proper-over-base}
\source{stacks:0CYS}
\href{https://stacks.math.columbia.edu/tag/0CYS}{\texttt{Stacks tag 0CYS}}
\group{coherent}
...
\begin{proof}
\uses{coherent-definition-proper-over-base, coherent-lemma-closed-closed-proper-over-base}
...
Hence we can apply Definition \ref{coherent-definition-proper-over-base}.
...
Definition \ref{coherent-definition-proper-over-base}.
...
Lemma \ref{coherent-lemma-closed-closed-proper-over-base}.
\end{proof}

\begin{lemma}[Base change module support proper over base]
\label{coherent-lemma-base-change-module-support-proper-over-base}
\source{stacks:0CYT}
\href{https://stacks.math.columbia.edu/tag/0CYT}{\texttt{Stacks tag 0CYT}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-base-change-closed-proper-over-base}
...
Lemma \ref{coherent-lemma-base-change-closed-proper-over-base}.
\end{proof}

\begin{lemma}[Cat module support proper over base]
\label{coherent-lemma-cat-module-support-proper-over-base}
\source{stacks:0CYU}
\href{https://stacks.math.columbia.edu/tag/0CYU}{\texttt{Stacks tag 0CYU}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-closed-closed-proper-over-base, coherent-lemma-union-closed-proper-over-base}
...
is clear from Lemmas \ref{coherent-lemma-closed-closed-proper-over-base} and
...
modules in Section \ref{coherent-section-coherent-sheaves}.
\end{proof}

\begin{lemma}[Support proper over base pushforward]
\label{coherent-lemma-support-proper-over-base-pushforward}
\source{stacks:08DS}
\href{https://stacks.math.columbia.edu/tag/08DS}{\texttt{Stacks tag 08DS}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-module-support-proper-over-base, coherent-proposition-proper-pushforward-coherent, coherent-lemma-finite-pushforward-coherent}

By Lemma \ref{coherent-lemma-module-support-proper-over-base}
...
\begin{lemma}[Systems with proper support]
\label{coherent-lemma-systems-with-proper-support}
\source{stacks:0CYV}
\href{https://stacks.math.columbia.edu/tag/0CYV}{\texttt{Stacks tag 0CYV}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-inverse-systems-abelian, coherent-lemma-union-closed-proper-over-base, coherent-definition-proper-over-base}
...
for some $m \geq n$. See proof of Lemma \ref{coherent-lemma-inverse-systems-abelian}.
...
By Lemma \ref{coherent-lemma-union-closed-proper-over-base}
(and via Definition \ref{coherent-definition-proper-over-base} which
...
Lemma \ref{coherent-lemma-cat-module-support-proper-over-base}.
Similarly, we let
$$
...
by Lemma \ref{coherent-lemma-systems-with-proper-support} part (1).
...
\source{stacks:088E}
\href{https://stacks.math.columbia.edu/tag/088E}{\texttt{Stacks tag 088E}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-i-star-equivalence, coherent-proposition-existence-proper, coherent-lemma-acc-coherent, coherent-lemma-chow-Noetherian, coherent-lemma-functoriality-closed-proper-over-base, coherent-lemma-pushforward-coherent-on-open, coherent-lemma-existence-projective, coherent-proposition-proper-pushforward-coherent, coherent-lemma-inverse-systems-push-pull, coherent-lemma-closed-closed-proper-over-base, coherent-lemma-systems-with-proper-support}
...
By Proposition \ref{coherent-proposition-existence-proper} we know
...
$\textit{Coh}_{\text{support proper over }A}(X, \mathcal{I})$
using the method of proof of Proposition \ref{coherent-proposition-existence-proper}.
...
Morphisms, Lemma \ref{morphisms-lemma-support-finite-type}.
By assumption and
Lemma \ref{coherent-lemma-functoriality-closed-proper-over-base} part (3)
...
Lemma \ref{coherent-lemma-functoriality-closed-proper-over-base} part (1).
Thus $\mathcal{F}'_n = j_*f^*\mathcal{F}_n$ is coherent on
$Y'$ by Lemma \ref{coherent-lemma-pushforward-coherent-on-open}.
...
Lemma \ref{coherent-lemma-closed-closed-proper-over-base} and
Lemma \ref{coherent-lemma-functoriality-closed-proper-over-base} part (2).
Hence $\mathcal{H}^\wedge$ is in the subcategory defined in
Lemma \ref{coherent-lemma-systems-with-proper-support} part (2)
and a fortiori in
$\textit{Coh}_{\text{support proper over }A}(X, \mathcal{I})$.
...
\source{stacks:088F}
\href{https://stacks.math.columbia.edu/tag/088F}{\texttt{Stacks tag 088F}}
\group{coherent}

\uses{coherent-theorem-grothendieck-existence}
Let $A$ be a Noetherian ring complete with respect to an ideal $I$.
...
\end{enumerate}
Theorem \ref{coherent-theorem-grothendieck-existence} says that the
completion functor
$$
\begin{matrix}
...
\source{stacks:0899}
\href{https://stacks.math.columbia.edu/tag/0899}{\texttt{Stacks tag 0899}}
\group{coherent}
...
\begin{proof}
\uses{coherent-remark-reformulate-existence-theorem, coherent-lemma-exact}
...
Remark \ref{coherent-remark-reformulate-existence-theorem},
...
As the completion functor is exact (Lemma \ref{coherent-lemma-exact})
...
\begin{lemma}[Algebraize formal scheme finite over proper]
\label{coherent-lemma-algebraize-formal-scheme-finite-over-proper}
\source{stacks:09ZT}
\href{https://stacks.math.columbia.edu/tag/09ZT}{\texttt{Stacks tag 09ZT}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-finite-pushforward-coherent, coherent-remark-reformulate-existence-theorem, coherent-theorem-grothendieck-existence}
...
\source{stacks:0A42}
\href{https://stacks.math.columbia.edu/tag/0A42}{\texttt{Stacks tag 0A42}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-algebraize-formal-closed-subscheme, coherent-lemma-proper-finite-fibre-finite-in-neighbourhood, coherent-proposition-existence-proper}
...
Lemma \ref{coherent-lemma-algebraize-formal-closed-subscheme}
...
Applying the equivalence of Proposition \ref{coherent-proposition-existence-proper}
...
\source{stacks:089A}
\href{https://stacks.math.columbia.edu/tag/089A}{\texttt{Stacks tag 089A}}
\group{coherent}
...
\begin{proof}
\uses{coherent-lemma-graded-finiteness, coherent-lemma-algebraize-formal-closed-subscheme}
...
By Lemma \ref{coherent-lemma-graded-finiteness} we can find an integer $d_0$
...
$$
\begin{array}{cccc}X_1 \underset{i_1}{\longrightarrow}\underset{\psi_1}{\downarrow} & X_2 \underset{i_2}{\longrightarrow}\underset{\psi_2}{\downarrow} & X_3 \longrightarrow\underset{\psi_3}{\downarrow} & \ldots \\ \mathbf{P}^N_{S_1} \longrightarrow & \mathbf{P}^N_{S_2} \longrightarrow & \mathbf{P}^N_{S_3} \longrightarrow & \ldots\end{array}
$$
where
...
We win by applying Lemma \ref{coherent-lemma-algebraize-formal-closed-subscheme}.
\end{proof}
