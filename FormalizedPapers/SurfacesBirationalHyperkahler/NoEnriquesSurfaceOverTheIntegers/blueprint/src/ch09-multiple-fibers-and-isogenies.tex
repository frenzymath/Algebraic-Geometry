...
\begin{proposition}
\label{src-no-enriques-surface-over-the-integers-ch09-multiple-fibers-and-isogenies-statement-1}
\source{no-enriques-surface-over-the-integers}
\notready
...
\begin{corollary}
\label{src-no-enriques-surface-over-the-integers-ch09-multiple-fibers-and-isogenies-statement-2}
\source{no-enriques-surface-over-the-integers}
\notready
...
\begin{corollary}
\label{src-no-enriques-surface-over-the-integers-ch09-multiple-fibers-and-isogenies-statement-3}
\source{no-enriques-surface-over-the-integers}
\notready
...
\begin{lemma}
\label{src-no-enriques-surface-over-the-integers-ch09-multiple-fibers-and-isogenies-statement-4}
\source{no-enriques-surface-over-the-integers}
\notready
\mylabel{covering}
