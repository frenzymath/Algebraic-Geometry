...
\begin{remark}
\label{src-standard-conjectures-abelian-fourfolds-ch03-standard-conjecture-of-hodge-type-statement-1}
\source{standard-conjectures-abelian-fourfolds}
\notready
...
\end{assumption}
\begin{remark}
\label{src-standard-conjectures-abelian-fourfolds-ch03-standard-conjecture-of-hodge-type-statement-2}
\source{standard-conjectures-abelian-fourfolds}
\notready
...
\end{enumerate}
 \end{definition}
 \begin{remark}
\label{src-standard-conjectures-abelian-fourfolds-ch03-standard-conjecture-of-hodge-type-statement-3}
\source{standard-conjectures-abelian-fourfolds}
\notready
...
\end{proof}
\begin{remark}
\label{src-standard-conjectures-abelian-fourfolds-ch03-standard-conjecture-of-hodge-type-statement-4}
\source{standard-conjectures-abelian-fourfolds}
\notready
...
\end{proof}
\begin{remark}
\label{src-standard-conjectures-abelian-fourfolds-ch03-standard-conjecture-of-hodge-type-statement-5}
\source{standard-conjectures-abelian-fourfolds}
\notready
