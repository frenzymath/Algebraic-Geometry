...
\begin{remark}
\label{src-squarefree-values-polynomial-discriminants-ch05-a-lower-bound-on-the-number-of-degree-n-number-fields-that-are-monogenic-statement-1}
\source{squarefree-values-polynomial-discriminants}
\notready{\em
...
\begin{remark}
\label{src-squarefree-values-polynomial-discriminants-ch05-a-lower-bound-on-the-number-of-degree-n-number-fields-that-are-monogenic-statement-2}
\source{squarefree-values-polynomial-discriminants}
\notready{\em
