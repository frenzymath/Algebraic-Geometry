...
\end{lemma}
\begin{proof}Take the inverse of
...
\begin{proof}\uses{mk-lem:right_exact_mono_left_exact}
...
\begin{proof}Preservation of finite limits is equivalent to: for every short exact sequence
...
\begin{proof}The forgetful functor to abelian presheaves preserves limits, hence monomorphisms, and is
...
\begin{proof}Along an open immersion the pullback is isomorphic to the restriction functor, and restriction
...
\begin{proof}Let \(c\) be a limit cone of \(K\). Since \(F\) preserves that limit, \(F c\) is a limit cone of
...
\begin{proof}\uses{mk-lem:preserves_limit_comp_cancel, mk-lem:tilde_preserves_kernels}
...
\begin{proof}The degree-\(i\) homology of \(K\) is that of the short complex
...
\end{lemma}
\begin{proof}The poset is nonempty: \(T'\) itself satisfies \(d \subseteq \varphi^{-1}(T') = T\). It is
...
\begin{lemma}[The opens-preimage functor of a continuous map is final]\label{mk-lem:opensMap_final}
  ...
  final functor.
\end{lemma}
\begin{proof}\uses{mk-lem:opensMap_structuredArrow_isFiltered}
...
\begin{lemma}[Pullback of the structure sheaf]\label{mk-lem:module_pullback_unit_iso}
  ...
  isomorphism.
\end{lemma}
\begin{proof}\uses{mk-lem:opensMap_final}
...
\begin{lemma}[Per-slice presentation of a pullback]\label{mk-lem:presentation_pullback_slice_of_over}
  ...
  \(W = g^{-1}(A)\).
\end{lemma}
\begin{proof}\uses{mk-lem:module_pullback_unit_iso, mk-lem:isQuasicoherent_pullback_opens}
...
\begin{lemma}[Pullback preserves quasi-coherence (general morphism)]\label{mk-lem:pullback_isQuasicoherent_hom}
  ...
  \(\mathcal{O}_Y\)-module.
\end{lemma}
\begin{proof}\uses{mk-lem:presentation_pullback_slice_of_over}
...
\begin{proof}For a literal \(q = \operatorname{Spec}\varphi\) this is the statement that an affine
...
\begin{proof}\uses{mk-lem:isQuasicoherent_pushforward_of_isAffine, mk-lem:pushPull_sigma_iso,
...
\end{lemma}
\begin{proof}\uses{mk-def:push_pull_obj, mk-lem:openimm_bareBC, mk-lem:openimm_bc_telescope,
...
\begin{lemma}[The geometric counit at an open immersion is invertible]\label{mk-lem:openimm_pullback_counit_isIso}
  ...
  an open immersion \(q\).)
\end{lemma}
\begin{proof}\uses{mk-lem:restrictFunctorIsoPullback_mathlib}
...
\begin{lemma}[Restriction maps of a pushforward-presented module are isomorphisms]\label{mk-lem:restrictionMap_isIso_of_essImage}
  ...
  is an isomorphism.
\end{lemma}
\begin{proof}Transport along the isomorphism \(N \cong \iota_*\,K\) (naturality of its components in the
...
\begin{lemma}[Essential-image membership for \(p'_*\) is cover local]\label{mk-lem:essimage_pushforward_cover_local}
  ...
  image of \(p'_*\).
\end{lemma}
\begin{proof}\uses{mk-lem:isIso_iff_isIso_restrict, mk-lem:restrictionMap_isIso_of_essImage,
        mk-lem:restrictFunctorIsoPullback_mathlib}
...
\end{lemma}
\begin{proof}\uses{mk-lem:affine_pushforward_pullback_baseChange,
        mk-lem:pullback_preserves_quasicoherent, mk-lem:pullback_spec_tilde_iso,
        mk-lem:openimm_refining_affine_cover, mk-lem:restrictFunctorIsoPullback_mathlib}
...
\end{lemma}
\begin{proof}\uses{mk-lem:openimm_pullback_counit_isIso, mk-lem:essimage_pushforward_cover_local,
        mk-lem:openimm_refining_affine_cover, mk-lem:openimm_bareBC_app_isIso_affine,
        mk-lem:openimm_bareBC, mk-lem:openimm_bc_telescope,
        mk-lem:isOpenImmersion_of_isPullback_left}
...
\end{lemma}
\begin{proof}\uses{mk-lem:coverinteropen_basechange_eq, mk-lem:openimm_beckchevalley, mk-lem:pushPullObj_iso_tilde,
