...
The part-local Lean package `StacksPart01Lib/` is a port of the corresponding Horizon
`FormalizedSources/StacksProject/Part01_Preliminaries` library. Lake metadata lives
