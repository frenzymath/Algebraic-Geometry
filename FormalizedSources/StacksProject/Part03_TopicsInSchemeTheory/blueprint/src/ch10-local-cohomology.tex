...
Grothendieck's finiteness theorem, see Theorem \ref{local-cohomology-theorem-finiteness}
and Lemma \ref{local-cohomology-lemma-finiteness-Rjstar} (higher direct images
...
\begin{lemma}[Local cohomology is local cohomology]
\label{local-cohomology-lemma-local-cohomology-is-local-cohomology}
\source{stacks:0A6T}
\href{https://stacks.math.columbia.edu/tag/0A6T}{\texttt{Stacks tag 0A6T}}
\group{local-cohomology}
...
the complex on the right hand side computes $R\Gamma_Z(K)$
and we see the lemma holds for a given $K$.

\medskip\noindent
We finish by showing that the isomorphism can be made functorial in $K$.
Consider the map of complexes of $A$-modules
$$
...
K^\bullet
$$
The arguments above show that this arrow becomes an isomorphism after
applying the functor $R\Gamma_Z(X, \widetilde{\ })$ and that
$R\Gamma(U, \widetilde{M}^\bullet) = 0$ (details omitted). Then we have
$$
...
$$
and all the maps are isomorphisms in $D(A)$ and functorial in $K^\bullet$
as desired.
\end{proof}

\begin{lemma}[Local cohomology]
\label{local-cohomology-lemma-local-cohomology}
\source{stacks:0DWR}
\href{https://stacks.math.columbia.edu/tag/0DWR}{\texttt{Stacks tag 0DWR}}
\group{local-cohomology}
...
for $p \geq 1$. By Lemma \ref{local-cohomology-lemma-local-cohomology-is-local-cohomology}
...
\begin{lemma}[Already torsion]
\label{local-cohomology-lemma-already-torsion}
\source{stacks:0DWS}
\href{https://stacks.math.columbia.edu/tag/0DWS}{\texttt{Stacks tag 0DWS}}
\group{local-cohomology}
...
\begin{lemma}[Multiplicative]
\label{local-cohomology-lemma-multiplicative}
\source{stacks:0DWT}
\href{https://stacks.math.columbia.edu/tag/0DWT}{\texttt{Stacks tag 0DWT}}
\group{local-cohomology}
...
Lemma \ref{local-cohomology-lemma-already-torsion}).
\end{proof}

\begin{lemma}[Elements come from bigger]
\label{local-cohomology-lemma-elements-come-from-bigger}
\source{stacks:0DWU}
\href{https://stacks.math.columbia.edu/tag/0DWU}{\texttt{Stacks tag 0DWU}}
\group{local-cohomology}
...
Lemma \ref{local-cohomology-lemma-multiplicative}.
...
\source{stacks:0DWV}
\href{https://stacks.math.columbia.edu/tag/0DWV}{\texttt{Stacks tag 0DWV}}
\group{local-cohomology}
...
By Lemma \ref{local-cohomology-lemma-elements-come-from-bigger} we can increase $I''$
...
\begin{lemma}[Hartshorne's connectedness]
\label{local-cohomology-lemma-depth-2-connected-punctured-spectrum}
\source{stacks:0BLR}
\href{https://stacks.math.columbia.edu/tag/0BLR}{\texttt{Stacks tag 0BLR}}
\group{local-cohomology}
...
By Lemma \ref{local-cohomology-lemma-local-cohomology}
...
\begin{lemma}[Catenary S2 equidimensional]
\label{local-cohomology-lemma-catenary-S2-equidimensional}
\source{stacks:0FIW}
\href{https://stacks.math.columbia.edu/tag/0FIW}{\texttt{Stacks tag 0FIW}}
\group{local-cohomology}
...
\source{stacks:0DX7}
\href{https://stacks.math.columbia.edu/tag/0DX7}{\texttt{Stacks tag 0DX7}}
\group{local-cohomology}
...
Lemma \ref{local-cohomology-lemma-local-cohomology}.
...
Lemma \ref{local-cohomology-lemma-local-cohomology} that (2) is equivalent to (3).
\end{proof}

\begin{definition}[Cd]
\label{local-cohomology-definition-cd}
\source{stacks:0DX8}
\href{https://stacks.math.columbia.edu/tag/0DX8}{\texttt{Stacks tag 0DX8}}
\group{local-cohomology}

Let $I \subset A$ be a finitely generated ideal of a ring $A$.
The smallest integer $d \geq -1$ satisfying the equivalent conditions
of Lemma \ref{local-cohomology-lemma-cd} is called the
...
\begin{lemma}[Bound cd]
\label{local-cohomology-lemma-bound-cd}
\source{stacks:0DX9}
\href{https://stacks.math.columbia.edu/tag/0DX9}{\texttt{Stacks tag 0DX9}}
\group{local-cohomology}
...
or it follows from Lemma \ref{local-cohomology-lemma-local-cohomology-is-local-cohomology}.
To see (3) we use Lemma \ref{local-cohomology-lemma-cd}
...
\source{stacks:0ECP}
\href{https://stacks.math.columbia.edu/tag/0ECP}{\texttt{Stacks tag 0ECP}}
\group{local-cohomology}
...
\begin{lemma}[Cd change rings]
\label{local-cohomology-lemma-cd-change-rings}
\source{stacks:0DXA}
\href{https://stacks.math.columbia.edu/tag/0DXA}{\texttt{Stacks tag 0DXA}}
\group{local-cohomology}
...
\begin{lemma}[Cd local]
\label{local-cohomology-lemma-cd-local}
\source{stacks:0DXB}
\href{https://stacks.math.columbia.edu/tag/0DXB}{\texttt{Stacks tag 0DXB}}
\group{local-cohomology}
...
\begin{lemma}[Cd dimension]
\label{local-cohomology-lemma-cd-dimension}
\source{stacks:0DXC}
\href{https://stacks.math.columbia.edu/tag/0DXC}{\texttt{Stacks tag 0DXC}}
\group{local-cohomology}
...
Lemma \ref{local-cohomology-lemma-cd-local} we may assume $A$ is local.
...
which implies what we want by Lemma \ref{local-cohomology-lemma-cd}.
...
\begin{lemma}[Cd is one]
\label{local-cohomology-lemma-cd-is-one}
\source{stacks:0DXD}
\href{https://stacks.math.columbia.edu/tag/0DXD}{\texttt{Stacks tag 0DXD}}
\group{local-cohomology}
...
\begin{proof}
This follows from Lemma \ref{local-cohomology-lemma-cd} and
Cohomology of Schemes, Lemma
\ref{coherent-lemma-quasi-compact-h1-zero-covering}.
\end{proof}

\begin{lemma}[Cd maximal]
\label{local-cohomology-lemma-cd-maximal}
\source{stacks:0DXE}
\href{https://stacks.math.columbia.edu/tag/0DXE}{\texttt{Stacks tag 0DXE}}
\group{local-cohomology}
...
Lemma \ref{local-cohomology-lemma-bound-cd}. Thus $H^d_\mathfrak m(A)$ is
...
By Lemma \ref{local-cohomology-lemma-cd-change-rings}
...
\begin{lemma}[Cd bound dim local]
\label{local-cohomology-lemma-cd-bound-dim-local}
\source{stacks:0DXF}
\href{https://stacks.math.columbia.edu/tag/0DXF}{\texttt{Stacks tag 0DXF}}
\group{local-cohomology}
...
\begin{proof}
By Lemma \ref{local-cohomology-lemma-cd-change-rings} we have
...
By Lemma \ref{local-cohomology-lemma-cd-maximal} this is equal to $\dim(A/\mathfrak p)$.
\end{proof}

\begin{lemma}[Cd blowup]
\label{local-cohomology-lemma-cd-blowup}
\source{stacks:0EHU}
\href{https://stacks.math.columbia.edu/tag/0EHU}{\texttt{Stacks tag 0EHU}}
\group{local-cohomology}
...
\source{stacks:0EEZ}
\href{https://stacks.math.columbia.edu/tag/0EEZ}{\texttt{Stacks tag 0EEZ}}
\group{local-cohomology}
...
the Serre subcategory described in Lemma \ref{local-cohomology-lemma-support}.
...
\source{stacks:0EF0}
\href{https://stacks.math.columbia.edu/tag/0EF0}{\texttt{Stacks tag 0EF0}}
\group{local-cohomology}
...
\begin{lemma}[Adjoint ext]
\label{local-cohomology-lemma-adjoint-ext}
\source{stacks:0EF1}
\href{https://stacks.math.columbia.edu/tag/0EF1}{\texttt{Stacks tag 0EF1}}
\group{local-cohomology}
...
\begin{lemma}[Equal plus]
\label{local-cohomology-lemma-equal-plus}
\source{stacks:0EF2}
\href{https://stacks.math.columbia.edu/tag/0EF2}{\texttt{Stacks tag 0EF2}}
\group{local-cohomology}
...
\begin{lemma}[Equal full]
\label{local-cohomology-lemma-equal-full}
\source{stacks:0EF3}
\href{https://stacks.math.columbia.edu/tag/0EF3}{\texttt{Stacks tag 0EF3}}
\group{local-cohomology}
...
Lemma \ref{local-cohomology-lemma-cd-dimension}.
By Lemma \ref{local-cohomology-lemma-adjoint-ext} we find that $H^0_T$ has bounded
cohomological dimension.

\medskip\noindent
Let $K \in D_T(A)$. We claim that $RH^0_T(K) \to K$ is an
isomorphism. We know this is true when $K$ is bounded below, see
Lemma \ref{local-cohomology-lemma-equal-plus}. However, since $H^0_T$ has bounded
...
\source{stacks:0EF4}
\href{https://stacks.math.columbia.edu/tag/0EF4}{\texttt{Stacks tag 0EF4}}
\group{local-cohomology}
...
Lemmas \ref{local-cohomology-lemma-adjoint}, \ref{local-cohomology-lemma-adjoint-ext},
\ref{local-cohomology-lemma-equal-plus}, and \ref{local-cohomology-lemma-equal-full}.
\end{remark}

\begin{lemma}[Torsion change rings]
\label{local-cohomology-lemma-torsion-change-rings}
\source{stacks:0EF5}
\href{https://stacks.math.columbia.edu/tag/0EF5}{\texttt{Stacks tag 0EF5}}
\group{local-cohomology}
...
Lemma \ref{local-cohomology-lemma-adjoint-ext}.
Correspondingly
...
\source{stacks:0EF6}
\href{https://stacks.math.columbia.edu/tag/0EF6}{\texttt{Stacks tag 0EF6}}
\group{local-cohomology}
...
\source{stacks:0EF7}
\href{https://stacks.math.columbia.edu/tag/0EF7}{\texttt{Stacks tag 0EF7}}
\group{local-cohomology}
...
with direct sums in $D(A)$ for example by Lemma \ref{local-cohomology-lemma-adjoint-ext},
...
Lemma \ref{local-cohomology-lemma-local-cohomology-ss}.

\begin{lemma}[Filter local cohomology]
\label{local-cohomology-lemma-filter-local-cohomology}
\source{stacks:0EF8}
\href{https://stacks.math.columbia.edu/tag/0EF8}{\texttt{Stacks tag 0EF8}}
\group{local-cohomology}
...
for some closed subset $Z \subset T$, see Lemma \ref{local-cohomology-lemma-adjoint-ext}.
...
\source{stacks:0EF9}
\href{https://stacks.math.columbia.edu/tag/0EF9}{\texttt{Stacks tag 0EF9}}
\group{local-cohomology}
...
H^i_{\mathfrak p A_\mathfrak p}(M_\mathfrak p)
$$
by Lemma \ref{local-cohomology-lemma-filter-local-cohomology}.
Thus we conclude by the initial remark of the proof.
\end{proof}

\begin{lemma}[Essential image]
\label{local-cohomology-lemma-essential-image}
\source{stacks:0EFA}
\href{https://stacks.math.columbia.edu/tag/0EFA}{\texttt{Stacks tag 0EFA}}
\group{local-cohomology}
...
$$
is pro-zero in Lemma \ref{local-cohomology-lemma-zero}; this uses that the function
...
\begin{lemma}[Check finiteness local cohomology by annihilator]
\label{local-cohomology-lemma-check-finiteness-local-cohomology-by-annihilator}
\source{stacks:0AW8}
\href{https://stacks.math.columbia.edu/tag/0AW8}{\texttt{Stacks tag 0AW8}}
\group{local-cohomology}
...
Lemma \ref{local-cohomology-lemma-adjoint-ext}. Since $H^i_T(M)$ is finitely generated
...
Remark \ref{local-cohomology-remark-upshot}. Thus we find that
...
\begin{lemma}[Check finiteness local cohomology locally]
\label{local-cohomology-lemma-check-finiteness-local-cohomology-locally}
\source{stacks:0AW9}
\href{https://stacks.math.columbia.edu/tag/0AW9}{\texttt{Stacks tag 0AW9}}
\group{local-cohomology}
...
for $i \leq n$. By
Lemma \ref{local-cohomology-lemma-check-finiteness-local-cohomology-by-annihilator}
we see that $H^i_Z(M)$ is finite for $i \leq n$.
\end{proof}

\begin{lemma}[Annihilate local cohomology]
\label{local-cohomology-lemma-annihilate-local-cohomology}
\source{stacks:0BPX}
\href{https://stacks.math.columbia.edu/tag/0BPX}{\texttt{Stacks tag 0BPX}}
\group{local-cohomology}
...
\begin{lemma}[Local finiteness for finite locally free]
\label{local-cohomology-lemma-local-finiteness-for-finite-locally-free}
\source{stacks:0BPY}
\href{https://stacks.math.columbia.edu/tag/0BPY}{\texttt{Stacks tag 0BPY}}
\group{local-cohomology}
...
Lemma \ref{local-cohomology-lemma-check-finiteness-local-cohomology-by-annihilator}.
Then Lemma \ref{local-cohomology-lemma-annihilate-local-cohomology}
...
Proposition \ref{local-cohomology-proposition-kollar}. The reader who is interested
in higher direct images or higher local cohomology groups should skip
ahead to Section \ref{local-cohomology-section-finiteness-pushforward-II} or
Section \ref{local-cohomology-section-finiteness-II} (which are developed
independently of the rest of this section).

\begin{lemma}[Check finiteness pushforward on associated points]
\label{local-cohomology-lemma-check-finiteness-pushforward-on-associated-points}
\source{stacks:0BJZ}
\href{https://stacks.math.columbia.edu/tag/0BJZ}{\texttt{Stacks tag 0BJZ}}
\group{local-cohomology}
...
\begin{lemma}[Finiteness pushforwards and H1 local]
\label{local-cohomology-lemma-finiteness-pushforwards-and-H1-local}
\source{stacks:0BK0}
\href{https://stacks.math.columbia.edu/tag/0BK0}{\texttt{Stacks tag 0BK0}}
\group{local-cohomology}
...
By Lemma \ref{local-cohomology-lemma-local-cohomology-is-local-cohomology}
...
\begin{lemma}[Finiteness pushforward]
\label{local-cohomology-lemma-finiteness-pushforward}
\source{stacks:0AWA}
\href{https://stacks.math.columbia.edu/tag/0AWA}{\texttt{Stacks tag 0AWA}}
\group{local-cohomology}
...
\begin{proof}
By Lemma \ref{local-cohomology-lemma-check-finiteness-pushforward-on-associated-points}
...
\begin{lemma}[Sharp finiteness pushforward]
\label{local-cohomology-lemma-sharp-finiteness-pushforward}
\source{stacks:0BK1}
\href{https://stacks.math.columbia.edu/tag/0BK1}{\texttt{Stacks tag 0BK1}}
\group{local-cohomology}
...
Using Lemmas \ref{local-cohomology-lemma-check-finiteness-local-cohomology-locally} and
\ref{local-cohomology-lemma-finiteness-pushforwards-and-H1-local} we reduce to
...
Moreover, condition (3) of Lemma \ref{local-cohomology-lemma-finiteness-pushforward}
...
\source{stacks:0BK2}
\href{https://stacks.math.columbia.edu/tag/0BK2}{\texttt{Stacks tag 0BK2}}
\group{local-cohomology}
...
$$
\begin{array}{cc}W_x \underset{i_x}{\downarrow}\underset{j'}{\longrightarrow} & \overline{\{x\}} \overset{i}{\downarrow} \\ U \overset{j}{\longrightarrow} & X\end{array}
$$
...
\begin{remark}[No finiteness pushforward]
\label{local-cohomology-remark-no-finiteness-pushforward}
\source{stacks:0AWC}
\href{https://stacks.math.columbia.edu/tag/0AWC}{\texttt{Stacks tag 0AWC}}
\group{local-cohomology}
...
\medskip\noindent
In fact, the converse of Lemma \ref{local-cohomology-lemma-sharp-finiteness-pushforward}
...
\begin{proposition}[Weak analogue of Hartogs' Theorem: On Noetherian schemes, the restriction of a coherent...]
\label{local-cohomology-proposition-kollar}
\source{stacks:0BK3}
\href{https://stacks.math.columbia.edu/tag/0BK3}{\texttt{Stacks tag 0BK3}}
\group{local-cohomology}
...
Lemmas \ref{local-cohomology-lemma-check-finiteness-pushforward-on-associated-points},
Remark \ref{local-cohomology-remark-closure}, and
Lemma \ref{local-cohomology-lemma-sharp-finiteness-pushforward}.
If (2) does not hold, then $j_*i_{x, *}\mathcal{O}_{W_x}$ is not finite
for some $x \in \text{Ass}(\mathcal{F})$ by the discussion in
Remark \ref{local-cohomology-remark-no-finiteness-pushforward}
(and Remark \ref{local-cohomology-remark-closure}).
Thus $j_*\mathcal{F}$ is not coherent by
Lemma \ref{local-cohomology-lemma-check-finiteness-pushforward-on-associated-points}.
\end{proof}

\begin{lemma}[Kollar finiteness H1 local]
\label{local-cohomology-lemma-kollar-finiteness-H1-local}
\source{stacks:0BL9}
\href{https://stacks.math.columbia.edu/tag/0BL9}{\texttt{Stacks tag 0BL9}}
\group{local-cohomology}
...
\begin{proof}
Follows immediately from Proposition \ref{local-cohomology-proposition-kollar}
via Lemma \ref{local-cohomology-lemma-finiteness-pushforwards-and-H1-local}.
\end{proof}
...
to higher direct images in Section \ref{local-cohomology-section-finiteness-pushforward-II}.

\begin{lemma}[Finiteness pushforward general]
\label{local-cohomology-lemma-finiteness-pushforward-general}
\source{stacks:0AWB}
\href{https://stacks.math.columbia.edu/tag/0AWB}{\texttt{Stacks tag 0AWB}}
\group{local-cohomology}
...
\begin{proof}
Let $x \in \text{Ass}(\mathcal{F})$. By Proposition \ref{local-cohomology-proposition-kollar}
...
\begin{lemma}[Ideal depth function]
\label{local-cohomology-lemma-ideal-depth-function}
\source{stacks:0DWX}
\href{https://stacks.math.columbia.edu/tag/0DWX}{\texttt{Stacks tag 0DWX}}
\group{local-cohomology}
...
\begin{lemma}[Depth function]
\label{local-cohomology-lemma-depth-function}
\source{stacks:0DWY}
\href{https://stacks.math.columbia.edu/tag/0DWY}{\texttt{Stacks tag 0DWY}}
\group{local-cohomology}
...
\begin{lemma}[Finite nr points next S]
\label{local-cohomology-lemma-finite-nr-points-next-S}
\source{stacks:0ECN}
\href{https://stacks.math.columbia.edu/tag/0ECN}{\texttt{Stacks tag 0ECN}}
\group{local-cohomology}
...
\source{stacks:0DWZ}
\href{https://stacks.math.columbia.edu/tag/0DWZ}{\texttt{Stacks tag 0DWZ}}
\group{local-cohomology}
...
\begin{proposition}[Annihilator]
\label{local-cohomology-proposition-annihilator}
\source{stacks:0EFC}
\href{https://stacks.math.columbia.edu/tag/0EFC}{\texttt{Stacks tag 0EFC}}
\group{local-cohomology}
...
by Lemma \ref{local-cohomology-lemma-torsion-change-rings}.
...
$$
of Lemma \ref{local-cohomology-lemma-local-cohomology-ss}.
...
\begin{lemma}[Kill local cohomology at prime]
\label{local-cohomology-lemma-kill-local-cohomology-at-prime}
\source{stacks:0EFE}
\href{https://stacks.math.columbia.edu/tag/0EFE}{\texttt{Stacks tag 0EFE}}
\group{local-cohomology}
...
Proposition \ref{local-cohomology-proposition-annihilator} holds.
...
Section \ref{local-cohomology-section-finiteness}. Using
...
\source{stacks:0EFD}
\href{https://stacks.math.columbia.edu/tag/0EFD}{\texttt{Stacks tag 0EFD}}
\group{local-cohomology}
...
\begin{proof}
Formal consequence of Proposition \ref{local-cohomology-proposition-annihilator} and
Lemma \ref{local-cohomology-lemma-check-finiteness-local-cohomology-by-annihilator}.
\end{proof}
...
\source{stacks:0BJS}
\href{https://stacks.math.columbia.edu/tag/0BJS}{\texttt{Stacks tag 0BJS}}
\group{local-cohomology}
...
\begin{lemma}[Change completion]
\label{local-cohomology-lemma-change-completion}
\source{stacks:0EHW}
\href{https://stacks.math.columbia.edu/tag/0EHW}{\texttt{Stacks tag 0EHW}}
\group{local-cohomology}
...
\begin{lemma}[Cutoff completion]
\label{local-cohomology-lemma-cutoff-completion}
\source{stacks:0BJT}
\href{https://stacks.math.columbia.edu/tag/0BJT}{\texttt{Stacks tag 0BJT}}
\group{local-cohomology}
...
$$
\begin{array}{ccc}\mathfrak p' \longrightarrow & \mathfrak q' \longrightarrow & A^\wedge \\ \mathfrak p \longrightarrow\uparrow & \mathfrak q \longrightarrow\uparrow & A \uparrow\end{array}
$$
Let us write
\begin{align*}
...
Theorem \ref{local-cohomology-theorem-finiteness} below.

\begin{lemma}[Local annihilator]
\label{local-cohomology-lemma-local-annihilator}
\source{stacks:0BJU}
\href{https://stacks.math.columbia.edu/tag/0BJU}{\texttt{Stacks tag 0BJU}}
\group{local-cohomology}
...
this is a special case of Proposition \ref{local-cohomology-proposition-finiteness}.
...
\source{stacks:0BJV}
\href{https://stacks.math.columbia.edu/tag/0BJV}{\texttt{Stacks tag 0BJV}}
\group{local-cohomology}
...
\begin{proof}
By Lemma \ref{local-cohomology-lemma-check-finiteness-local-cohomology-locally}
...
Using Lemma \ref{local-cohomology-lemma-cutoff} and
Dualizing Complexes, Lemma
\ref{dualizing-lemma-local-cohomology-and-restriction}
we reduce to the case
of a regular local ring which is a consequence of
Lemma \ref{local-cohomology-lemma-local-annihilator}
...
This follows from Lemma \ref{local-cohomology-lemma-cutoff-completion}.
\end{proof}

\begin{remark}[Astute reader]
\label{local-cohomology-remark-astute-reader}
\source{stacks:0BJW}
\href{https://stacks.math.columbia.edu/tag/0BJW}{\texttt{Stacks tag 0BJW}}
\group{local-cohomology}
...
of $A$. Namely, in the situation of Theorem \ref{local-cohomology-theorem-finiteness}
...
Section \ref{local-cohomology-section-finiteness-pushforward}.
In this section we reap the fruits of the labor done in
Section \ref{local-cohomology-section-finiteness-II}.

\begin{lemma}[Finiteness Rjstar]
\label{local-cohomology-lemma-finiteness-Rjstar}
\source{stacks:0BJY}
\href{https://stacks.math.columbia.edu/tag/0BJY}{\texttt{Stacks tag 0BJY}}
\group{local-cohomology}
...
Theorem \ref{local-cohomology-theorem-finiteness}
as elucidated by Remark \ref{local-cohomology-remark-astute-reader}.
\end{proof}

\begin{lemma}[Finiteness for finite locally free]
\label{local-cohomology-lemma-finiteness-for-finite-locally-free}
\source{stacks:0BLT}
\href{https://stacks.math.columbia.edu/tag/0BLT}{\texttt{Stacks tag 0BLT}}
\group{local-cohomology}
...
Lemma \ref{local-cohomology-lemma-local-finiteness-for-finite-locally-free}.
\end{proof}

\begin{lemma}[Annihilate Hp]
\label{local-cohomology-lemma-annihilate-Hp}
\source{stacks:0BM5}
\href{https://stacks.math.columbia.edu/tag/0BM5}{\texttt{Stacks tag 0BM5}}
\group{local-cohomology}
...
Section \ref{local-cohomology-section-annihilators}
to bounded below complexes with finite cohomology modules.

\begin{definition}[Depth complex]
\label{local-cohomology-definition-depth-complex}
\source{stacks:0EHY}
\href{https://stacks.math.columbia.edu/tag/0EHY}{\texttt{Stacks tag 0EHY}}
\group{local-cohomology}
...
\begin{proposition}[Annihilator complex]
\label{local-cohomology-proposition-annihilator-complex}
\source{stacks:0EHZ}
\href{https://stacks.math.columbia.edu/tag/0EHZ}{\texttt{Stacks tag 0EHZ}}
\group{local-cohomology}
...
is zero (this uses that $\delta$ is a dimension function).
This vanishes by the assumption in the lemma and $i \leq s$ and
our definition of depth in Definition \ref{local-cohomology-definition-depth-complex}.
...
Definition \ref{local-cohomology-definition-depth-complex}.
Set $n = \delta(\mathfrak q)$. Then
there does not exist an ideal $J \subset A$ with $V(J) \subset T'$
such that $J(E^{-n - i})_\mathfrak q = 0$.
...
in Sections \ref{local-cohomology-section-finiteness} and \ref{local-cohomology-section-finiteness-II}
to bounded below complexes with finite cohomology modules.

\begin{lemma}[Check finiteness local cohomology by annihilator complex]
\label{local-cohomology-lemma-check-finiteness-local-cohomology-by-annihilator-complex}
\source{stacks:0EI1}
\href{https://stacks.math.columbia.edu/tag/0EI1}{\texttt{Stacks tag 0EI1}}
\group{local-cohomology}
...
$J \subset A$ with $V(J) \subset T$, see
Lemma \ref{local-cohomology-lemma-adjoint-ext}. Since $H^i_T(K)$ is finitely generated
for $i \leq n$ we can find a $J \subset A$ as in (2) such that
...
Remark \ref{local-cohomology-remark-upshot}. Choose a distinguished triangle
$$
N[-a] \to K \to K' \to N[-a + 1]
$$
...
\begin{proposition}[Finiteness complex]
\label{local-cohomology-proposition-finiteness-complex}
\source{stacks:0EI2}
\href{https://stacks.math.columbia.edu/tag/0EI2}{\texttt{Stacks tag 0EI2}}
\group{local-cohomology}
...
Proposition \ref{local-cohomology-proposition-annihilator-complex} and
Lemma \ref{local-cohomology-lemma-check-finiteness-local-cohomology-by-annihilator-complex}.
\end{proof}
...
\begin{lemma}[Get depth 1 along Z]
\label{local-cohomology-lemma-get-depth-1-along-Z}
\source{stacks:0DX3}
\href{https://stacks.math.columbia.edu/tag/0DX3}{\texttt{Stacks tag 0DX3}}
\group{local-cohomology}
...
Set $M' = M / H^0_T(M)$ with $H^0_T(M)$ as in Section \ref{local-cohomology-section-supports}.
...
\begin{lemma}[Get depth 2 along Z]
\label{local-cohomology-lemma-get-depth-2-along-Z}
\source{stacks:0DX4}
\href{https://stacks.math.columbia.edu/tag/0DX4}{\texttt{Stacks tag 0DX4}}
\group{local-cohomology}
...
\begin{lemma}[Make S2 along Z]
\label{local-cohomology-lemma-make-S2-along-Z}
\source{stacks:0DX5}
\href{https://stacks.math.columbia.edu/tag/0DX5}{\texttt{Stacks tag 0DX5}}
\group{local-cohomology}
...
Lemma \ref{local-cohomology-lemma-get-depth-1-along-Z} for the subset $Z$ of $X$.
...
Lemma \ref{local-cohomology-lemma-depth-function}
...
the assumptions of Lemma \ref{local-cohomology-lemma-finiteness-pushforward-general}
are satisfied.
We conclude by setting $\mathcal{F}'' = j'_*(\mathcal{F}'|_{X \setminus Z'})$
and applying Lemma \ref{local-cohomology-lemma-get-depth-2-along-Z}.
...
\begin{lemma}[Make S2 along T simple]
\label{local-cohomology-lemma-make-S2-along-T-simple}
\source{stacks:0EI3}
\href{https://stacks.math.columbia.edu/tag/0EI3}{\texttt{Stacks tag 0EI3}}
\group{local-cohomology}
...
$\mathcal{F}$ constructed in Lemma \ref{local-cohomology-lemma-get-depth-1-along-Z} using $T'$.
Recall that $\mathcal{F}'$ is the quotient of $\mathcal{F}$
...
Lemma \ref{local-cohomology-lemma-get-depth-1-along-Z}. Applying
Lemmas \ref{local-cohomology-lemma-local-cohomology} and \ref{local-cohomology-lemma-adjoint-ext}
we see that $\mathcal{F}''$ corresponds to an $A$-module
$M''$ which fits into the short exact sequence
$$
0 \to M' \to M'' \to H^1_{T'}(M') \to 0
$$
By Proposition \ref{local-cohomology-proposition-finiteness} and our condition
...
Then conditions (1) and (2) follow from Lemma \ref{local-cohomology-lemma-get-depth-2-along-Z}.
...
\begin{lemma}[Make S2 along T]
\label{local-cohomology-lemma-make-S2-along-T}
\source{stacks:0EI4}
\href{https://stacks.math.columbia.edu/tag/0EI4}{\texttt{Stacks tag 0EI4}}
\group{local-cohomology}
...
constructed in Lemma \ref{local-cohomology-lemma-get-depth-1-along-Z} using $T$.
Second, let $\mathcal{F}' \to \mathcal{F}''$ be the unique
map of coherent modules construction in
Lemma \ref{local-cohomology-lemma-make-S2-along-T-simple} using $T'$.
...
\begin{lemma}[Cd top vanishing]
\label{local-cohomology-lemma-cd-top-vanishing}
\source{stacks:0EB1}
\href{https://stacks.math.columbia.edu/tag/0EB1}{\texttt{Stacks tag 0EB1}}
\group{local-cohomology}
...
\begin{proof}
By Lemma \ref{local-cohomology-lemma-cd-dimension} we know $\text{cd}(A, I) \leq d$.
We will use Lemma \ref{local-cohomology-lemma-isomorphism} to show
$$
...
by Lemma \ref{local-cohomology-lemma-cd-dimension}.
\end{proof}

\begin{lemma}[Cd top vanishing some module]
\label{local-cohomology-lemma-cd-top-vanishing-some-module}
\source{stacks:0EB2}
\href{https://stacks.math.columbia.edu/tag/0EB2}{\texttt{Stacks tag 0EB2}}
\group{local-cohomology}
...
for dimension reasons, see Lemma \ref{local-cohomology-lemma-cd-dimension}.
...
\begin{lemma}[Top coh divisible]
\label{local-cohomology-lemma-top-coh-divisible}
\source{stacks:0EB3}
\href{https://stacks.math.columbia.edu/tag/0EB3}{\texttt{Stacks tag 0EB3}}
\group{local-cohomology}
...
Thus $H^d_{V(I)}(M/fM) = 0$ by Lemma \ref{local-cohomology-lemma-cd-dimension}.
Thus $H^d_{V(I)}(fM) \to H^d_{V(I)}(M)$ is surjective.
Since by Lemma \ref{local-cohomology-lemma-cd-dimension} we know $\text{cd}(A, I) \leq d$
we also see that the surjection $M \to fM$, $x \mapsto fx$
induces a surjection $H^d_{V(I)}(M) \to H^d_{V(I)}(fM)$.
\end{proof}

\begin{lemma}[Cd bound dualizing]
\label{local-cohomology-lemma-cd-bound-dualizing}
\source{stacks:0EB4}
\href{https://stacks.math.columbia.edu/tag/0EB4}{\texttt{Stacks tag 0EB4}}
\group{local-cohomology}
...
Lemma \ref{local-cohomology-lemma-sitting-in-degrees}.
...
By Lemma \ref{local-cohomology-lemma-top-coh-divisible} we conlude $H^d_{V(I)}(\omega_A) = 0$.
Then we conclude by Lemma \ref{local-cohomology-lemma-cd-top-vanishing-some-module}
...
\begin{lemma}[Inverse system symbolic powers]
\label{local-cohomology-lemma-inverse-system-symbolic-powers}
\source{stacks:0EB5}
\href{https://stacks.math.columbia.edu/tag/0EB5}{\texttt{Stacks tag 0EB5}}
\group{local-cohomology}
...
\begin{proposition}[Hartshorne Lichtenbaum vanishing]
\label{local-cohomology-proposition-Hartshorne-Lichtenbaum-vanishing}
\source{stacks:0EB6}
\href{https://stacks.math.columbia.edu/tag/0EB6}{\texttt{Stacks tag 0EB6}}
\group{local-cohomology}
...
\ref{dualizing-lemma-local-cohomology-and-restriction}.
By Lemma \ref{local-cohomology-lemma-cd-top-vanishing-some-module}
...
By Lemma \ref{local-cohomology-lemma-cd-top-vanishing}
it suffices to prove the lemma for $\mathfrak p$.

\medskip\noindent
By Lemma \ref{local-cohomology-lemma-cd-bound-dualizing} it suffices to show that
...
$$
By Lemma \ref{local-cohomology-lemma-inverse-system-symbolic-powers}
we see that the colimit is the same as
$$
\colim \text{Ext}^0_A(A/\mathfrak p^{(n)}, \omega_A^\bullet)
$$
Since $\text{depth}(A/\mathfrak p^{(n)}) = 1$ we see that
these ext groups are zero by Lemma \ref{local-cohomology-lemma-sitting-in-degrees}
as desired.
\end{proof}

\begin{lemma}[Affine complement]
\label{local-cohomology-lemma-affine-complement}
\source{stacks:0EB7}
\href{https://stacks.math.columbia.edu/tag/0EB7}{\texttt{Stacks tag 0EB7}}
\group{local-cohomology}
...
Proposition \ref{local-cohomology-proposition-Hartshorne-Lichtenbaum-vanishing}
holds and we conclude. The statement on affineness
follows from Lemma \ref{local-cohomology-lemma-cd-is-one}.
\end{proof}
...
\begin{lemma}[Annihilator frobenius module]
\label{local-cohomology-lemma-annihilator-frobenius-module}
\source{stacks:0EBV}
\href{https://stacks.math.columbia.edu/tag/0EBV}{\texttt{Stacks tag 0EBV}}
\group{local-cohomology}
...
\source{stacks:0EBW}
\href{https://stacks.math.columbia.edu/tag/0EBW}{\texttt{Stacks tag 0EBW}}
\group{local-cohomology}
...
\source{stacks:0EBX}
\href{https://stacks.math.columbia.edu/tag/0EBX}{\texttt{Stacks tag 0EBX}}
\group{local-cohomology}
...
\source{stacks:0EBY}
\href{https://stacks.math.columbia.edu/tag/0EBY}{\texttt{Stacks tag 0EBY}}
\group{local-cohomology}
...
\begin{proof}
Use Lemmas \ref{local-cohomology-lemma-1} and \ref{local-cohomology-lemma-2} and induction.
\end{proof}

\begin{lemma}[Flat extension independent]
\label{local-cohomology-lemma-flat-extension-independent}
\source{stacks:0EBZ}
\href{https://stacks.math.columbia.edu/tag/0EBZ}{\texttt{Stacks tag 0EBZ}}
\group{local-cohomology}
...
\source{stacks:0EC0}
\href{https://stacks.math.columbia.edu/tag/0EC0}{\texttt{Stacks tag 0EC0}}
\group{local-cohomology}
...
are independent, see Lemma \ref{local-cohomology-lemma-flat-extension-independent}.
Hence $\text{length}_A(A/(x_1^p, \ldots, x_r^p)) = p^r$ by
Lemma \ref{local-cohomology-lemma-3}.
...
\begin{lemma}[Structure torsion D module regular]
\label{local-cohomology-lemma-structure-torsion-D-module-regular}
\source{stacks:0EC2}
\href{https://stacks.math.columbia.edu/tag/0EC2}{\texttt{Stacks tag 0EC2}}
\group{local-cohomology}
...
\begin{lemma}[Structure torsion Frobenius regular]
\label{local-cohomology-lemma-structure-torsion-Frobenius-regular}
\source{stacks:0EC3}
\href{https://stacks.math.columbia.edu/tag/0EC3}{\texttt{Stacks tag 0EC3}}
\group{local-cohomology}
...
Lemma \ref{local-cohomology-lemma-frobenius-flat-regular}.
...
\source{stacks:0EC5}
\href{https://stacks.math.columbia.edu/tag/0EC5}{\texttt{Stacks tag 0EC5}}
\group{local-cohomology}
...
\source{stacks:0EC6}
\href{https://stacks.math.columbia.edu/tag/0EC6}{\texttt{Stacks tag 0EC6}}
\group{local-cohomology}
...
\begin{lemma}[Etale derivation]
\label{local-cohomology-lemma-etale-derivation}
\source{stacks:0EC7}
\href{https://stacks.math.columbia.edu/tag/0EC7}{\texttt{Stacks tag 0EC7}}
\group{local-cohomology}
...
\source{stacks:0EC8}
\href{https://stacks.math.columbia.edu/tag/0EC8}{\texttt{Stacks tag 0EC8}}
\group{local-cohomology}

We can upgrade Lemmas \ref{local-cohomology-lemma-derivation} and \ref{local-cohomology-lemma-etale-derivation}
to include higher order differential operators, using
Algebra, Lemma \ref{algebra-lemma-formally-etale-principal-parts} and
Remark \ref{algebra-remark-formally-etale-differential-operators}.
If we ever need this we will state and prove a
precise lemma here.
\end{remark}

\begin{lemma}[Etale frobenius]
\label{local-cohomology-lemma-etale-frobenius}
\source{stacks:0EC9}
\href{https://stacks.math.columbia.edu/tag/0EC9}{\texttt{Stacks tag 0EC9}}
\group{local-cohomology}
...
Lemma \ref{local-cohomology-lemma-characterize-vanishing-tor-ext-above-e}.

\begin{lemma}[Map tor 1 zero]
\label{local-cohomology-lemma-map-tor-1-zero}
\source{stacks:0G9T}
\href{https://stacks.math.columbia.edu/tag/0G9T}{\texttt{Stacks tag 0G9T}}
\group{local-cohomology}
...
$$
\begin{array}{ccccc}0 \longrightarrow & K \longrightarrow\downarrow & R^{\oplus r} \longrightarrow\downarrow & M \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & K' \longrightarrow & \bigoplus_{i \in I} R \longrightarrow & M' \longrightarrow & 0\end{array}
$$
...
\begin{lemma}[Characterize vanishing tor ext above e]
\label{local-cohomology-lemma-characterize-vanishing-tor-ext-above-e}
\source{stacks:0G9V}
\href{https://stacks.math.columbia.edu/tag/0G9V}{\texttt{Stacks tag 0G9V}}
\group{local-cohomology}
...
$$
\begin{array}{ccccc}\ldots \longrightarrow & P_{e + 1} \longrightarrow\overset{0}{\downarrow} & P_e \longrightarrow\overset{a_e - \varphi}{\downarrow} & P_{e - 1} \longrightarrow\overset{a_{e - 1}}{\downarrow} & \ldots \\ \ldots \longrightarrow & P'_{e + 1} \longrightarrow & P'_e \longrightarrow & P'_{e - 1} \longrightarrow & \ldots\end{array}
$$
...
and we conclude from Lemma \ref{local-cohomology-lemma-map-tor-1-zero} that
...
\begin{lemma}[Cd sequence Koszul]
\label{local-cohomology-lemma-cd-sequence-Koszul}
\source{stacks:0EH1}
\href{https://stacks.math.columbia.edu/tag/0EH1}{\texttt{Stacks tag 0EH1}}
\group{local-cohomology}

Let $I$ be an ideal of a Noetherian ring $A$.
For all $n \geq 1$ there exists an $m > n$ such that the map
$A/I^m \to A/I^n$ satisfies the equivalent conditions of
Lemma \ref{local-cohomology-lemma-characterize-vanishing-tor-ext-above-e} with
$e = \text{cd}(A, I)$.
\end{lemma}

\begin{proof}
Let $\xi \in \Ext^{e + 1}_A(A/I^n, N)$ be the element constructed in
Lemma \ref{local-cohomology-lemma-characterize-vanishing-tor-ext-above-e} part (5).
...
\medskip\noindent
In Remark \ref{local-cohomology-remark-strict-pro-isomorphism} we will apply this to show that
...
\begin{lemma}[Maps zero fixed torsion]
\label{local-cohomology-lemma-maps-zero-fixed-torsion}
\source{stacks:0G9X}
\href{https://stacks.math.columbia.edu/tag/0G9X}{\texttt{Stacks tag 0G9X}}
\group{local-cohomology}
...
\begin{lemma}[Annihilates affine]
\label{local-cohomology-lemma-annihilates-affine}
\source{stacks:0G9Y}
\href{https://stacks.math.columbia.edu/tag/0G9Y}{\texttt{Stacks tag 0G9Y}}
\group{local-cohomology}
...
\begin{lemma}[Compute tor Iq]
\label{local-cohomology-lemma-compute-tor-Iq}
\source{stacks:0G9Z}
\href{https://stacks.math.columbia.edu/tag/0G9Z}{\texttt{Stacks tag 0G9Z}}
\group{local-cohomology}
...
\begin{lemma}[Annihilates]
\label{local-cohomology-lemma-annihilates}
\source{stacks:0GA0}
\href{https://stacks.math.columbia.edu/tag/0GA0}{\texttt{Stacks tag 0GA0}}
\group{local-cohomology}
...
Lemma \ref{local-cohomology-lemma-annihilates-affine}.
\end{proof}

\begin{lemma}[Annihilates tors]
\label{local-cohomology-lemma-annihilates-tors}
\source{stacks:0GA1}
\href{https://stacks.math.columbia.edu/tag/0GA1}{\texttt{Stacks tag 0GA1}}
\group{local-cohomology}
...
$$
by Lemma \ref{local-cohomology-lemma-compute-tor-Iq}.
...
by $I^c$ where $c = c(A, I)$ is as in Lemma \ref{local-cohomology-lemma-annihilates}
...
\begin{lemma}[Tor maps vanish]
\label{local-cohomology-lemma-tor-maps-vanish}
\source{stacks:0GA2}
\href{https://stacks.math.columbia.edu/tag/0GA2}{\texttt{Stacks tag 0GA2}}
\group{local-cohomology}
...
\begin{proof}
Let $c_1$ be the constant found in Lemma \ref{local-cohomology-lemma-annihilates-tors}.
...
Lemma \ref{local-cohomology-lemma-maps-zero-fixed-torsion}
...
$$
\begin{array}{ccc} &  & \text{Tor}_{i + 1}(M/a_i^{c_1}M, A/I^q) \downarrow \\ \text{Tor}_i(M[a_i^{c_1}], A/I^q) \longrightarrow & \text{Tor}_i(M, A/I^q) \longrightarrow\overset{0}{\searrow} & \text{Tor}_i(E, A/I^q) \downarrow \\  &  & \text{Tor}_i(M, A/I^q)\end{array}
$$
...
\begin{proposition}[Uniform artin rees]
\label{local-cohomology-proposition-uniform-artin-rees}
\source{stacks:0GA3}
\href{https://stacks.math.columbia.edu/tag/0GA3}{\texttt{Stacks tag 0GA3}}
\group{local-cohomology}
...
Lemma \ref{local-cohomology-lemma-characterize-vanishing-tor-ext-above-e} with $e = t$.
\end{proposition}

\begin{proof}
Immediate consequence of Lemmas
\ref{local-cohomology-lemma-tor-maps-vanish} and
\ref{local-cohomology-lemma-characterize-vanishing-tor-ext-above-e}.
\end{proof}

\begin{remark}[Better bound]
\label{local-cohomology-remark-better-bound}
\source{stacks:0GA4}
\href{https://stacks.math.columbia.edu/tag/0GA4}{\texttt{Stacks tag 0GA4}}
\group{local-cohomology}

The paper \cite{AHS} shows, besides many other things, that if $A$ is local,
then Proposition \ref{local-cohomology-proposition-uniform-artin-rees} also holds
with $e = t$ replaced by $e = \dim(A)$. Looking at
Lemma \ref{local-cohomology-lemma-cd-sequence-Koszul} it is natural to ask whether
Proposition \ref{local-cohomology-proposition-uniform-artin-rees}
holds with $e = t$ replaced with $e = \text{cd}(A, I)$. We don't know.
\end{remark}

\begin{remark}[Strict pro isomorphism]
\label{local-cohomology-remark-strict-pro-isomorphism}
\source{stacks:0GA5}
\href{https://stacks.math.columbia.edu/tag/0GA5}{\texttt{Stacks tag 0GA5}}
\group{local-cohomology}
...
Proposition \ref{local-cohomology-proposition-uniform-artin-rees} can be avoided).
...
Our goal is to prove Lemma \ref{local-cohomology-lemma-bound-two-term-complex} which we will
...
the fibre product
$$
\begin{array}{cc}Y \longrightarrow\downarrow & X \overset{p}{\downarrow} \\ \Spec(A/I) \longrightarrow & \Spec(A)\end{array}
$$
...
\begin{lemma}[Bound q and d]
\label{local-cohomology-lemma-bound-q-and-d}
\source{stacks:0GA7}
\href{https://stacks.math.columbia.edu/tag/0GA7}{\texttt{Stacks tag 0GA7}}
\group{local-cohomology}
...
$$
\begin{array}{ccccc}0 \longrightarrow & I^{q + 1}/I^{q + 1 + n} \downarrow\longrightarrow & I^q/I^{q + 1 + n} \downarrow\longrightarrow & I^q/I^{q + 1} \downarrow\longrightarrow & 0 \\ 0 \longrightarrow & H^0(X, \mathcal{O}_{Y_n}(q + 1)) \longrightarrow & H^0(X, \mathcal{O}_{Y_{n + 1}}(q)) \longrightarrow & H^0(Y, \mathcal{O}_Y(q)) \longrightarrow & 0\end{array}
$$
...
\begin{lemma}[Almost exactness]
\label{local-cohomology-lemma-almost-exactness}
\source{stacks:0GA8}
\href{https://stacks.math.columbia.edu/tag/0GA8}{\texttt{Stacks tag 0GA8}}
\group{local-cohomology}
...
\begin{lemma}[Annihilated]
\label{local-cohomology-lemma-annihilated}
\source{stacks:0GA9}
\href{https://stacks.math.columbia.edu/tag/0GA9}{\texttt{Stacks tag 0GA9}}
\group{local-cohomology}
...
\begin{lemma}[Vanishing coh almost projective]
\label{local-cohomology-lemma-vanishing-coh-almost-projective}
\source{stacks:0GAA}
\href{https://stacks.math.columbia.edu/tag/0GAA}{\texttt{Stacks tag 0GAA}}
\group{local-cohomology}
...
$$
By Lemma \ref{local-cohomology-lemma-almost-exactness} the coherent module $\mathcal{F}$
is scheme theoretically supported on $Y_c$.
...
This is true by Lemma \ref{local-cohomology-lemma-bound-q-and-d}.
...
$$
\begin{array}{ccc}H^{i + 1}(X, p^*K(q)) \longrightarrow\downarrow & H^{i + 1}(X, \mathcal{G}(q)) \longrightarrow\downarrow\swarrow & H^{i + 2}(X, \mathcal{F}(q)) \downarrow \\ H^{i + 1}(X, p^*K(q - c)) \longrightarrow\downarrow & H^{i + 1}(X, \mathcal{G}(q - c)) \longrightarrow\downarrow & H^{i + 2}(X, \mathcal{F}(q - c)) \\ H^{i + 1}(X, p^*K(q - (d - 1 - i)c)) \longrightarrow & H^{i + 1}(X, \mathcal{G}(q - (d - 1 - i)c)) & \end{array}
$$
...
$p^*K(q - c)$ by Lemma \ref{local-cohomology-lemma-annihilated}.
...
Lemma \ref{local-cohomology-lemma-bound-q-and-d} and this easily proves the statement.
...
\source{stacks:0GAB}
\href{https://stacks.math.columbia.edu/tag/0GAB}{\texttt{Stacks tag 0GAB}}
\group{local-cohomology}
...
\begin{lemma}[Factor hom]
\label{local-cohomology-lemma-factor-hom}
\source{stacks:0GAC}
\href{https://stacks.math.columbia.edu/tag/0GAC}{\texttt{Stacks tag 0GAC}}
\group{local-cohomology}
...
$$
with notation as in Remark \ref{local-cohomology-remark-duals}.
The discussion in Remark \ref{local-cohomology-remark-duals} shows
the cokernel and kernel of $can : p^*(M^\vee) \to (p^*M)^\vee$
are scheme theoretically supported on $Y_c$. By
Lemma \ref{local-cohomology-lemma-annihilated} the map
...
$$
By Lemma \ref{local-cohomology-lemma-vanishing-coh-almost-projective} part (5),
...
$$
\begin{array}{cc}p^*(M^\vee) \underset{can}{\downarrow}\underset{p^*e_z}{\longrightarrow} & \mathcal{O}_{Y_n} \downarrow \\ (p^*M)^\vee \overset{e_{p^*z}}{\longrightarrow} & \mathcal{O}_{Y_n}\end{array}
$$
...
I^{n - (1 + d)c}/I^{2n - (1 + d)c}$ by Lemma \ref{local-cohomology-lemma-bound-q-and-d} and
...
$$
and then we use
Lemma \ref{local-cohomology-lemma-vanishing-coh-almost-projective} part (4)
...
\begin{lemma}[Bound two term complex]
\label{local-cohomology-lemma-bound-two-term-complex}
\source{stacks:0GAD}
\href{https://stacks.math.columbia.edu/tag/0GAD}{\texttt{Stacks tag 0GAD}}
\group{local-cohomology}
...
By Lemma \ref{local-cohomology-lemma-factor-hom}
...
$$
\begin{array}{ccc}K^0 &  &  \\ K^{-1} \uparrow\overset{\varphi}{\longrightarrow} & I^n/I^{2n} \longrightarrow & I^{n - c}/I^{2n - c}\end{array}
$$
Pulling back to $X$ and using the map
$p^*(I^n/I^{2n}) \to \mathcal{O}_{Y_n}(n)$
we find a solid diagram
$$
\begin{array}{ccc}p^*K^0 \searrow &  &  \\ p^*K^{-1} \uparrow\longrightarrow & \mathcal{O}_{Y_n}(n) \longrightarrow & \mathcal{O}_{Y_n}(n - c)\end{array}
$$
