...
\ref{intersection-section-pushforward-and-rational-equivalence}, and
...
Example \ref{intersection-example-naive-multiplicity-wrong} shows that higher
...
\ref{intersection-section-computing-intersection-multiplicities}, and
...
\ref{intersection-section-flat-pullback-and-intersection-products}, and
...
\ref{intersection-section-general-pullback}, and
...
\begin{lemma}[Push coherent]
\label{intersection-lemma-push-coherent}
\source{stacks:0AZD}
\href{https://stacks.math.columbia.edu/tag/0AZD}{\texttt{Stacks tag 0AZD}}
\group{intersection}
...
\source{stacks:0B0N}
\href{https://stacks.math.columbia.edu/tag/0B0N}{\texttt{Stacks tag 0B0N}}
\group{intersection}
...
Let $Z \subset Y$ be a $k$-dimensional closed subvariety. We define
...
\source{stacks:0AZF}
\href{https://stacks.math.columbia.edu/tag/0AZF}{\texttt{Stacks tag 0AZF}}
\group{intersection}
...
\source{stacks:0B0P}
\href{https://stacks.math.columbia.edu/tag/0B0P}{\texttt{Stacks tag 0B0P}}
\group{intersection}
...
However, in Section \ref{intersection-section-alternative} we will show that
...
Lemma \ref{intersection-lemma-rational-equivalence}
...
\begin{lemma}[Rational equivalence]
\label{intersection-lemma-rational-equivalence}
\source{stacks:0AZI}
\href{https://stacks.math.columbia.edu/tag/0AZI}{\texttt{Stacks tag 0AZI}}
\group{intersection}
...
$$
\begin{array}{cc}Z_k(X) \longrightarrow\underset{f_*}{\downarrow} & \CH_k(X) \overset{f_*}{\downarrow} \\ Z_k(Y) \longrightarrow & \CH_k(Y)\end{array}
$$
...
Therefore we obtain a commutative diagram
$$
\begin{array}{cc}Z_{k + r}(X) \longrightarrow & \CH_{k + r}(X) \\ Z_k(Y) \longrightarrow\overset{f^*}{\uparrow} & \CH_k(Y) \underset{f^*}{\uparrow}\end{array}
$$
of groups of $k$-cycles.
...
$$
\begin{array}{cccc}\bigoplus Z_k(Z_i) \longrightarrow\downarrow & Z_k(X) \longrightarrow\downarrow & Z_k(U) \downarrow\longrightarrow & 0 \\ \bigoplus \CH_k(Z_i) \longrightarrow & \CH_k(X) \longrightarrow & \CH_k(U) \longrightarrow & 0\end{array}
$$
...
\begin{lemma}[Dimension product varieties]
\label{intersection-lemma-dimension-product-varieties}
\source{stacks:0AZM}
\href{https://stacks.math.columbia.edu/tag/0AZM}{\texttt{Stacks tag 0AZM}}
\group{intersection}
...
$f|_U$ as
$$
\begin{array}{ccc}U \underset{i}{\longrightarrow}\searrow &  & \mathbf{A}^n_Y \swarrow \\  & Y & \end{array}
$$
...
\begin{lemma}[Pullback by regular immersion]
\label{intersection-lemma-pullback-by-regular-immersion}
\source{stacks:0AZN}
\href{https://stacks.math.columbia.edu/tag/0AZN}{\texttt{Stacks tag 0AZN}}
\group{intersection}
...
\begin{lemma}[Diagonal regular immersion]
\label{intersection-lemma-diagonal-regular-immersion}
\source{stacks:0B0Q}
\href{https://stacks.math.columbia.edu/tag/0B0Q}{\texttt{Stacks tag 0B0Q}}
\group{intersection}
...
\begin{lemma}[Intersect in smooth]
\label{intersection-lemma-intersect-in-smooth}
\source{stacks:0AZP}
\href{https://stacks.math.columbia.edu/tag/0AZP}{\texttt{Stacks tag 0AZP}}
\group{intersection}
...
\begin{proof}
\uses{intersection-lemma-diagonal-regular-immersion, intersection-lemma-pullback-by-regular-immersion}

Since $V \cap W = \Delta^{-1}(V \times W)$ (scheme theoretically)
we conclude by Lemmas \ref{intersection-lemma-diagonal-regular-immersion} and
\ref{intersection-lemma-pullback-by-regular-immersion}.
\end{proof}

This lemma suggests the following definition.

\begin{definition}[Proper intersection]
\label{intersection-definition-proper-intersection}
\source{stacks:0AZQ}
\href{https://stacks.math.columbia.edu/tag/0AZQ}{\texttt{Stacks tag 0AZQ}}
\group{intersection}
...
\begin{lemma}[Tensor coherent]
\label{intersection-lemma-tensor-coherent}
\source{stacks:0AZS}
\href{https://stacks.math.columbia.edu/tag/0AZS}{\texttt{Stacks tag 0AZS}}
\group{intersection}
...
\begin{lemma}[Compute tor nonsingular]
\label{intersection-lemma-compute-tor-nonsingular}
\source{stacks:0AZT}
\href{https://stacks.math.columbia.edu/tag/0AZT}{\texttt{Stacks tag 0AZT}}
\group{intersection}
...
\begin{proof}
\uses{intersection-lemma-tensor-coherent}

The result on stalks was discussed above and it implies the support
condition. The $\text{Tor}$'s are coherent by
Lemma \ref{intersection-lemma-tensor-coherent}. The vanishing of negative
...
In this case Lemma \ref{intersection-lemma-intersect-in-smooth} tells us all irreducible
...
(Lemma \ref{intersection-lemma-compute-tor-nonsingular}).
...
\source{stacks:0B1I}
\href{https://stacks.math.columbia.edu/tag/0B1I}{\texttt{Stacks tag 0B1I}}
\group{intersection}
...
(in the sense of Section \ref{intersection-section-cycle-of-closed}) of $Z$
...
\begin{example}[Naive multiplicity wrong]
\label{intersection-example-naive-multiplicity-wrong}
\source{stacks:0B2S}
\href{https://stacks.math.columbia.edu/tag/0B2S}{\texttt{Stacks tag 0B2S}}
\group{intersection}

\uses{intersection-lemma-transversal}
...
$x - z = y - w = 0$ (Lemma \ref{intersection-lemma-transversal}). To make an
actual example, take
...
\source{stacks:0AZV}
\href{https://stacks.math.columbia.edu/tag/0AZV}{\texttt{Stacks tag 0AZV}}
\group{intersection}
...
\begin{lemma}[Multiplicity ses]
\label{intersection-lemma-multiplicity-ses}
\source{stacks:0AZW}
\href{https://stacks.math.columbia.edu/tag/0AZW}{\texttt{Stacks tag 0AZW}}
\group{intersection}
...
\begin{lemma}[Multiplicity as a sum]
\label{intersection-lemma-multiplicity-as-a-sum}
\source{stacks:0AZX}
\href{https://stacks.math.columbia.edu/tag/0AZX}{\texttt{Stacks tag 0AZX}}
\group{intersection}
...
\source{stacks:0AZY}
\href{https://stacks.math.columbia.edu/tag/0AZY}{\texttt{Stacks tag 0AZY}}
\group{intersection}
...
\begin{theorem}[Multiplicity with koszul]
\label{intersection-theorem-multiplicity-with-koszul}
\source{stacks:0AZZ}
\href{https://stacks.math.columbia.edu/tag/0AZZ}{\texttt{Stacks tag 0AZZ}}
\group{intersection}
...
\begin{proof}
\uses{intersection-lemma-leading-coefficient}
...
The lemma follows from Lemma \ref{intersection-lemma-leading-coefficient}
...
\source{stacks:0B00}
\href{https://stacks.math.columbia.edu/tag/0B00}{\texttt{Stacks tag 0B00}}
\group{intersection}
...
\begin{lemma}[Intersection multiplicity CM]
\label{intersection-lemma-intersection-multiplicity-CM}
\source{stacks:0B02}
\href{https://stacks.math.columbia.edu/tag/0B02}{\texttt{Stacks tag 0B02}}
\group{intersection}
...
\begin{lemma}[One ideal ci]
\label{intersection-lemma-one-ideal-ci}
\source{stacks:0B03}
\href{https://stacks.math.columbia.edu/tag/0B03}{\texttt{Stacks tag 0B03}}
\group{intersection}

\uses{intersection-remark-trivial-generalization}
...
$$
Here $e_I(M, r)$ is as in Remark \ref{intersection-remark-trivial-generalization}.
\end{lemma}

\begin{proof}
\uses{intersection-theorem-multiplicity-with-koszul}
...
Theorem \ref{intersection-theorem-multiplicity-with-koszul} if $I$ is an ideal
...
Theorem \ref{intersection-theorem-multiplicity-with-koszul} in this case as well.
\end{proof}

\begin{lemma}[Multiplicity with lci]
\label{intersection-lemma-multiplicity-with-lci}
\source{stacks:0B04}
\href{https://stacks.math.columbia.edu/tag/0B04}{\texttt{Stacks tag 0B04}}
\group{intersection}
...
\begin{proof}
\uses{intersection-lemma-one-ideal-ci, intersection-lemma-pullback-by-regular-immersion}

The equality
$$
e(X, V\cdot W, Z) = e_{(f_1, \ldots, f_c)}(\mathcal{O}_{W, \xi}, c)
$$
follows from the more general Lemma \ref{intersection-lemma-one-ideal-ci}.
...
and then Lemma \ref{intersection-lemma-pullback-by-regular-immersion}
...
\begin{lemma}[Multiplicity with effective Cartier divisor]
\label{intersection-lemma-multiplicity-with-effective-Cartier-divisor}
\source{stacks:0B05}
\href{https://stacks.math.columbia.edu/tag/0B05}{\texttt{Stacks tag 0B05}}
\group{intersection}

\uses{intersection-lemma-multiplicity-with-lci}
In Lemma \ref{intersection-lemma-multiplicity-with-lci} assume that  $c = 1$, i.e., $V$
...
\begin{lemma}[Multiplicity lci CM]
\label{intersection-lemma-multiplicity-lci-CM}
\source{stacks:0B06}
\href{https://stacks.math.columbia.edu/tag/0B06}{\texttt{Stacks tag 0B06}}
\group{intersection}

\uses{intersection-lemma-multiplicity-with-lci}
In Lemma \ref{intersection-lemma-multiplicity-with-lci} assume that
...
\begin{proof}
\uses{intersection-lemma-intersection-multiplicity-CM, intersection-lemma-multiplicity-with-lci}

This follows immediately from Lemma \ref{intersection-lemma-intersection-multiplicity-CM}.
Alternatively, we can deduce it from Lemma \ref{intersection-lemma-multiplicity-with-lci}.
...
Definition \ref{intersection-definition-proper-intersection}.
In this case we define
$$
\alpha \cdot \beta = \sum\nolimits_{i,j} n_i m_j W_i \cdot V_j.
$$
where $W_i \cdot V_j$ is as defined in Section \ref{intersection-section-tor-formula}.
If $\beta = [V]$ where $V$ is a closed subvariety of dimension $s$,
then we sometimes write $\alpha \cdot \beta = \alpha \cdot V$.

\begin{lemma}[Rational equivalence and intersection]
\label{intersection-lemma-rational-equivalence-and-intersection}
\source{stacks:0B07}
\href{https://stacks.math.columbia.edu/tag/0B07}{\texttt{Stacks tag 0B07}}
\group{intersection}
...
\begin{proof}
\uses{intersection-lemma-multiplicity-with-effective-Cartier-divisor}
...
Lemma \ref{intersection-lemma-multiplicity-with-effective-Cartier-divisor}.
Part (1)(b) holds because $W_a \to X \times \mathbf{P}^1 \to X$ maps
isomorphically onto its image which is how we viewed $W_a$
as a closed subscheme of $X$ in Section \ref{intersection-section-rational-equivalence}.
...
\begin{lemma}[Transversal subschemes]
\label{intersection-lemma-transversal-subschemes}
\source{stacks:0B1J}
\href{https://stacks.math.columbia.edu/tag/0B1J}{\texttt{Stacks tag 0B1J}}
\group{intersection}
...
(in the sense of Section \ref{intersection-section-cycle-of-closed}) of $T$
...
By Lemma \ref{intersection-lemma-transversal} and its proof we see that
...
$1$ by Lemma \ref{intersection-lemma-transversal}.
\end{proof}
...
(Lemma \ref{intersection-lemma-dimension-product-varieties}).
...
\begin{lemma}[Exterior product rational equivalence]
\label{intersection-lemma-exterior-product-rational-equivalence}
\source{stacks:0B0S}
\href{https://stacks.math.columbia.edu/tag/0B0S}{\texttt{Stacks tag 0B0S}}
\group{intersection}
...
\begin{proof}
\uses{intersection-lemma-dimension-product-varieties}
...
$V \times W_a$ (see Lemma \ref{intersection-lemma-dimension-product-varieties}).
...
$$
\begin{array}{cc}Z_r(X) \otimes_\mathbf{Z} Z_s(Y) \longrightarrow\downarrow & Z_{r + s}(X \times Y) \downarrow \\ \CH_r(X) \otimes_\mathbf{Z} \CH_s(Y) \longrightarrow & \CH_{r + s}(X \times Y)\end{array}
$$
...
\begin{lemma}[Exterior product]
\label{intersection-lemma-exterior-product}
\source{stacks:0B0R}
\href{https://stacks.math.columbia.edu/tag/0B0R}{\texttt{Stacks tag 0B0R}}
\group{intersection}
...
\begin{proof}
\uses{intersection-lemma-dimension-product-varieties, intersection-lemma-intersection-multiplicity-CM}
...
$\dim(V \times W) = r + s$ by Lemma \ref{intersection-lemma-dimension-product-varieties}.
...
and Lemma \ref{intersection-lemma-intersection-multiplicity-CM} applies.
...
\begin{lemma}[Tor and diagonal]
\label{intersection-lemma-tor-and-diagonal}
\source{stacks:0B0T}
\href{https://stacks.math.columbia.edu/tag/0B0T}{\texttt{Stacks tag 0B0T}}
\group{intersection}
...
\begin{lemma}[Reduction diagonal]
\label{intersection-lemma-reduction-diagonal}
\source{stacks:0B0U}
\href{https://stacks.math.columbia.edu/tag/0B0U}{\texttt{Stacks tag 0B0U}}
\group{intersection}
...
\begin{proof}
\uses{intersection-lemma-tor-and-diagonal, intersection-lemma-compose-pushforward}
...
$$
However, by Lemma \ref{intersection-lemma-tor-and-diagonal} we have
$$
...
Lemma \ref{intersection-lemma-compose-pushforward}.
\end{proof}

\begin{proposition}[Positivity]
\label{intersection-proposition-positivity}
\source{stacks:0B0V}
\href{https://stacks.math.columbia.edu/tag/0B0V}{\texttt{Stacks tag 0B0V}}
\group{intersection}
...
\begin{proof}
\uses{intersection-lemma-reduction-diagonal, intersection-lemma-diagonal-regular-immersion, intersection-lemma-multiplicity-with-lci}

By Lemma \ref{intersection-lemma-reduction-diagonal} we have
$$
e(X, V \cdot W, Z) = e(X \times X, \Delta \cdot V \times W, \Delta(Z))
$$
Since $\Delta : X \to X \times X$ is a regular immersion
(see Lemma \ref{intersection-lemma-diagonal-regular-immersion}), we see that
$e(X \times X, \Delta \cdot V \times W, \Delta(Z))$ is a positive
integer by Lemma \ref{intersection-lemma-multiplicity-with-lci}.
\end{proof}
...
\begin{lemma}[Tor sheaf]
\label{intersection-lemma-tor-sheaf}
\source{stacks:0B0W}
\href{https://stacks.math.columbia.edu/tag/0B0W}{\texttt{Stacks tag 0B0W}}
\group{intersection}
...
\begin{proof}
\uses{intersection-lemma-tor-and-diagonal, intersection-lemma-diagonal-regular-immersion, intersection-lemma-one-ideal-ci}
...
By Lemma \ref{intersection-lemma-tor-and-diagonal} we have
$$
...
length $\dim(X)$ (Lemma \ref{intersection-lemma-diagonal-regular-immersion}).
Hence vanishing by Lemma \ref{intersection-lemma-one-ideal-ci} because
the Hilbert function of $C$ with respect to $I$ has degree $\dim(C) < n$
by Algebra, Proposition \ref{algebra-proposition-dimension}.
\end{proof}

\begin{remark}[Serre conjectures]
\label{intersection-remark-Serre-conjectures}
\source{stacks:0B0X}
\href{https://stacks.math.columbia.edu/tag/0B0X}{\texttt{Stacks tag 0B0X}}
\group{intersection}

\uses{intersection-lemma-tor-sheaf, intersection-proposition-positivity}
...
\end{enumerate}
The arguments that prove Lemma \ref{intersection-lemma-tor-sheaf} and
Proposition \ref{intersection-proposition-positivity} can be leveraged
...
Using the key Lemma \ref{intersection-lemma-tor-sheaf} we can prove that (proper)
intersection products are associative.

\begin{lemma}[Associative]
\label{intersection-lemma-associative}
\source{stacks:0B1L}
\href{https://stacks.math.columbia.edu/tag/0B1L}{\texttt{Stacks tag 0B1L}}
\group{intersection}
...
\begin{proof}
\uses{intersection-lemma-tor-sheaf}

We are going to use Lemma \ref{intersection-lemma-tor-sheaf} without further mention.
This implies that
\begin{align*}
V \cdot W
& =
...
\begin{lemma}[Flat pull back and intersections sheaves]
\label{intersection-lemma-flat-pull-back-and-intersections-sheaves}
\source{stacks:0B0Y}
\href{https://stacks.math.columbia.edu/tag/0B0Y}{\texttt{Stacks tag 0B0Y}}
\group{intersection}
...
\begin{proof}
\uses{intersection-lemma-tor-sheaf, intersection-lemma-pullback}
...
Lemmas \ref{intersection-lemma-tor-sheaf} and \ref{intersection-lemma-pullback}
...
\begin{lemma}[Flat pullback and intersections]
\label{intersection-lemma-flat-pullback-and-intersections}
\source{stacks:0B0Z}
\href{https://stacks.math.columbia.edu/tag/0B0Z}{\texttt{Stacks tag 0B0Z}}
\group{intersection}
...
\begin{proof}
\uses{intersection-lemma-flat-pull-back-and-intersections-sheaves}
...
Lemma \ref{intersection-lemma-flat-pull-back-and-intersections-sheaves}
...
\begin{lemma}[Projection formula flat]
\label{intersection-lemma-projection-formula-flat}
\source{stacks:0B10}
\href{https://stacks.math.columbia.edu/tag/0B10}{\texttt{Stacks tag 0B10}}
\group{intersection}
...
\begin{proof}
\uses{intersection-lemma-pullback, intersection-lemma-tor-sheaf, intersection-lemma-push-coherent}
...
Lemma \ref{intersection-lemma-pullback} we have
$$
[V] \cdot f^*[W] =
\sum (-1)^i
...
$$
by Lemma \ref{intersection-lemma-tor-sheaf}. Applying
Lemma \ref{intersection-lemma-push-coherent}
we find
$$
f_*([V] \cdot f^*[W]) =
\sum (-1)^i
...
Lemma \ref{intersection-lemma-push-coherent} we have
$$
[f_*V] \cdot [W] =
\sum (-1)^i
...
$$
again by Lemma \ref{intersection-lemma-tor-sheaf}.
...
\source{stacks:0B1M}
\href{https://stacks.math.columbia.edu/tag/0B1M}{\texttt{Stacks tag 0B1M}}
\group{intersection}
...
\begin{proof}
\uses{intersection-lemma-projection-formula-flat, intersection-lemma-rational-equivalence-and-intersection, intersection-lemma-associative}
...
the projection formula (Lemma \ref{intersection-lemma-projection-formula-flat})
gives
$$
...
by Lemma \ref{intersection-lemma-rational-equivalence-and-intersection}.
Hence
$$
...
$$
by associativity (Lemma \ref{intersection-lemma-associative}) and commutativity of the
...
Lemma \ref{intersection-lemma-rational-equivalence-and-intersection} applied twice.
...
\begin{lemma}[Projection generically finite]
\label{intersection-lemma-projection-generically-finite}
\source{stacks:0B1P}
\href{https://stacks.math.columbia.edu/tag/0B1P}{\texttt{Stacks tag 0B1P}}
\group{intersection}
...
\begin{lemma}[Projection generically immersion]
\label{intersection-lemma-projection-generically-immersion}
\source{stacks:0B1Q}
\href{https://stacks.math.columbia.edu/tag/0B1Q}{\texttt{Stacks tag 0B1Q}}
\group{intersection}
...
\begin{proof}
\uses{intersection-lemma-projection-generically-finite}
...
finite by Lemma \ref{intersection-lemma-projection-generically-finite},
...
\begin{lemma}[Projection generically immersion refined]
\label{intersection-lemma-projection-generically-immersion-refined}
\source{stacks:0H8A}
\href{https://stacks.math.columbia.edu/tag/0H8A}{\texttt{Stacks tag 0H8A}}
\group{intersection}
...
\begin{proof}
\uses{intersection-lemma-projection-generically-immersion, intersection-lemma-projection-generically-finite}

Arguing as in the proof of Lemma \ref{intersection-lemma-projection-generically-immersion}
...
(Lemma \ref{intersection-lemma-projection-generically-finite}), unramified at $x$
...
\begin{lemma}[Projection injective]
\label{intersection-lemma-projection-injective}
\source{stacks:0B1R}
\href{https://stacks.math.columbia.edu/tag/0B1R}{\texttt{Stacks tag 0B1R}}
\group{intersection}
...
\begin{lemma}[Find lines]
\label{intersection-lemma-find-lines}
\source{stacks:0B2T}
\href{https://stacks.math.columbia.edu/tag/0B2T}{\texttt{Stacks tag 0B2T}}
\group{intersection}
...
\begin{lemma}[Doubly transitive]
\label{intersection-lemma-doubly-transitive}
\source{stacks:0B2U}
\href{https://stacks.math.columbia.edu/tag/0B2U}{\texttt{Stacks tag 0B2U}}
\group{intersection}
...
\source{stacks:0B2V}
\href{https://stacks.math.columbia.edu/tag/0B2V}{\texttt{Stacks tag 0B2V}}
\group{intersection}
...
\begin{lemma}[Make family]
\label{intersection-lemma-make-family}
\source{stacks:0B1S}
\href{https://stacks.math.columbia.edu/tag/0B1S}{\texttt{Stacks tag 0B1S}}
\group{intersection}
...
\begin{proof}
\uses{intersection-lemma-find-lines, intersection-lemma-doubly-transitive, intersection-lemma-determinant}
...
(Lemma \ref{intersection-lemma-find-lines}).
...
(Lemma \ref{intersection-lemma-doubly-transitive})
we see that
$$
...
irreducible polynomial (Lemma \ref{intersection-lemma-determinant}).
...
$\alpha'$ and $\beta$ intersect properly (Lemma \ref{intersection-lemma-moving-move}).
See \cite{Samuel}, \cite{ChevalleyI}, \cite{ChevalleyII}.
The key to this is Lemma \ref{intersection-lemma-moving}; the reader may find
...
\source{stacks:0B0E}
\href{https://stacks.math.columbia.edu/tag/0B0E}{\texttt{Stacks tag 0B0E}}
\group{intersection}
...
\begin{proof}
\uses{intersection-lemma-projection-generically-finite, intersection-lemma-projection-generically-immersion, intersection-lemma-projection-generically-immersion-refined, intersection-lemma-projection-injective, intersection-lemma-transversal-subschemes}
...
\end{align*}
as in Section \ref{intersection-section-projection}. At each step we will choose
...
Lemmas \ref{intersection-lemma-projection-generically-finite},
\ref{intersection-lemma-projection-generically-immersion},
\ref{intersection-lemma-projection-generically-immersion-refined}, and
\ref{intersection-lemma-projection-injective} and induction that we can do this;
...
from Lemma \ref{intersection-lemma-projection-injective}. Then note that
...
Hence by Lemma \ref{intersection-lemma-transversal-subschemes} we conclude that
$$
C \cdot X = [Z] + \sum m_j[Z_j]
$$
...
\source{stacks:0B1T}
\href{https://stacks.math.columbia.edu/tag/0B1T}{\texttt{Stacks tag 0B1T}}
\group{intersection}
...
\begin{proof}
\uses{intersection-lemma-make-family}
...
$\mathbf{P} = \mathbf{P}(E^\vee)$ as in Lemma \ref{intersection-lemma-make-family}.
...
$$
under the morphism (\ref{equation-r-psi}). By Lemma \ref{intersection-lemma-make-family}
...
\begin{lemma}[Moving move]
\label{intersection-lemma-moving-move}
\source{stacks:0B1U}
\href{https://stacks.math.columbia.edu/tag/0B1U}{\texttt{Stacks tag 0B1U}}
\group{intersection}
...
\begin{proof}
\uses{intersection-lemma-moving, intersection-lemma-move, intersection-lemma-transfer, intersection-lemma-rational-equivalence-and-intersection}
...
$X \subset \mathbf{P}^N$ and apply Lemma \ref{intersection-lemma-moving} to find a
closed subvariety $C \subset \mathbf{P}^N$ such that
$C \cdot X = [Z] + \sum m_j[Z_j]$ and such that the induction
hypothesis applies to each $Z_j$. Next, apply Lemma \ref{intersection-lemma-move}
to $C$, $X$, $T_i$ to find $C' \subset \mathbf{P}^N \times \mathbf{P}^1$.
Let $\gamma = C' \cdot X \times \mathbf{P}^1$ viewed as a cycle
on $X \times \mathbf{P}^1$. By Lemma \ref{intersection-lemma-transfer} we have
$$
...
by Lemma \ref{intersection-lemma-rational-equivalence-and-intersection}. Since by
...
\begin{lemma}[Well defined special case]
\label{intersection-lemma-well-defined-special-case}
\source{stacks:0B60}
\href{https://stacks.math.columbia.edu/tag/0B60}{\texttt{Stacks tag 0B60}}
\group{intersection}
...
\begin{proof}
\uses{intersection-lemma-rational-equivalence-and-intersection, intersection-lemma-projection-formula-flat, intersection-lemma-associative, intersection-lemma-intersect-in-smooth}

We have $[W_a]_r = \text{pr}_{X,*}(W \cdot X \times a)$ and similarly for
$[W_b]_r$, see Lemma \ref{intersection-lemma-rational-equivalence-and-intersection}.
...
Lemma \ref{intersection-lemma-projection-formula-flat} we get
$$
...
(Lemma \ref{intersection-lemma-associative})
...
\text{pr}_{X,*}((V \times \mathbf{P}^1 \cdot W) \cdot X\times b)
$$
which is true by Lemma \ref{intersection-lemma-rational-equivalence-and-intersection}.
...
Lemma \ref{intersection-lemma-intersect-in-smooth}. Since we have assumed
...
(V \times U \cdot W_U) \cdot X \times a
$$
as cycles on $X \times U$ by Lemma \ref{intersection-lemma-associative}.
...
Lemma \ref{intersection-lemma-rational-equivalence-and-intersection}.
\end{proof}

\begin{theorem}[Well defined]
\label{intersection-theorem-well-defined}
\source{stacks:0B1V}
\href{https://stacks.math.columbia.edu/tag/0B1V}{\texttt{Stacks tag 0B1V}}
\group{intersection}
...
\begin{proof}
\uses{intersection-lemma-well-defined-special-case, intersection-lemma-moving, intersection-lemma-move, intersection-proposition-positivity, intersection-lemma-transfer}
...
desired result follows from Lemma \ref{intersection-lemma-well-defined-special-case},
...
Lemma \ref{intersection-lemma-moving} to $Z \subset X$ and
...
as in Lemma \ref{intersection-lemma-move} with respect to $C$, $X$, and
...
By Lemma \ref{intersection-lemma-transfer} we have
$$
...
intersect $\alpha$ properly Lemma \ref{intersection-lemma-well-defined-special-case}
...
\begin{remark}[Quasi projective]
\label{intersection-remark-quasi-projective}
\source{stacks:0B61}
\href{https://stacks.math.columbia.edu/tag/0B61}{\texttt{Stacks tag 0B61}}
\group{intersection}

\uses{intersection-lemma-moving-move, intersection-theorem-well-defined, intersection-lemma-moving}
Lemma \ref{intersection-lemma-moving-move} and
Theorem \ref{intersection-theorem-well-defined}
...
version of the moving Lemma \ref{intersection-lemma-moving}: Let  $X \subset \mathbf{P}^N$
...
definition given in Section \ref{intersection-section-intersection-product}.
If not, then we choose $\alpha \sim_{rat} \alpha'$ as in
Lemma \ref{intersection-lemma-moving-move} and we set
$$
\alpha \cdot \beta =
\text{class of }\alpha' \cdot \beta \in \CH_{r + s - \dim(X)}(X)
$$
This is well defined and passes through rational equivalence by
Theorem \ref{intersection-theorem-well-defined}. The intersection product
on $\CH_*(X)$ is commutative (this is clear), associative
(Lemma \ref{intersection-lemma-associative}) and has a unit $[X] \in \CH_{\dim(X)}(X)$.
...
notation $\CH^*$ introduced in Section \ref{intersection-section-chow-rings}
...
\begin{lemma}[Pullback and intersection product]
\label{intersection-lemma-pullback-and-intersection-product}
\source{stacks:0B2X}
\href{https://stacks.math.columbia.edu/tag/0B2X}{\texttt{Stacks tag 0B2X}}
\group{intersection}
...
\begin{proof}
\uses{intersection-lemma-projection-formula-flat, intersection-lemma-transversal, intersection-lemma-multiplicity-lci-CM}
...
(Lemma \ref{intersection-lemma-projection-formula-flat}).
...
Lemma \ref{intersection-lemma-transversal}.
...
Lemma \ref{intersection-lemma-multiplicity-lci-CM}. Since $\Gamma_f \cap pr_Y^{-1}(V)$
...
$$
\begin{array}{cc}f^{-1}(Z) \longrightarrow\downarrow & Z \downarrow \\ X \longrightarrow & Y\end{array}
$$
...
and $X \times Z$ and using Lemma \ref{intersection-lemma-multiplicity-lci-CM}.
Details are similar to the proof of part (4) of
Lemma \ref{intersection-lemma-pullback-and-intersection-product} above.
