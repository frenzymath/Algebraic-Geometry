...
The part-local Lean package `StacksPart05Lib/` is a port of the corresponding Horizon
`FormalizedSources/StacksProject/Part05_TopicsInGeometry` library. Lake metadata lives
