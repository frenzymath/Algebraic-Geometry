...
Blueprint project under `FormalizedPapers/ModuliHiggsCharacter/VirasoroConstraintsModuliSheavesVertexAlgebras`.

- Blueprint: [`blueprint/src/content.tex`](blueprint/src/content.tex)
- Direct PDF: [arXiv PDF](https://arxiv.org/pdf/2210.05266)
