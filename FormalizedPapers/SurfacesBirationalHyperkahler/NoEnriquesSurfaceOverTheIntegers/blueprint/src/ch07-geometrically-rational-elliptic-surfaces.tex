...
\begin{proposition}
\label{src-no-enriques-surface-over-the-integers-ch07-geometrically-rational-elliptic-surfaces-statement-1}
\source{no-enriques-surface-over-the-integers}
\notready
...
\begin{proposition}
\label{src-no-enriques-surface-over-the-integers-ch07-geometrically-rational-elliptic-surfaces-statement-2}
\source{no-enriques-surface-over-the-integers}
\notready
