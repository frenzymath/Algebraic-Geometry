...
\source{stacks:0AD1}
\href{https://stacks.math.columbia.edu/tag/0AD1}{\texttt{Stacks tag 0AD1}}
\group{spaces-over-fields}
...
$$
\begin{array}{cc}U \longrightarrow\underset{g}{\downarrow} & X \overset{f}{\downarrow} \\ V \longrightarrow & Y\end{array}
$$
...
\source{stacks:0AD2}
\href{https://stacks.math.columbia.edu/tag/0AD2}{\texttt{Stacks tag 0AD2}}
\group{spaces-over-fields}
...
\begin{proof}
By Lemma \ref{spaces-over-fields-lemma-quasi-finite-in-codim-1} the morphism $f$ is
...
\source{stacks:0BBQ}
\href{https://stacks.math.columbia.edu/tag/0BBQ}{\texttt{Stacks tag 0BBQ}}
\group{spaces-over-fields}
...
Part (2) follows from part (3) and Lemma \ref{spaces-over-fields-lemma-finite-in-codim-1}
...
\begin{definition}[Integral algebraic space]
\label{spaces-over-fields-definition-integral-algebraic-space}
\source{stacks:0AD4}
\href{https://stacks.math.columbia.edu/tag/0AD4}{\texttt{Stacks tag 0AD4}}
\group{spaces-over-fields}
...
\begin{lemma}[Integral algebraic space rational functions]
\label{spaces-over-fields-lemma-integral-algebraic-space-rational-functions}
\source{stacks:0END}
\href{https://stacks.math.columbia.edu/tag/0END}{\texttt{Stacks tag 0END}}
\group{spaces-over-fields}
...
\source{stacks:0ENE}
\href{https://stacks.math.columbia.edu/tag/0ENE}{\texttt{Stacks tag 0ENE}}
\group{spaces-over-fields}

Let $S$ be a scheme. Let $X$ be an integral algebraic space over $S$.
The {\it function field}, or the {\it field of rational functions}
of $X$ is the field $R(X)$ of
Lemma \ref{spaces-over-fields-lemma-integral-algebraic-space-rational-functions}.
\end{definition}

We may occasionally indicate this field $k(X)$ instead of $R(X)$.

\begin{lemma}[Integral sections]
\label{spaces-over-fields-lemma-integral-sections}
\source{stacks:0BH2}
\href{https://stacks.math.columbia.edu/tag/0BH2}{\texttt{Stacks tag 0BH2}}
\group{spaces-over-fields}
...
\begin{lemma}[Normal integral cover by affines]
\label{spaces-over-fields-lemma-normal-integral-cover-by-affines}
\source{stacks:0AYH}
\href{https://stacks.math.columbia.edu/tag/0AYH}{\texttt{Stacks tag 0AYH}}
\group{spaces-over-fields}
...
\begin{lemma}[Normal integral sections]
\label{spaces-over-fields-lemma-normal-integral-sections}
\source{stacks:0BH3}
\href{https://stacks.math.columbia.edu/tag/0BH3}{\texttt{Stacks tag 0BH3}}
\group{spaces-over-fields}
...
Lemma \ref{spaces-over-fields-lemma-integral-sections}.
...
Lemma \ref{spaces-over-fields-lemma-normal-integral-cover-by-affines}.
...
\source{stacks:0ENF}
\href{https://stacks.math.columbia.edu/tag/0ENF}{\texttt{Stacks tag 0ENF}}
\group{spaces-over-fields}
...
\begin{lemma}[Finite degree]
\label{spaces-over-fields-lemma-finite-degree}
\source{stacks:0AD5}
\href{https://stacks.math.columbia.edu/tag/0AD5}{\texttt{Stacks tag 0AD5}}
\group{spaces-over-fields}
...
\source{stacks:0AD6}
\href{https://stacks.math.columbia.edu/tag/0AD6}{\texttt{Stacks tag 0AD6}}
\group{spaces-over-fields}
...
Lemma \ref{spaces-over-fields-lemma-finite-degree}. Let $x \in |X|$ and $y \in |Y|$
...
\begin{lemma}[Degree composition]
\label{spaces-over-fields-lemma-degree-composition}
\source{stacks:0ENH}
\href{https://stacks.math.columbia.edu/tag/0ENH}{\texttt{Stacks tag 0ENH}}
\group{spaces-over-fields}
...
(1) -- (5) of Lemma \ref{spaces-over-fields-lemma-finite-degree} hold for $f$ and $g$. Then
$$
...
\source{stacks:0EE5}
\href{https://stacks.math.columbia.edu/tag/0EE5}{\texttt{Stacks tag 0EE5}}
\group{spaces-over-fields}
...
\source{stacks:0ENJ}
\href{https://stacks.math.columbia.edu/tag/0ENJ}{\texttt{Stacks tag 0ENJ}}
\group{spaces-over-fields}
...
may not be a domain, see Example \ref{spaces-over-fields-example-not-a-domain}.
To get around this we use the following lemma.

\begin{lemma}[Order vanishing]
\label{spaces-over-fields-lemma-order-vanishing}
\source{stacks:0ENK}
\href{https://stacks.math.columbia.edu/tag/0ENK}{\texttt{Stacks tag 0ENK}}
\group{spaces-over-fields}
...
\source{stacks:0ENL}
\href{https://stacks.math.columbia.edu/tag/0ENL}{\texttt{Stacks tag 0ENL}}
\group{spaces-over-fields}
...
(Lemma \ref{spaces-over-fields-lemma-order-vanishing}) is equal to $a/b$.
...
\begin{lemma}[Order vanishing agrees]
\label{spaces-over-fields-lemma-order-vanishing-agrees}
\source{stacks:0ENM}
\href{https://stacks.math.columbia.edu/tag/0ENM}{\texttt{Stacks tag 0ENM}}
\group{spaces-over-fields}

Let $S$ be a scheme. Let $X$ be a locally Noetherian integral algebraic
space over $S$. Let $f \in R(X)^*$. If the prime divisor
$Z \subset X$ meets the schematic locus of $X$, then the order
of vanishing $\text{ord}_Z(f)$ of Definition \ref{spaces-over-fields-definition-order-vanishing}
...
\source{stacks:0ENN}
\href{https://stacks.math.columbia.edu/tag/0ENN}{\texttt{Stacks tag 0ENN}}
\group{spaces-over-fields}
...
Hence Lemma \ref{spaces-over-fields-lemma-components-locally-finite} gives the desired result.
\end{proof}
...
\source{stacks:0ENP}
\href{https://stacks.math.columbia.edu/tag/0ENP}{\texttt{Stacks tag 0ENP}}
\group{spaces-over-fields}
...
Definition \ref{spaces-over-fields-definition-order-vanishing}. This makes sense
by Lemma \ref{spaces-over-fields-lemma-divisor-locally-finite}.
\end{definition}

\begin{lemma}[Div additive]
\label{spaces-over-fields-lemma-div-additive}
\source{stacks:0ENQ}
\href{https://stacks.math.columbia.edu/tag/0ENQ}{\texttt{Stacks tag 0ENQ}}
\group{spaces-over-fields}
...
\source{stacks:0ENR}
\href{https://stacks.math.columbia.edu/tag/0ENR}{\texttt{Stacks tag 0ENR}}
\group{spaces-over-fields}
...
\begin{example}[Z mod 2]
\label{spaces-over-fields-example-Z-mod-2}
\source{stacks:0ENT}
\href{https://stacks.math.columbia.edu/tag/0ENT}{\texttt{Stacks tag 0ENT}}
\group{spaces-over-fields}
...
\begin{example}[Not a domain]
\label{spaces-over-fields-example-not-a-domain}
\source{stacks:0ENU}
\href{https://stacks.math.columbia.edu/tag/0ENU}{\texttt{Stacks tag 0ENU}}
\group{spaces-over-fields}
...
and Noetherian. Exactly as in Example \ref{spaces-over-fields-example-Z-mod-2}
...
Section \ref{spaces-over-fields-section-Weil-divisors} to define a canonical map
$\Pic(X) \to \text{Cl}(X)$
...
\source{stacks:0EPR}
\href{https://stacks.math.columbia.edu/tag/0EPR}{\texttt{Stacks tag 0EPR}}
\group{spaces-over-fields}
...
\source{stacks:0EPS}
\href{https://stacks.math.columbia.edu/tag/0EPS}{\texttt{Stacks tag 0EPS}}
\group{spaces-over-fields}
...
$|X| \setminus |U|$. Hence Lemma \ref{spaces-over-fields-lemma-components-locally-finite}.
...
\source{stacks:0EPT}
\href{https://stacks.math.columbia.edu/tag/0EPT}{\texttt{Stacks tag 0EPT}}
\group{spaces-over-fields}
...
Note that Lemma \ref{spaces-over-fields-lemma-divisor-meromorphic-locally-finite}
...
\source{stacks:0EPU}
\href{https://stacks.math.columbia.edu/tag/0EPU}{\texttt{Stacks tag 0EPU}}
\group{spaces-over-fields}
...
Lemma \ref{spaces-over-fields-lemma-divisor-meromorphic-locally-finite}.
...
This is well defined by
Lemma \ref{spaces-over-fields-lemma-divisor-meromorphic-well-defined}.
\end{enumerate}
\end{definition}
...
\source{stacks:0EPV}
\href{https://stacks.math.columbia.edu/tag/0EPV}{\texttt{Stacks tag 0EPV}}
\group{spaces-over-fields}
...
\source{stacks:0EPX}
\href{https://stacks.math.columbia.edu/tag/0EPX}{\texttt{Stacks tag 0EPX}}
\group{spaces-over-fields}
...
(Lemma \ref{spaces-over-fields-lemma-decent-irreducible-closed}), then
...
\source{stacks:0AD8}
\href{https://stacks.math.columbia.edu/tag/0AD8}{\texttt{Stacks tag 0AD8}}
\group{spaces-over-fields}
...
\begin{lemma}[Modification iso over open]
\label{spaces-over-fields-lemma-modification-iso-over-open}
\source{stacks:0AD9}
\href{https://stacks.math.columbia.edu/tag/0AD9}{\texttt{Stacks tag 0AD9}}
\group{spaces-over-fields}

Let $f : X' \to X$ be a modification as in
Definition \ref{spaces-over-fields-definition-modification}.
...
\begin{proof}
By
Lemma \ref{spaces-over-fields-lemma-finite-degree} there exists a nonempty $U \subset X$ such
...
\source{stacks:0ADA}
\href{https://stacks.math.columbia.edu/tag/0ADA}{\texttt{Stacks tag 0ADA}}
\group{spaces-over-fields}
...
\begin{lemma}[Alteration generically finite]
\label{spaces-over-fields-lemma-alteration-generically-finite}
\source{stacks:0ADB}
\href{https://stacks.math.columbia.edu/tag/0ADB}{\texttt{Stacks tag 0ADB}}
\group{spaces-over-fields}
...
Lemma \ref{spaces-over-fields-lemma-finite-degree} hold.
\end{lemma}
...
\begin{lemma}[Alteration contained in]
\label{spaces-over-fields-lemma-alteration-contained-in}
\source{stacks:0DMN}
\href{https://stacks.math.columbia.edu/tag/0DMN}{\texttt{Stacks tag 0DMN}}
\group{spaces-over-fields}
...
Lemma \ref{spaces-over-fields-lemma-alteration-generically-finite}.
\end{proof}
...
In Section \ref{spaces-over-fields-section-schematic-and-field-extension}
we will study what happens with the schematic
locus under extension of base field.

\begin{lemma}[Locally finite type dim zero]
\label{spaces-over-fields-lemma-locally-finite-type-dim-zero}
\source{stacks:06LZ}
\href{https://stacks.math.columbia.edu/tag/06LZ}{\texttt{Stacks tag 06LZ}}
\group{spaces-over-fields}
...
\begin{lemma}[Generic point in schematic locus]
\label{spaces-over-fields-lemma-generic-point-in-schematic-locus}
\source{stacks:0ADC}
\href{https://stacks.math.columbia.edu/tag/0ADC}{\texttt{Stacks tag 0ADC}}
\group{spaces-over-fields}
...
\begin{lemma}[Separated algebraic spaces are schemes in codimension 1.]
\label{spaces-over-fields-lemma-codim-1-point-in-schematic-locus}
\source{stacks:0ADD}
\href{https://stacks.math.columbia.edu/tag/0ADD}{\texttt{Stacks tag 0ADD}}
\group{spaces-over-fields}
...
\begin{remark}[Alternate proof scheme codim 1]
\label{spaces-over-fields-remark-alternate-proof-scheme-codim-1}
\source{stacks:0ADE}
\href{https://stacks.math.columbia.edu/tag/0ADE}{\texttt{Stacks tag 0ADE}}
\group{spaces-over-fields}

Here is a sketch of a proof of
Lemma \ref{spaces-over-fields-lemma-codim-1-point-in-schematic-locus}
which avoids using
...
neighbourhood of $x$ (Lemma \ref{spaces-over-fields-lemma-finite-in-codim-1}).
...
(Lemma \ref{spaces-over-fields-lemma-generic-point-in-schematic-locus}).
...
\begin{lemma}[Scheme after purely inseparable base change]
\label{spaces-over-fields-lemma-scheme-after-purely-inseparable-base-change}
\source{stacks:0B83}
\href{https://stacks.math.columbia.edu/tag/0B83}{\texttt{Stacks tag 0B83}}
\group{spaces-over-fields}
...
\begin{lemma}[When scheme after base change]
\label{spaces-over-fields-lemma-when-scheme-after-base-change}
\source{stacks:0B84}
\href{https://stacks.math.columbia.edu/tag/0B84}{\texttt{Stacks tag 0B84}}
\group{spaces-over-fields}
...
Lemma \ref{spaces-over-fields-lemma-scheme-after-purely-inseparable-base-change}
the algebraic space $X_{k''}$ is a scheme. Since $k''|k$ is separable
the proof is complete.
\end{proof}

\begin{lemma}[Base change by Galois]
\label{spaces-over-fields-lemma-base-change-by-Galois}
\source{stacks:0B86}
\href{https://stacks.math.columbia.edu/tag/0B86}{\texttt{Stacks tag 0B86}}
\group{spaces-over-fields}
...
\source{stacks:0B87}
\href{https://stacks.math.columbia.edu/tag/0B87}{\texttt{Stacks tag 0B87}}
\group{spaces-over-fields}
...
\begin{lemma}[Scheme after purely transcendental base change]
\label{spaces-over-fields-lemma-scheme-after-purely-transcendental-base-change}
\source{stacks:0B85}
\href{https://stacks.math.columbia.edu/tag/0B85}{\texttt{Stacks tag 0B85}}
\group{spaces-over-fields}
...
(Lemma \ref{spaces-over-fields-lemma-base-change-by-Galois}).
...
Lemma \ref{spaces-over-fields-lemma-when-quotient-scheme-at-point}
we see that $x$ is in the schematic locus of $X$ as desired.
\end{proof}

\begin{remark}[When does the argument work]
\label{spaces-over-fields-remark-when-does-the-argument-work}
\source{stacks:0BA7}
\href{https://stacks.math.columbia.edu/tag/0BA7}{\texttt{Stacks tag 0BA7}}
\group{spaces-over-fields}
...
Lemma \ref{spaces-over-fields-lemma-scheme-after-purely-transcendental-base-change}
...
\begin{lemma}[Scheme over algebraic closure enough affines]
\label{spaces-over-fields-lemma-scheme-over-algebraic-closure-enough-affines}
\source{stacks:0B88}
\href{https://stacks.math.columbia.edu/tag/0B88}{\texttt{Stacks tag 0B88}}
\group{spaces-over-fields}
...
By Lemma \ref{spaces-over-fields-lemma-scheme-after-purely-inseparable-base-change}
...
\medskip\noindent
By Lemma \ref{spaces-over-fields-lemma-when-scheme-after-base-change} we see that $X_{k'}$
...
Lemmas \ref{spaces-over-fields-lemma-base-change-by-Galois} and
...
\source{stacks:06S0}
\href{https://stacks.math.columbia.edu/tag/06S0}{\texttt{Stacks tag 06S0}}
\group{spaces-over-fields}
...
Lemma \ref{spaces-over-fields-lemma-locally-finite-type-dim-zero}
...
\begin{lemma}[Mono towards locally quasi finite over field]
\label{spaces-over-fields-lemma-mono-towards-locally-quasi-finite-over-field}
\source{stacks:06S1}
\href{https://stacks.math.columbia.edu/tag/06S1}{\texttt{Stacks tag 06S1}}
\group{spaces-over-fields}
...
Lemma \ref{spaces-over-fields-lemma-locally-quasi-finite-over-field}
...
\source{stacks:0DMQ}
\href{https://stacks.math.columbia.edu/tag/0DMQ}{\texttt{Stacks tag 0DMQ}}
\group{spaces-over-fields}
...
\begin{lemma}[Geometrically reduced at point]
\label{spaces-over-fields-lemma-geometrically-reduced-at-point}
\source{stacks:0DMR}
\href{https://stacks.math.columbia.edu/tag/0DMR}{\texttt{Stacks tag 0DMR}}
\group{spaces-over-fields}
...
\source{stacks:0DMS}
\href{https://stacks.math.columbia.edu/tag/0DMS}{\texttt{Stacks tag 0DMS}}
\group{spaces-over-fields}
...
Lemma \ref{spaces-over-fields-lemma-geometrically-reduced-at-point}.
\end{proof}
...
\source{stacks:0E02}
\href{https://stacks.math.columbia.edu/tag/0E02}{\texttt{Stacks tag 0E02}}
\group{spaces-over-fields}
...
\begin{lemma}[Geometrically reduced positive characteristic]
\label{spaces-over-fields-lemma-geometrically-reduced-positive-characteristic}
\source{stacks:0E03}
\href{https://stacks.math.columbia.edu/tag/0E03}{\texttt{Stacks tag 0E03}}
\group{spaces-over-fields}
...
Via Lemma \ref{spaces-over-fields-lemma-geometrically-reduced} the lemma follows from
...
\source{stacks:0E04}
\href{https://stacks.math.columbia.edu/tag/0E04}{\texttt{Stacks tag 0E04}}
\group{spaces-over-fields}
...
to both $u$ and $x'$. By Lemma \ref{spaces-over-fields-lemma-geometrically-reduced-at-point}
the lemma follows from the lemma for $U, u, u'$ which is
Varieties, Lemma \ref{varieties-lemma-geometrically-reduced-upstairs}.
\end{proof}

\begin{lemma}[Geometrically reduced etale local]
\label{spaces-over-fields-lemma-geometrically-reduced-etale-local}
\source{stacks:0E05}
\href{https://stacks.math.columbia.edu/tag/0E05}{\texttt{Stacks tag 0E05}}
\group{spaces-over-fields}
...
\source{stacks:0A0Z}
\href{https://stacks.math.columbia.edu/tag/0A0Z}{\texttt{Stacks tag 0A0Z}}
\group{spaces-over-fields}
...
\source{stacks:0A10}
\href{https://stacks.math.columbia.edu/tag/0A10}{\texttt{Stacks tag 0A10}}
\group{spaces-over-fields}
...
field extension $k'''/k$ of $k'/k$ and $k''/k$, see
...
\source{stacks:0A11}
\href{https://stacks.math.columbia.edu/tag/0A11}{\texttt{Stacks tag 0A11}}
\group{spaces-over-fields}
...
\source{stacks:0A12}
\href{https://stacks.math.columbia.edu/tag/0A12}{\texttt{Stacks tag 0A12}}
\group{spaces-over-fields}
...
Lemma \ref{spaces-over-fields-lemma-bijection-connected-components}.
\end{proof}

\begin{lemma}[Characterize geometrically connected]
\label{spaces-over-fields-lemma-characterize-geometrically-connected}
\source{stacks:0A13}
\href{https://stacks.math.columbia.edu/tag/0A13}{\texttt{Stacks tag 0A13}}
\group{spaces-over-fields}
...
By Lemma \ref{spaces-over-fields-lemma-separably-closed-field-connected-components}
...
\source{stacks:0A15}
\href{https://stacks.math.columbia.edu/tag/0A15}{\texttt{Stacks tag 0A15}}
\group{spaces-over-fields}
...
\source{stacks:0A16}
\href{https://stacks.math.columbia.edu/tag/0A16}{\texttt{Stacks tag 0A16}}
\group{spaces-over-fields}
...
\source{stacks:0A17}
\href{https://stacks.math.columbia.edu/tag/0A17}{\texttt{Stacks tag 0A17}}
\group{spaces-over-fields}
...
by Lemma \ref{spaces-over-fields-lemma-characterize-geometrically-connected},
we replace
Varieties, Lemma \ref{varieties-lemma-Galois-action-quasi-compact-open}
by Lemma \ref{spaces-over-fields-lemma-Galois-action-quasi-compact-open}, and
we replace
Varieties, Lemma \ref{varieties-lemma-closed-fixed-by-Galois}
by Lemma \ref{spaces-over-fields-lemma-closed-fixed-by-Galois}.
...
closure of $k$. By
Lemma \ref{spaces-over-fields-lemma-characterize-geometrically-connected}
...
Lemma \ref{spaces-over-fields-lemma-Galois-action-quasi-compact-open}
...
Lemma \ref{spaces-over-fields-lemma-closed-fixed-by-Galois}
...
\source{stacks:0DMU}
\href{https://stacks.math.columbia.edu/tag/0DMU}{\texttt{Stacks tag 0DMU}}
\group{spaces-over-fields}
...
Section \ref{spaces-over-fields-section-integral-spaces}.

\begin{definition}[Geometrically integral]
\label{spaces-over-fields-definition-geometrically-integral}
\source{stacks:0DMW}
\href{https://stacks.math.columbia.edu/tag/0DMW}{\texttt{Stacks tag 0DMW}}
\group{spaces-over-fields}

Let $X$ be an algebraic space over the field $k$. We say $X$ is
{\it geometrically integral} over $k$ if the algebraic space
$X_{k'}$ is integral (Definition \ref{spaces-over-fields-definition-integral-algebraic-space})
...
\source{stacks:0DMX}
\href{https://stacks.math.columbia.edu/tag/0DMX}{\texttt{Stacks tag 0DMX}}
\group{spaces-over-fields}
...
\source{stacks:0DMY}
\href{https://stacks.math.columbia.edu/tag/0DMY}{\texttt{Stacks tag 0DMY}}
\group{spaces-over-fields}
...
\begin{lemma}[Characterize trivial pic integral]
\label{spaces-over-fields-lemma-characterize-trivial-pic-integral}
\source{stacks:0DMZ}
\href{https://stacks.math.columbia.edu/tag/0DMZ}{\texttt{Stacks tag 0DMZ}}
\group{spaces-over-fields}
...
is a field in Lemma \ref{spaces-over-fields-lemma-proper-geometrically-reduced-global-sections}.
...
\begin{lemma}[Integral dimension]
\label{spaces-over-fields-lemma-integral-dimension}
\source{stacks:0EDB}
\href{https://stacks.math.columbia.edu/tag/0EDB}{\texttt{Stacks tag 0EDB}}
\group{spaces-over-fields}
...
\begin{lemma}[Alteration dimension]
\label{spaces-over-fields-lemma-alteration-dimension}
\source{stacks:0EDC}
\href{https://stacks.math.columbia.edu/tag/0EDC}{\texttt{Stacks tag 0EDC}}
\group{spaces-over-fields}
...
discussion following Definition \ref{spaces-over-fields-definition-integral-algebraic-space}.
...
Lemma \ref{spaces-over-fields-lemma-alteration-contained-in}.
...
is integral. Picture
$$
\begin{array}{cc}X'' \downarrow\longrightarrow & X \overset{f}{\downarrow} \\ Y' \longrightarrow & Y\end{array}
$$
By Lemma \ref{spaces-over-fields-lemma-integral-dimension} we have $\dim(X'') = \dim(X)$
...
\begin{lemma}[Smooth regular]
\label{spaces-over-fields-lemma-smooth-regular}
\source{stacks:06M1}
\href{https://stacks.math.columbia.edu/tag/06M1}{\texttt{Stacks tag 06M1}}
\group{spaces-over-fields}
...
\source{stacks:07W4}
\href{https://stacks.math.columbia.edu/tag/07W4}{\texttt{Stacks tag 07W4}}
\group{spaces-over-fields}
...
\source{stacks:0DN1}
\href{https://stacks.math.columbia.edu/tag/0DN1}{\texttt{Stacks tag 0DN1}}
\group{spaces-over-fields}
...
\source{stacks:0DN2}
\href{https://stacks.math.columbia.edu/tag/0DN2}{\texttt{Stacks tag 0DN2}}
\group{spaces-over-fields}
...
\source{stacks:0EDD}
\href{https://stacks.math.columbia.edu/tag/0EDD}{\texttt{Stacks tag 0EDD}}
\group{spaces-over-fields}
...
\source{stacks:0DN4}
\href{https://stacks.math.columbia.edu/tag/0DN4}{\texttt{Stacks tag 0DN4}}
\group{spaces-over-fields}
...
By Lemma \ref{spaces-over-fields-lemma-euler-characteristic-additive} we have
$$
...
\source{stacks:0EDE}
\href{https://stacks.math.columbia.edu/tag/0EDE}{\texttt{Stacks tag 0EDE}}
\group{spaces-over-fields}
...
(Lemma \ref{spaces-over-fields-lemma-euler-characteristic-additive})
...
Lemma \ref{spaces-over-fields-lemma-numerical-polynomial-from-euler}.
...
\source{stacks:0EDF}
\href{https://stacks.math.columbia.edu/tag/0EDF}{\texttt{Stacks tag 0EDF}}
\group{spaces-over-fields}
...
\source{stacks:0EDG}
\href{https://stacks.math.columbia.edu/tag/0EDG}{\texttt{Stacks tag 0EDG}}
\group{spaces-over-fields}

In the situation of Definition \ref{spaces-over-fields-definition-intersection-number}
...
\source{stacks:0EDH}
\href{https://stacks.math.columbia.edu/tag/0EDH}{\texttt{Stacks tag 0EDH}}
\group{spaces-over-fields}
...
\begin{proof}
This is true because by Lemma \ref{spaces-over-fields-lemma-numerical-polynomial-from-euler}
the function
$$
...
\source{stacks:0EDI}
\href{https://stacks.math.columbia.edu/tag/0EDI}{\texttt{Stacks tag 0EDI}}
\group{spaces-over-fields}
...
\begin{proof}
Immediate from Lemma \ref{spaces-over-fields-lemma-numerical-polynomial-leading-term}
and the definitions.
\end{proof}
...
\source{stacks:0EDJ}
\href{https://stacks.math.columbia.edu/tag/0EDJ}{\texttt{Stacks tag 0EDJ}}
\group{spaces-over-fields}
...
$$
where $\deg(Z \to f(Z))$ is as in Definition \ref{spaces-over-fields-definition-degree}
or $0$ if $\dim(f(Z)) < d$.
\end{lemma}
...
$$
The equality follows from Lemma \ref{spaces-over-fields-lemma-euler-characteristic-morphism}
...
by dimension theory (Lemma \ref{spaces-over-fields-lemma-alteration-dimension})
we find that the equivalent conditions (1) -- (5) of
Lemma \ref{spaces-over-fields-lemma-finite-degree} hold. Thus
$\deg(Z \to f(Z))$ is well defined.
By the already used Lemma \ref{spaces-over-fields-lemma-finite-degree}
...
Lemma \ref{spaces-over-fields-lemma-numerical-polynomial-leading-term}.
...
\source{stacks:0EDK}
\href{https://stacks.math.columbia.edu/tag/0EDK}{\texttt{Stacks tag 0EDK}}
\group{spaces-over-fields}
