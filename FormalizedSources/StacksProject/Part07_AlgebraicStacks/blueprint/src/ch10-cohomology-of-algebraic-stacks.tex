...
\begin{lemma}[Flat pullback quasi coherent]
\label{stacks-cohomology-lemma-flat-pullback-quasi-coherent}
\source{stacks:076X}
\href{https://stacks.math.columbia.edu/tag/076X}{\texttt{Stacks tag 076X}}
\group{stacks-cohomology}
...
$$
\begin{array}{cc}U \downarrow\underset{f'}{\longrightarrow} & V \downarrow \\ \mathcal{X} \overset{f}{\longrightarrow} & \mathcal{Y}\end{array}
$$
we obtain a commutative diagram
$$
\begin{array}{cc}\QCoh(\mathcal{O}_U) & \QCoh(\mathcal{O}_V) \longleftarrow \\ \QCoh(\mathcal{O}_\mathcal{X}) \uparrow & \QCoh(\mathcal{O}_\mathcal{Y}) \longleftarrow\uparrow\end{array}
$$
...
\begin{lemma}[Quasi coherent check exact]
\label{stacks-cohomology-lemma-quasi-coherent-check-exact}
\source{stacks:0GQF}
\href{https://stacks.math.columbia.edu/tag/0GQF}{\texttt{Stacks tag 0GQF}}
\group{stacks-cohomology}
...
\begin{lemma}[General pushforward]
\label{stacks-cohomology-lemma-general-pushforward}
\source{stacks:076Z}
\href{https://stacks.math.columbia.edu/tag/076Z}{\texttt{Stacks tag 076Z}}
\group{stacks-cohomology}
...
\begin{lemma}[General pushforward fppf]
\label{stacks-cohomology-lemma-general-pushforward-fppf}
\source{stacks:0770}
\href{https://stacks.math.columbia.edu/tag/0770}{\texttt{Stacks tag 0770}}
\group{stacks-cohomology}
...
\begin{proof}
Identical to the proof of Lemma \ref{stacks-cohomology-lemma-general-pushforward}.
\end{proof}
...
\begin{lemma}[Check lqc on etale covering]
\label{stacks-cohomology-lemma-check-lqc-on-etale-covering}
\source{stacks:075Y}
\href{https://stacks.math.columbia.edu/tag/075Y}{\texttt{Stacks tag 075Y}}
\group{stacks-cohomology}
...
\begin{lemma}[Pushforward locally quasi coherent]
\label{stacks-cohomology-lemma-pushforward-locally-quasi-coherent}
\source{stacks:075Z}
\href{https://stacks.math.columbia.edu/tag/075Z}{\texttt{Stacks tag 075Z}}
\group{stacks-cohomology}
...
\begin{proof}
We will use
Lemma \ref{stacks-cohomology-lemma-general-pushforward}
to prove this. We will check its assumptions (1) -- (4).
Parts (1) and (2) follows from
Sheaves on Stacks, Lemma \ref{stacks-sheaves-lemma-lqc-colimits}.
Part (3) follows from
Lemma \ref{stacks-cohomology-lemma-check-lqc-on-etale-covering}.
...
$$
\begin{array}{cc}\mathcal{Z} \downarrow\underset{g}{\longrightarrow}\underset{f'}{\downarrow} & \mathcal{X} \overset{f}{\downarrow} \\ \mathcal{V} \overset{y}{\longrightarrow} & \mathcal{Y}\end{array}
$$
...
\begin{lemma}[Check lqc on flat covering]
\label{stacks-cohomology-lemma-check-lqc-on-flat-covering}
\source{stacks:07AP}
\href{https://stacks.math.columbia.edu/tag/07AP}{\texttt{Stacks tag 07AP}}
\group{stacks-cohomology}
...
quasi-coherent by Lemma \ref{stacks-cohomology-lemma-pushforward-locally-quasi-coherent}.
...
$$
\begin{array}{ccc}U \underset{x}{\searrow}\underset{f}{\longrightarrow} &  & U' \overset{x'}{\swarrow} \\  & \mathcal{X} & \end{array}
$$
...
\begin{definition}[Flat base change]
\label{stacks-cohomology-definition-flat-base-change}
\source{stacks:0762}
\href{https://stacks.math.columbia.edu/tag/0762}{\texttt{Stacks tag 0762}}
\group{stacks-cohomology}
...
\begin{lemma}[Check flat comparison on etale covering]
\label{stacks-cohomology-lemma-check-flat-comparison-on-etale-covering}
\source{stacks:0764}
\href{https://stacks.math.columbia.edu/tag/0764}{\texttt{Stacks tag 0764}}
\group{stacks-cohomology}
...
$$
\begin{array}{ccc}U_i = U \times_{U'} U_i' \underset{a_i}{\longrightarrow}\downarrow & U_i' \underset{x_i'}{\longrightarrow}\downarrow & \mathcal{X}_i \overset{f_i}{\downarrow} \\ U \overset{a}{\longrightarrow} & U' \overset{x'}{\longrightarrow} & \mathcal{X}\end{array}
$$
...
\begin{lemma}[Flat comparison]
\label{stacks-cohomology-lemma-flat-comparison}
\source{stacks:0765}
\href{https://stacks.math.columbia.edu/tag/0765}{\texttt{Stacks tag 0765}}
\group{stacks-cohomology}
...
and
Lemmas \ref{stacks-cohomology-lemma-check-lqc-on-etale-covering} and
...
of algebraic stacks
$$
\begin{array}{ccc}\mathcal{Z} \underset{f''}{\downarrow}\underset{a}{\longrightarrow} & \mathcal{Z}' \underset{x'}{\longrightarrow}\underset{f'}{\downarrow} & \mathcal{X} \overset{f}{\downarrow} \\ \mathcal{V} \overset{b}{\longrightarrow} & \mathcal{V}' \overset{y'}{\longrightarrow} & \mathcal{Y}\end{array}
$$
...
\begin{proposition}[Loc qcoh flat base change]
\label{stacks-cohomology-proposition-loc-qcoh-flat-base-change}
\source{stacks:0771}
\href{https://stacks.math.columbia.edu/tag/0771}{\texttt{Stacks tag 0771}}
\group{stacks-cohomology}
...
\medskip\noindent
Part (3) follows from
Lemma \ref{stacks-cohomology-lemma-check-flat-comparison-on-etale-covering}
and
Sheaves on Stacks, Lemma \ref{stacks-sheaves-lemma-pullback-lqc}.

\medskip\noindent
Part (4)(b) for $R^if_*\mathcal{F}$ computed in the \'etale cohomology
follows from Lemma \ref{stacks-cohomology-lemma-flat-comparison}.
...
Lemma \ref{stacks-cohomology-lemma-check-flat-comparison-on-etale-covering} and
Sheaves on Stacks, Lemma \ref{stacks-sheaves-lemma-lqc-colimits}.
\end{proof}

\begin{lemma}[Check lqc fbc on covering]
\label{stacks-cohomology-lemma-check-lqc-fbc-on-covering}
\source{stacks:07AQ}
\href{https://stacks.math.columbia.edu/tag/07AQ}{\texttt{Stacks tag 07AQ}}
\group{stacks-cohomology}
...
Lemma \ref{stacks-cohomology-lemma-check-lqc-on-flat-covering}.
...
\begin{lemma}[Loc qcoh fbc compute higher direct image]
\label{stacks-cohomology-lemma-loc-qcoh-fbc-compute-higher-direct-image}
\source{stacks:0GQH}
\href{https://stacks.math.columbia.edu/tag/0GQH}{\texttt{Stacks tag 0GQH}}
\group{stacks-cohomology}
...
by Proposition \ref{stacks-cohomology-proposition-loc-qcoh-flat-base-change}.
...
\begin{lemma}[Loc qcoh fbc affine direct image]
\label{stacks-cohomology-lemma-loc-qcoh-fbc-affine-direct-image}
\source{stacks:0GQI}
\href{https://stacks.math.columbia.edu/tag/0GQI}{\texttt{Stacks tag 0GQI}}
\group{stacks-cohomology}
...
\begin{proof}
The functors exist by Proposition \ref{stacks-cohomology-proposition-loc-qcoh-flat-base-change}.
By Lemma \ref{stacks-cohomology-lemma-loc-qcoh-fbc-compute-higher-direct-image}
...
\source{stacks:0773}
\href{https://stacks.math.columbia.edu/tag/0773}{\texttt{Stacks tag 0773}}
\group{stacks-cohomology}
...
\begin{lemma}[Parasitic]
\label{stacks-cohomology-lemma-parasitic}
\source{stacks:0774}
\href{https://stacks.math.columbia.edu/tag/0774}{\texttt{Stacks tag 0774}}
\group{stacks-cohomology}
...
\begin{lemma}[Pushforward parasitic]
\label{stacks-cohomology-lemma-pushforward-parasitic}
\source{stacks:0775}
\href{https://stacks.math.columbia.edu/tag/0775}{\texttt{Stacks tag 0775}}
\group{stacks-cohomology}
...
By Lemma \ref{stacks-cohomology-lemma-parasitic} it suffices to show that
...
Lemma \ref{stacks-cohomology-lemma-parasitic} we see that $\text{pr}^{-1}\mathcal{F}$
...
Lemma \ref{stacks-cohomology-lemma-parasitic} because the morphisms
$f_p : \mathcal{U}_p =
...
proof of Lemma \ref{stacks-cohomology-lemma-general-pushforward})
...
\begin{lemma}[Exact sequence quasi coherent parasitic cohomology]
\label{stacks-cohomology-lemma-exact-sequence-quasi-coherent-parasitic-cohomology}
\source{stacks:0776}
\href{https://stacks.math.columbia.edu/tag/0776}{\texttt{Stacks tag 0776}}
\group{stacks-cohomology}
...
On the other hand, by Lemma \ref{stacks-cohomology-lemma-flat-pullback-quasi-coherent} and
...
Lemma \ref{stacks-cohomology-lemma-quasi-coherent-check-exact}
...
\source{stacks:0778}
\href{https://stacks.math.columbia.edu/tag/0778}{\texttt{Stacks tag 0778}}
\group{stacks-cohomology}
...
\begin{lemma}[Adjoint kernel parasitic]
\label{stacks-cohomology-lemma-adjoint-kernel-parasitic}
\source{stacks:0779}
\href{https://stacks.math.columbia.edu/tag/0779}{\texttt{Stacks tag 0779}}
\group{stacks-cohomology}

Let $\mathcal{X}$ be an algebraic stack.
Let $Q : \textit{LQCoh}^{fbc}(\mathcal{O}_\mathcal{X}) \to
\QCoh(\mathcal{O}_\mathcal{X})$
be the functor constructed in Lemma \ref{stacks-cohomology-lemma-adjoint}.
\begin{enumerate}
...
\begin{proof}
Write $\mathcal{X} = [U/R]$ as in the proof of Lemma \ref{stacks-cohomology-lemma-adjoint}.
Let $\mathcal{F}$ be an object of
$\textit{LQCoh}^{fbc}(\mathcal{O}_\mathcal{X})$.
It is clear from the proof of Lemma \ref{stacks-cohomology-lemma-adjoint}
...
$$
\begin{array}{cc}W \underset{p}{\downarrow}\underset{q}{\longrightarrow} & V \downarrow \\ U \longrightarrow & \mathcal{X}\end{array}
$$
...
$$
\begin{array}{ccccc}0 \longrightarrow & Q(\mathcal{F}) \longrightarrow\underset{a}{\downarrow} & Q(\mathcal{G}) \longrightarrow\underset{b}{\downarrow} & Q(\mathcal{H}) \longrightarrow\underset{c}{\downarrow} & 0 \\ 0 \longrightarrow & \mathcal{F} \longrightarrow & \mathcal{G} \longrightarrow & \mathcal{H} \longrightarrow & 0\end{array}
$$
...
Lemma \ref{stacks-cohomology-lemma-adjoint}. This uses a presentation $\mathcal{X} = [U/R]$
...
\begin{lemma}[Flat morphism and Q]
\label{stacks-cohomology-lemma-flat-morphism-and-Q}
\source{stacks:0GQJ}
\href{https://stacks.math.columbia.edu/tag/0GQJ}{\texttt{Stacks tag 0GQJ}}
\group{stacks-cohomology}

Let $f : \mathcal{X} \to \mathcal{Y}$ be a flat morphism of algebraic stacks.
Then $Q_\mathcal{X} \circ f^* = f^* \circ Q_\mathcal{Y}$ where
$Q_\mathcal{X}$ and $Q_\mathcal{Y}$ are as in Lemma \ref{stacks-cohomology-lemma-adjoint}.
\end{lemma}
...
by Lemma \ref{stacks-cohomology-lemma-adjoint-kernel-parasitic}.
...
\begin{lemma}[Flat object and Q]
\label{stacks-cohomology-lemma-flat-object-and-Q}
\source{stacks:0GQK}
\href{https://stacks.math.columbia.edu/tag/0GQK}{\texttt{Stacks tag 0GQK}}
\group{stacks-cohomology}
...
are parasitic, see Lemma \ref{stacks-cohomology-lemma-adjoint-kernel-parasitic}.
\end{proof}

\begin{remark}[QCoh abelian]
\label{stacks-cohomology-remark-QCoh-abelian}
\source{stacks:0GQL}
\href{https://stacks.math.columbia.edu/tag/0GQL}{\texttt{Stacks tag 0GQL}}
\group{stacks-cohomology}
...
Lemmas \ref{stacks-cohomology-lemma-adjoint} and \ref{stacks-cohomology-lemma-adjoint-kernel-parasitic}
...
$\textit{Mod}(\mathcal{O}_\mathcal{X})$
is in $\textit{LQCoh}^{fbc}(\mathcal{O}_\mathcal{X})$
by Proposition \ref{stacks-cohomology-proposition-loc-qcoh-flat-base-change} and
$Q(\Ker(\varphi))$ is the kernel in $\QCoh(\mathcal{O}_\mathcal{X})$.
\end{enumerate}
This follows from the references given.
\end{remark}

\begin{remark}[QCoh tensor]
\label{stacks-cohomology-remark-QCoh-tensor}
\source{stacks:0GQM}
\href{https://stacks.math.columbia.edu/tag/0GQM}{\texttt{Stacks tag 0GQM}}
\group{stacks-cohomology}
...
same property, see Proposition \ref{stacks-cohomology-proposition-loc-qcoh-flat-base-change}.
...
$$
\begin{array}{ccc}Q(\mathcal{F})
\otimes_{\mathcal{O}_\mathcal{X}}
Q(\mathcal{G}) \longrightarrow\searrow &  & \mathcal{F}
\otimes_{\mathcal{O}_\mathcal{X}}
\mathcal{G} \\  & Q(\mathcal{F} \otimes_{\mathcal{O}_\mathcal{X}} \mathcal{G}) \nearrow & \end{array}
$$
...
Lemmas \ref{stacks-cohomology-lemma-adjoint} and \ref{stacks-cohomology-lemma-adjoint-kernel-parasitic}
and Definition \ref{stacks-cohomology-definition-parasitic}).
...
\begin{remark}[Bousfield colocalization]
\label{stacks-cohomology-remark-bousfield-colocalization}
\source{stacks:07B2}
\href{https://stacks.math.columbia.edu/tag/07B2}{\texttt{Stacks tag 07B2}}
\group{stacks-cohomology}
...
\begin{lemma}[Internal hom fp into qcoh]
\label{stacks-cohomology-lemma-internal-hom-fp-into-qcoh}
\source{stacks:0GQN}
\href{https://stacks.math.columbia.edu/tag/0GQN}{\texttt{Stacks tag 0GQN}}
\group{stacks-cohomology}
...
By Lemma \ref{stacks-cohomology-lemma-check-flat-comparison-on-etale-covering}
we see that $\SheafHom_{\mathcal{O}_\mathcal{X}}(\mathcal{F}, \mathcal{G})$
has the flat base change property. Hence
$\SheafHom_{\mathcal{O}_\mathcal{X}}(\mathcal{F}, \mathcal{G})$
is an object of $\textit{LQCoh}^{fbc}(\mathcal{O}_\mathcal{X})$
and it makes sense to apply the functor $Q$ of Lemma \ref{stacks-cohomology-lemma-adjoint}
...
\begin{lemma}[Flat morphism and hom]
\label{stacks-cohomology-lemma-flat-morphism-and-hom}
\source{stacks:0GQP}
\href{https://stacks.math.columbia.edu/tag/0GQP}{\texttt{Stacks tag 0GQP}}
\group{stacks-cohomology}
...
with notation as in Lemma \ref{stacks-cohomology-lemma-internal-hom-fp-into-qcoh}.
\end{lemma}
...
Then apply Lemma \ref{stacks-cohomology-lemma-flat-morphism-and-Q} (and here we do use
flatness of $f$).
\end{proof}
...
modules (Lemma \ref{stacks-cohomology-lemma-pushforward-locally-quasi-coherent}),
\item $f_*$ transforms a quasi-coherent sheaf into a locally quasi-coherent
sheaf whose flat comparison maps are isomorphisms
(Lemma \ref{stacks-cohomology-lemma-flat-comparison}), and
...
Lemma \ref{stacks-cohomology-lemma-direct-image-quasi-coherent-over-flat}.
...
\begin{proposition}[Direct image quasi coherent]
\label{stacks-cohomology-proposition-direct-image-quasi-coherent}
\source{stacks:077A}
\href{https://stacks.math.columbia.edu/tag/077A}{\texttt{Stacks tag 077A}}
\group{stacks-cohomology}
...
Proposition \ref{stacks-cohomology-proposition-loc-qcoh-flat-base-change}
and
Lemma \ref{stacks-cohomology-lemma-adjoint}.
...
obtain the second equality by Lemma \ref{stacks-cohomology-lemma-adjoint}. The third
...
Proposition \ref{stacks-cohomology-proposition-loc-qcoh-flat-base-change}.
By
Lemma \ref{stacks-cohomology-lemma-pushforward-parasitic}
...
\begin{lemma}[Direct image quasi coherent over flat]
\label{stacks-cohomology-lemma-direct-image-quasi-coherent-over-flat}
\source{stacks:0GQQ}
\href{https://stacks.math.columbia.edu/tag/0GQQ}{\texttt{Stacks tag 0GQQ}}
\group{stacks-cohomology}
...
the definition of parasitic modules in Definition \ref{stacks-cohomology-definition-parasitic},
and Lemma \ref{stacks-cohomology-lemma-adjoint-kernel-parasitic} part (2).
\end{proof}

\begin{remark}[Direct image quasi coherent tensor]
\label{stacks-cohomology-remark-direct-image-quasi-coherent-tensor}
\source{stacks:0GQR}
\href{https://stacks.math.columbia.edu/tag/0GQR}{\texttt{Stacks tag 0GQR}}
\group{stacks-cohomology}
...
diagram
$$
\begin{array}{cc}f_{\QCoh, *}\mathcal{F}
\otimes_{\mathcal{O}_\mathcal{Y}}
f_{\QCoh, *}\mathcal{G} \longrightarrow\downarrow & f_*\mathcal{F}
\otimes_{\mathcal{O}_\mathcal{Y}}
f_*\mathcal{G} \overset{c}{\downarrow} \\ f_{\QCoh, *}(\mathcal{F}
\otimes_{\mathcal{O}_\mathcal{X}}
\mathcal{G}) \longrightarrow & f_*(\mathcal{F}
\otimes_{\mathcal{O}_\mathcal{X}}
\mathcal{G})\end{array}
$$
...
Remark \ref{stacks-cohomology-remark-QCoh-tensor}.
...
\source{stacks:0782}
\href{https://stacks.math.columbia.edu/tag/0782}{\texttt{Stacks tag 0782}}
\group{stacks-cohomology}
...
\begin{lemma}[Relative leray]
\label{stacks-cohomology-lemma-relative-leray}
\source{stacks:0783}
\href{https://stacks.math.columbia.edu/tag/0783}{\texttt{Stacks tag 0783}}
\group{stacks-cohomology}
...
$$
are parasitic (Lemma \ref{stacks-cohomology-lemma-adjoint-kernel-parasitic}) and that
...
\begin{proposition}[Smooth covering compute cohomology]
\label{stacks-cohomology-proposition-smooth-covering-compute-cohomology}
\source{stacks:0784}
\href{https://stacks.math.columbia.edu/tag/0784}{\texttt{Stacks tag 0784}}
\group{stacks-cohomology}
...
\source{stacks:0785}
\href{https://stacks.math.columbia.edu/tag/0785}{\texttt{Stacks tag 0785}}
\group{stacks-cohomology}
...
Lemma \ref{stacks-cohomology-lemma-flat-pullback-quasi-coherent} and
Sheaves on Stacks, Lemma \ref{stacks-sheaves-lemma-compare-quasi-coherent}.
\item If $f$ is flat, then $c$ kills parasitic objects.
Namely, $f^*$ preserves parasitic object by Lemma \ref{stacks-cohomology-lemma-parasitic}.
...
Lemma \ref{stacks-cohomology-lemma-adjoint-kernel-parasitic}. Thus, since
...
Lemma \ref{stacks-cohomology-lemma-quasi-coherent-check-exact} applied to $0 \to Q(\mathcal{F})$
and the morphism $f : U \to \mathcal{X}$ shows that $Q(\mathcal{F}) = 0$.
Thus $\mathcal{F}$ is parasitic by Lemma \ref{stacks-cohomology-lemma-adjoint-kernel-parasitic}.
...
whence $0$ for example by Remark \ref{stacks-cohomology-remark-bousfield-colocalization}.
\item
...
\source{stacks:0GQV}
\href{https://stacks.math.columbia.edu/tag/0GQV}{\texttt{Stacks tag 0GQV}}
\group{stacks-cohomology}
...
\source{stacks:0GQW}
\href{https://stacks.math.columbia.edu/tag/0GQW}{\texttt{Stacks tag 0GQW}}
\group{stacks-cohomology}
...
Lemma \ref{stacks-cohomology-lemma-colimits} to $H^p(V \times_\mathcal{Y} \mathcal{X}, -)$
where $V$ is affine. Since every $V$ has an fppf covering by
affine objects this proves the lemma. Some details omitted.
\end{proof}

\begin{lemma}[Quasi coherent pushforward direct sums]
\label{stacks-cohomology-lemma-quasi-coherent-pushforward-direct-sums}
\source{stacks:0GQX}
\href{https://stacks.math.columbia.edu/tag/0GQX}{\texttt{Stacks tag 0GQX}}
\group{stacks-cohomology}
...
colimits on all modules by Lemma \ref{stacks-cohomology-lemma-colimit-cohomology}.
The lemma follows as $f_{\QCoh, *} = Q \circ f_*$ and
$R^if_{\QCoh, *} = Q \circ R^if_*$ and $Q$ commutes with
all colimits, see Lemma \ref{stacks-cohomology-lemma-adjoint-kernel-parasitic}.
\end{proof}

\begin{lemma}[Quasi coherent pushforward affine]
\label{stacks-cohomology-lemma-quasi-coherent-pushforward-affine}
\source{stacks:0GQY}
\href{https://stacks.math.columbia.edu/tag/0GQY}{\texttt{Stacks tag 0GQY}}
\group{stacks-cohomology}
...
vanishing from Lemma \ref{stacks-cohomology-lemma-loc-qcoh-fbc-affine-direct-image}.
...
Lemma \ref{stacks-cohomology-lemma-quasi-coherent-pushforward-direct-sums}.
...
\source{stacks:0GQZ}
\href{https://stacks.math.columbia.edu/tag/0GQZ}{\texttt{Stacks tag 0GQZ}}
\group{stacks-cohomology}
...
\begin{definition}[Lisse etale]
\label{stacks-cohomology-definition-lisse-etale}
\source{stacks:0787}
\href{https://stacks.math.columbia.edu/tag/0787}{\texttt{Stacks tag 0787}}
\group{stacks-cohomology}
...
\begin{lemma}[Lisse etale]
\label{stacks-cohomology-lemma-lisse-etale}
\source{stacks:0788}
\href{https://stacks.math.columbia.edu/tag/0788}{\texttt{Stacks tag 0788}}
\group{stacks-cohomology}
...
\begin{lemma}[Lisse etale cohomology]
\label{stacks-cohomology-lemma-lisse-etale-cohomology}
\source{stacks:0GR0}
\href{https://stacks.math.columbia.edu/tag/0GR0}{\texttt{Stacks tag 0GR0}}
\group{stacks-cohomology}
...
\begin{lemma}[Lisse etale modules]
\label{stacks-cohomology-lemma-lisse-etale-modules}
\source{stacks:0789}
\href{https://stacks.math.columbia.edu/tag/0789}{\texttt{Stacks tag 0789}}
\group{stacks-cohomology}
...
$g^* = g^{-1}$ and the
equality for abelian sheaves in Lemma \ref{stacks-cohomology-lemma-lisse-etale}.
\end{proof}

\begin{lemma}[Lisse etale structure sheaf]
\label{stacks-cohomology-lemma-lisse-etale-structure-sheaf}
\source{stacks:078A}
\href{https://stacks.math.columbia.edu/tag/078A}{\texttt{Stacks tag 078A}}
\group{stacks-cohomology}

Let $\mathcal{X}$ be an algebraic stack. Notation as in
Lemmas \ref{stacks-cohomology-lemma-lisse-etale} and \ref{stacks-cohomology-lemma-lisse-etale-modules}.
\begin{enumerate}
...
$$
\begin{array}{ccc}V \underset{(\varphi, 0)}{\longrightarrow}\underset{\varphi}{\searrow} &  & U \times \mathbf{A}^1 \\  &  & U \underset{(\text{id}, 0)}{\uparrow}\end{array}
$$
we see that
...
\begin{lemma}[Parasitic in terms flat fppf]
\label{stacks-cohomology-lemma-parasitic-in-terms-flat-fppf}
\source{stacks:07AR}
\href{https://stacks.math.columbia.edu/tag/07AR}{\texttt{Stacks tag 07AR}}
\group{stacks-cohomology}
...
\Sh(\mathcal{X}_\etale)$ is as in Lemma \ref{stacks-cohomology-lemma-lisse-etale}.
\end{enumerate}
...
is as in Lemma \ref{stacks-cohomology-lemma-lisse-etale}.
\end{enumerate}
\end{enumerate}
\end{lemma}
...
\begin{lemma}[Lisse etale functorial]
\label{stacks-cohomology-lemma-lisse-etale-functorial}
\source{stacks:07AT}
\href{https://stacks.math.columbia.edu/tag/07AT}{\texttt{Stacks tag 07AT}}
\group{stacks-cohomology}
...
commutative diagram
$$
\begin{array}{cc}\Sh(\mathcal{X}_{lisse,\etale}) \underset{g'}{\longrightarrow}\underset{f'}{\downarrow} & \Sh(\mathcal{X}_\etale) \overset{f}{\downarrow} \\ \Sh(\mathcal{Y}_{lisse,\etale}) \overset{g}{\longrightarrow} & \Sh(\mathcal{Y}_\etale)\end{array}
$$
...
commutative diagram
$$
\begin{array}{cc}\Sh(\mathcal{X}_{flat,fppf}) \underset{g'}{\longrightarrow}\underset{f'}{\downarrow} & \Sh(\mathcal{X}_{fppf}) \overset{f}{\downarrow} \\ \Sh(\mathcal{Y}_{flat,fppf}) \overset{g}{\longrightarrow} & \Sh(\mathcal{Y}_{fppf})\end{array}
$$
We have $f'_*(g')^{-1} = g^{-1}f_*$ and $g'_!(f')^{-1} = f^{-1}g_!$.
\end{enumerate}
\end{lemma}
...
Lemma \ref{stacks-cohomology-lemma-lisse-etale}) and
...
\begin{lemma}[Lisse etale functorial pushforward]
\label{stacks-cohomology-lemma-lisse-etale-functorial-pushforward}
\source{stacks:0GR2}
\href{https://stacks.math.columbia.edu/tag/0GR2}{\texttt{Stacks tag 0GR2}}
\group{stacks-cohomology}

With assumptions and notation as in Lemma \ref{stacks-cohomology-lemma-lisse-etale-functorial}.
...
\begin{proof}
As in the proof of Lemma \ref{stacks-cohomology-lemma-lisse-etale-functorial}
...
\begin{lemma}[Lisse etale functorial cohomology]
\label{stacks-cohomology-lemma-lisse-etale-functorial-cohomology}
\source{stacks:0GR3}
\href{https://stacks.math.columbia.edu/tag/0GR3}{\texttt{Stacks tag 0GR3}}
\group{stacks-cohomology}
...
Sheaves on Stacks, Lemma \ref{stacks-sheaves-lemma-pushforward-restriction}
and Lemma \ref{stacks-cohomology-lemma-lisse-etale-functorial-pushforward}
...
\begin{lemma}[Check qc on etale covering]
\label{stacks-cohomology-lemma-check-qc-on-etale-covering}
\source{stacks:07AZ}
\href{https://stacks.math.columbia.edu/tag/07AZ}{\texttt{Stacks tag 07AZ}}
\group{stacks-cohomology}
...
\begin{lemma}[Shriek quasi coherent]
\label{stacks-cohomology-lemma-shriek-quasi-coherent}
\source{stacks:07B0}
\href{https://stacks.math.columbia.edu/tag/07B0}{\texttt{Stacks tag 07B0}}
\group{stacks-cohomology}
...
Using Lemma \ref{stacks-cohomology-lemma-check-qc-on-etale-covering}
...
Lemma \ref{stacks-cohomology-lemma-lisse-etale-modules} and
...
$$
Lemma \ref{stacks-cohomology-lemma-lisse-etale-structure-sheaf}
...
\source{stacks:07B1}
\href{https://stacks.math.columbia.edu/tag/07B1}{\texttt{Stacks tag 07B1}}
\group{stacks-cohomology}

Let $\mathcal{X}$ be an algebraic stack.
\begin{enumerate}
\item With $g$ as in Lemma \ref{stacks-cohomology-lemma-lisse-etale}
for the lisse-\'etale site we have
\begin{enumerate}
\item the functors $g^{-1}$ and $g_!$ define mutually inverse functors
$$
\begin{array}{cc}\QCoh(\mathcal{O}_\mathcal{X}) \overset{g^{-1}}{\longrightarrow} & \QCoh(\mathcal{X}_{lisse,\etale},
\mathcal{O}_{\mathcal{X}_{lisse,\etale}}) \overset{g_!}{\longleftarrow}\end{array}
$$
...
\item the functors $g^{-1}$ and $g_!$ define mutually inverse functors
$$
\begin{array}{cc}\QCoh(\mathcal{O}_\mathcal{X}) \overset{g^{-1}}{\longrightarrow} & \QCoh(\mathcal{X}_{flat,fppf},
\mathcal{O}_{\mathcal{X}_{flat,fppf}}) \overset{g_!}{\longleftarrow}\end{array}
$$
\item if $\mathcal{F}$ is in $\textit{LQCoh}^{fbc}(\mathcal{O}_\mathcal{X})$
then $g^{-1}\mathcal{F}$ is in
...
Lemma \ref{stacks-cohomology-lemma-shriek-quasi-coherent}.
...
Lemma \ref{stacks-cohomology-lemma-parasitic-in-terms-flat-fppf}
...
\begin{lemma}[Quasi coherent weak serre]
\label{stacks-cohomology-lemma-quasi-coherent-weak-serre}
\source{stacks:07B4}
\href{https://stacks.math.columbia.edu/tag/07B4}{\texttt{Stacks tag 07B4}}
\group{stacks-cohomology}
...
$\mathcal{G}$ and $\varphi$, see Lemma \ref{stacks-cohomology-lemma-lisse-etale-modules}.
By Lemma \ref{stacks-cohomology-lemma-shriek-quasi-coherent}
...
Since $g^*$ is exact (see Lemma \ref{stacks-cohomology-lemma-lisse-etale})
$g^*\Coker(g_!\varphi) = \Coker(g^*g_!\varphi) = \Coker(\varphi)$
is quasi-coherent too (see Lemma \ref{stacks-cohomology-lemma-quasi-coherent}).
By Proposition \ref{stacks-cohomology-proposition-loc-qcoh-flat-base-change}
...
modules by Lemma \ref{stacks-cohomology-lemma-quasi-coherent} we conclude that
...
(by Lemma \ref{stacks-cohomology-lemma-quasi-coherent}), cohomology
of $\mathcal{F}$ and $\mathcal{F}'$ agree (by
Lemma \ref{stacks-cohomology-lemma-lisse-etale-cohomology}), and we know that
...
\source{stacks:0GR5}
\href{https://stacks.math.columbia.edu/tag/0GR5}{\texttt{Stacks tag 0GR5}}
\group{stacks-cohomology}
...
\source{stacks:0GR6}
\href{https://stacks.math.columbia.edu/tag/0GR6}{\texttt{Stacks tag 0GR6}}
\group{stacks-cohomology}
...
conditions of Lemma \ref{stacks-cohomology-lemma-coherent-Noetherian}.
The category of coherent $\mathcal{O}_\mathcal{X}$-modules is
denote $\textit{Coh}(\mathcal{O}_\mathcal{X})$.
\end{definition}

\begin{lemma}[Elementary coherent]
\label{stacks-cohomology-lemma-elementary-coherent}
\source{stacks:0GR7}
\href{https://stacks.math.columbia.edu/tag/0GR7}{\texttt{Stacks tag 0GR7}}
\group{stacks-cohomology}
...
\source{stacks:0GR8}
\href{https://stacks.math.columbia.edu/tag/0GR8}{\texttt{Stacks tag 0GR8}}
\group{stacks-cohomology}
...
\source{stacks:0GR9}
\href{https://stacks.math.columbia.edu/tag/0GR9}{\texttt{Stacks tag 0GR9}}
\group{stacks-cohomology}
...
for quasi-coherent modules in Remark \ref{stacks-cohomology-remark-QCoh-abelian}.
...
By Lemma \ref{stacks-cohomology-lemma-coherent-Noetherian} it suffices to prove this after
...
$\mathcal{F} \mapsto f^*\mathcal{F}|_{U_\etale}$
kills parasitic modules by Lemma \ref{stacks-cohomology-lemma-parasitic}.
Hence $f^*Q(\Ker(\varphi))|_{U_\etale} = f^*\Ker(\varphi)|_{U_\etale}$
by part (2) of Lemma \ref{stacks-cohomology-lemma-adjoint-kernel-parasitic}.
Thus we conclude that $Q(\Ker(\varphi))$ is coherent in the same way.
\end{proof}

\begin{lemma}[Extension coherent]
\label{stacks-cohomology-lemma-extension-coherent}
\source{stacks:0GRA}
\href{https://stacks.math.columbia.edu/tag/0GRA}{\texttt{Stacks tag 0GRA}}
\group{stacks-cohomology}
...
\source{stacks:0GRB}
\href{https://stacks.math.columbia.edu/tag/0GRB}{\texttt{Stacks tag 0GRB}}
\group{stacks-cohomology}
...
is exact (Lemma \ref{stacks-cohomology-lemma-flat-pullback-quasi-coherent})
...
with the proof of Lemma \ref{stacks-cohomology-lemma-coherent-abelian-Noetherian}.
\end{proof}
...
\begin{lemma}[Coherent presentation]
\label{stacks-cohomology-lemma-coherent-presentation}
\source{stacks:0GRC}
\href{https://stacks.math.columbia.edu/tag/0GRC}{\texttt{Stacks tag 0GRC}}
\group{stacks-cohomology}
...
\begin{lemma}[Coherent hom]
\label{stacks-cohomology-lemma-coherent-hom}
\source{stacks:0GRD}
\href{https://stacks.math.columbia.edu/tag/0GRD}{\texttt{Stacks tag 0GRD}}
\group{stacks-cohomology}
...
constructed in Lemma \ref{stacks-cohomology-lemma-internal-hom-fp-into-qcoh}
is a coherent $\mathcal{O}_\mathcal{X}$-module.
\end{lemma}

\begin{proof}
Let $U \to \mathcal{X}$ be a smooth surjective morphism from a scheme.
By item (\ref{item-hom-restriction}) in Section \ref{stacks-cohomology-section-further-remarks}
...
\source{stacks:0GRF}
\href{https://stacks.math.columbia.edu/tag/0GRF}{\texttt{Stacks tag 0GRF}}
\group{stacks-cohomology}
...
see Lemma \ref{stacks-cohomology-lemma-coherent-Noetherian-quasi-coherent-sub-quotient}.
...
By Lemma \ref{stacks-cohomology-lemma-coherent-presentation} we have
