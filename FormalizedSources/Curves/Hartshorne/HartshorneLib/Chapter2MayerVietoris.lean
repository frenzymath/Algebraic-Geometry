...
`HartshorneLib.Chapter2OverOpen`). The (0,1)-slice is then extracted elementwise
...
The scheme-level two-affine-cover bridge is intentionally outside this generic core.
-/
