...
\source{stacks:022P}
\href{https://stacks.math.columbia.edu/tag/022P}{\texttt{Stacks tag 022P}}
\group{groupoids}
...
\begin{lemma}[Restrict relation]
\label{groupoids-lemma-restrict-relation}
\source{stacks:02V8}
\href{https://stacks.math.columbia.edu/tag/02V8}{\texttt{Stacks tag 02V8}}
\group{groupoids}
...
\begin{definition}[Restrict relation]
\label{groupoids-definition-restrict-relation}
\source{stacks:02V9}
\href{https://stacks.math.columbia.edu/tag/02V9}{\texttt{Stacks tag 02V9}}
\group{groupoids}
...
\source{stacks:022Q}
\href{https://stacks.math.columbia.edu/tag/022Q}{\texttt{Stacks tag 022Q}}
\group{groupoids}
...
diagram
$$
\begin{array}{cc}\kappa(r) \longrightarrow & K \\ \kappa(y) \uparrow\longrightarrow & \kappa(r') \uparrow\end{array}
$$
...
\begin{lemma}[Etale equivalence relation]
\label{groupoids-lemma-etale-equivalence-relation}
\source{stacks:0DT7}
\href{https://stacks.math.columbia.edu/tag/0DT7}{\texttt{Stacks tag 0DT7}}
\group{groupoids}
...
$$
\begin{array}{cccccc}U \underset{e}{\longrightarrow}\underset{\Delta}{\downarrow} & R \underset{j}{\downarrow} & R \overset{j}{\downarrow}\underset{i}{\longrightarrow} & R \overset{j}{\downarrow} & R \times_{s, U, t} R \overset{j \times j}{\downarrow}\underset{c}{\longrightarrow} & R \overset{j}{\downarrow} \\ U \times_S U \longrightarrow & U \times_S U & U \times_S U \overset{flip}{\longrightarrow} & U \times_S U & U \times_S U \times_S U \overset{\text{pr}_{02}}{\longrightarrow} & U \times_S U\end{array}
$$
are commutative.
\end{enumerate}
...
\source{stacks:022S}
\href{https://stacks.math.columbia.edu/tag/022S}{\texttt{Stacks tag 022S}}
\group{groupoids}
...
By the discussion above (and the discussion in Section \ref{groupoids-section-notation})
...
is commutative:
$$
\begin{array}{cc}G \times_S G \underset{f \times f}{\longrightarrow}\underset{m}{\downarrow} & G' \times_S G' \overset{m'}{\downarrow} \\ G \overset{f}{\longrightarrow} & G'\end{array}
$$

\begin{lemma}[Base change group scheme]
\label{groupoids-lemma-base-change-group-scheme}
\source{stacks:022T}
\href{https://stacks.math.columbia.edu/tag/022T}{\texttt{Stacks tag 022T}}
\group{groupoids}
...
\begin{definition}[Closed subgroup scheme]
\label{groupoids-definition-closed-subgroup-scheme}
\source{stacks:047D}
\href{https://stacks.math.columbia.edu/tag/047D}{\texttt{Stacks tag 047D}}
\group{groupoids}
...
\begin{lemma}[Closed subgroup scheme]
\label{groupoids-lemma-closed-subgroup-scheme}
\source{stacks:0G8L}
\href{https://stacks.math.columbia.edu/tag/0G8L}{\texttt{Stacks tag 0G8L}}
\group{groupoids}
...
\begin{definition}[Smooth group scheme]
\label{groupoids-definition-smooth-group-scheme}
\source{stacks:047E}
\href{https://stacks.math.columbia.edu/tag/047E}{\texttt{Stacks tag 047E}}
\group{groupoids}
...
\source{stacks:022U}
\href{https://stacks.math.columbia.edu/tag/022U}{\texttt{Stacks tag 022U}}
\group{groupoids}
...
\source{stacks:040M}
\href{https://stacks.math.columbia.edu/tag/040M}{\texttt{Stacks tag 040M}}
\group{groupoids}
...
\source{stacks:022V}
\href{https://stacks.math.columbia.edu/tag/022V}{\texttt{Stacks tag 022V}}
\group{groupoids}
...
\source{stacks:022W}
\href{https://stacks.math.columbia.edu/tag/022W}{\texttt{Stacks tag 022W}}
\group{groupoids}
...
\source{stacks:022X}
\href{https://stacks.math.columbia.edu/tag/022X}{\texttt{Stacks tag 022X}}
\group{groupoids}
...
\source{stacks:03YW}
\href{https://stacks.math.columbia.edu/tag/03YW}{\texttt{Stacks tag 03YW}}
\group{groupoids}
...
\begin{lemma}[Group scheme separated]
\label{groupoids-lemma-group-scheme-separated}
\source{stacks:047G}
\href{https://stacks.math.columbia.edu/tag/047G}{\texttt{Stacks tag 047G}}
\group{groupoids}
...
$$
\begin{array}{cc}G \underset{\Delta_{G/S}}{\longrightarrow}\downarrow & G \times_S G \overset{(g, g') \mapsto m(i(g), g')}{\downarrow} \\ S \overset{e}{\longrightarrow} & G\end{array}
$$
...
\begin{lemma}[Flat action on group scheme]
\label{groupoids-lemma-flat-action-on-group-scheme}
\source{stacks:047H}
\href{https://stacks.math.columbia.edu/tag/047H}{\texttt{Stacks tag 047H}}
\group{groupoids}
...
$$
\begin{array}{ccccc}T \times_S G \underset{(t, g) \mapsto (t, m(\psi(t), g))}{\longrightarrow} &  &  & T \times_S G \underset{\text{pr}}{\longrightarrow}\downarrow & G \downarrow \\  &  &  & T \longrightarrow & S\end{array}
$$
...
\begin{lemma}[Group scheme module differentials]
\label{groupoids-lemma-group-scheme-module-differentials}
\source{stacks:047I}
\href{https://stacks.math.columbia.edu/tag/047I}{\texttt{Stacks tag 047I}}
\group{groupoids}
...
\begin{lemma}[Group scheme addition tangent vectors]
\label{groupoids-lemma-group-scheme-addition-tangent-vectors}
\source{stacks:0BF5}
\href{https://stacks.math.columbia.edu/tag/0BF5}{\texttt{Stacks tag 0BF5}}
\group{groupoids}
...
\begin{lemma}[Group scheme over field open multiplication]
\label{groupoids-lemma-group-scheme-over-field-open-multiplication}
\source{stacks:047K}
\href{https://stacks.math.columbia.edu/tag/047K}{\texttt{Stacks tag 047K}}
\group{groupoids}
...
because the diagram
$$
\begin{array}{cccc}G \times_k G \overset{m}{\downarrow}\underset{(g, g') \mapsto (m(g, g'), g')}{\longrightarrow} &  &  & G \times_k G \overset{(g, g') \mapsto g}{\downarrow} \\ G \overset{\text{id}}{\longrightarrow} &  &  & G\end{array}
$$
...
\begin{lemma}[Group scheme over field translate open]
\label{groupoids-lemma-group-scheme-over-field-translate-open}
\source{stacks:0B7N}
\href{https://stacks.math.columbia.edu/tag/0B7N}{\texttt{Stacks tag 0B7N}}
\group{groupoids}
...
\begin{lemma}[Group scheme over field separated]
\label{groupoids-lemma-group-scheme-over-field-separated}
\source{stacks:047L}
\href{https://stacks.math.columbia.edu/tag/047L}{\texttt{Stacks tag 047L}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-lemma-group-scheme-separated}

Say $S = \Spec(k)$ with $k$ a field, and let $G$ be a group scheme
over $S$. By
Lemma \ref{groupoids-lemma-group-scheme-separated}
...
\begin{lemma}[Group scheme field geometrically irreducible]
\label{groupoids-lemma-group-scheme-field-geometrically-irreducible}
\source{stacks:047M}
\href{https://stacks.math.columbia.edu/tag/047M}{\texttt{Stacks tag 047M}}
\group{groupoids}
...
\begin{remark}[Warning group scheme geometrically irreducible]
\label{groupoids-remark-warning-group-scheme-geometrically-irreducible}
\source{stacks:04L9}
\href{https://stacks.math.columbia.edu/tag/04L9}{\texttt{Stacks tag 04L9}}
\group{groupoids}

\uses{groupoids-lemma-group-scheme-field-geometrically-irreducible}
Warning: The result of
Lemma \ref{groupoids-lemma-group-scheme-field-geometrically-irreducible}
...
\begin{lemma}[Reduced subgroup scheme perfect]
\label{groupoids-lemma-reduced-subgroup-scheme-perfect}
\source{stacks:047R}
\href{https://stacks.math.columbia.edu/tag/047R}{\texttt{Stacks tag 047R}}
\group{groupoids}
...
\begin{lemma}[Open subgroup closed over field]
\label{groupoids-lemma-open-subgroup-closed-over-field}
\source{stacks:047S}
\href{https://stacks.math.columbia.edu/tag/047S}{\texttt{Stacks tag 047S}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-lemma-group-scheme-over-field-translate-open}

Let $U = \psi(G') \subset G$. Let $Z = G \setminus \psi(G') = G \setminus U$
with the reduced induced closed subscheme structure. By
Lemma \ref{groupoids-lemma-group-scheme-over-field-translate-open}
the image of
$$
...
\begin{lemma}[Immersion group schemes closed over field]
\label{groupoids-lemma-immersion-group-schemes-closed-over-field}
\source{stacks:047T}
\href{https://stacks.math.columbia.edu/tag/047T}{\texttt{Stacks tag 047T}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-lemma-reduced-subgroup-scheme-perfect, groupoids-lemma-open-subgroup-closed-over-field}
...
Lemma \ref{groupoids-lemma-reduced-subgroup-scheme-perfect}.
...
Lemma \ref{groupoids-lemma-open-subgroup-closed-over-field}
we see that $i(G') \subset \overline{G'}$ is also closed
which implies that $i(G') = \overline{G'}$ as desired.
\end{proof}

\begin{lemma}[Irreducible group scheme over field qc]
\label{groupoids-lemma-irreducible-group-scheme-over-field-qc}
\source{stacks:0B7P}
\href{https://stacks.math.columbia.edu/tag/0B7P}{\texttt{Stacks tag 0B7P}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-lemma-group-scheme-field-geometrically-irreducible, groupoids-lemma-group-scheme-over-field-open-multiplication}

Suppose that $K/k$ is a field extension. If $G_K$
is quasi-compact, then $G$ is too as $G_K \to G$ is surjective.
By Lemma \ref{groupoids-lemma-group-scheme-field-geometrically-irreducible}
...
(Lemma \ref{groupoids-lemma-group-scheme-over-field-open-multiplication})
...
\begin{lemma}[Connected group scheme over field irreducible]
\label{groupoids-lemma-connected-group-scheme-over-field-irreducible}
\source{stacks:0B7Q}
\href{https://stacks.math.columbia.edu/tag/0B7Q}{\texttt{Stacks tag 0B7Q}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-lemma-group-scheme-field-geometrically-irreducible, groupoids-lemma-irreducible-group-scheme-over-field-qc, groupoids-lemma-group-scheme-over-field-translate-open, groupoids-lemma-group-scheme-over-field-separated}
...
Lemma \ref{groupoids-lemma-group-scheme-field-geometrically-irreducible}.
By Lemma \ref{groupoids-lemma-irreducible-group-scheme-over-field-qc}
...
(Lemma \ref{groupoids-lemma-group-scheme-over-field-separated}), the inclusion
...
\begin{proposition}[Connected component]
\label{groupoids-proposition-connected-component}
\source{stacks:0B7R}
\href{https://stacks.math.columbia.edu/tag/0B7R}{\texttt{Stacks tag 0B7R}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-lemma-closed-subgroup-scheme, groupoids-lemma-connected-group-scheme-over-field-irreducible, groupoids-lemma-group-scheme-field-geometrically-irreducible, groupoids-lemma-irreducible-group-scheme-over-field-qc}
...
criterion of Lemma \ref{groupoids-lemma-closed-subgroup-scheme}.
...
By Lemma \ref{groupoids-lemma-connected-group-scheme-over-field-irreducible}
we see that $G^0$ is irreducible. By
Lemma \ref{groupoids-lemma-group-scheme-field-geometrically-irreducible}
we see that $G^0$ is geometrically irreducible. By
Lemma \ref{groupoids-lemma-irreducible-group-scheme-over-field-qc}
we see that $G^0$ is quasi-compact.
\end{proof}

\begin{lemma}[Profinite product over field]
\label{groupoids-lemma-profinite-product-over-field}
\source{stacks:0B7T}
\href{https://stacks.math.columbia.edu/tag/0B7T}{\texttt{Stacks tag 0B7T}}
\group{groupoids}
...
We urge the reader to read Lemma \ref{groupoids-lemma-points-in-affine} first.

\begin{lemma}[Compact set in affine]
\label{groupoids-lemma-compact-set-in-affine}
\source{stacks:0B7U}
\href{https://stacks.math.columbia.edu/tag/0B7U}{\texttt{Stacks tag 0B7U}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-proposition-connected-component, groupoids-lemma-group-scheme-over-field-translate-open, groupoids-lemma-profinite-product-over-field}

Let $G^0 \subset G$ be the closed subgroup scheme found in
Proposition \ref{groupoids-proposition-connected-component}. The first two paragraphs
...
Lemma \ref{groupoids-lemma-profinite-product-over-field}.
...
\source{stacks:047V}
\href{https://stacks.math.columbia.edu/tag/047V}{\texttt{Stacks tag 047V}}
\group{groupoids}

\uses{groupoids-proposition-connected-component}
...
\begin{lemma}[Group scheme field countable affine]
\label{groupoids-lemma-group-scheme-field-countable-affine}
\source{stacks:047U}
\href{https://stacks.math.columbia.edu/tag/047U}{\texttt{Stacks tag 047U}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-lemma-group-scheme-over-field-open-multiplication, groupoids-lemma-open-subgroup-closed-over-field}
...
\begin{lemma}[Group scheme finite type field]
\label{groupoids-lemma-group-scheme-finite-type-field}
\source{stacks:045X}
\href{https://stacks.math.columbia.edu/tag/045X}{\texttt{Stacks tag 045X}}
\group{groupoids}
...
\begin{lemma}[Group scheme characteristic zero smooth]
\label{groupoids-lemma-group-scheme-characteristic-zero-smooth}
\source{stacks:047N}
\href{https://stacks.math.columbia.edu/tag/047N}{\texttt{Stacks tag 047N}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-lemma-group-scheme-module-differentials}

By
Lemma \ref{groupoids-lemma-group-scheme-module-differentials}
...
\begin{remark}[When reduced]
\label{groupoids-remark-when-reduced}
\source{stacks:047O}
\href{https://stacks.math.columbia.edu/tag/047O}{\texttt{Stacks tag 047O}}
\group{groupoids}

\uses{groupoids-lemma-group-scheme-characteristic-zero-smooth}
...
\cite[page 80]{Oort}.
We have seen in
Lemma \ref{groupoids-lemma-group-scheme-characteristic-zero-smooth}
that this holds when the group scheme is locally of finite type.
\end{remark}

\begin{lemma}[Reduced group scheme prefect field characteristic p smooth]
\label{groupoids-lemma-reduced-group-scheme-prefect-field-characteristic-p-smooth}
\source{stacks:047P}
\href{https://stacks.math.columbia.edu/tag/047P}{\texttt{Stacks tag 047P}}
\group{groupoids}
...
\begin{remark}[Reduced smooth not true general]
\label{groupoids-remark-reduced-smooth-not-true-general}
\source{stacks:047Q}
\href{https://stacks.math.columbia.edu/tag/047Q}{\texttt{Stacks tag 047Q}}
\group{groupoids}
...
Lemma \ref{groupoids-lemma-compact-set-in-affine}
with a somewhat easier proof.

\begin{lemma}[Points in affine]
\label{groupoids-lemma-points-in-affine}
\source{stacks:0B7S}
\href{https://stacks.math.columbia.edu/tag/0B7S}{\texttt{Stacks tag 0B7S}}
\group{groupoids}
...
Proposition \ref{groupoids-proposition-connected-component}. Choose an affine
...
\begin{lemma}[Algebraic quasi projective]
\label{groupoids-lemma-algebraic-quasi-projective}
\source{stacks:0BF7}
\href{https://stacks.math.columbia.edu/tag/0BF7}{\texttt{Stacks tag 0BF7}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-proposition-connected-component, groupoids-lemma-group-scheme-characteristic-zero-smooth, groupoids-lemma-reduced-subgroup-scheme-perfect, groupoids-lemma-reduced-group-scheme-prefect-field-characteristic-p-smooth, groupoids-lemma-group-scheme-over-field-separated}
...
$k$ by Lemma \ref{groupoids-lemma-group-scheme-characteristic-zero-smooth}.
...
By Lemma \ref{groupoids-lemma-reduced-subgroup-scheme-perfect}
we see that $H$ is a group scheme over $k$.
By Lemma \ref{groupoids-lemma-reduced-group-scheme-prefect-field-characteristic-p-smooth}
...
Lemma \ref{groupoids-lemma-group-scheme-over-field-separated}.)
...
$$
\begin{array}{ccc}G & U \underset{j}{\longleftarrow}\overset{\pi}{\longrightarrow} & \mathbf{A}^d_k \\  & W \overset{\pi'}{\longrightarrow}\uparrow & V \uparrow\end{array}
$$
...
\begin{lemma}[Algebraic center]
\label{groupoids-lemma-algebraic-center}
\source{stacks:0BF8}
\href{https://stacks.math.columbia.edu/tag/0BF8}{\texttt{Stacks tag 0BF8}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-example-general-linear-group, groupoids-proposition-connected-component, groupoids-lemma-irreducible-group-scheme-over-field-qc}
...
Example \ref{groupoids-example-general-linear-group}, and the
...
Let $G^0 \subset G$ be as in Proposition \ref{groupoids-proposition-connected-component}.
...
\source{stacks:03RO}
\href{https://stacks.math.columbia.edu/tag/03RO}{\texttt{Stacks tag 03RO}}
\group{groupoids}

\uses{groupoids-remark-16-equivalent}
...
$k$\footnote{For equivalent definitions see Remark \ref{groupoids-remark-16-equivalent}.}.
\end{definition}
...
\begin{lemma}[Abelian variety projective]
\label{groupoids-lemma-abelian-variety-projective}
\source{stacks:0BFA}
\href{https://stacks.math.columbia.edu/tag/0BFA}{\texttt{Stacks tag 0BFA}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-lemma-algebraic-quasi-projective}

This follows from
Lemma \ref{groupoids-lemma-algebraic-quasi-projective} and
More on Morphisms, Lemma \ref{more-morphisms-lemma-projective}.
\end{proof}

\begin{lemma}[Abelian variety change field]
\label{groupoids-lemma-abelian-variety-change-field}
\source{stacks:0BFB}
\href{https://stacks.math.columbia.edu/tag/0BFB}{\texttt{Stacks tag 0BFB}}
\group{groupoids}
...
\begin{lemma}[Abelian variety smooth]
\label{groupoids-lemma-abelian-variety-smooth}
\source{stacks:0BFC}
\href{https://stacks.math.columbia.edu/tag/0BFC}{\texttt{Stacks tag 0BFC}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-lemma-group-scheme-characteristic-zero-smooth, groupoids-lemma-reduced-group-scheme-prefect-field-characteristic-p-smooth, groupoids-lemma-abelian-variety-change-field}

If $k$ is perfect then this follows from
Lemma \ref{groupoids-lemma-group-scheme-characteristic-zero-smooth}
(characteristic zero) and
Lemma \ref{groupoids-lemma-reduced-group-scheme-prefect-field-characteristic-p-smooth}
...
Lemma \ref{groupoids-lemma-abelian-variety-change-field}.
\end{proof}

\begin{lemma}[Abelian variety abelian]
\label{groupoids-lemma-abelian-variety-abelian}
\source{stacks:0BFD}
\href{https://stacks.math.columbia.edu/tag/0BFD}{\texttt{Stacks tag 0BFD}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-lemma-abelian-variety-change-field}

Let $k$ be a field. Let $A$ be an abelian variety over $k$.
By Lemma \ref{groupoids-lemma-abelian-variety-change-field} we may replace
...
\begin{lemma}[Apply cube]
\label{groupoids-lemma-apply-cube}
\source{stacks:0BFE}
\href{https://stacks.math.columbia.edu/tag/0BFE}{\texttt{Stacks tag 0BFE}}
\group{groupoids}
...
\begin{lemma}[Pullbacks by n]
\label{groupoids-lemma-pullbacks-by-n}
\source{stacks:0BFF}
\href{https://stacks.math.columbia.edu/tag/0BFF}{\texttt{Stacks tag 0BFF}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-lemma-apply-cube}

Consider the morphism $A \to A \times_k A \times_k A$,
$x \mapsto (x, x, -x)$ where $-x = [-1](x)$. Pulling back
the relation of Lemma \ref{groupoids-lemma-apply-cube} we obtain
$$
\mathcal{L} \otimes
\mathcal{L} \otimes
\mathcal{L} \otimes
...
\begin{lemma}[Degree multiplication by d]
\label{groupoids-lemma-degree-multiplication-by-d}
\source{stacks:0BFG}
\href{https://stacks.math.columbia.edu/tag/0BFG}{\texttt{Stacks tag 0BFG}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-lemma-abelian-variety-projective, groupoids-lemma-pullbacks-by-n, groupoids-lemma-abelian-variety-smooth}

By Lemma \ref{groupoids-lemma-abelian-variety-projective}
...
Lemma \ref{groupoids-lemma-pullbacks-by-n}.
...
Lemma \ref{groupoids-lemma-abelian-variety-smooth}
...
\begin{lemma}[Multiplication by an integer on an abelian variety is an etale morphism if and only if ...]
\label{groupoids-lemma-abelian-variety-multiplication-by-d-etale}
\source{stacks:0BFH}
\href{https://stacks.math.columbia.edu/tag/0BFH}{\texttt{Stacks tag 0BFH}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-lemma-degree-multiplication-by-d, groupoids-lemma-group-scheme-addition-tangent-vectors}
...
(Lemma \ref{groupoids-lemma-degree-multiplication-by-d})
...
By Lemma \ref{groupoids-lemma-group-scheme-addition-tangent-vectors} we see that
$\text{d}[d]$ is given by multiplication by $d$ on $T_{A/k, e}$.
\end{proof}

\begin{lemma}[Abelian variety multiplication by p]
\label{groupoids-lemma-abelian-variety-multiplication-by-p}
\source{stacks:0C0Y}
\href{https://stacks.math.columbia.edu/tag/0C0Y}{\texttt{Stacks tag 0C0Y}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-lemma-group-scheme-addition-tangent-vectors, groupoids-lemma-abelian-variety-multiplication-by-d-etale, groupoids-lemma-degree-multiplication-by-d}

To prove this, we may and do replace $k$ by the algebraic closure.
By Lemma \ref{groupoids-lemma-group-scheme-addition-tangent-vectors}
the derivative of $[p]$ is multiplication by $p$ as a map
$T_{A/k, e} \to T_{A/k, e}$ and hence is zero (compare
with proof of Lemma \ref{groupoids-lemma-abelian-variety-multiplication-by-d-etale}).
...
By Lemma \ref{groupoids-lemma-degree-multiplication-by-d} we see that
...
\begin{proposition}[Review abelian varieties]
\label{groupoids-proposition-review-abelian-varieties}
\source{stacks:03RP}
\href{https://stacks.math.columbia.edu/tag/03RP}{\texttt{Stacks tag 03RP}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-lemma-abelian-variety-projective, groupoids-lemma-abelian-variety-abelian, groupoids-lemma-degree-multiplication-by-d, groupoids-lemma-abelian-variety-multiplication-by-d-etale, groupoids-lemma-abelian-variety-multiplication-by-p}

Part (1) follows from Lemma \ref{groupoids-lemma-abelian-variety-projective}.
Part (2) follows from Lemma \ref{groupoids-lemma-abelian-variety-abelian}.
Part (3) follows from Lemma \ref{groupoids-lemma-degree-multiplication-by-d}.
...
(4) follows from (3).
Part (5) follows from Lemma \ref{groupoids-lemma-degree-multiplication-by-d}
...
Part (6) follows from
Lemma \ref{groupoids-lemma-abelian-variety-multiplication-by-d-etale}.
...
Lemma \ref{groupoids-lemma-abelian-variety-multiplication-by-p} gives
$A(k)[p] \cong (\mathbf{Z}/p\mathbf{Z})^{\oplus f}$ for some $0 \leq f \leq g$.
\end{proof}

\begin{remark}[16 equivalent]
\label{groupoids-remark-16-equivalent}
\source{stacks:0H2U}
\href{https://stacks.math.columbia.edu/tag/0H2U}{\texttt{Stacks tag 0H2U}}
\group{groupoids}

\uses{groupoids-definition-abelian-variety, groupoids-lemma-connected-group-scheme-over-field-irreducible, groupoids-lemma-group-scheme-field-geometrically-irreducible, groupoids-proposition-review-abelian-varieties}
Let $k$ be a field. There are $2 \times 4 \times 2 = 16$ equivalent
definitions of abelian varieties. Let
\begin{itemize}
\item projective, proper,
\item geometrically irreducible, irreducible, geometrically connected,
connected,
\item smooth, geometrically reduced
\end{itemize}
be three sets of properties, pick one from each of them, and let $A$
be a group scheme over $k$ with the chosen properties over $k$.
Then $A$ is an abelian variety.
If we pick the options ``proper, geometrically irreducible, geometrically
reduced'', then we recover Definition \ref{groupoids-definition-abelian-variety}
(use Varieties, Lemma \ref{varieties-lemma-geometrically-integral}).
The weakest possible options would be ``proper, connected,
and geometrically reduced'', see for example
Morphisms, Lemma \ref{morphisms-lemma-locally-projective-proper} and
Varieties, Lemma \ref{varieties-lemma-smooth-geometrically-normal}.
So say $A$ is a proper, connected,
and geometrically reduced group scheme over $k$.
Then $A$ is geometrically irreducible by
Lemmas \ref{groupoids-lemma-connected-group-scheme-over-field-irreducible} and
\ref{groupoids-lemma-group-scheme-field-geometrically-irreducible}
and hence an abelian variety.
Finally, if $A/k$ is an abelian variety, then it is projective
and smooth over $k$ (Proposition
\ref{groupoids-proposition-review-abelian-varieties}), whence satisfies
the strongest possible options "projective, geometrically irreducible, smooth".
\end{remark}
...
\begin{definition}[Action group scheme]
\label{groupoids-definition-action-group-scheme}
\source{stacks:022Z}
\href{https://stacks.math.columbia.edu/tag/022Z}{\texttt{Stacks tag 022Z}}
\group{groupoids}
...
\vcenter{
\begin{array}{cc}G \times_S G \times_S X \underset{1_G \times a}{\longrightarrow}\underset{m \times 1_X}{\downarrow} & G \times_S X \overset{a}{\downarrow} \\ G \times_S X \overset{a}{\longrightarrow} & X\end{array}
}
\quad\quad
\vcenter{
\begin{array}{cc}G \times_S X \underset{a}{\longrightarrow} & X \\ X\overset{e \times 1_X}{\uparrow}\underset{1_X}{\nearrow} & \end{array}
}
\end{equation}
are commutative. In situation (2) this just means that the diagram
$$
\begin{array}{cc}G \times_S X \underset{\text{id} \times \psi}{\longrightarrow}\underset{a}{\downarrow} & G \times_S Y \overset{a}{\downarrow} \\ X \overset{\psi}{\longrightarrow} & Y\end{array}
$$
commutes.
...
\source{stacks:07S1}
\href{https://stacks.math.columbia.edu/tag/07S1}{\texttt{Stacks tag 07S1}}
\group{groupoids}

\uses{groupoids-definition-action-group-scheme}
Let $S$, $G \to S$, and $X \to S$ as in
Definition \ref{groupoids-definition-action-group-scheme}.
...
\source{stacks:07S2}
\href{https://stacks.math.columbia.edu/tag/07S2}{\texttt{Stacks tag 07S2}}
\group{groupoids}

\uses{groupoids-definition-free-action}
Situation as in Definition \ref{groupoids-definition-free-action},
...
\begin{definition}[Pseudo torsor]
\label{groupoids-definition-pseudo-torsor}
\source{stacks:0498}
\href{https://stacks.math.columbia.edu/tag/0498}{\texttt{Stacks tag 0498}}
\group{groupoids}
...
\begin{lemma}[Characterize trivial pseudo torsors]
\label{groupoids-lemma-characterize-trivial-pseudo-torsors}
\source{stacks:0499}
\href{https://stacks.math.columbia.edu/tag/0499}{\texttt{Stacks tag 0499}}
\group{groupoids}

\uses{groupoids-definition-pseudo-torsor}
In the situation of
Definition \ref{groupoids-definition-pseudo-torsor}.
\begin{enumerate}
...
\source{stacks:049A}
\href{https://stacks.math.columbia.edu/tag/049A}{\texttt{Stacks tag 049A}}
\group{groupoids}
...
\source{stacks:049B}
\href{https://stacks.math.columbia.edu/tag/049B}{\texttt{Stacks tag 049B}}
\group{groupoids}
...
\begin{remark}[Fun with torsors]
\label{groupoids-remark-fun-with-torsors}
\source{stacks:049C}
\href{https://stacks.math.columbia.edu/tag/049C}{\texttt{Stacks tag 049C}}
\group{groupoids}
...
\begin{definition}[Equivariant module]
\label{groupoids-definition-equivariant-module}
\source{stacks:03LF}
\href{https://stacks.math.columbia.edu/tag/03LF}{\texttt{Stacks tag 03LF}}
\group{groupoids}
...
\item the diagram
$$
\begin{array}{cc}(1_G \times a)^*\text{pr}_1^*\mathcal{F} \underset{\text{pr}_{12}^*\alpha}{\longrightarrow} & \text{pr}_2^*\mathcal{F} \\ (1_G \times a)^*a^*\mathcal{F} \overset{(1_G \times a)^*\alpha}{\uparrow}\xlongequal{} & (m \times 1_X)^*a^*\mathcal{F} \underset{(m \times 1_X)^*\alpha}{\uparrow}\end{array}
$$
...
\begin{lemma}[Pullback equivariant]
\label{groupoids-lemma-pullback-equivariant}
\source{stacks:03LG}
\href{https://stacks.math.columbia.edu/tag/03LG}{\texttt{Stacks tag 03LG}}
\group{groupoids}
...
\begin{example}[Gm on affine]
\label{groupoids-example-Gm-on-affine}
\source{stacks:0EKJ}
\href{https://stacks.math.columbia.edu/tag/0EKJ}{\texttt{Stacks tag 0EKJ}}
\group{groupoids}

\uses{groupoids-example-multiplicative-group, groupoids-definition-equivariant-module}
...
$$
\begin{array}{cc}A \underset{\mu}{\longrightarrow}\underset{\mu}{\downarrow} & A \otimes \mathbf{Z}[x, x^{-1}] \overset{\mu \otimes 1}{\downarrow} \\ A \otimes \mathbf{Z}[x, x^{-1}] \overset{1 \otimes m}{\longrightarrow} & A \otimes \mathbf{Z}[x, x^{-1}] \otimes \mathbf{Z}[x, x^{-1}]\end{array}
$$
where $m(x) = x \otimes x$, see Example \ref{groupoids-example-multiplicative-group}.
...
Definition \ref{groupoids-definition-equivariant-module} corresponding to the
...
\begin{lemma}[Complete reducibility Gm]
\label{groupoids-lemma-complete-reducibility-Gm}
\source{stacks:0EKK}
\href{https://stacks.math.columbia.edu/tag/0EKK}{\texttt{Stacks tag 0EKK}}
\group{groupoids}

\uses{groupoids-example-Gm-on-affine}
Let $a : \mathbf{G}_m \times X \to X$ be an action on an affine scheme.
Then $X$ is the spectrum of a $\mathbf{Z}$-graded ring
and the action is as in Example \ref{groupoids-example-Gm-on-affine}.
\end{lemma}
...
$$
(compare with computation in Example \ref{groupoids-example-Gm-on-affine}).
Thus $(f_n)_m = 0$ if $n \not = m$ and $(f_n)_n = f_n$.
Thus if we set
$$
...
\begin{lemma}[Gm equivariant module]
\label{groupoids-lemma-Gm-equivariant-module}
\source{stacks:0EKL}
\href{https://stacks.math.columbia.edu/tag/0EKL}{\texttt{Stacks tag 0EKL}}
\group{groupoids}

\uses{groupoids-example-Gm-on-affine}
Let $A$ be a graded ring. Let $X = \Spec(A)$ with action
$a : \mathbf{G}_m \times X \to X$ as in Example \ref{groupoids-example-Gm-on-affine}.
...
is the one from Example \ref{groupoids-example-Gm-on-affine}.
\end{lemma}

\begin{proof}
\uses{groupoids-lemma-complete-reducibility-Gm}

You can either prove this by repeating the arguments of
Lemma \ref{groupoids-lemma-complete-reducibility-Gm} for the module $M$.
...
Lemma \ref{groupoids-lemma-complete-reducibility-Gm} to $X'$ and conclude.
...
\source{stacks:0231}
\href{https://stacks.math.columbia.edu/tag/0231}{\texttt{Stacks tag 0231}}
\group{groupoids}
...
\ref{groupoids-section-equivalence-relations} above.
We sometimes say ``let $(U, R, s, t, c, e, i)$ be a
groupoid over $S$'' to stress the existence of identity and
inverse.

\begin{lemma}[Groupoid pre equivalence]
\label{groupoids-lemma-groupoid-pre-equivalence}
\source{stacks:0232}
\href{https://stacks.math.columbia.edu/tag/0232}{\texttt{Stacks tag 0232}}
\group{groupoids}
...
\begin{lemma}[Equivalence groupoid]
\label{groupoids-lemma-equivalence-groupoid}
\source{stacks:0233}
\href{https://stacks.math.columbia.edu/tag/0233}{\texttt{Stacks tag 0233}}
\group{groupoids}
...
\source{stacks:02YE}
\href{https://stacks.math.columbia.edu/tag/02YE}{\texttt{Stacks tag 02YE}}
\group{groupoids}
...
$$
\begin{array}{ccc} & U &  \\ R \underset{s}{\downarrow}\overset{t}{\nearrow} & R \times_{s, U, t} R
\overset{\text{pr}_0}{\longleftarrow}\overset{\text{pr}_1}{\downarrow}\underset{c}{\longrightarrow} & R \overset{s}{\downarrow}\underset{t}{\nwarrow} \\ U & R \underset{t}{\longleftarrow}\overset{s}{\longrightarrow} & U\end{array}
$$
...
\begin{lemma}[Diagram pull]
\label{groupoids-lemma-diagram-pull}
\source{stacks:03C6}
\href{https://stacks.math.columbia.edu/tag/03C6}{\texttt{Stacks tag 03C6}}
\group{groupoids}
...
\begin{equation}
\label{equation-pull}
\begin{array}{ccc}R \times_{t, U, t} R
\overset{\text{pr}_1}{\longrightarrow}\underset{\text{pr}_0}{\longrightarrow}\underset{(\text{pr}_0, c \circ (i, 1))}{\downarrow} & R \overset{t}{\longrightarrow}\overset{\text{id}_R}{\downarrow} & U \overset{\text{id}_U}{\downarrow} \\ R \times_{s, U, t} R
\overset{c}{\longrightarrow}\underset{\text{pr}_0}{\longrightarrow}\underset{\text{pr}_1}{\downarrow} & R \overset{t}{\longrightarrow}\overset{s}{\downarrow} & U \\ R \overset{s}{\longrightarrow}\underset{t}{\longrightarrow} & U & \end{array}
\end{equation}
...
\begin{lemma}[Base change groupoid]
\label{groupoids-lemma-base-change-groupoid}
\source{stacks:0DT8}
\href{https://stacks.math.columbia.edu/tag/0DT8}{\texttt{Stacks tag 0DT8}}
\group{groupoids}
...
See the introduction of Section \ref{groupoids-section-equivariant} for our
choices in direction of arrows.

\begin{definition}[Groupoid module]
\label{groupoids-definition-groupoid-module}
\source{stacks:03LI}
\href{https://stacks.math.columbia.edu/tag/03LI}{\texttt{Stacks tag 03LI}}
\group{groupoids}
...
\item the diagram
$$
\begin{array}{cccc} & \text{pr}_1^*t^*\mathcal{F} \underset{\text{pr}_1^*\alpha}{\longrightarrow} & \text{pr}_1^*s^*\mathcal{F} \searrow &  \\ \text{pr}_0^*s^*\mathcal{F} \nearrow &  &  & c^*s^*\mathcal{F} \\  & \text{pr}_0^*t^*\mathcal{F} \overset{\text{pr}_0^*\alpha}{\nwarrow}\xlongequal{} & c^*t^*\mathcal{F} \underset{c^*\alpha}{\nearrow} & \end{array}
$$
...
is the identity map.
\end{enumerate}
Compare with the commutative diagrams of Lemma \ref{groupoids-lemma-diagram}.
\end{definition}
...
\source{stacks:077Q}
\href{https://stacks.math.columbia.edu/tag/077Q}{\texttt{Stacks tag 077Q}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-definition-groupoid-module}

Pull back the commutative diagram of
Definition \ref{groupoids-definition-groupoid-module}
...
\source{stacks:03LJ}
\href{https://stacks.math.columbia.edu/tag/03LJ}{\texttt{Stacks tag 03LJ}}
\group{groupoids}
...
\source{stacks:09VH}
\href{https://stacks.math.columbia.edu/tag/09VH}{\texttt{Stacks tag 09VH}}
\group{groupoids}

\uses{groupoids-lemma-pullback}
Let $S$ be a scheme. Consider a morphism
$f : (U, R, s, t, c) \to (U', R', s', t', c')$
...
\item the square
$$
\begin{array}{cc}R \underset{t}{\downarrow}\underset{f}{\longrightarrow} & R' \overset{t'}{\downarrow} \\ U \overset{f}{\longrightarrow} & U'\end{array}
$$
is cartesian, and
...
Lemma \ref{groupoids-lemma-pullback}.
\end{lemma}
...
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}R \underset{s}{\downarrow}\underset{f}{\longrightarrow} & R' \overset{s'}{\downarrow} \\ U \overset{f}{\longrightarrow} & U'\end{array}
}
$$
...
\source{stacks:077R}
\href{https://stacks.math.columbia.edu/tag/077R}{\texttt{Stacks tag 077R}}
\group{groupoids}
...
\source{stacks:077S}
\href{https://stacks.math.columbia.edu/tag/077S}{\texttt{Stacks tag 077S}}
\group{groupoids}
...
\begin{lemma}[Construct quasi coherent]
\label{groupoids-lemma-construct-quasi-coherent}
\source{stacks:07TR}
\href{https://stacks.math.columbia.edu/tag/07TR}{\texttt{Stacks tag 07TR}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-lemma-diagram, groupoids-definition-groupoid-module, groupoids-lemma-equivalence-groupoid, groupoids-lemma-diagram-pull, groupoids-lemma-pushforward}
...
is quasi-coherent. With notation as in Lemma \ref{groupoids-lemma-diagram} we have
$$
t^*s_*t^*\mathcal{G} =
...
\medskip\noindent
To verify the cocycle condition of Definition \ref{groupoids-definition-groupoid-module}
...
on $R$, see Lemma \ref{groupoids-lemma-equivalence-groupoid}.
There is a morphism
$$
f :
...
$$
\begin{array}{ccc}R \times_{t, U, t} R \underset{\text{pr}_0}{\downarrow}\underset{(r_0, r_1) \mapsto r_0^{-1} \circ r_1}{\longrightarrow} &  & R \overset{t}{\downarrow} \\ R \overset{s}{\longrightarrow} &  & U\end{array}
$$
by Lemma \ref{groupoids-lemma-diagram-pull} it follows that
Lemma \ref{groupoids-lemma-pushforward} applies to $f$.
...
take the actual cocycle relation in Definition \ref{groupoids-definition-groupoid-module}
...
Lemma \ref{groupoids-lemma-diagram-pull}. It follows that
...
\begin{remark}[Adjunction map]
\label{groupoids-remark-adjunction-map}
\source{stacks:0GNF}
\href{https://stacks.math.columbia.edu/tag/0GNF}{\texttt{Stacks tag 0GNF}}
\group{groupoids}

\uses{groupoids-lemma-construct-quasi-coherent}
In the situation of Lemma \ref{groupoids-lemma-construct-quasi-coherent} denote
$$
...
\begin{lemma}[Push pull]
\label{groupoids-lemma-push-pull}
\source{stacks:07TT}
\href{https://stacks.math.columbia.edu/tag/07TT}{\texttt{Stacks tag 07TT}}
\group{groupoids}
...
$$
\begin{array}{cc}\mathcal{F} \longrightarrow & f_*f^*\mathcal{F} \\ \mathcal{F} \cap f_*\mathcal{G} \uparrow\longrightarrow & f_*\mathcal{G} \uparrow\end{array}
$$
...
\begin{lemma}[Colimit coherent]
\label{groupoids-lemma-colimit-coherent}
\source{stacks:07TU}
\href{https://stacks.math.columbia.edu/tag/07TU}{\texttt{Stacks tag 07TU}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-lemma-construct-quasi-coherent, groupoids-remark-adjunction-map, groupoids-lemma-abelian, groupoids-lemma-push-pull}
...
Lemma \ref{groupoids-lemma-construct-quasi-coherent}. Consider the adjunction map
$(\mathcal{F}, \beta) \to (s_*t^*\mathcal{F}, \alpha)$ in
$\QCoh(U, R, s, t, c)$, see Remark \ref{groupoids-remark-adjunction-map}.
Set
$$
(\mathcal{F}_i, \beta_i) =
(\mathcal{F}, \beta)
...
on $\QCoh(U, R, s, t, c)$  by the proof of Lemma \ref{groupoids-lemma-abelian}
we obtain a pullback diagram
$$
\begin{array}{cc}\mathcal{F} \longrightarrow & s_*t^*\mathcal{F} \\ \mathcal{F}_i \longrightarrow\uparrow & s_*t^*\mathcal{H}_i \uparrow\end{array}
$$
in other words $\mathcal{F}_i = \mathcal{F} \cap s_*t^*\mathcal{H}_i$.
By the description of the adjunction map in Remark \ref{groupoids-remark-adjunction-map}
this diagram is isomorphic to the diagram
$$
\begin{array}{cc}\mathcal{F} \longrightarrow & s_*s^*\mathcal{F} \\ \mathcal{F}_i \longrightarrow\uparrow & s_*t^*\mathcal{H}_i \uparrow\end{array}
$$
...
$\mathcal{F}_i$ is coherent by Lemma \ref{groupoids-lemma-push-pull}.
...
\begin{lemma}[Colimit finite type]
\label{groupoids-lemma-colimit-finite-type}
\source{stacks:07TV}
\href{https://stacks.math.columbia.edu/tag/07TV}{\texttt{Stacks tag 07TV}}
\group{groupoids}
...
in Definition \ref{groupoids-definition-groupoid-module} means that
$$
...
\source{stacks:077T}
\href{https://stacks.math.columbia.edu/tag/077T}{\texttt{Stacks tag 077T}}
\group{groupoids}
...
\source{stacks:077U}
\href{https://stacks.math.columbia.edu/tag/077U}{\texttt{Stacks tag 077U}}
\group{groupoids}
...
\begin{lemma}[Groupoid from action]
\label{groupoids-lemma-groupoid-from-action}
\source{stacks:0234}
\href{https://stacks.math.columbia.edu/tag/0234}{\texttt{Stacks tag 0234}}
\group{groupoids}
...
\begin{lemma}[Action groupoid modules]
\label{groupoids-lemma-action-groupoid-modules}
\source{stacks:03LL}
\href{https://stacks.math.columbia.edu/tag/03LL}{\texttt{Stacks tag 03LL}}
\group{groupoids}

\uses{groupoids-lemma-groupoid-from-action}
Let $S$ be a scheme.
Let $Y$ be a scheme over $S$.
...
the groupoid scheme constructed in Lemma \ref{groupoids-lemma-groupoid-from-action}.
The rule
...
\begin{proof}
\uses{groupoids-definition-equivariant-module, groupoids-definition-groupoid-module, groupoids-lemma-groupoid-from-action}

The assertion makes sense because $t = a$ and $s = \text{pr}_1$
as morphisms $R = G \times_Y X \to X$, see
Definitions \ref{groupoids-definition-equivariant-module} and
\ref{groupoids-definition-groupoid-module}.
Using the translation in Lemma \ref{groupoids-lemma-groupoid-from-action}
...
\begin{lemma}[Groupoid stabilizer]
\label{groupoids-lemma-groupoid-stabilizer}
\source{stacks:0235}
\href{https://stacks.math.columbia.edu/tag/0235}{\texttt{Stacks tag 0235}}
\group{groupoids}
...
$$
\begin{array}{cc}G \longrightarrow\downarrow & R \overset{j = (t, s)}{\downarrow} \\ U \overset{\Delta}{\longrightarrow} & U \times_S U\end{array}
$$
...
\begin{definition}[Stabilizer groupoid]
\label{groupoids-definition-stabilizer-groupoid}
\source{stacks:0236}
\href{https://stacks.math.columbia.edu/tag/0236}{\texttt{Stacks tag 0236}}
\group{groupoids}
...
\begin{lemma}[Groupoid action stabilizer]
\label{groupoids-lemma-groupoid-action-stabilizer}
\source{stacks:0237}
\href{https://stacks.math.columbia.edu/tag/0237}{\texttt{Stacks tag 0237}}
\group{groupoids}
...
\begin{lemma}[Groupoid action stabilizer pseudo torsor]
\label{groupoids-lemma-groupoid-action-stabilizer-pseudo-torsor}
\source{stacks:04Q2}
\href{https://stacks.math.columbia.edu/tag/04Q2}{\texttt{Stacks tag 04Q2}}
\group{groupoids}

\uses{groupoids-lemma-groupoid-action-stabilizer}
...
Lemma \ref{groupoids-lemma-groupoid-action-stabilizer}
...
\begin{lemma}[Fibres j]
\label{groupoids-lemma-fibres-j}
\source{stacks:04Q3}
\href{https://stacks.math.columbia.edu/tag/04Q3}{\texttt{Stacks tag 04Q3}}
\group{groupoids}

\uses{groupoids-lemma-groupoid-action-stabilizer-pseudo-torsor}
Let $S$ be a scheme. Let $(U, R, s, t, c)$ be a groupoid scheme over $S$.
...
$$
(see
Lemma \ref{groupoids-lemma-groupoid-action-stabilizer-pseudo-torsor})
...
\begin{lemma}[Restrict groupoid]
\label{groupoids-lemma-restrict-groupoid}
\source{stacks:02VB}
\href{https://stacks.math.columbia.edu/tag/02VB}{\texttt{Stacks tag 02VB}}
\group{groupoids}
...
$$
\begin{array}{ccc}R' \downarrow\longrightarrow\underset{t'}{\downarrow}\overset{s'}{\longrightarrow} & R \times_{s, U} U' \longrightarrow\downarrow & U' \overset{g}{\downarrow} \\ U' \times_{U, t} R \downarrow\longrightarrow & R \overset{s}{\longrightarrow}\underset{t}{\downarrow} & U \\ U' \overset{g}{\longrightarrow} & U & \end{array}
$$
...
\begin{definition}[Restrict groupoid]
\label{groupoids-definition-restrict-groupoid}
\source{stacks:02VC}
\href{https://stacks.math.columbia.edu/tag/02VC}{\texttt{Stacks tag 02VC}}
\group{groupoids}

\uses{groupoids-lemma-restrict-groupoid}
Let $S$ be a scheme.
Let $(U, R, s, t, c)$ be a groupoid scheme over $S$.
Let $g : U' \to U$ be a morphism of schemes.
The morphism of groupoids
$(U', R', s', t', c') \to (U, R, s, t, c)$
constructed in Lemma \ref{groupoids-lemma-restrict-groupoid} is called
the {\it restriction of $(U, R, s, t, c)$ to $U'$}.
We sometime use the notation $R' = R|_{U'}$ in this case.
\end{definition}

\begin{lemma}[Restrict groupoid relation]
\label{groupoids-lemma-restrict-groupoid-relation}
\source{stacks:02VD}
\href{https://stacks.math.columbia.edu/tag/02VD}{\texttt{Stacks tag 02VD}}
\group{groupoids}

\uses{groupoids-definition-restrict-groupoid, groupoids-definition-restrict-relation, groupoids-lemma-groupoid-pre-equivalence, groupoids-lemma-equivalence-groupoid}
The notions of restricting groupoids and
(pre-)equivalence relations defined in Definitions
\ref{groupoids-definition-restrict-groupoid} and \ref{groupoids-definition-restrict-relation}
agree via the constructions of
Lemmas \ref{groupoids-lemma-groupoid-pre-equivalence} and
...
Lemma \ref{groupoids-lemma-restrict-groupoid} is also
equal to
$$
R' = (U' \times_S U')\times_{U \times_S U} R
\longrightarrow
...
\begin{lemma}[Restrict stabilizer]
\label{groupoids-lemma-restrict-stabilizer}
\source{stacks:04ML}
\href{https://stacks.math.columbia.edu/tag/04ML}{\texttt{Stacks tag 04ML}}
\group{groupoids}
...
\begin{definition}[Invariant open]
\label{groupoids-definition-invariant-open}
\source{stacks:03BC}
\href{https://stacks.math.columbia.edu/tag/03BC}{\texttt{Stacks tag 03BC}}
\group{groupoids}
...
\begin{lemma}[Constructing invariant opens]
\label{groupoids-lemma-constructing-invariant-opens}
\source{stacks:03LO}
\href{https://stacks.math.columbia.edu/tag/03LO}{\texttt{Stacks tag 03LO}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-lemma-pre-equivalence-equivalence-relation-points, groupoids-lemma-groupoid-pre-equivalence}

Part (1) follows from
Lemmas \ref{groupoids-lemma-pre-equivalence-equivalence-relation-points} and
\ref{groupoids-lemma-groupoid-pre-equivalence}, namely, $t(s^{-1}(W))$
...
\begin{lemma}[First observation]
\label{groupoids-lemma-first-observation}
\source{stacks:0APA}
\href{https://stacks.math.columbia.edu/tag/0APA}{\texttt{Stacks tag 0APA}}
\group{groupoids}
...
\begin{lemma}[Second observation]
\label{groupoids-lemma-second-observation}
\source{stacks:0APB}
\href{https://stacks.math.columbia.edu/tag/0APB}{\texttt{Stacks tag 0APB}}
\group{groupoids}

\uses{groupoids-lemma-first-observation}
Assumptions and notation as in Lemma \ref{groupoids-lemma-first-observation}.
There exists an $R$-invariant open $V \subset U$ and a quasi-compact
open $W'$ such that $W \subset V \subset W' \subset U$.
\end{lemma}

\begin{proof}
\uses{groupoids-lemma-constructing-invariant-opens, groupoids-lemma-first-observation}

Set $E = t(s^{-1}(W))$. Recall that $E$ is set-theoretically $R$-invariant
(Lemma \ref{groupoids-lemma-constructing-invariant-opens}).
By Lemma \ref{groupoids-lemma-first-observation} there exists a quasi-compact
...
\source{stacks:02VG}
\href{https://stacks.math.columbia.edu/tag/02VG}{\texttt{Stacks tag 02VG}}
\group{groupoids}
...
$G/S$ on $U$ as in Lemma \ref{groupoids-lemma-groupoid-from-action} then we
sometimes denote the quotient sheaf $U/G$.
\end{definition}

This means exactly that the diagram
$$
\begin{array}{ccc}h_R \longrightarrow\longrightarrow & h_U \longrightarrow & U/R\end{array}
$$
...
$$
\begin{array}{ccc}R \overset{s}{\longrightarrow}\underset{t}{\longrightarrow} & U \longrightarrow & U/R\end{array}
$$
We will mostly work with the fppf topology when considering
quotient sheaves of groupoids/equivalence relations.

\begin{definition}[Representable quotient]
\label{groupoids-definition-representable-quotient}
\source{stacks:03BD}
\href{https://stacks.math.columbia.edu/tag/03BD}{\texttt{Stacks tag 03BD}}
\group{groupoids}

\uses{groupoids-definition-quotient-sheaf}
...
\begin{lemma}[Criterion quotient representable]
\label{groupoids-lemma-criterion-quotient-representable}
\source{stacks:03C5}
\href{https://stacks.math.columbia.edu/tag/03C5}{\texttt{Stacks tag 03C5}}
\group{groupoids}
...
\begin{lemma}[Quotient pre equivalence]
\label{groupoids-lemma-quotient-pre-equivalence}
\source{stacks:045Y}
\href{https://stacks.math.columbia.edu/tag/045Y}{\texttt{Stacks tag 045Y}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-definition-equivalence-relation}
...
Definition \ref{groupoids-definition-equivalence-relation}.
\end{proof}

\begin{lemma}[Quotient pre equivalence relation restrict]
\label{groupoids-lemma-quotient-pre-equivalence-relation-restrict}
\source{stacks:045Z}
\href{https://stacks.math.columbia.edu/tag/045Z}{\texttt{Stacks tag 045Z}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-lemma-quotient-pre-equivalence}
...
Lemma \ref{groupoids-lemma-quotient-pre-equivalence}
...
\begin{lemma}[Quotient groupoid restrict]
\label{groupoids-lemma-quotient-groupoid-restrict}
\source{stacks:02VH}
\href{https://stacks.math.columbia.edu/tag/02VH}{\texttt{Stacks tag 02VH}}
\group{groupoids}
...
$$
\begin{array}{ccc}U' \times_{g, U, t} R \underset{\text{pr}_1}{\longrightarrow}\overset{h}{\longrightarrow} & R \underset{s}{\longrightarrow} & U\end{array}
$$
...
\begin{proof}
\uses{groupoids-lemma-groupoid-pre-equivalence, groupoids-lemma-quotient-pre-equivalence-relation-restrict}
...
\begin{lemma}[Criterion fibre product]
\label{groupoids-lemma-criterion-fibre-product}
\source{stacks:07S3}
\href{https://stacks.math.columbia.edu/tag/07S3}{\texttt{Stacks tag 07S3}}
\group{groupoids}
...
the diagram
$$
\begin{array}{cc}U \downarrow\longrightarrow & U/R \overset{f}{\downarrow} \\ U' \longrightarrow & U'/R'\end{array}
$$
is a fibre product square of $\tau$-sheaves.
\end{lemma}

\begin{proof}
\uses{groupoids-lemma-quotient-pre-equivalence, groupoids-lemma-equivalence-groupoid}

By Lemma \ref{groupoids-lemma-quotient-pre-equivalence} the quotient sheaves
...
scheme associated to $j'$, see Lemma \ref{groupoids-lemma-equivalence-groupoid}).
...
\source{stacks:0APD}
\href{https://stacks.math.columbia.edu/tag/0APD}{\texttt{Stacks tag 0APD}}
\group{groupoids}
...
if the diagram
$$
\begin{array}{cc}R' \underset{f}{\longrightarrow}\underset{s'}{\downarrow} & R \overset{s}{\downarrow} \\ U' \overset{f}{\longrightarrow} & U\end{array}
$$
...
\source{stacks:0APE}
\href{https://stacks.math.columbia.edu/tag/0APE}{\texttt{Stacks tag 0APE}}
\group{groupoids}
...
Lemma \ref{groupoids-lemma-equivalence-groupoid}.

\begin{lemma}[Cartesian equivalent descent datum]
\label{groupoids-lemma-cartesian-equivalent-descent-datum}
\source{stacks:0APF}
\href{https://stacks.math.columbia.edu/tag/0APF}{\texttt{Stacks tag 0APF}}
\group{groupoids}

\uses{groupoids-lemma-characterize-cartesian-schemes}
Let $S$ be a scheme. Let $f : X \to Y$ be a morphism of schemes over $S$.
The construction of Lemma \ref{groupoids-lemma-characterize-cartesian-schemes}
...
This is clear from
Lemma \ref{groupoids-lemma-characterize-cartesian-schemes}
...
\begin{lemma}[Diagram diagonal]
\label{groupoids-lemma-diagram-diagonal}
\source{stacks:02YH}
\href{https://stacks.math.columbia.edu/tag/02YH}{\texttt{Stacks tag 02YH}}
\group{groupoids}
...
$$
\begin{array}{ccccc}R \overset{\Delta_{R/U \times_S U}}{\downarrow}\underset{f \mapsto (f, s(f))}{\longrightarrow} &  &  & R \times_{s, U} U \downarrow\longrightarrow & U \downarrow \\ R \times_{(U \times_S U)} R \overset{(f, g) \mapsto (f, f^{-1} \circ g)}{\longrightarrow} &  &  & R \times_{s, U} G \longrightarrow & G\end{array}
$$
...
\source{stacks:02YI}
\href{https://stacks.math.columbia.edu/tag/02YI}{\texttt{Stacks tag 02YI}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-lemma-groupoid-stabilizer, groupoids-lemma-diagram-diagonal}

The group scheme $G \to U$ is the base change of $R \to U \times_S U$
by the diagonal morphism $U \to U \times_S U$, see
Lemma \ref{groupoids-lemma-groupoid-stabilizer}. Hence if
...
\medskip\noindent
By the result of
Lemma \ref{groupoids-lemma-diagram-diagonal}
...
that the diagram
$$
\begin{array}{cc}R \underset{s}{\longrightarrow}\underset{t}{\downarrow} & U \downarrow \\ U \longrightarrow & M\end{array}
$$
...
\begin{example}[Quotient projective line]
\label{groupoids-example-quotient-projective-line}
\source{stacks:03BG}
\href{https://stacks.math.columbia.edu/tag/03BG}{\texttt{Stacks tag 03BG}}
\group{groupoids}
...
fppf topology, see Definition \ref{groupoids-definition-quotient-sheaf}) is
...
\source{stacks:03BH}
\href{https://stacks.math.columbia.edu/tag/03BH}{\texttt{Stacks tag 03BH}}
\group{groupoids}
...
\begin{lemma}[Finite locally free disjoint free]
\label{groupoids-lemma-finite-locally-free-disjoint-free}
\source{stacks:03BI}
\href{https://stacks.math.columbia.edu/tag/03BI}{\texttt{Stacks tag 03BI}}
\group{groupoids}
...
\begin{lemma}[Integral over invariants]
\label{groupoids-lemma-integral-over-invariants}
\source{stacks:03BJ}
\href{https://stacks.math.columbia.edu/tag/03BJ}{\texttt{Stacks tag 03BJ}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-lemma-finite-locally-free-disjoint-free, groupoids-lemma-determinant-trick}
...
\begin{lemma}[Invariants base change]
\label{groupoids-lemma-invariants-base-change}
\source{stacks:03BK}
\href{https://stacks.math.columbia.edu/tag/03BK}{\texttt{Stacks tag 03BK}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-lemma-integral-over-invariants, groupoids-lemma-finite-locally-free-disjoint-free, groupoids-lemma-determinant-trick}
...
\source{stacks:03BL}
\href{https://stacks.math.columbia.edu/tag/03BL}{\texttt{Stacks tag 03BL}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-lemma-integral-over-invariants, groupoids-lemma-determinant-trick, groupoids-lemma-invariants-base-change}
...
$$
\begin{array}{ccc} &  & B \swarrow \\ k &  & A
\overset{a_0}{\longleftarrow}\underset{a_1}{\longleftarrow}\uparrow\uparrow \\  &  & C \uparrow\overset{c}{\nwarrow}\end{array}
$$
...
\source{stacks:0DT9}
\href{https://stacks.math.columbia.edu/tag/0DT9}{\texttt{Stacks tag 0DT9}}
\group{groupoids}
...
\quad
\quad
\begin{array}{cc}G' \downarrow\underset{f}{\longrightarrow} & G \downarrow \\ U' \overset{f}{\longrightarrow} & U\end{array}
$$
...
\begin{proof}
\uses{groupoids-lemma-integral-over-invariants, groupoids-lemma-invariants-base-change, groupoids-lemma-points}

Set $M = \Spec(C)$ and $M' = \Spec(C')$.
Write $U = \Spec(A)$, $U' = \Spec(A')$, $R = \Spec(B)$, and
$R' = \Spec(B')$. We will use the results of
Lemmas \ref{groupoids-lemma-integral-over-invariants},
\ref{groupoids-lemma-invariants-base-change}, and
...
From Lemma \ref{groupoids-lemma-invariants-base-change}
...
\source{stacks:03C8}
\href{https://stacks.math.columbia.edu/tag/03C8}{\texttt{Stacks tag 03C8}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-lemma-diagram-pull, groupoids-lemma-diagram}
...
commutative diagram
$$
\begin{array}{ccc}B \otimes_{s, A, t} B & B \underset{c}{\longleftarrow}\overset{p_0}{\longleftarrow} & A \overset{t}{\longleftarrow} \\ B \overset{p_1}{\uparrow} & A \underset{s}{\longleftarrow}\overset{t}{\longleftarrow}\underset{s}{\uparrow} & C \uparrow\longleftarrow\end{array}
$$
Moreover the tow left squares are cocartesian in the category of rings, and
the top row is isomorphic to the diagram
$$
\begin{array}{ccc}B \otimes_{t, A, t} B & B \underset{p_1}{\longleftarrow}\overset{p_0}{\longleftarrow} & A \overset{t}{\longleftarrow}\end{array}
$$
...
$$
\begin{array}{ccc}B \otimes_{s, A, t} B & B \underset{c}{\longleftarrow}\overset{p_0}{\longleftarrow} & A \overset{t}{\longleftarrow} \\ \bigoplus_{i \in I} B x_i \overset{p_1}{\uparrow} & \bigoplus_{i \in I} A x_i \underset{s}{\longleftarrow}\overset{t}{\longleftarrow}\underset{s}{\uparrow} & \bigoplus_{i \in I} C x_i \uparrow\longleftarrow\end{array}
$$
...
\begin{proposition}[Finite flat equivalence]
\label{groupoids-proposition-finite-flat-equivalence}
\source{stacks:03BM}
\href{https://stacks.math.columbia.edu/tag/03BM}{\texttt{Stacks tag 03BM}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-lemma-criterion-quotient-representable, groupoids-lemma-invariants-base-change, groupoids-lemma-points, groupoids-lemma-finite-locally-free-disjoint-free, groupoids-lemma-integral-over-invariants, groupoids-lemma-basis}
...
\begin{lemma}[Find invariant affine]
\label{groupoids-lemma-find-invariant-affine}
\source{stacks:03JE}
\href{https://stacks.math.columbia.edu/tag/03JE}{\texttt{Stacks tag 03JE}}
\group{groupoids}
...
$$
\begin{array}{cc}s^{-1}(W') \underset{s}{\downarrow}\underset{t}{\longrightarrow} & W \\ W' & \end{array}
$$
...
We can use Lemma \ref{groupoids-lemma-find-invariant-affine}
to show that a certain type of descent datum is effective.

\begin{lemma}[Descend along finite with bound]
\label{groupoids-lemma-descend-along-finite-with-bound}
\source{stacks:0H8K}
\href{https://stacks.math.columbia.edu/tag/0H8K}{\texttt{Stacks tag 0H8K}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-lemma-cartesian-equivalent-descent-datum, groupoids-lemma-find-invariant-affine}
...
By Lemma \ref{groupoids-lemma-cartesian-equivalent-descent-datum}
...
are finite locally free, and their geometric fibers have at most $d$
points. In particular the $R$-orbit $t(s^{-1}(\{v\}))$ of our point
$v \in V$ has at most $d$ points. Using the equivalence of categories of
Lemma \ref{groupoids-lemma-cartesian-equivalent-descent-datum}
...
Thus Lemma \ref{groupoids-lemma-find-invariant-affine}
provides an $R$-invariant affine open containing $v$.
\end{proof}

\begin{lemma}[Descend along finite]
\label{groupoids-lemma-descend-along-finite}
\source{stacks:0CCI}
\href{https://stacks.math.columbia.edu/tag/0CCI}{\texttt{Stacks tag 0CCI}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-lemma-descend-along-finite-with-bound}

As in the proof of Lemma \ref{groupoids-lemma-descend-along-finite-with-bound}, we
may assume that $Y$ is affine, in particular quasi-compact. Thus there
exists an integer $d$ such that all geometric fibers of $X \to Y$
have at most $d$ points, see the discussion in Morphisms, Section
\ref{morphisms-section-universally-bounded}.
Our assumption on $V$ trivially implies that we can apply
Lemma \ref{groupoids-lemma-descend-along-finite-with-bound}, which completes the proof.
\end{proof}

\begin{lemma}[Descend along finite quasi projective]
\label{groupoids-lemma-descend-along-finite-quasi-projective}
\source{stacks:0CCJ}
\href{https://stacks.math.columbia.edu/tag/0CCJ}{\texttt{Stacks tag 0CCJ}}
\group{groupoids}
...
\begin{proof}
\uses{groupoids-lemma-descend-along-finite}

We check the condition in Lemma \ref{groupoids-lemma-descend-along-finite}.
...
\begin{lemma}[Descend along finite radicial]
\label{groupoids-lemma-descend-along-finite-radicial}
\source{stacks:0H8L}
\href{https://stacks.math.columbia.edu/tag/0H8L}{\texttt{Stacks tag 0H8L}}
\group{groupoids}

Let $X \to Y$ be a surjective finite locally free morphism which is radicial.
Let $V$ be a scheme over $X$. Then any descent datum on $V/X/Y$ is effective.
\end{lemma}

\begin{proof}
\uses{groupoids-lemma-descend-along-finite-with-bound}

Apply Lemma \ref{groupoids-lemma-descend-along-finite-with-bound} with $d = 1$.
\end{proof}
