...
The part-local Lean package `StacksPart03Lib/` is a port of the corresponding Horizon
`FormalizedSources/StacksProject/Part03_TopicsInSchemeTheory` library. Lake metadata lives
