...
\newcommand{\limdir}[1]{{{\mathop{\rm lim}_{\buildrel\longrightarrow\over{#1}}}}\,}
\newcommand{\liminv}[1]{{{\mathop{\rm lim}_{\buildrel\longleftarrow\over{#1}}}}\,}
