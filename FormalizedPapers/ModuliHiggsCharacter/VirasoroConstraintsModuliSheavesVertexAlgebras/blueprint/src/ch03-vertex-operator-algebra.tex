...
\begin{definition}
[{\cite[(2.3.5)]{Ka98}}]\label{src-virasoro-constraints-moduli-sheaves-vertex-algebras-ch03-vertex-operator-algebra-statement-1}
\source{virasoro-constraints-moduli-sheaves-vertex-algebras}
\notready
...
\begin{theorem}
[{\cite[Corollary 4.5]{Ka98}}]\label{src-virasoro-constraints-moduli-sheaves-vertex-algebras-ch03-vertex-operator-algebra-statement-2}
\source{virasoro-constraints-moduli-sheaves-vertex-algebras}
\notready
...
\begin{remark}
\label{src-virasoro-constraints-moduli-sheaves-vertex-algebras-ch03-vertex-operator-algebra-statement-3}
\source{virasoro-constraints-moduli-sheaves-vertex-algebras}
\notready
...
\begin{definition}
\label{src-virasoro-constraints-moduli-sheaves-vertex-algebras-ch03-vertex-operator-algebra-statement-4}
\source{virasoro-constraints-moduli-sheaves-vertex-algebras}
\notready
