...
\begin{thm}
[{\cite{VinbergKimelfeld}, \cite[Theorem 25.1]{Timashev}}]\label{src-intersection-complexes-unramified-l-factors-ch02-spherical-varieties-and-their-arc-spaces-statement-1}
\source{intersection-complexes-unramified-l-factors}
\notready
