...
\begin{lemma}[Quasi coherence direct sums]
\label{perfect-lemma-quasi-coherence-direct-sums}
\source{stacks:08DT}
\href{https://stacks.math.columbia.edu/tag/08DT}{\texttt{Stacks tag 08DT}}
\group{perfect}
...
\begin{lemma}[Rlim quasi coherent]
\label{perfect-lemma-Rlim-quasi-coherent}
\source{stacks:0A0J}
\href{https://stacks.math.columbia.edu/tag/0A0J}{\texttt{Stacks tag 0A0J}}
\group{perfect}
...
\begin{lemma}[Nice K injective]
\label{perfect-lemma-nice-K-injective}
\source{stacks:08D3}
\href{https://stacks.math.columbia.edu/tag/08D3}{\texttt{Stacks tag 08D3}}
\group{perfect}
...
\begin{lemma}[Application nice K injective]
\label{perfect-lemma-application-nice-K-injective}
\source{stacks:08D4}
\href{https://stacks.math.columbia.edu/tag/08D4}{\texttt{Stacks tag 08D4}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-nice-K-injective}
...
$E = R\lim E_n$, see Lemma \ref{perfect-lemma-nice-K-injective}. Thus
...
\begin{lemma}[Affine compare bounded]
\label{perfect-lemma-affine-compare-bounded}
\source{stacks:06Z0}
\href{https://stacks.math.columbia.edu/tag/06Z0}{\texttt{Stacks tag 06Z0}}
\group{perfect}

Let $X = \Spec(A)$ be an affine scheme. All the functors in the diagram
$$
\begin{array}{ccc}D(\QCoh(\mathcal{O}_X)) \underset{(\ref{equation-compare})}{\longrightarrow} &  & D_\QCoh(\mathcal{O}_X) \overset{R\Gamma(X, -)}{\swarrow} \\  & D(A) \overset{\widetilde{\ \ }}{\nwarrow} & \end{array}
$$
...
\begin{proof}
\uses{perfect-lemma-application-nice-K-injective}
...
$$
\begin{array}{cc}D(A) \longrightarrow & D(\mathcal{O}_X) \longleftarrow\end{array}
$$
...
Lemma \ref{perfect-lemma-application-nice-K-injective}
...
\begin{lemma}[Affine K flat]
\label{perfect-lemma-affine-K-flat}
\source{stacks:08DV}
\href{https://stacks.math.columbia.edu/tag/08DV}{\texttt{Stacks tag 08DV}}
\group{perfect}
...
\begin{lemma}[Quasi coherence pushforward]
\label{perfect-lemma-quasi-coherence-pushforward}
\source{stacks:0DJK}
\href{https://stacks.math.columbia.edu/tag/0DJK}{\texttt{Stacks tag 0DJK}}
\group{perfect}

If $f : X \to Y$ is a morphism of affine schemes given by the ring map
$A \to B$, then the diagram
$$
\begin{array}{cc}D(B) \downarrow\longrightarrow & D_\QCoh(\mathcal{O}_X) \overset{Rf_*}{\downarrow} \\ D(A) \longrightarrow & D_\QCoh(\mathcal{O}_Y)\end{array}
$$
commutes.
\end{lemma}

\begin{proof}
\uses{perfect-lemma-affine-compare-bounded}

Follows from Lemma \ref{perfect-lemma-affine-compare-bounded}
using that $R\Gamma(Y, Rf_*K) = R\Gamma(X, K)$ by
Cohomology, Lemma \ref{cohomology-lemma-Leray-unbounded}.
\end{proof}

\begin{lemma}[Quasi coherence pullback]
\label{perfect-lemma-quasi-coherence-pullback}
\source{stacks:08DW}
\href{https://stacks.math.columbia.edu/tag/08DW}{\texttt{Stacks tag 08DW}}
\group{perfect}
...
$A \to B$, then the diagram
$$
\begin{array}{cc}D(B) \longrightarrow & D_\QCoh(\mathcal{O}_Y) \\ D(A) \longrightarrow\overset{- \otimes_A^\mathbf{L} B}{\uparrow} & D_\QCoh(\mathcal{O}_X) \underset{Lf^*}{\uparrow}\end{array}
$$
commutes.
\end{enumerate}
\end{lemma}
...
\begin{proof}
\uses{perfect-lemma-affine-K-flat, perfect-lemma-affine-compare-bounded}

We first prove the diagram
$$
\begin{array}{cc}D(B) \longrightarrow & D(\mathcal{O}_Y) \\ D(A) \longrightarrow\overset{- \otimes_A^\mathbf{L} B}{\uparrow} & D(\mathcal{O}_X) \underset{Lf^*}{\uparrow}\end{array}
$$
commutes. This is clear from Lemma \ref{perfect-lemma-affine-K-flat} and
...
Then we can apply Lemma \ref{perfect-lemma-affine-compare-bounded} to see that
...
\begin{lemma}[Quasi coherence tensor product]
\label{perfect-lemma-quasi-coherence-tensor-product}
\source{stacks:08DX}
\href{https://stacks.math.columbia.edu/tag/08DX}{\texttt{Stacks tag 08DX}}
\group{perfect}
...
The equality of (2) follows immediately from Lemma \ref{perfect-lemma-affine-K-flat}
...
Lemma \ref{perfect-lemma-affine-compare-bounded} we may represent
...
\begin{lemma}[Quasi coherence direct image]
\label{perfect-lemma-quasi-coherence-direct-image}
\source{stacks:08D5}
\href{https://stacks.math.columbia.edu/tag/08D5}{\texttt{Stacks tag 08D5}}
\group{perfect}
...
Hence we may apply Lemma \ref{perfect-lemma-application-nice-K-injective}
...
\source{stacks:0G9N}
\href{https://stacks.math.columbia.edu/tag/0G9N}{\texttt{Stacks tag 0G9N}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-quasi-coherence-direct-image}
...
Lemma \ref{perfect-lemma-quasi-coherence-direct-image}
...
\begin{lemma}[Acyclicity lemma global]
\label{perfect-lemma-acyclicity-lemma-global}
\source{stacks:0G9P}
\href{https://stacks.math.columbia.edu/tag/0G9P}{\texttt{Stacks tag 0G9P}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-acyclicity-lemma}

Apply Lemma \ref{perfect-lemma-acyclicity-lemma} to the canonical morphism
$X \to \Spec(\Gamma(X, \mathcal{O}_X))$. Some details omitted.
\end{proof}

\begin{lemma}[Spectral sequence]
\label{perfect-lemma-spectral-sequence}
\source{stacks:0G9Q}
\href{https://stacks.math.columbia.edu/tag/0G9Q}{\texttt{Stacks tag 0G9Q}}
\group{perfect}
...
$$
The first follows from Lemma \ref{perfect-lemma-application-nice-K-injective}
...
\begin{lemma}[Quasi coherence pushforward direct sums]
\label{perfect-lemma-quasi-coherence-pushforward-direct-sums}
\source{stacks:08DZ}
\href{https://stacks.math.columbia.edu/tag/08DZ}{\texttt{Stacks tag 08DZ}}
\group{perfect}
...
Choose an integer $N$ as in Lemma \ref{perfect-lemma-quasi-coherence-direct-image}.
...
\begin{lemma}[Pushforward affine morphism]
\label{perfect-lemma-pushforward-affine-morphism}
\source{stacks:0G9R}
\href{https://stacks.math.columbia.edu/tag/0G9R}{\texttt{Stacks tag 0G9R}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-acyclicity-lemma, perfect-lemma-quasi-coherence-pushforward}

Combine Lemma \ref{perfect-lemma-acyclicity-lemma} with
Cohomology of Schemes, Lemma \ref{coherent-lemma-relative-affine-vanishing}.
An alternative proof is to work affine locally on $S$
and use Lemma \ref{perfect-lemma-quasi-coherence-pushforward}.
\end{proof}

\begin{lemma}[Affine morphism]
\label{perfect-lemma-affine-morphism}
\source{stacks:08I8}
\href{https://stacks.math.columbia.edu/tag/08I8}{\texttt{Stacks tag 08I8}}
\group{perfect}
...
\begin{lemma}[Affine morphism pull push]
\label{perfect-lemma-affine-morphism-pull-push}
\source{stacks:08I9}
\href{https://stacks.math.columbia.edu/tag/08I9}{\texttt{Stacks tag 08I9}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-affine-compare-bounded, perfect-lemma-quasi-coherence-pullback}
...
\begin{lemma}[Affine morphism equivalence]
\label{perfect-lemma-affine-morphism-equivalence}
\source{stacks:0AVW}
\href{https://stacks.math.columbia.edu/tag/0AVW}{\texttt{Stacks tag 0AVW}}
\group{perfect}
...
(Cohomology of Schemes, Lemma \ref{coherent-lemma-relative-affine-vanishing})
and Lemma \ref{perfect-lemma-application-nice-K-injective} (small detail omitted).
...
\source{stacks:08DA}
\href{https://stacks.math.columbia.edu/tag/08DA}{\texttt{Stacks tag 08DA}}
\group{perfect}
...
Thus we may apply the discussion in
Derived Categories, Section \ref{derived-section-triangulated-sub}
and we obtain a strictly full, saturated triangulated subcategory of
$D(\mathcal{O}_X)$ consisting of objects supported on $T$; we will
denote this category $D_T(\mathcal{O}_X)$ in the following.

\medskip\noindent
In the situation of Definition \ref{perfect-definition-supported-on}
...
\begin{lemma}[Support quasi coherent]
\label{perfect-lemma-support-quasi-coherent}
\source{stacks:0G7G}
\href{https://stacks.math.columbia.edu/tag/0G7G}{\texttt{Stacks tag 0G7G}}
\group{perfect}
...
$$
in $D(\mathcal{O}_X)$. By Lemma \ref{perfect-lemma-quasi-coherence-direct-image}
...
\begin{lemma}[Support direct sums]
\label{perfect-lemma-support-direct-sums}
\source{stacks:0G7H}
\href{https://stacks.math.columbia.edu/tag/0G7H}{\texttt{Stacks tag 0G7H}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-quasi-coherence-pushforward-direct-sums}
...
by Lemma \ref{perfect-lemma-quasi-coherence-pushforward-direct-sums}.
...
\begin{remark}[Support c equations]
\label{perfect-remark-support-c-equations}
\source{stacks:0G7I}
\href{https://stacks.math.columbia.edu/tag/0G7I}{\texttt{Stacks tag 0G7I}}
\group{perfect}
...
\begin{lemma}[Extended alternating zero]
\label{perfect-lemma-extended-alternating-zero}
\source{stacks:0G7K}
\href{https://stacks.math.columbia.edu/tag/0G7K}{\texttt{Stacks tag 0G7K}}
\group{perfect}

\uses{perfect-remark-support-c-equations}
With $X$, $f_1, \ldots, f_c \in \Gamma(X, \mathcal{O}_X)$, and
$\mathcal{F}$ as in Remark \ref{perfect-remark-support-c-equations}
...
Remark \ref{perfect-remark-support-c-equations} starting with a finite
...
\begin{remark}[Extended alternating map to support]
\label{perfect-remark-extended-alternating-map-to-support}
\source{stacks:0G7L}
\href{https://stacks.math.columbia.edu/tag/0G7L}{\texttt{Stacks tag 0G7L}}
\group{perfect}

\uses{perfect-remark-support-c-equations, perfect-lemma-extended-alternating-zero}
Let $X$, $f_1, \ldots, f_c \in \Gamma(X, \mathcal{O}_X)$, and
$\mathcal{F}$ be as in Remark \ref{perfect-remark-support-c-equations}.
Denote $\mathcal{F}^\bullet$ the complex
(\ref{equation-extended-alternating}). By
Lemma \ref{perfect-lemma-extended-alternating-zero}
...
$$
\begin{array}{ccc}\mathcal{F}^\bullet \searrow\longrightarrow &  & \mathcal{F} \\  & i_*R\mathcal{H}_Z(\mathcal{F}) \nearrow & \end{array}
$$
in $D(\mathcal{O}_X)$ functorial in the $\mathcal{O}_X$-module $\mathcal{F}$.
\end{remark}

\begin{lemma}[Extended alternating represented]
\label{perfect-lemma-extended-alternating-represented}
\source{stacks:0G7M}
\href{https://stacks.math.columbia.edu/tag/0G7M}{\texttt{Stacks tag 0G7M}}
\group{perfect}
...
\begin{proof}
\uses{perfect-remark-extended-alternating-map-to-support}
...
of Remark \ref{perfect-remark-extended-alternating-map-to-support}
...
\begin{lemma}[Supported trivial vanishing]
\label{perfect-lemma-supported-trivial-vanishing}
\source{stacks:0G7N}
\href{https://stacks.math.columbia.edu/tag/0G7N}{\texttt{Stacks tag 0G7N}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-extended-alternating-represented}

This follows immediately from the local description of
$R\mathcal{H}_T(\mathcal{F})$ given in
Lemma \ref{perfect-lemma-extended-alternating-represented}.
\end{proof}

\begin{lemma}[Supported vanishing]
\label{perfect-lemma-supported-vanishing}
\source{stacks:0G7P}
\href{https://stacks.math.columbia.edu/tag/0G7P}{\texttt{Stacks tag 0G7P}}
\group{perfect}

Let $X$ be a scheme. Let $Z \subset X$ be a closed subset which can
...
Lemma \ref{perfect-lemma-extended-alternating-represented} this boils
...
\begin{remark}[Supported map c equations]
\label{perfect-remark-supported-map-c-equations}
\source{stacks:0G7Q}
\href{https://stacks.math.columbia.edu/tag/0G7Q}{\texttt{Stacks tag 0G7Q}}
\group{perfect}

\uses{perfect-remark-support-c-equations, perfect-remark-extended-alternating-map-to-support}
With $X$, $f_1, \ldots, f_c \in \Gamma(X, \mathcal{O}_X)$, and
$\mathcal{F}$ as in Remark \ref{perfect-remark-support-c-equations}.
...
\begin{example}[Affine supported map c equations]
\label{perfect-example-affine-supported-map-c-equations}
\source{stacks:0G7R}
\href{https://stacks.math.columbia.edu/tag/0G7R}{\texttt{Stacks tag 0G7R}}
\group{perfect}

\uses{perfect-remark-supported-map-c-equations}
Let $X = \Spec(A)$ be affine, $f_1, \ldots, f_c \in A$, and let
$\mathcal{F} = \widetilde{M}$ for some $A$-module $M$. The map
$c_{f_1, \ldots, f_c}$ of Remark \ref{perfect-remark-supported-map-c-equations}
...
\begin{lemma}[Supported map determinant]
\label{perfect-lemma-supported-map-determinant}
\source{stacks:0G7S}
\href{https://stacks.math.columbia.edu/tag/0G7S}{\texttt{Stacks tag 0G7S}}
\group{perfect}

\uses{perfect-remark-support-c-equations, perfect-remark-supported-map-c-equations}
With $X$, $f_1, \ldots, f_c \in \Gamma(X, \mathcal{O}_X)$, and
$\mathcal{F}$ as in Remark \ref{perfect-remark-support-c-equations}.
...
Remark \ref{perfect-remark-supported-map-c-equations}.
\end{lemma}
...
\begin{lemma}[Supported map global]
\label{perfect-lemma-supported-map-global}
\source{stacks:0G7T}
\href{https://stacks.math.columbia.edu/tag/0G7T}{\texttt{Stacks tag 0G7T}}
\group{perfect}
...
\begin{proof}
\uses{perfect-remark-supported-map-c-equations, perfect-lemma-supported-map-determinant}

Follows from the construction in
Remark \ref{perfect-remark-supported-map-c-equations}
and the independence of the choice
of generators of the ideal sheaf shown in
Lemma \ref{perfect-lemma-supported-map-determinant}.
Some details omitted.
\end{proof}

\begin{remark}[Supported functorial]
\label{perfect-remark-supported-functorial}
\source{stacks:0G7U}
\href{https://stacks.math.columbia.edu/tag/0G7U}{\texttt{Stacks tag 0G7U}}
\group{perfect}

\uses{perfect-remark-support-c-equations, perfect-remark-extended-alternating-map-to-support, perfect-remark-supported-map-c-equations}
...
$$
\begin{array}{cc}(i')^{-1}\mathcal{O}_{X'} \otimes_{h^{-1}i^{-1}\mathcal{O}_X}
h^{-1}\mathcal{H}^c_Z(\mathcal{F}) \longrightarrow & \mathcal{H}_{Z'}^c(\mathcal{F}') \\ h^*i^*\mathcal{F} \longrightarrow\underset{c_{f_1, \ldots, f_c}}{\uparrow} & (i')^*\mathcal{F}' \overset{c_{f'_1, \ldots, f'_c}}{\uparrow}\end{array}
$$
...
Remark \ref{perfect-remark-support-c-equations}
...
$$
\begin{array}{cc}i'_* L(g|_{Z'})^* R\mathcal{H}_Z(\mathcal{F}) \longrightarrow\downarrow & i'_*R\mathcal{H}_{Z'}(Lg^*\mathcal{F}) \downarrow \\ Lg^*i_*R\mathcal{H}_Z(\mathcal{F}) & i'_*R\mathcal{H}_{Z'}(\mathcal{F}') \\ Lg^*(\mathcal{F}^\bullet) \uparrow\longrightarrow & (\mathcal{F}')^\bullet \uparrow\end{array}
$$
...
Remark \ref{perfect-remark-extended-alternating-map-to-support}.
...
used in Remark \ref{perfect-remark-supported-map-c-equations}
...
\begin{lemma}[Affine pushforward]
\label{perfect-lemma-affine-pushforward}
\source{stacks:08D7}
\href{https://stacks.math.columbia.edu/tag/08D7}{\texttt{Stacks tag 08D7}}
\group{perfect}
...
$$
\begin{array}{cc}D(\QCoh(\mathcal{O}_X)) \underset{f_*}{\downarrow}\longrightarrow & D_\QCoh(\mathcal{O}_X) \overset{Rf_*}{\downarrow} \\ D(\QCoh(\mathcal{O}_Y)) \longrightarrow & D_\QCoh(\mathcal{O}_Y)\end{array}
$$
commutes.
\end{lemma}

\begin{proof}
\uses{perfect-lemma-pushforward-affine-morphism}
...
The diagram commutes by Lemma \ref{perfect-lemma-pushforward-affine-morphism}.
\end{proof}

\begin{lemma}[Flat pushforward coherator]
\label{perfect-lemma-flat-pushforward-coherator}
\source{stacks:08D8}
\href{https://stacks.math.columbia.edu/tag/08D8}{\texttt{Stacks tag 08D8}}
\group{perfect}
...
\begin{lemma}[Affine coherator]
\label{perfect-lemma-affine-coherator}
\source{stacks:08D9}
\href{https://stacks.math.columbia.edu/tag/08D9}{\texttt{Stacks tag 08D9}}
\group{perfect}
...
\begin{lemma}[Argument proves]
\label{perfect-lemma-argument-proves}
\source{stacks:09T6}
\href{https://stacks.math.columbia.edu/tag/09T6}{\texttt{Stacks tag 09T6}}
\group{perfect}
...
$$
\begin{array}{cc}D(\QCoh(\mathcal{O}_U)) \underset{\Phi}{\downarrow}\underset{i_U}{\longrightarrow} & D_\QCoh(\mathcal{O}_U) \overset{Rj_*}{\downarrow} \\ D(\QCoh(\mathcal{O}_X)) \overset{i_X}{\longrightarrow} & D_\QCoh(\mathcal{O}_X)\end{array}
$$
...
\begin{proof}
\uses{perfect-definition-supported-on, perfect-lemma-flat-pushforward-coherator, perfect-lemma-affine-coherator}
...
Lemma \ref{perfect-lemma-flat-pushforward-coherator}
...
$$
are isomorphisms by Lemma \ref{perfect-lemma-affine-coherator}. The result follows.
\end{proof}

\begin{proposition}[Quasi compact affine diagonal]
\label{perfect-proposition-quasi-compact-affine-diagonal}
\source{stacks:08DB}
\href{https://stacks.math.columbia.edu/tag/08DB}{\texttt{Stacks tag 08DB}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-argument-proves, perfect-lemma-affine-pushforward}

Let $U \subset X$ be an affine open. Then the morphism
$U \to X$ is affine by
Morphisms, Lemma \ref{morphisms-lemma-affine-permanence}.
Thus the assumption of Lemma \ref{perfect-lemma-argument-proves}
holds by Lemma \ref{perfect-lemma-affine-pushforward} and we win.
\end{proof}

\begin{lemma}[Direct image coherator]
\label{perfect-lemma-direct-image-coherator}
\source{stacks:0CRX}
\href{https://stacks.math.columbia.edu/tag/0CRX}{\texttt{Stacks tag 0CRX}}
\group{perfect}
...
the diagram
$$
\begin{array}{cc}D(\QCoh(\mathcal{O}_X)) \underset{\Phi}{\downarrow}\longrightarrow & D_\QCoh(\mathcal{O}_X) \overset{Rf_*}{\downarrow} \\ D(\QCoh(\mathcal{O}_Y)) \longrightarrow & D_\QCoh(\mathcal{O}_Y)\end{array}
$$
is commutative.
\end{lemma}

\begin{proof}
\uses{perfect-proposition-quasi-compact-affine-diagonal, perfect-lemma-affine-pushforward}
...
g_*\mathcal{I}^\bullet
$$
By Lemma \ref{perfect-lemma-affine-pushforward} we see that
...
\source{stacks:0CRY}
\href{https://stacks.math.columbia.edu/tag/0CRY}{\texttt{Stacks tag 0CRY}}
\group{perfect}

\uses{perfect-proposition-quasi-compact-affine-diagonal}
...
\begin{lemma}[Injective quasi coherent sheaf Noetherian]
\label{perfect-lemma-injective-quasi-coherent-sheaf-Noetherian}
\source{stacks:09T2}
\href{https://stacks.math.columbia.edu/tag/09T2}{\texttt{Stacks tag 09T2}}
\group{perfect}
...
\begin{lemma}[Noetherian pushforward]
\label{perfect-lemma-Noetherian-pushforward}
\source{stacks:09T3}
\href{https://stacks.math.columbia.edu/tag/09T3}{\texttt{Stacks tag 09T3}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-acyclicity-lemma, perfect-lemma-injective-quasi-coherent-sheaf-Noetherian}
...
Lemma \ref{perfect-lemma-acyclicity-lemma}
...
Lemma \ref{perfect-lemma-injective-quasi-coherent-sheaf-Noetherian}
and flasque modules are right $f_*$-acyclic by
Cohomology, Lemma \ref{cohomology-lemma-flasque-acyclic-pushforward}.
\end{proof}

\begin{proposition}[Noetherian]
\label{perfect-proposition-Noetherian}
\source{stacks:09T4}
\href{https://stacks.math.columbia.edu/tag/09T4}{\texttt{Stacks tag 09T4}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-argument-proves, perfect-lemma-Noetherian-pushforward}

This follows from Lemma \ref{perfect-lemma-argument-proves} and
Lemma \ref{perfect-lemma-Noetherian-pushforward}.
\end{proof}
...
\begin{definition}[Situation: Complex]
\label{perfect-situation-complex}
\source{stacks:08CZ}
\href{https://stacks.math.columbia.edu/tag/08CZ}{\texttt{Stacks tag 08CZ}}
\group{perfect}
...
\begin{lemma}[Alternating cech complex]
\label{perfect-lemma-alternating-cech-complex}
\source{stacks:08D0}
\href{https://stacks.math.columbia.edu/tag/08D0}{\texttt{Stacks tag 08D0}}
\group{perfect}

\uses{perfect-situation-complex}
In Situation \ref{perfect-situation-complex}. Let $M$ be an $A$-module and
...
\source{stacks:08D1}
\href{https://stacks.math.columbia.edu/tag/08D1}{\texttt{Stacks tag 08D1}}
\group{perfect}

\uses{perfect-situation-complex}
In Situation \ref{perfect-situation-complex}. Let $M^\bullet$ be a
...
\begin{proof}
\uses{perfect-lemma-alternating-cech-complex}
...
constructed in the proof of Lemma \ref{perfect-lemma-alternating-cech-complex}
...
\begin{lemma}[Alternating cech complex complex computes cohomology]
\label{perfect-lemma-alternating-cech-complex-complex-computes-cohomology}
\source{stacks:08D2}
\href{https://stacks.math.columbia.edu/tag/08D2}{\texttt{Stacks tag 08D2}}
\group{perfect}

\uses{perfect-situation-complex}
In Situation \ref{perfect-situation-complex}. Let $\mathcal{F}^\bullet$
be a complex of quasi-coherent $\mathcal{O}_X$-modules. Then
...
In Situation \ref{perfect-situation-complex} denote $I_e$ the object of
$D(\mathcal{O}_X)$ corresponding to the complex of $A$-modules
$I^\bullet(f_1^e, \ldots, f_r^e)$ via the equivalence of
Lemma \ref{perfect-lemma-affine-compare-bounded}. The maps
...
\begin{proposition}[Represent cohomology class on open]
\label{perfect-proposition-represent-cohomology-class-on-open}
\source{stacks:08DD}
\href{https://stacks.math.columbia.edu/tag/08DD}{\texttt{Stacks tag 08DD}}
\group{perfect}

\uses{perfect-situation-complex}
In Situation \ref{perfect-situation-complex}. For every object $E$
of $D_\QCoh(\mathcal{O}_X)$ the map
(\ref{equation-comparison}) is an isomorphism.
\end{proposition}

\begin{proof}
\uses{perfect-lemma-affine-compare-bounded, perfect-lemma-alternating-cech-complex-complex, perfect-lemma-alternating-cech-complex-complex-computes-cohomology}

By Lemma \ref{perfect-lemma-affine-compare-bounded} we may assume that $E$
...
Lemmas \ref{perfect-lemma-alternating-cech-complex-complex} and
...
Lemma \ref{perfect-lemma-affine-compare-bounded} the lemma follows.
\end{proof}

In Situation \ref{perfect-situation-complex} denote $K_e$ the object of
$D(\mathcal{O}_X)$ corresponding to the complex of $A$-modules
$K^\bullet(f_1^e, \ldots, f_r^e)$ via the equivalence of
Lemma \ref{perfect-lemma-affine-compare-bounded}. Thus we have distinguished
triangles
$$
...
\begin{lemma}[Represent cohomology class on closed]
\label{perfect-lemma-represent-cohomology-class-on-closed}
\source{stacks:08E3}
\href{https://stacks.math.columbia.edu/tag/08E3}{\texttt{Stacks tag 08E3}}
\group{perfect}

\uses{perfect-situation-complex}
In Situation \ref{perfect-situation-complex}. Let $E$ be an object of
$D_\QCoh(\mathcal{O}_X)$.
...
\begin{proof}
\uses{perfect-lemma-application-nice-K-injective, perfect-proposition-represent-cohomology-class-on-open}
...
By Lemma \ref{perfect-lemma-application-nice-K-injective} we see that $H^0(U, E)$
...
By Proposition \ref{perfect-proposition-represent-cohomology-class-on-open}
...
\begin{lemma}[Pseudo coherent]
\label{perfect-lemma-pseudo-coherent}
\source{stacks:08E5}
\href{https://stacks.math.columbia.edu/tag/08E5}{\texttt{Stacks tag 08E5}}
\group{perfect}
...
\begin{lemma}[Pseudo coherent affine]
\label{perfect-lemma-pseudo-coherent-affine}
\source{stacks:08E7}
\href{https://stacks.math.columbia.edu/tag/08E7}{\texttt{Stacks tag 08E7}}
\group{perfect}
...
\begin{lemma}[Identify pseudo coherent noetherian]
\label{perfect-lemma-identify-pseudo-coherent-noetherian}
\source{stacks:08E8}
\href{https://stacks.math.columbia.edu/tag/08E8}{\texttt{Stacks tag 08E8}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-affine-compare-bounded, perfect-lemma-pseudo-coherent-affine}
...
by Lemma \ref{perfect-lemma-affine-compare-bounded}. By
Lemma \ref{perfect-lemma-pseudo-coherent-affine}
...
\begin{lemma}[Tor dimension affine]
\label{perfect-lemma-tor-dimension-affine}
\source{stacks:08E9}
\href{https://stacks.math.columbia.edu/tag/08E9}{\texttt{Stacks tag 08E9}}
\group{perfect}
...
\begin{lemma}[Tor dimension rel affine]
\label{perfect-lemma-tor-dimension-rel-affine}
\source{stacks:0DHY}
\href{https://stacks.math.columbia.edu/tag/0DHY}{\texttt{Stacks tag 0DHY}}
\group{perfect}
...
\begin{lemma}[Tor qc qs]
\label{perfect-lemma-tor-qc-qs}
\source{stacks:08EA}
\href{https://stacks.math.columbia.edu/tag/08EA}{\texttt{Stacks tag 08EA}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-affine-compare-bounded, perfect-lemma-tor-dimension-affine}
...
By Lemma \ref{perfect-lemma-tor-dimension-affine}
we conclude that $E|_U$ has tor amplitude in $[a, b]$.
This proves the lemma.
\end{proof}

\begin{lemma}[Perfect affine]
\label{perfect-lemma-perfect-affine}
\source{stacks:08EB}
\href{https://stacks.math.columbia.edu/tag/08EB}{\texttt{Stacks tag 08EB}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-pseudo-coherent-affine, perfect-lemma-tor-dimension-affine}

This is a logical consequence of
Lemmas \ref{perfect-lemma-pseudo-coherent-affine} and
...
\begin{lemma}[Quasi coherence internal hom]
\label{perfect-lemma-quasi-coherence-internal-hom}
\source{stacks:0A6H}
\href{https://stacks.math.columbia.edu/tag/0A6H}{\texttt{Stacks tag 0A6H}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-affine-compare-bounded, perfect-lemma-pseudo-coherent-affine, perfect-lemma-perfect-affine}
...
By Lemmas \ref{perfect-lemma-affine-compare-bounded},
\ref{perfect-lemma-pseudo-coherent-affine}, and
...
\begin{lemma}[Internal hom evaluate tensor isomorphism]
\label{perfect-lemma-internal-hom-evaluate-tensor-isomorphism}
\source{stacks:0ATN}
\href{https://stacks.math.columbia.edu/tag/0ATN}{\texttt{Stacks tag 0ATN}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-quasi-coherence-internal-hom, perfect-lemma-pseudo-coherent-affine, perfect-lemma-perfect-affine, perfect-lemma-tor-dimension-affine}
...
(You also have to use Lemmas \ref{perfect-lemma-pseudo-coherent-affine},
\ref{perfect-lemma-perfect-affine}, and \ref{perfect-lemma-tor-dimension-affine}
...
\begin{lemma}[Coh to qcoh]
\label{perfect-lemma-coh-to-qcoh}
\source{stacks:0FDA}
\href{https://stacks.math.columbia.edu/tag/0FDA}{\texttt{Stacks tag 0FDA}}
\group{perfect}
...
\begin{proposition}[DCoh]
\label{perfect-proposition-DCoh}
\source{stacks:0FDB}
\href{https://stacks.math.columbia.edu/tag/0FDB}{\texttt{Stacks tag 0FDB}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-coh-to-qcoh, perfect-proposition-Noetherian}

Consider the commutative diagram
$$
\begin{array}{cc}D^-(\textit{Coh}(\mathcal{O}_X)) \longrightarrow\downarrow & D^-_{\textit{Coh}}(\mathcal{O}_X) \downarrow \\ D^-(\QCoh(\mathcal{O}_X)) \longrightarrow & D^-_\QCoh(\mathcal{O}_X)\end{array}
$$
By Lemma \ref{perfect-lemma-coh-to-qcoh} the left vertical arrow is fully faithful.
By Proposition \ref{perfect-proposition-Noetherian} the bottom arrow is an equivalence.
...
to it by Proposition \ref{perfect-proposition-Noetherian} will have
coherent cohomology sheaves. Hence $K'$ is in the essential
image of the left vertical arrow by Lemma \ref{perfect-lemma-coh-to-qcoh}
...
\begin{lemma}[Direct image coherent]
\label{perfect-lemma-direct-image-coherent}
\source{stacks:08E2}
\href{https://stacks.math.columbia.edu/tag/08E2}{\texttt{Stacks tag 08E2}}
\group{perfect}
...
\begin{lemma}[Direct image coherent bdd below]
\label{perfect-lemma-direct-image-coherent-bdd-below}
\source{stacks:0D0B}
\href{https://stacks.math.columbia.edu/tag/0D0B}{\texttt{Stacks tag 0D0B}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-direct-image-coherent}

The proof is the same as the proof of
Lemma \ref{perfect-lemma-direct-image-coherent}.
...
\begin{lemma}[Coherent internal hom]
\label{perfect-lemma-coherent-internal-hom}
\source{stacks:0D0C}
\href{https://stacks.math.columbia.edu/tag/0D0C}{\texttt{Stacks tag 0D0C}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-identify-pseudo-coherent-noetherian, perfect-lemma-quasi-coherence-internal-hom}

It suffices to prove this when $X$ is the spectrum of
a Noetherian ring $A$.
By Lemma \ref{perfect-lemma-identify-pseudo-coherent-noetherian}
we see that $K$ is pseudo-coherent.
Then we can use Lemma \ref{perfect-lemma-quasi-coherence-internal-hom}
...
\begin{lemma}[Perfect on noetherian]
\label{perfect-lemma-perfect-on-noetherian}
\source{stacks:0FXU}
\href{https://stacks.math.columbia.edu/tag/0FXU}{\texttt{Stacks tag 0FXU}}
\group{perfect}
...
\begin{lemma}[Ext finite]
\label{perfect-lemma-ext-finite}
\source{stacks:0D0D}
\href{https://stacks.math.columbia.edu/tag/0D0D}{\texttt{Stacks tag 0D0D}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-coherent-internal-hom, perfect-lemma-direct-image-coherent-bdd-below}
...
Lemmas \ref{perfect-lemma-coherent-internal-hom} and
\ref{perfect-lemma-direct-image-coherent-bdd-below}.
\end{proof}

\begin{lemma}[Perfect on regular]
\label{perfect-lemma-perfect-on-regular}
\source{stacks:0FDC}
\href{https://stacks.math.columbia.edu/tag/0FDC}{\texttt{Stacks tag 0FDC}}
\group{perfect}

Let $X$ be a regular scheme. Then
...
\begin{proof}
\uses{perfect-lemma-perfect-affine, perfect-lemma-perfect-on-noetherian}
...
Then $K$ is perfect by Lemma \ref{perfect-lemma-perfect-affine} and
More on Algebra, Lemma \ref{more-algebra-lemma-regular-perfect}.
The converse is Lemma \ref{perfect-lemma-perfect-on-noetherian}.
\end{proof}
...
\begin{lemma}[Tor amplitude descends]
\label{perfect-lemma-tor-amplitude-descends}
\source{stacks:09UD}
\href{https://stacks.math.columbia.edu/tag/09UD}{\texttt{Stacks tag 09UD}}
\group{perfect}
...
\source{stacks:09UE}
\href{https://stacks.math.columbia.edu/tag/09UE}{\texttt{Stacks tag 09UE}}
\group{perfect}
...
via Lemmas \ref{perfect-lemma-affine-compare-bounded} and
\ref{perfect-lemma-pseudo-coherent-affine}.
\end{proof}

\begin{lemma}[Pseudo coherent descends fppf]
\label{perfect-lemma-pseudo-coherent-descends-fppf}
\source{stacks:09UF}
\href{https://stacks.math.columbia.edu/tag/09UF}{\texttt{Stacks tag 09UF}}
\group{perfect}
...
\begin{lemma}[Perfect descends fpqc]
\label{perfect-lemma-perfect-descends-fpqc}
\source{stacks:09UG}
\href{https://stacks.math.columbia.edu/tag/09UG}{\texttt{Stacks tag 09UG}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-pseudo-coherent, perfect-lemma-tor-amplitude-descends, perfect-lemma-pseudo-coherent-descends-fpqc}
...
Lemma \ref{perfect-lemma-pseudo-coherent}
and
...
Cohomology, Lemma \ref{cohomology-lemma-perfect}
and
Lemmas \ref{perfect-lemma-tor-amplitude-descends} and
\ref{perfect-lemma-pseudo-coherent-descends-fpqc}.
\end{proof}

\begin{lemma}[Closed push pseudo coherent]
\label{perfect-lemma-closed-push-pseudo-coherent}
\source{stacks:09VA}
\href{https://stacks.math.columbia.edu/tag/09VA}{\texttt{Stacks tag 09VA}}
\group{perfect}
...
\begin{lemma}[Finite push pseudo coherent]
\label{perfect-lemma-finite-push-pseudo-coherent}
\source{stacks:09VB}
\href{https://stacks.math.columbia.edu/tag/09VB}{\texttt{Stacks tag 09VB}}
\group{perfect}
...
\begin{lemma}[Lift quasi coherent]
\label{perfect-lemma-lift-quasi-coherent}
\source{stacks:08ED}
\href{https://stacks.math.columbia.edu/tag/08ED}{\texttt{Stacks tag 08ED}}
\group{perfect}
...
by Lemma \ref{perfect-lemma-quasi-coherence-direct-image}.
...
Finally, Lemma \ref{perfect-lemma-quasi-coherence-direct-image}
...
\begin{lemma}[Lift coherent]
\label{perfect-lemma-lift-coherent}
\source{stacks:0G48}
\href{https://stacks.math.columbia.edu/tag/0G48}{\texttt{Stacks tag 0G48}}
\group{perfect}
...
\begin{proof}
\uses{perfect-proposition-DCoh}

Let $K$ be an object of $D^b_{\textit{Coh}}(\mathcal{O}_U)$.
By Proposition \ref{perfect-proposition-DCoh} we can represent $K$ by a bounded
...
\begin{lemma}[Lift pseudo coherent]
\label{perfect-lemma-lift-pseudo-coherent}
\source{stacks:08EE}
\href{https://stacks.math.columbia.edu/tag/08EE}{\texttt{Stacks tag 08EE}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-pseudo-coherent, perfect-lemma-lift-quasi-coherent, perfect-lemma-affine-compare-bounded, perfect-lemma-pseudo-coherent-affine}

By Lemma \ref{perfect-lemma-pseudo-coherent} we see that $E$ is an object of
$D_\QCoh(\mathcal{O}_U)$. By
Lemma \ref{perfect-lemma-lift-quasi-coherent}
we may assume $E = E'|U$ for some object $E'$ of
$D_\QCoh(\mathcal{O}_X)$.
Write $X = \Spec(A)$. By Lemma \ref{perfect-lemma-affine-compare-bounded}
...
By Lemma \ref{perfect-lemma-pseudo-coherent-affine} the complexes
...
$$
\begin{array}{cccc} & F^n \longrightarrow\overset{\alpha}{\downarrow} & F^{n + 1} \overset{\alpha}{\downarrow}\longrightarrow & \ldots \\ M^{n-1} \longrightarrow & M^n \longrightarrow & M^{n + 1} \longrightarrow & \ldots\end{array}
$$
...
$$
\begin{array}{ccccc} & F^{n - 1} \overset{\alpha^{n - 1}}{\downarrow}\underset{d^{n - 1}}{\longrightarrow} & F^n \longrightarrow\overset{\alpha}{\downarrow} & F^{n + 1} \overset{\alpha}{\downarrow}\longrightarrow & \ldots \\ \ldots \longrightarrow & M^{n - 1} \longrightarrow & M^n \longrightarrow & M^{n + 1} \longrightarrow & \ldots\end{array}
$$
Moreover, these maps define a morphism of distinguished triangles
$$
\begin{array}{cccc}(F^n \to \ldots) \longrightarrow\downarrow & (F^{n-1} \to \ldots) \longrightarrow\downarrow & F^{n-1} \longrightarrow\underset{\beta}{\downarrow} & (F^n \to \ldots)[1] \downarrow \\ (F^n \to \ldots) \longrightarrow & M^\bullet \longrightarrow & C^\bullet \longrightarrow & (F^n \to \ldots)[1]\end{array}
$$
...
\begin{lemma}[Vanishing ext]
\label{perfect-lemma-vanishing-ext}
\source{stacks:08EF}
\href{https://stacks.math.columbia.edu/tag/08EF}{\texttt{Stacks tag 08EF}}
\group{perfect}
...
represents $E$, see Lemma \ref{perfect-lemma-affine-compare-bounded}.
...
\end{align*}
The first equality by Lemma \ref{perfect-lemma-affine-compare-bounded},
...
\begin{lemma}[Ext from perfect into bounded QCoh]
\label{perfect-lemma-ext-from-perfect-into-bounded-QCoh}
\source{stacks:09M4}
\href{https://stacks.math.columbia.edu/tag/09M4}{\texttt{Stacks tag 09M4}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-quasi-coherence-tensor-product, perfect-lemma-pseudo-coherent, perfect-lemma-application-nice-K-injective}
...
is in $D_\QCoh(X)$ by
Lemmas \ref{perfect-lemma-quasi-coherence-tensor-product} and
\ref{perfect-lemma-pseudo-coherent} (to see that a perfect complex
...
Lemma \ref{perfect-lemma-application-nice-K-injective}, we have
$$
H^0(X, K^\vee \otimes_{\mathcal{O}_X}^\mathbf{L} L) =
...
\begin{lemma}[Lift perfect complex plus locally free]
\label{perfect-lemma-lift-perfect-complex-plus-locally-free}
\source{stacks:08EG}
\href{https://stacks.math.columbia.edu/tag/08EG}{\texttt{Stacks tag 08EG}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-lift-pseudo-coherent, perfect-lemma-ext-from-perfect-into-bounded-QCoh}

Say $X = \Spec(A)$. Recall that a perfect complex is
pseudo-coherent, see
Cohomology, Lemma \ref{cohomology-lemma-perfect}.
By Lemma \ref{perfect-lemma-lift-pseudo-coherent} we can find a bounded above complex
...
Lemma \ref{perfect-lemma-ext-from-perfect-into-bounded-QCoh}.
\end{proof}

\begin{lemma}[Lift map]
\label{perfect-lemma-lift-map}
\source{stacks:08EH}
\href{https://stacks.math.columbia.edu/tag/08EH}{\texttt{Stacks tag 08EH}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-perfect-affine, perfect-lemma-affine-compare-bounded, perfect-proposition-represent-cohomology-class-on-open}
...
$E$ (Lemma \ref{perfect-lemma-perfect-affine}). Choose a complex of $A$-modules
$(M')^\bullet$ representing $E'$ (Lemma \ref{perfect-lemma-affine-compare-bounded}).
...
\begin{lemma}[Lift perfect complex plus shift]
\label{perfect-lemma-lift-perfect-complex-plus-shift}
\source{stacks:08EI}
\href{https://stacks.math.columbia.edu/tag/08EI}{\texttt{Stacks tag 08EI}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-lift-perfect-complex-plus-locally-free, perfect-lemma-lift-map}

By Lemma \ref{perfect-lemma-lift-perfect-complex-plus-locally-free}
...
By Lemma \ref{perfect-lemma-lift-map} we can find a morphism of
...
\begin{lemma}[Perfect into support on T]
\label{perfect-lemma-perfect-into-support-on-T}
\source{stacks:08EJ}
\href{https://stacks.math.columbia.edu/tag/08EJ}{\texttt{Stacks tag 08EJ}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-affine-compare-bounded, perfect-lemma-perfect-affine}
...
$P^\bullet$. This is possible by Lemma \ref{perfect-lemma-perfect-affine}.
...
\begin{lemma}[Lift perfect complex plus shift support]
\label{perfect-lemma-lift-perfect-complex-plus-shift-support}
\source{stacks:08EK}
\href{https://stacks.math.columbia.edu/tag/08EK}{\texttt{Stacks tag 08EK}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-perfect-into-support-on-T, perfect-lemma-lift-perfect-complex-plus-shift, perfect-lemma-lift-map}

Say $T = V(g_1, \ldots, g_s)$. After replacing $g_j$ by a power we
may assume multiplication by $g_j$ is zero on $F$, see
Lemma \ref{perfect-lemma-perfect-into-support-on-T}. Choose $E$ as in
Lemma \ref{perfect-lemma-lift-perfect-complex-plus-shift}.
...
Namely, the diagram
$$
\begin{array}{ccc}E \longrightarrow\underset{0}{\downarrow} & C_1 \underset{g_1}{\downarrow}\longrightarrow & E[1] \underset{0}{\downarrow} \\ E \longrightarrow & C_1 \longrightarrow & E[1]\end{array}
$$
...
and $\gamma : C' \to C_s$ as in Lemma \ref{perfect-lemma-lift-map}
...
By Lemma \ref{perfect-lemma-lift-map} we also have
...
\begin{lemma}[Lift map from perfect complex with support]
\label{perfect-lemma-lift-map-from-perfect-complex-with-support}
\source{stacks:09IM}
\href{https://stacks.math.columbia.edu/tag/09IM}{\texttt{Stacks tag 09IM}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-lift-perfect-complex-plus-shift-support, perfect-lemma-lift-map}
...
By Lemma \ref{perfect-lemma-lift-map} we can replace $Q$ by
...
\source{stacks:09IN}
\href{https://stacks.math.columbia.edu/tag/09IN}{\texttt{Stacks tag 09IN}}
\group{perfect}

\uses{perfect-lemma-lift-map-from-perfect-complex-with-support}
The proof of Lemma \ref{perfect-lemma-lift-map-from-perfect-complex-with-support}
shows that
$$
...
\begin{definition}[Approximation holds]
\label{perfect-definition-approximation-holds}
\source{stacks:08EM}
\href{https://stacks.math.columbia.edu/tag/08EM}{\texttt{Stacks tag 08EM}}
\group{perfect}
...
\source{stacks:08EN}
\href{https://stacks.math.columbia.edu/tag/08EN}{\texttt{Stacks tag 08EN}}
\group{perfect}

\uses{perfect-definition-approximation-holds}
...
Definition \ref{perfect-definition-approximation-holds} with
\begin{enumerate}
...
\source{stacks:08EP}
\href{https://stacks.math.columbia.edu/tag/08EP}{\texttt{Stacks tag 08EP}}
\group{perfect}

\uses{perfect-definition-approximation-holds}
Let $X$ be a scheme. Let $U \subset X$ be an open subscheme.
Let $(T, E, m)$ be a triple as in
Definition \ref{perfect-definition-approximation-holds}.
If
\begin{enumerate}
\item $T \subset U$,
...
\begin{lemma}[Approximation affine]
\label{perfect-lemma-approximation-affine}
\source{stacks:08EQ}
\href{https://stacks.math.columbia.edu/tag/08EQ}{\texttt{Stacks tag 08EQ}}
\group{perfect}

\uses{perfect-definition-approximation-holds}
Let $X$ be an affine scheme. Then approximation holds for every
triple $(T, E, m)$ as in Definition \ref{perfect-definition-approximation-holds}
...
\begin{proof}
\uses{perfect-lemma-pseudo-coherent-affine, perfect-lemma-affine-compare-bounded, perfect-lemma-represent-cohomology-class-on-closed}

Say $X = \Spec(A)$. Write $T = V(f_1, \ldots, f_r)$.
(The case $r = 0$, i.e., $T = X$ follows immediately from
Lemma \ref{perfect-lemma-pseudo-coherent-affine} and the definitions.)
...
(see proof of Lemma \ref{perfect-lemma-affine-compare-bounded})
we can find an $e > 0$ and a morphism $K_e[-t] \to E$
such that $s$ is in the image of
$H^0(K_e) = H^t(K_e[-t]) \to H^t(E)$, see
Lemma \ref{perfect-lemma-represent-cohomology-class-on-closed}.
...
$$
\begin{array}{cccc}P \longrightarrow\downarrow & P'' \downarrow\longrightarrow & P' \downarrow\longrightarrow & P[1] \downarrow \\ P \longrightarrow & E \longrightarrow & E' \longrightarrow & P[1]\end{array}
$$
...
\source{stacks:08ER}
\href{https://stacks.math.columbia.edu/tag/08ER}{\texttt{Stacks tag 08ER}}
\group{perfect}
...
\begin{proof}
\uses{perfect-definition-approximation, perfect-lemma-approximation-affine, perfect-lemma-open, perfect-lemma-lift-perfect-complex-plus-shift-support, perfect-lemma-lift-map}

Let $T \subset X$ be a closed subset with $X \setminus T$ retro-compact
in $X$. Let $r_U$ be the integer of Definition \ref{perfect-definition-approximation}
...
Lemma \ref{perfect-lemma-approximation-affine}
guarantees the existence of an approximation
$P \to E|_V$ of $(T', E|_V, m)$ on $V$.
Applying Lemma \ref{perfect-lemma-open} we see that
...
a morphism of distinguished triangles
$$
\begin{array}{cccc}R \longrightarrow\downarrow & R'' \downarrow\longrightarrow & R' \downarrow\longrightarrow & R[1] \downarrow \\ R \longrightarrow & E \longrightarrow & E' \longrightarrow & R[1]\end{array}
$$
...
\source{stacks:08ES}
\href{https://stacks.math.columbia.edu/tag/08ES}{\texttt{Stacks tag 08ES}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-induction-step, perfect-lemma-approximation-affine}

This follows from the induction principle of
Cohomology of Schemes, Lemma \ref{coherent-lemma-induction-principle}
and Lemmas \ref{perfect-lemma-induction-step} and \ref{perfect-lemma-approximation-affine}.
\end{proof}
...
\begin{lemma}[Direct summand of a restriction]
\label{perfect-lemma-direct-summand-of-a-restriction}
\source{stacks:09IQ}
\href{https://stacks.math.columbia.edu/tag/09IQ}{\texttt{Stacks tag 09IQ}}
\group{perfect}
...
Special case of Lemma \ref{perfect-lemma-lift-map-from-perfect-complex-with-support}.
\end{proof}

\begin{lemma}[Orthogonal koszul complex]
\label{perfect-lemma-orthogonal-koszul-complex}
\source{stacks:09IR}
\href{https://stacks.math.columbia.edu/tag/09IR}{\texttt{Stacks tag 09IR}}
\group{perfect}
...
\end{reference}
In Situation \ref{perfect-situation-complex} denote $j : U \to X$ the open
...
\begin{proof}
\uses{perfect-lemma-represent-cohomology-class-on-closed, perfect-lemma-affine-compare-bounded}
...
$K_e$ as in Lemma \ref{perfect-lemma-represent-cohomology-class-on-closed}.
...
\begin{theorem}[Bondal van den Bergh]
\label{perfect-theorem-bondal-van-den-Bergh}
\source{stacks:09IS}
\href{https://stacks.math.columbia.edu/tag/09IS}{\texttt{Stacks tag 09IS}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-affine-compare-bounded, perfect-lemma-direct-summand-of-a-restriction, perfect-lemma-orthogonal-koszul-complex}
...
This follows from Lemma \ref{perfect-lemma-affine-compare-bounded}.
...
Lemma \ref{perfect-lemma-direct-summand-of-a-restriction} we may
...
$$
Thus by Lemma \ref{perfect-lemma-orthogonal-koszul-complex} the vanishing of
...
Theorem \ref{perfect-theorem-bondal-van-den-Bergh}
...
supported on $T$ (Definition \ref{perfect-definition-supported-on}).
...
\begin{lemma}[Generator with support]
\label{perfect-lemma-generator-with-support}
\source{stacks:0A9A}
\href{https://stacks.math.columbia.edu/tag/0A9A}{\texttt{Stacks tag 0A9A}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-orthogonal-koszul-complex, perfect-lemma-lift-map-from-perfect-complex-with-support}
...
Lemma \ref{perfect-lemma-lift-map-from-perfect-complex-with-support}
...
\Hom_{D(\mathcal{O}_X)}(K'[n], E) = \Hom_{D(\mathcal{O}_V)}(K[n], E|_V)
$$
Thus by Lemma \ref{perfect-lemma-orthogonal-koszul-complex} we have
$E|_V = Rj_*E|_W$ where $j : W \to V$ is the inclusion. Picture
$$
\begin{array}{ccc}W \underset{j}{\longrightarrow} & V & Z \cap T \longleftarrow\downarrow \\ U \cap V \overset{j'}{\uparrow}\underset{j''}{\nearrow} &  & Z \nwarrow\end{array}
$$
...
\begin{lemma}[Nonzero some cohomology]
\label{perfect-lemma-nonzero-some-cohomology}
\source{stacks:0BQR}
\href{https://stacks.math.columbia.edu/tag/0BQR}{\texttt{Stacks tag 0BQR}}
\group{perfect}
...
\begin{lemma}[Construct the next one]
\label{perfect-lemma-construct-the-next-one}
\source{stacks:0BQS}
\href{https://stacks.math.columbia.edu/tag/0BQS}{\texttt{Stacks tag 0BQS}}
\group{perfect}
...
\begin{lemma}[Generator P1]
\label{perfect-lemma-generator-P1}
\source{stacks:0A9V}
\href{https://stacks.math.columbia.edu/tag/0A9V}{\texttt{Stacks tag 0A9V}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-construct-the-next-one, perfect-lemma-nonzero-some-cohomology}
...
and $p \in \mathbf{Z}$.
By Lemma \ref{perfect-lemma-construct-the-next-one}
applied with $a = -n - 1$
...
$$
we conclude that $K = 0$ by Lemma \ref{perfect-lemma-nonzero-some-cohomology}.
...
\begin{remark}[Pullback generator]
\label{perfect-remark-pullback-generator}
\source{stacks:0BQT}
\href{https://stacks.math.columbia.edu/tag/0BQT}{\texttt{Stacks tag 0BQT}}
\group{perfect}

\uses{perfect-theorem-bondal-van-den-Bergh, perfect-lemma-affine-morphism, perfect-lemma-generator-P1}
Let $f : X \to Y$ be a morphism of quasi-compact and quasi-separated schemes.
Let $E \in D_\QCoh(\mathcal{O}_Y)$ be a generator
(see Theorem \ref{perfect-theorem-bondal-van-den-Bergh}).
...
These conditions hold if $f$ is affine (Lemma \ref{perfect-lemma-affine-morphism})
...
\begin{proposition}[Compact is perfect]
\label{perfect-proposition-compact-is-perfect}
\source{stacks:09M1}
\href{https://stacks.math.columbia.edu/tag/09M1}{\texttt{Stacks tag 09M1}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-quasi-coherence-pushforward-direct-sums, perfect-lemma-affine-compare-bounded}
...
Lemma \ref{perfect-lemma-quasi-coherence-pushforward-direct-sums}
...
\medskip\noindent
Assume $X = \Spec(A)$ is affine. By Lemma \ref{perfect-lemma-affine-compare-bounded}
...
\begin{remark}[Classical generator]
\label{perfect-remark-classical-generator}
\source{stacks:0GEF}
\href{https://stacks.math.columbia.edu/tag/0GEF}{\texttt{Stacks tag 0GEF}}
\group{perfect}

\uses{perfect-theorem-bondal-van-den-Bergh, perfect-lemma-quasi-coherence-direct-sums, perfect-proposition-compact-is-perfect}
Let $X$ be a quasi-compact and quasi-separated scheme. Let $G$ be a
perfect object of $D(\mathcal{O}_X)$ which is a generator for
$D_\QCoh(\mathcal{O}_X)$. By Theorem \ref{perfect-theorem-bondal-van-den-Bergh}
there is at least one of these. Combining
Lemma \ref{perfect-lemma-quasi-coherence-direct-sums} with
Proposition \ref{perfect-proposition-compact-is-perfect} and with
...
\begin{lemma}[Compact is perfect with support]
\label{perfect-lemma-compact-is-perfect-with-support}
\source{stacks:0A9B}
\href{https://stacks.math.columbia.edu/tag/0A9B}{\texttt{Stacks tag 0A9B}}
\group{perfect}
...
\begin{proof}
\uses{perfect-proposition-compact-is-perfect, perfect-lemma-generator-with-support}

We observe that $D_{\QCoh, T}(\mathcal{O}_X)$ is a triangulated
category with direct sums by the remark preceding the lemma.
By Proposition \ref{perfect-proposition-compact-is-perfect}
...
Lemma \ref{perfect-lemma-generator-with-support}.
...
\begin{remark}[Classical generator with support]
\label{perfect-remark-classical-generator-with-support}
\source{stacks:0GEG}
\href{https://stacks.math.columbia.edu/tag/0GEG}{\texttt{Stacks tag 0GEG}}
\group{perfect}

\uses{perfect-lemma-generator-with-support, perfect-lemma-compact-is-perfect-with-support}
Let $X$ be a quasi-compact and quasi-separated scheme.
Let $T \subset X$ be a closed subset such that $X \setminus T$
is quasi-compact. Let $G$ be a
perfect object of $D_{\QCoh, T}(\mathcal{O}_X)$ which is a generator for
$D_{\QCoh, T}(\mathcal{O}_X)$. By Lemma \ref{perfect-lemma-generator-with-support}
there is at least one of these. Combining the fact that
$D_{\QCoh, T}(\mathcal{O}_X)$ has direct sums with
Lemma \ref{perfect-lemma-compact-is-perfect-with-support} and with
Derived Categories, Proposition
\ref{derived-proposition-generator-versus-classical-generator}
...
\begin{lemma}[Map from pseudo coherent to complex with support]
\label{perfect-lemma-map-from-pseudo-coherent-to-complex-with-support}
\source{stacks:0A9C}
\href{https://stacks.math.columbia.edu/tag/0A9C}{\texttt{Stacks tag 0A9C}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-quasi-coherence-internal-hom, perfect-lemma-generator-with-support}

Set $\mathcal{D} = D_{\QCoh, T}(\mathcal{O}_X)$. In both cases the complex
$K = R\SheafHom(P, E)$ is an object of $\mathcal{D}$. See
Lemma \ref{perfect-lemma-quasi-coherence-internal-hom} for quasi-coherence.
...
Lemma \ref{perfect-lemma-generator-with-support}. Write
$$
K = \text{hocolim} K_n
$$
...
\begin{lemma}[Tensor with QCoh complex]
\label{perfect-lemma-tensor-with-QCoh-complex}
\source{stacks:09M3}
\href{https://stacks.math.columbia.edu/tag/09M3}{\texttt{Stacks tag 09M3}}
\group{perfect}
...
\begin{theorem}[DQCoh is Ddga]
\label{perfect-theorem-DQCoh-is-Ddga}
\source{stacks:09M5}
\href{https://stacks.math.columbia.edu/tag/09M5}{\texttt{Stacks tag 09M5}}
\group{perfect}
...
\begin{proof}
\uses{perfect-theorem-bondal-van-den-Bergh, perfect-lemma-ext-from-perfect-into-bounded-QCoh, perfect-proposition-compact-is-perfect, perfect-lemma-tensor-with-QCoh-complex}

Let $K^\bullet$ be a K-injective complex of $\mathcal{O}$-modules which
is perfect and generates $D_\QCoh(\mathcal{O}_X)$. Such a
thing exists by Theorem \ref{perfect-theorem-bondal-van-den-Bergh}
...
are nonzero by Lemma \ref{perfect-lemma-ext-from-perfect-into-bounded-QCoh}.
...
$D(\mathcal{O}_X)$, see Proposition \ref{perfect-proposition-compact-is-perfect}.
...
Lemma \ref{perfect-lemma-tensor-with-QCoh-complex} that we obtain
$$
- \otimes_E^\mathbf{L} K^\bullet :
...
\source{stacks:0DJL}
\href{https://stacks.math.columbia.edu/tag/0DJL}{\texttt{Stacks tag 0DJL}}
\group{perfect}

\uses{perfect-theorem-DQCoh-is-Ddga, perfect-lemma-generator-with-support, perfect-lemma-compact-is-perfect-with-support, perfect-lemma-tensor-with-QCoh-complex}
Let $X$ be a quasi-compact and quasi-separated scheme. Let $T \subset X$
be a closed subset such that $X \setminus T$ is quasi-compact.
The analogue of Theorem \ref{perfect-theorem-DQCoh-is-Ddga} holds
for $D_{\QCoh, T}(\mathcal{O}_X)$.
This follows from the exact same argument as in the proof
of the theorem, using
Lemmas \ref{perfect-lemma-generator-with-support} and
\ref{perfect-lemma-compact-is-perfect-with-support}
and a variant of Lemma \ref{perfect-lemma-tensor-with-QCoh-complex}
with supports.
...
\source{stacks:09SU}
\href{https://stacks.math.columbia.edu/tag/09SU}{\texttt{Stacks tag 09SU}}
\group{perfect}

\uses{perfect-theorem-DQCoh-is-Ddga}
Let $X$ be a quasi-compact and quasi-separated scheme over a ring $R$.
By the construction of the proof of
Theorem \ref{perfect-theorem-DQCoh-is-Ddga}
...
\begin{lemma}[Pseudo coherent hocolim]
\label{perfect-lemma-pseudo-coherent-hocolim}
\source{stacks:0DJN}
\href{https://stacks.math.columbia.edu/tag/0DJN}{\texttt{Stacks tag 0DJN}}
\group{perfect}
...
\begin{proof}
\uses{perfect-definition-approximation-holds, perfect-definition-approximation, perfect-theorem-approximation, perfect-lemma-ext-from-perfect-into-bounded-QCoh}
...
Theorem \ref{perfect-theorem-approximation}.
...
\begin{lemma}[Pseudo coherent hocolim with support]
\label{perfect-lemma-pseudo-coherent-hocolim-with-support}
\source{stacks:0DJP}
\href{https://stacks.math.columbia.edu/tag/0DJP}{\texttt{Stacks tag 0DJP}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-pseudo-coherent-hocolim}

The proof of this lemma is exactly the same as the proof of
Lemma \ref{perfect-lemma-pseudo-coherent-hocolim}
...
In Section \ref{perfect-section-example-generator}
...
where $S = A[X_0, \ldots, X_n]$. By Lemma \ref{perfect-lemma-generator-P1}
we know that
\begin{equation}
...
\ref{dga-lemma-tensor-with-complex-derived}.
By Lemma \ref{perfect-lemma-tensor-with-QCoh-complex}
we see that the essential image of this functor
is contained in $D_\QCoh(\mathcal{O}_X)$.

\begin{lemma}[Pn module category]
\label{perfect-lemma-Pn-module-category}
\source{stacks:0BQU}
\href{https://stacks.math.columbia.edu/tag/0BQU}{\texttt{Stacks tag 0BQU}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-ext-from-perfect-into-bounded-QCoh, perfect-lemma-generator-P1}
...
In Section \ref{perfect-section-coherator} we constructed and studied
...
\begin{lemma}[Better coherator]
\label{perfect-lemma-better-coherator}
\source{stacks:0CR0}
\href{https://stacks.math.columbia.edu/tag/0CR0}{\texttt{Stacks tag 0CR0}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-affine-coherator, perfect-lemma-quasi-coherence-direct-image, perfect-lemma-quasi-coherence-pullback}
[First proof]
...
$RQ_X$ of Section \ref{perfect-section-coherator} is a right adjoint to the functor
$D(\QCoh(\mathcal{O}_X)) \to D(\mathcal{O}_X)$.
In particular, our lemma is true for affine schemes, see
Lemma \ref{perfect-lemma-affine-coherator}.
...
Lemma \ref{perfect-lemma-quasi-coherence-pullback}.
This finishes the proof.
\end{proof}

\begin{proof}
\uses{perfect-lemma-quasi-coherence-direct-sums, perfect-theorem-bondal-van-den-Bergh, perfect-proposition-compact-is-perfect}
[Second proof]
...
(Lemma \ref{perfect-lemma-quasi-coherence-direct-sums}).
On the other hand, $D_\QCoh(\mathcal{O}_X)$
is compactly generated because it has a perfect
generator Theorem \ref{perfect-theorem-bondal-van-den-Bergh}
and because perfect objects are compact by
Proposition \ref{perfect-proposition-compact-is-perfect}.
\end{proof}

\begin{lemma}[Pushforward better coherator]
\label{perfect-lemma-pushforward-better-coherator}
\source{stacks:0CR1}
\href{https://stacks.math.columbia.edu/tag/0CR1}{\texttt{Stacks tag 0CR1}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-quasi-coherence-direct-image, perfect-lemma-quasi-coherence-pullback}
...
\begin{remark}[Explain consequence]
\label{perfect-remark-explain-consequence}
\source{stacks:0CR2}
\href{https://stacks.math.columbia.edu/tag/0CR2}{\texttt{Stacks tag 0CR2}}
\group{perfect}

\uses{perfect-lemma-better-coherator, perfect-lemma-pushforward-better-coherator}
Let $X$ be a quasi-compact and quasi-separated scheme.
Let $X = U \cup V$ with $U$ and $V$ quasi-compact open.
By Lemma \ref{perfect-lemma-better-coherator} the functors
...
Cohomology, Lemma \ref{cohomology-lemma-exact-sequence-j-star}
and using Lemma \ref{perfect-lemma-pushforward-better-coherator} three times.
\end{remark}

\begin{lemma}[Boundedness better coherator]
\label{perfect-lemma-boundedness-better-coherator}
\source{stacks:0CSA}
\href{https://stacks.math.columbia.edu/tag/0CSA}{\texttt{Stacks tag 0CSA}}
\group{perfect}

\uses{perfect-lemma-better-coherator}
Let $X$ be a quasi-compact and quasi-separated scheme. The functor
$DQ_X$ of Lemma \ref{perfect-lemma-better-coherator}
...
\begin{proof}
\uses{perfect-lemma-affine-compare-bounded, perfect-lemma-affine-coherator, perfect-lemma-quasi-coherence-direct-image, perfect-remark-explain-consequence}
...
See Lemmas \ref{perfect-lemma-affine-compare-bounded} and \ref{perfect-lemma-affine-coherator}.
...
of Remark \ref{perfect-remark-explain-consequence}.
\end{proof}

\begin{example}[Inverse limit quasi coherent]
\label{perfect-example-inverse-limit-quasi-coherent}
\source{stacks:0CSB}
\href{https://stacks.math.columbia.edu/tag/0CSB}{\texttt{Stacks tag 0CSB}}
\group{perfect}

\uses{perfect-lemma-boundedness-better-coherator}
...
by Lemma \ref{perfect-lemma-boundedness-better-coherator}.
\end{example}
...
\begin{lemma}[Cohomology base change]
\label{perfect-lemma-cohomology-base-change}
\source{stacks:08EU}
\href{https://stacks.math.columbia.edu/tag/08EU}{\texttt{Stacks tag 08EU}}
\group{perfect}
...
\begin{definition}[Tor independent]
\label{perfect-definition-tor-independent}
\source{stacks:08IA}
\href{https://stacks.math.columbia.edu/tag/08IA}{\texttt{Stacks tag 08IA}}
\group{perfect}
...
\begin{lemma}[Tor independent]
\label{perfect-lemma-tor-independent}
\source{stacks:0FXV}
\href{https://stacks.math.columbia.edu/tag/0FXV}{\texttt{Stacks tag 0FXV}}
\group{perfect}
...
\begin{lemma}[Flat base change tor independent]
\label{perfect-lemma-flat-base-change-tor-independent}
\source{stacks:0FXW}
\href{https://stacks.math.columbia.edu/tag/0FXW}{\texttt{Stacks tag 0FXW}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-tor-independent}

Omitted. Hint: use Lemma \ref{perfect-lemma-tor-independent} and
on affine opens use More on Algebra, Lemma
\ref{more-algebra-lemma-flat-base-change-tor-independent}.
\end{proof}

\begin{lemma}[Compare base change]
\label{perfect-lemma-compare-base-change}
\source{stacks:08IB}
\href{https://stacks.math.columbia.edu/tag/08IB}{\texttt{Stacks tag 08IB}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-affine-morphism, perfect-lemma-quasi-coherence-pullback, perfect-lemma-quasi-coherence-tensor-product, perfect-lemma-quasi-coherence-direct-image, perfect-lemma-affine-morphism-pull-push, perfect-lemma-cohomology-base-change}
...
$$
is an isomorphism, see Lemma \ref{perfect-lemma-affine-morphism}
(and use Lemmas \ref{perfect-lemma-quasi-coherence-pullback},
...
By Lemma \ref{perfect-lemma-affine-morphism-pull-push} the map becomes a map
$$
...
Thus by
Lemma \ref{perfect-lemma-cohomology-base-change} it suffices to prove that
...
(use Lemma \ref{perfect-lemma-quasi-coherence-pullback}).
\end{proof}

The following lemma will be used in the chapter on dualizing complexes.

\begin{lemma}[Affine morphism and hom out of perfect]
\label{perfect-lemma-affine-morphism-and-hom-out-of-perfect}
\source{stacks:0AA7}
\href{https://stacks.math.columbia.edu/tag/0AA7}{\texttt{Stacks tag 0AA7}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-affine-morphism-pull-push, perfect-lemma-quasi-coherence-internal-hom, perfect-lemma-internal-hom-evaluate-tensor-isomorphism, perfect-lemma-compare-base-change, perfect-lemma-tor-dimension-affine}
...
$$
by Lemma \ref{perfect-lemma-affine-morphism-pull-push}. In both cases the complex
$R\SheafHom(M, K)$ is an object of $D_\QCoh(\mathcal{O}_X)$ by
Lemma \ref{perfect-lemma-quasi-coherence-internal-hom}. There is a natural map
$$
...
Lemma \ref{perfect-lemma-internal-hom-evaluate-tensor-isomorphism}.
...
Using Lemma \ref{perfect-lemma-tor-dimension-affine} and
Cohomology, Lemma \ref{cohomology-lemma-tor-amplitude-pullback}
...
by Lemma \ref{perfect-lemma-affine-morphism-pull-push}.
Hence the result follows from
Lemma \ref{perfect-lemma-compare-base-change}.
\end{proof}

\begin{remark}[Multiplication map]
\label{perfect-remark-multiplication-map}
\source{stacks:0BZA}
\href{https://stacks.math.columbia.edu/tag/0BZA}{\texttt{Stacks tag 0BZA}}
\group{perfect}

\uses{perfect-lemma-affine-morphism-and-hom-out-of-perfect}
With notation as in Lemma \ref{perfect-lemma-affine-morphism-and-hom-out-of-perfect}.
The diagram
$$
\begin{array}{cc}R\Hom_X(M, Rg'_*L) \otimes_R^\mathbf{L} R' \longrightarrow\underset{\mu}{\downarrow} & R\Hom_{X'}(L(g')^*M, L(g')^*Rg'_*L) \overset{a}{\downarrow} \\ R\Hom_X(M, R(g')_*L) \xlongequal{} & R\Hom_{X'}(L(g')^*M, L)\end{array}
$$
...
\begin{lemma}[Tor independence and tor amplitude]
\label{perfect-lemma-tor-independence-and-tor-amplitude}
\source{stacks:0C0V}
\href{https://stacks.math.columbia.edu/tag/0C0V}{\texttt{Stacks tag 0C0V}}
\group{perfect}
...
\begin{lemma}[Compare base change closed immersion]
\label{perfect-lemma-compare-base-change-closed-immersion}
\source{stacks:0E23}
\href{https://stacks.math.columbia.edu/tag/0E23}{\texttt{Stacks tag 0E23}}
\group{perfect}
...
Consider a cartesian diagram of schemes
$$
\begin{array}{ccc} & X \times_S Y \overset{p}{\swarrow}\underset{q}{\searrow}\overset{f}{\downarrow} &  \\ X \underset{a}{\searrow} &  & Y \overset{b}{\swarrow} \\  & S & \end{array}
$$
...
\source{stacks:0FLQ}
\href{https://stacks.math.columbia.edu/tag/0FLQ}{\texttt{Stacks tag 0FLQ}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-cohomology-base-change, perfect-lemma-compare-base-change}
[First proof]
...
by Lemma \ref{perfect-lemma-cohomology-base-change}. The third equality by
Lemma \ref{perfect-lemma-compare-base-change}.  The fourth equality by
...
\begin{proof}
\uses{perfect-lemma-quasi-coherence-direct-image, perfect-lemma-quasi-coherence-tensor-product, perfect-lemma-affine-compare-bounded, perfect-lemma-affine-K-flat}
[Second proof]
...
Lemmas \ref{perfect-lemma-quasi-coherence-direct-image} and
...
Thus, by Lemma \ref{perfect-lemma-affine-compare-bounded}, it suffices to prove that
(\ref{equation-kunneth-global}) is an isomorphism.

\medskip\noindent
Assume $S = \Spec(A)$ and $X = \Spec(B)$ and $Y = \Spec(C)$ are all affine.
We will use Lemma \ref{perfect-lemma-affine-compare-bounded} without further mention.
...
Lemma \ref{perfect-lemma-affine-K-flat}. Thus
...
\begin{lemma}[Cohomology de rham base change]
\label{perfect-lemma-cohomology-de-rham-base-change}
\source{stacks:0FML}
\href{https://stacks.math.columbia.edu/tag/0FML}{\texttt{Stacks tag 0FML}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-cohomology-base-change, perfect-lemma-quasi-coherence-pushforward-direct-sums}
...
proof of Lemma \ref{perfect-lemma-cohomology-base-change} except that we have
...
\source{stacks:0FMQ}
\href{https://stacks.math.columbia.edu/tag/0FMQ}{\texttt{Stacks tag 0FMQ}}
\group{perfect}
...
\begin{lemma}[Kunneth single sheaf]
\label{perfect-lemma-kunneth-single-sheaf}
\source{stacks:0FU4}
\href{https://stacks.math.columbia.edu/tag/0FU4}{\texttt{Stacks tag 0FU4}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-K-flat, perfect-lemma-cohomology-base-change}
...
$\check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{F})$
is K-flat by Lemma \ref{perfect-lemma-K-flat} and we conclude that
$\text{Tot}(
\check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{F})
\otimes_A
\check{\mathcal{C}}^\bullet(\mathcal{V}, \mathcal{G}))$
...
b^*\widetilde{\Gamma(X, \mathcal{F})} \otimes_{\mathcal{O}_Y} \mathcal{G})
$$
Using Lemma \ref{perfect-lemma-cohomology-base-change} for the morphism
...
\begin{remark}[Annoying compatibility]
\label{perfect-remark-annoying-compatibility}
\source{stacks:0G7W}
\href{https://stacks.math.columbia.edu/tag/0G7W}{\texttt{Stacks tag 0G7W}}
\group{perfect}
...
$$
\begin{array}{ccc}R\Gamma(X, \mathcal{F})[-i] \otimes_A^\mathbf{L} R\Gamma(Y, \mathcal{E})
\downarrow\underset{\xi \otimes \text{id}}{\longrightarrow} &  & R\Gamma(X, \mathcal{G} \otimes_{\mathcal{O}_X} \mathcal{F})
\otimes_A^\mathbf{L} R\Gamma(Y, \mathcal{E}) \downarrow \\ R\Gamma(X \times_S Y, p^*\mathcal{F} \otimes q^*\mathcal{E})[-i]
\overset{p^*\xi}{\longrightarrow} &  & R\Gamma(X \times_S Y,
p^*(\mathcal{G} \otimes_{\mathcal{O}_X} \mathcal{F}) \otimes q^*\mathcal{E})\end{array}
$$
...
Section \ref{perfect-section-kunneth}. In this section, given an
...
$$
\begin{array}{cccc}\ldots & \ldots & \ldots & \ldots \\ \ldots \longrightarrow & \mathcal{F}^i \boxtimes \mathcal{G}^{j + 1}
\overset{d_1^{i, j + 1}}{\longrightarrow}\uparrow & \mathcal{F}^{i + 1} \boxtimes \mathcal{G}^{j + 1} \longrightarrow\uparrow & \ldots \\ \ldots \longrightarrow & \mathcal{F}^i \boxtimes \mathcal{G}^j
\overset{d_1^{i, j}}{\longrightarrow}\overset{d_2^{i, j}}{\uparrow} & \mathcal{F}^{i + 1} \boxtimes \mathcal{G}^j \longrightarrow\underset{d_2^{i + 1, j}}{\uparrow} & \ldots \\ \ldots & \ldots \uparrow & \ldots \uparrow & \ldots\end{array}
$$
...
\begin{lemma}[Kunneth special]
\label{perfect-lemma-kunneth-special}
\source{stacks:0FLT}
\href{https://stacks.math.columbia.edu/tag/0FLT}{\texttt{Stacks tag 0FLT}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-cohomology-de-rham-base-change, perfect-lemma-kunneth-single-sheaf}
...
$$
\begin{array}{cc}R\Gamma(X, \mathcal{F}_1^\bullet)
\otimes_A^\mathbf{L}
R\Gamma(Y, \mathcal{G}^\bullet)
\longrightarrow\downarrow & R\Gamma(X \times_S Y,
\text{Tot}(\mathcal{F}_1^\bullet \boxtimes \mathcal{G}^\bullet)) \downarrow \\ R\Gamma(X, \mathcal{F}_2^\bullet)
\otimes_A^\mathbf{L}
R\Gamma(Y, \mathcal{G}^\bullet)
\longrightarrow\downarrow & R\Gamma(X \times_S Y,
\text{Tot}(\mathcal{F}_2^\bullet \boxtimes \mathcal{G}^\bullet)) \downarrow \\ R\Gamma(X, \mathcal{F}_3^\bullet)
\otimes_A^\mathbf{L}
R\Gamma(Y, \mathcal{G}^\bullet)
\longrightarrow\downarrow & R\Gamma(X \times_S Y,
\text{Tot}(\mathcal{F}_3^\bullet \boxtimes \mathcal{G}^\bullet)) \downarrow \\ R\Gamma(X, \mathcal{F}_1^\bullet[1])
\otimes_A^\mathbf{L}
R\Gamma(Y, \mathcal{G}^\bullet)
\longrightarrow & R\Gamma(X \times_S Y,
\text{Tot}(\mathcal{F}_1^\bullet[1] \boxtimes \mathcal{G}^\bullet))\end{array}
$$
...
tor dimension by Lemma \ref{perfect-lemma-cohomology-de-rham-base-change} for example.
...
This case is handled by Lemma \ref{perfect-lemma-kunneth-single-sheaf}.
\end{proof}
...
\begin{lemma}[Kunneth Ext]
\label{perfect-lemma-kunneth-Ext}
\source{stacks:0FXZ}
\href{https://stacks.math.columbia.edu/tag/0FXZ}{\texttt{Stacks tag 0FXZ}}
\group{perfect}
...
Hence this case follows from Lemma \ref{perfect-lemma-kunneth}.
...
In Section \ref{perfect-section-cohomology-and-base-change-perfect}
...
\begin{lemma}[Single complex base change condition]
\label{perfect-lemma-single-complex-base-change-condition}
\source{stacks:0DJ8}
\href{https://stacks.math.columbia.edu/tag/0DJ8}{\texttt{Stacks tag 0DJ8}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-quasi-coherence-pullback}
...
R\Gamma(U', L(g')^*K)
$$
of Lemma \ref{perfect-lemma-quasi-coherence-pullback} and the given arrow
...
\begin{lemma}[Single complex base change]
\label{perfect-lemma-single-complex-base-change}
\source{stacks:0DJ9}
\href{https://stacks.math.columbia.edu/tag/0DJ9}{\texttt{Stacks tag 0DJ9}}
\group{perfect}

\uses{perfect-lemma-single-complex-base-change-condition}
Let
$$
\begin{array}{cc}X' \underset{g'}{\longrightarrow}\underset{f'}{\downarrow} & X \overset{f}{\downarrow} \\ S' \overset{g}{\longrightarrow} & S\end{array}
$$
...
Lemma \ref{perfect-lemma-single-complex-base-change-condition} hold, and
...
\begin{proof}
\uses{perfect-lemma-compare-base-change, perfect-lemma-single-complex-base-change-condition, perfect-lemma-affine-compare-bounded, perfect-lemma-quasi-coherence-pullback}

We could prove this using the same method as in the proof of
Lemma \ref{perfect-lemma-compare-base-change} but instead we will prove
...
Lemma \ref{perfect-lemma-single-complex-base-change-condition} part (2)
and the translation into algebra afforded to us
by Lemmas \ref{perfect-lemma-affine-compare-bounded} and
\ref{perfect-lemma-quasi-coherence-pullback}.
...
we obtain a commutative diagram
$$
\begin{array}{cc}Lg^*Rf_*K \longrightarrow\downarrow & Rf'_* K' \downarrow \\ Lg^*Ra_* K|_U \oplus
Lg^*Rb_* K|_V \longrightarrow\downarrow & Ra'_* K'|_{U'} \oplus
Rb'_* K'|_{V'} \downarrow \\ Lg^*Rc_* K|_{U \cap V} \longrightarrow\downarrow & Rc'_* K'|_{U' \cap V'} \downarrow \\ Lg^*Rf_* K[1] \longrightarrow & Rf'_* K'[1]\end{array}
$$
...
\begin{lemma}[Single complex base change condition inherited]
\label{perfect-lemma-single-complex-base-change-condition-inherited}
\source{stacks:0DJA}
\href{https://stacks.math.columbia.edu/tag/0DJA}{\texttt{Stacks tag 0DJA}}
\group{perfect}
...
Lemma \ref{perfect-lemma-single-complex-base-change-condition} hold, then
\begin{enumerate}
\item for $E \in D_\QCoh(\mathcal{O}_X)$ the equivalent
conditions of Lemma \ref{perfect-lemma-single-complex-base-change-condition} hold
for $L(g')^*(E \otimes^\mathbf{L} K) \to L(g')^*E \otimes^\mathbf{L} K'$,
\item if $E$ in $D(\mathcal{O}_X)$ is perfect the equivalent conditions of
Lemma \ref{perfect-lemma-single-complex-base-change-condition} hold for
...
\begin{proof}
\uses{perfect-lemma-quasi-coherence-pullback, perfect-lemma-quasi-coherence-tensor-product, perfect-lemma-quasi-coherence-internal-hom}

The statement makes sense as the complexes involved have quasi-coherent
cohomology sheaves by Lemmas
\ref{perfect-lemma-quasi-coherence-pullback},
\ref{perfect-lemma-quasi-coherence-tensor-product}, and
\ref{perfect-lemma-quasi-coherence-internal-hom} and
...
\begin{lemma}[Base change tensor]
\label{perfect-lemma-base-change-tensor}
\source{stacks:0A1D}
\href{https://stacks.math.columbia.edu/tag/0A1D}{\texttt{Stacks tag 0A1D}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-single-complex-base-change, perfect-lemma-single-complex-base-change-condition-inherited, perfect-lemma-single-complex-base-change-condition}
...
To prove this, we apply Lemmas \ref{perfect-lemma-single-complex-base-change} and
\ref{perfect-lemma-single-complex-base-change-condition-inherited} to see that it
...
\begin{lemma}[Base change RHom]
\label{perfect-lemma-base-change-RHom}
\source{stacks:08IE}
\href{https://stacks.math.columbia.edu/tag/08IE}{\texttt{Stacks tag 08IE}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-single-complex-base-change, perfect-lemma-single-complex-base-change-condition-inherited, perfect-lemma-single-complex-base-change-condition, perfect-lemma-base-change-tensor}
...
Lemmas \ref{perfect-lemma-single-complex-base-change} and
\ref{perfect-lemma-single-complex-base-change-condition-inherited} to see that it
suffices to prove the canonical map
$$
L(g')^*\mathcal{G}^\bullet \to (g')^*\mathcal{G}^\bullet
...
satisfies the equivalent conditions of
Lemma \ref{perfect-lemma-single-complex-base-change-condition}.
This was shown in the proof of Lemma \ref{perfect-lemma-base-change-tensor}.
\end{proof}
...
\begin{lemma}[Perfect direct image]
\label{perfect-lemma-perfect-direct-image}
\source{stacks:08EV}
\href{https://stacks.math.columbia.edu/tag/08EV}{\texttt{Stacks tag 08EV}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-direct-image-coherent, perfect-lemma-identify-pseudo-coherent-noetherian, perfect-lemma-tor-qc-qs, perfect-lemma-cohomology-base-change}

By Lemma \ref{perfect-lemma-direct-image-coherent} we see that $Rf_*E$ is an object of
...
Cohomology, Lemma \ref{cohomology-lemma-perfect}.
By Lemma \ref{perfect-lemma-tor-qc-qs} it suffices to check that
...
\source{stacks:0DJQ}
\href{https://stacks.math.columbia.edu/tag/0DJQ}{\texttt{Stacks tag 0DJQ}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-perfect-direct-image}

The object $K$ is perfect by Lemma \ref{perfect-lemma-perfect-direct-image}.
...
\begin{lemma}[Ext perfect]
\label{perfect-lemma-ext-perfect}
\source{stacks:0DJR}
\href{https://stacks.math.columbia.edu/tag/0DJR}{\texttt{Stacks tag 0DJR}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-tensor-perfect}
...
Thus the perfectness of $K$ follows from Lemma \ref{perfect-lemma-tensor-perfect}.
\end{proof}
...
\begin{lemma}[Flat proper perfect direct image]
\label{perfect-lemma-flat-proper-perfect-direct-image}
\source{stacks:0B6F}
\href{https://stacks.math.columbia.edu/tag/0B6F}{\texttt{Stacks tag 0B6F}}
\group{perfect}
...
We claim that Lemma \ref{perfect-lemma-perfect-direct-image} applies.
...
Lemma \ref{perfect-lemma-compute-ext} (or similar results in the literature)
...
easily from Lemma \ref{perfect-lemma-cohomology-base-change}.

\begin{lemma}[Compute tensor perfect]
\label{perfect-lemma-compute-tensor-perfect}
\source{stacks:0A1F}
\href{https://stacks.math.columbia.edu/tag/0A1F}{\texttt{Stacks tag 0A1F}}
\group{perfect}

\uses{perfect-lemma-tensor-perfect}
Assumptions and notation as in Lemma \ref{perfect-lemma-tensor-perfect}.
...
\begin{proof}
\uses{perfect-lemma-cohomology-base-change}
...
the third equality by Lemma \ref{perfect-lemma-cohomology-base-change}.
...
$$
\begin{array}{cc}H^i(S, K \otimes^\mathbf{L}_{\mathcal{O}_S} \mathcal{F}_3)
\longrightarrow\underset{\delta}{\downarrow} & H^i(X, E \otimes^\mathbf{L}_{\mathcal{O}_X}
(\mathcal{G}^\bullet \otimes_{\mathcal{O}_X} f^*\mathcal{F}_3))
\overset{\delta}{\downarrow} \\ H^{i + 1}(S, K \otimes^\mathbf{L}_{\mathcal{O}_S} \mathcal{F}_1)
\longrightarrow & H^{i + 1}(X, E \otimes^\mathbf{L}_{\mathcal{O}_X}
(\mathcal{G}^\bullet \otimes_{\mathcal{O}_X} f^*\mathcal{F}_1))\end{array}
$$
...
\begin{lemma}[Compute ext perfect]
\label{perfect-lemma-compute-ext-perfect}
\source{stacks:08ID}
\href{https://stacks.math.columbia.edu/tag/08ID}{\texttt{Stacks tag 08ID}}
\group{perfect}

\uses{perfect-lemma-ext-perfect}
Assumptions and notation as in Lemma \ref{perfect-lemma-ext-perfect}.
Then there are functorial isomorphisms
$$
H^i(S, K \otimes^\mathbf{L}_{\mathcal{O}_S} \mathcal{F})
\longrightarrow
...
\begin{proof}
\uses{perfect-lemma-ext-perfect, perfect-lemma-compute-tensor-perfect}

As in the proof of Lemma \ref{perfect-lemma-ext-perfect} let $E^\vee$ be the
...
from Lemma \ref{perfect-lemma-compute-tensor-perfect} applied to $E^\vee$
...
$$
\begin{array}{cc}H^i(S, K \otimes^\mathbf{L}_{\mathcal{O}_S} \mathcal{F}_3)
\longrightarrow\underset{\delta}{\downarrow} & \Ext^i_{\mathcal{O}_X}(E,
\mathcal{G}^\bullet \otimes_{\mathcal{O}_X} f^*\mathcal{F}_3) \overset{\delta}{\downarrow} \\ H^{i + 1}(S, K \otimes^\mathbf{L}_{\mathcal{O}_S} \mathcal{F}_1)
\longrightarrow & \Ext^{i + 1}_{\mathcal{O}_X}(E,
\mathcal{G}^\bullet \otimes_{\mathcal{O}_X} f^*\mathcal{F}_1)\end{array}
$$
where the boundary maps come from the distinguished triangle
$$
...
\begin{lemma}[Compute ext]
\label{perfect-lemma-compute-ext}
\source{stacks:08IF}
\href{https://stacks.math.columbia.edu/tag/08IF}{\texttt{Stacks tag 08IF}}
\group{perfect}
...
\begin{proof}
\uses{perfect-theorem-approximation, perfect-lemma-compute-ext-perfect, perfect-lemma-identify-pseudo-coherent-noetherian, perfect-lemma-pseudo-coherent-hocolim, perfect-lemma-tensor-perfect}
...
$(X, E, -m - 1 + a)$
(possible by Theorem \ref{perfect-theorem-approximation}).
...
$E$ is a perfect complex which is Lemma \ref{perfect-lemma-compute-ext-perfect}.
The statement on boundaries is explained in the proof of
Lemma \ref{perfect-lemma-compute-ext-perfect}.

\medskip\noindent
Proof of (B). As in the proof of (A) we may assume $X$ is Noetherian.
Observe that $E$ is pseudo-coherent by
Lemma \ref{perfect-lemma-identify-pseudo-coherent-noetherian}.
By Lemma \ref{perfect-lemma-pseudo-coherent-hocolim} we can write
...
$$
perfect on $S$, see Lemma \ref{perfect-lemma-tensor-perfect}.
By Lemma \ref{perfect-lemma-compute-ext-perfect} and its proof and
...
$$
\begin{array}{ccc} & \Ext^i_{\mathcal{O}_X}(E,
\mathcal{G}^\bullet \otimes_{\mathcal{O}_X} f^*\mathcal{F})
\swarrow\searrow &  \\ H^i(S, K_{n + 1} \otimes_{\mathcal{O}_S}^\mathbf{L} \mathcal{F})
\longrightarrow &  & H^i(S, K_n \otimes_{\mathcal{O}_S}^\mathbf{L} \mathcal{F})\end{array}
$$
...
Lemma \ref{perfect-lemma-pseudo-coherent-hocolim}. The mapping property
...
\begin{remark}[Base change of L]
\label{perfect-remark-base-change-of-L}
\source{stacks:0DJS}
\href{https://stacks.math.columbia.edu/tag/0DJS}{\texttt{Stacks tag 0DJS}}
\group{perfect}

\uses{perfect-lemma-compute-ext}
The pseudo-coherent complex $L$ of part (B) of Lemma \ref{perfect-lemma-compute-ext}
...
\begin{definition}[Situation: Descent]
\label{perfect-situation-descent}
\source{stacks:09RD}
\href{https://stacks.math.columbia.edu/tag/09RD}{\texttt{Stacks tag 09RD}}
\group{perfect}
...
\begin{lemma}[Descend homomorphisms]
\label{perfect-lemma-descend-homomorphisms}
\source{stacks:09RE}
\href{https://stacks.math.columbia.edu/tag/09RE}{\texttt{Stacks tag 09RE}}
\group{perfect}

\uses{perfect-situation-descent}
In Situation \ref{perfect-situation-descent}.
...
\begin{proof}
\uses{perfect-lemma-affine-compare-bounded, perfect-lemma-perfect-affine, perfect-lemma-pseudo-coherent-affine, perfect-lemma-tor-dimension-affine}
...
$S = \Spec(A)$. We will use Lemma \ref{perfect-lemma-affine-compare-bounded}
without further mention.

\medskip\noindent
In case (1) the object $E_0^\bullet$ corresponds to a finite complex
of finite projective $A_0$-modules, see Lemma \ref{perfect-lemma-perfect-affine}.
...
see Lemma \ref{perfect-lemma-pseudo-coherent-affine}.
We may represent $K_0$ by a finite complex $K_0^\bullet$
of flat $A_0$-modules, see Lemma \ref{perfect-lemma-tor-dimension-affine}
and
More on Algebra, Lemma \ref{more-algebra-lemma-tor-amplitude}.
...
\begin{lemma}[Descend perfect]
\label{perfect-lemma-descend-perfect}
\source{stacks:09RF}
\href{https://stacks.math.columbia.edu/tag/09RF}{\texttt{Stacks tag 09RF}}
\group{perfect}

\uses{perfect-situation-descent}
In Situation \ref{perfect-situation-descent} the category of perfect
objects of $D(\mathcal{O}_S)$ is the colimit of the categories
of perfect objects of $D(\mathcal{O}_{S_i})$.
\end{lemma}

\begin{proof}
\uses{perfect-lemma-descend-homomorphisms, perfect-lemma-affine-compare-bounded, perfect-lemma-perfect-affine}
...
by Lemma \ref{perfect-lemma-descend-homomorphisms}. Thus it suffices to prove
...
$S = \Spec(A)$. Using Lemmas \ref{perfect-lemma-affine-compare-bounded}
and \ref{perfect-lemma-perfect-affine} we see that we have to show that
$$
...
\ref{perfect-section-cohomology-base-change}, and
\ref{perfect-section-producing-perfect}.
An easy to grok special case is given in
Remark \ref{perfect-remark-explain-perfect-direct-image}.

\begin{lemma}[Base change tensor perfect]
\label{perfect-lemma-base-change-tensor-perfect}
\source{stacks:0A1H}
\href{https://stacks.math.columbia.edu/tag/0A1H}{\texttt{Stacks tag 0A1H}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-base-change-tensor, perfect-lemma-tensor-perfect, perfect-lemma-descend-perfect}

The statement on base change is Lemma \ref{perfect-lemma-base-change-tensor}.
Thus it suffices to show that $K$ is a perfect object. If $S$ is
Noetherian, then this follows from
Lemma \ref{perfect-lemma-tensor-perfect}.
...
Lemma \ref{perfect-lemma-base-change-tensor-perfect}
...
\begin{lemma}[Base change tensor pseudo coherent]
\label{perfect-lemma-base-change-tensor-pseudo-coherent}
\source{stacks:0CSC}
\href{https://stacks.math.columbia.edu/tag/0CSC}{\texttt{Stacks tag 0CSC}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-base-change-tensor, perfect-lemma-base-change-tensor-perfect, perfect-lemma-quasi-coherence-direct-image, perfect-theorem-approximation}

The statement on base change is Lemma \ref{perfect-lemma-base-change-tensor}.
Thus it suffices to show that $K$ is a pseudo-coherent object.
This will follow from Lemma \ref{perfect-lemma-base-change-tensor-perfect}
...
$$
is an isomorphism on cohomology sheaves in degrees $\geq m$.
By Lemma \ref{perfect-lemma-base-change-tensor-perfect} the source
is a perfect complex.
We conclude that $K$ is $m$-pseudo-coherent as desired.
\end{proof}

\begin{lemma}[Flat proper perfect direct image general]
\label{perfect-lemma-flat-proper-perfect-direct-image-general}
\source{stacks:0B91}
\href{https://stacks.math.columbia.edu/tag/0B91}{\texttt{Stacks tag 0B91}}
\group{perfect}
...
Special cases of
Lemma \ref{perfect-lemma-base-change-tensor-perfect} applied with
...
\begin{lemma}[Flat proper pseudo coherent direct image general]
\label{perfect-lemma-flat-proper-pseudo-coherent-direct-image-general}
\source{stacks:0CSD}
\href{https://stacks.math.columbia.edu/tag/0CSD}{\texttt{Stacks tag 0CSD}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-base-change-tensor-pseudo-coherent}

Special case of
Lemma \ref{perfect-lemma-base-change-tensor-pseudo-coherent} applied with
$\mathcal{G}^\bullet$ equal to $\mathcal{O}_X$ in degree $0$.
\end{proof}

\begin{lemma}[Pullback and limits]
\label{perfect-lemma-pullback-and-limits}
\source{stacks:0D2Q}
\href{https://stacks.math.columbia.edu/tag/0D2Q}{\texttt{Stacks tag 0D2Q}}
\group{perfect}
...
\begin{proof}
\uses{perfect-theorem-bondal-van-den-Bergh, perfect-lemma-Rlim-quasi-coherent, perfect-lemma-cohomology-base-change, perfect-lemma-flat-proper-perfect-direct-image-general}
...
a perfect generator (Theorem \ref{perfect-theorem-bondal-van-den-Bergh})
it suffices to check this for perfect $E$.
By Lemma \ref{perfect-lemma-Rlim-quasi-coherent} we have
...
$$
by Lemma \ref{perfect-lemma-cohomology-base-change}.
From Lemma \ref{perfect-lemma-flat-proper-perfect-direct-image-general}
...
\begin{lemma}[Base change RHom perfect]
\label{perfect-lemma-base-change-RHom-perfect}
\source{stacks:0A1J}
\href{https://stacks.math.columbia.edu/tag/0A1J}{\texttt{Stacks tag 0A1J}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-base-change-RHom, perfect-lemma-ext-perfect, perfect-lemma-descend-perfect}

The statement on base change is Lemma \ref{perfect-lemma-base-change-RHom}.
Thus it suffices to show that $K$ is a perfect object. If $S$ is
Noetherian, then this follows from
Lemma \ref{perfect-lemma-ext-perfect}.
We will reduce to this case by Noetherian approximation.
We encourage the reader to skip the rest of this proof.
...
we may, after increasing $i$, assume there exists a perfect
object $E_i$ of $D(\mathcal{O}_{X_i})$ whose pullback to
$X$ is $E$. Applying Lemma \ref{perfect-lemma-ext-perfect}
to $X_i \to \Spec(R_i)$, $E_i$, $\mathcal{G}_i^\bullet$ and using the
base change property already shown we obtain the result.
\end{proof}
...
\begin{lemma}[Jump loci]
\label{perfect-lemma-jump-loci}
\source{stacks:0BDI}
\href{https://stacks.math.columbia.edu/tag/0BDI}{\texttt{Stacks tag 0BDI}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-lift-pseudo-coherent, perfect-lemma-affine-compare-bounded, perfect-lemma-perfect-affine}

Consider a morphism of schemes $f : Y \to X$ and a point $y \in Y$.
Let $x$ be the image of $y$ and consider the commutative diagram
$$
\begin{array}{cc}y \underset{j}{\longrightarrow}\underset{g}{\downarrow} & Y \overset{f}{\downarrow} \\ x \overset{i}{\longrightarrow} & X\end{array}
$$
...
of finite free modules (Lemma \ref{perfect-lemma-lift-pseudo-coherent}).
...
\begin{lemma}[Chi locally constant]
\label{perfect-lemma-chi-locally-constant}
\source{stacks:0BDJ}
\href{https://stacks.math.columbia.edu/tag/0BDJ}{\texttt{Stacks tag 0BDJ}}
\group{perfect}
...
\begin{lemma}[Open where cohomology in degree i rank r]
\label{perfect-lemma-open-where-cohomology-in-degree-i-rank-r}
\source{stacks:0BDK}
\href{https://stacks.math.columbia.edu/tag/0BDK}{\texttt{Stacks tag 0BDK}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-jump-loci}

Let $\beta_j : X \to \{0, 1, 2, \ldots\}$ for $j \in \mathbf{Z}$
be the functions of Lemma \ref{perfect-lemma-jump-loci}. Then the set
$$
...
\begin{lemma}[Locally closed where H0 locally free]
\label{perfect-lemma-locally-closed-where-H0-locally-free}
\source{stacks:0BDL}
\href{https://stacks.math.columbia.edu/tag/0BDL}{\texttt{Stacks tag 0BDL}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-jump-loci, perfect-lemma-affine-compare-bounded, perfect-lemma-perfect-affine}

First, let $U \subset X$ be the locally constructible
open subscheme where the function
$\beta_a$ of Lemma \ref{perfect-lemma-jump-loci} has values $\leq r$.
Let $f : Y \to X$ be as in (2). Then for any $y \in Y$
we have $\beta_a(Lf^*E) = r$ hence $y$ maps into $U$ by
Lemma \ref{perfect-lemma-jump-loci}. Hence $f$ as in (2) factors through $U$.
...
(Lemma \ref{perfect-lemma-jump-loci}). In this way we
...
(This also uses earlier results to turn the problem into algebra, for example
Lemmas \ref{perfect-lemma-affine-compare-bounded} and
\ref{perfect-lemma-perfect-affine}.) Now, if $g : Y \to U$ is any morphism
...
\begin{lemma}[Jump loci geometric]
\label{perfect-lemma-jump-loci-geometric}
\source{stacks:0BDN}
\href{https://stacks.math.columbia.edu/tag/0BDN}{\texttt{Stacks tag 0BDN}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-flat-proper-perfect-direct-image-general, perfect-lemma-jump-loci}
...
$$
Thus the lemma follows from
Lemma \ref{perfect-lemma-jump-loci}.
\end{proof}

\begin{lemma}[Chi locally constant geometric]
\label{perfect-lemma-chi-locally-constant-geometric}
\source{stacks:0B9T}
\href{https://stacks.math.columbia.edu/tag/0B9T}{\texttt{Stacks tag 0B9T}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-flat-proper-perfect-direct-image-general, perfect-lemma-chi-locally-constant}
...
$$
is locally constant on $S$. This is Lemma \ref{perfect-lemma-chi-locally-constant}.
\end{proof}

\begin{lemma}[Open where cohomology in degree i rank r geometric]
\label{perfect-lemma-open-where-cohomology-in-degree-i-rank-r-geometric}
\source{stacks:0B9S}
\href{https://stacks.math.columbia.edu/tag/0B9S}{\texttt{Stacks tag 0B9S}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-flat-proper-perfect-direct-image-general, perfect-lemma-open-where-cohomology-in-degree-i-rank-r}
...
Lemma \ref{perfect-lemma-open-where-cohomology-in-degree-i-rank-r}.
\end{proof}

\begin{lemma}[Vanishing implies locally free]
\label{perfect-lemma-vanishing-implies-locally-free}
\source{stacks:0D4E}
\href{https://stacks.math.columbia.edu/tag/0D4E}{\texttt{Stacks tag 0D4E}}
\group{perfect}
...
By Lemma \ref{perfect-lemma-base-change-tensor-perfect}
...
\begin{lemma}[Proper flat h0]
\label{perfect-lemma-proper-flat-h0}
\source{stacks:0E62}
\href{https://stacks.math.columbia.edu/tag/0E62}{\texttt{Stacks tag 0E62}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-flat-proper-perfect-direct-image-general}
...
\begin{lemma}[Proper flat geom red connected]
\label{perfect-lemma-proper-flat-geom-red-connected}
\source{stacks:0E0L}
\href{https://stacks.math.columbia.edu/tag/0E0L}{\texttt{Stacks tag 0E0L}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-proper-flat-h0}

By Lemma \ref{perfect-lemma-proper-flat-h0}
...
\begin{lemma}[Proper idempotent on fibre]
\label{perfect-lemma-proper-idempotent-on-fibre}
\source{stacks:0G7X}
\href{https://stacks.math.columbia.edu/tag/0G7X}{\texttt{Stacks tag 0G7X}}
\group{perfect}
...
\source{stacks:0G7Y}
\href{https://stacks.math.columbia.edu/tag/0G7Y}{\texttt{Stacks tag 0G7Y}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-proper-flat-h0, perfect-lemma-flat-proper-perfect-direct-image-general, perfect-lemma-proper-idempotent-on-fibre}

The proof of this lemma is similar to the proof of
Lemma \ref{perfect-lemma-proper-flat-h0}
...
\ref{varieties-lemma-proper-geometrically-reduced-global-sections}.
Since by Lemma \ref{perfect-lemma-proper-idempotent-on-fibre}
...
\begin{lemma}[Cohomology over coherent ring]
\label{perfect-lemma-cohomology-over-coherent-ring}
\source{stacks:0EX6}
\href{https://stacks.math.columbia.edu/tag/0EX6}{\texttt{Stacks tag 0EX6}}
\group{perfect}
...
Combine Lemma \ref{perfect-lemma-base-change-tensor-perfect} with
More on Algebra, Lemmas \ref{more-algebra-lemma-coherent-pseudo-coherent} and
\ref{more-algebra-lemma-perfect}.
\end{proof}

\begin{lemma}[Countable cohomology]
\label{perfect-lemma-countable-cohomology}
\source{stacks:0CRP}
\href{https://stacks.math.columbia.edu/tag/0CRP}{\texttt{Stacks tag 0CRP}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-affine-compare-bounded, perfect-lemma-perfect-affine, perfect-lemma-quasi-coherence-tensor-product}
...
See Lemmas \ref{perfect-lemma-affine-compare-bounded} and
\ref{perfect-lemma-perfect-affine}
...
(Lemma \ref{perfect-lemma-quasi-coherence-tensor-product}).
...
\begin{lemma}[Countable]
\label{perfect-lemma-countable}
\source{stacks:0CRQ}
\href{https://stacks.math.columbia.edu/tag/0CRQ}{\texttt{Stacks tag 0CRQ}}
\group{perfect}
...
\begin{proof}
\uses{perfect-theorem-DQCoh-is-Ddga, perfect-lemma-countable-cohomology}
...
According to Theorem \ref{perfect-theorem-DQCoh-is-Ddga}
...
This follows from Lemma \ref{perfect-lemma-countable-cohomology}.
\end{proof}

\begin{lemma}[Computing sections as colim]
\label{perfect-lemma-computing-sections-as-colim}
\source{stacks:0CRR}
\href{https://stacks.math.columbia.edu/tag/0CRR}{\texttt{Stacks tag 0CRR}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-cohomology-base-change, perfect-lemma-quasi-coherence-pushforward-direct-sums, perfect-lemma-compare-base-change, perfect-lemma-countable, perfect-lemma-countable-cohomology}

By Lemma \ref{perfect-lemma-cohomology-base-change} we have
$$
...
By Lemma \ref{perfect-lemma-compare-base-change}
...
colimit of perfect complexes. To see this we apply Lemma \ref{perfect-lemma-countable}.
...
\begin{lemma}[Pseudo coherent over algebra]
\label{perfect-lemma-pseudo-coherent-over-algebra}
\source{stacks:0CSF}
\href{https://stacks.math.columbia.edu/tag/0CSF}{\texttt{Stacks tag 0CSF}}
\group{perfect}
...
Picture:
$$
\begin{array}{cccc} & F^m \overset{\alpha}{\downarrow}\longrightarrow & 0 \downarrow\longrightarrow & \ldots \\ M^{m - 1} \longrightarrow & M^m \longrightarrow & M^{m + 1} \longrightarrow & \ldots\end{array}
$$
...
$$
\begin{array}{ccccccc} & F^n \longrightarrow\overset{\alpha}{\downarrow} & F^{n + 1} \overset{\alpha}{\downarrow}\longrightarrow & \ldots \longrightarrow & F^i \overset{\alpha}{\downarrow}\longrightarrow & 0 \downarrow\longrightarrow & \ldots \\ M^{n - 1} \longrightarrow & M^n \longrightarrow & M^{n + 1} \longrightarrow & \ldots \longrightarrow & M^i \longrightarrow & M^{i + 1} \longrightarrow & \ldots\end{array}
$$
...
\begin{lemma}[Pseudo coherent on projective space]
\label{perfect-lemma-pseudo-coherent-on-projective-space}
\source{stacks:0CSG}
\href{https://stacks.math.columbia.edu/tag/0CSG}{\texttt{Stacks tag 0CSG}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-flat-proper-pseudo-coherent-direct-image-general, perfect-lemma-Pn-module-category, perfect-lemma-pseudo-coherent-over-algebra}
...
By Lemma \ref{perfect-lemma-flat-proper-pseudo-coherent-direct-image-general}
...
$R$ as in (\ref{equation-algebra-for-Pn}).
By Lemma \ref{perfect-lemma-Pn-module-category} we have an equivalence
$$
...
By Lemma \ref{perfect-lemma-pseudo-coherent-over-algebra}
...
\begin{lemma}[Perfect enough]
\label{perfect-lemma-perfect-enough}
\source{stacks:0CSH}
\href{https://stacks.math.columbia.edu/tag/0CSH}{\texttt{Stacks tag 0CSH}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-quasi-coherence-direct-image, perfect-theorem-approximation}
...
\source{stacks:0DI0}
\href{https://stacks.math.columbia.edu/tag/0DI0}{\texttt{Stacks tag 0DI0}}
\group{perfect}
...
Please see Remark \ref{perfect-remark-discuss-rel-perfect} for a discussion.

\begin{example}[Relatively perfect field]
\label{perfect-example-relatively-perfect-field}
\source{stacks:0DI1}
\href{https://stacks.math.columbia.edu/tag/0DI1}{\texttt{Stacks tag 0DI1}}
\group{perfect}

\uses{perfect-lemma-identify-pseudo-coherent-noetherian}
...
\source{stacks:0DI2}
\href{https://stacks.math.columbia.edu/tag/0DI2}{\texttt{Stacks tag 0DI2}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-affine-compare-bounded, perfect-lemma-pseudo-coherent-affine, perfect-lemma-tor-dimension-rel-affine}
...
By Lemma \ref{perfect-lemma-pseudo-coherent-affine}
we see that $E$ is pseudo-coherent if and only if
$K$ is pseudo-coherent.
By Lemma \ref{perfect-lemma-tor-dimension-rel-affine} we see that
...
\source{stacks:0DI3}
\href{https://stacks.math.columbia.edu/tag/0DI3}{\texttt{Stacks tag 0DI3}}
\group{perfect}
...
\source{stacks:0DI4}
\href{https://stacks.math.columbia.edu/tag/0DI4}{\texttt{Stacks tag 0DI4}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-affine-locally-rel-perfect}
...
\source{stacks:0DI5}
\href{https://stacks.math.columbia.edu/tag/0DI5}{\texttt{Stacks tag 0DI5}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-affine-locally-rel-perfect, perfect-lemma-tor-independence-and-tor-amplitude}
...
Lemma \ref{perfect-lemma-tor-independence-and-tor-amplitude}.
\end{proof}

\begin{definition}[Situation: Relative descent]
\label{perfect-situation-relative-descent}
\source{stacks:0DI6}
\href{https://stacks.math.columbia.edu/tag/0DI6}{\texttt{Stacks tag 0DI6}}
\group{perfect}
...
\source{stacks:0DI7}
\href{https://stacks.math.columbia.edu/tag/0DI7}{\texttt{Stacks tag 0DI7}}
\group{perfect}

\uses{perfect-situation-relative-descent}
In Situation \ref{perfect-situation-relative-descent}.
...
\begin{proof}
\uses{perfect-lemma-pseudo-coherent, perfect-lemma-affine-compare-bounded, perfect-lemma-pseudo-coherent-affine, perfect-lemma-tor-dimension-rel-affine}
...
Namely, by Lemmas \ref{perfect-lemma-pseudo-coherent} and
...
Lemma \ref{perfect-lemma-tor-dimension-rel-affine}
...
\source{stacks:0DI8}
\href{https://stacks.math.columbia.edu/tag/0DI8}{\texttt{Stacks tag 0DI8}}
\group{perfect}

\uses{perfect-situation-relative-descent}
In Situation \ref{perfect-situation-relative-descent} the category of
$S$-perfect objects of $D(\mathcal{O}_X)$ is the colimit of the categories
of $S_i$-perfect objects of $D(\mathcal{O}_{X_i})$.
\end{lemma}

\begin{proof}
\uses{perfect-lemma-relative-descend-homomorphisms, perfect-lemma-affine-locally-rel-perfect}
...
by Lemma \ref{perfect-lemma-relative-descend-homomorphisms}. Thus it suffices to prove
essential surjectivity.
...
the proof of Lemma \ref{perfect-lemma-relative-descend-homomorphisms}
...
\source{stacks:0DJT}
\href{https://stacks.math.columbia.edu/tag/0DJT}{\texttt{Stacks tag 0DJT}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-compare-base-change, perfect-lemma-descend-relatively-perfect, perfect-lemma-perfect-direct-image}

The statement on base change is Lemma \ref{perfect-lemma-compare-base-change}.
...
By Lemma \ref{perfect-lemma-descend-relatively-perfect}
we may assume there exists a $R_i$-perfect object $E_i$ of
$D(\mathcal{O}_{X_i})$ whose pullback to $X$ is $E$.
Applying Lemma \ref{perfect-lemma-perfect-direct-image}
...
\source{stacks:0DJU}
\href{https://stacks.math.columbia.edu/tag/0DJU}{\texttt{Stacks tag 0DJU}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-pseudo-coherent-hocolim, perfect-lemma-perfect-relatively-perfect, perfect-lemma-derived-pushforward-rel-perfect, perfect-lemma-tor-independence-and-tor-amplitude}
...
of perfect objects. By Lemma \ref{perfect-lemma-perfect-relatively-perfect}
we see that $K_n^\vee \otimes_{\mathcal{O}_X} E$ is $S$-perfect.
Thus we may apply Lemma \ref{perfect-lemma-derived-pushforward-rel-perfect}
...
any base change, see Lemma \ref{perfect-lemma-tor-independence-and-tor-amplitude}.
We find that
...
\source{stacks:0DJV}
\href{https://stacks.math.columbia.edu/tag/0DJV}{\texttt{Stacks tag 0DJV}}
\group{perfect}

\uses{perfect-lemma-compute-ext-rel-perfect, perfect-lemma-compute-ext}
The reader may have noticed the similarity between
Lemma \ref{perfect-lemma-compute-ext-rel-perfect} and
Lemma \ref{perfect-lemma-compute-ext}.
Indeed, the pseudo-coherent complex $L$ of
Lemma \ref{perfect-lemma-compute-ext-rel-perfect}
...
\source{stacks:0GEH}
\href{https://stacks.math.columbia.edu/tag/0GEH}{\texttt{Stacks tag 0GEH}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-affine-locally-rel-perfect, perfect-lemma-compare-base-change}
...
\begin{remark}[Discuss rel perfect]
\label{perfect-remark-discuss-rel-perfect}
\source{stacks:0DI9}
\href{https://stacks.math.columbia.edu/tag/0DI9}{\texttt{Stacks tag 0DI9}}
\group{perfect}

\uses{perfect-definition-relatively-perfect, perfect-lemma-affine-locally-rel-perfect}
Our Definition \ref{perfect-definition-relatively-perfect} of a
...
see this, use Lemma \ref{perfect-lemma-affine-locally-rel-perfect} and
...
Definition \ref{perfect-definition-relatively-perfect} is
\begin{enumerate}
...
\begin{definition}[Resolution property]
\label{perfect-definition-resolution-property}
\source{stacks:0F86}
\href{https://stacks.math.columbia.edu/tag/0F86}{\texttt{Stacks tag 0F86}}
\group{perfect}
...
\begin{lemma}[Resolution property ample]
\label{perfect-lemma-resolution-property-ample}
\source{stacks:0F87}
\href{https://stacks.math.columbia.edu/tag/0F87}{\texttt{Stacks tag 0F87}}
\group{perfect}
...
\begin{lemma}[Resolution property ample relative]
\label{perfect-lemma-resolution-property-ample-relative}
\source{stacks:0FDD}
\href{https://stacks.math.columbia.edu/tag/0FDD}{\texttt{Stacks tag 0FDD}}
\group{perfect}
...
\begin{lemma}[Resolution property goes up affine]
\label{perfect-lemma-resolution-property-goes-up-affine}
\source{stacks:0F88}
\href{https://stacks.math.columbia.edu/tag/0F88}{\texttt{Stacks tag 0F88}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-resolution-property-ample-relative}
...
\begin{lemma}[Resolution property goes down finite flat]
\label{perfect-lemma-resolution-property-goes-down-finite-flat}
\source{stacks:0GTC}
\href{https://stacks.math.columbia.edu/tag/0GTC}{\texttt{Stacks tag 0GTC}}
\group{perfect}
...
\begin{lemma}[Resolution property finite number]
\label{perfect-lemma-resolution-property-finite-number}
\source{stacks:0F89}
\href{https://stacks.math.columbia.edu/tag/0F89}{\texttt{Stacks tag 0F89}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-resolution-property-goes-up-affine}
...
Lemma \ref{perfect-lemma-resolution-property-goes-up-affine}.
...
\begin{lemma}[Resolution property ample family]
\label{perfect-lemma-resolution-property-ample-family}
\source{stacks:0GMM}
\href{https://stacks.math.columbia.edu/tag/0GMM}{\texttt{Stacks tag 0GMM}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-resolution-property-finite-number}
...
Applying Lemma \ref{perfect-lemma-resolution-property-finite-number}
we find that $X$ has the resolution property.
\end{proof}

\begin{lemma}[Regular resolution property]
\label{perfect-lemma-regular-resolution-property}
\source{stacks:0F8A}
\href{https://stacks.math.columbia.edu/tag/0F8A}{\texttt{Stacks tag 0F8A}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-resolution-property-ample-family}

Combine Divisors, Lemma \ref{divisors-lemma-regular-ample-family} and the above
Lemma \ref{perfect-lemma-resolution-property-ample-family}.
\end{proof}

\begin{lemma}[Resolution property descends]
\label{perfect-lemma-resolution-property-descends}
\source{stacks:0F8B}
\href{https://stacks.math.columbia.edu/tag/0F8B}{\texttt{Stacks tag 0F8B}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-resolution-property-goes-up-affine, perfect-lemma-resolution-property-finite-number}
...
by Lemma \ref{perfect-lemma-resolution-property-finite-number}.
\end{proof}

\begin{lemma}[Resolution property affine diagonal]
\label{perfect-lemma-resolution-property-affine-diagonal}
\source{stacks:0F8C}
\href{https://stacks.math.columbia.edu/tag/0F8C}{\texttt{Stacks tag 0F8C}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-resolution-property-descends, perfect-proposition-Noetherian}

Combining Limits, Proposition \ref{limits-proposition-approximate}
and Lemma \ref{perfect-lemma-resolution-property-descends}
...
By Proposition \ref{perfect-proposition-Noetherian} (this is where we use
...
\begin{lemma}[Construct strictly perfect]
\label{perfect-lemma-construct-strictly-perfect}
\source{stacks:0F8E}
\href{https://stacks.math.columbia.edu/tag/0F8E}{\texttt{Stacks tag 0F8E}}
\group{perfect}
...
$$
\begin{array}{ccccc}\ldots \longrightarrow & \mathcal{E}^{b - 2} \longrightarrow\downarrow & \mathcal{E}^{b - 1} \longrightarrow\downarrow & 0 \longrightarrow\downarrow & \ldots \\ \ldots \longrightarrow & \mathcal{F}^{b - 2} \longrightarrow & \mathcal{F}^{b - 1} \oplus \mathcal{E}^b \longrightarrow & \mathcal{F}^b \longrightarrow & \ldots\end{array}
$$
...
\begin{lemma}[Resolution property perfect complex]
\label{perfect-lemma-resolution-property-perfect-complex}
\source{stacks:0F8F}
\href{https://stacks.math.columbia.edu/tag/0F8F}{\texttt{Stacks tag 0F8F}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-resolution-property-affine-diagonal, perfect-proposition-quasi-compact-affine-diagonal, perfect-lemma-construct-strictly-perfect}

Let $E$ be a perfect object of $D(\mathcal{O}_X)$.
By Lemma \ref{perfect-lemma-resolution-property-affine-diagonal}
...
Lemma \ref{perfect-lemma-construct-strictly-perfect} to conclude.
\end{proof}

\begin{lemma}[Resolution property map perfect complex]
\label{perfect-lemma-resolution-property-map-perfect-complex}
\source{stacks:0F8G}
\href{https://stacks.math.columbia.edu/tag/0F8G}{\texttt{Stacks tag 0F8G}}
\group{perfect}
...
\begin{lemma}[Resolution property homotopy map perfect complex]
\label{perfect-lemma-resolution-property-homotopy-map-perfect-complex}
\source{stacks:0F8H}
\href{https://stacks.math.columbia.edu/tag/0F8H}{\texttt{Stacks tag 0F8H}}
\group{perfect}
...
Then we may apply Lemma \ref{perfect-lemma-construct-strictly-perfect} to conclude.
\end{proof}

\begin{proposition}[Perfect resolution property]
\label{perfect-proposition-perfect-resolution-property}
\source{stacks:0F8I}
\href{https://stacks.math.columbia.edu/tag/0F8I}{\texttt{Stacks tag 0F8I}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-resolution-property-perfect-complex, perfect-lemma-resolution-property-map-perfect-complex, perfect-lemma-resolution-property-homotopy-map-perfect-complex}
...
By Lemmas \ref{perfect-lemma-resolution-property-perfect-complex},
\ref{perfect-lemma-resolution-property-map-perfect-complex}, and
...
\begin{lemma}[Noetherian Kprime]
\label{perfect-lemma-Noetherian-Kprime}
\source{stacks:0FDF}
\href{https://stacks.math.columbia.edu/tag/0FDF}{\texttt{Stacks tag 0FDF}}
\group{perfect}
...
by Proposition \ref{perfect-proposition-DCoh} to see the second
equality.)
\end{proof}
...
\source{stacks:0FDG}
\href{https://stacks.math.columbia.edu/tag/0FDG}{\texttt{Stacks tag 0FDG}}
\group{perfect}
...
See Lemma \ref{perfect-lemma-K-is-old-K}.

\begin{lemma}[K agrees affine]
\label{perfect-lemma-K-agrees-affine}
\source{stacks:0FDH}
\href{https://stacks.math.columbia.edu/tag/0FDH}{\texttt{Stacks tag 0FDH}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-perfect-affine, perfect-lemma-affine-compare-bounded}
...
By Lemmas \ref{perfect-lemma-perfect-affine} and \ref{perfect-lemma-affine-compare-bounded}
...
(by Lemma \ref{perfect-lemma-identify-pseudo-coherent-noetherian}), the inclusion
functor
...
Lemma \ref{perfect-lemma-Noetherian-Kprime}.

\begin{lemma}[Kprime K]
\label{perfect-lemma-Kprime-K}
\source{stacks:0FDI}
\href{https://stacks.math.columbia.edu/tag/0FDI}{\texttt{Stacks tag 0FDI}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-perfect-on-regular}

Follows immediately from Lemma \ref{perfect-lemma-perfect-on-regular}
...
\begin{lemma}[K is old K]
\label{perfect-lemma-K-is-old-K}
\source{stacks:0FDJ}
\href{https://stacks.math.columbia.edu/tag/0FDJ}{\texttt{Stacks tag 0FDJ}}
\group{perfect}
...
Lemmas \ref{perfect-lemma-resolution-property-perfect-complex},
\ref{perfect-lemma-resolution-property-map-perfect-complex}, and
\ref{perfect-lemma-resolution-property-homotopy-map-perfect-complex}
...
\source{stacks:0FDK}
\href{https://stacks.math.columbia.edu/tag/0FDK}{\texttt{Stacks tag 0FDK}}
\group{perfect}

\uses{perfect-lemma-Noetherian-Kprime}
...
\begin{remark}[Pushforward K]
\label{perfect-remark-pushforward-K}
\source{stacks:0FDL}
\href{https://stacks.math.columbia.edu/tag/0FDL}{\texttt{Stacks tag 0FDL}}
\group{perfect}
...
\source{stacks:0FDM}
\href{https://stacks.math.columbia.edu/tag/0FDM}{\texttt{Stacks tag 0FDM}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-cohomology-base-change, perfect-remark-pushforward-K, perfect-remark-K-ring}

Follows from Lemma \ref{perfect-lemma-cohomology-base-change}, the discussion in
Remark \ref{perfect-remark-pushforward-K}, and the definition of the product
$K'_0(X) \times K_0(X) \to K'_0(X)$ in Remark \ref{perfect-remark-K-ring}.
\end{proof}

\begin{remark}[Perf Z]
\label{perfect-remark-perf-Z}
\source{stacks:0FDN}
\href{https://stacks.math.columbia.edu/tag/0FDN}{\texttt{Stacks tag 0FDN}}
\group{perfect}

\uses{perfect-remark-K-ring}
...
as in Remark \ref{perfect-remark-K-ring} we see that $K_0(D_{Z, perf}(\mathcal{O}_X))$
...
\begin{lemma}[Determinant two term complexes]
\label{perfect-lemma-determinant-two-term-complexes}
\source{stacks:0FJX}
\href{https://stacks.math.columbia.edu/tag/0FJX}{\texttt{Stacks tag 0FJX}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-affine-compare-bounded, perfect-lemma-tor-dimension-affine, perfect-lemma-perfect-affine, perfect-lemma-quasi-coherence-pullback}
...
(see Lemma \ref{perfect-lemma-quasi-coherence-pullback} and note $A \to B$ is flat).
...
\begin{remark}[Functorial det]
\label{perfect-remark-functorial-det}
\source{stacks:0FJY}
\href{https://stacks.math.columbia.edu/tag/0FJY}{\texttt{Stacks tag 0FJY}}
\group{perfect}

\uses{perfect-lemma-determinant-two-term-complexes}
The construction of Lemma \ref{perfect-lemma-determinant-two-term-complexes}
...
Section \ref{perfect-section-generating}, have a special property.
We recommend reading that section first as it is very similar to this one.

\begin{lemma}[Orthogonal koszul first variant]
\label{perfect-lemma-orthogonal-koszul-first-variant}
\source{stacks:0GEJ}
\href{https://stacks.math.columbia.edu/tag/0GEJ}{\texttt{Stacks tag 0GEJ}}
\group{perfect}
...
$A$-modules $R\Gamma(X, N)$, see Lemma \ref{perfect-lemma-affine-compare-bounded}.
Thus we find that our lemma is true.
\end{proof}

\begin{lemma}[Orthogonal koszul second variant]
\label{perfect-lemma-orthogonal-koszul-second-variant}
\source{stacks:0GEK}
\href{https://stacks.math.columbia.edu/tag/0GEK}{\texttt{Stacks tag 0GEK}}
\group{perfect}
...
with $K_e$ as in Lemma \ref{perfect-lemma-represent-cohomology-class-on-closed}.
Since $N|_U = 0$, that lemma implies that this in turn is equivalent to
...
\begin{lemma}[Bounded truncation]
\label{perfect-lemma-bounded-truncation}
\source{stacks:0GEL}
\href{https://stacks.math.columbia.edu/tag/0GEL}{\texttt{Stacks tag 0GEL}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-ext-from-perfect-into-bounded-QCoh}
...
\begin{lemma}[Bounded below truncation]
\label{perfect-lemma-bounded-below-truncation}
\source{stacks:0GEM}
\href{https://stacks.math.columbia.edu/tag/0GEM}{\texttt{Stacks tag 0GEM}}
\group{perfect}
...
\begin{proposition}[Detecting bounded above]
\label{perfect-proposition-detecting-bounded-above}
\source{stacks:0GEN}
\href{https://stacks.math.columbia.edu/tag/0GEN}{\texttt{Stacks tag 0GEN}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-ext-from-perfect-into-bounded-QCoh, perfect-remark-classical-generator, perfect-lemma-affine-compare-bounded, perfect-lemma-direct-summand-of-a-restriction, perfect-theorem-bondal-van-den-Bergh, perfect-lemma-orthogonal-koszul-first-variant, perfect-lemma-bounded-truncation, perfect-lemma-quasi-coherence-direct-image}

Assume (1). Since
$\Hom_{D(\mathcal{O}_X)}(G[-i], E) = \Hom_{D(\mathcal{O}_X)}(G, E[i])$
we see that this is zero for $i \gg 0$ by
Lemma \ref{perfect-lemma-ext-from-perfect-into-bounded-QCoh}. This proves
that (1) implies (2).
...
Remark \ref{perfect-remark-classical-generator}.
...
see Lemma \ref{perfect-lemma-affine-compare-bounded}.
...
By Lemma \ref{perfect-lemma-direct-summand-of-a-restriction} and
Theorem \ref{perfect-theorem-bondal-van-den-Bergh} there exists a perfect
...
$U$ and to $V$). Hence using Lemma \ref{perfect-lemma-bounded-truncation}
twice we see that
$$
...
(by Lemma \ref{perfect-lemma-quasi-coherence-direct-image}), we get
$\tau_{\geq a}E \in D^-_\QCoh(\mathcal{O}_X)$. Thus
$E \in D^-_\QCoh (\mathcal{O}_X)$.
\end{proof}

\begin{proposition}[Detecting bounded below]
\label{perfect-proposition-detecting-bounded-below}
\source{stacks:0GEQ}
\href{https://stacks.math.columbia.edu/tag/0GEQ}{\texttt{Stacks tag 0GEQ}}
\group{perfect}
...
\begin{proof}
\uses{perfect-lemma-ext-from-perfect-into-bounded-QCoh, perfect-remark-classical-generator, perfect-lemma-affine-compare-bounded, perfect-lemma-direct-summand-of-a-restriction, perfect-theorem-bondal-van-den-Bergh, perfect-lemma-orthogonal-koszul-second-variant, perfect-lemma-bounded-below-truncation}
...
determined by $R\Gamma (X, E)$, see Lemma \ref{perfect-lemma-affine-compare-bounded}.
...
Lemma \ref{perfect-lemma-orthogonal-koszul-second-variant} to $E|_V$ to
obtain an integer $a$ such that
$\tau_{\leq a}(E|_V) = \tau_{\leq a} R(U \cap V \to V)_*(E|_{U \cap V})$.
Then $\tau_{\leq a} E = \tau_{\leq a} R(U \to X)_*(E|_U)$
(check that the canonical map is an isomorphism after restricting to
$U$ and to $V$). Hence using Lemma \ref{perfect-lemma-bounded-below-truncation}
twice we see that
$$
\Hom_{D(\mathcal{O}_U)}(Q|_U [-i], E|_U) =
\Hom_{D(\mathcal{O}_X)}(Q[-i], R (U \to X)_* (E|_U)) = 0
...
\begin{lemma}[DQCoh alternative small]
\label{perfect-lemma-DQCoh-alternative-small}
\source{stacks:0GZZ}
\href{https://stacks.math.columbia.edu/tag/0GZZ}{\texttt{Stacks tag 0GZZ}}
\group{perfect}
...
\begin{remark}[QC compare]
\label{perfect-remark-QC-compare}
\source{stacks:0H00}
\href{https://stacks.math.columbia.edu/tag/0H00}{\texttt{Stacks tag 0H00}}
\group{perfect}
