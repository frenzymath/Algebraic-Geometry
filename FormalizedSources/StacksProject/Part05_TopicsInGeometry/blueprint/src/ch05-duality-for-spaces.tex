...
\source{stacks:0E4Y}
\href{https://stacks.math.columbia.edu/tag/0E4Y}{\texttt{Stacks tag 0E4Y}}
\group{spaces-duality}
...
\source{stacks:0E4Z}
\href{https://stacks.math.columbia.edu/tag/0E4Z}{\texttt{Stacks tag 0E4Z}}
\group{spaces-duality}
...
Lemma \ref{spaces-duality-lemma-equivalent-definitions}.
\end{definition}

\begin{lemma}[Affine duality]
\label{spaces-duality-lemma-affine-duality}
\source{stacks:0E50}
\href{https://stacks.math.columbia.edu/tag/0E50}{\texttt{Stacks tag 0E50}}
\group{spaces-duality}
...
\begin{lemma}[Dualizing spaces]
\label{spaces-duality-lemma-dualizing-spaces}
\source{stacks:0E51}
\href{https://stacks.math.columbia.edu/tag/0E51}{\texttt{Stacks tag 0E51}}
\group{spaces-duality}
...
as in Lemma \ref{spaces-duality-lemma-equivalent-definitions} and
Duality for Schemes, Lemma \ref{duality-lemma-equivalent-definitions}.
By Lemma \ref{spaces-duality-lemma-affine-duality} the diagram
$$
\begin{array}{cc}D_{\textit{Coh}}(A) \longrightarrow\underset{R\Hom_A(-, \omega_A^\bullet)}{\downarrow} & D_{\textit{Coh}}(\mathcal{O}_\etale)
\overset{R\SheafHom_{\mathcal{O}_\etale}(-, K|_U)}{\downarrow} \\ D_{\textit{Coh}}(A) \longrightarrow & D(\mathcal{O}_\etale)\end{array}
$$
...
\begin{lemma}[Dualizing unique spaces]
\label{spaces-duality-lemma-dualizing-unique-spaces}
\source{stacks:0E52}
\href{https://stacks.math.columbia.edu/tag/0E52}{\texttt{Stacks tag 0E52}}
\group{spaces-duality}
...
this is true. Use Lemma \ref{spaces-duality-lemma-affine-duality} and
...
\source{stacks:0E53}
\href{https://stacks.math.columbia.edu/tag/0E53}{\texttt{Stacks tag 0E53}}
\group{spaces-duality}
...
\source{stacks:0E55}
\href{https://stacks.math.columbia.edu/tag/0E55}{\texttt{Stacks tag 0E55}}
\group{spaces-duality}
...
\source{stacks:0E56}
\href{https://stacks.math.columbia.edu/tag/0E56}{\texttt{Stacks tag 0E56}}
\group{spaces-duality}

Notation and assumptions as in Lemma \ref{spaces-duality-lemma-twisted-inverse-image}.
...
\source{stacks:0E58}
\href{https://stacks.math.columbia.edu/tag/0E58}{\texttt{Stacks tag 0E58}}
\group{spaces-duality}
...
\source{stacks:0GG3}
\href{https://stacks.math.columbia.edu/tag/0GG3}{\texttt{Stacks tag 0GG3}}
\group{spaces-duality}

The statement of Lemma \ref{spaces-duality-lemma-iso-on-RSheafHom} is not true without
...
\source{stacks:0GG4}
\href{https://stacks.math.columbia.edu/tag/0GG4}{\texttt{Stacks tag 0GG4}}
\group{spaces-duality}

In the situation of Lemma \ref{spaces-duality-lemma-iso-on-RSheafHom} we have
$$
...
is bounded below, see Lemma \ref{spaces-duality-lemma-twisted-inverse-image-bounded-below}.
\end{remark}

\begin{example}[Iso on RSheafHom noetherian]
\label{spaces-duality-example-iso-on-RSheafHom-noetherian}
\source{stacks:0GG5}
\href{https://stacks.math.columbia.edu/tag/0GG5}{\texttt{Stacks tag 0GG5}}
\group{spaces-duality}
...
and the discussion in Remark \ref{spaces-duality-remark-iso-on-RSheafHom} applies.
\end{example}

\begin{lemma}[Iso global hom]
\label{spaces-duality-lemma-iso-global-hom}
\source{stacks:0E59}
\href{https://stacks.math.columbia.edu/tag/0E59}{\texttt{Stacks tag 0E59}}
\group{spaces-duality}
...
$$
Thus the lemma is a consequence of Lemma \ref{spaces-duality-lemma-iso-on-RSheafHom}.
...
(Lemma \ref{spaces-duality-lemma-twisted-inverse-image}).
...
\source{stacks:0E5C}
\href{https://stacks.math.columbia.edu/tag/0E5C}{\texttt{Stacks tag 0E5C}}
\group{spaces-duality}
...
in the middle, see Lemma \ref{spaces-duality-lemma-flat-precompose-pus}.
...
\source{stacks:0E5E}
\href{https://stacks.math.columbia.edu/tag/0E5E}{\texttt{Stacks tag 0E5E}}
\group{spaces-duality}
...
\source{stacks:0E5F}
\href{https://stacks.math.columbia.edu/tag/0E5F}{\texttt{Stacks tag 0E5F}}
\group{spaces-duality}
...
\source{stacks:0E5G}
\href{https://stacks.math.columbia.edu/tag/0E5G}{\texttt{Stacks tag 0E5G}}
\group{spaces-duality}
...
right adjoints of Lemma \ref{spaces-duality-lemma-twisted-inverse-image}
for $f$, $f'$, $f''$, $g$, $g'$, $g''$.
...
\end{matrix}
$$
By Lemma \ref{spaces-duality-lemma-compose-base-change-maps-horizontal} we have
$$
\gamma_{A + B} = \gamma_A \circ \gamma_B, \quad
\gamma_{C + D} = \gamma_C \circ \gamma_D
$$
and by Lemma \ref{spaces-duality-lemma-compose-base-change-maps} we have
$$
...
Lemmas \ref{spaces-duality-lemma-compose-base-change-maps} and
...
Section \ref{spaces-duality-section-base-change-map} is an isomorphism
in some cases.

\begin{lemma}[More base change]
\label{spaces-duality-lemma-more-base-change}
\source{stacks:0E5I}
\href{https://stacks.math.columbia.edu/tag/0E5I}{\texttt{Stacks tag 0E5I}}
\group{spaces-duality}
...
of Lemma \ref{spaces-duality-lemma-iso-global-hom}
...
$$
of Lemma \ref{spaces-duality-lemma-iso-global-hom}. Since $f$ and $g$ are
...
$g'_* \circ a' \to a \circ g_*$  of Lemma \ref{spaces-duality-lemma-flat-precompose-pus}
...
be the right adjoint as in Lemma \ref{spaces-duality-lemma-twisted-inverse-image}. By
...
\source{stacks:0E5L}
\href{https://stacks.math.columbia.edu/tag/0E5L}{\texttt{Stacks tag 0E5L}}
\group{spaces-duality}
...
which is the adjoint of $\beta$, see Lemma \ref{spaces-duality-lemma-flat-precompose-pus}
...
Lemma \ref{spaces-duality-lemma-twisted-inverse-image}. By
Categories, Section \ref{categories-section-adjoint} we obtain a
transformation of functors
$$
...
\source{stacks:0E5M}
\href{https://stacks.math.columbia.edu/tag/0E5M}{\texttt{Stacks tag 0E5M}}
\group{spaces-duality}
...
\begin{proof}
This proof is dual to the proof of Lemma \ref{spaces-duality-lemma-trace-map-and-base-change}.
In this proof we write $f_*$ for $Rf_*$ and $g^*$ for $Lg^*$ and we
drop $\star$ products with identities as one can figure out which ones
to add as long as the source and target of the transformation is known.
Recall that $\beta : g^* \circ f_* \to f'_* \circ (g')^*$ is an isomorphism
...
Lemma \ref{spaces-duality-lemma-twisted-inverse-image}. For $K, L \in D_\QCoh(\mathcal{O}_Y)$
...
\source{stacks:0E5Q}
\href{https://stacks.math.columbia.edu/tag/0E5Q}{\texttt{Stacks tag 0E5Q}}
\group{spaces-duality}
...
\source{stacks:0E5R}
\href{https://stacks.math.columbia.edu/tag/0E5R}{\texttt{Stacks tag 0E5R}}
\group{spaces-duality}
...
Lemmas \ref{spaces-duality-lemma-unit-and-base-change} and
...
\source{stacks:0E5T}
\href{https://stacks.math.columbia.edu/tag/0E5T}{\texttt{Stacks tag 0E5T}}
\group{spaces-duality}
...
Lemma \ref{spaces-duality-lemma-twisted-inverse-image}. Then $a$ commutes with direct sums.
\end{lemma}
...
\source{stacks:0E5U}
\href{https://stacks.math.columbia.edu/tag/0E5U}{\texttt{Stacks tag 0E5U}}
\group{spaces-duality}
...
\begin{proof}
By Lemma \ref{spaces-duality-lemma-proper-flat} we know that $a$ commutes
...
Lemma \ref{spaces-duality-lemma-compare-with-pullback-perfect}.
\end{proof}

\begin{lemma}[Properties relative dualizing]
\label{spaces-duality-lemma-properties-relative-dualizing}
\source{stacks:0E5V}
\href{https://stacks.math.columbia.edu/tag/0E5V}{\texttt{Stacks tag 0E5V}}
\group{spaces-duality}
...
Cohomology on Sites, Lemma \ref{sites-cohomology-lemma-dual-perfect-complex}.
For the second equality, see Lemma \ref{spaces-duality-lemma-iso-on-RSheafHom},
Remark \ref{spaces-duality-remark-iso-on-RSheafHom}, and
Derived Categories of Spaces, Lemma
\ref{spaces-perfect-lemma-flat-proper-perfect-direct-image-general}.
...
\begin{definition}[Relative dualizing proper flat]
\label{spaces-duality-definition-relative-dualizing-proper-flat}
\source{stacks:0E5X}
\href{https://stacks.math.columbia.edu/tag/0E5X}{\texttt{Stacks tag 0E5X}}
\group{spaces-duality}
...
\ref{spaces-duality-section-compare-with-pullback}, and
\ref{spaces-duality-section-proper-flat}.
\end{definition}

There are several remarks we should make here.
\begin{enumerate}
\item In Definition \ref{spaces-duality-definition-relative-dualizing-proper-flat}
...
by affines, we see from Lemma \ref{spaces-duality-lemma-properties-relative-dualizing}
...
Definition \ref{spaces-duality-definition-relative-dualizing-proper-flat}.
...
and the discussion in Section \ref{spaces-duality-section-trace}. In particular,
...
Lemma \ref{spaces-duality-lemma-twisted-inverse-image}
and $\text{Tr}_f$ is as in Section \ref{spaces-duality-section-trace}.
Namely, given a diagram as in the definition we get
an isomorphism $L(g')^*a(\mathcal{O}_Y) \to a'(\mathcal{O}_{Y'})$ by
Lemma \ref{spaces-duality-lemma-more-base-change}
which is compatible with trace maps by
Lemma \ref{spaces-duality-lemma-trace-map-and-base-change}.
\end{enumerate}
...
\source{stacks:0E5Y}
\href{https://stacks.math.columbia.edu/tag/0E5Y}{\texttt{Stacks tag 0E5Y}}
\group{spaces-duality}
...
Lemma \ref{spaces-duality-lemma-properties-relative-dualizing}.
\end{proof}

\begin{lemma}[Uniqueness relative dualizing]
\label{spaces-duality-lemma-uniqueness-relative-dualizing}
\source{stacks:0E5Z}
\href{https://stacks.math.columbia.edu/tag/0E5Z}{\texttt{Stacks tag 0E5Z}}
\group{spaces-duality}
...
By Definition \ref{spaces-duality-definition-relative-dualizing-proper-flat}
...
by Lemma \ref{spaces-duality-lemma-relative-dualizing-RHom}.
...
$$
\begin{array}{ccc}Rf_*\omega_1^\bullet \underset{\tau_1}{\searrow}\underset{Rf_*\iota}{\longrightarrow} &  & Rf_*\omega_1^\bullet \overset{\tau_2}{\swarrow} \\  & \mathcal{O}_Y & \end{array}
$$
...
degrees (Lemma \ref{spaces-duality-lemma-relative-dualizing-RHom})
thus this commutativity may be proved after
restricting to the affines $Y_{0, i}$ where it holds by construction.
\end{proof}

\begin{lemma}[Covering enough]
\label{spaces-duality-lemma-covering-enough}
\source{stacks:0E60}
\href{https://stacks.math.columbia.edu/tag/0E60}{\texttt{Stacks tag 0E60}}
\group{spaces-duality}
...
$$
\begin{array}{cc}X_i \underset{g_i'}{\longrightarrow}\underset{f_i}{\downarrow} & X \overset{f}{\downarrow} \\ Y_i \overset{g_i}{\longrightarrow} & Y\end{array}
$$
...
as in Definition \ref{spaces-duality-definition-relative-dualizing-proper-flat}.
...
$$
\begin{array}{cc}X'_j \underset{h_j'}{\longrightarrow}\underset{f'_j}{\downarrow} & X' \overset{f'}{\downarrow} \\ Y'_j \overset{h_j}{\longrightarrow} & Y'\end{array}
$$
...
$f', g'$ as in Definition \ref{spaces-duality-definition-relative-dualizing-proper-flat}.
...
(a'(\mathcal{O}_{Y'}), \text{Tr}_{f', \mathcal{O}_{Y'}})
$$
Uniqueness by Lemma \ref{spaces-duality-lemma-uniqueness-relative-dualizing} for example.
...
$\omega_{X'/Y'}^\bullet$ over $X'$ (Lemma \ref{spaces-duality-lemma-relative-dualizing-RHom})
and since this remains true after pulling back by any projection
$Y' \times_Y \ldots \times_Y Y' \to Y'$ (small detail omitted -- compare
with the proof of Lemma \ref{spaces-duality-lemma-uniqueness-relative-dualizing}),
...
\source{stacks:0E61}
\href{https://stacks.math.columbia.edu/tag/0E61}{\texttt{Stacks tag 0E61}}
\group{spaces-duality}
...
self exts on $X_{n, i}$ by Lemma \ref{spaces-duality-lemma-relative-dualizing-RHom}.
...
Lemma \ref{spaces-duality-lemma-uniqueness-relative-dualizing}
for example to see why we have
the required vanishing of negative exts.
By Lemma \ref{spaces-duality-lemma-covering-enough}
...
\source{stacks:0E6C}
\href{https://stacks.math.columbia.edu/tag/0E6C}{\texttt{Stacks tag 0E6C}}
\group{spaces-duality}
...
\source{stacks:0E6E}
\href{https://stacks.math.columbia.edu/tag/0E6E}{\texttt{Stacks tag 0E6E}}
\group{spaces-duality}
...
Let $a : D_\QCoh(\mathcal{O}_Y) \to D_\QCoh(\mathcal{O}_X)$
be the right adjoint of $Rf_*$ from Lemma \ref{spaces-duality-lemma-twisted-inverse-image}.
...
\xlongequal{} &  &  &  &  &  & D_\QCoh(\mathcal{O}_X) \\ D_\QCoh(\mathcal{O}_{Y_0}) \overset{a_0}{\uparrow}\xlongequal{\text{Derived Categories of Spaces, Lemma
\ref{spaces-perfect-lemma-derived-quasi-coherent-small-etale-site}}} &  &  &  &  &  & D_\QCoh(\mathcal{O}_Y) \underset{a}{\uparrow}\end{array}
$$
is commutative.
\end{lemma}
