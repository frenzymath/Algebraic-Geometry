...
\begin{lemma}
\label{src-higher-siegel-weil-unitary-nonsingular-terms-ch11-local-intersection-number-and-trace-formula-statement-1}
\source{higher-siegel-weil-unitary-nonsingular-terms}
\notready
...
\begin{prop}
\label{src-higher-siegel-weil-unitary-nonsingular-terms-ch11-local-intersection-number-and-trace-formula-statement-2}
\source{higher-siegel-weil-unitary-nonsingular-terms}
...
%
%\begin{prop}
 The action of the cohomological correspondence $[\cH_{d}]$ on $Rf_{*}\Qlbar$ preserves the decomposition \eqref{KAi}, and it acts on $K_{\cA,i}$ by multiplication by $(d-2i)$.
%\end{prop}
%\begin{proof}
...
\begin{lemma}
\label{src-higher-siegel-weil-unitary-nonsingular-terms-ch11-local-intersection-number-and-trace-formula-statement-5}
\source{higher-siegel-weil-unitary-nonsingular-terms}
...
\begin{lemma}
\label{src-higher-siegel-weil-unitary-nonsingular-terms-ch11-local-intersection-number-and-trace-formula-statement-6}
\source{higher-siegel-weil-unitary-nonsingular-terms}
...
\begin{lemma}
\label{src-higher-siegel-weil-unitary-nonsingular-terms-ch11-local-intersection-number-and-trace-formula-statement-7}
\source{higher-siegel-weil-unitary-nonsingular-terms}
\notready
