...
\begin{lemma}
\label{src-rigid-local-systems-multiplicative-eigenvalue-problem-ch12-formulas-for-induction-statement-1}
\source{rigid-local-systems-multiplicative-eigenvalue-problem}
\notready
\begin{enumerate}
...
\begin{lemma}
\label{src-rigid-local-systems-multiplicative-eigenvalue-problem-ch12-formulas-for-induction-statement-2}
\source{rigid-local-systems-multiplicative-eigenvalue-problem}
\notready
The map
