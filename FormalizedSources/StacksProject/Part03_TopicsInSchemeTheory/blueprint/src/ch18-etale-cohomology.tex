...
\begin{definition}[Etale covering initial]
\label{etale-cohomology-definition-etale-covering-initial}
\source{stacks:03N5}
\href{https://stacks.math.columbia.edu/tag/03N5}{\texttt{Stacks tag 03N5}}
\group{etale-cohomology}
...
I}$, the diagram
$$
\begin{array}{ccc}\mathcal{F} (U) \longrightarrow & \Pi_{i \in I} \mathcal{F} (U_i) \longrightarrow\longrightarrow & \Pi_{i, j \in I} \mathcal{F} (U_i \times_U U_j)\end{array}
$$
...
\source{stacks:03N6}
\href{https://stacks.math.columbia.edu/tag/03N6}{\texttt{Stacks tag 03N6}}
\group{etale-cohomology}
...
$$
\begin{array}{cc}{Y\ } \longrightarrow\overset{\varphi}{\downarrow} & {\bar Y} \overset{\bar\varphi}{\downarrow} \\ {\mathbf{A}^1_\mathbf{C} \setminus \{0\}} \longrightarrow & {\mathbf{P}^1_\mathbf{C}}\end{array}
$$
...
Remark \ref{etale-cohomology-remark-normalize-H1-Gm}.
...
\source{stacks:03NC}
\href{https://stacks.math.columbia.edu/tag/03NC}{\texttt{Stacks tag 03NC}}
\group{etale-cohomology}
...
\begin{example}[Representable presheaf]
\label{etale-cohomology-example-representable-presheaf}
\source{stacks:03ND}
\href{https://stacks.math.columbia.edu/tag/03ND}{\texttt{Stacks tag 03ND}}
\group{etale-cohomology}
...
\begin{lemma}[Morphisms between objects are in bijection with natural transformations between the fun...]
\label{etale-cohomology-lemma-yoneda}
\source{stacks:03NE}
\href{https://stacks.math.columbia.edu/tag/03NE}{\texttt{Stacks tag 03NE}}
\group{etale-cohomology}
...
\begin{definition}[Family morphisms fixed target]
\label{etale-cohomology-definition-family-morphisms-fixed-target}
\source{stacks:03NG}
\href{https://stacks.math.columbia.edu/tag/03NG}{\texttt{Stacks tag 03NG}}
\group{etale-cohomology}
...
\source{stacks:03NH}
\href{https://stacks.math.columbia.edu/tag/03NH}{\texttt{Stacks tag 03NH}}
\group{etale-cohomology}
...
\begin{example}[Site topological space]
\label{etale-cohomology-example-site-topological-space}
\source{stacks:03NI}
\href{https://stacks.math.columbia.edu/tag/03NI}{\texttt{Stacks tag 03NI}}
\group{etale-cohomology}
...
\source{stacks:03NK}
\href{https://stacks.math.columbia.edu/tag/03NK}{\texttt{Stacks tag 03NK}}
\group{etale-cohomology}
...
\begin{array}{ccc}\mathcal{F}(U) \longrightarrow & \prod_{i\in I} \mathcal{F}(U_i) \longrightarrow\longrightarrow & \prod_{i, j \in I} \mathcal{F}(U_i \times_U U_j),\end{array}
\end{equation}
...
\begin{remark}[Empty covering]
\label{etale-cohomology-remark-empty-covering}
\source{stacks:03NM}
\href{https://stacks.math.columbia.edu/tag/03NM}{\texttt{Stacks tag 03NM}}
\group{etale-cohomology}
...
\begin{example}[Sheaf site space]
\label{etale-cohomology-example-sheaf-site-space}
\source{stacks:03NN}
\href{https://stacks.math.columbia.edu/tag/03NN}{\texttt{Stacks tag 03NN}}
\group{etale-cohomology}

Working this out for the site $X_{Zar}$ associated to a topological
space, see Example \ref{etale-cohomology-example-site-topological-space}, gives the usual
notion of sheaves.
\end{example}

\begin{definition}[Category sheaves]
\label{etale-cohomology-definition-category-sheaves}
\source{stacks:03NO}
\href{https://stacks.math.columbia.edu/tag/03NO}{\texttt{Stacks tag 03NO}}
\group{etale-cohomology}
...
$$
\begin{array}{ccc}\mathcal{F}(S) \longrightarrow & \prod_{i\in I} \mathcal{F}(O_i) \longrightarrow\longrightarrow & \prod_{i, j \in I} \mathcal{F}(O_i \times_S O_j)\end{array}
$$
...
reads
$$
\begin{array}{ccc}\mathcal{F} (G/H) \longrightarrow & \mathcal{F}({}_G G) \longrightarrow\longrightarrow & \prod_{h\in H} \mathcal{F}({}_G G)\end{array}
$$
...
\begin{definition}[0 cech]
\label{etale-cohomology-definition-0-cech}
\source{stacks:03NR}
\href{https://stacks.math.columbia.edu/tag/03NR}{\texttt{Stacks tag 03NR}}
\group{etale-cohomology}
...
$$
\begin{array}{ccc}V_j \underset{\chi_j}{\longrightarrow}\downarrow &  & U_{\alpha(j)} \downarrow \\ V \overset{\chi}{\longrightarrow} &  & U.\end{array}
$$
...
$$
\begin{array}{ccccc}V_j \underset{(\chi_j, \psi_j)}{\longrightarrow}\downarrow &  &  & U_{\alpha(j)} \times_U U_{\beta(j)} \swarrow\searrow &  \\  &  & U_{\alpha(j)} \searrow &  & U_{\beta(j)} \swarrow \\ V \overset{\chi = \psi}{\longrightarrow} &  &  & U. & \end{array}
$$
...
\source{stacks:03NS}
\href{https://stacks.math.columbia.edu/tag/03NS}{\texttt{Stacks tag 03NS}}
\group{etale-cohomology}
...
\source{stacks:03NU}
\href{https://stacks.math.columbia.edu/tag/03NU}{\texttt{Stacks tag 03NU}}
\group{etale-cohomology}
...
\source{stacks:03NW}
\href{https://stacks.math.columbia.edu/tag/03NW}{\texttt{Stacks tag 03NW}}
\group{etale-cohomology}
...
\source{stacks:03NX}
\href{https://stacks.math.columbia.edu/tag/03NX}{\texttt{Stacks tag 03NX}}
\group{etale-cohomology}
...
\begin{example}[Fpqc coverings]
\label{etale-cohomology-example-fpqc-coverings}
\source{stacks:03NY}
\href{https://stacks.math.columbia.edu/tag/03NY}{\texttt{Stacks tag 03NY}}
\group{etale-cohomology}
...
\begin{lemma}[Site fpqc]
\label{etale-cohomology-lemma-site-fpqc}
\source{stacks:03NZ}
\href{https://stacks.math.columbia.edu/tag/03NZ}{\texttt{Stacks tag 03NZ}}
\group{etale-cohomology}
...
\source{stacks:03X6}
\href{https://stacks.math.columbia.edu/tag/03X6}{\texttt{Stacks tag 03X6}}
\group{etale-cohomology}
...
\begin{lemma}[Fpqc sheaves]
\label{etale-cohomology-lemma-fpqc-sheaves}
\source{stacks:03O1}
\href{https://stacks.math.columbia.edu/tag/03O1}{\texttt{Stacks tag 03O1}}
\group{etale-cohomology}
...
$$
\begin{array}{ccc}\mathcal{F}(\Spec(A)) \longrightarrow & \mathcal{F}(\Spec(B)) \longrightarrow\longrightarrow & \mathcal{F}(\Spec(B \otimes_A B))\end{array}
$$
...
$$
\begin{array}{ccc}\mathcal{F}_{\Spec(A)}(\Spec(A)) \longrightarrow & \mathcal{F}_{\Spec(B)}(\Spec(B)) \longrightarrow\longrightarrow & \mathcal{F}_{\Spec(B \otimes_A B)}(\Spec(B \otimes_A B))\end{array}
$$
is an equalizer.
\end{enumerate}
...
By Lemma \ref{etale-cohomology-lemma-fpqc-sheaves} condition (c) then suffices to get the
sheaf condition for the fpqc topology.

\begin{example}[Quasi coherent]
\label{etale-cohomology-example-quasi-coherent}
\source{stacks:03O2}
\href{https://stacks.math.columbia.edu/tag/03O2}{\texttt{Stacks tag 03O2}}
\group{etale-cohomology}
...
$$
\begin{array}{ccc}\mathcal{F}(U) \overset{0}{\longrightarrow} & \mathcal{F}(V) \longrightarrow\longrightarrow & \mathcal{F}(V \times_U V)\end{array}
$$
is not an equalizer. We will see later that $\mathcal{F}$ does in fact
give rise to a sheaf on the \'etale and smooth sites.
\end{example}

\begin{lemma}[Representable sheaf fpqc]
\label{etale-cohomology-lemma-representable-sheaf-fpqc}
\source{stacks:03O3}
\href{https://stacks.math.columbia.edu/tag/03O3}{\texttt{Stacks tag 03O3}}
\group{etale-cohomology}
...
\begin{remark}[Fpqc finest]
\label{etale-cohomology-remark-fpqc-finest}
\source{stacks:03O4}
\href{https://stacks.math.columbia.edu/tag/03O4}{\texttt{Stacks tag 03O4}}
\group{etale-cohomology}
...
\begin{example}[Additive group sheaf]
\label{etale-cohomology-example-additive-group-sheaf}
\source{stacks:03O5}
\href{https://stacks.math.columbia.edu/tag/03O5}{\texttt{Stacks tag 03O5}}
\group{etale-cohomology}
...
\source{stacks:03O7}
\href{https://stacks.math.columbia.edu/tag/03O7}{\texttt{Stacks tag 03O7}}
\group{etale-cohomology}
...
$$
\begin{array}{ccc}\text{pr}_0^*\mathcal{F}_i \underset{\text{pr}_{02}^*\varphi_{ik}}{\searrow}\overset{\text{pr}_{01}^*\varphi_{ij}}{\longrightarrow} &  & \text{pr}_1^*\mathcal{F}_j \overset{\text{pr}_{12}^*\varphi_{jk}}{\swarrow} \\  & \text{pr}_2^*\mathcal{F}_k & \end{array}
$$
...
\begin{theorem}[Descent quasi coherent]
\label{etale-cohomology-theorem-descent-quasi-coherent}
\source{stacks:03O8}
\href{https://stacks.math.columbia.edu/tag/03O8}{\texttt{Stacks tag 03O8}}
\group{etale-cohomology}
...
\begin{lemma}[Algebra descent]
\label{etale-cohomology-lemma-algebra-descent}
\source{stacks:03O9}
\href{https://stacks.math.columbia.edu/tag/03O9}{\texttt{Stacks tag 03O9}}
\group{etale-cohomology}
...
\begin{lemma}[Descent modules]
\label{etale-cohomology-lemma-descent-modules}
\source{stacks:03OA}
\href{https://stacks.math.columbia.edu/tag/03OA}{\texttt{Stacks tag 03OA}}
\group{etale-cohomology}
...
\source{stacks:03OB}
\href{https://stacks.math.columbia.edu/tag/03OB}{\texttt{Stacks tag 03OB}}
\group{etale-cohomology}
...
$$
\begin{array}{ccc}{N \otimes_A B \otimes_A B} \underset{\varphi_{02}}{\searrow}\overset{\varphi_{01}}{\longrightarrow} &  & {B \otimes_A N \otimes_A B} \overset{\varphi_{12}}{\swarrow} \\  & {B \otimes_A B \otimes_A N} & \end{array}
$$
...
\begin{definition}[Effective modules]
\label{etale-cohomology-definition-effective-modules}
\source{stacks:03OC}
\href{https://stacks.math.columbia.edu/tag/03OC}{\texttt{Stacks tag 03OC}}
\group{etale-cohomology}
...
Theorem \ref{etale-cohomology-theorem-descent-quasi-coherent} is a consequence the
following result.

\begin{theorem}[Descent modules]
\label{etale-cohomology-theorem-descent-modules}
\source{stacks:03OD}
\href{https://stacks.math.columbia.edu/tag/03OD}{\texttt{Stacks tag 03OD}}
\group{etale-cohomology}
...
\begin{proposition}[Quasi coherent sheaf fpqc]
\label{etale-cohomology-proposition-quasi-coherent-sheaf-fpqc}
\source{stacks:03OG}
\href{https://stacks.math.columbia.edu/tag/03OG}{\texttt{Stacks tag 03OG}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-fpqc-sheaves},
...
\end{align*}
is exact by
Lemma \ref{etale-cohomology-lemma-descent-modules}.
\end{proof}
...
\source{stacks:03OH}
\href{https://stacks.math.columbia.edu/tag/03OH}{\texttt{Stacks tag 03OH}}
\group{etale-cohomology}
...
\begin{remark}[Final object]
\label{etale-cohomology-remark-final-object}
\source{stacks:03OI}
\href{https://stacks.math.columbia.edu/tag/03OI}{\texttt{Stacks tag 03OI}}
\group{etale-cohomology}
...
\source{stacks:03OJ}
\href{https://stacks.math.columbia.edu/tag/03OJ}{\texttt{Stacks tag 03OJ}}
\group{etale-cohomology}
...
\ref{etale-cohomology-theorem-descent-quasi-coherent}. Details omitted. In
...
``site as in Theorem \ref{etale-cohomology-theorem-quasi-coherent}''
...
any site $\mathcal{C}$ as in Theorem \ref{etale-cohomology-theorem-quasi-coherent}.
...
\source{stacks:03OL}
\href{https://stacks.math.columbia.edu/tag/03OL}{\texttt{Stacks tag 03OL}}
\group{etale-cohomology}
...
\begin{lemma}[Cech presheaves]
\label{etale-cohomology-lemma-cech-presheaves}
\source{stacks:03OM}
\href{https://stacks.math.columbia.edu/tag/03OM}{\texttt{Stacks tag 03OM}}
\group{etale-cohomology}

Notation and assumptions as in Definition \ref{etale-cohomology-definition-cech-complex}.
...
\source{stacks:03ON}
\href{https://stacks.math.columbia.edu/tag/03ON}{\texttt{Stacks tag 03ON}}
\group{etale-cohomology}
...
\begin{definition}[Free abelian presheaf]
\label{etale-cohomology-definition-free-abelian-presheaf}
\source{stacks:03OO}
\href{https://stacks.math.columbia.edu/tag/03OO}{\texttt{Stacks tag 03OO}}
\group{etale-cohomology}
...
\begin{lemma}[Cech complex describe]
\label{etale-cohomology-lemma-cech-complex-describe}
\source{stacks:03OP}
\href{https://stacks.math.columbia.edu/tag/03OP}{\texttt{Stacks tag 03OP}}
\group{etale-cohomology}
...
\source{stacks:03OQ}
\href{https://stacks.math.columbia.edu/tag/03OQ}{\texttt{Stacks tag 03OQ}}
\group{etale-cohomology}
...
\source{stacks:03OR}
\href{https://stacks.math.columbia.edu/tag/03OR}{\texttt{Stacks tag 03OR}}
\group{etale-cohomology}
...
\begin{theorem}[Cech derived]
\label{etale-cohomology-theorem-cech-derived}
\source{stacks:03OS}
\href{https://stacks.math.columbia.edu/tag/03OS}{\texttt{Stacks tag 03OS}}
\group{etale-cohomology}
...
\begin{proof}
By the Lemma \ref{etale-cohomology-lemma-hom-injective}, the functors
...
\begin{remark}[Presheaves no topology]
\label{etale-cohomology-remark-presheaves-no-topology}
\source{stacks:03OT}
\href{https://stacks.math.columbia.edu/tag/03OT}{\texttt{Stacks tag 03OT}}
\group{etale-cohomology}
...
\begin{theorem}[Cech ss]
\label{etale-cohomology-theorem-cech-ss}
\source{stacks:03OW}
\href{https://stacks.math.columbia.edu/tag/03OW}{\texttt{Stacks tag 03OW}}
\group{etale-cohomology}
...
and the maps
$$
\begin{array}{cc}\Gamma(U, I^\bullet) \longrightarrow & \check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{I}^\bullet) \\  & \check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{F}) \uparrow\end{array}
$$
...
Lemma \ref{etale-cohomology-lemma-forget-injectives}, it is a complex of injectives in
$\textit{PAb}(\mathcal{C})$. Thus, the rows of the double complex are
exact in positive degrees (Lemma \ref{etale-cohomology-lemma-hom-injective}), and
...
\begin{remark}[Grothendieck ss]
\label{etale-cohomology-remark-grothendieck-ss}
\source{stacks:03OX}
\href{https://stacks.math.columbia.edu/tag/03OX}{\texttt{Stacks tag 03OX}}
\group{etale-cohomology}
...
in more detail starting in Section \ref{etale-cohomology-section-etale-site}.
...
\begin{definition}[Tau covering]
\label{etale-cohomology-definition-tau-covering}
\source{stacks:03X8}
\href{https://stacks.math.columbia.edu/tag/03X8}{\texttt{Stacks tag 03X8}}
\group{etale-cohomology}
...
(1), (2) and (3) of
Definition \ref{etale-cohomology-definition-site} (our definition of a site), see
Topologies, Lemmas
...
\begin{definition}[Tau site]
\label{etale-cohomology-definition-tau-site}
\source{stacks:03XB}
\href{https://stacks.math.columbia.edu/tag/03XB}{\texttt{Stacks tag 03XB}}
\group{etale-cohomology}
...
Definition \ref{etale-cohomology-definition-tau-covering})
...
Section \ref{etale-cohomology-section-cohomology}. Thus we have
...
\begin{lemma}[Compare cohomology big small]
\label{etale-cohomology-lemma-compare-cohomology-big-small}
\source{stacks:03YX}
\href{https://stacks.math.columbia.edu/tag/03YX}{\texttt{Stacks tag 03YX}}
\group{etale-cohomology}
...
\begin{definition}[Standard tau]
\label{etale-cohomology-definition-standard-tau}
\source{stacks:03X9}
\href{https://stacks.math.columbia.edu/tag/03X9}{\texttt{Stacks tag 03X9}}
\group{etale-cohomology}
...
\begin{lemma}[Tau affine]
\label{etale-cohomology-lemma-tau-affine}
\source{stacks:03XA}
\href{https://stacks.math.columbia.edu/tag/03XA}{\texttt{Stacks tag 03XA}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-etale-topos-independent-partial-universe} below.
For notation and terminology used in this lemma we refer to
Topologies, Section \ref{topologies-section-change-alpha}.

\begin{lemma}[Cohomology enlarge partial universe]
\label{etale-cohomology-lemma-cohomology-enlarge-partial-universe}
\source{stacks:03YY}
\href{https://stacks.math.columbia.edu/tag/03YY}{\texttt{Stacks tag 03YY}}
\group{etale-cohomology}
...
\begin{definition}[Etale topos]
\label{etale-cohomology-definition-etale-topos}
\source{stacks:04HQ}
\href{https://stacks.math.columbia.edu/tag/04HQ}{\texttt{Stacks tag 04HQ}}
\group{etale-cohomology}
...
\begin{lemma}[Etale topos independent partial universe]
\label{etale-cohomology-lemma-etale-topos-independent-partial-universe}
\source{stacks:0958}
\href{https://stacks.math.columbia.edu/tag/0958}{\texttt{Stacks tag 0958}}
\group{etale-cohomology}

Let $S$ be a scheme. The \'etale topos of $S$ is independent
(up to canonical equivalence) of the construction of the small
\'etale site in Definition \ref{etale-cohomology-definition-tau-site}.
\end{lemma}
...
\begin{lemma}[Cech complex]
\label{etale-cohomology-lemma-cech-complex}
\source{stacks:03OZ}
\href{https://stacks.math.columbia.edu/tag/03OZ}{\texttt{Stacks tag 03OZ}}
\group{etale-cohomology}
...
Example \ref{etale-cohomology-example-fpqc-coverings}.
...
\source{stacks:03P0}
\href{https://stacks.math.columbia.edu/tag/03P0}{\texttt{Stacks tag 03P0}}
\group{etale-cohomology}

In the statement of Lemma \ref{etale-cohomology-lemma-cech-complex} the covering $\mathcal{U}$
...
\source{stacks:03P1}
\href{https://stacks.math.columbia.edu/tag/03P1}{\texttt{Stacks tag 03P1}}
\group{etale-cohomology}
...
\begin{theorem}[Zariski fpqc quasi coherent]
\label{etale-cohomology-theorem-zariski-fpqc-quasi-coherent}
\source{stacks:03P2}
\href{https://stacks.math.columbia.edu/tag/03P2}{\texttt{Stacks tag 03P2}}
\group{etale-cohomology}
...
By Lemma \ref{etale-cohomology-lemma-locality-cohomology},
...
Theorem \ref{etale-cohomology-theorem-cech-ss},
...
Lemma \ref{etale-cohomology-lemma-cech-complex},
...
Now by Lemma \ref{etale-cohomology-lemma-descent-modules},
$H^p((B/A)_\bullet \otimes_A M) = 0$ for $p > 0$, hence $\check \xi = 0$
and so $\xi = 0$.
\item[p > 1]
Pick $\xi \in H^p_\tau(U, \mathcal{F}^a)$. By
Lemma \ref{etale-cohomology-lemma-locality-cohomology},
there exists an fpqc covering $\mathcal{U} = \{U_i \to U\}_{i \in I}$
such that $\xi|_{U_i} = 0$ for all $i \in I$. Up to refining
$\mathcal{U}$, we may assume that $\mathcal{U}$ is a standard
...
and using Lemma \ref{etale-cohomology-lemma-descent-modules} again,
...
\begin{remark}[Right derived global sections]
\label{etale-cohomology-remark-right-derived-global-sections}
\source{stacks:03P3}
\href{https://stacks.math.columbia.edu/tag/03P3}{\texttt{Stacks tag 03P3}}
\group{etale-cohomology}

Comment on Theorem \ref{etale-cohomology-theorem-zariski-fpqc-quasi-coherent}.
...
Let $S$ and $\tau$ be as in Section \ref{etale-cohomology-section-big-small}.
We have already seen that any representable presheaf is a sheaf on
$(\Sch/S)_\tau$ or $S_\tau$, see
Lemma \ref{etale-cohomology-lemma-representable-sheaf-fpqc}
and
Remark \ref{etale-cohomology-remark-fpqc-finest}.
Here are some special cases.

\begin{definition}[Additive sheaf]
\label{etale-cohomology-definition-additive-sheaf}
\source{stacks:03P4}
\href{https://stacks.math.columbia.edu/tag/03P4}{\texttt{Stacks tag 03P4}}
\group{etale-cohomology}
...
\begin{remark}[Constant locally constant maps]
\label{etale-cohomology-remark-constant-locally-constant-maps}
\source{stacks:03P5}
\href{https://stacks.math.columbia.edu/tag/03P5}{\texttt{Stacks tag 03P5}}
\group{etale-cohomology}
...
\source{stacks:04HS}
\href{https://stacks.math.columbia.edu/tag/04HS}{\texttt{Stacks tag 04HS}}
\group{etale-cohomology}
...
\begin{remark}[Special case fpqc cohomology quasi coherent]
\label{etale-cohomology-remark-special-case-fpqc-cohomology-quasi-coherent}
\source{stacks:03P6}
\href{https://stacks.math.columbia.edu/tag/03P6}{\texttt{Stacks tag 03P6}}
\group{etale-cohomology}

In the terminology introduced above a special case of
Theorem \ref{etale-cohomology-theorem-zariski-fpqc-quasi-coherent}
is
$$
...
\begin{theorem}[Picard group]
\label{etale-cohomology-theorem-picard-group}
\source{stacks:03P8}
\href{https://stacks.math.columbia.edu/tag/03P8}{\texttt{Stacks tag 03P8}}
\group{etale-cohomology}
...
By Theorem \ref{etale-cohomology-theorem-quasi-coherent} or the more precise
Descent, Proposition \ref{descent-proposition-equivalence-quasi-coherent}
...
\source{stacks:03PB}
\href{https://stacks.math.columbia.edu/tag/03PB}{\texttt{Stacks tag 03PB}}
\group{etale-cohomology}
...
\begin{proposition}[Etale morphisms]
\label{etale-cohomology-proposition-etale-morphisms}
\source{stacks:03PC}
\href{https://stacks.math.columbia.edu/tag/03PC}{\texttt{Stacks tag 03PC}}
\group{etale-cohomology}
...
\source{stacks:03PD}
\href{https://stacks.math.columbia.edu/tag/03PD}{\texttt{Stacks tag 03PD}}
\group{etale-cohomology}
...
\begin{theorem}[Standard etale]
\label{etale-cohomology-theorem-standard-etale}
\source{stacks:03PE}
\href{https://stacks.math.columbia.edu/tag/03PE}{\texttt{Stacks tag 03PE}}
\group{etale-cohomology}
...
\source{stacks:03PG}
\href{https://stacks.math.columbia.edu/tag/03PG}{\texttt{Stacks tag 03PG}}
\group{etale-cohomology}
...
\begin{lemma}[Etale fpqc]
\label{etale-cohomology-lemma-etale-fpqc}
\source{stacks:03PH}
\href{https://stacks.math.columbia.edu/tag/03PH}{\texttt{Stacks tag 03PH}}
\group{etale-cohomology}
...
\source{stacks:03PI}
\href{https://stacks.math.columbia.edu/tag/03PI}{\texttt{Stacks tag 03PI}}
\group{etale-cohomology}

(For more details see Section \ref{etale-cohomology-section-big-small}, or
Topologies, Section \ref{topologies-section-etale}.)
Let $S$ be a scheme.
The {\it big \'etale site over $S$} is the site
$(\Sch/S)_\etale$, see
Definition \ref{etale-cohomology-definition-tau-site}.
...
\begin{proposition}[Cohomology restrict small site]
\label{etale-cohomology-proposition-cohomology-restrict-small-site}
\source{stacks:03PJ}
\href{https://stacks.math.columbia.edu/tag/03PJ}{\texttt{Stacks tag 03PJ}}
\group{etale-cohomology}
...
\begin{proof}
This is a special case of Lemma \ref{etale-cohomology-lemma-compare-cohomology-big-small}.
\end{proof}
...
\begin{lemma}[Kummer sequence]
\label{etale-cohomology-lemma-kummer-sequence}
\source{stacks:03PL}
\href{https://stacks.math.columbia.edu/tag/03PL}{\texttt{Stacks tag 03PL}}
\group{etale-cohomology}
...
\begin{remark}[No kummer sequence zariski]
\label{etale-cohomology-remark-no-kummer-sequence-zariski}
\source{stacks:03PM}
\href{https://stacks.math.columbia.edu/tag/03PM}{\texttt{Stacks tag 03PM}}
\group{etale-cohomology}

Lemma \ref{etale-cohomology-lemma-kummer-sequence} is false when ``\'etale'' is replaced
with ``Zariski''.
...
By
Theorem \ref{etale-cohomology-theorem-picard-group}
and
Lemma \ref{etale-cohomology-lemma-kummer-sequence}
and general properties of cohomology we obtain
the long exact cohomology sequence
$$
\begin{array}{cccc}0 \longrightarrow & H_\etale^0(S, \mu_{n, S}) \longrightarrow & \Gamma(S, \mathcal{O}_S^*) \overset{(\cdot)^n}{\longrightarrow} & \Gamma(S, \mathcal{O}_S^*) \downarrow \\  & H_\etale^1(S, \mu_{n, S}) \longrightarrow & \Pic(S) \overset{(\cdot)^n}{\longrightarrow} & \Pic(S) \downarrow \\  & H_\etale^2(S, \mu_{n, S}) \longrightarrow & \ldots & \end{array}
$$
at least if $n$ is invertible on $S$. When $n$ is not invertible on $S$
we can apply the following lemma.

\begin{lemma}[Kummer sequence syntomic]
\label{etale-cohomology-lemma-kummer-sequence-syntomic}
\source{stacks:040N}
\href{https://stacks.math.columbia.edu/tag/040N}{\texttt{Stacks tag 040N}}
\group{etale-cohomology}
...
\begin{remark}[No kummer sequence smooth etale zariski]
\label{etale-cohomology-remark-no-kummer-sequence-smooth-etale-zariski}
\source{stacks:040O}
\href{https://stacks.math.columbia.edu/tag/040O}{\texttt{Stacks tag 040O}}
\group{etale-cohomology}

Lemma \ref{etale-cohomology-lemma-kummer-sequence-syntomic}
...
the long exact cohomology sequence
$$
\begin{array}{cccc}0 \longrightarrow & H_{fppf}^0(S, \mu_{n, S}) \longrightarrow & \Gamma(S, \mathcal{O}_S^*) \overset{(\cdot)^n}{\longrightarrow} & \Gamma(S, \mathcal{O}_S^*) \downarrow \\  & H_{fppf}^1(S, \mu_{n, S}) \longrightarrow & \Pic(S) \overset{(\cdot)^n}{\longrightarrow} & \Pic(S) \downarrow \\  & H_{fppf}^2(S, \mu_{n, S}) \longrightarrow & \ldots & \end{array}
$$
...
$$
\begin{array}{cc}\mathcal{L}^{\otimes n} \underset{\varphi^{\otimes n}}{\downarrow}\underset{\alpha}{\longrightarrow} & \mathcal{O}_S \overset{1}{\downarrow} \\ (\mathcal{L}')^{\otimes n} \overset{\alpha'}{\longrightarrow} & \mathcal{O}_S \\  & \end{array}
$$
...
\begin{lemma}[Describe h1 mun]
\label{etale-cohomology-lemma-describe-h1-mun}
\source{stacks:040Q}
\href{https://stacks.math.columbia.edu/tag/040Q}{\texttt{Stacks tag 040Q}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-kummer-sequence}). The rest of the proof is independent
of the topology, apart from the very last argument which uses that
the Kummer sequence is exact, i.e., uses Lemma \ref{etale-cohomology-lemma-kummer-sequence}.
\end{proof}
...
\source{stacks:03PO}
\href{https://stacks.math.columbia.edu/tag/03PO}{\texttt{Stacks tag 03PO}}
\group{etale-cohomology}
...
$$
\begin{array}{cc} & U \overset{\varphi}{\downarrow} \\ {\overline{s}} \overset{\overline{s}}{\longrightarrow}\overset{\bar u}{\nearrow} & S\end{array}
$$
...
\begin{remark}[Etale between etale]
\label{etale-cohomology-remark-etale-between-etale}
\source{stacks:03PP}
\href{https://stacks.math.columbia.edu/tag/03PP}{\texttt{Stacks tag 03PP}}
\group{etale-cohomology}
...
\begin{remark}[Etale neighbourhoods]
\label{etale-cohomology-remark-etale-neighbourhoods}
\source{stacks:04HT}
\href{https://stacks.math.columbia.edu/tag/04HT}{\texttt{Stacks tag 04HT}}
\group{etale-cohomology}
...
\begin{lemma}[Cofinal etale]
\label{etale-cohomology-lemma-cofinal-etale}
\source{stacks:03PQ}
\href{https://stacks.math.columbia.edu/tag/03PQ}{\texttt{Stacks tag 03PQ}}
\group{etale-cohomology}
...
$$
\begin{array}{cc}U'' \longrightarrow\downarrow & U \overset{(h_1, h_2)}{\downarrow} \\ U' \overset{\Delta}{\longrightarrow} & U' \times_S U'.\end{array}
$$
...
Remark \ref{etale-cohomology-remark-etale-between-etale} above.
...
\begin{lemma}[Geometric lift to cover]
\label{etale-cohomology-lemma-geometric-lift-to-cover}
\source{stacks:03PR}
\href{https://stacks.math.columbia.edu/tag/03PR}{\texttt{Stacks tag 03PR}}
\group{etale-cohomology}
...
$$
\begin{array}{cc}\overline{s} \times_{\overline{u}, U, \varphi_i} U_i
\overset{\text{pr}_1}{\downarrow}\underset{\text{pr}_2}{\longrightarrow} & U_i
\overset{\varphi_i}{\downarrow} \\ \Spec(k) = \overline{s} \overset{\sigma}{\uparrow}\overset{\overline{u}}{\longrightarrow} & U\end{array}
$$
...
Proposition \ref{etale-cohomology-proposition-etale-morphisms}. Here
...
\source{stacks:040R}
\href{https://stacks.math.columbia.edu/tag/040R}{\texttt{Stacks tag 040R}}
\group{etale-cohomology}
...
By Lemma \ref{etale-cohomology-lemma-cofinal-etale}, this colimit is over a filtered
...
\begin{lemma}[Stalk gives point]
\label{etale-cohomology-lemma-stalk-gives-point}
\source{stacks:04FM}
\href{https://stacks.math.columbia.edu/tag/04FM}{\texttt{Stacks tag 04FM}}
\group{etale-cohomology}
...
\begin{proof}
In the proof of
Lemma \ref{etale-cohomology-lemma-geometric-lift-to-cover}
...
Definition \ref{etale-cohomology-definition-geometric-point}.
...
\begin{remark}[Map stalks]
\label{etale-cohomology-remark-map-stalks}
\source{stacks:04FN}
\href{https://stacks.math.columbia.edu/tag/04FN}{\texttt{Stacks tag 04FN}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-stalk-gives-point}. There are more general morphisms of
...
\source{stacks:03PT}
\href{https://stacks.math.columbia.edu/tag/03PT}{\texttt{Stacks tag 03PT}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-stalk-gives-point}.
...
Theorem \ref{etale-cohomology-theorem-sheafification}.
...
$\mathcal{F}(U_i')$ for all $i$. By Lemma \ref{etale-cohomology-lemma-geometric-lift-to-cover}
...
\begin{theorem}[Exactness stalks]
\label{etale-cohomology-theorem-exactness-stalks}
\source{stacks:03PU}
\href{https://stacks.math.columbia.edu/tag/03PU}{\texttt{Stacks tag 03PU}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-stalk-exact}.
...
\begin{enumerate}
\item Theorem \ref{etale-cohomology-theorem-exactness-stalks} says that the family of points
of $S_\etale$ given by the geometric points of $S$
(Lemma \ref{etale-cohomology-lemma-stalk-gives-point}) is conservative, see
...
\begin{lemma}[Points small etale site]
\label{etale-cohomology-lemma-points-small-etale-site}
\source{stacks:04HU}
\href{https://stacks.math.columbia.edu/tag/04HU}{\texttt{Stacks tag 04HU}}
\group{etale-cohomology}
...
Definition \ref{etale-cohomology-definition-stalk}.
\end{enumerate}
\end{lemma}
...
Lemma \ref{etale-cohomology-lemma-cofinal-etale}.
Hence by
...
$$
\begin{array}{cc}V' \overset{\sigma'}{\downarrow}\underset{\varphi}{\longrightarrow} & V \overset{\sigma}{\downarrow} \\ U \times_S V' \overset{1 \times \varphi}{\longrightarrow} & U \times_S V\end{array}
$$
...
$$
\begin{array}{ccc}V'' \longrightarrow\overset{\sigma'|_{V''}}{\downarrow} & V' \overset{\sigma'}{\downarrow}\underset{\varphi}{\longrightarrow} & V \overset{\sigma}{\downarrow} \\ U \times_S V'' \longrightarrow & U \times_S V' \overset{1 \times \varphi}{\longrightarrow} & U \times_S V\end{array}
$$
...
\begin{lemma}[Points fppf]
\label{etale-cohomology-lemma-points-fppf}
\source{stacks:06VX}
\href{https://stacks.math.columbia.edu/tag/06VX}{\texttt{Stacks tag 06VX}}
\group{etale-cohomology}
...
Theorem \ref{etale-cohomology-theorem-exactness-stalks}
...
\begin{remark}[Points fppf site]
\label{etale-cohomology-remark-points-fppf-site}
\source{stacks:06VY}
\href{https://stacks.math.columbia.edu/tag/06VY}{\texttt{Stacks tag 06VY}}
\group{etale-cohomology}
...
\begin{lemma}[Support subsheaf final]
\label{etale-cohomology-lemma-support-subsheaf-final}
\source{stacks:04HV}
\href{https://stacks.math.columbia.edu/tag/04HV}{\texttt{Stacks tag 04HV}}
\group{etale-cohomology}
...
\begin{lemma}[Zero over image]
\label{etale-cohomology-lemma-zero-over-image}
\source{stacks:04FR}
\href{https://stacks.math.columbia.edu/tag/04FR}{\texttt{Stacks tag 04FR}}
\group{etale-cohomology}
...
Remark \ref{etale-cohomology-remark-map-stalks}
...
\source{stacks:04FS}
\href{https://stacks.math.columbia.edu/tag/04FS}{\texttt{Stacks tag 04FS}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-zero-over-image}).
\end{enumerate}
\end{definition}
...
\begin{lemma}[Support section closed]
\label{etale-cohomology-lemma-support-section-closed}
\source{stacks:04FT}
\href{https://stacks.math.columbia.edu/tag/04FT}{\texttt{Stacks tag 04FT}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-zero-over-image} part (3).
Parts (5) and (6) follow from the other parts.
\end{proof}

\begin{lemma}[Support sheaf rings closed]
\label{etale-cohomology-lemma-support-sheaf-rings-closed}
\source{stacks:04FU}
\href{https://stacks.math.columbia.edu/tag/04FU}{\texttt{Stacks tag 04FU}}
\group{etale-cohomology}
...
\begin{theorem}[Quasi finite etale locally]
\label{etale-cohomology-theorem-quasi-finite-etale-locally}
\source{stacks:03QE}
\href{https://stacks.math.columbia.edu/tag/03QE}{\texttt{Stacks tag 03QE}}
\group{etale-cohomology}
...
\source{stacks:03QF}
\href{https://stacks.math.columbia.edu/tag/03QF}{\texttt{Stacks tag 03QF}}
\group{etale-cohomology}
...
\source{stacks:03QG}
\href{https://stacks.math.columbia.edu/tag/03QG}{\texttt{Stacks tag 03QG}}
\group{etale-cohomology}
...
\begin{theorem}[Henselian]
\label{etale-cohomology-theorem-henselian}
\source{stacks:03QH}
\href{https://stacks.math.columbia.edu/tag/03QH}{\texttt{Stacks tag 03QH}}
\group{etale-cohomology}
...
\begin{lemma}[Finite over henselian]
\label{etale-cohomology-lemma-finite-over-henselian}
\source{stacks:03QJ}
\href{https://stacks.math.columbia.edu/tag/03QJ}{\texttt{Stacks tag 03QJ}}
\group{etale-cohomology}
...
\begin{definition}[Strictly henselian]
\label{etale-cohomology-definition-strictly-henselian}
\source{stacks:03QK}
\href{https://stacks.math.columbia.edu/tag/03QK}{\texttt{Stacks tag 03QK}}
\group{etale-cohomology}
...
\begin{example}[Powerseries]
\label{etale-cohomology-example-powerseries}
\source{stacks:03QI}
\href{https://stacks.math.columbia.edu/tag/03QI}{\texttt{Stacks tag 03QI}}
\group{etale-cohomology}
...
\begin{theorem}[Henselization]
\label{etale-cohomology-theorem-henselization}
\source{stacks:03QL}
\href{https://stacks.math.columbia.edu/tag/03QL}{\texttt{Stacks tag 03QL}}
\group{etale-cohomology}
...
The rings constructed in Theorem \ref{etale-cohomology-theorem-henselization}
...
\begin{lemma}[The stalk of the structure sheaf of a scheme in the etale topology is the strict hensel...]
\label{etale-cohomology-lemma-describe-etale-local-ring}
\source{stacks:04HX}
\href{https://stacks.math.columbia.edu/tag/04HX}{\texttt{Stacks tag 04HX}}
\group{etale-cohomology}
...
Theorem \ref{etale-cohomology-theorem-henselization}
...
\begin{definition}[Etale local rings]
\label{etale-cohomology-definition-etale-local-rings}
\source{stacks:03PS}
\href{https://stacks.math.columbia.edu/tag/03PS}{\texttt{Stacks tag 03PS}}
\group{etale-cohomology}
...
$$
\begin{array}{ccc}\Spec(\mathcal{O}^{sh}_{T, \overline{t}}) \longrightarrow\downarrow & \Spec(\mathcal{O}^h_{T, t}) \longrightarrow\downarrow & T \overset{f}{\downarrow} \\ \Spec(\mathcal{O}^{sh}_{S, \overline{s}}) \longrightarrow & \Spec(\mathcal{O}^h_{S, s}) \longrightarrow & S\end{array}
$$
...
\begin{lemma}[Describe henselization]
\label{etale-cohomology-lemma-describe-henselization}
\source{stacks:04HY}
\href{https://stacks.math.columbia.edu/tag/04HY}{\texttt{Stacks tag 04HY}}
\group{etale-cohomology}
...
\begin{remark}[Henselization Noetherian]
\label{etale-cohomology-remark-henselization-Noetherian}
\source{stacks:03QM}
\href{https://stacks.math.columbia.edu/tag/03QM}{\texttt{Stacks tag 03QM}}
\group{etale-cohomology}
...
\begin{lemma}[Etale site locally ringed]
\label{etale-cohomology-lemma-etale-site-locally-ringed}
\source{stacks:04HZ}
\href{https://stacks.math.columbia.edu/tag/04HZ}{\texttt{Stacks tag 04HZ}}
\group{etale-cohomology}
...
\source{stacks:03PW}
\href{https://stacks.math.columbia.edu/tag/03PW}{\texttt{Stacks tag 03PW}}
\group{etale-cohomology}
...
\begin{remark}[Direct image sheaf]
\label{etale-cohomology-remark-direct-image-sheaf}
\source{stacks:03PX}
\href{https://stacks.math.columbia.edu/tag/03PX}{\texttt{Stacks tag 03PX}}
\group{etale-cohomology}
...
\source{stacks:03PY}
\href{https://stacks.math.columbia.edu/tag/03PY}{\texttt{Stacks tag 03PY}}
\group{etale-cohomology}
...
$$
which is a sheaf by
Remark \ref{etale-cohomology-remark-direct-image-sheaf}.
We sometimes write $f_* = f_{small, *}$ to distinguish from other
direct image functors (such as usual Zariski pushforward or $f_{big, *}$).
\end{definition}
...
\begin{definition}[Higher direct images]
\label{etale-cohomology-definition-higher-direct-images}
\source{stacks:04I2}
\href{https://stacks.math.columbia.edu/tag/04I2}{\texttt{Stacks tag 04I2}}
\group{etale-cohomology}
...
\source{stacks:03Q0}
\href{https://stacks.math.columbia.edu/tag/03Q0}{\texttt{Stacks tag 03Q0}}
\group{etale-cohomology}
...
Remark \ref{etale-cohomology-remark-functoriality-general}
...
\begin{lemma}[Stalk pullback]
\label{etale-cohomology-lemma-stalk-pullback}
\source{stacks:03Q1}
\href{https://stacks.math.columbia.edu/tag/03Q1}{\texttt{Stacks tag 03Q1}}
\group{etale-cohomology}
...
\begin{remark}[Functoriality general]
\label{etale-cohomology-remark-functoriality-general}
\source{stacks:03Q2}
\href{https://stacks.math.columbia.edu/tag/03Q2}{\texttt{Stacks tag 03Q2}}
\group{etale-cohomology}
...
Sections \ref{etale-cohomology-section-functoriality}, \ref{etale-cohomology-section-direct-image}, and
...
\begin{lemma}[Where sections are equal]
\label{etale-cohomology-lemma-where-sections-are-equal}
\source{stacks:09XM}
\href{https://stacks.math.columbia.edu/tag/09XM}{\texttt{Stacks tag 09XM}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-support-subsheaf-final}
...
Lemma \ref{etale-cohomology-lemma-stalk-pullback}
we see that $W$ has the desired property.
\end{proof}

\begin{lemma}[Describe pullback]
\label{etale-cohomology-lemma-describe-pullback}
\source{stacks:09XN}
\href{https://stacks.math.columbia.edu/tag/09XN}{\texttt{Stacks tag 09XN}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-where-sections-are-equal}.
...
$$
\begin{array}{cc}T_{ij} \longrightarrow\downarrow & V_{ij} \downarrow \\ T_i \longrightarrow & T\end{array}
$$
...
\begin{lemma}[Sections upstairs]
\label{etale-cohomology-lemma-sections-upstairs}
\source{stacks:0A3H}
\href{https://stacks.math.columbia.edu/tag/0A3H}{\texttt{Stacks tag 0A3H}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-describe-pullback} to see that suffices to prove that
...
Here is a version of Lemma \ref{etale-cohomology-lemma-sections-upstairs}
where we do not assume that the morphism is flat.

\begin{lemma}[Sections upstairs submersive]
\label{etale-cohomology-lemma-sections-upstairs-submersive}
\source{stacks:0EZK}
\href{https://stacks.math.columbia.edu/tag/0EZK}{\texttt{Stacks tag 0EZK}}
\group{etale-cohomology}
...
$$
See Lemma \ref{etale-cohomology-lemma-stalk-pullback}.
...
\medskip\noindent
By Lemma \ref{etale-cohomology-lemma-where-sections-are-equal}
...
\begin{lemma}[Sections base field extension]
\label{etale-cohomology-lemma-sections-base-field-extension}
\source{stacks:0A3I}
\href{https://stacks.math.columbia.edu/tag/0A3I}{\texttt{Stacks tag 0A3I}}
\group{etale-cohomology}
...
\begin{proof}
Follows from Lemma \ref{etale-cohomology-lemma-sections-upstairs}. Namely, it is clear
...
sense, see
Theorem \ref{etale-cohomology-theorem-fully-faithful}.

\begin{lemma}[Morphism locally ringed]
\label{etale-cohomology-lemma-morphism-locally-ringed}
\source{stacks:04I5}
\href{https://stacks.math.columbia.edu/tag/04I5}{\texttt{Stacks tag 04I5}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-etale-site-locally-ringed}.
...
Lemma \ref{etale-cohomology-lemma-points-small-etale-site}
...
\begin{lemma}[2 morphism]
\label{etale-cohomology-lemma-2-morphism}
\source{stacks:04IJ}
\href{https://stacks.math.columbia.edu/tag/04IJ}{\texttt{Stacks tag 04IJ}}
\group{etale-cohomology}
...
$$
\begin{array}{ccc}f_{small}^{-1}\mathcal{O}_Y
\underset{f_{small}^\sharp}{\searrow} &  & f_{small}^{-1}\mathcal{O}_Y \overset{t}{\longleftarrow}\overset{f_{small}^\sharp}{\swarrow} \\  & \mathcal{O}_X & \end{array}
$$
...
$$
\begin{array}{ccc}f_{small}^{-1}h_V \overset{f^{-1}h_i}{\longrightarrow} & \prod_{j = 1, \ldots, n} f_{small}^{-1}\mathcal{O}_Y
\overset{\prod f^\sharp}{\longrightarrow} & \prod_{j = 1, \ldots, n} \mathcal{O}_X\end{array}
$$
(verification omitted). This means that the map
$t : f_{small}^{-1}h_V \to f_{small}^{-1}h_V$
fits into the commutative diagram
$$
\begin{array}{ccc}f_{small}^{-1}h_V \overset{f^{-1}h_i}{\longrightarrow}\overset{t}{\downarrow} & \prod_{j = 1, \ldots, n} f_{small}^{-1}\mathcal{O}_Y
\overset{\prod f^\sharp}{\longrightarrow}\overset{\prod t}{\downarrow} & \prod_{j = 1, \ldots, n} \mathcal{O}_X \overset{\text{id}}{\downarrow} \\ f_{small}^{-1}h_V \overset{f^{-1}h_i}{\longrightarrow} & \prod_{j = 1, \ldots, n} f_{small}^{-1}\mathcal{O}_Y
\overset{\prod f^\sharp}{\longrightarrow} & \prod_{j = 1, \ldots, n} \mathcal{O}_X\end{array}
$$
...
\source{stacks:04LW}
\href{https://stacks.math.columbia.edu/tag/04LW}{\texttt{Stacks tag 04LW}}
\group{etale-cohomology}
...
$$
\begin{array}{ccccc}h_{b^{-1}(V)} \xlongequal{} & b_{small}^{-1}h_V \overset{b_{small}^{-1}(f)}{\downarrow} &  & a_{small}^{-1}h_V \overset{a_{small}^{-1}(f)}{\downarrow}\overset{t}{\longleftarrow} & h_{a^{-1}(V)} \xlongequal{} \\  & b_{small}^{-1}\mathcal{O}_Y
\underset{b^\sharp}{\searrow} &  & a_{small}^{-1}\mathcal{O}_Y \overset{t}{\longleftarrow}\overset{a^\sharp}{\swarrow} &  \\  &  & \mathcal{O}_X &  & \end{array}
$$
...
\begin{lemma}[Morphism ringed etale topoi affines]
\label{etale-cohomology-lemma-morphism-ringed-etale-topoi-affines}
\source{stacks:04I6}
\href{https://stacks.math.columbia.edu/tag/04I6}{\texttt{Stacks tag 04I6}}
\group{etale-cohomology}
...
\overset{a}{\longrightarrow}\underset{b}{\longrightarrow} & \prod\nolimits_{j = 1, \ldots, n} \mathcal{O}_Y\end{array}
$$
...
$$
\begin{array}{ccc}g^{-1}h_V \longrightarrow\downarrow & \prod\nolimits_{i = 1, \ldots, n} g^{-1}\mathcal{O}_Y
\overset{g^{-1}a}{\longrightarrow}\underset{g^{-1}b}{\longrightarrow}\overset{\prod g^\sharp}{\downarrow} & \prod\nolimits_{j = 1, \ldots, n} g^{-1}\mathcal{O}_Y \overset{\prod g^\sharp}{\downarrow} \\ h_{X \times_Y V} \longrightarrow & \prod\nolimits_{i = 1, \ldots, n} \mathcal{O}_X
\overset{a'}{\longrightarrow}\underset{b'}{\longrightarrow} & \prod\nolimits_{j = 1, \ldots, n} \mathcal{O}_X \\  &  & \end{array}
$$
...
$$
\begin{array}{cc}h_{V_1} \downarrow\longrightarrow & \prod_{i = 1, \ldots, n_1} \mathcal{O}_Y
\overset{Q_1, \ldots, Q_{n_2}}{\downarrow} \\ h_{V_2} \longrightarrow & \prod_{i = 1, \ldots, n_2} \mathcal{O}_Y\end{array}
$$
is commutative, and pulling back to $X_\etale$ we obtain the
solid commutative diagram
$$
\begin{array}{cccc}g^{-1}h_{V_1} \downarrow\searrow\longrightarrow & \prod_{i = 1, \ldots, n_1} g^{-1}\mathcal{O}_Y
\overset{g^\sharp}{\downarrow}\overset{Q_1, \ldots, Q_{n_2}}{\searrow} &  &  \\  &  & g^{-1}h_{V_2} \downarrow\longrightarrow & \prod_{i = 1, \ldots, n_2} g^{-1}\mathcal{O}_Y
\overset{g^\sharp}{\downarrow} \\ h_{X \times_Y V_1} \longrightarrow\searrow & \prod\nolimits_{i = 1, \ldots, n_1} \mathcal{O}_X
\overset{Q'_1, \ldots, Q'_{n_2}}{\searrow} &  &  \\  &  & h_{X \times_Y V_2} \longrightarrow & \prod\nolimits_{i = 1, \ldots, n_2} \mathcal{O}_X\end{array}
$$
...
$$
\begin{array}{cc}g^{-1}h_V \longrightarrow\downarrow & \prod\nolimits_{i = 1, \ldots, n} g^{-1}\mathcal{O}_Y
\overset{\prod g^\sharp}{\downarrow} \\ h_{X \times_Y V} \longrightarrow & \prod\nolimits_{i = 1, \ldots, n} \mathcal{O}_X\end{array}
$$
...
\begin{theorem}[Fully faithful]
\label{etale-cohomology-theorem-fully-faithful}
\source{stacks:04I7}
\href{https://stacks.math.columbia.edu/tag/04I7}{\texttt{Stacks tag 04I7}}
\group{etale-cohomology}
...
the proof of
Lemma \ref{etale-cohomology-lemma-morphism-ringed-etale-topoi-affines}
...
Lemma \ref{etale-cohomology-lemma-2-morphism}.
...
(\Sh(X_\etale), \mathcal{O}_X)$
by
Lemma \ref{etale-cohomology-lemma-morphism-locally-ringed}.
...
Lemma \ref{etale-cohomology-lemma-faithful})
we conclude that
...
notation)
$$
\begin{array}{ccc}g \circ j_{i, small} \circ j_{i, i', small}
\overset{t_i \star \text{id}_{j_{i, i', small}}}{\longrightarrow}\downarrow &  & f_{small} \circ j_{i, small} \circ j_{i, i', small} \downarrow \\ g \circ j_{i', small} \circ j_{i', i, small}
\overset{t_{i'} \star \text{id}_{j_{i', i, small}}}{\longrightarrow} &  & f_{small} \circ j_{i', small} \circ j_{i', i, small}\end{array}
$$
...
topoi
$$
\begin{array}{cc}(\Sh(W_\etale), \mathcal{O}_W) \longrightarrow\underset{g'}{\downarrow} & (\Sh(X_\etale), \mathcal{O}_X) \overset{g}{\downarrow} \\ (\Sh(V_\etale), \mathcal{O}_V) \longrightarrow & (\Sh(Y_\etale), \mathcal{O}_Y)\end{array}
$$
...
Please see Section \ref{etale-cohomology-section-monomorphisms} for the definition of property
(A).

\begin{lemma}[Property A implies]
\label{etale-cohomology-lemma-property-A-implies}
\source{stacks:04DK}
\href{https://stacks.math.columbia.edu/tag/04DK}{\texttt{Stacks tag 04DK}}
\group{etale-cohomology}
...
\begin{lemma}[Locally quasi finite A]
\label{etale-cohomology-lemma-locally-quasi-finite-A}
\source{stacks:04DL}
\href{https://stacks.math.columbia.edu/tag/04DL}{\texttt{Stacks tag 04DL}}
\group{etale-cohomology}
...
$$
\begin{array}{ccc}U \downarrow & U \times_Y V \longleftarrow\downarrow & W' \amalg R' \downarrow\longleftarrow \\ X \downarrow & X \times_Y V \longleftarrow\downarrow & W \amalg R \longleftarrow \\ Y & V \longleftarrow & \end{array}
$$
...
\begin{lemma}[Integral A]
\label{etale-cohomology-lemma-integral-A}
\source{stacks:04DM}
\href{https://stacks.math.columbia.edu/tag/04DM}{\texttt{Stacks tag 04DM}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-locally-quasi-finite-A}.
\end{proof}

\begin{lemma}[When push pull surjective]
\label{etale-cohomology-lemma-when-push-pull-surjective}
\source{stacks:04C9}
\href{https://stacks.math.columbia.edu/tag/04C9}{\texttt{Stacks tag 04C9}}
\group{etale-cohomology}
...
\begin{proof}
Combine
Lemmas \ref{etale-cohomology-lemma-locally-quasi-finite-A},
\ref{etale-cohomology-lemma-integral-A}, and
...
\begin{lemma}[Property B implies]
\label{etale-cohomology-lemma-property-B-implies}
\source{stacks:04DO}
\href{https://stacks.math.columbia.edu/tag/04DO}{\texttt{Stacks tag 04DO}}
\group{etale-cohomology}
...
\begin{lemma}[Simplify B]
\label{etale-cohomology-lemma-simplify-B}
\source{stacks:04DP}
\href{https://stacks.math.columbia.edu/tag/04DP}{\texttt{Stacks tag 04DP}}
\group{etale-cohomology}
...
\begin{lemma}[Finite B]
\label{etale-cohomology-lemma-finite-B}
\source{stacks:04DQ}
\href{https://stacks.math.columbia.edu/tag/04DQ}{\texttt{Stacks tag 04DQ}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-simplify-B}.
...
Lemma \ref{etale-cohomology-lemma-integral-A}
...
Here is a picture:
$$
\begin{array}{ccccc} &  &  & U_{i_l} \downarrow &  \\ W_l \nearrow\longrightarrow & W_l \amalg R_l \xlongequal{} & X \times_Y V' \longrightarrow\downarrow & X \times_Y V \longrightarrow\downarrow & X \downarrow \\  &  & V' \longrightarrow & V \longrightarrow & Y\end{array}
$$
...
\begin{lemma}[Integral B]
\label{etale-cohomology-lemma-integral-B}
\source{stacks:04DR}
\href{https://stacks.math.columbia.edu/tag/04DR}{\texttt{Stacks tag 04DR}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-finite-B}.
\end{proof}

\begin{lemma}[What integral]
\label{etale-cohomology-lemma-what-integral}
\source{stacks:04C2}
\href{https://stacks.math.columbia.edu/tag/04C2}{\texttt{Stacks tag 04C2}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-when-push-pull-surjective}.
Part (1) follows from
Lemmas \ref{etale-cohomology-lemma-integral-B} and \ref{etale-cohomology-lemma-property-B-implies}.
...
\begin{lemma}[Property C implies]
\label{etale-cohomology-lemma-property-C-implies}
\source{stacks:04DT}
\href{https://stacks.math.columbia.edu/tag/04DT}{\texttt{Stacks tag 04DT}}
\group{etale-cohomology}
...
\begin{remark}[Property C strong]
\label{etale-cohomology-remark-property-C-strong}
\source{stacks:04DU}
\href{https://stacks.math.columbia.edu/tag/04DU}{\texttt{Stacks tag 04DU}}
\group{etale-cohomology}
...
\begin{lemma}[Property C closed implies]
\label{etale-cohomology-lemma-property-C-closed-implies}
\source{stacks:04DV}
\href{https://stacks.math.columbia.edu/tag/04DV}{\texttt{Stacks tag 04DV}}
\group{etale-cohomology}
...
\begin{lemma}[Integral homeo onto image C]
\label{etale-cohomology-lemma-integral-homeo-onto-image-C}
\source{stacks:04DW}
\href{https://stacks.math.columbia.edu/tag/04DW}{\texttt{Stacks tag 04DW}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-integral-B},
...
\begin{lemma}[Integral universally injective]
\label{etale-cohomology-lemma-integral-universally-injective}
\source{stacks:04DX}
\href{https://stacks.math.columbia.edu/tag/04DX}{\texttt{Stacks tag 04DX}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-property-B-implies}.
\end{enumerate}
...
\begin{theorem}[Etale topological]
\label{etale-cohomology-theorem-etale-topological}
\source{stacks:0BTY}
\href{https://stacks.math.columbia.edu/tag/0BTY}{\texttt{Stacks tag 0BTY}}
\group{etale-cohomology}
...
\source{stacks:04DZ}
\href{https://stacks.math.columbia.edu/tag/04DZ}{\texttt{Stacks tag 04DZ}}
\group{etale-cohomology}
...
By Theorem \ref{etale-cohomology-theorem-etale-topological}
...
Recall that in the proof of Theorem \ref{etale-cohomology-theorem-etale-topological}
...
\medskip\noindent
By
Lemma \ref{etale-cohomology-lemma-integral-homeo-onto-image-C}
...
$$
\begin{array}{ccc}U \downarrow & U \times_Y W \longleftarrow\downarrow & W_X \amalg R \xlongequal{} \\ X \downarrow & W_X \longleftarrow\downarrow &  \\ Y & W \longleftarrow & \end{array}
$$
...
\begin{remark}[Affine inside equivalence]
\label{etale-cohomology-remark-affine-inside-equivalence}
\source{stacks:05YX}
\href{https://stacks.math.columbia.edu/tag/05YX}{\texttt{Stacks tag 05YX}}
\group{etale-cohomology}
...
\source{stacks:03SI}
\href{https://stacks.math.columbia.edu/tag/03SI}{\texttt{Stacks tag 03SI}}
\group{etale-cohomology}
...
given by Theorem \ref{etale-cohomology-theorem-topological-invariance}. We omit
...
\begin{lemma}[Closed immersion almost full]
\label{etale-cohomology-lemma-closed-immersion-almost-full}
\source{stacks:04FV}
\href{https://stacks.math.columbia.edu/tag/04FV}{\texttt{Stacks tag 04FV}}
\group{etale-cohomology}
...
$$
\begin{array}{ccc}U & W \underset{a}{\longleftarrow}\overset{b}{\longrightarrow} & U'\end{array}
$$
...
\begin{lemma}[Closed immersion almost essentially surjective]
\label{etale-cohomology-lemma-closed-immersion-almost-essentially-surjective}
\source{stacks:04FW}
\href{https://stacks.math.columbia.edu/tag/04FW}{\texttt{Stacks tag 04FW}}
\group{etale-cohomology}
...
\begin{lemma}[Stalk pushforward closed immersion]
\label{etale-cohomology-lemma-stalk-pushforward-closed-immersion}
\source{stacks:04FX}
\href{https://stacks.math.columbia.edu/tag/04FX}{\texttt{Stacks tag 04FX}}
\group{etale-cohomology}
...
Lemmas \ref{etale-cohomology-lemma-closed-immersion-almost-essentially-surjective} and
...
\begin{proposition}[Closed immersion pushforward]
\label{etale-cohomology-proposition-closed-immersion-pushforward}
\source{stacks:04CA}
\href{https://stacks.math.columbia.edu/tag/04CA}{\texttt{Stacks tag 04CA}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-stalk-pushforward-closed-immersion}
(and
Theorem \ref{etale-cohomology-theorem-exactness-stalks}).
...
$$
Combining
Lemmas \ref{etale-cohomology-lemma-stalk-pushforward-closed-immersion} and
...
\begin{proposition}[Integral universally injective pushforward]
\label{etale-cohomology-proposition-integral-universally-injective-pushforward}
\source{stacks:04FZ}
\href{https://stacks.math.columbia.edu/tag/04FZ}{\texttt{Stacks tag 04FZ}}
\group{etale-cohomology}
...
We may factor $f$ as
$$
\begin{array}{ccc}X \overset{h}{\longrightarrow} & Z \overset{i}{\longrightarrow} & Y\end{array}
$$
...
\begin{lemma}[Monomorphism big push pull]
\label{etale-cohomology-lemma-monomorphism-big-push-pull}
\source{stacks:04C7}
\href{https://stacks.math.columbia.edu/tag/04C7}{\texttt{Stacks tag 04C7}}
\group{etale-cohomology}
...
\begin{remark}[Push pull shriek]
\label{etale-cohomology-remark-push-pull-shriek}
\source{stacks:04C8}
\href{https://stacks.math.columbia.edu/tag/04C8}{\texttt{Stacks tag 04C8}}
\group{etale-cohomology}

In the situation of
Lemma \ref{etale-cohomology-lemma-monomorphism-big-push-pull}
...
\begin{lemma}[Closed immersion cover from below]
\label{etale-cohomology-lemma-closed-immersion-cover-from-below}
\source{stacks:04E3}
\href{https://stacks.math.columbia.edu/tag/04E3}{\texttt{Stacks tag 04E3}}
\group{etale-cohomology}
...
\begin{lemma}[Prepare closed immersion almost cocontinuous]
\label{etale-cohomology-lemma-prepare-closed-immersion-almost-cocontinuous}
\source{stacks:04E4}
\href{https://stacks.math.columbia.edu/tag/04E4}{\texttt{Stacks tag 04E4}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-closed-immersion-cover-from-below}.
...
\begin{lemma}[Closed immersion almost cocontinuous]
\label{etale-cohomology-lemma-closed-immersion-almost-cocontinuous}
\source{stacks:04C3}
\href{https://stacks.math.columbia.edu/tag/04C3}{\texttt{Stacks tag 04C3}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-prepare-closed-immersion-almost-cocontinuous}
above to the closed immersion $X \times_Y V \to V$.
\end{proof}

\begin{lemma}[Closed immersion pushforward exact]
\label{etale-cohomology-lemma-closed-immersion-pushforward-exact}
\source{stacks:04C4}
\href{https://stacks.math.columbia.edu/tag/04C4}{\texttt{Stacks tag 04C4}}
\group{etale-cohomology}
...
and
Lemma \ref{etale-cohomology-lemma-closed-immersion-almost-cocontinuous}
above.
\end{proof}

\begin{remark}[Fppf closed immersion not closed]
\label{etale-cohomology-remark-fppf-closed-immersion-not-closed}
\source{stacks:04C5}
\href{https://stacks.math.columbia.edu/tag/04C5}{\texttt{Stacks tag 04C5}}
\group{etale-cohomology}

In Lemma \ref{etale-cohomology-lemma-closed-immersion-pushforward-exact} the case $\tau = fppf$
...
\source{stacks:04CC}
\href{https://stacks.math.columbia.edu/tag/04CC}{\texttt{Stacks tag 04CC}}
\group{etale-cohomology}
...
\begin{lemma}[Compare structure sheaves]
\label{etale-cohomology-lemma-compare-structure-sheaves}
\source{stacks:07AJ}
\href{https://stacks.math.columbia.edu/tag/07AJ}{\texttt{Stacks tag 07AJ}}
\group{etale-cohomology}
...
\source{stacks:0A50}
\href{https://stacks.math.columbia.edu/tag/0A50}{\texttt{Stacks tag 0A50}}
\group{etale-cohomology}
...
Lemmas \ref{etale-cohomology-lemma-hom-injective} and \ref{etale-cohomology-lemma-forget-injectives}.
...
\source{stacks:0EYK}
\href{https://stacks.math.columbia.edu/tag/0EYK}{\texttt{Stacks tag 0EYK}}
\group{etale-cohomology}
...
0
$$
was shown to be short exact in the proof of Lemma \ref{etale-cohomology-lemma-mayer-vietoris}.
...
\begin{definition}[Inverse system sheaves]
\label{etale-cohomology-definition-inverse-system-sheaves}
\source{stacks:0EZL}
\href{https://stacks.math.columbia.edu/tag/0EZL}{\texttt{Stacks tag 0EZL}}
\group{etale-cohomology}
...
In the situation of Definition \ref{etale-cohomology-definition-inverse-system-sheaves},
...
for all $i$, see Theorem \ref{etale-cohomology-theorem-colimit}.

\begin{lemma}[Colimit affine sites]
\label{etale-cohomology-lemma-colimit-affine-sites}
\source{stacks:0EYL}
\href{https://stacks.math.columbia.edu/tag/0EYL}{\texttt{Stacks tag 0EYL}}
\group{etale-cohomology}
...
\begin{theorem}[Colimit]
\label{etale-cohomology-theorem-colimit}
\source{stacks:09YQ}
\href{https://stacks.math.columbia.edu/tag/09YQ}{\texttt{Stacks tag 09YQ}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-colimit-affine-sites}
and
...
\source{stacks:03Q5}
\href{https://stacks.math.columbia.edu/tag/03Q5}{\texttt{Stacks tag 03Q5}}
\group{etale-cohomology}
...
\begin{proof}
This is a special case of Theorem \ref{etale-cohomology-theorem-colimit}.
...
(Theorem \ref{etale-cohomology-theorem-cech-ss}) and the fact that the induction
...
\begin{lemma}[Directed colimit cohomology]
\label{etale-cohomology-lemma-directed-colimit-cohomology}
\source{stacks:03Q6}
\href{https://stacks.math.columbia.edu/tag/03Q6}{\texttt{Stacks tag 03Q6}}
\group{etale-cohomology}
...
\begin{lemma}[Higher direct images]
\label{etale-cohomology-lemma-higher-direct-images}
\source{stacks:03Q8}
\href{https://stacks.math.columbia.edu/tag/03Q8}{\texttt{Stacks tag 03Q8}}
\group{etale-cohomology}
...
\begin{lemma}[Relative colimit]
\label{etale-cohomology-lemma-relative-colimit}
\source{stacks:09Z1}
\href{https://stacks.math.columbia.edu/tag/09Z1}{\texttt{Stacks tag 09Z1}}
\group{etale-cohomology}
...
\begin{proof}
Recall (Lemma \ref{etale-cohomology-lemma-higher-direct-images})
...
$$
by Theorem \ref{etale-cohomology-theorem-colimit}. Thus the lemma follows.
\end{proof}

\begin{lemma}[Relative colimit general]
\label{etale-cohomology-lemma-relative-colimit-general}
\source{stacks:0EYM}
\href{https://stacks.math.columbia.edu/tag/0EYM}{\texttt{Stacks tag 0EYM}}
\group{etale-cohomology}
...
$$
\begin{array}{ccc}X \underset{f_{i'}}{\longrightarrow}\underset{g}{\downarrow} & X_{i'} \underset{f_{i'i}}{\longrightarrow}\underset{g_{i'}}{\downarrow} & X_i \overset{g_i}{\downarrow} \\ S \overset{h_{i'}}{\longrightarrow} & S_{i'} \overset{h_{i'i}}{\longrightarrow} & S_i\end{array}
$$
...
$U$ affine and \'etale over $X$ by Theorem \ref{etale-cohomology-theorem-colimit}
we have
$$
g_*\mathcal{F}(U) =
...
Theorem \ref{etale-cohomology-theorem-colimit} we have
$$
...
Lemma \ref{etale-cohomology-lemma-colimit-affine-sites}. Thus if $U$ is an object of
...
(Lemma \ref{etale-cohomology-lemma-higher-direct-images})
we obtain a canonical commutative diagram
$$
\begin{array}{cc}\colim_{i' \geq i}
H^p(U_i \times_{S_i} X_{i'}, \mathcal{F}_{i'}) \longrightarrow\downarrow & \colim_{i' \geq i}
(R^p g_{i', *}\mathcal{F}_{i'})(U_i \times_{S_i} S_{i'}) \downarrow \\ H^p(U \times_S X, \mathcal{F}) \longrightarrow & R^pg_*\mathcal{F}(U)\end{array}
$$
Observe that the left hand vertical arrow is an isomorphism
by Theorem \ref{etale-cohomology-theorem-colimit}. We're trying to show that
...
\begin{lemma}[Linus hamann]
\label{etale-cohomology-lemma-linus-hamann}
\source{stacks:0EYN}
\href{https://stacks.math.columbia.edu/tag/0EYN}{\texttt{Stacks tag 0EYN}}
\group{etale-cohomology}
...
Definition \ref{etale-cohomology-definition-inverse-system-sheaves}, and
...
Lemma \ref{etale-cohomology-lemma-colimit-affine-sites} this is a special case of
Sites, Lemma \ref{sites-lemma-colimit-push-pull}.
\end{proof}

\begin{lemma}[Compute strangely]
\label{etale-cohomology-lemma-compute-strangely}
\source{stacks:0DV2}
\href{https://stacks.math.columbia.edu/tag/0DV2}{\texttt{Stacks tag 0DV2}}
\group{etale-cohomology}
...
\begin{proof}
Formal combination of Lemmas \ref{etale-cohomology-lemma-relative-colimit-general}
and \ref{etale-cohomology-lemma-linus-hamann}.
\end{proof}
...
in Section \ref{etale-cohomology-section-colimit}.
We strongly urge the reader not to read this section unless absolutely
necessary.

\begin{lemma}[Colimit variant complexes]
\label{etale-cohomology-lemma-colimit-variant-complexes}
\source{stacks:0EZM}
\href{https://stacks.math.columbia.edu/tag/0EZM}{\texttt{Stacks tag 0EZM}}
\group{etale-cohomology}
...
\begin{proof}
This is a consequence of Theorem \ref{etale-cohomology-theorem-colimit}. Set
...
\begin{lemma}[Direct sum bounded below cohomology]
\label{etale-cohomology-lemma-direct-sum-bounded-below-cohomology}
\source{stacks:0GIS}
\href{https://stacks.math.columbia.edu/tag/0GIS}{\texttt{Stacks tag 0GIS}}
\group{etale-cohomology}
...
from Lemma \ref{etale-cohomology-lemma-colimit-variant-complexes}.
\end{proof}

\begin{lemma}[Colimit complexes]
\label{etale-cohomology-lemma-colimit-complexes}
\source{stacks:0GIT}
\href{https://stacks.math.columbia.edu/tag/0GIT}{\texttt{Stacks tag 0GIT}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-colimit-variant-complexes}.
\end{proof}

\begin{lemma}[Relative colimit general complexes]
\label{etale-cohomology-lemma-relative-colimit-general-complexes}
\source{stacks:0GIU}
\href{https://stacks.math.columbia.edu/tag/0GIU}{\texttt{Stacks tag 0GIU}}
\group{etale-cohomology}

Let $I$, $g_i : X_i \to S_i$, $g : X \to S$, $f_i$, $g_i$, $h_i$ be as in
Lemma \ref{etale-cohomology-lemma-relative-colimit-general}.
...
$$
\begin{array}{cc}\colim_{i \geq 0} h_i^{-1}R^{p - 1}g_{i, *}(\tau_{\geq a + 1}K_i)
\underset{\alpha}{\longrightarrow}\downarrow & R^{p - 1}g_*(\tau_{\geq a + 1}K) \downarrow \\ \colim_{i \geq 0} h_i^{-1}R^pg_{i, *}(H^a(K_i)[-a])
\underset{\beta}{\longrightarrow}\downarrow & R^pg_*(H^a(K)[-a]) \downarrow \\ \colim_{i \geq 0} h_i^{-1}R^pg_{i, *}K_i
\underset{\gamma}{\longrightarrow}\downarrow & R^pg_*K \downarrow \\ \colim_{i \geq 0} R^pg_{i, *}\tau_{\geq a + 1}K_i
\underset{\delta}{\longrightarrow}\downarrow & R^pg_*\tau_{\geq a + 1}K \downarrow \\ \colim_{i \geq 0} R^{p + 1}g_{i, *}(H^a(K_i)[-a])
\overset{\epsilon}{\longrightarrow} & R^{p + 1}g_*(H^a(K)[-a])\end{array}
$$
...
\begin{lemma}[Relative colimit general really complexes]
\label{etale-cohomology-lemma-relative-colimit-general-really-complexes}
\source{stacks:0GIV}
\href{https://stacks.math.columbia.edu/tag/0GIV}{\texttt{Stacks tag 0GIV}}
\group{etale-cohomology}

Let $I$, $g_i : X_i \to S_i$, $g : X \to S$, $f_{ii'}$, $f_i$, $g_i$, $h_i$
be as in Lemma \ref{etale-cohomology-lemma-relative-colimit-general}.
Let $\mathcal{F}_i^\bullet$ be a complex of abelian sheaves on
$X_{i, \etale}$. Let $\varphi_{i'i} : f_{i'i}^{-1}\mathcal{F}_i^\bullet \to
\mathcal{F}_{i'}^\bullet$ be a map of complexes on $X_{i, \etale}$
such that $\varphi_{i''i} = \varphi_{i''i'} \circ f_{i'' i'}^{-1}\varphi_{i'i}$
...
\begin{proof}
This is a consequence of Lemma \ref{etale-cohomology-lemma-relative-colimit-general}. Set
$\mathcal{F}^\bullet = \colim f_i^{-1}\mathcal{F}_i^\bullet$.
...
\begin{lemma}[Direct sum bounded below pushforward]
\label{etale-cohomology-lemma-direct-sum-bounded-below-pushforward}
\source{stacks:0GIW}
\href{https://stacks.math.columbia.edu/tag/0GIW}{\texttt{Stacks tag 0GIW}}
\group{etale-cohomology}
...
Since $\bigoplus \mathcal{F}^\bullet$ is the filtered
colimit of the finite direct sums, the result follows
from Lemma \ref{etale-cohomology-lemma-relative-colimit-general-really-complexes}.
\end{proof}
...
\begin{theorem}[Higher direct images]
\label{etale-cohomology-theorem-higher-direct-images}
\source{stacks:03Q9}
\href{https://stacks.math.columbia.edu/tag/03Q9}{\texttt{Stacks tag 03Q9}}
\group{etale-cohomology}
...
on $S$. By Lemma \ref{etale-cohomology-lemma-higher-direct-images}
we have
$$
...
$$
by Lemma \ref{etale-cohomology-lemma-describe-etale-local-ring} and
Limits, Lemma
...
$$
We conclude by Lemma \ref{etale-cohomology-lemma-directed-colimit-cohomology}.
For the second variant, use the same argument using
Lemma \ref{etale-cohomology-lemma-colimit-complexes} instead of
Lemma \ref{etale-cohomology-lemma-directed-colimit-cohomology}.
...
\begin{remark}[Stalk fibre]
\label{etale-cohomology-remark-stalk-fibre}
\source{stacks:0GIX}
\href{https://stacks.math.columbia.edu/tag/0GIX}{\texttt{Stacks tag 0GIX}}
\group{etale-cohomology}
...
$$
\begin{array}{ccc}X_{\overline{s}} \longrightarrow\overset{f_{\overline{s}}}{\downarrow} & X \times_S \Spec(\mathcal{O}_{S, \overline{s}}^{sh}) \underset{p}{\longrightarrow}\overset{f'}{\downarrow} & X \overset{f}{\downarrow} \\ \overline{s} \overset{i}{\longrightarrow} & \Spec(\mathcal{O}_{S, \overline{s}}^{sh}) \overset{j}{\longrightarrow} & S\end{array}
$$
...
\begin{lemma}[Prepare leray]
\label{etale-cohomology-lemma-prepare-leray}
\source{stacks:03QB}
\href{https://stacks.math.columbia.edu/tag/03QB}{\texttt{Stacks tag 03QB}}
\group{etale-cohomology}
...
which has vanishing higher cohomology groups by Lemma \ref{etale-cohomology-lemma-hom-injective}.
...
$R^pg_*$ in Lemma \ref{etale-cohomology-lemma-higher-direct-images}.
\end{proof}
...
\source{stacks:03QC}
\href{https://stacks.math.columbia.edu/tag/03QC}{\texttt{Stacks tag 03QC}}
\group{etale-cohomology}
...
\begin{proof}
See Lemma \ref{etale-cohomology-lemma-prepare-leray} and see
...
\begin{lemma}[Vanishing etale cohomology strictly henselian]
\label{etale-cohomology-lemma-vanishing-etale-cohomology-strictly-henselian}
\source{stacks:03QO}
\href{https://stacks.math.columbia.edu/tag/03QO}{\texttt{Stacks tag 03QO}}
\group{etale-cohomology}
...
By Theorem \ref{etale-cohomology-theorem-henselian} we see that $A \cong R \times A'$
as an $R$-algebra compatible with maps to
$\kappa(\overline{s}) = \kappa(\overline{u})$.
Hence we get a section
$$
\begin{array}{cc}\Spec(A) \longrightarrow & U \downarrow \\  & S \nwarrow\end{array}
$$
...
\begin{proposition}[Finite higher direct image zero]
\label{etale-cohomology-proposition-finite-higher-direct-image-zero}
\source{stacks:03QP}
\href{https://stacks.math.columbia.edu/tag/03QP}{\texttt{Stacks tag 03QP}}
\group{etale-cohomology}
...
By Theorem \ref{etale-cohomology-theorem-higher-direct-images}
...
Lemma \ref{etale-cohomology-lemma-finite-over-henselian}
...
The vanishing of
Lemma \ref{etale-cohomology-lemma-vanishing-etale-cohomology-strictly-henselian}
implies that $(R^qf_*\mathcal{F})_{\overline{y}} = 0$ for $q > 0$
which implies (2) by Theorem \ref{etale-cohomology-theorem-exactness-stalks}.
Part (1) follows from the corresponding statement of
Lemma \ref{etale-cohomology-lemma-vanishing-etale-cohomology-strictly-henselian}.
\end{proof}

\begin{lemma}[Finite pushforward commutes with base change]
\label{etale-cohomology-lemma-finite-pushforward-commutes-with-base-change}
\source{stacks:0959}
\href{https://stacks.math.columbia.edu/tag/0959}{\texttt{Stacks tag 0959}}
\group{etale-cohomology}
...
It suffices to check on stalks (Theorem \ref{etale-cohomology-theorem-exactness-stalks}).
...
\begin{lemma}[Integral pushforward commutes with base change]
\label{etale-cohomology-lemma-integral-pushforward-commutes-with-base-change}
\source{stacks:0EYP}
\href{https://stacks.math.columbia.edu/tag/0EYP}{\texttt{Stacks tag 0EYP}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-finite-pushforward-commutes-with-base-change}.
For the fourth use Lemma \ref{etale-cohomology-lemma-relative-colimit}.
...
\begin{lemma}[Cohomological descent finite]
\label{etale-cohomology-lemma-cohomological-descent-finite}
\source{stacks:09Z2}
\href{https://stacks.math.columbia.edu/tag/09Z2}{\texttt{Stacks tag 09Z2}}
\group{etale-cohomology}
...
$$
by Proposition \ref{etale-cohomology-proposition-leray}
...
to check on stalks at geometric points (Theorem \ref{etale-cohomology-theorem-exactness-stalks}).
...
$$
by Proposition \ref{etale-cohomology-proposition-finite-higher-direct-image-zero}
and Lemma \ref{etale-cohomology-lemma-stalk-pullback}.
...
\begin{remark}[Cohomological descent finite]
\label{etale-cohomology-remark-cohomological-descent-finite}
\source{stacks:09Z3}
\href{https://stacks.math.columbia.edu/tag/09Z3}{\texttt{Stacks tag 09Z3}}
\group{etale-cohomology}

In the situation of Lemma \ref{etale-cohomology-lemma-cohomological-descent-finite}
if $\mathcal{G}$ is a sheaf of sets on $Y_\etale$, then we have
$$
\Gamma(Y, \mathcal{G}) =
\text{Equalizer}(
\begin{array}{cc}\Gamma(X_0, f_0^{-1}\mathcal{G})
\longrightarrow\longrightarrow & \Gamma(X_1, f_1^{-1}\mathcal{G})\end{array}
)
$$
...
\begin{definition}[Algebraic geometric point]
\label{etale-cohomology-definition-algebraic-geometric-point}
\source{stacks:03QX}
\href{https://stacks.math.columbia.edu/tag/03QX}{\texttt{Stacks tag 03QX}}
\group{etale-cohomology}
...
\begin{example}[Stupid]
\label{etale-cohomology-example-stupid}
\source{stacks:03QY}
\href{https://stacks.math.columbia.edu/tag/03QY}{\texttt{Stacks tag 03QY}}
\group{etale-cohomology}
...
\begin{theorem}[Equivalence sheaves point]
\label{etale-cohomology-theorem-equivalence-sheaves-point}
\source{stacks:03QT}
\href{https://stacks.math.columbia.edu/tag/03QT}{\texttt{Stacks tag 03QT}}
\group{etale-cohomology}
...
\begin{remark}[Every sheaf representable]
\label{etale-cohomology-remark-every-sheaf-representable}
\source{stacks:04JL}
\href{https://stacks.math.columbia.edu/tag/04JL}{\texttt{Stacks tag 04JL}}
\group{etale-cohomology}

Another way to state the conclusion of
Theorem \ref{etale-cohomology-theorem-equivalence-sheaves-point} and
Fundamental Groups, Lemma \ref{pione-lemma-sheaves-point}
...
\begin{lemma}[Global sections point]
\label{etale-cohomology-lemma-global-sections-point}
\source{stacks:04JM}
\href{https://stacks.math.columbia.edu/tag/04JM}{\texttt{Stacks tag 04JM}}
\group{etale-cohomology}
...
\begin{remark}[Stalk pullback]
\label{etale-cohomology-remark-stalk-pullback}
\source{stacks:04JN}
\href{https://stacks.math.columbia.edu/tag/04JN}{\texttt{Stacks tag 04JN}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-stalk-pullback} part (3)
...
Definitions \ref{etale-cohomology-definition-G-module-continuous} and
\ref{etale-cohomology-definition-galois-cohomology}. This includes
...
\begin{definition}[G module continuous]
\label{etale-cohomology-definition-G-module-continuous}
\source{stacks:04JP}
\href{https://stacks.math.columbia.edu/tag/04JP}{\texttt{Stacks tag 04JP}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-modules-abelian} that this agrees with the cohomology
of the underlying $G$-module.

\begin{definition}[Galois cohomology]
\label{etale-cohomology-definition-galois-cohomology}
\source{stacks:04JR}
\href{https://stacks.math.columbia.edu/tag/04JR}{\texttt{Stacks tag 04JR}}
\group{etale-cohomology}
...
\begin{lemma}[Modules abelian]
\label{etale-cohomology-lemma-modules-abelian}
\source{stacks:0DVD}
\href{https://stacks.math.columbia.edu/tag/0DVD}{\texttt{Stacks tag 0DVD}}
\group{etale-cohomology}

Let $G$ be a topological group. Let $R$ be a ring.
For every $i \geq 0$ the diagram
$$
\begin{array}{ccc}\text{Mod}_{R, G} \underset{H^i(G, -)}{\longrightarrow}\downarrow &  & \text{Mod}_R \downarrow \\ \text{Mod}_G \overset{H^i(G, -)}{\longrightarrow} &  & \textit{Ab}\end{array}
$$
...
\begin{lemma}[Ext modules hom]
\label{etale-cohomology-lemma-ext-modules-hom}
\source{stacks:0DVE}
\href{https://stacks.math.columbia.edu/tag/0DVE}{\texttt{Stacks tag 0DVE}}
\group{etale-cohomology}
...
\begin{lemma}[Finite dim group cohomology]
\label{etale-cohomology-lemma-finite-dim-group-cohomology}
\source{stacks:0DVF}
\href{https://stacks.math.columbia.edu/tag/0DVF}{\texttt{Stacks tag 0DVF}}
\group{etale-cohomology}
...
By Lemma \ref{etale-cohomology-lemma-ext-modules-hom}
...
\begin{lemma}[Profinite group cohomology torsion]
\label{etale-cohomology-lemma-profinite-group-cohomology-torsion}
\source{stacks:0DV3}
\href{https://stacks.math.columbia.edu/tag/0DV3}{\texttt{Stacks tag 0DV3}}
\group{etale-cohomology}
...
Definition \ref{etale-cohomology-definition-G-module-continuous} the functors
...
of Definition \ref{etale-cohomology-definition-galois-cohomology}
...
\begin{lemma}[Equivalence abelian sheaves point]
\label{etale-cohomology-lemma-equivalence-abelian-sheaves-point}
\source{stacks:04JQ}
\href{https://stacks.math.columbia.edu/tag/04JQ}{\texttt{Stacks tag 04JQ}}
\group{etale-cohomology}
...
\begin{lemma}[Compare cohomology point]
\label{etale-cohomology-lemma-compare-cohomology-point}
\source{stacks:03QU}
\href{https://stacks.math.columbia.edu/tag/03QU}{\texttt{Stacks tag 03QU}}
\group{etale-cohomology}

Notation and assumptions as in
Lemma \ref{etale-cohomology-lemma-equivalence-abelian-sheaves-point}.
...
Lemma \ref{etale-cohomology-lemma-equivalence-abelian-sheaves-point}
with
Lemma \ref{etale-cohomology-lemma-global-sections-point}.
\end{proof}

\begin{example}[Sheaves point]
\label{etale-cohomology-example-sheaves-point}
\source{stacks:03QV}
\href{https://stacks.math.columbia.edu/tag/03QV}{\texttt{Stacks tag 03QV}}
\group{etale-cohomology}
...
\end{enumerate}
By
Remark \ref{etale-cohomology-remark-special-case-fpqc-cohomology-quasi-coherent}
and
Theorem \ref{etale-cohomology-theorem-picard-group}
...
\begin{lemma}[All modules quasi coherent]
\label{etale-cohomology-lemma-all-modules-quasi-coherent}
\source{stacks:0D1W}
\href{https://stacks.math.columbia.edu/tag/0D1W}{\texttt{Stacks tag 0D1W}}
\group{etale-cohomology}
...
\begin{theorem}[Central simple algebra]
\label{etale-cohomology-theorem-central-simple-algebra}
\source{stacks:03R2}
\href{https://stacks.math.columbia.edu/tag/03R2}{\texttt{Stacks tag 03R2}}
\group{etale-cohomology}
...
\begin{lemma}[Brauer inverse]
\label{etale-cohomology-lemma-brauer-inverse}
\source{stacks:03R4}
\href{https://stacks.math.columbia.edu/tag/03R4}{\texttt{Stacks tag 03R4}}
\group{etale-cohomology}
...
\begin{definition}[Brauer equivalent]
\label{etale-cohomology-definition-brauer-equivalent}
\source{stacks:03R3}
\href{https://stacks.math.columbia.edu/tag/03R3}{\texttt{Stacks tag 03R3}}
\group{etale-cohomology}
...
\source{stacks:03R5}
\href{https://stacks.math.columbia.edu/tag/03R5}{\texttt{Stacks tag 03R5}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-annihilated-by-degree}).
...
\begin{lemma}[Central simple algebras are classified by Galois cohomology of PGL.]
\label{etale-cohomology-lemma-central-simple-algebra-pgln}
\source{stacks:03R6}
\href{https://stacks.math.columbia.edu/tag/03R6}{\texttt{Stacks tag 03R6}}
\group{etale-cohomology}
...
Theorem \ref{etale-cohomology-theorem-central-simple-algebra}, we see that
...
\begin{theorem}[Brauer delta]
\label{etale-cohomology-theorem-brauer-delta}
\source{stacks:03R7}
\href{https://stacks.math.columbia.edu/tag/03R7}{\texttt{Stacks tag 03R7}}
\group{etale-cohomology}
...
\begin{lemma}[End unique up to invertible]
\label{etale-cohomology-lemma-end-unique-up-to-invertible}
\source{stacks:0A2K}
\href{https://stacks.math.columbia.edu/tag/0A2K}{\texttt{Stacks tag 0A2K}}
\group{etale-cohomology}
...
\begin{lemma}[Annihilated by degree]
\label{etale-cohomology-lemma-annihilated-by-degree}
\source{stacks:0A2L}
\href{https://stacks.math.columbia.edu/tag/0A2L}{\texttt{Stacks tag 0A2L}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-end-unique-up-to-invertible}
...
(Proposition \ref{etale-cohomology-proposition-quasi-coherent-sheaf-fpqc}) we find a canonical
...
Theorem \ref{etale-cohomology-theorem-brauer-delta}
is a map
$$
...
\begin{lemma}[Vanishing affine char p p]
\label{etale-cohomology-lemma-vanishing-affine-char-p-p}
\source{stacks:0A3K}
\href{https://stacks.math.columbia.edu/tag/0A3K}{\texttt{Stacks tag 0A3K}}
\group{etale-cohomology}
...
\source{stacks:0A3L}
\href{https://stacks.math.columbia.edu/tag/0A3L}{\texttt{Stacks tag 0A3L}}
\group{etale-cohomology}
...
\source{stacks:0HAN}
\href{https://stacks.math.columbia.edu/tag/0HAN}{\texttt{Stacks tag 0HAN}}
\group{etale-cohomology}

In the situation of Lemma \ref{etale-cohomology-lemma-F-1} let $k'/k$ be an extension
...
By Lemma \ref{etale-cohomology-lemma-F-1} these equations
...
\begin{lemma}[Top cohomology coherent]
\label{etale-cohomology-lemma-top-cohomology-coherent}
\source{stacks:0A3M}
\href{https://stacks.math.columbia.edu/tag/0A3M}{\texttt{Stacks tag 0A3M}}
\group{etale-cohomology}
...
$$
\begin{array}{ccc}X \underset{g}{\searrow} & X' \overset{g'}{\downarrow}\overset{\pi}{\longleftarrow}\underset{i}{\longrightarrow} & \mathbf{P}^n_k \swarrow \\  & \Spec(k) & \end{array}
$$
...
\begin{lemma}[Vanishing variety char p p]
\label{etale-cohomology-lemma-vanishing-variety-char-p-p}
\source{stacks:0A3N}
\href{https://stacks.math.columbia.edu/tag/0A3N}{\texttt{Stacks tag 0A3N}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-vanishing-affine-char-p-p}
it suffices to show that
$H_\etale^{d + 1}(X, \underline{\mathbf{Z}/p\mathbf{Z}}) = 0$.
By Lemma \ref{etale-cohomology-lemma-top-cohomology-coherent} we see that
...
$$
By Lemma \ref{etale-cohomology-lemma-F-1} the map $F - 1$ in this sequence is surjective.
This proves the lemma.
\end{proof}

\begin{lemma}[Finiteness proper variety char p p]
\label{etale-cohomology-lemma-finiteness-proper-variety-char-p-p}
\source{stacks:0A3P}
\href{https://stacks.math.columbia.edu/tag/0A3P}{\texttt{Stacks tag 0A3P}}
\group{etale-cohomology}
...
Theorem \ref{etale-cohomology-theorem-zariski-fpqc-quasi-coherent} the cohomology groups
$H^q_\etale(X, \mathbf{G}_a) = H^q(X, \mathcal{O}_X)$ are
finite dimensional $k$-vector spaces. Hence by
Lemma \ref{etale-cohomology-lemma-F-1} the long exact cohomology sequence
...
from Lemma \ref{etale-cohomology-lemma-F-2}
...
\begin{definition}[Finite locally constant]
\label{etale-cohomology-definition-finite-locally-constant}
\source{stacks:03RU}
\href{https://stacks.math.columbia.edu/tag/03RU}{\texttt{Stacks tag 03RU}}
\group{etale-cohomology}
...
\source{stacks:095A}
\href{https://stacks.math.columbia.edu/tag/095A}{\texttt{Stacks tag 095A}}
\group{etale-cohomology}
...
\begin{lemma}[Pushforward locally constant]
\label{etale-cohomology-lemma-pushforward-locally-constant}
\source{stacks:095B}
\href{https://stacks.math.columbia.edu/tag/095B}{\texttt{Stacks tag 095B}}
\group{etale-cohomology}
...
\begin{lemma}[Characterize finite locally constant]
\label{etale-cohomology-lemma-characterize-finite-locally-constant}
\source{stacks:03RV}
\href{https://stacks.math.columbia.edu/tag/03RV}{\texttt{Stacks tag 03RV}}
\group{etale-cohomology}
...
\source{stacks:095C}
\href{https://stacks.math.columbia.edu/tag/095C}{\texttt{Stacks tag 095C}}
\group{etale-cohomology}
...
\source{stacks:03RX}
\href{https://stacks.math.columbia.edu/tag/03RX}{\texttt{Stacks tag 03RX}}
\group{etale-cohomology}
...
\source{stacks:095D}
\href{https://stacks.math.columbia.edu/tag/095D}{\texttt{Stacks tag 095D}}
\group{etale-cohomology}
...
\begin{lemma}[Connected locally constant]
\label{etale-cohomology-lemma-connected-locally-constant}
\source{stacks:09BF}
\href{https://stacks.math.columbia.edu/tag/09BF}{\texttt{Stacks tag 09BF}}
\group{etale-cohomology}
...
\begin{lemma}[Locally constant on connected]
\label{etale-cohomology-lemma-locally-constant-on-connected}
\source{stacks:0DV5}
\href{https://stacks.math.columbia.edu/tag/0DV5}{\texttt{Stacks tag 0DV5}}
\group{etale-cohomology}
...
Fundamental Groups, Definition \ref{pione-definition-G-set-continuous}
for sets and
Definition \ref{etale-cohomology-definition-G-module-continuous} for abelian groups.
This explains the notation.

\medskip\noindent
Assertion (1) follows from
Lemma \ref{etale-cohomology-lemma-characterize-finite-locally-constant}
...
\begin{lemma}[Locally constant on connected geom unibranch]
\label{etale-cohomology-lemma-locally-constant-on-connected-geom-unibranch}
\source{stacks:0GIY}
\href{https://stacks.math.columbia.edu/tag/0GIY}{\texttt{Stacks tag 0GIY}}
\group{etale-cohomology}
...
\begin{proof}
The proof given in Lemma \ref{etale-cohomology-lemma-locally-constant-on-connected}
...
and by Theorem \ref{etale-cohomology-theorem-topological-invariance} we get
...
on $M$ by Section \ref{etale-cohomology-section-galois-action-stalks}.
...
\begin{remark}[Functorial locally constant on connected]
\label{etale-cohomology-remark-functorial-locally-constant-on-connected}
\source{stacks:0DV6}
\href{https://stacks.math.columbia.edu/tag/0DV6}{\texttt{Stacks tag 0DV6}}
\group{etale-cohomology}

The equivalences of Lemmas \ref{etale-cohomology-lemma-locally-constant-on-connected} and
...
Then the diagram
$$
\begin{array}{cc}\text{finite locally constant sheaves of sets on }Y_\etale
\longrightarrow & \text{finite }\pi_1(Y, \overline{y})\text{-sets} \\ \text{finite locally constant sheaves of sets on }X_\etale
\longrightarrow\underset{f^{-1}}{\uparrow} & \text{finite }\pi_1(X, \overline{x})\text{-sets} \uparrow\end{array}
$$
...
Lemma \ref{etale-cohomology-lemma-vanishing-easier} below.
...
The functor $f_!$ is discussed in Section \ref{etale-cohomology-section-extension-by-zero}.
...
(Lemma \ref{etale-cohomology-lemma-shriek-equals-star-finite-etale}) and
we can view this as a map $f_*f^{-1} \to \text{id}$.

\begin{definition}[Trace map]
\label{etale-cohomology-definition-trace-map}
\source{stacks:03SE}
\href{https://stacks.math.columbia.edu/tag/03SE}{\texttt{Stacks tag 03SE}}
\group{etale-cohomology}
...
\begin{lemma}[Pullback filtered]
\label{etale-cohomology-lemma-pullback-filtered}
\source{stacks:0A3R}
\href{https://stacks.math.columbia.edu/tag/0A3R}{\texttt{Stacks tag 0A3R}}
\group{etale-cohomology}
...
Via the equivalence of Lemma \ref{etale-cohomology-lemma-locally-constant-on-connected}
...
Remark \ref{etale-cohomology-remark-functorial-locally-constant-on-connected}. As
...
Lemma \ref{etale-cohomology-lemma-locally-constant-on-connected}
...
\begin{lemma}[Action l group]
\label{etale-cohomology-lemma-action-l-group}
\source{stacks:0GIZ}
\href{https://stacks.math.columbia.edu/tag/0GIZ}{\texttt{Stacks tag 0GIZ}}
\group{etale-cohomology}
...
\begin{lemma}[Pullback filtered modules]
\label{etale-cohomology-lemma-pullback-filtered-modules}
\source{stacks:0GJ0}
\href{https://stacks.math.columbia.edu/tag/0GJ0}{\texttt{Stacks tag 0GJ0}}
\group{etale-cohomology}
...
Choose a geometric point $\overline{s}$ of $S$.
Via the equivalence of
Lemma \ref{etale-cohomology-lemma-locally-constant-on-connected-geom-unibranch}
...
(see proof of Lemma \ref{etale-cohomology-lemma-locally-constant-on-connected-geom-unibranch}).
The surjective continuous homomorphism
$\overline{\rho} : \pi_1(S, \overline{s}) \to G$
corresponds to a Galois object $Y \to S$ of
$\textit{F\'Et}_S$ with automorphism group $G = \text{Aut}(Y/S)$, see
...
the map $\pi_1(T, \overline{t}) \to H$, see
Remark \ref{etale-cohomology-remark-functorial-locally-constant-on-connected}.
Let $0 = M_0 \subset M_1 \subset \ldots \subset M_t = M$
be as in Lemma \ref{etale-cohomology-lemma-action-l-group}.
...
\begin{lemma}[Nonvanishing inherited]
\label{etale-cohomology-lemma-nonvanishing-inherited}
\source{stacks:0DV7}
\href{https://stacks.math.columbia.edu/tag/0DV7}{\texttt{Stacks tag 0DV7}}
\group{etale-cohomology}
...
satisfy the conditions of Theorem \ref{etale-cohomology-theorem-colimit}
...
See Section \ref{etale-cohomology-section-trace-method}. Thus, the colimit is non-zero, i.e.,
...
(Proposition \ref{etale-cohomology-proposition-finite-higher-direct-image-zero}).
Then, by applying Lemma \ref{etale-cohomology-lemma-relative-colimit}
...
by Leray (Proposition \ref{etale-cohomology-proposition-leray})
giving us what we want with $\mathcal{G} = g_*\mathcal{F}$.
\end{proof}

\begin{lemma}[Reduce to l group]
\label{etale-cohomology-lemma-reduce-to-l-group}
\source{stacks:0DV8}
\href{https://stacks.math.columbia.edu/tag/0DV8}{\texttt{Stacks tag 0DV8}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-nonvanishing-inherited}.
...
Applying Theorem \ref{etale-cohomology-theorem-colimit} to this colimit, we reduce
...
\begin{lemma}[Reduce to l group higher]
\label{etale-cohomology-lemma-reduce-to-l-group-higher}
\source{stacks:0DV9}
\href{https://stacks.math.columbia.edu/tag/0DV9}{\texttt{Stacks tag 0DV9}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-reduce-to-l-group}. Now let
...
Lemma \ref{etale-cohomology-lemma-nonvanishing-inherited}, conclude that $f$ has
...
\begin{proposition}[Serre galois]
\label{etale-cohomology-proposition-serre-galois}
\source{stacks:03R8}
\href{https://stacks.math.columbia.edu/tag/03R8}{\texttt{Stacks tag 03R8}}
\group{etale-cohomology}
...
\begin{proof}
Set $p = \text{char}(K)$.
By Lemma \ref{etale-cohomology-lemma-compare-cohomology-point},
Theorem \ref{etale-cohomology-theorem-brauer-delta},
and Example \ref{etale-cohomology-example-sheaves-point}
...
cohomology with colimits (i.e, direct sums, see Theorem \ref{etale-cohomology-theorem-colimit})
...
consider the Kummer sequence (Lemma \ref{etale-cohomology-lemma-kummer-sequence})
$$
0 \to
\mu_{\ell, \Spec{K'}} \to
...
Theorem \ref{etale-cohomology-theorem-picard-group} combined with
...
applying Theorem \ref{etale-cohomology-theorem-colimit} to this colimit we see that
...
Hence, via Lemma \ref{etale-cohomology-lemma-reduce-to-l-group-higher},
we conclude the result for $\ell \neq p$.

\medskip\noindent
Now suppose that $\ell = p$. We consider the
Artin-Schrier exact sequence (Section \ref{etale-cohomology-section-artin-schreier})
$$
...
Remark \ref{etale-cohomology-remark-special-case-fpqc-cohomology-quasi-coherent} and the
...
Lemma \ref{etale-cohomology-lemma-reduce-to-l-group-higher}.
...
Lemma \ref{etale-cohomology-lemma-profinite-group-cohomology-torsion}
...
\source{stacks:03R9}
\href{https://stacks.math.columbia.edu/tag/03R9}{\texttt{Stacks tag 03R9}}
\group{etale-cohomology}
...
\begin{example}[Algebraically closed field Cr]
\label{etale-cohomology-example-algebraically-closed-field-Cr}
\source{stacks:03RA}
\href{https://stacks.math.columbia.edu/tag/03RA}{\texttt{Stacks tag 03RA}}
\group{etale-cohomology}
...
\begin{lemma}[Algebraically closed find solutions]
\label{etale-cohomology-lemma-algebraically-closed-find-solutions}
\source{stacks:03RB}
\href{https://stacks.math.columbia.edu/tag/03RB}{\texttt{Stacks tag 03RB}}
\group{etale-cohomology}
...
\begin{theorem}[C1 brauer group zero]
\label{etale-cohomology-theorem-C1-brauer-group-zero}
\source{stacks:03RC}
\href{https://stacks.math.columbia.edu/tag/03RC}{\texttt{Stacks tag 03RC}}
\group{etale-cohomology}
...
\source{stacks:03RE}
\href{https://stacks.math.columbia.edu/tag/03RE}{\texttt{Stacks tag 03RE}}
\group{etale-cohomology}
...
\source{stacks:03RD}
\href{https://stacks.math.columbia.edu/tag/03RD}{\texttt{Stacks tag 03RD}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-algebraically-closed-find-solutions}.
\end{proof}

\begin{lemma}[Curve brauer zero]
\label{etale-cohomology-lemma-curve-brauer-zero}
\source{stacks:03RF}
\href{https://stacks.math.columbia.edu/tag/03RF}{\texttt{Stacks tag 03RF}}
\group{etale-cohomology}
...
Theorem \ref{etale-cohomology-theorem-tsen} and
Theorem \ref{etale-cohomology-theorem-C1-brauer-group-zero}.
\end{proof}

\begin{lemma}[Cohomology Gm function field curve]
\label{etale-cohomology-lemma-cohomology-Gm-function-field-curve}
\source{stacks:03RG}
\href{https://stacks.math.columbia.edu/tag/03RG}{\texttt{Stacks tag 03RG}}
\group{etale-cohomology}
...
by Lemma \ref{etale-cohomology-lemma-compare-cohomology-point}.
Thus by Proposition \ref{etale-cohomology-proposition-serre-galois}
...
Lemma \ref{etale-cohomology-lemma-curve-brauer-zero}.
\end{proof}
...
\source{stacks:03RI}
\href{https://stacks.math.columbia.edu/tag/03RI}{\texttt{Stacks tag 03RI}}
\group{etale-cohomology}
...
\'etale morphisms (Proposition \ref{etale-cohomology-proposition-etale-morphisms}),
...
\begin{lemma}[Higher direct jstar Gm]
\label{etale-cohomology-lemma-higher-direct-jstar-Gm}
\source{stacks:03RJ}
\href{https://stacks.math.columbia.edu/tag/03RJ}{\texttt{Stacks tag 03RJ}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-cohomology-Gm-function-field-curve}
...
\begin{lemma}[Cohomology jstar Gm]
\label{etale-cohomology-lemma-cohomology-jstar-Gm}
\source{stacks:03RK}
\href{https://stacks.math.columbia.edu/tag/03RK}{\texttt{Stacks tag 03RK}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-higher-direct-jstar-Gm}. Thus we get the desired vanishing.
\end{proof}

\begin{lemma}[Cohomology istar Z]
\label{etale-cohomology-lemma-cohomology-istar-Z}
\source{stacks:03RL}
\href{https://stacks.math.columbia.edu/tag/03RL}{\texttt{Stacks tag 03RL}}
\group{etale-cohomology}
...
\begin{theorem}[Vanishing cohomology Gm curve]
\label{etale-cohomology-theorem-vanishing-cohomology-Gm-curve}
\source{stacks:03RM}
\href{https://stacks.math.columbia.edu/tag/03RM}{\texttt{Stacks tag 03RM}}
\group{etale-cohomology}
...
\begin{lemma}[Cohomology smooth projective curve]
\label{etale-cohomology-lemma-cohomology-smooth-projective-curve}
\source{stacks:03RQ}
\href{https://stacks.math.columbia.edu/tag/03RQ}{\texttt{Stacks tag 03RQ}}
\group{etale-cohomology}
...
\begin{proof}
Theorems \ref{etale-cohomology-theorem-picard-group} and
...
\to \mathbf{G}_{m, X}\to 0$ (Lemma \ref{etale-cohomology-lemma-kummer-sequence})
then gives us the long exact cohomology sequence
$$
\begin{array}{cccc}0 \longrightarrow & \mu_n(k) \longrightarrow & k^* \overset{(\cdot)^n}{\longrightarrow} & k^* \downarrow \\  & H_\etale^1(X, \mu_n) \longrightarrow & \Pic(X) \overset{(\cdot)^n}{\longrightarrow} & \Pic(X) \downarrow \\  & H_\etale^2(X, \mu_n) \longrightarrow & 0 \longrightarrow & 0 \ldots\end{array}
$$
...
exact rows
$$
\begin{array}{ccccc}0 \longrightarrow & \Pic^0(X) \longrightarrow\overset{(\cdot)^n}{\downarrow} & \Pic(X) \underset{\deg}{\longrightarrow}\overset{(\cdot)^n}{\downarrow} & \mathbf{Z} \longrightarrow\overset{n}{\downarrow} & 0 \\ 0 \longrightarrow & \Pic^0(X) \longrightarrow & \Pic(X) \overset{\deg}{\longrightarrow} & \mathbf{Z} \longrightarrow & 0\end{array}
$$
...
\begin{lemma}[Pullback on h2 curve]
\label{etale-cohomology-lemma-pullback-on-h2-curve}
\source{stacks:0AMB}
\href{https://stacks.math.columbia.edu/tag/0AMB}{\texttt{Stacks tag 0AMB}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-cohomology-smooth-projective-curve}.
...
\begin{lemma}[Vanishing cohomology mu smooth curve]
\label{etale-cohomology-lemma-vanishing-cohomology-mu-smooth-curve}
\source{stacks:03RR}
\href{https://stacks.math.columbia.edu/tag/03RR}{\texttt{Stacks tag 03RR}}
\group{etale-cohomology}
...
of Lemma \ref{etale-cohomology-lemma-cohomology-smooth-projective-curve}).
...
\end{align*}
For the first equality sign and notation see Lemma \ref{etale-cohomology-lemma-describe-h1-mun}.
...
Lemma \ref{etale-cohomology-lemma-describe-h1-mun}.
...
\begin{remark}[Natural proof]
\label{etale-cohomology-remark-natural-proof}
\source{stacks:03RS}
\href{https://stacks.math.columbia.edu/tag/03RS}{\texttt{Stacks tag 03RS}}
\group{etale-cohomology}
...
\begin{remark}[Normalize H1 Gm]
\label{etale-cohomology-remark-normalize-H1-Gm}
\source{stacks:0A44}
\href{https://stacks.math.columbia.edu/tag/0A44}{\texttt{Stacks tag 0A44}}
\group{etale-cohomology}
...
\begin{definition}[Extension zero]
\label{etale-cohomology-definition-extension-zero}
\source{stacks:03S3}
\href{https://stacks.math.columbia.edu/tag/03S3}{\texttt{Stacks tag 03S3}}
\group{etale-cohomology}
...
\medskip\noindent
To describe the functors in Definition \ref{etale-cohomology-definition-extension-zero}
...
\begin{proposition}[Describe jshriek]
\label{etale-cohomology-proposition-describe-jshriek}
\source{stacks:03S5}
\href{https://stacks.math.columbia.edu/tag/03S5}{\texttt{Stacks tag 03S5}}
\group{etale-cohomology}
...
in terms of geometric points, see Lemma \ref{etale-cohomology-lemma-points-small-etale-site}.
...
\begin{lemma}[Jshriek open]
\label{etale-cohomology-lemma-jshriek-open}
\source{stacks:0F70}
\href{https://stacks.math.columbia.edu/tag/0F70}{\texttt{Stacks tag 0F70}}
\group{etale-cohomology}
...
isomorphism by Theorem \ref{etale-cohomology-theorem-exactness-stalks}.
\end{proof}
...
\source{stacks:03S6}
\href{https://stacks.math.columbia.edu/tag/03S6}{\texttt{Stacks tag 03S6}}
\group{etale-cohomology}

Let $f: Y \to X$ be a morphism of schemes. Let $j: V \to X$ be an \'etale
morphism. Consider the fibre product
$$
\begin{array}{cc}V' = Y \times_X V \underset{f'}{\downarrow}\underset{j'}{\longrightarrow} & Y \overset{f}{\downarrow} \\ V \overset{j}{\longrightarrow} & X\end{array}
$$
...
\begin{lemma}[Shriek into star separated etale]
\label{etale-cohomology-lemma-shriek-into-star-separated-etale}
\source{stacks:0F4L}
\href{https://stacks.math.columbia.edu/tag/0F4L}{\texttt{Stacks tag 0F4L}}
\group{etale-cohomology}
...
\begin{lemma}[Shriek equals star finite etale]
\label{etale-cohomology-lemma-shriek-equals-star-finite-etale}
\source{stacks:03S7}
\href{https://stacks.math.columbia.edu/tag/03S7}{\texttt{Stacks tag 03S7}}
\group{etale-cohomology}

Let $j : U \to X$ be finite and \'etale. Then the map
$j_! \to j_*$ of Lemma \ref{etale-cohomology-lemma-shriek-into-star-separated-etale}
is an isomorphism
on abelian sheaves and sheaves of $\Lambda$-modules.
\end{lemma}
...
\begin{lemma}[Ses associated to open]
\label{etale-cohomology-lemma-ses-associated-to-open}
\source{stacks:095L}
\href{https://stacks.math.columbia.edu/tag/095L}{\texttt{Stacks tag 095L}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-stalk-pushforward-closed-immersion} and
Proposition \ref{etale-cohomology-proposition-describe-jshriek}.
\end{proof}

\begin{lemma}[Compatible shriek push finite]
\label{etale-cohomology-lemma-compatible-shriek-push-finite}
\source{stacks:0GJ1}
\href{https://stacks.math.columbia.edu/tag/0GJ1}{\texttt{Stacks tag 0GJ1}}
\group{etale-cohomology}

Consider a cartesian diagram of schemes
$$
\begin{array}{cc}U \underset{g}{\downarrow}\underset{j'}{\longrightarrow} & X \overset{f}{\downarrow} \\ V \overset{j}{\longrightarrow} & Y\end{array}
$$
...
$$
by Proposition \ref{etale-cohomology-proposition-finite-higher-direct-image-zero} and
because the stalk of $j'_!\mathcal{F}$ at $\overline{x} \not \in U$
are zero by Lemma \ref{etale-cohomology-lemma-jshriek-open}. On the other hand, we have
$$
j^{-1}f_*j'_!\mathcal{F} =
g_*(j')^{-1}j'_!\mathcal{F} =
g_*\mathcal{F}
$$
by Lemmas \ref{etale-cohomology-lemma-finite-pushforward-commutes-with-base-change} and
\ref{etale-cohomology-lemma-jshriek-open}.
Hence by the characterization of
$j_!$ in Lemma \ref{etale-cohomology-lemma-jshriek-open} we see that
...
invariance of the \'etale site (Theorem \ref{etale-cohomology-theorem-topological-invariance}).
...
\source{stacks:03RW}
\href{https://stacks.math.columbia.edu/tag/03RW}{\texttt{Stacks tag 03RW}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-constructible-abelian}
and
Lemmas \ref{etale-cohomology-lemma-category-constructible-sets},
\ref{etale-cohomology-lemma-category-constructible-abelian}, and
...
\begin{lemma}[Constructible quasi compact quasi separated]
\label{etale-cohomology-lemma-constructible-quasi-compact-quasi-separated}
\source{stacks:095E}
\href{https://stacks.math.columbia.edu/tag/095E}{\texttt{Stacks tag 095E}}
\group{etale-cohomology}
...
Definition \ref{etale-cohomology-definition-constructible}. Thus (1) holds.
\end{proof}

\begin{lemma}[Constructible constructible]
\label{etale-cohomology-lemma-constructible-constructible}
\source{stacks:09YR}
\href{https://stacks.math.columbia.edu/tag/09YR}{\texttt{Stacks tag 09YR}}
\group{etale-cohomology}
...
(Lemma \ref{etale-cohomology-lemma-constructible-quasi-compact-quasi-separated}).
...
\begin{lemma}[Constructible local]
\label{etale-cohomology-lemma-constructible-local}
\source{stacks:095F}
\href{https://stacks.math.columbia.edu/tag/095F}{\texttt{Stacks tag 095F}}
\group{etale-cohomology}
...
\begin{lemma}[Pullback constructible]
\label{etale-cohomology-lemma-pullback-constructible}
\source{stacks:095G}
\href{https://stacks.math.columbia.edu/tag/095G}{\texttt{Stacks tag 095G}}
\group{etale-cohomology}
...
\begin{proof}
By Lemma \ref{etale-cohomology-lemma-constructible-local} this reduces to the case
...
$\mathcal{F}$ and use
Lemma \ref{etale-cohomology-lemma-pullback-locally-constant}.
\end{proof}

\begin{lemma}[Constructible abelian]
\label{etale-cohomology-lemma-constructible-abelian}
\source{stacks:03RZ}
\href{https://stacks.math.columbia.edu/tag/03RZ}{\texttt{Stacks tag 03RZ}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-kernel-finite-locally-constant} to conclude.

\medskip\noindent
The proofs of (1) and (2) are very similar and are omitted.
\end{proof}

\begin{lemma}[Support constructible]
\label{etale-cohomology-lemma-support-constructible}
\source{stacks:09YS}
\href{https://stacks.math.columbia.edu/tag/09YS}{\texttt{Stacks tag 09YS}}
\group{etale-cohomology}
...
refinement). Then apply Lemma \ref{etale-cohomology-lemma-morphism-locally-constant}
...
\begin{lemma}[Colimit constructible]
\label{etale-cohomology-lemma-colimit-constructible}
\source{stacks:095P}
\href{https://stacks.math.columbia.edu/tag/095P}{\texttt{Stacks tag 095P}}
\group{etale-cohomology}
...
(Lemma \ref{etale-cohomology-lemma-kernel-finite-locally-constant}).
...
(Lemma \ref{etale-cohomology-lemma-support-constructible}).
...
(details omitted; hint: use Lemma \ref{etale-cohomology-lemma-support-constructible}).
...
\begin{lemma}[Tensor product constructible]
\label{etale-cohomology-lemma-tensor-product-constructible}
\source{stacks:095I}
\href{https://stacks.math.columbia.edu/tag/095I}{\texttt{Stacks tag 095I}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-tensor-product-locally-constant}.
\end{proof}

\begin{lemma}[Tensor constructible]
\label{etale-cohomology-lemma-tensor-constructible}
\source{stacks:0GKB}
\href{https://stacks.math.columbia.edu/tag/0GKB}{\texttt{Stacks tag 0GKB}}
\group{etale-cohomology}
...
\begin{lemma}[Etale stratified finite]
\label{etale-cohomology-lemma-etale-stratified-finite}
\source{stacks:03S0}
\href{https://stacks.math.columbia.edu/tag/03S0}{\texttt{Stacks tag 03S0}}
\group{etale-cohomology}
...
\begin{lemma}[Generically finite]
\label{etale-cohomology-lemma-generically-finite}
\source{stacks:03S1}
\href{https://stacks.math.columbia.edu/tag/03S1}{\texttt{Stacks tag 03S1}}
\group{etale-cohomology}
...
\begin{lemma}[Decompose quasi finite morphism]
\label{etale-cohomology-lemma-decompose-quasi-finite-morphism}
\source{stacks:095K}
\href{https://stacks.math.columbia.edu/tag/095K}{\texttt{Stacks tag 095K}}
\group{etale-cohomology}
...
subset of $X$ is constructible. By Lemma \ref{etale-cohomology-lemma-generically-finite}
...
\begin{lemma}[Jshriek constructible]
\label{etale-cohomology-lemma-jshriek-constructible}
\source{stacks:03S8}
\href{https://stacks.math.columbia.edu/tag/03S8}{\texttt{Stacks tag 03S8}}
\group{etale-cohomology}
...
\begin{proof}
By Lemma \ref{etale-cohomology-lemma-etale-stratified-finite} there is a partition
$\coprod_i X_i$ such that $\pi_i : j^{-1}(X_i) \to X_i$ is finite \'etale.
The restriction of $h_U$ to $X_i$ is $h_{j^{-1}(X_i)}$ which is finite
locally constant by Lemma \ref{etale-cohomology-lemma-characterize-finite-locally-constant}.
...
\pi_{i*}(\underline{M})
$$
by Lemmas \ref{etale-cohomology-lemma-shriek-base-change} and
\ref{etale-cohomology-lemma-shriek-equals-star-finite-etale}.
Thus it suffices to show the lemma for $\pi : Y \to X$ finite \'etale.
This is Lemma \ref{etale-cohomology-lemma-pushforward-locally-constant}.
\end{proof}

\begin{lemma}[Torsion colimit constructible]
\label{etale-cohomology-lemma-torsion-colimit-constructible}
\source{stacks:03SA}
\href{https://stacks.math.columbia.edu/tag/03SA}{\texttt{Stacks tag 03SA}}
\group{etale-cohomology}
...
of $X_\etale$. By
Lemmas \ref{etale-cohomology-lemma-jshriek-constructible} and \ref{etale-cohomology-lemma-constructible-abelian}
...
\begin{lemma}[Check constructible]
\label{etale-cohomology-lemma-check-constructible}
\source{stacks:095Q}
\href{https://stacks.math.columbia.edu/tag/095Q}{\texttt{Stacks tag 095Q}}
\group{etale-cohomology}
...
\begin{proof}
One implication follows from Lemma \ref{etale-cohomology-lemma-pullback-constructible}.
...
using Lemma \ref{etale-cohomology-lemma-torsion-colimit-constructible}.
...
By Lemma \ref{etale-cohomology-lemma-colimit-constructible} we see that
...
Lemma \ref{etale-cohomology-lemma-stalk-pullback} and
Theorem \ref{etale-cohomology-theorem-exactness-stalks})
...
\begin{lemma}[Pushforward constructible]
\label{etale-cohomology-lemma-pushforward-constructible}
\source{stacks:095H}
\href{https://stacks.math.columbia.edu/tag/095H}{\texttt{Stacks tag 095H}}
\group{etale-cohomology}
...
\begin{proof}
By Lemma \ref{etale-cohomology-lemma-constructible-local} it suffices to check this
Zariski locally on $Y$ and by Lemma \ref{etale-cohomology-lemma-check-constructible}
...
\begin{lemma}[Category constructible sets]
\label{etale-cohomology-lemma-category-constructible-sets}
\source{stacks:09Y9}
\href{https://stacks.math.columbia.edu/tag/09Y9}{\texttt{Stacks tag 09Y9}}
\group{etale-cohomology}
...
$$
\begin{array}{ccc}\mathcal{F}_1
\longrightarrow\longrightarrow & \mathcal{F}_0 \longrightarrow & \mathcal{F}\end{array}
$$
...
\begin{proof}
In the proof of Lemma \ref{etale-cohomology-lemma-torsion-colimit-constructible}
...
because the latter is constructible by Lemma \ref{etale-cohomology-lemma-constructible-abelian}.
...
\begin{lemma}[Category constructible modules]
\label{etale-cohomology-lemma-category-constructible-modules}
\source{stacks:095N}
\href{https://stacks.math.columbia.edu/tag/095N}{\texttt{Stacks tag 095N}}
\group{etale-cohomology}
...
\begin{lemma}[Category constructible abelian]
\label{etale-cohomology-lemma-category-constructible-abelian}
\source{stacks:09YT}
\href{https://stacks.math.columbia.edu/tag/09YT}{\texttt{Stacks tag 09YT}}
\group{etale-cohomology}
...
\begin{proof}
This follows from Lemma \ref{etale-cohomology-lemma-category-constructible-modules}
...
\begin{lemma}[Constructible is compact]
\label{etale-cohomology-lemma-constructible-is-compact}
\source{stacks:09Z4}
\href{https://stacks.math.columbia.edu/tag/09Z4}{\texttt{Stacks tag 09Z4}}
\group{etale-cohomology}
...
\begin{proof}
The case of sheaves of sets. By Lemma \ref{etale-cohomology-lemma-category-constructible-sets}
...
Lemmas \ref{etale-cohomology-lemma-category-constructible-abelian} and
\ref{etale-cohomology-lemma-category-constructible-modules}.
...
\begin{lemma}[Finite pushforward constructible]
\label{etale-cohomology-lemma-finite-pushforward-constructible}
\source{stacks:095R}
\href{https://stacks.math.columbia.edu/tag/095R}{\texttt{Stacks tag 095R}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-constructible-local}.
By
Lemmas \ref{etale-cohomology-lemma-finite-pushforward-commutes-with-base-change} and
\ref{etale-cohomology-lemma-check-constructible} we may base change to any
affine scheme surjective over $X$. By
Lemma \ref{etale-cohomology-lemma-decompose-quasi-finite-morphism}
...
Lemma \ref{etale-cohomology-lemma-pushforward-constructible}.
\end{proof}

\begin{lemma}[Category is colimit]
\label{etale-cohomology-lemma-category-is-colimit}
\source{stacks:09YU}
\href{https://stacks.math.columbia.edu/tag/09YU}{\texttt{Stacks tag 09YU}}
\group{etale-cohomology}
...
By Lemma \ref{etale-cohomology-lemma-support-constructible} the subset
...
By Lemma \ref{etale-cohomology-lemma-category-constructible-sets}
...
Lemma \ref{etale-cohomology-lemma-category-constructible-sets}
...
Lemma \ref{etale-cohomology-lemma-category-constructible-modules}
instead of
Lemma \ref{etale-cohomology-lemma-category-constructible-sets}. Details omitted.
...
\begin{lemma}[Category loc cst is colimit]
\label{etale-cohomology-lemma-category-loc-cst-is-colimit}
\source{stacks:0GL2}
\href{https://stacks.math.columbia.edu/tag/0GL2}{\texttt{Stacks tag 0GL2}}
\group{etale-cohomology}
...
\begin{proof}
By Lemma \ref{etale-cohomology-lemma-category-is-colimit} the functor in each case
...
By Lemma \ref{etale-cohomology-lemma-colimit-affine-sites} we can find an $i' \geq i$
...
\begin{lemma}[Irreducible subsheaf constant zero]
\label{etale-cohomology-lemma-irreducible-subsheaf-constant-zero}
\source{stacks:09BG}
\href{https://stacks.math.columbia.edu/tag/09BG}{\texttt{Stacks tag 09BG}}
\group{etale-cohomology}
...
\begin{lemma}[Push constant sheaf from open]
\label{etale-cohomology-lemma-push-constant-sheaf-from-open}
\source{stacks:09Z5}
\href{https://stacks.math.columbia.edu/tag/09Z5}{\texttt{Stacks tag 09Z5}}
\group{etale-cohomology}
...
see Theorem \ref{etale-cohomology-theorem-higher-direct-images}.
...
\begin{lemma}[Zero in generic point]
\label{etale-cohomology-lemma-zero-in-generic-point}
\source{stacks:0F0M}
\href{https://stacks.math.columbia.edu/tag/0F0M}{\texttt{Stacks tag 0F0M}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-colimit-constructible}.
Then $\mathcal{G}_i = \Im(\mathcal{F}_i \to \mathcal{F}_{i'(i)})$
is a constructible abelian sheaf (Lemma \ref{etale-cohomology-lemma-constructible-abelian})
...
Definition \ref{etale-cohomology-definition-constructible}. Actually, the category
of constructible sheaves on
Noetherian schemes has some additional properties which we will
catalogue in this section.

\begin{proposition}[Constructible over noetherian]
\label{etale-cohomology-proposition-constructible-over-noetherian}
\source{stacks:09BH}
\href{https://stacks.math.columbia.edu/tag/09BH}{\texttt{Stacks tag 09BH}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-irreducible-subsheaf-constant-zero}.
...
form a weak Serre subcategory, see Lemma \ref{etale-cohomology-lemma-constructible-abelian}.
...
\begin{lemma}[Constructible over noetherian noetherian]
\label{etale-cohomology-lemma-constructible-over-noetherian-noetherian}
\source{stacks:09YV}
\href{https://stacks.math.columbia.edu/tag/09YV}{\texttt{Stacks tag 09YV}}
\group{etale-cohomology}
...
\begin{proof}
By Proposition \ref{etale-cohomology-proposition-constructible-over-noetherian}
we see that $\mathcal{F}_i$ and $\colim \mathcal{F}_i$ are constructible.
Then the lemma follows from
Lemma \ref{etale-cohomology-lemma-colimit-constructible}.
\end{proof}

\begin{lemma}[Constructible maps into constant]
\label{etale-cohomology-lemma-constructible-maps-into-constant}
\source{stacks:09Z6}
\href{https://stacks.math.columbia.edu/tag/09Z6}{\texttt{Stacks tag 09Z6}}
\group{etale-cohomology}
...
(Lemma \ref{etale-cohomology-lemma-constructible-over-noetherian-noetherian}), it
...
(Lemma \ref{etale-cohomology-lemma-push-constant-sheaf-from-open}).
...
$$
\begin{array}{cc}\mathcal{F}_{\overline{x}} \xlongequal{}\downarrow & (\mathcal{F}|_Y)_{\overline{y}} \downarrow \\ (f_*\underline{E})_{\overline{x}} \longrightarrow & \underline{E}_{\overline{y}}\end{array}
$$
...
by Lemma \ref{etale-cohomology-lemma-relative-colimit}.
By Lemma \ref{etale-cohomology-lemma-constructible-is-compact} the map
...
\begin{lemma}[Constructible maps into constant general]
\label{etale-cohomology-lemma-constructible-maps-into-constant-general}
\source{stacks:09Z7}
\href{https://stacks.math.columbia.edu/tag/09Z7}{\texttt{Stacks tag 09Z7}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-category-is-colimit}
...
(Lemma \ref{etale-cohomology-lemma-constructible-maps-into-constant})
...
with base change
(Lemma \ref{etale-cohomology-lemma-finite-pushforward-commutes-with-base-change}), we conclude.
\end{proof}

\begin{lemma}[Support in subset]
\label{etale-cohomology-lemma-support-in-subset}
\source{stacks:0F0N}
\href{https://stacks.math.columbia.edu/tag/0F0N}{\texttt{Stacks tag 0F0N}}
\group{etale-cohomology}
...
of $(S, \overline{s})$, see Section \ref{etale-cohomology-section-stalks}. Since
...
$$
\begin{array}{ccc}\textit{Sets}
\rrtwocell^{\overline{t}}_{\overline{s}}{\ sp} &  & \Sh(S_\etale)\end{array}
$$
of topoi.
...
\source{stacks:0GJ3}
\href{https://stacks.math.columbia.edu/tag/0GJ3}{\texttt{Stacks tag 0GJ3}}
\group{etale-cohomology}
...
$$
The first equality follows from Theorem \ref{etale-cohomology-theorem-higher-direct-images}
applied to $\text{id}_S : S \to S$ and the second equality follows
from Lemma \ref{etale-cohomology-lemma-stalk-pullback}. Then we can think of $sp$
as the map
$$
sp :
\mathcal{F}_{\overline{s}} =
...
\source{stacks:0GJ4}
\href{https://stacks.math.columbia.edu/tag/0GJ4}{\texttt{Stacks tag 0GJ4}}
\group{etale-cohomology}
...
\source{stacks:0GJ5}
\href{https://stacks.math.columbia.edu/tag/0GJ5}{\texttt{Stacks tag 0GJ5}}
\group{etale-cohomology}
...
commutative diagram
$$
\begin{array}{ccc}\overline{t} \downarrow\longrightarrow & \Spec(\mathcal{O}^{sh}_{S, \overline{s}}) \downarrow & \overline{s} \longleftarrow\downarrow \\ t \longrightarrow & S & s \longleftarrow\end{array}
$$
...
\begin{lemma}[Specialization map pullback]
\label{etale-cohomology-lemma-specialization-map-pullback}
\source{stacks:0GJ6}
\href{https://stacks.math.columbia.edu/tag/0GJ6}{\texttt{Stacks tag 0GJ6}}
\group{etale-cohomology}
...
of Lemma \ref{etale-cohomology-lemma-stalk-pullback}.
\end{lemma}
...
\begin{lemma}[Characterize locally constant]
\label{etale-cohomology-lemma-characterize-locally-constant}
\source{stacks:0GJ7}
\href{https://stacks.math.columbia.edu/tag/0GJ7}{\texttt{Stacks tag 0GJ7}}
\group{etale-cohomology}
...
(the condition is independent of the choice by Remark \ref{etale-cohomology-remark-map-stalks}).
The image $u \in U$ of $\overline{u}$ is in $E$.
By our assumption on the specialization maps for $\mathcal{F}$,
by Remark \ref{etale-cohomology-remark-can-lift}, and by
Lemma \ref{etale-cohomology-lemma-specialization-map-pullback}
...
Theorem \ref{etale-cohomology-theorem-exactness-stalks}. Thus (1) follows.

\medskip\noindent
We omit the proof that (1) implies (2).
\end{proof}

\begin{lemma}[Characterize locally constant module]
\label{etale-cohomology-lemma-characterize-locally-constant-module}
\source{stacks:0GKC}
\href{https://stacks.math.columbia.edu/tag/0GKC}{\texttt{Stacks tag 0GKC}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-characterize-locally-constant}.
Assume (2). Let $\overline{s}$ be a geometric point of $S$ lying over
$s \in S$. In order to prove (1) we have to find an \'etale neighbourhood
$(U, \overline{u})$ of $(S, \overline{s})$ such that $\mathcal{F}|_U$
is constant. We may and do assume $S$ is affine.
...
\begin{lemma}[Specialization map pushforward]
\label{etale-cohomology-lemma-specialization-map-pushforward}
\source{stacks:0GJ8}
\href{https://stacks.math.columbia.edu/tag/0GJ8}{\texttt{Stacks tag 0GJ8}}
\group{etale-cohomology}
...
diagram
$$
\begin{array}{cc}(Rf_*K)_{\overline{s}} \underset{sp}{\longrightarrow}\downarrow & (Rf_*K)_{\overline{t}} \downarrow \\ R\Gamma(X \times_S \Spec(\mathcal{O}^{sh}_{S, \overline{s}}), K)
\longrightarrow & R\Gamma(X \times_S \Spec(\mathcal{O}^{sh}_{S, \overline{t}}), K)\end{array}
$$
...
\Spec(\mathcal{O}^{sh}_{S, \overline{s}})$
is the morphism introduced in Remark \ref{etale-cohomology-remark-another-sp}.
The vertical arrows are given by
Theorem \ref{etale-cohomology-theorem-higher-direct-images}.
\end{lemma}

\begin{proof}
This follows immediately from the description
of $sp$ in Remark \ref{etale-cohomology-remark-another-sp}.
\end{proof}

\begin{remark}[Specialization map and fibres]
\label{etale-cohomology-remark-specialization-map-and-fibres}
\source{stacks:0GJ9}
\href{https://stacks.math.columbia.edu/tag/0GJ9}{\texttt{Stacks tag 0GJ9}}
\group{etale-cohomology}
...
Let $c$ be as in Remark \ref{etale-cohomology-remark-another-sp}.
We can always make a commutative diagram
$$
\begin{array}{ccc}(Rf_*K)_{\overline{s}} \longrightarrow\underset{sp}{\downarrow} & R\Gamma(X \times_S \Spec(\mathcal{O}_{S, \overline{s}}^{sh}), K)
\longrightarrow\underset{(\text{id}_X \times c)^{-1}}{\downarrow} & R\Gamma(X_{\overline{s}}, K) \\ (Rf_*K)_{\overline{t}} \longrightarrow & R\Gamma(X \times_S \Spec(\mathcal{O}_{S, \overline{t}}^{sh}), K) \longrightarrow & R\Gamma(X_{\overline{t}}, K)\end{array}
$$
where the horizontal arrows are those of Remark \ref{etale-cohomology-remark-stalk-fibre}.
In general there won't be a vertical map on the right
between the cohomologies of $K$ on the fibres fitting into this
diagram, even in the case of Lemma \ref{etale-cohomology-lemma-specialization-map-pushforward}.
\end{remark}
...
\source{stacks:095W}
\href{https://stacks.math.columbia.edu/tag/095W}{\texttt{Stacks tag 095W}}
\group{etale-cohomology}
...
This definition makes sense by Lemma \ref{etale-cohomology-lemma-constructible-abelian} and
...
\begin{lemma}[Restrict and shriek from etale c]
\label{etale-cohomology-lemma-restrict-and-shriek-from-etale-c}
\source{stacks:095X}
\href{https://stacks.math.columbia.edu/tag/095X}{\texttt{Stacks tag 095X}}
\group{etale-cohomology}
...
that $j_!$ is exact and Lemma \ref{etale-cohomology-lemma-jshriek-constructible}.
\end{proof}

\begin{lemma}[Pullback c]
\label{etale-cohomology-lemma-pullback-c}
\source{stacks:095Y}
\href{https://stacks.math.columbia.edu/tag/095Y}{\texttt{Stacks tag 095Y}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-pullback-constructible}.
\end{proof}

\begin{lemma}[One constructible]
\label{etale-cohomology-lemma-one-constructible}
\source{stacks:095Z}
\href{https://stacks.math.columbia.edu/tag/095Z}{\texttt{Stacks tag 095Z}}
\group{etale-cohomology}
...
\begin{lemma}[Bounded above c]
\label{etale-cohomology-lemma-bounded-above-c}
\source{stacks:0960}
\href{https://stacks.math.columbia.edu/tag/0960}{\texttt{Stacks tag 0960}}
\group{etale-cohomology}
...
For $a = b$ this can be done by Lemma \ref{etale-cohomology-lemma-one-constructible}.
...
Lemma \ref{etale-cohomology-lemma-one-constructible}. The composition
...
\begin{lemma}[Tensor c]
\label{etale-cohomology-lemma-tensor-c}
\source{stacks:0961}
\href{https://stacks.math.columbia.edu/tag/0961}{\texttt{Stacks tag 0961}}
\group{etale-cohomology}
...
\begin{proof}
This follows from Lemmas \ref{etale-cohomology-lemma-bounded-above-c} and
...
in Section \ref{etale-cohomology-section-Dc} is the full subcategory consisting of objects
having (locally) finite tor dimension. Here is the formal definition.

\begin{definition}[Ctf]
\label{etale-cohomology-definition-ctf}
\source{stacks:03TQ}
\href{https://stacks.math.columbia.edu/tag/03TQ}{\texttt{Stacks tag 03TQ}}
\group{etale-cohomology}
...
$D_{ctf}(X_\etale, \Lambda)$ is given in Lemma \ref{etale-cohomology-lemma-when-ctf}.

\begin{remark}[Different]
\label{etale-cohomology-remark-different}
\source{stacks:03TS}
\href{https://stacks.math.columbia.edu/tag/03TS}{\texttt{Stacks tag 03TS}}
\group{etale-cohomology}
...
\begin{lemma}[When ctf]
\label{etale-cohomology-lemma-when-ctf}
\source{stacks:03TT}
\href{https://stacks.math.columbia.edu/tag/03TT}{\texttt{Stacks tag 03TT}}
\group{etale-cohomology}
...
H^b(K)
$$
By Lemma \ref{etale-cohomology-lemma-category-constructible-modules}
...
\begin{remark}[Projective each degree]
\label{etale-cohomology-remark-projective-each-degree}
\source{stacks:03TR}
\href{https://stacks.math.columbia.edu/tag/03TR}{\texttt{Stacks tag 03TR}}
\group{etale-cohomology}
...
\begin{lemma}[Restrict and shriek from etale ctf]
\label{etale-cohomology-lemma-restrict-and-shriek-from-etale-ctf}
\source{stacks:0962}
\href{https://stacks.math.columbia.edu/tag/0962}{\texttt{Stacks tag 0962}}
\group{etale-cohomology}
...
case where $X$ is affine and then apply Lemma \ref{etale-cohomology-lemma-when-ctf}
to translate it into a statement about finite complexes
of flat constructible sheaves of $\Lambda$-modules
where the result follows from Lemma \ref{etale-cohomology-lemma-jshriek-constructible}.
\end{proof}

\begin{lemma}[Pullback ctf]
\label{etale-cohomology-lemma-pullback-ctf}
\source{stacks:0963}
\href{https://stacks.math.columbia.edu/tag/0963}{\texttt{Stacks tag 0963}}
\group{etale-cohomology}
...
\begin{proof}
Apply Lemma \ref{etale-cohomology-lemma-when-ctf} to reduce this to a question
about finite complexes of flat constructible sheaves of $\Lambda$-modules.
Then the statement follows as $f^{-1} = f^*$ is exact and
Lemma \ref{etale-cohomology-lemma-pullback-constructible}.
\end{proof}

\begin{lemma}[Connected ctf locally constant]
\label{etale-cohomology-lemma-connected-ctf-locally-constant}
\source{stacks:09BI}
\href{https://stacks.math.columbia.edu/tag/09BI}{\texttt{Stacks tag 09BI}}
\group{etale-cohomology}
...
\begin{lemma}[Torsion cohomology]
\label{etale-cohomology-lemma-torsion-cohomology}
\source{stacks:0DDC}
\href{https://stacks.math.columbia.edu/tag/0DDC}{\texttt{Stacks tag 0DDC}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-colimit} we have
...
\begin{lemma}[Torsion direct image]
\label{etale-cohomology-lemma-torsion-direct-image}
\source{stacks:0DDD}
\href{https://stacks.math.columbia.edu/tag/0DDD}{\texttt{Stacks tag 0DDD}}
\group{etale-cohomology}
...
we can apply Lemma \ref{etale-cohomology-lemma-torsion-cohomology} to see that
...
$$
be the sections with support in $Z$ (Definition \ref{etale-cohomology-definition-support}).
...
$$
Here we use the support of a section from Definition \ref{etale-cohomology-definition-support}.
...
\begin{lemma}[Sections with support acyclic]
\label{etale-cohomology-lemma-sections-with-support-acyclic}
\source{stacks:09XQ}
\href{https://stacks.math.columbia.edu/tag/09XQ}{\texttt{Stacks tag 09XQ}}
\group{etale-cohomology}
...
Since $i_*$ is exact (Section \ref{etale-cohomology-section-closed-immersions}) and as
...
\begin{lemma}[Cohomology with support sheaf on support]
\label{etale-cohomology-lemma-cohomology-with-support-sheaf-on-support}
\source{stacks:09XR}
\href{https://stacks.math.columbia.edu/tag/09XR}{\texttt{Stacks tag 09XR}}
\group{etale-cohomology}
...
\begin{lemma}[Cohomology with support triangle]
\label{etale-cohomology-lemma-cohomology-with-support-triangle}
\source{stacks:0A45}
\href{https://stacks.math.columbia.edu/tag/0A45}{\texttt{Stacks tag 0A45}}
\group{etale-cohomology}
...
\begin{lemma}[Complexes with support on closed]
\label{etale-cohomology-lemma-complexes-with-support-on-closed}
\source{stacks:0AEG}
\href{https://stacks.math.columbia.edu/tag/0AEG}{\texttt{Stacks tag 0AEG}}
\group{etale-cohomology}
...
Proposition \ref{etale-cohomology-proposition-closed-immersion-pushforward} and
Lemma \ref{etale-cohomology-lemma-stalk-pullback}. Thus
...
\begin{lemma}[Cohomology with support quasi coherent]
\label{etale-cohomology-lemma-cohomology-with-support-quasi-coherent}
\source{stacks:0A46}
\href{https://stacks.math.columbia.edu/tag/0A46}{\texttt{Stacks tag 0A46}}
\group{etale-cohomology}
...
(Proposition \ref{etale-cohomology-proposition-quasi-coherent-sheaf-fpqc}). Then
\begin{enumerate}
...
Lemma \ref{etale-cohomology-lemma-cohomology-with-support-triangle}.
\end{proof}
...
\begin{lemma}[Local rings strictly henselian]
\label{etale-cohomology-lemma-local-rings-strictly-henselian}
\source{stacks:09AX}
\href{https://stacks.math.columbia.edu/tag/09AX}{\texttt{Stacks tag 09AX}}
\group{etale-cohomology}
...
\begin{lemma}[Gabber criterion]
\label{etale-cohomology-lemma-gabber-criterion}
\source{stacks:0GY0}
\href{https://stacks.math.columbia.edu/tag/0GY0}{\texttt{Stacks tag 0GY0}}
\group{etale-cohomology}
...
\begin{proof}
By Lemma \ref{etale-cohomology-lemma-local-rings-strictly-henselian} we see that
...
$$
\begin{array}{c}H^{i - 1}_\etale(D(fg(f + g)), \mathcal{F}) \downarrow \\ H^i_\etale(D(f + g), \mathcal{F}) \downarrow \\ H^i_\etale(D(f(f + g)), \mathcal{F}) \oplus
H^i_\etale(D(g(f + g)), \mathcal{F})\end{array}
$$
and the result follows as the first group is zero by induction.
\end{proof}

\begin{lemma}[Affine only closed points]
\label{etale-cohomology-lemma-affine-only-closed-points}
\source{stacks:09AY}
\href{https://stacks.math.columbia.edu/tag/09AY}{\texttt{Stacks tag 09AY}}
\group{etale-cohomology}
...
by Lemma \ref{etale-cohomology-lemma-local-rings-strictly-henselian}
...
\begin{lemma}[Normal scheme with alg closed function field]
\label{etale-cohomology-lemma-normal-scheme-with-alg-closed-function-field}
\source{stacks:09Z9}
\href{https://stacks.math.columbia.edu/tag/09Z9}{\texttt{Stacks tag 09Z9}}
\group{etale-cohomology}
...
on the \'etale site of $X$ (Lemma \ref{etale-cohomology-lemma-describe-etale-local-ring}).
...
\begin{lemma}[Rf star zero normal with alg closed function field]
\label{etale-cohomology-lemma-Rf-star-zero-normal-with-alg-closed-function-field}
\source{stacks:0EZP}
\href{https://stacks.math.columbia.edu/tag/0EZP}{\texttt{Stacks tag 0EZP}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-normal-scheme-with-alg-closed-function-field}.
By Lemma \ref{etale-cohomology-lemma-local-rings-strictly-henselian}
...
\begin{lemma}[Closed of affine normal scheme with alg closed function field]
\label{etale-cohomology-lemma-closed-of-affine-normal-scheme-with-alg-closed-function-field}
\source{stacks:09ZA}
\href{https://stacks.math.columbia.edu/tag/09ZA}{\texttt{Stacks tag 09ZA}}
\group{etale-cohomology}
...
Apply Lemma \ref{etale-cohomology-lemma-normal-scheme-with-alg-closed-function-field}
...
\begin{lemma}[Gabber for h1 absolutely algebraically closed]
\label{etale-cohomology-lemma-gabber-for-h1-absolutely-algebraically-closed}
\source{stacks:09ZB}
\href{https://stacks.math.columbia.edu/tag/09ZB}{\texttt{Stacks tag 09ZB}}
\group{etale-cohomology}
...
\'etale over $Z$, Lemma \ref{etale-cohomology-lemma-characterize-finite-locally-constant}.
Of course $V \to Z$ is surjective as a torsor is locally trivial.
Since $V \to Z$ has a section by
Lemma \ref{etale-cohomology-lemma-closed-of-affine-normal-scheme-with-alg-closed-function-field}
we are done.
\end{proof}

\begin{lemma}[Gabber for absolutely algebraically closed]
\label{etale-cohomology-lemma-gabber-for-absolutely-algebraically-closed}
\source{stacks:09ZC}
\href{https://stacks.math.columbia.edu/tag/09ZC}{\texttt{Stacks tag 09ZC}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-normal-scheme-with-alg-closed-function-field} and
...
Lemma \ref{etale-cohomology-lemma-gabber-for-h1-absolutely-algebraically-closed}.
Thus we may apply Lemma \ref{etale-cohomology-lemma-gabber-criterion} to $Z = \Spec(R')$
to conclude.
\end{proof}

\begin{lemma}[Integral cover trivial cohomology]
\label{etale-cohomology-lemma-integral-cover-trivial-cohomology}
\source{stacks:09ZD}
\href{https://stacks.math.columbia.edu/tag/09ZD}{\texttt{Stacks tag 09ZD}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-gabber-for-absolutely-algebraically-closed}.
...
By Lemma \ref{etale-cohomology-lemma-directed-colimit-cohomology}
...
vanishes in positive degrees (Proposition \ref{etale-cohomology-proposition-aic-vanishing})
thereby slightly improving the earlier
Lemma \ref{etale-cohomology-lemma-gabber-for-absolutely-algebraically-closed}.
We suggest the reader skip this section.

\begin{lemma}[Find extension]
\label{etale-cohomology-lemma-find-extension}
\source{stacks:0GY2}
\href{https://stacks.math.columbia.edu/tag/0GY2}{\texttt{Stacks tag 0GY2}}
\group{etale-cohomology}
...
\begin{lemma}[Monogenic one]
\label{etale-cohomology-lemma-monogenic-one}
\source{stacks:0GY3}
\href{https://stacks.math.columbia.edu/tag/0GY3}{\texttt{Stacks tag 0GY3}}
\group{etale-cohomology}
...
\begin{lemma}[Lift points H to G]
\label{etale-cohomology-lemma-lift-points-H-to-G}
\source{stacks:0GY5}
\href{https://stacks.math.columbia.edu/tag/0GY5}{\texttt{Stacks tag 0GY5}}
\group{etale-cohomology}
...
with $\Phi(b) = a$. By Lemma \ref{etale-cohomology-lemma-monogenic-one}
...
\begin{lemma}[Interpolate]
\label{etale-cohomology-lemma-interpolate}
\source{stacks:0GY6}
\href{https://stacks.math.columbia.edu/tag/0GY6}{\texttt{Stacks tag 0GY6}}
\group{etale-cohomology}
...
Thus we win by Lemma \ref{etale-cohomology-lemma-find-extension} and the
fact that $R$ is absolutely integrally closed.
\end{proof}

\begin{proposition}[Aic vanishing]
\label{etale-cohomology-proposition-aic-vanishing}
\source{stacks:0GY7}
\href{https://stacks.math.columbia.edu/tag/0GY7}{\texttt{Stacks tag 0GY7}}
\group{etale-cohomology}
...
Thus Lemma \ref{etale-cohomology-lemma-gabber-criterion} tells us it suffices to
...
(Lemma \ref{etale-cohomology-lemma-mayer-vietoris}) gives $\xi$.
...
its reduction (Proposition \ref{etale-cohomology-proposition-topological-invariance}).
...
above). However, then by Lemma \ref{etale-cohomology-lemma-lift-points-H-to-G}
...
a qotient of $R$). By
Lemma \ref{etale-cohomology-lemma-interpolate} we can find $g \in G(\overline{A})$ with
...
for Gabber's proof in Section \ref{etale-cohomology-section-strictly-henselian-local-rings}.

\begin{lemma}[Efface cohomology on closed by finite cover]
\label{etale-cohomology-lemma-efface-cohomology-on-closed-by-finite-cover}
\source{stacks:09ZE}
\href{https://stacks.math.columbia.edu/tag/09ZE}{\texttt{Stacks tag 09ZE}}
\group{etale-cohomology}
...
\begin{proof}
By Lemmas \ref{etale-cohomology-lemma-torsion-colimit-constructible} and \ref{etale-cohomology-lemma-colimit}
...
Lemma \ref{etale-cohomology-lemma-constructible-maps-into-constant-general}
...
$$
By Lemma \ref{etale-cohomology-lemma-integral-cover-trivial-cohomology}
...
\begin{lemma}[Gabber h0]
\label{etale-cohomology-lemma-gabber-h0}
\source{stacks:09ZF}
\href{https://stacks.math.columbia.edu/tag/09ZF}{\texttt{Stacks tag 09ZF}}
\group{etale-cohomology}
...
Remark \ref{etale-cohomology-remark-cohomological-descent-finite}.
\end{proof}

\begin{lemma}[Connected topological]
\label{etale-cohomology-lemma-connected-topological}
\source{stacks:0CAM}
\href{https://stacks.math.columbia.edu/tag/0CAM}{\texttt{Stacks tag 0CAM}}
\group{etale-cohomology}
...
\begin{lemma}[H0 topological]
\label{etale-cohomology-lemma-h0-topological}
\source{stacks:09ZG}
\href{https://stacks.math.columbia.edu/tag/09ZG}{\texttt{Stacks tag 09ZG}}
\group{etale-cohomology}
...
This case is a restatement of Lemma \ref{etale-cohomology-lemma-connected-topological}
which finishes the proof.
\end{proof}

\begin{example}[Quinard]
\label{etale-cohomology-example-quinard}
\source{stacks:0CAF}
\href{https://stacks.math.columbia.edu/tag/0CAF}{\texttt{Stacks tag 0CAF}}
\group{etale-cohomology}

Lemma \ref{etale-cohomology-lemma-h0-topological} is false if $X$ is not spectral.
...
of Lemma \ref{etale-cohomology-lemma-h0-topological}. But $X$ is connected, while $Z$ is not.
The conclusion of the lemma thus fails for the constant sheaf
with value $\{0, 1\}$ on $X$.
\end{example}

\begin{lemma}[H0 henselian pair]
\label{etale-cohomology-lemma-h0-henselian-pair}
\source{stacks:09ZH}
\href{https://stacks.math.columbia.edu/tag/09ZH}{\texttt{Stacks tag 09ZH}}
\group{etale-cohomology}
...
By Lemma \ref{etale-cohomology-lemma-h0-topological} we see that the statement
...
Thus we can apply Lemma \ref{etale-cohomology-lemma-gabber-h0} to conclude.
\end{proof}
...
\source{stacks:09ZI}
\href{https://stacks.math.columbia.edu/tag/09ZI}{\texttt{Stacks tag 09ZI}}
\group{etale-cohomology}
...
\begin{proof}
The result holds for $q = 0$ by Lemma \ref{etale-cohomology-lemma-h0-henselian-pair}.
...
$$
\begin{array}{cccc}H^{q - 1}_\etale(X, \mathcal{F}') \downarrow\longrightarrow & H^{q - 1}_\etale(X, \mathcal{Q}) \downarrow\longrightarrow & H^q_\etale(X, \mathcal{F}) \downarrow\longrightarrow & H^q_\etale(X, \mathcal{F}') \downarrow \\ H^{q - 1}_\etale(Z, \mathcal{F}'|_Z) \longrightarrow & H^{q - 1}_\etale(Z, \mathcal{Q}|_Z) \longrightarrow & H^q_\etale(Z, \mathcal{F}|_Z) \longrightarrow & H^q_\etale(Z, \mathcal{F}'|_Z)\end{array}
$$
...
Lemma \ref{etale-cohomology-lemma-efface-cohomology-on-closed-by-finite-cover} applied with
...
\begin{lemma}[Vanishing restriction injective]
\label{etale-cohomology-lemma-vanishing-restriction-injective}
\source{stacks:0A51}
\href{https://stacks.math.columbia.edu/tag/0A51}{\texttt{Stacks tag 0A51}}
\group{etale-cohomology}
...
By Theorem \ref{etale-cohomology-theorem-gabber}
we see that
$$
H^q_\etale(Z, \mathcal{I}|_Z) = H^q_\etale(X^h, \mathcal{I}|_{X^h})
$$
By Theorem \ref{etale-cohomology-theorem-colimit} we have
$$
...
Theorem \ref{etale-cohomology-theorem-vanishing-affine-curves}.
In Section \ref{etale-cohomology-section-vanishing-torsion-coefficients}
we will discuss constructible sheaves of torsion modules
over a Noetherian ring.

\begin{definition}[Situation: What to prove]
\label{etale-cohomology-situation-what-to-prove}
\source{stacks:0A52}
\href{https://stacks.math.columbia.edu/tag/0A52}{\texttt{Stacks tag 0A52}}
\group{etale-cohomology}
...
In Situation \ref{etale-cohomology-situation-what-to-prove}
...
\end{enumerate}
Given any Situation \ref{etale-cohomology-situation-what-to-prove}
we will say that
...
\begin{lemma}[Constant smooth statements]
\label{etale-cohomology-lemma-constant-smooth-statements}
\source{stacks:0A5B}
\href{https://stacks.math.columbia.edu/tag/0A5B}{\texttt{Stacks tag 0A5B}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-compare-cohomology-point}
or \ref{etale-cohomology-lemma-affine-only-closed-points}.
...
Lemma \ref{etale-cohomology-lemma-cohomology-smooth-projective-curve}
(projective case) and
Lemma \ref{etale-cohomology-lemma-vanishing-cohomology-mu-smooth-curve}
...
Vanishing by Lemma \ref{etale-cohomology-lemma-vanishing-variety-char-p-p}.
Statements (\ref{item-finite-proper}) and (\ref{item-base-change-proper})
follow from
Lemma \ref{etale-cohomology-lemma-finiteness-proper-variety-char-p-p}.
\end{proof}
...
\source{stacks:0A47}
\href{https://stacks.math.columbia.edu/tag/0A47}{\texttt{Stacks tag 0A47}}
\group{etale-cohomology}

Let $k$ be an algebraically closed field of characteristic $p > 0$.
In Section \ref{etale-cohomology-section-artin-schreier} we have seen that there is
an exact sequence
$$
k[x] \to k[x] \to
...
From Lemma \ref{etale-cohomology-lemma-constant-smooth-statements} above we see that
this is a phenomenon which only happens in characteristic $p$
with $p$-power torsion coefficients.
\end{remark}

\begin{lemma}[Ses statements]
\label{etale-cohomology-lemma-ses-statements}
\source{stacks:0A5C}
\href{https://stacks.math.columbia.edu/tag/0A5C}{\texttt{Stacks tag 0A5C}}
\group{etale-cohomology}
...
\begin{lemma}[Finite pushforward statements]
\label{etale-cohomology-lemma-finite-pushforward-statements}
\source{stacks:0A5D}
\href{https://stacks.math.columbia.edu/tag/0A5D}{\texttt{Stacks tag 0A5D}}
\group{etale-cohomology}
...
(Proposition \ref{etale-cohomology-proposition-finite-higher-direct-image-zero}) and
...
\source{stacks:0GJA}
\href{https://stacks.math.columbia.edu/tag/0GJA}{\texttt{Stacks tag 0GJA}}
\group{etale-cohomology}

In Situation \ref{etale-cohomology-situation-what-to-prove} assume $\mathcal{F}$
...
0 \to j_!j^{-1}\mathcal{F} \to \mathcal{F} \to i_*i^{-1}\mathcal{F} \to 0
$$
of Lemma \ref{etale-cohomology-lemma-ses-associated-to-open}. Observe that
...
\begin{lemma}[Even easier]
\label{etale-cohomology-lemma-even-easier}
\source{stacks:03SG}
\href{https://stacks.math.columbia.edu/tag/03SG}{\texttt{Stacks tag 03SG}}
\group{etale-cohomology}

In Situation \ref{etale-cohomology-situation-what-to-prove} assume $X$ is smooth.
...
Lemmas \ref{etale-cohomology-lemma-constant-smooth-statements} and
\ref{etale-cohomology-lemma-restrict-to-open}.
\end{proof}

\begin{lemma}[Somewhat easier]
\label{etale-cohomology-lemma-somewhat-easier}
\source{stacks:0A3Q}
\href{https://stacks.math.columbia.edu/tag/0A3Q}{\texttt{Stacks tag 0A3Q}}
\group{etale-cohomology}

In Situation \ref{etale-cohomology-situation-what-to-prove} assume $X$ reduced.
Let $j : U \to X$ an open immersion. Let $\ell$ be a prime number
...
\begin{proof}
The difference with Lemma \ref{etale-cohomology-lemma-even-easier} is that here we do not
...
By Lemma \ref{etale-cohomology-lemma-even-easier} the result holds for
$j^\nu_!\underline{\mathbf{Z}/\ell\mathbf{Z}}$.
By Lemma \ref{etale-cohomology-lemma-finite-pushforward-statements}
...
$$
Using Lemma \ref{etale-cohomology-lemma-restrict-to-open}
twice for $j' : X' \to X$ and the sheaves above
we conclude.
\end{proof}

\begin{lemma}[Vanishing easier]
\label{etale-cohomology-lemma-vanishing-easier}
\source{stacks:03SD}
\href{https://stacks.math.columbia.edu/tag/03SD}{\texttt{Stacks tag 03SD}}
\group{etale-cohomology}
...
as in Lemma \ref{etale-cohomology-lemma-pullback-filtered}. The discussion in
Section \ref{etale-cohomology-section-trace-method} gives maps
$$
...
$$
\begin{array}{cc}V \underset{j'}{\longrightarrow}\underset{f}{\downarrow} & Y \overset{\overline{f}}{\downarrow} \\ U \overset{j}{\longrightarrow} & X\end{array}
$$
...
Lemma \ref{etale-cohomology-lemma-compatible-shriek-push-finite} we have
$$
j_!f_*f^{-1}\mathcal{G} = \overline{f}_*j'_!f^{-1}\mathcal{G}
$$
By Lemma \ref{etale-cohomology-lemma-finite-pushforward-statements} it suffices to
consider $j'_!f^{-1}\mathcal{G}$.
The existence of the filtration given by
Lemma \ref{etale-cohomology-lemma-pullback-filtered},
the fact that $j'_!$ is exact, and
Lemma \ref{etale-cohomology-lemma-ses-statements}
reduces us to the case
$\mathcal{F} = j'_!\underline{\mathbf{Z}/\ell\mathbf{Z}}$
which is Lemma \ref{etale-cohomology-lemma-somewhat-easier}.
\end{proof}


%10.20.09

\begin{theorem}[Vanishing affine curves]
\label{etale-cohomology-theorem-vanishing-affine-curves}
\source{stacks:03SC}
\href{https://stacks.math.columbia.edu/tag/03SC}{\texttt{Stacks tag 03SC}}
\group{etale-cohomology}
...
\begin{proof}
The theorem says that in Situation \ref{etale-cohomology-situation-what-to-prove}
statements (\ref{item-vanishing}) -- (\ref{item-surjective}) hold.
Our first step is to replace $X$ by its reduction, which is permissible
by Proposition \ref{etale-cohomology-proposition-topological-invariance}.
By Lemma \ref{etale-cohomology-lemma-torsion-colimit-constructible} we can write
$\mathcal{F}$ as a filtered colimit of constructible abelian sheaves.
Taking cohomology commutes with colimits, see Lemma \ref{etale-cohomology-lemma-colimit}.
...
\medskip\noindent
In this paragraph we use Lemma \ref{etale-cohomology-lemma-ses-statements} without further
mention. Writing
...
By Lemma \ref{etale-cohomology-lemma-restrict-to-open} we reduce to the case
...
Lemma \ref{etale-cohomology-lemma-vanishing-easier}.
\end{proof}

\begin{theorem}[Vanishing curves]
\label{etale-cohomology-theorem-vanishing-curves}
\source{stacks:03RT}
\href{https://stacks.math.columbia.edu/tag/03RT}{\texttt{Stacks tag 03RT}}
\group{etale-cohomology}
...
Then Mayer-Vietoris (Lemma \ref{etale-cohomology-lemma-mayer-vietoris}) gives
$$
...
by Theorem \ref{etale-cohomology-theorem-vanishing-affine-curves}.
\end{proof}

\begin{lemma}[Base change dim 1 separably closed]
\label{etale-cohomology-lemma-base-change-dim-1-separably-closed}
\source{stacks:0A5E}
\href{https://stacks.math.columbia.edu/tag/0A5E}{\texttt{Stacks tag 0A5E}}
\group{etale-cohomology}
...
choose a diagram
$$
\begin{array}{cc}k' \longrightarrow & \overline{k}' \\ k \uparrow\longrightarrow & \overline{k} \uparrow\end{array}
$$
...
see Proposition \ref{etale-cohomology-proposition-topological-invariance}.
...
\begin{lemma}[Constant statements coefficients]
\label{etale-cohomology-lemma-constant-statements-coefficients}
\source{stacks:0GJC}
\href{https://stacks.math.columbia.edu/tag/0GJC}{\texttt{Stacks tag 0GJC}}
\group{etale-cohomology}
...
by Theorem \ref{etale-cohomology-theorem-colimit}
(or Lemma \ref{etale-cohomology-lemma-colimit} or
Lemma \ref{etale-cohomology-lemma-direct-sum-bounded-below-cohomology}).
...
\begin{lemma}[Finite pushforward coefficients]
\label{etale-cohomology-lemma-finite-pushforward-coefficients}
\source{stacks:0GJD}
\href{https://stacks.math.columbia.edu/tag/0GJD}{\texttt{Stacks tag 0GJD}}
\group{etale-cohomology}
...
\begin{lemma}[Restrict to open coefficients]
\label{etale-cohomology-lemma-restrict-to-open-coefficients}
\source{stacks:0GJE}
\href{https://stacks.math.columbia.edu/tag/0GJE}{\texttt{Stacks tag 0GJE}}
\group{etale-cohomology}
...
\begin{lemma}[Somewhat easier coefficients]
\label{etale-cohomology-lemma-somewhat-easier-coefficients}
\source{stacks:0GJF}
\href{https://stacks.math.columbia.edu/tag/0GJF}{\texttt{Stacks tag 0GJF}}
\group{etale-cohomology}
...
This case follows from Lemmas \ref{etale-cohomology-lemma-restrict-to-open-coefficients}
and \ref{etale-cohomology-lemma-constant-statements-coefficients}.
\end{proof}

\begin{lemma}[Ses statements coefficients]
\label{etale-cohomology-lemma-ses-statements-coefficients}
\source{stacks:0GJG}
\href{https://stacks.math.columbia.edu/tag/0GJG}{\texttt{Stacks tag 0GJG}}
\group{etale-cohomology}
...
\begin{lemma}[Vanishing easier coefficients]
\label{etale-cohomology-lemma-vanishing-easier-coefficients}
\source{stacks:0GJH}
\href{https://stacks.math.columbia.edu/tag/0GJH}{\texttt{Stacks tag 0GJH}}
\group{etale-cohomology}
...
\begin{proof}
Let $f : V \to U$ be a finite \'etale morphism of degree prime to $\ell$
as in Lemma \ref{etale-cohomology-lemma-pullback-filtered-modules}. The discussion in
Section \ref{etale-cohomology-section-trace-method} gives maps
$$
\mathcal{G} \to f_*f^{-1}\mathcal{G} \to \mathcal{G}
$$
...
$V = U \times_X Y$. By Lemma \ref{etale-cohomology-lemma-compatible-shriek-push-finite} we have
$$
j_!f_*f^{-1}\mathcal{G} = \overline{f}_*j'_!f^{-1}\mathcal{G}
$$
By Lemma \ref{etale-cohomology-lemma-finite-pushforward-coefficients} it suffices to
consider $j'_!f^{-1}\mathcal{G}$. The existence of the filtration given by
Lemma \ref{etale-cohomology-lemma-pullback-filtered-modules},
the fact that $j'_!$ is exact, and
Lemma \ref{etale-cohomology-lemma-ses-statements-coefficients}
reduces us to the case
$\mathcal{F} = j'_!\underline{M}$ for a finite $\Lambda$-module $M$
which is Lemma \ref{etale-cohomology-lemma-somewhat-easier-coefficients}.
\end{proof}

\begin{theorem}[Vanishing affine curves coefficients]
\label{etale-cohomology-theorem-vanishing-affine-curves-coefficients}
\source{stacks:0GJI}
\href{https://stacks.math.columbia.edu/tag/0GJI}{\texttt{Stacks tag 0GJI}}
\group{etale-cohomology}
...
By Lemma \ref{etale-cohomology-lemma-ses-statements-coefficients} it suffices
...
Lemma \ref{etale-cohomology-lemma-restrict-to-open-coefficients}
...
where $j_i : U_i \to X$ is the inclusion morphism.
The case of $j_{i!}(\mathcal{G}|_{U_i})$ is handled in
Lemma \ref{etale-cohomology-lemma-vanishing-easier-coefficients}.
\end{proof}
...
\begin{lemma}[Proper over henselian and h1]
\label{etale-cohomology-lemma-proper-over-henselian-and-h1}
\source{stacks:0A5G}
\href{https://stacks.math.columbia.edu/tag/0A5G}{\texttt{Stacks tag 0A5G}}
\group{etale-cohomology}
...
Such a torsor is clearly a finite locally constant sheaf.
Hence $\mathcal{F}$ is representable by a scheme $V$ finite
\'etale over $X$, Lemma \ref{etale-cohomology-lemma-characterize-finite-locally-constant}.
...
\begin{lemma}[Efface cohomology on fibre by finite cover]
\label{etale-cohomology-lemma-efface-cohomology-on-fibre-by-finite-cover}
\source{stacks:0A5H}
\href{https://stacks.math.columbia.edu/tag/0A5H}{\texttt{Stacks tag 0A5H}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-vanishing-restriction-injective}.
Thus we may assume $q = 1$. Let
$\xi \in H^1_\etale(X_0, \mathcal{I}|_{X_0})$.
Goal: show that $\xi$ is $0$.
By Lemmas \ref{etale-cohomology-lemma-torsion-colimit-constructible} and
\ref{etale-cohomology-lemma-colimit} we can find a map $\mathcal{F} \to \mathcal{I}$
...
\medskip\noindent
By Lemma \ref{etale-cohomology-lemma-constructible-maps-into-constant-general}
...
Lemma \ref{etale-cohomology-lemma-proper-over-henselian-and-h1} to see that
...
$$
\begin{array}{cc}H^1_\etale(X, f_*\underline{M}) \longrightarrow\downarrow & H^1_\etale(X, \mathcal{I}) \downarrow \\ H^1_\etale(X_0, (f_*\underline{M})|_{X_0}) \longrightarrow & H^1_\etale(X_0, \mathcal{I}|_{X_0})\end{array}
$$
...
$$
\begin{array}{cc}X \underset{f}{\downarrow} & Y \overset{h}{\longleftarrow}\overset{e}{\downarrow} \\ S & T \underset{g}{\longleftarrow}\end{array}
$$
...
$$
\begin{array}{cc}X_\etale \underset{f_{small}}{\downarrow} & Y_\etale \overset{e_{small}}{\downarrow}\overset{h_{small}}{\longleftarrow} \\ S_\etale & T_\etale \underset{g_{small}}{\longleftarrow}\end{array}
$$
...
\begin{lemma}[Base change local]
\label{etale-cohomology-lemma-base-change-local}
\source{stacks:0EZR}
\href{https://stacks.math.columbia.edu/tag/0EZR}{\texttt{Stacks tag 0EZR}}
\group{etale-cohomology}
...
$$
\begin{array}{cc}U_i \underset{f_i}{\downarrow} & U_i \times_X Y \overset{h_i}{\longleftarrow}\overset{e_i}{\downarrow} \\ V_i & V_i \times_S T \underset{g_i}{\longleftarrow}\end{array}
$$
...
\begin{lemma}[Base change compose]
\label{etale-cohomology-lemma-base-change-compose}
\source{stacks:0EZS}
\href{https://stacks.math.columbia.edu/tag/0EZS}{\texttt{Stacks tag 0EZS}}
\group{etale-cohomology}

Consider a tower of cartesian diagrams of schemes
$$
\begin{array}{cc}W \underset{i}{\downarrow} & Z \overset{j}{\longleftarrow}\overset{k}{\downarrow} \\ X \underset{f}{\downarrow} & Y \overset{h}{\longleftarrow}\overset{e}{\downarrow} \\ S & T \underset{g}{\longleftarrow}\end{array}
$$
...
\begin{lemma}[Base change Rf star colim]
\label{etale-cohomology-lemma-base-change-Rf-star-colim}
\source{stacks:0EZT}
\href{https://stacks.math.columbia.edu/tag/0EZT}{\texttt{Stacks tag 0EZT}}
\group{etale-cohomology}

Let $I$ be a directed set. Consider an inverse system of
cartesian diagrams of schemes
$$
\begin{array}{cc}X_i \underset{f_i}{\downarrow} & Y_i \overset{h_i}{\longleftarrow}\overset{e_i}{\downarrow} \\ S_i & T_i \underset{g_i}{\longleftarrow}\end{array}
$$
...
$(T_i)$ as in Definition \ref{etale-cohomology-definition-inverse-system-sheaves}. Set
...
By Lemma \ref{etale-cohomology-lemma-relative-colimit-general}
this gives
$$
...
\begin{lemma}[Base change Rf star colim complexes]
\label{etale-cohomology-lemma-base-change-Rf-star-colim-complexes}
\source{stacks:0GJL}
\href{https://stacks.math.columbia.edu/tag/0GJL}{\texttt{Stacks tag 0GJL}}
\group{etale-cohomology}

Let $I$, $X_i$, $Y_i$, $S_i$, $T_i$, $f_i$, $h_i$, $e_i$, $g_i$,
$X$, $Y$, $S$, $T$, $f$, $h$, $e$, $g$ be as in the statement
of Lemma \ref{etale-cohomology-lemma-base-change-Rf-star-colim}.
...
Lemma \ref{etale-cohomology-lemma-base-change-Rf-star-colim}
replacing reference to
Lemma \ref{etale-cohomology-lemma-relative-colimit-general}
by a reference to
Lemma \ref{etale-cohomology-lemma-relative-colimit-general-complexes}.
\end{proof}

\begin{lemma}[Base change f star general stalks]
\label{etale-cohomology-lemma-base-change-f-star-general-stalks}
\source{stacks:0EZU}
\href{https://stacks.math.columbia.edu/tag/0EZU}{\texttt{Stacks tag 0EZU}}
\group{etale-cohomology}
...
in (2) by Theorem \ref{etale-cohomology-theorem-higher-direct-images} (and
Lemma \ref{etale-cohomology-lemma-stalk-pullback}).
Thus the result by Theorem \ref{etale-cohomology-theorem-exactness-stalks}.
\end{proof}

\begin{lemma}[Check stalks better]
\label{etale-cohomology-lemma-check-stalks-better}
\source{stacks:0EZV}
\href{https://stacks.math.columbia.edu/tag/0EZV}{\texttt{Stacks tag 0EZV}}
\group{etale-cohomology}
...
of schemes (Theorem \ref{etale-cohomology-theorem-colimit}) we conclude.
\end{proof}
...
\begin{lemma}[Base change f star general]
\label{etale-cohomology-lemma-base-change-f-star-general}
\source{stacks:0EZX}
\href{https://stacks.math.columbia.edu/tag/0EZX}{\texttt{Stacks tag 0EZX}}
\group{etale-cohomology}
...
follows from Lemma \ref{etale-cohomology-lemma-sections-upstairs}\footnote{Strictly
...
the third equality  follows from Lemma \ref{etale-cohomology-lemma-sections-upstairs}
...
\begin{lemma}[Fppf reduced fibres base change f star]
\label{etale-cohomology-lemma-fppf-reduced-fibres-base-change-f-star}
\source{stacks:0EYS}
\href{https://stacks.math.columbia.edu/tag/0EYS}{\texttt{Stacks tag 0EYS}}
\group{etale-cohomology}
...
\begin{proof}
Combine Lemma \ref{etale-cohomology-lemma-base-change-f-star-general} with
More on Morphisms, Lemma
\ref{more-morphisms-lemma-cover-by-geometrically-connected}.
\end{proof}

\begin{lemma}[Base change f star field]
\label{etale-cohomology-lemma-base-change-f-star-field}
\source{stacks:0EZY}
\href{https://stacks.math.columbia.edu/tag/0EZY}{\texttt{Stacks tag 0EZY}}
\group{etale-cohomology}
...
finite type over $S$. By Lemma \ref{etale-cohomology-lemma-base-change-Rf-star-colim}
we may assume that $X$ is of finite type over $S$.
Then Lemma \ref{etale-cohomology-lemma-base-change-f-star-general}
...
\begin{lemma}[Base change f star valuation]
\label{etale-cohomology-lemma-base-change-f-star-valuation}
\source{stacks:0EZZ}
\href{https://stacks.math.columbia.edu/tag/0EZZ}{\texttt{Stacks tag 0EZZ}}
\group{etale-cohomology}
...
the condition of Lemma \ref{etale-cohomology-lemma-base-change-f-star-general}.
...
\begin{lemma}[Fppf reduced fibres pullback products]
\label{etale-cohomology-lemma-fppf-reduced-fibres-pullback-products}
\source{stacks:0EYR}
\href{https://stacks.math.columbia.edu/tag/0EYR}{\texttt{Stacks tag 0EYR}}
\group{etale-cohomology}
...
(\prod f^{-1}\mathcal{G}_i)(U)
\end{align*}
where we have used Lemma \ref{etale-cohomology-lemma-sections-upstairs}
...
\begin{lemma}[Base change f star]
\label{etale-cohomology-lemma-base-change-f-star}
\source{stacks:0F00}
\href{https://stacks.math.columbia.edu/tag/0F00}{\texttt{Stacks tag 0F00}}
\group{etale-cohomology}
...
Theorem \ref{etale-cohomology-theorem-exactness-stalks}.
By Theorem \ref{etale-cohomology-theorem-higher-direct-images} we have
$$
...
$$
These sets are equal by an application of Lemma \ref{etale-cohomology-lemma-sections-upstairs}
to the morphism
$$
...
This section is the analogue of Section \ref{etale-cohomology-section-base-change-f-star}
for higher direct images.
This section is preliminary and should be skipped on a first reading.

\begin{remark}[Base change holds]
\label{etale-cohomology-remark-base-change-holds}
\source{stacks:0F02}
\href{https://stacks.math.columbia.edu/tag/0F02}{\texttt{Stacks tag 0F02}}
\group{etale-cohomology}

Let $f : X \to S$ be a morphism of schemes. Let $n$ be an integer.
We will say $BC(f, n, q_0)$ is true if for every commutative diagram
$$
\begin{array}{ccc}X \underset{f}{\downarrow} & X' \longleftarrow\underset{f'}{\downarrow} & Y \overset{h}{\longleftarrow}\overset{e}{\downarrow} \\ S & S' \longleftarrow & T \underset{g}{\longleftarrow}\end{array}
$$
...
\begin{lemma}[Base change q injective]
\label{etale-cohomology-lemma-base-change-q-injective}
\source{stacks:0F03}
\href{https://stacks.math.columbia.edu/tag/0F03}{\texttt{Stacks tag 0F03}}
\group{etale-cohomology}

With $f : X \to S$ and $n$ as in Remark \ref{etale-cohomology-remark-base-change-holds}
...
$$
\begin{array}{cccc}(f')^{-1}R^{q - 1}g_*\mathcal{I} \underset{\cong}{\downarrow}\longrightarrow & (f')^{-1}R^{q - 1}g_*\mathcal{Q} \underset{\cong}{\downarrow}\longrightarrow & (f')^{-1}R^qg_*\mathcal{F} \downarrow\longrightarrow & 0 \downarrow \\ R^{q - 1}h_*e^{-1}\mathcal{I} \longrightarrow & R^{q - 1}h_*e^{-1}\mathcal{Q} \longrightarrow & R^qh_*e^{-1}\mathcal{F} \longrightarrow & R^qh_*e^{-1}\mathcal{I}\end{array}
$$
...
\begin{lemma}[Base change q integral top]
\label{etale-cohomology-lemma-base-change-q-integral-top}
\source{stacks:0F04}
\href{https://stacks.math.columbia.edu/tag/0F04}{\texttt{Stacks tag 0F04}}
\group{etale-cohomology}
...
$$
\vcenter{
\begin{array}{cccc}X \underset{f}{\downarrow} & X' \underset{f'}{\downarrow}\longleftarrow & Y \overset{h}{\longleftarrow}\overset{e}{\downarrow} & Y' \overset{\pi'}{\longleftarrow}\overset{e'}{\downarrow} \\ S & S' \longleftarrow & T \underset{g}{\longleftarrow} & T' \underset{\pi}{\longleftarrow}\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{ccc}X' \underset{f'}{\downarrow} &  & Y' \overset{h' = h \circ \pi'}{\longleftarrow}\overset{e'}{\downarrow} \\ S' &  & T' \underset{g' = g \circ \pi}{\longleftarrow}\end{array}
}
$$
...
Lemma \ref{etale-cohomology-lemma-base-change-q-injective}
...
\ref{etale-cohomology-lemma-integral-pushforward-commutes-with-base-change} and
\ref{etale-cohomology-lemma-what-integral} and the relative leray spectral sequence
(Cohomology on Sites, Lemma \ref{sites-cohomology-lemma-relative-Leray}).
\end{proof}

\begin{lemma}[Base change q integral bottom]
\label{etale-cohomology-lemma-base-change-q-integral-bottom}
\source{stacks:0F05}
\href{https://stacks.math.columbia.edu/tag/0F05}{\texttt{Stacks tag 0F05}}
\group{etale-cohomology}
...
$$
\vcenter{
\begin{array}{cccc}X \underset{f}{\downarrow} & X' \underset{f'}{\downarrow}\longleftarrow & X'' \overset{\pi'}{\longleftarrow}\underset{f''}{\downarrow} & Y \overset{h'}{\longleftarrow}\overset{e}{\downarrow} \\ S & S' \longleftarrow & S'' \underset{\pi}{\longleftarrow} & T \underset{g'}{\longleftarrow}\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{ccc}X' \underset{f'}{\downarrow} &  & Y \overset{h = h' \circ \pi'}{\longleftarrow}\overset{e}{\downarrow} \\ S' &  & T \underset{g = g' \circ \pi}{\longleftarrow}\end{array}
...
$R\pi'_* = \pi'_*$, see Lemma \ref{etale-cohomology-lemma-what-integral}.
...
Hence we see that it is an isomorphism by Lemma \ref{etale-cohomology-lemma-what-integral}.
\end{proof}

\begin{lemma}[Formal argument]
\label{etale-cohomology-lemma-formal-argument}
\source{stacks:0F06}
\href{https://stacks.math.columbia.edu/tag/0F06}{\texttt{Stacks tag 0F06}}
\group{etale-cohomology}
...
\begin{lemma}[Base change does not hold pre]
\label{etale-cohomology-lemma-base-change-does-not-hold-pre}
\source{stacks:0F07}
\href{https://stacks.math.columbia.edu/tag/0F07}{\texttt{Stacks tag 0F07}}
\group{etale-cohomology}
...
$$
\begin{array}{ccc}X \underset{f}{\downarrow} & X' \underset{f'}{\downarrow}\longleftarrow & Y \overset{h}{\longleftarrow}\overset{e}{\downarrow} \\ S & S' \longleftarrow & \Spec(K) \underset{g}{\longleftarrow}\end{array}
$$
...
and quasi-separated. By Lemma \ref{etale-cohomology-lemma-base-change-q-injective} we see
$(f')^{-1}R^qg_*\mathcal{F} \to R^qh_*e^{-1}\mathcal{F}$
...
$$
\vcenter{
\begin{array}{ccc}X' \underset{f'}{\downarrow} & Y \overset{h}{\longleftarrow}\overset{e}{\downarrow} & Y' \overset{\pi'}{\longleftarrow}\overset{e'}{\downarrow} \\ S' & T \underset{g}{\longleftarrow} & T' \underset{\pi}{\longleftarrow}\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{ccc}X' \underset{f'}{\downarrow} &  & Y' \overset{h' = h \circ \pi'}{\longleftarrow}\overset{e'}{\downarrow} \\ S' &  & T' \underset{g' = g \circ \pi}{\longleftarrow}\end{array}
...
$$
\begin{array}{cc}(f')^{-1}R^qg_*\mathcal{F} \longrightarrow\downarrow & (f')^{-1}R^qg'_*\mathcal{F}' \downarrow \\ R^qh_*e^{-1}\mathcal{F} \longrightarrow & R^qh'_*(e')^{-1}\mathcal{F}'\end{array}
$$
...
Lemma \ref{etale-cohomology-lemma-formal-argument} hold for $P$
which proves our lemma.

\medskip\noindent
Condition (1) of Lemma \ref{etale-cohomology-lemma-formal-argument}
...
$$
\vcenter{
\begin{array}{ccc}X \underset{f'}{\downarrow} & Y \overset{h}{\longleftarrow}\overset{e}{\downarrow} & Y_i \overset{\pi_i'}{\longleftarrow}\overset{e_i}{\downarrow} \\ S & T \underset{g}{\longleftarrow} & T_i \underset{\pi_i}{\longleftarrow}\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{ccc}X \underset{f'}{\downarrow} &  & Y_i \overset{h_i = h \circ \pi_i'}{\longleftarrow}\overset{e_i}{\downarrow} \\ S &  & T_i \underset{g_i = g \circ \pi_i}{\longleftarrow}\end{array}
}
$$
...
$P(T')$ holds. Thus condition (2) of Lemma \ref{etale-cohomology-lemma-formal-argument}
holds for $P$.

\medskip\noindent
The most interesting is condition (3) of Lemma \ref{etale-cohomology-lemma-formal-argument}.
...
$$
\begin{array}{ccc}Y' \times_{T'} Z \underset{e_Z}{\downarrow}\underset{i'}{\longrightarrow} & Y' \underset{e'}{\downarrow} & Y' \times_{T'} V \overset{j'}{\longleftarrow}\overset{e_V}{\downarrow} \\ Z \overset{i}{\longrightarrow} & T' & V \underset{j}{\longleftarrow}\end{array}
$$
...
\right)
\end{align*}
by part (2) of Lemma \ref{etale-cohomology-lemma-base-change-q-injective}.
...
$$
\begin{array}{ccc}X \underset{f}{\downarrow} & Y' \longleftarrow\underset{e'}{\downarrow} & Y \overset{j'}{\longleftarrow}\overset{e_V}{\downarrow} \\ S & T' \longleftarrow & V \underset{j}{\longleftarrow}\end{array}
$$
...
Applying part (3) of Lemma \ref{etale-cohomology-lemma-base-change-q-injective}
to the injection $j^{-1}\mathcal{F}' \to \mathcal{J}$
we conclude that $P(V)$ holds.
\end{proof}

\begin{lemma}[Base change does not hold]
\label{etale-cohomology-lemma-base-change-does-not-hold}
\source{stacks:0F08}
\href{https://stacks.math.columbia.edu/tag/0F08}{\texttt{Stacks tag 0F08}}
\group{etale-cohomology}
...
$$
\begin{array}{ccc}X \underset{f}{\downarrow} & X' \downarrow\longleftarrow & Y \overset{h}{\longleftarrow}\downarrow \\ S & S' \longleftarrow & \Spec(K) \longleftarrow\end{array}
$$
...
Lemma \ref{etale-cohomology-lemma-base-change-does-not-hold-pre}.
We may and do assume $S'$ is affine (this is obvious, but
see proof of the lemma in case of doubt).
By Lemma \ref{etale-cohomology-lemma-base-change-q-integral-top}
...
By Lemma \ref{etale-cohomology-lemma-base-change-q-integral-bottom}
...
\begin{lemma}[Smooth base change fields]
\label{etale-cohomology-lemma-smooth-base-change-fields}
\source{stacks:0EYT}
\href{https://stacks.math.columbia.edu/tag/0EYT}{\texttt{Stacks tag 0EYT}}
\group{etale-cohomology}
...
(Theorem \ref{etale-cohomology-theorem-vanishing-affine-curves}).
By Lemma \ref{etale-cohomology-lemma-directed-colimit-cohomology} we see that
...
see Lemma \ref{etale-cohomology-lemma-colimit}. After replacing $K$ by a finite extension
...
H^1(X_{\overline{K}}, \mathbf{Z}/d\mathbf{Z})
$$
See Theorem \ref{etale-cohomology-theorem-vanishing-affine-curves}.
...
Thus by Lemma \ref{etale-cohomology-lemma-directed-colimit-cohomology}
...
\source{stacks:0EYU}
\href{https://stacks.math.columbia.edu/tag/0EYU}{\texttt{Stacks tag 0EYU}}
\group{etale-cohomology}
...
$$
\begin{array}{cc}U \underset{f'}{\downarrow} & U \times_X Y \overset{h'}{\longleftarrow}\overset{e'}{\downarrow} \\ V & V \times_S T \underset{g'}{\longleftarrow}\end{array}
$$
...
Lemma \ref{etale-cohomology-lemma-relative-colimit}.
...
$$
\begin{array}{cc}X \downarrow & e^{-1}(W) \overset{i}{\longleftarrow}\downarrow \\ S & W \underset{a}{\longleftarrow}\end{array}
\quad
\begin{array}{cc}X \downarrow & e^{-1}(W') \overset{j}{\longleftarrow}\downarrow \\ S & W' \underset{b}{\longleftarrow}\end{array}
\quad
\begin{array}{cc}X \downarrow & e^{-1}(W \cap W') \overset{k}{\longleftarrow}\downarrow \\ S & W \cap W' \underset{c}{\longleftarrow}\end{array}
$$
then the theorem holds for the original diagram. To see this we consider the
diagram
$$
\begin{array}{ccc}f^{-1}R^{q - 1}c_*\mathcal{F}|_{W \cap W'} \overset{\cong}{\downarrow}\longrightarrow & f^{-1}R^qg_*\mathcal{F} \downarrow\longrightarrow & f^{-1}R^qa_*\mathcal{F}|_W \oplus
f^{-1}R^qb_*\mathcal{F}|_{W'} \underset{\cong}{\downarrow} \\ R^qk_*e^{-1}\mathcal{F}|_{e^{-1}(W \cap W')} \longrightarrow & R^qh_*e^{-1}\mathcal{F} \longrightarrow & R^qi_*e^{-1}\mathcal{F}|_{e^{-1}(W)} \oplus
R^qj_*e^{-1}\mathcal{F}|_{e^{-1}(W')}\end{array}
$$
whose rows are the long exact sequences of
Lemma \ref{etale-cohomology-lemma-relative-mayer-vietoris}.
...
is handled by Lemma \ref{etale-cohomology-lemma-fppf-reduced-fibres-base-change-f-star}.
...
by Lemma \ref{etale-cohomology-lemma-linus-hamann}. Pulling back by $e$ we get
$e^{-1}\mathcal{I} = \colim (Y \to Y_i)^{-1}e_i^{-1}\mathcal{I}_i$.
By Lemma \ref{etale-cohomology-lemma-relative-colimit-general} applied to the system
...
In particular, using Lemma \ref{etale-cohomology-lemma-higher-direct-images}
...
$$
By Proposition \ref{etale-cohomology-proposition-finite-higher-direct-image-zero} and
Lemma \ref{etale-cohomology-lemma-finite-pushforward-commutes-with-base-change} we have
...
$$
\begin{array}{ccc}X \underset{f}{\downarrow} & X' \overset{\pi'}{\longleftarrow}\overset{f'}{\downarrow} & Y \overset{h'}{\longleftarrow}\overset{e}{\downarrow} \\ S & S' \underset{\pi}{\longleftarrow} & T \underset{g}{\longleftarrow}\end{array}
$$
...
for $X' \to X$ (Lemma \ref{etale-cohomology-lemma-finite-B}) there exists an \'etale covering
...
Lemma \ref{etale-cohomology-lemma-smooth-base-change-fields} there exist finite field
...
$$
\begin{array}{cc}S' \downarrow & T' \longleftarrow\downarrow \\ S & T \longleftarrow\end{array}
$$
...
By Lemma \ref{etale-cohomology-lemma-directed-colimit-cohomology} we conclude there exists
...
$$
\begin{array}{ccc}Y \times_T Z \underset{e_Z}{\downarrow}\underset{i'}{\longrightarrow} & Y \underset{e}{\downarrow} & Y \times_T V \overset{j'}{\longleftarrow}\overset{e_V}{\downarrow} \\ Z \overset{i}{\longrightarrow} & T & V \underset{j}{\longleftarrow}\end{array}
$$
...
\medskip\noindent
By Lemma \ref{etale-cohomology-lemma-base-change-local} the question is \'etale local
...
\mathbf{A}^1_S \to S
$$
we conclude from Lemma \ref{etale-cohomology-lemma-base-change-compose}
that it suffices to prove the theorem when $X$ and $S$
are affine and $X \to S$ has relative dimension $1$.

\medskip\noindent
By Lemma \ref{etale-cohomology-lemma-base-change-does-not-hold} it suffices to show that
$R^qh_*\mathbf{Z}/d\mathbf{Z} = 0$ for $d | n$ whenever we have a
cartesian diagram
$$
\begin{array}{cc}X \downarrow & Y \downarrow\overset{h}{\longleftarrow} \\ S & \Spec(K) \longleftarrow\end{array}
$$
...
$$
on $X_\etale$ (Lemma \ref{etale-cohomology-lemma-higher-direct-images}).
...
for $q > 1$ by Theorem \ref{etale-cohomology-theorem-vanishing-affine-curves}.
...
$$
See Lemma \ref{etale-cohomology-lemma-base-change-dim-1-separably-closed}.
...
proof of Lemma \ref{etale-cohomology-lemma-smooth-base-change-fields}
...
\begin{lemma}[Smooth base change general]
\label{etale-cohomology-lemma-smooth-base-change-general}
\source{stacks:0F09}
\href{https://stacks.math.columbia.edu/tag/0F09}{\texttt{Stacks tag 0F09}}
\group{etale-cohomology}
...
$$
\begin{array}{cc}X' \underset{f'}{\downarrow}\underset{g'}{\longrightarrow} & X \overset{f}{\downarrow} \\ S' \overset{g}{\longrightarrow} & S\end{array}
$$
Then
$$
...
(Theorem \ref{etale-cohomology-theorem-smooth-base-change})
with Lemma \ref{etale-cohomology-lemma-base-change-Rf-star-colim} we see that
$$
...
\begin{lemma}[Base change field extension]
\label{etale-cohomology-lemma-base-change-field-extension}
\source{stacks:0F1C}
\href{https://stacks.math.columbia.edu/tag/0F1C}{\texttt{Stacks tag 0F1C}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-smooth-base-change-general}.
...
\begin{lemma}[Smooth base change separably closed]
\label{etale-cohomology-lemma-smooth-base-change-separably-closed}
\source{stacks:0F0B}
\href{https://stacks.math.columbia.edu/tag/0F0B}{\texttt{Stacks tag 0F0B}}
\group{etale-cohomology}
...
Theorem \ref{etale-cohomology-theorem-smooth-base-change} as reformulated in
Lemma \ref{etale-cohomology-lemma-smooth-base-change-general}.
...
\begin{lemma}[Base change does not hold post]
\label{etale-cohomology-lemma-base-change-does-not-hold-post}
\source{stacks:0F1D}
\href{https://stacks.math.columbia.edu/tag/0F1D}{\texttt{Stacks tag 0F1D}}
\group{etale-cohomology}
...
\begin{proof}
First choose a diagram and $\mathcal{F}$ as in
Lemma \ref{etale-cohomology-lemma-base-change-does-not-hold}.
We may and do assume $S'$ is affine (this is obvious, but
see proof of the lemma in case of doubt).
Let $K'$ be the function field of $S'$
and let $Y' = X' \times_{S'} \Spec(K')$ to get the diagram
$$
\begin{array}{cccc}X \underset{f}{\downarrow} & X' \downarrow\longleftarrow & Y' \overset{h'}{\longleftarrow}\downarrow & Y \longleftarrow\downarrow \\ S & S' \longleftarrow & \Spec(K') \longleftarrow & \Spec(K) \longleftarrow\end{array}
$$
By Lemma \ref{etale-cohomology-lemma-smooth-base-change-separably-closed}
...
\begin{lemma}[Zariski h0 proper over henselian pair]
\label{etale-cohomology-lemma-zariski-h0-proper-over-henselian-pair}
\source{stacks:0A0B}
\href{https://stacks.math.columbia.edu/tag/0A0B}{\texttt{Stacks tag 0A0B}}
\group{etale-cohomology}
...
\begin{proof}
We will use Lemma \ref{etale-cohomology-lemma-h0-topological} to prove this. First observe
...
\begin{lemma}[H0 proper over henselian pair]
\label{etale-cohomology-lemma-h0-proper-over-henselian-pair}
\source{stacks:0A0C}
\href{https://stacks.math.columbia.edu/tag/0A0C}{\texttt{Stacks tag 0A0C}}
\group{etale-cohomology}
...
\begin{proof}
This follows from Lemma \ref{etale-cohomology-lemma-gabber-h0} and
...
\begin{lemma}[H0 proper over henselian local]
\label{etale-cohomology-lemma-h0-proper-over-henselian-local}
\source{stacks:0A3S}
\href{https://stacks.math.columbia.edu/tag/0A3S}{\texttt{Stacks tag 0A3S}}
\group{etale-cohomology}
...
\begin{proof}
This is a special case of Lemma \ref{etale-cohomology-lemma-h0-proper-over-henselian-pair}.
\end{proof}
...
Definition \ref{etale-cohomology-definition-algebraic-geometric-point}.
By Lemma \ref{etale-cohomology-lemma-sections-base-field-extension}
...
\begin{lemma}[Proper pushforward stalk]
\label{etale-cohomology-lemma-proper-pushforward-stalk}
\source{stacks:0A3T}
\href{https://stacks.math.columbia.edu/tag/0A3T}{\texttt{Stacks tag 0A3T}}
\group{etale-cohomology}
...
\begin{proof}
By Theorem \ref{etale-cohomology-theorem-higher-direct-images} (for sheaves of sets)
we have
$$
...
Lemma \ref{etale-cohomology-lemma-h0-proper-over-henselian-local}.
\end{proof}

\begin{lemma}[Proper base change f star]
\label{etale-cohomology-lemma-proper-base-change-f-star}
\source{stacks:0A3U}
\href{https://stacks.math.columbia.edu/tag/0A3U}{\texttt{Stacks tag 0A3U}}
\group{etale-cohomology}
...
By Lemma \ref{etale-cohomology-lemma-proper-pushforward-stalk} the stalks are
...
$$
\begin{array}{cc}X'_\etale \underset{g'_{small}}{\longrightarrow}\underset{f'_{small}}{\downarrow} & X_\etale \overset{f_{small}}{\downarrow} \\ Y'_\etale \overset{g_{small}}{\longrightarrow} & Y_\etale\end{array}
$$
...
\begin{lemma}[Proper base change in terms of injectives]
\label{etale-cohomology-lemma-proper-base-change-in-terms-of-injectives}
\source{stacks:0A4B}
\href{https://stacks.math.columbia.edu/tag/0A4B}{\texttt{Stacks tag 0A4B}}
\group{etale-cohomology}
...
commutes with filtered colimits by Lemma \ref{etale-cohomology-lemma-relative-colimit}.
Hence we see that
$$
...
Lemma \ref{etale-cohomology-lemma-proper-base-change-f-star}.
\end{proof}

\begin{lemma}[Sandwich]
\label{etale-cohomology-lemma-sandwich}
\source{stacks:0A4C}
\href{https://stacks.math.columbia.edu/tag/0A4C}{\texttt{Stacks tag 0A4C}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-proper-base-change-in-terms-of-injectives}
...
By Lemma \ref{etale-cohomology-lemma-proper-base-change-f-star} we have
...
\source{stacks:0A4D}
\href{https://stacks.math.columbia.edu/tag/0A4D}{\texttt{Stacks tag 0A4D}}
\group{etale-cohomology}
...
\begin{lemma}[Proper base change for \'etale cohomology holds for finite morphisms.]
\label{etale-cohomology-lemma-finite}
\source{stacks:0A4E}
\href{https://stacks.math.columbia.edu/tag/0A4E}{\texttt{Stacks tag 0A4E}}
\group{etale-cohomology}
...
\begin{lemma}[Reduce to P1]
\label{etale-cohomology-lemma-reduce-to-P1}
\source{stacks:0A4F}
\href{https://stacks.math.columbia.edu/tag/0A4F}{\texttt{Stacks tag 0A4F}}
\group{etale-cohomology}
...
$$
\begin{array}{ccc}X \searrow & X' \downarrow\overset{\pi}{\longleftarrow}\longrightarrow & \mathbf{P}^n_Y \swarrow \\  & Y & \end{array}
$$
...
\medskip\noindent
By Lemma \ref{etale-cohomology-lemma-sandwich}
...
By Lemma \ref{etale-cohomology-lemma-finite} the result holds for closed
immersions (as closed immersions are finite).
By Lemma \ref{etale-cohomology-lemma-composition} it suffices to prove the
...
$$
Applying
Lemmas \ref{etale-cohomology-lemma-sandwich}, \ref{etale-cohomology-lemma-finite}, and \ref{etale-cohomology-lemma-composition}
...
\source{stacks:095T}
\href{https://stacks.math.columbia.edu/tag/095T}{\texttt{Stacks tag 095T}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-reduce-to-P1}
...
Lemma \ref{etale-cohomology-lemma-h0-proper-over-henselian-local}. This complex
...
The first equality by Theorem \ref{etale-cohomology-theorem-higher-direct-images}
...
isomorphism by Lemma \ref{etale-cohomology-lemma-base-change-dim-1-separably-closed}.
...
\begin{lemma}[Proper base change]
\label{etale-cohomology-lemma-proper-base-change}
\source{stacks:0DDE}
\href{https://stacks.math.columbia.edu/tag/0DDE}{\texttt{Stacks tag 0DDE}}
\group{etale-cohomology}
...
(Theorem \ref{etale-cohomology-theorem-proper-base-change}) using the spectral
sequences
$$
E_2^{p, q} = R^pf_*H^q(E)
\quad\text{and}\quad
...
\begin{lemma}[Proper base change stalk]
\label{etale-cohomology-lemma-proper-base-change-stalk}
\source{stacks:0DDF}
\href{https://stacks.math.columbia.edu/tag/0DDF}{\texttt{Stacks tag 0DDF}}
\group{etale-cohomology}
...
is a special case of Theorem \ref{etale-cohomology-theorem-proper-base-change}.
The second one is a special case of Lemma \ref{etale-cohomology-lemma-proper-base-change}.
\end{proof}
...
\begin{lemma}[Base change separably closed]
\label{etale-cohomology-lemma-base-change-separably-closed}
\source{stacks:0DDG}
\href{https://stacks.math.columbia.edu/tag/0DDG}{\texttt{Stacks tag 0DDG}}
\group{etale-cohomology}
...
Theorem \ref{etale-cohomology-theorem-proper-base-change}.
\end{proof}

\begin{lemma}[Cohomological dimension proper]
\label{etale-cohomology-lemma-cohomological-dimension-proper}
\source{stacks:095U}
\href{https://stacks.math.columbia.edu/tag/095U}{\texttt{Stacks tag 095U}}
\group{etale-cohomology}
...
and the
result is true by Proposition \ref{etale-cohomology-proposition-finite-higher-direct-image-zero}.

\medskip\noindent
If $n > 0$, then using Lemma \ref{etale-cohomology-lemma-proper-base-change-stalk}
...
\medskip\noindent
If $n = 1$ this follows from Theorem \ref{etale-cohomology-theorem-vanishing-curves}.
Assume $n > 1$. By Proposition \ref{etale-cohomology-proposition-topological-invariance}
...
By Proposition \ref{etale-cohomology-proposition-closed-immersion-pushforward} have
...
Lemma \ref{etale-cohomology-lemma-torsion-direct-image}.
...
\begin{lemma}[Proper base change mod n]
\label{etale-cohomology-lemma-proper-base-change-mod-n}
\source{stacks:0F0C}
\href{https://stacks.math.columbia.edu/tag/0F0C}{\texttt{Stacks tag 0F0C}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-cohomological-dimension-proper} implies that
$$
f_* :
...
\begin{lemma}[Pull out constant]
\label{etale-cohomology-lemma-pull-out-constant}
\source{stacks:0F0E}
\href{https://stacks.math.columbia.edu/tag/0F0E}{\texttt{Stacks tag 0F0E}}
\group{etale-cohomology}
...
By Theorem \ref{etale-cohomology-theorem-colimit} this reduces us to the case of finite free
$\mathbf{Z}$-module $M$ in which case the result is trivially true.
\end{proof}

\begin{lemma}[Projection formula proper]
\label{etale-cohomology-lemma-projection-formula-proper}
\source{stacks:0F0F}
\href{https://stacks.math.columbia.edu/tag/0F0F}{\texttt{Stacks tag 0F0F}}
\group{etale-cohomology}
...
In this way we see that Lemma \ref{etale-cohomology-lemma-proper-base-change-stalk}
...
$$
This is shown in Lemma \ref{etale-cohomology-lemma-pull-out-constant}.
\end{proof}
...
$$
\begin{array}{ccc}F_{\overline{x}, \overline{t}} =
\overline{t} \times_{\Spec(\mathcal{O}^{sh}_{S, \overline{s}})}
\Spec(\mathcal{O}^{sh}_{X, \overline{x}}) \longrightarrow\downarrow & \Spec(\mathcal{O}^{sh}_{X, \overline{x}}) \longrightarrow\downarrow & X \downarrow \\ \overline{t} \longrightarrow & \Spec(\mathcal{O}^{sh}_{S, \overline{s}}) \longrightarrow & S\end{array}
$$
...
\begin{definition}[Locally acyclic]
\label{etale-cohomology-definition-locally-acyclic}
\source{stacks:0GJP}
\href{https://stacks.math.columbia.edu/tag/0GJP}{\texttt{Stacks tag 0GJP}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-smooth-base-change-separably-closed}
...
\begin{proposition}[Smooth locally acyclic]
\label{etale-cohomology-proposition-smooth-locally-acyclic}
\source{stacks:0GJQ}
\href{https://stacks.math.columbia.edu/tag/0GJQ}{\texttt{Stacks tag 0GJQ}}
\group{etale-cohomology}
...
(see discussion following Definition \ref{etale-cohomology-definition-locally-acyclic})
...
\medskip\noindent
We will apply Lemma \ref{etale-cohomology-lemma-base-change-f-star-general-stalks}
to the diagram
$$
\begin{array}{cc}X \underset{f}{\downarrow} & X_{\overline{t}} \overset{h}{\longleftarrow}\overset{e}{\downarrow} \\ S & \overline{t} \underset{g}{\longleftarrow}\end{array}
$$
...
Theorem \ref{etale-cohomology-theorem-smooth-base-change} (the assumption
on torsion holds by our choice of $n$).
Thus Lemma \ref{etale-cohomology-lemma-base-change-f-star-general-stalks}
...
Definition \ref{etale-cohomology-definition-locally-acyclic}).
\end{proof}

\begin{lemma}[Locally acyclic locally constant]
\label{etale-cohomology-lemma-locally-acyclic-locally-constant}
\source{stacks:0GJR}
\href{https://stacks.math.columbia.edu/tag/0GJR}{\texttt{Stacks tag 0GJR}}
\group{etale-cohomology}
...
$$
by Lemma \ref{etale-cohomology-lemma-colimit}.
...
\begin{lemma}[Locally acyclic quasi finite base change]
\label{etale-cohomology-lemma-locally-acyclic-quasi-finite-base-change}
\source{stacks:0GJS}
\href{https://stacks.math.columbia.edu/tag/0GJS}{\texttt{Stacks tag 0GJS}}
\group{etale-cohomology}

Let
$$
\begin{array}{cc}X' \underset{g'}{\longrightarrow}\underset{f'}{\downarrow} & X \overset{f}{\downarrow} \\ S' \overset{g}{\longrightarrow} & S\end{array}
$$
...
considered in Section \ref{etale-cohomology-section-specialization} and especially
Remark \ref{etale-cohomology-remark-specialization-map-and-fibres}.
...
Lemma \ref{etale-cohomology-lemma-beta-is-isomorphism} below shows that the pullback
...
\begin{lemma}[Beta is isomorphism]
\label{etale-cohomology-lemma-beta-is-isomorphism}
\source{stacks:0GJU}
\href{https://stacks.math.columbia.edu/tag/0GJU}{\texttt{Stacks tag 0GJU}}
\group{etale-cohomology}
...
by Lemma \ref{etale-cohomology-lemma-locally-acyclic-quasi-finite-base-change} or just
...
$$
since pullback preserves stalks, see Lemma \ref{etale-cohomology-lemma-stalk-pullback}.
...
R\Gamma(F_{\overline{x}, \overline{t}}, K)
$$
where the equal sign is Theorem \ref{etale-cohomology-theorem-higher-direct-images}.
...
in Definition \ref{etale-cohomology-definition-locally-acyclic}. The result follows as we may
...
\begin{lemma}[Specialization cospecialization]
\label{etale-cohomology-lemma-specialization-cospecialization}
\source{stacks:0GJV}
\href{https://stacks.math.columbia.edu/tag/0GJV}{\texttt{Stacks tag 0GJV}}
\group{etale-cohomology}

In the situation above, if in addition
$f$ is quasi-compact and quasi-separated, then the diagram
$$
\begin{array}{cc}(Rf_*K)_{\overline{s}} \longrightarrow\underset{sp}{\downarrow} & R\Gamma(X_{\overline{s}}, K) \\ (Rf_*K)_{\overline{t}} \longrightarrow & R\Gamma(X_{\overline{t}}, K) \underset{cosp}{\uparrow}\end{array}
$$
is commutative.
\end{lemma}

\begin{proof}
As in the proof of Lemma \ref{etale-cohomology-lemma-beta-is-isomorphism}
...
\begin{lemma}[Sp isom proper torsion loc ac]
\label{etale-cohomology-lemma-sp-isom-proper-torsion-loc-ac}
\source{stacks:0GJW}
\href{https://stacks.math.columbia.edu/tag/0GJW}{\texttt{Stacks tag 0GJW}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-proper-base-change-stalk}) we have
...
Lemma \ref{etale-cohomology-lemma-specialization-cospecialization}
...
by Lemma \ref{etale-cohomology-lemma-torsion-direct-image}.
...
by the already used
Lemma \ref{etale-cohomology-lemma-proper-base-change-stalk}.
Thus we see that three out of the four arrows in the diagram
of Lemma \ref{etale-cohomology-lemma-specialization-cospecialization} are isomorphisms
and we conclude.
\end{proof}

\begin{lemma}[Sp isom proper loc cst torsion]
\label{etale-cohomology-lemma-sp-isom-proper-loc-cst-torsion}
\source{stacks:0GKD}
\href{https://stacks.math.columbia.edu/tag/0GKD}{\texttt{Stacks tag 0GKD}}
\group{etale-cohomology}
...
\begin{proof}
This follows from Lemmas \ref{etale-cohomology-lemma-sp-isom-proper-torsion-loc-ac}
and \ref{etale-cohomology-lemma-locally-acyclic-locally-constant} and
...
the results in Section \ref{etale-cohomology-section-vanishing-torsion}
and one, seemingly innocuous, application of the proper base
change theorem (in the proof of Proposition \ref{etale-cohomology-proposition-cd-affine}).

\begin{definition}[Cd]
\label{etale-cohomology-definition-cd}
\source{stacks:0F0Q}
\href{https://stacks.math.columbia.edu/tag/0F0Q}{\texttt{Stacks tag 0F0Q}}
\group{etale-cohomology}
...
\begin{lemma}[Cd limit]
\label{etale-cohomology-lemma-cd-limit}
\source{stacks:0F0R}
\href{https://stacks.math.columbia.edu/tag/0F0R}{\texttt{Stacks tag 0F0R}}
\group{etale-cohomology}
...
by Lemma \ref{etale-cohomology-lemma-linus-hamann}.
Thus $H^q_\etale(X, \mathcal{F}) =
...
\begin{lemma}[Cd curve over field]
\label{etale-cohomology-lemma-cd-curve-over-field}
\source{stacks:0F0S}
\href{https://stacks.math.columbia.edu/tag/0F0S}{\texttt{Stacks tag 0F0S}}
\group{etale-cohomology}
...
\begin{lemma}[Cd field extension]
\label{etale-cohomology-lemma-cd-field-extension}
\source{stacks:0F0T}
\href{https://stacks.math.columbia.edu/tag/0F0T}{\texttt{Stacks tag 0F0T}}
\group{etale-cohomology}
...
By Lemma \ref{etale-cohomology-lemma-cd-limit} it suffices to prove that
$\text{cd}(A_i) \leq 1 + \text{cd}(K)$. This follows
from Lemma \ref{etale-cohomology-lemma-cd-curve-over-field}.
\end{proof}

\begin{lemma}[Strictly henselian]
\label{etale-cohomology-lemma-strictly-henselian}
\source{stacks:0F0U}
\href{https://stacks.math.columbia.edu/tag/0F0U}{\texttt{Stacks tag 0F0U}}
\group{etale-cohomology}
...
\begin{proposition}[Cd affine]
\label{etale-cohomology-proposition-cd-affine}
\source{stacks:0F0V}
\href{https://stacks.math.columbia.edu/tag/0F0V}{\texttt{Stacks tag 0F0V}}
\group{etale-cohomology}
...
for $i > 0$, see Proposition \ref{etale-cohomology-proposition-finite-higher-direct-image-zero}.
...
\medskip\noindent
The case $\dim(X) = 1$. This is Lemma \ref{etale-cohomology-lemma-cd-curve-over-field}.
...
Theorem \ref{etale-cohomology-theorem-higher-direct-images} we have
$$
...
$$
Using Lemma \ref{etale-cohomology-lemma-strictly-henselian} we get an embedding
$$
...
dimension $1$ by Lemma \ref{etale-cohomology-lemma-cd-field-extension}. Thus by induction
hypothesis and Lemma \ref{etale-cohomology-lemma-cd-limit}
...
Lemma \ref{etale-cohomology-lemma-support-in-subset}.
Then the induction hypothesis kicks in to imply
the desired vanishing for $\mathcal{G}_i$\footnote{Here
we first use Proposition \ref{etale-cohomology-proposition-closed-immersion-pushforward}
...
conclude by Theorem \ref{etale-cohomology-theorem-colimit}.

\medskip\noindent
Consider the commutative diagram
$$
\begin{array}{ccc}\mathbf{A}^d_K \underset{f}{\searrow}\underset{j}{\longrightarrow} &  & \mathbf{P}^1_K \times_K \mathbf{A}^{d - 1}_K \overset{g}{\swarrow} \\  & \mathbf{A}^{d - 1}_K & \end{array}
$$
...
Lemma \ref{etale-cohomology-lemma-cohomological-dimension-proper}
...
$$
On the other hand, by Theorem \ref{etale-cohomology-theorem-higher-direct-images}
...
\begin{lemma}[Interlude II]
\label{etale-cohomology-lemma-interlude-II}
\source{stacks:0F0W}
\href{https://stacks.math.columbia.edu/tag/0F0W}{\texttt{Stacks tag 0F0W}}
\group{etale-cohomology}
...
supported on a closed subscheme $Z_i$ contained in $E_a$, see
Lemma \ref{etale-cohomology-lemma-support-in-subset}.
Then Proposition \ref{etale-cohomology-proposition-cd-affine} gives
the desired vanishing for $\mathcal{F}_i$. Details omitted;
hints: first use Proposition \ref{etale-cohomology-proposition-closed-immersion-pushforward}
...
\begin{lemma}[Interlude I]
\label{etale-cohomology-lemma-interlude-I}
\source{stacks:0F0X}
\href{https://stacks.math.columbia.edu/tag/0F0X}{\texttt{Stacks tag 0F0X}}
\group{etale-cohomology}
...
$$
\begin{array}{cc}X \underset{f}{\downarrow}\underset{i}{\longrightarrow} & \mathbf{A}^{n + m}_K \overset{\text{pr}}{\downarrow} \\ Y \overset{j}{\longrightarrow} & \mathbf{A}^n_K\end{array}
$$
...
$$
Say $b = \text{trdeg}_K(\kappa(y))$. From Lemma \ref{etale-cohomology-lemma-strictly-henselian}
we get an embedding
$$
...
By Lemma \ref{etale-cohomology-lemma-interlude-II} we see that
$$
H^q(\mathbf{A}^m_{B_i}, \mathcal{F}) = 0\text{ for }q > a - b
$$
Thus by Theorem \ref{etale-cohomology-theorem-colimit} we get
...
We continue the discussion started in Section \ref{etale-cohomology-section-cd}.

\begin{definition}[Cd f]
\label{etale-cohomology-definition-cd-f}
\source{stacks:0F0Z}
\href{https://stacks.math.columbia.edu/tag/0F0Z}{\texttt{Stacks tag 0F0Z}}
\group{etale-cohomology}
...
\begin{lemma}[Finite cd]
\label{etale-cohomology-lemma-finite-cd}
\source{stacks:0F10}
\href{https://stacks.math.columbia.edu/tag/0F10}{\texttt{Stacks tag 0F10}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-interlude-I}. Thus it suffices to show that if
...
Proposition \ref{etale-cohomology-proposition-cd-affine}. Thus it suffices to show that if
...
\begin{lemma}[Finite cd mod n direct sums]
\label{etale-cohomology-lemma-finite-cd-mod-n-direct-sums}
\source{stacks:0F11}
\href{https://stacks.math.columbia.edu/tag/0F11}{\texttt{Stacks tag 0F11}}
\group{etale-cohomology}
...
Injectives, Lemma \ref{injectives-lemma-derived-products}.
By Lemma \ref{etale-cohomology-lemma-relative-colimit} we have
$$
...
$$
(equality again by Lemma \ref{etale-cohomology-lemma-relative-colimit}) which
...
\begin{lemma}[Proper mod n direct sums]
\label{etale-cohomology-lemma-proper-mod-n-direct-sums}
\source{stacks:0F0D}
\href{https://stacks.math.columbia.edu/tag/0F0D}{\texttt{Stacks tag 0F0D}}
\group{etale-cohomology}
...
we see that the dimension of the fibres of
$f : X \to Y$ is bounded.
Thus Lemma \ref{etale-cohomology-lemma-cohomological-dimension-proper}
implies that $\text{cd}(f) < \infty$. Hence the
result by Lemma \ref{etale-cohomology-lemma-finite-cd-mod-n-direct-sums}.
\end{proof}

\begin{lemma}[Pull out constant mod n]
\label{etale-cohomology-lemma-pull-out-constant-mod-n}
\source{stacks:0F12}
\href{https://stacks.math.columbia.edu/tag/0F12}{\texttt{Stacks tag 0F12}}
\group{etale-cohomology}
...
\begin{lemma}[Projection formula proper mod n]
\label{etale-cohomology-lemma-projection-formula-proper-mod-n}
\source{stacks:0F0G}
\href{https://stacks.math.columbia.edu/tag/0F0G}{\texttt{Stacks tag 0F0G}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-proper-base-change-mod-n} where $Y' = \overline{y}$)
this reduces to the case where $Y$ is the spectrum of
an algebraically closed field.
This is shown in Lemma \ref{etale-cohomology-lemma-pull-out-constant-mod-n}
...
\begin{remark}[Define kunneth map]
\label{etale-cohomology-remark-define-kunneth-map}
\source{stacks:0F1E}
\href{https://stacks.math.columbia.edu/tag/0F1E}{\texttt{Stacks tag 0F1E}}
\group{etale-cohomology}

Consider a cartesian diagram in the category of schemes:
$$
\begin{array}{cc}X \times_S Y \underset{p}{\downarrow}\underset{q}{\longrightarrow}\underset{c}{\searrow} & Y \overset{g}{\downarrow} \\ X \overset{f}{\longrightarrow} & S\end{array}
$$
...
\begin{lemma}[Kunneth one proper]
\label{etale-cohomology-lemma-kunneth-one-proper}
\source{stacks:0F14}
\href{https://stacks.math.columbia.edu/tag/0F14}{\texttt{Stacks tag 0F14}}
\group{etale-cohomology}
...
\begin{proof}
Proof of (1). By Lemma \ref{etale-cohomology-lemma-projection-formula-proper} we have
$$
R\text{pr}_{2, *}(
\text{pr}_1^{-1}E
\otimes_\mathbf{Z}^\mathbf{L}
...
K
$$
By proper base change (in the form of Lemma \ref{etale-cohomology-lemma-proper-base-change})
...
Lemma \ref{etale-cohomology-lemma-pull-out-constant}.

\medskip\noindent
Proof of (2). This is exactly the same as the proof of (1)
except that we use Lemmas \ref{etale-cohomology-lemma-projection-formula-proper-mod-n},
\ref{etale-cohomology-lemma-proper-base-change-mod-n}, and
\ref{etale-cohomology-lemma-pull-out-constant-mod-n} as well as
$\text{cd}(Y) < \infty$ by Lemma \ref{etale-cohomology-lemma-finite-cd}.
\end{proof}

\begin{lemma}[Supported in closed points]
\label{etale-cohomology-lemma-supported-in-closed-points}
\source{stacks:0F1F}
\href{https://stacks.math.columbia.edu/tag/0F1F}{\texttt{Stacks tag 0F1F}}
\group{etale-cohomology}
...
from Lemma \ref{etale-cohomology-lemma-interlude-II}.)
By Lemma \ref{etale-cohomology-lemma-support-in-subset} we can write $\mathcal{F}$
...
(Proposition \ref{etale-cohomology-proposition-finite-higher-direct-image-zero}).
By Lemmas \ref{etale-cohomology-lemma-equivalence-abelian-sheaves-point} and
...
By Theorem \ref{etale-cohomology-theorem-colimit} we see that
...
\begin{lemma}[Vanishing closed points]
\label{etale-cohomology-lemma-vanishing-closed-points}
\source{stacks:0F1G}
\href{https://stacks.math.columbia.edu/tag/0F1G}{\texttt{Stacks tag 0F1G}}
\group{etale-cohomology}
...
By Lemma \ref{etale-cohomology-lemma-supported-in-closed-points} we have
$H^i(X, Q) = H^0(X, H^i(Q)) \not = 0$ and we conclude.

\medskip\noindent
General case. Let $\mathcal{B} \subset \Ob(X_\etale)$ be the
quasi-compact objects. By Lemma \ref{etale-cohomology-lemma-supported-in-closed-points}
...
Thus the conclusion by Lemma \ref{etale-cohomology-lemma-supported-in-closed-points}
as $Q$ is zero in $D(X_\etale)$ if and only if $H^q(Q)$ is zero
for all $q$.
\end{proof}

\begin{lemma}[Kunneth localize on X]
\label{etale-cohomology-lemma-kunneth-localize-on-X}
\source{stacks:0F1H}
\href{https://stacks.math.columbia.edu/tag/0F1H}{\texttt{Stacks tag 0F1H}}
\group{etale-cohomology}
...
$$
\begin{array}{cc}Y \times_{\Spec(K)} X \underset{q}{\downarrow} & Y \times_{\Spec(K)} U \overset{h}{\longleftarrow}\overset{p}{\downarrow} \\ X & U \underset{j}{\longleftarrow}\end{array}
$$
...
(for a precise reference see Lemma \ref{etale-cohomology-lemma-base-change-Rf-star-colim}),
...
$$
\begin{array}{cc}Y \times_K X' \underset{q'}{\downarrow} & Y \times_K U' \overset{h'}{\longleftarrow}\overset{p'}{\downarrow} \\ X' & U' \underset{j'}{\longleftarrow}\end{array}
$$
of our diagram by $X' \to X$. Observe that $X' \to X$ is a filtered
colimit of \'etale morphisms. By smooth base change in the form of
Lemma \ref{etale-cohomology-lemma-smooth-base-change-general} the pullback of
...
By Lemma \ref{etale-cohomology-lemma-strictly-henselian}
...
$$
\vcenter{
\begin{array}{cc}Y \times_K X_i \underset{q_i}{\downarrow} & Y \times_K U_i \overset{h_i}{\longleftarrow}\overset{p_i}{\downarrow} \\ X_i & U_i \underset{j_i}{\longleftarrow}\end{array}
}
\quad\text{equal to}\quad
\vcenter{
\begin{array}{cc}Y_L \times_L X_i \underset{q_i}{\downarrow} & Y_L \times_L U_i \overset{h_i}{\longleftarrow}\overset{p_i}{\downarrow} \\ X_i & U_i \underset{j_i}{\longleftarrow}\end{array}
}
$$
over the field $L$ and the pullback of $\mathcal{F}$ to these diagrams.
By Lemma \ref{etale-cohomology-lemma-base-change-Rf-star-colim} we conclude that the map
...
By Lemma \ref{etale-cohomology-lemma-strictly-henselian} there is a separably closed field
...
$$
\vcenter{
\begin{array}{cc}Y' \times_K X \underset{f}{\downarrow} & Y' \times_K U \overset{h'}{\longleftarrow}\overset{f'}{\downarrow} \\ Y \times_K X \underset{q}{\downarrow} & Y \times_K U \overset{h}{\longleftarrow}\overset{p}{\downarrow} \\ X & U \underset{j}{\longleftarrow}\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}Y' \times_L X_L \underset{q'}{\downarrow} & Y' \times_L U_L \overset{h'}{\longleftarrow}\overset{p'}{\downarrow} \\ X_L \downarrow & U_L \overset{j_L}{\longleftarrow}\downarrow \\ X & U \underset{j}{\longleftarrow}\end{array}
}
$$
...
(Lemma \ref{etale-cohomology-lemma-base-change-field-extension})
...
Lemma \ref{etale-cohomology-lemma-vanishing-closed-points}.
Thus it suffices to prove that
$q^{-1}Rj_*\mathcal{F} \to Rh_*p^{-1}\mathcal{F}$
induces an isomorphism on cohomology. Recall that $\mathcal{F}$
is annihilated by $n$ invertible in $K$.
By the K\"unneth formula of Lemma \ref{etale-cohomology-lemma-kunneth-one-proper}
we have
\begin{align*}
...
\begin{lemma}[Punctual base change]
\label{etale-cohomology-lemma-punctual-base-change}
\source{stacks:0F1I}
\href{https://stacks.math.columbia.edu/tag/0F1I}{\texttt{Stacks tag 0F1I}}
\group{etale-cohomology}

Let $K$ be a field. For any commutative diagram
$$
\begin{array}{ccc}X \downarrow & X' \longleftarrow\underset{f'}{\downarrow} & Y \overset{h}{\longleftarrow}\overset{e}{\downarrow} \\ \Spec(K) & S' \longleftarrow & T \underset{g}{\longleftarrow}\end{array}
$$
...
By Lemma \ref{etale-cohomology-lemma-base-change-Rf-star-colim}
...
Lemma \ref{etale-cohomology-lemma-base-change-field-extension} (works for both
...
is an isomorphism by Lemma \ref{etale-cohomology-lemma-fppf-reduced-fibres-base-change-f-star}.

\medskip\noindent
At this point we may apply
Lemma \ref{etale-cohomology-lemma-base-change-does-not-hold-post}
to see that it suffices to prove: given a commutative diagram
$$
\begin{array}{ccc}X \underset{f}{\downarrow} & X' \downarrow\longleftarrow & Y \overset{h}{\longleftarrow}\downarrow \\ \Spec(K) & S' \longleftarrow & \Spec(L) \longleftarrow\end{array}
$$
with both squares cartesian, where $S'$ is affine, integral, and normal
...
$$
\vcenter{
\begin{array}{cc}X' \downarrow & Y \overset{h}{\longleftarrow}\downarrow \\ S' & \Spec(L) \longleftarrow\end{array}
}
\quad\text{is the colimit of}\quad
\vcenter{
\begin{array}{cc}X \times_K S_j \downarrow & X \times_K U_j \overset{h_j}{\longleftarrow}\downarrow \\ S_j & U_j \longleftarrow\end{array}
}
$$
Thus we may apply Lemma \ref{etale-cohomology-lemma-base-change-Rf-star-colim}
to see that it suffices to prove
base change holds in the diagrams on the right which is what we
proved in Lemma \ref{etale-cohomology-lemma-kunneth-localize-on-X}.
\end{proof}

\begin{lemma}[Punctual base change upgrade]
\label{etale-cohomology-lemma-punctual-base-change-upgrade}
\source{stacks:0F1J}
\href{https://stacks.math.columbia.edu/tag/0F1J}{\texttt{Stacks tag 0F1J}}
\group{etale-cohomology}

Let $K$ be a field. Let $n \geq 1$ be invertible in $K$.
Consider a commutative diagram
$$
\begin{array}{ccc}X \downarrow & X' \overset{p}{\longleftarrow}\underset{f'}{\downarrow} & Y \overset{h}{\longleftarrow}\overset{e}{\downarrow} \\ \Spec(K) & S' \longleftarrow & T \underset{g}{\longleftarrow}\end{array}
$$
of schemes with
$X' = X \times_{\Spec(K)} S'$ and $Y = X' \times_{S'} T$ and
...
\begin{proof}
This lemma is a generalization of Lemma \ref{etale-cohomology-lemma-punctual-base-change}
to objects of the derived category; the assertion of our lemma is true because
in Lemma \ref{etale-cohomology-lemma-punctual-base-change} the scheme $X$ over $K$
...
higher direct images do too (Lemma \ref{etale-cohomology-lemma-relative-colimit})
...
$$
See Lemma \ref{etale-cohomology-lemma-constructible-maps-into-constant-general}.
...
$$
\begin{array}{ccc}X_i \overset{\pi_i}{\downarrow} & X'_i \overset{p_i}{\longleftarrow}\overset{\pi'_i}{\downarrow} & Y_i \overset{h_i}{\longleftarrow}\overset{\rho_i}{\downarrow} \\ X \downarrow & X' \overset{p}{\longleftarrow}\underset{f'}{\downarrow} & Y \overset{h}{\longleftarrow}\overset{e}{\downarrow} \\ \Spec(K) & S' \longleftarrow & T \underset{g}{\longleftarrow}\end{array}
$$
...
we are going to use
Lemma \ref{etale-cohomology-lemma-finite-pushforward-commutes-with-base-change}, and
we are going to use
Lemma \ref{etale-cohomology-lemma-projection-formula-proper-mod-n}
...
Lemma \ref{etale-cohomology-lemma-punctual-base-change}
we conclude.
\end{proof}

\begin{lemma}[Punctual base change upgrade unbounded]
\label{etale-cohomology-lemma-punctual-base-change-upgrade-unbounded}
\source{stacks:0F1N}
\href{https://stacks.math.columbia.edu/tag/0F1N}{\texttt{Stacks tag 0F1N}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-punctual-base-change-upgrade}
...
Lemmas \ref{etale-cohomology-lemma-finite-cd} and
...
At this point Lemma \ref{etale-cohomology-lemma-punctual-base-change-upgrade}
...
\source{stacks:0F1P}
\href{https://stacks.math.columbia.edu/tag/0F1P}{\texttt{Stacks tag 0F1P}}
\group{etale-cohomology}
...
\begin{proof}
By Lemma \ref{etale-cohomology-lemma-punctual-base-change-upgrade-unbounded} we have
$$
R\text{pr}_{1, *}(
\text{pr}_1^{-1}E
\otimes_{\mathbf{Z}/n\mathbf{Z}}^\mathbf{L}
...
$$
We conclude by
Lemma \ref{etale-cohomology-lemma-pull-out-constant-mod-n}
which we may use because
$\text{cd}(X) < \infty$ by Lemma \ref{etale-cohomology-lemma-finite-cd}.
\end{proof}
...
\begin{lemma}[Check zar]
\label{etale-cohomology-lemma-check-zar}
\source{stacks:0F1L}
\href{https://stacks.math.columbia.edu/tag/0F1L}{\texttt{Stacks tag 0F1L}}
\group{etale-cohomology}
...
\begin{lemma}[Compare injectives]
\label{etale-cohomology-lemma-compare-injectives}
\source{stacks:0758}
\href{https://stacks.math.columbia.edu/tag/0758}{\texttt{Stacks tag 0758}}
\group{etale-cohomology}
...
$$
\begin{array}{ccc}\mathcal{O}_S \underset{2}{\downarrow}\underset{\alpha|_{S_\etale}}{\longrightarrow} &  & \mathcal{I}|_{S_\etale} \\ \mathcal{O}_S \nearrow &  & \end{array}
$$
...
$$
\begin{array}{cc}(T_\etale, \mathcal{O}_T) \underset{f_{small}}{\downarrow} & ((\Sch/T)_\etale, \mathcal{O}) \overset{f_{big}}{\downarrow}\overset{\pi_T}{\longleftarrow} \\ (S_\etale, \mathcal{O}_S) & ((\Sch/S)_\etale, \mathcal{O}) \underset{\pi_S}{\longleftarrow}\end{array}
$$
...
\begin{lemma}[Compare higher direct image]
\label{etale-cohomology-lemma-compare-higher-direct-image}
\source{stacks:075A}
\href{https://stacks.math.columbia.edu/tag/075A}{\texttt{Stacks tag 075A}}
\group{etale-cohomology}
...
\begin{proof}
Part (1) follows from
Lemma \ref{etale-cohomology-lemma-compare-injectives}
and (\ref{equation-compare-big-small})
on choosing a K-injective complex of abelian sheaves representing $K$.

\medskip\noindent
Part (3) follows from Lemma \ref{etale-cohomology-lemma-compare-injectives}
...
\begin{lemma}[Compare cohomology]
\label{etale-cohomology-lemma-compare-cohomology}
\source{stacks:0DDH}
\href{https://stacks.math.columbia.edu/tag/0DDH}{\texttt{Stacks tag 0DDH}}
\group{etale-cohomology}
...
and apply Lemma \ref{etale-cohomology-lemma-compare-injectives}
...
\begin{lemma}[Cohomological descent etale]
\label{etale-cohomology-lemma-cohomological-descent-etale}
\source{stacks:0DDI}
\href{https://stacks.math.columbia.edu/tag/0DDI}{\texttt{Stacks tag 0DDI}}
\group{etale-cohomology}
...
\begin{lemma}[Compare higher direct image proper]
\label{etale-cohomology-lemma-compare-higher-direct-image-proper}
\source{stacks:0DDJ}
\href{https://stacks.math.columbia.edu/tag/0DDJ}{\texttt{Stacks tag 0DDJ}}
\group{etale-cohomology}
...
fibre product
$$
\begin{array}{cc}T' \underset{f'}{\longrightarrow}\underset{g'}{\downarrow} & S' \overset{g}{\downarrow} \\ T \overset{f}{\longrightarrow} & S\end{array}
$$
Then we have
$$
...
$$
the second equality by Lemma \ref{etale-cohomology-lemma-describe-pullback}.
On the other hand
$$
(\pi_S^{-1}f_{small, *}\mathcal{F})(S') =
(g_{small}^{-1}f_{small, *}\mathcal{F})(S')
$$
again by Lemma \ref{etale-cohomology-lemma-describe-pullback}.
...
Lemma \ref{etale-cohomology-lemma-compare-higher-direct-image}.
This map is an isomorphism by the proper base change theorem
(Lemma \ref{etale-cohomology-lemma-proper-base-change}) provided $K$ is bounded
below and the cohomology sheaves of $K$ are torsion.

\medskip\noindent
The proof of part (3) is the same as the proof of part (2), except
we use Lemma \ref{etale-cohomology-lemma-proper-base-change-mod-n}
instead of Lemma \ref{etale-cohomology-lemma-proper-base-change}.

\medskip\noindent
Proof of (4). If $f$ is finite, then the functors
$f_{small, *}$ and $f_{big, *}$ are exact. This follows
from Proposition \ref{etale-cohomology-proposition-finite-higher-direct-image-zero}
for $f_{small}$. Since any base change $f'$ of $f$ is finite too,
we conclude from Lemma \ref{etale-cohomology-lemma-compare-higher-direct-image} part (3)
...
\begin{lemma}[Describe pullback pi fppf]
\label{etale-cohomology-lemma-describe-pullback-pi-fppf}
\source{stacks:0DDL}
\href{https://stacks.math.columbia.edu/tag/0DDL}{\texttt{Stacks tag 0DDL}}
\group{etale-cohomology}
...
of Lemma \ref{etale-cohomology-lemma-describe-pullback}. To finish the proof it
suffices to show that $\pi_S^{-1}\mathcal{F}$ is a sheaf for the fppf
topology. This is shown in Lemma \ref{etale-cohomology-lemma-describe-pullback}
as well.
\end{proof}

In the situation of Lemma \ref{etale-cohomology-lemma-describe-pullback-pi-fppf}
...
\begin{lemma}[Push pull fppf etale]
\label{etale-cohomology-lemma-push-pull-fppf-etale}
\source{stacks:0DDM}
\href{https://stacks.math.columbia.edu/tag/0DDM}{\texttt{Stacks tag 0DDM}}
\group{etale-cohomology}
...
$$
\begin{array}{ccc}\Sh((\Sch/X)_{fppf}) \underset{f_{big, fppf}}{\longrightarrow}\underset{\epsilon_X}{\downarrow} &  & \Sh((\Sch/Y)_{fppf}) \overset{\epsilon_Y}{\downarrow} \\ \Sh((\Sch/X)_\etale) \overset{f_{big, \etale}}{\longrightarrow} &  & \Sh((\Sch/Y)_\etale)\end{array}
$$
and
$$
\begin{array}{ccc}\Sh((\Sch/X)_{fppf}) \underset{f_{big, fppf}}{\longrightarrow}\underset{a_X}{\downarrow} &  & \Sh((\Sch/Y)_{fppf}) \overset{a_Y}{\downarrow} \\ \Sh(X_\etale) \overset{f_{small}}{\longrightarrow} &  & \Sh(Y_\etale)\end{array}
$$
...
\begin{lemma}[Proper push pull fppf etale]
\label{etale-cohomology-lemma-proper-push-pull-fppf-etale}
\source{stacks:0DDN}
\href{https://stacks.math.columbia.edu/tag/0DDN}{\texttt{Stacks tag 0DDN}}
\group{etale-cohomology}

In Lemma \ref{etale-cohomology-lemma-push-pull-fppf-etale} if $f$ is proper, then we have
$a_Y^{-1} \circ f_{small, *} = f_{big, fppf, *} \circ a_X^{-1}$.
\end{lemma}

\begin{proof}
You can prove this by repeating the proof of
Lemma \ref{etale-cohomology-lemma-compare-higher-direct-image-proper} part (1);
...
in Lemma \ref{etale-cohomology-lemma-describe-pullback-pi-fppf}
...
(1) of Lemma \ref{etale-cohomology-lemma-compare-higher-direct-image-proper}.
\end{proof}

\begin{lemma}[Descent sheaf fppf etale]
\label{etale-cohomology-lemma-descent-sheaf-fppf-etale}
\source{stacks:0DEU}
\href{https://stacks.math.columbia.edu/tag/0DEU}{\texttt{Stacks tag 0DEU}}
\group{etale-cohomology}

In Lemma \ref{etale-cohomology-lemma-push-pull-fppf-etale} assume
...
Lemma \ref{etale-cohomology-lemma-describe-pullback-pi-fppf}). Hence the forgetful functor
...
\end{align*}
where the third equality is Lemma \ref{etale-cohomology-lemma-proper-push-pull-fppf-etale}
...
(to see this use Lemma \ref{etale-cohomology-lemma-proper-push-pull-fppf-etale} again;
...
\begin{lemma}[Compare fppf etale]
\label{etale-cohomology-lemma-compare-fppf-etale}
\source{stacks:0F0H}
\href{https://stacks.math.columbia.edu/tag/0F0H}{\texttt{Stacks tag 0F0H}}
\group{etale-cohomology}
...
fully faithful for example by Lemma \ref{etale-cohomology-lemma-cohomological-descent-etale}. If
...
is exact by Lemma \ref{etale-cohomology-lemma-cohomological-descent-etale}.
...
Lemma \ref{etale-cohomology-lemma-describe-pullback-pi-fppf}.

\medskip\noindent
Cohomology on Sites, Property (\ref{sites-cohomology-item-A-and-P}) holds by
Lemma \ref{etale-cohomology-lemma-compare-higher-direct-image-proper} part (4).
...
\begin{lemma}[V C all n etale fppf]
\label{etale-cohomology-lemma-V-C-all-n-etale-fppf}
\source{stacks:0DDS}
\href{https://stacks.math.columbia.edu/tag/0DDS}{\texttt{Stacks tag 0DDS}}
\group{etale-cohomology}
...
\begin{proof}
By Lemma \ref{etale-cohomology-lemma-compare-fppf-etale} the lemmas in
...
Lemma \ref{etale-cohomology-lemma-push-pull-fppf-etale}
and Cohomology on Sites, Lemma
\ref{sites-cohomology-lemma-derived-pushforward-composition}.
The second equality is (3). The third is
Lemma \ref{etale-cohomology-lemma-compare-higher-direct-image-proper} part (2).
...
\begin{lemma}[Cohomological descent etale fppf]
\label{etale-cohomology-lemma-cohomological-descent-etale-fppf}
\source{stacks:0DDT}
\href{https://stacks.math.columbia.edu/tag/0DDT}{\texttt{Stacks tag 0DDT}}
\group{etale-cohomology}
...
\medskip\noindent
By Lemma \ref{etale-cohomology-lemma-describe-pullback-pi-fppf} we have
...
the Leray spectral sequence
(Cohomology on Sites, Lemma \ref{sites-cohomology-lemma-relative-Leray}).
By Lemma \ref{etale-cohomology-lemma-V-C-all-n-etale-fppf}
we have $R^i\epsilon_{X, *}(a_X^{-1}\mathcal{F}) = 0$ for $i > 0$
and
$\epsilon_{X, *}a_X^{-1}\mathcal{F} = \pi_X^{-1}\mathcal{F}$.
By Lemma \ref{etale-cohomology-lemma-cohomological-descent-etale} we have
$R^j\pi_{X, *}(\pi_X^{-1}\mathcal{F}) = 0$ for $j > 0$.
This concludes the proof.
\end{proof}

\begin{lemma}[Compare cohomology etale fppf]
\label{etale-cohomology-lemma-compare-cohomology-etale-fppf}
\source{stacks:0DDU}
\href{https://stacks.math.columbia.edu/tag/0DDU}{\texttt{Stacks tag 0DDU}}
\group{etale-cohomology}
...
\begin{proof}
This follows from Lemma \ref{etale-cohomology-lemma-cohomological-descent-etale-fppf}
...
We continue the discussion in Section \ref{etale-cohomology-section-fppf-etale} but in this
...
their composition $a_S$ introduced in Section \ref{etale-cohomology-section-fppf-etale}
...
\begin{lemma}[Review quasi coherent]
\label{etale-cohomology-lemma-review-quasi-coherent}
\source{stacks:0DEW}
\href{https://stacks.math.columbia.edu/tag/0DEW}{\texttt{Stacks tag 0DEW}}
\group{etale-cohomology}
...
Sections \ref{etale-cohomology-section-quasi-coherent} and
...
\begin{lemma}[Cohomological descent etale fppf modules]
\label{etale-cohomology-lemma-cohomological-descent-etale-fppf-modules}
\source{stacks:0DEX}
\href{https://stacks.math.columbia.edu/tag/0DEX}{\texttt{Stacks tag 0DEX}}
\group{etale-cohomology}
...
parts (6) and (7) of
Lemma \ref{etale-cohomology-lemma-review-quasi-coherent}.
\end{proof}

\begin{lemma}[Cohomological descent complex modules]
\label{etale-cohomology-lemma-cohomological-descent-complex-modules}
\source{stacks:0H0U}
\href{https://stacks.math.columbia.edu/tag/0H0U}{\texttt{Stacks tag 0H0U}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-review-quasi-coherent} to
...
\begin{lemma}[Describe pullback pi ph]
\label{etale-cohomology-lemma-describe-pullback-pi-ph}
\source{stacks:0DDW}
\href{https://stacks.math.columbia.edu/tag/0DDW}{\texttt{Stacks tag 0DDW}}
\group{etale-cohomology}
...
$$
\begin{array}{ccc}(\pi_S^{-1}\mathcal{F})(U) \longrightarrow & (\pi_S^{-1}\mathcal{F})(V) \longrightarrow\longrightarrow & (\pi_S^{-1}\mathcal{F})(V \times_U V)\end{array}
$$
Set $\mathcal{G} = \pi_S^{-1}\mathcal{F}|_{U_\etale}$.
Consider the commutative diagram
$$
\begin{array}{cc}V \times_U V \longrightarrow\underset{g}{\searrow}\downarrow & V \overset{f}{\downarrow} \\ V \overset{f}{\longrightarrow} & U\end{array}
$$
We have
$$
...
Lemma \ref{etale-cohomology-lemma-proper-pushforward-stalk}
...
In the situation of Lemma \ref{etale-cohomology-lemma-describe-pullback-pi-ph}
the composition of $\epsilon_S$ and $\pi_S$ and the equality
determine a morphism of sites
$$
...
\begin{lemma}[Push pull ph etale]
\label{etale-cohomology-lemma-push-pull-ph-etale}
\source{stacks:0DDX}
\href{https://stacks.math.columbia.edu/tag/0DDX}{\texttt{Stacks tag 0DDX}}
\group{etale-cohomology}
...
Then there are commutative diagrams of topoi
$$
\begin{array}{ccc}\Sh((\Sch/X)_{ph}) \underset{f_{big, ph}}{\longrightarrow}\underset{\epsilon_X}{\downarrow} &  & \Sh((\Sch/Y)_{ph}) \overset{\epsilon_Y}{\downarrow} \\ \Sh((\Sch/X)_\etale) \overset{f_{big, \etale}}{\longrightarrow} &  & \Sh((\Sch/Y)_\etale)\end{array}
$$
and
$$
\begin{array}{ccc}\Sh((\Sch/X)_{ph}) \underset{f_{big, ph}}{\longrightarrow}\underset{a_X}{\downarrow} &  & \Sh((\Sch/Y)_{ph}) \overset{a_Y}{\downarrow} \\ \Sh(X_\etale) \overset{f_{small}}{\longrightarrow} &  & \Sh(Y_\etale)\end{array}
$$
with $a_X = \pi_X \circ \epsilon_X$ and $a_Y = \pi_X \circ \epsilon_X$.
\end{lemma}
...
\begin{lemma}[Proper push pull ph etale]
\label{etale-cohomology-lemma-proper-push-pull-ph-etale}
\source{stacks:0DDY}
\href{https://stacks.math.columbia.edu/tag/0DDY}{\texttt{Stacks tag 0DDY}}
\group{etale-cohomology}

In Lemma \ref{etale-cohomology-lemma-push-pull-ph-etale} if $f$ is proper, then we have
...
As $\epsilon_{Y, *}$ is the identity functor on underlying presheaves,
it reflects isomorphisms. The description
in Lemma \ref{etale-cohomology-lemma-describe-pullback-pi-ph}
shows that $\epsilon_{Y, *} \circ a_Y^{-1} = \pi_Y^{-1}$
and similarly for $X$. To show that the canonical map
...
\begin{lemma}[Compare ph etale]
\label{etale-cohomology-lemma-compare-ph-etale}
\source{stacks:0F0I}
\href{https://stacks.math.columbia.edu/tag/0F0I}{\texttt{Stacks tag 0F0I}}
\group{etale-cohomology}
...
\medskip\noindent
Cohomology on Sites, Property (\ref{sites-cohomology-item-A-sheaf}) is
Lemma \ref{etale-cohomology-lemma-describe-pullback-pi-ph}.
...
sheaf on $X_\etale$, see Lemma \ref{etale-cohomology-lemma-torsion-direct-image}.
...
\begin{lemma}[V C all n etale ph]
\label{etale-cohomology-lemma-V-C-all-n-etale-ph}
\source{stacks:0DE4}
\href{https://stacks.math.columbia.edu/tag/0DE4}{\texttt{Stacks tag 0DE4}}
\group{etale-cohomology}
...
\begin{proof}
By Lemma \ref{etale-cohomology-lemma-compare-ph-etale} the lemmas in
Cohomology on Sites, Section \ref{sites-cohomology-section-compare-general}
all apply to our current setting. To translate the results
observe that the category $\mathcal{A}_X$ of
Cohomology on Sites, Lemma \ref{sites-cohomology-lemma-A}
...
\begin{lemma}[Cohomological descent etale ph]
\label{etale-cohomology-lemma-cohomological-descent-etale-ph}
\source{stacks:0DE5}
\href{https://stacks.math.columbia.edu/tag/0DE5}{\texttt{Stacks tag 0DE5}}
\group{etale-cohomology}
...
\medskip\noindent
By Lemma \ref{etale-cohomology-lemma-describe-pullback-pi-ph} we have
$a_{X, *}a_X^{-1}\mathcal{F} = \mathcal{F}$. Thus it suffices to show that
$R^qa_{X, *}a_X^{-1}\mathcal{F} = 0$ for $q > 0$.
For this we can use $a_X = \epsilon_X \circ \pi_X$ and
the Leray spectral sequence
(Cohomology on Sites, Lemma \ref{sites-cohomology-lemma-relative-Leray}).
By Lemma \ref{etale-cohomology-lemma-V-C-all-n-etale-ph}
we have $R^i\epsilon_{X, *}(a_X^{-1}\mathcal{F}) = 0$ for $i > 0$
...
\begin{lemma}[Compare cohomology etale ph]
\label{etale-cohomology-lemma-compare-cohomology-etale-ph}
\source{stacks:0DE6}
\href{https://stacks.math.columbia.edu/tag/0DE6}{\texttt{Stacks tag 0DE6}}
\group{etale-cohomology}
...
\begin{proof}
This follows from Lemma \ref{etale-cohomology-lemma-cohomological-descent-etale-ph}
by Cohomology on Sites, Remark \ref{sites-cohomology-remark-before-Leray}.
\end{proof}
...
\begin{lemma}[Describe pullback pi h]
\label{etale-cohomology-lemma-describe-pullback-pi-h}
\source{stacks:0EW8}
\href{https://stacks.math.columbia.edu/tag/0EW8}{\texttt{Stacks tag 0EW8}}
\group{etale-cohomology}
...
topology. However, in Lemma \ref{etale-cohomology-lemma-describe-pullback-pi-ph}
we have shown that
$\pi_S^{-1}\mathcal{F}$ is a sheaf even in the stronger ph
topology.
\end{proof}

In the situation of Lemma \ref{etale-cohomology-lemma-describe-pullback-pi-h}
the composition of $\epsilon_S$ and $\pi_S$ and the equality
determine a morphism of sites
$$
...
\begin{lemma}[Push pull h etale]
\label{etale-cohomology-lemma-push-pull-h-etale}
\source{stacks:0EW9}
\href{https://stacks.math.columbia.edu/tag/0EW9}{\texttt{Stacks tag 0EW9}}
\group{etale-cohomology}
...
Then there are commutative diagrams of topoi
$$
\begin{array}{ccc}\Sh((\Sch/X)_h) \underset{f_{big, h}}{\longrightarrow}\underset{\epsilon_X}{\downarrow} &  & \Sh((\Sch/Y)_h) \overset{\epsilon_Y}{\downarrow} \\ \Sh((\Sch/X)_\etale) \overset{f_{big, \etale}}{\longrightarrow} &  & \Sh((\Sch/Y)_\etale)\end{array}
$$
and
$$
\begin{array}{ccc}\Sh((\Sch/X)_h) \underset{f_{big, h}}{\longrightarrow}\underset{a_X}{\downarrow} &  & \Sh((\Sch/Y)_h) \overset{a_Y}{\downarrow} \\ \Sh(X_\etale) \overset{f_{small}}{\longrightarrow} &  & \Sh(Y_\etale)\end{array}
$$
with $a_X = \pi_X \circ \epsilon_X$ and $a_Y = \pi_X \circ \epsilon_X$.
\end{lemma}
...
\begin{lemma}[Proper push pull h etale]
\label{etale-cohomology-lemma-proper-push-pull-h-etale}
\source{stacks:0EWA}
\href{https://stacks.math.columbia.edu/tag/0EWA}{\texttt{Stacks tag 0EWA}}
\group{etale-cohomology}

In Lemma \ref{etale-cohomology-lemma-push-pull-h-etale} if $f$ is proper, then we have
...
As $\epsilon_{Y, *}$ is the identity functor on underlying presheaves,
it reflects isomorphisms. The description
in Lemma \ref{etale-cohomology-lemma-describe-pullback-pi-h}
shows that $\epsilon_{Y, *} \circ a_Y^{-1} = \pi_Y^{-1}$
and similarly for $X$. To show that the canonical map
...
\begin{lemma}[Compare h etale]
\label{etale-cohomology-lemma-compare-h-etale}
\source{stacks:0F0J}
\href{https://stacks.math.columbia.edu/tag/0F0J}{\texttt{Stacks tag 0F0J}}
\group{etale-cohomology}
...
\medskip\noindent
Cohomology on Sites, Property (\ref{sites-cohomology-item-A-sheaf}) is
Lemma \ref{etale-cohomology-lemma-describe-pullback-pi-h}.
...
\begin{lemma}[V C all n etale h]
\label{etale-cohomology-lemma-V-C-all-n-etale-h}
\source{stacks:0EWF}
\href{https://stacks.math.columbia.edu/tag/0EWF}{\texttt{Stacks tag 0EWF}}
\group{etale-cohomology}
...
\begin{proof}
By Lemma \ref{etale-cohomology-lemma-compare-h-etale} the lemmas in
Cohomology on Sites, Section \ref{sites-cohomology-section-compare-general}
all apply to our current setting. To translate the results
observe that the category $\mathcal{A}_X$ of
Cohomology on Sites, Lemma \ref{sites-cohomology-lemma-A}
...
\begin{lemma}[Cohomological descent etale h]
\label{etale-cohomology-lemma-cohomological-descent-etale-h}
\source{stacks:0EWG}
\href{https://stacks.math.columbia.edu/tag/0EWG}{\texttt{Stacks tag 0EWG}}
\group{etale-cohomology}
...
\medskip\noindent
By Lemma \ref{etale-cohomology-lemma-describe-pullback-pi-h} we have
$a_{X, *}a_X^{-1}\mathcal{F} = \mathcal{F}$. Thus it suffices to show that
$R^qa_{X, *}a_X^{-1}\mathcal{F} = 0$ for $q > 0$.
For this we can use $a_X = \epsilon_X \circ \pi_X$ and
the Leray spectral sequence
(Cohomology on Sites, Lemma \ref{sites-cohomology-lemma-relative-Leray}).
By Lemma \ref{etale-cohomology-lemma-V-C-all-n-etale-h}
we have $R^i\epsilon_{X, *}(a_X^{-1}\mathcal{F}) = 0$ for $i > 0$
and $\epsilon_{X, *}a_X^{-1}\mathcal{F} = \pi_X^{-1}\mathcal{F}$.
By Lemma \ref{etale-cohomology-lemma-cohomological-descent-etale} we have
$R^j\pi_{X, *}(\pi_X^{-1}\mathcal{F}) = 0$ for $j > 0$.
...
\begin{lemma}[Compare cohomology etale h]
\label{etale-cohomology-lemma-compare-cohomology-etale-h}
\source{stacks:0EWH}
\href{https://stacks.math.columbia.edu/tag/0EWH}{\texttt{Stacks tag 0EWH}}
\group{etale-cohomology}
...
\begin{proof}
This follows from Lemma \ref{etale-cohomology-lemma-cohomological-descent-etale-h}
by Cohomology on Sites, Remark \ref{sites-cohomology-remark-before-Leray}.
\end{proof}
...
results
\begin{enumerate}
\item Lemma \ref{etale-cohomology-lemma-describe-pullback} tells us that a sheaf
...
and fppf coverings),
\item Lemma \ref{etale-cohomology-lemma-describe-pullback-pi-fppf} is a restatement of
the previous point for the fppf topology,
\item Lemma \ref{etale-cohomology-lemma-describe-pullback-pi-ph} proves the same for the
ph topology,
\item Lemma \ref{etale-cohomology-lemma-describe-pullback-pi-h} proves the same for the
h topology,
\item Lemma \ref{etale-cohomology-lemma-descent-sheaf-fppf-etale} is a version of
fppf descent for \'etale sheaves, and
\item Remark \ref{etale-cohomology-remark-cohomological-descent-finite} tells us that
...
such that the {\it cocycle condition} holds: the diagrams
$$
\begin{array}{ccc}\text{pr}_{0, small}^{-1}\mathcal{F}_i
\underset{\text{pr}_{02, small}^{-1}\varphi_{ik}}{\searrow}\overset{\text{pr}_{01, small}^{-1}\varphi_{ij}}{\longrightarrow} &  & \text{pr}_{1, small}^{-1}\mathcal{F}_j
\overset{\text{pr}_{12, small}^{-1}\varphi_{jk}}{\swarrow} \\  & \text{pr}_{2, small}^{-1}\mathcal{F}_k & \end{array}
$$
...
$$
\begin{array}{ccc}\text{pr}_{0, small}^{-1}\mathcal{F}
\underset{\text{pr}_{02, small}^{-1}\varphi}{\searrow}\overset{\text{pr}_{01, small}^{-1}\varphi}{\longrightarrow} &  & \text{pr}_{1, small}^{-1}\mathcal{F}
\overset{\text{pr}_{12, small}^{-1}\varphi}{\swarrow} \\  & \text{pr}_{2, small}^{-1}\mathcal{F} & \end{array}
$$
...
\begin{lemma}[Glue etale sheaf section]
\label{etale-cohomology-lemma-glue-etale-sheaf-section}
\source{stacks:0GEY}
\href{https://stacks.math.columbia.edu/tag/0GEY}{\texttt{Stacks tag 0GEY}}
\group{etale-cohomology}
...
\begin{lemma}[Glue etale sheaf integral surjective]
\label{etale-cohomology-lemma-glue-etale-sheaf-integral-surjective}
\source{stacks:0GEZ}
\href{https://stacks.math.columbia.edu/tag/0GEZ}{\texttt{Stacks tag 0GEZ}}
\group{etale-cohomology}
...
\mathcal{G} =
\text{Equalizer}\left(
\begin{array}{cc}f_*\mathcal{F}
\longrightarrow\longrightarrow & f_{1, *}\mathcal{F}_1\end{array}
\right)
$$
...
Theorem \ref{etale-cohomology-theorem-exactness-stalks}.
By Lemma \ref{etale-cohomology-lemma-integral-pushforward-commutes-with-base-change}
...
Lemma \ref{etale-cohomology-lemma-glue-etale-sheaf-section}.
...
\begin{lemma}[Glue etale sheaf proper surjective]
\label{etale-cohomology-lemma-glue-etale-sheaf-proper-surjective}
\source{stacks:0GF0}
\href{https://stacks.math.columbia.edu/tag/0GF0}{\texttt{Stacks tag 0GF0}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-glue-etale-sheaf-integral-surjective}
works, except the appeal to
Lemma \ref{etale-cohomology-lemma-integral-pushforward-commutes-with-base-change}
should be replaced by an appeal to
Lemma \ref{etale-cohomology-lemma-proper-base-change-f-star}.
\end{proof}

\begin{lemma}[Glue etale sheaf check after base change]
\label{etale-cohomology-lemma-glue-etale-sheaf-check-after-base-change}
\source{stacks:0GF1}
\href{https://stacks.math.columbia.edu/tag/0GF1}{\texttt{Stacks tag 0GF1}}
\group{etale-cohomology}
...
Lemmas \ref{etale-cohomology-lemma-glue-etale-sheaf-integral-surjective} and
\ref{etale-cohomology-lemma-glue-etale-sheaf-proper-surjective}. Details omitted.
\end{proof}

\begin{lemma}[Glue etale sheaf fppf cover]
\label{etale-cohomology-lemma-glue-etale-sheaf-fppf-cover}
\source{stacks:0GF2}
\href{https://stacks.math.columbia.edu/tag/0GF2}{\texttt{Stacks tag 0GF2}}
\group{etale-cohomology}
...
\begin{lemma}[Glue etale sheaf fppf]
\label{etale-cohomology-lemma-glue-etale-sheaf-fppf}
\source{stacks:0GF3}
\href{https://stacks.math.columbia.edu/tag/0GF3}{\texttt{Stacks tag 0GF3}}
\group{etale-cohomology}
...
\begin{proof}
We have Lemma \ref{etale-cohomology-lemma-glue-etale-sheaf-fppf-cover}
...
\begin{lemma}[Glue etale sheaf modification]
\label{etale-cohomology-lemma-glue-etale-sheaf-modification}
\source{stacks:0GF4}
\href{https://stacks.math.columbia.edu/tag/0GF4}{\texttt{Stacks tag 0GF4}}
\group{etale-cohomology}

Let $f : X' \to X$ be a proper morphism of schemes. Let $i : Z \to X$
be a closed immersion. Set $E = Z \times_X X'$. Picture
$$
\begin{array}{cc}E \underset{g}{\downarrow}\underset{j}{\longrightarrow} & X' \overset{f}{\downarrow} \\ Z \overset{i}{\longrightarrow} & X\end{array}
$$
...
g_*g^{-1}\mathcal{G}
$$
The first equality is Lemma \ref{etale-cohomology-lemma-proper-base-change-f-star}.
...
\begin{lemma}[H descent etale sheaves]
\label{etale-cohomology-lemma-h-descent-etale-sheaves}
\source{stacks:0GF5}
\href{https://stacks.math.columbia.edu/tag/0GF5}{\texttt{Stacks tag 0GF5}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-glue-etale-sheaf-fppf-cover} or
Lemma \ref{etale-cohomology-lemma-glue-etale-sheaf-proper-surjective}.

\medskip\noindent
Condition (3) follows immediately from the more general
Lemma \ref{etale-cohomology-lemma-glue-etale-sheaf-modification}.
\end{proof}
...
\begin{lemma}[Blow up square cohomological descent]
\label{etale-cohomology-lemma-blow-up-square-cohomological-descent}
\source{stacks:0EW5}
\href{https://stacks.math.columbia.edu/tag/0EW5}{\texttt{Stacks tag 0EW5}}
\group{etale-cohomology}
...
$$
\begin{array}{cc}E \underset{\pi}{\downarrow}\underset{j}{\longrightarrow} & X' \overset{b}{\downarrow} \\ Z \overset{i}{\longrightarrow} & X\end{array}
$$
For $K \in D^+(X_\etale)$ with torsion cohomology sheaves
...
by Lemma \ref{etale-cohomology-lemma-proper-base-change-f-star} and by
Lemma \ref{etale-cohomology-lemma-proper-base-change} this complex represents
...
\begin{lemma}[Blow up square etale cohomology]
\label{etale-cohomology-lemma-blow-up-square-etale-cohomology}
\source{stacks:0EW3}
\href{https://stacks.math.columbia.edu/tag/0EW3}{\texttt{Stacks tag 0EW3}}
\group{etale-cohomology}
...
corresponding blow up square
$$
\begin{array}{cc}E \downarrow\longrightarrow & X' \overset{b}{\downarrow} \\ Z \longrightarrow & X\end{array}
$$
...
Lemma \ref{etale-cohomology-lemma-blow-up-square-cohomological-descent}
and the fact that
$$
...
\begin{proof}[Second proof]
By Lemma \ref{etale-cohomology-lemma-compare-cohomology-etale-ph}
...
Lemma \ref{etale-cohomology-lemma-describe-pullback-pi-ph} above
...
\begin{lemma}[Blow up square equivalence]
\label{etale-cohomology-lemma-blow-up-square-equivalence}
\source{stacks:0EW6}
\href{https://stacks.math.columbia.edu/tag/0EW6}{\texttt{Stacks tag 0EW6}}
\group{etale-cohomology}
...
\begin{proof}
If $K$ exists, then Lemma \ref{etale-cohomology-lemma-blow-up-square-cohomological-descent}
...
by the base change theorem (Lemma \ref{etale-cohomology-lemma-proper-base-change}) and hence
...
$$
\begin{array}{cccc}K \longrightarrow\downarrow & Ri_*(K|_Z) \oplus Rb_*(K|_{X'}) \longrightarrow\underset{\beta \oplus \alpha}{\downarrow} & Rc_*(K|_E) \longrightarrow\underset{\alpha|_E}{\downarrow} & K[1] \downarrow \\ M \longrightarrow & Ri_*(M|_Z) \oplus Rb_*(M|_{X'}) \longrightarrow & Rc_*(M|_E) \longrightarrow & M[1]\end{array}
$$
...
\begin{lemma}[Blow up square h]
\label{etale-cohomology-lemma-blow-up-square-h}
\source{stacks:0EWN}
\href{https://stacks.math.columbia.edu/tag/0EWN}{\texttt{Stacks tag 0EWN}}
\group{etale-cohomology}
...
\begin{proposition}[Check h]
\label{etale-cohomology-proposition-check-h}
\source{stacks:0EWQ}
\href{https://stacks.math.columbia.edu/tag/0EWQ}{\texttt{Stacks tag 0EWQ}}
\group{etale-cohomology}
...
Lemma \ref{etale-cohomology-lemma-blow-up-square-h} and
More on Flatness, Proposition \ref{flat-proposition-check-h}.
\end{proof}

\begin{lemma}[Refine check h]
\label{etale-cohomology-lemma-refine-check-h}
\source{stacks:0EWR}
\href{https://stacks.math.columbia.edu/tag/0EWR}{\texttt{Stacks tag 0EWR}}
\group{etale-cohomology}
...
\begin{lemma}[H sheaf colim F]
\label{etale-cohomology-lemma-h-sheaf-colim-F}
\source{stacks:0EWT}
\href{https://stacks.math.columbia.edu/tag/0EWT}{\texttt{Stacks tag 0EWT}}
\group{etale-cohomology}
...
\begin{proof}
We prove this using the criterion of Lemma \ref{etale-cohomology-lemma-refine-check-h}.
...
\begin{proposition}[H cohomology structure sheaf]
\label{etale-cohomology-proposition-h-cohomology-structure-sheaf}
\source{stacks:0EWU}
\href{https://stacks.math.columbia.edu/tag/0EWU}{\texttt{Stacks tag 0EWU}}
\group{etale-cohomology}
...
\begin{proof}
This is just a reformulation of Lemma \ref{etale-cohomology-lemma-h-sheaf-colim-F}.
Recall that
$\mathcal{O}^h = \mathcal{O}^{perf} = \colim_F \mathcal{O}$, see
More on Flatness, Lemma \ref{flat-lemma-char-p}.
By Lemma \ref{etale-cohomology-lemma-h-sheaf-colim-F} we see that
...
(see proof of Lemma \ref{etale-cohomology-lemma-h-sheaf-colim-F}).
\end{proof}
