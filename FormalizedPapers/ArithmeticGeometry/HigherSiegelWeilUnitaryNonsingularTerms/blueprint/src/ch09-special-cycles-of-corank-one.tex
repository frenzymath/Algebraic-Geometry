...
\begin{prop}
\source{higher-siegel-weil-unitary-nonsingular-terms}
\notready\label{p:ShM dim} Let $n \geq 2$.
\begin{enumerate}
...
\begin{eqnarray*}
%V &\cong& \Spec \frac{ \ov k[x_{1},\cdots, x_{l}, \xi_{1},\ldots, \xi_{l}, y_1, \ldots, y_m, y_{m+1} \ldots, y_{m+d}  ]}{(I(x), I^{(1)}(\xi), x_{1}-f_1, \ldots, x_{l}-f_{l}, \xi_{1}-x^{q}_{1},\ldots, \xi_{l}-x_{l}^{q}, r_1, \ldots, r_m)}\\
V & \cong&  \Spec\frac{ \ov k[\xi_{1},\ldots, \xi_{l}, y_1, \ldots, y_m, y_{m+1} \ldots, y_{m+d}  ]}
...
\begin{prop}
\source{higher-siegel-weil-unitary-nonsingular-terms}
\notready\label{p:dim ZL0} Let $n \geq 2$.
\begin{enumerate}
