...
`FormalizedPapers/ModuliHiggsCharacter/RigidLocalSystemsMultiplicativeEigenvalueProblem`.
...
- Source bundle: [`references/rigid-local-systems-multiplicative-eigenvalue-problem/`](../../../references/rigid-local-systems-multiplicative-eigenvalue-problem/)
