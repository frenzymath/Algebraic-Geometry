...
\notready
	 ...
	 1. The direct image of the trivial bundle   \beq \label{canonicalBNR} (\pi_a)_*(\calO_{C_a}\stackrel{x}{\to}\pi_a^*(K))\cong \calE_{\calO_C, a}=(E_{\calO_C},\Phi_a)\in W^+_{\calE_0} \eeq   defines  the canonical section  $W^+_{\calE_0}$ of the Hitchin map (see \eqref{uniform}).
\source{very-stable-higgs-bundles-equivariant-multiplicity-mirror-symmetry}

	 2. If a Higgs bundle $(E,\Phi)$ is the direct image of a line bundle $U$:
