...
See Section \ref{relative-cycles-section-families-specialization}.
...
$Z_r(X)$ of $r$-cycles on $X$, see Section \ref{relative-cycles-section-conventions}.
...
\begin{lemma}[Multiplicities field extension]
\label{relative-cycles-lemma-multiplicities-field-extension}
\source{stacks:0H4F}
\href{https://stacks.math.columbia.edu/tag/0H4F}{\texttt{Stacks tag 0H4F}}
\group{relative-cycles}
...
\begin{lemma}[How different]
\label{relative-cycles-lemma-how-different}
\source{stacks:0H4G}
\href{https://stacks.math.columbia.edu/tag/0H4G}{\texttt{Stacks tag 0H4G}}
\group{relative-cycles}
...
Lemma \ref{relative-cycles-lemma-multiplicities-field-extension}.
\end{proof}
...
\begin{lemma}[Specialization module]
\label{relative-cycles-lemma-specialization-module}
\source{stacks:0H4I}
\href{https://stacks.math.columbia.edu/tag/0H4I}{\texttt{Stacks tag 0H4I}}
\group{relative-cycles}
...
\begin{lemma}[Specialization closed]
\label{relative-cycles-lemma-specialization-closed}
\source{stacks:0H4J}
\href{https://stacks.math.columbia.edu/tag/0H4J}{\texttt{Stacks tag 0H4J}}
\group{relative-cycles}
...
Lemma \ref{relative-cycles-lemma-specialization-module}. See
Chow Homology, Lemma \ref{chow-lemma-cycle-closed-coherent}.
\end{proof}

\begin{lemma}[Specialization extension]
\label{relative-cycles-lemma-specialization-extension}
\source{stacks:0H4K}
\href{https://stacks.math.columbia.edu/tag/0H4K}{\texttt{Stacks tag 0H4K}}
\group{relative-cycles}
...
Then the diagram
$$
\begin{array}{ccc}Z_r(X'_{K'}) \underset{sp_{X'/R'}}{\longrightarrow} &  & Z_r(X'_{\kappa'}) \\ Z_r(X_K) \overset{sp_{X/R}}{\longrightarrow}\uparrow &  & Z_r(X_\kappa) \uparrow\end{array}
$$
...
make sense (see Section \ref{relative-cycles-section-relative-fields}).
...
$$
by Lemma \ref{relative-cycles-lemma-specialization-module}. Since
$(\overline{Z}_{R'})_{\kappa'} = (\overline{Z}_\kappa)_{\kappa'}$
we conclude.
\end{proof}

\begin{lemma}[Specialization flat pullback]
\label{relative-cycles-lemma-specialization-flat-pullback}
\source{stacks:0H4L}
\href{https://stacks.math.columbia.edu/tag/0H4L}{\texttt{Stacks tag 0H4L}}
\group{relative-cycles}
...
$$
\begin{array}{ccc}Z_{r + e}(X'_K) \underset{sp_{X'/R}}{\longrightarrow} &  & Z_{r + e}(X'_\kappa) \\ Z_r(X_K) \overset{sp_{X/R}}{\longrightarrow}\uparrow &  & Z_r(X_\kappa) \uparrow\end{array}
$$
...
by Lemma \ref{relative-cycles-lemma-specialization-closed}.
...
\begin{lemma}[Specialization proper pushforward]
\label{relative-cycles-lemma-specialization-proper-pushforward}
\source{stacks:0H4M}
\href{https://stacks.math.columbia.edu/tag/0H4M}{\texttt{Stacks tag 0H4M}}
\group{relative-cycles}
...
$$
\begin{array}{ccc}Z_r(X_K) \underset{sp_{X/R}}{\longrightarrow}\downarrow &  & Z_r(X_\kappa) \downarrow \\ Z_r(Y_K) \overset{sp_{Y/R}}{\longrightarrow} &  & Z_r(Y_\kappa)\end{array}
$$
commutes where $r \geq 0$ and the vertical arrows are given
...
$$
\begin{array}{cc}X_\kappa \downarrow\underset{i}{\longrightarrow} & X \downarrow \\ Y_\kappa \overset{j}{\longrightarrow} & Y\end{array}
$$
...
{\bf Base change.} Let
$$
\begin{array}{cc}X' \longrightarrow\downarrow & X \overset{f}{\downarrow} \\ S' \overset{g}{\longrightarrow} & S\end{array}
$$
...
Section \ref{relative-cycles-section-relative-fields} via the identitification
...
$$
\begin{array}{ccc}X \underset{f}{\longrightarrow}\searrow &  & Y \swarrow \\  & S & \end{array}
$$
...
\begin{lemma}[Compatibilities]
\label{relative-cycles-lemma-compatibilities}
\source{stacks:0H4P}
\href{https://stacks.math.columbia.edu/tag/0H4P}{\texttt{Stacks tag 0H4P}}
\group{relative-cycles}
...
\begin{example}[Family associated module]
\label{relative-cycles-example-family-associated-module}
\source{stacks:0H4Q}
\href{https://stacks.math.columbia.edu/tag/0H4Q}{\texttt{Stacks tag 0H4Q}}
\group{relative-cycles}
...
\begin{lemma}[Family associated module]
\label{relative-cycles-lemma-family-associated-module}
\source{stacks:0H4R}
\href{https://stacks.math.columbia.edu/tag/0H4R}{\texttt{Stacks tag 0H4R}}
\group{relative-cycles}

The construction in Example \ref{relative-cycles-example-family-associated-module}
...
\begin{example}[Family associated closed]
\label{relative-cycles-example-family-associated-closed}
\source{stacks:0H4S}
\href{https://stacks.math.columbia.edu/tag/0H4S}{\texttt{Stacks tag 0H4S}}
\group{relative-cycles}
...
\begin{lemma}[Family associated closed]
\label{relative-cycles-lemma-family-associated-closed}
\source{stacks:0H4T}
\href{https://stacks.math.columbia.edu/tag/0H4T}{\texttt{Stacks tag 0H4T}}
\group{relative-cycles}

The construction in Example \ref{relative-cycles-example-family-associated-closed}
is compatible with base change, restriction, and flat pullback.
\end{lemma}

\begin{proof}
Taking $\mathcal{F} = (Z \to X)_*\mathcal{O}_Z$ this is a special case of
Lemma \ref{relative-cycles-lemma-family-associated-module}. See
Chow Homology, Lemma \ref{chow-lemma-cycle-closed-coherent}.
\end{proof}
...
\source{stacks:0H4U}
\href{https://stacks.math.columbia.edu/tag/0H4U}{\texttt{Stacks tag 0H4U}}
\group{relative-cycles}
...
\begin{lemma}[Support family]
\label{relative-cycles-lemma-support-family}
\source{stacks:0H4V}
\href{https://stacks.math.columbia.edu/tag/0H4V}{\texttt{Stacks tag 0H4V}}
\group{relative-cycles}

Taking the support as in Remark \ref{relative-cycles-remark-supports-family}
is compatible with base change, restriction, and flat pullback.
\end{lemma}
...
\begin{lemma}[Coequalizer dim r]
\label{relative-cycles-lemma-coequalizer-dim-r}
\source{stacks:0H4W}
\href{https://stacks.math.columbia.edu/tag/0H4W}{\texttt{Stacks tag 0H4W}}
\group{relative-cycles}
...
\begin{lemma}[Descend family]
\label{relative-cycles-lemma-descend-family}
\source{stacks:0H4X}
\href{https://stacks.math.columbia.edu/tag/0H4X}{\texttt{Stacks tag 0H4X}}
\group{relative-cycles}
...
in Section \ref{relative-cycles-section-relative-fields}. (This argument works as
...
(see for example Lemma \ref{relative-cycles-lemma-multiplicities-field-extension}).
...
in $(X''/S'')^{(r)}$.
By Lemma \ref{relative-cycles-lemma-coequalizer-dim-r} and an elementary
...
\begin{lemma}[Pullback universally bijective]
\label{relative-cycles-lemma-pullback-universally-bijective}
\source{stacks:0H4Y}
\href{https://stacks.math.columbia.edu/tag/0H4Y}{\texttt{Stacks tag 0H4Y}}
\group{relative-cycles}
...
Here is the definition we will work with; see Section \ref{relative-cycles-section-compare}
...
\source{stacks:0H50}
\href{https://stacks.math.columbia.edu/tag/0H50}{\texttt{Stacks tag 0H50}}
\group{relative-cycles}
...
$$
where $sp_{X'/S'}$ is as in Section \ref{relative-cycles-section-specialization}
...
\begin{lemma}[Relative cycle functoriality]
\label{relative-cycles-lemma-relative-cycle-functoriality}
\source{stacks:0H51}
\href{https://stacks.math.columbia.edu/tag/0H51}{\texttt{Stacks tag 0H51}}
\group{relative-cycles}

Let $\alpha$ be a relative $r$-cycle on $X/S$ as in
Definition \ref{relative-cycles-definition-relative-cycles}.
Then any restriction, base change, flat pullback, or proper pushforward
of $\alpha$ is a relative $r$-cycle.
\end{lemma}

\begin{proof}
For flat pullback use Lemma \ref{relative-cycles-lemma-specialization-flat-pullback}.
Restriction is a special case of flat pullback. To see it holds for
base change use that base change is transitive.
For proper pushforward use Lemma \ref{relative-cycles-lemma-specialization-proper-pushforward}.
\end{proof}

\begin{lemma}[Relative cycles h descent]
\label{relative-cycles-lemma-relative-cycles-h-descent}
\source{stacks:0H52}
\href{https://stacks.math.columbia.edu/tag/0H52}{\texttt{Stacks tag 0H52}}
\group{relative-cycles}
...
relative $r$-cycle by Lemma \ref{relative-cycles-lemma-relative-cycle-functoriality}.
...
on the fibres, see Lemma \ref{relative-cycles-lemma-specialization-extension}.
We conclude that $sp_{X/S}(\alpha_\eta) = \alpha_0$ because
the base change map $Z_r(X_0) \to Z_r(X'_{0'})$ is injective
as discussed in Section \ref{relative-cycles-section-relative-fields}.
\end{proof}

\begin{lemma}[Families specialization fppf descent]
\label{relative-cycles-lemma-families-specialization-fppf-descent}
\source{stacks:0H53}
\href{https://stacks.math.columbia.edu/tag/0H53}{\texttt{Stacks tag 0H53}}
\group{relative-cycles}
...
Lemma \ref{relative-cycles-lemma-specialization-flat-pullback}
...
\begin{lemma}[Check after closed]
\label{relative-cycles-lemma-check-after-closed}
\source{stacks:0H54}
\href{https://stacks.math.columbia.edu/tag/0H54}{\texttt{Stacks tag 0H54}}
\group{relative-cycles}
...
\begin{proof}
Since base change commutes with $i_*$ (Lemma \ref{relative-cycles-lemma-compatibilities})
...
Lemma \ref{relative-cycles-lemma-specialization-proper-pushforward}.
\end{proof}

The following lemma will be strengthened in
Lemma \ref{relative-cycles-lemma-relative-cycles-equal}.

\begin{lemma}[Uniqueness extension]
\label{relative-cycles-lemma-uniqueness-extension}
\source{stacks:0H55}
\href{https://stacks.math.columbia.edu/tag/0H55}{\texttt{Stacks tag 0H55}}
\group{relative-cycles}
...
\begin{lemma}[Family associated module specialization]
\label{relative-cycles-lemma-family-associated-module-specialization}
\source{stacks:0H56}
\href{https://stacks.math.columbia.edu/tag/0H56}{\texttt{Stacks tag 0H56}}
\group{relative-cycles}

In the situation of Example \ref{relative-cycles-example-family-associated-module}
...
base change by Lemma \ref{relative-cycles-lemma-family-associated-module}.
...
Lemma \ref{relative-cycles-lemma-specialization-module} and the definitions.
\end{proof}

\begin{lemma}[Family associated closed specialization]
\label{relative-cycles-lemma-family-associated-closed-specialization}
\source{stacks:0H57}
\href{https://stacks.math.columbia.edu/tag/0H57}{\texttt{Stacks tag 0H57}}
\group{relative-cycles}

In the situation of Example \ref{relative-cycles-example-family-associated-closed}
...
Lemma \ref{relative-cycles-lemma-family-associated-module-specialization}
...
Lemma \ref{relative-cycles-lemma-family-associated-closed-specialization} for each
...
\begin{lemma}[Get cycles]
\label{relative-cycles-lemma-get-cycles}
\source{stacks:0H59}
\href{https://stacks.math.columbia.edu/tag/0H59}{\texttt{Stacks tag 0H59}}
\group{relative-cycles}
...
by Lemma \ref{relative-cycles-lemma-uniqueness-extension}.
...
\begin{lemma}[Get cycles dvr]
\label{relative-cycles-lemma-get-cycles-dvr}
\source{stacks:0H5A}
\href{https://stacks.math.columbia.edu/tag/0H5A}{\texttt{Stacks tag 0H5A}}
\group{relative-cycles}
...
\begin{proof}
This of course follows from Lemma \ref{relative-cycles-lemma-get-cycles} but we can
...
Section \ref{relative-cycles-section-specialization}. Then
$\alpha = \sum n_i[\overline{Z}_i/X/S]$.
\end{proof}

\begin{lemma}[Relative cycle smooth]
\label{relative-cycles-lemma-relative-cycle-smooth}
\source{stacks:0H5B}
\href{https://stacks.math.columbia.edu/tag/0H5B}{\texttt{Stacks tag 0H5B}}
\group{relative-cycles}
...
Section \ref{relative-cycles-section-relative-fields}
...
\begin{lemma}[Relative cycles equal]
\label{relative-cycles-lemma-relative-cycles-equal}
\source{stacks:0H5C}
\href{https://stacks.math.columbia.edu/tag/0H5C}{\texttt{Stacks tag 0H5C}}
\group{relative-cycles}
...
By Lemma \ref{relative-cycles-lemma-family-associated-closed-specialization}
...
$$
\begin{array}{cccc}X \downarrow & X' \overset{g}{\longleftarrow}\overset{\pi}{\downarrow} & x \downarrow & x' \longleftarrow\downarrow \\  & Y \overset{h}{\downarrow} &  & y \downarrow \\ S \xlongequal{} & S & s & s \xlongequal{}\end{array}
$$
...
Lemma \ref{relative-cycles-lemma-relative-cycle-smooth} and openness of $Y \to S$
we see that an open neighbourhood of $s$ is disjoint from $E''$
and the proof is complete.
\end{proof}

\begin{lemma}[Descend through limit]
\label{relative-cycles-lemma-descend-through-limit}
\source{stacks:0H5D}
\href{https://stacks.math.columbia.edu/tag/0H5D}{\texttt{Stacks tag 0H5D}}
\group{relative-cycles}
...
\medskip\noindent
Let $\alpha \in z(X/S, r)$. Applying Lemma \ref{relative-cycles-lemma-get-cycles}
...
By Lemma \ref{relative-cycles-lemma-descend-family}
...
By Lemma \ref{relative-cycles-lemma-relative-cycles-h-descent}
we see that $\alpha_i \in z(X_i/S_i, r)$.
The uniqueness in Lemma \ref{relative-cycles-lemma-descend-family} implies that the
...
\source{stacks:0H5E}
\href{https://stacks.math.columbia.edu/tag/0H5E}{\texttt{Stacks tag 0H5E}}
\group{relative-cycles}
...
by Lemma \ref{relative-cycles-lemma-check-after-closed}. The lemma follows.
\end{proof}

\begin{lemma}[Extend to larger]
\label{relative-cycles-lemma-extend-to-larger}
\source{stacks:0H5F}
\href{https://stacks.math.columbia.edu/tag/0H5F}{\texttt{Stacks tag 0H5F}}
\group{relative-cycles}
...
Lemma \ref{relative-cycles-lemma-compatibilities} and \ref{relative-cycles-lemma-specialization-flat-pullback}.
The lemma follows easily from this; details omitted.
\end{proof}

\begin{lemma}[Seminormalize base]
\label{relative-cycles-lemma-seminormalize-base}
\source{stacks:0H5G}
\href{https://stacks.math.columbia.edu/tag/0H5G}{\texttt{Stacks tag 0H5G}}
\group{relative-cycles}
...
\begin{proof}
By Lemma \ref{relative-cycles-lemma-pullback-universally-bijective} we have a bijection
between the group of families of $r$-cycles on fibres of $X/S$ and
the group of families of $r$-cycles on fibres of $X'/S'$.
...
\source{stacks:0H5I}
\href{https://stacks.math.columbia.edu/tag/0H5I}{\texttt{Stacks tag 0H5I}}
\group{relative-cycles}
...
of $\alpha$ (Remark \ref{relative-cycles-remark-supports-family})
...
\begin{example}[Not equidimensional]
\label{relative-cycles-example-not-equidimensional}
\source{stacks:0H5J}
\href{https://stacks.math.columbia.edu/tag/0H5J}{\texttt{Stacks tag 0H5J}}
\group{relative-cycles}
...
\begin{lemma}[Equidimensional functoriality]
\label{relative-cycles-lemma-equidimensional-functoriality}
\source{stacks:0H5K}
\href{https://stacks.math.columbia.edu/tag/0H5K}{\texttt{Stacks tag 0H5K}}
\group{relative-cycles}
...
\begin{lemma}[Check equidimensional]
\label{relative-cycles-lemma-check-equidimensional}
\source{stacks:0H5L}
\href{https://stacks.math.columbia.edu/tag/0H5L}{\texttt{Stacks tag 0H5L}}
\group{relative-cycles}
...
\begin{lemma}[Equidimensional fppf descent]
\label{relative-cycles-lemma-equidimensional-fppf-descent}
\source{stacks:0H5M}
\href{https://stacks.math.columbia.edu/tag/0H5M}{\texttt{Stacks tag 0H5M}}
\group{relative-cycles}
...
Lemma \ref{relative-cycles-lemma-equidimensional-functoriality}. Assume each $g_i^*\alpha$
...
Lemma \ref{relative-cycles-lemma-support-family}.
...
\begin{lemma}[Equidimensional descent pullbacks]
\label{relative-cycles-lemma-equidimensional-descent-pullbacks}
\source{stacks:0H5N}
\href{https://stacks.math.columbia.edu/tag/0H5N}{\texttt{Stacks tag 0H5N}}
\group{relative-cycles}
...
\begin{proof}
Omitted. Hint: As in the proof of Lemma \ref{relative-cycles-lemma-equidimensional-fppf-descent}
...
\section{Weightings and relative zero cycles}
\label{relative-cycles-section-weightings}
In this section we show that for a quasi-finite morphism,
relative zero cycles are closely related to weighthings, as defined in
More on Morphisms, Section \ref{more-morphisms-section-weightings}.
...
\begin{lemma}[Weightings]
\label{relative-cycles-lemma-weightings}
\source{stacks:0H5P}
\href{https://stacks.math.columbia.edu/tag/0H5P}{\texttt{Stacks tag 0H5P}}
\group{relative-cycles}
...
$$
\begin{array}{cc}X \underset{f}{\downarrow} & U \overset{h}{\longleftarrow}\overset{\pi}{\downarrow} \\ Y & V \underset{g}{\longleftarrow}\end{array}
$$
...
By the compatibility with base change (Lemma \ref{relative-cycles-lemma-weightings-pre})
...
By Lemma \ref{relative-cycles-lemma-relative-cycle-smooth} this function is locally
constant on $V$.
...
nor the proof of Lemma \ref{relative-cycles-lemma-weightings-pre} uses that $\alpha$
...
\begin{example}[N must be positive sometimes]
\label{relative-cycles-example-n-must-be-positive-sometimes}
\group{relative-cycles}

Let $p$ be a prime number. Let $k'/k$ be a purely inseparable extension
of fields of degree $p^f$. Set $X = \Spec(k')$ and $S = \Spec(k)$.
The map $w : X \to \mathbf{Z}$ sending the unique point $x$ of $X$ to $1$
is a weighting of $X \to S$. On the other hand,
the group $z(X/S, 0)$ is freely generated by the cycle $\alpha = [x]$.
Thus we see that the smallest integer $n$ that works in
Lemma \ref{relative-cycles-lemma-weightings} is $n = p^f$ in this case.
\end{example}

\begin{example}[Merkurjev]
\label{relative-cycles-example-Merkurjev}
\group{relative-cycles}

The discussion above can be used to ``explain'' an example due to
A.S.~Merkurjev \cite[Example 3.5.10]{SV}. Let $p$ be a prime number
and let $k = \mathbf{F}_p(a, b)$ be the purely transcendental extension
of $\mathbf{F}_p$ on $a$ and $b$. Set
$$
A = k[x, y, z]/(a x^p + b y^p - z^p)
$$
This is a normal domain of finite type over $k$. The spectrum
$S = \Spec(A)$ is regular, except for a unique singular point $s$
corresponding to the maximal ideal $(x, y, z)$ of $A$ with residue field $k$.
Let $k' = k(a^{1/p}, b^{1/p})$ and $B = k'[x, y]$. Consider the map
$A \to B$ using the inclusion $k \to k'$, sending $x$ to $x$, $y$ to $y$,
and $z$ to $a^{1/p}x + b^{1/p}y$. Set $X = \Spec(B)$ and consider the morphism
$f : X \to S$ corresponding to the ring map $A \to B$.
The weighting $w : X \to \mathbf{Z}$ of $f$
produced by More on Morphisms, Lemma
\ref{more-morphisms-lemma-weighting-quasi-finite-Noetherian}
has constant value $1$ since the fraction field of $B$ is purely inseparable
over $A$!
Set $V = f^{-1}(U) \subset X$. By miracle flatness we see that
$V \to U$ is flat of degree $p$. It follows that the cycle
$\alpha = [V/V/U]_0 \in z(V/U, 0)$ satisfies $w_\alpha = pw|_V$.
However, since the unique point $x$ of $X$ lying over $s$
has residue field $k'$ of degree $p^2$ over $k$, we see that
there cannot be an element $\beta$ of $z(X/S, 0)$ restricting to $\alpha$.
Namely, the weighting $pw - w_\beta$ would be zero by More on Morphisms,
Lemma \ref{more-morphisms-lemma-weighting-specialization} which
would imply (by the formula in the proof of the lemma above) that
$$
\beta_s = \frac{pw(x)}{[\kappa(x) : \kappa(s)]_i} [x] =
\frac{1}{p}[x]
$$
in $Z_0(X_s)$ and this is impossible\footnote{In \cite{SV} there does
exist an element of the group of relative cycles $Cycl(X/S, 0)$
corresponding to $pw$ and this cycle does specialize to a cycle
on $X_s$ with non-integer coefficients.}. Of course,
the cycle $p\alpha$ is the restriction of a unique element of
$z(X/S, 0)$.
\end{example}
...
\source{stacks:0H5R}
\href{https://stacks.math.columbia.edu/tag/0H5R}{\texttt{Stacks tag 0H5R}}
\group{relative-cycles}
...
see Lemma \ref{relative-cycles-lemma-effective-equidimensional}.

\begin{lemma}[Effective functoriality]
\label{relative-cycles-lemma-effective-functoriality}
\source{stacks:0H5S}
\href{https://stacks.math.columbia.edu/tag/0H5S}{\texttt{Stacks tag 0H5S}}
\group{relative-cycles}
...
\begin{lemma}[Check effective]
\label{relative-cycles-lemma-check-effective}
\source{stacks:0H5T}
\href{https://stacks.math.columbia.edu/tag/0H5T}{\texttt{Stacks tag 0H5T}}
\group{relative-cycles}
...
\begin{lemma}[Effective descent]
\label{relative-cycles-lemma-effective-descent}
\source{stacks:0H5U}
\href{https://stacks.math.columbia.edu/tag/0H5U}{\texttt{Stacks tag 0H5U}}
\group{relative-cycles}
...
\begin{lemma}[Effective descent pullbacks]
\label{relative-cycles-lemma-effective-descent-pullbacks}
\source{stacks:0H5V}
\href{https://stacks.math.columbia.edu/tag/0H5V}{\texttt{Stacks tag 0H5V}}
\group{relative-cycles}
...
\begin{lemma}[Effective support closed]
\label{relative-cycles-lemma-effective-support-closed}
\source{stacks:0H5W}
\href{https://stacks.math.columbia.edu/tag/0H5W}{\texttt{Stacks tag 0H5W}}
\group{relative-cycles}
...
Lemmas \ref{relative-cycles-lemma-effective-functoriality} and \ref{relative-cycles-lemma-support-family}
...
\begin{lemma}[Effective equidimensional]
\label{relative-cycles-lemma-effective-equidimensional}
\source{stacks:0H5X}
\href{https://stacks.math.columbia.edu/tag/0H5X}{\texttt{Stacks tag 0H5X}}
\group{relative-cycles}
...
\begin{proof}
Assume $\alpha$ is effective. By Lemma \ref{relative-cycles-lemma-effective-support-closed}
...
\begin{remark}[Representable]
\label{relative-cycles-remark-representable}
\source{stacks:0H5Y}
\href{https://stacks.math.columbia.edu/tag/0H5Y}{\texttt{Stacks tag 0H5Y}}
\group{relative-cycles}
...
representable. Lemma \ref{relative-cycles-lemma-seminormalize-base} suggests
...
\begin{remark}[Equidimensional over geometrically unibranch]
\label{relative-cycles-remark-equidimensional-over-geometrically-unibranch}
\source{stacks:0H5Z}
\href{https://stacks.math.columbia.edu/tag/0H5Z}{\texttt{Stacks tag 0H5Z}}
\group{relative-cycles}
...
\source{stacks:0H61}
\href{https://stacks.math.columbia.edu/tag/0H61}{\texttt{Stacks tag 0H61}}
\group{relative-cycles}

Let $f : X \to S$ be a morphism of schemes. Assume $S$ is locally Noetherian
and $f$ is locally of finite type. Let $r \geq 0$ be an integer. We say a
relative $r$-cycle $\alpha$ on $X/S$ is a {\it proper relative cycle}
if the support of $\alpha$ (Remark \ref{relative-cycles-remark-supports-family})
...
\begin{lemma}[Proper functoriality]
\label{relative-cycles-lemma-proper-functoriality}
\source{stacks:0H62}
\href{https://stacks.math.columbia.edu/tag/0H62}{\texttt{Stacks tag 0H62}}
\group{relative-cycles}
...
\begin{lemma}[Proper h descent]
\label{relative-cycles-lemma-proper-h-descent}
\source{stacks:0H63}
\href{https://stacks.math.columbia.edu/tag/0H63}{\texttt{Stacks tag 0H63}}
\group{relative-cycles}
...
Lemma \ref{relative-cycles-lemma-proper-functoriality}. Assume each $g_i^*\alpha$
...
over $T$. By Lemma \ref{relative-cycles-lemma-support-family} we find that the support
...
(Definition \ref{relative-cycles-definition-equidimensional})
and proper (Definition \ref{relative-cycles-definition-proper}).
...
(Definition \ref{relative-cycles-definition-effective}) and proper
(Definition \ref{relative-cycles-definition-proper}).
The monoid of all proper, effective relative $r$-cycles on $X/S$ is
denoted $c^{eff}(X/S, r)$.
Observe that these are equidimensional by
Lemma \ref{relative-cycles-lemma-effective-equidimensional}.

\medskip\noindent
Thus we have the following diagram of inclusion maps
$$
\begin{array}{ccc}c^{eff}(X/S, r) \longrightarrow\downarrow & c_{equi}(X/S, r) \longrightarrow\downarrow & c(X/S, r) \downarrow \\ z^{eff}(X/S, r) \longrightarrow & z_{equi}(X/S, r) \longrightarrow & z(X/S, r)\end{array}
$$
...
\begin{lemma}[Action bilinear]
\label{relative-cycles-lemma-action-bilinear}
\source{stacks:0H66}
\href{https://stacks.math.columbia.edu/tag/0H66}{\texttt{Stacks tag 0H66}}
\group{relative-cycles}
...
\begin{lemma}[Action opens]
\label{relative-cycles-lemma-action-opens}
\source{stacks:0H67}
\href{https://stacks.math.columbia.edu/tag/0H67}{\texttt{Stacks tag 0H67}}
\group{relative-cycles}
...
\begin{lemma}[Action base change]
\label{relative-cycles-lemma-action-base-change}
\source{stacks:0H68}
\href{https://stacks.math.columbia.edu/tag/0H68}{\texttt{Stacks tag 0H68}}
\group{relative-cycles}
...
on $Y$, see Lemma \ref{relative-cycles-lemma-action-opens}. Thus we may assume $Y$
is affine. In particular $\beta$ is a finite linear combination of prime
cycles. Since $- \cap -$ is linear in the second variable
(Lemma \ref{relative-cycles-lemma-action-bilinear}), it suffices
...
that the diagram
$$
\begin{array}{cc}Z_r(V_j) \longrightarrow & Z_{r + c}(V_j \times_S S') \\ Z_0(\Spec(\kappa(y))) \longrightarrow\uparrow & Z_c(\Spec(\kappa(y)) \times_S S') \uparrow\end{array}
$$
...
\begin{lemma}[Action coherent]
\label{relative-cycles-lemma-action-coherent}
\source{stacks:0H69}
\href{https://stacks.math.columbia.edu/tag/0H69}{\texttt{Stacks tag 0H69}}
\group{relative-cycles}
...
(Example \ref{relative-cycles-example-family-associated-module}) and
...
\begin{lemma}[Action closed]
\label{relative-cycles-lemma-action-closed}
\source{stacks:0H6A}
\href{https://stacks.math.columbia.edu/tag/0H6A}{\texttt{Stacks tag 0H6A}}
\group{relative-cycles}

Let $(S, \delta)$ and $f : X \to Y$ be as above. Let $Z \subset X$
be a closed subscheme of relative dimension $\leq r$ over $Y$.
Set $\alpha = [Z/X/Y]_r$ (Example \ref{relative-cycles-example-family-associated-closed}).
...
\begin{proof}
This is a special case of Lemma \ref{relative-cycles-lemma-action-coherent}
if we take $\mathcal{F} = \mathcal{O}_Z$ and $\mathcal{F} = \mathcal{O}_W$.
\end{proof}

\begin{lemma}[Flat pullback as action]
\label{relative-cycles-lemma-flat-pullback-as-action}
\group{relative-cycles}

Let $(S, \delta)$ and $f : X \to Y$ be as above. Assume
$f$ is flat of relative dimension $e$. For $\beta \in Z_r(Y)$
we have $f^*\beta = [X/X/Y]_e \cap \beta$ in $Z_{e + r}(X)$.
\end{lemma}

\begin{proof}
It suffices to prove the equality locally on $X$. Thus we may assume
$Y$ is affine. In this case $\beta$ is a finite integer linear combination
of prime cycles. Since both sides of the equality are additive in $\beta$
we may assume $\beta = [W]$ where $W$ is an integral closed subscheme of
$Y$ of $\delta$-dimension $r$. Let $f^{-1}(W) = W \times_Y X$ be the
scheme theoretic inverse image of $W$ in $X$. By
Lemma \ref{relative-cycles-lemma-action-closed} we have
$[X/X/Y]_e \cap \beta = [W \times_Y X]_{r + e}$ and by
Chow Homology, Definition \ref{chow-definition-flat-pullback}
we have $f^*\beta = [f^{-1}(W)]_{r + e}$. Thus we have the desired
equality.
\end{proof}

\begin{lemma}[Action push pull]
\label{relative-cycles-lemma-action-push-pull}
\source{stacks:0H6B}
\href{https://stacks.math.columbia.edu/tag/0H6B}{\texttt{Stacks tag 0H6B}}
\group{relative-cycles}

Let $(S, \delta)$ be as above. Let
$$
\begin{array}{cc}X' \underset{f}{\longrightarrow}\downarrow & X \downarrow \\ Y' \overset{g}{\longrightarrow} & Y\end{array}
$$
...
Set $W = Z \times_Y X$ and $W' = Z' \times_{Y'} X'$.
Consider the cartesian squares
$$
\begin{array}{cc}W \longrightarrow\downarrow & X \downarrow \\ Z \longrightarrow & Y\end{array}
\quad
\begin{array}{cc}W' \longrightarrow\downarrow & X' \downarrow \\ Z' \longrightarrow & Y'\end{array}
\quad
\begin{array}{cc}W' \longrightarrow\downarrow & W \downarrow \\ Z' \longrightarrow & Z\end{array}
$$
...
\alpha \cap g_*\beta'
$$
as desired. The second equality is Lemma \ref{relative-cycles-lemma-action-base-change}
...
of Section \ref{relative-cycles-section-action} factors through rational equivalence
and defines a bivariant class.

\begin{lemma}[Closed in X gysin]
\label{relative-cycles-lemma-closed-in-X-gysin}
\source{stacks:0H6D}
\href{https://stacks.math.columbia.edu/tag/0H6D}{\texttt{Stacks tag 0H6D}}
\group{relative-cycles}

Let $(S, \delta)$ be as in Section \ref{relative-cycles-section-action}.
...
\begin{lemma}[Action gysin]
\label{relative-cycles-lemma-action-gysin}
\source{stacks:0H6E}
\href{https://stacks.math.columbia.edu/tag/0H6E}{\texttt{Stacks tag 0H6E}}
\group{relative-cycles}
...
$$
\begin{array}{cc}E \downarrow\underset{j}{\longrightarrow} & X \downarrow \\ D \overset{i}{\longrightarrow} & Y\end{array}
$$
See Chow Homology, Remark \ref{chow-remark-pullback-pairs}.
If $\mathcal{L}|_D \cong \mathcal{O}_D$, then for $e \in \mathbf{Z}$
the diagram
$$
\begin{array}{ccc}Z_e(D) \underset{i^*\alpha \cap -}{\longrightarrow} &  & Z_{e + r}(E) \\ Z_{e + 1}(Y) \overset{i^*}{\uparrow}\overset{\alpha \cap -}{\longrightarrow} &  & Z_{r + e + 1}(X) \underset{j^*}{\uparrow}\end{array}
$$
...
\end{align*}
Here the
first equality is Lemma \ref{relative-cycles-lemma-closed-in-X-gysin},
the second equality is Lemma \ref{relative-cycles-lemma-action-push-pull},
the third equality is the definition of $\alpha'$,
the fourth equality is the assumption that our lemma holds for
$D', i', E', j', X', \alpha'$,
the fifth equality is Lemma \ref{relative-cycles-lemma-closed-in-X-gysin}, and
the sixth equality is Lemma \ref{relative-cycles-lemma-action-push-pull}.
...
Lemma \ref{relative-cycles-lemma-action-opens} for the others.)
...
and Lemma \ref{relative-cycles-lemma-get-cycles} we may in addition assume that $\alpha$
...
is flat over $D$. Hence by Lemma \ref{relative-cycles-lemma-action-closed}
used twice we have
$$
i^*\alpha \cap i^*[W] =
...
\begin{proposition}[Get bivariant class]
\label{relative-cycles-proposition-get-bivariant-class}
\source{stacks:0H6F}
\href{https://stacks.math.columbia.edu/tag/0H6F}{\texttt{Stacks tag 0H6F}}
\group{relative-cycles}

Let $(S, \delta)$ be as in Section \ref{relative-cycles-section-action}. Let $X \to Y$
...
Lemma \ref{relative-cycles-lemma-action-gysin} and
...
and
Lemmas \ref{relative-cycles-lemma-action-push-pull}, \ref{relative-cycles-lemma-action-base-change}, and
\ref{relative-cycles-lemma-action-gysin}.
\end{proof}

\begin{remark}[Characterize relative cycles]
\label{relative-cycles-remark-characterize-relative-cycles}
\source{stacks:0H6G}
\href{https://stacks.math.columbia.edu/tag/0H6G}{\texttt{Stacks tag 0H6G}}
\group{relative-cycles}
...
Lemma \ref{relative-cycles-lemma-action-gysin}. Then we claim there is a relative $r$-cycle
...
was defined and studied in Section \ref{relative-cycles-section-action}\footnote{To be sure,
we use $s = \Spec(\kappa(s))$ as the base scheme with $\delta(s) = 0$.}.

\begin{lemma}[Construction bilinear]
\label{relative-cycles-lemma-construction-bilinear}
\source{stacks:0H6I}
\href{https://stacks.math.columbia.edu/tag/0H6I}{\texttt{Stacks tag 0H6I}}
\group{relative-cycles}
...
by Lemma \ref{relative-cycles-lemma-action-bilinear}.
\end{proof}

\begin{lemma}[Construction opens]
\label{relative-cycles-lemma-construction-opens}
\source{stacks:0H6J}
\href{https://stacks.math.columbia.edu/tag/0H6J}{\texttt{Stacks tag 0H6J}}
\group{relative-cycles}
...
Lemma \ref{relative-cycles-lemma-action-opens}.
\end{proof}

\begin{lemma}[Construction base change]
\label{relative-cycles-lemma-construction-base-change}
\source{stacks:0H6K}
\href{https://stacks.math.columbia.edu/tag/0H6K}{\texttt{Stacks tag 0H6K}}
\group{relative-cycles}
...
Hence the result follows from Lemma \ref{relative-cycles-lemma-action-base-change}
applied to $(Y_s \to Y)^*\alpha$, $\beta_s$,
$X_s \to Y_s \to s$, and base change by $s' \to s$.
\end{proof}

\begin{lemma}[Construction coherent]
\label{relative-cycles-lemma-construction-coherent}
\source{stacks:0H6L}
\href{https://stacks.math.columbia.edu/tag/0H6L}{\texttt{Stacks tag 0H6L}}
\group{relative-cycles}
...
(Example \ref{relative-cycles-example-family-associated-module}) and $\mathcal{F}$
...
follows from Lemma \ref{relative-cycles-lemma-action-coherent}.
\end{proof}

\begin{lemma}[Construction closed]
\label{relative-cycles-lemma-construction-closed}
\source{stacks:0H6M}
\href{https://stacks.math.columbia.edu/tag/0H6M}{\texttt{Stacks tag 0H6M}}
\group{relative-cycles}
...
(Example \ref{relative-cycles-example-family-associated-closed}) and $Z$ is flat over $Y$,
then $\alpha \circ \beta = [Z \times_Y W/X/S]_{r + e}$.
\end{lemma}

\begin{proof}
This is a special case of Lemma \ref{relative-cycles-lemma-construction-coherent}
if we take $\mathcal{F} = \mathcal{O}_Z$ and $\mathcal{F} = \mathcal{O}_W$.
\end{proof}

\begin{lemma}[Flat pullback as composition]
\label{relative-cycles-lemma-flat-pullback-as-composition}
\group{relative-cycles}

Let $f : X \to Y$ and $Y \to S$ be morphisms of schemes, both locally of
finite type. Assume $f$ is flat of relative dimension $e$. Let $\beta$ be
a family of $r$-cycles on the fibres of $Y/S$. Then
$f^*\beta = [X/X/Y]_e \circ \beta$
as families of $(e + r)$-cycles on $X/S$.
\end{lemma}

\begin{proof}
After unwinding the definitions and using that formation of
$[X/X/Y]_e$ is compatible with base change
(Lemma \ref{relative-cycles-lemma-family-associated-closed}) this follows from
Lemma \ref{relative-cycles-lemma-flat-pullback-as-action}.
\end{proof}

\begin{lemma}[Construction push pull]
\label{relative-cycles-lemma-construction-push-pull}
\source{stacks:0H6N}
\href{https://stacks.math.columbia.edu/tag/0H6N}{\texttt{Stacks tag 0H6N}}
\group{relative-cycles}
...
Lemma \ref{relative-cycles-lemma-action-push-pull}.
\end{proof}

\begin{lemma}[Construction composition]
\label{relative-cycles-lemma-construction-composition}
\source{stacks:0H6P}
\href{https://stacks.math.columbia.edu/tag/0H6P}{\texttt{Stacks tag 0H6P}}
\group{relative-cycles}
...
\begin{proof}
Since we are proving an equality of cycles on $X$, we may work locally
on $Z$, see Lemma \ref{relative-cycles-lemma-action-opens}. Thus we may assume $Z$
...
$$
using the construction in Section \ref{relative-cycles-section-compose-families}.
We already know the construction is bilinear
(Lemma \ref{relative-cycles-lemma-construction-bilinear})
...
\source{stacks:0H6R}
\href{https://stacks.math.columbia.edu/tag/0H6R}{\texttt{Stacks tag 0H6R}}
\group{relative-cycles}
...
\begin{proof}
The formation of $\alpha \circ \beta$ is compatible with base change
by Lemma \ref{relative-cycles-lemma-construction-base-change}. Thus we may assume
...
Lemmas \ref{relative-cycles-lemma-construction-opens} and
\ref{relative-cycles-lemma-specialization-flat-pullback}
to see that the constructions commute with restriction).
Thus we may assume $X$ and $Y$ are affine.
By Lemma \ref{relative-cycles-lemma-get-cycles}
...
on $Y/S$ (Lemma \ref{relative-cycles-lemma-relative-cycle-functoriality})
which have the same value at $\eta$ and hence are equal
(Lemma \ref{relative-cycles-lemma-uniqueness-extension}). By linearity
(Lemma \ref{relative-cycles-lemma-construction-bilinear})
...
By Lemma \ref{relative-cycles-lemma-construction-push-pull} we see that
$\alpha \circ g_*\beta' = f_*(g^*\alpha \circ \beta')$.
By Lemma \ref{relative-cycles-lemma-relative-cycle-functoriality}
it suffices to show that $g^*\alpha \circ \beta'$
is a relative $(r + e)$-cycle. Using Lemma \ref{relative-cycles-lemma-get-cycles-dvr}
...
By Lemma \ref{relative-cycles-lemma-construction-closed} we see that
$$
...
Lemma \ref{relative-cycles-lemma-family-associated-closed-specialization}.
\end{proof}

\begin{lemma}[Composition fundamental cycles]
\label{relative-cycles-lemma-composition-fundamental-cycles}
\source{stacks:0H6S}
\href{https://stacks.math.columbia.edu/tag/0H6S}{\texttt{Stacks tag 0H6S}}
\group{relative-cycles}
...
\begin{proof}
Special case of Lemma \ref{relative-cycles-lemma-construction-closed}.
\end{proof}
...
Section \ref{relative-cycles-section-action} agrees with
...
defined in Section \ref{relative-cycles-section-compose}
...
\begin{lemma}[Relative r cycle general]
\label{relative-cycles-lemma-relative-r-cycle-general}
\source{stacks:0H6W}
\href{https://stacks.math.columbia.edu/tag/0H6W}{\texttt{Stacks tag 0H6W}}
\group{relative-cycles}
...
$$
\begin{array}{cc}X \longrightarrow\downarrow & X_0 \downarrow \\ S \longrightarrow & S_0\end{array}
$$
...
By Lemma \ref{relative-cycles-lemma-get-cycles} there exists a completely decomposed proper
...
By Lemma \ref{relative-cycles-lemma-relative-cycles-equal} this is a closed subset.
...
Lemma \ref{relative-cycles-lemma-relative-r-cycle-general}, then it makes sense to
say that $\alpha$ is a {\it relative $r$-cycle on $X/S$} if
the equivalent conditions
(1) and (2) of Lemma \ref{relative-cycles-lemma-relative-r-cycle-general} hold.
...
Section \ref{relative-cycles-section-families-specialization} generalize
to this setting.
