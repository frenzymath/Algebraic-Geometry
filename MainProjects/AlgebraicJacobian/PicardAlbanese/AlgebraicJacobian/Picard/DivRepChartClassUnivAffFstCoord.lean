...
/-! # First-coordinate compatibility for the universal divisor chart -/
...
noncomputable local instance instOverCleftDivRepChartClassUnivAffFstCoord :
...
/-- The first universal window is the pullback of the first tautological pair-chart point. -/
