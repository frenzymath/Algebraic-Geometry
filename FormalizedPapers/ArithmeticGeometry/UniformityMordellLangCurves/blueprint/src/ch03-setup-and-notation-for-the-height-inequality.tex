% Source-derived chapter 03: Setup and notation for the height inequality
% Original source: uniformity-mordell-lang-curves
\chapter{Setup and notation for the height inequality}
\label{uniformity-mordell-lang-curves-chapter-03}
\source{uniformity-mordell-lang-curves}

\begin{remark}[Source section]
\label{uniformity-mordell-lang-curves-chapter-03-source}
\source{uniformity-mordell-lang-curves}
\source{uniformity-mordell-lang-curves}
...
% The source section title was: Setup and notation for the height inequality
\label{SectionSettingUpHtIneq}
\source{uniformity-mordell-lang-curves}
...
\begin{remark}
\source{uniformity-mordell-lang-curves}
\notready\label{RemarkHtcompatible}
\source{uniformity-mordell-lang-curves}
