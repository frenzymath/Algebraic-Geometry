...
`FormalizedPapers/ArithmeticGeometry/UniformityMordellLangCurves`.
...
- Source bundle: [`references/uniformity-mordell-lang-curves/`](../../../references/uniformity-mordell-lang-curves/)
