...
\source{stacks:061V}
\href{https://stacks.math.columbia.edu/tag/061V}{\texttt{Stacks tag 061V}}
\group{dga}
...
\begin{definition}[Homomorphism dga]
\label{dga-definition-homomorphism-dga}
\source{stacks:061X}
\href{https://stacks.math.columbia.edu/tag/061X}{\texttt{Stacks tag 061X}}
\group{dga}
...
\begin{definition}[Cdga]
\label{dga-definition-cdga}
\source{stacks:061W}
\href{https://stacks.math.columbia.edu/tag/061W}{\texttt{Stacks tag 061W}}
\group{dga}
...
\source{stacks:065W}
\href{https://stacks.math.columbia.edu/tag/065W}{\texttt{Stacks tag 065W}}
\group{dga}
...
\begin{lemma}[Total complex tensor product]
\label{dga-lemma-total-complex-tensor-product}
\source{stacks:065X}
\href{https://stacks.math.columbia.edu/tag/065X}{\texttt{Stacks tag 065X}}
\group{dga}
...
\begin{proof}
\uses{dga-definition-tensor-product}
...
on $A \otimes_R B$ in
Definition \ref{dga-definition-tensor-product}.
\end{proof}

\section{Differential graded modules}
\label{dga-section-modules}
Our default in this chapter is right modules;
we discuss left modules in Section \ref{dga-section-left-modules}.

\begin{definition}[Dgm]
\label{dga-definition-dgm}
\source{stacks:09JI}
\href{https://stacks.math.columbia.edu/tag/09JI}{\texttt{Stacks tag 09JI}}
\group{dga}
...
\begin{lemma}[Dgm abelian]
\label{dga-lemma-dgm-abelian}
\source{stacks:09JJ}
\href{https://stacks.math.columbia.edu/tag/09JJ}{\texttt{Stacks tag 09JJ}}
\group{dga}
...
\source{stacks:09JL}
\href{https://stacks.math.columbia.edu/tag/09JL}{\texttt{Stacks tag 09JL}}
\group{dga}
...
\source{stacks:09JN}
\href{https://stacks.math.columbia.edu/tag/09JN}{\texttt{Stacks tag 09JN}}
\group{dga}
...
\begin{lemma}[Compose homotopy]
\label{dga-lemma-compose-homotopy}
\source{stacks:09JP}
\href{https://stacks.math.columbia.edu/tag/09JP}{\texttt{Stacks tag 09JP}}
\group{dga}
...
\source{stacks:09JQ}
\href{https://stacks.math.columbia.edu/tag/09JQ}{\texttt{Stacks tag 09JQ}}
\group{dga}
...
\begin{lemma}[Homotopy direct sums]
\label{dga-lemma-homotopy-direct-sums}
\source{stacks:09JR}
\href{https://stacks.math.columbia.edu/tag/09JR}{\texttt{Stacks tag 09JR}}
\group{dga}
...
\begin{proof}
\uses{dga-lemma-dgm-abelian}

Omitted. Hint: Just use the direct sums and products as in
Lemma \ref{dga-lemma-dgm-abelian}. This works because we saw that
...
\source{stacks:09KA}
\href{https://stacks.math.columbia.edu/tag/09KA}{\texttt{Stacks tag 09KA}}
\group{dga}
...
\source{stacks:09KD}
\href{https://stacks.math.columbia.edu/tag/09KD}{\texttt{Stacks tag 09KD}}
\group{dga}

Let $(A, \text{d})$ be a differential graded algebra.
Suppose that
$$
\begin{array}{cc}K_1 \underset{f_1}{\longrightarrow}\underset{a}{\downarrow} & L_1 \overset{b}{\downarrow} \\ K_2 \overset{f_2}{\longrightarrow} & L_2\end{array}
$$
...
\begin{definition}[Admissible ses]
\label{dga-definition-admissible-ses}
\source{stacks:09JT}
\href{https://stacks.math.columbia.edu/tag/09JT}{\texttt{Stacks tag 09JT}}
\group{dga}
...
\begin{lemma}[Admissible ses]
\label{dga-lemma-admissible-ses}
\source{stacks:09JU}
\href{https://stacks.math.columbia.edu/tag/09JU}{\texttt{Stacks tag 09JU}}
\group{dga}
...
\source{stacks:09JV}
\href{https://stacks.math.columbia.edu/tag/09JV}{\texttt{Stacks tag 09JV}}
\group{dga}

Let $(A, \text{d})$ be a differential graded algebra. Let
$$
\begin{array}{cc}K \underset{f}{\longrightarrow}\underset{a}{\downarrow} & L \overset{b}{\downarrow} \\ M \overset{g}{\longrightarrow} & N\end{array}
$$
...
\source{stacks:09JW}
\href{https://stacks.math.columbia.edu/tag/09JW}{\texttt{Stacks tag 09JW}}
\group{dga}

\uses{dga-definition-admissible-ses}
Let $(A, \text{d})$ be a differential graded algebra.
Let $\alpha : K \to L$ be a homomorphism of differential graded
$A$-modules. There exists a factorization
$$
\begin{array}{ccc}K \overset{\tilde \alpha}{\longrightarrow}\underset{\alpha}{\longrightarrow} & \tilde L \overset{\pi}{\longrightarrow} & L\end{array}
$$
in $\text{Mod}_{(A, \text{d})}$ such that
\begin{enumerate}
\item $\tilde \alpha$ is an admissible monomorphism (see
Definition \ref{dga-definition-admissible-ses}),
...
\source{stacks:09JX}
\href{https://stacks.math.columbia.edu/tag/09JX}{\texttt{Stacks tag 09JX}}
\group{dga}
...
$$
\begin{array}{cccc}L_1 \longrightarrow & L_2 \longrightarrow & \ldots \longrightarrow & L_n \\ M_1 \longrightarrow\uparrow & M_2 \longrightarrow\uparrow & \ldots \longrightarrow & M_n \uparrow\end{array}
$$
...
\begin{proof}
\uses{dga-lemma-make-injective}

The case $n = 1$ is without content.
Lemma \ref{dga-lemma-make-injective} is the case $n = 2$.
Suppose we have constructed the diagram
except for $M_n$. Apply Lemma \ref{dga-lemma-make-injective} to
...
\source{stacks:09JY}
\href{https://stacks.math.columbia.edu/tag/09JY}{\texttt{Stacks tag 09JY}}
\group{dga}
...
$$
\vcenter{
\begin{array}{ccc}K_1 \underset{0}{\downarrow}\longrightarrow & L_1 \longrightarrow\underset{b}{\downarrow} & M_1 \underset{0}{\downarrow} \\ K_2 \longrightarrow & L_2 \longrightarrow & M_2\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{ccc}K_2 \overset{0}{\downarrow}\longrightarrow & L_2 \longrightarrow\overset{b'}{\downarrow} & M_2 \overset{0}{\downarrow} \\ K_3 \longrightarrow & L_3 \longrightarrow & M_3\end{array}
}
$$
...
\begin{proof}
\uses{dga-lemma-make-commute-map}

By Lemma \ref{dga-lemma-make-commute-map} we can replace $b$ and $b'$ by
...
\source{stacks:09K6}
\href{https://stacks.math.columbia.edu/tag/09K6}{\texttt{Stacks tag 09K6}}
\group{dga}

\uses{dga-lemma-admissible-ses}
Let $(A, \text{d})$ be a differential graded algebra. Let
...
\end{equation}
with $\delta$ as in Lemma \ref{dga-lemma-admissible-ses} is, up to canonical
isomorphism in $K(\text{Mod}_{(A, \text{d})})$, independent of the choices
made in Lemma \ref{dga-lemma-admissible-ses}.
\end{lemma}
...
Lemma \ref{dga-lemma-admissible-ses}. Then we claim that $\delta$ and $\delta'$
...
\source{stacks:09K8}
\href{https://stacks.math.columbia.edu/tag/09K8}{\texttt{Stacks tag 09K8}}
\group{dga}
...
\source{stacks:09KB}
\href{https://stacks.math.columbia.edu/tag/09KB}{\texttt{Stacks tag 09KB}}
\group{dga}
...
\source{stacks:09KC}
\href{https://stacks.math.columbia.edu/tag/09KC}{\texttt{Stacks tag 09KC}}
\group{dga}
...
\source{stacks:09KE}
\href{https://stacks.math.columbia.edu/tag/09KE}{\texttt{Stacks tag 09KE}}
\group{dga}
...
\begin{proof}
\uses{dga-lemma-functorial-cone, dga-lemma-nilpotent}
...
Lemma \ref{dga-lemma-functorial-cone} applied to
...
$$
\begin{array}{ccc}L \longrightarrow\underset{1}{\downarrow} & C(f) \longrightarrow\underset{c}{\downarrow} & K[1] \underset{1}{\downarrow} \\ L \longrightarrow & C(f) \longrightarrow & K[1]\end{array}
$$
...
\source{stacks:09KF}
\href{https://stacks.math.columbia.edu/tag/09KF}{\texttt{Stacks tag 09KF}}
\group{dga}
...
$$
\begin{array}{cccc}K \longrightarrow\downarrow & L \downarrow\longrightarrow & C(\alpha) \underset{-p}{\longrightarrow}\downarrow & K[1] \downarrow \\ K \overset{\alpha}{\longrightarrow} & L \overset{\beta}{\longrightarrow} & M \overset{\delta}{\longrightarrow} & K[1]\end{array}
$$
...
$$
\begin{array}{cccc}K \longrightarrow\downarrow & \tilde L \downarrow\longrightarrow & M \underset{\delta}{\longrightarrow}\downarrow & K[1] \downarrow \\ K \longrightarrow & L \longrightarrow & C(f) \overset{-p}{\longrightarrow} & K[1]\end{array}
$$
...
\begin{proof}
\uses{dga-definition-cone, dga-lemma-make-injective, dga-lemma-functorial-cone, dga-lemma-third-isomorphism}
...
$-p : C(\alpha) \to K[1]$ (see
Definition \ref{dga-definition-cone})
...
Lemma \ref{dga-lemma-make-injective}. By
Lemmas \ref{dga-lemma-functorial-cone} and \ref{dga-lemma-third-isomorphism}
...
\begin{lemma}[Homotopy category pre triangulated]
\label{dga-lemma-homotopy-category-pre-triangulated}
\source{stacks:09KH}
\href{https://stacks.math.columbia.edu/tag/09KH}{\texttt{Stacks tag 09KH}}
\group{dga}
...
\begin{proof}
\uses{dga-lemma-the-same-up-to-isomorphisms, dga-lemma-rotate-triangle, dga-lemma-rotate-cone, dga-lemma-functorial-cone}
...
Lemma \ref{dga-lemma-the-same-up-to-isomorphisms}.
...
$(M[-1], K, L, -\delta[-1], \alpha, \beta)$.
It follows from Lemma \ref{dga-lemma-rotate-triangle} that the triangle
$(M[-1], K, L, \delta[-1], \alpha, \beta)$
is isomorphic to
$(M[-1], K, C(\delta[-1]), \delta[-1], i, p)$.
...
By Lemma \ref{dga-lemma-the-same-up-to-isomorphisms} this means that it is
...
$(L, C(f), K[1], i, p, f[1])$.
By Lemma \ref{dga-lemma-rotate-cone} this triangle is distinguished.
...
Lemma \ref{dga-lemma-the-same-up-to-isomorphisms} we may assume that
$(X, Y, Z, f, g, h) = (X, Y, C(f), f, i, -p)$ and
$(X', Y', Z', f', g', h') = (X', Y', C(f'), f', i', -p')$.
At this point we simply apply Lemma \ref{dga-lemma-functorial-cone}
...
\source{stacks:09KI}
\href{https://stacks.math.columbia.edu/tag/09KI}{\texttt{Stacks tag 09KI}}
\group{dga}
...
\source{stacks:09KJ}
\href{https://stacks.math.columbia.edu/tag/09KJ}{\texttt{Stacks tag 09KJ}}
\group{dga}
...
\begin{proof}
\uses{dga-lemma-sequence-maps-split, dga-lemma-two-split-injections}
...
Lemma \ref{dga-lemma-sequence-maps-split} we may assume that
$K \to L$ and $L \to M$ are admissible monomorphisms.
In this case the result follows from
Lemma \ref{dga-lemma-two-split-injections}.
\end{proof}
...
\begin{definition}[Opposite dga]
\label{dga-definition-opposite-dga}
\source{stacks:09JG}
\href{https://stacks.math.columbia.edu/tag/09JG}{\texttt{Stacks tag 09JG}}
\group{dga}
...
$$
\begin{array}{cccc}\text{Tot}(A^\bullet \otimes_R A^\bullet)
\underset{\text{multiplication of }A^{opp}}{\longrightarrow}\underset{\text{commutativity constraint}}{\downarrow} &  &  & A^\bullet \overset{\text{id}}{\downarrow} \\ \text{Tot}(A^\bullet \otimes_R A^\bullet)
\overset{\text{multiplication of }A}{\longrightarrow} &  &  & A^\bullet\end{array}
$$
...
$$
\begin{array}{cccc}\text{Tot}(M^\bullet \otimes_R A^\bullet)
\underset{\text{multiplication on }M^{opp}}{\longrightarrow}\underset{\text{commutativity constraint}}{\downarrow} &  &  & M^\bullet \overset{\text{id}}{\downarrow} \\ \text{Tot}(A^\bullet \otimes_R M^\bullet)
\overset{\text{multiplication on }M}{\longrightarrow} &  &  & M^\bullet\end{array}
$$
...
\begin{lemma}[Left right]
\label{dga-lemma-left-right}
\source{stacks:0FQ0}
\href{https://stacks.math.columbia.edu/tag/0FQ0}{\texttt{Stacks tag 0FQ0}}
\group{dga}
...
of Lemma \ref{dga-lemma-left-right} is compatible with shift functors.

\medskip\noindent
Our choice above necessitates the following definition.

\begin{definition}[Shift graded module]
\label{dga-definition-shift-graded-module}
\source{stacks:0FQ1}
\href{https://stacks.math.columbia.edu/tag/0FQ1}{\texttt{Stacks tag 0FQ1}}
\group{dga}
...
Proposition \ref{dga-proposition-homotopy-category-triangulated}
...
Section \ref{dga-section-conventions}). Given a right $A$-module $M$
...
\begin{lemma}[Left module structure]
\label{dga-lemma-left-module-structure}
\source{stacks:0FQ3}
\href{https://stacks.math.columbia.edu/tag/0FQ3}{\texttt{Stacks tag 0FQ3}}
\group{dga}
...
Lemma \ref{dga-lemma-left-module-structure} we
...
\begin{lemma}[Characterize hom]
\label{dga-lemma-characterize-hom}
\source{stacks:0FQ4}
\href{https://stacks.math.columbia.edu/tag/0FQ4}{\texttt{Stacks tag 0FQ4}}
\group{dga}
...
as in Section \ref{dga-section-tensor-product}.
\end{lemma}
...
hand side in Section \ref{dga-section-tensor-product}. Given an element
...
expect from the discussion in Section \ref{dga-section-left-modules}.
Namely, we have
$$
...
\begin{lemma}[Right module structure]
\label{dga-lemma-right-module-structure}
\source{stacks:0FQ5}
\href{https://stacks.math.columbia.edu/tag/0FQ5}{\texttt{Stacks tag 0FQ5}}
\group{dga}
...
\begin{lemma}[Characterize hom other side]
\label{dga-lemma-characterize-hom-other-side}
\source{stacks:0FQ6}
\href{https://stacks.math.columbia.edu/tag/0FQ6}{\texttt{Stacks tag 0FQ6}}
\group{dga}
...
\begin{remark}[Evaluation map left]
\label{dga-remark-evaluation-map-left}
\source{stacks:0FQ7}
\href{https://stacks.math.columbia.edu/tag/0FQ7}{\texttt{Stacks tag 0FQ7}}
\group{dga}

\uses{dga-lemma-characterize-hom}
...
Lemma \ref{dga-lemma-characterize-hom} it suffices to construct an
$A$-bilinear pairing
$$
...
\begin{remark}[Evaluation map right]
\label{dga-remark-evaluation-map-right}
\source{stacks:0FQ8}
\href{https://stacks.math.columbia.edu/tag/0FQ8}{\texttt{Stacks tag 0FQ8}}
\group{dga}
...
\begin{remark}[Shift dual]
\label{dga-remark-shift-dual}
\source{stacks:0FQ9}
\href{https://stacks.math.columbia.edu/tag/0FQ9}{\texttt{Stacks tag 0FQ9}}
\group{dga}

\uses{dga-definition-shift-graded-module}
Let $R$ be a ring. Let $A$ be a differential graded $R$-algebra.
...
Definition \ref{dga-definition-shift-graded-module}.
\end{remark}
...
Section \ref{dga-section-conventions} for our conventions.
...
Section \ref{dga-section-projectives-over-graded-algebras}.

\begin{lemma}[Target graded projective]
\label{dga-lemma-target-graded-projective}
\source{stacks:09K0}
\href{https://stacks.math.columbia.edu/tag/09K0}{\texttt{Stacks tag 09K0}}
\group{dga}
...
\begin{lemma}[Hom from shift free]
\label{dga-lemma-hom-from-shift-free}
\source{stacks:09K1}
\href{https://stacks.math.columbia.edu/tag/09K1}{\texttt{Stacks tag 09K1}}
\group{dga}
...
$R$-algebra, see Section \ref{dga-section-conventions} for our conventions.
...
f \mapsto f \circ a
$$
as in Section \ref{dga-section-hom-complexes}.
...
$$
as in Section \ref{dga-section-hom-complexes} (the sign is forced on
...
Remarks \ref{dga-remark-evaluation-map-left} and \ref{dga-remark-evaluation-map-right}.
...
of right, resp.\ left $A$-modules. See Remark \ref{dga-remark-shift-dual}.
...
(N^0)^\vee
$$
by Lemma \ref{dga-lemma-characterize-hom}
...
that $I$ is an injective object of the abelian category $\text{Mod}_A$
of graded $A$-modules.

\begin{lemma}[Source graded injective]
\label{dga-lemma-source-graded-injective}
\source{stacks:09K2}
\href{https://stacks.math.columbia.edu/tag/09K2}{\texttt{Stacks tag 09K2}}
\group{dga}
...
Section \ref{dga-section-modules-noncommutative-graded} is a
right, resp.\ left differential graded $A$-module by the
discussion in Section \ref{dga-section-hom-complexes}.
By Remarks
\ref{dga-remark-evaluation-map-left} and \ref{dga-remark-evaluation-map-right}
there evaluation map of Section \ref{dga-section-modules-noncommutative-graded}
$$
M \longrightarrow (M^\vee)^\vee
$$
is a homomorphism of left, resp.\ right differential graded $A$-modules

\begin{lemma}[Map into dual]
\label{dga-lemma-map-into-dual}
\source{stacks:09K3}
\href{https://stacks.math.columbia.edu/tag/09K3}{\texttt{Stacks tag 09K3}}
\group{dga}
...
The first equality is Lemma \ref{dga-lemma-characterize-hom}
and the second equality was shown in Section \ref{dga-section-tensor-product}.
\end{proof}

\begin{lemma}[Hom into shift dual free]
\label{dga-lemma-hom-into-shift-dual-free}
\source{stacks:09K4}
\href{https://stacks.math.columbia.edu/tag/09K4}{\texttt{Stacks tag 09K4}}
\group{dga}
...
Lemma \ref{dga-lemma-target-graded-projective}. Moreover, the reader
can verify that as a graded $A$-module $P$ will be isomorphic to a
direct sum of shifts of $A$.

\begin{lemma}[Property P sequence]
\label{dga-lemma-property-P-sequence}
\source{stacks:09KL}
\href{https://stacks.math.columbia.edu/tag/09KL}{\texttt{Stacks tag 09KL}}
\group{dga}
...
\begin{lemma}[Property P K projective]
\label{dga-lemma-property-P-K-projective}
\source{stacks:09KM}
\href{https://stacks.math.columbia.edu/tag/09KM}{\texttt{Stacks tag 09KM}}
\group{dga}
...
\begin{proof}
\uses{dga-proposition-homotopy-category-triangulated, dga-lemma-property-P-sequence, dga-lemma-hom-from-shift-free}

We will use that $K(\text{Mod}_{(A, \text{d})})$ is a triangulated
category (Proposition \ref{dga-proposition-homotopy-category-triangulated}).
Let $F_\bullet$ be a filtration on $P$ as in property (P).
The short exact sequence of Lemma \ref{dga-lemma-property-P-sequence}
...
This follows from Lemma \ref{dga-lemma-hom-from-shift-free}.
\end{proof}

\begin{lemma}[Good quotient]
\label{dga-lemma-good-quotient}
\source{stacks:09KN}
\href{https://stacks.math.columbia.edu/tag/09KN}{\texttt{Stacks tag 09KN}}
\group{dga}
...
\source{stacks:09KP}
\href{https://stacks.math.columbia.edu/tag/09KP}{\texttt{Stacks tag 09KP}}
\group{dga}
...
\begin{proof}
\uses{dga-lemma-good-quotient, dga-lemma-target-graded-projective}

Set $M = M_0$. We inductively choose short exact sequences
$$
0 \to M_{i + 1} \to P_i \to M_i \to 0
$$
where the maps $P_i \to M_i$ are chosen as in Lemma \ref{dga-lemma-good-quotient}.
...
Lemma \ref{dga-lemma-target-graded-projective} we see that
...
in Section \ref{dga-section-modules-noncommutative-differential-graded}.
\end{enumerate}
In fact, condition (2) is a consequence of condition (3), see
Lemma \ref{dga-lemma-source-graded-injective}. The reader can verify that as
a graded module $I$ will be isomorphic to a product of $A^\vee[k]$.

\begin{lemma}[Property I sequence]
\label{dga-lemma-property-I-sequence}
\source{stacks:09KR}
\href{https://stacks.math.columbia.edu/tag/09KR}{\texttt{Stacks tag 09KR}}
\group{dga}
...
\begin{proof}
\uses{dga-lemma-property-P-sequence}

Omitted. Hint: This is dual to Lemma \ref{dga-lemma-property-P-sequence}.
\end{proof}
...
\begin{lemma}[Property I K injective]
\label{dga-lemma-property-I-K-injective}
\source{stacks:09KS}
\href{https://stacks.math.columbia.edu/tag/09KS}{\texttt{Stacks tag 09KS}}
\group{dga}
...
\begin{proof}
\uses{dga-proposition-homotopy-category-triangulated, dga-lemma-property-I-sequence, dga-lemma-hom-into-shift-dual-free}

We will use that $K(\text{Mod}_{(A, \text{d})})$ is a triangulated
category (Proposition \ref{dga-proposition-homotopy-category-triangulated}).
Let $F_\bullet$ be a filtration on $I$ as in property (I).
The short exact sequence of Lemma \ref{dga-lemma-property-I-sequence}
produces a distinguished triangle. Hence by
Derived Categories, Lemma \ref{derived-lemma-representable-homological}
it suffices to show that
$$
...
$$
for all acyclic differential graded $A$-modules $N$ and all $k$.
This follows from Lemma \ref{dga-lemma-hom-into-shift-dual-free}
and the fact that $(-)^\vee$ is an exact functor.
\end{proof}

\begin{lemma}[Good sub]
\label{dga-lemma-good-sub}
\source{stacks:09KT}
\href{https://stacks.math.columbia.edu/tag/09KT}{\texttt{Stacks tag 09KT}}
\group{dga}
...
\begin{proof}
\uses{dga-lemma-good-quotient, dga-lemma-hom-into-shift-dual-free}
...
Section \ref{dga-section-modules-noncommutative-differential-graded}
...
Lemma \ref{dga-lemma-good-quotient} we find a surjection
$$
...
Lemma \ref{dga-lemma-hom-into-shift-dual-free}
...
\begin{lemma}[Right resolution]
\label{dga-lemma-right-resolution}
\source{stacks:09KU}
\href{https://stacks.math.columbia.edu/tag/09KU}{\texttt{Stacks tag 09KU}}
\group{dga}
...
\begin{proof}
\uses{dga-lemma-good-sub, dga-lemma-source-graded-injective}

Set $M = M_0$. We inductively choose short exact sequences
$$
0 \to M_i \to I_i \to M_{i + 1} \to 0
$$
where the maps $M_i \to I_i$ are chosen as in Lemma \ref{dga-lemma-good-sub}.
This gives a ``resolution''
$$
...
Lemma \ref{dga-lemma-source-graded-injective} we see that
...
(see Section \ref{dga-section-modules}).

\begin{lemma}[Acyclic]
\label{dga-lemma-acyclic}
\source{stacks:09KW}
\href{https://stacks.math.columbia.edu/tag/09KW}{\texttt{Stacks tag 09KW}}
\group{dga}
...
\begin{proof}
\uses{dga-proposition-homotopy-category-triangulated, dga-lemma-resolve}
...
the proof of Proposition \ref{dga-proposition-homotopy-category-triangulated}
...
(the construction of a P-resolution in the proof of Lemma \ref{dga-lemma-resolve}
...
\source{stacks:09KX}
\href{https://stacks.math.columbia.edu/tag/09KX}{\texttt{Stacks tag 09KX}}
\group{dga}

\uses{dga-lemma-acyclic}
Let $(A, \text{d})$ be a differential graded algebra.
Let $\text{Ac}$ and $\text{Qis}$ be as in Lemma \ref{dga-lemma-acyclic}.
...
\begin{lemma}[Hom derived]
\label{dga-lemma-hom-derived}
\source{stacks:09KY}
\href{https://stacks.math.columbia.edu/tag/09KY}{\texttt{Stacks tag 09KY}}
\group{dga}

\uses{dga-lemma-resolve, dga-lemma-right-resolution}
Let $(A, \text{d})$ be a differential graded algebra.
Let $M$ and $N$ be differential graded $A$-modules.
\begin{enumerate}
\item Let $P \to M$ be a P-resolution as in
Lemma \ref{dga-lemma-resolve}. Then
$$
\Hom_{D(A, \text{d})}(M, N) =
\Hom_{K(\text{Mod}_{(A, \text{d})})}(P, N)
$$
\item Let $N \to I$ be an I-resolution as in
Lemma \ref{dga-lemma-right-resolution}. Then
$$
\Hom_{D(A, \text{d})}(M, N) =
...
\begin{proof}
\uses{dga-lemma-property-P-K-projective, dga-lemma-property-I-K-injective}
...
Lemma \ref{dga-lemma-property-P-K-projective}. Since
...
Lemma \ref{dga-lemma-property-I-K-injective} in stead of
Lemma \ref{dga-lemma-property-P-K-projective}.
\end{proof}

\begin{lemma}[Derived products]
\label{dga-lemma-derived-products}
\source{stacks:09QI}
\href{https://stacks.math.columbia.edu/tag/09QI}{\texttt{Stacks tag 09QI}}
\group{dga}
...
\begin{proof}
\uses{dga-lemma-dgm-abelian, dga-lemma-homotopy-direct-sums, dga-lemma-right-resolution, dga-lemma-hom-derived, dga-lemma-resolve}
...
See Lemmas \ref{dga-lemma-dgm-abelian} and \ref{dga-lemma-homotopy-direct-sums}.
...
See Lemma \ref{dga-lemma-right-resolution}.
Using Lemma \ref{dga-lemma-hom-derived} we have
\begin{align*}
\Hom_{D(A, \text{d})}(M, N)
& =
\Hom_{K(A, \text{d})}(M, I) \\
...
See Lemma \ref{dga-lemma-resolve}.
Using Lemma \ref{dga-lemma-hom-derived} we have
\begin{align*}
\Hom_{D(A, \text{d})}(N, M)
& =
...
\begin{remark}[P resolution]
\label{dga-remark-P-resolution}
\source{stacks:0FQE}
\href{https://stacks.math.columbia.edu/tag/0FQE}{\texttt{Stacks tag 0FQE}}
\group{dga}

\uses{dga-lemma-property-P-sequence, dga-lemma-resolve}
Let $R$ be a ring. Let $(A, \text{d})$ be a differential graded $R$-algebra.
...
Lemmas \ref{dga-lemma-property-P-sequence} and \ref{dga-lemma-resolve}.
\end{remark}
...
\source{stacks:09L0}
\href{https://stacks.math.columbia.edu/tag/09L0}{\texttt{Stacks tag 09L0}}
\group{dga}
...
\begin{proof}
\uses{dga-lemma-functorial-cone}
...
This follows from Lemma \ref{dga-lemma-functorial-cone} with a bit of
work. Compare with
Derived Categories, Lemma \ref{derived-lemma-derived-canonical-delta-functor}.
\end{proof}

\begin{lemma}[Homotopy colimit]
\label{dga-lemma-homotopy-colimit}
\source{stacks:0CRL}
\href{https://stacks.math.columbia.edu/tag/0CRL}{\texttt{Stacks tag 0CRL}}
\group{dga}
...
\begin{proof}
\uses{dga-lemma-derived-products, dga-lemma-derived-canonical-delta-functor}
...
(Lemma \ref{dga-lemma-derived-canonical-delta-functor}).
\end{proof}
...
\source{stacks:09MJ}
\href{https://stacks.math.columbia.edu/tag/09MJ}{\texttt{Stacks tag 09MJ}}
\group{dga}
...
\begin{definition}[Functor linear categories]
\label{dga-definition-functor-linear-categories}
\source{stacks:09MK}
\href{https://stacks.math.columbia.edu/tag/09MK}{\texttt{Stacks tag 09MK}}
\group{dga}
...
\source{stacks:09L2}
\href{https://stacks.math.columbia.edu/tag/09L2}{\texttt{Stacks tag 09L2}}
\group{dga}
...
\begin{definition}[Functor graded categories]
\label{dga-definition-functor-graded-categories}
\source{stacks:09L3}
\href{https://stacks.math.columbia.edu/tag/09L3}{\texttt{Stacks tag 09L3}}
\group{dga}
...
\begin{definition}[H0 of graded category]
\label{dga-definition-H0-of-graded-category}
\source{stacks:09ML}
\href{https://stacks.math.columbia.edu/tag/09ML}{\texttt{Stacks tag 09ML}}
\group{dga}
...
\begin{definition}[Graded direct sum]
\label{dga-definition-graded-direct-sum}
\source{stacks:09P2}
\href{https://stacks.math.columbia.edu/tag/09P2}{\texttt{Stacks tag 09P2}}
\group{dga}
...
\source{stacks:09MM}
\href{https://stacks.math.columbia.edu/tag/09MM}{\texttt{Stacks tag 09MM}}
\group{dga}
...
\source{stacks:09MN}
\href{https://stacks.math.columbia.edu/tag/09MN}{\texttt{Stacks tag 09MN}}
\group{dga}
...
Section \ref{dga-section-projectives-over-algebras}). Given graded
...
\begin{remark}[Graded shift functors]
\label{dga-remark-graded-shift-functors}
\source{stacks:09P3}
\href{https://stacks.math.columbia.edu/tag/09P3}{\texttt{Stacks tag 09P3}}
\group{dga}

\uses{dga-definition-H0-of-graded-category, dga-example-graded-category-graded-objects, dga-example-gm-gr-cat}
...
(see Definition \ref{dga-definition-H0-of-graded-category}). Moreover, the graded
...
Example \ref{dga-example-graded-category-graded-objects}.
\item If $A$ is a graded ring and $\mathcal{D} = \text{Mod}_A$
is the category of graded right $A$-modules, then
$\mathcal{A} = \text{Mod}^{gr}_A$, see Example \ref{dga-example-gm-gr-cat}.
\end{enumerate}
\end{remark}
...
\begin{definition}[Dga category]
\label{dga-definition-dga-category}
\source{stacks:09L5}
\href{https://stacks.math.columbia.edu/tag/09L5}{\texttt{Stacks tag 09L5}}
\group{dga}
...
\begin{definition}[Functor dga categories]
\label{dga-definition-functor-dga-categories}
\source{stacks:09L6}
\href{https://stacks.math.columbia.edu/tag/09L6}{\texttt{Stacks tag 09L6}}
\group{dga}
...
\begin{definition}[Homotopy category of dga category]
\label{dga-definition-homotopy-category-of-dga-category}
\source{stacks:09L7}
\href{https://stacks.math.columbia.edu/tag/09L7}{\texttt{Stacks tag 09L7}}
\group{dga}
...
\begin{definition}[Dg direct sum]
\label{dga-definition-dg-direct-sum}
\source{stacks:09P4}
\href{https://stacks.math.columbia.edu/tag/09P4}{\texttt{Stacks tag 09P4}}
\group{dga}
...
\begin{lemma}[Functorial]
\label{dga-lemma-functorial}
\source{stacks:09L8}
\href{https://stacks.math.columbia.edu/tag/09L8}{\texttt{Stacks tag 09L8}}
\group{dga}
...
\source{stacks:09L9}
\href{https://stacks.math.columbia.edu/tag/09L9}{\texttt{Stacks tag 09L9}}
\group{dga}

\uses{dga-example-graded-category-graded-objects, dga-definition-dga-category}
...
in Example \ref{dga-example-graded-category-graded-objects}.
...
$$
as required in Definition \ref{dga-definition-dga-category}
because
\begin{align*}
\text{d}(g \circ f) & =
...
\begin{lemma}[Additive functor induces dga functor]
\label{dga-lemma-additive-functor-induces-dga-functor}
\source{stacks:09LB}
\href{https://stacks.math.columbia.edu/tag/09LB}{\texttt{Stacks tag 09LB}}
\group{dga}

\uses{dga-example-category-complexes}
...
$$
of Example \ref{dga-example-category-complexes}
...
\source{stacks:09LC}
\href{https://stacks.math.columbia.edu/tag/09LC}{\texttt{Stacks tag 09LC}}
\group{dga}

\uses{dga-example-gm-gr-cat, dga-example-category-complexes, dga-definition-dga-category}
...
Example \ref{dga-example-gm-gr-cat}. In other words, the $n$th graded piece
...
to those of Example \ref{dga-example-category-complexes} hold for the
differential of $f$ in terms of components.
The reader checks (in the same way as in
Example \ref{dga-example-category-complexes}) that
\begin{enumerate}
\item $\text{d}$ has square zero,
...
$$
as required in
Definition \ref{dga-definition-dga-category}
because
\begin{align*}
\text{d}(g \circ f) & =
...
\begin{lemma}[Homomorphism induces dga functor]
\label{dga-lemma-homomorphism-induces-dga-functor}
\source{stacks:09LD}
\href{https://stacks.math.columbia.edu/tag/09LD}{\texttt{Stacks tag 09LD}}
\group{dga}

\uses{dga-example-dgm-dg-cat}
...
$$
of Example \ref{dga-example-dgm-dg-cat} inducing obvious restriction functors
...
\source{stacks:09LE}
\href{https://stacks.math.columbia.edu/tag/09LE}{\texttt{Stacks tag 09LE}}
\group{dga}

\uses{dga-lemma-functorial}
Let $R$ be a ring. Let $\mathcal{A}$ be a differential graded category
...
$$
by an application of Lemma \ref{dga-lemma-functorial}.
\end{lemma}
...
Proposition \ref{dga-proposition-homotopy-category-triangulated} apply.
...
(as in Definition \ref{dga-definition-dg-direct-sum}).
...
\begin{lemma}[Get triangle]
\label{dga-lemma-get-triangle}
\source{stacks:09P6}
\href{https://stacks.math.columbia.edu/tag/09P6}{\texttt{Stacks tag 09P6}}
\group{dga}
...
Choose a diagram
$$
\begin{array}{ccc}x \underset{1}{\longrightarrow}\underset{a}{\searrow} &  & x \\  & y \underset{\pi}{\nearrow}\overset{b}{\searrow} &  \\ z \overset{1}{\longrightarrow}\overset{s}{\nearrow} &  & z\end{array}
$$
...
\begin{definition}[Situation: ABC]
\label{dga-situation-ABC}
\source{stacks:09QJ}
\href{https://stacks.math.columbia.edu/tag/09QJ}{\texttt{Stacks tag 09QJ}}
\group{dga}

\uses{dga-lemma-get-triangle}
...
$x[1] \to y[1]$ of Lemma \ref{dga-lemma-get-triangle} is equal to $f[1]$.
\end{enumerate}
\end{definition}
...
\begin{lemma}[The homotopy category is a triangulated category. This lemma proves a part of the axiom...]
\label{dga-lemma-cone}
\source{stacks:09P7}
\href{https://stacks.math.columbia.edu/tag/09P7}{\texttt{Stacks tag 09P7}}
\group{dga}


\uses{dga-situation-ABC}
In Situation \ref{dga-situation-ABC} suppose that
$$
\begin{array}{cc}x_1 \underset{f_1}{\longrightarrow}\underset{a}{\downarrow} & y_1 \overset{b}{\downarrow} \\ x_2 \overset{f_2}{\longrightarrow} & y_2\end{array}
$$
...
equalities found in the proof of Lemma \ref{dga-lemma-get-triangle}
we obtain
\begin{align*}
\text{d}(c)
& =
...
In Situation \ref{dga-situation-ABC} we say that a triangle
...
constructed in Lemma \ref{dga-lemma-get-triangle}. We will show below that
$$
\boxed{
...
\begin{lemma}[Id cone null]
\label{dga-lemma-id-cone-null}
\source{stacks:09QK}
\href{https://stacks.math.columbia.edu/tag/09QK}{\texttt{Stacks tag 09QK}}
\group{dga}

\uses{dga-situation-ABC}
In Situation \ref{dga-situation-ABC}
...
$$
\begin{array}{ccc}x \overset{a}{\longrightarrow} & C(1_x) \overset{\pi}{\longleftarrow}\overset{b}{\longrightarrow} & x[1]\overset{s}{\longleftarrow}\end{array}
$$
Then by Lemma \ref{dga-lemma-get-triangle}, identifying hom-sets under
shifting, we have $1_x=\pi d(s)=-d(\pi)s$ where $s$ is regarded as
a morphism in $\Hom_{\mathcal{A}}^{-1}(x,C(1_x))$. Therefore
$a=a\pi d(s)=d(s)$ using formula (5) of Lemma \ref{dga-lemma-get-triangle},
and $b=-d(\pi)sb=-d(\pi)$ by formula (6) of Lemma \ref{dga-lemma-get-triangle}.
Hence
$$
...
Lemma \ref{dga-lemma-cone-homotopy}. The following lemma is the
analogue of Lemma \ref{dga-lemma-make-commute-map}.

\begin{lemma}[Homo change]
\label{dga-lemma-homo-change}
\source{stacks:09QL}
\href{https://stacks.math.columbia.edu/tag/09QL}{\texttt{Stacks tag 09QL}}
\group{dga}

\uses{dga-situation-ABC}
In Situation \ref{dga-situation-ABC} given a diagram
$$
\begin{array}{cc}x\overset{f}{\longrightarrow}\underset{a}{\downarrow} & y\overset{b}{\downarrow} \\ z\overset{g}{\longrightarrow} & w\end{array}
$$
...
The following lemma is the analogue of Lemma \ref{dga-lemma-make-injective}.

\begin{lemma}[Factor]
\label{dga-lemma-factor}
\source{stacks:09QM}
\href{https://stacks.math.columbia.edu/tag/09QM}{\texttt{Stacks tag 09QM}}
\group{dga}

\uses{dga-situation-ABC}
In Situation \ref{dga-situation-ABC} let $\alpha : x \to y$
be a morphism in $\text{Comp}(\mathcal{A})$. Then there exists
a factorization in $\text{Comp}(\mathcal{A})$:
$$
\begin{array}{ccc}x \overset{\tilde{\alpha}}{\longrightarrow} & \tilde{y} \overset{\pi}{\longrightarrow} & y\overset{s}{\longleftarrow}\end{array}
$$
such that
\begin{enumerate}
...
\begin{proof}
\uses{dga-lemma-id-cone-null}

By axiom (A), we may let $\tilde{y}$ be the differential graded direct
sum of $y$ and $C(1_x)$, i.e., there exists a diagram
$$
\begin{array}{ccc}y \overset{s}{\longrightarrow} & y\oplus C(1_x) \overset{\pi}{\longleftarrow}\overset{p}{\longrightarrow} & C(1_x)\overset{t}{\longleftarrow}\end{array}
$$
...
$$
\begin{array}{ccc}x \longrightarrow & C(1_x) \longleftarrow\longrightarrow & x[1]\longleftarrow\end{array}
$$
...
exact sequence
$$
\begin{array}{ccc}x\overset{\tilde{\alpha}}{\longrightarrow} & \tilde{y} \longrightarrow & x[1]\end{array}
$$
...
The following lemma is the analogue of Lemma \ref{dga-lemma-sequence-maps-split}.

\begin{lemma}[Analogue sequence maps split]
\label{dga-lemma-analogue-sequence-maps-split}
\source{stacks:09QN}
\href{https://stacks.math.columbia.edu/tag/09QN}{\texttt{Stacks tag 09QN}}
\group{dga}
...
$$
\begin{array}{cccc}x_1\longrightarrow & x_2\longrightarrow & \ldots\longrightarrow & x_n \\ y_1\longrightarrow\uparrow & y_2\longrightarrow\uparrow & \ldots\longrightarrow & y_n\uparrow\end{array}
$$
...
The case $n = 2$ is given by Lemma \ref{dga-lemma-factor}. Suppose we have
constructed the diagram up to $x_{n - 1}$. We apply
Lemma \ref{dga-lemma-factor} to the composition
...
The following lemma is the analogue of Lemma \ref{dga-lemma-nilpotent}.

\begin{lemma}[Triseq]
\label{dga-lemma-triseq}
\source{stacks:09QP}
\href{https://stacks.math.columbia.edu/tag/09QP}{\texttt{Stacks tag 09QP}}
\group{dga}

\uses{dga-situation-ABC}
In Situation \ref{dga-situation-ABC} let $x_i \to y_i \to z_i$
...
$$
\vcenter{
\begin{array}{ccc}x_1 \underset{0}{\downarrow}\longrightarrow & y_1 \longrightarrow\underset{b}{\downarrow} & z_1 \underset{0}{\downarrow} \\ x_2 \longrightarrow & y_2 \longrightarrow & z_2\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{ccc}x_2 \overset{0}{\downarrow}\longrightarrow & y_2 \longrightarrow\overset{b'}{\downarrow} & z_2 \overset{0}{\downarrow} \\ x_3 \longrightarrow & y_3 \longrightarrow & z_3\end{array}
}
$$
commute up to homotopy. Then $b'\circ b$ is homotopic to $0$.
\end{lemma}
...
\begin{proof}
\uses{dga-lemma-homo-change}

By Lemma \ref{dga-lemma-homo-change}, we can replace $b$ and $b'$
...
Lemma \ref{dga-lemma-triangle-independent-splittings}.

\begin{lemma}[Analogue triangle independent splittings]
\label{dga-lemma-analogue-triangle-independent-splittings}
\source{stacks:09QQ}
\href{https://stacks.math.columbia.edu/tag/09QQ}{\texttt{Stacks tag 09QQ}}
\group{dga}

\uses{dga-situation-ABC, dga-lemma-get-triangle}
In Situation \ref{dga-situation-ABC}
let $0 \to x \to y \to z \to 0$ be an admissible short
exact sequence in $\text{Comp}(\mathcal{A})$. The triangle
$$
\begin{array}{cccc}x\longrightarrow & y\longrightarrow & z\overset{\delta}{\longrightarrow} & x[1]\end{array}
$$
with $\delta : z \to x[1]$ as defined in Lemma \ref{dga-lemma-get-triangle}
is up to canonical isomorphism in $K(\mathcal{A})$, independent of the
choices made in Lemma \ref{dga-lemma-get-triangle}.
\end{lemma}
...
$$
\begin{array}{ccc}x \overset{a}{\longrightarrow} & y \overset{b}{\longrightarrow}\overset{\pi}{\longleftarrow} & z \overset{s}{\longleftarrow}\end{array}
$$
...
as constructed in Lemma \ref{dga-lemma-get-triangle}, we may compute
$$
\delta' = \pi'd(s') = (\pi + \pi'sb)d(s + a\pi s') = \delta + d(\pi s')
$$
using $\pi a = 1_x$, $ba = 0$, and $\pi'sbd(s') = \pi'sba\pi d(s') = 0$
by formula (5) in Lemma \ref{dga-lemma-get-triangle}.
\end{proof}

The following lemma is the analogue of Lemma \ref{dga-lemma-rotate-cone}.

\begin{lemma}[Restate axiom c]
\label{dga-lemma-restate-axiom-c}
\source{stacks:09QR}
\href{https://stacks.math.columbia.edu/tag/09QR}{\texttt{Stacks tag 09QR}}
\group{dga}
...
$$
\begin{array}{ccc}y\longrightarrow & c(f) \longrightarrow & x[1]\end{array}
$$
where the cone $c(f)$ is defined as in Lemma \ref{dga-lemma-get-triangle}.
\end{lemma}
...
The following lemma is the analogue of Lemma \ref{dga-lemma-rotate-triangle}.

\begin{lemma}[Cone rotate isom]
\label{dga-lemma-cone-rotate-isom}
\source{stacks:09QS}
\href{https://stacks.math.columbia.edu/tag/09QS}{\texttt{Stacks tag 09QS}}
\group{dga}

\uses{dga-situation-ABC}
In Situation \ref{dga-situation-ABC} let $\alpha : x \to y$ and $\beta : y \to z$
define an admissible short exact sequence
$$
\begin{array}{ccc}x \longrightarrow & y\longrightarrow & z\end{array}
$$
...
$$
\begin{array}{cccc}z[-1]\overset{\delta[-1]}{\longrightarrow}\overset{1}{\downarrow} & x\overset{\alpha}{\longrightarrow}\overset{1}{\downarrow} & y\overset{\beta}{\longrightarrow}\downarrow\overset{\tilde{\alpha}}{\longleftarrow} & z\overset{1}{\downarrow}\overset{\tilde\beta}{\longleftarrow} \\ z[-1] \overset{\delta[-1]}{\longrightarrow} & x\overset{i}{\longrightarrow} & c(\delta[-1]) \overset{p}{\longrightarrow}\overset{\tilde i}{\longleftarrow} & z\overset{\tilde p}{\longleftarrow}\end{array}
$$
...
We remark that by identities from Lemma \ref{dga-lemma-get-triangle},
...
Lemma \ref{dga-lemma-get-triangle} for the first equality and
...
Lemma \ref{dga-lemma-get-triangle}. Similarly, we compute
...
The following lemma is the analogue of
Lemma \ref{dga-lemma-third-isomorphism}.

\begin{lemma}[Analogue third isomorphism]
\label{dga-lemma-analogue-third-isomorphism}
\source{stacks:09QT}
\href{https://stacks.math.columbia.edu/tag/09QT}{\texttt{Stacks tag 09QT}}
\group{dga}

\uses{dga-situation-ABC}
In Situation \ref{dga-situation-ABC} let $f_1 : x_1 \to y_1$ and
...
\begin{proof}
\uses{dga-lemma-cone, dga-lemma-triseq}
...
$$
\begin{array}{ccc}x_2\overset{a^{-1}}{\downarrow}\overset{f_2}{\longrightarrow} & y_2\overset{b^{-1}}{\downarrow}\overset{i_2}{\longrightarrow} & c(f_2)\overset{c'}{\downarrow} \\ x_1\overset{f_1}{\longrightarrow} & y_1 \overset{i_1}{\longrightarrow} & c(f_1)\end{array}
$$
where the map $c'$ is defined via Lemma \ref{dga-lemma-cone} applied to the left
commutative box of the above diagram. Since the diagram commutes
in $K(\mathcal{A})$, it suffices by Lemma \ref{dga-lemma-triseq} to
...
$$
\vcenter{
\begin{array}{ccc}y\overset{1}{\downarrow}\longrightarrow & c(f)\overset{c}{\downarrow}\longrightarrow & x[1]\overset{1}{\downarrow} \\ y\longrightarrow & c(f) \longrightarrow & x[1]\end{array}
}
\quad\Rightarrow\quad
\vcenter{
\begin{array}{ccc}y\overset{0}{\downarrow}\longrightarrow & c(f)\overset{c-1}{\downarrow}\longrightarrow & x[1]\overset{0}{\downarrow} \\ y\longrightarrow & c(f) \longrightarrow & x[1]\end{array}
}
$$
Since the rows are admissible short exact sequences, we obtain
the identity $(c-1)^2 = 0$ by Lemma \ref{dga-lemma-triseq}, from
...
\begin{lemma}[Cone homotopy]
\label{dga-lemma-cone-homotopy}
\source{stacks:09QU}
\href{https://stacks.math.columbia.edu/tag/09QU}{\texttt{Stacks tag 09QU}}
\group{dga}

\uses{dga-situation-ABC, dga-lemma-factor}
In Situation \ref{dga-situation-ABC}.
\begin{enumerate}
\item Given an admissible short exact sequence
...
\vcenter{
\begin{array}{cccc}x\overset{\alpha}{\longrightarrow}\downarrow & y\overset{b}{\longrightarrow}\downarrow & C(\alpha)\overset{-c}{\longrightarrow}\overset{e}{\downarrow} & x[1]\downarrow \\ x\overset{\alpha}{\longrightarrow} & y\overset{\beta}{\longrightarrow} & z\overset{\delta}{\longrightarrow} & x[1]\end{array}
}
\end{equation}
...
factorization given as in Lemma \ref{dga-lemma-factor}, where the admissible
monomorphism $x \xrightarrow{\tilde{\alpha}} y$ extends to the
admissible short exact sequence
$$
\begin{array}{ccc}x \overset{\tilde{\alpha}}{\longrightarrow} & \tilde{y} \longrightarrow & z\end{array}
$$
Then there exists an isomorphism of triangles
$$
\begin{array}{cccc}x \overset{\tilde{\alpha}}{\longrightarrow}\downarrow & \tilde{y} \longrightarrow\downarrow & z \overset{\delta}{\longrightarrow}\overset{e}{\downarrow} & x[1] \downarrow \\ x \overset{\alpha}{\longrightarrow} & y \longrightarrow & C(\alpha) \overset{-c}{\longrightarrow} & x[1]\end{array}
$$
...
\begin{proof}
\uses{dga-lemma-get-triangle, dga-lemma-id-cone-null, dga-lemma-factor, dga-lemma-cone, dga-lemma-analogue-third-isomorphism}

For (1), we consider the more complete diagram, \emph{without} the
sign change on $c$:
$$
\begin{array}{ccccc}x\overset{\alpha}{\longrightarrow}\downarrow & y\overset{\pi}{\longleftarrow}\overset{b}{\longrightarrow}\downarrow & C(\alpha)\overset{p}{\longleftarrow}\overset{c}{\longrightarrow}\overset{e}{\downarrow} & x[1]\overset{\sigma}{\longleftarrow}\downarrow\overset{\alpha}{\longrightarrow} & y[1]\overset{\pi}{\longleftarrow} \\ x\overset{\alpha}{\longrightarrow} & y\overset{\beta}{\longrightarrow}\overset{\pi}{\longleftarrow} & z\overset{\delta}{\longrightarrow}\overset{s}{\longleftarrow}\overset{f}{\uparrow} & x[1] & \end{array}
$$
...
\delta = \pi d(s) = -d(\pi)s
$$
by the construction in Lemma \ref{dga-lemma-get-triangle}.
...
(cf. proof of Lemma \ref{dga-lemma-id-cone-null}).
...
given as in Lemma \ref{dga-lemma-factor}, so the second morphism
is a homotopy equivalence. By Lemmas \ref{dga-lemma-cone} and
\ref{dga-lemma-analogue-third-isomorphism}, there
...
The following lemma is the analogue of
Lemma \ref{dga-lemma-homotopy-category-pre-triangulated}.

\begin{lemma}[Analogue homotopy category pre triangulated]
\label{dga-lemma-analogue-homotopy-category-pre-triangulated}
\source{stacks:09QW}
\href{https://stacks.math.columbia.edu/tag/09QW}{\texttt{Stacks tag 09QW}}
\group{dga}

\uses{dga-situation-ABC}
In Situation \ref{dga-situation-ABC} the homotopy category $K(\mathcal{A})$
with its natural translation functors and distinguished triangles
is a pre-triangulated category.
\end{lemma}

\begin{proof}
\uses{dga-lemma-cone-homotopy, dga-lemma-cone-rotate-isom, dga-lemma-restate-axiom-c, dga-lemma-cone}
...
$$
\begin{array}{ccc}x\overset{1_x}{\longrightarrow} & x\longrightarrow & 0\end{array}
$$
...
Lemma \ref{dga-lemma-cone-homotopy}.
...
Lemma \ref{dga-lemma-cone-rotate-isom},
...
$$
\begin{array}{cccc}x\overset{\alpha}{\longrightarrow}\downarrow & y\overset{\beta}{\longrightarrow}\downarrow & z\overset{\gamma}{\longrightarrow}\downarrow & x[1]\downarrow \\ z'[-1]\overset{-\gamma'[-1]}{\longrightarrow}\underset{-1_{z'[-1]}}{\downarrow} & x \overset{\alpha'}{\longrightarrow}\downarrow & y' \overset{\beta'}{\longrightarrow}\downarrow & z'\overset{-1_{z'}}{\downarrow} \\ z'[-1]\overset{\gamma'[-1]}{\longrightarrow} & x \overset{\alpha'}{\longrightarrow} & c(\gamma'[-1]) \overset{-p}{\longrightarrow} & z'\end{array}
$$
We conclude that $(x,y,z,\alpha,\beta,\gamma)$ is distinguished by
Lemma \ref{dga-lemma-cone-homotopy} (2). Conversely, suppose that
$(x,y,z,\alpha,\beta,\gamma)$ is distinguished, so that by
Lemma \ref{dga-lemma-cone-homotopy} (1), it is isomorphic to a
...
By Lemma \ref{dga-lemma-restate-axiom-c}, this triangle is distinguished,
...
Lemma \ref{dga-lemma-cone-homotopy}, we may assume that
$(x,y,z,\alpha,\beta,\gamma)= (x,y,c(\alpha),\alpha, i, -p)$
and $(x',y',z', \alpha',\beta',\gamma')= (x',y',c(\alpha'), \alpha',i',-p')$.
Now apply Lemma \ref{dga-lemma-cone}
and we are done.
\end{proof}

The following lemma is the analogue of Lemma \ref{dga-lemma-two-split-injections}.

\begin{lemma}[Dgc analogue tr4]
\label{dga-lemma-dgc-analogue-tr4}
\source{stacks:09QX}
\href{https://stacks.math.columbia.edu/tag/09QX}{\texttt{Stacks tag 09QX}}
\group{dga}

\uses{dga-situation-ABC}
In Situation \ref{dga-situation-ABC} given admissible monomorphisms
...
$$
\begin{array}{cccc}x\overset{\alpha}{\longrightarrow} & y\overset{\pi_1}{\longleftarrow}\overset{p_1}{\longrightarrow} & q_1 \overset{\delta_1}{\longrightarrow}\overset{s_1}{\longleftarrow} & x[1]\end{array}
$$
$$
\begin{array}{cccc}x\overset{\beta\alpha}{\longrightarrow} & z\overset{\pi_1\pi_3}{\longleftarrow}\overset{p_2}{\longrightarrow} & q_2 \overset{\delta_2}{\longrightarrow}\overset{s_2}{\longleftarrow} & x[1]\end{array}
$$
$$
\begin{array}{cccc}y\overset{\beta}{\longrightarrow} & z\overset{\pi_3}{\longleftarrow}\overset{p_3}{\longrightarrow} & q_3 \overset{\delta_3}{\longrightarrow}\overset{s_3}{\longleftarrow} & x[1]\end{array}
$$
In these diagrams, the maps $\delta_i$ are defined as
$\delta_i = \pi_i d(s_i)$ analogous to the maps defined in
Lemma \ref{dga-lemma-get-triangle}.
They fit in the following solid commutative diagram
$$
\begin{array}{cccc}x\overset{\alpha}{\longrightarrow}\overset{\beta\alpha}{\searrow} & y\overset{\beta}{\downarrow}\overset{\pi_1}{\longleftarrow}\overset{p_1}{\longrightarrow} & q_1 \overset{\delta_1}{\longrightarrow}\overset{s_1}{\longleftarrow}\overset{p_2\beta s_1}{\downarrow} & x[1] \\  & z \overset{\pi_3}{\uparrow}\overset{p_3}{\downarrow}\overset{p_2}{\searrow}\overset{\pi_1\pi_3}{\nwarrow} &  &  \\  & q_3\overset{s_3}{\uparrow}\overset{\delta_3}{\downarrow} & q_2 \overset{p_3s_2}{\dashleftarrow}\overset{s_2}{\nwarrow}\overset{\delta_2}{\searrow} &  \\  & y[1] &  & x[1]\end{array}
$$
...
Lemma \ref{dga-lemma-get-triangle}, the morphism $\delta$ is given by
\begin{align*}
p_1\pi_3s_2d(p_2s_3)
= &
p_1\pi_3s_2p_2d(s_3) \\
...
of Proposition \ref{dga-proposition-homotopy-category-triangulated}.

\begin{proposition}[ABC homotopy category triangulated]
\label{dga-proposition-ABC-homotopy-category-triangulated}
\source{stacks:09QY}
\href{https://stacks.math.columbia.edu/tag/09QY}{\texttt{Stacks tag 09QY}}
\group{dga}
...
\begin{proof}
\uses{dga-lemma-analogue-homotopy-category-pre-triangulated, dga-lemma-analogue-sequence-maps-split, dga-lemma-dgc-analogue-tr4}

By Lemma \ref{dga-lemma-analogue-homotopy-category-pre-triangulated} we know that
$K(\mathcal{A})$ is pre-triangulated. Combining
Lemmas \ref{dga-lemma-analogue-sequence-maps-split} and
\ref{dga-lemma-dgc-analogue-tr4} with
Derived Categories, Lemma \ref{derived-lemma-easier-axiom-four},
we conclude that $K(\mathcal{A})$ is a triangulated category.
\end{proof}

\begin{lemma}[Functor between ABC]
\label{dga-lemma-functor-between-ABC}
\source{stacks:0FQF}
\href{https://stacks.math.columbia.edu/tag/0FQF}{\texttt{Stacks tag 0FQF}}
\group{dga}
...
constructed in Lemma \ref{dga-lemma-get-triangle} produces the morphism
...
We continue the discussion started in Section \ref{dga-section-tensor-product}.

\begin{definition}[Bimodule]
\label{dga-definition-bimodule}
\source{stacks:0FQH}
\href{https://stacks.math.columbia.edu/tag/0FQH}{\texttt{Stacks tag 0FQH}}
\group{dga}
...
\begin{lemma}[What makes a bimodule dg]
\label{dga-lemma-what-makes-a-bimodule-dg}
\source{stacks:0FQI}
\href{https://stacks.math.columbia.edu/tag/0FQI}{\texttt{Stacks tag 0FQI}}
\group{dga}
...
\begin{proof}
\uses{dga-lemma-left-module-structure}
...
By Lemma \ref{dga-lemma-left-module-structure} the structure $\mu$ corresponds
...
Section \ref{dga-section-left-modules} that the left differential graded
...
\begin{lemma}[Bimodule over tensor]
\label{dga-lemma-bimodule-over-tensor}
\source{stacks:0FQJ}
\href{https://stacks.math.columbia.edu/tag/0FQJ}{\texttt{Stacks tag 0FQJ}}
\group{dga}
...
\begin{lemma}[Bimodule resolve]
\label{dga-lemma-bimodule-resolve}
\source{stacks:0FQK}
\href{https://stacks.math.columbia.edu/tag/0FQK}{\texttt{Stacks tag 0FQK}}
\group{dga}
...
\begin{proof}
\uses{dga-lemma-bimodule-over-tensor, dga-lemma-resolve}

Immediate from Lemmas \ref{dga-lemma-bimodule-over-tensor} and
\ref{dga-lemma-resolve}.
\end{proof}

\begin{lemma}[Bimodule property P sequence]
\label{dga-lemma-bimodule-property-P-sequence}
\source{stacks:0FQL}
\href{https://stacks.math.columbia.edu/tag/0FQL}{\texttt{Stacks tag 0FQL}}
\group{dga}
...
\begin{proof}
\uses{dga-lemma-bimodule-over-tensor, dga-lemma-property-P-sequence}

Immediate from Lemmas \ref{dga-lemma-bimodule-over-tensor} and
\ref{dga-lemma-property-P-sequence}.
\end{proof}
...
\text{Mod}^{gr}_B
$$
of graded categories as in Example \ref{dga-example-gm-gr-cat}. Namely, if
...
\source{stacks:09LM}
\href{https://stacks.math.columbia.edu/tag/09LM}{\texttt{Stacks tag 09LM}}
\group{dga}
...
\begin{remark}[Shift tensor no sign]
\label{dga-remark-shift-tensor-no-sign}
\source{stacks:0FQN}
\href{https://stacks.math.columbia.edu/tag/0FQN}{\texttt{Stacks tag 0FQN}}
\group{dga}
...
in Section \ref{dga-section-conventions}) and $M$, $M'$ are right
...
$$
defined in Example \ref{dga-example-gm-gr-cat} as a right graded $A$-module
...
$$
defined in Example \ref{dga-example-dgm-dg-cat} as a right differential
...
of Lemma \ref{dga-lemma-what-makes-a-bimodule-dg} and the second
...
\label{dga-lemma-hom}
\source{stacks:0FQQ}
\href{https://stacks.math.columbia.edu/tag/0FQQ}{\texttt{Stacks tag 0FQQ}}
\group{dga}
...
\begin{remark}[Shift hom no sign]
\label{dga-remark-shift-hom-no-sign}
\source{stacks:0FQR}
\href{https://stacks.math.columbia.edu/tag/0FQR}{\texttt{Stacks tag 0FQR}}
\group{dga}
...
\begin{lemma}[Tensor hom adjunction]
\label{dga-lemma-tensor-hom-adjunction}
\source{stacks:09LN}
\href{https://stacks.math.columbia.edu/tag/09LN}{\texttt{Stacks tag 09LN}}
\group{dga}
...
Alternatively, use the isomorphism of Lemma \ref{dga-lemma-characterize-hom}
...
\text{Mod}_{(A, \text{d})}
\end{equation}
of Section \ref{dga-section-bimodules-hom}.

\begin{lemma}[Restriction homotopy]
\label{dga-lemma-restriction-homotopy}
\source{stacks:09LH}
\href{https://stacks.math.columbia.edu/tag/09LH}{\texttt{Stacks tag 09LH}}
\group{dga}
...
\begin{proof}
\uses{dga-lemma-hom, dga-remark-shift-hom-no-sign, dga-lemma-functor-between-ABC}

Via Lemma \ref{dga-lemma-hom} and
Remark \ref{dga-remark-shift-hom-no-sign}
this follows from the general principle of
Lemma \ref{dga-lemma-functor-between-ABC}.
\end{proof}
...
K(\text{Mod}_{(B, \text{d})}) \to K(\text{Mod}_{(A, \text{d})})
$$
see Lemma \ref{dga-lemma-restriction-homotopy}. Consider the diagram
$$
\begin{array}{ccc}K(\text{Mod}_{(B, \text{d})}) \downarrow\underset{\text{see above}}{\longrightarrow}\underset{F}{\searrow} &  & K(\text{Mod}_{(A, \text{d})}) \downarrow \\ D(B, \text{d}) \dashrightarrow &  & D(A, \text{d})\end{array}
$$
...
\begin{lemma}[Derived restriction]
\label{dga-lemma-derived-restriction}
\source{stacks:09LI}
\href{https://stacks.math.columbia.edu/tag/09LI}{\texttt{Stacks tag 09LI}}
\group{dga}
...
\begin{proof}
\uses{dga-lemma-right-resolution, dga-lemma-hom-derived}
...
Property (1) was shown in Lemma \ref{dga-lemma-right-resolution}.
Property (2) holds because if $s : I \to I'$ is a quasi-isomorphism
of modules with property (I), then $s$ is a homotopy equivalence
by Lemma \ref{dga-lemma-hom-derived}.
\end{proof}

\begin{lemma}[Functoriality derived restriction]
\label{dga-lemma-functoriality-derived-restriction}
\source{stacks:0BYV}
\href{https://stacks.math.columbia.edu/tag/0BYV}{\texttt{Stacks tag 0BYV}}
\group{dga}
...
\begin{proof}
\uses{dga-example-dgm-dg-cat, dga-lemma-derived-restriction, dga-lemma-hom-into-shift-dual-free}

Write $\mathcal{B} = \text{Mod}^{dg}_{(B, \text{d})}$ the
differential graded category of differential graded $B$-modules, see
Example \ref{dga-example-dgm-dg-cat}.
...
(Lemma \ref{dga-lemma-derived-restriction}) we obtain a transformation of functors
as indicated.
...
is a quasi-isomorphism. By Lemma \ref{dga-lemma-hom-into-shift-dual-free}
it suffices to show $(N')^\vee \to N^\vee$ is a quasi-isomorphism.
This is true because $f$ is a quasi-isomorphism and $(\ )^\vee$
is an exact functor.
\end{proof}

\begin{lemma}[Derived restriction exts]
\label{dga-lemma-derived-restriction-exts}
\source{stacks:0CS5}
\href{https://stacks.math.columbia.edu/tag/0CS5}{\texttt{Stacks tag 0CS5}}
\group{dga}

\uses{dga-lemma-functoriality-derived-restriction}
...
Lemma \ref{dga-lemma-functoriality-derived-restriction}.
\end{lemma}

\begin{proof}
\uses{dga-lemma-derived-restriction, dga-lemma-hom-derived}

In the proof of Lemma \ref{dga-lemma-derived-restriction}
we have seen
$$
R\Hom(N, M) =
...
correct cohomology modules by Lemma \ref{dga-lemma-hom-derived}.
We omit a discussion of the functorial nature of these
identifications.
\end{proof}

\begin{lemma}[Compute derived restriction]
\label{dga-lemma-compute-derived-restriction}
\source{stacks:0BYW}
\href{https://stacks.math.columbia.edu/tag/0BYW}{\texttt{Stacks tag 0BYW}}
\group{dga}
...
\begin{proof}
\uses{dga-lemma-derived-restriction, dga-example-dgm-dg-cat, dga-lemma-hom-derived}

By construction (Lemma \ref{dga-lemma-derived-restriction})
...
Example \ref{dga-example-dgm-dg-cat}. This proves the lemma.
If $N$ has property (P) as a $B$-module, then we see that the
assumption is satisfied by Lemma \ref{dga-lemma-hom-derived}.
\end{proof}
...
Example \ref{dga-example-category-complexes}.
...
$$
of Lemma \ref{dga-lemma-construction}.

\begin{lemma}[Existence of derived]
\label{dga-lemma-existence-of-derived}
\source{stacks:09LK}
\href{https://stacks.math.columbia.edu/tag/09LK}{\texttt{Stacks tag 09LK}}
\group{dga}
...
\end{equation}
defined in Section \ref{dga-section-bimodules-tensor}.

\begin{lemma}[Bc homotopy]
\label{dga-lemma-bc-homotopy}
\source{stacks:09LR}
\href{https://stacks.math.columbia.edu/tag/09LR}{\texttt{Stacks tag 09LR}}
\group{dga}
...
\begin{proof}
\uses{dga-lemma-tensor, dga-remark-shift-tensor-no-sign, dga-lemma-functor-between-ABC}

Via Lemma \ref{dga-lemma-tensor} and
Remark \ref{dga-remark-shift-tensor-no-sign}
this follows from the general principle of
Lemma \ref{dga-lemma-functor-between-ABC}.
\end{proof}
...
$$
\begin{array}{ccc}K(\text{Mod}_{(A, \text{d})}) \downarrow\underset{- \otimes_A N}{\longrightarrow}\underset{F}{\searrow} &  & K(\text{Mod}_{(B, \text{d})}) \downarrow \\ D(A, \text{d}) \dashrightarrow &  & D(B, \text{d})\end{array}
$$
...
\begin{lemma}[Derived bc]
\label{dga-lemma-derived-bc}
\source{stacks:09LS}
\href{https://stacks.math.columbia.edu/tag/09LS}{\texttt{Stacks tag 09LS}}
\group{dga}
...
(Lemma \ref{dga-lemma-derived-bc}) we obtain a transformation of functors
as indicated.
...
\begin{lemma}[Compute bc]
\label{dga-lemma-compute-bc}
\source{stacks:0GZ2}
\href{https://stacks.math.columbia.edu/tag/0GZ2}{\texttt{Stacks tag 0GZ2}}
\group{dga}
...
\begin{proof}
\uses{dga-lemma-derived-bc, dga-lemma-functoriality-bc}
...
in the proof of Lemma \ref{dga-lemma-derived-bc} we obtain the desired result.
...
from Lemma \ref{dga-lemma-functoriality-bc}.
\end{proof}

\begin{lemma}[Tensor hom adjoint]
\label{dga-lemma-tensor-hom-adjoint}
\source{stacks:09LT}
\href{https://stacks.math.columbia.edu/tag/09LT}{\texttt{Stacks tag 09LT}}
\group{dga}

\uses{dga-lemma-derived-bc, dga-lemma-derived-restriction}
Let $R$ be a ring.
...
$$
of Lemma \ref{dga-lemma-derived-bc} is a left adjoint to the functor
$$
R\Hom(N, -) : D(B, \text{d}) \longrightarrow D(A, \text{d})
$$
of Lemma \ref{dga-lemma-derived-restriction}.
\end{lemma}

\begin{proof}
\uses{dga-lemma-tensor-hom-adjunction}
...
Lemma \ref{dga-lemma-tensor-hom-adjunction}.
\end{proof}

\begin{example}[Map hom tensor]
\label{dga-example-map-hom-tensor}
\source{stacks:0BYX}
\href{https://stacks.math.columbia.edu/tag/0BYX}{\texttt{Stacks tag 0BYX}}
\group{dga}

\uses{dga-lemma-tensor-hom-adjoint}
...
$$
By Lemma \ref{dga-lemma-tensor-hom-adjoint} the left adjoint of this
...
\begin{lemma}[Tensor with compact fully faithful]
\label{dga-lemma-tensor-with-compact-fully-faithful}
\source{stacks:09R9}
\href{https://stacks.math.columbia.edu/tag/09R9}{\texttt{Stacks tag 09R9}}
\group{dga}

\uses{dga-lemma-tensor-hom-adjoint}
With notation and assumptions as in Lemma \ref{dga-lemma-tensor-hom-adjoint}.
Assume
\begin{enumerate}
...
\begin{proof}
\uses{dga-lemma-tensor-hom-adjoint, dga-lemma-derived-restriction-exts, dga-remark-P-resolution, dga-remark-shift-tensor-no-sign}

Our functor has a left adjoint given by
$R\Hom(N, -)$ by Lemma \ref{dga-lemma-tensor-hom-adjoint}.
...
$$
is an isomorphism, see Lemma \ref{dga-lemma-derived-restriction-exts}.
Since $N$ is a compact object the right hand side commutes
with direct sums. Thus by Remark \ref{dga-remark-P-resolution}
...
\begin{lemma}[Base change K flat]
\label{dga-lemma-base-change-K-flat}
\source{stacks:0BYZ}
\href{https://stacks.math.columbia.edu/tag/0BYZ}{\texttt{Stacks tag 0BYZ}}
\group{dga}
...
\item the diagram
$$
\begin{array}{cc}D(A, \text{d}) \underset{- \otimes_A^\mathbf{L} A'}{\longrightarrow}\underset{restriction}{\downarrow} & D(A', \text{d}) \overset{restriction}{\downarrow} \\ D(R) \overset{- \otimes_R^\mathbf{L} R'}{\longrightarrow} & D(R')\end{array}
$$
commutes, and
...
of derived tensor product in Lemma \ref{dga-lemma-derived-bc} and
...
\source{stacks:0BZ0}
\href{https://stacks.math.columbia.edu/tag/0BZ0}{\texttt{Stacks tag 0BZ0}}
\group{dga}
...
\begin{proof}
\uses{dga-example-dgm-dg-cat, dga-lemma-property-P-sequence}
...
\to \Hom_\mathcal{B}(T, B)$ defined in Example \ref{dga-example-dgm-dg-cat}.
...
Lemma \ref{dga-lemma-property-P-sequence}
...
\begin{lemma}[Compose tensor functors general]
\label{dga-lemma-compose-tensor-functors-general}
\source{stacks:0BZ3}
\href{https://stacks.math.columbia.edu/tag/0BZ3}{\texttt{Stacks tag 0BZ3}}
\group{dga}
...
$$
\begin{array}{ccccc}D(A, \text{d}) \overset{- \otimes_A^\mathbf{L} N}{\longrightarrow} &  & D(B, \text{d}) \overset{- \otimes_B^\mathbf{L} N'}{\longrightarrow} &  & D(C, \text{d})\end{array}
$$
...
\begin{proof}
\uses{dga-lemma-derived-bc, dga-remark-P-resolution}
...
of the proof of Lemma \ref{dga-lemma-derived-bc} the plain tensor
...
\end{enumerate}
Thus by Remark \ref{dga-remark-P-resolution} property $T$
...
\begin{lemma}[Compose tensor functors general algebra]
\label{dga-lemma-compose-tensor-functors-general-algebra}
\source{stacks:0BZ5}
\href{https://stacks.math.columbia.edu/tag/0BZ5}{\texttt{Stacks tag 0BZ5}}
\group{dga}
...
\begin{proof}
\uses{dga-lemma-functoriality-bc, dga-lemma-bimodule-resolve, dga-lemma-compose-tensor-functors-general, dga-lemma-bimodule-property-P-sequence, dga-lemma-derived-bc}

By Lemma \ref{dga-lemma-functoriality-bc} we may replace $N$ and $N'$ by
...
Lemma \ref{dga-lemma-bimodule-resolve}. We claim the lemma holds
...
Lemma \ref{dga-lemma-compose-tensor-functors-general}.

\medskip\noindent
Let $F_\bullet$ be the filtration on $N$ as in property (P) for bimodules.
By Lemma \ref{dga-lemma-bimodule-property-P-sequence}
...
by the construction in Lemma \ref{dga-lemma-derived-bc}.
...
\begin{lemma}[Compose tensor functors]
\label{dga-lemma-compose-tensor-functors}
\source{stacks:09S4}
\href{https://stacks.math.columbia.edu/tag/09S4}{\texttt{Stacks tag 09S4}}
\group{dga}

\uses{dga-lemma-compose-tensor-functors-general-algebra}
Let $R$ be a ring. Let $(A, \text{d})$, $(B, \text{d})$, and
$(C, \text{d})$ be differential graded $R$-algebras.
...
Lemma \ref{dga-lemma-compose-tensor-functors-general-algebra} is valid.
\end{lemma}
...
graded category of Example \ref{dga-example-category-complexes} associated
...
\begin{lemma}[Tensor with complex]
\label{dga-lemma-tensor-with-complex}
\source{stacks:09LV}
\href{https://stacks.math.columbia.edu/tag/09LV}{\texttt{Stacks tag 09LV}}
\group{dga}
...
Sections \ref{dga-section-tensor-product} and \ref{dga-section-bimodules}
...
of differential graded categories by Lemma \ref{dga-lemma-tensor}.
It is therefore clear that we obtain a functor as stated in the lemma.
\end{proof}

\begin{lemma}[Tensor with complex homotopy]
\label{dga-lemma-tensor-with-complex-homotopy}
\source{stacks:09LW}
\href{https://stacks.math.columbia.edu/tag/09LW}{\texttt{Stacks tag 09LW}}
\group{dga}

\uses{dga-lemma-tensor-with-complex}
The functor of Lemma \ref{dga-lemma-tensor-with-complex} defines an exact functor
of triangulated categories
...
Lemma \ref{dga-lemma-functorial}.
...
\begin{lemma}[Tensor with complex derived]
\label{dga-lemma-tensor-with-complex-derived}
\source{stacks:09LX}
\href{https://stacks.math.columbia.edu/tag/09LX}{\texttt{Stacks tag 09LX}}
\group{dga}

\uses{dga-lemma-tensor-with-complex-homotopy}
The functor $K(\text{Mod}_{(E, \text{d})}) \to K(\mathcal{O})$
of Lemma \ref{dga-lemma-tensor-with-complex-homotopy} has a left derived
...
\begin{lemma}[Upgrade tensor with complex derived]
\label{dga-lemma-upgrade-tensor-with-complex-derived}
\source{stacks:0CS6}
\href{https://stacks.math.columbia.edu/tag/0CS6}{\texttt{Stacks tag 0CS6}}
\group{dga}

\uses{dga-lemma-tensor-with-complex-derived}
...
The functor
of Lemma \ref{dga-lemma-tensor-with-complex-derived} has the following
...
\begin{proof}
\uses{dga-lemma-functoriality-derived-restriction, dga-lemma-compute-derived-restriction, dga-lemma-tensor-with-complex, dga-lemma-tensor-with-complex-homotopy, dga-lemma-tensor-with-complex-derived}
...
we have the derived $\Hom$ introduced in Section \ref{dga-section-restriction}
...
Lemma \ref{dga-lemma-functoriality-derived-restriction}.
By Lemma \ref{dga-lemma-compute-derived-restriction}
this means that the left hand side of the arrow becomes
$\Hom_{\text{Mod}^{dg}_{(B, \text{d})}}(M, N)$.
In Lemmas \ref{dga-lemma-tensor-with-complex},
\ref{dga-lemma-tensor-with-complex-homotopy}, and
...
\begin{lemma}[Tensor with complex hom adjoint]
\label{dga-lemma-tensor-with-complex-hom-adjoint}
\source{stacks:09LY}
\href{https://stacks.math.columbia.edu/tag/09LY}{\texttt{Stacks tag 09LY}}
\group{dga}

\uses{dga-lemma-tensor-with-complex-derived, dga-lemma-existence-of-derived}
...
D(\mathcal{O})
$$
of Lemma \ref{dga-lemma-tensor-with-complex-derived} is a left adjoint
of the functor
$$
R\Hom(K^\bullet, -) : D(\mathcal{O}) \longrightarrow D(E, \text{d})
$$
of Lemma \ref{dga-lemma-existence-of-derived}.
\end{lemma}

\begin{proof}
\uses{dga-lemma-hom-derived, dga-lemma-property-P-sequence}
...
combined with Lemma \ref{dga-lemma-hom-derived} translates the above into
$$
...
By Lemma \ref{dga-lemma-property-P-sequence} and the fact that
...
\begin{lemma}[Fully faithful in compact case]
\label{dga-lemma-fully-faithful-in-compact-case}
\source{stacks:09LZ}
\href{https://stacks.math.columbia.edu/tag/09LZ}{\texttt{Stacks tag 09LZ}}
\group{dga}
...
D(\mathcal{O})
$$
of Lemma \ref{dga-lemma-tensor-with-complex-derived} is fully faithful.
\end{lemma}

\begin{proof}
\uses{dga-lemma-tensor-with-complex-hom-adjoint, dga-lemma-property-P-sequence}

Because our functor has a left adjoint given by
$R\Hom(K^\bullet, -)$ by Lemma \ref{dga-lemma-tensor-with-complex-hom-adjoint}
...
\begin{remark}[Source graded projective]
\label{dga-remark-source-graded-projective}
\source{stacks:09R0}
\href{https://stacks.math.columbia.edu/tag/09R0}{\texttt{Stacks tag 09R0}}
\group{dga}
...
\begin{remark}[Graded projective is compact]
\label{dga-remark-graded-projective-is-compact}
\source{stacks:09R1}
\href{https://stacks.math.columbia.edu/tag/09R1}{\texttt{Stacks tag 09R1}}
\group{dga}

\uses{dga-remark-source-graded-projective}
...
$\mathcal{D}$ of Remark \ref{dga-remark-source-graded-projective},
...
\begin{lemma}[Factor through nicer]
\label{dga-lemma-factor-through-nicer}
\source{stacks:09R2}
\href{https://stacks.math.columbia.edu/tag/09R2}{\texttt{Stacks tag 09R2}}
\group{dga}
...
\begin{proposition}[Compact]
\label{dga-proposition-compact}
\source{stacks:09R3}
\href{https://stacks.math.columbia.edu/tag/09R3}{\texttt{Stacks tag 09R3}}
\group{dga}
...
\begin{proof}
\uses{dga-lemma-resolve, dga-lemma-property-P-sequence, dga-lemma-factor-through-nicer, dga-lemma-hom-derived, dga-lemma-derived-products}

Assume $E$ is compact. By Lemma \ref{dga-lemma-resolve} we may assume that $E$
...
Lemma \ref{dga-lemma-property-P-sequence}. Since $E$ is compact we have
...
Lemma \ref{dga-lemma-factor-through-nicer}
...
$$
for any differential graded module $M$ by Lemma \ref{dga-lemma-hom-derived}.
As direct sums in $D(A, \text{d})$ are given by direct sums of
graded modules (Lemma \ref{dga-lemma-derived-products}) we reduce
...
\begin{lemma}[Compact implies bounded]
\label{dga-lemma-compact-implies-bounded}
\source{stacks:09RA}
\href{https://stacks.math.columbia.edu/tag/09RA}{\texttt{Stacks tag 09RA}}
\group{dga}
...
Thus by Proposition \ref{dga-proposition-compact} it suffices to prove
...
\source{stacks:09RB}
\href{https://stacks.math.columbia.edu/tag/09RB}{\texttt{Stacks tag 09RB}}
\group{dga}
...
\begin{proof}
\uses{dga-remark-source-graded-projective, dga-remark-graded-projective-is-compact, dga-lemma-compact-implies-bounded, dga-proposition-compact, dga-lemma-hom-derived, dga-lemma-target-graded-projective, dga-lemma-admissible-ses}

Let $\mathcal{D} \subset K(A, \text{d})$ be the triangulated subcategory
discussed in Remark \ref{dga-remark-source-graded-projective}.
Let $P$ be an object of $\mathcal{D}$ which is finite projective
as a graded $A$-module. Then $P$ represents a compact object of
$D(A, \text{d})$ by Remark \ref{dga-remark-graded-projective-is-compact}.

\medskip\noindent
To prove the converse, let $E$ be a compact object of $D(A, \text{d})$.
Fix $a \leq b$ as in Lemma \ref{dga-lemma-compact-implies-bounded}.
After decreasing $a$ and increasing $b$ if necessary, we may also
assume that $H^i(E) = 0$ for $i \not \in [a, b]$ (this follows
from Proposition \ref{dga-proposition-compact} and our assumption on $A$).
Moreover, fix an integer $c > 0$ such that $A^n = 0$ if $|n| \geq c$.

\medskip\noindent
By Proposition \ref{dga-proposition-compact} we see that $E$ is a direct
...
differential graded module $M$ by Lemma \ref{dga-lemma-hom-derived}.
In other words, $P$ is an object of the triangulated
subcategory $\mathcal{D} \subset K(A, \text{d})$ discussed in
Remark \ref{dga-remark-source-graded-projective}.
...
short exact sequence (Lemma \ref{dga-lemma-target-graded-projective}).
Hence we obtain a boundary map
$\delta : P \to (P_1 \cap P_2)[1]$ in $K(A, \text{d})$, see
Lemma \ref{dga-lemma-admissible-ses}.
...
\begin{lemma}[Qis equivalence]
\label{dga-lemma-qis-equivalence}
\source{stacks:09S6}
\href{https://stacks.math.columbia.edu/tag/09S6}{\texttt{Stacks tag 09S6}}
\group{dga}
...
\begin{proof}
\uses{dga-lemma-tensor-with-compact-fully-faithful, dga-lemma-tensor-hom-adjoint, dga-example-map-hom-tensor}

By Lemma \ref{dga-lemma-tensor-with-compact-fully-faithful}
the functor $M \longmapsto M \otimes_A^\mathbf{L} B$ is
fully faithful. By Lemma \ref{dga-lemma-tensor-hom-adjoint}
the functor $N \longmapsto R\Hom(B, N) = N_A$ is a right adjoint, see
Example \ref{dga-example-map-hom-tensor}.
...
\source{stacks:09S7}
\href{https://stacks.math.columbia.edu/tag/09S7}{\texttt{Stacks tag 09S7}}
\group{dga}
...
\begin{proof}
\uses{dga-lemma-tensor-with-compact-fully-faithful, dga-lemma-tensor-hom-adjoint}
...
\begin{remark}[Tilting equivalence]
\label{dga-remark-tilting-equivalence}
\source{stacks:09SS}
\href{https://stacks.math.columbia.edu/tag/09SS}{\texttt{Stacks tag 09SS}}
\group{dga}

\uses{dga-lemma-tilting-equivalence}
In Lemma \ref{dga-lemma-tilting-equivalence} we can replace
...
\source{stacks:09S8}
\href{https://stacks.math.columbia.edu/tag/09S8}{\texttt{Stacks tag 09S8}}
\group{dga}
...
\begin{proof}
\uses{dga-lemma-hom-derived, dga-lemma-tilting-equivalence, dga-lemma-qis-equivalence}
...
Lemma \ref{dga-lemma-hom-derived} and assumption (2)(c).
Viewing $P$ as a $(E, B)$-bimodule and using
Lemma \ref{dga-lemma-tilting-equivalence} and assumption (2)(b)
...
$$
by Lemma \ref{dga-lemma-qis-equivalence}.
\end{proof}

\begin{remark}[Lift equivalence to dga]
\label{dga-remark-lift-equivalence-to-dga}
\source{stacks:09S9}
\href{https://stacks.math.columbia.edu/tag/09S9}{\texttt{Stacks tag 09S9}}
\group{dga}

\uses{dga-lemma-tilting-equivalence, dga-example-dgm-dg-cat}
Let $R$ be a ring. Let $(A, \text{d})$ and $(B, \text{d})$ be differential
...
Lemma \ref{dga-lemma-tilting-equivalence}
...
\begin{proof}
\uses{dga-remark-lift-equivalence-to-dga, dga-lemma-hom-derived, dga-lemma-tilting-equivalence, dga-lemma-qis-equivalence, dga-example-map-hom-tensor, dga-lemma-compose-tensor-functors}

As in Remark \ref{dga-remark-lift-equivalence-to-dga} above, we set $N = F(A)$
...
$$
Then $H^0(E) = A$ and $H^k(E) = 0$ for $k \not = 0$ by
Lemma \ref{dga-lemma-hom-derived}.
Moreover, by the discussion in Remark \ref{dga-remark-lift-equivalence-to-dga}
and by Lemma \ref{dga-lemma-tilting-equivalence}
...
$(A, E')$-bimodule, see Example \ref{dga-example-map-hom-tensor}.
On the other hand the functor $D(E', \text{d}) \to D(B, \text{d})$ is given by
$M \mapsto M \otimes_{E'}^\mathbf{L} N$ where $N$ is as above.
We conclude by Lemma \ref{dga-lemma-compose-tensor-functors}.
\end{proof}

\begin{remark}[Rickard]
\label{dga-remark-rickard}
\source{stacks:09SB}
\href{https://stacks.math.columbia.edu/tag/09SB}{\texttt{Stacks tag 09SB}}
\group{dga}

\uses{dga-proposition-rickard}
Let $A, B, F, N$ be as in Proposition \ref{dga-proposition-rickard}.
...
\begin{lemma}[Rickard rings]
\label{dga-lemma-rickard-rings}
\source{stacks:09SC}
\href{https://stacks.math.columbia.edu/tag/09SC}{\texttt{Stacks tag 09SC}}
\group{dga}
...
\begin{proof}
\uses{dga-lemma-rickard, dga-lemma-compact, dga-proposition-rickard}

The equivalence of (1) and (2) is a special case of
Lemma \ref{dga-lemma-rickard} combined with the result of
Lemma \ref{dga-lemma-compact} characterizing compact objects of $D(B)$
(small detail omitted).
The equivalence with (3) if $B$ is $R$-flat follows from
Proposition \ref{dga-proposition-rickard}.
\end{proof}

\begin{remark}[Centers]
\label{dga-remark-centers}
\source{stacks:09SD}
\href{https://stacks.math.columbia.edu/tag/09SD}{\texttt{Stacks tag 09SD}}
\group{dga}
...
\begin{remark}[Hochschild cohomology]
\label{dga-remark-hochschild-cohomology}
\source{stacks:09ST}
\href{https://stacks.math.columbia.edu/tag/09ST}{\texttt{Stacks tag 09ST}}
\group{dga}

\uses{dga-proposition-rickard, dga-lemma-bimodule-over-tensor, dga-remark-centers}
Let $R$ be a ring. Let $(A, \text{d})$ and $(B, \text{d})$ be differential
...
Proposition \ref{dga-proposition-rickard} and is often true
...
Lemma \ref{dga-lemma-bimodule-over-tensor} to turn bimodules into
right modules).
...
of the result mentioned in Remark \ref{dga-remark-centers}.
...
\source{stacks:0BZ7}
\href{https://stacks.math.columbia.edu/tag/0BZ7}{\texttt{Stacks tag 0BZ7}}
\group{dga}
...
and for each $s \in S_n$ we let $a_s \in \Ker(\text{d} : A_n \to A_n)$
...
Lemma \ref{dga-lemma-compose-tensor-functors-general-algebra}.

\begin{lemma}[Compose tensor functors tor]
\label{dga-lemma-compose-tensor-functors-tor}
\source{stacks:0BZ8}
\href{https://stacks.math.columbia.edu/tag/0BZ8}{\texttt{Stacks tag 0BZ8}}
\group{dga}
...
\begin{proof}
\uses{dga-lemma-K-flat-resolution, dga-lemma-qis-equivalence, dga-lemma-compose-tensor-functors, dga-lemma-compose-tensor-functors-general, dga-lemma-compose-tensor-functors-general-algebra}

Using Lemma \ref{dga-lemma-K-flat-resolution}
...
D(A) \to D(B') \to D(C).
$$
The first one is Lemma \ref{dga-lemma-compose-tensor-functors}
because $B'$ is K-flat as a complex of $R$-modules.
The second one is true because
$B \otimes_B^\mathbf{L} N' = N' = B \otimes_B N'$
and hence Lemma \ref{dga-lemma-compose-tensor-functors-general} applies.
...
\source{stacks:0CRM}
\href{https://stacks.math.columbia.edu/tag/0CRM}{\texttt{Stacks tag 0CRM}}
\group{dga}
...
\begin{proof}
\uses{dga-proposition-compact, dga-lemma-qis-equivalence, dga-lemma-resolve, dga-lemma-good-quotient, dga-lemma-factor-through-nicer, dga-lemma-homotopy-colimit}
...
By Proposition \ref{dga-proposition-compact} we see that $E_n$
...
Lemma \ref{dga-lemma-resolve} we see that it suffices to show that
we can prove Lemma \ref{dga-lemma-good-quotient}
...
proof of Lemma \ref{dga-lemma-factor-through-nicer} but it is also
...
Proposition \ref{dga-proposition-compact}. Since
$P = \text{hocolim} P'_n$ in $D(A, \text{d})$
by Lemma \ref{dga-lemma-homotopy-colimit}
