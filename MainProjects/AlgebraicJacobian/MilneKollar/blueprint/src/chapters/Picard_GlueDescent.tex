...
\begin{definition}[The pushforward product carrying the descent equalizer]\leanok
...
\begin{lemma}[Overlap base change of the chart square (\(\beta_{ij}\))]\leanok
...
\begin{lemma}[The chart restriction morphism of the glued sheaf]\leanok
...
\begin{theorem}[Effective descent: the chart restriction morphism is an isomorphism]\leanok
...
\begin{lemma}[Transport of \(\mathrm{appLE}\) along equal morphisms]\leanok
...
\begin{lemma}[Structure-sheaf compatibility of the chart--overlap square]\leanok
...
\begin{lemma}[Sections of the overlap base change, inverse side]\leanok
...
\begin{lemma}[Sections of the overlap base change, forward side]\leanok
...
\begin{lemma}[Unit comparison across the adjunctions]\leanok
...
\begin{lemma}[Counit comparison across the adjunctions]\leanok
...
\begin{lemma}[Congruence cast at the pullback level]\leanok
...
\begin{lemma}[Trivial site-level congruence cast]\leanok
...
\begin{lemma}[Comparison intertwines the two congruence casts]\leanok
...
\begin{definition}[Overlap base change in pullback form]\leanok
...
\begin{definition}[The \(j\)-th component of the candidate inverse]\leanok
...
\begin{definition}[The candidate-inverse family]\leanok
...
\begin{lemma}[The candidate family recovers each chart component]\leanok
  \label{lem:gr_glueChartFamily_pullback_map_pi}
  \dcref{custom}
  \lean{AlgebraicGeometry.Scheme.Modules.glueChartFamily_pullback_map_π}
  \uses{def:gr_glueChartComponent, def:gr_glueChartFamily}
...
\begin{lemma}[Triple-overlap bridges of the glue datum]\leanok
...
\begin{lemma}[Pair component of the equalizing condition]\leanok
...
\begin{lemma}[The candidate-inverse family equalizes the restricted legs (C2 transported)]\leanok
...
\begin{definition}[The candidate inverse \(\mathrm{s}_i\)]\leanok
...
\begin{lemma}[Comparison compatibility of the restricted projection]\leanok
...
\begin{lemma}[The candidate inverse recovers the components]\leanok
...
\begin{lemma}[Joint detection of morphisms into the restricted glued sheaf]\leanok
...
\begin{lemma}[Joint faithfulness of the chart restrictions]\leanok
...
\begin{lemma}[Self-component collapses to the identity (C1 + counit triangle)]\leanok
...
\begin{lemma}[Transpose of the overlap base change (mate core)]\leanok
...
\begin{lemma}[Mate recognition of the factor transpose]\leanok
...
\begin{lemma}[Overlap compatibility of the restriction morphisms]\leanok
...
\begin{lemma}[Pair condition transposed: restriction composed with the component]\leanok
...
\begin{definition}[The restriction isomorphism of the glued sheaf]\leanok
