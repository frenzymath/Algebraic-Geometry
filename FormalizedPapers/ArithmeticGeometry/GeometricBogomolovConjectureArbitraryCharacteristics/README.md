...
Blueprint project under `FormalizedPapers/ArithmeticGeometry/GeometricBogomolovConjectureArbitraryCharacteristics`.

- Blueprint: [`blueprint/src/content.tex`](blueprint/src/content.tex)
- Direct PDF: [arXiv PDF](https://arxiv.org/pdf/2108.09722)
