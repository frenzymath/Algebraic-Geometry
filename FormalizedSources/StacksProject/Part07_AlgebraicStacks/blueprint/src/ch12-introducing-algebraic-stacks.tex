...
$$
\begin{array}{ccc}E \underset{\alpha}{\longrightarrow}\overset{f}{\downarrow} &  & E' \underset{f'}{\downarrow} \\ S \overset{0}{\uparrow}\overset{a}{\longrightarrow} &  & S' \underset{0'}{\uparrow}\end{array}
$$
...
\item A diagram
$$
\begin{array}{ccc}S \underset{a}{\longrightarrow}\underset{(E, f, 0)}{\searrow} &  & S' \overset{(E', F', 0')}{\swarrow} \\  & \mathcal{M}_{1, 1} & \end{array}
$$
...
$$
\begin{array}{ccccccc}S \underset{a}{\longrightarrow}\underset{(E, f, 0)}{\searrow} &  &  & S' \underset{(E', F', 0')}{\downarrow}\underset{a'}{\longrightarrow} &  &  & S'' \overset{(E'', F'', 0'')}{\swarrow} \\  &  &  & \mathcal{M}_{1, 1} &  &  & \end{array}
$$
...
the diagram
$$
\begin{array}{ccc}S \underset{a}{\longrightarrow}\underset{F(E, f, 0)}{\searrow} &  & S' \overset{F(E', F', 0')}{\swarrow} \\  & T & \end{array}
$$
...
$$
\begin{array}{ccc} & ? \searrow\swarrow &  \\ S \underset{(E, f, 0)}{\searrow} &  & S' \overset{(E', f', 0')}{\swarrow} \\  & \mathcal{M}_{1, 1} & \end{array}
$$
...
\source{stacks:072M}
\href{https://stacks.math.columbia.edu/tag/072M}{\texttt{Stacks tag 072M}}
\group{stacks-introduction}
...
\source{stacks:072N}
\href{https://stacks.math.columbia.edu/tag/072N}{\texttt{Stacks tag 072N}}
\group{stacks-introduction}
...
\source{stacks:072P}
\href{https://stacks.math.columbia.edu/tag/072P}{\texttt{Stacks tag 072P}}
\group{stacks-introduction}
...
\source{stacks:072R}
\href{https://stacks.math.columbia.edu/tag/072R}{\texttt{Stacks tag 072R}}
\group{stacks-introduction}
...
$$
\begin{array}{ccc}S_i \times_S S_j \underset{e_i \circ \text{pr}_1}{\searrow}\underset{\text{id}}{\longrightarrow} &  & S_i \times_S S_j \overset{e_j \circ \text{pr}_2}{\swarrow} \\  & \mathcal{M}_{1, 1} & \end{array}
$$
...
\begin{lemma}[Weierstrass smooth cover]
\label{stacks-introduction-lemma-Weierstrass-smooth-cover}
\source{stacks:072T}
\href{https://stacks.math.columbia.edu/tag/072T}{\texttt{Stacks tag 072T}}
\group{stacks-introduction}
...
\begin{remark}[Quotient stack]
\label{stacks-introduction-remark-quotient-stack}
\source{stacks:072U}
\href{https://stacks.math.columbia.edu/tag/072U}{\texttt{Stacks tag 072U}}
\group{stacks-introduction}
