...
% The source proof, when supplied, is outside the statement environment.
...
\begin{lemma}[Printed Lemma 1]\label{mcrt-auto-lemma-1}\dcref{1}\source{matsumura-commutative-ring-theory:page-0025}\uses{}
\begin{verbatim}
The printed source heading 1 begins on PDF page 0025; consult the page-addressable Luna record.
\end{verbatim}
\end{lemma}
\begin{proof}
\notready The source prints this result without a proof at this location, or the page ledger does not contain a legible proof continuation.
...
\begin{lemma}[Printed Lemma 2]\label{mcrt-auto-lemma-2}\dcref{2}\source{matsumura-commutative-ring-theory:page-0026}\uses{}
\begin{verbatim}
The printed source heading 2 begins on PDF page 0026; consult the page-addressable Luna record.
\end{verbatim}
\end{lemma}
\begin{proof}
\notready The source prints this result without a proof at this location, or the page ledger does not contain a legible proof continuation.
...
\begin{corollary}[Printed Corollary 3]\label{mcrt-auto-corollary-3}\dcref{3}\source{matsumura-commutative-ring-theory:page-0039}\uses{}
\begin{verbatim}
The printed source heading 3 begins on PDF page 0039; consult the page-addressable Luna record.
\end{verbatim}
\end{corollary}
\begin{proof}
\notready The source prints this result without a proof at this location, or the page ledger does not contain a legible proof continuation.
...
\begin{corollary}[Printed Corollary 4]\label{mcrt-auto-corollary-4}\dcref{4}\source{matsumura-commutative-ring-theory:page-0039}\uses{}
\begin{verbatim}
The printed source heading 4 begins on PDF page 0039; consult the page-addressable Luna record.
\end{verbatim}
\end{corollary}
\begin{proof}
\notready The source prints this result without a proof at this location, or the page ledger does not contain a legible proof continuation.
...
mathematical transcription follows the rendered page; OCR/text-layer artifacts are retained as [uncertain] where not visually resolvable.
...
\begin{theorem}[Printed Theorem 14.8]\label{mcrt-auto-theorem-14-8}\dcref{14.8}\source{matsumura-commutative-ring-theory:page-0124}\uses{}
\begin{verbatim}
The printed source heading 14.8 begins on PDF page 0124; consult the page-addressable Luna record.
\end{verbatim}
\end{theorem}
\begin{proof}
\notready The source prints this result without a proof at this location, or the page ledger does not contain a legible proof continuation.
...
\begin{theorem}[Printed Theorem 20.8]\label{mcrt-auto-theorem-20-8}\dcref{20.8}\source{matsumura-commutative-ring-theory:page-0180}\uses{}
\begin{verbatim}
The printed source heading 20.8 begins on PDF page 0180; consult the page-addressable Luna record.
\end{verbatim}
\end{theorem}
\begin{proof}
\notready The source prints this result without a proof at this location, or the page ledger does not contain a legible proof continuation.
...
\begin{theorem}[Printed Theorem 28.4]\label{mcrt-auto-theorem-28-4}\dcref{28.4}\source{matsumura-commutative-ring-theory:page-0232}\uses{}
\begin{verbatim}
The printed source heading 28.4 begins on PDF page 0232; consult the page-addressable Luna record.
\end{verbatim}
\end{theorem}
\begin{proof}
\notready The source prints this result without a proof at this location, or the page ledger does not contain a legible proof continuation.
...
\begin{theorem}[Printed Theorem 28.9]\label{mcrt-auto-theorem-28-9}\dcref{28.9}\source{matsumura-commutative-ring-theory:page-0237}\uses{}
\begin{verbatim}
The printed source heading 28.9 begins on PDF page 0237; consult the page-addressable Luna record.
\end{verbatim}
\end{theorem}
\begin{proof}
\notready The source prints this result without a proof at this location, or the page ledger does not contain a legible proof continuation.
