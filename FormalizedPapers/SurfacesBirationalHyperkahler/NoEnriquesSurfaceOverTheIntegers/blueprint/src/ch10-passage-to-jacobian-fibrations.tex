...
\begin{theorem}
\label{src-no-enriques-surface-over-the-integers-ch10-passage-to-jacobian-fibrations-statement-1}
\source{no-enriques-surface-over-the-integers}
\notready
...
\begin{proposition}
\label{src-no-enriques-surface-over-the-integers-ch10-passage-to-jacobian-fibrations-statement-2}
\source{no-enriques-surface-over-the-integers}
\notready
...
\begin{proposition}
\label{src-no-enriques-surface-over-the-integers-ch10-passage-to-jacobian-fibrations-statement-3}
\source{no-enriques-surface-over-the-integers}
\notready
...
\begin{theorem}
\label{src-no-enriques-surface-over-the-integers-ch10-passage-to-jacobian-fibrations-statement-4}
\source{no-enriques-surface-over-the-integers}
\notready
...
\begin{proposition}
\label{src-no-enriques-surface-over-the-integers-ch10-passage-to-jacobian-fibrations-statement-5}
\source{no-enriques-surface-over-the-integers}
\notready
