...
\end{lemma}
\begin{proof}
  \leanok\uses{mk-lem:modules_annihilator_ideal_le, mk-lem:annihilator_localization_eq_map,
...
\end{lemma}
\begin{proof}
  \leanokChoose an open cover \(\{U_i\}\) of \(X\) on whose members \(\mathcal{F}\)
...
\end{lemma}
\begin{proof}
  \leanok\uses{mk-lem:pullback_isQuasicoherent_hom}
...
\end{lemma}
\begin{proof}
  \leanok\uses{mk-lem:affine_finite_sections_nhds, mk-lem:isLocalization_basicOpen_mathlib,
...
\begin{lemma}[Annihilators are stable under pullback: section level]\label{mk-lem:annihilator_pullback_sections}
  ...
  \leanok
  \source{stacks-project, nitsure-hilbert-quot}
...
\end{lemma}
\begin{proof}
  \leanok\uses{mk-lem:modules_pullback_mathlib, mk-lem:pullback_isQuasicoherent_hom,
    mk-lem:qcoh_section_localization_basicOpen}
...
\end{lemma}
\begin{proof}
  \leanok\uses{mk-lem:annihilator_pullback_sections, mk-lem:modules_annihilator_ideal,
...
\end{lemma}
\begin{proof}
  \leanok\uses{mk-lem:annihilator_le_map_pullback, mk-lem:isProper_mathlib,
...
\end{lemma}
\begin{proof}
  \leanokA scalar \(a \in \mathrm{Ann}_R(M)\) kills every elementary tensor via
...
\end{lemma}
\begin{proof}
  \leanokOver fields the base-change identity
...
\end{definition}
\begin{proof}
  \leanok\uses{mk-def:scheme_modules_tensorobj}
...
\end{lemma}
\begin{proof}
  \leanokDefinitional: both constructions sheafify \(A \otimes^p B\).
\end{proof}
...
\end{lemma}
\begin{proof}
  \leanokThe sheafification functor is a reflective localization, so it inverts the
...
\begin{lemma}[Sections of the twisted fibre module under residue field extension]\label{mk-lem:gamma_fiber_baseChange_field}
  ...
  \leanok
  \source{nitsure-hilbert-quot, stacks-project}
...
\end{lemma}
\begin{proof}
  \leanokFix \(x \in X\) and choose an affine open \(U \ni x\) with an isomorphism
...
\end{lemma}
\begin{proof}
  \leanokRestriction to \(V\) factors as restriction to \(U\) followed by
...
\end{lemma}
\begin{proof}
  \leanokBy local triviality there is an affine open \(U \ni x\) with a
...
\end{lemma}
\begin{proof}
  \leanokChoose a free presentation \(0 \to K \xrightarrow{\iota} F_0
...
\end{lemma}
\begin{proof}
  \leanok\uses{mk-lem:flat_cokernel_rTensor_injective}
...
\end{lemma}
\begin{proof}
  \leanok\uses{mk-lem:IsLocallyTrivial_pullback, mk-lem:locally_trivial_of_iso}
...
\end{lemma}
\begin{proof}
  \leanokInjectivity on a basis of opens gives injectivity of \(\varphi\) on
...
\end{lemma}
\begin{proof}
  \leanok\(q\) epi identifies \(F\) with the cokernel of the kernel inclusion
...
\end{lemma}
\begin{proof}
  \leanok\uses{mk-lem:pullback_kernel_comparison_epi}
...
\end{lemma}
\begin{proof}
  \leanokThe unit module carries the canonical one-generator, no-relation
...
\begin{proof}
  \leanok\uses{mk-thm:grassmannian_universal_property, mk-def:grassmannian_scheme}
...
\begin{proof}
  \leanok\uses{mk-def:zariski_sheaf_over, mk-lem:local_representability_mathlib}
...
\begin{proof}
  \leanok\uses{mk-def:scheme_modules_glue, mk-def:grassmannian_scheme,
...
\end{theorem}
\begin{proof}
  \leanok\uses{mk-lem:grassmannian_representable_free,
    mk-thm:representability_zariski_descent, mk-lem:grassmannian_zariski_sheaf}
...
\end{lemma}
\begin{proof}
  \leanokOn the basic-open chart \(D_+(X_i)\) the gluing datum of
...
\end{corollary}
\begin{proof}
  \leanokImmediate from \ref{mk-lem:serreTwist_isLocallyTrivial} and
...
\end{theorem}
\begin{proof}
  \leanokApply \ref{mk-thm:quot_pullback_baseMap_sectionEquiv_qc} (\(H^0\) flat
...
\end{lemma}
\begin{proof}
  \leanokEvaluation of sheaves of modules at the maximal open computes global
...
\end{lemma}
\begin{proof}
  \leanok\uses{mk-lem:gamma_pi_sections}
...
\end{lemma}
\begin{proof}
  \leanokPushforward along \(\varphi\) and pushforward along \(\varphi^{-1}\) are
...
\end{lemma}
\begin{proof}
  \leanokThe first descent leg is the pushforward, along \(f_{ij}\) followed by
...
\end{lemma}
\begin{proof}
  \leanok\uses{mk-lem:glue_sections_equalizer}
...
\end{lemma}
\begin{proof}
  \leanok\uses{mk-lem:serre_twist_glued_sections, mk-lem:pullback_iso_pushforward_inv}
...
\end{lemma}
\begin{proof}
  \leanok\uses{mk-lem:glue_legA_unit_restriction}
...
\end{lemma}
\begin{proof}
  \leanok\uses{mk-lem:glue_legA_unit_restriction, mk-lem:serre_twist_b_leg}
...
\end{definition}
\begin{proof}
  \leanokComposite of Mathlib's \(\operatorname{Proj}\) basic-open-versus-away
...
\end{lemma}
\begin{proof}
  \leanok\uses{mk-lem:serre_twist_compatible_condition}
...
\end{lemma}
\begin{proof}
  \leanok\uses{mk-lem:serre_twist_away_bridge}
...
\end{lemma}
\begin{proof}
  \leanok\uses{mk-lem:serre_twist_form_compatible}
...
\end{definition}
\begin{proof}
  \leanok\uses{mk-lem:serre_twist_forms_embed}
...
\end{lemma}
\begin{proof}
  \leanok\uses{mk-lem:serre_twist_sections_compatible, mk-lem:serre_twist_form_compatible}
...
\end{theorem}
\begin{proof}
  \leanok\uses{mk-thm:quot_canonical_basechange_isIso}
...
\end{lemma}
\begin{proof}
  \leanokAn element \(z\) of \(\ker s\) has, for every \(i\), image \(0\) under
...
\end{lemma}
\begin{proof}
  \leanok\uses{mk-lem:section_base_change_injective_cover}
...
\end{theorem}
\begin{proof}
  \leanok\uses{mk-thm:quot_canonical_basechange_app_app_isIso_of_affineCover,
...
\end{lemma}
\begin{proof}
  \leanokThe base map is by construction the unit component followed by the
...
\end{theorem}
\begin{proof}
  \leanok\uses{mk-lem:quot_baseMap_le_refl, mk-lem:baseMap_pullbackComp_apply,
...
\end{lemma}
\begin{proof}
  \leanokRestricting the cartesian square to the opens \(V, U, V'\) and
...
\end{lemma}
\begin{proof}
  \leanokFlatness of a morphism of schemes is affine-local: it holds if and only
...
\end{theorem}
\begin{proof}
  \leanok\uses{mk-def:quot_pullback_app_isoTensor, mk-lem:quot_baseMap_le_refl,
...
\end{theorem}
\begin{proof}
  \leanok\uses{mk-def:pullback_app_isoTensor_sigma, mk-lem:pushforward_isQuasicoherent,
...
\end{theorem}
\begin{proof}
  \leanok\uses{mk-thm:quot_canonical_basechange_app_app_isIso_of_le_preimage}
...
\end{theorem}
\begin{proof}
  \leanok\uses{mk-lem:modules_isIso_of_isBasis}
...
\end{theorem}
\begin{proof}
  \leanok\uses{mk-thm:quot_canonical_basechange_app_app_isIso}
