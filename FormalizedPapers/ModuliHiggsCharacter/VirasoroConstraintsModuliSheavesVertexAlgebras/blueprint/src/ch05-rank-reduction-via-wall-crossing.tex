...
The source diagram identifies the section $\mathcal O_S\to I_Z(E)$ whose
cokernel is supported on the nested pair $(E,Z)$.
...
The source diagram factors $\Pi_\alpha$ through the pair moduli space and its
rigidified sheaf moduli space.
