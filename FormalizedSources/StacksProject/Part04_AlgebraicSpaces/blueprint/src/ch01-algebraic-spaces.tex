...
see the discussion in Section \ref{spaces-section-presentations} and
Theorem \ref{spaces-theorem-presentation}. The analogue of this theorem in
...
\medskip\noindent
In Section \ref{spaces-section-separation} we introduce various separation
axioms on algebraic spaces that we have found in the literature.
Finally in Section \ref{spaces-section-examples}
...
of $\Sch_{fppf}$.
In Section \ref{spaces-section-change-big-site} we discuss what
...
$$
\begin{array}{ccc}V_\xi \rightsquigarrow\underset{a_\xi}{\downarrow} & h_{V_\xi} \downarrow\longrightarrow & F \overset{a}{\downarrow} \\ U \rightsquigarrow & h_U \overset{\xi}{\longrightarrow} & G\end{array}
$$
...
\begin{lemma}[Morphism schemes gives representable transformation]
\label{spaces-lemma-morphism-schemes-gives-representable-transformation}
\source{stacks:02W9}
\href{https://stacks.math.columbia.edu/tag/02W9}{\texttt{Stacks tag 02W9}}
\group{spaces}
...
\begin{lemma}[Composition representable transformations]
\label{spaces-lemma-composition-representable-transformations}
\source{stacks:02WA}
\href{https://stacks.math.columbia.edu/tag/02WA}{\texttt{Stacks tag 02WA}}
\group{spaces}
...
\begin{lemma}[Base change representable transformations]
\label{spaces-lemma-base-change-representable-transformations}
\source{stacks:02WB}
\href{https://stacks.math.columbia.edu/tag/02WB}{\texttt{Stacks tag 02WB}}
\group{spaces}
...
\begin{lemma}[Product representable transformations]
\label{spaces-lemma-product-representable-transformations}
\source{stacks:02WC}
\href{https://stacks.math.columbia.edu/tag/02WC}{\texttt{Stacks tag 02WC}}
\group{spaces}
...
\begin{proof}
\uses{spaces-lemma-composition-representable-transformations, spaces-lemma-base-change-representable-transformations}
...
consequence of Lemmas \ref{spaces-lemma-composition-representable-transformations}
and \ref{spaces-lemma-base-change-representable-transformations}.
\end{proof}

\begin{lemma}[Representable transformation to sheaf]
\label{spaces-lemma-representable-transformation-to-sheaf}
\source{stacks:02WD}
\href{https://stacks.math.columbia.edu/tag/02WD}{\texttt{Stacks tag 02WD}}
\group{spaces}
...
and hence (see remarks in Section \ref{spaces-section-general}) a sheaf.
...
\begin{lemma}[Representable transformation diagonal]
\label{spaces-lemma-representable-transformation-diagonal}
\source{stacks:05L9}
\href{https://stacks.math.columbia.edu/tag/05L9}{\texttt{Stacks tag 05L9}}
\group{spaces}
...
\begin{remark}[List properties stable base change]
\label{spaces-remark-list-properties-stable-base-change}
\source{stacks:02WF}
\href{https://stacks.math.columbia.edu/tag/02WF}{\texttt{Stacks tag 02WF}}
\group{spaces}
...
\begin{remark}[List properties stable composition]
\label{spaces-remark-list-properties-stable-composition}
\source{stacks:02WG}
\href{https://stacks.math.columbia.edu/tag/02WG}{\texttt{Stacks tag 02WG}}
\group{spaces}

\uses{spaces-remark-list-properties-stable-base-change}
Of the properties of morphisms which are stable under base change
(as listed in
Remark \ref{spaces-remark-list-properties-stable-base-change})
...
\begin{remark}[List properties fpqc local base]
\label{spaces-remark-list-properties-fpqc-local-base}
\source{stacks:02WH}
\href{https://stacks.math.columbia.edu/tag/02WH}{\texttt{Stacks tag 02WH}}
\group{spaces}

\uses{spaces-remark-list-properties-stable-base-change}
Of the properties mentioned which are stable under base change
(as listed in Remark \ref{spaces-remark-list-properties-stable-base-change})
...
\begin{definition}[Relative representable property]
\label{spaces-definition-relative-representable-property}
\source{stacks:025V}
\href{https://stacks.math.columbia.edu/tag/025V}{\texttt{Stacks tag 025V}}
\group{spaces}
...
\source{stacks:02YN}
\href{https://stacks.math.columbia.edu/tag/02YN}{\texttt{Stacks tag 02YN}}
\group{spaces}

\uses{spaces-definition-relative-representable-property, spaces-lemma-surjective-flat-locally-finite-presentation}
...
in Definition \ref{spaces-definition-relative-representable-property}
...
Lemma \ref{spaces-lemma-surjective-flat-locally-finite-presentation}
for a case where surjectivity implies surjectivity as a map of sheaves.
\end{remark}

Here is a sanity check.

\begin{lemma}[Morphism schemes gives representable transformation property]
\label{spaces-lemma-morphism-schemes-gives-representable-transformation-property}
\source{stacks:02WJ}
\href{https://stacks.math.columbia.edu/tag/02WJ}{\texttt{Stacks tag 02WJ}}
\group{spaces}

\uses{spaces-definition-relative-representable-property}
Let $S$, $X$, $Y$ be objects of $\Sch_{fppf}$.
Let $f : X \to Y$ be a morphism of schemes.
Let $\mathcal{P}$ be as in
Definition \ref{spaces-definition-relative-representable-property}.
Then $h_X \longrightarrow h_Y$ has property $\mathcal{P}$ if
and only if $f$ has property $\mathcal{P}$.
\end{lemma}

\begin{proof}
\uses{spaces-lemma-morphism-schemes-gives-representable-transformation}

Note that the lemma makes sense by
Lemma \ref{spaces-lemma-morphism-schemes-gives-representable-transformation}.
Proof omitted.
\end{proof}

\begin{lemma}[Composition representable transformations property]
\label{spaces-lemma-composition-representable-transformations-property}
\source{stacks:02WK}
\href{https://stacks.math.columbia.edu/tag/02WK}{\texttt{Stacks tag 02WK}}
\group{spaces}
...
\begin{proof}
\uses{spaces-lemma-composition-representable-transformations}

Note that the lemma makes sense by
Lemma \ref{spaces-lemma-composition-representable-transformations}.
Proof omitted.
\end{proof}

\begin{lemma}[Base change representable transformations property]
\label{spaces-lemma-base-change-representable-transformations-property}
\source{stacks:02WL}
\href{https://stacks.math.columbia.edu/tag/02WL}{\texttt{Stacks tag 02WL}}
\group{spaces}
...
\begin{proof}
\uses{spaces-lemma-base-change-representable-transformations}

Note that the lemma makes sense by
Lemma \ref{spaces-lemma-base-change-representable-transformations}.
Proof omitted.
\end{proof}

\begin{lemma}[Descent representable transformations property]
\label{spaces-lemma-descent-representable-transformations-property}
\source{stacks:03KD}
\href{https://stacks.math.columbia.edu/tag/03KD}{\texttt{Stacks tag 03KD}}
\group{spaces}
...
$$
\begin{array}{cc}U_i \times_{\xi_i, H, a'} (H \times_{b, G, a} F) \longrightarrow\downarrow & U \times_{\xi, G, a} F \downarrow \\ U_i \longrightarrow & U\end{array}
$$
...
\begin{lemma}[Product representable transformations property]
\label{spaces-lemma-product-representable-transformations-property}
\source{stacks:02WM}
\href{https://stacks.math.columbia.edu/tag/02WM}{\texttt{Stacks tag 02WM}}
\group{spaces}
...
\begin{proof}
\uses{spaces-lemma-product-representable-transformations}

Note that the lemma makes sense by
Lemma \ref{spaces-lemma-product-representable-transformations}.
Proof omitted.
\end{proof}

\begin{lemma}[Representable transformations property implication]
\label{spaces-lemma-representable-transformations-property-implication}
\source{stacks:02YO}
\href{https://stacks.math.columbia.edu/tag/02YO}{\texttt{Stacks tag 02YO}}
\group{spaces}
...
\source{stacks:05VM}
\href{https://stacks.math.columbia.edu/tag/05VM}{\texttt{Stacks tag 05VM}}
\group{spaces}
...
\source{stacks:025W}
\href{https://stacks.math.columbia.edu/tag/025W}{\texttt{Stacks tag 025W}}
\group{spaces}
...
as in Definition \ref{spaces-definition-relative-representable-property}.
In particular this holds for $\mathcal{P} = $ ``surjective''
and $\mathcal{P} = $ ``\'etale'', see
Remark \ref{spaces-remark-list-properties-fpqc-local-base}
above. We will use this remark in the definition
of algebraic spaces below.

\begin{lemma}[Transformation diagonal properties]
\label{spaces-lemma-transformation-diagonal-properties}
\source{stacks:0CB7}
\href{https://stacks.math.columbia.edu/tag/0CB7}{\texttt{Stacks tag 0CB7}}
\group{spaces}
...
\begin{proof}
\uses{spaces-lemma-representable-diagonal, spaces-lemma-morphism-schemes-gives-representable-transformation-property}

Observe that $\Delta$ is representable by
Lemma \ref{spaces-lemma-representable-diagonal}.
...
$$
\begin{array}{cc}F \times_{\Delta, F \times F, (a, b)} h_T \downarrow\longrightarrow & h_T \overset{\Delta_{T/S}}{\downarrow} \\ h_T \times_{a, F, b} h_T \longrightarrow\downarrow & h_{T \times_S T} \overset{(a, b)}{\downarrow} \\ F \overset{\Delta}{\longrightarrow} & F \times F\end{array}
$$
...
\source{stacks:025Y}
\href{https://stacks.math.columbia.edu/tag/025Y}{\texttt{Stacks tag 025Y}}
\group{spaces}

\uses{spaces-lemma-representable-diagonal, spaces-definition-relative-representable-property, spaces-remark-warning}
Let $S$ be a scheme contained in $\Sch_{fppf}$.
...
Lemma \ref{spaces-lemma-representable-diagonal},
Definition \ref{spaces-definition-relative-representable-property}, and
Remark \ref{spaces-remark-warning}.}.
\end{enumerate}
\end{definition}
...
\begin{lemma}[Scheme is space]
\label{spaces-lemma-scheme-is-space}
\source{stacks:025Z}
\href{https://stacks.math.columbia.edu/tag/025Z}{\texttt{Stacks tag 025Z}}
\group{spaces}
...
\begin{proof}
The functor $h_T$ is a sheaf by our remarks in Section \ref{spaces-section-general}.
...
\begin{definition}[Morphism algebraic spaces]
\label{spaces-definition-morphism-algebraic-spaces}
\source{stacks:0260}
\href{https://stacks.math.columbia.edu/tag/0260}{\texttt{Stacks tag 0260}}
\group{spaces}
...
\begin{lemma}[Product spaces]
\label{spaces-lemma-product-spaces}
\source{stacks:02X0}
\href{https://stacks.math.columbia.edu/tag/02X0}{\texttt{Stacks tag 02X0}}
\group{spaces}
...
\begin{proof}
\uses{spaces-lemma-product-representable-transformations, spaces-lemma-product-representable-transformations-property}
...
by Lemma \ref{spaces-lemma-product-representable-transformations-property}.
\end{proof}

\begin{lemma}[Fibre product spaces over sheaf with representable diagonal]
\label{spaces-lemma-fibre-product-spaces-over-sheaf-with-representable-diagonal}
\source{stacks:04T9}
\href{https://stacks.math.columbia.edu/tag/04T9}{\texttt{Stacks tag 04T9}}
\group{spaces}
...
\begin{proof}
\uses{spaces-definition-algebraic-space, spaces-lemma-product-representable-transformations, spaces-lemma-base-change-representable-transformations, spaces-lemma-composition-representable-transformations}

We check the 3 conditions of
Definition \ref{spaces-definition-algebraic-space}.
...
$$
\begin{array}{cc}F \times_H G \longrightarrow\underset{\Delta}{\downarrow} & F \times G \overset{\Delta_F \times \Delta_G}{\downarrow} \\ (F \times F) \times_{(H \times H)} (G \times G) \longrightarrow & (F \times F) \times (G \times G)\end{array}
$$
...
Lemmas \ref{spaces-lemma-product-representable-transformations} and
...
Lemmas \ref{spaces-lemma-composition-representable-transformations} and
\ref{spaces-lemma-base-change-representable-transformations}.
...
\begin{lemma}[Fibre product spaces]
\label{spaces-lemma-fibre-product-spaces}
\source{stacks:02X2}
\href{https://stacks.math.columbia.edu/tag/02X2}{\texttt{Stacks tag 02X2}}
\group{spaces}
...
\begin{proof}
\uses{spaces-lemma-fibre-product-spaces-over-sheaf-with-representable-diagonal}

It follows from the stronger
Lemma \ref{spaces-lemma-fibre-product-spaces-over-sheaf-with-representable-diagonal}
...
\begin{lemma}[Coproduct sheaves open and closed]
\label{spaces-lemma-coproduct-sheaves-open-and-closed}
\source{stacks:0F15}
\href{https://stacks.math.columbia.edu/tag/0F15}{\texttt{Stacks tag 0F15}}
\group{spaces}
...
\begin{lemma}[Representable sheaf coproduct sheaves]
\label{spaces-lemma-representable-sheaf-coproduct-sheaves}
\source{stacks:02WO}
\href{https://stacks.math.columbia.edu/tag/02WO}{\texttt{Stacks tag 02WO}}
\group{spaces}
...
\begin{proof}
\uses{spaces-lemma-coproduct-sheaves-open-and-closed}

By Lemma \ref{spaces-lemma-coproduct-sheaves-open-and-closed}
...
\begin{lemma}[Algebraic space coproduct sheaves]
\label{spaces-lemma-algebraic-space-coproduct-sheaves}
\source{stacks:02WP}
\href{https://stacks.math.columbia.edu/tag/02WP}{\texttt{Stacks tag 02WP}}
\group{spaces}
...
\begin{proof}
\uses{spaces-lemma-base-change-representable-transformations-property, spaces-lemma-coproduct-sheaves-open-and-closed, spaces-definition-algebraic-space}
...
by Lemma \ref{spaces-lemma-base-change-representable-transformations-property}.
On the other hand, $U \times_F F_i$ is a scheme by
Lemma \ref{spaces-lemma-coproduct-sheaves-open-and-closed}.
...
\begin{lemma}[Coproduct algebraic spaces]
\label{spaces-lemma-coproduct-algebraic-spaces}
\source{stacks:02WQ}
\href{https://stacks.math.columbia.edu/tag/02WQ}{\texttt{Stacks tag 02WQ}}
\group{spaces}
...
\begin{lemma}[Glueing algebraic spaces]
\label{spaces-lemma-glueing-algebraic-spaces}
\source{stacks:02WR}
\href{https://stacks.math.columbia.edu/tag/02WR}{\texttt{Stacks tag 02WR}}
\group{spaces}

\uses{spaces-definition-relative-representable-property, spaces-lemma-coproduct-algebraic-spaces}
Let $S \in \Ob(\Sch_{fppf})$.
Let $F$ be a presheaf of sets on $(\Sch/S)_{fppf}$.
Assume
\begin{enumerate}
...
Lemma \ref{spaces-lemma-coproduct-algebraic-spaces}).
\end{enumerate}
\end{enumerate}
...
\begin{proof}
\uses{spaces-definition-relative-representable-property, spaces-remark-warning, spaces-lemma-representable-diagonal, spaces-lemma-representable-sheaf-coproduct-sheaves, spaces-lemma-composition-representable-transformations-property}
...
Definition \ref{spaces-definition-relative-representable-property}
(see Remark \ref{spaces-remark-warning} for a discussion).
...
see Lemma \ref{spaces-lemma-representable-sheaf-coproduct-sheaves}.
...
by applying
Lemma \ref{spaces-lemma-composition-representable-transformations-property}.
...
\begin{lemma}[Space presentation]
\label{spaces-lemma-space-presentation}
\source{stacks:0262}
\href{https://stacks.math.columbia.edu/tag/0262}{\texttt{Stacks tag 0262}}
\group{spaces}
...
\item the diagram
$$
\begin{array}{ccc}R \longrightarrow\longrightarrow & U \longrightarrow & F\end{array}
$$
...
\source{stacks:02WS}
\href{https://stacks.math.columbia.edu/tag/02WS}{\texttt{Stacks tag 02WS}}
\group{spaces}
...
\source{stacks:0263}
\href{https://stacks.math.columbia.edu/tag/0263}{\texttt{Stacks tag 0263}}
\group{spaces}
...
equivalence relation on $U$ over $S$, see Theorem \ref{spaces-theorem-presentation}.
...
of it in Definition \ref{spaces-definition-algebraic-space}.

\begin{lemma}[Pullback etale equivalence relation]
\label{spaces-lemma-pullback-etale-equivalence-relation}
\source{stacks:02WT}
\href{https://stacks.math.columbia.edu/tag/02WT}{\texttt{Stacks tag 02WT}}
\group{spaces}
...
\begin{lemma}[Finding opens]
\label{spaces-lemma-finding-opens}
\source{stacks:02WU}
\href{https://stacks.math.columbia.edu/tag/02WU}{\texttt{Stacks tag 02WU}}
\group{spaces}
...
$$
\begin{array}{cc}T_j \underset{a_j}{\longrightarrow}\downarrow & U \downarrow \\ T \overset{a}{\longrightarrow} & F\end{array}
$$
commute.
...
$$
\begin{array}{ccc}W'_j \longrightarrow\downarrow\searrow &  & U' \overset{g}{\downarrow} \\  & s^{-1}(W^1) \underset{s}{\longrightarrow}\overset{t}{\downarrow} & W^1 \downarrow \\ W_j \overset{a_j|_{W_j}}{\longrightarrow} & W \longrightarrow & F\end{array}
$$
...
$$
\begin{array}{ccc}T'_i \underset{b_i}{\longrightarrow}\underset{f_j \circ \psi_i}{\downarrow} & U' \underset{g}{\longrightarrow} & U \downarrow \\ T_j \overset{a_j}{\longrightarrow} & U \longrightarrow & F\end{array}
$$
...
\begin{lemma}[When it works it works]
\label{spaces-lemma-when-it-works-it-works}
\source{stacks:02WV}
\href{https://stacks.math.columbia.edu/tag/02WV}{\texttt{Stacks tag 02WV}}
\group{spaces}
...
\begin{proof}
\uses{spaces-remark-list-properties-fpqc-local-base}
...
\begin{lemma}[Presentation quasi compact]
\label{spaces-lemma-presentation-quasi-compact}
\source{stacks:0265}
\href{https://stacks.math.columbia.edu/tag/0265}{\texttt{Stacks tag 0265}}
\group{spaces}
...
\begin{proof}
\uses{spaces-lemma-finding-opens, spaces-lemma-when-it-works-it-works, spaces-remark-list-properties-fpqc-local-base, spaces-lemma-product-representable-transformations, spaces-lemma-product-representable-transformations-property, spaces-remark-list-properties-stable-composition, spaces-lemma-base-change-representable-transformations, spaces-lemma-morphism-schemes-gives-representable-transformation, spaces-lemma-composition-representable-transformations}
...
is representable.
As seen in the proofs of Lemmas \ref{spaces-lemma-finding-opens} and
\ref{spaces-lemma-when-it-works-it-works} there exists an fppf covering
$\{\varphi_i : T_i \to T\}_{i \in I}$ and morphisms $a_i : T_i \to U$
such that $a_i \times a_{i'} : T_i \times_T T_{i'} \to U \times_S U$
factors through $R$, and such that $c \circ a_i = a \circ \varphi_i$.
As in the proof of Lemma \ref{spaces-lemma-when-it-works-it-works} we see that
\begin{eqnarray*}
...
Lemma \ref{spaces-lemma-when-it-works-it-works} in the current
situation.
...
$$
\begin{array}{cc}R \longrightarrow\underset{j}{\downarrow} & F \overset{\Delta}{\downarrow} \\ U \times_S U \longrightarrow & F \times F\end{array}
$$
is a fibre product square. By
Lemma \ref{spaces-lemma-product-representable-transformations} the morphism
$U \times_S U \to F \times F$ is representable (note that
$h_U \times h_U = h_{U \times_S U}$). Moreover, by
Lemma \ref{spaces-lemma-product-representable-transformations-property}
the morphism $U \times_S U \to F \times F$ is surjective
and \'etale (note also that \'etale and surjective occur in the lists of
Remarks \ref{spaces-remark-list-properties-fpqc-local-base}
and \ref{spaces-remark-list-properties-stable-composition}).
It follows either from
Lemma \ref{spaces-lemma-base-change-representable-transformations}
and the diagram above, or by writing $R \to F$ as $R \to U \to F$ and
Lemmas
\ref{spaces-lemma-morphism-schemes-gives-representable-transformation} and
\ref{spaces-lemma-composition-representable-transformations} that
...
$$
\begin{array}{cccc} & R \longrightarrow\downarrow &  & F \downarrow \\ T' \times_T G \longrightarrow\downarrow\nearrow &  & G \downarrow\nearrow &  \\  & U \times_S U \longrightarrow &  & F \times F \\ T' \longrightarrow\nearrow &  & T \nearrow & \end{array}
$$
...
\begin{theorem}[Presentation]
\label{spaces-theorem-presentation}
\source{stacks:02WW}
\href{https://stacks.math.columbia.edu/tag/02WW}{\texttt{Stacks tag 02WW}}
\group{spaces}
...
\begin{proof}
\uses{spaces-lemma-when-it-works-it-works, spaces-lemma-pullback-etale-equivalence-relation, spaces-lemma-finding-opens, spaces-lemma-presentation-quasi-compact, spaces-lemma-coproduct-algebraic-spaces, spaces-lemma-glueing-algebraic-spaces}

By Lemma \ref{spaces-lemma-when-it-works-it-works}
...
By Lemma \ref{spaces-lemma-pullback-etale-equivalence-relation} $R'$ is an
...
By Lemma \ref{spaces-lemma-pullback-etale-equivalence-relation}
this is an \'etale equivalence relation.
Set $F_i = U_i/R_i$ and $F = U/R$.
It is clear that $\coprod F_i \to F$ is surjective.
By Lemma \ref{spaces-lemma-finding-opens} each $F_i \to F$
...
Then by Lemma \ref{spaces-lemma-when-it-works-it-works} we see that
$U_i \to F_i$ is \'etale and surjective.
From Lemma \ref{spaces-lemma-coproduct-algebraic-spaces}
it follows that $\coprod F_i$ is an algebraic space.
Finally, we have verified all
hypotheses of Lemma \ref{spaces-lemma-glueing-algebraic-spaces}
...
The first result says that in Definition \ref{spaces-definition-algebraic-space}
we can weaken the condition on the diagonal as follows.

\begin{lemma}[Etale locally representable gives space]
\label{spaces-lemma-etale-locally-representable-gives-space}
\source{stacks:0BGQ}
\href{https://stacks.math.columbia.edu/tag/0BGQ}{\texttt{Stacks tag 0BGQ}}
\group{spaces}
...
\begin{proof}
\uses{spaces-theorem-presentation, spaces-lemma-surjective-flat-locally-finite-presentation}
...
relation as $R = U \times_F U$. By Theorem \ref{spaces-theorem-presentation}
...
of sheaves by Lemma \ref{spaces-lemma-surjective-flat-locally-finite-presentation}.
Thus $F' \to F$ is also surjective and we conclude $F' = F$ is an
algebraic space.
\end{proof}

\begin{lemma}[Etale locally representable by space gives space]
\label{spaces-lemma-etale-locally-representable-by-space-gives-space}
\source{stacks:0BGR}
\href{https://stacks.math.columbia.edu/tag/0BGR}{\texttt{Stacks tag 0BGR}}
\group{spaces}
...
\begin{proof}
\uses{spaces-lemma-composition-representable-transformations, spaces-lemma-composition-representable-transformations-property, spaces-lemma-etale-locally-representable-gives-space}
...
\ref{spaces-lemma-composition-representable-transformations} and
\ref{spaces-lemma-composition-representable-transformations-property}.
Thus $F$ is an algebraic space by
Lemma \ref{spaces-lemma-etale-locally-representable-gives-space}.
\end{proof}

\begin{lemma}[A functor that admits a representable morphism to an algebraic space is an algebraic sp...]
\label{spaces-lemma-representable-over-space}
\source{stacks:02WY}
\href{https://stacks.math.columbia.edu/tag/02WY}{\texttt{Stacks tag 02WY}}
\group{spaces}
...
\begin{proof}
\uses{spaces-lemma-representable-transformation-to-sheaf, spaces-lemma-base-change-representable-transformations, spaces-lemma-representable-transformation-diagonal, spaces-lemma-composition-representable-transformations, spaces-lemma-base-change-representable-transformations-property, spaces-definition-algebraic-space}

By Lemma \ref{spaces-lemma-representable-transformation-to-sheaf}
we see that $G$ is a sheaf. The diagram
$$
\begin{array}{cc}G \times_F G \longrightarrow\downarrow & F \overset{\Delta_F}{\downarrow} \\ G \times G \longrightarrow & F \times F\end{array}
$$
is cartesian. Hence we see that $G \times_F G \to G \times G$
is representable by
Lemma \ref{spaces-lemma-base-change-representable-transformations}.
By
Lemma \ref{spaces-lemma-representable-transformation-diagonal}
...
the final condition of Definition \ref{spaces-definition-algebraic-space} and we win.
\end{proof}

\begin{lemma}[Representable morphisms spaces property]
\label{spaces-lemma-representable-morphisms-spaces-property}
\source{stacks:02WZ}
\href{https://stacks.math.columbia.edu/tag/02WZ}{\texttt{Stacks tag 02WZ}}
\group{spaces}
...
of schemes as in Definition \ref{spaces-definition-relative-representable-property}.
Then $G \to F$ has property $\mathcal{P}$ if and only if
$V \to U$ has property $\mathcal{P}$.
\end{lemma}

\begin{proof}
\uses{spaces-lemma-base-change-representable-transformations-property, spaces-lemma-descent-representable-transformations-property}

(This lemma follows from
Lemmas \ref{spaces-lemma-base-change-representable-transformations-property} and
...
$$
\begin{array}{cccc}V \downarrow & T \times_F V \downarrow\longleftarrow\longrightarrow & T \times_F G \downarrow\xlongequal{} & T' \\ U & T \times_F U \longleftarrow\longrightarrow & T & \end{array}
$$
...
\begin{lemma}[Morphism sheaves with P effective descent etale]
\label{spaces-lemma-morphism-sheaves-with-P-effective-descent-etale}
\source{stacks:03I2}
\href{https://stacks.math.columbia.edu/tag/03I2}{\texttt{Stacks tag 03I2}}
\group{spaces}
...
\begin{proof}
\uses{spaces-lemma-representable-over-space, spaces-lemma-representable-morphisms-spaces-property}
...
Lemma \ref{spaces-lemma-representable-over-space}. The fact that $G \to F$ has
property $\mathcal{P}$ now follows from
Lemma \ref{spaces-lemma-representable-morphisms-spaces-property}.
\end{proof}

\begin{lemma}[Lift morphism presentations]
\label{spaces-lemma-lift-morphism-presentations}
\source{stacks:02X1}
\href{https://stacks.math.columbia.edu/tag/02X1}{\texttt{Stacks tag 02X1}}
\group{spaces}
...
$$
\begin{array}{cc}U \underset{p}{\downarrow}\underset{\alpha}{\longrightarrow} & V \overset{q}{\downarrow} \\ F \overset{a}{\longrightarrow} & G\end{array}
$$
with $p$ surjective and \'etale.
\end{lemma}

\begin{proof}
\uses{spaces-lemma-base-change-representable-transformations-property, spaces-lemma-composition-representable-transformations-property}
...
\source{stacks:02YU}
\href{https://stacks.math.columbia.edu/tag/02YU}{\texttt{Stacks tag 02YU}}
\group{spaces}
...
in the sense of Definition \ref{spaces-definition-relative-representable-property}.
...
and Lemma \ref{spaces-lemma-representable-transformations-property-implication}),
...
\begin{lemma}[Composition immersions]
\label{spaces-lemma-composition-immersions}
\source{stacks:02YV}
\href{https://stacks.math.columbia.edu/tag/02YV}{\texttt{Stacks tag 02YV}}
\group{spaces}
...
\begin{proof}
\uses{spaces-lemma-composition-representable-transformations-property, spaces-remark-list-properties-fpqc-local-base, spaces-remark-list-properties-stable-composition}

See Lemma \ref{spaces-lemma-composition-representable-transformations-property} and
Remarks \ref{spaces-remark-list-properties-fpqc-local-base} (see very last line of
that remark) and \ref{spaces-remark-list-properties-stable-composition}.
\end{proof}

\begin{lemma}[Base change immersions]
\label{spaces-lemma-base-change-immersions}
\source{stacks:02YW}
\href{https://stacks.math.columbia.edu/tag/02YW}{\texttt{Stacks tag 02YW}}
\group{spaces}
...
\begin{proof}
\uses{spaces-lemma-base-change-representable-transformations-property, spaces-remark-list-properties-fpqc-local-base}

See Lemma \ref{spaces-lemma-base-change-representable-transformations-property} and
Remark \ref{spaces-remark-list-properties-fpqc-local-base} (see very last line of
that remark).
\end{proof}

\begin{lemma}[Sub subspaces]
\label{spaces-lemma-sub-subspaces}
\source{stacks:02YX}
\href{https://stacks.math.columbia.edu/tag/02YX}{\texttt{Stacks tag 02YX}}
\group{spaces}
...
algebraic spaces. Note that in Lemma \ref{spaces-lemma-glueing-algebraic-spaces}
we have already encountered such open coverings as a method for
constructing algebraic spaces.

\begin{definition}[Zariski open covering]
\label{spaces-definition-Zariski-open-covering}
\source{stacks:02YY}
\href{https://stacks.math.columbia.edu/tag/02YY}{\texttt{Stacks tag 02YY}}
\group{spaces}
...
immersions by Lemma \ref{spaces-lemma-sub-subspaces}). Finally,
Definition \ref{spaces-definition-Zariski-open-covering}
...
\begin{definition}[Small Zariski site]
\label{spaces-definition-small-Zariski-site}
\source{stacks:02YZ}
\href{https://stacks.math.columbia.edu/tag/02YZ}{\texttt{Stacks tag 02YZ}}
\group{spaces}
...
\source{stacks:02X4}
\href{https://stacks.math.columbia.edu/tag/02X4}{\texttt{Stacks tag 02X4}}
\group{spaces}
...
\begin{proof}
\uses{spaces-lemma-presentation-quasi-compact, spaces-lemma-representable-morphisms-spaces-property, spaces-remark-list-properties-stable-base-change, spaces-remark-list-properties-fpqc-local-base}

Let $F = U/R$ be a presentation of $F$.
As in the proof of Lemma \ref{spaces-lemma-presentation-quasi-compact} the diagram
$$
\begin{array}{cc}R \longrightarrow\underset{j}{\downarrow} & F \overset{\Delta}{\downarrow} \\ U \times_S U \longrightarrow & F \times F\end{array}
$$
...
of Remarks \ref{spaces-remark-list-properties-stable-base-change}
and \ref{spaces-remark-list-properties-fpqc-local-base}.)
...
\source{stacks:02X5}
\href{https://stacks.math.columbia.edu/tag/02X5}{\texttt{Stacks tag 02X5}}
\group{spaces}
...
\begin{example}[Affine line involution]
\label{spaces-example-affine-line-involution}
\source{stacks:02Z1}
\href{https://stacks.math.columbia.edu/tag/02Z1}{\texttt{Stacks tag 02Z1}}
\group{spaces}

\uses{spaces-theorem-presentation}
...
\begin{example}[Non representable descent]
\label{spaces-example-non-representable-descent}
\source{stacks:03FN}
\href{https://stacks.math.columbia.edu/tag/03FN}{\texttt{Stacks tag 03FN}}
\group{spaces}
...
Theorem \ref{spaces-theorem-presentation}. Here are some properties of $X$ (some
...
\source{stacks:02Z2}
\href{https://stacks.math.columbia.edu/tag/02Z2}{\texttt{Stacks tag 02Z2}}
\group{spaces}
...
F = U/R
$$
is an algebraic space by Theorem \ref{spaces-theorem-presentation}.
\end{lemma}
...
of $G$ on $U$ is {\it free} if condition $(*)$ of Lemma \ref{spaces-lemma-quotient}
...
\source{stacks:02Z3}
\href{https://stacks.math.columbia.edu/tag/02Z3}{\texttt{Stacks tag 02Z3}}
\group{spaces}

\uses{spaces-lemma-quotient}
Notation $U \to S$, $G$, $R$ as in Lemma \ref{spaces-lemma-quotient}.
...
\begin{lemma}[Quotient finite separated]
\label{spaces-lemma-quotient-finite-separated}
\source{stacks:02Z4}
\href{https://stacks.math.columbia.edu/tag/02Z4}{\texttt{Stacks tag 02Z4}}
\group{spaces}

\uses{spaces-lemma-quotient}
Notation and assumptions as in Lemma \ref{spaces-lemma-quotient}.
...
\begin{proof}
\uses{spaces-lemma-properties-diagonal}

In the proof of Lemma \ref{spaces-lemma-properties-diagonal}
...
\begin{lemma}[Quotient field map]
\label{spaces-lemma-quotient-field-map}
\source{stacks:02Z5}
\href{https://stacks.math.columbia.edu/tag/02Z5}{\texttt{Stacks tag 02Z5}}
\group{spaces}
...
Here is a diagram
$$
\begin{array}{cc}V \longrightarrow\downarrow & U \downarrow \\ \Spec(k) \longrightarrow & U/G\end{array}
$$
...
\source{stacks:02Z6}
\href{https://stacks.math.columbia.edu/tag/02Z6}{\texttt{Stacks tag 02Z6}}
\group{spaces}

\uses{spaces-lemma-quotient, spaces-lemma-quotient-field-map}
Let $S = \Spec(\mathbf{Q})$.
...
Lemma \ref{spaces-lemma-quotient} holds and we obtain an algebraic space
$$
...
then it follows from Lemma \ref{spaces-lemma-quotient-field-map} and the theorem
...
\begin{example}[Affine line translation]
\label{spaces-example-affine-line-translation}
\source{stacks:02Z7}
\href{https://stacks.math.columbia.edu/tag/02Z7}{\texttt{Stacks tag 02Z7}}
\group{spaces}

\uses{spaces-lemma-quotient-field-map}
...
Lemma \ref{spaces-lemma-quotient-field-map} that for any such
...
\begin{example}[Infinite product]
\label{spaces-example-infinite-product}
\source{stacks:02Z8}
\href{https://stacks.math.columbia.edu/tag/02Z8}{\texttt{Stacks tag 02Z8}}
\group{spaces}
...
\begin{lemma}[Change big site]
\label{spaces-lemma-change-big-site}
\source{stacks:03FP}
\href{https://stacks.math.columbia.edu/tag/03FP}{\texttt{Stacks tag 03FP}}
\group{spaces}
...
\begin{proof}
\uses{spaces-lemma-space-presentation, spaces-theorem-presentation}
...
\medskip\noindent
Next, suppose that $F$
is an algebraic space over $S$. By Lemma \ref{spaces-lemma-space-presentation}
...
$f^{-1}F$ is an algebraic space over $S$ by Theorem \ref{spaces-theorem-presentation}.
\end{proof}
...
\source{stacks:04W1}
\href{https://stacks.math.columbia.edu/tag/04W1}{\texttt{Stacks tag 04W1}}
\group{spaces}

\uses{spaces-lemma-change-big-site}
...
Lemma \ref{spaces-lemma-change-big-site}
...
$$
\begin{array}{ccc}U' \times_{X'} U' \downarrow & \tilde U \times_{X'} \tilde U  \longleftarrow\downarrow\longrightarrow & U \times_{X'} U \downarrow \\ U' \times_S U' & \tilde U \times_S \tilde U \longleftarrow\longrightarrow & U \times_S U\end{array}
$$
...
Lemma \ref{spaces-lemma-space-presentation} and
Theorem \ref{spaces-theorem-presentation} imply that $X = h_{U'}/h_{R'}$
...
\begin{lemma}[Change base scheme]
\label{spaces-lemma-change-base-scheme}
\source{stacks:03I4}
\href{https://stacks.math.columbia.edu/tag/03I4}{\texttt{Stacks tag 03I4}}
\group{spaces}
...
(Lemma \ref{spaces-lemma-space-presentation})
and we get
$$
j_!F = j(U)/j(R)
$$
...
\source{stacks:03I5}
\href{https://stacks.math.columbia.edu/tag/03I5}{\texttt{Stacks tag 03I5}}
\group{spaces}

\uses{spaces-lemma-change-base-scheme}
...
Lemma \ref{spaces-lemma-change-base-scheme}. We denote it $F'_S$.
...
Lemma \ref{spaces-lemma-change-base-scheme}. We often simply denote this
...
Lemma \ref{spaces-lemma-change-base-scheme}).
In fact, in
...
\begin{lemma}[Category of spaces over smaller base scheme]
\label{spaces-lemma-category-of-spaces-over-smaller-base-scheme}
\source{stacks:04SG}
\href{https://stacks.math.columbia.edu/tag/04SG}{\texttt{Stacks tag 04SG}}
\group{spaces}
...
\begin{proof}
\uses{spaces-lemma-change-base-scheme, spaces-lemma-space-presentation, spaces-theorem-presentation}
...
\begin{lemma}[Rephrase]
\label{spaces-lemma-rephrase}
\source{stacks:04SH}
\href{https://stacks.math.columbia.edu/tag/04SH}{\texttt{Stacks tag 04SH}}
\group{spaces}
...
\begin{proof}
\uses{spaces-lemma-category-of-spaces-over-smaller-base-scheme}

The restriction and the product match under
the equivalence of categories of
Sites, Lemma \ref{sites-lemma-essential-image-j-shriek}
so that
Lemma \ref{spaces-lemma-category-of-spaces-over-smaller-base-scheme}
above gives the result.
\end{proof}

We finish this section with a lemma on a compatibility.

\begin{lemma}[Viewed as properties]
\label{spaces-lemma-viewed-as-properties}
\source{stacks:03I6}
\href{https://stacks.math.columbia.edu/tag/03I6}{\texttt{Stacks tag 03I6}}
\group{spaces}

\uses{spaces-lemma-category-of-spaces-over-smaller-base-scheme, spaces-definition-relative-representable-property}
Let $\Sch_{fppf}$ be a big fppf site.
Let $S \to S'$ be a morphism of this site.
Let $F$ be an algebraic space over $S$.
...
\begin{proof}
\uses{spaces-lemma-change-base-scheme, spaces-lemma-representable-morphisms-spaces-property}
