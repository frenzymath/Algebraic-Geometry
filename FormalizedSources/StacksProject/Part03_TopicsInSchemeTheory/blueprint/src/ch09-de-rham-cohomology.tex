...
\begin{lemma}[Base change de rham]
\label{derham-lemma-base-change-de-rham}
\source{stacks:0FL5}
\href{https://stacks.math.columbia.edu/tag/0FL5}{\texttt{Stacks tag 0FL5}}
\group{derham}
...
\source{stacks:0FLV}
\href{https://stacks.math.columbia.edu/tag/0FLV}{\texttt{Stacks tag 0FLV}}
\group{derham}
...
\begin{array}{cc}X' \underset{f}{\longrightarrow}\downarrow & X \downarrow \\ S' \longrightarrow & S\end{array}
$$
of schemes, using the canonical maps of Section \ref{derham-section-de-rham-complex}
...
\begin{lemma}[De rham affine]
\label{derham-lemma-de-rham-affine}
\source{stacks:0FLW}
\href{https://stacks.math.columbia.edu/tag/0FLW}{\texttt{Stacks tag 0FLW}}
\group{derham}
...
\begin{lemma}[Quasi coherence relative]
\label{derham-lemma-quasi-coherence-relative}
\source{stacks:0FLX}
\href{https://stacks.math.columbia.edu/tag/0FLX}{\texttt{Stacks tag 0FLX}}
\group{derham}
...
\begin{lemma}[Coherence relative]
\label{derham-lemma-coherence-relative}
\source{stacks:0FLY}
\href{https://stacks.math.columbia.edu/tag/0FLY}{\texttt{Stacks tag 0FLY}}
\group{derham}
...
\begin{proof}
\uses{derham-lemma-quasi-coherence-relative}
...
same argument as in the proof of Lemma \ref{derham-lemma-quasi-coherence-relative}
using Cohomology of Schemes, Proposition
\ref{coherent-proposition-proper-pushforward-coherent}.
\end{proof}

\begin{lemma}[Finite de Rham]
\label{derham-lemma-finite-de-Rham}
\source{stacks:0FLZ}
\href{https://stacks.math.columbia.edu/tag/0FLZ}{\texttt{Stacks tag 0FLZ}}
\group{derham}
...
\begin{proof}
\uses{derham-lemma-coherence-relative}

This is a special case of Lemma \ref{derham-lemma-coherence-relative}.
\end{proof}

\begin{lemma}[Proper smooth de Rham]
\label{derham-lemma-proper-smooth-de-Rham}
\source{stacks:0FM0}
\href{https://stacks.math.columbia.edu/tag/0FM0}{\texttt{Stacks tag 0FM0}}
\group{derham}
...
\begin{proof}
\uses{derham-lemma-base-change-de-rham}
...
Lemma \ref{derham-lemma-base-change-de-rham}. Hence
...
Using the formula for $\text{d}$ given in Section \ref{derham-section-de-rham-complex}
...
\begin{lemma}[Cup product graded commutative]
\label{derham-lemma-cup-product-graded-commutative}
\source{stacks:0FM3}
\href{https://stacks.math.columbia.edu/tag/0FM3}{\texttt{Stacks tag 0FM3}}
\group{derham}
...
\begin{remark}[Relative cup product]
\label{derham-remark-relative-cup-product}
\source{stacks:0FU6}
\href{https://stacks.math.columbia.edu/tag/0FU6}{\texttt{Stacks tag 0FU6}}
\group{derham}
...
$$
\begin{array}{cc}X \underset{p}{\downarrow}\underset{f}{\longrightarrow} & Y \overset{q}{\downarrow} \\ S \overset{h}{\longrightarrow} & T\end{array}
$$
...
\begin{remark}[Cup product as a map]
\label{derham-remark-cup-product-as-a-map}
\source{stacks:0FU7}
\href{https://stacks.math.columbia.edu/tag/0FU7}{\texttt{Stacks tag 0FU7}}
\group{derham}

\uses{derham-remark-relative-cup-product}
...
\item for any diagram as in Remark \ref{derham-remark-relative-cup-product}
we obtain a commutative diagram
$$
\begin{array}{cc}Rf_*\Omega^\bullet_{X/S}
\otimes_{q^{-1}\mathcal{O}_T}^\mathbf{L}
Rf_*\Omega^\bullet_{X/S} \underset{\xi' \otimes \text{id}}{\downarrow}\underset{\mu}{\longrightarrow} & Rf_*\Omega^\bullet_{X/S} \overset{\xi'}{\downarrow} \\ Rf_*\Omega^\bullet_{X/S}[n]
\otimes_{q^{-1}\mathcal{O}_T}^\mathbf{L}
Rf_*\Omega^\bullet_{X/S}
\overset{\mu}{\longrightarrow} & Rf_*\Omega^\bullet_{X/S}[n]\end{array}
$$
...
\begin{lemma}[Cup product hodge graded commutative]
\label{derham-lemma-cup-product-hodge-graded-commutative}
\source{stacks:0FM5}
\href{https://stacks.math.columbia.edu/tag/0FM5}{\texttt{Stacks tag 0FM5}}
\group{derham}
...
\begin{proof}
\uses{derham-lemma-cup-product-graded-commutative}

The proof is identical to the proof of
Lemma \ref{derham-lemma-cup-product-graded-commutative}.
\end{proof}
...
Here is a picture
$$
\begin{array}{cccc}H^2(X, \mathcal{O}_X) \longrightarrow\searrow\searrow & H^2(X, \Omega^1_{X/S}) \longrightarrow\searrow & H^2(X, \Omega^2_{X/S}) \longrightarrow & H^2(X, \Omega^3_{X/S}) \\ H^1(X, \mathcal{O}_X) \longrightarrow\searrow & H^1(X, \Omega^1_{X/S}) \longrightarrow\searrow & H^1(X, \Omega^2_{X/S}) \longrightarrow & H^1(X, \Omega^3_{X/S}) \\ H^0(X, \mathcal{O}_X) \longrightarrow & H^0(X, \Omega^1_{X/S}) \longrightarrow & H^0(X, \Omega^2_{X/S}) \longrightarrow & H^0(X, \Omega^3_{X/S})\end{array}
$$
...
Here is a picture
$$
\begin{array}{cccc}H^0(X, \mathcal{H}^2) \searrow\searrow & H^1(X, \mathcal{H}^2) \searrow & H^2(X, \mathcal{H}^2) & H^3(X, \mathcal{H}^2) \\ H^0(X, \mathcal{H}^1) \searrow & H^1(X, \mathcal{H}^1) \searrow & H^2(X, \mathcal{H}^1) & H^3(X, \mathcal{H}^1) \\ H^0(X, \mathcal{H}^0) & H^1(X, \mathcal{H}^0) & H^2(X, \mathcal{H}^0) & H^3(X, \mathcal{H}^0)\end{array}
$$
...
\source{stacks:0FM8}
\href{https://stacks.math.columbia.edu/tag/0FM8}{\texttt{Stacks tag 0FM8}}
\group{derham}
...
Section \ref{derham-section-hodge-to-de-rham} by
...
$$
\begin{array}{cc}H^n(X, \sigma_{\geq i}\Omega^\bullet_{X/S}))
\times
H^m(X, \sigma_{\geq j}\Omega^\bullet_{X/S}))
\longrightarrow\downarrow & H^{n + m}(X, \sigma_{\geq i + j}\Omega^\bullet_{X/S})) \downarrow \\ H^n_{dR}(X/S) \times
H^m_{dR}(X/S)
\overset{\cup}{\longrightarrow} & H^{n + m}_{dR}(X/S)\end{array}
$$
...
and differential operators of finite order over $S$, see
...
\begin{lemma}[De rham complex product]
\label{derham-lemma-de-rham-complex-product}
\source{stacks:0FMA}
\href{https://stacks.math.columbia.edu/tag/0FMA}{\texttt{Stacks tag 0FMA}}
\group{derham}
...
Lemma \ref{derham-lemma-de-rham-complex-product} with the map
...
\begin{lemma}[Kunneth de rham]
\label{derham-lemma-kunneth-de-rham}
\source{stacks:0FMB}
\href{https://stacks.math.columbia.edu/tag/0FMB}{\texttt{Stacks tag 0FMB}}
\group{derham}
...
\begin{proof}
\uses{derham-lemma-de-rham-complex-product}
...
the result by Lemma \ref{derham-lemma-de-rham-complex-product} and
...
$$
\begin{array}{cc}Ra_*\Omega^\bullet_{X/S}
\otimes_{\mathcal{O}_S}^\mathbf{L}
Rb_*\Omega^\bullet_{Y/S}
\overset{\text{units of adjunction}}{\downarrow} &  \\ Rf_*(p^{-1}\Omega^\bullet_{X/S})
\otimes_{\mathcal{O}_S}^\mathbf{L}
Rf_*(q^{-1}\Omega^\bullet_{Y/S}) \longrightarrow\overset{\text{relative cup product}}{\downarrow} & Rf_*(\Omega^\bullet_{X \times_S Y/S})
\otimes_{\mathcal{O}_S}^\mathbf{L}
Rf_*(\Omega^\bullet_{X \times_S Y/S}) \overset{\text{relative cup product}}{\downarrow} \\ Rf_*(p^{-1}\Omega^\bullet_{X/S}
\otimes_{f^{-1}\mathcal{O}_S}^\mathbf{L}
q^{-1}\Omega^\bullet_{Y/S})
\overset{\text{from derived to usual}}{\downarrow}\longrightarrow & Rf_*(\Omega^\bullet_{X \times_S Y/S}
\otimes_{f^{-1}\mathcal{O}_S}^\mathbf{L}
\Omega^\bullet_{X \times_S Y/S})
\overset{\text{from derived to usual}}{\downarrow} \\ Rf_*\text{Tot}(p^{-1}\Omega^\bullet_{X/S}
\otimes_{f^{-1}\mathcal{O}_S}
q^{-1}\Omega^\bullet_{Y/S}) \longrightarrow\overset{\text{canonical map}}{\downarrow} & Rf_*\text{Tot}(\Omega^\bullet_{X \times_S Y/S}
\otimes_{f^{-1}\mathcal{O}_S}
\Omega^\bullet_{X \times_S Y/S})
\overset{\eta \otimes \omega \mapsto \eta \wedge \omega}{\downarrow} \\ Rf_*\text{Tot}(\Omega^\bullet_{X/S} \boxtimes \Omega^\bullet_{Y/S})
\xlongequal{} & Rf_*\Omega^\bullet_{X \times_S Y/S}\end{array}
$$
...
The final equality is Lemma \ref{derham-lemma-de-rham-complex-product}.
This construction recovers on global section the construction given earlier.

\begin{lemma}[Kunneth de rham relative]
\label{derham-lemma-kunneth-de-rham-relative}
\source{stacks:0FMC}
\href{https://stacks.math.columbia.edu/tag/0FMC}{\texttt{Stacks tag 0FMC}}
\group{derham}
...
\begin{proof}
\uses{derham-lemma-kunneth-de-rham}

Immediate consequence of Lemma \ref{derham-lemma-kunneth-de-rham}.
\end{proof}
...
\begin{lemma}[Pullback c1]
\label{derham-lemma-pullback-c1}
\source{stacks:0FMD}
\href{https://stacks.math.columbia.edu/tag/0FMD}{\texttt{Stacks tag 0FMD}}
\group{derham}
...
$$
\begin{array}{cc}\Pic(X') \underset{c_1^{dR}}{\downarrow} & \Pic(X) \overset{c_1^{dR}}{\downarrow}\overset{f^*}{\longleftarrow} \\ H^2_{dR}(X'/S') & H^2_{dR}(X/S) \underset{f^*}{\longleftarrow}\end{array}
\quad
\begin{array}{cc}\Pic(X') \underset{c_1^{Hodge}}{\downarrow} & \Pic(X) \overset{c_1^{Hodge}}{\downarrow}\overset{f^*}{\longleftarrow} \\ H^1(X', \Omega^1_{X'/S'}) & H^1(X, \Omega^1_{X/S}) \underset{f^*}{\longleftarrow}\end{array}
$$
commute.
\end{lemma}
...
\begin{remark}[Truncations]
\label{derham-remark-truncations}
\source{stacks:0FME}
\href{https://stacks.math.columbia.edu/tag/0FME}{\texttt{Stacks tag 0FME}}
\group{derham}
...
\begin{remark}[Log forms]
\label{derham-remark-log-forms}
\source{stacks:0FMF}
\href{https://stacks.math.columbia.edu/tag/0FMF}{\texttt{Stacks tag 0FMF}}
\group{derham}

\uses{derham-remark-truncations}
...
of Remark \ref{derham-remark-truncations},
\item the image of $\tilde \gamma_1(\mathcal{L})$ under the canonical
...
\source{stacks:0FU9}
\href{https://stacks.math.columbia.edu/tag/0FU9}{\texttt{Stacks tag 0FU9}}
\group{derham}
...
Using the discussion in Remark \ref{derham-remark-de-rham-complex-graded}
...
Remark \ref{derham-remark-de-rham-complex-graded} over affine opens we find that
$$
...
\begin{lemma}[The complex for L star]
\label{derham-lemma-the-complex-for-L-star}
\source{stacks:0FUF}
\href{https://stacks.math.columbia.edu/tag/0FUF}{\texttt{Stacks tag 0FUF}}
\group{derham}
...
\begin{lemma}[The complex for L star gives chern class]
\label{derham-lemma-the-complex-for-L-star-gives-chern-class}
\source{stacks:0FUG}
\href{https://stacks.math.columbia.edu/tag/0FUG}{\texttt{Stacks tag 0FUG}}
\group{derham}

\uses{derham-lemma-the-complex-for-L-star, derham-remark-cup-product-as-a-map}
The ``boundary'' map
$\delta : \Omega^\bullet_{X/S} \to \Omega^\bullet_{X/S}[2]$
in $D(X, f^{-1}\mathcal{O}_S)$ coming from
the short exact sequence in Lemma \ref{derham-lemma-the-complex-for-L-star}
is the map of Remark \ref{derham-remark-cup-product-as-a-map}
...
$$
of the short exact sequence of Lemma \ref{derham-lemma-the-complex-for-L-star}.
...
proof of Lemma \ref{derham-lemma-the-complex-for-L-star}.
...
The uniqueness averted in Remark \ref{derham-remark-cup-product-as-a-map}
shows it suffices to prove that $\delta(1) = c_1^{dR}(\mathcal{L})$.

\medskip\noindent
We claim that there is a commutative diagram
$$
\begin{array}{ccccc}0 \longrightarrow & \mathcal{O}_X^* \longrightarrow\underset{\text{d}\log}{\downarrow} & E \longrightarrow\downarrow & \underline{\mathbf{Z}} \downarrow\longrightarrow & 0 \\ 0 \longrightarrow & \Omega^\bullet_{X/S}[1] \longrightarrow & \Omega^\bullet_{L^\star/S, 0}[1] \longrightarrow & \Omega^\bullet_{X/S} \longrightarrow & 0\end{array}
$$
...
constructed in the proof of Lemma \ref{derham-lemma-the-complex-for-L-star} sends
...
Section \ref{derham-section-first-chern-class}. On the overlaps
...
\begin{lemma}[Push omega a]
\label{derham-lemma-push-omega-a}
\source{stacks:0FUH}
\href{https://stacks.math.columbia.edu/tag/0FUH}{\texttt{Stacks tag 0FUH}}
\group{derham}
...
\begin{lemma}[Line bundle characteristic zero]
\label{derham-lemma-line-bundle-characteristic-zero}
\source{stacks:0FUI}
\href{https://stacks.math.columbia.edu/tag/0FUI}{\texttt{Stacks tag 0FUI}}
\group{derham}
...
\source{stacks:0FUJ}
\href{https://stacks.math.columbia.edu/tag/0FUJ}{\texttt{Stacks tag 0FUJ}}
\group{derham}

\uses{derham-lemma-line-bundle-characteristic-zero}
Lemma \ref{derham-lemma-line-bundle-characteristic-zero} is
...
\begin{lemma}[Euler sequence]
\label{derham-lemma-euler-sequence}
\source{stacks:0FMH}
\href{https://stacks.math.columbia.edu/tag/0FMH}{\texttt{Stacks tag 0FMH}}
\group{derham}
...
\begin{lemma}[Twisted hodge cohomology projective space]
\label{derham-lemma-twisted-hodge-cohomology-projective-space}
\source{stacks:0FUK}
\href{https://stacks.math.columbia.edu/tag/0FUK}{\texttt{Stacks tag 0FUK}}
\group{derham}
...
\begin{proof}
\uses{derham-lemma-euler-sequence}
...
0 \to \Omega \to \mathcal{O}(-1)^{\oplus n + 1} \to \mathcal{O} \to 0
$$
of Lemma \ref{derham-lemma-euler-sequence}. Since $\mathcal{O}(-1)$ has
...
\begin{lemma}[Hodge cohomology projective space]
\label{derham-lemma-hodge-cohomology-projective-space}
\source{stacks:0FMI}
\href{https://stacks.math.columbia.edu/tag/0FMI}{\texttt{Stacks tag 0FMI}}
\group{derham}
...
\begin{proof}
\uses{derham-lemma-twisted-hodge-cohomology-projective-space, derham-lemma-euler-sequence}

We have the vanishing and freeness by
Lemma \ref{derham-lemma-twisted-hodge-cohomology-projective-space}.
...
0 \to \Omega \to \mathcal{O}(-1)^{\oplus n + 1} \to \mathcal{O} \to 0
$$
of Lemma \ref{derham-lemma-euler-sequence}. In the proof of
Lemma \ref{derham-lemma-twisted-hodge-cohomology-projective-space}
we have seen that the generator of $H^1(\mathbf{P}^n_A, \Omega)$
is the boundary $\xi$ of $1 \in H^0(\mathbf{P}^n_A, \mathcal{O})$.
As in the proof of Lemma \ref{derham-lemma-euler-sequence} we will identify
...
see Section \ref{derham-section-first-chern-class}.
...
\to \Omega^{p - 1} \to 0
$$
By the calculation in Section \ref{derham-section-first-chern-class}
...
\begin{lemma}[De rham cohomology projective space]
\label{derham-lemma-de-rham-cohomology-projective-space}
\source{stacks:0FMJ}
\href{https://stacks.math.columbia.edu/tag/0FMJ}{\texttt{Stacks tag 0FMJ}}
\group{derham}
...
\begin{proof}
\uses{derham-lemma-hodge-cohomology-projective-space, derham-remark-truncations}
...
done in Lemma \ref{derham-lemma-hodge-cohomology-projective-space}
...
$$
This follows for example from the discussion in Remark \ref{derham-remark-truncations}
...
of the source (Lemma \ref{derham-lemma-hodge-cohomology-projective-space}),
...
\begin{lemma}[Spectral sequence smooth]
\label{derham-lemma-spectral-sequence-smooth}
\source{stacks:0FMM}
\href{https://stacks.math.columbia.edu/tag/0FMM}{\texttt{Stacks tag 0FMM}}
\group{derham}
...
\begin{remark}[Gauss manin]
\label{derham-remark-gauss-manin}
\source{stacks:0FMN}
\href{https://stacks.math.columbia.edu/tag/0FMN}{\texttt{Stacks tag 0FMN}}
\group{derham}

\uses{derham-lemma-spectral-sequence-smooth}
In Lemma \ref{derham-lemma-spectral-sequence-smooth} consider the cohomology sheaves
$$
...
\begin{lemma}[Relative global generation on fibres]
\label{derham-lemma-relative-global-generation-on-fibres}
\source{stacks:0FMP}
\href{https://stacks.math.columbia.edu/tag/0FMP}{\texttt{Stacks tag 0FMP}}
\group{derham}
...
\begin{proof}
\uses{derham-lemma-proper-smooth-de-Rham}

By Lemma \ref{derham-lemma-proper-smooth-de-Rham}
...
\begin{lemma}[Global generation on fibres]
\label{derham-lemma-global-generation-on-fibres}
\source{stacks:0FUM}
\href{https://stacks.math.columbia.edu/tag/0FUM}{\texttt{Stacks tag 0FUM}}
\group{derham}
...
\begin{proof}
\uses{derham-lemma-de-rham-affine, derham-lemma-spectral-sequence-smooth, derham-lemma-relative-global-generation-on-fibres}

Say $Y = \Spec(A)$ and $S = \Spec(R)$.
In this case $\Omega^\bullet_{A/R}$ computes
$R\Gamma(Y, \Omega^\bullet_{Y/S})$ by Lemma \ref{derham-lemma-de-rham-affine}.
...
Lemma \ref{derham-lemma-spectral-sequence-smooth}.
...
By construction and Lemma \ref{derham-lemma-relative-global-generation-on-fibres}
we see that
$$
\text{gr}^0\tilde x :
...
\begin{proposition}[Global generation on fibres]
\label{derham-proposition-global-generation-on-fibres}
\source{stacks:0FMR}
\href{https://stacks.math.columbia.edu/tag/0FMR}{\texttt{Stacks tag 0FMR}}
\group{derham}
...
\begin{proof}
\uses{derham-remark-cup-product-as-a-map, derham-lemma-spectral-sequence-smooth, derham-lemma-global-generation-on-fibres}

Denote $p : X \to S$ and $q : Y \to S$ be the structure morphisms.
Let $\xi'_i : \Omega^\bullet_{X/S} \to \Omega^\bullet_{X/S}[n_i]$
be the map of Remark \ref{derham-remark-cup-product-as-a-map} corresponding
to $\xi_i$. Denote
$$
\tilde \xi_i :
...
Lemma \ref{derham-lemma-spectral-sequence-smooth} to finish the proof.
...
are affine which is handled by Lemma \ref{derham-lemma-global-generation-on-fibres}
...
\source{stacks:0FMT}
\href{https://stacks.math.columbia.edu/tag/0FMT}{\texttt{Stacks tag 0FMT}}
\group{derham}
...
\begin{proof}
\uses{derham-lemma-de-rham-cohomology-projective-space, derham-proposition-global-generation-on-fibres}
...
$p$ is proper and smooth, see Section \ref{derham-section-projective-space}.
...
Lemma \ref{derham-lemma-de-rham-cohomology-projective-space}. Thus we've verified the
conditions of Proposition \ref{derham-proposition-global-generation-on-fibres}
and we win.
\end{proof}

\begin{remark}[Projective space bundle formula]
\label{derham-remark-projective-space-bundle-formula}
\source{stacks:0FUN}
\href{https://stacks.math.columbia.edu/tag/0FUN}{\texttt{Stacks tag 0FUN}}
\group{derham}

\uses{derham-proposition-projective-space-bundle-formula, derham-proposition-global-generation-on-fibres, derham-remark-cup-product-as-a-map}
In the situation of
...
of Section \ref{derham-section-de-rham-complex}.
...
$$
of Remark \ref{derham-remark-cup-product-as-a-map} corresponding to
$c_1^{dR}(\mathcal{O}_P(1))$. Then
$$
\xi'[2(t - 1)] \circ \ldots \circ \xi'[2] \circ \xi' :
\Omega^\bullet_{P/S} \to \Omega^\bullet_{P/S}[2t]
$$
is the map of Remark \ref{derham-remark-cup-product-as-a-map} corresponding to
$c_1^{dR}(\mathcal{O}_P(1))^t$. Tracing through the choices made in the
proof of Proposition \ref{derham-proposition-global-generation-on-fibres}
we find the value
$$
...
$$
\begin{array}{cc}K \underset{\tilde \xi|_K}{\downarrow}\underset{\text{id}}{\longrightarrow} & M[2] \overset{(\tilde \xi|_M)[2]}{\downarrow} \\ Rp_*\Omega^\bullet_{P/S} \overset{Rp_*\xi'}{\longrightarrow} & Rp_*\Omega^\bullet_{P/S}[2]\end{array}
$$
commutes where $\text{id} : K \to M[2]$ identifies the summand
corresponding to $t$ in the decomposition of $K$ to the summand
...
\begin{definition}[Local product]
\label{derham-definition-local-product}
\source{stacks:0FMV}
\href{https://stacks.math.columbia.edu/tag/0FMV}{\texttt{Stacks tag 0FMV}}
\group{derham}
...
\begin{lemma}[Log complex]
\label{derham-lemma-log-complex}
\source{stacks:0FMW}
\href{https://stacks.math.columbia.edu/tag/0FMW}{\texttt{Stacks tag 0FMW}}
\group{derham}
...
\begin{definition}[Log complex]
\label{derham-definition-log-complex}
\source{stacks:0FUA}
\href{https://stacks.math.columbia.edu/tag/0FUA}{\texttt{Stacks tag 0FUA}}
\group{derham}

\uses{derham-lemma-log-complex}
Let $X \to S$ be a morphism of schemes. Let $Y \subset X$ be an
...
$$
constructed in Lemma \ref{derham-lemma-log-complex} is the
{\it de Rham complex of log poles for $Y \subset X$ over $S$}.
\end{definition}

This complex has many good properties.

\begin{lemma}[Multiplication log]
\label{derham-lemma-multiplication-log}
\source{stacks:0FUP}
\href{https://stacks.math.columbia.edu/tag/0FUP}{\texttt{Stacks tag 0FUP}}
\group{derham}
...
of the complex in the proof of Lemma \ref{derham-lemma-log-complex}.
Details omitted.
\end{proof}
...
$$
\begin{array}{ccccc}0 \longrightarrow & f^{-1}\Omega^\bullet_{X/S} \longrightarrow\downarrow & f^{-1}\Omega^\bullet_{X/S}(\log Y) \longrightarrow\downarrow & f^{-1}\Omega^\bullet_{Y/S}[-1] \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & \Omega^\bullet_{X'/S'} \longrightarrow & \Omega^\bullet_{X'/S'}(\log Y') \longrightarrow & \Omega^\bullet_{Y'/S'}[-1] \longrightarrow & 0\end{array}
$$
Linearizing, for every $p$ we obtain a linear map
$f^*\Omega^p_{X/S}(\log Y) \to \Omega^p_{X'/S'}(\log Y')$.

\begin{lemma}[Gysin via log complex]
\label{derham-lemma-gysin-via-log-complex}
\source{stacks:0FUQ}
\href{https://stacks.math.columbia.edu/tag/0FUQ}{\texttt{Stacks tag 0FUQ}}
\group{derham}

\uses{derham-lemma-log-complex, derham-remark-cup-product-as-a-map}
...
short exact sequence in Lemma \ref{derham-lemma-log-complex}. Denote
$$
\xi' : \Omega^\bullet_{X/S} \to \Omega^\bullet_{X/S}[2]
$$
in $D(X, f^{-1}\mathcal{O}_S)$ the map of
Remark \ref{derham-remark-cup-product-as-a-map}
...
Remark \ref{derham-remark-cup-product-as-a-map} corresponding to
$\zeta = c_1^{dR}(\mathcal{O}_X(-Y)|_Y)$. Then the diagram
$$
\begin{array}{cc}\Omega^\bullet_{X/S} \underset{\xi'}{\downarrow}\longrightarrow & \Omega^\bullet_{Y/S} \overset{\zeta'}{\downarrow}\underset{\delta}{\swarrow} \\ \Omega^\bullet_{X/S}[2] \longrightarrow & \Omega^\bullet_{Y/S}[2]\end{array}
$$
is commutative in $D(X, f^{-1}\mathcal{O}_S)$.
\end{lemma}

\begin{proof}
\uses{derham-lemma-the-complex-for-L-star-gives-chern-class, derham-lemma-the-complex-for-L-star, derham-lemma-log-complex}
...
By Lemma \ref{derham-lemma-the-complex-for-L-star-gives-chern-class}
the map $\xi'$ is the boundary map of the triangle given in
Lemma \ref{derham-lemma-the-complex-for-L-star}.
By functoriality it suffices to prove there exists a morphism of
short exact sequences
$$
\begin{array}{ccccc}0 \longrightarrow & \Omega^\bullet_{X/S}[1] \longrightarrow\downarrow & \Omega^\bullet_{L^\star/S, 0}[1] \longrightarrow\downarrow & \Omega^\bullet_{X/S} \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & \Omega^\bullet_{X/S}[1] \longrightarrow & \Omega^\bullet_{X/S}(\log Y)[1] \longrightarrow & \Omega^\bullet_{Y/S} \longrightarrow & 0\end{array}
$$
...
Lemmas \ref{derham-lemma-the-complex-for-L-star} and \ref{derham-lemma-log-complex}
...
Lemma \ref{derham-lemma-the-complex-for-L-star} using the line bundle
$\overline{L}$ on $Y$.
By functoriality it suffices to prove there exists a morphism of
short exact sequences
$$
\begin{array}{ccccc}0 \longrightarrow & \Omega^\bullet_{X/S}[1] \longrightarrow\downarrow & \Omega^\bullet_{X/S}(\log Y)[1] \longrightarrow\downarrow & \Omega^\bullet_{Y/S} \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & \Omega^\bullet_{Y/S}[1] \longrightarrow & \Omega^\bullet_{\overline{L}^\star/S, 0}[1] \longrightarrow & \Omega^\bullet_{Y/S} \longrightarrow & 0 \\  &  &  &  & \end{array}
$$
where the left and right vertical arrows are the obvious ones.
We can define the middle vertical arrow by the rule
$$
...
\begin{lemma}[Log complex consequence]
\label{derham-lemma-log-complex-consequence}
\source{stacks:0FMX}
\href{https://stacks.math.columbia.edu/tag/0FMX}{\texttt{Stacks tag 0FMX}}
\group{derham}
...
\begin{proof}
\uses{derham-lemma-gysin-via-log-complex, derham-remark-cup-product-as-a-map}

This follows immediately from Lemma \ref{derham-lemma-gysin-via-log-complex}.
Namely, we have
$$
...
\begin{lemma}[Check log smooth]
\label{derham-lemma-check-log-smooth}
\source{stacks:0FMY}
\href{https://stacks.math.columbia.edu/tag/0FMY}{\texttt{Stacks tag 0FMY}}
\group{derham}
...
\begin{proof}
\uses{derham-lemma-etale, derham-definition-local-product}
...
$$
\begin{array}{ccc}Y \downarrow & V \longleftarrow\downarrow\longrightarrow & \mathbf{A}^m_T
\overset{(a_1, \ldots, a_m) \mapsto (a_1, \ldots, a_m, 0)}{\downarrow} \\ X & U \longleftarrow\overset{\pi}{\longrightarrow} & \mathbf{A}^{m + 1}_T\end{array}
$$
...
$$
by Lemma \ref{derham-lemma-etale}. Denote $x_1, \ldots, x_{m + 1}$
the coordinate functions on $\mathbf{A}^{m + 1}_T$.
Since the conditions (1) and (2) in Definition \ref{derham-definition-local-product}
...
\begin{remark}[Check log completion 1]
\label{derham-remark-check-log-completion-1}
\source{stacks:0FMZ}
\href{https://stacks.math.columbia.edu/tag/0FMZ}{\texttt{Stacks tag 0FMZ}}
\group{derham}
...
\begin{remark}[Check log completion 2]
\label{derham-remark-check-log-completion-2}
\source{stacks:0FN0}
\href{https://stacks.math.columbia.edu/tag/0FN0}{\texttt{Stacks tag 0FN0}}
\group{derham}
...
$$
\begin{array}{ccc}P \underset{0}{\longrightarrow}\underset{p}{\downarrow} & L \underset{\pi}{\longrightarrow}\overset{b}{\downarrow} & P \overset{p}{\downarrow} \\ Z \overset{i}{\longrightarrow} & X \longrightarrow & Z\end{array}
$$
...
\source{stacks:0FUR}
\href{https://stacks.math.columbia.edu/tag/0FUR}{\texttt{Stacks tag 0FUR}}
\group{derham}
...
\begin{proof}
\uses{derham-lemma-hodge-cohomology-projective-space, derham-lemma-push-omega-a, derham-lemma-the-complex-for-L-star, derham-lemma-de-rham-complex-product, derham-lemma-twisted-hodge-cohomology-projective-space}
...
$$
By the calculations in Section \ref{derham-section-projective-space}
and in particular in
the proof of Lemma \ref{derham-lemma-hodge-cohomology-projective-space}
...
\medskip\noindent
By the material in Section \ref{derham-section-line-bundle} and in particular
Lemma \ref{derham-lemma-push-omega-a} we have
...
By Lemmas \ref{derham-lemma-the-complex-for-L-star} and \ref{derham-lemma-push-omega-a}
...
$$
by Lemma \ref{derham-lemma-de-rham-complex-product}.
...
\begin{lemma}[Comparison bis]
\label{derham-lemma-comparison-bis}
\source{stacks:0G5G}
\href{https://stacks.math.columbia.edu/tag/0G5G}{\texttt{Stacks tag 0G5G}}
\group{derham}
...
discussed in Section \ref{derham-section-de-rham-complex}.
...
\begin{lemma}[Blowup twist same cohomology]
\label{derham-lemma-blowup-twist-same-cohomology}
\source{stacks:0G5H}
\href{https://stacks.math.columbia.edu/tag/0G5H}{\texttt{Stacks tag 0G5H}}
\group{derham}
...
\vcenter{
\begin{array}{cc}E \underset{j}{\longrightarrow}\underset{p}{\downarrow} & X' \overset{b}{\downarrow} \\ Z \overset{i}{\longrightarrow} & X\end{array}
}
\end{equation}
...
\begin{lemma}[Comparison general]
\label{derham-lemma-comparison-general}
\source{stacks:0FUU}
\href{https://stacks.math.columbia.edu/tag/0FUU}{\texttt{Stacks tag 0FUU}}
\group{derham}
...
\begin{proof}
\uses{derham-lemma-etale, derham-lemma-comparison}
...
Lemma \ref{derham-lemma-etale} we obtain that the pullback by $\epsilon$
...
Section \ref{derham-section-calculations}. In this case the lemma
is the same as Lemma \ref{derham-lemma-comparison}.
\end{proof}

\begin{lemma}[Distinguished triangle blowup]
\label{derham-lemma-distinguished-triangle-blowup}
\source{stacks:0FUV}
\href{https://stacks.math.columbia.edu/tag/0FUV}{\texttt{Stacks tag 0FUV}}
\group{derham}
...
\end{matrix}
$$
are the canonical ones (Section \ref{derham-section-de-rham-complex}),
except with sign reversed for one of them.
\end{lemma}

\begin{proof}
\uses{derham-lemma-comparison-general}
...
$$
\begin{array}{cccc}C' \longrightarrow\downarrow & b_*\Omega^\bullet_{X'/S} \oplus i_*\Omega^\bullet_{Z/S} \longrightarrow\downarrow & i_*p_*\Omega^\bullet_{E/S} \longrightarrow\downarrow & C'[1] \downarrow \\ C \longrightarrow & Rb_*\Omega^\bullet_{X'/S} \oplus i_*\Omega^\bullet_{Z/S} \longrightarrow & i_*Rp_*\Omega^\bullet_{E/S} \longrightarrow & C[1]\end{array}
$$
By Lemma \ref{derham-lemma-comparison-general} part (3) and
Derived Categories, Proposition \ref{derived-proposition-9} we conclude that
$C' \to C$ is an isomorphism. By Lemma \ref{derham-lemma-comparison-general} part (2)
the map $i_*\Omega^\bullet_{Z/S} \to i_*p_*\Omega^\bullet_{E/S}$
is an isomorphism. Thus $C' = b_*\Omega^\bullet_{X'/S}$
in the derived category. Finally we use Lemma \ref{derham-lemma-comparison-general}
part (1) tells us this is equal to $\Omega^\bullet_{X/S}$.
We omit the verification this is compatible with the canonical maps.
\end{proof}

\begin{proposition}[Blowup split]
\label{derham-proposition-blowup-split}
\source{stacks:0FUW}
\href{https://stacks.math.columbia.edu/tag/0FUW}{\texttt{Stacks tag 0FUW}}
\group{derham}
...
\begin{proof}
\uses{derham-lemma-distinguished-triangle-blowup, derham-remark-projective-space-bundle-formula, derham-lemma-gysin-via-log-complex, derham-remark-cup-product-as-a-map}

Consider the triangle constructed in
Lemma \ref{derham-lemma-distinguished-triangle-blowup}.
...
See Remark \ref{derham-remark-projective-space-bundle-formula}.
...
introduced in Remark \ref{derham-remark-projective-space-bundle-formula}.
We set
$$
M = \bigoplus M_m
\quad\text{and}\quad
...
Lemma \ref{derham-lemma-gysin-via-log-complex}
...
\Omega^\bullet_{E/S}
$$
is the map $\theta'$ of Remark \ref{derham-remark-cup-product-as-a-map} for
$c_1^{dR}(\mathcal{O}_{X'}(-E))|_E) = c_1^{dR}(\mathcal{O}_E(1))$.
The final assertion of Remark \ref{derham-remark-projective-space-bundle-formula}
tells us that the diagram
$$
\begin{array}{cc}K[-2] \underset{(\tilde \xi|_K)[-2]}{\downarrow}\underset{\text{id}}{\longrightarrow} & M \overset{\tilde x|_M}{\downarrow} \\ Rp_*\Omega^\bullet_{E/S}[-2] \overset{Rp_*\theta'}{\longrightarrow} & Rp_*\Omega^\bullet_{E/S}\end{array}
$$
...
\begin{lemma}[Ext zero]
\label{derham-lemma-ext-zero}
\source{stacks:0G5I}
\href{https://stacks.math.columbia.edu/tag/0G5I}{\texttt{Stacks tag 0G5I}}
\group{derham}
...
\begin{lemma}[Splitting on omega a]
\label{derham-lemma-splitting-on-omega-a}
\source{stacks:0G5J}
\href{https://stacks.math.columbia.edu/tag/0G5J}{\texttt{Stacks tag 0G5J}}
\group{derham}
...
\begin{proof}
\uses{derham-lemma-comparison-general, derham-lemma-comparison-bis, derham-lemma-blowup-twist-same-cohomology, derham-lemma-ext-zero}
...
proof of Lemma \ref{derham-lemma-comparison-general} and apply
Lemma \ref{derham-lemma-comparison-bis}.
Computing \'etale locally using Lemma \ref{derham-lemma-blowup-twist-same-cohomology}
...
Lemma \ref{derham-lemma-comparison-general}
...
Thus the desired vanishing follows from Lemma \ref{derham-lemma-ext-zero}.
\end{proof}
...
(as formulated in Lemma \ref{derham-lemma-base-change-Garel-upstairs}).
\end{enumerate}
...
Section \ref{derham-section-trace} to the construction of the trace map on
the de Rham complexes if $f$ is finite.

\begin{lemma}[Funny map]
\label{derham-lemma-funny-map}
\source{stacks:0FL8}
\href{https://stacks.math.columbia.edu/tag/0FL8}{\texttt{Stacks tag 0FL8}}
\group{derham}

Let $R$ be a ring and consider a commutative diagram
$$
\begin{array}{ccccc}0 \longrightarrow & K^0 \longrightarrow & L^0 \longrightarrow & M^0 \longrightarrow & 0 \\  &  & L^{-1} \underset{\partial}{\uparrow}\xlongequal{} & M^{-1} \uparrow & \end{array}
$$
...
\begin{lemma}[Funny map functorial]
\label{derham-lemma-funny-map-functorial}
\source{stacks:0H9F}
\href{https://stacks.math.columbia.edu/tag/0H9F}{\texttt{Stacks tag 0H9F}}
\group{derham}

\uses{derham-lemma-funny-map}
Let $R_1 \to R_2$ be a ring homomorphism. For $i = 1, 2$ consider
commutative diagrams
$$
\begin{array}{ccccc}0 \longrightarrow & K_i^0 \longrightarrow & L_i^0 \longrightarrow & M_i^0 \longrightarrow & 0 \\  &  & L_i^{-1} \underset{\partial_i}{\uparrow}\xlongequal{} & M_i^{-1} \uparrow & \end{array}
$$
of $R_i$-modules as in Lemma \ref{derham-lemma-funny-map}. Assume we have
...
the diagrams
$$
\begin{array}{cc}\wedge^p(H^0(L_1^\bullet)) \downarrow\underset{c^p}{\longrightarrow} & \wedge^p(K_1^0) \otimes_{R_1} \det(M_1^\bullet) \downarrow \\ \wedge^p(H^0(L_2^\bullet))
\overset{c^p}{\longrightarrow} & \wedge^p(K_2^0) \otimes_{R_2} \det(M_2^\bullet)\end{array}
$$
commute.
\end{lemma}
...
in the proof of Lemma \ref{derham-lemma-funny-map}. Note that we need
...
\begin{remark}[Local description]
\label{derham-remark-local-description}
\source{stacks:0FL9}
\href{https://stacks.math.columbia.edu/tag/0FL9}{\texttt{Stacks tag 0FL9}}
\group{derham}
...
$$
\begin{array}{ccc}\Omega_{A/\mathbf{Z}} \otimes_A B \longrightarrow & \Omega_{P/\mathbf{Z}} \otimes_P B \longrightarrow & \Omega_{P/A} \otimes_P B \\  & (f_1, \ldots, f_n)/(f_1, \ldots, f_n)^2 \uparrow\xlongequal{} & (f_1, \ldots, f_n)/(f_1, \ldots, f_n)^2 \uparrow\end{array}
$$
...
Thus by Lemma \ref{derham-lemma-funny-map} we obtain canonical $B$-module maps
$$
...
\begin{lemma}[Base change Garel upstairs]
\label{derham-lemma-base-change-Garel-upstairs}
\source{stacks:0H9G}
\href{https://stacks.math.columbia.edu/tag/0H9G}{\texttt{Stacks tag 0H9G}}
\group{derham}

Consider a commutative diagram
$$
\begin{array}{cc}Y' \underset{f'}{\downarrow}\underset{b}{\longrightarrow} & Y \overset{f}{\downarrow} \\ X' \overset{a}{\longrightarrow} & X\end{array}
$$
...
$$
\begin{array}{cccc}b^*\Omega^p_{Y/\mathbf{Z}} \underset{b^*c^p_{Y/X}}{\longrightarrow}\downarrow &  & b^*(f^*\Omega^p_{X/\mathbf{Z}} \otimes_{\mathcal{O}_Y} \det(\NL_{Y/X}))
\xlongequal{} & (f')^*a^*\Omega^p_{X/\mathbf{Z}} \otimes_{\mathcal{O}_Y} b^*\det(\NL_{Y/X}))
\downarrow \\ \Omega^p_{Y'/\mathbf{Z}} \overset{c^p_{Y'/X'}}{\longrightarrow} &  &  & (f')^*\Omega^p_{X'/\mathbf{Z}} \otimes_{\mathcal{O}_{Y'}} \det(\NL_{Y'/X'})\end{array}
$$
...
\begin{lemma}[Existence base change Garel upstairs]
\label{derham-lemma-existence-base-change-Garel-upstairs}
\source{stacks:0H9H}
\href{https://stacks.math.columbia.edu/tag/0H9H}{\texttt{Stacks tag 0H9H}}
\group{derham}

\uses{derham-lemma-base-change-Garel-upstairs}
Consider a commutative diagram
$$
\begin{array}{cc}Y' \underset{f'}{\downarrow}\underset{b}{\longrightarrow} & Y \overset{f}{\downarrow} \\ X' \overset{a}{\longrightarrow} & X\end{array}
$$
...
$$
\begin{array}{cc}V' \downarrow\underset{b}{\longrightarrow} & V \downarrow \\ U' \longrightarrow & U\end{array}
$$
in the sense explained in Lemma \ref{derham-lemma-base-change-Garel-upstairs}.
\end{lemma}

\begin{proof}
\uses{derham-remark-local-description, derham-lemma-funny-map-functorial}
...
The construction in Remark \ref{derham-remark-local-description}
provides us with the maps $c^p_{V/U}$ and $c^p_{V'/U'}$.
These maps are compatible by Lemma \ref{derham-lemma-funny-map-functorial}
and the compatibility of the presentations of $B$ and $B'$ over
$A$ and $A'$. Some details omitted.
\end{proof}

\begin{lemma}[Garel upstairs]
\label{derham-lemma-Garel-upstairs}
\source{stacks:0FLA}
\href{https://stacks.math.columbia.edu/tag/0FLA}{\texttt{Stacks tag 0FLA}}
\group{derham}
...
\begin{proof}
\uses{derham-lemma-base-change-Garel-upstairs, derham-remark-local-description, derham-lemma-existence-base-change-Garel-upstairs}
...
Lemma \ref{derham-lemma-base-change-Garel-upstairs}.
...
Discriminants, Lemma \ref{discriminant-lemma-syntomic-quasi-finite} part (5)
and then using the construction in Remark \ref{derham-remark-local-description}.
...
Lemma \ref{derham-lemma-base-change-Garel-upstairs}: namely,
locally there do exist compatible maps by
Lemma \ref{derham-lemma-existence-base-change-Garel-upstairs}
...
Lemma \ref{derham-lemma-base-change-Garel-upstairs}, tells us there are
...
Lemma \ref{derham-lemma-base-change-Garel-upstairs} we may work locally
...
(and the uniqueness in Lemma \ref{derham-lemma-base-change-Garel-upstairs})
...
$$
\begin{array}{ccc}B_1 \longrightarrow & B & B_2 \longleftarrow \\ A_1 \uparrow\longrightarrow & A \uparrow & A_2 \longleftarrow\uparrow\end{array}
$$
...
$$
\begin{array}{ccc}(A'_1 \otimes_{A_1} B_1)_{h_1} \longrightarrow & B & (A'_2 \otimes_{A_1} B_2)_{h_2} \longleftarrow \\ A'_1 \uparrow\longrightarrow & A \uparrow & A'_2 \longleftarrow\uparrow\end{array}
$$
...
$$
\begin{array}{ccccc} &  & Y/X \swarrow\underset{b_1/a_1}{\swarrow}\searrow\overset{b_2/a_2}{\searrow} &  &  \\  & Y'_1/X'_1 \searrow\swarrow &  & Y'_2/X'_2 \swarrow\searrow &  \\ Y_1/X_1 &  & Y'/X' &  & Y_2/X_2\end{array}
$$
...
$$
\begin{array}{ccc} & Y/X \swarrow\searrow &  \\ Y'_1/X'_1 \searrow &  & Y'_2/X'_2 \swarrow \\  & Y'/X' \downarrow &  \\  & Y_{n, d}/X_{n, d} & \end{array}
$$
...
\begin{example}[No trace]
\label{derham-example-no-trace}
\source{stacks:0FK7}
\href{https://stacks.math.columbia.edu/tag/0FK7}{\texttt{Stacks tag 0FK7}}
\group{derham}
...
\source{stacks:0FLB}
\href{https://stacks.math.columbia.edu/tag/0FLB}{\texttt{Stacks tag 0FLB}}
\group{derham}
...
\begin{proof}
\uses{derham-lemma-Garel-upstairs}

First, assume that $X$ is locally Noetherian. By
Lemma \ref{derham-lemma-Garel-upstairs} we have a canonical map
$$
...
$$
\begin{array}{ccc}Y \downarrow & V \downarrow\longleftarrow\longrightarrow & V_d \downarrow \\ X & U \longleftarrow\longrightarrow & U_d\end{array}
$$
...
Lemma \ref{derham-lemma-Garel-upstairs} to extend to general $X$.
...
cartesian diagram
$$
\begin{array}{cc}Y' \longrightarrow\downarrow & Y \downarrow \\ X' \longrightarrow & X\end{array}
$$
...
\begin{proposition}[Garel]
\label{derham-proposition-Garel}
\source{stacks:0FLC}
\href{https://stacks.math.columbia.edu/tag/0FLC}{\texttt{Stacks tag 0FLC}}
\group{derham}

\uses{derham-lemma-Garel}
\begin{reference}
\cite{Garel}
\end{reference}
Let $f : Y \to X$ be a finite syntomic morphism of schemes.
The maps $\Theta^p_{Y/X}$ of Lemma \ref{derham-lemma-Garel} define a map of complexes
$$
\Theta_{Y/X} :
...
$$
\begin{array}{cccc}Y \downarrow & V \downarrow\longleftarrow\longrightarrow & V_d \downarrow\longrightarrow & Y_d = \Spec(B_d) \downarrow \\ X & U \longleftarrow\longrightarrow & U_d \longrightarrow & X_d = \Spec(A_d)\end{array}
$$
...
$$
\begin{array}{ccc}V \longrightarrow\downarrow & V' = \mathbf{A}^N \times V_d \longrightarrow\downarrow & V_d \downarrow \\ U \longrightarrow & U' = \mathbf{A}^N \times U_d \longrightarrow & U_d\end{array}
$$
...
\source{stacks:0FLD}
\href{https://stacks.math.columbia.edu/tag/0FLD}{\texttt{Stacks tag 0FLD}}
\group{derham}

\uses{derham-proposition-Garel}
Let $A$ be a ring. Let $f = x^d + \sum_{0 \leq i < d} a_{d - i} x^i \in A[x]$.
Let $B = A[x]/(f)$. By Proposition \ref{derham-proposition-Garel}
...
Proposition \ref{derham-proposition-Garel} it suffices to compute this
...
\begin{lemma}[Garel map frobenius smooth char p]
\label{derham-lemma-Garel-map-frobenius-smooth-char-p}
\source{stacks:0FW2}
\href{https://stacks.math.columbia.edu/tag/0FW2}{\texttt{Stacks tag 0FW2}}
\group{derham}
...
\begin{proof}
\uses{derham-lemma-etale, derham-example-Garel}
...
$$
\begin{array}{cc}X \downarrow & U \longleftarrow\underset{\pi}{\downarrow} \\ S & \mathbf{A}^d_S \longleftarrow\end{array}
$$
...
$$
\begin{array}{cc}U \underset{\pi}{\downarrow}\underset{F_{X/S}}{\longrightarrow} & U^{(p)} \overset{\pi^{(p)}}{\downarrow} \\ \mathbf{A}^d_S \overset{x_i \mapsto x_i^p}{\longrightarrow} & \mathbf{A}^d_S\end{array}
$$
of
...
As in Example \ref{derham-example-Garel} we may reduce this to computing
...
\begin{lemma}[Duality hodge]
\label{derham-lemma-duality-hodge}
\source{stacks:0FW4}
\href{https://stacks.math.columbia.edu/tag/0FW4}{\texttt{Stacks tag 0FW4}}
\group{derham}
...
\begin{lemma}[Bottom part degenerates]
\label{derham-lemma-bottom-part-degenerates}
\source{stacks:0FW5}
\href{https://stacks.math.columbia.edu/tag/0FW5}{\texttt{Stacks tag 0FW5}}
\group{derham}
...
(see Section \ref{derham-section-de-rham-complex}), we conclude.
\end{proof}

\begin{lemma}[Top part degenerates]
\label{derham-lemma-top-part-degenerates}
\source{stacks:0FW6}
\href{https://stacks.math.columbia.edu/tag/0FW6}{\texttt{Stacks tag 0FW6}}
\group{derham}
...
\begin{proof}
\uses{derham-lemma-bottom-part-degenerates, derham-lemma-duality-hodge, derham-lemma-Garel-map-frobenius-smooth-char-p}

It is tempting to think this follows from a combination of
Lemmas \ref{derham-lemma-bottom-part-degenerates} and \ref{derham-lemma-duality-hodge}.
...
to conclude the map in Lemma \ref{derham-lemma-bottom-part-degenerates}
...
$\dim H^d(X, \Omega^d_{X/k}) = 1$ by Lemma \ref{derham-lemma-duality-hodge}.
...
Lemma \ref{derham-lemma-Garel-map-frobenius-smooth-char-p}.
Consider the commutative diagram
$$
\begin{array}{ccc}H^d(X, \Omega^{d - 1}_{X/k}) \downarrow\longrightarrow & H^d(X^{(p)}, F_{X/k, *}\Omega^{d - 1}_{X/k}) \downarrow\underset{\Theta^{d - 1}}{\longrightarrow} & H^d(X^{(p)}, \Omega^{d - 1}_{X^{(p)}/k}) \downarrow \\ H^d(X, \Omega^d_{X/k}) \longrightarrow & H^d(X^{(p)}, F_{X/k, *}\Omega^d_{X/k}) \overset{\Theta^d}{\longrightarrow} & H^d(X^{(p)}, \Omega^d_{X^{(p)}/k})\end{array}
$$
...
Lemma \ref{derham-lemma-duality-hodge} applied to $X^{(p)}$ over $k$.
...
$$
\begin{array}{cc}X \downarrow\longrightarrow & Y \downarrow \\ \Spec(k) \longrightarrow & \Spec(R)\end{array}
$$
...
\begin{proposition}[Poincare duality]
\label{derham-proposition-poincare-duality}
\source{stacks:0FW7}
\href{https://stacks.math.columbia.edu/tag/0FW7}{\texttt{Stacks tag 0FW7}}
\group{derham}
...
\begin{proof}
\uses{derham-lemma-bottom-part-degenerates, derham-lemma-top-part-degenerates, derham-lemma-duality-hodge}

By the Hodge-to-de Rham spectral sequence
(Section \ref{derham-section-hodge-to-de-rham}), the vanishing
of $\Omega^i_{X/k}$ for $i > d$, the vanishing in
Cohomology, Proposition \ref{cohomology-proposition-vanishing-Noetherian}
and the results of Lemmas \ref{derham-lemma-bottom-part-degenerates} and
...
corresponds to a $t$ as in Lemma \ref{derham-lemma-duality-hodge}.
...
\Omega^\bullet
$$
Using the same procedure as in Section \ref{derham-section-cup-product} we obtain
cup products
$$
...
Lemma \ref{derham-lemma-duality-hodge} and the result is true.
...
$$
\begin{array}{c}H^{i - 1}(X, \sigma_{\leq p}\Omega^\bullet) \underset{a}{\downarrow} \\ H^i(X, \Omega^{p + 1}[-p - 1]) \underset{b}{\downarrow} \\ H^i(X, \sigma_{\leq p + 1}\Omega^\bullet) \underset{c}{\downarrow} \\ H^i(X, \sigma_{\leq p}\Omega^\bullet) \underset{d}{\downarrow} \\ H^{i + 1}(X, \Omega^{p + 1}[-p - 1])\end{array}
\quad\quad
\begin{array}{c}H^{2d - i  + 1}(X, \sigma_{\geq d - p}\Omega^\bullet) \\ H^{2d - i}(X, \Omega^{d - p - 1}[-d + p + 1]) \underset{a'}{\uparrow} \\ H^{2d - i}(X, \sigma_{\geq d - p - 1}\Omega^\bullet) \underset{b'}{\uparrow} \\ H^{2d - i}(X, \sigma_{\geq d - p}\Omega^\bullet) \underset{c'}{\uparrow} \\ H^{2d - i - 1}(X, \Omega^{d - p - 1}[-d + p + 1]) \underset{d'}{\uparrow}\end{array}
$$
By induction and Lemma \ref{derham-lemma-duality-hodge}
...
$$
\begin{array}{cc}\text{Tot}(\sigma_{\leq p} \Omega^\bullet \otimes_{\underline{k}}
\sigma_{\geq d - p} \Omega^\bullet) \underset{\gamma_p}{\downarrow} & \text{Tot}(\sigma_{\leq p + 1} \Omega^\bullet \otimes_{\underline{k}}
\sigma_{\geq d - p} \Omega^\bullet) \longleftarrow\downarrow \\ \Omega^\bullet & \text{Tot}(\sigma_{\leq p + 1} \Omega^\bullet \otimes_{\underline{k}}
\sigma_{\geq d - p - 1} \Omega^\bullet) \underset{\gamma_{p + 1}}{\longleftarrow}\end{array}
$$
...
$$
\begin{array}{cc}\text{Tot}(\sigma_{\leq p + 1} \Omega^\bullet \otimes_{\underline{k}}
\sigma_{\geq d - p - 1} \Omega^\bullet) \underset{\gamma_{p + 1}}{\downarrow} & \text{Tot}(\Omega^{p + 1}[-p - 1] \otimes_{\underline{k}}
\sigma_{\geq d - p - 1} \Omega^\bullet) \longleftarrow\downarrow \\ \Omega^\bullet & \Omega^{p + 1}[-p - 1]
\otimes_{\underline{k}}
\Omega^{d - p - 1}[-d + p + 1] \underset{\wedge}{\longleftarrow}\end{array}
$$
...
$$
\begin{array}{cc}\Omega^{p + 1}[-p] \otimes_{\underline{k}}
\Omega^{d - p - 1}[-d + p] \downarrow & \text{Tot}(\sigma_{\leq p}\Omega^\bullet \otimes_{\underline{k}}
\Omega^{d - p - 1}[-d + p]) \longleftarrow\downarrow \\ \Omega^\bullet & \text{Tot}(\sigma_{\leq p}\Omega^\bullet \otimes_{\underline{k}}
\sigma_{\geq d - p}\Omega^\bullet) \longleftarrow\end{array}
$$
...
\begin{lemma}[Chern classes]
\label{derham-lemma-chern-classes}
\source{stacks:0FW9}
\href{https://stacks.math.columbia.edu/tag/0FW9}{\texttt{Stacks tag 0FW9}}
\group{derham}
...
\begin{proof}
\uses{derham-lemma-cup-product-graded-commutative, derham-lemma-pullback-c1, derham-proposition-projective-space-bundle-formula, derham-lemma-check-log-smooth, derham-lemma-log-complex-consequence}
...
Functoriality is discussed in Section \ref{derham-section-de-rham-cohomology}
and the cup product in Section \ref{derham-section-cup-product}.
For the additive maps $c_1^A$ we take $c_1^{dR}$ constructed
in Section \ref{derham-section-first-chern-class}.
...
This follows from the more general Lemma \ref{derham-lemma-pullback-c1}.

\medskip\noindent
Axiom (4) for $A$ is the projective space bundle formula which
we proved in Proposition \ref{derham-proposition-projective-space-bundle-formula}.
...
Thus by Lemma \ref{derham-lemma-check-log-smooth} the complex of log poles
for $P' \subset P$ over $\mathbf{Z}$ is defined.
Hence for $a \in A(P)$ with $i^*a = 0$ we have
$a \cup c_1^A(\mathcal{O}_P(P')) = 0$ by
Lemma \ref{derham-lemma-log-complex-consequence}.
This finishes the proof.
\end{proof}

\begin{remark}[Splitting principle]
\label{derham-remark-splitting-principle}
\source{stacks:0FWA}
\href{https://stacks.math.columbia.edu/tag/0FWA}{\texttt{Stacks tag 0FWA}}
\group{derham}

\uses{derham-lemma-chern-classes}
...
Lemma \ref{derham-lemma-chern-classes}
...
\begin{lemma}[Chern character]
\label{derham-lemma-chern-character}
\source{stacks:0FWB}
\href{https://stacks.math.columbia.edu/tag/0FWB}{\texttt{Stacks tag 0FWB}}
\group{derham}
...
Exactly as in the proof of Lemma \ref{derham-lemma-chern-classes}
...
By Lemma \ref{derham-lemma-proper-smooth-de-Rham} there are
...
$$
\begin{array}{cc}\Pic(X) \underset{c^{dR}_1}{\longrightarrow}\downarrow & H_{dR}^2(X/k) \downarrow \\ \Pic(X_{k'}) \overset{c^{dR}_1}{\longrightarrow} & H_{dR}^2(X_{k'}/k')\end{array}
$$
commute by Lemma \ref{derham-lemma-pullback-c1}.
...
$k$-schemes by Lemma \ref{derham-lemma-kunneth-de-rham} (observe that the
derived tensor products in the statement are harmless as we are
tensoring over the field $k$).

\medskip\noindent
Axiom (A7). This follows from Proposition \ref{derham-proposition-blowup-split}.
...
Lemma \ref{derham-lemma-bottom-part-degenerates}
...
$$
\begin{array}{cc}x \downarrow\longrightarrow & X \overset{\Delta}{\downarrow} \\ X \overset{x \times \text{id}}{\longrightarrow} & X \times_{\Spec(k)} X\end{array}
$$
...
By Proposition \ref{derham-proposition-Garel} we have a trace map
$$
\Theta_f :
...
Lemma \ref{derham-lemma-de-rham-cohomology-projective-space} and this
...
$$
\begin{array}{cccc}H_{dR}^{2d - 2}(X/k)
\underset{c^{dR}_1(\mathcal{O}_X(Y)) \cap -}{\longrightarrow}\underset{restriction}{\downarrow} &  &  & H_{dR}^{2d}(X) \overset{\lambda_X}{\downarrow} \\ H_{dR}^{2d - 2}(Y/k) \overset{\lambda_Y}{\longrightarrow} &  &  & k\end{array}
$$
...
\begin{proposition}[De rham is weil]
\label{derham-proposition-de-rham-is-weil}
\source{stacks:0FWD}
\href{https://stacks.math.columbia.edu/tag/0FWD}{\texttt{Stacks tag 0FWD}}
\group{derham}
...
\begin{proof}
\uses{derham-lemma-proper-smooth-de-Rham, derham-lemma-pullback-c1, derham-lemma-log-complex-consequence, derham-lemma-kunneth-de-rham, derham-lemma-bottom-part-degenerates, derham-lemma-de-rham-cohomology-projective-space, derham-proposition-projective-space-bundle-formula, derham-proposition-blowup-split, derham-proposition-Garel}
...
\begin{remark}[Hodge cohomology is weil]
\label{derham-remark-hodge-cohomology-is-weil}
\source{stacks:0FWE}
\href{https://stacks.math.columbia.edu/tag/0FWE}{\texttt{Stacks tag 0FWE}}
\group{derham}
...
\begin{remark}[Gysin equations]
\label{derham-remark-gysin-equations}
\source{stacks:0G83}
\href{https://stacks.math.columbia.edu/tag/0G83}{\texttt{Stacks tag 0G83}}
\group{derham}
...
\begin{lemma}[Gysin differential]
\label{derham-lemma-gysin-differential}
\source{stacks:0G85}
\href{https://stacks.math.columbia.edu/tag/0G85}{\texttt{Stacks tag 0G85}}
\group{derham}
...
\begin{lemma}[Gysin global]
\label{derham-lemma-gysin-global}
\source{stacks:0G86}
\href{https://stacks.math.columbia.edu/tag/0G86}{\texttt{Stacks tag 0G86}}
\group{derham}

\uses{derham-remark-gysin-equations}
...
of Remark \ref{derham-remark-gysin-equations}.
\end{lemma}
...
\begin{lemma}[Gysin differential global]
\label{derham-lemma-gysin-differential-global}
\source{stacks:0G87}
\href{https://stacks.math.columbia.edu/tag/0G87}{\texttt{Stacks tag 0G87}}
\group{derham}

\uses{derham-lemma-gysin-global}
Let $X \to S$ and $i : Z \to X$ be as in Lemma \ref{derham-lemma-gysin-global}.
The Gysin map $\gamma^p$ is compatible with the de Rham
differentials on $\Omega^\bullet_{X/S}$ and $\Omega^\bullet_{Z/S}$.
\end{lemma}

\begin{proof}
\uses{derham-lemma-gysin-differential}

We may check this locally and then it follows from
Lemma \ref{derham-lemma-gysin-differential}.
\end{proof}

\begin{lemma}[Gysin projection]
\label{derham-lemma-gysin-projection}
\source{stacks:0G88}
\href{https://stacks.math.columbia.edu/tag/0G88}{\texttt{Stacks tag 0G88}}
\group{derham}
...
$$
\begin{array}{ccc}i^{-1}\Omega^p_X \otimes \Omega^0_Z \underset{\text{id} \otimes \gamma^0}{\longrightarrow}\downarrow &  & i^{-1}\Omega^p_X \otimes \mathcal{H}^c_Z(\Omega^c_X) \overset{\wedge}{\downarrow} \\ \Omega^p_Z \otimes \Omega^0_Z \overset{\wedge}{\longrightarrow} & \Omega^p_Z \overset{\gamma^p}{\longrightarrow} & \mathcal{H}^c_Z(\Omega^{p + c}_X)\end{array}
$$
...
\begin{lemma}[Gysin transverse]
\label{derham-lemma-gysin-transverse}
\source{stacks:0G89}
\href{https://stacks.math.columbia.edu/tag/0G89}{\texttt{Stacks tag 0G89}}
\group{derham}

\uses{derham-lemma-gysin-global}
Let $c \geq 0$ be an integer. Let
$$
\begin{array}{ccc}Z' \underset{h}{\downarrow}\longrightarrow & X' \underset{g}{\downarrow}\longrightarrow & S' \downarrow \\ Z \longrightarrow & X \longrightarrow & S\end{array}
$$
be a commutative diagram of schemes.
Assume
\begin{enumerate}
\item $Z \to X$ and $Z' \to X'$
satisfy the assumptions of Lemma \ref{derham-lemma-gysin-global},
...
Then the diagram
$$
\begin{array}{ccc}h^*\Omega^p_{Z/S} \underset{h^{-1}\gamma^p}{\longrightarrow}\downarrow &  & \mathcal{O}_{X'}|_{Z'} \otimes_{h^{-1}\mathcal{O}_X|_Z}
h^{-1}\mathcal{H}^c_Z(\Omega^{p + c}_{X/S}) \downarrow \\ \Omega^p_{Z'/S'} \overset{\gamma^p}{\longrightarrow} &  & \mathcal{H}^c_{Z'}(\Omega^{p + c}_{X'/S'})\end{array}
$$
...
$$
\begin{array}{ccc}h^*i^*\Omega^p_{X/S} \underset{h^{-1}c_{f_1, \ldots, f_c}}{\longrightarrow}\downarrow &  & \mathcal{O}_{X'}|_{Z'} \otimes_{h^{-1}\mathcal{O}_X|_Z}
h^{-1}\mathcal{H}^c_Z(\Omega^p_{X/S}) \downarrow \\ (i')^*\Omega^p_{X'/S'} \overset{c_{f'_1, \ldots, f'_c}}{\longrightarrow} &  & \mathcal{H}^c_{Z'}(\Omega^p_{X'/S'})\end{array}
$$
...
\source{stacks:0G8A}
\href{https://stacks.math.columbia.edu/tag/0G8A}{\texttt{Stacks tag 0G8A}}
\group{derham}

\uses{derham-lemma-gysin-global}
Let $X \to S$, $i : Z \to X$, and $c \geq 0$ be as in
Lemma \ref{derham-lemma-gysin-global}.
...
\begin{lemma}[Gysin differential hodge]
\label{derham-lemma-gysin-differential-hodge}
\source{stacks:0G8B}
\href{https://stacks.math.columbia.edu/tag/0G8B}{\texttt{Stacks tag 0G8B}}
\group{derham}
...
\begin{proof}
\uses{derham-lemma-gysin-differential-global}

This follows immediately from
Lemma \ref{derham-lemma-gysin-differential-global}.
\end{proof}

\begin{lemma}[Gysin projection global]
\label{derham-lemma-gysin-projection-global}
\source{stacks:0G8C}
\href{https://stacks.math.columbia.edu/tag/0G8C}{\texttt{Stacks tag 0G8C}}
\group{derham}

\uses{derham-lemma-gysin-global, derham-remark-how-to-use}
Let $X \to S$, $i : Z \to X$, and $c \geq 0$ be as in
Lemma \ref{derham-lemma-gysin-global}. Assume $X \to S$ smooth and
...
Remark \ref{derham-remark-how-to-use}.
\end{lemma}

\begin{proof}
\uses{derham-lemma-gysin-projection, derham-remark-how-to-use}

This lemma follows from Lemma \ref{derham-lemma-gysin-projection}
...
for all $j$ as pointed out in Remark \ref{derham-remark-how-to-use}.
...
of the equality in Lemma \ref{derham-lemma-gysin-projection}
...
in the proof of Lemma \ref{derham-lemma-gysin-projection} and in
...
Lemma \ref{derham-lemma-gysin-projection} maps to
$\gamma^{p, q}(\alpha|_Z)$.
\end{enumerate}
This finishes the proof.
\end{proof}

\begin{lemma}[Gysin transverse global]
\label{derham-lemma-gysin-transverse-global}
\source{stacks:0G8D}
\href{https://stacks.math.columbia.edu/tag/0G8D}{\texttt{Stacks tag 0G8D}}
\group{derham}

\uses{derham-lemma-gysin-transverse, derham-remark-how-to-use}
Let $c \geq 0$ and
$$
\begin{array}{ccc}Z' \underset{h}{\downarrow}\longrightarrow & X' \underset{g}{\downarrow}\longrightarrow & S' \downarrow \\ Z \longrightarrow & X \longrightarrow & S\end{array}
$$
satisfy the assumptions of Lemma \ref{derham-lemma-gysin-transverse} and assume
in addition that $X \to S$ and $X' \to S'$ are smooth and that
$Z \to X$ and $Z' \to X'$ are Koszul regular immersions.
Then the diagram
$$
\begin{array}{ccc}H^q(Z, \Omega^p_{Z/S}) \underset{\gamma^{p, q}}{\longrightarrow}\downarrow &  & H^{q + c}(X, \Omega^{p + c}_{X/S}) \downarrow \\ H^q(Z', \Omega^p_{Z'/S'}) \overset{\gamma^{p, q}}{\longrightarrow} &  & H^{q + c}(X', \Omega^{p + c}_{X'/S'})\end{array}
$$
is commutative where $\gamma^{p, q}$ is as in Remark \ref{derham-remark-how-to-use}.
\end{lemma}

\begin{proof}
\uses{derham-lemma-gysin-transverse}

This follows on combining Lemma \ref{derham-lemma-gysin-transverse}
and Cohomology, Lemma \ref{cohomology-lemma-support-functorial}.
\end{proof}

\begin{lemma}[Class of a point]
\label{derham-lemma-class-of-a-point}
\source{stacks:0G8E}
\href{https://stacks.math.columbia.edu/tag/0G8E}{\texttt{Stacks tag 0G8E}}
\group{derham}

\uses{derham-remark-how-to-use}
...
of Remark \ref{derham-remark-how-to-use} is nonzero.
\end{lemma}
...
look at Section \ref{derham-section-poincare-duality} first.

\begin{definition}[Situation: Relative duality]
\label{derham-situation-relative-duality}
\source{stacks:0G8G}
\href{https://stacks.math.columbia.edu/tag/0G8G}{\texttt{Stacks tag 0G8G}}
\group{derham}
...
\begin{lemma}[Relative bottom part degenerates]
\label{derham-lemma-relative-bottom-part-degenerates}
\source{stacks:0G8H}
\href{https://stacks.math.columbia.edu/tag/0G8H}{\texttt{Stacks tag 0G8H}}
\group{derham}

\uses{derham-situation-relative-duality}
In Situation \ref{derham-situation-relative-duality} the pushforward
...
\begin{lemma}[Relative duality hodge]
\label{derham-lemma-relative-duality-hodge}
\source{stacks:0G8I}
\href{https://stacks.math.columbia.edu/tag/0G8I}{\texttt{Stacks tag 0G8I}}
\group{derham}

\uses{derham-situation-relative-duality}
In Situation \ref{derham-situation-relative-duality} there exists an
...
\begin{proof}
\uses{derham-lemma-proper-smooth-de-Rham, derham-lemma-relative-bottom-part-degenerates}
...
are perfect by Lemma \ref{derham-lemma-proper-smooth-de-Rham}.
...
$$
\begin{array}{cc}X \longrightarrow\overset{f}{\downarrow} & X_0 \overset{f_0}{\downarrow} \\ S \overset{g}{\longrightarrow} & S_0\end{array}
$$
...
Lemma \ref{derham-lemma-proper-smooth-de-Rham}. In particular the pullback
...
By Lemma \ref{derham-lemma-relative-bottom-part-degenerates}
...
\begin{lemma}[Relative top part degenerates]
\label{derham-lemma-relative-top-part-degenerates}
\source{stacks:0G8J}
\href{https://stacks.math.columbia.edu/tag/0G8J}{\texttt{Stacks tag 0G8J}}
\group{derham}

\uses{derham-situation-relative-duality}
In Situation \ref{derham-situation-relative-duality} the map
$\text{d} : R^nf_*\Omega^{n - 1}_{X/S} \to R^nf_*\Omega^n_{X/S}$
is zero.
\end{lemma}

As we mentioned in the proof of Lemma \ref{derham-lemma-top-part-degenerates}
this lemma is not an easy consequence of Lemmas
\ref{derham-lemma-relative-duality-hodge} and
\ref{derham-lemma-relative-bottom-part-degenerates}.

\begin{proof}
\uses{derham-lemma-relative-duality-hodge, derham-lemma-relative-bottom-part-degenerates, derham-lemma-top-part-degenerates}
...
$$
which is zero by Lemma \ref{derham-lemma-top-part-degenerates}.
\end{proof}

\begin{proof}
\uses{derham-lemma-relative-bottom-part-degenerates, derham-lemma-relative-duality-hodge, derham-remark-how-to-use, derham-lemma-gysin-transverse-global, derham-lemma-class-of-a-point, derham-lemma-de-rham-complex-product, derham-lemma-gysin-differential-hodge, derham-lemma-gysin-projection-global}
...
By Lemma \ref{derham-lemma-relative-bottom-part-degenerates} the morphism
...
In the proof of Lemma \ref{derham-lemma-relative-bottom-part-degenerates}
...
Lemma \ref{derham-lemma-relative-bottom-part-degenerates} the object $P$
of $D(A)$ is perfect of tor amplitude in $[1, n]$. As in the proof
of Lemma \ref{derham-lemma-relative-duality-hodge} we see that
...
see Lemma \ref{derham-lemma-gysin-transverse-global},
we see that the image of $\xi$ in $H^n(X_k, \Omega^n_{X_k/k})$
is nonzero by Lemma \ref{derham-lemma-class-of-a-point} if $k$ is a field.
...
$$
of Remark \ref{derham-remark-how-to-use}. Consider the image
$$
\gamma^{n - 1, n}(\theta) \in
H^{2n}(X \times_S X, \Omega^{2n - 1}_{X \times_S X})
$$
By Lemma \ref{derham-lemma-de-rham-complex-product} we have
$$
...
Namely, by Lemma \ref{derham-lemma-gysin-differential-hodge}
we have
$$
...
Section \ref{derham-section-kunneth} and
...
Lemma \ref{derham-lemma-gysin-transverse-global}. This means that
$$
...
Hence by Lemma \ref{derham-lemma-gysin-projection-global} we have
$$
...
\begin{proposition}[Relative poincare duality]
\label{derham-proposition-relative-poincare-duality}
\source{stacks:0G8K}
\href{https://stacks.math.columbia.edu/tag/0G8K}{\texttt{Stacks tag 0G8K}}
\group{derham}
...
\begin{proof}
\uses{derham-proposition-poincare-duality, derham-lemma-relative-bottom-part-degenerates, derham-lemma-relative-top-part-degenerates, derham-lemma-relative-duality-hodge, derham-lemma-duality-hodge}
...
\ref{limits-lemma-higher-direct-images-zero-above-dimension-fibre}
and the results of Lemmas \ref{derham-lemma-relative-bottom-part-degenerates} and
...
Lemma \ref{derham-lemma-relative-duality-hodge}.
...
Lemma \ref{derham-lemma-relative-duality-hodge} and the result is true.
...
$$
\begin{array}{c}Rf_*\sigma_{\leq p}\Omega^\bullet \underset{a}{\downarrow} \\ Rf_*\Omega^{p + 1}[-p - 1] \underset{b}{\downarrow} \\ Rf_*\sigma_{\leq p + 1}\Omega^\bullet \underset{c}{\downarrow} \\ Rf_*\sigma_{\leq p}\Omega^\bullet \underset{d}{\downarrow} \\ Rf_*\Omega^{p + 1}[-p - 1]\end{array}
\quad\quad
\begin{array}{c}Rf_*\sigma_{\geq n - p}\Omega^\bullet \\ Rf_*\Omega^{n - p - 1}[-n + p + 1] \underset{a'}{\uparrow} \\ Rf_*\sigma_{\geq n - p - 1}\Omega^\bullet \underset{b'}{\uparrow} \\ Rf_*\sigma_{\geq n - p}\Omega^\bullet \underset{c'}{\uparrow} \\ Rf_*\Omega^{n - p - 1}[-n + p + 1] \underset{d'}{\uparrow}\end{array}
$$
...
triangle on the right. By induction and Lemma \ref{derham-lemma-duality-hodge}
we know that the pairings constructed above between the
...
diagram
$$
\begin{array}{cc}K' \otimes_{\mathcal{O}_S}^\mathbf{L} M' \downarrow & K \otimes_{\mathcal{O}_S}^\mathbf{L} M'
\overset{e \otimes 1}{\longleftarrow}\overset{1 \otimes e'}{\downarrow} \\ \mathcal{O}_S & K \otimes_{\mathcal{O}_S}^\mathbf{L} M \longleftarrow\end{array}
$$
commutes. This indeed means that the diagram
$$
\begin{array}{cc}K \longrightarrow\underset{e}{\downarrow} & R\SheafHom(M, \mathcal{O}_S) \overset{R\SheafHom(e', -)}{\downarrow} \\ K' \longrightarrow & R\SheafHom(M', \mathcal{O}_S)\end{array}
$$
...
that we have a commutative diagram
$$
\begin{array}{cc}\text{Tot}(\sigma_{\leq p} \Omega^\bullet \otimes_{f^{-1}\mathcal{O}_S}
\sigma_{\geq n - p} \Omega^\bullet) \underset{\gamma_p}{\downarrow} & \text{Tot}(\sigma_{\leq p + 1} \Omega^\bullet \otimes_{f^{-1}\mathcal{O}_S}
\sigma_{\geq n - p} \Omega^\bullet) \longleftarrow\downarrow \\ \Omega^\bullet & \text{Tot}(\sigma_{\leq p + 1} \Omega^\bullet \otimes_{f^{-1}\mathcal{O}_S}
\sigma_{\geq n - p - 1} \Omega^\bullet) \underset{\gamma_{p + 1}}{\longleftarrow}\end{array}
$$
...
Similarly for the pair $(b, b')$ we use the commutative diagram
$$
\begin{array}{cc}\text{Tot}(\sigma_{\leq p + 1} \Omega^\bullet \otimes_{f^{-1}\mathcal{O}_S}
\sigma_{\geq n - p - 1} \Omega^\bullet) \underset{\gamma_{p + 1}}{\downarrow} & \text{Tot}(\Omega^{p + 1}[-p - 1] \otimes_{f^{-1}\mathcal{O}_S}
\sigma_{\geq n - p - 1} \Omega^\bullet) \longleftarrow\downarrow \\ \Omega^\bullet & \Omega^{p + 1}[-p - 1]
\otimes_{f^{-1}\mathcal{O}_S}
\Omega^{n - p - 1}[-n + p + 1] \underset{\wedge}{\longleftarrow}\end{array}
$$

\medskip\noindent
For the pairs $(d, d')$ and $(a, a')$ we use the commutative diagram
$$
\begin{array}{cc}\Omega^{p + 1}[-p] \otimes_{f^{-1}\mathcal{O}_S}
\Omega^{n - p - 1}[-n + p] \downarrow & \text{Tot}(\sigma_{\leq p}\Omega^\bullet \otimes_{f^{-1}\mathcal{O}_S}
\Omega^{n - p - 1}[-n + p]) \longleftarrow\downarrow \\ \Omega^\bullet & \text{Tot}(\sigma_{\leq p}\Omega^\bullet \otimes_{f^{-1}\mathcal{O}_S}
\sigma_{\geq n - p}\Omega^\bullet) \longleftarrow\end{array}
$$
