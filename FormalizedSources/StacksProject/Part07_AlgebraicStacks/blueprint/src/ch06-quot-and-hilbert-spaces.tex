...
over $B$. See Section \ref{quot-section-hom}. The subfunctor
$\mathit{Isom}(\mathcal{F}, \mathcal{G})$ of isomorphisms is
shown to be an algebraic space in Section \ref{quot-section-isom}.
...
Section \ref{quot-section-stack-coherent-sheaves} when $X \to B$ is flat
and in Section \ref{quot-section-not-flat} in general.
...
Sections \ref{quot-section-quot}, \ref{quot-section-hilb},
\ref{quot-section-picard-functor}, and \ref{quot-section-picard-stack}.
...
hypotheses) in Section \ref{quot-section-relative-morphisms}.

\medskip\noindent
In Section \ref{quot-section-stack-of-spaces} we prove that the stack in
groupoids
$$
...
this stack intentionally, because the reader should be careful
in using its properties.

\medskip\noindent
In Section \ref{quot-section-polarized} we prove that the stack
$\Polarizedstack$
...
\medskip\noindent
In Section \ref{quot-section-curves} we prove that the stack
$\Curvesstack$ parametrizing families of curves is algebraic.

\medskip\noindent
In Section \ref{quot-section-moduli-complexes}
...
\begin{definition}[Situation: Hom]
\label{quot-situation-hom}
\source{stacks:08JT}
\href{https://stacks.math.columbia.edu/tag/08JT}{\texttt{Stacks tag 08JT}}
\group{quot}
...
In Situation \ref{quot-situation-hom} we sometimes think of
...
\begin{lemma}[Hom sheaf]
\label{quot-lemma-hom-sheaf}
\source{stacks:08JV}
\href{https://stacks.math.columbia.edu/tag/08JV}{\texttt{Stacks tag 08JV}}
\group{quot}

\uses{quot-situation-hom}
In Situation \ref{quot-situation-hom} the functor
$\mathit{Hom}(\mathcal{F}, \mathcal{G})$
...
\begin{lemma}[Extend hom to spaces]
\label{quot-lemma-extend-hom-to-spaces}
\source{stacks:0D3S}
\href{https://stacks.math.columbia.edu/tag/0D3S}{\texttt{Stacks tag 0D3S}}
\group{quot}

\uses{quot-situation-hom}
In Situation \ref{quot-situation-hom}. Let $T$ be an algebraic space over $S$.
We have
$$
...
\begin{remark}[Hom base change]
\label{quot-remark-hom-base-change}
\source{stacks:08JW}
\href{https://stacks.math.columbia.edu/tag/08JW}{\texttt{Stacks tag 08JW}}
\group{quot}

\uses{quot-situation-hom}
In Situation \ref{quot-situation-hom} let $B' \to B$ be a morphism of
...
\begin{lemma}[Hom sheaf in X]
\label{quot-lemma-hom-sheaf-in-X}
\source{stacks:08K3}
\href{https://stacks.math.columbia.edu/tag/08K3}{\texttt{Stacks tag 08K3}}
\group{quot}

\uses{quot-situation-hom}
In Situation \ref{quot-situation-hom} let $\{X_i \to X\}_{i \in I}$ be an fppf
...
$$
\begin{array}{ccc}\mathit{Hom}(\mathcal{F}, \mathcal{G})(T) \longrightarrow & \prod\nolimits_i
\mathit{Hom}(\mathcal{F}_i, \mathcal{G}_i)(T)
\overset{\text{pr}_0^*}{\longrightarrow}\underset{\text{pr}_1^*}{\longrightarrow} & \prod\nolimits_{i, j, k}
\mathit{Hom}(\mathcal{F}_{ijk}, \mathcal{G}_{ijk})(T)\end{array}
$$
...
\begin{lemma}[Hom limits]
\label{quot-lemma-hom-limits}
\source{stacks:08K4}
\href{https://stacks.math.columbia.edu/tag/08K4}{\texttt{Stacks tag 08K4}}
\group{quot}

\uses{quot-situation-hom}
In Situation \ref{quot-situation-hom}. If $\mathcal{F}$ is of finite presentation
and $f$ is quasi-compact and quasi-separated, then
$\mathit{Hom}(\mathcal{F}, \mathcal{G})$ is limit preserving.
\end{lemma}

\begin{proof}
\uses{quot-remark-hom-base-change, quot-lemma-hom-sheaf-in-X}
...
See Remark \ref{quot-remark-hom-base-change}.
...
where $V$ is an affine scheme. Applying Lemma \ref{quot-lemma-hom-sheaf-in-X}
...
\begin{lemma}[Hom closed]
\label{quot-lemma-hom-closed}
\source{stacks:08K5}
\href{https://stacks.math.columbia.edu/tag/08K5}{\texttt{Stacks tag 08K5}}
\group{quot}
...
\begin{lemma}[Cohomology perfect complex]
\label{quot-lemma-cohomology-perfect-complex}
\source{stacks:08JX}
\href{https://stacks.math.columbia.edu/tag/08JX}{\texttt{Stacks tag 08JX}}
\group{quot}
...
\begin{lemma}[Noetherian hom]
\label{quot-lemma-noetherian-hom}
\source{stacks:08JY}
\href{https://stacks.math.columbia.edu/tag/08JY}{\texttt{Stacks tag 08JY}}
\group{quot}

\uses{quot-situation-hom}
In Situation \ref{quot-situation-hom} assume that
\begin{enumerate}
...
\begin{proof}
\uses{quot-lemma-cohomology-perfect-complex}
...
Lemma \ref{quot-lemma-cohomology-perfect-complex}
...
Here is a cheap consequence of Lemma \ref{quot-lemma-noetherian-hom}.

\begin{proposition}[Hom]
\label{quot-proposition-hom}
\source{stacks:08K6}
\href{https://stacks.math.columbia.edu/tag/08K6}{\texttt{Stacks tag 08K6}}
\group{quot}
...
\begin{proof}
\uses{quot-lemma-hom-sheaf, quot-lemma-noetherian-hom, quot-remark-hom-base-change}

By Lemma \ref{quot-lemma-hom-sheaf} the functor
...
In Situation \ref{quot-situation-hom} we can consider the subfunctor
$$
...
\begin{lemma}[Isom sheaf]
\label{quot-lemma-isom-sheaf}
\source{stacks:08K8}
\href{https://stacks.math.columbia.edu/tag/08K8}{\texttt{Stacks tag 08K8}}
\group{quot}
...
\begin{lemma}[Extend isom to spaces]
\label{quot-lemma-extend-isom-to-spaces}
\source{stacks:0D3T}
\href{https://stacks.math.columbia.edu/tag/0D3T}{\texttt{Stacks tag 0D3T}}
\group{quot}
...
By Proposition \ref{quot-proposition-hom} the functors
...
\begin{definition}[Situation: Coherent]
\label{quot-situation-coherent}
\source{stacks:08KB}
\href{https://stacks.math.columbia.edu/tag/08KB}{\texttt{Stacks tag 08KB}}
\group{quot}
...
\begin{lemma}[Coherent fibred in groupoids]
\label{quot-lemma-coherent-fibred-in-groupoids}
\source{stacks:08W5}
\href{https://stacks.math.columbia.edu/tag/08W5}{\texttt{Stacks tag 08W5}}
\group{quot}

\uses{quot-situation-coherent}
In Situation \ref{quot-situation-coherent} the functor
$p : \Cohstack_{X/B} \longrightarrow (\Sch/S)_{fppf}$
...
\begin{lemma}[Coherent diagonal]
\label{quot-lemma-coherent-diagonal}
\source{stacks:08W6}
\href{https://stacks.math.columbia.edu/tag/08W6}{\texttt{Stacks tag 08W6}}
\group{quot}

\uses{quot-situation-coherent}
In Situation \ref{quot-situation-coherent}. Denote
...
and the result follows from Proposition \ref{quot-proposition-isom}.
\end{proof}

\begin{lemma}[Coherent stack]
\label{quot-lemma-coherent-stack}
\source{stacks:08KC}
\href{https://stacks.math.columbia.edu/tag/08KC}{\texttt{Stacks tag 08KC}}
\group{quot}
...
\begin{proof}
\uses{quot-lemma-coherent-diagonal}
...
Lemma \ref{quot-lemma-coherent-diagonal}, see
Algebraic Stacks, Lemma \ref{algebraic-lemma-representable-diagonal}.
...
\begin{remark}[Coherent base change]
\label{quot-remark-coherent-base-change}
\source{stacks:08LP}
\href{https://stacks.math.columbia.edu/tag/08LP}{\texttt{Stacks tag 08LP}}
\group{quot}

\uses{quot-situation-coherent, quot-lemma-coherent-stack}
In Situation \ref{quot-situation-coherent} the rule
$(T, g, \mathcal{F}) \mapsto (T, g)$ defines a $1$-morphism
$$
\Cohstack_{X/B} \longrightarrow \mathcal{S}_B
$$
of stacks in groupoids
(see Lemma \ref{quot-lemma-coherent-stack},
...
$$
\vcenter{
\begin{array}{cc}\Cohstack_{X'/B'} \longrightarrow\downarrow & \Cohstack_{X/B} \downarrow \\ \mathcal{S}_{B'} \longrightarrow & \mathcal{S}_B\end{array}
}
\quad
\begin{matrix}
\text{or in} \\
...
\quad
\vcenter{
\begin{array}{cc}\Cohstack_{X'/B'} \longrightarrow\downarrow & \Cohstack_{X/B} \downarrow \\ \Sch/B' \longrightarrow & \Sch/B\end{array}
}
$$
...
\begin{lemma}[Coherent limits]
\label{quot-lemma-coherent-limits}
\source{stacks:08KD}
\href{https://stacks.math.columbia.edu/tag/08KD}{\texttt{Stacks tag 08KD}}
\group{quot}

\uses{quot-situation-coherent}
In Situation \ref{quot-situation-coherent} assume that $B \to S$
...
$$
\begin{array}{cc}\colim \Cohstack_{X/B, T_i} \longrightarrow\downarrow & \Cohstack_{X/B, T} \downarrow \\ \colim B(T_i) \longrightarrow & B(T)\end{array}
$$
...
\begin{lemma}[Coherent RS star]
\label{quot-lemma-coherent-RS-star}
\source{stacks:08LQ}
\href{https://stacks.math.columbia.edu/tag/08LQ}{\texttt{Stacks tag 08LQ}}
\group{quot}

\uses{quot-situation-coherent}
In Situation \ref{quot-situation-coherent}. Let
$$
\begin{array}{cc}Z \longrightarrow\downarrow & Z' \downarrow \\ Y \longrightarrow & Y'\end{array}
$$
...
\begin{proof}
\uses{quot-remark-coherent-base-change}
...
$$
\begin{array}{cc}\Cohstack_{X/B, Y'} \longrightarrow\downarrow & \Cohstack_{X/B, Y} \times_{\Cohstack_{X/B, Z}} \Cohstack_{X/B, Z'}
\downarrow \\ B(Y') \longrightarrow & B(Y) \times_{B(Z)} B(Z')\end{array}
$$
...
\begin{lemma}[Coherent over first order thickening]
\label{quot-lemma-coherent-over-first-order-thickening}
\source{stacks:08W7}
\href{https://stacks.math.columbia.edu/tag/08W7}{\texttt{Stacks tag 08W7}}
\group{quot}

Let
$$
\begin{array}{cc}X \downarrow\underset{i}{\longrightarrow} & X' \downarrow \\ T \longrightarrow & T'\end{array}
$$
...
\begin{lemma}[Coherent tangent space]
\label{quot-lemma-coherent-tangent-space}
\source{stacks:08W8}
\href{https://stacks.math.columbia.edu/tag/08W8}{\texttt{Stacks tag 08W8}}
\group{quot}

\uses{quot-situation-coherent}
In Situation \ref{quot-situation-coherent} assume that $S$ is a locally Noetherian
...
\begin{proof}
\uses{quot-lemma-coherent-RS-star, quot-remark-coherent-base-change, quot-lemma-coherent-over-first-order-thickening}

Observe that by Lemma \ref{quot-lemma-coherent-RS-star}
...
Remark \ref{quot-remark-coherent-base-change} we have seen that
...
Lemma \ref{quot-lemma-coherent-over-first-order-thickening}
...
\begin{lemma}[Coherent existence]
\label{quot-lemma-coherent-existence}
\source{stacks:08W9}
\href{https://stacks.math.columbia.edu/tag/08W9}{\texttt{Stacks tag 08W9}}
\group{quot}
...
\begin{lemma}[Coherent defo thy]
\label{quot-lemma-coherent-defo-thy}
\source{stacks:08WA}
\href{https://stacks.math.columbia.edu/tag/08WA}{\texttt{Stacks tag 08WA}}
\group{quot}

\uses{quot-situation-coherent}
In Situation \ref{quot-situation-coherent} assume that
...
\begin{proof}
\uses{quot-lemma-coherent-diagonal, quot-lemma-coherent-RS-star, quot-lemma-coherent-limits}
[Second proof]
...
Lemmas \ref{quot-lemma-coherent-diagonal},
\ref{quot-lemma-coherent-RS-star}, and
...
\source{stacks:08WC}
\href{https://stacks.math.columbia.edu/tag/08WC}{\texttt{Stacks tag 08WC}}
\group{quot}

Let $S$ be a scheme. Let $f : X \to B$ be a morphism of algebraic spaces
over $S$. Assume that $f$ is of finite presentation, separated, and
flat\footnote{This assumption is not necessary. See
Section \ref{quot-section-not-flat}.}. Then $\Cohstack_{X/B}$ is
an algebraic stack over $S$.
\end{theorem}

\begin{proof}
\uses{quot-lemma-coherent-stack, quot-lemma-coherent-diagonal, quot-remark-coherent-base-change, quot-lemma-coherent-defo-thy, quot-lemma-coherent-limits, quot-lemma-coherent-RS-star, quot-lemma-coherent-tangent-space, quot-lemma-coherent-existence}
...
by algebraic spaces
(Lemmas \ref{quot-lemma-coherent-stack} and \ref{quot-lemma-coherent-diagonal}).
...
(Remark \ref{quot-remark-coherent-base-change}). By the material in
...
(Remark \ref{quot-remark-coherent-base-change} and
Algebraic Stacks, Section \ref{algebraic-section-change-base-scheme})
...
By Lemma \ref{quot-lemma-coherent-defo-thy}
...
Lemmas \ref{quot-lemma-coherent-stack},
\ref{quot-lemma-coherent-limits},
\ref{quot-lemma-coherent-RS-star},
\ref{quot-lemma-coherent-tangent-space}.
Condition (3) follows from Lemma \ref{quot-lemma-coherent-existence}.
Finally, condition (1) is Lemma \ref{quot-lemma-coherent-diagonal}.
This finishes the proof of the theorem.
\end{proof}

\section{The stack of coherent sheaves in the non-flat case}
\label{quot-section-not-flat}
In Theorem \ref{quot-theorem-coherent-algebraic} the assumption that $f : X \to B$
...
\source{stacks:09DS}
\href{https://stacks.math.columbia.edu/tag/09DS}{\texttt{Stacks tag 09DS}}
\group{quot}
...
\begin{proof}
\uses{quot-lemma-coherent-stack, quot-lemma-coherent-diagonal, quot-remark-coherent-base-change, quot-lemma-coherent-limits, quot-lemma-coherent-RS-star, quot-lemma-coherent-tangent-space, quot-lemma-coherent-existence}
...
\ref{quot-lemma-coherent-RS-star},
\ref{quot-lemma-coherent-tangent-space}.
Condition (3) is Lemma \ref{quot-lemma-coherent-existence}.
Condition (1) is Lemma \ref{quot-lemma-coherent-diagonal}.
...
\begin{definition}[Situation: Q]
\label{quot-situation-q}
\source{stacks:082M}
\href{https://stacks.math.columbia.edu/tag/082M}{\texttt{Stacks tag 082M}}
\group{quot}
...
In Situation \ref{quot-situation-q} we sometimes think of
...
\begin{remark}[Q base change]
\label{quot-remark-q-base-change}
\source{stacks:08IT}
\href{https://stacks.math.columbia.edu/tag/08IT}{\texttt{Stacks tag 08IT}}
\group{quot}

\uses{quot-situation-q}
In Situation \ref{quot-situation-q} let $B' \to B$ be a morphism of
algebraic spaces over $S$. Set $X' = X \times_B B'$ and denote
...
\begin{remark}[Q sheaf]
\label{quot-remark-q-sheaf}
\source{stacks:08IU}
\href{https://stacks.math.columbia.edu/tag/08IU}{\texttt{Stacks tag 08IU}}
\group{quot}
...
\source{stacks:082P}
\href{https://stacks.math.columbia.edu/tag/082P}{\texttt{Stacks tag 082P}}
\group{quot}

\uses{quot-situation-q}
In Situation \ref{quot-situation-q}. The functors
...
Remark \ref{quot-remark-q-sheaf}
...
\begin{lemma}[Extend q to spaces]
\label{quot-lemma-extend-q-to-spaces}
\source{stacks:0D3U}
\href{https://stacks.math.columbia.edu/tag/0D3U}{\texttt{Stacks tag 0D3U}}
\group{quot}

\uses{quot-situation-q}
In Situation \ref{quot-situation-q}. Let $T$ be an algebraic space over $S$.
We have
$$
...
\begin{lemma}[Q sheaf in X]
\label{quot-lemma-q-sheaf-in-X}
\source{stacks:08IV}
\href{https://stacks.math.columbia.edu/tag/08IV}{\texttt{Stacks tag 08IV}}
\group{quot}

\uses{quot-situation-q}
In Situation \ref{quot-situation-q} let $\{X_i \to X\}_{i \in I}$ be an fpqc
covering and for each $i, j \in I$ let $\{X_{ijk} \to X_i \times_X X_j\}$
...
$T$ over $B$ the diagram
$$
\begin{array}{ccc}Q_{\mathcal{F}/X/B}(T) \longrightarrow & \prod\nolimits_i
Q_{\mathcal{F}_i/X_i/B}(T)
\overset{\text{pr}_0^*}{\longrightarrow}\underset{\text{pr}_1^*}{\longrightarrow} & \prod\nolimits_{i, j, k}
Q_{\mathcal{F}_{ijk}/X_{ijk}/B}(T)\end{array}
$$
presents the first arrow as the equalizer of the other two.
...
of $\text{pr}_0^*$ and $\text{pr}_1^*$. By Remark \ref{quot-remark-q-sheaf}
...
\begin{lemma}[Q limit preserving]
\label{quot-lemma-q-limit-preserving}
\source{stacks:082Q}
\href{https://stacks.math.columbia.edu/tag/082Q}{\texttt{Stacks tag 082Q}}
\group{quot}

\uses{quot-situation-q}
In Situation \ref{quot-situation-q} assume also that
...
\begin{lemma}[Q RS star]
\label{quot-lemma-q-RS-star}
\source{stacks:08IW}
\href{https://stacks.math.columbia.edu/tag/08IW}{\texttt{Stacks tag 08IW}}
\group{quot}

\uses{quot-situation-q}
In Situation \ref{quot-situation-q}. Let
$$
\begin{array}{cc}Z \longrightarrow\downarrow & Z' \downarrow \\ Y \longrightarrow & Y'\end{array}
$$
...
\source{stacks:0CZU}
\href{https://stacks.math.columbia.edu/tag/0CZU}{\texttt{Stacks tag 0CZU}}
\group{quot}

\uses{quot-situation-q}
In Situation \ref{quot-situation-q} {\bf assume} that $\mathcal{F}$ is flat
...
\source{stacks:0CZV}
\href{https://stacks.math.columbia.edu/tag/0CZV}{\texttt{Stacks tag 0CZV}}
\group{quot}

\uses{quot-situation-q, quot-remark-q-obs}
In Situation \ref{quot-situation-q} {\bf assume} that $\mathcal{F}$ is flat
over $B$. We continue the discussion of Remark \ref{quot-remark-q-obs}.
...
$$
\begin{array}{ccccc} & 0 \downarrow & 0 \downarrow & 0 \downarrow &  \\ 0 \longrightarrow & \mathcal{K} \otimes \mathcal{J} \longrightarrow\downarrow & \mathcal{F}_T \otimes \mathcal{J} \longrightarrow\downarrow & \mathcal{Q} \otimes \mathcal{J} \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & \mathcal{K}' \longrightarrow\downarrow & \mathcal{F}_{T'} \longrightarrow\downarrow & \mathcal{Q}' \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & \mathcal{K} \downarrow\longrightarrow & \mathcal{F}_T \downarrow\longrightarrow & \mathcal{Q} \downarrow\longrightarrow & 0 \\  & 0 & 0 & 0 & \end{array}
$$
...
\begin{definition}[Situation: Quot]
\label{quot-situation-quot}
\source{stacks:09TR}
\href{https://stacks.math.columbia.edu/tag/09TR}{\texttt{Stacks tag 09TR}}
\group{quot}
...
we discussed in Section \ref{quot-section-functor-quotients}.
Thus we obtain a functor
\begin{equation}
\label{equation-quot}
...
In Situation \ref{quot-situation-quot} we sometimes think of
...
\begin{lemma}[Quot sheaf]
\label{quot-lemma-quot-sheaf}
\source{stacks:09TT}
\href{https://stacks.math.columbia.edu/tag/09TT}{\texttt{Stacks tag 09TT}}
\group{quot}

\uses{quot-situation-quot}
In Situation \ref{quot-situation-quot}. The functor $\Quotfunctor_{\mathcal{F}/X/B}$
satisfies the sheaf property for the fpqc topology.
\end{lemma}

\begin{proof}
\uses{quot-lemma-q-sheaf}

In Lemma \ref{quot-lemma-q-sheaf} we have seen that the functor
...
\begin{lemma}[Extend quot to spaces]
\label{quot-lemma-extend-quot-to-spaces}
\source{stacks:0D3V}
\href{https://stacks.math.columbia.edu/tag/0D3V}{\texttt{Stacks tag 0D3V}}
\group{quot}

\uses{quot-situation-quot}
In Situation \ref{quot-situation-quot}. Let $T$ be an algebraic space over $S$.
We have
$$
...
\begin{proof}
\uses{quot-lemma-extend-q-to-spaces}

Observe that the left and right hand side of the equality are
subsets of the left and right hand side of the second equality in
Lemma \ref{quot-lemma-extend-q-to-spaces}.
...
\begin{proposition}[Quot]
\label{quot-proposition-quot}
\source{stacks:09TU}
\href{https://stacks.math.columbia.edu/tag/09TU}{\texttt{Stacks tag 09TU}}
\group{quot}
...
\begin{proof}
\uses{quot-lemma-quot-sheaf, quot-theorem-coherent-algebraic-general, quot-proposition-hom}

By Lemma \ref{quot-lemma-quot-sheaf}
...
By Theorem \ref{quot-theorem-coherent-algebraic-general} we know that
...
Proposition \ref{quot-proposition-hom}.
\end{proof}
...
\source{stacks:0CZW}
\href{https://stacks.math.columbia.edu/tag/0CZW}{\texttt{Stacks tag 0CZW}}
\group{quot}

\uses{quot-proposition-quot, quot-lemma-quot-sheaf, quot-lemma-q-limit-preserving, quot-lemma-q-RS-star, quot-remark-q-defos, quot-remark-q-obs, quot-lemma-coherent-defo-thy}
...
as was done in the proof of Proposition \ref{quot-proposition-quot}.
...
follow from Lemmas \ref{quot-lemma-quot-sheaf},
\ref{quot-lemma-q-limit-preserving}, and \ref{quot-lemma-q-RS-star}
...
deformations in Remark \ref{quot-remark-q-defos}
...
in Remark \ref{quot-remark-q-obs} and the description of
deformations in Remark \ref{quot-remark-q-defos}
to do this using the criterion in
Artin's Axioms, Lemma \ref{artin-lemma-get-openness-obstruction-theory}.
Please compare with the second proof of
Lemma \ref{quot-lemma-coherent-defo-thy}.
\end{remark}
...
\begin{definition}[Situation: Hilb]
\label{quot-situation-hilb}
\source{stacks:0CZY}
\href{https://stacks.math.columbia.edu/tag/0CZY}{\texttt{Stacks tag 0CZY}}
\group{quot}
...
In Situation \ref{quot-situation-hilb} we sometimes think of $\Hilbfunctor_{X/B}$
...
\begin{lemma}[Hilb is quot]
\label{quot-lemma-hilb-is-quot}
\source{stacks:0D00}
\href{https://stacks.math.columbia.edu/tag/0D00}{\texttt{Stacks tag 0D00}}
\group{quot}

\uses{quot-situation-hilb}
In Situation \ref{quot-situation-hilb} we have
...
\begin{lemma}[Extend hilb to spaces]
\label{quot-lemma-extend-hilb-to-spaces}
\source{stacks:0D3W}
\href{https://stacks.math.columbia.edu/tag/0D3W}{\texttt{Stacks tag 0D3W}}
\group{quot}

\uses{quot-situation-hilb}
In Situation \ref{quot-situation-hilb}. Let $T$ be an algebraic space over $S$.
We have
$$
...
\begin{proof}
\uses{quot-lemma-hilb-is-quot, quot-lemma-extend-quot-to-spaces}

By Lemma \ref{quot-lemma-hilb-is-quot}
we have $\Hilbfunctor_{X/B} = \Quotfunctor_{\mathcal{O}_X/X/B}$.
Thus we can apply Lemma \ref{quot-lemma-extend-quot-to-spaces}
...
proof of Lemma \ref{quot-lemma-hilb-is-quot}
...
\begin{proposition}[Hilb]
\label{quot-proposition-hilb}
\source{stacks:0D01}
\href{https://stacks.math.columbia.edu/tag/0D01}{\texttt{Stacks tag 0D01}}
\group{quot}
...
\begin{proof}
\uses{quot-lemma-hilb-is-quot, quot-proposition-quot}

Immediate consequence of
Lemma \ref{quot-lemma-hilb-is-quot}
and Proposition \ref{quot-proposition-quot}.
\end{proof}
...
\begin{lemma}[Picard stack open in coh]
\label{quot-lemma-picard-stack-open-in-coh}
\source{stacks:0D03}
\href{https://stacks.math.columbia.edu/tag/0D03}{\texttt{Stacks tag 0D03}}
\group{quot}
...
Situation \ref{quot-situation-coherent}.
...
\begin{proposition}[Pic]
\label{quot-proposition-pic}
\source{stacks:0D04}
\href{https://stacks.math.columbia.edu/tag/0D04}{\texttt{Stacks tag 0D04}}
\group{quot}
...
\begin{proof}
\uses{quot-lemma-picard-stack-open-in-coh, quot-theorem-coherent-algebraic, quot-theorem-coherent-algebraic-general}

Immediate consequence of
Lemma \ref{quot-lemma-picard-stack-open-in-coh},
Algebraic Stacks, Lemma
\ref{algebraic-lemma-representable-morphism-to-algebraic}
and either
Theorem \ref{quot-theorem-coherent-algebraic}
or
...
the section on the Picard stack, see Section \ref{quot-section-picard-stack}.
...
\begin{definition}[Situation: Pic]
\label{quot-situation-pic}
\source{stacks:0D25}
\href{https://stacks.math.columbia.edu/tag/0D25}{\texttt{Stacks tag 0D25}}
\group{quot}
...
In Situation \ref{quot-situation-pic} we sometimes think of
...
\begin{lemma}[Pic over pic]
\label{quot-lemma-pic-over-pic}
\source{stacks:0D26}
\href{https://stacks.math.columbia.edu/tag/0D26}{\texttt{Stacks tag 0D26}}
\group{quot}

\uses{quot-situation-pic}
In Situation \ref{quot-situation-pic}
...
$X_T$ (see Section \ref{quot-section-picard-stack} and
...
\begin{lemma}[Flat geometrically connected fibres]
\label{quot-lemma-flat-geometrically-connected-fibres}
\source{stacks:0D27}
\href{https://stacks.math.columbia.edu/tag/0D27}{\texttt{Stacks tag 0D27}}
\group{quot}
...
\begin{lemma}[Flat geometrically connected fibres with section]
\label{quot-lemma-flat-geometrically-connected-fibres-with-section}
\source{stacks:0D28}
\href{https://stacks.math.columbia.edu/tag/0D28}{\texttt{Stacks tag 0D28}}
\group{quot}

\uses{quot-situation-pic}
In Situation \ref{quot-situation-pic} let $\sigma : B \to X$ be a section.
...
\begin{proof}
\uses{quot-lemma-flat-geometrically-connected-fibres}
...
Thus by Lemma \ref{quot-lemma-flat-geometrically-connected-fibres} we see that
...
\begin{lemma}[Pic with section stack]
\label{quot-lemma-pic-with-section-stack}
\source{stacks:0D29}
\href{https://stacks.math.columbia.edu/tag/0D29}{\texttt{Stacks tag 0D29}}
\group{quot}
...
\begin{lemma}[Compare pic with section]
\label{quot-lemma-compare-pic-with-section}
\source{stacks:0D2A}
\href{https://stacks.math.columbia.edu/tag/0D2A}{\texttt{Stacks tag 0D2A}}
\group{quot}
...
presentation over $T$ by Proposition \ref{quot-proposition-isom}
...
\begin{lemma}[Flat geometrically connected fibres with section functor stack]
\label{quot-lemma-flat-geometrically-connected-fibres-with-section-functor-stack}
\source{stacks:0D2B}
\href{https://stacks.math.columbia.edu/tag/0D2B}{\texttt{Stacks tag 0D2B}}
\group{quot}
...
\begin{proposition}[Pic functor]
\label{quot-proposition-pic-functor}
\source{stacks:0D2C}
\href{https://stacks.math.columbia.edu/tag/0D2C}{\texttt{Stacks tag 0D2C}}
\group{quot}
...
\begin{proof}
\uses{quot-proposition-pic, quot-lemma-compare-pic-with-section, quot-lemma-flat-geometrically-connected-fibres-with-section-functor-stack, quot-lemma-flat-geometrically-connected-fibres-with-section}
...
Proposition \ref{quot-proposition-pic} we see that
$\Picardstack_{X/B}$ is an algebraic stack.
By Lemma \ref{quot-lemma-compare-pic-with-section} and
Algebraic Stacks, Lemma
\ref{algebraic-lemma-representable-morphism-to-algebraic}
...
By Lemma \ref{quot-lemma-flat-geometrically-connected-fibres-with-section}
this functor is the same as $\Picardfunctor_{X/B}$.
\end{proof}

\begin{lemma}[Diagonal pic]
\label{quot-lemma-diagonal-pic}
\source{stacks:0D2D}
\href{https://stacks.math.columbia.edu/tag/0D2D}{\texttt{Stacks tag 0D2D}}
\group{quot}

\uses{quot-proposition-pic-functor}
With assumptions and notation as in Proposition \ref{quot-proposition-pic-functor}.
Then the diagonal
...
Lemma \ref{quot-lemma-flat-geometrically-connected-fibres}.
...
\begin{lemma}[Mor into Hilb]
\label{quot-lemma-Mor-into-Hilb}
\source{stacks:0D1A}
\href{https://stacks.math.columbia.edu/tag/0D1A}{\texttt{Stacks tag 0D1A}}
\group{quot}
...
\begin{lemma}[Mor into Hilb open]
\label{quot-lemma-Mor-into-Hilb-open}
\source{stacks:0D1B}
\href{https://stacks.math.columbia.edu/tag/0D1B}{\texttt{Stacks tag 0D1B}}
\group{quot}

\uses{quot-lemma-Mor-into-Hilb}
Assumption and notation as in Lemma \ref{quot-lemma-Mor-into-Hilb}.
The transformation
$\mathit{Mor}_B(Z, X) \longrightarrow \Hilbfunctor_{Z \times_B X/B}$
is representable by open immersions.
\end{lemma}
...
\begin{proposition}[Mor]
\label{quot-proposition-Mor}
\source{stacks:0D1C}
\href{https://stacks.math.columbia.edu/tag/0D1C}{\texttt{Stacks tag 0D1C}}
\group{quot}
...
\begin{proof}
\uses{quot-lemma-Mor-into-Hilb-open, quot-proposition-hilb}

Immediate consequence of
Lemma \ref{quot-lemma-Mor-into-Hilb-open}
and Proposition \ref{quot-proposition-hilb}.
\end{proof}
...
$$
\begin{array}{cc}X' \downarrow\underset{f}{\longrightarrow} & X \downarrow \\ S' \overset{g}{\longrightarrow} & S\end{array}
$$
...
\begin{lemma}[Spaces fibred in groupoids]
\label{quot-lemma-spaces-fibred-in-groupoids}
\source{stacks:0D1E}
\href{https://stacks.math.columbia.edu/tag/0D1E}{\texttt{Stacks tag 0D1E}}
\group{quot}
...
\begin{lemma}[Spaces diagonal]
\label{quot-lemma-spaces-diagonal}
\source{stacks:0D1F}
\href{https://stacks.math.columbia.edu/tag/0D1F}{\texttt{Stacks tag 0D1F}}
\group{quot}
...
$$
\begin{array}{cc}\mathit{Isom}_S(X, Y) \longrightarrow\downarrow & S \underset{(\text{id}, \text{id})}{\downarrow} \\ \mathit{Mor}_S(X, Y) \times \mathit{Mor}_S(Y, X) \longrightarrow & \mathit{Mor}_S(X, X) \times \mathit{Mor}_S(Y, Y)\end{array}
$$
The bottom arrow sends $(\varphi, \psi)$ to
$(\psi \circ \varphi, \varphi \circ \psi)$.
By Proposition \ref{quot-proposition-Mor} the functors on the bottom row
...
\begin{lemma}[Spaces stack]
\label{quot-lemma-spaces-stack}
\source{stacks:0D1G}
\href{https://stacks.math.columbia.edu/tag/0D1G}{\texttt{Stacks tag 0D1G}}
\group{quot}
...
\begin{proof}
\uses{quot-lemma-spaces-fibred-in-groupoids, quot-lemma-spaces-diagonal}
...
\medskip\noindent
Property (1) we have seen in Lemma \ref{quot-lemma-spaces-fibred-in-groupoids}.

\medskip\noindent
Property (2) follows from
Lemma \ref{quot-lemma-spaces-diagonal} in the case of
$\Spacesstack'_{fp, flat, proper}$.
...
\begin{lemma}[Extend spaces to spaces]
\label{quot-lemma-extend-spaces-to-spaces}
\source{stacks:0E93}
\href{https://stacks.math.columbia.edu/tag/0E93}{\texttt{Stacks tag 0E93}}
\group{quot}
...
$$
\begin{array}{cccc}\mathcal{S}_{U \times_T U \times_T U} \longrightarrow\longrightarrow\longrightarrow & \mathcal{S}_R \longrightarrow\longrightarrow & \mathcal{S}_U \longrightarrow & \mathcal{S}_T\end{array}
$$
...
\begin{remark}[Spaces base change]
\label{quot-remark-spaces-base-change}
\source{stacks:0D1H}
\href{https://stacks.math.columbia.edu/tag/0D1H}{\texttt{Stacks tag 0D1H}}
\group{quot}
...
$$
\begin{array}{cc}B\textit{-Spaces}'_{ft} \longrightarrow\downarrow & \Spacesstack'_{ft} \downarrow \\ (\Sch/B)_{fppf} \longrightarrow & \Sch_{fppf}\end{array}
$$
is $2$-fibre product square. This trivial remark
...
\begin{lemma}[Spaces limits]
\label{quot-lemma-spaces-limits}
\source{stacks:0D1I}
\href{https://stacks.math.columbia.edu/tag/0D1I}{\texttt{Stacks tag 0D1I}}
\group{quot}
...
\begin{lemma}[Spaces RS star]
\label{quot-lemma-spaces-RS-star}
\source{stacks:0D1J}
\href{https://stacks.math.columbia.edu/tag/0D1J}{\texttt{Stacks tag 0D1J}}
\group{quot}

Let
$$
\begin{array}{cc}T \longrightarrow\downarrow & T' \downarrow \\ S \longrightarrow & S'\end{array}
$$
...
\begin{lemma}[Spaces tangent space]
\label{quot-lemma-spaces-tangent-space}
\source{stacks:0D1K}
\href{https://stacks.math.columbia.edu/tag/0D1K}{\texttt{Stacks tag 0D1K}}
\group{quot}
...
\begin{proof}
\uses{quot-lemma-spaces-RS-star}
...
Our stack satisfies (RS*) by Lemma \ref{quot-lemma-spaces-RS-star}
and we may apply
...
\begin{lemma}[Spaces defo thy]
\label{quot-lemma-spaces-defo-thy}
\source{stacks:0D3X}
\href{https://stacks.math.columbia.edu/tag/0D3X}{\texttt{Stacks tag 0D3X}}
\group{quot}

\uses{quot-remark-spaces-base-change}
The stack in groupoids $\mathcal{X} = \Spacesstack'_{fp, flat, proper}$
satisfies openness of versality over $\Spec(\mathbf{Z})$.
Similarly, after base change (Remark \ref{quot-remark-spaces-base-change})
openness of versality holds over any Noetherian base scheme $S$.
\end{lemma}

\begin{proof}
\uses{quot-lemma-spaces-diagonal, quot-lemma-spaces-RS-star, quot-lemma-spaces-limits}
...
We have already seen that $\mathcal{X}$ has diagonal
representable by algebraic spaces, has (RS*), and is limit preserving,
see Lemmas \ref{quot-lemma-spaces-diagonal},
\ref{quot-lemma-spaces-RS-star}, and
...
\begin{remark}[Spaces defo thy]
\label{quot-remark-spaces-defo-thy}
\source{stacks:0D1P}
\href{https://stacks.math.columbia.edu/tag/0D1P}{\texttt{Stacks tag 0D1P}}
\group{quot}

\uses{quot-lemma-spaces-defo-thy, quot-lemma-coherent-defo-thy}
Lemma \ref{quot-lemma-spaces-defo-thy} can also be shown using either
Artin's Axioms, Lemma \ref{artin-lemma-dual-openness}
(as in the first proof of
Lemma \ref{quot-lemma-coherent-defo-thy}), or using an obstruction theory
...
space we want (see Remark \ref{quot-remark-polarized-base-change}).

\begin{definition}[Situation: Polarized]
\label{quot-situation-polarized}
\source{stacks:0D1M}
\href{https://stacks.math.columbia.edu/tag/0D1M}{\texttt{Stacks tag 0D1M}}
\group{quot}
...
(see Section \ref{quot-section-conventions} for notation).
\end{definition}
...
\begin{lemma}[Polarized fibred in groupoids]
\label{quot-lemma-polarized-fibred-in-groupoids}
\source{stacks:0D3Z}
\href{https://stacks.math.columbia.edu/tag/0D3Z}{\texttt{Stacks tag 0D3Z}}
\group{quot}
...
\begin{lemma}[Polarized stack]
\label{quot-lemma-polarized-stack}
\source{stacks:0D40}
\href{https://stacks.math.columbia.edu/tag/0D40}{\texttt{Stacks tag 0D40}}
\group{quot}
...
\begin{proof}
\uses{quot-lemma-polarized-fibred-in-groupoids, quot-lemma-spaces-stack}
...
Lemma \ref{quot-lemma-polarized-fibred-in-groupoids}.
...
(Lemma \ref{quot-lemma-spaces-stack}) it now follows formally
...
\begin{lemma}[Extend polarized to spaces]
\label{quot-lemma-extend-polarized-to-spaces}
\source{stacks:0E94}
\href{https://stacks.math.columbia.edu/tag/0E94}{\texttt{Stacks tag 0E94}}
\group{quot}
...
\begin{proof}
\uses{quot-lemma-extend-spaces-to-spaces}

Omitted. Hints: Argue exactly as in the proof of
Lemma \ref{quot-lemma-extend-spaces-to-spaces} and use
Descent on Spaces, Proposition
\ref{spaces-descent-proposition-fpqc-descent-quasi-coherent}
...
\begin{remark}[Polarized base change]
\label{quot-remark-polarized-base-change}
\source{stacks:0D1N}
\href{https://stacks.math.columbia.edu/tag/0D1N}{\texttt{Stacks tag 0D1N}}
\group{quot}
...
In this situation the diagram
$$
\begin{array}{cc}B\textit{-Polarized} \longrightarrow\downarrow & \Polarizedstack \downarrow \\ (\Sch/B)_{fppf} \longrightarrow & \Sch_{fppf}\end{array}
$$
is $2$-fibre product square. This trivial remark
will occasionally be useful to deduce results from
...
\begin{lemma}[Polarized to spaces algebraic]
\label{quot-lemma-polarized-to-spaces-algebraic}
\source{stacks:0D41}
\href{https://stacks.math.columbia.edu/tag/0D41}{\texttt{Stacks tag 0D41}}
\group{quot}
...
\begin{proof}
\uses{quot-lemma-spaces-stack, quot-lemma-polarized-stack, quot-proposition-pic}

By Lemmas \ref{quot-lemma-spaces-stack} and \ref{quot-lemma-polarized-stack}
...
Proposition \ref{quot-proposition-pic} it suffices to show that the inclusion
...
\begin{lemma}[Polarized diagonal]
\label{quot-lemma-polarized-diagonal}
\source{stacks:0D42}
\href{https://stacks.math.columbia.edu/tag/0D42}{\texttt{Stacks tag 0D42}}
\group{quot}
...
\begin{proof}
\uses{quot-lemma-polarized-to-spaces-algebraic, quot-lemma-spaces-diagonal}

This is a formal consequence of
Lemmas \ref{quot-lemma-polarized-to-spaces-algebraic} and
...
\begin{lemma}[Polarized limits]
\label{quot-lemma-polarized-limits}
\source{stacks:0D43}
\href{https://stacks.math.columbia.edu/tag/0D43}{\texttt{Stacks tag 0D43}}
\group{quot}
...
\begin{lemma}[Polarized RS star]
\label{quot-lemma-polarized-RS-star}
\source{stacks:0D44}
\href{https://stacks.math.columbia.edu/tag/0D44}{\texttt{Stacks tag 0D44}}
\group{quot}
...
\begin{lemma}[Polarized tangent space]
\label{quot-lemma-polarized-tangent-space}
\source{stacks:0D4S}
\href{https://stacks.math.columbia.edu/tag/0D4S}{\texttt{Stacks tag 0D4S}}
\group{quot}
...
\begin{proof}
\uses{quot-lemma-polarized-RS-star, quot-lemma-spaces-tangent-space}

The discussion in Artin's Axioms, Section \ref{artin-section-tangent-spaces}
only applies to fields of finite type over the base scheme $\Spec(\mathbf{Z})$.
Our stack satisfies (RS*) by Lemma \ref{quot-lemma-polarized-RS-star}
and we may apply
Artin's Axioms, Lemma \ref{artin-lemma-properties-lift-RS-star}
to get the vector spaces $T_x(k)$ and $\text{Inf}_x(k)$
mentioned in (2). Moreover, in the finite type case these spaces agree with the
...
Lemma \ref{quot-lemma-spaces-tangent-space}; this would
...
Lemma \ref{quot-lemma-spaces-tangent-space},
the algebraicity of
$\Polarizedstack \to \Spacesstack'_{fp, flat, proper}$,
...
\begin{lemma}[Grothendieck's algebraization theorem continues to hold in the non-Noetherian setting i...]
\label{quot-lemma-polarized-strong-effectiveness}
\source{stacks:0D4T}
\href{https://stacks.math.columbia.edu/tag/0D4T}{\texttt{Stacks tag 0D4T}}
\group{quot}
...
\begin{lemma}[Polarized existence]
\label{quot-lemma-polarized-existence}
\source{stacks:0D4U}
\href{https://stacks.math.columbia.edu/tag/0D4U}{\texttt{Stacks tag 0D4U}}
\group{quot}
...
\begin{proof}
\uses{quot-lemma-polarized-strong-effectiveness}
...
from the more general Lemma \ref{quot-lemma-polarized-strong-effectiveness}.
\end{proof}

\begin{lemma}[Polarized defo thy]
\label{quot-lemma-polarized-defo-thy}
\source{stacks:0D4V}
\href{https://stacks.math.columbia.edu/tag/0D4V}{\texttt{Stacks tag 0D4V}}
\group{quot}

\uses{quot-remark-polarized-base-change}
The stack in groupoids $\Polarizedstack$
satisfies openness of versality over $\Spec(\mathbf{Z})$.
Similarly, after base change (Remark \ref{quot-remark-polarized-base-change})
openness of versality holds over any Noetherian base scheme $S$.
\end{lemma}

\begin{proof}
\uses{quot-lemma-polarized-diagonal, quot-lemma-polarized-RS-star, quot-lemma-polarized-limits, quot-lemma-polarized-strong-effectiveness}

This follows from
Artin's Axioms, Lemma \ref{artin-lemma-SGE-implies-openness-versality}
and Lemmas \ref{quot-lemma-polarized-diagonal},
...
\begin{remark}[Polarized defo thy]
\label{quot-remark-polarized-defo-thy}
\source{stacks:0D4W}
\href{https://stacks.math.columbia.edu/tag/0D4W}{\texttt{Stacks tag 0D4W}}
\group{quot}

\uses{quot-lemma-polarized-defo-thy, quot-lemma-coherent-defo-thy, quot-lemma-polarized-to-spaces-algebraic, quot-lemma-spaces-defo-thy, quot-remark-spaces-defo-thy}
Lemma \ref{quot-lemma-polarized-defo-thy} can also be shown
using an obstruction theory as in
Artin's Axioms, Lemma \ref{artin-lemma-get-openness-obstruction-theory}
(as in the second proof of Lemma \ref{quot-lemma-coherent-defo-thy}).
...
$\Polarizedstack \to \Spacesstack'_{fp, flat, proper}$
is algebraic (Lemma \ref{quot-lemma-polarized-to-spaces-algebraic})
and the fact that we know openness of versality for the target
(Lemma \ref{quot-lemma-spaces-defo-thy} and
Remark \ref{quot-remark-spaces-defo-thy}).
\end{remark}
...
\source{stacks:0D4X}
\href{https://stacks.math.columbia.edu/tag/0D4X}{\texttt{Stacks tag 0D4X}}
\group{quot}

\uses{quot-situation-polarized, quot-remark-polarized-base-change}
The stack $\Polarizedstack$ (Situation \ref{quot-situation-polarized})
is algebraic. In fact, for any algebraic space $B$ the stack
$B\textit{-Polarized}$ (Remark \ref{quot-remark-polarized-base-change})
is algebraic.
\end{theorem}

\begin{proof}
\uses{quot-lemma-polarized-diagonal, quot-lemma-polarized-RS-star, quot-lemma-polarized-limits, quot-lemma-polarized-existence, quot-lemma-polarized-defo-thy, quot-remark-polarized-base-change}
...
\ref{quot-lemma-polarized-existence}, and
...
Remark \ref{quot-remark-polarized-base-change}, and the fact
...
\begin{definition}[Situation: Curves]
\label{quot-situation-curves}
\source{stacks:0D4Z}
\href{https://stacks.math.columbia.edu/tag/0D4Z}{\texttt{Stacks tag 0D4Z}}
\group{quot}
...
\begin{lemma}[Curves fibred in groupoids]
\label{quot-lemma-curves-fibred-in-groupoids}
\source{stacks:0D51}
\href{https://stacks.math.columbia.edu/tag/0D51}{\texttt{Stacks tag 0D51}}
\group{quot}
...
\begin{proof}
\uses{quot-lemma-spaces-fibred-in-groupoids}
...
(Lemma \ref{quot-lemma-spaces-fibred-in-groupoids})
...
\begin{lemma}[Curves stack]
\label{quot-lemma-curves-stack}
\source{stacks:0D52}
\href{https://stacks.math.columbia.edu/tag/0D52}{\texttt{Stacks tag 0D52}}
\group{quot}
...
\begin{proof}
\uses{quot-lemma-spaces-stack}

Using the embedding (\ref{equation-curves-over-proper-spaces}),
the description of the image, and
the corresponding fact for $\Spacesstack'_{fp, flat, proper}$
(Lemma \ref{quot-lemma-spaces-stack})
...
\begin{lemma}[Curves diagonal]
\label{quot-lemma-curves-diagonal}
\source{stacks:0D53}
\href{https://stacks.math.columbia.edu/tag/0D53}{\texttt{Stacks tag 0D53}}
\group{quot}
...
\begin{proof}
\uses{quot-lemma-spaces-diagonal}

This is immediate from the fully faithful embedding
(\ref{equation-curves-over-proper-spaces}) and
the corresponding fact for $\Spacesstack'_{fp, flat, proper}$
(Lemma \ref{quot-lemma-spaces-diagonal}).
\end{proof}

\begin{remark}[Curves base change]
\label{quot-remark-curves-base-change}
\source{stacks:0D54}
\href{https://stacks.math.columbia.edu/tag/0D54}{\texttt{Stacks tag 0D54}}
\group{quot}
...
In this situation the diagram
$$
\begin{array}{cc}B\text{-}\Curvesstack \longrightarrow\downarrow & \Curvesstack \downarrow \\ (\Sch/B)_{fppf} \longrightarrow & \Sch_{fppf}\end{array}
$$
is $2$-fibre product square. This trivial remark
will occasionally be useful to deduce results from
...
\begin{lemma}[Curves limits]
\label{quot-lemma-curves-limits}
\source{stacks:0D55}
\href{https://stacks.math.columbia.edu/tag/0D55}{\texttt{Stacks tag 0D55}}
\group{quot}
...
\begin{proof}
\uses{quot-lemma-spaces-limits}

Using the embedding (\ref{equation-curves-over-proper-spaces}),
the description of the image, and
the corresponding fact for $\Spacesstack'_{fp, flat, proper}$
(Lemma \ref{quot-lemma-spaces-limits})
...
\begin{lemma}[Curves RS star]
\label{quot-lemma-curves-RS-star}
\source{stacks:0D56}
\href{https://stacks.math.columbia.edu/tag/0D56}{\texttt{Stacks tag 0D56}}
\group{quot}
...
the description of the image, and
the corresponding fact for $\Spacesstack'_{fp, flat, proper}$
(Lemma \ref{quot-lemma-spaces-RS-star})
this reduces to the following statement:
...
\begin{lemma}[Curves tangent space]
\label{quot-lemma-curves-tangent-space}
\source{stacks:0D57}
\href{https://stacks.math.columbia.edu/tag/0D57}{\texttt{Stacks tag 0D57}}
\group{quot}
...
\begin{proof}
\uses{quot-lemma-spaces-tangent-space}
...
\begin{lemma}[Curves existence]
\label{quot-lemma-curves-existence}
\source{stacks:0D58}
\href{https://stacks.math.columbia.edu/tag/0D58}{\texttt{Stacks tag 0D58}}
\group{quot}
...
\begin{lemma}[Curves defo thy]
\label{quot-lemma-curves-defo-thy}
\source{stacks:0D59}
\href{https://stacks.math.columbia.edu/tag/0D59}{\texttt{Stacks tag 0D59}}
\group{quot}

\uses{quot-remark-curves-base-change}
The stack in groupoids $\mathcal{X} = \Curvesstack$
satisfies openness of versality over $\Spec(\mathbf{Z})$.
Similarly, after base change (Remark \ref{quot-remark-curves-base-change})
openness of versality holds over any Noetherian base scheme $S$.
\end{lemma}

\begin{proof}
\uses{quot-lemma-spaces-defo-thy}

This is immediate from the fully faithful embedding
(\ref{equation-curves-over-proper-spaces}) and
the corresponding fact for $\Spacesstack'_{fp, flat, proper}$
(Lemma \ref{quot-lemma-spaces-defo-thy}).
\end{proof}
...
\source{stacks:0D5A}
\href{https://stacks.math.columbia.edu/tag/0D5A}{\texttt{Stacks tag 0D5A}}
\group{quot}

\uses{quot-situation-curves, quot-remark-curves-base-change}
\begin{reference}
See \cite[Proposition 3.3, page 8]{dJHS} and
\cite[Appendix B by Jack Hall, Theorem B.1]{Smyth}.
\end{reference}
The stack $\Curvesstack$ (Situation \ref{quot-situation-curves})
is algebraic. In fact, for any algebraic space $B$ the stack
$B\text{-}\Curvesstack$ (Remark \ref{quot-remark-curves-base-change})
is algebraic.
\end{theorem}

\begin{proof}
\uses{quot-lemma-curves-diagonal, quot-lemma-curves-RS-star, quot-lemma-curves-limits, quot-lemma-curves-existence, quot-lemma-curves-defo-thy, quot-remark-curves-base-change}

The absolute case follows from
Artin's Axioms, Lemma \ref{artin-lemma-diagonal-representable}
and Lemmas \ref{quot-lemma-curves-diagonal},
\ref{quot-lemma-curves-RS-star},
\ref{quot-lemma-curves-limits},
\ref{quot-lemma-curves-existence}, and
\ref{quot-lemma-curves-defo-thy}.
The case over $B$ follows from this, the description of
$B\text{-}\Curvesstack$ as a $2$-fibre product in
Remark \ref{quot-remark-curves-base-change}, and the fact
that algebraic stacks have $2$-fibre products, see
Algebraic Stacks, Lemma \ref{algebraic-lemma-2-fibre-product}.
\end{proof}

\begin{lemma}[Curves open and closed in spaces]
\label{quot-lemma-curves-open-and-closed-in-spaces}
\source{stacks:0D5B}
\href{https://stacks.math.columbia.edu/tag/0D5B}{\texttt{Stacks tag 0D5B}}
\group{quot}
...
\begin{remark}[Alternative approach curves]
\label{quot-remark-alternative-approach-curves}
\source{stacks:0D5C}
\href{https://stacks.math.columbia.edu/tag/0D5C}{\texttt{Stacks tag 0D5C}}
\group{quot}

\uses{quot-lemma-polarized-to-spaces-algebraic, quot-lemma-curves-existence, quot-lemma-curves-open-and-closed-in-spaces}
Consider the $2$-fibre product
$$
\begin{array}{cc}\Curvesstack \times_{\Spacesstack'_{fp, flat, proper}}
\Polarizedstack \longrightarrow\downarrow & \Polarizedstack \downarrow \\ \Curvesstack \longrightarrow & \Spacesstack'_{fp, flat, proper}\end{array}
$$
...
Lemma \ref{quot-lemma-polarized-to-spaces-algebraic}),
every point is in the image, and
there are no obstructions to deforming invertible sheaves on curves
(see proof of Lemma \ref{quot-lemma-curves-existence}).
This gives another approach to the algebraicity of $\Curvesstack$.
Namely, by Lemma \ref{quot-lemma-curves-open-and-closed-in-spaces}
...
\begin{lemma}[Complexes open neg exts vanishing]
\label{quot-lemma-complexes-open-neg-exts-vanishing}
\source{stacks:0DLC}
\href{https://stacks.math.columbia.edu/tag/0DLC}{\texttt{Stacks tag 0DLC}}
\group{quot}
...
$$
\begin{array}{cc}F \downarrow\longrightarrow & Y \overset{0}{\downarrow} \\ \mathbf{A}_Y^{m_0} \longrightarrow & \mathbf{A}_Y^{m_1}\end{array}
$$
which proves what we want.
\end{proof}

\begin{lemma}[Complexes]
\label{quot-lemma-complexes}
\source{stacks:0DLD}
\href{https://stacks.math.columbia.edu/tag/0DLD}{\texttt{Stacks tag 0DLD}}
\group{quot}
...
\begin{proof}
\uses{quot-lemma-complexes-open-neg-exts-vanishing}

Immediate consequence of Lemma \ref{quot-lemma-complexes-open-neg-exts-vanishing}.
\end{proof}

\begin{definition}[Situation: Complexes]
\label{quot-situation-complexes}
\source{stacks:0DLE}
\href{https://stacks.math.columbia.edu/tag/0DLE}{\texttt{Stacks tag 0DLE}}
\group{quot}

\uses{quot-lemma-complexes}
Let $S$ be a scheme. Let $f : X \to B$ be a morphism of algebraic spaces
...
conditions (1) and (2) of Lemma \ref{quot-lemma-complexes}.
\end{enumerate}
...
\begin{lemma}[Complexes fibred in groupoids]
\label{quot-lemma-complexes-fibred-in-groupoids}
\source{stacks:0DLF}
\href{https://stacks.math.columbia.edu/tag/0DLF}{\texttt{Stacks tag 0DLF}}
\group{quot}

\uses{quot-situation-complexes}
In Situation \ref{quot-situation-complexes} the functor
$p : \Complexesstack_{X/B} \longrightarrow (\Sch/S)_{fppf}$
is fibred in groupoids.
\end{lemma}
...
\begin{lemma}[Complexes diagonal]
\label{quot-lemma-complexes-diagonal}
\source{stacks:0DLG}
\href{https://stacks.math.columbia.edu/tag/0DLG}{\texttt{Stacks tag 0DLG}}
\group{quot}

\uses{quot-situation-complexes}
In Situation \ref{quot-situation-complexes}. Denote
...
\begin{proof}
\uses{quot-lemma-complexes, quot-lemma-complexes-open-neg-exts-vanishing, quot-proposition-isom}
...
satisfying conditions (1), (2) of Lemma \ref{quot-lemma-complexes}
...
Lemma \ref{quot-lemma-complexes-open-neg-exts-vanishing}.
...
Proposition \ref{quot-proposition-isom} to see that
$$
...
\begin{lemma}[Complexes stack]
\label{quot-lemma-complexes-stack}
\source{stacks:0DLH}
\href{https://stacks.math.columbia.edu/tag/0DLH}{\texttt{Stacks tag 0DLH}}
\group{quot}
...
\begin{proof}
\uses{quot-lemma-complexes-diagonal, quot-lemma-complexes, quot-lemma-complexes-open-neg-exts-vanishing}
...
$\mathit{Isom}$ follows from Lemma \ref{quot-lemma-complexes-diagonal}, see
Algebraic Stacks, Lemma \ref{algebraic-lemma-representable-diagonal}.
Let us prove the statement on descent data.
...
Lemma \ref{quot-lemma-complexes}, we may apply
...
Lemma \ref{quot-lemma-complexes} for $E$.
This immediately follows from the description of the open $W$
in Lemma \ref{quot-lemma-complexes-open-neg-exts-vanishing}
and the fact that (2) holds for $E_i$ on $X_{T_i}/T_i$.
\end{proof}

\begin{remark}[Complexes base change]
\label{quot-remark-complexes-base-change}
\source{stacks:0DLI}
\href{https://stacks.math.columbia.edu/tag/0DLI}{\texttt{Stacks tag 0DLI}}
\group{quot}

\uses{quot-situation-complexes, quot-lemma-complexes-stack}
In Situation \ref{quot-situation-complexes} the rule
$(T, g, E) \mapsto (T, g)$ defines a $1$-morphism
$$
\Complexesstack_{X/B} \longrightarrow \mathcal{S}_B
$$
of stacks in groupoids
(see Lemma \ref{quot-lemma-complexes-stack},
Algebraic Stacks, Section \ref{algebraic-section-split}, and
Examples of Stacks, Section
\ref{examples-stacks-section-stack-associated-to-sheaf}).
Let $B' \to B$ be a morphism of
...
$$
\vcenter{
\begin{array}{cc}\Complexesstack_{X'/B'} \longrightarrow\downarrow & \Complexesstack_{X/B} \downarrow \\ \mathcal{S}_{B'} \longrightarrow & \mathcal{S}_B\end{array}
}
\quad
\begin{matrix}
\text{or in} \\
...
\quad
\vcenter{
\begin{array}{cc}\Complexesstack_{X'/B'} \longrightarrow\downarrow & \Complexesstack_{X/B} \downarrow \\ \Sch/B' \longrightarrow & \Sch/B\end{array}
}
$$
is $2$-fibre product square. This trivial remark
will occasionally be useful to change the base algebraic space.
...
\begin{lemma}[Complexes limits]
\label{quot-lemma-complexes-limits}
\source{stacks:0DLJ}
\href{https://stacks.math.columbia.edu/tag/0DLJ}{\texttt{Stacks tag 0DLJ}}
\group{quot}

\uses{quot-situation-complexes}
In Situation \ref{quot-situation-complexes} assume that $B \to S$
is locally of finite presentation. Then
...
\begin{proof}
\uses{quot-lemma-complexes, quot-lemma-complexes-open-neg-exts-vanishing}
...
of $B(T)$ gives us a commutative diagram of fibre categories
$$
\begin{array}{cc}\colim \Complexesstack_{X/B, T_i} \longrightarrow\downarrow & \Complexesstack_{X/B, T} \downarrow \\ \colim B(T_i) \longrightarrow & B(T)\end{array}
$$
We have to show the top horizontal arrow is an equivalence. Since
...
condition (2) of Lemma \ref{quot-lemma-complexes},
...
\begin{lemma}[Complexes RS star]
\label{quot-lemma-complexes-RS-star}
\source{stacks:0DLK}
\href{https://stacks.math.columbia.edu/tag/0DLK}{\texttt{Stacks tag 0DLK}}
\group{quot}

\uses{quot-situation-complexes}
In Situation \ref{quot-situation-complexes}. Let
$$
\begin{array}{cc}Z \longrightarrow\downarrow & Z' \downarrow \\ Y \longrightarrow & Y'\end{array}
$$
be a pushout in the category of schemes over $S$ where
...
\begin{proof}
\uses{quot-remark-complexes-base-change, quot-lemma-complexes}
...
Thus using the commutative diagram
$$
\begin{array}{cc}\Complexesstack_{X/B, Y'} \longrightarrow\downarrow & \Complexesstack_{X/B, Y}
\times_{\Complexesstack_{X/B, Z}}
\Complexesstack_{X/B, Z'}
\downarrow \\ B(Y') \longrightarrow & B(Y) \times_{B(Z)} B(Z')\end{array}
$$
we see that we may assume that $Y'$ is a scheme over $B'$. By
Remark \ref{quot-remark-complexes-base-change}
we may replace $B$ by $Y'$ and $X$ by $X \times_B Y'$.
...
$$
\begin{array}{cc}X_Z \longrightarrow\downarrow & X_{Z'} \downarrow \\ X_Y \longrightarrow & X_{Y'}\end{array}
$$
...
of Lemma \ref{quot-lemma-complexes}
...
\begin{lemma}[Complexes tangent space]
\label{quot-lemma-complexes-tangent-space}
\source{stacks:0DLL}
\href{https://stacks.math.columbia.edu/tag/0DLL}{\texttt{Stacks tag 0DLL}}
\group{quot}

\uses{quot-situation-complexes}
In Situation \ref{quot-situation-complexes} assume that $S$ is a locally Noetherian
scheme and $B \to S$ is locally of finite presentation.
Let $k$ be a finite type field over $S$ and let
$x_0 = (\Spec(k), g_0, E_0)$
...
\begin{proof}
\uses{quot-lemma-complexes-RS-star, quot-remark-complexes-base-change}

Observe that by Lemma \ref{quot-lemma-complexes-RS-star}
our stack in groupoids $\mathcal{X}$ satisfies property (RS*)
...
Remark \ref{quot-remark-complexes-base-change} we have seen that
$\mathcal{X}_0$ is the $2$-fibre product of $\mathcal{X}$ with
$\Spec(k)$ over $B$ as categories fibred in groupoids over
$(\Sch/S)_{fppf}$. Thus by
Artin's Axioms, Lemma \ref{artin-lemma-fibre-product-tangent-spaces}
...
\begin{lemma}[Complexes strong effectiveness]
\label{quot-lemma-complexes-strong-effectiveness}
\source{stacks:0DLM}
\href{https://stacks.math.columbia.edu/tag/0DLM}{\texttt{Stacks tag 0DLM}}
\group{quot}

\uses{quot-situation-complexes}
In Situation \ref{quot-situation-complexes} assume $B = S$ is locally Noetherian.
...
Lemma \ref{quot-lemma-complexes}. In particular $E_n$ is pseudo-coherent.
...
\medskip\noindent
Finally, we have to check condition (2) of Lemma \ref{quot-lemma-complexes}.
By Lemma \ref{quot-lemma-complexes-open-neg-exts-vanishing}
...
\source{stacks:0DLN}
\href{https://stacks.math.columbia.edu/tag/0DLN}{\texttt{Stacks tag 0DLN}}
\group{quot}
...
\begin{proof}
\uses{quot-lemma-complexes-stack, quot-lemma-complexes-diagonal, quot-remark-complexes-base-change, quot-lemma-complexes-limits, quot-lemma-complexes-RS-star, quot-lemma-complexes-tangent-space, quot-lemma-complexes-strong-effectiveness}

Set $\mathcal{X} = \Complexesstack_{X/B}$. We have seen that $\mathcal{X}$
is a stack in groupoids over $(\Sch/S)_{fppf}$ with diagonal representable
by algebraic spaces
(Lemmas \ref{quot-lemma-complexes-stack} and \ref{quot-lemma-complexes-diagonal}).
Hence it suffices to find a scheme $W$ and a surjective and smooth
morphism $W \to \mathcal{X}$.
...
product of $\mathcal{X}$ with the category fibred in sets
associated to $B'$ over the category fibred in sets associated to $B$
(Remark \ref{quot-remark-complexes-base-change}). By the material in
Algebraic Stacks, Section \ref{algebraic-section-representable-properties}
the morphism $\mathcal{X}' \to \mathcal{X}$ is surjective and \'etale.
Hence it suffices to prove the result for $\mathcal{X}'$.
In other words, we may assume $B$ is a scheme.
...
algebraic stack, then it follows by base change
(Remark \ref{quot-remark-complexes-base-change} and
Algebraic Stacks, Section \ref{algebraic-section-change-base-scheme})
that $\mathcal{X}$ is an algebraic stack.
Thus we may assume that $\Lambda$ is a finite type $\mathbf{Z}$-algebra.
...
Condition (3) follows from Lemma \ref{quot-lemma-complexes-strong-effectiveness}.
Condition (1) is Lemma \ref{quot-lemma-complexes-diagonal}.
...
formal effectiveness formulated in
Artin's Axioms, Lemma \ref{artin-lemma-SGE-implies-openness-versality}.
This follows from Lemma \ref{quot-lemma-complexes-strong-effectiveness}
and the proof is complete.
\end{proof}
