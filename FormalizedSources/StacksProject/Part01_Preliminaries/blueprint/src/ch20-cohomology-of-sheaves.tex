...
Section \ref{cohomology-section-unbounded}.
...
\source{stacks:02FO}
\href{https://stacks.math.columbia.edu/tag/02FO}{\texttt{Stacks tag 02FO}}
\group{cohomology}
...
\begin{lemma}[Trivial torsor]
\label{cohomology-lemma-trivial-torsor}
\source{stacks:02FP}
\href{https://stacks.math.columbia.edu/tag/02FP}{\texttt{Stacks tag 02FP}}
\group{cohomology}
...
\begin{lemma}[Torsors h1]
\label{cohomology-lemma-torsors-h1}
\source{stacks:02FQ}
\href{https://stacks.math.columbia.edu/tag/02FQ}{\texttt{Stacks tag 02FQ}}
\group{cohomology}
...
$$
\begin{array}{ccccc}0 \longrightarrow & \Ker(\sigma) \longrightarrow\overset{a}{\downarrow} & \mathbf{Z}[\mathcal{F}] \longrightarrow\downarrow & \underline{\mathbf{Z}} \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & \mathcal{H} \longrightarrow & \mathcal{E} \longrightarrow & \underline{\mathbf{Z}} \longrightarrow & 0\end{array}
$$
...
sequence
$$
\begin{array}{ccccc}0 \longrightarrow & \mathcal{H} \longrightarrow & \mathcal{I} \longrightarrow & \mathcal{Q} \longrightarrow & 0\end{array}
$$
...
\begin{lemma}[H1 extensions]
\label{cohomology-lemma-h1-extensions}
\source{stacks:0B3A}
\href{https://stacks.math.columbia.edu/tag/0B3A}{\texttt{Stacks tag 0B3A}}
\group{cohomology}
...
$$
\begin{array}{ccccc}0 \longrightarrow & \mathcal{F} \longrightarrow\downarrow & \mathcal{E} \longrightarrow\downarrow & \mathcal{O}_X \longrightarrow\overset{\tilde \xi}{\downarrow} & 0 \\ 0 \longrightarrow & \mathcal{F} \longrightarrow & \mathcal{I} \longrightarrow & \mathcal{Q} \longrightarrow & 0\end{array}
$$
...
\begin{lemma}[H1 invertible]
\label{cohomology-lemma-h1-invertible}
\source{stacks:09NU}
\href{https://stacks.math.columbia.edu/tag/09NU}{\texttt{Stacks tag 09NU}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-torsors-h1, cohomology-lemma-trivial-torsor}
...
By
Lemma \ref{cohomology-lemma-torsors-h1}
...
Lemma \ref{cohomology-lemma-trivial-torsor}
...
\begin{lemma}[Cohomology of open]
\label{cohomology-lemma-cohomology-of-open}
\source{stacks:01E1}
\href{https://stacks.math.columbia.edu/tag/01E1}{\texttt{Stacks tag 01E1}}
\group{cohomology}
...
of this presheaf in Lemma \ref{cohomology-lemma-include}.

\begin{lemma}[Kill cohomology class on covering]
\label{cohomology-lemma-kill-cohomology-class-on-covering}
\source{stacks:01E3}
\href{https://stacks.math.columbia.edu/tag/01E3}{\texttt{Stacks tag 01E3}}
\group{cohomology}
...
\begin{lemma}[Describe higher direct images]
\label{cohomology-lemma-describe-higher-direct-images}
\source{stacks:01E4}
\href{https://stacks.math.columbia.edu/tag/01E4}{\texttt{Stacks tag 01E4}}
\group{cohomology}
...
\begin{lemma}[Localize higher direct images]
\label{cohomology-lemma-localize-higher-direct-images}
\source{stacks:01E5}
\href{https://stacks.math.columbia.edu/tag/01E5}{\texttt{Stacks tag 01E5}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-describe-higher-direct-images, cohomology-lemma-cohomology-of-open}

First proof. Apply Lemmas \ref{cohomology-lemma-describe-higher-direct-images}
and \ref{cohomology-lemma-cohomology-of-open} to see the displayed equality.
...
\source{stacks:03BA}
\href{https://stacks.math.columbia.edu/tag/03BA}{\texttt{Stacks tag 03BA}}
\group{cohomology}

\uses{cohomology-lemma-kill-cohomology-class-on-covering, cohomology-lemma-describe-higher-direct-images, cohomology-lemma-include}
Here is a different approach to the proofs of
Lemmas \ref{cohomology-lemma-kill-cohomology-class-on-covering} and
\ref{cohomology-lemma-describe-higher-direct-images} above.
...
\begin{enumerate}
\item First prove Lemma \ref{cohomology-lemma-include} below which says that the
...
\item A restatement of Lemma \ref{cohomology-lemma-kill-cohomology-class-on-covering}
...
Hence Lemma \ref{cohomology-lemma-describe-higher-direct-images}
...
Lemma \ref{cohomology-lemma-cech-spectral-sequence}.
...
\source{stacks:01EA}
\href{https://stacks.math.columbia.edu/tag/01EA}{\texttt{Stacks tag 01EA}}
\group{cohomology}
...
\source{stacks:01EB}
\href{https://stacks.math.columbia.edu/tag/01EB}{\texttt{Stacks tag 01EB}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-injective-restriction-surjective}
...
Lemma \ref{cohomology-lemma-injective-restriction-surjective} above implies that the map
...
\source{stacks:01EC}
\href{https://stacks.math.columbia.edu/tag/01EC}{\texttt{Stacks tag 01EC}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-mayer-vietoris, cohomology-lemma-cohomology-of-open}
...
0
$$
was shown to be short exact in the proof of Lemma \ref{cohomology-lemma-mayer-vietoris}.
...
see Lemma \ref{cohomology-lemma-cohomology-of-open}.
\end{proof}

\section{The {\v C}
ech complex and {\v C}ech cohomology}
...
in Section \ref{cohomology-section-alternating-cech}). We define
$$
...
\source{stacks:01EF}
\href{https://stacks.math.columbia.edu/tag/01EF}{\texttt{Stacks tag 01EF}}
\group{cohomology}
...
\source{stacks:01EG}
\href{https://stacks.math.columbia.edu/tag/01EG}{\texttt{Stacks tag 01EG}}
\group{cohomology}
...
\begin{lemma}[Cech trivial]
\label{cohomology-lemma-cech-trivial}
\source{stacks:0G6S}
\href{https://stacks.math.columbia.edu/tag/0G6S}{\texttt{Stacks tag 0G6S}}
\group{cohomology}
...
\section{{\v C}
ech cohomology as a functor on presheaves}
...
\begin{lemma}[Cech exact presheaves]
\label{cohomology-lemma-cech-exact-presheaves}
\source{stacks:01EJ}
\href{https://stacks.math.columbia.edu/tag/01EJ}{\texttt{Stacks tag 01EJ}}
\group{cohomology}
...
\begin{lemma}[Cech cohomology delta functor presheaves]
\label{cohomology-lemma-cech-cohomology-delta-functor-presheaves}
\source{stacks:01EK}
\href{https://stacks.math.columbia.edu/tag/01EK}{\texttt{Stacks tag 01EK}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-cech-exact-presheaves}

By
Lemma \ref{cohomology-lemma-cech-exact-presheaves}
...
\begin{lemma}[Cech map into]
\label{cohomology-lemma-cech-map-into}
\source{stacks:01EL}
\href{https://stacks.math.columbia.edu/tag/01EL}{\texttt{Stacks tag 01EL}}
\group{cohomology}
...
\begin{lemma}[Homology complex]
\label{cohomology-lemma-homology-complex}
\source{stacks:01EM}
\href{https://stacks.math.columbia.edu/tag/01EM}{\texttt{Stacks tag 01EM}}
\group{cohomology}

\uses{cohomology-lemma-cech-map-into}
Let $X$ be a ringed space.
Let $\mathcal{U} : U = \bigcup_{i \in I} U_i$ be an open covering.
...
of Lemma \ref{cohomology-lemma-cech-map-into} above has homology presheaves
$$
...
\begin{lemma}[Cech cohomology derived presheaves]
\label{cohomology-lemma-cech-cohomology-derived-presheaves}
\source{stacks:01EN}
\href{https://stacks.math.columbia.edu/tag/01EN}{\texttt{Stacks tag 01EN}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-cech-map-into, cohomology-lemma-homology-complex, cohomology-lemma-cech-cohomology-delta-functor-presheaves, cohomology-lemma-cech-exact-presheaves}
...
\medskip\noindent
Let $\mathcal{I}$ be an injective presheaf of $\mathcal{O}_X$-modules.
In this case the functor $\Hom_{\mathcal{O}_X}(-, \mathcal{I})$
is exact on $\textit{PMod}(\mathcal{O}_X)$. By
Lemma \ref{cohomology-lemma-cech-map-into} we have
$$
\Hom_{\mathcal{O}_X}(K(\mathcal{U})_\bullet, \mathcal{I})
=
\check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{I}).
$$
By Lemma \ref{cohomology-lemma-homology-complex} we have that $K(\mathcal{U})_\bullet$ is
...
(see Lemma \ref{cohomology-lemma-cech-cohomology-delta-functor-presheaves})
...
\section{{\v C}
ech cohomology and cohomology}
\label{cohomology-section-cech-cohomology-cohomology}

\begin{lemma}[Injective trivial cech]
\label{cohomology-lemma-injective-trivial-cech}
\source{stacks:01EP}
\href{https://stacks.math.columbia.edu/tag/01EP}{\texttt{Stacks tag 01EP}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-cech-cohomology-derived-presheaves}
...
Hence we can apply Lemma \ref{cohomology-lemma-cech-cohomology-derived-presheaves}
(or its proof) to see the result.
\end{proof}

\begin{lemma}[Cech cohomology]
\label{cohomology-lemma-cech-cohomology}
\source{stacks:01EQ}
\href{https://stacks.math.columbia.edu/tag/01EQ}{\texttt{Stacks tag 01EQ}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-injective-trivial-cech}
...
Namely, Lemma \ref{cohomology-lemma-injective-trivial-cech} implies that
...
\source{stacks:0B8R}
\href{https://stacks.math.columbia.edu/tag/0B8R}{\texttt{Stacks tag 0B8R}}
\group{cohomology}

\uses{cohomology-lemma-torsors-h1}
...
\source{stacks:01ER}
\href{https://stacks.math.columbia.edu/tag/01ER}{\texttt{Stacks tag 01ER}}
\group{cohomology}
...
$$
see discussion in Section \ref{cohomology-section-locality}.
\end{lemma}
...
\begin{lemma}[Cech spectral sequence]
\label{cohomology-lemma-cech-spectral-sequence}
\source{stacks:01ES}
\href{https://stacks.math.columbia.edu/tag/01ES}{\texttt{Stacks tag 01ES}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-cech-h0, cohomology-lemma-injective-trivial-cech, cohomology-lemma-cech-cohomology-derived-presheaves}
...
by Lemma \ref{cohomology-lemma-cech-h0}. We have that $i(\mathcal{I})$ is
{\v C}ech acyclic by Lemma \ref{cohomology-lemma-injective-trivial-cech}. And we
have that $\check{H}^p(\mathcal{U}, -) = R^p\check{H}^0(\mathcal{U}, -)$
as functors on $\textit{PMod}(\mathcal{O}_X)$
by Lemma \ref{cohomology-lemma-cech-cohomology-derived-presheaves}.
Putting everything together gives the lemma.
\end{proof}

\begin{lemma}[Cech spectral sequence application]
\label{cohomology-lemma-cech-spectral-sequence-application}
\source{stacks:01ET}
\href{https://stacks.math.columbia.edu/tag/01ET}{\texttt{Stacks tag 01ET}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-cech-spectral-sequence}
...
\begin{lemma}[Ses cech h1]
\label{cohomology-lemma-ses-cech-h1}
\source{stacks:01EU}
\href{https://stacks.math.columbia.edu/tag/01EU}{\texttt{Stacks tag 01EU}}
\group{cohomology}
...
\begin{lemma}[If higher \v Cech cohomology of an abelian sheaf vanishes for all open covers, then hig...]
\label{cohomology-lemma-cech-vanish}
\source{stacks:01EV}
\href{https://stacks.math.columbia.edu/tag/01EV}{\texttt{Stacks tag 01EV}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-injective-trivial-cech, cohomology-lemma-ses-cech-h1, cohomology-lemma-cech-cohomology-delta-functor-presheaves}
...
By Lemma \ref{cohomology-lemma-injective-trivial-cech} $\mathcal{I}$ has vanishing higher
{\v C}ech cohomology for any open covering.
...
$$
By Lemma \ref{cohomology-lemma-ses-cech-h1} and our assumptions
...
Lemma \ref{cohomology-lemma-cech-cohomology-delta-functor-presheaves}
...
$$
\begin{array}{cccc}0 \longrightarrow & H^0(U, \mathcal{F}) \longrightarrow & H^0(U, \mathcal{I}) \longrightarrow & H^0(U, \mathcal{Q}) \swarrow \\  & H^1(U, \mathcal{F}) \longrightarrow & H^1(U, \mathcal{I}) \longrightarrow & H^1(U, \mathcal{Q}) \swarrow \\  & \ldots & \ldots & \ldots \\  &  &  & \end{array}
$$
...
\begin{lemma}[Cech vanish basis]
\label{cohomology-lemma-cech-vanish-basis}
\source{stacks:01EW}
\href{https://stacks.math.columbia.edu/tag/01EW}{\texttt{Stacks tag 01EW}}
\group{cohomology}

\uses{cohomology-lemma-cech-vanish}
(Variant of Lemma \ref{cohomology-lemma-cech-vanish}.)
Let $X$ be a ringed space.
...
\begin{proof}
\uses{cohomology-lemma-injective-trivial-cech, cohomology-lemma-ses-cech-h1}
...
Choose an embedding $\mathcal{F} \to \mathcal{I}$ into an
injective $\mathcal{O}_X$-module.
By Lemma \ref{cohomology-lemma-injective-trivial-cech} $\mathcal{I}$
...
0 \to \mathcal{F} \to \mathcal{I} \to \mathcal{Q} \to 0.
$$
By Lemma \ref{cohomology-lemma-ses-cech-h1} and our assumption (2)
...
\begin{lemma}[Pushforward injective]
\label{cohomology-lemma-pushforward-injective}
\source{stacks:01EX}
\href{https://stacks.math.columbia.edu/tag/01EX}{\texttt{Stacks tag 01EX}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-injective-trivial-cech, cohomology-lemma-cech-vanish}
...
Lemma \ref{cohomology-lemma-injective-trivial-cech}. The second statement
follows from the first and Lemma \ref{cohomology-lemma-cech-vanish}.
\end{proof}
...
\begin{lemma}[Pushforward injective flat]
\label{cohomology-lemma-pushforward-injective-flat}
\source{stacks:02N5}
\href{https://stacks.math.columbia.edu/tag/02N5}{\texttt{Stacks tag 02N5}}
\group{cohomology}
...
\begin{lemma}[Cohomology products]
\label{cohomology-lemma-cohomology-products}
\source{stacks:0D0A}
\href{https://stacks.math.columbia.edu/tag/0D0A}{\texttt{Stacks tag 0D0A}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-kill-cohomology-class-on-covering, cohomology-lemma-cech-h1}
...
Lemma \ref{cohomology-lemma-kill-cohomology-class-on-covering},
there exists an open covering $\mathcal{U} : U = \bigcup U_j$ such that
$\xi|_{U_j} = 0$ for all $j$. By Lemma \ref{cohomology-lemma-cech-h1} this means
$\xi$ comes from an element
$\check \xi \in \check H^1(\mathcal{U}, \mathcal{F})$.
Since the maps
$\check H^1(\mathcal{U}, \mathcal{F}_i) \to H^1(U, \mathcal{F}_i)$
are injective for all $i$ (by Lemma \ref{cohomology-lemma-cech-h1}), and since
...
\source{stacks:09SW}
\href{https://stacks.math.columbia.edu/tag/09SW}{\texttt{Stacks tag 09SW}}
\group{cohomology}
...
\begin{lemma}[Injective flasque]
\label{cohomology-lemma-injective-flasque}
\source{stacks:09SX}
\href{https://stacks.math.columbia.edu/tag/09SX}{\texttt{Stacks tag 09SX}}
\group{cohomology}
...
This is a reformulation of Lemma \ref{cohomology-lemma-injective-restriction-surjective}.
\end{proof}

\begin{lemma}[Flasque acyclic]
\label{cohomology-lemma-flasque-acyclic}
\source{stacks:09SY}
\href{https://stacks.math.columbia.edu/tag/09SY}{\texttt{Stacks tag 09SY}}
\group{cohomology}
...
\begin{lemma}[Flasque acyclic cech]
\label{cohomology-lemma-flasque-acyclic-cech}
\source{stacks:09SZ}
\href{https://stacks.math.columbia.edu/tag/09SZ}{\texttt{Stacks tag 09SZ}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-cech-spectral-sequence, cohomology-lemma-flasque-acyclic}

The presheaves $\underline{H}^q(\mathcal{F})$ used in the statement
of Lemma \ref{cohomology-lemma-cech-spectral-sequence} are zero by
Lemma \ref{cohomology-lemma-flasque-acyclic}.
Hence $\check{H}^p(U, \mathcal{F}) = H^p(U, \mathcal{F}) = 0$
by Lemma \ref{cohomology-lemma-flasque-acyclic} again.
\end{proof}

\begin{lemma}[Flasque acyclic pushforward]
\label{cohomology-lemma-flasque-acyclic-pushforward}
\source{stacks:09T0}
\href{https://stacks.math.columbia.edu/tag/09T0}{\texttt{Stacks tag 09T0}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-describe-higher-direct-images, cohomology-lemma-flasque-acyclic}

Immediate from
Lemma \ref{cohomology-lemma-describe-higher-direct-images} and
Lemma \ref{cohomology-lemma-flasque-acyclic}.
\end{proof}
...
\begin{lemma}[Vanishing ravi]
\label{cohomology-lemma-vanishing-ravi}
\source{stacks:0A36}
\href{https://stacks.math.columbia.edu/tag/0A36}{\texttt{Stacks tag 0A36}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-flasque-acyclic-cech}
...
Lemma \ref{cohomology-lemma-flasque-acyclic-cech}.
\end{proof}

\section{The Leray spectral sequence}
\label{cohomology-section-Leray}
\begin{lemma}[Before Leray]
\label{cohomology-lemma-before-Leray}
\source{stacks:01EZ}
\href{https://stacks.math.columbia.edu/tag/01EZ}{\texttt{Stacks tag 01EZ}}
\group{cohomology}

\uses{cohomology-remark-elucidate-lemma}
Let $f : X \to Y$ be a morphism of ringed spaces.
There is a commutative diagram
$$
\begin{array}{ccc}D^{+}(X) \underset{R\Gamma(X, -)}{\longrightarrow}\underset{Rf_*}{\downarrow} &  & D^{+}(\mathcal{O}_X(X)) \overset{\text{restriction}}{\downarrow} \\ D^{+}(Y) \overset{R\Gamma(Y, -)}{\longrightarrow} &  & D^{+}(\mathcal{O}_Y(Y))\end{array}
$$
More generally for any $V \subset Y$ open and $U = f^{-1}(V)$ there
is a commutative diagram
$$
\begin{array}{ccc}D^{+}(X) \underset{R\Gamma(U, -)}{\longrightarrow}\underset{Rf_*}{\downarrow} &  & D^{+}(\mathcal{O}_X(U)) \overset{\text{restriction}}{\downarrow} \\ D^{+}(Y) \overset{R\Gamma(V, -)}{\longrightarrow} &  & D^{+}(\mathcal{O}_Y(V))\end{array}
$$
See also Remark \ref{cohomology-remark-elucidate-lemma} for more explanation.
\end{lemma}

\begin{proof}
\uses{cohomology-lemma-pushforward-injective}
...
Lemma \ref{cohomology-lemma-pushforward-injective} which implies that
injective $\mathcal{O}_X$-modules are mapped to $\Gamma(Y, -)$-acyclic
sheaves on $Y$.
\end{proof}

\begin{remark}[Elucidate lemma]
\label{cohomology-remark-elucidate-lemma}
\source{stacks:01F0}
\href{https://stacks.math.columbia.edu/tag/01F0}{\texttt{Stacks tag 01F0}}
\group{cohomology}

\uses{cohomology-lemma-before-Leray, cohomology-lemma-pushforward-injective}
Here is a down-to-earth explanation of the meaning of
Lemma \ref{cohomology-lemma-before-Leray}. It says that given
...
and Lemma \ref{cohomology-lemma-pushforward-injective}.
...
\source{stacks:01F1}
\href{https://stacks.math.columbia.edu/tag/01F1}{\texttt{Stacks tag 01F1}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-remark-elucidate-lemma, cohomology-lemma-describe-higher-direct-images}
...
By Remark \ref{cohomology-remark-elucidate-lemma} we see that
$\Gamma(X, \mathcal{I}^\bullet)$ computes both
$R\Gamma(X, \mathcal{F})$ and $R\Gamma(X, \mathcal{F}_{ab})$.
This proves (1).

\medskip\noindent
To prove (2) we use (1) and Lemma \ref{cohomology-lemma-describe-higher-direct-images}.
...
\source{stacks:01F2}
\href{https://stacks.math.columbia.edu/tag/01F2}{\texttt{Stacks tag 01F2}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-before-Leray, cohomology-remark-elucidate-lemma}
...
in the proof of Lemma \ref{cohomology-lemma-before-Leray}.
To see that the assumptions of
Derived Categories, Lemma \ref{derived-lemma-grothendieck-spectral-sequence}
are satisfied, see the proof of Lemma \ref{cohomology-lemma-before-Leray} or
Remark \ref{cohomology-remark-elucidate-lemma}.
\end{proof}

\begin{remark}[Leray ss more structure]
\label{cohomology-remark-Leray-ss-more-structure}
\source{stacks:01F3}
\href{https://stacks.math.columbia.edu/tag/01F3}{\texttt{Stacks tag 01F3}}
\group{cohomology}

\uses{cohomology-lemma-Leray, cohomology-lemma-modules-abelian}
The Leray spectral sequence, the way we proved it in Lemma \ref{cohomology-lemma-Leray}
...
By Lemma \ref{cohomology-lemma-modules-abelian} the terms $E_r^{p, q}$ of the
...
\begin{lemma}[Apply Leray]
\label{cohomology-lemma-apply-Leray}
\source{stacks:01F4}
\href{https://stacks.math.columbia.edu/tag/01F4}{\texttt{Stacks tag 01F4}}
\group{cohomology}
...
\begin{lemma}[The total derived functor of a composition is the composition of the total derived func...]
\label{cohomology-lemma-higher-direct-images-compose}
\source{stacks:01F5}
\href{https://stacks.math.columbia.edu/tag/01F5}{\texttt{Stacks tag 01F5}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-pushforward-injective, cohomology-lemma-describe-higher-direct-images}
...
This follows from Lemma \ref{cohomology-lemma-pushforward-injective}
and the description of the
higher direct images $R^ig_*$ in
Lemma \ref{cohomology-lemma-describe-higher-direct-images}.
\end{proof}
...
\source{stacks:01F6}
\href{https://stacks.math.columbia.edu/tag/01F6}{\texttt{Stacks tag 01F6}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-higher-direct-images-compose}

This is a Grothendieck spectral sequence for composition of functors
and follows from Lemma \ref{cohomology-lemma-higher-direct-images-compose} and
Derived Categories, Lemma \ref{derived-lemma-grothendieck-spectral-sequence}.
\end{proof}
...
\source{stacks:01F8}
\href{https://stacks.math.columbia.edu/tag/01F8}{\texttt{Stacks tag 01F8}}
\group{cohomology}
...
Lemma \ref{cohomology-lemma-functoriality}, and we apply $R\Gamma(Y, -)$.
By Lemma \ref{cohomology-lemma-before-Leray} we see that
$R\Gamma(X, \mathcal{F}) = R\Gamma(Y, Rf_*\mathcal{F})$
and we get the displayed arrow. We spell this out completely in
Remark \ref{cohomology-remark-explain-arrow} below.
...
\begin{remark}[Explain arrow]
\label{cohomology-remark-explain-arrow}
\source{stacks:01FB}
\href{https://stacks.math.columbia.edu/tag/01FB}{\texttt{Stacks tag 01FB}}
\group{cohomology}

\uses{cohomology-lemma-before-Leray}
Let $f : X \to Y$ be a morphism of ringed spaces.
...
\begin{array}{ccc}\mathcal{G} \downarrow\longrightarrow & f_*\mathcal{F} \longrightarrow & f_*\mathcal{I}^\bullet \downarrow \\ \mathcal{J}^\bullet \overset{\beta}{\longrightarrow} &  & (\mathcal{J}')^\bullet\end{array}
\end{equation}
commutes. Applying global section functors we see
that we get a diagram
$$
\begin{array}{cccc} &  & \Gamma(Y, f_*\mathcal{I}^\bullet) \underset{qis}{\downarrow}\xlongequal{} & \Gamma(X, \mathcal{I}^\bullet) \\ \Gamma(Y, \mathcal{J}^\bullet) \overset{\beta}{\longrightarrow} &  & \Gamma(Y, (\mathcal{J}')^\bullet) & \end{array}
$$
...
Lemma \ref{cohomology-lemma-before-Leray} which becomes invertible after
...
\xrightarrow{\text{Lemma \ref{cohomology-lemma-cech-cohomology}}}
H^p(X, \mathcal{F})
$$
is the canonical map from the first group to cohomology of
Lemma \ref{cohomology-lemma-cech-cohomology}.
...
\begin{lemma}[Functoriality cech]
\label{cohomology-lemma-functoriality-cech}
\source{stacks:01FD}
\href{https://stacks.math.columbia.edu/tag/01FD}{\texttt{Stacks tag 01FD}}
\group{cohomology}

\uses{cohomology-lemma-cech-cohomology}
Let $f : X \to Y$ be a morphism of ringed spaces.
...
$$
\begin{array}{cc}\check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{F}) \longrightarrow & R\Gamma(X, \mathcal{F}) \\ \check{\mathcal{C}}^\bullet(\mathcal{V}, \mathcal{G}) \longrightarrow\overset{\gamma}{\uparrow} & R\Gamma(Y, \mathcal{G}) \uparrow\end{array}
$$
in $D^{+}(\mathcal{O}_X(X))$ with horizontal arrows given by
Lemma \ref{cohomology-lemma-cech-cohomology} and right vertical arrow by
(\ref{equation-functorial-derived}).
In particular we get commutative diagrams of cohomology groups
$$
\begin{array}{cc}\check{H}^p(\mathcal{U}, \mathcal{F}) \longrightarrow & H^p(X, \mathcal{F}) \\ \check{H}^p(\mathcal{V}, \mathcal{G}) \longrightarrow\overset{\gamma}{\uparrow} & H^p(Y, \mathcal{G}) \uparrow\end{array}
$$
where the right vertical arrow is (\ref{equation-functorial})
\end{lemma}

\begin{proof}
\uses{cohomology-lemma-cech-cohomology, cohomology-remark-explain-arrow}
...
the proof of Lemma \ref{cohomology-lemma-cech-cohomology} we introduce the double
...
$$
As in Remark \ref{cohomology-remark-explain-arrow} above we also choose an
...
$$
\begin{array}{ccccc}\check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{F})
\longrightarrow & \text{Tot}(A^{\bullet, \bullet}) &  &  & \Gamma(X, \mathcal{I}^\bullet) \overset{qis}{\longleftarrow}\swarrow \\ \check{\mathcal{C}}^\bullet(\mathcal{V}, \mathcal{G})
\longrightarrow\overset{\gamma}{\uparrow} & \text{Tot}(B^{\bullet, \bullet}) \overset{\beta}{\longrightarrow} & \text{Tot}((B')^{\bullet, \bullet}) & \text{Tot}((B'')^{\bullet, \bullet}) \longleftarrow\underset{s\gamma}{\nwarrow} &  \\  & \Gamma(Y, \mathcal{J}^\bullet) \overset{qis}{\uparrow}\overset{\beta}{\longrightarrow} & \Gamma(Y, (\mathcal{J}')^\bullet) \uparrow & \Gamma(Y, f_*\mathcal{I}^\bullet) \uparrow\underset{qis}{\longleftarrow} & \end{array}
$$
The two horizontal arrows with targets $\text{Tot}(A^{\bullet, \bullet})$ and
$\text{Tot}(B^{\bullet, \bullet})$
are the ones explained in Lemma \ref{cohomology-lemma-cech-cohomology}.
...
\begin{lemma}[Cech always]
\label{cohomology-lemma-cech-always}
\source{stacks:09V1}
\href{https://stacks.math.columbia.edu/tag/09V1}{\texttt{Stacks tag 09V1}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-cech-spectral-sequence, cohomology-lemma-kill-cohomology-class-on-covering}

Let $\mathcal{U}$ be an open covering of $X$.
By Lemma \ref{cohomology-lemma-cech-spectral-sequence}
...
\begin{lemma}[Cech Hausdorff quasi compact]
\label{cohomology-lemma-cech-Hausdorff-quasi-compact}
\source{stacks:09V2}
\href{https://stacks.math.columbia.edu/tag/09V2}{\texttt{Stacks tag 09V2}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-cech-always, cohomology-lemma-cech-cohomology, cohomology-lemma-injective-trivial-cech}

We already know that $\check{H}^n(X, -) \to H^n(X, -)$
is an isomorphism of functors for $n = 0, 1$, see
Lemma \ref{cohomology-lemma-cech-always}.
...
$$
\begin{array}{ccccc}0 \longrightarrow & \check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{F}) \downarrow\longrightarrow & \check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{G}) \downarrow\longrightarrow & \check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{H}) \downarrow\longrightarrow & 0 \\ 0 \longrightarrow & \check{\mathcal{C}}^\bullet(\mathcal{V}, \mathcal{F}) \longrightarrow & \check{\mathcal{C}}^\bullet(\mathcal{V}, \mathcal{G}) \longrightarrow & \check{\mathcal{C}}^\bullet(\mathcal{V}, \mathcal{H}) \longrightarrow & 0\end{array}
$$
...
in the diagram above, see Section \ref{cohomology-section-refinements-cech}.
...
resolutions
$$
\begin{array}{ccccc}0 \longrightarrow & \mathcal{F} \longrightarrow\downarrow & \mathcal{G} \longrightarrow\downarrow & \mathcal{H} \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & \mathcal{I}_1^\bullet \longrightarrow & \mathcal{I}_2^\bullet \longrightarrow & \mathcal{I}_3^\bullet \longrightarrow & 0\end{array}
$$
as in Derived Categories, Lemma \ref{derived-lemma-injective-resolution-ses}.
This will give a commutative diagram
$$
\begin{array}{ccccc}0 \longrightarrow & \check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{F}) \longrightarrow\downarrow & \check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{F}) \longrightarrow\downarrow & \check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{F}) \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & \text{Tot}(\check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{I}_1^\bullet))
\longrightarrow & \text{Tot}(\check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{I}_2^\bullet))
\longrightarrow & \text{Tot}(\check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{I}_3^\bullet))
...
\medskip\noindent
Finally, we may apply Lemma \ref{cohomology-lemma-injective-trivial-cech}
...
\begin{lemma}[Cohomology of closed]
\label{cohomology-lemma-cohomology-of-closed}
\source{stacks:09V3}
\href{https://stacks.math.columbia.edu/tag/09V3}{\texttt{Stacks tag 09V3}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-cech-Hausdorff-quasi-compact, cohomology-lemma-injective-flasque, cohomology-lemma-injective-trivial-cech}
...
By Lemma \ref{cohomology-lemma-cech-Hausdorff-quasi-compact}
...
Since $\mathcal{I}$ is flasque (Lemma \ref{cohomology-lemma-injective-flasque})
...
(Lemma \ref{cohomology-lemma-injective-trivial-cech})
...
\begin{lemma}[Base change map flat case]
\label{cohomology-lemma-base-change-map-flat-case}
\source{stacks:02N7}
\href{https://stacks.math.columbia.edu/tag/02N7}{\texttt{Stacks tag 02N7}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-pushforward-injective-flat}

Choose injective resolutions $\mathcal{F}^\bullet \to \mathcal{I}^\bullet$
and $(g')^*\mathcal{F}^\bullet \to \mathcal{J}^\bullet$.
By Lemma \ref{cohomology-lemma-pushforward-injective-flat} we see that
...
$$
\begin{array}{cc}(g')_*(g')^*\mathcal{F}^\bullet \longrightarrow & (g')_*\mathcal{J}^\bullet \\ \mathcal{F}^\bullet \overset{adjunction}{\uparrow}\longrightarrow & \mathcal{I}^\bullet \underset{\beta}{\uparrow}\end{array}
$$
...
\begin{remark}[Correct version base change map]
\label{cohomology-remark-correct-version-base-change-map}
\source{stacks:02N8}
\href{https://stacks.math.columbia.edu/tag/02N8}{\texttt{Stacks tag 02N8}}
\group{cohomology}

\uses{cohomology-remark-base-change}
...
unbounded complexes, see Remark \ref{cohomology-remark-base-change}.
\end{remark}
...
\source{stacks:09V5}
\href{https://stacks.math.columbia.edu/tag/09V5}{\texttt{Stacks tag 09V5}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-base-change-map-flat-case, cohomology-lemma-cohomology-of-closed}

The base change map of Lemma \ref{cohomology-lemma-base-change-map-flat-case}
...
Lemma \ref{cohomology-lemma-cohomology-of-closed}
...
$$
is an isomorphism. Using Lemma \ref{cohomology-lemma-cohomology-of-closed}
...
\source{stacks:09V6}
\href{https://stacks.math.columbia.edu/tag/09V6}{\texttt{Stacks tag 09V6}}
\group{cohomology}

\uses{cohomology-lemma-base-change-map-flat-case}
\begin{reference}
\cite[Expose V bis, 4.1.1]{SGA4}
\end{reference}
Consider a cartesian square of topological spaces
$$
\begin{array}{cc}X' = Y' \times_Y X \underset{f'}{\downarrow}\underset{g'}{\longrightarrow} & X \overset{f}{\downarrow} \\ Y' \overset{g}{\longrightarrow} & Y\end{array}
$$
...
$$
of Lemma \ref{cohomology-lemma-base-change-map-flat-case} is an isomorphism
in $D^+(Y')$.
\end{theorem}

\begin{proof}
\uses{cohomology-lemma-proper-base-change}
...
Thus we can apply Lemma \ref{cohomology-lemma-proper-base-change} twice to see that
$$
...
\source{stacks:0D90}
\href{https://stacks.math.columbia.edu/tag/0D90}{\texttt{Stacks tag 0D90}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-theorem-proper-base-change, cohomology-lemma-proper-base-change, cohomology-lemma-cohomology-of-closed}

We argue exactly as in the proof of Theorem \ref{cohomology-theorem-proper-base-change}
and we find it suffices to show
$(f_*\mathcal{F})_y = \Gamma(X_y, \mathcal{F}|_{X_y})$.
Then we argue as in Lemma \ref{cohomology-lemma-proper-base-change}
to reduce this to the $p = 0$ case of Lemma \ref{cohomology-lemma-cohomology-of-closed}
...
\begin{lemma}[Quasi separated cohomology colimit]
\label{cohomology-lemma-quasi-separated-cohomology-colimit}
\source{stacks:01FF}
\href{https://stacks.math.columbia.edu/tag/01FF}{\texttt{Stacks tag 01FF}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-cech-vanish-basis, cohomology-lemma-injective-trivial-cech}
...
$$
\begin{array}{cccc}\colim_i H^{q_0}(U, \mathcal{I}_i) \downarrow\longrightarrow & \colim_i H^{q_0}(U, \mathcal{Q}_i) \downarrow\longrightarrow & \colim_i H^{q_0 + 1}(U, \mathcal{F}_i) \downarrow\longrightarrow & 0 \downarrow \\ H^{q_0}(U, \colim_i \mathcal{I}_i) \longrightarrow & H^{q_0}(U, \colim_i \mathcal{Q}_i) \longrightarrow & H^{q_0 + 1}(U, \colim_i \mathcal{F}_i) \longrightarrow & 0\end{array}
$$
...
Lemma \ref{cohomology-lemma-cech-vanish-basis}.
...
are quasi-compact. By Lemma \ref{cohomology-lemma-injective-trivial-cech}
...
Lemma \ref{cohomology-lemma-cech-vanish-basis} are satisfied and the claim follows.
\end{proof}

\begin{lemma}[Higher direct image colimit]
\label{cohomology-lemma-higher-direct-image-colimit}
\source{stacks:0H7A}
\href{https://stacks.math.columbia.edu/tag/0H7A}{\texttt{Stacks tag 0H7A}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-describe-higher-direct-images}

Recall that $R^pf_*\mathcal{F}$ is the sheafification of the presheaf
$\mathcal{G}$ sending $V$ to $H^p(f^{-1}(V), \mathcal{F})$, see
Lemma \ref{cohomology-lemma-describe-higher-direct-images}. Similarly,
...
\source{stacks:0A37}
\href{https://stacks.math.columbia.edu/tag/0A37}{\texttt{Stacks tag 0A37}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-pushforward-injective-flat, cohomology-lemma-quasi-separated-cohomology-colimit, cohomology-lemma-cech-vanish-basis, cohomology-lemma-injective-trivial-cech}
...
Lemma \ref{cohomology-lemma-pushforward-injective-flat} and
Homology, Lemma \ref{homology-lemma-product-injectives}.
This finishes the construction.

\medskip\noindent
Arguing exactly as in the proof of
Lemma \ref{cohomology-lemma-quasi-separated-cohomology-colimit}
...
Lemma \ref{cohomology-lemma-injective-trivial-cech}. Thus we conclude by
Algebra, Lemma \ref{algebra-lemma-directed-colimit-exact}.
\end{proof}
...
Proposition \ref{cohomology-proposition-vanishing-Noetherian}. See \cite{Tohoku}.

\begin{lemma}[Cohomology and closed immersions]
\label{cohomology-lemma-cohomology-and-closed-immersions}
\source{stacks:02UV}
\href{https://stacks.math.columbia.edu/tag/02UV}{\texttt{Stacks tag 02UV}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-apply-Leray}

This is true because $i_*$ is exact (see
Modules, Lemma \ref{modules-lemma-i-star-exact}),
and hence $R^pi_* = 0$ as a functor
(Derived Categories, Lemma \ref{derived-lemma-right-derived-exact-functor}).
Thus we may apply Lemma \ref{cohomology-lemma-apply-Leray}.
\end{proof}

\begin{lemma}[Irreducible constant cohomology zero]
\label{cohomology-lemma-irreducible-constant-cohomology-zero}
\source{stacks:02UW}
\href{https://stacks.math.columbia.edu/tag/02UW}{\texttt{Stacks tag 02UW}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-flasque-acyclic}
...
from Lemma \ref{cohomology-lemma-flasque-acyclic}.
\end{proof}

\begin{lemma}[Subsheaf of constant sheaf]
\label{cohomology-lemma-subsheaf-of-constant-sheaf}
\source{stacks:0A38}
\href{https://stacks.math.columbia.edu/tag/0A38}{\texttt{Stacks tag 0A38}}
\group{cohomology}
...
\begin{lemma}[Vanishing generated one section]
\label{cohomology-lemma-vanishing-generated-one-section}
\source{stacks:02UX}
\href{https://stacks.math.columbia.edu/tag/02UX}{\texttt{Stacks tag 02UX}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-quasi-separated-cohomology-colimit, cohomology-lemma-subsheaf-of-constant-sheaf}
...
Lemma \ref{cohomology-lemma-quasi-separated-cohomology-colimit} we have
$$
H^p(X, \mathcal{F}) =
...
Lemma \ref{cohomology-lemma-subsheaf-of-constant-sheaf} there exists a finite
...
\source{stacks:0BX0}
\href{https://stacks.math.columbia.edu/tag/0BX0}{\texttt{Stacks tag 0BX0}}
\group{cohomology}

\uses{cohomology-lemma-vanishing-generated-one-section}
...
Lemma \ref{cohomology-lemma-vanishing-generated-one-section} for $d = 0$
but not the conclusion.
\end{example}

\begin{lemma}[Subsheaf irreducible]
\label{cohomology-lemma-subsheaf-irreducible}
\source{stacks:02UY}
\href{https://stacks.math.columbia.edu/tag/02UY}{\texttt{Stacks tag 02UY}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-irreducible-constant-cohomology-zero}

Recall that $\underline{\mathbf{Z}}(V) = \mathbf{Z}$
for any nonempty open $V$ of $X$ (see proof of
Lemma \ref{cohomology-lemma-irreducible-constant-cohomology-zero}).
...
\source{stacks:02UZ}
\href{https://stacks.math.columbia.edu/tag/02UZ}{\texttt{Stacks tag 02UZ}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-cohomology-and-closed-immersions, cohomology-lemma-irreducible-constant-cohomology-zero, cohomology-lemma-vanishing-generated-one-section}
...
By Lemma \ref{cohomology-lemma-cohomology-and-closed-immersions} it suffices to prove
...
By Lemma \ref{cohomology-lemma-vanishing-generated-one-section}
...
By Lemma \ref{cohomology-lemma-irreducible-constant-cohomology-zero}
...
will be continued in Section \ref{cohomology-section-cohomology-support-bis}.
...
(Lemma \ref{cohomology-lemma-injective-restriction-surjective})
...
Lemma \ref{cohomology-lemma-sections-with-support-acyclic} below
...
\source{stacks:0A3A}
\href{https://stacks.math.columbia.edu/tag/0A3A}{\texttt{Stacks tag 0A3A}}
\group{cohomology}
...
A key result on the cohomology of spectral spaces is Lemma \ref{cohomology-lemma-colimit}
...
Lemmas \ref{cohomology-lemma-cohomology-of-closed} and \ref{cohomology-lemma-proper-base-change}
as follows.

\begin{lemma}[Cohomology of neighbourhoods of closed]
\label{cohomology-lemma-cohomology-of-neighbourhoods-of-closed}
\source{stacks:0A3D}
\href{https://stacks.math.columbia.edu/tag/0A3D}{\texttt{Stacks tag 0A3D}}
\group{cohomology}
...
Thus we may apply Lemma \ref{cohomology-lemma-colimit} to conclude that (1) holds.
The same proof works for part (2) except we use
Topology, Lemma \ref{topology-lemma-make-spectral-space-minus}.
\end{proof}

\begin{lemma}[Proper base change spectral]
\label{cohomology-lemma-proper-base-change-spectral}
\source{stacks:0A3E}
\href{https://stacks.math.columbia.edu/tag/0A3E}{\texttt{Stacks tag 0A3E}}
\group{cohomology}
...
$$
by Lemma \ref{cohomology-lemma-colimit}. On the other hand, the stalk of
$R^pf_*\mathcal{F}$ at $y$ is given by the colimit on the right.
\end{proof}

\begin{lemma}[Vanishing for profinite]
\label{cohomology-lemma-vanishing-for-profinite}
\source{stacks:0A3F}
\href{https://stacks.math.columbia.edu/tag/0A3F}{\texttt{Stacks tag 0A3F}}
\group{cohomology}
...
(Proposition \ref{cohomology-proposition-vanishing-Noetherian})
and can be found in \cite{Scheiderer}.

\begin{proposition}[Cohomological dimension spectral]
\label{cohomology-proposition-cohomological-dimension-spectral}
\source{stacks:0A3G}
\href{https://stacks.math.columbia.edu/tag/0A3G}{\texttt{Stacks tag 0A3G}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-vanishing-for-profinite, cohomology-lemma-cohomology-of-neighbourhoods-of-closed, cohomology-lemma-mayer-vietoris, cohomology-lemma-injective-flasque, cohomology-lemma-vanishing-ravi, cohomology-lemma-cech-vanish-basis}
...
Thus (1) holds by Lemma \ref{cohomology-lemma-vanishing-for-profinite}.
...
Lemma \ref{cohomology-lemma-cohomology-of-neighbourhoods-of-closed} we have
$$
...
(Lemma \ref{cohomology-lemma-mayer-vietoris}) for the covering $X = U \cup V$
...
as follows
$$
\begin{array}{cccc}\mathcal{I}^{d - 1}(X) \longrightarrow\downarrow & \mathcal{G}(X) \longrightarrow\downarrow & H^d(X, \mathcal{F}) \downarrow\longrightarrow & 0 \\ \mathcal{I}^{d - 1}(U) \longrightarrow & \mathcal{G}(U) \longrightarrow & H^d(U, \mathcal{F}) \longrightarrow & 0\end{array}
$$
The sheaf $\mathcal{I}^{d - 1}$ is flasque by
Lemma \ref{cohomology-lemma-injective-flasque} and the fact that $d \geq 1$.
...
By Lemma \ref{cohomology-lemma-vanishing-ravi} we conclude that
...
Lemma \ref{cohomology-lemma-cech-vanish-basis} we find that $H^q(U, \mathcal{G}) = 0$
...
\begin{definition}[Alternating cech complex]
\label{cohomology-definition-alternating-cech-complex}
\source{stacks:01FH}
\href{https://stacks.math.columbia.edu/tag/01FH}{\texttt{Stacks tag 01FH}}
\group{cohomology}
...
\begin{definition}[Ordered cech complex]
\label{cohomology-definition-ordered-cech-complex}
\source{stacks:01FI}
\href{https://stacks.math.columbia.edu/tag/01FI}{\texttt{Stacks tag 01FI}}
\group{cohomology}
...
\begin{lemma}[Ordered alternating]
\label{cohomology-lemma-ordered-alternating}
\source{stacks:01FJ}
\href{https://stacks.math.columbia.edu/tag/01FJ}{\texttt{Stacks tag 01FJ}}
\group{cohomology}
...
\begin{lemma}[Project to ordered]
\label{cohomology-lemma-project-to-ordered}
\source{stacks:01FK}
\href{https://stacks.math.columbia.edu/tag/01FK}{\texttt{Stacks tag 01FK}}
\group{cohomology}
...
\begin{remark}[Compared ordered complexes]
\label{cohomology-remark-compared-ordered-complexes}
\source{stacks:01FL}
\href{https://stacks.math.columbia.edu/tag/01FL}{\texttt{Stacks tag 01FL}}
\group{cohomology}
...
\begin{lemma}[Alternating usual]
\label{cohomology-lemma-alternating-usual}
\source{stacks:01FM}
\href{https://stacks.math.columbia.edu/tag/01FM}{\texttt{Stacks tag 01FM}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-project-to-ordered}
...
(analogous to Lemma \ref{cohomology-lemma-project-to-ordered}) that the projection map
$$
...
\begin{lemma}[Alternating cech trivial]
\label{cohomology-lemma-alternating-cech-trivial}
\source{stacks:0G6T}
\href{https://stacks.math.columbia.edu/tag/0G6T}{\texttt{Stacks tag 0G6T}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-cech-trivial, cohomology-lemma-alternating-usual}
[First proof]
Combine Lemmas \ref{cohomology-lemma-cech-trivial} and \ref{cohomology-lemma-alternating-usual}.
\end{proof}
...
\section{Alternative view of the {\v C}
ech complex}
...
\begin{lemma}[Covering resolution]
\label{cohomology-lemma-covering-resolution}
\source{stacks:02FU}
\href{https://stacks.math.columbia.edu/tag/02FU}{\texttt{Stacks tag 02FU}}
\group{cohomology}
...
sequence of Lemma \ref{cohomology-lemma-cech-spectral-sequence}. Namely,
let $X$, $\mathcal{U}$, $\mathcal{F}$ as in
Lemma \ref{cohomology-lemma-covering-resolution}
...
is a resolution (Lemma \ref{cohomology-lemma-covering-resolution})
of the injective sheaf $\mathcal{I}^q$
by injective sheaves (by Lemmas \ref{cohomology-lemma-cohomology-of-open} and
...
\begin{definition}[Covering locally finite]
\label{cohomology-definition-covering-locally-finite}
\source{stacks:02FS}
\href{https://stacks.math.columbia.edu/tag/02FS}{\texttt{Stacks tag 02FS}}
\group{cohomology}
...
\begin{remark}[Locally finite sections]
\label{cohomology-remark-locally-finite-sections}
\source{stacks:02FT}
\href{https://stacks.math.columbia.edu/tag/02FT}{\texttt{Stacks tag 02FT}}
\group{cohomology}

\uses{cohomology-lemma-covering-resolution}
...
Lemma \ref{cohomology-lemma-covering-resolution} has terms
$$
{\mathfrak C}^p(\mathcal{U}, \mathcal{F}) =
\bigoplus\nolimits_{i_0 \ldots i_p}
(j_{i_0 \ldots i_p})_* \mathcal{F}_{i_0 \ldots i_p}
...
$\check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{F})$
(Definition \ref{cohomology-definition-cech-complex})
...
\begin{lemma}[Cech complex complex]
\label{cohomology-lemma-cech-complex-complex}
\source{stacks:08BN}
\href{https://stacks.math.columbia.edu/tag/08BN}{\texttt{Stacks tag 08BN}}
\group{cohomology}
...
\begin{lemma}[Cech complex complex computes]
\label{cohomology-lemma-cech-complex-complex-computes}
\source{stacks:0FLH}
\href{https://stacks.math.columbia.edu/tag/0FLH}{\texttt{Stacks tag 0FLH}}
\group{cohomology}

\uses{cohomology-lemma-cech-complex-complex}
Let $(X, \mathcal{O}_X)$ be a ringed space.
Let $\mathcal{U} : X = \bigcup_{i \in I} U_i$ be
...
R\Gamma(X, \mathcal{F}^\bullet)
$
of Lemma \ref{cohomology-lemma-cech-complex-complex} is an isomorphism.
\end{lemma}

\begin{proof}
\uses{cohomology-lemma-cech-complex-complex}

Immediate from the spectral sequence of Lemma \ref{cohomology-lemma-cech-complex-complex}.
\end{proof}

\begin{remark}[Shift complex cech complex]
\label{cohomology-remark-shift-complex-cech-complex}
\source{stacks:0FLI}
\href{https://stacks.math.columbia.edu/tag/0FLI}{\texttt{Stacks tag 0FLI}}
\group{cohomology}
...
$$
\begin{array}{cc}\text{Tot}(\check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{F}^\bullet))[b]
\longrightarrow\underset{\gamma}{\downarrow} & R\Gamma(X, \mathcal{F}^\bullet)[b] \downarrow \\ \text{Tot}(\check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{F}^\bullet[b]))
\longrightarrow & R\Gamma(X, \mathcal{F}^\bullet[b])\end{array}
$$
...
Lemma \ref{cohomology-lemma-cech-complex-complex}. Chasing diagrams, we see that
...
$$
\begin{array}{ccc}\Gamma(X, \mathcal{I}^\bullet)[b] \longrightarrow\downarrow & \text{Tot}(\check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{I}^\bullet))[b]
\longrightarrow\underset{\gamma}{\downarrow} & R\Gamma(X, \mathcal{I}^\bullet)[b] \downarrow \\ \Gamma(X, \mathcal{I}^\bullet[b]) \longrightarrow & \text{Tot}(\check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{I}^\bullet[b]))
\longrightarrow & R\Gamma(X, \mathcal{I}^\bullet[b])\end{array}
$$
...
category (see proof of Lemma \ref{cohomology-lemma-cech-complex-complex}) it
...
the diagrams
$$
\begin{array}{cc}\text{Tot}({\mathcal F}_1^\bullet \otimes_{\mathbf Z} {\mathcal G}_1^\bullet)
\underset{\gamma_1}{\downarrow} & \text{Tot}({\mathcal F}_1^\bullet \otimes_{\mathbf Z} {\mathcal G}_2^\bullet)
\longleftarrow\downarrow \\ \mathcal{H}^\bullet & \text{Tot}({\mathcal F}_2^\bullet \otimes_{\mathbf Z} {\mathcal G}_2^\bullet)
\underset{\gamma_2}{\longleftarrow}\end{array}
$$
and
$$
\begin{array}{cc}\text{Tot}({\mathcal F}_2^\bullet \otimes_{\mathbf Z} {\mathcal G}_2^\bullet)
\underset{\gamma_2}{\downarrow} & \text{Tot}({\mathcal F}_2^\bullet \otimes_{\mathbf Z} {\mathcal G}_3^\bullet)
\longleftarrow\downarrow \\ \mathcal{H}^\bullet & \text{Tot}({\mathcal F}_3^\bullet \otimes_{\mathbf Z} {\mathcal G}_3^\bullet)
\underset{\gamma_3}{\longleftarrow}\end{array}
$$
are commutative.

\begin{lemma}[Compute sign cup product boundaries]
\label{cohomology-lemma-compute-sign-cup-product-boundaries}
\source{stacks:07MC}
\href{https://stacks.math.columbia.edu/tag/07MC}{\texttt{Stacks tag 07MC}}
\group{cohomology}
...
\begin{lemma}[Boundary derivation over cup product]
\label{cohomology-lemma-boundary-derivation-over-cup-product}
\source{stacks:0B8S}
\href{https://stacks.math.columbia.edu/tag/0B8S}{\texttt{Stacks tag 0B8S}}
\group{cohomology}
...
(Observe that by Lemma \ref{cohomology-lemma-cech-h1} the first {\v C}ech cohomology
...
\begin{lemma}[Derived tor exact]
\label{cohomology-lemma-derived-tor-exact}
\source{stacks:06Y8}
\href{https://stacks.math.columbia.edu/tag/06Y8}{\texttt{Stacks tag 06Y8}}
\group{cohomology}
...
\begin{definition}[K flat]
\label{cohomology-definition-K-flat}
\source{stacks:06Y9}
\href{https://stacks.math.columbia.edu/tag/06Y9}{\texttt{Stacks tag 06Y9}}
\group{cohomology}
...
\begin{lemma}[K flat quasi isomorphism]
\label{cohomology-lemma-K-flat-quasi-isomorphism}
\source{stacks:06YA}
\href{https://stacks.math.columbia.edu/tag/06YA}{\texttt{Stacks tag 06YA}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-derived-tor-exact}

Follows from
Lemma \ref{cohomology-lemma-derived-tor-exact}
and the fact that quasi-isomorphisms are characterized by having
acyclic cones.
\end{proof}

\begin{lemma}[Check K flat stalks]
\label{cohomology-lemma-check-K-flat-stalks}
\source{stacks:06YB}
\href{https://stacks.math.columbia.edu/tag/06YB}{\texttt{Stacks tag 06YB}}
\group{cohomology}
...
\begin{lemma}[Tensor product K flat]
\label{cohomology-lemma-tensor-product-K-flat}
\source{stacks:079R}
\href{https://stacks.math.columbia.edu/tag/079R}{\texttt{Stacks tag 079R}}
\group{cohomology}
...
\begin{lemma}[K flat two out of three]
\label{cohomology-lemma-K-flat-two-out-of-three}
\source{stacks:079S}
\href{https://stacks.math.columbia.edu/tag/079S}{\texttt{Stacks tag 079S}}
\group{cohomology}
...
\begin{lemma}[K flat two out of three ses]
\label{cohomology-lemma-K-flat-two-out-of-three-ses}
\source{stacks:0G6U}
\href{https://stacks.math.columbia.edu/tag/0G6U}{\texttt{Stacks tag 0G6U}}
\group{cohomology}
...
\begin{lemma}[Pullback K flat]
\label{cohomology-lemma-pullback-K-flat}
\source{stacks:06YC}
\href{https://stacks.math.columbia.edu/tag/06YC}{\texttt{Stacks tag 06YC}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-check-K-flat-stalks}

We can check this on stalks, see
Lemma \ref{cohomology-lemma-check-K-flat-stalks}.
...
\begin{lemma}[Bounded flat K flat]
\label{cohomology-lemma-bounded-flat-K-flat}
\source{stacks:06YD}
\href{https://stacks.math.columbia.edu/tag/06YD}{\texttt{Stacks tag 06YD}}
\group{cohomology}
...
\begin{lemma}[Colimit K flat]
\label{cohomology-lemma-colimit-K-flat}
\source{stacks:06YE}
\href{https://stacks.math.columbia.edu/tag/06YE}{\texttt{Stacks tag 06YE}}
\group{cohomology}
...
\begin{lemma}[Resolution by direct sums extensions by zero]
\label{cohomology-lemma-resolution-by-direct-sums-extensions-by-zero}
\source{stacks:079T}
\href{https://stacks.math.columbia.edu/tag/079T}{\texttt{Stacks tag 079T}}
\group{cohomology}
...
$$
\begin{array}{ccc}\mathcal{K}_1^\bullet \downarrow\longrightarrow & \mathcal{K}_2^\bullet \downarrow\longrightarrow & \ldots \\ \tau_{\leq 1}\mathcal{G}^\bullet \longrightarrow & \tau_{\leq 2}\mathcal{G}^\bullet \longrightarrow & \ldots\end{array}
$$
...
\begin{lemma}[K flat resolution]
\label{cohomology-lemma-K-flat-resolution}
\source{stacks:06YF}
\href{https://stacks.math.columbia.edu/tag/06YF}{\texttt{Stacks tag 06YF}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-resolution-by-direct-sums-extensions-by-zero, cohomology-lemma-bounded-flat-K-flat, cohomology-lemma-colimit-K-flat}

Choose a diagram as in
Lemma \ref{cohomology-lemma-resolution-by-direct-sums-extensions-by-zero}.
...
Lemma \ref{cohomology-lemma-bounded-flat-K-flat}.
Thus $\colim \mathcal{K}_n^\bullet$ is K-flat by
Lemma \ref{cohomology-lemma-colimit-K-flat}.
The induced map
$\colim \mathcal{K}_n^\bullet \to \mathcal{G}^\bullet$
is a quasi-isomorphism and termwise surjective by construction.
Property (3) of Lemma \ref{cohomology-lemma-resolution-by-direct-sums-extensions-by-zero}
shows that $\colim \mathcal{K}_n^m$ is a direct sum of
flat modules and hence flat which proves the final assertion.
\end{proof}

\begin{lemma}[Derived tor quasi isomorphism other side]
\label{cohomology-lemma-derived-tor-quasi-isomorphism-other-side}
\source{stacks:06YG}
\href{https://stacks.math.columbia.edu/tag/06YG}{\texttt{Stacks tag 06YG}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-K-flat-resolution, cohomology-lemma-K-flat-quasi-isomorphism}

Choose a quasi-isomorphism $\mathcal{K}^\bullet \to \mathcal{F}^\bullet$
with $\mathcal{K}^\bullet$ a K-flat complex, see
Lemma \ref{cohomology-lemma-K-flat-resolution}.
Consider the commutative diagram
$$
\begin{array}{cc}\text{Tot}(\mathcal{K}^\bullet
\otimes_{\mathcal{O}_X} \mathcal{P}^\bullet) \longrightarrow\downarrow & \text{Tot}(\mathcal{K}^\bullet
\otimes_{\mathcal{O}_X} \mathcal{Q}^\bullet) \downarrow \\ \text{Tot}(\mathcal{F}^\bullet
\otimes_{\mathcal{O}_X} \mathcal{P}^\bullet) \longrightarrow & \text{Tot}(\mathcal{F}^\bullet
\otimes_{\mathcal{O}_X} \mathcal{Q}^\bullet)\end{array}
$$
The result follows as by
Lemma \ref{cohomology-lemma-K-flat-quasi-isomorphism}
...
Lemma \ref{cohomology-lemma-derived-tor-quasi-isomorphism-other-side}
the resulting functor (up to isomorphism)
does not depend on the choice of $\mathcal{K}^\bullet$.

\begin{definition}[Derived tor]
\label{cohomology-definition-derived-tor}
\source{stacks:06YH}
\href{https://stacks.math.columbia.edu/tag/06YH}{\texttt{Stacks tag 06YH}}
\group{cohomology}
...
\source{stacks:08BP}
\href{https://stacks.math.columbia.edu/tag/08BP}{\texttt{Stacks tag 08BP}}
\group{cohomology}
...
$$
\begin{array}{cccc}\mathcal{F}_1 \otimes_{\mathcal{O}_X} \mathcal{G} \longrightarrow & \mathcal{F}_2 \otimes_{\mathcal{O}_X} \mathcal{G} \longrightarrow & \mathcal{F}_3 \otimes_{\mathcal{O}_X} \mathcal{G} \longrightarrow & 0 \\ \text{Tor}_1^{\mathcal{O}_X}(\mathcal{F}_1, \mathcal{G}) \longrightarrow & \text{Tor}_1^{\mathcal{O}_X}(\mathcal{F}_2, \mathcal{G}) \longrightarrow & \text{Tor}_1^{\mathcal{O}_X}(\mathcal{F}_3, \mathcal{G}) \nwarrow & \end{array}
$$
...
\begin{lemma}[Tor measures the deviation of flatness.]
\label{cohomology-lemma-flat-tor-zero}
\source{stacks:08BQ}
\href{https://stacks.math.columbia.edu/tag/08BQ}{\texttt{Stacks tag 08BQ}}
\group{cohomology}
...
\begin{lemma}[Factor through K flat]
\label{cohomology-lemma-factor-through-K-flat}
\source{stacks:0G6V}
\href{https://stacks.math.columbia.edu/tag/0G6V}{\texttt{Stacks tag 0G6V}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-K-flat-resolution, cohomology-lemma-K-flat-two-out-of-three}
...
By Lemma \ref{cohomology-lemma-K-flat-two-out-of-three} we see that
...
$$
\begin{array}{cccc}\mathcal{K}^\bullet \longrightarrow\downarrow & \mathcal{N}^\bullet \longrightarrow\downarrow & \mathcal{M}^\bullet \longrightarrow\downarrow & \mathcal{K}^\bullet[1] \downarrow \\ \mathcal{K}^\bullet \longrightarrow & \mathcal{L}^\bullet \longrightarrow & \mathcal{C}^\bullet \longrightarrow & \mathcal{K}^\bullet[1]\end{array}
$$
...
You can use
Lemmas \ref{cohomology-lemma-pullback-K-flat},
\ref{cohomology-lemma-K-flat-resolution}, and
...
\begin{lemma}[Derived base change]
\label{cohomology-lemma-derived-base-change}
\source{stacks:06YJ}
\href{https://stacks.math.columbia.edu/tag/06YJ}{\texttt{Stacks tag 06YJ}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-K-flat-resolution, cohomology-lemma-pullback-K-flat, cohomology-lemma-derived-tor-quasi-isomorphism-other-side}
...
Lemma \ref{cohomology-lemma-pullback-K-flat}
...
\begin{lemma}[Derived pullback composition]
\label{cohomology-lemma-derived-pullback-composition}
\source{stacks:0D5S}
\href{https://stacks.math.columbia.edu/tag/0D5S}{\texttt{Stacks tag 0D5S}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-pullback-K-flat}
...
By Lemma \ref{cohomology-lemma-pullback-K-flat} we see that $g^*\mathcal{K}^\bullet$
is K-flat on $Y$. Then $Lf^*Lg^*E$ is given by
$f^*g^*\mathcal{K}^\bullet = (g \circ f)^*\mathcal{K}^\bullet$
which also represents $L(g \circ f)^*E$.
\end{proof}

\begin{lemma}[Pullback tensor product]
\label{cohomology-lemma-pullback-tensor-product}
\source{stacks:079U}
\href{https://stacks.math.columbia.edu/tag/079U}{\texttt{Stacks tag 079U}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-tensor-product-K-flat}
...
By
Lemma \ref{cohomology-lemma-tensor-product-K-flat}
...
\begin{lemma}[Variant derived pullback]
\label{cohomology-lemma-variant-derived-pullback}
\source{stacks:08DE}
\href{https://stacks.math.columbia.edu/tag/08DE}{\texttt{Stacks tag 08DE}}
\group{cohomology}
...
\begin{lemma}[Tensor pull compatibility]
\label{cohomology-lemma-tensor-pull-compatibility}
\source{stacks:0FP0}
\href{https://stacks.math.columbia.edu/tag/0FP0}{\texttt{Stacks tag 0FP0}}
\group{cohomology}
...
$$
\begin{array}{cc}Lf^*(\mathcal{K}^\bullet
\otimes_{\mathcal{O}_Y}^\mathbf{L}
\mathcal{M}^\bullet) \longrightarrow\downarrow & Lf^*\text{Tot}(\mathcal{K}^\bullet
\otimes_{\mathcal{O}_Y}
\mathcal{M}^\bullet) \downarrow \\ Lf^*\mathcal{K}^\bullet \otimes_{\mathcal{O}_X}^\mathbf{L}
Lf^*\mathcal{M}^\bullet \downarrow & f^*\text{Tot}(\mathcal{K}^\bullet
\otimes_{\mathcal{O}_Y}
\mathcal{M}^\bullet) \downarrow \\ f^*\mathcal{K}^\bullet \otimes_{\mathcal{O}_X}^\mathbf{L}
f^*\mathcal{M}^\bullet \longrightarrow & \text{Tot}(f^*\mathcal{K}^\bullet \otimes_{\mathcal{O}_X}
f^*\mathcal{M}^\bullet)\end{array}
$$
commutes.
\end{lemma}

\begin{proof}
\uses{cohomology-lemma-pullback-K-flat, cohomology-lemma-tensor-product-K-flat}

We will use the existence of K-flat resolutions as in
Lemma \ref{cohomology-lemma-pullback-K-flat}. If we choose such
resolutions $\mathcal{P}^\bullet \to \mathcal{K}^\bullet$
and $\mathcal{Q}^\bullet \to \mathcal{M}^\bullet$, then
we see that
$$
\begin{array}{cc}Lf^*\text{Tot}(\mathcal{P}^\bullet
\otimes_{\mathcal{O}_Y}
\mathcal{Q}^\bullet) \longrightarrow\downarrow & Lf^*\text{Tot}(\mathcal{K}^\bullet
\otimes_{\mathcal{O}_Y}
\mathcal{M}^\bullet) \downarrow \\ f^*\text{Tot}(\mathcal{P}^\bullet
\otimes_{\mathcal{O}_Y}
\mathcal{Q}^\bullet) \downarrow\longrightarrow & f^*\text{Tot}(\mathcal{K}^\bullet
\otimes_{\mathcal{O}_Y}
\mathcal{M}^\bullet) \downarrow \\ \text{Tot}(f^*\mathcal{P}^\bullet \otimes_{\mathcal{O}_X}
f^*\mathcal{Q}^\bullet) \longrightarrow & \text{Tot}(f^*\mathcal{K}^\bullet \otimes_{\mathcal{O}_X}
f^*\mathcal{M}^\bullet)\end{array}
$$
...
\source{stacks:079W}
\href{https://stacks.math.columbia.edu/tag/079W}{\texttt{Stacks tag 079W}}
\group{cohomology}

\uses{cohomology-lemma-derived-base-change}
Let $f : (X, \mathcal{O}_X) \to (Y, \mathcal{O}_Y)$ be a morphism of
ringed spaces. The functor $Rf_*$ defined above and the functor $Lf^*$
defined in Lemma \ref{cohomology-lemma-derived-base-change} are adjoint:
$$
...
\begin{lemma}[Derived pushforward composition]
\label{cohomology-lemma-derived-pushforward-composition}
\source{stacks:0D5T}
\href{https://stacks.math.columbia.edu/tag/0D5T}{\texttt{Stacks tag 0D5T}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-adjoint, cohomology-lemma-derived-pullback-composition}

By Lemma \ref{cohomology-lemma-adjoint} we see that $Rg_* \circ Rf_*$
is adjoint to $Lf^* \circ Lg^*$. We have
$Lf^* \circ Lg^* = L(g \circ f)^*$ by
Lemma \ref{cohomology-lemma-derived-pullback-composition}
and hence by
...
\source{stacks:08HY}
\href{https://stacks.math.columbia.edu/tag/08HY}{\texttt{Stacks tag 08HY}}
\group{cohomology}
...
\begin{remark}[Compose base change]
\label{cohomology-remark-compose-base-change}
\source{stacks:0ATL}
\href{https://stacks.math.columbia.edu/tag/0ATL}{\texttt{Stacks tag 0ATL}}
\group{cohomology}

\uses{cohomology-remark-base-change}
Consider a commutative diagram
$$
\begin{array}{cc}X' \underset{k}{\longrightarrow}\underset{f'}{\downarrow} & X \overset{f}{\downarrow} \\ Y' \overset{l}{\longrightarrow}\underset{g'}{\downarrow} & Y \overset{g}{\downarrow} \\ Z' \overset{m}{\longrightarrow} & Z\end{array}
$$
of ringed spaces. Then the base change maps of
Remark \ref{cohomology-remark-base-change}
...
\begin{remark}[Compose base change horizontal]
\label{cohomology-remark-compose-base-change-horizontal}
\source{stacks:0ATM}
\href{https://stacks.math.columbia.edu/tag/0ATM}{\texttt{Stacks tag 0ATM}}
\group{cohomology}

\uses{cohomology-remark-base-change}
Consider a commutative diagram
$$
\begin{array}{ccc}X'' \underset{g'}{\longrightarrow}\underset{f''}{\downarrow} & X' \underset{g}{\longrightarrow}\underset{f'}{\downarrow} & X \overset{f}{\downarrow} \\ Y'' \overset{h'}{\longrightarrow} & Y' \overset{h}{\longrightarrow} & Y\end{array}
$$
of ringed spaces. Then the base change maps of
Remark \ref{cohomology-remark-base-change}
for the two squares compose to give the base
...
\begin{lemma}[Adjoints push pull compatibility]
\label{cohomology-lemma-adjoints-push-pull-compatibility}
\source{stacks:0FP1}
\href{https://stacks.math.columbia.edu/tag/0FP1}{\texttt{Stacks tag 0FP1}}
\group{cohomology}
...
The diagram
$$
\begin{array}{cc}Lf^*f_*\mathcal{K}^\bullet \longrightarrow\downarrow & f^*f_*\mathcal{K}^\bullet \downarrow \\ Lf^*Rf_*\mathcal{K}^\bullet \longrightarrow & \mathcal{K}^\bullet\end{array}
$$
...
K-injective resolutions, see Lemma \ref{cohomology-lemma-pullback-K-flat}
...
$$
\begin{array}{cc}\mathcal{P}^\bullet \longrightarrow\downarrow & f_*\mathcal{K}^\bullet \downarrow \\ \mathcal{Q}^\bullet \longrightarrow & f_*\mathcal{I}^\bullet\end{array}
$$
...
$$
\begin{array}{ccc}f^*\mathcal{P}^\bullet \longrightarrow\downarrow & f^*f_*\mathcal{K}^\bullet \downarrow\longrightarrow & \mathcal{K}^\bullet \downarrow \\ f^*\mathcal{Q}^\bullet \longrightarrow & f^*f_*\mathcal{I}^\bullet \longrightarrow & \mathcal{I}^\bullet\end{array}
$$
...
\source{stacks:0B68}
\href{https://stacks.math.columbia.edu/tag/0B68}{\texttt{Stacks tag 0B68}}
\group{cohomology}

\uses{cohomology-lemma-pullback-tensor-product}
Let $f : (X, \mathcal{O}_X) \to (Y, \mathcal{O}_Y)$ be a morphism of
...
(Lemma \ref{cohomology-lemma-pullback-tensor-product})
with the map
$Lf^*Rf_*K \otimes_{\mathcal{O}_X}^\mathbf{L} Lf^*Rf_*L
...
\begin{lemma}[Spectral sequence filtered object]
\label{cohomology-lemma-spectral-sequence-filtered-object}
\source{stacks:0BKK}
\href{https://stacks.math.columbia.edu/tag/0BKK}{\texttt{Stacks tag 0BKK}}
\group{cohomology}
...
\begin{remark}[Spectral sequence filtered object]
\label{cohomology-remark-spectral-sequence-filtered-object}
\source{stacks:0BKL}
\href{https://stacks.math.columbia.edu/tag/0BKL}{\texttt{Stacks tag 0BKL}}
\group{cohomology}

\uses{cohomology-lemma-spectral-sequence-filtered-object}
Let $(X, \mathcal{O}_X)$ be a ringed space. Let $\mathcal{F}^\bullet$ be a
...
in Lemma \ref{cohomology-lemma-spectral-sequence-filtered-object}
...
\source{stacks:0BKM}
\href{https://stacks.math.columbia.edu/tag/0BKM}{\texttt{Stacks tag 0BKM}}
\group{cohomology}

\uses{cohomology-lemma-spectral-sequence-filtered-object, cohomology-remark-spectral-sequence-filtered-object}
Let $(X, \mathcal{O}_X)$ be a ringed space. Let $\mathcal{F}^\bullet$ be a
complex of $\mathcal{O}_X$-modules. We can apply
Lemma \ref{cohomology-lemma-spectral-sequence-filtered-object}
with $F^p\mathcal{F}^\bullet = \tau_{\leq -p}\mathcal{F}^\bullet$.
(If $\mathcal{F}^\bullet$ is bounded below we can use
Remark \ref{cohomology-remark-spectral-sequence-filtered-object}.)
...
\begin{example}[Spectral sequence bis]
\label{cohomology-example-spectral-sequence-bis}
\source{stacks:0FLK}
\href{https://stacks.math.columbia.edu/tag/0FLK}{\texttt{Stacks tag 0FLK}}
\group{cohomology}
...
\begin{lemma}[Relative spectral sequence filtered object]
\label{cohomology-lemma-relative-spectral-sequence-filtered-object}
\source{stacks:0FLL}
\href{https://stacks.math.columbia.edu/tag/0FLL}{\texttt{Stacks tag 0FLL}}
\group{cohomology}
...
cosimplicial object
$$
\begin{array}{cccc}\text{id} \longrightarrow & f_*f^* \longrightarrow\longrightarrow & f_*f^*f_*f^* \longleftarrow\longrightarrow\longrightarrow\longrightarrow & f_*f^*f_*f^*f_*f^* \longleftarrow\longleftarrow\end{array}
$$
...
$$
\begin{array}{cccc}f^* \longrightarrow & f^*f_*f^* \longrightarrow\longrightarrow & f^*f_*f^*f_*f^* \longleftarrow\longrightarrow\longrightarrow\longrightarrow & f^*f_*f^*f_*f^*f_*f^* \longleftarrow\longleftarrow\end{array}
$$
...
\source{stacks:0FKS}
\href{https://stacks.math.columbia.edu/tag/0FKS}{\texttt{Stacks tag 0FKS}}
\group{cohomology}
...
\begin{lemma}[Godement resolution bounded below]
\label{cohomology-lemma-godement-resolution-bounded-below}
\source{stacks:0FKT}
\href{https://stacks.math.columbia.edu/tag/0FKT}{\texttt{Stacks tag 0FKT}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-godement-resolution}
...
Arguing exactly as in the proof of
Lemma \ref{cohomology-lemma-godement-resolution}
we get a resolution
$$
0 \to
\mathcal{F}^\bullet \to
...
as in Remark \ref{cohomology-remark-cup-product} via $D(pt, A) = D(A)$.
...
\begin{lemma}[Second cup equals first]
\label{cohomology-lemma-second-cup-equals-first}
\source{stacks:0FP2}
\href{https://stacks.math.columbia.edu/tag/0FP2}{\texttt{Stacks tag 0FP2}}
\group{cohomology}
...
\begin{remark}[Cup with element map total cohomology]
\label{cohomology-remark-cup-with-element-map-total-cohomology}
\source{stacks:0G6W}
\href{https://stacks.math.columbia.edu/tag/0G6W}{\texttt{Stacks tag 0G6W}}
\group{cohomology}

\uses{cohomology-lemma-second-cup-equals-first}
Let $(X, \mathcal{O}_X)$ be a ringed space. Let $K, M$ be objects
of $D(\mathcal{O}_X)$. Set $A = \Gamma(X, \mathcal{O}_X)$.
...
proof of Lemma \ref{cohomology-lemma-second-cup-equals-first}
...
from Lemma \ref{cohomology-lemma-second-cup-equals-first} and its proof.
\end{remark}
...
\begin{lemma}[Cup compatible with naive]
\label{cohomology-lemma-cup-compatible-with-naive}
\source{stacks:0FP3}
\href{https://stacks.math.columbia.edu/tag/0FP3}{\texttt{Stacks tag 0FP3}}
\group{cohomology}

\uses{cohomology-remark-cup-product}
In the situation above the following diagram commutes
$$
\begin{array}{cc}f_*\mathcal{K}^\bullet
\otimes_{\mathcal{O}_Y}^\mathbf{L}
f_*\mathcal{M}^\bullet \longrightarrow\downarrow & Rf_*\mathcal{K}^\bullet
\otimes_{\mathcal{O}_Y}^\mathbf{L}
Rf_*\mathcal{M}^\bullet \overset{\text{Remark \ref{cohomology-remark-cup-product}}}{\downarrow} \\ \text{Tot}(
f_*\mathcal{K}^\bullet
\otimes_{\mathcal{O}_Y}
f_*\mathcal{M}^\bullet) \underset{\text{naive cup product}}{\downarrow} & Rf_*(\mathcal{K}^\bullet
\otimes_{\mathcal{O}_X}^\mathbf{L}
\mathcal{M}^\bullet) \downarrow \\ f_*\text{Tot}(\mathcal{K}^\bullet
\otimes_{\mathcal{O}_X}
\mathcal{M}^\bullet) \longrightarrow & Rf_*\text{Tot}(\mathcal{K}^\bullet
\otimes_{\mathcal{O}_X}
\mathcal{M}^\bullet)\end{array}
$$
\end{lemma}

\begin{proof}
\uses{cohomology-remark-cup-product, cohomology-lemma-adjoints-push-pull-compatibility, cohomology-lemma-tensor-pull-compatibility}

By the construction in Remark \ref{cohomology-remark-cup-product} we see that
...
\mathcal{M}^\bullet)
\end{align*}
By Lemma \ref{cohomology-lemma-adjoints-push-pull-compatibility} this is also equal to
\begin{align*}
Lf^*(f_*\mathcal{K}^\bullet
\otimes_{\mathcal{O}_Y}^\mathbf{L}
f_*\mathcal{M}^\bullet)
...
$$
\begin{array}{ccc}Lf^*(f_*\mathcal{K}^\bullet
\otimes_{\mathcal{O}_Y}^\mathbf{L}
f_*\mathcal{M}^\bullet) \downarrow\longrightarrow &  & Lf^*f_*\mathcal{K}^\bullet \otimes_{\mathcal{O}_X}^\mathbf{L}
Lf^*f_*\mathcal{M}^\bullet \downarrow \\ Lf^*\text{Tot}(
f_*\mathcal{K}^\bullet
\otimes_{\mathcal{O}_Y}
f_*\mathcal{M}^\bullet) \underset{naive}{\downarrow}\longrightarrow & f^*\text{Tot}(
f_*\mathcal{K}^\bullet
\otimes_{\mathcal{O}_Y}
f_*\mathcal{M}^\bullet) \overset{naive}{\swarrow}\downarrow & f^*f_*\mathcal{K}^\bullet \otimes_{\mathcal{O}_X}^\mathbf{L}
f^*f_*\mathcal{M}^\bullet \downarrow\swarrow \\ Lf^*f_*\text{Tot}(\mathcal{K}^\bullet
\otimes_{\mathcal{O}_X}
\mathcal{M}^\bullet) \downarrow &  &  \\ f^*f_*\text{Tot}(\mathcal{K}^\bullet \otimes_{\mathcal{O}_X}
\mathcal{M}^\bullet) \searrow & \text{Tot}(f^*f_*\mathcal{K}^\bullet \otimes_{\mathcal{O}_X}
f^*f_*\mathcal{M}^\bullet) \downarrow & \mathcal{K}^\bullet \otimes_{\mathcal{O}_X}^\mathbf{L}
\mathcal{M}^\bullet \swarrow \\  & \text{Tot}(\mathcal{K}^\bullet
\otimes_{\mathcal{O}_X}
\mathcal{M}^\bullet) & \end{array}
$$
All of the polygons in this diagram commute. The top one commutes
by Lemma \ref{cohomology-lemma-tensor-pull-compatibility}.
...
$$
By Lemma \ref{cohomology-lemma-cup-compatible-with-naive}
...
$$
\begin{array}{cc}\Gamma(X, \mathcal{K}^\bullet)
\otimes_A^\mathbf{L}
\Gamma(X, \mathcal{M}^\bullet) \downarrow\longrightarrow & R\Gamma(X, \mathcal{K}^\bullet)
\otimes_A^\mathbf{L}
R\Gamma(X, \mathcal{M}^\bullet) \overset{\mu}{\downarrow} \\ \text{Tot}(\Gamma(X, \mathcal{K}^\bullet)
\otimes_A
\Gamma(X, \mathcal{M}^\bullet)) \underset{\mu'}{\downarrow} & R\Gamma(X, \mathcal{K}^\bullet
\otimes_{\mathcal{O}_X}^\mathbf{L}
\mathcal{M}^\bullet) \downarrow \\ \Gamma(X, \text{Tot}(\mathcal{K}^\bullet
\otimes_{\mathcal{O}_X}
\mathcal{M}^\bullet)) \longrightarrow & R\Gamma(X, \text{Tot}(\mathcal{K}^\bullet
\otimes_{\mathcal{O}_X}
\mathcal{M}^\bullet))\end{array}
$$
in $D(A)$. On cohomology we obtain the commutative diagram
$$
\begin{array}{cc}H^i(\Gamma(X, \mathcal{K}^\bullet)) \times
H^j(\Gamma(X, \mathcal{M}^\bullet)) \downarrow\longrightarrow & H^{i + j}(X,
\text{Tot}(\mathcal{K}^\bullet \otimes_{\mathcal{O}_X} \mathcal{M}^\bullet)) \\ H^i(X, \mathcal{K}^\bullet) \times
H^j(X, \mathcal{M}^\bullet) \overset{\cup}{\longrightarrow} & H^{i + j}(X, \mathcal{K}^\bullet \otimes_{\mathcal{O}_X}^\mathbf{L}
\mathcal{M}^\bullet) \uparrow\end{array}
$$
relating the naive cup product with the actual cuproduct.

\begin{lemma}[Diagrams commute]
\label{cohomology-lemma-diagrams-commute}
\source{stacks:0FKV}
\href{https://stacks.math.columbia.edu/tag/0FKV}{\texttt{Stacks tag 0FKV}}
\group{cohomology}
...
Then
$$
\begin{array}{cc}\text{Tot}(\check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{K}^\bullet))
\otimes_A^\mathbf{L}
\text{Tot}(\check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{M}^\bullet))
\downarrow\longrightarrow & R\Gamma(X, \mathcal{K}^\bullet)
\otimes_A^\mathbf{L}
R\Gamma(X, \mathcal{M}^\bullet) \overset{\mu}{\downarrow} \\ \text{Tot}(
\text{Tot}(\check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{K}^\bullet))
\otimes_A
\text{Tot}(\check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{M}^\bullet)))
\overset{(\ref{equation-needs-signs})}{\downarrow} & R\Gamma(X,
...
)) \longrightarrow & R\Gamma(X,
\text{Tot}(\mathcal{K}^\bullet \otimes_{\mathcal{O}_X} \mathcal{M}^\bullet))\end{array}
$$
where the horizontal arrows are the ones in
Lemma \ref{cohomology-lemma-cech-complex-complex}
commutes in $D(A)$.
\end{lemma}

\begin{proof}
\uses{cohomology-lemma-godement-resolution-bounded-below, cohomology-lemma-flasque-acyclic, cohomology-lemma-cech-complex-complex-computes, cohomology-lemma-cup-compatible-with-naive}
...
as in Lemma \ref{cohomology-lemma-godement-resolution-bounded-below}.
...
\begin{array}{cc}\Gamma(X, \mathcal{K}^\bullet)
\otimes_A^\mathbf{L}
\Gamma(X, \mathcal{M}^\bullet) \downarrow\longrightarrow & \text{Tot}(\check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{K}^\bullet))
\otimes_A^\mathbf{L}
\text{Tot}(\check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{M}^\bullet))
\downarrow \\ \text{Tot}(\Gamma(X, \mathcal{K}^\bullet)
\otimes_A
\Gamma(X, \mathcal{M}^\bullet)) \downarrow\longrightarrow & \text{Tot}(
\text{Tot}(\check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{K}^\bullet))
\otimes_A
\text{Tot}(\check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{M}^\bullet)))
\overset{(\ref{equation-needs-signs})}{\downarrow} \\ \Gamma(X, \text{Tot}(\mathcal{K}^\bullet
\otimes_{\mathcal{O}_X}
\mathcal{M}^\bullet)) \longrightarrow & \text{Tot}(
\check{\mathcal{C}}^\bullet({\mathcal U},
\text{Tot}(\mathcal{K}^\bullet \otimes_{\mathcal{O}_X} \mathcal{M}^\bullet)
))\end{array}
$$
...
Lemma \ref{cohomology-lemma-cech-complex-complex-computes}.
Hence the commutativity of the diagram of the lemma involving
(\ref{equation-needs-signs}) follows from the already proven
commutativity of Lemma \ref{cohomology-lemma-cup-compatible-with-naive}
where $f$ is the morphism to a point (see discussion
following Lemma \ref{cohomology-lemma-cup-compatible-with-naive}).
\end{proof}

\begin{lemma}[Cup product associative]
\label{cohomology-lemma-cup-product-associative}
\source{stacks:0FP4}
\href{https://stacks.math.columbia.edu/tag/0FP4}{\texttt{Stacks tag 0FP4}}
\group{cohomology}

\uses{cohomology-remark-cup-product}
Let $f : (X, \mathcal{O}_X) \to (Y, \mathcal{O}_Y)$
be a morphism of ringed spaces. The relative cup product of
Remark \ref{cohomology-remark-cup-product} is associative in the sense that
the diagram
$$
\begin{array}{cc}Rf_*K \otimes_{\mathcal{O}_Y}^\mathbf{L}
Rf_*L \otimes_{\mathcal{O}_Y}^\mathbf{L}
Rf_*M \longrightarrow\downarrow & Rf_*(K \otimes_{\mathcal{O}_X}^\mathbf{L} L)
\otimes_{\mathcal{O}_Y}^\mathbf{L} Rf_*M \downarrow \\ Rf_*K \otimes_{\mathcal{O}_Y}^\mathbf{L}
Rf_*(L \otimes_{\mathcal{O}_X}^\mathbf{L} M) \longrightarrow & Rf_*(K \otimes_{\mathcal{O}_X}^\mathbf{L}
L \otimes_{\mathcal{O}_X}^\mathbf{L} M)\end{array}
$$
...
\begin{lemma}[Cup product commutative]
\label{cohomology-lemma-cup-product-commutative}
\source{stacks:0FP5}
\href{https://stacks.math.columbia.edu/tag/0FP5}{\texttt{Stacks tag 0FP5}}
\group{cohomology}

\uses{cohomology-remark-cup-product, cohomology-lemma-symmetric-monoidal-derived}
Let $f : (X, \mathcal{O}_X) \to (Y, \mathcal{O}_Y)$
be a morphism of ringed spaces. The relative cup product of
Remark \ref{cohomology-remark-cup-product} is commutative in the sense that
the diagram
$$
\begin{array}{cc}Rf_*K \otimes_{\mathcal{O}_Y}^\mathbf{L} Rf_*L \longrightarrow\underset{\psi}{\downarrow} & Rf_*(K \otimes_{\mathcal{O}_X}^\mathbf{L} L) \overset{Rf_*\psi}{\downarrow} \\ Rf_*L \otimes_{\mathcal{O}_Y}^\mathbf{L} Rf_*K \longrightarrow & Rf_*(L \otimes_{\mathcal{O}_X}^\mathbf{L} K)\end{array}
$$
...
(Lemma \ref{cohomology-lemma-symmetric-monoidal-derived}).
\end{lemma}
...
\begin{lemma}[Compose cup product]
\label{cohomology-lemma-compose-cup-product}
\source{stacks:0FP6}
\href{https://stacks.math.columbia.edu/tag/0FP6}{\texttt{Stacks tag 0FP6}}
\group{cohomology}
...
Remark \ref{cohomology-remark-cup-product} is compatible with compositions
in the sense that the diagram
$$
\begin{array}{ccc}R(g \circ f)_*K \otimes_{\mathcal{O}_Z}^\mathbf{L} R(g \circ f)_*L
\xlongequal{}\downarrow &  & Rg_*Rf_*K \otimes_{\mathcal{O}_Z}^\mathbf{L} Rg_*Rf_*L \downarrow \\ R(g \circ f)_*(K \otimes_{\mathcal{O}_X}^\mathbf{L} L) \xlongequal{} & Rg_*Rf_*(K \otimes_{\mathcal{O}_X}^\mathbf{L} L) & Rg_*(Rf_*K \otimes_{\mathcal{O}_Y}^\mathbf{L}  Rf_*L) \longleftarrow\end{array}
$$
...
\begin{lemma}[Base change cup product]
\label{cohomology-lemma-base-change-cup-product}
\source{stacks:0H99}
\href{https://stacks.math.columbia.edu/tag/0H99}{\texttt{Stacks tag 0H99}}
\group{cohomology}

\uses{cohomology-remark-cup-product, cohomology-remark-base-change, cohomology-lemma-pullback-tensor-product}
Consider a commutative square
$$
\begin{array}{cc}(X', \mathcal{O}_{X'}) \underset{g'}{\longrightarrow}\underset{f'}{\downarrow} & (X, \mathcal{O}_X) \overset{f}{\downarrow} \\ (Y', \mathcal{O}_{Y'}) \overset{g}{\longrightarrow} & (Y, \mathcal{O}_Y)\end{array}
$$
...
$$
\begin{array}{cc}Lg^*(Rf_*K \otimes_{\mathcal{O}_Y}^\mathbf{L} Rf_*L)
\longrightarrow\downarrow & Lg^*(Rf_*(K \otimes_{\mathcal{O}_X}^\mathbf{L} L)) \downarrow \\ Lg^*Rf_*K \otimes_{\mathcal{O}_{Y'}}^\mathbf{L} Lg^*Rf_*L \downarrow & R(f')_*L(g')^*(K \otimes_{\mathcal{O}_X}^\mathbf{L} L) \downarrow \\ R(f')_*(L(g')^*K \otimes_{\mathcal{O}_{Y'}} R(f')_*(L(g')^*L \longrightarrow & R(f')_*(L(g')^*K \otimes_{\mathcal{O}_{X'}}^\mathbf{L} L(g')^*L)\end{array}
$$
is commutative in $D(\mathcal{O}_{Y'})$. The horizontal arrows are given
by the relative cup product (Remark \ref{cohomology-remark-cup-product})
and the vertical arrows are given
by the base change map (Remark \ref{cohomology-remark-base-change})
and Lemma \ref{cohomology-lemma-pullback-tensor-product}.
\end{lemma}
...
\begin{lemma}[Restrict K injective to open]
\label{cohomology-lemma-restrict-K-injective-to-open}
\source{stacks:08BS}
\href{https://stacks.math.columbia.edu/tag/08BS}{\texttt{Stacks tag 08BS}}
\group{cohomology}
...
\begin{lemma}[Unbounded cohomology of open]
\label{cohomology-lemma-unbounded-cohomology-of-open}
\source{stacks:0D5V}
\href{https://stacks.math.columbia.edu/tag/0D5V}{\texttt{Stacks tag 0D5V}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-restrict-K-injective-to-open}
...
$$
by construction of cohomology. By Lemma \ref{cohomology-lemma-restrict-K-injective-to-open}
the complex $\mathcal{I}^\bullet|_U$ is a K-injective complex
representing $K|_U$ and the lemma follows.
\end{proof}

\begin{lemma}[Sheafification cohomology]
\label{cohomology-lemma-sheafification-cohomology}
\source{stacks:0BKJ}
\href{https://stacks.math.columbia.edu/tag/0BKJ}{\texttt{Stacks tag 0BKJ}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-unbounded-cohomology-of-open}

The equality $H^q(U, K) = H^q(U, K|_U)$ holds by
Lemma \ref{cohomology-lemma-unbounded-cohomology-of-open}.
...
\begin{lemma}[Restrict direct image open]
\label{cohomology-lemma-restrict-direct-image-open}
\source{stacks:08FE}
\href{https://stacks.math.columbia.edu/tag/08FE}{\texttt{Stacks tag 08FE}}
\group{cohomology}
...
Lemma \ref{cohomology-lemma-restrict-K-injective-to-open}.
Since it is clear that $(f_*\mathcal{F})|_V = g_*(\mathcal{F}|_U)$
for any sheaf $\mathcal{F}$ on $X$ the result follows.
\end{proof}

\begin{lemma}[Leray unbounded]
\label{cohomology-lemma-Leray-unbounded}
\source{stacks:0D5W}
\href{https://stacks.math.columbia.edu/tag/0D5W}{\texttt{Stacks tag 0D5W}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-derived-pushforward-composition, cohomology-lemma-restrict-direct-image-open}
...
follows from Lemma \ref{cohomology-lemma-derived-pushforward-composition}
applied to $X \to Y \to Z$.

\medskip\noindent
The second (more general) statement follows from the first statement
after applying Lemma \ref{cohomology-lemma-restrict-direct-image-open}.
\end{proof}

\begin{lemma}[Unbounded describe higher direct images]
\label{cohomology-lemma-unbounded-describe-higher-direct-images}
\source{stacks:0D5X}
\href{https://stacks.math.columbia.edu/tag/0D5X}{\texttt{Stacks tag 0D5X}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-Leray-unbounded, cohomology-lemma-sheafification-cohomology}

The equality $H^i(f^{-1}(V), K) = H^i(V, Rf_*K)$ follows upon taking
cohomology from the second statement in
Lemma \ref{cohomology-lemma-Leray-unbounded}. Then the statement on sheafification
follows from Lemma \ref{cohomology-lemma-sheafification-cohomology}.
\end{proof}

\begin{lemma}[Modules abelian unbounded]
\label{cohomology-lemma-modules-abelian-unbounded}
\source{stacks:0D5Y}
\href{https://stacks.math.columbia.edu/tag/0D5Y}{\texttt{Stacks tag 0D5Y}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-unbounded-cohomology-of-open, cohomology-lemma-unbounded-describe-higher-direct-images, cohomology-lemma-derived-tor-quasi-isomorphism-other-side, cohomology-lemma-bounded-flat-K-flat}
...
By Lemmas \ref{cohomology-lemma-unbounded-cohomology-of-open} and
...
Derived Categories, Lemma \ref{derived-lemma-subcategory-left-resolution};
see discussion in Section \ref{cohomology-section-flat}.)
...
Lemmas \ref{cohomology-lemma-derived-tor-quasi-isomorphism-other-side} and
\ref{cohomology-lemma-bounded-flat-K-flat}.
We omit the detailed verification that this construction
is indeed an inverse.
\end{proof}

\begin{lemma}[Adjoint lower shriek restrict]
\label{cohomology-lemma-adjoint-lower-shriek-restrict}
\source{stacks:08BT}
\href{https://stacks.math.columbia.edu/tag/08BT}{\texttt{Stacks tag 08BT}}
\group{cohomology}
...
\begin{lemma}[K injective flat]
\label{cohomology-lemma-K-injective-flat}
\source{stacks:0D5Z}
\href{https://stacks.math.columbia.edu/tag/0D5Z}{\texttt{Stacks tag 0D5Z}}
\group{cohomology}
...
\begin{lemma}[Exact sequence lower shriek]
\label{cohomology-lemma-exact-sequence-lower-shriek}
\source{stacks:08BU}
\href{https://stacks.math.columbia.edu/tag/08BU}{\texttt{Stacks tag 08BU}}
\group{cohomology}
...
\begin{proof}
We have seen in Section \ref{cohomology-section-properties-K-injective}
...
\begin{lemma}[Exact sequence j star]
\label{cohomology-lemma-exact-sequence-j-star}
\source{stacks:08BV}
\href{https://stacks.math.columbia.edu/tag/08BV}{\texttt{Stacks tag 08BV}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-restrict-K-injective-to-open, cohomology-lemma-mayer-vietoris}
...
as well (Lemma \ref{cohomology-lemma-restrict-K-injective-to-open}). Hence
...
0
$$
is exact (see proof of Lemma \ref{cohomology-lemma-mayer-vietoris}).
\end{proof}

\begin{lemma}[Mayer vietoris hom]
\label{cohomology-lemma-mayer-vietoris-hom}
\source{stacks:08BW}
\href{https://stacks.math.columbia.edu/tag/08BW}{\texttt{Stacks tag 08BW}}
\group{cohomology}
...
$$
\begin{array}{ccc} & \ldots \longrightarrow & \Ext^{-1}(E_{U \cap V}, F_{U \cap V}) \swarrow \\ \Hom(E, F) \longrightarrow & \Hom(E_U, F_U) \oplus
\Hom(E_V, F_V) \longrightarrow & \Hom(E_{U \cap V}, F_{U \cap V})\end{array}
$$
...
\begin{proof}
\uses{cohomology-lemma-exact-sequence-lower-shriek, cohomology-lemma-adjoint-lower-shriek-restrict}

Use the distinguished triangle of
Lemma \ref{cohomology-lemma-exact-sequence-lower-shriek}
...
$$
by Lemma \ref{cohomology-lemma-adjoint-lower-shriek-restrict}.
\end{proof}

\begin{lemma}[Unbounded mayer vietoris]
\label{cohomology-lemma-unbounded-mayer-vietoris}
\source{stacks:08BX}
\href{https://stacks.math.columbia.edu/tag/08BX}{\texttt{Stacks tag 08BX}}
\group{cohomology}
...
Lemma \ref{cohomology-lemma-mayer-vietoris}.
The final statement follows from the functoriality of the construction
in Injectives, Theorem
\ref{injectives-theorem-K-injective-embedding-grothendieck}.
\end{proof}

\begin{lemma}[Unbounded relative mayer vietoris]
\label{cohomology-lemma-unbounded-relative-mayer-vietoris}
\source{stacks:08HZ}
\href{https://stacks.math.columbia.edu/tag/08HZ}{\texttt{Stacks tag 08HZ}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-restrict-K-injective-to-open, cohomology-lemma-relative-mayer-vietoris}
...
Lemma \ref{cohomology-lemma-relative-mayer-vietoris}
...
\begin{lemma}[Pushforward restriction]
\label{cohomology-lemma-pushforward-restriction}
\source{stacks:08DF}
\href{https://stacks.math.columbia.edu/tag/08DF}{\texttt{Stacks tag 08DF}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-restrict-direct-image-open}
...
supported on $T$. By
Lemma \ref{cohomology-lemma-restrict-direct-image-open} we have
...
\begin{lemma}[Mayer vietoris cup]
\label{cohomology-lemma-mayer-vietoris-cup}
\source{stacks:0G6X}
\href{https://stacks.math.columbia.edu/tag/0G6X}{\texttt{Stacks tag 0G6X}}
\group{cohomology}

\uses{cohomology-lemma-unbounded-mayer-vietoris}
...
$$
\begin{array}{cc}R\Gamma(X, K) \otimes_A^\mathbf{L} R\Gamma(X, M) \longrightarrow\downarrow & R\Gamma(X, K \otimes_{\mathcal{O}_X}^\mathbf{L} M) \downarrow \\ R\Gamma(X, K) \otimes_A^\mathbf{L}
(R\Gamma(U, M) \oplus R\Gamma(V, M)) \longrightarrow\downarrow & R\Gamma(U, K \otimes_{\mathcal{O}_X}^\mathbf{L} M)
\oplus R\Gamma(V, K \otimes_{\mathcal{O}_X}^\mathbf{L} M)) \downarrow \\ R\Gamma(X, K) \otimes_A^\mathbf{L} R\Gamma(U \cap V, M) \longrightarrow\downarrow & R\Gamma(U \cap V, K \otimes_{\mathcal{O}_X}^\mathbf{L} M) \downarrow \\ R\Gamma(X, K) \otimes_A^\mathbf{L} R\Gamma(X, M)[1] \longrightarrow & R\Gamma(X, K \otimes_{\mathcal{O}_X}^\mathbf{L} M)[1]\end{array}
$$
where
\begin{enumerate}
\item the horizontal arrows are given by cup product,
\item on the right hand side we have the distinguished triangle
of Lemma \ref{cohomology-lemma-unbounded-mayer-vietoris} for
...
distinguished triangle of Lemma \ref{cohomology-lemma-unbounded-mayer-vietoris} for $M$.
\end{enumerate}
\end{lemma}

\begin{proof}
\uses{cohomology-lemma-pullback-K-flat, cohomology-lemma-factor-through-K-flat, cohomology-lemma-mayer-vietoris, cohomology-lemma-unbounded-mayer-vietoris}
...
Lemma \ref{cohomology-lemma-pullback-K-flat} and
Modules, Lemma \ref{modules-lemma-pullback-flat}.
By Lemma \ref{cohomology-lemma-factor-through-K-flat} we can find a morphism of complexes
$$
...
$$
\begin{array}{cc}0 \downarrow & 0 \downarrow \\ \text{Tot}(T^\bullet \otimes_A \mathcal{I}^\bullet(X)) \downarrow\longrightarrow & \mathcal{J}^\bullet(X) \downarrow \\ \text{Tot}(T^\bullet \otimes_A
(\mathcal{I}^\bullet(U) \oplus \mathcal{I}^\bullet(V)) \downarrow\longrightarrow & \mathcal{J}^\bullet(U) \oplus \mathcal{J}^\bullet(V) \downarrow \\ \text{Tot}(T^\bullet \otimes_A \mathcal{I}^\bullet(U \cap V)) \longrightarrow\downarrow & \mathcal{J}^\bullet(U \cap V) \downarrow \\ 0 & 0\end{array}
$$
By the proof of Lemma \ref{cohomology-lemma-mayer-vietoris} the columns are
...
of Lemma \ref{cohomology-lemma-unbounded-mayer-vietoris}
...
and
Modules, Lemma \ref{modules-lemma-support-section-closed}.
Using K-injective resolutions, see Section \ref{cohomology-section-unbounded},
...
(Lemma \ref{cohomology-lemma-sections-support-abelian-unbounded}) that this
agrees with the construction in Section \ref{cohomology-section-cohomology-support}.
...
\source{stacks:0A3B}
\href{https://stacks.math.columbia.edu/tag/0A3B}{\texttt{Stacks tag 0A3B}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-K-injective-flat}
...
Lemma \ref{cohomology-lemma-K-injective-flat}
...
\source{stacks:0AEF}
\href{https://stacks.math.columbia.edu/tag/0AEF}{\texttt{Stacks tag 0AEF}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-cohomology-with-support-sheaf-on-support}

Part (1) is immediate from the definitions. Part (3) is a formal
consequence of part (2) and
Lemma \ref{cohomology-lemma-cohomology-with-support-sheaf-on-support}.
...
\begin{lemma}[Sections with support K injective]
\label{cohomology-lemma-sections-with-support-K-injective}
\source{stacks:0G6Z}
\href{https://stacks.math.columbia.edu/tag/0G6Z}{\texttt{Stacks tag 0G6Z}}
\group{cohomology}
...
\begin{lemma}[Local to global sections with support]
\label{cohomology-lemma-local-to-global-sections-with-support}
\source{stacks:0G70}
\href{https://stacks.math.columbia.edu/tag/0G70}{\texttt{Stacks tag 0G70}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-sections-with-support-K-injective}

Follows from the construction of right derived functors using
K-injective resolutions, Lemma \ref{cohomology-lemma-sections-with-support-K-injective},
and the fact that $\Gamma_Z(X, -) = \Gamma(Z, -) \circ \mathcal{H}_Z$.
\end{proof}

\begin{lemma}[Triangle sections with support]
\label{cohomology-lemma-triangle-sections-with-support}
\source{stacks:0G71}
\href{https://stacks.math.columbia.edu/tag/0G71}{\texttt{Stacks tag 0G71}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-restrict-K-injective-to-open, cohomology-lemma-injective-restriction-surjective}

Choose a K-injective complex $\mathcal{I}^\bullet$ all of whose terms
are injective $\mathcal{O}_X$-modules representing $K$. See
Section \ref{cohomology-section-unbounded}. Recall that $\mathcal{I}^\bullet|_U$
is a K-injective complex of $\mathcal{O}_U$-modules, see
Lemma \ref{cohomology-lemma-restrict-K-injective-to-open}. Hence each
...
$$
This follows from Lemma \ref{cohomology-lemma-injective-restriction-surjective}
and the definitions.
\end{proof}

\begin{lemma}[Triangle sections with support sheaves]
\label{cohomology-lemma-triangle-sections-with-support-sheaves}
\source{stacks:0G72}
\href{https://stacks.math.columbia.edu/tag/0G72}{\texttt{Stacks tag 0G72}}
\group{cohomology}
...
\begin{lemma}[Sections support in closed disjoint open]
\label{cohomology-lemma-sections-support-in-closed-disjoint-open}
\source{stacks:0G73}
\href{https://stacks.math.columbia.edu/tag/0G73}{\texttt{Stacks tag 0G73}}
\group{cohomology}
...
Lemma \ref{cohomology-lemma-K-injective-flat} the complex $j_*\mathcal{I}^\bullet$ is a
...
\begin{lemma}[Sections support abelian unbounded]
\label{cohomology-lemma-sections-support-abelian-unbounded}
\source{stacks:0G74}
\href{https://stacks.math.columbia.edu/tag/0G74}{\texttt{Stacks tag 0G74}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-modules-abelian-unbounded, cohomology-lemma-triangle-sections-with-support, cohomology-lemma-triangle-sections-with-support-sheaves}
...
maps of Lemma \ref{cohomology-lemma-modules-abelian-unbounded}
fit into a morphism of distinguished triangles
$$
\begin{array}{ccc}R\Gamma_Z(X, K) \longrightarrow\downarrow & R\Gamma(X, K) \longrightarrow\downarrow & R\Gamma(U, K) \downarrow \\ R\Gamma_Z(X, K_{ab}) \longrightarrow & R\Gamma(X, K_{ab}) \longrightarrow & R\Gamma(U, K_{ab})\end{array}
$$
of Lemma \ref{cohomology-lemma-triangle-sections-with-support}.
...
Lemma \ref{cohomology-lemma-triangle-sections-with-support-sheaves}
for the distinguished triangle.
\end{proof}

\begin{remark}[Support cup product]
\label{cohomology-remark-support-cup-product}
\source{stacks:0G75}
\href{https://stacks.math.columbia.edu/tag/0G75}{\texttt{Stacks tag 0G75}}
\group{cohomology}

\uses{cohomology-lemma-cohomology-with-support-sheaf-on-support, cohomology-lemma-pullback-K-flat}
Let $(X, \mathcal{O}_X)$ be a ringed space. Let $i : Z \to X$
...
Lemma \ref{cohomology-lemma-cohomology-with-support-sheaf-on-support} to construct this
...
Lemma \ref{cohomology-lemma-pullback-K-flat}. Hence we need to produce a map
of complexes
$$
i_*\text{Tot}\left(
...
\begin{remark}[Support cup product global]
\label{cohomology-remark-support-cup-product-global}
\source{stacks:0G76}
\href{https://stacks.math.columbia.edu/tag/0G76}{\texttt{Stacks tag 0G76}}
\group{cohomology}

\uses{cohomology-remark-support-cup-product, cohomology-lemma-local-to-global-sections-with-support}
With notation as in Remark \ref{cohomology-remark-support-cup-product}
...
Lemma \ref{cohomology-lemma-local-to-global-sections-with-support},
the first arrow is restriction to $Z$, the second
arrow is the cup product (Section \ref{cohomology-section-cup-product}),
and the third arrow is the map from Remark \ref{cohomology-remark-support-cup-product}.
\end{remark}

\begin{lemma}[Support cup product]
\label{cohomology-lemma-support-cup-product}
\source{stacks:0G77}
\href{https://stacks.math.columbia.edu/tag/0G77}{\texttt{Stacks tag 0G77}}
\group{cohomology}

\uses{cohomology-remark-support-cup-product, cohomology-remark-support-cup-product-global}
With notation as in Remark \ref{cohomology-remark-support-cup-product} the diagram
$$
\begin{array}{cc}H^i(X, K) \times H^j_Z(X, M) \longrightarrow\downarrow & H^{i + j}_Z(X, K \otimes_{\mathcal{O}_X}^\mathbf{L} M) \downarrow \\ H^i(X, K) \times H^j(X, M) \longrightarrow & H^{i + j}(X, K \otimes_{\mathcal{O}_X}^\mathbf{L} M)\end{array}
$$
commutes where the top horizontal arrow is the cup product of
Remark \ref{cohomology-remark-support-cup-product-global}.
\end{lemma}
...
\begin{remark}[Support functorial]
\label{cohomology-remark-support-functorial}
\source{stacks:0G78}
\href{https://stacks.math.columbia.edu/tag/0G78}{\texttt{Stacks tag 0G78}}
\group{cohomology}

\uses{cohomology-lemma-complexes-with-support-on-closed, cohomology-remark-base-change, cohomology-lemma-cohomology-with-support-sheaf-on-support}
...
Lemma \ref{cohomology-lemma-complexes-with-support-on-closed} part (2)
...
Remark \ref{cohomology-remark-base-change} is an isomorphism in this case
...
$$
\begin{array}{ccc}Lf^* i_* R\mathcal{H}_Z(K) \longrightarrow\searrow &  & i'_* R\mathcal{H}_{Z'}(Lf^*K) \swarrow \\  & Lf^*K & \end{array}
$$
...
(Lemma \ref{cohomology-lemma-cohomology-with-support-sheaf-on-support}). Since the
adjunction mapping $i'_* R\mathcal{H}_{Z'}(Lf^*K) \to Lf^*K$ is universal by
Lemma \ref{cohomology-lemma-complexes-with-support-on-closed} part (3), we find that
the south-east arrow factors uniquely over the south-west arrow and
we obtain the desired arrow.
\end{remark}

\begin{lemma}[Support functorial]
\label{cohomology-lemma-support-functorial}
\source{stacks:0G79}
\href{https://stacks.math.columbia.edu/tag/0G79}{\texttt{Stacks tag 0G79}}
\group{cohomology}

\uses{cohomology-remark-support-functorial}
With notation and assumptions as in Remark \ref{cohomology-remark-support-functorial}
the diagram
$$
\begin{array}{cc}H^p_Z(X, K) \longrightarrow\downarrow & H^p_{Z'}(X', Lf^*K) \downarrow \\ H^p(X, K) \longrightarrow & H^p(X', Lf^*K)\end{array}
$$
...
and the map constructed in Remark \ref{cohomology-remark-support-functorial}.
\end{lemma}
...
used to define the map of Remark \ref{cohomology-remark-support-functorial}.
\end{proof}
...
\begin{lemma}[ML general]
\label{cohomology-lemma-ML-general}
\source{stacks:0GYK}
\href{https://stacks.math.columbia.edu/tag/0GYK}{\texttt{Stacks tag 0GYK}}
\group{cohomology}
...
$$
\begin{array}{ccccc}0 \longrightarrow & I^n\mathcal{F}_{n + 1} \underset{f}{\downarrow}\longrightarrow & \mathcal{F}_{n + 1} \underset{f}{\downarrow}\longrightarrow & \mathcal{F}_n \underset{f}{\downarrow}\longrightarrow & 0 \\ 0 \longrightarrow & I^{n + m}\mathcal{F}_{n + m + 1} \longrightarrow & \mathcal{F}_{n + m + 1} \longrightarrow & \mathcal{F}_{n + m} \longrightarrow & 0\end{array}
$$
...
\begin{lemma}[ML general better]
\label{cohomology-lemma-ML-general-better}
\source{stacks:0GYL}
\href{https://stacks.math.columbia.edu/tag/0GYL}{\texttt{Stacks tag 0GYL}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-ML-general}

The proof is exactly the same as the proof of Lemma \ref{cohomology-lemma-ML-general}.
...
$$
\begin{array}{ccccc}0 \longrightarrow & I^n\mathcal{F}_{m + 1} \underset{f}{\downarrow}\longrightarrow & \mathcal{F}_{m + 1} \underset{f}{\downarrow}\longrightarrow & \mathcal{F}_n \underset{f}{\downarrow}\longrightarrow & 0 \\ 0 \longrightarrow & I^{n + k}\mathcal{F}_{m + 1} \longrightarrow & \mathcal{F}_{m + 1} \longrightarrow & \mathcal{F}_{n + k} \longrightarrow & 0\end{array}
$$
constructed as in the proof of Lemma \ref{cohomology-lemma-ML-general}.
...
$$
\begin{array}{ccccc}0 \longrightarrow & I^n\mathcal{F}_{m + 1} \downarrow\longrightarrow & \mathcal{F}_{m + 1} \downarrow\longrightarrow & \mathcal{F}_n \downarrow\longrightarrow & 0 \\ 0 \longrightarrow & I^n\mathcal{F}_{n + 1} \longrightarrow & \mathcal{F}_{n + 1} \longrightarrow & \mathcal{F}_n \longrightarrow & 0\end{array}
$$
for $m \geq n$. Looking at the induced maps on cohomology we conclude.
\end{proof}

\begin{lemma}[Topology I adic general]
\label{cohomology-lemma-topology-I-adic-general}
\source{stacks:0GYM}
\href{https://stacks.math.columbia.edu/tag/0GYM}{\texttt{Stacks tag 0GYM}}
\group{cohomology}
...
\begin{lemma}[Topology I adic general better]
\label{cohomology-lemma-topology-I-adic-general-better}
\source{stacks:0GYN}
\href{https://stacks.math.columbia.edu/tag/0GYN}{\texttt{Stacks tag 0GYN}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-topology-I-adic-general, cohomology-lemma-ML-general-better}

The proof is exactly the same as the proof of
Lemma \ref{cohomology-lemma-topology-I-adic-general}.
In fact, the result will follow from the arguments given there
as soon as we show that
$\bigoplus N_n$ is a graded $\bigoplus_{n \geq 0} I^n/I^{n + 1}$-submodule
of $\bigoplus H^{p + 1}(X, I^n\mathcal{F}_{n + 1})$
...
In the proof of Lemma \ref{cohomology-lemma-ML-general-better}
...
Section \ref{cohomology-section-inverse-systems}
in the setting where the ideal is principal.

\begin{lemma}[Equivalent f good]
\label{cohomology-lemma-equivalent-f-good}
\source{stacks:0H39}
\href{https://stacks.math.columbia.edu/tag/0H39}{\texttt{Stacks tag 0H39}}
\group{cohomology}
...
\begin{lemma}[Topology I adic f]
\label{cohomology-lemma-topology-I-adic-f}
\source{stacks:0EHA}
\href{https://stacks.math.columbia.edu/tag/0EHA}{\texttt{Stacks tag 0EHA}}
\group{cohomology}

\uses{cohomology-lemma-equivalent-f-good}
Suppose $X$, $f$, $(\mathcal{F}_n)$ satisfy condition (1) of
Lemma \ref{cohomology-lemma-equivalent-f-good}. Let $p \geq 0$ and set
...
\begin{lemma}[Limit finite]
\label{cohomology-lemma-limit-finite}
\source{stacks:0BLB}
\href{https://stacks.math.columbia.edu/tag/0BLB}{\texttt{Stacks tag 0BLB}}
\group{cohomology}
...
Lemma \ref{cohomology-lemma-equivalent-f-good}.
\end{enumerate}
Then
$$
...
\begin{proof}
\uses{cohomology-lemma-topology-I-adic-f, cohomology-lemma-equivalent-f-good}

By Lemma \ref{cohomology-lemma-topology-I-adic-f} we have
...
\source{stacks:0BLC}
\href{https://stacks.math.columbia.edu/tag/0BLC}{\texttt{Stacks tag 0BLC}}
\group{cohomology}
...
Set $I = (f)$. We will use the criterion of Lemma \ref{cohomology-lemma-ML-general}.
...
\begin{lemma}[ML better]
\label{cohomology-lemma-ML-better}
\source{stacks:0DXG}
\href{https://stacks.math.columbia.edu/tag/0DXG}{\texttt{Stacks tag 0DXG}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-ML-general-better, cohomology-lemma-ML}

Set $I = (f)$. We will use the criterion of Lemma \ref{cohomology-lemma-ML-general-better}
...
Thus we conclude exactly as in the proof of Lemma \ref{cohomology-lemma-ML}.
\end{proof}

\begin{remark}[Compare ML]
\label{cohomology-remark-compare-ML}
\source{stacks:0H3A}
\href{https://stacks.math.columbia.edu/tag/0H3A}{\texttt{Stacks tag 0H3A}}
\group{cohomology}
...
\begin{lemma}[RGamma commutes with Rlim]
\label{cohomology-lemma-RGamma-commutes-with-Rlim}
\source{stacks:0D60}
\href{https://stacks.math.columbia.edu/tag/0D60}{\texttt{Stacks tag 0D60}}
\group{cohomology}
...
\source{stacks:0BKP}
\href{https://stacks.math.columbia.edu/tag/0BKP}{\texttt{Stacks tag 0BKP}}
\group{cohomology}
...
Injectives, Lemma \ref{injectives-lemma-derived-products}).
However, since $Rf_*$ is a right adjoint by Lemma \ref{cohomology-lemma-adjoint}
...
\begin{remark}[Discuss derived limit]
\label{cohomology-remark-discuss-derived-limit}
\source{stacks:0BKQ}
\href{https://stacks.math.columbia.edu/tag/0BKQ}{\texttt{Stacks tag 0BKQ}}
\group{cohomology}

\uses{cohomology-lemma-sheafification-cohomology, cohomology-lemma-RGamma-commutes-with-Rlim}
...
By Lemma \ref{cohomology-lemma-sheafification-cohomology} we see that
...
Here is a diagram
$$
\begin{array}{ccc}K \downarrow & \underline{\mathcal{H}}^m \downarrow\longrightarrow & \mathcal{H}^m \downarrow \\ R\lim K_n & \lim \underline{\mathcal{H}}^m_n \longrightarrow & \lim \mathcal{H}^m_n\end{array}
$$
...
\begin{proof}
\uses{cohomology-remark-discuss-derived-limit}

Set $K_n = \mathcal{F}_n$ and $K = R\lim \mathcal{F}_n$. Using the notation
of Remark \ref{cohomology-remark-discuss-derived-limit} and assumption (2) we see that for
...
\begin{lemma}[Cohomology derived limit injective]
\label{cohomology-lemma-cohomology-derived-limit-injective}
\source{stacks:0D61}
\href{https://stacks.math.columbia.edu/tag/0D61}{\texttt{Stacks tag 0D61}}
\group{cohomology}
...
(by Lemma \ref{cohomology-lemma-sheafification-cohomology})
...
(by Lemma \ref{cohomology-lemma-sheafification-cohomology} again)
...
\lim H^m(U, K_n) \to 0
$$
of Lemma \ref{cohomology-lemma-RGamma-commutes-with-Rlim}.
...
\begin{lemma}[Is limit per point]
\label{cohomology-lemma-is-limit-per-point}
\source{stacks:0D62}
\href{https://stacks.math.columbia.edu/tag/0D62}{\texttt{Stacks tag 0D62}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-cohomology-derived-limit-injective}
...
(1) and (2) of Lemma \ref{cohomology-lemma-cohomology-derived-limit-injective}
...
\begin{lemma}[Is limit spaltenstein]
\label{cohomology-lemma-is-limit-spaltenstein}
\source{stacks:0D63}
\href{https://stacks.math.columbia.edu/tag/0D63}{\texttt{Stacks tag 0D63}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-is-limit-per-point}

This follows from Lemma \ref{cohomology-lemma-is-limit-per-point}
with $p(x, m) = d_x + \max(0, m)$.
\end{proof}

\begin{lemma}[Is limit]
\label{cohomology-lemma-is-limit}
\source{stacks:08U2}
\href{https://stacks.math.columbia.edu/tag/08U2}{\texttt{Stacks tag 08U2}}
\group{cohomology}
...
Apply Lemma \ref{cohomology-lemma-is-limit-per-point}
with $p(x, m) = p(m)$ and
$\mathfrak{U}_x = \{U \in \mathcal{B} \mid x \in U\}$.
\end{proof}

\begin{lemma}[Is limit dimension]
\label{cohomology-lemma-is-limit-dimension}
\source{stacks:0D64}
\href{https://stacks.math.columbia.edu/tag/0D64}{\texttt{Stacks tag 0D64}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-is-limit-spaltenstein}

Apply Lemma \ref{cohomology-lemma-is-limit-spaltenstein} with $d_x = d$
...
\begin{lemma}[Cohomology over U trivial]
\label{cohomology-lemma-cohomology-over-U-trivial}
\source{stacks:0BKT}
\href{https://stacks.math.columbia.edu/tag/0BKT}{\texttt{Stacks tag 0BKT}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-is-limit-dimension, cohomology-example-spectral-sequence}

Observe that $K = R\lim \tau_{\geq -n} K$ by
Lemma \ref{cohomology-lemma-is-limit-dimension} with $d = 0$.
...
Example \ref{cohomology-example-spectral-sequence}.
...
\begin{lemma}[Derived limit suitable system]
\label{cohomology-lemma-derived-limit-suitable-system}
\source{stacks:0BKU}
\href{https://stacks.math.columbia.edu/tag/0BKU}{\texttt{Stacks tag 0BKU}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-cohomology-over-U-trivial, cohomology-lemma-RGamma-commutes-with-Rlim}

Set $K = R\lim K_n$. Let $U \in \mathcal{B}$.
By Lemma \ref{cohomology-lemma-cohomology-over-U-trivial} and (2)(a)
we have $H^q(U, K_n) = H^0(U, H^q(K_n))$. By
Lemma \ref{cohomology-lemma-RGamma-commutes-with-Rlim} and (2)(b) we have
...
produce a diagram
$$
\begin{array}{ccc}\ldots \longrightarrow & \tau_{\geq -2}\mathcal{F}^\bullet \longrightarrow\downarrow & \tau_{\geq -1}\mathcal{F}^\bullet \downarrow \\ \ldots \longrightarrow & \mathcal{I}_2^\bullet \longrightarrow & \mathcal{I}_1^\bullet\end{array}
$$
...
\begin{lemma}[K injective]
\label{cohomology-lemma-K-injective}
\source{stacks:071B}
\href{https://stacks.math.columbia.edu/tag/071B}{\texttt{Stacks tag 071B}}
\group{cohomology}

\uses{cohomology-lemma-is-limit}
...
\begin{lemma}[Inverse limit complexes]
\label{cohomology-lemma-inverse-limit-complexes}
\source{stacks:08BY}
\href{https://stacks.math.columbia.edu/tag/08BY}{\texttt{Stacks tag 08BY}}
\group{cohomology}
...
This section continues the discussion in
Section \ref{cohomology-section-inverse-systems-bis}
using derived limits.

\begin{lemma}[Formal functions principal]
\label{cohomology-lemma-formal-functions-principal}
\source{stacks:0H3C}
\href{https://stacks.math.columbia.edu/tag/0H3C}{\texttt{Stacks tag 0H3C}}
\group{cohomology}
...
$$
\begin{array}{ccccc} & 0 & 0 &  &  \\ 0 \longrightarrow & \widehat{H^p(X, E)} \longrightarrow\uparrow & \lim H^p(X, E_n) \longrightarrow\uparrow & T_f(H^{p + 1}(X, E)) \longrightarrow & 0 \\ 0 \longrightarrow & H^0(H^p(X, E)^\wedge) \longrightarrow\uparrow & H^p(X, E^\wedge) \longrightarrow\uparrow & T_f(H^{p + 1}(X, E)) \longrightarrow\uparrow & 0 \\  & R^1\lim H^p(X, E)[f^n] \uparrow\overset{\cong}{\longrightarrow} & R^1\lim H^{p - 1}(X, E_n) \uparrow &  &  \\  & 0 \uparrow & 0 \uparrow &  & \end{array}
$$
...
\begin{proof}
\uses{cohomology-lemma-Rf-commutes-with-Rlim}

Observe that $R\Gamma(X, E^\wedge) = R\lim R\Gamma(X, E_n)$ by
Lemma \ref{cohomology-lemma-Rf-commutes-with-Rlim}.
On the other hand, we have
$$
R\Gamma(X, E_n) =
...
\begin{lemma}[Stabilizes]
\label{cohomology-lemma-stabilizes}
\source{stacks:0H3D}
\href{https://stacks.math.columbia.edu/tag/0H3D}{\texttt{Stacks tag 0H3D}}
\group{cohomology}
...
$$
\begin{array}{cc}M/M[f^c] \underset{f^{n + c}}{\longrightarrow}\underset{f^c}{\downarrow} & M \overset{1}{\downarrow} \\ M \overset{f^n}{\longrightarrow} & M\end{array}
$$
...
\begin{example}[Formal functions principal]
\label{cohomology-example-formal-functions-principal}
\source{stacks:0H3E}
\href{https://stacks.math.columbia.edu/tag/0H3E}{\texttt{Stacks tag 0H3E}}
\group{cohomology}

\uses{cohomology-lemma-formal-functions-principal, cohomology-lemma-stabilizes}
Let $(X, \mathcal{O}_X)$ be a ringed space. Let $A \to \Gamma(X, \mathcal{O}_X)$
...
Lemma \ref{cohomology-lemma-formal-functions-principal} with
$E = \mathcal{F}$. By Lemma \ref{cohomology-lemma-stabilizes} we see that
...
$$
\begin{array}{ccccc} & 0 & 0 &  &  \\ 0 \longrightarrow & \widehat{H^p(X, \mathcal{F})} \longrightarrow\uparrow & \lim H^p(X, \mathcal{F}/f^n\mathcal{F}) \longrightarrow\uparrow & T_f(H^{p + 1}(X, \mathcal{F})) \longrightarrow & 0 \\ 0 \longrightarrow & H^0(H^p(X, \mathcal{F})^\wedge) \longrightarrow\uparrow & H^p(R\Gamma(X, \mathcal{F})^\wedge) \longrightarrow\uparrow & T_f(H^{p + 1}(X, \mathcal{F})) \longrightarrow\uparrow & 0 \\  & R^1\lim H^p(X, \mathcal{F})[f^n] \uparrow\overset{\cong}{\longrightarrow} & R^1\lim H^{p - 1}(X, \mathcal{F}/f^n\mathcal{F}) \uparrow &  &  \\  & 0 \uparrow & 0 \uparrow &  & \end{array}
$$
...
\section{{\v C}
ech cohomology of unbounded complexes}
\label{cohomology-section-cech-cohomology-of-unbounded-complexes}

The construction of Section \ref{cohomology-section-cech-cohomology-of-complexes}
...
{\v C}ech complex
$\check{\mathcal{C}}_{alt}^\bullet(\mathcal{U}, \mathcal{F})$
(Section \ref{cohomology-section-alternating-cech})
is functorial in the presheaf $\mathcal{F}$ we obtain a double complex
...
\begin{lemma}[Alternating cech complex complex]
\label{cohomology-lemma-alternating-cech-complex-complex}
\source{stacks:08C1}
\href{https://stacks.math.columbia.edu/tag/08C1}{\texttt{Stacks tag 08C1}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-injective-trivial-cech, cohomology-lemma-alternating-usual}
...
Lemmas \ref{cohomology-lemma-injective-trivial-cech} and \ref{cohomology-lemma-alternating-usual}.
Suppose ${\mathcal F}^\bullet \to {\mathcal I}^\bullet$ is a quasi-isomorphism
...
\begin{lemma}[Alternating cech complex complex ss]
\label{cohomology-lemma-alternating-cech-complex-complex-ss}
\source{stacks:08C2}
\href{https://stacks.math.columbia.edu/tag/08C2}{\texttt{Stacks tag 08C2}}
\group{cohomology}

\uses{cohomology-lemma-alternating-cech-complex-complex}
Let $(X, \mathcal{O}_X)$ be a ringed space. Let
...
R\Gamma(X, \mathcal{F}^\bullet)
$$
of Lemma \ref{cohomology-lemma-alternating-cech-complex-complex}
is an isomorphism in $D(\textit{Ab})$.
\end{lemma}

\begin{proof}
\uses{cohomology-lemma-alternating-usual, cohomology-lemma-cech-complex-complex-computes, cohomology-lemma-K-injective}
...
\text{Tot}(\check{\mathcal{C}}^\bullet(\mathcal{U}, \mathcal{F}^\bullet))
$$
is a quasi-isomorphism by Lemma \ref{cohomology-lemma-alternating-usual}.
...
Lemma \ref{cohomology-lemma-cech-complex-complex-computes} and assumption (3)(a).

\medskip\noindent
In general, by assumption (3)(c) we may choose a resolution
$\mathcal{F}^\bullet \to \mathcal{I}^\bullet = \lim \mathcal{I}_n^\bullet$
as in Lemma \ref{cohomology-lemma-K-injective}.
...
\source{stacks:0A8M}
\href{https://stacks.math.columbia.edu/tag/0A8M}{\texttt{Stacks tag 0A8M}}
\group{cohomology}
...
\source{stacks:0A8N}
\href{https://stacks.math.columbia.edu/tag/0A8N}{\texttt{Stacks tag 0A8N}}
\group{cohomology}
...
\begin{lemma}[Diagonal better]
\label{cohomology-lemma-diagonal-better}
\source{stacks:0BYR}
\href{https://stacks.math.columbia.edu/tag/0BYR}{\texttt{Stacks tag 0BYR}}
\group{cohomology}
...
\source{stacks:0A8Q}
\href{https://stacks.math.columbia.edu/tag/0A8Q}{\texttt{Stacks tag 0A8Q}}
\group{cohomology}
...
\begin{lemma}[Evaluate and more]
\label{cohomology-lemma-evaluate-and-more}
\source{stacks:0A8P}
\href{https://stacks.math.columbia.edu/tag/0A8P}{\texttt{Stacks tag 0A8P}}
\group{cohomology}
...
\begin{lemma}[RHom into K injective]
\label{cohomology-lemma-RHom-into-K-injective}
\source{stacks:0A8R}
\href{https://stacks.math.columbia.edu/tag/0A8R}{\texttt{Stacks tag 0A8R}}
\group{cohomology}
...
is K-injective by Lemma \ref{cohomology-lemma-restrict-K-injective-to-open}.
\end{proof}

\begin{lemma}[RHom well defined]
\label{cohomology-lemma-RHom-well-defined}
\source{stacks:0A8S}
\href{https://stacks.math.columbia.edu/tag/0A8S}{\texttt{Stacks tag 0A8S}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-RHom-into-K-injective}
...
By Lemma \ref{cohomology-lemma-RHom-into-K-injective}
...
\begin{lemma}[RHom from K flat into K injective]
\label{cohomology-lemma-RHom-from-K-flat-into-K-injective}
\source{stacks:0A8T}
\href{https://stacks.math.columbia.edu/tag/0A8T}{\texttt{Stacks tag 0A8T}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-compose, cohomology-definition-K-flat}
...
The second equality by Lemma \ref{cohomology-lemma-compose}.
...
(Definition \ref{cohomology-definition-K-flat}) and because $\mathcal{I}^\bullet$
is K-injective.
\end{proof}
...
constructed in Section \ref{cohomology-section-hom-complexes}.
This is well defined by Lemma \ref{cohomology-lemma-RHom-well-defined}.
We get a functor
$$
...
\begin{lemma}[Section RHom over U]
\label{cohomology-lemma-section-RHom-over-U}
\source{stacks:08DK}
\href{https://stacks.math.columbia.edu/tag/08DK}{\texttt{Stacks tag 08DK}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-RHom-from-K-flat-into-K-injective, cohomology-lemma-RHom-into-K-injective}
...
$\SheafHom^\bullet(\mathcal{L}^\bullet, \mathcal{I}^\bullet)$
is K-injective by Lemma \ref{cohomology-lemma-RHom-from-K-flat-into-K-injective}.
Hence we can compute cohomology over $U$ by simply taking sections over $U$
and the result follows from Lemma \ref{cohomology-lemma-RHom-into-K-injective}.
\end{proof}

\begin{lemma}[Internal hom]
\label{cohomology-lemma-internal-hom}
\source{stacks:08DJ}
\href{https://stacks.math.columbia.edu/tag/08DJ}{\texttt{Stacks tag 08DJ}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-compose, cohomology-lemma-RHom-from-K-flat-into-K-injective, cohomology-lemma-section-RHom-over-U}
...
\mathcal{I}^\bullet)
$$
by Lemma \ref{cohomology-lemma-compose}.
Note that the left hand side represents
$R\SheafHom(K, R\SheafHom(L, M))$ (use
Lemma \ref{cohomology-lemma-RHom-from-K-flat-into-K-injective})
and that the right hand side represents
$R\SheafHom(K \otimes_{\mathcal{O}_X}^\mathbf{L} L, M)$.
This proves the displayed formula of the lemma.
Taking global sections and using Lemma \ref{cohomology-lemma-section-RHom-over-U}
we obtain (\ref{equation-internal-hom}).
\end{proof}

\begin{lemma}[Restriction RHom to U]
\label{cohomology-lemma-restriction-RHom-to-U}
\source{stacks:08DL}
\href{https://stacks.math.columbia.edu/tag/08DL}{\texttt{Stacks tag 08DL}}
\group{cohomology}
...
\begin{lemma}[RHom triangulated]
\label{cohomology-lemma-RHom-triangulated}
\source{stacks:08I0}
\href{https://stacks.math.columbia.edu/tag/08I0}{\texttt{Stacks tag 08I0}}
\group{cohomology}
...
\begin{lemma}[Internal hom composition]
\label{cohomology-lemma-internal-hom-composition}
\source{stacks:0A8V}
\href{https://stacks.math.columbia.edu/tag/0A8V}{\texttt{Stacks tag 0A8V}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-composition}
...
By Lemma \ref{cohomology-lemma-composition} there is a map of complexes
$$
\text{Tot}\left(
...
\begin{lemma}[Internal hom diagonal better]
\label{cohomology-lemma-internal-hom-diagonal-better}
\source{stacks:0BYS}
\href{https://stacks.math.columbia.edu/tag/0BYS}{\texttt{Stacks tag 0BYS}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-diagonal-better}
...
$$
where the first map is the map from Lemma \ref{cohomology-lemma-diagonal-better}.
\end{proof}

\begin{lemma}[Internal hom diagonal]
\label{cohomology-lemma-internal-hom-diagonal}
\source{stacks:0A8W}
\href{https://stacks.math.columbia.edu/tag/0A8W}{\texttt{Stacks tag 0A8W}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-diagonal}
...
$$
where the first map comes from Lemma \ref{cohomology-lemma-diagonal}.
\end{proof}

\begin{lemma}[Dual]
\label{cohomology-lemma-dual}
\source{stacks:08I1}
\href{https://stacks.math.columbia.edu/tag/08I1}{\texttt{Stacks tag 08I1}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-internal-hom-composition}

The map (\ref{equation-eval}) is a special case of
Lemma \ref{cohomology-lemma-internal-hom-composition}
using the identification $M = R\SheafHom(\mathcal{O}_X, M)$.
\end{proof}

\begin{lemma}[Internal hom evaluate]
\label{cohomology-lemma-internal-hom-evaluate}
\source{stacks:0A8U}
\href{https://stacks.math.columbia.edu/tag/0A8U}{\texttt{Stacks tag 0A8U}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-evaluate-and-more}
...
$$
of Lemma \ref{cohomology-lemma-evaluate-and-more}. By our particular
...
\begin{remark}[Tensor internal hom]
\label{cohomology-remark-tensor-internal-hom}
\source{stacks:0FXP}
\href{https://stacks.math.columbia.edu/tag/0FXP}{\texttt{Stacks tag 0FXP}}
\group{cohomology}
...
$$
from Lemma \ref{cohomology-lemma-internal-hom-composition} when thinking
of $K = R\SheafHom(\mathcal{O}_X, K)$ and similarly for
$K'$, $M$, and $M'$.
\end{remark}

\begin{remark}[Projection formula for internal hom]
\label{cohomology-remark-projection-formula-for-internal-hom}
\source{stacks:0B69}
\href{https://stacks.math.columbia.edu/tag/0B69}{\texttt{Stacks tag 0B69}}
\group{cohomology}

\uses{cohomology-remark-cup-product, cohomology-lemma-internal-hom-composition}
Let $f : X \to Y$ be a morphism of ringed spaces.
...
(Remark \ref{cohomology-remark-cup-product}) and the second arrow is $Rf_*$ applied
to the canonical map
$R\SheafHom(L, K) \otimes_{\mathcal{O}_X}^\mathbf{L} L \to K$
coming from Lemma \ref{cohomology-lemma-internal-hom-composition}
(with $\mathcal{O}_X$ in one of the spots).
\end{remark}

\begin{remark}[Relative cup and composition]
\label{cohomology-remark-relative-cup-and-composition}
\source{stacks:0G7A}
\href{https://stacks.math.columbia.edu/tag/0G7A}{\texttt{Stacks tag 0G7A}}
\group{cohomology}

\uses{cohomology-remark-projection-formula-for-internal-hom, cohomology-remark-cup-product, cohomology-lemma-internal-hom-composition}
Let $h : X \to Y$ be a morphism of ringed spaces.
Let $K, M$ be objects of $D(\mathcal{O}_Y)$.
The diagram
$$
\begin{array}{cc}Rf_*R\SheafHom_{\mathcal{O}_X}(K, M)
\otimes_{\mathcal{O}_Y}^\mathbf{L} Rf_*K
\longrightarrow\downarrow & Rf_*\left(R\SheafHom_{\mathcal{O}_X}(K, M)
\otimes_{\mathcal{O}_X}^\mathbf{L} K\right)
\downarrow \\ R\SheafHom_{\mathcal{O}_Y}(Rf_*K, Rf_*M) \otimes_{\mathcal{O}_Y}^\mathbf{L}
Rf_*K \longrightarrow & Rf_*M\end{array}
$$
is commutative. Here the left vertical arrow comes from
Remark \ref{cohomology-remark-projection-formula-for-internal-hom}.
The top horizontal arrow is Remark \ref{cohomology-remark-cup-product}.
The other two arrows are instances of the map in
Lemma \ref{cohomology-lemma-internal-hom-composition} (with one of the entries
replaced with $\mathcal{O}_X$ or $\mathcal{O}_Y$).
\end{remark}

\begin{remark}[Prepare fancy base change]
\label{cohomology-remark-prepare-fancy-base-change}
\source{stacks:08I3}
\href{https://stacks.math.columbia.edu/tag/08I3}{\texttt{Stacks tag 08I3}}
\group{cohomology}

\uses{cohomology-lemma-internal-hom, cohomology-lemma-pullback-tensor-product}
Let $h : X \to Y$ be a morphism of ringed spaces.
...
proved in Lemma \ref{cohomology-lemma-internal-hom}
...
by Lemma \ref{cohomology-lemma-pullback-tensor-product}
...
\begin{remark}[Fancy base change]
\label{cohomology-remark-fancy-base-change}
\source{stacks:08I4}
\href{https://stacks.math.columbia.edu/tag/08I4}{\texttt{Stacks tag 08I4}}
\group{cohomology}

\uses{cohomology-remark-prepare-fancy-base-change}
Suppose that
$$
\begin{array}{cc}X' \underset{h}{\longrightarrow}\underset{f'}{\downarrow} & X \overset{f}{\downarrow} \\ S' \overset{g}{\longrightarrow} & S\end{array}
$$
...
constructed in Remark \ref{cohomology-remark-prepare-fancy-base-change}.
\end{remark}
...
By Lemma \ref{cohomology-lemma-section-RHom-over-U}
we see that this $\SheafExt^n$-sheaf
is the sheafification of the rule
$$
U \longmapsto \Ext^n_{D(\mathcal{O}_U)}(K|_U, L|_U)
$$
By Example \ref{cohomology-example-spectral-sequence} there is always a spectral
sequence
$$
...
defined in Remark \ref{cohomology-remark-prepare-fancy-base-change}.
...
\source{stacks:08DG}
\href{https://stacks.math.columbia.edu/tag/08DG}{\texttt{Stacks tag 08DG}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-mayer-vietoris-hom}
...
Lemma \ref{cohomology-lemma-mayer-vietoris-hom}.
\end{proof}

\begin{lemma}[Vanishing and glueing]
\label{cohomology-lemma-vanishing-and-glueing}
\source{stacks:0D66}
\href{https://stacks.math.columbia.edu/tag/0D66}{\texttt{Stacks tag 0D66}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-unbounded-describe-higher-direct-images, cohomology-lemma-section-RHom-over-U}

Lemma \ref{cohomology-lemma-unbounded-describe-higher-direct-images} tells us
...
Lemma \ref{cohomology-lemma-section-RHom-over-U} to do the translation.
\end{proof}

\begin{definition}[Situation: Locally given]
\label{cohomology-situation-locally-given}
\source{stacks:0D67}
\href{https://stacks.math.columbia.edu/tag/0D67}{\texttt{Stacks tag 0D67}}
\group{cohomology}
...
\medskip\noindent
In Situation \ref{cohomology-situation-locally-given} a {\it solution}
...
\source{stacks:0D68}
\href{https://stacks.math.columbia.edu/tag/0D68}{\texttt{Stacks tag 0D68}}
\group{cohomology}

\uses{cohomology-situation-locally-given}
In Situation \ref{cohomology-situation-locally-given} assume
\begin{enumerate}
...
\begin{proof}
\uses{cohomology-lemma-vanishing-and-glueing}
...
Lemma \ref{cohomology-lemma-vanishing-and-glueing} part (2).
...
\source{stacks:0D69}
\href{https://stacks.math.columbia.edu/tag/0D69}{\texttt{Stacks tag 0D69}}
\group{cohomology}

\uses{cohomology-lemma-uniqueness}
With notation and assumptions as in Lemma \ref{cohomology-lemma-uniqueness}.
...
satisfying the assumptions of Lemma \ref{cohomology-lemma-uniqueness}.
...
diagram
$$
\begin{array}{ccc}K_U|_{U'} \underset{\rho_{U, V}|_{U'}}{\longrightarrow}\underset{\rho^U_{U'}}{\searrow} &  & K_V|_{U'} \overset{\rho^V_{U'}}{\swarrow} \\  & K_{U'} & \end{array}
$$
...
\begin{lemma}[Solution in finite case]
\label{cohomology-lemma-solution-in-finite-case}
\source{stacks:0D6A}
\href{https://stacks.math.columbia.edu/tag/0D6A}{\texttt{Stacks tag 0D6A}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-uniqueness, cohomology-remark-uniqueness, cohomology-lemma-glue}

Uniqueness was seen in Lemma \ref{cohomology-lemma-uniqueness}. We may prove the lemma
...
constructed in Remark \ref{cohomology-remark-uniqueness}.
By Lemma \ref{cohomology-lemma-glue} we obtain an object $K$ in $D(\mathcal{O}_X)$
...
described in Remark \ref{cohomology-remark-uniqueness} and the compatibility of
$\rho_{U_1}$ and $\rho_{U_2}$ with $\rho_{U_1, U_2}$. Having said this
we apply Lemma \ref{cohomology-lemma-uniqueness} to see that we obtain a unique
...
by Lemma \ref{cohomology-lemma-uniqueness} applied to the solution $K_{X'}$.
For this system we have $X = X' \cup U_n$.
This reduces us to the case $n = 2$ we worked out above.
\end{proof}

\begin{lemma}[Glueing increasing union]
\label{cohomology-lemma-glueing-increasing-union}
\source{stacks:0D6B}
\href{https://stacks.math.columbia.edu/tag/0D6B}{\texttt{Stacks tag 0D6B}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-solution-in-finite-case}
...
Lemma \ref{cohomology-lemma-solution-in-finite-case}
...
\source{stacks:0D6C}
\href{https://stacks.math.columbia.edu/tag/0D6C}{\texttt{Stacks tag 0D6C}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-uniqueness, cohomology-lemma-solution-in-finite-case, cohomology-lemma-glueing-increasing-union}

A pair $(K, \rho_U)$ is called a solution in the text above.
The uniqueness follows from Lemma \ref{cohomology-lemma-uniqueness}.
If $X$ has a finite covering by elements of $\mathcal{B}$
(for example if $X$ is quasi-compact), then the theorem
is a consequence of Lemma \ref{cohomology-lemma-solution-in-finite-case}.
In the general case we argue in exactly the same manner,
using transfinite induction and
Lemma \ref{cohomology-lemma-glueing-increasing-union}.
...
$$
is a system as in Lemma \ref{cohomology-lemma-uniqueness} on the ringed space $W_\alpha$.
...
\{\rho_V^U\}_{V \subset U\text{ with }U, V \in \mathcal{B}_\alpha^*})$.
Note that this new system also satisfies condition (3)
by Lemma \ref{cohomology-lemma-uniqueness} applied to the solution $K_{W_\beta}$.
...
Thus we may apply Lemma \ref{cohomology-lemma-glueing-increasing-union}
(note that the vanishing of negative exts is true for
$K_{W_\beta}$ by Lemma \ref{cohomology-lemma-uniqueness} applied
...
$$
\begin{array}{cc}K_{W_\alpha}|_V \underset{\rho_U^{W_\alpha}|_V}{\longrightarrow}\underset{\rho_{W_\beta}^{W_\alpha}|_V}{\downarrow} & K_U|_V \overset{\rho_U^V}{\downarrow} \\ K_{W_\beta} \overset{\rho_V^{W_\beta}}{\longrightarrow} & K_V\end{array}
$$
...
$$
is a system as in Lemma \ref{cohomology-lemma-uniqueness} on the ringed space $U$
...
\begin{definition}[Strictly perfect]
\label{cohomology-definition-strictly-perfect}
\source{stacks:08C4}
\href{https://stacks.math.columbia.edu/tag/08C4}{\texttt{Stacks tag 08C4}}
\group{cohomology}
...
\source{stacks:08C5}
\href{https://stacks.math.columbia.edu/tag/08C5}{\texttt{Stacks tag 08C5}}
\group{cohomology}
...
\source{stacks:09J2}
\href{https://stacks.math.columbia.edu/tag/09J2}{\texttt{Stacks tag 09J2}}
\group{cohomology}
...
\begin{lemma}[Strictly perfect pullback]
\label{cohomology-lemma-strictly-perfect-pullback}
\source{stacks:09U6}
\href{https://stacks.math.columbia.edu/tag/09U6}{\texttt{Stacks tag 09U6}}
\group{cohomology}
...
\begin{lemma}[Local lift map]
\label{cohomology-lemma-local-lift-map}
\source{stacks:08C6}
\href{https://stacks.math.columbia.edu/tag/08C6}{\texttt{Stacks tag 08C6}}
\group{cohomology}

Let $(X, \mathcal{O}_X)$ be a ringed space.
Given a solid diagram of $\mathcal{O}_X$-modules
$$
\begin{array}{cc}\mathcal{E} \searrow\longrightarrow & \mathcal{F} \\  & \mathcal{G} \underset{p}{\uparrow}\end{array}
$$
...
\begin{lemma}[Local homotopy]
\label{cohomology-lemma-local-homotopy}
\source{stacks:08C7}
\href{https://stacks.math.columbia.edu/tag/08C7}{\texttt{Stacks tag 08C7}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-local-lift-map}
...
Lemma \ref{cohomology-lemma-local-lift-map} and the fact that
...
\begin{lemma}[Lift through quasi isomorphism]
\label{cohomology-lemma-lift-through-quasi-isomorphism}
\source{stacks:08C8}
\href{https://stacks.math.columbia.edu/tag/08C8}{\texttt{Stacks tag 08C8}}
\group{cohomology}

Let $(X, \mathcal{O}_X)$ be a ringed space.
Given a solid diagram of complexes of $\mathcal{O}_X$-modules
$$
\begin{array}{cc}\mathcal{E}^\bullet \searrow\underset{\alpha}{\longrightarrow} & \mathcal{F}^\bullet \\  & \mathcal{G}^\bullet \underset{f}{\uparrow}\end{array}
$$
...
\begin{proof}
\uses{cohomology-lemma-local-homotopy}

Our assumptions on $f$ imply the cone $C(f)^\bullet$ has vanishing
cohomology sheaves in degrees $\geq a$.
Hence Lemma \ref{cohomology-lemma-local-homotopy} guarantees there is an open
...
\begin{lemma}[Local actual]
\label{cohomology-lemma-local-actual}
\source{stacks:08C9}
\href{https://stacks.math.columbia.edu/tag/08C9}{\texttt{Stacks tag 08C9}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-lift-through-quasi-isomorphism}
...
Lemma \ref{cohomology-lemma-lift-through-quasi-isomorphism}.
We omit the proof of (2).
\end{proof}

\begin{lemma}[Rhom strictly perfect]
\label{cohomology-lemma-Rhom-strictly-perfect}
\source{stacks:08DM}
\href{https://stacks.math.columbia.edu/tag/08DM}{\texttt{Stacks tag 08DM}}
\group{cohomology}
...
$$
and differential as described in Section \ref{cohomology-section-hom-complexes}.
\end{lemma}

\begin{proof}
\uses{cohomology-lemma-local-actual}
...
by the construction in Section \ref{cohomology-section-internal-hom}. It suffices
...
$$
By Lemma \ref{cohomology-lemma-local-actual} the sheafification of
...
\begin{lemma}[Rhom strictly perfect K flat]
\label{cohomology-lemma-Rhom-strictly-perfect-K-flat}
\source{stacks:0GM5}
\href{https://stacks.math.columbia.edu/tag/0GM5}{\texttt{Stacks tag 0GM5}}
\group{cohomology}

\uses{cohomology-lemma-Rhom-strictly-perfect}
In the situation of Lemma \ref{cohomology-lemma-Rhom-strictly-perfect}
if $\mathcal{F}^\bullet$ is K-flat, then $\mathcal{H}^\bullet$ is K-flat.
\end{lemma}

\begin{proof}
\uses{cohomology-lemma-diagonal-better, cohomology-lemma-local-actual, cohomology-lemma-Rhom-strictly-perfect}
...
$$
of Lemma \ref{cohomology-lemma-diagonal-better}. Since $\mathcal{F}^\bullet$ is K-flat,
the complex $\text{Tot}(\mathcal{K}^\bullet \otimes \mathcal{F}^\bullet)$
is acyclic, and hence by Lemma \ref{cohomology-lemma-local-actual}
(or Lemma \ref{cohomology-lemma-Rhom-strictly-perfect} if you like)
...
\begin{lemma}[Rhom complex of direct summands finite free]
\label{cohomology-lemma-Rhom-complex-of-direct-summands-finite-free}
\source{stacks:08I5}
\href{https://stacks.math.columbia.edu/tag/08I5}{\texttt{Stacks tag 08I5}}
\group{cohomology}
...
\SheafHom_{\mathcal{O}_X}(\mathcal{E}^{-q}, \mathcal{F}^p)
$$
and differential as described in Section \ref{cohomology-section-internal-hom}.
\end{lemma}
...
Hence the construction in Section \ref{cohomology-section-internal-hom}
shows that
...
\begin{definition}[Pseudo coherent]
\label{cohomology-definition-pseudo-coherent}
\source{stacks:08CB}
\href{https://stacks.math.columbia.edu/tag/08CB}{\texttt{Stacks tag 08CB}}
\group{cohomology}
...
\begin{lemma}[Pseudo coherent independent representative]
\label{cohomology-lemma-pseudo-coherent-independent-representative}
\source{stacks:08CC}
\href{https://stacks.math.columbia.edu/tag/08CC}{\texttt{Stacks tag 08CC}}
\group{cohomology}
...
By Lemma \ref{cohomology-lemma-local-actual}
...
\begin{lemma}[Pseudo coherent pullback]
\label{cohomology-lemma-pseudo-coherent-pullback}
\source{stacks:09U7}
\href{https://stacks.math.columbia.edu/tag/09U7}{\texttt{Stacks tag 09U7}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-definition-pseudo-coherent, cohomology-lemma-pseudo-coherent-independent-representative, cohomology-lemma-strictly-perfect-pullback}
...
as in Definition \ref{cohomology-definition-pseudo-coherent}.
Set $U_i = f^{-1}(V_i)$.
By Lemma \ref{cohomology-lemma-pseudo-coherent-independent-representative}
...
is strictly perfect by Lemma \ref{cohomology-lemma-strictly-perfect-pullback}.
Thus we conclude.
\end{proof}

\begin{lemma}[Cone pseudo coherent]
\label{cohomology-lemma-cone-pseudo-coherent}
\source{stacks:08CD}
\href{https://stacks.math.columbia.edu/tag/08CD}{\texttt{Stacks tag 08CD}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-lift-through-quasi-isomorphism, cohomology-lemma-cone, cohomology-lemma-pseudo-coherent-independent-representative}
...
$$
\begin{array}{cc}K|_{U_i} \longrightarrow & L|_{U_i} \\ \mathcal{K}_i^\bullet \overset{\alpha_i}{\uparrow}\overset{\gamma_i}{\longrightarrow} & \mathcal{L}_i^\bullet \underset{\beta_i}{\uparrow}\end{array}
$$
...
The cone $C(\gamma_i)^\bullet$ is strictly perfect (Lemma \ref{cohomology-lemma-cone}).
...
Lemma \ref{cohomology-lemma-pseudo-coherent-independent-representative}.
...
\begin{lemma}[Tensor pseudo coherent]
\label{cohomology-lemma-tensor-pseudo-coherent}
\source{stacks:09J3}
\href{https://stacks.math.columbia.edu/tag/09J3}{\texttt{Stacks tag 09J3}}
\group{cohomology}
...
\begin{lemma}[Summands pseudo coherent]
\label{cohomology-lemma-summands-pseudo-coherent}
\source{stacks:08CE}
\href{https://stacks.math.columbia.edu/tag/08CE}{\texttt{Stacks tag 08CE}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-cone-pseudo-coherent}
...
By
Lemma \ref{cohomology-lemma-cone-pseudo-coherent}
...
\begin{lemma}[Complex pseudo coherent modules]
\label{cohomology-lemma-complex-pseudo-coherent-modules}
\source{stacks:09V7}
\href{https://stacks.math.columbia.edu/tag/09V7}{\texttt{Stacks tag 09V7}}
\group{cohomology}
...
Omitted. Hint: use Lemma \ref{cohomology-lemma-cone-pseudo-coherent} and truncations
as in the proof of
More on Algebra, Lemma \ref{more-algebra-lemma-complex-pseudo-coherent-modules}.
\end{proof}

\begin{lemma}[Cohomology pseudo coherent]
\label{cohomology-lemma-cohomology-pseudo-coherent}
\source{stacks:09V8}
\href{https://stacks.math.columbia.edu/tag/09V8}{\texttt{Stacks tag 09V8}}
\group{cohomology}
...
\begin{lemma}[Finite cohomology]
\label{cohomology-lemma-finite-cohomology}
\source{stacks:08DN}
\href{https://stacks.math.columbia.edu/tag/08DN}{\texttt{Stacks tag 08DN}}
\group{cohomology}
...
\begin{lemma}[N pseudo module]
\label{cohomology-lemma-n-pseudo-module}
\source{stacks:09V9}
\href{https://stacks.math.columbia.edu/tag/09V9}{\texttt{Stacks tag 09V9}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-finite-cohomology, cohomology-lemma-cohomology-pseudo-coherent}

Use Lemma \ref{cohomology-lemma-finite-cohomology}
to prove the implications in one direction and
Lemma \ref{cohomology-lemma-cohomology-pseudo-coherent} for the other.
\end{proof}
...
\source{stacks:08CG}
\href{https://stacks.math.columbia.edu/tag/08CG}{\texttt{Stacks tag 08CG}}
\group{cohomology}
...
\begin{lemma}[Last one flat]
\label{cohomology-lemma-last-one-flat}
\source{stacks:08CH}
\href{https://stacks.math.columbia.edu/tag/08CH}{\texttt{Stacks tag 08CH}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-flat-tor-zero}
...
$\Coker(d^{a - 1})$ is flat, see Lemma \ref{cohomology-lemma-flat-tor-zero}.
\end{proof}

\begin{lemma}[Tor amplitude]
\label{cohomology-lemma-tor-amplitude}
\source{stacks:08CI}
\href{https://stacks.math.columbia.edu/tag/08CI}{\texttt{Stacks tag 08CI}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-last-one-flat}
...
Section \ref{cohomology-section-flat}.
...
\begin{lemma}[Tor amplitude pullback]
\label{cohomology-lemma-tor-amplitude-pullback}
\source{stacks:09U8}
\href{https://stacks.math.columbia.edu/tag/09U8}{\texttt{Stacks tag 09U8}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-tor-amplitude}

Assume $E$ has tor amplitude in $[a, b]$. By
Lemma \ref{cohomology-lemma-tor-amplitude}
...
By Modules, Lemma \ref{modules-lemma-base-change-flat}
the modules $f^*\mathcal{E}^i$ are flat.
Thus by Lemma \ref{cohomology-lemma-tor-amplitude}
we conclude that $Lf^*E$ has tor amplitude in $[a, b]$.
\end{proof}

\begin{lemma}[Tor amplitude stalk]
\label{cohomology-lemma-tor-amplitude-stalk}
\source{stacks:09U9}
\href{https://stacks.math.columbia.edu/tag/09U9}{\texttt{Stacks tag 09U9}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-tor-amplitude-pullback}
...
Lemma \ref{cohomology-lemma-tor-amplitude-pullback}.
...
\begin{lemma}[Cone tor amplitude]
\label{cohomology-lemma-cone-tor-amplitude}
\source{stacks:08CJ}
\href{https://stacks.math.columbia.edu/tag/08CJ}{\texttt{Stacks tag 08CJ}}
\group{cohomology}
...
\begin{lemma}[Tensor tor amplitude]
\label{cohomology-lemma-tensor-tor-amplitude}
\source{stacks:09J4}
\href{https://stacks.math.columbia.edu/tag/09J4}{\texttt{Stacks tag 09J4}}
\group{cohomology}
...
\begin{lemma}[Summands tor amplitude]
\label{cohomology-lemma-summands-tor-amplitude}
\source{stacks:08CK}
\href{https://stacks.math.columbia.edu/tag/08CK}{\texttt{Stacks tag 08CK}}
\group{cohomology}
...
\source{stacks:08CM}
\href{https://stacks.math.columbia.edu/tag/08CM}{\texttt{Stacks tag 08CM}}
\group{cohomology}
...
\begin{lemma}[Perfect independent representative]
\label{cohomology-lemma-perfect-independent-representative}
\source{stacks:08CN}
\href{https://stacks.math.columbia.edu/tag/08CN}{\texttt{Stacks tag 08CN}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-pseudo-coherent-independent-representative}

Identical to the proof of
Lemma \ref{cohomology-lemma-pseudo-coherent-independent-representative}.
\end{proof}

\begin{lemma}[Perfect on locally ringed]
\label{cohomology-lemma-perfect-on-locally-ringed}
\source{stacks:0BCJ}
\href{https://stacks.math.columbia.edu/tag/0BCJ}{\texttt{Stacks tag 0BCJ}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-perfect-independent-representative}

This follows from Lemma \ref{cohomology-lemma-perfect-independent-representative}
...
\begin{lemma}[Perfect precise]
\label{cohomology-lemma-perfect-precise}
\source{stacks:08CP}
\href{https://stacks.math.columbia.edu/tag/08CP}{\texttt{Stacks tag 08CP}}
\group{cohomology}
...
Hence $\mathcal{E}'$ is flat (Lemma \ref{cohomology-lemma-flat-tor-zero}).
...
\source{stacks:08CQ}
\href{https://stacks.math.columbia.edu/tag/08CQ}{\texttt{Stacks tag 08CQ}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-pseudo-coherent-independent-representative, cohomology-lemma-tor-amplitude, cohomology-lemma-perfect-precise}
...
\begin{lemma}[Perfect pullback]
\label{cohomology-lemma-perfect-pullback}
\source{stacks:09UA}
\href{https://stacks.math.columbia.edu/tag/09UA}{\texttt{Stacks tag 09UA}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-perfect, cohomology-lemma-tor-amplitude-pullback, cohomology-lemma-pseudo-coherent-pullback}

This follows from Lemma \ref{cohomology-lemma-perfect},
\ref{cohomology-lemma-tor-amplitude-pullback}, and
\ref{cohomology-lemma-pseudo-coherent-pullback}.
(An alternative proof is to copy the proof of
Lemma \ref{cohomology-lemma-pseudo-coherent-pullback}.)
\end{proof}

\begin{lemma}[Two out of three perfect]
\label{cohomology-lemma-two-out-of-three-perfect}
\source{stacks:08CR}
\href{https://stacks.math.columbia.edu/tag/08CR}{\texttt{Stacks tag 08CR}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-perfect, cohomology-lemma-cone-pseudo-coherent, cohomology-lemma-cone-tor-amplitude, cohomology-lemma-local-actual, cohomology-lemma-cone}

First proof: Combine
Lemmas \ref{cohomology-lemma-perfect}, \ref{cohomology-lemma-cone-pseudo-coherent}, and
...
see Lemma \ref{cohomology-lemma-local-actual}.
Then $M$ is isomorphic to the cone of $\alpha$ which is strictly
perfect by Lemma \ref{cohomology-lemma-cone}.
\end{proof}

\begin{lemma}[Tensor perfect]
\label{cohomology-lemma-tensor-perfect}
\source{stacks:09J5}
\href{https://stacks.math.columbia.edu/tag/09J5}{\texttt{Stacks tag 09J5}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-perfect, cohomology-lemma-tensor-pseudo-coherent, cohomology-lemma-tensor-tor-amplitude}

Follows from
Lemmas \ref{cohomology-lemma-perfect}, \ref{cohomology-lemma-tensor-pseudo-coherent}, and
\ref{cohomology-lemma-tensor-tor-amplitude}.
\end{proof}

\begin{lemma}[Summands perfect]
\label{cohomology-lemma-summands-perfect}
\source{stacks:08CS}
\href{https://stacks.math.columbia.edu/tag/08CS}{\texttt{Stacks tag 08CS}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-perfect, cohomology-lemma-summands-pseudo-coherent, cohomology-lemma-summands-tor-amplitude}

Follows from
Lemmas \ref{cohomology-lemma-perfect}, \ref{cohomology-lemma-summands-pseudo-coherent}, and
\ref{cohomology-lemma-summands-tor-amplitude}.
\end{proof}

\begin{lemma}[Pushforward perfect]
\label{cohomology-lemma-pushforward-perfect}
\source{stacks:08DP}
\href{https://stacks.math.columbia.edu/tag/08DP}{\texttt{Stacks tag 08DP}}
\group{cohomology}
...
\begin{lemma}[Perfect max open coh loc free]
\label{cohomology-lemma-perfect-max-open-coh-loc-free}
\source{stacks:0GT1}
\href{https://stacks.math.columbia.edu/tag/0GT1}{\texttt{Stacks tag 0GT1}}
\group{cohomology}
...
$H^b(E)$ is finite free, see Lemma \ref{cohomology-lemma-local-lift-map}.
...
Example \ref{cohomology-example-dual-derived} and
Lemma \ref{cohomology-lemma-left-dual-derived}).

\begin{lemma}[Symmetric monoidal cat complexes]
\label{cohomology-lemma-symmetric-monoidal-cat-complexes}
\source{stacks:0FP8}
\href{https://stacks.math.columbia.edu/tag/0FP8}{\texttt{Stacks tag 0FP8}}
\group{cohomology}
...
\source{stacks:0FP9}
\href{https://stacks.math.columbia.edu/tag/0FP9}{\texttt{Stacks tag 0FP9}}
\group{cohomology}
...
$$
as in Section \ref{cohomology-section-hom-complexes}. Let
$$
\eta :
\mathcal{O}_X
\to
...
\begin{lemma}[Left dual complex]
\label{cohomology-lemma-left-dual-complex}
\source{stacks:0FPA}
\href{https://stacks.math.columbia.edu/tag/0FPA}{\texttt{Stacks tag 0FPA}}
\group{cohomology}

\uses{cohomology-example-dual}
Let $(X, \mathcal{O}_X)$ be a ringed space. Let $\mathcal{F}^\bullet$
...
and the left dual is as constructed in Example \ref{cohomology-example-dual}.
\end{lemma}
...
\begin{lemma}[Internal hom evaluate isom]
\label{cohomology-lemma-internal-hom-evaluate-isom}
\source{stacks:0G40}
\href{https://stacks.math.columbia.edu/tag/0G40}{\texttt{Stacks tag 0G40}}
\group{cohomology}

\uses{cohomology-lemma-internal-hom-evaluate}
...
R\SheafHom(R\SheafHom(K, L), M)
$$
of Lemma \ref{cohomology-lemma-internal-hom-evaluate} is an isomorphism.
\end{lemma}

\begin{proof}
\uses{cohomology-lemma-restriction-RHom-to-U, cohomology-lemma-RHom-triangulated, cohomology-lemma-internal-hom-evaluate}

Since the map is globally defined and since formation of the right and
left hand side commute with localization
(see Lemma \ref{cohomology-lemma-restriction-RHom-to-U}), to prove this we may work
...
$$
See Section \ref{cohomology-section-flat} and
Lemma \ref{cohomology-lemma-RHom-triangulated}.
The arrow of Lemma \ref{cohomology-lemma-internal-hom-evaluate} is functorial in $K$
...
\begin{lemma}[Dual perfect complex]
\label{cohomology-lemma-dual-perfect-complex}
\source{stacks:08DQ}
\href{https://stacks.math.columbia.edu/tag/08DQ}{\texttt{Stacks tag 08DQ}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-internal-hom-evaluate, cohomology-lemma-internal-hom-evaluate-isom, cohomology-lemma-restriction-RHom-to-U, cohomology-lemma-dual, cohomology-lemma-Rhom-strictly-perfect}

By Lemma \ref{cohomology-lemma-internal-hom-evaluate} there is a canonical map
$$
...
(K^\vee)^\vee
$$
which is an isomorphism by Lemma \ref{cohomology-lemma-internal-hom-evaluate-isom}.
...
(Lemma \ref{cohomology-lemma-restriction-RHom-to-U}).
We may check $K^\vee$ is perfect locally on $X$.
By Lemma \ref{cohomology-lemma-dual}
...
Lemma \ref{cohomology-lemma-Rhom-strictly-perfect}
...
By Lemma \ref{cohomology-lemma-Rhom-strictly-perfect} the complex
...
\begin{lemma}[Symmetric monoidal derived]
\label{cohomology-lemma-symmetric-monoidal-derived}
\source{stacks:0FPB}
\href{https://stacks.math.columbia.edu/tag/0FPB}{\texttt{Stacks tag 0FPB}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-symmetric-monoidal-cat-complexes}

Omitted. Compare with Lemma \ref{cohomology-lemma-symmetric-monoidal-cat-complexes}.
\end{proof}

\begin{example}[Dual derived]
\label{cohomology-example-dual-derived}
\source{stacks:0FPC}
\href{https://stacks.math.columbia.edu/tag/0FPC}{\texttt{Stacks tag 0FPC}}
\group{cohomology}

\uses{cohomology-lemma-dual-perfect-complex, cohomology-lemma-internal-hom-composition}
Let $(X, \mathcal{O}_X)$ be a ringed space. Let $K$ be a perfect object
of $D(\mathcal{O}_X)$. Set $K^\vee = R\SheafHom(K, \mathcal{O}_X)$
as in Lemma \ref{cohomology-lemma-dual-perfect-complex}.
Then the map
$$
...
Lemma \ref{cohomology-lemma-internal-hom-composition} for example). Then
...
\begin{lemma}[Left dual derived]
\label{cohomology-lemma-left-dual-derived}
\source{stacks:0FPD}
\href{https://stacks.math.columbia.edu/tag/0FPD}{\texttt{Stacks tag 0FPD}}
\group{cohomology}

\uses{cohomology-example-dual-derived}
...
Example \ref{cohomology-example-dual-derived}.
\end{lemma}

\begin{proof}
\uses{cohomology-lemma-K-flat-resolution, cohomology-lemma-perfect-precise, cohomology-lemma-local-actual}
...
$\mathcal{O}_X$-modules, see Lemma \ref{cohomology-lemma-K-flat-resolution}.
Consider the map
$$
\eta : \mathcal{O}_X \to
...
$$
\begin{array}{cccc}M \underset{\eta \otimes 1}{\longrightarrow}\underset{\tilde \eta \otimes 1}{\searrow} &  & M \otimes^\mathbf{L} N \otimes^\mathbf{L} M
\underset{1 \otimes \epsilon}{\longrightarrow} & M \\  &  & K \otimes^\mathbf{L} N \otimes^\mathbf{L} M
\uparrow\overset{1 \otimes \epsilon}{\longrightarrow} & K \uparrow\end{array}
$$
...
Lemma \ref{cohomology-lemma-perfect-precise} and the fact that
...
$$
\begin{array}{cccc}\mathcal{E}^\bullet \longrightarrow & \mathcal{M}^\bullet \longrightarrow & \mathcal{L}^\bullet \longrightarrow & \mathcal{E}^\bullet[1] \\ \mathcal{E}^\bullet \longrightarrow\uparrow & \mathcal{K}^\bullet \longrightarrow\uparrow & \sigma_{\leq m - 1}\mathcal{K}^\bullet \longrightarrow\uparrow & \mathcal{E}^\bullet[1] \uparrow\end{array}
$$
...
diagram
$$
\begin{array}{ccc}\mathcal{E}^\bullet \longrightarrow & \mathcal{K}^\bullet \xlongequal{} & K \\ \mathcal{E}^\bullet \overset{\text{id}}{\uparrow}\overset{i}{\longrightarrow} & \mathcal{M}^\bullet \xlongequal{} & M \underset{s}{\uparrow}\end{array}
$$
commutes, but we do know it commutes after composing with the
map $K \to M$. By Lemma \ref{cohomology-lemma-local-actual} after shrinking $X$ we may
...
$$
\begin{array}{cccc}\mathcal{E}^\bullet \longrightarrow & M \longrightarrow & \mathcal{L}^\bullet \longrightarrow & \mathcal{E}^\bullet[1] \\ \mathcal{E}^\bullet \longrightarrow\uparrow & K \longrightarrow\uparrow & \sigma_{\leq m - 1}\mathcal{K}^\bullet \longrightarrow\uparrow & \mathcal{E}^\bullet[1] \uparrow \\ \mathcal{E}^\bullet \longrightarrow\uparrow & M \longrightarrow\overset{s}{\uparrow} & \mathcal{L}^\bullet \longrightarrow\uparrow & \mathcal{E}^\bullet[1] \uparrow\end{array}
$$
...
$$
\begin{array}{ccc}H^{m - 1}(M) \longrightarrow & H^{m - 1}(\mathcal{L}^\bullet) \longrightarrow & H^m(\mathcal{E}^\bullet) \\ H^{m - 1}(K) \longrightarrow\uparrow & H^{m - 1}(\sigma_{\leq m - 1}\mathcal{K}^\bullet) \longrightarrow\uparrow & H^m(\mathcal{E}^\bullet) \uparrow \\ H^{m - 1}(M) \longrightarrow\uparrow & H^{m - 1}(\mathcal{L}^\bullet) \longrightarrow\uparrow & H^m(\mathcal{E}^\bullet) \uparrow\end{array}
$$
...
\begin{lemma}[Colim and lim of duals]
\label{cohomology-lemma-colim-and-lim-of-duals}
\source{stacks:0DJI}
\href{https://stacks.math.columbia.edu/tag/0DJI}{\texttt{Stacks tag 0DJI}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-dual-perfect-complex}

By Lemma \ref{cohomology-lemma-dual-perfect-complex} we have
...
\begin{lemma}[Ext composition is cup]
\label{cohomology-lemma-ext-composition-is-cup}
\source{stacks:0FVB}
\href{https://stacks.math.columbia.edu/tag/0FVB}{\texttt{Stacks tag 0FVB}}
\group{cohomology}

\uses{cohomology-example-dual-derived, cohomology-lemma-dual-perfect-complex}
Let $(X, \mathcal{O}_X)$ be a ringed space. Let $K$ and $E$ be objects
of $D(\mathcal{O}_X)$ with $E$ perfect. The diagram
$$
\begin{array}{cc}H^0(X, K \otimes_{\mathcal{O}_X}^\mathbf{L} E^\vee) \times H^0(X, E)
\longrightarrow\downarrow & H^0(X, K \otimes_{\mathcal{O}_X}^\mathbf{L} E^\vee
\otimes_{\mathcal{O}_X}^\mathbf{L} E) \downarrow \\ \Hom_X(E, K) \times H^0(X, E) \longrightarrow & H^0(X, K)\end{array}
$$
...
(Example \ref{cohomology-example-dual-derived}), the left vertical arrow uses
Lemma \ref{cohomology-lemma-dual-perfect-complex}, and the bottom horizontal
arrow is the obvious one.
\end{lemma}

\begin{proof}
\uses{cohomology-lemma-second-cup-equals-first, cohomology-lemma-dual-perfect-complex, cohomology-lemma-internal-hom-composition, cohomology-example-dual-derived}
...
$D(\mathcal{O})$. By Lemma \ref{cohomology-lemma-second-cup-equals-first}
...
Lemma \ref{cohomology-lemma-dual-perfect-complex} is the composition
$$
...
K
$$
The construction in Lemma \ref{cohomology-lemma-dual-perfect-complex}
...
in Lemma \ref{cohomology-lemma-internal-hom-composition}.
...
Lemma \ref{cohomology-lemma-internal-hom-composition} is associative
...
\source{stacks:0GM7}
\href{https://stacks.math.columbia.edu/tag/0GM7}{\texttt{Stacks tag 0GM7}}
\group{cohomology}
...
$$
of Remark \ref{cohomology-remark-prepare-fancy-base-change}
...
\begin{proof}
\uses{cohomology-lemma-Rhom-strictly-perfect, cohomology-lemma-strictly-perfect-pullback, cohomology-lemma-Rhom-strictly-perfect-K-flat}

Proof of (1). The question is local on $Y$, hence we may assume that
$K$ is represented by a strictly perfect complex
$\mathcal{E}^\bullet$, see Section \ref{cohomology-section-perfect}.
Choose a K-flat complex $\mathcal{F}^\bullet$ representing $M$.
Apply Lemma \ref{cohomology-lemma-Rhom-strictly-perfect} to see that
$R\SheafHom(K, L)$ is represented by the complex
$\mathcal{H}^\bullet =
\SheafHom^\bullet(\mathcal{E}^\bullet, \mathcal{F}^\bullet)$
with terms $\mathcal{H}^n = \bigoplus\nolimits_{n = p + q}
\SheafHom_{\mathcal{O}_X}(\mathcal{E}^{-q}, \mathcal{F}^p)$.
By the construction of $Lh^*$ in Section \ref{cohomology-section-derived-pullback}
we see that $Lh^*K$ is represented by the strictly perfect complex
$h^*\mathcal{E}^\bullet$ (Lemma \ref{cohomology-lemma-strictly-perfect-pullback}).
...
Lemma \ref{cohomology-lemma-Rhom-strictly-perfect-K-flat}.
...
Section \ref{cohomology-section-pseudo-coherent}. This reduces us to case (1).
...
\begin{lemma}[Stalk internal hom]
\label{cohomology-lemma-stalk-internal-hom}
\source{stacks:0GM8}
\href{https://stacks.math.columbia.edu/tag/0GM8}{\texttt{Stacks tag 0GM8}}
\group{cohomology}
...
\begin{lemma}[Category summands finite free]
\label{cohomology-lemma-category-summands-finite-free}
\source{stacks:0FPF}
\href{https://stacks.math.columbia.edu/tag/0FPF}{\texttt{Stacks tag 0FPF}}
\group{cohomology}
...
\begin{lemma}[Invertible derived]
\label{cohomology-lemma-invertible-derived}
\source{stacks:0FPG}
\href{https://stacks.math.columbia.edu/tag/0FPG}{\texttt{Stacks tag 0FPG}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-left-dual-derived, cohomology-lemma-local-actual, cohomology-lemma-category-summands-finite-free}
...
Lemma \ref{cohomology-lemma-left-dual-derived}. By symmetry we see that
...
\to \mathcal{O}_X
$$
See Lemma \ref{cohomology-lemma-local-actual}. Then $\beta \circ \alpha = 1$
...
Lemma \ref{cohomology-lemma-category-summands-finite-free}
...
Correspondingly, using Lemma \ref{cohomology-lemma-category-summands-finite-free} again,
...
\begin{lemma}[When jshriek compact]
\label{cohomology-lemma-when-jshriek-compact}
\source{stacks:0F5Z}
\href{https://stacks.math.columbia.edu/tag/0F5Z}{\texttt{Stacks tag 0F5Z}}
\group{cohomology}
...
\begin{lemma}[Perfect is compact]
\label{cohomology-lemma-perfect-is-compact}
\source{stacks:09J7}
\href{https://stacks.math.columbia.edu/tag/09J7}{\texttt{Stacks tag 09J7}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-dual-perfect-complex, cohomology-lemma-quasi-separated-cohomology-colimit, cohomology-lemma-when-jshriek-compact}

Let $K^\vee$ be the dual of $K$, see
Lemma \ref{cohomology-lemma-dual-perfect-complex}. Then we have
$$
\Hom_{D(\mathcal{O}_X)}(K, M) =
...
Lemma \ref{cohomology-lemma-when-jshriek-compact}

\medskip\noindent
Proof of (a). Let $\mathcal{I}_i$, $i \in I$ be a collection of injective
$\mathcal{O}_X$-modules. By Lemma \ref{cohomology-lemma-quasi-separated-cohomology-colimit}
we see that
$$
...
The most basic version is Lemma \ref{cohomology-lemma-projection-formula}.
After we state and prove it, we discuss a more general version
involving perfect complexes.

\begin{lemma}[Injective tensor finite locally free]
\label{cohomology-lemma-injective-tensor-finite-locally-free}
\source{stacks:01E7}
\href{https://stacks.math.columbia.edu/tag/01E7}{\texttt{Stacks tag 01E7}}
\group{cohomology}
...
\source{stacks:01E8}
\href{https://stacks.math.columbia.edu/tag/01E8}{\texttt{Stacks tag 01E8}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-injective-tensor-finite-locally-free}
...
Lemma \ref{cohomology-lemma-injective-tensor-finite-locally-free}.
...
\ref{cohomology-lemma-pullback-tensor-product} and \ref{cohomology-lemma-adjoint}.
A reasonably general version of the projection formula is the following.

\begin{lemma}[Projection formula perfect]
\label{cohomology-lemma-projection-formula-perfect}
\source{stacks:0B54}
\href{https://stacks.math.columbia.edu/tag/0B54}{\texttt{Stacks tag 0B54}}
\group{cohomology}
...
\begin{lemma}[Projection formula closed immersion]
\label{cohomology-lemma-projection-formula-closed-immersion}
\source{stacks:0B55}
\href{https://stacks.math.columbia.edu/tag/0B55}{\texttt{Stacks tag 0B55}}
\group{cohomology}
...
(Lemma \ref{cohomology-lemma-pullback-K-flat}). Thus the right hand side of
...
\begin{remark}[Compatible with diagram]
\label{cohomology-remark-compatible-with-diagram}
\source{stacks:0B6B}
\href{https://stacks.math.columbia.edu/tag/0B6B}{\texttt{Stacks tag 0B6B}}
\group{cohomology}

\uses{cohomology-remark-base-change, cohomology-lemma-pullback-tensor-product}
The map (\ref{equation-projection-formula-map}) is compatible with the
base change map of Remark \ref{cohomology-remark-base-change} in the following sense.
Namely, suppose that
$$
...
Then the diagram
$$
\begin{array}{cc}Lg^*(Rf_*E \otimes^\mathbf{L}_{\mathcal{O}_Y} K) \underset{p}{\longrightarrow}\underset{t}{\downarrow} & Lg^*Rf_*(E \otimes^\mathbf{L}_{\mathcal{O}_X} Lf^*K) \underset{b}{\downarrow} \\ Lg^*Rf_*E \otimes^\mathbf{L}_{\mathcal{O}_{Y'}} Lg^*K \underset{b}{\downarrow} & Rf'_*L(g')^*(E \otimes^\mathbf{L}_{\mathcal{O}_X} Lf^*K) \underset{t}{\downarrow} \\ Rf'_*L(g')^*E \otimes^\mathbf{L}_{\mathcal{O}_{Y'}} Lg^*K \underset{p}{\searrow} & Rf'_*(L(g')^*E \otimes^\mathbf{L}_{\mathcal{O}_{Y'}} L(g')^*Lf^*K) \underset{c}{\downarrow} \\  & Rf'_*(L(g')^*E \otimes^\mathbf{L}_{\mathcal{O}_{Y'}} L(f')^*Lg^*K)\end{array}
$$
is commutative. Here arrows labeled $t$ are gotten by an application of
Lemma \ref{cohomology-lemma-pullback-tensor-product}, arrows labeled $b$ by an
application of Remark \ref{cohomology-remark-base-change}, arrows labeled $p$
...
\begin{lemma}[Invertible ideal sheaf]
\label{cohomology-lemma-invertible-ideal-sheaf}
\source{stacks:0GT3}
\href{https://stacks.math.columbia.edu/tag/0GT3}{\texttt{Stacks tag 0GT3}}
\group{cohomology}
...
\begin{definition}[Situation: Eta]
\label{cohomology-situation-eta}
\source{stacks:0GT4}
\href{https://stacks.math.columbia.edu/tag/0GT4}{\texttt{Stacks tag 0GT4}}
\group{cohomology}

\uses{cohomology-lemma-invertible-ideal-sheaf}
Let $(X, \mathcal{O}_X)$ be a ringed space. Let
$\mathcal{I} \subset \mathcal{O}_X$ be a sheaf of ideals
satisfying condition (1) of
Lemma \ref{cohomology-lemma-invertible-ideal-sheaf}\footnote{The discussion
...
\begin{lemma}[I torsion free]
\label{cohomology-lemma-I-torsion-free}
\source{stacks:0GT5}
\href{https://stacks.math.columbia.edu/tag/0GT5}{\texttt{Stacks tag 0GT5}}
\group{cohomology}

\uses{cohomology-situation-eta}
In Situation \ref{cohomology-situation-eta}
let $\mathcal{F}$ be an $\mathcal{O}_X$-module.
The following are equivalent
\begin{enumerate}
...
In Situation \ref{cohomology-situation-eta}
let $\mathcal{F}$ be an $\mathcal{O}_X$-module.
If the equivalent conditions of Lemma \ref{cohomology-lemma-I-torsion-free} hold,
...
\begin{lemma}[Eta stalks]
\label{cohomology-lemma-eta-stalks}
\source{stacks:0GT6}
\href{https://stacks.math.columbia.edu/tag/0GT6}{\texttt{Stacks tag 0GT6}}
\group{cohomology}
...
\begin{lemma}[Eta first property]
\label{cohomology-lemma-eta-first-property}
\source{stacks:0F8N}
\href{https://stacks.math.columbia.edu/tag/0F8N}{\texttt{Stacks tag 0F8N}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-eta-stalks}
...
via Lemma \ref{cohomology-lemma-eta-stalks} this translates into the result of
...
\source{stacks:0F8P}
\href{https://stacks.math.columbia.edu/tag/0F8P}{\texttt{Stacks tag 0F8P}}
\group{cohomology}
...
\begin{proof}
\uses{cohomology-lemma-eta-first-property}

This is true because the isomorphisms of Lemma \ref{cohomology-lemma-eta-first-property}
...
\source{stacks:0F8Q}
\href{https://stacks.math.columbia.edu/tag/0F8Q}{\texttt{Stacks tag 0F8Q}}
\group{cohomology}

\uses{cohomology-situation-eta}
In Situation \ref{cohomology-situation-eta} there is an additive
...
\begin{proof}
\uses{cohomology-lemma-K-flat-resolution, cohomology-lemma-I-torsion-free, cohomology-lemma-eta-qis}
...
By Lemma \ref{cohomology-lemma-K-flat-resolution} we can find a quasi-isomorphism
...
By the third characterization of Lemma \ref{cohomology-lemma-I-torsion-free}
...
Namely, by the discussion following Lemma \ref{cohomology-lemma-I-torsion-free}
...
$$
which according to Lemma \ref{cohomology-lemma-eta-qis} sends quasi-isomorphisms
...
In Situation \ref{cohomology-situation-eta} let us construct the Bockstein operators.
First we observe that there is a commutative diagram
$$
\begin{array}{ccccc}0 \longrightarrow & \mathcal{I}^{i + 1} \longrightarrow\downarrow & \mathcal{I}^i \longrightarrow\downarrow & \mathcal{I}^i/\mathcal{I}^{i + 1}
\longrightarrow\downarrow & 0 \\ 0 \longrightarrow & \mathcal{I}^{i + 1}/\mathcal{I}^{i + 2} \longrightarrow & \mathcal{I}^i/\mathcal{I}^{i + 2} \longrightarrow & \mathcal{I}^i/\mathcal{I}^{i + 1} \longrightarrow & 0\end{array}
$$
...
$$
\begin{array}{ccc}M \otimes^\mathbf{L} \mathcal{I}^{i + 1} \longrightarrow\downarrow & M \otimes^\mathbf{L} \mathcal{I}^i \longrightarrow\downarrow & M \otimes^\mathbf{L} \mathcal{I}^i/\mathcal{I}^{i + 1} \overset{\text{id}}{\downarrow} \\ M \otimes^\mathbf{L} \mathcal{I}^{i + 1}/\mathcal{I}^{i + 2} \longrightarrow & M \otimes^\mathbf{L} \mathcal{I}^i/\mathcal{I}^{i + 2} \longrightarrow & M \otimes^\mathbf{L} \mathcal{I}^i/\mathcal{I}^{i + 1}\end{array}
$$
...
\vcenter{
\begin{array}{cc}H^i(M \otimes^\mathbf{L} \mathcal{I}^i/\mathcal{I}^{i + 1})
\underset{\delta}{\longrightarrow}\underset{\beta}{\searrow} & H^{i + 1}(M \otimes^\mathbf{L} \mathcal{I}^{i + 1}) \downarrow \\  & H^{i + 1}(M \otimes^\mathbf{L} \mathcal{I}^{i + 1}/\mathcal{I}^{i + 2})\end{array}
}
\end{equation}
...
\begin{lemma}[Eta second property]
\label{cohomology-lemma-eta-second-property}
\source{stacks:0GT9}
\href{https://stacks.math.columbia.edu/tag/0GT9}{\texttt{Stacks tag 0GT9}}
\group{cohomology}

\uses{cohomology-situation-eta}
In Situation \ref{cohomology-situation-eta} let $M$ be an object of
...
\begin{proof}
\uses{cohomology-lemma-eta-qis}

By the construction of $L\eta_\mathcal{I}$ in Lemma \ref{cohomology-lemma-eta-qis}
...
\begin{lemma}[Eta tensor invertible]
\label{cohomology-lemma-eta-tensor-invertible}
\source{stacks:0F9W}
\href{https://stacks.math.columbia.edu/tag/0F9W}{\texttt{Stacks tag 0F9W}}
\group{cohomology}
...
\begin{lemma}[Eta cohomology locally free]
\label{cohomology-lemma-eta-cohomology-locally-free}
\source{stacks:0GTA}
\href{https://stacks.math.columbia.edu/tag/0GTA}{\texttt{Stacks tag 0GTA}}
\group{cohomology}

\uses{cohomology-situation-eta}
In Situation \ref{cohomology-situation-eta} let $M$ be an object of $D(\mathcal{O}_X)$.
...
Lemma \ref{cohomology-lemma-eta-first-property}
