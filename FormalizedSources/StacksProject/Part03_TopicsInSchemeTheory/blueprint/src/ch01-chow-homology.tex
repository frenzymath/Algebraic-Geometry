...
algebraic proof of the Key Lemma \ref{chow-lemma-milnor-gersten-low-degree}.
...
in Section \ref{chow-section-key-lemma}.

\medskip\noindent
Next, we introduce the basic setup we work with in the rest of this
chapter in Section \ref{chow-section-setup}. To make the material a little
...
Section \ref{chow-section-key}. Using this we prove that the operation
of intersecting with an invertible sheaf passes through rational
equivalence and is commutative, see Section \ref{chow-section-commutativity}.
One more application of the Key
lemma proves that the Gysin map of an effective Cartier divisor
passes through rational equivalence, see Section \ref{chow-section-gysin}.
...
\medskip\noindent
There are two appendices. In Appendix A (Section \ref{chow-section-appendix-A})
we discuss an alternative (longer) construction of the
tame symbol and corresponding proof of the Key Lemma.
Finally, in Appendix B (Section \ref{chow-section-appendix-chow})
...
\begin{definition}[Periodic complex]
\label{chow-definition-periodic-complex}
\source{stacks:02PG}
\href{https://stacks.math.columbia.edu/tag/02PG}{\texttt{Stacks tag 02PG}}
\group{chow}
...
$\psi : N \to M$ such that
$$
\begin{array}{cccccc}\ldots \longrightarrow & M \overset{\varphi}{\longrightarrow} & N \overset{\psi}{\longrightarrow} & M \overset{\varphi}{\longrightarrow} & N \longrightarrow & \ldots\end{array}
$$
...
such that
$$
\begin{array}{cccccc}\ldots \longrightarrow & M \overset{\varphi}{\longrightarrow} & M \overset{\psi}{\longrightarrow} & M \overset{\varphi}{\longrightarrow} & M \longrightarrow & \ldots\end{array}
$$
...
\begin{definition}[Periodic length]
\label{chow-definition-periodic-length}
\source{stacks:02PH}
\href{https://stacks.math.columbia.edu/tag/02PH}{\texttt{Stacks tag 02PH}}
\group{chow}
...
\begin{lemma}[Additivity periodic length]
\label{chow-lemma-additivity-periodic-length}
\source{stacks:0EA7}
\href{https://stacks.math.columbia.edu/tag/0EA7}{\texttt{Stacks tag 0EA7}}
\group{chow}
...
\begin{lemma}[Finite periodic length]
\label{chow-lemma-finite-periodic-length}
\source{stacks:0EA8}
\href{https://stacks.math.columbia.edu/tag/0EA8}{\texttt{Stacks tag 0EA8}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-additivity-periodic-length}
...
Lemma \ref{chow-lemma-additivity-periodic-length}
reduces us to the cases (a) $M = 0$ and (b) $\varphi$ is surjective.
We leave those cases to the reader.
\end{proof}

\begin{lemma}[Compare periodic lengths]
\label{chow-lemma-compare-periodic-lengths}
\source{stacks:0EA9}
\href{https://stacks.math.columbia.edu/tag/0EA9}{\texttt{Stacks tag 0EA9}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-additivity-periodic-length, chow-lemma-finite-periodic-length}

Apply the additivity of Lemma \ref{chow-lemma-additivity-periodic-length}
and observe that $(\Ker(f), \varphi, \psi)$ and
$(\Coker(f), \varphi', \psi')$ have vanishing multiplicity by
Lemma \ref{chow-lemma-finite-periodic-length}.
\end{proof}
...
\begin{lemma}[Length multiplication]
\label{chow-lemma-length-multiplication}
\source{stacks:02QF}
\href{https://stacks.math.columbia.edu/tag/02QF}{\texttt{Stacks tag 02QF}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-finite-periodic-length, chow-lemma-additivity-periodic-length}
...
in this case, see Lemma \ref{chow-lemma-finite-periodic-length}.
...
additivty of multiplicities (Lemma \ref{chow-lemma-additivity-periodic-length}).
...
\begin{lemma}[Additivity divisors restricted]
\label{chow-lemma-additivity-divisors-restricted}
\source{stacks:02QG}
\href{https://stacks.math.columbia.edu/tag/02QG}{\texttt{Stacks tag 02QG}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-length-multiplication}

These are special cases of Lemma \ref{chow-lemma-length-multiplication}.
\end{proof}

Here is another case where we can determine the value of a multiplicity.

\begin{lemma}[Powers period length zero]
\label{chow-lemma-powers-period-length-zero}
\source{stacks:0EAB}
\href{https://stacks.math.columbia.edu/tag/0EAB}{\texttt{Stacks tag 0EAB}}
\group{chow}
...
\begin{lemma}[Multiply period length]
\label{chow-lemma-multiply-period-length}
\source{stacks:0EAC}
\href{https://stacks.math.columbia.edu/tag/0EAC}{\texttt{Stacks tag 0EAC}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-compare-periodic-lengths, chow-lemma-additivity-periodic-length}
...
by Lemma \ref{chow-lemma-compare-periodic-lengths}.
By additivity (Lemma \ref{chow-lemma-additivity-periodic-length})
...
\begin{lemma}[Glue at max]
\label{chow-lemma-glue-at-max}
\source{stacks:0EAE}
\href{https://stacks.math.columbia.edu/tag/0EAE}{\texttt{Stacks tag 0EAE}}
\group{chow}
...
\begin{lemma}[Noetherian domain dim 1 two elements]
\label{chow-lemma-Noetherian-domain-dim-1-two-elements}
\source{stacks:02Q7}
\href{https://stacks.math.columbia.edu/tag/02Q7}{\texttt{Stacks tag 02Q7}}
\group{chow}
...
\begin{lemma}[Not infinitely divisible]
\label{chow-lemma-not-infinitely-divisible}
\source{stacks:0EAF}
\href{https://stacks.math.columbia.edu/tag/0EAF}{\texttt{Stacks tag 0EAF}}
\group{chow}
...
\begin{lemma}[Prepare tame symbol]
\label{chow-lemma-prepare-tame-symbol}
\source{stacks:0EAG}
\href{https://stacks.math.columbia.edu/tag/0EAG}{\texttt{Stacks tag 0EAG}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-glue-at-max, chow-lemma-compare-periodic-lengths, chow-lemma-Noetherian-domain-dim-1-two-elements, chow-lemma-not-infinitely-divisible}
...
Lemma \ref{chow-lemma-glue-at-max}.
...
then we can apply Lemma \ref{chow-lemma-glue-at-max}
...
Lemma \ref{chow-lemma-Noetherian-domain-dim-1-two-elements}
...
Lemma \ref{chow-lemma-not-infinitely-divisible}
...
as in Lemma \ref{chow-lemma-prepare-tame-symbol}.
Then we define
\begin{equation}
...
\begin{lemma}[Well defined tame symbol]
\label{chow-lemma-well-defined-tame-symbol}
\source{stacks:0EAR}
\href{https://stacks.math.columbia.edu/tag/0EAR}{\texttt{Stacks tag 0EAR}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-prepare-tame-symbol, chow-lemma-compare-periodic-lengths}
...
$A \subset B$ and $A \subset B'$ as in Lemma \ref{chow-lemma-prepare-tame-symbol}.
Then
$$
...
\begin{lemma}[Tame symbol]
\label{chow-lemma-tame-symbol}
\source{stacks:0EAS}
\href{https://stacks.math.columbia.edu/tag/0EAS}{\texttt{Stacks tag 0EAS}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-prepare-tame-symbol}

Let us prove (\ref{item-bilinear-better}).
Let $a_1, a_2, a_3 \in A$ be nonzerodivisors.
Choose $A \subset B$ as in Lemma \ref{chow-lemma-prepare-tame-symbol}
...
\begin{lemma}[Norm down tame symbol]
\label{chow-lemma-norm-down-tame-symbol}
\source{stacks:0EAT}
\href{https://stacks.math.columbia.edu/tag/0EAT}{\texttt{Stacks tag 0EAT}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-prepare-tame-symbol, chow-lemma-glue-at-max}

Choose $B_j \subset C_j$ as in
Lemma \ref{chow-lemma-prepare-tame-symbol} for $a, b$.
By Lemma \ref{chow-lemma-glue-at-max} we can choose a finite ring
...
\begin{lemma}[Tame symbol formally smooth]
\label{chow-lemma-tame-symbol-formally-smooth}
\source{stacks:0EPG}
\href{https://stacks.math.columbia.edu/tag/0EPG}{\texttt{Stacks tag 0EPG}}
\group{chow}
...
local factorizations as in Lemma \ref{chow-lemma-prepare-tame-symbol}.
...
Lemma \ref{chow-lemma-milnor-gersten-low-degree}.
...
See Remark \ref{chow-remark-gersten-complex-milnor}.

\begin{lemma}[Perpare key]
\label{chow-lemma-perpare-key}
\source{stacks:0EAV}
\href{https://stacks.math.columbia.edu/tag/0EAV}{\texttt{Stacks tag 0EAV}}
\group{chow}
...
\begin{lemma}[Key nonzerodivisors]
\label{chow-lemma-key-nonzerodivisors}
\source{stacks:0EAW}
\href{https://stacks.math.columbia.edu/tag/0EAW}{\texttt{Stacks tag 0EAW}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-prepare-tame-symbol, chow-lemma-perpare-key, chow-lemma-norm-down-tame-symbol, chow-lemma-compare-periodic-lengths, chow-lemma-multiply-period-length, chow-lemma-powers-period-length-zero, chow-lemma-length-multiplication}
...
as in Lemma \ref{chow-lemma-prepare-tame-symbol} for $a, b$.
By Lemma \ref{chow-lemma-perpare-key} with $t = ab$ and the given list of primes
...
$$
by Lemma \ref{chow-lemma-norm-down-tame-symbol} and
...
\sum e_A(M_i, a, b) = 0
$$
by Lemma \ref{chow-lemma-compare-periodic-lengths}. Hence it suffices to show
$e_A(M_i, a, b) =
- \text{ord}_{A/\mathfrak q_i}(\partial_{A_{\mathfrak q_i}}(a, b))$.
...
-\text{ord}_{A/\mathfrak q_i}(\partial_{A_{\mathfrak q_i}}(a, b))
\end{align*}
The second equality holds by Lemma \ref{chow-lemma-multiply-period-length}.
Observe that
...
Lemma \ref{chow-lemma-powers-period-length-zero}
and the other two terms come from
Lemma \ref{chow-lemma-length-multiplication}.
...
$$
by Lemma \ref{chow-lemma-length-multiplication}.
On the other hand, we have
$$
...
$$
and this follows from Lemma \ref{chow-lemma-length-multiplication}
...
\source{stacks:0EAX}
\href{https://stacks.math.columbia.edu/tag/0EAX}{\texttt{Stacks tag 0EAX}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-key-nonzerodivisors}
...
Lemma \ref{chow-lemma-key-nonzerodivisors}.
\end{proof}
...
\source{stacks:0EAY}
\href{https://stacks.math.columbia.edu/tag/0EAY}{\texttt{Stacks tag 0EAY}}
\group{chow}

\uses{chow-lemma-milnor-gersten-low-degree}
...
$$
defined as in Section \ref{chow-section-tame-symbol}; see \cite{Kato-Milnor-K}.
...
Section \ref{chow-section-tame-symbol} can be used to extend the construction
...
\begin{definition}[Situation: Setup]
\label{chow-situation-setup}
\source{stacks:02QL}
\href{https://stacks.math.columbia.edu/tag/02QL}{\texttt{Stacks tag 02QL}}
\group{chow}
...
\medskip\noindent
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
...
\source{stacks:02QM}
\href{https://stacks.math.columbia.edu/tag/02QM}{\texttt{Stacks tag 02QM}}
\group{chow}

\uses{chow-situation-setup}
...
Situation \ref{chow-situation-setup} by
Morphisms, Lemma \ref{morphisms-lemma-ubiquity-uc}.
\end{example}

\begin{example}[Domain dimension 1]
\label{chow-example-domain-dimension-1}
\source{stacks:02QN}
\href{https://stacks.math.columbia.edu/tag/02QN}{\texttt{Stacks tag 02QN}}
\group{chow}
...
This is an example of Situation \ref{chow-situation-setup} by
Morphisms, Lemma \ref{morphisms-lemma-ubiquity-uc}.
\end{example}

\begin{example}[CM irreducible]
\label{chow-example-CM-irreducible}
\source{stacks:0F91}
\href{https://stacks.math.columbia.edu/tag/0F91}{\texttt{Stacks tag 0F91}}
\group{chow}
...
is an example of Situation \ref{chow-situation-setup}.
\end{example}
...
\begin{lemma}[Delta is dimension]
\label{chow-lemma-delta-is-dimension}
\source{stacks:02QO}
\href{https://stacks.math.columbia.edu/tag/02QO}{\texttt{Stacks tag 02QO}}
\group{chow}
...
\begin{definition}[Delta dimension]
\label{chow-definition-delta-dimension}
\source{stacks:02QP}
\href{https://stacks.math.columbia.edu/tag/02QP}{\texttt{Stacks tag 02QP}}
\group{chow}

\uses{chow-situation-setup}
Let $(S, \delta)$ as in Situation \ref{chow-situation-setup}.
...
\source{stacks:02QR}
\href{https://stacks.math.columbia.edu/tag/02QR}{\texttt{Stacks tag 02QR}}
\group{chow}
...
\begin{remark}[Cycles pointwise]
\label{chow-remark-cycles-pointwise}
\source{stacks:0GU2}
\href{https://stacks.math.columbia.edu/tag/0GU2}{\texttt{Stacks tag 0GU2}}
\group{chow}

\uses{chow-situation-setup, chow-remark-gersten-complex-milnor}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
...
$x \in X$ (see Remark \ref{chow-remark-gersten-complex-milnor}), and
...
\begin{definition}[Support cycle]
\label{chow-definition-support-cycle}
\source{stacks:0H46}
\href{https://stacks.math.columbia.edu/tag/0H46}{\texttt{Stacks tag 0H46}}
\group{chow}
...
\begin{definition}[Effective cycle]
\label{chow-definition-effective-cycle}
\source{stacks:0H47}
\href{https://stacks.math.columbia.edu/tag/0H47}{\texttt{Stacks tag 0H47}}
\group{chow}
...
\begin{lemma}[Multiplicity finite]
\label{chow-lemma-multiplicity-finite}
\source{stacks:02QT}
\href{https://stacks.math.columbia.edu/tag/02QT}{\texttt{Stacks tag 02QT}}
\group{chow}
...
\begin{definition}[Cycle associated to closed subscheme]
\label{chow-definition-cycle-associated-to-closed-subscheme}
\source{stacks:02QU}
\href{https://stacks.math.columbia.edu/tag/02QU}{\texttt{Stacks tag 02QU}}
\group{chow}

\uses{chow-situation-setup, chow-lemma-multiplicity-finite}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
Let $X$ be locally of finite type over $S$.
Let $Z \subset X$ be a closed subscheme.
\begin{enumerate}
...
(Lemma \ref{chow-lemma-multiplicity-finite})
...
\begin{lemma}[Length finite]
\label{chow-lemma-length-finite}
\source{stacks:02QW}
\href{https://stacks.math.columbia.edu/tag/02QW}{\texttt{Stacks tag 02QW}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-multiplicity-finite}
...
and (3) follows from
Lemma \ref{chow-lemma-multiplicity-finite} applied to $Z$.
...
\begin{definition}[Cycle associated to coherent sheaf]
\label{chow-definition-cycle-associated-to-coherent-sheaf}
\source{stacks:02QX}
\href{https://stacks.math.columbia.edu/tag/02QX}{\texttt{Stacks tag 02QX}}
\group{chow}

\uses{chow-situation-setup, chow-lemma-length-finite}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
Let $X$ be locally of finite type over $S$.
Let $\mathcal{F}$ be a coherent $\mathcal{O}_X$-module.
\begin{enumerate}
...
(Lemma \ref{chow-lemma-length-finite})
...
(This is a $k$-cycle by Lemma \ref{chow-lemma-length-finite}.)
\end{enumerate}
\end{definition}
...
\begin{lemma}[Cycle closed coherent]
\label{chow-lemma-cycle-closed-coherent}
\source{stacks:02QY}
\href{https://stacks.math.columbia.edu/tag/02QY}{\texttt{Stacks tag 02QY}}
\group{chow}
...
\begin{lemma}[Additivity sheaf cycle]
\label{chow-lemma-additivity-sheaf-cycle}
\source{stacks:02QZ}
\href{https://stacks.math.columbia.edu/tag/02QZ}{\texttt{Stacks tag 02QZ}}
\group{chow}
...
\begin{lemma}[Equal dimension]
\label{chow-lemma-equal-dimension}
\source{stacks:02R1}
\href{https://stacks.math.columbia.edu/tag/02R1}{\texttt{Stacks tag 02R1}}
\group{chow}
...
\begin{lemma}[Quasi compact locally finite]
\label{chow-lemma-quasi-compact-locally-finite}
\source{stacks:02R2}
\href{https://stacks.math.columbia.edu/tag/02R2}{\texttt{Stacks tag 02R2}}
\group{chow}
...
\source{stacks:02R4}
\href{https://stacks.math.columbia.edu/tag/02R4}{\texttt{Stacks tag 02R4}}
\group{chow}

\uses{chow-situation-setup, chow-lemma-equal-dimension, chow-lemma-quasi-compact-locally-finite}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
Let $X$, $Y$ be locally of finite type over $S$.
Let $f : X \to Y$ be a morphism.
Assume $f$ is proper.
...
by Lemma \ref{chow-lemma-equal-dimension}.
...
by Lemma \ref{chow-lemma-quasi-compact-locally-finite} above.
\end{enumerate}
\end{definition}
...
\begin{lemma}[Compose pushforward]
\label{chow-lemma-compose-pushforward}
\source{stacks:02R5}
\href{https://stacks.math.columbia.edu/tag/02R5}{\texttt{Stacks tag 02R5}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-equal-dimension}
...
W''
$$
both satisfy the hypotheses of Lemma \ref{chow-lemma-equal-dimension}. Hence
$$
...
\begin{lemma}[Exact sequence closed]
\label{chow-lemma-exact-sequence-closed}
\source{stacks:0F92}
\href{https://stacks.math.columbia.edu/tag/0F92}{\texttt{Stacks tag 0F92}}
\group{chow}
...
$$
\begin{array}{cccc}Z_k(X_1 \cap X_2) \longrightarrow & Z_k(X_1) \oplus Z_k(X_2) \longrightarrow & Z_k(X) \longrightarrow & 0\end{array}
$$
...
\begin{lemma}[Cycle push sheaf]
\label{chow-lemma-cycle-push-sheaf}
\source{stacks:02R6}
\href{https://stacks.math.columbia.edu/tag/02R6}{\texttt{Stacks tag 02R6}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-cycle-closed-coherent, chow-lemma-multiplicity-finite}

Part (1) follows from (2) and Lemma \ref{chow-lemma-cycle-closed-coherent}.
...
$$
\begin{array}{cc}Z \underset{i}{\longrightarrow}\underset{f|_Z}{\downarrow} & X \overset{f}{\downarrow} \\ Z' \overset{i'}{\longrightarrow} & Y\end{array}
$$
...
(see Lemma \ref{chow-lemma-multiplicity-finite}). Since $f$ is quasi-compact
...
\begin{lemma}[Flat inverse image dimension]
\label{chow-lemma-flat-inverse-image-dimension}
\source{stacks:02R8}
\href{https://stacks.math.columbia.edu/tag/02R8}{\texttt{Stacks tag 02R8}}
\group{chow}
...
\begin{lemma}[Inverse image locally finite]
\label{chow-lemma-inverse-image-locally-finite}
\source{stacks:02R9}
\href{https://stacks.math.columbia.edu/tag/02R9}{\texttt{Stacks tag 02R9}}
\group{chow}
...
$$
\begin{array}{cc}f^{-1}(Z) \longrightarrow\downarrow & X \downarrow \\ Z \longrightarrow & Y\end{array}
$$
...
\begin{definition}[Flat pullback]
\label{chow-definition-flat-pullback}
\source{stacks:02RB}
\href{https://stacks.math.columbia.edu/tag/02RB}{\texttt{Stacks tag 02RB}}
\group{chow}

\uses{chow-situation-setup, chow-lemma-flat-inverse-image-dimension, chow-lemma-inverse-image-locally-finite}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
Let $X$, $Y$ be locally of finite type over $S$.
Let $f : X \to Y$ be a morphism.
Assume $f$ is flat of relative dimension $r$.
...
by Lemma \ref{chow-lemma-flat-inverse-image-dimension}.
...
The sum is locally finite by Lemma \ref{chow-lemma-inverse-image-locally-finite}.
...
\begin{lemma}[Exact sequence open]
\label{chow-lemma-exact-sequence-open}
\source{stacks:02RC}
\href{https://stacks.math.columbia.edu/tag/02RC}{\texttt{Stacks tag 02RC}}
\group{chow}
...
$$
\begin{array}{cccc}Z_k(Y) \overset{i_*}{\longrightarrow} & Z_k(X) \overset{j^*}{\longrightarrow} & Z_k(U) \longrightarrow & 0\end{array}
$$
...
\begin{lemma}[Compose flat pullback]
\label{chow-lemma-compose-flat-pullback}
\source{stacks:02RD}
\href{https://stacks.math.columbia.edu/tag/02RD}{\texttt{Stacks tag 02RD}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-flat-inverse-image-dimension}
...
cases follows from Lemma \ref{chow-lemma-flat-inverse-image-dimension}.
Let $\xi'' \in W''$, $\xi' \in W'$
...
\begin{lemma}[Pullback coherent]
\label{chow-lemma-pullback-coherent}
\source{stacks:02RE}
\href{https://stacks.math.columbia.edu/tag/02RE}{\texttt{Stacks tag 02RE}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-flat-inverse-image-dimension, chow-lemma-cycle-closed-coherent, chow-lemma-length-finite}

The statements on dimensions follow immediately from
Lemma \ref{chow-lemma-flat-inverse-image-dimension}.
Part (1) follows from part (2) by Lemma \ref{chow-lemma-cycle-closed-coherent}
...
\begin{lemma}[Flat pullback proper pushforward]
\label{chow-lemma-flat-pullback-proper-pushforward}
\source{stacks:02RG}
\href{https://stacks.math.columbia.edu/tag/02RG}{\texttt{Stacks tag 02RG}}
\group{chow}
...
Let
$$
\begin{array}{cc}X' \underset{g'}{\longrightarrow}\underset{f'}{\downarrow} & X \overset{f}{\downarrow} \\ Y' \overset{g}{\longrightarrow} & Y\end{array}
$$
...
\begin{proof}
\uses{chow-lemma-cycle-closed-coherent, chow-lemma-cycle-push-sheaf, chow-lemma-pullback-coherent}
...
Lemma \ref{chow-lemma-cycle-closed-coherent}.
By Lemmas \ref{chow-lemma-cycle-push-sheaf} and
\ref{chow-lemma-pullback-coherent} it therefore suffices
...
\begin{lemma}[Finite flat]
\label{chow-lemma-finite-flat}
\source{stacks:02RH}
\href{https://stacks.math.columbia.edu/tag/02RH}{\texttt{Stacks tag 02RH}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-pullback-coherent, chow-lemma-cycle-push-sheaf}
...
$$
where we have used Lemmas \ref{chow-lemma-pullback-coherent} and
...
\begin{lemma}[Divisor delta dimension]
\label{chow-lemma-divisor-delta-dimension}
\source{stacks:02RK}
\href{https://stacks.math.columbia.edu/tag/02RK}{\texttt{Stacks tag 02RK}}
\group{chow}
...
\begin{lemma}[Finite in codimension one]
\label{chow-lemma-finite-in-codimension-one}
\source{stacks:02RM}
\href{https://stacks.math.columbia.edu/tag/02RM}{\texttt{Stacks tag 02RM}}
\group{chow}
...
\source{stacks:02RO}
\href{https://stacks.math.columbia.edu/tag/02RO}{\texttt{Stacks tag 02RO}}
\group{chow}

\uses{chow-situation-setup, chow-lemma-divisor-delta-dimension}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
Let $X$ be locally of finite type over $S$. Assume $X$ is
...
Lemma \ref{chow-lemma-divisor-delta-dimension}.
\end{definition}
...
\begin{lemma}[Flat pullback principal divisor]
\label{chow-lemma-flat-pullback-principal-divisor}
\source{stacks:02RR}
\href{https://stacks.math.columbia.edu/tag/02RR}{\texttt{Stacks tag 02RR}}
\group{chow}
...
\begin{lemma}[Proper pushforward alteration]
\label{chow-lemma-proper-pushforward-alteration}
\source{stacks:02RT}
\href{https://stacks.math.columbia.edu/tag/02RT}{\texttt{Stacks tag 02RT}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-finite-in-codimension-one}
...
Lemma \ref{chow-lemma-finite-in-codimension-one}
...
\begin{lemma}[Rational function]
\label{chow-lemma-rational-function}
\source{stacks:02RQ}
\href{https://stacks.math.columbia.edu/tag/02RQ}{\texttt{Stacks tag 02RQ}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-divisor-delta-dimension, chow-lemma-cycle-push-sheaf, chow-lemma-proper-pushforward-alteration}
...
By Lemma \ref{chow-lemma-cycle-push-sheaf} we
...
Lemma \ref{chow-lemma-proper-pushforward-alteration}.
\end{proof}

The following lemma says that the degree of a principal divisor on
a proper curve is zero.

\begin{lemma}[Curve principal divisor]
\label{chow-lemma-curve-principal-divisor}
\source{stacks:02RU}
\href{https://stacks.math.columbia.edu/tag/02RU}{\texttt{Stacks tag 02RU}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-rational-function, chow-lemma-finite-flat, chow-lemma-finite-in-codimension-one}

Consider the diagram
$$
\begin{array}{cc}Y \underset{p}{\longrightarrow}\underset{q}{\downarrow} & X \overset{c}{\downarrow} \\ \mathbf{P}^1_K \overset{c'}{\longrightarrow} & \Spec(K)\end{array}
$$
that we constructed in Lemma \ref{chow-lemma-rational-function}
...
Then by Lemma \ref{chow-lemma-finite-flat} we get
...
by Lemma \ref{chow-lemma-finite-in-codimension-one}.
...
pretty strange phenomena, see Example \ref{chow-example-weird}.
...
\source{stacks:02RW}
\href{https://stacks.math.columbia.edu/tag/02RW}{\texttt{Stacks tag 02RW}}
\group{chow}
...
\begin{remark}[Chow group pointwise]
\label{chow-remark-chow-group-pointwise}
\source{stacks:0GU3}
\href{https://stacks.math.columbia.edu/tag/0GU3}{\texttt{Stacks tag 0GU3}}
\group{chow}

\uses{chow-situation-setup, chow-remark-cycles-pointwise, chow-remark-gersten-complex-milnor, chow-definition-rational-equivalence}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
Let $X$ be locally of finite type over $S$. Let $k \in \mathbf{Z}$.
...
Remark \ref{chow-remark-cycles-pointwise} and in addition
\begin{enumerate}
...
Remark \ref{chow-remark-cycles-pointwise}.
\end{enumerate}
The fact that we obtain a presentation of $\CH_k(X)$ follows
immediately by comparing with Definition \ref{chow-definition-rational-equivalence}.
\end{remark}

A very simple but important lemma is the following.

\begin{lemma}[Restrict to open]
\label{chow-lemma-restrict-to-open}
\source{stacks:02RX}
\href{https://stacks.math.columbia.edu/tag/02RX}{\texttt{Stacks tag 02RX}}
\group{chow}
...
$$
\begin{array}{cccc}\CH_k(Y) \overset{i_*}{\longrightarrow} & \CH_k(X) \overset{j^*}{\longrightarrow} & \CH_k(U) \longrightarrow & 0\end{array}
$$
is an exact complex of abelian groups.
\end{lemma}

\begin{proof}
\uses{chow-lemma-exact-sequence-open}
...
Lemma \ref{chow-lemma-exact-sequence-open}).
\end{proof}

\begin{lemma}[Exact sequence closed chow]
\label{chow-lemma-exact-sequence-closed-chow}
\source{stacks:0F94}
\href{https://stacks.math.columbia.edu/tag/0F94}{\texttt{Stacks tag 0F94}}
\group{chow}
...
For every $k \in \mathbf{Z}$ the sequence of abelian groups
$$
\begin{array}{cccc}\CH_k(X_1 \cap X_2) \longrightarrow & \CH_k(X_1) \oplus \CH_k(X_2) \longrightarrow & \CH_k(X) \longrightarrow & 0\end{array}
$$
...
\begin{proof}
\uses{chow-lemma-exact-sequence-closed}

By Lemma \ref{chow-lemma-exact-sequence-closed} the arrow
...
\source{stacks:02RY}
\href{https://stacks.math.columbia.edu/tag/02RY}{\texttt{Stacks tag 02RY}}
\group{chow}

\uses{chow-example-field}
Here is a ``strange'' example.
Suppose that $S$ is the spectrum of a field $k$
with $\delta$ as in Example \ref{chow-example-field}.
...
\begin{remark}[Infinite sums rational equivalences]
\label{chow-remark-infinite-sums-rational-equivalences}
\source{stacks:02RZ}
\href{https://stacks.math.columbia.edu/tag/02RZ}{\texttt{Stacks tag 02RZ}}
\group{chow}
...
\begin{lemma}[Prepare flat pullback rational equivalence]
\label{chow-lemma-prepare-flat-pullback-rational-equivalence}
\source{stacks:0EPH}
\href{https://stacks.math.columbia.edu/tag/0EPH}{\texttt{Stacks tag 0EPH}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-flat-inverse-image-dimension, chow-lemma-additivity-divisors-restricted}
...
subscheme of $Y$. By Lemma \ref{chow-lemma-flat-inverse-image-dimension}
...
Lemma \ref{chow-lemma-additivity-divisors-restricted}.
\end{proof}

\begin{lemma}[Flat pullback rational equivalence]
\label{chow-lemma-flat-pullback-rational-equivalence}
\source{stacks:02S1}
\href{https://stacks.math.columbia.edu/tag/02S1}{\texttt{Stacks tag 02S1}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-inverse-image-locally-finite, chow-lemma-flat-pullback-proper-pushforward, chow-lemma-prepare-flat-pullback-rational-equivalence, chow-remark-infinite-sums-rational-equivalences}
...
Lemma \ref{chow-lemma-inverse-image-locally-finite}.
...
By Lemma \ref{chow-lemma-flat-pullback-proper-pushforward}
we can write the sum above as
$$
\sum i'_{j, *}(f_j^*\text{div}(g_j))
$$
By Lemma \ref{chow-lemma-prepare-flat-pullback-rational-equivalence}
...
Remark \ref{chow-remark-infinite-sums-rational-equivalences}.
\end{proof}

\begin{lemma}[Proper pushforward rational equivalence]
\label{chow-lemma-proper-pushforward-rational-equivalence}
\source{stacks:02S2}
\href{https://stacks.math.columbia.edu/tag/02S2}{\texttt{Stacks tag 02S2}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-quasi-compact-locally-finite, chow-lemma-compose-pushforward, chow-lemma-curve-principal-divisor, chow-lemma-proper-pushforward-alteration}
...
in $Y$ by Lemma \ref{chow-lemma-quasi-compact-locally-finite}.
...
$$
\begin{array}{cc}W \underset{i}{\longrightarrow}\underset{p'}{\downarrow} & X \overset{p}{\downarrow} \\ W' \overset{i'}{\longrightarrow} & Y\end{array}
$$
Note that $p_*i_*\text{div}(f) = i'_*(p')_*\text{div}(f)$ by
Lemma \ref{chow-lemma-compose-pushforward}. As explained above
...
Here is a diagram
$$
\begin{array}{cc}W_\eta \longrightarrow\underset{c}{\downarrow} & W \overset{p'}{\downarrow} \\ \Spec(K) \longrightarrow & W'\end{array}
$$
...
By Lemma \ref{chow-lemma-curve-principal-divisor} this is zero.

\medskip\noindent
The case $\dim_\delta(W') = k + 1$. In this case
Lemma \ref{chow-lemma-proper-pushforward-alteration} applies,
...
\begin{lemma}[Rational equivalence family]
\label{chow-lemma-rational-equivalence-family}
\source{stacks:02S4}
\href{https://stacks.math.columbia.edu/tag/02S4}{\texttt{Stacks tag 02S4}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-rational-function, chow-lemma-proper-pushforward-rational-equivalence}
...
Lemma \ref{chow-lemma-rational-function} we have
$[W_0]_k \sim_{rat} [W_\infty]_k$ as cycles on $W$. Hence part (2) follows from
Lemma \ref{chow-lemma-proper-pushforward-rational-equivalence} as clearly
...
\begin{proof}
\uses{chow-lemma-rational-equivalence-family, chow-lemma-additivity-divisors-restricted}
...
follows from Lemma \ref{chow-lemma-rational-equivalence-family}.
...
\begin{lemma}[Coherent sheaf cross p1]
\label{chow-lemma-coherent-sheaf-cross-p1}
\source{stacks:02S6}
\href{https://stacks.math.columbia.edu/tag/02S6}{\texttt{Stacks tag 02S6}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-length-finite, chow-lemma-rational-equivalence-family, chow-lemma-additivity-divisors-restricted}
...
with $n_i > 0$ as per definition. Note that $\{W_i\}$
is a locally finite collection of closed subsets of
$X \times_S \mathbf{P}^1_S$ by Lemma \ref{chow-lemma-length-finite}.
We claim that
$$
...
\source{stacks:0GU5}
\href{https://stacks.math.columbia.edu/tag/0GU5}{\texttt{Stacks tag 0GU5}}
\group{chow}
...
The exact sequence of Lemma \ref{chow-lemma-envelope}
is the main motivation for the definition.

\begin{lemma}[Composition envelope]
\label{chow-lemma-composition-envelope}
\source{stacks:0GU6}
\href{https://stacks.math.columbia.edu/tag/0GU6}{\texttt{Stacks tag 0GU6}}
\group{chow}
...
\begin{lemma}[Base change envelope]
\label{chow-lemma-base-change-envelope}
\source{stacks:0GU7}
\href{https://stacks.math.columbia.edu/tag/0GU7}{\texttt{Stacks tag 0GU7}}
\group{chow}
...
\begin{lemma}[Envelope]
\label{chow-lemma-envelope}
\source{stacks:0GU8}
\href{https://stacks.math.columbia.edu/tag/0GU8}{\texttt{Stacks tag 0GU8}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-compose-pushforward, chow-lemma-quasi-compact-locally-finite}

Since $f$ is an envelope, $f$ is proper and hence pushforward on
cycles and cycle classes is defined, see
Sections \ref{chow-section-proper-pushforward} and \ref{chow-section-push-pull}.
...
Lemma \ref{chow-lemma-compose-pushforward}.
...
(This uses Lemma \ref{chow-lemma-compose-pushforward}.)
...
(Lemma \ref{chow-lemma-quasi-compact-locally-finite})
...
\begin{lemma}[Serre subcategories]
\label{chow-lemma-Serre-subcategories}
\source{stacks:02S8}
\href{https://stacks.math.columbia.edu/tag/02S8}{\texttt{Stacks tag 02S8}}
\group{chow}
...
\begin{lemma}[Cycles k group]
\label{chow-lemma-cycles-k-group}
\source{stacks:02S9}
\href{https://stacks.math.columbia.edu/tag/02S9}{\texttt{Stacks tag 02S9}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-additivity-sheaf-cycle}
...
Lemma \ref{chow-lemma-additivity-sheaf-cycle}. And $[\mathcal{F}]_k = 0$
...
\begin{lemma}[Finite cycles k group]
\label{chow-lemma-finite-cycles-k-group}
\source{stacks:0FDR}
\href{https://stacks.math.columbia.edu/tag/0FDR}{\texttt{Stacks tag 0FDR}}
\group{chow}

\uses{chow-situation-setup, chow-lemma-cycles-k-group}
Let $\pi : X \to Y$ be a finite morphism of schemes locally of finite type
over $(S, \delta)$ as in Situation \ref{chow-situation-setup}. Then
...
their quotients. The maps of Lemma \ref{chow-lemma-cycles-k-group}
fit into a commutative diagram
$$
\begin{array}{ccc}Z_k(X) \overset{\pi_*}{\downarrow}\longrightarrow & K_0(\textit{Coh}_{\leq k}(X)/\textit{Coh}_{\leq k - 1}(X))
\overset{\pi_*}{\downarrow}\longrightarrow & Z_k(X) \overset{\pi_*}{\downarrow} \\ Z_k(Y) \longrightarrow & K_0(\textit{Coh}_{\leq k}(Y)/\textit{Coh}_{\leq k - 1}(Y)) \longrightarrow & Z_k(Y)\end{array}
$$
\end{lemma}

\begin{proof}
\uses{chow-lemma-cycle-push-sheaf}
...
Lemma \ref{chow-lemma-cycle-push-sheaf}.
Since the horizontal arrows are bijections, we find that
we have commutativity on the left as well.
\end{proof}

\begin{lemma}[From chow to K]
\label{chow-lemma-from-chow-to-K}
\source{stacks:0FDS}
\href{https://stacks.math.columbia.edu/tag/0FDS}{\texttt{Stacks tag 0FDS}}
\group{chow}

\uses{chow-situation-setup, chow-lemma-cycles-k-group}
Let $X$ be a scheme locally of finite type over $(S, \delta)$
as in Situation \ref{chow-situation-setup}. There is a canonical map
$$
\CH_k(X)
\longrightarrow
...
from Lemma \ref{chow-lemma-cycles-k-group}.
\end{lemma}

\begin{proof}
\uses{chow-definition-rational-equivalence, chow-lemma-finite-cycles-k-group}
...
Definition \ref{chow-definition-rational-equivalence}.
Observe that
$$
...
Lemma \ref{chow-lemma-finite-cycles-k-group} to reduce to the case of $W$.
...
\begin{remark}[Good cases K A]
\label{chow-remark-good-cases-K-A}
\source{stacks:02SD}
\href{https://stacks.math.columbia.edu/tag/02SD}{\texttt{Stacks tag 02SD}}
\group{chow}

\uses{chow-situation-setup, chow-lemma-cycles-rational-equivalence-K-group, chow-lemma-from-chow-to-K}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
Let $X$ be a scheme locally of finite type over $S$.
We will see later (in Lemma \ref{chow-lemma-cycles-rational-equivalence-K-group})
that the map
$$
\CH_k(X)
\longrightarrow
...
$$
of Lemma \ref{chow-lemma-from-chow-to-K} is injective.
...
\begin{lemma}[K coherent supported on closed]
\label{chow-lemma-K-coherent-supported-on-closed}
\source{stacks:0FDT}
\href{https://stacks.math.columbia.edu/tag/0FDT}{\texttt{Stacks tag 0FDT}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-from-chow-to-K}
...
$$
Exactly as in the proof of Lemma \ref{chow-lemma-from-chow-to-K} this filtration
...
Lemma \ref{chow-lemma-from-chow-to-K}. Since the coherent module
$\bigoplus_{p \geq 0} \mathcal{F}^p/\mathcal{F}^{p + 1}$
...
\begin{definition}[Divisor invertible sheaf]
\label{chow-definition-divisor-invertible-sheaf}
\source{stacks:02SJ}
\href{https://stacks.math.columbia.edu/tag/02SJ}{\texttt{Stacks tag 02SJ}}
\group{chow}
...
by Lemma \ref{chow-lemma-divisor-delta-dimension}.
...
Let $X$ and $S$ be as in Definition \ref{chow-definition-divisor-invertible-sheaf}
...
\begin{lemma}[Compute c1]
\label{chow-lemma-compute-c1}
\source{stacks:02SK}
\href{https://stacks.math.columbia.edu/tag/02SK}{\texttt{Stacks tag 02SK}}
\group{chow}
...
The following lemma will be superseded by the more general
Lemma \ref{chow-lemma-flat-pullback-cap-c1}.

\begin{lemma}[Flat pullback divisor invertible sheaf]
\label{chow-lemma-flat-pullback-divisor-invertible-sheaf}
\source{stacks:02SM}
\href{https://stacks.math.columbia.edu/tag/02SM}{\texttt{Stacks tag 02SM}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-flat-pullback-principal-divisor}
...
Lemma \ref{chow-lemma-flat-pullback-principal-divisor}.
\end{proof}
...
\begin{definition}[Cap c1]
\label{chow-definition-cap-c1}
\source{stacks:02SO}
\href{https://stacks.math.columbia.edu/tag/02SO}{\texttt{Stacks tag 02SO}}
\group{chow}

\uses{chow-situation-setup, chow-definition-divisor-invertible-sheaf}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
Let $X$ be locally of finite type over $S$.
Let $\mathcal{L}$ be an invertible $\mathcal{O}_X$-module.
...
Definition \ref{chow-definition-divisor-invertible-sheaf}.
...
\begin{lemma}[C1 cap additive]
\label{chow-lemma-c1-cap-additive}
\source{stacks:02SP}
\href{https://stacks.math.columbia.edu/tag/02SP}{\texttt{Stacks tag 02SP}}
\group{chow}
...
\begin{lemma}[Prepare geometric cap]
\label{chow-lemma-prepare-geometric-cap}
\source{stacks:0EPI}
\href{https://stacks.math.columbia.edu/tag/0EPI}{\texttt{Stacks tag 0EPI}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-additivity-divisors-restricted}
...
\begin{lemma}[Geometric cap]
\label{chow-lemma-geometric-cap}
\source{stacks:02SQ}
\href{https://stacks.math.columbia.edu/tag/02SQ}{\texttt{Stacks tag 02SQ}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-compute-c1, chow-lemma-prepare-geometric-cap}
...
zero, and hence is a regular section. By Lemma \ref{chow-lemma-compute-c1}
we see that $[Z(s_i)]_k$ represents $c_1(\mathcal{L}|_{Y_i})$.
Hence by definition
$$
c_1(\mathcal{L}) \cap [Y]_{k + 1} = \sum n_i[Z(s_i)]_k
$$
Thus the result follows from Lemma \ref{chow-lemma-prepare-geometric-cap}.
\end{proof}
...
\begin{lemma}[Prepare flat pullback cap c1]
\label{chow-lemma-prepare-flat-pullback-cap-c1}
\source{stacks:0EPJ}
\href{https://stacks.math.columbia.edu/tag/0EPJ}{\texttt{Stacks tag 0EPJ}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-compute-c1, chow-lemma-pullback-coherent}
...
= [f^{-1}(Z(s))]_{k + r - 1},
$$
by Lemmas \ref{chow-lemma-compute-c1} and \ref{chow-lemma-pullback-coherent}.
Since $Z(f^*(s)) = f^{-1}(Z(s))$ we win.
\end{proof}

\begin{lemma}[Flat pullback cap c1]
\label{chow-lemma-flat-pullback-cap-c1}
\source{stacks:02SS}
\href{https://stacks.math.columbia.edu/tag/02SS}{\texttt{Stacks tag 02SS}}
\group{chow}
...
\begin{proof}
\uses{chow-remark-infinite-sums-rational-equivalences, chow-lemma-prepare-flat-pullback-cap-c1}
...
$$
\begin{array}{cc}W' \longrightarrow\underset{h}{\downarrow} & X \overset{f}{\downarrow} \\ W \longrightarrow & Y\end{array}
$$
We have to show that
...
each $i$. By Lemma \ref{chow-lemma-prepare-flat-pullback-cap-c1}
...
\begin{lemma}[Equal c1 as cycles]
\label{chow-lemma-equal-c1-as-cycles}
\source{stacks:02ST}
\href{https://stacks.math.columbia.edu/tag/02ST}{\texttt{Stacks tag 02ST}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-proper-pushforward-alteration}
...
\begin{lemma}[Pushforward cap c1]
\label{chow-lemma-pushforward-cap-c1}
\source{stacks:02SU}
\href{https://stacks.math.columbia.edu/tag/02SU}{\texttt{Stacks tag 02SU}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-equal-c1-as-cycles}
...
$$
\begin{array}{cc}X' = \coprod W_i \underset{q}{\longrightarrow}\underset{p'}{\downarrow} & X \overset{p}{\downarrow} \\ Y' = \coprod W'_i \overset{q'}{\longrightarrow} & Y.\end{array}
$$
...
Lemma \ref{chow-lemma-equal-c1-as-cycles}.
\end{proof}
...
$$
see Section \ref{chow-section-tame-symbol}.

\begin{lemma}[Key formula]

\label{chow-lemma-key-formula}
\source{stacks:0AYC}
\href{https://stacks.math.columbia.edu/tag/0AYC}{\texttt{Stacks tag 0AYC}}
\group{chow}
...
$$
which is zero by the key Lemma \ref{chow-lemma-milnor-gersten-low-degree}.
\end{proof}

\begin{remark}[Higher chow pointwise]
\label{chow-remark-higher-chow-pointwise}
\source{stacks:0GU9}
\href{https://stacks.math.columbia.edu/tag/0GU9}{\texttt{Stacks tag 0GU9}}
\group{chow}

\uses{chow-situation-setup, chow-remark-chow-group-pointwise, chow-remark-gersten-complex-milnor, chow-lemma-milnor-gersten-low-degree}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
Let $X$ be locally of finite type over $S$. Let $k \in \mathbf{Z}$.
...
Remark \ref{chow-remark-chow-group-pointwise} and in addition
\begin{enumerate}
\item $K_2^M(\kappa(x))$ is the degree $2$ part of
the Milnor K-theory of the residue field $\kappa(x)$ of the point
$x \in X$ (see Remark \ref{chow-remark-gersten-complex-milnor}) which
...
is the tame symbol constructed in Section \ref{chow-section-tame-symbol}.
\end{enumerate}
...
$$
The key algebraic Lemma \ref{chow-lemma-milnor-gersten-low-degree}
says exactly that this is zero.
\end{remark}

\begin{remark}[Higher chow]
\label{chow-remark-higher-chow}
\source{stacks:0GUA}
\href{https://stacks.math.columbia.edu/tag/0GUA}{\texttt{Stacks tag 0GUA}}
\group{chow}

\uses{chow-situation-setup, chow-remark-higher-chow-pointwise, chow-remark-chow-group-pointwise, chow-lemma-restrict-to-open}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
Let $X$ be locally of finite type over $S$. Let $k \in \mathbf{Z}$.
The complex in Remark \ref{chow-remark-higher-chow-pointwise} and the
presentation of $\CH_k(X)$ in Remark \ref{chow-remark-chow-group-pointwise}
...
of Remark \ref{chow-remark-higher-chow-pointwise}. Applying the snake lemma
...
$$
extending the canonical exact sequence of Lemma \ref{chow-lemma-restrict-to-open}.
...
\begin{lemma}[Commutativity on integral]
\label{chow-lemma-commutativity-on-integral}
\source{stacks:02TH}
\href{https://stacks.math.columbia.edu/tag/02TH}{\texttt{Stacks tag 02TH}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-key-formula}

Immediate from the key Lemma \ref{chow-lemma-key-formula}
...
\source{stacks:02TI}
\href{https://stacks.math.columbia.edu/tag/02TI}{\texttt{Stacks tag 02TI}}
\group{chow}
...
\begin{proof}
\uses{chow-definition-cap-c1, chow-definition-rational-equivalence, chow-lemma-pushforward-cap-c1, chow-lemma-commutativity-on-integral, chow-lemma-c1-cap-additive}

Let $\alpha \in Z_{k + 1}(X)$, and $\alpha \sim_{rat} 0$.
We have to show that $c_1(\mathcal{L}) \cap \alpha$
as defined in Definition \ref{chow-definition-cap-c1} is zero.
By Definition \ref{chow-definition-rational-equivalence} there
...
By Lemma \ref{chow-lemma-pushforward-cap-c1} we have
...
By Lemma \ref{chow-lemma-commutativity-on-integral}
we conclude that
$$
c_1(\mathcal{L}) \cap \alpha = c_1(\mathcal{O}_X) \cap \beta.
$$
However, by Lemma \ref{chow-lemma-c1-cap-additive} we see that the right hand side
...
Lemma \ref{chow-lemma-factors}. We will denote $c_1(\mathcal{L})^s \cap -$
the $s$-fold iterate of this operation for all $s \geq 0$.

\begin{lemma}[Cap commutative]
\label{chow-lemma-cap-commutative}
\source{stacks:02TJ}
\href{https://stacks.math.columbia.edu/tag/02TJ}{\texttt{Stacks tag 02TJ}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-pushforward-cap-c1, chow-lemma-commutativity-on-integral}
...
Lemma \ref{chow-lemma-pushforward-cap-c1} we see that
$c_1(\mathcal{L}) \cap c_1(\mathcal{N}) \cap \alpha
...
from Lemma \ref{chow-lemma-commutativity-on-integral} and the definitions.
\end{proof}
...
Remark \ref{chow-remark-pullback-pairs} and
Lemmas \ref{chow-lemma-closed-in-X-gysin}, \ref{chow-lemma-gysin-flat-pullback}, and
...
(Remark \ref{chow-remark-generalize-to-virtual}) or to
pseudo-divisors (Remark \ref{chow-remark-generalize-to-pseudo-divisor}).
...
\begin{definition}[Gysin homomorphism]
\label{chow-definition-gysin-homomorphism}
\source{stacks:02T8}
\href{https://stacks.math.columbia.edu/tag/02T8}{\texttt{Stacks tag 02T8}}
\group{chow}
...
\begin{remark}[Generalize to virtual]
\label{chow-remark-generalize-to-virtual}
\source{stacks:0B70}
\href{https://stacks.math.columbia.edu/tag/0B70}{\texttt{Stacks tag 0B70}}
\group{chow}

\uses{chow-situation-setup, chow-definition-gysin-homomorphism}
Let $X$ be a scheme locally of finite type over $S$ as in
Situation \ref{chow-situation-setup}. Let $(D, \mathcal{N}, \sigma)$
...
Definition \ref{chow-definition-gysin-homomorphism}
generalizes to such triples, see
Section \ref{chow-section-gysin-higher-codimension}.
\end{remark}

\begin{remark}[Generalize to pseudo divisor]
\label{chow-remark-generalize-to-pseudo-divisor}
\source{stacks:0B7D}
\href{https://stacks.math.columbia.edu/tag/0B7D}{\texttt{Stacks tag 0B7D}}
\group{chow}

\uses{chow-situation-setup}
Let $X$ be a scheme locally of finite type over $S$ as in
Situation \ref{chow-situation-setup}. In \cite{F} a {\it pseudo-divisor} on $X$
...
\begin{lemma}[Support cap effective Cartier]
\label{chow-lemma-support-cap-effective-Cartier}
\source{stacks:02T9}
\href{https://stacks.math.columbia.edu/tag/02T9}{\texttt{Stacks tag 02T9}}
\group{chow}

\uses{chow-situation-setup, chow-definition-gysin-homomorphism}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}. Let $X$ be locally
of finite type over $S$. Let $(\mathcal{L}, s, i : D \to X)$ be as in
Definition \ref{chow-definition-gysin-homomorphism}. Let $\alpha$ be a
...
\begin{proof}
\uses{chow-lemma-geometric-cap, chow-definition-cap-c1, chow-definition-gysin-homomorphism}
...
by Lemma \ref{chow-lemma-geometric-cap}. So we have
$$
...
$$
in $\CH_k(X)$ by Definition \ref{chow-definition-cap-c1}.
The right hand side matches (termwise) the pushforward of the class
$i^*\alpha$ on $D$ from Definition \ref{chow-definition-gysin-homomorphism}.
Hence we win.
\end{proof}

\begin{lemma}[Easy gysin]
\label{chow-lemma-easy-gysin}
\source{stacks:02TB}
\href{https://stacks.math.columbia.edu/tag/02TB}{\texttt{Stacks tag 02TB}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-cycle-closed-coherent, chow-lemma-additivity-divisors-restricted}
...
See Lemma \ref{chow-lemma-cycle-closed-coherent}.
...
\begin{remark}[Gysin on cycles]
\label{chow-remark-gysin-on-cycles}
\source{stacks:0B6Z}
\href{https://stacks.math.columbia.edu/tag/0B6Z}{\texttt{Stacks tag 0B6Z}}
\group{chow}

\uses{chow-definition-gysin-homomorphism}
Let $X \to S$, $\mathcal{L}$, $s$, $i : D \to X$ be as in
Definition \ref{chow-definition-gysin-homomorphism} and assume
...
\begin{remark}[Pullback pairs]
\label{chow-remark-pullback-pairs}
\source{stacks:0B6Y}
\href{https://stacks.math.columbia.edu/tag/0B6Y}{\texttt{Stacks tag 0B6Y}}
\group{chow}

\uses{chow-situation-setup, chow-definition-gysin-homomorphism}
Let $f : X' \to X$ be a morphism of schemes locally of finite type over $S$
as in Situation \ref{chow-situation-setup}. Let $(\mathcal{L}, s, i : D \to X)$
be a triple as in Definition \ref{chow-definition-gysin-homomorphism}.
Then we can set $\mathcal{L}' = f^*\mathcal{L}$, $s' = f^*s$, and
$D' = X' \times_X D = Z(s')$. This gives a commutative diagram
$$
\begin{array}{cc}D' \underset{g}{\downarrow}\underset{i'}{\longrightarrow} & X' \overset{f}{\downarrow} \\ D \overset{i}{\longrightarrow} & X\end{array}
$$
and we can ask for various compatibilities between $i^*$ and $(i')^*$.
\end{remark}

\begin{lemma}[Closed in X gysin]
\label{chow-lemma-closed-in-X-gysin}
\source{stacks:02TA}
\href{https://stacks.math.columbia.edu/tag/02TA}{\texttt{Stacks tag 02TA}}
\group{chow}

\uses{chow-situation-setup, chow-definition-gysin-homomorphism, chow-remark-pullback-pairs}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
...
\begin{array}{cc}D' \underset{g}{\downarrow}\underset{i'}{\longrightarrow} & X' \overset{f}{\downarrow} \\ D \overset{i}{\longrightarrow} & X\end{array}
$$
as in Remark \ref{chow-remark-pullback-pairs}.
...
\begin{proof}
\uses{chow-lemma-equal-c1-as-cycles, chow-remark-infinite-sums-rational-equivalences}
...
Lemma \ref{chow-lemma-equal-c1-as-cycles}. Hence the
...
assertion of Lemma \ref{chow-lemma-equal-c1-as-cycles}.
By Remark \ref{chow-remark-infinite-sums-rational-equivalences}
the result follows for general $\alpha'$.
\end{proof}

\begin{lemma}[Gysin flat pullback]
\label{chow-lemma-gysin-flat-pullback}
\source{stacks:0B71}
\href{https://stacks.math.columbia.edu/tag/0B71}{\texttt{Stacks tag 0B71}}
\group{chow}

\uses{chow-situation-setup, chow-definition-gysin-homomorphism, chow-remark-pullback-pairs}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}. Let $f : X' \to X$
be a flat morphism of relative dimension $r$ of schemes locally of finite type
over $S$. Let $(\mathcal{L}, s, i : D \to X)$ be as in
Definition \ref{chow-definition-gysin-homomorphism}. Form the diagram
$$
\begin{array}{cc}D' \underset{g}{\downarrow}\underset{i'}{\longrightarrow} & X' \overset{f}{\downarrow} \\ D \overset{i}{\longrightarrow} & X\end{array}
$$
as in Remark \ref{chow-remark-pullback-pairs}.
...
\begin{proof}
\uses{chow-lemma-pullback-coherent, chow-lemma-flat-pullback-cap-c1, chow-remark-infinite-sums-rational-equivalences}
...
equality holds as cycles, see Lemma \ref{chow-lemma-pullback-coherent}.
In case $W \subset D$, then $W' \subset D'$ and $W' = g^{-1}(W)$
with $[W']_{k + 1 + r} = g^*[W]$ and equality holds in
$\CH_{k + r}(D')$ by Lemma \ref{chow-lemma-flat-pullback-cap-c1}.
By Remark \ref{chow-remark-infinite-sums-rational-equivalences}
the result follows for general $\alpha'$.
\end{proof}
...
\begin{lemma}[Gysin factors general]
\label{chow-lemma-gysin-factors-general}
\source{stacks:02TM}
\href{https://stacks.math.columbia.edu/tag/02TM}{\texttt{Stacks tag 02TM}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-compute-c1, chow-lemma-key-formula}
...
Section \ref{chow-section-key} to our current situation.
...
Lemma \ref{chow-lemma-compute-c1}. Similarly,
$$
c_1(\mathcal{N}) \cap [D]_{n - 1} =
\sum \text{ord}_{B_i}(f_i) \text{div}_{\mathcal{N}|_{Z_i}}(t_i|_{Z_i})
$$
The key formula (Lemma \ref{chow-lemma-key-formula}) gives the equality
$$
\sum \left(
\text{ord}_{B_i}(f_i) \text{div}_{\mathcal{N}|_{Z_i}}(t_i|_{Z_i}) -
\text{ord}_{B_i}(g_i) \text{div}_{\mathcal{L}|_{Z_i}}(s_i|_{Z_i}) \right) =
...
\begin{lemma}[Gysin factors]
\label{chow-lemma-gysin-factors}
\source{stacks:02TO}
\href{https://stacks.math.columbia.edu/tag/02TO}{\texttt{Stacks tag 02TO}}
\group{chow}
...
\begin{proof}
\uses{chow-remark-pullback-pairs, chow-lemma-closed-in-X-gysin, chow-lemma-proper-pushforward-rational-equivalence, chow-lemma-factors, chow-lemma-gysin-factors-general, chow-lemma-c1-cap-additive}
...
$$
\begin{array}{cc}D' \underset{q}{\downarrow}\underset{i'}{\longrightarrow} & X' \overset{p}{\downarrow} \\ D \overset{i}{\longrightarrow} & X\end{array}
$$
of Remark \ref{chow-remark-pullback-pairs}. Since $X' \to X$ is proper
we see that $i^*p_* = q_*(i')^*$ by Lemma \ref{chow-lemma-closed-in-X-gysin}.
As we know that $q_*$ factors through rational equivalence
(Lemma \ref{chow-lemma-proper-pushforward-rational-equivalence}), it suffices
...
This is rationally equivalent to zero by Lemma \ref{chow-lemma-factors}.
If $D \not = X$, then we see that $i^*\text{div}_X(f)$ is equal to
$c_1(\mathcal{O}_D) \cap [D]_{n - 1}$ in $\CH_{n - 2}(D)$ by
Lemma \ref{chow-lemma-gysin-factors-general}. Of course
capping with $c_1(\mathcal{O}_D)$ is the zero map
(Lemma \ref{chow-lemma-c1-cap-additive}).
\end{proof}

\begin{lemma}[Gysin back]
\label{chow-lemma-gysin-back}
\source{stacks:0F95}
\href{https://stacks.math.columbia.edu/tag/0F95}{\texttt{Stacks tag 0F95}}
\group{chow}

\uses{chow-situation-setup, chow-definition-gysin-homomorphism}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}. Let $X$ be locally
of finite type over $S$. Let $(\mathcal{L}, s, i : D \to X)$ be as in
Definition \ref{chow-definition-gysin-homomorphism}. Then
...
\begin{lemma}[Gysin commutes cap c1]
\label{chow-lemma-gysin-commutes-cap-c1}
\source{stacks:0B72}
\href{https://stacks.math.columbia.edu/tag/0B72}{\texttt{Stacks tag 0B72}}
\group{chow}

\uses{chow-situation-setup, chow-definition-gysin-homomorphism}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}. Let $X$ be
...
\begin{proof}
\uses{chow-lemma-gysin-factors, chow-lemma-pushforward-cap-c1, chow-lemma-cap-commutative, chow-lemma-gysin-factors-general}

With exactly the same proof as in Lemma \ref{chow-lemma-gysin-factors}
this follows from Lemmas
\ref{chow-lemma-pushforward-cap-c1},
\ref{chow-lemma-cap-commutative}, and
\ref{chow-lemma-gysin-factors-general}.
\end{proof}

\begin{lemma}[Gysin commutes gysin]
\label{chow-lemma-gysin-commutes-gysin}
\source{stacks:0B73}
\href{https://stacks.math.columbia.edu/tag/0B73}{\texttt{Stacks tag 0B73}}
\group{chow}
...
Definition \ref{chow-definition-gysin-homomorphism}. Then the diagram
$$
\begin{array}{cc}\CH_k(X) \underset{i^*}{\longrightarrow}\underset{(i')^*}{\downarrow} & \CH_{k - 1}(D) \overset{j^*}{\downarrow} \\ \CH_{k - 1}(D') \overset{(j')^*}{\longrightarrow} & \CH_{k - 2}(D \cap D')\end{array}
$$
commutes where each of the maps is a Gysin map.
\end{lemma}

\begin{proof}
\uses{chow-lemma-key-formula, chow-remark-infinite-sums-rational-equivalences}
...
$$
as in the discussion in Section \ref{chow-section-key}.
Then we see that $Z_i \subset D$ if $n_i \not = 0$ and
$Z'_i \subset D'$ if $n'_i \not = 0$. For each $i$, let $\xi_i \in Z_i$
be the generic point. As in Section \ref{chow-section-key} we choose
...
$$
The key formula (Lemma \ref{chow-lemma-key-formula}) now gives the equality
$$
\sum \left(
...
\begin{lemma}[Relative effective cartier]
\label{chow-lemma-relative-effective-cartier}
\source{stacks:02TR}
\href{https://stacks.math.columbia.edu/tag/02TR}{\texttt{Stacks tag 02TR}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-easy-gysin, chow-lemma-support-cap-effective-Cartier}
...
Cartier divisor on $p^{-1}W$. By Lemma \ref{chow-lemma-easy-gysin}
...
first apply Lemma \ref{chow-lemma-support-cap-effective-Cartier}.
\end{proof}
...
\begin{lemma}[Pullback affine fibres surjective]
\label{chow-lemma-pullback-affine-fibres-surjective}
\source{stacks:02TT}
\href{https://stacks.math.columbia.edu/tag/02TT}{\texttt{Stacks tag 02TT}}
\group{chow}
...
\begin{proof}
\uses{chow-remark-infinite-sums-rational-equivalences, chow-lemma-exact-sequence-open, chow-lemma-restrict-to-open}
...
$$
\begin{array}{cc}f^{-1}(Z_j) \longrightarrow\underset{f_j}{\downarrow} & X \overset{f}{\downarrow} \\ Z_j \longrightarrow & Y\end{array}
$$
...
for some $\beta \in Z_k(V)$. By Lemma \ref{chow-lemma-exact-sequence-open}
we see that
$\beta = \beta'|_V$ for some $\beta' \in Z_k(Y)$.
By the exact sequence
$\CH_k(f^{-1}(Y \setminus V)) \to \CH_k(X) \to \CH_k(f^{-1}(V))$
of Lemma \ref{chow-lemma-restrict-to-open}
...
\begin{lemma}[Linebundle]
\label{chow-lemma-linebundle}
\source{stacks:0B74}
\href{https://stacks.math.columbia.edu/tag/0B74}{\texttt{Stacks tag 0B74}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-pullback-affine-fibres-surjective, chow-lemma-relative-effective-cartier}

For surjectivity see Lemma \ref{chow-lemma-pullback-affine-fibres-surjective}.
...
Cartier divisor on $L$. Hence by Lemma \ref{chow-lemma-relative-effective-cartier}
we see that $o^* \circ p^* = \text{id}$ and we conclude that $p^*$ is
injective too.
\end{proof}

\begin{remark}[When isomorphism]
\label{chow-remark-when-isomorphism}
\source{stacks:02TU}
\href{https://stacks.math.columbia.edu/tag/02TU}{\texttt{Stacks tag 02TU}}
\group{chow}

\uses{chow-lemma-vectorbundle, chow-lemma-pullback-affine-fibres-surjective, chow-remark-higher-chow-isomorphism}
We will see later (Lemma \ref{chow-lemma-vectorbundle}) that if $X$ is a
vector bundle of rank $r$ over $Y$ then the pullback map
$\CH_k(Y) \to \CH_{k + r}(X)$
is an isomorphism. This is true whenever $X \to Y$ satisfies
the assumptions of Lemma \ref{chow-lemma-pullback-affine-fibres-surjective}, see
\cite[Lemma 2.2]{Totaro-group}. We will sketch a proof in
Remark \ref{chow-remark-higher-chow-isomorphism} using higher chow groups.
\end{remark}

\begin{lemma}[Linebundle formulae]
\label{chow-lemma-linebundle-formulae}
\source{stacks:0F96}
\href{https://stacks.math.columbia.edu/tag/0F96}{\texttt{Stacks tag 0F96}}
\group{chow}

\uses{chow-lemma-linebundle}
In the situation of Lemma \ref{chow-lemma-linebundle} denote $o : X \to L$
...
\begin{proof}
\uses{chow-lemma-linebundle, chow-lemma-relative-effective-cartier, chow-lemma-c1-cap-additive, chow-lemma-flat-pullback-cap-c1, chow-lemma-gysin-back}
...
Lemma \ref{chow-lemma-linebundle}. Of course (4) is the first
formula in Lemma \ref{chow-lemma-relative-effective-cartier}.

\medskip\noindent
Part (5) follows from the second formula in
Lemma \ref{chow-lemma-relative-effective-cartier},
additivity of capping with $c_1$ (Lemma \ref{chow-lemma-c1-cap-additive}),
and the fact that capping with $c_1$ commutes with flat pullback
(Lemma \ref{chow-lemma-flat-pullback-cap-c1}).

\medskip\noindent
Part (6) follows from Lemma \ref{chow-lemma-gysin-back}
and the fact that $o^*p^*\mathcal{L} = \mathcal{L}$.
\end{proof}

\begin{lemma}[Decompose section]
\label{chow-lemma-decompose-section}
\source{stacks:0F97}
\href{https://stacks.math.columbia.edu/tag/0F97}{\texttt{Stacks tag 0F97}}
\group{chow}
...
$$
\begin{array}{ccc}D_1 \underset{i_1}{\longrightarrow}\underset{p_1}{\downarrow} & L \overset{p}{\downarrow} & D_2 \overset{i_2}{\longleftarrow}\overset{p_2}{\downarrow} \\ D \overset{i}{\longrightarrow} & Y & D \underset{i}{\longleftarrow}\end{array}
$$
...
\begin{lemma}[Decompose section formulae]
\label{chow-lemma-decompose-section-formulae}
\source{stacks:0F98}
\href{https://stacks.math.columbia.edu/tag/0F98}{\texttt{Stacks tag 0F98}}
\group{chow}

\uses{chow-lemma-decompose-section, chow-situation-setup}
In the situation of Lemma \ref{chow-lemma-decompose-section}
assume $Y$ is locally of finite type over $(S, \delta)$ as in
Situation \ref{chow-situation-setup}. Then we have
$i_1^*p^*\alpha = p_1^*i^*\alpha$
in $\CH_k(D_1)$ for all $\alpha \in \CH_k(Y)$.
\end{lemma}

\begin{proof}
\uses{chow-lemma-c1-cap-additive, chow-lemma-flat-pullback-cap-c1, chow-lemma-linebundle-formulae}
...
additivity of Lemma \ref{chow-lemma-c1-cap-additive}.
Hence $p_1^*i^*[W] =
...
with flat pullback (Lemma \ref{chow-lemma-flat-pullback-cap-c1}).
Since $W_1 \cap W_2$ is the zero section of the line bundle
$W_1 \to W$ we see from Lemma \ref{chow-lemma-linebundle-formulae}
...
\begin{lemma}[Normal cone effective Cartier]
\label{chow-lemma-normal-cone-effective-Cartier}
\source{stacks:0F99}
\href{https://stacks.math.columbia.edu/tag/0F99}{\texttt{Stacks tag 0F99}}
\group{chow}

\uses{chow-situation-setup, chow-definition-gysin-homomorphism}
In Situation \ref{chow-situation-setup} let $X$ be a scheme locally
of finite type over $S$. Let $(\mathcal{L}, s, i : D \to X)$
be a triple as in Definition \ref{chow-definition-gysin-homomorphism}.
There exists a commutative diagram
$$
\begin{array}{cc}D' \underset{i'}{\longrightarrow}\underset{p}{\downarrow} & X' \overset{g}{\downarrow} \\ D \overset{i}{\longrightarrow} & X\end{array}
$$
such that
\begin{enumerate}
...
\begin{proof}
\uses{chow-definition-gysin-homomorphism, chow-lemma-decompose-section, chow-lemma-decompose-section-formulae, chow-lemma-linebundle}

Observe that $(i')^*$ is defined because we have the triple
$(\mathcal{O}_{X'}, s', i' : D' \to X')$ as in
Definition \ref{chow-definition-gysin-homomorphism}. Thus the statement makes sense.

\medskip\noindent
Set $\mathcal{L}_1 = \mathcal{O}_X$, $\mathcal{L}_2 = \mathcal{L}$
and apply Lemma \ref{chow-lemma-decompose-section} with the section $s$ of
$\mathcal{L} = \mathcal{L}_1 \otimes_{\mathcal{O}_X} \mathcal{L}_2$.
Take $D' = D_1$. The results now follow from the lemma, from
Lemma \ref{chow-lemma-decompose-section-formulae}
and injectivity by
Lemma \ref{chow-lemma-linebundle}.
\end{proof}

\begin{remark}[Higher chow isomorphism]
\label{chow-remark-higher-chow-isomorphism}
\source{stacks:0GUB}
\href{https://stacks.math.columbia.edu/tag/0GUB}{\texttt{Stacks tag 0GUB}}
\group{chow}

\uses{chow-situation-setup, chow-lemma-pullback-affine-fibres-surjective, chow-remark-higher-chow}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
...
First, by Lemma \ref{chow-lemma-pullback-affine-fibres-surjective}
...
$$
\begin{array}{ccccc}\CH^M_{k + r}(U, 1) \longrightarrow & \CH_{k + r}(X') \longrightarrow & \CH_{k + r}(X) \longrightarrow & \CH_{k + r}(U) \longrightarrow & 0 \\ \CH^M_k(V, 1) \longrightarrow\uparrow & \CH_k(Y') \longrightarrow\uparrow & \CH_k(Y) \longrightarrow\uparrow & \CH_k(V) \longrightarrow\uparrow & 0\end{array}
$$
Here we use the first higher Chow groups of $V$ and $U$ and the
six term exact sequences constructed in Remark \ref{chow-remark-higher-chow},
...
Lemma \ref{chow-lemma-pullback-affine-fibres-surjective}
...
We will see later, in Lemma \ref{chow-lemma-gysin-commutes}, that our
...
\begin{definition}[Bivariant class]
\label{chow-definition-bivariant-class}
\source{stacks:0B76}
\href{https://stacks.math.columbia.edu/tag/0B76}{\texttt{Stacks tag 0B76}}
\group{chow}
...
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}. Let $X \to Y$
and $Y \to Z$
...
\begin{lemma}[Flat pullback bivariant]
\label{chow-lemma-flat-pullback-bivariant}
\source{stacks:0B78}
\href{https://stacks.math.columbia.edu/tag/0B78}{\texttt{Stacks tag 0B78}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-flat-pullback-rational-equivalence, chow-lemma-compose-flat-pullback, chow-lemma-flat-pullback-proper-pushforward, chow-lemma-gysin-flat-pullback}

This follows from
Lemmas \ref{chow-lemma-flat-pullback-rational-equivalence},
\ref{chow-lemma-compose-flat-pullback},
\ref{chow-lemma-flat-pullback-proper-pushforward}, and
\ref{chow-lemma-gysin-flat-pullback}.
\end{proof}

\begin{lemma}[Gysin bivariant]
\label{chow-lemma-gysin-bivariant}
\source{stacks:0B79}
\href{https://stacks.math.columbia.edu/tag/0B79}{\texttt{Stacks tag 0B79}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-gysin-factors, chow-lemma-closed-in-X-gysin, chow-lemma-gysin-flat-pullback, chow-lemma-gysin-commutes-gysin}

This follows from Lemmas \ref{chow-lemma-gysin-factors},
\ref{chow-lemma-closed-in-X-gysin},
\ref{chow-lemma-gysin-flat-pullback}, and
\ref{chow-lemma-gysin-commutes-gysin}.
\end{proof}

\begin{lemma}[Push proper bivariant]
\label{chow-lemma-push-proper-bivariant}
\source{stacks:0EPK}
\href{https://stacks.math.columbia.edu/tag/0EPK}{\texttt{Stacks tag 0EPK}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-compose-pushforward, chow-lemma-flat-pullback-proper-pushforward, chow-lemma-closed-in-X-gysin}

This follows from Lemmas \ref{chow-lemma-compose-pushforward},
\ref{chow-lemma-flat-pullback-proper-pushforward}, and
\ref{chow-lemma-closed-in-X-gysin}.
\end{proof}

\begin{remark}[Restriction bivariant]
\label{chow-remark-restriction-bivariant}
\source{stacks:0F9Z}
\href{https://stacks.math.columbia.edu/tag/0F9Z}{\texttt{Stacks tag 0F9Z}}
\group{chow}
...
\begin{remark}[Bivariant commute]
\label{chow-remark-bivariant-commute}
\source{stacks:0FA2}
\href{https://stacks.math.columbia.edu/tag/0FA2}{\texttt{Stacks tag 0FA2}}
\group{chow}

\uses{chow-situation-setup, chow-remark-restriction-bivariant}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}. Let $X$ be
...
as in Remark \ref{chow-remark-restriction-bivariant}; similarly for $res(c_2)$.
\end{remark}

\begin{example}[Gysin commute]
\label{chow-example-gysin-commute}
\source{stacks:0FA3}
\href{https://stacks.math.columbia.edu/tag/0FA3}{\texttt{Stacks tag 0FA3}}
\group{chow}

\uses{chow-situation-setup, chow-definition-gysin-homomorphism, chow-lemma-gysin-bivariant, chow-remark-bivariant-commute, chow-definition-bivariant-class}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}. Let $X$ be locally
of finite type over $S$. Let $(\mathcal{L}, s, i : D \to X)$ a triple as in
Definition \ref{chow-definition-gysin-homomorphism}. Let $Z \to X$ be a morphism
...
Lemma \ref{chow-lemma-gysin-bivariant} commutes with $c$ in the sense of
Remark \ref{chow-remark-bivariant-commute}. Namely, this is a restatement of
condition (3) of Definition \ref{chow-definition-bivariant-class}.
\end{example}

\begin{remark}[More general bivariant]
\label{chow-remark-more-general-bivariant}
\source{stacks:0FDU}
\href{https://stacks.math.columbia.edu/tag/0FDU}{\texttt{Stacks tag 0FDU}}
\group{chow}

\uses{chow-situation-setup, chow-definition-gysin-homomorphism, chow-definition-bivariant-class}
...
Situation \ref{chow-situation-setup}. Let $p \in \mathbf{Z}$.
...
Definition \ref{chow-definition-bivariant-class} but it is in the
...
\begin{definition}[Chow cohomology]
\label{chow-definition-chow-cohomology}
\source{stacks:0B7E}
\href{https://stacks.math.columbia.edu/tag/0B7E}{\texttt{Stacks tag 0B7E}}
\group{chow}
...
\begin{remark}[Pullback cohomology]
\label{chow-remark-pullback-cohomology}
\source{stacks:0B7F}
\href{https://stacks.math.columbia.edu/tag/0B7F}{\texttt{Stacks tag 0B7F}}
\group{chow}

\uses{chow-situation-setup, chow-remark-restriction-bivariant}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
Let $f : Y' \to Y$ be a morphism of schemes locally of finite type over $S$.
As a special case of Remark \ref{chow-remark-restriction-bivariant}
there is a canonical $\mathbf{Z}$-algebra map $res : A^*(Y) \to A^*(Y')$.
This map is often denoted $f^*$ in the literature.
\end{remark}

\begin{lemma}[Cap c1 bivariant]
\label{chow-lemma-cap-c1-bivariant}
\source{stacks:0B77}
\href{https://stacks.math.columbia.edu/tag/0B77}{\texttt{Stacks tag 0B77}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-factors, chow-lemma-pushforward-cap-c1, chow-lemma-flat-pullback-cap-c1, chow-lemma-gysin-commutes-cap-c1}

This follows from Lemmas \ref{chow-lemma-factors},
\ref{chow-lemma-pushforward-cap-c1},
\ref{chow-lemma-flat-pullback-cap-c1}, and
...
\source{stacks:0FDW}
\href{https://stacks.math.columbia.edu/tag/0FDW}{\texttt{Stacks tag 0FDW}}
\group{chow}

\uses{chow-situation-setup, chow-lemma-cap-c1-bivariant}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}. Let $X$
...
is the bivariant class of Lemma \ref{chow-lemma-cap-c1-bivariant}.
\end{definition}
...
\begin{lemma}[C1 center]
\label{chow-lemma-c1-center}
\source{stacks:0B7B}
\href{https://stacks.math.columbia.edu/tag/0B7B}{\texttt{Stacks tag 0B7B}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-linebundle, chow-lemma-linebundle-formulae}

Of course (2) implies (1).
Let $p : L \to X$ be as in Lemma \ref{chow-lemma-linebundle} and let $o : X \to L$
be the zero section. Denote $p' : L' \to X'$ and $o' : X' \to L'$
their base changes. By Lemma \ref{chow-lemma-linebundle-formulae} we have
$$
...
\begin{lemma}[Vanish above dimension]
\label{chow-lemma-vanish-above-dimension}
\source{stacks:0FDX}
\href{https://stacks.math.columbia.edu/tag/0FDX}{\texttt{Stacks tag 0FDX}}
\group{chow}

\uses{chow-situation-setup}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}. Let $X$ be a
...
\begin{proof}
\uses{chow-lemma-gysin-bivariant, chow-lemma-support-cap-effective-Cartier, chow-lemma-push-proper-bivariant}
...
Gysin hommomorphism as in Lemma \ref{chow-lemma-gysin-bivariant}.
We have $i_* \circ i^* = c_1(\mathcal{L}_{d + 1})$
in $A^1(X)$ by Lemma \ref{chow-lemma-support-cap-effective-Cartier}
(and Lemma \ref{chow-lemma-push-proper-bivariant}
...
\begin{remark}[Ring loc classes]
\label{chow-remark-ring-loc-classes}
\source{stacks:0FA0}
\href{https://stacks.math.columbia.edu/tag/0FA0}{\texttt{Stacks tag 0FA0}}
\group{chow}
...
$A^i(X) \to A^i(Z)$ (Remark \ref{chow-remark-restriction-bivariant}) and
...
Remark \ref{chow-remark-restriction-bivariant}). We omit the
verification that these multiplications are associative in a suitable sense.
\end{remark}

\begin{remark}[Res push]
\label{chow-remark-res-push}
\source{stacks:0FA1}
\href{https://stacks.math.columbia.edu/tag/0FA1}{\texttt{Stacks tag 0FA1}}
\group{chow}
...
the restriction map of Remark \ref{chow-remark-restriction-bivariant}.
...
\begin{lemma}[Factors through rational equivalence]
\label{chow-lemma-factors-through-rational-equivalence}
\source{stacks:0B7A}
\href{https://stacks.math.columbia.edu/tag/0B7A}{\texttt{Stacks tag 0B7A}}
\group{chow}

\uses{chow-situation-setup, chow-definition-bivariant-class}
\begin{reference}
...
Definition \ref{chow-definition-bivariant-class}
whenever $\mathcal{L}'|_{D'} \cong \mathcal{O}_{D'}$. Then
$c \cap -$ factors through rational equivalence.
\end{lemma}

\begin{proof}
\uses{chow-definition-gysin-homomorphism, chow-remark-gysin-on-cycles, chow-lemma-rational-equivalence-family}
...
(follows from Lemma \ref{chow-lemma-rational-equivalence-family}) we conclude.
\end{proof}

\begin{lemma}[Bivariant weaker]
\label{chow-lemma-bivariant-weaker}
\source{stacks:0F9A}
\href{https://stacks.math.columbia.edu/tag/0F9A}{\texttt{Stacks tag 0F9A}}
\group{chow}
...
\begin{proof}
\uses{chow-definition-gysin-homomorphism, chow-lemma-normal-cone-effective-Cartier}
...
constructed in Lemma \ref{chow-lemma-normal-cone-effective-Cartier}.
(Warning: $D''$ isn't the full inverse image of $D'$.)
Denote $f : X'' \to X'$ and $E'' \subset X''$
their base changes by $X' \to Y'$. Picture
$$
\begin{array}{cccc} & X'' \longrightarrow\underset{h}{\downarrow} &  & Y'' \overset{g}{\downarrow} \\ E'' \longrightarrow\underset{q}{\downarrow}\overset{j''}{\nearrow} &  & D'' \overset{p}{\downarrow}\overset{i''}{\nearrow} &  \\  & X' \longrightarrow &  & Y' \\ E' \longrightarrow\overset{j'}{\nearrow} &  & D' \overset{i'}{\nearrow} & \end{array}
$$
...
\begin{lemma}[Bivariant zero]
\label{chow-lemma-bivariant-zero}
\source{stacks:02UC}
\href{https://stacks.math.columbia.edu/tag/02UC}{\texttt{Stacks tag 02UC}}
\group{chow}
...
\begin{lemma}[Disjoint decomposition bivariant]
\label{chow-lemma-disjoint-decomposition-bivariant}
\source{stacks:0FDZ}
\href{https://stacks.math.columbia.edu/tag/0FDZ}{\texttt{Stacks tag 0FDZ}}
\group{chow}
...
\begin{remark}[Completion bivariant]
\label{chow-remark-completion-bivariant}
\source{stacks:0FE0}
\href{https://stacks.math.columbia.edu/tag/0FE0}{\texttt{Stacks tag 0FE0}}
\group{chow}

\uses{chow-situation-setup, chow-lemma-disjoint-decomposition-bivariant}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
Let $f : X \to Y$ be a morphism of schemes locally of finite type over $S$.
...
Lemma \ref{chow-lemma-disjoint-decomposition-bivariant}.
...
\begin{lemma}[Envelope bivariant]
\label{chow-lemma-envelope-bivariant}
\source{stacks:0GUC}
\href{https://stacks.math.columbia.edu/tag/0GUC}{\texttt{Stacks tag 0GUC}}
\group{chow}

\uses{chow-situation-setup, chow-definition-envelope}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
Let $f : X \to Y$ be a morphism of schemes locally of finite type over $S$.
Let $g : Y' \to Y$ be an envelope (Definition \ref{chow-definition-envelope})
...
\begin{proof}
\uses{chow-remark-restriction-bivariant, chow-lemma-envelope, chow-definition-bivariant-class, chow-lemma-base-change-envelope}

We have a commutative diagram
$$
\begin{array}{ccc}X' \times_X X' \overset{f''}{\downarrow}\overset{a}{\longrightarrow}\underset{b}{\longrightarrow} & X' \overset{f'}{\downarrow}\underset{h}{\longrightarrow} & X \overset{f}{\downarrow} \\ Y' \times_Y Y' \overset{p}{\longrightarrow}\underset{q}{\longrightarrow} & Y' \overset{g}{\longrightarrow} & Y\end{array}
$$
The element $res_1(c')$ is the restriction (see
Remark \ref{chow-remark-restriction-bivariant}) of $c'$ for the cartesian square
...
By Lemma \ref{chow-lemma-envelope} we can find a $\beta' \in \CH_k(Y')$
...
conditions listed in Definition \ref{chow-definition-bivariant-class}.
Denote $Y'_1 = Y' \times_Y Y_1$, $X_1 = X \times_Y Y_1$.
The morphism $Y'_1 \to Y_1$ is an envelope by
Lemma \ref{chow-lemma-base-change-envelope}. Hence we can use the base
changed diagram
$$
\begin{array}{ccc}X'_1 \times_{X_1} X'_1 \overset{f''_1}{\downarrow}\overset{a_1}{\longrightarrow}\underset{b_1}{\longrightarrow} & X'_1 \overset{f'_1}{\downarrow}\underset{h_1}{\longrightarrow} & X_1 \overset{f_1}{\downarrow} \\ Y'_1 \times_{Y_1} Y'_1 \overset{p_1}{\longrightarrow}\underset{q_1}{\longrightarrow} & Y'_1 \overset{g_1}{\longrightarrow} & Y_1\end{array}
$$
...
Definition \ref{chow-definition-bivariant-class} for $c$.
...
$$
\vcenter{
\begin{array}{cc}X'_2 \underset{s'}{\downarrow}\underset{h_2}{\longrightarrow} & X_2 \overset{s}{\downarrow} \\ X'_1 \overset{h_1}{\longrightarrow} & X_1\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}X'_2 \underset{s'}{\downarrow}\underset{f'_2}{\longrightarrow} & Y'_2 \overset{t'}{\downarrow} \\ X'_2 \overset{f'_1}{\longrightarrow} & Y'_1\end{array}
}
$$
...
$$
\begin{array}{cc}\mathbf{P}(\mathcal{E}) =
\underline{\text{Proj}}_X(\text{Sym}^*(\mathcal{E}))
\overset{\pi}{\longrightarrow} & X\end{array}
$$
over $X$ with
...
\begin{lemma}[Cap projective bundle]
\label{chow-lemma-cap-projective-bundle}
\source{stacks:02TW}
\href{https://stacks.math.columbia.edu/tag/02TW}{\texttt{Stacks tag 02TW}}
\group{chow}
...
\end{eqnarray*}
by repeated applications of Lemma \ref{chow-lemma-geometric-cap}.
...
\source{stacks:02TX}
\href{https://stacks.math.columbia.edu/tag/02TX}{\texttt{Stacks tag 02TX}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-cap-projective-bundle, chow-lemma-flat-pullback-proper-pushforward, chow-lemma-pushforward-cap-c1, chow-lemma-restrict-to-open, chow-lemma-pullback-affine-fibres-surjective, chow-lemma-relative-effective-cartier}
...
By Lemma \ref{chow-lemma-cap-projective-bundle} we see that
$$
0 = \pi_*(\pi^*\alpha_0 +
c_1(\mathcal{O}_P(1)) \cap \pi^*\alpha_1
+ \ldots +
...
diagram
$$
\begin{array}{cc}\coprod P_i \underset{\coprod \pi_i}{\downarrow}\underset{p}{\longrightarrow} & P \overset{\pi}{\downarrow} \\ \coprod X_i \overset{q}{\longrightarrow} & X\end{array}
$$
Observe that $p_*$ is surjective. If $\beta \in \CH_k(\coprod X_i)$
then $\pi^* q_* \beta = p_*(\coprod \pi_i)^* \beta$, see
Lemma \ref{chow-lemma-flat-pullback-proper-pushforward}. Similarly for
capping with $c_1(\mathcal{O}(1))$ by
Lemma \ref{chow-lemma-pushforward-cap-c1}.
...
is by Lemma \ref{chow-lemma-restrict-to-open}
...
By Lemma \ref{chow-lemma-pullback-affine-fibres-surjective}
again we can write
$\alpha'|_{U^{r - 2}} = (\pi^{r - 2})^*\alpha_1|_{U^{r - 2}}$
for some $\alpha_1 \in \CH_{k + 1}(X)$.
By Lemma \ref{chow-lemma-relative-effective-cartier}
...
\begin{lemma}[Vectorbundle]
\label{chow-lemma-vectorbundle}
\source{stacks:02TY}
\href{https://stacks.math.columbia.edu/tag/02TY}{\texttt{Stacks tag 02TY}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-linebundle, chow-lemma-pullback-affine-fibres-surjective, chow-lemma-restrict-to-open, chow-lemma-chow-ring-projective-bundle, chow-lemma-relative-effective-cartier, chow-lemma-pushforward-cap-c1}

(For the case of linebundles, see Lemma \ref{chow-lemma-linebundle}.)
For surjectivity see Lemma \ref{chow-lemma-pullback-affine-fibres-surjective}.
...
see Lemma \ref{chow-lemma-restrict-to-open}. So if $p^*\alpha = 0$, then
$\pi^*\alpha = i_*\beta$ for some $\beta \in \CH_{k + r}(D)$.
By Lemma \ref{chow-lemma-chow-ring-projective-bundle} we may write
$$
\beta = \pi_D^*\beta_0 +
\ldots + c_1(\mathcal{O}_D(1))^{r - 1} \cap \pi_D^* \beta_{r - 1}.
$$
for some $\beta_i \in \CH_{k + i}(X)$.
By Lemmas \ref{chow-lemma-relative-effective-cartier}
and \ref{chow-lemma-pushforward-cap-c1}
this implies
$$
\pi^*\alpha = i_*\beta =
...
this contradicts Lemma \ref{chow-lemma-pushforward-cap-c1} unless all
...
\source{stacks:02U0}
\href{https://stacks.math.columbia.edu/tag/02U0}{\texttt{Stacks tag 02U0}}
\group{chow}

\uses{chow-situation-setup, chow-lemma-chow-ring-projective-bundle}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
Let $X$ be locally of finite type over $S$.
...
\begin{enumerate}
\item By Lemma \ref{chow-lemma-chow-ring-projective-bundle} there are
...
\begin{lemma}[First chern class]
\label{chow-lemma-first-chern-class}
\source{stacks:02U2}
\href{https://stacks.math.columbia.edu/tag/02U2}{\texttt{Stacks tag 02U2}}
\group{chow}

\uses{chow-situation-setup, chow-definition-chern-classes, chow-definition-divisor-invertible-sheaf}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
Let $X$ be locally of finite type over $S$.
Assume $X$ is integral and $n = \dim_\delta(X)$.
Let $\mathcal{L}$ be an invertible $\mathcal{O}_X$-module.
The first Chern class of $\mathcal{L}$ on $X$ of
Definition \ref{chow-definition-chern-classes}
is equal to the Weil divisor associated to $\mathcal{L}$
by Definition \ref{chow-definition-divisor-invertible-sheaf}.
\end{lemma}

\begin{proof}
\uses{chow-definition-divisor-invertible-sheaf}

In this proof we use $c_1(\mathcal{L}) \cap [X]$ to denote the
construction of Definition \ref{chow-definition-divisor-invertible-sheaf}.
...
\begin{remark}[Equation signs]
\label{chow-remark-equation-signs}
\source{stacks:02U3}
\href{https://stacks.math.columbia.edu/tag/02U3}{\texttt{Stacks tag 02U3}}
\group{chow}
...
bivariant classes on $X$, see Lemma \ref{chow-lemma-cap-cp-bivariant}
...
summing. In Lemma \ref{chow-lemma-determine-intersections} we show
...
Lemma \ref{chow-lemma-determine-intersections} and using
Lemma \ref{chow-lemma-push-proper-bivariant}; the reader who wishes to
see this worked out should consult
Chow Groups of Spaces, Lemma \ref{spaces-chow-lemma-segre-classes}.

\begin{definition}[Cap chern classes]
\label{chow-definition-cap-chern-classes}
\source{stacks:02U5}
\href{https://stacks.math.columbia.edu/tag/02U5}{\texttt{Stacks tag 02U5}}
\group{chow}

\uses{chow-situation-setup, chow-definition-chern-classes}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
Let $X$ be locally of finite type over $S$.
Let $\mathcal{E}$ be a finite locally free sheaf of rank $r$ on $X$.
...
previous definition (Definition \ref{chow-definition-cap-c1})
by Lemma \ref{chow-lemma-first-chern-class}.

\begin{lemma}[Determine intersections]
\label{chow-lemma-determine-intersections}
\source{stacks:02U6}
\href{https://stacks.math.columbia.edu/tag/02U6}{\texttt{Stacks tag 02U6}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-chow-ring-projective-bundle, chow-lemma-flat-pullback-proper-pushforward, chow-lemma-pushforward-cap-c1}
...
Lemma \ref{chow-lemma-chow-ring-projective-bundle}.
...
$$
\begin{array}{ccc}P' \xlongequal{}\underset{\pi'}{\downarrow} & \coprod P_a \underset{\coprod \pi_a}{\downarrow}\underset{\coprod i'_a}{\longrightarrow} & P \overset{\pi}{\downarrow} \\ X' \xlongequal{} & \coprod W_a \overset{\coprod i_a}{\longrightarrow} & X\end{array}
$$
...
by Lemma \ref{chow-lemma-flat-pullback-proper-pushforward}.
By the projection formula of Lemma \ref{chow-lemma-pushforward-cap-c1}
we conclude that
$$
\sum\nolimits_{i = 0}^r
...
\begin{lemma}[Cap chern class factors rational equivalence]
\label{chow-lemma-cap-chern-class-factors-rational-equivalence}
\source{stacks:02U7}
\href{https://stacks.math.columbia.edu/tag/02U7}{\texttt{Stacks tag 02U7}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-determine-intersections, chow-lemma-flat-pullback-rational-equivalence}

By Lemma \ref{chow-lemma-determine-intersections} the elements
...
Lemma \ref{chow-lemma-flat-pullback-rational-equivalence}.) Hence they are equal.
\end{proof}
...
\begin{lemma}[Pushforward cap cj]
\label{chow-lemma-pushforward-cap-cj}
\source{stacks:02U9}
\href{https://stacks.math.columbia.edu/tag/02U9}{\texttt{Stacks tag 02U9}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-determine-intersections, chow-lemma-proper-pushforward-rational-equivalence, chow-lemma-pushforward-cap-c1, chow-lemma-flat-pullback-proper-pushforward}
...
$\alpha_0 = \alpha$. By Lemma \ref{chow-lemma-determine-intersections} we have
$$
\sum\nolimits_{i = 0}^r
(-1)^i c_1(\mathcal{O}_P(1))^i \cap
\pi_X^*(\alpha_{r - i}) = 0
...
$$
\begin{array}{cc}P_X \underset{p'}{\longrightarrow}\underset{\pi_X}{\downarrow} & P \overset{\pi}{\downarrow} \\ X \overset{p}{\longrightarrow} & Y\end{array}
$$
...
Lemmas \ref{chow-lemma-pushforward-cap-c1} and
\ref{chow-lemma-flat-pullback-proper-pushforward} we obtain
$$
\sum\nolimits_{i = 0}^r
(-1)^i c_1(\mathcal{O}_P(1))^i \cap
\pi^*(p_*\alpha_{r - i}) = 0
...
Lemma \ref{chow-lemma-determine-intersections} we conclude.
\end{proof}

\begin{lemma}[Flat pullback cap cj]
\label{chow-lemma-flat-pullback-cap-cj}
\source{stacks:02U8}
\href{https://stacks.math.columbia.edu/tag/02U8}{\texttt{Stacks tag 02U8}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-determine-intersections, chow-lemma-flat-pullback-rational-equivalence, chow-lemma-flat-pullback-cap-c1, chow-lemma-compose-flat-pullback}

Write $\alpha_j = c_j(\mathcal{E}) \cap \alpha$, so $\alpha_0 = \alpha$.
By Lemma \ref{chow-lemma-determine-intersections} we have
$$
\sum\nolimits_{i = 0}^r
(-1)^i c_1(\mathcal{O}_P(1))^i \cap
\pi^*(\alpha_{r - i}) = 0
...
$$
\begin{array}{cc}P_X = \mathbf{P}(f^*\mathcal{E}) \underset{f'}{\longrightarrow}\underset{\pi_X}{\downarrow} & P \overset{\pi}{\downarrow} \\ X \overset{f}{\longrightarrow} & Y\end{array}
$$
Note that $\mathcal{O}_{P_X}(1)$ is the pullback of $\mathcal{O}_P(1)$.
Apply flat pullback $(f')^*$
(Lemma \ref{chow-lemma-flat-pullback-rational-equivalence}) to the displayed
equation above. By Lemmas \ref{chow-lemma-flat-pullback-cap-c1} and
\ref{chow-lemma-compose-flat-pullback} we see that
$$
\sum\nolimits_{i = 0}^r
...
\begin{lemma}[Cap chern class commutes with gysin]
\label{chow-lemma-cap-chern-class-commutes-with-gysin}
\source{stacks:0B7G}
\href{https://stacks.math.columbia.edu/tag/0B7G}{\texttt{Stacks tag 0B7G}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-determine-intersections, chow-lemma-gysin-factors, chow-lemma-gysin-commutes-cap-c1, chow-lemma-gysin-flat-pullback}
...
associated to $\mathcal{E}$. Consider the fibre product diagram
$$
\begin{array}{cc}P_D = \mathbf{P}(\mathcal{E}|_D) \underset{i'}{\longrightarrow}\underset{\pi_D}{\downarrow} & P \overset{\pi}{\downarrow} \\ D \overset{i}{\longrightarrow} & X\end{array}
$$
Note that $\mathcal{O}_{P_D}(1)$ is the pullback of $\mathcal{O}_P(1)$.
Apply the Gysin map $(i')^*$ (Lemma \ref{chow-lemma-gysin-factors}) to the
displayed equation above.
Applying Lemmas \ref{chow-lemma-gysin-commutes-cap-c1} and
\ref{chow-lemma-gysin-flat-pullback} we obtain
$$
\sum\nolimits_{i = 0}^r
...
By the characterization of Lemma \ref{chow-lemma-determine-intersections}
we conclude.
\end{proof}
...
\begin{lemma}[Cap cp bivariant]
\label{chow-lemma-cap-cp-bivariant}
\source{stacks:0B7H}
\href{https://stacks.math.columbia.edu/tag/0B7H}{\texttt{Stacks tag 0B7H}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-cap-chern-class-factors-rational-equivalence, chow-lemma-pushforward-cap-cj, chow-lemma-flat-pullback-cap-cj, chow-lemma-cap-chern-class-commutes-with-gysin, chow-definition-bivariant-class}

Immediate from Lemmas
\ref{chow-lemma-cap-chern-class-factors-rational-equivalence},
\ref{chow-lemma-pushforward-cap-cj},
\ref{chow-lemma-flat-pullback-cap-cj}, and
\ref{chow-lemma-cap-chern-class-commutes-with-gysin}
and Definition \ref{chow-definition-bivariant-class}.
\end{proof}

This lemma allows us to define the Chern classes of a finite
locally free module as follows.

\begin{definition}[Chern classes final]
\label{chow-definition-chern-classes-final}
\source{stacks:0FE1}
\href{https://stacks.math.columbia.edu/tag/0FE1}{\texttt{Stacks tag 0FE1}}
\group{chow}

\uses{chow-situation-setup, chow-lemma-cap-cp-bivariant}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
Let $X$ be locally of finite type over $S$.
Let $\mathcal{E}$ be a locally free $\mathcal{O}_X$-module
...
constructed in Lemma \ref{chow-lemma-cap-cp-bivariant}. The
...
By the remark following Definition \ref{chow-definition-cap-chern-classes}
if $\mathcal{E}$ is invertible, then this definition agrees with
Definition \ref{chow-definition-first-chern-class}.
Next we see that Chern classes are in the center of the bivariant
Chow cohomology ring $A^*(X)$.

\begin{lemma}[Cap commutative chern]
\label{chow-lemma-cap-commutative-chern}
\source{stacks:02UA}
\href{https://stacks.math.columbia.edu/tag/02UA}{\texttt{Stacks tag 02UA}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-determine-intersections, chow-lemma-c1-center}
...
of $\pi$ by $f$. Using Lemma \ref{chow-lemma-c1-center} and
...
of Lemma \ref{chow-lemma-determine-intersections}.
This proves the lemma.
\end{proof}

\begin{remark}[Extend to finite locally free]
\label{chow-remark-extend-to-finite-locally-free}
\source{stacks:0ESW}
\href{https://stacks.math.columbia.edu/tag/0ESW}{\texttt{Stacks tag 0ESW}}
\group{chow}

\uses{chow-situation-setup, chow-lemma-disjoint-decomposition-bivariant, chow-remark-completion-bivariant}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
Let $X$ be locally of finite type over $S$.
Let $\mathcal{E}$ be a finite locally free $\mathcal{O}_X$-module.
...
Remark \ref{chow-remark-completion-bivariant}.
...
\begin{remark}[Top chern class]
\label{chow-remark-top-chern-class}
\source{stacks:0FA4}
\href{https://stacks.math.columbia.edu/tag/0FA4}{\texttt{Stacks tag 0FA4}}
\group{chow}

\uses{chow-situation-setup, chow-remark-extend-to-finite-locally-free, chow-lemma-disjoint-decomposition-bivariant, chow-remark-completion-bivariant}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}. Let $X$
...
Remark \ref{chow-remark-extend-to-finite-locally-free}.
...
$$
where the equality is Lemma \ref{chow-lemma-disjoint-decomposition-bivariant}.
...
$$
see Remark \ref{chow-remark-completion-bivariant} for notation.
\end{remark}
...
locally free sheaves on $X$. By Lemma \ref{chow-lemma-cap-commutative-chern}
...
By Lemma \ref{chow-lemma-bivariant-zero}
...
$$
proved in Lemma \ref{chow-lemma-c1-cap-additive}.
More generally, here is what happens when we tensor an
arbitrary locally free sheaf by an invertible sheaf.

\begin{lemma}[Chern classes E tensor L]
\label{chow-lemma-chern-classes-E-tensor-L}
\source{stacks:02UD}
\href{https://stacks.math.columbia.edu/tag/02UD}{\texttt{Stacks tag 02UD}}
\group{chow}
...
$$
\begin{array}{ccc}P \underset{\pi}{\searrow}\underset{g}{\longrightarrow} &  & P' \overset{\pi'}{\swarrow} \\  & X & \end{array}
$$
...
\begin{lemma}[Get rid of trivial subbundle]
\label{chow-lemma-get-rid-of-trivial-subbundle}
\source{stacks:02UG}
\href{https://stacks.math.columbia.edu/tag/02UG}{\texttt{Stacks tag 02UG}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-bivariant-zero, chow-lemma-relative-effective-cartier, chow-lemma-determine-intersections, chow-lemma-pushforward-cap-c1}
...
Lemma \ref{chow-lemma-relative-effective-cartier}.
By Lemma \ref{chow-lemma-determine-intersections} we see that
...
Lemma \ref{chow-lemma-pushforward-cap-c1} we get
$$
\sum\nolimits_{j = 0}^{r - 1}
(-1)^j c_1(\mathcal{O}_P(1))^{j + 1}
\cap \pi^*\alpha_j = 0
$$
By the uniqueness of Lemma \ref{chow-lemma-determine-intersections}
we conclude that
...
\begin{lemma}[Additivity invertible subsheaf]
\label{chow-lemma-additivity-invertible-subsheaf}
\source{stacks:02UH}
\href{https://stacks.math.columbia.edu/tag/02UH}{\texttt{Stacks tag 02UH}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-get-rid-of-trivial-subbundle, chow-lemma-chern-classes-E-tensor-L}

This relation really just says that
$c_i(\mathcal{E}) = c_i(\mathcal{F}) + c_1(\mathcal{L})c_{i - 1}(\mathcal{F})$.
By Lemma \ref{chow-lemma-get-rid-of-trivial-subbundle}
...
Applying Lemma \ref{chow-lemma-chern-classes-E-tensor-L} we deduce
$$
\sum_{j = 0}^i
...
\begin{lemma}[Additivity chern classes]
\label{chow-lemma-additivity-chern-classes}
\source{stacks:02UI}
\href{https://stacks.math.columbia.edu/tag/02UI}{\texttt{Stacks tag 02UI}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-bivariant-zero, chow-lemma-additivity-invertible-subsheaf, chow-lemma-flat-pullback-cap-cj}

By Lemma \ref{chow-lemma-bivariant-zero} we may assume that $X$ is integral
and we have to show the identity when capping against $[X]$.
By induction on $r_1$. The case $r_1 = 1$ is
Lemma \ref{chow-lemma-additivity-invertible-subsheaf}.
...
\end{eqnarray*}
Since $[P] = \pi^*[X]$ we
win by Lemma \ref{chow-lemma-flat-pullback-cap-cj}.
\end{proof}

\begin{lemma}[Chern filter by linebundles]
\label{chow-lemma-chern-filter-by-linebundles}
\source{stacks:02UJ}
\href{https://stacks.math.columbia.edu/tag/02UJ}{\texttt{Stacks tag 02UJ}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-additivity-invertible-subsheaf}

Apply Lemma \ref{chow-lemma-additivity-invertible-subsheaf} and induction.
\end{proof}
...
Lemma \ref{chow-lemma-spell-out-degree-zero-cycle} and then show
it is well defined by
Lemma \ref{chow-lemma-curve-principal-divisor}.
Instead we define it as follows.

\begin{definition}[Degree zero cycle]
\label{chow-definition-degree-zero-cycle}
\source{stacks:0AZ1}
\href{https://stacks.math.columbia.edu/tag/0AZ1}{\texttt{Stacks tag 0AZ1}}
\group{chow}

\uses{chow-example-field, chow-lemma-proper-pushforward-rational-equivalence}
Let $k$ be a field (Example \ref{chow-example-field}). Let $p : X \to \Spec(k)$
...
\begin{lemma}[Spell out degree zero cycle]
\label{chow-lemma-spell-out-degree-zero-cycle}
\source{stacks:0AZ2}
\href{https://stacks.math.columbia.edu/tag/0AZ2}{\texttt{Stacks tag 0AZ2}}
\group{chow}
...
\begin{proof}
\uses{chow-definition-proper-pushforward}

This is the definition of proper pushforward
(Definition \ref{chow-definition-proper-pushforward}).
\end{proof}
...
\begin{lemma}[Degree vector bundle]
\label{chow-lemma-degree-vector-bundle}
\source{stacks:0AZ3}
\href{https://stacks.math.columbia.edu/tag/0AZ3}{\texttt{Stacks tag 0AZ3}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-pushforward-cap-cj, chow-lemma-additivity-chern-classes, chow-lemma-c1-cap-additive, chow-lemma-chern-classes-E-tensor-L, chow-lemma-geometric-cap}
...
from Lemma \ref{chow-lemma-pushforward-cap-cj} that
$$
...
and of first Chern classes (Lemma \ref{chow-lemma-additivity-chern-classes})
...
(Lemma \ref{chow-lemma-c1-cap-additive} or \ref{chow-lemma-chern-classes-E-tensor-L})
...
Lemma \ref{chow-lemma-geometric-cap}.
Since
$$
[D]_0 = \sum\nolimits_{x \in D}
...
\begin{lemma}[Degrees and numerical intersections]
\label{chow-lemma-degrees-and-numerical-intersections}
\source{stacks:0BFI}
\href{https://stacks.math.columbia.edu/tag/0BFI}{\texttt{Stacks tag 0BFI}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-pushforward-cap-c1, chow-lemma-c1-cap-additive, chow-lemma-geometric-cap}
...
$$
by Lemma \ref{chow-lemma-pushforward-cap-c1}. Thus we may replace $X$ by $Y$
...
$$
and by Lemma \ref{chow-lemma-geometric-cap} we have
$$
c_1(\mathcal{L}_1) \cap \ldots \cap c_1(\mathcal{L}_d) \cap [X] =
...
\begin{lemma}[Locally equidimensional]
\label{chow-lemma-locally-equidimensional}
\source{stacks:0FE3}
\href{https://stacks.math.columbia.edu/tag/0FE3}{\texttt{Stacks tag 0FE3}}
\group{chow}

\uses{chow-situation-setup}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
Let $X$ be locally of finite type over $S$. Write
$\delta = \delta_{X/S}$ as in Section \ref{chow-section-setup}.
The following are equivalent
\begin{enumerate}
...
\begin{proof}
\uses{chow-example-CM-irreducible}
...
is a dimension function on $X$ (see Example \ref{chow-example-CM-irreducible}).
...
conditions of Lemma \ref{chow-lemma-locally-equidimensional}. For an integral
...
Lemma \ref{chow-lemma-locally-equidimensional} part (1).
...
Lemma \ref{chow-lemma-locally-equidimensional}. However, instead we simply
...
as in Lemma \ref{chow-lemma-locally-equidimensional}
...
Lemma \ref{chow-lemma-locally-equidimensional} then flat pullback determines a map
$$
f^* : \CH^p(Y) \to \CH^p(X)
$$
\item If $f : X \to Y$ is a morphism of schemes locally of finite type
over $S$ and $X$ and $Y$ satisfy the equivalent conditions of
Lemma \ref{chow-lemma-locally-equidimensional} let us say $f$ has
...
over $S$ and $X$ and $Y$ satisfy the equivalent conditions of
Lemma \ref{chow-lemma-locally-equidimensional} and $f$ has codimension $r$,
...
Lemma \ref{chow-lemma-locally-equidimensional} and
...
\begin{remark}[Fundamental class]
\label{chow-remark-fundamental-class}
\source{stacks:0FE4}
\href{https://stacks.math.columbia.edu/tag/0FE4}{\texttt{Stacks tag 0FE4}}
\group{chow}

\uses{chow-situation-setup, chow-lemma-locally-equidimensional}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
Let $X$ be locally of finite type over $S$ satisfying the
equivalent conditions of Lemma \ref{chow-lemma-locally-equidimensional}.
...
\begin{lemma}[Splitting principle]
\label{chow-lemma-splitting-principle}
\source{stacks:02UL}
\href{https://stacks.math.columbia.edu/tag/02UL}{\texttt{Stacks tag 02UL}}
\group{chow}

\uses{chow-situation-setup, chow-remark-pullback-cohomology}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}. Let $X$ be locally
...
(Remark \ref{chow-remark-pullback-cohomology}) is injective.
\end{lemma}

\begin{proof}
\uses{chow-lemma-chow-ring-projective-bundle}
...
\begin{remark}[The proof shows more]
\label{chow-remark-the-proof-shows-more}
\source{stacks:0FVE}
\href{https://stacks.math.columbia.edu/tag/0FVE}{\texttt{Stacks tag 0FVE}}
\group{chow}

\uses{chow-lemma-splitting-principle, chow-lemma-cap-projective-bundle}
The proof of Lemma \ref{chow-lemma-splitting-principle}
...
\medskip\noindent
Namely, let $\pi : P \to X$ be as in Lemma \ref{chow-lemma-splitting-principle}.
Recall that there is a canonical $\mathbf{Z}$-algebra map
$\pi^* : A^*(X) \to A^*(P)$, see
Remark \ref{chow-remark-pullback-cohomology}. The injectivity of $\pi_Y^*$
...
$$
by Lemma \ref{chow-lemma-chern-filter-by-linebundles}. Thus we may think of the
...
\begin{lemma}[Chern classes dual]
\label{chow-lemma-chern-classes-dual}
\source{stacks:0FA5}
\href{https://stacks.math.columbia.edu/tag/0FA5}{\texttt{Stacks tag 0FA5}}
\group{chow}

\uses{chow-situation-setup}
In Situation \ref{chow-situation-setup} let $X$ be locally of finite type over $S$.
Let $\mathcal{E}$ be a finite locally free $\mathcal{O}_X$-module
...
\begin{proof}
\uses{chow-lemma-splitting-principle, chow-lemma-c1-cap-additive, chow-lemma-chern-filter-by-linebundles}
...
by Lemma \ref{chow-lemma-c1-cap-additive}.
By Lemma \ref{chow-lemma-chern-filter-by-linebundles}
we have
$$
c(\mathcal{E}) = \prod\nolimits_{i = 1}^r (1 + x_i)
\quad\text{and}\quad
...
\begin{lemma}[Chern classes tensor product]
\label{chow-lemma-chern-classes-tensor-product}
\source{stacks:0FA6}
\href{https://stacks.math.columbia.edu/tag/0FA6}{\texttt{Stacks tag 0FA6}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-chern-classes-dual, chow-lemma-chern-filter-by-linebundles}

Arguing exactly as in the proof of Lemma \ref{chow-lemma-chern-classes-dual}
...
\begin{remark}[Equalities nonconstant rank]
\label{chow-remark-equalities-nonconstant-rank}
\source{stacks:0FA7}
\href{https://stacks.math.columbia.edu/tag/0FA7}{\texttt{Stacks tag 0FA7}}
\group{chow}

\uses{chow-remark-extend-to-finite-locally-free, chow-lemma-chern-classes-dual, chow-lemma-chern-classes-tensor-product}
...
\in A^p(X)
$$
see Remark \ref{chow-remark-extend-to-finite-locally-free} for notation and
...
Lemmas \ref{chow-lemma-chern-classes-dual} and
...
\begin{example}[Power sum]
\label{chow-example-power-sum}
\source{stacks:0F9B}
\href{https://stacks.math.columbia.edu/tag/0F9B}{\texttt{Stacks tag 0F9B}}
\group{chow}

\uses{chow-remark-extend-to-finite-locally-free, chow-remark-equalities-nonconstant-rank}
...
(as in Remarks \ref{chow-remark-extend-to-finite-locally-free} and
...
\medskip\noindent
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}. Let $X$ be a scheme
...
\begin{lemma}[Top chern class]
\label{chow-lemma-top-chern-class}
\source{stacks:0FA9}
\href{https://stacks.math.columbia.edu/tag/0FA9}{\texttt{Stacks tag 0FA9}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-cap-cp-bivariant, chow-lemma-geometric-cap, chow-lemma-chow-ring-projective-bundle}

Since $c_r(\mathcal{E})$ is a bivariant class
(Lemma \ref{chow-lemma-cap-cp-bivariant})
...
is handled by Lemma \ref{chow-lemma-geometric-cap}. Assume $r > 1$.
...
the already used Lemma \ref{chow-lemma-geometric-cap}.
...
\begin{lemma}[Easy virtual class]
\label{chow-lemma-easy-virtual-class}
\source{stacks:0FAA}
\href{https://stacks.math.columbia.edu/tag/0FAA}{\texttt{Stacks tag 0FAA}}
\group{chow}
...
\begin{proof}
\uses{chow-remark-top-chern-class, chow-lemma-top-chern-class}

Here $c_{top}(\mathcal{E})$ is the bivariant class defined in
Remark \ref{chow-remark-top-chern-class}. By its very definition, in
...
$$
by Lemma \ref{chow-lemma-top-chern-class}. This proves the lemma.
\end{proof}
...
Example \ref{chow-example-power-sum}. The degree $p$ component of
the above is
$$
...
\begin{remark}[Extend chern character to finite locally free]
\label{chow-remark-extend-chern-character-to-finite-locally-free}
\source{stacks:0ESX}
\href{https://stacks.math.columbia.edu/tag/0ESX}{\texttt{Stacks tag 0ESX}}
\group{chow}

\uses{chow-remark-extend-to-finite-locally-free, chow-remark-equalities-nonconstant-rank, chow-lemma-vanish-above-dimension}
...
is not constant. See Remarks \ref{chow-remark-extend-to-finite-locally-free} and
\ref{chow-remark-equalities-nonconstant-rank}. Thus the full Chern character
of $\mathcal{E}$ is
an element of $\prod_{p \geq 0} (A^p(X) \otimes \mathbf{Q})$. If $X$
is quasi-compact and $\dim(X) < \infty$ (usual dimension), then one can show
using Lemma \ref{chow-lemma-vanish-above-dimension} and the splitting principle
that $ch(\mathcal{E}) \in A^*(X) \otimes \mathbf{Q}$.
\end{remark}

\begin{lemma}[Chern character additive]
\label{chow-lemma-chern-character-additive}
\source{stacks:0F9C}
\href{https://stacks.math.columbia.edu/tag/0F9C}{\texttt{Stacks tag 0F9C}}
\group{chow}

\uses{chow-situation-setup, chow-example-power-sum}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}. Let $X$ be locally
...
in $A^p(X)$ where $P_p$ is as in Example \ref{chow-example-power-sum}.
\end{lemma}

\begin{proof}
\uses{chow-example-power-sum}
...
from our choice of $P_p$ in Example \ref{chow-example-power-sum}.
\end{proof}

\begin{lemma}[Chern character multiplicative]
\label{chow-lemma-chern-character-multiplicative}
\source{stacks:0F9D}
\href{https://stacks.math.columbia.edu/tag/0F9D}{\texttt{Stacks tag 0F9D}}
\group{chow}
...
shape of our polynomials $P_p$ in Example \ref{chow-example-power-sum}.
\end{proof}

\begin{lemma}[Chern character dual]
\label{chow-lemma-chern-character-dual}
\source{stacks:0FAB}
\href{https://stacks.math.columbia.edu/tag/0FAB}{\texttt{Stacks tag 0FAB}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-chern-classes-dual}

Follows from the corresponding result for Chern classes
(Lemma \ref{chow-lemma-chern-classes-dual}).
\end{proof}
...
as in Example \ref{chow-example-power-sum} we define
$$
...
\begin{lemma}[Pre derived chern class]
\label{chow-lemma-pre-derived-chern-class}
\source{stacks:0ESZ}
\href{https://stacks.math.columbia.edu/tag/0ESZ}{\texttt{Stacks tag 0ESZ}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-chern-character-additive, chow-lemma-additivity-chern-classes, chow-remark-extend-to-finite-locally-free, chow-lemma-disjoint-decomposition-bivariant, chow-lemma-bivariant-zero}

We prove this for the total Chern class; the other two cases follow
by the same arguments using
Lemma \ref{chow-lemma-chern-character-additive}
instead of
Lemma \ref{chow-lemma-additivity-chern-classes}.

\medskip\noindent
As in Remark \ref{chow-remark-extend-to-finite-locally-free} in order
...
$$
as above. By Lemma \ref{chow-lemma-disjoint-decomposition-bivariant}
...
By Lemma \ref{chow-lemma-bivariant-zero} it suffices to show that
...
By additivity (Lemma \ref{chow-lemma-additivity-chern-classes}) we see that
$$
c(\mathcal{E}^\bullet) = \prod\nolimits_i
...
\begin{lemma}[Defined by envelope]
\label{chow-lemma-defined-by-envelope}
\source{stacks:0GUD}
\href{https://stacks.math.columbia.edu/tag/0GUD}{\texttt{Stacks tag 0GUD}}
\group{chow}
...
$f : Y \to X$ (Definition \ref{chow-definition-envelope})
...
\begin{proof}
\uses{chow-lemma-pre-derived-chern-class, chow-remark-restriction-bivariant, chow-lemma-cap-cp-bivariant, chow-lemma-envelope-bivariant, chow-lemma-base-change-envelope, chow-lemma-composition-envelope}
...
Lemma \ref{chow-lemma-pre-derived-chern-class}.
...
restriction (Remark \ref{chow-remark-restriction-bivariant})
...
an application of Lemma \ref{chow-lemma-envelope-bivariant}
...
is an envelope (Lemmas \ref{chow-lemma-base-change-envelope} and
\ref{chow-lemma-composition-envelope}), we see that our two candidates for $c_p(E)$
agree by the unicity in Lemma \ref{chow-lemma-envelope-bivariant}.
\end{proof}

\begin{definition}[Defined on perfect]
\label{chow-definition-defined-on-perfect}
\source{stacks:0F9E}
\href{https://stacks.math.columbia.edu/tag/0F9E}{\texttt{Stacks tag 0F9E}}
\group{chow}

\uses{chow-situation-setup, chow-lemma-chern-classes-defined, chow-lemma-defined-by-envelope}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
Let $X$ be locally of finite type over $S$. Let $E \in D(\mathcal{O}_X)$
be a perfect object.
\begin{enumerate}
\item We say the {\it Chern classes of $E$ are defined}\footnote{See
Lemma \ref{chow-lemma-chern-classes-defined} for some criteria.} if there exists
...
P_p(E) \in A^p(X)
$$
by an application of Lemma \ref{chow-lemma-defined-by-envelope}.
\end{enumerate}
\end{definition}

This definition applies in many but not all situations envisioned
in this chapter, see Lemma \ref{chow-lemma-chern-classes-defined}.
...
\begin{lemma}[Chern classes defined]
\label{chow-lemma-chern-classes-defined}
\source{stacks:0GUE}
\href{https://stacks.math.columbia.edu/tag/0GUE}{\texttt{Stacks tag 0GUE}}
\group{chow}
...
\begin{proof}
\uses{chow-definition-defined-on-perfect, chow-lemma-base-change-envelope}

Condition (1) is just Definition \ref{chow-definition-defined-on-perfect} part (1).
...
Lemma \ref{chow-lemma-base-change-envelope}. Moreover, the pulllback
$\mathcal{E}^\bullet = g^*(\mathcal{E}')^\bullet$ represents $Lf^*E$
and we see that the chern classes of $E$ are defined.
\end{proof}

\begin{lemma}[Chern classes computed]
\label{chow-lemma-chern-classes-computed}
\source{stacks:0GUF}
\href{https://stacks.math.columbia.edu/tag/0GUF}{\texttt{Stacks tag 0GUF}}
\group{chow}
...
$$
\begin{array}{ccc}W' \underset{g'}{\searrow}\underset{b}{\longrightarrow} &  & W \overset{g}{\swarrow} \\  & X & \end{array}
$$
...
\begin{proof}
\uses{chow-lemma-base-change-envelope}
...
Lemma \ref{chow-lemma-base-change-envelope}. Choose a point
...
\begin{lemma}[Commutative chern perfect]
\label{chow-lemma-commutative-chern-perfect}
\source{stacks:0FAC}
\href{https://stacks.math.columbia.edu/tag/0FAC}{\texttt{Stacks tag 0FAC}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-bivariant-zero, chow-lemma-chern-classes-computed, chow-lemma-cap-commutative-chern}
...
Lemma \ref{chow-lemma-bivariant-zero}. Thus we may assume that $X$
is integral and by Lemma \ref{chow-lemma-chern-classes-computed}
...
Lemma \ref{chow-lemma-cap-commutative-chern} and the construction
of $c_p(\mathcal{E}^\bullet)$ as a polynomial in the
chern classes of the locally free modules $\mathcal{E}^n$.
\end{proof}

\begin{lemma}[Additivity on perfect]
\label{chow-lemma-additivity-on-perfect}
\source{stacks:0F9F}
\href{https://stacks.math.columbia.edu/tag/0F9F}{\texttt{Stacks tag 0F9F}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-additivity-chern-classes, chow-lemma-chern-character-additive, chow-lemma-chern-classes-defined}
...
multiplicativity of Lemma \ref{chow-lemma-additivity-chern-classes}.
In the case of $ch$ or $P_p$ we use
Lemmas \ref{chow-lemma-chern-character-additive}.
...
Lemma \ref{chow-lemma-chern-classes-defined} we find an envelope
...
\begin{remark}[Splitting principle perfect]
\label{chow-remark-splitting-principle-perfect}
\source{stacks:0FAD}
\href{https://stacks.math.columbia.edu/tag/0FAD}{\texttt{Stacks tag 0FAD}}
\group{chow}

\uses{chow-definition-defined-on-perfect, chow-lemma-defined-by-envelope, chow-lemma-splitting-principle, chow-example-power-sum}
...
Definition \ref{chow-definition-defined-on-perfect}
...
representing $E$. By the uniqueness in Lemma \ref{chow-lemma-defined-by-envelope}
...
(Lemma \ref{chow-lemma-splitting-principle}) we may assume each
...
Example \ref{chow-example-power-sum} it follows that $P_p(E)$
...
\begin{lemma}[Chern classes perfect dual]
\label{chow-lemma-chern-classes-perfect-dual}
\source{stacks:0FAE}
\href{https://stacks.math.columbia.edu/tag/0FAE}{\texttt{Stacks tag 0FAE}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-commutative-chern-perfect, chow-lemma-chern-classes-dual, chow-remark-splitting-principle-perfect}

First proof: argue as in the proof of
Lemma \ref{chow-lemma-commutative-chern-perfect}
to reduce to the case where $E$ is represented
by a bounded complex of finite locally free modules
of fixed rank and apply Lemma \ref{chow-lemma-chern-classes-dual}.
Second proof: use the splitting principle discussed
in Remark \ref{chow-remark-splitting-principle-perfect}
and use that the chern roots of $E^\vee$ are the negatives
of the chern roots of $E$.
\end{proof}

\begin{lemma}[Chern class perfect tensor invertible]
\label{chow-lemma-chern-class-perfect-tensor-invertible}
\source{stacks:0FAF}
\href{https://stacks.math.columbia.edu/tag/0FAF}{\texttt{Stacks tag 0FAF}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-chern-classes-E-tensor-L, chow-remark-splitting-principle-perfect}

In the case where $E$ is locally free of rank $r$ this is
Lemma \ref{chow-lemma-chern-classes-E-tensor-L}. The reader can deduce
the lemma from this special case by a formal computation.
An alternative is to use the splitting principle of
Remark \ref{chow-remark-splitting-principle-perfect}.
...
\begin{lemma}[Chern classes perfect tensor product]
\label{chow-lemma-chern-classes-perfect-tensor-product}
\source{stacks:0FAG}
\href{https://stacks.math.columbia.edu/tag/0FAG}{\texttt{Stacks tag 0FAG}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-chern-classes-tensor-product, chow-lemma-chern-character-multiplicative, chow-remark-splitting-principle-perfect}
...
Lemmas \ref{chow-lemma-chern-classes-tensor-product} and
...
in Remark \ref{chow-remark-splitting-principle-perfect}. For example
$$
...
\source{stacks:0F9H}
\href{https://stacks.math.columbia.edu/tag/0F9H}{\texttt{Stacks tag 0F9H}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-exact-sequence-closed-chow}

We are going to use the material of Section \ref{chow-section-pre-derived}
...
base change of $i_j$. By Lemma \ref{chow-lemma-exact-sequence-closed-chow}
...
\begin{lemma}[Silly independent]
\label{chow-lemma-silly-independent}
\source{stacks:0FAH}
\href{https://stacks.math.columbia.edu/tag/0FAH}{\texttt{Stacks tag 0FAH}}
\group{chow}

\uses{chow-lemma-silly}
In Lemma \ref{chow-lemma-silly} the bivariant class
...
\begin{lemma}[Base change silly]
\label{chow-lemma-base-change-silly}
\source{stacks:0GUG}
\href{https://stacks.math.columbia.edu/tag/0GUG}{\texttt{Stacks tag 0GUG}}
\group{chow}

\uses{chow-lemma-silly, chow-remark-restriction-bivariant}
In Lemma \ref{chow-lemma-silly} let $X' \to X$ be a morphism
...
$A^p(X_2' \to X')$ constructed in Lemma \ref{chow-lemma-silly} using
$X' = X'_1 \cup X'_2$ and $E_2'$ is the restriction
(Remark \ref{chow-remark-restriction-bivariant})
...
Lemma \ref{chow-lemma-silly}.
\end{proof}

\begin{lemma}[Silly silly]
\label{chow-lemma-silly-silly}
\source{stacks:0F9I}
\href{https://stacks.math.columbia.edu/tag/0F9I}{\texttt{Stacks tag 0F9I}}
\group{chow}

\uses{chow-lemma-silly, chow-lemma-push-proper-bivariant}
In Lemma \ref{chow-lemma-silly} say $E_2$ is the restriction of a
...
(with $\circ$ as in Lemma \ref{chow-lemma-push-proper-bivariant}).
\end{lemma}
...
With notations as in the proof of Lemma \ref{chow-lemma-silly}
...
\begin{lemma}[Silly shrink]
\label{chow-lemma-silly-shrink}
\source{stacks:0FAI}
\href{https://stacks.math.columbia.edu/tag/0FAI}{\texttt{Stacks tag 0FAI}}
\group{chow}

\uses{chow-lemma-silly, chow-lemma-push-proper-bivariant}
In Lemma \ref{chow-lemma-silly} suppose we have closed subschemes
...
in Lemma \ref{chow-lemma-silly}.
\end{proof}

\begin{lemma}[Silly commutes]
\label{chow-lemma-silly-commutes}
\source{stacks:0FAJ}
\href{https://stacks.math.columbia.edu/tag/0FAJ}{\texttt{Stacks tag 0FAJ}}
\group{chow}

\uses{chow-lemma-silly}
In Lemma \ref{chow-lemma-silly} let $f : Y \to X$ be locally of finite type
...
\begin{proof}
\uses{chow-lemma-commutative-chern-perfect}
...
We conclude by Lemma \ref{chow-lemma-commutative-chern-perfect}.
\end{proof}

\begin{lemma}[Silly compose]
\label{chow-lemma-silly-compose}
\source{stacks:0FAK}
\href{https://stacks.math.columbia.edu/tag/0FAK}{\texttt{Stacks tag 0FAK}}
\group{chow}

\uses{chow-lemma-silly, chow-remark-ring-loc-classes}
In Lemma \ref{chow-lemma-silly} assume $E_2|_{X_1 \cap X_2}$ is zero. Then
\begin{align*}
P'_1(E_2) & = c'_1(E_2), \\
...
\end{align*}
and so on with multiplication as in Remark \ref{chow-remark-ring-loc-classes}.
\end{lemma}

\begin{proof}
\uses{chow-lemma-silly, chow-remark-splitting-principle-perfect}
...
by Lemma \ref{chow-lemma-silly} and the corresponding result for
capping with the Chern classes of $E_2$ given in
Remark \ref{chow-remark-splitting-principle-perfect}.
\end{proof}

\begin{lemma}[Silly sum c]
\label{chow-lemma-silly-sum-c}
\source{stacks:0FAL}
\href{https://stacks.math.columbia.edu/tag/0FAL}{\texttt{Stacks tag 0FAL}}
\group{chow}

\uses{chow-situation-setup, chow-remark-ring-loc-classes, chow-lemma-silly}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}. Let $X$ be
locally of finite type over $S$. Let $i_j : X_j \to X$, $j = 1, 2$
be closed immersions such that $X = X_1 \cup X_2$ set theoretically. Let
...
\end{enumerate}
With notation as in Remark \ref{chow-remark-ring-loc-classes} set
$$
c^{(p)}(E) = 1 + c_1(E) + \ldots + c_{p - 1}(E) +
c'_p(E|_{X_2}) + c'_{p + 1}(E|_{X_2}) + \ldots \in A^{(p)}(X_2 \to X)
$$
with $c'_p(E|_{X_2})$ as in Lemma \ref{chow-lemma-silly}. Similarly
...
\begin{proof}
\uses{chow-lemma-silly, chow-lemma-additivity-on-perfect}

Immediate from the characterization of the classes in
Lemma \ref{chow-lemma-silly} and the additivity in
Lemma \ref{chow-lemma-additivity-on-perfect}.
\end{proof}

\begin{lemma}[Silly sum P]
\label{chow-lemma-silly-sum-P}
\source{stacks:0FAM}
\href{https://stacks.math.columbia.edu/tag/0FAM}{\texttt{Stacks tag 0FAM}}
\group{chow}

\uses{chow-situation-setup, chow-lemma-silly}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}. Let $X$ be
locally of finite type over $S$. Let $i_j : X_j \to X$, $j = 1, 2$
be closed immersions such that $X = X_1 \cup X_2$ set theoretically. Let
...
the classes constructed in Lemma \ref{chow-lemma-silly}. Then
...
\begin{lemma}[Silly tensor invertible]
\label{chow-lemma-silly-tensor-invertible}
\source{stacks:0FAN}
\href{https://stacks.math.columbia.edu/tag/0FAN}{\texttt{Stacks tag 0FAN}}
\group{chow}

\uses{chow-lemma-silly}
In Lemma \ref{chow-lemma-silly} assume $E_2$ has constant rank $0$.
Let $\mathcal{L}$ be an invertible $\mathcal{O}_X$-module. Then
$$
...
\begin{proof}
\uses{chow-lemma-chern-class-perfect-tensor-invertible, chow-lemma-silly}
...
immediately from Lemma \ref{chow-lemma-chern-class-perfect-tensor-invertible}
and the characterization of $c'_i$ in Lemma \ref{chow-lemma-silly}.
\end{proof}

\begin{lemma}[Silly tensor product]
\label{chow-lemma-silly-tensor-product}
\source{stacks:0FE5}
\href{https://stacks.math.columbia.edu/tag/0FE5}{\texttt{Stacks tag 0FE5}}
\group{chow}
...
\end{enumerate}
the classes constructed in Lemma \ref{chow-lemma-silly}. Then we have
$$
...
\begin{proof}
\uses{chow-lemma-silly, chow-lemma-chern-classes-perfect-tensor-product}
...
of our classes in Lemma \ref{chow-lemma-silly}
and the equalities of Lemma \ref{chow-lemma-chern-classes-perfect-tensor-product}.
We omit the details.
\end{proof}
...
\begin{lemma}[Gysin at infty]
\label{chow-lemma-gysin-at-infty}
\source{stacks:0F9J}
\href{https://stacks.math.columbia.edu/tag/0F9J}{\texttt{Stacks tag 0F9J}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-exact-sequence-open, chow-lemma-restrict-to-open, chow-remark-gysin-on-cycles, chow-lemma-support-cap-effective-Cartier, chow-lemma-relative-effective-cartier, chow-lemma-flat-pullback-bivariant, chow-lemma-gysin-bivariant}
...
Lemma \ref{chow-lemma-restrict-to-open}. Since the normal bundle of the effective
...
supported on $W_\infty$, see Remark \ref{chow-remark-gysin-on-cycles}.
...
Lemma \ref{chow-lemma-support-cap-effective-Cartier}. By our choice of
...
$$
\begin{array}{ccccc} &  &  & \CH_*(X) \overset{\text{flat pullback}}{\downarrow} &  \\ \CH_{* + 1}(W_\infty) \longrightarrow\overset{0}{\searrow} & \CH_{* + 1}(W) \overset{i_\infty^*}{\downarrow}\overset{\text{flat pullback}}{\longrightarrow} &  & \CH_{* + 1}(\mathbf{A}^1_X) \longrightarrow\overset{C \cap -}{\swarrow} & 0 \\  & \CH_*(W_\infty) &  &  & \end{array}
$$
...
Lemmas \ref{chow-lemma-flat-pullback-bivariant} and \ref{chow-lemma-gysin-bivariant}.
...
\begin{lemma}[Base change gysin at infty]
\label{chow-lemma-base-change-gysin-at-infty}
\source{stacks:0GUH}
\href{https://stacks.math.columbia.edu/tag/0GUH}{\texttt{Stacks tag 0GUH}}
\group{chow}

\uses{chow-lemma-gysin-at-infty, chow-remark-restriction-bivariant}
In Lemma \ref{chow-lemma-gysin-at-infty} let $X' \to X$ be a morphism
...
Lemma \ref{chow-lemma-gysin-at-infty} using $b'$ is the restriction
(Remark \ref{chow-remark-restriction-bivariant}) of $C$.
\end{lemma}
...
\begin{lemma}[Gysin at infty independent]
\label{chow-lemma-gysin-at-infty-independent}
\source{stacks:0FAQ}
\href{https://stacks.math.columbia.edu/tag/0FAQ}{\texttt{Stacks tag 0FAQ}}
\group{chow}

\uses{chow-lemma-gysin-at-infty}
In Lemma \ref{chow-lemma-gysin-at-infty} let $g : W' \to W$ be a proper morphism
which is an isomorphism over $\mathbf{A}^1_X$. Let
$C' \in A^0(W'_\infty \to X)$ and $C \in A^0(W_\infty \to X)$
be the classes constructed in Lemma \ref{chow-lemma-gysin-at-infty}.
Then $g_{\infty, *} \circ C' = C$ in $A^0(W_\infty \to X)$.
\end{lemma}

\begin{proof}
\uses{chow-lemma-closed-in-X-gysin}
...
by Lemma \ref{chow-lemma-closed-in-X-gysin}.
...
\begin{lemma}[Homomorphism pre]
\label{chow-lemma-homomorphism-pre}
\source{stacks:0FAR}
\href{https://stacks.math.columbia.edu/tag/0FAR}{\texttt{Stacks tag 0FAR}}
\group{chow}

\uses{chow-lemma-gysin-at-infty}
In Lemma \ref{chow-lemma-gysin-at-infty} we have
$C \circ (W_\infty \to X)_* \circ i_\infty^* = i_\infty^*$.
\end{lemma}

\begin{proof}
\uses{chow-lemma-support-cap-effective-Cartier, chow-lemma-linebundle, chow-lemma-linebundle-formulae}
...
Lemma \ref{chow-lemma-support-cap-effective-Cartier})
...
Lemmas \ref{chow-lemma-linebundle} and \ref{chow-lemma-linebundle-formulae}.
Hence we may use $\beta$ when computing the image of
$(W_\infty \to X)_*i_\infty^*\beta$ under $C$
and we get the desired result.
\end{proof}

\begin{lemma}[Gysin at infty commutes]
\label{chow-lemma-gysin-at-infty-commutes}
\source{stacks:0FAS}
\href{https://stacks.math.columbia.edu/tag/0FAS}{\texttt{Stacks tag 0FAS}}
\group{chow}

\uses{chow-lemma-gysin-at-infty}
In Lemma \ref{chow-lemma-gysin-at-infty} let $f : Y \to X$ be a morphism
...
$$
\begin{array}{ccccc}W_\infty \times_X Y \xlongequal{} & W_{Y, \infty} \underset{i_{Y, \infty}}{\longrightarrow}\downarrow & W_Y \underset{b_Y}{\longrightarrow}\downarrow & \mathbf{P}^1_Y \underset{p_Y}{\longrightarrow}\downarrow & Y \overset{f}{\downarrow} \\  & W_\infty \overset{i_\infty}{\longrightarrow} & W \overset{b}{\longrightarrow} & \mathbf{P}^1_X \overset{p}{\longrightarrow} & X\end{array}
$$
...
\begin{lemma}[Localized chern pre]
\label{chow-lemma-localized-chern-pre}
\source{stacks:0F9K}
\href{https://stacks.math.columbia.edu/tag/0F9K}{\texttt{Stacks tag 0F9K}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-gysin-at-infty, chow-lemma-silly, chow-lemma-push-proper-bivariant, chow-lemma-silly-silly}
...
in Lemma \ref{chow-lemma-gysin-at-infty}. Denote $P'_p(Q|_E)$, resp.\ $c'_p(Q|_E)$
in $A^p(E \to W_\infty)$ the bivariant class constructed
in Lemma \ref{chow-lemma-silly}. This makes sense because
...
$$
This is a bivariant class, see Lemma \ref{chow-lemma-push-proper-bivariant}.
...
c_p(Q|_{X \times \{0\}})
\end{align*}
The second equality holds by Lemma \ref{chow-lemma-silly-silly}.
The third equality because $c_p(Q)$ is a bivariant class.
The fourth equality by Lemma \ref{chow-lemma-gysin-at-infty}.
...
\begin{lemma}[Base change localized chern pre]
\label{chow-lemma-base-change-localized-chern-pre}
\source{stacks:0GUI}
\href{https://stacks.math.columbia.edu/tag/0GUI}{\texttt{Stacks tag 0GUI}}
\group{chow}

\uses{chow-lemma-localized-chern-pre, chow-remark-restriction-bivariant}
In Lemma \ref{chow-lemma-localized-chern-pre} let $X' \to X$ be a morphism
...
Lemma \ref{chow-lemma-localized-chern-pre} using $b'$, $Q'$, and $T'$
is the restriction (Remark \ref{chow-remark-restriction-bivariant})
of the class $P'_p(Q)$, resp.\ $c'_p(Q)$ in $A^p(Z \to X)$.
\end{lemma}

\begin{proof}
\uses{chow-lemma-base-change-gysin-at-infty, chow-lemma-silly}
...
for $C$ (Lemma \ref{chow-lemma-base-change-gysin-at-infty})
and the fact that the same base change property holds for the classes
constructed in Lemma \ref{chow-lemma-silly} (small detail omitted).
\end{proof}

\begin{lemma}[Localized chern pre independent]
\label{chow-lemma-localized-chern-pre-independent}
\source{stacks:0FAU}
\href{https://stacks.math.columbia.edu/tag/0FAU}{\texttt{Stacks tag 0FAU}}
\group{chow}

\uses{chow-lemma-localized-chern-pre}
In Lemma \ref{chow-lemma-localized-chern-pre} the bivariant class
$P'_p(Q)$, resp.\ $c'_p(Q)$
...
\begin{proof}
\uses{chow-lemma-silly-independent, chow-lemma-gysin-at-infty-independent, chow-remark-restriction-bivariant}

The independence of $T$ follows immediately from
Lemma \ref{chow-lemma-silly-independent}.
...
By Lemma \ref{chow-lemma-gysin-at-infty-independent} we have
...
Remark \ref{chow-remark-restriction-bivariant}. Thus we obtain
\begin{align*}
c'_p(Q')
& =
...
\begin{lemma}[Homomorphism]
\label{chow-lemma-homomorphism}
\source{stacks:0FAV}
\href{https://stacks.math.columbia.edu/tag/0FAV}{\texttt{Stacks tag 0FAV}}
\group{chow}

\uses{chow-lemma-localized-chern-pre, chow-lemma-gysin-at-infty}
In Lemma \ref{chow-lemma-localized-chern-pre} assume $Q|_T$ is isomorphic
to a finite locally free $\mathcal{O}_T$-module of rank $< p$.
Denote $C \in A^0(W_\infty \to X)$ the class of
Lemma \ref{chow-lemma-gysin-at-infty}. Then
$$
...
\begin{proof}
\uses{chow-lemma-localized-chern-pre, chow-lemma-bivariant-zero, chow-lemma-silly, chow-lemma-silly-silly, chow-lemma-homomorphism-pre}

The first equality holds because $c_p(Q|_{X \times \{0\}}) =
(Z \to X)_* \circ c'_p(Q)$ by Lemma \ref{chow-lemma-localized-chern-pre}.
We may prove the second equality one cycle class at a time
(see Lemma \ref{chow-lemma-bivariant-zero}). Since the construction of
...
in Lemma \ref{chow-lemma-silly}. The second equality is just the statement
...
Lemma \ref{chow-lemma-silly-silly}. The fifth equality is the fact that
$c_p(Q)$ is a bivariant class and hence commutes with $i_\infty^*$.
The sixth equality is Lemma \ref{chow-lemma-homomorphism-pre}.
The seventh uses again that $c_p(Q)$ is a bivariant class.
The final holds as $C \cap \alpha = i_\infty^*\beta$.
\end{proof}

\begin{lemma}[Homomorphism commute]
\label{chow-lemma-homomorphism-commute}
\source{stacks:0FAW}
\href{https://stacks.math.columbia.edu/tag/0FAW}{\texttt{Stacks tag 0FAW}}
\group{chow}

\uses{chow-lemma-localized-chern-pre}
In Lemma \ref{chow-lemma-localized-chern-pre} let $Y \to X$ be a morphism
...
\begin{proof}
\uses{chow-lemma-gysin-at-infty, chow-lemma-silly, chow-lemma-gysin-at-infty-commutes, chow-lemma-silly-commutes}
...
where $C$ is as in Lemma \ref{chow-lemma-gysin-at-infty} and
$P'_p(Q|_E)$, resp.\ $c'_p(Q|_E)$ are as in
Lemma \ref{chow-lemma-silly}.
By Lemma \ref{chow-lemma-gysin-at-infty-commutes}
we see that $C$ commutes with $c$
and by Lemma \ref{chow-lemma-silly-commutes} we see that
...
\begin{lemma}[Localized chern pre compose]
\label{chow-lemma-localized-chern-pre-compose}
\source{stacks:0FAX}
\href{https://stacks.math.columbia.edu/tag/0FAX}{\texttt{Stacks tag 0FAX}}
\group{chow}

\uses{chow-lemma-localized-chern-pre, chow-remark-ring-loc-classes}
In Lemma \ref{chow-lemma-localized-chern-pre} assume $Q|_T$ is zero. In
$A^*(Z \to X)$ we have
\begin{align*}
P'_1(Q) & = c'_1(Q), \\
...
\begin{proof}
\uses{chow-lemma-localized-chern-pre, chow-lemma-gysin-at-infty, chow-lemma-silly, chow-lemma-silly-compose, chow-remark-ring-loc-classes, chow-remark-res-push, chow-lemma-homomorphism}

The statement makes sense because the zero sheaf has rank $< 1$ and
hence the classes $c'_p(Q)$ are defined for all $p \geq 1$.
In the proof of Lemma \ref{chow-lemma-localized-chern-pre} we have constructed
the classes $P'_p(Q)$ and $c'_p(Q)$ using the bivariant class
$C \in A^0(W_\infty \to X)$ of Lemma \ref{chow-lemma-gysin-at-infty}
and the bivariant classes
$P'_p(Q|_E)$ and $c'_p(Q|_E)$ of Lemma \ref{chow-lemma-silly} for the restriction
$Q|_E$ of $Q$ to the inverse image $E$ of $Z$ in $W_\infty$.
Observe that by Lemma \ref{chow-lemma-silly-compose} we have the desired
...
in Remark \ref{chow-remark-ring-loc-classes} on the classes $a_p = c'_p(Q)$
...
For $r > 1$ note that by Remark \ref{chow-remark-res-push} the multiplication in
Remark \ref{chow-remark-ring-loc-classes} proceeds
...
Now by Lemma \ref{chow-lemma-silly} we have
$$
(E \to W_\infty)_* \circ b_{p_i} = c_{p_i}(Q|_{W_\infty})
$$
and by Lemma \ref{chow-lemma-homomorphism} we have
$$
...
\begin{lemma}[Localized chern pre sum c]
\label{chow-lemma-localized-chern-pre-sum-c}
\source{stacks:0FAY}
\href{https://stacks.math.columbia.edu/tag/0FAY}{\texttt{Stacks tag 0FAY}}
\group{chow}
...
Remark \ref{chow-remark-ring-loc-classes} set
$$
...
Lemma \ref{chow-lemma-localized-chern-pre}. Similarly for $c^{(p')}(Q')$ and
$c^{(p + p')}(Q \oplus Q')$.
...
\begin{proof}
\uses{chow-lemma-localized-chern-pre, chow-lemma-additivity-on-perfect, chow-lemma-silly-sum-c, chow-remark-ring-loc-classes, chow-remark-res-push, chow-lemma-silly, chow-lemma-homomorphism, chow-lemma-cap-commutative-chern}

Recall that the image of $c'_i(Q)$ in $A^p(X)$ is equal to
$c_i(Q|_{X \times \{0\}})$ for $i \geq p$ and similarly for
$Q'$ and $Q \oplus Q'$, see Lemma \ref{chow-lemma-localized-chern-pre}.
Hence the equality in degrees $< p + p'$ follows from the
additivity of Lemma \ref{chow-lemma-additivity-on-perfect}.

\medskip\noindent
Let's take $n \geq p + p'$.
As in the proof of Lemma \ref{chow-lemma-localized-chern-pre}
...
c^{(p)}(Q|_E)c^{(p')}(Q'|_E)
$$
in $A^{(p + p')}(E \to W_\infty)$ by Lemma \ref{chow-lemma-silly-sum-c}.
...
Remark \ref{chow-remark-ring-loc-classes} on both sides. There are
...
Remark \ref{chow-remark-res-push}.
...
$$
By Lemma \ref{chow-lemma-silly} the left hand side is equal to
$$
...
by Lemma \ref{chow-lemma-homomorphism}.
...
Lemma \ref{chow-lemma-homomorphism}.
...
(Lemma \ref{chow-lemma-cap-commutative-chern}). Hence it suffices to prove
$$
...
\begin{lemma}[Localized chern pre sum P]
\label{chow-lemma-localized-chern-pre-sum-P}
\source{stacks:0FAZ}
\href{https://stacks.math.columbia.edu/tag/0FAZ}{\texttt{Stacks tag 0FAZ}}
\group{chow}

\uses{chow-lemma-localized-chern-pre}
In Lemma \ref{chow-lemma-localized-chern-pre} assume $Q|_T$ is zero.
Assume we have another perfect object $Q' \in D(\mathcal{O}_W)$
...
constructed in Lemma \ref{chow-lemma-localized-chern-pre}
satisfy $P'_p(Q \oplus Q') = P'_p(Q) + P'_p(Q')$.
\end{lemma}

\begin{proof}
\uses{chow-lemma-silly-sum-P}

This follows immediately from the construction of these
classes and Lemma \ref{chow-lemma-silly-sum-P}.
\end{proof}
...
$$
\begin{array}{cc}W \underset{f}{\downarrow}\underset{q}{\longrightarrow} & X \\ \mathbf{P}^1_F & \end{array}
$$
...
Section \ref{chow-section-preparation-localized-chern-II} relying on
Sections \ref{chow-section-gysin-at-infty} and
\ref{chow-section-preparation-localized-chern}.

\begin{definition}[Situation: Loc chern]
\label{chow-situation-loc-chern}
\source{stacks:0GUJ}
\href{https://stacks.math.columbia.edu/tag/0GUJ}{\texttt{Stacks tag 0GUJ}}
\group{chow}

\uses{chow-situation-setup, chow-remark-loc-chern}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}. Let $X$ be a scheme
...
first reading; see discussion in Remark \ref{chow-remark-loc-chern}.}
...
\begin{lemma}[Independent loc chern]
\label{chow-lemma-independent-loc-chern}
\source{stacks:0FB2}
\href{https://stacks.math.columbia.edu/tag/0FB2}{\texttt{Stacks tag 0FB2}}
\group{chow}

\uses{chow-situation-loc-chern, chow-lemma-push-proper-bivariant}
In Situation \ref{chow-situation-loc-chern} there exists a canonical bivariant class
$$
...
Lemma \ref{chow-lemma-push-proper-bivariant}).
\end{lemma}

\begin{proof}
\uses{chow-situation-loc-chern, chow-lemma-localized-chern-pre, chow-definition-defined-on-perfect, chow-lemma-chern-classes-defined}
...
Situation \ref{chow-situation-loc-chern} the morphisms
$$
...
that the bivariant class constructed in Lemma \ref{chow-lemma-localized-chern-pre}
...
(Definition \ref{chow-definition-defined-on-perfect}); we suggest the reader skip
this. If assumption (3)(a) or (3)(b) of Situation \ref{chow-situation-loc-chern}
...
Lemma \ref{chow-lemma-chern-classes-defined}. If (3)(c) hold, i.e., if
...
Lemma \ref{chow-lemma-chern-classes-defined}
that the chern classes of $Q$ are defined.
\end{proof}

\begin{definition}[Localized chern]
\label{chow-definition-localized-chern}
\source{stacks:0FB5}
\href{https://stacks.math.columbia.edu/tag/0FB5}{\texttt{Stacks tag 0FB5}}
\group{chow}

\uses{chow-situation-loc-chern, chow-lemma-independent-loc-chern}
...
P_p(Z \to X, E) \in A^p(Z \to X)
$$
by the construction in Lemma \ref{chow-lemma-independent-loc-chern}
...
in Lemma \ref{chow-lemma-independent-loc-chern}.
\end{enumerate}
\end{definition}
...
\begin{lemma}[Base change loc chern]
\label{chow-lemma-base-change-loc-chern}
\source{stacks:0FB3}
\href{https://stacks.math.columbia.edu/tag/0FB3}{\texttt{Stacks tag 0FB3}}
\group{chow}

\uses{chow-situation-loc-chern, chow-definition-localized-chern, chow-lemma-independent-loc-chern, chow-remark-restriction-bivariant}
In Situation \ref{chow-situation-loc-chern}
let $f : X' \to X$ be a morphism of schemes which is locally of finite type.
Denote $E' = f^*E$ and $Z' = f^{-1}(Z)$. Then the bivariant class
of Definition \ref{chow-definition-localized-chern}
$$
P_p(Z' \to X', E') \in A^p(Z' \to X'),
\quad\text{resp.}\quad
c_p(Z' \to X', E') \in A^p(Z' \to X')
$$
constructed as in Lemma \ref{chow-lemma-independent-loc-chern}
using $X', Z', E'$ is the restriction
(Remark \ref{chow-remark-restriction-bivariant}) of the
bivariant class $P_p(Z \to X, E) \in A^p(Z \to X)$,
resp.\ $c_p(Z \to X, E) \in A^p(Z \to X)$.
\end{lemma}

\begin{proof}
\uses{chow-lemma-localized-chern-pre, chow-lemma-localized-chern-pre-independent, chow-lemma-base-change-localized-chern-pre}
...
$$
\begin{array}{ccc}W' \underset{b'}{\searrow}\underset{g}{\longrightarrow} & \mathbf{P}^1_{X'} \times_{\mathbf{P}^1_X} W \underset{r}{\downarrow}\underset{q}{\longrightarrow} & W \overset{b}{\downarrow} \\  & \mathbf{P}^1_{X'} \longrightarrow & \mathbf{P}^1_X\end{array}
$$
...
are constructed in Lemma \ref{chow-lemma-localized-chern-pre}
...
In the construction of Lemma \ref{chow-lemma-localized-chern-pre}
we chose a particular closed subscheme $T'$ with properties (a) and (b)
but the precise choice of $T'$ is immaterial, see
Lemma \ref{chow-lemma-localized-chern-pre-independent}.

\medskip\noindent
Next, by Lemma \ref{chow-lemma-base-change-localized-chern-pre}
...
constructed as in Lemma \ref{chow-lemma-localized-chern-pre} using
...
\begin{remark}[Loc chern]
\label{chow-remark-loc-chern}
\source{stacks:0GUK}
\href{https://stacks.math.columbia.edu/tag/0GUK}{\texttt{Stacks tag 0GUK}}
\group{chow}

\uses{chow-situation-loc-chern, chow-lemma-independent-loc-chern, chow-lemma-base-change-loc-chern, chow-lemma-envelope-bivariant}
In Situation \ref{chow-situation-loc-chern} it would have been more natural
to replace assumption (3) with the assumption: ``the chern classes
of $E$ are defined''. In fact, combining
Lemmas \ref{chow-lemma-independent-loc-chern} and
\ref{chow-lemma-base-change-loc-chern}
with Lemma \ref{chow-lemma-envelope-bivariant}
it is easy to extend the definition to this (slightly) more general case.
If we ever need this we will do so here.
\end{remark}

\begin{lemma}[Loc chern after pushforward]
\label{chow-lemma-loc-chern-after-pushforward}
\source{stacks:0FB4}
\href{https://stacks.math.columbia.edu/tag/0FB4}{\texttt{Stacks tag 0FB4}}
\group{chow}

\uses{chow-situation-loc-chern}
In Situation \ref{chow-situation-loc-chern} we have
$$
...
\begin{proof}
\uses{chow-lemma-base-change-loc-chern}
...
By Lemma \ref{chow-lemma-base-change-loc-chern} the restriction of
...
\begin{lemma}[Loc chern disjoint]
\label{chow-lemma-loc-chern-disjoint}
\source{stacks:0FB6}
\href{https://stacks.math.columbia.edu/tag/0FB6}{\texttt{Stacks tag 0FB6}}
\group{chow}
...
Lemma \ref{chow-lemma-base-change-loc-chern}
to see that this restriction is zero.
\end{proof}

\begin{lemma}[Loc chern shrink Z]
\label{chow-lemma-loc-chern-shrink-Z}
\source{stacks:0FB7}
\href{https://stacks.math.columbia.edu/tag/0FB7}{\texttt{Stacks tag 0FB7}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-independent-loc-chern, chow-lemma-silly-shrink}

The construction of $P_p(Z' \to X, E)$,
resp.\ $c_p(Z' \to X, E)$ in Lemma \ref{chow-lemma-independent-loc-chern}
uses the exact same morphism
$b : W \to \mathbf{P}^1_X$ and perfect object $Q$ of $D(\mathcal{O}_W)$.
Then we can use Lemma \ref{chow-lemma-silly-shrink} to conclude.
Some details omitted.
\end{proof}

\begin{lemma}[Loc chern agree]
\label{chow-lemma-loc-chern-agree}
\source{stacks:0FB8}
\href{https://stacks.math.columbia.edu/tag/0FB8}{\texttt{Stacks tag 0FB8}}
\group{chow}

\uses{chow-lemma-silly, chow-definition-localized-chern, chow-situation-loc-chern}
In Lemma \ref{chow-lemma-silly} say $E_2$ is the restriction of a perfect
$E \in D(\mathcal{O}_X)$ whose restriction to $X_1$ is zero,
resp.\ isomorphic to a finite locally free $\mathcal{O}_{X_1}$-module
of rank $< p$ sitting in cohomological degree $0$. Then the class
$P'_p(E_2)$, resp.\ $c'_p(E_2)$ of Lemma \ref{chow-lemma-silly} agrees with
$P_p(X_2 \to X, E)$, resp.\ $c_p(X_2 \to X, E)$ of
Definition \ref{chow-definition-localized-chern} provided $E$ satisfies
assumption (3) of Situation \ref{chow-situation-loc-chern}.
\end{lemma}

\begin{proof}
\uses{chow-lemma-loc-chern-shrink-Z, chow-lemma-silly, chow-lemma-loc-chern-disjoint, chow-lemma-loc-chern-after-pushforward}
...
by Lemma \ref{chow-lemma-loc-chern-disjoint}.
On the other hand,
$P_p(X_2 \to X, E) \circ i_{2, *} = P_p(E_2)$,
resp.\ $c_p(X_2 \to X, E) \circ i_{2, *} = c_p(E_2)$
by Lemma \ref{chow-lemma-loc-chern-after-pushforward}.
\end{proof}
...
the proofs of Lemmas \ref{chow-lemma-localized-chern-pre-compose} and
\ref{chow-lemma-localized-chern-pre-sum-c}.

\begin{lemma}[Homomorphism final]
\label{chow-lemma-homomorphism-final}
\source{stacks:0FE7}
\href{https://stacks.math.columbia.edu/tag/0FE7}{\texttt{Stacks tag 0FE7}}
\group{chow}

\uses{chow-situation-setup, chow-lemma-localized-chern-pre, chow-situation-loc-chern}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}. Let $X$ be
...
Lemma \ref{chow-lemma-localized-chern-pre} hold for
$b, Z_i, Q_i, T_i, p_i$,
...
\begin{proof}
\uses{chow-lemma-base-change-localized-chern-pre, chow-lemma-gysin-at-infty, chow-lemma-base-change-silly, chow-lemma-homomorphism-pre, chow-lemma-loc-chern-agree}
...
\circ C
$$
By Lemma \ref{chow-lemma-base-change-localized-chern-pre} the restriction of
...
Z_{n - 1} \cap \ldots \cap Z_1)$ the class of Lemma \ref{chow-lemma-gysin-at-infty}.
...
C_{n - 1}
\end{align*}
where the equality follows from Lemma \ref{chow-lemma-base-change-silly}
...
\circ C
\end{align*}
By Lemma \ref{chow-lemma-homomorphism-pre}
...
\text{ to } W_{i, \infty}
$$
by Lemma \ref{chow-lemma-loc-chern-agree} and assumptions (2) and (3) on $Q_i$
...
\begin{lemma}[Independent loc chern bQ]
\label{chow-lemma-independent-loc-chern-bQ}
\source{stacks:0FE8}
\href{https://stacks.math.columbia.edu/tag/0FE8}{\texttt{Stacks tag 0FE8}}
\group{chow}

\uses{chow-lemma-localized-chern-pre, chow-situation-loc-chern, chow-definition-localized-chern}
Assume $(S, \delta), X, Z, b : W \to \mathbf{P}^1_X, Q, T, p$
satisfy the assumptions of Lemma \ref{chow-lemma-localized-chern-pre}.
...
in Lemma \ref{chow-lemma-localized-chern-pre}
is equal to $P_p(Z \to X, F)$, resp.\ $c_p(Z \to X, F)$
from Definition \ref{chow-definition-localized-chern}.
\end{lemma}

\begin{proof}
\uses{chow-lemma-gysin-at-infty, chow-lemma-localized-chern-pre, chow-lemma-loc-chern-agree, chow-lemma-base-change-loc-chern, chow-remark-gysin-on-cycles, chow-lemma-support-cap-effective-Cartier}
...
$C$ in Lemma \ref{chow-lemma-gysin-at-infty}.
...
Lemma \ref{chow-lemma-localized-chern-pre}.
The second is Lemma \ref{chow-lemma-loc-chern-agree}.
The base change of $W' \to W$ by $W_\infty \to W$ is the
morphism $E = W'_\infty \to W_\infty$. Hence the third equality holds
by Lemma \ref{chow-lemma-base-change-loc-chern}. The fourth
...
use Lemma \ref{chow-lemma-base-change-loc-chern}.
Since $(i'_\infty)^*$ annihilates cycles supported on $W'_\infty$
(see Remark \ref{chow-remark-gysin-on-cycles}) we conclude the fifth equality
...
\begin{lemma}[Loc chern character]
\label{chow-lemma-loc-chern-character}
\source{stacks:0FBA}
\href{https://stacks.math.columbia.edu/tag/0FBA}{\texttt{Stacks tag 0FBA}}
\group{chow}

\uses{chow-situation-loc-chern, chow-remark-ring-loc-classes}
In Situation \ref{chow-situation-loc-chern} assume $E|_{X \setminus Z}$ is zero.
Then
\begin{align*}
...
of Remark \ref{chow-remark-ring-loc-classes}.
\end{lemma}

\begin{proof}
\uses{chow-lemma-localized-chern-pre-compose, chow-lemma-localized-chern-pre}

The statement makes sense because the zero sheaf has rank $< 1$ and
hence the classes $c_p(Z \to X, E)$ are defined for all $p \geq 1$.
The result itself follows immediately from the more general
Lemma \ref{chow-lemma-localized-chern-pre-compose} as the localized Chern
classes where defined using the procedure of
Lemma \ref{chow-lemma-localized-chern-pre}
in Section \ref{chow-section-localized-chern}.
\end{proof}

\begin{lemma}[Loc chern classes commute]
\label{chow-lemma-loc-chern-classes-commute}
\source{stacks:0FBB}
\href{https://stacks.math.columbia.edu/tag/0FBB}{\texttt{Stacks tag 0FBB}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-homomorphism-commute, chow-lemma-independent-loc-chern, chow-lemma-localized-chern-pre}

This follows from Lemma \ref{chow-lemma-homomorphism-commute}.
More precisely, let
$$
b : W \to \mathbf{P}^1_X
\quad\text{and}\quad
...
$$
be as in the proof of Lemma \ref{chow-lemma-independent-loc-chern}.
By definition $c_p(Z \to X, E) = c'_p(Q)$
as bivariant operations
where the right hand side is the bivariant class constructed in
Lemma \ref{chow-lemma-localized-chern-pre} using $W, b, Q, T'$.
By Lemma \ref{chow-lemma-homomorphism-commute} we have
$P'_p(Q) \circ c = c \circ P'_p(Q)$, resp.\ $c'_p(Q) \circ c = c \circ c'_p(Q)$
in $A^*(Y \times_X Z \to X)$ and we conclude.
\end{proof}

\begin{remark}[Loc chern classes]
\label{chow-remark-loc-chern-classes}
\source{stacks:0FBC}
\href{https://stacks.math.columbia.edu/tag/0FBC}{\texttt{Stacks tag 0FBC}}
\group{chow}

\uses{chow-situation-loc-chern, chow-remark-ring-loc-classes}
In Situation \ref{chow-situation-loc-chern} it is convenient to define
$$
c^{(p)}(Z \to X, E) = 1 + c_1(E) + \ldots + c_{p - 1}(E) +
c_p(Z \to X, E) + c_{p + 1}(Z \to X, E) + \ldots
$$
as an element of the algebra $A^{(p)}(Z \to X)$ considered in
Remark \ref{chow-remark-ring-loc-classes}.
\end{remark}

\begin{lemma}[Additivity loc chern c]
\label{chow-lemma-additivity-loc-chern-c}
\source{stacks:0FBD}
\href{https://stacks.math.columbia.edu/tag/0FBD}{\texttt{Stacks tag 0FBD}}
\group{chow}

\uses{chow-situation-setup, chow-remark-loc-chern-classes}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
...
\end{enumerate}
With notation as in Remark \ref{chow-remark-loc-chern-classes} we have
$$
...
\begin{proof}
\uses{chow-lemma-envelope-bivariant, chow-lemma-base-change-loc-chern, chow-lemma-additivity-on-perfect, chow-lemma-linebundle-formulae, chow-situation-loc-chern, chow-lemma-independent-loc-chern, chow-lemma-localized-chern-pre, chow-lemma-localized-chern-pre-independent, chow-lemma-independent-loc-chern-bQ, chow-lemma-localized-chern-pre-sum-c}
...
uniqueness in Lemma \ref{chow-lemma-envelope-bivariant} it suffices to prove the
...
(Lemma \ref{chow-lemma-base-change-loc-chern}) we may replace $X$ by $Y$
and the distinguished triangle by its pullback.

\medskip\noindent
In the proof of Lemma \ref{chow-lemma-additivity-on-perfect} we have
...
(Lemma \ref{chow-lemma-base-change-loc-chern}) we conclude that
$$
...
Lemma \ref{chow-lemma-linebundle-formulae}) we conclude that
$$
...
are as in Situation \ref{chow-situation-loc-chern}.
For $i = 1, 3$ let
$$
...
$$
where the right hand side is the bivariant class constructed in
Lemma \ref{chow-lemma-localized-chern-pre} using $W_i, b_i, Q_i, T'_i$.
Set $W = W_1 \times_{b_1, \mathbf{P}^1_X, b_2} W_2$ and consider
the cartesian diagram
$$
\begin{array}{cc}W \underset{g_1}{\downarrow}\overset{b}{\searrow}\underset{g_3}{\longrightarrow} & W_3 \overset{b_3}{\downarrow} \\ W_1 \overset{b_1}{\longrightarrow} & \mathbf{P}^1_X\end{array}
$$
...
By Lemma \ref{chow-lemma-localized-chern-pre-independent} we may use
$W$, $b$, $g_i^*\mathcal{Q}_i$, and
$T'$ to construct $c_p(Z \to X, E_i)$ for $i = 1, 3$.
Also, by the stronger independence given in
Lemma \ref{chow-lemma-independent-loc-chern-bQ} we may use
$W$, $b$, $g_1^*Q_1 \oplus g_3^*Q_3$, and $T'$
to compute the classes $c_p(Z \to X, E_2)$.
Thus the desired equality follows from
Lemma \ref{chow-lemma-localized-chern-pre-sum-c}.
\end{proof}

\begin{lemma}[Additivity loc chern P]
\label{chow-lemma-additivity-loc-chern-P}
\source{stacks:0FBE}
\href{https://stacks.math.columbia.edu/tag/0FBE}{\texttt{Stacks tag 0FBE}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-additivity-loc-chern-c, chow-lemma-localized-chern-pre-sum-P, chow-lemma-loc-chern-character}

The proof is exactly the same as the proof of
Lemma \ref{chow-lemma-additivity-loc-chern-c}
except it uses
Lemma \ref{chow-lemma-localized-chern-pre-sum-P}
at the very end. For $p > 0$ we can deduce this lemma
from Lemma \ref{chow-lemma-additivity-loc-chern-c} with $p_1 = p_3 = 1$
and the relationship between $P_p(Z \to X, E)$ and $c_p(Z \to X, E)$ given in
Lemma \ref{chow-lemma-loc-chern-character}. The case $p = 0$ can be shown
directly (it is only interesting if $X$ has a connected component
entirely contained in $Z$).
\end{proof}

\begin{lemma}[Loc chern tensor product]
\label{chow-lemma-loc-chern-tensor-product}
\source{stacks:0FBF}
\href{https://stacks.math.columbia.edu/tag/0FBF}{\texttt{Stacks tag 0FBF}}
\group{chow}

\uses{chow-situation-setup, chow-situation-loc-chern}
In Situation \ref{chow-situation-setup} let $X$ be locally of finite type over $S$.
...
(3) of Situation \ref{chow-situation-loc-chern}. Denote
...
\begin{proof}
\uses{chow-lemma-independent-loc-chern-bQ, chow-lemma-silly-tensor-product, chow-lemma-homomorphism-final}
...
Lemma \ref{chow-lemma-independent-loc-chern-bQ}. Choose a commutative
diagram
$$
\begin{array}{cc}W \overset{g_1}{\downarrow}\overset{b}{\searrow}\underset{g_2}{\longrightarrow} & W_2 \overset{b_2}{\downarrow} \\ W_1 \overset{b_1}{\longrightarrow} & \mathbf{P}^1_X\end{array}
$$
...
By Lemma \ref{chow-lemma-independent-loc-chern-bQ} we may work with
...
\end{enumerate}
\end{enumerate}
By Lemma \ref{chow-lemma-independent-loc-chern-bQ} we have
$$
...
$$
by the same lemma. By Lemma \ref{chow-lemma-silly-tensor-product}
...
Lemma \ref{chow-lemma-homomorphism-final}
...
$$
\begin{array}{cc}X' \longrightarrow\downarrow & W \overset{b}{\downarrow} \\ X \overset{\infty}{\longrightarrow} & \mathbf{P}^1_X\end{array}
$$
...
\begin{lemma}[Pullback virtual normal sheaf]
\label{chow-lemma-pullback-virtual-normal-sheaf}
\source{stacks:0FBJ}
\href{https://stacks.math.columbia.edu/tag/0FBJ}{\texttt{Stacks tag 0FBJ}}
\group{chow}

\uses{chow-situation-setup}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}. Let
$$
\begin{array}{cc}Z' \longrightarrow\underset{g}{\downarrow} & X' \overset{f}{\downarrow} \\ Z \longrightarrow & X\end{array}
$$
...
Section \ref{chow-section-blowup-Z-first}. By
Lemma \ref{chow-lemma-gysin-at-infty}
...
$i : C_ZX \to N$ constructed above. By Lemma \ref{chow-lemma-vectorbundle}
...
\begin{lemma}[Construction gysin]
\label{chow-lemma-construction-gysin}
\source{stacks:0FBK}
\href{https://stacks.math.columbia.edu/tag/0FBK}{\texttt{Stacks tag 0FBK}}
\group{chow}

\uses{chow-remark-completion-bivariant, chow-lemma-pullback-virtual-normal-sheaf}
...
as in Lemma \ref{chow-lemma-pullback-virtual-normal-sheaf}.
If $\mathcal{N}$ has constant rank $r$, then
$c(Z \to X, \mathcal{N}) \in A^r(Z \to X)$.
\end{lemma}

\begin{proof}
\uses{chow-lemma-flat-pullback-bivariant, chow-lemma-push-proper-bivariant, chow-lemma-vectorbundle, chow-lemma-pullback-virtual-normal-sheaf, chow-remark-restriction-bivariant, chow-lemma-gysin-at-infty, chow-lemma-gysin-at-infty-independent, chow-lemma-flat-pullback-proper-pushforward}

Since both $i_* \circ j^* \circ C$ and $p^*$ are bivariant classes
(see Lemmas \ref{chow-lemma-flat-pullback-bivariant} and
\ref{chow-lemma-push-proper-bivariant}) we can use the equation
$$
...
bijective on chow groups by Lemma \ref{chow-lemma-vectorbundle}.

\medskip\noindent
Let $X' \to X$, $Z' \to X'$, and $\mathcal{N}'$ be as in
Lemma \ref{chow-lemma-pullback-virtual-normal-sheaf}. Write
$c = c(Z \to X, \mathcal{N})$ and $c' = c(Z' \to X', \mathcal{N}')$.
The second statement of the lemma means that $c'$ is the restriction of $c$
as in Remark \ref{chow-remark-restriction-bivariant}. Since we claim this
...
$$
\begin{array}{cccc}C_{Z'}X' \downarrow\longrightarrow & W'_\infty \downarrow\longrightarrow & W' \downarrow\longrightarrow & \mathbf{P}^1_{X'} \downarrow \\ C_ZX \longrightarrow & W_\infty \longrightarrow & W \longrightarrow & \mathbf{P}^1_X\end{array}
$$
...
$$
\begin{array}{cc}C_{Z'} X' \downarrow\longrightarrow & N' \downarrow \\ C_ZX \times_Z Z' \longrightarrow & N \times_Z Z'\end{array}
$$
...
\begin{lemma}[Gysin decompose]
\label{chow-lemma-gysin-decompose}
\source{stacks:0FBL}
\href{https://stacks.math.columbia.edu/tag/0FBL}{\texttt{Stacks tag 0FBL}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-easy-virtual-class}
...
immediately from Lemma \ref{chow-lemma-easy-virtual-class}.
\end{proof}

\begin{lemma}[Gysin excess]
\label{chow-lemma-gysin-excess}
\source{stacks:0FV7}
\href{https://stacks.math.columbia.edu/tag/0FV7}{\texttt{Stacks tag 0FV7}}
\group{chow}

\uses{chow-situation-setup}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}. Consider
a cartesian diagram
$$
\begin{array}{cc}Z' \longrightarrow\underset{g}{\downarrow} & X' \overset{f}{\downarrow} \\ Z \longrightarrow & X\end{array}
$$
...
$$
\begin{array}{cc}g^*\mathcal{N}^\vee \longrightarrow\downarrow & (\mathcal{N}')^\vee \downarrow \\ g^*\mathcal{C}_{Z/X} \longrightarrow & \mathcal{C}_{Z'/X'}\end{array}
$$
...
\begin{proof}
\uses{chow-lemma-construction-gysin, chow-lemma-gysin-decompose}

By Lemma \ref{chow-lemma-construction-gysin} we have
$res(c(Z \to X, \mathcal{N})) = c(Z' \to X', g^*\mathcal{N})$
and the equality follows from Lemma \ref{chow-lemma-gysin-decompose}.
\end{proof}
...
\begin{lemma}[Gysin fundamental]
\label{chow-lemma-gysin-fundamental}
\source{stacks:0FBM}
\href{https://stacks.math.columbia.edu/tag/0FBM}{\texttt{Stacks tag 0FBM}}
\group{chow}
...
\begin{proof}
\uses{chow-remark-top-chern-class, chow-lemma-construction-gysin, chow-lemma-gysin-decompose, chow-lemma-gysin-at-infty, chow-lemma-easy-gysin}

The bivariant class $c_{top}(\mathcal{E}) \in A^*(Z \times_X Y)$ was
defined in Remark \ref{chow-remark-top-chern-class}.
By Lemma \ref{chow-lemma-construction-gysin} we may replace $X$ by $Y$.
...
By Lemma \ref{chow-lemma-gysin-decompose} we may even assume
...
the class of Lemma \ref{chow-lemma-gysin-at-infty}.
...
$i_\infty^*[W]_{n + 1} = [W_\infty]_n$, see Lemma \ref{chow-lemma-easy-gysin}.
...
\begin{lemma}[Gysin easy]
\label{chow-lemma-gysin-easy}
\source{stacks:0FEA}
\href{https://stacks.math.columbia.edu/tag/0FEA}{\texttt{Stacks tag 0FEA}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-gysin-fundamental}
...
Lemma \ref{chow-lemma-gysin-fundamental}
because the excess normal sheaf is $0$ over $V$.
\end{proof}

\begin{lemma}[Gysin agrees]
\label{chow-lemma-gysin-agrees}
\source{stacks:0FBN}
\href{https://stacks.math.columbia.edu/tag/0FBN}{\texttt{Stacks tag 0FBN}}
\group{chow}

\uses{chow-situation-setup, chow-definition-gysin-homomorphism, chow-lemma-gysin-bivariant}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}. Let $X$ be a scheme
locally of finite type over $S$. Let $(\mathcal{L}, s, i : D \to X)$
be a triple as in Definition \ref{chow-definition-gysin-homomorphism}.
The Gysin homomorphism $i^*$ viewed as an element of $A^1(D \to X)$
(see Lemma \ref{chow-lemma-gysin-bivariant}) is the same as the bivariant class
...
\begin{proof}
\uses{chow-lemma-bivariant-zero, chow-lemma-gysin-fundamental, chow-definition-gysin-homomorphism}

We will use the criterion of Lemma \ref{chow-lemma-bivariant-zero}.
...
$c_1(\mathcal{N}) \cap [X]_n$. See Lemma \ref{chow-lemma-gysin-fundamental}
and Definition \ref{chow-definition-gysin-homomorphism}.

\medskip\noindent
If $D \not = X$, then $D \to X$ is an effective Cartier divisor
and in particular a regular closed immersion of codimension $1$.
Again by Lemma \ref{chow-lemma-gysin-fundamental} we conclude
$c(D \to X, \mathcal{N}) \cap [X]_n = [D]_{n - 1}$. The same
is true by definition for the Gysin homomorphism and we conclude
once again.
\end{proof}

\begin{lemma}[Gysin commutes]
\label{chow-lemma-gysin-commutes}
\source{stacks:0FBP}
\href{https://stacks.math.columbia.edu/tag/0FBP}{\texttt{Stacks tag 0FBP}}
\group{chow}

\uses{chow-situation-setup, chow-remark-bivariant-commute}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}. Let $X$ be a scheme
locally of finite type over $S$. Let $Z \subset X$ be a closed subscheme
with virtual normal sheaf $\mathcal{N}$. Let $Y \to X$ be locally of
finite type and $c \in A^*(Y \to X)$. Then $c$ and $c(Z \to X, \mathcal{N})$
commute (Remark \ref{chow-remark-bivariant-commute}).
\end{lemma}

\begin{proof}
\uses{chow-lemma-bivariant-zero, chow-lemma-gysin-fundamental, chow-lemma-cap-commutative-chern, chow-lemma-gysin-bivariant, chow-lemma-gysin-decompose, chow-lemma-gysin-agrees}

To check this we may use Lemma \ref{chow-lemma-bivariant-zero}.
...
Lemma \ref{chow-lemma-gysin-fundamental} which commutes
with the bivariant class $c$, see Lemma \ref{chow-lemma-cap-commutative-chern}.

\medskip\noindent
Assume that $Z$ is not equal to $X$. By Lemma \ref{chow-lemma-bivariant-zero}
...
Lemma \ref{chow-lemma-gysin-bivariant}.

\begin{lemma}[Relation normal cones]
\label{chow-lemma-relation-normal-cones}
\source{stacks:0FEB}
\href{https://stacks.math.columbia.edu/tag/0FEB}{\texttt{Stacks tag 0FEB}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-gysin-bivariant, chow-remark-restriction-bivariant, chow-lemma-gysin-commutes-gysin}
...
$i^* \in A^1(\mathbf{P}^1_Y \to W')$ from Lemma \ref{chow-lemma-gysin-bivariant}.
We similarly denote $(i'_\infty)^* \in A^1(W'_\infty \to W')$ the
Gysin map at infinity. Observe that the restriction of $i'_\infty$
(Remark \ref{chow-remark-restriction-bivariant}) to $U$ is the restriction of
...
$$
\begin{array}{ccc}(\mathcal{N}'')^\vee|_Z \longrightarrow\downarrow & \mathcal{N}^\vee \longrightarrow\downarrow & (\mathcal{N}')^\vee \downarrow \\ \mathcal{C}_{Y/X}|_Z \longrightarrow & \mathcal{C}_{Z/X} \longrightarrow & \mathcal{C}_{Z/Y}\end{array}
$$
...
\begin{proof}
\uses{chow-lemma-bivariant-zero, chow-lemma-gysin-decompose, chow-lemma-cap-commutative-chern, chow-lemma-gysin-fundamental, chow-lemma-relation-normal-cones, chow-lemma-relative-effective-cartier}
...
equality of bivariant classes we may use Lemma \ref{chow-lemma-bivariant-zero}.
Thus we may assume $X$ is an integral scheme and we have to show
...
c(Z \to X, \mathcal{N}) \cap [X]
\end{align*}
The first equality by Lemma \ref{chow-lemma-gysin-decompose}.
The second because Chern classes commute with bivariant classes
(Lemma \ref{chow-lemma-cap-commutative-chern}).
The third equality by Lemma \ref{chow-lemma-gysin-decompose}.

\medskip\noindent
Assume $Y \not = X$. By Lemma \ref{chow-lemma-bivariant-zero}
it even suffices to prove the result after blowing up $X$ in a nonzero ideal.
...
By Lemma \ref{chow-lemma-gysin-decompose} we have
$$
...
Lemma \ref{chow-lemma-gysin-fundamental}. Thus we have to prove that
...
$$
\begin{array}{ccc}N' \underset{i}{\longrightarrow} & N \longrightarrow & (C_Y X) \times_Y Z \\ C_Z Y \longrightarrow\uparrow & C_Z X \uparrow & \end{array}
$$
of cones and vector bundles over $Z$. Observe that $N'$ is a relative
effective Cartier divisor in $N$ over $Z$ and that
$$
\begin{array}{cc}N' \downarrow\underset{i}{\longrightarrow} & N \downarrow \\ Z \overset{o}{\longrightarrow} & (C_Y X) \times_Y Z\end{array}
$$
is cartesian where $o$ is the zero section of the line bundle
$C_Y X$ over $Y$. By
Lemma \ref{chow-lemma-relation-normal-cones} we have $o^*[C_ZX]_n = [C_Z Y]_{n - 1}$
in
$$
...
\source{stacks:0FBQ}
\href{https://stacks.math.columbia.edu/tag/0FBQ}{\texttt{Stacks tag 0FBQ}}
\group{chow}
...
\begin{lemma}[Compute koszul]
\label{chow-lemma-compute-koszul}
\source{stacks:0FEE}
\href{https://stacks.math.columbia.edu/tag/0FEE}{\texttt{Stacks tag 0FEE}}
\group{chow}
...
Section \ref{chow-section-splitting-principle}. Observe that
$$
c(\wedge^n \mathcal{E}) =
...
\begin{lemma}[Compute section]
\label{chow-lemma-compute-section}
\source{stacks:0FEF}
\href{https://stacks.math.columbia.edu/tag/0FEF}{\texttt{Stacks tag 0FEF}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-compute-koszul, chow-lemma-chern-classes-dual, chow-lemma-vectorbundle, chow-lemma-restrict-to-open, chow-lemma-top-chern-class}
...
for $t = 1, \ldots, t - 1$ follows from Lemma \ref{chow-lemma-compute-koszul}.
This lemma also gives
$$
c_r(i_*\mathcal{O}_X) = - (r - 1)!
c_r(\pi^*\mathcal{C} \otimes \mathcal{O}_E(-1))
$$
On the other hand, by Lemma \ref{chow-lemma-chern-classes-dual} we have
$$
c_r(\pi^*\mathcal{C} \otimes \mathcal{O}_E(-1)) =
...
for some $\beta \in \CH_*(X)$ (Lemma \ref{chow-lemma-vectorbundle}).
Hence by Lemma \ref{chow-lemma-restrict-to-open}
...
Using the section $s$ and Lemma \ref{chow-lemma-top-chern-class} we find
...
\begin{lemma}[Agreement with loc chern]
\label{chow-lemma-agreement-with-loc-chern}
\source{stacks:0FEG}
\href{https://stacks.math.columbia.edu/tag/0FEG}{\texttt{Stacks tag 0FEG}}
\group{chow}

\uses{chow-situation-setup, chow-definition-localized-chern}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}. Let $i : Z \to X$
...
\begin{proof}
\uses{chow-situation-loc-chern, chow-definition-localized-chern, chow-lemma-independent-loc-chern-bQ, chow-lemma-compute-section, chow-lemma-gysin-at-infty, chow-lemma-localized-chern-pre}
...
Situation \ref{chow-situation-loc-chern} and
Definition \ref{chow-definition-localized-chern}. All in all
we conclude that the statement makes sense.

\medskip\noindent
Denote $b : W \to \mathbf{P}^1_X$ the blowing up in $\infty(Z)$
as in Section \ref{chow-section-blowup-Z-first}. By (\ref{item-find-Z-in-blowup})
...
Lemma \ref{chow-lemma-independent-loc-chern-bQ}.

\medskip\noindent
Assume the claim. The output of Lemma \ref{chow-lemma-independent-loc-chern-bQ}
is that we have
$$
...
by Lemma \ref{chow-lemma-compute-section} applied to $E \to Z$.
...
follows from the corresponding equation in Lemma \ref{chow-lemma-compute-section}.

\medskip\noindent
Proof of the claim. Let $A$ and $f_1, \ldots, f_r$ be as above.
Consider the affine open $\Spec(A[s]) \subset \mathbf{P}^1_X$
as in Section \ref{chow-section-blowup-Z-first}. Recall that $s = 0$
...
other assumptions on $F$ and $Q$ in Lemma \ref{chow-lemma-independent-loc-chern-bQ}
(and Lemma \ref{chow-lemma-localized-chern-pre}) are immediately verified.
\end{proof}

\begin{lemma}[Actual computation]
\label{chow-lemma-actual-computation}
\source{stacks:0FEH}
\href{https://stacks.math.columbia.edu/tag/0FEH}{\texttt{Stacks tag 0FEH}}
\group{chow}

\uses{chow-lemma-agreement-with-loc-chern}
In the situation of Lemma \ref{chow-lemma-agreement-with-loc-chern}
...
\begin{proof}
\uses{chow-lemma-agreement-with-loc-chern, chow-lemma-gysin-fundamental, chow-lemma-loc-chern-character}

Parts (1) and (2) follow immediately from
Lemma \ref{chow-lemma-agreement-with-loc-chern}
combined with Lemma \ref{chow-lemma-gysin-fundamental}.
Then we deduce parts (3) and (4) using the relationship
between $ch_p = (1/p!)P_p$ and $c_p$ given in
Lemma \ref{chow-lemma-loc-chern-character}. (Namely,
...
\begin{lemma}[Second adams operator]
\label{chow-lemma-second-adams-operator}
\source{stacks:0FEJ}
\href{https://stacks.math.columbia.edu/tag/0FEJ}{\texttt{Stacks tag 0FEJ}}
\group{chow}
...
\begin{remark}[Adams derived]
\label{chow-remark-adams-derived}
\source{stacks:0FEK}
\href{https://stacks.math.columbia.edu/tag/0FEK}{\texttt{Stacks tag 0FEK}}
\group{chow}

\uses{chow-lemma-second-adams-operator}
...
argue similarly to the proof of Lemma \ref{chow-lemma-second-adams-operator}
...
\begin{lemma}[Minus adams operator]
\label{chow-lemma-minus-adams-operator}
\source{stacks:0FV8}
\href{https://stacks.math.columbia.edu/tag/0FV8}{\texttt{Stacks tag 0FV8}}
\group{chow}
...
\begin{remark}[Chern classes K]
\label{chow-remark-chern-classes-K}
\source{stacks:0FEL}
\href{https://stacks.math.columbia.edu/tag/0FEL}{\texttt{Stacks tag 0FEL}}
\group{chow}

\uses{chow-situation-setup, chow-lemma-additivity-chern-classes}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
...
\begin{remark}[Chern character K]
\label{chow-remark-chern-character-K}
\source{stacks:0FEM}
\href{https://stacks.math.columbia.edu/tag/0FEM}{\texttt{Stacks tag 0FEM}}
\group{chow}

\uses{chow-situation-setup, chow-lemma-chern-character-additive, chow-lemma-chern-character-multiplicative}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
...
by Lemma \ref{chow-lemma-chern-character-additive} and a ring homomorphism by
Lemma \ref{chow-lemma-chern-character-multiplicative}.
\end{remark}

\begin{lemma}[Adams and chern]
\label{chow-lemma-adams-and-chern}
\source{stacks:0FEN}
\href{https://stacks.math.columbia.edu/tag/0FEN}{\texttt{Stacks tag 0FEN}}
\group{chow}

\uses{chow-situation-setup, chow-lemma-second-adams-operator, chow-remark-chern-classes-K, chow-remark-chern-character-K}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
Let $X$ be locally of finite type over $S$. If $\psi^2$ is
as in Lemma \ref{chow-lemma-second-adams-operator} and $c$ and $ch$ are as in
Remarks \ref{chow-remark-chern-classes-K} and \ref{chow-remark-chern-character-K}
...
\begin{proof}
\uses{chow-remark-extend-to-finite-locally-free, chow-lemma-splitting-principle}
...
Lemma \ref{chow-lemma-splitting-principle}. Then
...
\begin{remark}[Perf Z cohomology K]
\label{chow-remark-perf-Z-cohomology-K}
\source{stacks:0FEP}
\href{https://stacks.math.columbia.edu/tag/0FEP}{\texttt{Stacks tag 0FEP}}
\group{chow}

\uses{chow-lemma-K-coherent-supported-on-closed}
...
$$
(equality by Lemma \ref{chow-lemma-K-coherent-supported-on-closed}) by the rule
$$
E \longmapsto
...
\begin{remark}[Perf Z regular]
\label{chow-remark-perf-Z-regular}
\source{stacks:0FEQ}
\href{https://stacks.math.columbia.edu/tag/0FEQ}{\texttt{Stacks tag 0FEQ}}
\group{chow}

\uses{chow-remark-perf-Z-cohomology-K}
Let $X$, $Z$, $D_{Z, perf}(\mathcal{O}_X)$ be as in
Remark \ref{chow-remark-perf-Z-cohomology-K}. Assume $X$ is regular.
...
\begin{lemma}[Perf Z regular]
\label{chow-lemma-perf-Z-regular}
\source{stacks:0FER}
\href{https://stacks.math.columbia.edu/tag/0FER}{\texttt{Stacks tag 0FER}}
\group{chow}

\uses{chow-remark-perf-Z-cohomology-K, chow-remark-perf-Z-regular}
Let $X$ be a Noetherian regular scheme.
Let $Z \subset X$ be a closed subscheme. The maps constructed
in Remarks \ref{chow-remark-perf-Z-cohomology-K} and
\ref{chow-remark-perf-Z-regular} are mutually inverse and we get
...
\begin{remark}[Localized chern classes K]
\label{chow-remark-localized-chern-classes-K}
\source{stacks:0FES}
\href{https://stacks.math.columbia.edu/tag/0FES}{\texttt{Stacks tag 0FES}}
\group{chow}

\uses{chow-situation-setup, chow-remark-perf-Z-cohomology-K, chow-remark-ring-loc-classes, chow-situation-loc-chern, chow-definition-localized-chern, chow-lemma-additivity-loc-chern-c}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
Let $X$ be locally of finite type over $S$.
Let $Z \subset X$ be a closed subscheme and let
$D_{Z, perf}(\mathcal{O}_X)$ be as in
Remark \ref{chow-remark-perf-Z-cohomology-K}.
...
side as in Remark \ref{chow-remark-ring-loc-classes}).
The quasi-compactness condition on $X$ guarantees that the
localized chern classes are defined (Situation \ref{chow-situation-loc-chern} and
Definition \ref{chow-definition-localized-chern})
...
\begin{remark}[Localized chern character K]
\label{chow-remark-localized-chern-character-K}
\source{stacks:0FET}
\href{https://stacks.math.columbia.edu/tag/0FET}{\texttt{Stacks tag 0FET}}
\group{chow}

\uses{chow-situation-setup, chow-remark-perf-Z-cohomology-K, chow-situation-loc-chern, chow-definition-localized-chern, chow-lemma-additivity-loc-chern-P, chow-lemma-loc-chern-tensor-product}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
Let $X$ be locally of finite type over $S$.
Let $Z \subset X$ be a closed subscheme and let
$D_{Z, perf}(\mathcal{O}_X)$ be as in
...
localized chern character is defined (Situation \ref{chow-situation-loc-chern} and
Definition \ref{chow-definition-localized-chern})
...
(Lemma \ref{chow-lemma-additivity-loc-chern-P}).
...
Lemma \ref{chow-lemma-loc-chern-tensor-product}.
If $X$ is quasi-compact, then the map $ch(Z \to X, -)$ has
image contained in $A^*(Z \to X) \otimes \mathbf{Q}$; we omit
the details.
\end{remark}

\begin{remark}[Chern classes agree]
\label{chow-remark-chern-classes-agree}
\source{stacks:0FEU}
\href{https://stacks.math.columbia.edu/tag/0FEU}{\texttt{Stacks tag 0FEU}}
\group{chow}

\uses{chow-situation-setup, chow-remark-localized-chern-classes-K, chow-remark-localized-chern-character-K, chow-definition-defined-on-perfect, chow-lemma-additivity-on-perfect, chow-lemma-chern-classes-perfect-tensor-product, chow-remark-chern-classes-K, chow-remark-chern-character-K}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
...
Remarks \ref{chow-remark-localized-chern-classes-K} and
...
$$
as a special case of Remarks \ref{chow-remark-localized-chern-classes-K} and
\ref{chow-remark-localized-chern-character-K}. Of course, instead we could
have just directly used Definition \ref{chow-definition-defined-on-perfect} and
Lemmas \ref{chow-lemma-additivity-on-perfect} and
\ref{chow-lemma-chern-classes-perfect-tensor-product} to construct these maps
...
Then the diagram
$$
\begin{array}{ccc}K_0((\textit{Vect}(X)) \underset{c}{\searrow}\longrightarrow &  & K_0(D_{perf}(\mathcal{O}_X)) = K_0(X) \overset{c}{\swarrow} \\  & \prod A^i(X) & \end{array}
$$
commutes where the south-east arrow is the one constructed in
Remark \ref{chow-remark-chern-classes-K}. Similarly, the diagram
$$
\begin{array}{ccc}K_0((\textit{Vect}(X)) \underset{ch}{\searrow}\longrightarrow &  & K_0(D_{perf}(\mathcal{O}_X)) = K_0(X) \overset{ch}{\swarrow} \\  & \prod A^i(X) \otimes \mathbf{Q} & \end{array}
$$
commutes where the south-east arrow is the one constructed in
Remark \ref{chow-remark-chern-character-K}.
\end{remark}

\section{Chow groups and K-groups revisited}
\label{chow-section-chow-and-K-II}
This section is the continuation of Section \ref{chow-section-chow-and-K}.
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
...
The discussion in Remark \ref{chow-remark-good-cases-K-A} shows
...
\begin{proposition}[K tensor Q]
\label{chow-proposition-K-tensor-Q}
\source{stacks:0FEW}
\href{https://stacks.math.columbia.edu/tag/0FEW}{\texttt{Stacks tag 0FEW}}
\group{chow}

\uses{chow-situation-setup, chow-remark-perf-Z-regular, chow-remark-localized-chern-character-K}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}. Assume given a
...
Remark \ref{chow-remark-perf-Z-regular}, the map $ch(X \to Y, -)$ from
Remark \ref{chow-remark-localized-chern-character-K}, and
...
\begin{proof}
\uses{chow-remark-perf-Z-regular, chow-remark-localized-chern-character-K, chow-lemma-locally-equidimensional, chow-remark-fundamental-class, chow-lemma-loc-chern-shrink-Z, chow-lemma-actual-computation}

Since $Y$ is regular, the construction in
Remark \ref{chow-remark-perf-Z-regular} applies.
Since $Y$ is quasi-compact, the construction in
Remark \ref{chow-remark-localized-chern-character-K} applies.
We have that $Y$ is locally equidimensional
(Lemma \ref{chow-lemma-locally-equidimensional}) and
thus the ``fundamental cycle'' $[Y]$ is defined
as an element of $\CH_*(Y)$, see Remark \ref{chow-remark-fundamental-class}.
...
$$
by Lemma \ref{chow-lemma-loc-chern-shrink-Z}. We conclude that in this
...
Thus we deduce the result from Lemma \ref{chow-lemma-actual-computation}.
\end{proof}
...
\begin{lemma}[K tensor Q]
\label{chow-lemma-K-tensor-Q}
\source{stacks:0FEY}
\href{https://stacks.math.columbia.edu/tag/0FEY}{\texttt{Stacks tag 0FEY}}
\group{chow}

\uses{chow-situation-setup, chow-remark-chern-character-K}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
...
\CH_*(X) \otimes \mathbf{Q}
$$
of the map $ch$ from Remark \ref{chow-remark-chern-character-K} and
the map $c \mapsto c \cap [X]$ is an isomorphism.
\end{lemma}

\begin{proof}
\uses{chow-remark-chern-classes-agree, chow-proposition-K-tensor-Q}
...
By Remark \ref{chow-remark-chern-classes-agree}
the composition given agrees with the map of
Proposition \ref{chow-proposition-K-tensor-Q} for $X = Y$.
Thus the result follows from the proposition.
\end{proof}

Let $X, S, \delta$ be as in Lemma \ref{chow-lemma-K-tensor-Q}.
...
Remark \ref{chow-remark-fundamental-class}.
...
By Lemma \ref{chow-lemma-adams-and-chern} we see that
...
The construction in Section \ref{chow-section-gysin-higher-codimension}
...
\begin{lemma}[Composition regular immersion]
\label{chow-lemma-composition-regular-immersion}
\source{stacks:0FF0}
\href{https://stacks.math.columbia.edu/tag/0FF0}{\texttt{Stacks tag 0FF0}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-gysin-composition}
...
\mathcal{C}_{X/Y} \to 0
$$
Thus the result by the more general Lemma \ref{chow-lemma-gysin-composition}.
\end{proof}

\begin{lemma}[Section smooth]
\label{chow-lemma-section-smooth}
\source{stacks:0FF1}
\href{https://stacks.math.columbia.edu/tag/0FF1}{\texttt{Stacks tag 0FF1}}
\group{chow}

\uses{chow-situation-setup, chow-lemma-flat-pullback-bivariant}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
...
of Lemma \ref{chow-lemma-flat-pullback-bivariant}.
\end{lemma}
...
We conclude by Lemma \ref{chow-lemma-gysin-fundamental}.
\end{proof}

Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}. Consider a
commutative diagram
$$
\begin{array}{ccc}X \underset{f}{\searrow}\underset{i}{\longrightarrow} &  & P \overset{g}{\swarrow} \\  & Y & \end{array}
$$
...
of Lemma \ref{chow-lemma-flat-pullback-bivariant} we obtain
$$
...
\begin{lemma}[Lci gysin well defined]
\label{chow-lemma-lci-gysin-well-defined}
\source{stacks:0FF2}
\href{https://stacks.math.columbia.edu/tag/0FF2}{\texttt{Stacks tag 0FF2}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-compose-flat-pullback, chow-lemma-composition-regular-immersion, chow-remark-restriction-bivariant, chow-lemma-construction-gysin, chow-lemma-section-smooth}
...
$$
\begin{array}{ccc} & P' \overset{p}{\downarrow}\overset{g'}{\searrow} &  \\ X \overset{i}{\longrightarrow}\overset{i'}{\nearrow} & P \overset{g}{\longrightarrow} & Y\end{array}
$$
where $p$ is a smooth morphism. Then $(g')^* = p^* \circ g^*$
(Lemma \ref{chow-lemma-compose-flat-pullback}) and hence it suffices
to show that $i^! = (i')^! \circ p^*$
in $A^*(X \to P)$. Consider the commutative diagram
$$
\begin{array}{ccc} & X \times_P P' \overset{\overline{p}}{\downarrow}\underset{j}{\longrightarrow} & P' \overset{p}{\downarrow} \\ X \overset{s}{\nearrow}\overset{1}{\longrightarrow} & X \overset{i}{\longrightarrow} & P\end{array}
$$
...
and $i' = j \circ s$. By Lemma \ref{chow-lemma-composition-regular-immersion}
we have $(i')^! = s^! \circ j^!$.
Since the square is cartesian, the bivariant class $j^!$
is the restriction (Remark \ref{chow-remark-restriction-bivariant})
of $i^!$ to $P'$, see Lemma \ref{chow-lemma-construction-gysin}.
...
which is done in Lemma \ref{chow-lemma-section-smooth}.
\end{proof}

\begin{definition}[Lci gysin]
\label{chow-definition-lci-gysin}
\source{stacks:0FF3}
\href{https://stacks.math.columbia.edu/tag/0FF3}{\texttt{Stacks tag 0FF3}}
\group{chow}
...
\begin{lemma}[Lci gysin flat]
\label{chow-lemma-lci-gysin-flat}
\source{stacks:0FF4}
\href{https://stacks.math.columbia.edu/tag/0FF4}{\texttt{Stacks tag 0FF4}}
\group{chow}
...
bivariant class of Lemma \ref{chow-lemma-flat-pullback-bivariant}.
\end{lemma}

\begin{proof}
\uses{chow-lemma-bivariant-zero, chow-lemma-gysin-fundamental}
...
is integral, see Lemma \ref{chow-lemma-bivariant-zero}. Set $n = \dim_\delta(Y)$.
...
Thus $i^![P]_{n + t} = [X]_{n + s}$ (Lemma \ref{chow-lemma-gysin-fundamental})
and the proof is complete.
\end{proof}

\begin{lemma}[Lci gysin composition]
\label{chow-lemma-lci-gysin-composition}
\source{stacks:0FF5}
\href{https://stacks.math.columbia.edu/tag/0FF5}{\texttt{Stacks tag 0FF5}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-composition-regular-immersion, chow-lemma-compose-flat-pullback}
...
Consider the commutative diagram
$$
\begin{array}{ccc}X \longrightarrow\downarrow & P \times_Z Y \underset{a}{\longrightarrow}\overset{p}{\swarrow} & P \times_Z P' \overset{q}{\swarrow} \\ Y \underset{b}{\longrightarrow}\downarrow & P' \swarrow &  \\ Z &  & \end{array}
$$
...
Lemmas \ref{chow-lemma-composition-regular-immersion} and
\ref{chow-lemma-compose-flat-pullback}
the reader finds the statement of the lemma holds true.
Small detail omitted.
\end{proof}

\begin{lemma}[Lci gysin commutes]
\label{chow-lemma-lci-gysin-commutes}
\source{stacks:0FF6}
\href{https://stacks.math.columbia.edu/tag/0FF6}{\texttt{Stacks tag 0FF6}}
\group{chow}

\uses{chow-situation-setup, chow-remark-restriction-bivariant, chow-remark-bivariant-commute}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
Consider a commutative diagram
$$
\begin{array}{ccc}X'' \downarrow\longrightarrow & X' \downarrow\longrightarrow & X \overset{f}{\downarrow} \\ Y'' \longrightarrow & Y' \longrightarrow & Y\end{array}
$$
...
(Remark \ref{chow-remark-restriction-bivariant}). Then $c$ and $res(f^!)$ commute
(Remark \ref{chow-remark-bivariant-commute}).
\end{lemma}

\begin{proof}
\uses{chow-lemma-gysin-commutes}
...
immediately from Lemma \ref{chow-lemma-gysin-commutes}.
\end{proof}

\begin{lemma}[Lci gysin easy]
\label{chow-lemma-lci-gysin-easy}
\source{stacks:0FF7}
\href{https://stacks.math.columbia.edu/tag/0FF7}{\texttt{Stacks tag 0FF7}}
\group{chow}

\uses{chow-situation-setup, chow-lemma-locally-equidimensional, chow-remark-fundamental-class}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
Consider a cartesian diagram
$$
\begin{array}{cc}X' \underset{f'}{\downarrow}\longrightarrow & X \overset{f}{\downarrow} \\ Y' \longrightarrow & Y\end{array}
$$
...
Lemma \ref{chow-lemma-locally-equidimensional},
...
Lemma \ref{chow-lemma-gysin-easy}.
\end{proof}

\begin{remark}[Gysin chern classes]
\label{chow-remark-gysin-chern-classes}
\source{stacks:0FF8}
\href{https://stacks.math.columbia.edu/tag/0FF8}{\texttt{Stacks tag 0FF8}}
\group{chow}

\uses{chow-situation-setup, chow-lemma-lci-gysin-commutes, chow-lemma-locally-equidimensional, chow-lemma-lci-gysin-easy}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
Let $f : X \to Y$ be a local complete intersection morphism
of schemes locally of finite type over $S$. Assume the Gysin
...
Lemma \ref{chow-lemma-lci-gysin-commutes}.
If $X$ and $Y$ satisfy the equivalent conditions of
Lemma \ref{chow-lemma-locally-equidimensional} and $Y$ is Cohen-Macaulay
(for example), then $f^![Y] = [X]$ by Lemma \ref{chow-lemma-lci-gysin-easy}.
In this case we also get
$f^!(c_i(\mathcal{E}) \cap [Y]) = c_i(f^*\mathcal{E}) \cap [X]$
and similarly for the Chern character.
\end{remark}

\begin{lemma}[Compare gysin base change]
\label{chow-lemma-compare-gysin-base-change}
\source{stacks:0FV9}
\href{https://stacks.math.columbia.edu/tag/0FV9}{\texttt{Stacks tag 0FV9}}
\group{chow}
...
$$
\begin{array}{ccc}X' \longrightarrow\downarrow & P' \longrightarrow\downarrow & Y' \downarrow \\ X \overset{i}{\longrightarrow} & P \overset{h}{\longrightarrow} & Y\end{array}
$$
...
$$
in $A^*(X' \to P')$ by an application of Lemma \ref{chow-lemma-gysin-excess}.
...
\source{stacks:0FVA}
\href{https://stacks.math.columbia.edu/tag/0FVA}{\texttt{Stacks tag 0FVA}}
\group{chow}
...
$$
\begin{array}{cc}E \underset{j}{\longrightarrow}\underset{\pi}{\downarrow} & X' \overset{b}{\downarrow} \\ Z \overset{i}{\longrightarrow} & X\end{array}
$$
...
\begin{proof}
\uses{chow-lemma-compare-gysin-base-change, chow-lemma-lci-gysin-flat}
...
morphism. Thus Lemma \ref{chow-lemma-compare-gysin-base-change}
applies and we see that
$$
res(b^!) = c_{top}(\mathcal{C}^\vee) \circ \pi^!
$$
with $\mathcal{C}$ as in the statement there.
Of course $\pi^* = \pi^!$ by Lemma \ref{chow-lemma-lci-gysin-flat}.
...
\begin{lemma}[Lci gysin product regular]
\label{chow-lemma-lci-gysin-product-regular}
\source{stacks:0FF9}
\href{https://stacks.math.columbia.edu/tag/0FF9}{\texttt{Stacks tag 0FF9}}
\group{chow}
...
is as in Section \ref{chow-section-intersection-regular}.
\end{lemma}

\begin{proof}
\uses{chow-lemma-lci-gysin-easy, chow-lemma-lci-gysin-commutes}

The first statement follows from
More on Morphisms, Lemma
\ref{more-morphisms-lemma-morphism-regular-schemes-is-lci}.
Observe that $f^![Y] = [X]$, see Lemma \ref{chow-lemma-lci-gysin-easy}.
Write $\alpha = ch(\alpha') \cap [Y]$ and $\beta = ch(\beta') \cap [Y]$
where $\alpha', \beta' \in K_0(\textit{Vect}(X)) \otimes \mathbf{Q}$
as in Section \ref{chow-section-intersection-regular}.
Setting $c = ch(\alpha')$ and $c' = ch(\beta')$ we find
$\alpha \cdot \beta = c \cap c' \cap [Y]$ by construction.
By Lemma \ref{chow-lemma-lci-gysin-commutes} we know that $f^!$
...
\begin{lemma}[Projection formula regular]
\label{chow-lemma-projection-formula-regular}
\source{stacks:0FFA}
\href{https://stacks.math.columbia.edu/tag/0FFA}{\texttt{Stacks tag 0FFA}}
\group{chow}
...
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}. Let $f : X \to Y$
...
$$
constructed in Section \ref{chow-section-koszul}. If $X \to Y$ has constant
relative dimension $d$, then $\Delta^! \in A^d(X \to X \times_Y X)$.

\begin{lemma}[Diagonal identity]
\label{chow-lemma-diagonal-identity}
\source{stacks:0FBS}
\href{https://stacks.math.columbia.edu/tag/0FBS}{\texttt{Stacks tag 0FBS}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-lci-gysin-composition}
...
Lemma \ref{chow-lemma-lci-gysin-composition}.
\end{proof}

\begin{proposition}[Compute bivariant]
\label{chow-proposition-compute-bivariant}
\source{stacks:0FBT}
\href{https://stacks.math.columbia.edu/tag/0FBT}{\texttt{Stacks tag 0FBT}}
\group{chow}
...
\begin{proof}
\uses{chow-remark-restriction-bivariant, chow-lemma-lci-gysin-commutes, chow-lemma-diagonal-identity}

We will use that smooth morphisms are local complete intersection
morphisms whose Gysin maps exist (see Section \ref{chow-section-koszul}).
...
(Remark \ref{chow-remark-restriction-bivariant}) of $c'$ by the morphism $Y \to Z$.
Since the diagram
$$
\begin{array}{cc}X \times_Z Y \underset{\text{pr}_2}{\longrightarrow}\underset{\text{pr}_1}{\downarrow} & Y \overset{g}{\downarrow} \\ X \overset{f}{\longrightarrow} & Z\end{array}
$$
...
Since the diagram
$$
\begin{array}{cc}X \longrightarrow\downarrow & X \times_Z Y \downarrow \\ Y \overset{\Delta}{\longrightarrow} & Y \times_Z Y\end{array}
$$
...
$$
\begin{array}{ccc}X \downarrow\longrightarrow & Y \downarrow &  \\ X \times_Z Y \longrightarrow\overset{\text{pr}_1}{\downarrow} & Y \times_Z Y \underset{p_2}{\longrightarrow}\overset{p_1}{\downarrow} & Y \overset{g}{\downarrow} \\ X \overset{f}{\longrightarrow} & Y \overset{g}{\longrightarrow} & Z\end{array}
$$
...
square of the diagram and using Lemma \ref{chow-lemma-lci-gysin-commutes}
...
c
\end{align*}
The final equality by Lemma \ref{chow-lemma-diagonal-identity}.
...
Example \ref{chow-example-field}.

\medskip\noindent
Consider a cartesian square
$$
\begin{array}{cc}X \times_k Y \longrightarrow\downarrow & Y \downarrow \\ X \longrightarrow & \Spec(k) = S\end{array}
$$
...
\begin{lemma}[Exterior product well defined]
\label{chow-lemma-exterior-product-well-defined}
\source{stacks:0FBV}
\href{https://stacks.math.columbia.edu/tag/0FBV}{\texttt{Stacks tag 0FBV}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-flat-pullback-bivariant, chow-lemma-push-proper-bivariant}
...
Lemma \ref{chow-lemma-flat-pullback-bivariant}
...
\begin{lemma}[Chow cohomology towards point]
\label{chow-lemma-chow-cohomology-towards-point}
\source{stacks:0FBW}
\href{https://stacks.math.columbia.edu/tag/0FBW}{\texttt{Stacks tag 0FBW}}
\group{chow}
...
\begin{proof}
\uses{chow-definition-cycles, chow-lemma-flat-pullback-bivariant, chow-lemma-push-proper-bivariant, chow-lemma-bivariant-zero}
...
Definition \ref{chow-definition-cycles}. Consider the composition
$$
...
g_* \circ \nu \circ f^*
$$
by Lemma \ref{chow-lemma-push-proper-bivariant}. The reader easily
...
see Lemma \ref{chow-lemma-bivariant-zero}. However, then $p' : X' \to \Spec(k)$
...
\begin{lemma}[Chow cohomology towards point commutes]
\label{chow-lemma-chow-cohomology-towards-point-commutes}
\source{stacks:0FBX}
\href{https://stacks.math.columbia.edu/tag/0FBX}{\texttt{Stacks tag 0FBX}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-chow-cohomology-towards-point}

In the proof of Lemma \ref{chow-lemma-chow-cohomology-towards-point}
...
\begin{remark}[Commuting exterior]
\label{chow-remark-commuting-exterior}
\source{stacks:0FBY}
\href{https://stacks.math.columbia.edu/tag/0FBY}{\texttt{Stacks tag 0FBY}}
\group{chow}

\uses{chow-lemma-chow-cohomology-towards-point, chow-lemma-chow-cohomology-towards-point-commutes}
The upshot of Lemmas \ref{chow-lemma-chow-cohomology-towards-point}
and \ref{chow-lemma-chow-cohomology-towards-point-commutes} is the following.
Let $k$ be a field. Let $X$ be a scheme locally of finite type over $k$.
...
Lemma \ref{chow-lemma-chow-cohomology-towards-point}.
\end{remark}

\begin{lemma}[Exterior product associative]
\label{chow-lemma-exterior-product-associative}
\source{stacks:0FBZ}
\href{https://stacks.math.columbia.edu/tag/0FBZ}{\texttt{Stacks tag 0FBZ}}
\group{chow}
...
of Section \ref{chow-section-gysin-for-diagonal} allows us to define a kind of
...
Section \ref{chow-section-exterior-product} and the second arrow
is the Gysin map for the diagonal studied in
Section \ref{chow-section-gysin-for-diagonal}. If $X$ is equidimensional
...
\begin{lemma}[Associative]
\label{chow-lemma-associative}
\source{stacks:0FC1}
\href{https://stacks.math.columbia.edu/tag/0FC1}{\texttt{Stacks tag 0FC1}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-exterior-product-associative, chow-remark-restriction-bivariant, chow-lemma-gysin-commutes, chow-remark-commuting-exterior}

By Lemma \ref{chow-lemma-exterior-product-associative} we have
...
(Remark \ref{chow-remark-restriction-bivariant}) of $\Delta^!$
...
$\Delta^!$ too. Thus by Lemma \ref{chow-lemma-gysin-commutes} we have
$$
...
Remark \ref{chow-remark-commuting-exterior}. Similarly for the second
equation.
\end{proof}

\begin{lemma}[Identify chow for smooth]
\label{chow-lemma-identify-chow-for-smooth}
\source{stacks:0FC2}
\href{https://stacks.math.columbia.edu/tag/0FC2}{\texttt{Stacks tag 0FC2}}
\group{chow}
...
\begin{proof}
\uses{chow-proposition-compute-bivariant, chow-lemma-chow-cohomology-towards-point}
...
Lemma \ref{chow-lemma-chow-cohomology-towards-point}.
From the proof of Lemma \ref{chow-lemma-chow-cohomology-towards-point}
...
Proposition \ref{chow-proposition-compute-bivariant} we see the inverse
...
\begin{lemma}[Lci gysin product]
\label{chow-lemma-lci-gysin-product}
\source{stacks:0FFB}
\href{https://stacks.math.columbia.edu/tag/0FFB}{\texttt{Stacks tag 0FFB}}
\group{chow}
...
\begin{proof}
\uses{chow-definition-lci-gysin, chow-lemma-lci-gysin-easy, chow-lemma-identify-chow-for-smooth, chow-lemma-lci-gysin-commutes, chow-lemma-lci-gysin-composition}

Observe that $X \to X \times_k Y$ is an immersion of $X$ into a scheme
smooth over $Y$. Hence the Gysin map exists for $f$
(Definition \ref{chow-definition-lci-gysin}).
...
$f^![Y]_e = [X]_d$ (see for example Lemma \ref{chow-lemma-lci-gysin-easy}).
Write $\alpha = c \cap [Y]_e$ and $\beta = c' \cap [Y]_e$
and hence $\alpha \cdot \beta = c \cap c' \cap [Y]_e$,
see Lemma \ref{chow-lemma-identify-chow-for-smooth}.
By Lemma \ref{chow-lemma-lci-gysin-commutes} we know that $f^!$
commutes with both $c$ and $c'$. Hence
\begin{align*}
f^!(\alpha \cdot \beta)
...
f^!(\alpha) \cdot f^!(\beta)
\end{align*}
as desired where we have used Lemma \ref{chow-lemma-identify-chow-for-smooth}
for $X$ as well.

\medskip\noindent
An alternative proof can be given by proving that
$(f \times f)^!(\alpha \times \beta) = f^!\alpha \times f^!\beta$
and using Lemma \ref{chow-lemma-lci-gysin-composition}.
\end{proof}

\begin{lemma}[Projection formula]
\label{chow-lemma-projection-formula}
\source{stacks:0FFC}
\href{https://stacks.math.columbia.edu/tag/0FFC}{\texttt{Stacks tag 0FFC}}
\group{chow}
...
\begin{proof}
\uses{chow-definition-lci-gysin, chow-lemma-lci-gysin-easy, chow-lemma-identify-chow-for-smooth, chow-lemma-lci-gysin-commutes}
...
see Lemma \ref{chow-lemma-identify-chow-for-smooth}. We have
\begin{align*}
f_*(\alpha \cdot f^!\beta)
& =
f_*(c \cap f^!(c' \cap [Y]_e)) \\
...
\beta \cdot f_*(\alpha)
\end{align*}
The first equality by the result of Lemma \ref{chow-lemma-identify-chow-for-smooth}
for $X$. By Lemma \ref{chow-lemma-lci-gysin-commutes} we know that $f^!$
...
\begin{lemma}[Intersect properly]
\label{chow-lemma-intersect-properly}
\source{stacks:0FFD}
\href{https://stacks.math.columbia.edu/tag/0FFD}{\texttt{Stacks tag 0FFD}}
\group{chow}
...
(Section \ref{chow-section-gysin-higher-codimension}) with
...
(1), (2), and (3) of Lemma \ref{chow-lemma-gysin-easy} hold.
...
Lemma \ref{chow-lemma-gysin-easy} are satisfied and we conclude.
\end{proof}

\begin{lemma}[Intersect regularly embedded]
\label{chow-lemma-intersect-regularly-embedded}
\source{stacks:0FFE}
\href{https://stacks.math.columbia.edu/tag/0FFE}{\texttt{Stacks tag 0FFE}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-identify-chow-for-smooth, chow-lemma-lci-gysin-commutes, chow-lemma-lci-gysin-easy}
...
with $x \in A^*(X)$, see Lemma \ref{chow-lemma-identify-chow-for-smooth}. Then
$$
...
Lemma \ref{chow-lemma-lci-gysin-commutes}. The third because
$i^![X]_d = [Y]_e$ in $\CH_*(Y)$ (Lemma \ref{chow-lemma-lci-gysin-easy}).
The fourth because bivariant classes commute with proper pushforward.
The last equality by Lemma \ref{chow-lemma-identify-chow-for-smooth}.
\end{proof}

\begin{lemma}[Intersection regular smooth]
\label{chow-lemma-intersection-regular-smooth}
\source{stacks:0FFF}
\href{https://stacks.math.columbia.edu/tag/0FFF}{\texttt{Stacks tag 0FFF}}
\group{chow}
...
constructed in Section \ref{chow-section-intersection-regular}.
\end{lemma}

\begin{proof}
\uses{chow-lemma-identify-chow-for-smooth}
...
Then the intersection product in Section \ref{chow-section-intersection-regular}
produces $c \cap c' \cap [X]$. This is the same as $\alpha \cdot \beta$
by Lemma \ref{chow-lemma-identify-chow-for-smooth} (or rather the
...
general Situation \ref{chow-situation-setup}; see
Example \ref{chow-example-domain-dimension-1}.
...
Consider a cartesian square
$$
\begin{array}{cc}X \times_S Y \longrightarrow\downarrow & Y \downarrow \\ X \longrightarrow & S\end{array}
$$
...
\begin{lemma}[Exterior product well defined dim 1]
\label{chow-lemma-exterior-product-well-defined-dim-1}
\source{stacks:0FC4}
\href{https://stacks.math.columbia.edu/tag/0FC4}{\texttt{Stacks tag 0FC4}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-flat-pullback-bivariant, chow-lemma-push-proper-bivariant, chow-lemma-gysin-bivariant}
...
Lemma \ref{chow-lemma-gysin-bivariant}. The morphism $p' : X' \to s$
...
$$
by Lemma \ref{chow-lemma-push-proper-bivariant}. This produces maps
$$
c' \cap - : \CH_m(Y) \longrightarrow \CH_{m + n - 1}(X \times_S Y)
$$
...
\begin{lemma}[Chow cohomology towards base dim 1]
\label{chow-lemma-chow-cohomology-towards-base-dim-1}
\source{stacks:0FC5}
\href{https://stacks.math.columbia.edu/tag/0FC5}{\texttt{Stacks tag 0FC5}}
\group{chow}
...
\begin{proof}
\uses{chow-definition-cycles, chow-lemma-push-proper-bivariant, chow-lemma-exterior-product-well-defined-dim-1, chow-lemma-bivariant-zero}
...
Definition \ref{chow-definition-cycles}. In particular the morphism
$$
...
Lemma \ref{chow-lemma-exterior-product-well-defined-dim-1})
...
see Lemma \ref{chow-lemma-bivariant-zero}. However, either $p' : X' \to S$
...
\begin{lemma}[Chow cohomology towards base dim 1 commutes]
\label{chow-lemma-chow-cohomology-towards-base-dim-1-commutes}
\source{stacks:0FC6}
\href{https://stacks.math.columbia.edu/tag/0FC6}{\texttt{Stacks tag 0FC6}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-chow-cohomology-towards-base-dim-1}

In the proof of Lemma \ref{chow-lemma-chow-cohomology-towards-base-dim-1}
we have seen that $c$ is given by a combination of
proper pushforward, multiplying by integers over connected
...
\begin{remark}[Commuting exterior dim 1]
\label{chow-remark-commuting-exterior-dim-1}
\source{stacks:0FC7}
\href{https://stacks.math.columbia.edu/tag/0FC7}{\texttt{Stacks tag 0FC7}}
\group{chow}

\uses{chow-lemma-chow-cohomology-towards-base-dim-1, chow-lemma-chow-cohomology-towards-base-dim-1-commutes}
The upshot of Lemmas \ref{chow-lemma-chow-cohomology-towards-base-dim-1}
and \ref{chow-lemma-chow-cohomology-towards-base-dim-1-commutes} is the following.
Let $(S, \delta)$ be as above. Let $X$ be a scheme locally of finite type
over $S$.
Let $\alpha \in \CH_*(X)$. Let $Y \to Z$ be a morphism of schemes
locally of finite type over $S$. Let $c' \in A^q(Y \to Z)$. Then
...
corresponding to $\alpha$, see proof of
Lemma \ref{chow-lemma-chow-cohomology-towards-base-dim-1}.
\end{remark}

\begin{lemma}[Exterior product associative dim 1]
\label{chow-lemma-exterior-product-associative-dim-1}
\source{stacks:0FC8}
\href{https://stacks.math.columbia.edu/tag/0FC8}{\texttt{Stacks tag 0FC8}}
\group{chow}
...
and $\delta(s) = 1$ otherwise. Then $(S, \delta)$ is a special case of our
general Situation \ref{chow-situation-setup}; see
Example \ref{chow-example-domain-dimension-1} and discussion in
...
$$
Here the first arrow is the exterior product constructed in
Section \ref{chow-section-exterior-product-dim-1} and the second arrow
is the Gysin map for the diagonal studied in
Section \ref{chow-section-gysin-for-diagonal}. If $X$ is equidimensional
...
\begin{lemma}[Associative dim 1]
\label{chow-lemma-associative-dim-1}
\source{stacks:0FCA}
\href{https://stacks.math.columbia.edu/tag/0FCA}{\texttt{Stacks tag 0FCA}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-exterior-product-associative-dim-1, chow-remark-restriction-bivariant, chow-lemma-gysin-commutes, chow-remark-commuting-exterior}

By Lemma \ref{chow-lemma-exterior-product-associative-dim-1} we have
$(\alpha \times \beta) \times \gamma =
...
\begin{lemma}[Identify chow for smooth dim 1]
\label{chow-lemma-identify-chow-for-smooth-dim-1}
\source{stacks:0FCB}
\href{https://stacks.math.columbia.edu/tag/0FCB}{\texttt{Stacks tag 0FCB}}
\group{chow}
...
\begin{proof}
\uses{chow-proposition-compute-bivariant, chow-lemma-chow-cohomology-towards-base-dim-1}
...
Lemma \ref{chow-lemma-chow-cohomology-towards-base-dim-1}.
From the proof of Lemma \ref{chow-lemma-chow-cohomology-towards-base-dim-1}
we see that the inverse to the second arrow sends $\alpha \in \CH_{d - p}(X)$
to the bivariant class $c_\alpha$ which sends $\beta \in \CH_*(Y)$
for $Y$ locally of finite type over $k$
to $\alpha \times \beta$ in $\CH_*(X \times_k Y)$. From the proof of
...
\begin{definition}[Situation: Setup base change]
\label{chow-situation-setup-base-change}
\source{stacks:0FVG}
\href{https://stacks.math.columbia.edu/tag/0FVG}{\texttt{Stacks tag 0FVG}}
\group{chow}

\uses{chow-situation-setup}
Here  $(S, \delta)$ and $(S', \delta')$ are as in
Situation \ref{chow-situation-setup}. Furthermore $g : S' \to S$
...
\begin{lemma}[Dimension base change]
\label{chow-lemma-dimension-base-change}
\source{stacks:0FVH}
\href{https://stacks.math.columbia.edu/tag/0FVH}{\texttt{Stacks tag 0FVH}}
\group{chow}

\uses{chow-situation-setup-base-change}
In Situation \ref{chow-situation-setup-base-change} let $X \to S$ be locally
...
\begin{proof}
\uses{chow-definition-delta-dimension}
...
$$
This proves what we want by Definition \ref{chow-definition-delta-dimension}.
\end{proof}
...
This makes sense by Lemma \ref{chow-lemma-dimension-base-change}.

\begin{lemma}[Pullback coherent base change]
\label{chow-lemma-pullback-coherent-base-change}
\source{stacks:0FVI}
\href{https://stacks.math.columbia.edu/tag/0FVI}{\texttt{Stacks tag 0FVI}}
\group{chow}

\uses{chow-situation-setup-base-change}
In Situation \ref{chow-situation-setup-base-change} let $X \to S$
...
\begin{proof}
\uses{chow-lemma-pullback-coherent, chow-lemma-dimension-base-change, chow-lemma-cycle-closed-coherent, chow-lemma-length-finite}

The proof is exactly the same is the proof of
Lemma \ref{chow-lemma-pullback-coherent}
and we suggest the reader skip it.

\medskip\noindent
The statements on dimensions follow from
Lemma \ref{chow-lemma-dimension-base-change}.
Part (1) follows from part (2) by Lemma \ref{chow-lemma-cycle-closed-coherent}
...
\begin{lemma}[Pullback base change]
\label{chow-lemma-pullback-base-change}
\source{stacks:0FVJ}
\href{https://stacks.math.columbia.edu/tag/0FVJ}{\texttt{Stacks tag 0FVJ}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-rational-equivalence-family, chow-lemma-closed-subscheme-cross-p1, chow-lemma-pullback-coherent-base-change, chow-lemma-dimension-base-change}

Suppose that $\alpha \in Z_k(X)$ is a $k$-cycle which is rationally equivalent
to zero. By Lemma \ref{chow-lemma-rational-equivalence-family}
...
\begin{lemma}[Pullback base change pullback]
\label{chow-lemma-pullback-base-change-pullback}
\source{stacks:0FVK}
\href{https://stacks.math.columbia.edu/tag/0FVK}{\texttt{Stacks tag 0FVK}}
\group{chow}

\uses{chow-situation-setup-base-change}
In Situation \ref{chow-situation-setup-base-change} let $Y \to X \to S$ be locally
...
$$
\vcenter{
\begin{array}{cc}Z_{k + r}(Y) \underset{g^*}{\longrightarrow} & Z_{k + c + r}(Y') \\ Z_k(X) \overset{g^*}{\longrightarrow}\overset{f^*}{\uparrow} & Z_{k + c}(X') \underset{(f')^*}{\uparrow}\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}\CH_{k + r}(Y) \underset{g^*}{\longrightarrow} & \CH_{k + c + r}(Y') \\ \CH_k(X) \overset{g^*}{\longrightarrow}\overset{f^*}{\uparrow} & \CH_{k + c}(X') \underset{(f')^*}{\uparrow}\end{array}
}
$$
...
\begin{proof}
\uses{chow-lemma-pullback-coherent, chow-definition-flat-pullback, chow-lemma-pullback-coherent-base-change}
...
we have $g^*[Z] = [Z']_{k + c}$. By Lemma \ref{chow-lemma-pullback-coherent}
we have $(f')^*g^*[Z] = [Z' \times_{X'} Y']_{k + c + r}$.
Conversely, we have $f^*[Z] = [Z \times_X Y]_{k + r}$ by
Definition \ref{chow-definition-flat-pullback}. By
Lemma \ref{chow-lemma-pullback-coherent-base-change}
we have $g^*f^*[Z] = [(Z \times_X Y)']_{k + r + c}$.
Since $(Z \times_X Y)' = Z' \times_{X'} Y'$ by
associativity of fibre product we conclude.
\end{proof}

\begin{lemma}[Pullback base change pushforward]
\label{chow-lemma-pullback-base-change-pushforward}
\source{stacks:0FVL}
\href{https://stacks.math.columbia.edu/tag/0FVL}{\texttt{Stacks tag 0FVL}}
\group{chow}
...
$$
\vcenter{
\begin{array}{cc}Z_k(Y) \underset{g^*}{\longrightarrow}\underset{f_*}{\downarrow} & Z_{k + c}(Y') \overset{f'_*}{\downarrow} \\ Z_k(X) \overset{g^*}{\longrightarrow} & Z_{k + c}(X')\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}\CH_k(Y) \underset{g^*}{\longrightarrow}\underset{f_*}{\downarrow} & \CH_{k + c}(Y') \overset{f'_*}{\downarrow} \\ \CH_k(X) \overset{g^*}{\longrightarrow} & \CH_{k + c}(X')\end{array}
}
$$
of cycle and chow groups commutes.
\end{lemma}
...
\begin{proof}
\uses{chow-lemma-cycle-push-sheaf, chow-lemma-pullback-coherent-base-change}

It suffices to show the first diagram commutes. To see this, let
$Z \subset Y$ be an integral closed subscheme of $\delta$-dimension $k$
and denote $Z' \subset X'$ its base change. By construction
we have $g^*[Z] = [Z']_{k + c}$. By Lemma \ref{chow-lemma-cycle-push-sheaf}
...
\begin{lemma}[Pullback base change c1]
\label{chow-lemma-pullback-base-change-c1}
\source{stacks:0FVM}
\href{https://stacks.math.columbia.edu/tag/0FVM}{\texttt{Stacks tag 0FVM}}
\group{chow}
...
diagram
$$
\begin{array}{cc}\CH_k(X) \underset{g^*}{\longrightarrow}\underset{c_1(\mathcal{L}) \cap -}{\downarrow} & \CH_{k + c}(X') \overset{c_1(\mathcal{L}') \cap -}{\downarrow} \\ \CH_{k - 1}(X) \overset{g^*}{\longrightarrow} & \CH_{k + c - 1}(X')\end{array}
$$
of chow groups commutes.
\end{lemma}

\begin{proof}
\uses{chow-lemma-linebundle, chow-lemma-linebundle-formulae, chow-lemma-pullback-base-change-pullback, chow-lemma-pullback-base-change-pushforward}
...
$o_*\alpha = - p^*\beta$, see Lemmas \ref{chow-lemma-linebundle} and
\ref{chow-lemma-linebundle-formulae}.
The same characterization holds after pullback. Hence the lemma follows from
Lemmas \ref{chow-lemma-pullback-base-change-pullback} and
\ref{chow-lemma-pullback-base-change-pushforward}.
\end{proof}

\begin{lemma}[Pullback base change chern classes]
\label{chow-lemma-pullback-base-change-chern-classes}
\source{stacks:0FVN}
\href{https://stacks.math.columbia.edu/tag/0FVN}{\texttt{Stacks tag 0FVN}}
\group{chow}
...
diagram
$$
\begin{array}{cc}\CH_k(X) \underset{g^*}{\longrightarrow}\underset{c_i(\mathcal{E}) \cap -}{\downarrow} & \CH_{k + c}(X') \overset{c_i(\mathcal{E}') \cap -}{\downarrow} \\ \CH_{k - i}(X) \overset{g^*}{\longrightarrow} & \CH_{k + c - i}(X')\end{array}
$$
of chow groups commutes for all $i$.
\end{lemma}

\begin{proof}
\uses{chow-lemma-pullback-base-change-pullback, chow-lemma-pullback-base-change-c1, chow-lemma-determine-intersections}
...
commute with base change (Lemmas \ref{chow-lemma-pullback-base-change-pullback} and
\ref{chow-lemma-pullback-base-change-c1})
the lemma follows from the characterization of capping
with $c_i(\mathcal{E})$ given in Lemma \ref{chow-lemma-determine-intersections}.
\end{proof}

\begin{lemma}[Compose base change]
\label{chow-lemma-compose-base-change}
\source{stacks:0FVP}
\href{https://stacks.math.columbia.edu/tag/0FVP}{\texttt{Stacks tag 0FVP}}
\group{chow}

\uses{chow-situation-setup, chow-situation-setup-base-change, chow-lemma-pullback-base-change}
Let $(S, \delta)$, $(S', \delta')$, $(S'', \delta'')$ be as in
Situation \ref{chow-situation-setup}. Let $g : S' \to S$ and $g' : S'' \to S'$
...
Lemma \ref{chow-lemma-pullback-base-change}
compose to give the map $(g \circ g')^* : \CH_k(X) \to \CH_{k + c + c'}(X'')$
of Lemma \ref{chow-lemma-pullback-base-change}.
\end{enumerate}
\end{lemma}

\begin{proof}
\uses{chow-lemma-pullback-coherent-base-change}
...
By Lemma \ref{chow-lemma-pullback-coherent-base-change} we have
$(g')^*[Z']_{k + c} = [Z'']_{k + c + c'}$. This proves the final statement.
\end{proof}

\begin{lemma}[Chow limit]
\label{chow-lemma-chow-limit}
\source{stacks:0FVQ}
\href{https://stacks.math.columbia.edu/tag/0FVQ}{\texttt{Stacks tag 0FVQ}}
\group{chow}

\uses{chow-situation-setup-base-change, chow-situation-setup}
In Situation \ref{chow-situation-setup-base-change} assume $c = 0$
...
the pair $(S_i, \delta_i)$ is as in Situation \ref{chow-situation-setup},
\item $S_i, \delta_i, S, \delta, S \to S_i, c = 0$ is as in
Situation \ref{chow-situation-setup-base-change},
\item $S_i, \delta_i, S_{i'}, \delta_{i'}, S_i \to S_{i'}, c = 0$
for $i \geq i'$ is as in Situation \ref{chow-situation-setup-base-change}.
\end{enumerate}
...
\begin{proof}
\uses{chow-lemma-compose-base-change, chow-lemma-dimension-base-change}

By the result of Lemma \ref{chow-lemma-compose-base-change} we obtain
...
By Lemma \ref{chow-lemma-dimension-base-change} we conclude that
...
By Lemma \ref{chow-lemma-dimension-base-change} each irreducible component
...
see Subsection \ref{chow-subsection-determinants-finite-length}.
The determinant $\det_\kappa(M)$ is a $1$-dimensional $\kappa$-vector space.
We use this in Subsection \ref{chow-subsection-periodic-complexes-determinants}
to define the determinant $\det_\kappa(M, \varphi, \psi) \in \kappa^*$
of an exact $(2, 1)$-periodic complex $(M, \varphi, \psi)$
with $M$ of finite length. In Subsection \ref{chow-subsection-symbols}
...
$$
where $\partial_R$ is as in Section \ref{chow-section-tame-symbol},
...
Subsection \ref{chow-subsection-length-determinant}
...
whose Herbrand quotient $e_R$ (Definition \ref{chow-definition-periodic-length})
is defined
...
Lemma \ref{chow-lemma-secondary-ramification}.
...
sense, see Remark \ref{chow-remark-explain-determinant}.

\begin{definition}[Determinant]
\label{chow-definition-determinant}
\source{stacks:02P6}
\href{https://stacks.math.columbia.edu/tag/02P6}{\texttt{Stacks tag 02P6}}
\group{chow}
...
\begin{lemma}[Dimension at most one]
\label{chow-lemma-dimension-at-most-one}
\source{stacks:02P7}
\href{https://stacks.math.columbia.edu/tag/02P7}{\texttt{Stacks tag 02P7}}
\group{chow}
...
\begin{lemma}[Compare det]
\label{chow-lemma-compare-det}
\source{stacks:02P8}
\href{https://stacks.math.columbia.edu/tag/02P8}{\texttt{Stacks tag 02P8}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-dimension-at-most-one}
...
map. Since by Lemma \ref{chow-lemma-dimension-at-most-one} the left hand side
has dimension at most one
we see that the map is an isomorphism.
\end{proof}

\begin{lemma}[Determinant dimension one]
\label{chow-lemma-determinant-dimension-one}
\source{stacks:02P9}
\href{https://stacks.math.columbia.edu/tag/02P9}{\texttt{Stacks tag 02P9}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-dimension-at-most-one, chow-lemma-compare-det}

We know $\det_\kappa(M)$ has dimension at most $1$, and in fact that it
is generated by $[f_1, \ldots, f_l]$, by
Lemma \ref{chow-lemma-dimension-at-most-one} and its proof.
We will show by induction on $l = \text{length}(M)$
that it is nonzero. For $l = 1$ it follows from Lemma \ref{chow-lemma-compare-det}.
...
\begin{lemma}[Det exact sequences]
\label{chow-lemma-det-exact-sequences}
\source{stacks:02PA}
\href{https://stacks.math.columbia.edu/tag/02PA}{\texttt{Stacks tag 02PA}}
\group{chow}
...
$$
\begin{array}{ccccc}0 \longrightarrow & K \longrightarrow\overset{u}{\downarrow} & L \longrightarrow\overset{v}{\downarrow} & M \longrightarrow\overset{w}{\downarrow} & 0 \\ 0 \longrightarrow & K' \longrightarrow & L' \longrightarrow & M' \longrightarrow & 0\end{array}
$$
...
$$
\begin{array}{ccccc} & 0 \downarrow & 0 \downarrow & 0 \downarrow &  \\ 0 \longrightarrow & A \longrightarrow\downarrow & B \longrightarrow\downarrow & C \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & D \longrightarrow\downarrow & E \longrightarrow\downarrow & F \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & G \longrightarrow\downarrow & H \longrightarrow\downarrow & I \longrightarrow\downarrow & 0 \\  & 0 & 0 & 0 & \end{array}
$$
the following diagram is commutative
$$
\begin{array}{cccc}\det\nolimits_\kappa(A) \otimes
\det\nolimits_\kappa(C) \otimes
\det\nolimits_\kappa(G) \otimes
\det\nolimits_\kappa(I)
\underset{\epsilon}{\downarrow}\underset{\gamma_{A \to B \to C} \otimes \gamma_{G \to H \to I}}{\longrightarrow} &  &  & \det\nolimits_\kappa(B) \otimes
\det\nolimits_\kappa(H)
\overset{\gamma_{B \to E \to H}}{\downarrow} \\  &  &  & \det\nolimits_\kappa(E) \\ \det\nolimits_\kappa(A) \otimes
\det\nolimits_\kappa(G) \otimes
\det\nolimits_\kappa(C) \otimes
\det\nolimits_\kappa(I)
\overset{\gamma_{A \to D \to G} \otimes \gamma_{C \to F \to I}}{\longrightarrow} &  &  & \det\nolimits_\kappa(D) \otimes
\det\nolimits_\kappa(F)
\underset{\gamma_{D \to E \to F}}{\uparrow}\end{array}
$$
...
\begin{proof}
\uses{chow-lemma-dimension-at-most-one, chow-lemma-determinant-dimension-one}
...
proof of Lemma \ref{chow-lemma-dimension-at-most-one}), and
...
\medskip\noindent
By Lemma \ref{chow-lemma-determinant-dimension-one} we know
...
\det\nolimits_\kappa(M)
$$
To construct it we use isomorphisms of Lemma \ref{chow-lemma-det-exact-sequences}
coming from the short exact sequences
$0 \to F^{i - 1}/F^i \to M/F^i \to M/F^{i - 1} \to 0$.
Part (2) of Lemma \ref{chow-lemma-det-exact-sequences} with $G = 0$ shows
...
\begin{lemma}[Uniqueness det]
\label{chow-lemma-uniqueness-det}
\source{stacks:02PB}
\href{https://stacks.math.columbia.edu/tag/02PB}{\texttt{Stacks tag 02PB}}
\group{chow}

\uses{chow-lemma-compare-det, chow-lemma-det-exact-sequences}
...
(see Lemma \ref{chow-lemma-compare-det}), and
\item (1), (2) and (3) of Lemma \ref{chow-lemma-det-exact-sequences}
hold.
\end{enumerate}
\end{lemma}
...
\begin{lemma}[Determinant quotient ring]
\label{chow-lemma-determinant-quotient-ring}
\source{stacks:02PC}
\href{https://stacks.math.columbia.edu/tag/02PC}{\texttt{Stacks tag 02PC}}
\group{chow}

\uses{chow-lemma-det-exact-sequences}
...
isomorphisms $\gamma_{K \to L \to M}$ of Lemma \ref{chow-lemma-det-exact-sequences}
...
$\gamma$ of Lemma \ref{chow-lemma-det-exact-sequences}.
\end{proof}

\begin{remark}[Explain determinant]
\label{chow-remark-explain-determinant}
\source{stacks:0BDQ}
\href{https://stacks.math.columbia.edu/tag/0BDQ}{\texttt{Stacks tag 0BDQ}}
\group{chow}

\uses{chow-lemma-determinant-quotient-ring, chow-lemma-det-exact-sequences}
...
using Lemma \ref{chow-lemma-determinant-quotient-ring} we see that
$$
\det\nolimits_\kappa(M_i) = \wedge_\kappa^{l_i}(M_{i, \kappa})
$$
These isomorphisms are compatible with the isomorphisms
$\gamma_{K \to M \to L}$ of Lemma \ref{chow-lemma-det-exact-sequences}
...
Example \ref{chow-example-determinant-map} for a random example.

\begin{lemma}[Times u determinant]
\label{chow-lemma-times-u-determinant}
\source{stacks:02PD}
\href{https://stacks.math.columbia.edu/tag/02PD}{\texttt{Stacks tag 02PD}}
\group{chow}
...
Hence by Lemma \ref{chow-lemma-det-exact-sequences} (1) we conclude that
$f_K f_M = f_L$.
This means that by induction on length it suffices to prove the
lemma in the case of length $1$ where it is trivial.
\end{proof}

\begin{example}[Determinant map]
\label{chow-example-determinant-map}
\source{stacks:02PE}
\href{https://stacks.math.columbia.edu/tag/02PE}{\texttt{Stacks tag 02PE}}
\group{chow}
...
Subsection \ref{chow-subsection-determinants-finite-length}.
Let us abbreviate
...
\det\nolimits_\kappa(M),
$$
see Lemma \ref{chow-lemma-det-exact-sequences}.
...
\begin{definition}[Periodic determinant]
\label{chow-definition-periodic-determinant}
\source{stacks:02PJ}
\href{https://stacks.math.columbia.edu/tag/02PJ}{\texttt{Stacks tag 02PJ}}
\group{chow}
...
\begin{remark}[More elementary]
\label{chow-remark-more-elementary}
\source{stacks:02PK}
\href{https://stacks.math.columbia.edu/tag/02PK}{\texttt{Stacks tag 02PK}}
\group{chow}
...
\begin{lemma}[Periodic determinant shift]
\label{chow-lemma-periodic-determinant-shift}
\source{stacks:02PL}
\href{https://stacks.math.columbia.edu/tag/02PL}{\texttt{Stacks tag 02PL}}
\group{chow}
...
\begin{lemma}[Periodic determinant sign]
\label{chow-lemma-periodic-determinant-sign}
\source{stacks:02PM}
\href{https://stacks.math.columbia.edu/tag/02PM}{\texttt{Stacks tag 02PM}}
\group{chow}
...
\begin{lemma}[Periodic determinant easy case]
\label{chow-lemma-periodic-determinant-easy-case}
\source{stacks:02PN}
\href{https://stacks.math.columbia.edu/tag/02PN}{\texttt{Stacks tag 02PN}}
\group{chow}
...
\begin{proof}
\uses{chow-definition-periodic-determinant}

Let us prove (1). Set $\psi = 0$. Then we may, with notation
as above Definition \ref{chow-definition-periodic-determinant}, identify
...
\begin{lemma}[Periodic determinant]
\label{chow-lemma-periodic-determinant}
\source{stacks:02PO}
\href{https://stacks.math.columbia.edu/tag/02PO}{\texttt{Stacks tag 02PO}}
\group{chow}
...
$$
\begin{array}{ccccc} & 0 \downarrow & 0 \downarrow & 0 \downarrow &  \\ 0 \longrightarrow & K_{\varphi, 1} \longrightarrow\downarrow & K_{\varphi, 2} \longrightarrow\downarrow & K_{\varphi, 3} \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & M_1 \longrightarrow\downarrow & M_2 \longrightarrow\downarrow & M_3 \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & I_{\varphi, 1} \longrightarrow\downarrow & I_{\varphi, 2} \longrightarrow\downarrow & I_{\varphi, 3} \longrightarrow\downarrow & 0 \\  & 0 & 0 & 0 & \end{array}
$$
...
$$
\begin{array}{cc}\det_\kappa(M_1) \otimes
\det_\kappa(M_3) \overset{\gamma}{\longrightarrow}\overset{\gamma^{-1} \otimes \gamma^{-1}}{\downarrow} & \det_\kappa(M_2)
\overset{\gamma^{-1}}{\downarrow} \\ \det\nolimits_\kappa(K_{\varphi, 1})
\otimes
...
\overset{\sigma \otimes \sigma}{\downarrow}\overset{\gamma \otimes \gamma}{\longrightarrow} & \det\nolimits_\kappa(K_{\varphi, 2})
\otimes
\det\nolimits_\kappa(I_{\varphi, 2})
\overset{\sigma}{\downarrow} \\ \det\nolimits_\kappa(K_{\psi, 1})
\otimes
...
\overset{\gamma \otimes \gamma}{\downarrow}\overset{\gamma \otimes \gamma}{\longrightarrow} & \det\nolimits_\kappa(K_{\psi, 2})
\otimes
\det\nolimits_\kappa(I_{\psi, 2})
\overset{\gamma}{\downarrow} \\ \det_\kappa(M_1)
\otimes
\det_\kappa(M_3) \overset{\gamma}{\longrightarrow} & \det_\kappa(M_2)\end{array}
$$
The top and bottom squares are commutative up to sign
by applying Lemma \ref{chow-lemma-det-exact-sequences} (2).
...
\source{stacks:02PP}
\href{https://stacks.math.columbia.edu/tag/02PP}{\texttt{Stacks tag 02PP}}
\group{chow}
...
\source{stacks:02PQ}
\href{https://stacks.math.columbia.edu/tag/02PQ}{\texttt{Stacks tag 02PQ}}
\group{chow}

\uses{chow-example-dual-numbers, chow-lemma-symbol-is-usual-tame-symbol}
Let $R = \mathbf{Z}_p$ and let $M = \mathbf{Z}_p/(p^l)$.
Let $\varphi = p^b u$ and $\varphi = p^a v$ with $a, b \geq 0$,
$a + b = l$ and $u, v \in \mathbf{Z}_p^*$.
Then a computation as in Example \ref{chow-example-dual-numbers}
shows that
\begin{eqnarray*}
...
See Lemma \ref{chow-lemma-symbol-is-usual-tame-symbol}
for a more general case (and a proof).
\end{example}

\begin{example}[Generic vector space]
\label{chow-example-generic-vector-space}
\source{stacks:02PR}
\href{https://stacks.math.columbia.edu/tag/02PR}{\texttt{Stacks tag 02PR}}
\group{chow}

\uses{chow-lemma-periodic-determinant}
Let $R = k$ be a field.
...
and using the additivity of Lemma \ref{chow-lemma-periodic-determinant}.
\end{example}

\begin{example}[Special vector space]
\label{chow-example-special-vector-space}
\source{stacks:02PS}
\href{https://stacks.math.columbia.edu/tag/02PS}{\texttt{Stacks tag 02PS}}
\group{chow}

\uses{chow-example-dual-numbers}
Let $R = k$ be a field.
...
Example \ref{chow-example-dual-numbers}.
\end{example}

\begin{example}[A la oort]
\label{chow-example-a-la-oort}
\source{stacks:02PT}
\href{https://stacks.math.columbia.edu/tag/02PT}{\texttt{Stacks tag 02PT}}
\group{chow}
...
\begin{lemma}[Multiplicativity determinant]
\label{chow-lemma-multiplicativity-determinant}
\source{stacks:02PU}
\href{https://stacks.math.columbia.edu/tag/02PU}{\texttt{Stacks tag 02PU}}
\group{chow}
...
\begin{proof}
\uses{chow-remark-more-elementary}
...
Hence, by Remark \ref{chow-remark-more-elementary} the determinant
...
\source{stacks:02PV}
\href{https://stacks.math.columbia.edu/tag/02PV}{\texttt{Stacks tag 02PV}}
\group{chow}
...
$$
\begin{array}{ccccc}Q \overset{\varphi'}{\longrightarrow} & I_{\varphi'}/\alpha(I_\varphi)
\overset{\psi\alpha^{-1}|_{I_{\varphi'}/\alpha(I_\varphi)}}{\longrightarrow} &  &  & K\end{array}
$$
and similarly
...
in $Q$ generating $Q$.
\end{enumerate}
By Remark \ref{chow-remark-more-elementary} the element
...
Hence by Remark \ref{chow-remark-more-elementary} the element
$D' = \det_\kappa(M', \varphi', \psi') \in \kappa^*$ is
characterized by
\begin{eqnarray*}
& &
...
\begin{lemma}[Pre symbol]
\label{chow-lemma-pre-symbol}
\source{stacks:02PX}
\href{https://stacks.math.columbia.edu/tag/02PX}{\texttt{Stacks tag 02PX}}
\group{chow}
...
\begin{lemma}[Symbol defined]
\label{chow-lemma-symbol-defined}
\source{stacks:02PY}
\href{https://stacks.math.columbia.edu/tag/02PY}{\texttt{Stacks tag 02PY}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-pre-symbol}

Follows from Lemma \ref{chow-lemma-pre-symbol}.
\end{proof}

\begin{definition}[Symbol M]
\label{chow-definition-symbol-M}
\source{stacks:02PZ}
\href{https://stacks.math.columbia.edu/tag/02PZ}{\texttt{Stacks tag 02PZ}}
\group{chow}
...
\begin{lemma}[Multiplicativity symbol]
\label{chow-lemma-multiplicativity-symbol}
\source{stacks:02Q0}
\href{https://stacks.math.columbia.edu/tag/02Q0}{\texttt{Stacks tag 02Q0}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-multiplicativity-determinant, chow-lemma-periodic-determinant-shift}

The first statement follows from Lemma \ref{chow-lemma-multiplicativity-determinant}
applied to $M/abcM$ and endomorphisms $\alpha, \beta, \gamma$ given by
multiplication by $a, b, c$.
The second comes from Lemma \ref{chow-lemma-periodic-determinant-shift}.
\end{proof}

\begin{definition}[Tame symbol]
\label{chow-definition-tame-symbol}
\source{stacks:02Q1}
\href{https://stacks.math.columbia.edu/tag/02Q1}{\texttt{Stacks tag 02Q1}}
\group{chow}

\uses{chow-lemma-multiplicativity-symbol}
...
\begin{proof}
\uses{chow-lemma-periodic-determinant-sign}

Immediate from Lemma \ref{chow-lemma-periodic-determinant-sign}.
\end{proof}

\begin{lemma}[Symbol when one is a unit]
\label{chow-lemma-symbol-when-one-is-a-unit}
\source{stacks:02Q2}
\href{https://stacks.math.columbia.edu/tag/02Q2}{\texttt{Stacks tag 02Q2}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-periodic-determinant-easy-case, chow-lemma-times-u-determinant}

Note that in this case $M/ubM = M/bM$ on which multiplication
by $b$ is zero. Hence $d_M(u, b) = \det_\kappa(u|_{M/bM})$
by Lemma \ref{chow-lemma-periodic-determinant-easy-case}. The lemma
then follows from Lemma \ref{chow-lemma-times-u-determinant}.
\end{proof}

\begin{lemma}[Symbol short exact sequence]
\label{chow-lemma-symbol-short-exact-sequence}
\source{stacks:02Q3}
\href{https://stacks.math.columbia.edu/tag/02Q3}{\texttt{Stacks tag 02Q3}}
\group{chow}
...
(M''/abM'', a, b) \to 0
$$
Hence the lemma follows from Lemma \ref{chow-lemma-periodic-determinant}.
\end{proof}

\begin{lemma}[Symbol compare modules]
\label{chow-lemma-symbol-compare-modules}
\source{stacks:02Q4}
\href{https://stacks.math.columbia.edu/tag/02Q4}{\texttt{Stacks tag 02Q4}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-symbol-when-one-is-a-unit, chow-lemma-multiplicativity-symbol, chow-lemma-tricky}

If $a \in A^*$, then the equality follows from the
equality $\text{length}(M/bM) = \text{length}(M'/bM')$
and Lemma \ref{chow-lemma-symbol-when-one-is-a-unit}.
Similarly if $b$ is a unit the lemma holds as well
(by the symmetry of Lemma \ref{chow-lemma-multiplicativity-symbol}).
...
Hence we may apply Lemma \ref{chow-lemma-tricky}. Thus it suffices to see
...
\begin{lemma}[Compute symbol M]
\label{chow-lemma-compute-symbol-M}
\source{stacks:02Q5}
\href{https://stacks.math.columbia.edu/tag/02Q5}{\texttt{Stacks tag 02Q5}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-symbol-short-exact-sequence, chow-lemma-symbol-compare-modules}
...
\right.
$$
by Lemma \ref{chow-lemma-symbol-short-exact-sequence} in the first instance
and Lemma \ref{chow-lemma-symbol-compare-modules} in the second. Hence the lemma.
\end{proof}

\begin{lemma}[Symbol is usual tame symbol]
\label{chow-lemma-symbol-is-usual-tame-symbol}
\source{stacks:02Q6}
\href{https://stacks.math.columbia.edu/tag/02Q6}{\texttt{Stacks tag 02Q6}}
\group{chow}
...
sequence in $(y)/(xy)$. Hence by Remark \ref{chow-remark-more-elementary}
...
\begin{lemma}[Symbol is steinberg prepare]
\label{chow-lemma-symbol-is-steinberg-prepare}
\source{stacks:02Q8}
\href{https://stacks.math.columbia.edu/tag/02Q8}{\texttt{Stacks tag 02Q8}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-compute-symbol-M, chow-lemma-determinant-quotient-ring, chow-lemma-symbol-when-one-is-a-unit, chow-lemma-symbol-when-equal, chow-lemma-Noetherian-domain-dim-1-two-elements, chow-lemma-pre-symbol, chow-lemma-symbol-compare-modules, chow-lemma-periodic-determinant-easy-case, chow-lemma-periodic-determinant, chow-lemma-periodic-determinant-sign}

By Lemma \ref{chow-lemma-compute-symbol-M} it suffices to show the relation when
...
See Lemma \ref{chow-lemma-determinant-quotient-ring}.

\medskip\noindent
It suffices to show the relation when both
$a, b$ are in the maximal ideal. Namely, the case where one
or both are units follows from Lemmas \ref{chow-lemma-symbol-when-one-is-a-unit}
and \ref{chow-lemma-symbol-when-equal}.
...
$$
which is defined by Lemma \ref{chow-lemma-pre-symbol}. The upper index ${}^A$
...
By Lemma \ref{chow-lemma-symbol-compare-modules} we see that
$d_A(a, b) = d^A_{A'}(a, b)$,
...
Using Lemmas
\ref{chow-lemma-periodic-determinant-easy-case} and
...
On the other hand, by Lemma \ref{chow-lemma-periodic-determinant-sign} we have
...
\begin{lemma}[Symbol is steinberg]
\label{chow-lemma-symbol-is-steinberg}
\source{stacks:02Q9}
\href{https://stacks.math.columbia.edu/tag/02Q9}{\texttt{Stacks tag 02Q9}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-symbol-is-steinberg-prepare}
...
This is Lemma \ref{chow-lemma-symbol-is-steinberg-prepare}.
\end{proof}
...
\source{stacks:02QB}
\href{https://stacks.math.columbia.edu/tag/02QB}{\texttt{Stacks tag 02QB}}
\group{chow}
...
$$
\begin{array}{ccccc}0 \longrightarrow & \langle x_1 \rangle \longrightarrow\downarrow & \langle x_1, \ldots, x_l \rangle \longrightarrow\downarrow & \langle x_1, \ldots, x_l \rangle / \langle x_1 \rangle \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & \langle y_1 \rangle \longrightarrow & \langle y_1, \ldots, y_l \rangle \longrightarrow & \langle y_1, \ldots, y_l \rangle / \langle y_1 \rangle \longrightarrow & 0\end{array}
$$
...
$$
\begin{array}{cc}M' \downarrow\underset{\varphi'}{\longrightarrow} & N' \downarrow \\ M \overset{\varphi}{\longrightarrow} & N\end{array}
$$
...
\begin{lemma}[Good sequence exists]
\label{chow-lemma-good-sequence-exists}
\source{stacks:02QC}
\href{https://stacks.math.columbia.edu/tag/02QC}{\texttt{Stacks tag 02QC}}
\group{chow}
...
Lemma \ref{chow-lemma-application-herbrand-quotient} his/herself.

\begin{proposition}[Length determinant periodic complex]
\label{chow-proposition-length-determinant-periodic-complex}
\source{stacks:02QD}
\href{https://stacks.math.columbia.edu/tag/02QD}{\texttt{Stacks tag 02QD}}
\group{chow}
...
current value, see Definition \ref{chow-definition-periodic-determinant}.}
$$
- e_R(M, \varphi, \psi) =
\sum\nolimits_{i = 1, \ldots, t}
...
\begin{proof}
\uses{chow-lemma-compare-periodic-lengths, chow-lemma-key-lemma, chow-lemma-good-sequence-exists, chow-lemma-determinant-dimension-one, chow-definition-periodic-determinant}
...
$\{\mathfrak m\}$. Hence by Lemma \ref{chow-lemma-compare-periodic-lengths}
we have
$$
e_R(M, \varphi, \psi) =
\sum\nolimits_{i = 1, \ldots, t}
...
follows from Lemma \ref{chow-lemma-key-lemma} and careful bookkeeping.
Denote
$K_\varphi = \Ker(\varphi)$,
$I_\varphi = \Im(\varphi)$,
$K_\psi = \Ker(\psi)$, and
...
\medskip\noindent
We are going to use Lemma \ref{chow-lemma-good-sequence-exists}
...
with properties (1) and (2) of Lemma \ref{chow-lemma-good-sequence-exists}
...
is a generator, see Lemma \ref{chow-lemma-determinant-dimension-one}.
...
of Lemma \ref{chow-lemma-good-sequence-exists}) we can find a
$d \in R$, $d \not \in \mathfrak q$ such that
...
of Definition \ref{chow-definition-periodic-determinant} we have
\begin{eqnarray*}
[z_1, \ldots, z_l] & = &
f_\varphi [x_1, \ldots, x_b, \tilde y_1, \ldots, \tilde y_a] \\
...
$$
by our first application of the key Lemma \ref{chow-lemma-key-lemma}.
...
\end{eqnarray*}
where we used the key Lemma \ref{chow-lemma-key-lemma} twice in the third equality.
...
\begin{lemma}[Application herbrand quotient]
\label{chow-lemma-application-herbrand-quotient}
\source{stacks:02QE}
\href{https://stacks.math.columbia.edu/tag/02QE}{\texttt{Stacks tag 02QE}}
\group{chow}
...
\begin{proof}
\uses{chow-definition-periodic-length, chow-proposition-length-determinant-periodic-complex, chow-lemma-periodic-determinant-easy-case, chow-lemma-key-lemma, chow-lemma-good-sequence-exists}

Recall that $H^0(M, 0, \psi) = \Coker(\psi)$ and
$H^1(M, 0, \psi) = \Ker(\psi)$, see remarks above
Definition \ref{chow-definition-periodic-length}.
The lemma follows by combining
Proposition \ref{chow-proposition-length-determinant-periodic-complex} with
Lemma \ref{chow-lemma-periodic-determinant-easy-case}.
...
Lemmas \ref{chow-lemma-key-lemma} and
...
analogue of the key lemma (Lemma \ref{chow-lemma-milnor-gersten-low-degree})
...
\source{stacks:02QJ}
\href{https://stacks.math.columbia.edu/tag/02QJ}{\texttt{Stacks tag 02QJ}}
\group{chow}

\uses{chow-lemma-symbol-when-one-is-a-unit}
\begin{reference}
When $A$ is an excellent ring this is \cite[Proposition 1]{Kato-Milnor-K}.
\end{reference}
Let $A$ be a $2$-dimensional Noetherian local domain with fraction field $K$.
...
Lemma \ref{chow-lemma-symbol-when-one-is-a-unit}.
\end{lemma}

\begin{proof}
\uses{chow-lemma-multiplicativity-symbol, chow-proposition-length-determinant-periodic-complex}

Since the tame symbols $d_{A_{\mathfrak q}}(f, g)$ are additive
(Lemma \ref{chow-lemma-multiplicativity-symbol}) and the order
...
= 0
$$
By Proposition \ref{chow-proposition-length-determinant-periodic-complex}
...
Lemma \ref{chow-lemma-coherent-sheaf-cap-c1}.
...
This section is a continuation of Section \ref{chow-section-chow-and-K}.
The motivation for the following lemma is
Homology, Lemma \ref{homology-lemma-serre-subcategory-K-groups}.

\begin{lemma}[Maps between coherent sheaves]
\label{chow-lemma-maps-between-coherent-sheaves}
\source{stacks:02SB}
\href{https://stacks.math.columbia.edu/tag/02SB}{\texttt{Stacks tag 02SB}}
\group{chow}
...
Let
$$
\begin{array}{cccccc}\ldots \longrightarrow & \mathcal{F} \overset{\varphi}{\longrightarrow} & \mathcal{F} \overset{\psi}{\longrightarrow} & \mathcal{F} \overset{\varphi}{\longrightarrow} & \mathcal{F} \longrightarrow & \ldots\end{array}
$$
...
\begin{proof}
\uses{chow-lemma-length-finite, chow-definition-periodic-determinant, chow-proposition-length-determinant-periodic-complex}

Let $\{W_j\}_{j \in J}$ be the collection of irreducible
components of $\text{Supp}(\mathcal{F})$
which have $\delta$-dimension $k + 1$. Note that $\{W_j\}$
is a locally finite collection of closed subsets of
$X$ by Lemma \ref{chow-lemma-length-finite}.
...
R(W_j)^*.
$$
See Definition \ref{chow-definition-periodic-determinant} for notation.
We claim that
$$
...
\begin{lemma}[Cycles rational equivalence K group]
\label{chow-lemma-cycles-rational-equivalence-K-group}
\source{stacks:02SC}
\href{https://stacks.math.columbia.edu/tag/02SC}{\texttt{Stacks tag 02SC}}
\group{chow}

\uses{chow-situation-setup, chow-lemma-from-chow-to-K}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
Let $X$ be a scheme locally of finite type over $S$.
The map
$$
...
K_0(\textit{Coh}_{\leq k + 1}(X)/\textit{Coh}_{\leq k - 1}(X))
$$
from Lemma \ref{chow-lemma-from-chow-to-K} induces a bijection from
...
\begin{proof}
\uses{chow-lemma-cycles-k-group, chow-lemma-from-chow-to-K, chow-lemma-maps-between-coherent-sheaves}

By Lemma \ref{chow-lemma-cycles-k-group} we have
$Z_k(X) = K_0(\textit{Coh}_{\leq k}(X)/\textit{Coh}_{\leq k - 1}(X))$
compatible with the map of Lemma \ref{chow-lemma-from-chow-to-K}.
...
By Lemma \ref{chow-lemma-maps-between-coherent-sheaves}
this implies that
$$
...
$$
of Lemma \ref{chow-lemma-cycles-k-group}. This is what we
...
\begin{lemma}[No embedded points modules]
\label{chow-lemma-no-embedded-points-modules}
\source{stacks:02QH}
\href{https://stacks.math.columbia.edu/tag/02QH}{\texttt{Stacks tag 02QH}}
\group{chow}
...
\begin{lemma}[No embedded points]
\label{chow-lemma-no-embedded-points}
\source{stacks:02SW}
\href{https://stacks.math.columbia.edu/tag/02SW}{\texttt{Stacks tag 02SW}}
\group{chow}
...
\begin{proof}
\uses{chow-lemma-no-embedded-points-modules}
...
follows from Lemma \ref{chow-lemma-no-embedded-points-modules}.
\end{proof}

\begin{lemma}[Coherent sheaf cap c1]
\label{chow-lemma-coherent-sheaf-cap-c1}
\source{stacks:02SX}
\href{https://stacks.math.columbia.edu/tag/02SX}{\texttt{Stacks tag 02SX}}
\group{chow}

\uses{chow-situation-setup, chow-lemma-cycles-rational-equivalence-K-group}
Let $(S, \delta)$ be as in Situation \ref{chow-situation-setup}.
Let $X$ be locally of finite type over $S$.
Let $\mathcal{L}$ be an invertible $\mathcal{O}_X$-module.
Let $\mathcal{F}$ be a coherent $\mathcal{O}_X$-module.
...
Lemma \ref{chow-lemma-cycles-rational-equivalence-K-group} and maps to
the element $c_1(\mathcal{L}) \cap [\mathcal{F}]_{k + 1}$ via
the map $B_k(X) \to \CH_k(X)$.
\end{lemma}

\begin{proof}
\uses{chow-lemma-additivity-sheaf-cycle, chow-lemma-no-embedded-points, chow-lemma-pushforward-cap-c1, chow-lemma-cycle-push-sheaf}
...
+ [\mathcal{K}'']_{k + 1}
$$
(use Lemma \ref{chow-lemma-additivity-sheaf-cycle}),
$$
[\mathcal{F} \otimes_{\mathcal{O}_X} \mathcal{L}]
-
[\mathcal{F}]
...
of denominators of $s$. By Lemma \ref{chow-lemma-no-embedded-points}
...
c_1(\mathcal{L}) \cap [\mathcal{F}]_{k + 1}
\end{eqnarray*}
by the above and Lemmas \ref{chow-lemma-pushforward-cap-c1}
and \ref{chow-lemma-cycle-push-sheaf}. And this agree with the
