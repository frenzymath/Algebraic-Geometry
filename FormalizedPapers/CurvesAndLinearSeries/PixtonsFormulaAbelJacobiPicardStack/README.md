...
`FormalizedPapers/CurvesAndLinearSeries/PixtonsFormulaAbelJacobiPicardStack`.
...
- Source bundle: [`references/pixtons-formula-abel-jacobi-picard-stack/`](../../../references/pixtons-formula-abel-jacobi-picard-stack/)
