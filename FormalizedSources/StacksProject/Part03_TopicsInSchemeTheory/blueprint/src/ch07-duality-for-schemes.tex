...
schemes, see Section \ref{duality-section-dualizing-schemes}.
...
\ref{duality-section-dualizing-Cartier}, and
\ref{duality-section-examples}.
...
\ref{duality-section-upper-shriek-properties}, and
\ref{duality-section-base-change-shriek}
culminating in the overview Section
\ref{duality-section-duality}.

\medskip\noindent
In Section \ref{duality-section-glue}
...
\source{stacks:0A86}
\href{https://stacks.math.columbia.edu/tag/0A86}{\texttt{Stacks tag 0A86}}
\group{duality}
...
\begin{definition}[Dualizing scheme]
\label{duality-definition-dualizing-scheme}
\source{stacks:0A87}
\href{https://stacks.math.columbia.edu/tag/0A87}{\texttt{Stacks tag 0A87}}
\group{duality}

\uses{duality-lemma-equivalent-definitions}
...
Lemma \ref{duality-lemma-equivalent-definitions}.
\end{definition}

Please see remarks made at the beginning of this section.

\begin{lemma}[Affine duality]
\label{duality-lemma-affine-duality}
\source{stacks:0A88}
\href{https://stacks.math.columbia.edu/tag/0A88}{\texttt{Stacks tag 0A88}}
\group{duality}
...
\source{stacks:0G4I}
\href{https://stacks.math.columbia.edu/tag/0G4I}{\texttt{Stacks tag 0G4I}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-affine-duality}
...
Lemma \ref{duality-lemma-affine-duality} and
Derived Categories of Schemes, Lemma
...
affine locally (which is allowable by Lemma \ref{duality-lemma-affine-duality})
...
\begin{lemma}[Dualizing schemes]
\label{duality-lemma-dualizing-schemes}
\source{stacks:0A89}
\href{https://stacks.math.columbia.edu/tag/0A89}{\texttt{Stacks tag 0A89}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-equivalent-definitions, duality-lemma-affine-duality, duality-lemma-internal-hom-evaluate-isom}

Let $U \subset X$ be an affine open. Say $U = \Spec(A)$ and
let $\omega_A^\bullet$ be a dualizing complex for $A$
corresponding to $K|_U$
as in Lemma \ref{duality-lemma-equivalent-definitions}.
By Lemma \ref{duality-lemma-affine-duality} the diagram
$$
\begin{array}{cc}D_{\textit{Coh}}(A) \longrightarrow\underset{R\Hom_A(-, \omega_A^\bullet)}{\downarrow} & D_{\textit{Coh}}(\mathcal{O}_U) \overset{R\SheafHom_{\mathcal{O}_X}(-, K|_U)}{\downarrow} \\ D_{\textit{Coh}}(A) \longrightarrow & D(\mathcal{O}_U)\end{array}
$$
...
Lemma \ref{duality-lemma-internal-hom-evaluate-isom} part (2)
...
\begin{lemma}[Dualizing unique schemes]
\label{duality-lemma-dualizing-unique-schemes}
\source{stacks:0ATP}
\href{https://stacks.math.columbia.edu/tag/0ATP}{\texttt{Stacks tag 0ATP}}
\group{duality}
...
\begin{lemma}[Dimension function scheme]
\label{duality-lemma-dimension-function-scheme}
\source{stacks:0AWF}
\href{https://stacks.math.columbia.edu/tag/0AWF}{\texttt{Stacks tag 0AWF}}
\group{duality}
...
\source{stacks:0ECM}
\href{https://stacks.math.columbia.edu/tag/0ECM}{\texttt{Stacks tag 0ECM}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-dualizing-schemes, duality-lemma-dimension-function-scheme}

Lemma \ref{duality-lemma-dualizing-schemes} tells us that $\mathcal{E}^i$
...
\omega_{X, x}^\bullet[-\delta(x)])
$$
By construction of $\delta$ in Lemma \ref{duality-lemma-dimension-function-scheme}
...
\begin{lemma}[Twisted inverse image]
\label{duality-lemma-twisted-inverse-image}
\source{stacks:0A9E}
\href{https://stacks.math.columbia.edu/tag/0A9E}{\texttt{Stacks tag 0A9E}}
\group{duality}
...
\begin{example}[Affine twisted inverse image]
\label{duality-example-affine-twisted-inverse-image}
\source{stacks:0A9F}
\href{https://stacks.math.columbia.edu/tag/0A9F}{\texttt{Stacks tag 0A9F}}
\group{duality}
...
\begin{example}[Does not preserve coherent]
\label{duality-example-does-not-preserve-coherent}
\source{stacks:0A9G}
\href{https://stacks.math.columbia.edu/tag/0A9G}{\texttt{Stacks tag 0A9G}}
\group{duality}

\uses{duality-example-affine-twisted-inverse-image}
...
Example \ref{duality-example-affine-twisted-inverse-image}
...
\begin{example}[Does not preserve bounded above]
\label{duality-example-does-not-preserve-bounded-above}
\source{stacks:0A9H}
\href{https://stacks.math.columbia.edu/tag/0A9H}{\texttt{Stacks tag 0A9H}}
\group{duality}
...
by Example \ref{duality-example-affine-twisted-inverse-image}.
\end{example}

\begin{lemma}[Twisted inverse image bounded below]
\label{duality-lemma-twisted-inverse-image-bounded-below}
\source{stacks:0A9I}
\href{https://stacks.math.columbia.edu/tag/0A9I}{\texttt{Stacks tag 0A9I}}
\group{duality}

\uses{duality-lemma-twisted-inverse-image}
Let $f : X \to Y$ be a morphism of quasi-compact and quasi-separated
schemes. Let $a : D_\QCoh(\mathcal{O}_Y) \to D_\QCoh(\mathcal{O}_X)$
be the right adjoint to $Rf_*$ of Lemma \ref{duality-lemma-twisted-inverse-image}.
...
\begin{lemma}[Iso on RSheafHom]
\label{duality-lemma-iso-on-RSheafHom}
\source{stacks:0A9Q}
\href{https://stacks.math.columbia.edu/tag/0A9Q}{\texttt{Stacks tag 0A9Q}}
\group{duality}
...
\begin{example}[Iso on RSheafHom]
\label{duality-example-iso-on-RSheafHom}
\source{stacks:0GEU}
\href{https://stacks.math.columbia.edu/tag/0GEU}{\texttt{Stacks tag 0GEU}}
\group{duality}

\uses{duality-lemma-iso-on-RSheafHom}
The statement of Lemma \ref{duality-lemma-iso-on-RSheafHom} is not true without
...
\begin{remark}[Iso on RSheafHom]
\label{duality-remark-iso-on-RSheafHom}
\source{stacks:0GEV}
\href{https://stacks.math.columbia.edu/tag/0GEV}{\texttt{Stacks tag 0GEV}}
\group{duality}

\uses{duality-lemma-iso-on-RSheafHom, duality-lemma-twisted-inverse-image-bounded-below}
In the situation of Lemma \ref{duality-lemma-iso-on-RSheafHom} we have
$$
...
is bounded below, see Lemma \ref{duality-lemma-twisted-inverse-image-bounded-below}.
\end{remark}

\begin{example}[Iso on RSheafHom noetherian]
\label{duality-example-iso-on-RSheafHom-noetherian}
\source{stacks:0GEW}
\href{https://stacks.math.columbia.edu/tag/0GEW}{\texttt{Stacks tag 0GEW}}
\group{duality}

\uses{duality-remark-iso-on-RSheafHom}
...
and the discussion in Remark \ref{duality-remark-iso-on-RSheafHom} applies.
\end{example}

\begin{lemma}[Iso global hom]
\label{duality-lemma-iso-global-hom}
\source{stacks:0B6I}
\href{https://stacks.math.columbia.edu/tag/0B6I}{\texttt{Stacks tag 0B6I}}
\group{duality}
...
$$
Thus the lemma is a consequence of Lemma \ref{duality-lemma-iso-on-RSheafHom}.
...
In this section we study the question to what extent the right adjoint
...
(Lemma \ref{duality-lemma-twisted-inverse-image}).
...
\begin{lemma}[Flat precompose pus]
\label{duality-lemma-flat-precompose-pus}
\source{stacks:0A9K}
\href{https://stacks.math.columbia.edu/tag/0A9K}{\texttt{Stacks tag 0A9K}}
\group{duality}
...
$$
\begin{array}{cc}U \underset{j'}{\longrightarrow}\underset{f|_U}{\downarrow} & X \overset{f}{\downarrow} \\ V \overset{j}{\longrightarrow} & Y\end{array}
$$
as in (\ref{equation-base-change}). By Lemma \ref{duality-lemma-flat-precompose-pus}
...
\begin{example}[Not supported on inverse image]
\label{duality-example-not-supported-on-inverse-image}
\source{stacks:0A9M}
\href{https://stacks.math.columbia.edu/tag/0A9M}{\texttt{Stacks tag 0A9M}}
\group{duality}
...
to $R\Hom(B, K)$ by Example \ref{duality-example-affine-twisted-inverse-image} and
$$
...
\begin{lemma}[When sheafy]
\label{duality-lemma-when-sheafy}
\source{stacks:0A9N}
\href{https://stacks.math.columbia.edu/tag/0A9N}{\texttt{Stacks tag 0A9N}}
\group{duality}
...
\begin{lemma}[Proper noetherian]
\label{duality-lemma-proper-noetherian}
\source{stacks:0A9P}
\href{https://stacks.math.columbia.edu/tag/0A9P}{\texttt{Stacks tag 0A9P}}
\group{duality}

\uses{duality-lemma-when-sheafy}
...
\end{enumerate}
then the equivalent conditions of Lemma \ref{duality-lemma-when-sheafy} part (1)
...
in the middle, see Lemma \ref{duality-lemma-flat-precompose-pus}.
...
\begin{lemma}[Compose base change maps]
\label{duality-lemma-compose-base-change-maps}
\source{stacks:0ATQ}
\href{https://stacks.math.columbia.edu/tag/0ATQ}{\texttt{Stacks tag 0ATQ}}
\group{duality}
...
$$
\begin{array}{ccc} &  & k^* \circ a \circ b \downarrow\swarrow \\  &  & k^* \circ a \circ l_* \circ l^* \circ b \swarrow \\ k^* \circ a \circ b \circ m_* \circ m^* \longrightarrow & k^* \circ a \circ l_* \circ l^* \circ b \circ m_* \circ m^* & k^* \circ k_* \circ a' \circ l^* \circ b \underset{\xi_{top}}{\uparrow}\downarrow\swarrow \\  & k^*\circ k_* \circ a' \circ l^* \circ b \circ m_* \circ m^*
\underset{\xi_{top}}{\uparrow}\searrow & a' \circ l^* \circ b \downarrow \\ k^* \circ k_* \circ a' \circ b' \circ m^* \underset{\xi_{rect}}{\uparrow}\searrow & k^*\circ k_* \circ a' \circ l^* \circ l_* \circ b' \circ m^*
\underset{\xi_{bot}}{\uparrow}\longleftarrow\searrow & a' \circ l^* \circ b \circ m_* \circ m^* \\  &  & a' \circ l^* \circ l_* \circ b' \circ m^* \underset{\xi_{bot}}{\uparrow}\downarrow \\  &  & a' \circ b' \circ m^*\end{array}
$$
...
$$
\begin{array}{cc}a \circ l_* \circ l^* \circ b \circ m_* & a \circ b \circ m_* \longleftarrow \\ k_* \circ a' \circ l^* \circ b \circ m_* \underset{\xi_{top}}{\uparrow} &  \\ k_* \circ a' \circ l^* \circ l_* \circ b' \underset{\xi_{bot}}{\uparrow}\longrightarrow & k_* \circ a' \circ b' \underset{\xi_{rect}}{\uparrow}\end{array}
$$
...
$$
\begin{array}{ccc} & a \circ l_* \circ l^* \circ b \circ m_* &  \\ a \circ l_* \circ l^* \circ l_* \circ b'
\overset{\xi_{bot}}{\nearrow} &  & k_* \circ a' \circ l^* \circ b \circ m_* \underset{\xi_{top}}{\nwarrow} \\  & k_* \circ a' \circ l^* \circ l_* \circ b'
\overset{\xi_{top}}{\nwarrow}\underset{\xi_{bot}}{\nearrow} & \end{array}
$$
commutes by Categories, Lemma \ref{categories-lemma-properties-2-cat-cats}.
Since the diagrams
$$
\vcenter{
\begin{array}{cc}a \circ l_* \circ l^* \circ b \circ m_* & a \circ b \circ m \longleftarrow \\ a \circ l_* \circ l^* \circ l_* \circ b' \uparrow & a \circ l_* \circ b' \longleftarrow\uparrow\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}a \circ l_* \circ l^* \circ l_* \circ b' \longrightarrow & a \circ l_* \circ b' \\ k_* \circ a' \circ l^* \circ l_* \circ b' \uparrow\longrightarrow & k_* \circ a' \circ b' \uparrow\end{array}
}
$$
...
\begin{lemma}[Compose base change maps horizontal]
\label{duality-lemma-compose-base-change-maps-horizontal}
\source{stacks:0ATR}
\href{https://stacks.math.columbia.edu/tag/0ATR}{\texttt{Stacks tag 0ATR}}
\group{duality}
...
To see this we contemplate the following diagram
$$
\begin{array}{cc} & (g')^* \circ g^* \circ a \downarrow\swarrow \\  & (g')^* \circ g^* \circ a \circ h_* \circ h^* \swarrow \\ (g')^* \circ g^* \circ a \circ h_* \circ (h')_* \circ (h')^* \circ h^* & (g')^* \circ g^* \circ g_* \circ a' \circ h^*
\underset{\xi_{right}}{\uparrow}\downarrow\swarrow \\ (g')^* \circ g^* \circ g_* \circ a' \circ (h')_* \circ (h')^* \circ h^*
\underset{\xi_{right}}{\uparrow}\searrow & (g')^* \circ a' \circ h^* \downarrow \\ (g')^* \circ g^* \circ g_* \circ (g')_* \circ a'' \circ (h')^* \circ h^*
\underset{\xi_{left}}{\uparrow}\searrow\searrow & (g')^* \circ a' \circ (h')_* \circ (h')^* \circ h^* \\  & (g')^*\circ (g')_* \circ a'' \circ (h')^* \circ h^*
\underset{\xi_{left}}{\uparrow}\downarrow \\  & a'' \circ (h')^* \circ h^*\end{array}
$$
Going down the right hand side we have the composition and going
down the left hand side we have $\gamma_{rect}$.
All the quadrilaterals on the right hand side of this diagram commute
...
\begin{remark}[Going around]
\label{duality-remark-going-around}
\source{stacks:0ATS}
\href{https://stacks.math.columbia.edu/tag/0ATS}{\texttt{Stacks tag 0ATS}}
\group{duality}

\uses{duality-lemma-twisted-inverse-image, duality-lemma-compose-base-change-maps-horizontal, duality-lemma-compose-base-change-maps}
Consider a commutative diagram
$$
\begin{array}{ccc}X'' \underset{k'}{\longrightarrow}\underset{f''}{\downarrow} & X' \underset{k}{\longrightarrow}\underset{f'}{\downarrow} & X \overset{f}{\downarrow} \\ Y'' \overset{l'}{\longrightarrow}\underset{g''}{\downarrow} & Y' \overset{l}{\longrightarrow}\underset{g'}{\downarrow} & Y \overset{g}{\downarrow} \\ Z'' \overset{m'}{\longrightarrow} & Z' \overset{m}{\longrightarrow} & Z\end{array}
$$
of quasi-compact and quasi-separated schemes where
...
right adjoints of Lemma \ref{duality-lemma-twisted-inverse-image}
for $f$, $f'$, $f''$, $g$, $g'$, $g''$.
...
\end{matrix}
$$
By Lemma \ref{duality-lemma-compose-base-change-maps-horizontal} we have
$$
\gamma_{A + B} = \gamma_A \circ \gamma_B, \quad
\gamma_{C + D} = \gamma_C \circ \gamma_D
$$
and by Lemma \ref{duality-lemma-compose-base-change-maps} we have
$$
...
Lemmas \ref{duality-lemma-compose-base-change-maps} and
\ref{duality-lemma-compose-base-change-maps-horizontal}
...
$$
\begin{array}{cc}(k')^* \circ a' \circ l^* \circ b \underset{\gamma_D}{\longrightarrow}\underset{\gamma_A}{\downarrow} & (k')^* \circ a' \circ b' \circ m^* \overset{\gamma_A}{\downarrow} \\ a'' \circ (l')^* \circ l^* \circ b \overset{\gamma_D}{\longrightarrow} & a'' \circ (l')^* \circ b' \circ m^*\end{array}
$$
...
Section \ref{duality-section-base-change-map} is an isomorphism
...
\begin{remark}[Check over affines]
\label{duality-remark-check-over-affines}
\source{stacks:0E9S}
\href{https://stacks.math.columbia.edu/tag/0E9S}{\texttt{Stacks tag 0E9S}}
\group{duality}

\uses{duality-lemma-compose-base-change-maps-horizontal}
...
$$
\vcenter{
\begin{array}{cc}U \longrightarrow\downarrow & X \downarrow \\ V \longrightarrow & Y\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}U' \longrightarrow\downarrow & X' \downarrow \\ V' \longrightarrow & Y'\end{array}
...
cartesian diagram
$$
\begin{array}{cc}U' \longrightarrow\downarrow & U \downarrow \\ V' \longrightarrow & V\end{array}
$$
...
horizontally, see Lemma \ref{duality-lemma-compose-base-change-maps-horizontal}.
Thus in order to check the base change map restricted to $U'$
is an isomorphism it suffices to work with the last diagram.
\end{remark}

\begin{lemma}[More base change]
\label{duality-lemma-more-base-change}
\source{stacks:0AA8}
\href{https://stacks.math.columbia.edu/tag/0AA8}{\texttt{Stacks tag 0AA8}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-iso-global-hom, duality-lemma-flat-precompose-pus}
...
of Lemma \ref{duality-lemma-iso-global-hom}
...
$$
of Lemma \ref{duality-lemma-iso-global-hom}. Then we use the base change
...
commutative diagram
$$
\begin{array}{ccc}((g')^*M, (g')^*a(K))_{X'} \downarrow & (M, a(K))_X \otimes A' \overset{\alpha}{\longleftarrow}\downarrow & (f_*M, K)_Y \otimes A' \xlongequal{}\downarrow \\ ((g')^*M, (g')^*a(g_*g^*K))_{X'} & (M, a(g_*g^*K))_X \otimes A' \overset{\alpha}{\longleftarrow} & (f_*M, g_*g^*K)_Y \otimes A' \xlongequal{}\underset{\mu'}{\downarrow} \\ ((g')^*M, (g')^*g'_*a'(g^*K))_{X'} \uparrow\downarrow & (M, g'_*a'(g^*K))_X \otimes A' \uparrow\overset{\alpha}{\longleftarrow}\overset{\mu}{\swarrow} & (f_*M, K) \otimes A' \overset{\beta}{\downarrow} \\ ((g')^*M, a'(g^*K))_{X'} & (f'_*(g')^*M, g^*K)_{Y'} \xlongequal{}\longrightarrow & (g^*f_*M, g^*K)_{Y'}\end{array}
$$
...
$g'_* \circ a' \to a \circ g_*$  of Lemma \ref{duality-lemma-flat-precompose-pus}
...
Observe that
$$
\begin{array}{ccc}(M, a(g_*g^*K))_X & (f_*M, g_* g^*K)_Y \xlongequal{} & (g^*f_*M, g^*K)_{Y'} \xlongequal{} \\ (M, g'_* a'(g^*K))_X \uparrow & ((g')^*M, a'(g^*K))_{X'} \xlongequal{} & (f'_*(g')^*M, g^*K)_{Y'} \xlongequal{}\uparrow\end{array}
$$
...
$$
\begin{array}{ccc}R\Hom_A(E, K) \underset{\text{induced by }\beta}{\longrightarrow}\searrow &  & R\Hom_{A'}(E \otimes_A^\mathbf{L} A', K \otimes_A^\mathbf{L} A') \\  & R\Hom_A(E, K \otimes_A^\mathbf{L} A') \nearrow & \end{array}
$$
...
Let $f : X \to Y$ be a morphism of quasi-compact and quasi-separated
schemes. Let $a : D_\QCoh(\mathcal{O}_Y) \to D_\QCoh(\mathcal{O}_X)$
be the right adjoint as in Lemma \ref{duality-lemma-twisted-inverse-image}. By
...
\source{stacks:0B6J}
\href{https://stacks.math.columbia.edu/tag/0B6J}{\texttt{Stacks tag 0B6J}}
\group{duality}
...
$$
\begin{array}{cc}Lg^* \circ Rf_* \circ a
\underset{\beta \star 1}{\downarrow}\underset{1 \star \text{Tr}_f}{\longrightarrow} & Lg^* \\ Rf'_* \circ L(g')^* \circ a \overset{1 \star \alpha}{\longrightarrow} & Rf'_* \circ a' \circ Lg^* \underset{\text{Tr}_{f'} \star 1}{\uparrow}\end{array}
$$
of transformations of functors commutes.
\end{lemma}

\begin{proof}
\uses{duality-lemma-flat-precompose-pus}
...
which is the adjoint of $\beta$, see Lemma \ref{duality-lemma-flat-precompose-pus}
...
$$
\begin{array}{cccc} & g^* \circ f_* \circ a \underset{\beta}{\swarrow}\downarrow\underset{\text{Tr}_f}{\longrightarrow} & g^* &  \\ f'_* \circ (g')^* \circ a \searrow & g^* \circ f_* \circ a \circ g_* \circ g^* \underset{\beta}{\downarrow}\nearrow & g^* \circ f_* \circ g'_* \circ a' \circ g^* \underset{\beta^\vee}{\longleftarrow}\underset{\beta}{\downarrow} & f'_* \circ a' \circ g^* \underset{\text{Tr}_{f'}}{\nwarrow} \\  & f'_* \circ (g')^* \circ a \circ g_* \circ g^* & f'_* \circ (g')^* \circ g'_* \circ a' \circ g^* \nearrow\underset{\beta^\vee}{\longleftarrow} & \end{array}
$$
...
the square
$$
\begin{array}{cc}g^* \circ f_* \circ g'_* \circ a' \underset{\beta^\vee}{\downarrow}\underset{\beta}{\longrightarrow} & f'_* \circ (g')^* \circ g'_* \circ a' \downarrow \\ g^* \circ f_* \circ a \circ g_* \longrightarrow & \text{id}\end{array}
$$
...
Lemma \ref{duality-lemma-twisted-inverse-image}. By
Categories, Section \ref{categories-section-adjoint} we obtain a
transformation of functors
$$
...
\begin{lemma}[Unit and base change]
\label{duality-lemma-unit-and-base-change}
\source{stacks:0B6K}
\href{https://stacks.math.columbia.edu/tag/0B6K}{\texttt{Stacks tag 0B6K}}
\group{duality}
...
More precisely, the diagram
$$
\begin{array}{cc}L(g')^* \underset{1 \star \eta_f}{\longrightarrow}\underset{\eta_{f'} \star 1}{\downarrow} & L(g')^* \circ a \circ Rf_* \overset{\alpha}{\downarrow} \\ a' \circ Rf'_* \circ L(g')^* & a' \circ Lg^* \circ Rf_* \underset{\beta}{\longleftarrow}\end{array}
$$
of transformations of functors commutes.
\end{lemma}

\begin{proof}
\uses{duality-lemma-trace-map-and-base-change, duality-lemma-flat-precompose-pus}

This proof is dual to the proof of Lemma \ref{duality-lemma-trace-map-and-base-change}.
In this proof we write $f_*$ for $Rf_*$ and $g^*$ for $Lg^*$ and we
drop $\star$ products with identities as one can figure out which ones
to add as long as the source and target of the transformation is known.
Recall that $\beta : g^* \circ f_* \to f'_* \circ (g')^*$ is an isomorphism
...
$$
\begin{array}{ccc} & (g')^* \circ a \circ f_* \longrightarrow & (g')^* \circ a \circ g_* \circ g^* \circ f_*
\underset{\beta}{\swarrow} \\ (g')^* \overset{\eta_f}{\nearrow}\underset{\eta_{f'}}{\downarrow}\searrow & (g')^* \circ a \circ g_* \circ f'_* \circ (g')^* & (g')^* \circ g'_* \circ a' \circ g^* \circ f_*
\underset{\beta^\vee}{\uparrow}\underset{\beta}{\swarrow}\downarrow \\  & (g')^* \circ g'_* \circ a' \circ f'_* \circ (g')^*
\swarrow\underset{\beta^\vee}{\uparrow} & a' \circ g^* \circ f_* \overset{\beta}{\swarrow} \\ a' \circ f'_* \circ (g')^* &  & \end{array}
$$
In this diagram the two squares commute
Categories, Lemma \ref{categories-lemma-properties-2-cat-cats}
or more simply the discussion preceding
...
the square
$$
\begin{array}{cc}\text{id} \longrightarrow\downarrow & g'_* \circ a' \circ g^* \circ f_* \overset{\beta}{\downarrow} \\ g'_* \circ a' \circ g^* \circ f_* \overset{\beta^\vee}{\longrightarrow} & a \circ g_* \circ f'_* \circ (g')^*\end{array}
$$
commutes which implies the pentagon in the big diagram commutes.
Since $\beta$ and $\beta^\vee$ are isomorphisms, and since going on
the outside of the big diagram equals
...
\begin{example}[Trace affine]
\label{duality-example-trace-affine}
\source{stacks:0B6L}
\href{https://stacks.math.columbia.edu/tag/0B6L}{\texttt{Stacks tag 0B6L}}
\group{duality}

\uses{duality-example-affine-twisted-inverse-image}
Let $A \to B$ be a ring map. Let $Y = \Spec(A)$ and $X = \Spec(B)$
and $f : X \to Y$ the morphism corresponding to $A \to B$. As seen
in Example \ref{duality-example-affine-twisted-inverse-image}
...
Lemma \ref{duality-lemma-twisted-inverse-image}. For $K, L \in D_\QCoh(\mathcal{O}_Y)$
...
\begin{lemma}[Compare with pullback perfect]
\label{duality-lemma-compare-with-pullback-perfect}
\source{stacks:0A9T}
\href{https://stacks.math.columbia.edu/tag/0A9T}{\texttt{Stacks tag 0A9T}}
\group{duality}
...
\begin{lemma}[Restriction compare with pullback]
\label{duality-lemma-restriction-compare-with-pullback}
\source{stacks:0B6P}
\href{https://stacks.math.columbia.edu/tag/0B6P}{\texttt{Stacks tag 0B6P}}
\group{duality}

Suppose we have a diagram (\ref{equation-base-change}) where $f$ and $g$
are tor independent. Let $K \in D_\QCoh(\mathcal{O}_Y)$. The diagram
$$
\begin{array}{cc}L(g')^*(Lf^*K \otimes^\mathbf{L}_{\mathcal{O}_X} a(\mathcal{O}_Y))
\longrightarrow\downarrow & L(g')^*a(K) \downarrow \\ L(f')^*Lg^*K \otimes_{\mathcal{O}_{X'}}^\mathbf{L} a'(\mathcal{O}_{Y'})
\longrightarrow & a'(Lg^*K)\end{array}
$$
...
\begin{proof}
\uses{duality-lemma-unit-and-base-change, duality-lemma-trace-map-and-base-change}
...
Lemmas \ref{duality-lemma-unit-and-base-change} and
\ref{duality-lemma-trace-map-and-base-change}.
...
\begin{lemma}[Compare on open]
\label{duality-lemma-compare-on-open}
\source{stacks:0B6Q}
\href{https://stacks.math.columbia.edu/tag/0B6Q}{\texttt{Stacks tag 0B6Q}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-proper-noetherian, duality-lemma-restriction-compare-with-pullback}

By Lemma \ref{duality-lemma-proper-noetherian} the map (\ref{equation-sheafy}) is an
isomorphism for objects of $D_\QCoh^+(\mathcal{O}_Y)$. Hence
Lemma \ref{duality-lemma-restriction-compare-with-pullback} tells us the
...
\begin{lemma}[Transitivity compare with pullback]
\label{duality-lemma-transitivity-compare-with-pullback}
\source{stacks:0B6R}
\href{https://stacks.math.columbia.edu/tag/0B6R}{\texttt{Stacks tag 0B6R}}
\group{duality}
...
adjoints of Lemma \ref{duality-lemma-twisted-inverse-image} for $f, g, h$.
For any $K \in D_\QCoh(\mathcal{O}_Z)$ the diagram
$$
\begin{array}{ccc}Lf^*(Lg^*K \otimes_{\mathcal{O}_Y}^\mathbf{L}
b(\mathcal{O}_Z)) \otimes_{\mathcal{O}_X}^\mathbf{L} a(\mathcal{O}_Y)
\downarrow\longrightarrow & a(Lg^*K \otimes_{\mathcal{O}_Y}^\mathbf{L} b(\mathcal{O}_Z)) \longrightarrow & a(b(K)) \downarrow \\ Lh^*K \otimes_{\mathcal{O}_X}^\mathbf{L} Lf^*b(\mathcal{O}_Z)
\otimes_{\mathcal{O}_X}^\mathbf{L} a(\mathcal{O}_Y) \longrightarrow & Lh^*K \otimes_{\mathcal{O}_X}^\mathbf{L} c(\mathcal{O}_Z) \longrightarrow & c(K)\end{array}
$$
...
\begin{lemma}[Compute sheaf with exact support]
\label{duality-lemma-compute-sheaf-with-exact-support}
\source{stacks:0A75}
\href{https://stacks.math.columbia.edu/tag/0A75}{\texttt{Stacks tag 0A75}}
\group{duality}
...
\begin{lemma}[Sheaf with exact support adjoint]
\label{duality-lemma-sheaf-with-exact-support-adjoint}
\source{stacks:0A76}
\href{https://stacks.math.columbia.edu/tag/0A76}{\texttt{Stacks tag 0A76}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-compute-sheaf-with-exact-support}

This is a consequence of the fact that $i_*$ and
$\SheafHom(\mathcal{O}_Z, -)$ are adjoint functors by
Lemma \ref{duality-lemma-compute-sheaf-with-exact-support}. See
Derived Categories, Lemma \ref{derived-lemma-derived-adjoint-functors}.
\end{proof}

\begin{lemma}[Sheaf with exact support ext]
\label{duality-lemma-sheaf-with-exact-support-ext}
\source{stacks:0A77}
\href{https://stacks.math.columbia.edu/tag/0A77}{\texttt{Stacks tag 0A77}}
\group{duality}
...
\begin{lemma}[Sheaf with exact support internal home]
\label{duality-lemma-sheaf-with-exact-support-internal-home}
\source{stacks:0E2I}
\href{https://stacks.math.columbia.edu/tag/0E2I}{\texttt{Stacks tag 0E2I}}
\group{duality}
...
\begin{lemma}[Sheaf with exact support quasi coherent]
\label{duality-lemma-sheaf-with-exact-support-quasi-coherent}
\source{stacks:0A78}
\href{https://stacks.math.columbia.edu/tag/0A78}{\texttt{Stacks tag 0A78}}
\group{duality}
...
$$
\begin{array}{cc}D^+(B) \longrightarrow & D_\QCoh^+(\mathcal{O}_Z) \\ D^+(A) \longrightarrow\overset{R\Hom(B, -)}{\uparrow} & D_\QCoh^+(\mathcal{O}_X) \underset{R\SheafHom(\mathcal{O}_Z, -)}{\uparrow}\end{array}
$$
is commutative.
\end{enumerate}
\end{lemma}
...
\begin{proof}
\uses{duality-lemma-sheaf-with-exact-support-ext, duality-lemma-compute-sheaf-with-exact-support}
...
Lemma \ref{duality-lemma-sheaf-with-exact-support-ext}
...
Lemma \ref{duality-lemma-compute-sheaf-with-exact-support}
that there is a map
$$
\Hom_A(B, I^\bullet)
\longrightarrow
...
\begin{lemma}[Sheaf with exact support coherent]
\label{duality-lemma-sheaf-with-exact-support-coherent}
\source{stacks:0A79}
\href{https://stacks.math.columbia.edu/tag/0A79}{\texttt{Stacks tag 0A79}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-sheaf-with-exact-support-quasi-coherent}
...
Lemma \ref{duality-lemma-sheaf-with-exact-support-quasi-coherent}
...
\begin{lemma}[Twisted inverse image closed]
\label{duality-lemma-twisted-inverse-image-closed}
\source{stacks:0A9X}
\href{https://stacks.math.columbia.edu/tag/0A9X}{\texttt{Stacks tag 0A9X}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-sheaf-with-exact-support-adjoint, duality-lemma-sheaf-with-exact-support-quasi-coherent, duality-lemma-twisted-inverse-image-bounded-below}

(The parenthetical statement follows from More on Morphisms, Lemma
\ref{more-morphisms-lemma-Noetherian-pseudo-coherent}.)
By Lemma \ref{duality-lemma-sheaf-with-exact-support-adjoint}
the functor $R\SheafHom(\mathcal{O}_Z, -)$ is a right adjoint
to $Ri_* : D(\mathcal{O}_Z) \to D(\mathcal{O}_X)$. Moreover,
by Lemma \ref{duality-lemma-sheaf-with-exact-support-quasi-coherent}
and Lemma \ref{duality-lemma-twisted-inverse-image-bounded-below}
...
\begin{example}[Trace closed immersion]
\label{duality-example-trace-closed-immersion}
\source{stacks:0B6M}
\href{https://stacks.math.columbia.edu/tag/0B6M}{\texttt{Stacks tag 0B6M}}
\group{duality}

\uses{duality-lemma-sheaf-with-exact-support-ext, duality-lemma-twisted-inverse-image-closed}
If $i : Z \to X$ is closed immersion of Noetherian schemes, then
the diagram
$$
\begin{array}{ccc}i_*a(K) \underset{\text{Tr}_{i, K}}{\longrightarrow}\downarrow &  & K \downarrow \\ i_*R\SheafHom(\mathcal{O}_Z, K) \xlongequal{} & R\SheafHom_{\mathcal{O}_X}(i_*\mathcal{O}_Z, K)
\longrightarrow & K\end{array}
$$
is commutative for $K \in D_\QCoh^+(\mathcal{O}_X)$.
Here the horizontal equality sign is
Lemma \ref{duality-lemma-sheaf-with-exact-support-ext} and the
...
Lemma \ref{duality-lemma-twisted-inverse-image-closed}.
\end{example}
...
$$
\begin{array}{cc}Z' \underset{i'}{\longrightarrow}\underset{g}{\downarrow} & X' \overset{f}{\downarrow} \\ Z \overset{i}{\longrightarrow} & X\end{array}
$$
...
Namely, by adjointness of Lemma \ref{duality-lemma-sheaf-with-exact-support-adjoint}
...
\source{stacks:0E2L}
\href{https://stacks.math.columbia.edu/tag/0E2L}{\texttt{Stacks tag 0E2L}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-sheaf-with-exact-support-ext}
...
Lemma \ref{duality-lemma-sheaf-with-exact-support-ext}. We omit the
...
\begin{lemma}[Flat bc sheaf with exact support]
\label{duality-lemma-flat-bc-sheaf-with-exact-support}
\source{stacks:0E2M}
\href{https://stacks.math.columbia.edu/tag/0E2M}{\texttt{Stacks tag 0E2M}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-check-base-change-is-iso}
...
over $A$. By Lemma \ref{duality-lemma-check-base-change-is-iso} it suffices
to check that
$$
...
\begin{lemma}[Sheaf with exact support tensor]
\label{duality-lemma-sheaf-with-exact-support-tensor}
\source{stacks:0E2N}
\href{https://stacks.math.columbia.edu/tag/0E2N}{\texttt{Stacks tag 0E2N}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-sheaf-with-exact-support-adjoint, duality-lemma-sheaf-with-exact-support-ext, duality-lemma-sheaf-with-exact-support-quasi-coherent, duality-lemma-flat-bc-sheaf-with-exact-support}
...
$$
by Lemmas \ref{duality-lemma-sheaf-with-exact-support-adjoint} and
\ref{duality-lemma-sheaf-with-exact-support-ext}. For this map we take the
...
Instead of using Lemma \ref{duality-lemma-sheaf-with-exact-support-quasi-coherent}
you can look at stalks as in the second proof of
Lemma \ref{duality-lemma-flat-bc-sheaf-with-exact-support}.
\end{proof}
...
Section \ref{duality-section-sections-with-exact-support}.
...
\begin{lemma}[Compute sheafhom affine]
\label{duality-lemma-compute-sheafhom-affine}
\source{stacks:0BUZ}
\href{https://stacks.math.columbia.edu/tag/0BUZ}{\texttt{Stacks tag 0BUZ}}
\group{duality}
...
\begin{lemma}[Sheafhom affine adjoint]
\label{duality-lemma-sheafhom-affine-adjoint}
\source{stacks:0BV0}
\href{https://stacks.math.columbia.edu/tag/0BV0}{\texttt{Stacks tag 0BV0}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-compute-sheafhom-affine}

Follows from Lemma \ref{duality-lemma-compute-sheafhom-affine}
and
Derived Categories, Lemma \ref{derived-lemma-derived-adjoint-functors}.
\end{proof}

\begin{lemma}[Sheafhom affine ext]
\label{duality-lemma-sheafhom-affine-ext}
\source{stacks:0BV1}
\href{https://stacks.math.columbia.edu/tag/0BV1}{\texttt{Stacks tag 0BV1}}
\group{duality}
...
\begin{lemma}[Finite twisted]
\label{duality-lemma-finite-twisted}
\source{stacks:0AX2}
\href{https://stacks.math.columbia.edu/tag/0AX2}{\texttt{Stacks tag 0AX2}}
\group{duality}
...
$$
\begin{array}{ccc}D_\QCoh^+(\mathcal{O}_X) \underset{a}{\longrightarrow}\underset{R\SheafHom(f_*\mathcal{O}_Y, -)}{\searrow} &  & D_\QCoh^+(\mathcal{O}_Y) \overset{\Phi}{\swarrow} \\  & D_\QCoh^+(f_*\mathcal{O}_Y) & \end{array}
$$
is commutative, where $a$ is the right adjoint of
Lemma \ref{duality-lemma-twisted-inverse-image} for $f$ and $\Phi$ is the equivalence
of Derived Categories of Schemes, Lemma
\ref{perfect-lemma-affine-morphism-equivalence}.
\end{lemma}

\begin{proof}
\uses{duality-lemma-twisted-inverse-image-bounded-below, duality-lemma-sheafhom-affine-adjoint}
...
use Lemmas \ref{duality-lemma-twisted-inverse-image-bounded-below} and
\ref{duality-lemma-sheafhom-affine-adjoint}.
\end{proof}

\begin{remark}[Trace map finite]
\label{duality-remark-trace-map-finite}
\source{stacks:0AX3}
\href{https://stacks.math.columbia.edu/tag/0AX3}{\texttt{Stacks tag 0AX3}}
\group{duality}

\uses{duality-lemma-finite-twisted}
If $f : Y \to X$ is a finite morphism of Noetherian schemes, then the diagram
$$
\begin{array}{cc}Rf_*a(K) \underset{\text{Tr}_{f, K}}{\longrightarrow}\downarrow & K \downarrow \\ R\SheafHom_{\mathcal{O}_X}(f_*\mathcal{O}_Y, K) \longrightarrow & K\end{array}
$$
is commutative for $K \in D_\QCoh^+(\mathcal{O}_X)$. This follows
from Lemma \ref{duality-lemma-finite-twisted}. The lower horizontal
arrow is induced by the map $\mathcal{O}_X \to f_*\mathcal{O}_Y$ and the
upper horizontal arrow is the trace map discussed in
Section \ref{duality-section-trace}.
\end{remark}
...
\begin{lemma}[Proper flat]
\label{duality-lemma-proper-flat}
\source{stacks:0E4I}
\href{https://stacks.math.columbia.edu/tag/0E4I}{\texttt{Stacks tag 0E4I}}
\group{duality}
...
Lemma \ref{duality-lemma-twisted-inverse-image}. Then $a$ commutes with direct sums.
\end{lemma}
...
\begin{lemma}[Proper flat relative]
\label{duality-lemma-proper-flat-relative}
\source{stacks:0E4J}
\href{https://stacks.math.columbia.edu/tag/0E4J}{\texttt{Stacks tag 0E4J}}
\group{duality}
...
Let $a$ be the right adjoint for
$Rf_* : D_\QCoh(\mathcal{O}_X) \to D_\QCoh(\mathcal{O}_Y)$ of
Lemma \ref{duality-lemma-twisted-inverse-image}. Then
\begin{enumerate}
...
\begin{proof}
\uses{duality-lemma-when-sheafy, duality-lemma-proper-noetherian, duality-lemma-proper-flat}

This follows from Lemmas \ref{duality-lemma-when-sheafy},
\ref{duality-lemma-proper-noetherian}, and
\ref{duality-lemma-proper-flat}. Strictly speaking part (1) follows
...
\begin{lemma}[Compare with pullback flat proper]
\label{duality-lemma-compare-with-pullback-flat-proper}
\source{stacks:0E4K}
\href{https://stacks.math.columbia.edu/tag/0E4K}{\texttt{Stacks tag 0E4K}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-proper-flat, duality-lemma-compare-with-pullback-perfect}

By Lemma \ref{duality-lemma-proper-flat} we know that $a$ commutes
...
Lemma \ref{duality-lemma-compare-with-pullback-perfect}.
\end{proof}
...
\begin{proof}
\uses{duality-lemma-proper-flat-relative, duality-remark-check-over-affines, duality-lemma-more-base-change}

By Lemma \ref{duality-lemma-proper-flat-relative} formation of the
...
Remark \ref{duality-remark-check-over-affines}. In this
case the statement follows from Lemma \ref{duality-lemma-more-base-change}.
\end{proof}

\begin{remark}[Relative dualizing complex]
\label{duality-remark-relative-dualizing-complex}
\source{stacks:0B6S}
\href{https://stacks.math.columbia.edu/tag/0B6S}{\texttt{Stacks tag 0B6S}}
\group{duality}

\uses{duality-lemma-twisted-inverse-image, duality-lemma-compare-with-pullback-flat-proper, duality-lemma-proper-flat-base-change, duality-lemma-trace-map-and-base-change}
Let $Y$ be a quasi-compact and quasi-separated scheme.
Let $f : X \to Y$ be a proper, flat morphism of finite presentation.
Let $a$ be the adjoint of Lemma \ref{duality-lemma-twisted-inverse-image} for $f$.
In this situation, $\omega_{X/Y}^\bullet = a(\mathcal{O}_Y)$
is sometimes called the {\it relative dualizing complex}. By
Lemma \ref{duality-lemma-compare-with-pullback-flat-proper}
...
$$
of Section \ref{duality-section-trace} induces the trace map for all $K$
in $D_\QCoh(\mathcal{O}_Y)$. More precisely the diagram
$$
\begin{array}{cccc}Rf_*a(K) \underset{\text{Tr}_{f, K}}{\longrightarrow}\downarrow &  &  & K \downarrow \\ Rf_*(Lf^*K \otimes_{\mathcal{O}_X}^\mathbf{L} \omega_{X/Y}^\bullet)
\xlongequal{} & K \otimes_{\mathcal{O}_Y}^\mathbf{L} Rf_*\omega_{X/Y}^\bullet
\overset{\text{id}_K \otimes \text{Tr}_{f, \mathcal{O}_Y}}{\longrightarrow} &  & K\end{array}
$$
...
Lemma \ref{duality-lemma-proper-flat-base-change} we have
$\omega_{X'/Y'}^\bullet = L(g')^*\omega_{X/Y}^\bullet$ where $g' : X' \to X$
is the projection and by Lemma \ref{duality-lemma-trace-map-and-base-change}
the trace map
$$
...
\begin{remark}[Relative dualizing complex relative cup product]
\label{duality-remark-relative-dualizing-complex-relative-cup-product}
\source{stacks:0G81}
\href{https://stacks.math.columbia.edu/tag/0G81}{\texttt{Stacks tag 0G81}}
\group{duality}

\uses{duality-remark-relative-dualizing-complex, duality-lemma-iso-on-RSheafHom, duality-remark-iso-on-RSheafHom}
Let $f : X \to Y$, $\omega^\bullet_{X/Y}$, and $\text{Tr}_{f, \mathcal{O}_Y}$
be as in Remark \ref{duality-remark-relative-dualizing-complex}.
...
Lemma \ref{duality-lemma-iso-on-RSheafHom} and
Remark \ref{duality-remark-iso-on-RSheafHom}
...
\begin{lemma}[Properties relative dualizing]
\label{duality-lemma-properties-relative-dualizing}
\source{stacks:0E4L}
\href{https://stacks.math.columbia.edu/tag/0E4L}{\texttt{Stacks tag 0E4L}}
\group{duality}

\uses{duality-remark-relative-dualizing-complex}
Let $Y$ be a quasi-compact and quasi-separated scheme.
...
with base change (see Remark \ref{duality-remark-relative-dualizing-complex}),
...
Cohomology, Lemma \ref{cohomology-lemma-dual-perfect-complex}.
For the second equality, see Lemma \ref{duality-lemma-iso-on-RSheafHom},
Remark \ref{duality-remark-iso-on-RSheafHom}, and
Derived Categories of Schemes, Lemma
\ref{perfect-lemma-flat-proper-perfect-direct-image-general}.
...
\source{stacks:0E2P}
\href{https://stacks.math.columbia.edu/tag/0E2P}{\texttt{Stacks tag 0E2P}}
\group{duality}

\uses{duality-remark-relative-dualizing-complex, duality-lemma-twisted-inverse-image}
Let $Y$ be a quasi-compact and quasi-separated scheme.
Let $f : X \to Y$ be a proper, flat morphism of finite presentation
...
\begin{proof}
\uses{duality-lemma-twisted-inverse-image, duality-lemma-compare-with-pullback-flat-proper, duality-lemma-proper-flat-base-change}

Let $a$ be the right adjoint to $Rf_*$ as in
Lemma \ref{duality-lemma-twisted-inverse-image}.
Consider the cartesian square
$$
\begin{array}{cc}X \times_Y X \underset{q}{\longrightarrow}\underset{p}{\downarrow} & X \underset{f}{\downarrow} \\ X \overset{f}{\longrightarrow} & Y\end{array}
$$
Let $b$ be the right adjoint for $p$
as in Lemma \ref{duality-lemma-twisted-inverse-image}. Then
\begin{align*}
\omega_{X/Y}^\bullet
& =
...
Lemma \ref{duality-lemma-compare-with-pullback-flat-proper}.
\item The third holds by Lemma \ref{duality-lemma-proper-flat-base-change}
...
\begin{remark}[Van den bergh]
\label{duality-remark-van-den-bergh}
\source{stacks:0BRU}
\href{https://stacks.math.columbia.edu/tag/0BRU}{\texttt{Stacks tag 0BRU}}
\group{duality}

\uses{duality-lemma-van-den-bergh}
Lemma \ref{duality-lemma-van-den-bergh} means our relative dualizing
...
We will return to this in Section \ref{duality-section-relative-dualizing-complexes}.
\end{remark}
...
\begin{lemma}[Proper flat noetherian]
\label{duality-lemma-proper-flat-noetherian}
\source{stacks:0A9R}
\href{https://stacks.math.columbia.edu/tag/0A9R}{\texttt{Stacks tag 0A9R}}
\group{duality}
...
\begin{lemma}[Proper flat noetherian relative]
\label{duality-lemma-proper-flat-noetherian-relative}
\source{stacks:0AAA}
\href{https://stacks.math.columbia.edu/tag/0AAA}{\texttt{Stacks tag 0AAA}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-when-sheafy, duality-lemma-proper-noetherian, duality-lemma-proper-flat-noetherian}

This follows from Lemmas \ref{duality-lemma-when-sheafy},
\ref{duality-lemma-proper-noetherian}, and
\ref{duality-lemma-proper-flat-noetherian}.
\end{proof}

\begin{lemma}[Compare with pullback flat proper noetherian]
\label{duality-lemma-compare-with-pullback-flat-proper-noetherian}
\source{stacks:0A9U}
\href{https://stacks.math.columbia.edu/tag/0A9U}{\texttt{Stacks tag 0A9U}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-proper-flat-noetherian, duality-lemma-compare-with-pullback-perfect}

By Lemma \ref{duality-lemma-proper-flat-noetherian} we know that $a$ commutes
with direct sums. Hence the collection of objects of
$D_\QCoh(\mathcal{O}_Y)$ for which (\ref{equation-compare-with-pullback})
is an isomorphism is a strictly full, saturated, triangulated
subcategory of $D_\QCoh(\mathcal{O}_Y)$ which is moreover
...
\begin{lemma}[Proper perfect base change]
\label{duality-lemma-proper-perfect-base-change}
\source{stacks:0BZG}
\href{https://stacks.math.columbia.edu/tag/0BZG}{\texttt{Stacks tag 0BZG}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-proper-flat-noetherian-relative, duality-remark-check-over-affines, duality-lemma-more-base-change}

By Lemma \ref{duality-lemma-proper-flat-noetherian-relative} formation of the
functors $a$ and $a'$ commutes with restriction to opens of $Y$ and $Y'$.
Hence we may assume $Y' \to Y$ is a morphism of affine schemes, see
Remark \ref{duality-remark-check-over-affines}. In this
case the statement follows from Lemma \ref{duality-lemma-more-base-change}.
...
see Section \ref{duality-section-sections-with-exact-support}.

\begin{lemma}[Compute for effective Cartier]
\label{duality-lemma-compute-for-effective-Cartier}
\source{stacks:0B4B}
\href{https://stacks.math.columbia.edu/tag/0B4B}{\texttt{Stacks tag 0B4B}}
\group{duality}
...
by Lemma \ref{duality-lemma-sheaf-with-exact-support-ext}. We have a resolution
$$
...
Lemma \ref{duality-lemma-compare-with-pullback-flat-proper-noetherian}.

\begin{lemma}[Sheaf with exact support effective Cartier]
\label{duality-lemma-sheaf-with-exact-support-effective-Cartier}
\source{stacks:0AA4}
\href{https://stacks.math.columbia.edu/tag/0AA4}{\texttt{Stacks tag 0AA4}}
\group{duality}

\uses{duality-lemma-compute-for-effective-Cartier}
As above, let $X$ be a scheme and let $D \subset X$ be an
effective Cartier divisor. Then (\ref{equation-map-effective-Cartier})
combined with Lemma \ref{duality-lemma-compute-for-effective-Cartier}
...
and
$0 \to \mathcal{O}_X \to \mathcal{O}_X(D) \to i_*\mathcal{N} \to 0$
used in the proof of Lemma \ref{duality-lemma-compute-for-effective-Cartier}
...
\begin{lemma}[Upper shriek P1]
\label{duality-lemma-upper-shriek-P1}
\source{stacks:0A9W}
\href{https://stacks.math.columbia.edu/tag/0A9W}{\texttt{Stacks tag 0A9W}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-proper-noetherian}
...
By Lemma \ref{duality-lemma-proper-noetherian} construction of the $a$
...
\begin{example}[Base change wrong]
\label{duality-example-base-change-wrong}
\source{stacks:0AAC}
\href{https://stacks.math.columbia.edu/tag/0AAC}{\texttt{Stacks tag 0AAC}}
\group{duality}

\uses{duality-lemma-twisted-inverse-image, duality-lemma-upper-shriek-P1, duality-lemma-twisted-inverse-image-closed, duality-lemma-sheaf-with-exact-support-effective-Cartier, duality-lemma-more-base-change}
...
By Lemma \ref{duality-lemma-upper-shriek-P1} we have
$b(\mathcal{O}_Y) = \mathcal{O}(-2)[1]$.
By Lemma \ref{duality-lemma-twisted-inverse-image-closed}
we have
$$
...
\mathcal{O}_X(-1)
$$
Last equality by Lemma \ref{duality-lemma-sheaf-with-exact-support-effective-Cartier}.
...
the hypothesis of Tor independence in Lemma \ref{duality-lemma-more-base-change}
is violated.
\end{example}
...
\source{stacks:0BQW}
\href{https://stacks.math.columbia.edu/tag/0BQW}{\texttt{Stacks tag 0BQW}}
\group{duality}
...
\begin{lemma}[Regular ideal ext]
\label{duality-lemma-regular-ideal-ext}
\source{stacks:0BQY}
\href{https://stacks.math.columbia.edu/tag/0BQY}{\texttt{Stacks tag 0BQY}}
\group{duality}
...
\begin{lemma}[Regular immersion ext]
\label{duality-lemma-regular-immersion-ext}
\source{stacks:0BQZ}
\href{https://stacks.math.columbia.edu/tag/0BQZ}{\texttt{Stacks tag 0BQZ}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-ext, duality-lemma-regular-ideal-ext}

We can use Lemmas \ref{duality-lemma-ext} and \ref{duality-lemma-regular-ideal-ext}
...
Lemma \ref{duality-lemma-regular-ideal-ext}. Then
$$
R\SheafHom_{\mathcal{O}_Y}(\mathcal{O}_X, \mathcal{O}_Y) =
...
With $\delta_j$ as in the proof of Lemma \ref{duality-lemma-regular-ideal-ext}
...
\begin{lemma}[Regular immersion]
\label{duality-lemma-regular-immersion}
\source{stacks:0BR0}
\href{https://stacks.math.columbia.edu/tag/0BR0}{\texttt{Stacks tag 0BR0}}
\group{duality}
...
Lemma \ref{duality-lemma-twisted-inverse-image}. Then there is an isomorphism
$$
...
\begin{proof}
\uses{duality-lemma-twisted-inverse-image-closed, duality-lemma-sheaf-with-exact-support-ext, duality-lemma-regular-immersion-ext}

Recall, from Lemmas \ref{duality-lemma-twisted-inverse-image-closed}
and \ref{duality-lemma-sheaf-with-exact-support-ext},
that $a(\mathcal{O}_Y)$ is an object of $D_\QCoh(\mathcal{O}_X)$ whose
pushforward to $Y$ is
$R\SheafHom_{\mathcal{O}_Y}(i_*\mathcal{O}_X, \mathcal{O}_Y)$.
Thus the result follows from Lemma \ref{duality-lemma-regular-immersion-ext}.
\end{proof}

\begin{lemma}[Smooth proper]
\label{duality-lemma-smooth-proper}
\source{stacks:0BRT}
\href{https://stacks.math.columbia.edu/tag/0BRT}{\texttt{Stacks tag 0BRT}}
\group{duality}
...
\begin{proof}
\uses{duality-remark-relative-dualizing-complex, duality-lemma-twisted-inverse-image, duality-lemma-compare-with-pullback-flat-proper-noetherian, duality-lemma-regular-immersion}

Set $\omega_{X/S}^\bullet = a(\mathcal{O}_S)$ as in
Remark \ref{duality-remark-relative-dualizing-complex}.
Let $c$ be the right adjoint of Lemma \ref{duality-lemma-twisted-inverse-image} for
...
The fourth equality by Lemma \ref{duality-lemma-regular-immersion}.
...
\begin{definition}[Situation: Shriek]
\label{duality-situation-shriek}
\source{stacks:0F42}
\href{https://stacks.math.columbia.edu/tag/0F42}{\texttt{Stacks tag 0F42}}
\group{duality}
...
In Situation \ref{duality-situation-shriek} given a morphism $f : X \to Y$
...
constructed in Lemma \ref{duality-lemma-twisted-inverse-image}. Then we set
$$
f^!K  = \overline{a}(K)|_X
$$
...
\begin{lemma}[Shriek well defined]
\label{duality-lemma-shriek-well-defined}
\source{stacks:0AA0}
\href{https://stacks.math.columbia.edu/tag/0AA0}{\texttt{Stacks tag 0AA0}}
\group{duality}

\uses{duality-situation-shriek}
In Situation \ref{duality-situation-shriek} let $f : X \to Y$ be a morphism
of $\textit{FTS}_S$. The functor $f^!$ is, up to canonical isomorphism,
independent of the choice of the compactification.
\end{lemma}

\begin{proof}
\uses{duality-lemma-twisted-inverse-image, duality-lemma-proper-noetherian, duality-lemma-compose-base-change-maps}
...
constructed in Lemma \ref{duality-lemma-twisted-inverse-image}.
...
Lemma \ref{duality-lemma-twisted-inverse-image} for $g$.
...
which is an isomorphism by Lemma \ref{duality-lemma-proper-noetherian}.
The composition
$$
...
Lemma \ref{duality-lemma-twisted-inverse-image} for $g$, resp.\ $h$.
...
right adjoint of Lemma \ref{duality-lemma-twisted-inverse-image}
...
$$
\begin{array}{cc}\overline{a}_1 \longrightarrow\downarrow & \overline{c} \circ \overline{a}_2 \downarrow \\ \overline{e} \circ \overline{a}_3 \longrightarrow & \overline{c} \circ \overline{d} \circ \overline{a}_3\end{array}
$$
...
$$
\begin{array}{cc}R\overline{f}_{1, *} \longrightarrow\downarrow & Rg_* \circ R\overline{f}_{2, *} \downarrow \\ R(h \circ g)_* \circ R\overline{f}_{3, *} \longrightarrow & Rg_* \circ Rh_* \circ R\overline{f}_{3, *}\end{array}
$$
...
This was proven in Lemma \ref{duality-lemma-compose-base-change-maps}
(note that in the current case the morphisms $f', g'$ of that
lemma are equal to $\text{id}_X$).
\end{proof}

\begin{lemma}[Upper shriek composition]
\label{duality-lemma-upper-shriek-composition}
\source{stacks:0ATX}
\href{https://stacks.math.columbia.edu/tag/0ATX}{\texttt{Stacks tag 0ATX}}
\group{duality}

\uses{duality-situation-shriek}
In Situation \ref{duality-situation-shriek} let $f : X \to Y$ and $g : Y \to Z$
be composable morphisms of $\textit{FTS}_S$. Then there is a canonical
isomorphism $(g \circ f)^! \to f^! \circ g^!$.
\end{lemma}

\begin{proof}
\uses{duality-lemma-twisted-inverse-image, duality-lemma-proper-noetherian, duality-lemma-shriek-well-defined, duality-lemma-compose-base-change-maps, duality-lemma-compose-base-change-maps-horizontal, duality-remark-going-around}
...
right adjoint of Lemma \ref{duality-lemma-twisted-inverse-image} for
...
$$
\begin{array}{ccc}X \underset{j}{\longrightarrow}\downarrow & U \swarrow\underset{j'}{\longrightarrow} & \overline{X} \swarrow \\ Y \underset{i}{\longrightarrow}\downarrow & \overline{Y} \swarrow &  \\ Z &  & \end{array}
$$
Let $\overline{a}'$ be the
right adjoint of Lemma \ref{duality-lemma-twisted-inverse-image} for
$U \to Y$.
...
Lemma \ref{duality-lemma-proper-noetherian}. To finish the proof we show that
...
$$
\vcenter{
\begin{array}{ccc}X \underset{j_1}{\longrightarrow}\downarrow & U_1 \swarrow\underset{j'_1}{\longrightarrow} & \overline{X}_1 \swarrow \\ Y \underset{i_1}{\longrightarrow}\downarrow & \overline{Y}_1 \swarrow &  \\ Z &  & \end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{ccc}X \underset{j_2}{\longrightarrow}\downarrow & U_2 \swarrow\underset{j'_2}{\longrightarrow} & \overline{X}_2 \swarrow \\ Y \underset{i_2}{\longrightarrow}\downarrow & \overline{Y}_2 \swarrow &  \\ Z &  & \end{array}
}
$$
...
as follows
$$
\begin{array}{ccccc}X \underset{j_1}{\longrightarrow}\downarrow &  & U_1 \downarrow\swarrow\underset{j'_1}{\longrightarrow} &  & \overline{X}_1 \downarrow\swarrow \\ X \overset{j_2}{\longrightarrow}\downarrow &  & U_2 \swarrow\overset{j'_2}{\longrightarrow} &  & \overline{X}_2 \swarrow \\ Y \overset{i_1}{\longrightarrow}\downarrow &  & \overline{Y}_1 \downarrow &  &  \\ Y \overset{i_2}{\longrightarrow}\downarrow &  & \overline{Y}_2 \swarrow &  &  \\ Z &  &  &  & \end{array}
$$
...
Each of the squares
$$
\begin{array}{cc}X \longrightarrow\downarrow\searrow|A & U_1 \downarrow \\ X \longrightarrow & U_2\end{array}
\quad
\begin{array}{cc}U_2 \longrightarrow\downarrow\searrow|B & \overline{X}_2 \downarrow \\ Y \longrightarrow & \overline{Y}_2\end{array}
\quad
\begin{array}{cc}U_1 \longrightarrow\downarrow\searrow|C & \overline{X}_1 \downarrow \\ Y \longrightarrow & \overline{Y}_1\end{array}
\quad
\begin{array}{cc}Y \longrightarrow\downarrow\searrow|D & \overline{Y}_1 \downarrow \\ Y \longrightarrow & \overline{Y}_2\end{array}
\quad
\begin{array}{cc}X \longrightarrow\downarrow\searrow|E & \overline{X}_1 \downarrow \\ X \longrightarrow & \overline{X}_2\end{array}
$$
is cartesian (see
...
and in Lemma \ref{duality-lemma-shriek-well-defined} uses
\begin{enumerate}
...
$$
\begin{array}{cc}(g \circ f)^!_1 \underset{\gamma_E}{\longrightarrow}\underset{\gamma_C}{\downarrow} & (g \circ f)^!_2 \underset{\gamma_B}{\downarrow} \\ f_1^! \circ g_1^! \overset{\gamma_A \circ \gamma_D}{\longrightarrow} & f_2^! \circ g_2^!\end{array}
$$
is commutative. We will use
Lemmas \ref{duality-lemma-compose-base-change-maps} and
\ref{duality-lemma-compose-base-change-maps-horizontal}
and with (abuse of) notation as in
Remark \ref{duality-remark-going-around} (in particular
dropping $\star$ products with identity transformations
from the notation).
We can write $\gamma_E = \gamma_A \circ \gamma_F$ where
$$
\begin{array}{cc}U_1 \longrightarrow\downarrow\searrow|F & \overline{X}_1 \downarrow \\ U_2 \longrightarrow & \overline{X}_2\end{array}
$$
Thus we see that
$$
...
Remark \ref{duality-remark-going-around}). Thus it suffices to prove that
$\gamma_D \circ \gamma_C = \gamma_B \circ \gamma_F$.
Since both of these are equal to the map (\ref{equation-sheafy})
for the square
$$
\begin{array}{cc}U_1 \longrightarrow\downarrow & \overline{X}_1 \downarrow \\ Y \longrightarrow & \overline{Y}_2\end{array}
$$
we conclude.
\end{proof}

\begin{lemma}[Pseudo functor]
\label{duality-lemma-pseudo-functor}
\source{stacks:0ATY}
\href{https://stacks.math.columbia.edu/tag/0ATY}{\texttt{Stacks tag 0ATY}}
\group{duality}

\uses{duality-situation-shriek, duality-lemma-shriek-well-defined, duality-lemma-upper-shriek-composition}
In Situation \ref{duality-situation-shriek} the constructions of
Lemmas \ref{duality-lemma-shriek-well-defined} and \ref{duality-lemma-upper-shriek-composition}
...
\begin{proof}
\uses{duality-lemma-upper-shriek-composition, duality-lemma-compose-base-change-maps, duality-lemma-compose-base-change-maps-horizontal, duality-remark-going-around}

To show this we have to prove given morphisms
$f : X \to Y$, $g : Y \to Z$, $h : Z \to T$
that
$$
\begin{array}{cc}(h \circ g \circ f)^! \underset{\gamma_{A + B}}{\longrightarrow}\underset{\gamma_{B + C}}{\downarrow} & f^! \circ (h \circ g)^! \overset{\gamma_C}{\downarrow} \\ (g \circ f)^! \circ h^! \overset{\gamma_A}{\longrightarrow} & f^! \circ g^! \circ h^!\end{array}
$$
...
$$
\begin{array}{cccc}X \underset{f}{\downarrow}\longrightarrow & U \longrightarrow\downarrow\searrow|A & V \downarrow\longrightarrow\searrow|B & \overline{X} \downarrow \\ Y \underset{g}{\downarrow}\longrightarrow & Y \longrightarrow\downarrow & W \longrightarrow\downarrow\searrow|C & \overline{Y} \downarrow \\ Z \underset{h}{\downarrow}\longrightarrow & Z \downarrow\longrightarrow & Z \downarrow\longrightarrow & \overline{Z} \downarrow \\ T \longrightarrow & T \longrightarrow & T \longrightarrow & T\end{array}
$$
Without introducing tons of notation but arguing exactly
as in the proof of Lemma \ref{duality-lemma-upper-shriek-composition}
...
intersect in one point (similar to the last argument in
Remark \ref{duality-remark-going-around}).
\end{proof}

\begin{lemma}[Map pullback to shriek well defined]
\label{duality-lemma-map-pullback-to-shriek-well-defined}
\source{stacks:0B6T}
\href{https://stacks.math.columbia.edu/tag/0B6T}{\texttt{Stacks tag 0B6T}}
\group{duality}

\uses{duality-situation-shriek}
In Situation \ref{duality-situation-shriek} let
...
the diagram
$$
\begin{array}{ccc}Lf^*(Lg^*K \otimes_{\mathcal{O}_Y}^\mathbf{L} g^!\mathcal{O}_Z)
\otimes_{\mathcal{O}_X}^\mathbf{L} f^!\mathcal{O}_Y
\downarrow\underset{\mu_f}{\longrightarrow} & f^!(Lg^*K \otimes_{\mathcal{O}_Y}^\mathbf{L} g^!\mathcal{O}_Z)
\underset{f^!\mu_g}{\longrightarrow} & f^!g^!K \downarrow \\ Lf^*Lg^*K \otimes_{\mathcal{O}_X}^\mathbf{L} Lf^* g^!\mathcal{O}_Z
\otimes_{\mathcal{O}_X}^\mathbf{L} f^!\mathcal{O}_Y \overset{\mu_f}{\longrightarrow} & Lf^*Lg^*K \otimes_{\mathcal{O}_X}^\mathbf{L} f^!g^!\mathcal{O}_Z
\overset{\mu_{g \circ f}}{\longrightarrow} & f^!g^!K\end{array}
$$
commutes for all $K \in D^+_\QCoh(\mathcal{O}_Z)$.
\end{lemma}

\begin{proof}
\uses{duality-lemma-transitivity-compare-with-pullback, duality-lemma-shriek-well-defined, duality-lemma-twisted-inverse-image, duality-lemma-compare-on-open, duality-lemma-restriction-compare-with-pullback, duality-lemma-upper-shriek-composition}

If $f$ is proper, then $f^! = a$ and we can use
(\ref{equation-compare-with-pullback}) and if $g$ is also proper,
then Lemma \ref{duality-lemma-transitivity-compare-with-pullback} proves
...
we argue as in the proof of Lemma \ref{duality-lemma-shriek-well-defined}.
...
right adjoint for pushforward of Lemma \ref{duality-lemma-twisted-inverse-image}
...
$$
\begin{array}{ccc}Lg^*(L\overline{f}_2^*K \otimes^\mathbf{L}
\overline{a}_2(\mathcal{O}_Y))
\otimes^\mathbf{L} \overline{c}(\mathcal{O}_{\overline{X}_2})
\downarrow\underset{\sigma}{\longrightarrow} & \overline{c}(L\overline{f}_2^*K \otimes^\mathbf{L}
\overline{a}_2(\mathcal{O}_Y)) \longrightarrow & \overline{c}(\overline{a}_2(K)) \downarrow \\ L\overline{f}_1^*K \otimes^\mathbf{L} Lg^*\overline{a}_2(\mathcal{O}_Y)
\otimes^\mathbf{L} \overline{c}(\mathcal{O}_{\overline{X}_2})
\overset{1 \otimes \tau}{\longrightarrow} & L\overline{f}_1^*K \otimes^\mathbf{L} \overline{a}_1(\mathcal{O}_Y) \longrightarrow & \overline{a}_1(K)\end{array}
$$
by Lemma \ref{duality-lemma-transitivity-compare-with-pullback}. By
Lemma \ref{duality-lemma-compare-on-open} the maps $\sigma$ and $\tau$
restrict to an isomorphism over $X$. In fact, we can say more.
Recall that in the proof of Lemma \ref{duality-lemma-shriek-well-defined} we used
...
Lemma \ref{duality-lemma-restriction-compare-with-pullback}.
...
$$
\begin{array}{ccc}j_2^*\left(L\overline{f}_2^*K \otimes^\mathbf{L}
\overline{a}_2(\mathcal{O}_Y)\right) \longrightarrow\downarrow & j_2^*\overline{a}_2(K) &  \\ j_1^*L\overline{f}_1^*K \otimes^\mathbf{L} j_2^*\overline{a}_2(\mathcal{O}_Y) & j_1^*(L\overline{f}_1^*K \otimes^\mathbf{L} \overline{a}_1(\mathcal{O}_Y))
\longrightarrow\underset{1 \otimes \alpha_g}{\longleftarrow} & j_1^* \overline{a}_1(K) \underset{\alpha_g}{\nwarrow}\end{array}
$$
...
of Lemma \ref{duality-lemma-shriek-well-defined}. Some categorical arguments
exactly as in the proof of  Lemma \ref{duality-lemma-shriek-well-defined}
...
Lemma \ref{duality-lemma-upper-shriek-composition} using
$\overline{X} \to \overline{Y} \to Z$) and the result
of Lemma \ref{duality-lemma-transitivity-compare-with-pullback}
...
\begin{lemma}[Shriek open immersion]
\label{duality-lemma-shriek-open-immersion}
\source{stacks:0AU0}
\href{https://stacks.math.columbia.edu/tag/0AU0}{\texttt{Stacks tag 0AU0}}
\group{duality}

\uses{duality-situation-shriek}
In Situation \ref{duality-situation-shriek} let $Y$ be an object
...
we also have $f^* \cong f^!$, see Lemma \ref{duality-lemma-shriek-etale}.
...
\begin{lemma}[Restrict before or after]
\label{duality-lemma-restrict-before-or-after}
\source{stacks:0G4J}
\href{https://stacks.math.columbia.edu/tag/0G4J}{\texttt{Stacks tag 0G4J}}
\group{duality}

\uses{duality-situation-shriek}
In Situation \ref{duality-situation-shriek} let
$$
\begin{array}{cc}U \underset{j}{\longrightarrow}\underset{g}{\downarrow} & X \overset{f}{\downarrow} \\ V \overset{j'}{\longrightarrow} & Y\end{array}
$$
...
\begin{proof}
\uses{duality-lemma-upper-shriek-composition, duality-lemma-shriek-open-immersion}

Let $h = f \circ j = j' \circ g$. By
Lemma \ref{duality-lemma-upper-shriek-composition} we have
$h^! = j^! \circ f^! = g^! \circ (j')^!$. By
Lemma \ref{duality-lemma-shriek-open-immersion}
we have $j^! = j^*$ and $(j')^! = (j')^*$.
\end{proof}

\begin{lemma}[Shriek affine line]
\label{duality-lemma-shriek-affine-line}
\source{stacks:0AA1}
\href{https://stacks.math.columbia.edu/tag/0AA1}{\texttt{Stacks tag 0AA1}}
\group{duality}

\uses{duality-situation-shriek}
In Situation \ref{duality-situation-shriek} let $Y$ be an object of $\textit{FTS}_S$
...
\begin{proof}
\uses{duality-lemma-upper-shriek-P1, duality-lemma-compare-with-pullback-flat-proper-noetherian}

Since $X = \mathbf{A}^1_Y \subset \mathbf{P}^1_Y$
and since $\mathcal{O}_{\mathbf{P}^1_Y}(-2)|_X \cong \mathcal{O}_X$
this follows from Lemmas \ref{duality-lemma-upper-shriek-P1} and
\ref{duality-lemma-compare-with-pullback-flat-proper-noetherian}.
\end{proof}

\begin{lemma}[Shriek closed immersion]
\label{duality-lemma-shriek-closed-immersion}
\source{stacks:0AA2}
\href{https://stacks.math.columbia.edu/tag/0AA2}{\texttt{Stacks tag 0AA2}}
\group{duality}

\uses{duality-situation-shriek}
In Situation \ref{duality-situation-shriek} let $Y$ be an object of
...
\begin{proof}
\uses{duality-lemma-twisted-inverse-image-closed}

This is a restatement of Lemma \ref{duality-lemma-twisted-inverse-image-closed}.
\end{proof}
...
\source{stacks:0BV2}
\href{https://stacks.math.columbia.edu/tag/0BV2}{\texttt{Stacks tag 0BV2}}
\group{duality}

\uses{duality-situation-shriek, duality-lemma-upper-shriek-composition, duality-lemma-shriek-open-immersion, duality-lemma-shriek-affine-line, duality-lemma-sheaf-with-exact-support-quasi-coherent, duality-lemma-shriek-closed-immersion}
In Situation \ref{duality-situation-shriek} let $f : X \to Y$ be a morphism of
$\textit{FTS}_S$. Using the lemmas above we can compute
$f^!$ locally as follows. Suppose that we are given affine opens
$$
\begin{array}{cc}U \underset{j}{\longrightarrow}\underset{g}{\downarrow} & X \overset{f}{\downarrow} \\ V \overset{i}{\longrightarrow} & Y\end{array}
$$
Since $j^! \circ f^! = g^! \circ i^!$
(Lemma \ref{duality-lemma-upper-shriek-composition})
...
\mathbf{A}^1_V \to V
$$
Applying Lemma \ref{duality-lemma-shriek-affine-line} exactly $n$ times we see that
$(\mathbf{A}^n_V \to V)^!(E|_V)$ corresponds to
$K \otimes_R^\mathbf{L} P[n]$. By Lemmas
\ref{duality-lemma-sheaf-with-exact-support-quasi-coherent} and
\ref{duality-lemma-shriek-closed-immersion} the last step corresponds to
applying $R\Hom(A, -)$.
\end{remark}

\begin{lemma}[Shriek coherent]
\label{duality-lemma-shriek-coherent}
\source{stacks:0AU1}
\href{https://stacks.math.columbia.edu/tag/0AU1}{\texttt{Stacks tag 0AU1}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-shriek-affine-line, duality-lemma-sheaf-with-exact-support-coherent}
...
By Lemmas \ref{duality-lemma-shriek-affine-line} and
\ref{duality-lemma-sheaf-with-exact-support-coherent} and
Dualizing Complexes, Lemma
\ref{dualizing-lemma-dualizing-polynomial-ring}
and induction.
\end{proof}

\begin{lemma}[Shriek dualizing]
\label{duality-lemma-shriek-dualizing}
\source{stacks:0AA3}
\href{https://stacks.math.columbia.edu/tag/0AA3}{\texttt{Stacks tag 0AA3}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-shriek-affine-line, duality-lemma-sheaf-with-exact-support-quasi-coherent, duality-lemma-shriek-closed-immersion}
...
\mathbf{A}^1_Y \to Y
$$
where $i$ is a closed immersion. By Lemma \ref{duality-lemma-shriek-affine-line} and
...
and Lemmas
\ref{duality-lemma-sheaf-with-exact-support-quasi-coherent} and
\ref{duality-lemma-shriek-closed-immersion} we see that $i^!$
transforms dualizing complexes into dualizing complexes.
\end{proof}

\begin{lemma}[Shriek via duality]
\label{duality-lemma-shriek-via-duality}
\source{stacks:0AU2}
\href{https://stacks.math.columbia.edu/tag/0AU2}{\texttt{Stacks tag 0AU2}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-twisted-inverse-image, duality-lemma-dualizing-schemes}
...
The fifth equality by Lemma \ref{duality-lemma-dualizing-schemes}.
The final equality by definition of $a$.
Hence we see that $a(M) = D_{\overline{X}}(L\overline{f}^*D_Y(M))$
by Yoneda's lemma.
\end{proof}

\begin{lemma}[Perfect comparison shriek]
\label{duality-lemma-perfect-comparison-shriek}
\source{stacks:0B6U}
\href{https://stacks.math.columbia.edu/tag/0B6U}{\texttt{Stacks tag 0B6U}}
\group{duality}

\uses{duality-situation-shriek, duality-lemma-map-pullback-to-shriek-well-defined}
In Situation \ref{duality-situation-shriek} let $f : X \to Y$ be a morphism of
...
\to
f^!K$
of Lemma \ref{duality-lemma-map-pullback-to-shriek-well-defined}
is an isomorphism for all $K \in D_\QCoh^+(\mathcal{O}_Y)$.
\end{enumerate}
\end{lemma}

\begin{proof}
\uses{duality-remark-local-calculation-shriek, duality-lemma-shriek-coherent, duality-lemma-shriek-open-immersion, duality-lemma-compare-with-pullback-flat-proper-noetherian, duality-lemma-map-pullback-to-shriek-well-defined, duality-lemma-shriek-closed-immersion, duality-lemma-shriek-affine-line}
...
Then Remark \ref{duality-remark-local-calculation-shriek}
...
(Lemma \ref{duality-lemma-shriek-closed-immersion})
...
by repeated application of Lemma \ref{duality-lemma-shriek-affine-line}.
Finally, (e) is true because it holds for $\mathbf{P}^n_Y \to Y$
(flat and proper) and because $\mathbf{A}^n_Y \subset \mathbf{P}^n_Y$
is an open.
\end{proof}

\begin{lemma}[Flat shriek relatively perfect]
\label{duality-lemma-flat-shriek-relatively-perfect}
\source{stacks:0E9T}
\href{https://stacks.math.columbia.edu/tag/0E9T}{\texttt{Stacks tag 0E9T}}
\group{duality}
...
\begin{proof}
\uses{duality-remark-local-calculation-shriek}

Both assertions are local on $X$. Thus we may assume $X$ and $Y$ are
affine. Then Remark \ref{duality-remark-local-calculation-shriek}
...
\source{stacks:0B6V}
\href{https://stacks.math.columbia.edu/tag/0B6V}{\texttt{Stacks tag 0B6V}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-perfect-comparison-shriek, duality-lemma-shriek-affine-line, duality-lemma-compute-for-effective-Cartier}
...
By Lemma \ref{duality-lemma-perfect-comparison-shriek} it suffices to show
...
by Lemma \ref{duality-lemma-shriek-affine-line}. Thus it suffices to prove
...
Lemma \ref{duality-lemma-compute-for-effective-Cartier} and the proof is complete.
\end{proof}
...
Section \ref{duality-section-base-change-map} does not apply\footnote{
...
the proof of Lemma \ref{duality-lemma-base-change-shriek-flat}
...
Section \ref{duality-section-relative-dualizing-complexes}.
Namely, if the morphism $f$ is flat, then there is a good
notion of a relative dualizing complex and using
Lemmas \ref{duality-lemma-compactifyable-relative-dualizing}
...
\begin{lemma}[Base change shriek flat]
\label{duality-lemma-base-change-shriek-flat}
\source{stacks:0E9U}
\href{https://stacks.math.columbia.edu/tag/0E9U}{\texttt{Stacks tag 0E9U}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-twisted-inverse-image, duality-lemma-proper-noetherian, duality-remark-check-over-affines, duality-lemma-more-base-change}
...
of Lemma \ref{duality-lemma-twisted-inverse-image}
...
By Lemma \ref{duality-lemma-proper-noetherian} formation of $a$ and $a'$
commutes with restriction to affine opens of $Y$ and $Y'$.
Thus by Remark \ref{duality-remark-check-over-affines}
we may assume that $Y$ and $Y'$ are affine.
Thus the result by Lemma \ref{duality-lemma-more-base-change}.
\end{proof}

\begin{lemma}[Shriek etale]
\label{duality-lemma-shriek-etale}
\source{stacks:0FWI}
\href{https://stacks.math.columbia.edu/tag/0FWI}{\texttt{Stacks tag 0FWI}}
\group{duality}

\uses{duality-situation-shriek}
In Situation \ref{duality-situation-shriek} let $f : X \to Y$ be an \'etale
morphism of $\textit{FTS}_S$. Then $f^! \cong f^*$ as functors on
$D^+_\QCoh(\mathcal{O}_Y)$.
\end{lemma}

\begin{proof}
\uses{duality-lemma-perfect-comparison-shriek, duality-lemma-lci-shriek, duality-lemma-shriek-open-immersion, duality-lemma-upper-shriek-composition, duality-lemma-base-change-shriek-flat}
...
By Lemma \ref{duality-lemma-perfect-comparison-shriek} it suffices
to show $f^!\mathcal{O}_Y = \mathcal{O}_X$.
By Lemma \ref{duality-lemma-lci-shriek} we know that $f^!\mathcal{O}_Y$
is an invertible module. Consider the commutative diagram
$$
\begin{array}{cc}X \times_Y X \underset{p_2}{\longrightarrow}\underset{p_1}{\downarrow} & X \overset{f}{\downarrow} \\ X \overset{f}{\longrightarrow} & Y\end{array}
$$
...
Lemma \ref{duality-lemma-shriek-open-immersion} we have $\Delta^! = \Delta^*$.
By Lemma \ref{duality-lemma-upper-shriek-composition} we have
$\Delta^! \circ p_1^! \circ f^! = f^!$.
By Lemma \ref{duality-lemma-base-change-shriek-flat} applied to
...
Lemma \ref{duality-lemma-perfect-comparison-shriek} once more.
...
\source{stacks:0BZY}
\href{https://stacks.math.columbia.edu/tag/0BZY}{\texttt{Stacks tag 0BZY}}
\group{duality}
...
Remark \ref{duality-remark-local-calculation-shriek}
...
\begin{lemma}[Relative dualizing fibres]
\label{duality-lemma-relative-dualizing-fibres}
\source{stacks:0BZZ}
\href{https://stacks.math.columbia.edu/tag/0BZZ}{\texttt{Stacks tag 0BZZ}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-perfect-comparison-shriek, duality-lemma-base-change-locally, duality-lemma-shriek-dualizing}

The complex $\omega_{X/Y}^\bullet$ is in $D^b_{\textit{Coh}}$
by Lemma \ref{duality-lemma-perfect-comparison-shriek}.
Being a dualizing complex is a local property.
Hence by Lemma \ref{duality-lemma-base-change-locally}
it suffices to show that $(X_y \to y)^!\mathcal{O}_y$
is a dualizing complex on $X_y$.
This follows from Lemma \ref{duality-lemma-shriek-dualizing}.
\end{proof}
...
Definition \ref{duality-definition-dualizing-scheme}.
...
\ref{duality-lemma-shriek-via-duality}, and
\ref{duality-lemma-perfect-comparison-shriek} and
...
as in Situation \ref{duality-situation-dualizing}. This is similar to
\cite[Remark on page 310]{RD}.

\begin{definition}[Situation: Dualizing]
\label{duality-situation-dualizing}
\source{stacks:0AU4}
\href{https://stacks.math.columbia.edu/tag/0AU4}{\texttt{Stacks tag 0AU4}}
\group{duality}
...
In Situation \ref{duality-situation-dualizing} let $X$ be a scheme of finite type
over $S$. Let $\mathcal{U} : X = \bigcup_{i = 1, \ldots, n} U_i$
be a finite open covering of $X$ by objects of $\textit{FTS}_S$, see
Situation \ref{duality-situation-shriek}. All this means is that the morphisms
...
a dualizing complex on $U_i$, see Section \ref{duality-section-duality},
...
is given by restriction (Lemma \ref{duality-lemma-shriek-open-immersion})
and that we have canonical isomorphisms
$$
(U_i \cap U_j \to U_i)^! \circ p_i^! = p_{ij}^! =
(U_i \cap U_j \to U_j)^! \circ p_j^!
$$
by Lemma \ref{duality-lemma-upper-shriek-composition} and to get (3) we use
that the upper shriek functors form a pseudo functor by
Lemma \ref{duality-lemma-pseudo-functor}.
...
\begin{lemma}[Good dualizing unique]
\label{duality-lemma-good-dualizing-unique}
\source{stacks:0AU7}
\href{https://stacks.math.columbia.edu/tag/0AU7}{\texttt{Stacks tag 0AU7}}
\group{duality}

\uses{duality-situation-dualizing}
In Situation \ref{duality-situation-dualizing} let $X$ be a scheme of finite type
...
\begin{proof}
\uses{duality-lemma-dualizing-unique-schemes}

If $(K, \alpha_i)$ and $(K', \alpha_i')$ are two, then we consider
$L = R\SheafHom_{\mathcal{O}_X}(K, K')$.
By Lemma \ref{duality-lemma-dualizing-unique-schemes}
...
\begin{lemma}[Good dualizing independence covering]
\label{duality-lemma-good-dualizing-independence-covering}
\source{stacks:0AU8}
\href{https://stacks.math.columbia.edu/tag/0AU8}{\texttt{Stacks tag 0AU8}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-good-dualizing-unique}
...
By Lemma \ref{duality-lemma-good-dualizing-unique} we obtain a unique isomorphism
$$
...
\begin{lemma}[Existence good dualizing]
\label{duality-lemma-existence-good-dualizing}
\source{stacks:0AU9}
\href{https://stacks.math.columbia.edu/tag/0AU9}{\texttt{Stacks tag 0AU9}}
\group{duality}
...
Let $(S, \omega_S^\bullet)$ be as in Situation \ref{duality-situation-dualizing}.
...
complex on $U$, see Section \ref{duality-section-duality}. Moreover, if
...
Lemma \ref{duality-lemma-good-dualizing-unique},
existence for one open covering by
Lemma \ref{duality-lemma-existence-good-dualizing}, and
the fact that $K$ then works for all open coverings is
Lemma \ref{duality-lemma-good-dualizing-independence-covering}.

\begin{definition}[Good dualizing]
\label{duality-definition-good-dualizing}
\source{stacks:0AUA}
\href{https://stacks.math.columbia.edu/tag/0AUA}{\texttt{Stacks tag 0AUA}}
\group{duality}
...
\begin{lemma}[Good over both]
\label{duality-lemma-good-over-both}
\source{stacks:0AUB}
\href{https://stacks.math.columbia.edu/tag/0AUB}{\texttt{Stacks tag 0AUB}}
\group{duality}
...
\begin{lemma}[Open immersion good dualizing complex]
\label{duality-lemma-open-immersion-good-dualizing-complex}
\source{stacks:0AUC}
\href{https://stacks.math.columbia.edu/tag/0AUC}{\texttt{Stacks tag 0AUC}}
\group{duality}
...
\begin{proof}
\uses{duality-definition-good-dualizing}

Immediate from the construction of normalized dualizing complexes
given just above
Definition \ref{duality-definition-good-dualizing}.
\end{proof}

\begin{lemma}[Proper map good dualizing complex]
\label{duality-lemma-proper-map-good-dualizing-complex}
\source{stacks:0AUD}
\href{https://stacks.math.columbia.edu/tag/0AUD}{\texttt{Stacks tag 0AUD}}
\group{duality}

\uses{duality-situation-dualizing, duality-lemma-twisted-inverse-image}
Let $(S, \omega_S^\bullet)$ be as in Situation \ref{duality-situation-dualizing}.
...
\begin{proof}
\uses{duality-lemma-upper-shriek-composition, duality-lemma-good-over-both}
...
$f^! \circ q^! = p^!$ (Lemma \ref{duality-lemma-upper-shriek-composition}).
In the general case we first use Lemma \ref{duality-lemma-good-over-both}
...
as in Lemma \ref{duality-lemma-dualizing-schemes}.
Let $f : X \to Y$ be a morphism of finite type schemes over $S$.
Define
$$
...
\end{align*}
where the arrow is defined in Lemma \ref{duality-lemma-dualizing-schemes}.
We collect the results together in the following lemma.

\begin{lemma}[Duality bootstrap]
\label{duality-lemma-duality-bootstrap}
\source{stacks:0AUE}
\href{https://stacks.math.columbia.edu/tag/0AUE}{\texttt{Stacks tag 0AUE}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-dualizing-schemes, duality-lemma-twisted-inverse-image, duality-lemma-shriek-via-duality, duality-lemma-proper-map-good-dualizing-complex, duality-example-iso-on-RSheafHom-noetherian}

Let $f : X \to Y$, $g : Y \to Z$, $h : Z \to T$ be morphisms of schemes
of finite type over $S$. We have to show that
$$
\begin{array}{cc}(h \circ g \circ f)^!_{new} \longrightarrow\downarrow & f^!_{new} \circ (h \circ g)^!_{new} \downarrow \\ (g \circ f)^!_{new} \circ h^!_{new} \longrightarrow & f^!_{new} \circ g^!_{new} \circ h^!_{new}\end{array}
$$
is commutative. Let $\eta_Y : \text{id} \to D_Y^2$
and $\eta_Z : \text{id} \to D_Z^2$ be the canonical isomorphisms
of Lemma \ref{duality-lemma-dualizing-schemes}. Then, using
Categories, Lemma \ref{categories-lemma-properties-2-cat-cats},
...
Part (3) is Lemma \ref{duality-lemma-dualizing-schemes}.
Part (4) follows by the same argument as part (2).
Part (5) is the definition of $f^!_{new}$.

\medskip\noindent
Proof of (6). Let $a$ be the
right adjoint of Lemma \ref{duality-lemma-twisted-inverse-image} for the
...
Lemma \ref{duality-lemma-shriek-via-duality} to $f$ over $S$.
To get around this we use the canonical identification
$\omega_X^\bullet = a(\omega_Y^\bullet)$ of
Lemma \ref{duality-lemma-proper-map-good-dualizing-complex}.
Hence $f^!_{new}$ is the restriction of $a$ to
$D_{\textit{Coh}}^+(\mathcal{O}_Y)$ by Lemma \ref{duality-lemma-shriek-via-duality}
...
dualizing complexes and the already used Lemma \ref{duality-lemma-shriek-via-duality}.
\end{proof}

\begin{remark}[Independent omega S]
\label{duality-remark-independent-omega-S}
\source{stacks:0BV3}
\href{https://stacks.math.columbia.edu/tag/0BV3}{\texttt{Stacks tag 0BV3}}
\group{duality}

\uses{duality-lemma-dualizing-unique-schemes, duality-lemma-compare-with-pullback-perfect}
...
Lemma \ref{duality-lemma-dualizing-unique-schemes}.
...
by Lemma \ref{duality-lemma-compare-with-pullback-perfect}.
...
\begin{example}[Trace proper]
\label{duality-example-trace-proper}
\source{stacks:0B6X}
\href{https://stacks.math.columbia.edu/tag/0B6X}{\texttt{Stacks tag 0B6X}}
\group{duality}

\uses{duality-lemma-proper-map-good-dualizing-complex, duality-lemma-duality-bootstrap}
...
(Lemma \ref{duality-lemma-proper-map-good-dualizing-complex})
and hence the trace map (Section \ref{duality-section-trace}) is a canonical arrow
$$
\text{Tr}_f : Rf_*\omega_X^\bullet \longrightarrow \omega_Y^\bullet
$$
which produces the isomorphisms (Lemma \ref{duality-lemma-duality-bootstrap})
$$
...
\begin{remark}[Dualizing finite]
\label{duality-remark-dualizing-finite}
\source{stacks:0AX4}
\href{https://stacks.math.columbia.edu/tag/0AX4}{\texttt{Stacks tag 0AX4}}
\group{duality}

\uses{duality-lemma-finite-twisted, duality-lemma-proper-map-good-dualizing-complex, duality-example-trace-proper}
Let $S$ be a Noetherian scheme and let $\omega_S^\bullet$ be a dualizing
...
$$
in $D_\QCoh^+(f_*\mathcal{O}_X)$ by Lemmas \ref{duality-lemma-finite-twisted} and
\ref{duality-lemma-proper-map-good-dualizing-complex}
and the trace map of Example \ref{duality-example-trace-proper} is the map
$$
...
\begin{remark}[Relative dualizing complex shriek]
\label{duality-remark-relative-dualizing-complex-shriek}
\source{stacks:0B6W}
\href{https://stacks.math.columbia.edu/tag/0B6W}{\texttt{Stacks tag 0B6W}}
\group{duality}

\uses{duality-situation-dualizing, duality-remark-relative-dualizing-complex, duality-lemma-proper-map-good-dualizing-complex}
Let $f : X \to Y$ be a flat proper morphism of finite type
schemes over a pair $(S, \omega_S^\bullet)$ as in
Situation \ref{duality-situation-dualizing}. The relative dualizing complex
(Remark \ref{duality-remark-relative-dualizing-complex}) is
...
discussion in Remark \ref{duality-remark-relative-dualizing-complex}.
\end{remark}
...
\begin{lemma}[Good dualizing normalized]
\label{duality-lemma-good-dualizing-normalized}
\source{stacks:0AWL}
\href{https://stacks.math.columbia.edu/tag/0AWL}{\texttt{Stacks tag 0AWL}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-shriek-closed-immersion, duality-example-iso-on-RSheafHom-noetherian}
...
$$
\begin{array}{cc}x \underset{i_x}{\longrightarrow}\underset{\pi}{\downarrow} & X \overset{f}{\downarrow} \\ s \overset{i_s}{\longrightarrow} & S\end{array}
$$
By Morphisms, Lemma
...
$$
The first equality by Example \ref{duality-example-iso-on-RSheafHom-noetherian}
applied with $L = \kappa(x)[0]$. The second equality holds because
$\pi_*$ is exact.
Thus $\pi^!(\kappa(s)[0])$ is supported in degree $0$ and we win.
\end{proof}

\begin{lemma}[Good dualizing dimension function]
\label{duality-lemma-good-dualizing-dimension-function}
\source{stacks:0AWM}
\href{https://stacks.math.columbia.edu/tag/0AWM}{\texttt{Stacks tag 0AWM}}
\group{duality}

\uses{duality-lemma-dimension-function-scheme}
Let $S$ be a Noetherian scheme and let $\omega_S^\bullet$ be a
...
Lemma \ref{duality-lemma-dimension-function-scheme}.
\end{lemma}

\begin{proof}
\uses{duality-lemma-dimension-function-scheme, duality-lemma-good-dualizing-normalized}
...
Lemma \ref{duality-lemma-good-dualizing-normalized} to conclude.
\end{proof}

\begin{lemma}[Shriek]
\label{duality-lemma-shriek}
\source{stacks:0BV5}
\href{https://stacks.math.columbia.edu/tag/0BV5}{\texttt{Stacks tag 0BV5}}
\group{duality}
...
by Remark \ref{duality-remark-local-calculation-shriek}.
Thus the lemma follows from Dualizing Complexes, Lemma
\ref{dualizing-lemma-relative-dualizing-trivial-vanishing}.
\end{proof}

\begin{lemma}[Flat shriek]
\label{duality-lemma-flat-shriek}
\source{stacks:0BV6}
\href{https://stacks.math.columbia.edu/tag/0BV6}{\texttt{Stacks tag 0BV6}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-shriek}

Arguing exactly as in the proof of Lemma \ref{duality-lemma-shriek}
this follows from Dualizing Complexes, Lemma
\ref{dualizing-lemma-relative-dualizing-flat-vanishing}.
\end{proof}

\begin{lemma}[Shriek over CM]
\label{duality-lemma-shriek-over-CM}
\source{stacks:0E9V}
\href{https://stacks.math.columbia.edu/tag/0E9V}{\texttt{Stacks tag 0E9V}}
\group{duality}
...
Then arguing exactly as in the proof of Lemma \ref{duality-lemma-shriek}
this follows from Dualizing Complexes, Lemma
\ref{dualizing-lemma-relative-dualizing-CM-vanishing}.
\end{proof}

\begin{lemma}[Flat quasi finite shriek]
\label{duality-lemma-flat-quasi-finite-shriek}
\source{stacks:0BV7}
\href{https://stacks.math.columbia.edu/tag/0BV7}{\texttt{Stacks tag 0BV7}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-flat-shriek, duality-lemma-shriek-coherent}

Consequence of Lemma \ref{duality-lemma-flat-shriek} and the fact that the
cohomology sheaves of $f^!\mathcal{O}_Y$ are coherent by
Lemma \ref{duality-lemma-shriek-coherent}.
\end{proof}

\begin{lemma}[CM shriek]
\label{duality-lemma-CM-shriek}
\source{stacks:0BV8}
\href{https://stacks.math.columbia.edu/tag/0BV8}{\texttt{Stacks tag 0BV8}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-shriek-coherent, duality-lemma-flat-shriek, duality-lemma-flat-quasi-finite-shriek, duality-lemma-shriek-affine-line}
...
Lemma \ref{duality-lemma-shriek-coherent}.
We will get flatness of $\omega_{X/Y}$ from Lemma \ref{duality-lemma-flat-shriek}
...
result follows directly from Lemma \ref{duality-lemma-flat-quasi-finite-shriek}.
...
Then $f^! = g^! \circ p^!$. By Lemma \ref{duality-lemma-shriek-affine-line}
we see that $p^!\mathcal{O}_Y \cong \mathcal{O}_{\mathbf{A}^d_Y}[-d]$.
We conclude by the case $d = 0$.
\end{proof}

\begin{remark}[The same is true]
\label{duality-remark-the-same-is-true}
\source{stacks:0BV9}
\href{https://stacks.math.columbia.edu/tag/0BV9}{\texttt{Stacks tag 0BV9}}
\group{duality}

\uses{duality-lemma-shriek, duality-lemma-flat-shriek, duality-lemma-flat-quasi-finite-shriek, duality-lemma-CM-shriek, duality-lemma-duality-bootstrap}
...
\ref{duality-lemma-flat-quasi-finite-shriek}, and \ref{duality-lemma-CM-shriek}
...
and then $f^! = f_{new}^!$ by Lemma \ref{duality-lemma-duality-bootstrap}.
\end{remark}
...
\begin{example}[Proper over local]
\label{duality-example-proper-over-local}
\source{stacks:0AWI}
\href{https://stacks.math.columbia.edu/tag/0AWI}{\texttt{Stacks tag 0AWI}}
\group{duality}
...
\begin{example}[Equidimensional over field]
\label{duality-example-equidimensional-over-field}
\source{stacks:0AWJ}
\href{https://stacks.math.columbia.edu/tag/0AWJ}{\texttt{Stacks tag 0AWJ}}
\group{duality}

\uses{duality-lemma-duality-bootstrap, duality-example-proper-over-local}
...
Lemma \ref{duality-lemma-duality-bootstrap}. If $X$ is proper over $k$, then
this is a special case of Example \ref{duality-example-proper-over-local}.
\end{example}

\begin{lemma}[Dualizing module]
\label{duality-lemma-dualizing-module}
\source{stacks:0AWK}
\href{https://stacks.math.columbia.edu/tag/0AWK}{\texttt{Stacks tag 0AWK}}
\group{duality}
...
\begin{lemma}[Vanishing good dualizing]
\label{duality-lemma-vanishing-good-dualizing}
\source{stacks:0AWN}
\href{https://stacks.math.columbia.edu/tag/0AWN}{\texttt{Stacks tag 0AWN}}
\group{duality}

\uses{duality-example-proper-over-local}
Let $X/A$ with $\omega_X^\bullet$ and $\omega_X$ be as in
Example \ref{duality-example-proper-over-local}. Then
\begin{enumerate}
...
\begin{proof}
\uses{duality-lemma-good-dualizing-dimension-function, duality-lemma-dualizing-module}

Let $\delta_X$ and $\delta_S$ be the dimension functions associated to
$\omega_X^\bullet$ and $\omega_S^\bullet$ as in
Lemma \ref{duality-lemma-good-dualizing-dimension-function}.
...
Lemma \ref{duality-lemma-dualizing-module}.
\end{proof}

\begin{lemma}[Dualizing module proper over A]
\label{duality-lemma-dualizing-module-proper-over-A}
\source{stacks:0AWP}
\href{https://stacks.math.columbia.edu/tag/0AWP}{\texttt{Stacks tag 0AWP}}
\group{duality}

\uses{duality-example-proper-over-local}
Let $X/A$ with dualizing module $\omega_X$ be as in
Example \ref{duality-example-proper-over-local}.
...
\begin{proof}
\uses{duality-lemma-vanishing-good-dualizing, duality-lemma-twisted-inverse-image}
...
$i < -\dim(X)$, see Lemma \ref{duality-lemma-vanishing-good-dualizing} and
...
right adjoint of Lemma \ref{duality-lemma-twisted-inverse-image} for
$f$, see Section \ref{duality-section-duality}.
...
\begin{lemma}[Dualizing module CM scheme]
\label{duality-lemma-dualizing-module-CM-scheme}
\source{stacks:0AWT}
\href{https://stacks.math.columbia.edu/tag/0AWT}{\texttt{Stacks tag 0AWT}}
\group{duality}
...
\begin{lemma}[Has dualizing module CM scheme]
\label{duality-lemma-has-dualizing-module-CM-scheme}
\source{stacks:0AWU}
\href{https://stacks.math.columbia.edu/tag/0AWU}{\texttt{Stacks tag 0AWU}}
\group{duality}
...
\begin{lemma}[Affine flat Noetherian CM]
\label{duality-lemma-affine-flat-Noetherian-CM}
\source{stacks:0C0Z}
\href{https://stacks.math.columbia.edu/tag/0C0Z}{\texttt{Stacks tag 0C0Z}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-CM-shriek, duality-lemma-flat-shriek, duality-lemma-relative-dualizing-fibres, duality-lemma-dualizing-module-CM-scheme}

One direction of the lemma follows from Lemma \ref{duality-lemma-CM-shriek}.
...
Hence by Lemma \ref{duality-lemma-CM-shriek} we see that
...
is flat over $Y$ by Lemma \ref{duality-lemma-flat-shriek}.
...
Lemma \ref{duality-lemma-relative-dualizing-fibres}.
Hence $X_y$ is Cohen-Macaulay by
Lemma \ref{duality-lemma-dualizing-module-CM-scheme}.
This proves $f$ is Cohen-Macaulay at $x$ as desired.
\end{proof}

\begin{remark}[CM morphism compare dualizing]
\label{duality-remark-CM-morphism-compare-dualizing}
\source{stacks:0C10}
\href{https://stacks.math.columbia.edu/tag/0C10}{\texttt{Stacks tag 0C10}}
\group{duality}

\uses{duality-situation-shriek, duality-lemma-CM-shriek, duality-lemma-perfect-comparison-shriek}
In Situation \ref{duality-situation-shriek} let $f : X \to Y$ be a morphism
...
Lemma \ref{duality-lemma-CM-shriek}.
Then there is a canonical isomorphism
$$
f^!K = Lf^*K \otimes_{\mathcal{O}_X}^\mathbf{L} \omega_{X/Y}[d]
$$
for $K \in D^+_\QCoh(\mathcal{O}_Y)$, see
Lemma \ref{duality-lemma-perfect-comparison-shriek}. In particular, if
...
$\omega_S^\bullet$ as in Section \ref{duality-section-glue}.
\end{remark}
...
\source{stacks:0AWW}
\href{https://stacks.math.columbia.edu/tag/0AWW}{\texttt{Stacks tag 0AWW}}
\group{duality}
...
\source{stacks:0C00}
\href{https://stacks.math.columbia.edu/tag/0C00}{\texttt{Stacks tag 0C00}}
\group{duality}
...
\source{stacks:0DWG}
\href{https://stacks.math.columbia.edu/tag/0DWG}{\texttt{Stacks tag 0DWG}}
\group{duality}
...
\source{stacks:0BFQ}
\href{https://stacks.math.columbia.edu/tag/0BFQ}{\texttt{Stacks tag 0BFQ}}
\group{duality}
...
\source{stacks:0BVA}
\href{https://stacks.math.columbia.edu/tag/0BVA}{\texttt{Stacks tag 0BVA}}
\group{duality}
...
\begin{lemma}[Gorenstein local syntomic]
\label{duality-lemma-gorenstein-local-syntomic}
\source{stacks:0C01}
\href{https://stacks.math.columbia.edu/tag/0C01}{\texttt{Stacks tag 0C01}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-gorenstein-lci}
...
each $S_i$ is Gorenstein by Lemma \ref{duality-lemma-gorenstein-lci}.
...
\begin{lemma}[Gorenstein base change]
\label{duality-lemma-gorenstein-base-change}
\source{stacks:0C03}
\href{https://stacks.math.columbia.edu/tag/0C03}{\texttt{Stacks tag 0C03}}
\group{duality}
...
\begin{definition}[Gorenstein morphism]
\label{duality-definition-gorenstein-morphism}
\source{stacks:0C04}
\href{https://stacks.math.columbia.edu/tag/0C04}{\texttt{Stacks tag 0C04}}
\group{duality}
...
\begin{lemma}[Gorenstein morphism]
\label{duality-lemma-gorenstein-morphism}
\source{stacks:0C05}
\href{https://stacks.math.columbia.edu/tag/0C05}{\texttt{Stacks tag 0C05}}
\group{duality}
...
\begin{lemma}[Gorenstein CM morphism]
\label{duality-lemma-gorenstein-CM-morphism}
\source{stacks:0C06}
\href{https://stacks.math.columbia.edu/tag/0C06}{\texttt{Stacks tag 0C06}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-gorenstein-CM}

Follows from Lemma \ref{duality-lemma-gorenstein-CM} and the definitions.
\end{proof}

\begin{lemma}[Lci gorenstein]
\label{duality-lemma-lci-gorenstein}
\source{stacks:0C15}
\href{https://stacks.math.columbia.edu/tag/0C15}{\texttt{Stacks tag 0C15}}
\group{duality}
...
by Lemma \ref{duality-lemma-gorenstein-lci} we conclude.
The properties ``syntomic'' and ``flat and local
complete intersection morphism'' are equivalent by
More on Morphisms, Lemma \ref{more-morphisms-lemma-flat-lci}.
\end{proof}

\begin{lemma}[Composition gorenstein]
\label{duality-lemma-composition-gorenstein}
\source{stacks:0C11}
\href{https://stacks.math.columbia.edu/tag/0C11}{\texttt{Stacks tag 0C11}}
\group{duality}
...
\begin{lemma}[Gorensteinnes of the total space of a flat fibration implies same for base and fibres]
\label{duality-lemma-flat-morphism-from-gorenstein-scheme}
\source{stacks:0C12}
\href{https://stacks.math.columbia.edu/tag/0C12}{\texttt{Stacks tag 0C12}}
\group{duality}
...
\begin{lemma}[Base change gorenstein]
\label{duality-lemma-base-change-gorenstein}
\source{stacks:0C07}
\href{https://stacks.math.columbia.edu/tag/0C07}{\texttt{Stacks tag 0C07}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-gorenstein-base-change}
...
$$
\begin{array}{cc}\mathcal{O}_{X', x'} & \mathcal{O}_{X, x} \longleftarrow \\ \mathcal{O}_{Y', y'} \uparrow & \mathcal{O}_{Y, y} \longleftarrow\uparrow\end{array}
$$
...
is Gorenstein, see
Lemma \ref{duality-lemma-gorenstein-base-change}. Hence we see that $f'$
is Gorenstein at $x'$.
...
\begin{lemma}[Flat lft base change gorenstein]
\label{duality-lemma-flat-lft-base-change-gorenstein}
\source{stacks:0E0Q}
\href{https://stacks.math.columbia.edu/tag/0E0Q}{\texttt{Stacks tag 0E0Q}}
\group{duality}
...
\begin{lemma}[Affine flat Noetherian gorenstein]
\label{duality-lemma-affine-flat-Noetherian-gorenstein}
\source{stacks:0C08}
\href{https://stacks.math.columbia.edu/tag/0C08}{\texttt{Stacks tag 0C08}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-relative-dualizing-fibres, duality-lemma-gorenstein}
...
Lemma \ref{duality-lemma-gorenstein}.
...
\begin{lemma}[Flat finite presentation characterize gorenstein]
\label{duality-lemma-flat-finite-presentation-characterize-gorenstein}
\source{stacks:0C09}
\href{https://stacks.math.columbia.edu/tag/0C09}{\texttt{Stacks tag 0C09}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-base-change-gorenstein, duality-lemma-upper-shriek-composition, duality-lemma-shriek-affine-line, duality-lemma-affine-flat-Noetherian-gorenstein}
...
Lemma \ref{duality-lemma-base-change-gorenstein}.
...
(Lemmas \ref{duality-lemma-upper-shriek-composition} and
\ref{duality-lemma-shriek-affine-line}).
Hence the equivalence of (a), (b), and (c) by
Lemma \ref{duality-lemma-affine-flat-Noetherian-gorenstein}.
\end{proof}

\begin{lemma}[Gorenstein local source and target]
\label{duality-lemma-gorenstein-local-source-and-target}
\source{stacks:0C0A}
\href{https://stacks.math.columbia.edu/tag/0C0A}{\texttt{Stacks tag 0C0A}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-gorenstein-base-change, duality-lemma-gorenstein-local-syntomic}
...
Lemma \ref{duality-lemma-gorenstein-base-change}.
...
Lemma \ref{duality-lemma-gorenstein-local-syntomic}.
\end{proof}
...
\source{stacks:0E4N}
\href{https://stacks.math.columbia.edu/tag/0E4N}{\texttt{Stacks tag 0E4N}}
\group{duality}
...
\begin{lemma}[Duality proper over field]
\label{duality-lemma-duality-proper-over-field}
\source{stacks:0FVV}
\href{https://stacks.math.columbia.edu/tag/0FVV}{\texttt{Stacks tag 0FVV}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-twisted-inverse-image, duality-remark-relative-dualizing-complex, duality-lemma-shriek-dualizing, duality-example-proper-over-local, duality-example-equidimensional-over-field, duality-lemma-vanishing-good-dualizing, duality-lemma-good-dualizing-normalized, duality-lemma-dualizing-module-proper-over-A, duality-lemma-smooth-proper}

Denote $f : X \to \Spec(k)$ the structure morphism. Let $a$ be the
right adjoint of pushforward of this morphism, see
Lemma \ref{duality-lemma-twisted-inverse-image}. Consider the relative dualizing
complex
$$
\omega_X^\bullet = a(\mathcal{O}_{\Spec(k)})
$$
Compare with Remark \ref{duality-remark-relative-dualizing-complex}.
Since $f$ is proper we have
$f^!(\mathcal{O}_{\Spec(k)}) = a(\mathcal{O}_{\Spec(k)})$ by
definition, see Section \ref{duality-section-upper-shriek}.
Applying Lemma \ref{duality-lemma-shriek-dualizing} we find that
$\omega_X^\bullet$ is a dualizing complex. Moreover, we see that
$\omega_X^\bullet$ and $\omega_X$ are as in
Example \ref{duality-example-proper-over-local} and as in
Example \ref{duality-example-equidimensional-over-field}.

\medskip\noindent
Parts (1), (2), and (3) follow from
Lemma \ref{duality-lemma-vanishing-good-dualizing}.

\medskip\noindent
For a closed point $x \in X$ we see that $\omega_{X, x}^\bullet$ is a
normalized dualizing complex over $\mathcal{O}_{X, x}$, see
Lemma \ref{duality-lemma-good-dualizing-normalized}.
...
\medskip\noindent
Part (6) follows from Lemma \ref{duality-lemma-dualizing-module-proper-over-A}
for coherent $\mathcal{F}$ and in general by unwinding
(5) for $K = \mathcal{F}[0]$ and $i = -\dim(X)$.

\medskip\noindent
Part (7) follows from Lemma \ref{duality-lemma-smooth-proper}.
\end{proof}

\begin{remark}[Duality proper over field]
\label{duality-remark-duality-proper-over-field}
\source{stacks:0FVW}
\href{https://stacks.math.columbia.edu/tag/0FVW}{\texttt{Stacks tag 0FVW}}
\group{duality}

\uses{duality-lemma-duality-proper-over-field}
Let $k$, $X$, and $\omega_X^\bullet$
be as in Lemma \ref{duality-lemma-duality-proper-over-field}.
...
\begin{remark}[Coherent duality proper over field]
\label{duality-remark-coherent-duality-proper-over-field}
\source{stacks:0FVX}
\href{https://stacks.math.columbia.edu/tag/0FVX}{\texttt{Stacks tag 0FVX}}
\group{duality}

\uses{duality-remark-duality-proper-over-field}
We continue the discussion in Remark \ref{duality-remark-duality-proper-over-field}
...
\begin{lemma}[Duality proper over field perfect]
\label{duality-lemma-duality-proper-over-field-perfect}
\source{stacks:0FVY}
\href{https://stacks.math.columbia.edu/tag/0FVY}{\texttt{Stacks tag 0FVY}}
\group{duality}

\uses{duality-lemma-duality-proper-over-field, duality-remark-duality-proper-over-field}
Let $k$, $X$, and $\omega_X^\bullet$
be as in Lemma \ref{duality-lemma-duality-proper-over-field}.
Let $t : H^0(X, \omega_X^\bullet) \to k$ be as in
Remark \ref{duality-remark-duality-proper-over-field}.
...
in Remark \ref{duality-remark-duality-proper-over-field}
whence the result by the discussion in that remark.
\end{proof}

\begin{lemma}[Duality proper over field CM]
\label{duality-lemma-duality-proper-over-field-CM}
\source{stacks:0FVZ}
\href{https://stacks.math.columbia.edu/tag/0FVZ}{\texttt{Stacks tag 0FVZ}}
\group{duality}

\uses{duality-lemma-duality-proper-over-field}
Let $X$ be a proper scheme over a field $k$ which is Cohen-Macaulay
and equidimensional of dimension $d$. The module $\omega_X$
of Lemma \ref{duality-lemma-duality-proper-over-field} has the following properties
\begin{enumerate}
\item $\omega_X$ is a dualizing module on $X$
(Section \ref{duality-section-dualizing-module}),
...
\begin{proof}
\uses{duality-lemma-duality-proper-over-field, duality-lemma-dualizing-module-CM-scheme}

It is clear from Lemma \ref{duality-lemma-duality-proper-over-field}
...
as $X$ is Cohen-Macualay, see Lemma \ref{duality-lemma-dualizing-module-CM-scheme}.
The other statements follow from this combined with the
corresponding statements of Lemma \ref{duality-lemma-duality-proper-over-field}.
\end{proof}

\begin{remark}[Rework duality locally free CM]
\label{duality-remark-rework-duality-locally-free-CM}
\source{stacks:0FW0}
\href{https://stacks.math.columbia.edu/tag/0FW0}{\texttt{Stacks tag 0FW0}}
\group{duality}

\uses{duality-lemma-duality-proper-over-field, duality-lemma-duality-proper-over-field-CM, duality-remark-duality-proper-over-field, duality-lemma-duality-proper-over-field-perfect}
...
Lemma \ref{duality-lemma-duality-proper-over-field}.
By Lemma \ref{duality-lemma-duality-proper-over-field-CM}
...
This is a special case of Lemma \ref{duality-lemma-duality-proper-over-field-perfect}.
\end{remark}

Here is a sanity check for the dualizing complex.

\begin{lemma}[Sanity check duality]
\label{duality-lemma-sanity-check-duality}
\source{stacks:0FW1}
\href{https://stacks.math.columbia.edu/tag/0FW1}{\texttt{Stacks tag 0FW1}}
\group{duality}

\uses{duality-lemma-duality-proper-over-field}
Let $X$ be a proper scheme over a field $k$. Let $\omega_X^\bullet$ and
$\omega_X$ be as in Lemma \ref{duality-lemma-duality-proper-over-field}.
\begin{enumerate}
\item If $X \to \Spec(k)$ factors as $X \to \Spec(k') \to \Spec(k)$
for some field $k'$, then $\omega_X^\bullet$ and $\omega_X$
are as in Lemma \ref{duality-lemma-duality-proper-over-field} for the morphism
$X \to \Spec(k')$.
...
\begin{proof}
\uses{duality-lemma-duality-proper-over-field, duality-lemma-twisted-inverse-image, duality-example-affine-twisted-inverse-image, duality-lemma-more-base-change, duality-remark-relative-dualizing-complex}

Denote $f : X \to \Spec(k)$ the structure morphism and denote
$f' : X \to \Spec(k')$ the given factorization.
In the proof of Lemma \ref{duality-lemma-duality-proper-over-field}
we took $\omega_X^\bullet = a(\mathcal{O}_{\Spec(k)})$
where $a$ be is the right adjoint of
Lemma \ref{duality-lemma-twisted-inverse-image} for $f$.
...
$k'$-modules, see Example \ref{duality-example-affine-twisted-inverse-image}.
...
Lemma \ref{duality-lemma-more-base-change}. See discussion in
Remark \ref{duality-remark-relative-dualizing-complex}.
\end{proof}
...
Remark \ref{duality-remark-relative-dualizing-complex} and
Lemma \ref{duality-lemma-van-den-bergh}. For a separated and finite type
...
\source{stacks:0E2T}
\href{https://stacks.math.columbia.edu/tag/0E2T}{\texttt{Stacks tag 0E2T}}
\group{duality}
...
By Lemma \ref{duality-lemma-sheaf-with-exact-support-ext} condition (2)
...
\begin{lemma}[Relative dualizing complex algebra]
\label{duality-lemma-relative-dualizing-complex-algebra}
\source{stacks:0E2U}
\href{https://stacks.math.columbia.edu/tag/0E2U}{\texttt{Stacks tag 0E2U}}
\group{duality}
...
$$
\begin{array}{cc}\Spec(A) \downarrow\longrightarrow & X \downarrow \\ \Spec(R) \longrightarrow & S\end{array}
$$
...
\source{stacks:0E2V}
\href{https://stacks.math.columbia.edu/tag/0E2V}{\texttt{Stacks tag 0E2V}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-relative-dualizing-complex-algebra}

Looking affine locally this reduces using
Lemma \ref{duality-lemma-relative-dualizing-complex-algebra}
...
\source{stacks:0E2W}
\href{https://stacks.math.columbia.edu/tag/0E2W}{\texttt{Stacks tag 0E2W}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-relative-dualizing-complex-algebra, duality-lemma-relative-dualizing-RHom}

Let $U \subset X$ be an affine open mapping into an
affine open of $S$. Then there is an isomorphism
$K|_U \to L|_U$ by Lemma \ref{duality-lemma-relative-dualizing-complex-algebra} and
Dualizing Complexes, Lemma
...
$K$ is $H^0(X, \mathcal{O}_X^*)$ by Lemma \ref{duality-lemma-relative-dualizing-RHom}
...
and any open $U$ of $X$ by Lemma \ref{duality-lemma-relative-dualizing-RHom}.
...
\begin{lemma}[Existence relative dualizing]
\label{duality-lemma-existence-relative-dualizing}
\source{stacks:0E2X}
\href{https://stacks.math.columbia.edu/tag/0E2X}{\texttt{Stacks tag 0E2X}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-relative-dualizing-complex-algebra, duality-lemma-uniqueness-relative-dualizing, duality-lemma-relative-dualizing-RHom, duality-definition-relative-dualizing-complex}
...
to $\xi_{U'}$ by Lemma \ref{duality-lemma-uniqueness-relative-dualizing}
...
for $U \in \mathcal{B}$ by Lemma \ref{duality-lemma-relative-dualizing-RHom}
...
Definition \ref{duality-definition-relative-dualizing-complex}.
\end{proof}

\begin{lemma}[Base change relative dualizing]
\label{duality-lemma-base-change-relative-dualizing}
\source{stacks:0E2Y}
\href{https://stacks.math.columbia.edu/tag/0E2Y}{\texttt{Stacks tag 0E2Y}}
\group{duality}
...
Consider the cartesian square
$$
\begin{array}{cc}X' \underset{\Delta_{X'/S'}}{\downarrow}\longrightarrow & X \overset{\Delta_{X/S}}{\downarrow} \\ X' \times_{S'} X' \overset{g' \times g'}{\longrightarrow} & X \times_S X\end{array}
$$
...
\begin{lemma}[Flat proper relative dualizing]
\label{duality-lemma-flat-proper-relative-dualizing}
\source{stacks:0E2Z}
\href{https://stacks.math.columbia.edu/tag/0E2Z}{\texttt{Stacks tag 0E2Z}}
\group{duality}

\uses{duality-remark-relative-dualizing-complex, duality-definition-relative-dualizing-complex}
...
\begin{proof}
\uses{duality-lemma-properties-relative-dualizing, duality-lemma-twisted-inverse-image, duality-lemma-twisted-inverse-image-closed, duality-lemma-sheaf-with-exact-support-ext}

In Lemma \ref{duality-lemma-properties-relative-dualizing} we proved that
...
Lemmas \ref{duality-lemma-twisted-inverse-image-closed} and
\ref{duality-lemma-sheaf-with-exact-support-ext}.
This finishes the proof.
\end{proof}

\begin{remark}[Relative dualizing complex bis]
\label{duality-remark-relative-dualizing-complex-bis}
\source{stacks:0E4P}
\href{https://stacks.math.columbia.edu/tag/0E4P}{\texttt{Stacks tag 0E4P}}
\group{duality}

\uses{duality-lemma-existence-relative-dualizing, duality-definition-relative-dualizing-complex, duality-lemma-base-change-relative-dualizing, duality-remark-relative-dualizing-complex, duality-lemma-flat-proper-relative-dualizing, duality-lemma-uniqueness-relative-dualizing, duality-lemma-proper-flat-base-change}
Let $X \to S$ be a morphism of schemes which is flat, proper, and
of finite presentation. By Lemma \ref{duality-lemma-existence-relative-dualizing}
there exists a relative dualizing complex $(\omega_{X/S}^\bullet, \xi)$
in the sense of Definition \ref{duality-definition-relative-dualizing-complex}.
Consider any morphism $g : S' \to S$ where $S'$ is quasi-compact and
quasi-separated (for example an affine open of $S$).
By Lemma \ref{duality-lemma-base-change-relative-dualizing}
...
for $X' \to S'$ in the sense of Remark \ref{duality-remark-relative-dualizing-complex}.
Combining Lemmas \ref{duality-lemma-flat-proper-relative-dualizing} and
\ref{duality-lemma-uniqueness-relative-dualizing}
...
and the base change isomorphisms of Lemma \ref{duality-lemma-proper-flat-base-change}
(if we ever need this compatibility we will carefully state and prove
it here).
\end{remark}

\begin{lemma}[Compactifyable relative dualizing]
\label{duality-lemma-compactifyable-relative-dualizing}
\source{stacks:0E9W}
\href{https://stacks.math.columbia.edu/tag/0E9W}{\texttt{Stacks tag 0E9W}}
\group{duality}

\uses{duality-situation-shriek, duality-definition-relative-dualizing-complex}
In Situation \ref{duality-situation-shriek} let $f : X \to Y$
...
\begin{proof}
\uses{duality-lemma-flat-shriek-relatively-perfect, duality-lemma-twisted-inverse-image-closed, duality-lemma-sheaf-with-exact-support-ext, duality-lemma-base-change-shriek-flat}

By Lemma \ref{duality-lemma-flat-shriek-relatively-perfect}
...
Lemma \ref{duality-lemma-base-change-shriek-flat}.
\end{proof}

\begin{lemma}[Relative dualizing composition]
\label{duality-lemma-relative-dualizing-composition}
\source{stacks:0E30}
\href{https://stacks.math.columbia.edu/tag/0E30}{\texttt{Stacks tag 0E30}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-relative-dualizing-complex-algebra, duality-lemma-sheaf-with-exact-support-internal-home, duality-lemma-sheaf-with-exact-support-tensor, duality-lemma-flat-bc-sheaf-with-exact-support}

Using Lemma \ref{duality-lemma-relative-dualizing-complex-algebra}
...
$$
\begin{array}{cccc} &  & Y \xlongequal{} & Y \overset{f}{\downarrow} \\ Y \underset{\Delta_{Y/X}}{\longrightarrow} & Y \times_X Y \underset{m}{\downarrow}\underset{\delta}{\longrightarrow}\underset{q}{\nearrow} & Y \times_S Y \overset{f \times f}{\downarrow}\underset{p}{\nearrow} & X \\  & X \overset{\Delta_{X/S}}{\longrightarrow} & X \times_S X \underset{r}{\nearrow} & \end{array}
$$
where $p$, $q$, $r$ are the first projections.
By Lemma \ref{duality-lemma-sheaf-with-exact-support-internal-home}
we have
$$
...
$$
By Lemma \ref{duality-lemma-sheaf-with-exact-support-tensor} we have
$$
...
$$
By Lemma \ref{duality-lemma-flat-bc-sheaf-with-exact-support} we have
$$
R\SheafHom(\mathcal{O}_{Y \times_X Y}, L(f \times f)^*Lr^*K) =
...
$$
\begin{array}{cccc} &  & Y \xlongequal{} & Y \overset{f}{\downarrow} \\ Y \underset{\Delta'}{\longrightarrow} & V \underset{m}{\downarrow}\underset{\delta}{\longrightarrow}\underset{q}{\nearrow} & W' \overset{f \times f}{\downarrow}\underset{p}{\nearrow} & X \\  & X \overset{\Delta}{\longrightarrow} & W \underset{r}{\nearrow} & \end{array}
$$
...
Section \ref{duality-section-examples}. Thus our result will suffer
from the same kind of non-uniqueness as we have in that section.

\begin{lemma}[Determinant]
\label{duality-lemma-determinant}
\source{stacks:0E9Y}
\href{https://stacks.math.columbia.edu/tag/0E9Y}{\texttt{Stacks tag 0E9Y}}
\group{duality}
...
\begin{lemma}[Fundamental class lci]
\label{duality-lemma-fundamental-class-lci}
\source{stacks:0E9Z}
\href{https://stacks.math.columbia.edu/tag/0E9Z}{\texttt{Stacks tag 0E9Z}}
\group{duality}

\uses{duality-lemma-lci-shriek}
...
Lemma \ref{duality-lemma-lci-shriek}.
Then there is a map
$$
...
\begin{proof}
\uses{duality-lemma-smooth-proper, duality-lemma-regular-immersion, duality-lemma-perfect-comparison-shriek, duality-lemma-determinant}

The assumption implies that $X$ is compactifiable over $Y$ hence $f^!$
is defined, see Section \ref{duality-section-upper-shriek}.
...
Lemma \ref{duality-lemma-smooth-proper} where $d$ is the locally
...
the Koszul-regular immersion $i$, see Lemma \ref{duality-lemma-regular-immersion}.
...
$$
where we have also used Lemma \ref{duality-lemma-perfect-comparison-shriek}.
...
We obtain our map by an application of Lemma \ref{duality-lemma-determinant}.

\medskip\noindent
If $f$ is smooth at $x$, then the map is an isomorphism by an application of
Lemma \ref{duality-lemma-determinant}
...
\begin{lemma}[Fundamental class almost lci]
\label{duality-lemma-fundamental-class-almost-lci}
\source{stacks:0EA0}
\href{https://stacks.math.columbia.edu/tag/0EA0}{\texttt{Stacks tag 0EA0}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-fundamental-class-lci, duality-lemma-shriek-over-CM}
...
intersection morphism). By Lemma \ref{duality-lemma-shriek-over-CM}
...
\source{stacks:0G2H}
\href{https://stacks.math.columbia.edu/tag/0G2H}{\texttt{Stacks tag 0G2H}}
\group{duality}
...
$$
\begin{array}{ccccc}\ldots \longrightarrow & \colim \Hom_X(K_n, L) \longrightarrow\downarrow & \colim \Hom_X(K_n, M) \longrightarrow\downarrow & \colim \Hom_X(K_n, N) \longrightarrow\downarrow & \ldots \\ \ldots \longrightarrow & \Hom_U(K, L|_U) \longrightarrow & \Hom_U(K, M|_U) \longrightarrow & \Hom_U(K, N|_U) \longrightarrow & \ldots\end{array}
$$
...
$$
\begin{array}{ccc}\colim \Ext^{i - 1}_X(\mathcal{I}^n\mathcal{F}'', \mathcal{G})
\longrightarrow\downarrow & \colim \Ext^{i - 1}_X(\mathcal{F}' \cap \mathcal{I}^n\mathcal{F}'', \mathcal{G})
\longrightarrow\downarrow & \colim \Ext^i_X(\mathcal{I}^n\mathcal{F}, \mathcal{G})
\downarrow \\ \Ext^{i - 1}_U(\mathcal{F}''|_U, \mathcal{G}|_U) \longrightarrow & \Ext^{i - 1}_U(\mathcal{F}'|_U, \mathcal{G}|_U) \longrightarrow & \Ext^{i - 1}_U(\mathcal{F}|_U, \mathcal{G}|_U)\end{array}
$$
...
\begin{lemma}[Lift map plus]
\label{duality-lemma-lift-map-plus}
\source{stacks:0G4K}
\href{https://stacks.math.columbia.edu/tag/0G4K}{\texttt{Stacks tag 0G4K}}
\group{duality}

\uses{duality-lemma-lift-map}
The result of Lemma \ref{duality-lemma-lift-map} holds even for
...
\source{stacks:0G4L}
\href{https://stacks.math.columbia.edu/tag/0G4L}{\texttt{Stacks tag 0G4L}}
\group{duality}
...
Part (1) is an immediate consequence of Lemma \ref{duality-lemma-lift-map}
...
\begin{lemma}[Extension by zero triangle]
\label{duality-lemma-extension-by-zero-triangle}
\source{stacks:0G4M}
\href{https://stacks.math.columbia.edu/tag/0G4M}{\texttt{Stacks tag 0G4M}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-extension-by-zero, duality-lemma-lift-map}

Let $(K_n)$ be as in Lemma \ref{duality-lemma-extension-by-zero} part (2).
Choose an object $L'$ of $D^b_{\textit{Coh}}(\mathcal{O}_X)$
whose restriction to $U$ is $L$ (we can do this as the lemma shows).
By Lemma \ref{duality-lemma-lift-map} we can find an $n$ and a morphism
...
\begin{remark}[Extension by zero]
\label{duality-remark-extension-by-zero}
\source{stacks:0G4N}
\href{https://stacks.math.columbia.edu/tag/0G4N}{\texttt{Stacks tag 0G4N}}
\group{duality}

\uses{duality-lemma-extension-by-zero-triangle, duality-lemma-lift-map}
Let $j : U \to X$ be an open immersion of Noetherian schemes.
...
$$
which is ``exact'' by Lemma \ref{duality-lemma-extension-by-zero-triangle} and
which is
``left adjoint'' to the functor
$j^* : D^b_{\textit{Coh}}(\mathcal{O}_X) \to
D^b_{\textit{Coh}}(\mathcal{O}_U)$ by Lemma \ref{duality-lemma-lift-map}.
\end{remark}

\begin{remark}[Extension by zero linear pro system]
\label{duality-remark-extension-by-zero-linear-pro-system}
\source{stacks:0G4P}
\href{https://stacks.math.columbia.edu/tag/0G4P}{\texttt{Stacks tag 0G4P}}
\group{duality}
...
\begin{lemma}[Deligne system 2 out of 3]
\label{duality-lemma-deligne-system-2-out-of-3}
\source{stacks:0G4Q}
\href{https://stacks.math.columbia.edu/tag/0G4Q}{\texttt{Stacks tag 0G4Q}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-lift-map, duality-lemma-extension-by-zero}
...
diagram
$$
\begin{array}{ccccc}\ldots \longrightarrow & \colim \Hom_X(M_n, N) \longrightarrow\downarrow & \colim \Hom_X(L_n, N) \longrightarrow\downarrow & \colim \Hom_X(K_n, N) \longrightarrow\downarrow & \ldots \\ \ldots \longrightarrow & \Hom_U(M, N|_U) \longrightarrow & \Hom_U(L, N|_U) \longrightarrow & \Hom_U(K, N|_U) \longrightarrow & \ldots\end{array}
$$
By Lemma \ref{duality-lemma-lift-map} and the fact that isomorphic ind-systems
...
exists by Lemma \ref{duality-lemma-extension-by-zero}), then
...
\begin{lemma}[Consequence Artin Rees bis]
\label{duality-lemma-consequence-Artin-Rees-bis}
\source{stacks:0G4R}
\href{https://stacks.math.columbia.edu/tag/0G4R}{\texttt{Stacks tag 0G4R}}
\group{duality}
...
\begin{lemma}[Characterize extension by zero algebra]
\label{duality-lemma-characterize-extension-by-zero-algebra}
\source{stacks:0G4S}
\href{https://stacks.math.columbia.edu/tag/0G4S}{\texttt{Stacks tag 0G4S}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-consequence-Artin-Rees-bis, duality-lemma-deligne-system-2-out-of-3}
...
Thus the result follows from Lemma \ref{duality-lemma-consequence-Artin-Rees-bis}.
...
We conclude by Lemma \ref{duality-lemma-deligne-system-2-out-of-3}.
\end{proof}

\begin{lemma}[Characterize extension by zero]
\label{duality-lemma-characterize-extension-by-zero}
\source{stacks:0G4T}
\href{https://stacks.math.columbia.edu/tag/0G4T}{\texttt{Stacks tag 0G4T}}
\group{duality}
...
Consider the diagram
$$
\begin{array}{cc}\colim \Ext^{-1}(K_n|_V, L|_V) \oplus
\colim \Ext^{-1}(K_n|_W, L|_W) \longrightarrow\downarrow & \Ext^{-1}(K|_{U \cap V}, L|_{U \cap V}) \oplus
\Ext^{-1}(K|_{U \cap W}, L|_{U \cap W}) \downarrow \\ \colim \Ext^{-1}(K_n|_{V \cap W}, L|_{V \cap W}) \longrightarrow\downarrow & \Ext^{-1}(K|_{U \cap V \cap W}, L|_{U \cap V \cap W}) \downarrow \\ \colim \Hom(K_n, L) \downarrow\longrightarrow & \Hom(K|_U, L|_U) \downarrow \\ \colim \Hom(K_n|_V, L|_V) \oplus \colim \Hom(K_n|_W, L|_W) \longrightarrow\downarrow & \Hom(K|_{U \cap V}, L|_{U \cap V}) \oplus
\Hom(K|_{U \cap W}, L|_{U \cap W}) \downarrow \\ \colim \Hom(K_n|_{V \cap W}, L|_{V \cap W}) \longrightarrow & \Hom(K|_{U \cap V \cap W}, L|_{U \cap V \cap W})\end{array}
$$
...
by Lemma \ref{duality-lemma-lift-map} and the fact that pro-isomorphic systems
...
\begin{lemma}[Tensoring Deligne system]
\label{duality-lemma-tensoring-Deligne-system}
\source{stacks:0G4U}
\href{https://stacks.math.columbia.edu/tag/0G4U}{\texttt{Stacks tag 0G4U}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-characterize-extension-by-zero}

By Lemma \ref{duality-lemma-characterize-extension-by-zero} the question is
...
$$
which reduces to the functor of Remark \ref{duality-remark-extension-by-zero}
...
\begin{lemma}[Well defined pre]
\label{duality-lemma-well-defined-pre}
\source{stacks:0G4W}
\href{https://stacks.math.columbia.edu/tag/0G4W}{\texttt{Stacks tag 0G4W}}
\group{duality}

\uses{duality-remark-extension-by-zero}
Let $f : X \to Y$ be a proper morphism of Noetherian schemes.
...
$Rj_!$ and $Rj'_!$ are as in Remark \ref{duality-remark-extension-by-zero}.
\end{lemma}

\begin{proof}
\uses{duality-lemma-extension-by-zero, duality-lemma-extension-by-zero-triangle, duality-lemma-deligne-system-2-out-of-3, duality-lemma-characterize-extension-by-zero, duality-lemma-characterize-extension-by-zero-algebra}
[First proof]
...
By the uniqueness of Deligne systems in Lemma \ref{duality-lemma-extension-by-zero}
...
uniqueness). By Lemmas \ref{duality-lemma-extension-by-zero-triangle} and
\ref{duality-lemma-deligne-system-2-out-of-3}
...
is a Deligne system. By Lemma \ref{duality-lemma-characterize-extension-by-zero}
the question is local on $Y$. Thus we may assume $Y = \Spec(A)$ is affine
and $\mathcal{J}$ corresponds to an ideal $I \subset A$. By
Lemma \ref{duality-lemma-characterize-extension-by-zero-algebra}
...
\begin{proof}
\uses{duality-lemma-lift-map, duality-lemma-restrict-before-or-after, duality-lemma-shriek-coherent, duality-lemma-lift-map-plus}
[Second proof]
...
\Hom_{\text{Pro-}D^b_{\textit{Coh}}(\mathcal{O}_Y)}(Rf_*Rj_!K, L)
\end{align*}
The first equality is true by Lemma \ref{duality-lemma-lift-map}.
...
construction, see Section \ref{duality-section-upper-shriek}.
The third equality holds as $g^!(L|_V) = f^!L|_U$ by
Lemma \ref{duality-lemma-restrict-before-or-after}.
Since $f^!L$ is in $D^+_{\textit{Coh}}(\mathcal{O}_X)$ by
Lemma \ref{duality-lemma-shriek-coherent} the fourth equality follows from
Lemma \ref{duality-lemma-lift-map-plus}. The fifth equality holds again
...
\source{stacks:0G4X}
\href{https://stacks.math.columbia.edu/tag/0G4X}{\texttt{Stacks tag 0G4X}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-well-defined-pre}
...
Lemma \ref{duality-lemma-well-defined-pre}.
...
Picture
$$
\begin{array}{ccc} &  & X'' \overset{f'}{\downarrow} \\  &  & X' \overset{f}{\downarrow} \\ U \overset{j}{\longrightarrow}\overset{j'}{\nearrow}\overset{j''}{\nearrow} &  & X\end{array}
$$
By
More on Flatness, Lemma \ref{flat-lemma-compactifications-cofiltered} part (c)
...
\begin{remark}[Covariance open j lower shriek]
\label{duality-remark-covariance-open-j-lower-shriek}
\source{stacks:0G4Y}
\href{https://stacks.math.columbia.edu/tag/0G4Y}{\texttt{Stacks tag 0G4Y}}
\group{duality}
...
Lemma \ref{duality-lemma-lift-map} we have for any $L$ in
...
Lemma \ref{duality-lemma-extension-by-zero}
...
as in Remark \ref{duality-remark-extension-by-zero}.

\begin{lemma}[Lower shriek well defined]
\label{duality-lemma-lower-shriek-well-defined}
\source{stacks:0G50}
\href{https://stacks.math.columbia.edu/tag/0G50}{\texttt{Stacks tag 0G50}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-well-defined}
...
$$
using Lemma \ref{duality-lemma-well-defined} in the first equality. In this way
we see our functor is independent of the choice of compactification
up to isomorphism.
\end{proof}

\begin{proposition}[Duality compactly supported]
\label{duality-proposition-duality-compactly-supported}
\source{stacks:0G51}
\href{https://stacks.math.columbia.edu/tag/0G51}{\texttt{Stacks tag 0G51}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-shriek-coherent, duality-lemma-lift-map-plus}
...
Section \ref{duality-section-upper-shriek}.
By Lemma \ref{duality-lemma-shriek-coherent} we have $\overline{f}{}^!L$
in $D^+_{\textit{Coh}}(\mathcal{O}_{\overline{X}})$ hence the second
equality follows from Lemma \ref{duality-lemma-lift-map-plus}.
...
\begin{lemma}[Compactly supported triangle]
\label{duality-lemma-compactly-supported-triangle}
\source{stacks:0G52}
\href{https://stacks.math.columbia.edu/tag/0G52}{\texttt{Stacks tag 0G52}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-extension-by-zero-triangle}
...
Lemma \ref{duality-lemma-extension-by-zero-triangle} corresponding to the
...
\begin{remark}[Compose inverse systems]
\label{duality-remark-compose-inverse-systems}
\source{stacks:0G53}
\href{https://stacks.math.columbia.edu/tag/0G53}{\texttt{Stacks tag 0G53}}
\group{duality}
...
making the diagrams
$$
\begin{array}{cccc}\ldots \longrightarrow & M_{i, m_i(3)} \overset{a_{i, 3}}{\downarrow}\longrightarrow & M_{i, m_i(2)} \overset{a_{i, 2}}{\downarrow}\longrightarrow & M_{i, m_i(1)} \overset{a_{i, 1}}{\downarrow} \\ \ldots \longrightarrow & M_{i - 1, 3} \longrightarrow & M_{i - 1, 2} \longrightarrow & M_{i - 1, 1}\end{array}
$$
...
\begin{remark}[Composition lower shriek]
\label{duality-remark-composition-lower-shriek}
\source{stacks:0G54}
\href{https://stacks.math.columbia.edu/tag/0G54}{\texttt{Stacks tag 0G54}}
\group{duality}

\uses{duality-situation-shriek, duality-remark-compose-inverse-systems}
In Situation \ref{duality-situation-shriek} let $f : X \to Y$ and $g : Y \to Z$
...
By the discussion in Remark \ref{duality-remark-compose-inverse-systems}
...
\begin{lemma}[Composition lower shriek]
\label{duality-lemma-composition-lower-shriek}
\source{stacks:0G55}
\href{https://stacks.math.columbia.edu/tag/0G55}{\texttt{Stacks tag 0G55}}
\group{duality}

\uses{duality-situation-shriek, duality-remark-composition-lower-shriek}
In Situation \ref{duality-situation-shriek} let $f : X \to Y$ and $g : Y \to Z$
be composable morphisms of $\textit{FTS}_S$. With notation as in
Remark \ref{duality-remark-composition-lower-shriek} we have
$Rg_! \circ Rf_! = R(g \circ f)_!$.
\end{lemma}

\begin{proof}
\uses{duality-remark-composition-lower-shriek, duality-proposition-duality-compactly-supported, duality-lemma-upper-shriek-composition}
...
Remark \ref{duality-remark-composition-lower-shriek}, as follows
\begin{align*}
\Hom_Z(Rg_!Rf_!K, L)
& =
...
equality is Proposition \ref{duality-proposition-duality-compactly-supported}
for $g$.
The third equality is the fact that $Rf_!K$ is given by $(M_n)$.
The fourth equality is
Proposition \ref{duality-proposition-duality-compactly-supported} for $f$.
The fifth equality is Lemma \ref{duality-lemma-upper-shriek-composition}.
The sixth is
Proposition \ref{duality-proposition-duality-compactly-supported} for $g \circ f$.
\end{proof}

\begin{remark}[Covariance open lower shriek]
\label{duality-remark-covariance-open-lower-shriek}
\source{stacks:0G56}
\href{https://stacks.math.columbia.edu/tag/0G56}{\texttt{Stacks tag 0G56}}
\group{duality}

\uses{duality-situation-shriek, duality-lemma-composition-lower-shriek, duality-remark-covariance-open-j-lower-shriek, duality-proposition-duality-compactly-supported}
In Situation \ref{duality-situation-shriek} let $f : X \to Y$ be a morphism of
...
$Rg_! = Rf_! \circ Ri_!$ by
Lemma \ref{duality-lemma-composition-lower-shriek}
and we can use $Rf_!$ applied to the map $Ri_!(K|_U) \to K$
which is a special case of
Remark \ref{duality-remark-covariance-open-j-lower-shriek}.
...
Proposition \ref{duality-proposition-duality-compactly-supported}
...
\begin{remark}[Covariance etale lower shriek]
\label{duality-remark-covariance-etale-lower-shriek}
\source{stacks:0G57}
\href{https://stacks.math.columbia.edu/tag/0G57}{\texttt{Stacks tag 0G57}}
\group{duality}

\uses{duality-remark-covariance-open-lower-shriek, duality-situation-shriek, duality-proposition-duality-compactly-supported, duality-lemma-shriek-etale, duality-lemma-upper-shriek-composition}
Let us generalize the covariance of compactly supported cohomology
given in Remark \ref{duality-remark-covariance-open-lower-shriek}
to \'etale morphisms. Namely, in Situation \ref{duality-situation-shriek}
suppose given a commutative diagram
$$
\begin{array}{ccc}U \underset{h}{\longrightarrow}\underset{g}{\searrow} &  & X \overset{f}{\swarrow} \\  & Y & \end{array}
$$
...
Lemma \ref{duality-lemma-shriek-etale}, and we have used the equality
$h^! \circ f^! = g^!$ of Lemma \ref{duality-lemma-upper-shriek-composition}.
...
\begin{remark}[Covariance lower shriek]
\label{duality-remark-covariance-lower-shriek}
\source{stacks:0G58}
\href{https://stacks.math.columbia.edu/tag/0G58}{\texttt{Stacks tag 0G58}}
\group{duality}

\uses{duality-remark-covariance-open-lower-shriek, duality-remark-covariance-etale-lower-shriek, duality-lemma-perfect-comparison-shriek, duality-lemma-flat-quasi-finite-shriek}
In Remarks \ref{duality-remark-covariance-open-lower-shriek} and
\ref{duality-remark-covariance-etale-lower-shriek} we have seen
...
$$
As in Remark \ref{duality-remark-covariance-etale-lower-shriek}
...
Lemmas \ref{duality-lemma-perfect-comparison-shriek} and
...
See for example Remark \ref{duality-remark-covariance-open-lower-shriek}.
In fact, using Remark \ref{duality-remark-covariance-etale-lower-shriek}
...
\begin{lemma}[Duality compact support]
\label{duality-lemma-duality-compact-support}
\source{stacks:0G5A}
\href{https://stacks.math.columbia.edu/tag/0G5A}{\texttt{Stacks tag 0G5A}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-lift-map, duality-lemma-duality-proper-over-field, duality-lemma-internal-hom-evaluate-isom, duality-lemma-tensoring-Deligne-system}
...
$$
by Lemma \ref{duality-lemma-lift-map}.
...
Section \ref{duality-section-duality-proper-over-field}. We find that
\begin{align*}
\Hom_k(
&
...
\end{align*}
by Lemma \ref{duality-lemma-duality-proper-over-field}. By
Lemma \ref{duality-lemma-internal-hom-evaluate-isom} part (1) the canonical map
$$
...
Hence by Lemma \ref{duality-lemma-tensoring-Deligne-system} we conclude that
$$
...
\begin{lemma}[Duality compact support restrict open]
\label{duality-lemma-duality-compact-support-restrict-open}
\source{stacks:0G5B}
\href{https://stacks.math.columbia.edu/tag/0G5B}{\texttt{Stacks tag 0G5B}}
\group{duality}

\uses{duality-lemma-duality-compact-support, duality-remark-covariance-open-lower-shriek}
With notation as in Lemma \ref{duality-lemma-duality-compact-support}
suppose $U' \subset U$ is an open subscheme. Then the diagram
$$
\begin{array}{ccc}\Hom_k(H^i(U, K), k) \longrightarrow &  & H^{-i}_c(U, R\SheafHom_{\mathcal{O}_U}(K, \omega_{U/k}^\bullet)) \\ \Hom_k(H^i(U', K|_{U'}), k) \longrightarrow\uparrow &  & H^{-i}_c(U', R\SheafHom_{\mathcal{O}_{U'}}(K, \omega_{U'/k}^\bullet)) \uparrow\end{array}
$$
is commutative. Here the horizontal arrows are the isomorphisms of
Lemma \ref{duality-lemma-duality-compact-support}, the vertical arrow on the
left is the contragredient to the restriction map
$H^i(U, K) \to H^i(U', K|_{U'})$, and the right vertical arrow
is Remark \ref{duality-remark-covariance-open-lower-shriek} (see discussion
before the lemma).
\end{lemma}

\begin{proof}
\uses{duality-lemma-duality-compact-support, duality-remark-covariance-open-j-lower-shriek}

We strongly urge the reader to skip this proof. Choose $X$ and $M$ as
in the proof of Lemma \ref{duality-lemma-duality-compact-support}. We are going to drop
...
$$
as in the proof of Lemma \ref{duality-lemma-duality-compact-support} where we choose
$\mathcal{I}' \subset \mathcal{I}$ as in the discussion in
Remark \ref{duality-remark-covariance-open-j-lower-shriek} so that the map
...
The diagrams
$$
\begin{array}{ccc}R\SheafHom(M, \omega_{X/k}^\bullet)
\otimes^\mathbf{L} \mathcal{I}^n
\longrightarrow &  & R\SheafHom(R\SheafHom(\mathcal{I}^n, M), \omega_{X/k}^\bullet) \\ R\SheafHom(M, \omega_{X/k}^\bullet) \otimes^\mathbf{L} (\mathcal{I}')^n
\longrightarrow\uparrow &  & R\SheafHom(R\SheafHom((\mathcal{I}')^n, M), \omega_{X/k}^\bullet) \uparrow\end{array}
$$
...
$$
\begin{array}{cc}\Hom_k(H^i(X, R\SheafHom(\mathcal{I}^n, M)), k) \longrightarrow & H^{-i}(X, R\SheafHom(R\SheafHom(
\mathcal{I}^n, M), \omega_{X/k}^\bullet)) \\ \Hom_k(H^i(X, R\SheafHom((\mathcal{I}')^n, M)), k) \longrightarrow\uparrow & H^{-i}(X, R\SheafHom(R\SheafHom(
(\mathcal{I}')^n, M), \omega_{X/k}^\bullet)) \uparrow\end{array}
$$
...
\begin{lemma}[H0 compactly supported]
\label{duality-lemma-h0-compactly-supported}
\source{stacks:0G5C}
\href{https://stacks.math.columbia.edu/tag/0G5C}{\texttt{Stacks tag 0G5C}}
\group{duality}
...
\begin{proof}
\uses{duality-remark-covariance-open-lower-shriek}

Consider the map
$H^0_c(U, K|_U) \to H^0_X(X, K) = H^0(X, K) = H^0(X, \mathcal{F})$ of
Remark \ref{duality-remark-covariance-open-lower-shriek}. To study this
...
\begin{lemma}[Lichtenbaum]
\label{duality-lemma-lichtenbaum}
\source{stacks:0G5E}
\href{https://stacks.math.columbia.edu/tag/0G5E}{\texttt{Stacks tag 0G5E}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-duality-compact-support, duality-lemma-duality-proper-over-field, duality-lemma-h0-compactly-supported}
...
Section \ref{duality-section-duality-proper-over-field}.
...
$$
by Lemma \ref{duality-lemma-duality-compact-support}. By
Lemma \ref{duality-lemma-duality-proper-over-field} we see that
...
Thus it follows from Lemma \ref{duality-lemma-h0-compactly-supported} that
$H^{-d}_c(U, R\SheafHom_{\mathcal{O}_U}(\mathcal{F}, \omega_U^\bullet))$
is zero, and hence $H^d(U, \mathcal{F})$ is zero as desired.
\end{proof}

\begin{theorem}[Lichtenbaum]
\label{duality-theorem-lichtenbaum}
\source{stacks:0G5F}
\href{https://stacks.math.columbia.edu/tag/0G5F}{\texttt{Stacks tag 0G5F}}
\group{duality}
...
\begin{proof}
\uses{duality-lemma-duality-proper-over-field, duality-lemma-lichtenbaum}
...
Lemma \ref{duality-lemma-duality-proper-over-field}. Then
...
By Lemma \ref{duality-lemma-lichtenbaum}
