...
\begin{remark}
\label{src-rigid-local-systems-multiplicative-eigenvalue-problem-ch07-unitary-irreducible-rigid-local-systems-and-kz-equations-statement-1}
\source{rigid-local-systems-multiplicative-eigenvalue-problem}
\notready
...
\begin{example}
\label{src-rigid-local-systems-multiplicative-eigenvalue-problem-ch07-unitary-irreducible-rigid-local-systems-and-kz-equations-statement-2}
\source{rigid-local-systems-multiplicative-eigenvalue-problem}
\notready
