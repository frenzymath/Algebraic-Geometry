...
Blueprint project under `FormalizedPapers/SheavesAndCohomology/BoundsStalksPerverseSheavesCharacteristicPShende`.

- Blueprint: [`blueprint/src/content.tex`](blueprint/src/content.tex)
- Direct PDF: [arXiv PDF](https://arxiv.org/pdf/1907.04850)
