...
\source{stacks:049J}
\href{https://stacks.math.columbia.edu/tag/049J}{\texttt{Stacks tag 049J}}
\group{spaces-limits}
...
\begin{lemma}[Characterize relative limit preserving]
\label{spaces-limits-lemma-characterize-relative-limit-preserving}
\source{stacks:06BC}
\href{https://stacks.math.columbia.edu/tag/06BC}{\texttt{Stacks tag 06BC}}
\group{spaces-limits}
...
$$
\begin{array}{cc}\colim_i F(T_i) \longrightarrow\underset{a}{\downarrow} & F(T) \overset{a}{\downarrow} \\ \colim_i G(T_i) \longrightarrow & G(T)\end{array}
$$
...
\begin{lemma}[Composition locally finite presentation]
\label{spaces-limits-lemma-composition-locally-finite-presentation}
\source{stacks:049L}
\href{https://stacks.math.columbia.edu/tag/049L}{\texttt{Stacks tag 049L}}
\group{spaces-limits}
...
$$
\begin{array}{cc}\colim_i F(T_i) \longrightarrow\underset{a}{\downarrow} & F(T) \overset{a}{\downarrow} \\ \colim_i G(T_i) \longrightarrow\underset{b}{\downarrow} & G(T) \overset{b}{\downarrow} \\ \colim_i H(T_i) \longrightarrow & H(T)\end{array}
$$
...
\begin{lemma}[Locally finite presentation permanence]
\label{spaces-limits-lemma-locally-finite-presentation-permanence}
\source{stacks:0GDY}
\href{https://stacks.math.columbia.edu/tag/0GDY}{\texttt{Stacks tag 0GDY}}
\group{spaces-limits}
...
\begin{lemma}[Base change locally finite presentation]
\label{spaces-limits-lemma-base-change-locally-finite-presentation}
\source{stacks:049M}
\href{https://stacks.math.columbia.edu/tag/049M}{\texttt{Stacks tag 049M}}
\group{spaces-limits}
...
\begin{lemma}[Fibre product locally finite presentation]
\label{spaces-limits-lemma-fibre-product-locally-finite-presentation}
\source{stacks:0GDZ}
\href{https://stacks.math.columbia.edu/tag/0GDZ}{\texttt{Stacks tag 0GDZ}}
\group{spaces-limits}
...
show that
$$
\begin{array}{cc}\colim F(T_i) \times_{\colim G(T_i)} \colim H(T_i) \longrightarrow\downarrow & F(T) \times_{G(T)} H(T) \downarrow \\ \colim_i E(T_i) \longrightarrow & E(T)\end{array}
$$
...
\begin{lemma}[Sheafify finite presentation]
\label{spaces-limits-lemma-sheafify-finite-presentation}
\source{stacks:049O}
\href{https://stacks.math.columbia.edu/tag/049O}{\texttt{Stacks tag 049O}}
\group{spaces-limits}
...
\text{Equalizer}
\left(
\begin{array}{cc}\prod F(T_{i', k})
\longrightarrow\longrightarrow & \prod F(T_{i', k} \times_{T_{i'}} T_{i', l})\end{array}
\right)
\\
& =
\text{Equalizer}
...
\prod F(T_{i', k} \times_{T_{i'}} T_{i', l})\end{array}
\right)
\\
& =
\text{Equalizer}
\left(
\begin{array}{cc}\prod F(T_k)
\longrightarrow\longrightarrow & \prod F(T_k \times_T T_l)\end{array}
\right)
\\
& =
\check H^0(\mathcal{V}, F)
...
\begin{lemma}[Sheaf finite presentation]
\label{spaces-limits-lemma-sheaf-finite-presentation}
\source{stacks:049P}
\href{https://stacks.math.columbia.edu/tag/049P}{\texttt{Stacks tag 049P}}
\group{spaces-limits}
...
\begin{lemma}[Sheafify finite presentation map]
\label{spaces-limits-lemma-sheafify-finite-presentation-map}
\source{stacks:049Q}
\href{https://stacks.math.columbia.edu/tag/049Q}{\texttt{Stacks tag 049Q}}
\group{spaces-limits}
...
Lemma \ref{spaces-limits-lemma-sheaf-finite-presentation}
...
Lemma \ref{spaces-limits-lemma-sheafify-finite-presentation}.
\end{proof}
...
\source{stacks:04AK}
\href{https://stacks.math.columbia.edu/tag/04AK}{\texttt{Stacks tag 04AK}}
\group{spaces-limits}
...
$U \to V \times_Y X$. By
Lemma \ref{spaces-limits-lemma-base-change-locally-finite-presentation}
...
Lemma \ref{spaces-limits-lemma-composition-locally-finite-presentation}
...
\source{stacks:05N0}
\href{https://stacks.math.columbia.edu/tag/05N0}{\texttt{Stacks tag 05N0}}
\group{spaces-limits}
...
In fact, we will see in Lemma \ref{spaces-limits-lemma-surjection-is-enough}
...
\source{stacks:0CM6}
\href{https://stacks.math.columbia.edu/tag/0CM6}{\texttt{Stacks tag 0CM6}}
\group{spaces-limits}
...
$$
\begin{array}{ccc}T \underset{a}{\downarrow}\underset{p_i}{\longrightarrow} &  & T_i \overset{b_i}{\downarrow}\swarrow \\ U \overset{h}{\longrightarrow} & X \times_Y V \downarrow\longrightarrow & V \overset{g}{\downarrow} \\  & X \overset{f}{\longrightarrow} & Y\end{array}
$$
...
$$
by Proposition \ref{spaces-limits-proposition-characterize-locally-finite-presentation}.
...
\source{stacks:07SF}
\href{https://stacks.math.columbia.edu/tag/07SF}{\texttt{Stacks tag 07SF}}
\group{spaces-limits}
...
\begin{lemma}[Space over limit]
\label{spaces-limits-lemma-space-over-limit}
\source{stacks:07SH}
\href{https://stacks.math.columbia.edu/tag/07SH}{\texttt{Stacks tag 07SH}}
\group{spaces-limits}
...
\begin{lemma}[Directed inverse system closed immersions]
\label{spaces-limits-lemma-directed-inverse-system-closed-immersions}
\source{stacks:0CUH}
\href{https://stacks.math.columbia.edu/tag/0CUH}{\texttt{Stacks tag 0CUH}}
\group{spaces-limits}
...
\begin{lemma}[Directed inverse system reduced]
\label{spaces-limits-lemma-directed-inverse-system-reduced}
\source{stacks:0CUI}
\href{https://stacks.math.columbia.edu/tag/0CUI}{\texttt{Stacks tag 0CUI}}
\group{spaces-limits}
...
\begin{lemma}[Better characterize relative limit preserving]
\label{spaces-limits-lemma-better-characterize-relative-limit-preserving}
\source{stacks:0CP4}
\href{https://stacks.math.columbia.edu/tag/0CP4}{\texttt{Stacks tag 0CP4}}
\group{spaces-limits}
...
$$
\begin{array}{cc}\colim_i \Mor(T_i, X) \longrightarrow\downarrow & \Mor(T, X) \downarrow \\ \colim_i \Mor(T_i, Y) \longrightarrow & \Mor(T, Y)\end{array}
$$
is a fibre product diagram.
\end{enumerate}
\end{lemma}
...
where $U_i$ is affine. Using Lemma \ref{spaces-limits-lemma-space-over-limit}
...
\source{stacks:0CUJ}
\href{https://stacks.math.columbia.edu/tag/0CUJ}{\texttt{Stacks tag 0CUJ}}
\group{spaces-limits}
...
(Lemma \ref{spaces-limits-lemma-directed-inverse-system-has-limit}). If each $X_i$
...
\source{stacks:086V}
\href{https://stacks.math.columbia.edu/tag/086V}{\texttt{Stacks tag 086V}}
\group{spaces-limits}

With same notation and assumptions as in Lemma \ref{spaces-limits-lemma-inverse-limit-sets}
...
\source{stacks:086W}
\href{https://stacks.math.columbia.edu/tag/086W}{\texttt{Stacks tag 086W}}
\group{spaces-limits}
...
\source{stacks:0CUK}
\href{https://stacks.math.columbia.edu/tag/0CUK}{\texttt{Stacks tag 0CUK}}
\group{spaces-limits}
...
because $|X| = \lim |X_i|$ as sets (Lemma \ref{spaces-limits-lemma-inverse-limit-sets}).
Suppose that $x' \in |X|$ is not in $Z$.
Then there is an open subset $U \subset |X|$ with $x' \in U$
and $x \not \in U$. Since
$|X| = \lim |X_i|$ as topological spaces (Lemma \ref{spaces-limits-lemma-topology-limit})
...
By Lemma \ref{spaces-limits-lemma-directed-inverse-system-closed-immersions}
we see that $\lim Z_i \to X$ is a
closed immersion. By Lemma \ref{spaces-limits-lemma-directed-inverse-system-reduced}
...
\source{stacks:084R}
\href{https://stacks.math.columbia.edu/tag/084R}{\texttt{Stacks tag 084R}}
\group{spaces-limits}
...
\source{stacks:07SI}
\href{https://stacks.math.columbia.edu/tag/07SI}{\texttt{Stacks tag 07SI}}
\group{spaces-limits}

Notation and assumptions as in Situation \ref{spaces-limits-situation-descent}.
...
In the proof of Lemma \ref{spaces-limits-lemma-directed-inverse-system-has-limit} we have
...
\source{stacks:0827}
\href{https://stacks.math.columbia.edu/tag/0827}{\texttt{Stacks tag 0827}}
\group{spaces-limits}
...
Lemma \ref{spaces-limits-lemma-descend-isomorphism}.

\begin{lemma}[Descend equality]
\label{spaces-limits-lemma-descend-equality}
\source{stacks:084S}
\href{https://stacks.math.columbia.edu/tag/084S}{\texttt{Stacks tag 084S}}
\group{spaces-limits}
...
\begin{lemma}[Descend separated]
\label{spaces-limits-lemma-descend-separated}
\source{stacks:084T}
\href{https://stacks.math.columbia.edu/tag/084T}{\texttt{Stacks tag 084T}}
\group{spaces-limits}
...
\begin{lemma}[Limit is affine]
\label{spaces-limits-lemma-limit-is-affine}
\source{stacks:07SQ}
\href{https://stacks.math.columbia.edu/tag/07SQ}{\texttt{Stacks tag 07SQ}}
\group{spaces-limits}
...
Lemma \ref{spaces-limits-lemma-descend-section}. After increasing $0$ we may assume
...
\vcenter{
\begin{array}{cc}X_i \downarrow & U_i \longleftarrow\downarrow \\ \Spec(A_i) & \Spec(B_i) \longleftarrow\end{array}
}
\end{equation}
...
Lemma \ref{spaces-limits-lemma-descend-equality}
...
\begin{lemma}[Limit is scheme]
\label{spaces-limits-lemma-limit-is-scheme}
\source{stacks:07SR}
\href{https://stacks.math.columbia.edu/tag/07SR}{\texttt{Stacks tag 07SR}}
\group{spaces-limits}
...
By Lemma \ref{spaces-limits-lemma-descend-opens}
we can find an $i \in I$ and open subspaces $W_{j, i} \subset X_i$
whose base change to $X$ is $W_j \to X$. By
Lemma \ref{spaces-limits-lemma-limit-is-affine} we may assume that
...
\source{stacks:0828}
\href{https://stacks.math.columbia.edu/tag/0828}{\texttt{Stacks tag 0828}}
\group{spaces-limits}
...
\source{stacks:086X}
\href{https://stacks.math.columbia.edu/tag/086X}{\texttt{Stacks tag 086X}}
\group{spaces-limits}
...
\source{stacks:0A0R}
\href{https://stacks.math.columbia.edu/tag/0A0R}{\texttt{Stacks tag 0A0R}}
\group{spaces-limits}
...
This follows from Lemma \ref{spaces-limits-lemma-limit-is-affine}.
\end{proof}

\begin{lemma}[Eventually finite]
\label{spaces-limits-lemma-eventually-finite}
\source{stacks:0A0S}
\href{https://stacks.math.columbia.edu/tag/0A0S}{\texttt{Stacks tag 0A0S}}
\group{spaces-limits}
...
Lemma \ref{spaces-limits-lemma-limit-is-scheme} this reduces us to the case of schemes.
...
\source{stacks:0A0T}
\href{https://stacks.math.columbia.edu/tag/0A0T}{\texttt{Stacks tag 0A0T}}
\group{spaces-limits}
...
This section is the analogue of Section \ref{spaces-limits-section-descent}
...
\source{stacks:084W}
\href{https://stacks.math.columbia.edu/tag/084W}{\texttt{Stacks tag 084W}}
\group{spaces-limits}
...
\source{stacks:07SL}
\href{https://stacks.math.columbia.edu/tag/07SL}{\texttt{Stacks tag 07SL}}
\group{spaces-limits}

With notation and assumptions as in
Situation \ref{spaces-limits-situation-descent-property}. If
\begin{enumerate}
\item $f$ is \'etale,
...
$$
\begin{array}{cc}U_0 \downarrow\longrightarrow & V_0 \downarrow \\ X_0 \longrightarrow & Y_0\end{array}
$$
The vertical arrows are surjective and \'etale by construction.
We can base change this diagram to $B_i$ or $B$ to get
$$
\vcenter{
\begin{array}{cc}U_i \downarrow\longrightarrow & V_i \downarrow \\ X_i \longrightarrow & Y_i\end{array}
}
\quad\text{and}\quad
\vcenter{
...
\source{stacks:0CN2}
\href{https://stacks.math.columbia.edu/tag/0CN2}{\texttt{Stacks tag 0CN2}}
\group{spaces-limits}
...
\source{stacks:07SN}
\href{https://stacks.math.columbia.edu/tag/07SN}{\texttt{Stacks tag 07SN}}
\group{spaces-limits}
...
\begin{lemma}[Descend universally injective]
\label{spaces-limits-lemma-descend-universally-injective}
\source{stacks:084X}
\href{https://stacks.math.columbia.edu/tag/084X}{\texttt{Stacks tag 084X}}
\group{spaces-limits}

Notation and assumptions as in Situation \ref{spaces-limits-situation-descent-property}. If
\begin{enumerate}
...
\ref{spaces-morphisms-lemma-diagonal-morphism-finite-type}).
Hence the lemma follows from Lemma \ref{spaces-limits-lemma-descend-surjective}
by considering the morphism $X_0 \to X_0 \times_{Y_0} X_0$.
\end{proof}

\begin{lemma}[Descend affine]
\label{spaces-limits-lemma-descend-affine}
\source{stacks:084Y}
\href{https://stacks.math.columbia.edu/tag/084Y}{\texttt{Stacks tag 084Y}}
\group{spaces-limits}
...
is affine. By Lemma \ref{spaces-limits-lemma-limit-is-affine} we see that
...
\begin{lemma}[Descend finite]
\label{spaces-limits-lemma-descend-finite}
\source{stacks:084Z}
\href{https://stacks.math.columbia.edu/tag/084Z}{\texttt{Stacks tag 084Z}}
\group{spaces-limits}
...
is a scheme finite over $V$. By Lemma \ref{spaces-limits-lemma-limit-is-affine} we see that
...
\begin{lemma}[Descend closed immersion]
\label{spaces-limits-lemma-descend-closed-immersion}
\source{stacks:0850}
\href{https://stacks.math.columbia.edu/tag/0850}{\texttt{Stacks tag 0850}}
\group{spaces-limits}
...
Lemma \ref{spaces-limits-lemma-limit-is-affine} we see that
$V_i \times_{Y_i} X_i$ is affine for some $i \geq 0$. Increasing $i$ if
...
\begin{lemma}[Descend separated morphism]
\label{spaces-limits-lemma-descend-separated-morphism}
\source{stacks:0851}
\href{https://stacks.math.columbia.edu/tag/0851}{\texttt{Stacks tag 0851}}
\group{spaces-limits}

Notation and assumptions as in Situation \ref{spaces-limits-situation-descent-property}.
If $f$ is separated, then $f_i$ is separated for some $i \geq 0$.
\end{lemma}

\begin{proof}
Apply Lemma \ref{spaces-limits-lemma-descend-closed-immersion}
...
\source{stacks:0852}
\href{https://stacks.math.columbia.edu/tag/0852}{\texttt{Stacks tag 0852}}
\group{spaces-limits}
...
Lemmas \ref{spaces-limits-lemma-descend-etale},
...
\source{stacks:07SM}
\href{https://stacks.math.columbia.edu/tag/07SM}{\texttt{Stacks tag 07SM}}
\group{spaces-limits}
...
\begin{lemma}[Descend flat]
\label{spaces-limits-lemma-descend-flat}
\source{stacks:08K0}
\href{https://stacks.math.columbia.edu/tag/08K0}{\texttt{Stacks tag 08K0}}
\group{spaces-limits}
...
\begin{lemma}[Eventually proper]
\label{spaces-limits-lemma-eventually-proper}
\source{stacks:08K1}
\href{https://stacks.math.columbia.edu/tag/08K1}{\texttt{Stacks tag 08K1}}
\group{spaces-limits}

Assumptions and notation as in Situation \ref{spaces-limits-situation-descent-property}.
If
\begin{enumerate}
...
\medskip\noindent
By Lemma \ref{spaces-limits-lemma-descend-separated-morphism} we see that
...
By Lemma \ref{spaces-limits-lemma-descend-closed-immersion}
...
\source{stacks:0D4K}
\href{https://stacks.math.columbia.edu/tag/0D4K}{\texttt{Stacks tag 0D4K}}
\group{spaces-limits}
...
\source{stacks:07SK}
\href{https://stacks.math.columbia.edu/tag/07SK}{\texttt{Stacks tag 07SK}}
\group{spaces-limits}
...
Lemma \ref{spaces-limits-lemma-directed-inverse-system-has-limit} we have
seen that there exists a presentation $X = U/R$ with
...
\source{stacks:07V7}
\href{https://stacks.math.columbia.edu/tag/07V7}{\texttt{Stacks tag 07V7}}
\group{spaces-limits}
...
\source{stacks:0D2X}
\href{https://stacks.math.columbia.edu/tag/0D2X}{\texttt{Stacks tag 0D2X}}
\group{spaces-limits}

With notation and assumptions as in
Lemma \ref{spaces-limits-lemma-descend-finite-presentation}. Then
\begin{enumerate}
...
Lemma \ref{spaces-limits-lemma-descend-modules-finite-presentation}.
...
\source{stacks:07SU}
\href{https://stacks.math.columbia.edu/tag/07SU}{\texttt{Stacks tag 07SU}}
\group{spaces-limits}
...
Lemmas \ref{spaces-limits-lemma-descend-finite-presentation} and \ref{spaces-limits-lemma-descend-etale}
...
Lemma \ref{spaces-limits-lemma-limit-is-scheme}.
...
$$
\begin{array}{cc}W_i \longrightarrow\underset{\Delta}{\downarrow} & V_i \downarrow \\ W_i \times_{U_i} W_i \longrightarrow & R_i\end{array}
$$
...
\vcenter{
\begin{array}{cc}R_i \longrightarrow\underset{s_i}{\downarrow} & R_{i'} \overset{s_{i'}}{\downarrow} \\ V_i \longrightarrow & V_{i'}\end{array}
}
\end{equation}
...
$$
\begin{array}{cc}V_i \longrightarrow\downarrow & V_{i'} \downarrow \\ X_i \longrightarrow & X_{i'}\end{array}
$$
...
V \times_{X'} V \cong R
$$
(use Lemma \ref{spaces-limits-lemma-directed-inverse-system-has-limit}).
...
\begin{lemma}[Colimit finitely presented]
\label{spaces-limits-lemma-colimit-finitely-presented}
\source{stacks:07V9}
\href{https://stacks.math.columbia.edu/tag/07V9}{\texttt{Stacks tag 07V9}}
\group{spaces-limits}
...
Thus we may apply Proposition \ref{spaces-limits-proposition-approximate}
...
applications of Lemma \ref{spaces-limits-lemma-colimit-finitely-presented}.

\begin{lemma}[Directed colimit finite type]
\label{spaces-limits-lemma-directed-colimit-finite-type}
\source{stacks:0829}
\href{https://stacks.math.columbia.edu/tag/0829}{\texttt{Stacks tag 0829}}
\group{spaces-limits}
...
\source{stacks:086Y}
\href{https://stacks.math.columbia.edu/tag/086Y}{\texttt{Stacks tag 086Y}}
\group{spaces-limits}
...
(Lemma \ref{spaces-limits-lemma-directed-colimit-finite-type}). Then
...
\source{stacks:082A}
\href{https://stacks.math.columbia.edu/tag/082A}{\texttt{Stacks tag 082A}}
\group{spaces-limits}
...
\source{stacks:082B}
\href{https://stacks.math.columbia.edu/tag/082B}{\texttt{Stacks tag 082B}}
\group{spaces-limits}
...
\source{stacks:086Z}
\href{https://stacks.math.columbia.edu/tag/086Z}{\texttt{Stacks tag 086Z}}
\group{spaces-limits}
...
\begin{proof}
By Lemma \ref{spaces-limits-lemma-finite-directed-colimit-surjective-maps}
...
$\mathcal{E}_i$ (Lemma \ref{spaces-limits-lemma-directed-colimit-finite-type}). Set
$$
...
\source{stacks:082C}
\href{https://stacks.math.columbia.edu/tag/082C}{\texttt{Stacks tag 082C}}
\group{spaces-limits}
...
\begin{proof}
By Lemma \ref{spaces-limits-lemma-algebra-directed-colimit-finite-type} we have
...
(see proof of
Lemma \ref{spaces-limits-lemma-finite-algebra-directed-colimit-finite-finitely-presented}).
Finally, we have
$$
...
\source{stacks:0853}
\href{https://stacks.math.columbia.edu/tag/0853}{\texttt{Stacks tag 0853}}
\group{spaces-limits}
...
We discuss variants of Proposition \ref{spaces-limits-proposition-approximate}
over a base.

\begin{lemma}[Approximate morphism]
\label{spaces-limits-lemma-approximate-morphism}
\source{stacks:0GS3}
\href{https://stacks.math.columbia.edu/tag/0GS3}{\texttt{Stacks tag 0GS3}}
\group{spaces-limits}
...
Proposition \ref{spaces-limits-proposition-approximate}, i.e., with $X_a$ and $Y_b$
quasi-separated and of finite type over $\mathbf{Z}$ and
with affine transition morphisms.

\medskip\noindent
Fix $b \in B$.
By Lemma \ref{spaces-limits-lemma-better-characterize-relative-limit-preserving}
...
$$
\begin{array}{cc}X \downarrow\longrightarrow & Y \downarrow \\ X_a \longrightarrow & Y_b\end{array}
$$
...
Lemma \ref{spaces-limits-lemma-better-characterize-relative-limit-preserving}
...
\source{stacks:09NS}
\href{https://stacks.math.columbia.edu/tag/09NS}{\texttt{Stacks tag 09NS}}
\group{spaces-limits}
...
By Lemma \ref{spaces-limits-lemma-approximate-morphism} we can write
...
\begin{lemma}[Affine morphism is limit]
\label{spaces-limits-lemma-affine-morphism-is-limit}
\source{stacks:0870}
\href{https://stacks.math.columbia.edu/tag/0870}{\texttt{Stacks tag 0870}}
\group{spaces-limits}
...
Lemma \ref{spaces-limits-lemma-algebra-directed-colimit-finite-presentation}
...
\source{stacks:09YA}
\href{https://stacks.math.columbia.edu/tag/09YA}{\texttt{Stacks tag 09YA}}
\group{spaces-limits}
...
Consider the quasi-coherent $\mathcal{O}_Y$-module
$\mathcal{A} = f_*\mathcal{O}_X$. By
Lemma \ref{spaces-limits-lemma-integral-algebra-directed-colimit-finite}
we can write $\mathcal{A} = \colim \mathcal{A}_i$ as a directed
...
\source{stacks:07VR}
\href{https://stacks.math.columbia.edu/tag/07VR}{\texttt{Stacks tag 07VR}}
\group{spaces-limits}
...
\begin{lemma}[Closed immersions of qcqs algebraic spaces can be approximated by finitely presented cl...]
\label{spaces-limits-lemma-closed-is-limit-closed-and-finite-presentation}
\source{stacks:0A0U}
\href{https://stacks.math.columbia.edu/tag/0A0U}{\texttt{Stacks tag 0A0U}}
\group{spaces-limits}
...
\begin{lemma}[Quasi affine closed in finite presentation]
\label{spaces-limits-lemma-quasi-affine-closed-in-finite-presentation}
\source{stacks:0871}
\href{https://stacks.math.columbia.edu/tag/0871}{\texttt{Stacks tag 0871}}
\group{spaces-limits}
...
of finite presentation over $Y$ (Lemma \ref{spaces-limits-lemma-affine-morphism-is-limit}).
...
(Lemma \ref{spaces-limits-lemma-descend-opens}). Let $U_i$ be the inverse image of
$U_0$ in $Z_i$, so $U = \lim U_i$. By
Lemma \ref{spaces-limits-lemma-finite-type-eventually-closed}
...
\source{stacks:0872}
\href{https://stacks.math.columbia.edu/tag/0872}{\texttt{Stacks tag 0872}}
\group{spaces-limits}
...
\begin{proof}
By Proposition \ref{spaces-limits-proposition-approximate}
...
$$
\begin{array}{ccc}X \longrightarrow\searrow & X_{i, Y} \longrightarrow\downarrow & X_i \downarrow \\  & Y \longrightarrow & \Spec(\mathbf{Z})\end{array}
$$
...
monomorphism. By Lemma \ref{spaces-limits-lemma-finite-type-eventually-closed}
...
Thus Lemma \ref{spaces-limits-lemma-quasi-affine-closed-in-finite-presentation}
...
\source{stacks:0873}
\href{https://stacks.math.columbia.edu/tag/0873}{\texttt{Stacks tag 0873}}
\group{spaces-limits}
...
\begin{proof}
By Lemma \ref{spaces-limits-lemma-finite-type-closed-in-finite-presentation}
...
$a \in A$. This follows from Lemma \ref{spaces-limits-lemma-eventually-separated}
...
\source{stacks:0A0W}
\href{https://stacks.math.columbia.edu/tag/0A0W}{\texttt{Stacks tag 0A0W}}
\group{spaces-limits}
...
\begin{proof}
By Proposition \ref{spaces-limits-proposition-separated-closed-in-finite-presentation}
we can find a closed immersion $X \to X'$ with $X'$ separated and of
finite presentation over $Y$. By
Lemma \ref{spaces-limits-lemma-closed-is-limit-closed-and-finite-presentation}
...
Lemma \ref{spaces-limits-lemma-eventually-closed-immersion}.
...
\source{stacks:0A0X}
\href{https://stacks.math.columbia.edu/tag/0A0X}{\texttt{Stacks tag 0A0X}}
\group{spaces-limits}
...
\begin{proof}
By Lemma \ref{spaces-limits-lemma-proper-limit-of-proper-finite-presentation}
we can write $X = \lim_{k \in K} X_k$ with $X_k \to Y$ proper and
of finite presentation. Next, by absolute Noetherian approximation
(Proposition \ref{spaces-limits-proposition-approximate}) we can
...
Lemma \ref{spaces-limits-lemma-eventually-proper}. The set $I$ will be consist
...
\source{stacks:08K2}
\href{https://stacks.math.columbia.edu/tag/08K2}{\texttt{Stacks tag 08K2}}
\group{spaces-limits}
...
By Lemma \ref{spaces-limits-lemma-eventually-proper} we see that $X_i \to Y$ is proper
...
\begin{lemma}[Embedding into affine over ls qs]
\label{spaces-limits-lemma-embedding-into-affine-over-ls-qs}
\source{stacks:088L}
\href{https://stacks.math.columbia.edu/tag/088L}{\texttt{Stacks tag 088L}}
\group{spaces-limits}
...
By Lemma \ref{spaces-limits-lemma-finite-type-eventually-closed}
...
\source{stacks:0855}
\href{https://stacks.math.columbia.edu/tag/0855}{\texttt{Stacks tag 0855}}
\group{spaces-limits}
...
\source{stacks:0856}
\href{https://stacks.math.columbia.edu/tag/0856}{\texttt{Stacks tag 0856}}
\group{spaces-limits}
...
\source{stacks:0857}
\href{https://stacks.math.columbia.edu/tag/0857}{\texttt{Stacks tag 0857}}
\group{spaces-limits}
...
Lemma \ref{spaces-limits-lemma-sections-annihilated-by-ideal} above is called
...
\source{stacks:0858}
\href{https://stacks.math.columbia.edu/tag/0858}{\texttt{Stacks tag 0858}}
\group{spaces-limits}
...
so that Lemma \ref{spaces-limits-lemma-sections-annihilated-by-ideal} applies
...
\source{stacks:0859}
\href{https://stacks.math.columbia.edu/tag/0859}{\texttt{Stacks tag 0859}}
\group{spaces-limits}
...
\source{stacks:085A}
\href{https://stacks.math.columbia.edu/tag/085A}{\texttt{Stacks tag 085A}}
\group{spaces-limits}
...
Lemma \ref{spaces-limits-lemma-sections-supported-on-closed-subset} above is called
...
\source{stacks:085B}
\href{https://stacks.math.columbia.edu/tag/085B}{\texttt{Stacks tag 085B}}
\group{spaces-limits}
...
quasi-separated implies that $f_*\mathcal{F}$ is quasi-coherent.
Hence Lemma \ref{spaces-limits-lemma-sections-supported-on-closed-subset}
...
\source{stacks:07VS}
\href{https://stacks.math.columbia.edu/tag/07VS}{\texttt{Stacks tag 07VS}}
\group{spaces-limits}
...
\medskip\noindent
By Lemma \ref{spaces-limits-lemma-finite-in-finite-and-finite-presentation}
we can write $X = \lim X_a$ with each $X_a \to Y$ finite and of
finite presentation. By
Lemma \ref{spaces-limits-lemma-limit-is-affine}
we see that $X_a$ is affine for $a$ large enough.
Hence we may and do assume that $f : X \to Y$ is finite, surjective, and
of finite presentation.

\medskip\noindent
By Proposition \ref{spaces-limits-proposition-approximate} we may write
$Y = \lim Y_i$ as a directed limit of algebraic
spaces of finite presentation over $\mathbf{Z}$.
By Lemma \ref{spaces-limits-lemma-descend-finite-presentation} we can
...
Lemma \ref{spaces-limits-lemma-descend-finite}
we see that $X_i \to Y_i$ is finite for $i$ large enough.
By Lemma \ref{spaces-limits-lemma-descend-surjective}
we see that $X_i \to Y_i$ is surjective for $i$ large enough.
By Lemma \ref{spaces-limits-lemma-limit-is-affine} we see that $X_i$ is
...
\source{stacks:07VT}
\href{https://stacks.math.columbia.edu/tag/07VT}{\texttt{Stacks tag 07VT}}
\group{spaces-limits}
...
Morphisms of Spaces, Lemma \ref{spaces-morphisms-lemma-pushforward}.
By Lemma \ref{spaces-limits-lemma-colimit-finitely-presented}
...
Lemma \ref{spaces-limits-lemma-affine}.
\end{proof}

The following corollary of the result above can be found in
\cite{CLO}.

\begin{lemma}[Reduction scheme]
\label{spaces-limits-lemma-reduction-scheme}
\source{stacks:07VU}
\href{https://stacks.math.columbia.edu/tag/07VU}{\texttt{Stacks tag 07VU}}
\group{spaces-limits}
...
\begin{lemma}[Integral universally bijective scheme]
\label{spaces-limits-lemma-integral-universally-bijective-scheme}
\source{stacks:07VV}
\href{https://stacks.math.columbia.edu/tag/07VV}{\texttt{Stacks tag 07VV}}
\group{spaces-limits}
...
$V$ is an affine scheme by Proposition \ref{spaces-limits-proposition-affine}.
This concludes the proof.
\end{proof}

\begin{lemma}[Check closed infinitesimally]
\label{spaces-limits-lemma-check-closed-infinitesimally}
\source{stacks:08B2}
\href{https://stacks.math.columbia.edu/tag/08B2}{\texttt{Stacks tag 08B2}}
\group{spaces-limits}
...
$X \times_B U$ by Lemma \ref{spaces-limits-lemma-reduction-scheme}.
...
\begin{proposition}[There is a scheme finite over]
\label{spaces-limits-proposition-there-is-a-scheme-finite-over}
\source{stacks:09YC}
\href{https://stacks.math.columbia.edu/tag/09YC}{\texttt{Stacks tag 09YC}}
\group{spaces-limits}
...
Lemma \ref{spaces-limits-lemma-integral-limit-finite-and-finite-presentation}.
...
\begin{lemma}[Integral limit finite and finite presentation refined]
\label{spaces-limits-lemma-integral-limit-finite-and-finite-presentation-refined}
\source{stacks:0GUM}
\href{https://stacks.math.columbia.edu/tag/0GUM}{\texttt{Stacks tag 0GUM}}
\group{spaces-limits}
...
\begin{lemma}[There is a scheme finite over refined]
\label{spaces-limits-lemma-there-is-a-scheme-finite-over-refined}
\source{stacks:0GUN}
\href{https://stacks.math.columbia.edu/tag/0GUN}{\texttt{Stacks tag 0GUN}}
\group{spaces-limits}
...
Lemma \ref{spaces-limits-lemma-integral-limit-finite-and-finite-presentation-refined}.
For large enough $i$ the algebraic space $Y_i$ is a scheme, see
Lemma \ref{spaces-limits-lemma-limit-is-scheme}.
...
\begin{lemma}[There is a scheme finite over filtered]
\label{spaces-limits-lemma-there-is-a-scheme-finite-over-filtered}
\source{stacks:0GUP}
\href{https://stacks.math.columbia.edu/tag/0GUP}{\texttt{Stacks tag 0GUP}}
\group{spaces-limits}
...
By Lemma \ref{spaces-limits-lemma-there-is-a-scheme-finite-over-refined}
...
\begin{lemma}[Minimal closed subspace]
\label{spaces-limits-lemma-minimal-closed-subspace}
\source{stacks:0B7Y}
\href{https://stacks.math.columbia.edu/tag/0B7Y}{\texttt{Stacks tag 0B7Y}}
\group{spaces-limits}
...
\begin{proof}
We see that $X$ is reduced by Lemma \ref{spaces-limits-lemma-reduction-scheme}.
...
Lemma \ref{spaces-limits-lemma-affine} to find an affine neighbourhood of every point.
...
\begin{lemma}[Enough local]
\label{spaces-limits-lemma-enough-local}
\source{stacks:0B80}
\href{https://stacks.math.columbia.edu/tag/0B80}{\texttt{Stacks tag 0B80}}
\group{spaces-limits}
...
$$
By Lemma \ref{spaces-limits-lemma-limit-is-scheme} we see that $X \times_S U$
is a scheme for some $U$.
\end{proof}

Instead of restricting to local rings as in Lemma \ref{spaces-limits-lemma-enough-local},
we can restrict to closed subschemes of the base.

\begin{lemma}[Maximal ideal]
\label{spaces-limits-lemma-maximal-ideal}
\source{stacks:0B81}
\href{https://stacks.math.columbia.edu/tag/0B81}{\texttt{Stacks tag 0B81}}
\group{spaces-limits}
...
$$
Thus we may apply Lemma \ref{spaces-limits-lemma-limit-is-scheme} to see that if $X_{A/I}$
...
\source{stacks:0E8Z}
\href{https://stacks.math.columbia.edu/tag/0E8Z}{\texttt{Stacks tag 0E8Z}}
\group{spaces-limits}
...
\source{stacks:0E90}
\href{https://stacks.math.columbia.edu/tag/0E90}{\texttt{Stacks tag 0E90}}
\group{spaces-limits}
...
$$
is an equivalence of categories by Lemma \ref{spaces-limits-lemma-relative-glueing}.
...
\source{stacks:0E91}
\href{https://stacks.math.columbia.edu/tag/0E91}{\texttt{Stacks tag 0E91}}
\group{spaces-limits}
...
Lemma \ref{spaces-limits-lemma-relative-glueing} the functor
$$
FP_{U \cup W}
\longrightarrow
...
\source{stacks:0E92}
\href{https://stacks.math.columbia.edu/tag/0E92}{\texttt{Stacks tag 0E92}}
\group{spaces-limits}
...
\begin{proof}
For $n = 1$ this is Lemma \ref{spaces-limits-lemma-glueing-near-closed-point}.
...
By Lemma \ref{spaces-limits-lemma-glueing-near-closed-point} we can find
...
\begin{lemma}[Excision modifications]
\label{spaces-limits-lemma-excision-modifications}
\source{stacks:0BGY}
\href{https://stacks.math.columbia.edu/tag/0BGY}{\texttt{Stacks tag 0BGY}}
\group{spaces-limits}
...
\begin{lemma}[Excision modifications properties]
\label{spaces-limits-lemma-excision-modifications-properties}
\source{stacks:0BGZ}
\href{https://stacks.math.columbia.edu/tag/0BGZ}{\texttt{Stacks tag 0BGZ}}
\group{spaces-limits}

Notation and assumptions as in Lemma \ref{spaces-limits-lemma-excision-modifications}.
...
\source{stacks:0BH0}
\href{https://stacks.math.columbia.edu/tag/0BH0}{\texttt{Stacks tag 0BH0}}
\group{spaces-limits}
...
Lemma \ref{spaces-limits-lemma-excision-modifications} and
...
\source{stacks:0CM8}
\href{https://stacks.math.columbia.edu/tag/0CM8}{\texttt{Stacks tag 0CM8}}
\group{spaces-limits}
...
$$
\begin{array}{cc}V \downarrow\underset{a}{\longrightarrow} & Z' \overset{b}{\downarrow} \\ Z \overset{g}{\longrightarrow} & Y,\end{array}
$$
...
$$
\begin{array}{cccc}W \times_Y Z \downarrow & W \times_Y V \longleftarrow\underset{a_1}{\longrightarrow}\underset{c}{\downarrow} &  & W \times_Y Z' \overset{q}{\downarrow} \\ X \times_Y Z & X \times_Y V \longleftarrow\overset{a_2}{\longrightarrow} &  & X \times_Y Z'\end{array}
$$
...
\source{stacks:0CM9}
\href{https://stacks.math.columbia.edu/tag/0CM9}{\texttt{Stacks tag 0CM9}}
\group{spaces-limits}
...
Apply Lemma \ref{spaces-limits-lemma-separate}.
...
$$
\begin{array}{ccc}X \times_Y Z \downarrow & X \times_Y V \longleftarrow\downarrow\longrightarrow & X \times_Y Z' \downarrow \\ Z & V \longleftarrow\overset{a}{\longrightarrow} & Z'\end{array}
$$
...
$$
\vcenter{
\begin{array}{cc}X \times_Y Z \downarrow\longrightarrow & \mathbf{A}^n \times X \downarrow \\ Z \longrightarrow & \mathbf{A}^n \times Y\end{array}
}
\quad
\begin{matrix}
\text{inducing the} \\
...
\source{stacks:0CMA}
\href{https://stacks.math.columbia.edu/tag/0CMA}{\texttt{Stacks tag 0CMA}}
\group{spaces-limits}
...
lemma is a special case of Lemma \ref{spaces-limits-lemma-test-universally-closed}.
\end{proof}
...
\source{stacks:0CMC}
\href{https://stacks.math.columbia.edu/tag/0CMC}{\texttt{Stacks tag 0CMC}}
\group{spaces-limits}
...
\source{stacks:0H1W}
\href{https://stacks.math.columbia.edu/tag/0H1W}{\texttt{Stacks tag 0H1W}}
\group{spaces-limits}
...
$$
\begin{array}{cc}\Spec(K) \longrightarrow\downarrow & V \downarrow \\ \Spec(A) \longrightarrow\nearrow & U\end{array}
$$
...
\source{stacks:0H1X}
\href{https://stacks.math.columbia.edu/tag/0H1X}{\texttt{Stacks tag 0H1X}}
\group{spaces-limits}
...
\medskip\noindent
Assume (5). By Lemma \ref{spaces-limits-lemma-Noetherian-dvr-valuative-separation}
...
Let
$$
\begin{array}{ccc}\Spec(K) \longrightarrow\downarrow & V \times_Y X \downarrow\longrightarrow & X \downarrow \\ \Spec(A) \longrightarrow\nearrow\nearrow & V \longrightarrow & Y\end{array}
$$
of algebraic spaces over $S$
...
$$
\begin{array}{ccc}\Spec(K) \longrightarrow\downarrow & X' \longrightarrow & X \downarrow \\ \Spec(A) \longrightarrow\overset{a}{\nearrow}\underset{b}{\nearrow} &  & Y\end{array}
$$
...
\source{stacks:0H1Y}
\href{https://stacks.math.columbia.edu/tag/0H1Y}{\texttt{Stacks tag 0H1Y}}
\group{spaces-limits}
...
Lemma \ref{spaces-limits-lemma-test-universally-closed} and
Morphisms of Spaces, Lemma
...
\ref{spaces-morphisms-lemma-universally-closed-local}.
Exactly as in the proof of Lemma \ref{spaces-limits-lemma-Noetherian-dvr-valuative-proper}
...
$|X| \to |Y|$. By Lemma \ref{spaces-limits-lemma-reach-point-closure-Noetherian}
...
\source{stacks:0CMD}
\href{https://stacks.math.columbia.edu/tag/0CMD}{\texttt{Stacks tag 0CMD}}
\group{spaces-limits}
...
\source{stacks:0CME}
\href{https://stacks.math.columbia.edu/tag/0CME}{\texttt{Stacks tag 0CME}}
\group{spaces-limits}
...
\begin{proof}
We will apply Lemma \ref{spaces-limits-lemma-refined-valuative-criterion-proper}
...
\source{stacks:0CMF}
\href{https://stacks.math.columbia.edu/tag/0CMF}{\texttt{Stacks tag 0CMF}}
\group{spaces-limits}
...
\begin{proof}
Combine Lemmas \ref{spaces-limits-lemma-refined-valuative-criterion-separated} and
...
\source{stacks:0CP6}
\href{https://stacks.math.columbia.edu/tag/0CP6}{\texttt{Stacks tag 0CP6}}
\group{spaces-limits}
...
\source{stacks:0CP7}
\href{https://stacks.math.columbia.edu/tag/0CP7}{\texttt{Stacks tag 0CP7}}
\group{spaces-limits}

In Situation \ref{spaces-limits-situation-limit-noetherian}.
...
\vcenter{
\begin{array}{cc}X \longrightarrow\downarrow & W \downarrow \\ B \longrightarrow & B_i\end{array}
}
\end{equation}
...
By Lemma \ref{spaces-limits-lemma-descend-finite-presentation}
...
\source{stacks:0CP9}
\href{https://stacks.math.columbia.edu/tag/0CP9}{\texttt{Stacks tag 0CP9}}
\group{spaces-limits}
...
\source{stacks:0CPA}
\href{https://stacks.math.columbia.edu/tag/0CPA}{\texttt{Stacks tag 0CPA}}
\group{spaces-limits}
...
$$
\vcenter{
\begin{array}{cc}X \longrightarrow\downarrow & W \downarrow \\ B \longrightarrow & B_{i_1}\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}Y \longrightarrow\downarrow & V \downarrow \\ B \longrightarrow & B_{i_2}\end{array}
}
$$
be diagrams as in (\ref{equation-good-diagram}). Let
$X = \lim_{i \geq i_1} X_i$ and
$Y = \lim_{i \geq i_2} Y_i$ be the corresponding
limit descriptions as in Lemma \ref{spaces-limits-lemma-limit-from-good-diagram}.
...
\ref{spaces-limits-proposition-characterize-locally-finite-presentation}
as improved by Lemma \ref{spaces-limits-lemma-better-characterize-relative-limit-preserving}
...
$$
\begin{array}{ccc}X \downarrow\longrightarrow & X_i \longrightarrow\downarrow\downarrow & X_{i_0} \overset{h}{\downarrow} \\ Y \longrightarrow\downarrow & Y_i \longrightarrow\downarrow & V \downarrow \\ B \longrightarrow & B_i \longrightarrow & B_{i_0}\end{array}
$$
...
that $E_i = X_i$ for $i$ large enough by Lemma \ref{spaces-limits-lemma-descend-isomorphism}.
\end{proof}

\begin{remark}[Finite type gives well defined system]
\label{spaces-limits-remark-finite-type-gives-well-defined-system}
\source{stacks:0CPB}
\href{https://stacks.math.columbia.edu/tag/0CPB}{\texttt{Stacks tag 0CPB}}
\group{spaces-limits}

In Situation \ref{spaces-limits-situation-limit-noetherian}
Lemmas \ref{spaces-limits-lemma-good-diagram}, \ref{spaces-limits-lemma-limit-from-good-diagram}, and
...
the ones produced by applying Lemma \ref{spaces-limits-lemma-limit-from-good-diagram}
...
applying Lemma \ref{spaces-limits-lemma-morphism-good-diagram} to $\text{id}_X$
(in two directions)
...
\source{stacks:0CPC}
\href{https://stacks.math.columbia.edu/tag/0CPC}{\texttt{Stacks tag 0CPC}}
\group{spaces-limits}

Notation and assumptions as in Lemma \ref{spaces-limits-lemma-morphism-good-diagram}.
...
Lemma \ref{spaces-limits-lemma-descend-flat}.
As discussed in Remark \ref{spaces-limits-remark-finite-type-gives-well-defined-system}
...
\source{stacks:0CPD}
\href{https://stacks.math.columbia.edu/tag/0CPD}{\texttt{Stacks tag 0CPD}}
\group{spaces-limits}
...
\begin{proof}
Combine Lemmas \ref{spaces-limits-lemma-morphism-good-diagram-flat} and
...
\source{stacks:0CPE}
\href{https://stacks.math.columbia.edu/tag/0CPE}{\texttt{Stacks tag 0CPE}}
\group{spaces-limits}
...
Remark \ref{spaces-limits-remark-finite-type-gives-well-defined-system}
...
Lemma \ref{spaces-limits-lemma-proper-limit-of-proper-finite-presentation}.
...
Lemmas \ref{spaces-limits-lemma-relative-approximation} and \ref{spaces-limits-lemma-eventually-proper}.
...
\source{stacks:0CPF}
\href{https://stacks.math.columbia.edu/tag/0CPF}{\texttt{Stacks tag 0CPF}}
\group{spaces-limits}

In Situation \ref{spaces-limits-situation-limit-noetherian} suppose that we have a
cartesian diagram
$$
...
$$
\begin{array}{cc}X^j \longrightarrow\downarrow & W^j \downarrow \\ B \longrightarrow & B_{i_j}\end{array}
$$
as in (\ref{equation-good-diagram}). Let
$X^j = \lim_{i \geq i_j} X^j_i$ be the corresponding limit descriptions
as in Lemma \ref{spaces-limits-lemma-morphism-good-diagram}.
Let $(a_i)_{i \geq i_5}$, $(b_i)_{i \geq i_6}$, $(p_i)_{i \geq i_7}$, and
$(q_i)_{i \geq i_8}$ be the corresponding morphisms of inverse systems
constructed in Lemma \ref{spaces-limits-lemma-morphism-good-diagram}. Then there exists an
...
Lemma \ref{spaces-limits-lemma-morphism-good-diagram-flat}
...
large $i$ by Lemma \ref{spaces-limits-lemma-descend-isomorphism}.
\end{proof}
