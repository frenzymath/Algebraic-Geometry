...
\begin{lemma}
\label{src-no-enriques-surface-over-the-integers-ch02-the-local-system-of-numerical-classes-statement-1}
\source{no-enriques-surface-over-the-integers}
\notready
...
\begin{proposition}
\label{src-no-enriques-surface-over-the-integers-ch02-the-local-system-of-numerical-classes-statement-2}
\source{no-enriques-surface-over-the-integers}
\notready
...
\begin{theorem}
\label{src-no-enriques-surface-over-the-integers-ch02-the-local-system-of-numerical-classes-statement-3}
\source{no-enriques-surface-over-the-integers}
\notready
...
\begin{lemma}
\label{src-no-enriques-surface-over-the-integers-ch02-the-local-system-of-numerical-classes-statement-4}
\source{no-enriques-surface-over-the-integers}
\notready
