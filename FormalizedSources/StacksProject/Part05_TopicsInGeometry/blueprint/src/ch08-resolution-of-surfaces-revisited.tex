...
\begin{lemma}[Modification]
\label{spaces-resolve-lemma-modification}
\source{stacks:0AE3}
\href{https://stacks.math.columbia.edu/tag/0AE3}{\texttt{Stacks tag 0AE3}}
\group{spaces-resolve}
...
\begin{lemma}[Closed immersion on fibre]
\label{spaces-resolve-lemma-closed-immersion-on-fibre}
\source{stacks:0AGM}
\href{https://stacks.math.columbia.edu/tag/0AGM}{\texttt{Stacks tag 0AGM}}
\group{spaces-resolve}
...
\begin{lemma}[Dimension special fibre]
\label{spaces-resolve-lemma-dimension-special-fibre}
\source{stacks:0AYJ}
\href{https://stacks.math.columbia.edu/tag/0AYJ}{\texttt{Stacks tag 0AYJ}}
\group{spaces-resolve}
...
\begin{lemma}[Modification of dim 2 is projective over complete]
\label{spaces-resolve-lemma-modification-of-dim-2-is-projective-over-complete}
\source{stacks:0AGN}
\href{https://stacks.math.columbia.edu/tag/0AGN}{\texttt{Stacks tag 0AGN}}
\group{spaces-resolve}
...
This follows from Lemma \ref{spaces-resolve-lemma-dimension-special-fibre}.
\end{proof}
...
\source{stacks:0BHB}
\href{https://stacks.math.columbia.edu/tag/0BHB}{\texttt{Stacks tag 0BHB}}
\group{spaces-resolve}
...
\source{stacks:0BHC}
\href{https://stacks.math.columbia.edu/tag/0BHC}{\texttt{Stacks tag 0BHC}}
\group{spaces-resolve}
...
\source{stacks:0BHD}
\href{https://stacks.math.columbia.edu/tag/0BHD}{\texttt{Stacks tag 0BHD}}
\group{spaces-resolve}
...
\begin{definition}[Blowup at point]
\label{spaces-resolve-definition-blowup-at-point}
\source{stacks:0BHE}
\href{https://stacks.math.columbia.edu/tag/0BHE}{\texttt{Stacks tag 0BHE}}
\group{spaces-resolve}
...
\source{stacks:0BHF}
\href{https://stacks.math.columbia.edu/tag/0BHF}{\texttt{Stacks tag 0BHF}}
\group{spaces-resolve}
...
(Lemma \ref{spaces-resolve-lemma-equivalence-fibre})
...
\source{stacks:0BHG}
\href{https://stacks.math.columbia.edu/tag/0BHG}{\texttt{Stacks tag 0BHG}}
\group{spaces-resolve}
...
$(U_i, u_i) \to (X, x_i)$ as in Section \ref{spaces-resolve-section-strategy}.
...
By Lemma \ref{spaces-resolve-lemma-equivalence-sequence-blowups}
...
\source{stacks:0BHH}
\href{https://stacks.math.columbia.edu/tag/0BHH}{\texttt{Stacks tag 0BHH}}
\group{spaces-resolve}
...
By Lemma \ref{spaces-resolve-lemma-make-ideal-principal}
...
\source{stacks:0BHJ}
\href{https://stacks.math.columbia.edu/tag/0BHJ}{\texttt{Stacks tag 0BHJ}}
\group{spaces-resolve}
...
of $X$ at $x$ (Definition \ref{spaces-resolve-definition-blowup-at-point})
...
\source{stacks:0BHK}
\href{https://stacks.math.columbia.edu/tag/0BHK}{\texttt{Stacks tag 0BHK}}
\group{spaces-resolve}

In Definition \ref{spaces-resolve-definition-normalized-blowup} if $X$ is Nagata,
...
Lemma \ref{spaces-resolve-lemma-equivalence-sequence-blowups}
...
\source{stacks:0BHL}
\href{https://stacks.math.columbia.edu/tag/0BHL}{\texttt{Stacks tag 0BHL}}
\group{spaces-resolve}
...
\source{stacks:0BHM}
\href{https://stacks.math.columbia.edu/tag/0BHM}{\texttt{Stacks tag 0BHM}}
\group{spaces-resolve}
...
By Lemma \ref{spaces-resolve-lemma-equivalence-sequence-normalized-blowups}
...
Lemma \ref{spaces-resolve-lemma-equivalence}.
\end{proof}
...
\source{stacks:0BHP}
\href{https://stacks.math.columbia.edu/tag/0BHP}{\texttt{Stacks tag 0BHP}}
\group{spaces-resolve}
...
\source{stacks:0BHQ}
\href{https://stacks.math.columbia.edu/tag/0BHQ}{\texttt{Stacks tag 0BHQ}}
\group{spaces-resolve}
...
\source{stacks:0BHR}
\href{https://stacks.math.columbia.edu/tag/0BHR}{\texttt{Stacks tag 0BHR}}
\group{spaces-resolve}
...
\source{stacks:0BHT}
\href{https://stacks.math.columbia.edu/tag/0BHT}{\texttt{Stacks tag 0BHT}}
\group{spaces-resolve}
...
\source{stacks:0BHU}
\href{https://stacks.math.columbia.edu/tag/0BHU}{\texttt{Stacks tag 0BHU}}
\group{spaces-resolve}
...
\begin{proof}
Parts (1) and (2) follow from Lemma \ref{spaces-resolve-lemma-regular-alteration-implies}.
...
Lemma \ref{spaces-resolve-lemma-port-regularity-to-completion}
...
is regular by Lemma \ref{spaces-resolve-lemma-port-regularity-to-completion}
...
\source{stacks:0BHW}
\href{https://stacks.math.columbia.edu/tag/0BHW}{\texttt{Stacks tag 0BHW}}
\group{spaces-resolve}
...
\source{stacks:0BHX}
\href{https://stacks.math.columbia.edu/tag/0BHX}{\texttt{Stacks tag 0BHX}}
\group{spaces-resolve}
...
\begin{theorem}[Resolve]
\label{spaces-resolve-theorem-resolve}
\source{stacks:0BHY}
\href{https://stacks.math.columbia.edu/tag/0BHY}{\texttt{Stacks tag 0BHY}}
\group{spaces-resolve}
...
is finite by Lemma \ref{spaces-resolve-lemma-regular-alteration-implies}.
...
By Lemma \ref{spaces-resolve-lemma-regular-alteration-implies-local}
...
$(V_i, v_i) \to (Y, y_i)$ as in Section \ref{spaces-resolve-section-strategy}.
...
is regular. By Lemma \ref{spaces-resolve-lemma-equivalence-sequence-normalized-blowups}
...
\source{stacks:0AE9}
\href{https://stacks.math.columbia.edu/tag/0AE9}{\texttt{Stacks tag 0AE9}}
\group{spaces-resolve}
...
\begin{example}[Completion not factorial]
\label{spaces-resolve-example-completion-not-factorial}
\source{stacks:0AEA}
\href{https://stacks.math.columbia.edu/tag/0AEA}{\texttt{Stacks tag 0AEA}}
\group{spaces-resolve}
...
\begin{example}[Not blow up]
\label{spaces-resolve-example-not-blow-up}
\source{stacks:0AEB}
\href{https://stacks.math.columbia.edu/tag/0AEB}{\texttt{Stacks tag 0AEB}}
\group{spaces-resolve}
...
Picture
$$
\begin{array}{ccc} & X'' \swarrow\searrow &  \\ X' \searrow &  & X''' \swarrow \\  & X & \end{array}
$$
