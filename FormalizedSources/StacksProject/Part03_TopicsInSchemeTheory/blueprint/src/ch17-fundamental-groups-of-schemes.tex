...
\begin{definition}[G set continuous]
\label{pione-definition-G-set-continuous}
\source{stacks:04JJ}
\href{https://stacks.math.columbia.edu/tag/04JJ}{\texttt{Stacks tag 04JJ}}
\group{pione}
...
\begin{lemma}[Sheaves point]
\label{pione-lemma-sheaves-point}
\source{stacks:03QR}
\href{https://stacks.math.columbia.edu/tag/03QR}{\texttt{Stacks tag 03QR}}
\group{pione}
...
\begin{remark}[Covering surjective]
\label{pione-remark-covering-surjective}
\source{stacks:03QS}
\href{https://stacks.math.columbia.edu/tag/03QS}{\texttt{Stacks tag 03QS}}
\group{pione}

\uses{pione-lemma-sheaves-point}
Under the correspondence of Lemma \ref{pione-lemma-sheaves-point},
...
\begin{lemma}[Aut inverse limit]
\label{pione-lemma-aut-inverse-limit}
\source{stacks:0BMR}
\href{https://stacks.math.columbia.edu/tag/0BMR}{\texttt{Stacks tag 0BMR}}
\group{pione}
...
\begin{example}[Galois category G sets]
\label{pione-example-galois-category-G-sets}
\source{stacks:0BMS}
\href{https://stacks.math.columbia.edu/tag/0BMS}{\texttt{Stacks tag 0BMS}}
\group{pione}

\uses{pione-definition-G-set-continuous}
...
Definition \ref{pione-definition-G-set-continuous}.
\end{example}
...
\begin{lemma}[Single out profinite]
\label{pione-lemma-single-out-profinite}
\source{stacks:0BMU}
\href{https://stacks.math.columbia.edu/tag/0BMU}{\texttt{Stacks tag 0BMU}}
\group{pione}

\uses{pione-lemma-aut-inverse-limit}
...
Lemma \ref{pione-lemma-aut-inverse-limit} is the profinite completion of $G$.
\end{lemma}
...
By Lemma \ref{pione-lemma-aut-inverse-limit} and the universal property
...
\begin{lemma}[Second fundamental functor]
\label{pione-lemma-second-fundamental-functor}
\source{stacks:0BMV}
\href{https://stacks.math.columbia.edu/tag/0BMV}{\texttt{Stacks tag 0BMV}}
\group{pione}
...
The diagram
$$
\begin{array}{cc}X \longrightarrow\downarrow & \{*\} \downarrow \\ \{*\} \longrightarrow & \{*\}\end{array}
$$
...
\begin{example}[From C F to G sets]
\label{pione-example-from-C-F-to-G-sets}
\source{stacks:0BMW}
\href{https://stacks.math.columbia.edu/tag/0BMW}{\texttt{Stacks tag 0BMW}}
\group{pione}

\uses{pione-lemma-aut-inverse-limit}
Let $\mathcal{C}$ be a category and let $F : \mathcal{C} \to \textit{Sets}$
be a functor such that $F(X)$ is finite for all $X \in \Ob(\mathcal{C})$.
By Lemma \ref{pione-lemma-aut-inverse-limit} we see that $G = \text{Aut}(F)$
...
\source{stacks:0BMY}
\href{https://stacks.math.columbia.edu/tag/0BMY}{\texttt{Stacks tag 0BMY}}
\group{pione}
...
\begin{lemma}[Epi mono]
\label{pione-lemma-epi-mono}
\source{stacks:0BN0}
\href{https://stacks.math.columbia.edu/tag/0BN0}{\texttt{Stacks tag 0BN0}}
\group{pione}
...
and $g \in \text{Aut}(X)$ we see that $F(g)(s) = s$ if and only
...
\source{stacks:0BN2}
\href{https://stacks.math.columbia.edu/tag/0BN2}{\texttt{Stacks tag 0BN2}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-epi-mono}

We will use the results of Lemma \ref{pione-lemma-epi-mono} without further mention.
...
\source{stacks:0BN3}
\href{https://stacks.math.columbia.edu/tag/0BN3}{\texttt{Stacks tag 0BN3}}
\group{pione}

\uses{pione-example-from-C-F-to-G-sets}
\begin{reference}
Compare with \cite[Definition 7.2.4]{BS}.
\end{reference}
Let $(\mathcal{C}, F)$ be a Galois category. Let $G = \text{Aut}(F)$
be as in Example \ref{pione-example-from-C-F-to-G-sets}. For any connected
$X$ in $\mathcal{C}$ the action of $G$ on $F(X)$ is transitive.
\end{lemma}

\begin{proof}
\uses{pione-lemma-epi-mono, pione-lemma-galois}
...
$Y \to X_{i_1} \times X_{i_2}$ by Lemma \ref{pione-lemma-galois} applied
...
Lemma \ref{pione-lemma-galois}. In this case $X$ is isomorphic to $X_i$
...
the diagram
$$
\begin{array}{cc}X_i \underset{a}{\downarrow}\underset{f_{ii'}}{\longrightarrow} & X_{i'} \overset{h_{ii'}(a)}{\downarrow} \\ X_i \overset{f_{ii'}}{\longrightarrow} & X_{i'}\end{array}
$$
...
\begin{proposition}[Galois]
\label{pione-proposition-galois}
\source{stacks:0BN4}
\href{https://stacks.math.columbia.edu/tag/0BN4}{\texttt{Stacks tag 0BN4}}
\group{pione}
...
\end{reference}
Let $(\mathcal{C}, F)$ be a Galois category. Let $G = \text{Aut}(F)$
be as in Example \ref{pione-example-from-C-F-to-G-sets}. The functor
$F : \mathcal{C} \to \textit{Finite-}G\textit{-Sets}$
(\ref{equation-remember}) an equivalence.
\end{proposition}

\begin{proof}
\uses{pione-lemma-epi-mono, pione-lemma-tame, pione-lemma-galois}

We will use the results of Lemma \ref{pione-lemma-epi-mono} without further mention.
In particular we know the functor is faithful.
By Lemma \ref{pione-lemma-tame} we know that for any connected $X$ the
...
Lemma \ref{pione-lemma-galois}. Choose an isomorphism $F(Y) = G/U$
...
\begin{lemma}[Functoriality galois]
\label{pione-lemma-functoriality-galois}
\source{stacks:0BN5}
\href{https://stacks.math.columbia.edu/tag/0BN5}{\texttt{Stacks tag 0BN5}}
\group{pione}
...
$$
\begin{array}{cc}\mathcal{C} \underset{H}{\longrightarrow}\downarrow & \mathcal{C}' \downarrow \\ \textit{Finite-}G\textit{-Sets} \overset{h}{\longrightarrow} & \textit{Finite-}G'\textit{-Sets}\end{array}
$$
...
\begin{proof}
\uses{pione-proposition-galois, pione-lemma-single-out-profinite, pione-lemma-second-fundamental-functor}

By Proposition \ref{pione-proposition-galois} and
Lemma \ref{pione-lemma-single-out-profinite} we may assume
$\mathcal{C} = \textit{Finite-}G\textit{-Sets}$ and $F$ is the
forgetful functor and similarly for $\mathcal{C}'$. Thus the existence of
$t$ follows from Lemma \ref{pione-lemma-second-fundamental-functor}. The map $h$
...
continuous homomorphism as in Lemma \ref{pione-lemma-functoriality-galois}.
In this section we consider the corresponding $2$-commutative diagram
\begin{equation}
\label{equation-translation}
\vcenter{
\begin{array}{ccc}\mathcal{C} \underset{H}{\longrightarrow}\downarrow & \mathcal{C}' \underset{H'}{\longrightarrow}\downarrow & \mathcal{C}'' \downarrow \\ \textit{Finite-}G\textit{-Sets} \overset{h}{\longrightarrow} & \textit{Finite-}G'\textit{-Sets} \overset{h'}{\longrightarrow} & \textit{Finite-}G''\textit{-Sets}\end{array}
}
\end{equation}
and we relate exactness properties of the sequence
$1 \to G'' \to G' \to G \to 1$ to properties of the functors $H$ and $H'$.

\begin{lemma}[Functoriality galois surjective]
\label{pione-lemma-functoriality-galois-surjective}
\source{stacks:0BN6}
\href{https://stacks.math.columbia.edu/tag/0BN6}{\texttt{Stacks tag 0BN6}}
\group{pione}
...
\begin{lemma}[Composition trivial]
\label{pione-lemma-composition-trivial}
\source{stacks:0BS8}
\href{https://stacks.math.columbia.edu/tag/0BS8}{\texttt{Stacks tag 0BS8}}
\group{pione}
...
\begin{lemma}[Functoriality galois ses]
\label{pione-lemma-functoriality-galois-ses}
\source{stacks:0BS9}
\href{https://stacks.math.columbia.edu/tag/0BS9}{\texttt{Stacks tag 0BS9}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-functoriality-galois-surjective, pione-lemma-composition-trivial}

By Lemmas \ref{pione-lemma-functoriality-galois-surjective} and
\ref{pione-lemma-composition-trivial} we may assume that
...
\begin{lemma}[Functoriality galois injective]
\label{pione-lemma-functoriality-galois-injective}
\source{stacks:0BN7}
\href{https://stacks.math.columbia.edu/tag/0BN7}{\texttt{Stacks tag 0BN7}}
\group{pione}
...
\begin{lemma}[Functoriality galois normal]
\label{pione-lemma-functoriality-galois-normal}
\source{stacks:0BTS}
\href{https://stacks.math.columbia.edu/tag/0BTS}{\texttt{Stacks tag 0BTS}}
\group{pione}
...
the diagram
$$
\begin{array}{ccc}Y \longrightarrow\searrow &  & Y' \swarrow \\  & X & \end{array}
$$
commute.
\end{enumerate}
...
\begin{example}[Finite etale geometric point]
\label{pione-example-finite-etale-geometric-point}
\source{stacks:0BN8}
\href{https://stacks.math.columbia.edu/tag/0BN8}{\texttt{Stacks tag 0BN8}}
\group{pione}
...
\begin{lemma}[Finite etale covers limits colimits]
\label{pione-lemma-finite-etale-covers-limits-colimits}
\source{stacks:0BN9}
\href{https://stacks.math.columbia.edu/tag/0BN9}{\texttt{Stacks tag 0BN9}}
\group{pione}
...
\begin{remark}[Colimits commute forgetful]
\label{pione-remark-colimits-commute-forgetful}
\source{stacks:0BNA}
\href{https://stacks.math.columbia.edu/tag/0BNA}{\texttt{Stacks tag 0BNA}}
\group{pione}

\uses{pione-lemma-finite-etale-covers-limits-colimits}
...
the proof of Lemma \ref{pione-lemma-finite-etale-covers-limits-colimits}
...
In the proof of Lemma \ref{pione-lemma-finite-etale-covers-limits-colimits}
we saw that coequalizers in $\textit{F\'Et}_X$ look \'etale locally
like this
$$
\begin{array}{ccc}\coprod_{j \in J} U \overset{a}{\longrightarrow}\underset{b}{\longrightarrow} & \coprod_{i \in I} U \longrightarrow & \coprod_{t \in \text{Coeq}(a, b)} U\end{array}
$$
...
\begin{lemma}[Internal hom finite etale]
\label{pione-lemma-internal-hom-finite-etale}
\source{stacks:0BL7}
\href{https://stacks.math.columbia.edu/tag/0BL7}{\texttt{Stacks tag 0BL7}}
\group{pione}
...
\end{matrix}
\vcenter{
\begin{array}{cc}\overline{x} \underset{\overline{x}}{\searrow}\underset{\overline{u}}{\longrightarrow} & U \downarrow \\  & X\end{array}
}
\right\}
$$
...
\begin{lemma}[Finite etale connected galois category]
\label{pione-lemma-finite-etale-connected-galois-category}
\source{stacks:0BNB}
\href{https://stacks.math.columbia.edu/tag/0BNB}{\texttt{Stacks tag 0BNB}}
\group{pione}

\uses{pione-definition-galois-category}
...
$$
defines a Galois category (Definition \ref{pione-definition-galois-category}).
\end{lemma}

\begin{proof}
\uses{pione-example-finite-etale-geometric-point, pione-lemma-finite-etale-covers-limits-colimits, pione-remark-colimits-commute-forgetful, pione-definition-galois-category}

After identifying $\textit{F\'Et}_{\overline{x}}$ with the category of
finite sets (Example \ref{pione-example-finite-etale-geometric-point})
...
Lemma \ref{pione-lemma-finite-etale-covers-limits-colimits}.
We will also use that finite limits in $\textit{F\'Et}_X$
agree with the corresponding finite limits in the category
of schemes over $X$, see Remark \ref{pione-remark-colimits-commute-forgetful}.
...
It follows that $Y$ is a connected object of the category
$\textit{F\'Et}_X$ (as in Definition \ref{pione-definition-galois-category})
...
Definition \ref{pione-definition-galois-category}.
...
Lemma \ref{pione-lemma-finite-etale-connected-galois-category}.

\begin{definition}[Fundamental group]
\label{pione-definition-fundamental-group}
\source{stacks:0BNC}
\href{https://stacks.math.columbia.edu/tag/0BNC}{\texttt{Stacks tag 0BNC}}
\group{pione}
...
Lemma \ref{pione-lemma-aut-inverse-limit}.
\end{definition}

Combining the above with the material from Section \ref{pione-section-galois}
we obtain the following theorem.

\begin{theorem}[Fundamental group]
\label{pione-theorem-fundamental-group}
\source{stacks:0BND}
\href{https://stacks.math.columbia.edu/tag/0BND}{\texttt{Stacks tag 0BND}}
\group{pione}
...
$$
\begin{array}{cc}\textit{F\'Et}_Y \underset{\text{base change}}{\longrightarrow}\underset{F_{\overline{y}}}{\downarrow} & \textit{F\'Et}_X \overset{F_{\overline{x}}}{\downarrow} \\ \textit{Finite-}\pi_1(Y, \overline{y})\textit{-Sets} \overset{f_*}{\longrightarrow} & \textit{Finite-}\pi_1(X, \overline{x})\textit{-Sets}\end{array}
$$
is commutative.
\end{enumerate}
\end{theorem}
...
\begin{proof}
\uses{pione-lemma-finite-etale-connected-galois-category, pione-proposition-galois, pione-lemma-functoriality-galois}

Part (1) follows from Lemma \ref{pione-lemma-finite-etale-connected-galois-category}
and Proposition \ref{pione-proposition-galois}.
Part (2) is a special case of Lemma \ref{pione-lemma-functoriality-galois}.
For part (3) observe that the diagram
$$
\begin{array}{cc}\textit{F\'Et}_Y \longrightarrow\underset{F_{\overline{y}}}{\downarrow} & \textit{F\'Et}_X \overset{F_{\overline{x}}}{\downarrow} \\ \textit{Sets} \xlongequal{} & \textit{Sets}\end{array}
$$
is commutative (actually commutative, not just $2$-commutative) because
$\overline{y} = f \circ \overline{x}$. Hence
we can apply Lemma \ref{pione-lemma-functoriality-galois} with the implied
transformation of functors to get (3).
\end{proof}

\begin{lemma}[Fundamental group Galois group]
\label{pione-lemma-fundamental-group-Galois-group}
\source{stacks:0BNE}
\href{https://stacks.math.columbia.edu/tag/0BNE}{\texttt{Stacks tag 0BNE}}
\group{pione}
...
\begin{enumerate}
\item The functor of Lemma \ref{pione-lemma-sheaves-point} induces an equivalence
$$
\textit{F\'Et}_X \longrightarrow
...
\begin{proof}
\uses{pione-lemma-sheaves-point, pione-lemma-functoriality-galois, pione-lemma-single-out-profinite}

The functor of Lemma \ref{pione-lemma-sheaves-point} is the same as the functor
$F_{\overline{x}}$ because for any $Y$ \'etale over $X$ we have
$$
\Mor_X(\Spec(\overline{K}), Y) = \Mor_X(\Spec(K^{sep}), Y)
$$
Namely, as seen in the proof of Lemma \ref{pione-lemma-sheaves-point} we have
...
Lemma \ref{pione-lemma-functoriality-galois}, and
Lemma \ref{pione-lemma-single-out-profinite}.
...
\source{stacks:0BQ9}
\href{https://stacks.math.columbia.edu/tag/0BQ9}{\texttt{Stacks tag 0BQ9}}
\group{pione}

\uses{pione-lemma-fundamental-group-Galois-group}
In the situation of Lemma \ref{pione-lemma-fundamental-group-Galois-group}
...
Galois category (Lemma \ref{pione-lemma-finite-etale-connected-galois-category})
the material in Section \ref{pione-section-galois} applies.
In this section we explicitly transfer some of the terminology
...
\textit{Finite-}\pi_1(X, \overline{x})\textit{-Sets}
$$
of Theorem \ref{pione-theorem-fundamental-group},
...
See Proposition \ref{pione-proposition-universal-homeomorphism}.
...
\begin{lemma}[What equivalence gives]
\label{pione-lemma-what-equivalence-gives}
\source{stacks:0BQA}
\href{https://stacks.math.columbia.edu/tag/0BQA}{\texttt{Stacks tag 0BQA}}
\group{pione}
...
\source{stacks:09ZS}
\href{https://stacks.math.columbia.edu/tag/09ZS}{\texttt{Stacks tag 09ZS}}
\group{pione}
...
\source{stacks:0BQB}
\href{https://stacks.math.columbia.edu/tag/0BQB}{\texttt{Stacks tag 0BQB}}
\group{pione}
...
and the result follows from Lemma \ref{pione-lemma-gabber} (which is
...
\begin{proposition}[Universal homeomorphism]
\label{pione-proposition-universal-homeomorphism}
\source{stacks:0BQN}
\href{https://stacks.math.columbia.edu/tag/0BQN}{\texttt{Stacks tag 0BQN}}
\group{pione}
...
Thus by Lemma \ref{pione-lemma-thickening}
...
group of its special fibre. We also prove a variant of this result for
a henselian pair.

\medskip\noindent
We also show that the fundamental
...
Lemma \ref{pione-lemma-what-equivalence-gives}.

\begin{lemma}[Finite etale on proper over henselian]
\label{pione-lemma-finite-etale-on-proper-over-henselian}
\source{stacks:0A48}
\href{https://stacks.math.columbia.edu/tag/0A48}{\texttt{Stacks tag 0A48}}
\group{pione}
...
\begin{lemma}[Finite etale on proper over henselian pair]
\label{pione-lemma-finite-etale-on-proper-over-henselian-pair}
\source{stacks:0GS2}
\href{https://stacks.math.columbia.edu/tag/0GS2}{\texttt{Stacks tag 0GS2}}
\group{pione}

Let $(A, I)$ be a henselian pair. Let $X$ be a proper scheme over $A$.
...
\begin{proof}
\uses{pione-lemma-finite-etale-on-proper-over-henselian}

The proof of this lemma is exactly the same as the proof of
Lemma \ref{pione-lemma-finite-etale-on-proper-over-henselian}.

\medskip\noindent
Essential surjectivity when $A$ is Noetherian and $I$-adically complete.
Let $X_n = X \times_{\Spec(A)} \Spec(A/I^{n + 1})$.
By \'Etale Morphisms, Theorem \ref{etale-theorem-remarkable-equivalence}
the inclusions
$$
X_0 \to X_1 \to X_2 \to \ldots
...
by More on Morphisms, Lemma
\ref{more-morphisms-lemma-thicken-property-morphisms-cartesian}.
In this case the morphism $U_0 \to \Spec(A/I)$
is proper as $X_0$ is proper over $A/I$. Thus we may apply
Grothendieck's algebraization theorem
(in the form of
Cohomology of Schemes, Lemma
\ref{coherent-lemma-algebraize-formal-scheme-finite-over-proper})
...
\medskip\noindent
Fully faithfulness when $A$ is Noetherian and $I$-adically complete.
Let $U \to X$ and $V \to X$ be finite \'etale morphisms and
let $\varphi_0 : U_0 \to V_0$ be a morphism over $X_0$. Look at
the morphism
$$
...
\medskip\noindent
Essential surjectivity when $(A, I)$ is a henselian pair
and $A$ is a Noetherian G-ring.
Let $U_0 \to X_0$ be a finite \'etale morphism.
Let $A^\wedge$ be the completion of $A$ with respect to $I$.
Observe that $A^\wedge$ is a Noetherian ring which is
$IA^\wedge$-adically complete, see Algebra, Lemmas
...
the ring map $A_i \to A^\wedge$ can be reinterpreted as a solution
$(a_1, \ldots, a_n)$ in $A^\wedge$ for the system of equations $f_j = 0$.
By Smoothing Ring Maps, Lemma \ref{smoothing-lemma-henselian-pair}
we can approximate this solution (to order $11$ for example) by a solution
$(b_1, \ldots, b_n)$ in $A$. Translating back we find an $A$-algebra map
$A_i \to A$ which gives the same closed point as the original map
$A_i \to A^\wedge$ (as $11 > 1$). The base change $U \to X$ of $V \to X_{A_i}$
...
\medskip\noindent
Fully faithfulness when $(A, I$ is a henselian pair and $A$ is a Noetherian
G-ring. This can be deduced from essential surjectivity in exactly the same
manner as was done in the case that $A$ is complete Noetherian.

\medskip\noindent
General case. Let $(A, I)$ be a henselian pair.
Set $S = \Spec(A)$ and denote $S_0 = \Spec(A/I)$. By Limits, Lemma
\ref{limits-lemma-proper-limit-of-proper-finite-presentation-noetherian}
we can write $X \to \Spec(A)$ as a cofiltered limit of
proper morphisms $X_i \to S_i$ with $S_i$ affine and of finite type
over $\mathbf{Z}$. Write $S_i = \Spec(A_i)$ and denote
$I_i \subset A_i$ the inverse image of $I$ by the map $A_i \to A$.
Set $S_{i, 0} = \Spec(A_i/I_i)$. Since $S = \lim S_i$ we have
$A = \colim A_i$. Thus we also have $I = \colim I_i$ and $A/I = \colim A_i/I_i$.
The ring $A_i$ is a Noetherian G-ring (More on Algebra, Proposition
\ref{more-algebra-proposition-ubiquity-G-ring}).
Denote $(A_i^h, I_i^h)$ the henselization of the pair $(A_i, I_i)$.
By More on Algebra, Lemma \ref{more-algebra-lemma-henselization-colimit}
we see that $A = \colim A_i^h$. By
More on Algebra, Lemma \ref{more-algebra-lemma-henselization-pair-G-ring}
the rings $A_i^h$ are G-rings. Thus we see that $A = \colim A_i^h$ and
$$
X = \lim (X_i \times_{S_i} \Spec(A_i^h))
$$
...
\begin{lemma}[Finite etale invariant over proper]
\label{pione-lemma-finite-etale-invariant-over-proper}
\source{stacks:0A49}
\href{https://stacks.math.columbia.edu/tag/0A49}{\texttt{Stacks tag 0A49}}
\group{pione}
...
\begin{lemma}[Dense faithful]
\label{pione-lemma-dense-faithful}
\source{stacks:0BQE}
\href{https://stacks.math.columbia.edu/tag/0BQE}{\texttt{Stacks tag 0BQE}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-internal-hom-finite-etale}

Since the category of finite \'etale coverings has an
internal hom (Lemma \ref{pione-lemma-internal-hom-finite-etale})
...
\begin{lemma}[Same etale extensions]
\label{pione-lemma-same-etale-extensions}
\source{stacks:0BLQ}
\href{https://stacks.math.columbia.edu/tag/0BLQ}{\texttt{Stacks tag 0BLQ}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-internal-hom-finite-etale, pione-lemma-dense-faithful}
...
$t'_1 = t'_2$ by Lemma \ref{pione-lemma-dense-faithful}.
Hence $t^{sh}$ descends to a morphism $t : X \to Y$
for example by
Descent, Lemma \ref{descent-lemma-fpqc-universal-effective-epimorphisms}.
\end{proof}

In view of Lemma \ref{pione-lemma-same-etale-extensions}
...
\begin{lemma}[Quasi compact dense open connected at infinity Noetherian]
\label{pione-lemma-quasi-compact-dense-open-connected-at-infinity-Noetherian}
\source{stacks:0BQF}
\href{https://stacks.math.columbia.edu/tag/0BQF}{\texttt{Stacks tag 0BQF}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-dense-faithful, pione-lemma-same-etale-extensions}
...
Uniqueness follows from Lemma \ref{pione-lemma-dense-faithful}.
...
Lemma \ref{pione-lemma-same-etale-extensions}
...
\begin{lemma}[Retrocompact dense open connected at infinity closed]
\label{pione-lemma-retrocompact-dense-open-connected-at-infinity-closed}
\source{stacks:0BSA}
\href{https://stacks.math.columbia.edu/tag/0BSA}{\texttt{Stacks tag 0BSA}}
\group{pione}
...
(Lemma \ref{pione-lemma-dense-faithful}). Thus we can extend $\varphi$
to $\bigcup U'_x = X$ as desired.
\end{proof}

\begin{lemma}[Quasi compact dense open connected at infinity]
\label{pione-lemma-quasi-compact-dense-open-connected-at-infinity}
\source{stacks:0BQG}
\href{https://stacks.math.columbia.edu/tag/0BQG}{\texttt{Stacks tag 0BQG}}
\group{pione}
...
$W'' \cap U$, we see by Lemma \ref{pione-lemma-dense-faithful}
...
\begin{lemma}[Local exact sequence]
\label{pione-lemma-local-exact-sequence}
\source{stacks:0BSB}
\href{https://stacks.math.columbia.edu/tag/0BSB}{\texttt{Stacks tag 0BSB}}
\group{pione}

\uses{pione-lemma-functoriality-galois-ses}
...
$$
is exact in the sense of Lemma \ref{pione-lemma-functoriality-galois-ses} part (1).
\end{lemma}

\begin{proof}
\uses{pione-lemma-same-etale-extensions, pione-lemma-functoriality-galois-surjective, pione-lemma-composition-trivial, pione-lemma-functoriality-galois-ses, pione-lemma-retrocompact-dense-open-connected-at-infinity-closed}

The map $\pi_1(U) \to \pi_1(X)$ is surjective by
Lemmas \ref{pione-lemma-same-etale-extensions} and
...
Lemma \ref{pione-lemma-composition-trivial}.

\medskip\noindent
To finish the proof, it suffices according to
Lemma \ref{pione-lemma-functoriality-galois-ses}
...
$$
\begin{array}{cccc}U \downarrow & U^{sh} \downarrow\longleftarrow & U^{sh} \times_U U^{sh} \downarrow\longleftarrow\longleftarrow & U^{sh} \times_U U^{sh} \times_U U^{sh}
\downarrow\longleftarrow\longleftarrow\longleftarrow \\ X & X^{sh} \longleftarrow & X^{sh} \times_X X^{sh} \longleftarrow\longleftarrow & X^{sh} \times_X X^{sh} \times_X X^{sh} \longleftarrow\longleftarrow\longleftarrow\end{array}
$$
...
Lemma \ref{pione-lemma-retrocompact-dense-open-connected-at-infinity-closed}
...
Lemma \ref{pione-lemma-fundamental-group-Galois-group}.

\begin{lemma}[Irreducible geometrically unibranch]
\label{pione-lemma-irreducible-geometrically-unibranch}
\source{stacks:0BQI}
\href{https://stacks.math.columbia.edu/tag/0BQI}{\texttt{Stacks tag 0BQI}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-thickening, pione-lemma-functoriality-galois-surjective, pione-lemma-quasi-compact-dense-open-connected-at-infinity}

By Lemma \ref{pione-lemma-thickening} we may replace $X$ by its reduction.
Thus we may assume that $X$ is an integral scheme. By
Lemma \ref{pione-lemma-functoriality-galois-surjective}
...
from Lemma \ref{pione-lemma-quasi-compact-dense-open-connected-at-infinity}
...
\begin{lemma}[Exact sequence finite nr closed pts]
\label{pione-lemma-exact-sequence-finite-nr-closed-pts}
\source{stacks:0BSC}
\href{https://stacks.math.columbia.edu/tag/0BSC}{\texttt{Stacks tag 0BSC}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-retrocompact-dense-open-connected-at-infinity-closed, pione-lemma-functoriality-galois-surjective, pione-lemma-functoriality-galois-ses, pione-lemma-local-exact-sequence}

Surjectivity follows from
Lemmas \ref{pione-lemma-retrocompact-dense-open-connected-at-infinity-closed} and
\ref{pione-lemma-functoriality-galois-surjective}.
...
$$
\begin{array}{ccc}U \downarrow & \Spec(A) \setminus \{\mathfrak m\} \longleftarrow\downarrow & U^{sh} \downarrow\longleftarrow \\ X & \Spec(A) \longleftarrow & \Spec(A^{sh}) \longleftarrow\end{array}
$$
By Lemma \ref{pione-lemma-functoriality-galois-ses}
...
By Lemma \ref{pione-lemma-local-exact-sequence}
...
Let $L/K$ be a finite extension. Consider the normalization
...
Lemma \ref{pione-lemma-unramified} we will elucidate this condition.
...
\begin{lemma}[Unramified in L]
\label{pione-lemma-unramified-in-L}
\source{stacks:0BQK}
\href{https://stacks.math.columbia.edu/tag/0BQK}{\texttt{Stacks tag 0BQK}}
\group{pione}
...
\medskip\noindent
Conversely, assume $Y \to X$ is unramified. Since a normal scheme is
geometrically unibranch
(Properties, Lemma \ref{properties-lemma-normal-geometrically-unibranch}),
we see that the morphism $Y \to X$ is \'etale by More on Morphisms, Lemma
\ref{more-morphisms-lemma-global-unramified-dominant-unibranch-is-etale}.
We also give a direct proof in the next paragraph.
...
\begin{lemma}[Finite etale covering normal unramified]
\label{pione-lemma-finite-etale-covering-normal-unramified}
\source{stacks:0BQL}
\href{https://stacks.math.columbia.edu/tag/0BQL}{\texttt{Stacks tag 0BQL}}
\group{pione}
...
\source{stacks:0BQM}
\href{https://stacks.math.columbia.edu/tag/0BQM}{\texttt{Stacks tag 0BQM}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-irreducible-geometrically-unibranch, pione-theorem-fundamental-group, pione-lemma-fundamental-group-Galois-group, pione-lemma-unramified-in-L, pione-lemma-finite-etale-covering-normal-unramified}

The normal scheme $X$ is geometrically unibranch
(Properties, Lemma \ref{properties-lemma-normal-geometrically-unibranch}).
Hence Lemma \ref{pione-lemma-irreducible-geometrically-unibranch} applies to $X$.
Thus $\pi_1(\eta, \overline{\eta}) \to \pi_1(X, \overline{\eta})$
is surjective and top horizontal arrow of the commutative diagram
$$
\begin{array}{cc}\textit{F\'Et}_X \longrightarrow\downarrow\underset{c}{\searrow} & \textit{F\'Et}_\eta \downarrow \\ \textit{Finite-}\pi_1(X, \overline{\eta})\textit{-sets} \longrightarrow & \textit{Finite-}\text{Gal}(K^{sep}/K)\textit{-sets}\end{array}
$$
is fully faithful. The left vertical arrow is the equivalence of
Theorem \ref{pione-theorem-fundamental-group}
and the right vertical arrow is the equivalence of
Lemma \ref{pione-lemma-fundamental-group-Galois-group}. The lower
horizontal arrow is induced by the map of the proposition.
By Lemmas \ref{pione-lemma-unramified-in-L} and
...
\begin{lemma}[Local exact sequence normal]
\label{pione-lemma-local-exact-sequence-normal}
\source{stacks:0BSM}
\href{https://stacks.math.columbia.edu/tag/0BSM}{\texttt{Stacks tag 0BSM}}
\group{pione}
...
\begin{proof}
\uses{pione-proposition-normal, pione-lemma-composition-trivial, pione-lemma-functoriality-galois-ses}
...
\begin{lemma}[Get algebraic closure]
\label{pione-lemma-get-algebraic-closure}
\source{stacks:0BSP}
\href{https://stacks.math.columbia.edu/tag/0BSP}{\texttt{Stacks tag 0BSP}}
\group{pione}
...
\begin{lemma}[Normal local domain separablly closed fraction field]
\label{pione-lemma-normal-local-domain-separablly-closed-fraction-field}
\source{stacks:0BSQ}
\href{https://stacks.math.columbia.edu/tag/0BSQ}{\texttt{Stacks tag 0BSQ}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-get-algebraic-closure}
...
by Lemma \ref{pione-lemma-get-algebraic-closure} and it suffices to
...
\begin{lemma}[Inertia base change]
\label{pione-lemma-inertia-base-change}
\source{stacks:0BSS}
\href{https://stacks.math.columbia.edu/tag/0BSS}{\texttt{Stacks tag 0BSS}}
\group{pione}
...
\begin{lemma}[Inertia invariants etale]
\label{pione-lemma-inertia-invariants-etale}
\source{stacks:0BST}
\href{https://stacks.math.columbia.edu/tag/0BST}{\texttt{Stacks tag 0BST}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-inertia-base-change}
...
By Lemma \ref{pione-lemma-inertia-base-change} the group $I$ does not change.
...
Thus
$$
\begin{array}{cc}\Spec((A \otimes_{R^G} R)^I) \downarrow\longrightarrow & \Spec(R^I) \downarrow \\ \Spec(A) \longrightarrow & \Spec(R^G)\end{array}
$$
...
\begin{lemma}[Inertial invariants unramified]
\label{pione-lemma-inertial-invariants-unramified}
\source{stacks:0BSU}
\href{https://stacks.math.columbia.edu/tag/0BSU}{\texttt{Stacks tag 0BSU}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-inertia-invariants-etale}
...
Lemma \ref{pione-lemma-inertia-invariants-etale}.
\end{proof}
...
Lemma \ref{pione-lemma-normal-local-domain-separablly-closed-fraction-field}
...
of $\kappa$ by Lemma \ref{pione-lemma-get-algebraic-closure}.}
...
$$
\begin{array}{cccc}K^{sep} & K^{sh} \longleftarrow & K^h \longleftarrow & K \longleftarrow \\ (A^{sep})_{\mathfrak m^{sep}} \uparrow & A^{sh} \uparrow\longleftarrow & A^h \uparrow\longleftarrow & A \uparrow\longleftarrow\end{array}
$$
...
\vcenter{
\begin{array}{ccc}\pi_1(U^{sh}) \longrightarrow\underset{1}{\searrow} & \pi_1(U^h) \downarrow\longrightarrow & \pi_1(U) \downarrow \\  & \pi_1(X^h) \longrightarrow & \pi_1(X)\end{array}
}
\end{equation}
...
\begin{lemma}[Identify inertia]
\label{pione-lemma-identify-inertia}
\source{stacks:0BSW}
\href{https://stacks.math.columbia.edu/tag/0BSW}{\texttt{Stacks tag 0BSW}}
\group{pione}
...
$$
\begin{array}{ccc}I \longrightarrow\underset{1}{\searrow} & D \downarrow\longrightarrow & \text{Gal}(K^{sep}/K) \downarrow \\  & \text{Gal}(\kappa(\mathfrak m^{sh})/\kappa) \longrightarrow & \text{Gal}(M/K)\end{array}
$$
...
\begin{proof}
\uses{pione-lemma-inertial-invariants-unramified, pione-lemma-fundamental-group-Galois-group, pione-lemma-gabber, pione-proposition-normal, pione-lemma-local-exact-sequence-normal}
...
On the other hand,
Lemma \ref{pione-lemma-inertial-invariants-unramified}
...
\text{Gal}(\kappa(\mathfrak m^{sh})/\kappa)
$$
Let $\kappa'/\kappa$ be a finite Galois extension with
...
correspond via
Lemma \ref{pione-lemma-fundamental-group-Galois-group}.
By Lemma \ref{pione-lemma-gabber} we have
...
By Proposition \ref{pione-proposition-normal}
we see that $\pi_1(X) = \text{Gal}(M/K)$.
Finally, the statement on the kernel of
$\text{Gal}(K^{sep}/K) \to \text{Gal}(M/K) = \pi_1(X)$
follows from Lemma \ref{pione-lemma-local-exact-sequence-normal}.
...
\begin{lemma}[Normal pione quotient inertia]
\label{pione-lemma-normal-pione-quotient-inertia}
\source{stacks:0BTD}
\href{https://stacks.math.columbia.edu/tag/0BTD}{\texttt{Stacks tag 0BTD}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-identify-inertia, pione-lemma-local-exact-sequence-normal, pione-proposition-normal, pione-lemma-inertia-invariants-etale}

The equivalence of (2) and (3) follows from
Lemma \ref{pione-lemma-identify-inertia}
which tells us that $I_y$ is conjugate to $\text{Gal}(K^{sep}/K_x^{sh})$
if $y$ lies over $x$. By Lemma \ref{pione-lemma-local-exact-sequence-normal}
...
(Section \ref{pione-section-normal}, especially
Proposition \ref{pione-proposition-normal}).
...
Lemma \ref{pione-lemma-inertia-invariants-etale}.
(Alternative: you can use Lemma \ref{pione-lemma-local-exact-sequence-normal}
to see that the pullback of $Y$ to $\Spec(\mathcal{O}_{X, x})$ is
\'etale for all $x \in X$ and then conclude from there
with a bit more work.)
\end{proof}

\begin{example}[Bigger codim]
\label{pione-example-bigger-codim}
\source{stacks:0BTE}
\href{https://stacks.math.columbia.edu/tag/0BTE}{\texttt{Stacks tag 0BTE}}
\group{pione}

\uses{pione-lemma-normal-pione-quotient-inertia}
...
it suffices in Lemma \ref{pione-lemma-normal-pione-quotient-inertia}
...
\source{stacks:0BTF}
\href{https://stacks.math.columbia.edu/tag/0BTF}{\texttt{Stacks tag 0BTF}}
\group{pione}
...
\begin{enumerate}
\item $X$ is unramified in $L$ as defined in Section \ref{pione-section-normal},
...
\begin{proof}
\uses{pione-lemma-unramified-in-L, pione-lemma-inertial-invariants-unramified}

The equivalence of (1) and (2) is the definition of (1).
The equivalence of (2), (3), and (4) is Lemma \ref{pione-lemma-unramified-in-L}.
...
Hence by Lemma \ref{pione-lemma-unramified-in-L} (applied to the factors
...
by Lemma \ref{pione-lemma-inertial-invariants-unramified}.
...
\begin{lemma}[Structure decomposition]
\label{pione-lemma-structure-decomposition}
\source{stacks:0BUA}
\href{https://stacks.math.columbia.edu/tag/0BUA}{\texttt{Stacks tag 0BUA}}
\group{pione}
...
$$
\begin{array}{cccc}P_\lambda \downarrow\longrightarrow & I_\lambda \downarrow\longrightarrow & D_\lambda \downarrow\longrightarrow & G_\lambda \downarrow \\ P_{\lambda'} \longrightarrow & I_{\lambda'} \longrightarrow & D_{\lambda'} \longrightarrow & G_{\lambda'}\end{array}
$$
...
$$
\begin{array}{cc}I_\lambda \underset{\theta_{\lambda, can}}{\longrightarrow}\downarrow & \mu_{n_\lambda}(\kappa(\mathfrak m_\lambda))
\overset{(-)^{n_\lambda/n_{\lambda'}}}{\downarrow} \\ I_{\lambda'} \overset{\theta_{\lambda', can}}{\longrightarrow} & \mu_{n_{\lambda'}}(\kappa(\mathfrak m_{\lambda'}))\end{array}
$$
see
...
$$
\begin{array}{cc}I \downarrow\underset{\theta_{can}}{\longrightarrow} & \lim_{n \in S} \mu_n(\kappa(\mathfrak m)) \downarrow \\ I_{\lambda} \overset{\theta_{\lambda, can}}{\longrightarrow} & \mu_{n_\lambda}(\kappa(\mathfrak m_\lambda))\end{array}
$$
...
\begin{lemma}[Structure decomposition separable closure]
\label{pione-lemma-structure-decomposition-separable-closure}
\source{stacks:0BUB}
\href{https://stacks.math.columbia.edu/tag/0BUB}{\texttt{Stacks tag 0BUB}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-get-algebraic-closure, pione-lemma-structure-decomposition}

The field $\overline{\kappa}$ is the algebraic closure of $\kappa$ by
Lemma \ref{pione-lemma-get-algebraic-closure}.
Most of the statements immediately follow from the corresponding
parts of Lemma \ref{pione-lemma-structure-decomposition}. For example because
...
with $S$ as in Lemma \ref{pione-lemma-structure-decomposition} the
...
Lemma \ref{pione-lemma-structure-decomposition}
...
\source{stacks:0BTV}
\href{https://stacks.math.columbia.edu/tag/0BTV}{\texttt{Stacks tag 0BTV}}
\group{pione}
...
\begin{lemma}[Perfection]
\label{pione-lemma-perfection}
\source{stacks:0BTW}
\href{https://stacks.math.columbia.edu/tag/0BTW}{\texttt{Stacks tag 0BTW}}
\group{pione}
...
\begin{proof}
\uses{pione-proposition-universal-homeomorphism}
...
\begin{lemma}[Ses field]
\label{pione-lemma-ses-field}
\source{stacks:0BTX}
\href{https://stacks.math.columbia.edu/tag/0BTX}{\texttt{Stacks tag 0BTX}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-functoriality-galois-surjective, pione-lemma-perfection, pione-lemma-composition-trivial, pione-lemma-functoriality-galois-normal, pione-lemma-limit, pione-lemma-functoriality-galois-injective, pione-lemma-functoriality-galois-ses}
...
$\pi_1(\Spec(k^{perf})) = \pi_1(\Spec(k))$ by Lemma \ref{pione-lemma-perfection}.
...
is the trivial homomorphism by Lemma \ref{pione-lemma-composition-trivial}.
...
Lemma \ref{pione-lemma-functoriality-galois-normal} we conclude that the image of
...
By Lemma \ref{pione-lemma-limit} we find a finite separable extension $k'/k$
...
Lemma \ref{pione-lemma-functoriality-galois-injective}
...
See Lemma \ref{pione-lemma-functoriality-galois-ses}.
Arguing as above using Lemma \ref{pione-lemma-limit}
...
\source{stacks:0BUN}
\href{https://stacks.math.columbia.edu/tag/0BUN}{\texttt{Stacks tag 0BUN}}
\group{pione}
...
\begin{proposition}[First homotopy sequence]
\label{pione-proposition-first-homotopy-sequence}
\source{stacks:0C0J}
\href{https://stacks.math.columbia.edu/tag/0C0J}{\texttt{Stacks tag 0C0J}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-stein-factorization-etale, pione-lemma-functoriality-galois-surjective, pione-lemma-composition-trivial, pione-lemma-functoriality-galois-ses, pione-lemma-functoriality-galois-normal}

Let $Y \to X$ be a finite \'etale morphism. Consider the Stein factorization
$$
\begin{array}{cc}Y \downarrow\longrightarrow & X \downarrow \\ T \longrightarrow & S\end{array}
$$
of $Y \to S$. By Lemma \ref{pione-lemma-stein-factorization-etale}
...
by Lemma \ref{pione-lemma-composition-trivial}.
...
Lemmas \ref{pione-lemma-functoriality-galois-ses} and
...
diagram
$$
\begin{array}{ccc}\overline{s}' \underset{\varphi}{\longrightarrow}\searrow & \Spec(A) \downarrow & \overline{s} \longleftarrow\swarrow \\  & S & \end{array}
$$
...
Lemmas \ref{pione-lemma-perfection} and
\ref{pione-lemma-finite-etale-invariant-over-proper}.
By construction the specialization map fits into a commutative
diagram
$$
\begin{array}{ccc}\pi_1(X_{\overline{s}'}) \underset{sp}{\longrightarrow}\searrow &  & \pi_1(X_{\overline{s}}) \swarrow \\  & \pi_1(X) & \end{array}
$$
...
\begin{lemma}[Specialization map base change]
\label{pione-lemma-specialization-map-base-change}
\source{stacks:0C0K}
\href{https://stacks.math.columbia.edu/tag/0C0K}{\texttt{Stacks tag 0C0K}}
\group{pione}

Consider a commutative diagram
$$
\begin{array}{cc}Y \underset{g}{\downarrow}\longrightarrow & X \overset{f}{\downarrow} \\ T \longrightarrow & S\end{array}
$$
...
$$
\begin{array}{cc}\pi_1(Y_{\overline{t}'}) \underset{sp}{\longrightarrow}\downarrow & \pi_1(Y_{\overline{t}}) \downarrow \\ \pi_1(X_{\overline{s}'}) \overset{sp}{\longrightarrow} & \pi_1(X_{\overline{s}})\end{array}
$$
...
$$
\begin{array}{ccc}\overline{t}' \underset{\psi}{\longrightarrow}\downarrow & \Spec(B) \downarrow\longrightarrow & T \downarrow \\ \overline{s}' \overset{\varphi}{\longrightarrow} & \Spec(A) \longrightarrow & S\end{array}
$$
...
$$
\begin{array}{cc}Y_{\overline{t}'} \longrightarrow\downarrow & Y_B \downarrow \\ X_{\overline{s}'} \longrightarrow & X_A\end{array}
$$
...
\begin{lemma}[Specialization map composition]
\label{pione-lemma-specialization-map-composition}
\source{stacks:0C0L}
\href{https://stacks.math.columbia.edu/tag/0C0L}{\texttt{Stacks tag 0C0L}}
\group{pione}
...
\begin{lemma}[Specialization map valuation ring]
\label{pione-lemma-specialization-map-valuation-ring}
\source{stacks:0C0M}
\href{https://stacks.math.columbia.edu/tag/0C0M}{\texttt{Stacks tag 0C0M}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-normal-local-domain-separablly-closed-fraction-field}
...
\begin{lemma}[Specialization map discrete valuation ring]
\label{pione-lemma-specialization-map-discrete-valuation-ring}
\source{stacks:0C0N}
\href{https://stacks.math.columbia.edu/tag/0C0N}{\texttt{Stacks tag 0C0N}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-finite-etale-invariant-over-proper}
...
$$
\begin{array}{cc}\kappa(\overline{s}) \longrightarrow & k \\ A/\mathfrak m_A \longrightarrow\uparrow & R/\mathfrak m_R \uparrow\end{array}
$$
with $k$ algebraically closed. Let $R^{sh}$ be the strict
henselization of $R$ constructed using $R \to k$. We obtain
a map $A \to R^{sh}$ from Algebra, Lemma
\ref{algebra-lemma-strictly-henselian-functorial}.
The ring $R^{sh}$ is a discrete valuation ring by
...
$$
\begin{array}{ccc}\overline{\eta} \downarrow\longrightarrow & \Spec(R^{sh}) \downarrow & \Spec(k) \downarrow\longleftarrow \\ \overline{s}' \longrightarrow & \Spec(A) & \overline{s} \longleftarrow\end{array}
$$
commutes, we obtain a commutative diagram
$$
\begin{array}{cc}\pi_1(X_{\overline{\eta}}) \downarrow\underset{sp_{R^{sh}}}{\longrightarrow} & \pi_1(X_o) \downarrow \\ \pi_1(X_{\overline{s}'}) \overset{sp}{\longrightarrow} & X_{\overline{s}}\end{array}
$$
of specialization maps by the construction of these maps.
Since the vertical arrows are isomorphisms
(Lemma \ref{pione-lemma-finite-etale-invariant-over-proper}), this proves the lemma.
\end{proof}
...
\begin{lemma}[Restriction fully faithful]
\label{pione-lemma-restriction-fully-faithful}
\source{stacks:0EL8}
\href{https://stacks.math.columbia.edu/tag/0EL8}{\texttt{Stacks tag 0EL8}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-internal-hom-finite-etale, pione-lemma-thickening}
...
$$
\begin{array}{cc} & U \overset{f}{\downarrow} \\ Y \longrightarrow\nearrow & X \uparrow\end{array}
$$
...
By Lemma \ref{pione-lemma-thickening} we can lift $t$ uniquely to a compatible
...
$$
\begin{array}{cc}f_*\mathcal{O}_U \otimes_{\mathcal{O}_X} f_*\mathcal{O}_U
\longrightarrow\underset{\sigma \otimes \sigma}{\downarrow} & f_*\mathcal{O}_U \overset{\sigma}{\downarrow} \\ \mathcal{O}_X \otimes_{\mathcal{O}_X} \mathcal{O}_X \longrightarrow & \mathcal{O}_X\end{array}
$$
...
\begin{lemma}[Restriction equivalence]
\label{pione-lemma-restriction-equivalence}
\source{stacks:0EL9}
\href{https://stacks.math.columbia.edu/tag/0EL9}{\texttt{Stacks tag 0EL9}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-restriction-fully-faithful, pione-lemma-thickening}

The restriction functor is fully faithful by
Lemma \ref{pione-lemma-restriction-fully-faithful}.
...
By Lemma \ref{pione-lemma-thickening}
...
By faithfulness of the functor in the statement of the lemma,
we conclude that $\mu$ defines a commutative $\mathcal{O}_X$-algebra
...
\begin{lemma}[Restriction fully faithful general]
\label{pione-lemma-restriction-fully-faithful-general}
\source{stacks:0ELA}
\href{https://stacks.math.columbia.edu/tag/0ELA}{\texttt{Stacks tag 0ELA}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-restriction-fully-faithful, pione-lemma-internal-hom-finite-etale, pione-lemma-thickening}
...
in the proof of Lemma \ref{pione-lemma-restriction-fully-faithful}; we urge
...
$$
\begin{array}{ccc} &  & U \overset{f}{\downarrow} \\ Y \longrightarrow\nearrow & V' \nearrow\longrightarrow & V\end{array}
$$
Finding the dotted arrow $s$ is the same thing as finding an
...
that the diagram
$$
\begin{array}{cc}(f_*\mathcal{O}_U \otimes_{\mathcal{O}_V} f_*\mathcal{O}_U)|_{V'}
\longrightarrow\underset{\sigma \otimes \sigma}{\downarrow} & f_*\mathcal{O}_U|_{V'} \overset{\sigma}{\downarrow} \\ \mathcal{O}_{V'} \otimes_{\mathcal{O}_{V'}} \mathcal{O}_{V'} \longrightarrow & \mathcal{O}_{V'}\end{array}
$$
commutes. For every $n$ we know this diagram commutes after restricting
to $Y_n$, i.e., the diagram commutes after applying the completion functor.
...
\begin{lemma}[Restriction equivalence general]
\label{pione-lemma-restriction-equivalence-general}
\source{stacks:0EK1}
\href{https://stacks.math.columbia.edu/tag/0EK1}{\texttt{Stacks tag 0EK1}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-restriction-equivalence, pione-lemma-restriction-fully-faithful-general, pione-lemma-thickening}

Observe that $\mathcal{V}$ is a directed set, so the colimits are
as in Categories, Section \ref{categories-section-directed-colimits}.
The rest of the argument is almost exactly the same as the argument
in the proof of Lemma \ref{pione-lemma-restriction-equivalence}; we urge
the reader to skip it.

\medskip\noindent
The restriction functor is fully faithful by
Lemma \ref{pione-lemma-restriction-fully-faithful-general}.
...
\begin{lemma}[Restriction faithful]
\label{pione-lemma-restriction-faithful}
\source{stacks:0EJX}
\href{https://stacks.math.columbia.edu/tag/0EJX}{\texttt{Stacks tag 0EJX}}
\group{pione}
...
\begin{lemma}[Restriction fully faithful special]
\label{pione-lemma-restriction-fully-faithful-special}
\source{stacks:0EJZ}
\href{https://stacks.math.columbia.edu/tag/0EJZ}{\texttt{Stacks tag 0EJZ}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-restriction-fully-faithful}

This lemma follows formally from
Lemma \ref{pione-lemma-restriction-fully-faithful} and
Algebraic and Formal Geometry, Lemma
\ref{algebraization-lemma-completion-fully-faithful}.
\end{proof}

\begin{lemma}[Restriction fully faithful general special]
\label{pione-lemma-restriction-fully-faithful-general-special}
\source{stacks:0EK0}
\href{https://stacks.math.columbia.edu/tag/0EK0}{\texttt{Stacks tag 0EK0}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-restriction-fully-faithful-general}

This lemma follows formally from
Lemma \ref{pione-lemma-restriction-fully-faithful-general} and
Algebraic and Formal Geometry, Lemma
...
\begin{lemma}[Pushout along closed immersion and integral]
\label{pione-lemma-pushout-along-closed-immersion-and-integral}
\source{stacks:0EK4}
\href{https://stacks.math.columbia.edu/tag/0EK4}{\texttt{Stacks tag 0EK4}}
\group{pione}
...
\begin{definition}[Situation: Local lefschetz]
\label{pione-situation-local-lefschetz}
\source{stacks:0BLF}
\href{https://stacks.math.columbia.edu/tag/0BLF}{\texttt{Stacks tag 0BLF}}
\group{pione}
...
In Situation \ref{pione-situation-local-lefschetz}
we will study the base change functors
$$
\begin{array}{cc}\textit{F\'Et}_X \downarrow\longrightarrow & \textit{F\'Et}_U \downarrow \\ \textit{F\'Et}_{X_0} \longrightarrow & \textit{F\'Et}_{U_0}\end{array}
$$
...
\source{stacks:0BLG}
\href{https://stacks.math.columbia.edu/tag/0BLG}{\texttt{Stacks tag 0BLG}}
\group{pione}

\uses{pione-situation-local-lefschetz}
In Situation \ref{pione-situation-local-lefschetz}.
Assume one of the following holds
\begin{enumerate}
...
\begin{proof}
\uses{pione-lemma-restriction-faithful}

Case (2) is immediate from Lemma \ref{pione-lemma-restriction-faithful}.
...
\begin{lemma}[Fill in missing]
\label{pione-lemma-fill-in-missing}
\source{stacks:0BLH}
\href{https://stacks.math.columbia.edu/tag/0BLH}{\texttt{Stacks tag 0BLH}}
\group{pione}

\uses{pione-situation-local-lefschetz}
In Situation \ref{pione-situation-local-lefschetz}. Let $V \to U$ be a finite
...
\begin{lemma}[Fully faithful henselian completion]
\label{pione-lemma-fully-faithful-henselian-completion}
\source{stacks:0BLI}
\href{https://stacks.math.columbia.edu/tag/0BLI}{\texttt{Stacks tag 0BLI}}
\group{pione}

\uses{pione-situation-local-lefschetz}
In Situation \ref{pione-situation-local-lefschetz} assume $A$ is henselian
...
\begin{proof}
\uses{pione-lemma-internal-hom-finite-etale, pione-lemma-fill-in-missing}
...
(Lemma \ref{pione-lemma-internal-hom-finite-etale})
...
By Lemma \ref{pione-lemma-fill-in-missing} we can find $Y \to X$ finite
such that $V = Y \times_X U$ and $Y' = Y \times_X X'$.
...
\begin{lemma}[Fully faithful simple]
\label{pione-lemma-fully-faithful-simple}
\source{stacks:0EK5}
\href{https://stacks.math.columbia.edu/tag/0EK5}{\texttt{Stacks tag 0EK5}}
\group{pione}

\uses{pione-situation-local-lefschetz}
In Situation \ref{pione-situation-local-lefschetz}. Assume
\begin{enumerate}
...
\begin{proof}
\uses{pione-lemma-fully-faithful-henselian-completion, pione-lemma-restriction-fully-faithful}
...
Thus by Lemma \ref{pione-lemma-fully-faithful-henselian-completion}
...
By Lemma \ref{pione-lemma-restriction-fully-faithful} the result follows from
Algebraic and Formal Geometry, Lemma
\ref{algebraization-lemma-fully-faithful-simple-two}.
\end{proof}

\begin{lemma}[Fully faithful minimal]
\label{pione-lemma-fully-faithful-minimal}
\source{stacks:0BM6}
\href{https://stacks.math.columbia.edu/tag/0BM6}{\texttt{Stacks tag 0BM6}}
\group{pione}
...
By Lemma \ref{pione-lemma-fully-faithful-henselian-completion}
we may assume that $A$ is a Noetherian complete local ring.
(The assumptions carry over; use
Dualizing Complexes, Lemma \ref{dualizing-lemma-torsion-change-rings}.)
By Lemma \ref{pione-lemma-restriction-fully-faithful}
...
\source{stacks:0BLJ}
\href{https://stacks.math.columbia.edu/tag/0BLJ}{\texttt{Stacks tag 0BLJ}}
\group{pione}

\uses{pione-situation-local-lefschetz}
In Situation \ref{pione-situation-local-lefschetz} assume $A$ has depth $\geq 3$
...
\begin{proof}
\uses{pione-lemma-fully-faithful-minimal}
...
Hence Lemma \ref{pione-lemma-fully-faithful-minimal} applies.
\end{proof}
...
Lemma \ref{pione-lemma-local-purity},
Proposition \ref{pione-proposition-purity-complete-intersection}, and
Proposition \ref{pione-proposition-purity-smooth-over-depth2}.

\begin{lemma}[Sections over punctured spec]
\label{pione-lemma-sections-over-punctured-spec}
\source{stacks:0BM8}
\href{https://stacks.math.columbia.edu/tag/0BM8}{\texttt{Stacks tag 0BM8}}
\group{pione}
...
\begin{lemma}[Reformulate purity]
\label{pione-lemma-reformulate-purity}
\source{stacks:0BLK}
\href{https://stacks.math.columbia.edu/tag/0BLK}{\texttt{Stacks tag 0BLK}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-sections-over-punctured-spec}
...
Hence Lemma \ref{pione-lemma-sections-over-punctured-spec}
...
\begin{lemma}[Reformulate purity normal]
\label{pione-lemma-reformulate-purity-normal}
\source{stacks:0BM9}
\href{https://stacks.math.columbia.edu/tag/0BM9}{\texttt{Stacks tag 0BM9}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-reformulate-purity, pione-lemma-sections-over-punctured-spec}
...
Thus the final statement follows from Lemma \ref{pione-lemma-reformulate-purity}.
...
Lemma \ref{pione-lemma-sections-over-punctured-spec}
...
\begin{lemma}[Purity and completion]
\label{pione-lemma-purity-and-completion}
\source{stacks:0BLL}
\href{https://stacks.math.columbia.edu/tag/0BLL}{\texttt{Stacks tag 0BLL}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-fill-in-missing}
...
\begin{lemma}[Lift simple]
\label{pione-lemma-lift-simple}
\source{stacks:0EK6}
\href{https://stacks.math.columbia.edu/tag/0EK6}{\texttt{Stacks tag 0EK6}}
\group{pione}

\uses{pione-situation-local-lefschetz}
In Situation \ref{pione-situation-local-lefschetz}. Let $V$ be finite
\'etale over $U$. Assume
\begin{enumerate}
\item[(a)] $A$ has a dualizing complex,
\item[(b)] the pair $(A, (f))$ is henselian,
...
\begin{proof}
\uses{pione-lemma-purity-and-completion, pione-lemma-fully-faithful-simple}

We reduce to the complete case using Lemma \ref{pione-lemma-purity-and-completion}.
(The assumptions carry over; see proof of
Lemma \ref{pione-lemma-fully-faithful-simple}.)
...
Then we can use Lemma \ref{pione-lemma-fully-faithful-simple}
to see that $V$ is isomorphic to $Y \times_X U$ and
the proof is complete.
\end{proof}

\begin{lemma}[Lift purity general]
\label{pione-lemma-lift-purity-general}
\source{stacks:0BLS}
\href{https://stacks.math.columbia.edu/tag/0BLS}{\texttt{Stacks tag 0BLS}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-purity-and-completion, pione-lemma-fully-faithful-minimal}
...
observe that $(A, fA)$ is a henselian pair by
More on Algebra, Lemma \ref{more-algebra-lemma-complete-henselian}.
Then we can use Lemma \ref{pione-lemma-fully-faithful-minimal}
to see that $V$ is isomorphic to $Y \times_X U$ and
the proof is complete.
\end{proof}

\begin{lemma}[Lift purity]
\label{pione-lemma-lift-purity}
\source{stacks:0BLM}
\href{https://stacks.math.columbia.edu/tag/0BLM}{\texttt{Stacks tag 0BLM}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-lift-purity-general}

The assumption of depth forces
$H^1_\mathfrak m(A) = H^2_\mathfrak m(A) = 0$, see
Dualizing Complexes, Lemma \ref{dualizing-lemma-depth}.
Hence Lemma \ref{pione-lemma-lift-purity-general} applies.
\end{proof}
...
\begin{lemma}[Find point codim 1]
\label{pione-lemma-find-point-codim-1}
\source{stacks:0BJG}
\href{https://stacks.math.columbia.edu/tag/0BJG}{\texttt{Stacks tag 0BJG}}
\group{pione}
...
\begin{lemma}[Ramification quasi finite flat]
\label{pione-lemma-ramification-quasi-finite-flat}
\source{stacks:0BJH}
\href{https://stacks.math.columbia.edu/tag/0BJH}{\texttt{Stacks tag 0BJH}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-find-point-codim-1}
...
By Lemma \ref{pione-lemma-find-point-codim-1}
...
\begin{lemma}[Local purity]
\label{pione-lemma-local-purity}
\source{stacks:0BMA}
\href{https://stacks.math.columbia.edu/tag/0BMA}{\texttt{Stacks tag 0BMA}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-reformulate-purity-normal, pione-lemma-ramification-quasi-finite-flat, pione-lemma-lift-purity}
...
Lemma \ref{pione-lemma-reformulate-purity-normal}.
...
Lemma \ref{pione-lemma-ramification-quasi-finite-flat}
...
$V_0 = V \times_U U_0$.
By Lemma \ref{pione-lemma-lift-purity}
...
\source{stacks:0BMB}
\href{https://stacks.math.columbia.edu/tag/0BMB}{\texttt{Stacks tag 0BMB}}
\group{pione}
...
to the case discussed in Lemma \ref{pione-lemma-local-purity}.
...
This follows from Lemma \ref{pione-lemma-local-purity}
and the proof is complete.
\end{proof}
...
\begin{lemma}[Extend S2]
\label{pione-lemma-extend-S2}
\source{stacks:0EY6}
\href{https://stacks.math.columbia.edu/tag/0EY6}{\texttt{Stacks tag 0EY6}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-ramification-quasi-finite-flat}
...
Lemma \ref{pione-lemma-ramification-quasi-finite-flat} hold
...
Lemma \ref{pione-lemma-ramification-quasi-finite-flat} holds too.
...
\begin{lemma}[Extend pure]
\label{pione-lemma-extend-pure}
\source{stacks:0EY7}
\href{https://stacks.math.columbia.edu/tag/0EY7}{\texttt{Stacks tag 0EY7}}
\group{pione}
...
in Section \ref{pione-section-pi1-punctured-spec}. Suppose
...
\source{stacks:0BLN}
\href{https://stacks.math.columbia.edu/tag/0BLN}{\texttt{Stacks tag 0BLN}}
\group{pione}

\uses{pione-situation-local-lefschetz}
In Situation \ref{pione-situation-local-lefschetz}. Let $U' \subset U$
...
by Lemma \ref{pione-lemma-restriction-faithful}.
...
\begin{lemma}[Fully faithful general better]
\label{pione-lemma-fully-faithful-general-better}
\source{stacks:0DXX}
\href{https://stacks.math.columbia.edu/tag/0DXX}{\texttt{Stacks tag 0DXX}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-thickening, pione-lemma-restriction-fully-faithful-general}

To prove this we may replace $A$ by its reduction by the topological
invariance of the fundamental group, see Lemma \ref{pione-lemma-thickening}.
...
\begin{lemma}[Fully faithful general]
\label{pione-lemma-fully-faithful-general}
\source{stacks:0BLP}
\href{https://stacks.math.columbia.edu/tag/0BLP}{\texttt{Stacks tag 0BLP}}
\group{pione}
...
In this section we study when in Situation \ref{pione-situation-local-lefschetz}.
the restriction functor
$$
\colim_{U_0 \subset U' \subset U\text{ open}} \textit{F\'Et}_{U'}
\longrightarrow
...
\begin{lemma}[Essentially surjective general better]
\label{pione-lemma-essentially-surjective-general-better}
\source{stacks:0DXY}
\href{https://stacks.math.columbia.edu/tag/0DXY}{\texttt{Stacks tag 0DXY}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-restriction-equivalence-general}

This follows from Lemma \ref{pione-lemma-restriction-equivalence-general}
and
Algebraic and Formal Geometry, Lemma
\ref{algebraization-lemma-equivalence-better}.
\end{proof}

\begin{lemma}[Essentially surjective general]
\label{pione-lemma-essentially-surjective-general}
\source{stacks:0BLV}
\href{https://stacks.math.columbia.edu/tag/0BLV}{\texttt{Stacks tag 0BLV}}
\group{pione}
...
\begin{remark}[Combine]
\label{pione-remark-combine}
\source{stacks:0BLW}
\href{https://stacks.math.columbia.edu/tag/0BLW}{\texttt{Stacks tag 0BLW}}
\group{pione}

\uses{pione-lemma-essentially-surjective-general-better}
...
Then Lemma \ref{pione-lemma-essentially-surjective-general-better}
...
Let $X, X_0, U, U_0$ be as in Situation \ref{pione-situation-local-lefschetz}.
...
\begin{lemma}[Equivalence better]
\label{pione-lemma-equivalence-better}
\source{stacks:0EK9}
\href{https://stacks.math.columbia.edu/tag/0EK9}{\texttt{Stacks tag 0EK9}}
\group{pione}
...
Lemma \ref{pione-lemma-essentially-surjective-general-better}
...
\source{stacks:0EKA}
\href{https://stacks.math.columbia.edu/tag/0EKA}{\texttt{Stacks tag 0EKA}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-equivalence-better, pione-lemma-essentially-surjective-general, pione-lemma-essentially-surjective-general-better}

The proof is identical to the proof of
Lemma \ref{pione-lemma-equivalence-better}
using
Lemma \ref{pione-lemma-essentially-surjective-general}
in stead of
Lemma \ref{pione-lemma-essentially-surjective-general-better}.
\end{proof}
...
This section is the continuation of Section \ref{pione-section-local-purity}.
Recall that we say {\it purity holds} for a Noetherian local ring
$(A, \mathfrak m)$ if the restriction functor
$\textit{F\'Et}_X \to \textit{F\'Et}_U$ is essentially
surjective where $X = \Spec(A)$ and $U = X \setminus \{\mathfrak m\}$.

\begin{lemma}[Purity inherited by hypersurface better]
\label{pione-lemma-purity-inherited-by-hypersurface-better}
\source{stacks:0DXZ}
\href{https://stacks.math.columbia.edu/tag/0DXZ}{\texttt{Stacks tag 0DXZ}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-equivalence-better}
...
\begin{lemma}[Purity inherited by hypersurface]
\label{pione-lemma-purity-inherited-by-hypersurface}
\source{stacks:0BPC}
\href{https://stacks.math.columbia.edu/tag/0BPC}{\texttt{Stacks tag 0BPC}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-purity-inherited-by-hypersurface-better, pione-lemma-equivalence, pione-lemma-equivalence-better}

The proof is identical to the proof of
Lemma \ref{pione-lemma-purity-inherited-by-hypersurface-better}
using
Lemma \ref{pione-lemma-equivalence}
in stead of
Lemma \ref{pione-lemma-equivalence-better}.
\end{proof}
...
\begin{proposition}[Purity complete intersection]
\label{pione-proposition-purity-complete-intersection}
\source{stacks:0BPD}
\href{https://stacks.math.columbia.edu/tag/0BPD}{\texttt{Stacks tag 0BPD}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-purity-and-completion, pione-lemma-local-purity, pione-lemma-purity-inherited-by-hypersurface}

By Lemma \ref{pione-lemma-purity-and-completion} we may assume that $A$ is
...
Lemma \ref{pione-lemma-local-purity} which applies to
...
Lemma \ref{pione-lemma-purity-inherited-by-hypersurface} to $f_r \in A'$.
This is permissible:
...
Sections \ref{pione-section-local-purity} and \ref{pione-section-local-purity-II}.

\begin{lemma}[Fully faithful power series over depth2]
\label{pione-lemma-fully-faithful-power-series-over-depth2}
\source{stacks:0EY9}
\href{https://stacks.math.columbia.edu/tag/0EY9}{\texttt{Stacks tag 0EY9}}
\group{pione}
...
\begin{lemma}[Ramanujam-Samuel for finite \'etale covers]
\label{pione-lemma-purity-power-series-over-depth2}
\source{stacks:0EYA}
\href{https://stacks.math.columbia.edu/tag/0EYA}{\texttt{Stacks tag 0EYA}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-quasi-compact-dense-open-connected-at-infinity-Noetherian, pione-lemma-extend-S2, pione-lemma-fully-faithful-power-series-over-depth2}
...
Lemma \ref{pione-lemma-quasi-compact-dense-open-connected-at-infinity-Noetherian}
...
$W \to V$ constructed in Lemma \ref{pione-lemma-extend-S2}.
...
Lemma \ref{pione-lemma-fully-faithful-power-series-over-depth2}
...
by Lemma \ref{pione-lemma-extend-S2} applied to $W_0 \to U \subset X$ (exactly
as we did for $B \to C$ above). Since the construction in
Lemma \ref{pione-lemma-extend-S2} is compatible with flat base change
...
\begin{lemma}[Purity smooth over depth2]
\label{pione-lemma-purity-smooth-over-depth2}
\source{stacks:0EYB}
\href{https://stacks.math.columbia.edu/tag/0EYB}{\texttt{Stacks tag 0EYB}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-quasi-compact-dense-open-connected-at-infinity-Noetherian, pione-lemma-extend-S2, pione-lemma-purity-power-series-over-depth2}
...
be the finite morphism constructed in Lemma \ref{pione-lemma-extend-S2}.
...
construction in Lemma \ref{pione-lemma-extend-S2} with flat base change.
...
this follows from Lemma \ref{pione-lemma-purity-power-series-over-depth2}
and the uniqueness in the construction of $Y \to X$.
\end{proof}

\begin{proposition}[Purity smooth over depth2]
\label{pione-proposition-purity-smooth-over-depth2}
\source{stacks:0EYC}
\href{https://stacks.math.columbia.edu/tag/0EYC}{\texttt{Stacks tag 0EYC}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-quasi-compact-dense-open-connected-at-infinity-Noetherian, pione-lemma-extend-S2, pione-lemma-purity-and-completion, pione-lemma-purity-smooth-over-depth2}
...
of the construction of  Lemma \ref{pione-lemma-extend-S2}
it suffices to prove the essential surjectivity for
$A^\wedge \to B^\wedge$ and the inverse image of $V$
(details omitted; compare with Lemma \ref{pione-lemma-purity-and-completion}
...
At this point we may apply Lemma \ref{pione-lemma-purity-smooth-over-depth2}
...
\begin{proposition}[Lefschetz fully faithful]
\label{pione-proposition-lefschetz-fully-faithful}
\source{stacks:0ELC}
\href{https://stacks.math.columbia.edu/tag/0ELC}{\texttt{Stacks tag 0ELC}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-restriction-fully-faithful-special}

The first statement is a formal consequence of
Lemma \ref{pione-lemma-restriction-fully-faithful-special}
and
...
\begin{proposition}[Lefschetz equivalence general]
\label{pione-proposition-lefschetz-equivalence-general}
\source{stacks:0ELD}
\href{https://stacks.math.columbia.edu/tag/0ELD}{\texttt{Stacks tag 0ELD}}
\group{pione}
...
Lemma \ref{pione-lemma-restriction-equivalence-general} and
Algebraic and Formal Geometry, Proposition
\ref{algebraization-proposition-lefschetz-equivalence}.
\end{proof}

\begin{proposition}[Lefschetz equivalence]
\label{pione-proposition-lefschetz-equivalence}
\source{stacks:0ELE}
\href{https://stacks.math.columbia.edu/tag/0ELE}{\texttt{Stacks tag 0ELE}}
\group{pione}
...
\begin{proof}
\uses{pione-proposition-lefschetz-fully-faithful, pione-proposition-lefschetz-equivalence-general, pione-lemma-what-equivalence-gives}

Fully faithfulness holds by
Proposition \ref{pione-proposition-lefschetz-fully-faithful}.
By Proposition \ref{pione-proposition-lefschetz-equivalence-general}
...
See Lemma \ref{pione-lemma-what-equivalence-gives} for the final statement.
\end{proof}
...
\begin{lemma}[Characterize rational singularity]
\label{pione-lemma-characterize-rational-singularity}
\source{stacks:0EA2}
\href{https://stacks.math.columbia.edu/tag/0EA2}{\texttt{Stacks tag 0EA2}}
\group{pione}
...
\begin{lemma}[Key purity ramification]
\label{pione-lemma-key-purity-ramification}
\source{stacks:0EA3}
\href{https://stacks.math.columbia.edu/tag/0EA3}{\texttt{Stacks tag 0EA3}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-characterize-rational-singularity}
...
By Lemma \ref{pione-lemma-characterize-rational-singularity}
we find $E|_W = 0$.
...
\source{stacks:0EA4}
\href{https://stacks.math.columbia.edu/tag/0EA4}{\texttt{Stacks tag 0EA4}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-key-purity-ramification, pione-lemma-purity}
...
\medskip\noindent
The case $d = 2$ now follows from Lemma \ref{pione-lemma-key-purity-ramification}.
...
ramification locus (Lemma \ref{pione-lemma-purity-ramification}) by
...
Theorem \ref{pione-theorem-global}. It seems reasonable
to guess the result remains true for $X$ and $Y$
of mixed characteristic (but still excellent).

\begin{lemma}[Structure cohomology]
\label{pione-lemma-structure-cohomology}
\source{stacks:0ECB}
\href{https://stacks.math.columbia.edu/tag/0ECB}{\texttt{Stacks tag 0ECB}}
\group{pione}
...
\begin{lemma}[Conclude]
\label{pione-lemma-conclude}
\source{stacks:0ECC}
\href{https://stacks.math.columbia.edu/tag/0ECC}{\texttt{Stacks tag 0ECC}}
\group{pione}

\uses{pione-lemma-structure-cohomology}
In the situation of Lemma \ref{pione-lemma-structure-cohomology}
...
converging to zero. By Lemma \ref{pione-lemma-structure-cohomology},
...
\source{stacks:0ECD}
\href{https://stacks.math.columbia.edu/tag/0ECD}{\texttt{Stacks tag 0ECD}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-purity-ramification, pione-lemma-conclude}
...
ramification locus (Lemma \ref{pione-lemma-purity-ramification})
...
Thus $V$ is affine by Lemma \ref{pione-lemma-conclude}
...
sp : \pi_1(X_{\overline{s}}) \longrightarrow \pi_1(X_{\overline{s}'})
$$
of Section \ref{pione-section-specialization-map}
is surjective and
\begin{enumerate}
...
\begin{lemma}[Specialization map surjective]
\label{pione-lemma-specialization-map-surjective}
\source{stacks:0C0P}
\href{https://stacks.math.columbia.edu/tag/0C0P}{\texttt{Stacks tag 0C0P}}
\group{pione}
...
\begin{proof}
\uses{pione-proposition-first-homotopy-sequence}
...
\begin{proposition}[Specialization map isomorphism]
\label{pione-proposition-specialization-map-isomorphism}
\source{stacks:0C0Q}
\href{https://stacks.math.columbia.edu/tag/0C0Q}{\texttt{Stacks tag 0C0Q}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-specialization-map-surjective, pione-lemma-specialization-map-base-change, pione-lemma-specialization-map-discrete-valuation-ring, pione-lemma-functoriality-galois-injective, pione-lemma-perfection, pione-lemma-limit, pione-lemma-purity, pione-lemma-finite-etale-on-proper-over-henselian}

The map is surjective by
Lemma \ref{pione-lemma-specialization-map-surjective}.
...
Lemma \ref{pione-lemma-specialization-map-base-change}
we reduce to the case where the base is Noetherian.

\medskip\noindent
Applying Lemma \ref{pione-lemma-specialization-map-discrete-valuation-ring}
...
is injective by Lemma \ref{pione-lemma-functoriality-galois-injective}.

\medskip\noindent
Given $V$ we can first descend $V$ to $V' \to X_{K^{sep}}$ by
Lemma \ref{pione-lemma-perfection} and then to
$V'' \to X_L$ by Lemma \ref{pione-lemma-limit}.
...
branch locus (Lemma \ref{pione-lemma-purity})
...
\begin{theorem}[Specialization map isomorphism prime to p]
\label{pione-theorem-specialization-map-isomorphism-prime-to-p}
\source{stacks:0C0R}
\href{https://stacks.math.columbia.edu/tag/0C0R}{\texttt{Stacks tag 0C0R}}
\group{pione}
...
\begin{proof}
\uses{pione-proposition-specialization-map-isomorphism, pione-proposition-universal-homeomorphism}
...
\item The extension $\kappa_B/\kappa_A$ is no longer
...
of fundamental groups by Proposition \ref{pione-proposition-universal-homeomorphism}.
\end{enumerate}
\end{proof}
...
$$
\begin{array}{cc}\Spec(K_\xi) \longrightarrow\downarrow & U \downarrow \\ \Spec(\mathcal{O}_{X, \xi}) \longrightarrow & X\end{array}
$$
of schemes. In particular, we see that $Y \times_U \Spec(K_\xi)$
is the spectrum of a finite separable algebra $L_\xi/K_\xi$.
Then we say
...
\begin{lemma}[Pullback tame codim1]
\label{pione-lemma-pullback-tame-codim1}
\source{stacks:0EYD}
\href{https://stacks.math.columbia.edu/tag/0EYD}{\texttt{Stacks tag 0EYD}}
\group{pione}
...
\begin{lemma}[Purity one divisor general]
\label{pione-lemma-purity-one-divisor-general}
\source{stacks:0H2W}
\href{https://stacks.math.columbia.edu/tag/0H2W}{\texttt{Stacks tag 0H2W}}
\group{pione}

Let $X$ be a locally Noetherian scheme. Let $U \subset X$ be open and dense.
...
whose restriction to $U$ is $Y$.
\end{lemma}

\begin{proof}
\uses{pione-lemma-extend-pure, pione-lemma-local-purity}

Let $\xi \in X \setminus U$ be a generic point of an irreducible component
of $X \setminus U$ of codimension $1$. Then $\mathcal{O}_{X, \xi}$ is a
discrete valuation ring. As in the discussion above, write
...
whose restriction to $U$ recovers $Y$ and
...
$X \setminus U$ of codimension $1$ we may assume that we have
a finite \'etale morphism $Y' \to U'$ extending $Y \to U$
to an open subscheme containing $U' \subset X$ containing $U$
and all codimension $1$ points of $X \setminus U$.
We finish by applying Lemma \ref{pione-lemma-extend-pure}
to $Y' \to U'$. Namely, all local rings $\mathcal{O}_{X, x}$
for $x \in X \setminus U'$ are regular and
have $\dim(\mathcal{O}_{X, x}) \geq 2$. Hence we have
purity for $\mathcal{O}_{X, x}$ by Lemma \ref{pione-lemma-local-purity}.
\end{proof}

\begin{lemma}[Purity one divisor]
\label{pione-lemma-purity-one-divisor}
\source{stacks:0EYE}
\href{https://stacks.math.columbia.edu/tag/0EYE}{\texttt{Stacks tag 0EYE}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-purity-one-divisor-general}

This is a special case of Lemma \ref{pione-lemma-purity-one-divisor-general}.
First, $D$ is nowhere dense in $X$ (see discussion in
Divisors, Section \ref{divisors-section-effective-Cartier-divisors})
and hence $X \setminus D$ is dense in $X$. Second, the ring
$\mathcal{O}_{X, x}$ is a regular local ring for all $x \in D$ by
...
\source{stacks:0EYF}
\href{https://stacks.math.columbia.edu/tag/0EYF}{\texttt{Stacks tag 0EYF}}
\group{pione}
...
\source{stacks:0EYG}
\href{https://stacks.math.columbia.edu/tag/0EYG}{\texttt{Stacks tag 0EYG}}
\group{pione}

\uses{pione-example-tamely-ramified}
Let $X$ be a locally Noetherian scheme. Let $D \subset X$
be an effective Cartier divisor such that $D$ is a regular scheme.
Let $Y \to X \setminus D$ be a finite \'etale morphism.
...
morphisms as described in Example \ref{pione-example-tamely-ramified}.
\end{lemma}

\begin{proof}
\uses{pione-example-tamely-ramified, pione-lemma-pullback-tame-codim1, pione-lemma-purity-one-divisor}

For every $x \in X$ we are going to find an \'etale neighourhood
$(U, u) \to (X, x)$ with $U = \Spec(A)$ such that the base change
$Y \times_X U \to U$ is a finite disjoint union of standard tamely ramified
morphisms as in Example \ref{pione-example-tamely-ramified}.
We will assume $x \in D$; the case $x \not \in D$ follows from
\'Etale Morphisms, Lemma \ref{etale-lemma-finite-etale-etale-local}
and taking $e = 1$ and $f = 1$ in Example \ref{pione-example-tamely-ramified}.

\medskip\noindent
In this paragraph we reduce to the case where $X$ is the spectrum of a
strictly henselian local ring and $x$ is the closed point. Namely, shrinking
$X$ we may assume $X = \Spec(A)$ and $D \subset X$ is given by a
nonzerodivisor $f \in A$. Then $Y$ is affine as a finite
\'etale covering of $\Spec(A_f)$. Write $Y = \Spec(B)$.
Let $A^{sh}$ be the strict henselization of $\mathcal{O}_{X, x}$.
Since $A \to A^{sh}$ is flat and $x \in D$, we see that $f$ maps
to a nonzerodivisor of the maximal ideal of $A^{sh}$.
Observe that $A^{sh}/fA^{sh} = (A/fA)^{sh}$
(Algebra, Lemma \ref{algebra-lemma-quotient-strict-henselization})
is a regular local ring as the strict henselization of $\mathcal{O}_{D, x}$,
see More on Algebra, Lemma \ref{more-algebra-lemma-henselization-regular}.
By Lemma \ref{pione-lemma-pullback-tame-codim1}
the base change of $Y$ to $\Spec(A^{sh})$ is tamely ramified in
codimension $1$. Assume we've proven the assertion for the base change
of $Y$ to $\Spec(A^{sh})$. Since $A^{sh}$ is strictly henselian any
\'etale neighbourhood has a section and we conclude that we have an isomorphism
$$
A^{sh} \otimes_A B \cong
\prod\nolimits_{i \in I} A^{sh}_f[x]/(x^{e_i} - f)
$$
where $I$ is a finite set and each $e_i$ is an integer invertible in $A^{sh}$.
Write $A^{sh} = \colim A_\lambda$ as a filtered colimit of \'etale
$A$-algebras $A_\lambda$. The displayed isomorphism
descends to an isomorphism
$$
A_\lambda \otimes_A B \cong \prod\nolimits_{i \in I}
(A_\lambda)_f[x]/(x^{e_i} - f)
$$
for suitably large $\lambda$, see for example
Algebra, Lemma \ref{algebra-lemma-colimit-category-fp-algebras}.
After increasing $\lambda$ a bit
more we may assume $e_i$ is invertible in $A_\lambda$. Then
$\Spec(A_\lambda) \to \Spec(A)$ is the desired \'etale neighbourhood
of $x$.

\medskip\noindent
Assume $X = \Spec(A)$ where $A$ is a strictly henselian local ring
and $x \in X$ corresponds to the maximal ideal $\mathfrak m$ of $A$.
Let $f \in \mathfrak m$ be the nonzerodivisor cutting out $D$.
Then $A/fA$ is regular and by Algebra, Lemma \ref{algebra-lemma-regular-mod-x}
we find that $A$ is regular too. We will use some properties of regular
local rings, for example that they are normal domains, see
Algebra, Lemmas \ref{algebra-lemma-regular-domain} and
\ref{algebra-lemma-regular-normal}. In particular $A$ is a domain.
As above we see that $Y = \Spec(B)$ is affine and $A_f \to B$
is finite \'etale. Hence $B$ is normal too
(Algebra, Lemma \ref{algebra-lemma-normal-goes-up})
and we conclude $Y$ is a finite disjoint union of spectra of normal domains by
Algebra, Lemma \ref{algebra-lemma-characterize-reduced-ring-normal}.
Thus we may assume $B$ is a domain too.
Since $A$ and $A/fA$ are domains, we conclude that $f$ is a prime
element of $A$ generating a height $1$ prime $\mathfrak p = fA$.
Observe that $A_\mathfrak p$ is a discrete valuation ring with uniformizer $f$.

\medskip\noindent
Let $K$ be the fraction field of $A$ and let $L$ be the fraction
field of $B$. The tame ramification assumption means that
$L$ is tamely ramified with respect to $A_\mathfrak p$.
Let $e \geq 1$ be the product of the ramification indices for $L$
over $A_\mathfrak p$ as in
More on Algebra, Remark \ref{more-algebra-remark-finite-separable-extension}.
Then $e$ is invertible in $\kappa(\mathfrak p)$ but
at this point we do not know that $e$ is invertible in $A/fA$
or in $A$.
...
A' = A[x]/(x^e - f)
$$
This is a local finite extension of a strictly henselian local
ring and hence strictly henselian.
Observe that $f' = x$ is a nonzerodivisor in $A'$ and that
$A'/f'A' \cong A/fA$ is a regular ring. So as before $A'$
is regular and a fortiori a domain. Set
$B' = B \otimes_A A' = B \otimes_{A_f} A'_{f'}$.
By Abhyankar's lemma
(More on Algebra, Lemma \ref{more-algebra-lemma-abhyankar})
we see that $\Spec(B')$ is unramified over $\Spec(A')$
in codimension $1$. Namely, by Lemma \ref{pione-lemma-pullback-tame-codim1}
...
By Lemma \ref{pione-lemma-purity-one-divisor} we conclude that
$\Spec(B') \to \Spec(A'_{f'})$ extends to a finite \'etale morphism
$\Spec(C) \to \Spec(A')$. However, since $A'$ is strictly henselian,
we conclude that $\Spec(C)$ is a finite disjoint union of copies
of $\Spec(A')$. Conclusion: there exists at least one morphism
$\Spec(A'_{f'}) \to \Spec(B')$. We conclude that there exists
an inclusion $B \subset A'_{f'}$ of $A_f$-algebras.

\medskip\noindent
It follows that we have inclusions $K \subset L \subset K[f^{1/e}]$.
By More on Algebra, Lemma \ref{more-algebra-lemma-pull-root-uniformizer}
we conclude that $L$ is equal to $K[f^{1/n}]$ for some divisor $n$ of $e$.
The normality of $B$ then implies that $B \cong A_f[y]/(y^n - f)$; details
omitted.
However, the ramification locus of the ring map $A_f \to A_f[y]/(y^n - f)$
is cut out by $ny^{n - 1}$ which must imply that $n$ is a unit in $A_f$.
Since $f$ is a prime element, this means that $n = u f^s$ for
some unit $u$ of $A$ and $s \in \mathbf{Z}$. Since $n$ maps to a unit in
$\kappa(\mathfrak p)$ we find $s = 0$ and the proof is complete.
\end{proof}

\begin{lemma}[Extend tame covering normal]
\label{pione-lemma-extend-tame-covering-normal}
\source{stacks:0EYH}
\href{https://stacks.math.columbia.edu/tag/0EYH}{\texttt{Stacks tag 0EYH}}
\group{pione}

\uses{pione-lemma-abhyankar-one-divisor}
In the situation of Lemma \ref{pione-lemma-abhyankar-one-divisor}
...
This is just an addendum to Lemma \ref{pione-lemma-abhyankar-one-divisor}
...
the lemma from the result of Lemma \ref{pione-lemma-abhyankar-one-divisor}.
...
Lemma \ref{pione-lemma-abhyankar-one-divisor} we may assume that
...
\begin{lemma}[Tame covering split]
\label{pione-lemma-tame-covering-split}
\source{stacks:0EYI}
\href{https://stacks.math.columbia.edu/tag/0EYI}{\texttt{Stacks tag 0EYI}}
\group{pione}

\uses{pione-lemma-abhyankar-one-divisor, pione-lemma-extend-tame-covering-normal}
In the situation of Lemma \ref{pione-lemma-abhyankar-one-divisor}
let $Y' \to X$ be as in Lemma \ref{pione-lemma-extend-tame-covering-normal}.
...
\begin{proof}
\uses{pione-lemma-extend-tame-covering-normal}
...
has a description as in Lemma \ref{pione-lemma-extend-tame-covering-normal}
...
\begin{lemma}[Extend covering]
\label{pione-lemma-extend-covering}
\source{stacks:0EYJ}
\href{https://stacks.math.columbia.edu/tag/0EYJ}{\texttt{Stacks tag 0EYJ}}
\group{pione}
...
finite \'etale Galois cover (Section \ref{pione-section-finite-etale-under-galois})
...
\begin{proof}
\uses{pione-lemma-extend-tame-covering-normal, pione-lemma-tame-covering-split, pione-lemma-purity-one-divisor, pione-lemma-extend-S2, pione-lemma-purity-smooth-over-depth2, pione-lemma-fully-faithful-power-series-over-depth2}
...
Lemma \ref{pione-lemma-extend-tame-covering-normal}. Observe that
the action of $G$ on $Z$ extends to an action of $G$ on $Z'$.
By Lemma \ref{pione-lemma-tame-covering-split}
...
Lemma \ref{pione-lemma-purity-one-divisor}.
...
Lemma \ref{pione-lemma-purity-smooth-over-depth2} (for example)
...
with flat base change in Lemma \ref{pione-lemma-extend-S2}
we find that the base chang
$Y' \times_X \Spec(B^\wedge) \to \Spec(B^\wedge)$
is constructed from $W \to V$ over $\Spec(B^\wedge)$
by the procedure in Lemma \ref{pione-lemma-extend-S2}.
...
\begin{lemma}[Extend covering general]
\label{pione-lemma-extend-covering-general}
\source{stacks:0EZJ}
\href{https://stacks.math.columbia.edu/tag/0EZJ}{\texttt{Stacks tag 0EZJ}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-extend-covering, pione-lemma-limit}

If $S$ is Noetherian, then this is the result of
Lemma \ref{pione-lemma-extend-covering}. The general case
...
See Lemma \ref{pione-lemma-limit}.
...
$$
\begin{array}{cc} & B \\ C \longrightarrow & C/\varphi(I)C \overset{\tau}{\uparrow} \\ k[x_1, \ldots, x_n] \overset{\varphi}{\uparrow}\longrightarrow & A \uparrow\underset{\pi}{\uparrow}\end{array}
$$
...
\begin{lemma}[Lower invariant]
\label{pione-lemma-lower-invariant}
\source{stacks:0G1F}
\href{https://stacks.math.columbia.edu/tag/0G1F}{\texttt{Stacks tag 0G1F}}
\group{pione}
...
$$
\begin{array}{cc} & B \\ C \longrightarrow & C/\varphi'(I)C \underset{\tau'}{\uparrow} \\ k[x_1, \ldots, x_n] \overset{\varphi'}{\uparrow}\longrightarrow & A \uparrow\underset{\pi}{\uparrow}\end{array}
$$
...
\begin{lemma}[Affine etale over affine space]
\label{pione-lemma-affine-etale-over-affine-space}
\source{stacks:0G1G}
\href{https://stacks.math.columbia.edu/tag/0G1G}{\texttt{Stacks tag 0G1G}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-lower-invariant}
...
that $N(C, \varphi, \tau)$ is minimal. By Lemma \ref{pione-lemma-lower-invariant}
we get $N(C, \varphi, \tau) = 0$. Hence $\varphi$ is finite \'etale.
\end{proof}

\begin{lemma}[Dominate affine space]
\label{pione-lemma-dominate-affine-space}
\source{stacks:0G1H}
\href{https://stacks.math.columbia.edu/tag/0G1H}{\texttt{Stacks tag 0G1H}}
\group{pione}
...
\begin{proposition}[Injective]
\label{pione-proposition-injective}
\source{stacks:0G1I}
\href{https://stacks.math.columbia.edu/tag/0G1I}{\texttt{Stacks tag 0G1I}}
\group{pione}
...
\begin{proof}
\uses{pione-lemma-functoriality-galois-injective, pione-lemma-limit, pione-lemma-dominate-affine-space}
...
of finite type. By Lemma \ref{pione-lemma-limit}
...
$$
\begin{array}{cc}\mathbf{F}_p[x_1, \ldots, x_n] \longrightarrow\downarrow & A_i \downarrow \\ R \longrightarrow & A\end{array}
$$
of $\mathbf{F}_p$-algebras. Thus we have a commutative diagram
$$
\begin{array}{ccc}Y_i \longrightarrow & Z_i \longrightarrow & X_i \\ Y \uparrow\longrightarrow & Z \uparrow\longrightarrow & X \uparrow\end{array}
$$
...
Lemma \ref{pione-lemma-dominate-affine-space} to
