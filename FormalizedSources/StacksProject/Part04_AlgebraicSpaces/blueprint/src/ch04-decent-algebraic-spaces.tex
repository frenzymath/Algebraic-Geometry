...
\begin{definition}[Universally bounded]
\label{decent-spaces-definition-universally-bounded}
\source{stacks:03JL}
\href{https://stacks.math.columbia.edu/tag/03JL}{\texttt{Stacks tag 03JL}}
\group{decent-spaces}
...
\begin{lemma}[Composition universally bounded]
\label{decent-spaces-lemma-composition-universally-bounded}
\source{stacks:03JM}
\href{https://stacks.math.columbia.edu/tag/03JM}{\texttt{Stacks tag 03JM}}
\group{decent-spaces}
...
Definition \ref{decent-spaces-definition-universally-bounded}.
...
\begin{lemma}[Base change universally bounded]
\label{decent-spaces-lemma-base-change-universally-bounded}
\source{stacks:03JN}
\href{https://stacks.math.columbia.edu/tag/03JN}{\texttt{Stacks tag 03JN}}
\group{decent-spaces}
...
\begin{lemma}[Descent universally bounded]
\label{decent-spaces-lemma-descent-universally-bounded}
\source{stacks:03JO}
\href{https://stacks.math.columbia.edu/tag/03JO}{\texttt{Stacks tag 03JO}}
\group{decent-spaces}
...
Definition \ref{decent-spaces-definition-universally-bounded} for the morphism $f'$.
...
commutative diagram
$$
\begin{array}{cc}\Spec(k') \longrightarrow\downarrow & Y \downarrow \\ \Spec(k) \longrightarrow & X\end{array}
$$
Hence we see that
$$
...
\begin{lemma}[Universally bounded permanence]
\label{decent-spaces-lemma-universally-bounded-permanence}
\source{stacks:03JP}
\href{https://stacks.math.columbia.edu/tag/03JP}{\texttt{Stacks tag 03JP}}
\group{decent-spaces}

Let $S$ be a scheme. Let $X$ be an algebraic space over $S$.
Consider a commutative diagram
$$
\begin{array}{ccc}U \underset{g}{\searrow}\underset{f}{\longrightarrow} &  & V \overset{h}{\swarrow} \\  & X & \end{array}
$$
...
\begin{lemma}[Universally bounded finite fibres]
\label{decent-spaces-lemma-universally-bounded-finite-fibres}
\source{stacks:03JQ}
\href{https://stacks.math.columbia.edu/tag/03JQ}{\texttt{Stacks tag 03JQ}}
\group{decent-spaces}
...
\begin{proof}
The integer $n$ of Definition \ref{decent-spaces-definition-universally-bounded} works.
Namely, pick $x \in |X|$. Represent $x$ by a morphism
$x : \Spec(k) \to X$. Then we get a commutative diagram
$$
\begin{array}{cc}\Spec(k) \times_X U \longrightarrow\downarrow & U \downarrow \\ \Spec(k) \overset{x}{\longrightarrow} & X\end{array}
$$
which shows (via
Properties of Spaces,
Lemma \ref{spaces-properties-lemma-points-cartesian})
...
\source{stacks:03II}
\href{https://stacks.math.columbia.edu/tag/03II}{\texttt{Stacks tag 03II}}
\group{decent-spaces}
...
\begin{lemma}[U finite above x]
\label{decent-spaces-lemma-U-finite-above-x}
\source{stacks:03JS}
\href{https://stacks.math.columbia.edu/tag/03JS}{\texttt{Stacks tag 03JS}}
\group{decent-spaces}
...
$$
\begin{array}{cc}U \times_X U_i \underset{p_i}{\longrightarrow}\underset{q_i}{\downarrow} & U_i \overset{\varphi_i}{\downarrow} \\ U \overset{\varphi}{\longrightarrow} & X\end{array}
\quad \quad
\begin{array}{cc}\coprod U \times_X U_i \underset{\coprod p_i}{\longrightarrow}\underset{\coprod q_i}{\downarrow} & \coprod U_i \overset{\coprod \varphi_i}{\downarrow} \\ U \overset{\varphi}{\longrightarrow} & X\end{array}
$$
Since $q_i$ is \'etale it is open (see Remark \ref{decent-spaces-remark-recall}).
...
\begin{lemma}[R finite above x]
\label{decent-spaces-lemma-R-finite-above-x}
\source{stacks:03JU}
\href{https://stacks.math.columbia.edu/tag/03JU}{\texttt{Stacks tag 03JU}}
\group{decent-spaces}
...
$$
\begin{array}{cc}W \times_X U \underset{p}{\longrightarrow}\underset{q}{\downarrow} & U \overset{\varphi}{\downarrow} \\ W \overset{\psi}{\longrightarrow} & X\end{array}
$$
...
finite separable, see Remark \ref{decent-spaces-remark-recall}.
Then we get a commutative diagram
$$
\begin{array}{ccc}w \times_X w' \downarrow & \tilde w \times_X \tilde w' \longleftarrow\downarrow\longrightarrow & u \times_X u' \downarrow \\ w \times_X w' & \tilde w \times_S \tilde w' \longleftarrow\longrightarrow & u \times_S u'\end{array}
$$
...
Remark \ref{decent-spaces-remark-recall}). Since $u \times_X u$ is finite the image
...
a picture
$$
\begin{array}{cc}u \longrightarrow\downarrow & U \downarrow \\ \Spec(k) \longrightarrow & X\end{array}
$$
...
\begin{lemma}[Weak UR finite above x]
\label{decent-spaces-lemma-weak-UR-finite-above-x}
\source{stacks:040U}
\href{https://stacks.math.columbia.edu/tag/040U}{\texttt{Stacks tag 040U}}
\group{decent-spaces}
...
Lemma \ref{decent-spaces-lemma-R-finite-above-x} and hence we obtain a monomorphism
...
\begin{lemma}[UR finite above x]
\label{decent-spaces-lemma-UR-finite-above-x}
\source{stacks:03JV}
\href{https://stacks.math.columbia.edu/tag/03JV}{\texttt{Stacks tag 03JV}}
\group{decent-spaces}
...
Lemma \ref{decent-spaces-lemma-weak-UR-finite-above-x}
...
Lemma \ref{decent-spaces-lemma-U-finite-above-x}
that for any affine scheme $U$ and \'etale morphism $U \to X$
the fibre of $|U| \to |X|$ over $x$ is finite.
Say this fibre is $\{u_1, \ldots, u_n\}$. Then, as
Lemma \ref{decent-spaces-lemma-R-finite-above-x} (1)
...
extensions of $k$ by
Remark \ref{decent-spaces-remark-recall})
...
$$
\begin{array}{cc}F \longrightarrow\downarrow & U \downarrow \\ \Spec(k) \longrightarrow & X\end{array}
$$
...
(Remark \ref{decent-spaces-remark-recall}). Since the image of $|F| \to |U|$
...
\begin{lemma}[U universally bounded]
\label{decent-spaces-lemma-U-universally-bounded}
\source{stacks:03JT}
\href{https://stacks.math.columbia.edu/tag/03JT}{\texttt{Stacks tag 03JT}}
\group{decent-spaces}
...
$$
\begin{array}{cc}U \times_X U_i \underset{p_i}{\longrightarrow}\underset{q_i}{\downarrow} & U_i \overset{\varphi_i}{\downarrow} \\ U \overset{\psi}{\longrightarrow} & X\end{array}
$$
Since $q_i$ is \'etale it is open (see Remark \ref{decent-spaces-remark-recall}).
...
bounded. Hence by
Lemma \ref{decent-spaces-lemma-composition-universally-bounded}
...
Lemma \ref{decent-spaces-lemma-universally-bounded-permanence}.
In other words (2) holds.
\end{proof}

\begin{lemma}[Characterize very reasonable]
\label{decent-spaces-lemma-characterize-very-reasonable}
\source{stacks:03IH}
\href{https://stacks.math.columbia.edu/tag/03IH}{\texttt{Stacks tag 03IH}}
\group{decent-spaces}
...
\begin{lemma}[Bounded fibres]
\label{decent-spaces-lemma-bounded-fibres}
\source{stacks:03JX}
\href{https://stacks.math.columbia.edu/tag/03JX}{\texttt{Stacks tag 03JX}}
\group{decent-spaces}
...
Lemma \ref{decent-spaces-lemma-R-finite-above-x}
hold.
\item[] $(\gamma)$ For every $x \in |X|$, the equivalent conditions of
Lemma \ref{decent-spaces-lemma-UR-finite-above-x}
hold.
\item[] $(\delta)$ The equivalent conditions of
Lemma \ref{decent-spaces-lemma-U-universally-bounded}
hold.
\item[] $(\epsilon)$ The equivalent conditions of
Lemma \ref{decent-spaces-lemma-characterize-very-reasonable}
hold.
...
We have
$$
\begin{array}{ccccccc} & (\theta) \searrow &  &  &  &  &  \\ (\iota) \nearrow\searrow &  & (\zeta) \Longrightarrow & (\epsilon) \Longrightarrow & (\delta) \Longrightarrow & (\gamma) \Longleftrightarrow & (\alpha) + (\beta) \\  & (\eta) \nearrow &  &  &  &  & \end{array}
$$
\end{lemma}
...
$$
\begin{array}{cc}W \times_X U_i \underset{p}{\longrightarrow}\underset{q}{\downarrow} & U_i \downarrow \\ W \longrightarrow & X\end{array}
$$
...
Lemma \ref{decent-spaces-lemma-descent-universally-bounded}
...
Lemma \ref{decent-spaces-lemma-base-change-universally-bounded}.
And by
Lemma \ref{decent-spaces-lemma-composition-universally-bounded}
also the fibres of $R \to X$ are universally bounded.
Hence for any $x \in X$ the fibres of $|U| \to |X|$ and $|R| \to |X|$
over $x$ are finite, see
Lemma \ref{decent-spaces-lemma-universally-bounded-finite-fibres}.
...
\source{stacks:03KE}
\href{https://stacks.math.columbia.edu/tag/03KE}{\texttt{Stacks tag 03KE}}
\group{decent-spaces}
...
\begin{lemma}[Representable properties]
\label{decent-spaces-lemma-representable-properties}
\source{stacks:03KF}
\href{https://stacks.math.columbia.edu/tag/03KF}{\texttt{Stacks tag 03KF}}
\group{decent-spaces}
...
$$
\begin{array}{cc}\Spec(k') \underset{x}{\longrightarrow}\downarrow & X \downarrow \\ \Spec(k) \overset{y}{\longrightarrow} & Y\end{array}
$$
Also, by definition of property $(\gamma)$ via
Lemma \ref{decent-spaces-lemma-UR-finite-above-x} (2)
there exist schemes
...
Lemma \ref{decent-spaces-lemma-characterize-very-reasonable} (2).
...
\begin{definition}[Very reasonable]
\label{decent-spaces-definition-very-reasonable}
\source{stacks:03I8}
\href{https://stacks.math.columbia.edu/tag/03I8}{\texttt{Stacks tag 03I8}}
\group{decent-spaces}
...
$$
\begin{array}{cccc}\text{representable} \searrow &  &  &  \\  & \text{very reasonable} \Longrightarrow & \text{reasonable} \Longrightarrow & \text{decent} \\ \text{quasi-separated} \nearrow &  &  & \end{array}
$$
...
\begin{example}[Not decent]
\label{decent-spaces-example-not-decent}
\source{stacks:03ID}
\href{https://stacks.math.columbia.edu/tag/03ID}{\texttt{Stacks tag 03ID}}
\group{decent-spaces}
...
\begin{remark}[Reasonable]
\label{decent-spaces-remark-reasonable}
\source{stacks:03JY}
\href{https://stacks.math.columbia.edu/tag/03JY}{\texttt{Stacks tag 03JY}}
\group{decent-spaces}
...
so is $Y$, see
Lemma \ref{decent-spaces-lemma-descent-conditions}
...
\begin{lemma}[Fun property reasonable]
\label{decent-spaces-lemma-fun-property-reasonable}
\source{stacks:03K0}
\href{https://stacks.math.columbia.edu/tag/03K0}{\texttt{Stacks tag 03K0}}
\group{decent-spaces}
...
\begin{lemma}[Representable named properties]
\label{decent-spaces-lemma-representable-named-properties}
\source{stacks:0ABT}
\href{https://stacks.math.columbia.edu/tag/0ABT}{\texttt{Stacks tag 0ABT}}
\group{decent-spaces}
...
\begin{proof}
Translation of Lemma \ref{decent-spaces-lemma-representable-properties}.
\end{proof}

\begin{lemma}[Etale named properties]
\label{decent-spaces-lemma-etale-named-properties}
\source{stacks:0ABU}
\href{https://stacks.math.columbia.edu/tag/0ABU}{\texttt{Stacks tag 0ABU}}
\group{decent-spaces}
...
\begin{lemma}[No specializations map to same point]
\label{decent-spaces-lemma-no-specializations-map-to-same-point}
\source{stacks:03IM}
\href{https://stacks.math.columbia.edu/tag/03IM}{\texttt{Stacks tag 03IM}}
\group{decent-spaces}
...
equivalent conditions for Lemma \ref{decent-spaces-lemma-U-finite-above-x}.
...
(Remark \ref{decent-spaces-remark-recall}) we can find a specialization $r' \leadsto r$ with
$t(r') = u'$. Set $u'' = s(r')$. Then $u'' \leadsto u'$.
Thus we may repeat and find $r'' \leadsto r'$ with
$t(r'') = u''$. Set $u''' = s(r'')$, and so on.
Here is a picture:
$$
\begin{array}{ccc} & r'' \overset{s}{\searrow}\underset{t}{\swarrow}\downarrow &  \\ u'' \downarrow & r' \overset{s}{\searrow}\underset{t}{\swarrow}\downarrow & u''' \downarrow \\ u' \downarrow & r \overset{s}{\searrow}\underset{t}{\swarrow} & u'' \downarrow \\ u &  & u'\end{array}
$$
In Remark \ref{decent-spaces-remark-recall} we have seen that there are no specializations
...
Lemma \ref{decent-spaces-lemma-U-finite-above-x}, as desired.
\end{proof}

\begin{lemma}[No specializations map to same point Noetherian]
\label{decent-spaces-lemma-no-specializations-map-to-same-point-Noetherian}
\source{stacks:0H1Q}
\href{https://stacks.math.columbia.edu/tag/0H1Q}{\texttt{Stacks tag 0H1Q}}
\group{decent-spaces}
...
\source{stacks:03K2}
\href{https://stacks.math.columbia.edu/tag/03K2}{\texttt{Stacks tag 03K2}}
\group{decent-spaces}
...
of Lemma \ref{decent-spaces-lemma-UR-finite-above-x}.
...
Remark \ref{decent-spaces-remark-recall}, we can find $r' \leadsto r$ with
...
\begin{lemma}[Generalizations lift flat]
\label{decent-spaces-lemma-generalizations-lift-flat}
\source{stacks:0B7W}
\href{https://stacks.math.columbia.edu/tag/0B7W}{\texttt{Stacks tag 0B7W}}
\group{decent-spaces}
...
conditions of Lemma \ref{decent-spaces-lemma-UR-finite-above-x} (for example if
...
mentioned in Section \ref{decent-spaces-section-reasonable-decent}.)
...
Choose $u \in U$ mapping to $x$. By Lemma \ref{decent-spaces-lemma-specialization}
...
\begin{lemma}[Quasi compact reasonable stratification]
\label{decent-spaces-lemma-quasi-compact-reasonable-stratification}
\source{stacks:07S8}
\href{https://stacks.math.columbia.edu/tag/07S8}{\texttt{Stacks tag 07S8}}
\group{decent-spaces}
...
\begin{lemma}[Stratify flat fp lqf]
\label{decent-spaces-lemma-stratify-flat-fp-lqf}
\source{stacks:086T}
\href{https://stacks.math.columbia.edu/tag/086T}{\texttt{Stacks tag 086T}}
\group{decent-spaces}
...
\begin{lemma}[Filter quasi compact]
\label{decent-spaces-lemma-filter-quasi-compact}
\source{stacks:0BBN}
\href{https://stacks.math.columbia.edu/tag/0BBN}{\texttt{Stacks tag 0BBN}}
\group{decent-spaces}
...
Remark \ref{decent-spaces-remark-recall}. It follows that
...
\begin{lemma}[Filter reasonable]
\label{decent-spaces-lemma-filter-reasonable}
\source{stacks:07S9}
\href{https://stacks.math.columbia.edu/tag/07S9}{\texttt{Stacks tag 07S9}}
\group{decent-spaces}
...
\begin{lemma}[Stratify reasonable]
\label{decent-spaces-lemma-stratify-reasonable}
\source{stacks:07SA}
\href{https://stacks.math.columbia.edu/tag/07SA}{\texttt{Stacks tag 07SA}}
\group{decent-spaces}
...
\begin{proof}
Immediate consequence of Lemma \ref{decent-spaces-lemma-filter-reasonable}.
\end{proof}

The following result is almost identical to
\cite[Proposition 5.7.8]{GruRay}.

\begin{lemma}[Filter quasi compact quasi separated]
\label{decent-spaces-lemma-filter-quasi-compact-quasi-separated}
\source{stacks:07ST}
\href{https://stacks.math.columbia.edu/tag/07ST}{\texttt{Stacks tag 07ST}}
\group{decent-spaces}
...
\source{stacks:0ECZ}
\href{https://stacks.math.columbia.edu/tag/0ECZ}{\texttt{Stacks tag 0ECZ}}
\group{decent-spaces}
...
Lemma \ref{decent-spaces-lemma-filter-quasi-compact-quasi-separated}.
...
\begin{lemma}[Extend integral morphism]
\label{decent-spaces-lemma-extend-integral-morphism}
\source{stacks:0G2D}
\href{https://stacks.math.columbia.edu/tag/0G2D}{\texttt{Stacks tag 0G2D}}
\group{decent-spaces}
...
\begin{lemma}[There is a scheme integral over]
\label{decent-spaces-lemma-there-is-a-scheme-integral-over}
\source{stacks:09YB}
\href{https://stacks.math.columbia.edu/tag/09YB}{\texttt{Stacks tag 09YB}}
\group{decent-spaces}
...
(see Lemma \ref{decent-spaces-lemma-bounded-fibres}).
...
$$
\begin{array}{ccc}U \underset{j}{\longrightarrow}\searrow &  & Y \overset{\pi}{\swarrow} \\  & X & \end{array}
$$
...
by Lemma \ref{decent-spaces-lemma-quasi-compact-reasonable-stratification}
...
(Lemma \ref{decent-spaces-lemma-extend-integral-morphism}).
...
\begin{lemma}[There is a scheme integral over refined]
\label{decent-spaces-lemma-there-is-a-scheme-integral-over-refined}
\source{stacks:0GUL}
\href{https://stacks.math.columbia.edu/tag/0GUL}{\texttt{Stacks tag 0GUL}}
\group{decent-spaces}
...
Lemma \ref{decent-spaces-lemma-there-is-a-scheme-integral-over}
...
$$
\begin{array}{ccc}V_j \longrightarrow\underset{\varphi_j}{\searrow} &  & Y_j \overset{\pi_j}{\swarrow} \\  & X & \end{array}
$$
...
of $Y_j$ by Lemma \ref{decent-spaces-lemma-quasi-compact-reasonable-stratification}
(the degree of the fibres of a quasi-compact \'etale morphism
...
\begin{proposition}[Reasonable open dense scheme]
\label{decent-spaces-proposition-reasonable-open-dense-scheme}
\source{stacks:03JI}
\href{https://stacks.math.columbia.edu/tag/03JI}{\texttt{Stacks tag 03JI}}
\group{decent-spaces}
...
Lemma \ref{decent-spaces-lemma-quasi-compact-reasonable-stratification}
...
\source{stacks:086U}
\href{https://stacks.math.columbia.edu/tag/086U}{\texttt{Stacks tag 086U}}
\group{decent-spaces}
...
$$
constructed in Lemma \ref{decent-spaces-lemma-stratify-flat-fp-lqf}
...
\begin{lemma}[When quotient scheme at point]
\label{decent-spaces-lemma-when-quotient-scheme-at-point}
\source{stacks:0BA1}
\href{https://stacks.math.columbia.edu/tag/0BA1}{\texttt{Stacks tag 0BA1}}
\group{decent-spaces}
...
\begin{lemma}[Finite etale cover dense open scheme]
\label{decent-spaces-lemma-finite-etale-cover-dense-open-scheme}
\source{stacks:06NG}
\href{https://stacks.math.columbia.edu/tag/06NG}{\texttt{Stacks tag 06NG}}
\group{decent-spaces}
...
Lemma \ref{decent-spaces-lemma-when-quotient-scheme-at-point}.
\end{proof}
...
\begin{lemma}[Decent points monomorphism]
\label{decent-spaces-lemma-decent-points-monomorphism}
\source{stacks:03K4}
\href{https://stacks.math.columbia.edu/tag/03K4}{\texttt{Stacks tag 03K4}}
\group{decent-spaces}
...
By Lemma \ref{decent-spaces-lemma-bounded-fibres} it is surjective when $X$ is
...
by Lemma \ref{decent-spaces-lemma-decent-points-monomorphism}
and hence the following definition makes sense.

\begin{definition}[Residue field]
\label{decent-spaces-definition-residue-field}
\source{stacks:0EMW}
\href{https://stacks.math.columbia.edu/tag/0EMW}{\texttt{Stacks tag 0EMW}}
\group{decent-spaces}
...
$$
\begin{array}{cc}\Spec(\kappa(x)) \underset{x}{\longrightarrow}\downarrow & X \overset{f}{\downarrow} \\ \Spec(\kappa(y)) \overset{y}{\longrightarrow} & Y\end{array}
$$
...
\begin{lemma}[Identifies residue fields]
\label{decent-spaces-lemma-identifies-residue-fields}
\source{stacks:0EMX}
\href{https://stacks.math.columbia.edu/tag/0EMX}{\texttt{Stacks tag 0EMX}}
\group{decent-spaces}
...
\begin{lemma}[Decent space elementary etale neighbourhood]
\label{decent-spaces-lemma-decent-space-elementary-etale-neighbourhood}
\source{stacks:0BBP}
\href{https://stacks.math.columbia.edu/tag/0BBP}{\texttt{Stacks tag 0BBP}}
\group{decent-spaces}
...
lemma follows from Lemma \ref{decent-spaces-lemma-filter-quasi-compact}.
\end{proof}

\begin{definition}[Elemenary etale neighbourhood]
\label{decent-spaces-definition-elemenary-etale-neighbourhood}
\source{stacks:0BGU}
\href{https://stacks.math.columbia.edu/tag/0BGU}{\texttt{Stacks tag 0BGU}}
\group{decent-spaces}
...
\begin{lemma}[Elementary etale neighbourhoods]
\label{decent-spaces-lemma-elementary-etale-neighbourhoods}
\source{stacks:0BGV}
\href{https://stacks.math.columbia.edu/tag/0BGV}{\texttt{Stacks tag 0BGV}}
\group{decent-spaces}
...
Lemma \ref{decent-spaces-lemma-decent-space-elementary-etale-neighbourhood}.
...
in the class of $x$ (Lemma \ref{decent-spaces-lemma-identifies-residue-fields})
, we see that
$$
...
\begin{definition}[Henselian local ring]
\label{decent-spaces-definition-henselian-local-ring}
\source{stacks:0BGW}
\href{https://stacks.math.columbia.edu/tag/0BGW}{\texttt{Stacks tag 0BGW}}
\group{decent-spaces}
...
\begin{lemma}[Describe henselian local ring]
\label{decent-spaces-lemma-describe-henselian-local-ring}
\source{stacks:0EMY}
\href{https://stacks.math.columbia.edu/tag/0EMY}{\texttt{Stacks tag 0EMY}}
\group{decent-spaces}
...
is cofiltered (Lemma \ref{decent-spaces-lemma-elementary-etale-neighbourhoods})
we see that
...
defining henselian local rings is over the
opposite of the category of elementary
\'etale neighbourhoods).
\end{proof}

\begin{lemma}[Henselian local ring strict]
\label{decent-spaces-lemma-henselian-local-ring-strict}
\source{stacks:0EMZ}
\href{https://stacks.math.columbia.edu/tag/0EMZ}{\texttt{Stacks tag 0EMZ}}
\group{decent-spaces}
...
\begin{proof}
Follows from Lemma \ref{decent-spaces-lemma-describe-henselian-local-ring},
Properties of Spaces, Lemma
\ref{spaces-properties-lemma-describe-etale-local-ring}
...
\begin{lemma}[Residue field henselian local ring]
\label{decent-spaces-lemma-residue-field-henselian-local-ring}
\source{stacks:0EN0}
\href{https://stacks.math.columbia.edu/tag/0EN0}{\texttt{Stacks tag 0EN0}}
\group{decent-spaces}

Let $S$ be a scheme. Let $X$ be a decent algebraic space over $S$.
Let $x \in |X|$. The residue field of the
henselian local ring of $X$ at $x$
(Definition \ref{decent-spaces-definition-henselian-local-ring})
is the residue field of $X$ at $x$
(Definition \ref{decent-spaces-definition-residue-field}).
\end{lemma}
...
$\mathcal{O}_{X, x}^h = \mathcal{O}_{U, u}^h$
(Lemma \ref{decent-spaces-lemma-describe-henselian-local-ring}).
...
\begin{remark}[Functoriality henselian local ring]
\label{decent-spaces-remark-functoriality-henselian-local-ring}
\source{stacks:0EPL}
\href{https://stacks.math.columbia.edu/tag/0EPL}{\texttt{Stacks tag 0EPL}}
\group{decent-spaces}
...
$$
\begin{array}{ccccc}\Spec(\mathcal{O}_{X, \overline{x}}) \longrightarrow\downarrow & \Spec(\mathcal{O}_{X, x}^h) \longrightarrow\downarrow & \Spec(\mathcal{O}_{U, u}) \longrightarrow\downarrow & U \longrightarrow\downarrow & X \downarrow \\ \Spec(\mathcal{O}_{Y, \overline{y}}) \longrightarrow & \Spec(\mathcal{O}_{Y, y}^h) \longrightarrow & \Spec(\mathcal{O}_{V, v}) \longrightarrow & V \longrightarrow & Y\end{array}
$$
...
\begin{lemma}[Decent no specializations map to same point]
\label{decent-spaces-lemma-decent-no-specializations-map-to-same-point}
\source{stacks:03K5}
\href{https://stacks.math.columbia.edu/tag/03K5}{\texttt{Stacks tag 03K5}}
\group{decent-spaces}
...
\begin{proof}
Combine Lemmas \ref{decent-spaces-lemma-bounded-fibres} and
\ref{decent-spaces-lemma-no-specializations-map-to-same-point}.
\end{proof}

\begin{lemma}[Decent specialization]
\label{decent-spaces-lemma-decent-specialization}
\source{stacks:03IL}
\href{https://stacks.math.columbia.edu/tag/03IL}{\texttt{Stacks tag 03IL}}
\group{decent-spaces}
...
\source{stacks:03K3}
\href{https://stacks.math.columbia.edu/tag/03K3}{\texttt{Stacks tag 03K3}}
\group{decent-spaces}
...
By Lemma \ref{decent-spaces-lemma-decent-specialization} we can find a specialization
$u_1 \leadsto u_2$ in $U$ mapping to $x_1 \leadsto x_2$.
By Lemma \ref{decent-spaces-lemma-decent-specialization} we can find
...
$u_2' = u_2$, see
Lemma \ref{decent-spaces-lemma-decent-no-specializations-map-to-same-point}. Hence
also $u_1 = u_2$ as desired.
\end{proof}

\begin{proposition}[Reasonable sober]
\label{decent-spaces-proposition-reasonable-sober}
\source{stacks:03K6}
\href{https://stacks.math.columbia.edu/tag/03K6}{\texttt{Stacks tag 03K6}}
\group{decent-spaces}
...
\begin{proof}
We have seen in Lemma \ref{decent-spaces-lemma-kolmogorov} that $|X|$ is Kolmogorov.
...
by Lemma \ref{decent-spaces-lemma-representable-properties}. By
...
\begin{lemma}[Dimension decent space]
\label{decent-spaces-lemma-dimension-decent-space}
\source{stacks:0A4J}
\href{https://stacks.math.columbia.edu/tag/0A4J}{\texttt{Stacks tag 0A4J}}
\group{decent-spaces}
...
Lemma \ref{decent-spaces-lemma-decent-no-specializations-map-to-same-point}.
...
in $U$ by Lemma \ref{decent-spaces-lemma-decent-specialization}.
...
\begin{lemma}[Dimension local ring quasi finite]
\label{decent-spaces-lemma-dimension-local-ring-quasi-finite}
\source{stacks:0ABW}
\href{https://stacks.math.columbia.edu/tag/0ABW}{\texttt{Stacks tag 0ABW}}
\group{decent-spaces}
...
\begin{lemma}[Dimension quasi finite]
\label{decent-spaces-lemma-dimension-quasi-finite}
\source{stacks:0ED0}
\href{https://stacks.math.columbia.edu/tag/0ED0}{\texttt{Stacks tag 0ED0}}
\group{decent-spaces}
...
\begin{proof}
This follows from Lemma \ref{decent-spaces-lemma-dimension-local-ring-quasi-finite}
...
Properties of Spaces,
Lemma \ref{spaces-properties-lemma-point-like-spaces}.
We will improve this lemma in Lemma \ref{decent-spaces-lemma-when-field}.

\begin{lemma}[Decent point like spaces]
\label{decent-spaces-lemma-decent-point-like-spaces}
\source{stacks:03IK}
\href{https://stacks.math.columbia.edu/tag/03IK}{\texttt{Stacks tag 03IK}}
\group{decent-spaces}
...
\source{stacks:06QV}
\href{https://stacks.math.columbia.edu/tag/06QV}{\texttt{Stacks tag 06QV}}
\group{decent-spaces}
...
$$
\begin{array}{cc}T \downarrow\longrightarrow & \Spec(k) \downarrow \\ \Spec(k') \longrightarrow & Z\end{array}
$$
...
\source{stacks:06QW}
\href{https://stacks.math.columbia.edu/tag/06QW}{\texttt{Stacks tag 06QW}}
\group{decent-spaces}
...
(see Remark \ref{decent-spaces-remark-recall}), in particular reduced. Since
$W \times_Z \Spec(k) \to W$
...
Lemma \ref{decent-spaces-lemma-flat-cover-by-field}.
Hence (3) holds.
\end{proof}
...
\source{stacks:06QX}
\href{https://stacks.math.columbia.edu/tag/06QX}{\texttt{Stacks tag 06QX}}
\group{decent-spaces}
...
\begin{proof}
Assume (2) holds. By
Lemma \ref{decent-spaces-lemma-unique-point}
...
(see Remark \ref{decent-spaces-remark-recall}),
...
\source{stacks:06QY}
\href{https://stacks.math.columbia.edu/tag/06QY}{\texttt{Stacks tag 06QY}}
\group{decent-spaces}
...
\begin{lemma}[Find singleton from point]
\label{decent-spaces-lemma-find-singleton-from-point}
\source{stacks:06QZ}
\href{https://stacks.math.columbia.edu/tag/06QZ}{\texttt{Stacks tag 06QZ}}
\group{decent-spaces}
...
conditions of
Lemma \ref{decent-spaces-lemma-unique-point-better}
...
Lemma \ref{decent-spaces-lemma-monomorphism-into-point}
and we win.
\end{proof}
...
\source{stacks:06R0}
\href{https://stacks.math.columbia.edu/tag/06R0}{\texttt{Stacks tag 06R0}}
\group{decent-spaces}
...
Lemma \ref{decent-spaces-lemma-find-singleton-from-point}.
\end{definition}
...
\begin{lemma}[Residual space monomorphism]
\label{decent-spaces-lemma-residual-space-monomorphism}
\source{stacks:0H1R}
\href{https://stacks.math.columbia.edu/tag/0H1R}{\texttt{Stacks tag 0H1R}}
\group{decent-spaces}
...
an isomorphism by Lemma \ref{decent-spaces-lemma-monomorphism-into-point}.
The final statement follows from Lemma \ref{decent-spaces-lemma-decent-points-monomorphism}.
\end{proof}

The residual space is a regular algebraic space by the following lemma.

\begin{lemma}[Residual space regular]
\label{decent-spaces-lemma-residual-space-regular}
\source{stacks:06R1}
\href{https://stacks.math.columbia.edu/tag/06R1}{\texttt{Stacks tag 06R1}}
\group{decent-spaces}
...
\begin{lemma}[Factor through residual space Noetherian]
\label{decent-spaces-lemma-factor-through-residual-space-Noetherian}
\source{stacks:0H1S}
\href{https://stacks.math.columbia.edu/tag/0H1S}{\texttt{Stacks tag 0H1S}}
\group{decent-spaces}
...
Lemma \ref{decent-spaces-lemma-no-specializations-map-to-same-point-Noetherian}.
The morphism $Y' \to U$ maps $|Y'|$ into $E$. By our construction
of $Z_x$ in the proof of Lemma \ref{decent-spaces-lemma-find-singleton-from-point}
...
\begin{lemma}[Factor through residual space decent]
\label{decent-spaces-lemma-factor-through-residual-space-decent}
\source{stacks:0H1T}
\href{https://stacks.math.columbia.edu/tag/0H1T}{\texttt{Stacks tag 0H1T}}
\group{decent-spaces}
...
\begin{proof}
By Lemma \ref{decent-spaces-lemma-residual-space-monomorphism} we have $Z_x = \Spec(k)$.
...
we may assume $X$ quasi-compact. By Lemma \ref{decent-spaces-lemma-filter-quasi-compact}, $x$
...
\begin{example}[Does not factor through residual gerbe]
\label{decent-spaces-example-does-not-factor-through-residual-gerbe}
\source{stacks:0H2Y}
\href{https://stacks.math.columbia.edu/tag/0H2Y}{\texttt{Stacks tag 0H2Y}}
\group{decent-spaces}

Here is a counter example to
Lemmas \ref{decent-spaces-lemma-factor-through-residual-space-Noetherian} and
...
acting on $Y$ by translations. Put $X = Y/\Gamma$.
...
\source{stacks:0H1U}
\href{https://stacks.math.columbia.edu/tag/0H1U}{\texttt{Stacks tag 0H1U}}
\group{decent-spaces}
...
\begin{lemma}[Locally Noetherian decent quasi separated]
\label{decent-spaces-lemma-locally-Noetherian-decent-quasi-separated}
\source{stacks:0BB6}
\href{https://stacks.math.columbia.edu/tag/0BB6}{\texttt{Stacks tag 0BB6}}
\group{decent-spaces}
...
finite separable extensions of $k$ (Remark \ref{decent-spaces-remark-recall})
...
\begin{lemma}[When field]
\label{decent-spaces-lemma-when-field}
\source{stacks:047Z}
\href{https://stacks.math.columbia.edu/tag/047Z}{\texttt{Stacks tag 047Z}}
\group{decent-spaces}
...
Theorem \ref{decent-spaces-theorem-decent-open-dense-scheme} that $X$ is a scheme,
...
Lemma \ref{decent-spaces-lemma-UR-finite-above-x} (and the definition of a decent space).
...
\begin{remark}[One point decent scheme]
\label{decent-spaces-remark-one-point-decent-scheme}
\source{stacks:049D}
\href{https://stacks.math.columbia.edu/tag/049D}{\texttt{Stacks tag 049D}}
\group{decent-spaces}
...
\begin{lemma}[Algebraic residue field extension closed point]
\label{decent-spaces-lemma-algebraic-residue-field-extension-closed-point}
\source{stacks:07U5}
\href{https://stacks.math.columbia.edu/tag/07U5}{\texttt{Stacks tag 07U5}}
\group{decent-spaces}

Let $S$ be a scheme. Let $X$ be a decent algebraic space over $S$.
Consider a commutative diagram
$$
\begin{array}{ccc}\Spec(k) \longrightarrow\searrow &  & X \swarrow \\  & S & \end{array}
$$
...
mapping to $x$ in $X$, see Lemma \ref{decent-spaces-lemma-decent-specialization}.
...
\begin{lemma}[Finite residue field extension finite]
\label{decent-spaces-lemma-finite-residue-field-extension-finite}
\source{stacks:08AL}
\href{https://stacks.math.columbia.edu/tag/08AL}{\texttt{Stacks tag 08AL}}
\group{decent-spaces}
...
\begin{proof}
By Lemma \ref{decent-spaces-lemma-algebraic-residue-field-extension-closed-point}
...
Lemma \ref{decent-spaces-lemma-representable-named-properties}.
By Lemma \ref{decent-spaces-lemma-when-field} we see that $Z = \Spec(k')$
...
\begin{lemma}[Decent space closed point]
\label{decent-spaces-lemma-decent-space-closed-point}
\source{stacks:0AHB}
\href{https://stacks.math.columbia.edu/tag/0AHB}{\texttt{Stacks tag 0AHB}}
\group{decent-spaces}
...
finite disjoint union of spectra of fields (Remark \ref{decent-spaces-remark-recall}).
...
\begin{lemma}[Infinite number]
\label{decent-spaces-lemma-infinite-number}
\source{stacks:088I}
\href{https://stacks.math.columbia.edu/tag/088I}{\texttt{Stacks tag 088I}}
\group{decent-spaces}
...
\source{stacks:088J}
\href{https://stacks.math.columbia.edu/tag/088J}{\texttt{Stacks tag 088J}}
\group{decent-spaces}
...
(see Remark \ref{decent-spaces-remark-recall} and
Schemes, Lemma \ref{schemes-lemma-mono-towards-spec-field}).
...
$i \not = i'$, $i, i' \in I$. By Lemma \ref{decent-spaces-lemma-infinite-number}
...
\begin{proposition}[Characterize universally closed]
\label{decent-spaces-proposition-characterize-universally-closed}
\source{stacks:03KJ}
\href{https://stacks.math.columbia.edu/tag/03KJ}{\texttt{Stacks tag 03KJ}}
\group{decent-spaces}
...
$$
\begin{array}{cc}\Spec(K) \longrightarrow\searrow & X_A \downarrow \\  & \Spec(A)\end{array}
$$
By
Morphisms of Spaces,
...
Lemma \ref{decent-spaces-lemma-representable-properties}.
...
$\varphi(u) = x$. By
Lemma \ref{decent-spaces-lemma-specialization}
...
$$
\begin{array}{cc}\Spec(K') \longrightarrow\downarrow & U \downarrow \\ \Spec(K) \longrightarrow\searrow & X \downarrow \\  & \Spec(A)\end{array}
$$
is commutative. This gives the following commutative diagram of rings
$$
\begin{array}{cc}K' & \mathcal{O}_{U, u} \longleftarrow \\ K \uparrow &  \\  & A \nwarrow\uparrow\end{array}
$$
By
...
\begin{definition}[Relative conditions]
\label{decent-spaces-definition-relative-conditions}
\source{stacks:03KZ}
\href{https://stacks.math.columbia.edu/tag/03KZ}{\texttt{Stacks tag 03KZ}}
\group{decent-spaces}
...
We refer to Remark \ref{decent-spaces-remark-very-reasonable} for an informal discussion.
...
\begin{lemma}[Properties trivial implications]
\label{decent-spaces-lemma-properties-trivial-implications}
\source{stacks:03M5}
\href{https://stacks.math.columbia.edu/tag/03M5}{\texttt{Stacks tag 03M5}}
\group{decent-spaces}
...
$$
\begin{array}{ccccc}\text{representable} \searrow &  &  &  &  \\  & \text{very reasonable} \Longrightarrow & \text{reasonable} \Longrightarrow & \text{decent} \Longrightarrow & (\beta) \\ \text{quasi-separated} \nearrow &  &  &  & \end{array}
$$
\end{lemma}
...
\begin{lemma}[Property for morphism out of property]
\label{decent-spaces-lemma-property-for-morphism-out-of-property}
\source{stacks:0ABX}
\href{https://stacks.math.columbia.edu/tag/0ABX}{\texttt{Stacks tag 0ABX}}
\group{decent-spaces}

Let $S$ be a scheme. Let $f : X \to Y$ be a morphism of algebraic
spaces over $S$. If $X$ is decent (resp.\ is reasonable, resp.\ has property
$(\beta)$ of Lemma \ref{decent-spaces-lemma-bounded-fibres}), then $f$ is
...
\begin{lemma}[Base change relative conditions]
\label{decent-spaces-lemma-base-change-relative-conditions}
\source{stacks:03L0}
\href{https://stacks.math.columbia.edu/tag/03L0}{\texttt{Stacks tag 03L0}}
\group{decent-spaces}
...
\begin{lemma}[Property over property]
\label{decent-spaces-lemma-property-over-property}
\source{stacks:0ABY}
\href{https://stacks.math.columbia.edu/tag/0ABY}{\texttt{Stacks tag 0ABY}}
\group{decent-spaces}
...
$$
\begin{array}{cc}\Spec(k') \underset{x}{\longrightarrow}\downarrow & X \overset{f}{\downarrow} \\ \Spec(k) \overset{y}{\longrightarrow} & Y\end{array}
$$
...
\begin{lemma}[Composition relative conditions]
\label{decent-spaces-lemma-composition-relative-conditions}
\source{stacks:03L1}
\href{https://stacks.math.columbia.edu/tag/03L1}{\texttt{Stacks tag 03L1}}
\group{decent-spaces}
...
has $(\omega)$. By
Lemma \ref{decent-spaces-lemma-base-change-relative-conditions}
...
This is the content of Lemma \ref{decent-spaces-lemma-property-over-property}.
\end{proof}

\begin{lemma}[Fibre product conditions]
\label{decent-spaces-lemma-fibre-product-conditions}
\source{stacks:0ABZ}
\href{https://stacks.math.columbia.edu/tag/0ABZ}{\texttt{Stacks tag 0ABZ}}
\group{decent-spaces}
...
$(\beta)$ of Lemma \ref{decent-spaces-lemma-bounded-fibres}), then so does $X \times_Y Z$.
\end{lemma}

\begin{proof}
Namely, by Lemma \ref{decent-spaces-lemma-property-for-morphism-out-of-property}
...
property by Lemma \ref{decent-spaces-lemma-property-over-property}.
\end{proof}

\begin{lemma}[Descent conditions]
\label{decent-spaces-lemma-descent-conditions}
\source{stacks:03L2}
\href{https://stacks.math.columbia.edu/tag/03L2}{\texttt{Stacks tag 03L2}}
\group{decent-spaces}
...
$$
\begin{array}{cccc}W \longrightarrow\searrow & V \times_Y X \longrightarrow\downarrow & X \underset{f}{\downarrow} & \Spec(k) \overset{x}{\dashleftarrow}\overset{y}{\swarrow} \\  & V \longrightarrow & Y & \end{array}
$$
...
\begin{lemma}[Relative conditions local]
\label{decent-spaces-lemma-relative-conditions-local}
\source{stacks:03L3}
\href{https://stacks.math.columbia.edu/tag/03L3}{\texttt{Stacks tag 03L3}}
\group{decent-spaces}
...
Lemma \ref{decent-spaces-lemma-properties-local}
...
$$
\begin{array}{cc}Z \times_Y V \underset{q}{\longrightarrow}\underset{p}{\downarrow} & V \downarrow \\ Z \longrightarrow & Y\end{array}
$$
...
$$
\begin{array}{ccc}V \times_Y X \downarrow & (\coprod W_i) \times_Y X \longleftarrow\downarrow\longrightarrow & Z \times_Y X \downarrow \\ V & \coprod W_i \longleftarrow\longrightarrow & Z\end{array}
$$
...
Hence by Lemma \ref{decent-spaces-lemma-descent-conditions}
we conclude that $Z \times_Y X$ has property $\mathcal{P}$.
\end{proof}

\begin{remark}[Very reasonable]
\label{decent-spaces-remark-very-reasonable}
\source{stacks:03L4}
\href{https://stacks.math.columbia.edu/tag/03L4}{\texttt{Stacks tag 03L4}}
\group{decent-spaces}

An informal description of the properties $(\beta)$, decent, reasonable,
very reasonable was given in Section \ref{decent-spaces-section-reasonable-decent}.
...
\begin{lemma}[Re characterize universally closed]
\label{decent-spaces-lemma-re-characterize-universally-closed}
\source{stacks:03M6}
\href{https://stacks.math.columbia.edu/tag/03M6}{\texttt{Stacks tag 03M6}}
\group{decent-spaces}
...
\begin{array}{cc}W \underset{q}{\longrightarrow}\underset{p}{\downarrow} & Z \overset{g}{\downarrow} \\ X \overset{f}{\longrightarrow} & Y\end{array}
\end{equation}
...
\source{stacks:0AC3}
\href{https://stacks.math.columbia.edu/tag/0AC3}{\texttt{Stacks tag 0AC3}}
\group{decent-spaces}
...
\begin{example}[Not finite]
\label{decent-spaces-example-not-finite}
\source{stacks:0AC4}
\href{https://stacks.math.columbia.edu/tag/0AC4}{\texttt{Stacks tag 0AC4}}
\group{decent-spaces}
...
$$
\begin{array}{cc}\mathbf{A}^1_K \underset{q}{\longrightarrow}\underset{p}{\downarrow} & \Spec(K) \overset{g}{\downarrow} \\ \mathbf{A}^1_K/\mathbf{Z} \overset{f}{\longrightarrow} & \Spec(K)/\mathbf{Z}\end{array}
$$
Take $x$ corresponding to $t = 0$ and $z$ the unique point of $\Spec(K)$.
Then we see that $F_{x, z} = \mathbf{Z}$ as a set.
\end{example}

\begin{lemma}[Surjective on fibres]
\label{decent-spaces-lemma-surjective-on-fibres}
\source{stacks:0AC5}
\href{https://stacks.math.columbia.edu/tag/0AC5}{\texttt{Stacks tag 0AC5}}
\group{decent-spaces}
...
\begin{lemma}[Qf and qc finite fibre]
\label{decent-spaces-lemma-qf-and-qc-finite-fibre}
\source{stacks:0AC6}
\href{https://stacks.math.columbia.edu/tag/0AC6}{\texttt{Stacks tag 0AC6}}
\group{decent-spaces}
...
\begin{lemma}[Decent finite fibre]
\label{decent-spaces-lemma-decent-finite-fibre}
\source{stacks:0AC7}
\href{https://stacks.math.columbia.edu/tag/0AC7}{\texttt{Stacks tag 0AC7}}
\group{decent-spaces}
...
\begin{proof}
By Lemma \ref{decent-spaces-lemma-surjective-on-fibres} applied twice
...
Again by Lemma \ref{decent-spaces-lemma-surjective-on-fibres}
it suffices to show $F_{u, v}$ is finite for the diagram
$$
\begin{array}{cc}U \times_{\Spec(k)} V \longrightarrow\downarrow & V \downarrow \\ U \longrightarrow & \Spec(k)\end{array}
$$
...
At this point the finiteness follows from Example \ref{decent-spaces-example-schemes}.
...
\begin{lemma}[Fibers of field points of algebraic spaces have the expected Zariski topologies.]
\label{decent-spaces-lemma-topology-fibre}
\source{stacks:0AC8}
\href{https://stacks.math.columbia.edu/tag/0AC8}{\texttt{Stacks tag 0AC8}}
\group{decent-spaces}
...
(Lemma \ref{decent-spaces-lemma-UR-finite-above-x}). After shrinking
$V$ we may assume $v$ is the only one. Choose a scheme $U$ and
a surjective \'etale morphism $U \to X$.
Consider the commutative diagram
$$
\begin{array}{ccc}U \downarrow & U_V \longleftarrow\downarrow & U_v \longleftarrow\downarrow \\ X \downarrow & X_V \longleftarrow\downarrow & X_v \longleftarrow\downarrow \\ Y & V \longleftarrow & v \longleftarrow\end{array}
$$
...
\begin{lemma}[Conditions on point on space over field]
\label{decent-spaces-lemma-conditions-on-point-on-space-over-field}
\source{stacks:0AC9}
\href{https://stacks.math.columbia.edu/tag/0AC9}{\texttt{Stacks tag 0AC9}}
\group{decent-spaces}
...
by Lemma \ref{decent-spaces-lemma-dimension-decent-space} and the proof is complete.
\end{proof}

\begin{lemma}[Conditions on space over field]
\label{decent-spaces-lemma-conditions-on-space-over-field}
\source{stacks:0ACA}
\href{https://stacks.math.columbia.edu/tag/0ACA}{\texttt{Stacks tag 0ACA}}
\group{decent-spaces}
...
\begin{lemma}[Conditions on point in fibre and qf]
\label{decent-spaces-lemma-conditions-on-point-in-fibre-and-qf}
\source{stacks:0ACB}
\href{https://stacks.math.columbia.edu/tag/0ACB}{\texttt{Stacks tag 0ACB}}
\group{decent-spaces}
...
Then we have
$$
\begin{array}{ccccc}(\ref{item-dimension-top-k-fibre}) \underset{f\text{ decent}}{\Longrightarrow} & (\ref{item-isolated-in-k-fibre}) \Longleftrightarrow & (\ref{item-no-specializations-in-k-fibre}) \Longleftrightarrow & (\ref{item-k-fibre-at-x-dim-0}) \Longleftrightarrow & (\ref{item-quasi-finite-at-x})\end{array}
$$
...
\begin{proof}
By Lemma \ref{decent-spaces-lemma-conditions-on-point-on-space-over-field} conditions
(\ref{item-isolated-in-k-fibre}),
...
Lemma \ref{decent-spaces-lemma-conditions-on-point-on-space-over-field}
...
Lemma \ref{decent-spaces-lemma-topology-fibre}
...
\begin{lemma}[Conditions on fibre and qf]
\label{decent-spaces-lemma-conditions-on-fibre-and-qf}
\source{stacks:0ACK}
\href{https://stacks.math.columbia.edu/tag/0ACK}{\texttt{Stacks tag 0ACK}}
\group{decent-spaces}
...
Then we have
$$
\begin{array}{cccccc}(\ref{item-fibre-finite}) & (\ref{item-k-fibre-finite}) \Longleftarrow\underset{f\text{ decent}}{\Longrightarrow} & (\ref{item-k-fibre-discrete}) \Longleftrightarrow & (\ref{item-k-fibre-no-specializations}) \Longleftrightarrow & (\ref{item-k-fibre-dim-0}) \Longleftrightarrow & (\ref{item-quasi-finite-at-points-fibre})\end{array}
$$
...
\begin{proof}
By Lemma \ref{decent-spaces-lemma-conditions-on-space-over-field}
...
If $f$ is decent, then $X_k$ is a decent algebraic space and
Lemma \ref{decent-spaces-lemma-conditions-on-space-over-field}
...
\begin{lemma}[Monomorphism toward disjoint union dim 0 rings]
\label{decent-spaces-lemma-monomorphism-toward-disjoint-union-dim-0-rings}
\source{stacks:06RZ}
\href{https://stacks.math.columbia.edu/tag/06RZ}{\texttt{Stacks tag 06RZ}}
\group{decent-spaces}
...
\begin{lemma}[Decent generic points]
\label{decent-spaces-lemma-decent-generic-points}
\source{stacks:0ABV}
\href{https://stacks.math.columbia.edu/tag/0ABV}{\texttt{Stacks tag 0ABV}}
\group{decent-spaces}
...
Lemma \ref{decent-spaces-lemma-etale-named-properties}.
...
(Lemma \ref{decent-spaces-lemma-decent-specialization}). This contradicts the assumption
...
\source{stacks:0ED1}
\href{https://stacks.math.columbia.edu/tag/0ED1}{\texttt{Stacks tag 0ED1}}
\group{decent-spaces}

Let $S$ be a scheme. Let $X$ be a decent algebraic space over $S$.
Let $T \subset |X|$ be an irreducible closed subset. Let $\xi \in T$
be the generic point (Proposition \ref{decent-spaces-proposition-reasonable-sober}).
Then $\text{codim}(T, |X|)$
...
by Lemma \ref{decent-spaces-lemma-decent-specialization}.
...
\begin{lemma}[Get reasonable]
\label{decent-spaces-lemma-get-reasonable}
\source{stacks:0BB8}
\href{https://stacks.math.columbia.edu/tag/0BB8}{\texttt{Stacks tag 0BB8}}
\group{decent-spaces}
...
X = X_0 \supset X_1 \supset X_2 \supset \ldots
$$
associated to $U \to X$ in Lemma \ref{decent-spaces-lemma-stratify-flat-fp-lqf}.
...
\begin{lemma}[Finitely many irreducible components]
\label{decent-spaces-lemma-finitely-many-irreducible-components}
\source{stacks:0BB9}
\href{https://stacks.math.columbia.edu/tag/0BB9}{\texttt{Stacks tag 0BB9}}
\group{decent-spaces}
...
(Lemma \ref{decent-spaces-lemma-UR-finite-above-x}). Hence $U'$ has finitely
...
statement by Lemma \ref{decent-spaces-lemma-get-reasonable}.
(We also use that a reasonable algebraic space is decent, see
discussion following Definition \ref{decent-spaces-definition-very-reasonable}.)
\end{proof}
...
\source{stacks:0ACZ}
\href{https://stacks.math.columbia.edu/tag/0ACZ}{\texttt{Stacks tag 0ACZ}}
\group{decent-spaces}
...
Lemma \ref{decent-spaces-lemma-conditions-on-fibre-and-qf}
...
Hence Lemma \ref{decent-spaces-lemma-conditions-on-fibre-and-qf}
applies to show that (4) implies (1) and (2). On the other hand,
we see that (2) implies (4) by Morphisms of Spaces, Lemma
\ref{spaces-morphisms-lemma-quasi-finite-at-a-finite-number-of-points}.
\end{proof}

\begin{lemma}[Generically finite reprise]
\label{decent-spaces-lemma-generically-finite-reprise}
\source{stacks:0AD0}
\href{https://stacks.math.columbia.edu/tag/0AD0}{\texttt{Stacks tag 0AD0}}
\group{decent-spaces}
...
Applying Lemma \ref{decent-spaces-lemma-generically-finite}
to $f|_{X'} : X' \to Y$ we see that (3) holds.
We omit the proof that (3) implies (2).
\end{proof}

\begin{lemma}[Quasi finiteness over generic point]
\label{decent-spaces-lemma-quasi-finiteness-over-generic-point}
\source{stacks:0BBB}
\href{https://stacks.math.columbia.edu/tag/0BBB}{\texttt{Stacks tag 0BBB}}
\group{decent-spaces}
...
\begin{lemma}[Finite over dense open]
\label{decent-spaces-lemma-finite-over-dense-open}
\source{stacks:0BBC}
\href{https://stacks.math.columbia.edu/tag/0BBC}{\texttt{Stacks tag 0BBC}}
\group{decent-spaces}
...
\begin{proof}
By Lemmas \ref{decent-spaces-lemma-finitely-many-irreducible-components} and
\ref{decent-spaces-lemma-decent-generic-points} we may assume $Y$ is a scheme
...
Lemma \ref{decent-spaces-lemma-generically-finite}
...
and $U \subset X$ as in Lemma \ref{decent-spaces-lemma-generically-finite-reprise}.
...
\source{stacks:0ACV}
\href{https://stacks.math.columbia.edu/tag/0ACV}{\texttt{Stacks tag 0ACV}}
\group{decent-spaces}
...
$|X|$ and $|Y|$ are sober (Proposition \ref{decent-spaces-proposition-reasonable-sober}).
...
are given in Lemma \ref{decent-spaces-lemma-finitely-many-irreducible-components}.
In most cases birational morphisms are isomorphisms over dense opens.

\begin{lemma}[Birational dominant]
\label{decent-spaces-lemma-birational-dominant}
\source{stacks:0ACW}
\href{https://stacks.math.columbia.edu/tag/0ACW}{\texttt{Stacks tag 0ACW}}
\group{decent-spaces}
...
\begin{lemma}[Birational generic fibres]
\label{decent-spaces-lemma-birational-generic-fibres}
\source{stacks:0BBD}
\href{https://stacks.math.columbia.edu/tag/0BBD}{\texttt{Stacks tag 0BBD}}
\group{decent-spaces}
...
Lemma \ref{decent-spaces-lemma-finitely-many-irreducible-components}. By
Lemma \ref{decent-spaces-lemma-quasi-finiteness-over-generic-point}
...
\begin{lemma}[Birational birational]
\label{decent-spaces-lemma-birational-birational}
\source{stacks:0BBE}
\href{https://stacks.math.columbia.edu/tag/0BBE}{\texttt{Stacks tag 0BBE}}
\group{decent-spaces}
...
\begin{proof}
By Lemma \ref{decent-spaces-lemma-finitely-many-irreducible-components} we may assume
that $X$ and $Y$ are schemes. In this case the result is
Morphisms, Lemma \ref{morphisms-lemma-birational-birational}.
\end{proof}

\begin{lemma}[Birational isomorphism over dense open]
\label{decent-spaces-lemma-birational-isomorphism-over-dense-open}
\source{stacks:0BBF}
\href{https://stacks.math.columbia.edu/tag/0BBF}{\texttt{Stacks tag 0BBF}}
\group{decent-spaces}
...
\begin{proof}
By Lemma \ref{decent-spaces-lemma-finitely-many-irreducible-components} we may assume
$Y$ is a scheme. By Lemma \ref{decent-spaces-lemma-finite-over-dense-open} we may assume
...
\begin{lemma}[Birational etale localization]
\label{decent-spaces-lemma-birational-etale-localization}
\source{stacks:0B4D}
\href{https://stacks.math.columbia.edu/tag/0B4D}{\texttt{Stacks tag 0B4D}}
\group{decent-spaces}
...
(Lemma \ref{decent-spaces-lemma-decent-generic-points}).
...
By the discussion following Definition \ref{decent-spaces-definition-birational}
we have a cartesian square
$$
\begin{array}{cc}\Spec(\mathcal{O}_{X, \xi}) \downarrow\longrightarrow & X \downarrow \\ \Spec(\mathcal{O}_{Y, f(\xi)}) \longrightarrow & Y\end{array}
$$
...
in the diagram
$$
\begin{array}{cc}\Spec(\mathcal{O}_{X, \xi}) \times_X U \downarrow\longrightarrow & U \downarrow \\ \Spec(\mathcal{O}_{Y, f(\xi)}) \times_Y V \longrightarrow & V\end{array}
$$
the vertical arrow on the left is an isomorphism. The horizontal arrows
...
\begin{lemma}[Birational induced morphism normalizations]
\label{decent-spaces-lemma-birational-induced-morphism-normalizations}
\source{stacks:0BBG}
\href{https://stacks.math.columbia.edu/tag/0BBG}{\texttt{Stacks tag 0BBG}}
\group{decent-spaces}
...
$$
\begin{array}{cc}X^\nu \longrightarrow\downarrow & Y^\nu \downarrow \\ X \longrightarrow & Y\end{array}
$$
of algebraic spaces over $S$. The morphism $X^\nu \to Y^\nu$ is birational.
\end{lemma}

\begin{proof}
By Lemma \ref{decent-spaces-lemma-finitely-many-irreducible-components} we see that
...
spaces by Lemma \ref{decent-spaces-lemma-decent-generic-points})
we obtain from
Morphisms of Spaces, Lemma \ref{spaces-morphisms-lemma-normalization-normal}
...
\begin{lemma}[Finite birational over normal]
\label{decent-spaces-lemma-finite-birational-over-normal}
\source{stacks:0B4E}
\href{https://stacks.math.columbia.edu/tag/0B4E}{\texttt{Stacks tag 0B4E}}
\group{decent-spaces}
...
Lemma \ref{decent-spaces-lemma-birational-etale-localization} and its proof
...
\source{stacks:0BBH}
\href{https://stacks.math.columbia.edu/tag/0BBH}{\texttt{Stacks tag 0BBH}}
\group{decent-spaces}
...
\begin{proof}
Consider the map $X^\nu \to Y^\nu$ of
Lemma \ref{decent-spaces-lemma-birational-induced-morphism-normalizations}.
...
Lemma \ref{decent-spaces-lemma-finite-birational-over-normal}.
\end{proof}
...
(see Lemma \ref{decent-spaces-lemma-decent-Jacobson}).

\begin{lemma}[Jacobson universally Jacobson]
\label{decent-spaces-lemma-Jacobson-universally-Jacobson}
\source{stacks:0BA3}
\href{https://stacks.math.columbia.edu/tag/0BA3}{\texttt{Stacks tag 0BA3}}
\group{decent-spaces}
...
\begin{lemma}[Jacobson ft points lift to closed]
\label{decent-spaces-lemma-Jacobson-ft-points-lift-to-closed}
\source{stacks:0BA4}
\href{https://stacks.math.columbia.edu/tag/0BA4}{\texttt{Stacks tag 0BA4}}
\group{decent-spaces}
...
by Lemma \ref{decent-spaces-lemma-Jacobson-universally-Jacobson}.
...
\begin{lemma}[Decent Jacobson ft pts]
\label{decent-spaces-lemma-decent-Jacobson-ft-pts}
\source{stacks:0BA5}
\href{https://stacks.math.columbia.edu/tag/0BA5}{\texttt{Stacks tag 0BA5}}
\group{decent-spaces}
...
immersion $\Spec(k) \to X$, see Lemma \ref{decent-spaces-lemma-decent-space-closed-point}.
...
(Definition \ref{decent-spaces-definition-very-reasonable}). On the other hand,
...
of spectra of fields (Remark \ref{decent-spaces-remark-recall}).
...
\begin{lemma}[Decent Jacobson]
\label{decent-spaces-lemma-decent-Jacobson}
\source{stacks:0BA6}
\href{https://stacks.math.columbia.edu/tag/0BA6}{\texttt{Stacks tag 0BA6}}
\group{decent-spaces}
...
By Lemma \ref{decent-spaces-lemma-decent-Jacobson-ft-pts} we see that
...
\begin{lemma}[Punctured spec]
\label{decent-spaces-lemma-punctured-spec}
\source{stacks:0ED2}
\href{https://stacks.math.columbia.edu/tag/0ED2}{\texttt{Stacks tag 0ED2}}
\group{decent-spaces}
...
\medskip\noindent
Combining Lemma \ref{decent-spaces-lemma-locally-Noetherian-decent-quasi-separated} with
Properties of Spaces, Lemma
...
point $\eta \in Z$ by Proposition \ref{decent-spaces-proposition-reasonable-sober}.
...
Lemma \ref{decent-spaces-lemma-decent-specialization}
...
By Lemma \ref{decent-spaces-lemma-decent-no-specializations-map-to-same-point}
...
\source{stacks:0DQ6}
\href{https://stacks.math.columbia.edu/tag/0DQ6}{\texttt{Stacks tag 0DQ6}}
\group{decent-spaces}
...
discussion following Definition \ref{decent-spaces-definition-henselian-local-ring}.
...
\source{stacks:0DQ7}
\href{https://stacks.math.columbia.edu/tag/0DQ7}{\texttt{Stacks tag 0DQ7}}
\group{decent-spaces}

Let $S$ be a scheme. Let $X$ be a decent algebraic space over $S$.
Let $x \in |X|$. We say that $X$ is {\it unibranch at $x$}
if the equivalent conditions of
Lemma \ref{decent-spaces-lemma-irreducible-local-ring} hold.
...
\source{stacks:0DQ8}
\href{https://stacks.math.columbia.edu/tag/0DQ8}{\texttt{Stacks tag 0DQ8}}
\group{decent-spaces}
...
\source{stacks:0DQ9}
\href{https://stacks.math.columbia.edu/tag/0DQ9}{\texttt{Stacks tag 0DQ9}}
\group{decent-spaces}

Let $S$ be a scheme. Let $X$ be a decent algebraic space over $S$.
Let $x \in |X|$. The {\it number of branches of $X$ at $x$} is
either $n \in \mathbf{N}$ if the equivalent conditions
of Lemma \ref{decent-spaces-lemma-nr-branches-local-ring}
hold, or else $\infty$.
\end{definition}
...
\source{stacks:0ED4}
\href{https://stacks.math.columbia.edu/tag/0ED4}{\texttt{Stacks tag 0ED4}}
\group{decent-spaces}
...
\begin{lemma}[Scheme with dimension function]
\label{decent-spaces-lemma-scheme-with-dimension-function}
\source{stacks:0ED5}
\href{https://stacks.math.columbia.edu/tag/0ED5}{\texttt{Stacks tag 0ED5}}
\group{decent-spaces}
...
\begin{lemma}[Universally catenary scheme]
\label{decent-spaces-lemma-universally-catenary-scheme}
\source{stacks:0ED6}
\href{https://stacks.math.columbia.edu/tag/0ED6}{\texttt{Stacks tag 0ED6}}
\group{decent-spaces}
...
Lemma \ref{decent-spaces-lemma-scheme-with-dimension-function}.
Since $|X|$ is sober (Proposition \ref{decent-spaces-proposition-reasonable-sober})
we conclude that $|X|$ is catenary by
Topology, Lemma \ref{topology-lemma-dimension-function-catenary}.
\end{proof}

By Lemma \ref{decent-spaces-lemma-universally-catenary-scheme}
the following definition is compatible with the
already existing notion for representable algebraic spaces.

\begin{definition}[Universally catenary]
\label{decent-spaces-definition-universally-catenary}
\source{stacks:0ED7}
\href{https://stacks.math.columbia.edu/tag/0ED7}{\texttt{Stacks tag 0ED7}}
\group{decent-spaces}
...
Lemma \ref{decent-spaces-lemma-locally-Noetherian-decent-quasi-separated}.
...
\source{stacks:0ED8}
\href{https://stacks.math.columbia.edu/tag/0ED8}{\texttt{Stacks tag 0ED8}}
\group{decent-spaces}
...
\begin{lemma}[Check dimension function finite cover]
\label{decent-spaces-lemma-check-dimension-function-finite-cover}
\source{stacks:0ED9}
\href{https://stacks.math.columbia.edu/tag/0ED9}{\texttt{Stacks tag 0ED9}}
\group{decent-spaces}
