% Source-derived chapter 06: Preparation for counting points
% Original source: uniformity-mordell-lang-curves
\chapter{Preparation for counting points}
\label{uniformity-mordell-lang-curves-chapter-06}
\source{uniformity-mordell-lang-curves}

\begin{remark}[Source section]
\label{uniformity-mordell-lang-curves-chapter-06-source}
\source{uniformity-mordell-lang-curves}
\source{uniformity-mordell-lang-curves}
...
% The source section title was: Preparation for counting points
\label{SectionSettingUp}
\source{uniformity-mordell-lang-curves}
...
\begin{theorem}[\!\!{\cite[Theorem~1.2']{GaoBettiRank}}]
\source{uniformity-mordell-lang-curves}
\notready\label{ThmNonDegForBd}
\source{uniformity-mordell-lang-curves}
...
\begin{lemma}
\source{uniformity-mordell-lang-curves}
\notready\label{LemmaPacketsAlternative3}
\source{uniformity-mordell-lang-curves}
