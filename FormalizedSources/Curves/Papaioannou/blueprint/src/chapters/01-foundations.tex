...
\source{papaioannou-algebraic-rr:page-0002}
...
$\widetilde{\mathbb K}\subseteq\mathcal O$ and $\widetilde{\mathbb K}\cap\mathcal O=\{0\}$.
\end{enumerate}
\end{theorem}
\begin{proof}
...
$z=-(a_mz^{-m+1}+\cdots+a_1)\in\mathcal O$, a contradiction. The displayed
intersection assertion is retained as printed in the source.
\end{proof}
...
\source{papaioannou-algebraic-rr:page-0002}
If $\mathcal O$ is a valuation ring (the source prints "of $K/F$") with maximal
...
For $z\in\mathbb F_P$ as printed (equivalently, a nonzero function-field
element) and $P\in\mathbf P_{\mathbb F}$, $P$ is a zero of order
