...
\begin{equation} \label{theirformula}\dcref{1.1}
\source{refined-brill-noether-theory-hurwitz-spaces}
...
\begin{equation} \label{rr}\dcref{1.2}
\source{refined-brill-noether-theory-hurwitz-spaces}
...
In particular,
\begin{equation} \label{W}\dcref{1.3}
\source{refined-brill-noether-theory-hurwitz-spaces}
...
\begin{Example} \label{Geoff}\dcref{1.1}
\source{refined-brill-noether-theory-hurwitz-spaces}
...
The partial order has maximal element $(-1,-1,-1)$, with
$(-2,-1,0)$ below it, then $(-2,-2,1)$ and $(-3,0,0)$, and their common
specialization $(-3,-1,1)$. The corresponding loci in $\Pic^4(C)$ are
nested accordingly; $\Sigmabar_{(-3,-1,1)}$ is the intersection of the two
one-dimensional components described below.
We have
