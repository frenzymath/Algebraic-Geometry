...
\begin{lemma}[Recurring]
\label{models-lemma-recurring}
\source{stacks:0C5U}
\href{https://stacks.math.columbia.edu/tag/0C5U}{\texttt{Stacks tag 0C5U}}
\group{models}
...
\begin{lemma}[Recurring real]
\label{models-lemma-recurring-real}
\source{stacks:0C5V}
\href{https://stacks.math.columbia.edu/tag/0C5V}{\texttt{Stacks tag 0C5V}}
\group{models}
...
\begin{lemma}[Recurring symmetric real]
\label{models-lemma-recurring-symmetric-real}
\source{stacks:0C5X}
\href{https://stacks.math.columbia.edu/tag/0C5X}{\texttt{Stacks tag 0C5X}}
\group{models}
...
\begin{proof}
\uses{models-lemma-recurring, models-lemma-recurring-real}
[Second proof]
...
Hence $A'$ is invertible by Lemma \ref{models-lemma-recurring}.
...
The description of the kernel in Lemma \ref{models-lemma-recurring-real}
gives the final statement of the lemma.
\end{proof}

\begin{lemma}[Orthogonal direct sum]
\label{models-lemma-orthogonal-direct-sum}
\source{stacks:0C6V}
\href{https://stacks.math.columbia.edu/tag/0C6V}{\texttt{Stacks tag 0C6V}}
\group{models}
...
\source{stacks:0C6W}
\href{https://stacks.math.columbia.edu/tag/0C6W}{\texttt{Stacks tag 0C6W}}
\group{models}

\uses{models-lemma-orthogonal-direct-sum}
...
\Im(\text{d})^\#/\Im(\text{d})
$$
with notation as in Lemma \ref{models-lemma-orthogonal-direct-sum}.
\end{lemma}
...
\begin{lemma}[Recurring symmetric integer]
\label{models-lemma-recurring-symmetric-integer}
\source{stacks:0C6X}
\href{https://stacks.math.columbia.edu/tag/0C6X}{\texttt{Stacks tag 0C6X}}
\group{models}
...
\begin{proof}
\uses{models-lemma-recurring-symmetric-real, models-lemma-orthogonal-direct-sum, models-lemma-coker}

By Lemma \ref{models-lemma-recurring-symmetric-real} the rank of $A$ is $n - 1$.
The composition
$$
...
\medskip\noindent
Hence we may apply Lemma \ref{models-lemma-orthogonal-direct-sum}
...
$$
This is proved in Lemma \ref{models-lemma-coker}.
\end{proof}
...
\source{stacks:0C6Z}
\href{https://stacks.math.columbia.edu/tag/0C6Z}{\texttt{Stacks tag 0C6Z}}
\group{models}
...
\begin{definition}[Type equivalent]
\label{models-definition-type-equivalent}
\source{stacks:0C70}
\href{https://stacks.math.columbia.edu/tag/0C70}{\texttt{Stacks tag 0C70}}
\group{models}
...
\source{stacks:0C71}
\href{https://stacks.math.columbia.edu/tag/0C71}{\texttt{Stacks tag 0C71}}
\group{models}
...
\source{stacks:0C72}
\href{https://stacks.math.columbia.edu/tag/0C72}{\texttt{Stacks tag 0C72}}
\group{models}

\uses{models-lemma-genus}
We say $n, m_i, a_{ij}, w_i, g_i$ is a {\it numerical type of genus $g$}
if $g = 1 + \sum m_i(w_i(g_i - 1) - \frac{1}{2} a_{ii})$ is the integer
from Lemma \ref{models-lemma-genus}.
\end{definition}

We will prove below (Lemma \ref{models-lemma-genus-nonnegative}) that the genus
...
\source{stacks:0C73}
\href{https://stacks.math.columbia.edu/tag/0C73}{\texttt{Stacks tag 0C73}}
\group{models}

\uses{models-lemma-genus-zero, models-lemma-genus-one}
...
\begin{lemma}[Diagonal negative]
\label{models-lemma-diagonal-negative}
\source{stacks:0C74}
\href{https://stacks.math.columbia.edu/tag/0C74}{\texttt{Stacks tag 0C74}}
\group{models}
...
\begin{proof}
\uses{models-lemma-recurring-symmetric-real}

Lemma \ref{models-lemma-recurring-symmetric-real} applies to the matrix $A$.
\end{proof}

\begin{lemma}[Minus one]
\label{models-lemma-minus-one}
\source{stacks:0C75}
\href{https://stacks.math.columbia.edu/tag/0C75}{\texttt{Stacks tag 0C75}}
\group{models}
...
\begin{proof}
\uses{models-lemma-diagonal-negative}

Follows immediately from Lemma \ref{models-lemma-diagonal-negative} and
$w_i > 0$, $g_i \geq 0$, and $w_i | a_{ii}$.
\end{proof}

\begin{definition}[Type minus one]
\label{models-definition-type-minus-one}
\source{stacks:0C76}
\href{https://stacks.math.columbia.edu/tag/0C76}{\texttt{Stacks tag 0C76}}
\group{models}
...
\begin{lemma}[Contract]
\label{models-lemma-contract}
\source{stacks:0C77}
\href{https://stacks.math.columbia.edu/tag/0C77}{\texttt{Stacks tag 0C77}}
\group{models}
...
\begin{proof}
\uses{models-lemma-irreducible, models-definition-type, models-lemma-diagonal-negative}

Observe that $n > 1$ for example by Lemma \ref{models-lemma-irreducible}
and hence $n' \geq 1$. We check conditions (1) -- (5) of
Definition \ref{models-definition-type} for $n', m'_i, a'_{ij}, w'_i, g'_i$.
...
and since $a_{nn} < 0$ by Lemma \ref{models-lemma-diagonal-negative}
...
\begin{lemma}[Top genus]
\label{models-lemma-top-genus}
\source{stacks:0C78}
\href{https://stacks.math.columbia.edu/tag/0C78}{\texttt{Stacks tag 0C78}}
\group{models}
...
\begin{proof}
\uses{models-definition-type}

If not, then $e < n - 1$ which means there exists an $i$ such that
$a_{ij} = 0$ for all $j \not = i$. This contradicts assumption
(3) of Definition \ref{models-definition-type}.
\end{proof}

\begin{definition}[Top genus]
\label{models-definition-top-genus}
\source{stacks:0C79}
\href{https://stacks.math.columbia.edu/tag/0C79}{\texttt{Stacks tag 0C79}}
\group{models}

\uses{models-lemma-top-genus}
Let $n, m_i, a_{ij}, w_i, g_i$ be a numerical type $T$. The
{\it topological genus of $T$} is the nonnegative integer
$g_{top} = 1 - n + e$ from Lemma \ref{models-lemma-top-genus}.
\end{definition}
...
with $n = 1$ as in Lemma \ref{models-lemma-irreducible}. But it will
be true for minimal numerical types which are defined as follows.

\begin{definition}[Type minimal]
\label{models-definition-type-minimal}
\source{stacks:0C7A}
\href{https://stacks.math.columbia.edu/tag/0C7A}{\texttt{Stacks tag 0C7A}}
\group{models}
...
\begin{lemma}[Non irreducible minimal type genus at least one]
\label{models-lemma-non-irreducible-minimal-type-genus-at-least-one}
\source{stacks:0C7B}
\href{https://stacks.math.columbia.edu/tag/0C7B}{\texttt{Stacks tag 0C7B}}
\group{models}
...
\begin{proof}
\uses{models-lemma-minus-one}

This is true because $g = 1 + \sum \Phi_i$ with
$\Phi_i = m_i(w_i(g_i - 1) - \frac{1}{2} a_{ii})$ nonnegative
by Lemma \ref{models-lemma-minus-one} and the definition of minimal types.
\end{proof}

\begin{lemma}[Genus nonnegative]
\label{models-lemma-genus-nonnegative}
\source{stacks:0C7C}
\href{https://stacks.math.columbia.edu/tag/0C7C}{\texttt{Stacks tag 0C7C}}
\group{models}
...
\begin{proof}
\uses{models-lemma-non-irreducible-minimal-type-genus-at-least-one}
...
Lemma \ref{models-lemma-non-irreducible-minimal-type-genus-at-least-one}.
...
\begin{lemma}[Minus two]
\label{models-lemma-minus-two}
\source{stacks:0C7D}
\href{https://stacks.math.columbia.edu/tag/0C7D}{\texttt{Stacks tag 0C7D}}
\group{models}
...
\begin{definition}[Type minus two]
\label{models-definition-type-minus-two}
\source{stacks:0C7E}
\href{https://stacks.math.columbia.edu/tag/0C7E}{\texttt{Stacks tag 0C7E}}
\group{models}
...
\begin{remark}[Genus equality]
\label{models-remark-genus-equality}
\source{stacks:0C7F}
\href{https://stacks.math.columbia.edu/tag/0C7F}{\texttt{Stacks tag 0C7F}}
\group{models}

\uses{models-lemma-genus-nonnegative}
Let $n, m_i, a_{ij}, w_i, g_i$ be a minimal numerical type with $n > 1$.
Equality $g = g_{top}$ can hold in Lemma \ref{models-lemma-genus-nonnegative}.
...
\source{stacks:0C7H}
\href{https://stacks.math.columbia.edu/tag/0C7H}{\texttt{Stacks tag 0C7H}}
\group{models}
...
\begin{lemma}[Picard rank 1]
\label{models-lemma-picard-rank-1}
\source{stacks:0C7I}
\href{https://stacks.math.columbia.edu/tag/0C7I}{\texttt{Stacks tag 0C7I}}
\group{models}
...
\begin{proof}
\uses{models-lemma-recurring-real, models-lemma-recurring-symmetric-real}

If $n = 1$, then $A = (a_{ij})$ is the zero matrix and
the result is clear. For $n > 1$ the matrix $A$ has rank
$n - 1$ by either Lemma \ref{models-lemma-recurring-real} or
Lemma \ref{models-lemma-recurring-symmetric-real}.
Of course the rank is not affected by scaling the rows
by $1/w_i$. This proves the lemma.
\end{proof}

\begin{lemma}[Picard T and A]
\label{models-lemma-picard-T-and-A}
\source{stacks:0CE7}
\href{https://stacks.math.columbia.edu/tag/0CE7}{\texttt{Stacks tag 0CE7}}
\group{models}
...
$$
\begin{array}{ccccccc}0 \longrightarrow & \mathbf{Z}^{\oplus n} \underset{A}{\longrightarrow} &  & \mathbf{Z}^{\oplus n} \longrightarrow &  & \Coker(A) \longrightarrow & 0 \\ 0 \longrightarrow & \mathbf{Z}^{\oplus n} \overset{(a_{ij}/w_i)}{\longrightarrow}\underset{\text{id}}{\uparrow} &  & \mathbf{Z}^{\oplus n} \longrightarrow\underset{\text{diag}(w_1, \ldots, w_n)}{\uparrow} &  & \Pic(T) \longrightarrow\uparrow & 0\end{array}
$$
with exact rows. By the snake lemma we conclude that
$\Pic(T) \subset \Coker(A)$.
\end{proof}

\begin{lemma}[Contract picard group]
\label{models-lemma-contract-picard-group}
\source{stacks:0C7J}
\href{https://stacks.math.columbia.edu/tag/0C7J}{\texttt{Stacks tag 0C7J}}
\group{models}

\uses{models-lemma-contract}
Let $n, m_i, a_{ij}, w_i, g_i$ be a numerical type $T$.
Assume $n$ is a $(-1)$-index. Let $T'$ be the numerical
type constructed in Lemma \ref{models-lemma-contract}. There exists an
injective map
$$
\Pic(T) \to \Pic(T')
$$
...
$$
\begin{array}{ccc}\mathbf{Z}^{\oplus n} \underset{(a_{ij}/w_i)}{\longrightarrow}\underset{q}{\downarrow} &  & \mathbf{Z}^{\oplus n} \overset{p}{\downarrow} \\ \mathbf{Z}^{\oplus n'} \overset{(a'_{ij}/w'_i)}{\longrightarrow} &  & \mathbf{Z}^{\oplus n'}\end{array}
$$
...
\begin{lemma}[Picard group genus nonpositive]
\label{models-lemma-picard-group-genus-nonpositive}
\source{stacks:0C7K}
\href{https://stacks.math.columbia.edu/tag/0C7K}{\texttt{Stacks tag 0C7K}}
\group{models}
...
\begin{proof}
\uses{models-lemma-non-irreducible-minimal-type-genus-at-least-one, models-lemma-contract-picard-group, models-lemma-contract}
...
By Lemma \ref{models-lemma-contract-picard-group}
we find $\Pic(T) \subset \Pic(T')$.
By Lemma \ref{models-lemma-contract} we see that the genus
...
of $(-2)$-indices (Definition \ref{models-definition-type-minus-two}) and
at the same time we classify all possible minimal numerical
types of genus $1$. In other words, in this section we prove
Proposition \ref{models-proposition-classify-subgraphs} and
Lemma \ref{models-lemma-genus-one}
...
and $w_i$ are $w_i | a_{ii}$ from Definition \ref{models-definition-type}
and $a_{ii} < 0$ from Lemma \ref{models-lemma-diagonal-negative}
...
Lemma \ref{models-lemma-recurring-symmetric-real} that the
...
(by Lemma \ref{models-lemma-recurring-symmetric-real} again) and $g = 0$.
In these cases we actually find all possible $m_i, a_{ij}, w_i$, $i, j \in I$
and list them in Lemma \ref{models-lemma-genus-one}. After completing the
...
possibilities given in Lemma \ref{models-lemma-genus-one} to see that all
...
Lemma \ref{models-lemma-recurring-symmetric-real} we see that the matrix
$$
\left(
\begin{matrix}
-2w_i & a_{ij} \\
...
(\ref{item-two-cycle}) and (\ref{item-up4}) of Lemma \ref{models-lemma-genus-one}.
Assuming $n > 2$ we see
...
(\ref{item-G2}) of Lemma \ref{models-lemma-two-by-two}. In this lemma
...
\begin{lemma}[Two by two]
\label{models-lemma-two-by-two}
\source{stacks:0C7M}
\href{https://stacks.math.columbia.edu/tag/0C7M}{\texttt{Stacks tag 0C7M}}
\group{models}

Classification of proper subgraphs of the form
$$
\begin{array}{cc}\bullet \longrightarrow & \bullet\end{array}
$$
...
$(i, j)$, $(i, k)$, and $(j, k)$ is as listed in Lemma \ref{models-lemma-two-by-two}.
Since the matrix $A = (a_{ij})$ is semi-negative
definite by Lemma \ref{models-lemma-recurring-symmetric-real} we see that the matrix
$$
\left(
\begin{matrix}
-2w_i & a_{ij} & a_{ik} \\
...
of Lemma \ref{models-lemma-three-by-three} where we also wrote out the consequences
for the integers $m_i$, $m_j$, and $m_k$.

\begin{lemma}[Three by three]
\label{models-lemma-three-by-three}
\source{stacks:0C7R}
\href{https://stacks.math.columbia.edu/tag/0C7R}{\texttt{Stacks tag 0C7R}}
\group{models}

Classification of proper subgraphs of the form
$$
\begin{array}{ccc}\bullet \longrightarrow & \bullet \longrightarrow & \bullet\end{array}
$$
...
Then we see from Lemma \ref{models-lemma-three-by-three} that $a_{ik} = a_{jl} = 0$.
...
of Lemma \ref{models-lemma-genus-one}. Assuming $n > 4$
we obtain the inequality
$$
16 +
\frac{a_{ij}^2}{w_iw_j}\frac{a_{kl}^2}{w_kw_l} +
...
(\ref{item-F4}) of Lemma \ref{models-lemma-four-by-four}
where we also wrote out the consequences for the integers $m_i$, $m_j$, $m_k$,
and $m_l$.

\begin{lemma}[Four by four]
\label{models-lemma-four-by-four}
\source{stacks:0C7V}
\href{https://stacks.math.columbia.edu/tag/0C7V}{\texttt{Stacks tag 0C7V}}
\group{models}

Classification of proper subgraphs of the form
$$
\begin{array}{cccc}\bullet \longrightarrow & \bullet \longrightarrow & \bullet \longrightarrow & \bullet\end{array}
$$
...
$j$, $k$, $l$. Then we see from Lemma \ref{models-lemma-three-by-three} that
...
Lemma \ref{models-lemma-genus-one}. Assuming $n > 4$
we obtain the inequality
$$
4 > \frac{a_{ij}^2}{w_iw_j} + \frac{a_{ik}^2}{w_iw_k} + \frac{a_{il}^2}{w_jw_l}
$$
...
(\ref{item-D4}) of Lemma \ref{models-lemma-D4}
where we also wrote out the consequences for the integers $m_i$, $m_j$, $m_k$,
and $m_l$.
...
\source{stacks:0C80}
\href{https://stacks.math.columbia.edu/tag/0C80}{\texttt{Stacks tag 0C80}}
\group{models}

Classification of proper subgraphs of the form
$$
\begin{array}{ccc}\bullet \longrightarrow & \bullet \longrightarrow\downarrow & \bullet \\  & \bullet & \end{array}
$$
If $n > 4$, then given four $(-2)$-indices $i, j, k, l$
...
Then we can apply Lemmas \ref{models-lemma-three-by-three} and
\ref{models-lemma-four-by-four} to see that
...
(\ref{item-down-equal-equal-up}) of Lemma \ref{models-lemma-genus-one}
...
Lemma \ref{models-lemma-five-by-five} where we also wrote out the
consequences for the integers $m_h$, $m_i$, $m_j$, $m_k$, and $m_l$.

\begin{lemma}[Five by five]
\label{models-lemma-five-by-five}
\source{stacks:0C82}
\href{https://stacks.math.columbia.edu/tag/0C82}{\texttt{Stacks tag 0C82}}
\group{models}

Classification of proper subgraphs of the form
$$
\begin{array}{ccccc}\bullet \longrightarrow & \bullet \longrightarrow & \bullet \longrightarrow & \bullet \longrightarrow & \bullet\end{array}
$$
...
$i$, $j$, $k$, $l$. Then we see from Lemma \ref{models-lemma-three-by-three}
that $a_{ij} = a_{ik} = a_{il} = a_{jk} = a_{jl} = a_{kl} = 0$ and
by Lemma \ref{models-lemma-D4} that
...
(\ref{item-quadruple}) Lemma \ref{models-lemma-genus-one}.

\begin{lemma}[Fourfold]
\label{models-lemma-fourfold}
\source{stacks:0C86}
\href{https://stacks.math.columbia.edu/tag/0C86}{\texttt{Stacks tag 0C86}}
\group{models}

Nonexistence of proper subgraphs of the form
$$
\begin{array}{ccc}\bullet \longrightarrow & \bullet \swarrow\longrightarrow\downarrow & \bullet \\ \bullet & \bullet & \end{array}
$$
...
Lemma \ref{models-lemma-D4} that $a_{ik} = a_{il} = a_{kl} = 0$,
$w_i = w_j = w_k = w_l = w$, and $a_{ij} = a_{jk} = a_{jl} = w$
for some integer $w$. Applying Lemma \ref{models-lemma-four-by-four} to
the four tuples
...
(\ref{item-triple-extended-down}) of Lemma \ref{models-lemma-genus-one}.
For $w_h = w$ we obtain case (\ref{item-D5}) of
Lemma \ref{models-lemma-D5}.

\begin{lemma}[D5]
\label{models-lemma-D5}
\source{stacks:0C87}
\href{https://stacks.math.columbia.edu/tag/0C87}{\texttt{Stacks tag 0C87}}
\group{models}

Classification of proper subgraphs of the form
$$
\begin{array}{cccc}\bullet \longrightarrow & \bullet \longrightarrow & \bullet \longrightarrow\downarrow & \bullet \\  &  & \bullet & \end{array}
$$
If $n > 5$, then given five $(-2)$-indices $h, i, j, k, l$
...
of Lemma \ref{models-lemma-genus-one} and if $n > t$ to cases
(\ref{item-An}), (\ref{item-Cn}), and (\ref{item-Bn}) of
Lemma \ref{models-lemma-long}.
First, if $a_{i_1i_t}$ is nonzero, then it is clear from
the result of Lemma \ref{models-lemma-five-by-five} that
...
in case (\ref{item-n-cycle}) of Lemma \ref{models-lemma-genus-one}.
Thus we may assume $a_{i_1i_t} = 0$.
By induction hypothesis (or Lemma \ref{models-lemma-five-by-five} if $t = 6$)
...
then we are in case (\ref{item-Bn}) of Lemma \ref{models-lemma-long},
...
(\ref{item-An}) of Lemma \ref{models-lemma-long},
\item if $(w_{i_1}, w_{i_t}) = (w, 2w)$ or $(2w, w)$ then we are
in case (\ref{item-Cn}) of Lemma \ref{models-lemma-long}, and
\item if $(w_{i_1}, w_{i_t}) = (2w, 2w)$ then we are in case
(\ref{item-down-chain-equal-up}) of Lemma \ref{models-lemma-genus-one}.
\end{enumerate}

\begin{lemma}[Long]
\label{models-lemma-long}
\source{stacks:0C89}
\href{https://stacks.math.columbia.edu/tag/0C89}{\texttt{Stacks tag 0C89}}
\group{models}

Classification of proper subgraphs of the form
$$
\begin{array}{cccccc}\bullet \longrightarrow & \bullet \longrightarrow & \bullet \longrightarrow & \bullet \longrightarrow & \bullet \longrightarrow & \bullet\end{array}
$$
...
See picture in Lemma \ref{models-lemma-Dn}. We will prove by induction on $t$
that if $n = t + 1$ this leads to possibilities
(\ref{item-Dn-extended-up}) and (\ref{item-Dn-extended-down})
of Lemma \ref{models-lemma-genus-one} and if $n > t + 1$ to
case (\ref{item-Dn}) of Lemma \ref{models-lemma-Dn}.
By induction hypothesis (or Lemma \ref{models-lemma-D5} in case $t = 5$)
...
equal to $w$. Applying Lemma \ref{models-lemma-long}
(or Lemma \ref{models-lemma-five-by-five} if $t = 5$) to the sequence
...
(\ref{item-Dn-extended-down}) of Lemma \ref{models-lemma-genus-one}.
\item If $w_1 = w$, then we are in case
(\ref{item-Dn}) of Lemma \ref{models-lemma-Dn}.
\item If $w_1 = 2w$, then we are in case
(\ref{item-Dn-extended-up}) of Lemma \ref{models-lemma-genus-one}.
\end{enumerate}

\begin{lemma}[Dn]
\label{models-lemma-Dn}
\source{stacks:0C8D}
\href{https://stacks.math.columbia.edu/tag/0C8D}{\texttt{Stacks tag 0C8D}}
\group{models}

Classification of proper subgraphs of the form
$$
\begin{array}{ccccc}\bullet \longrightarrow & \bullet \longrightarrow & \bullet \longrightarrow & \bullet \longrightarrow\downarrow & \bullet \\  &  &  & \bullet & \end{array}
$$
...
See picture in Lemma \ref{models-lemma-E6}. Then we can apply
Lemma \ref{models-lemma-D5} to see that we must be in the situation
of Lemma \ref{models-lemma-E6}. Since the determinant is $3w^6 > 0$
we conclude that in this case it never happens that $n = 6$!

\begin{lemma}[E6]
\label{models-lemma-E6}
\source{stacks:0C8F}
\href{https://stacks.math.columbia.edu/tag/0C8F}{\texttt{Stacks tag 0C8F}}
\group{models}

Classification of proper subgraphs of the form
$$
\begin{array}{ccccc}\bullet \longrightarrow & \bullet \longrightarrow & \bullet \longrightarrow\downarrow & \bullet \longrightarrow & \bullet \\  &  & \bullet &  & \end{array}
$$
...
See picture in Lemma \ref{models-lemma-double-triple}.
Then we can apply Lemmas \ref{models-lemma-D5} and \ref{models-lemma-Dn}
...
\begin{lemma}[Double triple]
\label{models-lemma-double-triple}
\source{stacks:0C8H}
\href{https://stacks.math.columbia.edu/tag/0C8H}{\texttt{Stacks tag 0C8H}}
\group{models}

Nonexistence of proper subgraphs of the form
$$
\begin{array}{cccc}\bullet \longrightarrow & \bullet \longrightarrow\downarrow & \bullet \downarrow\longrightarrow & \bullet \\  & \bullet & \bullet & \end{array}
$$
...
See picture in Lemma \ref{models-lemma-E6-completed}. Then we can apply
Lemma \ref{models-lemma-D5} to see that the corresponding matrix is
$$
\left(
\begin{matrix}
-2w & w & 0 & 0 & 0 & 0 & 0 \\
...
of Lemma \ref{models-lemma-genus-one}.

\begin{lemma}[E6 completed]
\label{models-lemma-E6-completed}
\source{stacks:0C8I}
\href{https://stacks.math.columbia.edu/tag/0C8I}{\texttt{Stacks tag 0C8I}}
\group{models}

Nonexistence of proper subgraphs of the form
$$
\begin{array}{ccccc}\bullet \longrightarrow & \bullet \longrightarrow & \bullet \longrightarrow\downarrow & \bullet \longrightarrow & \bullet \\  &  & \bullet \downarrow &  &  \\  &  & \bullet &  & \end{array}
$$
...
See picture in Lemma \ref{models-lemma-E7}. Then we can apply
Lemmas \ref{models-lemma-D5} and \ref{models-lemma-Dn}
to see that we must be in the situation
of Lemma \ref{models-lemma-E7}. Since the determinant is $-8w^7 > 0$
we conclude that in this case it never happens that $n = 7$!

\begin{lemma}[E7]
\label{models-lemma-E7}
\source{stacks:0C8J}
\href{https://stacks.math.columbia.edu/tag/0C8J}{\texttt{Stacks tag 0C8J}}
\group{models}

Classification of proper subgraphs of the form
$$
\begin{array}{cccccc}\bullet \longrightarrow & \bullet \longrightarrow & \bullet \longrightarrow & \bullet \longrightarrow\downarrow & \bullet \longrightarrow & \bullet \\  &  &  & \bullet &  & \end{array}
$$
...
$$
\begin{array}{ccccccc}\bullet \longrightarrow & \bullet \longrightarrow & \bullet \longrightarrow & \bullet \longrightarrow & \bullet \longrightarrow\downarrow & \bullet \longrightarrow & \bullet \\  &  &  &  & \bullet &  & \end{array}
$$
or like
$$
\begin{array}{ccccccc}\bullet \longrightarrow & \bullet \longrightarrow & \bullet \longrightarrow & \bullet \longrightarrow\downarrow & \bullet \longrightarrow & \bullet \longrightarrow & \bullet \\  &  &  & \bullet &  &  & \end{array}
$$
Arguing exactly as in the proof of Lemma \ref{models-lemma-E7}
we see that the first pattern leads to case
(\ref{item-E8}) in Lemma \ref{models-lemma-E8}
and does not lead to a new case in Lemma \ref{models-lemma-genus-one}.
Arguing exactly as in the proof of Lemma \ref{models-lemma-E6-completed}
we see that the second pattern does not occur if
$n > 8$, but leads to case (\ref{item-E7-completed})
in Lemma \ref{models-lemma-genus-one} when $n = 8$.

\begin{lemma}[E8]
\label{models-lemma-E8}
\source{stacks:0C8L}
\href{https://stacks.math.columbia.edu/tag/0C8L}{\texttt{Stacks tag 0C8L}}
\group{models}
...
\begin{lemma}[E7 completed]
\label{models-lemma-E7-completed}
\source{stacks:0C8N}
\href{https://stacks.math.columbia.edu/tag/0C8N}{\texttt{Stacks tag 0C8N}}
\group{models}
...
of nonzero entries $a_{ij}$ of the matrix $A$ looks like
$$
\begin{array}{cccccccc}\bullet \longrightarrow & \bullet \longrightarrow & \bullet \longrightarrow & \bullet \longrightarrow & \bullet \longrightarrow & \bullet \longrightarrow\downarrow & \bullet \longrightarrow & \bullet \\  &  &  &  &  & \bullet &  & \end{array}
$$
Arguing exactly as in the proof of Lemma \ref{models-lemma-E6-completed}
we see that this pattern does not occur if
$n > 9$, but leads to case (\ref{item-E8-completed})
in Lemma \ref{models-lemma-genus-one} when $n = 9$.

\begin{lemma}[E8 completed]
\label{models-lemma-E8-completed}
\source{stacks:0C8P}
\href{https://stacks.math.columbia.edu/tag/0C8P}{\texttt{Stacks tag 0C8P}}
\group{models}
...
\begin{proposition}[Classify subgraphs]
\label{models-proposition-classify-subgraphs}
\source{stacks:0C8Q}
\href{https://stacks.math.columbia.edu/tag/0C8Q}{\texttt{Stacks tag 0C8Q}}
\group{models}

\uses{models-lemma-two-by-two, models-lemma-three-by-three, models-lemma-four-by-four, models-lemma-D4, models-lemma-five-by-five, models-lemma-D5, models-lemma-long, models-lemma-Dn, models-lemma-E6, models-lemma-E7, models-lemma-E8}
Let $n, m_i, a_{ij}, w_i, g_i$ be a numerical type of genus $g$.
...
Lemmas \ref{models-lemma-two-by-two},
...
\ref{models-lemma-Dn},
\ref{models-lemma-E6},
\ref{models-lemma-E7}, or
\ref{models-lemma-E8}.
\end{proposition}

\begin{proof}
This follows from the discussion above; see discussion at the
start of Section \ref{models-section-classify-proper-subgraphs}.
\end{proof}
...
\source{stacks:0C8S}
\href{https://stacks.math.columbia.edu/tag/0C8S}{\texttt{Stacks tag 0C8S}}
\group{models}
...
\begin{proof}
\uses{models-lemma-non-irreducible-minimal-type-genus-at-least-one, models-lemma-irreducible}

Follows from Lemmas \ref{models-lemma-non-irreducible-minimal-type-genus-at-least-one}
and \ref{models-lemma-irreducible}.
\end{proof}
...
\source{stacks:0C8T}
\href{https://stacks.math.columbia.edu/tag/0C8T}{\texttt{Stacks tag 0C8T}}
\group{models}
...
\begin{proof}
This is proved in Section \ref{models-section-classify-proper-subgraphs}.
...
\begin{lemma}[Bound neighbours]
\label{models-lemma-bound-neighbours}
\source{stacks:0C9U}
\href{https://stacks.math.columbia.edu/tag/0C9U}{\texttt{Stacks tag 0C9U}}
\group{models}
...
\begin{lemma}[Bound heart]
\label{models-lemma-bound-heart}
\source{stacks:0C9V}
\href{https://stacks.math.columbia.edu/tag/0C9V}{\texttt{Stacks tag 0C9V}}
\group{models}
...
\begin{proof}
\uses{models-lemma-minus-one, models-definition-type-minus-one, models-definition-type-minimal, models-lemma-minus-two, models-definition-type-minus-two, models-lemma-diagonal-negative, models-lemma-bound-neighbours}
...
Lemma \ref{models-lemma-minus-one},
Definition \ref{models-definition-type-minus-one},
Definition \ref{models-definition-type-minimal},
Lemma \ref{models-lemma-minus-two}, and
Definition \ref{models-definition-type-minus-two}; we will use these
results without further mention in the following.
Thus $J$ has at most $2(g - 1)$ elements.
This proves (1).

\medskip\noindent
Recall that $-a_{ii} > 0$ for all $i$ by Lemma \ref{models-lemma-diagonal-negative}.
...
\medskip\noindent
Part (4) follows from Lemma \ref{models-lemma-bound-neighbours} and (3).
\end{proof}

\begin{lemma}[Bound wm]
\label{models-lemma-bound-wm}
\source{stacks:0C9W}
\href{https://stacks.math.columbia.edu/tag/0C9W}{\texttt{Stacks tag 0C9W}}
\group{models}
...
\begin{proof}
\uses{models-lemma-bound-neighbours, models-lemma-bound-heart, models-proposition-classify-subgraphs, models-lemma-long, models-lemma-Dn}

By Lemma \ref{models-lemma-bound-neighbours} it suffices to show
$m_i|a_{ii}| \leq 768g$ for all $i$.
Let $J \subset \{1, \ldots, n\}$ be the set of non-$(-2)$-indices
as in Lemma \ref{models-lemma-bound-heart}. Observe that $J$ is
...
Lemma \ref{models-lemma-bound-neighbours}
...
of such $I$ in Proposition \ref{models-proposition-classify-subgraphs}
and using the result of the previous paragraph, we see that
$w_i|a_{ii}| \leq 768g$ for all $i \in I$ unless $I$ is as described in
Lemma \ref{models-lemma-long} or
Lemma \ref{models-lemma-Dn}.
Thus we may assume the nonvanishing of $a_{ii'}$, $i, i' \in I$
has either the shape
$$
\begin{array}{cccccc}\bullet \longrightarrow & \bullet \longrightarrow & \bullet \longrightarrow & \bullet \longrightarrow & \bullet \longrightarrow & \bullet\end{array}
$$
(which has 3 subcases as detailed in Lemma \ref{models-lemma-long})
or the shape
$$
\begin{array}{cccccc}\bullet \longrightarrow & \bullet \longrightarrow & \bullet \longrightarrow & \bullet \longrightarrow & \bullet \longrightarrow\downarrow & \bullet \\  &  &  &  & \bullet & \end{array}
$$
We will prove the bound holds for the first subcase of
Lemma \ref{models-lemma-long} and leave the other cases to reader (the argument
...
\begin{proposition}[Bound picard group]
\label{models-proposition-bound-picard-group}
\source{stacks:0C9X}
\href{https://stacks.math.columbia.edu/tag/0C9X}{\texttt{Stacks tag 0C9X}}
\group{models}

\uses{models-definition-picard-group, models-definition-top-genus}
Let $g \geq 2$. For every numerical type $T$ of genus $g$
and prime number $\ell > 768g$ we have
$$
\dim_{\mathbf{F}_\ell} \Pic(T)[\ell] \leq g
$$
where $\Pic(T)$ is as in Definition \ref{models-definition-picard-group}.
If $T$ is minimal, then we even have
$$
\dim_{\mathbf{F}_\ell} \Pic(T)[\ell] \leq g_{top} \leq g
$$
where $g_{top}$ as in Definition \ref{models-definition-top-genus}.
\end{proposition}

\begin{proof}
\uses{models-lemma-contract-picard-group, models-lemma-contract, models-lemma-genus-nonnegative, models-lemma-picard-T-and-A, models-lemma-bound-wm, models-lemma-recurring-symmetric-integer}
...
$n$ is a $(-1)$-index. Applying Lemma \ref{models-lemma-contract-picard-group}
we find $\Pic(T) \subset \Pic(T')$ where $T'$
is a numerical type of genus $g$ (Lemma \ref{models-lemma-contract})
...
Observe that $g_{top} \leq g$ by Lemma \ref{models-lemma-genus-nonnegative}.
If $A = (a_{ij})$ then since $\Pic(T) \subset \Coker(A)$
by Lemma \ref{models-lemma-picard-T-and-A}. Thus it suffices to prove
the lemma for $\Coker(A)$.
By Lemma \ref{models-lemma-bound-wm} we see that $m_i|a_{ij}| \leq 768g$ for
all $i, j$.
Hence the result by Lemma \ref{models-lemma-recurring-symmetric-integer}.
\end{proof}
...
\begin{lemma}[Closure is model]
\label{models-lemma-closure-is-model}
\source{stacks:0C2S}
\href{https://stacks.math.columbia.edu/tag/0C2S}{\texttt{Stacks tag 0C2S}}
\group{models}
...
\source{stacks:0C2T}
\href{https://stacks.math.columbia.edu/tag/0C2T}{\texttt{Stacks tag 0C2T}}
\group{models}
...
\source{stacks:0C2U}
\href{https://stacks.math.columbia.edu/tag/0C2U}{\texttt{Stacks tag 0C2U}}
\group{models}
...
\source{stacks:0C2V}
\href{https://stacks.math.columbia.edu/tag/0C2V}{\texttt{Stacks tag 0C2V}}
\group{models}
...
(Proposition \ref{models-proposition-exists-minimal-model}) and are unique
when the genus is $> 0$ (Lemma \ref{models-lemma-minimal-model-unique}).

\begin{lemma}[A regular proper model of a curve is obtained by successive blowups from a minimal model]
\label{models-lemma-pre-exists-minimal-model}
\source{stacks:0CD9}
\href{https://stacks.math.columbia.edu/tag/0CD9}{\texttt{Stacks tag 0CD9}}
\group{models}
...
\begin{proposition}[Exists minimal model]
\label{models-proposition-exists-minimal-model}
\source{stacks:0C2W}
\href{https://stacks.math.columbia.edu/tag/0C2W}{\texttt{Stacks tag 0C2W}}
\group{models}
...
\begin{proof}
\uses{models-lemma-closure-is-model, models-lemma-regular, models-lemma-pre-exists-minimal-model}
...
Lemma \ref{models-lemma-closure-is-model}.
By Lemma \ref{models-lemma-regular} there exists a resolution
of singularities $X' \to X$ and $X'$ is a model for $C$.
Then $X' \to \Spec(R)$ is proper as a composition of proper morphisms.
Then we may apply Lemma \ref{models-lemma-pre-exists-minimal-model}
...
\begin{lemma}[Divisor special fiber]
\label{models-lemma-divisor-special-fiber}
\source{stacks:0C5Z}
\href{https://stacks.math.columbia.edu/tag/0C5Z}{\texttt{Stacks tag 0C5Z}}
\group{models}
...
\source{stacks:0C60}
\href{https://stacks.math.columbia.edu/tag/0C60}{\texttt{Stacks tag 0C60}}
\group{models}
...
\begin{definition}[Situation: Regular model]
\label{models-situation-regular-model}
\source{stacks:0C61}
\href{https://stacks.math.columbia.edu/tag/0C61}{\texttt{Stacks tag 0C61}}
\group{models}

\uses{models-lemma-divisor-special-fiber}
...
Lemma \ref{models-lemma-divisor-special-fiber}.
\end{definition}

\begin{lemma}[Regular model connected]
\label{models-lemma-regular-model-connected}
\source{stacks:0C62}
\href{https://stacks.math.columbia.edu/tag/0C62}{\texttt{Stacks tag 0C62}}
\group{models}

\uses{models-situation-regular-model}
In Situation \ref{models-situation-regular-model} the special fibre $X_k$ is connected.
\end{lemma}
...
\begin{lemma}[Regular model pic]
\label{models-lemma-regular-model-pic}
\source{stacks:0C63}
\href{https://stacks.math.columbia.edu/tag/0C63}{\texttt{Stacks tag 0C63}}
\group{models}

\uses{models-situation-regular-model}
In Situation \ref{models-situation-regular-model} there is an exact sequence
$$
...
In Situation \ref{models-situation-regular-model} for every invertible
...
\begin{lemma}[Intersection pairing]
\label{models-lemma-intersection-pairing}
\source{stacks:0C64}
\href{https://stacks.math.columbia.edu/tag/0C64}{\texttt{Stacks tag 0C64}}
\group{models}

\uses{models-situation-regular-model}
In Situation \ref{models-situation-regular-model} given $\mathcal{L}$ an invertible
...
In Situation \ref{models-situation-regular-model} it is often convenient to think
...
Lemma \ref{models-lemma-intersection-pairing}
...
\begin{lemma}[Properties form]
\label{models-lemma-properties-form}
\source{stacks:0C66}
\href{https://stacks.math.columbia.edu/tag/0C66}{\texttt{Stacks tag 0C66}}
\group{models}

\uses{models-situation-regular-model}
In Situation \ref{models-situation-regular-model} the symmetric bilinear form
...
\begin{proof}
\uses{models-lemma-intersection-pairing, models-lemma-divisor-special-fiber, models-lemma-regular-model-connected, models-lemma-recurring-symmetric-real}

In the proof of Lemma \ref{models-lemma-intersection-pairing} we saw that
$(C_i \cdot C_j) = \deg(C_i \cap C_j)$ if $i \not = j$. This is
$\geq 0$ and $> 0 $ if and only if $C_i \cap C_j \not = \emptyset$.
This proves (1).

\medskip\noindent
Proof of (2). This is true because by Lemma \ref{models-lemma-divisor-special-fiber}
...
\begin{lemma}[Multiple fibre normal bundle]
\label{models-lemma-multiple-fibre-normal-bundle}
\source{stacks:0C67}
\href{https://stacks.math.columbia.edu/tag/0C67}{\texttt{Stacks tag 0C67}}
\group{models}

\uses{models-situation-regular-model}
In Situation \ref{models-situation-regular-model} set $d = \gcd(m_1, \ldots, m_n)$
...
$$
by Lemma \ref{models-lemma-divisor-special-fiber}.
We conclude as $\mathcal{C}_{D/X}$ is the pullback of
$\mathcal{O}_X(-D)$.
\end{proof}

\begin{lemma}[Regular model field]
\label{models-lemma-regular-model-field}
\source{stacks:0C68}
\href{https://stacks.math.columbia.edu/tag/0C68}{\texttt{Stacks tag 0C68}}
\group{models}
...
\end{reference}
In Situation \ref{models-situation-regular-model} let $d = \gcd(m_1, \ldots, m_n)$.
...
\begin{proof}
\uses{models-lemma-regular-model-connected, models-lemma-properties-form}

The reduction $D_{red} = (X_k)_{red} = \sum C_i$ is connected
(Lemma \ref{models-lemma-regular-model-connected}) and proper over $k$. Hence
...
$(Z_t \cdot Z_t) < 0$ by Lemma \ref{models-lemma-properties-form}. This means that
...
\begin{lemma}[Regular model genus]
\label{models-lemma-regular-model-genus}
\source{stacks:0C69}
\href{https://stacks.math.columbia.edu/tag/0C69}{\texttt{Stacks tag 0C69}}
\group{models}
...
\begin{proof}
\uses{models-lemma-regular-model-field, models-lemma-multiple-fibre-normal-bundle}

By Lemma \ref{models-lemma-regular-model-field} we see that $\kappa$ is a field
...
element of $\Pic(D)$ (Lemma \ref{models-lemma-multiple-fibre-normal-bundle})
and because the degree of a line bundle is additive
(Varieties, Lemma \ref{varieties-lemma-degree-tensor-product})
hence zero for torsion invertible sheaves.
\end{proof}

\begin{lemma}[Exceptional curves dont meet]
\label{models-lemma-exceptional-curves-dont-meet}
\source{stacks:0C6A}
\href{https://stacks.math.columbia.edu/tag/0C6A}{\texttt{Stacks tag 0C6A}}
\group{models}

\uses{models-situation-regular-model}
In Situation \ref{models-situation-regular-model} given a pair of indices $i, j$
...
\begin{proof}
\uses{models-lemma-intersection-pairing, models-lemma-properties-form, models-lemma-regular-model-genus}
...
$C_j$. By Lemma \ref{models-lemma-properties-form}
$$
...
$H^1(D, \mathcal{O}_D) = 0$. By Lemma \ref{models-lemma-regular-model-genus}
we conclude
$$
1 - g_C = d[\kappa : k](1 - 0)
$$
...
(Lemma \ref{models-lemma-minimal-model-unique}) and consequently have a suitable
mapping property (Lemma \ref{models-lemma-minimal-model-mapping-property}).

\begin{lemma}[Minimal model unique]
\label{models-lemma-minimal-model-unique}
\source{stacks:0C6B}
\href{https://stacks.math.columbia.edu/tag/0C6B}{\texttt{Stacks tag 0C6B}}
\group{models}
...
\begin{proof}
\uses{models-proposition-exists-minimal-model, models-lemma-exceptional-curves-dont-meet}
...
$E \cap E' = \emptyset$ by
Lemma \ref{models-lemma-exceptional-curves-dont-meet}.
...
\begin{lemma}[Minimal model mapping property]
\label{models-lemma-minimal-model-mapping-property}
\source{stacks:0C9Z}
\href{https://stacks.math.columbia.edu/tag/0C9Z}{\texttt{Stacks tag 0C9Z}}
\group{models}

\uses{models-lemma-minimal-model-unique}
Let $C$ be a smooth projective curve over $K$ with $H^0(C, \mathcal{O}_C) = K$
...
\begin{proof}
\uses{models-lemma-pre-exists-minimal-model}

The existence and properties of the morphism $X \to Y$
follows immediately from Lemma \ref{models-lemma-pre-exists-minimal-model}
...
\begin{example}[Nonunique in genus zero]
\label{models-example-nonunique-in-genus-zero}
\source{stacks:0CA0}
\href{https://stacks.math.columbia.edu/tag/0CA0}{\texttt{Stacks tag 0CA0}}
\group{models}

\uses{models-lemma-exceptional-curves-dont-meet, models-lemma-nonuniqueness}
...
(exactly as in Lemma \ref{models-lemma-exceptional-curves-dont-meet}).
...
R[T_0, T_2]
$$
In Lemma \ref{models-lemma-nonuniqueness} we will study this phenomenon.
\end{example}
...
\begin{lemma}[Add component]
\label{models-lemma-add-component}
\source{stacks:0CA2}
\href{https://stacks.math.columbia.edu/tag/0CA2}{\texttt{Stacks tag 0CA2}}
\group{models}

\uses{models-situation-regular-model}
In Situation \ref{models-situation-regular-model} suppose we have an
...
\begin{proof}
\uses{models-lemma-intersection-pairing}

The second equality follows from the definition of the bilinear form
$(\ \cdot\ )$ in (\ref{equation-form}) and
Lemma \ref{models-lemma-intersection-pairing}. To see the first
...
\source{stacks:0CA3}
\href{https://stacks.math.columbia.edu/tag/0CA3}{\texttt{Stacks tag 0CA3}}
\group{models}

\uses{models-situation-regular-model}
In Situation \ref{models-situation-regular-model} we have
$$
...
\begin{proof}
\uses{models-lemma-add-component, models-lemma-properties-form}
...
of $D_{j + 1}$ one step at a time.) Applying Lemma \ref{models-lemma-add-component}
...
Lemma \ref{models-lemma-properties-form}. Thus we see that
$$
0 = \sum\nolimits_{j \not = j'} (C_{i_{j'}} \cdot C_{i_j}) +
...
\begin{lemma}[Numerical type of model]
\label{models-lemma-numerical-type-of-model}
\source{stacks:0CA4}
\href{https://stacks.math.columbia.edu/tag/0CA4}{\texttt{Stacks tag 0CA4}}
\group{models}

\uses{models-situation-regular-model}
In Situation \ref{models-situation-regular-model} with
...
\begin{proof}
\uses{models-lemma-genus-formula, models-definition-type, models-lemma-intersection-pairing, models-lemma-properties-form, models-definition-genus}

(In the proof of Lemma \ref{models-lemma-genus-formula}
...
Definition \ref{models-definition-type}.
...
is part (1) of Lemma \ref{models-lemma-properties-form}.

\medskip\noindent
Condition (3) is part (3) of Lemma \ref{models-lemma-properties-form}.

\medskip\noindent
Condition (4) is part (2) of Lemma \ref{models-lemma-properties-form}.
...
\medskip\noindent
The genus formula proved in Lemma \ref{models-lemma-genus-formula}
tells us that the numerical type has the genus as stated, see
Definition \ref{models-definition-genus}.
\end{proof}

\begin{definition}[Numerical type model]
\label{models-definition-numerical-type-model}
\source{stacks:0CA5}
\href{https://stacks.math.columbia.edu/tag/0CA5}{\texttt{Stacks tag 0CA5}}
\group{models}

\uses{models-situation-regular-model, models-lemma-numerical-type-of-model}
In Situation \ref{models-situation-regular-model} the
{\it numerical type associated to $X$} is the numerical
type described in Lemma \ref{models-lemma-numerical-type-of-model}.
\end{definition}

Now we match minimality of the model with minimality of the type.

\begin{lemma}[Numerical type minimal model]
\label{models-lemma-numerical-type-minimal-model}
\source{stacks:0CA6}
\href{https://stacks.math.columbia.edu/tag/0CA6}{\texttt{Stacks tag 0CA6}}
\group{models}

\uses{models-situation-regular-model}
In Situation \ref{models-situation-regular-model}. The following
are equivalent
\begin{enumerate}
...
\begin{proof}
\uses{models-definition-type-minimal}
...
\begin{remark}[Numerical type not from model]
\label{models-remark-numerical-type-not-from-model}
\source{stacks:0CA7}
\href{https://stacks.math.columbia.edu/tag/0CA7}{\texttt{Stacks tag 0CA7}}
\group{models}
...
\begin{lemma}[Numerical type rational point]
\label{models-lemma-numerical-type-rational-point}
\source{stacks:0CE8}
\href{https://stacks.math.columbia.edu/tag/0CE8}{\texttt{Stacks tag 0CE8}}
\group{models}

\uses{models-situation-regular-model}
In Situation \ref{models-situation-regular-model} assume $C$ has a $K$-rational point.
Then
\begin{enumerate}
...
\begin{proof}
\uses{models-lemma-regular-model-field, models-lemma-regular-model-genus}
...
extension of $k$ (Lemma \ref{models-lemma-regular-model-field})
which maps to $H^0(C_i, \mathcal{O}_{C_i}) = k$.
The genus equality follows from Lemma \ref{models-lemma-regular-model-genus}.
\end{proof}

\begin{lemma}[Genus reduction smaller]
\label{models-lemma-genus-reduction-smaller}
\source{stacks:0CE9}
\href{https://stacks.math.columbia.edu/tag/0CE9}{\texttt{Stacks tag 0CE9}}
\group{models}

\uses{models-situation-regular-model}
In Situation \ref{models-situation-regular-model} assume $X$ is a minimal model,
...
\begin{proof}
\uses{models-lemma-regular-model-field, models-lemma-numerical-type-minimal-model}
...
$$
of Lemma \ref{models-lemma-regular-model-field}. Since the field maps
...
As in the proof of Lemma \ref{models-lemma-regular-model-field}
...
(see proof of Lemma \ref{models-lemma-numerical-type-minimal-model}).
Thus $\dim_k H^1(C, \mathcal{L}) > 0$ which finishes the proof.
\end{proof}

\begin{lemma}[Genus reduction bigger than]
\label{models-lemma-genus-reduction-bigger-than}
\source{stacks:0CEA}
\href{https://stacks.math.columbia.edu/tag/0CEA}{\texttt{Stacks tag 0CEA}}
\group{models}

\uses{models-situation-regular-model, models-definition-top-genus, models-definition-numerical-type-model}
In Situation \ref{models-situation-regular-model} assume $X_k$ has a $k$-rational
...
\end{align*}
Here as in Lemma \ref{models-lemma-numerical-type-of-model} we set
...
\begin{lemma}[Equality genus reduction bigger than]
\label{models-lemma-equality-genus-reduction-bigger-than}
\source{stacks:0CEE}
\href{https://stacks.math.columbia.edu/tag/0CEE}{\texttt{Stacks tag 0CEE}}
\group{models}

\uses{models-lemma-genus-reduction-bigger-than}
If equality holds in Lemma \ref{models-lemma-genus-reduction-bigger-than}
then
\begin{enumerate}
...
Looking over the proof of Lemma \ref{models-lemma-genus-reduction-bigger-than}
...
in the proof of Lemma \ref{models-lemma-genus-reduction-bigger-than}.
...
the numerical contractions introduced in Lemma \ref{models-lemma-contract}.
We will compare the geometric and numerical contractions in
Remark \ref{models-remark-compare-contractions}.

\begin{lemma}[Blowdown regular model]
\label{models-lemma-blowdown-regular-model}
\source{stacks:0C6C}
\href{https://stacks.math.columbia.edu/tag/0C6C}{\texttt{Stacks tag 0C6C}}
\group{models}

\uses{models-situation-regular-model}
In Situation \ref{models-situation-regular-model} assume that $C_n$ is
...
is as in Situation \ref{models-situation-regular-model} and we have
\begin{enumerate}
...
Situation \ref{models-situation-regular-model}.
...
$$
\begin{array}{cc}C_j \longrightarrow\underset{f_j}{\downarrow} & X \overset{f}{\downarrow} \\ C'_j \longrightarrow & X'\end{array}
$$
...
\begin{remark}[Genus change]
\label{models-remark-genus-change}
\source{stacks:0CA8}
\href{https://stacks.math.columbia.edu/tag/0CA8}{\texttt{Stacks tag 0CA8}}
\group{models}

\uses{models-lemma-blowdown-regular-model}
In the situation of Lemma \ref{models-lemma-blowdown-regular-model}
...
$$
with $e_i$ as in the proof of Lemma \ref{models-lemma-blowdown-regular-model}.
...
\begin{remark}[Compare contractions]
\label{models-remark-compare-contractions}
\source{stacks:0CA9}
\href{https://stacks.math.columbia.edu/tag/0CA9}{\texttt{Stacks tag 0CA9}}
\group{models}

\uses{models-lemma-blowdown-regular-model, models-remark-genus-change, models-lemma-contract, models-lemma-contract-picard-group}
Let $f : X \to X'$ be as in Lemma \ref{models-lemma-blowdown-regular-model}.
...
It is clear from Lemma \ref{models-lemma-blowdown-regular-model} and
Remark \ref{models-remark-genus-change}
that this agrees with the contraction of numerical types in
Lemma \ref{models-lemma-contract}
...
of the numerical types, see Lemma \ref{models-lemma-contract-picard-group}
(although only injectivity is every used in the following and this
injectivity works as well for smaller $w'_i$).
\end{remark}

\begin{lemma}[Nonuniqueness]
\label{models-lemma-nonuniqueness}
\source{stacks:0CDA}
\href{https://stacks.math.columbia.edu/tag/0CDA}{\texttt{Stacks tag 0CDA}}
\group{models}
...
elementary transformations as in Example \ref{models-example-nonunique-in-genus-zero}.
If we ever need this, we will precisely formulate and prove this here.

\begin{proof}
\uses{models-definition-numerical-type-model, models-lemma-numerical-type-minimal-model, models-lemma-genus-zero}

Let $X$ be some minimal model of $C$. The numerical type associated to $X$
has genus $0$ and is minimal (Definition \ref{models-definition-numerical-type-model}
and Lemma \ref{models-lemma-numerical-type-minimal-model}).
Hence by Lemma \ref{models-lemma-genus-zero} we see that
...
are as in Situation \ref{models-situation-regular-model}.
In Lemma \ref{models-lemma-regular-model-pic} we found an exact sequence
$$
0 \to \mathbf{Z} \to \mathbf{Z}^{\oplus n} \to
\Pic(X) \to \Pic(C) \to 0
$$
...
\begin{lemma}[Characterize trivial]
\label{models-lemma-characterize-trivial}
\source{stacks:0CAB}
\href{https://stacks.math.columbia.edu/tag/0CAB}{\texttt{Stacks tag 0CAB}}
\group{models}
...
\begin{proof}
\uses{models-lemma-regular-model-pic, models-lemma-properties-form, models-lemma-multiple-fibre-normal-bundle}

By Lemma \ref{models-lemma-regular-model-pic} we have
...
Hence we see from Lemma \ref{models-lemma-properties-form}
...
Lemma \ref{models-lemma-multiple-fibre-normal-bundle}
and we conclude.
\end{proof}

\begin{lemma}[Canonical map of pic]
\label{models-lemma-canonical-map-of-pic}
\source{stacks:0CAC}
\href{https://stacks.math.columbia.edu/tag/0CAC}{\texttt{Stacks tag 0CAC}}
\group{models}

\uses{models-situation-regular-model}
In Situation \ref{models-situation-regular-model}
...
\begin{proof}
\uses{models-definition-picard-group, models-lemma-regular-model-pic}
...
diagram
$$
\begin{array}{cccc}\mathbf{Z}^{\oplus n} \longrightarrow\underset{\text{id}}{\downarrow} & \Pic(X) \longrightarrow\overset{\frac{\deg}{w}}{\downarrow} & \Pic(C) \longrightarrow\downarrow & 0 \\ \mathbf{Z}^{\oplus n} \overset{(a_{ij}/w_i)}{\longrightarrow} & \mathbf{Z}^{\oplus n} \longrightarrow & \Pic(T) \longrightarrow & 0\end{array}
$$
with exact rows (top row by Lemma \ref{models-lemma-regular-model-pic}).
The description of the kernel is clear.
\end{proof}

\begin{lemma}[Sequence torsion]
\label{models-lemma-sequence-torsion}
\source{stacks:0CAD}
\href{https://stacks.math.columbia.edu/tag/0CAD}{\texttt{Stacks tag 0CAD}}
\group{models}
...
\begin{proof}
\uses{models-lemma-regular-model-pic, models-lemma-canonical-map-of-pic, models-lemma-characterize-trivial}

Taking $h$-torsion in the exact sequence of
Lemma \ref{models-lemma-regular-model-pic}
we obtain the exactness of
$0 \to \Pic(X)[h] \to \Pic(C)[h]$
because $h$ is prime to $d$.
Using the map of Lemma \ref{models-lemma-canonical-map-of-pic}
...
Lemma \ref{models-lemma-characterize-trivial}.
...
\begin{lemma}[Torsion embeds]
\label{models-lemma-torsion-embeds}
\source{stacks:0CAE}
\href{https://stacks.math.columbia.edu/tag/0CAE}{\texttt{Stacks tag 0CAE}}
\group{models}

\uses{models-situation-regular-model}
In Situation \ref{models-situation-regular-model} let $h$ be an integer
...
\source{stacks:0CDC}
\href{https://stacks.math.columbia.edu/tag/0CDC}{\texttt{Stacks tag 0CDC}}
\group{models}
...
the same as the case of $A[\frac{\mathfrak m}{x}]$.
...
\begin{lemma}[Etale local at worst nodal]
\label{models-lemma-etale-local-at-worst-nodal}
\source{stacks:0CDD}
\href{https://stacks.math.columbia.edu/tag/0CDD}{\texttt{Stacks tag 0CDD}}
\group{models}
...
$$
\begin{array}{ccc}X \downarrow & U \longrightarrow\downarrow\longleftarrow & \Spec(A) \swarrow \\ \Spec(R) & \Spec(R') \longleftarrow & \end{array}
$$
...
to get a diagram
$$
\begin{array}{ccccc}X \downarrow & U \longrightarrow\longleftarrow\searrow &  & W \longrightarrow\swarrow & \Spec(\mathbf{Z}[u, v, a]/(uv - a)) \downarrow \\ \Spec(R) &  & V \longleftarrow\longrightarrow &  & \Spec(\mathbf{Z}[a])\end{array}
$$
...
\begin{lemma}[Blowup at worst nodal]
\label{models-lemma-blowup-at-worst-nodal}
\source{stacks:0CDE}
\href{https://stacks.math.columbia.edu/tag/0CDE}{\texttt{Stacks tag 0CDE}}
\group{models}
...
\begin{proof}
\uses{models-lemma-etale-local-at-worst-nodal, models-example-blowup}
...
\begin{array}{ccc}X \downarrow & U \longrightarrow\downarrow\longleftarrow & \Spec(A) \swarrow \\ \Spec(R) & \Spec(R') \longleftarrow & \end{array}
$$
as in Lemma \ref{models-lemma-etale-local-at-worst-nodal}.
...
Example \ref{models-example-blowup}.
...
$$
\begin{array}{ccc}X' \downarrow & U' \longleftarrow\downarrow\longrightarrow & W' \downarrow \\ X & U \longleftarrow\longrightarrow & \Spec(A)\end{array}
$$
with cartesian squares where the vertical arrows are the blowing
up of $x, u, w$ in $X, U, \Spec(A)$. The scheme $W'$ was described
in Example \ref{models-example-blowup}. We saw there that $W'$
...
$$
\begin{array}{ccc}X'' \downarrow & U'' \longleftarrow\downarrow\longrightarrow & W'' \downarrow \\ X' & U' \longleftarrow\longrightarrow & W'\end{array}
$$
with cartesian squares where the vertical arrows are the blowing
...
\begin{lemma}[Blowdown at worst nodal]
\label{models-lemma-blowdown-at-worst-nodal}
\source{stacks:0CDF}
\href{https://stacks.math.columbia.edu/tag/0CDF}{\texttt{Stacks tag 0CDF}}
\group{models}
...
\begin{lemma}[Semistable]
\label{models-lemma-semistable}
\source{stacks:0CDG}
\href{https://stacks.math.columbia.edu/tag/0CDG}{\texttt{Stacks tag 0CDG}}
\group{models}
...
\begin{proof}
\uses{models-definition-minimal-model, models-proposition-exists-minimal-model, models-lemma-minimal-model-unique, models-lemma-blowup-at-worst-nodal, models-lemma-pre-exists-minimal-model, models-lemma-blowdown-at-worst-nodal, models-lemma-nonuniqueness}
...
(Definition \ref{models-definition-minimal-model}),
...
of $C$ is $> 0$ (Lemma \ref{models-lemma-minimal-model-unique}).
...
at-worst-nodal of relative dimension $1$ over $R$.
Applying Lemma \ref{models-lemma-blowup-at-worst-nodal}
we see that we may assume $X$ is regular as well.
Let
$$
X = X_m \to X_{m - 1} \to \ldots \to X_1 \to X_0
$$
be as in Lemma \ref{models-lemma-pre-exists-minimal-model}.
By Lemma \ref{models-lemma-blowdown-at-worst-nodal} and induction
...
by Lemma \ref{models-lemma-nonuniqueness}.
\end{proof}

\begin{definition}[Semistable]
\label{models-definition-semistable}
\source{stacks:0CDH}
\href{https://stacks.math.columbia.edu/tag/0CDH}{\texttt{Stacks tag 0CDH}}
\group{models}

\uses{models-lemma-semistable}
Let $R$ be a discrete valuation ring with fraction field $K$.
Let $C$ be a smooth projective curve over $K$ with $H^0(C, \mathcal{O}_C) = K$.
We say that $C$ has {\it semistable reduction} if the equivalent
conditions of Lemma \ref{models-lemma-semistable} are satisfied.
\end{definition}

\begin{lemma}[Good]
\label{models-lemma-good}
\source{stacks:0CDI}
\href{https://stacks.math.columbia.edu/tag/0CDI}{\texttt{Stacks tag 0CDI}}
\group{models}
...
\begin{proof}
\uses{models-lemma-regular-model-connected, models-lemma-minimal-model-unique, models-lemma-nonuniqueness}

If $X$ is a smooth proper model, then the special fibre is
connected (Lemma \ref{models-lemma-regular-model-connected})
and smooth, hence irreducible. This immediately implies that
it is minimal. Thus (1) implies (2).
To finish the proof we have to show that (2) implies (3).
This is clear if the genus of $C$ is $> 0$, since then
the minimal model is unique (Lemma \ref{models-lemma-minimal-model-unique}).
On the other hand, if the minimal model is not unique, then
the morphism $X \to \Spec(R)$ is smooth for any minimal model
as its special fibre will be isomorphic to $\mathbf{P}^1_k$
by Lemma \ref{models-lemma-nonuniqueness}.
...
\source{stacks:0CDJ}
\href{https://stacks.math.columbia.edu/tag/0CDJ}{\texttt{Stacks tag 0CDJ}}
\group{models}

\uses{models-lemma-good}
Let $R$ be a discrete valuation ring with fraction field $K$.
Let $C$ be a smooth projective curve over $K$ with $H^0(C, \mathcal{O}_C) = K$.
We say that $C$ has {\it good reduction} if the equivalent
conditions of Lemma \ref{models-lemma-good} are satisfied.
\end{definition}
...
\begin{example}[Extension necessary genus zero]
\label{models-example-extension-necessary-genus-zero}
\source{stacks:0CDL}
\href{https://stacks.math.columbia.edu/tag/0CDL}{\texttt{Stacks tag 0CDL}}
\group{models}

\uses{models-example-nonunique-in-genus-zero, models-lemma-nonuniqueness}
...
to the scheme defined in Example \ref{models-example-nonunique-in-genus-zero}
...
(use Lemma \ref{models-lemma-nonuniqueness}).
...
In this section we prove the semistable reduction theorem
(Theorem \ref{models-theorem-semistable-reduction}) for curves of genus one.
...
such that $m_i = w_i = 1$ by Lemma \ref{models-lemma-numerical-type-rational-point}.
Looking at the classification of minimal numerical types
of genus $1$ in Lemma \ref{models-lemma-genus-one}
...
of a numerical type is defined in Section \ref{models-section-picard-group}).
The vanishing follows as $\Pic(T) \subset \Coker(A)$
(Lemma \ref{models-lemma-picard-T-and-A}) and $\Coker(A)[\ell] = 0$ by
Lemma \ref{models-lemma-recurring-symmetric-integer} and the
fact that $\ell$ was chosen relatively prime to $a_{ij}$ and $m_i$.
By Lemmas \ref{models-lemma-sequence-torsion} and \ref{models-lemma-torsion-embeds}
...
The assumptions of Lemma \ref{models-lemma-genus-reduction-smaller}
hold by Lemma \ref{models-lemma-numerical-type-rational-point} and we
...
But since $X_k$ is Gorenstein (Lemma \ref{models-lemma-gorenstein}),
...
\begin{example}[Extension necessary genus one]
\label{models-example-extension-necessary-genus-one}
\source{stacks:0CEH}
\href{https://stacks.math.columbia.edu/tag/0CEH}{\texttt{Stacks tag 0CEH}}
\group{models}
...
In this section we prove the semistable reduction theorem
(Theorem \ref{models-theorem-semistable-reduction}) for curves of genus $\geq 2$.
Fix $g \geq 2$.
...
that the conclusions of Lemma \ref{models-lemma-numerical-type-rational-point}
are true.
...
(Lemma \ref{models-lemma-numerical-type-minimal-model}).
By Proposition \ref{models-proposition-bound-picard-group}
we have
$$
...
$$
By Lemmas \ref{models-lemma-genus-reduction-smaller} and
...
Looking at Lemma \ref{models-lemma-genus-reduction-smaller}
we conclude that $m_i = 1$ for all $i$.
Looking at Lemma \ref{models-lemma-equality-genus-reduction-bigger-than}
...
\begin{theorem}[Semistable reduction]
\label{models-theorem-semistable-reduction}
\source{stacks:0CDN}
\href{https://stacks.math.columbia.edu/tag/0CDN}{\texttt{Stacks tag 0CDN}}
\group{models}
...
Section \ref{models-section-semistable-reduction-genus-zero}.
For the case of genus one, see
Section \ref{models-section-semistable-reduction-genus-one}.
...
\source{stacks:0CEK}
\href{https://stacks.math.columbia.edu/tag/0CEK}{\texttt{Stacks tag 0CEK}}
\group{models}

\uses{models-theorem-semistable-reduction}
Results in the literature suggest that one can improve the bound
given in the statement of Theorem \ref{models-theorem-semistable-reduction}.
