...
We discuss a particular case of this in Section \ref{spaces-pushouts-section-pushouts}
...
\medskip\noindent
In Sections \ref{spaces-pushouts-section-formal-glueing} and
\ref{spaces-pushouts-section-formal-glueing-spaces} we discuss diagrams
$$
\begin{array}{cc}f^{-1}(X \setminus Z) \longrightarrow\downarrow & Y \overset{f}{\downarrow} \\ X \setminus Z \longrightarrow & X\end{array}
$$
...
(in Section \ref{spaces-pushouts-section-formal-glueing}) to quasi-coherent modules on $X$
and we glue algebraic spaces over $X \setminus Z$ and $Y$
(in Section \ref{spaces-pushouts-section-formal-glueing-spaces}) to algebraic spaces over $X$.

\medskip\noindent
In Section \ref{spaces-pushouts-section-coequalizer-glue} we discuss how proper birational
morphisms of Noetherian algebraic spaces give rise to coequalizer diagrams
in algebraic spaces in some sense.

\medskip\noindent
In Section \ref{spaces-pushouts-section-compactifications} we use the construction
of elementary distinguished squares
in Section \ref{spaces-pushouts-section-elementary-dsitnguished-squares}
...
$$
\begin{array}{cc}U_i \longrightarrow\downarrow & U_j \downarrow \\ X_i \longrightarrow & X_j\end{array}
$$
...
\begin{lemma}[Colimit agrees]
\label{spaces-pushouts-lemma-colimit-agrees}
\source{stacks:07SX}
\href{https://stacks.math.columbia.edu/tag/07SX}{\texttt{Stacks tag 07SX}}
\group{spaces-pushouts}
...
\begin{lemma}[Pushout fpqc local]
\label{spaces-pushouts-lemma-pushout-fpqc-local}
\source{stacks:0GFQ}
\href{https://stacks.math.columbia.edu/tag/0GFQ}{\texttt{Stacks tag 0GFQ}}
\group{spaces-pushouts}
...
Lemmas \ref{spaces-pushouts-lemma-colimit-agrees} and \ref{spaces-pushouts-lemma-pushout-fpqc-local}
...
\begin{lemma}[Colimit check etale locally]
\label{spaces-pushouts-lemma-colimit-check-etale-locally}
\source{stacks:0GHL}
\href{https://stacks.math.columbia.edu/tag/0GHL}{\texttt{Stacks tag 0GHL}}
\group{spaces-pushouts}
...
By Lemma \ref{spaces-pushouts-lemma-pushout-fpqc-local}
...
\begin{lemma}[Colimit separated enough]
\label{spaces-pushouts-lemma-colimit-separated-enough}
\source{stacks:0GFP}
\href{https://stacks.math.columbia.edu/tag/0GFP}{\texttt{Stacks tag 0GFP}}
\group{spaces-pushouts}
...
Lemma \ref{spaces-pushouts-lemma-colimit-check-etale-locally}
and its proof.
...
\begin{lemma}[Glue etale sheaf etale]
\label{spaces-pushouts-lemma-glue-etale-sheaf-etale}
\source{stacks:0GFS}
\href{https://stacks.math.columbia.edu/tag/0GFS}{\texttt{Stacks tag 0GFS}}
\group{spaces-pushouts}
...
Moreover, we have identifications
...
\begin{lemma}[Reduce to scheme base]
\label{spaces-pushouts-lemma-reduce-to-scheme-base}
\source{stacks:0GFT}
\href{https://stacks.math.columbia.edu/tag/0GFT}{\texttt{Stacks tag 0GFT}}
\group{spaces-pushouts}
...
\begin{proof}
Formal consequence of Lemma \ref{spaces-pushouts-lemma-glue-etale-sheaf-etale}
and the definitions.
\end{proof}

\begin{lemma}[Representable case]
\label{spaces-pushouts-lemma-representable-case}
\source{stacks:0GFU}
\href{https://stacks.math.columbia.edu/tag/0GFU}{\texttt{Stacks tag 0GFU}}
\group{spaces-pushouts}
...
Thus we can apply Lemma \ref{spaces-pushouts-lemma-reduce-to-scheme-base}
...
\begin{lemma}[Reduce to scheme source]
\label{spaces-pushouts-lemma-reduce-to-scheme-source}
\source{stacks:0GFV}
\href{https://stacks.math.columbia.edu/tag/0GFV}{\texttt{Stacks tag 0GFV}}
\group{spaces-pushouts}
...
\begin{proof}
Formal consequence of Lemma \ref{spaces-pushouts-lemma-representable-case}
...
\source{stacks:0GFW}
\href{https://stacks.math.columbia.edu/tag/0GFW}{\texttt{Stacks tag 0GFW}}
\group{spaces-pushouts}
...
Hence by Lemma \ref{spaces-pushouts-lemma-reduce-to-scheme-base}
we may work \'etale locally on $Y$. Hence
we reduce to $Y$ being an affine scheme; some details omitted.

\medskip\noindent
Assume $Y$ is affine. By Lemma \ref{spaces-pushouts-lemma-reduce-to-scheme-source}
...
\source{stacks:0GFX}
\href{https://stacks.math.columbia.edu/tag/0GFX}{\texttt{Stacks tag 0GFX}}
\group{spaces-pushouts}
...
\begin{proof}
We have Lemma \ref{spaces-pushouts-lemma-glue-etale-sheaf-proper-surjective}
...
\source{stacks:0GFY}
\href{https://stacks.math.columbia.edu/tag/0GFY}{\texttt{Stacks tag 0GFY}}
\group{spaces-pushouts}
...
$$
\begin{array}{cc}E \underset{g}{\downarrow}\underset{j}{\longrightarrow} & Y' \overset{f}{\downarrow} \\ Z \overset{i}{\longrightarrow} & Y\end{array}
$$
...
because then we can use Lemma \ref{spaces-pushouts-lemma-glue-etale-sheaf-proper-surjective}
...
\section{Descending \'etale morphisms of algebraic spaces}
\label{spaces-pushouts-section-descending-etale}
In this section we combine the glueing results for \'etale sheaves given in
Section \ref{spaces-pushouts-section-glueing-etale} with the flexibility of algebraic spaces
to get some descent statements for \'etale morphisms of algebraic spaces.

\begin{lemma}[Descend etale proper surjective]
\label{spaces-pushouts-lemma-descend-etale-proper-surjective}
\source{stacks:0GG0}
\href{https://stacks.math.columbia.edu/tag/0GG0}{\texttt{Stacks tag 0GG0}}
\group{spaces-pushouts}
...
By Lemma \ref{spaces-pushouts-lemma-glue-etale-sheaf-proper-surjective}
...
\begin{lemma}[Glue etale space modification]
\label{spaces-pushouts-lemma-glue-etale-space-modification}
\source{stacks:0GG1}
\href{https://stacks.math.columbia.edu/tag/0GG1}{\texttt{Stacks tag 0GG1}}
\group{spaces-pushouts}
...
sheaves on $E$.
By Lemma \ref{spaces-pushouts-lemma-glue-etale-sheaf-modification}
...
\begin{lemma}[Pushout along thickening schemes]
\label{spaces-pushouts-lemma-pushout-along-thickening-schemes}
\source{stacks:07SY}
\href{https://stacks.math.columbia.edu/tag/07SY}{\texttt{Stacks tag 07SY}}
\group{spaces-pushouts}
...
\begin{proof}
This is an immediate consequence of Lemma \ref{spaces-pushouts-lemma-colimit-agrees} and
...
\begin{lemma}[Pushout along thickening]
\label{spaces-pushouts-lemma-pushout-along-thickening}
\source{stacks:07VX}
\href{https://stacks.math.columbia.edu/tag/07VX}{\texttt{Stacks tag 07VX}}
\group{spaces-pushouts}
...
$$
\begin{array}{cc}X \longrightarrow\underset{f}{\downarrow} & X' \overset{f'}{\downarrow} \\ Y \longrightarrow & Y \amalg_X X'\end{array}
$$
...
$$
\begin{array}{cc}U \times_X U \downarrow\longrightarrow & U' \times_{X'} U' \downarrow \\ V \times_Y V \longrightarrow & R'\end{array}
$$
...
(details omitted). At this point we set $Y' = V'/R'$, see
...
$$
\begin{array}{cc}X \longrightarrow\underset{f}{\downarrow} & X' \overset{f'}{\downarrow} \\ Y \longrightarrow & Y'\end{array}
$$
...
algebraic spaces. By
Lemma \ref{spaces-pushouts-lemma-pushout-along-thickening-schemes}
we obtain a unique morphism $h : V' \to Z$ fitting into the commutative
diagrams
$$
\vcenter{
\begin{array}{cc}U' \downarrow\longrightarrow & V' \overset{h}{\downarrow} \\ X' \overset{a'}{\longrightarrow} & Z\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}V \longrightarrow\downarrow & V' \overset{h}{\downarrow} \\ Y \overset{b}{\longrightarrow} & Z\end{array}
}
$$
...
\begin{lemma}[Categories spaces over pushout]
\label{spaces-pushouts-lemma-categories-spaces-over-pushout}
\source{stacks:07VY}
\href{https://stacks.math.columbia.edu/tag/07VY}{\texttt{Stacks tag 07VY}}
\group{spaces-pushouts}

Let $S$ be a base scheme. Let $X \to X'$ be a thickening of algebraic spaces
over $S$ and let $X \to Y$ be an affine morphism of algebraic spaces over $S$.
Let $Y' = Y \amalg_X X'$ be the pushout (see
Lemma \ref{spaces-pushouts-lemma-pushout-along-thickening}). Base change gives a functor
$$
F :
(\textit{Spaces}/Y')
\longrightarrow
...
Hence we can apply Lemma \ref{spaces-pushouts-lemma-pushout-along-thickening}
...
More on Morphisms, Lemma \ref{more-morphisms-lemma-pushout-along-thickening}.
By Lemma \ref{spaces-pushouts-lemma-pushout-along-thickening-schemes}
...
\source{stacks:07VZ}
\href{https://stacks.math.columbia.edu/tag/07VZ}{\texttt{Stacks tag 07VZ}}
\group{spaces-pushouts}

Let $S$ be a scheme. Let
$$
\begin{array}{ccc}A \longrightarrow\downarrow & C \downarrow\longrightarrow & E \downarrow \\ B \longrightarrow & D \longrightarrow & F\end{array}
$$
...
\begin{lemma}[Equivalence categories spaces over pushout]
\label{spaces-pushouts-lemma-equivalence-categories-spaces-over-pushout}
\source{stacks:07W0}
\href{https://stacks.math.columbia.edu/tag/07W0}{\texttt{Stacks tag 07W0}}
\group{spaces-pushouts}

In the situation of Lemma \ref{spaces-pushouts-lemma-categories-spaces-over-pushout}
...
schemes. In the proof of Lemma \ref{spaces-pushouts-lemma-pushout-along-thickening}
we constructed
...
\label{equation-cube}
\vcenter{
\begin{array}{cccc} & X \longrightarrow\downarrow &  & X' \downarrow \\ X_1 \longrightarrow\downarrow\nearrow &  & X_1' \downarrow\nearrow &  \\  & Y \longrightarrow &  & Y' \\ Y_1 \longrightarrow\nearrow &  & Y_1' \nearrow & \end{array}
}
\end{equation}
...
$$
\begin{array}{cc}(\Sch/Y_1') \underset{F_1}{\longrightarrow}\downarrow & (\Sch/Y_1) \times_{(\Sch/Y_1')} (\Sch/X_1') \downarrow\underset{G_1}{\longleftarrow} \\ (\textit{Spaces}/Y') \underset{F}{\longrightarrow} & (\textit{Spaces}/Y) \times_{(\textit{Spaces}/Y')} (\textit{Spaces}/X')
\underset{G}{\longleftarrow}\end{array}
$$
...
spaces of Lemma \ref{spaces-pushouts-lemma-pushout-along-thickening-schemes}.
...
Lemma \ref{spaces-pushouts-lemma-pushout-along-thickening} we constructed
...
\vcenter{
\begin{array}{cccc} & U \longrightarrow\downarrow &  & U' \downarrow \\ U_1 \longrightarrow\downarrow\nearrow &  & U_1' \downarrow\nearrow &  \\  & V \longrightarrow &  & G(V, U', \varphi) \\ V_1 \longrightarrow\nearrow &  & G_1(V_1, U_1', \varphi_1) \nearrow & \end{array}
}
\end{equation}
where all squares except the front and back squares are cartesian
(the front and back squares are pushouts) and the northeast arrows
...
and Lemma \ref{spaces-pushouts-lemma-diagram}
we see that
...
\begin{lemma}[Space over pushout flat modules]
\label{spaces-pushouts-lemma-space-over-pushout-flat-modules}
\source{stacks:08KV}
\href{https://stacks.math.columbia.edu/tag/08KV}{\texttt{Stacks tag 08KV}}
\group{spaces-pushouts}
...
(see Lemma \ref{spaces-pushouts-lemma-pushout-along-thickening}).
...
\begin{lemma}[Equivalence categories spaces pushout flat]
\label{spaces-pushouts-lemma-equivalence-categories-spaces-pushout-flat}
\source{stacks:07W3}
\href{https://stacks.math.columbia.edu/tag/07W3}{\texttt{Stacks tag 07W3}}
\group{spaces-pushouts}

In the situation of
Lemma \ref{spaces-pushouts-lemma-equivalence-categories-spaces-over-pushout}.
...
as constructed in Lemma \ref{spaces-pushouts-lemma-pushout-along-thickening}) shows that
...
\source{stacks:0EDP}
\href{https://stacks.math.columbia.edu/tag/0EDP}{\texttt{Stacks tag 0EDP}}
\group{spaces-pushouts}
...
\begin{proof}
This is a consequence of Lemma \ref{spaces-pushouts-lemma-colimit-agrees}, the proposition
...
Conditions (1) and (2) of Lemma \ref{spaces-pushouts-lemma-colimit-agrees}
...
\begin{lemma}[Pushout along thickening derived]
\label{spaces-pushouts-lemma-pushout-along-thickening-derived}
\source{stacks:0DL7}
\href{https://stacks.math.columbia.edu/tag/0DL7}{\texttt{Stacks tag 0DL7}}
\group{spaces-pushouts}
...
as in Lemma \ref{spaces-pushouts-lemma-pushout-along-thickening}.
...
$$
\begin{array}{cc}B & B' \longleftarrow \\ A \uparrow & A' \longleftarrow\uparrow\end{array}
$$
...
\begin{lemma}[Elementary distinguished square pushout]
\label{spaces-pushouts-lemma-elementary-distinguished-square-pushout}
\source{stacks:0DVI}
\href{https://stacks.math.columbia.edu/tag/0DVI}{\texttt{Stacks tag 0DVI}}
\group{spaces-pushouts}

Let $S$ be a scheme. Let $(U \subset W, f : V \to W)$ be
an elementary distinguished square. Then
$$
\begin{array}{cc}U \times_W V \longrightarrow\downarrow & V \overset{f}{\downarrow} \\ U \longrightarrow & W\end{array}
$$
...
\begin{lemma}[Construct elementary distinguished square]
\label{spaces-pushouts-lemma-construct-elementary-distinguished-square}
\source{stacks:0DVJ}
\href{https://stacks.math.columbia.edu/tag/0DVJ}{\texttt{Stacks tag 0DVJ}}
\group{spaces-pushouts}
...
Then there exists a pushout
$$
\begin{array}{cc}V' \longrightarrow\downarrow & V \overset{f}{\downarrow} \\ U \longrightarrow & W\end{array}
$$
...
Lemma \ref{spaces-pushouts-lemma-elementary-distinguished-square-pushout} tells us to take
$$
...
Lemma \ref{spaces-pushouts-lemma-elementary-distinguished-square-pushout}
...
\begin{lemma}[Stalk pushforward with support]
\label{spaces-pushouts-lemma-stalk-pushforward-with-support}
\source{stacks:0AEQ}
\href{https://stacks.math.columbia.edu/tag/0AEQ}{\texttt{Stacks tag 0AEQ}}
\group{spaces-pushouts}
...
$$
\begin{array}{cc}f^{-1}Z \underset{i'}{\longrightarrow}\underset{f'}{\downarrow} & Y \underset{f}{\downarrow} \\ Z \overset{i}{\longrightarrow} & X\end{array}
$$
...
\begin{lemma}[Stalk formal glueing]
\label{spaces-pushouts-lemma-stalk-formal-glueing}
\source{stacks:0AER}
\href{https://stacks.math.columbia.edu/tag/0AER}{\texttt{Stacks tag 0AER}}
\group{spaces-pushouts}
...
Lemma \ref{spaces-pushouts-lemma-stalk-pushforward-with-support}.
\end{proof}

\begin{lemma}[Stalk of pushforward]
\label{spaces-pushouts-lemma-stalk-of-pushforward}
\source{stacks:0AES}
\href{https://stacks.math.columbia.edu/tag/0AES}{\texttt{Stacks tag 0AES}}
\group{spaces-pushouts}
...
\begin{lemma}[Stalk of module with support]
\label{spaces-pushouts-lemma-stalk-of-module-with-support}
\source{stacks:0AET}
\href{https://stacks.math.columbia.edu/tag/0AET}{\texttt{Stacks tag 0AET}}
\group{spaces-pushouts}
...
\begin{lemma}[Formal glueing on closed]
\label{spaces-pushouts-lemma-formal-glueing-on-closed}
\source{stacks:0AEU}
\href{https://stacks.math.columbia.edu/tag/0AEU}{\texttt{Stacks tag 0AEU}}
\group{spaces-pushouts}
...
By Lemma \ref{spaces-pushouts-lemma-stalk-pushforward-with-support} we have
...
torsion by Lemma \ref{spaces-pushouts-lemma-stalk-of-module-with-support} applied to $Q$ on $Y$.
...
\begin{definition}[Situation: Formal glueing]
\label{spaces-pushouts-situation-formal-glueing}
\source{stacks:0AEV}
\href{https://stacks.math.columbia.edu/tag/0AEV}{\texttt{Stacks tag 0AEV}}
\group{spaces-pushouts}
...
Picture
$$
\begin{array}{cc}V \underset{j'}{\longrightarrow}\underset{f|_V}{\downarrow} & Y \overset{f}{\downarrow} \\ U \overset{j}{\longrightarrow} & X\end{array}
$$
\end{definition}

In Situation \ref{spaces-pushouts-situation-formal-glueing} we define
...
\source{stacks:0AEY}
\href{https://stacks.math.columbia.edu/tag/0AEY}{\texttt{Stacks tag 0AEY}}
\group{spaces-pushouts}

In Situation \ref{spaces-pushouts-situation-formal-glueing}.
...
\begin{lemma}[Reverse commutes with flat base change]
\label{spaces-pushouts-lemma-reverse-commutes-with-flat-base-change}
\source{stacks:0AEZ}
\href{https://stacks.math.columbia.edu/tag/0AEZ}{\texttt{Stacks tag 0AEZ}}
\group{spaces-pushouts}
...
\begin{proposition}[Formal glueing modules]
\label{spaces-pushouts-proposition-formal-glueing-modules}
\source{stacks:0AF0}
\href{https://stacks.math.columbia.edu/tag/0AF0}{\texttt{Stacks tag 0AF0}}
\group{spaces-pushouts}

In Situation \ref{spaces-pushouts-situation-formal-glueing} the functor
...
By Lemma \ref{spaces-pushouts-lemma-stalk-formal-glueing}
...
$$
\begin{array}{cc}\QCoh(\mathcal{O}_X) \underset{(\ref{equation-formal-glueing-modules})}{\longrightarrow}\downarrow & \QCoh(Y \to X, Z) \downarrow\overset{(\ref{equation-reverse})}{\longleftarrow} \\ \text{Mod}_{\mathcal{O}_{X, \overline{x}}} \overset{\text{Can}}{\longrightarrow} & \text{Glue}(\mathcal{O}_{X, \overline{x}} \to \mathcal{O}_{Y, \overline{y}},
f_1, \ldots, f_t) \underset{H^0}{\longleftarrow}\end{array}
$$
...
Lemma \ref{spaces-pushouts-lemma-stalk-of-pushforward} implies that
...
\begin{lemma}[Derived equivalent]
\label{spaces-pushouts-lemma-derived-equivalent}
\source{stacks:0AFJ}
\href{https://stacks.math.columbia.edu/tag/0AFJ}{\texttt{Stacks tag 0AFJ}}
\group{spaces-pushouts}
...
In Lemma \ref{spaces-pushouts-lemma-formal-glueing-on-closed} we have seen that
...
\begin{lemma}[Dominate by fpqc covering]
\label{spaces-pushouts-lemma-dominate-by-fpqc-covering}
\source{stacks:0AF1}
\href{https://stacks.math.columbia.edu/tag/0AF1}{\texttt{Stacks tag 0AF1}}
\group{spaces-pushouts}

In Situation \ref{spaces-pushouts-situation-formal-glueing} there exists an
...
In Situation \ref{spaces-pushouts-situation-formal-glueing} we consider the category
$\textit{Spaces}(Y \to X, Z)$
of commutative diagrams of algebraic spaces over $S$ of the form
$$
\begin{array}{ccc}U' \downarrow & V' \longleftarrow\downarrow\longrightarrow & Y' \downarrow \\ U & V \longleftarrow\longrightarrow & Y\end{array}
$$
...
\begin{lemma}[Equivalence on affine]
\label{spaces-pushouts-lemma-equivalence-on-affine}
\source{stacks:0AF4}
\href{https://stacks.math.columbia.edu/tag/0AF4}{\texttt{Stacks tag 0AF4}}
\group{spaces-pushouts}
...
lemma follows from Proposition \ref{spaces-pushouts-proposition-formal-glueing-modules}.
...
Lemma \ref{spaces-pushouts-lemma-dominate-by-fpqc-covering}
...
\begin{lemma}[Reflects isomorphisms]
\label{spaces-pushouts-lemma-reflects-isomorphisms}
\source{stacks:0AF5}
\href{https://stacks.math.columbia.edu/tag/0AF5}{\texttt{Stacks tag 0AF5}}
\group{spaces-pushouts}
...
an fpqc covering by Lemma \ref{spaces-pushouts-lemma-dominate-by-fpqc-covering}.
Hence the result follows from
Descent on Spaces, Lemma
\ref{spaces-descent-lemma-descending-property-isomorphism}.
\end{proof}

\begin{lemma}[Fully faithful on separated]
\label{spaces-pushouts-lemma-fully-faithful-on-separated}
\source{stacks:0AF6}
\href{https://stacks.math.columbia.edu/tag/0AF6}{\texttt{Stacks tag 0AF6}}
\group{spaces-pushouts}
...
by applying Lemmas \ref{spaces-pushouts-lemma-equivalence-on-affine} and
\ref{spaces-pushouts-lemma-reflects-isomorphisms}.
\end{proof}
...
$$
\begin{array}{ccc}V \downarrow & V' \longleftarrow\downarrow\longrightarrow & Y' \downarrow \\ U & U' \longleftarrow\longrightarrow & X'\end{array}
$$
...
\begin{lemma}[Glueable]
\label{spaces-pushouts-lemma-glueable}
\source{stacks:0F9P}
\href{https://stacks.math.columbia.edu/tag/0F9P}{\texttt{Stacks tag 0F9P}}
\group{spaces-pushouts}
...
if the equivalent conditions of Lemma \ref{spaces-pushouts-lemma-glueable}
are satisfied.

\begin{lemma}[Glueing affines]
\label{spaces-pushouts-lemma-glueing-affines}
\source{stacks:0F9Q}
\href{https://stacks.math.columbia.edu/tag/0F9Q}{\texttt{Stacks tag 0F9Q}}
\group{spaces-pushouts}
...
\begin{lemma}[Glueing affines etale]
\label{spaces-pushouts-lemma-glueing-affines-etale}
\source{stacks:0F9R}
\href{https://stacks.math.columbia.edu/tag/0F9R}{\texttt{Stacks tag 0F9R}}
\group{spaces-pushouts}
...
Under the equivalence of Lemma \ref{spaces-pushouts-lemma-glueing-affines}
...
\begin{lemma}[Glueing f]
\label{spaces-pushouts-lemma-glueing-f}
\source{stacks:0F9S}
\href{https://stacks.math.columbia.edu/tag/0F9S}{\texttt{Stacks tag 0F9S}}
\group{spaces-pushouts}
...
\begin{lemma}[Glueing ff]
\label{spaces-pushouts-lemma-glueing-ff}
\source{stacks:0F9T}
\href{https://stacks.math.columbia.edu/tag/0F9T}{\texttt{Stacks tag 0F9T}}
\group{spaces-pushouts}
...
By the faithfulness of Lemma \ref{spaces-pushouts-lemma-glueing-f}, it suffices to construct
...
Hence by Lemma \ref{spaces-pushouts-lemma-glueing-affines}
...
case (Lemma \ref{spaces-pushouts-lemma-glueing-affines}) we get a unique morphisms
$V \to W$ and $V \to Y$ agreeing with the first and second projection
morphisms over $U$ and $X'$ in the construction above.
By Lemma \ref{spaces-pushouts-lemma-glueing-affines-etale} the morphism $V \to Y$ is \'etale.
...
diagram
$$
\begin{array}{cc}X' \times_X V \longrightarrow\downarrow & X' \times_X W \downarrow \\ X' \times_X Y \longrightarrow & X' \times_X Z\end{array}
$$
...
\begin{lemma}[Glueing quasi affines]
\label{spaces-pushouts-lemma-glueing-quasi-affines}
\source{stacks:0F9U}
\href{https://stacks.math.columbia.edu/tag/0F9U}{\texttt{Stacks tag 0F9U}}
\group{spaces-pushouts}
...
Picture
$$
\begin{array}{ccccc} &  & T_1 \times_V V' \times_Y T' \swarrow\searrow &  &  \\ T_1 \downarrow & T_1 \times_V V' \longleftarrow\searrow &  & V' \times_{Y'} T' \longrightarrow\swarrow & T' \downarrow \\ V &  & V' \longrightarrow\longleftarrow &  & Y'\end{array}
$$
...
$\textit{Spaces}(U \leftarrow U' \to X')$.
By Lemma \ref{spaces-pushouts-lemma-glueing-affines}
...
\medskip\noindent
By Lemma \ref{spaces-pushouts-lemma-glueing-affines} there is an affine scheme $W$ whose
...
By Lemma \ref{spaces-pushouts-lemma-glueing-affines-etale}
...
\begin{lemma}[Coequalizer]
\label{spaces-pushouts-lemma-coequalizer}
\source{stacks:0AGG}
\href{https://stacks.math.columbia.edu/tag/0AGG}{\texttt{Stacks tag 0AGG}}
\group{spaces-pushouts}
...
Lemma \ref{spaces-pushouts-lemma-colimit-check-etale-locally}. Condition (1)
follows from Lemma \ref{spaces-pushouts-lemma-descend-etale-proper-surjective}
...
\begin{definition}[Situation: Coequalizer glue]
\label{spaces-pushouts-situation-coequalizer-glue}
\source{stacks:0AGH}
\href{https://stacks.math.columbia.edu/tag/0AGH}{\texttt{Stacks tag 0AGH}}
\group{spaces-pushouts}
...
\begin{lemma}[Coequalizer glue]
\label{spaces-pushouts-lemma-coequalizer-glue}
\source{stacks:0AGI}
\href{https://stacks.math.columbia.edu/tag/0AGI}{\texttt{Stacks tag 0AGI}}
\group{spaces-pushouts}

In Situation \ref{spaces-pushouts-situation-coequalizer-glue} let $Y = X' \amalg Z$ and
...
universal homeomorphism is a special case of Lemma \ref{spaces-pushouts-lemma-coequalizer}.
The formation of $X_1$ commutes with \'etale localization on $X$
(see proof of Lemma \ref{spaces-pushouts-lemma-coequalizer}).
Thus the morphism $X_1 \to X$ is an isomorphism over $U$.
It is immediate from the construction that $Z \to X$ lifts to $X_1$.
\end{proof}

In Situation \ref{spaces-pushouts-situation-coequalizer-glue} for $n \geq 1$ let
...
$$
\begin{array}{cccc}R_n \longrightarrow\longrightarrow & Y_n \longrightarrow & X_n \longrightarrow & X\end{array}
$$
as in Lemma \ref{spaces-pushouts-lemma-coequalizer-glue}. The maps $Y_n \to Y_{n + 1}$
...
\source{stacks:0AGK}
\href{https://stacks.math.columbia.edu/tag/0AGK}{\texttt{Stacks tag 0AGK}}
\group{spaces-pushouts}

In Situation \ref{spaces-pushouts-situation-coequalizer-glue} assume $X$ quasi-compact.
...
\begin{array}{cc}f_*\mathcal{O}_{X'} \longrightarrow\longrightarrow & (f \times f)_*\mathcal{O}_{X' \times_X X'}\end{array}
)
$$
...
\mathcal{A}_n =
\text{Equalizer}(
\begin{array}{cc}\mathcal{A} \times \mathcal{O}_X/\mathcal{I}^n \longrightarrow\longrightarrow & f_{n, *}\mathcal{O}_{X' \times_X Z_n}\end{array}
)
$$
...
\begin{remark}[Essentially constant]
\label{spaces-pushouts-remark-essentially-constant}
\source{stacks:0AGL}
\href{https://stacks.math.columbia.edu/tag/0AGL}{\texttt{Stacks tag 0AGL}}
\group{spaces-pushouts}

The meaning of Lemma \ref{spaces-pushouts-lemma-essentially-constant}
...
\source{stacks:0F45}
\href{https://stacks.math.columbia.edu/tag/0F45}{\texttt{Stacks tag 0F45}}
\group{spaces-pushouts}
...
\source{stacks:0F46}
\href{https://stacks.math.columbia.edu/tag/0F46}{\texttt{Stacks tag 0F46}}
\group{spaces-pushouts}
...
\source{stacks:0F47}
\href{https://stacks.math.columbia.edu/tag/0F47}{\texttt{Stacks tag 0F47}}
\group{spaces-pushouts}
...
By Lemma \ref{spaces-pushouts-lemma-separate-disjoint-locally-closed-by-blowing-up}
...
\begin{lemma}[Blowup etale along]
\label{spaces-pushouts-lemma-blowup-etale-along}
\source{stacks:0F48}
\href{https://stacks.math.columbia.edu/tag/0F48}{\texttt{Stacks tag 0F48}}
\group{spaces-pushouts}

Let $S$ be a scheme. Consider a diagram
$$
\begin{array}{ccc}X \underset{f}{\downarrow} & U \longleftarrow\underset{f|_U}{\downarrow} & A \downarrow\longleftarrow \\ Y & V \longleftarrow & B \longleftarrow\end{array}
$$
...
$T_c \cap T'_c = \emptyset$ (see proof of Lemma \ref{spaces-pushouts-lemma-blowup-iso-along}).
By Lemma \ref{spaces-pushouts-lemma-separate-disjoint-locally-closed-by-blowing-up}
...
$$
\vcenter{
\begin{array}{ccc}X_1 \longrightarrow\searrow &  & X \swarrow \\  & Y & \end{array}
}
\quad\text{and the diagram}\quad
\vcenter{
\begin{array}{ccc}\overline{A}_1 \longrightarrow\searrow &  & \overline{A} \swarrow \\  & \overline{B} & \end{array}
}
$$
...
\source{stacks:0F49}
\href{https://stacks.math.columbia.edu/tag/0F49}{\texttt{Stacks tag 0F49}}
\group{spaces-pushouts}
...
\source{stacks:0F4A}
\href{https://stacks.math.columbia.edu/tag/0F4A}{\texttt{Stacks tag 0F4A}}
\group{spaces-pushouts}
...
Lemma \ref{spaces-pushouts-lemma-replaced-by-strict-transform}. Hence by
More on Morphisms of Spaces, Lemma
\ref{spaces-more-morphisms-lemma-zariski-after-blowup}
we may assume $Z \to Y$
...
\source{stacks:0F4B}
\href{https://stacks.math.columbia.edu/tag/0F4B}{\texttt{Stacks tag 0F4B}}
\group{spaces-pushouts}
...
Lemma \ref{spaces-pushouts-lemma-compactification-dominates}. Picture
$$
...
Lemma \ref{spaces-pushouts-lemma-separate-disjoint-locally-closed-by-blowing-up}.
...
the strict transform with respect to this blowing up, see
Lemma \ref{spaces-pushouts-lemma-replaced-by-strict-transform}.
...
$V_{12} = V_1 \times_U V_2$. By Lemma \ref{spaces-pushouts-lemma-blowup-iso-along}
...
Thus we may apply Lemma \ref{spaces-pushouts-lemma-blowup-etale-along} to the morphism
...
Lemma \ref{spaces-pushouts-lemma-construct-elementary-distinguished-square}.
Let us apply Lemma \ref{spaces-pushouts-lemma-check-separated}
...
$$
\begin{array}{ccc}A \dashrightarrow &  & A' \\ \mathcal{O}_{X_2, \overline{z}} \longrightarrow\uparrow & \mathcal{O}_{X_{12}, \overline{y}} \longrightarrow & \mathcal{O} \uparrow\end{array}
$$
...
\begin{lemma}[Filter Noetherian space]
\label{spaces-pushouts-lemma-filter-Noetherian-space}
\source{stacks:0F4C}
\href{https://stacks.math.columbia.edu/tag/0F4C}{\texttt{Stacks tag 0F4C}}
\group{spaces-pushouts}
...
\source{stacks:0F4D}
\href{https://stacks.math.columbia.edu/tag/0F4D}{\texttt{Stacks tag 0F4D}}
\group{spaces-pushouts}
...
Namely, by Lemma \ref{spaces-pushouts-lemma-filter-Noetherian-space}
