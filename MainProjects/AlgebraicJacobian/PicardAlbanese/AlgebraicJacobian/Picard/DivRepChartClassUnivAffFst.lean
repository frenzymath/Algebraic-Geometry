...
/-! # The first universal widened window at an arbitrary classifier test -/
...
noncomputable local instance instOverCleftDivRepChartClassUnivAffFst :
...
-- The quotient equality is extracted before the first compiled window comparison is applied.
set_option synthInstance.maxHeartbeats 800000 in
set_option backward.isDefEq.respectTransparency true in
/-- The classifier hypothesis identifies the first intrinsic epsilon window with the mapped
