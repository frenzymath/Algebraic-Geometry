...
\lb{fig1}
The proof interpolates Gross--Zagier formulas across representations and
quadruples in a Hida family. Known formulas on a dense set of trivial-weight
specializations extend to the universal formula, and multiplicity one
propagates the result across each family.
\end{remark}
