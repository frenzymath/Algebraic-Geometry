% Source-derived chapter 08: Proof of Theorems~\ref{ThmBdRatIntro}, \ref{ThmBdFinRank}, and \ref{thm:BdTorIntroNF}
% Original source: uniformity-mordell-lang-curves
\chapter{Proof of Theorems~\ref{ThmBdRatIntro}, \ref{ThmBdFinRank}, and \ref{thm:BdTorIntroNF}}
\label{uniformity-mordell-lang-curves-chapter-08}
\source{uniformity-mordell-lang-curves}

\begin{remark}[Source section]
\label{uniformity-mordell-lang-curves-chapter-08-source}
\source{uniformity-mordell-lang-curves}
\source{uniformity-mordell-lang-curves}
...
% The source section title was: Proof of Theorems~\ref{ThmBdRatIntro}, \ref{ThmBdFinRank}, and \ref{thm:BdTorIntroNF}
\label{SectionRatPt}
\source{uniformity-mordell-lang-curves}
...
\end{proof}
\begin{remark}
\label{src-uniformity-mordell-lang-curves-ch08-proof-of-theorems-thmbdratintro-thmbdfinrank-and-thm-bdtorintronf-statement-1}
\source{uniformity-mordell-lang-curves}
\notready
