...
\end{definition}
\begin{remark}
\label{src-standard-conjectures-abelian-fourfolds-ch11-characterization-of-p-adic-periods-statement-1}
\source{standard-conjectures-abelian-fourfolds}
\notready
...
\end{proof}
\begin{remark}
\label{src-standard-conjectures-abelian-fourfolds-ch11-characterization-of-p-adic-periods-statement-2}
\source{standard-conjectures-abelian-fourfolds}
\notready  
