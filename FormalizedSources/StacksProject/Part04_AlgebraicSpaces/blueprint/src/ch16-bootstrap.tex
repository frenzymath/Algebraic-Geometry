...
\begin{definition}[Morphism representable by spaces]
\label{bootstrap-definition-morphism-representable-by-spaces}
\source{stacks:02YQ}
\href{https://stacks.math.columbia.edu/tag/02YQ}{\texttt{Stacks tag 02YQ}}
\group{bootstrap}
...
\begin{lemma}[Morphism spaces is representable by spaces]
\label{bootstrap-lemma-morphism-spaces-is-representable-by-spaces}
\source{stacks:03BN}
\href{https://stacks.math.columbia.edu/tag/03BN}{\texttt{Stacks tag 03BN}}
\group{bootstrap}
...
\begin{lemma}[A base change of a representable by algebraic spaces morphism of presheaves is represen...]
\label{bootstrap-lemma-base-change-transformation}
\source{stacks:03Y0}
\href{https://stacks.math.columbia.edu/tag/03Y0}{\texttt{Stacks tag 03Y0}}
\group{bootstrap}


Let $S$ be a scheme. Let
$$
\begin{array}{cc}G' \times_G F \longrightarrow\overset{a'}{\downarrow} & F \overset{a}{\downarrow} \\ G' \longrightarrow & G\end{array}
$$
...
\begin{lemma}[Representable by spaces transformation to sheaf]
\label{bootstrap-lemma-representable-by-spaces-transformation-to-sheaf}
\source{stacks:02YR}
\href{https://stacks.math.columbia.edu/tag/02YR}{\texttt{Stacks tag 02YR}}
\group{bootstrap}
...
\begin{lemma}[Representable by spaces transformation diagonal]
\label{bootstrap-lemma-representable-by-spaces-transformation-diagonal}
\source{stacks:05LA}
\href{https://stacks.math.columbia.edu/tag/05LA}{\texttt{Stacks tag 05LA}}
\group{bootstrap}
...
The proof of
Lemma \ref{bootstrap-lemma-representable-by-spaces-over-space}
...
\begin{lemma}[Representable by spaces over space]
\label{bootstrap-lemma-representable-by-spaces-over-space}
\source{stacks:02YS}
\href{https://stacks.math.columbia.edu/tag/02YS}{\texttt{Stacks tag 02YS}}
\group{bootstrap}
...
\begin{proof}
\uses{bootstrap-lemma-representable-by-spaces-transformation-to-sheaf}

We have seen in
Lemma \ref{bootstrap-lemma-representable-by-spaces-transformation-to-sheaf}
that $F$ is a sheaf.
...
\begin{lemma}[Representable by spaces]
\label{bootstrap-lemma-representable-by-spaces}
\source{stacks:03XY}
\href{https://stacks.math.columbia.edu/tag/03XY}{\texttt{Stacks tag 03XY}}
\group{bootstrap}
...
\begin{proof}
\uses{bootstrap-lemma-base-change-transformation, bootstrap-lemma-representable-by-spaces-over-space}

By Lemma \ref{bootstrap-lemma-base-change-transformation} the transformation
$X \times_G F \to X$ is representable by algebraic spaces. Hence it is
an algebraic space by
Lemma \ref{bootstrap-lemma-representable-by-spaces-over-space}.
\end{proof}

\begin{lemma}[Composition transformation]
\label{bootstrap-lemma-composition-transformation}
\source{stacks:03Y1}
\href{https://stacks.math.columbia.edu/tag/03Y1}{\texttt{Stacks tag 03Y1}}
\group{bootstrap}

Let $S$ be a scheme.
Let
$$
\begin{array}{ccc}F \overset{a}{\longrightarrow} & G \overset{b}{\longrightarrow} & H\end{array}
$$
...
\begin{proof}
\uses{bootstrap-lemma-composition-transformation, bootstrap-lemma-base-change-transformation}
...
consequence of Lemmas \ref{bootstrap-lemma-composition-transformation}
and \ref{bootstrap-lemma-base-change-transformation}.
\end{proof}

\begin{lemma}[Representable by spaces permanence]
\label{bootstrap-lemma-representable-by-spaces-permanence}
\source{stacks:0AMN}
\href{https://stacks.math.columbia.edu/tag/0AMN}{\texttt{Stacks tag 0AMN}}
\group{bootstrap}
...
$$
Hence the result using Lemma \ref{bootstrap-lemma-representable-by-spaces}.
\end{proof}

\begin{lemma}[Glueing sheaves]
\label{bootstrap-lemma-glueing-sheaves}
\source{stacks:07WE}
\href{https://stacks.math.columbia.edu/tag/07WE}{\texttt{Stacks tag 07WE}}
\group{bootstrap}
...
(2)(c) we may refine the covering and assume that $s_j \in F_{\alpha(j)}(T_j)$
...
\begin{definition}[Property transformation]
\label{bootstrap-definition-property-transformation}
\source{stacks:03XZ}
\href{https://stacks.math.columbia.edu/tag/03XZ}{\texttt{Stacks tag 03XZ}}
\group{bootstrap}
...
Lemma \ref{bootstrap-lemma-morphism-spaces-is-representable-by-spaces}
...
\begin{lemma}[Base change transformation property]
\label{bootstrap-lemma-base-change-transformation-property}
\source{stacks:046F}
\href{https://stacks.math.columbia.edu/tag/046F}{\texttt{Stacks tag 046F}}
\group{bootstrap}

\uses{bootstrap-definition-property-transformation}
Let $S$ be a scheme.
Let $\mathcal{P}$ be a property as in
Definition \ref{bootstrap-definition-property-transformation}.
Let
$$
\begin{array}{cc}G' \times_G F \longrightarrow\overset{a'}{\downarrow} & F \overset{a}{\downarrow} \\ G' \longrightarrow & G\end{array}
$$
...
\begin{lemma}[Composition transformation property]
\label{bootstrap-lemma-composition-transformation-property}
\source{stacks:046G}
\href{https://stacks.math.columbia.edu/tag/046G}{\texttt{Stacks tag 046G}}
\group{bootstrap}
...
\begin{proof}
\uses{bootstrap-lemma-composition-transformation}

Omitted. Hint: See
Lemma \ref{bootstrap-lemma-composition-transformation}
and use stability under composition.
\end{proof}

\begin{lemma}[Product transformations property]
\label{bootstrap-lemma-product-transformations-property}
\source{stacks:046H}
\href{https://stacks.math.columbia.edu/tag/046H}{\texttt{Stacks tag 046H}}
\group{bootstrap}
...
\begin{proof}
\uses{bootstrap-lemma-product-transformations}

Note that the lemma makes sense by
Lemma \ref{bootstrap-lemma-product-transformations}.
Proof omitted.
\end{proof}

\begin{lemma}[Transformations property implication]
\label{bootstrap-lemma-transformations-property-implication}
\source{stacks:0AM1}
\href{https://stacks.math.columbia.edu/tag/0AM1}{\texttt{Stacks tag 0AM1}}
\group{bootstrap}
...
\source{stacks:04S1}
\href{https://stacks.math.columbia.edu/tag/04S1}{\texttt{Stacks tag 04S1}}
\group{bootstrap}
...
Lemma \ref{bootstrap-lemma-bootstrap-diagonal}.

\begin{lemma}[The diagonal of a presheaf is representable by algebraic spaces if and only if every ma...]
\label{bootstrap-lemma-representable-diagonal}
\source{stacks:03Y2}
\href{https://stacks.math.columbia.edu/tag/03Y2}{\texttt{Stacks tag 03Y2}}
\group{bootstrap}
...
\begin{lemma}[After fppf sep lqf]
\label{bootstrap-lemma-after-fppf-sep-lqf}
\source{stacks:046J}
\href{https://stacks.math.columbia.edu/tag/046J}{\texttt{Stacks tag 046J}}
\group{bootstrap}

Let $S$ be a scheme.
Let
$$
\begin{array}{cc}E \underset{a}{\longrightarrow}\underset{f}{\downarrow} & F \overset{g}{\downarrow} \\ H \overset{b}{\longrightarrow} & G\end{array}
$$
...
\begin{proof}
\uses{bootstrap-lemma-composition-transformation, bootstrap-lemma-base-change-transformation-property}
...
Lemma \ref{bootstrap-lemma-base-change-transformation-property}). Hence we
...
\begin{lemma}[Bootstrap diagonal]
\label{bootstrap-lemma-bootstrap-diagonal}
\source{stacks:046K}
\href{https://stacks.math.columbia.edu/tag/046K}{\texttt{Stacks tag 046K}}
\group{bootstrap}
...
\begin{proof}
\uses{bootstrap-lemma-composition-transformation-property, bootstrap-lemma-representable-by-spaces, bootstrap-lemma-base-change-transformation-property, bootstrap-lemma-product-transformations-property, bootstrap-lemma-after-fppf-sep-lqf}
...
\ref{spaces-morphisms-lemma-etale-locally-finite-presentation}.
By
Lemma \ref{bootstrap-lemma-composition-transformation-property}
...
Lemma \ref{bootstrap-lemma-base-change-transformation-property}.
...
locally of finite presentation by
Lemma \ref{bootstrap-lemma-product-transformations-property}.
...
Hence we may apply
Lemma \ref{bootstrap-lemma-after-fppf-sep-lqf}
to the diagram
$$
\begin{array}{cc}Z' \longrightarrow\downarrow & T' \downarrow \\ Z \longrightarrow & T\end{array}
$$
and we conclude.
\end{proof}
...
\begin{lemma}[Bootstrap locally quasi finite]
\label{bootstrap-lemma-bootstrap-locally-quasi-finite}
\source{stacks:0AHV}
\href{https://stacks.math.columbia.edu/tag/0AHV}{\texttt{Stacks tag 0AHV}}
\group{bootstrap}
...
Theorem \ref{bootstrap-theorem-final-bootstrap}.
...
\source{stacks:03Y3}
\href{https://stacks.math.columbia.edu/tag/03Y3}{\texttt{Stacks tag 03Y3}}
\group{bootstrap}
...
\begin{proof}
\uses{bootstrap-definition-property-transformation, bootstrap-lemma-representable-diagonal, bootstrap-lemma-composition-transformation, bootstrap-lemma-bootstrap-diagonal, bootstrap-lemma-base-change-transformation-property, bootstrap-lemma-representable-by-spaces-over-space, bootstrap-lemma-surjective-flat-locally-finite-presentation}
...
By Lemma \ref{bootstrap-lemma-representable-diagonal} the morphism
...
Let $U \to X$ be a surjective \'etale morphism from a scheme towards $X$.
By Lemma \ref{bootstrap-lemma-composition-transformation} the transformation
...
and \'etale (Lemma \ref{bootstrap-lemma-base-change-transformation-property}).
...
Lemma \ref{bootstrap-lemma-surjective-flat-locally-finite-presentation}
...
\begin{lemma}[Better finding opens]
\label{bootstrap-lemma-better-finding-opens}
\source{stacks:046M}
\href{https://stacks.math.columbia.edu/tag/046M}{\texttt{Stacks tag 046M}}
\group{bootstrap}
...
\begin{lemma}[Slice equivalence relation]
\label{bootstrap-lemma-slice-equivalence-relation}
\source{stacks:0489}
\href{https://stacks.math.columbia.edu/tag/0489}{\texttt{Stacks tag 0489}}
\group{bootstrap}
...
$$
\begin{array}{cccc}t^{-1}(U') \xlongequal{} & U' \times_{g, U, t} R \underset{\text{pr}_1}{\longrightarrow}\overset{h}{\longrightarrow} & R \underset{s}{\longrightarrow} & U\end{array}
$$
...
\begin{lemma}[Divide subgroupoid]
\label{bootstrap-lemma-divide-subgroupoid}
\source{stacks:04S4}
\href{https://stacks.math.columbia.edu/tag/04S4}{\texttt{Stacks tag 04S4}}
\group{bootstrap}
...
\begin{theorem}[Final bootstrap]
\label{bootstrap-theorem-final-bootstrap}
\source{stacks:04S6}
\href{https://stacks.math.columbia.edu/tag/04S6}{\texttt{Stacks tag 04S6}}
\group{bootstrap}
...
\begin{proof}
\uses{bootstrap-lemma-bootstrap-diagonal, bootstrap-lemma-surjective-flat-locally-finite-presentation, bootstrap-lemma-slice-equivalence-relation, bootstrap-lemma-better-finding-opens, bootstrap-lemma-divide-subgroupoid}
...
Lemma \ref{bootstrap-lemma-slice-equivalence-relation}
...
Lemma \ref{bootstrap-lemma-better-finding-opens}
(or the simpler
Spaces, Lemma \ref{spaces-lemma-finding-opens})
...
of $R$ over $u$. By
Lemma \ref{bootstrap-lemma-divide-subgroupoid}
...
\begin{lemma}[The definition of an algebraic space is fppf local.]
\label{bootstrap-lemma-locally-algebraic-space}
\source{stacks:04SK}
\href{https://stacks.math.columbia.edu/tag/04SK}{\texttt{Stacks tag 04SK}}
\group{bootstrap}
...
\begin{proof}
\uses{bootstrap-lemma-base-change-transformation-property, bootstrap-theorem-final-bootstrap}
...
Here is a special case of Lemma \ref{bootstrap-lemma-locally-algebraic-space}
where we do not need to worry about set theoretical issues.

\begin{lemma}[Locally algebraic space finite type]
\label{bootstrap-lemma-locally-algebraic-space-finite-type}
\source{stacks:04U0}
\href{https://stacks.math.columbia.edu/tag/04U0}{\texttt{Stacks tag 04U0}}
\group{bootstrap}
...
\begin{proof}
\uses{bootstrap-lemma-locally-algebraic-space}

We will use
Lemma \ref{bootstrap-lemma-locally-algebraic-space}
...
\begin{lemma}[Fppf descent data for algebraic spaces are effective.]
\label{bootstrap-lemma-descend-algebraic-space}
\source{stacks:0ADV}
\href{https://stacks.math.columbia.edu/tag/0ADV}{\texttt{Stacks tag 0ADV}}
\group{bootstrap}


\uses{bootstrap-lemma-locally-algebraic-space-finite-type}
...
Lemma \ref{bootstrap-lemma-locally-algebraic-space-finite-type}.}, then any
...
\begin{proof}
\uses{bootstrap-lemma-base-change-transformation, bootstrap-lemma-base-change-transformation-property, bootstrap-theorem-final-bootstrap, bootstrap-lemma-locally-algebraic-space-finite-type}
...
$\coprod X_i \to X$, see Lemma \ref{bootstrap-lemma-base-change-transformation}),
and surjective, flat, and locally of finite presentation
(as the base change of $\coprod X_i \to X$, see
Lemma \ref{bootstrap-lemma-base-change-transformation-property}).
Hence part (1) follows from Theorem \ref{bootstrap-theorem-final-bootstrap}.
...
By Theorem \ref{bootstrap-theorem-final-bootstrap} it suffices to show
...
space by Lemma \ref{bootstrap-lemma-locally-algebraic-space-finite-type}.
\end{proof}

Here is a different type of application.

\begin{lemma}[Representable by spaces cover]
\label{bootstrap-lemma-representable-by-spaces-cover}
\source{stacks:0AMP}
\href{https://stacks.math.columbia.edu/tag/0AMP}{\texttt{Stacks tag 0AMP}}
\group{bootstrap}
...
Lemma \ref{bootstrap-lemma-base-change-transformation-property}).
Thus the result follows from Theorem \ref{bootstrap-theorem-final-bootstrap}.
\end{proof}

\begin{lemma}[Quotient stack isom]
\label{bootstrap-lemma-quotient-stack-isom}
\source{stacks:04TB}
\href{https://stacks.math.columbia.edu/tag/04TB}{\texttt{Stacks tag 04TB}}
\group{bootstrap}
...
\begin{lemma}[Covering quotient]
\label{bootstrap-lemma-covering-quotient}
\source{stacks:06PG}
\href{https://stacks.math.columbia.edu/tag/06PG}{\texttt{Stacks tag 06PG}}
\group{bootstrap}
...
\begin{lemma}[Quotient free action]
\label{bootstrap-lemma-quotient-free-action}
\source{stacks:06PH}
\href{https://stacks.math.columbia.edu/tag/06PH}{\texttt{Stacks tag 06PH}}
\group{bootstrap}
...
\begin{proof}
\uses{bootstrap-theorem-final-bootstrap, bootstrap-lemma-covering-quotient}
...
locally of finite presentation by Lemma \ref{bootstrap-lemma-covering-quotient}.
...
\begin{lemma}[Descent torsor]
\label{bootstrap-lemma-descent-torsor}
\source{stacks:04U1}
\href{https://stacks.math.columbia.edu/tag/04U1}{\texttt{Stacks tag 04U1}}
\group{bootstrap}
...
\begin{lemma}[Spaces etale]
\label{bootstrap-lemma-spaces-etale}
\source{stacks:076M}
\href{https://stacks.math.columbia.edu/tag/076M}{\texttt{Stacks tag 076M}}
\group{bootstrap}
...
\begin{lemma}[Spaces etale locally representable]
\label{bootstrap-lemma-spaces-etale-locally-representable}
\source{stacks:0BH4}
\href{https://stacks.math.columbia.edu/tag/0BH4}{\texttt{Stacks tag 0BH4}}
\group{bootstrap}
...
presentation by Lemma \ref{bootstrap-lemma-covering-quotient}.
...
\begin{lemma}[Spaces etale smooth cover]
\label{bootstrap-lemma-spaces-etale-smooth-cover}
\source{stacks:07WF}
\href{https://stacks.math.columbia.edu/tag/07WF}{\texttt{Stacks tag 07WF}}
\group{bootstrap}
...
\begin{proof}
\uses{bootstrap-lemma-spaces-etale, bootstrap-theorem-final-bootstrap, bootstrap-lemma-covering-quotient}

The proof mirrors the proof of Lemma \ref{bootstrap-lemma-spaces-etale}. Let
...
By Theorem \ref{bootstrap-theorem-final-bootstrap} we see that $X = U/R$ (quotient
...
U \to F \to X.
$$
By Lemma \ref{bootstrap-lemma-covering-quotient} we see that $U \to X$ is
...
\begin{lemma}[Spaces smooth locally representable]
\label{bootstrap-lemma-spaces-smooth-locally-representable}
\source{stacks:0GE0}
\href{https://stacks.math.columbia.edu/tag/0GE0}{\texttt{Stacks tag 0GE0}}
\group{bootstrap}
...
\begin{proof}
\uses{bootstrap-lemma-spaces-etale-locally-representable, bootstrap-theorem-final-bootstrap, bootstrap-lemma-covering-quotient}

The proof is identical to the proof of
Lemma \ref{bootstrap-lemma-spaces-etale-locally-representable}.
Set $R = U \times_F U$. This is an algebraic space as $U \to F$ is assumed
representable by algebraic spaces. The projections $s, t : R \to U$ are
