...
Blueprint project under `FormalizedPapers/ModuliHiggsCharacter/CanonicalRepresentationsSurfaceGroups`.

- Blueprint: [`blueprint/src/content.tex`](blueprint/src/content.tex)
- Direct PDF: [arXiv PDF](https://arxiv.org/pdf/2205.15352)
