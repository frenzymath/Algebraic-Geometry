% Source-derived chapter 04: Intersection theory and height inequality on the total space
% Original source: uniformity-mordell-lang-curves
\chapter{Intersection theory and height inequality on the total space}
\label{uniformity-mordell-lang-curves-chapter-04}
\source{uniformity-mordell-lang-curves}

\begin{remark}[Source section]
\label{uniformity-mordell-lang-curves-chapter-04-source}
\source{uniformity-mordell-lang-curves}
\source{uniformity-mordell-lang-curves}
...
% The source section title was: Intersection theory and height inequality on the total space
\label{SectionIntThAndHtIneq}
\source{uniformity-mordell-lang-curves}
