...
\source{stacks:02OJ}
\href{https://stacks.math.columbia.edu/tag/02OJ}{\texttt{Stacks tag 02OJ}}
\group{divisors}
...
Example \ref{divisors-example-no-associated-prime}.
In the non-Noetherian case it may be more convenient to use weakly
associated points, see
Section \ref{divisors-section-weakly-associated}.
...
\begin{lemma}[Associated affine open]
\label{divisors-lemma-associated-affine-open}
\source{stacks:02OK}
\href{https://stacks.math.columbia.edu/tag/02OK}{\texttt{Stacks tag 02OK}}
\group{divisors}
...
\begin{lemma}[Ass support]
\label{divisors-lemma-ass-support}
\source{stacks:05AD}
\href{https://stacks.math.columbia.edu/tag/05AD}{\texttt{Stacks tag 05AD}}
\group{divisors}
...
\source{stacks:05AE}
\href{https://stacks.math.columbia.edu/tag/05AE}{\texttt{Stacks tag 05AE}}
\group{divisors}
...
\begin{lemma}[Finite ass]
\label{divisors-lemma-finite-ass}
\source{stacks:05AF}
\href{https://stacks.math.columbia.edu/tag/05AF}{\texttt{Stacks tag 05AF}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-associated-affine-open}
...
and finally use
Lemma \ref{divisors-lemma-associated-affine-open}.
\end{proof}

\begin{lemma}[Ass zero]
\label{divisors-lemma-ass-zero}
\source{stacks:05AG}
\href{https://stacks.math.columbia.edu/tag/05AG}{\texttt{Stacks tag 05AG}}
\group{divisors}
...
\begin{example}[No associated prime]
\label{divisors-example-no-associated-prime}
\source{stacks:05AI}
\href{https://stacks.math.columbia.edu/tag/05AI}{\texttt{Stacks tag 05AI}}
\group{divisors}
...
\begin{lemma}[Restriction injective open contains ass]
\label{divisors-lemma-restriction-injective-open-contains-ass}
\source{stacks:0B3L}
\href{https://stacks.math.columbia.edu/tag/0B3L}{\texttt{Stacks tag 0B3L}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-ses-ass, divisors-lemma-ass-support, divisors-lemma-ass-zero}
...
by Lemma \ref{divisors-lemma-ses-ass}. Since also
$\text{Ass}(\mathcal{F}') \subset \text{Supp}(\mathcal{F}')$
(Lemma \ref{divisors-lemma-ass-support}) we conclude
$\text{Ass}(\mathcal{F}') = \emptyset$.
Hence $\mathcal{F}' = 0$ by Lemma \ref{divisors-lemma-ass-zero}.
\end{proof}

\begin{lemma}[Minimal support in ass]
\label{divisors-lemma-minimal-support-in-ass}
\source{stacks:05AH}
\href{https://stacks.math.columbia.edu/tag/05AH}{\texttt{Stacks tag 05AH}}
\group{divisors}
...
\begin{lemma}[Check injective on ass]
\label{divisors-lemma-check-injective-on-ass}
\source{stacks:0AVL}
\href{https://stacks.math.columbia.edu/tag/0AVL}{\texttt{Stacks tag 0AVL}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-ass-zero}

The assumptions imply that $\text{Ass}(\Ker(\varphi)) = \emptyset$
and hence $\Ker(\varphi) = 0$ by Lemma \ref{divisors-lemma-ass-zero}.
\end{proof}

\begin{lemma}[Check isomorphism via depth and ass]
\label{divisors-lemma-check-isomorphism-via-depth-and-ass}
\source{stacks:0AVM}
\href{https://stacks.math.columbia.edu/tag/0AVM}{\texttt{Stacks tag 0AVM}}
\group{divisors}
...
\begin{lemma}[Bourbaki]
\label{divisors-lemma-bourbaki}
\source{stacks:05DB}
\href{https://stacks.math.columbia.edu/tag/05DB}{\texttt{Stacks tag 05DB}}
\group{divisors}
...
\begin{definition}[Embedded]
\label{divisors-definition-embedded}
\source{stacks:05AK}
\href{https://stacks.math.columbia.edu/tag/05AK}{\texttt{Stacks tag 05AK}}
\group{divisors}
...
\begin{lemma}[Embedded]
\label{divisors-lemma-embedded}
\source{stacks:05AL}
\href{https://stacks.math.columbia.edu/tag/05AL}{\texttt{Stacks tag 05AL}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-minimal-support-in-ass, divisors-lemma-ass-support}
...
Lemma \ref{divisors-lemma-minimal-support-in-ass}.
...
\begin{lemma}[S1 no embedded]
\label{divisors-lemma-S1-no-embedded}
\source{stacks:0346}
\href{https://stacks.math.columbia.edu/tag/0346}{\texttt{Stacks tag 0346}}
\group{divisors}
...
combined with Lemma \ref{divisors-lemma-associated-affine-open} above.
\end{proof}

\begin{lemma}[Noetherian dim 1 CM no embedded points]
\label{divisors-lemma-noetherian-dim-1-CM-no-embedded-points}
\source{stacks:0BXG}
\href{https://stacks.math.columbia.edu/tag/0BXG}{\texttt{Stacks tag 0BXG}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-S1-no-embedded}

Follows from Lemma \ref{divisors-lemma-S1-no-embedded} and the definitions.
\end{proof}

\begin{lemma}[Scheme theoretically dense contain embedded points]
\label{divisors-lemma-scheme-theoretically-dense-contain-embedded-points}
\source{stacks:083P}
\href{https://stacks.math.columbia.edu/tag/083P}{\texttt{Stacks tag 083P}}
\group{divisors}
...
\begin{lemma}[Remove embedded points]
\label{divisors-lemma-remove-embedded-points}
\source{stacks:02OL}
\href{https://stacks.math.columbia.edu/tag/02OL}{\texttt{Stacks tag 02OL}}
\group{divisors}
...
\begin{lemma}[No embedded points endos]
\label{divisors-lemma-no-embedded-points-endos}
\source{stacks:02OM}
\href{https://stacks.math.columbia.edu/tag/02OM}{\texttt{Stacks tag 02OM}}
\group{divisors}
...
\begin{definition}[Weakly associated]
\label{divisors-definition-weakly-associated}
\source{stacks:056L}
\href{https://stacks.math.columbia.edu/tag/056L}{\texttt{Stacks tag 056L}}
\group{divisors}
...
\begin{lemma}[Weakly associated affine open]
\label{divisors-lemma-weakly-associated-affine-open}
\source{stacks:056M}
\href{https://stacks.math.columbia.edu/tag/056M}{\texttt{Stacks tag 056M}}
\group{divisors}
...
\begin{lemma}[Weakly ass support]
\label{divisors-lemma-weakly-ass-support}
\source{stacks:05AM}
\href{https://stacks.math.columbia.edu/tag/05AM}{\texttt{Stacks tag 05AM}}
\group{divisors}
...
\begin{lemma}[Ses weakly ass]
\label{divisors-lemma-ses-weakly-ass}
\source{stacks:05AN}
\href{https://stacks.math.columbia.edu/tag/05AN}{\texttt{Stacks tag 05AN}}
\group{divisors}
...
\begin{lemma}[Weakly ass zero]
\label{divisors-lemma-weakly-ass-zero}
\source{stacks:05AP}
\href{https://stacks.math.columbia.edu/tag/05AP}{\texttt{Stacks tag 05AP}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-weakly-associated-affine-open}

Follows from
Lemma \ref{divisors-lemma-weakly-associated-affine-open}
and
Algebra, Lemma \ref{algebra-lemma-weakly-ass-zero}
\end{proof}

\begin{lemma}[Restriction injective open contains weakly ass]
\label{divisors-lemma-restriction-injective-open-contains-weakly-ass}
\source{stacks:0B3M}
\href{https://stacks.math.columbia.edu/tag/0B3M}{\texttt{Stacks tag 0B3M}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-ses-weakly-ass, divisors-lemma-weakly-ass-support, divisors-lemma-weakly-ass-zero}
...
by Lemma \ref{divisors-lemma-ses-weakly-ass}. Since also
$\text{WeakAss}(\mathcal{F}') \subset \text{Supp}(\mathcal{F}')$
(Lemma \ref{divisors-lemma-weakly-ass-support}) we conclude
$\text{WeakAss}(\mathcal{F}') = \emptyset$.
Hence $\mathcal{F}' = 0$ by Lemma \ref{divisors-lemma-weakly-ass-zero}.
\end{proof}

\begin{lemma}[Minimal support in weakly ass]
\label{divisors-lemma-minimal-support-in-weakly-ass}
\source{stacks:05AQ}
\href{https://stacks.math.columbia.edu/tag/05AQ}{\texttt{Stacks tag 05AQ}}
\group{divisors}
...
\begin{lemma}[Ass weakly ass]
\label{divisors-lemma-ass-weakly-ass}
\source{stacks:05AR}
\href{https://stacks.math.columbia.edu/tag/05AR}{\texttt{Stacks tag 05AR}}
\group{divisors}
...
\begin{lemma}[Weakass pushforward]
\label{divisors-lemma-weakass-pushforward}
\source{stacks:0AVN}
\href{https://stacks.math.columbia.edu/tag/0AVN}{\texttt{Stacks tag 0AVN}}
\group{divisors}
...
\begin{lemma}[Check injective on weakass]
\label{divisors-lemma-check-injective-on-weakass}
\source{stacks:0AVP}
\href{https://stacks.math.columbia.edu/tag/0AVP}{\texttt{Stacks tag 0AVP}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-weakly-ass-zero}

The assumptions imply that $\text{WeakAss}(\Ker(\varphi)) = \emptyset$
and hence $\Ker(\varphi) = 0$ by Lemma \ref{divisors-lemma-weakly-ass-zero}.
\end{proof}

\begin{lemma}[Depth 2 hartog]
\label{divisors-lemma-depth-2-hartog}
\source{stacks:0E9I}
\href{https://stacks.math.columbia.edu/tag/0E9I}{\texttt{Stacks tag 0E9I}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-check-isomorphism-via-depth-and-ass, divisors-lemma-weakass-pushforward, divisors-lemma-weakly-ass-support}

We claim Lemma \ref{divisors-lemma-check-isomorphism-via-depth-and-ass}
...
(Lemmas \ref{divisors-lemma-weakass-pushforward} and \ref{divisors-lemma-weakly-ass-support}).
Since we've assumed $\text{depth}(\mathcal{F}_x) \geq 2$
this finishes the proof.
\end{proof}

\begin{lemma}[Weakass reduced]
\label{divisors-lemma-weakass-reduced}
\source{stacks:0EME}
\href{https://stacks.math.columbia.edu/tag/0EME}{\texttt{Stacks tag 0EME}}
\group{divisors}
...
\begin{lemma}[Weakly ass reverse functorial]
\label{divisors-lemma-weakly-ass-reverse-functorial}
\source{stacks:05EX}
\href{https://stacks.math.columbia.edu/tag/05EX}{\texttt{Stacks tag 05EX}}
\group{divisors}
...
\begin{lemma}[Ass functorial equal]
\label{divisors-lemma-ass-functorial-equal}
\source{stacks:05EY}
\href{https://stacks.math.columbia.edu/tag/05EY}{\texttt{Stacks tag 05EY}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-associated-affine-open, divisors-lemma-weakly-ass-support, divisors-lemma-weakly-ass-reverse-functorial, divisors-lemma-ass-weakly-ass}
...
$$
by
Lemma \ref{divisors-lemma-weakly-ass-reverse-functorial}.
The outer sets are equal by
Lemma \ref{divisors-lemma-ass-weakly-ass}
hence we have equality everywhere.
\end{proof}

\begin{lemma}[Weakly associated finite]
\label{divisors-lemma-weakly-associated-finite}
\source{stacks:05EZ}
\href{https://stacks.math.columbia.edu/tag/05EZ}{\texttt{Stacks tag 05EZ}}
\group{divisors}
...
\begin{lemma}[Weakly ass pullback]
\label{divisors-lemma-weakly-ass-pullback}
\source{stacks:05F0}
\href{https://stacks.math.columbia.edu/tag/05F0}{\texttt{Stacks tag 05F0}}
\group{divisors}
...
\begin{lemma}[Weakly ass change fields]
\label{divisors-lemma-weakly-ass-change-fields}
\source{stacks:0CUC}
\href{https://stacks.math.columbia.edu/tag/0CUC}{\texttt{Stacks tag 0CUC}}
\group{divisors}
...
\begin{lemma}[Depth pushforward]
\label{divisors-lemma-depth-pushforward}
\source{stacks:0EY0}
\href{https://stacks.math.columbia.edu/tag/0EY0}{\texttt{Stacks tag 0EY0}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-weakass-pushforward, divisors-lemma-ass-weakly-ass}

Part (1) is Lemma \ref{divisors-lemma-weakass-pushforward}.
Part (2) follows from (1) and Lemma \ref{divisors-lemma-ass-weakly-ass}.
...
\source{stacks:05AT}
\href{https://stacks.math.columbia.edu/tag/05AT}{\texttt{Stacks tag 05AT}}
\group{divisors}
...
\begin{lemma}[Relative assassin affine open]
\label{divisors-lemma-relative-assassin-affine-open}
\source{stacks:0CU5}
\href{https://stacks.math.columbia.edu/tag/0CU5}{\texttt{Stacks tag 0CU5}}
\group{divisors}
...
$$
\begin{array}{cc}X' \downarrow\underset{g'}{\longrightarrow} & X \downarrow \\ S' \overset{g}{\longrightarrow} & S\end{array}
$$
...
Thus we may apply
Lemma \ref{divisors-lemma-bourbaki}
and we see that
$$
...
\begin{remark}[Base change relative assassin]
\label{divisors-remark-base-change-relative-assassin}
\source{stacks:05KL}
\href{https://stacks.math.columbia.edu/tag/05KL}{\texttt{Stacks tag 05KL}}
\group{divisors}

\uses{divisors-lemma-base-change-relative-assassin}
With notation and assumptions as in
Lemma \ref{divisors-lemma-base-change-relative-assassin}
...
\begin{definition}[Relative weak assassin]
\label{divisors-definition-relative-weak-assassin}
\source{stacks:05AV}
\href{https://stacks.math.columbia.edu/tag/05AV}{\texttt{Stacks tag 05AV}}
\group{divisors}
...
\begin{lemma}[Relative weak assassin assassin finite type]
\label{divisors-lemma-relative-weak-assassin-assassin-finite-type}
\source{stacks:05F2}
\href{https://stacks.math.columbia.edu/tag/05F2}{\texttt{Stacks tag 05F2}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-ass-weakly-ass}
...
\begin{lemma}[Relative weak assassin finite]
\label{divisors-lemma-relative-weak-assassin-finite}
\source{stacks:0CUD}
\href{https://stacks.math.columbia.edu/tag/0CUD}{\texttt{Stacks tag 0CUD}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-weakly-associated-finite}
...
we may apply Lemma \ref{divisors-lemma-weakly-associated-finite} to conclude.
\end{proof}
...
\begin{lemma}[Base change fitting ideal]
\label{divisors-lemma-base-change-fitting-ideal}
\source{stacks:0C3D}
\href{https://stacks.math.columbia.edu/tag/0C3D}{\texttt{Stacks tag 0C3D}}
\group{divisors}
...
\begin{lemma}[Fitting ideal of finitely presented]
\label{divisors-lemma-fitting-ideal-of-finitely-presented}
\source{stacks:0C3E}
\href{https://stacks.math.columbia.edu/tag/0C3E}{\texttt{Stacks tag 0C3E}}
\group{divisors}
...
\begin{lemma}[On subscheme cut out by Fit 0]
\label{divisors-lemma-on-subscheme-cut-out-by-Fit-0}
\source{stacks:0CYX}
\href{https://stacks.math.columbia.edu/tag/0CYX}{\texttt{Stacks tag 0CYX}}
\group{divisors}
...
\begin{lemma}[Fitting ideal generate locally]
\label{divisors-lemma-fitting-ideal-generate-locally}
\source{stacks:0C3F}
\href{https://stacks.math.columbia.edu/tag/0C3F}{\texttt{Stacks tag 0C3F}}
\group{divisors}
...
\begin{lemma}[Fitting ideal finite locally free]
\label{divisors-lemma-fitting-ideal-finite-locally-free}
\source{stacks:0C3G}
\href{https://stacks.math.columbia.edu/tag/0C3G}{\texttt{Stacks tag 0C3G}}
\group{divisors}
...
\begin{lemma}[Locally free rank r pullback]
\label{divisors-lemma-locally-free-rank-r-pullback}
\source{stacks:05P8}
\href{https://stacks.math.columbia.edu/tag/05P8}{\texttt{Stacks tag 05P8}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-base-change-fitting-ideal, divisors-lemma-fitting-ideal-generate-locally, divisors-lemma-fitting-ideal-finite-locally-free, divisors-lemma-fitting-ideal-of-finitely-presented}
...
Lemmas \ref{divisors-lemma-base-change-fitting-ideal} and
\ref{divisors-lemma-fitting-ideal-generate-locally}
...
is of finite type (Lemma \ref{divisors-lemma-fitting-ideal-of-finitely-presented} and
...
Lemma \ref{divisors-lemma-locally-free-rank-r-pullback} notwithstanding
...
\begin{lemma}[Finite presentation module]
\label{divisors-lemma-finite-presentation-module}
\source{stacks:05P9}
\href{https://stacks.math.columbia.edu/tag/05P9}{\texttt{Stacks tag 05P9}}
\group{divisors}

\uses{divisors-lemma-locally-free-rank-r-pullback}
...
be as in Lemma \ref{divisors-lemma-locally-free-rank-r-pullback}.
...
Lemma \ref{divisors-lemma-locally-free-rank-r-pullback}. It follows
that $F_{flat}$ is represented by
$\coprod_{r \geq 0} (Z_{r - 1} \setminus Z_r)$ where
$Z_r$ is as in
Lemma \ref{divisors-lemma-locally-free-rank-r-pullback}.
The other statements also follow from the lemma.
\end{proof}

\begin{example}[Not fp MB]
\label{divisors-example-not-fp-MB}
\source{stacks:0FJ0}
\href{https://stacks.math.columbia.edu/tag/0FJ0}{\texttt{Stacks tag 0FJ0}}
\group{divisors}

\uses{divisors-lemma-locally-free-rank-r-pullback, divisors-lemma-finite-presentation-module}
...
The closed subschemes of Lemma \ref{divisors-lemma-locally-free-rank-r-pullback} are
...
point of $S$. Thus
Lemma \ref{divisors-lemma-finite-presentation-module}
...
\begin{lemma}[Base change and fitting ideal omega]
\label{divisors-lemma-base-change-and-fitting-ideal-omega}
\source{stacks:0C3I}
\href{https://stacks.math.columbia.edu/tag/0C3I}{\texttt{Stacks tag 0C3I}}
\group{divisors}
...
\begin{lemma}[Zero fitting ideal omega unramified]
\label{divisors-lemma-zero-fitting-ideal-omega-unramified}
\source{stacks:0C3J}
\href{https://stacks.math.columbia.edu/tag/0C3J}{\texttt{Stacks tag 0C3J}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-on-subscheme-cut-out-by-Fit-0}

By Lemma \ref{divisors-lemma-on-subscheme-cut-out-by-Fit-0} the complement of $Z$
...
\begin{lemma}[D fitting ideal omega smooth]
\label{divisors-lemma-d-fitting-ideal-omega-smooth}
\source{stacks:0C3K}
\href{https://stacks.math.columbia.edu/tag/0C3K}{\texttt{Stacks tag 0C3K}}
\group{divisors}
...
By Lemma \ref{divisors-lemma-locally-free-rank-r-pullback} the complement of $Z$
...
\begin{lemma}[Torsion sections]
\label{divisors-lemma-torsion-sections}
\source{stacks:0AXR}
\href{https://stacks.math.columbia.edu/tag/0AXR}{\texttt{Stacks tag 0AXR}}
\group{divisors}
...
\source{stacks:0AVR}
\href{https://stacks.math.columbia.edu/tag/0AVR}{\texttt{Stacks tag 0AVR}}
\group{divisors}

\uses{divisors-lemma-torsion-sections}
Let $X$ be an integral scheme. Let $\mathcal{F}$ be a quasi-coherent
$\mathcal{O}_X$-module.
\begin{enumerate}
\item We say a local section of $\mathcal{F}$ is {\it torsion}
if it satisfies the equivalent conditions of Lemma \ref{divisors-lemma-torsion-sections}.
...
\begin{lemma}[Check torsion on affines]
\label{divisors-lemma-check-torsion-on-affines}
\source{stacks:0AXS}
\href{https://stacks.math.columbia.edu/tag/0AXS}{\texttt{Stacks tag 0AXS}}
\group{divisors}
...
\source{stacks:0AXT}
\href{https://stacks.math.columbia.edu/tag/0AXT}{\texttt{Stacks tag 0AXT}}
\group{divisors}
...
\begin{lemma}[Flat torsion free]
\label{divisors-lemma-flat-torsion-free}
\source{stacks:0AXU}
\href{https://stacks.math.columbia.edu/tag/0AXU}{\texttt{Stacks tag 0AXU}}
\group{divisors}
...
\begin{lemma}[Flat pullback torsion]
\label{divisors-lemma-flat-pullback-torsion}
\source{stacks:0AXV}
\href{https://stacks.math.columbia.edu/tag/0AXV}{\texttt{Stacks tag 0AXV}}
\group{divisors}
...
\begin{lemma}[Flat over integral integral fibre]
\label{divisors-lemma-flat-over-integral-integral-fibre}
\source{stacks:0BCM}
\href{https://stacks.math.columbia.edu/tag/0BCM}{\texttt{Stacks tag 0BCM}}
\group{divisors}
...
\begin{lemma}[Check torsion]
\label{divisors-lemma-check-torsion}
\source{stacks:0AXW}
\href{https://stacks.math.columbia.edu/tag/0AXW}{\texttt{Stacks tag 0AXW}}
\group{divisors}
...
\begin{lemma}[Extension torsion free]
\label{divisors-lemma-extension-torsion-free}
\source{stacks:0AXX}
\href{https://stacks.math.columbia.edu/tag/0AXX}{\texttt{Stacks tag 0AXX}}
\group{divisors}
...
\begin{lemma}[Torsion free finite noetherian domain]
\label{divisors-lemma-torsion-free-finite-noetherian-domain}
\source{stacks:0AXY}
\href{https://stacks.math.columbia.edu/tag/0AXY}{\texttt{Stacks tag 0AXY}}
\group{divisors}
...
\begin{lemma}[Torsion free over regular dim 1]
\label{divisors-lemma-torsion-free-over-regular-dim-1}
\source{stacks:0CC4}
\href{https://stacks.math.columbia.edu/tag/0CC4}{\texttt{Stacks tag 0CC4}}
\group{divisors}
...
\begin{lemma}[Hom into torsion free]
\label{divisors-lemma-hom-into-torsion-free}
\source{stacks:0AXZ}
\href{https://stacks.math.columbia.edu/tag/0AXZ}{\texttt{Stacks tag 0AXZ}}
\group{divisors}
...
\begin{lemma}[Isom depth 2 torsion free]
\label{divisors-lemma-isom-depth-2-torsion-free}
\source{stacks:0AVS}
\href{https://stacks.math.columbia.edu/tag/0AVS}{\texttt{Stacks tag 0AVS}}
\group{divisors}
...
This section is the analogue of
More on Algebra, Section \ref{more-algebra-section-rank}
for quasi-coherent modules.
Recall that if $X$ is an integral scheme with generic point $\eta$,
then the local ring $\mathcal{O}_{X, \eta}$ is equal to the
residue field $\kappa(\eta)$, see
Morphisms, Lemma \ref{morphisms-lemma-integral-scheme-rational-functions}.

\begin{definition}[Rank]
\label{divisors-definition-rank}
\source{stacks:0HAF}
\href{https://stacks.math.columbia.edu/tag/0HAF}{\texttt{Stacks tag 0HAF}}
\group{divisors}

Let $X$ be an integral scheme with generic point $\eta$.
Let $\mathcal{F}$ be a quasi-coherent $\mathcal{O}_X$-module.
The {\it rank} of $\mathcal{F}$ is $\dim_{\kappa(\eta)} \mathcal{F}_\eta$.
\end{definition}

This does not conflict with the defition of the rank of a locally free module
(in the case both definitions apply). It does not seem like a good idea
to define the rank of a quasi-coherent module if the scheme $X$
is not irreducible or if the local ring $\mathcal{O}_{X, \eta}$
at the generic point is not a field\footnote{If $X$ is irreducible and
$\mathcal{F}_\eta$ is free over $\mathcal{O}_{X, \eta}$ it would appear
natural to use the rank of this free module. Beware that some references
define rank using the length of $\mathcal{F}_\eta$.}

\begin{lemma}[Check rank on affines]
\label{divisors-lemma-check-rank-on-affines}
\source{stacks:0HAG}
\href{https://stacks.math.columbia.edu/tag/0HAG}{\texttt{Stacks tag 0HAG}}
\group{divisors}
...
\begin{lemma}[Dominant pullback rank]
\label{divisors-lemma-dominant-pullback-rank}
\source{stacks:0HAH}
\href{https://stacks.math.columbia.edu/tag/0HAH}{\texttt{Stacks tag 0HAH}}
\group{divisors}

Let $f : X \to Y$ be a dominant morphism of integral schemes.
...
\begin{proof}
\uses{divisors-lemma-check-rank-on-affines}

Use Lemma \ref{divisors-lemma-check-rank-on-affines},
Morphisms, Lemma \ref{morphisms-lemma-dominant-between-integral},
and
More on Algebra, Lemma \ref{more-algebra-lemma-dominant-pullback-rank}.
\end{proof}

\begin{lemma}[Rank additive]
\label{divisors-lemma-rank-additive}
\source{stacks:0HAI}
\href{https://stacks.math.columbia.edu/tag/0HAI}{\texttt{Stacks tag 0HAI}}
\group{divisors}
...
$\mathcal{F}$ and $\mathcal{F}''$.
\end{lemma}

\begin{proof}
Omitted. See More on Algebra, Lemma \ref{more-algebra-lemma-rank-additive}.
\end{proof}

\begin{lemma}[Rank tensor]
\label{divisors-lemma-rank-tensor}
\source{stacks:0HAJ}
\href{https://stacks.math.columbia.edu/tag/0HAJ}{\texttt{Stacks tag 0HAJ}}
\group{divisors}
...
\begin{proof}
Omitted. Note that part (2) makes sense because
$\SheafHom_{\mathcal{O}_X}(\mathcal{F}, \mathcal{G})$
is quasi-coherent by item (10) in
Schemes, Section \ref{schemes-section-quasi-coherent}.
The algebraic version of this lemma is
More on Algebra, Lemma \ref{more-algebra-lemma-rank-tensor}.
\end{proof}

\begin{lemma}[Finite module rank]
\label{divisors-lemma-finite-module-rank}
\source{stacks:0HAK}
\href{https://stacks.math.columbia.edu/tag/0HAK}{\texttt{Stacks tag 0HAK}}
\group{divisors}

Let $X$ be an integral scheme. Let $\mathcal{F}$ be a finite type
quasi-coherent $\mathcal{O}_X$-module. Then
\begin{enumerate}
...
\begin{proof}
See More on Algebra, Lemma \ref{more-algebra-lemma-finite-module-rank}
...
\source{stacks:0AVU}
\href{https://stacks.math.columbia.edu/tag/0AVU}{\texttt{Stacks tag 0AVU}}
\group{divisors}
...
It follows from Lemma \ref{divisors-lemma-dual-reflexive} that the reflexive hull
...
\begin{lemma}[Check reflexive on affines]
\label{divisors-lemma-check-reflexive-on-affines}
\source{stacks:0AY0}
\href{https://stacks.math.columbia.edu/tag/0AY0}{\texttt{Stacks tag 0AY0}}
\group{divisors}
...
\begin{remark}[Different reflexive]
\label{divisors-remark-different-reflexive}
\source{stacks:0AY1}
\href{https://stacks.math.columbia.edu/tag/0AY1}{\texttt{Stacks tag 0AY1}}
\group{divisors}
...
\begin{lemma}[Reflexive torsion free]
\label{divisors-lemma-reflexive-torsion-free}
\source{stacks:0AY2}
\href{https://stacks.math.columbia.edu/tag/0AY2}{\texttt{Stacks tag 0AY2}}
\group{divisors}
...
\begin{lemma}[Check reflexive]
\label{divisors-lemma-check-reflexive}
\source{stacks:0AY3}
\href{https://stacks.math.columbia.edu/tag/0AY3}{\texttt{Stacks tag 0AY3}}
\group{divisors}
...
\begin{lemma}[Flat pullback reflexive]
\label{divisors-lemma-flat-pullback-reflexive}
\source{stacks:0EBF}
\href{https://stacks.math.columbia.edu/tag/0EBF}{\texttt{Stacks tag 0EBF}}
\group{divisors}
...
\begin{lemma}[Sequence reflexive]
\label{divisors-lemma-sequence-reflexive}
\source{stacks:0EBG}
\href{https://stacks.math.columbia.edu/tag/0EBG}{\texttt{Stacks tag 0EBG}}
\group{divisors}
...
\begin{lemma}[Dual reflexive]
\label{divisors-lemma-dual-reflexive}
\source{stacks:0AY4}
\href{https://stacks.math.columbia.edu/tag/0AY4}{\texttt{Stacks tag 0AY4}}
\group{divisors}
...
\source{stacks:0EBH}
\href{https://stacks.math.columbia.edu/tag/0EBH}{\texttt{Stacks tag 0EBH}}
\group{divisors}

\uses{divisors-lemma-dual-reflexive, divisors-lemma-sequence-reflexive}
Let $X$ be an integral locally Noetherian scheme. Thanks to
Lemma \ref{divisors-lemma-dual-reflexive} we know that the reflexive
...
(Lemma \ref{divisors-lemma-sequence-reflexive}) and the reflexive hull
...
\begin{lemma}[Reflexive depth 2]
\label{divisors-lemma-reflexive-depth-2}
\source{stacks:0AY5}
\href{https://stacks.math.columbia.edu/tag/0AY5}{\texttt{Stacks tag 0AY5}}
\group{divisors}
...
\begin{lemma}[Reflexive S2]
\label{divisors-lemma-reflexive-S2}
\source{stacks:0EBI}
\href{https://stacks.math.columbia.edu/tag/0EBI}{\texttt{Stacks tag 0EBI}}
\group{divisors}
...
\begin{lemma}[Reflexive S2 extend]
\label{divisors-lemma-reflexive-S2-extend}
\source{stacks:0EBJ}
\href{https://stacks.math.columbia.edu/tag/0EBJ}{\texttt{Stacks tag 0EBJ}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-reflexive-S2, divisors-lemma-depth-2-hartog, divisors-lemma-dual-reflexive}

Let $\mathcal{F}$ be a coherent reflexive $\mathcal{O}_X$-module. For $z \in Z$
the stalk $\mathcal{F}_z$ has depth $\geq 2$ by Lemma \ref{divisors-lemma-reflexive-S2}.
Thus $\mathcal{F} \to j_*j^*\mathcal{F}$ is an isomorphism by
Lemma \ref{divisors-lemma-depth-2-hartog}. Conversely, let $\mathcal{G}$
...
(see discussion above and in particular Lemma \ref{divisors-lemma-dual-reflexive}).
...
\begin{lemma}[Reflexive over normal]
\label{divisors-lemma-reflexive-over-normal}
\source{stacks:0AY6}
\href{https://stacks.math.columbia.edu/tag/0AY6}{\texttt{Stacks tag 0AY6}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-check-reflexive-on-affines, divisors-lemma-reflexive-S2-extend}

Using Lemma \ref{divisors-lemma-check-reflexive-on-affines}
...
we conclude (3) implies (1) by Lemma \ref{divisors-lemma-reflexive-S2-extend}.
...
Lemma \ref{divisors-lemma-reflexive-S2-extend}.
\end{proof}

\begin{lemma}[Describe reflexive hull]
\label{divisors-lemma-describe-reflexive-hull}
\source{stacks:0AY7}
\href{https://stacks.math.columbia.edu/tag/0AY7}{\texttt{Stacks tag 0AY7}}
\group{divisors}
...
\begin{lemma}[Reflexive over regular dim 2]
\label{divisors-lemma-reflexive-over-regular-dim-2}
\source{stacks:0B3N}
\href{https://stacks.math.columbia.edu/tag/0B3N}{\texttt{Stacks tag 0B3N}}
\group{divisors}
...
\begin{definition}[Effective Cartier divisor]
\label{divisors-definition-effective-Cartier-divisor}
\source{stacks:01WR}
\href{https://stacks.math.columbia.edu/tag/01WR}{\texttt{Stacks tag 01WR}}
\group{divisors}
...
\begin{lemma}[Characterize effective Cartier divisor]
\label{divisors-lemma-characterize-effective-Cartier-divisor}
\source{stacks:01WS}
\href{https://stacks.math.columbia.edu/tag/01WS}{\texttt{Stacks tag 01WS}}
\group{divisors}
...
\begin{lemma}[Complement locally principal closed subscheme]
\label{divisors-lemma-complement-locally-principal-closed-subscheme}
\source{stacks:07ZT}
\href{https://stacks.math.columbia.edu/tag/07ZT}{\texttt{Stacks tag 07ZT}}
\group{divisors}
...
\begin{lemma}[Complement effective Cartier divisor]
\label{divisors-lemma-complement-effective-Cartier-divisor}
\source{stacks:07ZU}
\href{https://stacks.math.columbia.edu/tag/07ZU}{\texttt{Stacks tag 07ZU}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-complement-locally-principal-closed-subscheme, divisors-lemma-characterize-effective-Cartier-divisor}

Affineness is Lemma \ref{divisors-lemma-complement-locally-principal-closed-subscheme}.
...
Lemma \ref{divisors-lemma-characterize-effective-Cartier-divisor}.
Thus $A \subset A_f$ which implies that $U \subset S$ is
scheme theoretically dense, see
Morphisms, Example \ref{morphisms-example-scheme-theoretic-closure}.
\end{proof}

\begin{lemma}[Effective Cartier makes dimension drop]
\label{divisors-lemma-effective-Cartier-makes-dimension-drop}
\source{stacks:056N}
\href{https://stacks.math.columbia.edu/tag/056N}{\texttt{Stacks tag 056N}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-characterize-effective-Cartier-divisor}
...
\begin{definition}[Sum effective Cartier divisors]
\label{divisors-definition-sum-effective-Cartier-divisors}
\source{stacks:01WT}
\href{https://stacks.math.columbia.edu/tag/01WT}{\texttt{Stacks tag 01WT}}
\group{divisors}
...
\begin{lemma}[Sum effective Cartier divisors]
\label{divisors-lemma-sum-effective-Cartier-divisors}
\source{stacks:01WU}
\href{https://stacks.math.columbia.edu/tag/01WU}{\texttt{Stacks tag 01WU}}
\group{divisors}
...
\begin{lemma}[Difference effective Cartier divisors]
\label{divisors-lemma-difference-effective-Cartier-divisors}
\source{stacks:02ON}
\href{https://stacks.math.columbia.edu/tag/02ON}{\texttt{Stacks tag 02ON}}
\group{divisors}
...
\begin{lemma}[Sum closed subschemes effective Cartier]
\label{divisors-lemma-sum-closed-subschemes-effective-Cartier}
\source{stacks:07ZV}
\href{https://stacks.math.columbia.edu/tag/07ZV}{\texttt{Stacks tag 07ZV}}
\group{divisors}
...
Applying Lemma \ref{divisors-lemma-characterize-effective-Cartier-divisor} we obtain
...
\begin{lemma}[Sum effective Cartier divisors union]
\label{divisors-lemma-sum-effective-Cartier-divisors-union}
\source{stacks:0C4R}
\href{https://stacks.math.columbia.edu/tag/0C4R}{\texttt{Stacks tag 0C4R}}
\group{divisors}
...
(using Lemma \ref{divisors-lemma-characterize-effective-Cartier-divisor})
...
\begin{lemma}[Pullback locally principal]
\label{divisors-lemma-pullback-locally-principal}
\source{stacks:053P}
\href{https://stacks.math.columbia.edu/tag/053P}{\texttt{Stacks tag 053P}}
\group{divisors}
...
\begin{definition}[Pullback effective Cartier divisor]
\label{divisors-definition-pullback-effective-Cartier-divisor}
\source{stacks:01WV}
\href{https://stacks.math.columbia.edu/tag/01WV}{\texttt{Stacks tag 01WV}}
\group{divisors}
...
\begin{lemma}[Pullback effective Cartier defined]
\label{divisors-lemma-pullback-effective-Cartier-defined}
\source{stacks:02OO}
\href{https://stacks.math.columbia.edu/tag/02OO}{\texttt{Stacks tag 02OO}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-ass-weakly-ass, divisors-lemma-weakass-reduced}
...
(Definition \ref{divisors-definition-effective-Cartier-divisor}) the
following definition makes sense.

\begin{definition}[Invertible sheaf effective Cartier divisor]
\label{divisors-definition-invertible-sheaf-effective-Cartier-divisor}
\source{stacks:01WX}
\href{https://stacks.math.columbia.edu/tag/01WX}{\texttt{Stacks tag 01WX}}
\group{divisors}
...
(Lemma \ref{divisors-lemma-invertible-sheaf-sum-effective-Cartier-divisors}).
...
\begin{lemma}[Conormal effective Cartier divisor]
\label{divisors-lemma-conormal-effective-Cartier-divisor}
\source{stacks:0B3P}
\href{https://stacks.math.columbia.edu/tag/0B3P}{\texttt{Stacks tag 0B3P}}
\group{divisors}
...
\begin{lemma}[Ses add divisor]
\label{divisors-lemma-ses-add-divisor}
\source{stacks:0C4T}
\href{https://stacks.math.columbia.edu/tag/0C4T}{\texttt{Stacks tag 0C4T}}
\group{divisors}

\uses{divisors-lemma-difference-effective-Cartier-divisors}
Let $X$ be a scheme. Let $D, D' \subset X$ be effective Cartier divisors
with $D \subset D'$ and let $C \subset X$ be an effective Cartier divisor
such that $D' = D + C$ (which exists by
Lemma \ref{divisors-lemma-difference-effective-Cartier-divisors}).
...
sheaf of $D$ in $D'$ and let $\mathcal{I}_D = \mathcal{O}_X(-D)$ be
the ideal sheaf of $D$ in $X$. Then there is a canonical surjection
$\mathcal{I}_D \to \mathcal{I}$.
Thus it suffices to show the kernel of this map is equal to
$\mathcal{I}_C\mathcal{I}_D$ (with obvious notation).
This can be checked locally, hence we may assume
$X = \Spec(A)$, $D = \Spec(A/fA)$ and $C = \Spec(A/gA)$ where
$f, g \in A$ are nonzerodivisors
(Lemma \ref{divisors-lemma-characterize-effective-Cartier-divisor}).
Then $\mathcal{I}_D$ corresponds to $fA$, the nonzerodivisor $fg \in A$
generates the ideal of $D'$, and $\mathcal{I}$ corresponds to $I = fA/fgA$.
Thus the result is clear.
\end{proof}

\begin{lemma}[Invertible sheaf sum effective Cartier divisors]
\label{divisors-lemma-invertible-sheaf-sum-effective-Cartier-divisors}
\source{stacks:02OP}
\href{https://stacks.math.columbia.edu/tag/02OP}{\texttt{Stacks tag 02OP}}
\group{divisors}
...
\begin{lemma}[Pullback effective Cartier divisors]
\label{divisors-lemma-pullback-effective-Cartier-divisors}
\source{stacks:0C4U}
\href{https://stacks.math.columbia.edu/tag/0C4U}{\texttt{Stacks tag 0C4U}}
\group{divisors}
...
\begin{definition}[Regular section]
\label{divisors-definition-regular-section}
\source{stacks:01WY}
\href{https://stacks.math.columbia.edu/tag/01WY}{\texttt{Stacks tag 01WY}}
\group{divisors}
...
\begin{lemma}[Regular section structure sheaf]
\label{divisors-lemma-regular-section-structure-sheaf}
\source{stacks:01WZ}
\href{https://stacks.math.columbia.edu/tag/01WZ}{\texttt{Stacks tag 01WZ}}
\group{divisors}
...
\begin{definition}[Zero scheme s]
\label{divisors-definition-zero-scheme-s}
\source{stacks:02OQ}
\href{https://stacks.math.columbia.edu/tag/02OQ}{\texttt{Stacks tag 02OQ}}
\group{divisors}
...
\begin{lemma}[Zero scheme]
\label{divisors-lemma-zero-scheme}
\source{stacks:02OR}
\href{https://stacks.math.columbia.edu/tag/02OR}{\texttt{Stacks tag 02OR}}
\group{divisors}
...
\begin{lemma}[Effective Cartier divisors on a scheme are the same as invertible sheaves with fixed re...]
\label{divisors-lemma-characterize-OD}
\source{stacks:01X0}
\href{https://stacks.math.columbia.edu/tag/01X0}{\texttt{Stacks tag 01X0}}
\group{divisors}
...
\begin{remark}[Ses regular section]
\label{divisors-remark-ses-regular-section}
\source{stacks:0C6K}
\href{https://stacks.math.columbia.edu/tag/0C6K}{\texttt{Stacks tag 0C6K}}
\group{divisors}

\uses{divisors-lemma-characterize-OD, divisors-lemma-conormal-effective-Cartier-divisor}
...
Lemmas \ref{divisors-lemma-characterize-OD} and
...
\begin{lemma}[Regular section associated points]
\label{divisors-lemma-regular-section-associated-points}
\source{stacks:0AYL}
\href{https://stacks.math.columbia.edu/tag/0AYL}{\texttt{Stacks tag 0AYL}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-regular-section-structure-sheaf}

Omitted. Hint: reduce to the affine case and $\mathcal{L}$ trivial
and then use Lemma \ref{divisors-lemma-regular-section-structure-sheaf} and
Algebra, Lemma \ref{algebra-lemma-ass-zero-divisors}.
\end{proof}

\begin{lemma}[Effective Cartier in points]
\label{divisors-lemma-effective-Cartier-in-points}
\source{stacks:0AG8}
\href{https://stacks.math.columbia.edu/tag/0AG8}{\texttt{Stacks tag 0AG8}}
\group{divisors}
...
\begin{lemma}[Effective Cartier codimension 1]
\label{divisors-lemma-effective-Cartier-codimension-1}
\source{stacks:0BCN}
\href{https://stacks.math.columbia.edu/tag/0BCN}{\texttt{Stacks tag 0BCN}}
\group{divisors}
...
$A_\mathfrak p$ by Lemma \ref{divisors-lemma-characterize-effective-Cartier-divisor}
...
\begin{lemma}[Integral effective Cartier divisor dvr]
\label{divisors-lemma-integral-effective-Cartier-divisor-dvr}
\source{stacks:0AG9}
\href{https://stacks.math.columbia.edu/tag/0AG9}{\texttt{Stacks tag 0AG9}}
\group{divisors}
...
By Lemma \ref{divisors-lemma-characterize-effective-Cartier-divisor}
...
\begin{lemma}[Effective Cartier divisor Sk]
\label{divisors-lemma-effective-Cartier-divisor-Sk}
\source{stacks:0B3R}
\href{https://stacks.math.columbia.edu/tag/0B3R}{\texttt{Stacks tag 0B3R}}
\group{divisors}
...
\begin{lemma}[Normal effective Cartier divisor S1]
\label{divisors-lemma-normal-effective-Cartier-divisor-S1}
\source{stacks:0B3S}
\href{https://stacks.math.columbia.edu/tag/0B3S}{\texttt{Stacks tag 0B3S}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-effective-Cartier-divisor-Sk}

By Properties, Lemma \ref{properties-lemma-criterion-normal}
we see that $X$ is $(S_2)$. Thus we conclude by
Lemma \ref{divisors-lemma-effective-Cartier-divisor-Sk}.
\end{proof}

\begin{lemma}[Weil divisor is cartier UFD]
\label{divisors-lemma-weil-divisor-is-cartier-UFD}
\source{stacks:0AGA}
\href{https://stacks.math.columbia.edu/tag/0AGA}{\texttt{Stacks tag 0AGA}}
\group{divisors}

Let $X$ be a locally Noetherian scheme. Let $D \subset X$ be an integral
...
\begin{proof}
\uses{divisors-lemma-effective-Cartier-in-points}
...
\begin{lemma}[Codim 1 part]
\label{divisors-lemma-codim-1-part}
\source{stacks:0AGB}
\href{https://stacks.math.columbia.edu/tag/0AGB}{\texttt{Stacks tag 0AGB}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-integral-effective-Cartier-divisor-dvr, divisors-lemma-weil-divisor-is-cartier-UFD}
...
Lemma \ref{divisors-lemma-integral-effective-Cartier-divisor-dvr}.
...
By Lemma \ref{divisors-lemma-weil-divisor-is-cartier-UFD} each $D_i$
is an effective Cartier divisor.
\end{proof}

\begin{lemma}[Codimension 1 is effective Cartier]
\label{divisors-lemma-codimension-1-is-effective-Cartier}
\source{stacks:0BXH}
\href{https://stacks.math.columbia.edu/tag/0BXH}{\texttt{Stacks tag 0BXH}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-codim-1-part}

Let $D = \sum a_i D_i$ be as in Lemma \ref{divisors-lemma-codim-1-part}
...
\begin{lemma}[UFD one equation CM]
\label{divisors-lemma-UFD-one-equation-CM}
\source{stacks:0BXI}
\href{https://stacks.math.columbia.edu/tag/0BXI}{\texttt{Stacks tag 0BXI}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-codimension-1-is-effective-Cartier}

By Lemma \ref{divisors-lemma-codimension-1-is-effective-Cartier}
...
\begin{lemma}[Effective Cartier divisor is a sum]
\label{divisors-lemma-effective-Cartier-divisor-is-a-sum}
\source{stacks:0BCP}
\href{https://stacks.math.columbia.edu/tag/0BCP}{\texttt{Stacks tag 0BCP}}
\group{divisors}
...
Choose $a_i$ as in Lemma \ref{divisors-lemma-codim-1-part} and set $D' = \sum a_i D_i$.
...
\begin{lemma}[On a projective scheme, every line bundle has a regular meromorphic section.]
\label{divisors-lemma-quasi-projective-Noetherian-pic-effective-Cartier}
\source{stacks:0AYM}
\href{https://stacks.math.columbia.edu/tag/0AYM}{\texttt{Stacks tag 0AYM}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-finite-ass, divisors-lemma-regular-section-associated-points, divisors-lemma-characterize-OD}
...
Lemma \ref{divisors-lemma-regular-section-associated-points}.
Hence $\mathcal{N} \cong \mathcal{O}_X(D)$ where
$D = Z(t)$ is the effective Cartier divisor corresponding to $t$, see
Lemma \ref{divisors-lemma-characterize-OD}. Since $E \cap D = \emptyset$
...
effective Cartier divisors $D$ and $D'$, see Lemma \ref{divisors-lemma-characterize-OD}.
By construction $E \cap D = \emptyset$ and $E \cap D' = \emptyset$
and the proof is complete.
\end{proof}

\begin{lemma}[Wedge product ses]
\label{divisors-lemma-wedge-product-ses}
\source{stacks:0B3T}
\href{https://stacks.math.columbia.edu/tag/0B3T}{\texttt{Stacks tag 0B3T}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-reflexive-over-regular-dim-2}

The first statement follows from Lemma \ref{divisors-lemma-reflexive-over-regular-dim-2}
...
\begin{lemma}[Affine punctured spec]
\label{divisors-lemma-affine-punctured-spec}
\source{stacks:0BCR}
\href{https://stacks.math.columbia.edu/tag/0BCR}{\texttt{Stacks tag 0BCR}}
\group{divisors}
...
\begin{remark}[Affine punctured spectrum standard proof]
\label{divisors-remark-affine-punctured-spectrum-standard-proof}
\source{stacks:0BCS}
\href{https://stacks.math.columbia.edu/tag/0BCS}{\texttt{Stacks tag 0BCS}}
\group{divisors}

\uses{divisors-lemma-affine-punctured-spec}
...
the proof of Lemma \ref{divisors-lemma-affine-punctured-spec}.
...
\begin{remark}[Affine puctured spectrum general]
\label{divisors-remark-affine-puctured-spectrum-general}
\source{stacks:0BCT}
\href{https://stacks.math.columbia.edu/tag/0BCT}{\texttt{Stacks tag 0BCT}}
\group{divisors}
...
Lemma \ref{divisors-lemma-affine-punctured-spec}
...
\begin{lemma}[Complement affine open immersion]
\label{divisors-lemma-complement-affine-open-immersion}
\source{stacks:0BCU}
\href{https://stacks.math.columbia.edu/tag/0BCU}{\texttt{Stacks tag 0BCU}}
\group{divisors}
...
\begin{lemma}[Complement affine open]
\label{divisors-lemma-complement-affine-open}
\source{stacks:0BCV}
\href{https://stacks.math.columbia.edu/tag/0BCV}{\texttt{Stacks tag 0BCV}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-complement-affine-open-immersion}

This follows from Lemma \ref{divisors-lemma-complement-affine-open-immersion}
...
\begin{lemma}[Complement open affine effective cartier divisor]
\label{divisors-lemma-complement-open-affine-effective-cartier-divisor}
\source{stacks:0BCW}
\href{https://stacks.math.columbia.edu/tag/0BCW}{\texttt{Stacks tag 0BCW}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-complement-affine-open, divisors-lemma-weil-divisor-is-cartier-UFD}
...
Lemma \ref{divisors-lemma-complement-affine-open}
(and Properties, Lemma \ref{properties-lemma-codimension-local-ring}).
Thus $D_i$ is an effective Cartier divisor by
Lemma \ref{divisors-lemma-weil-divisor-is-cartier-UFD}.
Hence we can take $D = D_1 + \ldots + D_r$.
\end{proof}

\begin{lemma}[Complement open affine effective cartier divisor bis]
\label{divisors-lemma-complement-open-affine-effective-cartier-divisor-bis}
\source{stacks:0EGJ}
\href{https://stacks.math.columbia.edu/tag/0EGJ}{\texttt{Stacks tag 0EGJ}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-complement-open-affine-effective-cartier-divisor}
...
Lemma \ref{divisors-lemma-complement-open-affine-effective-cartier-divisor}
...
\begin{lemma}[Regular ample family]
\label{divisors-lemma-regular-ample-family}
\source{stacks:0GML}
\href{https://stacks.math.columbia.edu/tag/0GML}{\texttt{Stacks tag 0GML}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-complement-open-affine-effective-cartier-divisor-bis, divisors-definition-invertible-sheaf-effective-Cartier-divisor}
...
see Definition \ref{divisors-definition-invertible-sheaf-effective-Cartier-divisor},
...
in the proof of Lemma \ref{divisors-lemma-norm-ample}) will require property (2).

\begin{lemma}[Finite trivialize invertible upstairs]
\label{divisors-lemma-finite-trivialize-invertible-upstairs}
\source{stacks:0BUT}
\href{https://stacks.math.columbia.edu/tag/0BUT}{\texttt{Stacks tag 0BUT}}
\group{divisors}
...
\begin{lemma}[Norm invertible]
\label{divisors-lemma-norm-invertible}
\source{stacks:0BCY}
\href{https://stacks.math.columbia.edu/tag/0BCY}{\texttt{Stacks tag 0BCY}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-finite-trivialize-invertible-upstairs}
...
Lemma \ref{divisors-lemma-finite-trivialize-invertible-upstairs}
...
\begin{lemma}[Norm map invertible]
\label{divisors-lemma-norm-map-invertible}
\source{stacks:0BCZ}
\href{https://stacks.math.columbia.edu/tag/0BCZ}{\texttt{Stacks tag 0BCZ}}
\group{divisors}

\uses{divisors-lemma-norm-invertible}
...
as in Lemma \ref{divisors-lemma-norm-invertible}. Moreover, for
...
\begin{proof}
\uses{divisors-lemma-finite-trivialize-invertible-upstairs, divisors-lemma-norm-invertible}
...
in the proof of Lemma \ref{divisors-lemma-norm-invertible}
...
\begin{lemma}[Norm ample]
\label{divisors-lemma-norm-ample}
\source{stacks:0BD0}
\href{https://stacks.math.columbia.edu/tag/0BD0}{\texttt{Stacks tag 0BD0}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-norm-map-invertible}
...
Lemma \ref{divisors-lemma-norm-map-invertible}. Then $Y_t$
is affine by Properties, Lemma \ref{properties-lemma-affine-cap-s-open}.
\end{proof}

\begin{lemma}[Norm quasi affine]
\label{divisors-lemma-norm-quasi-affine}
\source{stacks:0BD1}
\href{https://stacks.math.columbia.edu/tag/0BD1}{\texttt{Stacks tag 0BD1}}
\group{divisors}
...
\begin{lemma}[Finite locally free has norm]
\label{divisors-lemma-finite-locally-free-has-norm}
\source{stacks:0BD2}
\href{https://stacks.math.columbia.edu/tag/0BD2}{\texttt{Stacks tag 0BD2}}
\group{divisors}
...
\begin{lemma}[Norm in normal case]
\label{divisors-lemma-norm-in-normal-case}
\source{stacks:0BD3}
\href{https://stacks.math.columbia.edu/tag/0BD3}{\texttt{Stacks tag 0BD3}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-finite-locally-free-has-norm}
...
$$
\begin{array}{cc}L \longrightarrow & K \\ B \uparrow\longrightarrow & A \uparrow\end{array}
$$
...
of Lemma \ref{divisors-lemma-finite-locally-free-has-norm}.
...
\begin{lemma}[Frobenius gives norm for reduction]
\label{divisors-lemma-Frobenius-gives-norm-for-reduction}
\source{stacks:0BDZ}
\href{https://stacks.math.columbia.edu/tag/0BDZ}{\texttt{Stacks tag 0BDZ}}
\group{divisors}
...
\begin{proposition}[Push down ample]
\label{divisors-proposition-push-down-ample}
\source{stacks:0BD4}
\href{https://stacks.math.columbia.edu/tag/0BD4}{\texttt{Stacks tag 0BD4}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-finite-locally-free-has-norm, divisors-lemma-norm-ample, divisors-lemma-Frobenius-gives-norm-for-reduction, divisors-lemma-norm-in-normal-case}

Case (1) follows from a combination of
Lemmas \ref{divisors-lemma-finite-locally-free-has-norm} and \ref{divisors-lemma-norm-ample}.
Case (3) follows from a combination of
Lemmas \ref{divisors-lemma-Frobenius-gives-norm-for-reduction} and
\ref{divisors-lemma-norm-ample}.
In case (2) we first replace $X$ by an irreducible component of $X$
which dominates $Y$ (viewed as a reduced closed subscheme of $X$).
Then we can apply Lemma \ref{divisors-lemma-norm-in-normal-case}.
\end{proof}

\begin{lemma}[Push down quasi affine]
\label{divisors-lemma-push-down-quasi-affine}
\source{stacks:0BD5}
\href{https://stacks.math.columbia.edu/tag/0BD5}{\texttt{Stacks tag 0BD5}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-finite-locally-free-has-norm, divisors-lemma-norm-quasi-affine, divisors-lemma-norm-in-normal-case}

Case (1) follows from a combination of Lemmas
\ref{divisors-lemma-finite-locally-free-has-norm} and \ref{divisors-lemma-norm-quasi-affine}.
In case (2) we first replace $X$ by an irreducible component of $X$
which dominates $Y$ (viewed as a reduced closed subscheme of $X$).
Then we can apply Lemma \ref{divisors-lemma-norm-in-normal-case}.
\end{proof}
...
\begin{lemma}[Relative Cartier]
\label{divisors-lemma-relative-Cartier}
\source{stacks:056Q}
\href{https://stacks.math.columbia.edu/tag/056Q}{\texttt{Stacks tag 056Q}}
\group{divisors}
...
\source{stacks:062T}
\href{https://stacks.math.columbia.edu/tag/062T}{\texttt{Stacks tag 062T}}
\group{divisors}
...
\begin{lemma}[Sum relative effective Cartier divisor]
\label{divisors-lemma-sum-relative-effective-Cartier-divisor}
\source{stacks:0B8U}
\href{https://stacks.math.columbia.edu/tag/0B8U}{\texttt{Stacks tag 0B8U}}
\group{divisors}

\uses{divisors-definition-sum-effective-Cartier-divisors}
Let $f : X \to S$ be a morphism of schemes. If $D_1, D_2 \subset X$
are relative effective Cartier divisor on $X/S$ then so
is $D_1 + D_2$ (Definition \ref{divisors-definition-sum-effective-Cartier-divisors}).
\end{lemma}
...
\begin{lemma}[Difference relative effective Cartier divisor]
\label{divisors-lemma-difference-relative-effective-Cartier-divisor}
\source{stacks:0B8V}
\href{https://stacks.math.columbia.edu/tag/0B8V}{\texttt{Stacks tag 0B8V}}
\group{divisors}
...
such that $D_2 = D_1 + D$
(Lemma \ref{divisors-lemma-difference-effective-Cartier-divisors}) is
...
\begin{lemma}[Flat at x]
\label{divisors-lemma-flat-at-x}
\source{stacks:062U}
\href{https://stacks.math.columbia.edu/tag/062U}{\texttt{Stacks tag 062U}}
\group{divisors}
...
$$
\begin{array}{ccccc}0 \longrightarrow & B \underset{h}{\longrightarrow} & B \longrightarrow & B/hB \longrightarrow & 0 \\ 0 \longrightarrow & B \otimes_A I \overset{h}{\longrightarrow}\uparrow & B \otimes_A I \longrightarrow\uparrow & B/hB \otimes_A I \longrightarrow\uparrow & 0\end{array}
$$
...
\begin{lemma}[Flat relative Cartier divisor]
\label{divisors-lemma-flat-relative-Cartier-divisor}
\source{stacks:062V}
\href{https://stacks.math.columbia.edu/tag/062V}{\texttt{Stacks tag 062V}}
\group{divisors}
...
Lemma \ref{divisors-lemma-flat-at-x}.
...
\begin{lemma}[Michael artin]
\label{divisors-lemma-michael-artin}
\source{stacks:062W}
\href{https://stacks.math.columbia.edu/tag/062W}{\texttt{Stacks tag 062W}}
\group{divisors}
...
\begin{example}[Relative cartier ambient space not flat]
\label{divisors-example-relative-cartier-ambient-space-not-flat}
\source{stacks:062X}
\href{https://stacks.math.columbia.edu/tag/062X}{\texttt{Stacks tag 062X}}
\group{divisors}
...
\begin{lemma}[Fibre Cartier]
\label{divisors-lemma-fibre-Cartier}
\source{stacks:062Y}
\href{https://stacks.math.columbia.edu/tag/062Y}{\texttt{Stacks tag 062Y}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-relative-Cartier}
...
base change, see
Lemma \ref{divisors-lemma-relative-Cartier},
...
as the conormal algebra of the closed immersion
...
\source{stacks:0630}
\href{https://stacks.math.columbia.edu/tag/0630}{\texttt{Stacks tag 0630}}
\group{divisors}
...
\begin{lemma}[Affine conormal sheaf]
\label{divisors-lemma-affine-conormal-sheaf}
\source{stacks:0633}
\href{https://stacks.math.columbia.edu/tag/0633}{\texttt{Stacks tag 0633}}
\group{divisors}
...
\source{stacks:0634}
\href{https://stacks.math.columbia.edu/tag/0634}{\texttt{Stacks tag 0634}}
\group{divisors}
...
\source{stacks:0635}
\href{https://stacks.math.columbia.edu/tag/0635}{\texttt{Stacks tag 0635}}
\group{divisors}

\uses{divisors-lemma-conormal-algebra-functorial}
Let
$$
\begin{array}{cc}Z \underset{i}{\longrightarrow}\underset{f}{\downarrow} & X \overset{g}{\downarrow} \\ Z' \overset{i'}{\longrightarrow} & X'\end{array}
$$
...
Lemma \ref{divisors-lemma-conormal-algebra-functorial}
...
\source{stacks:0636}
\href{https://stacks.math.columbia.edu/tag/0636}{\texttt{Stacks tag 0636}}
\group{divisors}
...
\begin{lemma}[Types regular sequences implications]
\label{divisors-lemma-types-regular-sequences-implications}
\source{stacks:063C}
\href{https://stacks.math.columbia.edu/tag/063C}{\texttt{Stacks tag 063C}}
\group{divisors}
...
\mathcal{O}_{X, x}/(f_1, \ldots, f_{i - 1})
$$
are injective for all $x \in X$. The other types of regularity
can be checked stalkwise as well (details omitted).
Hence the implications follow from More on Algebra, Lemmas
...
\begin{definition}[Regular ideal sheaf]
\label{divisors-definition-regular-ideal-sheaf}
\source{stacks:063D}
\href{https://stacks.math.columbia.edu/tag/063D}{\texttt{Stacks tag 063D}}
\group{divisors}
...
\begin{lemma}[Regular quasi regular scheme]
\label{divisors-lemma-regular-quasi-regular-scheme}
\source{stacks:063E}
\href{https://stacks.math.columbia.edu/tag/063E}{\texttt{Stacks tag 063E}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-types-regular-sequences-implications}

The lemma immediately reduces to
Lemma \ref{divisors-lemma-types-regular-sequences-implications}.
\end{proof}

\begin{lemma}[Quasi regular ideal]
\label{divisors-lemma-quasi-regular-ideal}
\source{stacks:063H}
\href{https://stacks.math.columbia.edu/tag/063H}{\texttt{Stacks tag 063H}}
\group{divisors}
...
\begin{lemma}[Generate regular ideal]
\label{divisors-lemma-generate-regular-ideal}
\source{stacks:067N}
\href{https://stacks.math.columbia.edu/tag/067N}{\texttt{Stacks tag 067N}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-quasi-regular-ideal}
...
Lemma \ref{divisors-lemma-quasi-regular-ideal}
...
\begin{lemma}[Regular ideal sheaf quasi coherent]
\label{divisors-lemma-regular-ideal-sheaf-quasi-coherent}
\source{stacks:063F}
\href{https://stacks.math.columbia.edu/tag/063F}{\texttt{Stacks tag 063F}}
\group{divisors}
...
\begin{lemma}[Regular ideal sheaf scheme]
\label{divisors-lemma-regular-ideal-sheaf-scheme}
\source{stacks:063G}
\href{https://stacks.math.columbia.edu/tag/063G}{\texttt{Stacks tag 063G}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-regular-ideal-sheaf-quasi-coherent}
...
Lemma \ref{divisors-lemma-regular-ideal-sheaf-quasi-coherent}
...
\begin{lemma}[Noetherian scheme regular ideal]
\label{divisors-lemma-Noetherian-scheme-regular-ideal}
\source{stacks:063I}
\href{https://stacks.math.columbia.edu/tag/063I}{\texttt{Stacks tag 063I}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-regular-ideal-sheaf-scheme, divisors-lemma-regular-quasi-regular-scheme}

It follows from
Lemma \ref{divisors-lemma-regular-ideal-sheaf-scheme}
...
Lemma \ref{divisors-lemma-regular-quasi-regular-scheme}.
...
Definition \ref{divisors-definition-regular-ideal-sheaf}
...
\source{stacks:063J}
\href{https://stacks.math.columbia.edu/tag/063J}{\texttt{Stacks tag 063J}}
\group{divisors}
...
Lemma \ref{divisors-lemma-regular-quasi-regular-immersion}.
A Koszul-regular closed immersion is smooth locally a regular immersion, see
Lemma \ref{divisors-lemma-koszul-regular-smooth-locally-regular}.
...
\source{stacks:063K}
\href{https://stacks.math.columbia.edu/tag/063K}{\texttt{Stacks tag 063K}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-regular-quasi-regular-scheme}
...
\source{stacks:063L}
\href{https://stacks.math.columbia.edu/tag/063L}{\texttt{Stacks tag 063L}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-regular-quasi-regular-immersion, divisors-lemma-Noetherian-scheme-regular-ideal}
...
\begin{lemma}[Flat base change regular immersion]
\label{divisors-lemma-flat-base-change-regular-immersion}
\source{stacks:067P}
\href{https://stacks.math.columbia.edu/tag/067P}{\texttt{Stacks tag 067P}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-regular-ideal-sheaf-scheme}
...
\source{stacks:063M}
\href{https://stacks.math.columbia.edu/tag/063M}{\texttt{Stacks tag 063M}}
\group{divisors}
...
\source{stacks:063N}
\href{https://stacks.math.columbia.edu/tag/063N}{\texttt{Stacks tag 063N}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-quasi-regular-immersion, divisors-lemma-regular-quasi-regular-scheme}

Since $\mathcal{C}_{Z/Y}$ is finite locally free (see
Lemma \ref{divisors-lemma-quasi-regular-immersion}
and
Lemma \ref{divisors-lemma-regular-quasi-regular-scheme})
...
\source{stacks:067Q}
\href{https://stacks.math.columbia.edu/tag/067Q}{\texttt{Stacks tag 067Q}}
\group{divisors}
...
\source{stacks:068Z}
\href{https://stacks.math.columbia.edu/tag/068Z}{\texttt{Stacks tag 068Z}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-generate-regular-ideal}
...
\medskip\noindent
Proof of (1). By
Lemma \ref{divisors-lemma-generate-regular-ideal}
we can find an affine open neighbourhood $U$ of $x$ such that
$f_1, \ldots, f_n, g_1, \ldots, g_m$ forms a quasi-regular sequence
generating $\mathcal{J}$. Since $i$ is locally of finite presentation
we may in addition assume that $\mathcal{I}$ is generated by
$f_1, \ldots, f_n$ (use
Morphisms, Lemma \ref{morphisms-lemma-closed-immersion-finite-presentation},
...
\source{stacks:0690}
\href{https://stacks.math.columbia.edu/tag/0690}{\texttt{Stacks tag 0690}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-Noetherian-scheme-regular-ideal, divisors-lemma-composition-regular-immersion, divisors-lemma-transitivity-conormal-quasi-regular, divisors-lemma-generate-regular-ideal}
...
Lemma \ref{divisors-lemma-composition-regular-immersion}.
The implication (2) $\Rightarrow$ (3) is
Lemma \ref{divisors-lemma-transitivity-conormal-quasi-regular}.
...
\begin{remark}[Not always extra permanence]
\label{divisors-remark-not-always-extra-permanence}
\source{stacks:0691}
\href{https://stacks.math.columbia.edu/tag/0691}{\texttt{Stacks tag 0691}}
\group{divisors}

\uses{divisors-lemma-extra-permanence-regular-immersion-noetherian}
In the situation of
Lemma \ref{divisors-lemma-extra-permanence-regular-immersion-noetherian}
...
\begin{lemma}[Koszul regular smooth locally regular]
\label{divisors-lemma-koszul-regular-smooth-locally-regular}
\source{stacks:0692}
\href{https://stacks.math.columbia.edu/tag/0692}{\texttt{Stacks tag 0692}}
\group{divisors}
...
\begin{lemma}[Immersion regular regular immersion]
\label{divisors-lemma-immersion-regular-regular-immersion}
\source{stacks:0E9J}
\href{https://stacks.math.columbia.edu/tag/0E9J}{\texttt{Stacks tag 0E9J}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-Noetherian-scheme-regular-ideal}

Let $z \in Z$. By Lemma \ref{divisors-lemma-Noetherian-scheme-regular-ideal}
...
\begin{lemma}[Relative regular immersion]
\label{divisors-lemma-relative-regular-immersion}
\source{stacks:063R}
\href{https://stacks.math.columbia.edu/tag/063R}{\texttt{Stacks tag 063R}}
\group{divisors}
...
\begin{definition}[Relative H1 regular immersion]
\label{divisors-definition-relative-H1-regular-immersion}
\source{stacks:063S}
\href{https://stacks.math.columbia.edu/tag/063S}{\texttt{Stacks tag 063S}}
\group{divisors}
...
We warn the reader that this may be nonstandard notation.
Lemma \ref{divisors-lemma-relative-regular-immersion}
...
Lemma \ref{divisors-lemma-flat-relative-H1-regular}
(or
...
\begin{lemma}[Quasi regular immersion flat at x]
\label{divisors-lemma-quasi-regular-immersion-flat-at-x}
\source{stacks:063T}
\href{https://stacks.math.columbia.edu/tag/063T}{\texttt{Stacks tag 063T}}
\group{divisors}
...
\begin{lemma}[Relative regular immersion flat in neighbourhood]
\label{divisors-lemma-relative-regular-immersion-flat-in-neighbourhood}
\source{stacks:063U}
\href{https://stacks.math.columbia.edu/tag/063U}{\texttt{Stacks tag 063U}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-fibre-Cartier, divisors-lemma-relative-Cartier}
...
By
Lemma \ref{divisors-lemma-fibre-Cartier}
...
\begin{remark}[Relative regular immersion elements]
\label{divisors-remark-relative-regular-immersion-elements}
\source{stacks:0FUD}
\href{https://stacks.math.columbia.edu/tag/0FUD}{\texttt{Stacks tag 0FUD}}
\group{divisors}

\uses{divisors-lemma-relative-regular-immersion, divisors-lemma-relative-regular-immersion-flat-in-neighbourhood}
...
Lemma \ref{divisors-lemma-relative-regular-immersion} above).
Now the proof of
Lemma \ref{divisors-lemma-relative-regular-immersion-flat-in-neighbourhood}
...
\begin{lemma}[Flat relative H1 regular]
\label{divisors-lemma-flat-relative-H1-regular}
\source{stacks:063V}
\href{https://stacks.math.columbia.edu/tag/063V}{\texttt{Stacks tag 063V}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-quasi-regular-immersion-flat-at-x, divisors-lemma-relative-regular-immersion-flat-in-neighbourhood}
...
point of $Z$ by
Lemma \ref{divisors-lemma-quasi-regular-immersion-flat-at-x}.
Combined with the fact that the flat locus is open in this case, see
Algebra, Theorem \ref{algebra-theorem-openness-flatness}
...
\begin{lemma}[Fibre quasi regular]
\label{divisors-lemma-fibre-quasi-regular}
\source{stacks:063W}
\href{https://stacks.math.columbia.edu/tag/063W}{\texttt{Stacks tag 063W}}
\group{divisors}

\uses{divisors-lemma-relative-regular-immersion-flat-in-neighbourhood}
Let $\varphi : X \to S$ be a flat morphism which is locally of finite
...
\begin{proof}
\uses{divisors-lemma-fibre-Cartier}
...
\begin{lemma}[Section smooth regular immersion]
\label{divisors-lemma-section-smooth-regular-immersion}
\source{stacks:067R}
\href{https://stacks.math.columbia.edu/tag/067R}{\texttt{Stacks tag 067R}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-fibre-quasi-regular}
...
Thus, according to
Lemma \ref{divisors-lemma-fibre-quasi-regular},
...
Lemma \ref{divisors-lemma-push-regular-immersion-thru-smooth}.

\begin{lemma}[Lift regular immersion to smooth]
\label{divisors-lemma-lift-regular-immersion-to-smooth}
\source{stacks:067S}
\href{https://stacks.math.columbia.edu/tag/067S}{\texttt{Stacks tag 067S}}
\group{divisors}

Let
$$
\begin{array}{ccc}Y \underset{j}{\searrow}\underset{i}{\longrightarrow} &  & X \swarrow \\  & S & \end{array}
$$
...
\begin{proof}
\uses{divisors-lemma-section-smooth-regular-immersion, divisors-lemma-flat-base-change-regular-immersion, divisors-lemma-composition-regular-immersion}
...
$$
By
Lemma \ref{divisors-lemma-section-smooth-regular-immersion}
...
Lemma \ref{divisors-lemma-flat-base-change-regular-immersion}.
We conclude by an application of
Lemma \ref{divisors-lemma-composition-regular-immersion}.
\end{proof}

\begin{lemma}[Immersion lci into smooth regular immersion]
\label{divisors-lemma-immersion-lci-into-smooth-regular-immersion}
\source{stacks:067T}
\href{https://stacks.math.columbia.edu/tag/067T}{\texttt{Stacks tag 067T}}
\group{divisors}

Let
$$
\begin{array}{ccc}Y \searrow\underset{i}{\longrightarrow} &  & X \swarrow \\  & S & \end{array}
$$
be a commutative diagram of morphisms of schemes.
...
\begin{proof}
\uses{divisors-lemma-fibre-quasi-regular, divisors-lemma-Noetherian-scheme-regular-ideal}
...
\begin{lemma}[Immersion smooth into smooth regular immersion]
\label{divisors-lemma-immersion-smooth-into-smooth-regular-immersion}
\source{stacks:067U}
\href{https://stacks.math.columbia.edu/tag/067U}{\texttt{Stacks tag 067U}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-immersion-lci-into-smooth-regular-immersion}

This is a special case of
Lemma \ref{divisors-lemma-immersion-lci-into-smooth-regular-immersion}
because a smooth morphism is syntomic, see
Morphisms, Lemma \ref{morphisms-lemma-smooth-syntomic}.
\end{proof}

\begin{lemma}[Push regular immersion thru smooth]
\label{divisors-lemma-push-regular-immersion-thru-smooth}
\source{stacks:0693}
\href{https://stacks.math.columbia.edu/tag/0693}{\texttt{Stacks tag 0693}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-regular-quasi-regular-immersion, divisors-lemma-permanence-regular-immersion, divisors-lemma-immersion-smooth-into-smooth-regular-immersion, divisors-lemma-composition-regular-immersion}

We will use Lemma \ref{divisors-lemma-regular-quasi-regular-immersion}
...
Lemma \ref{divisors-lemma-permanence-regular-immersion}.
...
Lemma \ref{divisors-lemma-composition-regular-immersion} (note that this step
...
Definition \ref{divisors-definition-regular-section}. The restriction
...
\begin{definition}[Sheaf meromorphic functions]
\label{divisors-definition-sheaf-meromorphic-functions}
\source{stacks:01X2}
\href{https://stacks.math.columbia.edu/tag/01X2}{\texttt{Stacks tag 01X2}}
\group{divisors}
...
\begin{example}[No change]
\label{divisors-example-no-change}
\source{stacks:01X3}
\href{https://stacks.math.columbia.edu/tag/01X3}{\texttt{Stacks tag 01X3}}
\group{divisors}
...
\begin{definition}[Meromorphic section]
\label{divisors-definition-meromorphic-section}
\source{stacks:01X4}
\href{https://stacks.math.columbia.edu/tag/01X4}{\texttt{Stacks tag 01X4}}
\group{divisors}
...
\begin{definition}[Pullback meromorphic sections]
\label{divisors-definition-pullback-meromorphic-sections}
\source{stacks:02OT}
\href{https://stacks.math.columbia.edu/tag/02OT}{\texttt{Stacks tag 02OT}}
\group{divisors}
...
of ringed spaces
$$
\begin{array}{cc}(X, \mathcal{K}_X) \longrightarrow\overset{f}{\downarrow} & (X, \mathcal{O}_X) \overset{f}{\downarrow} \\ (Y, \mathcal{K}_Y) \longrightarrow & (Y, \mathcal{O}_Y)\end{array}
$$
We sometimes denote $f^*(s) = f^\sharp(s)$ for a
section $s \in \Gamma(Y, \mathcal{K}_Y)$.

\begin{lemma}[Pullback meromorphic sections defined]
\label{divisors-lemma-pullback-meromorphic-sections-defined}
\source{stacks:02OU}
\href{https://stacks.math.columbia.edu/tag/02OU}{\texttt{Stacks tag 02OU}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-regular-section-structure-sheaf, divisors-lemma-ass-weakly-ass, divisors-lemma-weakass-reduced}
...
in Lemma \ref{divisors-lemma-regular-section-structure-sheaf} we have to
...
Algebra, Lemma \ref{algebra-lemma-weakly-ass-zero-divisors}.
Case (5) is a special case of (1) by Lemma \ref{divisors-lemma-ass-weakly-ass}.
...
\begin{lemma}[Meromorphic weakass finite]
\label{divisors-lemma-meromorphic-weakass-finite}
\source{stacks:0EMF}
\href{https://stacks.math.columbia.edu/tag/0EMF}{\texttt{Stacks tag 0EMF}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-pullback-meromorphic-sections-defined}
...
Lemma \ref{divisors-lemma-pullback-meromorphic-sections-defined}.
This gives a map
$$
...
\begin{definition}[Regular meromorphic section]
\label{divisors-definition-regular-meromorphic-section}
\source{stacks:02OX}
\href{https://stacks.math.columbia.edu/tag/02OX}{\texttt{Stacks tag 02OX}}
\group{divisors}

\uses{divisors-definition-regular-section}
Let $X$ be a locally ringed space.
Let $\mathcal{L}$ be an invertible $\mathcal{O}_X$-module.
...
Definition \ref{divisors-definition-regular-section}.
\end{definition}

Let us spell out when (regular) meromorphic sections can be pulled back.

\begin{lemma}[Meromorphic sections pullback]
\label{divisors-lemma-meromorphic-sections-pullback}
\source{stacks:02OY}
\href{https://stacks.math.columbia.edu/tag/02OY}{\texttt{Stacks tag 02OY}}
\group{divisors}

\uses{divisors-definition-pullback-meromorphic-sections}
Let $f : X \to Y$ be a morphism of locally ringed spaces.
Assume that pullbacks of meromorphic functions are defined
for $f$ (see
Definition \ref{divisors-definition-pullback-meromorphic-sections}).
\begin{enumerate}
...
\begin{lemma}[Regular meromorphic ideal denominators]
\label{divisors-lemma-regular-meromorphic-ideal-denominators}
\source{stacks:02P0}
\href{https://stacks.math.columbia.edu/tag/02P0}{\texttt{Stacks tag 02P0}}
\group{divisors}
...
\begin{definition}[Regular meromorphic ideal denominators]
\label{divisors-definition-regular-meromorphic-ideal-denominators}
\source{stacks:02P1}
\href{https://stacks.math.columbia.edu/tag/02P1}{\texttt{Stacks tag 02P1}}
\group{divisors}

\uses{divisors-lemma-regular-meromorphic-ideal-denominators}
Let $X$ be a scheme.
Let $\mathcal{L}$ be an invertible $\mathcal{O}_X$-module.
Let $s$ be a regular meromorphic section of $\mathcal{L}$.
The sheaf of ideals $\mathcal{I}$ constructed in
Lemma \ref{divisors-lemma-regular-meromorphic-ideal-denominators}
...
\begin{lemma}[Meromorphic section restricts to zero]
\label{divisors-lemma-meromorphic-section-restricts-to-zero}
\source{stacks:08I7}
\href{https://stacks.math.columbia.edu/tag/08I7}{\texttt{Stacks tag 08I7}}
\group{divisors}
...
\begin{lemma}[Locally Noetherian K]
\label{divisors-lemma-locally-Noetherian-K}
\source{stacks:02OV}
\href{https://stacks.math.columbia.edu/tag/02OV}{\texttt{Stacks tag 02OV}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-meromorphic-section-restricts-to-zero}
...
Lemma \ref{divisors-lemma-meromorphic-section-restricts-to-zero}.
...
\begin{lemma}[Quasi coherent K]
\label{divisors-lemma-quasi-coherent-K}
\source{stacks:0EMH}
\href{https://stacks.math.columbia.edu/tag/0EMH}{\texttt{Stacks tag 0EMH}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-meromorphic-weakass-finite, divisors-lemma-ass-weakly-ass}

This lemma is a special case of
Lemma \ref{divisors-lemma-meromorphic-weakass-finite}
because in the locally Noetherian case
weakly associated points are the same thing
as associated points by Lemma \ref{divisors-lemma-ass-weakly-ass}.
\end{proof}

\begin{lemma}[Regular meromorphic section exists noetherian]
\label{divisors-lemma-regular-meromorphic-section-exists-noetherian}
\source{stacks:0EMI}
\href{https://stacks.math.columbia.edu/tag/0EMI}{\texttt{Stacks tag 0EMI}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-quasi-coherent-K}
...
Lemma \ref{divisors-lemma-quasi-coherent-K} that $s = \prod s_\eta$
is a regular meromorphic section of $\mathcal{L}$.
\end{proof}

\begin{lemma}[Make maps regular section]
\label{divisors-lemma-make-maps-regular-section}
\source{stacks:02P2}
\href{https://stacks.math.columbia.edu/tag/02P2}{\texttt{Stacks tag 02P2}}
\group{divisors}
...
proof of Lemma \ref{divisors-lemma-regular-meromorphic-ideal-denominators}).
...
\begin{lemma}[Reduced finite irreducible]
\label{divisors-lemma-reduced-finite-irreducible}
\source{stacks:02OW}
\href{https://stacks.math.columbia.edu/tag/02OW}{\texttt{Stacks tag 02OW}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-meromorphic-weakass-finite, divisors-lemma-weakass-reduced}
...
\begin{lemma}[Reduced normalization]
\label{divisors-lemma-reduced-normalization}
\source{stacks:035T}
\href{https://stacks.math.columbia.edu/tag/035T}{\texttt{Stacks tag 035T}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-reduced-finite-irreducible}
...
Lemma \ref{divisors-lemma-reduced-finite-irreducible} above.
\end{proof}

\begin{lemma}[Meromorphic functions integral scheme]
\label{divisors-lemma-meromorphic-functions-integral-scheme}
\source{stacks:01X5}
\href{https://stacks.math.columbia.edu/tag/01X5}{\texttt{Stacks tag 01X5}}
\group{divisors}
...
\begin{lemma}[Regular meromorphic section exists]
\label{divisors-lemma-regular-meromorphic-section-exists}
\source{stacks:02OZ}
\href{https://stacks.math.columbia.edu/tag/02OZ}{\texttt{Stacks tag 02OZ}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-meromorphic-functions-integral-scheme, divisors-lemma-reduced-finite-irreducible, divisors-lemma-regular-meromorphic-section-exists-noetherian}

In case (1) let $\eta \in X$ be the generic point. We have seen in
Lemma \ref{divisors-lemma-meromorphic-functions-integral-scheme}
...
in Lemma \ref{divisors-lemma-reduced-finite-irreducible}
that $s = \prod s_\eta$ is a regular meromorphic section of $\mathcal{L}$.
Case (3) is Lemma \ref{divisors-lemma-regular-meromorphic-section-exists-noetherian}.
\end{proof}
...
\begin{lemma}[Components locally finite]
\label{divisors-lemma-components-locally-finite}
\source{stacks:0BE1}
\href{https://stacks.math.columbia.edu/tag/0BE1}{\texttt{Stacks tag 0BE1}}
\group{divisors}
...
\source{stacks:0BE2}
\href{https://stacks.math.columbia.edu/tag/0BE2}{\texttt{Stacks tag 0BE2}}
\group{divisors}
...
\begin{definition}[Order vanishing]
\label{divisors-definition-order-vanishing}
\source{stacks:02RJ}
\href{https://stacks.math.columbia.edu/tag/02RJ}{\texttt{Stacks tag 02RJ}}
\group{divisors}
...
\begin{lemma}[Divisor locally finite]
\label{divisors-lemma-divisor-locally-finite}
\source{stacks:02RL}
\href{https://stacks.math.columbia.edu/tag/02RL}{\texttt{Stacks tag 02RL}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-components-locally-finite}
...
Hence Lemma \ref{divisors-lemma-components-locally-finite} gives the desired result.
\end{proof}
...
\source{stacks:0BE3}
\href{https://stacks.math.columbia.edu/tag/0BE3}{\texttt{Stacks tag 0BE3}}
\group{divisors}

\uses{divisors-definition-order-vanishing, divisors-lemma-divisor-locally-finite}
Let $X$ be a locally Noetherian integral scheme. Let $f \in R(X)^*$.
...
Definition \ref{divisors-definition-order-vanishing}. This makes sense
by Lemma \ref{divisors-lemma-divisor-locally-finite}.
\end{definition}

\begin{lemma}[Div additive]
\label{divisors-lemma-div-additive}
\source{stacks:02RP}
\href{https://stacks.math.columbia.edu/tag/02RP}{\texttt{Stacks tag 02RP}}
\group{divisors}
...
\source{stacks:0BE4}
\href{https://stacks.math.columbia.edu/tag/0BE4}{\texttt{Stacks tag 0BE4}}
\group{divisors}
...
Section \ref{divisors-section-Weil-divisors} to define a canonical map
$\Pic(X) \to \text{Cl}(X)$
...
\begin{definition}[Order vanishing meromorphic]
\label{divisors-definition-order-vanishing-meromorphic}
\source{stacks:02SF}
\href{https://stacks.math.columbia.edu/tag/02SF}{\texttt{Stacks tag 02SF}}
\group{divisors}
...
\begin{lemma}[Divisor meromorphic locally finite]
\label{divisors-lemma-divisor-meromorphic-locally-finite}
\source{stacks:02SG}
\href{https://stacks.math.columbia.edu/tag/02SG}{\texttt{Stacks tag 02SG}}
\group{divisors}
...
Hence Lemma \ref{divisors-lemma-components-locally-finite}.
gives the desired result.
\end{proof}

\begin{lemma}[Divisor meromorphic well defined]
\label{divisors-lemma-divisor-meromorphic-well-defined}
\source{stacks:02SH}
\href{https://stacks.math.columbia.edu/tag/02SH}{\texttt{Stacks tag 02SH}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-divisor-meromorphic-locally-finite}

This is clear from the definitions.
Note that Lemma \ref{divisors-lemma-divisor-meromorphic-locally-finite}
...
\source{stacks:0BE6}
\href{https://stacks.math.columbia.edu/tag/0BE6}{\texttt{Stacks tag 0BE6}}
\group{divisors}

\uses{divisors-lemma-divisor-meromorphic-well-defined}
Let $X$ be a locally Noetherian integral scheme.
Let $\mathcal{L}$ be an invertible $\mathcal{O}_X$-module.
\begin{enumerate}
...
Lemma \ref{divisors-lemma-divisor-meromorphic-well-defined}.
\end{enumerate}
\end{definition}

As expected this construction is additive in the invertible module.

\begin{lemma}[C1 additive]
\label{divisors-lemma-c1-additive}
\source{stacks:02SL}
\href{https://stacks.math.columbia.edu/tag/02SL}{\texttt{Stacks tag 02SL}}
\group{divisors}
...
\begin{lemma}[Normal c1 injective]
\label{divisors-lemma-normal-c1-injective}
\source{stacks:0BE8}
\href{https://stacks.math.columbia.edu/tag/0BE8}{\texttt{Stacks tag 0BE8}}
\group{divisors}
...
\begin{lemma}[Local rings UFD c1 bijective]
\label{divisors-lemma-local-rings-UFD-c1-bijective}
\source{stacks:0BE9}
\href{https://stacks.math.columbia.edu/tag/0BE9}{\texttt{Stacks tag 0BE9}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-normal-c1-injective, divisors-lemma-weil-divisor-is-cartier-UFD, divisors-definition-invertible-sheaf-effective-Cartier-divisor}

If (1) holds, then $X$ is normal by
Algebra, Lemma \ref{algebra-lemma-UFD-normal}.
Hence the map (\ref{equation-c1}) is injective by
Lemma \ref{divisors-lemma-normal-c1-injective}. Moreover,
every prime divisor $D \subset X$ is an effective
Cartier divisor by Lemma \ref{divisors-lemma-weil-divisor-is-cartier-UFD}.
In this case the canonical section $1_D$ of $\mathcal{O}_X(D)$
(Definition \ref{divisors-definition-invertible-sheaf-effective-Cartier-divisor})
...
\begin{lemma}[In image pullback]
\label{divisors-lemma-in-image-pullback}
\source{stacks:0BD7}
\href{https://stacks.math.columbia.edu/tag/0BD7}{\texttt{Stacks tag 0BD7}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-flat-over-integral-integral-fibre, divisors-lemma-pullback-meromorphic-sections-defined}
...
Lemma \ref{divisors-lemma-flat-over-integral-integral-fibre}.
Hence we can think of $s$ as a regular meromorphic section of $\mathcal{L}$.
Pullbacks of meromorphic functions are defined for
$\varphi$ by Lemma \ref{divisors-lemma-pullback-meromorphic-sections-defined}.
...
\begin{lemma}[Closure effective cartier divisor]
\label{divisors-lemma-closure-effective-cartier-divisor}
\source{stacks:0BD8}
\href{https://stacks.math.columbia.edu/tag/0BD8}{\texttt{Stacks tag 0BD8}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-effective-Cartier-in-points, divisors-lemma-effective-Cartier-divisor-is-a-sum, divisors-lemma-effective-Cartier-codimension-1}
...
by one element, see Lemma \ref{divisors-lemma-effective-Cartier-in-points}.
...
\begin{proof}
\uses{divisors-lemma-quasi-projective-Noetherian-pic-effective-Cartier, divisors-lemma-closure-effective-cartier-divisor}
...
Lemma \ref{divisors-lemma-quasi-projective-Noetherian-pic-effective-Cartier}.
Then $D_1$ and $D_2$ extend to effective Cartier divisors of
$W$ by Lemma \ref{divisors-lemma-closure-effective-cartier-divisor}
...
\begin{lemma}[Open subscheme UFD]
\label{divisors-lemma-open-subscheme-UFD}
\source{stacks:0BDA}
\href{https://stacks.math.columbia.edu/tag/0BDA}{\texttt{Stacks tag 0BDA}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-extend-invertible-module}

Any polynomial ring over $R$ is a UFD by
Algebra, Lemma \ref{algebra-lemma-polynomial-ring-UFD}.
Thus the question is to show that $\Pic(U)$ is trivial
if $U \subset \Spec(R)$ is a (nonempty) open.

\medskip\noindent
In the Noetherian case, we may use Lemma \ref{divisors-lemma-extend-invertible-module}
to reduce to showing $\Pic(\Spec(R))$ is trivial. This in turn is
proved in More on Algebra, Lemma \ref{more-algebra-lemma-UFD-Pic-trivial}.
We urge the reader to skip the rest of the proof.

\medskip\noindent
Let $U \subset \Spec(R)$ be a nonempty open. Choose a nonzero $f \in R$
with $D(f) \subset U$. Since $f$ is a product of prime elements of $R$
we conclude that there are finitely many prime elements
$a_1, \ldots, a_n \in R$ such that $(a_i) \not \in U$ (or
equivalentaly $U \cap V(a_i) = \emptyset$).
After replacing $R$ by $R_{a_1 \ldots a_n}$ we may assume that
$U$ contains all principal prime ideals. (Note that a localization
of a UFD is a UFD, for example by Algebra, Lemma
\ref{algebra-lemma-invert-prime-elements}.)

\medskip\noindent
Assume $U$ contains all principal prime ideals.
Write $U = \Spec(R) \setminus V(I)$ for some ideal $I \subset R$.
Pick $f \in I$ nonzero and write $f = a_1 \ldots a_n$ as a product
of prime elements. Since $(a_i) \not \in V(I)$ we may choose $g \in I$ with
$g \not \in (a_i)$ for all $i$ (prime avoidance). Picture
$$
U' = D(f) \cup D(g) \subset U \subset \Spec(R)
$$
By More on Algebra, Lemma \ref{more-algebra-lemma-UFD-Pic-trivial}
the Picard groups of $D(f)$ and $D(g)$ are trivial and by an elementary
argument about UFDs the map $R_f^* \times R_g^* \to R_{fg}^*$,
$(u, v) \mapsto uv^{-1}$ is surjective. We conclude that
$\Pic(U')$ is trivial.

\medskip\noindent
Thus it suffices to show that an invertible module $\mathcal{L}$
on $U$ whose pullback by $j : U' \to U'$ is trivial, is trivial.
To do this it suffices to show that the map
$\mathcal{L} \to j_*j^*\mathcal{L}$ is an isomorphism.
For this in turn, let $u \in U \setminus U'$. Then
$f, g \in \mathfrak m_u \subset \mathcal{O}_{U, u} = A$ are elements
of a local UFD which do not have a prime factor in common. The reader
easily shows that this means that
$$
0 \to A \to A_f \times A_g \to A_{fg}
$$
is exact by looking at prime factors. Since $A = \mathcal{L}_u$
because $\mathcal{L}$ is invertible and since $(j_*j^*\mathcal{L})_u$
is the kernel of $A_f \times A_g \to A_{fg}$ we conclude.
\end{proof}

\begin{lemma}[Pic projective space UFD]
\label{divisors-lemma-Pic-projective-space-UFD}
\source{stacks:0BXJ}
\href{https://stacks.math.columbia.edu/tag/0BXJ}{\texttt{Stacks tag 0BXJ}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-open-subscheme-UFD}

By Lemma \ref{divisors-lemma-open-subscheme-UFD} the Picard groups of the opens
...
\begin{lemma}[Reflexive normal]
\label{divisors-lemma-reflexive-normal}
\source{stacks:0EBL}
\href{https://stacks.math.columbia.edu/tag/0EBL}{\texttt{Stacks tag 0EBL}}
\group{divisors}
...
\begin{proof}
\uses{divisors-remark-tensor, divisors-lemma-reflexive-over-normal, divisors-lemma-reflexive-S2-extend}

Although not strictly necessary, we recommend reading
Remark \ref{divisors-remark-tensor} before proceeding with the proof.
...
locally free, see Lemma \ref{divisors-lemma-reflexive-over-normal}.
The map
$$
...
(by Lemma \ref{divisors-lemma-reflexive-S2-extend} and Serre's criterion
Properties, Lemma \ref{properties-lemma-criterion-normal}),
...
\begin{lemma}[Normal class group]
\label{divisors-lemma-normal-class-group}
\source{stacks:0EBM}
\href{https://stacks.math.columbia.edu/tag/0EBM}{\texttt{Stacks tag 0EBM}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-reflexive-over-normal, divisors-lemma-normal-c1-injective, divisors-lemma-reflexive-S2-extend, divisors-lemma-sum-effective-Cartier-divisors}
...
Lemma \ref{divisors-lemma-reflexive-over-normal}.
...
$\mathcal{F}|_U$ is trivial (Lemma \ref{divisors-lemma-normal-c1-injective})
and hence $\mathcal{F}$ is trivial too by
Lemma \ref{divisors-lemma-reflexive-S2-extend} and Serre's criterion
Properties, Lemma \ref{properties-lemma-criterion-normal}.
...
Lemma \ref{divisors-lemma-sum-effective-Cartier-divisors}.
...
Lemma \ref{divisors-lemma-reflexive-S2-extend} we find that $D$ is
...
\begin{lemma}[Structure sheaf Xs]
\label{divisors-lemma-structure-sheaf-Xs}
\source{stacks:0EBN}
\href{https://stacks.math.columbia.edu/tag/0EBN}{\texttt{Stacks tag 0EBN}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-reflexive-over-normal, divisors-lemma-reflexive-S2-extend}
...
$\mathcal{F}|_V$ is invertible, see Lemma \ref{divisors-lemma-reflexive-over-normal}.
...
See Lemma \ref{divisors-lemma-reflexive-S2-extend} and Serre's criterion
Properties, Lemma \ref{properties-lemma-criterion-normal}.
...
\begin{lemma}[Xs codim complement]
\label{divisors-lemma-Xs-codim-complement}
\source{stacks:0EBP}
\href{https://stacks.math.columbia.edu/tag/0EBP}{\texttt{Stacks tag 0EBP}}
\group{divisors}

\uses{divisors-lemma-structure-sheaf-Xs}
Assumptions and notation as in Lemma \ref{divisors-lemma-structure-sheaf-Xs}.
If $s$ is nonzero, then every irreducible component of $X \setminus U$
has codimension $1$ in $X$.
\end{lemma}

\begin{proof}
\uses{divisors-lemma-reflexive-S2-extend}
...
\begin{remark}[Structure sheaf Xs]
\label{divisors-remark-structure-sheaf-Xs}
\source{stacks:0EBQ}
\href{https://stacks.math.columbia.edu/tag/0EBQ}{\texttt{Stacks tag 0EBQ}}
\group{divisors}

\uses{divisors-lemma-structure-sheaf-Xs, divisors-lemma-Xs-codim-complement}
...
Then the open $U$ of Lemma \ref{divisors-lemma-structure-sheaf-Xs} is
$$
U = \Spec(A) \setminus
\left(V(\mathfrak p_1) \cup \ldots \cup V(\mathfrak p_r)\right)
$$
by Lemma \ref{divisors-lemma-Xs-codim-complement}. Moreover, if $M^{[n]}$
denotes the reflexive hull of $M \otimes_A \ldots \otimes_A M$
($n$-factors), then
$$
\Gamma(U, \mathcal{O}_U) = \colim M^{[n]}
$$
according to Lemma \ref{divisors-lemma-structure-sheaf-Xs}.
\end{remark}

\begin{lemma}[Affine Xs]
\label{divisors-lemma-affine-Xs}
\source{stacks:0EBR}
\href{https://stacks.math.columbia.edu/tag/0EBR}{\texttt{Stacks tag 0EBR}}
\group{divisors}
...
By Lemma \ref{divisors-lemma-structure-sheaf-Xs} we have
...
$$
\begin{array}{cc}U_x \underset{j_x}{\downarrow}\longrightarrow & U \overset{j}{\downarrow} \\ \Spec(\mathcal{O}_{X, x}) \longrightarrow & X\end{array}
$$
...
\begin{lemma}[Relative proj quasi compact]
\label{divisors-lemma-relative-proj-quasi-compact}
\source{stacks:07ZX}
\href{https://stacks.math.columbia.edu/tag/07ZX}{\texttt{Stacks tag 07ZX}}
\group{divisors}
...
\begin{lemma}[Relative proj finite type]
\label{divisors-lemma-relative-proj-finite-type}
\source{stacks:07ZY}
\href{https://stacks.math.columbia.edu/tag/07ZY}{\texttt{Stacks tag 07ZY}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-relative-proj-quasi-compact}

The assumption implies that $p$ is quasi-compact, see
Lemma \ref{divisors-lemma-relative-proj-quasi-compact}. Hence it suffices
...
\begin{lemma}[Relative proj universally closed]
\label{divisors-lemma-relative-proj-universally-closed}
\source{stacks:07ZZ}
\href{https://stacks.math.columbia.edu/tag/07ZZ}{\texttt{Stacks tag 07ZZ}}
\group{divisors}
...
\begin{lemma}[Relative proj proper]
\label{divisors-lemma-relative-proj-proper}
\source{stacks:0800}
\href{https://stacks.math.columbia.edu/tag/0800}{\texttt{Stacks tag 0800}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-relative-proj-finite-type, divisors-lemma-relative-proj-universally-closed}
...
\medskip\noindent
By Lemma \ref{divisors-lemma-relative-proj-finite-type}
...
This follows from Lemma \ref{divisors-lemma-relative-proj-universally-closed}.
\end{proof}

\begin{lemma}[Relative proj projective]
\label{divisors-lemma-relative-proj-projective}
\source{stacks:0B3U}
\href{https://stacks.math.columbia.edu/tag/0B3U}{\texttt{Stacks tag 0B3U}}
\group{divisors}
...
\begin{lemma}[Relative proj flat]
\label{divisors-lemma-relative-proj-flat}
\source{stacks:0D4C}
\href{https://stacks.math.columbia.edu/tag/0D4C}{\texttt{Stacks tag 0D4C}}
\group{divisors}
...
\begin{lemma}[Relative proj finite presentation]
\label{divisors-lemma-relative-proj-finite-presentation}
\source{stacks:0D4D}
\href{https://stacks.math.columbia.edu/tag/0D4D}{\texttt{Stacks tag 0D4D}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-relative-proj-finite-type}
...
\begin{lemma}[Closed subscheme proj]
\label{divisors-lemma-closed-subscheme-proj}
\source{stacks:0801}
\href{https://stacks.math.columbia.edu/tag/0801}{\texttt{Stacks tag 0801}}
\group{divisors}
...
\begin{example}[Closed subscheme of proj]
\label{divisors-example-closed-subscheme-of-proj}
\source{stacks:0BXK}
\href{https://stacks.math.columbia.edu/tag/0BXK}{\texttt{Stacks tag 0BXK}}
\group{divisors}

\uses{divisors-lemma-closed-subscheme-proj}
...
\ref{constructions-lemma-surjective-graded-rings-map-proj}.
Translating the result of Lemma \ref{divisors-lemma-closed-subscheme-proj}
...
\source{stacks:0BXL}
\href{https://stacks.math.columbia.edu/tag/0BXL}{\texttt{Stacks tag 0BXL}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-codimension-1-is-effective-Cartier, divisors-lemma-Pic-projective-space-UFD}
...
Lemma \ref{divisors-lemma-codimension-1-is-effective-Cartier}.
...
Lemma \ref{divisors-lemma-Pic-projective-space-UFD}.
...
\begin{lemma}[Closed subscheme proj finite]
\label{divisors-lemma-closed-subscheme-proj-finite}
\source{stacks:0802}
\href{https://stacks.math.columbia.edu/tag/0802}{\texttt{Stacks tag 0802}}
\group{divisors}
...
By Lemma \ref{divisors-lemma-closed-subscheme-proj} we know there exists a
...
The following version of Lemma \ref{divisors-lemma-closed-subscheme-proj-finite}
will be used in the proof of
Lemma \ref{divisors-lemma-composition-admissible-blowups}.

\begin{lemma}[Closed subscheme proj finite type]
\label{divisors-lemma-closed-subscheme-proj-finite-type}
\source{stacks:0803}
\href{https://stacks.math.columbia.edu/tag/0803}{\texttt{Stacks tag 0803}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-closed-subscheme-proj, divisors-lemma-closed-subscheme-proj-finite}

Let $\mathcal{I} \subset \mathcal{A}$ be the sheaf of quasi-coherent
graded ideals constructed in Lemma \ref{divisors-lemma-closed-subscheme-proj}.
Let $U_i$, $R_i$, $A_i$, $I_i$, $f_{i, j}$, $h_{i, j, k}$, and $d$
be as constructed in the proof of
Lemma \ref{divisors-lemma-closed-subscheme-proj-finite}.
...
\begin{lemma}[Conormal sheaf section projective bundle]
\label{divisors-lemma-conormal-sheaf-section-projective-bundle}
\source{stacks:0B3V}
\href{https://stacks.math.columbia.edu/tag/0B3V}{\texttt{Stacks tag 0B3V}}
\group{divisors}
...
\source{stacks:01OG}
\href{https://stacks.math.columbia.edu/tag/01OG}{\texttt{Stacks tag 01OG}}
\group{divisors}
...
\begin{lemma}[Blowing up affine]
\label{divisors-lemma-blowing-up-affine}
\source{stacks:0804}
\href{https://stacks.math.columbia.edu/tag/0804}{\texttt{Stacks tag 0804}}
\group{divisors}
...
\begin{lemma}[Blowing up commutes with flat base change.]
\label{divisors-lemma-flat-base-change-blowing-up}
\source{stacks:0805}
\href{https://stacks.math.columbia.edu/tag/0805}{\texttt{Stacks tag 0805}}
\group{divisors}
...
diagram
$$
\begin{array}{cc}X_1' \longrightarrow\downarrow & X_2' \downarrow \\ X_1 \longrightarrow & X_2\end{array}
$$
of schemes.
\end{lemma}
...
\begin{lemma}[Blowing up gives effective Cartier divisor]
\label{divisors-lemma-blowing-up-gives-effective-Cartier-divisor}
\source{stacks:02OS}
\href{https://stacks.math.columbia.edu/tag/02OS}{\texttt{Stacks tag 02OS}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-flat-base-change-blowing-up, divisors-lemma-blowing-up-affine}

As blowing up commutes with restrictions to open subschemes
(Lemma \ref{divisors-lemma-flat-base-change-blowing-up}) the first statement
...
Say $X = \Spec(A)$ and $Z = \Spec(A/I)$. By Lemma \ref{divisors-lemma-blowing-up-affine}
...
\source{stacks:0806}
\href{https://stacks.math.columbia.edu/tag/0806}{\texttt{Stacks tag 0806}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-blowing-up-gives-effective-Cartier-divisor, divisors-lemma-complement-effective-Cartier-divisor}
...
according to Lemma \ref{divisors-lemma-complement-effective-Cartier-divisor}.
...
\begin{lemma}[Characterize affine blowup]
\label{divisors-lemma-characterize-affine-blowup}
\source{stacks:0BFL}
\href{https://stacks.math.columbia.edu/tag/0BFL}{\texttt{Stacks tag 0BFL}}
\group{divisors}
...
\begin{proof}
\uses{divisors-definition-blow-up, divisors-lemma-universal-property-blowing-up}
...
Algebra, Definition \ref{divisors-definition-blow-up}. The uniqueness mentioned
...
(Lemma \ref{divisors-lemma-universal-property-blowing-up})
this is a morphism over
$X'$, which of course implies that $x' \in U'$.
\end{proof}

\begin{lemma}[Blow up effective Cartier divisor]
\label{divisors-lemma-blow-up-effective-Cartier-divisor}
\source{stacks:0807}
\href{https://stacks.math.columbia.edu/tag/0807}{\texttt{Stacks tag 0807}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-universal-property-blowing-up}

Immediate from the universal property of blowups
(Lemma \ref{divisors-lemma-universal-property-blowing-up}).
\end{proof}

\begin{lemma}[Blow up reduced scheme]
\label{divisors-lemma-blow-up-reduced-scheme}
\source{stacks:0808}
\href{https://stacks.math.columbia.edu/tag/0808}{\texttt{Stacks tag 0808}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-blowing-up-affine}

Combine Lemma \ref{divisors-lemma-blowing-up-affine}
with Algebra, Lemma \ref{algebra-lemma-blowup-reduced}.
\end{proof}

\begin{lemma}[Blow up integral scheme]
\label{divisors-lemma-blow-up-integral-scheme}
\source{stacks:02ND}
\href{https://stacks.math.columbia.edu/tag/02ND}{\texttt{Stacks tag 02ND}}
\group{divisors}
...
\begin{lemma}[Blow up and irreducible components]
\label{divisors-lemma-blow-up-and-irreducible-components}
\source{stacks:0BFM}
\href{https://stacks.math.columbia.edu/tag/0BFM}{\texttt{Stacks tag 0BFM}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-blowing-up-gives-effective-Cartier-divisor, divisors-lemma-characterize-effective-Cartier-divisor}
...
covering. Hence by Lemma \ref{divisors-lemma-characterize-effective-Cartier-divisor}
...
\begin{lemma}[Blow up pullback effective Cartier]
\label{divisors-lemma-blow-up-pullback-effective-Cartier}
\source{stacks:0809}
\href{https://stacks.math.columbia.edu/tag/0809}{\texttt{Stacks tag 0809}}
\group{divisors}

\uses{divisors-definition-pullback-effective-Cartier-divisor, divisors-definition-pullback-meromorphic-sections}
...
(Definitions
\ref{divisors-definition-pullback-effective-Cartier-divisor} and
\ref{divisors-definition-pullback-meromorphic-sections}).
\end{lemma}

\begin{proof}
\uses{divisors-lemma-blowing-up-affine, divisors-lemma-characterize-effective-Cartier-divisor}

By Lemmas \ref{divisors-lemma-blowing-up-affine} and
...
\begin{lemma}[Blowing up two ideals]
\label{divisors-lemma-blowing-up-two-ideals}
\source{stacks:080A}
\href{https://stacks.math.columbia.edu/tag/080A}{\texttt{Stacks tag 080A}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-blowing-up-gives-effective-Cartier-divisor, divisors-lemma-blow-up-pullback-effective-Cartier, divisors-lemma-universal-property-blowing-up, divisors-lemma-sum-closed-subschemes-effective-Cartier}

Let $E \subset X'$ be the exceptional divisor of $b$ which is an effective
Cartier divisor by
Lemma \ref{divisors-lemma-blowing-up-gives-effective-Cartier-divisor}.
Then $(b')^{-1}E$ is an effective Cartier divisor on $X''$ by
Lemma \ref{divisors-lemma-blow-up-pullback-effective-Cartier}.
...
Hence according to Lemma \ref{divisors-lemma-universal-property-blowing-up}
...
Lemma \ref{divisors-lemma-sum-closed-subschemes-effective-Cartier}.
...
\begin{lemma}[Blowing up projective]
\label{divisors-lemma-blowing-up-projective}
\source{stacks:02NS}
\href{https://stacks.math.columbia.edu/tag/02NS}{\texttt{Stacks tag 02NS}}
\group{divisors}
...
\begin{lemma}[Composition of blowing ups is a blowing up]
\label{divisors-lemma-composition-finite-type-blowups}
\source{stacks:080B}
\href{https://stacks.math.columbia.edu/tag/080B}{\texttt{Stacks tag 080B}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-blowing-up-gives-effective-Cartier-divisor, divisors-lemma-closed-subscheme-proj-finite-type, divisors-lemma-blowing-up-two-ideals, divisors-lemma-blow-up-effective-Cartier-divisor, divisors-lemma-blowing-up-affine}
...
(Lemma \ref{divisors-lemma-blowing-up-gives-effective-Cartier-divisor}) the same
result shows that
$b^{-1}(X \setminus Z) \setminus Z'$ is quasi-compact open in $X'$.
Hence $U = X \setminus (Z \cup b(Z'))$ is quasi-compact open in $X$.
By Lemma \ref{divisors-lemma-closed-subscheme-proj-finite-type}
...
see Lemma \ref{divisors-lemma-blowing-up-two-ideals}.
...
and we can use Lemmas \ref{divisors-lemma-blow-up-effective-Cartier-divisor} and
\ref{divisors-lemma-blowing-up-two-ideals}.

\medskip\noindent
To see the displayed equality of the ideals we may work locally.
With notation $A$, $I$, $a \in I$ as in Lemma \ref{divisors-lemma-blowing-up-affine}
...
$$
\begin{array}{ccc}\text{pr}_{S'}^{-1}E \longrightarrow\downarrow & X \times_S S' \underset{\text{pr}_X}{\longrightarrow}\underset{\text{pr}_{S'}}{\downarrow} & X \overset{f}{\downarrow} \\ E \longrightarrow & S' \longrightarrow & S\end{array}
$$
...
\source{stacks:080D}
\href{https://stacks.math.columbia.edu/tag/080D}{\texttt{Stacks tag 080D}}
\group{divisors}
...
\begin{lemma}[Strict transform]
\label{divisors-lemma-strict-transform}
\source{stacks:080E}
\href{https://stacks.math.columbia.edu/tag/080E}{\texttt{Stacks tag 080E}}
\group{divisors}

\uses{divisors-definition-strict-transform}
In the situation of Definition \ref{divisors-definition-strict-transform}.
\begin{enumerate}
...
\begin{proof}
\uses{divisors-lemma-universal-property-blowing-up, divisors-lemma-blowing-up-affine}

Let $X'' \to X$ be the blowup of $X$ in $f^{-1}Z$. By the universal
property of blowing up (Lemma \ref{divisors-lemma-universal-property-blowing-up})
there exists a commutative diagram
$$
\begin{array}{cc}X'' \longrightarrow\downarrow & X \downarrow \\ S' \longrightarrow & S\end{array}
$$
...
$\Spec(A[\frac{I}{a}]) \subset S'$, see Lemma \ref{divisors-lemma-blowing-up-affine}.
...
\begin{lemma}[Strict transform flat]
\label{divisors-lemma-strict-transform-flat}
\source{stacks:080F}
\href{https://stacks.math.columbia.edu/tag/080F}{\texttt{Stacks tag 080F}}
\group{divisors}
...
\begin{lemma}[Strict transform affine]
\label{divisors-lemma-strict-transform-affine}
\source{stacks:080G}
\href{https://stacks.math.columbia.edu/tag/080G}{\texttt{Stacks tag 080G}}
\group{divisors}
...
\begin{lemma}[Strict transform different centers]
\label{divisors-lemma-strict-transform-different-centers}
\source{stacks:080H}
\href{https://stacks.math.columbia.edu/tag/080H}{\texttt{Stacks tag 080H}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-blowing-up-two-ideals, divisors-lemma-blow-up-effective-Cartier-divisor, divisors-lemma-blowing-up-affine}

The first statement follows on combining
Lemmas \ref{divisors-lemma-blowing-up-two-ideals} and
\ref{divisors-lemma-blow-up-effective-Cartier-divisor}.
Using Lemma \ref{divisors-lemma-blowing-up-affine} the second statement
translates into the
...
\begin{lemma}[Strict transform composition blowups]
\label{divisors-lemma-strict-transform-composition-blowups}
\source{stacks:080I}
\href{https://stacks.math.columbia.edu/tag/080I}{\texttt{Stacks tag 080I}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-strict-transform-different-centers}
...
$$
\begin{array}{ccc}X \times_S S'' \underset{q}{\longrightarrow}\overset{f''}{\downarrow} & X \times_S S' \underset{p}{\longrightarrow}\overset{f'}{\downarrow} & X \overset{f}{\downarrow} \\ S'' \longrightarrow & S' \longrightarrow & S\end{array}
$$
...
$(f \circ p \circ q)^{-1}(Y) =
(f \circ p \circ q)^{-1}Z \cup (f' \circ q)^{-1}Z'$.
This follows from Lemma \ref{divisors-lemma-strict-transform-different-centers}
applied to $\mathcal{F}'$ on $X \times_S S'$ over $S'$, the closed
subscheme $Z'$ and the effective Cartier divisor $b^{-1}Z$.
\end{proof}

\begin{lemma}[Strict transform universally injective]
\label{divisors-lemma-strict-transform-universally-injective}
\source{stacks:080W}
\href{https://stacks.math.columbia.edu/tag/080W}{\texttt{Stacks tag 080W}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-strict-transform-affine}

We may localize on $S$ and $X$ and assume both are affine.
Then we may push $\mathcal{F}_i$ to $S$, see
Lemma \ref{divisors-lemma-strict-transform-affine}.
...
\begin{definition}[Admissible blowup]
\label{divisors-definition-admissible-blowup}
\source{stacks:080K}
\href{https://stacks.math.columbia.edu/tag/080K}{\texttt{Stacks tag 080K}}
\group{divisors}
...
Lemma \ref{divisors-lemma-blowing-up-projective}.
...
Lemma \ref{divisors-lemma-blowing-up-gives-effective-Cartier-divisor}) we will often
abuse notation and think of $U$ as an open subscheme of $X'$ as well.

\begin{lemma}[Admissible blowups are stable under composition.]
\label{divisors-lemma-composition-admissible-blowups}
\source{stacks:080L}
\href{https://stacks.math.columbia.edu/tag/080L}{\texttt{Stacks tag 080L}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-composition-finite-type-blowups}

Immediate from the more precise
Lemma \ref{divisors-lemma-composition-finite-type-blowups}.
\end{proof}

\begin{lemma}[Extend admissible blowups]
\label{divisors-lemma-extend-admissible-blowups}
\source{stacks:080M}
\href{https://stacks.math.columbia.edu/tag/080M}{\texttt{Stacks tag 080M}}
\group{divisors}
...
\begin{lemma}[Dominate admissible blowups]
\label{divisors-lemma-dominate-admissible-blowups}
\source{stacks:080N}
\href{https://stacks.math.columbia.edu/tag/080N}{\texttt{Stacks tag 080N}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-blowing-up-two-ideals}
...
$X' \to X$ factors through $b_i$ by Lemma \ref{divisors-lemma-blowing-up-two-ideals}.
\end{proof}

\begin{lemma}[Separate irreducible components by blowing up.]
\label{divisors-lemma-separate-disjoint-opens-by-blowing-up}
\source{stacks:080P}
\href{https://stacks.math.columbia.edu/tag/080P}{\texttt{Stacks tag 080P}}
\group{divisors}
...
Lemma \ref{divisors-lemma-blowing-up-affine}. Suppose that $U = \Spec(A) \subset X$
...
\begin{lemma}[Blowing up denominators]
\label{divisors-lemma-blowing-up-denominators}
\source{stacks:0ESL}
\href{https://stacks.math.columbia.edu/tag/0ESL}{\texttt{Stacks tag 0ESL}}
\group{divisors}
...
\begin{proof}
\uses{divisors-definition-regular-meromorphic-ideal-denominators, divisors-definition-invertible-sheaf-effective-Cartier-divisor, divisors-lemma-blow-up-pullback-effective-Cartier, divisors-lemma-meromorphic-sections-pullback, divisors-lemma-blowing-up-affine}
...
Lemmas \ref{divisors-lemma-blow-up-pullback-effective-Cartier} and
\ref{divisors-lemma-meromorphic-sections-pullback}.
...
(Lemma \ref{divisors-lemma-blowing-up-affine}). Fix $x \in I$ and
...
\begin{lemma}[Strict transform blowup fitting ideal]
\label{divisors-lemma-strict-transform-blowup-fitting-ideal}
\source{stacks:0CZP}
\href{https://stacks.math.columbia.edu/tag/0CZP}{\texttt{Stacks tag 0CZP}}
\group{divisors}
...
Section \ref{divisors-section-fitting-ideals}.
...
\begin{lemma}[Blowup fitting ideal]
\label{divisors-lemma-blowup-fitting-ideal}
\source{stacks:0ESN}
\href{https://stacks.math.columbia.edu/tag/0ESN}{\texttt{Stacks tag 0ESN}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-fitting-ideal-of-finitely-presented, divisors-lemma-fitting-ideal-finite-locally-free, divisors-definition-admissible-blowup, divisors-lemma-strict-transform-blowup-fitting-ideal-locally-free}

The ideal $\text{Fit}_r(\mathcal{F})$ is of finite type
by Lemma \ref{divisors-lemma-fitting-ideal-of-finitely-presented}
and its restriction to $U$ is equal to $\mathcal{O}_U$ by
Lemma \ref{divisors-lemma-fitting-ideal-finite-locally-free}.
Hence $b : X' \to X$ is $U$-admissible, see
Definition \ref{divisors-definition-admissible-blowup}.

\medskip\noindent
By Lemma \ref{divisors-lemma-fitting-ideal-finite-locally-free}
...
\begin{lemma}[Filter after modification]
\label{divisors-lemma-filter-after-modification}
\source{stacks:0AYP}
\href{https://stacks.math.columbia.edu/tag/0AYP}{\texttt{Stacks tag 0AYP}}
\group{divisors}
...
\begin{proof}
\uses{divisors-lemma-relative-proj-proper}
...
Then $\pi$ is proper (Lemma \ref{divisors-lemma-relative-proj-proper}).
...
\begin{lemma}[Extend rational map after modification]
\label{divisors-lemma-extend-rational-map-after-modification}
\source{stacks:0C4V}
\href{https://stacks.math.columbia.edu/tag/0C4V}{\texttt{Stacks tag 0C4V}}
\group{divisors}
