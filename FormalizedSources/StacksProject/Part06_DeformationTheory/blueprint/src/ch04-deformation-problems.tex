...
\source{stacks:0D3I}
\href{https://stacks.math.columbia.edu/tag/0D3I}{\texttt{Stacks tag 0D3I}}
\group{examples-defos}
...
in Section \ref{examples-defos-section-general} to provide an easy example.

\begin{lemma}[Finite projective modules RS]
\label{examples-defos-lemma-finite-projective-modules-RS}
\source{stacks:0DVP}
\href{https://stacks.math.columbia.edu/tag/0DVP}{\texttt{Stacks tag 0DVP}}
\group{examples-defos}

Example \ref{examples-defos-example-finite-projective-modules}
...
\begin{lemma}[Finite projective modules TI]
\label{examples-defos-lemma-finite-projective-modules-TI}
\source{stacks:0DVQ}
\href{https://stacks.math.columbia.edu/tag/0DVQ}{\texttt{Stacks tag 0DVQ}}
\group{examples-defos}

In Example \ref{examples-defos-example-finite-projective-modules}
...
\begin{proof}
With $\mathcal{F}$ as in Example \ref{examples-defos-example-finite-projective-modules}
...
\source{stacks:0D3J}
\href{https://stacks.math.columbia.edu/tag/0D3J}{\texttt{Stacks tag 0D3J}}
\group{examples-defos}
...
\begin{lemma}[Representations RS]
\label{examples-defos-lemma-representations-RS}
\source{stacks:0DVS}
\href{https://stacks.math.columbia.edu/tag/0DVS}{\texttt{Stacks tag 0DVS}}
\group{examples-defos}

Example \ref{examples-defos-example-representations}
satisfies the Rim-Schlessinger condition (RS).
...
Then, as seen in the proof of Lemma \ref{examples-defos-lemma-finite-projective-modules-RS},
...
\begin{lemma}[Representations TI]
\label{examples-defos-lemma-representations-TI}
\source{stacks:0DVT}
\href{https://stacks.math.columbia.edu/tag/0DVT}{\texttt{Stacks tag 0DVT}}
\group{examples-defos}

In Example \ref{examples-defos-example-representations} let
$\rho_0 : \Gamma \to \text{GL}_k(V)$
...
as in the proof of Lemma \ref{examples-defos-lemma-finite-projective-modules-TI},
...
In Example \ref{examples-defos-example-representations} if $\Gamma$ is finitely generated
...
from Lemmas \ref{examples-defos-lemma-representations-RS} and \ref{examples-defos-lemma-representations-TI}
and the general discussion in Section \ref{examples-defos-section-general}.

\begin{lemma}[Representations hull]
\label{examples-defos-lemma-representations-hull}
\source{stacks:0ET1}
\href{https://stacks.math.columbia.edu/tag/0ET1}{\texttt{Stacks tag 0ET1}}
\group{examples-defos}

In Example \ref{examples-defos-example-representations} assume $\Gamma$ finitely generated.
...
\begin{proof}
The existence of a hull follows from Lemmas \ref{examples-defos-lemma-representations-RS} and
\ref{examples-defos-lemma-representations-TI} and
...
\source{stacks:0D3K}
\href{https://stacks.math.columbia.edu/tag/0D3K}{\texttt{Stacks tag 0D3K}}
\group{examples-defos}
...
\begin{lemma}[Continuous representations RS]
\label{examples-defos-lemma-continuous-representations-RS}
\source{stacks:0DVV}
\href{https://stacks.math.columbia.edu/tag/0DVV}{\texttt{Stacks tag 0DVV}}
\group{examples-defos}

Example \ref{examples-defos-example-continuous-representations}
satisfies the Rim-Schlessinger condition (RS).
In particular, $\Deformationcategory_{V, \rho_0}$ is a deformation category
...
Lemma \ref{examples-defos-lemma-representations-RS}.
\end{proof}

\begin{lemma}[Continuous representations TI]
\label{examples-defos-lemma-continuous-representations-TI}
\source{stacks:0DVW}
\href{https://stacks.math.columbia.edu/tag/0DVW}{\texttt{Stacks tag 0DVW}}
\group{examples-defos}

In Example \ref{examples-defos-example-continuous-representations} let
...
\begin{proof}
The proof is exactly the same as the proof of
Lemma \ref{examples-defos-lemma-representations-TI}.
\end{proof}

In Example \ref{examples-defos-example-continuous-representations} if $\Gamma$
...
over $\mathcal{C}_\Lambda$
and a fortiori has a (minimal) versal formal object. This follows
from Lemmas \ref{examples-defos-lemma-continuous-representations-RS} and
\ref{examples-defos-lemma-continuous-representations-TI}
and the general discussion in Section \ref{examples-defos-section-general}.

\begin{lemma}[Continuous representations hull]
\label{examples-defos-lemma-continuous-representations-hull}
\source{stacks:0ET2}
\href{https://stacks.math.columbia.edu/tag/0ET2}{\texttt{Stacks tag 0ET2}}
\group{examples-defos}

In Example \ref{examples-defos-example-continuous-representations} assume $\Gamma$
is topologically finitely generated.
Let $\rho_0 : \Gamma \to \text{GL}_k(V)$ be a finite dimensional representation.
Assume $\Lambda$ is a complete local ring with residue field $k$
(the classical case). Then the functor
...
\begin{proof}
The proof is exactly the same as the proof of
Lemma \ref{examples-defos-lemma-representations-hull}.
\end{proof}
...
\source{stacks:0D3L}
\href{https://stacks.math.columbia.edu/tag/0D3L}{\texttt{Stacks tag 0D3L}}
\group{examples-defos}
...
\begin{lemma}[Graded algebras RS]
\label{examples-defos-lemma-graded-algebras-RS}
\source{stacks:0DVY}
\href{https://stacks.math.columbia.edu/tag/0DVY}{\texttt{Stacks tag 0DVY}}
\group{examples-defos}

Example \ref{examples-defos-example-graded-algebras}
satisfies the Rim-Schlessinger condition (RS).
...
see proof of Lemma \ref{examples-defos-lemma-finite-projective-modules-RS}.
Thus $P_1 \times_\varphi P_2$ is an object of $\mathcal{F}(A_1 \times_A A_2)$.
This construction determines a quasi-inverse to our functor
and the proof is complete.
\end{proof}

\begin{lemma}[Graded algebras TI]
\label{examples-defos-lemma-graded-algebras-TI}
\source{stacks:0DVZ}
\href{https://stacks.math.columbia.edu/tag/0DVZ}{\texttt{Stacks tag 0DVZ}}
\group{examples-defos}

In Example \ref{examples-defos-example-graded-algebras} let $P$ be a graded $k$-algebra.
Then
$$
...
In Example \ref{examples-defos-example-graded-algebras} if $P$ is a finitely generated
graded $k$-algebra, then $\Deformationcategory_P$
admits a presentation by a smooth prorepresentable groupoid in functors
over $\mathcal{C}_\Lambda$
and a fortiori has a (minimal) versal formal object. This follows
from Lemmas \ref{examples-defos-lemma-graded-algebras-RS} and
\ref{examples-defos-lemma-graded-algebras-TI}
and the general discussion in Section \ref{examples-defos-section-general}.

\begin{lemma}[Graded algebras hull]
\label{examples-defos-lemma-graded-algebras-hull}
\source{stacks:0ET3}
\href{https://stacks.math.columbia.edu/tag/0ET3}{\texttt{Stacks tag 0ET3}}
\group{examples-defos}

In Example \ref{examples-defos-example-graded-algebras} assume $P$ is a finitely generated
...
\begin{proof}
This follows immediately from Lemmas \ref{examples-defos-lemma-graded-algebras-RS} and
\ref{examples-defos-lemma-graded-algebras-TI} and
Formal Deformation Theory, Lemma \ref{formal-defos-lemma-RS-implies-S1-S2}
and Remark \ref{formal-defos-remark-compose-minimal-into-iso-classes}.
\end{proof}
...
\source{stacks:0DY1}
\href{https://stacks.math.columbia.edu/tag/0DY1}{\texttt{Stacks tag 0DY1}}
\group{examples-defos}
...
\begin{lemma}[Rings RS]
\label{examples-defos-lemma-rings-RS}
\source{stacks:0DY2}
\href{https://stacks.math.columbia.edu/tag/0DY2}{\texttt{Stacks tag 0DY2}}
\group{examples-defos}

Example \ref{examples-defos-example-rings}
satisfies the Rim-Schlessinger condition (RS).
In particular, $\Deformationcategory_P$ is a deformation category
for any $k$-algebra $P$.
\end{lemma}
...
\begin{lemma}[Rings TI]
\label{examples-defos-lemma-rings-TI}
\source{stacks:0DY3}
\href{https://stacks.math.columbia.edu/tag/0DY3}{\texttt{Stacks tag 0DY3}}
\group{examples-defos}

In Example \ref{examples-defos-example-rings} let $P$ be a $k$-algebra. Then
$$
...
\source{stacks:0DZL}
\href{https://stacks.math.columbia.edu/tag/0DZL}{\texttt{Stacks tag 0DZL}}
\group{examples-defos}

In Example \ref{examples-defos-example-rings} let $P$ be a smooth $k$-algebra. Then
$T\Deformationcategory_P = (0)$.
\end{lemma}

\begin{proof}
By Lemma \ref{examples-defos-lemma-rings-TI} we have to show
...
\begin{lemma}[Finite type rings TI]
\label{examples-defos-lemma-finite-type-rings-TI}
\source{stacks:0DY4}
\href{https://stacks.math.columbia.edu/tag/0DY4}{\texttt{Stacks tag 0DY4}}
\group{examples-defos}

In Lemma \ref{examples-defos-lemma-rings-TI} if $P$ is a finite type $k$-algebra, then
\begin{enumerate}
...
In Example \ref{examples-defos-example-rings}, let $P$ be a finite type
...
singular points. This follows from Lemmas \ref{examples-defos-lemma-rings-RS} and
\ref{examples-defos-lemma-finite-type-rings-TI}
and the general discussion in Section \ref{examples-defos-section-general}.

\begin{lemma}[Rings hull]
\label{examples-defos-lemma-rings-hull}
\source{stacks:0ET4}
\href{https://stacks.math.columbia.edu/tag/0ET4}{\texttt{Stacks tag 0ET4}}
\group{examples-defos}

In Example \ref{examples-defos-example-rings} assume $P$ is a finite type
...
\begin{proof}
This follows immediately from Lemmas \ref{examples-defos-lemma-rings-RS} and
\ref{examples-defos-lemma-finite-type-rings-TI} and
Formal Deformation Theory, Lemma \ref{formal-defos-lemma-RS-implies-S1-S2}
and Remark \ref{formal-defos-remark-compose-minimal-into-iso-classes}.
\end{proof}
...
\source{stacks:0DYS}
\href{https://stacks.math.columbia.edu/tag/0DYS}{\texttt{Stacks tag 0DYS}}
\group{examples-defos}

In Example \ref{examples-defos-example-rings} let $P$ be a $k$-algebra.
...
\begin{lemma}[Henselization]
\label{examples-defos-lemma-henselization}
\source{stacks:0DYT}
\href{https://stacks.math.columbia.edu/tag/0DYT}{\texttt{Stacks tag 0DYT}}
\group{examples-defos}
...
\begin{lemma}[Strict henselization]
\label{examples-defos-lemma-strict-henselization}
\source{stacks:0DYU}
\href{https://stacks.math.columbia.edu/tag/0DYU}{\texttt{Stacks tag 0DYU}}
\group{examples-defos}
...
\source{stacks:0DYV}
\href{https://stacks.math.columbia.edu/tag/0DYV}{\texttt{Stacks tag 0DYV}}
\group{examples-defos}
...
\begin{lemma}[Power series rings TI]
\label{examples-defos-lemma-power-series-rings-TI}
\source{stacks:0DY5}
\href{https://stacks.math.columbia.edu/tag/0DY5}{\texttt{Stacks tag 0DY5}}
\group{examples-defos}

In Lemma \ref{examples-defos-lemma-rings-TI} if $P = k[[x_1, \ldots, x_n]]/(f)$
...
as in the proof of Lemma \ref{examples-defos-lemma-rings-TI}. Choose lifts $q_i \in Q$
...
\source{stacks:0DY7}
\href{https://stacks.math.columbia.edu/tag/0DY7}{\texttt{Stacks tag 0DY7}}
\group{examples-defos}
...
$$
\begin{array}{cc}X \underset{g}{\longrightarrow}\downarrow & Y \downarrow \\ \Spec(A) \overset{f}{\longrightarrow} & \Spec(B)\end{array}
$$
...
\begin{lemma}[Schemes RS]
\label{examples-defos-lemma-schemes-RS}
\source{stacks:0DY8}
\href{https://stacks.math.columbia.edu/tag/0DY8}{\texttt{Stacks tag 0DY8}}
\group{examples-defos}

Example \ref{examples-defos-example-schemes}
satisfies the Rim-Schlessinger condition (RS).
...
Observe that
$$
\begin{array}{cc}\Spec(A) \longrightarrow\downarrow & \Spec(A_2) \downarrow \\ \Spec(A_1) \longrightarrow & \Spec(A_1 \times_A A_2)\end{array}
$$
...
\begin{lemma}[Schemes TI]
\label{examples-defos-lemma-schemes-TI}
\source{stacks:0DY9}
\href{https://stacks.math.columbia.edu/tag/0DY9}{\texttt{Stacks tag 0DY9}}
\group{examples-defos}

In Example \ref{examples-defos-example-schemes} let $X$ be a scheme over $k$. Then
$$
...
\begin{lemma}[Proper schemes TI]
\label{examples-defos-lemma-proper-schemes-TI}
\source{stacks:0DYA}
\href{https://stacks.math.columbia.edu/tag/0DYA}{\texttt{Stacks tag 0DYA}}
\group{examples-defos}

In Lemma \ref{examples-defos-lemma-schemes-TI} if $X$ is proper over $k$, then
...
In Example \ref{examples-defos-example-schemes} if $X$ is a proper scheme over $k$,
then $\Deformationcategory_X$
admits a presentation by a smooth prorepresentable groupoid in functors
over $\mathcal{C}_\Lambda$
and a fortiori has a (minimal) versal formal object. This follows
from Lemmas \ref{examples-defos-lemma-schemes-RS} and
\ref{examples-defos-lemma-proper-schemes-TI}
and the general discussion in Section \ref{examples-defos-section-general}.

\begin{lemma}[Schemes hull]
\label{examples-defos-lemma-schemes-hull}
\source{stacks:0ET5}
\href{https://stacks.math.columbia.edu/tag/0ET5}{\texttt{Stacks tag 0ET5}}
\group{examples-defos}

In Example \ref{examples-defos-example-schemes} assume $X$ is a proper $k$-scheme.
Assume $\Lambda$ is a complete local ring with residue field $k$
(the classical case). Then the functor
$$
F : \mathcal{C}_\Lambda \longrightarrow \textit{Sets},\quad
...
Lemmas \ref{examples-defos-lemma-schemes-RS} and \ref{examples-defos-lemma-proper-schemes-TI} and
Formal Deformation Theory, Lemma \ref{formal-defos-lemma-RS-implies-S1-S2}
and Remark \ref{formal-defos-remark-compose-minimal-into-iso-classes}.
...
\source{stacks:0DYW}
\href{https://stacks.math.columbia.edu/tag/0DYW}{\texttt{Stacks tag 0DYW}}
\group{examples-defos}

In Example \ref{examples-defos-example-schemes} let $X$ be a scheme over $k$.
...
\source{stacks:0DYX}
\href{https://stacks.math.columbia.edu/tag/0DYX}{\texttt{Stacks tag 0DYX}}
\group{examples-defos}

In Example \ref{examples-defos-example-schemes} let $X = \Spec(P)$ be an
affine scheme over $k$. With $\Deformationcategory_P$ as in
Example \ref{examples-defos-example-rings} there is a natural equivalence
$$
...
\begin{lemma}[Local ring]
\label{examples-defos-lemma-local-ring}
\source{stacks:0DZM}
\href{https://stacks.math.columbia.edu/tag/0DZM}{\texttt{Stacks tag 0DZM}}
\group{examples-defos}

In Example \ref{examples-defos-example-schemes} let $X$ be a scheme over $k$
Let $p \in X$ be a point. With $\Deformationcategory_{\mathcal{O}_{X, p}}$
as in Example \ref{examples-defos-example-rings} there is a natural functor
$$
...
the functors from
Lemmas \ref{examples-defos-lemma-open}, \ref{examples-defos-lemma-affine}, and \ref{examples-defos-lemma-localization}.
\end{proof}

\begin{definition}[Situation: Glueing]
\label{examples-defos-situation-glueing}
\source{stacks:0DYY}
\href{https://stacks.math.columbia.edu/tag/0DYY}{\texttt{Stacks tag 0DYY}}
\group{examples-defos}

Let $\Lambda \to k$ be as in Section \ref{examples-defos-section-general}.
...
be as in Example \ref{examples-defos-example-schemes} and let
$\Deformationcategory_{P_1}$, $\Deformationcategory_{P_2}$, and
$\Deformationcategory_{P_{12}}$ be as in Example \ref{examples-defos-example-rings}.
\end{definition}

\begin{lemma}[Glueing]
\label{examples-defos-lemma-glueing}
\source{stacks:0DYZ}
\href{https://stacks.math.columbia.edu/tag/0DYZ}{\texttt{Stacks tag 0DYZ}}
\group{examples-defos}

In Situation \ref{examples-defos-situation-glueing}
...
$$
of deformation categories, see Examples \ref{examples-defos-example-schemes} and
\ref{examples-defos-example-rings}.
\end{lemma}

\begin{proof}
It suffices to show that the functors of Lemma \ref{examples-defos-lemma-open}
...
$$
because then we can apply Lemma \ref{examples-defos-lemma-affine} to translate into rings.
To do this we construct a quasi-inverse. Denote
$F_i : \Deformationcategory_{U_i} \to \Deformationcategory_{U_{12}}$
the functor of Lemma \ref{examples-defos-lemma-open}.
...
\source{stacks:0E3T}
\href{https://stacks.math.columbia.edu/tag/0E3T}{\texttt{Stacks tag 0E3T}}
\group{examples-defos}
...
$$
\begin{array}{cc}X \underset{g}{\longrightarrow}\downarrow & X' \downarrow \\ Y \underset{h}{\longrightarrow}\downarrow & Y' \downarrow \\ \Spec(A) \overset{f}{\longrightarrow} & \Spec(A')\end{array}
$$
...
\begin{lemma}[Schemes morphisms RS]
\label{examples-defos-lemma-schemes-morphisms-RS}
\source{stacks:0E3U}
\href{https://stacks.math.columbia.edu/tag/0E3U}{\texttt{Stacks tag 0E3U}}
\group{examples-defos}

Example \ref{examples-defos-example-schemes-morphisms}
satisfies the Rim-Schlessinger condition (RS).
...
\begin{lemma}[Schemes morphisms TI]
\label{examples-defos-lemma-schemes-morphisms-TI}
\source{stacks:0E3V}
\href{https://stacks.math.columbia.edu/tag/0E3V}{\texttt{Stacks tag 0E3V}}
\group{examples-defos}

In Example \ref{examples-defos-example-schemes} let $f : X \to Y$ be a morphism of schemes
over $k$. There is a canonical exact sequence of $k$-vector spaces
$$
\begin{array}{cccc}0 \longrightarrow & \text{Inf}(\Deformationcategory_{X \to Y}) \longrightarrow & \text{Inf}(\Deformationcategory_X \times \Deformationcategory_Y) \longrightarrow & \text{Der}_k(\mathcal{O}_Y, f_*\mathcal{O}_X) \swarrow \\  & T\Deformationcategory_{X \to Y} \longrightarrow & T(\Deformationcategory_X \times \Deformationcategory_Y) \longrightarrow & \text{Ext}^1_{\mathcal{O}_X}(Lf^*\NL_{Y/k}, \mathcal{O}_X)\end{array}
$$
\end{lemma}
...
$\beta^{-1} \circ f' \circ \alpha : X' \to Y'$ defines an element
in
$$
...
\begin{lemma}[Proper schemes morphisms TI]
\label{examples-defos-lemma-proper-schemes-morphisms-TI}
\source{stacks:0E3W}
\href{https://stacks.math.columbia.edu/tag/0E3W}{\texttt{Stacks tag 0E3W}}
\group{examples-defos}

In Lemma \ref{examples-defos-lemma-schemes-morphisms-TI} if $X$ and $Y$ are both
proper over $k$, then
...
\begin{proof}
Omitted. Hint: argue as in Lemma \ref{examples-defos-lemma-proper-schemes-TI}
and use the exact sequence of the lemma.
\end{proof}

In Example \ref{examples-defos-example-schemes-morphisms}
if $X \to Y$ is a morphism of proper schemes over $k$,
then $\Deformationcategory_{X \to Y}$
admits a presentation by a smooth prorepresentable groupoid in functors
over $\mathcal{C}_\Lambda$
and a fortiori has a (minimal) versal formal object. This follows
from Lemmas \ref{examples-defos-lemma-schemes-morphisms-RS} and
\ref{examples-defos-lemma-proper-schemes-morphisms-TI}
and the general discussion in Section \ref{examples-defos-section-general}.

\begin{lemma}[Schemes morphisms hull]
\label{examples-defos-lemma-schemes-morphisms-hull}
\source{stacks:0ET6}
\href{https://stacks.math.columbia.edu/tag/0ET6}{\texttt{Stacks tag 0ET6}}
\group{examples-defos}

In Example \ref{examples-defos-example-schemes-morphisms} assume $X \to Y$
...
\begin{proof}
The existence of a hull follows immediately from
Lemmas \ref{examples-defos-lemma-schemes-morphisms-RS} and
\ref{examples-defos-lemma-proper-schemes-morphisms-TI} and
Formal Deformation Theory, Lemma \ref{formal-defos-lemma-RS-implies-S1-S2}
and Remark \ref{formal-defos-remark-compose-minimal-into-iso-classes}.
...
\text{Der}_k(\mathcal{O}_Y, \mathcal{O}_Y) = 0$. Then
the exact sequence of Lemma \ref{examples-defos-lemma-schemes-morphisms-TI}
combined with Lemma \ref{examples-defos-lemma-schemes-TI}
...
\begin{lemma}[Schemes morphisms smooth to base]
\label{examples-defos-lemma-schemes-morphisms-smooth-to-base}
\source{stacks:0E3X}
\href{https://stacks.math.columbia.edu/tag/0E3X}{\texttt{Stacks tag 0E3X}}
\group{examples-defos}
...
\source{stacks:0E3Z}
\href{https://stacks.math.columbia.edu/tag/0E3Z}{\texttt{Stacks tag 0E3Z}}
\group{examples-defos}
...
\begin{lemma}[Spaces RS]
\label{examples-defos-lemma-spaces-RS}
\source{stacks:0E40}
\href{https://stacks.math.columbia.edu/tag/0E40}{\texttt{Stacks tag 0E40}}
\group{examples-defos}

Example \ref{examples-defos-example-spaces}
satisfies the Rim-Schlessinger condition (RS).
In particular, $\Deformationcategory_X$ is a deformation category
...
\begin{lemma}[Spaces TI]
\label{examples-defos-lemma-spaces-TI}
\source{stacks:0E41}
\href{https://stacks.math.columbia.edu/tag/0E41}{\texttt{Stacks tag 0E41}}
\group{examples-defos}

In Example \ref{examples-defos-example-spaces} let $X$ be an algebraic space over $k$. Then
$$
\text{Inf}(\Deformationcategory_X) =
\text{Ext}^0_{\mathcal{O}_X}(\NL_{X/k}, \mathcal{O}_X) =
\Hom_{\mathcal{O}_X}(\Omega_{X/k}, \mathcal{O}_X) =
...
\begin{lemma}[Proper spaces TI]
\label{examples-defos-lemma-proper-spaces-TI}
\source{stacks:0E42}
\href{https://stacks.math.columbia.edu/tag/0E42}{\texttt{Stacks tag 0E42}}
\group{examples-defos}

In Lemma \ref{examples-defos-lemma-spaces-TI} if $X$ is proper over $k$, then
$\text{Inf}(\Deformationcategory_X)$ and $T\Deformationcategory_X$ are
finite dimensional.
\end{lemma}
...
In Example \ref{examples-defos-example-spaces} if $X$ is a proper algebraic space over $k$,
then $\Deformationcategory_X$
admits a presentation by a smooth prorepresentable groupoid in functors
over $\mathcal{C}_\Lambda$
and a fortiori has a (minimal) versal formal object. This follows
from Lemmas \ref{examples-defos-lemma-spaces-RS} and
\ref{examples-defos-lemma-proper-spaces-TI}
and the general discussion in Section \ref{examples-defos-section-general}.

\begin{lemma}[Spaces hull]
\label{examples-defos-lemma-spaces-hull}
\source{stacks:0ET7}
\href{https://stacks.math.columbia.edu/tag/0ET7}{\texttt{Stacks tag 0ET7}}
\group{examples-defos}

In Example \ref{examples-defos-example-spaces} assume $X$ is a proper algebraic space over $k$.
Assume $\Lambda$ is a complete local ring with residue field $k$
(the classical case). Then the functor
$$
F : \mathcal{C}_\Lambda \longrightarrow \textit{Sets},\quad
...
\begin{proof}
The existence of a hull follows immediately from
Lemmas \ref{examples-defos-lemma-spaces-RS} and \ref{examples-defos-lemma-proper-spaces-TI} and
Formal Deformation Theory, Lemma \ref{formal-defos-lemma-RS-implies-S1-S2}
and Remark \ref{formal-defos-remark-compose-minimal-into-iso-classes}.
...
\begin{lemma}[Lift equivalence module derived]
\label{examples-defos-lemma-lift-equivalence-module-derived}
\source{stacks:0DZ1}
\href{https://stacks.math.columbia.edu/tag/0DZ1}{\texttt{Stacks tag 0DZ1}}
\group{examples-defos}
...
\begin{lemma}[Lift equivalence module]
\label{examples-defos-lemma-lift-equivalence-module}
\source{stacks:0DZ2}
\href{https://stacks.math.columbia.edu/tag/0DZ2}{\texttt{Stacks tag 0DZ2}}
\group{examples-defos}

Consider a commutative diagram of Noetherian rings
$$
\begin{array}{ccc}A' \downarrow\longrightarrow & P' \downarrow\longrightarrow & Q' \downarrow \\ A \longrightarrow & P \longrightarrow & Q\end{array}
$$
...
Lemma \ref{examples-defos-lemma-lift-equivalence-module-derived}.
...
\begin{lemma}[Lift equivalence]
\label{examples-defos-lemma-lift-equivalence}
\source{stacks:0DZ3}
\href{https://stacks.math.columbia.edu/tag/0DZ3}{\texttt{Stacks tag 0DZ3}}
\group{examples-defos}
...
Lemma \ref{examples-defos-lemma-lift-equivalence-module} provided we can
...
$$
\begin{array}{ccccc}0 \longrightarrow & N \longrightarrow\underset{\text{id}}{\downarrow} & C \longrightarrow\downarrow & B \longrightarrow\underset{\text{id}}{\downarrow} & 0 \\ 0 \longrightarrow & N \longrightarrow & C' \longrightarrow & B \longrightarrow & 0\end{array}
$$
...
\begin{lemma}[First order completion]
\label{examples-defos-lemma-first-order-completion}
\source{stacks:0DZ4}
\href{https://stacks.math.columbia.edu/tag/0DZ4}{\texttt{Stacks tag 0DZ4}}
\group{examples-defos}
...
the proof of Lemma \ref{examples-defos-lemma-completion}.
...
$$
\begin{array}{ccccc}0 \longrightarrow & N^\wedge \longrightarrow & C' \longrightarrow & B^\wedge \longrightarrow & 0 \\  &  & B \overset{\sigma}{\uparrow}\nearrow &  & \end{array}
$$
...
\begin{lemma}[Smooth completion]
\label{examples-defos-lemma-smooth-completion}
\source{stacks:0DZ5}
\href{https://stacks.math.columbia.edu/tag/0DZ5}{\texttt{Stacks tag 0DZ5}}
\group{examples-defos}
...
Lemma \ref{examples-defos-lemma-completion}
$$
\Deformationcategory_P \longrightarrow \Deformationcategory_{P^\wedge}
$$
...
are deformation categories by Lemma \ref{examples-defos-lemma-rings-RS}.
...
Lemma \ref{examples-defos-lemma-lift-equivalence}
and the isomorphism on tangent spaces is the special case of
Lemma \ref{examples-defos-lemma-first-order-completion} where $N = B$.
\end{proof}
...
\begin{lemma}[Lift equivalence localization]
\label{examples-defos-lemma-lift-equivalence-localization}
\source{stacks:0DZ7}
\href{https://stacks.math.columbia.edu/tag/0DZ7}{\texttt{Stacks tag 0DZ7}}
\group{examples-defos}
...
Lemma \ref{examples-defos-lemma-lift-equivalence} but easier. We suggest the
...
\begin{lemma}[First order localization]
\label{examples-defos-lemma-first-order-localization}
\source{stacks:0DZ8}
\href{https://stacks.math.columbia.edu/tag/0DZ8}{\texttt{Stacks tag 0DZ8}}
\group{examples-defos}
...
\begin{proof}
This proof is the same as the proof of
Lemma \ref{examples-defos-lemma-first-order-completion} but easier. We suggest the
reader to skip the proof.
...
Compare with the proof of Lemma \ref{examples-defos-lemma-localization}.
...
Lemma \ref{examples-defos-lemma-first-order-completion}.
\end{proof}

\begin{lemma}[Smooth localization]
\label{examples-defos-lemma-smooth-localization}
\source{stacks:0DZ9}
\href{https://stacks.math.columbia.edu/tag/0DZ9}{\texttt{Stacks tag 0DZ9}}
\group{examples-defos}
...
\end{enumerate}
then the functor between deformation categories of
Lemma \ref{examples-defos-lemma-localization}
$$
\Deformationcategory_P \longrightarrow \Deformationcategory_{S^{-1}P}
$$
is smooth and induces an isomorphism on tangent spaces.
...
Formal Deformation Theory, Lemma \ref{formal-defos-lemma-easy-check-smooth}.
The property on liftability is proven in
Lemma \ref{examples-defos-lemma-lift-equivalence-localization}
and the isomorphism on tangent spaces is the special case of
Lemma \ref{examples-defos-lemma-first-order-localization} where $N = B$.
\end{proof}
...
\begin{lemma}[Lift equivalence henselization]
\label{examples-defos-lemma-lift-equivalence-henselization}
\source{stacks:0DZB}
\href{https://stacks.math.columbia.edu/tag/0DZB}{\texttt{Stacks tag 0DZB}}
\group{examples-defos}
...
(compare with the proof of Lemma \ref{examples-defos-lemma-henselization}).
...
\begin{lemma}[First order henselization]
\label{examples-defos-lemma-first-order-henselization}
\source{stacks:0DZC}
\href{https://stacks.math.columbia.edu/tag/0DZC}{\texttt{Stacks tag 0DZC}}
\group{examples-defos}
...
\begin{lemma}[Smooth henselization]
\label{examples-defos-lemma-smooth-henselization}
\source{stacks:0DZD}
\href{https://stacks.math.columbia.edu/tag/0DZD}{\texttt{Stacks tag 0DZD}}
\group{examples-defos}
...
\end{enumerate}
then the functor between deformation categories of
Lemma \ref{examples-defos-lemma-henselization}
$$
\Deformationcategory_P \longrightarrow \Deformationcategory_{P^h}
$$
is smooth and induces an isomorphism on tangent spaces.
...
Formal Deformation Theory, Lemma \ref{formal-defos-lemma-easy-check-smooth}.
The property on liftability is proven in
Lemma \ref{examples-defos-lemma-lift-equivalence-henselization}
and the isomorphism on tangent spaces is the special case of
Lemma \ref{examples-defos-lemma-first-order-henselization} where $N = B$.
\end{proof}
...
\begin{lemma}[Isolated]
\label{examples-defos-lemma-isolated}
\source{stacks:0DZF}
\href{https://stacks.math.columbia.edu/tag/0DZF}{\texttt{Stacks tag 0DZF}}
\group{examples-defos}
...
Lemma \ref{examples-defos-lemma-finite-type-rings-TI}.
The functors between the categories are constructed
in Lemmas \ref{examples-defos-lemma-localization}, \ref{examples-defos-lemma-henselization}, and
\ref{examples-defos-lemma-completion} (we omit some verifications of the form:
the completion of the henselization is the completion).

\medskip\noindent
Set $J = \mathfrak m_1 \cap \ldots \cap \mathfrak m_n$ and apply
Lemma \ref{examples-defos-lemma-smooth-completion} to get that
...
Hence we can apply Lemma \ref{examples-defos-lemma-smooth-henselization}
...
Then we can apply
Lemma \ref{examples-defos-lemma-smooth-localization}
...
\begin{lemma}[Lci unobstructed]
\label{examples-defos-lemma-lci-unobstructed}
\source{stacks:0DZH}
\href{https://stacks.math.columbia.edu/tag/0DZH}{\texttt{Stacks tag 0DZH}}
\group{examples-defos}

In Example \ref{examples-defos-example-rings} let $P$ be a local complete
...
\begin{lemma}[Glueing smooth]
\label{examples-defos-lemma-glueing-smooth}
\source{stacks:0DZN}
\href{https://stacks.math.columbia.edu/tag/0DZN}{\texttt{Stacks tag 0DZN}}
\group{examples-defos}

In Situation \ref{examples-defos-situation-glueing} if $U_{12} \to \Spec(k)$ is smooth,
then the morphism
$$
\Deformationcategory_X
\longrightarrow
...
\begin{proof}
The equality signs hold by Lemma \ref{examples-defos-lemma-affine}.
...
Using
Lemma \ref{examples-defos-lemma-glueing}
...
This vanishing follows from Lemma \ref{examples-defos-lemma-smooth}
...
is unobstructed, which is Lemma \ref{examples-defos-lemma-lci-unobstructed}.
\end{proof}

\begin{lemma}[Curve isolated]
\label{examples-defos-lemma-curve-isolated}
\source{stacks:0DZP}
\href{https://stacks.math.columbia.edu/tag/0DZP}{\texttt{Stacks tag 0DZP}}
\group{examples-defos}

In Example \ref{examples-defos-example-schemes} let $X$ be a scheme over $k$. Assume
\begin{enumerate}
...
$$
is smooth by Lemma \ref{examples-defos-lemma-glueing-smooth}.
Applying Lemmas \ref{examples-defos-lemma-affine} and \ref{examples-defos-lemma-isolated} we win.
\end{proof}

\begin{lemma}[Curve isolated lci]
\label{examples-defos-lemma-curve-isolated-lci}
\source{stacks:0DZQ}
\href{https://stacks.math.columbia.edu/tag/0DZQ}{\texttt{Stacks tag 0DZQ}}
\group{examples-defos}
...
$$
is smooth by Lemma \ref{examples-defos-lemma-glueing-smooth}.
Applying Lemmas \ref{examples-defos-lemma-affine} and \ref{examples-defos-lemma-lci-unobstructed} we win.
\end{proof}
...
\begin{lemma}[Criterion smoothing]
\label{examples-defos-lemma-criterion-smoothing}
\source{stacks:0E7T}
\href{https://stacks.math.columbia.edu/tag/0E7T}{\texttt{Stacks tag 0E7T}}
\group{examples-defos}
...
\begin{lemma}[Jouanolou type thing]
\label{examples-defos-lemma-jouanolou-type-thing}
\source{stacks:0E7U}
\href{https://stacks.math.columbia.edu/tag/0E7U}{\texttt{Stacks tag 0E7U}}
\group{examples-defos}
...
\begin{lemma}[Smoothing affine lci]
\label{examples-defos-lemma-smoothing-affine-lci}
\source{stacks:0E7V}
\href{https://stacks.math.columbia.edu/tag/0E7V}{\texttt{Stacks tag 0E7V}}
\group{examples-defos}
...
Lemma \ref{examples-defos-lemma-smoothing-affine-lci}.
...
\begin{lemma}[Smoothing at lci point]
\label{examples-defos-lemma-smoothing-at-lci-point}
\source{stacks:0E7X}
\href{https://stacks.math.columbia.edu/tag/0E7X}{\texttt{Stacks tag 0E7X}}
\group{examples-defos}
...
By Lemma \ref{examples-defos-lemma-smoothing-affine-lci} we can find a
...
\begin{lemma}[Smoothing proper curve isolated lci]
\label{examples-defos-lemma-smoothing-proper-curve-isolated-lci}
\source{stacks:0E7Y}
\href{https://stacks.math.columbia.edu/tag/0E7Y}{\texttt{Stacks tag 0E7Y}}
\group{examples-defos}
...
Lemma \ref{examples-defos-lemma-smoothing-artinian-lci}.
...
This is possible by Lemma \ref{examples-defos-lemma-smoothing-at-lci-point}.
Observe that the system $(B_i/t^nB_i)$ defines a formal object of
$\Deformationcategory_{\mathcal{O}_{X, p_i}}$ over $k[[t]]$.
By Lemma \ref{examples-defos-lemma-curve-isolated} the map
$$
\Deformationcategory_X
\longrightarrow
...
we may apply Lemma \ref{examples-defos-lemma-criterion-smoothing}
...
If we can show $t^{n - 1}$ is in the first Fitting ideal of
...
\begin{lemma}[Smoothing curve isolated lci]
\label{examples-defos-lemma-smoothing-curve-isolated-lci}
\source{stacks:0E7Z}
\href{https://stacks.math.columbia.edu/tag/0E7Z}{\texttt{Stacks tag 0E7Z}}
\group{examples-defos}
...
Thus we may apply Lemma \ref{examples-defos-lemma-smoothing-proper-curve-isolated-lci}
...
as in the proof of Lemma \ref{examples-defos-lemma-smoothing-proper-curve-isolated-lci}.
