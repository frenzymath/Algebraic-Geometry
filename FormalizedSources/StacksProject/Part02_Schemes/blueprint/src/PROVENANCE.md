...
The part-local Lean package `StacksPart02Lib/` is a port of the corresponding Horizon
`FormalizedSources/StacksProject/Part02_Schemes` library. Lake metadata lives
