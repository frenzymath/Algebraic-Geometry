...
\'etale topoi agree:
$$
\begin{array}{ccc}\Sh(X_\etale) \underset{f_{small}}{\longrightarrow}\downarrow &  & \Sh(Y_\etale) \downarrow \\ \Sh((X_0)_\etale) \overset{(f_0)_{small}}{\longrightarrow} &  & \Sh((Y_0)_\etale)\end{array}
$$
...
\begin{lemma}[Compare cohomology other topologies]
\label{spaces-more-cohomology-lemma-compare-cohomology-other-topologies}
\source{stacks:0DFV}
\href{https://stacks.math.columbia.edu/tag/0DFV}{\texttt{Stacks tag 0DFV}}
\group{spaces-more-cohomology}
...
\begin{lemma}[Surjective proper]
\label{spaces-more-cohomology-lemma-surjective-proper}
\source{stacks:0DFX}
\href{https://stacks.math.columbia.edu/tag/0DFX}{\texttt{Stacks tag 0DFX}}
\group{spaces-more-cohomology}
...
\source{stacks:0DFY}
\href{https://stacks.math.columbia.edu/tag/0DFY}{\texttt{Stacks tag 0DFY}}
\group{spaces-more-cohomology}
...
$$
\begin{array}{ccc}\Gamma(X_0, \mathcal{F}_0) \longrightarrow & \Gamma(Y_0, \mathcal{G}_0) \longrightarrow\longrightarrow & \Gamma((Y \times_X Y)_0, \mathcal{H}_0) \\ \Gamma(X, \mathcal{F}) \longrightarrow\uparrow & \Gamma(Y, \mathcal{G}) \longrightarrow\longrightarrow\uparrow & \Gamma(Y \times_X Y, \mathcal{H}) \uparrow\end{array}
$$
...
By Lemma \ref{spaces-more-cohomology-lemma-surjective-proper} it follows that the left one is too.
\end{proof}

\begin{lemma}[H0 proper over henselian local]
\label{spaces-more-cohomology-lemma-h0-proper-over-henselian-local}
\source{stacks:0DFZ}
\href{https://stacks.math.columbia.edu/tag/0DFZ}{\texttt{Stacks tag 0DFZ}}
\group{spaces-more-cohomology}
...
\begin{proof}
This is a special case of Lemma \ref{spaces-more-cohomology-lemma-h0-proper-over-henselian-pair}.
\end{proof}

\begin{lemma}[Proper base change f star]
\label{spaces-more-cohomology-lemma-proper-base-change-f-star}
\source{stacks:0DG0}
\href{https://stacks.math.columbia.edu/tag/0DG0}{\texttt{Stacks tag 0DG0}}
\group{spaces-more-cohomology}
...
$$
\vcenter{
\begin{array}{cc}X'_1 \longrightarrow\downarrow & X_1 \downarrow \\ Y' \longrightarrow & Y\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}X'_2 \longrightarrow\downarrow & X_2 \downarrow \\ Y' \longrightarrow & Y\end{array}
}
$$
and the sheaves $\mathcal{F}_i = (X_i \to X)^{-1}\mathcal{F}$.
By Lemma \ref{spaces-more-cohomology-lemma-surjective-proper} we have an exact sequence
...
\source{stacks:0DG1}
\href{https://stacks.math.columbia.edu/tag/0DG1}{\texttt{Stacks tag 0DG1}}
\group{spaces-more-cohomology}
...
\begin{proof}
This is a special case of Lemma \ref{spaces-more-cohomology-lemma-proper-base-change-f-star}.
\end{proof}

\begin{theorem}[Proper base change]
\label{spaces-more-cohomology-theorem-proper-base-change}
\source{stacks:0DG2}
\href{https://stacks.math.columbia.edu/tag/0DG2}{\texttt{Stacks tag 0DG2}}
\group{spaces-more-cohomology}
...
by Lemma \ref{spaces-more-cohomology-lemma-proper-base-change-f-star}.
...
is injective (see Lemma \ref{spaces-more-cohomology-lemma-surjective-proper}).
...
$$
by Lemma \ref{spaces-more-cohomology-lemma-proper-base-change-f-star}. This finishes the proof.
\end{proof}

\begin{lemma}[Proper base change]
\label{spaces-more-cohomology-lemma-proper-base-change}
\source{stacks:0DG3}
\href{https://stacks.math.columbia.edu/tag/0DG3}{\texttt{Stacks tag 0DG3}}
\group{spaces-more-cohomology}
...
(Theorem \ref{spaces-more-cohomology-theorem-proper-base-change}) using the spectral
sequences
$$
E_2^{p, q} = R^pf_*H^q(E)
\quad\text{and}\quad
...
\source{stacks:0DG4}
\href{https://stacks.math.columbia.edu/tag/0DG4}{\texttt{Stacks tag 0DG4}}
\group{spaces-more-cohomology}
...
is a special case of Theorem \ref{spaces-more-cohomology-theorem-proper-base-change}.
The second one is a special case of Lemma \ref{spaces-more-cohomology-lemma-proper-base-change}.
\end{proof}

\begin{lemma}[Base change separably closed]
\label{spaces-more-cohomology-lemma-base-change-separably-closed}
\source{stacks:0DG5}
\href{https://stacks.math.columbia.edu/tag/0DG5}{\texttt{Stacks tag 0DG5}}
\group{spaces-more-cohomology}
...
\begin{proof}
This is a special case of Theorem \ref{spaces-more-cohomology-theorem-proper-base-change}.
\end{proof}
...
\source{stacks:0DG7}
\href{https://stacks.math.columbia.edu/tag/0DG7}{\texttt{Stacks tag 0DG7}}
\group{spaces-more-cohomology}
...
This we have seen in Lemma \ref{spaces-more-cohomology-lemma-surjective-proper}.
...
\source{stacks:0DG8}
\href{https://stacks.math.columbia.edu/tag/0DG8}{\texttt{Stacks tag 0DG8}}
\group{spaces-more-cohomology}
...
$$
\begin{array}{cc}(Y_{spaces, \etale}, \mathcal{O}_Y) \underset{f_{spaces, \etale}}{\downarrow} & ((\textit{Spaces}/Y)_\etale, \mathcal{O}) \overset{f_{big}}{\downarrow}\overset{\pi_Y}{\longleftarrow} \\ (X_{spaces, \etale}, \mathcal{O}_X) & ((\textit{Spaces}/X)_\etale, \mathcal{O}) \underset{\pi_X}{\longleftarrow}\end{array}
$$
...
\source{stacks:0DGA}
\href{https://stacks.math.columbia.edu/tag/0DGA}{\texttt{Stacks tag 0DGA}}
\group{spaces-more-cohomology}
...
\begin{proof}
Part (1) follows from
Lemma \ref{spaces-more-cohomology-lemma-compare-injectives}
and (\ref{equation-compare-big-small})
on choosing a K-injective complex of abelian sheaves representing $K$.

\medskip\noindent
Part (3) follows from Lemma \ref{spaces-more-cohomology-lemma-compare-injectives}
...
\source{stacks:0DGB}
\href{https://stacks.math.columbia.edu/tag/0DGB}{\texttt{Stacks tag 0DGB}}
\group{spaces-more-cohomology}
...
and apply Lemma \ref{spaces-more-cohomology-lemma-compare-injectives}
...
\source{stacks:0DGC}
\href{https://stacks.math.columbia.edu/tag/0DGC}{\texttt{Stacks tag 0DGC}}
\group{spaces-more-cohomology}
...
\source{stacks:0DGD}
\href{https://stacks.math.columbia.edu/tag/0DGD}{\texttt{Stacks tag 0DGD}}
\group{spaces-more-cohomology}
...
$$
\begin{array}{cc}Y' \underset{f'}{\longrightarrow}\underset{g'}{\downarrow} & X' \overset{g}{\downarrow} \\ Y \overset{f}{\longrightarrow} & X\end{array}
$$
Then we have
$$
...
$$
the second equality by Lemma \ref{spaces-more-cohomology-lemma-describe-pullback}.
On the other hand
$$
(\pi_X^{-1}f_{small, *}\mathcal{F})(X') =
(g_{small}^{-1}f_{small, *}\mathcal{F})(X')
$$
again by Lemma \ref{spaces-more-cohomology-lemma-describe-pullback}.
Hence by proper base change for sheaves of sets
(Lemma \ref{spaces-more-cohomology-lemma-proper-base-change-f-star})
...
Lemma \ref{spaces-more-cohomology-lemma-compare-higher-direct-image}.
This map is an isomorphism by the proper base change theorem
(Lemma \ref{spaces-more-cohomology-lemma-proper-base-change}) provided $K$ is bounded
...
we conclude from Lemma \ref{spaces-more-cohomology-lemma-compare-higher-direct-image} part (3)
...
$$
comparing big and small \'etale sites, see Section \ref{spaces-more-cohomology-section-compare}.
...
\begin{lemma}[Comparison fppf etale]
\label{spaces-more-cohomology-lemma-comparison-fppf-etale}
\source{stacks:0DGF}
\href{https://stacks.math.columbia.edu/tag/0DGF}{\texttt{Stacks tag 0DGF}}
\group{spaces-more-cohomology}
...
By Lemma \ref{spaces-more-cohomology-lemma-describe-pullback} the \'etale sheaf
...
in Lemma \ref{spaces-more-cohomology-lemma-describe-pullback}.
...
Lemma \ref{spaces-more-cohomology-lemma-compare-cohomology-other-topologies}
...
\source{stacks:0DGG}
\href{https://stacks.math.columbia.edu/tag/0DGG}{\texttt{Stacks tag 0DGG}}
\group{spaces-more-cohomology}
...
\medskip\noindent
By Lemma \ref{spaces-more-cohomology-lemma-comparison-fppf-etale} we have
...
By Lemma \ref{spaces-more-cohomology-lemma-comparison-fppf-etale}
we have $R^i\epsilon_{X, *}(a_X^{-1}\mathcal{F}) = 0$ for $i > 0$.
We have
$\epsilon_{X, *}a_X^{-1}\mathcal{F} = \pi_X^{-1}\mathcal{F}$
and by Lemma \ref{spaces-more-cohomology-lemma-cohomological-descent-etale} we have
...
\source{stacks:0DGH}
\href{https://stacks.math.columbia.edu/tag/0DGH}{\texttt{Stacks tag 0DGH}}
\group{spaces-more-cohomology}
...
\begin{proof}
This follows from Lemma \ref{spaces-more-cohomology-lemma-cohomological-descent-etale-fppf}
...
\source{stacks:0DGI}
\href{https://stacks.math.columbia.edu/tag/0DGI}{\texttt{Stacks tag 0DGI}}
\group{spaces-more-cohomology}
...
$$
\begin{array}{ccc}\Sh((\textit{Spaces}/X)_{fppf}) \underset{f_{big, fppf}}{\longrightarrow}\underset{\epsilon_X}{\downarrow} &  & \Sh((\textit{Spaces}/Y)_{fppf}) \overset{\epsilon_Y}{\downarrow} \\ \Sh((\textit{Spaces}/X)_\etale) \overset{f_{big, \etale}}{\longrightarrow} &  & \Sh((\textit{Spaces}/Y)_\etale)\end{array}
$$
and
$$
\begin{array}{ccc}\Sh((\textit{Spaces}/X)_{fppf}) \underset{f_{big, fppf}}{\longrightarrow}\underset{a_X}{\downarrow} &  & \Sh((\textit{Spaces}/Y)_{fppf}) \overset{a_Y}{\downarrow} \\ \Sh(X_\etale) \overset{f_{small}}{\longrightarrow} &  & \Sh(Y_\etale)\end{array}
$$
...
and Section \ref{spaces-more-cohomology-section-compare}.
\end{proof}

\begin{lemma}[Proper push pull fppf etale]
\label{spaces-more-cohomology-lemma-proper-push-pull-fppf-etale}
\source{stacks:0DGJ}
\href{https://stacks.math.columbia.edu/tag/0DGJ}{\texttt{Stacks tag 0DGJ}}
\group{spaces-more-cohomology}

In Lemma \ref{spaces-more-cohomology-lemma-push-pull-fppf-etale} if $f$ is proper, then we have
\begin{enumerate}
...
Lemma \ref{spaces-more-cohomology-lemma-compare-higher-direct-image-proper} part (1);
we will instead deduce the result from this.
As $\epsilon_{Y, *}$ is the identity functor on underlying presheaves,
it reflects isomorphisms. Lemma \ref{spaces-more-cohomology-lemma-comparison-fppf-etale}
...
(1) of Lemma \ref{spaces-more-cohomology-lemma-compare-higher-direct-image-proper}.
...
Lemma \ref{spaces-more-cohomology-lemma-push-pull-fppf-etale}
and Cohomology on Sites, Lemma
\ref{sites-cohomology-lemma-derived-pushforward-composition}.
Then second equality is Lemma \ref{spaces-more-cohomology-lemma-cohomological-descent-etale-fppf}.
The third is
Lemma \ref{spaces-more-cohomology-lemma-compare-higher-direct-image-proper} part (2).
The fourth is Lemma \ref{spaces-more-cohomology-lemma-cohomological-descent-etale-fppf} again.
...
\begin{lemma}[Finite push pull fppf etale]
\label{spaces-more-cohomology-lemma-finite-push-pull-fppf-etale}
\source{stacks:0DGK}
\href{https://stacks.math.columbia.edu/tag/0DGK}{\texttt{Stacks tag 0DGK}}
\group{spaces-more-cohomology}

In Lemma \ref{spaces-more-cohomology-lemma-push-pull-fppf-etale} if $f$ is finite, then
$a_Y^{-1}(Rf_{small, *}K) = Rf_{big, fppf, *}(a_X^{-1}K)$
for $K$ in $D^+(X_\etale)$.
\end{lemma}
...
Section \ref{spaces-more-cohomology-section-api}
...
\source{stacks:0DGL}
\href{https://stacks.math.columbia.edu/tag/0DGL}{\texttt{Stacks tag 0DGL}}
\group{spaces-more-cohomology}

In Lemma \ref{spaces-more-cohomology-lemma-push-pull-fppf-etale} assume
...
Lemma \ref{spaces-more-cohomology-lemma-comparison-fppf-etale}). Hence the forgetful functor
...
via the discussion in Section \ref{spaces-more-cohomology-section-api}
and in particular Lemma \ref{spaces-more-cohomology-lemma-compare-cohomology-other-topologies}.
\end{proof}

\section{Comparing fppf and \'etale topologies: modules}
\label{spaces-more-cohomology-section-fppf-etale-modules}
We continue the discussion in Section \ref{spaces-more-cohomology-section-fppf-etale} but in this
section we briefly discuss what happens for sheaves of modules.

\medskip\noindent
Let $S$ be a scheme. Let $X$ be an algebraic space over $S$.
The morphisms of sites $\epsilon_X$, $\pi_X$, and
their composition $a_X$ introduced in Section \ref{spaces-more-cohomology-section-fppf-etale}
...
\source{stacks:0DGN}
\href{https://stacks.math.columbia.edu/tag/0DGN}{\texttt{Stacks tag 0DGN}}
\group{spaces-more-cohomology}
...
\source{stacks:0DGP}
\href{https://stacks.math.columbia.edu/tag/0DGP}{\texttt{Stacks tag 0DGP}}
\group{spaces-more-cohomology}
...
Lemma \ref{spaces-more-cohomology-lemma-review-quasi-coherent}.
\end{proof}

\begin{lemma}[Vanishing adequate]
\label{spaces-more-cohomology-lemma-vanishing-adequate}
\source{stacks:0DGQ}
\href{https://stacks.math.columbia.edu/tag/0DGQ}{\texttt{Stacks tag 0DGQ}}
\group{spaces-more-cohomology}
...
the functor $i_f^* = i_f^{-1}$ discussed in Section \ref{spaces-more-cohomology-section-compare}.
...
by (1) of Lemma \ref{spaces-more-cohomology-lemma-review-quasi-coherent}
...
\begin{lemma}[Cohomological descent etale fppf modules unbounded]
\label{spaces-more-cohomology-lemma-cohomological-descent-etale-fppf-modules-unbounded}
\source{stacks:0DGR}
\href{https://stacks.math.columbia.edu/tag/0DGR}{\texttt{Stacks tag 0DGR}}
\group{spaces-more-cohomology}
...
Lemma \ref{spaces-more-cohomology-lemma-vanishing-adequate}.
Therefore we have
$$
...
in Lemma \ref{spaces-more-cohomology-lemma-vanishing-adequate} as this will prove
...
\begin{lemma}[Comparison ph etale]
\label{spaces-more-cohomology-lemma-comparison-ph-etale}
\source{stacks:0DGT}
\href{https://stacks.math.columbia.edu/tag/0DGT}{\texttt{Stacks tag 0DGT}}
\group{spaces-more-cohomology}
...
\source{stacks:0DGU}
\href{https://stacks.math.columbia.edu/tag/0DGU}{\texttt{Stacks tag 0DGU}}
\group{spaces-more-cohomology}
...
\medskip\noindent
By Lemma \ref{spaces-more-cohomology-lemma-comparison-ph-etale} we have
$a_{X, *}a_X^{-1}\mathcal{F} = \mathcal{F}$. Thus it suffices to show that
$R^qa_{X, *}a_X^{-1}\mathcal{F} = 0$ for $q > 0$.
For this we can use $a_X = \epsilon_X \circ \pi_X$ and
the Leray spectral sequence
(Cohomology on Sites, Lemma \ref{sites-cohomology-lemma-relative-Leray}).
By Lemma \ref{spaces-more-cohomology-lemma-comparison-ph-etale}
we have $R^i\epsilon_{X, *}(a_X^{-1}\mathcal{F}) = 0$ for $i > 0$.
We have
$\epsilon_{X, *}a_X^{-1}\mathcal{F} = \pi_X^{-1}\mathcal{F}$
and by Lemma \ref{spaces-more-cohomology-lemma-cohomological-descent-etale} we have
...
\source{stacks:0DGV}
\href{https://stacks.math.columbia.edu/tag/0DGV}{\texttt{Stacks tag 0DGV}}
\group{spaces-more-cohomology}
...
\begin{proof}
This follows from Lemma \ref{spaces-more-cohomology-lemma-cohomological-descent-etale-ph}
by Cohomology on Sites, Remark \ref{sites-cohomology-remark-before-Leray}.
\end{proof}
...
\source{stacks:0DGW}
\href{https://stacks.math.columbia.edu/tag/0DGW}{\texttt{Stacks tag 0DGW}}
\group{spaces-more-cohomology}
...
Then there are commutative diagrams of topoi
$$
\begin{array}{ccc}\Sh((\textit{Spaces}/X)_{ph}) \underset{f_{big, ph}}{\longrightarrow}\underset{\epsilon_X}{\downarrow} &  & \Sh((\textit{Spaces}/Y)_{ph}) \overset{\epsilon_Y}{\downarrow} \\ \Sh((\textit{Spaces}/X)_\etale) \overset{f_{big, \etale}}{\longrightarrow} &  & \Sh((\textit{Spaces}/Y)_\etale)\end{array}
$$
and
$$
\begin{array}{ccc}\Sh((\textit{Spaces}/X)_{ph}) \underset{f_{big, ph}}{\longrightarrow}\underset{a_X}{\downarrow} &  & \Sh((\textit{Spaces}/Y)_{ph}) \overset{a_Y}{\downarrow} \\ \Sh(X_\etale) \overset{f_{small}}{\longrightarrow} &  & \Sh(Y_\etale)\end{array}
$$
with $a_X = \pi_X \circ \epsilon_X$ and $a_Y = \pi_X \circ \epsilon_X$.
\end{lemma}
...
\source{stacks:0DGX}
\href{https://stacks.math.columbia.edu/tag/0DGX}{\texttt{Stacks tag 0DGX}}
\group{spaces-more-cohomology}

In Lemma \ref{spaces-more-cohomology-lemma-push-pull-ph-etale} if $f$ is proper, then we have
\begin{enumerate}
...
we will instead deduce the result from this.
As $\epsilon_{Y, *}$ is the identity functor on underlying presheaves,
it reflects isomorphisms. Lemma \ref{spaces-more-cohomology-lemma-comparison-ph-etale}
shows that $\epsilon_{Y, *} \circ a_Y^{-1} = \pi_Y^{-1}$
and similarly for $X$. To show that the canonical map
...
\end{align*}
The first equality by the commutative diagram in
Lemma \ref{spaces-more-cohomology-lemma-push-pull-ph-etale}
and Cohomology on Sites, Lemma
\ref{sites-cohomology-lemma-derived-pushforward-composition}.
Then second equality is Lemma \ref{spaces-more-cohomology-lemma-cohomological-descent-etale-ph}.
The third is
Lemma \ref{spaces-more-cohomology-lemma-compare-higher-direct-image-proper} part (2).
The fourth is Lemma \ref{spaces-more-cohomology-lemma-cohomological-descent-etale-ph} again.
Thus the base change map
