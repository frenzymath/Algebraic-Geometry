...
\source{stacks:00ZY}
\href{https://stacks.math.columbia.edu/tag/00ZY}{\texttt{Stacks tag 00ZY}}
\group{homology}
...
\begin{lemma}[Preadditive zero]
\label{homology-lemma-preadditive-zero}
\source{stacks:00ZZ}
\href{https://stacks.math.columbia.edu/tag/00ZZ}{\texttt{Stacks tag 00ZZ}}
\group{homology}
...
\source{stacks:0100}
\href{https://stacks.math.columbia.edu/tag/0100}{\texttt{Stacks tag 0100}}
\group{homology}

\uses{homology-lemma-preadditive-zero}
In a preadditive category $\mathcal{A}$, we call an object that is both
final and initial (as in Lemma \ref{homology-lemma-preadditive-zero}) a
{\it zero object} and denote it $0$.
\end{definition}

\begin{lemma}[Preadditive direct sum]
\label{homology-lemma-preadditive-direct-sum}
\source{stacks:0101}
\href{https://stacks.math.columbia.edu/tag/0101}{\texttt{Stacks tag 0101}}
\group{homology}
...
commutative diagram
$$
\begin{array}{ccc}x \overset{1}{\longrightarrow}\overset{i}{\searrow} &  & x \\  & z \overset{p}{\nearrow}\overset{q}{\searrow} &  \\ y \overset{1}{\longrightarrow}\overset{j}{\nearrow} &  & y\end{array}
$$
...
\source{stacks:0102}
\href{https://stacks.math.columbia.edu/tag/0102}{\texttt{Stacks tag 0102}}
\group{homology}

\uses{homology-lemma-preadditive-direct-sum}
...
$i, j, p, q$ as in Lemma \ref{homology-lemma-preadditive-direct-sum} above.
\end{definition}

\begin{remark}[Direct sum]
\label{homology-remark-direct-sum}
\source{stacks:0103}
\href{https://stacks.math.columbia.edu/tag/0103}{\texttt{Stacks tag 0103}}
\group{homology}

\uses{homology-lemma-preadditive-direct-sum}
Note that the proof of Lemma \ref{homology-lemma-preadditive-direct-sum}
...
\begin{lemma}[Additive additive]
\label{homology-lemma-additive-additive}
\source{stacks:0105}
\href{https://stacks.math.columbia.edu/tag/0105}{\texttt{Stacks tag 0105}}
\group{homology}
...
\begin{proof}
\uses{homology-remark-direct-sum, homology-lemma-preadditive-zero}
...
to Remark \ref{homology-remark-direct-sum}. Clearly $F(x), F(y), F(z)$
...
Lemma \ref{homology-lemma-preadditive-zero}.
\end{proof}

\begin{definition}[Additive category]
\label{homology-definition-additive-category}
\source{stacks:0104}
\href{https://stacks.math.columbia.edu/tag/0104}{\texttt{Stacks tag 0104}}
\group{homology}
...
\source{stacks:0106}
\href{https://stacks.math.columbia.edu/tag/0106}{\texttt{Stacks tag 0106}}
\group{homology}
...
\begin{lemma}[Additive cat biproduct kernel]
\label{homology-lemma-additive-cat-biproduct-kernel}
\source{stacks:09QG}
\href{https://stacks.math.columbia.edu/tag/09QG}{\texttt{Stacks tag 09QG}}
\group{homology}

\uses{homology-lemma-preadditive-direct-sum}
Let $\mathcal{C}$ be a preadditive category.
Let $x \oplus y$ with morphisms $i, j, p, q$ as in
Lemma \ref{homology-lemma-preadditive-direct-sum}
...
\begin{lemma}[Kernel mono]
\label{homology-lemma-kernel-mono}
\source{stacks:0E43}
\href{https://stacks.math.columbia.edu/tag/0E43}{\texttt{Stacks tag 0E43}}
\group{homology}
...
\begin{lemma}[Coim im map]
\label{homology-lemma-coim-im-map}
\source{stacks:0107}
\href{https://stacks.math.columbia.edu/tag/0107}{\texttt{Stacks tag 0107}}
\group{homology}
...
\begin{proof}
\uses{homology-lemma-kernel-mono}
...
Lemma \ref{homology-lemma-kernel-mono} (3)).
Hence $\Coim(f) \to y$ factors uniquely through
$\Im(f) \to y$, which gives us the desired map.
\end{proof}

\begin{example}[Not abelian]
\label{homology-example-not-abelian}
\source{stacks:0108}
\href{https://stacks.math.columbia.edu/tag/0108}{\texttt{Stacks tag 0108}}
\group{homology}

\uses{homology-definition-filtered}
Let $k$ be a field.
Consider the category
of filtered vector spaces over $k$.
(See Definition \ref{homology-definition-filtered}.)
...
\begin{remark}[Idempotent symmetry]
\label{homology-remark-idempotent-symmetry}
\source{stacks:0H9N}
\href{https://stacks.math.columbia.edu/tag/0H9N}{\texttt{Stacks tag 0H9N}}
\group{homology}
...
\begin{lemma}[Idempotent kernel cokernel]
\label{homology-lemma-idempotent-kernel-cokernel}
\source{stacks:0H9P}
\href{https://stacks.math.columbia.edu/tag/0H9P}{\texttt{Stacks tag 0H9P}}
\group{homology}

\uses{homology-remark-idempotent-symmetry}
Let $\mathcal{A}$ be a preadditive category,
$x$ be an object of $\mathcal{A}$,
and $f : x \to x$ be idempotent.
Write $g = \text{id} _ x - f$
and recall by Remark \ref{homology-remark-idempotent-symmetry}
...
\begin{proof}
\uses{homology-lemma-kernel-mono, homology-remark-idempotent-symmetry}
...
By Lemma \ref{homology-lemma-kernel-mono} we conclude that
...
cf. Remark \ref{homology-remark-idempotent-symmetry}),
and duality and symmetry respectively, (2), (3), and (4) follow as did (1).
\end{proof}

\begin{lemma}[Idempotent splitting]
\label{homology-lemma-idempotent-splitting}
\source{stacks:0H9Q}
\href{https://stacks.math.columbia.edu/tag/0H9Q}{\texttt{Stacks tag 0H9Q}}
\group{homology}

\uses{homology-lemma-idempotent-kernel-cokernel}
Let $\mathcal{A}$ be a preadditive category,
$x$ be an object of $\mathcal{A}$,
and $f : x \to x$ be idempotent.
Write $g = \text{id} _ x - f$.
...
as in the statement of Lemma \ref{homology-lemma-idempotent-kernel-cokernel},
...
\begin{proof}
\uses{homology-lemma-idempotent-kernel-cokernel, homology-remark-direct-sum}

By Lemma \ref{homology-lemma-idempotent-kernel-cokernel}
...
By Remark \ref{homology-remark-direct-sum} the claim follows.
\end{proof}

\begin{lemma}[Split morphism kernel cokernel]
\label{homology-lemma-split-morphism-kernel-cokernel}
\source{stacks:0H9R}
\href{https://stacks.math.columbia.edu/tag/0H9R}{\texttt{Stacks tag 0H9R}}
\group{homology}
...
\begin{lemma}[Split morphism splitting]
\label{homology-lemma-split-morphism-splitting}
\source{stacks:0H9S}
\href{https://stacks.math.columbia.edu/tag/0H9S}{\texttt{Stacks tag 0H9S}}
\group{homology}
...
\begin{proof}
\uses{homology-lemma-idempotent-splitting, homology-lemma-split-morphism-kernel-cokernel}

Write $f = j \circ q$,
compute that $f \circ f = f$,
and apply Lemma \ref{homology-lemma-idempotent-splitting}
and Lemma \ref{homology-lemma-split-morphism-kernel-cokernel}.
\end{proof}
...
\source{stacks:09SG}
\href{https://stacks.math.columbia.edu/tag/09SG}{\texttt{Stacks tag 09SG}}
\group{homology}
...
\begin{lemma}[Karoubian]
\label{homology-lemma-karoubian}
\source{stacks:09SH}
\href{https://stacks.math.columbia.edu/tag/09SH}{\texttt{Stacks tag 09SH}}
\group{homology}
...
\begin{proof}
\uses{homology-lemma-idempotent-kernel-cokernel, homology-lemma-idempotent-splitting, homology-lemma-additive-cat-biproduct-kernel}

Immediate via Lemmas \ref{homology-lemma-idempotent-kernel-cokernel},
\ref{homology-lemma-idempotent-splitting}, and \ref{homology-lemma-additive-cat-biproduct-kernel}.
\end{proof}

\begin{lemma}[Projectors have images]
\label{homology-lemma-projectors-have-images}
\source{stacks:05QV}
\href{https://stacks.math.columbia.edu/tag/05QV}{\texttt{Stacks tag 05QV}}
\group{homology}
...
Lemma \ref{homology-lemma-karoubian}).
\end{proof}
...
of Lemma \ref{homology-lemma-coim-im-map} is always an isomorphism.
Example \ref{homology-example-not-abelian} shows that it is necessary.

\begin{definition}[Abelian category]
\label{homology-definition-abelian-category}
\source{stacks:0109}
\href{https://stacks.math.columbia.edu/tag/0109}{\texttt{Stacks tag 0109}}
\group{homology}
...
\begin{lemma}[Abelian opposite]
\label{homology-lemma-abelian-opposite}
\source{stacks:010A}
\href{https://stacks.math.columbia.edu/tag/010A}{\texttt{Stacks tag 010A}}
\group{homology}
...
\source{stacks:010B}
\href{https://stacks.math.columbia.edu/tag/010B}{\texttt{Stacks tag 010B}}
\group{homology}
...
\begin{lemma}[Characterize injective]
\label{homology-lemma-characterize-injective}
\source{stacks:010C}
\href{https://stacks.math.columbia.edu/tag/010C}{\texttt{Stacks tag 010C}}
\group{homology}
...
\begin{proof}
\uses{homology-definition-kernel}
...
Definition \ref{homology-definition-kernel}.
...
\begin{lemma}[Colimit abelian category]
\label{homology-lemma-colimit-abelian-category}
\source{stacks:010D}
\href{https://stacks.math.columbia.edu/tag/010D}{\texttt{Stacks tag 010D}}
\group{homology}
...
\begin{example}[Fibre product pushouts]
\label{homology-example-fibre-product-pushouts}
\source{stacks:05PJ}
\href{https://stacks.math.columbia.edu/tag/05PJ}{\texttt{Stacks tag 05PJ}}
\group{homology}
...
\source{stacks:010E}
\href{https://stacks.math.columbia.edu/tag/010E}{\texttt{Stacks tag 010E}}
\group{homology}
...
\begin{lemma}[Check exactness]
\label{homology-lemma-check-exactness}
\source{stacks:05AA}
\href{https://stacks.math.columbia.edu/tag/05AA}{\texttt{Stacks tag 05AA}}
\group{homology}
...
\begin{definition}[Ses split]
\label{homology-definition-ses-split}
\source{stacks:010F}
\href{https://stacks.math.columbia.edu/tag/010F}{\texttt{Stacks tag 010F}}
\group{homology}
...
\begin{lemma}[Ses split]
\label{homology-lemma-ses-split}
\source{stacks:010G}
\href{https://stacks.math.columbia.edu/tag/010G}{\texttt{Stacks tag 010G}}
\group{homology}

\uses{homology-definition-ses-split}
Let $\mathcal{A}$ be an abelian category.
...
as in Definition \ref{homology-definition-ses-split}.
...
\begin{proof}
\uses{homology-lemma-split-morphism-splitting}

Immediate corollary of Lemma \ref{homology-lemma-split-morphism-splitting}.
\end{proof}

\begin{lemma}[Characterize cartesian]
\label{homology-lemma-characterize-cartesian}
\source{stacks:08N2}
\href{https://stacks.math.columbia.edu/tag/08N2}{\texttt{Stacks tag 08N2}}
\group{homology}

Let $\mathcal{A}$ be an abelian category. Let
$$
\begin{array}{cc}w\overset{f}{\longrightarrow}\underset{g}{\downarrow} & y\overset{h}{\downarrow} \\ x\overset{k}{\longrightarrow} & z\end{array}
$$
...
\begin{proof}
\uses{homology-example-fibre-product-pushouts}
...
injection. By Example \ref{homology-example-fibre-product-pushouts}, the diagram is
...
\begin{lemma}[Cartesian kernel]
\label{homology-lemma-cartesian-kernel}
\source{stacks:08N3}
\href{https://stacks.math.columbia.edu/tag/08N3}{\texttt{Stacks tag 08N3}}
\group{homology}
...
\begin{lemma}[Cartesian cocartesian]
\label{homology-lemma-cartesian-cocartesian}
\source{stacks:08N4}
\href{https://stacks.math.columbia.edu/tag/08N4}{\texttt{Stacks tag 08N4}}
\group{homology}
...
\begin{proof}
\uses{homology-lemma-characterize-cartesian, homology-lemma-cartesian-kernel, homology-lemma-characterize-injective}
...
and by Lemma \ref{homology-lemma-characterize-cartesian}, the sequence
$0\to w\overset{u}\to x\oplus y\overset{v}\to z\to 0$ is exact. Thus, the
diagram is cocartesian by Lemma \ref{homology-lemma-characterize-cartesian}. Finally,
$f$ is an epimorphism by Lemma \ref{homology-lemma-cartesian-kernel} and
Lemma \ref{homology-lemma-characterize-injective}. This proves (1), and (2)
follows by duality.
\end{proof}

\begin{lemma}[Epimorphism universal abelian category]
\label{homology-lemma-epimorphism-universal-abelian-category}
\source{stacks:05PK}
\href{https://stacks.math.columbia.edu/tag/05PK}{\texttt{Stacks tag 05PK}}
\group{homology}
...
\begin{proof}
\uses{homology-lemma-characterize-injective, homology-lemma-cartesian-cocartesian}

Immediately from Lemma \ref{homology-lemma-characterize-injective} and
Lemma \ref{homology-lemma-cartesian-cocartesian}.
\end{proof}

\begin{lemma}[Check exactness fibre product]
\label{homology-lemma-check-exactness-fibre-product}
\source{stacks:08N5}
\href{https://stacks.math.columbia.edu/tag/08N5}{\texttt{Stacks tag 08N5}}
\group{homology}
...
\begin{proof}
\uses{homology-lemma-cartesian-cocartesian}
...
epimorphism by Lemma \ref{homology-lemma-cartesian-cocartesian}. This implies (2).
...
\begin{lemma}[Exact kernel sequence]
\label{homology-lemma-exact-kernel-sequence}
\source{stacks:08N6}
\href{https://stacks.math.columbia.edu/tag/08N6}{\texttt{Stacks tag 08N6}}
\group{homology}

Let $\mathcal{A}$ be an abelian category. Let
$$
\begin{array}{ccc}x \overset{f}{\longrightarrow}\overset{\alpha}{\downarrow} & y \overset{g}{\longrightarrow}\overset{\beta}{\downarrow} & z \overset{\gamma}{\downarrow} \\ u \overset{k}{\longrightarrow} & v \overset{l}{\longrightarrow} & w\end{array}
$$
be a commutative diagram.
\begin{enumerate}
...
\begin{proof}
\uses{homology-lemma-check-exactness-fibre-product}
...
Lemma \ref{homology-lemma-check-exactness-fibre-product} there are an object $t$, an
...
Lemma \ref{homology-lemma-check-exactness-fibre-product} implies (1), and then
...
\source{stacks:010H}
\href{https://stacks.math.columbia.edu/tag/010H}{\texttt{Stacks tag 010H}}
\group{homology}

Let $\mathcal{A}$ be an abelian category. Let
$$
\begin{array}{ccccc} & x \overset{f}{\longrightarrow}\overset{\alpha}{\downarrow} & y \overset{g}{\longrightarrow}\overset{\beta}{\downarrow} & z \longrightarrow\overset{\gamma}{\downarrow} & 0 \\ 0 \longrightarrow & u \overset{k}{\longrightarrow} & v \overset{l}{\longrightarrow} & w & \end{array}
$$
...
$$
\begin{array}{ccc}y \underset{\beta}{\downarrow} & y \times_z \Ker(\gamma) \underset{\pi'}{\longleftarrow}\overset{\pi}{\longrightarrow} & \Ker(\gamma) \overset{\delta}{\downarrow} \\ v \overset{\iota'}{\longrightarrow} & \Coker(\alpha) \amalg_u v & \Coker(\alpha) \underset{\iota}{\longleftarrow}\end{array}
$$
...
\begin{proof}
\uses{homology-lemma-cartesian-cocartesian, homology-lemma-cartesian-kernel, homology-lemma-check-exactness-fibre-product, homology-lemma-exact-kernel-sequence}

As $\pi$ is an epimorphism and $\iota$ is a monomorphism by
Lemma \ref{homology-lemma-cartesian-cocartesian}, uniqueness of $\delta$ is clear.
...
Keeping in mind Lemma \ref{homology-lemma-cartesian-cocartesian} we get a commutative
diagram with exact rows
$$
\begin{array}{ccccc}0 \longrightarrow & \Ker(\pi) \overset{j}{\longrightarrow} & p \overset{\pi}{\longrightarrow}\underset{\pi'}{\downarrow} & \Ker(\gamma) \underset{i}{\downarrow}\longrightarrow & 0 \\  & x \overset{f}{\longrightarrow}\underset{\alpha}{\downarrow} & y \overset{g}{\longrightarrow}\underset{\beta}{\downarrow} & z \underset{\gamma}{\downarrow}\longrightarrow & 0 \\ 0 \longrightarrow & u \overset{k}{\longrightarrow}\underset{\pi''}{\downarrow} & v \overset{l}{\longrightarrow}\underset{\iota'}{\downarrow} & w &  \\ 0 \longrightarrow & \Coker(\alpha) \overset{\iota}{\longrightarrow} & q &  & \end{array}
$$
...
diagram above is cartesian, Lemma \ref{homology-lemma-cartesian-kernel} yields an
...
Lemma \ref{homology-lemma-check-exactness-fibre-product} to the exact sequence
...
applying Lemma \ref{homology-lemma-check-exactness-fibre-product} to the exact sequence
...
Lemma \ref{homology-lemma-check-exactness-fibre-product} implies that
$\Ker(\beta) \xrightarrow{g'} \Ker(\gamma) \xrightarrow{\delta} \Coker(\alpha)$
is exact. Then, the claim follows by Lemma \ref{homology-lemma-exact-kernel-sequence}
and duality.
\end{proof}

\begin{lemma}[Snake natural]
\label{homology-lemma-snake-natural}
\source{stacks:08N7}
\href{https://stacks.math.columbia.edu/tag/08N7}{\texttt{Stacks tag 08N7}}
\group{homology}

Let $\mathcal{A}$ be an abelian category. Let
$$
\begin{array}{cccccccccc} &  &  & x\swarrow\longrightarrow\overset{(}{\downarrow}.4)\alpha &  & y\swarrow\longrightarrow\overset{(}{\downarrow}.4)\beta &  & z\swarrow\longrightarrow\overset{(}{\downarrow}.4)\gamma &  & 0 \\  &  & x'\longrightarrow\overset{(}{\downarrow}.4){\alpha'} &  & y'\longrightarrow\overset{(}{\downarrow}.4){\beta'} &  & z'\longrightarrow\overset{(}{\downarrow}.4){\gamma'} &  & 0 &  \\  & 0\longrightarrow &  & u\swarrow\longrightarrow &  & v\swarrow\longrightarrow &  & w\swarrow &  &  \\ 0\longrightarrow &  & u'\longrightarrow &  & v'\longrightarrow &  & w' &  &  & \end{array}
$$
be a commutative diagram with exact rows. Then, the induced diagram
$$
\begin{array}{cccccc}\Ker(\alpha) \longrightarrow\downarrow & \Ker(\beta) \longrightarrow\downarrow & \Ker(\gamma) \overset{(}{\longrightarrow}.45){\delta} \downarrow & \Coker(\alpha) \longrightarrow\downarrow & \Coker(\beta) \longrightarrow\downarrow & \Coker(\gamma) \downarrow \\ \Ker(\alpha') \longrightarrow & \Ker(\beta') \longrightarrow & \Ker(\gamma') \overset{(}{\longrightarrow}.45){\delta'} & \Coker(\alpha') \longrightarrow & \Coker(\beta') \longrightarrow & \Coker(\gamma')\end{array}
$$
commutes.
\end{lemma}
...
\source{stacks:05QA}
\href{https://stacks.math.columbia.edu/tag/05QA}{\texttt{Stacks tag 05QA}}
\group{homology}

Let $\mathcal{A}$ be an abelian category. Let
$$
\begin{array}{cccc}w \longrightarrow\overset{\alpha}{\downarrow} & x \longrightarrow\overset{\beta}{\downarrow} & y \longrightarrow\overset{\gamma}{\downarrow} & z \overset{\delta}{\downarrow} \\ w' \longrightarrow & x' \longrightarrow & y' \longrightarrow & z'\end{array}
$$
be a commutative diagram with exact rows.
\begin{enumerate}
...
Lemma \ref{homology-lemma-snake}
to
$$
\begin{array}{ccccc} & \Ker(y \to z) \longrightarrow\downarrow & y \longrightarrow\downarrow & z \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & \Ker(y' \to z') \longrightarrow & y' \longrightarrow & z' & \end{array}
$$
...
to
$$
\begin{array}{ccccc} & w \longrightarrow\downarrow & x \longrightarrow\downarrow & \Ker(y \to z) \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & w' \longrightarrow & x' \longrightarrow & \Ker(y' \to z') & \end{array}
$$
...
\source{stacks:05QB}
\href{https://stacks.math.columbia.edu/tag/05QB}{\texttt{Stacks tag 05QB}}
\group{homology}
...
Let $\mathcal{A}$ be an abelian category. Let
$$
\begin{array}{ccccc}v \longrightarrow\overset{\alpha}{\downarrow} & w \longrightarrow\overset{\beta}{\downarrow} & x \longrightarrow\overset{\gamma}{\downarrow} & y \longrightarrow\overset{\delta}{\downarrow} & z \overset{\epsilon}{\downarrow} \\ v' \longrightarrow & w' \longrightarrow & x' \longrightarrow & y' \longrightarrow & z'\end{array}
$$
...
\begin{proof}
\uses{homology-lemma-four-lemma}

Immediate consequence of
Lemma \ref{homology-lemma-four-lemma}.
\end{proof}
...
\source{stacks:010J}
\href{https://stacks.math.columbia.edu/tag/010J}{\texttt{Stacks tag 010J}}
\group{homology}
...
$$
\begin{array}{ccccc}0 \longrightarrow & A \longrightarrow\overset{\text{id}}{\downarrow} & E \longrightarrow\overset{f}{\downarrow} & B \longrightarrow\overset{\text{id}}{\downarrow} & 0 \\ 0 \longrightarrow & A \longrightarrow & F \longrightarrow & B \longrightarrow & 0\end{array}
$$
commutative.
...
\source{stacks:010K}
\href{https://stacks.math.columbia.edu/tag/010K}{\texttt{Stacks tag 010K}}
\group{homology}
...
By Lemma \ref{homology-lemma-cartesian-kernel} we have the following
commutative diagram of short exact sequences
$$
\begin{array}{ccccc}0 \longrightarrow & A \longrightarrow\downarrow & E' \longrightarrow\downarrow & B' \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & A \longrightarrow & E \longrightarrow & B \longrightarrow & 0\end{array}
$$
...
By Lemma \ref{homology-lemma-cartesian-cocartesian}
...
$$
\begin{array}{ccccc}0 \longrightarrow & A \oplus A \longrightarrow\underset{\Sigma}{\downarrow} & E_1 \oplus E_2 \longrightarrow\downarrow & B \oplus B \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & A \longrightarrow & E' \longrightarrow & B \oplus B \longrightarrow & 0 \\ 0 \longrightarrow & A \longrightarrow\uparrow & E_1 + E_2 \longrightarrow\uparrow & B \longrightarrow\overset{\Delta}{\uparrow} & 0\end{array}
$$
The extension $E_1 + E_2$ is called the {\it Baer sum} of the
given extensions.

\begin{lemma}[Baer sum]
\label{homology-lemma-baer-sum}
\source{stacks:010L}
\href{https://stacks.math.columbia.edu/tag/010L}{\texttt{Stacks tag 010L}}
\group{homology}
...
\begin{lemma}[Six term sequence ext]
\label{homology-lemma-six-term-sequence-ext}
\source{stacks:05E2}
\href{https://stacks.math.columbia.edu/tag/05E2}{\texttt{Stacks tag 05E2}}
\group{homology}
...
$$
\begin{array}{cccc}0 \longrightarrow & \Hom_\mathcal{A}(M_3, N) \longrightarrow & \Hom_\mathcal{A}(M_2, N) \longrightarrow & \Hom_\mathcal{A}(M_1, N) \swarrow \\  & \Ext_\mathcal{A}(M_3, N) \longrightarrow & \Ext_\mathcal{A}(M_2, N) \longrightarrow & \Ext_\mathcal{A}(M_1, N)\end{array}
$$
for all objects $N$ of $\mathcal{A}$, and
\item there is a canonical six term exact sequence of abelian groups
$$
\begin{array}{cccc}0 \longrightarrow & \Hom_\mathcal{A}(N, M_1) \longrightarrow & \Hom_\mathcal{A}(N, M_2) \longrightarrow & \Hom_\mathcal{A}(N, M_3) \swarrow \\  & \Ext_\mathcal{A}(N, M_1) \longrightarrow & \Ext_\mathcal{A}(N, M_2) \longrightarrow & \Ext_\mathcal{A}(N, M_3)\end{array}
$$
...
\begin{lemma}[Additive functor]
\label{homology-lemma-additive-functor}
\source{stacks:0DLP}
\href{https://stacks.math.columbia.edu/tag/0DLP}{\texttt{Stacks tag 0DLP}}
\group{homology}
...
\begin{proof}
\uses{homology-lemma-additive-additive}

Additive functors commute with direct sums by
Lemma \ref{homology-lemma-additive-additive} hence (1)
...
$$
\begin{array}{ccccc}F(A) \longrightarrow\searrow & F(A \oplus A) \underset{F(\text{diag}(f, g))}{\longrightarrow} &  & F(B \oplus B) \longrightarrow\downarrow & F(B) \\  & F(A) \oplus F(A) \uparrow\overset{\text{diag}(F(f), F(g))}{\longrightarrow} &  & F(B) \oplus F(B) \nearrow & \end{array}
$$
...
\begin{lemma}[Exact functor]
\label{homology-lemma-exact-functor}
\source{stacks:010N}
\href{https://stacks.math.columbia.edu/tag/010N}{\texttt{Stacks tag 010N}}
\group{homology}
...
\begin{proof}
\uses{homology-lemma-additive-functor, homology-lemma-additive-cat-biproduct-kernel, homology-lemma-snake}

If $F$ is left exact, i.e., $F$ commutes with finite limits, then
$F$ sends products to products, hence $F$ preserved direct sums,
hence $F$ is additive by Lemma \ref{homology-lemma-additive-functor}.
...
$$
see for example Lemma \ref{homology-lemma-additive-cat-biproduct-kernel}.
By assumption, the lower row in the commutative diagram
$$
\begin{array}{ccccc}0 \longrightarrow & F(A) \downarrow\longrightarrow & F(A) \oplus F(B) \longrightarrow\downarrow & F(B) \downarrow\longrightarrow & 0 \\ 0 \longrightarrow & F(A) \longrightarrow & F(A \oplus B) \longrightarrow & F(B) & \end{array}
$$
is exact. Hence by the snake lemma (Lemma \ref{homology-lemma-snake})
...
\begin{lemma}[Exact functor ext]
\label{homology-lemma-exact-functor-ext}
\source{stacks:010O}
\href{https://stacks.math.columbia.edu/tag/010O}{\texttt{Stacks tag 010O}}
\group{homology}
...
\begin{lemma}[Adjoint get abelian]
\label{homology-lemma-adjoint-get-abelian}
\source{stacks:03A3}
\href{https://stacks.math.columbia.edu/tag/03A3}{\texttt{Stacks tag 03A3}}
\group{homology}
...
\begin{proof}
\uses{homology-lemma-colimit-abelian-category}

As $\mathcal{B}$ is abelian we see that all finite limits and colimits
exist in $\mathcal{B}$ by Lemma \ref{homology-lemma-colimit-abelian-category}.
...
Lemma \ref{homology-lemma-colimit-abelian-category}).
...
\begin{lemma}[Localization preadditive]
\label{homology-lemma-localization-preadditive}
\source{stacks:05QD}
\href{https://stacks.math.columbia.edu/tag/05QD}{\texttt{Stacks tag 05QD}}
\group{homology}
...
$$
\begin{array}{ccc} &  & Z \overset{t}{\downarrow} \\  & Y \overset{h}{\longrightarrow}\overset{s}{\downarrow} & Z' \overset{t'}{\downarrow} \\ X \overset{f, g}{\longrightarrow} & Y' \overset{a}{\longrightarrow} & Z''\end{array}
$$
Then
...
$$
\begin{array}{cccc} &  &  & Y \overset{s}{\downarrow} \\  & X \overset{f, g, f + g}{\longrightarrow}\overset{r}{\downarrow} &  & Y' \overset{s'}{\downarrow} \\ W \overset{i}{\longrightarrow} & X' \overset{a'', b'', a'' + b''}{\longrightarrow} &  & Y''\end{array}
$$
...
\begin{lemma}[Localization additive]
\label{homology-lemma-localization-additive}
\source{stacks:05QE}
\href{https://stacks.math.columbia.edu/tag/05QE}{\texttt{Stacks tag 05QE}}
\group{homology}
...
\begin{proof}
\uses{homology-lemma-localization-preadditive, homology-lemma-additive-additive}

By Lemma \ref{homology-lemma-localization-preadditive}
we see that $S^{-1}\mathcal{C}$ is preadditive and that $Q$ is additive.
By Lemma \ref{homology-lemma-additive-additive} we conclude that $S^{-1}\mathcal{C}$
...
\source{stacks:05QF}
\href{https://stacks.math.columbia.edu/tag/05QF}{\texttt{Stacks tag 05QF}}
\group{homology}
...
\begin{lemma}[Localization abelian]
\label{homology-lemma-localization-abelian}
\source{stacks:05QG}
\href{https://stacks.math.columbia.edu/tag/05QG}{\texttt{Stacks tag 05QG}}
\group{homology}
...
The Jordan-H\"older lemma is Lemma \ref{homology-lemma-jordan-holder}.
First we state some definitions.

\begin{definition}[Simple]
\label{homology-definition-simple}
\source{stacks:0FCE}
\href{https://stacks.math.columbia.edu/tag/0FCE}{\texttt{Stacks tag 0FCE}}
\group{homology}
...
\source{stacks:0FCF}
\href{https://stacks.math.columbia.edu/tag/0FCF}{\texttt{Stacks tag 0FCF}}
\group{homology}
...
\source{stacks:0FCG}
\href{https://stacks.math.columbia.edu/tag/0FCG}{\texttt{Stacks tag 0FCG}}
\group{homology}
...
\begin{lemma}[Ses artinian]
\label{homology-lemma-ses-artinian}
\source{stacks:0FCH}
\href{https://stacks.math.columbia.edu/tag/0FCH}{\texttt{Stacks tag 0FCH}}
\group{homology}
...
\begin{lemma}[Ses noetherian]
\label{homology-lemma-ses-noetherian}
\source{stacks:0FCI}
\href{https://stacks.math.columbia.edu/tag/0FCI}{\texttt{Stacks tag 0FCI}}
\group{homology}
...
\begin{lemma}[Finite length]
\label{homology-lemma-finite-length}
\source{stacks:0FCJ}
\href{https://stacks.math.columbia.edu/tag/0FCJ}{\texttt{Stacks tag 0FCJ}}
\group{homology}
...
\begin{proof}
\uses{homology-lemma-ses-artinian, homology-lemma-ses-noetherian}
...
and Lemmas \ref{homology-lemma-ses-artinian} and \ref{homology-lemma-ses-noetherian}
to conclude for $n$.
\end{proof}
...
\source{stacks:0FCK}
\href{https://stacks.math.columbia.edu/tag/0FCK}{\texttt{Stacks tag 0FCK}}
\group{homology}

\uses{homology-lemma-finite-length}
Let $\mathcal{A}$ be an abelian category. Let $A$ be an object
of $\mathcal{A}$ satisfying the equivalent conditions of
Lemma \ref{homology-lemma-finite-length}. Given two filtrations
$$
0 \subset A_1 \subset A_2 \subset \ldots \subset A_n = A
\quad\text{and}\quad
...
\source{stacks:02MO}
\href{https://stacks.math.columbia.edu/tag/02MO}{\texttt{Stacks tag 02MO}}
\group{homology}

\uses{homology-definition-exact}
\begin{reference}
...
Definition \ref{homology-definition-exact} this means $\Im(A \to B) = \Ker(B \to C)$.}
$$
A \to B \to C
$$
...
\begin{lemma}[Characterize serre subcategory]
\label{homology-lemma-characterize-serre-subcategory}
\source{stacks:02MP}
\href{https://stacks.math.columbia.edu/tag/02MP}{\texttt{Stacks tag 02MP}}
\group{homology}
...
\begin{lemma}[Characterize weak serre subcategory]
\label{homology-lemma-characterize-weak-serre-subcategory}
\source{stacks:0754}
\href{https://stacks.math.columbia.edu/tag/0754}{\texttt{Stacks tag 0754}}
\group{homology}
...
\begin{lemma}[Kernel exact functor]
\label{homology-lemma-kernel-exact-functor}
\source{stacks:02MQ}
\href{https://stacks.math.columbia.edu/tag/02MQ}{\texttt{Stacks tag 02MQ}}
\group{homology}
...
\source{stacks:02MR}
\href{https://stacks.math.columbia.edu/tag/02MR}{\texttt{Stacks tag 02MR}}
\group{homology}
...
\begin{lemma}[Serre subcategory is kernel]
\label{homology-lemma-serre-subcategory-is-kernel}
\source{stacks:02MS}
\href{https://stacks.math.columbia.edu/tag/02MS}{\texttt{Stacks tag 02MS}}
\group{homology}
...
\begin{proof}
\uses{homology-lemma-localization-abelian, homology-lemma-kernel-localization, homology-lemma-exact-functor}
...
$$
\begin{array}{cc}A \underset{t}{\downarrow}\underset{g}{\longrightarrow} & B \overset{s}{\downarrow} \\ C \overset{f}{\dashrightarrow} & C \amalg_A B\end{array}
$$
with $t \in S$. Set
...
with taking kernels and cokernels, see Lemma \ref{homology-lemma-exact-functor}.
...
\begin{lemma}[Quotient by kernel exact functor]
\label{homology-lemma-quotient-by-kernel-exact-functor}
\source{stacks:06XK}
\href{https://stacks.math.columbia.edu/tag/06XK}{\texttt{Stacks tag 06XK}}
\group{homology}

\uses{homology-lemma-serre-subcategory-is-kernel}
Let $\mathcal{A}$, $\mathcal{B}$ be abelian categories.
Let $F : \mathcal{A} \to \mathcal{B}$ be an exact functor.
Let $\mathcal{C} \subset \mathcal{A}$ be a Serre subcategory
...
(Lemma \ref{homology-lemma-serre-subcategory-is-kernel}) is faithful.
\end{lemma}

\begin{proof}
\uses{homology-lemma-serre-subcategory-is-kernel}

We will use the results of Lemma \ref{homology-lemma-serre-subcategory-is-kernel}
...
\source{stacks:02MU}
\href{https://stacks.math.columbia.edu/tag/02MU}{\texttt{Stacks tag 02MU}}
\group{homology}
...
\begin{lemma}[Exact functor K groups]
\label{homology-lemma-exact-functor-K-groups}
\source{stacks:02MV}
\href{https://stacks.math.columbia.edu/tag/02MV}{\texttt{Stacks tag 02MV}}
\group{homology}
...
\begin{lemma}[Serre subcategory K groups]
\label{homology-lemma-serre-subcategory-K-groups}
\source{stacks:02MX}
\href{https://stacks.math.columbia.edu/tag/02MX}{\texttt{Stacks tag 02MX}}
\group{homology}
...
\begin{proof}
\uses{homology-lemma-serre-subcategory-is-kernel, homology-lemma-localization-abelian}
...
The proof of Lemmas \ref{homology-lemma-serre-subcategory-is-kernel} and
\ref{homology-lemma-localization-abelian} show that we choose for $i \in I$
...
\begin{definition}[Cohomological delta functor]
\label{homology-definition-cohomological-delta-functor}
\source{stacks:010Q}
\href{https://stacks.math.columbia.edu/tag/010Q}{\texttt{Stacks tag 010Q}}
\group{homology}
...
$$
\begin{array}{cccc}0 \longrightarrow & F^0(A) \longrightarrow & F^0(B) \longrightarrow & F^0(C) \overset{\delta_{A \to B \to C}}{\swarrow} \\  & F^1(A) \longrightarrow & F^1(B) \longrightarrow & F^1(C) \overset{\delta_{A \to B \to C}}{\swarrow} \\  & F^2(A) \longrightarrow & F^2(B) \longrightarrow & \ldots\end{array}
$$
is exact, and
\item for every morphism $(A \to B \to C) \to (A' \to B' \to C')$
of short exact sequences of $\mathcal{A}$ the diagrams
$$
\begin{array}{ccc}F^n(C) \downarrow\underset{\delta_{A \to B \to C}}{\longrightarrow} &  & F^{n + 1}(A) \downarrow \\ F^n(C') \overset{\delta_{A' \to B' \to C'}}{\longrightarrow} &  & F^{n + 1}(A')\end{array}
$$
are commutative.
\end{enumerate}
\end{definition}
...
\begin{definition}[Morphism delta functors]
\label{homology-definition-morphism-delta-functors}
\source{stacks:010R}
\href{https://stacks.math.columbia.edu/tag/010R}{\texttt{Stacks tag 010R}}
\group{homology}
...
$$
\begin{array}{ccc}F^n(C) \underset{t^n}{\downarrow}\underset{\delta_{F, A \to B \to C}}{\longrightarrow} &  & F^{n + 1}(A) \overset{t^{n + 1}}{\downarrow} \\ G^n(C) \overset{\delta_{G, A \to B \to C}}{\longrightarrow} &  & G^{n + 1}(A)\end{array}
$$
are commutative.
\end{definition}

\begin{definition}[Universal delta functor]
\label{homology-definition-universal-delta-functor}
\source{stacks:010S}
\href{https://stacks.math.columbia.edu/tag/010S}{\texttt{Stacks tag 010S}}
\group{homology}
...
\begin{lemma}[Efface implies universal]
\label{homology-lemma-efface-implies-universal}
\source{stacks:010T}
\href{https://stacks.math.columbia.edu/tag/010T}{\texttt{Stacks tag 010T}}
\group{homology}
...
$$
\begin{array}{cc}\Coker(F^n(B) \to F^n(C)) \underset{t^n}{\longrightarrow}\underset{\delta_{F, A \to B \to C}}{\downarrow} & \Coker(G^n(B) \to G^n(C))
\overset{\delta_{G, A \to B \to C}}{\downarrow} \\ F^{n + 1}(A) \overset{t^{n + 1}_A}{\longrightarrow} & G^{n + 1}(A)\end{array}
$$
...
\begin{lemma}[Uniqueness universal delta functor]
\label{homology-lemma-uniqueness-universal-delta-functor}
\source{stacks:010U}
\href{https://stacks.math.columbia.edu/tag/010U}{\texttt{Stacks tag 010U}}
\group{homology}
...
the diagrams
$$
\begin{array}{cc}A_i \underset{d_i}{\longrightarrow}\underset{f_i}{\downarrow} & A_{i - 1} \overset{f_{i - 1}}{\downarrow} \\ B_i \overset{d_i}{\longrightarrow} & B_{i - 1}\end{array}
$$
...
Section \ref{homology-section-homotopy-shift}.
...
\begin{lemma}[Hom functors of $Ch(A)$ respect the homotopy relation.]
\label{homology-lemma-compose-homotopy}
\source{stacks:010W}
\href{https://stacks.math.columbia.edu/tag/010W}{\texttt{Stacks tag 010W}}
\group{homology}
...
\source{stacks:010X}
\href{https://stacks.math.columbia.edu/tag/010X}{\texttt{Stacks tag 010X}}
\group{homology}
...
\begin{lemma}[Cat chain abelian]
\label{homology-lemma-cat-chain-abelian}
\source{stacks:010Y}
\href{https://stacks.math.columbia.edu/tag/010Y}{\texttt{Stacks tag 010Y}}
\group{homology}
...
\source{stacks:010Z}
\href{https://stacks.math.columbia.edu/tag/010Z}{\texttt{Stacks tag 010Z}}
\group{homology}
...
\begin{lemma}[Map homology homotopy]
\label{homology-lemma-map-homology-homotopy}
\source{stacks:0110}
\href{https://stacks.math.columbia.edu/tag/0110}{\texttt{Stacks tag 0110}}
\group{homology}
...
\begin{lemma}[Long exact sequence chain]
\label{homology-lemma-long-exact-sequence-chain}
\source{stacks:0111}
\href{https://stacks.math.columbia.edu/tag/0111}{\texttt{Stacks tag 0111}}
\group{homology}
...
$$
\begin{array}{ccc}\ldots & \ldots & \ldots \swarrow \\ H_i(A_\bullet) \longrightarrow & H_i(B_\bullet) \longrightarrow & H_i(C_\bullet) \swarrow \\ H_{i - 1}(A_\bullet) \longrightarrow & H_{i - 1}(B_\bullet) \longrightarrow & H_{i - 1}(C_\bullet) \swarrow \\ \ldots & \ldots & \ldots \\  &  & \end{array}
$$
\end{lemma}
...
Omitted. The maps come from the Snake Lemma \ref{homology-lemma-snake}
applied to the diagrams
$$
\begin{array}{ccccc} & A_i/\Im(d_{A, i + 1}) \longrightarrow\overset{d_{A, i}}{\downarrow} & B_i/\Im(d_{B, i + 1}) \longrightarrow\overset{d_{B, i}}{\downarrow} & C_i/\Im(d_{C, i + 1}) \longrightarrow\overset{d_{C, i}}{\downarrow} & 0 \\ 0 \longrightarrow & \Ker(d_{A, i - 1}) \longrightarrow & \Ker(d_{B, i - 1}) \longrightarrow & \Ker(d_{C, i - 1}) & \end{array}
$$
\end{proof}
...
the diagrams
$$
\begin{array}{cc}A^i \underset{d^i}{\longrightarrow}\underset{f^i}{\downarrow} & A^{i + 1} \overset{f^{i + 1}}{\downarrow} \\ B^i \overset{d^i}{\longrightarrow} & B^{i + 1}\end{array}
$$
...
\begin{lemma}[Compose homotopy cochain]
\label{homology-lemma-compose-homotopy-cochain}
\source{stacks:0112}
\href{https://stacks.math.columbia.edu/tag/0112}{\texttt{Stacks tag 0112}}
\group{homology}
...
\begin{definition}[Homotopy equivalent cochain]
\label{homology-definition-homotopy-equivalent-cochain}
\source{stacks:0113}
\href{https://stacks.math.columbia.edu/tag/0113}{\texttt{Stacks tag 0113}}
\group{homology}
...
\begin{lemma}[Cat cochain abelian]
\label{homology-lemma-cat-cochain-abelian}
\source{stacks:0114}
\href{https://stacks.math.columbia.edu/tag/0114}{\texttt{Stacks tag 0114}}
\group{homology}
...
\begin{definition}[Quasi isomorphism cochain]
\label{homology-definition-quasi-isomorphism-cochain}
\source{stacks:0115}
\href{https://stacks.math.columbia.edu/tag/0115}{\texttt{Stacks tag 0115}}
\group{homology}
...
\begin{lemma}[Map cohomology homotopy cochain]
\label{homology-lemma-map-cohomology-homotopy-cochain}
\source{stacks:0116}
\href{https://stacks.math.columbia.edu/tag/0116}{\texttt{Stacks tag 0116}}
\group{homology}
...
\begin{lemma}[Short exact sequences of complexes give rise to long exact sequences of (co)homology.]
\label{homology-lemma-long-exact-sequence-cochain}
\source{stacks:0117}
\href{https://stacks.math.columbia.edu/tag/0117}{\texttt{Stacks tag 0117}}
\group{homology}


\uses{homology-definition-cohomology-shift}
...
$$
\begin{array}{ccc}\ldots & \ldots & \ldots \swarrow \\ H^i(A^\bullet) \longrightarrow & H^i(B^\bullet) \longrightarrow & H^i(C^\bullet) \swarrow \\ H^{i + 1}(A^\bullet) \longrightarrow & H^{i + 1}(B^\bullet) \longrightarrow & H^{i + 1}(C^\bullet) \swarrow \\ \ldots & \ldots & \ldots \\  &  & \end{array}
$$
...
Definition \ref{homology-definition-cohomology-shift}.
\end{lemma}

\begin{proof}
\uses{homology-lemma-snake, homology-lemma-snake-natural}
...
of the Snake Lemma \ref{homology-lemma-snake}
applied to the diagram
$$
\begin{array}{ccccc} & A^i/\Im(d_A^{i - 1}) \longrightarrow\overset{d_A^i}{\downarrow} & B^i/\Im(d_B^{i - 1}) \longrightarrow\overset{d_B^i}{\downarrow} & C^i/\Im(d_C^{i - 1}) \longrightarrow\overset{d_C^i}{\downarrow} & 0 \\ 0 \longrightarrow & \Ker(d_A^{i + 1}) \longrightarrow & \Ker(d_B^{i + 1}) \longrightarrow & \Ker(d_C^{i + 1}) & \end{array}
$$
...
the exactnesss in part (2) of Lemma \ref{homology-lemma-snake}.
The functoriality is Lemma \ref{homology-lemma-snake-natural}. Compatibility
...
\source{stacks:011A}
\href{https://stacks.math.columbia.edu/tag/011A}{\texttt{Stacks tag 011A}}
\group{homology}
...
\begin{lemma}[Homotopy shift]
\label{homology-lemma-homotopy-shift}
\source{stacks:011C}
\href{https://stacks.math.columbia.edu/tag/011C}{\texttt{Stacks tag 011C}}
\group{homology}
...
\begin{lemma}[Ses termwise split]
\label{homology-lemma-ses-termwise-split}
\source{stacks:011D}
\href{https://stacks.math.columbia.edu/tag/011D}{\texttt{Stacks tag 011D}}
\group{homology}

\uses{homology-lemma-ses-split}
Let $\mathcal{A}$ be an abelian category.
Let
$$
...
projections, see Lemma \ref{homology-lemma-ses-split}.
...
\begin{lemma}[Ses termwise split long]
\label{homology-lemma-ses-termwise-split-long}
\source{stacks:011E}
\href{https://stacks.math.columbia.edu/tag/011E}{\texttt{Stacks tag 011E}}
\group{homology}

\uses{homology-lemma-ses-termwise-split, homology-lemma-long-exact-sequence-chain}
Notation and assumptions as in Lemma \ref{homology-lemma-ses-termwise-split} above.
...
Lemma \ref{homology-lemma-long-exact-sequence-chain}.
\end{lemma}
...
\begin{lemma}[Ses termwise split homotopy]
\label{homology-lemma-ses-termwise-split-homotopy}
\source{stacks:011F}
\href{https://stacks.math.columbia.edu/tag/011F}{\texttt{Stacks tag 011F}}
\group{homology}

\uses{homology-lemma-ses-termwise-split}
Notation and assumptions as in Lemma \ref{homology-lemma-ses-termwise-split} above.
...
\begin{definition}[Shift cochain]
\label{homology-definition-shift-cochain}
\source{stacks:011G}
\href{https://stacks.math.columbia.edu/tag/011G}{\texttt{Stacks tag 011G}}
\group{homology}
...
\medskip\noindent
Recall that we view $\mathcal{A}$ as a full subcategory of
$\text{CoCh}(\mathcal{A})$, see Section \ref{homology-section-complexes}.
Thus for any object $A$ of $\mathcal{A}$ the notation $A[k]$
refers to the unique cochain complex zero in all degrees except having
$A$ in degree $-k$.

\begin{definition}[Cohomology shift]
\label{homology-definition-cohomology-shift}
\source{stacks:011H}
\href{https://stacks.math.columbia.edu/tag/011H}{\texttt{Stacks tag 011H}}
\group{homology}
...
\begin{lemma}[Homotopy shift cochain]
\label{homology-lemma-homotopy-shift-cochain}
\source{stacks:011I}
\href{https://stacks.math.columbia.edu/tag/011I}{\texttt{Stacks tag 011I}}
\group{homology}
...
\begin{lemma}[Ses termwise split cochain]
\label{homology-lemma-ses-termwise-split-cochain}
\source{stacks:011J}
\href{https://stacks.math.columbia.edu/tag/011J}{\texttt{Stacks tag 011J}}
\group{homology}
...
\begin{lemma}[Ses termwise split long cochain]
\label{homology-lemma-ses-termwise-split-long-cochain}
\source{stacks:011K}
\href{https://stacks.math.columbia.edu/tag/011K}{\texttt{Stacks tag 011K}}
\group{homology}

\uses{homology-lemma-ses-termwise-split-cochain, homology-lemma-long-exact-sequence-cochain}
Notation and assumptions as in
Lemma \ref{homology-lemma-ses-termwise-split-cochain} above.
...
\begin{lemma}[Ses termwise split homotopy cochain]
\label{homology-lemma-ses-termwise-split-homotopy-cochain}
\source{stacks:011L}
\href{https://stacks.math.columbia.edu/tag/011L}{\texttt{Stacks tag 011L}}
\group{homology}

\uses{homology-lemma-ses-termwise-split-cochain}
Notation and assumptions as in
Lemma \ref{homology-lemma-ses-termwise-split-cochain}.
...
$$
\begin{array}{cccccc}\sigma_{\leq n}A_\bullet \downarrow & \ldots \longrightarrow & 0 \longrightarrow\downarrow & A_n \longrightarrow\downarrow & A_{n - 1} \longrightarrow\downarrow & \ldots \\ A_\bullet & \ldots \longrightarrow & A_{n + 1} \longrightarrow & A_n \longrightarrow & A_{n - 1} \longrightarrow & \ldots\end{array}
$$
Note the property
...
$i < n$. In a picture
$$
\begin{array}{cccccc}A_\bullet \downarrow & \ldots \longrightarrow & A_{n + 1} \longrightarrow\downarrow & A_n \longrightarrow\downarrow & A_{n - 1} \longrightarrow\downarrow & \ldots \\ \sigma_{\geq n}A_\bullet & \ldots \longrightarrow & A_{n + 1} \longrightarrow & A_n \longrightarrow & 0 \longrightarrow & \ldots\end{array}
$$
...
$$
\begin{array}{cccccc}\tau_{\geq n}A_\bullet \downarrow & \ldots \longrightarrow & A_{n + 1} \longrightarrow\downarrow & \Ker(d_n) \longrightarrow\downarrow & 0 \longrightarrow\downarrow & \ldots \\ A_\bullet & \ldots \longrightarrow & A_{n + 1} \longrightarrow & A_n \longrightarrow & A_{n - 1} \longrightarrow & \ldots\end{array}
$$
...
is defined by the picture
$$
\begin{array}{cccccc}A_\bullet \downarrow & \ldots \longrightarrow & A_{n + 1} \longrightarrow\downarrow & A_n \longrightarrow\downarrow & A_{n - 1} \longrightarrow\downarrow & \ldots \\ \tau_{\leq n}A_\bullet & \ldots \longrightarrow & 0 \longrightarrow & \Coker(d_{n + 1}) \longrightarrow & A_{n - 1} \longrightarrow & \ldots\end{array}
$$
Note that these complexes have the property that
$$
...
$$
\begin{array}{cccccc}\sigma_{\geq n}A^\bullet \downarrow & \ldots \longrightarrow & 0 \longrightarrow\downarrow & A^n \longrightarrow\downarrow & A^{n + 1} \longrightarrow\downarrow & \ldots \\ A^\bullet & \ldots \longrightarrow & A^{n - 1} \longrightarrow & A^n \longrightarrow & A^{n + 1} \longrightarrow & \ldots\end{array}
$$
Note the property
...
$i \leq n$. In a picture
$$
\begin{array}{cccccc}A^\bullet \downarrow & \ldots \longrightarrow & A^{n - 1} \longrightarrow\downarrow & A^n \longrightarrow\downarrow & A^{n + 1} \longrightarrow\downarrow & \ldots \\ \sigma_{\leq n}A^\bullet & \ldots \longrightarrow & A^{n - 1} \longrightarrow & A^n \longrightarrow & 0 \longrightarrow & \ldots \\  &  &  &  &  & \end{array}
$$
The map of complexes
...
is defined by the picture
$$
\begin{array}{cccccc}\tau_{\leq n}A^\bullet \downarrow & \ldots \longrightarrow & A^{n - 1} \longrightarrow\downarrow & \Ker(d^n) \longrightarrow\downarrow & 0 \longrightarrow\downarrow & \ldots \\ A^\bullet & \ldots \longrightarrow & A^{n - 1} \longrightarrow & A^n \longrightarrow & A^{n + 1} \longrightarrow & \ldots\end{array}
$$
Note that these complexes have the property that
$$
...
is defined by the picture
$$
\begin{array}{cccccc}A^\bullet \downarrow & \ldots \longrightarrow & A^{n - 1} \longrightarrow\downarrow & A^n \longrightarrow\downarrow & A^{n + 1} \longrightarrow\downarrow & \ldots \\ \tau_{\geq n}A^\bullet & \ldots \longrightarrow & 0 \longrightarrow & \Coker(d^{n - 1}) \longrightarrow & A^{n + 1} \longrightarrow & \ldots\end{array}
$$
Note that these complexes have the property that
$$
...
\source{stacks:0125}
\href{https://stacks.math.columbia.edu/tag/0125}{\texttt{Stacks tag 0125}}
\group{homology}
...
\source{stacks:0126}
\href{https://stacks.math.columbia.edu/tag/0126}{\texttt{Stacks tag 0126}}
\group{homology}
...
\source{stacks:0AMH}
\href{https://stacks.math.columbia.edu/tag/0AMH}{\texttt{Stacks tag 0AMH}}
\group{homology}
...
\begin{definition}[Graded shift]
\label{homology-definition-graded-shift}
\source{stacks:09MG}
\href{https://stacks.math.columbia.edu/tag/09MG}{\texttt{Stacks tag 09MG}}
\group{homology}
...
\begin{definition}[Additive monoidal]
\label{homology-definition-additive-monoidal}
\source{stacks:0FNA}
\href{https://stacks.math.columbia.edu/tag/0FNA}{\texttt{Stacks tag 0FNA}}
\group{homology}
...
\begin{lemma}[Additive dual]
\label{homology-lemma-additive-dual}
\source{stacks:0FFT}
\href{https://stacks.math.columbia.edu/tag/0FFT}{\texttt{Stacks tag 0FFT}}
\group{homology}
...
\begin{lemma}[Karoubian dual]
\label{homology-lemma-Karoubian-dual}
\source{stacks:0FFU}
\href{https://stacks.math.columbia.edu/tag/0FFU}{\texttt{Stacks tag 0FFU}}
\group{homology}
...
sum decomposition of $Y$ (Section \ref{homology-section-karoubian})
...
\source{stacks:0FFX}
\href{https://stacks.math.columbia.edu/tag/0FFX}{\texttt{Stacks tag 0FFX}}
\group{homology}
...
\begin{lemma}[Left dual graded vector spaces]
\label{homology-lemma-left-dual-graded-vector-spaces}
\source{stacks:0FFV}
\href{https://stacks.math.columbia.edu/tag/0FFV}{\texttt{Stacks tag 0FFV}}
\group{homology}

\uses{homology-example-graded-vector-spaces}
Let $F$ be a field. Let $\mathcal{C}$ be the category of graded
$F$-vector spaces viewed as a monoidal category as in
Example \ref{homology-example-graded-vector-spaces}. If $V$ in $\mathcal{C}$
...
\source{stacks:012Y}
\href{https://stacks.math.columbia.edu/tag/012Y}{\texttt{Stacks tag 012Y}}
\group{homology}
...
$$
\begin{array}{cccc}\ldots & \ldots & \ldots & \ldots \\ \ldots \longrightarrow & A^{p, q + 1} \overset{d_1^{p, q + 1}}{\longrightarrow}\uparrow & A^{p + 1, q + 1} \longrightarrow\uparrow & \ldots \\ \ldots \longrightarrow & A^{p, q} \overset{d_1^{p, q}}{\longrightarrow}\overset{d_2^{p, q}}{\uparrow} & A^{p + 1, q} \longrightarrow\underset{d_2^{p + 1, q}}{\uparrow} & \ldots \\ \ldots & \ldots \uparrow & \ldots \uparrow & \ldots\end{array}
$$
any square commutes.
...
\begin{example}[Double complex as tensor product of]
\label{homology-example-double-complex-as-tensor-product-of}
\source{stacks:0A5J}
\href{https://stacks.math.columbia.edu/tag/0A5J}{\texttt{Stacks tag 0A5J}}
\group{homology}
...
\begin{definition}[Associated simple complex]
\label{homology-definition-associated-simple-complex}
\source{stacks:012Z}
\href{https://stacks.math.columbia.edu/tag/012Z}{\texttt{Stacks tag 012Z}}
\group{homology}
...
\begin{remark}[Triple complex]
\label{homology-remark-triple-complex}
\source{stacks:08BI}
\href{https://stacks.math.columbia.edu/tag/08BI}{\texttt{Stacks tag 08BI}}
\group{homology}
...
\begin{remark}[Shift double complex]
\label{homology-remark-shift-double-complex}
\source{stacks:0FLG}
\href{https://stacks.math.columbia.edu/tag/0FLG}{\texttt{Stacks tag 0FLG}}
\group{homology}
...
$$
\begin{array}{c}(\text{Tot}(A^{\bullet, \bullet})[a + b])^n =
\bigoplus_{p + q = n + a + b} A^{p, q}
\overset{\epsilon(p, q, a, b)\text{id}_{A^{p, q}}}{\downarrow} \\ \text{Tot}(A^{\bullet, \bullet}[a, b])^n =
\bigoplus_{p' + q' = n} A^{p' + a, q' + b}\end{array}
$$
...
\begin{remark}[Double complex complex of complexes first]
\label{homology-remark-double-complex-complex-of-complexes-first}
\source{stacks:0G6A}
\href{https://stacks.math.columbia.edu/tag/0G6A}{\texttt{Stacks tag 0G6A}}
\group{homology}

\uses{homology-remark-double-complex-complex-of-complexes-second, homology-remark-shift-double-complex, homology-lemma-homotopy-shift-cochain, homology-lemma-ses-termwise-split-cochain, homology-lemma-ses-termwise-split-homotopy-cochain}
...
Remark \ref{homology-remark-double-complex-complex-of-complexes-second}.
...
$[0, 1]$ defined in Remark \ref{homology-remark-shift-double-complex}.
By Remark \ref{homology-remark-shift-double-complex} the functor
$$
...
the identification of Lemma \ref{homology-lemma-homotopy-shift-cochain}.
...
Remark \ref{homology-remark-shift-double-complex}.
...
of this as in Lemma \ref{homology-lemma-ses-termwise-split-cochain}
...
$$
by the procedure in Lemma \ref{homology-lemma-ses-termwise-split-cochain}.
...
$$
well defined up to homotopy by Lemmas \ref{homology-lemma-ses-termwise-split-cochain}
and \ref{homology-lemma-ses-termwise-split-homotopy-cochain}. Claim:
...
Remark \ref{homology-remark-shift-double-complex}. To see this denote
...
\begin{remark}[Double complex complex of complexes second]
\label{homology-remark-double-complex-complex-of-complexes-second}
\source{stacks:0G6B}
\href{https://stacks.math.columbia.edu/tag/0G6B}{\texttt{Stacks tag 0G6B}}
\group{homology}

\uses{homology-remark-double-complex-complex-of-complexes-first, homology-remark-shift-double-complex, homology-lemma-homotopy-shift-cochain, homology-lemma-ses-termwise-split-cochain, homology-lemma-ses-termwise-split-homotopy-cochain}
Let $\mathcal{A}$ be an additive category with countable direct sums.
Let $\text{DoubleComp}(\mathcal{A})$ denote the category of double complexes.
We can consider an object $A^{\bullet, \bullet}$ of
$\text{DoubleComp}(\mathcal{A})$ as a complex of complexes
...
$$
For the variant where we switch the role of the indices, see
Remark \ref{homology-remark-double-complex-complex-of-complexes-first}.
In this remark we show that taking the associated total complex
is compatible with all the structures on complexes we have studied
in the chapter so far.
...
First, observe that the shift functor on double complexes viewed
as complexes of complexes in the manner given above is the functor
$[1, 0]$ defined in Remark \ref{homology-remark-shift-double-complex}.
By Remark \ref{homology-remark-shift-double-complex} the functor
$$
\text{Tot} : \text{DoubleComp}(\mathcal{A}) \to \text{Comp}(\mathcal{A})
$$
...
\source{stacks:0121}
\href{https://stacks.math.columbia.edu/tag/0121}{\texttt{Stacks tag 0121}}
\group{homology}
...
Lemma \ref{homology-lemma-filtered}
this is also equivalent to having zero kernel (resp.\ cokernel).

\begin{lemma}[Filtered]
\label{homology-lemma-filtered}
\source{stacks:0122}
\href{https://stacks.math.columbia.edu/tag/0122}{\texttt{Stacks tag 0122}}
\group{homology}
...
\begin{proof}
\uses{homology-example-not-abelian}
...
Example \ref{homology-example-not-abelian}
...
\source{stacks:0123}
\href{https://stacks.math.columbia.edu/tag/0123}{\texttt{Stacks tag 0123}}
\group{homology}
...
\begin{lemma}[Characterize strict general]
\label{homology-lemma-characterize-strict-general}
\source{stacks:05SI}
\href{https://stacks.math.columbia.edu/tag/05SI}{\texttt{Stacks tag 05SI}}
\group{homology}

\uses{homology-lemma-coim-im-map}
Let $\mathcal{A}$ be an abelian category.
...
Lemma \ref{homology-lemma-coim-im-map}
is an isomorphism.
\end{enumerate}
\end{lemma}

\begin{proof}
\uses{homology-lemma-filtered}
...
\begin{lemma}[Add summand strict monomorphism]
\label{homology-lemma-add-summand-strict-monomorphism}
\source{stacks:05SK}
\href{https://stacks.math.columbia.edu/tag/05SK}{\texttt{Stacks tag 05SK}}
\group{homology}
...
\begin{lemma}[Add summand strict epimorphism]
\label{homology-lemma-add-summand-strict-epimorphism}
\source{stacks:05SL}
\href{https://stacks.math.columbia.edu/tag/05SL}{\texttt{Stacks tag 05SL}}
\group{homology}
...
\begin{lemma}[Induced and quotient strict]
\label{homology-lemma-induced-and-quotient-strict}
\source{stacks:0124}
\href{https://stacks.math.columbia.edu/tag/0124}{\texttt{Stacks tag 0124}}
\group{homology}
...
\begin{lemma}[Composition strict]
\label{homology-lemma-composition-strict}
\source{stacks:05SJ}
\href{https://stacks.math.columbia.edu/tag/05SJ}{\texttt{Stacks tag 05SJ}}
\group{homology}
...
\begin{proof}
\uses{homology-lemma-induced-and-quotient-strict}
...
(Lemma \ref{homology-lemma-induced-and-quotient-strict}).
...
\begin{lemma}[Filtration subobject]
\label{homology-lemma-filtration-subobject}
\source{stacks:0129}
\href{https://stacks.math.columbia.edu/tag/0129}{\texttt{Stacks tag 0129}}
\group{homology}
...
\begin{lemma}[Pushout filtered]
\label{homology-lemma-pushout-filtered}
\source{stacks:05SM}
\href{https://stacks.math.columbia.edu/tag/05SM}{\texttt{Stacks tag 05SM}}
\group{homology}
...
$$
\begin{array}{cc}A \underset{f}{\longrightarrow}\underset{g}{\downarrow} & B \overset{g'}{\downarrow} \\ C \overset{f'}{\longrightarrow} & C \amalg_A B\end{array}
$$
in $\text{Fil}(\mathcal{A})$. If $f$ is strict, so is $f'$.
\end{lemma}

\begin{proof}
\uses{homology-lemma-filtered, homology-example-fibre-product-pushouts}

Set $C \amalg_A B$ equal to $\Coker((g, -f) : A \to C \oplus B)$
in $\text{Fil}(\mathcal{A})$. This cokernel exists, by
Lemma \ref{homology-lemma-filtered}.
It is a pushout, see
Example \ref{homology-example-fibre-product-pushouts}.
...
\begin{lemma}[Fibre product filtered]
\label{homology-lemma-fibre-product-filtered}
\source{stacks:05SN}
\href{https://stacks.math.columbia.edu/tag/05SN}{\texttt{Stacks tag 05SN}}
\group{homology}
...
$$
\begin{array}{cc}B \times_A C \underset{g'}{\longrightarrow}\underset{f'}{\downarrow} & B \overset{f}{\downarrow} \\ C \overset{g}{\longrightarrow} & A\end{array}
$$
in $\text{Fil}(\mathcal{A})$. If $f$ is strict, so is $f'$.
\end{lemma}

\begin{proof}
\uses{homology-lemma-pushout-filtered}

This lemma is dual to
Lemma \ref{homology-lemma-pushout-filtered}.
\end{proof}
...
of graded objects of $\mathcal{A}$ in Section \ref{homology-section-graded}.
...
\source{stacks:05SP}
\href{https://stacks.math.columbia.edu/tag/05SP}{\texttt{Stacks tag 05SP}}
\group{homology}
...
\begin{lemma}[Characterize strict]
\label{homology-lemma-characterize-strict}
\source{stacks:0127}
\href{https://stacks.math.columbia.edu/tag/0127}{\texttt{Stacks tag 0127}}
\group{homology}
...
\begin{proof}
\uses{homology-lemma-characterize-strict-general, homology-lemma-ses-gr}

The equivalence of (1) and (2) is
Lemma \ref{homology-lemma-characterize-strict-general}.
By
Lemma \ref{homology-lemma-ses-gr}
...
$$
\begin{array}{ccccc}0 \longrightarrow & F^{p + 1}A \longrightarrow\overset{f}{\downarrow} & F^pA \longrightarrow\overset{f}{\downarrow} & \text{gr}^p(A) \longrightarrow\overset{\text{gr}^p(f)}{\downarrow} & 0 \\ 0 \longrightarrow & F^{p + 1}B \longrightarrow & F^pB \longrightarrow & \text{gr}^p(B) \longrightarrow & 0\end{array}
$$
and the five lemma imply that $f(F^pA) = F^pB$.
\end{proof}

\begin{lemma}[Filtered complex]
\label{homology-lemma-filtered-complex}
\source{stacks:0128}
\href{https://stacks.math.columbia.edu/tag/0128}{\texttt{Stacks tag 0128}}
\group{homology}
...
\begin{proof}
\uses{homology-lemma-ses-gr, homology-lemma-characterize-strict-general}
...
\source{stacks:05QH}
\href{https://stacks.math.columbia.edu/tag/05QH}{\texttt{Stacks tag 05QH}}
\group{homology}
...
$$
\begin{array}{ccccc}0 \longrightarrow & F^nA \longrightarrow\downarrow & A \longrightarrow\downarrow & A' \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & F^nB \longrightarrow\downarrow & B \longrightarrow\downarrow & B' \longrightarrow\downarrow & 0 \\ 0 \longrightarrow & F^nC \longrightarrow & C \longrightarrow & C' \longrightarrow & 0\end{array}
$$
...
\source{stacks:011N}
\href{https://stacks.math.columbia.edu/tag/011N}{\texttt{Stacks tag 011N}}
\group{homology}
...
\begin{definition}[Limit spectral sequence]
\label{homology-definition-limit-spectral-sequence}
\source{stacks:011O}
\href{https://stacks.math.columbia.edu/tag/011O}{\texttt{Stacks tag 011O}}
\group{homology}
...
\source{stacks:0AMI}
\href{https://stacks.math.columbia.edu/tag/0AMI}{\texttt{Stacks tag 0AMI}}
\group{homology}
...
$$
\begin{array}{cccccc}\ldots \longrightarrow & T_r^{-1}E_r \overset{T_r^{-1}d_r}{\longrightarrow} & E_r \overset{d_r}{\longrightarrow} & T_rE_r \overset{T_r d_r}{\longrightarrow} & T_r^2E_r \longrightarrow & \ldots\end{array}
$$
...
\source{stacks:011Q}
\href{https://stacks.math.columbia.edu/tag/011Q}{\texttt{Stacks tag 011Q}}
\group{homology}
...
$$
\begin{array}{ccc}A \underset{\alpha}{\longrightarrow} &  & A \overset{g}{\swarrow} \\  & E \overset{f}{\nwarrow} & \end{array}
$$
...
\begin{lemma}[Derived exact couple]
\label{homology-lemma-derived-exact-couple}
\source{stacks:011R}
\href{https://stacks.math.columbia.edu/tag/011R}{\texttt{Stacks tag 011R}}
\group{homology}
...
\begin{definition}[Spectral sequence associated exact couple]
\label{homology-definition-spectral-sequence-associated-exact-couple}
\source{stacks:011S}
\href{https://stacks.math.columbia.edu/tag/011S}{\texttt{Stacks tag 011S}}
\group{homology}
...
\begin{lemma}[Spectral sequence associated exact couple]
\label{homology-lemma-spectral-sequence-associated-exact-couple}
\source{stacks:011T}
\href{https://stacks.math.columbia.edu/tag/011T}{\texttt{Stacks tag 011T}}
\group{homology}
...
Definition \ref{homology-definition-limit-spectral-sequence}.

\begin{remark}[Variant]

\label{homology-remark-shifted-exact-couple}
\source{stacks:0AMJ}
\href{https://stacks.math.columbia.edu/tag/0AMJ}{\texttt{Stacks tag 0AMJ}}
\group{homology}

\uses{homology-remark-allow-translation-functors, homology-lemma-spectral-sequence-associated-exact-couple}
Let $\mathcal{A}$ be an abelian category. Let
...
$$
\begin{array}{ccccc}TE \overset{Tf}{\longrightarrow} & TA \overset{T\alpha}{\longrightarrow} & A \overset{g}{\longrightarrow} & SE \overset{Sf}{\longrightarrow} & SA\end{array}
$$
is an exact complex. Let's visualize this as follows
$$
\begin{array}{ccccccc}TA \underset{T\alpha}{\longrightarrow} &  &  & A \overset{g}{\swarrow}\underset{\alpha}{\longrightarrow} &  &  & T^{-1}A \overset{T^{-1}g}{\swarrow} \\  & TE \overset{Tf}{\nwarrow}\longrightarrow & SE &  & E \overset{f}{\nwarrow}\longrightarrow & T^{-1}SE & \end{array}
$$
...
(as in Remark \ref{homology-remark-allow-translation-functors})
with $E_1 = E$, $E_2 = E'$, etc, with $d_r : E_r \to T^{r - 1}SE_r$
for all $r \geq 1$. Lemma \ref{homology-lemma-spectral-sequence-associated-exact-couple}
tells us that
$$
SB_{r + 1} =
...
\source{stacks:011V}
\href{https://stacks.math.columbia.edu/tag/011V}{\texttt{Stacks tag 011V}}
\group{homology}
...
\begin{lemma}[The category of differential objects of an abelian category is itself an abelian category.]
\label{homology-lemma-differential-objects-abelian}
\source{stacks:011W}
\href{https://stacks.math.columbia.edu/tag/011W}{\texttt{Stacks tag 011W}}
\group{homology}
...
\begin{definition}[Differential object homology]
\label{homology-definition-differential-object-homology}
\source{stacks:011X}
\href{https://stacks.math.columbia.edu/tag/011X}{\texttt{Stacks tag 011X}}
\group{homology}
...
\begin{lemma}[Differential objects ses]
\label{homology-lemma-differential-objects-ses}
\source{stacks:011Y}
\href{https://stacks.math.columbia.edu/tag/011Y}{\texttt{Stacks tag 011Y}}
\group{homology}
...
\begin{proof}
\uses{homology-lemma-long-exact-sequence-cochain}

Apply Lemma \ref{homology-lemma-long-exact-sequence-cochain}
...
$$
of differential objects. By
Lemma \ref{homology-lemma-differential-objects-ses} we get an exact couple
$$
\begin{array}{ccc}H(A, d) \underset{\overline{\alpha}}{\longrightarrow} &  & H(A, d) \overset{g}{\swarrow} \\  & H(A/\alpha A, d) \overset{f}{\nwarrow} & \end{array}
$$
where $g$ is the canonical map and $f$ is the map defined in the snake lemma.
By Section \ref{homology-section-exact-couple} we get an associated spectral sequence.
Since in this case we have $E_1 = H(A/\alpha A, d)$,
it makes sense to define $E_0 = A/\alpha A$ and $d_0 = d$.
In other words, we start the spectral sequence
with $r = 0$. According to our conventions in
Section \ref{homology-section-spectral-sequence} we define a sequence of subobjects
$$
0 = B_0 \subset \ldots \subset B_r \subset \ldots
\subset Z_r \subset \ldots \subset Z_0 = E_0
$$
with the property that $E_r = Z_r/B_r$. It follows from
Lemma \ref{homology-lemma-spectral-sequence-associated-exact-couple}
that for $r \geq 1$ we have
\begin{enumerate}
...
\begin{definition}[Differential object selfmap]
\label{homology-definition-differential-object-selfmap}
\source{stacks:011Z}
\href{https://stacks.math.columbia.edu/tag/011Z}{\texttt{Stacks tag 011Z}}
\group{homology}
...
\source{stacks:0AMK}
\href{https://stacks.math.columbia.edu/tag/0AMK}{\texttt{Stacks tag 0AMK}}
\group{homology}

\uses{homology-remark-shifted-exact-couple}
...
Remark \ref{homology-remark-shifted-exact-couple} with shift functors $TS$ and
$T$ given by
$$
...
\begin{definition}[Filtered differential]
\label{homology-definition-filtered-differential}
\source{stacks:012B}
\href{https://stacks.math.columbia.edu/tag/012B}{\texttt{Stacks tag 012B}}
\group{homology}
...
(this is not automatic, see Remark \ref{homology-remark-direct-sums-not-exact}).
...
Definition \ref{homology-definition-differential-object-selfmap}
...
Section \ref{homology-section-differential-object}) is equal to
...
\begin{lemma}[Spectral sequence filtered differential]
\label{homology-lemma-spectral-sequence-filtered-differential}
\source{stacks:012C}
\href{https://stacks.math.columbia.edu/tag/012C}{\texttt{Stacks tag 012C}}
\group{homology}
...
\begin{proof}
\uses{homology-remark-differential-object-selfmap}
...
Remark \ref{homology-remark-differential-object-selfmap}
...
in Remark \ref{homology-remark-differential-object-selfmap}
translates into a straightforward manner into the formulae
for $Z_r^p$ and $B_r^p$ given above.
\end{proof}

\begin{lemma}[Spectral sequence filtered differential d1]
\label{homology-lemma-spectral-sequence-filtered-differential-d1}
\source{stacks:012D}
\href{https://stacks.math.columbia.edu/tag/012D}{\texttt{Stacks tag 012D}}
\group{homology}
...
\begin{proof}
\uses{homology-lemma-spectral-sequence-filtered-differential}

This is clear from the formula for the differential $d_1^p$
given just above Lemma \ref{homology-lemma-spectral-sequence-filtered-differential}.
\end{proof}

\begin{definition}[Filtration cohomology filtered differential]
\label{homology-definition-filtration-cohomology-filtered-differential}
\source{stacks:012E}
\href{https://stacks.math.columbia.edu/tag/012E}{\texttt{Stacks tag 012E}}
\group{homology}
...
\begin{lemma}[Compute filtered cohomology]
\label{homology-lemma-compute-filtered-cohomology}
\source{stacks:012F}
\href{https://stacks.math.columbia.edu/tag/012F}{\texttt{Stacks tag 012F}}
\group{homology}
...
\begin{proof}
\uses{homology-definition-limit-spectral-sequence, homology-lemma-spectral-sequence-filtered-differential, homology-definition-filtration-cohomology-filtered-differential}
...
Lemma \ref{homology-lemma-spectral-sequence-filtered-differential}.
...
following
Definition \ref{homology-definition-filtration-cohomology-filtered-differential}
we conclude.
\end{proof}

\begin{definition}[Filtered differential ss converges]
\label{homology-definition-filtered-differential-ss-converges}
\source{stacks:012I}
\href{https://stacks.math.columbia.edu/tag/012I}{\texttt{Stacks tag 012I}}
\group{homology}

\uses{homology-lemma-compute-filtered-cohomology}
Let $\mathcal{A}$ be an abelian category.
Let $(K, F, d)$ be a filtered differential object of $\mathcal{A}$.
We say the spectral sequence associated to $(K, F, d)$
\begin{enumerate}
\item {\it weakly converges to $H(K)$} if $\text{gr}H(K) = E_{\infty}$
via Lemma \ref{homology-lemma-compute-filtered-cohomology},
...
\begin{lemma}[Filtered differential ss converges]
\label{homology-lemma-filtered-differential-ss-converges}
\source{stacks:012J}
\href{https://stacks.math.columbia.edu/tag/012J}{\texttt{Stacks tag 012J}}
\group{homology}
...
\source{stacks:012L}
\href{https://stacks.math.columbia.edu/tag/012L}{\texttt{Stacks tag 012L}}
\group{homology}
...
$\mathcal{A}$. Hence according to Section \ref{homology-section-filtered-differential}
...
in Section \ref{homology-section-filtered-differential} as graded objects and
...
\begin{lemma}[Spectral sequence filtered complex]
\label{homology-lemma-spectral-sequence-filtered-complex}
\source{stacks:012M}
\href{https://stacks.math.columbia.edu/tag/012M}{\texttt{Stacks tag 012M}}
\group{homology}
...
\begin{lemma}[Spectral sequence filtered complex d1]
\label{homology-lemma-spectral-sequence-filtered-complex-d1}
\source{stacks:012N}
\href{https://stacks.math.columbia.edu/tag/012N}{\texttt{Stacks tag 012N}}
\group{homology}
...
\begin{proof}
\uses{homology-lemma-spectral-sequence-filtered-complex}

This is clear from the formula given for the differential
$d_1^{p, q}$ just above Lemma \ref{homology-lemma-spectral-sequence-filtered-complex}.
\end{proof}

\begin{lemma}[Spectral sequence filtered complex functorial]
\label{homology-lemma-spectral-sequence-filtered-complex-functorial}
\source{stacks:012O}
\href{https://stacks.math.columbia.edu/tag/012O}{\texttt{Stacks tag 012O}}
\group{homology}
...
\begin{definition}[Filtration cohomology filtered complex]
\label{homology-definition-filtration-cohomology-filtered-complex}
\source{stacks:012P}
\href{https://stacks.math.columbia.edu/tag/012P}{\texttt{Stacks tag 012P}}
\group{homology}
...
\begin{lemma}[Compute cohomology filtered complex]
\label{homology-lemma-compute-cohomology-filtered-complex}
\source{stacks:012Q}
\href{https://stacks.math.columbia.edu/tag/012Q}{\texttt{Stacks tag 012Q}}
\group{homology}
...
\begin{proof}
\uses{homology-definition-limit-spectral-sequence, homology-lemma-spectral-sequence-filtered-complex}

The objects $Z_\infty$, $B_\infty$, and the limit
$E_\infty = Z_\infty/B_\infty$ of
Definition \ref{homology-definition-limit-spectral-sequence}
are bigraded objects of $\mathcal{A}$ by our construction of the
spectral sequence in Lemma \ref{homology-lemma-spectral-sequence-filtered-complex}.
...
\begin{definition}[Bounded ss]
\label{homology-definition-bounded-ss}
\source{stacks:0BDU}
\href{https://stacks.math.columbia.edu/tag/0BDU}{\texttt{Stacks tag 0BDU}}
\group{homology}
...
\begin{lemma}[Relate boundedness]
\label{homology-lemma-relate-boundedness}
\source{stacks:0BDV}
\href{https://stacks.math.columbia.edu/tag/0BDV}{\texttt{Stacks tag 0BDV}}
\group{homology}

\uses{homology-definition-bounded-ss}
In the situation of Definition \ref{homology-definition-bounded-ss}.
Let $Z_r^{p, q}, B_r^{p, q} \subset E_{r_0}^{p, q}$ be the
$(p, q)$-graded parts of $Z_r, B_r$ defined as in
Section \ref{homology-section-spectral-sequence}.
\begin{enumerate}
...
\begin{definition}[Filtered complex ss converges]
\label{homology-definition-filtered-complex-ss-converges}
\source{stacks:012U}
\href{https://stacks.math.columbia.edu/tag/012U}{\texttt{Stacks tag 012U}}
\group{homology}

\uses{homology-lemma-compute-cohomology-filtered-complex}
Let $\mathcal{A}$ be an abelian category. Let $(K^\bullet, F)$ be a
...
via Lemma \ref{homology-lemma-compute-cohomology-filtered-complex}
...
\begin{lemma}[Filtered complex ss converges]
\label{homology-lemma-filtered-complex-ss-converges}
\source{stacks:012V}
\href{https://stacks.math.columbia.edu/tag/012V}{\texttt{Stacks tag 012V}}
\group{homology}
...
\begin{lemma}[Biregular ss converges]
\label{homology-lemma-biregular-ss-converges}
\source{stacks:012W}
\href{https://stacks.math.columbia.edu/tag/012W}{\texttt{Stacks tag 012W}}
\group{homology}

\uses{homology-definition-filtered}
Let $\mathcal{A}$ be an abelian category. Let $(K^\bullet, F)$ be a
filtered complex of $\mathcal{A}$. Assume that the filtration on each $K^n$
is finite (see Definition \ref{homology-definition-filtered}). Then
\begin{enumerate}
...
\begin{proof}
\uses{homology-lemma-filtered-complex-ss-converges, homology-lemma-relate-boundedness, homology-lemma-characterize-weak-serre-subcategory}

Part (1) follows as $E_0^{p, n - p} = \text{gr}^p K^n$.
Part (2) is clear from Equation (\ref{equation-filtration-cohomology}).
We will use Lemma \ref{homology-lemma-filtered-complex-ss-converges} to prove
...
(Lemma \ref{homology-lemma-relate-boundedness}) and we have
...
is both regular and coregular, see Lemma \ref{homology-lemma-relate-boundedness})
...
by Lemma \ref{homology-lemma-characterize-weak-serre-subcategory}.
\end{proof}

\begin{lemma}[Biregular ss relation in K0]
\label{homology-lemma-biregular-ss-relation-in-K0}
\source{stacks:0BDW}
\href{https://stacks.math.columbia.edu/tag/0BDW}{\texttt{Stacks tag 0BDW}}
\group{homology}

\uses{homology-definition-filtered}
Let $\mathcal{A}$ be an abelian category. Let $(K^\bullet, F)$ be a
filtered complex of $\mathcal{A}$. Assume that the filtration on each $K^n$
is finite (see Definition \ref{homology-definition-filtered}) and that for some
...
\begin{proof}
\uses{homology-lemma-biregular-ss-converges}
...
(Lemma \ref{homology-lemma-biregular-ss-converges}) whose graded pieces
...
\begin{lemma}[Ss converges trivial]
\label{homology-lemma-ss-converges-trivial}
\source{stacks:0BK5}
\href{https://stacks.math.columbia.edu/tag/0BK5}{\texttt{Stacks tag 0BK5}}
\group{homology}
...
\begin{proof}
\uses{homology-definition-bounded-ss, homology-definition-filtration-cohomology-filtered-complex, homology-lemma-filtered-complex-ss-converges}
...
(Definition \ref{homology-definition-bounded-ss}). This proves (1).

\medskip\noindent
It is clear from the assumptions and
Definition \ref{homology-definition-filtration-cohomology-filtered-complex}
that the filtration on $H^n(K^\bullet)$ is finite. This proves (2).

\medskip\noindent
Next we prove that the spectral sequence weakly converges to
$H^*(K^\bullet)$ using
Lemma \ref{homology-lemma-filtered-complex-ss-converges}.
...
Lemma \ref{homology-lemma-filtered-complex-ss-converges} we have to show that
$\bigcap_p (\Ker(d) \cap F^pK^n + \Im(d) \cap K^n) = \Im(d) \cap K^n$
and
$\bigcup_p (\Ker(d) \cap F^pK^n + \Im(d) \cap K^n) = \Ker(d) \cap K^n$.
...
Section \ref{homology-section-double-complexes}. It is customary to denote
...
Definition \ref{homology-definition-associated-simple-complex}.
...
By Section \ref{homology-section-filtered-complex}
...
\begin{lemma}[Ss double complex]
\label{homology-lemma-ss-double-complex}
\source{stacks:0130}
\href{https://stacks.math.columbia.edu/tag/0130}{\texttt{Stacks tag 0130}}
\group{homology}
...
\begin{definition}[Ss double complex converge]
\label{homology-definition-ss-double-complex-converge}
\source{stacks:0131}
\href{https://stacks.math.columbia.edu/tag/0131}{\texttt{Stacks tag 0131}}
\group{homology}

\uses{homology-definition-filtered-complex-ss-converges}
Let $\mathcal{A}$ be an abelian category.
Let $K^{\bullet, \bullet}$ be a double complex.
...
if Definition \ref{homology-definition-filtered-complex-ss-converges} applies.
...
Lemma \ref{homology-lemma-compute-cohomology-filtered-complex}.
...
\begin{lemma}[First quadrant ss]
\label{homology-lemma-first-quadrant-ss}
\source{stacks:0132}
\href{https://stacks.math.columbia.edu/tag/0132}{\texttt{Stacks tag 0132}}
\group{homology}
...
Follows immediately from Lemma \ref{homology-lemma-biregular-ss-converges}.
\end{proof}

Here is our first application of spectral sequences.

\begin{lemma}[Double complex gives resolution]
\label{homology-lemma-double-complex-gives-resolution}
\source{stacks:0133}
\href{https://stacks.math.columbia.edu/tag/0133}{\texttt{Stacks tag 0133}}
\group{homology}
...
\begin{proof}
\uses{homology-lemma-first-quadrant-ss, homology-lemma-ss-double-complex}
...
By Lemma \ref{homology-lemma-first-quadrant-ss} this spectral sequence converges
and the induced filtration on $H^n(\text{Tot}(A^{\bullet, \bullet}))$
is finite for each $n$.
By Lemma \ref{homology-lemma-ss-double-complex} and assumption (4) we have
...
\begin{lemma}[Homotopy complex complexes]
\label{homology-lemma-homotopy-complex-complexes}
\source{stacks:0FKH}
\href{https://stacks.math.columbia.edu/tag/0FKH}{\texttt{Stacks tag 0FKH}}
\group{homology}
...
\begin{lemma}[Right resolution gives qis]
\label{homology-lemma-right-resolution-gives-qis}
\source{stacks:0E1Q}
\href{https://stacks.math.columbia.edu/tag/0E1Q}{\texttt{Stacks tag 0E1Q}}
\group{homology}
...
\begin{proof}
\uses{homology-lemma-double-complex-gives-resolution}
...
\begin{lemma}[Good resolution gives qis]
\label{homology-lemma-good-resolution-gives-qis}
\source{stacks:09IZ}
\href{https://stacks.math.columbia.edu/tag/09IZ}{\texttt{Stacks tag 09IZ}}
\group{homology}
...
\begin{lemma}[Good right resolution gives qis]
\label{homology-lemma-good-right-resolution-gives-qis}
\source{stacks:09J0}
\href{https://stacks.math.columbia.edu/tag/09J0}{\texttt{Stacks tag 09J0}}
\group{homology}
...
\begin{proof}
\uses{homology-lemma-good-resolution-gives-qis}
...
Lemma \ref{homology-lemma-good-resolution-gives-qis}
...
\begin{lemma}[Resolution gives qis]
\label{homology-lemma-resolution-gives-qis}
\source{stacks:0E1R}
\href{https://stacks.math.columbia.edu/tag/0E1R}{\texttt{Stacks tag 0E1R}}
\group{homology}
...
\source{stacks:0135}
\href{https://stacks.math.columbia.edu/tag/0135}{\texttt{Stacks tag 0135}}
\group{homology}
...
$$
\begin{array}{cc}A \longrightarrow\downarrow & B \swarrow \\ J & \end{array}
$$
\end{definition}
...
\source{stacks:0136}
\href{https://stacks.math.columbia.edu/tag/0136}{\texttt{Stacks tag 0136}}
\group{homology}
...
\source{stacks:0137}
\href{https://stacks.math.columbia.edu/tag/0137}{\texttt{Stacks tag 0137}}
\group{homology}
...
\source{stacks:0138}
\href{https://stacks.math.columbia.edu/tag/0138}{\texttt{Stacks tag 0138}}
\group{homology}
...
\begin{definition}[Functorial injective embedding]
\label{homology-definition-functorial-injective-embedding}
\source{stacks:0139}
\href{https://stacks.math.columbia.edu/tag/0139}{\texttt{Stacks tag 0139}}
\group{homology}
...
\source{stacks:013B}
\href{https://stacks.math.columbia.edu/tag/013B}{\texttt{Stacks tag 013B}}
\group{homology}
...
the following diagram commute
$$
\begin{array}{cc}A \longrightarrow & B \\ P \uparrow\nearrow & \end{array}
$$
\end{definition}

Here is the obligatory characterization of projective objects.

\begin{lemma}[Characterize projectives]
\label{homology-lemma-characterize-projectives}
\source{stacks:013C}
\href{https://stacks.math.columbia.edu/tag/013C}{\texttt{Stacks tag 013C}}
\group{homology}
...
\begin{lemma}[Coproduct projectives]
\label{homology-lemma-coproduct-projectives}
\source{stacks:013D}
\href{https://stacks.math.columbia.edu/tag/013D}{\texttt{Stacks tag 013D}}
\group{homology}
...
\source{stacks:013E}
\href{https://stacks.math.columbia.edu/tag/013E}{\texttt{Stacks tag 013E}}
\group{homology}
...
\begin{definition}[Functorial projective surjections]
\label{homology-definition-functorial-projective-surjections}
\source{stacks:013F}
\href{https://stacks.math.columbia.edu/tag/013F}{\texttt{Stacks tag 013F}}
\group{homology}
...
injectives. See also Lemma \ref{homology-lemma-adjoint-get-abelian}.

\begin{lemma}[A functor with an exact left adjoint preserves injectives]
\label{homology-lemma-adjoint-preserve-injectives}
\source{stacks:015Z}
\href{https://stacks.math.columbia.edu/tag/015Z}{\texttt{Stacks tag 015Z}}
\group{homology}
...
\begin{remark}[Need left exactness]
\label{homology-remark-need-left-exactness}
\source{stacks:03B8}
\href{https://stacks.math.columbia.edu/tag/03B8}{\texttt{Stacks tag 03B8}}
\group{homology}

\uses{homology-lemma-adjoint-preserve-injectives}
...
Lemma \ref{homology-lemma-adjoint-preserve-injectives} do not hold in general.
...
\begin{lemma}[Adjoint enough injectives]
\label{homology-lemma-adjoint-enough-injectives}
\source{stacks:0160}
\href{https://stacks.math.columbia.edu/tag/0160}{\texttt{Stacks tag 0160}}
\group{homology}
...
According to Lemma \ref{homology-lemma-adjoint-preserve-injectives}
and the assumptions the corresponding map
$B \to uI$ is the injection of $B$ into an injective object.
\end{proof}

\begin{remark}[Faithfulness needed]
\label{homology-remark-faithfulness-needed}
\source{stacks:03B9}
\href{https://stacks.math.columbia.edu/tag/03B9}{\texttt{Stacks tag 03B9}}
\group{homology}

\uses{homology-lemma-adjoint-enough-injectives}
Let $\mathcal{A}$, $\mathcal{B}$, $u : \mathcal{A} \to \mathcal{B}$ and
$v : \mathcal{B} \to \mathcal{A}$ be as
In Lemma \ref{homology-lemma-adjoint-enough-injectives}.
...
\begin{lemma}[Adjoint functorial injectives]
\label{homology-lemma-adjoint-functorial-injectives}
\source{stacks:0161}
\href{https://stacks.math.columbia.edu/tag/0161}{\texttt{Stacks tag 0161}}
\group{homology}
...
proof of Lemma \ref{homology-lemma-adjoint-enough-injectives}.
\end{proof}

\begin{lemma}[Partially defined adjoint]
\label{homology-lemma-partially-defined-adjoint}
\source{stacks:0793}
\href{https://stacks.math.columbia.edu/tag/0793}{\texttt{Stacks tag 0793}}
\group{homology}
...
\begin{lemma}[Essentially constant into karoubian]
\label{homology-lemma-essentially-constant-into-karoubian}
\source{stacks:0A2E}
\href{https://stacks.math.columbia.edu/tag/0A2E}{\texttt{Stacks tag 0A2E}}
\group{homology}
...
\begin{lemma}[Direct sum from product colimit]
\label{homology-lemma-direct-sum-from-product-colimit}
\source{stacks:0A2F}
\href{https://stacks.math.columbia.edu/tag/0A2F}{\texttt{Stacks tag 0A2F}}
\group{homology}
...
sum decomposition $W = X \oplus Y$, see Lemma \ref{homology-lemma-karoubian}.
...
\begin{lemma}[Direct sum from product essentially constant]
\label{homology-lemma-direct-sum-from-product-essentially-constant}
\source{stacks:0A2G}
\href{https://stacks.math.columbia.edu/tag/0A2G}{\texttt{Stacks tag 0A2G}}
\group{homology}
...
\begin{proof}
\uses{homology-lemma-direct-sum-from-product-colimit}

Assume (1) holds. In particular $W = \colim_\mathcal{I} F \oplus G$ exists
and hence by Lemma \ref{homology-lemma-direct-sum-from-product-colimit}
...
\source{stacks:02MZ}
\href{https://stacks.math.columbia.edu/tag/02MZ}{\texttt{Stacks tag 02MZ}}
\group{homology}
...
\begin{definition}[Mittag Leffler]
\label{homology-definition-Mittag-Leffler}
\source{stacks:02N0}
\href{https://stacks.math.columbia.edu/tag/02N0}{\texttt{Stacks tag 02N0}}
\group{homology}
...
\source{stacks:02N1}
\href{https://stacks.math.columbia.edu/tag/02N1}{\texttt{Stacks tag 02N1}}
\group{homology}
...
\begin{lemma}[Apply Mittag Leffler]
\label{homology-lemma-apply-Mittag-Leffler}
\source{stacks:070B}
\href{https://stacks.math.columbia.edu/tag/070B}{\texttt{Stacks tag 070B}}
\group{homology}
...
\begin{proof}
\uses{homology-lemma-Mittag-Leffler}
...
$$
Moreover, by
Lemma \ref{homology-lemma-Mittag-Leffler}
...
\source{stacks:070C}
\href{https://stacks.math.columbia.edu/tag/070C}{\texttt{Stacks tag 070C}}
\group{homology}
...
\begin{lemma}[Exact sequence ML]
\label{homology-lemma-exact-sequence-ML}
\source{stacks:070D}
\href{https://stacks.math.columbia.edu/tag/070D}{\texttt{Stacks tag 070D}}
\group{homology}
...
\begin{proof}
\uses{homology-lemma-essentially-constant}
...
$Z_{i'} \to Z_i$ is zero, see Lemma \ref{homology-lemma-essentially-constant}.
...
\begin{lemma}[Apply Mittag Leffler again]
\label{homology-lemma-apply-Mittag-Leffler-again}
\source{stacks:070E}
\href{https://stacks.math.columbia.edu/tag/070E}{\texttt{Stacks tag 070E}}
\group{homology}
...
\begin{proof}
\uses{homology-lemma-Mittag-Leffler, homology-lemma-exact-sequence-ML}
...
Lemma \ref{homology-lemma-exact-sequence-ML}.
The exact sequence
$$
...
\begin{lemma}[ML over ordinals]
\label{homology-lemma-ML-over-ordinals}
\source{stacks:0AAT}
\href{https://stacks.math.columbia.edu/tag/0AAT}{\texttt{Stacks tag 0AAT}}
\group{homology}
...
\begin{lemma}[Product abelian groups exact]
\label{homology-lemma-product-abelian-groups-exact}
\source{stacks:060K}
\href{https://stacks.math.columbia.edu/tag/060K}{\texttt{Stacks tag 060K}}
\group{homology}
