...
\begin{lemma}[Quasi coherent strongly cartesian]
\label{examples-stacks-lemma-quasi-coherent-strongly-cartesian}
\source{stacks:04U3}
\href{https://stacks.math.columbia.edu/tag/04U3}{\texttt{Stacks tag 04U3}}
\group{examples-stacks}
...
\begin{lemma}[Stack of quasi coherent sheaves]
\label{examples-stacks-lemma-stack-of-quasi-coherent-sheaves}
\source{stacks:03YM}
\href{https://stacks.math.columbia.edu/tag/03YM}{\texttt{Stacks tag 03YM}}
\group{examples-stacks}
...
\begin{proof}
It is clear from
Lemma \ref{examples-stacks-lemma-quasi-coherent-strongly-cartesian}
...
\begin{lemma}[Stack of finite type quasi coherent sheaves]
\label{examples-stacks-lemma-stack-of-finite-type-quasi-coherent-sheaves}
\source{stacks:04U4}
\href{https://stacks.math.columbia.edu/tag/04U4}{\texttt{Stacks tag 04U4}}
\group{examples-stacks}
...
\source{stacks:04U5}
\href{https://stacks.math.columbia.edu/tag/04U5}{\texttt{Stacks tag 04U5}}
\group{examples-stacks}
...
\begin{lemma}[Stack fg quasi coherent]
\label{examples-stacks-lemma-stack-fg-quasi-coherent}
\source{stacks:04U6}
\href{https://stacks.math.columbia.edu/tag/04U6}{\texttt{Stacks tag 04U6}}
\group{examples-stacks}
...
\begin{proof}
We have seen in
Lemmas \ref{examples-stacks-lemma-stack-of-finite-type-quasi-coherent-sheaves} and
...
\source{stacks:04U7}
\href{https://stacks.math.columbia.edu/tag/04U7}{\texttt{Stacks tag 04U7}}
\group{examples-stacks}
...
$$
\begin{array}{cc}Y \downarrow\underset{b}{\longrightarrow} & Y' \downarrow \\ X \underset{a}{\longrightarrow} & X'\end{array}
$$
...
\begin{lemma}[Finite etale stack]
\label{examples-stacks-lemma-finite-etale-stack}
\source{stacks:0BLZ}
\href{https://stacks.math.columbia.edu/tag/0BLZ}{\texttt{Stacks tag 0BLZ}}
\group{examples-stacks}
...
is a commutative diagram
$$
\begin{array}{cc}X \downarrow\underset{f}{\longrightarrow} & Y \downarrow \\ U \overset{g}{\longrightarrow} & V\end{array}
$$
...
\begin{lemma}[Spaces strongly cartesian]
\label{examples-stacks-lemma-spaces-strongly-cartesian}
\source{stacks:04U9}
\href{https://stacks.math.columbia.edu/tag/04U9}{\texttt{Stacks tag 04U9}}
\group{examples-stacks}
...
\begin{lemma}[Pre stack of spaces]
\label{examples-stacks-lemma-pre-stack-of-spaces}
\source{stacks:04UA}
\href{https://stacks.math.columbia.edu/tag/04UA}{\texttt{Stacks tag 04UA}}
\group{examples-stacks}
...
\begin{proof}
It is follows from
Lemma \ref{examples-stacks-lemma-spaces-strongly-cartesian}
...
\begin{remark}[Stack spaces]
\label{examples-stacks-remark-stack-spaces}
\source{stacks:04UB}
\href{https://stacks.math.columbia.edu/tag/04UB}{\texttt{Stacks tag 04UB}}
\group{examples-stacks}
...
\begin{lemma}[Stack of finite type spaces]
\label{examples-stacks-lemma-stack-of-finite-type-spaces}
\source{stacks:04UD}
\href{https://stacks.math.columbia.edu/tag/04UD}{\texttt{Stacks tag 04UD}}
\group{examples-stacks}
...
Lemma \ref{examples-stacks-lemma-pre-stack-of-spaces}
...
\begin{lemma}[Stack ft spaces]
\label{examples-stacks-lemma-stack-ft-spaces}
\source{stacks:04UE}
\href{https://stacks.math.columbia.edu/tag/04UE}{\texttt{Stacks tag 04UE}}
\group{examples-stacks}
...
\begin{proof}
We have seen in
Lemmas \ref{examples-stacks-lemma-stack-of-finite-type-spaces}
...
\begin{remark}[Higher cardinality spaces]
\label{examples-stacks-remark-higher-cardinality-spaces}
\source{stacks:04UF}
\href{https://stacks.math.columbia.edu/tag/04UF}{\texttt{Stacks tag 04UF}}
\group{examples-stacks}
...
\begin{lemma}[Torsors sheaf stack in groupoids]
\label{examples-stacks-lemma-torsors-sheaf-stack-in-groupoids}
\source{stacks:04UK}
\href{https://stacks.math.columbia.edu/tag/04UK}{\texttt{Stacks tag 04UK}}
\group{examples-stacks}
...
The construction of
Subsection \ref{examples-stacks-subsection-torsors-sheaf}
...
\begin{lemma}[Variant torsors sheaf stack in groupoids]
\label{examples-stacks-lemma-variant-torsors-sheaf-stack-in-groupoids}
\source{stacks:04UM}
\href{https://stacks.math.columbia.edu/tag/04UM}{\texttt{Stacks tag 04UM}}
\group{examples-stacks}
...
Lemma \ref{examples-stacks-lemma-torsors-sheaf-stack-in-groupoids}.
...
diagrams
$$
\begin{array}{cc}X \downarrow\underset{g}{\longrightarrow} & X' \downarrow \\ U \overset{f}{\longrightarrow} & U'\end{array}
$$
where $g$ is $G$-equivariant.

\begin{remark}[Principal stack in groupoids]
\label{examples-stacks-remark-principal-stack-in-groupoids}
\source{stacks:04UP}
\href{https://stacks.math.columbia.edu/tag/04UP}{\texttt{Stacks tag 04UP}}
\group{examples-stacks}
...
\begin{lemma}[Torsors stack in groupoids]
\label{examples-stacks-lemma-torsors-stack-in-groupoids}
\source{stacks:04US}
\href{https://stacks.math.columbia.edu/tag/04US}{\texttt{Stacks tag 04US}}
\group{examples-stacks}
...
\begin{lemma}[Compare torsors]
\label{examples-stacks-lemma-compare-torsors}
\source{stacks:04UT}
\href{https://stacks.math.columbia.edu/tag/04UT}{\texttt{Stacks tag 04UT}}
\group{examples-stacks}
...
\begin{definition}[Situation: Quotient stack]
\label{examples-stacks-situation-quotient-stack}
\source{stacks:04WL}
\href{https://stacks.math.columbia.edu/tag/04WL}{\texttt{Stacks tag 04WL}}
\group{examples-stacks}
...
$$
\begin{array}{cc}P \downarrow\underset{\varphi}{\longrightarrow} & X \downarrow \\ U \overset{b}{\longrightarrow} & B\end{array}
$$
\end{enumerate}
...
diagram
$$
\begin{array}{cccc}P \downarrow\underset{\varphi}{\searrow}\overset{g}{\longrightarrow} & P' \downarrow\overset{\varphi'}{\searrow} &  &  \\ U \underset{b}{\searrow}\overset{f}{\longrightarrow} & U' \overset{b'}{\searrow} &  & X \downarrow \\  &  &  & B\end{array}
$$
\end{enumerate}
...
\begin{lemma}[Group quotient stack in groupoids]
\label{examples-stacks-lemma-group-quotient-stack-in-groupoids}
\source{stacks:0370}
\href{https://stacks.math.columbia.edu/tag/0370}{\texttt{Stacks tag 0370}}
\group{examples-stacks}
...
(Lemma \ref{examples-stacks-lemma-torsors-stack-in-groupoids}).
...
\begin{proposition}[Equal quotient stacks]
\label{examples-stacks-proposition-equal-quotient-stacks}
\source{stacks:04WM}
\href{https://stacks.math.columbia.edu/tag/04WM}{\texttt{Stacks tag 04WM}}
\group{examples-stacks}
...
$$
\begin{array}{ccc}G \times_{B, \pi \circ x} U \downarrow\underset{\text{id}_G \times x}{\longrightarrow} & G \times_{B, \pi} X \underset{a}{\longrightarrow} & X \overset{\pi}{\downarrow} \\ U \overset{\pi \circ x}{\longrightarrow} &  & B\end{array}
$$
...
$$
\begin{array}{cc}G \times_{B, \pi \circ x} U \downarrow\underset{R_{g^{-1}}}{\longrightarrow} & G \times_{B, \pi \circ x'} U' \downarrow \\ U \overset{f}{\longrightarrow} & U'\end{array}
$$
...
\begin{lemma}[The classifying stack of a group scheme or group algebraic space.]
\label{examples-stacks-lemma-classifying-stacks}
\source{stacks:0CQJ}
\href{https://stacks.math.columbia.edu/tag/0CQJ}{\texttt{Stacks tag 0CQJ}}
\group{examples-stacks}
...
is given in Lemma \ref{examples-stacks-lemma-compare-torsors}.
...
\begin{remark}[X mod G group]
\label{examples-stacks-remark-X-mod-G-group}
\source{stacks:0371}
\href{https://stacks.math.columbia.edu/tag/0371}{\texttt{Stacks tag 0371}}
\group{examples-stacks}
...
\begin{lemma}[Picard stack]
\label{examples-stacks-lemma-picard-stack}
\source{stacks:04WN}
\href{https://stacks.math.columbia.edu/tag/04WN}{\texttt{Stacks tag 04WN}}
\group{examples-stacks}
...
\begin{example}[Inertia stack of X mod G]
\label{examples-stacks-example-inertia-stack-of-X-mod-G}
\source{stacks:0374}
\href{https://stacks.math.columbia.edu/tag/0374}{\texttt{Stacks tag 0374}}
\group{examples-stacks}
...
Remark \ref{examples-stacks-remark-X-mod-G-group})
is given by
$$
...
$\phi : P \to X$, together
with an automorphism $\alpha$ of $P$ over $T$ such that
$\phi \circ \alpha = \phi$.
...
\begin{example}[Inertia stack of picard]
\label{examples-stacks-example-inertia-stack-of-picard}
\source{stacks:0375}
\href{https://stacks.math.columbia.edu/tag/0375}{\texttt{Stacks tag 0375}}
\group{examples-stacks}
...
$$
\begin{array}{cc}(\Sch/Z)_{fppf} \underset{x}{\longrightarrow}\downarrow & \mathcal{X} \overset{F}{\downarrow} \\ (\Sch/U)_{fppf} \overset{y}{\longrightarrow} & \mathcal{Y}\end{array}
$$
of stacks in groupoids over $(\Sch/S)_{fppf}$.
Alternatively, we may picture $\alpha$ as a $2$-morphism
$$
\begin{array}{ccc}(\Sch/Z)_{fppf}
\rrtwocell^{y \circ (Z \to U)}_{F \circ x}{\alpha} &  & \mathcal{Y}.\end{array}
$$
}.
...
diagram
$$
\begin{array}{ccc}y|_Z \underset{\alpha}{\longrightarrow}\underset{b|_Z}{\downarrow} &  & F(x) \overset{F(a)}{\downarrow} \\ f^*y'|_Z \overset{\alpha'}{\longrightarrow} &  & F(g^*x') \\  &  & \end{array}
$$
\end{enumerate}
...
\begin{lemma}[Hilbert d stack]
\label{examples-stacks-lemma-hilbert-d-stack}
\source{stacks:05WB}
\href{https://stacks.math.columbia.edu/tag/05WB}{\texttt{Stacks tag 05WB}}
\group{examples-stacks}
...
\begin{definition}[Hilbert d stack]
\label{examples-stacks-definition-hilbert-d-stack}
\source{stacks:05WC}
\href{https://stacks.math.columbia.edu/tag/05WC}{\texttt{Stacks tag 05WC}}
\group{examples-stacks}
...
\vcenter{
\begin{array}{ccc}\mathcal{H}_d(\mathcal{X}) \searrow & \mathcal{H}_d(\mathcal{X}/\mathcal{Y}) \downarrow\longleftarrow\longrightarrow & \mathcal{Y} \\  & \mathcal{H}_d & \end{array}
}
\end{equation}
Each of the arrows is given by a "forgetful functor".

\begin{lemma}[Faithful hilbert]
\label{examples-stacks-lemma-faithful-hilbert}
\source{stacks:05XV}
\href{https://stacks.math.columbia.edu/tag/05XV}{\texttt{Stacks tag 05XV}}
\group{examples-stacks}
...
$$
\begin{array}{ccc}y|_Z \underset{\alpha}{\longrightarrow}\underset{b|_Z, \ b'|_Z}{\downarrow} &  & F(x) \overset{F(a) = F(a')}{\downarrow} \\ y'|_Z \overset{\alpha'}{\longrightarrow} &  & F(g^*x') = F((g')^*x') \\  &  & \end{array}
$$
