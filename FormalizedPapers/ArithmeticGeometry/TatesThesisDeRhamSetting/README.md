...
`FormalizedPapers/ArithmeticGeometry/TatesThesisDeRhamSetting`.
...
- Source bundle: [`references/tates-thesis-de-rham-setting/`](../../../references/tates-thesis-de-rham-setting/)
