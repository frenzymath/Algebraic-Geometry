...
groupoids; we introduce them in Section \ref{formal-defos-section-preliminary}.
...
\medskip\noindent
In
Section \ref{formal-defos-section-schlessinger-conditions},
...
(S1), (S2) and (H3), see
Lemma \ref{formal-defos-lemma-versal-object-existence}.
...
\medskip\noindent
In Section \ref{formal-defos-section-RS-condition},
...
Definitions \ref{formal-defos-definition-groupoid-in-functors},
\ref{formal-defos-definition-prorepresentable-groupoid-in-functors}, and
...
Theorem \ref{formal-defos-theorem-presentation-deformation-groupoid}
...
There is a final
Section \ref{formal-defos-section-minimality}
...
(Lemma \ref{formal-defos-lemma-RS-associated-functor}).
...
\begin{definition}[CLambda]
\label{formal-defos-definition-CLambda}
\source{stacks:06GC}
\href{https://stacks.math.columbia.edu/tag/06GC}{\texttt{Stacks tag 06GC}}
\group{formal-defos}
...
\source{stacks:06GD}
\href{https://stacks.math.columbia.edu/tag/06GD}{\texttt{Stacks tag 06GD}}
\group{formal-defos}
...
\begin{lemma}[Factor small extension]
\label{formal-defos-lemma-factor-small-extension}
\source{stacks:06GE}
\href{https://stacks.math.columbia.edu/tag/06GE}{\texttt{Stacks tag 06GE}}
\group{formal-defos}
...
\source{stacks:06GG}
\href{https://stacks.math.columbia.edu/tag/06GG}{\texttt{Stacks tag 06GG}}
\group{formal-defos}
...
\source{stacks:06S3}
\href{https://stacks.math.columbia.edu/tag/06S3}{\texttt{Stacks tag 06S3}}
\group{formal-defos}
...
$$
\begin{array}{cccc}\mathfrak m_\Lambda/\mathfrak m_\Lambda^2 \otimes_{k'} k \longrightarrow\downarrow & \mathfrak m_A/\mathfrak m_A^2 \longrightarrow\downarrow & \mathfrak m_A/(\mathfrak m_\Lambda A + \mathfrak m_A^2) \longrightarrow\downarrow & 0 \\ \mathfrak m_\Lambda/\mathfrak m_\Lambda^2 \otimes_{k'} k \longrightarrow & \mathfrak m_B/\mathfrak m_B^2 \longrightarrow & \mathfrak m_B/(\mathfrak m_\Lambda B + \mathfrak m_B^2) \longrightarrow & 0\end{array}
$$
...
\begin{definition}[Tangent space ring]
\label{formal-defos-definition-tangent-space-ring}
\source{stacks:06GY}
\href{https://stacks.math.columbia.edu/tag/06GY}{\texttt{Stacks tag 06GY}}
\group{formal-defos}
...
\begin{example}[Fibre product]
\label{formal-defos-example-fibre-product}
\source{stacks:06S4}
\href{https://stacks.math.columbia.edu/tag/06S4}{\texttt{Stacks tag 06S4}}
\group{formal-defos}
...
\begin{lemma}[Fiber product CLambda]
\label{formal-defos-lemma-fiber-product-CLambda}
\source{stacks:06GH}
\href{https://stacks.math.columbia.edu/tag/06GH}{\texttt{Stacks tag 06GH}}
\group{formal-defos}
...
over itself, see
Algebra, Lemma \ref{algebra-lemma-artinian-finite-length}.
Since $A_1$ and $A_2$ are Artinian, Lemma \ref{formal-defos-lemma-length} implies
...
essential is given in Lemma \ref{formal-defos-lemma-essential-surjection}.

\begin{definition}[Essential surjection]
\label{formal-defos-definition-essential-surjection}
\source{stacks:06GF}
\href{https://stacks.math.columbia.edu/tag/06GF}{\texttt{Stacks tag 06GF}}
\group{formal-defos}
...
Using Lemma \ref{formal-defos-lemma-surjective}, we can characterize
essential surjections in $\mathcal{C}_\Lambda$ as follows.

\begin{lemma}[Essential surjection mod squares]
\label{formal-defos-lemma-essential-surjection-mod-squares}
\source{stacks:06S5}
\href{https://stacks.math.columbia.edu/tag/06S5}{\texttt{Stacks tag 06S5}}
\group{formal-defos}
...
Lemma \ref{formal-defos-lemma-surjective} (2 times).
...
\vcenter{
\begin{array}{ccccc}H_1(L_{k/\Lambda}) \longrightarrow\downarrow & \mathfrak m_B/\mathfrak m_B^2 \underset{\text{d}_B}{\longrightarrow}\downarrow & \Omega_{B/\Lambda} \otimes_B k \longrightarrow\downarrow & \Omega_{k/\Lambda} \longrightarrow\downarrow & 0 \\ H_1(L_{k/\Lambda}) \longrightarrow & \mathfrak m_A/\mathfrak m_A^2 \overset{\text{d}_A}{\longrightarrow} & \Omega_{A/\Lambda} \otimes_A k \longrightarrow & \Omega_{k/\Lambda} \longrightarrow & 0\end{array}
}
\end{equation}
with exact rows.

\begin{lemma}[H1 separable case]
\label{formal-defos-lemma-H1-separable-case}
\source{stacks:06S9}
\href{https://stacks.math.columbia.edu/tag/06S9}{\texttt{Stacks tag 06S9}}
\group{formal-defos}
...
\begin{lemma}[Essential surjection]
\label{formal-defos-lemma-essential-surjection}
\source{stacks:06H0}
\href{https://stacks.math.columbia.edu/tag/06H0}{\texttt{Stacks tag 06H0}}
\group{formal-defos}
...
\begin{enumerate}
\item $f$ is an essential surjection
(see Lemma \ref{formal-defos-lemma-essential-surjection-mod-squares}),
...
Lemma \ref{formal-defos-lemma-surjective}. This finishes the proof of (1).
...
Lemma \ref{formal-defos-lemma-H1-separable-case}.
Hence $\Im(\text{d}_A) =
\mathfrak m_A/(\mathfrak m_\Lambda A + \mathfrak m_A^2)$
...
Lemma \ref{formal-defos-lemma-essential-surjection} (3)
...
(Section \ref{formal-defos-section-formal-objects}).

\begin{definition}[Completion CLambda]
\label{formal-defos-definition-completion-CLambda}
\source{stacks:06GW}
\href{https://stacks.math.columbia.edu/tag/06GW}{\texttt{Stacks tag 06GW}}
\group{formal-defos}
...
\begin{lemma}[Surjective cotangent space]
\label{formal-defos-lemma-surjective-cotangent-space}
\source{stacks:06GZ}
\href{https://stacks.math.columbia.edu/tag/06GZ}{\texttt{Stacks tag 06GZ}}
\group{formal-defos}
...
\begin{lemma}[CLambdahat pushouts]
\label{formal-defos-lemma-CLambdahat-pushouts}
\source{stacks:06SB}
\href{https://stacks.math.columbia.edu/tag/06SB}{\texttt{Stacks tag 06SB}}
\group{formal-defos}
...
\begin{lemma}[CLambdahat coproducts]
\label{formal-defos-lemma-CLambdahat-coproducts}
\source{stacks:06H1}
\href{https://stacks.math.columbia.edu/tag/06H1}{\texttt{Stacks tag 06H1}}
\group{formal-defos}
...
\begin{lemma}[Derivations finite]
\label{formal-defos-lemma-derivations-finite}
\source{stacks:06SC}
\href{https://stacks.math.columbia.edu/tag/06SC}{\texttt{Stacks tag 06SC}}
\group{formal-defos}
...
\begin{lemma}[Derivations surjective]
\label{formal-defos-lemma-derivations-surjective}
\source{stacks:06SD}
\href{https://stacks.math.columbia.edu/tag/06SD}{\texttt{Stacks tag 06SD}}
\group{formal-defos}
...
Lemma \ref{formal-defos-lemma-surjective-cotangent-space}.
...
\begin{lemma}[M adic topology]
\label{formal-defos-lemma-m-adic-topology}
\source{stacks:06SE}
\href{https://stacks.math.columbia.edu/tag/06SE}{\texttt{Stacks tag 06SE}}
\group{formal-defos}
...
$f \in J_m$ by Krull's intersection theorem, see
...
\begin{lemma}[Limit artinian]
\label{formal-defos-lemma-limit-artinian}
\source{stacks:06SF}
\href{https://stacks.math.columbia.edu/tag/06SF}{\texttt{Stacks tag 06SF}}
\group{formal-defos}
...
Set $J = \bigcap J_n$. By
Lemma \ref{formal-defos-lemma-m-adic-topology}
...
\source{stacks:06SG}
\href{https://stacks.math.columbia.edu/tag/06SG}{\texttt{Stacks tag 06SG}}
\group{formal-defos}
...
\begin{definition}[Category cofibred groupoids]
\label{formal-defos-definition-category-cofibred-groupoids}
\source{stacks:06GJ}
\href{https://stacks.math.columbia.edu/tag/06GJ}{\texttt{Stacks tag 06GJ}}
\group{formal-defos}
...
\begin{definition}[Prorepresentable]
\label{formal-defos-definition-prorepresentable}
\source{stacks:06GX}
\href{https://stacks.math.columbia.edu/tag/06GX}{\texttt{Stacks tag 06GX}}
\group{formal-defos}
...
\begin{definition}[Predeformation category]
\label{formal-defos-definition-predeformation-category}
\source{stacks:06GS}
\href{https://stacks.math.columbia.edu/tag/06GS}{\texttt{Stacks tag 06GS}}
\group{formal-defos}
...
\begin{remark}[Predeformation functor]
\label{formal-defos-remark-predeformation-functor}
\source{stacks:06GT}
\href{https://stacks.math.columbia.edu/tag/06GT}{\texttt{Stacks tag 06GT}}
\group{formal-defos}
...
\begin{remark}[Localize cofibered groupoid]
\label{formal-defos-remark-localize-cofibered-groupoid}
\source{stacks:06GU}
\href{https://stacks.math.columbia.edu/tag/06GU}{\texttt{Stacks tag 06GU}}
\group{formal-defos}
...
diagram
$$
\begin{array}{ccc}y \longrightarrow\searrow &  & z \swarrow \\  & x & \end{array}
$$
...
\begin{definition}[Formal objects]
\label{formal-defos-definition-formal-objects}
\source{stacks:06H3}
\href{https://stacks.math.columbia.edu/tag/06H3}{\texttt{Stacks tag 06H3}}
\group{formal-defos}
...
$$
\begin{array}{cc}\xi_{n + 1} \underset{f_n}{\longrightarrow}\underset{a_{n + 1}}{\downarrow} & \xi_n \overset{a_n}{\downarrow} \\ \eta_{n + 1} \overset{g_n}{\longrightarrow} & \eta_n\end{array}
$$
commutes.
\end{enumerate}
\end{definition}
...
\begin{lemma}[Completion cofibred]
\label{formal-defos-lemma-completion-cofibred}
\source{stacks:06H4}
\href{https://stacks.math.columbia.edu/tag/06H4}{\texttt{Stacks tag 06H4}}
\group{formal-defos}
...
$$
\begin{array}{cc}\xi_{n + 1} \downarrow\underset{f_n}{\longrightarrow} & \xi_n \downarrow \\ \eta_{n + 1} \overset{g_n}{\longrightarrow} & \eta_n\end{array}
$$
...
\source{stacks:06H5}
\href{https://stacks.math.columbia.edu/tag/06H5}{\texttt{Stacks tag 06H5}}
\group{formal-defos}
...
$$
\begin{array}{cc}\xi_{n + 1} \overset{f_n}{\longrightarrow}\underset{a_{n + 1}}{\downarrow} & \xi_n \overset{a_n}{\downarrow} \\ \eta_{n + 1} \overset{g_n}{\longrightarrow} & \eta_n\end{array}
$$
commutes.
\end{enumerate}

\begin{lemma}[Formal objects different filtration]
\label{formal-defos-lemma-formal-objects-different-filtration}
\source{stacks:06H6}
\href{https://stacks.math.columbia.edu/tag/06H6}{\texttt{Stacks tag 06H6}}
\group{formal-defos}
...
$$
\begin{array}{cccc}\xi_{m(n + 1)} \underset{f_{m(n)} \circ \ldots \circ f_{m(n + 1) - 1}}{\longrightarrow}\downarrow &  &  & \xi_{m(n)} \downarrow \\ \eta_{n + 1} \overset{g_n}{\longrightarrow} &  &  & \eta_n\end{array}
$$
...
\begin{remark}[Different sequence ideals]
\label{formal-defos-remark-different-sequence-ideals}
\source{stacks:06H7}
\href{https://stacks.math.columbia.edu/tag/06H7}{\texttt{Stacks tag 06H7}}
\group{formal-defos}
...
$R \in \Ob(\widehat{\mathcal{C}}_\Lambda)$
the equivalence of
Lemma \ref{formal-defos-lemma-formal-objects-different-filtration}.
\end{remark}

\begin{remark}[Completion functor]
\label{formal-defos-remark-completion-functor}
\source{stacks:06H8}
\href{https://stacks.math.columbia.edu/tag/06H8}{\texttt{Stacks tag 06H8}}
\group{formal-defos}
...
\begin{remark}[Restrict completion]
\label{formal-defos-remark-restrict-completion}
\source{stacks:06SJ}
\href{https://stacks.math.columbia.edu/tag/06SJ}{\texttt{Stacks tag 06SJ}}
\group{formal-defos}
...
\begin{remark}[Completion morphism]
\label{formal-defos-remark-completion-morphism}
\source{stacks:06H9}
\href{https://stacks.math.columbia.edu/tag/06H9}{\texttt{Stacks tag 06H9}}
\group{formal-defos}
...
\begin{remark}[Completion restriction adjoint]
\label{formal-defos-remark-completion-restriction-adjoint}
\source{stacks:06HA}
\href{https://stacks.math.columbia.edu/tag/06HA}{\texttt{Stacks tag 06HA}}
\group{formal-defos}

We claim the completion functor of
Remark \ref{formal-defos-remark-completion-morphism}
...
of
Remark \ref{formal-defos-remark-restrict-completion}.
\end{enumerate}
...
\begin{remark}[Completion restriction cofset adjoint]
\label{formal-defos-remark-completion-restriction-cofset-adjoint}
\source{stacks:06HB}
\href{https://stacks.math.columbia.edu/tag/06HB}{\texttt{Stacks tag 06HB}}
\group{formal-defos}
...
Remark \ref{formal-defos-remark-completion-restriction-adjoint} defines a functorial
bijection
$$
...
\begin{remark}[Restrict complete continuous functor]
\label{formal-defos-remark-restrict-complete-continuous-functor}
\source{stacks:06HE}
\href{https://stacks.math.columbia.edu/tag/06HE}{\texttt{Stacks tag 06HE}}
\group{formal-defos}
...
Remark \ref{formal-defos-remark-completion-restriction-adjoint}
...
\begin{remark}[Formal objects yoneda]
\label{formal-defos-remark-formal-objects-yoneda}
\source{stacks:06HC}
\href{https://stacks.math.columbia.edu/tag/06HC}{\texttt{Stacks tag 06HC}}
\group{formal-defos}
...
(see Remark \ref{formal-defos-remark-restrict-complete-continuous-functor})
and unwinding the definitions of $\Phi$ and $\Psi$ we conclude that
$\iota(\xi)$ is isomorphic to the completion of $\underline{\xi}$.
\end{remark}

\begin{remark}[Formal objects yoneda map]
\label{formal-defos-remark-formal-objects-yoneda-map}
\source{stacks:06SL}
\href{https://stacks.math.columbia.edu/tag/06SL}{\texttt{Stacks tag 06SL}}
\group{formal-defos}
...
diagram
$$
\begin{array}{ccc}\underline{R}|_{\mathcal{C}_\Lambda} \underset{\underline{\xi}}{\searrow} &  & \underline{S}|_{\mathcal{C}_\Lambda} \overset{f}{\longleftarrow}\overset{\underline{\eta}}{\swarrow} \\  & \mathcal{F} & \end{array}
$$
where $\underline{\xi}$ and $\underline{\eta}$ are the morphisms
constructed in
Remark \ref{formal-defos-remark-formal-objects-yoneda}.
...
$$
\begin{array}{ccc}R \overset{f}{\downarrow}\longrightarrow & R/\mathfrak m_R^m \underset{f_m}{\downarrow}\overset{\beta_m}{\searrow} &  \\ S \longrightarrow & S/\mathfrak m_S^m \overset{\alpha_m}{\longrightarrow} & A\end{array}
$$
...
$$
\begin{array}{cc}\xi_m \longrightarrow\overset{a_m}{\downarrow} & \beta_{m, *}\xi_m \downarrow \\ \eta_m \longrightarrow & \alpha_{m, *}\eta_m\end{array}
$$
...
\begin{remark}[Spell out formal object]
\label{formal-defos-remark-spell-out-formal-object}
\source{stacks:06HD}
\href{https://stacks.math.columbia.edu/tag/06HD}{\texttt{Stacks tag 06HD}}
\group{formal-defos}

According to Remark \ref{formal-defos-remark-formal-objects-yoneda}, giving a formal object
...
\source{stacks:06HG}
\href{https://stacks.math.columbia.edu/tag/06HG}{\texttt{Stacks tag 06HG}}
\group{formal-defos}
...
$$
\begin{array}{cc}\varphi(x') \longrightarrow\searrow & y \downarrow \\  & \varphi(x)\end{array}
$$
commutes.
\end{definition}

\begin{lemma}[Smoothness small extensions]
\label{formal-defos-lemma-smoothness-small-extensions}
\source{stacks:06HH}
\href{https://stacks.math.columbia.edu/tag/06HH}{\texttt{Stacks tag 06HH}}
\group{formal-defos}

Let $\varphi : \mathcal{F} \to \mathcal{G}$ be a morphism of categories
cofibered in groupoids over $\mathcal{C}_\Lambda$.  Then $\varphi$ is smooth
if the condition in Definition \ref{formal-defos-definition-smooth-morphism} is assumed to
...
Lemma \ref{formal-defos-lemma-factor-small-extension} we can factor $B \to A$ into
...
$$
\begin{array}{cc}\varphi(x_{n - 1}) \underset{a}{\longrightarrow}\searrow & f_*y \downarrow \\  & \varphi(x)\end{array}
$$
...
$$
\begin{array}{cc}\varphi(x_n) \longrightarrow\downarrow & y \downarrow \\ \varphi(x_{n - 1}) \overset{a}{\longrightarrow}\searrow & f_*y \downarrow \\  & \varphi(x)\end{array}
$$
...
\begin{remark}[Smoothness 2 categorical]
\label{formal-defos-remark-smoothness-2-categorical}
\source{stacks:06HI}
\href{https://stacks.math.columbia.edu/tag/06HI}{\texttt{Stacks tag 06HI}}
\group{formal-defos}
...
diagram
$$
\begin{array}{cc}\mathcal{F}(B) \overset{\varphi}{\longrightarrow}\downarrow & \mathcal{G}(B) \downarrow \\ \mathcal{F}(A) \overset{\varphi}{\longrightarrow} & \mathcal{G}(A) .\end{array}
$$
...
Lemma \ref{formal-defos-lemma-smoothness-small-extensions},
whenever $B \to A$ is a small extension).
\end{remark}

\begin{remark}[Compare smooth schlessinger]
\label{formal-defos-remark-compare-smooth-schlessinger}
\source{stacks:06HJ}
\href{https://stacks.math.columbia.edu/tag/06HJ}{\texttt{Stacks tag 06HJ}}
\group{formal-defos}

The characterization of smooth morphisms in
Remark \ref{formal-defos-remark-smoothness-2-categorical}
...
\begin{remark}[Smooth to iso classes]
\label{formal-defos-remark-smooth-to-iso-classes}
\source{stacks:06HK}
\href{https://stacks.math.columbia.edu/tag/06HK}{\texttt{Stacks tag 06HK}}
\group{formal-defos}
...
the problem posed in Definition \ref{formal-defos-definition-smooth-morphism}.
\end{remark}
...
\begin{lemma}[Smooth morphism power series]
\label{formal-defos-lemma-smooth-morphism-power-series}
\source{stacks:06HL}
\href{https://stacks.math.columbia.edu/tag/06HL}{\texttt{Stacks tag 06HL}}
\group{formal-defos}
...
Smoothness of
$\underline{S}|_{\mathcal{C}_\Lambda} \to \underline{R}|_{\mathcal{C}_\Lambda}$
means the following (see Remark \ref{formal-defos-remark-compare-smooth-schlessinger}):
Given a surjective ring map $B \to A$ in
$\mathcal{C}_\Lambda$, a ring map $R \to B$, a ring map $S \to A$ such that
the solid diagram
$$
\begin{array}{cc}S \longrightarrow\searrow & A \\ R \uparrow\longrightarrow & B \uparrow\end{array}
$$
...
\begin{lemma}[Smooth properties]
\label{formal-defos-lemma-smooth-properties}
\source{stacks:06HM}
\href{https://stacks.math.columbia.edu/tag/06HM}{\texttt{Stacks tag 06HM}}
\group{formal-defos}
...
\begin{lemma}[Smooth morphism essentially surjective]
\label{formal-defos-lemma-smooth-morphism-essentially-surjective}
\source{stacks:06HN}
\href{https://stacks.math.columbia.edu/tag/06HN}{\texttt{Stacks tag 06HN}}
\group{formal-defos}
...
$$
\begin{array}{cc}\varphi(\xi_2)  \overset{\varphi(f_1)}{\longrightarrow} & \varphi(\xi_{1}) \\ \eta_2   \uparrow\overset{g_1}{\longrightarrow} & \eta_1  \uparrow \\  & \end{array}
$$
...
\begin{definition}[Versal]
\label{formal-defos-definition-versal}
\source{stacks:06HR}
\href{https://stacks.math.columbia.edu/tag/06HR}{\texttt{Stacks tag 06HR}}
\group{formal-defos}
...
$\underline{\xi}: \underline{R}|_{\mathcal{C}_\Lambda} \to \mathcal{F}$
of Remark \ref{formal-defos-remark-formal-objects-yoneda} is smooth.
\end{definition}

\begin{remark}[Versal object]
\label{formal-defos-remark-versal-object}
\source{stacks:06HS}
\href{https://stacks.math.columbia.edu/tag/06HS}{\texttt{Stacks tag 06HS}}
\group{formal-defos}
...
$$
\begin{array}{cc} & y \downarrow \\ \xi \longrightarrow & x\end{array}
$$
...
$$
\begin{array}{cc} & y \downarrow \\ \xi \longrightarrow\nearrow & x\end{array}
$$
...
\begin{lemma}[Versal object quasi initial]
\label{formal-defos-lemma-versal-object-quasi-initial}
\source{stacks:06HT}
\href{https://stacks.math.columbia.edu/tag/06HT}{\texttt{Stacks tag 06HT}}
\group{formal-defos}
...
\begin{definition}[Cofibered groupoid projection smooth]
\label{formal-defos-definition-cofibered-groupoid-projection-smooth}
\source{stacks:06HP}
\href{https://stacks.math.columbia.edu/tag/06HP}{\texttt{Stacks tag 06HP}}
\group{formal-defos}

Let $p : \mathcal{F} \to \mathcal{C}_\Lambda$ be a category cofibered in
groupoids. We say $\mathcal{F}$ is {\it smooth} or {\it unobstructed}
if its structure morphism $p$ is smooth
in the sense of Definition \ref{formal-defos-definition-smooth-morphism}.
\end{definition}
...
\begin{remark}[Smooth on top]
\label{formal-defos-remark-smooth-on-top}
\source{stacks:06HQ}
\href{https://stacks.math.columbia.edu/tag/06HQ}{\texttt{Stacks tag 06HQ}}
\group{formal-defos}
...
Lemma \ref{formal-defos-lemma-smooth-properties}
...
\source{stacks:0DYL}
\href{https://stacks.math.columbia.edu/tag/0DYL}{\texttt{Stacks tag 0DYL}}
\group{formal-defos}
...
diagram
$$
\begin{array}{cc}R \longrightarrow\searrow & A \\ \Lambda \longrightarrow\uparrow & B \uparrow\end{array}
$$
...
Lemma \ref{formal-defos-lemma-smooth-morphism-power-series}
and the fact that $\mathcal{C}_\Lambda$ is the same
as $\underline{\Lambda}|_{\mathcal{C}_\Lambda}$ in the classical case.
\end{proof}

\begin{lemma}[Smooth power series classical]
\label{formal-defos-lemma-smooth-power-series-classical}
\source{stacks:0DZK}
\href{https://stacks.math.columbia.edu/tag/0DZK}{\texttt{Stacks tag 0DZK}}
\group{formal-defos}
...
\mathcal{C}_\Lambda
$$
is smooth, see Lemma \ref{formal-defos-lemma-smooth-properties}.
Hence we see that (2) holds by Lemma \ref{formal-defos-lemma-smooth}.
Conversely, if (2) holds, then the composition is smooth
and moreover the first arrow is essentially surjective by
Lemma \ref{formal-defos-lemma-versal-object-quasi-initial}. Hence we
find that the second arrow is smooth by Lemma \ref{formal-defos-lemma-smooth-properties}
which means that $\mathcal{F}$ is unobstructed by definition.
The equivalence with (3) in the classical case follows
from Lemma \ref{formal-defos-lemma-smooth}.
\end{proof}

\begin{lemma}[Exists smooth]
\label{formal-defos-lemma-exists-smooth}
\source{stacks:06SM}
\href{https://stacks.math.columbia.edu/tag/06SM}{\texttt{Stacks tag 06SM}}
\group{formal-defos}

There exists an $R \in \Ob(\widehat{\mathcal{C}}_\Lambda)$
such that the equivalent conditions of Lemma \ref{formal-defos-lemma-smooth}
...
\begin{example}[Smooth explicit]
\label{formal-defos-example-smooth-explicit}
\source{stacks:06SN}
\href{https://stacks.math.columbia.edu/tag/06SN}{\texttt{Stacks tag 06SN}}
\group{formal-defos}

Here is a more explicit example of an $R$ as in
Lemma \ref{formal-defos-lemma-exists-smooth}.
Let $p$ be a prime number and let $n \in \mathbf{N}$.
Let $\Lambda = \mathbf{F}_p(t_1, t_2, \ldots, t_n)$ and let
$k = \mathbf{F}_p(x_1, \ldots, x_n)$ with map $\Lambda \to k$ given
...
Example \ref{formal-defos-example-fibre-product}
...
\begin{definition}[S1 S2]
\label{formal-defos-definition-S1-S2}
\source{stacks:06HW}
\href{https://stacks.math.columbia.edu/tag/06HW}{\texttt{Stacks tag 06HW}}
\group{formal-defos}
...
$$
\vcenter{
\begin{array}{cc} & x_2 \downarrow \\ x_1 \longrightarrow & x\end{array}
}
\quad\text{lying over}\quad
\vcenter{
\begin{array}{cc} & A_2 \downarrow \\ A_1 \longrightarrow & A\end{array}
}
$$
...
$$
\vcenter{
\begin{array}{cc}y \longrightarrow\downarrow & x_2 \downarrow \\ x_1 \longrightarrow & x\end{array}
}
\quad\text{lying over}\quad
\vcenter{
\begin{array}{cc}A_1 \times_A A_2 \longrightarrow\downarrow & A_2 \downarrow \\ A_1 \longrightarrow & A.\end{array}
}
$$
\item[(S2)]
...
$$
\begin{array}{cc} & k[\epsilon] \downarrow \\ A  \longrightarrow & k.\end{array}
$$
Moreover, if we have two commutative diagrams in $\mathcal{F}$
$$
\vcenter{
\begin{array}{cc}y \underset{c}{\longrightarrow}\underset{a}{\downarrow} & x_\epsilon \overset{e}{\downarrow} \\ x \overset{d}{\longrightarrow} & x_0\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}y' \underset{c'}{\longrightarrow}\underset{a'}{\downarrow} & x_\epsilon \overset{e}{\downarrow} \\ x \overset{d}{\longrightarrow} & x_0\end{array}
...
\quad\text{lying over}\quad
\vcenter{
\begin{array}{cc}A \times_k k[\epsilon] \longrightarrow\downarrow & k[\epsilon] \downarrow \\ A  \longrightarrow & k\end{array}
}
$$
...
$$
\begin{array}{cc}\mathcal{F}(A_1 \times_A A_2) \underset{p_{2, *}}{\longrightarrow}\underset{p_{1, *}}{\downarrow} & \mathcal{F}(A_2) \overset{f_{2, *}}{\downarrow} \\ \mathcal{F}(A_1) \overset{f_{1, *}}{\longrightarrow} & \mathcal{F}(A)\end{array}
$$
...
\begin{lemma}[S1 small extensions]
\label{formal-defos-lemma-S1-small-extensions}
\source{stacks:06HX}
\href{https://stacks.math.columbia.edu/tag/06HX}{\texttt{Stacks tag 06HX}}
\group{formal-defos}
...
\begin{proof}
Proof omitted. Hints: apply Lemma \ref{formal-defos-lemma-factor-small-extension}
and use induction similar to the proof of
Lemma \ref{formal-defos-lemma-smoothness-small-extensions}.
\end{proof}

\begin{remark}[Compare S1 S2 schlessinger]
\label{formal-defos-remark-compare-S1-S2-schlessinger}
\source{stacks:06HY}
\href{https://stacks.math.columbia.edu/tag/06HY}{\texttt{Stacks tag 06HY}}
\group{formal-defos}
...
\begin{lemma}[S2 extensions]
\label{formal-defos-lemma-S2-extensions}
\source{stacks:06HZ}
\href{https://stacks.math.columbia.edu/tag/06HZ}{\texttt{Stacks tag 06HZ}}
\group{formal-defos}
...
Remark \ref{formal-defos-remark-compare-S1-S2-schlessinger}
and the fact that
...
$$
\vcenter{
\begin{array}{cc} & x_V \downarrow \\ x \longrightarrow & x_0\end{array}
}
\quad\text{lying over}\quad
\vcenter{
\begin{array}{cc} & k[V] \downarrow \\ A \longrightarrow & k\end{array}
}
$$
...
$$
\vcenter{
\begin{array}{cc}y' \downarrow\longrightarrow & x_{V'} \downarrow \\ x \longrightarrow & x_0\end{array}
}
\quad\text{lying over}\quad
\vcenter{
\begin{array}{cc}A \times_k k[V'] \downarrow\longrightarrow & k[V'] \downarrow \\ A \longrightarrow & k\end{array}
}
$$
This gives us a commutative diagram
$$
\vcenter{
\begin{array}{cc} & x_\epsilon \downarrow \\ y' \longrightarrow & x_0\end{array}
}
\quad\text{lying over}\quad
\vcenter{
\begin{array}{cc} & k[\epsilon] \downarrow \\ A \times_k k[V'] \longrightarrow & k\end{array}
}
$$
Hence by (S2) we get a commutative diagram
$$
\vcenter{
\begin{array}{cc}y \downarrow\longrightarrow & x_\epsilon \downarrow \\ y' \longrightarrow & x_0\end{array}
}
\quad\text{lying over}\quad
\vcenter{
\begin{array}{cc}(A \times_k k[V']) \times_k k[\epsilon] \downarrow\longrightarrow & k[\epsilon] \downarrow \\ A \times_k k[V'] \longrightarrow & k\end{array}
}
$$
Note that
...
$$
\vcenter{
\begin{array}{cc}y_V \longrightarrow\downarrow & x_\epsilon \downarrow \\ x_{V'} \longrightarrow & x_0\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}x_V \longrightarrow\downarrow & x_\epsilon \downarrow \\ x_{V'} \longrightarrow & x_0\end{array}
}
$$
...
$$
\vcenter{
\begin{array}{cc}y \longrightarrow\downarrow & x_V \downarrow \\ x \longrightarrow & x_0\end{array}
}
\quad\text{lying over}\quad
\vcenter{
\begin{array}{cc}A \times_k k[V] \downarrow\longrightarrow & k[V] \downarrow \\ A \longrightarrow & k\end{array}
...
$$
\vcenter{
\begin{array}{cc}y_{V'} \longrightarrow\downarrow & x_{V'} \downarrow \\ x \longrightarrow & x_0\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}y'_{V'} \longrightarrow\downarrow & x_{V'} \downarrow \\ x \longrightarrow & x_0\end{array}
}
\quad\text{lying over}\quad
\vcenter{
\begin{array}{cc}A \times_k k[V'] \downarrow\longrightarrow & k[V'] \downarrow \\ A \longrightarrow & k\end{array}
...
$$
\vcenter{
\begin{array}{cc}y \longrightarrow\downarrow & x_\epsilon \downarrow \\ y'_{V'} \longrightarrow & x_0\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}y' \longrightarrow\downarrow & x_\epsilon \downarrow \\ y'_{V'} \longrightarrow & x_0\end{array}
...
\quad\text{lying over}\quad
\vcenter{
\begin{array}{cc}A \times_k k[\epsilon] \downarrow\longrightarrow & k[\epsilon] \downarrow \\ A \longrightarrow & k\end{array}
}
$$
...
\begin{lemma}[S1 S2 associated functor]
\label{formal-defos-lemma-S1-S2-associated-functor}
\source{stacks:06I0}
\href{https://stacks.math.columbia.edu/tag/06I0}{\texttt{Stacks tag 06I0}}
\group{formal-defos}
...
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}y' \underset{c'}{\longrightarrow}\underset{a'}{\downarrow} & x'_\epsilon \overset{e'}{\downarrow} \\ x' \overset{d'}{\longrightarrow} & x'_0\end{array}
}
\quad\text{lying over}\quad
\vcenter{
\begin{array}{cc}A \times_k k[\epsilon] \downarrow\longrightarrow & k[\epsilon] \downarrow \\ A \longrightarrow & k\end{array}
...
$$
\begin{array}{ccc}x \overset{\alpha}{\downarrow}\longrightarrow & x_0 \overset{\gamma}{\downarrow} & x_\epsilon \overset{\beta}{\downarrow}\overset{e}{\longleftarrow} \\ x' \longrightarrow & x'_0 & x'_\epsilon \underset{e'}{\longleftarrow}\end{array}
$$
...
\begin{lemma}[S1 S2 localize]
\label{formal-defos-lemma-S1-S2-localize}
\source{stacks:06SQ}
\href{https://stacks.math.columbia.edu/tag/06SQ}{\texttt{Stacks tag 06SQ}}
\group{formal-defos}
...
\begin{proof}
Any diagram as in
Definition \ref{formal-defos-definition-S1-S2}
...
\begin{lemma}[Lifting section]
\label{formal-defos-lemma-lifting-section}
\source{stacks:06IS}
\href{https://stacks.math.columbia.edu/tag/06IS}{\texttt{Stacks tag 06IS}}
\group{formal-defos}
...
$$
\vcenter{
\begin{array}{cc}y \longrightarrow\underset{a}{\downarrow} & x_\epsilon \underset{e}{\downarrow} \\ x \overset{d}{\longrightarrow} & x_0\end{array}
}
\quad\text{lying over}\quad
\vcenter{
\begin{array}{cc}A \times_k k[\epsilon] \longrightarrow\downarrow & k[\epsilon] \downarrow \\ A \longrightarrow & k.\end{array}
...
$$
\begin{array}{cc}\sigma_*x \longrightarrow\downarrow & x_\epsilon \underset{e}{\downarrow} \\ x \overset{d}{\longrightarrow} & x_0\end{array}
$$
...
\begin{lemma}[Lifting along small extension]
\label{formal-defos-lemma-lifting-along-small-extension}
\source{stacks:06IT}
\href{https://stacks.math.columbia.edu/tag/06IT}{\texttt{Stacks tag 06IT}}
\group{formal-defos}

Consider a commutative diagram in a predeformation category $\mathcal{F}$
$$
\vcenter{
\begin{array}{cc}y \longrightarrow\downarrow & x_2 \overset{a_2}{\downarrow} \\ x_1 \overset{a_1}{\longrightarrow} & x\end{array}
}
\quad\text{lying over}
\vcenter{
\begin{array}{cc}A_1 \times_A A_2 \longrightarrow\downarrow & A_2 \overset{f_2}{\downarrow} \\ A_1 \overset{f_1}{\longrightarrow} & A\end{array}
}
$$
...
$$
\vcenter{
\begin{array}{cc}y \longrightarrow\downarrow & g_*y \downarrow \\ x_1 \longrightarrow & x_0\end{array}
}
\quad\text{lying over}\quad
\vcenter{
\begin{array}{cc}A_1 \times_k k[\epsilon] \longrightarrow\downarrow & k[\epsilon] \downarrow \\ A_1 \longrightarrow & k.\end{array}
}
$$
where $x_0$ is an object of $\mathcal{F}$ lying over $k$ (every object
of $\mathcal{F}$ has a unique morphism to $x_0$, see
discussion following Definition \ref{formal-defos-definition-predeformation-category}).
If we have a morphism $x_1 \to g_*y$ then
Lemma \ref{formal-defos-lemma-lifting-section}
...
\source{stacks:06I3}
\href{https://stacks.math.columbia.edu/tag/06I3}{\texttt{Stacks tag 06I3}}
\group{formal-defos}
...
\begin{remark}[Linear enriched over modules]
\label{formal-defos-remark-linear-enriched-over-modules}
\source{stacks:06I4}
\href{https://stacks.math.columbia.edu/tag/06I4}{\texttt{Stacks tag 06I4}}
\group{formal-defos}
...
\begin{remark}[Linear functor]
\label{formal-defos-remark-linear-functor}
\source{stacks:06I5}
\href{https://stacks.math.columbia.edu/tag/06I5}{\texttt{Stacks tag 06I5}}
\group{formal-defos}
...
Lemma \ref{formal-defos-lemma-linear-functor}.
\end{remark}

\begin{lemma}[Linear functor]
\label{formal-defos-lemma-linear-functor}
\source{stacks:06I6}
\href{https://stacks.math.columbia.edu/tag/06I6}{\texttt{Stacks tag 06I6}}
\group{formal-defos}
...
$$
\vcenter{
\begin{array}{ccc} & \text{Mod}_R \overset{\text{forget}}{\searrow} &  \\ \text{Mod}^{fg}_R  \overset{\widetilde{L}}{\nearrow}\overset{L}{\longrightarrow} &  & \textit{Sets}\end{array}
}
\quad\text{resp.}\quad
\vcenter{
\begin{array}{ccc} & \text{Mod}_R \overset{\text{forget}}{\searrow} &  \\ \text{Mod}_R  \overset{\widetilde{L}}{\nearrow}\overset{L}{\longrightarrow} &  & \textit{Sets}\end{array}
}
$$
commutes.
\end{lemma}
...
\begin{lemma}[Morphism linear functors]
\label{formal-defos-lemma-morphism-linear-functors}
\source{stacks:06I7}
\href{https://stacks.math.columbia.edu/tag/06I7}{\texttt{Stacks tag 06I7}}
\group{formal-defos}
...
functors guaranteed by Lemma \ref{formal-defos-lemma-linear-functor}, which is given simply
...
\begin{lemma}[Linear functor over field]
\label{formal-defos-lemma-linear-functor-over-field}
\source{stacks:06I8}
\href{https://stacks.math.columbia.edu/tag/06I8}{\texttt{Stacks tag 06I8}}
\group{formal-defos}
...
products (Remark \ref{formal-defos-remark-linear-functor}).
\end{proof}
...
\begin{lemma}[Preserves products]
\label{formal-defos-lemma-preserves-products}
\source{stacks:06I9}
\href{https://stacks.math.columbia.edu/tag/06I9}{\texttt{Stacks tag 06I9}}
\group{formal-defos}
...
\begin{lemma}[Tangent space functor]
\label{formal-defos-lemma-tangent-space-functor}
\source{stacks:06IA}
\href{https://stacks.math.columbia.edu/tag/06IA}{\texttt{Stacks tag 06IA}}
\group{formal-defos}
...
Lemma \ref{formal-defos-lemma-preserves-products}
...
\begin{definition}[Tangent space over R]
\label{formal-defos-definition-tangent-space-over-R}
\source{stacks:06IB}
\href{https://stacks.math.columbia.edu/tag/06IB}{\texttt{Stacks tag 06IB}}
\group{formal-defos}

Let $\mathcal{C}$ be a category as in
Lemma \ref{formal-defos-lemma-tangent-space-functor}.
...
\begin{example}[Tangent space functor]
\label{formal-defos-example-tangent-space-functor}
\source{stacks:06SR}
\href{https://stacks.math.columbia.edu/tag/06SR}{\texttt{Stacks tag 06SR}}
\group{formal-defos}

Since $\mathcal{C}_\Lambda$ contains all $k[V]$ for finite dimensional
vector spaces $V$ we see that
Definition \ref{formal-defos-definition-tangent-space-over-R} applies with
...
\begin{example}[Tangent space prorepresentable functor]
\label{formal-defos-example-tangent-space-prorepresentable-functor}
\source{stacks:06IC}
\href{https://stacks.math.columbia.edu/tag/06IC}{\texttt{Stacks tag 06IC}}
\group{formal-defos}

Let us work out the tangent space of
Example \ref{formal-defos-example-tangent-space-functor}
...
Lemma \ref{formal-defos-lemma-morphism-linear-functors}).
It follows that $\dim_k TF$ is finite by
Lemma \ref{formal-defos-lemma-derivations-finite}.
\end{example}

\begin{example}[Tangent space classical prorepresentable functor]
\label{formal-defos-example-tangent-space-classical-prorepresentable-functor}
\source{stacks:06SS}
\href{https://stacks.math.columbia.edu/tag/06SS}{\texttt{Stacks tag 06SS}}
\group{formal-defos}

The computation of
Example \ref{formal-defos-example-tangent-space-prorepresentable-functor}
...
field extension $k/k'$ is separable. See
Exercises, Exercise \ref{exercises-exercise-tangent-space-Zariski}.
\end{example}

\begin{lemma}[Morphism tangent spaces]
\label{formal-defos-lemma-morphism-tangent-spaces}
\source{stacks:06ID}
\href{https://stacks.math.columbia.edu/tag/06ID}{\texttt{Stacks tag 06ID}}
\group{formal-defos}
...
\begin{example}[Tangent space map prorepresentable functor]
\label{formal-defos-example-tangent-space-map-prorepresentable-functor}
\source{stacks:06ST}
\href{https://stacks.math.columbia.edu/tag/06ST}{\texttt{Stacks tag 06ST}}
\group{formal-defos}
...
Lemma \ref{formal-defos-lemma-morphism-tangent-spaces}
...
\begin{lemma}[Tangent space tensor]
\label{formal-defos-lemma-tangent-space-tensor}
\source{stacks:06IE}
\href{https://stacks.math.columbia.edu/tag/06IE}{\texttt{Stacks tag 06IE}}
\group{formal-defos}
...
\begin{proof}
Follows from
Lemma \ref{formal-defos-lemma-linear-functor-over-field}.
\end{proof}
...
Definition \ref{formal-defos-definition-tangent-space-over-R}.
...
\source{stacks:06IG}
\href{https://stacks.math.columbia.edu/tag/06IG}{\texttt{Stacks tag 06IG}}
\group{formal-defos}
...
\begin{lemma}[Tangent space vector space]
\label{formal-defos-lemma-tangent-space-vector-space}
\source{stacks:06IH}
\href{https://stacks.math.columbia.edu/tag/06IH}{\texttt{Stacks tag 06IH}}
\group{formal-defos}
...
Lemma \ref{formal-defos-lemma-S1-S2-associated-functor}.}. Then $T \mathcal{F}$ has a
...
Lemma \ref{formal-defos-lemma-S2-extensions}
...
Lemma \ref{formal-defos-lemma-tangent-space-tensor}.
\end{proof}
...
\source{stacks:06II}
\href{https://stacks.math.columbia.edu/tag/06II}{\texttt{Stacks tag 06II}}
\group{formal-defos}
...
\begin{lemma}[K linear differential]
\label{formal-defos-lemma-k-linear-differential}
\source{stacks:06IJ}
\href{https://stacks.math.columbia.edu/tag/06IJ}{\texttt{Stacks tag 06IJ}}
\group{formal-defos}
...
\begin{remark}[Tangent space cofibered groupoid]
\label{formal-defos-remark-tangent-space-cofibered-groupoid}
\source{stacks:06IK}
\href{https://stacks.math.columbia.edu/tag/06IK}{\texttt{Stacks tag 06IK}}
\group{formal-defos}
...
$d_x \varphi : T_x \mathcal{F} \to T_{\varphi(x)} \mathcal{G}$
are $k$-linear (use
Lemmas \ref{formal-defos-lemma-S1-S2-localize} and \ref{formal-defos-lemma-k-linear-differential}).
\end{remark}
...
\begin{lemma}[Action linear]
\label{formal-defos-lemma-action-linear}
\source{stacks:06SU}
\href{https://stacks.math.columbia.edu/tag/06SU}{\texttt{Stacks tag 06SU}}
\group{formal-defos}
...
Then
$$
\begin{array}{cc}k[V \times V] \underset{+}{\longrightarrow}\overset{f_{1, D_1}}{\downarrow} & k[V] \overset{f_{1, D}}{\downarrow} \\ k[V \times V] \overset{+}{\longrightarrow} & k[V]\end{array}
$$
...
$$
\vcenter{
\begin{array}{cc}\text{Der}_\Lambda(k, k) \underset{\gamma}{\longrightarrow}\underset{\gamma}{\searrow} & T\mathcal{F} \underset{d\varphi}{\downarrow} \\  & T\mathcal{G}\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}\text{Der}_\Lambda(k, k) \times T\mathcal{F} \underset{a}{\longrightarrow}\underset{1 \times d\varphi}{\downarrow} & T\mathcal{F} \overset{d\varphi}{\downarrow} \\ \text{Der}_\Lambda(k, k) \times T\mathcal{G} \overset{a}{\longrightarrow} & T\mathcal{G}\end{array}
}
$$
...
\begin{lemma}[Versal object S1]
\label{formal-defos-lemma-versal-object-S1}
\source{stacks:06SY}
\href{https://stacks.math.columbia.edu/tag/06SY}{\texttt{Stacks tag 06SY}}
\group{formal-defos}
...
Remark \ref{formal-defos-remark-restrict-completion}), we can consider this
diagram also as a diagram in $\widehat{\mathcal{F}}$. By
Lemma \ref{formal-defos-lemma-versal-object-quasi-initial} there exists a morphism
$\xi \to x_1$, so by
Remark \ref{formal-defos-remark-versal-object} we also get a
morphism $\xi \to x_2$ making the diagram
$$
\begin{array}{cc}\xi \longrightarrow\downarrow & x_2 \downarrow \\ x_1 \longrightarrow & x\end{array}
$$
...
\begin{lemma}[Versal criterion]
\label{formal-defos-lemma-versal-criterion}
\source{stacks:06IU}
\href{https://stacks.math.columbia.edu/tag/06IU}{\texttt{Stacks tag 06IU}}
\group{formal-defos}
...
\quad\text{lying over}\quad
\vcenter{
\begin{array}{cc} & B  \overset{f}{\downarrow} \\ R \longrightarrow & A\end{array}
}
$$
in $\widehat{\mathcal{C}}_\Lambda$ with $B \to A$ a small extension of
Artinian rings, then there exists a ring map $R \to B$ such that
$$
\begin{array}{cc} & B  \overset{f}{\downarrow} \\ R \nearrow\longrightarrow & A\end{array}
$$
commutes.
\end{enumerate}
\end{lemma}
...
$$
\vcenter{
\begin{array}{cc}z  \longrightarrow\downarrow & y \downarrow \\ y' \longrightarrow & x\end{array}
}
\quad\text{lying over}\quad
\vcenter{
\begin{array}{cc}B \times_A B \downarrow\longrightarrow & B  \overset{f}{\downarrow} \\ B \overset{f}{\longrightarrow} & A .\end{array}
}
$$
Set $I = \Ker(f)$. Let $\overline{g} : B \times_A B \to k[I]$
be the ring map $(u, v) \mapsto \overline{u} \oplus (v - u)$,
cf.\ Lemma \ref{formal-defos-lemma-lifting-along-small-extension}.
...
$$
\vcenter{
\begin{array}{ccc}z_1  \longrightarrow\downarrow & z \longrightarrow\downarrow & y \downarrow \\ y_1 \longrightarrow & y' \longrightarrow & x\end{array}
}
\quad\text{lying over}\quad
\vcenter{
\begin{array}{ccc}B_1 \times_A B \downarrow\longrightarrow & B \times_A B \longrightarrow\downarrow & B \overset{f}{\downarrow} \\ B_1 \longrightarrow & B \longrightarrow & A .\end{array}
}
$$
Note that the map $g : B_1 \times_A B \to k[I]$ of
Lemma \ref{formal-defos-lemma-lifting-along-small-extension}
(defined using $h$)
...
\begin{lemma}[Largest closed where lift]
\label{formal-defos-lemma-largest-closed-where-lift}
\source{stacks:06SZ}
\href{https://stacks.math.columbia.edu/tag/06SZ}{\texttt{Stacks tag 06SZ}}
\group{formal-defos}
...
\begin{lemma}[Versal object existence]
\label{formal-defos-lemma-versal-object-existence}
\source{stacks:06IW}
\href{https://stacks.math.columbia.edu/tag/06IW}{\texttt{Stacks tag 06IW}}
\group{formal-defos}
...
See Lemma \ref{formal-defos-lemma-exists-smooth}.
...
$$
see
Lemmas \ref{formal-defos-lemma-S1-S2-associated-functor} and
...
$S/J \to S/J_n$, see
Lemma \ref{formal-defos-lemma-largest-closed-where-lift}.
...
Lemma \ref{formal-defos-lemma-versal-criterion}.
...
\quad\text{lying over}\quad
\vcenter{
\begin{array}{cc} & B  \overset{f}{\downarrow} \\ \overline{S} \longrightarrow & A\end{array}
}
$$
...
$$
\vcenter{
\begin{array}{cc} & y \downarrow \\ \xi_n \longrightarrow & x\end{array}
}
\quad\text{lying over}\quad
\vcenter{
\begin{array}{cc} & B  \overset{f}{\downarrow} \\ S/J_n \longrightarrow & A .\end{array}
}
$$
...
$$
\begin{array}{cc}S/J_{n + 1} \downarrow\dashrightarrow & B \overset{f}{\downarrow} \\ S/J_n   \longrightarrow & A\end{array}
$$
or equivalently, to complete the diagram
$$
\begin{array}{cc} & S/J_n \times_A B \overset{p_1}{\downarrow} \\ S/J_{n + 1} \nearrow\longrightarrow & S/J_n.\end{array}
$$
If $p_1$ has a section we are done. If not, by
Lemma \ref{formal-defos-lemma-fiber-product-CLambda} (2)
$p_1$ is a small extension, so by
Lemma \ref{formal-defos-lemma-essential-surjection} (4)
...
$$
\begin{array}{cc}S \downarrow\underset{g}{\longrightarrow} & S/J_n \times_A B \overset{p_1}{\downarrow} \\ S/J_{n + 1} \nearrow\longrightarrow & S/J_n\end{array}
$$
...
\begin{remark}[Compare schlessinger H3 pre]
\label{formal-defos-remark-compare-schlessinger-H3-pre}
\source{stacks:0D3G}
\href{https://stacks.math.columbia.edu/tag/0D3G}{\texttt{Stacks tag 0D3G}}
\group{formal-defos}
...
Remark \ref{formal-defos-remark-compare-S1-S2-schlessinger}.
Thus Lemma \ref{formal-defos-lemma-versal-object-existence} tells us
$$
(H1) + (H2) + (H3)
\Rightarrow
...
Remark \ref{formal-defos-remark-compare-schlessinger-H3}.
\end{remark}
...
$$
\begin{array}{cc}y' \downarrow\longrightarrow & x' \downarrow \\ y \longrightarrow & x\end{array}
$$
...
\begin{lemma}[Smallest where descends]
\label{formal-defos-lemma-smallest-where-descends}
\source{stacks:06T1}
\href{https://stacks.math.columbia.edu/tag/06T1}{\texttt{Stacks tag 06T1}}
\group{formal-defos}
...
\quad\text{lying over}\quad
\vcenter{
\begin{array}{cc}B' \downarrow\longrightarrow & f(B') \downarrow \\ B \longrightarrow & A\end{array}
}
$$
...
\begin{lemma}[Smallest where descends versal]
\label{formal-defos-lemma-smallest-where-descends-versal}
\source{stacks:06T2}
\href{https://stacks.math.columbia.edu/tag/06T2}{\texttt{Stacks tag 06T2}}
\group{formal-defos}
...
$$
\vcenter{
\begin{array}{cc}\xi' \downarrow\longrightarrow & x' \downarrow \\ \xi \longrightarrow & x\end{array}
}
\quad\text{lying over}\quad
\vcenter{
\begin{array}{cc}R' \downarrow\longrightarrow & f(R') \downarrow \\ R \longrightarrow & A\end{array}
}
$$
...
for $m \leq n - 1$. By
Lemma \ref{formal-defos-lemma-smallest-where-descends} (2)
...
$$
\begin{array}{cc}\xi'_{n + 1} \underset{f'_n}{\longrightarrow}\downarrow & \xi'_n \downarrow \\ \xi_{n + 1} \overset{f_n}{\longrightarrow} & \xi_n\end{array}
$$
...
Lemma \ref{formal-defos-lemma-versal-object-quasi-initial}.
...
Lemma \ref{formal-defos-lemma-limit-artinian}
...
Lemma \ref{formal-defos-lemma-smallest-where-descends} (1).
...
\begin{lemma}[Descends versal]
\label{formal-defos-lemma-descends-versal}
\source{stacks:06T3}
\href{https://stacks.math.columbia.edu/tag/06T3}{\texttt{Stacks tag 06T3}}
\group{formal-defos}
...
Lemma \ref{formal-defos-lemma-smallest-where-descends-versal}.
Then
$$
...
\quad\text{lying over}\quad
\vcenter{
\begin{array}{cc} & S/\mathfrak m_S^n \downarrow \\ R \longrightarrow\nearrow & R/\mathfrak m_R^n\end{array}
}
$$
...
It follows from
Lemma \ref{formal-defos-lemma-power-series}
that $S \to R$ is an isomorphism.

\medskip\noindent
As $\xi$ is a pushforward of $\xi'$ along $R' \to R$ we obtain from
Remark \ref{formal-defos-remark-formal-objects-yoneda-map}
a commutative diagram
$$
\begin{array}{ccc}\underline{R}|_{\mathcal{C}_\Lambda} \longrightarrow\underset{\underline{\xi}}{\searrow} &  & \underline{R'}|_{\mathcal{C}_\Lambda} \overset{\underline{\xi'}}{\swarrow} \\  & \mathcal{F} & \end{array}
$$
...
\begin{definition}[Minimal versal]
\label{formal-defos-definition-minimal-versal}
\source{stacks:06T4}
\href{https://stacks.math.columbia.edu/tag/06T4}{\texttt{Stacks tag 06T4}}
\group{formal-defos}
...
Section \ref{formal-defos-section-miniversal-objects-existence}.}
...
\begin{lemma}[Minimal versal]
\label{formal-defos-lemma-minimal-versal}
\source{stacks:06T5}
\href{https://stacks.math.columbia.edu/tag/06T5}{\texttt{Stacks tag 06T5}}
\group{formal-defos}
...
Lemma \ref{formal-defos-lemma-versal-object-S1}.
Let $\xi' \to \xi$ over $R' \subset R$ be any of the morphisms constructed in
Lemma \ref{formal-defos-lemma-smallest-where-descends-versal}.
By
Lemma \ref{formal-defos-lemma-descends-versal}
...
Lemma \ref{formal-defos-lemma-completion-cofibred}). This proves (2) and
...
\begin{lemma}[Miniversal object unique]
\label{formal-defos-lemma-miniversal-object-unique}
\source{stacks:06IR}
\href{https://stacks.math.columbia.edu/tag/06IR}{\texttt{Stacks tag 06IR}}
\group{formal-defos}
...
\begin{lemma}[Miniversal object existence 1]
\label{formal-defos-lemma-miniversal-object-existence-1}
\source{stacks:06IV}
\href{https://stacks.math.columbia.edu/tag/06IV}{\texttt{Stacks tag 06IV}}
\group{formal-defos}
...
$$
\begin{array}{cc}\xi \overset{b'}{\longrightarrow}\underset{b}{\downarrow} & y' \overset{a'}{\downarrow} \\ y \overset{a}{\longrightarrow} & x\end{array}
$$
...
\begin{example}[Do not get S2]
\label{formal-defos-example-do-not-get-S2}
\source{stacks:06T7}
\href{https://stacks.math.columbia.edu/tag/06T7}{\texttt{Stacks tag 06T7}}
\group{formal-defos}
...
\begin{lemma}[Construct bijective orbits]
\label{formal-defos-lemma-construct-bijective-orbits}
\source{stacks:06T8}
\href{https://stacks.math.columbia.edu/tag/06T8}{\texttt{Stacks tag 06T8}}
\group{formal-defos}
...
is linear (see
Lemma \ref{formal-defos-lemma-k-linear-differential}),
and that the action of $\text{Der}_\Lambda(k, k)$ is
given by addition (see
Lemma \ref{formal-defos-lemma-action-linear}).
Consider the diagram
$$
\begin{array}{ccc} & \Hom_k(\mathfrak m_R/\mathfrak m_R^2, k) &  \\ K \longrightarrow & \text{Der}_\Lambda(R, k) \overset{d\underline{\xi}}{\longrightarrow}\uparrow & T\mathcal{F} \\  & \text{Der}_\Lambda(k, k) \uparrow\nearrow & \end{array}
$$
...
$$
\vcenter{
\begin{array}{cc}y \longrightarrow\downarrow & x_\epsilon \downarrow \\ x \longrightarrow & x_0\end{array}
}
\quad\text{lying over}\quad
\vcenter{
\begin{array}{cc}R'/\mathfrak m_R^2 \times_k k[\epsilon] \longrightarrow\downarrow & k[\epsilon] \downarrow \\ R'/\mathfrak m_R^2 \longrightarrow & k.\end{array}
}
$$
...
\begin{theorem}[Miniversal object existence]
\label{formal-defos-theorem-miniversal-object-existence}
\source{stacks:06IX}
\href{https://stacks.math.columbia.edu/tag/06IX}{\texttt{Stacks tag 06IX}}
\group{formal-defos}
...
\begin{proof}
Lemma \ref{formal-defos-lemma-miniversal-object-existence-1}
shows that (1) $\Rightarrow$ (3).
Lemmas \ref{formal-defos-lemma-versal-object-existence} and
...
\begin{remark}[Compare schlessinger H3]
\label{formal-defos-remark-compare-schlessinger-H3}
\source{stacks:06IY}
\href{https://stacks.math.columbia.edu/tag/06IY}{\texttt{Stacks tag 06IY}}
\group{formal-defos}
...
Remark \ref{formal-defos-remark-compare-schlessinger-H3-pre}.
...
Thus Theorem \ref{formal-defos-theorem-miniversal-object-existence} tells us
$$
(H1) + (H2) + (H3)
\Rightarrow
...
\begin{remark}[Compose minimal into iso classes]
\label{formal-defos-remark-compose-minimal-into-iso-classes}
\source{stacks:06IZ}
\href{https://stacks.math.columbia.edu/tag/06IZ}{\texttt{Stacks tag 06IZ}}
\group{formal-defos}

Let $\mathcal{F}$ be a predeformation category. Recall that
$\mathcal{F} \to \overline{\mathcal{F}}$ is smooth, see
Remark \ref{formal-defos-remark-smooth-to-iso-classes}. Hence if
...
$$
is smooth (Lemma \ref{formal-defos-lemma-smooth-properties}) and we conclude
...
Remark \ref{formal-defos-remark-compare-schlessinger-H3}.
By Theorem \ref{formal-defos-theorem-miniversal-object-existence}
...
\begin{example}[Smooth continued]
\label{formal-defos-example-smooth-continued}
\source{stacks:06T9}
\href{https://stacks.math.columbia.edu/tag/06T9}{\texttt{Stacks tag 06T9}}
\group{formal-defos}

In Lemma \ref{formal-defos-lemma-exists-smooth} we constructed objects
...
Lemma \ref{formal-defos-lemma-smooth} shows that
...
in Lemma \ref{formal-defos-lemma-exists-smooth} carries a minimal versal object.
...
There is a very natural property of categories cofibred in groupoids
...
\source{stacks:06J2}
\href{https://stacks.math.columbia.edu/tag/06J2}{\texttt{Stacks tag 06J2}}
\group{formal-defos}
...
$$
\vcenter{
\begin{array}{cc}x_1 \times_x x_2 \longrightarrow\downarrow & x_2 \downarrow \\ x_1 \longrightarrow & x\end{array}
}
...
\begin{lemma}[RS fiber square]
\label{formal-defos-lemma-RS-fiber-square}
\source{stacks:06J3}
\href{https://stacks.math.columbia.edu/tag/06J3}{\texttt{Stacks tag 06J3}}
\group{formal-defos}
...
\begin{lemma}[RS small extension]
\label{formal-defos-lemma-RS-small-extension}
\source{stacks:06J4}
\href{https://stacks.math.columbia.edu/tag/06J4}{\texttt{Stacks tag 06J4}}
\group{formal-defos}

Let $\mathcal{F}$ be a category cofibered in groupoids over $\mathcal
C_\Lambda$. Then $\mathcal{F}$ satisfies (RS) if the condition in
Definition \ref{formal-defos-definition-RS} is assumed to hold only when $A_2 \to A$
is a small extension.
\end{lemma}

\begin{proof}
Apply Lemma \ref{formal-defos-lemma-factor-small-extension}.  The proof is similar to that
of Lemma \ref{formal-defos-lemma-smoothness-small-extensions}.
\end{proof}

\begin{lemma}[RS 2 categorical]
\label{formal-defos-lemma-RS-2-categorical}
\source{stacks:06J5}
\href{https://stacks.math.columbia.edu/tag/06J5}{\texttt{Stacks tag 06J5}}
\group{formal-defos}
...
\begin{proof}
Assume (1). By
Lemma \ref{formal-defos-lemma-RS-fiber-square}
...
Hence (RS) holds by
Lemma \ref{formal-defos-lemma-RS-small-extension}.
\end{proof}

\begin{remark}[Compare schlessinger H4]
\label{formal-defos-remark-compare-schlessinger-H4}
\source{stacks:06J6}
\href{https://stacks.math.columbia.edu/tag/06J6}{\texttt{Stacks tag 06J6}}
\group{formal-defos}
...
\begin{lemma}[RS implies S1 S2]
\label{formal-defos-lemma-RS-implies-S1-S2}
\source{stacks:06J7}
\href{https://stacks.math.columbia.edu/tag/06J7}{\texttt{Stacks tag 06J7}}
\group{formal-defos}
...
Definition \ref{formal-defos-definition-S1-S2}. (In fact the morphism
$y \to y'$ is compatible with both $a, a'$ and $c, c'$!)
\end{proof}

The following lemma is the analogue of
Lemma \ref{formal-defos-lemma-S1-S2-associated-functor}.
...
\begin{lemma}[RS associated functor]
\label{formal-defos-lemma-RS-associated-functor}
\source{stacks:06J8}
\href{https://stacks.math.columbia.edu/tag/06J8}{\texttt{Stacks tag 06J8}}
\group{formal-defos}
...
Remark \ref{formal-defos-remark-compare-schlessinger-H4}
...
$$
\begin{array}{cc}x \underset{a}{\longrightarrow}\underset{f_*b_1}{\downarrow} & x \overset{f_*b_2}{\downarrow} \\ x \overset{\text{id}}{\longrightarrow} & x\end{array}
$$
...
that the diagram
$$
\begin{array}{cc}(f_1)_*x_1 \underset{a}{\longrightarrow}\underset{(f_1)_*b_1}{\downarrow} & (f_2)_*x_2 \overset{(f_2)_*b_2}{\downarrow} \\ (f_1)_*x'_1 \overset{a'}{\longrightarrow} & (f_2)_*x'_2.\end{array}
$$
...
\begin{definition}[Deformation category]
\label{formal-defos-definition-deformation-category}
\source{stacks:06J9}
\href{https://stacks.math.columbia.edu/tag/06J9}{\texttt{Stacks tag 06J9}}
\group{formal-defos}
...
\begin{remark}[Deformation functor]
\label{formal-defos-remark-deformation-functor}
\source{stacks:06JA}
\href{https://stacks.math.columbia.edu/tag/06JA}{\texttt{Stacks tag 06JA}}
\group{formal-defos}
...
Lemma \ref{formal-defos-lemma-RS-associated-functor} shows.
\end{remark}

\begin{example}[Prorepresentable deformation functor]
\label{formal-defos-example-prorepresentable-deformation-functor}
\source{stacks:06JB}
\href{https://stacks.math.columbia.edu/tag/06JB}{\texttt{Stacks tag 06JB}}
\group{formal-defos}
...
\begin{lemma}[Localize RS]
\label{formal-defos-lemma-localize-RS}
\source{stacks:06JC}
\href{https://stacks.math.columbia.edu/tag/06JC}{\texttt{Stacks tag 06JC}}
\group{formal-defos}
...
\begin{proof}
Any diagram as in
Definition \ref{formal-defos-definition-RS}
in $\mathcal{F}_{x_0}$ gives rise to a diagram in $\mathcal{F}$
...
\begin{lemma}[RS fiber product morphisms]
\label{formal-defos-lemma-RS-fiber-product-morphisms}
\source{stacks:06L4}
\href{https://stacks.math.columbia.edu/tag/06L4}{\texttt{Stacks tag 06L4}}
\group{formal-defos}

Let
$$
\begin{array}{cc}\mathcal{H} \times_\mathcal{F} \mathcal{G} \longrightarrow\downarrow & \mathcal{G} \overset{g}{\downarrow} \\ \mathcal{H} \overset{f}{\longrightarrow} & \mathcal{F}\end{array}
$$
...
$$
\vcenter{
\begin{array}{cc} & (u_2, v_2, a_2) \downarrow \\ (u_1, v_1, a_1) \longrightarrow & (u, v, a)\end{array}
}
\quad\text{lying over}\quad
\vcenter{
\begin{array}{cc} & A_2 \downarrow \\ A_1 \longrightarrow & A\end{array}
...
Lemma \ref{formal-defos-lemma-RS-fiber-square} shows
$$
\vcenter{
\begin{array}{cc}f(u_1 \times_u u_2) \longrightarrow\downarrow & f(u_2) \downarrow \\ f(u_1) \longrightarrow & f(u)\end{array}
}
\quad\text{and}\quad
\vcenter{
\begin{array}{cc}g(v_1 \times_v v_2) \longrightarrow\downarrow & g(v_2) \downarrow \\ g(v_1) \longrightarrow & g(v)\end{array}
}
$$
...
It follows that
$$
\begin{array}{cc}(u_1 \times_u u_2, v_1 \times_v v_2, a_{1} \times_a a_2) \downarrow\longrightarrow & (u_2, v_2, a_2) \downarrow \\ (u_1, v_1, a_1) \longrightarrow & (u, v, a)\end{array}
$$
...
\source{stacks:06JE}
\href{https://stacks.math.columbia.edu/tag/06JE}{\texttt{Stacks tag 06JE}}
\group{formal-defos}
...
\begin{remark}[Omit arrow]
\label{formal-defos-remark-omit-arrow}
\source{stacks:06JF}
\href{https://stacks.math.columbia.edu/tag/06JF}{\texttt{Stacks tag 06JF}}
\group{formal-defos}
...
\begin{remark}[Tangent space lifting]
\label{formal-defos-remark-tangent-space-lifting}
\source{stacks:06JG}
\href{https://stacks.math.columbia.edu/tag/06JG}{\texttt{Stacks tag 06JG}}
\group{formal-defos}
...
$\mathcal{F}_{x_0}$ (see
Lemma \ref{formal-defos-lemma-S1-S2-localize})
and by
Lemma \ref{formal-defos-lemma-tangent-space-vector-space}
we see that
$$
...
\begin{remark}[Lift bijections]
\label{formal-defos-remark-lift-bijections}
\source{stacks:06JH}
\href{https://stacks.math.columbia.edu/tag/06JH}{\texttt{Stacks tag 06JH}}
\group{formal-defos}
...
Now let
$$
\begin{array}{ccc}A_1' \times_A A_2 \longrightarrow\downarrow & A_1 \times_A A_2 \longrightarrow\downarrow & A_2
\downarrow \\ A_1' \longrightarrow & A_1 \longrightarrow & A\end{array}
$$
...
\begin{lemma}[Free transitive action]
\label{formal-defos-lemma-free-transitive-action}
\source{stacks:06JI}
\href{https://stacks.math.columbia.edu/tag/06JI}{\texttt{Stacks tag 06JI}}
\group{formal-defos}
...
\end{equation}
By Remark \ref{formal-defos-remark-lift-bijections} there is a bijection
\begin{equation}
\label{equation-two}
...
$$
\begin{array}{ccc}A' \times_k k[I] \longrightarrow\downarrow & A \times_k k[I] \longrightarrow\downarrow & k[I] \downarrow \\ A' \longrightarrow & A \longrightarrow & k.\end{array}
$$
Thus if we choose a pushforward $x \to x_0$ of $x$ along
$A \to k$, we obtain by the end of
Remark \ref{formal-defos-remark-lift-bijections}
a bijection
\begin{equation}
...
By Remark \ref{formal-defos-remark-tangent-space-lifting}
...
diagram
$$
\begin{array}{cccccc}A' \times_A A' \times_A A'
\underset{(a_1, a_2, a_3) \mapsto (g(a_1, a_2), g(a_2, a_3))}{\longrightarrow}\underset{(a_1, a_2, a_3) \mapsto g(a_1, a_3)}{\searrow} &  &  &  &  & k[I] \times_k k[I] = k[I \times I] \overset{+}{\downarrow} \\  &  &  &  &  & k[I]\end{array}
$$
The action is free and transitive because $\Phi$ is bijective.
\end{proof}

\begin{remark}[Free transitive action functorial]
\label{formal-defos-remark-free-transitive-action-functorial}
\source{stacks:06JJ}
\href{https://stacks.math.columbia.edu/tag/06JJ}{\texttt{Stacks tag 06JJ}}
\group{formal-defos}

The action of Lemma \ref{formal-defos-lemma-free-transitive-action} is functorial.
...
$$
\begin{array}{cc}\text{Lift}(x, A') \times (T\mathcal{F} \otimes_k I)
\underset{(\varphi, d\varphi \otimes \text{id}_I)}{\downarrow}\longrightarrow & \text{Lift}(x, A') \overset{\varphi}{\downarrow} \\ \text{Lift}(\varphi(x), A') \times (T\mathcal{G} \otimes_k I) \longrightarrow & \text{Lift}(\varphi(x), A')\end{array}
$$
The commutativity follows as each of the maps
(\ref{equation-two}), (\ref{equation-one}), and (\ref{equation-three})
of the proof of
Lemma \ref{formal-defos-lemma-free-transitive-action}
...
\begin{lemma}[Minimal smooth morphism functors]
\label{formal-defos-lemma-minimal-smooth-morphism-functors}
\source{stacks:06JL}
\href{https://stacks.math.columbia.edu/tag/06JL}{\texttt{Stacks tag 06JL}}
\group{formal-defos}
...
commutative diagram
$$
\begin{array}{cc}F(A') \longrightarrow\underset{F(f)}{\downarrow} & G(A') \overset{G(f)}{\downarrow} \\ F(A) \overset{\sim}{\longrightarrow} & G(A)\end{array}
$$
where the map $F(A) \to G(A)$ is a bijection.  By smoothness of $F
\to G$, $F(A') \to G(A')$ is surjective (Lemma
\ref{formal-defos-lemma-smooth-morphism-essentially-surjective}).  Thus we can check
...
Thus, by
Lemma \ref{formal-defos-lemma-free-transitive-action} and
Remark \ref{formal-defos-remark-free-transitive-action-functorial},
...
\begin{theorem}[Schlessinger prorepresentability]
\label{formal-defos-theorem-Schlessinger-prorepresentability}
\source{stacks:06JM}
\href{https://stacks.math.columbia.edu/tag/06JM}{\texttt{Stacks tag 06JM}}
\group{formal-defos}
...
Example \ref{formal-defos-example-prorepresentable-deformation-functor}.
...
Example \ref{formal-defos-example-tangent-space-map-prorepresentable-functor}
which is injective because $R \to k$ is surjective.

\medskip\noindent
Conversely, assume (a), (b), and (c) hold. By
Lemma \ref{formal-defos-lemma-RS-implies-S1-S2}
...
Lemma \ref{formal-defos-lemma-minimal-smooth-morphism-functors}.
\end{proof}
...
\begin{definition}[Relative infinitesimal auts]
\label{formal-defos-definition-relative-infinitesimal-auts}
\source{stacks:06JP}
\href{https://stacks.math.columbia.edu/tag/06JP}{\texttt{Stacks tag 06JP}}
\group{formal-defos}
...
\begin{definition}[Infinitesimal auts]
\label{formal-defos-definition-infinitesimal-auts}
\source{stacks:06JQ}
\href{https://stacks.math.columbia.edu/tag/06JQ}{\texttt{Stacks tag 06JQ}}
\group{formal-defos}
...
\begin{remark}[Choice pushforward immaterial infinitesimal aut]
\label{formal-defos-remark-choice-pushforward-immaterial-infinitesimal-aut}
\source{stacks:06JR}
\href{https://stacks.math.columbia.edu/tag/06JR}{\texttt{Stacks tag 06JR}}
\group{formal-defos}
...
\begin{remark}[Trivial aut point]
\label{formal-defos-remark-trivial-aut-point}
\source{stacks:06JS}
\href{https://stacks.math.columbia.edu/tag/06JS}{\texttt{Stacks tag 06JS}}
\group{formal-defos}
...
in Remark \ref{formal-defos-remark-tangent-space-cofibered-groupoid}.
\end{remark}
...
\begin{definition}[Automorphism functor]
\label{formal-defos-definition-automorphism-functor}
\source{stacks:06JT}
\href{https://stacks.math.columbia.edu/tag/06JT}{\texttt{Stacks tag 06JT}}
\group{formal-defos}
...
$$
\begin{array}{ccc}V' \longrightarrow &  & V \\  & U \overset{f'}{\nwarrow}\underset{f}{\nearrow} & \end{array}
$$
to the homomorphism
...
i.e.\ the category defined in Section \ref{formal-defos-section-CLambda}
...
Lemma \ref{formal-defos-lemma-RS-fiber-product-morphisms}
...
\begin{lemma}[Aut functor RS]
\label{formal-defos-lemma-Aut-functor-RS}
\source{stacks:06JU}
\href{https://stacks.math.columbia.edu/tag/06JU}{\texttt{Stacks tag 06JU}}
\group{formal-defos}
...
\begin{lemma}[Aut functor tangent space]
\label{formal-defos-lemma-Aut-functor-tangent-space}
\source{stacks:06JV}
\href{https://stacks.math.columbia.edu/tag/06JV}{\texttt{Stacks tag 06JV}}
\group{formal-defos}
...
Lemmas \ref{formal-defos-lemma-Aut-functor-RS} and \ref{formal-defos-lemma-localize-RS}
...
\ref{formal-defos-lemma-tangent-space-functor}.
...
\begin{remark}[Infaut lifting equalities]
\label{formal-defos-remark-infaut-lifting-equalities}
\source{stacks:06JW}
\href{https://stacks.math.columbia.edu/tag/06JW}{\texttt{Stacks tag 06JW}}
\group{formal-defos}
...
\begin{lemma}[Infaut vector space]
\label{formal-defos-lemma-infaut-vector-space}
\source{stacks:06JX}
\href{https://stacks.math.columbia.edu/tag/06JX}{\texttt{Stacks tag 06JX}}
\group{formal-defos}
...
Remark \ref{formal-defos-remark-infaut-lifting-equalities}
and the statement about the vector space structure follows from
Lemma \ref{formal-defos-lemma-Aut-functor-tangent-space}.
\end{proof}

\begin{lemma}[K linear infaut]
\label{formal-defos-lemma-k-linear-infaut}
\source{stacks:07W6}
\href{https://stacks.math.columbia.edu/tag/07W6}{\texttt{Stacks tag 07W6}}
\group{formal-defos}
...
\begin{lemma}[Lifted automorphisms torsor]
\label{formal-defos-lemma-lifted-automorphisms-torsor}
\source{stacks:06JY}
\href{https://stacks.math.columbia.edu/tag/06JY}{\texttt{Stacks tag 06JY}}
\group{formal-defos}
...
\begin{lemma}[Infaut trivial]
\label{formal-defos-lemma-infaut-trivial}
\source{stacks:06JZ}
\href{https://stacks.math.columbia.edu/tag/06JZ}{\texttt{Stacks tag 06JZ}}
\group{formal-defos}
...
\begin{lemma}[Infdef trivial]
\label{formal-defos-lemma-infdef-trivial}
\source{stacks:06K0}
\href{https://stacks.math.columbia.edu/tag/06K0}{\texttt{Stacks tag 06K0}}
\group{formal-defos}
...
Lemma \ref{formal-defos-lemma-infaut-trivial},
...
\begin{lemma}[Deformation categories fiber product morphisms]
\label{formal-defos-lemma-deformation-categories-fiber-product-morphisms}
\source{stacks:06L5}
\href{https://stacks.math.columbia.edu/tag/06L5}{\texttt{Stacks tag 06L5}}
\group{formal-defos}
...
\begin{proof}
Part (1) follows from Lemma \ref{formal-defos-lemma-RS-fiber-product-morphisms}
...
and similarly for $\mathcal{H}$, $\mathcal{G}$, and $\mathcal{F}$, see
Remark \ref{formal-defos-remark-trivial-aut-point}.
We apply Lemmas \ref{formal-defos-lemma-k-linear-differential} and
\ref{formal-defos-lemma-k-linear-infaut} to get all the linear maps
...
\begin{lemma}[Map fibre products smooth]
\label{formal-defos-lemma-map-fibre-products-smooth}
\source{stacks:0DYN}
\href{https://stacks.math.columbia.edu/tag/0DYN}{\texttt{Stacks tag 0DYN}}
\group{formal-defos}
...
$$
defines an injection on isomorphism classes by
Lemma \ref{formal-defos-lemma-free-transitive-action}
...
infinitesimal automorphisms and Lemma \ref{formal-defos-lemma-lifted-automorphisms-torsor}.
\end{proof}

\begin{lemma}[Easy check smooth]
\label{formal-defos-lemma-easy-check-smooth}
\source{stacks:0DYP}
\href{https://stacks.math.columbia.edu/tag/0DYP}{\texttt{Stacks tag 0DYP}}
\group{formal-defos}
...
\begin{lemma}[Map between smooth]
\label{formal-defos-lemma-map-between-smooth}
\source{stacks:0E3R}
\href{https://stacks.math.columbia.edu/tag/0E3R}{\texttt{Stacks tag 0E3R}}
\group{formal-defos}
...
Lemma \ref{formal-defos-lemma-easy-check-smooth} all we have to do is check
...
Definition \ref{formal-defos-definition-smooth-morphism}. This finishes the proof.
\end{proof}
...
\begin{definition}[Groupoid in functors]
\label{formal-defos-definition-groupoid-in-functors}
\source{stacks:06K3}
\href{https://stacks.math.columbia.edu/tag/06K3}{\texttt{Stacks tag 06K3}}
\group{formal-defos}
...
\begin{remark}[Confusion groupoids in functors]
\label{formal-defos-remark-confusion-groupoids-in-functors}
\source{stacks:06K4}
\href{https://stacks.math.columbia.edu/tag/06K4}{\texttt{Stacks tag 06K4}}
\group{formal-defos}
...
confusion (Remark \ref{formal-defos-remark-smooth-groupoid-in-functors-warning}).
\end{remark}

\begin{remark}[Identity inverse]
\label{formal-defos-remark-identity-inverse}
\source{stacks:06K5}
\href{https://stacks.math.columbia.edu/tag/06K5}{\texttt{Stacks tag 06K5}}
\group{formal-defos}
...
\source{stacks:06K6}
\href{https://stacks.math.columbia.edu/tag/06K6}{\texttt{Stacks tag 06K6}}
\group{formal-defos}
...
\begin{remark}[Reason existence coproduct]
\label{formal-defos-remark-reason-existence-coproduct}
\source{stacks:06K7}
\href{https://stacks.math.columbia.edu/tag/06K7}{\texttt{Stacks tag 06K7}}
\group{formal-defos}
...
Definition \ref{formal-defos-definition-groupoid-in-functors}. The reason for requiring
...
Lemma \ref{formal-defos-lemma-CLambdahat-pushouts}
the category $\widehat{\mathcal{C}}_\Lambda$ admits pushouts.
\end{remark}

\begin{remark}[Simplify terminology]
\label{formal-defos-remark-simplify-terminology}
\source{stacks:06K8}
\href{https://stacks.math.columbia.edu/tag/06K8}{\texttt{Stacks tag 06K8}}
\group{formal-defos}
...
\begin{definition}[Restricting groupoids in functors]
\label{formal-defos-definition-restricting-groupoids-in-functors}
\source{stacks:06K9}
\href{https://stacks.math.columbia.edu/tag/06K9}{\texttt{Stacks tag 06K9}}
\group{formal-defos}
...
\begin{remark}[Notation restriction]
\label{formal-defos-remark-notation-restriction}
\source{stacks:06KA}
\href{https://stacks.math.columbia.edu/tag/06KA}{\texttt{Stacks tag 06KA}}
\group{formal-defos}

In the situation of Definition
\ref{formal-defos-definition-restricting-groupoids-in-functors}, we often denote
...
\source{stacks:06KB}
\href{https://stacks.math.columbia.edu/tag/06KB}{\texttt{Stacks tag 06KB}}
\group{formal-defos}
...
\begin{definition}[Prorepresentable groupoid in functors]
\label{formal-defos-definition-prorepresentable-groupoid-in-functors}
\source{stacks:06KD}
\href{https://stacks.math.columbia.edu/tag/06KD}{\texttt{Stacks tag 06KD}}
\group{formal-defos}
...
Remark \ref{formal-defos-remark-completion-restriction-cofset-adjoint}
...
\begin{definition}[Completion groupoid in functors]
\label{formal-defos-definition-completion-groupoid-in-functors}
\source{stacks:06KE}
\href{https://stacks.math.columbia.edu/tag/06KE}{\texttt{Stacks tag 06KE}}
\group{formal-defos}
...
\begin{remark}[Groupoid in functors complete restrict]
\label{formal-defos-remark-groupoid-in-functors-complete-restrict}
\source{stacks:06KF}
\href{https://stacks.math.columbia.edu/tag/06KF}{\texttt{Stacks tag 06KF}}
\group{formal-defos}
...
This follows from
Remark \ref{formal-defos-remark-restrict-complete-continuous-functor}.
\end{remark}

\begin{lemma}[Groupoid in functors prorep equivalences]
\label{formal-defos-lemma-groupoid-in-functors-prorep-equivalences}
\source{stacks:06KG}
\href{https://stacks.math.columbia.edu/tag/06KG}{\texttt{Stacks tag 06KG}}
\group{formal-defos}
...
\begin{proof}
Part (1) follows from
Remark \ref{formal-defos-remark-groupoid-in-functors-complete-restrict}.
...
\begin{definition}[Smooth groupoid in functors]
\label{formal-defos-definition-smooth-groupoid-in-functors}
\source{stacks:06KI}
\href{https://stacks.math.columbia.edu/tag/06KI}{\texttt{Stacks tag 06KI}}
\group{formal-defos}
...
\begin{remark}[Smooth groupoid in functors warning]
\label{formal-defos-remark-smooth-groupoid-in-functors-warning}
\source{stacks:06KJ}
\href{https://stacks.math.columbia.edu/tag/06KJ}{\texttt{Stacks tag 06KJ}}
\group{formal-defos}
...
Definition \ref{formal-defos-definition-cofibered-groupoid-projection-smooth}.
...
see in
Lemma \ref{formal-defos-lemma-smooth-quotient-morphism}.
\end{remark}

\begin{remark}[Smooth power series prorepresentable smooth groupoid in functors]
\label{formal-defos-remark-smooth-power-series-prorepresentable-smooth-groupoid-in-functors}
\source{stacks:06KK}
\href{https://stacks.math.columbia.edu/tag/06KK}{\texttt{Stacks tag 06KK}}
\group{formal-defos}
...
\begin{lemma}[Smooth quotient morphism]
\label{formal-defos-lemma-smooth-quotient-morphism}
\source{stacks:06KL}
\href{https://stacks.math.columbia.edu/tag/06KL}{\texttt{Stacks tag 06KL}}
\group{formal-defos}
...
\begin{lemma}[Smooth RS groupoid in functors quotient]
\label{formal-defos-lemma-smooth-RS-groupoid-in-functors-quotient}
\source{stacks:06KT}
\href{https://stacks.math.columbia.edu/tag/06KT}{\texttt{Stacks tag 06KT}}
\group{formal-defos}
...
Let
$$
\begin{array}{cc} & (A_2, x_2) \overset{(f_2, a_2)}{\downarrow} \\ (A_1, x_1) \overset{(f_1, a_1)}{\longrightarrow} & (A, x)\end{array}
$$
...
$$
\begin{array}{ccc}(A_1 \times_A A_2, x_1 \times t(\widetilde{a})) \underset{(p_1, e(x_1))}{\downarrow}\underset{(p_2, i(\widetilde{a}))}{\longrightarrow} &  & (A_2, x_2) \overset{(f_2, a_2)}{\downarrow} \\ (A_1, x_1) \overset{(f_1, a_1)}{\longrightarrow} &  & (A, x)\end{array}
$$
...
$$
\begin{array}{ccc}(B, z) \underset{(g_1, b_1)}{\downarrow}\underset{(g_2, b_2)}{\longrightarrow} &  & (A_2, x_2)
\overset{(f_2, a_2)}{\downarrow} \\ (A_1, x_1) \overset{(f_1, a_1)}{\longrightarrow} &  & (A, x)\end{array}
$$
...
\begin{lemma}[Deformation groupoid quotient]
\label{formal-defos-lemma-deformation-groupoid-quotient}
\source{stacks:06KU}
\href{https://stacks.math.columbia.edu/tag/06KU}{\texttt{Stacks tag 06KU}}
\group{formal-defos}
...
Lemma \ref{formal-defos-lemma-smooth-RS-groupoid-in-functors-quotient}.
...
\source{stacks:06KX}
\href{https://stacks.math.columbia.edu/tag/06KX}{\texttt{Stacks tag 06KX}}
\group{formal-defos}
...
\begin{lemma}[Presentation construction]
\label{formal-defos-lemma-presentation-construction}
\source{stacks:06KY}
\href{https://stacks.math.columbia.edu/tag/06KY}{\texttt{Stacks tag 06KY}}
\group{formal-defos}
...
\begin{lemma}[Presentation morphism]
\label{formal-defos-lemma-presentation-morphism}
\source{stacks:06KZ}
\href{https://stacks.math.columbia.edu/tag/06KZ}{\texttt{Stacks tag 06KZ}}
\group{formal-defos}
...
Lemma \ref{formal-defos-lemma-presentation-construction}.
...
\begin{lemma}[Smooth groupoid in functors construction]
\label{formal-defos-lemma-smooth-groupoid-in-functors-construction}
\source{stacks:06L1}
\href{https://stacks.math.columbia.edu/tag/06L1}{\texttt{Stacks tag 06L1}}
\group{formal-defos}
...
Lemma \ref{formal-defos-lemma-presentation-construction}, then $(U, R, s, t, c)$
is smooth.
\item If $f : U(k) \to \mathcal{F}(k)$ is essentially surjective,
then the morphism $[f] : [U/R] \to \mathcal{F}$ of
Lemma \ref{formal-defos-lemma-presentation-morphism}
is an equivalence.
\end{enumerate}
\end{lemma}
...
$$
\begin{array}{cc}R = U \times_{f, \mathcal{F}, f} U \underset{s}{\longrightarrow}\underset{t}{\downarrow} & U
\overset{f}{\downarrow} \\ U \overset{f}{\longrightarrow} & \mathcal{F}\end{array}
$$
where $t, s$ are the first and second projections.  So $t, s$ are smooth by
Lemma \ref{formal-defos-lemma-smooth-properties}.  Hence (1) holds.
...
\begin{lemma}[Deformation functor diagonal]
\label{formal-defos-lemma-deformation-functor-diagonal}
\source{stacks:06L6}
\href{https://stacks.math.columbia.edu/tag/06L6}{\texttt{Stacks tag 06L6}}
\group{formal-defos}
...
\begin{proof}
Follows from
Lemma \ref{formal-defos-lemma-deformation-categories-fiber-product-morphisms}
and the fact that $\text{Inf}(U) = (0)$.
\end{proof}

\begin{lemma}[Prorepresentable groupoid in functors construction]
\label{formal-defos-lemma-prorepresentable-groupoid-in-functors-construction}
\source{stacks:06L7}
\href{https://stacks.math.columbia.edu/tag/06L7}{\texttt{Stacks tag 06L7}}
\group{formal-defos}
...
Lemma \ref{formal-defos-lemma-presentation-construction}. If
...
Example \ref{formal-defos-example-prorepresentable-deformation-functor}.
By
Lemma \ref{formal-defos-lemma-deformation-functor-diagonal}
...
Theorem \ref{formal-defos-theorem-Schlessinger-prorepresentability}
for the prorepresentable functor $U$. Thus $R$ is prorepresentable by
Theorem \ref{formal-defos-theorem-Schlessinger-prorepresentability}.
It follows from
Lemma \ref{formal-defos-lemma-groupoid-in-functors-prorep-equivalences}
that $(U, R, s, t, c)$ is prorepresentable.
\end{proof}

\begin{theorem}[Presentation deformation groupoid]
\label{formal-defos-theorem-presentation-deformation-groupoid}
\source{stacks:06L8}
\href{https://stacks.math.columbia.edu/tag/06L8}{\texttt{Stacks tag 06L8}}
\group{formal-defos}
...
Example \ref{formal-defos-example-prorepresentable-deformation-functor}. Thus
if $\mathcal{F}$ is equivalent to a smooth prorepresentable groupoid in
functors, then conditions (1), (2), and (3) follow from
Lemma \ref{formal-defos-lemma-deformation-groupoid-quotient} (1), (2), and (3).
...
Lemma \ref{formal-defos-lemma-smooth-groupoid-in-functors-construction}
we see that $(U, R, s, t, c)$ is a smooth groupoid in functors and that
$[U/R] \to \mathcal{F}$ is an equivalence. By
Lemma \ref{formal-defos-lemma-prorepresentable-groupoid-in-functors-construction}
...
Sections \ref{formal-defos-section-minimal-versal} and
\ref{formal-defos-section-miniversal-objects-existence}
can be used to obtain a ``minimal'' smooth prorepresentable presentation.

\begin{definition}[Minimal groupoid in functors]
\label{formal-defos-definition-minimal-groupoid-in-functors}
\source{stacks:06KM}
\href{https://stacks.math.columbia.edu/tag/06KM}{\texttt{Stacks tag 06KM}}
\group{formal-defos}
...
\begin{lemma}[Characterize minimal groupoid in functors]
\label{formal-defos-lemma-characterize-minimal-groupoid-in-functors}
\source{stacks:06KN}
\href{https://stacks.math.columbia.edu/tag/06KN}{\texttt{Stacks tag 06KN}}
\group{formal-defos}
...
\begin{lemma}[Surjective morphism prorepresentable functor]
\label{formal-defos-lemma-surjective-morphism-prorepresentable-functor}
\source{stacks:06KP}
\href{https://stacks.math.columbia.edu/tag/06KP}{\texttt{Stacks tag 06KP}}
\group{formal-defos}
...
Lemma \ref{formal-defos-lemma-derivations-surjective}.
...
\begin{lemma}[Minimal prorepresentable groupoid autoequivalence]
\label{formal-defos-lemma-minimal-prorepresentable-groupoid-autoequivalence}
\source{stacks:06KQ}
\href{https://stacks.math.columbia.edu/tag/06KQ}{\texttt{Stacks tag 06KQ}}
\group{formal-defos}
...
Definition \ref{formal-defos-definition-groupoid-in-functors}.
Denote $\phi : U \to U$ and $\psi : R \to R$ the corresponding morphisms.
Because the diagram
$$
\begin{array}{ccc} & \text{Der}_\Lambda(k, k) \underset{\gamma}{\searrow}\overset{\gamma}{\swarrow} &  \\ TU \underset{d\phi}{\longrightarrow}\downarrow &  & TU \downarrow \\ T[U/R] \overset{d\varphi}{\longrightarrow} &  & T[U/R]\end{array}
$$
is commutative, since $d\varphi$ is bijective, and since we have
the characterization of minimality in
Lemma \ref{formal-defos-lemma-characterize-minimal-groupoid-in-functors}
we conclude that $d\phi$ is injective (hence bijective by dimension reasons).
Thus $\phi : U \to U$ is an isomorphism by
Lemma \ref{formal-defos-lemma-surjective-morphism-prorepresentable-functor}.
...
\begin{lemma}[Minimal prorepresentable groupoid equivalence]
\label{formal-defos-lemma-minimal-prorepresentable-groupoid-equivalence}
\source{stacks:06KR}
\href{https://stacks.math.columbia.edu/tag/06KR}{\texttt{Stacks tag 06KR}}
\group{formal-defos}
...
Lemma \ref{formal-defos-lemma-minimal-prorepresentable-groupoid-autoequivalence},
...
\begin{lemma}[Minimal groupoid in functors construction]
\label{formal-defos-lemma-minimal-groupoid-in-functors-construction}
\source{stacks:06L2}
\href{https://stacks.math.columbia.edu/tag/06L2}{\texttt{Stacks tag 06L2}}
\group{formal-defos}
...
\begin{lemma}[Minimal presentations equivalent]
\label{formal-defos-lemma-minimal-presentations-equivalent}
\source{stacks:06L3}
\href{https://stacks.math.columbia.edu/tag/06L3}{\texttt{Stacks tag 06L3}}
\group{formal-defos}
...
\begin{proof}
Follows from
Lemma \ref{formal-defos-lemma-minimal-prorepresentable-groupoid-equivalence}
...
Definition \ref{formal-defos-definition-quotient}).
\end{proof}

In summary we have proved the following theorem.

\begin{theorem}[Minimal smooth prorepresentable presentations]
\label{formal-defos-theorem-minimal-smooth-prorepresentable-presentations}
\source{stacks:06TE}
\href{https://stacks.math.columbia.edu/tag/06TE}{\texttt{Stacks tag 06TE}}
\group{formal-defos}
...
Lemma \ref{formal-defos-lemma-minimal-groupoid-in-functors-construction}.
This proves all the implications.
The final uniqueness statement follows from
Lemma \ref{formal-defos-lemma-minimal-presentations-equivalent}.
\end{proof}
...
\source{stacks:0DQB}
\href{https://stacks.math.columbia.edu/tag/0DQB}{\texttt{Stacks tag 0DQB}}
\group{formal-defos}
...
$$
\begin{array}{cc}R \underset{h_1}{\longrightarrow}\overset{h_2}{\downarrow} & R[[t_1, \ldots, t_{r_1}]] \overset{h_2'}{\downarrow} \\ R[[t_{r_1 + 1}, \ldots, t_{r_1 + r_2}]] \overset{h_1'}{\longrightarrow} & R[[t_1, \ldots, t_{r_1 + r_2}]]\end{array}
$$
...
\begin{lemma}[Composition homotopic]
\label{formal-defos-lemma-composition-homotopic}
\source{stacks:0DQC}
\href{https://stacks.math.columbia.edu/tag/0DQC}{\texttt{Stacks tag 0DQC}}
\group{formal-defos}
...
\begin{lemma}[Versal unique up to homotopy]
\label{formal-defos-lemma-versal-unique-up-to-homotopy}
\source{stacks:0DQD}
\href{https://stacks.math.columbia.edu/tag/0DQD}{\texttt{Stacks tag 0DQD}}
\group{formal-defos}
...
\begin{proof}
By Theorem \ref{formal-defos-theorem-presentation-deformation-groupoid}
...
\begin{lemma}[Homotopic minimal prime]
\label{formal-defos-lemma-homotopic-minimal-prime}
\source{stacks:0DQE}
\href{https://stacks.math.columbia.edu/tag/0DQE}{\texttt{Stacks tag 0DQE}}
\group{formal-defos}
...
identified with $k$, see Definition \ref{formal-defos-definition-CLambda}.
...
\begin{definition}[Situation: Change of fields]
\label{formal-defos-situation-change-of-fields}
\source{stacks:07W8}
\href{https://stacks.math.columbia.edu/tag/07W8}{\texttt{Stacks tag 07W8}}
\group{formal-defos}
...
\end{align*}
(see Lemma \ref{formal-defos-lemma-length}) hence $B \times_l k$ is Artinian
...
with the construction of Remark \ref{formal-defos-remark-localize-cofibered-groupoid}.
Here are some elementary observations.

\begin{lemma}[Elementary properties change of field]
\label{formal-defos-lemma-elementary-properties-change-of-field}
\source{stacks:07WA}
\href{https://stacks.math.columbia.edu/tag/07WA}{\texttt{Stacks tag 07WA}}
\group{formal-defos}

With notation and assumptions as in Situation \ref{formal-defos-situation-change-of-fields}.
\begin{enumerate}
...
definition, see Definition \ref{formal-defos-definition-predeformation-category}.
...
$$
\begin{array}{cc} & l[\epsilon] \downarrow \\ B  \longrightarrow & l\end{array}
$$
in $\mathcal{C}_{\Lambda, l}$ as in Definition \ref{formal-defos-definition-S1-S2}.
Applying the functor (\ref{equation-comparison}) we obtain
$$
\begin{array}{cc} & k[l\epsilon] \downarrow \\ B \times_l k  \longrightarrow & k\end{array}
$$
where $l\epsilon$ denotes the finite dimensional $k$-vector space
$l\epsilon \subset l[\epsilon]$. According to Lemma \ref{formal-defos-lemma-S2-extensions}
...
Lemma \ref{formal-defos-lemma-RS-2-categorical} part (2) and the fact that
...
\begin{lemma}[Tangent space change of field]
\label{formal-defos-lemma-tangent-space-change-of-field}
\source{stacks:07WB}
\href{https://stacks.math.columbia.edu/tag/07WB}{\texttt{Stacks tag 07WB}}
\group{formal-defos}
...
\begin{proof}
By Lemma \ref{formal-defos-lemma-elementary-properties-change-of-field} we may replace
...
Lemma \ref{formal-defos-lemma-tangent-space-vector-space}. Then
$$
T\mathcal{F}_{l/k} = \mathcal{F}_{l/k}(l[\epsilon])
= \mathcal{F}(k[l\epsilon]) = T\mathcal{F} \otimes_k l
$$
the last equality by Lemma \ref{formal-defos-lemma-tangent-space-vector-space}.
...
as functors to the category of sets. By Lemma \ref{formal-defos-lemma-linear-functor}
...
\begin{lemma}[Inf aut change of field]
\label{formal-defos-lemma-inf-aut-change-of-field}
\source{stacks:07WC}
\href{https://stacks.math.columbia.edu/tag/07WC}{\texttt{Stacks tag 07WC}}
\group{formal-defos}
...
see Remark \ref{formal-defos-remark-trivial-aut-point}.
...
Lemma \ref{formal-defos-lemma-tangent-space-change-of-field}
and the fact that $\mathit{Aut}(x_0)$ satisfies (RS) by
Lemma \ref{formal-defos-lemma-Aut-functor-RS} (whence we have (S2) by
Lemma \ref{formal-defos-lemma-RS-implies-S1-S2}).
\end{proof}

\begin{lemma}[Change of fields smooth]
\label{formal-defos-lemma-change-of-fields-smooth}
\source{stacks:07WD}
\href{https://stacks.math.columbia.edu/tag/07WD}{\texttt{Stacks tag 07WD}}
\group{formal-defos}
...
\begin{lemma}[Change of field versal ring]
\label{formal-defos-lemma-change-of-field-versal-ring}
\source{stacks:0DQF}
\href{https://stacks.math.columbia.edu/tag/0DQF}{\texttt{Stacks tag 0DQF}}
\group{formal-defos}
...
(Compare with the proof Lemma \ref{formal-defos-lemma-exists-smooth}.)

\medskip\noindent
Since $\xi$ is versal, the transformation
$\underline{\xi} : \underline{R}|_{\mathcal{C}_{\Lambda, k}} \to \mathcal{F}$
is smooth. By Lemma \ref{formal-defos-lemma-change-of-fields-smooth} the induced map
$$
...
$$
\begin{array}{ccc}S \longrightarrow & B \xlongequal{} & B \\ R \uparrow\longrightarrow & B' \times_l k \uparrow\longrightarrow & B' \uparrow\end{array}
$$
