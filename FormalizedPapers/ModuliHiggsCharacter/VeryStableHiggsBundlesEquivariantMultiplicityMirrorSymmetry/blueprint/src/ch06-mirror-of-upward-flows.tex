...
\begin{remark}
\label{src-very-stable-higgs-bundles-equivariant-multiplicity-mirror-symmetry-ch06-mirror-of-upward-flows-statement-2}
\source{very-stable-higgs-bundles-equivariant-multiplicity-mirror-symmetry}
...
\end{remark}
% \begin{remark}
 The other identity \eqref{skewdual} from \cite{mukai} shows that a self-dual coherent sheaf $\calF$, i.e. $\calF^\vee\cong \calF$ on an Abelian variety is mapped to a skew self-dual coherent sheaf i.e.  $(-1)^*S(\calF)^\vee=S(\calF)$.
...
\begin{remark}
\label{src-very-stable-higgs-bundles-equivariant-multiplicity-mirror-symmetry-ch06-mirror-of-upward-flows-statement-4}
\source{very-stable-higgs-bundles-equivariant-multiplicity-mirror-symmetry}
...
\begin{remark}
\label{src-very-stable-higgs-bundles-equivariant-multiplicity-mirror-symmetry-ch06-mirror-of-upward-flows-statement-5}
\source{very-stable-higgs-bundles-equivariant-multiplicity-mirror-symmetry}
