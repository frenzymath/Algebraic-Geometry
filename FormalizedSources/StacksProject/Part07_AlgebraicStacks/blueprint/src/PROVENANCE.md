...
The part-local Lean package `StacksPart07Lib/` is a port of the corresponding Horizon
`FormalizedSources/StacksProject/Part07_AlgebraicStacks` library. Lake metadata lives
