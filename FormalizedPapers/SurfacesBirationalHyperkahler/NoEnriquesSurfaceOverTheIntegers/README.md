...
Blueprint project under `FormalizedPapers/SurfacesBirationalHyperkahler/NoEnriquesSurfaceOverTheIntegers`.

- Blueprint: [`blueprint/src/content.tex`](blueprint/src/content.tex)
- Direct PDF: [arXiv PDF](https://arxiv.org/pdf/2004.07025)
