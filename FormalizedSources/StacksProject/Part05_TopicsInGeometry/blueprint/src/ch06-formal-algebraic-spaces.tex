...
\mathcal{F}(U_{i_0} \cap U_{i_1})\end{array}
$$
...
Remark \ref{formal-spaces-remark-sheafification-of-presheaves-in-top}.
...
\source{stacks:0AI1}
\href{https://stacks.math.columbia.edu/tag/0AI1}{\texttt{Stacks tag 0AI1}}
\group{formal-spaces}
...
such that
$$
\begin{array}{cc}h_{\mathfrak U_i} \underset{\varphi_i}{\longrightarrow}\downarrow & h_{\mathfrak V_j} \downarrow \\ h_{\mathfrak X} \overset{\varphi}{\longrightarrow} & h_\mathfrak Y\end{array}
$$
...
\begin{lemma}[Formal schemes are fpqc sheaves]
\label{formal-spaces-lemma-formal-scheme-sheaf-fppf}
\source{stacks:0AI2}
\href{https://stacks.math.columbia.edu/tag/0AI2}{\texttt{Stacks tag 0AI2}}
\group{formal-spaces}


Let $\mathfrak X$ be a formal scheme. The functor of points
$h_\mathfrak X$ (see Lemma \ref{formal-spaces-lemma-fully-faithful})
...
We observed in the proof of Lemma \ref{formal-spaces-lemma-fully-faithful}
...
\source{stacks:0AI3}
\href{https://stacks.math.columbia.edu/tag/0AI3}{\texttt{Stacks tag 0AI3}}
\group{formal-spaces}
...
on this notion. The analogues of Lemmas \ref{formal-spaces-lemma-fully-faithful} and
...
\source{stacks:0AI4}
\href{https://stacks.math.columbia.edu/tag/0AI4}{\texttt{Stacks tag 0AI4}}
\group{formal-spaces}
...
Remark \ref{formal-spaces-remark-set-theoretic}).
...
\begin{example}[What does it mean]
\label{formal-spaces-example-what-does-it-mean}
\source{stacks:0AMR}
\href{https://stacks.math.columbia.edu/tag/0AMR}{\texttt{Stacks tag 0AMR}}
\group{formal-spaces}
...
\source{stacks:0AMS}
\href{https://stacks.math.columbia.edu/tag/0AMS}{\texttt{Stacks tag 0AMS}}
\group{formal-spaces}
...
\source{stacks:0ARZ}
\href{https://stacks.math.columbia.edu/tag/0ARZ}{\texttt{Stacks tag 0ARZ}}
\group{formal-spaces}
...
\begin{lemma}[Quotient by closed]
\label{formal-spaces-lemma-quotient-by-closed}
\source{stacks:0AMT}
\href{https://stacks.math.columbia.edu/tag/0AMT}{\texttt{Stacks tag 0AMT}}
\group{formal-spaces}
...
is $N$ (see Lemma \ref{formal-spaces-lemma-closed}). Finally, $M \to M/N$
...
\source{stacks:0AS0}
\href{https://stacks.math.columbia.edu/tag/0AS0}{\texttt{Stacks tag 0AS0}}
\group{formal-spaces}
...
and statement (2) by Lemma \ref{formal-spaces-lemma-closure}.
...
Lemma \ref{formal-spaces-lemma-quotient-by-closed}.
...
\begin{lemma}[Completion adic star]
\label{formal-spaces-lemma-completion-adic-star}
\source{stacks:0F1S}
\href{https://stacks.math.columbia.edu/tag/0F1S}{\texttt{Stacks tag 0F1S}}
\group{formal-spaces}
...
By Lemma \ref{formal-spaces-lemma-ses} applied to this surjection and to the
...
\begin{definition}[Toplogy tensor product]
\label{formal-spaces-definition-toplogy-tensor-product}
\source{stacks:0AMU}
\href{https://stacks.math.columbia.edu/tag/0AMU}{\texttt{Stacks tag 0AMU}}
\group{formal-spaces}
...
\medskip\noindent
We record here the notions introduced in Remark \ref{formal-spaces-remark-mcquillan}.

\begin{definition}[Weakly admissible]
\label{formal-spaces-definition-weakly-admissible}
\source{stacks:0AMV}
\href{https://stacks.math.columbia.edu/tag/0AMV}{\texttt{Stacks tag 0AMV}}
\group{formal-spaces}
...
\begin{lemma}[Weakly admissible henselian]
\label{formal-spaces-lemma-weakly-admissible-henselian}
\source{stacks:0DCZ}
\href{https://stacks.math.columbia.edu/tag/0DCZ}{\texttt{Stacks tag 0DCZ}}
\group{formal-spaces}
...
\begin{lemma}[Topologically nilpotent]
\label{formal-spaces-lemma-topologically-nilpotent}
\source{stacks:0AMW}
\href{https://stacks.math.columbia.edu/tag/0AMW}{\texttt{Stacks tag 0AMW}}
\group{formal-spaces}
...
by Lemma \ref{formal-spaces-lemma-closed}. Hence $g = f + h$
...
\begin{lemma}[Closure image ideal]
\label{formal-spaces-lemma-closure-image-ideal}
\source{stacks:0AMZ}
\href{https://stacks.math.columbia.edu/tag/0AMZ}{\texttt{Stacks tag 0AMZ}}
\group{formal-spaces}
...
The closure of $IB$ is $\bigcap (IB + J_\lambda)$ by Lemma \ref{formal-spaces-lemma-closed}.
...
Example \ref{formal-spaces-example-what-does-it-mean}. Hence the limit
can be written as $\lim B/(J_\lambda + IB)$ and the result is clear.
\end{proof}

\begin{lemma}[Completed tensor product]
\label{formal-spaces-lemma-completed-tensor-product}
\source{stacks:0GB4}
\href{https://stacks.math.columbia.edu/tag/0GB4}{\texttt{Stacks tag 0GB4}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-topologically-nilpotent}. Hence
...
\begin{definition}[Taut]
\label{formal-spaces-definition-taut}
\source{stacks:0AMX}
\href{https://stacks.math.columbia.edu/tag/0AMX}{\texttt{Stacks tag 0AMX}}
\group{formal-spaces}
...
\begin{lemma}[Taut weakly admissible]
\label{formal-spaces-lemma-taut-weakly-admissible}
\source{stacks:0AMY}
\href{https://stacks.math.columbia.edu/tag/0AMY}{\texttt{Stacks tag 0AMY}}
\group{formal-spaces}
...
\begin{proof}
The remarks following Definition \ref{formal-spaces-definition-taut} show that
...
nilpotent elements by Lemma \ref{formal-spaces-lemma-topologically-nilpotent}.
...
\begin{lemma}[Completion taut]
\label{formal-spaces-lemma-completion-taut}
\source{stacks:0GX2}
\href{https://stacks.math.columbia.edu/tag/0GX2}{\texttt{Stacks tag 0GX2}}
\group{formal-spaces}
...
(compare with Lemma \ref{formal-spaces-lemma-closure-image-ideal}) we conclude.
\end{proof}

\begin{lemma}[Composition taut]
\label{formal-spaces-lemma-composition-taut}
\source{stacks:0GX3}
\href{https://stacks.math.columbia.edu/tag/0GX3}{\texttt{Stacks tag 0GX3}}
\group{formal-spaces}
...
\begin{lemma}[Permanence taut]
\label{formal-spaces-lemma-permanence-taut}
\source{stacks:0GX4}
\href{https://stacks.math.columbia.edu/tag/0GX4}{\texttt{Stacks tag 0GX4}}
\group{formal-spaces}
...
\begin{lemma}[Base change taut]
\label{formal-spaces-lemma-base-change-taut}
\source{stacks:0GX5}
\href{https://stacks.math.columbia.edu/tag/0GX5}{\texttt{Stacks tag 0GX5}}
\group{formal-spaces}
...
\begin{lemma}[Taut ascent countable]
\label{formal-spaces-lemma-taut-ascent-countable}
\source{stacks:0GX6}
\href{https://stacks.math.columbia.edu/tag/0GX6}{\texttt{Stacks tag 0GX6}}
\group{formal-spaces}
...
\begin{lemma}[Taut ascent weakly admissible]
\label{formal-spaces-lemma-taut-ascent-weakly-admissible}
\source{stacks:0GX7}
\href{https://stacks.math.columbia.edu/tag/0GX7}{\texttt{Stacks tag 0GX7}}
\group{formal-spaces}
...
by Lemma \ref{formal-spaces-lemma-topologically-nilpotent}. Hence $J$ is a weak
ideal of definition of $B$.
\end{proof}

\begin{lemma}[Taut ascent admissible]
\label{formal-spaces-lemma-taut-ascent-admissible}
\source{stacks:0GX8}
\href{https://stacks.math.columbia.edu/tag/0GX8}{\texttt{Stacks tag 0GX8}}
\group{formal-spaces}
...
\begin{lemma}[Dense image surjective]
\label{formal-spaces-lemma-dense-image-surjective}
\source{stacks:0APT}
\href{https://stacks.math.columbia.edu/tag/0APT}{\texttt{Stacks tag 0APT}}
\group{formal-spaces}
...
\begin{definition}[Adic homomorphism]
\label{formal-spaces-definition-adic-homomorphism}
\source{stacks:0GBR}
\href{https://stacks.math.columbia.edu/tag/0GBR}{\texttt{Stacks tag 0GBR}}
\group{formal-spaces}
...
\begin{lemma}[Composition adic]
\label{formal-spaces-lemma-composition-adic}
\source{stacks:0GXA}
\href{https://stacks.math.columbia.edu/tag/0GXA}{\texttt{Stacks tag 0GXA}}
\group{formal-spaces}
...
\begin{lemma}[Permanence adic]
\label{formal-spaces-lemma-permanence-adic}
\source{stacks:0GXB}
\href{https://stacks.math.columbia.edu/tag/0GXB}{\texttt{Stacks tag 0GXB}}
\group{formal-spaces}
...
\begin{lemma}[Adic taut]
\label{formal-spaces-lemma-adic-taut}
\source{stacks:0GXC}
\href{https://stacks.math.columbia.edu/tag/0GXC}{\texttt{Stacks tag 0GXC}}
\group{formal-spaces}
...
See also Section \ref{formal-spaces-section-adic}.

\begin{lemma}[Taut is adic]
\label{formal-spaces-lemma-taut-is-adic}
\source{stacks:0APU}
\href{https://stacks.math.columbia.edu/tag/0APU}{\texttt{Stacks tag 0APU}}
\group{formal-spaces}
...
By Lemma \ref{formal-spaces-lemma-dense-image-surjective} we see that $B' \to B$ is open
...
\begin{definition}[Weakly adic]
\label{formal-spaces-definition-weakly-adic}
\source{stacks:0GXE}
\href{https://stacks.math.columbia.edu/tag/0GXE}{\texttt{Stacks tag 0GXE}}
\group{formal-spaces}
...
$$
\begin{array}{cc}\text{adic + Noetherian} \downarrow &  \\ \text{adic + finitely generated ideal of definition} \downarrow &  \\ \text{adic} \downarrow &  \\ \text{weakly adic} \downarrow &  \\ \text{admissible + first countable} \downarrow\Longrightarrow & \text{admissible} \downarrow \\ \text{weakly admissible + first countable} \Longrightarrow & \text{weakly admissible}\end{array}
$$
...
\begin{lemma}[Weakly adic]
\label{formal-spaces-lemma-weakly-adic}
\source{stacks:0GXF}
\href{https://stacks.math.columbia.edu/tag/0GXF}{\texttt{Stacks tag 0GXF}}
\group{formal-spaces}
...
Definition \ref{formal-spaces-definition-weakly-adic} and we see that (1) holds.
...
By Lemmas \ref{formal-spaces-lemma-completion-taut} and
...
\begin{lemma}[Weakly adic finite generation bis]
\label{formal-spaces-lemma-weakly-adic-finite-generation-bis}
\source{stacks:0GXG}
\href{https://stacks.math.columbia.edu/tag/0GXG}{\texttt{Stacks tag 0GXG}}
\group{formal-spaces}
...
We conclude by Lemma \ref{formal-spaces-lemma-taut-is-adic} (to be sure, this
lemma also tells us that $I$ is an ideal of definition).
\end{proof}

\begin{lemma}[Weakly adic finite generation]
\label{formal-spaces-lemma-weakly-adic-finite-generation}
\source{stacks:0GXH}
\href{https://stacks.math.columbia.edu/tag/0GXH}{\texttt{Stacks tag 0GXH}}
\group{formal-spaces}
...
\begin{proof}
We use the characterization of Lemma \ref{formal-spaces-lemma-weakly-adic}
...
We conclude by Lemma \ref{formal-spaces-lemma-weakly-adic-finite-generation-bis}.
\end{proof}
...
\begin{lemma}[Taut ascent weakly adic]
\label{formal-spaces-lemma-taut-ascent-weakly-adic}
\source{stacks:0GXI}
\href{https://stacks.math.columbia.edu/tag/0GXI}{\texttt{Stacks tag 0GXI}}
\group{formal-spaces}
...
\begin{lemma}[Completed tensor product weakly adic]
\label{formal-spaces-lemma-completed-tensor-product-weakly-adic}
\source{stacks:0GXJ}
\href{https://stacks.math.columbia.edu/tag/0GXJ}{\texttt{Stacks tag 0GXJ}}
\group{formal-spaces}
...
\begin{proof}
We will use the characterization of Lemma \ref{formal-spaces-lemma-weakly-adic}
without further mention. By Lemma \ref{formal-spaces-lemma-completed-tensor-product}
...
\begin{lemma}[Taut descent countable]
\label{formal-spaces-lemma-taut-descent-countable}
\source{stacks:0GXL}
\href{https://stacks.math.columbia.edu/tag/0GXL}{\texttt{Stacks tag 0GXL}}
\group{formal-spaces}
...
\begin{lemma}[Taut descent weakly admissible]
\label{formal-spaces-lemma-taut-descent-weakly-admissible}
\source{stacks:0GXM}
\href{https://stacks.math.columbia.edu/tag/0GXM}{\texttt{Stacks tag 0GXM}}
\group{formal-spaces}
...
$\varphi(f) \in J$, the ideal $J$ is a weak ideal of definition of $B$,
and $J'$ is open in $B$.
\end{proof}

\begin{lemma}[Taut descent admissible]
\label{formal-spaces-lemma-taut-descent-admissible}
\source{stacks:0GXN}
\href{https://stacks.math.columbia.edu/tag/0GXN}{\texttt{Stacks tag 0GXN}}
\group{formal-spaces}
...
$\varphi(I) \subset J$, the ideal $J$ is an ideal of definition of $B$,
and $J'$ is open in $B$.
\end{proof}

\begin{lemma}[Taut descent weakly adic]
\label{formal-spaces-lemma-taut-descent-weakly-adic}
\source{stacks:0GXP}
\href{https://stacks.math.columbia.edu/tag/0GXP}{\texttt{Stacks tag 0GXP}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-weakly-adic} without further mention.
By Lemma \ref{formal-spaces-lemma-taut-descent-admissible}
...
Lemma \ref{formal-spaces-lemma-closed}.
...
\begin{lemma}[Taut descent adic star]
\label{formal-spaces-lemma-taut-descent-adic-star}
\source{stacks:0GXQ}
\href{https://stacks.math.columbia.edu/tag/0GXQ}{\texttt{Stacks tag 0GXQ}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-taut-descent-weakly-adic}
(and Lemma \ref{formal-spaces-lemma-weakly-adic} to see that adic rings are weakly adic).
Let $I \subset A$ be an ideal of definition.
...
of definition contained in the closure of $IB$. By Lemma \ref{formal-spaces-lemma-closed}
...
By Lemma \ref{formal-spaces-lemma-weakly-admissible-henselian} (for example)
...
\begin{definition}[Affine formal algebraic space]
\label{formal-spaces-definition-affine-formal-algebraic-space}
\source{stacks:0AI7}
\href{https://stacks.math.columbia.edu/tag/0AI7}{\texttt{Stacks tag 0AI7}}
\group{formal-spaces}
...
(see Remark \ref{formal-spaces-remark-set-theoretic}). A
...
\begin{lemma}[Diagonal affine formal algebraic space]
\label{formal-spaces-lemma-diagonal-affine-formal-algebraic-space}
\source{stacks:0AI8}
\href{https://stacks.math.columbia.edu/tag/0AI8}{\texttt{Stacks tag 0AI8}}
\group{formal-spaces}
...
as in Definition \ref{formal-spaces-definition-affine-formal-algebraic-space}.
...
\begin{lemma}[Covering by thickenings]
\label{formal-spaces-lemma-covering-by-thickenings}
\source{stacks:0AI9}
\href{https://stacks.math.columbia.edu/tag/0AI9}{\texttt{Stacks tag 0AI9}}
\group{formal-spaces}

Let $X_\lambda, \lambda \in \Lambda$ and $X = \colim X_\lambda$
be as in Definition \ref{formal-spaces-definition-affine-formal-algebraic-space}.
...
By Lemma \ref{formal-spaces-lemma-diagonal-affine-formal-algebraic-space}
the morphisms $X_\lambda \to X$ are representable.
Given $U \to X$ where $U$ is a scheme,
then the discussion following
Definition \ref{formal-spaces-definition-affine-formal-algebraic-space}
...
\begin{lemma}[Factor through thickening]
\label{formal-spaces-lemma-factor-through-thickening}
\source{stacks:0AIA}
\href{https://stacks.math.columbia.edu/tag/0AIA}{\texttt{Stacks tag 0AIA}}
\group{formal-spaces}
...
\begin{lemma}[Characterize affine formal algebraic space]
\label{formal-spaces-lemma-characterize-affine-formal-algebraic-space}
\source{stacks:0AIB}
\href{https://stacks.math.columbia.edu/tag/0AIB}{\texttt{Stacks tag 0AIB}}
\group{formal-spaces}
...
\item a set theoretic condition as in Remark \ref{formal-spaces-remark-set-theoretic}.
\end{enumerate}
\end{lemma}

\begin{proof}
It follows from Lemmas \ref{formal-spaces-lemma-covering-by-thickenings} and
\ref{formal-spaces-lemma-factor-through-thickening} that an affine formal algebraic space
...
\begin{lemma}[Mcquillan affine formal algebraic space]
\label{formal-spaces-lemma-mcquillan-affine-formal-algebraic-space}
\source{stacks:0AIC}
\href{https://stacks.math.columbia.edu/tag/0AIC}{\texttt{Stacks tag 0AIC}}
\group{formal-spaces}
...
(see Remark \ref{formal-spaces-remark-mcquillan}) such that
...
Lemma \ref{formal-spaces-lemma-diagonal-affine-formal-algebraic-space}).
...
by Lemma \ref{formal-spaces-lemma-factor-through-thickening}.
...
$\Spec(A/I) \to X$, see Lemma \ref{formal-spaces-lemma-factor-through-thickening}.
...
\begin{definition}[Types affine formal algebraic space]
\label{formal-spaces-definition-types-affine-formal-algebraic-space}
\source{stacks:0AID}
\href{https://stacks.math.columbia.edu/tag/0AID}{\texttt{Stacks tag 0AID}}
\group{formal-spaces}
...
of Lemma \ref{formal-spaces-lemma-mcquillan-affine-formal-algebraic-space}. Let $A$
...
(Definition \ref{formal-spaces-definition-weakly-adic}),
...
$$
\begin{array}{ccc}X\text{ Noetherian} \Longrightarrow & X\text{ adic*} \Longrightarrow & X\text{ adic} \swarrow \\ X\text{ weakly adic} \Longrightarrow & X\text{ classical} \Longrightarrow & X\text{ McQuillan}\end{array}
$$
See discussion in Section \ref{formal-spaces-section-weakly-adic} and for a precise statement
see Lemma \ref{formal-spaces-lemma-implications-between-types}.

\begin{remark}[Compare with affine formal schemes]
\label{formal-spaces-remark-compare-with-affine-formal-schemes}
\source{stacks:0AIE}
\href{https://stacks.math.columbia.edu/tag/0AIE}{\texttt{Stacks tag 0AIE}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-fully-faithful}.
...
Lemma \ref{formal-spaces-lemma-formal-scheme-sheaf-fppf}.
Thus $h_\mathfrak X$ is an affine formal algebraic space.
In fact, it is a classical affine formal algebraic space
by Definition \ref{formal-spaces-definition-types-affine-formal-algebraic-space}.
Thus Lemma \ref{formal-spaces-lemma-fully-faithful} tells us
...
\begin{definition}[Affine formal spectrum]
\label{formal-spaces-definition-affine-formal-spectrum}
\source{stacks:0AIF}
\href{https://stacks.math.columbia.edu/tag/0AIF}{\texttt{Stacks tag 0AIF}}
\group{formal-spaces}

Let $S$ be a scheme. Let $A$ be a weakly admissible topological ring over
$S$, see Definition \ref{formal-spaces-definition-weakly-admissible}\footnote{See
More on Algebra, Definition
\ref{more-algebra-definition-topological-ring}
for the classical case and see Remark \ref{formal-spaces-remark-mcquillan}
...
the diagrams
$$
\begin{array}{cc}\Spec(B/J) \downarrow\longrightarrow & \Spec(A/I) \downarrow \\ \text{Spf}(B) \longrightarrow & \text{Spf}(A)\end{array}
$$
...
\begin{lemma}[Morphism between formal spectra]
\label{formal-spaces-lemma-morphism-between-formal-spectra}
\source{stacks:0AN0}
\href{https://stacks.math.columbia.edu/tag/0AN0}{\texttt{Stacks tag 0AN0}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-factor-through-thickening}
...
\begin{lemma}[Presentation representable]
\label{formal-spaces-lemma-presentation-representable}
\source{stacks:0AIG}
\href{https://stacks.math.columbia.edu/tag/0AIG}{\texttt{Stacks tag 0AIG}}
\group{formal-spaces}
...
\begin{lemma}[Countable affine formal algebraic space]
\label{formal-spaces-lemma-countable-affine-formal-algebraic-space}
\source{stacks:0AII}
\href{https://stacks.math.columbia.edu/tag/0AII}{\texttt{Stacks tag 0AII}}
\group{formal-spaces}
...
\source{stacks:0AIJ}
\href{https://stacks.math.columbia.edu/tag/0AIJ}{\texttt{Stacks tag 0AIJ}}
\group{formal-spaces}

Let $S$ be a scheme. Let $X$ be an affine formal algebraic space over $S$.
We say $X$ is {\it countably indexed} if the equivalent conditions of
Lemma \ref{formal-spaces-lemma-countable-affine-formal-algebraic-space} are satisfied.
\end{definition}

In the language of \cite{BVGD} this is expressed by saying that
$X$ is an $\aleph_0$-ind scheme.

\begin{lemma}[Implications between types]
\label{formal-spaces-lemma-implications-between-types}
\source{stacks:0AIK}
\href{https://stacks.math.columbia.edu/tag/0AIK}{\texttt{Stacks tag 0AIK}}
\group{formal-spaces}
...
types of such rings discussed in Section \ref{formal-spaces-section-weakly-adic}.
...
\begin{lemma}[Countably indexed]
\label{formal-spaces-lemma-countably-indexed}
\source{stacks:0AN1}
\href{https://stacks.math.columbia.edu/tag/0AN1}{\texttt{Stacks tag 0AN1}}
\group{formal-spaces}
...
\begin{proof}
Assume (1). By Lemma \ref{formal-spaces-lemma-implications-between-types}
we can write $X = \text{Spf}(A)$ where $A$ is a weakly admissible
topological $S$-algebra. For any presentation $X = \colim X_n$ as in
Lemma \ref{formal-spaces-lemma-countable-affine-formal-algebraic-space} part (1)
...
Lemma \ref{formal-spaces-lemma-mcquillan-affine-formal-algebraic-space}
...
\begin{lemma}[Characterize noetherian affine]
\label{formal-spaces-lemma-characterize-noetherian-affine}
\source{stacks:0AKM}
\href{https://stacks.math.columbia.edu/tag/0AKM}{\texttt{Stacks tag 0AKM}}
\group{formal-spaces}
...
By Lemma \ref{formal-spaces-lemma-mcquillan-affine-formal-algebraic-space}
...
immediate (see Lemma \ref{formal-spaces-lemma-implications-between-types}).
...
is open, see Lemma \ref{formal-spaces-lemma-weakly-adic}.
We are also given that the rings $A/I_\lambda$ are Noetherian
for some fundamental system of open ideals $I_\lambda$.
...
of definition by Lemma \ref{formal-spaces-lemma-weakly-adic-finite-generation}.
...
\begin{definition}[Formal algebraic space]
\label{formal-spaces-definition-formal-algebraic-space}
\source{stacks:0AIM}
\href{https://stacks.math.columbia.edu/tag/0AIM}{\texttt{Stacks tag 0AIM}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-presentation-representable}.
By Bootstrap, Lemma
...
\begin{lemma}[Diagonal formal algebraic space]
\label{formal-spaces-lemma-diagonal-formal-algebraic-space}
\source{stacks:0AIP}
\href{https://stacks.math.columbia.edu/tag/0AIP}{\texttt{Stacks tag 0AIP}}
\group{formal-spaces}
...
Lemmas \ref{formal-spaces-lemma-diagonal-affine-formal-algebraic-space} and
\ref{formal-spaces-lemma-presentation-representable}). These maps are jointly surjective
...
immersion (Lemma \ref{formal-spaces-lemma-diagonal-affine-formal-algebraic-space})
...
\begin{lemma}[Space to formal space]
\label{formal-spaces-lemma-space-to-formal-space}
\source{stacks:0AIQ}
\href{https://stacks.math.columbia.edu/tag/0AIQ}{\texttt{Stacks tag 0AIQ}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-diagonal-formal-algebraic-space}.
Hence the result by
Bootstrap, Theorem \ref{bootstrap-theorem-final-bootstrap}.
\end{proof}

\begin{remark}[Compare with formal schemes]
\label{formal-spaces-remark-compare-with-formal-schemes}
\source{stacks:0AIR}
\href{https://stacks.math.columbia.edu/tag/0AIR}{\texttt{Stacks tag 0AIR}}
\group{formal-spaces}

Modulo set theoretic issues the category of formal schemes \`a la EGA
(see Section \ref{formal-spaces-section-formal-schemes-EGA}) is equivalent to a full
subcategory of the category of formal algebraic spaces. To explain this
we assume our base scheme is $\Spec(\mathbf{Z})$. By
Lemma \ref{formal-spaces-lemma-formal-scheme-sheaf-fppf} the functor of points
$h_\mathfrak X$ associated to a formal scheme $\mathfrak X$ is a sheaf
in the fppf topology. By Lemma \ref{formal-spaces-lemma-fully-faithful}
...
Remark \ref{formal-spaces-remark-compare-with-affine-formal-schemes}.
The morphisms $h_{\mathfrak X_i} \to h_\mathfrak X$ are representable
and open immersions. Thus $\{h_{\mathfrak X_i} \to h_\mathfrak X\}$
is a family as in Definition \ref{formal-spaces-definition-formal-algebraic-space}
and we see that $h_\mathfrak X$ is a formal algebraic space.
\end{remark}

\begin{remark}[Set theoretic]
\label{formal-spaces-remark-set-theoretic}
\source{stacks:0AIS}
\href{https://stacks.math.columbia.edu/tag/0AIS}{\texttt{Stacks tag 0AIS}}
\group{formal-spaces}
...
Definitions \ref{formal-spaces-definition-affine-formal-algebraic-space} and
\ref{formal-spaces-definition-formal-algebraic-space} we take:
...
Definition \ref{formal-spaces-definition-affine-formal-algebraic-space}. Then
$U = \coprod_{\lambda \in \Lambda} X_\lambda \to X$ is a surjection
of fppf sheaves. Moreover, $U \times_X U$ is a closed subscheme
of $U \times_S U$ by Lemma \ref{formal-spaces-lemma-diagonal-affine-formal-algebraic-space}.
...
\begin{lemma}[Reduction formal algebraic space]
\label{formal-spaces-lemma-reduction-formal-algebraic-space}
\source{stacks:0AIN}
\href{https://stacks.math.columbia.edu/tag/0AIN}{\texttt{Stacks tag 0AIN}}
\group{formal-spaces}
...
by Lemma \ref{formal-spaces-lemma-covering-by-thickenings} and the fact that
...
morphism of schemes (by Lemma \ref{formal-spaces-lemma-presentation-representable}).
...
$$
\begin{array}{cc}\coprod X_{i, red} \longrightarrow\downarrow & \coprod X_i \downarrow \\ X_{red} \longrightarrow & X\end{array}
$$
...
\begin{example}[Reduction affine formal spectrum]
\label{formal-spaces-example-reduction-affine-formal-spectrum}
\source{stacks:0GB6}
\href{https://stacks.math.columbia.edu/tag/0GB6}{\texttt{Stacks tag 0GB6}}
\group{formal-spaces}
...
(Lemma \ref{formal-spaces-lemma-topologically-nilpotent})
which is open because $A$ is weakly admissible.
\end{example}

\begin{lemma}[Reduction smooth]
\label{formal-spaces-lemma-reduction-smooth}
\source{stacks:0GB7}
\href{https://stacks.math.columbia.edu/tag/0GB7}{\texttt{Stacks tag 0GB7}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-reduction-formal-algebraic-space}.)
...
Then the universal property of reduction shows that the canonical morphism
$X_{red} \to X \times_Y Y_{red}$ is an isomorphism.
\end{proof}

\begin{lemma}[Reduction surjective]
\label{formal-spaces-lemma-reduction-surjective}
\source{stacks:0GB8}
\href{https://stacks.math.columbia.edu/tag/0GB8}{\texttt{Stacks tag 0GB8}}
\group{formal-spaces}
...
(in Section \ref{formal-spaces-section-quasi-compact-quasi-separated})
that any quasi-compact and quasi-separated formal algebraic space
is such a global colimit.

\begin{lemma}[Colimit is formal]
\label{formal-spaces-lemma-colimit-is-formal}
\source{stacks:0AIU}
\href{https://stacks.math.columbia.edu/tag/0AIU}{\texttt{Stacks tag 0AIU}}
\group{formal-spaces}
...
$$
\begin{array}{cc}X_{i, \lambda} \longrightarrow\downarrow & X_{i, \mu} \downarrow \\ X_\lambda \longrightarrow & X_\mu\end{array}
$$
...
Lemma \ref{formal-spaces-lemma-colimit-is-formal}? To do this we look for maps
...
(Lemma \ref{formal-spaces-lemma-space-to-formal-space}) and we can use
Bootstrap, Definition \ref{bootstrap-definition-property-transformation}
as before.

\begin{example}[David hansen]
\label{formal-spaces-example-david-hansen}
\source{stacks:0CB8}
\href{https://stacks.math.columbia.edu/tag/0CB8}{\texttt{Stacks tag 0CB8}}
\group{formal-spaces}
...
\source{stacks:0AIV}
\href{https://stacks.math.columbia.edu/tag/0AIV}{\texttt{Stacks tag 0AIV}}
\group{formal-spaces}

Let $\mathfrak X$ be a formal scheme in the sense of McQuillan, see
Remark \ref{formal-spaces-remark-mcquillan}. An {\it weak ideal of definition}
...
in Lemma \ref{formal-spaces-lemma-colimit-is-formal} if and only if
...
\source{stacks:0AIW}
\href{https://stacks.math.columbia.edu/tag/0AIW}{\texttt{Stacks tag 0AIW}}
\group{formal-spaces}
...
Remark \ref{formal-spaces-remark-weak-ideals-of-definition}; an example
is given in Example \ref{formal-spaces-example-david-hansen}.
...
Remark \ref{formal-spaces-remark-weak-ideals-of-definition} we conclude that
the formal algebraic space $h_\mathfrak X$ associated to
the quasi-compact formal scheme $\mathfrak X$ \`a la EGA
is a colimit of schemes as in Lemma \ref{formal-spaces-lemma-colimit-is-formal}
...
\begin{lemma}[Completion affine is affine formal algebraic space]
\label{formal-spaces-lemma-completion-affine-is-affine-formal-algebraic-space}
\source{stacks:0AIY}
\href{https://stacks.math.columbia.edu/tag/0AIY}{\texttt{Stacks tag 0AIY}}
\group{formal-spaces}
...
(Definition \ref{formal-spaces-definition-types-affine-formal-algebraic-space})
because the maps $A \to A/J$ are surjective
and hence $A^\wedge = \lim A/J \to A/J$ is surjective, see
Lemma \ref{formal-spaces-lemma-mcquillan-affine-formal-algebraic-space}.
\end{proof}

\begin{lemma}[Completion is formal algebraic space]
\label{formal-spaces-lemma-completion-is-formal-algebraic-space}
\source{stacks:0AIZ}
\href{https://stacks.math.columbia.edu/tag/0AIZ}{\texttt{Stacks tag 0AIZ}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-completion-affine-is-affine-formal-algebraic-space}.
\end{proof}

\begin{definition}[Completion]
\label{formal-spaces-definition-completion}
\source{stacks:0AMC}
\href{https://stacks.math.columbia.edu/tag/0AMC}{\texttt{Stacks tag 0AMC}}
\group{formal-spaces}

Let $S$ be a scheme. Let $X$ be an algebraic space over $S$.
Let $T \subset |X|$ be a closed subset. The formal algebraic space
of Lemma \ref{formal-spaces-lemma-completion-is-formal-algebraic-space}
...
\begin{lemma}[Map completions representable]
\label{formal-spaces-lemma-map-completions-representable}
\source{stacks:0APV}
\href{https://stacks.math.columbia.edu/tag/0APV}{\texttt{Stacks tag 0APV}}
\group{formal-spaces}
...
Then
$$
\begin{array}{cc}X'_{/T'} \longrightarrow\downarrow & X' \overset{f}{\downarrow} \\ X_{/T} \longrightarrow & X\end{array}
$$
...
\begin{lemma}[Reduction completion]
\label{formal-spaces-lemma-reduction-completion}
\source{stacks:0GB9}
\href{https://stacks.math.columbia.edu/tag/0GB9}{\texttt{Stacks tag 0GB9}}
\group{formal-spaces}
...
\begin{proof}
It follows from Lemma \ref{formal-spaces-lemma-reduction-formal-algebraic-space},
Properties of Spaces, Definition
...
\begin{lemma}[Affine formal completion types]
\label{formal-spaces-lemma-affine-formal-completion-types}
\source{stacks:0GBA}
\href{https://stacks.math.columbia.edu/tag/0GBA}{\texttt{Stacks tag 0GBA}}
\group{formal-spaces}
...
\begin{lemma}[Completion countably indexed]
\label{formal-spaces-lemma-completion-countably-indexed}
\source{stacks:0APW}
\href{https://stacks.math.columbia.edu/tag/0APW}{\texttt{Stacks tag 0APW}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-ses}.
...
(by Lemma \ref{formal-spaces-lemma-ses}) map
...
(Lemma \ref{formal-spaces-lemma-closed}) is open we see that there exists an $m$ such that
...
\begin{lemma}[Etale covering by formal algebraic spaces]
\label{formal-spaces-lemma-etale-covering-by-formal-algebraic-spaces}
\source{stacks:0AJ1}
\href{https://stacks.math.columbia.edu/tag/0AJ1}{\texttt{Stacks tag 0AJ1}}
\group{formal-spaces}
...
as in Definition \ref{formal-spaces-definition-formal-algebraic-space}
for $X$.
\end{proof}

\begin{lemma}[Fibre products general]
\label{formal-spaces-lemma-fibre-products-general}
\source{stacks:0AJ2}
\href{https://stacks.math.columbia.edu/tag/0AJ2}{\texttt{Stacks tag 0AJ2}}
\group{formal-spaces}
...
Thus Lemma \ref{formal-spaces-lemma-etale-covering-by-formal-algebraic-spaces}
...
in Definition \ref{formal-spaces-definition-affine-formal-algebraic-space}.
...
Thus we conclude by applying Lemma \ref{formal-spaces-lemma-colimit-is-formal}.
\end{proof}

\begin{lemma}[Fibre products]
\label{formal-spaces-lemma-fibre-products}
\source{stacks:0AJ3}
\href{https://stacks.math.columbia.edu/tag/0AJ3}{\texttt{Stacks tag 0AJ3}}
\group{formal-spaces}
...
\begin{proof}
Special case of Lemma \ref{formal-spaces-lemma-fibre-products-general}
because formal algebraic spaces have representable diagonals, see
Lemma \ref{formal-spaces-lemma-diagonal-formal-algebraic-space}.
\end{proof}

\begin{lemma}[Reduction fibre products]
\label{formal-spaces-lemma-reduction-fibre-products}
\source{stacks:0CB9}
\href{https://stacks.math.columbia.edu/tag/0CB9}{\texttt{Stacks tag 0CB9}}
\group{formal-spaces}
...
in Lemma \ref{formal-spaces-lemma-reduction-formal-algebraic-space}.
\end{proof}

We have already proved the following lemma (without knowing that
fibre products exist).

\begin{lemma}[Diagonal morphism formal algebraic spaces]
\label{formal-spaces-lemma-diagonal-morphism-formal-algebraic-spaces}
\source{stacks:0AN2}
\href{https://stacks.math.columbia.edu/tag/0AN2}{\texttt{Stacks tag 0AN2}}
\group{formal-spaces}
...
\begin{lemma}[Characterize quasi separated]
\label{formal-spaces-lemma-characterize-quasi-separated}
\source{stacks:0AJ5}
\href{https://stacks.math.columbia.edu/tag/0AJ5}{\texttt{Stacks tag 0AJ5}}
\group{formal-spaces}
...
(Lemma \ref{formal-spaces-lemma-reduction-formal-algebraic-space}) is a
...
\begin{lemma}[Characterize separated]
\label{formal-spaces-lemma-characterize-separated}
\source{stacks:0AJ6}
\href{https://stacks.math.columbia.edu/tag/0AJ6}{\texttt{Stacks tag 0AJ6}}
\group{formal-spaces}
...
\begin{enumerate}
\item the reduction of $X$
(Lemma \ref{formal-spaces-lemma-reduction-formal-algebraic-space}) is a separated
algebraic space,
\item for $U \to X$, $V \to X$ with $U$, $V$ affine
...
\source{stacks:0AJ7}
\href{https://stacks.math.columbia.edu/tag/0AJ7}{\texttt{Stacks tag 0AJ7}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-characterize-quasi-separated} are satisfied.
\item $X$ is {\it separated} if the equivalent conditions of
Lemma \ref{formal-spaces-lemma-characterize-separated} are satisfied.
\end{enumerate}
\end{definition}
...
\begin{lemma}[Fibre product affines over separated]
\label{formal-spaces-lemma-fibre-product-affines-over-separated}
\source{stacks:0AN3}
\href{https://stacks.math.columbia.edu/tag/0AN3}{\texttt{Stacks tag 0AN3}}
\group{formal-spaces}
...
(see Definition \ref{formal-spaces-definition-toplogy-tensor-product}).
\end{proof}

\begin{lemma}[Separated from separated]
\label{formal-spaces-lemma-separated-from-separated}
\source{stacks:0APX}
\href{https://stacks.math.columbia.edu/tag/0APX}{\texttt{Stacks tag 0APX}}
\group{formal-spaces}
...
algebraic spaces (Lemma \ref{formal-spaces-lemma-space-to-formal-space}).
...
\begin{lemma}[Characterize quasi compact]
\label{formal-spaces-lemma-characterize-quasi-compact}
\source{stacks:0AJ9}
\href{https://stacks.math.columbia.edu/tag/0AJ9}{\texttt{Stacks tag 0AJ9}}
\group{formal-spaces}
...
\begin{enumerate}
\item the reduction of $X$
(Lemma \ref{formal-spaces-lemma-reduction-formal-algebraic-space}) is a quasi-compact
algebraic space,
\item we can find $\{X_i \to X\}_{i \in I}$ as in
Definition \ref{formal-spaces-definition-formal-algebraic-space} with $I$ finite,
...
\source{stacks:0AJA}
\href{https://stacks.math.columbia.edu/tag/0AJA}{\texttt{Stacks tag 0AJA}}
\group{formal-spaces}

Let $S$ be a scheme. Let $X$ be a formal algebraic space over $S$.
We say $X$ is {\it quasi-compact} if the equivalent conditions of
Lemma \ref{formal-spaces-lemma-characterize-quasi-compact} are satisfied.
\end{definition}

\begin{lemma}[Characterize quasi compact morphism]
\label{formal-spaces-lemma-characterize-quasi-compact-morphism}
\source{stacks:0AJB}
\href{https://stacks.math.columbia.edu/tag/0AJB}{\texttt{Stacks tag 0AJB}}
\group{formal-spaces}
...
\source{stacks:0AJC}
\href{https://stacks.math.columbia.edu/tag/0AJC}{\texttt{Stacks tag 0AJC}}
\group{formal-spaces}

Let $S$ be a scheme. Let $f : X \to Y$ be a morphism of
formal algebraic spaces over $S$.
We say $f$ is {\it quasi-compact} if the equivalent conditions of
Lemma \ref{formal-spaces-lemma-characterize-quasi-compact-morphism} are satisfied.
\end{definition}
...
\begin{lemma}[Quasi compact representable]
\label{formal-spaces-lemma-quasi-compact-representable}
\source{stacks:0AM2}
\href{https://stacks.math.columbia.edu/tag/0AM2}{\texttt{Stacks tag 0AM2}}
\group{formal-spaces}

Let $S$ be a scheme. Let $f : X \to Y$ be a morphism of formal algebraic
spaces over $S$ which is representable by algebraic spaces.
Then $f$ is quasi-compact in the sense of
Definition \ref{formal-spaces-definition-quasi-compact-morphism}
...
Lemma \ref{formal-spaces-lemma-characterize-quasi-compact-morphism}.
\end{proof}
...
\begin{lemma}[Structure quasi compact quasi separated]
\label{formal-spaces-lemma-structure-quasi-compact-quasi-separated}
\source{stacks:0AJE}
\href{https://stacks.math.columbia.edu/tag/0AJE}{\texttt{Stacks tag 0AJE}}
\group{formal-spaces}
...
\begin{proof}
By Lemma \ref{formal-spaces-lemma-characterize-quasi-compact} we may choose an
...
Lemma \ref{formal-spaces-lemma-presentation-representable}. The reduction
(Lemma \ref{formal-spaces-lemma-reduction-formal-algebraic-space})
...
through $Y_\mu$, see Lemma \ref{formal-spaces-lemma-factor-through-thickening}.
...
$$
\begin{array}{cc}Z_\lambda \longrightarrow\downarrow & Y \downarrow \\ X_\lambda \longrightarrow & X\end{array}
$$
...
\begin{remark}[Structure quasi compact quasi separated]
\label{formal-spaces-remark-structure-quasi-compact-quasi-separated}
\source{stacks:0AJF}
\href{https://stacks.math.columbia.edu/tag/0AJF}{\texttt{Stacks tag 0AJF}}
\group{formal-spaces}

In this remark we translate the statement and proof of
Lemma \ref{formal-spaces-lemma-structure-quasi-compact-quasi-separated}
into the language of formal schemes \`a la EGA.
Looking at Remark \ref{formal-spaces-remark-ideals-of-definition} we see
...
Remark \ref{formal-spaces-remark-weak-ideals-of-definition}
...
of definition, see Remark \ref{formal-spaces-remark-ideals-of-definition}.
\end{remark}

\begin{lemma}[Characterize affine]
\label{formal-spaces-lemma-characterize-affine}
\source{stacks:0DE8}
\href{https://stacks.math.columbia.edu/tag/0DE8}{\texttt{Stacks tag 0DE8}}
\group{formal-spaces}

Let $S$ be a scheme. Let $X$ be a formal algebraic space over $S$.
Then $X$ is an affine formal algebraic space if and only if
its reduction $X_{red}$ (Lemma \ref{formal-spaces-lemma-reduction-formal-algebraic-space})
is affine.
\end{lemma}

\begin{proof}
By Lemmas \ref{formal-spaces-lemma-characterize-quasi-separated} and
\ref{formal-spaces-lemma-characterize-quasi-compact} and
Definitions \ref{formal-spaces-definition-separated} and \ref{formal-spaces-definition-quasi-compact}
we see that $X$ is quasi-compact and quasi-separated.
By Yasuda's lemma (Lemma \ref{formal-spaces-lemma-structure-quasi-compact-quasi-separated})
...
\source{stacks:0APY}
\href{https://stacks.math.columbia.edu/tag/0APY}{\texttt{Stacks tag 0APY}}
\group{formal-spaces}
...
\source{stacks:0APZ}
\href{https://stacks.math.columbia.edu/tag/0APZ}{\texttt{Stacks tag 0APZ}}
\group{formal-spaces}
...
\begin{lemma}[Permanence representable]
\label{formal-spaces-lemma-permanence-representable}
\source{stacks:0AQ0}
\href{https://stacks.math.columbia.edu/tag/0AQ0}{\texttt{Stacks tag 0AQ0}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-diagonal-morphism-formal-algebraic-spaces}.
...
\begin{lemma}[Representable by algebraic spaces local]
\label{formal-spaces-lemma-representable-by-algebraic-spaces-local}
\source{stacks:0AN4}
\href{https://stacks.math.columbia.edu/tag/0AN4}{\texttt{Stacks tag 0AN4}}
\group{formal-spaces}
...
Definition \ref{formal-spaces-definition-formal-algebraic-space} such that
...
algebraic spaces by Lemma \ref{formal-spaces-lemma-permanence-representable}.
...
Lemma \ref{formal-spaces-lemma-fibre-products}.
...
\begin{lemma}[Algebraic space over affine formal]
\label{formal-spaces-lemma-algebraic-space-over-affine-formal}
\source{stacks:0AJH}
\href{https://stacks.math.columbia.edu/tag/0AJH}{\texttt{Stacks tag 0AJH}}
\group{formal-spaces}
...
algebraic space by Lemma \ref{formal-spaces-lemma-colimit-is-formal}.
\end{proof}

\begin{lemma}[Representable by algebraic spaces]
\label{formal-spaces-lemma-representable-by-algebraic-spaces}
\source{stacks:0AJI}
\href{https://stacks.math.columbia.edu/tag/0AJI}{\texttt{Stacks tag 0AJI}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-etale-covering-by-formal-algebraic-spaces}.
This follows from Lemma \ref{formal-spaces-lemma-algebraic-space-over-affine-formal}.
\end{proof}

\begin{lemma}[Affine representable by algebraic spaces]
\label{formal-spaces-lemma-affine-representable-by-algebraic-spaces}
\source{stacks:0AKN}
\href{https://stacks.math.columbia.edu/tag/0AKN}{\texttt{Stacks tag 0AKN}}
\group{formal-spaces}
...
quasi-compact (Lemma \ref{formal-spaces-lemma-characterize-quasi-compact-morphism}).
...
\begin{lemma}[Representable affine]
\label{formal-spaces-lemma-representable-affine}
\source{stacks:0AN5}
\href{https://stacks.math.columbia.edu/tag/0AN5}{\texttt{Stacks tag 0AN5}}
\group{formal-spaces}
...
\item $\varphi$ is taut, see Definition \ref{formal-spaces-definition-taut}.
\end{enumerate}
\end{lemma}

\begin{proof}
Parts (1) and (2) are equivalent by
Lemma \ref{formal-spaces-lemma-affine-representable-by-algebraic-spaces}.
...
$$
\begin{array}{cc}\Spec(B/J(I)) \downarrow\longrightarrow & \Spec(A/I) \downarrow \\ \text{Spf}(B) \longrightarrow & \text{Spf}(A)\end{array}
$$
By Lemma \ref{formal-spaces-lemma-fibre-product-affines-over-separated}
we see that $B/J(I) = B \widehat{\otimes}_A A/I$.
It follows that $J(I)$ is the closure of the ideal $\varphi(I)B$, see
Lemma \ref{formal-spaces-lemma-closure-image-ideal}.
...
$$
\begin{array}{cc}\text{Spf}(B \widehat{\otimes}_A A/I) \downarrow\longrightarrow & \Spec(A/I) \downarrow \\ \text{Spf}(B) \longrightarrow & \text{Spf}(A)\end{array}
$$
...
$J(I) = \bigcap_{J \subset B\text{ open}} (IB + J)$ by Lemma \ref{formal-spaces-lemma-closed}.
...
\begin{lemma}[Property goes up affine morphism]
\label{formal-spaces-lemma-property-goes-up-affine-morphism}
\source{stacks:0AKP}
\href{https://stacks.math.columbia.edu/tag/0AKP}{\texttt{Stacks tag 0AKP}}
\group{formal-spaces}
...
(Lemma \ref{formal-spaces-lemma-implications-between-types})
and hence $X$ is too by (2). Thus we may write $X = \text{Spf}(A)$
and $Y = \text{Spf}(B)$ for some weakly admissible topological
$S$-algebras $A$ and $B$, see Lemma \ref{formal-spaces-lemma-countably-indexed}.
By Lemma \ref{formal-spaces-lemma-morphism-between-formal-spectra}
the morphism $f$ corresponds to a continuous $S$-algebra
homomorphism $\varphi : B \to A$. We see from
Lemma \ref{formal-spaces-lemma-representable-affine} that $\varphi$ is taut. We conclude that
(3) follows from Lemma \ref{formal-spaces-lemma-taut-ascent-admissible},
(4) follows from Lemma \ref{formal-spaces-lemma-taut-ascent-weakly-adic}, and
(5) follows from Lemma \ref{formal-spaces-lemma-taut-is-adic}.

\medskip\noindent
Proof of (6). Combining (3) with Lemma \ref{formal-spaces-lemma-implications-between-types}
we see that $X$ is adic*. Thus we can use the criterion of
Lemma \ref{formal-spaces-lemma-characterize-noetherian-affine}.
...
\begin{lemma}[Property goes up affine]
\label{formal-spaces-lemma-property-goes-up-affine}
\source{stacks:0AKQ}
\href{https://stacks.math.columbia.edu/tag/0AKQ}{\texttt{Stacks tag 0AKQ}}
\group{formal-spaces}
...
\begin{proof}
Combine Lemmas \ref{formal-spaces-lemma-affine-representable-by-algebraic-spaces} and
\ref{formal-spaces-lemma-property-goes-up-affine-morphism}.
\end{proof}

\begin{example}[Representable morphism from completion]
\label{formal-spaces-example-representable-morphism-from-completion}
\source{stacks:0AN6}
\href{https://stacks.math.columbia.edu/tag/0AN6}{\texttt{Stacks tag 0AN6}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-closed}. By
Lemma \ref{formal-spaces-lemma-topologically-nilpotent}
...
Lemma \ref{formal-spaces-lemma-representable-affine}.
\end{example}
...
\source{stacks:0AN7}
\href{https://stacks.math.columbia.edu/tag/0AN7}{\texttt{Stacks tag 0AN7}}
\group{formal-spaces}

The discussion in Lemmas \ref{formal-spaces-lemma-representable-affine},
...
\source{stacks:0AN8}
\href{https://stacks.math.columbia.edu/tag/0AN8}{\texttt{Stacks tag 0AN8}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-morphism-between-formal-spectra}.
...
\begin{lemma}[Etale surjective]
\label{formal-spaces-lemma-etale-surjective}
\source{stacks:0AN9}
\href{https://stacks.math.columbia.edu/tag/0AN9}{\texttt{Stacks tag 0AN9}}
\group{formal-spaces}

With notation and assumptions as in Lemma \ref{formal-spaces-lemma-etale} let
...
\begin{lemma}[Iff countably indexed]
\label{formal-spaces-lemma-iff-countably-indexed}
\source{stacks:0AKS}
\href{https://stacks.math.columbia.edu/tag/0AKS}{\texttt{Stacks tag 0AKS}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-countable-affine-formal-algebraic-space}.
Write $Y = \colim Y_\lambda$ as in
Definition \ref{formal-spaces-definition-affine-formal-algebraic-space}.
...
$X_n$ for some $n$ (Lemma \ref{formal-spaces-lemma-factor-through-thickening}).
Picture
$$
\begin{array}{ccc}Y_\lambda \times_Y X \longrightarrow\downarrow & X_n \longrightarrow\downarrow & X \downarrow \\ Y_\lambda \dashrightarrow\longrightarrow & Y_{\lambda_n} \longrightarrow & Y\end{array}
$$
...
by Lemma \ref{formal-spaces-lemma-property-goes-up-affine}.
\end{proof}

\begin{lemma}[Iff cic]
\label{formal-spaces-lemma-iff-cic}
\source{stacks:0GXR}
\href{https://stacks.math.columbia.edu/tag/0GXR}{\texttt{Stacks tag 0GXR}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-property-goes-up-affine}. For the other direction,
note that by Lemma \ref{formal-spaces-lemma-iff-countably-indexed} we may assume
...
homomorphism $\varphi : B \to A$. We see from
Lemma \ref{formal-spaces-lemma-representable-affine} that $\varphi$ is taut.
Let $J \subset B$ be an open ideal and let $I \subset A$
be the closure of $JA$. By
Lemmas \ref{formal-spaces-lemma-fibre-product-affines-over-separated} and
...
Section \ref{formal-spaces-section-taut-descent} (with the roles of $A$ and $B$ swapped).
We conclude that the lemma holds by
Lemma \ref{formal-spaces-lemma-taut-descent-weakly-admissible}.
\end{proof}

\begin{lemma}[Iff weakly adic]
\label{formal-spaces-lemma-iff-weakly-adic}
\source{stacks:0GXS}
\href{https://stacks.math.columbia.edu/tag/0GXS}{\texttt{Stacks tag 0GXS}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-iff-cic} except that at the end we use
Lemma \ref{formal-spaces-lemma-taut-descent-weakly-adic}.
\end{proof}

\begin{lemma}[Iff adic star]
\label{formal-spaces-lemma-iff-adic-star}
\source{stacks:0AKT}
\href{https://stacks.math.columbia.edu/tag/0AKT}{\texttt{Stacks tag 0AKT}}
\group{formal-spaces}
...
The proof is exactly the same as the proof of
Lemma \ref{formal-spaces-lemma-iff-cic} except that at the end we use
Lemma \ref{formal-spaces-lemma-taut-descent-adic-star}.
\end{proof}

\begin{lemma}[Iff noetherian]
\label{formal-spaces-lemma-iff-noetherian}
\source{stacks:0AKW}
\href{https://stacks.math.columbia.edu/tag/0AKW}{\texttt{Stacks tag 0AKW}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-implications-between-types}. Thus by
Lemma \ref{formal-spaces-lemma-iff-adic-star} we may assume that both $X$ and $Y$
are adic*. We will use the criterion of
Lemma \ref{formal-spaces-lemma-characterize-noetherian-affine}
to see that the lemma holds. Namely, write $Y = \colim Y_n$
as in Lemma \ref{formal-spaces-lemma-countable-affine-formal-algebraic-space}.
For each $n$ set $X_n = Y_n \times_Y X$. Then $X_n$ is an
affine scheme (Lemma \ref{formal-spaces-lemma-affine-representable-by-algebraic-spaces})
...
\begin{lemma}[Type local]
\label{formal-spaces-lemma-type-local}
\source{stacks:0AKX}
\href{https://stacks.math.columbia.edu/tag/0AKX}{\texttt{Stacks tag 0AKX}}
\group{formal-spaces}
...
are formal algebraic spaces (Lemma \ref{formal-spaces-lemma-fibre-products-general})
...
Lemma \ref{formal-spaces-lemma-property-goes-up-affine}.
...
if the equivalent conditions of Lemma \ref{formal-spaces-lemma-type-local}
...
\begin{lemma}[Formal completion types]
\label{formal-spaces-lemma-formal-completion-types}
\source{stacks:0AQ1}
\href{https://stacks.math.columbia.edu/tag/0AQ1}{\texttt{Stacks tag 0AQ1}}
\group{formal-spaces}
...
(Lemma \ref{formal-spaces-lemma-map-completions-representable}).
...
Lemma \ref{formal-spaces-lemma-affine-formal-completion-types}.
\end{proof}
...
\source{stacks:0CKX}
\href{https://stacks.math.columbia.edu/tag/0CKX}{\texttt{Stacks tag 0CKX}}
\group{formal-spaces}
...
the $J$-adic completion can fail to be a ring isomorphism.
As an example let
$$
...
is the valuation ring described in Example \ref{formal-spaces-example-david-hansen}
(but in particular it is easy to see that $A \subset A^\wedge$).
\end{remark}

\begin{lemma}[Types fibre products]
\label{formal-spaces-lemma-types-fibre-products}
\source{stacks:0GBB}
\href{https://stacks.math.columbia.edu/tag/0GBB}{\texttt{Stacks tag 0GBB}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-fibre-product-affines-over-separated}.
Hence
$$
\{X_{ji} \times_{Y_j} Z_{jk} \to X \times_Y Z\}
$$
is a covering as in Definition \ref{formal-spaces-definition-formal-algebraic-space}.
...
(for example see Lemma \ref{formal-spaces-lemma-factor-through-thickening}).
...
Lemma \ref{formal-spaces-lemma-countably-indexed} we can write
...
by Lemma \ref{formal-spaces-lemma-completed-tensor-product} part (3).
This proves (1).
...
Lemma \ref{formal-spaces-lemma-completed-tensor-product} part (2).
...
Lemma \ref{formal-spaces-lemma-completed-tensor-product-weakly-adic}.

\medskip\noindent
Proof of (4). Arguing as above, this follows from
Lemma \ref{formal-spaces-lemma-completed-tensor-product} part (4).

\medskip\noindent
Proof of (5). To deduce case (5) from
Lemma \ref{formal-spaces-lemma-completed-tensor-product} part (5)
...
$$
\begin{array}{cc}(X_{ji})_{red} \downarrow\longrightarrow & (Y_j)_{red} \downarrow \\ X_{red} \longrightarrow & Y_{red}\end{array}
$$
the vertical morphisms are \'etale. Namely, we have
$(X_{ji})_{red} = X_{ij} \times_X X_{red}$ and
$(Y_j)_{red} = Y_j \times_Y Y_{red}$
by Lemma \ref{formal-spaces-lemma-reduction-smooth}. Thus as above we reduce
...
\begin{lemma}[Structure locally noetherian]
\label{formal-spaces-lemma-structure-locally-noetherian}
\source{stacks:0GHM}
\href{https://stacks.math.columbia.edu/tag/0GHM}{\texttt{Stacks tag 0GHM}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-countably-indexed}.
By Lemma \ref{formal-spaces-lemma-morphism-between-formal-spectra}
...
Definition \ref{formal-spaces-definition-types-formal-algebraic-spaces} (and hence via
Lemma \ref{formal-spaces-lemma-type-local}) we see that $U$ and $V$ are countably indexed
...
\begin{lemma}[Completion in sub]
\label{formal-spaces-lemma-completion-in-sub}
\source{stacks:0ANB}
\href{https://stacks.math.columbia.edu/tag/0ANB}{\texttt{Stacks tag 0ANB}}
\group{formal-spaces}
...
Example \ref{formal-spaces-example-representable-morphism-from-completion}.
\begin{enumerate}
...
\ref{formal-spaces-lemma-taut-ascent-weakly-adic}, and
...
\begin{definition}[Situation: Local property]
\label{formal-spaces-situation-local-property}
\source{stacks:0CBA}
\href{https://stacks.math.columbia.edu/tag/0CBA}{\texttt{Stacks tag 0CBA}}
\group{formal-spaces}
...
\vcenter{
\begin{array}{cc}A \longrightarrow & (A')^\wedge \\ B \longrightarrow\overset{\varphi}{\uparrow} & (B')^\wedge \underset{\varphi'}{\uparrow}\end{array}
}
\end{equation}
...
are continuous.
\end{enumerate}
By Lemma \ref{formal-spaces-lemma-completion-in-sub} the topological rings
...
\begin{lemma}[Property defines property morphisms]
\label{formal-spaces-lemma-property-defines-property-morphisms}
\source{stacks:0ANG}
\href{https://stacks.math.columbia.edu/tag/0ANG}{\texttt{Stacks tag 0ANG}}
\group{formal-spaces}
...
\item there exists a covering $\{Y_j \to Y\}$ as in
Definition \ref{formal-spaces-definition-formal-algebraic-space} and for each $j$
...
(Lemma \ref{formal-spaces-lemma-fibre-products-general}) we may pick
...
$$
\begin{array}{ccccccc} &  &  & X_{i_s j_s k_s} \swarrow\downarrow\searrow &  &  &  \\ X \downarrow & X_{i_s} \longleftarrow\downarrow & X_{i_s} \times_X U \longleftarrow\downarrow & Y_{i_s j_s} \swarrow\searrow & X_{i_s} \times_X U \downarrow\longrightarrow & U \downarrow\longrightarrow & X \downarrow \\ Y & Y_{i_s} \longleftarrow & Y_{i_s} \times_Y V \longleftarrow &  & Y_{i_s} \times_Y V \longrightarrow & V \longrightarrow & Y\end{array}
$$
...
are given by completions of \'etale ring maps, see Lemma \ref{formal-spaces-lemma-etale}.
...
$$
\begin{array}{cc}X_{i_s j_s k_s} \xlongequal{}\downarrow & X_{i_s j_s k_s} \downarrow \\ Y_{i_s j_s} \longrightarrow & V\end{array}
$$
...
\source{stacks:0ANH}
\href{https://stacks.math.columbia.edu/tag/0ANH}{\texttt{Stacks tag 0ANH}}
\group{formal-spaces}
...
of Situation \ref{formal-spaces-situation-local-property}
hold for morphisms of $\textit{WAdm}^{adic*}$. In exactly the same way
we obtain a variant of Lemma \ref{formal-spaces-lemma-property-defines-property-morphisms}
...
\source{stacks:0ANI}
\href{https://stacks.math.columbia.edu/tag/0ANI}{\texttt{Stacks tag 0ANI}}
\group{formal-spaces}
...
\begin{definition}[Situation: Base change local property]
\label{formal-spaces-situation-base-change-local-property}
\source{stacks:0GBC}
\href{https://stacks.math.columbia.edu/tag/0GBC}{\texttt{Stacks tag 0GBC}}
\group{formal-spaces}

Let $P$ be a local property of morphisms of $\textit{WAdm}^{count}$, see
Situation \ref{formal-spaces-situation-local-property}. We say $P$ is {\it stable under
...
$\textit{WAdm}^{count}$ by Lemma \ref{formal-spaces-lemma-completed-tensor-product}.
\end{definition}

\begin{lemma}[Base change property morphisms]
\label{formal-spaces-lemma-base-change-property-morphisms}
\source{stacks:0GBD}
\href{https://stacks.math.columbia.edu/tag/0GBD}{\texttt{Stacks tag 0GBD}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-property-defines-property-morphisms}
...
Lemma \ref{formal-spaces-lemma-types-fibre-products}.
Then we see that
$$
\{X_{ji} \times_{Y_j} Z_{jk} \to X \times_Y Z\}
$$
...
\source{stacks:0GBE}
\href{https://stacks.math.columbia.edu/tag/0GBE}{\texttt{Stacks tag 0GBE}}
\group{formal-spaces}

Let $P$ be a local property of morphisms of $\textit{WAdm}^{adic*}$, see
Remark \ref{formal-spaces-remark-variant-adic-star}. We say $P$ is {\it stable under
base change} if given $B \to A$ and $B \to C$ in $\textit{WAdm}^{adic*}$
we have $P(B \to A) \Rightarrow P(C \to A \widehat{\otimes}_B C)$.
This makes sense as $A \widehat{\otimes}_B C$ is an object of
$\textit{WAdm}^{adic*}$ by Lemma \ref{formal-spaces-lemma-completed-tensor-product}.
In exactly the same way we obtain a variant of
Lemma \ref{formal-spaces-lemma-base-change-property-morphisms}
for morphisms between locally adic* formal algebraic spaces over $S$.
\end{remark}
...
\source{stacks:0GBF}
\href{https://stacks.math.columbia.edu/tag/0GBF}{\texttt{Stacks tag 0GBF}}
\group{formal-spaces}

Let $P$ be a local property of morphisms of $\textit{WAdm}^{Noeth}$, see
Remark \ref{formal-spaces-remark-variant-Noetherian}. We say $P$ is
...
Noetherian\footnote{See Lemma \ref{formal-spaces-lemma-completed-tensor-product}
...
\source{stacks:0GBG}
\href{https://stacks.math.columbia.edu/tag/0GBG}{\texttt{Stacks tag 0GBG}}
\group{formal-spaces}

Let $P$ and $Q$ be local properties of morphisms of
$\textit{WAdm}^{Noeth}$, see Remark \ref{formal-spaces-remark-variant-Noetherian}.
...
\begin{definition}[Situation: Composition local property]
\label{formal-spaces-situation-composition-local-property}
\source{stacks:0GBH}
\href{https://stacks.math.columbia.edu/tag/0GBH}{\texttt{Stacks tag 0GBH}}
\group{formal-spaces}
...
\begin{lemma}[Composition property morphisms]
\label{formal-spaces-lemma-composition-property-morphisms}
\source{stacks:0GBI}
\href{https://stacks.math.columbia.edu/tag/0GBI}{\texttt{Stacks tag 0GBI}}
\group{formal-spaces}
...
\source{stacks:0GBJ}
\href{https://stacks.math.columbia.edu/tag/0GBJ}{\texttt{Stacks tag 0GBJ}}
\group{formal-spaces}
...
we have $P(B \to A) \wedge P(C \to B) \Rightarrow P(C \to A)$.
In exactly the same way we obtain a variant of
Lemma \ref{formal-spaces-lemma-composition-property-morphisms}
for morphisms between locally adic* formal algebraic spaces over $S$.
\end{remark}
...
\source{stacks:0GBK}
\href{https://stacks.math.columbia.edu/tag/0GBK}{\texttt{Stacks tag 0GBK}}
\group{formal-spaces}
...
\begin{definition}[Situation: Permanence local property]
\label{formal-spaces-situation-permanence-local-property}
\source{stacks:0GBL}
\href{https://stacks.math.columbia.edu/tag/0GBL}{\texttt{Stacks tag 0GBL}}
\group{formal-spaces}

Let $P$ be a local property of morphisms of $\textit{WAdm}^{count}$, see
Situation \ref{formal-spaces-situation-local-property}. We say $P$
...
\begin{lemma}[Permanence property morphisms]
\label{formal-spaces-lemma-permanence-property-morphisms}
\source{stacks:0GBM}
\href{https://stacks.math.columbia.edu/tag/0GBM}{\texttt{Stacks tag 0GBM}}
\group{formal-spaces}
...
\source{stacks:0GBN}
\href{https://stacks.math.columbia.edu/tag/0GBN}{\texttt{Stacks tag 0GBN}}
\group{formal-spaces}

Let $P$ be a local property of morphisms of $\textit{WAdm}^{adic*}$, see
Remark \ref{formal-spaces-remark-variant-adic-star}. We say $P$ {\it has the cancellation
...
\source{stacks:0GBP}
\href{https://stacks.math.columbia.edu/tag/0GBP}{\texttt{Stacks tag 0GBP}}
\group{formal-spaces}

Let $P$ be a local property of morphisms of $\textit{WAdm}^{Noeth}$, see
Remark \ref{formal-spaces-remark-variant-Noetherian}. We say $P$
...
\begin{lemma}[Representable property rings]
\label{formal-spaces-lemma-representable-property-rings}
\source{stacks:0ANJ}
\href{https://stacks.math.columbia.edu/tag/0ANJ}{\texttt{Stacks tag 0ANJ}}
\group{formal-spaces}

Let $B \to A$ be an arrow of $\textit{WAdm}^{count}$.
The following are equivalent
\begin{enumerate}
\item[(a)] $B \to A$ is taut (Definition \ref{formal-spaces-definition-taut}),
...
$$
\begin{array}{ccccc}A \longrightarrow & \ldots \longrightarrow & A_3 \longrightarrow & A_2 \longrightarrow & A_1 \\ B \longrightarrow\uparrow & \ldots \longrightarrow & B/J_3 \longrightarrow\uparrow & B/J_2 \longrightarrow\uparrow & B/J_1 \uparrow\end{array}
$$
...
them. Namely, using Lemma \ref{formal-spaces-lemma-representable-affine}
...
Lemma \ref{formal-spaces-lemma-representable-by-algebraic-spaces-local}
...
Situation \ref{formal-spaces-situation-local-property} be given.
By Example \ref{formal-spaces-example-representable-morphism-from-completion}
...
& = \bigcap (JA + I_0)
\end{align*}
which is the closure of $JA$ by Lemma \ref{formal-spaces-lemma-closed}.
...
Thus the closure of $JA$ is open. By Lemma \ref{formal-spaces-lemma-topologically-nilpotent}
the closure of $JA$
...
\begin{lemma}[Representable local property]
\label{formal-spaces-lemma-representable-local-property}
\source{stacks:0ANK}
\href{https://stacks.math.columbia.edu/tag/0ANK}{\texttt{Stacks tag 0ANK}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-representable-property-rings}.
Thus Lemma \ref{formal-spaces-lemma-property-defines-property-morphisms}
exactly tells us that (1), (2), and (3) are equivalent.
On the other hand, by Lemma \ref{formal-spaces-lemma-representable-affine}
...
\begin{lemma}[Adic homomorphism]
\label{formal-spaces-lemma-adic-homomorphism}
\source{stacks:0GBS}
\href{https://stacks.math.columbia.edu/tag/0GBS}{\texttt{Stacks tag 0GBS}}
\group{formal-spaces}
...
\begin{proof}
Part (1) is Lemma \ref{formal-spaces-lemma-adic-taut}.
Part (2) is Lemma \ref{formal-spaces-lemma-taut-is-adic}.
The final statement is a consequence of (1) and (2).
\end{proof}

Let $S$ be a scheme. Let $f : X \to Y$ be a morphism of
locally adic* formal algebraic spaces over $S$.
By Lemma \ref{formal-spaces-lemma-representable-local-property}
the following are equivalent
\begin{enumerate}
\item $f$ is representable by algebraic spaces (in other words, the
equivalent conditions of
Lemma \ref{formal-spaces-lemma-representable-by-algebraic-spaces-local} hold),
\item for every commutative diagram
$$
\begin{array}{cc}U \downarrow\longrightarrow & V \downarrow \\ X \longrightarrow & Y\end{array}
$$
...
Lemma \ref{formal-spaces-lemma-adic-homomorphism}.} map in $\textit{WAdm}^{adic*}$.
\end{enumerate}
...
\begin{definition}[Adic morphism]
\label{formal-spaces-definition-adic-morphism}
\source{stacks:0AQ3}
\href{https://stacks.math.columbia.edu/tag/0AQ3}{\texttt{Stacks tag 0AQ3}}
\group{formal-spaces}
...
\source{stacks:0AM4}
\href{https://stacks.math.columbia.edu/tag/0AM4}{\texttt{Stacks tag 0AM4}}
\group{formal-spaces}
...
quasi-compact (Definition \ref{formal-spaces-definition-quasi-compact-morphism}).
\end{enumerate}
\end{definition}
...
in Section \ref{formal-spaces-section-tft}.

\begin{lemma}[Characterize finite type]
\label{formal-spaces-lemma-characterize-finite-type}
\source{stacks:0AJJ}
\href{https://stacks.math.columbia.edu/tag/0AJJ}{\texttt{Stacks tag 0AJJ}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-quasi-compact-representable}.
\end{proof}

\begin{lemma}[Composition finite type]
\label{formal-spaces-lemma-composition-finite-type}
\source{stacks:0AQ4}
\href{https://stacks.math.columbia.edu/tag/0AQ4}{\texttt{Stacks tag 0AQ4}}
\group{formal-spaces}
...
\source{stacks:0AQ5}
\href{https://stacks.math.columbia.edu/tag/0AQ5}{\texttt{Stacks tag 0AQ5}}
\group{formal-spaces}
...
\source{stacks:0AQ6}
\href{https://stacks.math.columbia.edu/tag/0AQ6}{\texttt{Stacks tag 0AQ6}}
\group{formal-spaces}
...
\begin{proof}
By Lemma \ref{formal-spaces-lemma-permanence-representable} we see that $f$ is
...
\source{stacks:0ANL}
\href{https://stacks.math.columbia.edu/tag/0ANL}{\texttt{Stacks tag 0ANL}}
\group{formal-spaces}
...
$$
\begin{array}{cc}U \times_Y T \downarrow\longrightarrow & V \times_Y T \downarrow \\ X \times_Y T \longrightarrow & T\end{array}
$$
...
\begin{example}[Finite type from finite type ring map]
\label{formal-spaces-example-finite-type-from-finite-type-ring-map}
\source{stacks:0ANM}
\href{https://stacks.math.columbia.edu/tag/0ANM}{\texttt{Stacks tag 0ANM}}
\group{formal-spaces}
...
see Example \ref{formal-spaces-example-representable-morphism-from-completion}.
If $T \to \text{Spf}(A)$ is a morphism where $T$ is a quasi-compact
scheme, then this factors through $\Spec(A/I)$ for some weak
ideal of definition $I \subset A$ (Lemma \ref{formal-spaces-lemma-factor-through-thickening}).
...
\source{stacks:0AQ7}
\href{https://stacks.math.columbia.edu/tag/0AQ7}{\texttt{Stacks tag 0AQ7}}
\group{formal-spaces}
...
as in Lemma \ref{formal-spaces-lemma-finite-type-local}. Then it follows
from Lemma \ref{formal-spaces-lemma-property-goes-up-affine-morphism}
that each $X_{ij}$ is Noetherian. This proves the lemma.
\end{proof}

\begin{lemma}[Fibre product Noetherian]
\label{formal-spaces-lemma-fibre-product-Noetherian}
\source{stacks:0AQ8}
\href{https://stacks.math.columbia.edu/tag/0AQ8}{\texttt{Stacks tag 0AQ8}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-base-change-finite-type}. Hence this follows
from Lemma \ref{formal-spaces-lemma-locally-finite-type-locally-noetherian}.
\end{proof}

\section{Surjective morphisms}
\label{formal-spaces-section-surjective}
By Lemma \ref{formal-spaces-lemma-reduction-surjective} the following definition does
...
\source{stacks:0GHP}
\href{https://stacks.math.columbia.edu/tag/0GHP}{\texttt{Stacks tag 0GHP}}
\group{formal-spaces}
...
\source{stacks:0GHQ}
\href{https://stacks.math.columbia.edu/tag/0GHQ}{\texttt{Stacks tag 0GHQ}}
\group{formal-spaces}
...
\source{stacks:0GHR}
\href{https://stacks.math.columbia.edu/tag/0GHR}{\texttt{Stacks tag 0GHR}}
\group{formal-spaces}
...
\source{stacks:0GHS}
\href{https://stacks.math.columbia.edu/tag/0GHS}{\texttt{Stacks tag 0GHS}}
\group{formal-spaces}
...
\source{stacks:0AQB}
\href{https://stacks.math.columbia.edu/tag/0AQB}{\texttt{Stacks tag 0AQB}}
\group{formal-spaces}
...
\source{stacks:0GHT}
\href{https://stacks.math.columbia.edu/tag/0GHT}{\texttt{Stacks tag 0GHT}}
\group{formal-spaces}
...
\source{stacks:0GHU}
\href{https://stacks.math.columbia.edu/tag/0GHU}{\texttt{Stacks tag 0GHU}}
\group{formal-spaces}
...
\begin{lemma}[Characterize monomorphisms]
\label{formal-spaces-lemma-characterize-monomorphisms}
\source{stacks:0GHV}
\href{https://stacks.math.columbia.edu/tag/0GHV}{\texttt{Stacks tag 0GHV}}
\group{formal-spaces}
...
\source{stacks:0ANP}
\href{https://stacks.math.columbia.edu/tag/0ANP}{\texttt{Stacks tag 0ANP}}
\group{formal-spaces}
...
\begin{lemma}[Composition closed immersion]
\label{formal-spaces-lemma-composition-closed-immersion}
\source{stacks:0GHW}
\href{https://stacks.math.columbia.edu/tag/0GHW}{\texttt{Stacks tag 0GHW}}
\group{formal-spaces}
...
\begin{lemma}[Base change closed immersion]
\label{formal-spaces-lemma-base-change-closed-immersion}
\source{stacks:0GHX}
\href{https://stacks.math.columbia.edu/tag/0GHX}{\texttt{Stacks tag 0GHX}}
\group{formal-spaces}
...
\source{stacks:0GHY}
\href{https://stacks.math.columbia.edu/tag/0GHY}{\texttt{Stacks tag 0GHY}}
\group{formal-spaces}
...
\begin{lemma}[Closed immersion into McQuillan]
\label{formal-spaces-lemma-closed-immersion-into-McQuillan}
\source{stacks:0ANQ}
\href{https://stacks.math.columbia.edu/tag/0ANQ}{\texttt{Stacks tag 0ANQ}}
\group{formal-spaces}
...
and hence affine (Definition \ref{formal-spaces-definition-closed-immersion}).
...
Lemma \ref{formal-spaces-lemma-mcquillan-affine-formal-algebraic-space}.
The ring map $A \to B$ is taut by Lemma \ref{formal-spaces-lemma-representable-affine}.
...
McQuillan affine formal algebraic space, see Remark \ref{formal-spaces-remark-questions}.

\begin{example}[Closed immersion from quotient]
\label{formal-spaces-example-closed-immersion-from-quotient}
\source{stacks:0ANR}
\href{https://stacks.math.columbia.edu/tag/0ANR}{\texttt{Stacks tag 0ANR}}
\group{formal-spaces}
...
\begin{lemma}[Monomorphism iso over red]
\label{formal-spaces-lemma-monomorphism-iso-over-red}
\source{stacks:0GHZ}
\href{https://stacks.math.columbia.edu/tag/0GHZ}{\texttt{Stacks tag 0GHZ}}
\group{formal-spaces}
...
(1) -- (4). Hence by Lemma \ref{formal-spaces-lemma-characterize-closed-immersion}
...
\source{stacks:0AJM}
\href{https://stacks.math.columbia.edu/tag/0AJM}{\texttt{Stacks tag 0AJM}}
\group{formal-spaces}
...
\begin{remark}[I adic completion and restricted power series]
\label{formal-spaces-remark-I-adic-completion-and-restricted-power-series}
\source{stacks:0AL0}
\href{https://stacks.math.columbia.edu/tag/0AL0}{\texttt{Stacks tag 0AL0}}
\group{formal-spaces}
...
\begin{definition}[Topologically finite type]
\label{formal-spaces-definition-topologically-finite-type}
\source{stacks:0ANS}
\href{https://stacks.math.columbia.edu/tag/0ANS}{\texttt{Stacks tag 0ANS}}
\group{formal-spaces}
...
\begin{lemma}[Topologically finite type finite type]
\label{formal-spaces-lemma-topologically-finite-type-finite-type}
\source{stacks:0ANT}
\href{https://stacks.math.columbia.edu/tag/0ANT}{\texttt{Stacks tag 0ANT}}
\group{formal-spaces}
...
\begin{proof}
We can use Lemma \ref{formal-spaces-lemma-representable-affine} to relate tautness of
...
$\Spec(A/I)$ for some $I$ (Lemma \ref{formal-spaces-lemma-factor-through-thickening}).
...
\begin{lemma}[Category affine over]
\label{formal-spaces-lemma-category-affine-over}
\source{stacks:0AL1}
\href{https://stacks.math.columbia.edu/tag/0AL1}{\texttt{Stacks tag 0AL1}}
\group{formal-spaces}
...
(Definition \ref{formal-spaces-definition-finite-type}
...
finite type
(by Definition \ref{formal-spaces-definition-finite-type}).
...
Lemma \ref{formal-spaces-lemma-factor-through-thickening} two times). Since
...
\begin{remark}[Questions]
\label{formal-spaces-remark-questions}
\source{stacks:0AJK}
\href{https://stacks.math.columbia.edu/tag/0AJK}{\texttt{Stacks tag 0AJK}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-closed-immersion-into-McQuillan}.
What conditions on $A$ guarantee that $B = (A/K)^\wedge$ as in
Example \ref{formal-spaces-example-closed-immersion-from-quotient}?
...
$\mathcal{C}$ by Lemma \ref{formal-spaces-lemma-category-affine-over}.
...
(1) $\Rightarrow$ (2) in
Lemma \ref{formal-spaces-lemma-topologically-finite-type-finite-type}).
...
\begin{lemma}[Closed immersion into countably indexed]
\label{formal-spaces-lemma-closed-immersion-into-countably-indexed}
\source{stacks:0AQI}
\href{https://stacks.math.columbia.edu/tag/0AQI}{\texttt{Stacks tag 0AQI}}
\group{formal-spaces}
...
\begin{proof}
By Lemma \ref{formal-spaces-lemma-countably-indexed}
we see that $X = \text{Spf}(A)$ where $A$ is an object of
$\textit{WAdm}^{count}$. Since a closed immersion is representable
and affine, we conclude by Lemma \ref{formal-spaces-lemma-property-goes-up-affine-morphism}
that $Y$ is an affine formal algebraic space and countably index.
Thus applying Lemma \ref{formal-spaces-lemma-countably-indexed}
again we see that $Y = \text{Spf}(B)$ with $B$ an object of
$\textit{WAdm}^{count}$. By Lemma \ref{formal-spaces-lemma-closed-immersion-into-McQuillan}
...
Lemma \ref{formal-spaces-lemma-dense-image-surjective}.
\end{proof}

\begin{lemma}[Quotient restricted power series]
\label{formal-spaces-lemma-quotient-restricted-power-series}
\source{stacks:0ANU}
\href{https://stacks.math.columbia.edu/tag/0ANU}{\texttt{Stacks tag 0ANU}}
\group{formal-spaces}
...
Remark \ref{formal-spaces-remark-universal-property} we find a continuous map
...
be given. By Example \ref{formal-spaces-example-finite-type-from-finite-type-ring-map}
the maps $A \to (A')^\wedge$ and $B \to (B')^\wedge$
...
diagram
$$
\begin{array}{cc}A/I \longrightarrow & (A')^\wedge/I' \\ B/J \longrightarrow\overset{\overline{\varphi}}{\uparrow} & (B')^\wedge/J' \underset{\overline{\varphi}'}{\uparrow}\end{array}
$$
...
\begin{lemma}[Quotient restricted power series admissible]
\label{formal-spaces-lemma-quotient-restricted-power-series-admissible}
\source{stacks:0CB6}
\href{https://stacks.math.columbia.edu/tag/0CB6}{\texttt{Stacks tag 0CB6}}
\group{formal-spaces}

In Lemma \ref{formal-spaces-lemma-quotient-restricted-power-series}
...
diagram
$$
\begin{array}{ccccc}0 \longrightarrow & I/I' \longrightarrow & A/I' \longrightarrow & A/I \longrightarrow & 0 \\ 0 \longrightarrow & J/J' \longrightarrow\uparrow & B/J' \longrightarrow\uparrow & B/J \longrightarrow\uparrow & 0\end{array}
$$
...
\begin{lemma}[Representable affine finite type]
\label{formal-spaces-lemma-representable-affine-finite-type}
\source{stacks:0ANV}
\href{https://stacks.math.columbia.edu/tag/0ANV}{\texttt{Stacks tag 0ANV}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-quotient-restricted-power-series}.
\end{enumerate}
\end{lemma}
...
affine by Lemma \ref{formal-spaces-lemma-affine-representable-by-algebraic-spaces}.
Thus if (1) or (2) holds we see that
$X$ is countably indexed by
Lemma \ref{formal-spaces-lemma-property-goes-up-affine-morphism}.
Write $X = \text{Spf}(A)$ and $Y = \text{Spf}(B)$
for topological $S$-algebras $A$ and $B$ in $\textit{WAdm}^{count}$, see
Lemma \ref{formal-spaces-lemma-countably-indexed}. By
Lemma \ref{formal-spaces-lemma-morphism-between-formal-spectra}
...
\begin{lemma}[Finite type local property]
\label{formal-spaces-lemma-finite-type-local-property}
\source{stacks:0ANW}
\href{https://stacks.math.columbia.edu/tag/0ANW}{\texttt{Stacks tag 0ANW}}
\group{formal-spaces}
...
\begin{proof}
By Lemma \ref{formal-spaces-lemma-quotient-restricted-power-series}
the property
...
On the other hand, by Lemma \ref{formal-spaces-lemma-representable-affine-finite-type}
...
\source{stacks:0ARN}
\href{https://stacks.math.columbia.edu/tag/0ARN}{\texttt{Stacks tag 0ARN}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-quasi-compact-representable} or
Definition \ref{formal-spaces-definition-closed-immersion}.
...
\source{stacks:0ARP}
\href{https://stacks.math.columbia.edu/tag/0ARP}{\texttt{Stacks tag 0ARP}}
\group{formal-spaces}

All of the separation axioms listed in
Definition \ref{formal-spaces-definition-separated-morphism}
...
of the diagonal used in Definition \ref{formal-spaces-definition-separated-morphism}
...
\source{stacks:0ARQ}
\href{https://stacks.math.columbia.edu/tag/0ARQ}{\texttt{Stacks tag 0ARQ}}
\group{formal-spaces}
...
from Lemma \ref{formal-spaces-lemma-diagonal-morphism-formal-algebraic-spaces}.
\end{proof}

\begin{lemma}[Composition separated]
\label{formal-spaces-lemma-composition-separated}
\source{stacks:0ARR}
\href{https://stacks.math.columbia.edu/tag/0ARR}{\texttt{Stacks tag 0ARR}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-fibre-product-after-map} above we see that
...
\source{stacks:0ARS}
\href{https://stacks.math.columbia.edu/tag/0ARS}{\texttt{Stacks tag 0ARS}}
\group{formal-spaces}
...
Definition \ref{formal-spaces-definition-separated}),
\item there exists a covering $\{Y_j \to Y\}$ as in
Definition \ref{formal-spaces-definition-formal-algebraic-space}
...
Lemma \ref{formal-spaces-lemma-base-change-separated}
...
$$
\begin{array}{cc}\coprod Y_j \times_Y X \longrightarrow\downarrow & X \downarrow \\ \coprod Y_j \times_Y X \times_Y X \longrightarrow & X \times_Y X\end{array}
$$
...
\source{stacks:0AM6}
\href{https://stacks.math.columbia.edu/tag/0AM6}{\texttt{Stacks tag 0AM6}}
\group{formal-spaces}
...
\source{stacks:0ART}
\href{https://stacks.math.columbia.edu/tag/0ART}{\texttt{Stacks tag 0ART}}
\group{formal-spaces}
...
\source{stacks:0GBT}
\href{https://stacks.math.columbia.edu/tag/0GBT}{\texttt{Stacks tag 0GBT}}
\group{formal-spaces}
...
\begin{proof}
This is an immediate consequence of Lemma \ref{formal-spaces-lemma-proper-local}
...
\begin{lemma}[Formal algebraic spaces are fpqc sheaves]
\label{formal-spaces-lemma-sheaf-fpqc}
\source{stacks:0AQD}
\href{https://stacks.math.columbia.edu/tag/0AQD}{\texttt{Stacks tag 0AQD}}
\group{formal-spaces}
...
$$
By Lemma \ref{formal-spaces-lemma-diagonal-formal-algebraic-space}
...
$$
\begin{array}{cc}T' \times_T E \longrightarrow\downarrow & E \downarrow \\ T' \longrightarrow\uparrow\nearrow & T\end{array}
$$
...
by schemes (Lemma \ref{formal-spaces-lemma-presentation-representable}) and
separated (Lemma \ref{formal-spaces-lemma-separated-from-separated}). Thus
$$
...
The diagram
$$
\begin{array}{ccc}T' \times_T W \longrightarrow\downarrow & W \underset{b}{\longrightarrow} & U \downarrow \\ T' \overset{c}{\longrightarrow} &  & X\end{array}
$$
...
\begin{lemma}[Map into affine]
\label{formal-spaces-lemma-map-into-affine}
\source{stacks:0AQF}
\href{https://stacks.math.columbia.edu/tag/0AQF}{\texttt{Stacks tag 0AQF}}
\group{formal-spaces}
...
\begin{lemma}[Map into scheme]
\label{formal-spaces-lemma-map-into-scheme}
\source{stacks:0AQG}
\href{https://stacks.math.columbia.edu/tag/0AQG}{\texttt{Stacks tag 0AQG}}
\group{formal-spaces}
...
apply Lemma \ref{formal-spaces-lemma-map-into-affine} to see that $\varphi$ comes
from a morphism $\Spec(A) \to X$. This proves surjectivity of the map.
We omit the proof of injectivity.
\end{proof}

\begin{lemma}[Map into algebraic space]
\label{formal-spaces-lemma-map-into-algebraic-space}
\source{stacks:0AQH}
\href{https://stacks.math.columbia.edu/tag/0AQH}{\texttt{Stacks tag 0AQH}}
\group{formal-spaces}
...
$$
\begin{array}{cc}\Spec(k') \downarrow\underset{u_0}{\longrightarrow} & U \downarrow \\ \Spec(k) \overset{x_0}{\longrightarrow} & X\end{array}
$$
...
mapping to $(x'_n)$. By Lemma \ref{formal-spaces-lemma-map-into-scheme}
...
Hence the diagram
$$
\begin{array}{cc}\Spec(R' \otimes_R R') \longrightarrow\downarrow & \Spec(R') \overset{x'}{\downarrow} \\ \Spec(R') \overset{x'}{\longrightarrow} & X\end{array}
$$
...
\begin{lemma}[Adic into completion]
\label{formal-spaces-lemma-adic-into-completion}
\source{stacks:0GBU}
\href{https://stacks.math.columbia.edu/tag/0GBU}{\texttt{Stacks tag 0GBU}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-formal-completion-types} (and hence we're
allowed to use the terminology adic for morphisms, see
Definition \ref{formal-spaces-definition-adic-morphism}).
Let $p$ be given. By Lemma \ref{formal-spaces-lemma-map-into-algebraic-space}
...
\begin{definition}[Etale sites]
\label{formal-spaces-definition-etale-sites}
\source{stacks:0DEA}
\href{https://stacks.math.columbia.edu/tag/0DEA}{\texttt{Stacks tag 0DEA}}
\group{formal-spaces}

Let $S$ be a scheme. Let $X$ be a formal algebraic space with
reduction $X_{red}$ (Lemma \ref{formal-spaces-lemma-reduction-formal-algebraic-space}).
\begin{enumerate}
...
In Lemma \ref{formal-spaces-lemma-identify-spaces-etale} we will see that
...
\begin{lemma}[Functoriality etale site]
\label{formal-spaces-lemma-functoriality-etale-site}
\source{stacks:0DEC}
\href{https://stacks.math.columbia.edu/tag/0DEC}{\texttt{Stacks tag 0DEC}}
\group{formal-spaces}
...
$X_{red} \to Y_{red}$ by Lemma \ref{formal-spaces-lemma-reduction-formal-algebraic-space}.
...
\begin{lemma}[Etale morphism topoi]
\label{formal-spaces-lemma-etale-morphism-topoi}
\source{stacks:0DED}
\href{https://stacks.math.columbia.edu/tag/0DED}{\texttt{Stacks tag 0DED}}
\group{formal-spaces}
...
\begin{lemma}[Affine identify affine etale]
\label{formal-spaces-lemma-affine-identify-affine-etale}
\source{stacks:0DEE}
\href{https://stacks.math.columbia.edu/tag/0DEE}{\texttt{Stacks tag 0DEE}}
\group{formal-spaces}
...
\begin{lemma}[Affine etale mcquillan]
\label{formal-spaces-lemma-affine-etale-mcquillan}
\source{stacks:0DEF}
\href{https://stacks.math.columbia.edu/tag/0DEF}{\texttt{Stacks tag 0DEF}}
\group{formal-spaces}
...
\begin{proof}
Combine Lemmas \ref{formal-spaces-lemma-affine-identify-affine-etale} and \ref{formal-spaces-lemma-etale}.
\end{proof}

\begin{lemma}[Identify spaces etale]
\label{formal-spaces-lemma-identify-spaces-etale}
\source{stacks:0DEG}
\href{https://stacks.math.columbia.edu/tag/0DEG}{\texttt{Stacks tag 0DEG}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-etale-morphism-topoi}
...
\begin{lemma}[Identify affine etale]
\label{formal-spaces-lemma-identify-affine-etale}
\source{stacks:0DEH}
\href{https://stacks.math.columbia.edu/tag/0DEH}{\texttt{Stacks tag 0DEH}}
\group{formal-spaces}
...
\begin{proof}
This follows by combining Lemmas \ref{formal-spaces-lemma-identify-spaces-etale} and
\ref{formal-spaces-lemma-characterize-affine}.
\end{proof}

\section{The structure sheaf}
\label{formal-spaces-section-structure-sheaf}
As in Section \ref{formal-spaces-section-etale-sites} the motivation for the discussion
in this section comes from classical formal schemes. These are defined as pairs
$(\mathfrak X, \mathcal{O}_\mathfrak X)$ where $\mathcal{O}_\mathfrak X$
is a sheaf of topological rings.

\medskip\noindent
Let $X$ be a formal algebraic space. A {\it structure sheaf for $X$}
is a sheaf of topological rings $\mathcal{O}_X$ on the \'etale site
$X_\etale$ (which we defined in Section \ref{formal-spaces-section-etale-sites}) such that
$$
...
$X_\etale$, see
Lemma \ref{formal-spaces-lemma-identify-affine-etale},
...
\begin{lemma}[Structure sheaf]
\label{formal-spaces-lemma-structure-sheaf}
\source{stacks:0DEJ}
\href{https://stacks.math.columbia.edu/tag/0DEJ}{\texttt{Stacks tag 0DEJ}}
\group{formal-spaces}
...
$\varphi$ is representable by algebraic spaces and \'etale.
By Lemma \ref{formal-spaces-lemma-identify-affine-etale}
...
(Lemma \ref{formal-spaces-lemma-permanence-representable}) hence affine
(Lemma \ref{formal-spaces-lemma-affine-representable-by-algebraic-spaces}).
...
\begin{remark}[Not enough sections]
\label{formal-spaces-remark-not-enough-sections}
\source{stacks:0DEK}
\href{https://stacks.math.columbia.edu/tag/0DEK}{\texttt{Stacks tag 0DEK}}
\group{formal-spaces}
...
\begin{lemma}[Higher vanishing structure sheaf]
\label{formal-spaces-lemma-higher-vanishing-structure-sheaf}
\source{stacks:0DEL}
\href{https://stacks.math.columbia.edu/tag/0DEL}{\texttt{Stacks tag 0DEL}}
\group{formal-spaces}
...
\ref{formal-spaces-lemma-affine-identify-affine-etale} and
...
is faithfully flat, see Lemma \ref{formal-spaces-lemma-etale-surjective}.
Hence the complex
$$
...
$$
remain exact by Lemma \ref{formal-spaces-lemma-ses}. This proves the lemma.
\end{proof}

\begin{remark}[Bad quasi coherent]
\label{formal-spaces-remark-bad-quasi-coherent}
\source{stacks:0DEM}
\href{https://stacks.math.columbia.edu/tag/0DEM}{\texttt{Stacks tag 0DEM}}
\group{formal-spaces}
...
\begin{lemma}[Colimit affine formal]
\label{formal-spaces-lemma-colimit-affine-formal}
\source{stacks:0GVM}
\href{https://stacks.math.columbia.edu/tag/0GVM}{\texttt{Stacks tag 0GVM}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-factor-through-thickening}. Then
...
\begin{lemma}[Colimit formal spaces is formal space]
\label{formal-spaces-lemma-colimit-formal-spaces-is-formal-space}
\source{stacks:0GVN}
\href{https://stacks.math.columbia.edu/tag/0GVN}{\texttt{Stacks tag 0GVN}}
\group{formal-spaces}
...
\ref{formal-spaces-definition-formal-algebraic-space}. In particular, we see
...
algebraic space, see
Lemma \ref{formal-spaces-lemma-affine-identify-affine-etale}.
...
Lemma \ref{formal-spaces-lemma-colimit-affine-formal}.
\end{proof}
...
generalization of Section \ref{formal-spaces-section-completion}.

\begin{lemma}[Completion affine formal is affine formal]
\label{formal-spaces-lemma-completion-affine-formal-is-affine-formal}
\source{stacks:0GVQ}
\href{https://stacks.math.columbia.edu/tag/0GVQ}{\texttt{Stacks tag 0GVQ}}
\group{formal-spaces}
...
By Lemma \ref{formal-spaces-lemma-completion-affine-is-affine-formal-algebraic-space}
...
$X_\lambda \to X_\mu$, see Lemma \ref{formal-spaces-lemma-map-completions-representable}.
Also the morphisms $((X_\lambda)_{/T})_{red} \to ((X_\mu)_/T)_{red}$
are isomorphisms by Lemma \ref{formal-spaces-lemma-reduction-completion}.
Since $X_{/T} = \colim (X_\lambda)_{/T}$ we conclude
by Lemma \ref{formal-spaces-lemma-colimit-affine-formal}.
\end{proof}

\begin{lemma}[Completion fas is fas]
\label{formal-spaces-lemma-completion-fas-is-fas}
\source{stacks:0GVR}
\href{https://stacks.math.columbia.edu/tag/0GVR}{\texttt{Stacks tag 0GVR}}
\group{formal-spaces}
...
Lemma \ref{formal-spaces-lemma-completion-affine-formal-is-affine-formal}.
\end{proof}

\begin{definition}[Completion formal algebraic space]
\label{formal-spaces-definition-completion-formal-algebraic-space}
\source{stacks:0GVS}
\href{https://stacks.math.columbia.edu/tag/0GVS}{\texttt{Stacks tag 0GVS}}
\group{formal-spaces}

Let $S$ be a scheme. Let $X$ be a formal algebraic space over $S$.
Let $T \subset |X_{red}|$ be a closed subset. The formal algebraic space
$X_{/T}$ of Lemma \ref{formal-spaces-lemma-completion-is-formal-algebraic-space}
is called the {\it completion of $X$ along $T$}.
\end{definition}
...
\begin{lemma}[Map recompletions]
\label{formal-spaces-lemma-map-recompletions}
\source{stacks:0GVT}
\href{https://stacks.math.columbia.edu/tag/0GVT}{\texttt{Stacks tag 0GVT}}
\group{formal-spaces}
...
\begin{lemma}[Reduction recompletion]
\label{formal-spaces-lemma-reduction-recompletion}
\source{stacks:0GVU}
\href{https://stacks.math.columbia.edu/tag/0GVU}{\texttt{Stacks tag 0GVU}}
\group{formal-spaces}
...
\begin{lemma}[Recompletion affine types]
\label{formal-spaces-lemma-recompletion-affine-types}
\source{stacks:0GVV}
\href{https://stacks.math.columbia.edu/tag/0GVV}{\texttt{Stacks tag 0GVV}}
\group{formal-spaces}
...
\begin{proof}
Part (1) is Lemma \ref{formal-spaces-lemma-completion-affine-formal-is-affine-formal}.
If $X$ is McQuillan, then $X = \text{Spf}(A)$ for some weakly admissible
topological ring $A$. Then $X_{/T} \to X \to \Spec(A)$ satisfies
property (2) of Lemma \ref{formal-spaces-lemma-mcquillan-affine-formal-algebraic-space}
...
$A \supset I_1 \supset I_2 \supset I_3 \supset \ldots$
of weak ideals of definition, see Lemma \ref{formal-spaces-lemma-countably-indexed}.
...
\begin{lemma}[Recompletion types]
\label{formal-spaces-lemma-recompletion-types}
\source{stacks:0GVW}
\href{https://stacks.math.columbia.edu/tag/0GVW}{\texttt{Stacks tag 0GVW}}
\group{formal-spaces}
...
(Lemma \ref{formal-spaces-lemma-map-recompletions}).
...
Lemma \ref{formal-spaces-lemma-recompletion-affine-types}.
\end{proof}

\section{Completion along a closed subspace}
\label{formal-spaces-section-completion-subspace}
This section is the analgue of Section \ref{formal-spaces-section-completion}
for completions with respect to a closed subspace.

\begin{definition}[Completion subspace]
\label{formal-spaces-definition-completion-subspace}
\source{stacks:0GXU}
\href{https://stacks.math.columbia.edu/tag/0GXU}{\texttt{Stacks tag 0GXU}}
\group{formal-spaces}
...
X^\wedge_Z = \colim Z_n
$$
(see Lemma \ref{formal-spaces-lemma-colimit-formal-spaces-is-formal-space})
is called the {\it completion of $X$ along $Z$}.
\end{definition}

For example, if $X = \Spec(A)$ and $Z$ is cut out by the ideal $I \subset A$,
then we have
$$
X^\wedge_Z = \colim \Spec(A/I^n) = \text{Spf}(B)
$$
where $B = \lim A/I^n$ with the limit topology. Note that $B$ is a
weakly adic topological ring but in general not adic.

\medskip\noindent
Returning to the general case, if $T = |Z|$ then there is a canonical morphism
$X^\wedge_Z \to X_{/T}$ comparing the completions along $Z$
and $T$ (Section \ref{formal-spaces-section-completion}) which need not be an isomorphism
(see Lemma \ref{formal-spaces-lemma-when-isomorphism}).
...
\begin{lemma}[Map completions subspaces representable]
\label{formal-spaces-lemma-map-completions-subspaces-representable}
\source{stacks:0GXV}
\href{https://stacks.math.columbia.edu/tag/0GXV}{\texttt{Stacks tag 0GXV}}
\group{formal-spaces}
...
Then
$$
\begin{array}{cc}(X')^\wedge_{Z'} \longrightarrow\downarrow & X' \overset{f}{\downarrow} \\ X^\wedge_Z \longrightarrow & X\end{array}
$$
is a cartesian diagram of sheaves. In particular, the morphism
...
\begin{lemma}[Reduction completion subspace]
\label{formal-spaces-lemma-reduction-completion-subspace}
\source{stacks:0GXW}
\href{https://stacks.math.columbia.edu/tag/0GXW}{\texttt{Stacks tag 0GXW}}
\group{formal-spaces}
...
\begin{lemma}[Affine formal completion subspace types]
\label{formal-spaces-lemma-affine-formal-completion-subspace-types}
\source{stacks:0GXX}
\href{https://stacks.math.columbia.edu/tag/0GXX}{\texttt{Stacks tag 0GXX}}
\group{formal-spaces}
...
\begin{lemma}[Formal completion subspace types]
\label{formal-spaces-lemma-formal-completion-subspace-types}
\source{stacks:0GXY}
\href{https://stacks.math.columbia.edu/tag/0GXY}{\texttt{Stacks tag 0GXY}}
\group{formal-spaces}
...
\begin{lemma}[When isomorphism]
\label{formal-spaces-lemma-when-isomorphism}
\source{stacks:0H8N}
\href{https://stacks.math.columbia.edu/tag/0H8N}{\texttt{Stacks tag 0H8N}}
\group{formal-spaces}

Let $S$ be a scheme. Let $X$ be an algebraic space over $S$.
Let $Z \subset X$ be a closed subspace and set $T = |Z|$. The canonical
morphism $c : X^\wedge_Z \to X_{/T}$ is an isomorphism if $Z \to X$
is of finite presentation, but not in general.
\end{lemma}

\begin{proof}
Both constructions commute with \'etale localization, hence it suffices
to prove this when $X$ is affine. Say $X = \Spec(A)$ and $Z$ corresponds
to the ideal $I \subset A$. If $I$ is finitely generated then both
$X^\wedge_Z$ and $X_{/T}$ are equal to $\text{Spf}(A^\wedge)$ where $A^\wedge$
is the $I$-adic completion of $A$, see
Lemmas \ref{formal-spaces-lemma-affine-formal-completion-types} and
\ref{formal-spaces-lemma-affine-formal-completion-subspace-types}.
If $A = \mathbf{Z}[x_1, x_2, \ldots]$ and $I = (x_1, x_2, \ldots)$
then $\Spec(A/(x_n^n, n \geq 1)) \to X$ factors through $X_{/T}$
but not through $X^\wedge_Z$ and hence $c$ is not an isomorphism.
\end{proof}
