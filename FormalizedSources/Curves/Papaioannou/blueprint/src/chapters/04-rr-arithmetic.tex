...
\source{papaioannou-algebraic-rr:page-0013}\uses{}
...
injective. If $\omega_1\in\Omega(D)$,
...
\source{papaioannou-algebraic-rr:page-0014}\uses{}
...
\source{papaioannou-algebraic-rr:page-0014}\uses{}
Write $u=a/c$ and $v=b/c$ in lowest terms, so that $a+b=c$.  For every
$\epsilon>0$ there is $m_\epsilon$ such that
\[
