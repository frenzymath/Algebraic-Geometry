...
`FormalizedPapers/SurfacesBirationalHyperkahler/NoEnriquesSurfaceOverTheIntegers`.
...
- Source bundle: [`references/no-enriques-surface-over-the-integers/`](../../../references/no-enriques-surface-over-the-integers/)
