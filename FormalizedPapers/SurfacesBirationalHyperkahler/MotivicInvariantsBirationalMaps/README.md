...
`FormalizedPapers/SurfacesBirationalHyperkahler/MotivicInvariantsBirationalMaps`.
...
- Source bundle: [`references/motivic-invariants-birational-maps/`](../../../references/motivic-invariants-birational-maps/)
