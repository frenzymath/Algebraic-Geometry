...
\begin{definition}
\label{src-standard-conjectures-abelian-fourfolds-ch07-exotic-classes-statement-1}
\source{standard-conjectures-abelian-fourfolds}
\notready
...
\begin{lemma}
\label{src-standard-conjectures-abelian-fourfolds-ch07-exotic-classes-statement-2}
\source{standard-conjectures-abelian-fourfolds}
\notready
...
\begin{lemma}
\label{src-standard-conjectures-abelian-fourfolds-ch07-exotic-classes-statement-3}
\source{standard-conjectures-abelian-fourfolds}
\notready
