...
is representable as a category fibred in groupoids over
$(\Sch/U)_{fppf}$. Choose a representing object $f_y : V_y \to U$
and an equivalence
$$
(\Sch/V_y)_{fppf}
\longrightarrow
(\Sch/U)_{fppf} \times_{y, \mathcal{Y}} \mathcal{X}.
$$
The morphism $f_y$ corresponds to the projection
$(\Sch/V_y)_{fppf} \to
(\Sch/U)_{fppf} \times_\mathcal{Y} \mathcal{Y}
\to (\Sch/U)_{fppf}$
See Section \ref{algebraic-section-representable},
Equation (\ref{equation-morphisms-schemes}). We represent this by the diagram
\begin{equation}
\label{equation-representable}
\vcenter{
\begin{array}{ccc}V_y \rightsquigarrow\underset{f_y}{\downarrow} & (\Sch/V_y)_{fppf} \downarrow\longrightarrow & \mathcal{X} \overset{f}{\downarrow} \\ U \rightsquigarrow & (\Sch/U)_{fppf} \overset{y}{\longrightarrow} & \mathcal{Y}\end{array}
}
\end{equation}
...
\source{stacks:02ZR}
\href{https://stacks.math.columbia.edu/tag/02ZR}{\texttt{Stacks tag 02ZR}}
\group{algebraic}
...
\begin{lemma}[Representable morphism equivalent]
\label{algebraic-lemma-representable-morphism-equivalent}
\source{stacks:0456}
\href{https://stacks.math.columbia.edu/tag/0456}{\texttt{Stacks tag 0456}}
\group{algebraic}
...
\source{stacks:02ZS}
\href{https://stacks.math.columbia.edu/tag/02ZS}{\texttt{Stacks tag 02ZS}}
\group{algebraic}
...
\source{stacks:02ZT}
\href{https://stacks.math.columbia.edu/tag/02ZT}{\texttt{Stacks tag 02ZT}}
\group{algebraic}
...
$$
\begin{array}{cc}\mathcal{Z} \times_{g, \mathcal{Y}, f} \mathcal{X} \underset{g'}{\longrightarrow}\underset{f'}{\downarrow} & \mathcal{X} \overset{f}{\downarrow} \\ \mathcal{Z} \overset{g}{\longrightarrow} & \mathcal{Y}\end{array}
$$
...
\source{stacks:02ZU}
\href{https://stacks.math.columbia.edu/tag/02ZU}{\texttt{Stacks tag 02ZU}}
\group{algebraic}
...
\begin{proof}
\uses{algebraic-lemma-composition-representable-transformations, algebraic-lemma-base-change-representable-transformations}
...
consequence of Lemmas \ref{algebraic-lemma-composition-representable-transformations}
and \ref{algebraic-lemma-base-change-representable-transformations}.
\end{proof}
...
\begin{definition}[Representable by algebraic space]
\label{algebraic-definition-representable-by-algebraic-space}
\source{stacks:04SV}
\href{https://stacks.math.columbia.edu/tag/04SV}{\texttt{Stacks tag 04SV}}
\group{algebraic}
...
\begin{lemma}[Characterize representable by space]
\label{algebraic-lemma-characterize-representable-by-space}
\source{stacks:02ZX}
\href{https://stacks.math.columbia.edu/tag/02ZX}{\texttt{Stacks tag 02ZX}}
\group{algebraic}
...
\begin{definition}[Representable by algebraic spaces]
\label{algebraic-definition-representable-by-algebraic-spaces}
\source{stacks:02ZW}
\href{https://stacks.math.columbia.edu/tag/02ZW}{\texttt{Stacks tag 02ZW}}
\group{algebraic}
...
\vcenter{
\begin{array}{ccc}F_y \underset{f_y}{\downarrow} & (\Sch/U)_{fppf} \times_{y, \mathcal{Y}} \mathcal{X}
\leftsquigarrow\underset{\text{pr}_0}{\downarrow}\underset{\text{pr}_1}{\longrightarrow} & \mathcal{X} \overset{f}{\downarrow} \\ U & (\Sch/U)_{fppf} \leftsquigarrow\overset{y}{\longrightarrow} & \mathcal{Y}\end{array}
}
\end{equation}
...
\begin{lemma}[Criterion map representable spaces fibred in groupoids]
\label{algebraic-lemma-criterion-map-representable-spaces-fibred-in-groupoids}
\source{stacks:02ZY}
\href{https://stacks.math.columbia.edu/tag/02ZY}{\texttt{Stacks tag 02ZY}}
\group{algebraic}
...
\begin{proof}
\uses{algebraic-lemma-characterize-representable-by-space}
...
\begin{lemma}[Representable by spaces morphism equivalent]
\label{algebraic-lemma-representable-by-spaces-morphism-equivalent}
\source{stacks:0457}
\href{https://stacks.math.columbia.edu/tag/0457}{\texttt{Stacks tag 0457}}
\group{algebraic}
...
\begin{lemma}[Morphism spaces gives representable by spaces]
\label{algebraic-lemma-morphism-spaces-gives-representable-by-spaces}
\source{stacks:02ZZ}
\href{https://stacks.math.columbia.edu/tag/02ZZ}{\texttt{Stacks tag 02ZZ}}
\group{algebraic}
...
\begin{lemma}[Map presheaves representable by algebraic spaces]
\label{algebraic-lemma-map-presheaves-representable-by-algebraic-spaces}
\source{stacks:0458}
\href{https://stacks.math.columbia.edu/tag/0458}{\texttt{Stacks tag 0458}}
\group{algebraic}
...
\begin{lemma}[Map fibred setoids representable algebraic spaces]
\label{algebraic-lemma-map-fibred-setoids-representable-algebraic-spaces}
\source{stacks:04SY}
\href{https://stacks.math.columbia.edu/tag/04SY}{\texttt{Stacks tag 04SY}}
\group{algebraic}
...
\begin{proof}
\uses{algebraic-lemma-representable-by-spaces-morphism-equivalent, algebraic-lemma-map-presheaves-representable-by-algebraic-spaces}

Omitted. Hint: Combine
Lemmas \ref{algebraic-lemma-representable-by-spaces-morphism-equivalent}
and \ref{algebraic-lemma-map-presheaves-representable-by-algebraic-spaces}.
\end{proof}

\begin{lemma}[Base change representable by spaces]
\label{algebraic-lemma-base-change-representable-by-spaces}
\source{stacks:0302}
\href{https://stacks.math.columbia.edu/tag/0302}{\texttt{Stacks tag 0302}}
\group{algebraic}
...
\begin{lemma}[Base change by space representable by space]
\label{algebraic-lemma-base-change-by-space-representable-by-space}
\source{stacks:0300}
\href{https://stacks.math.columbia.edu/tag/0300}{\texttt{Stacks tag 0300}}
\group{algebraic}
...
\begin{proof}
\uses{algebraic-lemma-base-change-representable-by-spaces, algebraic-lemma-map-fibred-setoids-representable-algebraic-spaces}
...
Lemma \ref{algebraic-lemma-base-change-representable-by-spaces}.
...
Lemma \ref{algebraic-lemma-map-fibred-setoids-representable-algebraic-spaces}.
Hence
Bootstrap, Lemma \ref{bootstrap-lemma-representable-by-spaces-over-space}
...
\vcenter{
\begin{array}{ccc}F \underset{f'}{\downarrow} & \mathcal{Z} \times_{g, \mathcal{Y}, f} \mathcal{X}
\leftsquigarrow\downarrow\longrightarrow & \mathcal{X} \overset{f}{\downarrow} \\ G & \mathcal{Z} \leftsquigarrow\overset{g}{\longrightarrow} & \mathcal{Y}\end{array}
}
\end{equation}
where the squiggly arrows represent the construction which associates
to a stack fibred in setoids its associated sheaf of isomorphism classes
...
\begin{lemma}[Composition representable by spaces]
\label{algebraic-lemma-composition-representable-by-spaces}
\source{stacks:0301}
\href{https://stacks.math.columbia.edu/tag/0301}{\texttt{Stacks tag 0301}}
\group{algebraic}
...
\begin{proof}
\uses{algebraic-lemma-base-change-by-space-representable-by-space}
...
\begin{lemma}[Product representable by spaces]
\label{algebraic-lemma-product-representable-by-spaces}
\source{stacks:0303}
\href{https://stacks.math.columbia.edu/tag/0303}{\texttt{Stacks tag 0303}}
\group{algebraic}
...
\begin{proof}
\uses{algebraic-lemma-composition-representable-by-spaces, algebraic-lemma-base-change-representable-by-spaces}
...
$\mathcal{Y}_1 \times \mathcal{Y}_2 \to \mathcal{Y}_2$.
Hence this lemma is a formal
consequence of Lemmas \ref{algebraic-lemma-composition-representable-by-spaces}
and \ref{algebraic-lemma-base-change-representable-by-spaces}.
\end{proof}

\begin{lemma}[Get a stack]
\label{algebraic-lemma-get-a-stack}
\source{stacks:0CKY}
\href{https://stacks.math.columbia.edu/tag/0CKY}{\texttt{Stacks tag 0CKY}}
\group{algebraic}
...
\begin{proof}
\uses{algebraic-lemma-base-change-by-space-representable-by-space, algebraic-lemma-criterion-map-representable-spaces-fibred-in-groupoids}
...
Lemma \ref{algebraic-lemma-criterion-map-representable-spaces-fibred-in-groupoids}.
\end{proof}
...
\source{stacks:03YK}
\href{https://stacks.math.columbia.edu/tag/03YK}{\texttt{Stacks tag 03YK}}
\group{algebraic}
...
\begin{lemma}[Property morphism equivalent]
\label{algebraic-lemma-property-morphism-equivalent}
\source{stacks:0459}
\href{https://stacks.math.columbia.edu/tag/0459}{\texttt{Stacks tag 0459}}
\group{algebraic}

\uses{algebraic-definition-relative-representable-property}
Let $S$ be an object of $\Sch_{fppf}$.
...
\begin{proof}
\uses{algebraic-lemma-representable-by-spaces-morphism-equivalent}

Note that this makes sense by
Lemma \ref{algebraic-lemma-representable-by-spaces-morphism-equivalent}.
Proof omitted.
\end{proof}

Here is a sanity check.

\begin{lemma}[Map presheaves representable by spaces transformation property]
\label{algebraic-lemma-map-presheaves-representable-by-spaces-transformation-property}
\source{stacks:045A}
\href{https://stacks.math.columbia.edu/tag/045A}{\texttt{Stacks tag 045A}}
\group{algebraic}
...
\begin{proof}
\uses{algebraic-lemma-map-presheaves-representable-by-algebraic-spaces}

Note that the lemma makes sense by
Lemma \ref{algebraic-lemma-map-presheaves-representable-by-algebraic-spaces}.
Proof omitted.
\end{proof}

\begin{lemma}[Map fibred setoids property]
\label{algebraic-lemma-map-fibred-setoids-property}
\source{stacks:04TC}
\href{https://stacks.math.columbia.edu/tag/04TC}{\texttt{Stacks tag 04TC}}
\group{algebraic}
...
\begin{proof}
\uses{algebraic-lemma-map-fibred-setoids-representable-algebraic-spaces, algebraic-lemma-property-morphism-equivalent, algebraic-lemma-map-presheaves-representable-by-spaces-transformation-property}

The lemma makes sense by
Lemma \ref{algebraic-lemma-map-fibred-setoids-representable-algebraic-spaces}.
The lemma follows on combining
Lemmas \ref{algebraic-lemma-property-morphism-equivalent}
and \ref{algebraic-lemma-map-presheaves-representable-by-spaces-transformation-property}.
\end{proof}
...
\source{stacks:045B}
\href{https://stacks.math.columbia.edu/tag/045B}{\texttt{Stacks tag 045B}}
\group{algebraic}
...
\begin{proof}
\uses{algebraic-lemma-composition-representable-by-spaces}

Note that the lemma makes sense by
Lemma \ref{algebraic-lemma-composition-representable-by-spaces}.
Proof omitted.
\end{proof}
...
\source{stacks:045C}
\href{https://stacks.math.columbia.edu/tag/045C}{\texttt{Stacks tag 045C}}
\group{algebraic}
...
\begin{proof}
\uses{algebraic-lemma-base-change-representable-by-spaces}
...
\source{stacks:045D}
\href{https://stacks.math.columbia.edu/tag/045D}{\texttt{Stacks tag 045D}}
\group{algebraic}
...
\source{stacks:045E}
\href{https://stacks.math.columbia.edu/tag/045E}{\texttt{Stacks tag 045E}}
\group{algebraic}
...
\begin{proof}
\uses{algebraic-lemma-product-representable-by-spaces}

The lemma makes sense by
Lemma \ref{algebraic-lemma-product-representable-by-spaces}.
Proof omitted.
\end{proof}
...
\source{stacks:045F}
\href{https://stacks.math.columbia.edu/tag/045F}{\texttt{Stacks tag 045F}}
\group{algebraic}
...
\begin{lemma}[Open fibred category is full]
\label{algebraic-lemma-open-fibred-category-is-full}
\source{stacks:05UK}
\href{https://stacks.math.columbia.edu/tag/05UK}{\texttt{Stacks tag 05UK}}
\group{algebraic}
...
\begin{proof}
\uses{algebraic-lemma-criterion-map-representable-spaces-fibred-in-groupoids}
...
By the $2$-Yoneda lemma (see Section \ref{algebraic-section-2-yoneda})
...
\source{stacks:045G}
\href{https://stacks.math.columbia.edu/tag/045G}{\texttt{Stacks tag 045G}}
\group{algebraic}
...
\begin{proof}
\uses{algebraic-lemma-representable-by-spaces-morphism-equivalent, algebraic-lemma-base-change-by-space-representable-by-space}
...
Lemma \ref{algebraic-lemma-representable-diagonal}.

\begin{definition}[Algebraic stack]
\label{algebraic-definition-algebraic-stack}
\source{stacks:026O}
\href{https://stacks.math.columbia.edu/tag/026O}{\texttt{Stacks tag 026O}}
\group{algebraic}
...
\begin{definition}[Deligne mumford]
\label{algebraic-definition-deligne-mumford}
\source{stacks:03YO}
\href{https://stacks.math.columbia.edu/tag/03YO}{\texttt{Stacks tag 03YO}}
\group{algebraic}
...
\begin{definition}[Morphism algebraic stacks]
\label{algebraic-definition-morphism-algebraic-stacks}
\source{stacks:03YP}
\href{https://stacks.math.columbia.edu/tag/03YP}{\texttt{Stacks tag 03YP}}
\group{algebraic}
...
\source{stacks:03YQ}
\href{https://stacks.math.columbia.edu/tag/03YQ}{\texttt{Stacks tag 03YQ}}
\group{algebraic}
...
\begin{proof}
\uses{algebraic-lemma-representable-by-spaces-morphism-equivalent, algebraic-lemma-property-morphism-equivalent}
...
$$
\begin{array}{cc}\mathcal{X} \underset{f}{\longrightarrow}\underset{\Delta_\mathcal{X}}{\downarrow} & \mathcal{Y} \overset{\Delta_\mathcal{Y}}{\downarrow} \\ \mathcal{X} \times \mathcal{X} \overset{f \times f}{\longrightarrow} & \mathcal{Y} \times \mathcal{Y}\end{array}
$$
...
$$
\begin{array}{cc}(\Sch/U)_{fppf} \underset{\text{id}}{\longrightarrow}\underset{x}{\downarrow} & (\Sch/U)_{fppf} \overset{f \circ x}{\downarrow} \\ \mathcal{X} \overset{f}{\longrightarrow} & \mathcal{Y}\end{array}
$$
and applying
Lemma \ref{algebraic-lemma-property-morphism-equivalent}
...
\begin{lemma}[Representable algebraic]
\label{algebraic-lemma-representable-algebraic}
\source{stacks:03YS}
\href{https://stacks.math.columbia.edu/tag/03YS}{\texttt{Stacks tag 03YS}}
\group{algebraic}
...
\begin{proof}
\uses{algebraic-lemma-equivalent, algebraic-lemma-morphism-spaces-gives-representable-by-spaces, algebraic-lemma-map-presheaves-representable-by-spaces-transformation-property}

It is clear that (2) implies (3).
Parts (1) and (2) are equivalent by Lemma \ref{algebraic-lemma-equivalent}.
...
Lemma \ref{algebraic-lemma-morphism-spaces-gives-representable-by-spaces}.
...
\begin{lemma}[Algebraic stack no automorphisms]
\label{algebraic-lemma-algebraic-stack-no-automorphisms}
\source{stacks:045H}
\href{https://stacks.math.columbia.edu/tag/045H}{\texttt{Stacks tag 045H}}
\group{algebraic}
...
\begin{proof}
\uses{algebraic-lemma-representable-algebraic, algebraic-lemma-map-presheaves-representable-by-algebraic-spaces, algebraic-lemma-map-fibred-setoids-property}

The equivalence of (1) and (2) follows from
Stacks, Lemma \ref{stacks-lemma-characterize-stack-in-setoids}.
The implication (3) $\Rightarrow$ (1) follows from
Lemma \ref{algebraic-lemma-representable-algebraic}.
Finally, assume (1). By
...
Hence by
Lemma \ref{algebraic-lemma-map-fibred-setoids-property}
...
\begin{proposition}[Algebraic stack no automorphisms]
\label{algebraic-proposition-algebraic-stack-no-automorphisms}
\source{stacks:04SZ}
\href{https://stacks.math.columbia.edu/tag/04SZ}{\texttt{Stacks tag 04SZ}}
\group{algebraic}
...
\begin{proof}
\uses{algebraic-lemma-algebraic-stack-no-automorphisms, algebraic-lemma-map-presheaves-representable-by-algebraic-spaces, algebraic-lemma-map-fibred-setoids-property, algebraic-lemma-representable-transformations-property-implication}

The equivalence of (1) and (2) follows from
Stacks, Lemma \ref{stacks-lemma-characterize-stack-in-setoids}.
The implication (3) $\Rightarrow$ (1) follows from
Lemma \ref{algebraic-lemma-algebraic-stack-no-automorphisms}.
Finally, assume (1). By
Stacks, Lemma \ref{stacks-lemma-stack-in-setoids-characterize}
...
Lemma \ref{algebraic-lemma-2-fibre-product}
but its proof is slightly easier.

\begin{lemma}[Product spaces]
\label{algebraic-lemma-product-spaces}
\source{stacks:04TE}
\href{https://stacks.math.columbia.edu/tag/04TE}{\texttt{Stacks tag 04TE}}
\group{algebraic}
...
\begin{proof}
\uses{algebraic-lemma-representable-diagonal, algebraic-lemma-base-change-representable-transformations-property, algebraic-lemma-composition-representable-transformations-property}
...
Lemmas \ref{algebraic-lemma-base-change-representable-transformations-property} and
...
\begin{lemma}[2 fibre product general]
\label{algebraic-lemma-2-fibre-product-general}
\source{stacks:04TF}
\href{https://stacks.math.columbia.edu/tag/04TF}{\texttt{Stacks tag 04TF}}
\group{algebraic}
...
\begin{proof}
\uses{algebraic-definition-algebraic-stack, algebraic-lemma-representable-diagonal, algebraic-lemma-base-change-representable-transformations-property, algebraic-lemma-composition-representable-transformations-property}

We have to check conditions (1), (2), and (3) of
Definition \ref{algebraic-definition-algebraic-stack}.
...
$$
\begin{array}{ccc}\mathit{Isom}(u, v) \downarrow\longrightarrow &  & \mathit{Isom}(y, y') \overset{\phi \mapsto g(\phi) \circ \alpha}{\downarrow} \\ \mathit{Isom}(x, x') \overset{\psi \mapsto \alpha' \circ f(\psi)}{\longrightarrow} &  & \mathit{Isom}(f(x), g(y'))\end{array}
$$
...
\begin{lemma}[2 fibre product]
\label{algebraic-lemma-2-fibre-product}
\source{stacks:04T2}
\href{https://stacks.math.columbia.edu/tag/04T2}{\texttt{Stacks tag 04T2}}
\group{algebraic}
...
\source{stacks:04T1}
\href{https://stacks.math.columbia.edu/tag/04T1}{\texttt{Stacks tag 04T1}}
\group{algebraic}
...
$$
\begin{array}{cc}(\Sch/U)_{fppf} \underset{a}{\longrightarrow}\underset{x}{\downarrow} & (\Sch/V)_{fppf} \overset{y}{\downarrow} \\ \mathcal{X} \overset{f}{\longrightarrow} & \mathcal{Y}\end{array}
$$
with $x$ surjective and smooth.
\end{lemma}

\begin{proof}
\uses{algebraic-lemma-base-change-representable-transformations-property, algebraic-lemma-composition-representable-transformations-property}
...
Lemma \ref{algebraic-lemma-base-change-representable-transformations-property}
the morphism
$\mathcal{S}_F \to (\Sch/W)_{fppf}$ is surjective and smooth
as a base change of $y$. Hence by
Lemma \ref{algebraic-lemma-composition-representable-transformations-property}
...
\begin{lemma}[Characterize representable by algebraic spaces]
\label{algebraic-lemma-characterize-representable-by-algebraic-spaces}
\source{stacks:04Y5}
\href{https://stacks.math.columbia.edu/tag/04Y5}{\texttt{Stacks tag 04Y5}}
\group{algebraic}
...
\begin{proof}
\uses{algebraic-lemma-criterion-map-representable-spaces-fibred-in-groupoids, algebraic-lemma-2-fibre-product, algebraic-proposition-algebraic-stack-no-automorphisms}
...
\begin{lemma}[Smooth surjective morphism implies algebraic]
\label{algebraic-lemma-smooth-surjective-morphism-implies-algebraic}
\source{stacks:05UL}
\href{https://stacks.math.columbia.edu/tag/05UL}{\texttt{Stacks tag 05UL}}
\group{algebraic}
...
\begin{proof}
\uses{algebraic-definition-algebraic-stack, algebraic-lemma-representable-diagonal, algebraic-lemma-map-fibred-setoids-representable-algebraic-spaces, algebraic-lemma-base-change-representable-by-spaces, algebraic-lemma-map-fibred-setoids-property, algebraic-lemma-base-change-representable-transformations-property}
...
$$
\begin{array}{cccc} & \mathcal{T}_1 \times_{\mathcal X} \mathcal{T}_2 \longrightarrow\downarrow &  & \mathcal{T}_1 \downarrow \\ \mathcal{T}_1' \times_\mathcal{U} \mathcal{T}_2' \nearrow\longrightarrow\downarrow &  & \mathcal{T}_1' \nearrow\downarrow &  \\  & \mathcal{T}_2 \longrightarrow &  & \mathcal X \\ \mathcal{T}_2' \longrightarrow\nearrow &  & \mathcal{U} \nearrow & \end{array}
$$
...
the diagram
$$
\begin{array}{cc}\mathcal{T}_1' \times_\mathcal{U} \mathcal{T}_2' \downarrow\longrightarrow & \mathcal{U} \downarrow \\ \mathcal{T}_1 \times_{\mathcal X} \mathcal{T}_2 \longrightarrow & \mathcal{X}\end{array}
$$
is a $2$-fibre square.
Hence $T'_1 \times_U T'_2 \to F$ is representable by algebraic spaces,
smooth, and surjective, see
Lemmas \ref{algebraic-lemma-map-fibred-setoids-representable-algebraic-spaces},
...
\begin{lemma}[Representable morphism to algebraic]
\label{algebraic-lemma-representable-morphism-to-algebraic}
\source{stacks:05UM}
\href{https://stacks.math.columbia.edu/tag/05UM}{\texttt{Stacks tag 05UM}}
\group{algebraic}
...
\begin{proof}
\uses{algebraic-definition-algebraic-stack, algebraic-lemma-base-change-by-space-representable-by-space, algebraic-lemma-base-change-representable-by-spaces, algebraic-lemma-base-change-representable-transformations-property, algebraic-lemma-smooth-surjective-morphism-implies-algebraic}
...
\begin{lemma}[Open fibred category is algebraic]
\label{algebraic-lemma-open-fibred-category-is-algebraic}
\source{stacks:05UN}
\href{https://stacks.math.columbia.edu/tag/05UN}{\texttt{Stacks tag 05UN}}
\group{algebraic}
...
\begin{proof}
\uses{algebraic-lemma-representable-morphism-to-algebraic, algebraic-lemma-criterion-map-representable-spaces-fibred-in-groupoids}

The statement on algebraic stacks will follow from the statement on
stacks in groupoids by Lemma \ref{algebraic-lemma-representable-morphism-to-algebraic}.
...
\begin{lemma}[Map space into stack]
\label{algebraic-lemma-map-space-into-stack}
\source{stacks:04T4}
\href{https://stacks.math.columbia.edu/tag/04T4}{\texttt{Stacks tag 04T4}}
\group{algebraic}
...
\begin{proof}
\uses{algebraic-lemma-representable-diagonal, algebraic-lemma-base-change-by-space-representable-by-space, algebraic-lemma-characterize-representable-by-space}
...
$$
\begin{array}{ccc}c \overset{\beta^{-1}}{\longrightarrow} & b \overset{\alpha^{-1}}{\longrightarrow} & a\end{array}
$$
...
\begin{lemma}[Stack presentation]
\label{algebraic-lemma-stack-presentation}
\source{stacks:04T5}
\href{https://stacks.math.columbia.edu/tag/04T5}{\texttt{Stacks tag 04T5}}
\group{algebraic}

\uses{algebraic-lemma-map-space-into-stack}
Let $S$ be a scheme contained in $\Sch_{fppf}$.
Let $\mathcal{X}$ be an algebraic stack over $S$.
...
Lemma \ref{algebraic-lemma-map-space-into-stack}
to $U$ and $f$. Then
\begin{enumerate}
...
\begin{proof}
\uses{algebraic-lemma-property-morphism-equivalent, algebraic-lemma-map-presheaves-representable-by-spaces-transformation-property}

The morphisms $s, t$ are smooth by
Lemmas \ref{algebraic-lemma-property-morphism-equivalent} and
\ref{algebraic-lemma-map-presheaves-representable-by-spaces-transformation-property}.
...
\begin{remark}[Flat fp presentation]
\label{algebraic-remark-flat-fp-presentation}
\source{stacks:04WY}
\href{https://stacks.math.columbia.edu/tag/04WY}{\texttt{Stacks tag 04WY}}
\group{algebraic}

\uses{algebraic-lemma-stack-presentation}
...
\begin{definition}[Smooth groupoid]
\label{algebraic-definition-smooth-groupoid}
\source{stacks:04TH}
\href{https://stacks.math.columbia.edu/tag/04TH}{\texttt{Stacks tag 04TH}}
\group{algebraic}
...
\source{stacks:04TI}
\href{https://stacks.math.columbia.edu/tag/04TI}{\texttt{Stacks tag 04TI}}
\group{algebraic}
...
\begin{lemma}[Diagonal quotient stack]
\label{algebraic-lemma-diagonal-quotient-stack}
\source{stacks:04WZ}
\href{https://stacks.math.columbia.edu/tag/04WZ}{\texttt{Stacks tag 04WZ}}
\group{algebraic}
...
\begin{proof}
\uses{algebraic-lemma-representable-diagonal}
...
\begin{lemma}[Smooth quotient smooth presentation]
\label{algebraic-lemma-smooth-quotient-smooth-presentation}
\source{stacks:04X0}
\href{https://stacks.math.columbia.edu/tag/04X0}{\texttt{Stacks tag 04X0}}
\group{algebraic}
...
\begin{proof}
\uses{algebraic-lemma-diagonal-quotient-stack, algebraic-lemma-representable-diagonal}
...
Lemmas \ref{algebraic-lemma-diagonal-quotient-stack} and
...
\begin{theorem}[Smooth groupoid gives algebraic stack]
\label{algebraic-theorem-smooth-groupoid-gives-algebraic-stack}
\source{stacks:04TK}
\href{https://stacks.math.columbia.edu/tag/04TK}{\texttt{Stacks tag 04TK}}
\group{algebraic}
...
\begin{proof}
\uses{algebraic-definition-algebraic-stack, algebraic-lemma-diagonal-quotient-stack, algebraic-lemma-map-presheaves-representable-by-spaces-transformation-property, algebraic-lemma-representable-transformations-property-implication, algebraic-lemma-smooth-quotient-smooth-presentation, algebraic-lemma-composition-representable-transformations-property}
...
Lemma \ref{algebraic-lemma-diagonal-quotient-stack}.
...
Lemmas \ref{algebraic-lemma-smooth-quotient-smooth-presentation} and
\ref{algebraic-lemma-composition-representable-transformations-property}.
\end{proof}
...
\source{stacks:04X2}
\href{https://stacks.math.columbia.edu/tag/04X2}{\texttt{Stacks tag 04X2}}
\group{algebraic}
...
\source{stacks:04X3}
\href{https://stacks.math.columbia.edu/tag/04X3}{\texttt{Stacks tag 04X3}}
\group{algebraic}

\uses{algebraic-lemma-change-big-site}
...
Lemma \ref{algebraic-lemma-change-big-site}
...
\source{stacks:04X5}
\href{https://stacks.math.columbia.edu/tag/04X5}{\texttt{Stacks tag 04X5}}
\group{algebraic}
...
\begin{definition}[Viewed as]
\label{algebraic-definition-viewed-as}
\source{stacks:04X6}
\href{https://stacks.math.columbia.edu/tag/04X6}{\texttt{Stacks tag 04X6}}
\group{algebraic}

\uses{algebraic-lemma-category-of-spaces-over-smaller-base-scheme}
Let $\Sch_{fppf}$ be a big fppf site.
Let $S \to S'$ be a morphism of this site.
...
Lemma \ref{algebraic-lemma-category-of-spaces-over-smaller-base-scheme}
to $\mathcal{X}$.
\end{definition}
...
\source{stacks:04X7}
\href{https://stacks.math.columbia.edu/tag/04X7}{\texttt{Stacks tag 04X7}}
\group{algebraic}
...
algebraic stack $\mathcal{X}'_S$ over $S$ described above.
\end{definition}
